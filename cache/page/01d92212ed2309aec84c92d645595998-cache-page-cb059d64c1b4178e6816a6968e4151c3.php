<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:67256:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-25/menus/list-all-categories" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-09-28T23:10:19-07:00" />
  <meta name="keywords" content="joomla 2.5 list all categories" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="In this Joomla 2.5 tutorial, we'll show you how to create a List All Categories menu item." />
  <title>Joomla 2.5 Menu Items - List All Categories - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-25/menus/list-all-categories" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:bc5560dcbcbae2424f437d55a17771c8 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Joomla 2.5 Menu Items - List All Categories									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>23,700</span></div>
							...
							<div style='clear:both;'></div>
								...
								<p class="alert">Joomla 2.5 has reached its end of life as for 12/31/2014. Please be advised this may be a security risk to your website. You can view more information about the end of life <a href="https://docs.joomla.org/Joomla!_CMS_versions">here</a>.</p><br /><p>When creating new menu items in Joomla 2.5, one of the available options is a <strong>List All Categories</strong> menu type. Creating a List All Categories menu item will create a link, that when clicked, will bring users to a page that list all categories within a specific parent category (which you can select).</p>
<p><strong>How to create a List All Categories menu item in Joomla 2.5:</strong></p>
<ol class="article_list">
<li><a href="/support/edu/joomla-25/getting-started/how-to-log-into-dashboard">Log into your Joomla admin</a></li>
<li>In the top menu, hover over <strong>Menus</strong>, hover over the menu you want to create the menu item for, and then click <strong>Add New Menu Item</strong></li>
<li>Next to <strong>Menu Item Type</strong>, click <strong>Select</strong> and then click <strong>List All Categories</strong><br /><br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/list-all-categories/click-list-all-categories.gif"><img  alt="click-list-all-categories" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/list-all-categories/click-list-all-categories.gif" /></a></li>
<li>Next to <strong>Menu Title</strong>, enter a name for the menu item</li>
<li>Next to <strong>Select a Top Menu Category</strong>, select the top category that you would like to show all categories within<br /><br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/list-all-categories/select-a-top-level-category.gif"><img  alt="select-a-top-level-category" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/list-all-categories/select-a-top-level-category.gif" /></a></li>
<li>Click <strong>Save</strong> in the top right menu</li>
<li>Visit your Joomla 2.5 website, find and click on your new link, and you will then see a listing of all categories within the top menu category you selected!<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/list-all-categories/new-link-has-been-created.gif"><img  alt="new-link-has-been-created" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/list-all-categories/new-link-has-been-created.gif" /></a></li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 7: Joomla 2.5 Menu Items - List All Categories</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 8: <a href='/support/edu/joomla-25/menus/menu-items-in-new-tab'>Forcing Joomla 2.5 menu items to open in a new window</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-25/menus/list-all-categories&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-25/menus/list-all-categories'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xODYmaWQ9MTMzMCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/92d327ee41e2a0e07514326d4a02d211?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/92d327ee41e2a0e07514326d4a02d211'>Shridhar Tandale</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-07 3:31 am</div>
				                <div><p><span style="color: #222222; font-family: arial, sans-serif; font-size: 12.8px;">Hello Sir,</span></p>
<div style="color: #222222; font-family: arial, sans-serif; font-size: 12.8px;">&nbsp; &nbsp;I am managing a Joomla 2.5 site in that I have created a menu item of&nbsp;<strong>List All Categories</strong>&nbsp;like</div>
<div style="color: #222222; font-family: arial, sans-serif; font-size: 12.8px;">&nbsp; &nbsp;&nbsp;<strong>Journal Paper (Menu)</strong>&nbsp;&nbsp;assigned root category is&nbsp;<strong>Vol-Year</strong></div>
<div style="color: #222222; font-family: arial, sans-serif; font-size: 12.8px;">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; -Vol.46-2014 &nbsp;(Category)</div>
<div style="color: #222222; font-family: arial, sans-serif; font-size: 12.8px;">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; --Jan-Mar 2014 (Category)</div>
<div style="color: #222222; font-family: arial, sans-serif; font-size: 12.8px;">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; ---Article-1</div>
<div style="color: #222222; font-family: arial, sans-serif; font-size: 12.8px;">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; ---Article-2&nbsp;</div>
<div style="color: #222222; font-family: arial, sans-serif; font-size: 12.8px;">&nbsp;In this structure I want to assign a module for Vol.46-2014 category. I have searched lot but did not find answer so please guide me in this manner.</div></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26401);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
				...
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-09 10:56 am</div>
				                <div>Hello Shridhar,<br />
<br />
Thank you for contacting us. It's not exactly clear what you are trying to accomplish, but there are some 3rd party modules available for this type of listing. Such as <a href="http://extensions.joomla.org/extension/monthly-archive" target="_blank">Monthly Archive</a>.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26491);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
