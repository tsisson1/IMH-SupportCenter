<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50919:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/email/sending-email-from-within-a-program" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Dave, and thank you for your question. It would depend on how exactly you're trying to code your application as to why it might work in one locati..." />
  <title>Sending email from within a program | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/email/sending-email-from-within-a-program" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:c7db7de4b3c1fcc11e587e216c1aacff -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Sending email from within a program</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/bpgsim5'>bpgsim5</a>
			<div>20 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-12-03 8:23 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>1,297</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I have an educational simulation in which administrators (professors) need to send a small zip file to each competing team prior to the start of the competition.  I have designed the program so that they enter a team number and an email address and then click Send.  The program sends a small message and the attachment using my email address bpgaccess@bpgsim.com at Inmotion.  <br />
The program uses the following info to send the program:<br />
.SMTPHost = &quot;secure104.inmotionhosting.com&quot;<br />
        .From = &quot;bpgaccess@bpgsim.com&quot;<br />
        .FromDisplayName = &quot;Simulation Administrator&quot;<br />
        .Recipient = EmailAddress1<br />
        .RecipientDisplayName = &quot;BPG team&quot; &amp; World1 &amp; Company1<br />
<br />
It works fine on my computer, but a user in Brazil tested it and received the following errors:<br />
550 Helo required before mail<br />
503 Sender not yet given<br />
<br />
I want to send it through my account using a variant of sendmail to prevent problems present when trying to use MAPI with a number of different email clients.  What do I need to do to make this work?<br />
<br />
Dave</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_1952' id='upvote_answer_1952' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='1952' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_1952').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_1952' id='downvote_answer_1952' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='1952' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_1952').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>9,968 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2012-12-04 9:54 am EST
                		        </div>
					
		                </div>

				Hello Dave, and thank you for your question.<br />
<br />
It would depend on how exactly you're trying to code your application as to why it might work in one location but not from another. <br />
<br />
I see that you have a WordPress installation, and also a phpList one, is it one of these that you're having issues with? Or you also mention using a variant of sendmail, so are you doing this on a local program that you are then distributing to others?<br />
<br />
With the errors that you're getting back from the server it sounds like you're not properly setting up SMTP authentication in your application. Here is the failed connection from the mail logs:<br />
<br />
&lt;pre class=&quot;code_block&quot; style=&quot;width: 500px;&quot;&gt;<br />
rejected MAIL &amp;lt;&amp;gt;: HELO required before MAIL<br />
SMTP AUTH is required for message submission on port 587<br />
SMTP connection from (bpgsim.com) closed by DROP in ACL<br />
&lt;/pre&gt;<br />
<br />
You might wish to look into a pre-built PHP class such as phpMailer which already has SMTP authentication built in to it:<br />
<br />
&lt;a href=&quot;http://code.google.com/a/apache-extras.org/p/phpmailer/&quot;&gt;phpMailer - Full Featured Email Transfer Class for PHP&lt;/a&gt;<br />
<br />
I hope that information was helpful, please let us know if you have any further questions.<br />
<br />
- Jacob
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_1952').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_1952' id='form_comment_on_answer_1952' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/email/sending-email-from-within-a-program&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/email/sending-email-from-within-a-program'></div>
<script type='text/javascript'>
  (function() {
