<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:67971:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/opencart/317-enabling-gzip-compression-in-opencart" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-04-20T13:53:31-07:00" />
  <meta name="keywords" content="opencart compression GZIP page speed" />
  <meta name="author" content="Tim Sisson" />
  <meta name="description" content="In this tutorial, we'll show you how to enable GZIP compression in your OpenCart dashboard." />
  <title>317: Enabling GZIP compression in OpenCart 1.5 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/opencart/317-enabling-gzip-compression-in-opencart" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:ab0cc508f936ffa14c4078916c1df552 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '5.189.162.27']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															317: Enabling GZIP compression in OpenCart 1.5									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>14,153</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Feb 2, 2012'><span style='color:#606060;'>Published:</span> Apr 20, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<p>OpenCart comes with the ability to enable <a href="/support/website/general-server-setup/how-to-enable-gzip-moddeflate">GZIP compression</a>. GZIP compression helps your pages load faster by compressing them when they are sent to the web browser to be rendered. When using the <a href="https://developers.google.com/pagespeed/">Google Page Speed tool</a>, they recommend using compression. GZIP compression can be enabled through your OpenCart dashboard.</p>
<p class="”alert”">We do not recommend using compression unless you are on a VPS or dedicated server since enabling GZIP compression increases your server resource usage.</p>
...
<li>Select your store by clicking “<strong>Edit</strong>” next to it</li>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/opencart/opencart_gzip_1.jpg"><img  alt="opencart_gzip_1" src="//cdn.inmotionhosting.com/support/images/stories/opencart/opencart_gzip_1.jpg" /></a></p>
<li>Go to the “<strong>Server</strong>” Tab</li>
<li>Go to “<strong>Output Compression Level</strong>” and set the value between 0-9 <em>(typically 4 – 6 is recommended)</em></li>
<p><em><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/opencart/opencart_gzip_2.jpg"><img  alt="opencart_gzip_2" src="//cdn.inmotionhosting.com/support/images/stories/opencart/opencart_gzip_2.jpg" /></a></em></p>
...
<p>If you need further assistance please feel free to <a href="/support/community-support">ask a question on our support center</a>.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 42: 317: Enabling GZIP compression in OpenCart 1.5</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 41: <a href='/support/edu/opencart/318-using-web-browser-caching-in-opencart'>318: Using web browser caching in OpenCart 1.5</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 43: <a href='/support/edu/opencart/324-removing-the-product-count-to-speed-up-opencart'>324: Removing the Product Count to speed up OpenCart 1.5</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/opencart/317-enabling-gzip-compression-in-opencart&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/opencart/317-enabling-gzip-compression-in-opencart'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD04OCZpZD0yMzUwJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="1d56c0eabac2297c2b8512644631bf16" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/20cdccdcdbe2a28c63b9240c9222efe7?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/20cdccdcdbe2a28c63b9240c9222efe7'>ramesh</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-05 9:30 am</div>
				                <div><p>I kept same above what you said but not working Gzip Compression</p>
<p>thanks &amp; Regards</p>
<p>Ramesh</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12368);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-06 1:55 am</div>
				                <div>Hello ramesh<br />
<br />
How are you testing to see if the Gzip compression has been successfully enabled? As mentioned in our &lt;a href=&quot;http://www.inmotionhosting.com/support/website/what-is/how-to-enable-gzip-moddeflate&quot; target=&quot;_blank&quot;&gt;an introduction to Gzip and mod_deflate&lt;/a&gt; guide you can use this site:<br />
<br />
&lt;a href=&quot;http://www.whatsmyip.org/http-compression-test/&quot; target=&quot;_blank&quot;&gt;http://www.whatsmyip.org/http-compression-test/&lt;/a&gt;<br />
<br />
As also mentioned in that guide you can also enable Gzip compress in your &lt;span style=&quot;color: red;&quot;&gt;.htaccess&lt;/span&gt; file with this:<br />
<br />
&lt;pre class=&quot;code_block&quot; style=&quot;width: 496px; margin: -10px 0px -30px 0px; line-height: .9em&quot;&gt;&amp;lt;IfModule mod_deflate.c&amp;gt;<br />
...
<br />
- Jacob</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12378);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-17344'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/c3f10f08f29e6bb5cbeeca59acf40629?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/c3f10f08f29e6bb5cbeeca59acf40629'>Danigar</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-12 1:35 pm</div>
				                <div><p>I did this but only HTML files are compressed. Doesn't work for .css or .js files.</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17344);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-12 2:37 pm</div>
				                <div>Hello Danigar,<br />
<br />
Sorry for the problem with Gzip.  Try adding the following code under your the "AddOutputFilterByType" lines:<br />
<br />
<filesMatch "\.(js|css)$"><br />
Header set Content-Encoding x-deflate<br />
# Header set Content-Encoding compress<br />
# Header set Content-Encoding x-gzip<br />
</filesMatch><br />
<br />
You can find this solution discussed <a href="http://stackoverflow.com/questions/7704624/how-can-i-use-gzip-compression-for-css-and-js-files-on-my-websites" rel="nofollow" target="_blank">here</a>.  They discuss several alternatives if this option does not work. <br />
<br />
Hope that helps to resolve your problem! <br />
<br />
Regards,<br />
Arnel C.<br />
</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17346);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-13 7:02 pm</div>
				                <div><p>Thanks for that link Arn, I've tried what they say there but, it still won't work. I supose there's something on the apache configuration that should be tweaked, but being a shared hosting I don't have access to it.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17407);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-13 7:11 pm</div>
				                <div>Hello Danigar,<br />
<br />
Thank you for contacting us. This setting should work on our servers, but I was unable to locate an account with us to confirm.<br />
<br />
You can check that gzip is enabled by looking in  your <a href="http://www.inmotionhosting.com/support/website/php/create-phpinfo-page-to-see-php-settings">phpinfo</a> page.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17408);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-24944'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/c3ee6ff073ce6545af7d4b3ffa09bd0b?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/c3ee6ff073ce6545af7d4b3ffa09bd0b'>dimasagung</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-16 12:22 pm</div>
				                <div><p>I have tried this, thanks for the sharing about opencart.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24944);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
