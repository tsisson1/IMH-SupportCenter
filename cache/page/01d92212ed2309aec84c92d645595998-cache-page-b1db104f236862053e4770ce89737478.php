<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:53131:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/email-troubleshooting/outlook-2013-inbox-empty" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, Sorry to hear your emails are not showing. Microsoft pushed out an update to Outlook 2013 &amp; Office365 on 11/13/2013, that affected many users. He..." />
  <title>My Inbox on Outlook 2013 is empty and not showing emails | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/email-troubleshooting/outlook-2013-inbox-empty" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:0e5e68e5b390da8d18ebb79b13a665e1 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '174.67.113.14']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>My Inbox on Outlook 2013 is empty and not showing emails</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-11-15 12:21 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>69,437</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>When I booted my PC yesterday my inbox on Outlook 2013 is empty and not populating. I am using IMAP. On another PC with Lookout 2013 it loads fine. The subfolders populate OK it is just the Inbox. I have tried removing and adding the account back using the instructions for IMAP and SSL.<br />
<br />
I can send mail fine.</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_4230' id='upvote_answer_4230' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='4230' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_4230').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_4230' id='downvote_answer_4230' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='4230' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_4230').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
Sorry to hear your emails are <strong>not showing</strong>. Microsoft pushed out an update to <strong>Outlook 2013</strong> & Office365 on 11/13/2013, that affected many users. Here is a link to the <a href="http://social.technet.microsoft.com/Forums/windows/en-US/482b353f-eaa9-4367-989f-47b66e361cca/outlook-2013-fails-after-latest-ms-updates-nov-13th-2013?forum=officeitpro" target="_blank" >Official Microsoft forum</a>, where they are discussing the problem and solution.<br />
<br />
It has been reported by some customers that this will help:<br />
<h2 style="margin-bottom:0">Displaying Folder Hierarchy in Outlook</h2><ol class="article_list" style="margin-top:0"><br />
<li>Under the "<em>Folder</em>" tab, right of the "<em>Favorites</em>" tab, click "<strong>IMAP Folders</strong>"</li><br />
<li>Outlook should open a dialog box with IMAP folders. There is a checkbox that says, "<em>When displaying hierarchy in outlook, show only the subscribed folders</em>." That should be <strong>unchecked</strong>, then force a <strong>send/receive</strong> and it should immediately start downloading the inbox files.</li></ol><br />
If your problems persist, I recommend reading our full guide on the <a href="http://www.inmotionhosting.com/support/news/general/imap-issues-affecting-outlook-2013-and-office-365-functionality">Outlook 2013 & Office365 issues</a>. It provides additional solutions such as uninstalling the recent updates (KB2837618 or KB2837643), or Changing the root folder path. <br />
<br />
It may also be helpful posting/reviewing <a href="http://social.technet.microsoft.com/Forums/windows/en-US/482b353f-eaa9-4367-989f-47b66e361cca/outlook-2013-fails-after-latest-ms-updates-nov-13th-2013?forum=officeitpro" target="_blank" >Microsoft's forum</a> for a solution.<br />
<br />
...
-John-Paul
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_4230').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_4230' id='form_comment_on_answer_4230' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Worked for me too, thanks for the help. (using office 365)</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='http://graph.facebook.com/david.beam.16/picture?type=normal' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/David&per;B'>David.B</a><br />
									3 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2013-11-19 10:39 am EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Worked perfectly! Thanks!</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='/support/images/avatars/default_avatar.jpg' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/trinit77'>trinit77</a><br />
									3 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2015-08-10 3:54 pm EST
								</div>
...
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/email-troubleshooting/outlook-2013-inbox-empty'></div>
<script type='text/javascript'>
  (function() {
