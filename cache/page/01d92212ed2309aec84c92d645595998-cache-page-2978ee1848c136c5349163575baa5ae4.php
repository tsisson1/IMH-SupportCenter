<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:68779:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/whm/creating-and-managing-accounts/create-a-package-within-whm" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-12-19T00:10:10-08:00" />
  <meta name="keywords" content="create cpanel package whm" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="Similar to how InMotion Hosting has a Power plan that offers 26 parked domains, you can create cPanel packages to make it easier to create and manage cPanel accounts." />
  <title>How to Create a Package within WHM - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/whm/creating-and-managing-accounts/create-a-package-within-whm" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:57d885a8ab763bb844c5820ca173a9ac -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to Create a Package within WHM									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>13,820</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Nov 16, 2011'><span style='color:#606060;'>Published:</span> Dec 19, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<iframe width="675" height="380" src="//www.youtube.com/embed/VSeBUYWTIcI?list=PLz91o-yiaKWr-SVrwNM_n3_SmzxQCwvec" frameborder="0" allowfullscreen></iframe>

<p class="alert" style="color:#9d7734">This article pertains to WHM, a feature only available to <a href="http://www.inmotionhosting.com/vps_hosting.html" target="_blank">VPS Hosting</a>, <a href="http://www.inmotionhosting.com/dedicated_servers.html" target="_blank">Dedicated Hosting</a>, and <a href="http://www.inmotionhosting.com/reseller-hosting" target="_blank" >Reseller Hosting</a> users. <a href="http://www.inmotionhosting.com/hostingplans.html" target="_blank">Shared Hosting</a> users do not have WHM access.Visit our page for more information on <a href="http://www.inmotionhosting.com/shared-cpanel-hosting">Shared cPanel Hosting</a>.</p>
<p>A package specifies several different values for a cPanel account. For example, you could offer a "power" package that includes 5 addon domains while you have a "pro" package that includes 16 addon domains. When creating new cPanel accounts, you can assign specific packages to each cPanel account. This helps to not only speed up the cPanel account creation process, but it also helps with updating several accounts at once. If you have 20 accounts on one package, modifying a setting for the package itself will apply the setting to all accounts assigned to that package.</p>
<h2>To create a package:</h2>
<div class="white_box">
<ol>
<li><a href="/support/edu/whm/creating-and-managing-accounts/log-into-whm">Log into your WHM</a></li>
<li>Click "Add a Package" under the "Packages" heading in the left menu<br /><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/whm-edu/creating-a-package/to-create-a-new-cpanel-package-click-add-a-package-under-packages.gif"><img  alt="to-create-a-new-cpanel-package-click-add-a-package-under-packages" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/whm-edu/creating-a-package/to-create-a-new-cpanel-package-click-add-a-package-under-packages.gif" /></a></li>
<li>On the following page:            
<ul>
<li><strong>Specify a package name</strong></li>
<li><strong>Resources</strong> 
<ul>
<li>Define how many of each item the package offers. Enter "unlimited" (without the quotes) to allow an unlimited number, 0 to not allow any, or a specific number.<br /><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/whm-edu/creating-a-package/an_example_power_plan_package_setup_in_whm.gif"><img  alt="an_example_power_plan_package_setup_in_whm" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/whm-edu/creating-a-package/an_example_power_plan_package_setup_in_whm.gif" /></a></li>
</ul>
</li>
...
<li>Dedicated IP                                             
<ul>
<li>If you have any available dedicated IP addresses on your server and you would like this package to include a dedicated IP address, select that option.</li>
</ul>
</li>
<li>Select Options                                             
<ul>
<li>Decide whether or not this account should have ssh access, Frontpage Extensions installed by default, and if they should have CGI Access.</li>
</ul>
</li>
<li>cPanel Theme                                             
<ul>
<li>Choose the cPanel theme to use. InMotion Hosting currently users x3.</li>
</ul>
</li>
<li>Feature List                                             
<ul>
<li>Select which feature list to assign to the account. Feature lists specify which cPanel features are available to the user, and are managed within the "Feature Manager" in WHM.</li>
</ul>
</li>
<li>Locale                                             
<ul>
<li>Select which language to assign to the cPanel accounts</li>
</ul>
</li>
</ul>
</li>
 ...
 <br>
  When complete, click "<strong>Add</strong>" at the bottom of the page to create the package.<br /><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/whm-edu/creating-a-package/add-a-package-success-page-within-whm.gif"><img  alt="add-a-package-success-page-within-whm" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/whm-edu/creating-a-package/add-a-package-success-page-within-whm.gif" /></a> </ol></div><br>
Congratulations, now you know how to create a cPanel package within WHM! 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 5: How to Create a Package within WHM</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 6: <a href='/support/edu/whm/creating-and-managing-accounts/feature-lists'>How to Work with Feature Lists in WHM</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/whm/creating-and-managing-accounts/create-a-package-within-whm&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/whm/creating-and-managing-accounts/create-a-package-within-whm'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xNDkmaWQ9MTA3NyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="ddbea4f0c435c41dab82a7269eda2c17" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/16e7601f5b6d006ad1a8f30c31431420?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/16e7601f5b6d006ad1a8f30c31431420'>Elmer</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-19 5:37 am</div>
				                <div><p>I am interested in reseller hosting. If i avail R-2000S package what will be the price per month after one year if i plan to renew my subscription. Secondly can I make orders (as if I am a customer) such as web hosting package within my reseller account but without having to pay since i have full control of the disk space, cpanel etc. under my reseller account? Is weebly sitebuilder tool already present in the cpanel under the reseller account?</p>
<p>&nbsp;Hope to hear from you soon&nbsp;</p>
<p>&nbsp;</p>
<p>Elmer</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25895);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-19 12:20 pm</div>
				                <div>Hello Elmer,<br />
<br />
I believe you asked this question earlier.  If you're using a VPS account, that's a lot different from a reseller account.  With root access you have full control of the account and how you can build cPanel accounts you could assign to your customers.  Also, VPS accounts don't have the billing system built in, so you would need to provide that on your own.  The place to get answers for questions like this is to speak with our sales team.  They can explain how all the different packages work.  <br />
<br />
...
<br />
						...
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25908);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-31999'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/6dac6cf74ed8b2f3aa138f0aa31381a2?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/6dac6cf74ed8b2f3aa138f0aa31381a2'>Ruben</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-16 5:36 am</div>
				                <div><p>How can give a package to a new user &nbsp;?&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31999);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-18 7:31 am</div>
				                <div>You will need to <a href="http://www.inmotionhosting.com/support/edu/whm/creating-and-managing-accounts/modify-an-account">modify the account</a> and assign the package to it.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32017);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
