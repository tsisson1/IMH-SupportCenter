<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:56952:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/email-troubleshooting/trouble-setting-up-send-mail-as-in-gmail" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Carl1950, It seems that others were experiencing this issue as well and followed the steps in this forum thread. Best Regards, TJ Edens..." />
  <title>Trouble setting up &quot;Send mail as&quot; in GMail | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/email-troubleshooting/trouble-setting-up-send-mail-as-in-gmail" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:9c5bbab1d38a204450c7f2c377166c31 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '185.101.236.34']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Trouble setting up &quot;Send mail as&quot; in GMail</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/carl1950'>carl1950</a>
			<div>14 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-05-26 4:39 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>3,431</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I am trying to set up one of my GMail accounts to &quot;send mail as&quot; using the gmail account I have on inmotion and keep getting an error<br />
Here is the situation:<br />
- I have Google Apps set up on my website: &quot;mychurch.org&quot;,; hosted on inmotion and everything is working fine. Within GMail I have set up my email &quot;me@mychurch.org&quot; to forward to another GMail account I have &quot;me@myname.com&quot;.  The forwarding works fine.<br />
- I am encountering troubles when go into &quot;me@myname.com&quot; and try and set up &quot;me@mychurch.org&quot; using the &quot;Send mail as&quot; (under GMail&gt;Settings&gt;Accounts)<br />
- I have successfully done this with other gmail accounts and it works fine; however when I try to set my &quot;me@mychurch.org&quot; I encounter an error<br />
The steps I follow from GMail&gt;Settings&gt;Accounts<br />
1. Click &quot;Add another email address you own&quot;<br />
2. Enter my name and email address in the next window and click &quot;Next&quot;<br />
3. In the next window , enter<br />
SMTP Server: mail.mychurch.org Port 587<br />
Username: me@mychurch.org<br />
Password: mypassword<br />
and click &quot;Add accountt&quot;<br />
- I get the following error message: &quot;Your other email provider is responding too slowly. Please try again later, or contact the administrator of your other domain for further information.&quot;<br />
<br />
Is there something I am doing incorrectly?  Is it possible to do this?<br />
</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_7323' id='upvote_answer_7323' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='7323' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_7323').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_7323' id='downvote_answer_7323' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='7323' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_7323').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Carl1950,<br />
<br />
It seems that others were experiencing this issue as well and followed the steps in <a href="https://productforums.google.com/forum/#!topic/gmail/JtEDbVkSWQo">this forum thread</a>.<br />
<br />
Best Regards,<br />
TJ Edens
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_7323').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_7323' id='form_comment_on_answer_7323' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Thanks TJ - I tried some of the solutions offered there: ulocked Captcha, went to my Gmail admin and made sure &quot;allow per-user outbound gateways&quot; was checked.  <br />
<br />
Do I need to change the Port setting?  <br />
<br />
Other suggestions?</div>
							...
							<td style='width:96px;' valign='top'>
								...
								<div class='smallgrey'>
									<a href='/support/community-support/users/carl1950'>carl1950</a><br />
									14 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2015-05-27 4:05 pm EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello Carl1950,<br />
<br />
Apologies for the continued problem.  We unfortunately can only suggest the offered in the other support forum, as this issue is within the Gmail interface for which we provide very limited support.  We are unable to determine mail settings because you're using generic names, so you may want to verify your mail server settings.  Port 587 is our generic non-SSL outgoing mail port.  Check the domain that you're using and see what port is recommended.  You may want to review mail settings for that specific domain if that is the only one giving you trouble.  It may not be set to send mail remotely or other settings may prohibit how it reacts to the settings you're trying to use.<br />
<br />
Apologies again that we can't give you a direct or specific answer in this issue.  You may also want to consult with Google's support information on this particular issue.<br />
<br />
...
Arnel C.</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Arn,<br />
I used generic names in my post because the instructions said to not post information like email addresses.  I am attempting use my email carl@franzons.com to &quot;send mail as&quot; carl@fruitlandcovenant.org  (which is hosted on inmotion)<br />
<br />
 When I have done research in the Google forums, the solution most often involves an issue in the server setup which is why I posted my question here.  <br />
<br />
Looking at it a little more, one of the possible issues is that I am being asked to input info for an SSL connection; from your product support forum (http://www.inmotionhosting.com/support/email/email-troubleshooting/problems-sending-mail-receiving-is-fine), it appears that for outgoing SMTP I should have the following:<br />
Outgoing Server secure##.inmotionhosting.com on Port 465  where ## is my server number from account technical details <br />
User: my email<br />
Password; my password<br />
<br />
When I enter that in the gmail interface I get &quot;Authentication failed. Please check your username/password.<br />
[Server response: 535 Incorrect authentication data code(535) ]&quot;<br />
<br />
</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>More searching through forums and I found a solution that seems to have worked: use smtp.gmail.com for the outgoing server<br />
<br />
Thanks !</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/email-troubleshooting/trouble-setting-up-send-mail-as-in-gmail&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/email-troubleshooting/trouble-setting-up-send-mail-as-in-gmail'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="e2a6a172368c68cfaff0050d0f00f7ae" value="1" />	</div>
	</form>
<!-- <br />
