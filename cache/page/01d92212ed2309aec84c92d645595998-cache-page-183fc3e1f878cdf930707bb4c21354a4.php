<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:60778:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/wordpress/get-the-excerpt-wordpress-function" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-09-02T21:32:36-07:00" />
  <meta name="author" content="Jeff Matson" />
  <meta name="description" content="In this article, we will introduce you to the get_the_excerpt() WordPress function." />
  <title>The get_the_excerpt() WordPress function - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/wordpress/get-the-excerpt-wordpress-function" rel="canonical" />
...
<script>
  ...
  ga('send', 'pageview');
	...
	<!-- cid:a6f2a71770053515a97e4a8cdcb407ea -->
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>The get_the_excerpt() WordPress function</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															The get_the_excerpt() WordPress function									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>1,240</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jun 30, 2014'><span style='color:#606060;'>Published:</span> Sep 2, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Built within WordPress, is the ability to add excerpts to your posts.  Of course, these excerpts will not do you any good if you cannot display them on your WordPress site.  In this article, we will show you the <em>get_the_excerpt()</em> function that you can use within your themes or plugins to display the post excerpt.</p>
...
<h2>Basic usage</h2>
<p class="code_block">&lt;?php $excerpt = get_the_excerpt() ?&gt;</p>
<p>In this example, we simply get the excerpt using the <em>get_the_excerpt()</em> function, and assign it to the <em>$excerpt</em> variable.</p>
<p>Now that the variable contains the excerpt of the post, we can now display it like this:</p>
<p class="code_block">&lt;?php echo $excerpt; ?&gt;</p>
<h2>What if I don't have an excerpt defined?</h2>
<p>If an excerpt is not defined within the post, the <em>wp_trim_excerpt()</em> function will be used on the post content so that an excerpt is still displayed.</p>
<p>For more information on the <em>wp_trim_excerpt()</em> function, take a look at the <a href="http://codex.wordpress.org/Function_Reference/wp_trim_excerpt" target="_blank"><em>wp_trim_excerpt()</em> WordPress Codex page</a>.</p>
<h2>References</h2>
<p>For the full, official documentation on the <em>get_the_excerpt()</em> function, take a look at the <a href="http://codex.wordpress.org/Function_Reference/get_the_excerpt" target="_blank"><em>get_the_excerpt()</em> WordPress Codex page</a>.</p>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/wordpress/get-the-excerpt-wordpress-function&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/wordpress/get-the-excerpt-wordpress-function'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD02MyZpZD0zMzMxJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
