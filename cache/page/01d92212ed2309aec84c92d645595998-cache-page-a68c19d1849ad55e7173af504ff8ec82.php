<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:54307:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/email-troubleshooting/550verification-error" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hi blainemtntech, Thanks for posting your question. I'm happy to assist you today. We're reviewing the settings and possible causes now. As soon as I ha..." />
  <title>550-Verification Error | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/email-troubleshooting/550verification-error" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:284fb82298698210b9cf1d93a3fc6f2d -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>550-Verification Error</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/blainemtntech'>blainemtntech</a>
			<div>19 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-04-06 12:16 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>3,796</span>
			</div>
...
<br />
One of my clients just informed me that they are unable to send me emails from their account.  It worked up until last night.  I also have an email account on their domain and am having the same problem.  Here is the response that I'm getting.<br />
<br />
...
<br />
  nick@blainemountaintech.com<br />
    SMTP error from remote mail server after RCPT TO::<br />
    host blainemountaintech.com [74.124.194.209]:<br />
    550-Verification failed for nick@flatheadtravel.com<br />
    550-No Such User Here<br />
    550 Sender verify failed<br />
<br />
Please advise and let me know what I can do.  Or if it is on their end I can deal with their host.<br />
<br />
FYI, they are not having any issues sending emails among themselves, or to other domains... Just mine.<br />
<br />
Thanks!!<br />
Nick<br />
<br />
EDIT:  I just realized that the other email address didn't post when I pasted the rest of the information.. added &quot;550-Verification failed for nick@flatheadtravel.com&quot;</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_848' id='upvote_answer_848' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='848' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_848').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_848' id='downvote_answer_848' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='848' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_848').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hi blainemtntech,<br />
<br />
Thanks for posting your question. After looking into this for you we have determined the issue to be with local/remote domains. It appears you do not host the domain "flatheadtravel.com" on your account, when I look it up however you have it listed in cPanel.<br />
<br />
So when you try to send an email, it tries to deliver it locally, since it thinks the domain resides on the same server. This can be fixed by changing the settings in the MX records option in cPanel from "automatic" to "remote".<br />
<br />
...
Tim S
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_848').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_848' id='form_comment_on_answer_848' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
...
<div class='  not_best_answer'>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px; width:50px;' valign='top'>
<div class='vote_div'>
	<form method='post' name='upvote_answer_847' id='upvote_answer_847' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='847' />
		<input type='hidden' name='component' id='component' value='qa' />
		<input type='hidden' name='vote_value' id='vote_value' value='1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_847').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_847' id='downvote_answer_847' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='847' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_847').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hi blainemtntech,<br />
<br />
Thanks for posting your question. I'm happy to assist you today. We're reviewing the settings and possible causes now. As soon as I have more information to provide you, I'll let you know by posting here. <br />
<br />
...
Tim S
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_847').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_847' id='form_comment_on_answer_847' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
					                <p>You must <a href='/support/login'>login</a> before you can post a comment about this answer.</p>
					        </div></div></div></div>
					</form>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/email-troubleshooting/550verification-error&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/email-troubleshooting/550verification-error'></div>
<script type='text/javascript'>
  (function() {
