<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:54901:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/website/how-to-disable-webmail-redirection" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, As Jeff had mentioned, unfortunately due to the way the /webmail re-direction is handled at the server-wide Apache level you can't have this forw..." />
  <title>How to disable /webmail redirection | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/website/how-to-disable-webmail-redirection" rel="canonical" />
...
<script>
  ...
  ga('send', 'pageview');
	...
	<!-- cid:c8bc387857ec5b5fef319ce9b3c8e1ab -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>How to disable /webmail redirection</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='http://graph.facebook.com/m.2santos/picture?type=normal' class='user_avatar' /><br />
			<a href='/support/community-support/users/santosm'>santosm</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2014-01-02 4:12 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>1,427</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I have a new domain that I have just added to my hosting plan.  In that website, we had a folder to access email through a webmail portal hosted elsewhere.  Within the folder, we have an index.html file that does an automatic redirect to the proper portal.  Our users used to access the webmail portal through:<br />
<br />
www.domain.tld/webmail<br />
<br />
Since witching the domain hosting to here, users are no longer able to access the old webmail portal through that address, which we would like to maintain.  Instead, they get re-directed to the InMotioHosting webmail portal.<br />
<br />
I have looked through the cPanel settings and have added a redirection in one of the settings, but have had no success.  I've also searched through the support forums, and have tried adding redirection in the .htaccess file.<br />
<br />
Can you please tell me how to turn off the automatic redirection of /webmail so that I can implement my own?<br />
<br />
Many thanks.<br />
</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_4377' id='upvote_answer_4377' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='4377' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_4377').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_4377' id='downvote_answer_4377' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='4377' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_4377').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>11,186 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2014-01-02 4:29 pm EST
                		        </div>
					
		                </div>

				This is not something that would be possible within a shared hosting environment as the configuration would effect all users, however, within a VPS or dedicated server, it can indeed be done.  If on a VPS or dedicated server, you may simply &lt;a href=&quot;http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support&quot;&gt;submit a ticket with support&lt;/a&gt; in which these changes could be made.  <br />
<br />
If you are currently on shared hosting and need to upgrade your account, you may complete the &lt;a href=&quot;http://www.inmotionhosting.com/support/website/amp/upgrade-downgrade-hosting-plan&quot;&gt;upgrade process via AMP&lt;/a&gt;.
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_4377').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_4377' id='form_comment_on_answer_4377' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
...
<div class='  not_best_answer'>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px; width:50px;' valign='top'>
<div class='vote_div'>
	<form method='post' name='upvote_answer_4379' id='upvote_answer_4379' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='4379' />
		<input type='hidden' name='component' id='component' value='qa' />
		<input type='hidden' name='vote_value' id='vote_value' value='1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_4379').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_4379' id='downvote_answer_4379' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='4379' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_4379').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
As Jeff had mentioned, unfortunately due to the way the &lt;strong&gt;/webmail&lt;/strong&gt; re-direction is handled at the server-wide Apache level you can't have this forwarded off to another service.<br />
<br />
If you have a physical &lt;strong&gt;/webmail&lt;/strong&gt; folder with a &lt;strong&gt;index.html&lt;/strong&gt; file inside it, you can still go directly there to trigger the redirection:<br />
<br />
&lt;pre class=&quot;code_block&quot; style=&quot;width: 500px; white-space: normal; margin-bottom: -30px;&quot;&gt;www.domain.tld/webmail/index.html&lt;/pre&gt;<br />
<br />
You could also setup a &lt;a href=&quot;http://www.inmotionhosting.com/support/website/redirects/setting-up-a-301-permanent-redirect-via-htaccess&quot; target=&quot;_blank&quot;&gt;301 redirect&lt;/a&gt; to redirect the URL to the correct web portal so they don't have to enter &lt;strong&gt;index.html&lt;/strong&gt;. For instance if you're using &lt;strong&gt;gmail.com&lt;/strong&gt; as your webmail portal, the following &lt;strong&gt;.htaccess&lt;/strong&gt; code would work:<br />
<br />
&lt;pre class=&quot;code_block&quot; style=&quot;width: 500px; white-space: normal; margin-bottom: -30px;&quot;&gt;Redirect 301 /webmail/go http://gmail.com&lt;/pre&gt; <br />
<br />
Then if you typed in &lt;pre class=&quot;code_block&quot; style=&quot;width: 500px; white-space: normal; margin-bottom: -30px;&quot;&gt;www.domain.tld/webmail/go&lt;/pre&gt;<br />
<br />
You'd get redirected to the URL you set it up to go to, in this case &lt;strong&gt;gmail.com&lt;/strong&gt;.<br />
<br />
That's unfortunately the only thing I can think about, other than being on a VPS or dedicated server, where the global &lt;strong&gt;/webmail&lt;/strong&gt; rewrite can be turned off for you.<br />
<br />
- Jacob
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_4379').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_4379' id='form_comment_on_answer_4379' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
					                <p>You must <a href='/support/login'>login</a> before you can post a comment about this answer.</p>
					        </div></div></div></div>
					</form>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/website/how-to-disable-webmail-redirection&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/website/how-to-disable-webmail-redirection'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="c95f7b34b200f3b51243fb1871699681" value="1" />	</div>
	</form>
<!-- <br />
