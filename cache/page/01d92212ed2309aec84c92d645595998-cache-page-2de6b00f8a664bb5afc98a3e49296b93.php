<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:51678:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/prestashop-15/prestashop-footer-links-problem" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Bruce, I see what you mean. There is some 'Lorem ipsum' style default text at the bottom of your site. I did some checking and that text is nowher..." />
  <title>Prestashop Footer Links Problem | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/prestashop-15/prestashop-footer-links-problem" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:8001791f659743b29421575f21d668f9 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '185.78.64.5']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box straight_bottom'>
                <h1 style='font-size:26px;'>Prestashop Footer Links Problem</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2014-06-27 12:22 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>673</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>http://pawsandclawspetsupply.com/prestashop/index.php ( This is my home page)<br />
My email:  heartlandpetproducts@gmail.com<br />
Please note that in my footer there are footer links and in three different languages.  No change I try to make has any effect on the website footer.  I have read all the training on footer blocks and such and have had no luck in being able to edit the footer in any way.<br />
<br />
Please advise.<br />
<br />
Bruce</div>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px;'>
				<div style='font-size:12px; max-width:500px; overflow:auto;'>Note also that I have read y.our articles on changing Contact Info, Links.....etc.  No attempt to edit has any effect whatsoever</div>
...
<div style='padding:15px; border:1px solid #d6d6d6; border-top:0px; background:#ebebeb;' class='round_bottom' >
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px;'>
				<div style='font-size:12px; max-width:500px; overflow:auto;'>Scott,<br />
<br />
Thanks,<br />
<br />
I see what you mean.  I went to the Static Block and cleared the footer.<br />
<br />
Please see:  http://www.hostknox.com/tutorials/prestashop/footer-links<br />
The way to put links in the footer is covered here.  Using the CMS Block is the way to do it.  In my case, no changes I try to make within that block appear in the footer.  Something is wrong.  Do you know what is going on?<br />
<br />
Bruce</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_5175' id='upvote_answer_5175' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='5175' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_5175').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_5175' id='downvote_answer_5175' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='5175' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_5175').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Bruce,<br />
<br />
I see what you mean. There is some 'Lorem ipsum' style default text at the bottom of your site. I did some checking and that text is nowhere in the database. I then did a string search through the files and it showed up in reference to one module, static blocks. I checked and that module is indeed enabled in your site. Disabling it removed all the footer information, so that confirms it is the correct module. It has been re-enabled of course.<br />
<br />
To edit the information, click on Configure for the Static Block module. It is not obvious at all (no edit button anywhere) but just click on the row you want to edit. In this case it is the third row (CMS footer page). Clicking on the row anywhere will open up the edit page. There you will see all the default information so you can edit it to your liking.<br />
<br />
Kindest Regards,<br />
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_5175').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_5175' id='form_comment_on_answer_5175' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/prestashop-15/prestashop-footer-links-problem&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/prestashop-15/prestashop-footer-links-problem'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="b6f58f1cd2305cd0aaab30cb6637d8df" value="1" />	</div>
	</form>
<!-- <br />
