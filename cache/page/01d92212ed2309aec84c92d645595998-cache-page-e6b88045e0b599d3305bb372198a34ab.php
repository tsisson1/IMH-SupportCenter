<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:70065:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/opencart/unable-to-access-error-logs" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello ArkenSeal, I was able to login and look at your Admin. First, the option to display errors was NOT enabled. You had to select &quot;YES&quot; in order to se..." />
  <title>Unable to access Error logs | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/opencart/unable-to-access-error-logs" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:cef90cb88b3efec212e2fa38da73782f -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '199.36.7.6']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Unable to access Error logs</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/ArkenSeal'>ArkenSeal</a>
			<div>87 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2014-10-13 4:39 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>657</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I am unable to access the error logs in the administration panel of Opencart.<br />
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_5776' id='upvote_answer_5776' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='5776' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_5776').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_5776' id='downvote_answer_5776' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='5776' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_5776').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello ArkenSeal,<br />
<br />
Thank you for your question. First, would make sure <a href="http://www.inmotionhosting.com/support/edu/opencart/316-working-with-error-reporting-in-opencart">error logging is set to <strong>Yes</strong></a> in the dashboard.<br />
<br />
What happens when you attempt to view the error logs? Is it blank, or is the page not loading?<br />
<br />
...
John-Paul
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_5776').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_5776' id='form_comment_on_answer_5776' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello John-Paul,<br />
Thank you for trying to help.<br />
The error logging is set to Yes in the dashboard. <br />
When I try to view the error logs, I have a blank page with the following :<br />
https://www.example.com/admin/index.php?route=tool/error_log&amp;token=f0572c13d0c8f70687d6380bd08f9202<br />
I don't know if it has something to do with this but I have tried some changes in the modules and banners lately.<br />
Arkenseal<br />
</div>
							...
							<td style='width:96px;' valign='top'>
								...
								<div class='smallgrey'>
									<a href='/support/community-support/users/ArkenSeal'>ArkenSeal</a><br />
									87 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2014-10-13 11:15 am EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Using the cPanel File Manager, do you have any logs located within /system/logs?  You may simply be seeing a blank page because no errors exist to be logged.</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello Jeff,<br />
There are two files:<br />
 /public_html/system/logs/error.txt       (6.06 KB) <br />
/public_html/system/logs/index.html    (0bytes).<br />
Thank you,<br />
Arkenseal</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello ArkenSeal,<br />
<br />
First, you need to be sure you have the proper settings for the error log file to view. Also, is it simply a blank text box you are seeing? Or is the entire stab blanked out? Lastly, what version of OpenCart are you using?<br />
<br />
Kindest Regards,<br />
Scott M</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello Scott,<br />
I have OpenCart Version 1.5.6.1<br />
In the cPanel Error Log, which normaly should display the Last 300 Error Log Messages in reverse order does not display anything. It's just a a blank text box.<br />
What do you mean by  proper settings to view the error log file?<br />
Thanks<br />
Arkenseal<br />
<br />
<br />
...
<br />
That error log you are looking at is for cPanel. Those errors are separate from the ones in cPanel. To set those up properly, you will want to follow <a href="http://www.inmotionhosting.com/support/edu/opencart/316-working-with-error-reporting-in-opencart">these instructions</a>.<br />
<br />
Then to view them, log into your opencart dashboard, click System and then Error Log. You should then see the content of the error.txt file in your OpenCart structure.<br />
<br />
Kindest Regards,<br />
Scott M</div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello ArkenSeal,<br />
<br />
Scott is referring to the settings within the Admin dashboard under Settings>Server> area.  The setting needs to allow the display and logging of errors.  Additionally, the error log name should be listed.  If these values are not listed, then the error log will not display correctly.  <br />
<br />
If the log is blank, it will not show any errors.   I actually have a test  account running  OpenCart 1.56 and I don't see any errors.  Were you expecting a bunch of errors to appear?<br />
<br />
Regards,<br />
Arnel C.</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello Arnel,<br />
The settings within the Admin dashboard under Settings&gt;Server&gt; area are OK. <br />
I still don't understand why I could view the log file (error.txt) using cPanel (/public_html/system/logs/error.txt) but not in the Admin dashboard under system&gt;Error Logs ?<br />
I had some issues trying to make some changes in the modules and banners lately.<br />
Thanks<br />
Arkenseal</div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello ArkenSeal,<br />
<br />
I was comparing my site to yours, but the problem is that we can't see into your administrator.  Is there anyway you can temporarily provide us credentials to see what's happening?  I also tried to clear my list and see if there would be any remaining errors.  However, the errors I had on my list (I had like 3) were cleared out.  So now the error.txt file is blank.  <br />
<br />
Can you make sure that your error log is specifically set to error.txt (all lower-case)?  I also ran a script to make sure your file permissions were okay.  Let us know if you have any luck seeing the log at this point.  If not, then we would like to temporarily be able to login to your admin so that we can investigate it further.<br />
<br />
Regards,<br />
Arnel C.</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello Arnel,<br />
Where do I have to send my credentials to login to my admin ?<br />
Regards<br />
Arkenseal</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>You may send them to docs@inmotionhosting.com with the subject line as your username here.  Let us know when you have sent them.</div>
...
Arkenseal</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Unfortunately, we are not seeing the email.  What email address did you send it from?  Could you send it again?</div>
...
<div class=' straight_bottom not_best_answer'>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px; width:50px;' valign='top'>
<div class='vote_div'>
	<form method='post' name='upvote_answer_5787' id='upvote_answer_5787' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='5787' />
		<input type='hidden' name='component' id='component' value='qa' />
		<input type='hidden' name='vote_value' id='vote_value' value='1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_5787').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_5787' id='downvote_answer_5787' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='5787' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_5787').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello ArkenSeal,<br />
<br />
I was able to login and look at your Admin.  First, the option to display errors was NOT enabled.  You had to select "YES" in order to see the errors displayed.  When I did this, it indicated that the error_log.tpl was missing.  I copied a copy of my error_log.tpl over to your installation and now the errors appear.  <br />
<br />
Not sure why that tpl file was missing, but it had either been deleted or replaced.  However, it should be working now.<br />
<br />
...
Arnel C.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_5787').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_5787' id='form_comment_on_answer_5787' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
					                <p>You must <a href='/support/login'>login</a> before you can post a comment about this answer.</p>
					        </div></div></div></div>
					</form>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello Arn,<br />
It is working fine now. Thank you.<br />
I really appreciate your help guys.<br />
Regards<br />
Arkenseal</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/opencart/unable-to-access-error-logs&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/opencart/unable-to-access-error-logs'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="9ad44717c75d1492d94b6e124af6cbc8" value="1" />	</div>
	</form>
<!-- <br />
