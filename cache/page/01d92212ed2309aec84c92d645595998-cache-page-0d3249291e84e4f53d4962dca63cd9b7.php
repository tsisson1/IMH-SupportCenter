<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50777:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/cpanel/mx-records" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hi stu, Thanks for posting your question. I'm more than happy to assist you today. What you're looking to accomplish can be achieved through DNS records..." />
  <title>MX records | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/cpanel/mx-records" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:a0ef53f603aa307e7c62c8926b06f5bf -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>MX records</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/stu'>stu</a>
			<div>18 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-04-17 10:11 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>1,563</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I've designed a new website and want to move it from another host to my space on In Motion Hosting, but I don't want to change the email route that is already in place. Is this possible? </div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_904' id='upvote_answer_904' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='904' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_904').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_904' id='downvote_answer_904' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='904' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_904').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hi stu,<br />
<br />
Thanks for posting your question. I'm more than happy to assist you today. What you're looking to accomplish can be achieved through DNS records. You can move the files over for the website, then at your current host point the A record to the IP address of the server your account is housed on here at InMotion.<br />
<br />
Alternatively, you can change the namerservers over to our nameservers, thus moving everthing over to InMotion. At the same time you can create MX records to point to your current mail provider. Here's a link on working with MX records:<br />
<br />
<a href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/how-do-i-make-custom-dns-records">How to work with DNS records</a><br />
<br />
...
Tim S
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_904').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_904' id='form_comment_on_answer_904' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/cpanel/mx-records&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/cpanel/mx-records'></div>
<script type='text/javascript'>
  (function() {
