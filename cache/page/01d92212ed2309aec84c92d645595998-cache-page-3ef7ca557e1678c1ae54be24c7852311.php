<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:72689:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/google-tools/tag-manager" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-01-15T22:09:28-08:00" />
  <meta name="keywords" content="google tag manager tutorial" />
  <meta name="author" content="John-Paul Briones" />
  <meta name="description" content="This is a guide on how to setup a Google Tag Manager Account." />
  <title>How to Setup Google Tag Manager - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/google-tools/tag-manager" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:be974ade1ef755a61876bedc8dea133f -->
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/website/google-tools' itemprop='url'><span itemprop='title'>Google Tools<span></a>
			<div class='dropdown_3columns' style='width:900px; margin-left:-250px;'>
				<div class='col_1' style='width:290px;'><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/google-tools/setting-a-crawl-delay-in-google-webmaster-tools'>Setting a Crawl Delay in Google Webmaster Tools</a> (19,652 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/google-tools/introduction-to-google-webmaster-tools'>Introduction to Google Webmaster Tools</a> (15,696 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/google-tools/chrome-analytics-debugger'>Debug Google Analytics with Google Analytics Debugger</a> (8,728 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/google-tools/creating-google-analytics-account'>Creating a Google Analytics Account </a> (5,473 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/google-tools/submitting-a-sitemap-to-google-using-webmaster-tools'>Submitting a Sitemap to Google using Webmaster Tools</a> (5,172 hits)</div></div>
				<div class='col_1' style='width:290px;'><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/google-tools/installing-google-analytics-on-your-website'>Installing Google Analytics on your Website</a> (19,482 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/google-tools/using-google-custom-404-page-widget'>Using Google's custom 404 page widget</a> (10,309 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/google-tools/verifying-your-website-with-google'>Verifying your website with Google</a> (8,592 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/google-tools/using-fetch-as-googlebot-in-webmaster-tools'>Using Fetch as Googlebot in Webmaster Tools</a> (5,427 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/google-tools/how-do-i-get-google-to-reconsider-crawling-my-site'>How do I get Google to reconsider crawling my site?</a> (4,671 hits)</div></div>
				<div class='col_1' style='width:290px;'><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/google-tools/what-is-a-xml-sitemap-and-how-do-i-create-one'>What is a XML sitemap and how do I create one?</a> (16,558 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/google-tools/google-safe-browsing-diagnostic-page'>More help with Google's Safe Browsing Diagnostic Page</a> (9,819 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/google-tools/how-to-remove-entire-webpage-from-google-search-webmaster-tools'>How to remove an entire webpage from Google Search with Webmaster Tools</a> (8,559 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/google-tools/blocked-loading-mixed-active-content'>Blocked loading mixed active content http://www.google.com/recaptcha/api/challenge?k=KEY</a> (5,366 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/google-tools/google-adwords-voucher-redemption'>Google AdWords Voucher Redemption</a> (3,257 hits)</div></div>
			</div>
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to Setup Google Tag Manager</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to Setup Google Tag Manager									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>2,112</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Dec 27, 2013'><span style='color:#606060;'>Published:</span> Jan 15, 2014</div>
  ...
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('create');">Create Account</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('container');">Add Container</button>
</div>

<p>When you are developing a website, <strong>Google Tag Manager</strong> can help you handle the many tags you are using. Tags are javascript files (typically used for tracking) that pull from separate 3rd party services, such as <em>Google Analytics</em>, <em>DoubleClick Floodlight Counter</em>, or <em>Adwords</em>. This can slow down site load times, since it must wait for a response from the 3rd party scripts before it can completely load your page. <br><br>

A <em>container</em> tag is placed on each page of your website, and it pulls all the tags that you set up from Google Tag Manager. This simplifies the process for adding or removing scripts from your website, but it can also improves the load times. Google tag manager is helpful for marketing a website, since it allows you to quickly add tags to a container without having to access/edit the code of the website.
  
  In this tutorial we will show you how to setup a Google Tag Manager account, which consists of 2 main steps: <a href="#create">Creating a Google Tag Manager account</a> (this will create a container), then <a hre="#container">Adding the container to your web pages</a>.</p>



<a name="create"></a>
<h2>Create Google Tag Manager Account:</h2>
<ol class="article_list">
<li>Go to the <a href="https://www.google.com/tagmanager/" target="_blank" >Google Tag Manager</a> site, this is the address:<br>
<pre>https://www.google.com/tagmanager/</pre></li>
<li>Click the <strong>Sign up now</strong> button.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/google/tag-manager/sign-up.jpg"><img  src="//cdn.inmotionhosting.com/support/images/stories/google/tag-manager/sign-up.jpg" alt="" /></a></li>
<li>Enter an <strong>Account Name</strong>, choose if you want to share your data with Google, then click the <strong>Next</strong> button.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/google/tag-manager/setup-account.jpg"><img  src="//cdn.inmotionhosting.com/support/images/stories/google/tag-manager/setup-account.jpg" alt="" /></a></li>
<li>On the next screen enter a <strong>Container Name</strong>. Google suggests that you "<em>name the container after the website</em>."</li>
<li>Choose if you are going to use the Container on <em>Web Pages</em>, or <em>Mobile Apps</em>. For this article I chose <strong>Web Pages</strong>.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/google/tag-manager/container-name.jpg"><img  src="//cdn.inmotionhosting.com/support/images/stories/google/tag-manager/container-name.jpg" alt="" /></a></li>
<li>It will drop down with additional options, choose your <strong>Time Zone</strong>, and click the <strong>Create Account and Container</strong> button.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/google/tag-manager/create-container.jpg"><img  src="//cdn.inmotionhosting.com/support/images/stories/google/tag-manager/create-container.jpg" alt="" /></a></li>
<li>The <em>Google Tag Manager Terms of Service Agreement</em> will then be displayed, click the <strong>I ACCEPT</strong> button to proceed. You will then see the code for your <em>Container</em>, in the next section we will show you how to add it to your website.</li></ol>

<a name="container"></a>
<h2>How to Add the Container to your Site:</h2>
There are several ways to add this code to your website; in this tutorial I am using the <strong>File Manager</strong> in <em>cPanel</em>. If you are not familiar with your file structure, see our article titled "<a href="/support/website/getting-started-guides/where-to-upload-files" target="_blank">What directory should I put my files in?</a>"
<ol class="article_list">
<li>Login to the <a href="https://www.google.com/tagmanager/" target="_blank" >Google Tag Manager</a>.</li>
  <li>Click <strong>Accounts</strong>, then click the account you want to setup.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/google/tag-manager/select-container.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/google/tag-manager/select-container.png" alt="" /></a></li>
  <li>Select your container from the <em>Containers</em> section. Now, click <strong>Users & Settings</strong>, then <strong>Settings</strong>.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/google/tag-manager/container-settings.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/google/tag-manager/container-settings.png" alt="" /></a></li>
  <li>Copy the provided code, it must be pasted into <u>each</u> page of your website. It will look similar to this:<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/google/tag-manager/container-code.jpg"><img  src="//cdn.inmotionhosting.com/support/images/stories/google/tag-manager/container-code.jpg" alt="" /></a></li>
<li><a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">Login to cPanel</a>.</li>
<li>Click the <strong>File Manager</strong> button in the <em>Files</em> section. If the <em>Directory Selection</em> window pops up, choose <strong>Web Root</strong>, then click <strong>Go</strong>.</li>
<li>Navigate to where your website files are located. Now, click the site file you want to add the container to, and click the <strong>Edit</strong> button. (If the <em>Text Editor</em> window pops up, click the <strong>Edit</strong> button)</li>
  <li>Paste the code immediately after the <strong>&ltbody&gt</strong> tag.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/google/tag-manager/paste-google-tag-manager-code.jpg"><img  src="//cdn.inmotionhosting.com/support/images/stories/google/tag-manager/paste-google-tag-manager-code.jpg" alt="" /></a><br><br>
    Repeat <strong>Step 5</strong>, and <strong>Step 6</strong> for <u>each page</u> of your site.</li></ol>
<br>
    Congratulations, now you know how to setup <strong>Google Tag Manager</strong>! The next article will show you how to add tags to your container via Google Tag Manager. 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/google-tools/tag-manager&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/google-tools/tag-manager'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD03OCZpZD0zMDQ5JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="42d5568e58695f411abf9d88863b9d73" value="1" />	</div>
	</form>
<!-- <br />
...
<a name='comments'></a>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/afef400b5f39095c67885f22caffb8e5?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/afef400b5f39095c67885f22caffb8e5'>bernie</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-19 10:05 pm</div>
				                <div><p>getting 406 errors now</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32067);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-20 7:43 am</div>
				                <div>Bernie, can you elaborate a little more. Are you getting 406 errors after you followed the tutorial? Can you provide us a link to the URL so we can test it? </div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32078);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-32428'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/2a2eb0e8223608cf903d9dc5d1cf90f6?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/2a2eb0e8223608cf903d9dc5d1cf90f6'>James Gibson</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-05-03 4:13 pm</div>
				                <div><p>I am getting the same error, and I believe it caused because of an issue between gtm cookies and apache security, it think the cookie has malisious code in it and so throw the 406 error. &nbsp; I don't know how to fix it. Help anyone... :)</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32428);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-05-04 7:39 am</div>
				                <div>You can try disabling mod_security (in the Modsec Manager, if you use cPanel) and seeing if that has an effect. Then at least we can isolate that as a possible cause.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32447);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
