<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:64123:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/opencart/processing-orders/changing-the-status-of-an-order-in-opencart" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-01-17T14:25:25-08:00" />
  <meta name="keywords" content="opencart update change order status order history" />
  <meta name="author" content="Tim Sisson" />
  <meta name="description" content="Learn how to change and update the order status of any order in your OpenCart shopping cart." />
  <title>Changing the status of an order in OpenCart - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/opencart/processing-orders/changing-the-status-of-an-order-in-opencart" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:f8fd3fb2b069daa2562ea3cd7694888b -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Changing the status of an order in OpenCart									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>15,795</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 6, 2012'><span style='color:#606060;'>Published:</span> Jan 17, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Once orders are placed on your website, you’ll need to process them. When an initial order arrives, it will have the status of “Pending”. You’ll want to make sure the payment for the order is completed, and then update the status. Anytime you update the status you can notify the customer. This keeps your customers informed about the order they placed. Updating an order status can be done through your OpenCart Dashboard. There are quite a few different status options so be sure to familiarize yourself with them.</p>
<ol>
...
<li>Select the order you want to update by clicking on the “<strong>view</strong>” link in the right side column of the specific order</li>
<li>Now that the order is on your screen, you can click on the “<strong>Order History</strong>” Tab on the left side bar</li>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/opencart/opencart_order_update_2.jpg"><img src="//cdn.inmotionhosting.com/support/images/stories/opencart/opencart_order_update_2.jpg" alt="opencart_order_update_2"  /></a></p>
<li>You can change the Order Status by clicking on the dropdown menu. Once you have made your selection, you can then decide whether to notify your customer. If you want to notify the customer of the status change, check the box next to “<strong>Notify Customer</strong>”. If you want to leave a comment to the customer you can type it in the comment box as well, but it is not necessary.&nbsp;</li>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/opencart/opencart_order_update_1.jpg"><img src="//cdn.inmotionhosting.com/support/images/stories/opencart/opencart_order_update_1.jpg" alt="opencart_order_update_1"  /></a></p>
<li>Click “<strong>Add History</strong>” once you have made the changes you want.</li>
</ol>
<p>If you need further assistance please feel free to <a href="/support/community-support/">ask a question on our support center website</a>.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/opencart/processing-orders'>105: Processing Orders in OpenCart</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 2: Changing the status of an order in OpenCart</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 1: <a href='/support/edu/opencart/processing-orders/viewing-orders-in-opencart'>Viewing Orders in OpenCart</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 3: <a href='/support/edu/opencart/processing-orders/deleting-orders-in-opencart'>Deleting Orders in OpenCart</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xNTQmaWQ9MTExMSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="5a5d2378158b62c12c20d91f36ce1215" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/opencart/processing-orders?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Processing Orders in OpenCart</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/opencart/processing-orders/viewing-orders-in-opencart?tsrc=rsbedu'>Viewing Orders in OpenCart</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/opencart/processing-orders/changing-the-status-of-an-order-in-opencart?tsrc=rsbedu'>Changing the status of an order in OpenCart</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/opencart/processing-orders/deleting-orders-in-opencart?tsrc=rsbedu'>Deleting Orders in OpenCart</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/opencart/processing-orders/printing-order-invoices-in-opencart?tsrc=rsbedu'>Printing Order Invoices in OpenCart</a></td>
                </tr>
          	</table>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						...
						<div><a style='font-size:16px;' href='/support/community-support/users/Tkanaenabogi91'>Tkanaenabogi91</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-03 9:28 pm</div>
				                <div>Hi,<br />
Each time I try to change the status of an order, a red circle with a red line appears when i click add history, and it says loading. But nothing changes.<br />
Can somebody please help me?</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31667);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-04 3:50 pm</div>
				                <div>Do you have error reporting enabled? Does it give any other type of error message?</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31692);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-06 8:27 pm</div>
				                <div>Error reporting? Our online shop was just created 2 weeks ago and I used to get this &quot;Warning: Your IP 58.104.5.107 is not allowed to access this API!&quot; I was then told by support to add API. But the problem hasn't changed. I still can't notify customers when the order is shipped or change the Order Status at all. </div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31750);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-06 9:35 pm</div>
				                <div>Hello Tkanaenabogi91,<br />
<br />
Sorry for the problem with the notifications.  In order for us to investigate your problem, we need  a little information.  Can you please provide us an account id (if you are one of our customers), and also the version of OpenCart you're using as well as any plugins that you may be using.?  It would help investigate the issue in more depth. <br />
<br />
If you have any further questions or comments, please let us know.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31751);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
