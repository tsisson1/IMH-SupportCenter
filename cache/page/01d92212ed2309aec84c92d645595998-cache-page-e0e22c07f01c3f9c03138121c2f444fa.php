<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:51065:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/cpanel/i-cannot-log-in-to-cpanel-error-403" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Keating, Were you able to enter the password? You can also try using http://ecbiz111.inmotionhosting.com/cpanel. We are not able to duplicate the ..." />
  <title>I cannot log in to cpanel - error 403 | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/cpanel/i-cannot-log-in-to-cpanel-error-403" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:323077a5802d587c83a858ed6b0cb4c4 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>I cannot log in to cpanel - error 403</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/Keating'>Keating</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-12-19 1:37 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>1,051</span>
			</div>
...
<br />
I am using Internet Explorer v8.0.7601.<br />
<br />
I get &quot;  The website declined to show this webpage &quot; when I go to cpanel, either via AMP or directly as hcaresraces.org/cpanel.<br />
<br />
I _am_ able to log into my account with my email address, but I cannot get logged into cpanel.<br />
<br />
Thanks,<br />
<br />
Keating<br />
kc4hsi@gmail.com<br />
www.hcaresraces.org<br />
</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_2011' id='upvote_answer_2011' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='2011' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_2011').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_2011' id='downvote_answer_2011' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='2011' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_2011').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Keating,<br />
<br />
Were you able to enter the password?  You can also try using http://ecbiz111.inmotionhosting.com/cpanel.  We are not able to duplicate the issue here.  Though we also do not have  any systems with an older version of IE.  You might want to try <a href="http://www.inmotionhosting.com/support/website/how-to/clear-browser-cache" target="new">clearing your browser cache</a>  or a different browser.  If the problem continues, you may want to call into live support troubleshoot while you're at the computer.<br />
<br />
...
Arnel C.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_2011').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_2011' id='form_comment_on_answer_2011' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/cpanel/i-cannot-log-in-to-cpanel-error-403&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/cpanel/i-cannot-log-in-to-cpanel-error-403'></div>
<script type='text/javascript'>
  (function() {
