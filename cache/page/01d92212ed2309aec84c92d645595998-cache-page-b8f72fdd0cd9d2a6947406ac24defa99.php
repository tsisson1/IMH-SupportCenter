<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:70550:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotion.net/support/edu/joomla-3/306-configure-smtp" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-10-02T15:05:55-07:00" />
  <meta name="keywords" content="joomla 3.0 setup smtp" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="In this Joomla 3.0 tutorial, we show you how to send email using SMTP to avoid the Could not instantiate mail function error." />
  <title>306: Joomla 3.1 Error - Could not instantiate mail function - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-3/306-configure-smtp" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:3b5230143ad3ad0dd66993c1a4d04859 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															306: Joomla 3.1 Error - Could not instantiate mail function									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>31,126</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Oct 2, 2012'><span style='color:#606060;'>Published:</span> Oct 2, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/joomla-3/global-configuration/joomla-3-email-errors.jpg"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="joomla-3-email-errors" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/joomla-3/global-configuration/joomla-3-email-errors.jpg" /></a>If your Joomla server does not support the php mail() function and Joomla attempts to send an email (such as a new user registration email), any of the following message may appear:</p>
<ul>
<li>Could not instantiate mail function.</li>
<li>The mail() function has been disabled and the mail cannot be sent.</li>
<li>Registration failed: An error was encountered while sending the registration email. A message has been sent to the administrator of this site.</li>
</ul>
<p>Not all servers support the php mail function, and if your Joomla hosting provider does not, you're still in luck. To prevent the above error and to setup Joomla to be able to send email successfully, we have to adjust Joomla's email settings. Besides the php mail function, Joomla 3.0 can use <strong>Sendmail</strong> or <strong>SMTP</strong>. In this tutorial, we are going to walk you through the steps for setting up SMTP with Joomla 3.0</p>
<div style="clear: both;"></div>
<h2>Configuring Joomla 3.0 to send emails using SMTP:</h2>
<ol class="article_list">
<li><strong>Configure your sending email account</strong><br /><br />When emailing using SMTP, we are also going to setup SMTP Authentication. What this means is that we are going to setup Joomla to log into the server using a username and password, and then send email as that user. SMTP Authentication is much like using <em>Microsoft Outlook</em> or <em>Mozilla Thunderbird</em>: you enter your email settings, a password, and then you can use that email account.<br /><br />Creating email accounts is not the same on each hosting provider. If you use InMotion Hosting or use cPanel, <a href="/support/edu/everything-email/introduction-email/creating-email-account">click here</a> to learn how to create an email address. Otherwise, you should contact your hosting provider for more help with setting up a new email account.<br /><br />Be sure to keep track of the email account and password that you use. In our testing, we created <em>do-not-reply@bradm.rubelix.com</em>.</li>
...
<li>In the tabs at the top of the page, click the <strong>Server</strong> tab</li>
<li>In the right column, find the <strong>Mail Settings</strong>. Update the settings as we describe below, and then click the <strong>Save</strong> button in the top left of the page.<br /> 
...
<tr>
<th>From Email</th>
<td>Enter the email address you created in step 1 above. In our testing, we entered <em>do-not-reply@bradm.rubelix.com</em></td>
</tr>
<tr>
<th>From Name</th>
<td>Enter your name or the name of your website. In our testing, we entered <em>Best Website Ever</em></td>
</tr>
<tr>
<th>SendMail path</th>
<td>Generally you can leave this setting alone</td>
</tr>
<tr>
<th>SMTP Authentication</th>
<td>Set SMTP Authentication to <strong>Yes</strong></td>
</tr>
<tr>
<th>SMTP Security</th>
<td>If you want to send email, you may need to contact your hosting provider for the necessary settings. In our testing, set Security to <strong>SSL</strong>.</td>
</tr>
<tr>
<th>SMTP Port</th>
<td>As we are using SSL (see the setting above), we are setting the port to <strong>465</strong>. Again, you may need to contact your <a href="http://www.inmotionhosting.com/joomla-hosting.html">joomla host</a> for the correct settings.</td>
</tr>
<tr>
<th>SMTP Username</th>
<td>Enter the username of the email address you created in step 1.<br /></td>
</tr>
<tr>
<th>SMTP Password</th>
<td>Enter the password of the email address you created in step 1.<br /></td>
</tr>
<tr>
<th>SMTP Host</th>
<td>Most often, your STMP Host will be <strong>localhost</strong>. If you have any doubts, be sure you contact your joomla hosting provider for clarification.<br /></td>
</tr>
</tbody>
</table>
<p>You can see in the screenshot below how the settings looked when we saved them in Joomla 3.0. We then signed up as a new user within our Joomla 3.0 website, and you can see how some of the SMTP settings we configured (such as <strong>From email</strong> and <strong>From Name</strong>) show up in our email client.<br /><br /></p>
<table class="article_table">
<tbody>
<tr>
<th>SMTP Settings Within Joomla 3.0</th> <th>An email sent by Joomla with our new SMTP Settings</th>
</tr>
<tr>
<td><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/joomla-3/global-configuration/joomla-3.0-smtp-mail-settings.jpg"><img style="max-width: 240px;"  alt="joomla-3.0-smtp-mail-settings" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/joomla-3/global-configuration/joomla-3.0-smtp-mail-settings.jpg" /></a></td>
<td><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/joomla-3/global-configuration/email-sent-to-yahoo.jpg"><img style="max-width: 240px;"  alt="email-sent-to-yahoo" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/joomla-3/global-configuration/email-sent-to-yahoo.jpg" /></a></td>
</tr>
</tbody>
</table>
</li>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 37: 306: Joomla 3.1 Error - Could not instantiate mail function</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 36: <a href='/support/edu/joomla-3/307-generic-error-page'>307: Why is Joomla 3.1 not showing a custom error page?</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 38: <a href='/support/edu/joomla-3/305-change-database-settings'>305: How to Change your Joomla 3.1 Database Settings</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotion.net/support/edu/joomla-3/306-configure-smtp&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotion.net/support/edu/joomla-3/306-configure-smtp'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xMDEmaWQ9MjM5OCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="3c73667da56c8ba674923a07c8ae1699" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-23 4:32 pm</div>
				                <div><p class="MsoNormal">Hi,</p>
<p class="MsoNormal">We are a not-for-profit organization trying to host our Joomla! based website with hostinger.in. Email is very important to us, as members are required to create their account. After uploading our website in above host we found that authentication email is not being sent. We tried PHP mailer, Sendmail and SMTP without having any luck.</p>
<p class="MsoNormal"><strong>Workarounds&hellip;</strong></p>
<p class="MsoListParagraphCxSpFirst" style="text-indent:-.25in;mso-list:l0 level1 lfo1">1.<span style="font-size: 7pt; font-family: 'Times New Roman';">&nbsp; &nbsp; &nbsp; &nbsp;1.&nbsp;</span>Removed the whole website and fresh installed newly downloaded Joomla 3.3.1 without any sample data. No additional Extension installed.</p>
<p class="MsoListParagraphCxSpMiddle" style="text-indent:-.25in;mso-list:l0 level1 lfo1">2.<span style="font-size: 7pt; font-family: 'Times New Roman';">&nbsp; &nbsp; &nbsp; &nbsp;2.&nbsp;</span>Tried PHP mail in following settings in Global Configuration &gt; Server</p>
<p class="MsoListParagraphCxSpMiddle">Send Mail : Yes. Mailer: PHP Mail. From email: admin@ourdomain.org. From name: Site name</p>
<blockquote>
<p>&nbsp;Message</p>
<p>Your account has been created and an activation link has been sent to the email address you entered. Note that you must activate the account by clicking on the activation link when you get the email before you can login.</p>
</blockquote>
<p class="MsoListParagraphCxSpMiddle">Account is being created in the backend but no email sent. (Checked spam folder)</p>
<p class="MsoListParagraphCxSpMiddle">&nbsp;</p>
<p class="MsoListParagraphCxSpMiddle">Tried Sendmail with the following settings&hellip;</p>
<p class="MsoListParagraphCxSpMiddle">Send Mail : Yes. Mailer: sendmail. From email: admin@ourdomain.org. From name: Site name. Sendmail Path: /usr/sbin/sendmail</p>
<p class="MsoListParagraphCxSpMiddle">&nbsp;</p>
<blockquote>
<p class="MsoListParagraphCxSpMiddle">Notice</p>
<p class="MsoListParagraphCxSpMiddle">Could not execute: /usr/sbin/sendmail</p>
<p class="MsoListParagraphCxSpMiddle">&nbsp;</p>
<p class="MsoListParagraphCxSpMiddle">Warning</p>
<p class="MsoListParagraphCxSpMiddle">Registration failed: An error was encountered while sending the registration email. A message has been sent to the administrator of this site.</p>
<p class="MsoListParagraphCxSpMiddle">Account is created in the backend but no email sent.</p>
</blockquote>
<p class="MsoListParagraphCxSpMiddle">&nbsp;</p>
<p class="MsoListParagraphCxSpMiddle">Tried SMTP with following settings&hellip;</p>
<p class="MsoListParagraphCxSpMiddle">Send Mail : Yes. Mailer: SMTP. From email: admin@ourdomain.org. From name: Site name. SMTP Authentication: Yes and No tried both way. SMTP Security: None. SMTP Port: 2525. SMTP Username: admin@ourdomain.org. SMTP Password: our password. SMTP Host: mx1.hostinger.in</p>
<p class="MsoListParagraphCxSpMiddle">&nbsp;</p>
<blockquote>
<p class="MsoListParagraphCxSpMiddle">Notice</p>
<p class="MsoListParagraphCxSpMiddle">SMTP connect failed</p>
<p class="MsoListParagraphCxSpMiddle">&nbsp;</p>
<p class="MsoListParagraphCxSpMiddle">Warning</p>
<p class="MsoListParagraphCxSpMiddle">Registration failed: An error was encountered while sending the registration email. A message has been sent to the administrator of this site.</p>
</blockquote>
...
<p class="MsoListParagraphCxSpMiddle">Account is created in the backend but no email sent.</p>
<p class="MsoListParagraphCxSpMiddle">&nbsp;</p>
<p class="MsoListParagraphCxSpMiddle" style="text-indent:-.25in;mso-list:l0 level1 lfo1">3.<span style="font-size: 7pt; font-family: 'Times New Roman';">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>Install Thunderbird 24.6.0 (latest) in home PC. Configured the SMTP mail as per settings provided by the host. It works without any issue.</p>
<p class="MsoListParagraphCxSpMiddle">&nbsp;</p>
<p class="MsoListParagraphCxSpMiddle">Thunderbird Setting (As seen in the Account Setting Panel)</p>
<blockquote>
<p class="MsoListParagraphCxSpMiddle">Outgoing Server (SMTP)</p>
<p class="MsoListParagraphCxSpMiddle">Description : Site name</p>
<p class="MsoListParagraphCxSpMiddle">Server Name:&nbsp; mx1.hostinger.in</p>
<p class="MsoListParagraphCxSpMiddle">Port: 2525</p>
<p class="MsoListParagraphCxSpMiddle">User Name: : <a href="mailto:admin@ourdomain.org">admin@ourdomain.org</a></p>
<p class="MsoListParagraphCxSpMiddle">Authentication method: Password, transmitted insecurely</p>
<p class="MsoListParagraphCxSpMiddle">Connection Security: None</p>
</blockquote>
<p class="MsoListParagraphCxSpMiddle">&nbsp;</p>
<p class="MsoListParagraphCxSpMiddle">Information provided by the host</p>
<p class="MsoListParagraphCxSpMiddle" style="margin-left:1.0in;mso-add-space:
auto;text-indent:-.5in;mso-list:l1 level1 lfo2">i.<span style="font-size: 7pt; font-family: 'Times New Roman';">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>POP3/IMAP Host: mx1.hostinger.in</p>
<p class="MsoListParagraphCxSpMiddle" style="margin-left:1.0in;mso-add-space:
auto;text-indent:-.5in;mso-list:l1 level1 lfo2">ii.<span style="font-size: 7pt; font-family: 'Times New Roman';">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>POP3 Port: 110</p>
<p class="MsoListParagraphCxSpMiddle" style="margin-left:1.0in;mso-add-space:
auto;text-indent:-.5in;mso-list:l1 level1 lfo2">iii.<span style="font-size: 7pt; font-family: 'Times New Roman';">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>IMAP Port: 143</p>
<p class="MsoListParagraphCxSpMiddle" style="margin-left:1.0in;mso-add-space:
auto;text-indent:-.5in;mso-list:l1 level1 lfo2">iv.<span style="font-size: 7pt; font-family: 'Times New Roman';">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>SMTP Host: mx1.hostinger.in</p>
<p class="MsoListParagraphCxSpMiddle" style="margin-left:1.0in;mso-add-space:
auto;text-indent:-.5in;mso-list:l1 level1 lfo2">v.<span style="font-size: 7pt; font-family: 'Times New Roman';">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>SMTP Port: 2525</p>
<p class="MsoListParagraphCxSpMiddle" style="margin-left:1.0in;mso-add-space:
auto;text-indent:-.5in;mso-list:l1 level1 lfo2">vi.<span style="font-size: 7pt; font-family: 'Times New Roman';">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>No SSL</p>
<p class="MsoListParagraphCxSpMiddle">&nbsp;</p>
<p class="MsoListParagraphCxSpMiddle">PHP version can be chosen from the cpanel of the host, 5.2, 5.3, 5.4, 5.4. We tried with 5.3 and 5.4.</p>
<p class="MsoListParagraphCxSpMiddle">&nbsp;</p>
<p class="MsoListParagraphCxSpMiddle">Any help in this regard will be highly appreciated.</p>
<p class="MsoListParagraphCxSpMiddle">&nbsp;</p>
<p>&nbsp;</p>
<p class="MsoListParagraphCxSpLast">Thank you</p>
<p class="MsoListParagraphCxSpLast">Tarun</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11884);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-23 4:45 pm</div>
				                <div>Hello Tarun,<br />
<br />
I am unsure of why it would fail. It appears they are using a different port for SMTP standard, most of the time either 25 or 587 will work using non-SSL. As a shot in the dark, you may try  those ports in case there was a miscommunication. Please give that a try and see if it works.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11886);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
