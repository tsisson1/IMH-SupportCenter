<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50317:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/moodle/user-roles-moodle" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="keywords" content="section  Users roles Moodle 2.3 user role enrollment permissions" />
  <meta name="description" content="This section of the Education Channel will focus on Users and their roles in Moodle 2.3." />
  <title>105: User Accounts and Permissions in Moodle | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/moodle/user-roles-moodle" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:d76e4d711f0ddab52361fa9ca9cc3f7f -->
...
<div class='page-header'>
	<h1>105: User Accounts and Permissions in Moodle</h1>
</div>
<div class='section_listing'>
		<table>
	<tr><td colspan='3'><h2>User Accounts</h2><div>This section will discuss how to manage users and their profiles.</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 1:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/user-roles-moodle/add-new-user'>Adding new users to the Moodle User Accounts</a>
					<div>In order for the Courses to be utilized. Users will need to be added to the Courses. This tutorial will explain how to create and add users to the Moodle 2.3 database.</div>
					<div class='smallgrey'>Hits: 6,733</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/user-roles-moodle/user-profile-fields'>Editing User profile fields in Moodle</a>
					<div>When setting up users in Moodle 2.3, there may be a need for setting up custom user profile fields. This tutorial will explain how to add user profile fields.</div>
					<div class='smallgrey'>Hits: 9,993</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/user-roles-moodle/bulk-user-actions'>Running bulk user actions in Moodle</a>
					<div>Bulk actions ran on users are convenient and saves time. For example, messaging a whole class of users with a uptade. This article will explain how to perform a User bulk action in Moodle 2.3.</div>
					<div class='smallgrey'>Hits: 3,689</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/user-roles-moodle/browse-list-of-users'>Browsing and filtering users in the Moodle Site Administration</a>
					<div>Once the users are set up in Moodle 2.3, the administrator may need to view certain users in the database. This tutorial will explain the Browse list of users in the Site administration section.</div>
					<div class='smallgrey'>Hits: 174,069</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/user-roles-moodle/user-cohorts'>Creating Cohorts in the Moodle site administration</a>
					<div>Cohorts, in Moodle 2.3, are a group of users that are of the same demographic or have a relation ship to each other in the Course. The following tutorial will outline how to create and add users to a cohort.</div>
					<div class='smallgrey'>Hits: 4,143</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/user-roles-moodle/download-bulk-users'>Exporting or Downloading users in Moodle</a>
					<div>In this article, exporting and downloading the user data from Moodle 2.3 will be discussed. Saving user data from Moodle is done with the Bulk user actions in the Moodle Site administration section. </div>
					<div class='smallgrey'>Hits: 9,760</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/user-roles-moodle/upload-users'>Importing or Uploading users in Moodle</a>
					<div>User data can be imported into Moodle 2.3 using the Upload Users feature in the Moodle Site administrator section. This article will walk through the steps to import and upload users.</div>
					<div class='smallgrey'>Hits: 9,533</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/user-roles-moodle/remove-guest-login'>Removing the Guest login button from the Moodle login page</a>
					<div>This article will explain how to remove the guest login button from the moodle 2.3 login page.</div>
					<div class='smallgrey'>Hits: 6,153</div>
				</td>
			</tr>
		<tr><td colspan='3' style='padding-top:20px;'><h2>User Roles and Permissions</h2><div>User permissions define the roles each user can take which grants access to certian functionalities of Moodle.  </div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 9:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/user-roles-moodle/permissions-user-policies'>Configuring the User Permission policies in Moodle</a>
					<div>This tutorial will explain how to edit the global settings for roles and permissions in the user profiles of Moodle 2.3.</div>
					<div class='smallgrey'>Hits: 3,549</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/user-roles-moodle/site-administrator-roles'>Modifying Site Administrators in the User permissions section of Moodle</a>
					<div>Administrators can be added, removed, and their roles changed in Moodle 2.3. In This tutorial, the focus is on the Administrator user permissions and roles.</div>
					<div class='smallgrey'>Hits: 106,440</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/user-roles-moodle/define-roles'>Defining Roles in Moodle </a>
					<div>Moodle 2.3 allows the administrator to create custom roles and edit the existing default roles for all the users on the site.  This tutorial will outline managing roles, defining roles, and Adding a new role within the Moodle Site administration.</div>
					<div class='smallgrey'>Hits: 4,567</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/user-roles-moodle/assign-system-roles'>Assigning system roles in Moodle</a>
					<div>Once roles are defined, the users can be set to those specific roles. In this tutorial, we will learn how to assign system roles in Moodle 2.3. </div>
					<div class='smallgrey'>Hits: 3,255</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/user-roles-moodle/check-system-permissions'>Checking user permissions in Moodle</a>
					<div>This tutorial will explain how to check the user permissions in Moodle 2.3.</div>
					<div class='smallgrey'>Hits: 2,687</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/user-roles-moodle/enrolling-users'>How to Enrol a student in a Moodle course</a>
					<div>In order for a student to access the Moodle Courses, the users will need to be added to the Course. The following article will explain how to enrol users into a Moodle 2.3 course.</div>
					<div class='smallgrey'>Hits: 8,079</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/user-roles-moodle/skip-guest-login'>Allowing Guest access without logging into Moodle</a>
					<div>This article will discuss how to disable the Guest Auto-login feature that Moodle 2.3 has by default.</div>
					<div class='smallgrey'>Hits: 7,160</div>
				</td>
			</tr>
			</table>
</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yODcmaWQ9Mjg3JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
