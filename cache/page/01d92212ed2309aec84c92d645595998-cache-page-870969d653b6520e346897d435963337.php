<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:97993:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/amp/what-is-my-username-and-password" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-02-11T13:44:25-08:00" />
  <meta name="keywords" content="cpanel amp ftp premium website builder username password reset forgot remember" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="Sometimes it can be a bit tricky to keep track of all your usernames and passwords. In this article, we'll outline what your username is for various applications and also provide the steps to take if you have forgotten your password." />
  <title>What is my username and password (I forgot)? - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/amp/what-is-my-username-and-password" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:4bce6d49d1b9a5a1285f1752a949538d -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '120.168.0.81']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															What is my username and password (I forgot)?									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>52,210</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Dec 22, 2011'><span style='color:#606060;'>Published:</span> Feb 11, 2014</div>
  ...
  <h2>Navigation:</h2>
  <button type="button" class="btn btn-primary" onclick="window.location.hash='amp';">AMP</button>
  <button type="button" class="btn btn-primary" onclick="window.location.hash='cpanel';">cPanel</button>
  <button type="button" class="btn btn-primary" onclick="window.location.hash='email';">Email</button>
  <button type="button" class="btn btn-primary" onclick="window.location.hash='ftp';">FTP</button>
  <button type="button" class="btn btn-primary" onclick="window.location.hash='pwb';">Premium Web Builder</button>
  <button type="button" class="btn btn-primary" onclick="window.location.hash='wordpress';">WordPress</button>
</div>


<p>Within your hosting account, there are various tools that you can use to manage your hosting account and build a website. Not all of these tools are tied together, and in this article we hope to clear up any confusion on logins between the multiple systems.</p>

<!-- //NOTE AMP ----------------------------------------------------------------------------------------->
<a name='amp'></a>
<h2>AMP - Account Management Panel</h2>
<p>When you <a href="/support/website/how-to/how-to-log-into-amp">log into AMP</a>, you actually login using your email address as a username. If you have forgotten your password, please use the <strong>I don't know my password</strong> link on the <a href="https://secure1.inmotionhosting.com/index/login">AMP log in page</a>. Please note, when using the Forgot Password feature for AMP, enter just your domain name (do not include http:// or www).</p>
<p><strong>Related Articles:</strong></p>
<ul>
<li><a href="/support/website/how-to/amp-vs-cpanel">cPanel vs. AMP</a></li>
</ul>


<!-- //NOTE CPANEL -------------------------------------------------------------------------------------->
<div style="background-color: #DFDFDF; padding: 5px">
<a name='cpanel'></a>
<h2>cPanel - Your hosting account's Control Panel</h2>
<p>Your cPanel username can be found within AMP. To find your cPanel username:</p>
<ol class="article_list">
<li><a href="/support/website/how-to/how-to-log-into-amp">Log into AMP</a></li>
...
<li>Your <strong>cPanel username</strong> will be listed next to <em>Username</em><br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/revamp/cpanel-username.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/revamp/cpanel-username.png" alt="" /></a></li>
</ol>
<p><strong>Related Articles:</strong></p>
<ul>
<li><a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">How to log into cPanel</a></li>
<li><a href="/support/website/cpanel/resetting-cpanel-password-amp">How to reset your cPanel password</a></li>
</ul>
</div>
...
<a name='email'></a>
<h2>Email</h2>
<p>Email passwords can be reset in cPanel and from the webmail interface.  However, you would need to know the cPanel password in order to gain access to the interface that can change the email password.  The webmail interface requires that you know the existing email password, so this option may not the best if you've lost your email account password. To see the steps necessary to reset your password using either of these methods, please read <a href="http://www.inmotionhosting.com/support/email/general-information/changing-your-email-password" target="new">changing your email password</a>.</p>


<!-- //NOTE FTP ----------------------------------------------------------------------------------------->
<a name='ftp'></a>
<h2>FTP</h2>
<p>FTP stands for file transfer protocol, and is used for uploading and download files from your hosting account. Your cPanel username and password is actually an ftp account as well, so you can use your cPanel username and password to login to your account via ftp. You also have the option to create ftp accounts for other users. For more help with this, please see <a href="/support/website/file-management/how-do-i-create-a-ftp-account-in-my-control-panel-cpanel">How to create additional ftp accounts</a>.</p>
<p><strong>Related Articles:</strong></p>
<ul>
<li><a href="/support/website/file-management/using-ftp-with-your-addon-domain">Addon domain ftp accounts</a></li>
</ul>
...
<div style="background-color: #DFDFDF; padding: 5px">
<a name='pwb'></a>
<h2>Premium Website Builder</h2>
<p>When working with your Premium Website Builder, there are two logins:</p>
<ol class="article_list">
<li>There is a login to simply access your builder and edit your site</li>
<li>There is a username and password stored and used when you publish your site</li>
</ol>
<p>The initial login for your Premium Site Builder (item #1 above) is actually your original cPanel username and your AMP password. If you are unable to log into the builder, you can find more information on resetting your password here: <a href="/support/website/pwb/how-do-i-change-my-premium-website-builder-login-password">How Do I change my Premium Website Builder Login Password?</a></p>
<p>The second username and password involved with the Premium Site Builder is the actual publishing credentials. This is set to your cPanel username and password. Because the systems are not tied together, if you reset your cPanel password, your Builder's publishing settings will not be updated and you will not be able to publish any longer. For more help with updating your Builder's publishing username and password, please see: <a href="/support/website/pwb/updating-password-setting-premium-website-builder">Updating your password setting in Premium Website Builder</a></p>
</div>
...
<p>If you do not know your username, you can always go into the database to locate it as it is stored there.  The following steps will walk you through doing so.</p>
<ol class='article_list'>
<li>
<p>First, <a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">log into cPanel</a> and select the PHPMyAdmin option.</p>
</li>
<li>
<p>Once in PHPMyAdmin, select <a href="/support/edu/wordpress/324-find-db-name">the database that you have Wordpress installed on</a>.</p>
</li>
<li>
<p>The table that your Wordpress users are stored in the the users table.  Of course, the name of this table will be prefaced with whatever prefix that you defined when you installed Wordpress.  Click on that table on the left side of the screen to open it up.</p>
</li>
<li>
<p>Once the table is open, you should see a few different columns there.  Your Wordpress user is defined in the user_login column.</p>
</li>
</ol>
<h3>I forgot my password</h3>
<p>Wordpress offers several options in resetting your password.  You may reset your password via FTP, phpMyAdmin, or the "Forgot Password" button on the login screen.  The following article will walk you through the process of resetting your passwords:</p>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/amp/what-is-my-username-and-password&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/amp/what-is-my-username-and-password'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MjcmaWQ9MzQ2JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="fbbfae0793daa58f68c611147f275b61" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/website-troubleshooting/client-cant-remember-their-login?tsrc=rsbraq'>My client cannot remember their login information</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/39628ac46e820200ec9f7d947ef92af3?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/39628ac46e820200ec9f7d947ef92af3'>Ketil Olav Sand</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-20 3:45 am</div>
				                <div><p>regarding "kunstparken.no":</p>
<p>All basic settings needed for the account has gone down the drain. Will you please resend?</p>
<p>bw Ketil S</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9052);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-20 8:03 am</div>
				                <div>Your private information is not something that we are able to provide via this public forum.  You may, however, use the instructions in this article to obtain any information that you may need.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9058);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/0beb654ae77e3c9528f33175dff6778a?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/0beb654ae77e3c9528f33175dff6778a'>John</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-23 8:18 pm</div>
				                <div><p>How long should it take to get my intro email with login info? Over an hour?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11888);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-23 8:24 pm</div>
				                <div>Hello John<br />
<br />
Looking at your account notes, it appears your welcome email was sent out about 2 hours ago. Please be sure to double-check any spam or junk folders to make sure it didn't end up there.<br />
<br />
It should have come from &lt;strong&gt;support@inmotionhosting.com&lt;/strong&gt; with the subject &lt;strong&gt;Welcome to InMotion Hosting!&lt;/strong&gt;.<br />
<br />
If you still are not seeing it, please use the &lt;strong&gt;Support Chat&lt;/strong&gt; link from the top-right of our website to ensure that we have the correct email address on file for you and that there are not issues delivering email to you there.<br />
<br />
- Jacob</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11889);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-13462'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/2ebb67c90a71a5082a975b39ed55a00b?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/2ebb67c90a71a5082a975b39ed55a00b'>Anupam sahoo</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-30 8:53 am</div>
				                <div><p>How do I creat my username&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13462);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-30 9:14 am</div>
				                <div>Any usernames would already be created for you.  could you clarify what specific username you are looking for?  Nearly all usernames are able to be located from within the instructions in this article.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13465);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-15386'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/542f6520c5b85fca3965219ea9027267?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/542f6520c5b85fca3965219ea9027267'>James fugghett</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-23 5:36 am</div>
				                <div><p>I need To know my pass word&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15386);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-23 9:10 am</div>
				                <div>Hello James,<br />
<br />
Thank you for your question about your cPanel password. We do not know your password, but you can <a href="http://www.inmotionhosting.com/support/edu/cpanel/getting-started-cpanel/change-password#amp">reset your cPanel password in AMP</a>.<br />
<br />
You do not need to know the original password to create a new one in AMP.<br />
<br />
If you have any further questions, feel free to post them below.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15403);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-17398'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/b8d0c355aa73439ce732a81dc443711f?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/b8d0c355aa73439ce732a81dc443711f'>Delaney</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-13 4:05 pm</div>
				                <div>Make it easier</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17398);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-17595'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/787a270765927a35736dc9e19e597962?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/787a270765927a35736dc9e19e597962'>Amit Sogani</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-19 3:39 am</div>
				                <div><p><span style="color: rgb(35, 35, 35); font-family: adelle-sans, Helvetica, Arial, sans-serif; font-size: 13px; line-height: 22px;">How long should it take to get intro email with login info?</span></p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17595);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-19 9:16 am</div>
				                <div>Hello Amit,<br />
<br />
You should be contacted around 30 minutes after you sign up by our confirmations team. Once they complete your confirmation, you should receive an email within 15-20 minutes with instructions on how to get started. <br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17603);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-18585'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/aa6c59370fc600c811d336b2ee440d97?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/aa6c59370fc600c811d336b2ee440d97'>babypics</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-17 3:53 am</div>
				                <div><p>This article is great and very informative i really like this post. Thanks ..</p>
</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(18585);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-27076'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/cd40e444af4bd72a47ee4c7efabbb578?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/cd40e444af4bd72a47ee4c7efabbb578'>Mario Rotolo</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-30 6:41 am</div>
				                <div><p>As a new customer I did receive the welcome email but still it is not clear to me how to report failures to the technical support.&nbsp; I have tried logging in into the support site but my user name or email are not recognised.&nbsp; Do I&nbsp; need a seperate username for that?&nbsp; Is there a live chat somewhere for support?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27076);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-30 7:38 pm</div>
				                <div>Hello Mario,<br />
<br />
Sorry for the problem with logging in.  You should be logging into the <a href="https://secure1.inmotionhosting.com/index/login">Account Management Panel (AMP)</a> using your email address and password that you set.  There is also a forgot password option on the screen.  If you continue to have problems, contact our  <a href="http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support"> our live technical support team</a>.  Click on the link for information on how to reach them via email/phone/chat.  You can also go to the bottom of the <a href="http://www.inmotionhosting.com/support/">support center</a> to see the information contact support team - including a link for chat support.<br />
<br />
If you have any further questions or comments, please let us know.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27096);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-28950'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/ca6811313cacd330332603a1cad44a52?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/ca6811313cacd330332603a1cad44a52'>Rachel</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-12-03 5:30 am</div>
				                <div><p>Hi,</p>
<p>&nbsp;</p>
<p>I do not have my password and username for my cPanel.</p>
<p>How do I obtain? As I stuck and unable to edit the details on the website.</p>
<p>&nbsp;</p>
<p>Thanks!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28950);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-12-03 9:10 am</div>
				                <div>Rachel, you can find your information in AMP.  Here's an article on <a href="http://www.inmotionhosting.com/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel#access-via-amp">accessing cPanel via AMP</a>. I hope this helps! </div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28959);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
