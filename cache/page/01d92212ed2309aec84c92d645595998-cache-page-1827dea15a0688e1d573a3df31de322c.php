<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:86177:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.info/support/email/outlook/how-to-set-up-outlook-2011" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-01-28T18:57:34-08:00" />
  <meta name="keywords" content="Outlook 2011 mac email setup" />
  <meta name="author" content="Tim Sisson" />
  <meta name="description" content="In this tutorial, we will go through the steps to set up your email in Outlook 2011 on a Mac." />
  <title>How to Set Up your Email in Outlook 2011 for the Mac - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/email/outlook/how-to-set-up-outlook-2011" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:90673f3b0a1a6959ed50de48576e4a0c -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '192.249.66.24']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to Set Up your Email in Outlook 2011 for the Mac</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to Set Up your Email in Outlook 2011 for the Mac									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>29,780</span></div>
							...
							<div style='clear:both;'></div>
								...
								<p>Outlook 2011 is a version of Microsoft Outlook available for the Mac computer. You can set up Outlook 2011 as an email client to send and receive email from your email hosted at InMotion Hosting.</p>

<p>First, you will need to log into Outlook 2011. Next, we will go through the steps to add a new account:
...
<ol class="article_list">
  <li>Click on <strong>Tools</strong>, and then <strong>Accounts</strong>....</li>
  <li>On the <em>Add an Account</em> menu, click <strong>E-mail</strong></li>
  <li>Enter your full email address and password on the next screen and click <strong>Add Account</strong></li>
</ol></p>


<p>Once the account is added, you will fill in the information for the new email account.</p>

<h3>Pesonal Information</h3>
<table class="article_table">
<tr><th>Account Description</th><td>This is the name your mail will show as in your Microsoft Office inbox.</td></tr>
<tr><th>Full name</th><td>Insert your full name here, as this is the name that will show when you send email</td></tr>
<tr><th>E-mail address</th><td>Put in your full email address, for example <em>tim@example.com</em></td></tr>
</table>
<p> </p>
<h3>Server Information</h3>
<table class="article_table">
<tr><th>User name</th><td>This will be your full email address. For example, <em>kevin@example.com.</em> Make sure to include the full address, including the <em>@example.com</em>.</td></tr>
<tr><th>Password</th><td>This is the password for the email account you listed above, not your cPanel password.</td></tr>
<tr><th>Incoming Mail Server</th><td>If your domain points to InMotion Hosting, the incoming mail server is mail.example.com.</td></tr>
<tr><th>Outgoing Mail Server</th><td>This will be the same as your Incoming Mail Server, mail.example.com. Make sure it is using Port 465.</td></tr>
</table>
<p> </p>
<p>As Outlook recommends, check the boxes that say <strong>Use SSL to connect</strong>. After confirming the information click on red circle at the top left to close the window. To confirm the account was added, check your Outlook Inbox. There you will see listed the account you just added with your Account Description.</p>

<p>Congratulations, you have added your email account to Outlook 2011! If you have any problems setting up the account, double-check all your settings. If the settings are correct, check out our articles on troubleshooting issues <a href="/support/email/email-troubleshooting/problems-sending-mail-receiving-is-fine">sending email</a> or <a href="/support/email/email-troubleshooting/problems-receiving-email">receiving email</a>.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.info/support/email/outlook/how-to-set-up-outlook-2011&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.info/support/email/outlook/how-to-set-up-outlook-2011'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD01NSZpZD02OTUmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="370c42725ff2f83f4945cef402449c27" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/c297883bf95f1c040f68598c74bd7781?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/c297883bf95f1c040f68598c74bd7781'>Doug Johnson</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-21 8:12 pm</div>
				                <div><p>Your technical support representative and the support documents he sent along were very helpful.</p>
<p>&nbsp;</p>
<p>Thank you!</p>
<p>Doug</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9957);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-21 8:20 pm</div>
				                <div>Thanks Doug!  Let us know if you have any further questions!<br />
<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9958);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-12032'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/7282b9d31d1f829ab10a6169548b5e95?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/7282b9d31d1f829ab10a6169548b5e95'>Randy Bowling</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-26 3:12 pm</div>
				                <div><p>Hello</p>
<p>I just bought my new Mac Air and click tools and do not see anything close to 'accounts' please help</p>
<p>Thanks!!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12032);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-26 4:33 pm</div>
				                <div>Hello Randy,<br />
<br />
Are you using Outlook 2011 for Mac? It looks like MacBook Air might come with another version of Outlook in which you'd want to follow these steps to setup an account:<br />
<br />
&lt;ol class=&quot;article_list&quot;&gt;<br />
&lt;li&gt;Click on the &lt;strong&gt;Outlook&lt;/strong&gt; menu at the top-left, then &lt;strong&gt;Preferences&lt;/strong&gt;&lt;/li&gt;<br />
&lt;li&gt;Under the &lt;strong&gt;Personal Settings&lt;/strong&gt; section, click on &lt;strong&gt;Accounts&lt;/strong&gt;&lt;/li&gt;<br />
&lt;li&gt;On the &lt;strong&gt;Add an Account&lt;/strong&gt; screen, click on &lt;strong&gt;E-mail Account&lt;/strong&gt;&lt;/li&gt;<br />
&lt;/ol&gt;<br />
<br />
Then you would just follow the steps as normal to configure your email account.<br />
<br />
Please let us know if you're still having any issues getting this setup. You can also &lt;a href=&quot;http://www.inmotionhosting.com/support/edu/cpanel/cpanel-email/logging-into-webmail&quot; target=&quot;_blank&quot;&gt;login to webmail&lt;/a&gt; in the meantime to directly check your mail on the server.<br />
<br />
- Jacob</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12035);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-18142'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/54a90fc2656dc08ec8d764e1dfdc692e?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/54a90fc2656dc08ec8d764e1dfdc692e'>April Klazema</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-04 8:59 am</div>
				                <div><p>So, I have successfully added the account, but I do not get a sent items folder?</p>
<p>&nbsp;</p>
<p>Where do these go?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(18142);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-04 10:02 am</div>
				                <div>Hello April,<br />
<br />
Thanks for the question!  You will need to subscribe to the folder for the sent mail to update properly.  Check out this article: <a href="http://www.inmotionhosting.com/support/email/outlook/inbox-subscribe">HOutlook 2013/Office 365 - Subscribing to your Inbox</a>.  That should take care of the issue!  <br />
<br />
I hope this helps to answer your question, please let us know if you require any further  assistance.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(18145);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-20848'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/e6d43b4f523a3e73a125122e5ef5276c?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/e6d43b4f523a3e73a125122e5ef5276c'>mowafak</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-19 7:28 am</div>
				                <div><p>i am trying the same but the outlook stops at 1st step with no response....any help</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20848);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-19 1:31 pm</div>
				                <div>Hello mowafak,<br />
<br />
Thank you for contacting us . Since you are having problems on the first step, I would suspect the client first.<br />
<br />
Have you tried restarting Outlook, or even your computer?<br />
<br />
Do you have any other existing accounts, if so make sure they are not stuck in the middle of processing something. For example, an email attempting to send with a large attachment. <br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20865);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-21187'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/9ef4230c5a7ba4bf7f6d98999abfabc2?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/9ef4230c5a7ba4bf7f6d98999abfabc2'>Michal Cerva</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-28 5:25 pm</div>
				                <div><p>Hi,</p>
<p>&nbsp;</p>
<p>I have problem with set up outlook for more accounts. All incoming email put into one inbox.</p>
<p>Could you help me? :-)</p>
<p>&nbsp;</p>
<p>Thanks. Michal</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21187);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-02 11:54 am</div>
				                <div>Hello Michal,<br />
<br />
it sounds as if it is using the Unified Inbox. Here is an article <a href="http://www.utexas.edu/its/help/office365/2334">how to disable that</a>.<br />
<br />
Kindest Regards,<br />
Scott M<br />
</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21221);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-23596'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/f8983d4cec26cc2f635278cbc91e107a?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/f8983d4cec26cc2f635278cbc91e107a'>Paul</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-05-21 12:46 pm</div>
				                <div><p>I tried to send out approximately 400 emails from my Outlook but got many sent back saying:</p>
<p><em><strong>has exceeded the max emails per hour (313/250 (125%)) allowed</strong></em></p>
<p>Is this an InMotion hosting account level limit or an Outlook limitation?</p>
<p>Thanks, Paul</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23596);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-05-21 2:42 pm</div>
				                <div>Hello Paul,<br />
<br />
Thank you for contacting us about a "exceeded the max emails per hour" error. There is a default limit of 250 email per hour, which is covered in our guide <a href="http://www.inmotionhosting.com/support/email/mailing-lists/email-limit-exception-request-amp">Domain example.com has exceeded the max emails per hour</a>. <br />
<br />
You could space the emails out over a period of time, instead. For example, 200 per hour would allow you to send 4800 emails in a day.<br />
<br />
Another option would be to <a href="http://www.inmotionhosting.com/support/email/mailing-lists/email-limit-exception-request-amp">request an hourly email exemption request</a>. This will allow you to raise the hourly email to something that better suits your needs.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23605);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-31402'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/879a2cfdbfc384ed6d417fd6eb869f62?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/879a2cfdbfc384ed6d417fd6eb869f62'>Jason D</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-23 10:42 am</div>
				                <div><p>I have a user setting up Outlook 2011 for Mac and continually recieves this error message:</p>
<p>A secure connection cannot be established with the server xxx.inmotionhosting.com because its intermediate or root certificate cannot be found.</p>
<p>Options are Show Certificate (but cant find it to display), Cancel or continue. &nbsp;Continue will not allow any mail to arrive.</p>
<p>&nbsp;</p>
<p>Any Ideas? &nbsp;I'm at witts end with this one.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31402);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
