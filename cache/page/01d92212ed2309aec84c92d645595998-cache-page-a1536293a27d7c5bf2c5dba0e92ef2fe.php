<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:64091:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/moodle/new-to-moodle/edit-profile" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-10-26T19:42:27-07:00" />
  <meta name="keywords" content="moodle 2.3 edit profile settings username password picture modify editing modifying change changing" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="Users can edit their profiles within the My profile settings of the Settings section in Moodle 2.3. This tutorial will briefly explain the User profile settings." />
  <title>Editing the User profile in the My Profile Settings of Moodle - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/moodle/new-to-moodle/edit-profile" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:b3490a190aa88c2786e7673a7f7b68fa -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '185.80.130.124']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Editing the User profile in the My Profile Settings of Moodle									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>2,723</span></div>
							...
							<div style='clear:both;'></div>
								...
								<p>Users can edit their profiles within the <strong>My profile settings</strong> of the <strong>Settings</strong> section in Moodle 2.3. The <strong>User profile</strong> can be customized and fine tuned for specific Course related information. Extra fields can also be added to the profile. See the <a href="/support/edu/moodle/user-roles-moodle/user-profile-fields" target="_blank" title="Click here to visit this article">Editing User profile fields in Moodle</a> tutorial on this. This tutorial will briefly explain the User profile settings.</p>
<h3>Modifying My Profile Settings in the Moodle Edit Profile page</h3>
...
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/101/edit-profile/edit-profile-1-select.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="edit-profile-1-select-moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/101/edit-profile/edit-profile-1-select.gif" title="Click here to view the larger image" width="200" /></a> Navigate to <strong>My profile settings</strong> &gt; <strong>Edit profile</strong> in the <strong>Settings </strong>section on the left.
...
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/101/edit-profile/edit-profile-2-general.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="edit-profile-2-general-moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/101/edit-profile/edit-profile-2-general.gif" title="Click here to view the larger image" width="200" /></a>Next the <strong>User Profile</strong> page will load. The first section is the general information for the user. In this section, the Username and password can be changed. Also the basic information like <strong>First name</strong> and Last name (<strong>Surname</strong>), <strong>Email address</strong>, <strong>City/Town</strong>, <strong>Country</strong>, <strong>Language</strong>, and <strong>Description</strong> can be changed or edited here. <br style="clear: both;" />
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/101/edit-profile/edit-profile-3-drag-image.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="edit-profile-3-drag-image-moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/101/edit-profile/edit-profile-3-drag-image.gif" title="Click here to view the larger image" width="200" /></a>The user can upload an <strong>Avatar</strong> or <strong>profile picture</strong> in the <strong>Edit Profile page</strong>. In the <strong>User Picture</strong> section, drag an image to the <strong>New picture</strong> block. This will automatically upload an image to the user profile.</p>
<br style="clear: both;" />
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/101/edit-profile/edit-profile-4-interests-options.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="edit-profile-4-interests-options-moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/101/edit-profile/edit-profile-4-interests-options.gif" title="Click here to view the larger image" width="200" /></a> The <strong>Interests</strong> box if for listing Course related interests that will display on the <strong>User profile</strong>. Also, the Users webpage, phone number, Instant Messenger IDs for Skype, AIM, Yahoo, and MSN can be added in the <strong>Optional</strong> area. When done with the User Profile page, click <strong>Update profile</strong>.</p>
<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/101/edit-profile/edit-profile-5-final.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="edit-profile-5-final-moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/101/edit-profile/edit-profile-5-final.gif" title="Click here to view the larger image" width="200" /></a>Finally, when viewing the profile, the <strong>View profile</strong> page will look like the following snapshot.<br style="clear: both;" /></li>
</ol>
<p>This concludes the article for Editing the User profile in the My Profile Settings of Moodle. Please check the next article on <a target="_blank" href="/support/edu/moodle/new-to-moodle/user-messaging" title="Click here to view the next article">Configuring notification methods for incoming messages in Moodle</a>. If the previous tutorial was missed, please visit Please check the next article on <a target="_blank" href="/support/edu/moodle/new-to-moodle/restoring-moodle-backup" title="Click here to view the previous article">Restoring Moodle from a backup</a> to review the article. For more information on this Education Channel please visit <a target="_blank" href="/support/edu/moodle/new-to-moodle" title="Click here to view the courses">Getting Started with Moodle - Moodle</a></p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 13: Editing the User profile in the My Profile Settings of Moodle</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 12: <a href='/support/edu/moodle/new-to-moodle/restoring-moodle-backup'>Restoring Moodle from a backup</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 14: <a href='/support/edu/moodle/new-to-moodle/user-messaging'>Configuring notification methods for incoming messages in Moodle</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/moodle/new-to-moodle/edit-profile&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/moodle/new-to-moodle/edit-profile'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNzQmaWQ9MTk0MCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
        ...
        <tr><td colspan='2'><h4>My Profile Settings</h4></td></tr>  <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>13.</td>
