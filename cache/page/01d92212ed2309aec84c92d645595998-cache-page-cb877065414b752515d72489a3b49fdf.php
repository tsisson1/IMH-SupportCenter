<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:51883:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/whm/change-max-user-connections" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-01-15T13:56:04-08:00" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Need to increase the number of simultaneous users on your MySQL? We tell you how in this article." />
  <title>How to change max_user_connections in VPS/Dedicated - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/whm/change-max-user-connections" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:2e8ae4ead3e62a592f422987a2b1644a -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '183.182.110.160']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to change max_user_connections in VPS/Dedicated									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>2,066</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 14, 2015'><span style='color:#606060;'>Published:</span> Jan 15, 2015</div>
							...
							<div style='clear:both;'></div>
								...
								<p>There are times when you may need to allow more simultaneous connections to your database. Our default setting is to allow 30 connections. If you need to change the setting, however, you will need to do so within your my.cnf file. The instructions below tell you how to make the changes on your VPS or Dedicated server.</p>

<div class="alert"><strong>Note</strong>: Root access is required to be able to make this change.</div>

<h2>Modifying your max_user_connections setting</h2>

<ol class="article_list">
  <li>Log into your server via SSH.<div style="clear:both;"></div></li>
  <li>Move to the /etc folder.<div style="clear:both;"></div></li>
  <li>Open the my.cnf file for editing usng nano, vim, or your favorite editor.<div style="clear:both;"></div></li>
  <li>Locate the setting similar to below:
  <div class="code_block">max_user_connections=30</div>
  <div style="clear:both;"></div></li>
  <li>Change the setting to your required level. Example:
  <div class="code_block">max_user_connections=50</div>
    <div class="alert">Note that 30 is the recommended max for VPS while dedicated servers can go 60 or higher depending on RAM.</div>
  <div style="clear:both;"></div></li>
  <li>Close out your editor, saving the changes.<div style="clear:both;"></div></li>
</ol>

<p>Now that you have increased the max_user_connection settings your MySQL will be able to hole more simultaneous connections. Note that making this number too high can have adverse effects on the performance of the site, so tweaking to find the optimal number may be necessary.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 4: How to change max_user_connections in VPS/Dedicated</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 5: <a href='/support/edu/whm/delete-cpanel'>How to Delete a cPanel in WHM</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/whm/change-max-user-connections&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/whm/change-max-user-connections'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD04NiZpZD0zNDkzJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="297543155dbfff918b2e0d03f1fe767d" value="1" />	</div>
	</form>
<!-- <br />
