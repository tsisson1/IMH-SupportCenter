<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:54417:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/wordpress/recently-migrated-wp-website-not-working" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello vision9_wp, Thank you for your question on your WordPress site display. I visited your main site and do not see that error. I do see the site, tho..." />
  <title>Recently migrated WP website not working | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/wordpress/recently-migrated-wp-website-not-working" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:dd9c4609fc2786f3497417989f9b9806 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '38.97.64.195']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box straight_bottom'>
                <h1 style='font-size:26px;'>Recently migrated WP website not working</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/vizion9_wp'>vizion9_wp</a>
			<div>8 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-09-21 10:25 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>99</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I followed all the instructions for migration and each step was successful but a default page is showing when I try to reach the site. <br />
Message: &quot;If you're seeing this page instead of the one you were expecting:<br />
The IP address of the website may have changed recently<br />
The site in question may have been moved to another server<br />
You're accessing a hostname or IP that is not configured for web traffic on this server&quot;<br />
<br />
 I've waited hours for it propagate but still nothing. I can't even enter my wordpress admin page again. Should I be concerned or wait for a few more hours? Please help.</div>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px;'>
				<div style='font-size:12px; max-width:500px; overflow:auto;'>When I removed the shared ip address from my local host file, all I see is the website's loading gif in a continual state but the website i'snt actually loading. <br />
I also can't seem to access my wordpress admin page. An error page comes up with the following url: http://localhost/wp-admin/upgrade.php?_wp_http_referer=%2Fwp-admin%2F </div>
			...
			<td style='width:100px;' valign='top'>
				...
				<div class='smallgrey'>
					<a href='/support/community-support/users/vizion9_wp'>vizion9_wp</a><br />
					8 <a href='/support/team/points' target='_blank'>Points</a><br />
					2015-09-21 10:34 am EST
				</div>
			</td>
		</tr>
	</table>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_8156' id='upvote_answer_8156' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='8156' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_8156').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_8156' id='downvote_answer_8156' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='8156' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_8156').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello vision9_wp,<br />
<br />
Thank you for your question on your WordPress site display. I visited your main site and do not see that error. I do see the site, though it appears to be missing a theme element. Propagation can take up to 24 hours, depending on your local DNS refresh time. You can do a <a href="http://www.inmotionhosting.com/support/website/how-to/modifying-your-hosts-file">hosts file mod</a> in the meantime to see what the site looks like.<br />
<br />
Kindest Regards,<br />
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_8156').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_8156' id='form_comment_on_answer_8156' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Soon after i sent that message, the site did then show up. But as you said its missing the theme element. I will wait a little more to see what happens. Can you explain why i can't log into the admin section of wordpress at this time? Or would i be able to alter and update the wordpress site as if it were on my localhost machine after migration? </div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello vizion9_wp,<br />
<br />
It appears there are still some hard set URLs in the site pointing to localhost. You will want to make sure the URL was <a href="http://www.inmotionhosting.com/support/website/wordpress/wordpress-changing-the-site-url-and-home-settings">changed in the wp-config file</a>.<br />
<br />
Kindest Regards,<br />
Scott M</div>
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="d613bb094bdef22a42ff3f106c2ab749" value="1" />	</div>
	</form>
<!-- <br />
