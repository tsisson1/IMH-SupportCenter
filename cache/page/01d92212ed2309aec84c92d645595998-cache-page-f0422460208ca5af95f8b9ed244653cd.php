<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:83677:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/server-usage/what-is-high-system-resource-usage" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-04-15T18:21:15-07:00" />
  <meta name="keywords" content="high system server resource usage" />
  <meta name="author" content="Jacob Nicholson" />
  <meta name="description" content="In this article I'm going to take a few moments to explain what high system resource usage is, and some of the common things that tend to lead to these conditions happening on your server." />
  <title>What is high system resource usage? - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/server-usage/what-is-high-system-resource-usage" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:d949bcfcb580eb7d0d1539337b6c6bfc -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-22']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '115.111.176.13']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>What is high system resource usage?</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															What is high system resource usage?									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>20,931</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Mar 25, 2013'><span style='color:#606060;'>Published:</span> Apr 15, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In this article I'm going to take a few moments to explain what high system resource usage is, and some of the common things that tend to lead to these conditions happening on your server.</p>

<h2>What is resource usage?</h2>

<p>On servers there is a limited amount of resources available for use at any one given time, for all users on that server. The main resources that we monitor for high usage would be CPU usage, and disk usage.</p>

<h3>CPU Usage</h3>

<p>The processors or CPU cores on a server handle any tasks that your account sends to them, with typical tasks including running a server-side PHP script, connecting to a database, or sending email.</p>

<p>Because there is a set number of CPU cores per server, the amount of time that your account can request processing time from the CPUs is limited on a shared hosting platform. One user monopolizing CPU usage even unintentionally can lead to delays for other user's website requests, so this is why we monitor this usage and send out notices when we see problematic levels of CPU usage.</p>

<h3>Disk Usage</h3>

<p>Once the CPU has processed the instructions for the tasks it needs to complete for your account, it typically is going to require reading or writing information to the hard drive on the server.</p>

<p>Because the hard drive is shared by all the users on the server, excessive read or write requests to the disk can delay other user's requests from getting fulfilled in a timely manner. One user with an excessive amount of un-optimized MySQL queries for example could potentially cause other user's MySQL requests to delay or even time-out, so we also monitor this resource and alert when we notice high usage.</p>

<h2>What is high resource usage?</h2>

<p>Depending on the level of hosting that you have, either shared, VPS, or dedicated, your acceptable levels of resource usage will be different.</p>

<p>I would recommend reviewing my article on <a href="/support/website/server-usage/how-can-i-view-my-accounts-resource-usage" target="_blank">how can I view my account's resource usage</a> for ways that you can review your account's current resource usage levels, and also the acceptable levels of resource usage on each platform.</p>

<h2>Common high resource usage problems</h2>

<p>There are a lot of common things that could lead to high resource usage problems, and the list below is not meant to be 100% exhaustive, but rather the most common issues to our knowledge we see happening on accounts.</p>

<p>If you encounter a resource usage related problem that is not mentioned here, please use the <strong>Your Opinion Matters!</strong> form up at the top-right of this article to inform me. This way we can continue to expand our list and make it that much easier for the next customer that has a similar problem.</p>

<ul class="article_list">
<li><a href="/support/website/website-troubleshooting/excessive-amounts-of-errors" target="_blank">Excessive amount of errors</a>.</li>
<li><a href="/support/website/website-troubleshooting/malicious-user-activity-and-hacks" target="_blank">Malicious user activity and hacks</a>.</li>
<li><a href="/support/website/website-troubleshooting/inefficient-coding-of-your-website" target="_blank">Inefficient coding of your website</a>.</li>
<li><a href="/support/website/website-troubleshooting/intensive-cron-jobs-or-scheduled-tasks" target="_blank">Intensive cron jobs or scheduled tasks</a>.</li>
<li><a href="/support/website/website-troubleshooting/unattended-forums-getting-used-for-spam" target="_blank">Unattended forums getting used for spam</a>.</li>
<li><a href="/support/email/email-troubleshooting/imap-resource-usage" target="_blank">Heavy disk activity coming from IMAP e-mail accounts</a>.</li>
<li><a href="/support/website/website-troubleshooting/excessive-amount-of-plugins-modules-on-your-application" target="_blank">Excessive amount of plugins/modules on your application</a>.</li>
<li><a href="/support/website/website-troubleshooting/excessive-amount-of-spam-comments-or-guestbook-entries" target="_blank">Excessive amount of spam comments, or guestbook entries</a>.</li>
<li><a href="/support/website/website-troubleshooting/database-caching-reduce-duplicate-database-queries" target="_blank">No form of database caching to reduce duplicate database queries</a>.</li>
<li><a href="/support/website/website-troubleshooting/excessive-spam-filtering-forwarding-boxtrapper-usage" target="_blank">Excessive e-mail spam filtering, forwarding, and BoxTrapper usage</a>.</li>
<li><a href="/support/website/website-troubleshooting/traffic-surge-to-site-not-optimized-for-that-level-of-traffic" target="_blank">Large surges in traffic going to a site not optimized for that level of traffic</a>.</li>
<li><a href="/support/website/website-troubleshooting/search-engine-crawlers-automated-robots-not-being-controlled" target="_blank">Search engine crawlers and automated robots activity not being controlled</a>.</li>
<li><a href="/support/website/website-troubleshooting/excessive-cpu-processing-especially-image-manipulation" target="_blank">Excessive amounts of CPU processing especially related to image manipulation</a>.</li>
</ul>

<h2>Resolving high resource usage problems</h2>

<p>When encountering problems with high resource usage, there are several key things that you want to check to see if your problems can be resolved without having to upgrade to a more robust hosting platform.</p>

<h3>Application optimizations</h3>
<p>WordPress - <a href="/support/website/wordpress/how-to-optimize-wordpress">How to Optimize WordPress</a>&nbsp;|&nbsp;<a href="/support/edu/wordpress/recommended-wordpress-plugins/optimizing-wordpress-with-wp-super-cache">Optimizing WordPress with WP Super Cache</a>&nbsp;|&nbsp;<a href="/support/edu/wordpress/recommended-wordpress-plugins/optimizing-wordpress-with-w3-total-cache">Optimizing WordPress with W3 Total Cache</a>&nbsp;|&nbsp;<a href="/support/website/wordpress/disabling-the-wp-cronphp-in-wordpress">Disabling the wp-cron.php in WordPress</a></p>
<p>Joomla/Mambo - <a href="/support/website/joomla/how-to-optimize-joomla-mambo">How to Optimize Joomla/Mambo</a></p>
<p>Gallery2 - <a href="http://codex.gallery2.org/Gallery2:Performance_Tips" rel="nofollow">Gallery2 Performance Tips</a></p>
<p>vBulletin - <a href="http://www.vbulletin-faq.com/optimize-vbulletin-server.htm" rel="nofollow">Optimizing your vBulletin forum to run faster</a></p>
<p>Magento - <a href="http://www.magentocommerce.com/blog/comments/performance-is-key-notes-on-magentos-performance" rel="nofollow">Notes on Magento's performance</a> *Note: The developer's of Magento have warned about high resource usage, indicating it could be difficult to run on shared-hosting.</p>
<h3>General optimizations and best practices</h3>
<p>There are several online tools that can help you benchmark your website and provide some good starting points for general optimizations:</p>
<ul class="article_list">
<li><a href="http://www.gtmetrix" rel="nofollow">GTmetrix</a></li>
<li><a href="http://tools.pingdom.com/fpt/" rel="nofollow">Pingdom Tools</a></li>
<li><a href="http://www.websiteoptimization.com/services/analyze/" rel="nofollow">Web Page Analyzer</a></li>
</ul>
<p><strong>Dynamic page caching</strong> - Most website applications today will run a PHP/MySQL back-end. The PHP scripts are used to dynamically pull your content out of the MySQL database for your website. Most applications support some form of database caching either natively or via a plugin that can help cut down on duplicate database calls that can lead to excessive resource usage. This allows your site to serve more static HTML content which is quicker to load for your visitors, and less taxing on the server's resources.</p>
<p><strong>Search engines and bot activity</strong> - A lot of the time search engine crawlers, and other automated bots that are simply trying to index large portions of the Internet, could be among your highest amounts of traffic. This type of activity can sometimes have the same affect of multiple concurrent users on your website, and unlike humans they usually aren't going to wait a good amount of time before they request your next page, but instead just follow your links one after another until they have the complete site indexed.</p>
<p>You can read about the (robots.txt) file and <a href="/support/website/how-to/how-to-stop-search-engines-from-crawling-your-website">how to stop search engines from crawling your website</a>, for info on how to help control the way in which search engines crawl your website, and what sections they're allowed to index. If you for instance have an image gallery section of your website with photos of family and friends, that you might not necessarily want the whole world to know about, you can utilize (robots.txt) rules to tell search engines to igore that section of your site.</p>
<p>This is also helpful if you have some sections of your site that could require a lot of database activity or other type of high resource usage activity. That way you can still provide that service to your human visitors, but you're not wasting server resources to try to fulfil a bots requests for the same content.</p>
<p><strong>MySQL optimization</strong> - As your database gets more and more usage, over time there can be additional overhead and you might need to re-index, or re-organize your data. The easiest and qickest way to handle this would be by <a href="/support/website/databases/how-to-use-phpmyadmin-to-optimize-a-database">optimizing the database from phpMyAdmin</a> available from your cPanel. Sometimes this alone isn't enough, and a manual re-structuring of your data or indexes might be necessary to keep your database queries fast and efficient.</p>
<p>Typically with database problems we'll alert you if we notice hanging queries from our end, or a sudden increase in resource usage coming from your database activity. In most of these cases your site's code or database design would need to be reviewed by the developer that created your site, as they should have a good understanding of its functionality and what could be causing problems such as "delayed INSERTS" which is a common problem on shared-hosting.</p>
<p>Before either a developer or yourself starts messing around with your database trying to optimize things, it's generally recommend to first get comfortable with learning how to <a href="/support/website/databases/creating-importing-and-exporting-mysql-databases">export and import a MySQL database with phpMyAdmin</a>. That way you can always revert back to a good working copy of your database in the event that something is deleted in your optimization attempts by accident.</p>

<p>You should now hopefully have a good understanding of what high system resource usage is. If you continue to experience issues with high resource usage on your current hosting platform, you might be interested in <a href="/support/website/general-server-setup/upgrade-downgrade-hosting-plan" target="_blank">upgrading your hosting plan</a>, that way you would have a higher resource usage limit for your account.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/server-usage/what-is-high-system-resource-usage&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/server-usage/what-is-high-system-resource-usage'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD04NSZpZD0yNTIwJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/billing/my-website-cant-open-please-help?tsrc=rsbraq'>Website not responding due to high resource usage</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/server-usage/high-resource-usage-on-php-files?tsrc=rsbraq'>High resource usage with website</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/blacklist-check/my-ip-is-blocked-can-it-be-unblocked?tsrc=rsbraq'>My IP is blocked, can it be unblocked? </a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/new-customers/page-elements-render-slowly-with-inmotion-versus-media-temple-gs?tsrc=rsbraq'>Page Elements Render Slowly with InMotion versus Media Temple GS</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/server-usage/alert-email-for-account-resource-overage?tsrc=rsbraq'>Alert e-mail for Account Resource Overage</a>
                                </div>
...
<a name='comments'></a>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/4ac7e36dffbed0b53679fd1f91c79a42?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/4ac7e36dffbed0b53679fd1f91c79a42'>Samuel Hung</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-16 3:18 am</div>
				                <div><p>Hi, how can I find out what's causing the high resource usage for my hosted website? Can you inform me of the specific causes for our team to take corresponding actions to resolve these issues in a timely fashion. Thanks.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11635);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-16 10:06 am</div>
				                <div>Reasoning can greatly vary depending on your site.  I recommend &lt;a href=&quot;http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support&quot;&gt;submitting a ticket to technical support&lt;/a&gt; as they will be able to look further into your account and provide more specific details.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11655);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-20195'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/8276c5333caf76839965526f2639a6ce?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/8276c5333caf76839965526f2639a6ce'>Zeek.</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-31 10:42 am</div>
				                <div><p>I'm not sure why this should be an issue. If you're going to sell hosting, you should understand that over 50% of websites are going to be wordpress. If there's bots out there, handle security yourself. You're the hosting company. Don't sell me a pro plan saying I can have as many websites as you advertize then turn around and disable all of my sites telling me it's my fault. If you can't support something, don't sell it. Seems like a common problem. Seems like the way In Motion does business.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20195);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-02 2:45 pm</div>
				                <div>Hello Zeek,<br />
<br />
Our servers are perfectly able to handle websites under normal conditions. WordPress, Joomla, Drupal, and all the other php based CMSes out there are can quickly become unruly for any hosting server. That is where optimization comes into play. This reduces usage on individual accounts and works to the advantage of all accounts on the server. How many sites you can have is far less of an obstacle to an account than how much resources they consume. <br />
<br />
If someone set up something at their home that consumed enough electricity to harm the grid, the electric company would not allow them to do so for long.  The same goes with the hosting industry. What the site is composed of (Wordpress, etc) is not an issue. It is how well that site is optimized that is the key. We have very high traffic sites that use far less resources than slower traffic, poorly optimized sites who get usage warnings. <br />
<br />
Remember that hosting companies simply supply the space. The care, security, and behavior, and optimization of the site is the responsibility of the site owner. <br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20268);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-05-20 5:51 am</div>
				                <div><p>Because I have multiple sites. How can I see resource usage per site?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32830);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-05-20 9:06 am</div>
				                <div>Hello Sergey,<br />
<br />
If you are asking to see the CPU usage from each site that is not possible. Are you on a dedicated or VPS?<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32838);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
