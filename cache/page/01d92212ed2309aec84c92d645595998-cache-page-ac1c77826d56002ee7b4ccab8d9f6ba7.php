<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:76776:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/prestashop-15/restore-my-prestashop-modules" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Yes, that is the correct folder path to replace the files for. I recommend replacing them with the original PrestaShop files...." />
  <title>Restore my prestashop modules | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/prestashop-15/restore-my-prestashop-modules" rel="canonical" />
...
<script>
  ...
  ga('send', 'pageview');
	...
	<!-- cid:f75eb8f4fe685d7ab73977bca22d30d5 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '91.126.128.242']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Restore my prestashop modules</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='https://lh4.googleusercontent.com/-Y28N8TnDwK0/AAAAAAAAAAI/AAAAAAAAAGo/A-oy8-hHB1w/photo.jpg?sz=90' class='user_avatar' /><br />
			<a href='/support/community-support/users/MartinBenjamin'>MartinBenjamin</a>
			<div>116 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2014-07-30 9:04 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>3,253</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Dear all,<br />
<br />
It seems like my prestashop modules have some errors, my site are messed up, i had to put it on maintenance mode, is it possible to perhabs rollback to a previous installation with my back up (did when i upgraded to 1.6.0.8.) without losing any of my new products, images, catagories etc. Is it enough with a Database backup. Or are there some way to restore the modules?<br />
<br />
Any help much appreciated, thanks.  </div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_5335' id='upvote_answer_5335' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='5335' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_5335').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_5335' id='downvote_answer_5335' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='5335' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_5335').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>11,186 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2014-07-30 9:08 am EST
                		        </div>
					
		                </div>

				In addition to the database, you would also need to restore your files as well.  Did you create a backup of your files or just the database?  <br />
<br />
It may be possible to just resolve the errors.  Could you clarify what specific errors you are getting?
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_5335').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_5335' id='form_comment_on_answer_5335' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Thanks for your answer. <br />
It would be easier to resolve the issue than make a reinstall.<br />
I took my site out of maintenance mode, because it is easier to have a look than explaining. www.pitstop-international.com<br />
As you see at the top there are module error, shoppingcart error, also the product rating system are messed up, and the bottom of the page (cms, info ect.) But have also error in the backoffice, it dont show my avatar, the image seem to keep loading, everything else are working at the backoffice. <br />
<br />
Regarding the backup, i created a database backup via my prestashop backoffice, i also did a backup of my previous version at the backoffice &quot;1-click autoupgrade&quot; so i was able to rolllback. <br />
 </div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='https://lh4.googleusercontent.com/-Y28N8TnDwK0/AAAAAAAAAAI/AAAAAAAAAGo/A-oy8-hHB1w/photo.jpg?sz=90' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/MartinBenjamin'>MartinBenjamin</a><br />
									116 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2014-07-30 10:50 am EST
								</div>
				...
				<div style='padding:15px 15px 15px 76px; border:1px solid #ddd; border-top:0px; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Could you clarify what version of PrestaShop you were previously on?  Was it a minor update or a major update such as from 1.5 to 1.6?  1.6 changed a significant amount of  information so most 1.5 themes will not be compatible with 1.6.</div>
				...
				<div style='padding:15px 15px 15px 76px; border:1px solid #ddd; border-top:0px; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>It was a minor update, i used the 1-click upgrade from version 1.6.0.6 to the new one 1.6.0.8. And it is the default theme bootstrap.</div>
				...
				<div style='padding:15px 15px 15px 76px; border:1px solid #ddd; border-top:0px; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>It looks like the update may have broken 2rd party modules.  Try disabling any additional modules that you have added since the initial installation.</div>
				...
				<div style='padding:15px 15px 15px 76px; border:1px solid #ddd; border-top:0px; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>We had a friend to work on our site last night because we did have some mail errors, all that are sorted out now. I just talked to him on the phone, he told me that, he have copied the modules from public_html to the theme default_bootstrap modules (C-Panel) Perhabs thats the reason why all this have messed up. </div>
				...
				<div style='padding:15px 15px 15px 76px; border:1px solid #ddd; border-top:0px; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello MartinBenjamin,<br />
<br />
Yes, the next step in troubleshooting would be to remove those files temporarily to see if the regular behavior returns to the site.<br />
<br />
Kindest Regards,<br />
Scott M</div>
							...
							<td style='width:96px;' valign='top'>
								...
								<div class='smallgrey'>
									...
									37,019 <a href='/support/team/points' target='_blank'>Points</a>
				...
				<div style='padding:15px 15px 15px 76px; border:1px solid #ddd; border-top:0px; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>public_html/modules to the public_html/themes/default-bootstrap/modules</div>
				...
				<div style='padding:15px 15px 15px 76px; border:1px solid #ddd; border-top:0px; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>He said, all folders from public_html modules have been copied, and then he overwrited the folders in public_html/themes/default-bootstrap/modules </div>
				...
				<div style='padding:15px 15px 15px 76px; border:1px solid #ddd; border-top:0px; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Overwriting those default modules seems to be what caused the issue.  I recommend restoring those specific files from backup if you have them or replacing them with the default PrestaShop modules.</div>
				...
				<div style='padding:15px 15px 15px 76px; border:1px solid #ddd; border-top:0px; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>It is every folders in the public_html/themes/default-bootstrap/modules that has to be restored right. If i download my backup previous version 1.6.0.6 could i then copy the folder modules and then upload it via cPanel and then restore it. I also have the orginal prestashop 1.6.0.8 i could also take the modules from that.</div>
...
<div class=' straight_bottom not_best_answer'>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px; width:50px;' valign='top'>
<div class='vote_div'>
	<form method='post' name='upvote_answer_5338' id='upvote_answer_5338' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='5338' />
		<input type='hidden' name='component' id='component' value='qa' />
		<input type='hidden' name='vote_value' id='vote_value' value='1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_5338').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_5338' id='downvote_answer_5338' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='5338' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_5338').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>11,186 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2014-07-30 11:50 am EST
                		        </div>
					
		                </div>

				Yes, that is the correct folder path to replace the files for.  I recommend replacing them with the original PrestaShop files.
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_5338').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_5338' id='form_comment_on_answer_5338' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
					                <p>You must <a href='/support/login'>login</a> before you can post a comment about this answer.</p>
					        </div></div></div></div>
					</form>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>OK i´ll try that right away have the original PrestaShop installation folders right here. Thanks so far for your help.</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>I´ve restored every files with files/folders from a original installation, but nothing have changed, site are still messed up. ??</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>You may have further issues within your theme itself.  At this point, I recommend replacing the entire theme folder, as well as the modules folder.  <br />
<br />
If this still doesn't work, you may need to replace your entire PrestaShop installation and connect a new installation to your existing database.  Be sure to of course make a backup of all files and your database before making any changes.</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>I´ll try to replace the entire theme folder with the original.</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Have replaced the entire Theme folder, but sadly nothing has changed. How do i  replace my entire PrestaShop installation and connect a new installation to the existing database. I cant risk to lose my products, catagories etc.</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>First, make a backup of your current files.  Then, delete all of the PrestaShop files on the server and replace them with the default PrestaShop installation files.  From there, then replace the settings.inc.php file inside the config folder with your copy that you backed up. </div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Everything are very close to be back in order, except the shopping cart need to be moved, it is in a wrong position and default language are in Danish, but still some text are in English, strange as i´ve deactivated the english language.</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello Martin,<br />
<br />
If your shopping cart is in the wrong position you will probably want to look at our &lt;a href=&quot;http://www.inmotionhosting.com/support/prestashop-16/move-cart-block-after-upgrade&quot; target=&quot;_blank&quot;&gt;positioning the cart block after PrestaShop 1.6 upgrade&lt;/a&gt; guide for steps on how to fix that.<br />
<br />
If some text is still in English, I would assume that the Danish language pack doesn't include text for those particular sections of text. Looking at the &lt;a href=&quot;http://www.prestashop.com/en/translations&quot; target=&quot;_blank&quot;&gt;PrestaShop translations&lt;/a&gt; page it appears that the Danish language is only 80% complete, so this very well could be the case.<br />
<br />
- Jacob</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Thank you Jacob. I´ll look into the link you provided, and try to move the cart. After that then i´ll manually translate from english to the default language which in this case are danish. </div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Is it possible to use the translations folder from my old installation, where every text where translated fine, cause i´ve did it manually before. And then upload it ?? Save time that way.</div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello Martin,<br />
<br />
If you still have your original PrestaShop files you should be able to copy over your language overrides from this directory:<br />
<br />
&lt;span style=&quot;color: red;&quot;&gt;/themes/default-bootstrap/lang/&lt;/span&gt;<br />
<br />
...
- Jacob</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Just a quick update, site are up and running smoothly again after ALOT of work, thanks to staff at InMotion for directing me so I was able to sort out this mess. My backup was crucial in this situation, a reminder of how important it is to make regular backups. Thanks a have a great week.</div>
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="2a49bcdfc92c834056cdb9f7ca804765" value="1" />	</div>
	</form>
<!-- <br />
