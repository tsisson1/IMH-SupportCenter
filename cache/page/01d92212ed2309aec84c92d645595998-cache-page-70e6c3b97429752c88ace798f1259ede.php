<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49016:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/domain-names/what-is-parked-domain" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="For information about what a parked domain name is, please see the following article: Domain Names - What is the difference / how to work with Addon, Pa..." />
  <title>What is a parked domain? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/domain-names/what-is-parked-domain" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:a840bcfcfa22c01eca1bb129ea244476 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>What is a parked domain?</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-09-24 1:11 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>1,002</span>
			</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_4007' id='upvote_answer_4007' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='4007' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_4007').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_4007' id='downvote_answer_4007' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='4007' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_4007').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>5,399 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2013-09-24 1:13 pm EST
                		        </div>
					
		                </div>

				For information about what a parked domain name is, please see the following article:<br />
<br />
&lt;a href='http://www.inmotionhosting.com/support/domain-names/general-information/domain-names-what-is-the-difference-how-to-work-with-addon-parked-and-subdomains'&gt;Domain Names - What is the difference / how to work with Addon, &lt;strong&gt;Parked&lt;/strong&gt;, and Subdomains?&lt;/a&gt;<br />
&lt;i&gt;In this article, we will discuss what is the difference in add-on , parked, and subdomains.&lt;/i&gt;
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_4007').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_4007' id='form_comment_on_answer_4007' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/domain-names/what-is-parked-domain&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/domain-names/what-is-parked-domain'></div>
<script type='text/javascript'>
  (function() {
