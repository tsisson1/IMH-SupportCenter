<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:63004:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/moodle/changing-appearance-moodle/purge-clear-cache" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-12-03T19:20:14-08:00" />
  <meta name="keywords" content="Moodle 2.3 cache cleared server clear purge purging remove removing clearing" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="When working in Moodle 2.3, there comes a time when the cache will need to be cleared from the server. This Article will detail how to clear the cache from your Moodle site." />
  <title>Clearing or Purging the cache from Moodle 2.3 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/moodle/changing-appearance-moodle/purge-clear-cache" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:fc9585f1ade9a76094fb99f4525f6dea -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '205.237.24.7']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Clearing or Purging the cache from Moodle 2.3									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>11,757</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Dec 3, 2012'><span style='color:#606060;'>Published:</span> Dec 3, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>When working in Moodle 2.3, there comes a time when the cache will need to be cleared from the server. Cache is a static page that was saved by Moodle. This allows the Moodle site to load faster. When switching themes and making other changes within Moodle, the old theme or code may still continue to work after the site was updated. To fix this, the cache will need to be cleared.</p>
<p>There are 2 types of cache clearing in Moodle. The Theme cache, and the Purge all cache. When switching themes, the <strong>theme cache</strong> can be cleared to allow the new theme to function. If any changes were made in the code that are not found in the theme, the <strong>Purge all caches</strong> option will need to be used. The following will detail how to clear the cache from your Moodle site.</p>
<h3>Clearing the Theme cache in Moodle</h3>
...
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/107/purge-clear-cache/purge-caches-1-select.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="purge-caches-1-select-moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/107/purge-clear-cache/purge-caches-1-select.gif" title="Click here to view the larger image" width="75" /></a>Navigate to <strong>Site administration</strong> &gt; <strong>Appearance</strong> &gt; <strong>Themes</strong> &gt; <strong>Theme selecto</strong>r in the settings section. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/107/purge-clear-cache/purge-caches-2-clear.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="purge-caches-2-clear-moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/107/purge-clear-cache/purge-caches-2-clear.gif" title="Click here to view the larger image" width="200" /></a>At the top left of the page, click the Clear theme caches button. This will remove all cache related to the theme.<br style="clear: both;" /></li>
</ol>
<h3>Purging all cache in Moodle</h3>
<ol class="article_list">
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/107/purge-clear-cache/purge-caches-3-click.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="purge-caches-3-click-moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/107/purge-clear-cache/purge-caches-3-click.gif" title="Click here to view the larger image" width="75" /></a>To Clear all caches for moodle, navigate to <strong>Site administration</strong> &gt; <strong>Development</strong> &gt; <strong>Purge all caches</strong> in the Settings section. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/107/purge-clear-cache/purge-caches-4-purge.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="purge-caches-4-purge-moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/107/purge-clear-cache/purge-caches-4-purge.gif" title="Click here to view the larger image" width="200" /></a>On the purge all caches page, click <strong>Purge all caches</strong>.<br style="clear: both;" />
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/107/purge-clear-cache/purge-caches-5-continue.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="purge-caches-5-continue.-moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/107/purge-clear-cache/purge-caches-5-continue.gif" title="Click here to view the larger image" width="75" /></a><strong>Click continue</strong><br style="clear: both;" /></p>
</li>
</ol>
<p>Congratulating, the cache was cleared for your site. This concludes the tutorial on Clearing or Purging the cache from Moodle 2.3. For more information on this Education Course please visit <a target="_blank" href="/support/edu/moodle/changing-appearance-moodle" title="Click here to view the courses">Changing the Appearance of Moodle</a></p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 7: Clearing or Purging the cache from Moodle 2.3</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 8: <a href='/support/edu/moodle/changing-appearance-moodle/customize-front-page'>Customizing the Moodle Frontpage Appearance</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/moodle/changing-appearance-moodle/purge-clear-cache&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/moodle/changing-appearance-moodle/purge-clear-cache'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yOTQmaWQ9MjAzNCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="2d3277e308bfddacf2a4a480ef8a0fec" value="1" />	</div>
	</form>
<!-- <br />
