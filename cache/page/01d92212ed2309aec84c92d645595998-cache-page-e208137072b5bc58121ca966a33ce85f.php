<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:60117:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/movable-type/create-blog-movable-type/using-activity-log" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-03-14T16:10:48-07:00" />
  <meta name="keywords" content="error reporting activity logs movable type" />
  <meta name="author" content="Arnel Custodio" />
  <meta name="description" content="The Movable Type activity log is used to track all events occurring within the application's websites and blogs.  The following article shows how to locate and use the Activity Log within the Movable Type dashboard." />
  <title>Using the Activity log in Movable Type - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/movable-type/create-blog-movable-type/using-activity-log" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:6601ae51c45e8806cf84570de4abecce -->
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/movable-type' itemprop='url'><span itemprop='title'>Movable Type<span></a><div class='dropdown_4columns'><h2>Movable Type Education Channel</h2><div class='col_2'><h3>100 Level Classes</h3><div><a href='/support/edu/movable-type/geting-started-movable-type'>101: Getting Started with Movable Type</a></div><div><a href='/support/edu/movable-type/adding-content-movable-type'>102: Adding Content to Movable Type</a></div><div><a href='/support/edu/movable-type/change-theme-template-movable-type'>103: Changing the Appearance of Movable Type</a></div><div><a href='/support/edu/movable-type/widgets-movable-type'>104: Working with Widgets in Movable Type</a></div><div><a href='/support/edu/movable-type/create-blog-movable-type'>105: Creating a Blog in Movable Type</a></div></div><div class='col_2'><h3>200 Level Classes</h3><div><a href='/support/edu/movable-type/site-security-in-movable-type'>201: Site Security in Movable Type</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/movable-type/create-blog-movable-type' itemprop='url'><span itemprop='title'>105: Creating a Blog in Movable Type<span></a><div class='dropdown_3columns'><h2> Creating a Blog in Movable Type</h2><div class='col_3'><div>1. <a style='display:inline;' href='/support/edu/movable-type/create-blog-movable-type/creating-blog'>Creating a Blog in Movable Type</a></div><div>2. <a style='display:inline;' href='/support/edu/movable-type/create-blog-movable-type/create-new-user'>How to register a user in Movable Type</a></div><div>3. <a style='display:inline;' href='/support/edu/movable-type/create-blog-movable-type/register-new-account'>How to register for an account in Movable Type</a></div><div>4. <a style='display:inline;' href='/support/edu/movable-type/create-blog-movable-type/change-preferred-language'>How to change your user profile language in Movable Type</a></div><div>5. <a style='display:inline;' href='/support/edu/movable-type/create-blog-movable-type/using-activity-log'>Using the Activity log in Movable Type</a></div><div>6. <a style='display:inline;' href='/support/edu/movable-type/create-blog-movable-type/using-the-movable-type-quickpost-bookmarklet'>Using the Movable Type QuickPost bookmarklet</a></div><div>7. <a style='display:inline;' href='/support/edu/movable-type/create-blog-movable-type/set-auth-methods'>Allowing different authentication methods in Movable Type</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Using the Activity log in...</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Using the Activity log in Movable Type									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>937</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Mar 12, 2013'><span style='color:#606060;'>Published:</span> Mar 14, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<div>Anytime an event occurs in Movable Type, it is noted within an activity log. &nbsp;This log will capture errors as well as successful events such as a blog entry or page creation. &nbsp;The following article explains where to find the Activity log and its available options within the Movable Type Dashboard.</div>
<div>&nbsp;</div>
<h2>Understanding the Activity Log within Movable Type</h2>
<div>&nbsp;</div>
<h3>Locating the Activity Log</h3>
<div><ol class="article_list">
<li><a href="/support/edu/movable-type/geting-started-movable-type/moveable-type-admin" target="_blank">Login to the Movable Type</a>.</li>
<li>Scroll down the left hand side menu to the bottom and click on <strong>TOOLS</strong>. &nbsp;At the bottom of the <strong>TOOLS</strong> menu you should see <strong>ACTIVITY LOG</strong>. &nbsp;Click on <strong>ACTIVITY LOG</strong>.<br /><br /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mt/activitylog/activity-log-main.png"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/mt/activitylog/activity-log-main.png" alt="Activity log - main view"  style="margin: 0px 0px 15px 15px; float: right;" height="215" width="200" /></a>When you enter the activity log, you will see a table listing the most recent events. &nbsp;You can use the <strong>DISPLAY</strong> options (in the top right corner) to determine the number of events that will be listed. Click on <strong>DISPLAY OPTION</strong> in the top right hand corner.</li>
<li>You will see the option to show 25-200 rows fo results. &nbsp;You also have the option of showing or hiding the <strong>IP ADDRESS</strong> column. &nbsp;Uncheck the box to hide the column. &nbsp;If you wish, click on the <strong>RESET DEFAULTS</strong> option at the bottom to start over.</li>
<li>Click on the <strong>DISPLAY OPTIONS</strong> drop-down arrow to close the display options.</li>
</ol>
<div style="clear: both;">&nbsp;</div>
<h3>Filtering the Error Messages<span style="font-size: 11px;">&nbsp;</span></h3>
<div><ol class="article_list">
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mt/activitylog/show-errors-option.png"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/mt/activitylog/show-errors-option.png" alt="Show Errors"  style="margin: 0px 0px 15px 15px; float: right;" height="148" width="200" /></a>While logged into the Dashboard, and in the <strong>ACTIVITY LOG</strong> section (as per the instructions above), click on <strong>ALL LOG MESSAGES</strong> (next to <strong>FILTER</strong>). &nbsp;This will bring up the option select a filter. &nbsp;You can create a new filter or select a built-in filter. &nbsp;</li>
<li>Click on <strong>SHOW ONLY ERRORS</strong>.</li>
<li>This will isolate only the error messages within the log, if there are any reported. In order to return to the original view, click on the red-lettered <strong>REMOVE FILTER</strong> option.</li>
</ol>
<div style="clear: both;">&nbsp;</div>
<h3>Clear or Download the Activity Log&nbsp;<span style="font-size: 11px;">&nbsp;</span></h3>
<div><ol>
<li>Upon opening the Activity Log Page, the option to clear the log is located at the top of the interface. &nbsp;The option will ask that you configure the action before actually clearing the log. Click on the <strong>CLEAR ACTIVITY LOG</strong> option in order to clear the log. &nbsp;Click on <strong>YES</strong> to clear, or <strong>NO</strong> in order to cancel the action.</li>
<li>To the right of <strong>CLEAR ACTIVITY LOG</strong> is<strong> DOWNLOAD LOG (CSV)</strong>. &nbsp;This option allows the user to select a download of the activity log in CSV format. &nbsp;You will be prompted to confirm the download and detemine where the file will be saved.</li>
</ol>
<div>&nbsp;</div>
<h3>Activity Feed<span style="font-size: 11px;">&nbsp;</span></h3>
<div><ol class="article_list">
<li>The final option available for the <strong>ACTIVITY LOG</strong> is the option to subscribe to an Activity Feed. &nbsp;This is at the bottom of the page. &nbsp;Click on <strong>ACTIVITY FEED</strong>. If you need more information on RSS (Really Simple Syndication), go to <a href="http://www.whatisrss.com/" target="_blank" rel="nofollow"><em>RSS Primer</em></a>.<br /><br /></li>
<li>You will see a typical RSS subscribe screen. &nbsp;Anytime an activity occurs, you will get a feed update through your RSS reader. &nbsp;This is illustrated in the screenshot below. You can use any RSS reader to subscribe to the feeds.<br /><br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mt/activitylog/subscribe-activity-feed.png"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/mt/activitylog/subscribe-activity-feed.png" alt="Movable Type RSS Activity Log"  /></a><br /><br /></li>
</ol></div>
</div>
<div>&nbsp;</div>
</div>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/movable-type/create-blog-movable-type'>105: Creating a Blog in Movable Type</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 5: Using the Activity log in Movable Type</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 4: <a href='/support/edu/movable-type/create-blog-movable-type/change-preferred-language'>How to change your user profile language in Movable Type</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 6: <a href='/support/edu/movable-type/create-blog-movable-type/using-the-movable-type-quickpost-bookmarklet'>Using the Movable Type QuickPost bookmarklet</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/movable-type/create-blog-movable-type/using-activity-log&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/movable-type/create-blog-movable-type/using-activity-log'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zNDUmaWQ9MjI5NyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="3afcfd87906a2c5c8c459a5b860e7dee" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/movable-type/create-blog-movable-type?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Creating a Blog in Movable Type</h3></a>
		<table><tr><td colspan='2'><h4>Setting up a Blog</h4></td></tr>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/movable-type/create-blog-movable-type/creating-blog?tsrc=rsbedu'>Creating a Blog in Movable Type</a></td>
                </tr>
        <tr><td colspan='2'><h4>Managing Users</h4></td></tr>  <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/movable-type/create-blog-movable-type/create-new-user?tsrc=rsbedu'>How to register a user in Movable Type</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/movable-type/create-blog-movable-type/register-new-account?tsrc=rsbedu'>How to register for an account in Movable Type</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/movable-type/create-blog-movable-type/change-preferred-language?tsrc=rsbedu'>How to change your user profile language in Movable Type</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/movable-type/create-blog-movable-type/using-activity-log?tsrc=rsbedu'>Using the Activity log in Movable Type</a></td>
                </tr>
        <tr><td colspan='2'><h4>Blog features </h4></td></tr>  <tr >
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/movable-type/create-blog-movable-type/using-the-movable-type-quickpost-bookmarklet?tsrc=rsbedu'>Using the Movable Type QuickPost bookmarklet</a></td>
                </tr>
          <tr >
                        <td valign='top'>7.</td>
                        <td><a href='/support/edu/movable-type/create-blog-movable-type/set-auth-methods?tsrc=rsbedu'>Allowing different authentication methods in Movable Type</a></td>
                </tr>
          	</table>
