<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:60207:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/prestashop-16/assign-category" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-02-27T23:28:53-08:00" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Learn how to assign your product to the proper categories in PrestaShop 1.6." />
  <title>Assigning your products to categories in PrestaShop 1.6 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/prestashop-16/assign-category" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:0f77214c7edbbfd03222215c5ac71793 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '79.189.209.249']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Assigning your products to categories in PrestaShop 1.6									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>4,812</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Feb 27, 2014'><span style='color:#606060;'>Published:</span> Feb 27, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Once you have <a href="/support/prestashop-16/add-product">created</a> and <a href="/support/prestashop-16/set-pricing">priced</a> your product, you will want to add it to a category so that it is easily found in your store. You can associate products with more than one category. You will also want to assign them to as many relevant categories as possible. This tutorial walks you through the basics of assigning a product to a category in PrestaShop 1.6.
</p>

<h2>How to add your product to a category</h2>

<ol class="article_list">
  <li><a href="/support/prestashop-16/admin-login">Log into the admin interface</a>.<div style="clear:both;"></div></li>
  <li>From the main dashboard screen, first click on the <strong>Catalog</strong> and then the <strong>Products</strong> tab.<div style="clear:both;"></div></li>
  <li>From your main <em>Products</em> list page, click on the <strong>Edit</strong> button on the row of your selected product.<div style="clear:both;"></div></li>
  <li>From the main <em>Information</em> page fo the product, click on the <strong>Associations</strong> tab.<div style="clear:both;"></div></li>
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/ps16/products/add-association/1-default-association-screen.png"><img   style="float:right; margin:0px 0px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/ps16/products/add-association/1-default-association-screen.png" title="Click here to view the larger image" width="200" /></a>This is the Associations tab. From here, select the <strong>Expand All</strong> tab so you can see full category list.<div style="clear:both;"></div></li>
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/ps16/products/add-association/2-add-association-data.png"><img   style="float:right; margin:0px 0px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/ps16/products/add-association/2-add-association-data.png" title="Click here to view the larger image" width="200" /></a>From here, select on all relevant categories for your product. In our example, we selected the <strong>Televisions</strong> category. Note that the <em>Home</em> category is also selected by default. You may deselect that if you wish. If you need to create a new category to add to the list, click the <strong>Create new category</strong> link.<div style="clear:both;"></div></li>
  <li>If you have selected more than one category for your product, you will need to choose one of them to be the Default category. If you only selected one category, it will be the only one in the dropdown to select.<div style="clear:both;"></div></li>
  <li>The <em>Accessories</em> field allows you to list other products to go along with this one. As you begin typing in the product name it will appear in the field.<div style="clear:both;"></div></li>
  <li>The last field is where you will select the manufacturer from the dropdown list. If you need to add the manufacturer, click on the <strong>Create New Manufacturer</strong> link.<div style="clear:both;"></div></li>
  <li>Once you have added all the category information for your product, click on either the <strong>Save and Stay</strong> or the <strong>Save</strong> buttons to save the data.<div style="clear:both;"></div></li>
</ol>
<br />
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/ps16/products/add-association/after.png"><img   style="float:right; margin:0px 0px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/ps16/products/add-association/after.png" title="Click here to view the larger image" width="200" /></a>Once you have completed the association, you can visit your site and see that the product appears under the category page.</p>
<div style="clear:both;"></div> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/prestashop-16/assign-category&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/prestashop-16/assign-category'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00OTMmaWQ9MzEyNiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="a77e03e7ff5def77a8ee380f9fa89eba" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/prestashop-15/how-do-i-make-a-category-a-subcategory-in-prestashop-16?tsrc=rsbraq'>How do I make a category a subcategory in PrestaShop 1.6 ?</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/53bcdbccd763f386d34b7d0da2f972f1?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/53bcdbccd763f386d34b7d0da2f972f1'>Diptiman</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-21 1:38 am</div>
				                <div><p>Hi, I am looking for more than one category assigned in one product. Is it possible. E.g - A unisex beauty cream for both men and women category.</p>
<p>Can you help me in this point.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10749);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-21 8:00 am</div>
				                <div>Within the &lt;em&gt;Associated Categories&lt;/em&gt; section, you may select as many checkboxes as apply to place the product in multiple categories.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10761);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-27699'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/26bf17f9cbe1ef42b8473778553d1ea8?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/26bf17f9cbe1ef42b8473778553d1ea8'>Ahmed</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-20 7:31 am</div>
				                <div><p>Hi,</p>
<p>Is there a way to quickly assign multiple items to a category?&nbsp; instead of going to each item one by one and assign each of them to a category, is there a way to open a category and list the products that belong to them?</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27699);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-26 11:45 am</div>
				                <div>Hello Ahmed,<br />
<br />
You can use an addon like the ones listed <a href="http://addons.prestashop.com/en/13-bulk-update-prestashop-modules">here for quick edits</a>. <br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27870);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
