<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:64637:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-file-manager/file-manager-code-editor" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-09-15T15:41:09-07:00" />
  <meta name="keywords" content="file manager code editor edit server editing cpanel" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="File manager has the handy code editor to make immediate server changes. This article will explain the code editor." />
  <title>How to Use the Code Editor in the cPanel File Manager - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-file-manager/file-manager-code-editor" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:dd89fc9ea74b5928df8408c38d390aca -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '174.60.148.142']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to Use the Code Editor in the cPanel File Manager									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>18,997</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 9, 2013'><span style='color:#606060;'>Published:</span> Sep 15, 2015</div>
							...
							<div style='clear:both;'></div>
								...
								<p><strong>Editing code</strong> on your web site is an inevitable event. If you have minor changes to make on your web site that can be done simply, you can use the <strong>code editor</strong> in the <strong>cPanel</strong> <strong>File Manager</strong> to change the code. This is called "<em>Editing on the fly</em>", which is changing the files of the source website while its live. Let's go to cPanel File manager and see how this editor works.</p>
<p class="alert"><strong>Important!</strong> Editing the code in a file on the server can break your website. Because the file is being used by the live website, we always recommend editing a backup copy of your site instead of the files on the server. Make a backup copy of the file before editing it by saving the file as a different name.</p>
<h2>Using use the Code Editor in cPanel</h2>
<ol class="article_list">
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/cpanel/201/code-editor/code-editor-cpanel-1-home.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="Cpanel home page" src="//cdn.inmotionhosting.com/support/images/stories/edu/cpanel/201/code-editor/code-editor-cpanel-1-home.gif" title="Click here to view the larger image" width="100" /></a><a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel" target="_blank" title="Click here for info">Login into your cPanel</a>.<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/cpanel/201/code-editor/code-editor-cpanel-2-file-manager.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="File manager cpanel" src="//cdn.inmotionhosting.com/support/images/stories/edu/cpanel/201/code-editor/code-editor-cpanel-2-file-manager.gif" title="Click here to view the larger image" width="100" /></a><a href="/support/edu/cpanel/cpanel-file-manager/using-file-manager-in-cpanel" target="_blank" title="Click here for info">Go to the File Manager</a>.<br style="clear: both;" />
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/cpanel/201/code-editor/code-editor-cpanel-3-directory-selection.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Select teh directory in File manager" src="//cdn.inmotionhosting.com/support/images/stories/edu/cpanel/201/code-editor/code-editor-cpanel-3-directory-selection.gif" title="Click here to view the larger image" width="100" /></a>Select the directory the file is located in and <strong>click Go</strong>.<br style="clear: both;" /></p>
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/cpanel/201/code-editor/code-editor-cpanel-4-select-file.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Select teh file and click code editor" src="//cdn.inmotionhosting.com/support/images/stories/edu/cpanel/201/code-editor/code-editor-cpanel-4-select-file.gif" title="Click here to view the larger image" width="100" /></a><strong>Navigate to the page</strong> you want to edit. <strong>Select the file</strong> and <strong>click code editor</strong>. <br style="clear: both;" />
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/cpanel/201/code-editor/code-editor-cpanel-5-interface.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Code Editor Interface" src="//cdn.inmotionhosting.com/support/images/stories/edu/cpanel/201/code-editor/code-editor-cpanel-5-interface.gif" title="Click here to view the larger image" width="100" /></a>Now you should see the basic code editor interface.</p>
<p>This is where you can add code or change code in your file.</p>
<p>When you are done making the changes, you can <strong>click Save Changes</strong> at the top right. Otherwise, click cancel.</p>
<p>The code editor has the following features.<br style="clear: both;" /></p>
<table class="article_table">
<tbody>
<tr><th colspan="2">Code editor properties</th></tr>
<tr>
<td><strong>Editing:</strong></td>
<td>This is the path to the file location of the file you are editing.</td>
</tr>
<tr>
<td><strong>Line numbering</strong></td>
<td>Code editor will place all code in lines for an easier time in locating lines of code.</td>
</tr>
<tr>
<td><strong>Find and Replace</strong></td>
<td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/cpanel/201/code-editor/code-editor-cpanel-6-find-and-replace.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Find and Replace box code editor" src="//cdn.inmotionhosting.com/support/images/stories/edu/cpanel/201/code-editor/code-editor-cpanel-6-find-and-replace.gif" title="Click here to view the larger image" width="100" /></a>By entering <strong>Ctrl + F</strong> on your keyboard at the same time, the find and replace box shows. This is handy for making multiple changes to the same code.<br style="clear: both;" /></td>
</tr>
<tr>
<td><strong>Highlighted code</strong></td>
<td>The code highlighter can be turned on or off. The color coding helps find blocks of code of the same code type easier. This can be turned off.</td>
</tr>
<tr>
<td><strong>Use Text editor</strong></td>
<td>This allows the interface to switch back and forth from the text editor to the code editor.</td>
</tr>
<tr>
<td><strong>Encoding</strong></td>
<td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/cpanel/201/code-editor/code-editor-cpanel-7-encoding.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Encoding selection code editor cpanel" src="//cdn.inmotionhosting.com/support/images/stories/edu/cpanel/201/code-editor/code-editor-cpanel-7-encoding.gif" title="Click here to view the larger image" width="100" /></a>The encoding drop box allows the page encoding type to be changed on the server. This is useful for foreign language sites or other programming code requirements.<br style="clear: both;" /></td>
</tr>
</tbody>
</table>
<br style="clear: both;" /></li>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 4: How to Use the Code Editor in the cPanel File Manager</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 5: <a href='/support/edu/cpanel/cpanel-file-manager/coming-soon-page'>Creating an Under Construction or Coming Soon page</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/cpanel/cpanel-file-manager/file-manager-code-editor&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/cpanel/cpanel-file-manager/file-manager-code-editor'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xMzUmaWQ9MjEyOCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="e8c216fff80ebb0df91f22cbdf2adf3d" value="1" />	</div>
	</form>
<!-- <br />
          ...
          <tr >
			...
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/opencart/edit-product-tpl-file?tsrc=rsbraq'>OpenCart Product.tpl file needs edit</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support//?tsrc=rsbraq'>Where is the &quot;head section of your main website code. &quot; ?????</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						...
						<div><a style='font-size:16px;' href='//www.gravatar.com/081bfe6f83516d6ca41156bf39329583'>Peter</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-30 11:41 am</div>
				                <div><p>When you make a copy of the file to edit by saving it under a different name then how do you implement the change? Do you have to delete the orginal file?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13474);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-30 11:45 am</div>
				                <div>If you save the file under a different name, it will create a second copy of the file.  If you want to replace the original with that file, you would need to remove the original and rename the copy.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13475);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
