<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50042:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/file-management/filezilla-fails-with-msld-command" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Thank you for your question KyleYoung101! If you are connecting over a TLS connection, make sure you are using the SSL host. For example, the non SSL ho..." />
  <title>Filezilla fails with MSLD Command | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/file-management/filezilla-fails-with-msld-command" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:aea6517cf00087a7b54750852b30d447 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '108.171.128.164']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Filezilla fails with MSLD Command</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/KyleYoung101'>KyleYoung101</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-01-01 9:13 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>1,853</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I am attempting to use Filezilla to connect to my website. the connection seems to be established, but the connection times out when the MLSD command is issued, and fails to retrieve the directory listing. I am connected through a commercial VPN, since I have no private internet connection. <br />
On another note, when attempting to connect through FTP using explicit TLS, I get the error:<br />
GnuTLS error -110: The TLS connection was non-properly terminated.<br />
Error:	Transfer connection interrupted: ECONNABORTED - Connection aborted<br />
<br />
</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_2052' id='upvote_answer_2052' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='2052' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_2052').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_2052' id='downvote_answer_2052' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='2052' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_2052').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>5,889 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2013-01-02 9:59 am EST
                		        </div>
					
		                </div>

				Thank you for your question KyleYoung101!<br />
<br />
If you are connecting over a TLS connection, make sure you are using the SSL host. For example, the non SSL host will be like the following.<br />
<br />
&lt;span style=&quot;margin-left:20px&quot;&gt;ftp.yourdomain.com&lt;/span&gt;<br />
<br />
The SSL connection on a shared server will use something similar to the following.<br />
<br />
&lt;span style=&quot;margin-left:20px&quot;&gt;secure##.inmotionhosting.com&lt;/span&gt;<br />
<br />
If you don't use the SSL host on a TLS connection, you will have connection issues. Hope this helps.<br />
<br />
Regards,<br />
James R
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_2052').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_2052' id='form_comment_on_answer_2052' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/file-management/filezilla-fails-with-msld-command&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/file-management/filezilla-fails-with-msld-command'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="b929d8da01097bc253617cb7bc9ddfa0" value="1" />	</div>
	</form>
<!-- <br />
