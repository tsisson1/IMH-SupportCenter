<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:61239:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/htaccess/access-specific-filetype" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-08-16T19:52:40-07:00" />
  <meta name="keywords" content="secure directory allow access certain specific file types" />
  ...
  <link href="http://www.inmotionhosting.com/support/website/htaccess/access-specific-filetype" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:50d89883f4dd884f07364760aaa3aa25 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '78.152.245.220']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Allow access to specific file types in a protected directory</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Allow access to specific file types in a protected directory									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>8,599</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Feb 21, 2013'><span style='color:#606060;'>Published:</span> Aug 16, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>For security reasons, many users like to protect directories from intrusion. This prevents people from injecting php or other malicious code or scripts into the directories. However, locking down a directory entirely may prevent access to specific tile types you do wish people to view, such as images. The instructions below will explain how to lock down a directory from access while still allowing any file of a given type to be accessed by setting up code in your .htaccess file.</p>
<h2>How to allow access to certain file types for protected directories via htaccess</h2>
<ol class="article_list">
<li><a target="_blank" href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">Log into your cPanel</a> cPanel dashboard.</li>
<li>From the main cPanel page, <a target="_blank" href="/support/edu/cpanel/cpanel-file-manager/using-file-manager-in-cpanel">use the File Manager</a> to access the root folder of your domain. Be sure you have the <strong>Show Hidden Files (dotfiles)</strong> option selected as we will be editing the .htaccess file.</li>
...
<li>Once inside the folder you want to protect, check to see if there is an existing <a target="_blank" href="/support/edu/cpanel/cpanel-file-manager/using-file-manager-in-cpanel">.</a> <em>.htaccess</em> file. If not, you will need to create a new one by clicking the <strong>New File</strong> button in the upper toolbar and naming it <em>.htaccess</em> (be sure to place the . at the front!). Once you find or create the <em>.htaccess</em> file, open the file for editing.</li>
<li>Now that you are in the editor, we will set the directory to be very secure, denying access for all file types. Below is the code you want to insert into the <em>.htaccess</em> file. <br />
<div class="code_block"><files>Order Allow,Deny <br />Deny from all <br /> </files></div>
</li>
<li>Since we have now set the security, we now want to allow access to our desired file types. To do that, add the code below to the .htaccess file under the security code you just inserted. <br />
<div class="code_block">&lt;FilesMatch "\.(jpg|gif|png)$"&gt;<br />Order Deny,Allow<br />&nbsp;&nbsp; &nbsp;Allow from all<br />&lt;/FilesMatch&gt;</div>
...
<div style='display:inline-block;'>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MTMmaWQ9NTgwJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="ead0d1293bccdc6398297ff9301a9ed0" value="1" />	</div>
	</form>
<!-- <br />
