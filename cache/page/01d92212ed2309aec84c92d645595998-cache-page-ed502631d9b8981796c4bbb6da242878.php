<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:62201:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/wordpress/cleaning-up-old-post-meta-data-in-wordpress" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-10-31T17:12:22-07:00" />
  ...
  <title>Cleaning up old post meta data in WordPress - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/wordpress/cleaning-up-old-post-meta-data-in-wordpress" rel="canonical" />
...
<script>
  ...
  ga('send', 'pageview');
	...
	<!-- cid:6badf762d8a2d771924b69b0d88b85a9 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '177.64.138.222']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Cleaning up old post meta data in WordPress</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Cleaning up old post meta data in WordPress									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>3,289</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Oct 9, 2014'><span style='color:#606060;'>Published:</span> Oct 31, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Over time, as posts are updated, created, or deleted, the <em>wp_postmeta</em> table can become large and inhibit your website performance.  In this article, we are going to show you how to clean up old, unnecessary post meta data from the <em>wp_postmeta</em> table to help your WordPress site run more efficiently.</p>
<ol class="article_list">
  <li style='clear:both;'><p>Before continuing, make a <a href="http://www.inmotionhosting.com/support/website/backup-and-restore/backup-your-database-in-cpanel">backup of your database</a>.  This step is critical as we are making mass deletions can potentially break things on your site.</p></li>
  <li style='clear:both;'><p><a href="http://www.inmotionhosting.com/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">Log into cPanel</a>.</p></li>
  <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress/clean-postmeta-1.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress/clean-postmeta-1.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>Next, scroll down to the <strong>Databases</strong> section and click on <strong>PHPMyAdmin</strong>.</p></li>
  <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress/clean-postmeta-2.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress/clean-postmeta-2.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>Within PHPMyAdmin, select your WordPress database on the left side column.  If you are unsure of the database that your WordPress site is using, follow our guide on <a href="http://www.inmotionhosting.com/support/edu/wordpress/324-find-db-name">finding your WordPress database name</a>.</p></li>
  <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress/clean-postmeta-3.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress/clean-postmeta-3.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>At the top of the page, click on <strong>SQL</strong>.</p></li>
  <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress/clean-postmeta-4.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress/clean-postmeta-4.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>Inside the text area, enter the following:</p>
    <p class="code_block">SELECT * FROM wp_postmeta pm LEFT JOIN wp_posts wp ON wp.ID = pm.post_id WHERE wp.ID IS NULL;<br>
DELETE pm FROM wp_postmeta pm LEFT JOIN wp_posts wp ON wp.ID = pm.post_id WHERE wp.ID IS NULL;</p>
  <li style='clear:both;'><p>Then, press the <strong>Go</strong> button on the bottom right.</p></li>
  <div style='clear:both;'></div>
</ol>
    <p>PHPMyAdmin will either let you know how many items it removed, or state that the result is empty which means that nothing was found.  Congratulations!  Your <em>wp_postmeta</em> table has now been cleaned up.</p> 
...
<div style='display:inline-block;'>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD02MyZpZD0zNDA0JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="04f376f154cc3906f60f68c57b19eb54" value="1" />	</div>
	</form>
<!-- <br />
