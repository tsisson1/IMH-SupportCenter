<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:54426:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/joomla/i-cannot-log-into-joomla-administrator-due-to-a-redirect-plug-in" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, I've been researching how this re-direct could be done. There are several plugins as listed per this search. The best way to handle this would be..." />
  <title>I cannot log into joomla administrator due to a redirect plug in | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/joomla/i-cannot-log-into-joomla-administrator-due-to-a-redirect-plug-in" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:4fafbcb148ef06f8d7f936e7ff334fba -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-20']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '190.14.249.228']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>I cannot log into joomla administrator due to a redirect plug in</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-05-06 9:08 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>1,185</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>We are a not for profit spiritual website that lost our webmaster.  Before he left, due to previous hacking issues, he installed a redirect plug in for joomla administrator log in which takes me back to the home page when I use the typical url for administrator.  He never shared the new url extension to get me into joomla as administrator before he left.  I need a coder or programmer to help find this inside the C Panel and either remove it or give me the url address or extension to let me enter joomla as administrator for my our website.  Thank you in advance for your help in this matter.<br />
</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_7183' id='upvote_answer_7183' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='7183' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_7183').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_7183' id='downvote_answer_7183' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='7183' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_7183').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
I've been researching how this re-direct could be done.  There are several plugins as listed per this <a href="https://www.google.com/search?q=login+redirect+extension+for+joomla&ie=utf-8&oe=utf-8" rel="nofollow" target="_blank">search</a>.  The best way to handle this would be to get the URL that you need to login to the Admin.<br />
<br />
There is also the option to DISABLE the plugin.  You will need to access your files via the cPanel File Manager and then disable the plugin(s) by renaming the PHP files.  Checkout this <a href="https://www.ostraining.com/blog/joomla/disable-a-joomla-plugin/" rel="nofollow" target="_blank">tutorial</a> to do this. They give you several ways, but the easiest will be to rename the files.  I'm not sure what plugins were used, but you can go in there and disable all of them so that you can at least login. If you need information on accessing the files, please see <a href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-file-manager/using-file-manager-in-cpanel">cPanel File Manager</a> for more details.  <br />
<br />
...
Arnel C.<br />
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_7183').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_7183' id='form_comment_on_answer_7183' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>I cannot get the actual url log in that works.  I have experimented and tried many variations to no avail.  Regarding your suggestions, I am not qualified to do what you are suggesting.  I need expert assistance.  Can you suggest someone I can work with by Skype and/or Team Viewer and/or Google Hangouts?  I would greatly appreciate it.  Rev. Merriam</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='/support/images/avatars/default_avatar.jpg' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/mjhandy'>mjhandy</a><br />
									8 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2015-05-06 1:32 pm EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello Rev. Merriam,<br />
<br />
Apologies for the continued issue, but unfortunately, when it comes to modifying code on a running website, we are unable to make those changes for you.  Please look for a local developer/web designer who can manipulate the file for you.  You may want check <a href="http://developer.joomla.org/" rel="nofollow" target="_blank">here</a> for additional assistance.<br />
<br />
Regards,<br />
Arnel C.</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/joomla/i-cannot-log-into-joomla-administrator-due-to-a-redirect-plug-in&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/joomla/i-cannot-log-into-joomla-administrator-due-to-a-redirect-plug-in'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="50e01f96ef4172bc78dd88a4f2f846ab" value="1" />	</div>
	</form>
<!-- <br />
