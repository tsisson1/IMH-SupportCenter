<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:80068:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/change-dns-records-to-use-3rd-party-services" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-05-14T21:39:04-07:00" />
  <meta name="keywords" content="change modify point dns to remote 3rd party host" />
  <meta name="author" content="Jacob Nicholson" />
  <meta name="description" content="In this article we'll go over how you can modify your domain's DNS records, in order to split up your various services between multiple hosting providers." />
  <title>Change DNS records to use 3rd party services - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/change-dns-records-to-use-3rd-party-services" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:1cc3a877683f4ef9b55612a315cce0ea -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-22']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '176.44.78.142']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Change DNS records to use 3rd party services</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Change DNS records to use 3rd party services									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>14,806</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Dec 31, 2012'><span style='color:#606060;'>Published:</span> May 14, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<div class="in_this_tutorial" style="margin: 0px 0px 15px auto; width: 590px;">
  <h2>Navigation:</h2>
  <button type="button" class="btn btn-primary" onclick="window.location.hash='website-with-3rdparty';">Website hosted by 3rd party with email at InMotion</button>
  <button type="button" class="btn btn-primary" onclick="window.location.hash='website-with-inmotion';" style="margin: 5px 0px 0px 90px;">Website hosted by InMotion with email at 3rd party</button>
</div>

<p>In this article we'll go over how you can modify your domain's DNS records, in order to split up your various services between multiple hosting providers.</p>
<p>In most cases the average website owner will have all of their web services with one hosting provider. In some cases though you might want to split up your services, so that you have one provider actually host your website, and a completely separate provider to host your email.</p>
<p class="alert">In order to follow any of the steps below, you'll need to have your domain name <a href="/support/domain-names/dns-nameserver-changes/updating-your-domains-nameservers" target="_blank">pointed at our name servers</a>, so that any DNS changes you make in cPanel on our server is what your domain actually uses.</p>

<a name="website-with-3rdparty"></a>
<h2>Website hosted by 3rd party, email hosted by InMotion</h2>
<p>A common example of this, is if you're using a website hosting company that has a proprietary website builder, but maybe doesn't host email. So if you looked for a new web host and found InMotion Hosting, your plan might be to slowly transition your website over to non-proprietary website software with us, and in the meantime also have us host your email for you.</p>
<p>In the steps below, we'll walk through using an example domain <strong>PrimaryDomain.com</strong>. Where we would like to continue to have the e-mail hosted by InMotion Hosting, but we want to point our DNS <strong>A (Address)</strong> record to another website host where you might already have your site built.</p>
<ol class="article_list">
<li><a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel" target="_blank">Login to your cPanel</a></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/domains/change-dns-for-3rd-party/click-on-advanced-dns-zone-editor.png"><img src="//cdn.inmotionhosting.com/support/images/stories/domains/change-dns-for-3rd-party/click-on-advanced-dns-zone-editor.png" alt="click on advancedd dns zone editor"  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;" /></a> Under the <strong>Domains</strong> section, click on <strong>Advanced DNS Editor</strong></li>
<li style="clear: both;"><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/domains/change-dns-for-3rd-party/select-domain-from-drop-down.png"><img src="//cdn.inmotionhosting.com/support/images/stories/domains/change-dns-for-3rd-party/select-domain-from-drop-down.png" alt="select domain from drop down"  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;" /></a> Select the domain you'd like to modify in the drop-down to see those DNS records.</li>
<li style="clear: both;"><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/domains/change-dns-for-3rd-party/click-on-edit-beside-domain-a-record.png"><img src="//cdn.inmotionhosting.com/support/images/stories/domains/change-dns-for-3rd-party/click-on-edit-beside-domain-a-record.png" alt="click on edit beside domain a record"  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;" /></a> In this example the DNS records are already setup pointing the entire domain to InMotion's servers for all of the services. So the only thing we need to modify is our <strong>A (Address)</strong>&nbsp;of the website.
<p>Click on <strong>Edit</strong> beside the <strong>primarydomain.com.</strong> entry.</p>
</li>
<li style="clear: both;"><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/domains/change-dns-for-3rd-party/fill-in-remote-host-ip-address-for-a-record.png"><img src="//cdn.inmotionhosting.com/support/images/stories/domains/change-dns-for-3rd-party/fill-in-remote-host-ip-address-for-a-record.png" alt="fill in remote host ip address for website a record"  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;" /></a> Fill in the IP address of your remote website host, in the <strong>Address</strong> field, then click on <strong>Edit Record</strong>.</li>

<p class="alert" style="clear: both;">Anytime you make DNS changes, it can take between 24-48 hours for those DNS settings to fully propagate. So your website will not start immediately pulling from this new IP address, and it will take a different amount of time depending on several factors.</p>

<li style="clear: both;"><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/domains/change-dns-for-3rd-party/delete-mail-cname-record.png"><img src="//cdn.inmotionhosting.com/support/images/stories/domains/change-dns-for-3rd-party/delete-mail-cname-record.png" alt="delete mail cname record"  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;" /></a>You should now see the new <strong>A</strong> record you updated. Now click on <strong>Delete</strong> beside the <strong>CNAME</strong> record for <strong>mail.primarydomain.com</strong>.</li>

<li style="clear: both;"><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/domains/change-dns-for-3rd-party/add-mail-a-record.png"><img src="//cdn.inmotionhosting.com/support/images/stories/domains/change-dns-for-3rd-party/add-mail-a-record.png" alt="add mail a record"  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;" /></a>Under the <strong>Add a record</strong> section, now re-create the <strong>mail.</strong> <strong>CNAME</strong> record you deleted, but this time as an <strong>A</strong> record, and pointing to the InMotion server's IP address. You can always <a href="http://www.inmotionhosting.com/support/website/cpanel/how-to-find-your-shared-ip-address-of-your-server-in-cpanel" target="_blank">find your IP address in cPanel</a>.</li>

<li style="clear: both;"><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/domains/change-dns-for-3rd-party/click-on-mx-entry.png"><img src="//cdn.inmotionhosting.com/support/images/stories/domains/change-dns-for-3rd-party/click-on-mx-entry.png" alt="click on mx entry"  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;" /></a>At the main cPanel page, under the <strong>Mail</strong> section click on <strong>MX Entry</strong>.</li>

<li style="clear: both;"><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/domains/change-dns-for-3rd-party/click-on-edit-mx-record.png"><img src="//cdn.inmotionhosting.com/support/images/stories/domains/change-dns-for-3rd-party/click-on-edit-mx-record.png" alt="click on edit mx record"  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;" /></a>Under the <strong>MX Records</strong> section at the bottom, click on <strong>Edit</strong> beside your <strong>primarydomain.com</strong> entry with a <strong>Priority</strong> of 0.</li>

<li style="clear: both;"><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/domains/change-dns-for-3rd-party/add-mail-to-mx-entry-click-edit.png"><img src="//cdn.inmotionhosting.com/support/images/stories/domains/change-dns-for-3rd-party/add-mail-to-mx-entry-click-edit.png" alt="add mail to mx entry click edit"  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;" /></a>Now type in <strong>mail.</strong> in front of your domain to correlate your <strong>MX</strong> record with the local <strong>A</strong> record we previously created.</li>
<p style="clear: both;">&nbsp;</p>
</ol>

<a name="website-with-inmotion"></a>
<h2>Website hosted by InMotion, email hosted by 3rd party</h2>
<p>A common example of this, is if you'd like to host your website with InMotion Hosting, but you have email services with another provider such as Google Apps for your domain.</p>
<p>In the steps below, we'll walk through using an example domain <strong>PrimaryDomain.com</strong>. Where we would like to continue to have the website hosted by InMotion Hosting, but we want to point our DNS <strong>MX (Mail Exchange)</strong> record to another email host.</p>
<ol class="article_list">
<li><a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel" target="_blank">Login to your cPanel</a></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/domains/change-dns-for-3rd-party/click-on-mx-entry.png"><img src="//cdn.inmotionhosting.com/support/images/stories/domains/change-dns-for-3rd-party/click-on-mx-entry.png" alt="click on mx entry"  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;" /></a> Under the <strong>Mail</strong> section, click on <strong>MX Entry</strong>.</li>
<li style="clear: both;">In the <strong>Add New Record</strong> section, you'll want to set the <strong>Priority</strong> and <strong>Destination</strong> for your 3rd party mail service, then click on <strong>Add New Record</strong>.
<p>We are going to use Google's as an example, since they're very common:</p>
<table class="article_table">
<tbody>
<tr><th>Priority</th><th>Destination</th></tr>
<tr>
<td>1</td>
...
<p>These should all now be populated in the <strong>MX Records</strong> section at the bottom.</p>
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/domains/change-dns-for-3rd-party/click-on-delete-local-mx-record.png"><img src="//cdn.inmotionhosting.com/support/images/stories/domains/change-dns-for-3rd-party/click-on-delete-local-mx-record.png" alt="click on delete local mx record"  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;" /></a>With all of the remote MX servers added, we now want to remove the original local one.
<p>Click on <strong>Delete</strong> beside the <strong>primarydomain.com.</strong> MX entry, then click the confirmation <strong>Delete</strong> button.</p>
</li>
<li style="clear: both;"><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/domains/change-dns-for-3rd-party/click-on-remote-mail-exchanger.png"><img src="//cdn.inmotionhosting.com/support/images/stories/domains/change-dns-for-3rd-party/click-on-remote-mail-exchanger.png" alt="click on remote mail exchanger"  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;" /></a> Finally change the <strong>Email Routing</strong> option to <strong>Remote Mail Exchanger</strong>, then click on <strong>Change</strong></li>
<p class="alert" style="clear: both;">Anytime you make DNS changes, it can take between 24-48 hours for those DNS settings to fully propagate. So your email will not start immediately delivering to these new remote MX servers.</p>
</ol>
<p>You should now understand how to split up your domain's various services by using DNS records. While this typically isn't needed for the average user, it might be good to know that you do have this option available to you.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/change-dns-records-to-use-3rd-party-services&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/change-dns-records-to-use-3rd-party-services'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD02OCZpZD04NjImdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="df5a4257064c0c5cbee3c5c1a31d8f33" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-04 6:48 am</div>
				                <div><p>I am configuring spilt delivery with Google and it was working fine. When I delete the CNAME record and create the A recod my hosted email with inmotionhosting no longer able to receive emails. Any suggestions please?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11142);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-04 8:44 am</div>
				                <div>This is because the MX records which control mail point to the location of your A record by default which is then sending your mail to the other location that you changed your A record to.  To fix it, you may use the MX Entry tool to point your mail to the server that you are located on.  You may see this to the left side of cPanel and will say something like &lt;em&gt;bizXXX.inmotionhosting.com&lt;/em&gt;.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11150);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-27 7:27 am</div>
				                <div><p>I really need help to setup this correctly, my setup as follows:</p>
<p>- Website hosted locally (Made the above steps)</p>
<p>- Have group of emails hosted in Google Apps</p>
<p>- Have the rest of the staff emails hosted in my Inmotion Hosting</p>
<p>--</p>
<p>So far things work, but now mail from Gapps/Inmotion to Group don't reach Inmotion-hosted accounts inside that group. Ex: When I send email to a group contain users from Gapps, Inmotion, hotmail, etc.. the message don't rach Inmotion accounts only!!&nbsp;</p>
<p>Any advise?! Thanks! </p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12059);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-27 7:50 am</div>
				                <div>Hello Yousif,<br />
<br />
Thank you for your question. We are happy to help, but will need some additional information.<br />
<br />
Are the emails returned or bounced? If so, can you provide the returned/bounced message?<br />
<br />
Also, it may be easier to contact <a href="http://www.inmotionhosting.com/contact">live support</a> at the time you are sending the emails. so they review the server logs in real-time.<br />
<br />
If you have any further questions, feel free to post them below.<br />
Thank you,<br />
<br />
-John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12061);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-19658'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/061a58de9bb0dea88913f7165b63b16c?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/061a58de9bb0dea88913f7165b63b16c'>muhire kavuna </a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-17 8:12 pm</div>
				                <div><p>Hello Yousif, <a style="font-size: 16px;" href="http://www.gravatar.com/87bd30b07f6f65577fee1fc78872cc26"></a></p>
<p>I am in a similar situation. How did you end up solving the issue please? I will love to hear from you. </p>
<p>&nbsp;</p>
<p>Thanks</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19658);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-19 11:26 am</div>
				                <div>Hello Muhire,<br />
<br />
Thank you for contacting us. If you want email hosted at 2 different places, you would have to setup 2 separate mail servers, and point their "<a href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/a-record-change">A record</a>" to different locations.<br />
<br />
For example create:<br />
mail1.example.com with an A record pointed to Google Apps.<br />
<br />
mail2.example.com with an A record pointed to InMotion Hosting.<br />
<br />
Then, people using Google apps use mail1.example.com as their mail server.<br />
<br />
People with email hosted at InMotion will use mail2.example.com<br />
<br />
If you have any further questions, feel free to post them below.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19701);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-19 12:16 pm</div>
				                <div><p>I handle it by creating an mail forwarder to every single Google App's email in inMotion cPanel</p>
<p>using the free offered test domain alias from Google.</p>
<p>Example: I have hr@mycompany.com hosted in Google Apps, so I created hr@mycompany.com.test-google-a.com in cPanel &gt; Forwarders</p>
<p>So far everything working fine but groups!</p>
<p>Groups I created under Google Apps with users from:</p>
<p>Google Apps &gt; Get emails of course. InMotion Hosting &gt; Don't get emails! Other public services (Hotmail, outlook.com, yahoo,..) &gt; Get emails.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19709);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
