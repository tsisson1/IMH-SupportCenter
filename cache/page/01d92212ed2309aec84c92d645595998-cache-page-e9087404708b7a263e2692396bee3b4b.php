<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:63165:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/joomla-25/virtuemart-ajax-search" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-05-07T19:39:31-07:00" />
  <meta name="keywords" content="joomla 2.5 virtuemart ajax search" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="VirtueMart Ajax Search is any module for VirtueMart that displays product search results using Ajax. Using an Ajax search tool can make it faster for shoppers to search through your products and find what they need." />
  <title>VirtueMart Ajax Search - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/joomla-25/virtuemart-ajax-search" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:9163e99caed262206cdc2391cd865814 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '82.211.172.171']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>VirtueMart Ajax Search</span></li>			</ul>
		</div>
	</div>
</div>
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>3,728</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: May 7, 2012'><span style='color:#606060;'>Published:</span> May 7, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>If you're looking to add the power of Ajax to your VirtueMart search, there are a few modules available for download. Using one of these ajax search tools, you can allow your customers to dynamically interact with your site without leaving the current page to look for products!</p>
<h2>Ajax Search Explained</h2>
<p>An asynchronous javascript and xml (AJAX) search sends the user's query from their browser to your server through a JavaScript XML HttpRequest object. This means that your user's browser is exchanging data with your VirtueMart store without reloading the current page (which can make finding products faster).</p>
<p>Ajax is not a programming language, it is a new method for using technologies that already exist. An easy way to understand Ajax is by looking at the auto suggest results below. We started to type virtuemart aj and the search engine, using Ajax, began suggesting phrases such as ajax cart and ajax search.</p>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/virtuemart-ajax-search/virtuemart-ajax-search-results.gif"><img  alt="virtuemart-ajax-search-results" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/virtuemart-ajax-search/virtuemart-ajax-search-results.gif" /></a></p>
<p>If you were selling outdoor equiment with VirtueMart and the user typed in sho, the ajax search would most likely return <span style="text-decoration: underline;">sho</span>es and <span style="text-decoration: underline;">sho</span>vels. Again, the client (your web browser, such as Internet Explorer or Firefox) is sending data (the characters you are typing in) to the server asynchronously.</p>
<h2>VirtueMart Ajax Search Modules</h2>
<p>You can find the following VirtueMart Ajax search modules in either the the Joomla Extension Directory or in the VirtueMart Extensions Directory.</p>
<p><a href="http://extensions.virtuemart.net/component/sobi2/?sobi2Task=sobi2Details&amp;catid=11&amp;sobi2Id=687&amp;Itemid=2" target="_blank" rel="nofollow">VirtueMart Ajax Search module</a><br />The <em>VirtueMart Ajax Search</em> module is a PrestaShop search module that allows you to show product search results by using Ajax. You can use CSS to style the results, show thumbnails for each product, and even speed up the ajax search by using cache.</p>
<p><a href="http://extensions.virtuemart.net/component/sobi2/?sobi2Task=sobi2Details&amp;catid=11&amp;sobi2Id=92&amp;Itemid=2" target="_blank" rel="nofollow">VM Live Product Search</a><br />You can incorporate AJAX search within VirtueMart using the <em>VM Live Product Search</em>. Based upon this modules description, it uses AJAX to call the normal VirtueMart search result page, parses the data, and then returns in back to the user without actually redirecting the user to the newer page. Because this ajax search module still calls the result page, don't expect increases in page load time.</p>
<p><a href="http://extensions.joomla.org/extensions/extension-specific/virtuemart-extensions/virtuemart-products-search/5242" target="_blank" rel="nofollow">JXTC VirtueMart Advanced Ajax Search Module</a><br />This is another VirtueMart Ajax Search Module, which includes the ability to narrow down results based upon category, manufacturer, and product.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/joomla-25/virtuemart-ajax-search&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/joomla-25/virtuemart-ajax-search'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD04OSZpZD00MjUmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
