<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:63380:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/add-cname-record" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-05-02T16:19:06-07:00" />
  <meta name="keywords" content="cname record dns whm zone editor" />
  <meta name="author" content="null" />
  <meta name="description" content="This article is a walk through for creating CNAME records in the cPanel and WHM" />
  <title>Adding a CNAME Record - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/add-cname-record" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:dbc79668673cc2a404272507fb039746 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-37']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '186.91.140.231']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Adding a CNAME Record</span></li>			</ul>
		</div>
	</div>
</div>
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>37,553</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Sep 20, 2011'><span style='color:#606060;'>Published:</span> May 2, 2016</div>
				...
				<iframe width='675' height='315' src='https://www.youtube.com/embed/lCGCGKI9x5M' frameborder='0' allowfullscreen style='margin-bottom:15px;'></iframe>
								...
								<p>CNAME records are a type of DNS record you can use to point a hostname to another hostname such as pointing calendar.example.com to ghs.google.com. CNAME records aren't needed by most users, but there situations where you will wnat to create a CNAME record for your domain.</p>
<h1>Shared Plans</h1>
<p>In this example, we will point the CNAME of calendar to ghs.google.com.&nbsp; This will allow anyone that goes to calendar.imhsupport.com to be automatically re-directed to our Google Calendar.</p>
<p>Let's begin by logging into our cPanel account. Once inside the cPanel account, find and click on the "Simple DNS Zone Editor" under the "Domains" section.</p>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/cpanel/cpanel-simple-dns-editor.jpg"><img  title="Simple DNS Zone Editor in cPanel" alt="cpanel-simple-dns-editor" src="//cdn.inmotionhosting.com/support/images/stories/cpanel/cpanel-simple-dns-editor.jpg" /></a></p>
<p>Choose your domain name in the drop down menu and go to the "Add a CNAME Record" area of the Simple Zone Editor. Fill in the name for your new CNAME(subdomain) in the "Name" field and the hostname you want to point it to in the "CNAME" field.</p>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/cpanel/cPanel-add-cname-record.jpg"><img  title="Adding a CNAME Record in cPanel" alt="cPanel-add-cname-record" src="//cdn.inmotionhosting.com/support/images/stories/cpanel/cPanel-add-cname-record.jpg" /></a></p>
<p>After filling in the needed information, click the "Add CNAME Record" button. You will now see your new CNAME record listed in the "User-Defined Records" at the bottom of the screen</p>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/cpanel/cPanel-cname-added.jpg"><img  title="CNAME Record added in cPanel" alt="cPanel-cname-added" src="//cdn.inmotionhosting.com/support/images/stories/cpanel/cPanel-cname-added.jpg" /></a></p>
...
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/cpanel/cPanel-cname-record-error.jpg"><img  title="Reserved CNAME Record Error in cPanel" alt="cPanel-cname-record-error" src="//cdn.inmotionhosting.com/support/images/stories/cpanel/cPanel-cname-record-error.jpg" /></a></p>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/cpanel/cPanel-cname-record-error-popup.jpg"><img  title="Reservered CNAME error in cPanel" alt="cPanel-cname-record-error-popup" src="//cdn.inmotionhosting.com/support/images/stories/cpanel/cPanel-cname-record-error-popup.jpg" /></a></p>
<p>An example of a common CNAME change that is already reserved would be for the mail subdomain.&nbsp; To request a CNAME change for the mail subdomain, please contact our support team at <a href="mailto:support@inmotionhosting.com">support@inmotionhosting.com</a> and we will be happy to make that change for you.</p>
<p><strong>Please allow up to 24 hours for any DNS changes to take effect, including adding or changing CNAME records.</strong></p>
<h1>VPS and Dedicated Plans</h1>
<p>VPS and Dedicated plans include Advanced DNS editor as part of WHM. This provides greater control over DNS records than the cPanel Simple DNS Zone editor.</p>
<p>Not only will the Advanced DNS Editor allow you to add CNAME records, it will allow you to edit current records as well. For more information on using the Advanced DNS Editor please see the cPanel documentation here:</p>
...
<p>You can access the Advanced DNS Editor from within your WHM account. First, log into WHM. Next, find and click the Edit DNS Zone link (on the left side of your screen) to open the Advanced DNS Zone Editor:</p>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/WHM/whm-edit-dns-zone.jpg"><img  title="Advanced DNS Zone Editor in WHM" alt="whm-edit-dns-zone" src="//cdn.inmotionhosting.com/support/images/stories/WHM/whm-edit-dns-zone.jpg" /></a></p>
<p><strong>As above, please allow up to 24 hours for changes to your DNS to take effect.</strong></p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/add-cname-record&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/add-cname-record'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD02OCZpZD04NTUmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="bc5e6371e2592983f1bb4ceee9f31688" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/0cbefcb9a7b3a838483ed2b5f029a08e?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/0cbefcb9a7b3a838483ed2b5f029a08e'>Owen Prescott</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-18 8:37 pm</div>
				                <div><p>Is this how it works for Cloudfront?</p>
<p><strong>Name</strong>: df2[cloudfrontstring]g34gd.cloudfront.net</p>
<p><strong>CNAME</strong>: cdn.example.com</p>
<p>In the example provided it looks like "mail.inmotionhosting.com." should be the CNAME yet it's in the "name" section. Can I get an indication which is the Name and what's the CNAME using a cloudfront distribution?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21850);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-20 1:22 pm</div>
				                <div>Hello Owen,<br />
<br />
Thank you for your question. I could not find any guides on amazon's site,  but I found a helpful <a href="http://stackoverflow.com/questions/4445396/cloudfront-cname-vs-dns-cname" target="_blank">post</a> via online search, where they offer helpful information.<br />
<br />
From their suggestion you would set it up like this:<br />
<strong>Name:</strong> cdn.example.com<br />
<strong>CNAME:</strong> df2[cloudfrontstring]g34gd.cloudfront.net<br />
<br />
Be sure to allow time for any DNS modification to <a href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/domain-names-dns-changes">propagate</a>.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21893);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-15 9:37 am</div>
				                <div><p>Just thought I would follow up to say thanks, your suggestion worked.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22668);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
