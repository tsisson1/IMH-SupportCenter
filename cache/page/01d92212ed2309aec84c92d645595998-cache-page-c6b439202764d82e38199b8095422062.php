<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:64200:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/amp/new-plan" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-01-29T19:04:30-08:00" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Looking to add a new hosting plan from within your AMP? Learn how in this tutorial!" />
  <title>How to Order a New Hosting Plan in AMP - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/amp/new-plan" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:720790d0d2e263aee3228eea1e2f9057 -->
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to Order a New Hosting Plan in AMP</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to Order a New Hosting Plan in AMP									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>93</span></div>
							...
							<div style='clear:both;'></div>
								...
								<p>You can easily order an additional spearate hosting plan and manage it from within the same Account Management Panel (AMP) account as your current hosting package. If you need help logging into AMP, please review our&nbsp;<a href="/support/website/how-to/how-to-log-into-amp">How to log into AMP</a> article for more information.</p>

<h2>How do I order a new hosting plan?</h2>

<ol class="article_list">
<li>Log into your<a href="https://secure1.inmotionhosting.com/index/login"> Account Management Panel (AMP)</a>.<div style="clear:both;"></div></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/amp/new-plan/01-click-hosting.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/amp/new-plan/01-click-hosting.png" title="Click here to view the larger image" width="200" /></a>At the top menu bar, hover over "<strong>Add Services</strong>" and select <strong>Hosting</strong>.<div style="clear:both;"></div></li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/amp/new-plan/02-select-plan-type.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/amp/new-plan/02-select-plan-type.png" title="Click here to view the larger image" width="200" /></a>Choose the desired type of hosting for the new package.<div style="clear:both;"></div></li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/amp/new-plan/03-select-new-or-existing-domain.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/amp/new-plan/03-select-new-or-existing-domain.png" title="Click here to view the larger image" width="200" /></a>Choose whether this is a new domain or an existing domain.<div style="clear:both;"></div></li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/amp/new-plan/04-enter-domain-name.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/amp/new-plan/04-enter-domain-name.png" title="Click here to view the larger image" width="200" /></a>Fill in the domain name.<div style="clear:both;"></div></li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/amp/new-plan/05-select-plan-length.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/amp/new-plan/05-select-plan-length.png" title="Click here to view the larger image" width="200" /></a>Select length and terms of your plan.<div style="clear:both;"></div></li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/amp/new-plan/06-select-privacy.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/amp/new-plan/06-select-privacy.png" title="Click here to view the larger image" width="200" /></a>Add domain privacy if you wish.<div style="clear:both;"></div></li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/amp/new-plan/07-select-auto-install.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/amp/new-plan/07-select-auto-install.png" title="Click here to view the larger image" width="200" /></a>Next, select an additional FREE auto-installed programs that you want.<div style="clear:both;"></div></li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/amp/new-plan/08-select-data-center.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/amp/new-plan/08-select-data-center.png" title="Click here to view the larger image" width="200" /></a>Choose between the East or West coast data center (shared and VPS only).<div style="clear:both;"></div></li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/amp/new-plan/09-select-billing-information.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/amp/new-plan/09-select-billing-information.png" title="Click here to view the larger image" width="200" /></a>Either choose to use your existing billing information or add new billing information if necessary.<div style="clear:both;"></div></li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/amp/new-plan/10-select-payment-method2.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/amp/new-plan/10-select-payment-method2.png" title="Click here to view the larger image" width="200" /></a>Next, select your <strong>Payment Method</strong> and enter any related information.<div style="clear:both;"></div></li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/amp/new-plan/11-agree-tos.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/amp/new-plan/11-agree-tos.png" title="Click here to view the larger image" width="200" /></a>Select "<strong>I agree</strong>" to confirm you agree to the charges and you have reviewed and agree to our<a href="/support/../policies.html"> Terms of Service</a>.<div style="clear:both;"></div></li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/amp/new-plan/12-review-and-submit.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/amp/new-plan/12-review-and-submit.png" title="Click here to view the larger image" width="200" /></a>Review your charges at the bottom. If they are correct, click the <strong>Submit</strong> button and your order for your new hosting plan with InMotion Hosting will be complete.<div style="clear:both;"></div></li>
</ol>

<p>If you need further assistance or have any questions please feel free to contact our Live Support department that is available 24 hours a day 7 days a week!</p>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/amp/new-plan&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/amp/new-plan'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MjcmaWQ9Mzc0NiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="95b0b1721d5b1ff5df3ba29207078473" value="1" />	</div>
	</form>
<!-- <br />
