<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:62398:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/databases/mysql-command-line" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-05-09T04:26:04-07:00" />
  <meta name="keywords" content="MySQL shell ssh access command line" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="If you are learning how to use command line functions via your shell access, read this article to learn how to access and use MySQL." />
  <title>How to access MySQL via command line - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/databases/mysql-command-line" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:0b5236206a526fc8240423a61874d586 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '184.96.25.92']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to access MySQL via command line</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to access MySQL via command line									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>19,413</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Apr 25, 2013'><span style='color:#606060;'>Published:</span> May 9, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>MySQL is the actual database system that uses the Structured Query Language to process data. MySQL is currently the most popular open source database and is frequently utilized with PHP to create dynamic websites. That said, MySQL also works well with Python, Ruby and Perl. This article will guide you on how to access the MySQL tool via command line.</p>

<div style="background-color: #fafad2; border: 1px #D3D3D3 dashed; border-radius: 5px; padding: 0px 0px 0px 5px;">Note that you can only access MySQL via Shell, or command line, via a VPS or Dedicated server account. This is not a feature that is available on shared accounts.</div>


<h2>Accessing MySQL via command line</h2>

<ol class="article_list">
<li>Log into your server via ssh.<div style="clear:both;"></div></li>
<li>Once in your shell, you will at the command line prompt. To log into the MySQL monitor, use the following syntax:<br />
  <div class="code_block"><em>mysql -u &lt;db-username&gt; -p</em></div></p>
  <p>The <em>&lt;db-username&gt;</em> tag will need to be replaced with the actual database username with which you want to sign into the monitor. If you do not know which user you want to use, you can <a href="/support/edu/cpanel/find-database-users">find a list of users for your databases</a> via your cPanel.</p><div style="clear:both;"></div></li>
<li>Once you have your database user name, enter command line code similar to below and hit <em>Enter</em>. In our case, we are using a database user named <em>inmoti5_dbuser1</em>.
<div class="cli">root@vps9999 [~]# mysql -u inmoti5_dbuser1 -p<div style="clear:both;"></div></li>
  <li>Due to the <em>-p</em> switch with nothing following, you will be required to enter your password as below. Simply enter the password and click <em>Enter</em>.
<div class="cli">Enter password:</div><div style="clear:both;"></div></li>
<li>After entering the correct password you will be met with the following greeting and MySQL prompt:
<div class="cli">
Welcome to the MySQL monitor.  Commands end with ; or \g.<br />
Your MySQL connection id is 19472<br />
Server version: 5.5.30-cll MySQL Community Server (GPL)<br /><br />

Copyright (c) 2000, 2013, Oracle and/or its affiliates. All rights reserved.<br /><br />
...
mysql></div><div style="clear:both;"></div></li>
</ol> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/databases/mysql-command-line&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/databases/mysql-command-line'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMyZpZD0yNjY1JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="87479d40c1dafed55278cfa63ed8f308" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						...
						<div><a style='font-size:16px;' href='//www.gravatar.com/3f009d72559f51e7e454b16e5d0687a1'>rajiv</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-01 1:18 pm</div>
				                <div><p>very nice article</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24568);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
