<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:54700:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/registrations-and-transfers/awaiting-registrar-how-long-it-takes-from-godaddy" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="IMPORTANT: Godaddy will not tell you this, as they want to make it difficult to transfer away from them. You must login to Godaddy &gt; click on DOMAINS&gt;&gt;&gt;..." />
  <title>Awaiting Registrar - How long it takes from GoDaddy | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/registrations-and-transfers/awaiting-registrar-how-long-it-takes-from-godaddy" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:0b52f230aee4f104746198aea318e071 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '66.249.93.226']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Awaiting Registrar - How long it takes from GoDaddy</h1>
		<div style='margin-bottom:20px; margin-top:10px; clear:both; color:#6e6e6e;'>Category: <a href='/support/community-support/registrations-and-transfers'>Registrations And Transfers</a></div>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/VGrover'>VGrover</a>
			<div>10 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-05-17 1:40 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>7,565</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I have asked for a domain transfer, domain name is eastwestwedding.com, the status is Awaiting Registrar.<br />
It's been 4-5 days now, how long it will take and what I can do to expedite the transfer.</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_1038' id='upvote_answer_1038' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='1038' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_1038').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_1038' id='downvote_answer_1038' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='1038' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_1038').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello VGrover,<br />
<br />
When a domain transfer gets to the Awaiting Registrar portion of the process, it means it the new registrar is awaiting the losing registrar, in this case GoDaddy, to respond. This can take up to 7 days. <br />
<br />
A full registrar transfer can take up to 7-14 days. There are no ways to expedite the process except to answer any emails you receive from the registrars in a timely manner. GoDaddy generally sends out an email to the domain owner for confirmation and this can speed up the transfer if you answer it. If you already have then there is nothing more you can do from your side. Your timeframe is typical although I have seen transfers happen in as little as 8 hours or as long as 14 days.<br />
<br />
- Scott M
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_1038').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_1038' id='form_comment_on_answer_1038' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
...
<div class=' straight_bottom not_best_answer'>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px; width:50px;' valign='top'>
<div class='vote_div'>
	<form method='post' name='upvote_answer_4670' id='upvote_answer_4670' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='4670' />
		<input type='hidden' name='component' id='component' value='qa' />
		<input type='hidden' name='vote_value' id='vote_value' value='1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_4670').submit();"></div>
	</form>
	<div class='vote_sum'>2</div>
	<form method='post' name='downvote_answer_4670' id='downvote_answer_4670' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='4670' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_4670').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					<img src='http://graph.facebook.com/benny.youngblood333/picture?type=normal' class='user_avatar' style='max-width:60px;' /><br />
                		        <a href='/support/community-support/users/onecom'>onecom</a>
					
					<div>10 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2014-03-17 6:26 pm EST
                		        </div>
					
		                </div>

				IMPORTANT: Godaddy will not tell you this, as they want to make it difficult to transfer away from them.<br />
<br />
You must login to Godaddy &gt; click on DOMAINS&gt;&gt;&gt; PENDING TRANSFERS &gt;&gt;&gt; CLICK ON ACCEPT.<br />
<br />
Once this process is complete, the domain should be transferred w/in 24 hours.<br />
<br />

				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_4670').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_4670' id='form_comment_on_answer_4670' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
					                <p>You must <a href='/support/login'>login</a> before you can post a comment about this answer.</p>
					        </div></div></div></div>
					</form>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>You are my hero. Haha.  I swapped hosting from ipage to inmotion and then transfered my domain from godaddy to inmotion (without changing the nameservers) then realized I couldn't do anything with my site.  Inmotion CS was great but said I had to make sure Godaddy released it.  Went to Godaddy support and they said, did you get an e-mail asking you to do anything (it didn't.)  All they would say was great, you don't have to do anything else (even when I asked them about the &quot;denying period&quot; and what not.)<br />
<br />
Then I came across this post!  Oh man, did you just save me at least 5 days of downtime.  :D</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='http://graph.facebook.com/phillip.navarre/picture?type=normal' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/Tigerbite'>Tigerbite</a><br />
									3 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2015-02-27 1:25 am EST
								</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/registrations-and-transfers/awaiting-registrar-how-long-it-takes-from-godaddy&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/registrations-and-transfers/awaiting-registrar-how-long-it-takes-from-godaddy'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="d2dfccd3a1a3c340e7ac444337cc2e0f" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
                                ...
                                <h3>Related Articles</h3><a target='_blank' href='http://inmotionhosting.com/support/registering-a-new-domain-name'>Registering a New Domain Name</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/how-to-unlock-domain-name-retrieve-authorization-code'>How to unlock your domain name and retrieve your Authorization Code</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/transfer-domain-name-to-inmotion-hosting'>How to Transfer your Domain Name to InMotion Hosting</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/add-another-domain-name-account'>How can I add another domain name to my account?</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/private-domain-registration'>Private Domain Registration</a><br/><br />
		</div>
