<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49516:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/everything-email/active-sync-for-mdm" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, Active sync is usually only available on exchange servers of which unfortunately we do not offer. You can however get an account and still use a ..." />
  <title>Active sync for MDM | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/everything-email/active-sync-for-mdm" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:0969053957713b01cc1e506c17061eee -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Active sync for MDM</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-08-21 2:14 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>94</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>We are exploring MDM solutions for our mobile devices and one provider asked if &quot;InMotion is providing us with mail that is configured with active sync.&quot; Please advise. Thanks.</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_7950' id='upvote_answer_7950' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='7950' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_7950').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_7950' id='downvote_answer_7950' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='7950' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_7950').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
Active sync is usually only available on exchange servers of which unfortunately we do not offer. You can however get an account and still use a third party email service to gain active sync services.<br />
<br />
Best Regards,<br />
TJ Edens
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_7950').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_7950' id='form_comment_on_answer_7950' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/everything-email/active-sync-for-mdm&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/everything-email/active-sync-for-mdm'></div>
<script type='text/javascript'>
  (function() {
