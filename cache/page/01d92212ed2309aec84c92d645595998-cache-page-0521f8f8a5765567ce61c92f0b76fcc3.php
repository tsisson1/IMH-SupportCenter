<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:60363:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/prestashop-15/supply-orders/edit-supply-order-status" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-10-19T13:13:49-07:00" />
  <meta name="keywords" content="inventory management PrestaShop 1.5 supply order stats edit modify" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="In this PrestaShop 1.5 tutorial, you will learn how to edit a supply order status in Advanced Stock Management." />
  <title>Editing a supply order status in PrestaShop 1.5 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/prestashop-15/supply-orders/edit-supply-order-status" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:dbb3b97ff4b8ce2e11d5f9889dbae8ed -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Editing a supply order status in PrestaShop 1.5									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>1,030</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Oct 17, 2012'><span style='color:#606060;'>Published:</span> Oct 19, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>When dealing with Supply Orders, there are different settings and configurations you need to manage. This article covers the modification of an existing supply order status. Follow the instructions below to learn how to edit a supply order status in PrestaShop 1.5.</p>
<div class="alert">In order edit a supply order status the <a href="/support/edu/prestashop-15/advanced-stock-management/enable-advanced-stock-management">Advanced Stock Management</a> option must be enabled.</div>
<p><strong>How to modify a supply order status in PrestaShop 1.5</strong></p>
<ol class="article_list">
<li><a href="/support/edu/prestashop-15/getting-started/login-to-dashboard"> Log into your PrestaShop 1.5 dashboard</a>.</li>
<li>Using the top menu bar, hover over the <strong>Stock</strong> tab and click on the <strong>Configuration</strong> option from the menu.</li>
<li>This brings you to the <em>Configuration</em> page where there are various settings for <em>Advanced Stock Management</em>. Look for the <em>Supply Order Status</em> section, which is located at the top of the page. You will see a list of the existing supply order statuses as below.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Stock/Configuration/Edit_Status/edit-supply-order-status.png"><img  alt="edit-supply-order-status" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Stock/Configuration/Edit_Status/edit-supply-order-status.png" /></a></li>
<li>Find the status you wish to edit, and click on the Edit icon <img alt="edit-icon" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Stock/Configuration/Edit_Status/edit-icon.png" height="16" width="15" />. This will send you to the Status edit page.</li>
<li>Once created, most of the data for a status cannot be changed. You can see below that there are only two settings you are able to modify.<br />
<table class="article_table">
<tbody>
<tr><th>Status</th>
<td>The name of the supply status</td>
</tr>
<tr><th>Back Office Color</th>
<td>The color representing the status, which is only viewable in the back office.</td>
</tr>
</tbody>
</table>
</li>
<li>Once you have finished making any changes, click on the green <strong>Save</strong> button found in the upper right corner of the screen.<br /><br />You have now completed editing a supply order staus. If you need to modify the other settings you will need to rename the one you want to replace with the instructions above and then create a new status altogether. Our next article on creating a supply status will help you do just that.</li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/prestashop-15/supply-orders'>119: Configuring Supply Orders in PrestaShop 1.5</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 1: Editing a supply order status in PrestaShop 1.5</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 2: <a href='/support/edu/prestashop-15/supply-orders/add-supply-order-status'>Creating a supply order status in PrestaShop 1.5</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/prestashop-15/supply-orders/edit-supply-order-status&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/prestashop-15/supply-orders/edit-supply-order-status'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yODImaWQ9MTg4NiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/prestashop-15/supply-orders?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Configuring Supply Orders in PrestaShop 1.5</h3></a>
		<table>  <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/prestashop-15/supply-orders/edit-supply-order-status?tsrc=rsbedu'>Editing a supply order status in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/prestashop-15/supply-orders/add-supply-order-status?tsrc=rsbedu'>Creating a supply order status in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/prestashop-15/supply-orders/delete-supply-order-status?tsrc=rsbedu'>Removing a supply order status in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/prestashop-15/supply-orders/create-stock-movement-label?tsrc=rsbedu'>Creating a stock movement label in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/prestashop-15/supply-orders/manage-custom-movement-labels?tsrc=rsbedu'>Managing custom stock movement labels in PrestaShop 1.5</a></td>
                </tr>
          	</table>
