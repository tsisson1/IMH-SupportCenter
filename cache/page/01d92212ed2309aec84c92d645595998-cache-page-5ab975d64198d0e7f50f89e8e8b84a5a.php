<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:83543:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/prestashop-15/343-alter-sef-url-format" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-02-20T19:57:19-08:00" />
  <meta name="keywords" content="SEF URL search engine friendly customer customize PrestaShop 1.5 change format" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Looking to customize your SEF URLs to be even more customer friendly? Learn how in this PrestaShop 1.5 tutorial." />
  <title>343: How to alter the format of SEF URLs in PrestaShop 1.5 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/prestashop-15/343-alter-sef-url-format" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<script type="text/javascript">
		...
		_gaq.push(['_setCustomVar', 3, 'DateMonthModified', '2013-02', 3]);
	...
	<!-- cid:a0c600e5a1f76078c3f23b00668d83dd -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '1.0.180.49']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															343: How to alter the format of SEF URLs in PrestaShop 1.5									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>8,776</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Feb 20, 2013'><span style='color:#606060;'>Published:</span> Feb 20, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>When using SEF URLS in your PretaShop 1.5 store, you may not like the default format. For example, the format for a product is as follows: <span style="background-color: #ffffff; color: #ff0000;">category</span>/<span style="color: #339966;">id</span>-<span style="color: #993366;">rewrite-text</span>-<span style="color: #ff9900;">ean13</span>.html. This URL comes from different variables strung together to give you a more human-readable format. There are four parts to the URL as shown by the color differences in the text. Below is a table displaying the separate sections:</p>
<table class="article_table">
<tbody>
<tr><th>Keyword</th><th>Sample Code</th><th>Description</th></tr>
<tr>
<td><span style="color: #ff0000;">category</span></td>
<td>music-ipods</td>
<td>The category under which the product is listed.</td>
</tr>
<tr>
<td><span style="color: #008000;">id</span></td>
<td>1</td>
<td>The unique product ID number in the database.</td>
</tr>
<tr>
<td><span style="color: #993366;">rewrite text</span></td>
<td>ipod-nano</td>
<td>Thsi comes from the friendly URL field under the SEO tab of the Product Edit page.</td>
</tr>
<tr>
<td><span style="color: #ff9900;">ean13</span></td>
<td>123</td>
<td>This comes from the ean13 or JAN field from the Information tab of the Product Edit page.</td>
</tr>
</tbody>
</table>
<p><strong>Why change the format?</strong><br />The friendly URL for an ipod nano using the sample code for each section above will be <em>http://prestashop.inmotiontesting.com/en/music-ipods/1-ipod-nano-123.html</em>. This URL may not suit your tastes and you may want to arrange it differently for your customers. Perhaps you want to remove the ean13 number, or move the product ID to the back, or make it appear as its own category separated by slashes. Unfortunately, you cannot remove the id entirely from the URL as it is required by PrestaShop's core coding.</p>
<p><strong>Formatting Syntax</strong><br />The default URL format is <em>{category:/}{id}-{rewrite}{-:ean13}.html</em>. The syntax is fairly straight forward, each keyword is enclosed in a set of curly braces like <em>{}</em>. You can add a slash (/) or a dash (-) in between keywords (outside the curly braces) to add them to the URL. For example: <em>{category}/{id}-{rewrite}</em> will result in <em>category/id-rewrite</em>. You may also notice the use of the colon (:) character. This is used within a keyword when adding a slash or a dash. <em>{category :/}</em> results in <em>category/</em>. You can use either method to add dashes or slashes. Below we will change the default URL format for our ipod nano to be more visitor friendly.</p>
<h2>Modifying your SEF URL format in PrestaShop 1.5</h2>
<ol class="article_list">
<li><a href="/support/edu/prestashop-15/getting-started/login-to-dashboard">Log into your PrestaShop admin dashboard</a>.</li>
<li>Using the toolbar across the top of the page, hover over the <em>Preferences</em> tab and then click on the <strong>SEO &amp; URLs</strong> option from the popup menu.</li>
<li>Once on the <em>SEO &amp; URLs</em> page, scroll down until you get to the section labeled <strong>Schema of URLs</strong>. Although there are many fields to work with, we will work with the first one, <strong>Route to products</strong>. In our example, we will remove the <em>ean13</em> number from the URL by removing the keyword tag <em>{-:ean13}</em>. We also will add a slash instead of a dash between the product <em>ID</em> and the <em>rewrite</em> text. To do this we enter the code in the field as <em>{category:/}{id}/{rewrite}.html<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/how-to/change-sef-url-format/change-url.png"><img  alt="new url format coding" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/how-to/change-sef-url-format/change-url.png" /></a><br /></em></li>
<li>Once you have your desired format in place, click the green <strong>Save</strong> button in the upper right corner to save the changes. Below you can see the before and after shots for the URL formatting change.<br />
<table class="article_table">
<tbody>
<tr><th>Before</th><th>After</th></tr>
<tr>
<td>format: <em>{category:/}{id}-{rewrite}{-:ean13}.html</em></td>
<td>format: <em>{category:/}{id}/{rewrite}.html</em></td>
</tr>
<tr>
<td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/how-to/change-sef-url-format/before.png"><img style="max-width: 250px;"  alt="before url formatting change" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/how-to/change-sef-url-format/before.png" /></a></td>
<td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/how-to/change-sef-url-format/after.png"><img style="max-width: 250px;"  alt="after SEF URL format changes" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/how-to/change-sef-url-format/after.png" /></a></td>
</tr>
</tbody>
</table>
</li>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 24: 343: How to alter the format of SEF URLs in PrestaShop 1.5</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 23: <a href='/support/edu/prestashop-15/347-modify-invoice-date-format'>347: How to change the invoice date format in PrestaShop 1.5</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 25: <a href='/support/edu/prestashop-15/342-restore-db'>342: Restoring a database backup in PrestaShop 1.5</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/prestashop-15/343-alter-sef-url-format&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/prestashop-15/343-alter-sef-url-format'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD05OSZpZD0yNDY4JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="71c0625ddc027e10ae53d01983e67bd4" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/36a800694bbafd1024e70e946d9ef492?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/36a800694bbafd1024e70e946d9ef492'>Alastair</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-09 8:21 am</div>
				                <div><p>Great post, I have developed a module that cleans URLs and make them SEO friendly, let me now how do you rate this one,http://www.fmemodules.com/en/49-pretty-urls.html</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13834);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-11 11:28 am</div>
				                <div>Hello Alastair,<br />
<br />
Thank you for your suggestion. Your Pretty URLs PrestaShop module looks helpful.<br />
<br />
If you want to create a blog post about it in our <a href="http://inmotionhosting.com/support/u">User Submitted articles</a> section, I would be happy to link to the post.<br />
<br />
If you have any further questions, feel free to post them below.<br />
Thank you,<br />
<br />
-John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13877);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-11 2:21 am</div>
				                <div><p>Thanks for appreciating our module. I have written a detailed post about PrestaShop URLs with title "One Webpage, Multiple Links, Ugly or Pretty URLs: Does it Matter to Google?"&nbsp;</p>
<p>Please link this post to my article as you said above</p>
<p>Link of article is here; <a href="http://www.inmotionhosting.com/support/u/one-webpage-multiple-links-ugly-or-pretty-urls-does-it-matter-to-google">http://www.inmotionhosting.com/support/u/one-webpage-multiple-links-ugly-or-pretty-urls-does-it-matter-to-google</a></p>
<p>Regards</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25654);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-11 11:39 pm</div>
				                <div>Hello Alastair,<br />
<br />
I have enabled the link to the article you have written. Thanks again for your input.<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25682);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/36a800694bbafd1024e70e946d9ef492?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/36a800694bbafd1024e70e946d9ef492'>Alastair Brian</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-12 4:06 am</div>
				                <div><p>Thank you so much for approving the link. Regards,</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25694);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-15950'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/043565c3ccacda13181105b3aeab3b96?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/043565c3ccacda13181105b3aeab3b96'>vivian</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-07 4:00 am</div>
				                <div><p>May i know how to rewrite the category page from http://shoppingononline.com/en/3-wedding-dresses.html to&nbsp;http://shoppingononline.com/wedding-dresses.html?</p>
<p>How to rewrite product page from&nbsp;http://shoppingononline.com/en/wedding-gowns/8-purple-wedding-gown-transparent-net.html to&nbsp;http://shoppingononline.com/8-purple-wedding-gown-transparent-net.html?</p>
<p>How to rewrite cms page from&nbsp;http://shoppingononline.com/en/content4-About-Us.html to&nbsp;http://shoppingononline.com/About-Us.html?</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15950);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
				...
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-07 7:52 am</div>
				                <div>Hello Vivian,<br />
<br />
Unfortunately, the SEF do not remove the category ID from the URL. There is a paid solution for this, if you like. It is about 50 Euros and can be <a href="http://www.bvkyazilim.com/cart/prestashop-modules/prestashop-pretty-url.html">found here</a>.<br />
<br />
As for the other requests, /en/ is the default for English language version, and removing the category name is possible, but would take you modifying source code to do it. It is not readily done by using the back end of PrestaShop as that is not what it was made for.<br />
<br />
SEF URLs are not meant for the customer, but for Search Engines. Instead of having something like <em>example.com/index.php?catgory_id=2&product_id=3</em> it comes out like <em>example.com/electronics/32-inch-tv.html</em>.  It is meant for search engines to better understand how to rank your pages, and since they are dynamically generated, the SEF makes them look more like actual pages would. Customers or visitors simply bookmark URLs, they do not memorize them, so removing a category name is not useful for that purpose. <br />
<br />
Removing the ID number, even though it can be done via the paid module, is not recommended at all. PrestaShop uses that number, so removing it from the URL can have consequences.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15959);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/043565c3ccacda13181105b3aeab3b96?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/043565c3ccacda13181105b3aeab3b96'>Vivian Lou</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-07 10:16 pm</div>
				                <div><p>For this domain was about 3 years, some of my category page is PR1. If i cannot make the url same as previously then my PR will be gone. Category on url just make my url too long so i want to remove it. Are you mean free version cannot solve this? I must buy the module to solve this?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15980);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-08 7:06 am</div>
				                <div>Hello Vivian,<br />
<br />
To remove the product ID from the URL, yes, you would need to purchase a module. But we still recommend against doing that as it can have consequences on your site. <br />
<br />
You can change the existing URL structure a bit, using the instructions above. For instance, you can try removing the {category} portion of the URL. This means that it would go from <em> {category:/}{id}/{rewrite}.html</em> to <em> {id}/{rewrite}.html</em><br />
<br />
That may make is shorter for you. We have extremely long URLs in some of our articles and we are a PR 7 site. The longer URLs have not affected our ranking, so I wouldn't dwell on that too much.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15996);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-26772'></a>
		<div  style='margin:2px 0px 0px 160px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/b7bddd23353c57e9ecfefa9cafcee3e5?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/b7bddd23353c57e9ecfefa9cafcee3e5'>Xavi</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-18 7:04 am</div>
				                <div><p>Hello scott, sorry to revive this topic again but you've said twice, "removing IDs can have consequences...", could you explain it a bit more, what type of consequences?Many thanks in advance!Regards,Xavi</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26772);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 200px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-18 10:18 am</div>
				                <div>Hello Xavi,<br />
<br />
In the simplest terms it can break the ability of the URL to point to the correct item. This can range from a URL not found to pointing to a different product entirely. <br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26777);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
