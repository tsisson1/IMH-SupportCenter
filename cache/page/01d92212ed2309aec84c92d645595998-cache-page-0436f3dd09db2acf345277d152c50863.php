<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49950:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/php-fusion" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="InMotion Hosting Support Center" />
  <title>PHP-Fusion | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/php-fusion" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:200c76626f4ddad5b49eaa9984030231 -->
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>PHP-Fusion</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	...
	<div class='item-page'>
		<div class='page-header'>
			<h1>PHP-Fusion Education Channel</h1>
		</div>
	
<div style='clear:both;'></div>

<div class='edu_class_listing white_box'>
	<h2>PHP-Fusion Tutorials</h2>
	<ul style='float:left; width:300px; margin-right:20px;'>
<li  ><a href='/support/edu/php-fusion/getting-started-php-fusion'>101: Getting started with PHP-Fusion</a></li>
<li  ><a href='/support/edu/php-fusion/adding-content-to-php-fusion'>102: Adding content to your PHP-Fusion website</a></li>
<li  ><a href='/support/edu/php-fusion/working-with-menus-php-fusion'>103: Working with menus in PHP-Fusion</a></li>
<li  ><a href='/support/edu/php-fusion/changing-appearance-php-fusion'>104: Changing the PHP-Fusion Appearance</a></li></ul><div style='clear:both;'></div></div>
...
<div class='edu_most_popular white_box'>
	<h2>Most Popular Articles</h2>
		<div style='width:300px; height:75px; float:left; margin-right:20px;'>
							<a href='/support/edu/php-fusion/getting-started-php-fusion/login-admin-panel'>How to login to the PHP-Fusion Admin Panel</a>
							<div class='smallgrey'>Hits: 11,086</div>
						</div>
						<div style='width:300px; height:75px; float:left; margin-right:20px;'>
							<a href='/support/edu/php-fusion/changing-appearance-php-fusion/modify-the-copyright-footer-in-php-fusion'>Modify the copyright footer in PHP-Fusion</a>
							<div class='smallgrey'>Hits: 10,157</div>
						</div>
						<div style='width:300px; height:75px; float:left; margin-right:20px;'>
							<a href='/support/edu/php-fusion/adding-content-to-php-fusion/how-to-insert-an-iframe-youtube-video-in-php-fusion'>How to insert an iFrame / YouTube video in PHP-Fusion</a>
							<div class='smallgrey'>Hits: 7,833</div>
						</div>
						<div style='width:300px; height:75px; float:left; margin-right:20px;'>
							<a href='/support/edu/php-fusion/changing-appearance-php-fusion/installing-free-theme-php-fusion'>How to install a free theme to your PHP-Fusion site</a>
							<div class='smallgrey'>Hits: 3,873</div>
						</div>
						<div style='width:300px; height:75px; float:left; margin-right:20px;'>
							<a href='/support/edu/php-fusion/changing-appearance-php-fusion/change-banner-logo'>Changing the banner/logo in PHP-Fusion</a>
							<div class='smallgrey'>Hits: 3,360</div>
						</div>
						<div style='width:300px; height:75px; float:left; margin-right:20px;'>
							<a href='/support/edu/php-fusion/changing-appearance-php-fusion/switching-your-php-fusion-theme'>Switching your PHP-Fusion theme</a>
							<div class='smallgrey'>Hits: 3,293</div>
						</div>
						<div style='clear:both;'></div>
</div>
...
<form action="http://www.inmotionhosting.com/support/edu/php-fusion" method="post" name="adminForm" id="adminForm" class="form-inline">
	...
	<option value="0">All</option>
		...
		<h2>PHP-Fusion - Advanced Tutorials</h2>
		<table style='margin-top:20px;'>
			...
			<tr>
				...
				<td valign='top' style='padding-bottom:15px;'>
					<div><a href='/support/edu/php-fusion/add-recaptcha'>300: Add ReCaptcha to PHP-Fusion</a></div>
					<div>Activating and using Recaptcha within PHP-Fusion is very simple due to the way it is available within the interface.  The following article explains how to use it within the PHP-Fusion interface.</div>
					<div class='smallgrey'>
			...
			<tr>
				...
				<td valign='top' style='padding-bottom:15px;'>
					<div><a href='/support/edu/php-fusion/301-php-fusion-over-ssl'>301:Forcing PHP-Fusion to work over SSL</a></div>
					<div>This is a guide on using PHP-Fusion over a secure SSL connection via https://.</div>
					<div class='smallgrey'>
			...
			<tr>
				...
				<td valign='top' style='padding-bottom:15px;'>
					<div><a href='/support/edu/php-fusion/302-db-backup'>302: How to create a database backup in PHP-Fusion</a></div>
					<div>Backing up your data regularly is highly recommended. Find out how to do so in this PHP-Fusion tutorial.</div>
					<div class='smallgrey'>
			...
			<tr>
				<td valign='top' style='padding:6px 15px 0px 0px;'><img src='https://lh3.googleusercontent.com/-et9qjCJVL08/AAAAAAAAAAI/AAAAAAAAAC4/C539ZYF2HNc/s90-p-rw-no/photo.jpg' class='sc_rc' style='width:55px;' /></td>
				<td valign='top' style='padding-bottom:15px;'>
					<div><a href='/support/edu/php-fusion/303-restore-backup'>303: Restoring a database backup in PHP-Fusion</a></div>
					<div>Once you have a backup ready to go, you can restore it via the admin dashboard. Learn how  in this PHP-Fusion article.</div>
					<div class='smallgrey'>
						Written by Scott Mitchell<br />
						Hits: 1,096
					</div>
			...
			<tr>
				<td valign='top' style='padding:6px 15px 0px 0px;'><img src='http://lh3.googleusercontent.com/-Qzm5Afwbl4g/AAAAAAAAAAI/AAAAAAAAAEc/CXPngTPySFA/s120-c/photo.jpg?sz=90' class='sc_rc' style='width:55px;' /></td>
				<td valign='top' style='padding-bottom:15px;'>
					<div><a href='/support/edu/php-fusion/304-installing-an-addon-in-php-fusion'>304:Installing an Addon in PHP-Fusion</a></div>
					<div>This is a guide on how to install an addon or Infusion in PHP-Fusion.</div>
					<div class='smallgrey'>
						Written by John-Paul Briones<br />
						Hits: 2,131
					</div>
			...
			<tr>
				<td valign='top' style='padding:6px 15px 0px 0px;'><img src='https://lh3.googleusercontent.com/-np8xy9GiNy8/AAAAAAAAAAI/AAAAAAAAAEU/Eu1yKGoTxiA/photo.jpg?sz=50' class='sc_rc' style='width:55px;' /></td>
				<td valign='top' style='padding-bottom:15px;'>
					<div><a href='/support/edu/php-fusion/305-database-errors'>305: Dealing with Database Errors in PHP-Fusion</a></div>
					<div>PHP-Fusion uses a MYSQL database.  Occasionally, there might be an issue with database connection that can happen due to a SQL server issue, or due to login issues.  The following article describes the errors you may see in these cases.</div>
					<div class='smallgrey'>
						Written by Arnel Custodio<br />
						Hits: 979
					</div>
			...
			<tr>
				<td valign='top' style='padding:6px 15px 0px 0px;'><img src='http://lh3.googleusercontent.com/-Qzm5Afwbl4g/AAAAAAAAAAI/AAAAAAAAAEc/CXPngTPySFA/s120-c/photo.jpg?sz=90' class='sc_rc' style='width:55px;' /></td>
				<td valign='top' style='padding-bottom:15px;'>
					<div><a href='/support/edu/php-fusion/setting-up-smtp-in-php-fusion'>306: Setting Up SMTP in PHP-Fusion</a></div>
					<div></div>
					<div class='smallgrey'>
						Written by John-Paul Briones<br />
						Hits: 1,579
			...
			<tr>
				<td valign='top' style='padding:6px 15px 0px 0px;'><img src='https://lh3.googleusercontent.com/-et9qjCJVL08/AAAAAAAAAAI/AAAAAAAAAC4/C539ZYF2HNc/s90-p-rw-no/photo.jpg' class='sc_rc' style='width:55px;' /></td>
				<td valign='top' style='padding-bottom:15px;'>
					<div><a href='/support/edu/php-fusion/307-view-error-report'>307: Viewing error reporting in PHP-Fusion</a></div>
					<div>Looking to find an error? Look here for a guide on viewing error reports in PHP-Fusion.</div>
					<div class='smallgrey'>
						Written by Scott Mitchell<br />
						Hits: 1,047
					</div>
			...
			<tr>
				<td valign='top' style='padding:6px 15px 0px 0px;'><img src='http://lh3.googleusercontent.com/-Qzm5Afwbl4g/AAAAAAAAAAI/AAAAAAAAAEc/CXPngTPySFA/s120-c/photo.jpg?sz=90' class='sc_rc' style='width:55px;' /></td>
				<td valign='top' style='padding-bottom:15px;'>
					<div><a href='/support/edu/php-fusion/adding-google-analytics-code-to-php-fusion'>Adding Google Analytics Code to PHP-Fusion</a></div>
					<div></div>
					<div class='smallgrey'>
						Written by John-Paul Briones<br />
						Hits: 2,422
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xMTYmaWQ9MTE2JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
