<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:68667:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-3/311-search-component" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-01-04T14:38:14-08:00" />
  <meta name="keywords" content="joomla 3.0 search component" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="The Joomla Search Component allows you to both view statistics about what your users are searching for and customize various search settings available." />
  <title>311: Joomla 3.1 Search Component Tutorial - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-3/311-search-component" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:320614d5ca518e6e4c093e45c180c0e8 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '83.28.6.58']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															311: Joomla 3.1 Search Component Tutorial									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>14,303</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Dec 18, 2012'><span style='color:#606060;'>Published:</span> Jan 4, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/components/search/components-search.jpg"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="components-search" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/components/search/components-search.jpg" /></a>The Joomla Search component allows you to do two things - view statistics about what people are searching for on your site and customize the available search settings. In this tutorial, we'll cover both of these topics, starting first with search statistics.</p>
<h2>Search Statistics</h2>
<h3>Enabling gathering of search statistics</h3>
<p>When you first access the Joomla Search Component, you'll see a <strong>Gathering statistics disabled</strong> error message. To being using the search statistics feature, we'll first enable statistics gathering.</p>
<ol class="article_list">
	<li><a href="/support/edu/joomla-3/getting-started/login-dashboard">Log into your Joomla 3.0 admin dashboard</a></li>
	<li>In the top menu, click <strong>Components</strong> and then click <strong>Search</strong></li>
	<li>Click the <strong>Options</strong> button towards the top of the page</li>
	<li>Set the <strong>Gather Search Statistics</strong> setting to <strong>Yes</strong>, and then click the <strong>Save &amp; Close</strong> button towards the top of the page.<br /><br />The page will refresh and then you will see a message that says <strong>Gathering statistics enabled</strong>.</li>
</ol>
<h3>Viewing what users are searching for</h3>
<p>In our testing, we used the search module on our website to search for the following words (each one in a separate search): apple, orange, and fruit. Using the search statistics feature, we can see information on these searches that we just performed.</p>
<ol class="article_list">
	<li><a href="/support/edu/joomla-3/getting-started/login-dashboard">Log into your Joomla 3.0 admin dashboard</a></li>
	<li>In the top menu, click <strong>Components</strong> and then click <strong>Search</strong><br /><br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/components/search/search-statistics.jpg"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="search-statistics" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/components/search/search-statistics.jpg" /></a>That's it! As you can see in the screenshot to the right, Joomla shows a listing of all phrases searched for on the site, how many times each phrase was searched for (referred to as <strong>hits</strong>), and the number of results for each search.
		<div style="clear: both;">&nbsp;</div>
		<h4>Showing the number of search results</h4>
		<p>In the screenshot above, you can see under the <strong>Results</strong> column it simply says <strong>Off</strong>. If you want to see how many search results are returned for each search phrase, find and click on the button that says <strong>Show Search Results</strong>.<br /><br />In our testing, we don't have any articles about oranges, apples, or fruit. We do have a few articles about the word blog, so we'll show you how the Results feature works by searching our site for <strong>blog</strong>.<br /><br />As you can see in the screenshots below, we have 9 results for the word blog, and the search component similarly shows 9 search results.</p>
		<table class="article_table">
			<tbody>
				<tr>
					<th>A search for the word blog</th>
					<th>Results data shown in the search component</th>
				</tr>
				<tr>
					<td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/components/search/nine-search-results-returned.jpg"><img style="max-width: 250px;"  alt="nine-search-results-returned" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/components/search/nine-search-results-returned.jpg" /></a>
					</td>
					<td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/components/search/search-component-showing-nine-results-as-well.jpg"><img style="max-width: 250px;"  alt="search-component-showing-nine-results-as-well" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/components/search/search-component-showing-nine-results-as-well.jpg" /></a>
					</td>
				</tr>
			</tbody>
		</table></li>
</ol>
<h3>Reseting search data</h3>
<p>For busy websites, your users may search on your website quite often. With so much data showing in the search statistics, it may make it difficult to find the information you're actually looking for. Clearing the search statistics will remove all data, and allow you to start fresh.</p>
<ol class="article_list">
	<li><a href="/support/edu/joomla-3/getting-started/login-dashboard">Log into your Joomla 3.0 admin dashboard</a></li>
	<li>In the top menu, click <strong>Components</strong> and then click <strong>Search</strong></li>
	<li>In the top menu, click the <strong>Reset</strong> button.<br /><br />You can see below what the search statistics look like before and after we click the reset button.<br />
		<table class="article_table">
			<tbody>
				<tr>
					<th>Before clicking reset</th>
					<th>After clicking reset</th>
				</tr>
				<tr>
					<td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/components/search/before-clicking-reset.jpg"><img style="max-width: 240px;"  alt="before-clicking-reset" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/components/search/before-clicking-reset.jpg" /></a>
					</td>
					<td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/components/search/after-resetting-search-statistics.jpg"><img style="max-width: 240px;"  alt="after-resetting-search-statistics" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/components/search/after-resetting-search-statistics.jpg" /></a>
					</td>
				</tr>
			</tbody>
		</table><strong><br /></strong></li>
</ol>
<h2>Search Options</h2>
<p>There are several options available that you can use to customize the way your Joomla site's search works. Below, we will show you how to access these settings, and we will also explain what each of them controls.</p>
<ol class="article_list">
	<li><a href="/support/edu/joomla-3/getting-started/login-dashboard">Log into your Joomla 3.0 admin dashboard</a></li>
	<li>In the top menu, click <strong>Components</strong> and then click <strong>Search</strong></li>
	<li>Click the <strong>Options</strong> button towards the top of the page</li>
	<li>Adjust the settings as you see fit, and then click the <strong>Save </strong>button in the top left of the page. Below is a summary of several of the settings.
		<p>&nbsp;</p>
		<h3>Use Search Areas</h3>
		<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/components/search/search-only.jpg"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="search-only" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/components/search/search-only.jpg" /></a>The <strong>Use Search Areas</strong> setting gives your users the option to search only through certain types of content. For example, if the user only wants to search through Newsfeed and not Articles, using the search areas feature (shown to users as <strong>Search Only</strong>) they can do this. If you disable this setting, the Search Only feature (highlighted in the screenshot to the right) will not show to users.</p>
		<div style="clear: both;">&nbsp;</div>
		<h3>Created Date</h3>
		<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/components/search/search-created-on.jpg"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="search-created-on" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/components/search/search-created-on.jpg" /></a>By default, when you search a Joomla site, in the results the date the article was created on will show. If you disable the <strong>created date</strong> feature, the search results will no longer show the <em>Created on</em> data. In the screenshot to the right, we've highlighted the created on feature so you know exactly what it is we're referring to.</p>
		<div style="clear: both;">&nbsp;</div>
		<h3>OpenSearch</h3>
		<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/components/search/opensearch.jpg"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="opensearch" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/components/search/opensearch.jpg" /></a>Are you familiar with the Google search bar in the top right of your firefox browser? That's an OpenSearch feature. If you see in the screenshot to the right, when you're on our Joomla site's search results page, users have the option to add a custom OpenSearch toolbar, which will allow them to quickly search our site, and only our site.<br /><br />OpenSearch was developed in 2005 by Amazon. In our many years in technical support, the phrase OpenSearch has not come up often, but most everyone is familiar with what it is (but maybe not its name).</p>
		<p>The Joomla Search Component includes two OpenSearch settings, <strong>OpenSearch Name</strong> and <strong>OpenSearch Description</strong>.<br /><br />In our testing, we entered the following settings:</p>
		<table class="article_table">
			<tbody>
				<tr>
					<th>OpenSearch Name</th>
					<td>Joomla 3.0.2 Testing site</td>
				</tr>
				<tr>
					<th>OpenSearch Description</th>
					<td>This website is driven by Joomla 3.0.2, and is used as a testing ground for testing Joomla.</td>
				</tr>
			</tbody>
		</table>
		<p>Now that we've adjusted these settings, how do we see what has changed?</p>
		<p>Go to your Joomla website and perform any search. Then view the source code of the page and you should see something similar to the follow:</p>
		<pre class="code_block">&lt;link href="http://domain.com/component/search/?searchword=blog&amp;ordering=newest&amp;searchphrase=all&amp;limit=20&amp;format=<strong>opensearch</strong>" rel="search" title="Search Joomla 3.0.2" type="application/<strong>opensearch</strong>description+xml" /&gt;</pre>
		<p>If you access this URL, it will prompt you to download a file named download.osdx. When you open that file with a text editor, such as notepad, you should see something similar to the following:</p>
		<pre class="code_block">&lt;?xml version="1.0" encoding="utf-8"?&gt;<br />   &lt;OpenSearchDescription xmlns="http://a9.com/-/spec/opensearch/1.1/"&gt;<br />      &lt;ShortName&gt;<span style="background-color: #ffff99;">Joomla 3.0.2 Testing site</span>&lt;/ShortName&gt;<br />      &lt;Description&gt;<span style="background-color: #ffff99;">This website is driven by Joomla 3.0.2, and is used as a testing ground for testing Joomla.</span>&lt;/Description&gt; &lt;InputEncoding&gt;UTF-8&lt;/InputEncoding&gt;<br />      &lt;Image type="image/vnd.microsoft.icon" width="16" height="16"&gt;http://domain.com/templates/protostar/favicon.ico&lt;/Image&gt;<br />      &lt;Url type="application/opensearchdescription+xml" rel="self" template="http://domain.com/component/search/?searchword=blog&amp;ordering=newest&amp;searchphrase=all&amp;limit=20&amp;format=opensearch"/&gt;<br />      &lt;Url type="text/html" template="http://bradm.rubelix.com/joomla3.0.2/index.php?option=com_search&amp;searchword={searchTerms}"/&gt;<br />   &lt;/OpenSearchDescription&gt;</pre>
		<p>We'd love to tell you what all this means, but it honestly isn't something we're very familiar with. The take home point is that the Joomla allows you to customize these OpenSearch settings if you need to do so.</p>
		<h3>Search for</h3>
		<p>If you notice in the screenshots above, the search feature includes a <strong>Search for</strong> option. This option allows users to search either for <em>All words</em>, <em>Any words</em>, or <em>Exact Phrase</em>.</p>
		<p>We received a question on how to hide this functionality. There does not seem to be a setting in Joomla to do this. To accomplish this however, we can edit our template's CSS.</p>
		<p>To hide the <em>Search for</em> feature, edit your template's CSS file and add the following code to the bottom:</p>
		<p class="code_block">#searchForm fieldset.phrases {display:none;}</p>
		<p>If you're using the protostar template, this is the file you will need to edit:</p>
		<p class="code_block">templates/protostar/css/template.css</p>
		<p>In our testing, using this 'work around' solved the problem. After making the change, be sure to clear your browser's cache so the update CSS file is used.</p></li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 32: 311: Joomla 3.1 Search Component Tutorial</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 31: <a href='/support/edu/joomla-3/301-need-php-5-3-1'>301: Your host needs to use PHP 5.3.1 or higher to run this version of Joomla!</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 33: <a href='/support/edu/joomla-3/310-newsfeeds'>310: Joomla 3.1 RSS Newsfeeds Component Tutorial</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-3/311-search-component&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-3/311-search-component'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xMDEmaWQ9MjQ1MiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="98e5ce0d8b795e8483f3a74893defe74" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/ebca7ddb042c80dbffa755fa14e42c06?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/ebca7ddb042c80dbffa755fa14e42c06'>Sandro</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-06 10:57 am</div>
				                <div><p>Hi,</p>
<p>I do this but in the last version of Joomla the "show search results" make a blank page !</p>
<p>I resolve the problem in the file :&nbsp;www/components/com_tags/models/tag.php on line 174</p>
<p>//line added to repair search blank page in admin BO sandro 20140606</p>
<p>$params = JComponentHelper::getParams('com_tags');</p>
<p>//Remove this line&nbsp;because error on search blank page in admin BO sandro20140606&nbsp;</p>
<p>//$params = $app-&gt;getParams();</p>
<p>&nbsp;</p>
<p>Sandro from www.italie-visite.com</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11237);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
