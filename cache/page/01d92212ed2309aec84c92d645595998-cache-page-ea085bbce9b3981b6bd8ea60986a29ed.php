<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50265:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/reseller/custom-default-page" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-08-20T14:44:26-07:00" />
  <meta name="author" content="John-Paul Briones" />
  <meta name="description" content="InMotion Hosting Support Center" />
  <title>Using a Custom Landing Page - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/reseller/custom-default-page" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:7d383fc8003c5efef3b176a2880a7c09 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Using a Custom Landing Page									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>2,685</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Sep 12, 2013'><span style='color:#606060;'>Published:</span> Aug 20, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								When you create a cpanel, you have an option to copy some standard files to the account, such as a default landing page. For example, you may want a “coming soon” page as a placeholder on new accounts, then when your customer uploads their own website files they can remove the existing page.<br><br>

In this article I will show you how to upload a custom default landing page via the cPanel File Manager. You can also upload files using FTP, or SSH.

<p class="alert" style="color:red">For a file to load by <em>default</em>, it must be named: default.htm, default.html, index.htm, index.html, or index.php</p>

<h2>How to use a Custom Landing Page</h2>
<ol class="article_list">
  <li><a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">Login to cPanel</a></li>
<li>Click the <strong>File Manager</strong> button under <em>Files</em><br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/reseller/selecting-file-manager.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/reseller/selecting-file-manager.png" alt="open file manager in cPanel" title="managing files" /></a><br></li><br>
<li>In the <em>left</em> navigation window, click the <strong>cpanel3-skel</strong> folder, then click the <strong>public_html</strong> folder.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/reseller/selecting-public_html-folder.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/reseller/selecting-public_html-folder.png" alt="public_html click" title="opening public_html" /></a><br></li><br>
<li>Click the <strong>Upload</strong> button, then click the <strong>Browse</strong> button and select your <em>custom landing page</em>, and click the <strong>Open</strong> button. The file will then be uploaded. <br>
Now, when you create a new cPanel account, it will include the <em>default landing page</em> you just uploaded.</li>
<br></ol><br>
Congratulations, now you know how to use a custom landing page for the cPanels you create. 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/reseller/custom-default-page&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/reseller/custom-default-page'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MjQmaWQ9MjgyOSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
