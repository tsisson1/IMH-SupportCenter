<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:67857:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotion.net/support/website/google-tools/what-is-a-xml-sitemap-and-how-do-i-create-one" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-02-20T18:48:10-08:00" />
  <meta name="keywords" content="XML sitemap Google webmaster tools" />
  <meta name="author" content="Tim Sisson" />
  <meta name="description" content="In this tutorial, learn what an XML sitemap is and how to generate one using a third party website. " />
  <title>What is a XML sitemap and how do I create one? - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/google-tools/what-is-a-xml-sitemap-and-how-do-i-create-one" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:c915606ab2d02e978fa5d3a364b078cb -->
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>What is a XML sitemap and how do I create one?</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															What is a XML sitemap and how do I create one?									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>16,558</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Nov 11, 2011'><span style='color:#606060;'>Published:</span> Feb 20, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>An XML sitemap is a document that helps Google and other major search engines better understand your website while crawling it.</p>
<h2>What is a sitemap and why is it important?</h2>
<p>Sitemaps are a protocol that allows the webmaster for a website to inform Google and other major search engines about URLS on a website that are available for crawling. Sitemaps allow search engines to find all of your webpages, that they might otherwise miss when indexing. The XML sitemap allows you to specify additional information about each URL such as:</p>
<ul>
<li>When it was last updated</li>
<li>How often the site changes</li>
<li>How important the page is in relation to other pages on the site</li>
</ul>
<p>Having this information within one document helps search engines understand your website and crawl it more intelligently. Sitemaps are an inclusion protocol, where Robots.txt files are exclusionary. For more information on <a href="/support/website/how-to/how-to-stop-search-engines-from-crawling-your-website">robots.txt files</a> please read our article.</p>
<h2>How do I generate a XML sitemap?</h2>
<p>Generating a XML sitemap for you website is a simple process, and there are many websites that can help you do so. Google recommends using <a href="http://xml-sitemaps.com">http://xml-sitemaps.com</a></p>
<p>Start by visiting the link above in your web browser. On the home page of the website you can follow the 4 easy steps they have listed there.</p>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/xml-sitemap.jpg"><img  alt="xml-sitemap" src="//cdn.inmotionhosting.com/support/images/stories/xml-sitemap.jpg" /></a></p>
<p>In the third step on the webpage, you'll be downloading the text file from the website to your local computer. Once the file is downloaded to your local computer you'll then need to upload it to your document root of your domain. If you're unfamiliar with <a href="http://www.inmotionhosting.com/support/website/managing-files/how-to-upload-files-server#file-manager">uploading files using manager</a>, please read our article.&nbsp;</p>
<h2>Understanding Search Engines and Sitemaps</h2>
<p>You do not upload your sitemap to the search engines. After you have uploaded the sitemap to the server, you simply have to submit the full URL to your sitemap. After you have submitted the sitemaps to the major search engines, the next time they crawl the website they will have a better understanding of how your website works.</p>
<ul>
<li><strong>Google</strong>: You will need to use your <a href="/support/website/google-tools/introduction-to-google-webmaster-tools">Webmaster Tools</a> account to let Google know the full URL to your sitemap.</li>
<li><strong>Bing</strong>: Bing uses Windows Live accounts under the Webmaster Center section to specify sitemaps.</li>
<li><strong>Yahoo</strong>: You will need to sign in to Yahoo! and insert the url in the 'Submit Site feed field'</li>
</ul>
<p>If you need further assistance or have further questions, please feel free to <a href="/support/website/website-troubleshooting/how-to-get-great-technical-support">contact our support department</a>.&nbsp;</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotion.net/support/website/google-tools/what-is-a-xml-sitemap-and-how-do-i-create-one&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotion.net/support/website/google-tools/what-is-a-xml-sitemap-and-how-do-i-create-one'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD03OCZpZD0yOTUmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="a4c6901f267cd1bd77aae0c91546bffa" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/ea233987646142d1319eafda3a53f2ee?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/ea233987646142d1319eafda3a53f2ee'>mhima</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-21 8:12 am</div>
				                <div><p style="margin: 0px 0px 11px; color: #232323; font-family: adelle-sans, Helvetica, Arial, sans-serif; font-size: 13px; line-height: 22px; background-color: #f9f9f9;">Sitemaps are a protocol that allows the webmaster for a website to inform Google and other major search engines about URLS on a website that are available for crawling. Sitemaps allow search engines to find all of your webpages, that they might otherwise miss when indexing. The XML sitemap allows you to specify additional information about each URL such as:</p>
...
<p style="margin: 0px 0px 11px; color: #232323; font-family: adelle-sans, Helvetica, Arial, sans-serif; font-size: 13px; line-height: 22px; background-color: #f9f9f9;">&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13073);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-27825'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/c46df77a7722d215f58152fc5682a7e1?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/c46df77a7722d215f58152fc5682a7e1'>egrowth solution</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-24 1:05 am</div>
				                <div><p>useful and good inforation&nbsp;provided.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27825);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-29 1:56 pm</div>
				                <div><p>Tnku for sharing this information. very helpful for the starters like us.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30238);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
