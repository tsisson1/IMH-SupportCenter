<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:85728:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/ip-addresses/purchase-dedicated-ip-address-amp" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-07-17T15:18:05-07:00" />
  <meta name="keywords" content="AMP dedicated IP additional IP order purchase obtain assign 2xram" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="In this tutorial, we will explain how to request a dedicated IP address in AMP." />
  <title>How to Obtain Additional IP Addresses - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/ip-addresses/purchase-dedicated-ip-address-amp" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:c4087fa52830e9a093dd5a5c97cfb6cc -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '134.83.1.241']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/website/ip-addresses' itemprop='url'><span itemprop='title'>IP Addresses<span></a><div class='dropdown_3columns'><div class='col_3'><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/ip-addresses/purchase-dedicated-ip-address-amp'>How to Obtain Additional IP Addresses</a> (39583 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/ip-addresses/explaining-ip-request-decisions'>Why would my request to obtain a dedicated IP address be denied?</a> (1190 hits)</div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to Obtain Additional IP Addresses</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to Obtain Additional IP Addresses									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>39,583</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Aug 23, 2011'><span style='color:#606060;'>Published:</span> Jul 17, 2015</div>
  ...
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('shared');">Shared or Dedicated IP?</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('purchase');">Purchase a Dedicated IP</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('add');">Adding IP from AMP</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('assign');">Assign IP in WHM</button>
</div>

<p>When you sign up for a shared account (<a href="/support/../hostingplans.html">Business Class Hosting</a>), the account will use the same "<em>Main</em>" IP address as the other sites on server. <a href="http://www.inmotionhosting.com/reseller-hosting">Reseller</a>, <a href="http://www.inmotionhosting.com/dedicated-servers">Dedicated</a> and <a href="http://www.inmotionhosting.com/vps-hosting">VPS</a> servers have a single "<em>Main</em>" IP address set up on the server as well. Click here to learn more about <a href="http://www.inmotionhosting.com/dedicated-servers">Dedicated Server hosting</a></p>

<a name="shared"></a>
<h2>Is My IP address shared or dedicated?</h2>
<p><strong>The "<em>Main</em>" server IP address is referred to as a "<em>Shared IP address</em>".</strong> This is because all cPanel accounts on the server by default will use that "<em>Main</em>" IP address for their domain. <strong>To find if you have a dedicated IP or not, log into your cpanel and look at the stats to the left.</strong> cPanel accounts can have a dedicated IP address assigned separate from the main IP (See images below).<br style="clear: both;" /></p>
<table align="center">
<tbody>
<tr><th colspan="3" align="center">cPanel IP assignments</th></tr>
<tr>
<td align="center">Shared IP address</td>
<td></td>
<td align="center">Dedicated IP address</td>
</tr>
<tr>
<td align="center"><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/server-usage/dedicated-ip/shared-ip.gif"><img  alt="Cpanel with a shared IP address" src="//cdn.inmotionhosting.com/support/images/stories/website/server-usage/dedicated-ip/shared-ip.gif" title="Click here to view the larger image" width="150" /></a></td>
<td></td>
<td align="center"><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/server-usage/dedicated-ip/dedicated-ip-1.gif"><img  alt="Cpanel with a dedicated IP address" src="//cdn.inmotionhosting.com/support/images/stories/website/server-usage/dedicated-ip/dedicated-ip-1.gif" title="Click here to view the larger image" width="150" /></a></td>
</tr>
</tbody>
</table>
<p><strong>VPS and Dedicated servers do not have Dedicated IP addresses assigned by default</strong> due to IP scarcity. Even though Dedicated and VPS server plans have free IP addresses included, only the main "Shared IP" is assigned to the server. In order for an IP address to be changed or added to any server with InMotion hosting (ie., Shared, VPS, or Dedicated plans), the IP will need to be requested.</p>
<p>Depending on the plan you have, you may need to either purchase the IP or have it assigned for free. The next 2 sections will explain how to purchase a dedicated IP or have one assigned.<br style="clear: both;" /></p>


<a name="purchase"></a>
<h2>Purchasing a dedicated IP address</h2>
<p>If you require a dedicated IP address and your plan does not have any free IP addresses included, <strong>you can purchase one for  $24 per year</strong>. Dedicated IP addresses can be ordered from within your Account Management Panel (AMP). The following steps will explain how to purchase a dedicated IP address.</p>
<ol class="article_list">

<li><a href="/support/website/how-to/how-to-log-into-amp"><strong>Log into your AMP</strong></a> (Account Management Panel).</li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/amp/add-ip/request-dedicated-ip.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Add IP address AMP request" src="//cdn.inmotionhosting.com/support/images/stories/amp/add-ip/request-dedicated-ip.png" title="Click here to view the larger image" width="100" /></a>Under your account name, click the <strong>Request Dedicated IP</strong> button.<br>
</li><br style="clear: both;" />


<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/amp/add-ip/add-ip-server-4-proceed.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Add IP address AMP proceed with assignment" src="//cdn.inmotionhosting.com/support/images/stories/amp/add-ip/add-ip-server-4-proceed.png" title="Click here to view the larger image" width="100" /></a>Read the disclaimer for the IP address assignment. Click <strong>Proceed</strong>.
<br style="clear: both;" />

<li>Confirm your payment details on the next screen.
<p><strong>Click Submit</strong>.</p>
</li>
</ol>

<p>When you order a dedicated IP address, an email will be sent to you confirming your Dedicated IP was set up with the IP included in the email. Due to DNS Propagation, the new IP address can take up to 24 hours before it is fully activated.</p>

<a name="add"></a>
<h2>Adding an IP address through AMP</h2>
<p>If your hosting plan includes an IP address, you can request it from AMP.</p>
<ol class="article_list white_box">

<li><a target="_blank" href="/support/website/how-to/how-to-log-into-amp" title="Click for more information">Log into AMP.</a></li>
...
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/amp/add-ip/add-ip-server-5-check-email.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="chyeck email Add IP address AMP" src="//cdn.inmotionhosting.com/support/images/stories/amp/add-ip/add-ip-server-5-check-email.png" title="Click here to view the larger image" width="100" /></a>You will see a confirmation that the IP address was submitted.
<br style="clear: both;" /></p></li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/amp/add-ip/add-ip-server-6-initial.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Request submitted Add IP address AMP" src="//cdn.inmotionhosting.com/support/images/stories/amp/add-ip/add-ip-server-6-initial.png" title="Click here to view the larger image" width="100" /></a>Check your email that you signed into AMP with. You will see an initial email explaining the request was submitted.
<br style="clear: both;" />

<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/amp/add-ip/add-ip-server-7-new.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="New IP address Add IP address AMP" src="//cdn.inmotionhosting.com/support/images/stories/amp/add-ip/add-ip-server-7-new.png" title="Click here to view the larger image" width="100" /></a>Shortly after you will get an email with your new IP address in the contents. Next you will need to assign the IP address to the domain.
<br style="clear: both;" />
</p></li>

</ol>
<a name="assign"></a>
<h2>Assigning an IP in WHM (VPS, Reseller, and Dedicated)</h2>

<ol class="article_list white_box">

<li><a href="/support/component/content/email/email-client-setup/log-into-whm?Itemid=242" target="_blank" title="Click here for info">Log into your WHM</a>.</li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/amp/add-ip/add-ip-server-8-change.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Add IP address AMP change IP" src="//cdn.inmotionhosting.com/support/images/stories/amp/add-ip/add-ip-server-8-change.png" title="Click here to view the larger image" width="100" /></a>You can type IP in the search to narrow the list of options on the left. Look for the IP Functions section and click Change a Site's IP address.
<br style="clear: both;" />
</li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/amp/add-ip/add-ip-server-9-domain.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Add IP address AMP domain selection" src="//cdn.inmotionhosting.com/support/images/stories/amp/add-ip/add-ip-server-9-domain.png" title="Click here to view the larger image" width="100" /></a>Select the domain from the list or type the domain you want the IP for.
<p>Click <strong>Change</strong>.<br style="clear: both;" />
</p></li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/amp/add-ip/add-ip-server-10-list-of.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="List of IP addresses Add IP address AMP" src="//cdn.inmotionhosting.com/support/images/stories/amp/add-ip/add-ip-server-10-list-of.png" title="Click here to view the larger image" width="100" /></a>From the New Address drop box, select the IP address from the list.
<p>Click <strong>change</strong>.<br style="clear: both;" />
</p></li>
</ol>

<p>If you are looking for a dedicated server solution but are unsure how to go about getting one, read more about <a href="http://www.inmotionhosting.com/dedicated_servers/articles/how-to-get-dedicated-server.html">how to get a dedicated server</a> here.</p>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/ip-addresses/purchase-dedicated-ip-address-amp&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/ip-addresses/purchase-dedicated-ip-address-amp'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NDcmaWQ9MTMzJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="5b7f19a03df362725e7e646aef44b551" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/team/do-i-have-a-fix-ip-address?tsrc=rsbraq'>Do I have a dedicated IP address?</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/file-management/how-can-i-allow-users-to-download-files-via-a-symlink?tsrc=rsbraq'>How can I allow users to download files via a symlink?</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/whm/dedicated-ip-in-reseller-hosting-plan?tsrc=rsbraq'>Free Dedicated IP in Reseller Hosting Plan</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/prestashop-15/prestashop-throwing-paypal-error-line-130?tsrc=rsbraq'>Prestashop throwing Paypal error line 130</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/429ffb6339c1b32cf502627bb72b7f63?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/429ffb6339c1b32cf502627bb72b7f63'>Mathew Zupan</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-11 2:54 pm</div>
				                <div><p>I am trying to get one of the five static IP's that come with our dedicated server to be assigned to the following domain: carlsbadok.com</p>
<p>How do I go about this?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22543);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-13 11:28 am</div>
				                <div>Hello Mathew,<br />
<br />
If you are asking about the free ones, you simply need to send an email request to support@inmotionhosting.com. Be sure to tell them why you need it as they only approve them if they are to be used for valid reasons, such as SSL. Also, be sure to verify the account in the email with either the last 4 digits of the credit card on file or the current AMP password.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22582);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						...
						<div><a style='font-size:16px;' href='/support/community-support/users/thealt'>thealt</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-19 8:12 pm</div>
				                <div>Hi, I requested and paid for a dedicated IP address for my ssl domain enoverse.com on the 14th of September. I have spoken with support and all I have been told is what I already know, that it is pending. I was told 24 hours at most, its now 6 days later. I am losing money , losing visitors because I cannot run the site until it is secure. Why is it taking so long?</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26802);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-21 2:25 pm</div>
				                <div>Hello thealt,<br />
<br />
Apologies for your delay on your SSL. Unfortunately I have no information on your account here. Six days is definitely too long. You will want to contact <a href="http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support">Live Support</a> to speak with them on your individual situation.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26834);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-25229'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/1aba228900ac98073a9edc438c85e3fb?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/1aba228900ac98073a9edc438c85e3fb'>Peter</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-28 4:19 am</div>
				                <div><p>I have been directed to this page every time I ask for more dedicated IP address for new domian on my dedicated server account(klsupply.com) but I do not see "Request Dedicated IP" button on my AMP site.</p>
<p>Here is my ticket number {100-2350068}</p>
<p>Please advise.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25229);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-28 8:53 am</div>
				                <div>Hello Peter,<br />
<br />
I see that we have responded to your ticket with information regarding your dedicated IP addresses. This icon appears to only be for people who are on shared/vps plans due to the differences in our dedicated/commercial class servers. I do apologize for this inconvenience. <br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25239);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='/support/images/avatars/default_avatar.jpg' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='/support/community-support/users/mattsimpson'>mattsimpson</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-11 1:50 pm</div>
				                <div>In the section &quot;Assigning an IP in WHM (VPS, Reseller, and Dedicated)&quot; -- You need to have root access enabled to access this area in WHM, otherwise it's hidden. If you don't want to do that, you can just contact support and they can help you assign the IP.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28355);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-29795'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/d7799fa512184e197db813b4f8cdcddf?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/d7799fa512184e197db813b4f8cdcddf'>Ramin Nahoraof</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-13 5:24 pm</div>
				                <div><p>I requested a dedicated IP address a few days ago.</p>
<p>I have not received any emails about it.</p>
<p>You have changed the layout of the login page, so this page "How to obtain an additional IP address" is no longer relavent since none of the images of the interface are accurate.</p>
<p>Can someone please tell me where I can find my new dedicated IP address. &nbsp;I cannot find it on my interface anywhere since InMotion changed the interface.&nbsp;</p>
<p>Thank you,</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29795);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-13 5:48 pm</div>
				                <div>Hello Ramin,<br />
<br />
Sorry for the delay in getting your IP address.  We unfortunately cannot correct that for you, but we can create a ticket asking the status of the issue - you can do the same or even call into the live support team to determine what's happening.  I will go ahead and submit a ticket on your behalf to determine the status (ticket#2583174).<br />
<br />
If you have any further questions or comments, please let us know.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29796);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
