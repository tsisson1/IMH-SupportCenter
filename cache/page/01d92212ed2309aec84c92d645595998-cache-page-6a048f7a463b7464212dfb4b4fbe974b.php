<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:56716:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/oscommerce/testing-ecommerce-functionality/locate-db-name" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-05-16T15:37:54-07:00" />
  <meta name="keywords" content="find database oscommerce" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Use this tutorial to quickly find the exact database name for your osCommerce application." />
  <title>How to find your database name in osCommerce - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/oscommerce/testing-ecommerce-functionality/locate-db-name" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:1a4b3e21fd099303d1535ed965f716fe -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '86.11.36.125']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to find your database name in osCommerce									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>5,197</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Feb 19, 2013'><span style='color:#606060;'>Published:</span> May 16, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Working with your osCommerce site you will be able to make most changes for settings within the administrative panel. However, you may need to access the database directly, most often during troubleshooting. To do this, you will need to know the exact database name. Below are the instructions that will help you find the exact database name your osCommerce application is using.</p>
<h2>Finding your database name in your osCommerce application</h2>
<ol class="article_list">
<li>First, <a target="_blank" href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">log into your cPanel</a>.</li>
<li>This leads you to the main cPanel screen. From here, <a target="_blank" href="/support/edu/cpanel/cpanel-file-manager/using-file-manager-in-cpanel">enter the File Manager</a> section.</li>
<li>Now that you are in the File Manager, you will need to navigate through the folders your osCommerce store root folder. For example, if your store is using your main domain name the folder you want is the<em> public_html</em> folder. If you are using a subfolder for your store, such as <em>example.com/store</em> then it would be under a folder with that name (<em>public_html/store</em>)</li>
<li>Once you locate the root folder for your store, click on the <strong>includes</strong> folder.</li>
<li>Inside the includes folder you will see many files. Find and highlight the file names <em>configure.php</em> file, then click on the <strong>Edit</strong> button located in the toolbar across the top of the screen. You will be met with a popup box, click the <strong>Edit</strong> button there as well.</li>
<li>Once inside the editor, you will see a lot of code which is a list of various settings. The line of code you want is the one with the DB_DATABASE setting. At the end of the lien of code, you will find your database name. Below is an example of the correct line of code.<br />
<div class="code_block">define('DB_DATABASE', 'userna5_osco123');</div>
<br />The database name parameter is composed of two parts has two parts. Using our example, <span style="color: #ff0000;">userna5</span><span style="color: #008000;">_osco123</span> the first part coded in red, <span style="color: #ff0000;"><em>userna5</em></span> is the cpanel username, followed by the actual database name coded in green <span style="color: #008000;"><em>_osco123</em></span>.</li>
<li>Be sure to write down the database name for later use. Now you can locate the correct database when working with <a href="/support/website/cpanel/how-do-i-manage-a-mysql-database-in-phpmyadmin-in-my-control-panel-cpanel">phpMyAdmin</a> or other database management tools.</li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 5: How to find your database name in osCommerce</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 4: <a href='/support/edu/oscommerce/testing-ecommerce-functionality/how-to-upgrade-oscommerce'>How to upgrade osCommerce</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/oscommerce/testing-ecommerce-functionality/locate-db-name&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/oscommerce/testing-ecommerce-functionality/locate-db-name'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zNzQmaWQ9NTc0JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="87b491486d9133fd6b1a2a915b20da36" value="1" />	</div>
	</form>
<!-- <br />
