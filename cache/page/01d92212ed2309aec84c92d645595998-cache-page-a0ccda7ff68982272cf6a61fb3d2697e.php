<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50326:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/file-management/can-i-create-an-ftp-dropbox" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Photoed, FTP accounts have full read/write access to the folders they are assigned. Restricting either can hinder the ability to upload files. Dep..." />
  <title>Can I create an ftp dropbox | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/file-management/can-i-create-an-ftp-dropbox" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:3fbd6d7a9a8e44e0d1011b29c30152be -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Can I create an ftp dropbox</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/photoed'>photoed</a>
			<div>10 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-05-23 10:19 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>5,754</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I want to create an ftp account for my customers, but I want to keep them from getting access to each others' files. I assume that this can be accomplished with a 'dropbox' folder, that is write  access but not read access. i can't see a way to do this in the cpanel. Is there another way to do this?</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_1064' id='upvote_answer_1064' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='1064' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_1064').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_1064' id='downvote_answer_1064' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='1064' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_1064').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Photoed,<br />
<br />
FTP accounts have full read/write access to the folders they are assigned. Restricting either can hinder the ability to upload files. Depending on the number of customers you are looking at, you may assign each one their own FTP account. They have full access to their folder, but cannot see any other account folders.<br />
<br />
Here is a link on <a href="http://www.inmotionhosting.com/support/website/file-management/how-do-i-create-a-ftp-account-in-my-control-panel-cpanel" targer="_blank">creating an FTP account in your cPanel</a>. This may help you accomplish your goals. <br />
<br />
Another option to consider, if you have access to a coder, is to have them create a password protected upload page. This way your customers could upload the files and never see the folder it drops the file in. <br />
<br />
I hope this answers your question. If you have any more questions or need more information on the issue please leave a comment below and we will be happy to assist you further.<br />
<br />
Thanks!<br />
- Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_1064').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_1064' id='form_comment_on_answer_1064' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/file-management/can-i-create-an-ftp-dropbox&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/file-management/can-i-create-an-ftp-dropbox'></div>
<script type='text/javascript'>
  (function() {
