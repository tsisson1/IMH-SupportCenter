<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:77759:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/domain-names/general-information/change-domains-whois-information-amp" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-12-12T20:13:57-08:00" />
  <meta name="keywords" content="WHOIS changes AMP contact" />
  <meta name="author" content="Tim Sisson" />
  <meta name="description" content="In this article we will review how to update your domain's WHOIS information in AMP. " />
  <title>How to change domain information in AMP - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/domain-names/general-information/change-domains-whois-information-amp" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:7409c32ddd695a32d4da9a8b1d8cf49e -->
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/domain-names' itemprop='url'><span itemprop='title'>Domain Names<span></a><div class='dropdown_2columns'><div class='col_2'><div><a href='/support/domain-names/3rd-party-registrars'>3rd Party Registrars</a> (13)</div><div><a href='/support/domain-names/dns-nameserver-changes'>DNS and Nameserver Changes</a> (18)</div><div><a href='/support/domain-names/general-information'>General Information</a> (9)</div><div><a href='/support/domain-names/registrations-and-transfers'>Registrations and Transfers</a> (5)</div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/domain-names/general-information' itemprop='url'><span itemprop='title'>General Information<span></a><div class='dropdown_3columns'><div class='col_3'><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/domain-names/general-information/how-do-i-change-the-main-domain-name-on-my-account'>How do I change the main domain name on my account?</a> (72520 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/domain-names/general-information/how-to-look-up-domain-whois'>How to look up a Domains WHOIS information</a> (18244 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/domain-names/general-information/change-domains-whois-information-amp'>How to change domain information in AMP</a> (16822 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/domain-names/general-information/cancel-domain-registration'>How to Cancel your Domain Registration</a> (11392 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/domain-names/general-information/what-does-it-mean-when-a-domain-is-in-redemption'>What does it mean when a domain is in redemption?</a> (8001 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/domain-names/general-information/renewing-your-domain-with-inmotion-hosting'>Renewing your Domain with InMotion Hosting</a> (6488 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/domain-names/general-information/how-move-primary-domain-files'>How to Move files after a Primary Domain Change</a> (5472 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/domain-names/general-information/add-privacy-existing-domains'>How to Add/Cancel Domain Privacy in AMP</a> (4246 hits)</div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to change domain information in AMP</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to change domain information in AMP									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>16,822</span></div>
							...
							<div style='clear:both;'></div>
								...
								<p>You are able to manage your domains that have been registered through <a href="http://www.inmotionhosting.com">InMotion Hosting</a> in your <a href="https://secure1.inmotionhosting.com/index/login">Account Management Panel (or AMP)</a>. Any changes made in your registration details will show in the information that displays on a WHOIS lookup on your domain.</p>

<h2>Changing your domain information</h2>
<ol class="article_list">
<li><a href="/support/website/how-to/how-to-log-into-amp">Log into your AMP interface</a>.</li>

<li>In the main menu, move your mouse over <em>Domains</em> and click <strong>Manage domains</strong>.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/revamp/manage-domain.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/revamp/manage-domain.png" alt="" /></a></li>

<li>Next, select the domain that you want to change the WHOIS information for, by clicking on its name.</li>

<li>Then click on the link labeled <strong>Review or change your registration details?</strong></li>

<li>You are taken to a page that allows you to change the email address, address, and phone number of the domain. Click <strong>Edit</strong> by the section you want to change and fill in the new information.</li>

<li>Once the new information is added, click on the <strong>Submit</strong> button to save it.</li>
</ol>

<p>Changes to your account can take <em>up to 24 hours</em> before updating in a WHOIS search. Remember that any information you change for your domain must remain accurate. If you want to hide your personal information then you can purchase domain privacy for your domain. For more information on Domain Privacy, please read the knowledge base article, <a href="/support/domain-names/registrations-and-transfers/private-domain-registration">Private Domain Registration.</a></p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/domain-names/general-information/change-domains-whois-information-amp&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/domain-names/general-information/change-domains-whois-information-amp'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNyZpZD04NDkmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="4e18e10ba33c5a22a560e4b258e78879" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/domain-names/country-phone-in-organization-administrative-details?tsrc=rsbraq'>Country &amp; phone in organization &amp; administrative details</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/dns-nameserver-changes/manage-domain-area-in-cpanel?tsrc=rsbraq'>Manage domain area in cpanel</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='https://lh5.googleusercontent.com/-DIu1RiK0jMM/AAAAAAAAAAI/AAAAAAAAAPM/pVl-9isj4kM/photo.jpg?sz=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='/support/community-support/users/MEArrowsmith'>MEArrowsmith</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-15 12:29 pm</div>
				                <div>Yes, But It did not work!</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12789);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-15 12:46 pm</div>
				                <div>Hello MEArrowsmith,<br />
<br />
Thank you for contacting us. Sorry to hear it didn't work. We are happy to help, but will need some additional information. <br />
<br />
What happened when you attempted to update your Whois? Did you get an error message? What was the error message?<br />
<br />
Did you allow <em>up to 24 hours</em> for it to show-up in a WHOIS search?<br />
<br />
If you have any further questions, feel free to post them below.<br />
Thank you,<br />
<br />
-John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12791);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-15 12:52 pm</div>
				                <div>O.k., I will wait till tomorrow to try , Thanks John<br />
</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12793);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-15 12:49 pm</div>
				                <div>o.k., verified domain, still cannot remove domain privacy</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12792);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
				...
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-15 1:05 pm</div>
				                <div>Hello MEArrowsmith,<br />
<br />
Thanks for the reply.  I looked at your account, and it does appear that you removed domain privacy (you set it to expire in the Account Management Panel (AMP)).  The change to the domain - like any change to the domain settings- requires a little time to propagate.  You should see the change apply to the domain within 24 hours.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12796);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-20931'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/c3fec19993875581e568451e38b87cdd?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/c3fec19993875581e568451e38b87cdd'>jasa</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-21 8:45 pm</div>
				                <div>This is the first service that impressed for me , fast service , anda good information, and good server hosting :* is the best inmotion hosting</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20931);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-27002'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/38f0e0679dd20692e6e3d650a846468a?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/38f0e0679dd20692e6e3d650a846468a'>Camilla</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-28 1:05 am</div>
				                <div><p>I need to change my email in domain info records. So, from AMP page I went to My Account &gt; Domain Management &gt; Domain Management &gt; Edit Details and changed mail addresses in all the sections (Administrative, Billing, Technical). The day after, in my domain info records, I got changed the Admin Mail and the Tech Mail but NOT the Registrant Mail. How can I have the Registrant mail changed?</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<div id="amp-bread-crumb-content"><a href="https://secure1.inmotionhosting.com/amp">My Account</a> &gt; <a href="https://secure1.inmotionhosting.com/amp/support/search-results?searchKey=registrant%20mail">Search Results</a> &gt; <a href="https://secure1.inmotionhosting.com/index/domcntrlselect">Domain Management</a> &gt; <a href="https://secure1.inmotionhosting.com/index/domcntrl?domain=atelierantea.com">Domain Management</a><span id="amp-bread-crumb-current"> &gt; Edit Details for atelierantea.com</span></div></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27002);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-28 8:49 am</div>
				                <div>Hello Camilla,<br />
<br />
It might simply have been a delay through the Domain Registrar on the update.  When I look at your WHOIS information I see the registrant email, admin email, and tech email all being the same.  If you have any further questions or comments, please let us know.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27015);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-29380'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/00898dbb02c853183bc57a28de1c5076?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/00898dbb02c853183bc57a28de1c5076'>Megalegacy</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-12-26 7:32 pm</div>
				                <div><p>Hi! If I disable Domain Privacy, can I get it back after I cancel it? I want to change my Registrar Name and Admin Name, then re-enable domain privacy. Thanks.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29380);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-12-27 7:16 pm</div>
				                <div>Hello MegaLegacy,<br />
<br />
The short answer to your question is yes. However, to make it easier on you, you can simply contact <a href="http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support">Live Support</a> and tell them the specific fields you want to change and they can do it without having to undo privacy and then redo it again. This will also avoid any confusion if it tries to charge you again.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29394);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-32014'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/cdc2c92ea6be3509fe50024ae9630800?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/cdc2c92ea6be3509fe50024ae9630800'>Laszlo Kulcsar</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-17 5:27 pm</div>
				                <div><p>Thank you Scott! This is a clear answer. Your answer should appear instead of the official advise. Nobody want to lose the domain privacy just because one of the field needs to be updated.&nbsp;</p>
<p>I hope that "inmotion hosting" will implement a self service menu for WHOIS record updates and a domain privacy on/off switch.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32014);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-18 10:05 am</div>
				                <div>Hello Laszlo,<br />
<br />
Thank you for your suggestions. I have notified my manager of your requests.<br />
<br />
Let us know if you have any additional recommendations.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32028);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
