<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:51081:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/cpanel/search-for-string-file-manager" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Unfortunately, the search box at the top right of the cPanel File Manager is unable to search within files and only locates file or folder names. If you..." />
  <title>Searching for a text string in the cPanel File Manager | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/cpanel/search-for-string-file-manager" rel="canonical" />
...
<script>
  ...
  ga('send', 'pageview');
	...
	<!-- cid:d79c453c9e37c4f79cb6f4c30e858b09 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '50.98.232.218']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Searching for a text string in the cPanel File Manager</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2014-02-18 11:39 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>4,007</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Can you search for text strings within the files using the search in the top right screen on file manager?</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_4543' id='upvote_answer_4543' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='4543' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_4543').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_4543' id='downvote_answer_4543' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='4543' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_4543').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>11,186 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2014-02-18 12:01 pm EST
                		        </div>
					
		                </div>

				Unfortunately, the search box at the top right of the cPanel File Manager is unable to search within files and only locates file or folder names.  If you want to search through files in a directory for a string, you could do so with the following PHP script:<br />
&lt;p class=&quot;code_block&quot;&gt;<br />
&amp;lt;?php<br />
// string to search in a filename.<br />
$searchString = 'myFile';<br />
<br />
// all files in my/dir with the extension <br />
// .php <br />
$files = glob('my/dir/*.php');<br />
<br />
// array populated with files found <br />
// containing the search string.<br />
$filesFound = array();<br />
<br />
// iterate through the files and determine <br />
// if the filename contains the search string.<br />
foreach($files as $file) {<br />
    $name = pathinfo($file, PATHINFO_FILENAME);<br />
<br />
    // determines if the search string is in the filename.<br />
    if(strpos(strtolower($name), strtolower($searchString))) {<br />
         $filesFound[] = $file;<br />
    } <br />
}<br />
<br />
// output the results.<br />
print_r($filesFound);<br />
?&amp;gt;<br />
&lt;/p&gt;
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_4543').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_4543' id='form_comment_on_answer_4543' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/cpanel/search-for-string-file-manager&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/cpanel/search-for-string-file-manager'></div>
<script type='text/javascript'>
  (function() {
