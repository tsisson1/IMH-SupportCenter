<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:63741:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/drupal-7/intro-to-modules/uninstall-module" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-08-02T20:57:17-07:00" />
  <meta name="keywords" content="uninstall module Drupal 7" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Clean house by learning to uninstall modules and remove their files in Druppal 7." />
  <title>How to uninstall a module in Drupal 7  - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/drupal-7/intro-to-modules/uninstall-module" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:3bdbb0c54d09c496accdb6e46e259535 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '180.76.15.148']);
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
				<img src='/support/images/stories/drupal-partner/supporting-partner-80_3.png' style='float:right; margin:0px 0px 15px 15px;' alt='Drupal Association Support Partner'>		<h1>
															How to uninstall a module in Drupal 7 									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>20,693</span></div>
...
<li>From the top menu bar, locate the <strong>Modules</strong> option and click it.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Modules/modules.png"><img  alt="modules" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Modules/modules.png" /></a></li>
<li>Scroll down if needed to find the module you want to unsinstall. This is necessary as the module must be disabled. Here we are going to remove the <em>Lightbox2</em> module. We ensure the checkbox next to its name is unchecked<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Modules/Uninstall/disable-module.png"><img  alt="disable-module" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Modules/Uninstall/disable-module.png" /></a></li>
<li>Once it is disabled, we scroll back up to the top of the screen and click on the <strong>Uninstall</strong> tab at the upper right corner<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Modules/Uninstall/uninstall-tab.png"><img  alt="uninstall-tab" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Modules/Uninstall/uninstall-tab.png" /></a></li>
<li>This new screen lists all modules that are currently disabled. Find your module and click the checkbox next to its name. Then you can click the <strong>Uninstall</strong> button at the bottom of the screen.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Modules/Uninstall/uninstall-module.png"><img  alt="uninstall-module" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Modules/Uninstall/uninstall-module.png" /></a></li>
<li>You then will be brought to a confirmation screen. Once again, click on the <strong>Uninstall</strong> button at the bottom. This confirms and finalizes the removal of the module by removinf database tables and other files that were inserted during the initial installation.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Modules/Uninstall/confirm-uninstall.png"><img  alt="confirm-uninstall" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Modules/Uninstall/confirm-uninstall.png" /></a></li>
<li>The final screen is the disabled module list. You should have a message confirming the deletion at the top and no longer see the module in the list.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Modules/Uninstall/uninstall-after.png"><img  alt="uninstall-after" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Modules/Uninstall/uninstall-after.png" /></a></li>
<li>We are not finished yet. The modules are still listed in the modules list. To finish the removal of the installation we must delete the files physically from the folder they are stored in. You can do this via FTP, SSH (if available), or your cPanel. This tutorial will use the cPanel for demonstration. You must now <a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">log into your cPanel dashboard</a>.</li>
<li>Once in the cPanel dashboard, find and click on the File Manager tool.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/htaccess/cpanel.png"><img  alt="cpanel" src="//cdn.inmotionhosting.com/support/images/stories/edu/htaccess/cpanel.png" /></a></li>
<li>From here, select the proper root folder for your drupal installation. To do so, use the dropdown at the bottom. Once selected click the <strong>Go</strong> button at the bottom.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/htaccess/drupal-root.png"><img  alt="drupal-root" src="//cdn.inmotionhosting.com/support/images/stories/edu/htaccess/drupal-root.png" /></a></li>
<li>Once in the root folder, click through the folders to get down to the <em>'/sites/all/modules'</em> folder. You will see folders for your installed modules in the right hand panel under the <strong>Name </strong>column. <br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/htaccess/modules-folder.png"><img  alt="modules-folder" src="//cdn.inmotionhosting.com/support/images/stories/edu/htaccess/modules-folder.png" /></a></li>
<li>After you find the correct module folder, right click on it to bring up a menu. From here click on the Delete option to remove the files.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/htaccess/delete-module.png"><img  alt="delete-module" src="//cdn.inmotionhosting.com/support/images/stories/edu/htaccess/delete-module.png" /></a></li>
<li>You will then be greeted with a confirmation popup. Click on the <strong>Delete File(s)</strong> button to complete the deletion.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/htaccess/delete-module-confirm.png"><img  alt="delete-module-confirm" src="//cdn.inmotionhosting.com/support/images/stories/edu/htaccess/delete-module-confirm.png" /></a></li>
<li>Going back to your Drupal 7 admin Modules area, you should now no longer see the module you uninstalled and deleted.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/htaccess/delete-after.png"><img  alt="delete-after" src="//cdn.inmotionhosting.com/support/images/stories/edu/htaccess/delete-after.png" /></a><br /><br /></li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/drupal-7/intro-to-modules'>201: An Introduction to Drupal 7 Modules</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 5: How to uninstall a module in Drupal 7 </div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 4: <a href='/support/edu/drupal-7/intro-to-modules/updating-modules-in-drupal-7'>How to install updates for modules in Drupal 7</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/drupal-7/intro-to-modules/uninstall-module&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/drupal-7/intro-to-modules/uninstall-module'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yMDYmaWQ9MTY0NiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="0da87042c9460b8964c584493c52ffba" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/drupal-7/intro-to-modules?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> An Introduction to Drupal 7 Modules</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/drupal-7/intro-to-modules/what-are-modules?tsrc=rsbedu'>What is a Drupal 7 module?</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/drupal-7/intro-to-modules/how-to-upload-a-new-module-to-drupal?tsrc=rsbedu'>How to install a new module to Drupal 7</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/drupal-7/intro-to-modules/finding-modules-that-need-to-be-updated-in-drupal-7?tsrc=rsbedu'>Finding Modules that need to be updated in Drupal 7</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/drupal-7/intro-to-modules/updating-modules-in-drupal-7?tsrc=rsbedu'>How to install updates for modules in Drupal 7</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/drupal-7/intro-to-modules/uninstall-module?tsrc=rsbedu'>How to uninstall a module in Drupal 7 </a></td>
                </tr>
          	</table>
			...
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/joomla/phoca-gallery-does-not-show-image-file-names-in-uploading?tsrc=rsbraq'>Phoca Gallery Does not show image file names in uploading</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/5407ce90f3dbbd6ecb8e4aca00cd9ee3?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/5407ce90f3dbbd6ecb8e4aca00cd9ee3'>ashiqullah</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-29 6:14 am</div>
				                <div><p>Thank you so much. so easy method. It is helfull for me.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10276);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
