<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:101597:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-25/user-profile/copy-user-profile-plugin" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-04-15T17:01:04-07:00" />
  ...
  <title>Adding Custom User Profile Fields in Joomla 2.5 - Step 1/3 - Copy the Plugin - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-25/user-profile/copy-user-profile-plugin" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:d83e466297d07886743971e8c55c7c84 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Adding Custom User Profile Fields in Joomla 2.5 - Step 1/3 - Copy the Plugin									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>51,989</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jul 9, 2012'><span style='color:#606060;'>Published:</span> Apr 15, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<p class="alert">Joomla 2.5 has reached its end of life as for 12/31/2014. Please be advised this may be a security risk to your website. You can view more information about the end of life <a href="https://docs.joomla.org/Joomla!_CMS_versions">here</a>.</p><br /><p>The default Joomla 2.5 user profile plugin allows your site users to input more information about themselves than what is by default allowed. You can find more information here on the <a href="/support/edu/joomla-25/user-profile/view-profile">fields included by default within the Joomla 2.5 user plugin</a>.</p>
...
<li><strong>Connect</strong> to your Joomla server via <a href="/support/website/file-management/getting-started-guide-ftp" target="_blank" title="Click here for info">FTP</a>.</li>
...
en-GB.plg_user_profile.sys.ini</p></li>
...
<li>The  following steps will require that we change several references of &quot;<em>profile</em>&quot; to &quot;<em>profile10</em>&quot;, the name of our new user profile plugin. Find the following lines in the following files, and make the necessary changes.<br />
    ...
    <pre style="margin:10px 0px 10px 20px; padding:5px;">LINE 3:  &lt;name&gt;plg_user_profile10&lt;/name&gt;
LINE 14: &lt;filename plugin="profile10"&gt;profile10.php&lt;/filename&gt;
LINE 19: &lt;language tag="en-GB"&gt;en-GB.plg_user_profile10.ini&lt;/language&gt;
LINE 20: &lt;language tag="en-GB"&gt;en-GB.plg_user_profile10.sys.ini&lt;/language&gt;</pre>
  </li>
...
<li>Just like any other plugin, <a href="/support/edu/joomla-25/extensions/how-to-install-a-plugin">install the profile10.zip plugin</a>.<br />
  <br />Our next step is to <a href="/support/edu/joomla-25/user-profile/front-end-form">update the user facing user profile form</a> so that users can type in a value for the new field that you will be adding.</li>
</ol>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/joomla-25/user-profile'>217: Joomla 2.5 User Profile Plugin</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 5: Adding Custom User Profile Fields in Joomla 2.5 - Step 1/3 - Copy the Plugin</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 4: <a href='/support/edu/joomla-25/user-profile/user-profile-menu-item'>How to create a User Profile menu item in Joomla 2.5</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 6: <a href='/support/edu/joomla-25/user-profile/front-end-form'>Adding Custom User Profile Fields in Joomla 2.5 - Step 2/3 - The Front End Form</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-25/user-profile/copy-user-profile-plugin&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-25/user-profile/copy-user-profile-plugin'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yMjImaWQ9MTU1NSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="5752503f0206a6db6db021f87b1a6b79" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/joomla-25/user-profile?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Joomla 2.5 User Profile Plugin</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/joomla-25/user-profile/enable-user-profile?tsrc=rsbedu'>How to enable the Joomla 2.5 User Profile plugin</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/joomla-25/user-profile/view-profile?tsrc=rsbedu'>Viewing User Profiles in Joomla 2.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/joomla-25/user-profile/basic-options?tsrc=rsbedu'>Understanding the Joomla 2.5 User Profile Plugin's Basic Options</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/joomla-25/user-profile/user-profile-menu-item?tsrc=rsbedu'>How to create a User Profile menu item in Joomla 2.5</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/joomla-25/user-profile/copy-user-profile-plugin?tsrc=rsbedu'>Adding Custom User Profile Fields in Joomla 2.5 - Step 1/3 - Copy the Plugin</a></td>
                </tr>
          <tr >
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/joomla-25/user-profile/front-end-form?tsrc=rsbedu'>Adding Custom User Profile Fields in Joomla 2.5 - Step 2/3 - The Front End Form</a></td>
                </tr>
          <tr >
                        <td valign='top'>7.</td>
                        <td><a href='/support/edu/joomla-25/user-profile/profile-plugin-parameters?tsrc=rsbedu'>Adding Custom User Profile Fields in Joomla 2.5 - Step 3/3 - Plugin Parameters</a></td>
                </tr>
          	</table>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//graph.facebook.com/miguel.durazo/picture?type=normal' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='/support/community-support/users/daxl70'>daxl70</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-05-09 7:13 pm</div>
				                <div>It is telling me the folder plugins/user/profile is already in use, deleting it just makes a new error saying the plugin profile10 already exists</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(7842);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-05-09 7:26 pm</div>
				                <div>Hello Daxl70,<br />
<br />
Sorry you are having problems with these instructions.  Are attempting to make changes with the folder on your desktop? Make sure that after you moved all of the files, that you disconnect the FTP site first, and then make changes to folder - you may need to close down the FTP application.  Also, be sure that nothing else (application-wise) has those folders or files open.  Also, I noted that yo state that plugins/user/profile is already in use.  The instructions ask you rename the file to profile10.php.   Also, try renaming it something else - like profile11.  Try this first, please and then let us know if you continue to have problems.  <br />
<br />
If you have any further questions, please <a href="http://www.inmotionhosting.com/contact" target="new">contact technical support</a> available 24 hours a day / 7 days a week.<br />
<br />
Arnel C.<br />
InMotion Hosting<br />
Community Support Team</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(7843);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						...
						<div><a style='font-size:16px;' href='/support/community-support/users/Pete_E'>Pete_E</a></div>
						<div></div>
						<div></div>
						<div>3 <a href='/support/team/points' target='_blank'>Points</a></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-10-24 5:41 am</div>
				                <div>FYI, I had the same problem as daxl70, you need to make sure that on step 6 line 14 you rename the plugin to the name of your new version i.e. plugin=&quot;plugin10&quot;  and not just rename profile.php to profile10.php</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8315);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-8422'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//graph.facebook.com/lianna.ryan/picture?type=normal' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='/support/community-support/users/lianna'>lianna</a></div>
						<div></div>
						<div></div>
						<div>3 <a href='/support/team/points' target='_blank'>Points</a></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-11-26 3:18 pm</div>
				                <div>Does this work with Joomla 3</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8422);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-11-26 6:12 pm</div>
				                <div>&lt;div style=&quot;background-color: #FFF; padding-left: 10px;&quot;&gt;Hello lianna,<br />
<br />
This user profile plugin should be compatible with &lt;strong&gt;Joomla 3.0&lt;/strong&gt; as &lt;a href=&quot;http://docs.joomla.org/Will_my_Joomla!_2.5_extensions_work_with_Joomla!_3.x%3F&quot; target=&quot;_blank&quot;&gt;native Joomla 2.5 extensions should work with Joomla 3.0&lt;/a&gt;.<br />
<br />
If you're having any issues at all getting it working, please let us know!<br />
<br />
- Jacob&lt;/div&gt;</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8423);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-8526'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//graph.facebook.com/orlando.browne.9/picture?type=normal' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='/support/community-support/users/obrowne'>obrowne</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-01-14 10:29 pm</div>
				                <div>Hi. <br />
I have followed all steps in this tutorial, and was:<br />
1.  able to put some custom registration fields in place.<br />
2.  able to set the fields otions (required / optional / etc) in Admin backend<br />
So far so good........<br />
3.  I have also enabled the field  TOS ( Terms of Services ).... now her is my problem...<br />
The field TOS is being displayed as a TEXT input field.   (????????)<br />
I would expect it to show a checkbox instead.... does anyone have a clue as to what is going wrong here?<br />
Thanks for your help.<br />
<br />
cheers . . . . . .<br />
Orlando<br />
<br />
Ps. sorry for the double post.. Could not find where to edit the first post.<br />
I forgot to mention my platform:<br />
1) Developiin on WAMP<br />
2) Using Joomla 3.2.1<br />
3) With Artisteer generated template</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8526);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-01-15 10:59 am</div>
				                <div>You would need to define a checkbox a bit differently than you would a form field.  The following Joomla documentation should help you out with this:<br />
<br />
&lt;a href=&quot;http://docs.joomla.org/Checkbox_form_field_type&quot;&gt;Checkbox form field type&lt;/a&gt;</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8527);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-01-15 3:52 pm</div>
				                <div>QUOTE: &quot; You would need to define a checkbox a bit differently than you would a form field. The following Joomla documentation should help you out with this:  Checkbox form field type&quot;<br />
---------------------------------------------------------------------------------------------------------------------------<br />
Thanks for your reply JeffMA....<br />
Could you explain me the following?....<br />
1)  When I use the standard TOS that is present in the standard Joomla 3.2.1. user profile, it is displayed as :<br />
two radiobuttons with label including a &quot;terms of Service hyperlink that leads to the terms of service article. That works for me except for the fact that I need extra custom fields.<br />
2) Why is it that the radio buttons an hyperlink of the standard TOS are lost / changed  when duplicating the plugin to be able to provide extra fields ? How can I fix this?<br />
<br />
Thanks,<br />
Orlando</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8530);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-01-15 5:25 pm</div>
				                <div>Hi All....<br />
Never mind the last question... <br />
( I gave banging my head against the wall a rest and came back with a fresh pair of eyes... an found the issue)<br />
<br />
it so happens that when you install the plugin after zipping it, the installation omits adding the &quot;fields&quot; folder in the newly made &quot;profile10&quot; (even though you have copied it in the first step of the tutorial)<br />
I noticed this when comparing the contents of the profile10 folder with the original profile folder.<br />
My sollution was to copy the &quot;fields&quot; folder out of the original profile folder to the new profile10 folder.<br />
<br />
After doing that, the TOS two radio buttons and Terms of Service hyperlink appear.<br />
</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8531);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-23592'></a>
		<div  style='margin:2px 0px 0px 40px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/7589334229e3635997c31442c7fb4bc8?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/7589334229e3635997c31442c7fb4bc8'>Giovanni</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-05-21 11:30 am</div>
				                <div><p>THANKS&nbsp;<a style="color: #4ba0e1; text-decoration: none; font-family: adelle-sans, Helvetica, Arial, sans-serif; line-height: 22px; font-size: 16px; background-color: #f9f9f9;" href="/support/../../../community-support/users/obrowne">obrowne</a>&nbsp;;)</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23592);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-01-15 6:04 pm</div>
				                <div>&lt;div style=&quot;background-color: #FFF; padding-left: 10px;&quot;&gt;Hello Orlando,<br />
<br />
Thanks for posting back on this article and letting us know your solution. It's strange that a particular folder like &lt;strong&gt;fields&lt;/strong&gt; would be left out.<br />
<br />
Did you happen to notice this folder inside your &lt;strong&gt;profile10.zip&lt;/strong&gt; file? It almost sounds like when you zipped up the &lt;strong&gt;/profile10&lt;/strong&gt; directory that your zip application was not setup to also include sub-folders.<br />
<br />
- Jacob&lt;/div&gt;</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8532);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-01-15 7:12 pm</div>
				                <div>Hi Jacob,<br />
<br />
I went back and double checked the zip file oddly enough, the &quot;fields&quot; folder IS included in the zip.<br />
So i have to conclude that upon installation of the plug-in it is somehow being ommitted (maybe Joomla 3.2.1. bug? )</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8533);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-10631'></a>
		<div  style='margin:2px 0px 0px 40px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/5c405bbceafa5d21a456334af98868c3?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/5c405bbceafa5d21a456334af98868c3'>Alessandra</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-14 10:27 am</div>
				                <div><p>It is not a bugYou should edit the profile10.xml file. At line 16 you should find this&lt;folder&gt;profiles&lt;/folder&gt;at line 17 add the following&lt;folder&gt;fields&lt;/folder&gt;In this way Joomla will know that the plugin also needs the fields folder</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10631);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-01-16 10:00 am</div>
				                <div>It does indeed appear that if it was missing after installation, but is included in the zip file, that Joomla omitted it from being installed.  I recommend bringing this up at the &lt;a href=&quot;http://forum.joomla.org/&quot;&gt;Joomla forums&lt;/a&gt; as there may be a reason (or a bug) for this.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8534);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-8562'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//graph.facebook.com/henrik.wolframm/picture?type=normal' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='/support/community-support/users/DerLange'>DerLange</a></div>
						<div></div>
						<div></div>
						<div>3 <a href='/support/team/points' target='_blank'>Points</a></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-02-02 11:28 am</div>
				                <div>hi,<br />
i followed all the steps, but when i try to install the plugin i get this warnig: <br />
JInstaller: :Install: Cannot find Joomla XML setup file</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8562);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-02-03 9:08 am</div>
				                <div>Hello DerLange,<br />
<br />
If you are getting this error, this means that your XML file does not exist within your newly created zip file.  Ensure that you have included the profile10.xml file within your zip.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8565);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-17008'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/2f47e3d9012514fa62cf1112871bc78e?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/2f47e3d9012514fa62cf1112871bc78e'>justine</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-03 2:19 am</div>
				                <div><p>Hello. I having a trouble uploading my new plugin. I followed the instructions above change it into profile10 still has an error stating, "<span style="color: #c09853; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 13px; line-height: 18px; background-color: #fcf8e3;">Plugin Install: Another plugin is already using directory: /hsphere/local/home/a897837/filestatecorp.com/mrtshops/plugins/user/contactcreator</span>". Any ideas how to solve this? I will really appreciate your help.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17008);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
				...
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-03 11:56 am</div>
				                <div>Hello justine,<br />
<br />
Thank you for your question. I found a similar issue with a different plugin in the official <a href="http://forum.joomla.org/viewtopic.php?f=162&t=530783" >Joomla Support Forum</a>, where they are offering several solutions.<br />
<br />
If you have any further questions, feel free to post them below.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17038);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						...
						<div><a style='font-size:16px;' href='/support/community-support/users/kraadde'>kraadde</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-02-14 8:53 am</div>
				                <div>I double checked steps 1 to 9 of your instruction and everything was OK. However I was not able to install the new profile 10 plugin in my J 3.4.8 version. I was getting following messages: <br />
JFolder: :delete: ......<br />
Path: /home/xxxxxxx/plugins/user/profile/profiles<br />
JInstaller: :Install: File „/home/xxxxxx/logs/install_56c06fd187511/profiles10“ does not exist.<br />
<br />
What could the problem be?<br />
BTW. Line 6 of your tutorial 1/3 is a bit unclear to me: Has the file profile.xml to be renamed to profile10.xml itself or only the code inside the file?<br />
<br />
Thanks for your help.<br />
<br />
</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30546);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
