<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:56879:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/wordpress/wp-fixing-500-internal-server-error" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-05-11T17:45:59-07:00" />
  <meta name="author" content="Arnel Custodio" />
  <meta name="description" content="WordPress version 4.1.1 users may see 500 internal server errors due to the PHP version used by WordPress.  This issue is also often caused by file/folder permission issues.  This article provides an easy to understand guide to fixing the 500 internal server error." />
  <title>347: Fixing the 500 Internal Server Error with WordPress - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/wordpress/wp-fixing-500-internal-server-error" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<script type="text/javascript">
		...
		_gaq.push(['_setCustomVar', 4, 'DateMonthPublished', '2015-04', 3]);
	...
	<!-- cid:536a0cf87d3bbdc0e19838a856fb2947 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-20']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '188.167.55.208']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															347: Fixing the 500 Internal Server Error with WordPress									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>11,448</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Apr 8, 2015'><span style='color:#606060;'>Published:</span> May 11, 2015</div>
							...
							<div style='clear:both;'></div>
								...
								<p>The latest version of WordPress requires that the PHP version be set to version 5.4 or higher. By default, new InMotion Hosting accounts are set to version PHP version 5.4.  However, in some cases, this version may have been changed.  For more information, please see <a href="http://www.inmotionhosting.com/support/website/php/how-to-change-the-php-version-your-account-uses">how to change the PHP version in cPanel</a>.  The 500 error can also occur when file permissions are incorrectly set for the WordPress installation files.  The following tutorial walks you through correcting the error when the PHP version is set to the wrong version. If you are having problems with this error, then you may see the following error message on your screen:</p>

<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/500-wp-error/internal-server-error.jpg"><img style="left; margin: 0px 0px 0px 0px;"  alt="500 Internal Serverr error" src="//cdn.inmotionhosting.com/support/images/stories/500-wp-error/internal-server-error.jpg" align="left" /></a>
<br />
<div style="clear:both;"></div>
...
<li><a href="http://www.inmotionhosting.com/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">Login to cPanel</a> </li>

<li>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/500-wp-error/software-services.jpg"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Software services" src="//cdn.inmotionhosting.com/support/images/stories/500-wp-error/software-services.jpg" align="right" /></a>

<p>If you have just finished <a href="http://www.inmotionhosting.com/support/edu/wordpress/wordpress-introduction/install-wordpress-using-softaculous">installing WordPress with Softaculous</a>, and after logging into the WordPress Admin you're getting an Internal Server error, your first step will be to look for the version of PHP that you have loaded on your account.  Look for <b>Software and Services</b>, then click on <b>PHP Configuration</b></p>
<div style="clear:both;"></div>
</li>

<li>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/500-wp-error/php-version-options.jpg"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="PHP version options" src="//cdn.inmotionhosting.com/support/images/stories/500-wp-error/php-version-options.jpg" align="right" /></a>

<p>You will then see the version of PHP that is currently set in cPanel for your account.  Click on the drop-down arrow to choose version 5.4 or higher. Click on the <b>Update</b> button to change the version</p>
<div style="clear:both;"></div>
</li>

<li>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/500-wp-error/changed-php-version.jpg"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Confirmation of version change" src="//cdn.inmotionhosting.com/support/images/stories/500-wp-error/changed-php-version.jpg" align="right" /></a>
<p>Once the version has been updated, you will see a confirmation message indicating the version that you have selected.  You should now be able to go back to your WordPress URL and verify that the error has been resolved.</p>
<div style="clear:both;"></div>
</li>

</ol>

<p>If you find that the error continues, first make sure that your <a href="http://www.inmotionhosting.com/support/website/how-to/clear-browser-cache">browser cache</a> has been cleared. Then, if the error persists, <a href="http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support">contact our live technical support team</a> via phone/chat/email in order to have the issue reviewed.  File permissions errors is typically another common cause of the 500 internal server error and can be quickly fixed by our support team.
</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 5: 347: Fixing the 500 Internal Server Error with WordPress</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 4: <a href='/support/edu/wordpress/change-wp-admin-pass-in-softaculous'>Changing your WordPress Admin password via Softaculous</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 6: <a href='/support/edu/wordpress/automatic-update-email'>I received a "Your site has updated to WordPress 3.x.x" email</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/wordpress/wp-fixing-500-internal-server-error&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/wordpress/wp-fixing-500-internal-server-error'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD03MSZpZD0zNTQ0JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/website-troubleshooting/random-error-500-internal-server-error?tsrc=rsbraq'>Random error 500 - Internal Server Error</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/wordpress/error-message-when-accessing-website-after-wordpress-install?tsrc=rsbraq'>Error message when accessing website after wordpress install</a>
                                </div>
