<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49616:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/website-transfers/browser-does-not-execute-php-files" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Thank you for your question IanHinton! The following code in the .htaccess is the cause of this problem. AddHandler application/x-httpd-php5s .php I com..." />
  <title>Browser does not execute PHP files | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/website-transfers/browser-does-not-execute-php-files" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:6d3af6e185a5322cc8960a4b84bd4cf1 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Browser does not execute PHP files</h1>
		<div style='margin-bottom:20px; margin-top:10px; clear:both; color:#6e6e6e;'>Category: <a href='/support/community-support/website-transfers'>Website Transfers</a></div>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/IanHinton'>IanHinton</a>
			<div>17 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-11-01 10:25 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>2,038</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I'm migrating from my old host to InMotion, and keeping my old stuff active until I get everything running on IM.<br />
I've encountered a problem. My browser executes HTML files, but not PHP files. It wants to download them. I've found the same problem in my Joomla website and also a phpBB forum. So it doesn't seem to be related to any specific software - just PHP files in general.<br />
The website and the forum are in different domains.<br />
Any clues please?</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_1819' id='upvote_answer_1819' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='1819' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_1819').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_1819' id='downvote_answer_1819' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='1819' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_1819').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>5,889 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2012-11-01 4:33 pm EST
                		        </div>
					
		                </div>

				Thank you for your question  IanHinton!<br />
<br />
The following code in the .htaccess is the cause of this problem. <br />
<br />
AddHandler application/x-httpd-php5s .php<br />
<br />
I commented it with a #. You should see them load now.<br />
<br />
Best regards<br />
<br />
James R
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_1819').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_1819' id='form_comment_on_answer_1819' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/website-transfers/browser-does-not-execute-php-files&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/website-transfers/browser-does-not-execute-php-files'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="f9afdad919daf4122e252d4b4c832309" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
                                ...
                                <h3>Related Articles</h3><a target='_blank' href='http://inmotionhosting.com/support/update-configuration-file-with-database-settings'>Update configuration file with your new database settings</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/what-you-need-to-know-about-your-email-when-transferring-your-website'>What you need to know about your email when transferring your website</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/restore-copy-of-database'>Restore a copy of your database</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/create-a-blank-database'>Create a blank database</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/download-database-previous-host'>Download a copy of your database</a><br/><br />
		</div>
