<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:51128:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-3/joomla-blog" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="keywords" content="joomla 3.0 blog" />
  <meta name="description" content="If you are using Joomla 3.0 to build an online blog, this set of tutorials will help you get started." />
  <title>107: How to Blog using Joomla 3 | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-3/joomla-blog" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:465c45ace4b77a232a9b97294081ed74 -->
...
<div class='page-header'>
	<h1>107: How to Blog using Joomla 3</h1>
</div>
<div class='section_listing'>
	<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/getting-started/sample-data-blog.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="sample-data-blog" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/getting-started/sample-data-blog.gif" /></a>When you initially <a href="/support/edu/joomla-3/getting-started/install-joomla-3">install Joomla 3.0</a>, installing the <em>Blog English Sample Data</em> will setup your Joomla 3.0 in a blog format right from the start (see the screenshot to the right). In this set of tutorials, we will help answer many of the basic questions for users getting started using Joomla 3.0 to blog. Click here to learn more about <a href="http://www.inmotionhosting.com/joomla-hosting">Joomla Hosting</a>.</p>
<div style="clear: both;"></div>
	<table>
	<tr><td colspan='3'><h2>Working with Blog Posts</h2></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 1:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-3/joomla-blog/write-blog-post'>How to write a blog post in Joomla 3.1</a>
					<div>In this tutorial, we'll show you how to publish a blog post in Joomla 3.0</div>
					<div class='smallgrey'>Hits: 12,761</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-3/joomla-blog/read-more'>How to add a Read more button in Joomla 3.1</a>
					<div>If you write very long blog posts, you'll want to learn how to add a read more button. This will help prevent your frontpage from being a mile long, and makes it easier for users to navigate your site.</div>
					<div class='smallgrey'>Hits: 25,259</div>
				</td>
			</tr>
		<tr><td colspan='3' style='padding-top:20px;'><h2>Working with the Header / Banner Images</h2></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 3:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-3/joomla-blog/new-banner-image'>How to change the banner image in Joomla 3.1</a>
					<div>You'll notice that there is a banner image in your Joomla 3.0 template by default. In this tutorial we'll show you how to change this header image.</div>
					<div class='smallgrey'>Hits: 61,972</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-3/joomla-blog/hide-header-image'>How to hide the banner image in Joomla 3.1</a>
					<div>If you don't want to show the banner image at all in Joomla 3.0, you can disable the Image module.</div>
					<div class='smallgrey'>Hits: 10,600</div>
				</td>
			</tr>
		<tr><td colspan='3' style='padding-top:20px;'><h2>Frontpage Settings</h2><div>Learn more about various settings available to help configure your Joomla 3.0 homepage.</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 5:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-3/joomla-blog/number-of-articles-on-homepage'>Change the number of articles on your Joomla 3.1 frontpage</a>
					<div>In this Joomla 3.0 tutorial, we'll show you how to change the number of articles on your homepage using the # Leading Articles setting.</div>
					<div class='smallgrey'>Hits: 10,245</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-3/joomla-blog/frontpage-columns'>Showing Articles in Columns on the Joomla 3.1 frontpage</a>
					<div>In this Joomla 3.0 tutorial, we'll show you how to show articles in columns on your frontpage.</div>
					<div class='smallgrey'>Hits: 24,730</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-3/joomla-blog/number-of-links'>Changing the number of links on the Joomla 3.1 frontpage</a>
					<div>Ever notice those links on your Joomla 3.0 homepage? In this tutorial, we'll show you why they're there and what setting controls them.</div>
					<div class='smallgrey'>Hits: 2,395</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-3/joomla-blog/frontpage-article-order'>Joomla 3.1 frontpage article order</a>
					<div>In this Joomla 3.0 tutorial, we'll review the various options that are available for ordering articles on your frontpage.</div>
					<div class='smallgrey'>Hits: 20,043</div>
				</td>
			</tr>
		<tr><td colspan='3' style='padding-top:20px;'><h2>Sidebar Modules and Widgets</h2><div>When you use Joomla to blog, you'll see familiar sidebar widgets such as Older Posts and Blog Roll. These tutorials will help you manage these modules.</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 9:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-3/joomla-blog/older-posts'>Configuring Older Posts in Joomla 3.1</a>
					<div>In this tutorial we'll show you how to work with the older posts module in your Joomla 3.0 blog.</div>
					<div class='smallgrey'>Hits: 2,382</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-3/joomla-blog/blog-roll'>Working with the BlogRoll module in Joomla 3.1</a>
					<div>In this tutorial we'll show you how to manage your blogroll module in Joomla 3.0.</div>
					<div class='smallgrey'>Hits: 4,769</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-3/joomla-blog/most-read-posts'>Working with the Most Read Posts module in Joomla 3.1</a>
					<div>The most read posts module in Joomla 3.0 shows your readers your most popular articles (based upon views). In this tutorial, we'll show you how to manage this widget.</div>
					<div class='smallgrey'>Hits: 3,687</div>
				</td>
			</tr>
			</table>
</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNjkmaWQ9MjY5JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
