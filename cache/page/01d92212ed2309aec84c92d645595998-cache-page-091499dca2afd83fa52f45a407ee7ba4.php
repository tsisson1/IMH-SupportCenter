...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/general-server-setup/uid-smaller-than-min-uid" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-02-17T19:44:56-08:00" />
  <meta name="keywords" content="error php file edit cpanel shell root fix min_uid uid smaller" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="If you run across an error such as &quot;SoftException in Application.cpp:357: UID of script &quot;/home/mysite/public_html/index.php&quot; is smaller than min_uid&quot; and are not sure what causes it, find out what it is and how to fix it with this quick guide." />
  <title>SoftException UID is smaller than min_uid - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/general-server-setup/uid-smaller-than-min-uid" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:d14622ec074419017f2a4dc1c3daa6ef -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '80.180.36.169']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>SoftException UID is smaller than min_uid</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															SoftException UID is smaller than min_uid									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>23,169</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: May 10, 2013'><span style='color:#606060;'>Published:</span> Feb 17, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>When working with <a href="/support/website/ssh/what-is-shell-access">SSH (shell)</a> there are various things you can do, among the simplest is creating and editing files that are in use on your hosting account. There can be times when you run across issues in the WHM or cPanel GUI after working within the shell.</p>
...
<div class="cli">SoftException in Application.cpp:357: UID of script "/home/mysite/public_html/index.php" is smaller than min_uid
Premature end of script headers: index.php</div>
...
<div class="cli" style="font-family: courier">
drwxr-x---  &nbsp;4 &nbsp;user123 nobody&nbsp; 4.0K May 10 14:19 ./<br />
drwx--x--x 11 &nbsp;user123 user123 4.0K May 10 14:19 ../<br />
drwxr-xr-x  &nbsp;2 &nbsp;user123 user123 4.0K May 10 14:04 cgi-bin/<br />
-rw-r--r--  &nbsp;1 &nbsp;user123 user123    &nbsp;&nbsp;&nbsp;0 May 10 14:05 .htaccess<br />
-rw-r--r--  &nbsp;1 &nbsp;root&nbsp;&nbsp;&nbsp;    root    &nbsp;&nbsp;&nbsp;3.0K Aug 27  &nbsp;2009 index.php<br />
-rw-r--r--  &nbsp;1 &nbsp;user123 user123  &nbsp;39K May 10 14:05 php.ini<br />
</div>
...
<div class="cli">chown user123:user123 index.php</div>
<p>After running the command, you can check the ownership of the files by running ls -lah command for the resident folder of the files. It should appear as below:
<div class="cli" style="font-family: courier">
drwxr-x--- &nbsp;4 user123 nobody &nbsp;4.0K May 10 14:19 ./<br />
drwx--x--x 11 user123 user123 4.0K May 10 14:19 ../<br />
drwxr-xr-x &nbsp;2 user123 user123 4.0K May 10 14:04 cgi-bin/<br />
-rw-r--r--  &nbsp;1 user123 user123    &nbsp;&nbsp;&nbsp;0 May 10 14:05 .htaccess<br />
-rw-r--r-- &nbsp;1 user123 user123 3.0K Aug 27 &nbsp;2009 index.php<br />
-rw-r--r--  &nbsp;1 user123 user123  &nbsp;39K May 10 14:05 php.ini<br />
</div>
</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/general-server-setup/uid-smaller-than-min-uid&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/general-server-setup/uid-smaller-than-min-uid'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NCZpZD0yNzA0JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="f318797cd2641515977b8ca1f2eaab03" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/beb4a6f6fb077e83d34715cf33bbfcdb?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/beb4a6f6fb077e83d34715cf33bbfcdb'>Andreza</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-07 12:55 pm</div>
				                <div><p>From where should I have to rum this command:&nbsp;<span style="background-color: #000000; color: #ffffff; font-family: adelle-sans, Helvetica, Arial, sans-serif; font-size: 13px; line-height: 22px;">chown user123:user123 index.php</span></p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9471);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-07 1:20 pm</div>
				                <div>Hello Andreza,<br />
<br />
You will run that command from whichever program you are using for shell access. The safest place would be from within the directory where the file is located.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9472);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-07 2:01 pm</div>
				                <div><p>Hi,</p>
<p>&nbsp;</p>
<p>I do not know where the file index.php is located. I'm using Filezila. Is it in the public_html? The error here is:</p>
<h1 style="font-family: 'Times New Roman';">Internal Server Error</h1>
<p style="font-family: 'Times New Roman'; font-size: medium;">UID of script "/home/httpd/html/index.php" is smaller than min_uid</p>
suPHP 0.6.3&nbsp;&nbsp;</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9476);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-07 2:43 pm</div>
				                <div>Hello Andreza,<br />
<br />
The path to the file is within the error message itself. The file should be located at "/home/httpd/html"<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9477);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-07 5:19 pm</div>
				                <div><p>Sorry my dummy questions. The cpanel username is the same as the FTP username?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9493);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-07 5:23 pm</div>
				                <div>Hello Andreza,<br />
<br />
Yes the cPanel user name will typically be the same as the main FTP user name for an account, if you are in fact using cPanel.<br />
<br />
What URL are you trying to access that it is trying to pull files from &lt;span style=&quot;color: red;&quot;&gt;/home/httpd/html&lt;/span&gt;?<br />
<br />
On our servers for instance, if your cPanel user name was &lt;span style=&quot;color: red;&quot;&gt;userna5&lt;/span&gt; the server would attempt to serve your files from &lt;span style=&quot;color: red;&quot;&gt;/home/userna5/public_html&lt;/span&gt;<br />
<br />
- Jacob</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9495);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-07 5:36 pm</div>
				                <div><p>Hi Jacob,</p>
<p>I'm not using cpanel. I'm using a control painel, but it is not cpanel.</p>
<p>The url I'm trying to acess is: </p>
<p>I dont understand why the index.php (mentioned in the error) is in the path&nbsp;<span style="color: #ff0000; font-family: adelle-sans, Helvetica, Arial, sans-serif; font-size: 13px; line-height: 22px;">/home/httpd/html</span></p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9499);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-07 6:16 pm</div>
				                <div>Hello Andreza,<br />
<br />
It seems that the server you're running your website on has the &lt;span style=&quot;color: red;&quot;&gt;DocumentRoot&lt;/span&gt; for your site set to the &lt;span style=&quot;color: red;&quot;&gt;/home/httpd/html&lt;/span&gt; directory.<br />
<br />
As such, any file you try to access on your domain is going to attempt to be pulled from that directory.<br />
<br />
If you have access to the server your website resides on, can you pull up a directory listing of that folder? It should look something similar to our example above of:<br />
<br />
&lt;pre class=&quot;cli&quot; style=&quot;white-space: nowrap; margin: -20px 0px -30px 0px;&quot;&gt;<br />
drwxr-x---  4  user123 nobody  4.0K May 10 14:19 ./<br />
drwx--x--x 11  user123 user123 4.0K May 10 14:19 ../<br />
drwxr-xr-x  2  user123 user123 4.0K May 10 14:04 cgi-bin/<br />
-rw-r--r--  1  user123 user123    0 May 10 14:05 .htaccess<br />
&lt;span style=&quot;color: red;&quot;&gt;-rw-r--r--  1  root    root    3.0K Aug 27  2009 index.php&lt;/span&gt;<br />
-rw-r--r--  1  user123 user123  39K May 10 14:05 php.ini<br />
&lt;/pre&gt;<br />
<br />
In this case you can see that I've &lt;span style=&quot;color: red;&quot;&gt;highlighted&lt;/span&gt; the &lt;span style=&quot;color: red;&quot;&gt;index.php&lt;/span&gt; file, and you can see that it's owned by the user and group &lt;span style=&quot;color: red;&quot;&gt;root&lt;/span&gt;.<br />
<br />
So if I tried to access the &lt;span style=&quot;color: red;&quot;&gt;index.php&lt;/span&gt; script as is, I'd get the same error as you. Instead if you were to run this if your website user was &lt;span style=&quot;color: red;&quot;&gt;user123&lt;/span&gt;:<br />
<br />
&lt;pre class=&quot;cli&quot; style=&quot;white-space: nowrap; margin: -20px 0px -30px 0px;&quot;&gt;chown user123.user123 /home/httpd/html/index.php&lt;/pre&gt;<br />
<br />
Then you should notice that the file listing for that file changes to:<br />
<br />
&lt;pre class=&quot;cli&quot; style=&quot;white-space: nowrap; margin: -20px 0px -30px 0px;&quot;&gt;-rw-r--r--  1  user123    user123    3.0K Aug 27  2009 index.php&lt;/pre&gt;<br />
<br />
You should then be able to access that script directly from your website without an issue. If you don't have access to the server or from your control panel to change the owner of files, then you would need to contact your web host to do this for you.<br />
<br />
- Jacob</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9500);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-07 7:15 pm</div>
				                <div><p>Is there other solution for this error? I contacted my hosting and this operation (<span style="background-color: #000000; color: #ffffff; font-family: adelle-sans, Helvetica, Arial, sans-serif; font-size: 13px; line-height: 22px;">chown user123.user123 /home/httpd/html/index.php</span>) is not allowed because I have a share hosting.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9504);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-07 7:59 pm</div>
				                <div>Hello Andreza,<br />
<br />
This article requires that you have access to SSH and be able to make a change to the file.  If you are unable to make that change, then you will need to speak with your host's support staff and find out if it's possible for them to make the change for you.  If they can't, then you will need to ask them about your error and whether it's something they can resolve for you. <br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9506);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-30429'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/24a7f6d1ed680a56497cab6da14e931b?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/24a7f6d1ed680a56497cab6da14e931b'>gelo</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-02-09 7:21 am</div>
				                <div><p>This and some other articles save me a lot of time. Your&nbsp;Knowledge Base is great for VPS newbies.&nbsp;Thanks!!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30429);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
