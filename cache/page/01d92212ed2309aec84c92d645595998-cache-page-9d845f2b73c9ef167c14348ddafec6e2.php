<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:140798:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/databases/setting-up-a-remote-mysql-connection-in-cpanel" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-10-28T14:04:43-07:00" />
  <meta name="keywords" content="remote MySQL connect database" />
  <meta name="author" content="Tim Sisson" />
  <meta name="description" content=" In this tutorial, we'll show you how to setup a remote mysql connection within your cPanel so you can connect and work with your databases remotely." />
  <title>Setting up a Remote MySQL connection in cPanel - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/databases/setting-up-a-remote-mysql-connection-in-cpanel" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<script type="text/javascript">
		...
		_gaq.push(['_setCustomVar', 3, 'DateMonthModified', '2013-10', 3]);
	...
	<!-- cid:d77fd5cbfc5ecb8afd846abf202258d5 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '99.72.162.158']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Setting up a Remote MySQL connection in cPanel</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Setting up a Remote MySQL connection in cPanel									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>80,262</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Dec 14, 2011'><span style='color:#606060;'>Published:</span> Oct 28, 2013</div>
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Comments:</span> <a href='#comments'>39</a></div>
  ...
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('program');">What program to use</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('add-ip');">Add an IP</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('wildcard');">Use Wildcard</button>
  <button type="button" class="btn btn-danger" onclick="trackAnchorClickSC('troubleshoot');">Troubleshooting</button>
</div>

<p>If you need to connect to your database using third party software that does not run on the server, such as a MySQL client on your desktop a remote MySQL connection can be made. First you will have to allow the connection from within cPanel for the IP address you are connecting from.&nbsp;</p>

<a name="program"></a><h2>What program do I use to connect Remotely?</h2>
<p>There are a few programs you can use to connect remotely to your database. HTML editors like DreamWeaver can connect to your databases remotely as well. There are Free Open Source programs you can use like MySQL Workbench or or Heidi SQL. Below are some links to programs you can use to connect to your databases remotely.</p>

<ul>
  <li><a target="_blank" href="/support/website/databases/connect-database-navicat">Navicat for MySQL 10</a></li>
  <li><a target="_blank" href="/support/website/databases/connect-database-remotely-mysql-workbench">MySQL Workbench 5.2</a></li>
  <li><a target="_blank" href="/support/website/databases/connecting-heidi-sql-database">Heidi SQL</a></li>
</ul>

<a name="add-ip"></a><h2>Adding an IP address to allow a remote MySQL connection</h2>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/db_1.jpg"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="db_1" src="//cdn.inmotionhosting.com/support/images/stories/db_1.jpg" width="100" /></a>First, you will need to make sure you have the IP address that will be accessing the database. These rules protect the database by only accepting external connections that you have set up. If you are connecting to a database from your current connection, you can obtain your current IP address by visiting this link:<a href="/support/ipcheck.php" target="_blank"> current IP address</a>. Once you have the IP address that you wish to connect remotely, <a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">log into cPanel</a> and click on "<em>Remote MySQL</em>" under the Databases Heading.<br style="clear: both;" /></p>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/db_2.jpg"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="db_2" src="//cdn.inmotionhosting.com/support/images/stories/db_2.jpg" width="100" /></a>Next, you'll need to add the IP address into the field on the page and select "<em>Add Host</em>".<br style="clear: both;" /></p>
...
<a name="wildcard"></a><h2>Using a Wildcard to allow all IP's</h2>
...
<p>If you want to list all IP addresses in the range 174.77.92.1 to 174.77.92.255 you'd add the IP address 174.77.92.%.</p>


<a name="troubleshoot"></a><h2>Troubleshooting Remote connection issues</h2>
<p>If you are using your preferred remote connection tool and suddenly it will not connect. This error is known as a <em>1045</em> and usually reads similar to '<strong>1045 - access denied for user</strong>'. If you are getting this error, there are a couple of things listed below that you may want to check.


<h3>Check your cPanel password</h3>
  <p>Many people connect remotely using their <a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">cPanel username and password</a> as opposed to <a href="/support/website/databases/create-db-user">creating a single administrative user</a> to add to the databases. This is not the preferred method, however if you do use the cPanel username and you are now getting a connection error, chances are you recently changed the <a href="/support/edu/cpanel/getting-started-cpanel/change-password">cPanel password</a> and have not changed it in the Remote connection software settings. Change the password there and you should be able to connect once again.</p>

<h3>Check to see if connecting IP has changed</h3>
  <p>Not all of us are blessed with static IP addresses. From time to time your ISP (Internet Service Provider) may change your public IP address. If that is the case, you may find yourself unable to connect remotely via your <a href="#program">preferred software</a>. First, check your IP address by going to Google.com and searching for the term IP. You can also find your current IP address by clicking <a href="http://support.inmotionhosting.com/ipcheck.php">here</a>.</p>
<p>Once you know your current IP address, go back and make sure that it is in the list of allowed IP addresses for your <em>Remote MySQL</em> settings. If you find it was not in the list and add the new one, you should then be able to connect remotely.</p>

</p>   
<p>If you need further assistance with connecting to a database remotely please <a href="/support/website/website-troubleshooting/how-to-get-great-technical-support">contact our support department</a>.&nbsp;</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/databases/setting-up-a-remote-mysql-connection-in-cpanel&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/databases/setting-up-a-remote-mysql-connection-in-cpanel'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMyZpZD0zNDEmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="0e2e79c56bc96cbe42d55101f4a7022c" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/databases/connection-with-mysql-database?tsrc=rsbraq'>connection with mysql database</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						...
						<div><a style='font-size:16px;' href='/support/community-support/users/airquality'>airquality</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2012-11-12 6:40 pm</div>
				                <div>You should mention how we find out HOW to access our MySQL databases from the remote location? What address do we use from the remote location to access the MySQL database?</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(7183);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2012-11-12 7:18 pm</div>
				                <div>Hello Airquality,<br />
<br />
Apologies, but this is a general article about making a remote connection to a database. Access to the database is generally based on the URL used to get to the server, and the user name and password assigned to the database you're trying to access. You will need to provide your IP address in order to allow the access through the firewall. This access is ONLY for database access (which occurs by default through a specific port). All of this is determined the Remote MySQL setup.<br />
<br />
If you have any further questions, please contact technical support or leave a comment at the bottom of the page.<br />
<br />
Regards,<br />
<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(7184);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-8236'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//graph.facebook.com/RnzTx/picture?type=normal' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='/support/community-support/users/RohitKaradkar'>RohitKaradkar</a></div>
						<div></div>
						<div></div>
						<div>3 <a href='/support/team/points' target='_blank'>Points</a></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-09-18 12:14 am</div>
				                <div>As you said use % as Wildcard then , how to allow all remote connection ?</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8236);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-09-18 8:37 am</div>
				                <div>If you want to allow all IP addresses to connect to a remote MySQL server, you would use wildwards such as %.%.%.% which would allow any IP address to connect.  Doing so, however, is a very large security risk and I highly recommend against it.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8238);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-9851'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/e49a1cec763304c08bef457b342625cd?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/e49a1cec763304c08bef457b342625cd'>Joey</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-18 6:32 am</div>
				                <div><p>I'm trying to synchronize data tables&nbsp; local install (mamp)&nbsp; phpmysqladmin and it failes.&nbsp;I'm unable to troblehoot with telnet connection.</p>
<p>Upon telneting to my site, it ask only for password and not a username.&nbsp; I already assigned username and password for specific database.&nbsp; Which password is it waiting for? cpanel, my domain login to inmotion, or something else?&nbsp;</p>
<p>After several failed attempts, i'm not allowed connet back to my ip address and get a packet out of order.</p>
<p>&nbsp;</p>
<p>The error message attempting to connect:</p>
<p>5.5.36-cll?r"L=*W\?*?&lt;P]cZwg"n(mysql_native_password (mypasswordhere)!#08S01Got packets out of orderConnection closed by foreign host.</p>
<p>?Host '107-223-112-160.lightspeed.sndgca.sbcglobal.net' is blocked because of many connection errors; unblock with 'mysqladmin flush-hosts'Connection closed by foreign host.</p>
<p>Do i have the 'mysqladmin flush-hosts ability? It doesn't work in sql screen and looks like a command prompt from the unix shell.&nbsp; I don't have access directly to that unix shell that i'm aware of.</p>
<p>&nbsp;</p>
<p>Example Edited log below.</p>
<p>Joeys-MacAir:cgi-bin boun619$ telnet 70.39.999.999 3306Trying 70.39.999.999...Connected to ecbiz999999.inmotionhosting.com.Escape character is '^]'.N5.5.36-cllf?=Z/z:Rm?(u6KVOh=9E-Rmysql_native_password</p>
<p>Connection closed by foreign host.</p>
<p>&nbsp;</p>
<p>Any Ideas?</p>
<p>-Joey</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9851);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-11715'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/551a5085df266440887393a7c78588b1?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/551a5085df266440887393a7c78588b1'>Ron Z</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-17 6:55 pm</div>
				                <div><p>This doesn't explain how to connect - i.e. what should the mysql_connect look like. I can't get it to work and all I can find are platitudes.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11715);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-17 7:17 pm</div>
				                <div>Hello Ron,<br />
<br />
This guide just covers how to allow a remote MySQL connection into the server. If you're looking for how to connect to MySQL from PHP, we do have a guide on &lt;a href=&quot;http://www.inmotionhosting.com/support/edu/website-design/using-php-and-mysql/grab-all-comments-from-database&quot; target=&quot;_blank&quot;&gt;connecting to MySQL with PHP&lt;/a&gt; that does go over &lt;span style=&quot;color: red;&quot;&gt;mysql_connect&lt;/span&gt; with this bit of code in the second step of the guide:<br />
<br />
&lt;pre class=&quot;code_block&quot; style=&quot;margin: -10px 0px -30px 0px; line-height: .9em&quot;&gt;$con = mysql_connect(&quot;localhost&quot;,&quot;inmoti6_myuser&quot;,&quot;mypassword&quot;);&lt;/pre&gt;<br />
<br />
Please let us know if you had any other questions at all.<br />
<br />
- Jacob</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11716);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-17 7:58 pm</div>
				                <div><p>I'm trying to do a remote mysql access - and I can't get it to work. There's obviously more to it than is explained here.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11718);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-17 8:14 pm</div>
				                <div><p>I know how to do a local connection. I can't get a remote connection to work</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11719);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-17 8:36 pm</div>
				                <div>Hello Ron,<br />
<br />
What code are you trying to currently use, and is it resulting in any errors? Also are you allowing the remote IP address of the server that you're running your PHP script from? Because that's the one that will need to be added, and not your local IP if the PHP server is running from another server.<br />
<br />
There is an explanation as well as examples of &lt;a href=&quot;http://www.php.net//manual/en/function.mysql-connect.php&quot; target=&quot;_blank&quot;&gt;mysql_connect&lt;/a&gt; from the PHP.net site.<br />
<br />
If your script works locally but not remotely, I'd try this basic example:<br />
<br />
&lt;pre class=&quot;code_block&quot; style=&quot;margin: -10px 0px -30px 0px; line-height: .9em&quot;&gt;&amp;lt;?php<br />
$link = mysql_connect('&lt;span style=&quot;color: red;&quot;&gt;localhost&lt;/span&gt;', '&lt;span style=&quot;color: red;&quot;&gt;mysql_user&lt;/span&gt;', '&lt;span style=&quot;color: red;&quot;&gt;mysql_password&lt;/span&gt;');<br />
if (!$link) {<br />
...
?&amp;gt;&lt;/pre&gt;<br />
<br />
After ensuring that the &lt;span style=&quot;color: red;&quot;&gt;localhost&lt;/span&gt; variable is set to the server that is hosting your MySQL database, and also that the &lt;span style=&quot;color: red;&quot;&gt;mysql_user&lt;/span&gt;, and &lt;span style=&quot;color: red;&quot;&gt;mysql_password&lt;/span&gt; settings are correct what error is it giving back after the &lt;span style=&quot;color: red;&quot;&gt;Could not connect: &lt;/span&gt; text?<br />
<br />
- Jacob</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11720);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-26384'></a>
		<div  style='margin:2px 0px 0px 80px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/292d683cc634bc4c44a20529054a4a9c?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/292d683cc634bc4c44a20529054a4a9c'>hamid</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-05 11:02 am</div>
				                <div>what can i replace with localhost  if i want to connect from local system to web-based database?</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26384);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-08 9:21 am</div>
				                <div>Hello hamid,<br />
<br />
Thank you for contacting us. If you are connecting to a remote server, just use the domain as the hostname.<br />
<br />
Such as: example.com<br />
<br />
If you have any further questions, feel free to post them below.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26428);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-17 8:42 pm</div>
				                <div><p>The error I'm getting is this:</p>
<p><span style="font-family: arial;">Lost connection to MySQL server at 'reading initial communication packet', system error: 110</span></p>
<p><span style="font-family: arial;">and yea the local connection works. What's this about a different password for remote connection? How do I find that?</span></p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11721);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-17 9:24 pm</div>
				                <div>Hello again Ron,<br />
<br />
I'd assume either the server address you're using, or the username and password are incorrect based off that error. Either that or possibly you have a local firewall running that is preventing the outbound connection on port 3306.<br />
<br />
Yes you do need a different username / password typically for a remote connection. This would be the database username and password that you setup on the remote server. For instance you need to &lt;a href=&quot;http://www.inmotionhosting.com/support/website/databases/create-db-user&quot; target=&quot;_blank&quot;&gt;create and attach a database user to a database&lt;/a&gt; in order to remotely connect to it.<br />
<br />
- Jacob</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11722);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-12151'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/963ebf8fffb43fb79edb272d44b30868?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/963ebf8fffb43fb79edb272d44b30868'>Steve</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-30 8:45 am</div>
				                <div><p>Hello Jacob (or colleague)</p>
<p>I'm trying to connect to my remote MySQL database using a JAVA program (that I used to process data from a CSV file). It all works fine when I connect to my local database, but when I change the settings to access the remote database, I can't connect.&nbsp; I discovered this morning that I don't have SSH access to the remote database; does this mean that I will not be able to connect remotely using my JAVA app? Will I have to use something like WorkBench or Heidi? (I have got PHPMyAdmin access through cPanel, but it would be much quicker to load the database directly from the JAVA app.)</p>
<p>Any help appreciated.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12151);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-30 9:10 am</div>
				                <div>Hello Steve,<br />
<br />
...
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12158);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-30 11:31 am</div>
				                <div><p>Thanks for the quick reply Scott.</p>
<p>I can connect fine through a dummy php page I uploaded (using an example on IMH site), but still can't connect using the JAVA app. Could you tell me what format the domain should be:-</p>
<p>Eg. "<span style="color: rgb(57, 51, 255); font-family: Monaco;">jdbc:mysql://www.mydomain.org.uk:3306"</span></p>
<p><span style="color: #3933ff; font-family: Monaco;">Steve</span></p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12174);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-30 11:56 am</div>
				                <div>Hello Steve,<br />
<br />
Within the snippet you provided, have you tried using the IP address instead of the domain name? Also, are you adding /dbname at the end before you provide the username and password? It should appear something like this:<br />
jdbc:mysql://123.123.123.123/db_name, db_user, password<br />
<br />
If not, please let me know any error text you are receiving as well. <br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12179);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-12809'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/30759ddf0e2686a6a88a63fa5e9dd38d?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/30759ddf0e2686a6a88a63fa5e9dd38d'>fish</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-15 4:34 pm</div>
				                <div><p>String host= "jdbc:mysql://%.%.%.%/a21_senkwaepos";</p>
<p>String uname = "username";</p>
<p>String upass = "password";</p>
<p>&nbsp; &nbsp; &nbsp; &nbsp; try {</p>
<p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Class.forName("com.mysql.jdbc.Driver");</p>
<p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; con = DriverManager.getConnection(host, uname, upass);</p>
<p>am having error messages with the connection to the database..</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12809);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-15 4:58 pm</div>
				                <div>Hello Fish,<br />
<br />
What is the error that you're getting about problems connecting to the database? It's hard to troubleshoot without seeing your full code or the specific error. I would make sure to reference the &lt;a href=&quot;http://dev.mysql.com/doc/connector-j/en/connector-j-usagenotes-connect-drivermanager.html&quot; target=&quot;_blank&quot;&gt;connecting to MySQL using JDBC&lt;/a&gt; guide from MySQL.<br />
<br />
Also you want to make sure that your host is a valid entry that your Java application can connect remotely to. So I'm not sure if you were just using &lt;span style=&quot;color: red;&quot;&gt;jdbc:mysql://%.%.%.%/a21_senkwaepos&lt;/span&gt; as an example. But that needs to be a valid IP address or hostname:<br />
<br />
&lt;p class=&quot;cli&quot; style=&quot;margin: -10px 0px -30px 0px;&quot;&gt;String url = &quot;jdbc:mysql://localhost/test&quot;;<br />
Class.forName (&quot;com.mysql.jdbc.Driver&quot;).newInstance ();<br />
Connection conn = DriverManager.getConnection (url, &quot;username&quot;, &quot;password&quot;);&lt;/p&gt;<br />
<br />
- Jacob</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12811);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-17678'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/173f4d30720c090000f336cf5b1a0660?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/173f4d30720c090000f336cf5b1a0660'>agriirga</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-20 9:31 pm</div>
				                <div><p>Hello sir, i've make a remote database in cpanel on my hosting, but i cant acces thaint database both in heidi sql, navicat or from my program (written in C#). my program gimme error "Unable to connect to any of specified my sql host". Btw, i used mysql connector for .NET</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17678);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-21 9:15 am</div>
				                <div>Hello Agriirga,<br />
<br />
Have you made you sure you added your IP address in cPanel as it instructed? If so can you provide us your domain so we may take a look into your account and try to replicate the error. <br />
<br />
Kindest Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17696);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-22 3:38 am</div>
				                <div><p>already solved sir :). Thank you. My hosting provider has blocked the port for mysql, so i use simple web services in php to acces the DB.</p>
<p>Thank you...</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(18746);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-20580'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/b7fa9402e95b2858bb9e4a7e0649e8da?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/b7fa9402e95b2858bb9e4a7e0649e8da'>Alvin</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-11 1:40 pm</div>
				                <div>I found it to be short and precise</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20580);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-27007'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/a326b9d42e87eb2428a0f04bd0a6da69?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/a326b9d42e87eb2428a0f04bd0a6da69'>Arun</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-28 8:01 am</div>
				                <div><p>How to connect remote MySQL Server with Java Application through Internet ?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27007);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-28 8:30 am</div>
				                <div>Hello Arun,<br />
<br />
Thanks for the question about MySQL server and JAVA.  This will require coding and we do not provide coding support as it is beyond our scope of support.  However, we do try to point you in a direction that will help. Check out the official documentation for MYSQL connection using Java <a href="http://dev.mysql.com/doc/connector-j/en/connector-j-usagenotes-connect-drivermanager.html" rel="nofollow" target="_blank">here</a>.<br />
<br />
If you have any further questions or comments, please let us know.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27010);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-28745'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/287722847ed046a31854d7e7f58ec008?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/287722847ed046a31854d7e7f58ec008'>Mauricio Giacometti</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-25 10:01 am</div>
				                <div><p>Can I add a Host like no-ip or dynamicDNS to access from my IP each time?</p>
<p>Thks</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28745);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-25 10:10 am</div>
				                <div>Hello Mauricio,<br />
<br />
Thanks for the question.  I'm not sure what you mean by "no-ip", unless you're saying to make the connection with a domain name - which can be done.  You can't create a rule in the Remote MySQL connection to prevent no-IP connections.  You can create ranges of IP addresses, but in general, you'll want to specify a specific IP address to access the MySQL database.  Making it dynamic and allowing a large range of addresses may compromise the security of your database.<br />
<br />
I hope this helps to answer your question, please let us know if you require any further  assistance.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28746);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-25 10:21 am</div>
				                <div><p>I mean a dynamic DNS service like no-ip.org that points a specific address myname.no-ip.org to my real IP that is a dynamic one. It is a solution to dynamic addresses.</p>
<p>I want to put it in the "add host" field in remote mysql, can this be done?</p>
<p>&nbsp;</p>
<p>Thks</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28748);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-25 2:34 pm</div>
				                <div>Hello Mauricio,<br />
<br />
If the domain name is resolving so that it can be used on the internet, then it should connect.  You would have to use the domain name in the Access Host area.  <br />
<br />
I hope this helps to answer your question, please let us know if you require any further  assistance.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28757);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-26 9:33 am</div>
				                <div><p><span style="color: #222222; font-family: arial, sans-serif; font-size: 12.8px;">Thanks, In my case I have dynamic IP so I use no-ip to get a domain name, so the question is: Can I put that domain name and access to mysql in that way?</span></p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28781);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-31041'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/92999ef57e3ebd62f549821eec013d6a?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/92999ef57e3ebd62f549821eec013d6a'>RJ Moyer</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-08 3:30 am</div>
				                <div><p>I am trying to connect using Dreamweaver CC 2015&nbsp;to mysql database.&nbsp; I am getting the following error message:</p>
<p>Your php server doesn't have MySQL module loaded or you can't use the mysql_(p)connect function.</p>
<p>Any help would be greatly appreciated.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31041);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-08 10:52 am</div>
				                <div>Sorry to hear you were having trouble making the mySQL connection. Were there any steps in the above article you had trouble with? Did you add your IP to cPanel to allow the connection?</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31050);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-32601'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/419e0876a47cb109c149639f8ef3130f?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/419e0876a47cb109c149639f8ef3130f'>Maor Levy</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-05-11 1:47 pm</div>
				                <div><p>Hello,</p>
<p>Can I use no-ip address when adding hosts? I doesn't seem to work.</p>
<p>for example: "user.no-ip.org" as a host</p>
<p>&nbsp;</p>
<p>Thanks</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32601);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-05-11 3:10 pm</div>
				                <div>Hello Maor Levy,<br />
<br />
Access to the databases are done per IP address, so you need to have an IP address (or range of addresses) in order to make the remote connection.  This is done due to security constraints.<br />
<br />
If you have any further questions or comments, please let us know.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32611);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
	...
	<div name='fixComments' id='fixComments' style='width:220px; margin:0px; float:right;'>
		<div class='moduletable'>
			<h3><span class='comment-count'>39</span> Questions & <span class='comment-text'>Comments</span></h3>
