<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:56750:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotion.net/support/prestashop-16/logo-size-questions" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-07-29T11:47:59-07:00" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Learn how PrestaShop treats different sized logos in this article." />
  <title>PrestaShop 1.6 logo size questions - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/prestashop-16/logo-size-questions" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:e1b16195fa40608dac287108a601f2c3 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															PrestaShop 1.6 logo size questions									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>7,012</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: May 14, 2014'><span style='color:#606060;'>Published:</span> Jul 29, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>After <a href="/support/prestashop-16/install-with-softaculous">installing your PrestaShop 1.6</a> store, you naturally want to begin working on customizing your store. One of the first things most people do is to <a href="/support/prestashop-16/change-logo">upload their own logo</a> so that it displays in the header of the store. We have had some questions about the logo and what sizes are allowed when uploading it to your store using the default 1.6 theme.</p>

<h2>Quick Reference Guide</h2>
<table class="article_table">
  <tr><th>Dimension</th><th>Min pixels</th><th>Max pixels</th></tr>
  <tr><th>height</th><td>none</td><td><span style="font-size:16pt;">&infin;</span></td></tr>
  <tr><th>width</th><td>none</td><td>370</td></tr>
</table>

<h2>What is the smallest size for my logo?</h2>
<p><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/ps16/logo-questions/testlogo-50.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/ps16/logo-questions/testlogo-50.png" title="Click here to view the larger image" width="" /></a>In a default installation, PretaShop does not seem to care how small a logo is. To the right is a sample logo we used that is 50 pixels wide by 50 pixels tall. In the screenshot below you can see that it displays as actual size.</p>
<p><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/ps16/logo-questions/1-50-screen.png"><img   style="" alt="" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/ps16/logo-questions/1-50-screen.png" title="Click here to view the larger image" width="100%" /></a></p>


<h2>What is the largest size for my logo?</h2>
<p>Logos come in many shapes and sizes. Some logos can be very large or oddly shaped. PrestaShop can handle these types of images easily.</p>

<h3>What is the widest size for a logo?</h3>
<p><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/ps16/logo-questions/testlogo-500.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/ps16/logo-questions/testlogo-500.png" title="Click here to view the larger image" width="200px" /></a>In testing the PrestaShop 1.6 default installation, it seems the largest size for a logo to display is 370 pixels in width. When uploaded and displayed on the store, any image wider than 370 is resized to fit. Prestashop keeps the aspect ratio of height and width so that the image, although smaller, is not skewed and appears correctly.</p>

<table class="article_table" style="width:100%">
<tr>
  <th>Screen</th><th>Image Info</th>
</tr>
<tr>
  <td width="338px"><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/ps16/logo-questions/2-500-screen.png"><img   style="" alt="" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/ps16/logo-questions/2-500-screen.png" title="Click here to view the larger image" width="100%" /></a></td><td width="337px"><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/ps16/logo-questions/3-image-info.png"><img   style="" alt="" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/ps16/logo-questions/3-image-info.png" title="Click here to view the larger image"/></a></td>
</tr>
</table>

<h3>What is the largest height for a logo?</h3>
<p>As far as maximum height, we have tested heights as large as 10,000px and PrestaShop displays it at actual size as long as the width is under 370 pixels. Below is an example of the test logo with a width of 350 pixels and a height of 500 pixels.</p>
...
<tr>
  <td width="338px"><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/ps16/logo-questions/3-350x500-screen.png"><img   style="" alt="" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/ps16/logo-questions/3-350x500-screen.png" title="Click here to view the larger image" width="100%" /></a></td><td width="337px"><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/ps16/logo-questions/350x500-info.png"><img   style="" alt="" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/ps16/logo-questions/350x500-info.png" title="Click here to view the larger image"/></a></td>
</tr>
</table>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotion.net/support/prestashop-16/logo-size-questions&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotion.net/support/prestashop-16/logo-size-questions'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00OTMmaWQ9MzI0MiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/c13ffb459b79cd18fafdf89598a01f2a?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/c13ffb459b79cd18fafdf89598a01f2a'>Miro</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-21 1:11 pm</div>
				                <div><p>How i can change a logo size?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20928);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-23 12:12 pm</div>
				                <div>Hello Miro,<br />
<br />
You would simply alter the size of the image using an image editing program such as Paint.net, Gimp, photoshop, paint, etc.<br />
<br />
Kindest Regards,<br />
Scott M<br />
</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20973);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
