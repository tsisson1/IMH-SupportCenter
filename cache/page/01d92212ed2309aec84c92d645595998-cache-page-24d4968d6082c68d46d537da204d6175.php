<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:61307:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-3/create-component/add-new-model" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-05-23T20:11:57-07:00" />
  ...
  <link href="http://www.inmotionhosting.com/support/edu/joomla-3/create-component/add-new-model" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:05c3cfa1acb9c415e365d35ee1e59713 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to add the default Model to your Joomla 3 component									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>5,669</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: May 22, 2014'><span style='color:#606060;'>Published:</span> May 23, 2014</div>
...
<ol class='article_list'>
  <li>
    <p><strong>Create the models folder</strong></p>
    <p>If you haven't already, you will need to create the <strong>models</strong> folder. This is where our <em>model</em> files will go. In our testing, we created:<br />/components/com_helloworld/<span style='color:red;'>models</span></p></li>
  <li>
    <p><strong>Create &lt;view&gt;.php within models folder</strong></p>
...
<a href="/support/edu/joomla-3/jimport">jimport</a>('joomla.application.component.modelitem');
 
/**
 * HelloWorld Model
 */
class HelloWorldModel<span style='color:red;'>HelloWorld</span> extends JModelItem
{
        /**
         * @var string msg
         */
  ...
  <li>
    <p><strong>Update your view.html.php file to call the getMsg() function</strong></p>
    <p>In our <u>components/com_helloworld/views/helloworld/<span style='color:red;'>view.html.php</span></u> file,<br /> we originally created the "<em>Hello World</em>" message via the following line:</p>
...
class HelloWorldViewHelloWorld extends JViewLegacy
{
        ...
        function display($tpl = null) 
        {
                ...
                <span style='color:red;'>$this-&gt;msg = $this-&gt;get('Msg');</span>
...
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/create-component/tracing-the-new-model.png"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/create-component/tracing-the-new-model.png"  style="max-width:100%; max-height:500px;" /></a>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 8: How to add the default Model to your Joomla 3 component</div>
...
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-3/create-component/add-new-model'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD01MDcmaWQ9MzI1MyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
