<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:71150:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/server-usage/using-the-linux-top-command-in-batch-mode" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-02-13T11:52:57-08:00" />
  <meta name="keywords" content="linux top command batch mode script execution executions" />
  ...
  <link href="http://www.inmotionhosting.com/support/website/server-usage/using-the-linux-top-command-in-batch-mode" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:36abfdd0911809ca60c3aabf60a89f12 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-22']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '137.254.4.9']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Using the Linux top command in batch mode</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Using the Linux top command in batch mode									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>15,406</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 24, 2013'><span style='color:#606060;'>Published:</span> Feb 13, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In this article I'm going to teach you how you can use the popular Linux top command in batch mode on your VPS (Virtual Private Server) or dedicated server to track down possible problematic script executions.</p>
<p>A lot of times there can be just a few scripts on your server that can quickly cause a lot of CPU usage and cause your server's load average to spike. If you've already read my previous articles on either <a href="/support/website/server-usage/advanced-server-load-monitoring" target="_blank">advanced server load monitoring</a>, or on <a href="/support/website/server-usage/create-server-load-monitoring-bash-script" target="_blank">how to create a server load monitoring script</a>, you might have noticed that your server's usage has been spiking. Being able to hop on your server and look for long running script executions can be a good troubleshooting tactic to use to see where this extra usage might be coming from.</p>
...
<p>To follow along with the steps below, you'll need to already have <a href="/support/website/general-server-setup/root-access-faq" target="_blank">root access</a> to either your VPS or dedicated server so that you have full access to all of the processes running on your server.</p>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/server-usage/using-the-linux-top-command-in-batch-mode&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/server-usage/using-the-linux-top-command-in-batch-mode'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD04NSZpZD01MTcmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="7c3ab725db411a75dd67bfcebe1d9d6d" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/92f355c7ee9b409fc3b0f7c40c5a9c2a?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/92f355c7ee9b409fc3b0f7c40c5a9c2a'>Dominik</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-19 5:15 am</div>
				                <div><p>Why are you interested in <em>idle</em> processes?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32049);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-19 9:31 am</div>
				                <div>An admininistrator can know which programs are running by monitor idle processes; and to make sure that the programs which should be running are running as expected.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32056);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
