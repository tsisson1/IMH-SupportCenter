<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:65796:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/dokuwiki/change-dokuwiki-appearance/change-template-dokuwiki" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-01-15T20:19:16-08:00" />
  <meta name="keywords" content="change changing template theme sidebar dokuwiki doku wiki upload uploading zip file default [gs]" />
  ...
  <link href="http://www.inmotionhosting.com/support/edu/dokuwiki/change-dokuwiki-appearance/change-template-dokuwiki" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:2dbb06806772729e3b26d95d6dcbde92 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '67.53.168.82']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Changing the DokuWiki template									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>12,595</span></div>
							...
							<div style='clear:both;'></div>
								...
								<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/changing-dokuwiki-theme/dokuwiki-template.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="The DokuWiki front page" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/changing-dokuwiki-theme/dokuwiki-template.gif" title="Click here to view the larger image" width="100" /></a> DokuWiki is a free Open Source Software that has many templates available for free online. Switching templates within the administration section is very simple compared to other wiki software. While some wiki programs require the code to be edited on the server to change the template, DokuWiki just has a simple drop box where you can change the template in the admin area.</p>
<p>There is a great repository of free templates available at <a href="https://www.dokuwiki.org/start?do=search&amp;id=template" target="_blank">DokuWiki</a>. The snapshot to the right shows what the intitial installed DokuWiki template looks like. This article will explain how to change the DokuWiki template to Default, upload a free template, and switch the theme and sidebar options within the Round Corner template.<br style="clear: both;" /></p>
...
<li><a target="_blank" href="/support/edu/dokuwiki/geting-started-dokuwiki/login-dokuwiki" title="Click for more information"><strong>Log into DokuWiki</strong></a>.</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/changing-dokuwiki-theme/change-template-dokuwiki-1-click-admin.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="To Change the template click admin link" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/changing-dokuwiki-theme/change-template-dokuwiki-1-click-admin.gif" title="Click here to view the larger image" width="100" /></a><strong>Click</strong> the <strong>Admin</strong> link at the top. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/changing-dokuwiki-theme/change-template-dokuwiki-2-click-config-settings.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="To change template dokuwiki click config settings" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/changing-dokuwiki-theme/change-template-dokuwiki-2-click-config-settings.gif" title="Click here to view the larger image" width="100" /></a><strong>Select</strong> the <strong>Configuration Settings</strong> link in the Administration. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/changing-dokuwiki-theme/change-template-dokuwiki-3-select-default.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="To change template dokuwiki select default" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/changing-dokuwiki-theme/change-template-dokuwiki-3-select-default.gif" title="Click here to view the larger image" width="100" /></a>On the DokuWiki settings page, <strong>Select Default</strong> from the "<em>Template aka the design of the wiki</em>" drop box. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/changing-dokuwiki-theme/change-template-dokuwiki-4-save.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="To change template dokuwiki save" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/changing-dokuwiki-theme/change-template-dokuwiki-4-save.gif" title="Click here to view the larger image" width="100" /></a><strong>Click Save</strong>. <br style="clear: both;" /> <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/changing-dokuwiki-theme/default-dokuwiki-template.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="The default dokuwiki template" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/changing-dokuwiki-theme/default-dokuwiki-template.gif" title="Click here to view the larger image" width="100" /></a>Now the appearance of your DokuWiki site will have the Default template displayed. <br style="clear: both;" /></li>
</ol>
<h2>Uploading a free DokuWiki theme</h2>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/changing-dokuwiki-theme/dokuwiki-roundbox-template-download.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="dokuwiki roundbox template download site" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/changing-dokuwiki-theme/dokuwiki-roundbox-template-download.gif" title="Click here to view the larger image" width="100" /></a>By Default, a new installation of DokuWiki only has the DokuWiki and Default templates. In this section, we will upload the Round Corner template to the server. Download the Round Corner Template from the following link.</p>
<p style="margin-left: 20px;"><a href="https://www.dokuwiki.org/template:roundbox" target="_blank">www.dokuwiki.org/template:roundbox</a></p>
...
<ol class="article_list">
<li><a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel" title="Click here for info" target="_blank"><strong>Login to your cPanel</strong></a></li>
<li><a href="/support/edu/cpanel/cpanel-file-manager/using-file-manager-in-cpanel" title="Click here for info" target="_blank"><strong>Go to the File Manager</strong></a></li>
...
<li><a target="_blank" href="/support/website/cpanel/compressing-uncompressing-files"><strong>Extract the .zip file </strong></a>to the following:
<p style="margin-left: 20px;">public_html/yourfolder/lib/tpl</p>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/changing-dokuwiki-theme/dokuwiki-roundbox-template-1-file-manager.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="dokuwiki roundbox template in the file manager" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/changing-dokuwiki-theme/dokuwiki-roundbox-template-1-file-manager.gif" title="Click here to view the larger image" width="100" /></a>The folder for the Round Corner theme will show with the other templates like the snapshot to the right.<br style="clear: both;" /></p>
</li>
<li><a href="/support/edu/dokuwiki/geting-started-dokuwiki/login-dokuwiki" title="Click for more information" target="_blank"><strong>Log into DokuWiki</strong></a> as admin. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/changing-dokuwiki-theme/dokuwiki-roundbox-template-2-settings.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="dokuwiki roundbox template settings" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/changing-dokuwiki-theme/dokuwiki-roundbox-template-2-settings.gif" title="Click here to view the larger image" width="100" /></a><strong>Go to Admin &gt; Configuration settings</strong>. <br style="clear: both;" /></li>
<li>Scroll to the bottom and <strong>click Save</strong>. <br style="clear: both;" /> <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/changing-dokuwiki-theme/dokuwiki-roundbox-template-3-home-page.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="dokuwiki roundbox template home page" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/changing-dokuwiki-theme/dokuwiki-roundbox-template-3-home-page.gif" title="Click here to view the larger image" width="100" /></a>Now your Dokuwiki site will have the Round Corner theme <br style="clear: both;" /></li>
</ol>
...
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/changing-dokuwiki-theme/template-settings-dokuwiki-1-roundbox-themes.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Changing the Round Corner theme" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/changing-dokuwiki-theme/template-settings-dokuwiki-1-roundbox-themes.gif" title="Click here to view the larger image" width="100" /></a>On the <em>Template settings</em> section, <strong>select haze</strong> from the <em>Theme</em> drop box.. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/changing-dokuwiki-theme/template-settings-dokuwiki-2-haze-theme.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Round Corner Haze Theme" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/changing-dokuwiki-theme/template-settings-dokuwiki-2-haze-theme.gif" title="Click here to view the larger image" width="100" /></a><strong>Click Save</strong>.
...
<li><a target="_blank" href="/support/edu/dokuwiki/geting-started-dokuwiki/login-dokuwiki" title="Click for more information"><strong>Log into DokuWiki</strong></a>.</li>
<li><strong>Go to Admin &gt; Configuration settings.</strong><br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/changing-dokuwiki-theme/template-settings-dokuwiki-3-sidebar-right.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Setting for the sidebar in round corner theme" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/changing-dokuwiki-theme/template-settings-dokuwiki-3-sidebar-right.gif" title="Click here to view the larger image" width="100" /></a>In the <em>Template Settings</em>, <strong>select right</strong> from the <em>Sidebar position</em>. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/changing-dokuwiki-theme/template-settings-dokuwiki-4-home-page.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Sidebar on the right of the Round Corner template" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/changing-dokuwiki-theme/template-settings-dokuwiki-4-home-page.gif" title="Click here to view the larger image" width="100" /></a><strong>Click Save</strong>. The template sidebar is now on the right like the snapshot. <br style="clear: both;" /></li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 2: Changing the DokuWiki template</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 1: <a href='/support/edu/dokuwiki/change-dokuwiki-appearance/site-title-url-license-basic-settings'>DokuWiki Basic Settings: Site title, Site URL, and License</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 3: <a href='/support/edu/dokuwiki/change-dokuwiki-appearance/change-dokuwiki-logo'>How to change the DokuWiki logo</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/dokuwiki/change-dokuwiki-appearance/change-template-dokuwiki&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/dokuwiki/change-dokuwiki-appearance/change-template-dokuwiki'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMjUmaWQ9MjExNSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="32702919922c1a87e660ef859d85151e" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
        ...
        <tr><td colspan='2'><h4>Header, Footer, and Logo</h4></td></tr>  <tr >
                        <td valign='top'>3.</td>
