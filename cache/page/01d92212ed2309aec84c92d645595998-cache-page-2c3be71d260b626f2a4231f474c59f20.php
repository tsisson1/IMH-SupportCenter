<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50188:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/website-design/can-i-create-a-website-on-another-website-eg-wix-and-have-it-hosted-on-my-inmotion-domain" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Mstmary, Thanks for the question. The answer is yes, but you need to understand that it will depend on the application and vendor that you are usi..." />
  <title>Can I create a website on another website (e.g. Wix) and have it hosted on my inmotion domain? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/website-design/can-i-create-a-website-on-another-website-eg-wix-and-have-it-hosted-on-my-inmotion-domain" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:dd636e07f971b0e19609d8310facf5a4 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-20']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '54.236.1.80']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Can I create a website on another website (e.g. Wix) and have it hosted on my inmotion domain?</h1>
		<div style='margin-bottom:20px; margin-top:10px; clear:both; color:#6e6e6e;'>Category: <a href='/support/community-support/website-design'>Website Design</a></div>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='https://lh5.googleusercontent.com/-R59YamqvjSk/AAAAAAAAAAI/AAAAAAAACKg/WIC5mWOKdts/photo.jpg?sz=90' class='user_avatar' /><br />
			<a href='/support/community-support/users/mstmary'>mstmary</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-05-24 7:12 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>1,171</span>
			</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_3203' id='upvote_answer_3203' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='3203' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_3203').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_3203' id='downvote_answer_3203' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='3203' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_3203').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Mstmary,<br />
<br />
Thanks for the question.  The answer is yes, but you need to understand that it will depend on the application and vendor that you are using to build the website.  In some cases, you may not be able to move the website that you have created with a proprietary application over to our hosting services.  We can host websites here as long as you have all the files necessary for the website to operate.  If you're interested in the many applications that we have available for building website, check out <a href="http://www.inmotionhosting.com/support/edu/cpanel/softaculous/list-programs-softaculous" target="new">list of programs available through Softaculous</a>.  These programs are free and can be loaded and tested on your InMotion Hosting account at any time.<br />
<br />
I hope that helps to answer your question!  Please let us know if you require any further assistance!<br />
<br />
Arnel C.
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_3203').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_3203' id='form_comment_on_answer_3203' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/website-design/can-i-create-a-website-on-another-website-eg-wix-and-have-it-hosted-on-my-inmotion-domain&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/website-design/can-i-create-a-website-on-another-website-eg-wix-and-have-it-hosted-on-my-inmotion-domain'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="cd3c97931dcc69c8e5a308253915e887" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
                                ...
                                <h3>Related Articles</h3><a target='_blank' href='http://inmotionhosting.com/support/create-503-status'>Create a 503 Status Code for your Site</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/minifying-css'>Minifying CSS</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/minifying-html'>Minifying HTML</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/html-reference'>304: HTML Tag Reference List</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/303-using-server-side-includes-with-html'>303: Using Server Side Includes with HTML Files</a><br/><br />
		</div>
