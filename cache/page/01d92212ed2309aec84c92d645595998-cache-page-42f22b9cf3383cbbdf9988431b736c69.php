<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:73585:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/prestashop-15/catalog-setup/set-new-orcer-notification" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-09-18T17:49:17-07:00" />
  <meta name="keywords" content="edit enable disable new order PrestaShop 1.5 back office dashboard panel notification" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="This article guides you through enabling or disabling the new order notification in the PrestaShop 1.5 back office dashboard panel." />
  <title>How to enable/disable the new order notification in PrestaShop 1.5 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/prestashop-15/catalog-setup/set-new-orcer-notification" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:726d2efdddf45681ff19581a56d0048d -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '74.135.77.3']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to enable/disable the new order notification in PrestaShop 1.5									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>18,922</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jun 19, 2012'><span style='color:#606060;'>Published:</span> Sep 18, 2012</div>
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Comments:</span> <a href='#comments'>4</a></div>
...
<li>Using the top menu bar, hover over the <strong>Administration </strong>tab and select the <strong>Preferences </strong>option.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Administration/Preferences/administration_tab_preferences.png"><img  alt="administration_tab_preferences" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Administration/Preferences/administration_tab_preferences.png" /></a></li>
<li>You are now on the <em>Administration : Preferences</em> screen. In the lower section, named <strong>Notifications</strong>, you will see the setting named <strong>Show notifications for new orders</strong>. This is set to <strong>Yes </strong>by default, which means the notification is turned on. To turn it off, simply click the radio button next to the red <strong>X</strong>.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Administration/Preferences/administration-preferences-notifications.png"><img  alt="administration-preferences-notifications" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Administration/Preferences/administration-preferences-notifications.png" /></a></li>
<li>Once finished, click the green <strong>Save </strong>button in the upper right corner.</li>
</ol>
<p>That is how you change the new order setting in PrestaShop 1.5</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/prestashop-15/catalog-setup'>109: Catalog Setup in PrestaShop 1.5</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 2: How to enable/disable the new order notification in PrestaShop 1.5</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 1: <a href='/support/edu/prestashop-15/catalog-setup/allow-out-of-stock-orders'>How to allow orders on out-of-stock products in PrestaShop 1.5</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 3: <a href='/support/edu/prestashop-15/catalog-setup/allow-backorders'>How to allow back orders in PrestaShop 1.5</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/prestashop-15/catalog-setup/set-new-orcer-notification&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/prestashop-15/catalog-setup/set-new-orcer-notification'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yMzYmaWQ9MTQ4MyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="1be4e5d94ff64b239e7e37801cae87b4" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/prestashop-15/catalog-setup?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Catalog Setup in PrestaShop 1.5</h3></a>
		<table><tr><td colspan='2'><h4>Features</h4></td></tr>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/prestashop-15/catalog-setup/allow-out-of-stock-orders?tsrc=rsbedu'>How to allow orders on out-of-stock products in PrestaShop 1.5</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/prestashop-15/catalog-setup/set-new-orcer-notification?tsrc=rsbedu'>How to enable/disable the new order notification in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/prestashop-15/catalog-setup/allow-backorders?tsrc=rsbedu'>How to allow back orders in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/prestashop-15/catalog-setup/set-minimum-order-quantity?tsrc=rsbedu'>Setting a minimum order  quantity in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/prestashop-15/catalog-setup/add-new-store-location?tsrc=rsbedu'>Adding a new Store Locations list in PrestaShop 1.5</a></td>
                </tr>
        <tr><td colspan='2'><h4>Products</h4></td></tr>  <tr >
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/prestashop-15/catalog-setup/edit-enable-stock-management?tsrc=rsbedu'>How to edit the Stock Management option in PrestaShop 1.5 </a></td>
                </tr>
          <tr >
                        <td valign='top'>7.</td>
                        <td><a href='/support/edu/prestashop-15/catalog-setup/products-per-page?tsrc=rsbedu'>Changing the Number of Products per Page in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>8.</td>
                        <td><a href='/support/edu/prestashop-15/catalog-setup/change-product-prder-display?tsrc=rsbedu'>Changing the order Products are displayed in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>9.</td>
                        <td><a href='/support/edu/prestashop-15/catalog-setup/asending-descending-order?tsrc=rsbedu'>Listing products in ascending or descending order in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>10.</td>
                        <td><a href='/support/edu/prestashop-15/catalog-setup/display-remove-available-quantity?tsrc=rsbedu'>How to display/remove available product quantities in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>11.</td>
                        <td><a href='/support/edu/prestashop-15/catalog-setup/setting-days-new?tsrc=rsbedu'>Setting the days a product is considered New in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>12.</td>
                        <td><a href='/support/edu/prestashop-15/catalog-setup/set-max-product-image?tsrc=rsbedu'>How to set the max product image size in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>13.</td>
                        <td><a href='/support/edu/prestashop-15/catalog-setup/set-max-downloadable?tsrc=rsbedu'>Setting the max size for downloadable products in PrestaShop 1.5</a></td>
                </tr>
          	</table>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/ca157e31dcf1447aba50978b934934bb?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/ca157e31dcf1447aba50978b934934bb'>Ernie</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-21 10:14 am</div>
				                <div><p>We just installed the new paypal module for the poodle thing. Now we are not getting emails from paypal and no email from prestashop. Orders do not even show up in prestashop</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19787);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-21 10:30 am</div>
				                <div>Hello Ernie,<br />
<br />
Apologies for the problem with Paypal.  Unfortunately, this issue is something that Paypal may need to correct and it does depend upon the versions you've installed.  Please review these <a href="http://www.prestashop.com/download/pdf/PrestaShop_POODLE_EN.pdf" rel="nofollow" target="_blank">official instructions from Paypal</a>.  Also, please make sure to see <a href="https://www.prestashop.com/forums/topic/379348-paypal-ssl-3-issues/" rel="nofollow" target="_blank">PrestaShop's forum on this issue</a>.  They discuss older version issues and possible fixes.<br />
<br />
If you have followed them to the letter and you're still having issues, then check with Paypal's support on the issue.  They may have posted an update or are aware of the issue and working to fix it.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19788);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-05-08 11:15 pm</div>
				                <div><p><span id="result_box" lang="en"><span class="hps">prestashop</span> <span class="hps">I</span>'ve been <span class="hps">in</span> <span class="hps">settings</span> <span class="hps">like</span> <span class="hps">this way</span>. <span class="hps">I</span> <span class="hps">use the</span> <span class="hps">module</span> <span class="hps">mail</span> <span class="hps">alerts</span>, <span class="hps">and</span> <span class="hps">I</span> <span class="hps">fill</span> <span class="hps">my email</span>, <span class="hps">but</span> <span class="hps">each</span> <span class="hps">no purchase</span> <span class="hps">only</span> <span class="hps">appear</span> <span class="hps">pemberitauan</span> <span class="hps">in</span> <span class="hps">backoffice</span> <span class="hps">only,</span> <span class="hps">not</span> <span class="hps">sent</span> <span class="hps">in</span> <span class="hps">my</span> <span class="hps">email</span> <span class="hps">admin</span><span>.</span></span></p>
<p>&nbsp;</p>
<p><span lang="en"><span>please help.</span></span></p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23280);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-05-12 10:32 am</div>
				                <div>Hello Ardhi,<br />
<br />
Sorry for the continued problem with the Paypal.  The information you're providing unfortunately is not enough to help troubleshoot the issue.  Can you please provide information on your settings so that  can attempt to duplicate the issue.  We would also need specific information on the versions for  PrestaShop and the modules you're attempting to use.  Issues of this nature are handled publicly in this forum.  If you want it private, you should contact the developer of the add-on.  Apologies that we can't provide a direct answer at this point.  <br />
<br />
Kindest regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23369);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
	...
	<div name='fixComments' id='fixComments' style='width:220px; margin:0px; float:right;'>
		<div class='moduletable'>
			<h3><span class='comment-count'>4</span> Questions & <span class='comment-text'>Comments</span></h3>
