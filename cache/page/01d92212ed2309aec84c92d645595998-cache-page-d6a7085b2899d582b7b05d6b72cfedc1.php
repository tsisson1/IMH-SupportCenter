<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:71639:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/opencart/admin-tools/forgot-password-link" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-04-22T17:32:34-07:00" />
  <meta name="keywords" content="opencart password reset forgot admin dashboard" />
  <meta name="author" content="John-Paul Briones" />
  <meta name="description" content="This guide walks you through resetting your OpenCart Admin password using the Forgot  Password link on the dashboard login page." />
  <title>Resetting your OpenCart 1.5 Admin Password with the Forgot Password link - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/opencart/admin-tools/forgot-password-link" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:e0274c27d92e6b4c3f1993469de84a95 -->
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/opencart' itemprop='url'><span itemprop='title'>OpenCart<span></a><div class='dropdown_4columns'><h2>OpenCart Education Channel</h2><div class='col_2'><h3>100 Level Classes</h3><div><a href='/support/edu/opencart/installing-opencart-and-adding-products'>101: Installing OpenCart and Adding Products</a></div><div><a href='/support/edu/opencart/managing-customers'>102: Managing Customers through OpenCart</a></div><div><a href='/support/edu/opencart/setting-up-payment-gateways'>103: Setting up a Payment Gateway</a></div><div><a href='/support/edu/opencart/testing-your-store'>104: Testing your OpenCart Store</a></div><div><a href='/support/edu/opencart/processing-orders'>105: Processing Orders in OpenCart</a></div><div><a href='/support/edu/opencart/customizing-store-look-and-feel'>106: Customizing the Look and Feel of OpenCart</a></div><div><a href='/support/edu/opencart/reports'>107: Using OpenCart Reports</a></div></div><div class='col_2'><h3>200 Level Classes</h3><div><a href='/support/edu/opencart/admin-tools'>201: OpenCart Administration</a></div><div><a href='/support/edu/opencart/security'>202: OpenCart Security</a></div><div><a href='/support/edu/opencart/203-shipping-and-taxes-in-opencart'>203: Shipping and Taxes in OpenCart</a></div><div><a href='/support/edu/opencart/204-working-with-affiliates-in-opencart'>204: Working with Affiliates in OpenCart</a></div><div><a href='/support/edu/opencart/attributes-products-specifications'>205: Adding Attributes to OpenCart products</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/opencart/admin-tools' itemprop='url'><span itemprop='title'>201: OpenCart Administration<span></a><div class='dropdown_3columns'><h2> OpenCart Administration</h2><div class='col_3'><div>1. <a style='display:inline;' href='/support/edu/opencart/admin-tools/fix-opencart-email-notifications'>Fixing the Email issue with OpenCart 1.5</a></div><div>2. <a style='display:inline;' href='/support/edu/opencart/admin-tools/forgot-password-link'>Resetting your OpenCart 1.5 Admin Password with the Forgot Password link</a></div><div>3. <a style='display:inline;' href='/support/edu/opencart/admin-tools/backup-restore'>Using the Backup/Restore option in OpenCart 1.5</a></div><div>4. <a style='display:inline;' href='/support/edu/opencart/admin-tools/changing-your-admin-password-in-opencart'>Changing your Admin Password in OpenCart</a></div><div>5. <a style='display:inline;' href='/support/edu/opencart/admin-tools/what-are-opencart-extensions-and-modules'>What are OpenCart Extensions and Modules?</a></div><div>6. <a style='display:inline;' href='/support/edu/opencart/admin-tools/restoring-a-database-backup-in-opencart'>Restoring a Database Backup in OpenCart</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Resetting your OpenCart 1.5 Admin Pas...</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Resetting your OpenCart 1.5 Admin Password with the Forgot Password link									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>9,199</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Mar 4, 2014'><span style='color:#606060;'>Published:</span> Apr 22, 2016</div>
  ...
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('reset-password');">Reset Password</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('warning');">Troubleshoot Warning message</button>
</div>

<p>If you are unable to <a href="/support/edu/opencart/installing-opencart-and-adding-products/dashboard-login"><strong>login</strong> to your <strong>OpenCart Dashboard</strong></a>, there is a <em>Forgot Password</em> link that can help you. In this tutorial we will show you how to <strong>Reset your OpenCart Password</strong>, so you can login to the Admin Dashboard.</p>
<a name="reset-password"></a>

<h2>How to Reset your Admin Password</h2>
<ol class="article_list">
  <li>Go to your <em><a href="/support/edu/opencart/installing-opencart-and-adding-products/logging-into-the-opencart-dashboard">OpenCart Login</a></em> page, and click the <strong>Forgotten Password</strong> link.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/opencart/password-reset/opencart-forgotten-password-link.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/opencart/password-reset/opencart-forgotten-password-link.png" alt="using the forgot password link" title="click the forgotten password on the opencart admin page" /></a></li>
  <li>Type your <em>OpenCart Admin</em> <strong>E-mail Address</strong> in the blank box, then click the <strong>Reset</strong> button. Getting a warning about the email address you're entering? <a href="#warning">click here</a><br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/opencart/password-reset/enter-e-mail-address-associated-with-account.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/opencart/password-reset/enter-e-mail-address-associated-with-account.png" alt="input your email address for the dashboard login" title="enter your admin email address for opencart" /></a><br><br>
You will then see a message stating "<em>An email with a confirmation link has been sent your admin email address.</em>"<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/opencart/password-reset/opencart-email-confirmation-link.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/opencart/password-reset/opencart-email-confirmation-link.png" alt="opencart email reset sent" title="opencart password reset email sent confirmation" /></a></li>
<li>Check your email account and open the message with the subject "<strong>Your Store - Password reset request</strong>."</li>
<li>The email message will state "<em>A new password was requested for Your Store administration.To reset your password click on the link below.</em>" Click the provided link<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/opencart/password-reset/click-password-reset-request-email-link-in-open-cart.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/opencart/password-reset/click-password-reset-request-email-link-in-open-cart.png" alt="clicking the opencart password reset link in your email" title="opencart admin dashboard passwsord reset email" /></a><br><br>
You will then be on the <em>Reset your password</em> page.</li>
<li>Enter a new password, in the blank fields, then click the <strong>Save</strong> button.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/opencart/password-reset/creating-new-admin-password-for-opencart.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/opencart/password-reset/creating-new-admin-password-for-opencart.png" alt="create a new admin password for opencart" title="enter a new password for the opencart dashboard" /></a><br><br>
  You are finished when you see the "<em>Success: Your password has been successfully updated.</em>" Now you can <a href="/support/edu/opencart/installing-opencart-and-adding-products/logging-into-the-opencart-dashboard">login to the OpenCart Dashboard</a>.</li>
</ol>


<a name="warning"></a>

<h3>Warning: The E-Mail Address was not found in our records, please try again!</h3>
<p>On <strong>Step 2</strong> above, when you entered your email address, you may have received the following message - <em>"Warning: The E-Mail Address was not found in our records, please try again!</em>" This message means the <em>email address</em> you entered was not correct. The following is a list of possible solutions.</p>
  
<ul><li>Check the spelling of your email address for typos</li>
<li>Try a different email address, in case you are using the wrong one</li>
<li><a href="/support/edu/opencart/339-how-to-reset-my-opencart-admin-password">Change the password in the database (<strong style="color:red">for Advanced users</strong>)</a></li></ul> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/opencart/admin-tools'>201: OpenCart Administration</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 2: Resetting your OpenCart 1.5 Admin Password with the Forgot Password link</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 1: <a href='/support/edu/opencart/admin-tools/fix-opencart-email-notifications'>Fixing the Email issue with OpenCart 1.5</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 3: <a href='/support/edu/opencart/admin-tools/backup-restore'>Using the Backup/Restore option in OpenCart 1.5</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/opencart/admin-tools/forgot-password-link&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/opencart/admin-tools/forgot-password-link'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xNTcmaWQ9MzEzMiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/opencart/admin-tools?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> OpenCart Administration</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/opencart/admin-tools/fix-opencart-email-notifications?tsrc=rsbedu'>Fixing the Email issue with OpenCart 1.5</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/opencart/admin-tools/forgot-password-link?tsrc=rsbedu'>Resetting your OpenCart 1.5 Admin Password with the Forgot Password link</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/opencart/admin-tools/backup-restore?tsrc=rsbedu'>Using the Backup/Restore option in OpenCart 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/opencart/admin-tools/changing-your-admin-password-in-opencart?tsrc=rsbedu'>Changing your Admin Password in OpenCart</a></td>
                </tr>
          <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/opencart/admin-tools/what-are-opencart-extensions-and-modules?tsrc=rsbedu'>What are OpenCart Extensions and Modules?</a></td>
                </tr>
          <tr >
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/opencart/admin-tools/restoring-a-database-backup-in-opencart?tsrc=rsbedu'>Restoring a Database Backup in OpenCart</a></td>
                </tr>
          	</table>
...
<a name='comments'></a>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/99c1a5f1d255d4dfbd13ceabf4cc0529?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/99c1a5f1d255d4dfbd13ceabf4cc0529'>ZAHEER</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-04 7:17 am</div>
				                <div><p>iN mY CASE NOT SHOW THAT OPTION&nbsp; THAT YOU SHOW FORGETTED PASSWORD BUT THAT OPTION NOT SHOW IN MY ADMIN PAGE</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11144);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-04 8:49 am</div>
				                <div>If you are unable to use the &lt;strong&gt;Forgot Password&lt;/strong&gt; link, you may also &lt;a href=&quot;http://www.inmotionhosting.com/support/edu/opencart/339-how-to-reset-my-opencart-admin-password&quot;&gt;reset your OpenCart password from within the database&lt;/a&gt;.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11152);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-24176'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/5b098694d54102d5dc4c00f6c2110d41?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/5b098694d54102d5dc4c00f6c2110d41'>Sohoz</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-13 12:29 pm</div>
				                <div><p>admin password reset option not showing</p>
<p>&nbsp;</p>
<p>site: www.sohozlife.com</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24176);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-15 2:22 pm</div>
				                <div>Hello Sohoz,<br />
<br />
The Forgotten Password link should display in the default theme, even in the 2.0.2.0 version. Have you added a different theme or any modules that would remove that?<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24215);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
...
<p>&nbsp;</p>
<p>I've installed oc in non www mode after, I decide it should be www (it looks good ) then I've made 301 redirect non www to www, thats it. its working in non www mode but in www mode its removed.</p>
<p>&nbsp;</p>
<p>There is no image adding option here :( , you can see here sohozlife.com/admin</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>regards</p>
<p>&nbsp;</p>
<p>Sohoz</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24227);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-15 3:28 pm</div>
				                <div>Hello Sohoz,<br />
<br />
I don't think that would affect the link not displaying. It should be there. If you have not added any content yet I would remove OpenCart and then reinstall it.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24235);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
