<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50277:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/moodle/activity-resource" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="keywords" content="Add activity resource moodle course section" />
  <meta name="description" content="This section explains the functions for adding an activity or resource to the Course sections in Moodle 2.3." />
  <title>103: Adding an activity or resource to a course in Moodle | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/moodle/activity-resource" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:03a775f3db7866c8b949c37e3e1b57ad -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '209.216.150.247']);
...
<div class='page-header'>
	<h1>103: Adding an activity or resource to a course in Moodle</h1>
</div>
<div class='section_listing'>
		<table>
	<tr><td colspan='3'><h2>Overview</h2><div>Brief overview of the Activities and Resources</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 1:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/activity-resource/activity-resource-overview'>Moodle Activity or Resource Overview</a>
					<div>This article is a basic overview of the Activities and Resources available in Moodle 2.3. Activities and resources add interactivity and content to the Course Sections.</div>
					<div class='smallgrey'>Hits: 1,552</div>
				</td>
			</tr>
		<tr><td colspan='3' style='padding-top:20px;'><h2>Activities</h2><div>General category for user activity in Moodle such as Assignments, lessons, and Quizzes.</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 2:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/activity-resource/adding-assignment'>How do I add an  Assignment to a Course in Moodle</a>
					<div>This tutorial will explain how to add the Assignment module to the Course sections in Moodle 2.3</div>
					<div class='smallgrey'>Hits: 1,708</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/activity-resource/add-lesson-module'>Adding the Lesson module to a course in Moodle</a>
					<div>This article will focus on adding Lessons to a course section in Moodle 2.3.</div>
					<div class='smallgrey'>Hits: 1,659</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/activity-resource/build-lesson'>Building a Lesson in Moodle</a>
					<div>This article will focus on building the Lesson for functionality in Moodle. The focus of this article is to explain the different options available for the Lessons. </div>
					<div class='smallgrey'>Hits: 1,646</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/activity-resource/add-content-page-lesson'>Adding a content page in the Moodle Lesson module</a>
					<div>The most important part of the Course is the content of each Section. The Add a content page portion of lesson module is specifically for incorporating the content into the Course section for Moodle 2.3.</div>
					<div class='smallgrey'>Hits: 1,547</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/activity-resource/add-question-page'>Adding questions to the Lesson module in Moodle</a>
					<div>This tutorial will explain how to add Lesson Questions in the Course sections of Moodle 2.3. The Question page is a part of the lesson module and should not be confused with the quiz module.</div>
					<div class='smallgrey'>Hits: 1,936</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/activity-resource/create-glossary'>Creating a Glossary for a Moodle Course Section</a>
					<div>A Glossary may be needed for giving access to the terms of the course in Moodle 2.3. This article will walk through the process of adding Vocabulary words necessary for the course through Glossary module.</div>
					<div class='smallgrey'>Hits: 1,151</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/activity-resource/quiz-module'>How to add the Quiz Module in Moodle</a>
					<div>This tutorial will focus on adding the quiz module to a Course in the add an activity or resource section of Moodle 2.3.</div>
					<div class='smallgrey'>Hits: 2,272</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/activity-resource/adding-questions-quiz'>Adding questions to a quiz using the Question bank</a>
					<div>Once the Quiz module is added, questions will need to be added to the quiz. In this tutorial, questions will be added to a quiz using the Moodle 2.3 Question bank.</div>
			...
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/activity-resource/view-quiz-statistics-report'>Viewing the Quiz Statistics Report in Moodle</a>
					<div>This guide shows you how to view the statistic results for quizzes you have given in Moodle.</div>
					<div class='smallgrey'>Hits: 803</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/activity-resource/forum-module'>Creating a discussion with the Moodle Forum module</a>
					<div>The Moodle 2.3 Forum module allows students to participate in a discussion created by the instructor. This article will discuss how to add the Forum module.</div>
					<div class='smallgrey'>Hits: 1,943</div>
				</td>
			</tr>
		<tr><td colspan='3' style='padding-top:20px;'><h2>Resources</h2><div>These are resources that can be inserted into the Courses such as a file, page or URL.</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 12:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/activity-resource/file-resource-module'>Adding the File Resource Module to Moodle Courses</a>
					<div>This tutorial will briefly explain how to upload file resources to the Course Sections in Moodle 2.3.</div>
					<div class='smallgrey'>Hits: 1,166</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/activity-resource/label-module'>Labeling Activities and Resources with the label Module in Moodle</a>
					<div>To separate the Activities and resources, the Label module can be used to add a header between modules for organizing them under sections in Moodle 2.3.</div>
					<div class='smallgrey'>Hits: 1,118</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/activity-resource/page-module'>Making pages for courses with the page module in Moodle</a>
					<div>Moodle 2.3 has a built in feature for adding content to the Course Sections. This tutorial will focus on the developing the Page Module included in the resource section.</div>
					<div class='smallgrey'>Hits: 1,210</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/activity-resource/external-url-module'>Placing an External URL using the Moodle URL module</a>
					<div>Another feature within Moodle 2.3 is the External URL module. Next is how to create an External link in the Course section with the URL module. </div>
					<div class='smallgrey'>Hits: 2,051</div>
				</td>
			</tr>
			</table>
</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yODEmaWQ9MjgxJnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="40dfb063ac0e6f5c1ac38f6b2dbd4738" value="1" />	</div>
	</form>
<!-- <br />
