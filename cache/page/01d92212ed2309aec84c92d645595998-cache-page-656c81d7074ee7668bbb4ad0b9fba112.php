<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:58838:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/movable-type/create-blog-movable-type/register-new-account" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-02-17T19:53:53-08:00" />
  <meta name="keywords" content="register new account Movable Type" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Need to register a new account in order for blog commenting? This Movable Type tutorial describes how to do just that." />
  <title>How to register for an account in Movable Type - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/movable-type/create-blog-movable-type/register-new-account" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:bd816cea915a195f9dca418deef616bb -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to register for an account in Movable Type									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>1,720</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Mar 11, 2013'><span style='color:#606060;'>Published:</span> Feb 17, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>When creating a blog, it is common to allow visitors to leave a comment on posts and pages. This fosters a community feeling and helps build content. This article will demonstrate how to create a new account as a visitor in order to be able to make comments on your <a href="http://www.inmotionhosting.com/support/edu/movable-type">Movable Type</a> blog site.</p>
<h2>Registering as a visitor in Movable Type</h2>
<ol class="article_list">
<li>Visit the movable type blog website. For example, our test website is set up at <em>mt.inmotiontesting.com/test_blog</em>
<div style="clear: both;">&nbsp;</div>
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mt/register-account/click-comment.png"><img style="margin: 0px 0px 15px 15px; max-width: 200px; float: right;"  alt="click comment no comment link" src="//cdn.inmotionhosting.com/support/images/stories/edu/mt/register-account/click-comment.png" /></a>From the main blog page, you should see at the blog entries. Find an entry you want to comment on and click on the <strong>Comments</strong> (or <strong>No Comments</strong>) link.
<div style="clear: both;">&nbsp;</div>
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mt/register-account/sign-in.png"><img style="margin: 0px 0px 15px 15px; max-width: 200px; float: right;"  alt="click the sign-in link" src="//cdn.inmotionhosting.com/support/images/stories/edu/mt/register-account/sign-in.png" /></a>This opens up the comment area below the post. You will see a link entitled <strong>Sign In</strong>. Click there to continue.
<div style="clear: both;">&nbsp;</div>
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mt/register-account/sign-up.png"><img style="margin: 0px 0px 15px 15px; max-width: 200px; float: right;"  alt="click the sign up link" src="//cdn.inmotionhosting.com/support/images/stories/edu/mt/register-account/sign-up.png" /></a>You are brought to the sign in page. At the bottom is a <strong>Sign Up</strong>link. Click that link to begin registration.
<div style="clear: both;">&nbsp;</div>
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mt/register-account/register.png"><img style="margin: 0px 0px 15px 15px; max-width: 200px; float: right;"  alt="registration information page" src="//cdn.inmotionhosting.com/support/images/stories/edu/mt/register-account/register.png" /></a>From this screen, enter your membership details. All fields except Website are required. Click the <strong>Register</strong>button to continue once you have entered all of your information.
<div style="clear: both;">&nbsp;</div>
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mt/register-account/confirmed.png"><img style="margin: 0px 0px 15px 15px; max-width: 200px; float: right;"  alt="registration confirmation screen" src="//cdn.inmotionhosting.com/support/images/stories/edu/mt/register-account/confirmed.png" /></a>You receive a screen explaining that your email will receive a confirmation message. Log into your email and click on the link in the message.
<div style="clear: both;">&nbsp;</div>
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mt/register-account/complete.png"><img style="margin: 0px 0px 15px 15px; max-width: 200px; float: right;"  alt="registration completed" src="//cdn.inmotionhosting.com/support/images/stories/edu/mt/register-account/complete.png" /></a>After clicking the link, you will be sent to a login screen with a confirmation message. From here you may log in and make your comment.
<div style="clear: both;">&nbsp;</div>
</li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 3: How to register for an account in Movable Type</div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/movable-type/create-blog-movable-type/register-new-account&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/movable-type/create-blog-movable-type/register-new-account'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zNDUmaWQ9MjI5MCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
