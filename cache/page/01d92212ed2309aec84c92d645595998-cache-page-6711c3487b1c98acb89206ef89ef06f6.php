<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50446:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/prestashop-16/find-db-name" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-05-08T21:48:32-07:00" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Learn how to find your database name for your PrestaShop 1.6 program." />
  <title>Finding your database name for PrestaShop 1.6 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/prestashop-16/find-db-name" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:fa9d0ca88d94a1b509049745054d3e36 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '92.145.140.236']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Finding your database name for PrestaShop 1.6									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>2,764</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Apr 4, 2014'><span style='color:#606060;'>Published:</span> May 8, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>For the most part, the work you need to do on your PrestaShop store is done via the Back Office. There are times, however, when you may need to access the database directly. This may be for research, or debugging, or perhaps performing a change that is not done within the Back Office at all. In any case, knowing which database to work in is important. For those with a single database on their account, this is simple. Many people, however, have multiple sites on their account and in some cases many different PrestaShop stores. Below is a guide on finding the database name for your PrestaShop 1.6 store.
</p>

<h2>How to find your database name for PrestaShop 1.6</h2>

<ol class="article_list">
  <li>Log into your cPanel admin interface.<div style="clear:both;"></div></li>
  <li>Locate the <em>Files</em> category and open the <strong>File Manager</strong> tool.<div style="clear:both;"></div></li>
  <li>Once inside the <em>File Manager<em>, navigate to the root folder for your PrestaShop store. For most people, the store will be in a folder with the same name as the website, such as <em>example.com</em>. However, if your store is for your <em>Primary Domain</em> on your account, the folder name will be <em>public_html</em>.<div style="clear:both;"></div></li>
  <li>Once in the root folder, look for the <em>config</em> folder and open it.<div style="clear:both;"></div></li>
  <li>From inside the <em>config</em> folder, edit the <strong>settings.inc.php</strong> folder.<div style="clear:both;"></div></li>
  <li>You can now see all the code in the file. Look for a line that is similar to the one below:
    <div class="code_block">define('_DB_NAME_', 'userna5_pshopdb');</div>
    <div style="clear:both;"></div></li>
  <li>Now that you have found the database name, be sure to write it down or copy it into a safe place. This allows you to ue a tool such as phpMyAdmin to make any changes necessary.<div style="clear:both;"></div></li>
</ol> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/prestashop-16/find-db-name&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/prestashop-16/find-db-name'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00OTMmaWQ9MzE5MiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="363f56dda369272d18a834bb3a8a8c42" value="1" />	</div>
	</form>
<!-- <br />
