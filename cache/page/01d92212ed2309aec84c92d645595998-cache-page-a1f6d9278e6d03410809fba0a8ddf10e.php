<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:56434:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/website-design/meta-tags-explained/creating-a-timed-re-direct-webpage" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-05-09T04:47:13-07:00" />
  <meta name="keywords" content="meta refresh redirect html 404 page custom jump" />
  <meta name="author" content="Arnel Custodio" />
  <meta name="description" content="404 pages can be created to jump to another page after a period of time.  The following article explains how to create this page using the meta refresh tag." />
  <title>Creating a Timed 404 Re-direct Webpage - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/website-design/meta-tags-explained/creating-a-timed-re-direct-webpage" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:06a4ca8abf658519ab042800d50cb346 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Creating a Timed 404 Re-direct Webpage									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>1,032</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: May 9, 2013'><span style='color:#606060;'>Published:</span> May 9, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Sometimes you may find it necessary to create or modify a web page so that it displays for a period of time, then jumps to another page.  In HTML, the code for this is somtimes called a meta refresh redirection.  The page will display for the period of time that you designate and then jump to the URL that you have indicated in the code.  The following article explains how to make this change using a 404 error page as an example of an HTML page that can use this type of redirect. </p>

<h2>Using the META refresh tag for a custom 404 error redirect page</h2>

<ol class="article_list">
<li><a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">Login to the cPanel.</a><div style="clear:both;"></div></li>
   <li>Make a custom 404 page. You can use the <a href="http://support.inmotionhosting.com/userguides/cpflash_x3/cpanel_x3_errorpages.swf" target="new">cPanel tool</a> to do it, or you can manually create the page.  Here are the <a href="http://www.inmotionhosting.com/support/website/how-to/creating-a-custom-404-error-page" target="new">step-by-step instructions on how to create a custom 404 page</a>.<div style="clear:both;"></div></li>
<li>Once you have created the the custom 404 error page, edit the file and add the following code:
  <div class="code_block"> &lt;meta http-equiv="refresh" content="10;url=http://domain_name.com/"&gt;</div>
  <br />
  <p><em>"content=10"</em> - indicates the time (in seconds) until the page changes to the URL. </p>
  <p><em>";url=http://domain_name.com"></em> - this portion of the code shows the URL that page will redirect after the designated time has expired. </p>
      
  <div style="clear:both;"></div></li>
  <li><strong>SAVE</strong> the page with the code that you have added.<div style="clear:both;"></div></li>
</ol>
<p><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/custom404/404-redirect-page-sample.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="200" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/custom404/404-redirect-page-sample.png" alt="Sample of a possible 404 redirect page" align="right" ></a>This completes the tutorial for creating a timed 404 redirect page.  Adjust the time as necessary and make sure to add a link in case the re-direct does not occur correctly. Test your custom 404 page by creating a bad link by misspelling a page or subdomain under the main domain for your website. </p>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/website-design/meta-tags-explained'>104: Meta Tags Explained</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 1: Creating a Timed 404 Re-direct Webpage</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 2: <a href='/support/edu/website-design/meta-tags-explained/what-are-meta-tags'>What are Meta Tags?</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/website-design/meta-tags-explained/creating-a-timed-re-direct-webpage&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/website-design/meta-tags-explained/creating-a-timed-re-direct-webpage'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP3RzcmM9cnNiZWR1Jm9wdGlvbj1jb21fY29udGVudCZjYXRpZD0xMjEmaWQ9MjY5NyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="eb205b6b7c3cb700b2cbb982077d104d" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/website-design/meta-tags-explained?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Meta Tags Explained</h3></a>
		<table>  <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/website-design/meta-tags-explained/creating-a-timed-re-direct-webpage?tsrc=rsbedu'>Creating a Timed 404 Re-direct Webpage</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/website-design/meta-tags-explained/what-are-meta-tags?tsrc=rsbedu'>What are Meta Tags?</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/website-design/meta-tags-explained/adding-a-meta-description-tag?tsrc=rsbedu'>Adding a Meta Description Tag</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/website-design/meta-tags-explained/adding-meta-keywords-tag?tsrc=rsbedu'>Adding a Meta Keywords Tag</a></td>
                </tr>
          	</table>
