<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:53742:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/domain-names/how-can-i-tell-when-my-dns-was-last-updated" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, and thanks for your question. Sorry for the issues you've been experiencing and that the article you read didn't spell out exactly how to investi..." />
  <title>How can I tell when my dns was last updated? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/domain-names/how-can-i-tell-when-my-dns-was-last-updated" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:28f63787229ff5e3963957448c8c2c02 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-22']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '83.218.8.242']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>How can I tell when my dns was last updated?</h1>
		<div style='margin-bottom:20px; margin-top:10px; clear:both; color:#6e6e6e;'>Category: <a href='/support/community-support/domain-names'>Domain Names</a></div>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-10-04 1:25 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>5,065</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I'm going crazy! My site is down, and I'm looking at your article here:<br />
http://www.inmotionhosting.com/support/website/website-unavailable/why-is-my-website-down<br />
... but it's like a dead end. You tell me what to do, but not how. Ug...<br />
<br />
Ok, enough venting.<br />
<br />
The article talks about dns and propagation. How do I find out the last time my dns was changed? Obviously if I changed it, I would remember lol. But, I work with a team of about 5 designers / developers, and I don't always know what it is they're up to! (yeah, what a pain that is! lol)<br />
<br />
Again, how can I tell when my dns was last updated?</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_4065' id='upvote_answer_4065' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='4065' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_4065').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_4065' id='downvote_answer_4065' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='4065' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_4065').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>9,968 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2013-10-04 3:11 pm EST
                		        </div>
					
		                </div>

				Hello, and thanks for your question.<br />
<br />
Sorry for the issues you've been experiencing and that the article you read didn't spell out exactly how to investigate the problems you're seeing.<br />
<br />
If you can let us know the domain you're having issues with, we'd be glad to take a look for you.<br />
<br />
You can take a look at the last time your website's DNS was updated using an online DNS lookup tool, or by using the built-in &lt;strong&gt;nslookup&lt;/strong&gt; command on Windows.<br />
<br />
If you were using Windows you could simply:<br />
<br />
&lt;ol class=&quot;article_list&quot;&gt;<br />
&lt;li&gt;Click on the &lt;strong&gt;Start&lt;/strong&gt; button&lt;/li&gt;<br />
&lt;li&gt;In the &lt;strong&gt;Search Programs and Files&lt;/strong&gt; box type &lt;strong&gt;cmd&lt;/strong&gt;&lt;/li&gt;<br />
&lt;li&gt;Once the command prompt window is opened, type in the following command:<br />
<br />
&lt;pre class=&quot;code_block&quot; style=&quot;width: 500px; white-space: normal; margin-bottom: -30px;&quot;&gt;nslookup -q=SOA inmotionhosting.com&lt;/pre&gt; <br />
<br />
Now you'll get back the &lt;strong&gt;SOA&lt;/strong&gt; record for the domain you queried, in this case I used &lt;strong&gt;inmotionhosting.com&lt;/strong&gt;.Then it will return the &lt;strong style=&quot;color: red;&quot;&gt;serial&lt;/strong&gt; entry which would look like this:<br />
<br />
&lt;pre class=&quot;code_block&quot; style=&quot;width: 500px; white-space: normal; margin-bottom: -30px;&quot;&gt;Non-authoritative answer:<br />
inmotionhosting.com<br />
        primary name server = ns.inmotionhosting.com<br />
        responsible mail addr = webserver.inmotionhosting.com<br />
        &lt;strong style=&quot;color: red;&quot;&gt;serial  = 2013100403&lt;/strong&gt;<br />
        refresh = 28800 (8 hours)<br />
        retry   = 600 (10 mins)<br />
        expire  = 3600000 (41 days 16 hours)<br />
        default TTL = 86400 (1 day)&lt;/pre&gt;<br />
&lt;/li&gt;<br />
&lt;/ol&gt;<br />
<br />
A DNS &lt;strong&gt;SOA serial&lt;/strong&gt; can be read as the time-stamp when the DNS records were last seen to be updated. In this case our:<br />
<br />
&lt;pre class=&quot;code_block&quot; style=&quot;width: 500px; white-space: normal; margin-bottom: -30px;&quot;&gt;2013100403&lt;/pre&gt;<br />
<br />
Breaks down to:<br />
<br />
&lt;pre class=&quot;code_block&quot; style=&quot;width: 500px; white-space: normal; margin-bottom: -30px;&quot;&gt;2013/10/04 - 03&lt;/pre&gt;<br />
<br />
So our latest DNS record update was actually today October 4th, 2013, and it was the 3rd update today indicated by the &lt;strong&gt;03&lt;/strong&gt; at the end of the time-stamp.<br />
<br />
Now the only other important thing to keep in mind is if you recently changed your name servers. As this can take up to 48 hours to fully propagate, and your computer might be using a different name server than you updated to. <br />
<br />
You can also specify a name server to query with the same &lt;strong&gt;nslookup&lt;/strong&gt; command like so:<br />
<br />
&lt;pre class=&quot;code_block&quot; style=&quot;width: 500px; white-space: normal; margin-bottom: -30px;&quot;&gt;nslookup inmotionhosting.com &lt;strong style=&quot;color: red;&quot;&gt;ns.inmotionhosting.com&lt;/strong&gt;&lt;/pre&gt;<br />
<br />
So in this case you can see that I'm directly asking our name server &lt;strong style=&quot;color: red;&quot;&gt;ns.inmotionhosting.com&lt;/strong&gt; for the DNS records for our domain. If you had your domain previously using another name server and now you can't get to the website, you should see if you get a different response for:<br />
<br />
&lt;pre class=&quot;code_block&quot; style=&quot;width: 500px; white-space: normal; margin-bottom: -30px;&quot;&gt;nslookup example.com &lt;strong style=&quot;color: red;&quot;&gt;ns.inmotionhosting.com&lt;/strong&gt;&lt;/pre&gt;<br />
<br />
Or:<br />
<br />
&lt;pre class=&quot;code_block&quot; style=&quot;width: 500px; white-space: normal; margin-bottom: -30px;&quot;&gt;nslookup example.com&lt;/pre&gt;<br />
<br />
If you're getting back a different IP address, then that means your computer hasn't fully propagated to pull from our name servers for your domain.<br />
<br />
I hope that helps clear things up a bit, if you still had any further questions at all please let us know!<br />
<br />
- Jacob
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_4065').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_4065' id='form_comment_on_answer_4065' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
                                ...
                                <h3>Related Articles</h3><a target='_blank' href='http://inmotionhosting.com/support/domain-validation-requirement-changes'>Domain Registration Validation Requirement Changes</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/no-confirmation-email-transfer-melbourne'>What to do if you didn't get the confirmation email from Melbourne IT for a domain transfer</a><br/><br />
		</div>
