<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:78117:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-3/banners/banner-code" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-11-06T15:52:02-08:00" />
  <meta name="keywords" content="joomla 3.0 flash html code banner" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="Not all banners are images. In this tutorial, we'll explain how to use HTML in a Joomla 3.0 banner to show a flash banner." />
  <title>Using HTML to show a swf flash banner in Joomla 3.1 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-3/banners/banner-code" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:67cc69cc4954ee9a3d0923bb615e203f -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Using HTML to show a swf flash banner in Joomla 3.1									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>16,846</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Nov 1, 2012'><span style='color:#606060;'>Published:</span> Nov 6, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In a previous tutorial, we showed you <a href="/support/edu/joomla-3/banners/create-banner">how to create a Joomla 3.0 banner using an image</a>. Not all banners are images however, some banners may be flash banners (.swf files) for example. To show a flash banner, you will need to enter HTML code when creating the banner (instead of defining an image as the banner).</p>
<h2>Steps for using HTML as a banner in Joomla 3.0:</h2>
<p>In the following steps we'll show you how to create a banner using HTML instead of an image. If your banner is not an image, most likely it will be a flash banner, but it could be any HTML that you'd like. These steps assume that you already have the HTML ready that you want to use.</p>
<ol class="article_list">
<li><a href="/support/edu/joomla-3/getting-started/login-dashboard">Log into your Joomla 3.0 admin dashboard</a></li>
<li>In the top menu, click <strong>Components</strong> and then click <strong>Banners</strong></li>
<li>Click <strong>New</strong> in the top left of the page</li>
<li>Enter the details of your new banner and then click <strong>Save</strong> in the top left of the page. These are the details we entered:<br />
<table class="article_table">
<tbody>
<tr><th>Name</th>
<td>Enter a name for your banner. This name will not appear on your website, but will instead show in your joomla dashboard, and help you manage this particular banner.<br /><br />We entered <em>My Flash Banner</em></td>
</tr>
<tr><th>Category</th>
<td>Select a category for the banner. If you plan to use many banners on your site, you may find it to be a good idea to create categories to help organize your banners.<br /><br />We haven't created an categories yet, so we left this option as <em>Uncategorised</em></td>
</tr>
<tr><th>Type</th>
<td>Select <strong>Custom</strong> as the banner type.</td>
</tr>
<tr><th>Custom Code</th>
<td>After setting <em>Custom</em> as the banner <em>Type</em>, you will see a <strong>Custom Code </strong>textbox appear. This is where you will need to enter the HTML that is required for your banner. We entered the following code:
<pre class="code_block">&lt;div style="width:150px;height:100px;"&gt;<br />   &lt;object type="application/x-shockwave-flash" data="http://domain.com/banner.swf" width="150" height="100"&gt;<br />      &lt;param name="movie" value="http://domain.com/banner.swf"&gt;<br />      &lt;param name="wmode" value="opaque"&gt; &lt;param name="flashvars" value="direct_link=true"&gt;<br />      &lt;embed src="http://domain.com/banner.swf" width="150" height="100" wmode="opaque" flashvars="direct_link=true" /&gt;<br />   &lt;/object&gt;<br />&lt;/div&gt;</pre>
</td>
</tr>
</tbody>
</table>
<p>That's all there is to it! After you've <a href="/support/edu/joomla-3/banners/show-banner">created a banner module</a> to show this banner, you're flash / HTML banner will now show on your Joomla 3.0 website.</p>
</li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 2: Using HTML to show a swf flash banner in Joomla 3.1</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 1: <a href='/support/edu/joomla-3/banners/create-banner'>How to create a new image banner in Joomla 3.1</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 3: <a href='/support/edu/joomla-3/banners/show-banner'>How to show a banner in Joomla 3.1</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-3/banners/banner-code&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-3/banners/banner-code'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yOTImaWQ9MTk1NiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//graph.facebook.com/estar69/picture?type=normal' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='/support/community-support/users/estar69'>estar69</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-01-20 10:49 am</div>
				                <div>This works perfectly, however, the hyperlink does not want to work, so I cant track the links sent from a flash file??</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8538);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-01-20 11:02 am</div>
				                <div>Hello estar69,<br />
Could you clarify what you are referring to?  Any links within the flash object will be something defined within the flash itself and would not be modified within your website code.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8539);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-01-20 11:05 am</div>
				                <div>Yah I am aware of that, if you have a look at this site http://eventstuff.co.za/ at the flashbanner next to the logo, you will see that I cant get the Joomla banner component to link to the website this banner is intended to go</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8540);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-01-20 11:10 am</div>
				                <div>To clarify, are you stating that the correct banner is not displaying, or is this supposed to be a link to another location when clicked?</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8541);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-01-20 11:13 am</div>
				                <div>The correct banner is displaying, and yes it is supposed to link to the location you specify in the banner component so you can view your tracking stats for click throughs, as it functions with a jpeg image</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8542);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-01-20 11:18 am</div>
				                <div>A change like this would be something that needs to be made to the code within the flash object itself.  Unfortunately, this is not something that would be done within Joomla or within any code for the site itself.  I was, however, able to locate a 3rd party article on how you can modify the flash object to link to a remote location within Adobe Flash:<br />
<br />
&lt;a href=&quot;http://www.foundation-flash.com/tutorials/as3urlbutton/&quot;&gt;URL Buttons in AS3&lt;/a&gt;</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8543);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-01-20 11:22 am</div>
				                <div>Thanks for your help, this can be achieved using flex banner component, just would have preferred it to be handled by Joomla Banner Component</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8544);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-13586'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/5d813ee37a8b9483e65dbade9a78ce98?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/5d813ee37a8b9483e65dbade9a78ce98'>Filipe Torres</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-03 7:00 pm</div>
				                <div>The code posted above doesn't alow banner component to count clicks of the flash banner, only banner impressions.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13586);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-04 1:42 am</div>
				                <div><p>Hi,</p>
<p>I found a solution for Joomla 1.5 posted at&nbsp;Joomla Forum that can be adapted to Joomla 3:&nbsp;http://forum.joomla.org/viewtopic.php?t=418575</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13591);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
