<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:45474:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/billing" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="keywords" content="features billing system Account Management Panel" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="This article will guide you to the main features of the billing system in the Account Management Panel." />
  <title>Billing | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/billing" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:fadb4c698a445e7e3d53199e68919ae5 -->
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Billing</span></li>			</ul>
		</div>
	</div>
</div>
...
<div style="float:left;margin-bottom:15px;width:300px;height:230px;" class="white_box">
  <h2 style="margin-top:0px;">Login</h2>
  <p>In order for you to access your billing information, you will need to <a href="https://secure1.inmotionhosting.com/index/login" target="_blank">log into your Account Management Panel</a>. If you need help logging in please see the following links.</p>
<ul>
<li><a href="/support/website/amp/how-to-log-into-amp">How to login</a></li>
<li><a href="/support/website/amp/i-forgot-my-account-management-panel-amp-password">Forgot your password?</a></li>
</ul>
</div>


<div style="float:right;margin-bottom:15px;width:300px;height:230px;" class="white_box">
  <h2 style="margin-top:0px;">Purchase Products</h2>
  <p>You can purchase SSL certificates, domains names and request a CSR in your AMP panel.</p>
  <ul>
    <li><a href="/support/domain-names/registrations-and-transfers/registering-a-new-domain-name" target="_blank">Registering a New Domain Name</a></li>
    <li><a href="/support/website/ssl/install-third-party-ssl" target="_blank">Installing a Third Party SSL</a></li>
    <li><a href="/support/website/ssl/how-do-i-obtain-an-ssl-certificate" target="_blank">How do I obtain an SSL certificate?</a></li>
    <li><a href="/support/website/how-to/purchase-dedicated-ip-address-amp" target="_blank">How to obtain additional IP addresses</a></li>
    <li><a href="/support/email/mailing-lists/email-limit-exception-request-amp" target="_blank">Sending an Email Limit Exception Request in AMP</a></li>
  </ul>
</div>

<br style="clear:both;" />
  
<div style="float:left;margin-bottom:15px;margin-right: 15px;width:300px;height:255px;" class="white_box">
  <h2 style="margin-top:0px;">Updating and Viewing billing Information</h2>
  <p>See the links below to update you billing information.</p>           
  <ul>
  <li><a href="/support/website/billing/add-change-credit-card-amp" target="_blank">How to Add or Change a Credit Card in AMP</a></li>
  <li><a href="/support/website/billing/update-billing-contact-information" target="_blank">How to Update your Billing and Contact Information</a></li>
  <li><a href="/support/website/billing/viewing-renewal-dates-in-the-account-management-panel" target="_blank">Viewing Renewal Dates in the Account Management Panel</a></li>
  </ul>
</div>



<div style="float:right;margin-bottom:15px;width:300px;height:255px;" class="white_box">
  <h2 style="margin-top:0px;">Billing renewal and reminder</h2>
  <p>Print invoices, set payment reminders, and view your renewal dates in AMP.</p>
<ul>
  <li><a href="/support/website/billing/renew-current-plan-amp" target="_blank">Renew your Current Plan in AMP</a></li>
  <li><a href="/support/website/billing/print-invoice-amp" target="_blank">How to Print a Billing Invoice in AMP</a></li>
  <li><a href="/support/website/billing/set-billing-reminder-amp" target="_blank">How to Set a Billing Reminder in AMP</a></li>
  <li><a href="/support/website/billing/viewing-renewal-dates-in-the-account-management-panel" target="_blank">Viewing Renewal Dates in the Account Management Panel</a></li>
  <li><a href="/support/website/how-to/cancel-hosting" target="_blank">How can I cancel my hosting account?</a></li>
</ul>
</div>
<br style="clear:both;" />
<form action="http://www.inmotionhosting.com/support/billing" method="post" name="adminForm" id="adminForm" class="form-inline">
  ...
  <table class='article_list'>
          ...
          <tr>
                                <td style='padding-right:20px;'><a href='/support/billing/identifying-phishing-scams'>Avoiding Phishing Scams</a></td>
                                <td>872</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/billing/changing-contact-info'>Updating WHOIS information in AMP</a></td>
                                <td>550</td>
                        </tr>
                  </table>
	</form>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zODYmaWQ9Mzg2JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
