<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:65477:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.net/support/edu/prestashop-15/pshop15-price-rules/change-partial-use" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-08-13T16:20:13-07:00" />
  <meta name="keywords" content="change partial use PrestaShop 1.5 setting" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Learn how to change the Partial Use setting in PrestaShop 1.5 as well as the effects of the change on the customer." />
  <title>Changing the  partial use of a coupon voucher in PrestaShop 1.5 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/prestashop-15/pshop15-price-rules/change-partial-use" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:ec723e7219da622d1454eb939f32b4cc -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '157.55.39.223']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Changing the  partial use of a coupon voucher in PrestaShop 1.5									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>1,909</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Aug 13, 2012'><span style='color:#606060;'>Published:</span> Aug 13, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>When you create vouchers, or cart rules for your customers, you have the ability to assign them to individual customers. Often these are used to give 'store credit' to customers. If you assign a customer a specific value (for example, $20) and they purchase something of lesser value, what do you do with the remainder? The answer lies in the 'Partial Use' setting. If the cart rule is set to allow partial use, a second voucher will automatically be created for the remaining value for that customer. If the partial use is disabled, then the customer will lose that remainder. Setting the partial use setting is quick and easy as shown in the instructions below.<strong></strong></p>
<p><strong>Setting the partial use setting of a coupon voucher in PrestaShop 1.5</strong></p>
...
<li>You are now on the <strong>Cart Rules</strong> screen. Locate the rule you want to edit and click on the <strong>Edit</strong> icon on the right side of that specific row. The icon looks like a pencil and paper.     <br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Price_Rules/Cart_Rules/cart-rule-edit.png"><img  alt="cart-rule-edit" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Price_Rules/Cart_Rules/cart-rule-edit.png" /></a> </li>
<li>You are now in the <strong>Cart Rules</strong> edit screen. Look for the field labeled <strong>Partial Use</strong>. By default, the partial use setting is enabled, which will create an additional coupon, or cart rule for the remainder if the purchase is of lesser value than the voucher itself. To disable the setting, click the radio button with the red <strong>X</strong>.     <br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Price_Rules/Cart_Rules/Partial_Use/partial-use.png"><img  alt="partial-use" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Price_Rules/Cart_Rules/Partial_Use/partial-use.png" /></a></li>
<li>Once your setting is selected, click on the green <strong>Save</strong> button in the upper right corner. You will be returned to the Cart Rules list page. The new setting will now take place when a cart rule is used.</li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 3: Changing the  partial use of a coupon voucher in PrestaShop 1.5</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 2: <a href='/support/edu/prestashop-15/pshop15-price-rules/set-coupon-code'>How to set a coupon code in PrestaShop 1.5</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 4: <a href='/support/edu/prestashop-15/pshop15-price-rules/set-cart-rule-priority'>Setting the priority for cart rules in PrestaShop 1.5</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.net/support/edu/prestashop-15/pshop15-price-rules/change-partial-use&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.net/support/edu/prestashop-15/pshop15-price-rules/change-partial-use'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP3RzcmM9cnNiZWR1Jm9wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNTImaWQ9MTU3MyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="8f906ab1ddedc9bfa8f6270229fb818f" value="1" />	</div>
	</form>
<!-- <br />
