<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:66230:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-25/contact-form/change-to-address" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-01-21T19:03:20-08:00" />
  <meta name="keywords" content="joomla 2.5 aiContactSafe change to recipient address" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="You can change the recipient address for aiContactForms by changing the Email Address option in each profile." />
  <title>Changing the TO address in an aiContactSafe Joomla 2.5 contact form - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-25/contact-form/change-to-address" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:154f548f049717ed420b6226f307d1f1 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '123.252.180.179']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Changing the TO address in an aiContactSafe Joomla 2.5 contact form									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>7,451</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jun 26, 2012'><span style='color:#606060;'>Published:</span> Jan 21, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<p class="alert">Joomla 2.5 has reached its end of life as for 12/31/2014. Please be advised this may be a security risk to your website. You can view more information about the end of life <a href="https://docs.joomla.org/Joomla!_CMS_versions">here</a>.</p><br /><h2>Where are emails sent to by default?</h2>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/aiContactSafe/from-email-global-configuration.gif"><img  alt="from-email-global-configuration" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/aiContactSafe/from-email-global-configuration.gif" style="float: right; margin: 0px 0px 15px 15px;" /></a>By default, emails sent from aiContactSafe forms will be delivered to the <strong>From email</strong> set in the Joomla 2.5 Server Global Configuration.</p>
<p>In this <a href="/support/edu/joomla-25/contact-form">aiContactSafe tutorial</a>, we will show you how to change the recipient address of your emails.</p>
<div style="clear: both;"></div>
<h2>To update the email address that receives aiContactSafe submissions:</h2>
<ol class="article_list">
<li>
<h3>Log into your Joomla Admin</h3>
<p>To make any changes to aiContactSave, you must first <a href="/support/edu/joomla-25/getting-started/how-to-log-into-dashboard">log into your Joomla 2.5 Dashboard</a></p>
</li>
<li>
<h3>Click Components » aiContactSafe » Profiles</h3>
<p>In the top menu, hover over <strong>Components</strong>. Then hover over <strong>aiContactSafe</strong> and finally click <strong>Profiles</strong></p>
</li>
<li>
<h3>Select your Profile</h3>
<p>In the list of profiles, click the profile you are working with. If you are following along with our tutorial, we click on the <strong>Default form</strong>.</p>
</li>
<li>
<h3>Update the Email address</h3>
<p>In the list of <strong>Profile</strong> settings, find the field labeled <strong>Email address</strong>. Enter the email address you would like to receive the aiContactSafe emails.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/aiContactSafe/change-recipient-address.gif"><img  alt="change-recipient-address" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/aiContactSafe/change-recipient-address.gif" /></a></p>
</li>
<li>
<h3>Save Changes and Test</h3>
<p>To save your changes, click the <strong>Save</strong> button in the top right menu. Be sure to test your contact form and ensure the message is being sent to the new email address.</p>
</li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/joomla-25/contact-form'>214: Joomla 2.5 Contact Form</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 3: Changing the TO address in an aiContactSafe Joomla 2.5 contact form</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 2: <a href='/support/edu/joomla-25/contact-form/create-contact-us'>Create a Contact Us page in Joomla 2.5 using aiContactSafe</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 4: <a href='/support/edu/joomla-25/contact-form/change-contact-information'>How to change contact information shown within aiContactSafe forms</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-25/contact-form/change-to-address&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-25/contact-form/change-to-address'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yMTYmaWQ9MTUxNSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="0570853cd8d49c12abe328dcc4eee3a5" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/joomla-25/contact-form?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Joomla 2.5 Contact Form</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/joomla-25/contact-form/install-aicontactsafe?tsrc=rsbedu'>How to install aiContactSafe in Joomla 2.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/joomla-25/contact-form/create-contact-us?tsrc=rsbedu'>Create a Contact Us page in Joomla 2.5 using aiContactSafe</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/joomla-25/contact-form/change-to-address?tsrc=rsbedu'>Changing the TO address in an aiContactSafe Joomla 2.5 contact form</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/joomla-25/contact-form/change-contact-information?tsrc=rsbedu'>How to change contact information shown within aiContactSafe forms</a></td>
                </tr>
          <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/joomla-25/contact-form/add-new-field?tsrc=rsbedu'>How to add a new field to aiContactSafe forms</a></td>
                </tr>
          <tr >
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/joomla-25/contact-form/rearrange-fields?tsrc=rsbedu'>How to change the order of fields in aiContactSafe forms</a></td>
                </tr>
          <tr >
                        <td valign='top'>7.</td>
                        <td><a href='/support/edu/joomla-25/contact-form/change-field-width?tsrc=rsbedu'>How to change the width of fields in aiContactSafe forms</a></td>
                </tr>
          	</table>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/3d31b4deedace9449fdc589860a12943?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/3d31b4deedace9449fdc589860a12943'>Diana </a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-05-15 5:25 pm</div>
				                <div><p>I followed the tutorial but the messages are not being send to the email address I put. How can I fix that?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23441);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-05-18 1:21 pm</div>
				                <div>Hello Diana,<br />
<br />
What specific version of Joomla are you using? Are you getting any type of error message when the form attempts to send?<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23493);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-05-19 4:30 pm</div>
				                <div><p>Thanks for answering. I'm using Joomla 2.5 and there's no error message but I could finally fix the problem, it wastn't the component's configuration but in server mail configuration.&nbsp;</p>
<p>Thanks for the help anyway :)</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23547);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
