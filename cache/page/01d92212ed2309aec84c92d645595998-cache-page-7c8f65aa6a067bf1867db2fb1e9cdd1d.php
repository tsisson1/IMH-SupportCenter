<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:107938:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/email/send-email-from-a-page/how-to-set-up-formmail" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-05-02T16:00:21-07:00" />
  <meta name="keywords" content="formmail mail from a webpage email thank you thankyou" />
  ...
  <link href="http://www.inmotionhosting.com/support/email/send-email-from-a-page/how-to-set-up-formmail" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:4e138b44a665dbc56dd7ce10938edd7b -->
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>37,296</span></div>
							...
							<div style='clear:both;'></div>
								...
								<p>Here is a walk through on setting up the NMS FormMail script.</p>
<p>See Also:&nbsp;<a style="outline-style: none; outline-width: initial; outline-color: initial; color: #306090;" target="_blank" href="http://forum.inmotionhosting.com/viewtopic.php?p=6007">Preventing SPAM in FormMail</a></p>
<p>You will need to download the&nbsp;<a style="outline-style: none; outline-width: initial; outline-color: initial; color: #306090;" target="_blank" href="http://nms-cgi.sourceforge.net/scripts.shtml">NMS FormMail</a> script. Make sure to download the "<strong>compat</strong>" version.</p>

<h3>Steps for setting up FormMail</h3>
<ol class="article_list">
<li>Un-compress the downloaded file and upload the FormMail.pl script to your cgi-bin (you will only need to upload the FormMail.pl file, all other files are documentation).</li>
<li>The next step is to modify the FormMail.pl that is inside your cgi-bin. There are only two lines that you will need to modify. The first is the&nbsp;<span style="font-weight: bold;">@referers</span> line. Replace everything inside of the parentheses with your domain, once without the www and then a single space and again with the&nbsp;<a style="outline-style: none; outline-width: initial; outline-color: initial; color: #306090;" target="_blank" href="http://www./">www.</a> You will need to do this for each domain that you will be sending from. Remember, only one space between each url.</li>
<li>This is where you input any email addresses that the forms will send to. Again, only one space between multiple email addresses. Also, make sure you remove '<strong>localhost'</strong> from both the <strong>@referers</strong> and the <strong>@allow_mail_to lines</strong>.</li>
<li>Now you can save the FormMail and proceed to modifying your forms.</li>
<li>First, point the action of the FORM tag to the FormMail.pl script inside the cgi-bin:
<p><strong>Pointing the the contact form to the FormMail.pl</strong></p>
<p>The following tag is necessary for the form to process the values in the form. Make sure the action points to the correct location on your server. The following is an example.</p>
<p class="code_block">&lt;form action="http://www.example.com/cgi-bin/FormMail.pl" method="post" &gt;</p>
</li>
<li>Next, inside of each of your forms you will need to include a few hidden input tags. Copy the code in the text box and paste it into your Contact form. They are detailed below:
  <p><strong>Add the recipient(s) of the email</strong></p>
<p>This tag will configure the form to send to a specific email or email addresses.</p>
<p class="code_block">&lt;input type="hidden" name="recipient" value="you@example.com,me@example.com" / &gt;</p>
<p><strong><span class="postbody">Create the subject of the email</span></strong></p>
<p><span class="postbody">This tag tells the form which email address to send the form to. Just make sure that this email is one of the addresses in your <strong>@allow_mail_to field </strong></span></p>
<p class="code_block">&lt;input type="hidden" name="subject" value="From the feedback form" / &gt;</p>
<p><strong>Redirecting the page to your own "Thank You" page</strong></p>
<p>This is a optional tag you can input into your form to redirect your form to your own page.</p>
<p class="code_block">&lt;input type="hidden" name="redirect" value="http://www.example.com/thankyou.html" / &gt;</p>
...
<p class="alert"><strong>Important! </strong>One last thing that must be performed in order for the FormMail to work is that you must <strong>set the <a target="_blank" title=" Changing File Permissions" href="/support/website/how-to/change-file-permissions">permissions </a>on the FormMail.pl to 755</strong>. This can be done either inside our control panel from the file manager or from an<strong> FTP client like SmartFTP</strong> or <strong>WS_FTP</strong>.</p>
</li>
</ol>
<p>If you are using the file manger you will want to browse to the cgi-bin by clicking on the folder icons for<strong> public_html &gt; cgi-bin</strong>. Once inside of the cgi-bin click on the text title for FormMail.pl and take notice of the text links that appear in the upper right hand corner of the screen. One of them is Change Permissions. Click this and click all the check boxes for Execute. This will change the numbers at the bottom to 755. Click Change, and your all done.</p>
<p>If you are using an FTP client you will want to browse to the cgi-bin. Then right click on the FormMail.pl and look for an option called CHMOD. This will open a dialog box where you can make the same changes as in our file manager. Make sure execute is turned on for all types of users and that the numbers have changed to 755.</p>
<p>If you have any questions on how to set this up please feel free to send an email to<a href="mailto:support@inmotionhosting.com"> support@inmotionhosting.com</a>.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/email/send-email-from-a-page/how-to-set-up-formmail&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/email/send-email-from-a-page/how-to-set-up-formmail'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00OCZpZD02Nzcmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/email/how-do-i-set-up-cgiemail?tsrc=rsbraq'>How to set up cgiemail?</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/how-to/formmailpl-will-not-send-own-made-thank-you-page?tsrc=rsbraq'>FormMail.pl will not send own made thank you page</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						...
						<div><a style='font-size:16px;' href='/support/community-support/users/Mikexzhou'>Mikexzhou</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2012-10-16 1:32 pm</div>
				                <div>Do you have any instruction to setup formmail.pl to support UTF-8? (Asia characters<br />
<br />
Thanks.<br />
<br />
Mike Zhou</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(7055);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2012-10-16 1:58 pm</div>
				                <div>Hello Mikexzhou,<br />
<br />
Thank you for your question regarding using UTF-8 with formmail.<br />
<br />
You can update this setting by editing the the line of code in FormMail.pl file pertaining to:<br />
$charset = 'iso-8859-1';<br />
<br />
To update it, change 'iso-8859-1' to:<br />
'utf-8'<br />
<br />
...
<br />
-John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(7056);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-8535'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//graph.facebook.com/el.tomasso/picture?type=normal' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='/support/community-support/users/Tomek1979'>Tomek1979</a></div>
						<div></div>
						<div></div>
						<div>3 <a href='/support/team/points' target='_blank'>Points</a></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-01-17 1:36 pm</div>
				                <div>Hello,<br />
It's not working in my case. Everything is working smoothly, I can send e-mails but utf-8 encoding doesn't work. I've changed the following (no result):<br />
$charset           = 'utf-8';<br />
<br />
=head1 SYNOPSIS<br />
  my $cs = CGI::NMS::Charset-&gt;new('utf-8');<br />
  $self-&gt;{CFG} = {<br />
<br />
    DEBUGGING           =&gt; 0,<br />
    emulate_matts_code  =&gt; 0,<br />
    secure              =&gt; 1,<br />
    locale              =&gt; '',<br />
    charset             =&gt; 'utf-8',<br />
Thanks<br />
Tom</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8535);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-01-17 7:55 pm</div>
				                <div>&lt;div style=&quot;background-color: #FFF; padding-left: 10px;&quot;&gt;Hello Tom,<br />
<br />
If you're trying to use &lt;strong&gt;utf-8&lt;/strong&gt; with &lt;strong&gt;FormMail.pl&lt;/strong&gt;, the only thing you need to change in the &lt;strong&gt;FormMail.pl&lt;/strong&gt; script is just the following line:<br />
<br />
&lt;pre class=&quot;code_block&quot; style=&quot;width: 500px; white-space: normal; margin-bottom: -30px;&quot;&gt;$charset = 'utf-8';&lt;/pre&gt; <br />
<br />
In your HTML form itself, you need to specify the &lt;strong&gt;charset&lt;/strong&gt; to also be &lt;strong&gt;UTF-8&lt;/strong&gt; so that when a web-browser loads the page it already knows that &lt;strong&gt;charset&lt;/strong&gt; should be used for any data submitted from the page.<br />
<br />
Just stick this bit of code between your &lt;strong&gt;&amp;lt;head&amp;gt;&lt;/strong&gt; and &lt;strong&gt;&amp;lt;/head&amp;gt;&lt;/strong&gt; tags:<br />
<br />
&lt;pre class=&quot;code_block&quot; style=&quot;width: 500px; white-space: normal; margin-bottom: -30px;&quot;&gt;&amp;lt;meta http-equiv=&quot;Content-Type&quot; content=&quot;text/html; charset=UTF-8&quot; /&amp;gt;&lt;/pre&gt;<br />
<br />
That should do the trick. I went ahead and tested this to verify and it went from sending my email account HTML encoded characters like &lt;strong&gt;&amp;amp;#1053;&lt;/strong&gt; to actually displaying the correct &lt;strong&gt;UTF-8&lt;/strong&gt; character &lt;strong&gt;&amp;#1053;&lt;/strong&gt; which in that case was a Cyrillic capital H.<br />
<br />
If you're still having any issues and you're hosted on our servers, please let us know your domain name either here publicly or by emailing &lt;a href=&quot;mailto:support@inmotionhosting.com&quot;&gt;support@inmotionhosting.com&lt;/a&gt; so we can take a closer look at all your code, and to look for any errors on the server.<br />
<br />
- Jacob&lt;/div&gt;</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8536);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-13936'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/518ccbf567c421701c8f50dbd35d24bd?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/518ccbf567c421701c8f50dbd35d24bd'>David</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-12 10:15 pm</div>
				                <div>Your FormMail.pl is great but when it is used the from email is nobody@carrierzone.com.  Why is this?  How do I fix this?  It must be a setting in your form mail program FormMail.pl.  Please email me and let me know at abcdnow@live.com.  thanks</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13936);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-27 11:52 am</div>
				                <div>To do so, you may simply set a field within your form that looks like this:<br />
&lt;p class=&quot;code_block&quot;&gt;&amp;lt;input type=&quot;text&quot; name=&quot;email&quot;&amp;gt;&lt;/p&gt;<br />
By creating this input field, a user will be able to specify their email address, and the &quot;From&quot; address will be set to their input.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14389);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-14393'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/971f0a2e331c1be02aa2159e0cf9fb06?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/971f0a2e331c1be02aa2159e0cf9fb06'>Ed Bingle</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-27 2:12 pm</div>
				                <div><p>I get a confirmation page but do not get email?</p>
<p>$DEBUGGING&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; = 1;&nbsp; $emulate_matts_code= 0;&nbsp; $secure&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; = 1;&nbsp; $allow_empty_ref&nbsp;&nbsp; = 1;&nbsp; $max_recipients&nbsp;&nbsp;&nbsp; = 5;&nbsp; $mailprog&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; = '/usr/lib/sendmail -oi -t';&nbsp; $postmaster&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; = '';&nbsp; @referers&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; = qw(ed@trainingindustrialmachinesandequipment.com www.trainingindustrialmachinesandequipment.com);&nbsp; @allow_mail_to&nbsp;&nbsp;&nbsp;&nbsp; = qw(ed@trainingindustrialmachinesandequipment.com www.trainingindustrialmachinesandequipment.com);&nbsp; @recipients&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; = ();&nbsp; %recipient_alias&nbsp;&nbsp; = ();&nbsp; @valid_ENV&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; = qw(REMOTE_HOST REMOTE_ADDR REMOTE_USER HTTP_USER_AGENT);&nbsp; $locale&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; = '';&nbsp; $charset&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; = 'iso-8859-1';&nbsp; $date_fmt&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; = '%A, %B %d, %Y at %H:%M:%S';&nbsp; $style&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; = '/css/nms.css';&nbsp; $no_content&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; = 0;&nbsp; $double_spacing&nbsp;&nbsp;&nbsp; = 1;&nbsp; $wrap_text&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; = 0;&nbsp; $wrap_style&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; = 1;&nbsp; $address_style&nbsp;&nbsp;&nbsp;&nbsp; = 0;&nbsp; $send_confirmation_mail = 0;</p>
<p>I have this FormMail.pl in my cgibin folder.</p>
<p>What am Idoing wrong?</p>
<p>Any help is great.</p>
<p>Ed</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14393);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-27 2:16 pm</div>
				                <div>Below is my form code

     Name:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;        Email:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;        Comments:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;     <span class="auto-style4">    </span>   
...
<p>I get a confirmation page but do not get email?</p>
<p>$DEBUGGING&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; = 1;&nbsp; $emulate_matts_code= 0;&nbsp; $secure&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; = 1;&nbsp; $allow_empty_ref&nbsp;&nbsp; = 1;&nbsp; $max_recipients&nbsp;&nbsp;&nbsp; = 5;&nbsp; $mailprog&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; = '/usr/lib/sendmail -oi -t';&nbsp; $postmaster&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; = '';&nbsp; @referers&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; = qw(ed@trainingindustrialmachinesandequipment.com www.trainingindustrialmachinesandequipment.com);&nbsp; @allow_mail_to&nbsp;&nbsp;&nbsp;&nbsp; = qw(ed@trainingindustrialmachinesandequipment.com www.trainingindustrialmachinesandequipment.com);&nbsp; @recipients&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; = ();&nbsp; %recipient_alias&nbsp;&nbsp; = ();&nbsp; @valid_ENV&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; = qw(REMOTE_HOST REMOTE_ADDR REMOTE_USER HTTP_USER_AGENT);&nbsp; $locale&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; = '';&nbsp; $charset&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; = 'iso-8859-1';&nbsp; $date_fmt&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; = '%A, %B %d, %Y at %H:%M:%S';&nbsp; $style&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; = '/css/nms.css';&nbsp; $no_content&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; = 0;&nbsp; $double_spacing&nbsp;&nbsp;&nbsp; = 1;&nbsp; $wrap_text&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; = 0;&nbsp; $wrap_style&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; = 1;&nbsp; $address_style&nbsp;&nbsp;&nbsp;&nbsp; = 0;&nbsp; $send_confirmation_mail = 0;</p>
<p>I have this FormMail.pl in my cgibin folder.</p>
<p>What am Idoing wrong?</p>
<p>Any help is great.</p>
<p>Ed</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14394);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-14399'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/7b4eeb64068962edd4ad89b4b2d3ba34?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/7b4eeb64068962edd4ad89b4b2d3ba34'>Ed</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-27 2:35 pm</div>
				                <div><p>sorry I dont see the post but I see a duplicate of the first post. I will try again.</p>
<p>&lt;form action="http://www.trainingindustrialmachinesandequipment.com/cgi-bin/FormMail.cgi" method="post" &gt;&nbsp;&lt;input type="hidden" name="recipient" value="ed@trainingindustrialmachinesandequipment.com,itsparts@hotmail.com" /&gt;&nbsp;&lt;input type="hidden" name="subject" value="From the feedback form" /&gt;&nbsp;&lt;input type="hidden" name="redirect" value="http://www.trainingindustrialmachinesandequipment.com/confirmation.html" /&gt;&nbsp;&lt;input type="hidden" name="reset" value="reset"/&gt;&nbsp;Name:&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp; &nbsp;&nbsp; &lt;input type="text" name="name" style="width: 385px"/&gt;&lt;br /&gt;&nbsp;&nbsp; &lt;br/&gt;&nbsp;Email:&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp; &nbsp;&nbsp; &lt;input type="text" name="email" style="width: 379px"/&gt;&lt;br /&gt;&nbsp;&nbsp; &lt;br/&gt;&nbsp;Comments:&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp;&amp;nbsp; &nbsp;&nbsp; &nbsp;&lt;span class="auto-style4"&gt; &nbsp;&nbsp; &lt;textarea name="comments" class="auto-style5" style="width: 408px; height: 166px" rows="1"&gt;&lt;/textarea&gt;&lt;/span&gt;&lt;br /&gt;&nbsp;&nbsp; &lt;br /&gt;</p>
<p>&nbsp;&nbsp;&lt;INPUT TYPE="submit" value="Send e-mail"/&gt; &lt;INPUT TYPE="reset" value="reset"/&gt;&lt;/FORM&gt;&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14399);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-27 2:48 pm</div>
				                <div>Hello Ed,<br />
<br />
We do appreciate the comments and questions. In the future, if there's anyway that you can consolidate the code to as few posts as possible, then we can reply to them much quicker.<br />
<br />
I went through your code with Jeff, and it all appears normal to us.  The form looks okay as well.  On our servers this script is meant to run as a Perl script, so that might be the issue.  You may need to talk with your host to see why the script is running  completely.  Or at least why the email portion is failing to send you  a message.   They may need to check the logs to see if they can find any error or indication of the mail being processed at the server.  <br />
<br />
Apologies that we can't give a direct answer.  Hopefully, this does lead you to a solution.  Please let us know if you have any further questions or comments.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14400);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-22316'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/5bbc80a0e345ff33a0173f756e9fcb29?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/5bbc80a0e345ff33a0173f756e9fcb29'>Gourav Batra </a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-03 10:04 am</div>
				                <div><p>I did everything as u mentioned but its giving 502 gateway error... Please Help me with this...</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>Regards,</p>
<p>Gourav</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22316);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-03 3:14 pm</div>
				                <div>Hello Gourav Batra,<br />
Sorry to hear that you're having problems with the 502 gateway error. There are MANY things that a <a href="http://pcsupport.about.com/od/findbyerrormessage/a/502error.htm" rel="nofollow" target="_blank">502 bad gateway error</a> could be. We need more specific info on the account and how you're getting the error, please.  If you can provide more information, then we can look further into the problem that you are having.  <br />
<br />
Kindest regards,<br />
Arnel C.<br />
</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22328);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-23715'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/ad38b0b8a64b02b69bbbf81c2b27772d?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/ad38b0b8a64b02b69bbbf81c2b27772d'>David Doan</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-05-26 10:54 pm</div>
				                <div><p>If i want to add attachment to the form, how can i do it? Thanks for the help.</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23715);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-05-28 2:18 pm</div>
				                <div>Hello David,<br />
<br />
Probably the easiest way to add the attachment would be to simply go to the HTML portion of the email form and add a link to the attachment that you wish to add.  <br />
<br />
I hope that helps to answer your question!  If you require further assistance, please let us know!<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23772);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-26555'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/84b7840f828f502aa85d84e4be8f2328?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/84b7840f828f502aa85d84e4be8f2328'>Stephen</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-10 5:11 pm</div>
				                <div><p>Is there a way to import a list into the mailform? I am currently using Mailchimp to send out a daily HTML of our site to out 560+ subscribers and I would liek to import them into the site</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26555);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-14 9:49 am</div>
				                <div>Hello Stephen,<br />
<br />
Not by default as this is a simple script setup. You could of course code your own import where it stored the list in a database and sent out mails using that list. That is not part of this article, however.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26614);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-27287'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/48d77c43bc3b695be3c347916e61dcb3?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/48d77c43bc3b695be3c347916e61dcb3'>Kisubiboy</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-07 9:16 am</div>
				                <div><p>Hi ,</p>
<p>I've conffigured the FormMail.pl as per steps above and still it will not work, also done it correctly in the Form as well.</p>
<p>&nbsp;</p>
<p>What else can I do to make it work?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27287);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-07 5:51 pm</div>
				                <div>Hello Kisubiboy,<br />
<br />
Sorry for the problem with the Form.  However, in order to help you we would need more information.  If you are hosted with us, please provide us some account information so that we can look at where you have implemented the form.  Do you get any error messages?  Can you provide us a copy of the code you saved?  We can't determine why the form is not working without a little more info.  <br />
<br />
Kindest regards,<br />
Arnel C. </div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27306);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-28980'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/648672edb6a856c19169a4184c4d6978?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/648672edb6a856c19169a4184c4d6978'>Barry</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-12-03 5:54 pm</div>
				                <div><p>using your form is it possible to send the reply to two different email's?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28980);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-12-03 8:16 pm</div>
				                <div>Hello Barry,<br />
<br />
Thank you for contacting us. Yes, "<strong>Step 3</strong>" above explains how to <em>input any email addresses that the forms will send to.</em>.<br />
<br />
If you have any further questions, feel free to post them below.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28983);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-12-22 9:55 am</div>
				                <div><p>all code try but &nbsp;when click on send &nbsp;value are clear and not receve any mail</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29334);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-12-22 11:55 am</div>
				                <div>Hello Jagdish,<br />
<br />
Did you copy the code completely or have you made modifications? Have you tried to turn on <a href="http://www.inmotionhosting.com/support/website/php-troubleshooting/troubleshoot-php-errors">error reporting</a> to see if you are getting any PHP errors?<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29337);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
