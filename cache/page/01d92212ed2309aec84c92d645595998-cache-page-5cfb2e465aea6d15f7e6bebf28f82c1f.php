<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:57308:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/drupal-8/getting-started/change-admin-password" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-06-07T17:12:14-07:00" />
  <meta name="keywords" content="admin password change new dashboard Drupal 9" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="If you wish to change your admin profile password, check this short Drupal 8 tutorial to learn how." />
  <title>How to change your admin password in Drupal 8 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/drupal-8/getting-started/change-admin-password" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:0316d43291612ec339df344137b920dd -->
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
				<img src='/support/images/stories/drupal-partner/supporting-partner-80_3.png' style='float:right; margin:0px 0px 15px 15px;' alt='Drupal Association Support Partner'>		<h1>
															How to change your admin password in Drupal 8									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>2,221</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: May 16, 2013'><span style='color:#606060;'>Published:</span> Jun 7, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In keeping with good security policy, it is important to change your <a href="/support/website/how-to/an-introduction-to-password-security">password</a> on a regular basis. Being the administrator, you have a different dashboard available to you than the normal users do. Changing your password within the admin dashboard is quick and easy in Drupal 8. Follow the instructions below to learn how.</p>

<h2>Changing your Admin password in Drupal 8</h2>
...
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/101/change-admin-pass/admin-dash.png"><img  style="float:right;" alt="administrator dash panel" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/101/change-admin-pass/admin-dash.png" title="Click here to view the larger image" width="200" /></a>Once in the admin dashboard, look to the toolbar across the upper portion of the screen and select the <strong>Edit profile</strong> option.<div style="clear:both;"></div></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/101/change-admin-pass/edit-profile.png"><img  style="float:right;" alt="profile edit screen" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/101/change-admin-pass/edit-profile.png" title="Click here to view the larger image" width="200" /></a>You are now on the profile edit screen for the Admin user. You will need to to enter your <strong>Current password</strong> in order to change your account password. Enter your new password in the <strong>Password</strong> and <strong>Confirm password</strong> fields.<div style="clear:both;"></div></li>
<li>Click on the <strong>Save</strong> button at the bottom to confirm and save the new password. You can now log into your admin account using the new password.<div style="clear:both;"></div></li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 3: How to change your admin password in Drupal 8</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 2: <a href='/support/edu/drupal-8/getting-started/admin-login'>Logging into Drupal 8 Administrator Dashboard</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 4: <a href='/support/edu/drupal-8/getting-started/fix-magic-quotes-error'>Fixing the magic_quotes error when installing Drupal 8</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/drupal-8/getting-started/change-admin-password&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/drupal-8/getting-started/change-admin-password'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zODcmaWQ9MjcyMSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="beeec00e863551d58c977a094ceafbc4" value="1" />	</div>
	</form>
<!-- <br />
