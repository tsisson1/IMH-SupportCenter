<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:62521:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/hacks/cleaning-up-a-htaccess-hack" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-04-21T23:41:59-07:00" />
  <meta name="keywords" content="clean up htaccess .htaccess hack rewrite redirect redirection" />
  ...
  <link href="http://www.inmotionhosting.com/support/website/hacks/cleaning-up-a-htaccess-hack" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:31fac2a9150dfded027faf66cddbf626 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-22']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '89.212.40.254']);
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>26,216</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Dec 4, 2012'><span style='color:#606060;'>Published:</span> Apr 21, 2016</div>
...
<div><span class="code_block">http://google.com/safebrowsing/diagnostic?site=example.com</span></div>
...
<li>Scroll up and down the document and you'll want to look for any code that seems to be out of place, more than likely you'll see something along the following lines if your .htaccess file has been hacked:<br /><br />
<pre class="code_block" style="width: 500px;">&lt;IfModule mod_rewrite.c&gt;
RewriteEngine On
...
<p>What this rewrite code is attempting to do is checking for the referrer of a request, if it's a popular search engine they are redirecting it to their <strong>MaliciousDomain.tld</strong> website and trying to load the <strong>bad.php</strong> malicious script.</p>
<p>Because these <strong>RewriteCond</strong> conditional statements wouldn't match for yourself, and only for search engine bots, sometimes these types of hacks can go unnoticed for some time. Unfortunately the longer they're active the more potential it has at affecting your search engine ranking.</p>
</li>
<li>To remove these malicious rewrites you can simply highlight all of the text and hit <strong>Delete</strong> on your keyboard and then click on <strong>Save Changes</strong>at the top-right to save the file.
<p>If you aren't 100% confident that you've found malicious redirect code, we would recommend backing up your <strong>.htaccess</strong> file prior to making edits to it. This can be accomplished by simply right-clicking on the <strong>.htaccess</strong> file in the File Manager, selecting <strong>Copy</strong> and then choosing a copy path such as <strong>/public_html/.htaccess-BAK</strong>, then finally clicking on <strong>Copy File(s)</strong>.</p>
</li>
</ol>
<p>You should now understand how to locate and remove a .htaccess hack that could be causing your website to do a malicious redirection. You'll more than likely also want to read about <a href="/support/website/website-troubleshooting/steps-to-take-after-a-hack">steps to take after a hack</a> for more information on how to prevent hacks like this from taking place.</p>
<p>If you're on a VPS or dedicated server you might also wish to read about <a href="/support/website/website-troubleshooting/clean-up-code-injection-attack">how to clean up a code injection attack</a> if more than just your .htaccess file has been hacked.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/hacks/cleaning-up-a-htaccess-hack&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/hacks/cleaning-up-a-htaccess-hack'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MDYmaWQ9NDkwJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="b874072ef7696fe183b8ff6bb1bc2401" value="1" />	</div>
	</form>
<!-- <br />
