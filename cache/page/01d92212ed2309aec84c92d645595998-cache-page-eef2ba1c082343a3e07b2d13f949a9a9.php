<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:57058:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-3/menu-location" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-02-03T13:49:37-08:00" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="In this tutorial, we'll explain what and how the &quot;Menu Location&quot; setting works for Joomla 3 menu items." />
  <title>Menu Location settings in Joomla 3 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-3/menu-location" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:9195a102fc8567bf560f3dfa380716bf -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Menu Location settings in Joomla 3									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>1,822</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 17, 2014'><span style='color:#606060;'>Published:</span> Feb 3, 2014</div>
  ...
  <h2>Joomla Menu Location Settings:</h2>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('available-options');">Available Options</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('what-happens');">What does this setting do?</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('how-to-change');">How to change</button>
</div>


<p>When configuring menu items in Joomla 3, the <strong>Menu Location</strong> setting controls which menu the item belongs to. If you want to move a link to a different menu, you need to change the link's (aka menu item's) <em>Menu Location</em> setting.</p>

<p>In this tutorial, we will help you understand the <em>Menu Location</em> setting by demonstrating what happens when you change this setting.</p>

<a name='available-options'></a>
<h2>What options appear as Menu Locations?</h2>

<p>In our testing, we <a href="/support/edu/joomla-3/getting-started/install-joomla-3">installed Joomla 3.2</a> with the testing <a href="/support/edu/joomla-3/302-blog-brochure-default">sample data</a>. When we examine the <em>Single Article</em> menu item, we see the following <em>Menu Location</em> settings:</p>

<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/menu-item-options/menu-location-options-are-main-menus.gif"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/menu-item-options/menu-location-options-are-main-menus.gif"  style='float:left; margin:0px 35px 15px 0px;' /></a>

<ul>
  <li>All Front End Views</li>
  <li>About Joomla</li>
  <li>All Modules</li>
  <li>Australian Parks</li>
  <li>Fruit Shop</li>
  <li>Main Menu</li>
  <li>Top</li>
  <li>User Menu</li>
...
<p style='clear:both;'>As you can see in the screenshot above, these menu items are the same as the menus that show under the <strong>Menus</strong> in the top navigation of your Joomla 3 dashboard.</p>

<a name='what-happens'></a>
<h2>What happens if I change the Menu Location Setting?</h2>

<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/menu-item-options/changing-menu-item-location.gif"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/menu-item-options/changing-menu-item-location.gif"  style="float:right; margin:0px 0px 15px 15px;" /></a>

<p>By default, the <em>Single Article</em> menu item is assigned to the <strong>All Front End Views</strong> <em>Menu Location</em>. If we change the <em>menu location</em> to <strong>Main Menu</strong>, you can see in the screenshot that the <em>Single Article</em> menu item now shows in the <em>"Main Menu"</em>.</p>

<a name='how-to-change'></a>
<h2 style='clear:both;'>How do I change a Menu Item's Menu Location?</h2>

<p>To change a link's <em>menu location</em>:</p>

<ol class='article_list'>
  <li><a href="/support/edu/joomla-3/getting-started/login-dashboard"><strong>Login</strong></a> to your Joomla admin dashboard</li>
  <li>In the top menu, click <strong>Menus</strong> and then click <strong>Menu Manager</strong></li>
  <li>In the left menu, click <strong>Menu Items</strong> (<em>located under "Menus"</em>)</li>
  <li>Find your menu item and then click it</li>
  <li>Find the <strong>Menu Location</strong> setting towards the right of the page, change it, and then click <strong>Save</strong> in the top right of the page</li>
</ol>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 25: Menu Location settings in Joomla 3</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 24: <a href='/support/edu/joomla-3/artisteer'>Artisteer 4 and Joomla 3.2</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 26: <a href='/support/edu/joomla-3/template-style'>Template Style settings in Joomla 3</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-3/menu-location&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-3/menu-location'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xMDEmaWQ9MzA3MSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="d7f4be7ad765f6023816cc921e713bd7" value="1" />	</div>
	</form>
<!-- <br />
