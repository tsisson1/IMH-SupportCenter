<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:60964:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/team/using-bella-book-guestbook" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-04-21T22:40:50-07:00" />
  <meta name="keywords" content="guest book guestbook optional installation configuration" />
  <meta name="author" content="Arnel Custodio" />
  <meta name="description" content="The following article explains how to use BellaBook as a Guestbook option.  These installation instructions avoids the use of Softaculous (which currently does not work for the different Guestbook options). The installation is very simple and also includes anti-spam options." />
  <title>Using the BellaBook Guestbook - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/team/using-bella-book-guestbook" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:2e012887ed7c73d74ae2b5d9d8e648b2 -->
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/team' itemprop='url'><span itemprop='title'>Customer Community Team<span></a><div class='dropdown_2columns'><div class='col_2'><div><a href='/support/team/community'>Community Building</a> (7)</div><div><a href='/support/team/faq'>Frequently Asked Questions</a> (2)</div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Using the BellaBook Guestbook</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Using the BellaBook Guestbook									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>2,297</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Dec 31, 2013'><span style='color:#606060;'>Published:</span> Apr 21, 2016</div>
  ...
  <p><em> If you were looking for the cPanel Guestbook script, you have been re-directed to this page because the current program is no longer operational with the current releases of cPanel.  The following tutorial covers another free guestbook solution available to you through cPanel.</em></p>
</div>

<p>The following article uses a program called BellaBook Guestbook and will walk you through obtaining the software, installing it, and running it on your hosting account. </p>

<h2>What is BellaBook Guestbook?</h2>

<p>BellaBook is a simple PHP-based guest book program that you can run on your website.  A guest book is simply a book that allows people to sign in and allow visitors to see who's come and visited your site.  The BellaBook program allows this and also provides for comments, an email address and spam protection without using a database.  The advantage to this is that the program is not dependent on the database server in order to run.  The disadvantage would be that the program can only display a certain number of entries and would not have the search capabilities that a relative database can provide.  There are many other guestbook programs that you can obtain if that is your primary need, but bear in mind that with added functionality you get more complexity.  The BellaBook program is simple and meets the basic needs of a guestbook. </p>

<h2>Obtaining BellaBook</h2>

<p>In order to install BellaBook, you will need to go to the website: <a href="http://www.jemjabella.co.uk/scripts/bellabook/">BellaBook home page</a>.  The download link is directly accessible by going here:  <a href="https://github.com/jemjabella/BellaBook/archive/master.zip">Download BellaBook</a>.
</p>

<div class="alert alert-danger">

<p><b>NOTE:</b>  BellaBook is available through Softaculous, but at this time the installation will not work in the latest version of cPanel (11.38 build 15).  The installation instructions that follow will explain how to install it manually.</p>
</div>

<h2>Installing and Configuring BellaBook</h2>

<ol class="article_list">

<li>Upload the BellaBook zip file.</li>


<li>You can either extract the file locally on your computer, or you can upload the zip file and <a href="http://www.inmotionhosting.com/support/website/file-manager/compressing-uncompressing-files">uncompress/extract</a> the file within the cPanel File Manager. Doing this in the cPanel file manager would be much easier.  If you extract it locally, then you will need to use an FTP client in order to move the extracted files and folders without any complications.</li>

<li>Once you have the extracted BellaBook folder extracted, you will notice that by default a folder called "BellaBook" is created with all of the files in it.  You can use this folder, or move all of the files into a different one.  Note that the instructions from BellaBook's author can be found in the <b>README.TXT</b> file.</li>

  <li><p>Look through the list of files that you uploaded (or extracted) and then look for the <b>prefs.php</b>. The text below is a copy of the contents of the <b>prefs.php</b>.</p><p></p>
...
$admin_email = "you@example.com";   // admin e-mail address
$admin_url = "http://example.com";   // your website url - used in guestbook footer
$admin_gburl = "http://example.com/bellabook";   // your guestbook url - used in the sign notification emails
...
<li>You will need to set the following values (in the table below) by editing replacing each of the default values.  You will need edit the file by using text editor like Notepad in Windows or the <a href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-file-manager/file-manager-code-editor">code editor</a> available in cPanel under the File Manager.  Replace the values by simply replacing the existing text within the quotation marks.  For example, replace $admin_name="admin" with $admin_name="marktheadmin".

<table>
<tr><td> Admin name</td><td>Administrator User name</td></tr>
<tr><td> Password</td><td>administrator password</td></tr>
<tr><td> Admin_email</td><td>email of the administrator</td></tr>
<tr><td> Admin_url</td><td>URL used for the website. This URL is displayed in the guestbook footer</td></tr>
<tr><td> Guestbook URL</td><td>Guestbook URL. This URL is used in the notification emails</td></tr>
<tr><td> Website name</td><td>Non-URL name of the website used in the guestbook footer</td></tr>
<tr><td> Secret</td><td>Second password used for security (per their documentation you don't need to remember it)</td></tr>
<tr><td> Optional - dateformat</td><td>Date format in PHP format. For more information go to php.net/date</td></tr>
<tr><td> Optional - Stylecolor</td><td>This is a  color scheme for the application. You can get more from <a href="http://www.jemjabella.co.uk/scripts/">BellaBook website</a></td></tr>
  </table>
</li>

<li>After your changes are complete, save the file</li>
</ol>

<h2>Securing BellaBook</h2>

<p>The next step in setting up BellaBook is to change the permissions on four of the text files files that were uploaded in the BellaBook directory:</p>
<ul>
<li>entries.txt</li>
<li>tempentries.txt</li>
<li>spamwords.txt</li>
<li>iplist.txt</li>
</ul>
<p>Change the permissions from 755 to 666.  You can easily accomplish this by using the <a href="http://www.inmotionhosting.com/support/website/managing-files/change-file-permissions">cPanel File manager</a>.  


<h2>Using the Advanced options to help manage Guestbook entries</h2>
<p>Bellabook controls entries by using the following options:</p>
<ul>
<li><b>Captcha</b> - allows you to force a user to enter a code before they can place an entry in the guestbook</li>
<li><b>Moderate</b> - allows you set that all entries be approved by an administrator before they can be seen</li>
<li><b>Floodcontrol</b> - helps to provide a flood of entries into the guestbook</li>
<li><b>Allow links</b> - Allows URLs in the comment (defaults to NO in order to help cut down on spam)</li>

  <p>These entries are found at the bottom of the <b>prefs.php</b> file.  Simply change "no" to "yes" in order to activate the feature.</p>
  </ul>

  <h2>Summary</h2>
<p>This completes the instructional tutorial on using the BellaBook Guestbook program.  For more information on BellaBook, go to the <a href="http://www.jemjabella.co.uk">their main website</a>.  This is a very basic program, but when running you will see that it looks something like this:</p>

  <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/bellabook/bella-book-in-action.png"><img  alt="BellaBook" src="//cdn.inmotionhosting.com/support/images/stories/edu/bellabook/bella-book-in-action.png" /></a>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/team/using-bella-book-guestbook&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/team/using-bella-book-guestbook'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yMiZpZD0zMDUxJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="fc028a677b00776ba8bf67e046ab666d" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/55208acc66708f2fbbd95f1fca239771?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/55208acc66708f2fbbd95f1fca239771'>Jem</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-28 6:46 pm</div>
				                <div><p>Please note that the download link included in this article is not necessarily always the most up to date version of BellaBook. If in doubt I recommend sourcing from the github repository:</p>

<p>https://github.com/jemjabella/BellaBook/archive/master.zip</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10958);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-28 8:11 pm</div>
				                <div>Hello Jem, and thanks for the comment!<br />
<br />
Thanks a lot for pointing that out! I've gone ahead and updated the article to reflect that GitHub URL for the download link.<br />
<br />
Also thanks for creating this awesome guestbook software so we have something to write about!<br />
<br />
- Jacob</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10959);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
