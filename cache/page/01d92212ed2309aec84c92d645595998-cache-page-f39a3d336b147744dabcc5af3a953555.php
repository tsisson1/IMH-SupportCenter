<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:93227:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/dreamweaver/dreamweaver-cs5-how-to-configure-server-settings" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-04-21T23:11:02-07:00" />
  <meta name="keywords" content="Dreamweaver server settings configure" />
  ...
  <link href="http://www.inmotionhosting.com/support/website/dreamweaver/dreamweaver-cs5-how-to-configure-server-settings" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:372a17a4cc3ae12a670b1b1e82e035a8 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '125.162.23.149']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/website/dreamweaver' itemprop='url'><span itemprop='title'>Dreamweaver<span></a></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Dreamweaver CS5 - How to configure server settings</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Dreamweaver CS5 - How to configure server settings									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>27,307</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Aug 23, 2011'><span style='color:#606060;'>Published:</span> Apr 21, 2016</div>
				...
				<a class="ddtut" href="http://support.inmotionhosting.com/userguides/dwmx/dwmx_configuresite.swf" style='display:block; margin-bottom:15px;'>
					<img src='/support/images/icon.movie.png' /><br />
					Click here to watch a video tutorial
				</a>
				

								<div>This article will assist you with configuring your sever settings in Dreamweaver CS5.</div>
<p> </p>
<div>Open your current site by clicking <strong>Site</strong> and then <strong>Manage Sites...</strong></div>
<div></div>
<div><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/DWCS5/click_sites_managesites.gif"><img  alt="click_sites_managesites" src="//cdn.inmotionhosting.com/support/images/stories/DWCS5/click_sites_managesites.gif" /></a></div>
<p> </p>
<div>Choose your site from the list, and then click "Edit"</div>
<div></div>
<div><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/DWCS5/select_site_click_edit.gif"><img  alt="select_site_click_edit" src="//cdn.inmotionhosting.com/support/images/stories/DWCS5/select_site_click_edit.gif" /></a></div>
<p> </p>
<div>If you don't already have a server configured, click "Servers" and then click the plus sign to add a new server. If you already configured a server, choose the server from the list and click the pencil icon to modify it.</div>
<div></div>
<div><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/DWCS5/click_servers_click_add_new_server.gif"><img  alt="click_servers_click_add_new_server" src="//cdn.inmotionhosting.com/support/images/stories/DWCS5/click_servers_click_add_new_server.gif" /></a></div>
<p> </p>
<h2>Basic Server Settings</h2>
<div>Fill out the Basic server settings as described below, and then click "<em>Test</em>"</div>
<div></div>
<div><strong>Server Name:</strong> Enter a name for this server</div>
<div></div>
<div><strong>Connect using:</strong> Choose FTP</div>
<div></div>
<div><strong>FTP Address:</strong> Enter your domain name here</div>
<div></div>
<div><strong>Username and Password:</strong> Enter your cPanel username and password</div>
<div></div>
<div><strong>Root Directory:</strong> If you are setting this up for your main domain, enter public_html</div>
<div></div>
<div><strong>Web URL:</strong> This will auto fill in for you when you enter a root directory. Please be sure to remove "public_html" from the Web URL so that it only reads <a href="http://yourdomain.com">http://example.com</a></div>
<div></div>
<div><strong>More Options -</strong> Use Passive FTP: Select "Use Passive FTP"</div>
<p> </p>
<div><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/DWCS5/basic_server_settings.gif"><img  alt="basic_server_settings" src="//cdn.inmotionhosting.com/support/images/stories/DWCS5/basic_server_settings.gif" /></a></div>
<p> </p>
<div>When your server settings test was a success, click "<em>OK</em>" and then click "<em>Save</em>"</div>
<div></div>
<div><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/DWCS5/successful_connection.gif"><img  alt="successful_connection" src="//cdn.inmotionhosting.com/support/images/stories/DWCS5/successful_connection.gif" /></a></div>
<p> </p>
<div>After you have properly configured your server, click "<em>Save</em>"</div>
<div></div>
<div><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/DWCS5/save_settings.gif"><img  alt="save_settings" src="//cdn.inmotionhosting.com/support/images/stories/DWCS5/save_settings.gif" /></a></div>
<div></div> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/dreamweaver/dreamweaver-cs5-how-to-configure-server-settings&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/dreamweaver/dreamweaver-cs5-how-to-configure-server-settings'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD02MiZpZD0xNDUmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="e024d481da51e9caf5df0a7dcd2719f1" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/dreamweaver/cant-set-up-ftp-in-dreamweaver-cs5?tsrc=rsbraq'>Can't set up Dreamweaver CS5 to publish site</a>
                                </div>
...
<a name='comments'></a>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/fb456434e02f61b64d5ee19243c1274f?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/fb456434e02f61b64d5ee19243c1274f'>Van Turner</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-08 10:01 am</div>
				                <div><p>For a subdomain, would the Root Director look like this:&nbsp;<span style="color: rgb(35, 35, 35); font-family: adelle-sans, Helvetica, Arial, sans-serif; font-size: 13px; line-height: 22px; background-color: rgb(249, 249, 249);"><strong style="font-family: verdana;">Root Directory:</strong>&nbsp; public_html/subdomain (where you'd enter the name of your subdomain)</span></p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8852);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-10 10:29 am</div>
				                <div>Yes, this would indeed be the correct root directory.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8883);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-32369'></a>
		<div  style='margin:2px 0px 0px 40px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/a9c1030b51eea7c557d5748bcea879d8?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/a9c1030b51eea7c557d5748bcea879d8'>Kingsford</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-05-01 2:41 am</div>
				                <div><p>The root directory, I think, differs from host to host</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32369);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-16088'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/cea46d0eab3dc9cae86de6cb607a469f?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/cea46d0eab3dc9cae86de6cb607a469f'>Hiren Patel</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-10 4:00 am</div>
				                <div>nice article very helpfull to me</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16088);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//graph.facebook.com/annettelechatnoir/picture?type=normal' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='/support/community-support/users/Lechatnoir'>Lechatnoir</a></div>
						<div><a href='https://twitter.com/___chatnoir' target='_blank'><img src='//www.inmotionhosting.com/img/icon-twitter.png' style='width:20px;' /></a><a href='https://www.facebook.com/annettelechatnoir' target='_blank'><img src='//www.inmotionhosting.com/img/icon-facebook.png' style='width:20px;' /></a></div>
						<div></div>
						<div>6 <a href='/support/team/points' target='_blank'>Points</a></div>
						
					</td>
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-14 3:56 am</div>
				                <div>Hello! I don't know a server name in ftp setup on Dreamweaver...  Can you help me please? Sorry for my English... Annette</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16199);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-14 7:57 am</div>
				                <div>Hello Annette,<br />
<br />
If your domain is already pointed to our servers, then you can simply use the domain name. If it is not, you will need to know the server name on which your account resides. You may find our <a href="http://www.inmotionhosting.com/support/website/ftp/getting-started-guide">FTP Guide</a> some help when configuring Dreamweaver's FTP settings.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16211);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-20069'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/fd1f69bf26eea2c173fa8fced1f1f6a8?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/fd1f69bf26eea2c173fa8fced1f1f6a8'>Claudio</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-28 4:02 pm</div>
				                <div><p>Whats is the ip address from my FTP, because the DNS are still the old ones, so I need the IP address to make the conection until the DNS setting are changed. Thanks</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20069);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-28 4:27 pm</div>
				                <div>Hello Claudio,<br />
<br />
You can find your IP address for FTP by going into the cPanel.  Check out:  <a href="http://www.inmotionhosting.com/support/website/cpanel/how-to-find-your-shared-ip-address-of-your-server-in-cpanel">How to find your shared IP address of your server in cPanel</a>.  You can also use your server name by looking at the <a href="http://www.inmotionhosting.com/support/website/amp/viewing-account-technicial-information-in-amp">technical server info</a>.  If you want to see how that information is used, here's an example of using the server name for the FTP credentials:<br />
<br />
ftp://biz321.inmotionhosting.com<br />
user name = someone5<br />
pw= cPanel password<br />
port = 21<br />
directory where the files should be uploaded = public_html<br />
<br />
...
<br />
						...
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20073);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-20485'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/9706ecbf94067fcbe103bdaaa641770a?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/9706ecbf94067fcbe103bdaaa641770a'>Cooper Timewell</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-08 6:10 am</div>
				                <div>It was all awesome</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20485);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-21568'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/ebdfc6d3ddce4c368323a49852ab558d?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/ebdfc6d3ddce4c368323a49852ab558d'>paul komar</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-10 6:55 pm</div>
				                <div>Worked like a charm!  Good support</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21568);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-26342'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/0dc1a5001e35bfb58717367e3d1efe7f?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/0dc1a5001e35bfb58717367e3d1efe7f'>Tracy</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-03 3:13 pm</div>
				                <div><p>If my web designer uses Dreamweaver, I need&nbsp;to give him my cpanel password, correct? I've set up an FTP account for him, but that user/pass doesn't work in Dreamweaver. Does it&nbsp;work only for Filezilla and the others listed&nbsp;upon&nbsp;clicking "Configure FTP client"?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26342);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-04 4:21 pm</div>
				                <div>Hello Tracy,<br />
<br />
That account should work for DreamWeaver. Please be sure the username you are using is developer@yourdomain.com. It looks like an email address but that is how extra FTP accounts look like within cPanel.<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26366);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-28044'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/016c911829feaf9dcd61c8c1290fab66?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/016c911829feaf9dcd61c8c1290fab66'>JPCreative</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-30 4:50 pm</div>
				                <div><p>What if I don't want to connect via FTP and want to connect SFTP? FTP is not secure and not recommended. I am having trouble accessing the server via dreamweaver and yet Filezilla connects without issue.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28044);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-30 5:50 pm</div>
				                <div>Hello JPCreative,<br />
<br />
Thank you for contacting us. Here is a helpful link to our guide on <a href="http://www.inmotionhosting.com/support/website/ftp/shared-sftp-setup">Connecting to SFTP for Shared Accounts</a>. That guide explains how to create secure keys.<br />
<br />
The <a href="https://helpx.adobe.com/dreamweaver/using/connect-remote-server.html" target="_blank">Official DreamWeaver guide</a> includes a section on setting up SFTP.<br />
<br />
If you have any further questions, feel free to post them below.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28047);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-28 11:29 pm</div>
				                <div><p>No, that guide is for CS5 and below. Dreamweaver has removed those options in CS6 apparently. It is no longer possible to connect to the server via SFTP with SSH key.I found out that you can make it work via a round-about method with bitvise ssh client although that's of little use to me on a mac. Detailed instructions here - http://stackoverflow.com/questions/11942653/dreamweaver-cs6-ssh-private-key-sftp-on-amazon-ec2There is no excuse for Inmotion to not be aware of this if they are going to force SSH keys for SFTP connections. This has wasted a lot of my time and documentation is poor and out of date. As another example of this, even though the SSH Key guide continues to talk about puttygen, it is no longer needed as your own service allows conversion to PPK right from cpanel.Hopefully this helps someone.Thanks</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31516);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-29234'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/ed46eaadd34a87a43a4b35ccd22a6df7?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/ed46eaadd34a87a43a4b35ccd22a6df7'>Gilbert</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-12-16 10:50 pm</div>
				                <div><p>My web site brings up a generic Wordpress site. I've talked to the IMH support staff and they gave me&nbsp; these instructions - which didn't help. How can I get my site back using Dreamweaver?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29234);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-12-17 10:07 am</div>
				                <div>So, I'm assuming you have a local copy of your site you built with Dreamweaver? You would need to set up Dreamweaver to push those files from your local computer to the server using FTP. This article explains how to do that. You will need to configure Dreamweaver to publish your site. This tutorial will walk you through the settings needed to do so. </div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29239);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
