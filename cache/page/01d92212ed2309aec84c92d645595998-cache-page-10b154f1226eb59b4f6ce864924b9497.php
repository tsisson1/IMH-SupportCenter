<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:76148:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/ftp/shared-sftp-setup" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-05-20T18:56:49-07:00" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Learn how to set up SFTP connections for shared accounts." />
  <title>Connecting to SFTP for Shared Accounts - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/ftp/shared-sftp-setup" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:e0f3d8194523f737b7eb2b86d2b0c4a9 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '99.58.169.232']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Connecting to SFTP for Shared Accounts									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>5,218</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jul 18, 2014'><span style='color:#606060;'>Published:</span> May 20, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								While <a href="/support/website/ftp/getting-started-guide">FTP access</a> has always been allowed on our <a href="http://www.inmotionhosting.com/business-hosting">Shared plans</a>, we have recently added the ability to use Secure FTP, or SFTP. This procedure is a little different and does not use the normal <a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">cPanel login</a> procedure to access the account. Below is our guide on using FileZilla to access your account using SFTP.

<h2>Generate access keys via cPanel</h2>
<p>If you have not already done so, create your public and private keys as per the instructions in the <a href="/support/website/ssh/shared-reseller-ssh">SSH access for Resellers and Shared Servers</a> article. If you already have created keys for SSH access, the same keys will be used for SFTP.</p>

<h2>Create the FileZilla profile</h2>
<p>After your keys have been generated, you will need to create your SFTP profile in your FileZilla application. There are twos steps to this process. First you will need to attach your private keyfile to FileZilla and then you will need to create your connection profile.</p>
<h3>Attach your private keyfile.</h3>
<ol class="article_list">
  <li>Log into your FileZilla application.<div style="clear:both;"></div></li>
  <li>From the upper toolbar, click on <strong>Edit</strong> and then <strong>Settings</strong>.<div style="clear:both;"></div></li>
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/ssh/sftp/1-click-settings-addkeyfile.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/ssh/sftp/1-click-settings-addkeyfile.png" title="Click here to view the larger image" width="200" /></a>A settings popup will appear. From there click on <strong>SFTP</strong> in the left-hand toolbar. In the right panel, click on the <strong>Add keyfile...</strong> button.<div style="clear:both;"></div></li>
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/ssh/sftp/2-keyfile-added.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/ssh/sftp/2-keyfile-added.png" title="Click here to view the larger image" width="200" /></a>Using the popup window, navigate to the ppk file you saved for your private key and click <strong>Open</strong>.<div style="clear:both;"></div></li>
  <li>The keyfile will appear in the list. Click the <strong>OK</strong> button to save the information.<div style="clear:both;"></div></li>
</ol>

<h3>Set up the SFTP connection profile</h3>
<ol class="article_list">
  <li>Using the upper toolbar, click on <strong>File</strong> and then <strong>Site Manager</strong>.<div style="clear:both;"></div></li>
  <li>A popup will appear for you to create a new profile. Click on the <strong>New Site</strong>.<div style="clear:both;"></div></li>
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/ssh/sftp/3-enter-profile-info.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/ssh/sftp/3-enter-profile-info.png" title="Click here to view the larger image" width="200" /></a>The right hand form will appear brighter, indicating you can now enter data in it. Be sure to enter data into the following fields:
  ...
  <tr>
    <td>Host</td>
    <td>Enter your domain name here. (ie: example.com)</td>
  </tr>

  <tr>
    <td>Port</td>
    <td>Set this to "2222".</td>
  </tr>

  <tr>
    <td>Protocol</td>
    <td>Set this to "SFTP - SSH File Transfer Protocol".</td>
  </tr>

  <tr>
    <td>Logon Type</td>
    <td>Set to "Ask for Password".</td>
  </tr>

  <tr>
    <td>User</td>
    <td>Enter your cPanel username.</td>
  </tr>

  <tr>
    <td>Password</td>
    <td>Enter your current cPanel password.</td>
  </tr>

  </table>

  <div style="clear:both;"></div></li>
  <li>Once all data has been entered, click <strong>Connect</strong> to let FileZilla connect to your server.<div style="clear:both;"></div></li>
</ol>


<p>Once you have completed the above, you should be able to connect to your shared account using SFTP.</p>
...
<div style='display:inline-block;'>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MDImaWQ9MzM1NiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="0253f65ec670ee5429c3c5bfcdfebfa8" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/file-management/how-do-you-find-your-secure-ftp-host-name?tsrc=rsbraq'>How do you find your secure FTP host name? </a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/cpanel/sftp-ssh-for-vaultpress?tsrc=rsbraq'>SFTP &amp; SSH for VaultPress</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='https://lh6.googleusercontent.com/-56d_rgSNLMs/AAAAAAAAAAI/AAAAAAAAZ2g/id6UUpSGsu0/photo.jpg?sz=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='/support/community-support/users/bennyp'>bennyp</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-15 3:37 pm</div>
				                <div>I'm trying this method to log in to a subdomain's FTP account, but the passphrase to the key isn't accepted, Coda 2 on Mac Yosemite.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22676);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-15 3:38 pm</div>
				                <div>Unable to extract public key from private key file: Wrong passphrase or invalid/unrecognized private key file format</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22677);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-16 10:36 am</div>
				                <div>Hello Bennyp,<br />
<br />
Sorry for the problems with connecting Coda2 through SFTP.  I would suggest using SSH instead - as I do not have Coda2 to test.  However, I did see this article with another Coda2 user having the same problems, so he switched to SSH:  <a href="http://wordpress.2bearstudio.com/how-to-setup-coda-2-sftp-private-ssh-key/" rel="nofollow" target="_blank">How to Setup Coda2 SFTP using Private SSH Key</a>.  Check that out, and also our own article for <a href="http://www.inmotionhosting.com/support/website/ssh/shared-server-ssh-mac">connecting to a shared server SSH with a Mac</a>.  Hopefully, that will cover all the bases.<br />
<br />
If you have any further questions or comments, please let us know.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22704);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/b62e5d9570c7c151fc4eac4c81875a68?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/b62e5d9570c7c151fc4eac4c81875a68'>bennyp</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-03 1:36 am</div>
				                <div><p>Hey there,</p>
<p>I followed the steps to add the key to my mac's keychain, then tried connecting with Coda, restarting coda after every step. It still doesn't work: says that the login doesn't authenticate.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26313);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-03 12:18 pm</div>
				                <div>Hello bennyp,<br />
<br />
Thank you for contacting us. An authentication error is usually related to username, and password. I recommend confirming your <a href="http://www.inmotionhosting.com/support/website/ftp/getting-started-guide">FTP Settings</a> are correct and without misspellings.<br />
<br />
If your problems persist, I recommend checking the <a href="http://www.inmotionhosting.com/support/website/getting-started-guides/cpanel-logs-for-access-apache-email-error-ftp-mysql-whm">FTP logs</a> for additional errors, or clues. If you are on a shared server, <a href="http://www.inmotionhosting.com/contact">Live Support</a> can help you with this.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26335);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-31068'></a>
		<div  style='margin:2px 0px 0px 120px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/0cfa627a9484e4357a853262b645529c?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/0cfa627a9484e4357a853262b645529c'>Michael Singletary</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-09 3:12 am</div>
				                <div><p>I was able to get this working in Coda 2, finally! I found that using the keys generated through cPanel was not possible in Coda, so I tried generating my own through Terminal like this:</p>
<p><strong>ssh-keygen</strong></p>
<p>Give it a unique name, like inmotionhosting and set your passphrase - just like you do through cPanel.</p>
<p>After generating the key, add it to your Keychain with:</p>
<p><strong>ssh-add -K inmotionhosting</strong> (but replace 'inmotionhosting' with whatever you name your key)</p>
<p>Once that's done, head over to&nbsp;<strong>Security -&gt; SSH Shell Access</strong> in cPanel and click&nbsp;<strong>Manage SSH Keys</strong>. Then click&nbsp;<strong>Import Key</strong>.</p>
<p>Enter the name that you gave your key in the relevant field. Then copy and paste the contents of your private and public key files that you generated earlier in their respective boxes. Type in your&nbsp;<strong>passphrase</strong> where it asks for it.</p>
<p>If you want to quickly view the contents of these key files in Terminal, use these commands (assuming you named your key 'inmotionhosting'):</p>
<p><strong>cat ~/.ssh/inmotionhosting</strong></p>
<p><strong>cat ~/.ssh/inmotionhosting.pub</strong></p>
<p>Copy and paste the results of those commands into the private field (first one) and then the public field (second one) in cPanel. Then click&nbsp;<strong>Import</strong>. Go back to the list of your keys and click&nbsp;<strong>Manage Authorization</strong> next to the key name you just imported, then click&nbsp;<strong>Authorize</strong>.</p>
<p>Go back to Terminal on your Mac and create a new 'config' file in the '.ssh' directory if there is not already one there. You can do this with nano like this:</p>
<p><strong>nano ~/.ssh/config</strong></p>
<p>In it, add a new host record that looks like this:</p>
<p>Host <strong>YOURSERVERNAME</strong>.inmotionhosting.com</p>
<p>HostName <strong>YOURSERVERNAME</strong>.inmotionhosting.com</p>
<p>User&nbsp;<strong>YOURUSERNAME</strong></p>
<p>IdentityFile ~/.ssh/inmotionhosting</p>
<p>Port 2222</p>
<p>Then save the file with&nbsp;<strong>CTRL-X</strong> and hit&nbsp;<strong>Y</strong> to confirm, then&nbsp;<strong>Enter</strong>.</p>
<p>Go back to edit your site within Coda, and go to the&nbsp;<strong>Server</strong> tab. Select&nbsp;<strong>SFTP</strong> under Protocol, then type in the name of your shared server in the&nbsp;<strong>Server</strong> field.&nbsp;<strong>Leave everything else blank</strong>. The config file that you just created will be pulled when attempting to connect and will use the details you entered above.</p>
<p>By doing all of this, I am now able to successfully connect to my account via SFTP in Coda 2!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31068);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
