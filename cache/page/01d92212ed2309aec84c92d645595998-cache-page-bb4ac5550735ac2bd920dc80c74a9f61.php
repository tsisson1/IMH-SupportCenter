<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:54675:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/file-management/552-disk-full-please-upload-later-via-ftp" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello ravinder, I'm sorry to hear about the problems you're having. If you're getting the 552 Disk full error on your account when attempting to upload ..." />
  <title>552 Disk full - please upload later (via FTP) | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/file-management/552-disk-full-please-upload-later-via-ftp" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:af6f89bac7cb7cda1770ba57d7191577 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '82.208.136.156']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box straight_bottom'>
                <h1 style='font-size:26px;'>552 Disk full - please upload later (via FTP)</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/josephakins'>josephakins</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2011-10-23 10:52 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>28,817</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I'm getting the error '552 Disk full - please upload later' when I try to upload files (even very small script files) via FTP. This problem has recurred every day for five days. Each time I report it Tech Support says they're 'working on it'. Is this problem system-wide, or limited to one server? When this error is reported, is the disk truly full? What will happen if someone purchases files for digital delivery via our shopping cart? The cart software has to copy the files to a web-accessible directory.  Will here be any available disk space to copy them to?</div>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px;'>
				<div style='font-size:12px; max-width:500px; overflow:auto;'>hi sir <br />
i am sufr this problem what i do next reply me answer....<br />
?</div>
				
				
			</td>
			<td style='width:100px;' valign='top'>
				<img src='https://lh6.googleusercontent.com/-JU1kaUcyOxc/AAAAAAAAAAI/AAAAAAAAAH4/Ms7yfw8dfSY/photo.jpg?sz=90' style='width:40px;' class='user_avatar' />
				<div class='smallgrey'>
					<a href='/support/community-support/users/ravinder'>ravinder</a><br />
					0 <a href='/support/team/points' target='_blank'>Points</a><br />
					2014-01-02 07:40 am EST
				</div>
			</td>
		</tr>
	</table>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_197' id='upvote_answer_197' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='197' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_197').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_197' id='downvote_answer_197' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='197' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_197').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hi josephakins,<br />
<br />
Thanks for posting your question. The problem is with the server you are on. There's a point where the server disk space is nearing capacity and causing the issue. If you provide me your primary domain I'd be happy to look into this further for you. <br />
<br />
As for your shopping cart, depending on how your cart handles the sale of digital media will determine if it is affected or not. <br />
<br />
Let us know if there's anything else we can assist you with. I look forward to hearing from you soon. <br />
<br />
Thanks!<br />
<br />
Tim S
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_197').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_197' id='form_comment_on_answer_197' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
...
<div class='  not_best_answer'>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px; width:50px;' valign='top'>
<div class='vote_div'>
	<form method='post' name='upvote_answer_4374' id='upvote_answer_4374' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='4374' />
		<input type='hidden' name='component' id='component' value='qa' />
		<input type='hidden' name='vote_value' id='vote_value' value='1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_4374').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_4374' id='downvote_answer_4374' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='4374' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_4374').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello ravinder,<br />
<br />
I'm sorry to hear about the problems you're having. If you're getting the &lt;strong&gt;552 Disk full&lt;/strong&gt; error on your account when attempting to upload files, the server could be temporarily close to its disk limit.<br />
<br />
Please &lt;a href=&quot;http://www.inmotionhosting.com/support/website/getting-started-guides/submitting-and-checking-on-status-of-tickets&quot; target=&quot;_blank&quot;&gt;submit a ticket&lt;/a&gt; to our support department so that they can pull up your account and look into any current disk space issues on the server your account is hosted on.<br />
<br />
Alternatively, if you'd like to reply to this public forum with the domain name of your account we can take a look for you here in the community as well.<br />
<br />
- Jacob
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_4374').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_4374' id='form_comment_on_answer_4374' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
					                <p>You must <a href='/support/login'>login</a> before you can post a comment about this answer.</p>
					        </div></div></div></div>
					</form>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/file-management/552-disk-full-please-upload-later-via-ftp&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/file-management/552-disk-full-please-upload-later-via-ftp'></div>
<script type='text/javascript'>
  (function() {
