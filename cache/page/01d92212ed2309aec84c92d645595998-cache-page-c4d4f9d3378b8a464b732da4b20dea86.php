<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50065:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/databases/mysql-error-1874-innodb-is-in-read-only-mode-when-importing" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Pteagle, Sorry for the problems you're having in trying to work with your database. Unfortunately, this kind of issue will require a systems suppo..." />
  <title>MySQL Error : #1874 - InnoDB is in read only mode when Importing | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/databases/mysql-error-1874-innodb-is-in-read-only-mode-when-importing" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:0c481b9ea8751a76b3736dac3f306551 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-20']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '182.138.232.184']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>MySQL Error : #1874 - InnoDB is in read only mode when Importing</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='https://lh3.googleusercontent.com/-WaZYeaXhGBY/AAAAAAAAAAI/AAAAAAAAAVw/ZTGUwxwU2c0/photo.jpg?sz=90' class='user_avatar' /><br />
			<a href='/support/community-support/users/pteagle'>pteagle</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-01-01 4:15 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>544</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I am not able to import a dump file due to the error thrown by MySQL during import<br />
<br />
#1874 - InnoDB is in read only mode.</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_6216' id='upvote_answer_6216' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='6216' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_6216').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_6216' id='downvote_answer_6216' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='6216' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_6216').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Pteagle,<br />
<br />
Sorry for the problems you're having in trying to work with your database.  Unfortunately, this kind of issue will require a systems support member to resolve the problem.  Typically, you can <a href="http://www.inmotionhosting.com/support/website/getting-started-guides/submitting-and-checking-on-status-of-tickets">submit a support ticket</a> that will be escalated to the System team so that they can troubleshoot the issue for you.  In this case, I will submit the ticket in your name so that they can take a look at the problem.  They will follow up on the issue through email.  <br />
<br />
Apologies again that I can't provide a direct answer, but hopefully, the support ticket will lead to the resolution of your problem.<br />
<br />
Kindest regards,<br />
Arnel C.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_6216').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_6216' id='form_comment_on_answer_6216' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/databases/mysql-error-1874-innodb-is-in-read-only-mode-when-importing&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/databases/mysql-error-1874-innodb-is-in-read-only-mode-when-importing'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="d6c5b9b03077ec35d84b3296edf03080" value="1" />	</div>
	</form>
<!-- <br />
