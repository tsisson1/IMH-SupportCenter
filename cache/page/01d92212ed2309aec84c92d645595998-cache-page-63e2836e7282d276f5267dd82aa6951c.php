<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:84395:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/prestashop-15/change-site-url-in-database" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-04-12T19:51:41-07:00" />
  <meta name="keywords" content="change adjust edit site url directly in database prestashop 15" />
  <meta name="author" content="Arnel Custodio" />
  <meta name="description" content="Occasionally, it may be necessary to change the URL for a PrestaShop 1.5.  This can be done directly in the database using the cPanel phpMyAdmin program.  The following article explains how to make this change and other factors that may affect the change." />
  <title>351: How to change your site URL directly in the Database for PrestaShop 1.5 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/prestashop-15/change-site-url-in-database" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:505eb8293ff5a8e06caa4571ba87a60d -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-20']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '103.25.77.95']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															351: How to change your site URL directly in the Database for PrestaShop 1.5									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>36,172</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Apr 12, 2013'><span style='color:#606060;'>Published:</span> Apr 12, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								If your domain name changes for whatever reason, you will need to make this change in the PrestaShop backoffice  (<a href="/support/edu/prestashop-15/337-change-shop-url"><em>337: How to change your shop URL in PrestaShop 1.5</em></a>).  However, access to change the URL may not always be available through the dashboard.  To accommodate this possibility, you can make the change directly in the mySQL database.  The following article walks you through the steps for making this change using phpMyAdmin.  

<h2>Modify the Shop URL in the Database using phpMyAdmin</h2>


<ol class="article_list">
<li><a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">Login to your cPanel</a>.<div style="clear:both;"></div></li>
  <li>Scroll down to the database section and click on <strong>phpMyAdmin</strong>.<div style="clear:both;"></div></li>
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/change-url/prestashop154-db-list.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="200" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/change-url/prestashop154-db-list.png" alt="Select Select the database in phpMyAdmin" align="right" ></a>When you have launched phpMyadmin, select the database by scrolling down the left side list. If you're not sure how to find your PrestaShop 1.5 database, go to <a href="/support/edu/prestashop-15/341-find-database-name"><em>341: How to find your database name for PrestaShop 1.5</em></a>. Once you have found your database, click on it to open.<div style="clear:both;"></div></li>
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/change-url/change-db-shop-url.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="200" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/change-url/change-db-shop-url.png" alt="Select table for Shop URL" align="right" ></a>When the database is open, scroll down the left side until you see the table labeled "tableinitals_shop_url".  <em>Table initials </em>usually default to "ps" but can be changed to something else during the installation process. Click on this table to select and open it. You will see the option to EDIT this table at left (as indicated in the screenshot at right).<div style="clear:both;"></div></li>
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/change-url/prestashop154-db-edit.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="200" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/change-url/prestashop154-db-edit.png" alt="Edit the URL entries in the table" align="right" ></a>Click on <strong>EDIT</strong> and then change the URL entries.  Make sure to change both the entries with the appropriate URL.  If you aren't sure about the SSL or you are not using it, simply use the same one.<div style="clear:both;"></div></li>
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/change-url/prestashop154-db-save.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="200" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/change-url/prestashop154-db-save.png" alt="Scroll to the bottom, make sure the drop-down menu on left says SAVE and click on GO" align="right" ></a>Click on <strong>GO</strong> at the bottom of the page in order to save your entries.<div style="clear:both;"></div></li>
</ol>
<p>The change of the shop URL in the database should only be done as necessary because it will affect ALL links within the shop.</p>
<p class="alert">If you have <strong>FRIENDLY URLs</strong> set, then you will need to turn this option off, save the change, then turn it back on in order to set the updated URLs in the database.  For more information on setting Friendly URLs, go to <a href="/support/edu/prestashop-15/set-configure-catalog-modes/setting-search-engine-friendly-urls">How to set up Search Engine Friendly URLs in PrestaShop 1.5</a></p>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 6: 351: How to change your site URL directly in the Database for PrestaShop 1.5</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 7: <a href='/support/edu/prestashop-15/open-magicquotes-error'>350: How to fix the fopen and magicquotes error in Prestashop</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD05OSZpZD0yNjA2JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="be12a7926f7271629f3f5f0f14bcabad" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/b6c0856c0025d26bb5b45a2b06519edf?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/b6c0856c0025d26bb5b45a2b06519edf'>Caroline Fisher</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-14 9:38 pm</div>
				                <div><p>I do not find tableinitals_shop_url anywhere.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8963);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-17 8:15 am</div>
				                <div>As stated within the note at the bottom of this article, you may need to disabled the friendly URLs, then re-enable them to see this option.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8979);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-25 1:55 pm</div>
				                <div><p>That needs to be higher on the page; I never get down to the bottom. None of this solves my problem, anyway. It was alread pointing to my domain. Only my first page works; others are blank.</p>
<p>Your answer is insulting.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9194);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-25 2:46 pm</div>
				                <div>Hello Caroline,<br />
<br />
We're sorry to hear that you're still having problems with your PrestaShop installation.  If you could please give us more information on your site (such as the URL, version of the software loaded, modules loaded, etc.), then we may be able to provide your more information or research the issue for you in order to resolve it.  We do have a close relationship with PrestaShop and would be glad to help you solve your problem.  Please provide a little more relevant information and we would be happy to continue troubleshooting the issue. <br />
<br />
Kindest regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9197);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-14229'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/2971eac60a853b3bbd20fdde248419b7?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/2971eac60a853b3bbd20fdde248419b7'>Ms_AUS</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-21 8:50 pm</div>
				                <div>Great step-by-step guide!  Easy to follow.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14229);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-25564'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/270a5108a134d3fcae0fc3238883f04c?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/270a5108a134d3fcae0fc3238883f04c'>James</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-07 1:07 am</div>
				                <div><p>Hi,</p>
<p>Was tinkering around with prestashop (options to change url, changed it to something else) then when i clicked to save it. &nbsp;The site disappeared (404). &nbsp;Tried fixing the url with the instructions on this page - cpanel but to no avail. &nbsp;Wondeirng if could get some assist? &nbsp;Thank you.</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25564);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-07 10:06 am</div>
				                <div>Hello James,<br />
<br />
Thank you for contacting us about a <a href="http://www.inmotionhosting.com/support/website/error-numbers/404-error-not-found-pages">404 error</a>. We will need some additional information to help you troubleshoot further. Does the URL stay the same when you get the 404 error?<br />
<br />
Can you provide a link to the site?<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25578);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-30366'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/dd0f946b0b0c70bc8eee2d69ac15a189?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/dd0f946b0b0c70bc8eee2d69ac15a189'>Shansana</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-02-06 5:08 am</div>
				                <div><div class="post-text">
<p>----http://localhost/project/ ---- change urls</p>
<p>In ps_shop_url table you must set domain=localhost, domain_ssl=localhost &amp; physical_uri=/myProject/</p>
<p>In ps_configuration set PS_SHOP_DOMAIN_SSL &amp; PS_SHOP_DOMAIN to localhost</p>
<p>Also go at BackOffice -&gt; Preferences -&gt; SEO &amp; URLs and click [Save] - this will regenerate your .htaccess file and will add the /myProject/ where needed.</p>
</div></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30366);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-31730'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/3f5555d750d6f31ef4051f9ae7eafa19?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/3f5555d750d6f31ef4051f9ae7eafa19'>kallmas</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-06 5:29 am</div>
				                <div><p>I copied my PS installation to a new server that has no real domain name yet, to test my new server. so i changed the url to the ip of the server and also disabled SSL. i did all steps as desecribed above but i only get the Erro 503. i also renamed the .htaccess but with no success.&nbsp;Shansana said we need also save go to the BO -&gt;SEO &amp; URLs, but how if you can't access the site?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31730);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-06 11:58 am</div>
				                <div>Hello Kallmas,<br />
<br />
Sorry for the problems with PrestaShop.  Your best bet is to use a subdomain.  PrestaShop generates many of paths based on a existing URL. You can't just use an IP address.  Also, what version of PrestaShop are you using?  Remember that this documentation was written for an older version of PrestaShop.  If you can't access the backend, then your only choice is to edit the configuration files or the  database.<br />
<br />
I hope this helps to answer your question, please let us know if you require any further  assistance.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31741);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-33076'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/1dc0bb22d20558452d18ed02950f7108?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/1dc0bb22d20558452d18ed02950f7108'>maria</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-05-31 6:35 am</div>
				                <div><p>Hi, I need to clean my PrestaShop store urls from Ids, numbers and tags. I checked one of your other article&nbsp;http://www.inmotionhosting.com/support/edu/prestashop-15/343-alter-sef-url-format where you have metnioned to change the url structure using seo and url option from backend. Anohher visitor alastair brian told about a module&nbsp;<span style="color: #232323; font-family: adelle-sans, Helvetica, Arial, sans-serif; font-size: 13px; line-height: 22px;">http://www.fmemodules.com/en/49-pretty-urls.html&nbsp;</span>that can do the same functionality.&nbsp;</p>
<p>Please let me know in this regard that turning the option of seo and urls will help me or I have to use a url cleaner module?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(33076);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-05-31 9:35 pm</div>
				                <div>The search-engine friendly URLs function well without additional support. I advise trying those first to see how they work for you, and compare that with what the module promises to do. I'm not sure how the module can improve on the rewrite function; it's a fairly straightforward parameter.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(33107);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
