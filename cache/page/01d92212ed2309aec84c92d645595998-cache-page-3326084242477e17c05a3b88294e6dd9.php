<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:52562:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/joomla-25/how-assign-custom-user-ids-in-joomla-25" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Tk748m, I spent some researching this but I did not find a clear answer. I found this article about a Joomla extension: Users Generator But, it ap..." />
  <title>How assign custom User ID's in Joomla 2.5 | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/joomla-25/how-assign-custom-user-ids-in-joomla-25" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:71ef4aaa733207a54f260e2b5ddfd8e0 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>How assign custom User ID's in Joomla 2.5</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/tk748'>tk748</a>
			<div>8 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-04-12 10:09 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>796</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Hello All,<br />
<br />
I would like to automatically assign custom user ID’s from a file (or random number generator) instead of having Joomla 2.5 automatically assign one in sequence. Can anyone tell me how to do this?<br />
<br />
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_2855' id='upvote_answer_2855' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='2855' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_2855').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_2855' id='downvote_answer_2855' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='2855' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_2855').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Tk748m,<br />
<br />
I spent some researching this but I did not find a clear answer.  I found this article about a Joomla extension:<br />
<br />
<a href="http://archive.extensions.joomla.org/extensions/miscellaneous/fake-data/5786, " target="new">Users Generator </a><br />
<br />
But, it appears to be Joomla 1.5.  I see a lot of things for a password generator, but unfortunately not for user generation in Joomla.  You might want put up a post in Joomla forums and you may get a solid answer or solution.  Otherwise, you may want try asking a developer for help in creating the solution you need.<br />
<br />
...
<br />
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_2855').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_2855' id='form_comment_on_answer_2855' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hi Arnel C.<br />
<br />
Thank you for responding to my question. I too have researched this topic with similar results. I know the User_ID's are generated from somewhere in Joomla but I can't discover how to access that file or modify it. I will keep looking.</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='/support/images/avatars/default_avatar.jpg' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/tk748'>tk748</a><br />
									8 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2013-04-12 6:26 pm EST
								</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/joomla-25/how-assign-custom-user-ids-in-joomla-25&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/joomla-25/how-assign-custom-user-ids-in-joomla-25'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="ceb850a7713a21146ba6616067f631e3" value="1" />	</div>
	</form>
<!-- <br />
