<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:52886:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/email/how-to-send-an-gnupg-encrypted-email-message-on-webmail" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Parlox, Thanks for the question about sending encrypted email through webmail. Currently, this is not something you can do through the webmail cli..." />
  <title>How to send an GnuPG encrypted email message on webmail? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/email/how-to-send-an-gnupg-encrypted-email-message-on-webmail" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:4c3b4b1f9d38d0676700942c5046bbb7 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-20']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '5.172.47.98']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>How to send an GnuPG encrypted email message on webmail?</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='https://lh5.googleusercontent.com/-rinGVNSgK-0/AAAAAAAAAAI/AAAAAAAAAAA/meTeUD1mkqQ/photo.jpg?sz=90' class='user_avatar' /><br />
			<a href='/support/community-support/users/parlox'>parlox</a>
			<div>18 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-05-04 11:59 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>266</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I have already imported my GnuPG public and private key on the cpanel section for encryption.<br />
<br />
Now, I would really appreaciate if you can tell me how to send an encrypted email message on webmail.</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_7173' id='upvote_answer_7173' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='7173' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_7173').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_7173' id='downvote_answer_7173' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='7173' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_7173').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Parlox,<br />
<br />
Thanks for the question about sending encrypted email through webmail.  Currently, this is not something you can do through the webmail clients that are provided with your account.  Check out this <a href="http://lifehacker.com/how-to-encrypt-your-email-and-keep-your-conversations-p-1133495744" rel="nofollow" target="_blank">Lifehacker article</a> about sending encrypted email.  The Thunderbird option would probably be easiest (and free), but you would have to setup Thunderbird for your computer using your <a href="http://www.inmotionhosting.com/support/edu/everything-email/introduction-email/how-to-find-email-settings">email settings</a>.<br />
<br />
...
Arnel C.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_7173').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_7173' id='form_comment_on_answer_7173' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
...
<br />
Considering what you commented, could you explain to me the purpose for the &quot;encryption&quot; option on Cpanel?<br />
<br />
I am using Enigmail on Thunderbird and it has been a great option. <br />
<br />
Thank you.</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='https://lh5.googleusercontent.com/-rinGVNSgK-0/AAAAAAAAAAI/AAAAAAAAAAA/meTeUD1mkqQ/photo.jpg?sz=90' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/parlox'>parlox</a><br />
									18 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2015-05-05 1:12 pm EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello Parlox,<br />
<br />
It's a great question as I've haven't used it myself.  The GNUpg  option under security (the "encryption" option, I think you're referring to as there's nothing labeled "encryption" in cPanel) is used to generate keys that can be used for encryption of messages.  These keys are used within SSH or within code in order to encrypt messages that are being sent or received.  You can also create code that sends encrypted messages.  Here's an example of that from a <a href="http://stackoverflow.com/questions/1398703/how-to-use-gnupg-and-crypt-gpg" rel="nofollow" target="_blank">post from StackOverflow</a> that discusses that option.  The key generator is simply a convenience to allow for the quick creation of these keys for email addresses that you can create within cPanel.  <br />
<br />
I hope this helps to answer your question, please let us know if you require any further  assistance.<br />
<br />
Regards,<br />
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="21364f1da29b9fa8eda29aeb16d3e491" value="1" />	</div>
	</form>
<!-- <br />
