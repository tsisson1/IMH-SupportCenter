<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:58589:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/error-numbers/403-forbidden-error" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-10-07T18:35:54-07:00" />
  <meta name="keywords" content="403 error forbidden website troubleshooting" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="Learn about the 403 Forbidden error message and how to correct it." />
  <title>403 Forbidden Error - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/error-numbers/403-forbidden-error" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:bacea11df7e1ca8140317a89fdccdacb -->
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>28,491</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Sep 19, 2011'><span style='color:#606060;'>Published:</span> Oct 7, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>There are many different types of errors that can happen when building a website. One of the more common ones is the <em>403 Forbidden Error</em>. Here we discuss this error and what you can do about it.</p>
<p>The two most common causes of a "<strong>403 Forbidden</strong>" error are:</p>
<ul>
<li><strong>Incorrect File Permissions</strong></li>
<li><strong>"No Index" in .htaccess file is improperly used</strong></li>
</ul>
<h2>Correcting a 403 Forbidden Error</h2>
<ol class="article_list">
<li>First, you will want to <strong>check the file permissions</strong> that each of your files has set. If a file or folder is set to "<strong>777</strong>" which is "<strong>world</strong>" writable for security reasons the 403 error will be displayed to protect your website from hacks. Folders should have the permissions set to "<strong>750</strong>" or "755" and files should be set to "644"</li>
<li>Once you have verified all the permissions are correct and the issue still persists, you will need to <strong>check your .htaccess file</strong>. Please keep in mind that you can have multiple .htaccess files in your account, so you may need to search / modify .htaccess files other than public_html/.htaccess. For example, if you have an addon domain located at public_html/addon_domain, you'll need to check any .htaccess files within that folder as well. If one of the lines in the actual file says "<strong>Options All -Indexes</strong>" then simply<strong> remove "-Indexes"</strong> and <strong>save the file</strong>.</li>
</ol>
<p>At this point if the issue still persists please <a href="/support/website/website-troubleshooting/how-to-get-great-technical-support">contact support for further assistance</a> in diagnosing the 403 forbidden error message.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/error-numbers/403-forbidden-error&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/error-numbers/403-forbidden-error'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MTAmaWQ9MjM5JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/file-management/403-error-after-moving-quarantined-files-back-to-publichtml?tsrc=rsbraq'>403 Error after moving quarantined files back to public_html</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support//?tsrc=rsbraq'>I cannot log into wordpress admin panel</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/wordpress/wordpress-image-upload-displays-403-error-links-are-broken?tsrc=rsbraq'>Wordpress image upload displays 403 error. Links are broken</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/wordpress/posts-not-loading-on-mobile?tsrc=rsbraq'>Posts not loading on mobile</a>
                                </div>
