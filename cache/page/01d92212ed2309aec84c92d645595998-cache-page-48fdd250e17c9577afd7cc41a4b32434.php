<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:51238:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/cpanel/i-reset-my-password-and-i-still-cant-log-onto-cpanel" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, Sorry to hear you're having problems with the cPanel password. Typically, you can easily change the password using the instructions from our Supp..." />
  <title>I reset my password and I still can't log onto cpanel | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/cpanel/i-reset-my-password-and-i-still-cant-log-onto-cpanel" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:8621d7364ae9376d3b7bb1c17e93ab77 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>I reset my password and I still can't log onto cpanel</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2014-02-12 2:58 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>273</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I reset my password yesterday and I still can't log onto cpanel</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_4526' id='upvote_answer_4526' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='4526' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_4526').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_4526' id='downvote_answer_4526' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='4526' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_4526').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
Sorry to hear you're having problems with the cPanel password.  Typically, you can easily change the password using the <a href="http://www.inmotionhosting.com/support/edu/cpanel/getting-started-cpanel/change-password">instructions</a> from our Support Center, but it does require that you know your original password.  The cPanel login also uses a different user name.  So, if you're having problems with it, you need to re-visit how to find your <a href="http://www.inmotionhosting.com/support/website/amp/what-is-my-username-and-password">cPanel user name</a>.  The quickest way to get this resolved is to simply contact our live <a href="http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support">technical support team</a> available 24/7.  You can contact them via phone/chat/email.  As per the notes in your record, it does appear that you have contacted them already and resolved the issue.<br />
<br />
Regards,<br />
Arnel C.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_4526').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_4526' id='form_comment_on_answer_4526' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/cpanel/i-reset-my-password-and-i-still-cant-log-onto-cpanel&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/cpanel/i-reset-my-password-and-i-still-cant-log-onto-cpanel'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="ea19ca493ac2bb8247cb31713cb531dd" value="1" />	</div>
	</form>
<!-- <br />
