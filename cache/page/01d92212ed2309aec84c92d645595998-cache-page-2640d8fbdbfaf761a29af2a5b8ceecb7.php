<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50771:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/cpanel/website-is-displaying-asp-code-after-uploading-on-server" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, As our servers are using Linux Operating Systems, they will not display pages designed using Microsoft proprietary code or design. Sites that are..." />
  <title>Website is displaying asp code after uploading on server | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/cpanel/website-is-displaying-asp-code-after-uploading-on-server" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:17666bec6eebcf0b68ce55fdd55f0ad5 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '107.167.104.144']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Website is displaying asp code after uploading on server</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='https://lh4.googleusercontent.com/-O_Xm1jclAHk/AAAAAAAAAAI/AAAAAAAAAO8/pu831Ow21s0/photo.jpg?sz=90' class='user_avatar' /><br />
			<a href='/support/community-support/users/tpawar1992'>tpawar1992</a>
			<div>8 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2014-09-25 2:20 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>250</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Hello,<br />
I need some favor, actually I have uploaded my website on server.but it is in .net architecture.It all contains .aspx pages not .html. I uploaded that but these pages are showing asp code on my website.what should I have to do? uploaded website on cPanel. <br />
</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_5695' id='upvote_answer_5695' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='5695' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_5695').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_5695' id='downvote_answer_5695' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='5695' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_5695').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
As our servers are using Linux Operating Systems, they will not display pages designed using Microsoft proprietary code or design. Sites that are in aspx or designed for .net will not work, they only work on Windows based servers. Our servers will display and run sites coded with html, php, perl, and ruby while using MySQL (as opposed to MSSQL).<br />
<br />
Kindest Regards,<br />
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_5695').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_5695' id='form_comment_on_answer_5695' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/cpanel/website-is-displaying-asp-code-after-uploading-on-server&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/cpanel/website-is-displaying-asp-code-after-uploading-on-server'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="e579db5af9d1b2b86753236885850b31" value="1" />	</div>
	</form>
<!-- <br />
