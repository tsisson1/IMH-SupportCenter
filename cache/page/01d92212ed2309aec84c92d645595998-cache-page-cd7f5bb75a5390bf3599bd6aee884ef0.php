<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:56724:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/email/bounceback-errors/email-error-551" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-05-02T16:11:17-07:00" />
  <meta name="keywords" content="email e-mail error 551 bounce bounceback bounce-back error errors message messages" />
  <meta name="author" content="Jacob Nicholson" />
  <meta name="description" content="551 email errors are normally encountered when there is an attempted delivery to a mail server that doesn't handle mail for the specified recipient." />
  <title>Email error 551 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/email/bounceback-errors/email-error-551" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:55670a8b873c62f0ce7f53a651e6ea04 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-22']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '212.2.219.147']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Email error 551</span></li>			</ul>
		</div>
	</div>
</div>
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>8,707</span></div>
							...
							<div style='clear:both;'></div>
								...
								<p>A&nbsp;<strong>551 email error</strong>&nbsp;is normally ecountered when there is an attempted delivery to a mail server that doesn't handle mail for the specified recipient.</p>
<p>You should receive a bounce-back message from the server with a variation of&nbsp;<strong>email error 551</strong>&nbsp;in the subject, and the body should contain your original message that you attempted to deliver.</p>
<h2>Example bounce-back message</h2>
<div class="cli">
  <p>Return-path: &lt;&gt;<br />Envelope-to: <strong>sender@example.com</strong><br />Delivery-date: Thu, 25 Oct 2012 11:19:59 -0700<br />Received: from mailnull by biz100.inmotionhosting.com with local (Exim 4.77)<br />id 1TRS2B-00033h-Fn<br />for <strong>sender@example.com</strong>; Thu, 25 Oct 2012 11:19:59 -0700<br />X-Failed-Recipients: <strong>recipient@RemoteDomain.com</strong><br />Auto-Submitted: auto-replied<br />From: Mail Delivery System &lt;Mailer-Daemon@biz100.inmotionhosting.com&gt;<br />To: <strong>sender@example.com</strong><br />Subject: <a href="/support/email/email-troubleshooting/mail-delivery-failed-returning-message-to-sender">Mail delivery failed: returning message to sender</a><br />Message-Id: &lt;E1TRS2B-00033h-Fn@biz100.inmotionhosting.com&gt;<br />Date: Thu, 25 Oct 2012 11:19:59 -0700</p>
...
<div>&nbsp;</div>
<div><strong>recipient@RemoteDomain.com</strong><br />SMTP error from remote mail server after RCPT TO:&lt;<strong>recipient@RemoteDomain.com</strong>&gt;:<br />host RemoteDomain.com [123.123.123.123]:<br /><strong>551 not our customer</strong></div>
<div>&nbsp;</div>
<div>------ This is a copy of the message, including all the headers. ------</div>
<div>&nbsp;</div>
<div>Return-path: &lt;<strong>sender@example.com</strong>&gt;<br />Received: from bell.ca ([123.123.123]:42593 helo=Admin)<br />by biz100.inmotionhosting.com with esmtpa (Exim 4.77)<br />(envelope-from &lt;<strong>sender@example.com</strong>&gt;)<br />id 1TRS1q-0002fq-S4; Thu, 25 Oct 2012 11:19:39 -0700<br />Date: Fri, 26 Oct 2012 00:03:21 +0600<br />From: Sender &lt;<strong>sender@example.com</strong>&gt;<br />MIME-Version: 1.0<br />To: &lt;<strong>recipient@RemoteDomain.com</strong>&gt;<br />Subject: Meeting proposal</div>
</div>
<h2>Common variations of the 551 email error</h2>
<ul>
<li>551 5.1.1 recipient is not exist</li>
<li>551 5.1.1 user does not exist</li>
<li>551 Denied IVF<br /><br /></li>
<li>551 not our customer</li>
<li>551 recipient@RemoteDomain.com failed to route the address</li>
<li>551 &lt;recipient@RemoteDomain.com&gt;... User not locali</li>
<li>551 Relay request denied</li>
<li>551 This is not a relay host - mail must be to or from host domain.</li>
<li>551 Unknown user.</li>
<li>551 User not local. Authentication required for relay</li>
<li>551 User not local; please try &lt;forward-path&gt;</li>
</ul>
<h2>Resolving a 551 email error bounceback</h2>
<div>
<p>The 551 series of errors would typically be a hard bounce. For an in-depth review on the differences between soft and hard bounces, and general email bounceback reasons you can read&nbsp;<a href="/support/email/email-troubleshooting/email-bounce-bounceback-error">why does email bounce, bounceback, or error?</a></p>
<p>In our example bounce-back error above the reason the message has failed is because the server for&nbsp;<strong>RemoteDomains.com&nbsp;</strong>doesn't control mail for the&nbsp;<strong>recipient@RemoteDomain.com&nbsp;</strong>e-mail address.&nbsp;</p>
</div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/email/bounceback-errors/email-error-551&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/email/bounceback-errors/email-error-551'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NjImaWQ9NzgyJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="82afc8840f4fbc9bea71f5decb2dc882" value="1" />	</div>
	</form>
<!-- <br />
