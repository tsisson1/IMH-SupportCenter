<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:71756:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/what-is/speed-up-php-with-apc" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-07-04T22:29:05-07:00" />
  <meta name="keywords" content="speed up php apc memory cache caching optimize memcache memcached" />
  <meta name="author" content="Jacob Nicholson" />
  <meta name="description" content="APC or Alternative PHP Cache is a free open-source opcode (operation code) caching plugin for PHP. With APC setup on your server, your PHP script executions can be optimized to run more efficiently, by cutting down on needless dynamic PHP executions." />
  <title>Speed up PHP with APC - Alternative PHP Cache - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/what-is/speed-up-php-with-apc" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:d4fdf88fdc83465b344dd64231790530 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-22']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '59.91.148.223']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/website/what-is' itemprop='url'><span itemprop='title'>What Is...<span></a><div class='dropdown_3columns'><div class='col_3'><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/what-is/speed-up-php-with-apc'>Speed up PHP with APC - Alternative PHP Cache</a> (50451 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/what-is/how-to-enable-gzip-moddeflate'>An introduction to gzip / mod_deflate</a> (48622 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/what-is/what-are-core-dumps'>What are Core Dumps?</a> (12944 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/what-is/what-is-a-ddos-attack'>What is a DDOS Attack?</a> (9153 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/what-is/introduction-memcached-server-side-caching'>Introduction to Memcached: server side data caching</a> (8508 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/what-is/what-is-ioncube'>What is IonCube?</a> (7710 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/what-is/what-is-a-content-delivery-network-cdn'>What is a Content Delivery Network (CDN)?</a> (6327 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/what-is/what-is-cgi'>What is CGI?</a> (4880 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/what-is/what-is-jquery-and-can-i-use-it'>What is jQuery and can I use it?</a> (4809 hits)</div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Speed up PHP with APC - Alternative PHP Cache</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Speed up PHP with APC - Alternative PHP Cache									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>50,451</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Oct 31, 2012'><span style='color:#606060;'>Published:</span> Jul 4, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p><strong>APC</strong> or <strong>Alternative PHP Cache</strong>, is a free open-source opcode (operation code) caching plugin for PHP. With APC caching your PHP script executions can run more efficiently, by cutting down on dynamic PHP executions.</p>

<p>If you already know about APC, you might like to go ahead and skip to our guide on <a href="http://www.inmotionhosting.com/support/website/php-configuration/install-apc-for-php" target="_blank">how to install APC</a>.</p>

<p>We also have a guide that covers how to <a href="http://www.inmotionhosting.com/support/website/php-configuration/view-and-clear-php-apc-cache" target="_blank">view and clear the APC cache</a>.</p>

<div>
<img src="//cdn.inmotionhosting.com/support/images/stories/website/apc/php-apc-cache.png" alt="PHP APC cache example" />
</div>

<h2>Why would you want to install APC?</h2>

<p>PHP is a dynamic scripting language, so every time there is a request for a page, the server must first parse the code in your PHP script in order to generate the resulting HTML code seen by a visitor's web-browser.</p>

<p>PHP is ideal for web pages that have content that is constantly updated, since each visitor gets a fresh copy of the page. So for instance if you have your PHP script pulling data from a database, as soon as there is new data in the database, it will automatically be in the generated HTML code for the next visitor requesting that page as well.</p>

<p>In most cases the need to re-run PHP scripts for data that might not have changed in the first place, can be taxing on the server. By implementing APC you cut down on repeat PHP script executions, skipping the parsing and compiling steps. APC stores the opcode, and that is simply executed each time the script is called again.</p>

<h2>What's the difference between APC and other types of caching?</h2>

<p>APC for PHP is one of the most widely used PHP opcode caching solutions in use today. You can utilize APC on a VPS &nbsp;or dedicated server that is running PHP as either DSO or FastCGI. You might want to read about <a href="/support/website/general-server-setup/choosing-the-best-php-handler" target="_blank">choosing the best PHP handler</a> for your specific needs, and also a more in-depth explanation on what DSO and FastCGI are.</p>

<p>Another common caching module is <a href="/support/website/website-troubleshooting/introduction-memcached-server-side-caching" target="_blank">Memcached</a>, and the main difference between it and APC is that Memcached is distributed and more robust generic caching platform, while APC is specific to PHP. APC is great when you need local caching of objects for your PHP scripts that are relatively small and frequently accessed.</p>

<h2>How to install APC</h2>

<p>APC is a PECL module that can be loaded into PHP, but because it operates at the server-level it can not be run on our <a href="http://www.inmotionhosting.com/business-hosting" target="_blank">shared hosting servers</a>. If you are on a <a href="http://www.inmotionhosting.com/vps_hosting.html" target="_blank">VPS</a> or <a href="http://www.inmotionhosting.com/dedicated_servers.html" target="_blank">dedicated server</a> and are comfortable installing PECL modules, then you can go ahead and install APC yourself.</p>

<p>Or if you prefer our system administration department can setup APC on your server for you. If this is something that you'd like to take advantage of please <a href="/support/website/website-troubleshooting/how-to-get-great-technical-support" target="_blank">contact our support department</a>.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/what-is/speed-up-php-with-apc&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/what-is/speed-up-php-with-apc'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MTUmaWQ9NDU3JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="c5227897a3de904841b1fe8e2e06b88a" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/server-usage/install-dedicated-server-software?tsrc=rsbraq'>Installation of Software on dedicated server</a>
                                </div>
...
<a name='comments'></a>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						...
						<div><a style='font-size:16px;' href='/support/community-support/users/MaxPower'>MaxPower</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-03-23 8:54 pm</div>
				                <div>I would love some direction on installing APC on an Inmotion VPS. Need to speed up some Magento sites.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(7604);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-8195'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='https://lh5.googleusercontent.com/-2MyEPj4oORs/AAAAAAAAAAI/AAAAAAAABAo/-d4pZg30x1Q/photo.jpg?sz=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='/support/community-support/users/tpradebe'>tpradebe</a></div>
						<div></div>
						<div></div>
						<div>3 <a href='/support/team/points' target='_blank'>Points</a></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-09-06 11:44 am</div>
				                <div>I'm looking for a good hosting with APC pre-installed, do you do that?</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8195);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-09-06 12:12 pm</div>
				                <div>Hello Tpradebe,<br />
<br />
Thanks for the question.  As per the last paragraph above, we do not support the installation of APC on our shared servers, but you can either install it yourself or have it installed on our VPS/Dedicated server solutions.  <br />
<br />
There's a simple shell command to install APC on a VPS or Dedicated server (you have to be logged into the shell):  pecl install apc.  You can find more information here:  <a href="http://stackoverflow.com/questions/6905087/how-to-install-apc-on-centos-5-6" rel="nofollow" target="new">How to install APC</a>.  <br />
<br />
I hope this helps to answer your question.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8196);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-22360'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/d3b01f3ac924db251883e443bff26cdf?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/d3b01f3ac924db251883e443bff26cdf'>filmrally.com</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-05 5:26 pm</div>
				                <div><p>Thanks for the post going to try and install APC and test it out hope it does good with the caching...</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22360);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-13 9:18 am</div>
				                <div>APC install is simple if you have the right procedure. Unfortunately there is a lot of bad install advice out there on the net! You really need to do it the cPanel/WHM way as others will just FUBAR your install. The tricky part is to get apc.so in your [/usr/local/lib/php/extensions/no-debug-non-zts-XXXXXXXX/apc.so], otherwise [Home]/usr/local/lib/php.ini will not work.<br />
<br />
Your php.ini ([Home]/usr/local/lib/php.ini) should have [extension=&quot;apc.so&quot;] (without the brackets) where you load your extensions. It will find it in  [/usr/local/lib/php/extensions/no-debug-non-zts-XXXXXXXX/] (current one used). As in WHM Home »Service Configuration »PHP Configuration Editor advanced mode Section [CORE ] , Directive [extension], Value [pdo.so, pdo_mysql.so, apc.so]<br />
After this you should be able to restart Apache and use &gt;&gt;Home »Service Configuration »PHP Configuration Editor &gt;&gt; in WHM, in Advanced Mode.<br />
If not them you php.ini should have something like this (values depend on you needs).<br />
;;;;;;;;;;;;;;;;;;;<br />
; Module Settings ;<br />
;;;;;;;;;;;;;;;;;;;<br />
<br />
...
apc.user_entries_hint = 1000<br />
apc.mmap_file_mask = &quot;/tmp/apc-LoginName.XXXXXX&quot;<br />
apc.enable_cli = 1<br />
apc.cache_by_default = 1<br />
apc.max_file_size = 2M<br />
apc.stat = 1<br />
See this link http://php.net/manual/en/apc.configuration.php<br />
Good day James Niland</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24817);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
