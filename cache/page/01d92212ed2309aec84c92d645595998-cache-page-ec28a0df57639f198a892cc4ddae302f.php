<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:63114:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/cpanel/softaculous/create-backup" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-08-12T18:18:41-07:00" />
  <meta name="keywords" content="softaculous restore backup download" />
  <meta name="author" content="John-Paul Briones" />
  <meta name="description" content="In this tutorial, we'll show you how to generate and restore backups using Softaculous." />
  <title>How to Back up your Website with Softaculous - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/cpanel/softaculous/create-backup" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:d19b089cbada14a166185cce841f1fe2 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '66.65.129.159']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to Back up your Website with Softaculous									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>8,024</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Aug 22, 2012'><span style='color:#606060;'>Published:</span> Aug 12, 2015</div>
							...
							<div style='clear:both;'></div>
								...
								<iframe width="560" height="315" src="https://www.youtube.com/embed/LJlXk17tbjU" frameborder="0" allowfullscreen></iframe>
<div class="in_this_tutorial">
<h2>In this tutorial:</h2>
<button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('create');">Create a Backup</button>
<button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('download');">Download your Backup</button>
</div>
<p>If you used Softaculous to <a href="/support/edu/cpanel/softaculous/how-to-install">install a program</a>, you can also use Softaculous to generate a backup of your website. It's important to backup both your website files and your website's database, and Softtaculous makes both of these tasks easy.</p>
<p>In this tutorial, we'll cover creating, and Downloading a backup. Our next tutorial will show you <a href="/support/edu/cpanel/softaculous/restore-backup">How to Restore a Softaculous Backup</a>.</li>

<a name="create"></a>
<h2>To create a backup of your website using Softaculous:</h2>
<ol class="article_list">
<li><a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">Log into your cPanel</a></li>
<li>Click the <strong>Softaculous</strong> link under the <em>Software/Services</em> section</li>
<li>In the top right of the page, click the <strong>Application Installs</strong>&nbsp;link (which is the icon that looks like a down arrow)</li>
<li>Within the list of applications, <strong>click the backup icon</strong> to the far right (which looks like a zipped folder) of the website you want to backup</li>
<li>Under <em>Backup Installation</em>, check either or both boxes to the right of <strong>Backup Directory</strong> and <strong>Backup Database</strong>.</li>
<li>Click the <strong>Backup Installation</strong> button at the bottom of the page.<br /><br />You will see a progress bar appear on the screen showing you how much time is left in the backup process. When the backup is completed, you'll see the following message:<br /><br /><em>The backup was created successfully. You can download it from the Backups page.</em><br /><br />If you click that <em>Backups</em> link, you'll be taken to a page where you can download a copy of the backup created. You can also find the backups using either FTP or the cPanel file manager. They will be located within the root of your account in a folder named <strong>softaculous_backups</strong>.</li>
</ol>

<p><a name="download"></a></p>
<h2>To download the backup just created by Softaculous</h2>
<ol class="article_list">
<li><a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">Log into your cPanel</a></li>
<li>Click the <strong>Softaculous</strong> link under the <em>Software/Services</em> section</li>
<li>In the top right of the page, click the Backup and Restore link (which is the icon that looks like a CD)</li>
<li>On this page you will see a list of backups you've previously created. Click the File Name next to the backup that you would like to download. Your browser will then begin to download the backup file.<br /><br />Take note that the File Name of each backup includes the date and time the backup was generated. For example, if you have a backup named wp.26_97098.<span style="color: #ff0000;"><strong>2012-08-22</strong></span>_<span style="color: #008000;"><strong>17-32-20</strong></span>.tar.gz, the backup was generated <strong><span style="color: #ff0000;">August 22nd, 2012</span></strong> at <span style="color: #008000;"><strong>5:32pm</strong></span>.<br /><br /></li>
<li>Once you've downloaded your backup locally it's important to remove old Softaculous backups that are no longer of any use. You can simply click on the red&nbsp;<strong>X</strong> beside each older backup to remove them one by one, or you can place a check mark in the column with the down arrow beside each backup, then with the <b>With Selected:</b> drop-down select&nbsp;<strong>Remove Backup</strong> and then click on&nbsp;<strong>Go</strong>.</li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 10: How to Back up your Website with Softaculous</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 9: <a href='/support/edu/cpanel/softaculous/softaculous-update-rollback'>Softaculous Auto Upgrade and Rollback</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 11: <a href='/support/edu/cpanel/softaculous/restore-backup'>How to Restore a Softaculous Backup</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/cpanel/softaculous/create-backup&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/cpanel/softaculous/create-backup'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNTcmaWQ9MTcxMiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="1c9935a3c73b1aede3dbe01208a3f789" value="1" />	</div>
	</form>
<!-- <br />
          ...
          <tr >
			...
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/file-management/status-of-backup-uncertain?tsrc=rsbraq'>Status of backup uncertain</a>
                                </div>
