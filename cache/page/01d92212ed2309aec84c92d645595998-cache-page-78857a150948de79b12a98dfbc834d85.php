<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:59119:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/email/mailing-lists/import-csv-into-phplist" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2011-12-21T16:03:20-08:00" />
  <meta name="keywords" content="import email addresses bulk csv phplist" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="In this tutorial, we'll show you how you can import a CSV file full of email addresses into phpList." />
  <title>How to import a CSV file of email addresses into phpList - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/email/mailing-lists/import-csv-into-phplist" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:db52df471aa82e30675c8d35e5dabac9 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '104.6.204.199']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to import a CSV file of email addresses into phpList									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>7,756</span></div>
							...
							<div style='clear:both;'></div>
								...
								<p>During <a href="/support/email/mailing-lists/install-php-list">our testing of phpList</a> and the <a href="/support/email/mailing-lists/rate-limit-phplist">rate limiting feature</a> it has available, we had the need to import a large number of email addresses into a mailing list. Just like us, if you already have a list of email addresses and you need to import them into phpList, you'll need to also know how to import email addresses in bulk.</p>
<p>In our example, we imported a CSV file with almost 400 email addresses in it. This is what part of our CSV file looked like:</p>
<p class="code_block">bulk000@inmotiontesting.com,bulk001@inmotiontesting.com,bulk002@inmotiontesting.com,bulk003@inmotiontesting.com</p>
<p>As you can see, it is a simple text file full of email address, and each email address is separated by a comma.</p>
<p><strong>To import a CSV file into phpList:</strong></p>
<ol>
<li>Log into your phpList Admin (if you're following along with our example, we visited phplist.inmotiontesting.com/phplist/admin)</li>
<li>Click "Manage Users" in the right menu</li>
<li>Click "Import Users"</li>
<li>Click the link, "import emails with the same values for attributes."</li>
<li> 
<ul>
<li>At the top of the page you'll see a list of your mailing lists. Check the lists that you would like to import the email addresses to.</li>
<li>Next to "File containing emails", click browse and select the CSV file on your computer</li>
<li>For "Record Delimiter", enter a comma ,</li>
<li>If you want all of the email addresses to be sent a confirmation message before they are subscribed, select the "Send Notification email" option. Otherwise, to automatically subscribe each user, click "Make confirmed immediately"</li>
<li>Click "Import"<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/phplist/mass_import_page_screen_in_phplist.gif"><img  alt="mass_import_page_screen_in_phplist" src="//cdn.inmotionhosting.com/support/images/stories/phplist/mass_import_page_screen_in_phplist.gif" /></a></li>
</ul>
</li>
<li>When the import has been successful, you should see a page similar to the below:<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/phplist/what-it-looks-like-after-importing-users-into-phplist.gif"><img  alt="what-it-looks-like-after-importing-users-into-phplist" src="//cdn.inmotionhosting.com/support/images/stories/phplist/what-it-looks-like-after-importing-users-into-phplist.gif" /></a></li>
</ol>
<p><br />To confirm that you have imported the users, click "lists" in the right menu. The list you subscribed your users to should have increased:<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/phplist/successful-phplist-import.gif"><img  alt="successful-phplist-import" src="//cdn.inmotionhosting.com/support/images/stories/phplist/successful-phplist-import.gif" /></a></p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/email/mailing-lists/import-csv-into-phplist&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/email/mailing-lists/import-csv-into-phplist'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNCZpZD03Njcmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="414e74085f3f6333274402de8eb3b185" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						...
						<div><a style='font-size:16px;' href='/support/community-support/users/Bellytwins'>Bellytwins</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2011-12-23 8:45 pm</div>
				                <div>Hello,<br />
<br />
I am trying to import a .csv file with names and other information. I have each column labeled and I dont see why it wouldn't work but the upload keeps giving me the error that it can't find an &quot;email&quot; column. Any information on this would help greatly. As well a tutorial on this type of list and not just an email list. <br />
<br />
Thanks<br />
Aaron</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(5844);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2011-12-27 12:35 pm</div>
				                <div>Hi Bellytwins,<br />
<br />
Thanks for posting your comment. I'm more than happy to assist you today. It sounds as if the issues you are having can be resolved by following the link to the tutorial below:<br />
<a href="http://docs.phplist.com/ImportUsersWalkthrough" target="_blank">http://docs.phplist.com/ImportUsersWalkthrough</a> <br />
<br />
...
<br />
Tim S</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(5854);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
