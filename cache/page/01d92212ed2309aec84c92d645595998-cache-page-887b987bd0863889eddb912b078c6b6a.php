<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:72237:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/wordpress/turning-on-wordpress-debugging" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-03-30T20:46:54-07:00" />
  <meta name="author" content="Jeff Matson" />
  <meta name="description" content="In this article, we will teach you how to turn on debugging in WordPress to show any possible errors produced." />
  <title>Turning on WordPress debugging - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/wordpress/turning-on-wordpress-debugging" rel="canonical" />
...
<script>
  ...
  ga('send', 'pageview');
	...
	<!-- cid:ce84523f1e4d43f3e49975e7f7e718b7 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '80.28.203.4']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Turning on WordPress debugging									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>4,800</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 28, 2014'><span style='color:#606060;'>Published:</span> Mar 30, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<iframe width="560" height="315" src="https://www.youtube.com/embed/Nj2ziU6_0F8" frameborder="0" allowfullscreen></iframe>
<p>In this article, we will teach you how to turn WordPress debugging on.  With debugging turned on, it is much easier to locate any errors within your WordPress site as well as any plugins and themes that may be causing errors.</p>
<h2>Enabling WordPress debugging within your wp-config.php using the cPanel File Manager</h2>
<p>WordPress debugging is something that is enabled within your wp-config.php file.  With just a simple edit to this file, you will be able to view any errors produced within WordPress.</p>
<ol class="article_list">
<li style='clear:both;'><p>First, be sure that you are <a href="http://www.inmotionhosting.com/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">logged into cPanel</a>.</li></p>
<li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress/wordpress-debugging-1.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress/wordpress-debugging-1.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>Now that you are logged into cPanel, look for the icon that says <strong>File Manager</strong> and click on it.</p></li>
<li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress/wordpress-debugging-2.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress/wordpress-debugging-2.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>Within your <em>public_html</em> directory, you will see a file labeled <em>wp-config.php</em>.  Right-click on it, then click on <strong>Code Editor</strong>.</p></li>
<li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress/wordpress-debugging-3.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress/wordpress-debugging-3.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>At the bottom of your wp-config.php file, add the following lines:</p><p class="code_block">define( 'WP_DEBUG', true );<br>define( 'SCRIPT_DEBUG', true );</p><p>The first line will cause WordPress to display any errors caused by various PHP functions that are built into WordPress.  The second line will display any errors for WordPress' built-in JavaScript and CSS.</li>
<li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress/wordpress-debugging-4.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress/wordpress-debugging-4.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>After you have edited the <em>wp-config.php</em> file, be sure to save your changes by clicking on the <strong>Save Changes</strong> button at the top right of the file manager.</p></li>
<div style='clear:both;'></div>
</ol><br>
<p>Now that the you have enabled debugging within WordPress, you should now be able to see any errors that are produced within your WordPress site.</p> 
...
<div style='display:inline-block;'>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD02MyZpZD0zMDgxJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="734462fe6c81140fef6a7bb7cc05089f" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/wordpress/cant-generate-wordpress-logs?tsrc=rsbraq'>No error logs in WordPress</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/wordpress/an-internal-error-occurred?tsrc=rsbraq'>An internal error occurred: 50EF66525DC49.ABCD106.3E00735D </a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/wordpress/cant-access-my-wordpress-multiste-login-but-my-sites-are-loading?tsrc=rsbraq'>Can't access my Wordpress multiste login but my sites are loading</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/wordpress/cannot-update-wp-database?tsrc=rsbraq'>Cannot Update WP Database</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/wordpress/my-themes-are-not-installing-as-expected?tsrc=rsbraq'>My themes are not installing as expected. </a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/wordpress/issues-with-w3tc-and-super-cache-in-wordpress?tsrc=rsbraq'>Issues with W3TC and Super Cache in Wordpress</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/google-tools/recent-problem-with-sharing-links-from-site-on-google?tsrc=rsbraq'>Recent problem with sharing links from site on Google+</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/wordpress/cant-see-wp-media-library?tsrc=rsbraq'>can't see wp media library</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/dfa65adc14a42bf58a9845458f4fc73f?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/dfa65adc14a42bf58a9845458f4fc73f'>Lea </a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-20 10:21 pm</div>
				                <div><p>after i put the code into the file.&nbsp; how do i get the site to start the debugging process.&nbsp; I dont' know what step to take next and I cannot locate the email any more.</p>
<p>&nbsp;</p>
<p>Thank you for any and all assistance!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17682);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-21 9:20 am</div>
				                <div>Hello Lea,<br />
<br />
After turning on wordpress debugging, any php errors, warnings, or notices will be displayed. So essentially you would try to get an error for what ever the reason you needed the wordpress debugging on to start with.<br />
<br />
Kindest Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17697);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-32646'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/2d21d324097e5a1f3192f5b6684c3d55?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/2d21d324097e5a1f3192f5b6684c3d55'>jim</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-05-12 7:52 pm</div>
				                <div><p>well that didn't work either, gave me nothing but errors, my issue is with the new version of wordpress, my classified site was good with 4.5, but upgrade to 4.5.1 &amp; 2 I get the auto draft message instead of the actual post, I just tried on my localhost site with older version of same theme and works great, but once update the wordpress I get auto draft..</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32646);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-05-12 8:13 pm</div>
				                <div>I recommend trying some of the other <a href="http://www.inmotionhosting.com/support/website/website-troubleshooting/common-wordpress-troubleshooting-techniques">WordPress troubleshooting</a> techniques to narrow down the cause.<br />
<br />
What are the errors you are getting?<br />
<br />
Best Regards,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32647);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
