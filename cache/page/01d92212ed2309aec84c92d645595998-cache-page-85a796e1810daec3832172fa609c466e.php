<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:57963:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/wordpress/unable-to-import-demodummy-data-content-for-wordpress-themes" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, Thank you for contacting us about an issue importing demo data into WordPress Themes. First, enable WordPress debugging. With debugging turned on..." />
  <title>Unable to import Demo/Dummy Data Content for Wordpress Themes | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/wordpress/unable-to-import-demodummy-data-content-for-wordpress-themes" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:9057b89b6c5db4a26b361b0bf7014185 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Unable to import Demo/Dummy Data Content for Wordpress Themes</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2016-03-03 11:30 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>76</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I've increased the php limits (execution time, memory limit, filesize, etc) but I'm unable to import the dummy data from multiple wordpress themes.<br />
<br />
I've installed wordpress into a folder (not on the main domain) and updated the php.ini in both the main domain and in the folder. The wordpress themes have import settings in their respective menus that allow for full demo data and content to be imported, but when I try, the import process happens too fast to actually be importing anything; it says everything has imported successfully, but nothing shows up. The theme works properly, but I'd really like the pages, menus and data to work from. Suggestions appreciated.</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_9399' id='upvote_answer_9399' class='f_vote_option'>
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_9399').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_9399' id='downvote_answer_9399' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='9399' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_9399').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
Thank you for contacting us about an issue importing demo data into WordPress Themes. First, enable <a href="http://www.inmotionhosting.com/support/website/wordpress/turning-on-wordpress-debugging">WordPress debugging</a>. With debugging turned on, it is much easier to locate any errors within your WordPress site as well as any plugins and themes that may be causing errors.<br />
<br />
As a test, try making the <a href="http://www.inmotionhosting.com/support/website/php/recursive-php-ini">php.ini file recursive</a> (if you haven't already). This allows the updated settings to affect child folders.<br />
<br />
We are happy to help you test further, but will need some additional information.<br />
<br />
What are the specific Theme's and versions are you testing?<br />
<br />
What is the exact Demo/Dummy data you are importing<br />
<br />
...
John-Paul
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_9399').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_9399' id='form_comment_on_answer_9399' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>I enabled debugging, but I'm not getting errors. It always says it imports successfully, it just doesn't. I made the php.ini file recursive but that hasn't fixed anything. The only plugins installed are the plugins the theme required.  I'm testing the theme &quot;Burst&quot; - but the same problem happens with the theme &quot;Tower&quot;. I've tried importing any and all of their data, specifically I'd like to use Burst-3 Classic or Burst-4 Standard, Importing &quot;All&quot; (content, widgets, options) and &quot;yes&quot; importing attachments. Running WordPress 4.4.2.</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='/support/images/avatars/default_avatar.jpg' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/Marcee'>Marcee</a><br />
									6 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2016-03-03 1:48 pm EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello Marcee,<br />
<br />
Thank you for contacting us. It can be difficult to troubleshoot purchased themes, since we do not  have access to them for testing. But, since you have paid them for the Theme, they usually provide some level of support on their product.<br />
<br />
I did find a similar issues posted (as recent as 3 days ago) by other customers in the official <a href="http://themeforest.net/item/burst-a-bold-and-vibrant-wordpress-theme/13137984/comments" target="_blank" rel="nofollow">comments section</a> of the Burst Theme, where the Theme's Author (Mikado-Themes) advised to submit a ticket. This may be the best course for you as well, since they coded this Theme, and may have a known solution and workaround.<br />
<br />
If you have any further questions, feel free to post them below.<br />
<br />
Thank you,<br />
John-Paul</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>I've already submitted a ticket with Mikado-Themes and they are trying to solve the problem, but just so you're aware, it's definitely a problem with inmotion as I've uploaded the theme to godaddy and had no issues. I'm sure it has something to do with the php settings.</div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello Marcee,<br />
<br />
Thank you for contacting us. As a test, you can try <a href="http://www.inmotionhosting.com/support/website/modsecurity/disable-mod-security-via-modsec-manager">disabling mod security</a>, to ensure it is not triggering a security rule.<br />
<br />
Since you can <a href="http://www.inmotionhosting.com/support/website/php/update-local-php-settings">update the PHP settings</a> within your account at any time, I recommend adjusting the settings to meet your needs (if you know your PHP settings with godaddy, you can just match them).  A <a href="http://www.inmotionhosting.com/support/website/php/create-phpinfo-page-to-see-php-settings">phpinfo</a> page can help confirm the setting is changing.<br />
<br />
Let us know the theme developer's (Mikado) response, as it may help us and other visitors to this post.<br />
<br />
Thank you,<br />
John-Paul</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/wordpress/unable-to-import-demodummy-data-content-for-wordpress-themes&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/wordpress/unable-to-import-demodummy-data-content-for-wordpress-themes'></div>
<script type='text/javascript'>
  (function() {
