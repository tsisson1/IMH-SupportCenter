<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:54084:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/website-troubleshooting/i-keep-getting-a-403-error-after-reinstalling-any-cms-software" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello masonem, and sorry for the troubles you're having. From what I could tell, it looks like you were lacking any default Index pages in .htaccess in ..." />
  <title>I keep getting a 403 error after reinstalling any CMS software | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/website-troubleshooting/i-keep-getting-a-403-error-after-reinstalling-any-cms-software" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:25e735ea93e0d960ec5d3582bac2cf49 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>I keep getting a 403 error after reinstalling any CMS software</h1>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_3098' id='upvote_answer_3098' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='3098' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_3098').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_3098' id='downvote_answer_3098' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='3098' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_3098').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>9,968 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2013-05-13 4:08 pm EST
                		        </div>
					
		                </div>

				Hello masonem, and sorry for the troubles you're having.<br />
<br />
From what I could tell, it looks like you were lacking any &lt;a href=&quot;http://www.inmotionhosting.com/support/website/general-server-setup/htaccess-change-index-page&quot; target=&quot;_blank&quot;&gt;default Index pages in .htaccess&lt;/a&gt; in your main &lt;strong&gt;/public_html/&lt;/strong&gt; directory. Because of this, you were getting a &lt;a href=&quot;http://www.inmotionhosting.com/support/website/website-troubleshooting/403-forbidden-error&quot; target=&quot;_blank&quot;&gt;403 error&lt;/a&gt; since your user didn't have access to any files (since there were none there).<br />
<br />
You did appear to have some files in the &lt;strong&gt;/public_html/drup/&lt;/strong&gt; directory, and when I attempted to go to your website and appended &lt;strong&gt;/drup&lt;/strong&gt; onto the end, it did pull up the Drupal files from the server, but those appeared to just be the defaults and you had a lot of missing content.<br />
<br />
I see that we've already sent you out a data restoration request, because it didn't look like there was anything of importance already setup on the account. I went ahead and restored to your account what we had in our daily backups.<br />
<br />
I left the original files from when I first got into your account in the following directory:<br />
&lt;p class=&quot;code_block&quot; style=&quot;width: 550px; line-height: .7em; overflow: hidden;&quot;&gt;<br />
/home/userna5/public_html-BAK<br />
&lt;/p&gt;<br />
Please let us know if you needed either of those directories placed back onto your live website. For the time being, it looks like everything should be operation again.<br />
<br />
If you continue to have issues accessing an application that you &lt;a href=&quot;http://www.inmotionhosting.com/support/edu/cpanel/softaculous/how-to-install&quot; target=&quot;_blank&quot;&gt;install with Softaculous&lt;/a&gt;, please ensure that you're attempting to access the correct sub-directory that you've installed it to. If it's still giving you problems please let us know!<br />
<br />
- Jacob
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_3098').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_3098' id='form_comment_on_answer_3098' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Ok, it was working then it stopped. I looked at the directories and you moved my working Drupa and OCPortal to publi_html-OLD.  I then tried to update the app setting to reflec that, but it i not wokring.  The live site is working, but I am creating the real one with the CMS software.  How do I get that back up and running?</div>
							...
							<td style='width:96px;' valign='top'>
								...
								<div class='smallgrey'>
									<a href='/support/community-support/users/masonem'>masonem</a><br />
									13 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2013-05-13 4:15 pm EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello masonem,<br />
<br />
I went ahead and moved the two directories from the &lt;strong&gt;/public_html-BAK/&lt;/strong&gt; directory, to just &lt;strong&gt;/public_html/&lt;/strong&gt;. You should now be able to to view either of those sections by appending one of the following onto the end of your domain name, either &lt;strong&gt;/drup&lt;/strong&gt; or &lt;strong&gt;/new3&lt;/strong&gt;.<br />
<br />
...
- Jacob</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/website-troubleshooting/i-keep-getting-a-403-error-after-reinstalling-any-cms-software&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/website-troubleshooting/i-keep-getting-a-403-error-after-reinstalling-any-cms-software'></div>
<script type='text/javascript'>
  (function() {
