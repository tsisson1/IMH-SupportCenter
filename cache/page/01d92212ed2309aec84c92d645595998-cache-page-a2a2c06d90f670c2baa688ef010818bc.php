<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:59132:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/zen-cart/admin-dash-login" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-02-17T19:24:54-08:00" />
  <meta name="keywords" content="admin dashboard zencart login" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Learn how to log into your ZenCart administration dashboard." />
  <title>Logging into the ZenCart admin dashboard - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/zen-cart/admin-dash-login" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:9f948a677a3b19b02cf510d83cc41b49 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '182.186.18.85']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Logging into the ZenCart admin dashboard									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;' title='Originally published: Oct 4, 2013'><span style='color:#606060;'>Published:</span> Feb 17, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>After you have completed <a href="http://www.inmotionhosting.com/support/website/zen-cart/getting-started-guide-zen-cart">installing ZenCart</a> into your account, you will be ready to log into the admin dashboard. This area is where you will be able to modify and control your store. The login credentials (username and password) are not the same as your hosting credentials. The ones for ZenCart were set during the installation process. You need to know the following information in order to log into the ZenCart admin dashboard:</p>
<ul>
  <li><strong>Admin Dashboard URL:</strong> If you installed ZenCart into the root directory of your site, the URL would be: <em>http://example.com/zcadmin</em></li>
  <li><strong>Admin Username:</strong> This is the username you assigned during the installation process.</li>
  <li><strong>Admin Password:</strong> This is the password you assigned during the installation process.</li>
</ul>

<h2>How to Log into ZenCart</h2>
<ol class="article_list">
<li>Accessing the Admin URL for ZenCart is easy, simply add <em>/zcadmin</em> to the end of the URL where you installed ZenCart. Below are a couple of examples:
<table class="article_table">
<tr><th>URL for ZenCart</th><th>Admin URL</th></tr>
<tr><td>example.com</td><td>example.com/zcadmin</td></tr>
<tr><td>example.com/zencart</td><td>example.com/zencart/zcadmin</td></tr>
</table>
  <br />
 This leads you to the ZenCart admin login page.
  
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/zencart/login/admin-page.png"><img  style="float:right; margin:0px 0px 15px 15px;" alt="ZenCart admin login" src="//cdn.inmotionhosting.com/support/images/stories/edu/zencart/login/admin-page.png" title="Click here to view the larger image" width="200" /></a>From the admin login page, enter your username and password, then click on the <strong>Login</strong> button. This will take you to the admin dashboard for the program.<div style="clear:both;"></div></li>
</ol>
  <p>The image below displays what your screen should look like after entering the admin dashboard. From here you will now be able to work on your ZenCart website!</p>  
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/zencart/login/dashboard.png"><img  alt="ZenCart admin dashboard" src="//cdn.inmotionhosting.com/support/images/stories/edu/zencart/login/dashboard.png" title="Click here to view the larger image" width="200" /></a>  
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/zen-cart/admin-dash-login&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/zen-cart/admin-dash-login'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zOCZpZD0yODY4JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="cd4ada5a135c1fbaeb54f18196fcb3c8" value="1" />	</div>
	</form>
<!-- <br />
