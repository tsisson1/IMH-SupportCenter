<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:59685:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/cpanel/getting-started-cpanel/cpanel-layout" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-04-24T13:49:26-07:00" />
  <meta name="keywords" content="cpanel layout admin panel" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="Learn the basic layout of cPanel so you can begin to successfully using the control panel for your InMotion Hosting account." />
  <title>The cPanel Layout - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/cpanel/getting-started-cpanel/cpanel-layout" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:b5a90737df9b01c030d8aa2ccfc25800 -->
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>16,210</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Sep 2, 2011'><span style='color:#606060;'>Published:</span> Apr 24, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Since you have successfully logged in to cPanel, you will see the cPanel interface. This can be a bit overwhelming if you have never worked with cPanel and this is your first time logging in. We'll discuss the most important features in cPanel. Here is a screenshot of cPanel with the two main sections outlined in red and blue.</p>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/cpanel/cpanel-layout.jpg"><img src="//cdn.inmotionhosting.com/support/images/stories/cpanel/cpanel-layout.jpg" alt="cpanel-layout"  /></a></p>
<p>The <span style="color: #ff0000;"><strong>RED</strong></span> section is your website statistics. This shows general information such as your Shared IP address, Disk Space, what server you are on, how many emails accounts you have, how many databases you have ,and much more. This information will change based on any modifications you may make to your account.</p>
<p>The<span style="color: #0000ff;"><strong> BLUE</strong></span> section are the features of cPanel that you have control over. Each section has it's own header to better organized the options in common groups. The main sections most customers use is Mail, Files, and Databases.&nbsp;</p>
<p>Did you know you could brand your cPanel accounts if you are reselling hosting? Learn more about <a href="http://www.inmotionhosting.com/reseller-hosting">reseller hosting with cPanel</a>.</p>
<p>Please check the next article on <a href="/support/edu/cpanel/getting-started-cpanel/using-cpanel-video-tutorials" target="_blank" title="Click here to view the next article">Using the cPanel Video Tutorials</a>. If you missed our previous article, please see the <a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel" title="Click here to view the previous article" target="_blank">How to log into cPanel</a> tutorial. For more information on this course please visit <a target="_blank" href="/support/edu/cpanel/getting-started-cpanel" title="Click here to view the courses">Getting Started in cPanel</a>.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 4: The cPanel Layout</div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/cpanel/getting-started-cpanel/cpanel-layout&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/cpanel/getting-started-cpanel/cpanel-layout'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xMzImaWQ9OTcxJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="1a33dc79dc2c1fed816ab5dde7c4d87b" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/b75191634125fb792ce0094a4e7c5a21?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/b75191634125fb792ce0094a4e7c5a21'>aymen eag</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-18 3:03 pm</div>
				                <div><p>:D</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(18676);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
