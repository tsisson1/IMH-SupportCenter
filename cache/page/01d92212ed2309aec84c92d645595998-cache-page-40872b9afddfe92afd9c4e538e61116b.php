<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:58152:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-3/system-settings/debug-system" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-08-13T20:43:30-07:00" />
  <meta name="keywords" content="joomla 3.0 debug mode" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="In this Joomla 3.0 tutorial, we'll show you how to enable debug mode. This will give you access to important information that may assist you when troubleshooting issues with your Joomla 3.0 site." />
  <title>How to put Joomla 3.1 in debug mode - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-3/system-settings/debug-system" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:2745ed7742687e8fc1ed9f88dc6fe3b2 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to put Joomla 3.1 in debug mode									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>11,102</span></div>
							...
							<div style='clear:both;'></div>
								...
								<p>When troubleshooting various issues in Joomla 3.0, you may find it beneficial to put your website in debug mode. Enabling the <strong>debug system</strong> allows you to see details about how Joomla is rendering your site, including:</p>
<ul>
<li>Session Data</li>
...
<p><strong>To put Joomla 3.0 in debug mode:</strong></p>
<ol class="article_list">
<li><a href="/support/edu/joomla-3/getting-started/login-dashboard">Log into your Joomla 3.0 control panel</a></li>
<li>In the left menu, click the <strong>Global Configuration</strong> link</li>
<li>You should see several tabs listed at the top of the page. Click the <strong>System</strong> tab</li>
<li>Under <em>Debug Settings</em>, find the setting labeled <strong>Debug System</strong>. Click <strong>Yes</strong>, and then click the <strong>Save</strong> button in the top left of the page.<br /><br />When you visit your Joomla 3.0 site again, you should see a list of debug information listed towards the bottom of the page (see the screenshot below). This information will be under a heading labeled:<br /><br /><strong>Joomla! Debug Console</strong><br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/global-configuration/joomla-debug-console.gif"><img  alt="joomla-debug-console" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/global-configuration/joomla-debug-console.gif" /></a></li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 2: How to put Joomla 3.1 in debug mode</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 1: <a href='/support/edu/joomla-3/system-settings/path-to-log-folder'>Changing the folder logs are stored in within Joomla 3.1</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-3/system-settings/debug-system&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-3/system-settings/debug-system'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNDMmaWQ9MTU3NCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="08e6e1889e350462ae71f6cb72729841" value="1" />	</div>
	</form>
<!-- <br />
