<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:51718:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/dns-nameserver-changes/addon-domain" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Larry8, I recognize the issue. I could see that your domain was pointed to us through the A record. However, you have set the wrong IP. You used t..." />
  <title>Addon Domain | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/dns-nameserver-changes/addon-domain" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:8e0520fa139f6b96e178887ea6f4b724 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Addon Domain</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/larry8'>larry8</a>
			<div>10 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-12-29 12:27 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>618</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I have an addon domain bztaxi.com setup with a index.htm default home page. Tracert shows that it ends up in ns.inmotionhosting.com and it goes thru about 10 hops and takes a long time as show below:<br />
ms  208-110-248-229.centurylink.net [208.110.248.229<br />
<br />
31 ms    44 ms    28 ms  198.32.160.154<br />
27 ms    27 ms    63 ms  ae1-70g.cr1.ewr1.us.nlayer.net [69.31.95.173]<br />
47 ms    46 ms    47 ms  xe-5-0-0.cr1.ord1.us.nlayer.net [69.22.142.74]<br />
54 ms    46 ms    46 ms  ae0-40g.cr2.ord1.us.nlayer.net [69.31.111.154]<br />
95 ms    95 ms    95 ms  xe-5-0-1.cr1.lax1.us.nlayer.net [69.22.142.254]<br />
<br />
97 ms    96 ms    96 ms  ae1-50g.ar1.lax2.us.nlayer.net [69.31.127.130]<br />
96 ms    95 ms   113 ms  as17139.xe-5-0-5.ar1.lax2.us.nlayer.net [69.31.1<br />
<br />
95 ms    99 ms    95 ms  po10-dc1-core-1.corporatecolo.com [74.124.220.12<br />
<br />
95 ms    95 ms    96 ms  wcvz3.imhadmin.net [173.247.242.20]<br />
95 ms    95 ms    96 ms  ns.inmotionhosting.com [74.124.210.242]<br />
<br />
When I try to access www.bztaxi.com/index.htm from a browser, it timed-out. Can you help to see anything wrong in the settings?<br />
<br />
Thanks<br />
Larry</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_2046' id='upvote_answer_2046' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='2046' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_2046').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_2046' id='downvote_answer_2046' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='2046' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_2046').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Larry8,<br />
<br />
I recognize the issue.  I could see that your domain was pointed to us through the A record.  However, you have set the wrong IP.  You used the IP for one of our name servers.  If you were trying to set an A record to direct only web traffic to us, then you would need to use the IP provided in your Cpanel labeled "shared IP address". You can find this IP address by logging into your Cpanel and then looking down the lefthand column for the proper IP address (use your main account).  You will need to go back into your current host/registrar interface where you have set the IP and change it to the proper IP.  However, you were actually trying to change the NAME SERVERS, then you will need to consult with your current domain registrar and request a name server change.  You would remove the current name server settings of:<br />
<br />
bztaxi.com.             172800  IN      NS      ns51.1and1.com.<br />
bztaxi.com.             172800  IN      NS      ns52.1and1.com.<br />
<br />
And then you would change them to InMotion Hosting's Nameservers:<br />
<br />
ns.inmotionhosting.com  - IP Address:  74.124.210.242<br />
ns2.inmotionhosting.com -  IP Address: 70.39.150.2<br />
<br />
For more information on changing name servers see this article:<br />
<a href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/updating-your-domains-nameservers" target="new"> Updating Domain Name servers</a><br />
<br />
...
Arnel C.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_2046').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_2046' id='form_comment_on_answer_2046' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/dns-nameserver-changes/addon-domain&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/dns-nameserver-changes/addon-domain'></div>
<script type='text/javascript'>
  (function() {
