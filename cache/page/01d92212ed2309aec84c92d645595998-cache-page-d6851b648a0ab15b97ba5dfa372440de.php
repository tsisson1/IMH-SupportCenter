<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50638:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/billing/i-lost-my-username-and-password-for-my-cpanel-how-do-i-retrieve-those" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Thank you for your question charityposimpmag! Sorry to hear you lost your username and password. You can get your cPanel username in your AMP technical ..." />
  <title>I lost my username and password for my cpanel. How do I retrieve those | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/billing/i-lost-my-username-and-password-for-my-cpanel-how-do-i-retrieve-those" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:f190bf91ccbe67a1755a24ced119c9f1 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '64.228.214.43']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>I lost my username and password for my cpanel. How do I retrieve those</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/charityposimpmag'>charityposimpmag</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-04-13 5:14 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>2,402</span>
			</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_2874' id='upvote_answer_2874' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='2874' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_2874').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_2874' id='downvote_answer_2874' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='2874' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_2874').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>5,889 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2013-04-15 10:21 am EST
                		        </div>
					
		                </div>

				Thank you for your question charityposimpmag!<br />
<br />
Sorry to hear you lost your username and password. You can get your cPanel username in your AMP technical details and the password can be reset in your AMP panel as well. Please see the following links with instructions on this.<br />
<br />
&lt;a href=&quot;http://www.inmotionhosting.com/support/website/how-to/viewing-account-technicial-information-in-amp&quot;&gt;Viewing Your Account's technical information in AMP&lt;/a&gt;<br />
<br />
...
<br />
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_2874').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_2874' id='form_comment_on_answer_2874' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/billing/i-lost-my-username-and-password-for-my-cpanel-how-do-i-retrieve-those&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/billing/i-lost-my-username-and-password-for-my-cpanel-how-do-i-retrieve-those'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="27898c9032f0a95a38d8d4d0616f5806" value="1" />	</div>
	</form>
<!-- <br />
