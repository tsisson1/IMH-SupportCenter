...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-3/create-component/formats" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-05-23T20:10:08-07:00" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="InMotion Hosting Support Center" />
  <title>How to add a New Format to your Joomla 3 Component - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-3/create-component/formats" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:3dd47d6d4e04d2373315c563b3bdc929 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to add a New Format to your Joomla 3 Component									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>5,594</span></div>
...
<p>In our last few tutorials about <a href="/support/edu/joomla-3/create-component">creating components within Joomla 3</a>, we've been <a href="/support/edu/joomla-3/create-component/add-default-view">creating new views</a>. The default format for views is HTML format. However, you can setup your views to return data in other formats too, such as json or xml.</p>

<h2>Creating a new format</h2>

<ol class='article_list'>
  <li>
    <p><strong>Create your new "view format" file:</strong> /components/com_helloworld/views/helloworld/<span style='color:red;'>view.<strong>xml</strong>.php</span></p>
    <img src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/create-component/different-formats.png" class='sc_rc' style='border:1px solid #000; float:right; margin:0px 0px 15px 15px;' />
    <p>In our testing, we are creating an <span style='color:red;'>xml</span> format, but you can create other formats too. For example, if you wanted to create a json format, you would create:<br />/components/helloworld/views/helloworld/view.<u>json</u>.php</p>
  </li>
  <li style='clear:both;'>
    <p>In the file you just created, write the php code that you would like to ultimately create your XML file. Here's our example code:</p>
...
class HelloWorldViewHelloWorld extends JViewLegacy
{
        ...
        {
            echo "<span style='color:red;'>&lt;?xml version='1.0' encoding='UTF-8'?&gt;
&lt;article&gt;
...
<h2>Testing our new format</h2>

<p>To test our new format, call it via the URL as in this example:</p>

<p class='white_box'>http://example.com/index.php?option=com_helloworld<span style='color:red;'>&format=xml</span></p>
  
<p>If you followed along with this tutorial, your Joomla component should output the following:</p>
  
  <img src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/create-component/xml-format.png" class='sc_rc' style='border:1px solid #000;' />
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 5: How to add a New Format to your Joomla 3 Component</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 6: <a href='/support/edu/joomla-3/create-component/add-new-task'>How to add a New Task to your Joomla 3 Component</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-3/create-component/formats&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-3/create-component/formats'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD01MDcmaWQ9MzI0NSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/46d02455d12e618a70af8c477b24ade6?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/46d02455d12e618a70af8c477b24ade6'>Memma89</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-05-10 4:46 am</div>
				                <div><p>When i&nbsp;call the view via the URL as in this example&nbsp;http://example.com/index.php?option=com_helloworld&amp;format=xml i get the follow error:</p>
<h3 style="font-family: 'Times New Roman'; white-space: pre;">This page contains the following errors:</h3>
<div style="white-space: pre; font-family: monospace; font-size: 12px;">error on line 1 at column 1: Document is empty</div>
<h3 style="font-family: 'Times New Roman'; white-space: pre;">Below is a rendering of the page up to the first error.</h3>
<p>&nbsp;</p>
<p>Any ideas?</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32562);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-05-10 4:59 pm</div>
				                <div>That error indicates that a piece of code, likely a php function, is not closed properly. You may need to add a closing tag.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32575);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
