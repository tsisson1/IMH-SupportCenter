<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:76366:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/email/fighting-spam/blacklist-whitelist" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-06-18T13:59:48-07:00" />
  <meta name="keywords" content="spam assassin whitelist blacklist" />
  <meta name="author" content="John-Paul Briones" />
  <meta name="description" content="This guide walks you through whitelisting and blacklisting email addresses using SpamAssassin" />
  <title>Blacklist/Whitelist an Email Address in SpamAssassin - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/email/fighting-spam/blacklist-whitelist" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:ebb852fb48e4f86bd6ea596d9a17a44c -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '108.171.129.162']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Blacklist/Whitelist an Email Address in SpamAssassin</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Blacklist/Whitelist an Email Address in SpamAssassin									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>16,755</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Nov 25, 2013'><span style='color:#606060;'>Published:</span> Jun 18, 2015</div>
							...
							<div style='clear:both;'></div>
								...
								<iframe width="560" height="315" src="https://www.youtube.com/embed/FGSU22CJvH8" frameborder="0" allowfullscreen></iframe>
<div class="in_this_tutorial">
  <h2>In this tutorial:</h2>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('whitelist');">Whitelist an Email address</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('blacklist');">Blacklist an Email addresss</button>
</div>

<p>In <em>SpamAssasin</em> you have the ability to <strong>Blacklist</strong> (block), and <strong>Whitelist </strong> (allow) email address. In this guide we will show you how to <strong>Whitelist/Blacklist</strong> email address in SpamAssassin, which is included in cPanel.</p>


<a name="whitelist"></a>
<h2>Whitelist an Email Address:</h2>
<ol class="article_list">
<li><a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel" target="_blank">Login to cPanel</a>.</li>
<li>Click the <strong>Spam Assassin</strong> button in the <em>Mail</em> section.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/cpanel/mail/spamassassin/spam-assassin-button.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/edu/cpanel/mail/spamassassin/spam-assassin-button.png" alt="accessing SpamAssassin" title="click the SpamAssassin button" /></a></li>
<li>On the <em>SpamAssassin</em> settings page, click the <strong>Configure SpamAssassin</strong> button.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/cpanel/mail/spamassassin/configuring-spamassassin.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/edu/cpanel/mail/spamassassin/configuring-spamassassin.png" alt="" /></a></li>
<li>Next to the <em>whitelist_from</em> option, enter the email address you want to <strong>Allow</strong>, then click the <strong>Save</strong> button.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/cpanel/mail/spamassassin/white-listing-address.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/edu/cpanel/mail/spamassassin/white-listing-address.png" alt="white listing email address" title="adding address to whitelist in SpamAssassin" /></a><br><br>
You will then see a message stating "Your settings have been saved!"</li>
</ol>

<a name="blacklist"></a>
<h2>Blacklist an Email Address:</h2>
<ol class="article_list">
<li><a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel" target="_blank">Login to cPanel</a>.</li>
<li>Click the <strong>Spam Assassin</strong> button in the <em>Mail</em> section.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/cpanel/mail/spamassassin/spam-assassin-button.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/edu/cpanel/mail/spamassassin/spam-assassin-button.png" alt="" /></a></li>
<li>On the <em>SpamAssassin</em> settings page, click the <strong>Configure SpamAssassin</strong> button.</li>
<li>Next to the <em>blacklist_from</em> option, enter the email address you want to <strong>Block</strong>, then click the <strong>Save</strong> button. You will then see a message stating "Your settings have been saved!"</li>
</ol>

<p>Congratulations, now you know how to <strong>Blacklist</strong> and <strong>Whitelist</strong> email addresses using SpamAssassin!</p> 
...
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/email/fighting-spam/blacklist-whitelist'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NiZpZD0zMDAxJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="a5dc5f19f002c8f928d9ba88a740a838" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/fighting-spam/why-are-we-limited-to-five-entries-on-spam-assassin-white-list?tsrc=rsbraq'>Why Are We Limited to Five Entries on Spam Assassin White List</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/b5ac1700c17e4ca7d24372e5fbcb44d5?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/b5ac1700c17e4ca7d24372e5fbcb44d5'>Sukhpal singh</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-23 12:57 am</div>
				                <div><p>HI&nbsp;</p>
<p>I have a question</p>
<p>When we add a DNS blacklist to the spamassassin like zen.spamhaus.org. Does it stores all the blacklisted domains locaaly onto the databade&nbsp;</p>
<p>or</p>
<p>does it goes to online every time it receives an email and check! which will be slower.</p>
<p>If someone can answer this, i will really appreciate him/her</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27796);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-23 9:11 am</div>
				                <div>Hello Sukhpal,<br />
<br />
Unfortunately it does not work like that. If you add zen.spamhaus.org to your Spam Assassin blacklist then no one could email you from email@zen.spamhaus.org. If you wanted to use zen.spamhaus.org as a RBL you would need root access to WHM to make that change.<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27814);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-27826'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/8af763fcfd2719cccb0ed08cb985e880?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/8af763fcfd2719cccb0ed08cb985e880'>Emma Manuel</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-24 2:09 am</div>
				                <div><p>Hello Guys,</p>
<p>&nbsp;</p>
<p>when i try to block an email from spam assasin i get this error;</p>
<p>&nbsp;</p>
<h1>Apache SpamAssassin&trade; Configuration</h1>
<p>You can not call this page directly.</p>
<p>&nbsp;</p>
<p>Help pliz</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27826);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-26 9:05 am</div>
				                <div>Hello Emma,<br />
<br />
Are you trying to add an email address to the blacklist like it says above?<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27852);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/d9b91c2fc1853694efe72de9f4f792aa?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/d9b91c2fc1853694efe72de9f4f792aa'>David</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-05-17 4:35 pm</div>
				                <div><p>Any way to have the system automatically add addresses to whom I (and my users on the domain / VPS) SEND email TO??&nbsp; (TO, CC, BCC)</p>
<p>&nbsp;</p>
<p>Tx, David</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32750);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-05-17 7:44 pm</div>
				                <div>This may be possible with a great deal of custom coding, but I don't know of a straightforward way to do it in cPanel, SpamAssassin, or with conventional email clients.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32754);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-32849'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/e8ba352784da0b93657777273acdfa3c?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/e8ba352784da0b93657777273acdfa3c'>Erik</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-05-20 6:56 pm</div>
				                <div><p>Hi. I have a question. Is it possible to upload a large blacklist to spamassassin?&nbsp; On my old hosting provider we had spam experts which was quite good at blocking the majority of spam, and I created a rather large (500+ adressess and servers) list. Is it possible to just upload that entire list, or do I have to do it one at a time?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32849);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
...
TJ Edens</div>
		...
		<a name='comment-33043'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/9eff80c09059587e4332c9482c635d59?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/9eff80c09059587e4332c9482c635d59'>Dave A.</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-05-29 12:27 pm</div>
				                <div><p>I have been getting 400 emails a day from all sorts of domains with a .win TLD. &nbsp;In looking at all the senders email addresses there are hundreds of new domains being sent from every day. &nbsp;Is there a way to just block any domain with a .win TLD?&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(33043);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-05-31 9:14 pm</div>
				                <div>You could try setting up a filter for Sender "Contains" with the .win TLD in Spam Assassin.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(33104);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
