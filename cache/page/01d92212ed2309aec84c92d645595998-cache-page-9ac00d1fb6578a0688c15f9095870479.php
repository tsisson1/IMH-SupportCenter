<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:53610:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/opencart/integrating-wordpress-with-opencart" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="I too was trying to do this and ended up just linking the two seperate sites together. I did see the enclosed link just a few minutes ago. I have no ide..." />
  <title>Integrating WordPress with OpenCart | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/opencart/integrating-wordpress-with-opencart" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:fbfae3eaa5e1e811c8cfb27f7a0f34ad -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '89.142.72.34']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Integrating WordPress with OpenCart</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/sbaldwin'>sbaldwin</a>
			<div>83 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-04-12 4:58 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>10,993</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I am trying to integrate my opencart site and my wordpress site together so users dont have to sign up twice. Any suggestions?</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_882' id='upvote_answer_882' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='882' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_882').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_882' id='downvote_answer_882' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='882' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_882').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hi sbaldwin,<br />
<br />
I've done some research on this topic, and it seems like there are quite a few people interested in combining both WordPress and OpenCart, but it doesn't seem like there are any solid or any official plugins that will do this.<br />
<br />
Here are a few links I found that you may find interesting for review:<br />
<br />
&lt;a href='http://wordpress.org/support/topic/opencart-wordpress-integration' target='_blank' rel='nofollow'&gt;OpenCart + WordPress Integration&lt;/a&gt;<br />
<br />
&lt;a href='http://forum.opencart.com/viewtopic.php?t=3991' target='_blank' rel='nofollow'&gt;Combining OpenCart with Wordpress&lt;/a&gt;<br />
<br />
Because there doesn't seem to be any solid work on plugins for combining WordPress and OpenCart, I will tell you that it would be a major task.<br />
<br />
Thanks,<br />
- Brad
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_882').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_882' id='form_comment_on_answer_882' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
...
<div class='  not_best_answer'>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px; width:50px;' valign='top'>
<div class='vote_div'>
	<form method='post' name='upvote_answer_1355' id='upvote_answer_1355' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='1355' />
		<input type='hidden' name='component' id='component' value='qa' />
		<input type='hidden' name='vote_value' id='vote_value' value='1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_1355').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_1355' id='downvote_answer_1355' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='1355' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_1355').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					<img src='/support/images/avatars/avatar_314233893.jpg' class='user_avatar' style='max-width:60px;' /><br />
                		        <a href='/support/community-support/users/USAeshopFrance'>USAeshopFrance</a>
					
					<div>51 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2012-07-27 9:51 am EST
                		        </div>
					
		                </div>

				I too was trying to do this and ended up just linking the two seperate sites together.  I did see the enclosed link just a few minutes ago. I have no idea if it works or not, but thought it was at least worth looking into.  I believe it is just a matter of time before some hotshot genuis geek figures it out. It seems by the number of hits here that it is a popular topic.<br />
<br />
Good luck.
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_1355').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_1355' id='form_comment_on_answer_1355' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
					                <p>You must <a href='/support/login'>login</a> before you can post a comment about this answer.</p>
					        </div></div></div></div>
					</form>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/opencart/integrating-wordpress-with-opencart&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/opencart/integrating-wordpress-with-opencart'></div>
<script type='text/javascript'>
  (function() {
