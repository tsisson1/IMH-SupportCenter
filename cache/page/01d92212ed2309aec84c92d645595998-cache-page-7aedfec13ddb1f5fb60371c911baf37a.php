<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:51918:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/wordpress/why-do-i-get-a-403-forbidden-page-when-logging-into-wordpress" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello AlonsoMartin, I'm glad you are able to login to Wordpress! Thank you for updating us and letting us know how you fixed the problem. If you have an..." />
  <title>Why do I get a 403 forbidden page when logging into Wordpress? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/wordpress/why-do-i-get-a-403-forbidden-page-when-logging-into-wordpress" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:cf66c7ab39aa6b60e02c8f00df447fd8 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '1.0.233.105']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box straight_bottom'>
                <h1 style='font-size:26px;'>Why do I get a 403 forbidden page when logging into Wordpress?</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='http://graph.facebook.com/alonsomartin/picture?type=normal' class='user_avatar' /><br />
			<a href='/support/community-support/users/AlonsoMartin'>AlonsoMartin</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-06-13 10:40 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>1,742</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Hello. I have tried to modify the .htaccess files to see if my IP is blocked, and checking the permissions of the folder I'm trying to access (wordpress admin login folder), but I still get a 403. <br />
<br />
I've had problems with wordpress ever since inmotionhosting seemed to be targeted by brute-force attacks, and I've had to reset my passwords, disable the modsec manager security every time I or a collaborator wants to log in to the blog. Now we can't even access the admin section, even after adding exceptions in the .htaccess files.<br />
<br />
Would you be able to help me trace the problem? I've searched google for answers, but they all point to the server as the source of the problem. <br />
<br />
Thank you.</div>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px;'>
				<div style='font-size:12px; max-width:500px; overflow:auto;'>If anyone runs into the problem, I solved it by editing the .htaccess of the root folder of the blog, to which I  apparently had added a RewriteCond %{REMOTE_ADDR} to allow access into the login system (after the modifications were done by inmotionhosting after the attacks). The problem was that my IP had changed, and the old IP was still being checked for.</div>
				
				
			</td>
			<td style='width:100px;' valign='top'>
				<img src='http://graph.facebook.com/alonsomartin/picture?type=normal' style='width:40px;' class='user_avatar' />
				<div class='smallgrey'>
					<a href='/support/community-support/users/AlonsoMartin'>AlonsoMartin</a><br />
					5 <a href='/support/team/points' target='_blank'>Points</a><br />
					2013-06-14 09:06 am EST
				</div>
			</td>
		</tr>
	</table>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_3326' id='upvote_answer_3326' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='3326' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_3326').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_3326' id='downvote_answer_3326' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='3326' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_3326').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>22,986 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2013-06-14 9:09 am EST
                		        </div>
					
		                </div>

				Hello AlonsoMartin,<br />
<br />
I'm glad you are able to login to Wordpress! Thank you for updating us and letting us know how you fixed the problem. <br />
<br />
...
-John-Paul
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_3326').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_3326' id='form_comment_on_answer_3326' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/wordpress/why-do-i-get-a-403-forbidden-page-when-logging-into-wordpress&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/wordpress/why-do-i-get-a-403-forbidden-page-when-logging-into-wordpress'></div>
<script type='text/javascript'>
  (function() {
