<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:62982:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/mediawiki/adding-content-mediawiki/insert-images-wiki" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-01-23T18:00:39-08:00" />
  <meta name="keywords" content="insert upload images media wiki mediawiki embedded embed" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="This article will explain how to upload and insert images into MediaWiki pages." />
  <title>How to insert images into MediaWiki - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/mediawiki/adding-content-mediawiki/insert-images-wiki" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:60b451fc3f0ace418c572f0ebdd58674 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '187.255.254.19']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to insert images into MediaWiki									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>20,023</span></div>
							...
							<div style='clear:both;'></div>
								...
								<p>Inserting images in MediaWiki takes a few steps to accomplish. First the file needs to be uploaded. Then you will need to insert the code in the page that places the image in the content. This article will explain the steps to upload and insert images into your MediaWiki pages.</p>
<p class="alert"><strong>Important!</strong> If you have not enabled user uploads in your MediaWiki you will not be able to complete this tutorial. Please check the <a target="_blank" title="Click here for more  info on Enabling uploads" href="/support/edu/mediawiki/adding-content-mediawiki/enable-uploads-wiki">Enabling user image uploads in MediaWiki</a> tutorial for more information on allowing image uploads.</p>
<h2>Inserting an image into your MediaWiki pages</h2>
...
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/102/insert-images
/insert-images-6-upload-file.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Upload file link MediaWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/102/insert-images
/insert-images-6-upload-file.gif" title="Click here to view the larger image" width="100" /></a>On the left hand side in the navigation sidebar, <strong>click the Upload File link</strong>. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/102/insert-images
/insert-images-7-select-source.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Select the image source MediaWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/102/insert-images
/insert-images-7-select-source.gif" title="Click here to view the larger image" width="100" /></a>On the Upload file page, browse for the image you want to upload to your MediaWiki page.
<p><strong>Click Upload File</strong>.</p>
<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/102/insert-images
/insert-images-8-file-name.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Get the file name MediaWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/102/insert-images
/insert-images-8-file-name.gif" title="Click here to view the larger image" width="100" /></a>The file will show in the File history and the file name will display in the page.
<p>On the image page to the top left, you can see the file name. in this case File:Dog4.gif.</p>
<p class="alert"><strong>Note!</strong> The file name is used in the MediaWiki code to display the image. Notate the image name for the next step.</p>
<p><strong>Notate the file name.</strong></p>
<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/102/insert-images
/insert-images-9-insert.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Insert the image code MediaWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/102/insert-images
/insert-images-9-insert.gif" title="Click here to view the larger image" width="100" /></a><strong>Find a page to insert an image in</strong>.
<p>Click the Embedded file icon in the WYSIWYG editor. A code will be generated like the following:</p>
<pre style="margin-left: 20px;">[[File:Example.jpg]]</pre>
<p>Change Example.jpg to your file name. In this case the file name is Dog4.gif. The code should look like the following example.</p>
<pre style="margin-left: 20px;">[[File:Dog4.gif]]</pre>
<p><strong>Save the page.</strong></p>
<br style="clear: both;" />
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/102/insert-images
/insert-images-10-upload-finished.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Finished view of image MediaWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/102/insert-images
/insert-images-10-upload-finished.gif" title="Click here to view the larger image" width="100" /></a>Now you will see your image show on the wiki page. <br style="clear: both;" /></p>
</li>
</ol>
<p>Images can also be formatted to display left, right or with captions. The next article will explain <a target="_blank" title="Click here to see the formatting images in MediaWiki tutorial" href="/support/edu/mediawiki/adding-content-mediawiki/formatting-images-wiki-code">how to format the images in MediaWiki</a>.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 8: How to insert images into MediaWiki</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 7: <a href='/support/edu/mediawiki/adding-content-mediawiki/enable-uploads-wiki'>Enabling user image uploads in MediaWiki</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 9: <a href='/support/edu/mediawiki/adding-content-mediawiki/formatting-images-wiki-code'>Formatting images in MediaWiki</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/mediawiki/adding-content-mediawiki/insert-images-wiki&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/mediawiki/adding-content-mediawiki/insert-images-wiki'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMjcmaWQ9MjE5OSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="9c82a4e34bb4fa06d9efaa67d8a9fb1e" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/177898df21e8829dae207a0c96cb2c50?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/177898df21e8829dae207a0c96cb2c50'>Lars</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-21 4:53 pm</div>
				                <div><p style="margin: 0.5em 0px; line-height: 22.3999996185303px; color: #252525; font-family: sans-serif; font-size: 14px;">WikiUp is a small utility for adding images and files to your MediaWiki wiki site. (Windows only). With WikiUp you simply paste the image from the clipboard, click upload and then paste the Wiki-tag directly into the page you're editing.</p>
<p style="margin: 0.5em 0px; line-height: 22.3999996185303px; color: #252525; font-family: sans-serif; font-size: 14px;">You can drag and drop files and images to upload instantly. Automatic naming of pasted images.</p>
<p style="margin: 0.5em 0px; line-height: 22.3999996185303px; color: #252525; font-family: sans-serif; font-size: 14px;">WikiUp is completely free.</p>
<p style="margin: 0.5em 0px; line-height: 22.3999996185303px; color: #252525; font-family: sans-serif; font-size: 14px;">Available at http://wikiup.se</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24348);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
