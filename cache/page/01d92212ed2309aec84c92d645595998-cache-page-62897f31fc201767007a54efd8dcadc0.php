<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:64954:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/prestashop-15/working-with-shipping/set-shipping-and-handling" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-08-30T14:11:55-07:00" />
  <meta name="keywords" content="edit shipping handling charges prestashop 1.5" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="This PrestaShop 1.5 tutorial shows you how to set your Shipping and Handling charges." />
  <title>How to set Shipping and Handling in PrestaShop 1.5 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/prestashop-15/working-with-shipping/set-shipping-and-handling" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:ccc9834680224dda0adf372ab37c2a33 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to set Shipping and Handling in PrestaShop 1.5									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>6,213</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jun 1, 2012'><span style='color:#606060;'>Published:</span> Aug 30, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>After <a href="/support/edu/prestashop-15/working-with-shipping/add-shipping-carrier">adding a shipping carrier</a> to your PrestaShop 1.5 store you will need to set up the shipping and handling charges to cover your expenses in delivering the product. These are additional charges that help cover the overhead of preparing the package for shipment (handling) and the overhead costs of shipping the product to the customer via a carrier (shipping). Learn how to set your shipping and handling charges in your PrestaShop 1.5 store by following the instructions below.</p>
<p><strong>To set the Shipping charges in PrestaShop 1.5:</strong></p>
<ol class="article_list">
<li><a href="/support/edu/prestashop-15/getting-started/login-to-dashboard">Log into your PrestaShop 1.5 dashboard</a></li>
<li>Using the top menu bar, hover over the <strong>Shipping </strong>tab and select <strong>Shipping </strong>from the menu.</li>
<li>From the <strong>Shipping : Shipping </strong>page you can set the charges in both the <strong>Handling</strong> and <strong>Shipping</strong> areas. You can also set the <strong>Free shipping</strong> based on price or weight. You will also need to set the general <strong>Billing</strong> by either total weight or total price.<br /><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/prestashop1.5/shipping-shipping-handling/shipping-shipping-charges.png"><img  alt="shipping-shipping-charges" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/prestashop1.5/shipping-shipping-handling/shipping-shipping-charges.png" /></a></li>
<li>When finished, click on the green <strong>Save</strong> button in the upper right corner. </li>
</ol>
<p>That is how you set the shipping and handling costs in PrestaShop 1.5. You may also want to check out our article on <a href="/support/edu/prestashop-15/working-with-shipping/add-shipping-to-product">how to set up additional shipping costs for a specific product</a>.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/prestashop-15/working-with-shipping'>107: Working with Shipping in PrestaShop 1.5</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 3: How to set Shipping and Handling in PrestaShop 1.5</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 2: <a href='/support/edu/prestashop-15/working-with-shipping/add-shipping-carrier'>How to add a Shipping Carrier in PrestaShop 1.5</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 4: <a href='/support/edu/prestashop-15/working-with-shipping/set-default-shipping-carrier'>How to set a default Shipping Carrier in PrestaShop 1.5</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/prestashop-15/working-with-shipping/set-shipping-and-handling&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/prestashop-15/working-with-shipping/set-shipping-and-handling'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP3RzcmM9cnNiZWR1Jm9wdGlvbj1jb21fY29udGVudCZjYXRpZD0yMzMmaWQ9MTM5NiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="abb7e7373e859281e107ac6002671372" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/prestashop-15/working-with-shipping?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Working with Shipping in PrestaShop 1.5</h3></a>
		<table><tr><td colspan='2'><h4>Getting Started With Shipping</h4></td></tr>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/prestashop-15/working-with-shipping/add-shipping-to-product?tsrc=rsbedu'>Adding shipping to your products in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/prestashop-15/working-with-shipping/add-shipping-carrier?tsrc=rsbedu'>How to add a Shipping Carrier in PrestaShop 1.5</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/prestashop-15/working-with-shipping/set-shipping-and-handling?tsrc=rsbedu'>How to set Shipping and Handling in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/prestashop-15/working-with-shipping/set-default-shipping-carrier?tsrc=rsbedu'>How to set a default Shipping Carrier in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/prestashop-15/working-with-shipping/remove-shipping-carrier?tsrc=rsbedu'>How to remove a Shipping Carrier in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/prestashop-15/working-with-shipping/how-to-disable-a-carrier-in-prestashop-15?tsrc=rsbedu'>How to disable a Carrier in PrestaShop 1.5</a></td>
                </tr>
        <tr><td colspan='2'><h4>Advanced Shipping Configuration</h4></td></tr>  <tr >
                        <td valign='top'>7.</td>
                        <td><a href='/support/edu/prestashop-15/working-with-shipping/sort-carriers?tsrc=rsbedu'>How to sort Carriers in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>8.</td>
                        <td><a href='/support/edu/prestashop-15/working-with-shipping/add-carrier-logo?tsrc=rsbedu'>How to add a Carrier Logo in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>9.</td>
                        <td><a href='/support/edu/prestashop-15/working-with-shipping/set-carrier-speed-grade?tsrc=rsbedu'>How to set the Speed Grade for a Carrier in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>10.</td>
                        <td><a href='/support/edu/prestashop-15/working-with-shipping/set-carrier-zone?tsrc=rsbedu'>How to edit the Carrier Zone in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>11.</td>
                        <td><a href='/support/edu/prestashop-15/working-with-shipping/how-to-set-price-ranges-for-shipping-carriers-in-prestashop-15?tsrc=rsbedu'>How to set Price Ranges for Shipping Carriers in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>12.</td>
                        <td><a href='/support/edu/prestashop-15/working-with-shipping/set-shipping-weight-ranges?tsrc=rsbedu'>How to set Weight Ranges for Shipping Carriers in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>13.</td>
                        <td><a href='/support/edu/prestashop-15/working-with-shipping/shipping-fees-by-zone-carrier-and-ranges-in-prestashop-15?tsrc=rsbedu'>Shipping fees by zone, carrier, and ranges in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>14.</td>
                        <td><a href='/support/edu/prestashop-15/working-with-shipping/set-carrier-max-package-specs?tsrc=rsbedu'>How to set the max package specs for a Carrier in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>15.</td>
                        <td><a href='/support/edu/prestashop-15/working-with-shipping/set-carrier-out-of-range-behavior?tsrc=rsbedu'>Setting Out of Range behavior for Carriers in PrestaShop 1.5</a></td>
                </tr>
          	</table>
