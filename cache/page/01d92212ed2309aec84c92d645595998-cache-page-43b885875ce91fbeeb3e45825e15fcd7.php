<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49920:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/general-server-setup/i-want-request-dedicated-ip" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Shaker, Sorry for the problems with getting your dedicated IP addresses. I took a look at your account and you do have two dedicated IP addresses ..." />
  <title>i want request dedicated ip         | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/general-server-setup/i-want-request-dedicated-ip" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:2e4837d8f0192db83be2a8c3e5b66349 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>i want request dedicated ip        </h1>
...
I have changed my hosting plan from business to vps. Now I want to request getting dedicated IP addresses assigned to my account but via my AMP I can not request them.there is just one option to buy dedicated ip addresses.I would really appreciate it if you could please help me.</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_6976' id='upvote_answer_6976' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='6976' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_6976').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_6976' id='downvote_answer_6976' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='6976' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_6976').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Shaker,<br />
<br />
Sorry for the problems with getting your dedicated IP addresses.  I took a look at your account and you do have two dedicated IP addresses for your account that you do not need to purchase.  You have taken the correct route by <a href="http://www.inmotionhosting.com/support/website/getting-started-guides/submitting-and-checking-on-status-of-tickets">submitting a support ticket</a>.  Systems will need to assign the IP address as per your request.  <br />
<br />
...
Arnel C.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_6976').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_6976' id='form_comment_on_answer_6976' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="96f105a0bc2c9a9ea6001c2477ed9834" value="1" />	</div>
	</form>
<!-- <br />
