<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:55480:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/opencart/facebook-authentication-error-404" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, Sorry to hear about your problem with your website. The problem you're describing is very vague. Can you please be more specific? Facebook authen..." />
  <title>Facebook authentication error 404 | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/opencart/facebook-authentication-error-404" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:089433be9723e04bf781724a58a7808e -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Facebook authentication error 404</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2014-09-05 5:35 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>83</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Facebook authentication required for website hosted by inmotion. HOwever, when the user logs in using facebook, I get an error 404. </div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_5578' id='upvote_answer_5578' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='5578' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_5578').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_5578' id='downvote_answer_5578' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='5578' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_5578').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
Sorry to hear about your problem with your website.  The problem you're describing is very vague.  Can you please be more specific?  Facebook authentication is only used with InMotion Hosting in the Support Center login - we don't have anything to do with your website login.  Please provide us a URL or the specific information to duplicate the problem.  We can then investigate it to find a resolution.<br />
<br />
Regards,<br />
Arnel C.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_5578').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_5578' id='form_comment_on_answer_5578' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
...
<br />
I have a website hosted on inmotion based on openclassifieds. I was users to log in using their facebook credentials. I have created an app in facebook and configured my website to allow facebook authentication. However, when the user tries to log into the website using his facebook details, it fails to do so and the Error 404 is displayed<br />
<br />
</div>
							...
							<td style='width:96px;' valign='top'>
								...
								<div class='smallgrey'>
									<a href='/support/community-support/users/prathikpankaj'>prathikpankaj</a><br />
									3 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2014-09-05 6:20 pm EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello Prathikpankaj,<br />
<br />
Sorry to hear that the problem continues.  You have not provided enough information for us to duplicate the error.  When I look at the website, I'm seeing the re-direct to the login Facebook (if I click on the Facebook login option).  I did check the server logs and NO errors are being generated.  This means that the error is not occurring on the InMotion Hosting server (at least, we're not recording any error occurring).  I checked both the server logs in cpanel and apache web server logs.  They show no  problem.  You might want to look at how you're tying in your login with Facebook and see if the problem is there.  <br />
<br />
Apologies again that we don't have a direct answer for you.  Please double-check your code and see if you can identify where the error occurs.  When the website is running here, we are not seeing any error messages.<br />
<br />
Regards,<br />
Arnel C.</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>On another note.... the facebook login is not working. Its giving off an error saying that the app delepers did nkt sup up the app properly.... can this get checked? Cause im using my google login now for the support im not sure if anyo e else is getting the error but i am and ive tested it through 3 computers and 2 phones and a tablet</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello Christian,<br />
<br />
My facebook login is also behaving strangely. I am not getting an error, but it is simply stuck in attempting to log in. Thank you for pointing that out. I will forward that to the person who manages the login APIs.<br />
<br />
Kindest Regards,<br />
Scott M</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/opencart/facebook-authentication-error-404&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/opencart/facebook-authentication-error-404'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="a7d41e945e5214f7ab57918d79302523" value="1" />	</div>
	</form>
<!-- <br />
