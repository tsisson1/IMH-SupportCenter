<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:52284:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/wordpress/with-wordpress-the-child-theme-css-not-overriding-parent-themes-css" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, Thank you for your question about modifying the css on a WordPress theme. In our guide on Creating a Child Theme in WordPress it walks you throug..." />
  <title>With WordPress, the child theme CSS not overriding parent theme's CSS. | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/wordpress/with-wordpress-the-child-theme-css-not-overriding-parent-themes-css" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:279a82ee84cda602fb7f6ac2ac676323 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>With WordPress, the child theme CSS not overriding parent theme's CSS.</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-02-13 10:24 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>1,638</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I created a child theme and correspoding style.css file and functions.php within it for 2013.  The changes I make in the child's style.css are not occuring.  I checked with online chat who confirmed the child theme is active, but it appears the 2013 (not the child) page source is being used.  How can I change this so that I can make changes to my child theme using css?  Basically, my child css is not overriding my parent css.</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_6531' id='upvote_answer_6531' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='6531' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_6531').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_6531' id='downvote_answer_6531' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='6531' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_6531').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
Thank you for your question about modifying the css on a WordPress theme. In our guide on <a href="http://www.inmotionhosting.com/support/edu/wordpress/change-wordpress-appearance/wp-childtheme-2014">Creating a Child Theme in WordPress</a> it walks you through the setup process, including specifying the css file.<br />
<br />
I recommend following this guide to make sure you have completed the necessary steps.If it is still not working, review your code for typo, or misspellings.<br />
<br />
...
John-Paul
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_6531').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_6531' id='form_comment_on_answer_6531' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
...
Thanks for pointing me in the right direction.  I followed the WordPress directions for setting up a child theme, but the directions were missing the second line: wp_enqueue_style( 'child-style', get_stylesheet_uri(), array( 'parent-style' ) );<br />
This made all the difference and the css in the child theme works now.  Great support, thank you!<br />
<br />
</div>
							...
							<td style='width:96px;' valign='top'>
								...
								<div class='smallgrey'>
									<a href='/support/community-support/users/LynnADB'>LynnADB</a><br />
									3 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2015-02-14 7:19 am EST
								</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/wordpress/with-wordpress-the-child-theme-css-not-overriding-parent-themes-css&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/wordpress/with-wordpress-the-child-theme-css-not-overriding-parent-themes-css'></div>
<script type='text/javascript'>
  (function() {
