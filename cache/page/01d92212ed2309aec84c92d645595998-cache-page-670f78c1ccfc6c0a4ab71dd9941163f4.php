<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:60908:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/virtuemart-3/introduction/installation" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-01-27T15:49:01-08:00" />
  <meta name="keywords" content="VirtueMart 3 install Joomla vm3" />
  <meta name="author" content="John-Paul Briones" />
  <meta name="description" content="This guide teaches you how to setup VirtueMart 3 in Joomla." />
  <title>How to Install VirtueMart 3 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/virtuemart-3/introduction/installation" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:9aa5048a73bed442c8dfb128e8df6a66 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '79.21.12.240']);
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/virtuemart-3' itemprop='url'><span itemprop='title'>VirtueMart 3<span></a><div class='dropdown_2columns'><h2>VirtueMart 3 Education Channel</h2><div class='col_2'><h3>100 Level Classes</h3><div><a href='/support/edu/virtuemart-3/introduction'>101: An Introduction to VirtueMart</a></div><div><a href='/support/edu/virtuemart-3/working-with-products'>102: Working with Products in VirtueMart</a></div><div><a href='/support/edu/virtuemart-3/setting-up-taxes-shipping'>103: Setting up Taxes & Shipping in VirtueMart 3</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/virtuemart-3/introduction' itemprop='url'><span itemprop='title'>101: An Introduction to VirtueMart<span></a><div class='dropdown_3columns'><h2> An Introduction to VirtueMart</h2><div class='col_3'><div>1. <a style='display:inline;' href='/support/edu/virtuemart-3/introduction/installation'>How to Install VirtueMart 3</a></div><div>2. <a style='display:inline;' href='/support/edu/virtuemart-3/introduction/default-front-page'>How to Make VirtueMart 3 your Front Page</a></div><div>3. <a style='display:inline;' href='/support/edu/virtuemart-3/introduction/assign-menu-item'>How to make a VirtueMart 3 menu in Joomla</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to Install VirtueMart 3</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to Install VirtueMart 3									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>3,749</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Dec 12, 2014'><span style='color:#606060;'>Published:</span> Jan 27, 2015</div>
  ...
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('vm-core');">Installing VirtueMart 3</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('database-update-tools');">Enabling Database Update Tools</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('safe-path');">Setting the Safe Path</button>
</div>

<p>In this tutorial we will show you <strong>how to install <a href="/support/edu/virtuemart-3">VirtueMart 3</a> in Joomla</strong> 3. After installing VirtueMart 3 we will complete the setup by enabling Database Update Tools, and setting up a Safe folder path. You can then begin creating an e-commerce website, using this powerful shopping cart software.</p>

<a name="vm-core"></a>
<h2>Installing VirtueMart 3</h2>

<ol class="article_list">
  <li><a href="/support/edu/cpanel/softaculous/how-to-install">Install Joomla 3 using Softaculous</a>.</li>
<li>Download the <a href="http://virtuemart.net/downloads" target="_blank" >VirtueMart 3</a> core and AIO file. At the time this article was written, the file is titled <strong>com_virtuemart.3.0.0_extract_first.zip</strong>.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/virtuemart/downloading-vm3-core-aio.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/virtuemart/downloading-vm3-core-aio.png" alt="Acquire VM3 files" title="Download the VirtueMart 3 Core and aio files" /></a></li>
  <li><a href="/support/website/file-management/zip-unzip-win7#unzip" >Extract</a> the file you downloaded in <strong>Step 1</strong> to your computer, it will contain 2 files.</li>
  <li><a href="/support/edu/joomla-3/getting-started/login-dashboard">Login to the Joomla 3 Dashboard</a>. Click <strong>Extensions</strong>, then <strong>Extension Manager</strong>.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/virtuemart/extension-manager.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/virtuemart/extension-manager.png" alt="VM3 Extension installation" title="Installing VirtueMart 3 with the Extension Manager" /></a></li>
<li>You will then be on the <em>Upload & Install Joomla Extension</em> page. Click the <strong>Choose File</strong> button, select the core file (<strong>com_virtuemart.3.0.0.tar.gz</strong>), then click the <strong>Upload & Install</strong> button. See the steps in the screenshot below:<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/virtuemart/uploading-installing-vm3-core.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/virtuemart/uploading-installing-vm3-core.png" alt="Adding VM3 files" title="Upload and Install VirtueMart 3" /></a><br><br>
You will then see a <em>Notice</em>, with a summary of what was done. There will also be a message stating "<em>Installing component was successful.</em>"<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/virtuemart/vm3-install-notice.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/virtuemart/vm3-install-notice.png" alt="VM3 Installation notice" title="VirtueMart Install Notification" /></a></li>
<li>Scroll down and click the <strong>Choose File</strong> button again. This time select the <em>aio</em> file (<strong>com_virtuemart.3.0.0_ext_aio.tar.gz</strong>), then click the <strong>Upload & Install</strong> button. The image below shows you the steps to take.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/virtuemart/uploading-installing-vm3-core.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/virtuemart/uploading-installing-vm3-core.png" alt="VM3 Installation setup" title="Upload and Install VirtueMart 3" /></a><br><br>
You are finished when you see a message stating "<em>Installing component was successful</em>."</li>
<li><strong>Optional:</strong> Click the <strong>Install Sample Data</strong> button, to include example products and store information. This can be helpful when you are learning to use VirtueMart 3 for the first time.</li>
</ol>

<a name="database-update-tools"></a>
<h2>How to Enable Database Update tools in VirtueMart 3</h2>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/virtuemart/to-use-these-tools-fully-you-must-check-enable-database-update-tools-in-configuration-panel.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/virtuemart/to-use-these-tools-fully-you-must-check-enable-database-update-tools-in-configuration-panel.png" alt="VM3 error" align="right" title="Enable Database Update tools message" /></a>

<p>After installing VirtueMart 3, you will want to <strong>Enable database Update tools</strong>, which allows you to utilize the tools included with VirtueMart 3. We will now show you how to <strong>Enable Database update</strong> tools in VirtueMart.</p>

<ol class="article_list">
  <li><a href="/support/edu/joomla-3/getting-started/login-dashboard">Login to the Joomla 3 Admin Dashboard</a>.</li>
<li>In the navigation menu click <strong>VirtueMart</strong>, then <strong>Configuration</strong>.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/virtuemart/virtuemart-3-configuration.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/virtuemart/virtuemart-3-configuration.png" alt="VM3 Config" title="Accessing VirtueMart Configuration settings" /></a></li>
<li>Scroll down to the <em>Advanced Settings</em> section, and click the box next to <strong>Enable database Update tools</strong>.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/virtuemart/enable-database-update-tools-in-vm3.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/virtuemart/enable-database-update-tools-in-vm3.png" alt="VM3 DB updating" title="Enabling Database Update Tools in VirtueMart 3" /></a></li>
<li>Click the <strong>Save</strong> button to complete the setup.</li>
</ol>


<a name="safe-path"></a>
<h2>Setting the Safe Path in VirtueMart 3</h2>
<p>After installing VirtueMart 3, you will see the following message: "<em>Warning, the Safe Path is empty, for safety reasons it is very important to create a folder in a path not accessible by an URL, create also a folder invoices in it to store your sensitive data secure</em>." We will now show you how to set the <strong>Safe Path</strong> in VirtueMart 3.</p>

<ol class="article_list">
  <li><a href="/support/website/file-manager/create-new-file">Create a folder</a> titled <strong>vmfiles</strong> in the <em>/home</em> directory. Make sure the <a href="/support/website/managing-files/change-file-permissions">permissions</a> on the <em>vmfiles</em> folder is set to <strong>777</strong>. Then, create another folder titled <strong>invoices</strong> inside the <em>vmfiles</em> folder. When you are finished, it should be structured like this: home/userna99/vmfiles/invoices/<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/virtuemart/vmfiles-invoices-safe-path.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/virtuemart/vmfiles-invoices-safe-path.png" alt="Creating Safe Paths in VirtueMart" title="View of vmfiles, and invoices folder in cPanel File Manager" /></a></li>
<li><a href="/support/edu/joomla-3/getting-started/login-dashboard">Login to the Joomla 3 Admin Dashboard</a>.</li>
<li>In the navigation menu click <strong>VirtueMart</strong>, then <strong>Configuration</strong>.</li>
<li>On the next page, click the <strong>Templates</strong> tab. The following images show the steps in order.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/virtuemart/virtuemart-configuration-templates.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/virtuemart/virtuemart-configuration-templates.png" alt="VirtueMart Config Templates" title="VM3 Configuration Templates" /></a></li>
<li>Scroll down to the <em>Safe Path</em> field, and enter the path to files we created. For example: <strong>home/userna99/vmfiles/invoices/</strong>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/virtuemart/adding-safe-path-in-virtuemart.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/virtuemart/adding-safe-path-in-virtuemart.png" alt="VM3 Safe Path setup" title="Entering VirtueMart Safe Path" /></a></li>
<li>Click the <strong>Save</strong> button. You are finished when you see a "<em>Configuration Saved</em>" message.</li>
</ol>
  
<p>Congratulations, now you know how to successfully install VirtueMart 3 for Joomla 3! Now you can begin building your e-commerce store.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/virtuemart-3/introduction'>101: An Introduction to VirtueMart</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 1: How to Install VirtueMart 3</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 2: <a href='/support/edu/virtuemart-3/introduction/default-front-page'>How to Make VirtueMart 3 your Front Page</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/virtuemart-3/introduction/installation&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/virtuemart-3/introduction/installation'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD01MjEmaWQ9MzQ2NyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="003d2b5e974fe88786bedf54f4729bd6" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/virtuemart-3/introduction?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> An Introduction to VirtueMart</h3></a>
		<table>  <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/virtuemart-3/introduction/installation?tsrc=rsbedu'>How to Install VirtueMart 3</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/virtuemart-3/introduction/default-front-page?tsrc=rsbedu'>How to Make VirtueMart 3 your Front Page</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/virtuemart-3/introduction/assign-menu-item?tsrc=rsbedu'>How to make a VirtueMart 3 menu in Joomla</a></td>
                </tr>
          	</table>
