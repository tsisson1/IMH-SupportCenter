<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:65020:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.org/support/edu/website-design/inserting-links-into-website/creating-link-new-web-page" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-04-21T15:14:49-07:00" />
  <meta name="keywords" content="hyperlink link webpage design ahref a href external internal to another page anchor attribute" />
  ...
  <link href="http://www.inmotionhosting.com/support/edu/website-design/inserting-links-into-website/creating-link-new-web-page" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:bacd8143ee76465841a9f77ceeb8aace -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '173.208.130.146']);
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/website-design' itemprop='url'><span itemprop='title'>Website Design<span></a><div class='dropdown_4columns'><h2>Website Design Education Channel</h2><div class='col_2'><h3>100 Level Classes</h3><div><a href='/support/edu/website-design/website-design-basics'>101: Website Design Basics</a></div><div><a href='/support/edu/website-design/insert-images-website'>102: Inserting Images into a Website</a></div><div><a href='/support/edu/website-design/inserting-links-into-website'>103: Inserting Links into a Website</a></div><div><a href='/support/edu/website-design/meta-tags-explained'>104: Meta Tags Explained</a></div><div><a href='/support/edu/website-design/html-5-syntax'>105: HTML 5 Basic syntax</a></div></div><div class='col_2'><h3>200 Level Classes</h3><div><a href='/support/edu/website-design/adding-videos-website'>201: Adding Videos to a Website</a></div><div><a href='/support/edu/website-design/adding-contact-forms'>202: Adding Contact Forms </a></div><div><a href='/support/edu/website-design/using-css'>203: Using and Understanding CSS</a></div><div><a href='/support/edu/website-design/website-design-best-practices'>204: Website Design Best Practices</a></div><div><a href='/support/edu/website-design/using-php-and-mysql'>205: Using PHP to create dynamic pages</a></div><div><a href='/support/edu/website-design/create-responsive-template'>206: Creating Responsive Templates</a></div><div><a href='/support/edu/website-design/search-engine-optimization'>207: Search Engine Optimization</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/website-design/inserting-links-into-website' itemprop='url'><span itemprop='title'>103: Inserting Links into a Website<span></a><div class='dropdown_3columns'><h2> Inserting Links into a Website</h2><div class='col_3'><div>1. <a style='display:inline;' href='/support/edu/website-design/inserting-links-into-website/creating-link-new-web-page'>Using the anchor tag to create links</a></div><div>2. <a style='display:inline;' href='/support/edu/website-design/inserting-links-into-website/creating-an-email-link-in-your-webpage'>Creating an Email Link in your Webpage</a></div><div>3. <a style='display:inline;' href='/support/edu/website-design/inserting-links-into-website/opening-new-window-with-link'>Opening a new window with a link</a></div><div>4. <a style='display:inline;' href='/support/edu/website-design/inserting-links-into-website/anchor-links-create'>Anchor Links and How to Create Them</a></div><div>5. <a style='display:inline;' href='/support/edu/website-design/inserting-links-into-website/hotlink-direct-link'>Hotlink or Direct link to files on the server</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Using the anchor tag to ...</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Using the anchor tag to create links									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>9,236</span></div>
							...
							<div style='clear:both;'></div>
								...
								<p>There are two types of links to pages you can create. There is the "<em>Internal Link</em>" and the "<em>External Link</em>". An "<em>Internal Link</em>" is a link in your site that navigates the visitor to another page in your website. The "<em>External Link</em>" navigates the visitor away from your site to another website in the internet (like http://google.com). Below are examples of an external and internal link. The <code>&lt;a&gt;</code> in an HTML tag called an "<em>anchor</em>". The anchor can have different attributes inside. The "<em>href</em>" attribute is the location the link takes you when clicked.</p>
<p class="alert"><strong>Note!</strong> If you are using a Content Management System like Drupal, Joomla, Wordpress or the Premium Web Builder, you will use their WYSIWYG editor to create links. For more information see the following links.</p>
<h2>Creating an Internal link in your website</h2>
<p>This first link is the "<em>Internal Link</em>". Internal links reference to a file location on your server. The path to the file location is placed in the "<em>href</em>" attribute. To link a page in your own site you reference the location of the file in the "<em>href</em>" attribute. For Example, if you place a file called <em>nextpage.html</em> in <a target="_blank" href="/support/website/getting-started-guides/where-to-upload-files">your public_html for your main domain</a>, you simply put the file name like below.</p>
<pre class="code_block" style="margin-left: 20px;">&lt;a href="/support/nextpage.html"&gt;This text will now be a link&lt;/a&gt;</pre>
...
<pre class="code_block" style="margin-left: 20px;">&lt;a href="/support/subfolder/nextpage.html"&gt;This text will now be a link&lt;/a&gt;</pre>
<p class="alert"><strong>Important!</strong> Don't forget to close out the tag with the proper closing tag which is <code>&lt;/a&gt;</code>. If you don't close the tag the entire page below the tag will become a hyperlink as well.</p>
...
<pre class="code_block" style="margin-left: 20px;">&lt;a href="http://inmotionhosting.com"&gt;Text that will be a link&lt;/a&gt;</pre>
...
<tbody>
<tr><th style="text-align: center;" colspan="2">Basic Anchor Attributes</th></tr>
<tr><th width="87">href</th>
<td width="936">This attribute specifies where the link will navigate to.
<pre style="margin: 5px 0px 5px 20px;">&lt;a <strong>href="nextpage.html"</strong>&gt;This text will now be a link&lt;/a&gt;</pre>
</td>
</tr>
<tr><th>target</th>
<td>You can have your links open in a new tab or open in the same window with the target.
<pre style="margin: 5px 0px 5px 20px;">_blank (Opens in a new tab)<br />
_parent (Opens in the parent frame.)<br />
_self (Opens in the same window.)<br />
_top (Opens the same as self except works with frames.)</pre>
The below is an example of the <em>_blank</em>target.
<pre style="margin: 5px 0px 5px 20px;">&lt;a href="/support/nextpage.html" <strong>target="_blank"</strong>&gt;This text will now be a link&lt;/a&gt;</pre>
</td>
</tr>
<tr><th>title</th>
<td>Shows information about the link. When you hover your mouse over a link with a title tag, a little pop up will display the text in this attribute.
<pre style="margin: 5px 0px 5px 20px;">&lt;a href="/support/nextpage.html" <strong>title="Click here to see this link"</strong>&gt;This text will now be a link&lt;/a&gt;</pre>
</td>
</tr>
<tr><th>name</th>
<td>This is the name of the anchor, This is used for linking to a specific spot in a page. For example, if you want to navigate to the bottom of your web page, you can add a name attribute like:
<pre style="margin: 5px 0px 5px 20px;">&lt;a name="bottom"&gt;bottom&lt;/a&gt;</pre>
When you create this name you can reference your site like:
<pre style="margin: 5px 0px 5px 20px;">http://example.com/#bottom</pre>
Visiting this will send the web surfer to the bottom of your main page.
<pre style="margin: 5px 0px 5px 20px;">&lt;a href="/support/nextpage.html" <strong>name="location_of_page"</strong>&gt;This text will now be a link&lt;/a&gt;</pre>
</td>
</tr>
</tbody>
</table>
<p>Please check the next article on <a href="/support/edu/website-design/inserting-links-into-website/creating-an-email-link-in-your-webpage" target="_blank" title="Click here to view the next article"> Creating an Email Link in your Web page.</a> For more information on this course please visit <a target="_blank" href="/support/edu/website-design/inserting-links-into-website" title="Click here to view the courses">Inserting Links into a Website</a>.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/website-design/inserting-links-into-website'>103: Inserting Links into a Website</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 1: Using the anchor tag to create links</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 2: <a href='/support/edu/website-design/inserting-links-into-website/creating-an-email-link-in-your-webpage'>Creating an Email Link in your Webpage</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.org/support/edu/website-design/inserting-links-into-website/creating-link-new-web-page&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.org/support/edu/website-design/inserting-links-into-website/creating-link-new-web-page'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xNDUmaWQ9OTUzJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="b3e2c997fd537c652db50ba260f1947b" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/website-design/inserting-links-into-website?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Inserting Links into a Website</h3></a>
		<table>  <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/website-design/inserting-links-into-website/creating-link-new-web-page?tsrc=rsbedu'>Using the anchor tag to create links</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/website-design/inserting-links-into-website/creating-an-email-link-in-your-webpage?tsrc=rsbedu'>Creating an Email Link in your Webpage</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/website-design/inserting-links-into-website/opening-new-window-with-link?tsrc=rsbedu'>Opening a new window with a link</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/website-design/inserting-links-into-website/anchor-links-create?tsrc=rsbedu'>Anchor Links and How to Create Them</a></td>
                </tr>
          <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/website-design/inserting-links-into-website/hotlink-direct-link?tsrc=rsbedu'>Hotlink or Direct link to files on the server</a></td>
                </tr>
          	</table>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/7dd0865580127844a2d8a211ee904dbc?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/7dd0865580127844a2d8a211ee904dbc'>Sally Walborn</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-06 3:32 pm</div>
				                <div><p>One of your techs sent me a link to the above information, but I need more basic instruction. I am trying to create a link in Premium Web Builder from a specific word or phrase on one webpage to further information about that word, like a definition, on another webpage (on the same website).</p>
<p>It looks like the info above is what I need, but it is too advanced for me. Can you give me more step-by-step basic instruction? How do I fix the location of the anchor - do I highlite it? And where am I entering all of this information?</p>
<p>Sorry, I wish I could be more specific. I pretty much understand the instructions above, but need a little more before and after instructions.</p>
<p>Thanks - hope you can help. </p>
<p>Sally</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25545);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-06 5:22 pm</div>
				                <div>Hello Sally,<br />
<br />
Thank you for contacting us. Yes, the above guide is for creating an HTML link, but since you are using the Builder we have a more detailed guide: <a href="http://www.inmotionhosting.com/support/edu/premium-website-builder/303-external-links-in-builder">Adding External Links in the Premium Website Builder</a><br />
<br />
You can also link to places within the page using <a href="http://www.inmotionhosting.com/support/edu/premium-website-builder/linking-in-the-web-builder/anchor-links-builder">anchor links</a>.<br />
<br />
If you have any further questions, feel free to post them below.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25554);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
