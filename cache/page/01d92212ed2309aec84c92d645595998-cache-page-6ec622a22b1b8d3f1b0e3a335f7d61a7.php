...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/wordpress/import-data-blogger" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-01-28T18:55:34-08:00" />
  <meta name="keywords" content="google blogger import move migrate wordpress blogspot blog Tumblr LiveJournal" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="Google Blogger can be imported into WordPress. This article will explain how to import your Google Blogspot data into WordPress." />
  <title>Importing Blogger data into WordPress - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/wordpress/import-data-blogger" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:e6ddcc916b244fadea742bb469c3dc27 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '85.15.7.131']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Importing Blogger data into WordPress</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Importing Blogger data into WordPress									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>7,719</span></div>
							...
							<div style='clear:both;'></div>
								...
								<p>Customers that initially built their blog sites with <strong>Google Blogger (Blogspot)</strong> can have the blog information imported into their WordPress software by using the "<em>Import</em>" feature in the WordPress dashboard. WordPress has a built in "<em>Import</em>" feature that allows you to import different blogs like Blogspot, Tumblr, LiveJournal, and even WordPress. The import process is the same for each. This article will walk you through the steps in importing your <strong>Blogspot</strong> into your WordPRess on our server.</p>
<h3>Importing a Blogger site into WordPress</h3>
...
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/import-site-blogger/import-from-blogger-1-click-import.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Click import in WordPress" src="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/import-site-blogger/import-from-blogger-1-click-import.gif" title="Click here to view the larger image" width="100" /></a>Navigate to <strong>Tools</strong> &gt; <strong>Import</strong>. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/import-site-blogger/import-from-blogger-2-select-blogger.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Select blogger from import list WordPress" src="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/import-site-blogger/import-from-blogger-2-select-blogger.gif" title="Click here to view the larger image" width="100" /></a>On the list of sites to import, <strong>select "<em>Blogger</em>"</strong> from the list. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/import-site-blogger/import-from-blogger-3-install-now.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Install Blogspot plugin WordPress" src="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/import-site-blogger/import-from-blogger-3-install-now.gif" title="Click here to view the larger image" width="100" /></a>On the install importer pop up box, <strong>click "<em>Install now</em>"</strong>. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/import-site-blogger/import-from-blogger-4-activate.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Activate Blogspot plugin WordPress" src="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/import-site-blogger/import-from-blogger-4-activate.gif" title="Click here to view the larger image" width="100" /></a>The "<em>Installing Plugin: Blogger Importer 0.5</em>" screen<strong> click "Activate Plugin &amp; Run Importer"</strong>. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/import-site-blogger/import-from-blogger-5-authorize.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Authorize Blogspot access WordPress" src="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/import-site-blogger/import-from-blogger-5-authorize.gif" title="Click here to view the larger image" width="100" /></a>Now the import Blogger page will show. <strong>Select the "<em>Authorize</em>" button</strong>. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/import-site-blogger/import-from-blogger-6-grant-access.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Grant access to Blogspot WordPress" src="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/import-site-blogger/import-from-blogger-6-grant-access.gif" title="Click here to view the larger image" width="100" /></a>Your WordPress will direct you to Google to Grant access to your blogger site, <strong>click "Grant Access"</strong>. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/import-site-blogger/import-from-blogger-7-imported.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Imported BlogSpot in WordPress" src="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/import-site-blogger/import-from-blogger-7-imported.gif" title="Click here to view the larger image" width="100" /></a>Your Blog name and url should appear in the list of Blogger Blogs. When your Blogger site is updated, under "<em>The Magic Button</em>" column <strong>click "Import"</strong> and your blogger will be imported to your WordPress. <br style="clear: both;" /></li>
<p>Congratulations! You have successfully imported your Google Blogspot blog into your Wordpress on your server.</p>
</ol> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/wordpress/import-data-blogger&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/wordpress/import-data-blogger'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD02MyZpZD01MjImdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="21e295d8aef48af101c2e99dd83664b8" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/wordpress/can-i-transport-blogger-to-wordpress?tsrc=rsbraq'>Can i transport Blogger to Wordpress?</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/80246acdb9ee9a361390298daacc6272?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/80246acdb9ee9a361390298daacc6272'>Export Import Data </a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-23 8:18 am</div>
				                <div><p>Thanks for sharing useful Information for user.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26911);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
