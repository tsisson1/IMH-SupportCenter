<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:61879:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/drupal-7/views-module-tutorial/create-block-display" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-07-31T15:16:57-07:00" />
  <meta name="keywords" content="Drupal 7 Views module Block page change create" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Learn how to take an existing View page and make a Block display version in Drupal 7 Views." />
  <title>Creating a block display for a View in Drupal 7 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/drupal-7/views-module-tutorial/create-block-display" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:e9edf84b2418650729a6d34767b765ed -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '197.211.53.46']);
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
				<img src='/support/images/stories/drupal-partner/supporting-partner-80_3.png' style='float:right; margin:0px 0px 15px 15px;' alt='Drupal Association Support Partner'>		<h1>
															Creating a block display for a View in Drupal 7									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>24,219</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jul 27, 2012'><span style='color:#606060;'>Published:</span> Jul 31, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In our last article, we created a very simple view as a page. This page appears as on the main menu of the site and lists the articles much like a blog index does. Views also allows you to take the list you created and save it in a Block format, so it can be added as a piece of an overall layout instead of simly a stand alone page. This tutorial will take the original View we made and show you how to make it into a block.</p>
<p><strong>How to create a block display from an existing View in Drupal 7</strong></p>
...
<li>If you have the <strong>Views </strong>module installed, you should see a <strong>Views </strong>content type in the list. If not, you will need to <a href="/support/edu/drupal-7/intro-to-modules/how-to-upload-a-new-module-to-drupal">install and enable the Views module</a>. Click on the <strong>Views</strong> option to move to the next screen.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Views/structure-views.png"><img  alt="structure-views" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Views/structure-views.png" /></a></li>
<li>You are now on the Views list screen. Available Views are listed below with enabled view listed at the top above the grayed out views, which are disabled. From here, click on the <strong>Edit </strong>link for the View you want to work with.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Views/Add_Display/edit-view.png"><img  alt="edit-view" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Views/Add_Display/edit-view.png" /></a></li>
<li>Now you are on the Display Edit screen. Up at the top you will see the types of displays you have for your View. In our example, we only have a Page display, which is selected at the moment. We want to add a Block display as well, so click on the <strong>+Add</strong> button next to the <strong>Page </strong>button. From there, select the <strong>Block </strong>option.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Views/Add_Display/add-display.png"><img  alt="add-display" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Views/Add_Display/add-display.png" /></a></li>
<li>The screen now shows the <strong>Block </strong>display option and that display has focus. This means that all of the settings on the page are for your new <strong>Block </strong>display. Notice there is a message at the top of the screen that says "<em>All changes are stored temporarily. Click Save to make your changes permanent. Click Cancel to discard your changes.</em>" This means the block display is not yet saved. You must click the Save button at the top right to save the display and any changes you make to the settings.|<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Views/Add_Display/new-block-save.png"><img  alt="new-block-save" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Views/Add_Display/new-block-save.png" /></a></li>
<li>You can check to see your block by clicking on Structure from the top menu bar and then selecting the Blocks option.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/blocks.png"><img  alt="blocks" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/blocks.png" /></a><br /><br /></li>
<li>Scroll down to the Disabled Blocks list and you will see your View Block, ready to add to your template as you see fit!<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Views/Add_Display/view-block.png"><img  alt="view-block" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Views/Add_Display/view-block.png" /></a></li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 4: Creating a block display for a View in Drupal 7</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 3: <a href='/support/edu/drupal-7/views-module-tutorial/enable-view'>Enabling a view in Drupal 7 Views</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 5: <a href='/support/edu/drupal-7/views-module-tutorial/change-view-title'>Changing the title for a view in the Drupal 7 Views Module</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/drupal-7/views-module-tutorial/create-block-display&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/drupal-7/views-module-tutorial/create-block-display'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNDUmaWQ9MTYyOCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
          ...
          <tr >
			...
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/drupal-7/drupal-commerce-and-related-products?tsrc=rsbraq'>drupal commerce and related products</a>
                                </div>
