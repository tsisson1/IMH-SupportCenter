<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:124350:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/security/ssl-lock-display" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-02-17T19:13:11-08:00" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Is your SSL lock not displaying in your browser? Check this article to find out why." />
  <title>My SSL Lock is not displaying properly - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/security/ssl-lock-display" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:79baa0a24912fa87ee9bd0c34a338f24 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '130.105.193.186']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>My SSL Lock is not displaying properly</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															My SSL Lock is not displaying properly									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>16,511</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Sep 25, 2013'><span style='color:#606060;'>Published:</span> Feb 17, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Using an <a href="/support/website/ssl/what-is-ssl-and-why-is-it-important">SSL certificate</a> on your website is very important for security. It is used to create an encrypted connection to the server to protect data from prying eyes. Though it can be used across an entire site, it is most commonly used for portions of the site that use sensitive information, such as shopping cart checkout areas.</p>
   
<h2>How do I know the SSL is working?</h2>
<p>It is very important for your visitors to know when they are on a secure area of your site. When the SSL is active on the page you are viewing, they can tell by checking the address bar at the top of the browser. There should be a small padlock icon in the address bar area. The format can can vary among the different browsers. Below are a few examples of different sites with different browsers.</p>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/security/SSL/lock-disappear/chrome-lock.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="200" src="//cdn.inmotionhosting.com/support/images/stories/edu/security/SSL/lock-disappear/chrome-lock.png" alt="Chrome Security Lock" align="right" ></a>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/security/SSL/lock-disappear/firefox-lock.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="200" src="//cdn.inmotionhosting.com/support/images/stories/edu/security/SSL/lock-disappear/firefox-lock.png" alt="FireFox Security Lock" align="right" ></a>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/security/SSL/lock-disappear/ie-lock.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="200" src="//cdn.inmotionhosting.com/support/images/stories/edu/security/SSL/lock-disappear/ie-lock.png" alt="IE Security Lock" align="right" ></a>
</p>
<p>&nbsp;</p>            
<h2>Why does my lock disappear?</h2>
<p>It is a common reaction to blame the SSL or host for having the certificate installed improperly. This is usually not the case.  The SSL lock will only appear or display properly if all items on the page are linking securely. If there is even one unsecure link on the page, the SSL will appear as broken. This means it may not display at all, or it may display differently. Again, this will vary depending on the browser you are using. Below are examples of the same browsers using a page that is partially unsecure.</p>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/security/SSL/lock-disappear/chrome-no-lock.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="200" src="//cdn.inmotionhosting.com/support/images/stories/edu/security/SSL/lock-disappear/chrome-no-lock.png" alt="Chrome improper lock" align="right" ></a>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/security/SSL/lock-disappear/firefox-no-lock.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="200" src="//cdn.inmotionhosting.com/support/images/stories/edu/security/SSL/lock-disappear/firefox-no-lock.png" alt="Firefox no lock visible" align="right" ></a>
  <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/security/SSL/lock-disappear/ie-no-lock.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="200" src="//cdn.inmotionhosting.com/support/images/stories/edu/security/SSL/lock-disappear/ie-no-lock.png" alt="IE no lock visible" align="right" ></a></p>
<p>&nbsp;</p>                
<p>Almost exclusively, the cause for this is the use of absolute links for images and text links within the page code instead of relative links. If even ONE link on the page is using the absolute format it will 'break' an otherwise secure page. Below are descriptions of absolute and relative addresss linking.</p>
            
    <h3>Absolute addresses</h3>
    <p>Absolute adddressing for images and links include the entire domain name and the prorocol, which is typically http://. For example, if you were linking image.jpg and your domain name was example.com, the link would be code as <em>&lt;img src="http://example.com/image.jpg"&gt;</em></p>
    
            <h3>Relative addresses</h3>
        <p>Relative addresses differ from absolute in that they include neither the protocol nor the domain name. Using the same image.jog file as before, he link code to that file in would simply be <em>&lt;img src="/support/image.jpg"&gt;</em>.</p>
            
<h2>It's a coding issue? How do I correct it?</h2>
        <p>The solution is 'relatively' easy, pun intended. You will need to go through the code for your site and change all absolute links to relative ones. With hand-code sites this can be a simple, but tedious process. If your site is coded with a Content Managemetn System such as WordPresss or Drupal, they should already follow this rule on the core level, so you will want to check any links that have been included in the content addition areas such as the editors within the program where you create pages and posts. Once you or your developer has completed this process, you should be able to refresh your site and the lock should display in the correct format.</p>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/security/ssl-lock-display&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/security/ssl-lock-display'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NDUmaWQ9Mjg1NiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="dfccd8bc77e4ba820d799a56a3684283" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/45f4c66d2e5b3ad3a04adba3d78316f6?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/45f4c66d2e5b3ad3a04adba3d78316f6'>HoPhuong</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-06 5:48 am</div>
				                <div><p>http://livesuperfoods.com/&nbsp;</p>
<p>http://healthygoods.com/</p>
<p>I have 2 websites so how &nbsp;to show error ssl that is same to "chrome-to-lock.jpg" of this post.?</p>
<p>I am looking forward to hearing your new replying. Thanks!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13684);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-06 8:49 am</div>
				                <div>Hello HoPhuong,<br />
<br />
As stated in the article, the cause for the lock not displaying is almost entirely due to having absolute links  in your code. Simply checking the code for the links is what you will need to do. If you would like to have a list of everything that is wrong, you can enter your domain name at <a href="http://whynopadlock.com">http://whynopadlock.com</a>. This will give you a list of every error found. I tested one of your domains and it found over 60 image links that use absolute linking with http://. <br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13690);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/45f4c66d2e5b3ad3a04adba3d78316f6?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/45f4c66d2e5b3ad3a04adba3d78316f6'>Ho Phuong</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-07 6:36 am</div>
				                <div><p>Sorry. I told "no true".&nbsp;</p>
<p>These are 2 websites as&nbsp;http://livesuperfoods.com/ &nbsp;; &nbsp;&nbsp;http://healthygoods.com/</p>
<p>How to show an exclamation in the front of these websites (not&nbsp;"yellow triangle").?</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13715);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-07 9:20 am</div>
				                <div>Hello Ho Phuong,<br />
<br />
The yellow triangle is the image that particular browser uses. For instance, FireFox displays the exclamation point while Chrome displays the yellow triangle.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13730);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-18191'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/e1de36649bcdac1285fe9d03f26f1672?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/e1de36649bcdac1285fe9d03f26f1672'>Shamiso H</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-05 11:35 am</div>
				                <div><p>DOMAIN: bayshorefuel.com, I've&nbsp;run my<span style="color: rgb(35, 35, 35); font-family: adelle-sans, Helvetica, Arial, sans-serif; font-size: 13px; line-height: 22px;">&nbsp;domain name at&nbsp;</span><a style="color: rgb(75, 160, 225); text-decoration: none; font-family: adelle-sans, Helvetica, Arial, sans-serif; font-size: 13px; line-height: 22px;" href="http://whynopadlock.com/">http://whynopadlock.com</a><span style="color: rgb(35, 35, 35); font-family: adelle-sans, Helvetica, Arial, sans-serif; font-size: 13px; line-height: 22px;">. It comes back with ==&gt;</span></p>




<p><strong>Domain Name:</strong>&nbsp;www.bayshorefuel.com<strong>URL Tested:</strong>&nbsp;https://www.bayshorefuel.com/<strong>Number of items downloaded on page:</strong>&nbsp;70</p>



<img src="https://www.whynopadlock.com/x.PNG" alt="" width="40" height="40" align="absmiddle" />
<strong>SSL verification issue</strong>&nbsp;(Possibly mis-matched URL or bad intermediate cert.). Details:ERROR: cannot verify www.bayshorefuel.com's certificate, issued by '/C=GB/ST=Greater Manchester/L=Salford/O=COMODO CA Limited/CN=COMODO SSL CA': Unable to locally verify the issuer's authority.
<p>&nbsp;</p>
<p>&nbsp;</p>
...
<img src="https://www.whynopadlock.com/check.PNG" alt="" width="40" height="40" align="absmiddle" />
<strong>Certificate valid through</strong>: Jan 3 23:59:59 2015 GMT<strong>Certificate Issuer</strong>: COMODO CA Limited
...
<img src="https://www.whynopadlock.com/check.PNG" alt="" width="40" height="40" align="absmiddle" />
<strong>All 70 items called securely!</strong>
...
<p>QUESTION:</p>
<p>&nbsp;</p>
<p>When customers are looking up bayshorefuel.com using Android, smart phones, they are getting a warning message. One warning is "There are problems with the security certificate for the site" another is "Certificate not from a trusted authority". We already submitted a ticket and the problem doesn't seem to get fixed. It has to do with the SSL Certificate.&nbsp;</p>
<p>Any suggestions on what to do next will be appreciated.</p>
<p>-Thanks</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(18191);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-05 1:14 pm</div>
				                <div>Hello Shamiso H,<br />
<br />
I have re-installed your SSL which as fixed the issue, I apologize for the trouble in the matter. It seemed that something with your cabundle was messed up.<br />
<br />
Kindest Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(18196);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-05 1:42 pm</div>
				                <div><p>Thank you so much for taking such immediate care, TJ Edens. I've run my domain bayshorefuel.com again at&nbsp;<a style="color: #4ba0e1; text-decoration: none; font-family: adelle-sans, Helvetica, Arial, sans-serif; font-size: 13px; line-height: 22px;" href="http://whynopadlock.com/">http://whynopadlock.com</a>&nbsp;and a valid certificate was found. All went thorugh fine.</p>
<p>&nbsp;</p>
<p>But I am still not getting the lock to display in the browsers. I have looked at the website code to make sure absolute and relative URLs (adresses) don't exist. Please can you help!</p>
<p>Many Thanks for your support.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(18201);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-05 2:45 pm</div>
				                <div>Hello Shamiso,<br />
<br />
Thank you for your question. When I initially load your site, the padlock comes up successfully, but after a few seconds the padlock disappears.<br />
<br />
When I viewed the source for your page, and searched for "http://" (without the quotation marks), I found the following result:<br />
<div class="code_block">&ltlink rel="pingback" href="http://www.bayshorefuel.com/xmlrpc.php" /&gt</div><br />
<br />
It looks like this xmlrpc.php script is being called in insecurely, after your site initially loads, causing the padlock to break.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(18206);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-05 3:31 pm</div>
				                <div><p>Dear John-Paul, I am afraid that the script you mentioned&nbsp;<span style="font-family: 'Courier New', Courier, monospace; font-size: 12px; line-height: 22px; white-space: nowrap; background-color: rgb(242, 242, 242);">&lt;link rel="pingback" href="http://www.bayshorefuel.com/xmlrpc.php" /&gt;</span>might not be the cause. There is something else going on. I have removed &nbsp;<span style="font-family: 'Courier New', Courier, monospace; font-size: 12px; line-height: 22px; white-space: nowrap; background-color: #f2f2f2;">&lt;link rel="pingback" href="http://www.bayshorefuel.com/xmlrpc.php" /&gt;</span>and I still don't get a padlock .</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(18211);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-05 4:10 pm</div>
				                <div>Hello Shamiso,<br />
<br />
Thank you for contacting us. I noticed the padlock is breaking when the arrow pops up in your image slider, next to the middle picture.<br />
<br />
When I inspected the page in Chrome, I noticed another image is being called in insecurely:<br />
http://www.bayshorefuel.shamisohart.com/wp-content/themes/bayshore/featured_images/selected-item.gif<br />
<br />
This image is breaking the security of the page, and the padlock.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(18213);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-19922'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/2848ab2631c7daec63bdcaec2a174b8b?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/2848ab2631c7daec63bdcaec2a174b8b'>Marshall Schaffer</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-25 5:30 pm</div>
				                <div>It is perfect.  I had not realized that links to other sites and pictures had to *themselves* use https and relative paths, respectively.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19922);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-27478'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/bde89a330be23295f661ef8c074f5570?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/bde89a330be23295f661ef8c074f5570'>SuperMike</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-13 12:16 am</div>
				                <div><p>If you are using the popular Yoast SEO plug in be sure to check your cononical settings for each page. &nbsp;That is, for each page scroll down to the Yoast SEO settings and click on Advanced. &nbsp;The last item in this box is Cononical URL. &nbsp;Set all Cononicals to https://www.example.com not http://www.example.com</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27478);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-29783'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/ba7e061302fce27193e22a90e9e67c2b?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/ba7e061302fce27193e22a90e9e67c2b'>Jeannette</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-13 3:25 pm</div>
				                <div><p>Hello, we recently installed an SSL certificate but don't show a padlock. &nbsp;When testing on whynopadlock.com it comes back with this error:</p>
<p><strong style="margin: 0px; padding: 0px; border: 0px; outline: 0px; font-size: 14px; font-family: 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif; vertical-align: baseline; color: #666666; line-height: 21px;">content.incapsula.com</strong><span style="color: #666666; font-family: 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif; font-size: 14px; line-height: 21px;">&nbsp;is an invalid URL/domain</span></p>
<p><span style="color: #666666; font-family: 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;"><span style="font-size: 14px; line-height: 21px;">Our domain is bransoncedarsresort.com</span></span></p>
<p><span style="color: #666666; font-family: 'Lucida Grande', 'Lucida Sans Unicode', Geneva, Verdana, sans-serif;"><span style="font-size: 14px; line-height: 21px;">thank you</span></span></p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29783);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-13 3:34 pm</div>
				                <div>Hello Jeannette,<br />
<br />
When you look at the evaluation page from whynopadlock.com, it's basically telling you why there is no padlock.  It says, "Secure calls made to other websites: content.incapsula.com is an invalid URL/domain".  This means that somewhere on your website page, it's making call to that URL - which is being declared as an invalid domain.  Remove that call and then your padlock will show.<br />
<br />
If you have any further questions or comments, please let us know.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29784);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-13 3:39 pm</div>
				                <div><p>Hi Arnel, thanks for being so fast. &nbsp;I am a newbie and not someone that is familiar with coding. &nbsp;Can you tell me how and where to do that? &nbsp;thank you! &nbsp;Jeannette</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29786);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-13 4:12 pm</div>
				                <div>Hello Jeannette,<br />
<br />
I'm sorry that you're unfamiliar with the code for your website.  When I take a quick look and do a search for "incapsula" on the front page I'm seeing it in two places and it's referenced by a script. Since the script is not coming from a source that's covered by your SSL certificate, it is being listed as insecure.  You may need to remove a plugin, or change something in the theme to correct this.  If you're not familiar with it, then you may need to speak with a developer to get this done.  <br />
<br />
I hope this helps to answer your question, please let us know if you require any further  assistance.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29790);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-13 4:18 pm</div>
				                <div><p>Hi Arnel, I appreciate your help. &nbsp;thanks,&nbsp;Jeannette</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29791);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-13 5:13 pm</div>
				                <div>Hello Jeannette,<br />
<br />
No problem.  If you have any further questions or comments, please let us know.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29794);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-30719'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/707854c61f898a259507b38cbe1061e0?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/707854c61f898a259507b38cbe1061e0'>Sue</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-02-22 5:40 am</div>
				                <div><p>Hello, we recently installed an SSL certificate but don't show a padlock. &nbsp;When testing on whynopadlock.com it comes back with this error:</p>
<p><span style="color: red;"><strong>*** NOTE ***:</strong></span> 0 items means no images were downloaded or existed on the page. It's likely the URL you submitted was not a valid secure URL, or the page being tested only has text on it. Try copying and pasting the secure URL into a new browser window to make sure it displays as you'd expect.</p>
...
<img style="padding: 0px; border: 0px; background-color: white;" src="https://www.whynopadlock.com/x.PNG" alt="" width="40" height="40" align="absmiddle" />
<strong>Website returned an error</strong> (Possibly 404 not found or other webserver error). Details:HTTP/1.0 503 Service Unavailable





<img style="padding: 0px; border: 0px; background-color: white;" src="https://www.whynopadlock.com/check.PNG" alt="" width="40" height="40" align="absmiddle" />

<p><strong>Certificate valid through</strong>: Feb 22 08:38:58 2017 GMT<strong>Certificate Issuer</strong>: GeoTrust Inc. <strong>SSL Protocols Supported</strong>: TLSv1 TLSv1.1 TLSv1.2</p>
<p>&nbsp;</p>
<p><strong>Domain Name:</strong> www.lifeinterwoven.org</p>
<p>&nbsp;</p>
<p>I am learning to install SSL certificate.</p>
<p>&nbsp;</p>
...
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30719);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-02-22 10:04 pm</div>
				                <div><p>Hi Arnel,</p>
<p>&nbsp;</p>
<p>Thank you very much for your knowledge. I appreciate your help.</p>
<p>Regards</p>
<p>Sue</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30744);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-31064'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/0571a3f23e83914f743ce6bf04b0cbb9?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/0571a3f23e83914f743ce6bf04b0cbb9'>Diego</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-08 11:41 pm</div>
				                <div><p>Thanks for all of this information.&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31064);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-31237'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/1283872fdcffeea7cbf477684824354d?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/1283872fdcffeea7cbf477684824354d'>Toks Fashion</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-15 5:00 am</div>
				                <div><p>Hello there,</p>
<p>Please help me, I have recently bought a dedicated IP and SSL certificate for my website, when I check https://www.toksfashionboutique.com I don't see the padlock sign, amazingly when working in wordpress dashboard the padlock is here, but when I visit my site it disappears again.</p>
<p>I tested my url in www.whynopadlock.com, I got the error messages below, I have tried everything, also if I click on that link with the error message, it comes back with a blank page, I am totally confused.&nbsp;</p>
<p>Please help!</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
...
<img style="margin: 0px; padding: 0px; border: 0px; outline: 0px; font-weight: inherit; font-style: inherit; font-family: inherit; vertical-align: baseline; background-image: initial; background-attachment: initial; background-size: initial; background-origin: initial; background-clip: initial; background-position: initial; background-repeat: initial;" src="https://www.whynopadlock.com/check.PNG" alt="" width="40" height="40" align="absmiddle" />
<strong style="margin: 0px; padding: 0px; border: 0px; outline: 0px; font-style: inherit; font-family: inherit; vertical-align: baseline;">Valid Certificate found.</strong>
...
<img style="margin: 0px; padding: 0px; border: 0px; outline: 0px; font-weight: inherit; font-style: inherit; font-family: inherit; vertical-align: baseline; background-image: initial; background-attachment: initial; background-size: initial; background-origin: initial; background-clip: initial; background-position: initial; background-repeat: initial;" src="https://www.whynopadlock.com/check.PNG" alt="" width="40" height="40" align="absmiddle" />
<strong style="margin: 0px; padding: 0px; border: 0px; outline: 0px; font-style: inherit; font-family: inherit; vertical-align: baseline;">Certificate valid through</strong>: Mar 4 23:59:59 2017 GMT<strong style="margin: 0px; padding: 0px; border: 0px; outline: 0px; font-style: inherit; font-family: inherit; vertical-align: baseline;">Certificate Issuer</strong>: COMODO CA Limited&nbsp;<strong style="margin: 0px; padding: 0px; border: 0px; outline: 0px; font-style: inherit; font-family: inherit; vertical-align: baseline;">SSL Protocols Supported</strong>: TLSv1 TLSv1.1 TLSv1.2





<img style="margin: 0px; padding: 0px; border: 0px; outline: 0px; font-weight: inherit; font-style: inherit; font-family: inherit; vertical-align: baseline; background-image: initial; background-attachment: initial; background-size: initial; background-origin: initial; background-clip: initial; background-position: initial; background-repeat: initial;" src="https://www.whynopadlock.com/x.PNG" alt="" width="40" height="40" align="top" />
<strong style="margin: 0px; padding: 0px; border: 0px; outline: 0px; font-style: inherit; font-family: inherit; vertical-align: baseline;">Total number of items</strong>: 114<strong style="margin: 0px; padding: 0px; border: 0px; outline: 0px; font-style: inherit; font-family: inherit; vertical-align: baseline;">Number of insecure items</strong>: 2
<p style="margin: 10px 20px; padding: 0px; border: 0px; outline: 0px; font-weight: inherit; font-style: inherit; font-family: inherit; vertical-align: baseline;"><strong style="margin: 0px; padding: 0px; border: 0px; outline: 0px; font-style: inherit; font-family: inherit; vertical-align: baseline;">Insecure URL:</strong>&nbsp;http://toksfashionboutique.com/wp-content/themes/Cartsy/images/texture/tts_texture1.png<strong style="margin: 0px; padding: 0px; border: 0px; outline: 0px; font-style: inherit; font-family: inherit; vertical-align: baseline;">Found in</strong>: https://www.toksfashionboutique.com/</p>
<p style="margin: 10px 20px; padding: 0px; border: 0px; outline: 0px; font-weight: inherit; font-style: inherit; font-family: inherit; vertical-align: baseline;"><strong style="margin: 0px; padding: 0px; border: 0px; outline: 0px; font-style: inherit; font-family: inherit; vertical-align: baseline;">Insecure URL:</strong>&nbsp;http://fonts.googleapis.com/css?family=Crimson+Text<strong style="margin: 0px; padding: 0px; border: 0px; outline: 0px; font-style: inherit; font-family: inherit; vertical-align: baseline;">Found in</strong>: https://www.toksfashionboutique.com/wp-content/themes/Cartsy/style.css</p>
<p style="margin: 10px 20px; padding: 0px; border: 0px; outline: 0px; font-weight: inherit; font-style: inherit; font-family: inherit; vertical-align: baseline;">&nbsp;</p>
...
<img style="margin: 0px; padding: 0px; border: 0px; outline: 0px; font-weight: inherit; font-style: inherit; font-family: inherit; vertical-align: baseline; background-image: initial; background-attachment: initial; background-size: initial; background-origin: initial; background-clip: initial; background-position: initial; background-repeat: initial;" src="https://www.whynopadlock.com/check.PNG" alt="" width="40" height="40" align="absmiddle" />
<strong style="margin: 0px; padding: 0px; border: 0px; outline: 0px; font-style: inherit; font-family: inherit; vertical-align: baseline;">Secure calls made to other websites:</strong>
<p style="margin: 10px 20px; padding: 0px; border: 0px; outline: 0px; font-weight: inherit; font-style: inherit; font-family: inherit; vertical-align: baseline;"><strong style="margin: 0px; padding: 0px; border: 0px; outline: 0px; font-style: inherit; font-family: inherit; vertical-align: baseline;">maxcdn.bootstrapcdn.com</strong>&nbsp;is valid and secure.</p>
<p style="margin: 10px 20px; padding: 0px; border: 0px; outline: 0px; font-weight: inherit; font-style: inherit; font-family: inherit; vertical-align: baseline;"><strong style="margin: 0px; padding: 0px; border: 0px; outline: 0px; font-style: inherit; font-family: inherit; vertical-align: baseline;">static.addtoany.com</strong>&nbsp;is valid and secure.</p>
<p style="margin: 10px 20px; padding: 0px; border: 0px; outline: 0px; font-weight: inherit; font-style: inherit; font-family: inherit; vertical-align: baseline;"><strong style="margin: 0px; padding: 0px; border: 0px; outline: 0px; font-style: inherit; font-family: inherit; vertical-align: baseline;">assets.pinterest.com</strong>&nbsp;is valid and secure.</p>




</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31237);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-15 10:11 am</div>
				                <div>It looks like http://toksfashionboutique.com/wp-content/themes/Cartsy/images/texture/tts_texture1.png is identified as an insecure URL. I suggest trying to change the http:// to https:// wherever that image is linked.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31245);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-31301'></a>
		<div  style='margin:2px 0px 0px 40px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/412c84dc0992549bc94f2abcf64f66a8?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/412c84dc0992549bc94f2abcf64f66a8'>diego</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-17 12:54 pm</div>
				                <div><p>I had a similar issue wth and image in my wordpress and what I did to fix it was to change the http://myexample.com form the wordpress dashboard to https://myexample.com after that i took the image and uploaded it to the server again and it worked.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31301);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
