<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50490:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/registrations-and-transfers/cannot-remove-subdomain-linked-to-addon-domain" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hi Jason, Is there anyway to remove this subdomain from the main domain? The answer is unfortunately no, this is how cPanel was designed to work. For mo..." />
  <title>Cannot remove subdomain linked to addon domain? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/registrations-and-transfers/cannot-remove-subdomain-linked-to-addon-domain" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:065d71112948b0788748f90cb20bd86c -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Cannot remove subdomain linked to addon domain?</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/jassultd'>jassultd</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-05-26 8:19 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>5,293</span>
			</div>
...
<br />
I have added &quot;[seconddomain].com&quot; as a addon domain in the &quot;[firstdomain].com&quot; CPanel.<br />
<br />
After creating this [seconddomain].com, the a subdomain is automatically created - [seconddomain].[firstdomain].com<br />
<br />
When trying to remove this automatically created subdomain the following message comes up saying that it cannot be removed:<br />
&quot;Sorry, the subdomain [seconddomain] cannot be removed because it is linked to the addon domain(s) '[seconddomain].com'. You must first remove the addon domain(s).&quot;<br />
<br />
Question:<br />
Is there anyway to remove this subdomain from the main domain?<br />
<br />
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_1085' id='upvote_answer_1085' class='f_vote_option'>
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_1085').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_1085' id='downvote_answer_1085' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='1085' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_1085').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hi Jason,<br />
<br />
&lt;strong&gt;Is there anyway to remove this subdomain from the main domain?&lt;/strong&gt;<br />
<br />
The answer is unfortunately no, this is how cPanel was designed to work. For most users this isn't a problem because they're the only ones that know that new subdomain was created. If you're worried about users somehow finding it, you can &lt;a href='http://www.inmotionhosting.com/support/edu/cpanel/cpanel-manage-domains/setting-up-redirect-cpanel' target='_blank'&gt;setup a redirect&lt;/a&gt; that redirects traffic from the subdomain to the actual domain name.<br />
<br />
Let us know if you have any follow up questions, we're more than happy to help further.<br />
<br />
Thanks,<br />
- Brad
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_1085').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_1085' id='form_comment_on_answer_1085' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/registrations-and-transfers/cannot-remove-subdomain-linked-to-addon-domain&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/registrations-and-transfers/cannot-remove-subdomain-linked-to-addon-domain'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="46c3e11c12db7f2d808485d410d0732f" value="1" />	</div>
	</form>
<!-- <br />
