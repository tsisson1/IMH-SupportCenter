<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:47055:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/mediawiki/adding-content-mediawiki" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="keywords" content="add content mediawiki format wiki code media" />
  <meta name="description" content="The next step in the development process of a MediaWiki site is to add content to the pages. This educational channel will explain the basics of adding content to your MediaWiki site." />
  <title>102: Adding content to MediaWiki | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/mediawiki/adding-content-mediawiki" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:c2fdbfb5a607b3cef68469afac1a485a -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '82.112.107.84']);
...
<div class='page-header'>
	<h1>102: Adding content to MediaWiki</h1>
</div>
<div class='section_listing'>
		<table>
	<tr><td colspan='3'><h2>Working with namespaces and pages</h2><div>This section will focus on creating, editing, and deleting pages, adding pages to namespaces, and setting up redirects.</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 1:</td>
				<td style='padding-right:10px;'><div class='gold_star'></div></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/mediawiki/adding-content-mediawiki/create-edit-delete-pages'>How to create pages in MediaWiki</a>
					<div>This article will explain the steps to create pages in MediaWiki.</div>
					<div class='smallgrey'>Hits: 10,555</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'><div class='gold_star'></div></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/mediawiki/adding-content-mediawiki/edit-format-mediawiki-content'>How to edit MediaWiki pages</a>
					<div>MediaWiki has its own way of formatting content. This article will explain how to edit your MediaWiki content.</div>
					<div class='smallgrey'>Hits: 2,180</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'><div class='gold_star'></div></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/mediawiki/adding-content-mediawiki/add-page-namespace'>Adding pages to MediaWiki namespaces</a>
					<div>After creating pages in MediaWiki, it is important to understand how the namespaces work. This article discusses MediaWiki namespaces.</div>
					<div class='smallgrey'>Hits: 4,577</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/mediawiki/adding-content-mediawiki/deleting-restoring-pages-mediawiki'>Deleting and restoring pages in MediaWiki</a>
					<div>When your MediaWiki is defaced or you want to remove pages because they are not needed anymore, you can delete pages or restore them accordingly. This article will give the steps to delete and restore MediaWiki pages.</div>
					<div class='smallgrey'>Hits: 2,544</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/mediawiki/adding-content-mediawiki/add-remove-redirect-wiki'>Adding and removing redirects in MediaWiki</a>
					<div>When renaming, deleting and moving pages in MediaWiki, its important to create redirects. This article will explain how to remove and add recirects to your MediaWiki pages.</div>
					<div class='smallgrey'>Hits: 3,005</div>
				</td>
			</tr>
		<tr><td colspan='3' style='padding-top:20px;'><h2>Formatting and inserting content</h2><div>The following tutorials are the basics for editing content in MediaWiki.</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 6:</td>
				<td style='padding-right:10px;'><div class='gold_star'></div></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/mediawiki/adding-content-mediawiki/formatting-text-mediawiki'>How to format content in MediaWiki</a>
					<div>Formatting text is the next step in page creation. This article will explain the MediaWiki WYSIWYG editor and how to format text.</div>
					<div class='smallgrey'>Hits: 2,356</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/mediawiki/adding-content-mediawiki/enable-uploads-wiki'>Enabling user image uploads in MediaWiki</a>
					<div>MediaWiki by default does not have the Upload file enabled. This article will explain how to enable uploads for users in MediaWiki.</div>
					<div class='smallgrey'>Hits: 5,063</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/mediawiki/adding-content-mediawiki/insert-images-wiki'>How to insert images into MediaWiki</a>
					<div>This article will explain how to upload and insert images into MediaWiki pages.</div>
					<div class='smallgrey'>Hits: 20,023</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/mediawiki/adding-content-mediawiki/formatting-images-wiki-code'>Formatting images in MediaWiki</a>
					<div>MediaWiki requires their own code to format images. This article is a basic list of MediaWiki code to format images.</div>
					<div class='smallgrey'>Hits: 11,254</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/mediawiki/adding-content-mediawiki/image-gallery-wiki-code'>Creating an Image Gallery in MediaWiki</a>
					<div>MediaWIki can have image galleries placed in the pages. This article will explain how to insert an Image Gallery in MediaWiki.</div>
					<div class='smallgrey'>Hits: 3,738</div>
				</td>
			</tr>
			</table>
</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMjcmaWQ9MzI3JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
