<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:63831:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/wordpress/photographers-guide-wordpress/changing-the-font-sizes" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-03-26T12:19:44-07:00" />
  <meta name="author" content="Arnel Custodio" />
  <meta name="description" content="In some cases, you may need to change the font sizes for your pages and posts.  This tutorial will walk you through changing font sizes with the WordPress interface and Editor." />
  <title>Changing the Font Sizes in WordPress - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/wordpress/photographers-guide-wordpress/changing-the-font-sizes" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:d3c5491d0037ebbe4c44009e0f4630f2 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-20']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '77.12.93.44']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Changing the Font Sizes in WordPress									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>1,814</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Mar 24, 2015'><span style='color:#606060;'>Published:</span> Mar 26, 2015</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Changing fonts in WordPress usually means that you're changing the font size, making it bold or using italics.  To keep things simple, we will be making adjustments to the font size in a WordPress post or page interface. We will also use the CSS editor that is provided with your WordPress Administrator Dashboard to show how you can change the size of the header fonts for the theme.</p>


<p class="alert alert-danger">Changing the header font sizes will require that you modify the theme Stylesheet.  We will only be showing how to change font sizes for the headers of your pages or posts to keep things simple.  Note that you when you make changes to the Stylesheet, you should consider using a <a href="http://www.inmotionhosting.com/support/edu/wordpress/change-wordpress-appearance/wp-childtheme-2014" target="_blank">child theme</a>. This prevents theme updates from overriding your changes. </p>



<b>Changing Font Size within a Page or Post</b>
...
<li>Add a New Post/Page or Edit an existing Post/Page</li>  

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wpphoto/open-toolbar.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Open tool bar" src="//cdn.inmotionhosting.com/support/images/stories/wpphoto/open-toolbar.png" align="right" /></a>

<p>Normally, when you're working with a post or a page in WordPress, you will see that the visual editor has a menu of different items such as Bold, Italics, bullets and other options that you can use to format your text. As per the screenshot at right, click on the far right icon in order to open what they call the "kitchen sink".  This opens all of the available options within the visual editor.</p>
<div style="clear:both;"></div>
</li>


<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wpphoto/fonts-pages-posts.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Change font size" src="//cdn.inmotionhosting.com/support/images/stories/wpphoto/fonts-pages-posts.png" align="right" /></a>

<p>Highlight and select existing text that you want to change, then click on the drop-down menu that is labeled "Paragraph". This option lets you select six different header sizes, or an option called "pre".  Each of these options will change the size of the font.  You can also select one of these options before you start typing in order to use that particular size.</p>

<div style="clear:both;"></div>
</li>
</ol>

<p><b>Changing the Font Header sizes in the WordPress Theme Stylesheet</b></p>

<p class="alert alert-danger">As noted above, it should be stressed that if you are not using a <a href="http://www.inmotionhosting.com/support/edu/wordpress/change-wordpress-appearance/wp-childtheme-2014">child theme</a>, then a theme update will overwrite any changes that you make directly within the theme's <b>style.css</b> file.</p>

<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wpphoto/change-header-font-3.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="see different header font size" src="//cdn.inmotionhosting.com/support/images/stories/wpphoto/change-header-font-3.png" align="right" /></a>
 <p>You may find that you want to change the size of the header font within your theme.  This can be easily done by editing the <b>Style.css</b> file with the editor that WordPress provides in the Administrator. The screen shot at right demonstrates the difference in font size you can set by simply editing the CSS.</p>
<div style="clear:both;"></div>
...
<li>In the menu at left, click on <b>Appearance</b> </li>
  <li>In the menus that appear under <b>Appearance</b>, click on <b>Editor</b></li>
<li>You will then see the <b>Editor</b> window appear with a column of files listed to the right</li>

<li>Scroll down the list of files until you see the <b>Styles</b> section - it will be close to the bottom of the list.  Click on the <b>style.css</b> file.  This will open the file in the editor </li>

<li>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wpphoto/css-edit-font.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Change font size" src="//cdn.inmotionhosting.com/support/images/stories/wpphoto/css-edit-font.png" align="right" /></a>

<p>If you are not familiar with CSS, do not worry.  However, also be careful not to accidentally delete or change options within the CSS file.  Scroll down until you find a section where you see "h1 {".
  </p>
<div style="clear:both;"></div>
</li>

<li>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wpphoto/edit-header-font-size.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Change font size" src="//cdn.inmotionhosting.com/support/images/stories/wpphoto/edit-header-font-size.png" align="right" /></a>
<p>In this are, you will look for the line of text that reads, "font-size: 26px".  The "px" or pixel value may vary depending on the header.  H1 is the largest and the font gets smaller as you descend.  Change the font-size value as per your needs.  Remember that a very large font may cause some overlapping with images or graphics within your WordPress site.</p>

<div style="clear:both;"></div>
</li>  
<li>Click on <b>Update File</b> in order to save any changes</li>
  </ol>
<p>Be cautious when making changes within the CSS for your theme. You should always immediately check to see the effect of the change on your website. </p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 11: Changing the Font Sizes in WordPress</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 10: <a href='/support/edu/wordpress/photographers-guide-wordpress/changing-theme-colors'>Changing Colors in WordPress</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/wordpress/photographers-guide-wordpress/changing-the-font-sizes&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/wordpress/photographers-guide-wordpress/changing-the-font-sizes'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD01MjkmaWQ9MzUyOSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="03962a936255986aa7adaa36b474d724" value="1" />	</div>
	</form>
<!-- <br />
