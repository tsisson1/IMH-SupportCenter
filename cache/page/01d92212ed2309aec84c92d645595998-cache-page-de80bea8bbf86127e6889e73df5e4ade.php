<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:52450:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/wordpress/cannot-install-wordpress-via-cpanel" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello wyncole, Thank you for contacting us about difficulties installing WordPress through Softaculous. This happens from time to time and can be frustr..." />
  <title>Cannot Install Wordpress via cpanel | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/wordpress/cannot-install-wordpress-via-cpanel" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:62cec23e71712eef46ed344ff8597e90 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Cannot Install Wordpress via cpanel</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/wyncole'>wyncole</a>
			<div>8 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2016-05-10 8:04 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>41</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I am trying to install wordpress via softulocus but each time i get this error <br />
The following errors were found :<br />
<br />
   Could not write the Configuration File check_charset.php<br />
    Could not write the Configuration File soft.htaccess<br />
    Could not write the Configuration File wp-config.php<br />
<br />
This is a brand new site in a hosting plan i havent used yet any help would be appreciated.</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_9870' id='upvote_answer_9870' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='9870' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_9870').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_9870' id='downvote_answer_9870' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='9870' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_9870').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
...
Christopher M. 
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_9870').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_9870' id='form_comment_on_answer_9870' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/wordpress/cannot-install-wordpress-via-cpanel&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/wordpress/cannot-install-wordpress-via-cpanel'></div>
<script type='text/javascript'>
  (function() {
