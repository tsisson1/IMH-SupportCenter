<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:68647:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/iweb/publish-iweb" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-04-21T22:55:07-07:00" />
  <meta name="keywords" content="iweb publishing" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="This article discusses how to publish with iWeb." />
  <title>How to publish with iWeb - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/iweb/publish-iweb" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:7ca077ff7ee709fd495f2bdf6ec13712 -->
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/website/iweb' itemprop='url'><span itemprop='title'>iWeb<span></a><div class='dropdown_3columns'><div class='col_3'><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/iweb/publish-iweb'>How to publish with iWeb</a> (29066 hits)</div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to publish with iWeb</span></li>			</ul>
		</div>
	</div>
</div>
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>29,066</span></div>
							...
							<div style='clear:both;'></div>
								...
								<p>This tutorial will walk you through publishing your website with iWeb to your <a href="http://www.inmotionhosting.com" target="_blank">web hosting</a> account.</p>
<p class="alert">Please keep in mind, when you publish your site for the first time, you will want to use the "<strong>Publish Site</strong>" button to publish your entire website. If you make changes to the website, you'll want to use the "<strong>Publish Site Changes</strong>" button instead. This will keep from re-publishing every file and only publish files that changes were made to.</p>
<ol class="article_list">
<li>&nbsp;Open <strong>iWeb</strong> and<strong> load the website</strong> you are working with.</li>
<li>&nbsp;To set up your publishing settings, click your <strong>site title</strong> in the left menu.</li>
<li>&nbsp;Configure your publishing settings as follows:     Select "<strong>FTP Server</strong>" enter "<strong>public_html</strong>"                                                                                    
<table class="article_table">
<tbody>
<tr>
<th colspan="2">Publishing Settings</th>
</tr>
<tr>
<th>Publish To:</th>
<td>Select "<strong>FTP Server</strong>"</td>
</tr>
<tr>
<th>Site Name:</th>
<td>Enter "<strong>public_html"</strong></td>
</tr>
</tbody>
</table>
<table class="article_table">
<tbody>
<tr>
<th colspan="2">FTP Server Settings</th>
</tr>
<tr>
<th>Server Address</th>
<td>Enter "example.com" (be sure to replace this with your actual domain name)
<p class="alert">Please keep in mind, if your domain is <a href="/support/domain-names/dns-nameserver-changes/updating-your-domains-nameservers">not pointed to InMotion Hosting</a> or you have not allowed 4 - 24 hours for propagation use your server name instead of your domain name. Your server name is shown as the <strong>Hostname</strong> in your account's <a href="/support/website/how-to/viewing-account-technicial-information-in-amp">Technical Details in AMP</a>.</p>
</td>
</tr>
<tr>
<th>Username</th>
<td>Enter your <strong>cPanel username</strong></td>
</tr>
<tr>
<th>Password</th>
<td>Enter your <strong>cPanel password</strong></td>
</tr>
<tr>
...
<tr>
<th>Protocol</th>
<td>Select <strong>FTP</strong></td>
</tr>
<tr>
<th>Port</th>
<td>Enter <strong>21</strong></td>
</tr>
<tr>
<th>Website URL</th>
<td>Enter "http://example.com" (replacing "example.com" with your actual domain). If your domain is not pointed to InMotion Hosting's Nameservers or you have not allowed 4 - 24 hours for propagation, you can use <a href="/support/website/how-to/using-your-temporary-url">your temporary URL</a>.</td>
</tr>
</tbody>
</table>
<h3>Publishing to an Add-on Domain</h3>
<p>The settings above should be used when publishing to your primary domain. When publishing to add-on domains. you will need to update your settings slightly. Assuming your add-on domain is "example2.com" and its document root is public_html/example2.com you will need to use the following settings:</p>
<table class="article_table">
<tbody>
<tr>
<th colspan="2">Publishing to an Add-on Domain</th>
</tr>
<tr>
<th>Site Name</th>
<td>yourdomain2.com (replace yourdomain2.com with your actual domain)</td>
</tr>
<tr>
<th>Directory/Path</th>
<td>public_html</td>
...
<li>&nbsp;Click the "<strong>Test Connection</strong>" button to ensure you have entered the correct settings.</li>
<li>&nbsp;To Publish your site, click either:
<p style="padding-left: 60px;">File - Publish Entire Site (or)<br /> File - Publish Site Changes</p>
</li>
</ol>
<p>Due to the way iWeb publishes via ftp, the above directions actually have you set the "<strong>Site name</strong>" to the "<strong>Directory/Path</strong>", and leave the"<strong>Directory/Path</strong>" blank. After publishing, iWeb will tell you to access your website via http://example.com/public_html, however you only need to use http://example.com</p>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/iweb_publishing_settings_large.gif"><img style="padding: 2px;" src="//cdn.inmotionhosting.com/support/images/stories/iweb_publishing_settings_large.gif" alt="iweb_publishing_settings_large"  /></a></p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/iweb/publish-iweb&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/iweb/publish-iweb'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yOSZpZD00MyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="a69b2bbde9d29d3a13fcf7f3ae31440d" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/website-troubleshooting/iweb-wont-connect-with-website?tsrc=rsbraq'>iWeb won't connect with website</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/1e936f45c009f004fa0007b790845a96?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/1e936f45c009f004fa0007b790845a96'>brian willsey</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-14 3:35 pm</div>
				                <div>has all the info. not necessary to try to improve.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19539);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-11 3:17 am</div>
				                <div><p>I was a litte confused with public_html. For example, my site is <a href="http://paytowriteessay.net" target="_blank">paytowriteessay.net</a>, should I indicate in Site name line public_html or just the name of the site itself?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25657);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-11 11:43 pm</div>
				                <div>Hello Gilda,<br />
<br />
You should just have to put public_html and nothing else.<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25683);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-25875'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/e0d07973ae08aecc24c0e3ded4d02304?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/e0d07973ae08aecc24c0e3ded4d02304'>BC</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-18 11:51 am</div>
				                <div><p>I have a site - the root is: public_html/Site. &nbsp;I typed this into the Site Name field, and iWeb created a new folder called public_html_Site. &nbsp;What should the configuration be if I'm trying to publish to path: public_html/Site?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25875);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-19 9:49 am</div>
				                <div>Hello BC,<br />
<br />
In the directory/path field you would put Site in there. Also in the website URL setting you  would need to enter http://yourdomain.com/Site<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25897);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
