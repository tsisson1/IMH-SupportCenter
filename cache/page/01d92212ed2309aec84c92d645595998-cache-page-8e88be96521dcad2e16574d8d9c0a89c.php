<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:62297:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/general-server-setup/incrrease-file-display-limit" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-05-14T14:22:53-07:00" />
  <meta name="keywords" content="change display limit ftp files 2000 8000 command line" />
  ...
  <link href="http://www.inmotionhosting.com/support/website/general-server-setup/incrrease-file-display-limit" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:9c9fdc2e2c9286f18ce6003feafcf6b9 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '80.101.84.80']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to increase the FTP visible file limits via com...</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to increase the FTP visible file limits via command line									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>11,822</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: May 13, 2013'><span style='color:#606060;'>Published:</span> May 14, 2013</div>
...
<ol class="article_list">
  <li><a href="/support/website/general-server-setup/how-to-login-ssh">Log into your shell account as the root user</a>.<div style="clear:both;"></div></li>
  <li>Move to the <em>/etc</em> folder.<div style="clear:both;"></div></li>
  <li>Open the <em>pure-ftpd.conf</em> file for editing. For this example, we use the nano command.<div class="cli">nano pure-ftpd.conf</div><div style="clear:both;"></div></li>
<li>Scroll through the document and locate the LimitRecursion setting. Below is a sample of this line.
    <div class="cli"># 'ls' recursion limits. The first argument is the maximum number of<br />
# files to be displayed. The second one is the max subdirectories depth<br /><br />
...
<div class="cli"># 'ls' recursion limits. The first argument is the maximum number of<br />
# files to be displayed. The second one is the max subdirectories depth<br /><br />
LimitRecursion 10000 8</div><div style="clear:both;"></div></li>
<li>Save your file according to the editor used. Using nano, we selected ctrl-X, then Y to commit the changes, then &lt;Enter&gt; to save the file under the same name.<div style="clear:both;"></div></li>
...
<tr><td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/howto/increase-file-display/before.png"><img  alt="before the limite is changed" src="//cdn.inmotionhosting.com/support/images/stories/edu/howto/increase-file-display/before.png" title="Click here to view the larger image" width="200" /></a></td><td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/howto/increase-file-display/after.png"><img  alt="after the display limit has been changed" src="//cdn.inmotionhosting.com/support/images/stories/edu/howto/increase-file-display/after.png" title="Click here to view the larger image" width="200" /></a></td></tr>
</table>
  <div style="clear:both;"></div></li>
</ol> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/general-server-setup/incrrease-file-display-limit&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/general-server-setup/incrrease-file-display-limit'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NCZpZD0yNzA4JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="b8968467c1ac30ee789cc2816096e5c1" value="1" />	</div>
	</form>
<!-- <br />
