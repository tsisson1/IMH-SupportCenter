<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:47487:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-25/templates" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Your Joomla 2.5 templates control the majority of how your website looks and feels. The following tutorial series will teach you what you need to know about Joomla 2.5 templates." />
  <title>107: Installing and Changing Templates in Joomla 2.5 | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-25/templates" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:b7a5b9a010987f08aa1c2bb7310f72d4 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '216.79.147.128']);
...
<div class='page-header'>
	<h1>107: Installing and Changing Templates in Joomla 2.5</h1>
</div>
<div class='section_listing'>
		...
		<tr>
				...
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/templates/install-new-template'>How to install a new Joomla 2.5 template</a>
					<div>In this tutorial, we'll show you how to install a Joomla 2.5 template that you've downloaded from the web.</div>
					<div class='smallgrey'>Hits: 49,109</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/templates/how-to-change-site-template'>How to change your Joomla 2.5 Site Template</a>
					<div>In this article, we'll walk you through the steps to take to change your Joomla 2.5 Site template.</div>
					<div class='smallgrey'>Hits: 37,167</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/templates/edit-template'>How to edit a Joomla 2.5 template</a>
					<div>In this Joomla 2.5 tutorial, we'll show you how to use Joomla's built in template editor to make changes to your templates.</div>
					<div class='smallgrey'>Hits: 38,689</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/templates/how-to-delete-template'>How to Delete a Template in Joomla 2.5</a>
					<div>In this Joomla 2.5 tutorial, we'll show you the proper steps for deleting a template. If you receive the error - cannot delete last style of a template - you're doing it wrong.</div>
					<div class='smallgrey'>Hits: 33,862</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/templates/specific-template-per-page'>Changing the template used for specific menu items in Joomla 2.5</a>
					<div>In this Joomla 2.5 tutorial we'll show you how to assign a template to one unique page in your website.</div>
					<div class='smallgrey'>Hits: 10,320</div>
				</td>
			</tr>
			</table>
</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xODcmaWQ9MTg3JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="7b8964b6231ad16efaad5011622f1c8e" value="1" />	</div>
	</form>
<!-- <br />
