<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:84432:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/wordpress/limit-or-disable-wordpress-revisions" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-09-03T19:06:29-07:00" />
  <meta name="keywords" content="limit disable turn off wordpress revision revisions control wp-config.php optimize" />
  ...
  <title>Limit or disable WordPress revisions - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/wordpress/limit-or-disable-wordpress-revisions" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:375d2bb93060439015652ab0a040a9da -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-22']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '23.126.205.69']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Limit or disable WordPress revisions</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Limit or disable WordPress revisions									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>28,258</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 29, 2013'><span style='color:#606060;'>Published:</span> Sep 3, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<div>In this article I'm going to talk about WordPress revisions and why you might possibly want to limit or disable the revision history of your WordPress pages and posts.</div>
<div>&nbsp;</div>
<div>WordPress provides revision control on any pages or posts that you create which allow you to go back and see previous edits that you've written over in the database. While this can seem like a great thing to have, over time it can lead to a lot of unessary overhead in your WordPress database.</div>
<div>&nbsp;</div>
<div>For instance let's say that you've previewed a post that you've been working on 7 or so times, each of those revisions you might have just changed around a word or two, or made some very minimal changes. However in the WordPress database you would now have 8 copies of your original post, the 1 main one and 7 revisions storing the full content of that past revision and not just the changes made since the last one.&nbsp;</div>
<h2>Limit WordPress revisions</h2>
<p>Using the steps below I'll show you how you can limit the number of revisions that WordPress will store per page or post. By default there is no limit on the amount of revisions so any limit you impose is going to help keep your WordPress database more efficient. We'll be using the&nbsp;<strong>WP_POST_REVISIONS</strong> setting in our&nbsp;<strong>wp-config.php</strong> file to accomplish this.<strong><br /></strong></p>
...
<li>Access the <a href="/support/edu/cpanel/cpanel-file-manager/file-manager-code-editor" target="_blank">cPanel File Manager Code Editor</a>&nbsp;and navigate to your <strong>wp-config.php</strong> file.</li>
<li>Enter in the following code towards the top of the <strong>wp-config.php</strong>&nbsp;file:
  <p class="code_block" style="width: 500px;">/* @package WordPress<br /> */<br /><br /> <strong>define('WP_POST_REVISIONS', 3);</strong><br /><br /> // ** MySQL settings - You can get this info from your web host ** //</p>
<p>After that click on <strong>Save Changes</strong> at the top-right.</p>
<p>Below is a screen shot of the WordPress database showing the difference between the default <strong>WP_POST_REVISIONS</strong> settings, and the ones we just set.<br /><br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/wordpress-revisions/wordpress-database-showing-wp-post-revisions-difference.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/wordpress-revisions/wordpress-database-showing-wp-post-revisions-difference.png" alt="wordpress database showing wp_post_revisions difference"  /></a></p>
</li>
</ol>
<h2>Disable WordPress revisions</h2>
...
<li>Access the <a href="/support/edu/cpanel/cpanel-file-manager/file-manager-code-editor" target="_blank">cPanel File Manager Code Editor</a>&nbsp;and navigate to your <strong>wp-config.php</strong> file.</li>
<li>Enter in the following code towards the top of the <strong>wp-config.php</strong>&nbsp;file:
<p class="code_block" style="width: 500px;">* @package WordPress<br /> */<br /><br /> <strong>define('WP_POST_REVISIONS', false);</strong><br /><br /> // ** MySQL settings - You can get this info from your web host ** //</p>
<p>After that click on <strong>Save Changes</strong> at the top-right.</p>
<p>Below is a screen shot of the WordPress database that no revisions are being stored, and only 1 row is being used for my post.<br /><br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/wordpress-revisions/wordpress-database-showing-wp-post-revisions-off.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/wordpress-revisions/wordpress-database-showing-wp-post-revisions-off.png" alt="wordpress database showing wp_post_revisions off"  /></a></p>
</li>
</ol>
<p>You should now understand how to limit or completly disable the WordPress revision functionality to help keep your WordPress database optimized. If you already have a large amount of pages and posts that have a lot of revisions we would recommend possibly trying out the <a href="http://wordpress.org/extend/plugins/better-delete-revision/" target="_blank" rel="nofollow">Better Delete Revision WordPress plugin</a>, while this plugin is old it still functions perfectly fine from the testing that we've done.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/wordpress/limit-or-disable-wordpress-revisions&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/wordpress/limit-or-disable-wordpress-revisions'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD02MyZpZD01MzQmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="2becc6274c5ec71067498fb95db0b583" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/d9d0c210937f078ef220f2ed8a4a5d2c?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/d9d0c210937f078ef220f2ed8a4a5d2c'>James</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-03 2:21 pm</div>
				                <div><p>When I applied the code provided above and attempted to access my site I got an error pointing directly to the line containing;</p>
<p>* @package WordPress</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14670);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-03 3:04 pm</div>
				                <div>Hello James,<br />
<br />
...
<br />
I will also correct the code used above.  Sorry for the confusion!<br />
<br />
Regards!<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14675);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-15602'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/467691bfd001991fd761992f12f0eef0?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/467691bfd001991fd761992f12f0eef0'>Phred</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-28 10:05 am</div>
				                <div><p>you didnt correct the code</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15602);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-28 11:26 am</div>
				                <div>Hello Phred,<br />
<br />
To what code are you referring? Are you not having any luck with implementing one of the above solutions?<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15606);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-17006'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/03c86f467288cdd09d5f04af70e2b033?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/03c86f467288cdd09d5f04af70e2b033'>Kerrie Redgate</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-03 12:35 am</div>
				                <div>Thank you! Worked like a charm! I had accidentally(?) published a complex Wordpress post and had to &quot;Private&quot; it to proceed with, would you believe, over 200 tweaking revisions over several days!! Yikes! I used your method above, changing revision number to 7 (to be safe), and just added another teak after publishing, and I'm now on 7 revisions only! I'm switching hosting to you guys very soon, just cleaning up my email account first. Cheers!!</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17006);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-18693'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/3117d084c12049dc1a2042f4f55fd4db?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/3117d084c12049dc1a2042f4f55fd4db'>Anand</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-19 10:52 am</div>
				                <div><p>UPDATE: The 'Better Delete Revision WordPress plugin' mentioned towards the end of the article has been updated.</p>
<p>Thanks for the article guys !!!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(18693);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-30 1:50 am</div>
				                <div>Is there any different between this two code?<br />
define( 'WP_POST_REVISIONS', false );<br />
define('WP_POST_REVISIONS', false);<br />
<br />
The first one has space after the bracket.<br />
<br />
Regards,<br />
Joseph</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20134);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-30 5:10 pm</div>
				                <div>Hello Joseph,<br />
<br />
I would use the second version, without the space after "false".  Many commands will not work properly because of a simple space in the wrong place.  This happens a lot in HTML.  I hope this helps to answer your question, please let us know if you require any further  assistance.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20179);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-31 2:18 am</div>
				                <div>Hi @Arn,<br />
<br />
Thanks for your clarification. I was told by another host to use the code with the space, so I was confused.<br />
<br />
Cheers!<br />
Joseph</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20186);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-29989'></a>
		<div  style='margin:2px 0px 0px 120px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/1d84f47b927ea2060f1d65f542a27fc9?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/1d84f47b927ea2060f1d65f542a27fc9'>kyobul</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-21 7:17 am</div>
				                <div><p><strong>There is strictly no difference</strong> if you have space(s) here and there as long as the values in the definition follow the declaration type and syntax convention.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29989);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
