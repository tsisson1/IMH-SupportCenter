<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49722:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/general-server-setup/document-conversion-from-html-to-docx" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, Thank you for your question regarding converting html to docx. While there are certain scripts you can use to perform this conversion there are o..." />
  <title>Document conversion from HTML to DOCX | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/general-server-setup/document-conversion-from-html-to-docx" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:409f86dfa6f62c671bf1f46d804cb154 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Document conversion from HTML to DOCX</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2016-05-20 11:22 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>14</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I need to do document conversion from HTML to DOCX as an integral part of my application.  I'm looking at using PanDoc for that and wanted to know if it's installed, and if not can it be?</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_9961' id='upvote_answer_9961' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='9961' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_9961').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_9961' id='downvote_answer_9961' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='9961' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_9961').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
Thank you for your question regarding converting html to docx. While there are certain scripts you can use to perform this conversion there are other ways to do so via websites such as <a href="https://cloudconvert.com/html-to-docx">https://cloudconvert.com/html-to-docx</a>.<br />
<br />
Best Regards,<br />
TJ Edens
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_9961').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_9961' id='form_comment_on_answer_9961' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/general-server-setup/document-conversion-from-html-to-docx&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/general-server-setup/document-conversion-from-html-to-docx'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="ca0425faa7437ce714575de7a8985364" value="1" />	</div>
	</form>
<!-- <br />
