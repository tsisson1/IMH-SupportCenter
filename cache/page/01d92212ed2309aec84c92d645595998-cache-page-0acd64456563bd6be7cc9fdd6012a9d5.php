<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:61412:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/dokuwiki/change-language-doku-wiki/installing-multi-language-plugin-doku" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-02-12T17:06:27-08:00" />
  <meta name="keywords" content="Installing the Multilingual Plugin change add language dokuwiki doku wiki multilanguage multi" />
  ...
  <link href="http://www.inmotionhosting.com/support/edu/dokuwiki/change-language-doku-wiki/installing-multi-language-plugin-doku" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:a60ef21b3c0d4d39dcb44cbf214fed55 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '132.210.194.238']);
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/dokuwiki' itemprop='url'><span itemprop='title'>Dokuwiki<span></a><div class='dropdown_4columns'><h2>Dokuwiki Education Channel</h2><div class='col_2'><h3>100 Level Classes</h3><div><a href='/support/edu/dokuwiki/geting-started-dokuwiki'>101: Getting Started with Dokuwiki</a></div><div><a href='/support/edu/dokuwiki/writing-content-dokuwiki'>102: Writing content for DokuWiki</a></div><div><a href='/support/edu/dokuwiki/change-dokuwiki-appearance'>103: Changing the DokuWiki Appearance</a></div><div><a href='/support/edu/dokuwiki/add-contact-form-dokuwiki'>104: Adding a contact form in DokuWiki</a></div><div><a href='/support/edu/dokuwiki/install-configure-plugins-doku'>105: Installing and Configuring plugins in DokuWiki</a></div></div><div class='col_2'><h3>200 Level Classes</h3><div><a href='/support/edu/dokuwiki/working-with-menus'>201: Working with menus in DokuWiki</a></div><div><a href='/support/edu/dokuwiki/change-language-doku-wiki'>202: Changing the language in DokuWiki</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/dokuwiki/change-language-doku-wiki' itemprop='url'><span itemprop='title'>202: Changing the language in DokuWiki<span></a><div class='dropdown_3columns'><h2> Changing the language in DokuWiki</h2><div class='col_3'><div>1. <a style='display:inline;' href='/support/edu/dokuwiki/change-language-doku-wiki/change-admin-language-doku'>How to change the DokuWiki admin language</a></div><div>2. <a style='display:inline;' href='/support/edu/dokuwiki/change-language-doku-wiki/installing-multi-language-plugin-doku'>Installing the Multilingual Plugin for DokuWiki</a></div><div>3. <a style='display:inline;' href='/support/edu/dokuwiki/change-language-doku-wiki/configure-multilingual-plugin'>Configuring the Multilingual Plugin in DokuWiki</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Installing the Multilingual...</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Installing the Multilingual Plugin for DokuWiki									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>2,262</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Feb 6, 2013'><span style='color:#606060;'>Published:</span> Feb 12, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>DokuWiki is capable of making a multil language site. This functionality is not installed in new DokuWiki installations by default. In order to get the multi language functionality to work, you will need to use the "<em>Multilingual Plugin</em>".</p>
<p><strong>The "<em>Multilingual Plugin</em>" does not translate your pages into a language.</strong> The plugin makes&nbsp;<a target="_blank" href="/support/edu/dokuwiki/writing-content-dokuwiki/create-namespace-doku">namespace</a>s particular to the language so pages can be created in a specific language namespace. This plugin is completely different than changing the admin interface language. For information on how to change teh admin interface language in DokuWiki, please click <a target="_blank" href="/support/edu/dokuwiki/change-language-doku-wiki/change-admin-language-doku">here</a>.</p>
...
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/202/multi-language-plugin-doku/multi-language-plugin-1-download.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Download multilanguage plugin DokuWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/202/multi-language-plugin-doku/multi-language-plugin-1-download.gif" title="Click here to view the larger image" width="100" /></a>Go to the following link and get the link for the plugin.
<p style="margin-left: 20px;"><a target="_blank" href="https://www.dokuwiki.org/plugin:multilingual" title="Click for more information">https://www.dokuwiki.org/plugin:multilingual</a></p>
<p>Unless the version changes, you should have a link like the following:</p>
<pre style="margin-left: 20px;">http://snorriheim.dnsdojo.com/redmine/attachments/download/29/multilingual-1.0.1.tar.gz</pre>
<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/202/multi-language-plugin-doku/multi-language-plugin-2-install.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Install multilanguage plugin DokuWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/202/multi-language-plugin-doku/multi-language-plugin-2-install.gif" title="Click here to view the larger image" width="100" /></a><a target="_blank" href="/support/edu/dokuwiki/geting-started-dokuwiki/login-dokuwiki" title="Click for more information">Log into DokuWiki</a>. Go to <strong>Admin</strong> &gt; <strong>Manage Plugins</strong>. Paste the URL in the "<em>Download and Install a new plugin</em>" box.
<p>Click Download.</p>
<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/202/multi-language-plugin-doku/multi-language-plugin-3-code-for-plugin.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Code for multilanguage plugin DokuWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/202/multi-language-plugin-doku/multi-language-plugin-3-code-for-plugin.gif" title="Click here to view the larger image" width="100" /></a><a target="_blank" href="/support/website/how-to/create-new-file" title="How do I create a file on my server?">Create a file</a> called "<em>show_languages.html</em>" on your server in the following location of your DokuWiki installation directory:
<pre style="margin-left: 20px;">/lib/tpl/dokuwiki</pre>
<p>Add the following code in the "<em>show_languages.html</em>" file:</p>
<pre class="code_block" style="margin-left: 20px;">&lt;?php 
...
<p>Save the file.</p>
<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/202/multi-language-plugin-doku/multi-language-plugin-4-code-view.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Include for multilanguage plugin DokuWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/202/multi-language-plugin-doku/multi-language-plugin-4-code-view.gif" title="Click here to view the larger image" width="100" /></a>Next, <a target="_blank" href="/support/website/how-to/how-to-edit-a-file">edit your <code>lib/tpl/dokuwiki/tpl_header.php</code></a>. Add the following code towards the end of the file before the <code>&lt;hr class="ally" /&gt;</code>.
<pre class="code_block" style="margin-left: 20px;">&lt;div style="float:left;"&gt;&lt;?php  @include(dirname(__FILE__).'/show_languages.html')?&gt;&lt;/div&gt;</pre>
<p>Your file should look like the image to the right.</p>
<p>Save the changes.</p>
<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/202/multi-language-plugin-doku/multi-language-plugin-5-settings.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Settings multilanguage plugin DokuWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/202/multi-language-plugin-doku/multi-language-plugin-5-settings.gif" title="Click here to view the larger image" width="100" /></a><strong>Go back to your DokuWiki admin</strong> section and select<strong> Configuration Settings</strong>. Scroll towards the bottom and you will see the configuration settings for the multilingual plugin. In the first box that says "<em>plugin»multilingual»enabled_langs</em>", enter the languages you want separated by commas. See the image to the right.
<p class="alert"><strong>Note!</strong> For a list of language codes, see the article on <a href="/support/website/general-server-setup/language-code-list" target="_blank" title="Click here for the Language code list for PHP programs">Language code list for PHP programs</a>. Not all languages work with DokuWiki. Unfortunately, there is no list of language codes that work specific with DokuWiki. You will need to trial and error on languages that are not as common.</p>
<p>When finished, click save at the bottom of the page.</p>
<br style="clear: both;" />
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/202/multi-language-plugin-doku/multi-language-plugin-6-links-for-lang.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="View of links for multilanguage plugin DokuWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/202/multi-language-plugin-doku/multi-language-plugin-6-links-for-lang.gif" title="Click here to view the larger image" width="100" /></a>Now when you go to your home DokuWiki page, The language options will show as links towards the top left of your site. Each language has its own namespace created. When clicking the links they will take you to the language namespace. For example, German will have the <code>de:start</code> namespace.<br style="clear: both;" /></p>
</li>
<p>For information on changing the administrator interface language in DokuWiki, please see our tutorial on <a href="/support/edu/dokuwiki/change-language-doku-wiki/change-admin-language-doku" target="_blank" title="Click here for How to change the DokuWiki admin language">How to change the DokuWiki admin language</a>.</p>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/dokuwiki/change-language-doku-wiki'>202: Changing the language in DokuWiki</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 2: Installing the Multilingual Plugin for DokuWiki</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 1: <a href='/support/edu/dokuwiki/change-language-doku-wiki/change-admin-language-doku'>How to change the DokuWiki admin language</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 3: <a href='/support/edu/dokuwiki/change-language-doku-wiki/configure-multilingual-plugin'>Configuring the Multilingual Plugin in DokuWiki</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/dokuwiki/change-language-doku-wiki/installing-multi-language-plugin-doku&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/dokuwiki/change-language-doku-wiki/installing-multi-language-plugin-doku'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMzMmaWQ9MjIxOSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="7a63cce367731a2fc2a9adbb74c6f99e" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/dokuwiki/change-language-doku-wiki?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Changing the language in DokuWiki</h3></a>
		<table><tr><td colspan='2'><h4>Changing the Admin language</h4></td></tr>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/dokuwiki/change-language-doku-wiki/change-admin-language-doku?tsrc=rsbedu'>How to change the DokuWiki admin language</a></td>
                </tr>
        <tr><td colspan='2'><h4>Configuring the Multilingual Plugin</h4></td></tr>  <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/dokuwiki/change-language-doku-wiki/installing-multi-language-plugin-doku?tsrc=rsbedu'>Installing the Multilingual Plugin for DokuWiki</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/dokuwiki/change-language-doku-wiki/configure-multilingual-plugin?tsrc=rsbedu'>Configuring the Multilingual Plugin in DokuWiki</a></td>
                </tr>
          	</table>
