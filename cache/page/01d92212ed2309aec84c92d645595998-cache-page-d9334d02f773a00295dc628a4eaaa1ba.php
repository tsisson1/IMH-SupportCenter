<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:59655:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-25/language/add-new-language-override" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-07-22T14:32:43-07:00" />
  <meta name="keywords" content="joomla 2.5 change text new language override" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="In this tutorial, we'll show you how you can use the Joomla 2.5 Language Override tool to change the text of common words and phrases used in Joomla." />
  <title>How to use the Joomla 2.5 Language Overrides Tool - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-25/language/add-new-language-override" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:046572f6faa9590eba67e441c487fb6a -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to use the Joomla 2.5 Language Overrides Tool									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>24,230</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Mar 7, 2012'><span style='color:#606060;'>Published:</span> Jul 22, 2015</div>
							...
							<div style='clear:both;'></div>
								...
								<p class="alert">Joomla 2.5 has reached its end of life as for 12/31/2014. Please be advised this may be a security risk to your website. You can view more information about the end of life <a href="https://docs.joomla.org/Joomla!_CMS_versions">here</a>.</p><br /><p>Much of Joomla 2.5 runs off of language files. These language files store values for commonly used words and phrases, and make it easier to <a href="/support/edu/joomla-25/language/change-site-language">change languages in Joomla</a>. For example, if your site is in English, you may have a language "Constant" named HELLO. In English, HELLO equals "hello". In Spanish, HELLO equals "hola". If you change languages in Joomla, when Joomla is asked to print the constant HELLO to the screen, it will print either hello or hola, depending on the language you have set.</p>
<p>Joomla includes a new feature called <strong>Language Overrides</strong> that allows you to easily change these constants. For example, in your site's breadcrumb trail, it by default says, "You are here", and then prints the breadcrumb trail. "You are here" is actually a language contstant, and in this tutorial we'll show you how to change the value of that constant in the event you don't want it to show or you want to change its value.</p>
<p><strong>To use the Joomla 2.5 Language Override tool:</strong></p>
<ol class="article_list">
<li><a href="/support/edu/joomla-25/getting-started/how-to-log-into-dashboard">Log into your Joomla Dashboard</a></li>
<li>In the top menu, hover over <strong>Extensions</strong> and click <strong>Language Manager</strong></li>
<li>Click the <strong>Overrides</strong> Tab and then click <strong>New<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/add-language-override/click-new-override.gif"><img  alt="click-new-override" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/add-language-override/click-new-override.gif" /></a></strong></li>
<li>Under <strong>Search text you want to change</strong>, type in the text you want to edit. Ensure <strong>Value</strong> is selected, and then click <strong>Search</strong>. In our Example, we typed in <strong>You are here</strong>. In the search results, click on <strong>MOD_BREADCRUMBS_HERE</strong>, as this is the value we want to change.</li>
<li>Under <strong>Create a New Override</strong>, update the text to reflect what you want it to read. In our situation, we don't want the text to display at all, so we will delete all of the text.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/add-language-override/edit-your-new-language-override.gif"><img  alt="edit-your-new-language-override" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/add-language-override/edit-your-new-language-override.gif" /></a></li>
<li>Click <strong>Save &amp; Close</strong> in the top right menu</li>
</ol>
<p>If you followed the exact steps above, the "You are here:" text in the breadcrumb trail will no longer show.</p>
<table class="article_table">
<tbody>
<tr>
<th>Before our Language Override</th> <th>After our Language Override</th>
</tr>
<tr>
<td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/add-language-override/before-language-override.gif"><img style="max-width: 250px;"  alt="before-language-override" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/add-language-override/before-language-override.gif" /></a></td>
<td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/add-language-override/after-language-override.gif"><img style="max-width: 250px;"  alt="after-language-override" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/add-language-override/after-language-override.gif" /></a></td>
</tr>
</tbody>
</table> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/joomla-25/language'>203: Working with languages in Joomla 2.5</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 2: How to use the Joomla 2.5 Language Overrides Tool</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 1: <a href='/support/edu/joomla-25/language/change-site-language'>How to change the Site Language in Joomla 2.5</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-25/language/add-new-language-override&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-25/language/add-new-language-override'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xOTEmaWQ9MTIwMiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/joomla-25/language?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Working with languages in Joomla 2.5</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/joomla-25/language/change-site-language?tsrc=rsbedu'>How to change the Site Language in Joomla 2.5</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/joomla-25/language/add-new-language-override?tsrc=rsbedu'>How to use the Joomla 2.5 Language Overrides Tool</a></td>
                </tr>
          	</table>
