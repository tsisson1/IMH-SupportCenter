<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:62260:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/boldgrid/getting-started/setup-staging" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-12-15T14:33:10-08:00" />
  <meta name="keywords" content="Staging BoldGrid" />
  <meta name="author" content="John-Paul Briones" />
  <meta name="description" content="Learn how to setup a staging site in BoldGrid for WordPress." />
  <title>How to Set Up Staging in BoldGrid - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/boldgrid/getting-started/setup-staging" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:9278ddcab453af127bf6b0d1b1c81ff5 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to Set Up Staging in BoldGrid									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>440</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Oct 13, 2015'><span style='color:#606060;'>Published:</span> Dec 15, 2015</div>
							...
							<div style='clear:both;'></div>
								...
								<center><iframe width="560" height="315" src="https://www.youtube.com/embed/Y1K3Cl2qZCw" frameborder="0" allowfullscreen></iframe></center>
<p>One of the best features of <a href="http://www.boldgrid.com/introduction-to-boldgrid">BoldGrid</a> is the Staging option.  Staging is a basically a location created to hold a <i>second</i> website within the BoldGrid Administrative interface.  Staging allows you to create a new or "staged" site while still have an "Active" or "live" site. This means you can work on building your new BoldGrid site without removing your current WordPress website.  It's important to remember that the Staging site is not visible to the public.  We will go over the general steps to use <b>Staging</b> to build another website.</p>

<h2>Installing the Staging Site</h2>
<p>The first step in using the Staging option is to install it.  NOTE: The Staging site cannot be installed until after an Active site has already been installed.  </p>
<ol class="article_list">
<li><a href="http://www.webhostinghub.com/help/learn/boldgrid/getting-started-boldgrid/how-to-login-to-boldgrid">Log into your website admin interface</a>.</li>
<li>In the menu at left, click on Inspirations</li>
<li>
<a class="std_ss" href="http://webhostinghub.com/help/images/stories/using-staging/install-staging.jpg"><img style="float: right; margin: 0px 0px 15px 15px;" width="100"  alt="Install as staging" src="http://webhostinghub.com/help/images/stories/using-staging/install-staging.jpg" align="right" /></a>
<p>In the window labeled "How would you like to install your new content", select <b>Install as Staging</b></p>
<div style="clear:both;"></div>
</li>
<li><a class="std_ss" href="http://webhostinghub.com/help/images/stories/using-staging/select-themes-tab.jpg"><img style="float: right; margin: 0px 0px 15px 15px;" width="100"  alt="Click on Themes Tab" src="http://webhostinghub.com/help/images/stories/using-staging/select-themes-tab.jpg" align="right" /></a>
  
    <p>Select the <b>Themes</b> tab in order to select a theme for your Staging site.</p>
    <div style="clear:both;"></div>
  </li>

  <li>
    <a class="std_ss" href="http://webhostinghub.com/help/images/stories/using-staging/pick-a-theme.jpg"><img style="float: right; margin: 0px 0px 15px 15px;" width="100"  alt="Hover over a theme for preview or selection" src="http://webhostinghub.com/help/images/stories/using-staging/pick-a-theme.jpg" align="right" /></a>
  
    <p>Hover over a theme with your mouse pointer and you'll see the option to preview or select.  Click on <b>Additional Themes</b> to see other choices.  Click on <b>Select</b> when you have decided on a particular theme.</p>  
    <div style="clear:both;"></div>
  </li>

  <li>
    <a class="std_ss" href="http://webhostinghub.com/help/images/stories/using-staging/confirm-theme-choice.jpg"><img style="float: right; margin: 0px 0px 15px 15px;" width="100"  alt="Confirm the theme choice for installation" src="http://webhostinghub.com/help/images/stories/using-staging/confirm-theme-choice.jpg" align="right" /></a>
  
    <p>Confirm your theme choice by clicking on <b>Install this theme!</b>, or click on <b>Go back</b> to see the themes list again.  </p>
    <div style="clear:both;"></div>
  </li>

  <li>  
    <a class="std_ss" href="http://webhostinghub.com/help/images/stories/using-staging/enable-theme.jpg"><img style="float: right; margin: 0px 0px 15px 15px;" width="100"  alt="Enable theme for Staging" src="http://webhostinghub.com/help/images/stories/using-staging/enable-theme.jpg" align="right" /></a>
  
    <p>Click on <b>Enable Theme</b> in order to activate the them you just installed for Staging.</p>
    <div style="clear:both;"></div>
  </li>

</ol>

<h2>How to Edit/Customize the Staging Site</h2>

<ul>

<li>
  <a class="std_ss" href="http://webhostinghub.com/help/images/stories/using-staging/customize-staged.jpg"><img style="float: right; margin: 0px 0px 15px 15px;" width="100"  alt="Using the Customize menu for staging" src="http://webhostinghub.com/help/images/stories/using-staging/customize-staged.jpg" align="right" /></a>

  <p>When you have the Staging Site loaded, you can edit a few different ways.  You can edit its Pages, or you can use the <b>Customize</b> option to modify the Staging site as needed.</p>
  <div style="clear:both;"></div>
</li>

<li>  
  <a class="std_ss" href="http://webhostinghub.com/help/images/stories/using-staging/staging-pages.jpg"><img style="float: right; margin: 0px 0px 15px 15px;" width="100"  alt="Customize Staging Pages" src="http://webhostinghub.com/help/images/stories/using-staging/staging-pages.jpg" align="right" /></a>

  <p>The pages of a staging site can be edited by simply clicking on <b>Pages</b> in the menu at left, and then editing the pages or adding the pages of the development group labeled <b>Staging</b>.  </p>
  <div style="clear:both;"></div>
</li>

</ul>

<h2>How to See the Staging Site</h2>

<a class="std_ss" href="http://webhostinghub.com/help/images/stories/using-staging/see-staging-site.jpg"><img style="float: right; margin: 0px 0px 15px 15px;" width="100"  alt="View Staging Site" src="http://webhostinghub.com/help/images/stories/using-staging/see-staging-site.jpg" align="right" /></a>
<p>Finally, the last step in seeing the staging site is by clicking the on title bar in the Admin Menu, and then click on <b>Staging site</b>.  This will bring up the staging site so that you can view your changes.</p>
<p>Feel free to visit the <a href="http://www.boldgrid.com/support/">BoldGrid Support Center</a> article on <a href="http://www.boldgrid.com/support/how-to-set-up-staging-in-boldgrid/">How to Set Up Staging</a> for more information. 
</p>
<div style="clear:both;"></div>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 7: How to Set Up Staging in BoldGrid</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 6: <a href='/support/edu/boldgrid/getting-started/change-themes'>How to Change Themes in BoldGrid for WordPress</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/boldgrid/getting-started/setup-staging&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/boldgrid/getting-started/setup-staging'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD01MzcmaWQ9MzY2NyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
