<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:65056:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/website-design/create-responsive-template/adding-css-styles-web" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-06-10T20:36:24-07:00" />
  <meta name="keywords" content="styles Responsive website changecreate DesktopTabletMobile StyleSheethow" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="To get the styles for your Responsive website to change, you will need to create a Desktop, Tablet, and Mobile StyleSheet. This tutorial will show you how." />
  <title>Step 2: Adding CSS styles to a Responsive Template - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/website-design/create-responsive-template/adding-css-styles-web" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:aebd1311471de1f728b67ceb0b517831 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '78.158.177.148']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Step 2: Adding CSS styles to a Responsive Template									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>7,506</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jun 3, 2013'><span style='color:#606060;'>Published:</span> Jun 10, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In order for your Responsive Template to work, you will need to make at least 3 different stylesheets. The stylesheets will load depending on the size of the screen of the device. We will explain how to attach the style sheets in the next article. In the meantime we will<strong> make 3 different stylesheets</strong>, a <strong>Desktop</strong> (<em>style.css</em>), <strong>Tablet</strong> (<em>medium-style.css</em>), and a <strong>Mobile</strong> Stylesheet (<em>mobile-style.css</em>).
<h2>Make the general CSS style sheet</h2>
  
<p>Your website will need a style sheet that holds CSS styles that do not change throughout the site. The CSS we will use is the code below. You will need to create a <em>styles.css</em> stylesheet to store the CSS code.</p>
  

<pre style="padding:15px;">body{background:#555555;margin:0%; padding:0%;}
...
<p>The previous code will display the colors for the background and the styles for the footer, header, and content. Next we will create the code for making the boxes change when the device screen is changed.</p>
<br style="clear: both;" />

<h2>Creating the CSS Stylesheets for the Responsive Template</h2>

<p>What we are going to do in the next style sheets is create a different size for the box elements. We named the boxes in the page the "<em>box</em>" class.

The Box class is what we will change in each sheet for the images and the box size.<h3>1. Desktop Stylesheet: min-device-width: 1440px</h3>
  
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/website-design/206/adding-style-sheets/create-responsive-template3-desktop.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Create Responsive Template Desktop code" src="//cdn.inmotionhosting.com/support/images/stories/edu/website-design/206/adding-style-sheets/create-responsive-template3-desktop.png" title="Click here to view the larger image" width="100" /></a>
First you will need to create a file called <em>desktop-style.css</em>. Once you have the stylesheet created, you will need to paste the code below in the file and save it. The final result of this stylesheet will look like the snapshot to the right.</p>
  

<pre style="padding:15px;">#wrapper{border:none; margin:0% auto; padding:0%; width:80%; min-width:1440px;max-width:1600px}
...
<p>The previous code will display the Responsive site <em>.box</em> items horizontally. The wrapper of the site will fix the maximum width to 1600 pixels and minimum at 1240 pixels. It sets the boxes width to 18% displays the boxes inline-block and aligns them vertically top. This allows the site to display horizontally.</p>
<br style="clear: both;" />




<h3>2. Tablet Stylesheet: min-width: 800px and max-width: 1440px</h3>

<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/website-design/206/adding-style-sheets/create-responsive-template-2-tablet.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Create Responsive Template tablet styles" src="//cdn.inmotionhosting.com/support/images/stories/edu/website-design/206/adding-style-sheets/create-responsive-template-2-tablet.png" title="Click here to view the larger image" width="100" /></a>Next your will need to make a stylesheet called <em>medium-style.css</em>. The below code is different from the last. This code will stack the <em>.box</em> items in 2 columns. Paste the code in the medium-style.css sheet and save the file. The final result of this stylesheet will look like the snapshot to the right.
</p>

<pre style="padding:15px;">#wrapper{border:none; margin:0% auto; padding:0%; width:80%; min-width:700px;max-width:1439px}
.box{background:#ffffff;padding:2%;margin:2% 0% 2% 2%;width:43%;display:inline-block;vertical-align:top;border:1px solid #999999}
.image-box{max-width:40%;float:left;padding:0px 2% 1% 0%;}</pre>
<p>This will display the site with 2 columns when the browser window or the device screen is between 700 and 1439 pixels. The width for the boxes is set to 43% to make them float in columns.<br style="clear: both;" />
</p>



<h3>3. Mobile Stylesheet: min-width: 100px and max-width: 799px</h3>

<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/website-design/206/adding-style-sheets/create-responsive-template-1-mobile.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Create Responsive Template Mobile Styles" src="//cdn.inmotionhosting.com/support/images/stories/edu/website-design/206/adding-style-sheets/create-responsive-template-1-mobile.png" title="Click here to view the larger image" width="100" /></a>Now for the mobile stylesheet. Create a file called <em>mobile-style.css</em>. Paste the following code in that sheet and save the changes. The final result of this stylesheet will look like the snapshot to the right.
</p> 

<pre style="padding:15px;">#wrapper{border:none; margin:0%; padding:0%;min-width:200px;width:100%}
.box{background:#ffffff;width:92%;padding:2%;display:inline-block;vertical-align:top;border:1px solid #999999}
.image-box{padding:0% 2% 2% 0%;max-width:100px;}</pre>


<p>The previous code will display the site with the <em>.box</em> items stacking vertically on each other. When this stylesheet loads, you will see the boxes at 92% width. So when the screen gets below 700 pixels the boxes will float vertically. This allows a small screen to display the site better.<br style="clear: both;" />
</p>
<p>Now when you are finished adding the CSS code to each stylesheet, you can now <a href="/support/edu/website-design/create-responsive-template/links-stylesheets-responsive-templates">link the stylesheets to your Responsive Web Template</a>.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 3: Step 2: Adding CSS styles to a Responsive Template</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 2: <a href='/support/edu/website-design/create-responsive-template/adding-html-web-design'>Step 1: Adding HTML to the Responsive Template</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/website-design/create-responsive-template/adding-css-styles-web&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/website-design/create-responsive-template/adding-css-styles-web'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zOTMmaWQ9Mjc1MyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="70b269c784079a92e7f32cabd54596ab" value="1" />	</div>
	</form>
<!-- <br />
