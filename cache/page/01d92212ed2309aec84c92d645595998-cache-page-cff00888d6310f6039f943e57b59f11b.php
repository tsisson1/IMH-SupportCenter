<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:64157:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/wordpress-development/save-wordpress-plugin-settings-with-form" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-08-01T18:40:09-07:00" />
  <meta name="keywords" content="wordpress development dev create creating make making plugin plugins setting settings form" />
  <meta name="author" content="Jacob Nicholson" />
  <meta name="description" content="Save WordPress plugin settings with a form. To take information typed into your plugin page and add it to the WordPress database so your plugin can read it" />
  <title>Save WordPress plugin settings with form - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/wordpress-development/save-wordpress-plugin-settings-with-form" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:533506e6d358485c3543c234af5b6365 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-22']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '182.180.141.79']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/website/wordpress-development' itemprop='url'><span itemprop='title'>WordPress Development<span></a>
			<div class='dropdown_3columns' style='width:900px; margin-left:-250px;'>
				<div class='col_1' style='width:290px;'><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/wordpress-development/save-wordpress-plugin-settings-with-form'>Save WordPress plugin settings with form</a> (7,513 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/wordpress-development/create-your-first-wordpress-plugin'>Create your first WordPress plugin</a> (1,643 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/wordpress-development/extra-post-info-wordpress-plugin'>Extra Post Info WordPress Plugin</a> (786 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/wordpress-development/the-has-action-wordpress-function'>The has_action() WordPress function</a> (315 hits)</div></div>
				<div class='col_1' style='width:290px;'><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/wordpress-development/register-wordpress-plugin-settings-to-database'>Register WordPress plugin settings to database</a> (3,995 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/wordpress-development/read-wordpress-plugin-settings-from-database'>Read WordPress plugin settings from database</a> (1,006 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/wordpress-development/create-wordpress-plugin-script'>Create WordPress plugin script</a> (451 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/wordpress-development/wordpress-plugin-file-header'>Wordpress plugin file header</a> (216 hits)</div></div>
				<div class='col_1' style='width:290px;'><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/wordpress-development/create-wordpress-admin-menu-for-your-plugin'>Create WordPress admin menu for your plugin</a> (2,785 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/wordpress-development/create-wordpress-plugin-page'>Create WordPress plugin page</a> (932 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/wordpress-development/create-wordpress-plugin-function'>Create WordPress plugin function</a> (352 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/wordpress-development/the-add-action-wordpress-function'>The add_action WordPress function</a> (163 hits)</div></div>
			</div>
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Save WordPress plugin settings with form</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Save WordPress plugin settings with form									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>7,513</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jul 4, 2014'><span style='color:#606060;'>Published:</span> Aug 1, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>After you <a href="http://www.inmotionhosting.com/support/website/wordpress-development/create-your-first-wordpress-plugin" target="_blank">create your first WordPress plugin</a>, and have your <a href="http://www.inmotionhosting.com/support/website/wordpress-development/create-wordpress-plugin-page" target="_blank">WordPress plugin page</a> setup. You want to take information typed into your plugin page and add it to the WordPress database so your plugin can read it.</p>

<p>This allows your plugin users to alter settings for your WordPress plugin and customize it to fit their needs.</p>

<img style="width: 595px; display: block; margin: 0px auto 10px auto;" src="http://www.inmotionhosting.com/support/images/stories/wordpress-development/plugins/admin-menu/extra-post-info-admin-page-with-non-functional-form.png" alt="extra post info admin page with non-functional form" />
...
<h2>Add form to WordPress plugin page</h2>

<p>One of the most common things you'll do on a WordPress plugin page is use a form to capture some user input.</p>

<p>You can use the built in WordPress option page to gather info from the user, and then save it in our WordPress database in the <span style="color: red;">wp_options</span> table. That way we can pull this info later to change what our plugin does on our site.</p>

<pre class="cli" style="width: 800px; margin-bottom: 15px;">function extra_post_info_page(){
?&gt;
  &lt;h1&gt;WordPress Extra Post Info&lt;/h1&gt;
  &lt;form method="post" action="<span style="color: red;">options.php</span>"&gt;
    &lt;?php <span style="color: red;">settings_fields</span>( '<span style="color: red;">extra-post-info-settings</span>' ); ?&gt;
    &lt;?php <span style="color: red;">do_settings_sections</span>( '<span style="color: red;">extra-post-info-settings</span>' ); ?&gt;
    &lt;table class="form-table"&gt;
      &lt;tr valign="top"&gt;
      &lt;th scope="row"&gt;<span style="color: red;">Extra post info:</span>&lt;/th&gt;
      &lt;td&gt;&lt;input type="text" name="<span style="color: red;">extra_post_info</span>" value="&lt;?php echo <span style="color: red;">get_option( 'extra_post_info' )</span>; ?&gt;"/&gt;&lt;/td&gt;
      &lt;/tr&gt;
    &lt;/table&gt;
    &lt;?php <span style="color: red;">submit_button()</span>; ?&gt;
  &lt;/form&gt;
...
<pre class="cli" style="margin-bottom: 15px;">&lt;form method="post" action="<span style="color: red;">options.php</span>"&gt;</pre>
...
<pre class="cli" style="margin-bottom: 15px;">&lt;?php <span style="color: red;">settings_fields</span>( '<span style="color: red;">extra-post-info-settings</span>' ); ?&gt;</pre>
...
<pre class="cli" style="margin-bottom: 15px;">&lt;?php <span style="color: red;">do_settings_sections</span>( '<span style="color: red;">extra-post-info-settings</span>' ); ?&gt;</pre>
...
<pre class="cli" style="margin-bottom: 15px;">&lt;th scope="row"&gt;<span style="color: red;">Extra post info:</span>&lt;/th&gt;</pre>
...
<pre class="cli" style="width: 740px; margin-bottom: 15px;">&lt;td&gt;&lt;input type="text" name="<span style="color: red;">extra_post_info</span>" value="&lt;?php echo <span style="color: red;">get_option('extra_post_info')</span>; ?&gt;"/&gt;&lt;/td&gt;</pre>

<p>We use the WordPress <span style="color: red;">submit_button()</span> function to create a button to save our data.</p>

<pre class="cli" style="margin-bottom: 15px;">&lt;?php <span style="color: red;">submit_button()</span>; ?&gt;</pre>

<h3>Plugin page with non-functional form</h3>

<p>We now have enough logic in our plugin page to display a form, but it doesn't do anything yet.</p>

<img style="width: 595px; display: block; margin-left: auto; margin-right: auto;" src="http://www.inmotionhosting.com/support/images/stories/wordpress-development/plugins/admin-menu/extra-post-info-admin-page-with-non-functional-form.png" alt="extra post info admin page with non-functional form" />

<h3>Register plugin settings to WordPress database</h3>

<p>You now want to <a href="http://www.inmotionhosting.com/support/website/wordpress-development/register-wordpress-plugin-settings-to-database" target="_blank">register WordPress plugin settings to the database</a> so that information entered into our plugin page's form is taken and added to the database.</p> 
...
<div style='display:inline-block;'>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD01MDQmaWQ9MzMzNyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="a2536ead30dc4f72b1c3ecd0dc7ce0dc" value="1" />	</div>
	</form>
<!-- <br />
