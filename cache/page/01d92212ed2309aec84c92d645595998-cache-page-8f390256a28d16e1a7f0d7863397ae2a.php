<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50308:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/domain-names/stop-subdomain-from-redirecting" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, Thanks for the question and sorry to hear that your subdomain is not going where you want it to go. In general, subdomains won't re-direct unless..." />
  <title>Stop Subdomain From Redirecting | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/domain-names/stop-subdomain-from-redirecting" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:213b8b1b1dc751dc9279b8344576ceaa -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Stop Subdomain From Redirecting</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-12-25 5:46 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>1,922</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>For some reason my subdomain redirects to one of my other sites and I did not set it up this way. How do I fix?  Eg.   www.store.xyz.com goes to and displays the following www.store.abc.com.  The domain does not redirect, only the subdomain. Thanks<br />
</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_4350' id='upvote_answer_4350' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='4350' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_4350').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_4350' id='downvote_answer_4350' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='4350' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_4350').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
Thanks for the question and sorry to hear that your subdomain is not going where you want it to go.  In general, subdomains won't re-direct unless, they are either setup improperly, or something is causing that URL go to that location.  Without specifics I cannot check to see what's actually happening.  However, you may want to check the subdomain settings in the cPanel.  You can see how it's normally setup through our article:  <a href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-manage-domains/creating-a-subdomain">Creating  a Subdomain</a>.  If that's not the issue, then you should also review your <a href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/how-do-i-make-custom-dns-records">DNS settings</a> or your <a href="http://www.inmotionhosting.com/support/website/htaccess/what-is-the-htaccess-file-and-what-do-i-use-it-for">HTACCESS file</a> to see if a re-direct is affecting the general domain.  <br />
<br />
If you are still having trouble with this, please provide more specific information so that we can investigate.  Or, if you wish to keep it private, then contact our live tech support team available 24/7.  Their contact information is at the bottom of this page.<br />
<br />
Happy Holidays!<br />
Kindest regards,<br />
Arnel C.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_4350').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_4350' id='form_comment_on_answer_4350' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/domain-names/stop-subdomain-from-redirecting&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/domain-names/stop-subdomain-from-redirecting'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="195e85288294657f6d41b1be7773189c" value="1" />	</div>
	</form>
<!-- <br />
