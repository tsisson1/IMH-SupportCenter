<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:58567:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/phpbb/working-with-users/how-to-set-my-default-phpbb-user-group" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-03-28T19:29:09-07:00" />
  <meta name="keywords" content="change user group default phpBB" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Looking to change a user's default user group? Learn how in this tutorial." />
  <title>How to set my default phpBB user group - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/phpbb/working-with-users/how-to-set-my-default-phpbb-user-group" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:1d3d349726997a6e02c1a03b4a48768c -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '89.75.82.195']);
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/phpbb' itemprop='url'><span itemprop='title'>phpBB<span></a><div class='dropdown_4columns'><h2>phpBB Education Channel</h2><div class='col_2'><h3>100 Level Classes</h3><div><a href='/support/edu/phpbb/getting-started-phpbb'>101: Getting Started in phpBB 3.0</a></div><div><a href='/support/edu/phpbb/manage-forums'>102: Creating Forums in phpBB 3.0</a></div><div><a href='/support/edu/phpbb/working-with-users'>103: Working with Users in phpBB 3.0</a></div></div><div class='col_2'><h3>200 Level Classes</h3><div><a href='/support/edu/phpbb/general-settings'>201: Working with General Settings in phpBB 3</a></div><div><a href='/support/edu/phpbb/manage-posting-settings'>202: Working with posting settings in phpBB 3.0</a></div><div><a href='/support/edu/phpbb/managing-permissions'>203: Managing permissions in phpBB 3.0</a></div><div><a href='/support/edu/phpbb/manage-styles'>204: Managing styles and themes in phpBB 3.0</a></div><div><a href='/support/edu/phpbb/maintaining-forum'>205: Forum moderation in phpBB 3.0</a></div><div><a href='/support/edu/phpbb/manage-system-settings'>206: Manging System Settings in phpBB 3.0</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/phpbb/working-with-users' itemprop='url'><span itemprop='title'>103: Working with Users in phpBB 3.0<span></a><div class='dropdown_3columns'><h2> Working with Users in phpBB 3.0</h2><div class='col_3'><div>1. <a style='display:inline;' href='/support/edu/phpbb/working-with-users/change-user-password'>How to change a user's password in phpBB</a></div><div>2. <a style='display:inline;' href='/support/edu/phpbb/working-with-users/create-user'>How to create a user in phpBB 3.0</a></div><div>3. <a style='display:inline;' href='/support/edu/phpbb/working-with-users/delete-user'>How to delete a user account in phpBB 3.0</a></div><div>4. <a style='display:inline;' href='/support/edu/phpbb/working-with-users/new-user-group'>How to create a user group in phpBB 3.0</a></div><div>5. <a style='display:inline;' href='/support/edu/phpbb/working-with-users/user-discipline'>How to discipline users in phpBB 3.0</a></div><div>6. <a style='display:inline;' href='/support/edu/phpbb/working-with-users/prune-user'>Pruning users in phpBB 3.0</a></div><div>7. <a style='display:inline;' href='/support/edu/phpbb/working-with-users/how-to-set-my-default-phpbb-user-group'>How to set my default phpBB user group</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to set my default phpBB user...</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to set my default phpBB user group									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>3,512</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Mar 27, 2013'><span style='color:#606060;'>Published:</span> Mar 28, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>As a phpBB admin, you have the ability to change which group in a user's group list will be their default. The default group dictates how the user will display when logged into the site. For instance, a user is in both Registered Users and Moderators groups. Their default group is the Registered User group, so they display with the color of that group.</p>

<p>Changing the default group to the Moderators group will cause them to display in the moderators group colors instead. Changing the default group does not change the users permissions as they have the highest level of permissions for all of their groups at all times. Below is a quick guide on how to change the default group for a user within the phpBB admin user panel.</p>

<h2>Setting a user's default group in phpBB</h2>

<ol class="article_list">
<li><a href="/support/edu/phpbb/getting-started-phpbb/phpbb-login">Log into your phpBB ACP (Administrative Control Panel)</a><div style="clear:both;"></div></li>
<li>Once inside the main Account Control Panel (ACP) click on the <strong>Users and Groups</strong> tab found across the top of the page.<div style="clear:both;"></div></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/users-and-groups/change-default-group/manage-users.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="click on user management" src="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/users-and-groups/change-default-group/manage-users.png" title="Click here to view the larger image" width="200" /></a>Using the left hand sidebar, click on the <strong>Manage Users</strong> option under the <em>Users</em> category.<div style="clear:both;"></div></li>
<li>Now that you are on the <em>User Administration</em> page, type in the username that you want to work with and click the <strong>Submit</strong> button.<div style="clear:both;"></div></li>
<li>This brings you to the main user settings page for your selected user. Look to the upper right corner and select the <strong>Groups</strong> option from the <em>Select Form</em> dropdown.<div style="clear:both;"></div></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/users-and-groups/change-default-group/assign-default.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="set the default group" src="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/users-and-groups/change-default-group/assign-default.png" title="Click here to view the larger image" width="200" /></a>The new page you are on is the groups list for the user. You will see each group to which the user belongs listed alphabetically on the page. There is a second column for each group with the value '<em>Make group default for member</em>' in it. The default group is in bold. To set a new default group, simply click the text in this column for the appropriate group. It will turn bold and now be the new default group.<div style="clear:both;"></div></li>
</ol>
<br />
<p>The new default group is automatically saved. Below is a sample of how the user, testy, displays with the Registered Users group as the default, then again as the Global Moderators group as the default.
<table class="article_table">
<tr><th>Before</th><th>After</th><tr>
<tr><td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/users-and-groups/change-default-group/before.png"><img  alt="before default group change" src="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/users-and-groups/change-default-group/before.png" title="Click here to view the larger image" width="200" /></a></td><td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/users-and-groups/change-default-group/after.png"><img  alt="after default group change" src="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/users-and-groups/change-default-group/after.png" title="Click here to view the larger image" width="200" /></a></td></tr>
</table> 
</p>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/phpbb/working-with-users'>103: Working with Users in phpBB 3.0</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 7: How to set my default phpBB user group</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 6: <a href='/support/edu/phpbb/working-with-users/prune-user'>Pruning users in phpBB 3.0</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/phpbb/working-with-users/how-to-set-my-default-phpbb-user-group&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/phpbb/working-with-users/how-to-set-my-default-phpbb-user-group'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMDEmaWQ9MjU0MCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="f2054b0e0f7ebbbb39ae475ea8d6dcb7" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/phpbb/working-with-users?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Working with Users in phpBB 3.0</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/phpbb/working-with-users/change-user-password?tsrc=rsbedu'>How to change a user's password in phpBB</a></td>
                </tr>
        <tr><td colspan='2'><h4>User Management</h4></td></tr>  <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/phpbb/working-with-users/create-user?tsrc=rsbedu'>How to create a user in phpBB 3.0</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/phpbb/working-with-users/delete-user?tsrc=rsbedu'>How to delete a user account in phpBB 3.0</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/phpbb/working-with-users/new-user-group?tsrc=rsbedu'>How to create a user group in phpBB 3.0</a></td>
                </tr>
        <tr><td colspan='2'><h4>Advanced User Management</h4></td></tr>  <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/phpbb/working-with-users/user-discipline?tsrc=rsbedu'>How to discipline users in phpBB 3.0</a></td>
                </tr>
          <tr >
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/phpbb/working-with-users/prune-user?tsrc=rsbedu'>Pruning users in phpBB 3.0</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>7.</td>
                        <td><a href='/support/edu/phpbb/working-with-users/how-to-set-my-default-phpbb-user-group?tsrc=rsbedu'>How to set my default phpBB user group</a></td>
                </tr>
          	</table>
