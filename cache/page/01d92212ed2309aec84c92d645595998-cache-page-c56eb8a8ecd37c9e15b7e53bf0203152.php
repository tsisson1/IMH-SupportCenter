<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:68212:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/prestashop-15/images-and-descriptions/change-short-description-max-length" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-08-22T11:40:49-07:00" />
  <meta name="keywords" content="set maximum length short description products PrestaShop 1.5" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Learn how to set the maximum length of a product's short description in PrestaShop 1.5." />
  <title>Changing the max length of the short description in PrestaShop 1.5 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/prestashop-15/images-and-descriptions/change-short-description-max-length" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:ea397b1c01ee7b4e48710870227afd1f -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '194.187.168.201']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Changing the max length of the short description in PrestaShop 1.5									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>15,496</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jun 6, 2012'><span style='color:#606060;'>Published:</span> Aug 22, 2012</div>
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Comments:</span> <a href='#comments'>3</a></div>
							<div style='clear:both;'></div>
								...
								<p>There are many settings that affect the look and feel of your store. These can help with the overall atmosphere customers experience as they shop. One of these smaller details is the <a href="/support/edu/prestashop-15/images-and-descriptions/product-description">short description of your products</a>. You may want to set a specific maximum limit for consistency, or to avoid overly long descriptions, for example. Changing the maximum length of the short description in PrestaShop 1.5 is a simple process.</p>
<p> </p>
<h2>What does the Short description max size setting do?</h2>
<p>The <strong>Short description max size</strong> setting controls how many characters the store administrator can type in for a short description. If you've previously typed longer <em>short descriptions</em> than what you are changing this value to now, those descriptions will be unaltered. Only new <em>short descriptions</em> will be checked for length going forward.</p>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/add-product/short-description-error.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="short-description-error" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/add-product/short-description-error.gif" /></a></p>
<p>For example, if you set the <strong>Short description max size</strong> to 40, when you type a <em>short description</em> with 293 characters, PrestaShop 1.5 will give you the following error when trying to save the <em>short description</em>:</p>
<p>This field description_short (English (English)) is too long: 40 chars max (count now 293).</p>
<div style="clear: both;"></div>
<p> </p>
<h2>To change the max length of the short description in PrestaShop 1.5:</h2>
<ol class="article_list">
<li><a href="/support/edu/prestashop-15/getting-started/login-to-dashboard">Log into your PrestaShop 1.5 dashboard.</a></li>
<li>Using the top menu bar, hover over the <strong>Preferences </strong>tab and select the <strong>Products </strong>option.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/preferences-products-max-length-description/_preferences-tab-products.png"><img  alt="_preferences-tab-products" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/preferences-products-max-length-description/_preferences-tab-products.png" /></a></li>
<li>From the <strong>Preferences : Products</strong> screen, find the <strong>Short description max size</strong> label and enter the maximum number of characters you want to set the short description to. If you wish to have no maximum description, simply leave it blank. This setting is blank by default.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/preferences-products-max-length-description/preferences-products-max-length.png"><img  alt="preferences-products-max-length" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/preferences-products-max-length-description/preferences-products-max-length.png" /></a></li>
<li>Once completed, click on the green <strong>Save </strong>button to save the changes.</li>
</ol>
<p>You now have a new maximum length for your short descriptions in Prestashop 1.5!</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/prestashop-15/images-and-descriptions'>103: PrestaShop 1.5 Product Images and Descriptions</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 7: Changing the max length of the short description in PrestaShop 1.5</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 6: <a href='/support/edu/prestashop-15/images-and-descriptions/product-description'>Adding a PrestaShop 1.5 Product Description</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/prestashop-15/images-and-descriptions/change-short-description-max-length&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/prestashop-15/images-and-descriptions/change-short-description-max-length'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNTMmaWQ9MTQxMyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="1aa26c8e6fbe93f965e2318a15251579" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/prestashop-15/images-and-descriptions?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> PrestaShop 1.5 Product Images and Descriptions</h3></a>
		<table><tr><td colspan='2'><h4>Product Images</h4></td></tr>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/prestashop-15/images-and-descriptions/add-product-image?tsrc=rsbedu'>Adding product images in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/prestashop-15/images-and-descriptions/multiple-images?tsrc=rsbedu'>Adding multiple images to products in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/prestashop-15/images-and-descriptions/changing-the-main-product-image?tsrc=rsbedu'>How to change the main product image in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/prestashop-15/images-and-descriptions/change-image-position?tsrc=rsbedu'>How to order images for a product in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/prestashop-15/images-and-descriptions/removing-product-images?tsrc=rsbedu'>Removing product images in PrestaShop 1.5</a></td>
                </tr>
        <tr><td colspan='2'><h4>Product Descriptions</h4></td></tr>  <tr >
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/prestashop-15/images-and-descriptions/product-description?tsrc=rsbedu'>Adding a PrestaShop 1.5 Product Description</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>7.</td>
                        <td><a href='/support/edu/prestashop-15/images-and-descriptions/change-short-description-max-length?tsrc=rsbedu'>Changing the max length of the short description in PrestaShop 1.5</a></td>
                </tr>
          	</table>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/ca254410c7ac52716c70c55b335b1e66?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/ca254410c7ac52716c70c55b335b1e66'>Vikash Kumar</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-13 4:09 am</div>
				                <div><p>The best website for resolving issues related to prestashop</p>
<p>thanks</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10598);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						...
						<div><a style='font-size:16px;' href='//www.gravatar.com/801cf18a30a08791aa5ebb02f471ee78'>Sara Lind</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-30 2:09 pm</div>
				                <div><p>Hi, how can I do this in 1.6? The short discription is left empty. But nothing changes.</p>
<p>Thanks :)</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27088);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-01 10:13 am</div>
				                <div>Hello Sara,<br />
<br />
Sorry for the problem with Prestashop 1.6.  I'm not sure what you're leaving empty.  When I remove the short description in my 1.6 site, it's no longer there.  If you're using any caching, you may want to turn it off temporarily, or clear it and then reload.  Also, make sure to <a href="http://www.inmotionhosting.com/support/website/how-to/clear-browser-cache">clear any browser cache</a>, in case your browser is loading an old page it has saved on your computer.<br />
<br />
If you have any further questions or comments, please let us know.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27120);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
	...
	<div name='fixComments' id='fixComments' style='width:220px; margin:0px; float:right;'>
		<div class='moduletable'>
			<h3><span class='comment-count'>3</span> Questions & <span class='comment-text'>Comments</span></h3>
