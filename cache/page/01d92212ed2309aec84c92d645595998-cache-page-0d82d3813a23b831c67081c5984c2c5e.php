<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50585:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/drupal-7/modsecurity-error-in-drupal-install" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Mod_security can be disabled via cPanel quite easily. This article will help you with doing so: Disable mod_security via cPanel Modsec Manager If for so..." />
  <title>Mod_Security Error in Drupal Install | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/drupal-7/modsecurity-error-in-drupal-install" rel="canonical" />
...
<script>
  ...
  ga('send', 'pageview');
	...
	<!-- cid:27997e352dd5ec20cb3ed5a61cc822cc -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Mod_Security Error in Drupal Install</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-09-26 8:09 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>503</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Hello, We purchased hosting with inmotion because of the advertised Drupal hosting optimization.<br />
 Drupal's use of Jquery.Cookie is triggering the Mod_Security error.  This happened here as well: http://www.inmotionhosting.com/support/community-support/prestashop-15/how-to-modify-modsecurity<br />
<br />
Can someone disable this for our domain so that our site can work?<br />
</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_4031' id='upvote_answer_4031' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='4031' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_4031').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_4031' id='downvote_answer_4031' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='4031' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_4031').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>11,186 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2013-09-27 8:07 am EST
                		        </div>
					
		                </div>

				Mod_security can be disabled via cPanel quite easily.  This article will help you with doing so:<br />
<br />
&lt;a href=&quot;http://www.inmotionhosting.com/support/website/modsecurity/disable-mod-security-via-modsec-manager&quot;&gt;Disable mod_security via cPanel Modsec Manager&lt;/a&gt;<br />
<br />
If for some reason you do not see this option within your cPanel, you will need to contact &lt;a href=&quot;http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support&quot;&gt;technical support&lt;/a&gt; for any further information.
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_4031').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_4031' id='form_comment_on_answer_4031' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/drupal-7/modsecurity-error-in-drupal-install&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/drupal-7/modsecurity-error-in-drupal-install'></div>
<script type='text/javascript'>
  (function() {
