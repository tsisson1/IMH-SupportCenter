<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:56746:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/oscommerce/new-store/oscommerce-registerglobals-error" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-01-29T19:22:23-08:00" />
  <meta name="keywords" content="oscommerce register_globals error install [gs]" />
  <meta name="author" content="Tim Sisson" />
  <meta name="description" content="In this article, we will discuss register_globals error upon installation and how to correct the error." />
  <title>OsCommerce - register_globals error - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/oscommerce/new-store/oscommerce-registerglobals-error" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:339db4a729291b9ff414e9e7c624935b -->
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/oscommerce' itemprop='url'><span itemprop='title'>osCommerce<span></a><div class='dropdown_4columns'><h2>osCommerce Education Channel</h2><div class='col_2'><h3>100 Level Classes</h3><div><a href='/support/edu/oscommerce/new-store'>101: Getting Started with osCommerce</a></div><div><a href='/support/edu/oscommerce/adding-products-content'>102: Adding products and content to osCommerce</a></div><div><a href='/support/edu/oscommerce/config-tax-payment-shipping'>103: Configuring Taxes and Shipping in osCommerce</a></div><div><a href='/support/edu/oscommerce/payment-gateway-configuration'>104: osCommerce payment gateway configuration</a></div><div><a href='/support/edu/oscommerce/testing-ecommerce-functionality'>105: Testing the osCommerce site</a></div></div><div class='col_2'><h3>200 Level Classes</h3><div><a href='/support/edu/oscommerce/change-theme-template-appearance'>201: Changing your osCommerce appearance</a></div><div><a href='/support/edu/oscommerce/manage-users-administrators'>202: Managing Users in osCommerce</a></div><div><a href='/support/edu/oscommerce/add-security-addons'>203: Adding security to osCommerce</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/oscommerce/new-store' itemprop='url'><span itemprop='title'>101: Getting Started with osCommerce<span></a><div class='dropdown_3columns'><h2> Getting Started with osCommerce</h2><div class='col_3'><div>1. <a style='display:inline;' href='/support/edu/oscommerce/new-store/getting-started-guide-oscommerce'>Getting Started Guide OsCommerce</a></div><div>2. <a style='display:inline;' href='/support/edu/oscommerce/new-store/softaculous-install'>How to Install osCommerce via Softaculous</a></div><div>3. <a style='display:inline;' href='/support/edu/oscommerce/new-store/installing-oscommerce-manually'>Installing osCommerce manually</a></div><div>4. <a style='display:inline;' href='/support/edu/oscommerce/new-store/oscommerce-manually-installing-oscommerce'>Manually Installing osCommerce Video</a></div><div>5. <a style='display:inline;' href='/support/edu/oscommerce/new-store/oscommerce-registerglobals-error'>OsCommerce - register_globals error</a></div><div>6. <a style='display:inline;' href='/support/edu/oscommerce/new-store/oscommerce-admin-login'>How to log into your osCommerce Admin dashboard</a></div><div>7. <a style='display:inline;' href='/support/edu/oscommerce/new-store/how-to-log-into-oscommerce'>How to change the osCommerce admin password</a></div><div>8. <a style='display:inline;' href='/support/edu/oscommerce/new-store/oscommerce-store-configure'>Configuring your store in OsCommerce</a></div><div>9. <a style='display:inline;' href='/support/edu/oscommerce/new-store/oscommerce-editing-your-home-page'>Editing your home page in OSCommerce</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>OsCommerce - register_globa...</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															OsCommerce - register_globals error									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>8,371</span></div>
							...
							<div style='clear:both;'></div>
								...
								<p>When <a href="/support/edu/oscommerce/new-store/softaculous-install">installing OsCommerce</a> for the first time you may receive this error:</p>
<p><strong>Server Requirement Error: register_globals is disabled in your PHP configuration. This can be enabled in your php.ini configuration file or in the .htaccess file in your catalog directory.</strong></p>
<p>To enable register_globals for your account, you will need to <a href="http://www.inmotionhosting.com/support/website/managing-files/how-to-edit-a-file">edit the <strong>.htaccess </strong>file</a> in your OsCommerce root directory. There should already be an .htaccess in there, and you should just have to comment out these lines (may vary per version)</p>
<div class="code_block">php_value register_globals 1</div>
<p>If you are on a PHP 5 server, you should change mod_php4.c to&nbsp;mod_php5.c. If you do not have an .htaccess in your OsCommerce directory, you can simply create one and insert the above lines.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/oscommerce/new-store'>101: Getting Started with osCommerce</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 5: OsCommerce - register_globals error</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 4: <a href='/support/edu/oscommerce/new-store/oscommerce-manually-installing-oscommerce'>Manually Installing osCommerce Video</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 6: <a href='/support/edu/oscommerce/new-store/oscommerce-admin-login'>How to log into your osCommerce Admin dashboard</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/oscommerce/new-store/oscommerce-registerglobals-error&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/oscommerce/new-store/oscommerce-registerglobals-error'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zNzAmaWQ9NjQmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/oscommerce/new-store?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Getting Started with osCommerce</h3></a>
		<table><tr><td colspan='2'><h4>Installing and setting up osCommerce</h4></td></tr>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/oscommerce/new-store/getting-started-guide-oscommerce?tsrc=rsbedu'>Getting Started Guide OsCommerce</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/oscommerce/new-store/softaculous-install?tsrc=rsbedu'>How to Install osCommerce via Softaculous</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/oscommerce/new-store/installing-oscommerce-manually?tsrc=rsbedu'>Installing osCommerce manually</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/oscommerce/new-store/oscommerce-manually-installing-oscommerce?tsrc=rsbedu'>Manually Installing osCommerce Video</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/oscommerce/new-store/oscommerce-registerglobals-error?tsrc=rsbedu'>OsCommerce - register_globals error</a></td>
                </tr>
        <tr><td colspan='2'><h4>osCommerce login</h4></td></tr>  <tr >
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/oscommerce/new-store/oscommerce-admin-login?tsrc=rsbedu'>How to log into your osCommerce Admin dashboard</a></td>
                </tr>
          <tr >
                        <td valign='top'>7.</td>
                        <td><a href='/support/edu/oscommerce/new-store/how-to-log-into-oscommerce?tsrc=rsbedu'>How to change the osCommerce admin password</a></td>
                </tr>
        <tr><td colspan='2'><h4>Basic osCommerce configuration</h4></td></tr>  <tr >
                        <td valign='top'>8.</td>
                        <td><a href='/support/edu/oscommerce/new-store/oscommerce-store-configure?tsrc=rsbedu'>Configuring your store in OsCommerce</a></td>
                </tr>
          <tr >
                        <td valign='top'>9.</td>
                        <td><a href='/support/edu/oscommerce/new-store/oscommerce-editing-your-home-page?tsrc=rsbedu'>Editing your home page in OSCommerce</a></td>
                </tr>
          	</table>
