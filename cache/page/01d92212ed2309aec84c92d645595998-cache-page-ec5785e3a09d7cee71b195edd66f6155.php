<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:60388:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/wordpress/change-max-upload-size" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-04-08T19:08:23-07:00" />
  <meta name="keywords" content="network multisite wordpress amx upload file size" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="You may alter the max upload file size in your network settings. Changing this setting allows for larger file uploads. The guide below demonstrates how to change this particular setting using the Network Admin for a Wordpressmax upload multisite." />
  <title>331: Setting Up the Max Upload File Size for a Wordpress MS installation - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/wordpress/change-max-upload-size" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:fe46f8134128b3a68a9f16856a25bfc3 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															331: Setting Up the Max Upload File Size for a Wordpress MS installation									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>2,844</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Apr 5, 2013'><span style='color:#606060;'>Published:</span> Apr 8, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>When working with file uploads in WordPress a multisite configuration, you want to pay attention to the maximum upload file size. Allowing a setting that allows file sizes that are too large will cause performance issues. Below is a guide that explains how to change the maximum upload size.</p>

<h2>How to set the Max Upload Size for Wordpress multisite</h2>

<ol class="article_list">
  <li><a href="/support/edu/wordpress/330-network-admin-login">Log into the Network Admin</a> for your Wordpress multisite program.</li>
  
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/multi-site/set-max-upload/network-settings.png
"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="network settings menu" src="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/multi-site/set-max-upload/network-settings.png
" title="Click here to view the larger image" width="200" /></a>Scroll down the left hand menu and hover over the <strong>Settings</strong> option. Next, click on <strong>Network Settings</strong> from the popup portion of the menu on the right.<br />
    <div style="clear: both;"></div></li>
    
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/multi-site/set-max-upload/max-upload-file-size.png
"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="set max upload value" src="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/multi-site/set-max-upload/max-upload-file-size.png
" title="Click here to view the larger image" width="200" /></a>This takes you to the <strong>Network Settings</strong> screen. Scroll down until you find the setting that reads <strong>Max Upload File Size</strong>. Note that size is set in <em>Kilobytes (KB)</em>, so <em>1000kb = 1MB</em> Click on the <strong>Max Upload File Size</strong> field and then you are able to change the setting by either using the up and down arrows or by typing in a new value directly. The default value for this setting is 1500 KB.</li>
  
  <li>Once you have entered your desired value, scroll down and click on the <strong>Save Changes</strong> button to finish and save it<br /></li>
</ol>
<br />
<p class="alert">In some cases, this change must be made in conjunction with a change in the php.ini file. Information on changing that can be found here: <a href="/support/website/general-server-setup/update-local-php-settings">How to update your local php settings</a>.
</p>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 20: 331: Setting Up the Max Upload File Size for a Wordpress MS installation</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 19: <a href='/support/edu/wordpress/setting-wordpress-ms-upload-quota-size'>332: Setting the Upload Quota in a Wordpress MS Site</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 21: <a href='/support/edu/wordpress/333-add-admin-via-mysql'>333: How to Add an Admin account in WordPress via MySQL</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/wordpress/change-max-upload-size&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/wordpress/change-max-upload-size'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD03MSZpZD0yNTkwJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="0ed8201ac81928a0651944fbb46f4859" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						...
						<div><a style='font-size:16px;' href='/support/community-support/users/hsn'>hsn</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-14 5:49 pm</div>
				                <div>The &quot;Network Settings&quot; is not present in the settings tab and php.ini doesn't change the upload limit.<br />
What's the solution?</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20690);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-16 12:07 pm</div>
				                <div>Hello Hsn,<br />
<br />
What are the settings you see when you visit "Network Settings"? Are you running WordPress in Multisite mode?<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20735);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-22 3:21 pm</div>
				                <div>Hello Scott<br />
<br />
after so much struggling with the admin page, I decided to reinstall wordpress and then the upload limit becomes 64MB by itself.<br />
</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20944);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
