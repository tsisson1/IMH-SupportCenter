<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:57067:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/magento/104-customizing-magento-admin-backend/changing-the-magento-startup-page-in-admin" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-06-27T13:56:38-07:00" />
  <meta name="keywords" content="magento startup start up page backend admin panel first change" />
  <meta name="author" content="Tim Sisson" />
  <meta name="description" content="In this tutorial, we'll show you how to change the startup page that is displayed when you first log into the Magento backend. " />
  <title>Changing the Magento 1.6 Startup Page in Admin - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/magento/104-customizing-magento-admin-backend/changing-the-magento-startup-page-in-admin" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:a7b511e50523cf1427864ae8ee4f2ae1 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Changing the Magento 1.6 Startup Page in Admin									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>3,459</span></div>
							...
							<div style='clear:both;'></div>
								...
								<p>When you log into the Magento 1.6 admin panel, you will see the Magento Dashboard. While the dashboard may contain valuable information, it may not be the information you want to see when you first log into the backend. You can change the Admin Startup Page in the Magento 1.6 Admin Backend relatively easy.</p>
...
<li>In the left menu pane, scroll down and click "<strong>Admin</strong>" under the "<strong>Advanced</strong>" heading</li>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/magento/magento_dashboard_2.jpg"><img src="//cdn.inmotionhosting.com/support/images/stories/magento/magento_dashboard_2.jpg" alt="magento_dashboard_2"  /></a></p>
<li>Open the section labeled "<strong>Startup Page</strong>"</li>
<li>Find the "<strong>Startup Page</strong>" and change the dropdown to whatever page you want to see first</li>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/magento/magento_startup_1.jpg"><img src="//cdn.inmotionhosting.com/support/images/stories/magento/magento_startup_1.jpg" alt="magento_startup_1"  /></a></p>
...
<p>If you need further assistance please feel free to <a href="/support/community-support">ask a question on our support center</a>.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/magento/104-customizing-magento-admin-backend'>104: Customizing Magento 1.6 Admin Backend</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 2: Changing the Magento 1.6 Startup Page in Admin</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 1: <a href='/support/edu/magento/104-customizing-magento-admin-backend/disable-admin-dashboard-charts-in-magento'>Disable the Admin Dashboard Charts in Magento 1.6</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 3: <a href='/support/edu/magento/104-customizing-magento-admin-backend/changing-the-year-to-date-report-dashboard-in-magento'>Changing the Year-To-Date Report Dashboard in Magento 1.6</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/magento/104-customizing-magento-admin-backend/changing-the-magento-startup-page-in-admin&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/magento/104-customizing-magento-admin-backend/changing-the-magento-startup-page-in-admin'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xNjcmaWQ9MTIzMCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="bba1dfe8f06fa544c838911e5662c00f" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/magento/104-customizing-magento-admin-backend?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Customizing Magento 1.6 Admin Backend</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/magento/104-customizing-magento-admin-backend/disable-admin-dashboard-charts-in-magento?tsrc=rsbedu'>Disable the Admin Dashboard Charts in Magento 1.6</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/magento/104-customizing-magento-admin-backend/changing-the-magento-startup-page-in-admin?tsrc=rsbedu'>Changing the Magento 1.6 Startup Page in Admin</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/magento/104-customizing-magento-admin-backend/changing-the-year-to-date-report-dashboard-in-magento?tsrc=rsbedu'>Changing the Year-To-Date Report Dashboard in Magento 1.6</a></td>
                </tr>
          	</table>
