<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:54286:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/email-client-setup/why-do-i-get-outlook-cannot-connect-to-your-outgoing-smtp-email-server" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hi dewill,Thanks for posting your question. I'm more than happy to assist you. Do you get an error message when trying to send emails? Also, what port a..." />
  <title>Why do I get Outlook cannot connect to your outgoing (SMTP) e-mail server? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/email-client-setup/why-do-i-get-outlook-cannot-connect-to-your-outgoing-smtp-email-server" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:6c22b915b521c2f27d97177290cc9663 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '80.68.59.81']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Why do I get Outlook cannot connect to your outgoing (SMTP) e-mail server?</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/dewill'>dewill</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-02-02 5:28 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>115,074</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I am trying to configure Outlook 2007 to work with my IMAP account.  I followed the directions on this sight and I can receive mail, but I cannot send mail.<br />
<br />
I am using mail.mydomain.com (where mydomain is my actual domain) for both the incoming and outgoing mail servers.  I also configured it to indicate that my outgoing server requires authentication and to use the same settings as my incoming server.<br />
<br />
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_509' id='upvote_answer_509' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='509' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_509').submit();"></div>
	</form>
	<div class='vote_sum'>1</div>
	<form method='post' name='downvote_answer_509' id='downvote_answer_509' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='509' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_509').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>11,071 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2012-02-02 5:32 pm EST
                		        </div>
					
		                </div>

				<p>Hi dewill,</p><p>Thanks for posting your question. I'm more than happy to assist you. Do you get an error message when trying to send emails? Also, what port are you using for Outgoing mail? If you are using port 25 it's likely your ISP is blocking it. Doeble check yoru email settings that they match one of the below connection types.</p><p><strong>Non SSL configuration</strong></p><p style="margin:10px"><strong>Incoming Server:</strong> mail.your-domain.com<br />
<strong>Outgoing Server:</strong> mail.your-domain.com<br />
...
Secure Authentication or SPA needs to be turned off</p><p><strong>SSL configuration</strong></p><p style="margin:10px"><strong>Incoming Server:</strong> secure##.inmotionhosting.com<br />
...
SMTP Authentication Required<br />
Secure Authentication or SPA needs to be turned off</p><p>Here's an article outlining what to do to troubleshoot your issue:<br />
<a href="http://www.inmotionhosting.com/support/email/email-troubleshooting/problems-sending-mail-receiving-is-fine">Cannot send email but receiving email is fine</a></p><p>If you need further assistance please feel free to contact us.</p><p>Thanks!</p><p>Tim S</p><br />

				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_509').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_509' id='form_comment_on_answer_509' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>I have spent hours trying to figure it out but with your answer it took not even 5 minutes. Thank you sooo much. </div>
							...
							<td style='width:96px;' valign='top'>
								...
								<div class='smallgrey'>
									<a href='/support/community-support/users/MSBC_Secretary'>MSBC_Secretary</a><br />
									3 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2013-11-05 12:45 pm EST
								</div>
				...
				<div style='padding:15px 15px 15px 76px; border:1px solid #ddd; border-top:0px; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Thank you so much, Tim. I had almost given up on this annoying problem until I stumbled across your answer. et voila it works!! Thanks much!</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='/support/images/avatars/default_avatar.jpg' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/username'>username</a><br />
									143 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2014-01-26 11:35 am EST
								</div>
				...
				<div style='padding:15px 15px 15px 76px; border:1px solid #ddd; border-top:0px; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>both didn't work for me. :(</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='https://lh6.googleusercontent.com/-ky-ApK2khJE/AAAAAAAAAAI/AAAAAAAAAzM/GMr6-Kh8iHY/photo.jpg?sz=90' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/clairebear'>clairebear</a><br />
									3 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2015-10-19 4:05 am EST
								</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/email-client-setup/why-do-i-get-outlook-cannot-connect-to-your-outgoing-smtp-email-server&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/email-client-setup/why-do-i-get-outlook-cannot-connect-to-your-outgoing-smtp-email-server'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="0438ee9d83b6053082e09e785d095ec2" value="1" />	</div>
	</form>
<!-- <br />
