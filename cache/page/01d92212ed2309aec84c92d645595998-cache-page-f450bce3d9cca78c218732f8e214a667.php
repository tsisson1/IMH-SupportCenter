<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:51872:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/databases/asp-service-needs-started" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Pheoebus417, Thank you for your question about asp services. We do not have any Microsoft servers within our fleet so they do not use .asp. I do k..." />
  <title>.ASP service needs started | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/databases/asp-service-needs-started" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:2e7ca92ff268aca4daae66433de5ab04 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>.ASP service needs started</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-06-06 6:22 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>100</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I would like to use .asp pages instead of php can have the service turned on. I need to have the service installed and use microsoft .asp pages for  </div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_7400' id='upvote_answer_7400' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='7400' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_7400').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_7400' id='downvote_answer_7400' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='7400' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_7400').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>37,019 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2015-06-08 10:25 am EST
                		        </div>
					
		                </div>

				Hello Pheoebus417,<br />
<br />
Thank you for your question about asp services. We do not have any Microsoft servers within our fleet so they do not use .asp. I do know there are ways to run ASP on Linux servers, but those types of modifications are not supported by us and would need to be done by you. Running ASP on a Linux server also would not give the full effect of running on a Windows server so it is not recommended.<br />
<br />
Kindest Regards,<br />
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_7400').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_7400' id='form_comment_on_answer_7400' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Thank you I appreciate your help. I have another question. I need to have another user to log on to my php admin.  I have created the user how do i connect as this user. I have created databases and the proper user privileges.</div>
...
<br />
The phpmyadmin does not switch users within the cPanel. But if the database has the secondary user added to it you can use a remote connection tool such as Heidi SQL and that will allow them to connect as that specific user.<br />
<br />
Kindest Regards,<br />
Scott M</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/databases/asp-service-needs-started&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/databases/asp-service-needs-started'></div>
<script type='text/javascript'>
  (function() {
