<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:60558:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/frontpage/how-remove-frontpage-extensions" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-09-24T13:29:31-07:00" />
  <meta name="keywords" content="remove uninstall delete frontpage http extensions cpanel interface" />
  <meta name="author" content="Arnel Custodio" />
  <meta name="description" content="The following article explains how to uninstall Frontpage extensions using the Cpanel interface." />
  <title>How to Remove FrontPage Extensions in Cpanel - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/frontpage/how-remove-frontpage-extensions" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:1888e3d272102917eafb37d0bf38a3a8 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-20']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '185.51.74.76']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to Remove FrontPage Extensions in Cpanel									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>3,443</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Apr 2, 2013'><span style='color:#606060;'>Published:</span> Sep 24, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<div>One of the venerable programs for working with webpages using Microsoft software is the program named FrontPage.  The program lets you publish using HTTP or FTP, but in order to publish with HTTP, it required that extensions be installed on the server account.  cPanel accounts can be set to have the extension loaded or removed using the cPanel interface. As time has passed, the need for FrontPage extensions has also faded and in some cases may need to be removed from the installation.  Removing the HTTP extensions still leaves the option of publishing with FTP.  The following article explains how quickly remove these extensions using the cPanel interface.</div>

<h2>Uninstalling the FrontPage Extensions in Cpanel</h2>

<ol class="article_list">
<li><a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">How to log into cPanel</a><div style="clear:both;"></div></li>
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/frontpage/finding-fp-extension-cpanel.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="200" src="//cdn.inmotionhosting.com/support/images/stories/edu/frontpage/finding-fp-extension-cpanel.png" alt="Find the FrontPage Extensions in Cpanel" align="right" ></a>Scroll down to the <strong>ADVANCED</strong> section of the Cpanel.  Click on the FrontPage Extennsions icon that you see there.<div style="clear:both;"></div></li>
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/frontpage/cpanel-fp-exts-list.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="200" src="//cdn.inmotionhosting.com/support/images/stories/edu/frontpage/cpanel-fp-exts-list.png" alt="List of websites in Cpanel with Front Page Extension loaded" align="right" ></a>When the screen loads, you will see the websites that have the FrontPage Extensions loaded.  There will be an option to <strong>REINSTALL EXTENSIONS</strong> or <strong>UNINSTALL EXTENSIONS.</strong> <div style="clear:both;"></div></li>
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/frontpage/uninstalled-extension.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="200" src="//cdn.inmotionhosting.com/support/images/stories/edu/frontpage/uninstalled-extension.png" alt="Uninstalled extension screen" align="right" ></a>To remove the extension, simply click on the <strong>UNINSTALL EXTENSIONS</strong> button next to the domain name that you wish to clear.<div style="clear:both;"></div></li>
  <li>Click on the <strong>GO BACK</strong> button at the bottom of the screen when the uninstall process has finished.<div style="clear:both;"></div></li>
  <li>You will see the same list of the website(s) on your account, but this time with option to <strong>INSTALL EXTENSIONS</strong> and <strong>CLEANUP OLD EXTENSIONS</strong>. The cleanup of the old extensions is not required, but in some cases when you are having problems with the extensions and you are attempting correct issues, then cleaning up the old extension may be your best course of action.<div style="clear:both;"></div></li>
</ol>
This completes the process to remove the FrontPage Extensions.  If you need more information on FrontPage extensions, please check out the article <a href="/support/website/cpanel/how-do-i-install-frontpage-extensions-in-my-control-panel-cpanel">How do I install Frontpage extensions in my control panel (cpanel)?</a> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/frontpage/how-remove-frontpage-extensions&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/frontpage/how-remove-frontpage-extensions'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MCZpZD0yNTczJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="5276b97e98d179a2cfa0c1f9f346a347" value="1" />	</div>
	</form>
<!-- <br />
