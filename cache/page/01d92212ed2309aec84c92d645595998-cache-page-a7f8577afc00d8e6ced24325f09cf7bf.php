<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:43342:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/phplist/sending-messages" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="keywords" content="phplist send sending message messages" />
  <meta name="description" content="This course will explain how message sending is done in phpList." />
  <title>104: Sending messages with phpList | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/phplist/sending-messages" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:fefd8849d7a891f9fcafe048df8e101f -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '212.114.196.82']);
...
<div class='page-header'>
	<h1>104: Sending messages with phpList</h1>
</div>
<div class='section_listing'>
		...
		<tr>
				...
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/phplist/sending-messages/send-test-message'>Sending a test message in phpList</a>
					<div>In this article we'll go over how you can send a test message with phpList. This will help ensure that your phpList installation is properly functioning, and show that it's able to send mail successfully.</div>
					<div class='smallgrey'>Hits: 2,317</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/phplist/sending-messages/rate-limit-sending'>Rate limit the sending of messages in phpList</a>
					<div>In this article we'll discuss how you can rate limit how quickly phpList will attempt to send out your messages.</div>
					<div class='smallgrey'>Hits: 5,137</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/phplist/sending-messages/send-a-message-to-a-list-in-phplist'>Send a message to a list in phpList</a>
					<div>In this article we'll go over how you can send a message to a list in phpList now that you should have a few setup.</div>
					<div class='smallgrey'>Hits: 2,138</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/phplist/sending-messages/handling-bounces'>Handling bounces with phpList</a>
					<div>In this article we'll discuss how phpList handles bounce backs. A bounce back can happen when one of the users you attempt to send a message to does not receive the message, and it bounces back to you with an explanation of why.</div>
					<div class='smallgrey'>Hits: 4,016</div>
				</td>
			</tr>
			</table>
</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMjgmaWQ9MzI4JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="ced0fd3c70646965c3c4cffc3fb7ce66" value="1" />	</div>
	</form>
<!-- <br />
