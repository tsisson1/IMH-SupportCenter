<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:51430:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/file-management/can-not-connect-to-my-site-using-ftp" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hi DavidM, Thanks for posting your question. I'm more than happy to assist you. What settings are you using in FileZilla? What type of encryption method..." />
  <title>Can not connect to my site using FTP | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/file-management/can-not-connect-to-my-site-using-ftp" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:61e66aedcdcfe39bfc25947fe8142c47 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '68.14.202.250']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Can not connect to my site using FTP</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/DavidM'>DavidM</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-03-08 10:31 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>5,441</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I have been connecting to my site for some time as described in &quot;Securely Connecting to your Website using FTP&quot;. I am using FileZilla. Recently I get the following:<br />
<br />
Status:	Resolving address of secure115.inmotionhosting.com<br />
Status:	Connecting to 70.39.146.241:21...<br />
Status:	Connection established, waiting for welcome message...<br />
Response:	220---------- Welcome to Pure-FTPd [privsep] [TLS] ----------<br />
Response:	220-You are user number 25 of 150 allowed.<br />
Response:	220-Local time is now 09:24. Server port: 21.<br />
...
Response:	220 You will be disconnected after 30 minutes of inactivity.<br />
Command:	AUTH TLS<br />
Response:	234 AUTH TLS OK.<br />
...
Status:	Connection established, waiting for welcome message...<br />
Response:	220---------- Welcome to Pure-FTPd [privsep] [TLS] ----------<br />
Response:	220-You are user number 24 of 150 allowed.<br />
Response:	220-Local time is now 09:24. Server port: 21.<br />
Response:	220-This is a private system - No anonymous login<br />
Response:	220-IPv6 connections are also welcome on this server.<br />
Response:	220 You will be disconnected after 30 minutes of inactivity.<br />
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_709' id='upvote_answer_709' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='709' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_709').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_709' id='downvote_answer_709' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='709' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_709').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hi DavidM,<br />
<br />
Thanks for posting your question. I'm more than happy to assist you. What settings are you using in FileZilla? What type of encryption method do you have selected?<br />
<br />
Make sure you are using "Require explicit FTP over TLS". If you still are having issues, please email docs@inmotionhosting.com with the settings you are using in FileZilla so I can attempt to replicate the issue. We will need your exact settings for the host, username, password, port, protocol, etc.<br />
<br />
...
Tim S
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_709').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_709' id='form_comment_on_answer_709' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/file-management/can-not-connect-to-my-site-using-ftp&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/file-management/can-not-connect-to-my-site-using-ftp'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="b4ef624eb3147ac346fc9fb82bc17fae" value="1" />	</div>
	</form>
<!-- <br />
