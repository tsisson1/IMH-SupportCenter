<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:106525:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotion.net/support/email/general-information/transferring-emails-from-your-old-host-to-inmotion-hosting" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-05-02T15:57:17-07:00" />
  <meta name="keywords" content="email migrating new customer transfer what to know when move IMAP backup" />
  <meta name="author" content="null" />
  <meta name="description" content="What to know when moving email from a previous host to InMotion Hosting." />
  <title>Transferring Emails from your old host to InMotion Hosting - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/email/general-information/transferring-emails-from-your-old-host-to-inmotion-hosting" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:c6118122f78012a91935bcbbb446130b -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Transferring Emails from your old host to InMotion Hosting									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>45,637</span></div>
							...
							<div style='clear:both;'></div>
								...
								<p>In this article we'll go over how to move emails from a previous host to InMotion Hosting. If your previous hosting provider uses cPanel, this article will not apply as your emails will be moved over with your full cPanel backup. For more information on performing a website move from a host that also uses cPanel, please see our article: <a href="/support/website/how-to/migrate-your-website-another-host-uses-cpanel">How to migrate your website FROM another host that uses cPanel TO InMotion Hosting</a>.</p>

<h2>How to move your emails from one server to another</h2>
<p>The steps involved will depend on whether or not you use POP3 or IMAP to check emails at your previous host. If you're not sure which connection you use, you can check your email settings in your email client to determine which type of connection you use. Please see our <a href="http://www.youtube.com/v/G4mGw4eGKi8?fs=1&amp;autoplay=1&amp;rel=0" class="fb_youtube">Tools for using email</a> video for more inforamtion on the difference between the two.</p>
<p>Before anything else, you will want to setup your email accounts on your new sever at InMotion hosting. Please see our <a href="/support/edu/everything-email/introduction-email/creating-email-account">Creating an Email Account</a> article for a walk through on creating email accounts.</p>

<h3>POP3</h3>
<p>If you use a POP3 connection when checking emails on your previous host, your emails are downloaded to your local computer. You will not have to follow any steps to move emails as they are already on your computer. You will want to take a look at the section below on how not to lose emails when you point your domain to our Nameservers.</p>

<h3>IMAP</h3>
<p>If you use IMAP when checking emails, you will want to follow the steps outlined in our <a href="/support/edu/everything-email/301-using-thunderbird-to-transfer-emails-between-servers">Using Thunderbird to transfer Emails between servers</a> article for step-by-step instructions. As noted in that article, while we use Thunderbird as an example, what we are really explaining is the process which can be used in other email clients as well.</p>
...
<h2><br />How not to lose emails during propagation time after a Nameserver change</h2>
<p>When you have completed your website migration, the last step is to update your domain's Nameservers. After propagation, emails will be routed to the new server, but during the 4-24 hours it can take for DNS propagation some emails will go to the new servers and some email will go to your old server. Fortunately, we have two recommendations to keep you from missing emails during that time:</p>
<ol>
<li>Before you point your domain to our Nameservers, create a forwarder at your previous host that forwards emails to an email that's not on the same domain you are moving to InMotion Hosting (e.g. gmail, yahoo, hotmail or another domain at which you receive emails).<br /><br /></li>
<li>Check email at your old host using their webmail interface. You will want to make sure you use a temp url or similar url that specifies the server name in the url instead of example.com/webmail or webmail.example.com.</li>
</ol>

<h2>Modifying your MX Records</h2>
<p>Some people use third party companies for their email and thus will not be pointing to our nameservers for email services. If this is your case, you will want to make sure that your <a href="/support/edu/cpanel/cpanel-email/modfying-mx-records">MX records are properly pointing</a> before <a href="/support/domain-names/dns-nameserver-changes/updating-your-domains-nameservers">pointing your domain name to our nameservers</a>.
</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotion.net/support/email/general-information/transferring-emails-from-your-old-host-to-inmotion-hosting&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotion.net/support/email/general-information/transferring-emails-from-your-old-host-to-inmotion-hosting'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="418d81308c9f17deb14e25a85ee45341" value="1" />	</div>
	</form>
<!-- <br />
...
<a name='comments'></a>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/6e7d47648da633e1857c52a9eb14882a?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/6e7d47648da633e1857c52a9eb14882a'>Dede Chism</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-07 3:35 am</div>
				                <div><p>i changed my domain name on in motion hosting and now can't forward my old emails</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8819);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-07 10:17 am</div>
				                <div>Upon changing your primary domain, any information under your old domain will then be replaced with the new domain.  To use services on the old domain, you will need to add the old domain as an &lt;a href=&quot;http://www.inmotionhosting.com/support/edu/cpanel/cpanel-manage-domains/adding-add-on-domain-in-cpanel&quot;&gt;addon domain&lt;/a&gt; to cPanel.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8826);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-13050'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/180aadef70c85c54006a371f18de53a9?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/180aadef70c85c54006a371f18de53a9'>jackie</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-20 6:55 am</div>
				                <div>i dont know that answer,im living in omaha nebraska and id like to get my emails from an email i had in texas<br />
</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13050);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-21 2:00 pm</div>
				                <div>Hello Jackie,<br />
<br />
Have you attempted the instructions above? If so, where did you get stuck? We would like to help but simply need more information.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13106);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-18604'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/0bfb957a98e889497d312324d044c03a?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/0bfb957a98e889497d312324d044c03a'>Paul</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-17 11:45 am</div>
				                <div>I think this can be improved by speaking &quot;non-tech&quot; talk for us non techies.  I was lost in the first sentence when I read cPanel...never seen one, never heard of one, don't know where to find one, and even if I did find it I'd not know what to do with it.  Unfortunately, my knowledge of the computer goes no deeper than turning it on, and using it...nothing on the &quot;back end&quot; or behind the scenes, or anything technical.  So I was totally lost...POP3 and IMAP...holy cow!  Anyway, you get the idea...way too technical for me to understand.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(18604);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-22845'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/12a7af8b092784421cf03b5fec2a477f?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/12a7af8b092784421cf03b5fec2a477f'>Elaine</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-21 6:18 pm</div>
				                <div><p>Is there a way to transfer sent mail? &nbsp;I'm moving clients to my dedicated server, and they can download the incoming by setting up a POP account; but if they've been using webmail for their account, their sent mail will stay on the server. &nbsp;Any way to get that exported?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22845);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-21 7:10 pm</div>
				                <div>Hello Elaine,<br />
<br />
Thank you for contacting us. Since webmail is just an IMAP client, setup outlook as IMAP and you can view/access all the folders.<br />
<br />
Then just drag the folders/emails to backup folders.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22847);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-22968'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/f5099d18dcf7b716e16e110b9535c8a9?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/f5099d18dcf7b716e16e110b9535c8a9'>Ruben Ardila</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-27 6:30 am</div>
				                <div><p>I am trying to transfer my email address from my old host www.dentistidentity.com to inmotion, what do I need to do?...do I have to have a transfer code? I am not clear what to do...</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22968);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-27 4:54 pm</div>
				                <div>Hello Ruben,<br />
<br />
The article above explains how to transfer email from your old hosting account to your one here with us. We are happy to explain any step you may need more clarification on, just let us know where that is.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23000);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						...
						<div><a style='font-size:16px;' href='/support/community-support/users/jennlandrum@supplylink&per;us'>jennlandrum@supplylink.us</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-05-29 3:41 pm</div>
				                <div>I switched my email from old host to new and followed the instructions but lost ALL my emails!!<br />
</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23815);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-05-29 4:09 pm</div>
				                <div>Hello Jenn,<br />
<br />
Are your emails still on your old server? This method simply downloads the emails to the new server, some systems will remove the emails from the origin server but they will be on the destination server.<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23816);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-25632'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/e0bd03defe4c1dab26e3703a87091747?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/e0bd03defe4c1dab26e3703a87091747'>MAJ</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-10 11:17 am</div>
				                <div><p>I have migrated emails to my new account with Inmotion; how do I migrate emails from all the different folders?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25632);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-10 12:36 pm</div>
				                <div>Hello Maj,<br />
<br />
When you migrate the email folders, the subfolder should come along with them. <br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25636);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-26971'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/a076fc8ab5bc31e27b63c18953940970?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/a076fc8ab5bc31e27b63c18953940970'>Brad</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-25 8:34 pm</div>
				                <div><p>What happens to ALL my EXISTING Folders and emails that are in Outlook 2010 and i've had for years. I was under the impretion they were stored on my PC because i could access all those old emails even when i had no internet access.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26971);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-27 2:27 pm</div>
				                <div>Hello Brad,<br />
<br />
If you are you using POP then those folders will stay in your Outlook even after changing the server settings.<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26991);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/aff8784b483558e1815c843f7a029106?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/aff8784b483558e1815c843f7a029106'>mike</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-30 12:07 pm</div>
				                <div><p>I am moving websites to you guys and emails. How do I add new emails if the domain name is not listed in dropdown? I am keeping domain name with another host. Am I suppose to AddOn Domains for this?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27085);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-01 10:07 am</div>
				                <div>Hello Mike,<br />
<br />
Thanks for the question.  Yes, when you add the domain as an add-on domain, it adds the DNS entries, and creates the mail account to which you can add your email addresses.  If you're not familiar with adding an add-on domain, check out:  <a href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-manage-domains/adding-addon-domains-in-cpanel">How to add an Add-on domain in cPanel</a>.<br />
<br />
If you have any further questions or comments, please let us know.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27119);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-31228'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/3d03006a80a06adc9210dc4ef9091fa9?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/3d03006a80a06adc9210dc4ef9091fa9'>Patrick McCabe</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-14 10:29 pm</div>
				                <div><p>Hello,</p>
<p>I was attempting to move emails from my former hosting service (HostGator) to InMotion. &nbsp;I didn't want to do the cPanel backup / restore method for several reasons. The IMAP option looked good but I made the mistake of changing the account information in Outlook rather than setting up a new account. &nbsp;That process deleted all the emails in Outlook. &nbsp;When I tried changing the settings back to HostGator IMAP, Outlook would "see" the new emails but none of the old emails. &nbsp;I checked HostGator webmail and all the emails are still there. &nbsp;HostGator uses Squirrel Mail, Horde, and Roundcube for webmail interfaces. &nbsp;I tried setting up Outlook on a different PC as described in the IMAP instructions but unfortunately, the emails that were previously downloaded (and deleted) on my PC would still not download.</p>
<p>Essentially, I'm looking for the easiest way to move the emails from HostGator to InMotion and I'm not sure if I should try to export the emails using Horde (or one of the other webmail services) and then import them into InMotion - or what exactly.</p>
<p>Can you suggest a method with details on moving emails from HostGator to InMotion given this information?</p>
<p>Thank you.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31228);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-15 9:43 am</div>
				                <div>The above IMAP transfer method is what I would do if I were in your position. If you're having trouble with Outlook, you can try using <a href="http://www.inmotionhosting.com/support/edu/everything-email/301-using-thunderbird-to-transfer-emails-between-servers">Thunderbird</a>. I recently tested this method with two mailboxes on different servers. Thunderbird alllows you to set up two IMAP accounts easily and manually transfer the messages you need to save.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31243);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-16 9:02 pm</div>
				                <div><p>Hi Christopher,</p>
<p>I installed Thunderbird and did the process as described. &nbsp;I ran into the same issue which is that Thunderbird (and Outlook) see the new messages, but they do not see old messages. &nbsp;Allow me to clarify a little.</p>
<p>When I initially did the IMAP process in Outlook, all the emails sitting on HostGator were viewable in Outlook. &nbsp;Rather than doing it correctly by setting up a new account, I mistakingly just changed the settings in Outlook to look for mail at the same email account at InMotion - and because there were no email messages residing on the InMotion server, then Outlook proceeded to delete the messages in Outlook. &nbsp;Since that time, and even though I can see the messages at HostGator by using webmail, neither Outlook nor Thunderbird can see those messages so it seems I'm unable to move the messages using this IMAP process because this process relies on the email client seeing the messages.</p>
<p>In an effort to solve this "moving mail problem, I logged into HostGator webmail and used Horde to export the email to an .mbox file, and then I logged into webmail on InMotion and used Horder to import the email. &nbsp;It worked but the emails are unusable. &nbsp;There is no header information (to, from, date, subject, etc.). &nbsp;And the messages that have HTML in them, all you see is the HTML.</p>
<p>So considering this dillemma, that Outlook/Thunderbird don't seem to "see" the old messages but the messages are clearly on the server, do you have any suggestions for moving the messages from my old hosting company?</p>
<p>Thanks much!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31280);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-17 8:26 am</div>
				                <div>Hi Patrick, the issue is that IMAP connections only grab a copy of whats on the server. You're trying to connect to two "different" email accounts (while they have the same email, they are separate becuase they are on different servers. You can set up a connection to BOTH email accounts (name them something different but use the same email). Then once the old account is finished, drag that inbox from Hostgator into your inbox with InMotion. This will place all the emails from Hostgator into your inbox with us. I hope this helps. Keep in mind, depending on how many emails there are it could take quite a long time to drag the folders into the new inbox. Thanks!<br />
</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31297);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-31528'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/d66fc1df98e831d9c4ed7512fb2dbe99?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/d66fc1df98e831d9c4ed7512fb2dbe99'>Sarah Burke</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-29 8:10 am</div>
				                <div><p>Preparing to transfer email from old host to InMotion. &nbsp;I don't understand this instruction: &nbsp;</p>
<ol style="padding: 0px; margin: 0px 0px 11px 25px; color: rgb(35, 35, 35); font-family: adelle-sans, Helvetica, Arial, sans-serif; font-size: 13px;">
<li style="line-height: 22px;">Check email at your old host using their webmail interface. You will want to make sure you use a temp url or similar url that specifies the server name in the url instead of yourdomain.com/webmail or webmail.yourdomain.com. &nbsp;</li>
</ol>
<p>Please explain how I create a temp url. &nbsp;Thanks.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31528);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-29 9:42 am</div>
				                <div>TEMP URL is an abbreviated term for "temporary URL", and it is basically a direct link to your account on the server. This link should be provided by your host. If you have a hosting account with us you can check your TEMP URL in your Account Management Panel under Account Technical Details.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31531);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
