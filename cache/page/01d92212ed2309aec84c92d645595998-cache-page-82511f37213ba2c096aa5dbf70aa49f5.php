...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/wordpress/wordpress-introduction" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="keywords" content="wordpress introduction getting started enflatewordpress" />
  <meta name="description" content="Learn the basics of WordPress. Discover what WordPress is, how to install it, and the different types of sites you can build." />
  <title>101: An introduction to WordPress | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/wordpress/wordpress-introduction" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:40c059ddda663d8961ad000baf4c997c -->
...
<div class='page-header'>
	<h1>101: An introduction to WordPress</h1>
</div>
<div class='section_listing'>
		<table>
	<tr><td colspan='3'><h2>About WordPress</h2></td></tr>	<tr>
			...
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/wordpress/wordpress-introduction/what-kind-of-website-can-i-build-with-wordpress'>What kind of website can I build with WordPress?</a>
					<div>WordPress is completely customizable and there is no limit to what type of website you can create using WordPress.  </div>
					<div class='smallgrey'>Hits: 26,751</div>
				</td>
			</tr>
			<tr>
		...
		<tr><td colspan='3' style='padding-top:20px;'><h2>Installing Wordpress</h2><div>There's more than one way to install WordPress.</div></td></tr>	<tr>
			...
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/wordpress/wordpress-introduction/installing-wordpress-manually'>How to Install WordPress Manually</a>
					<div>How to install WordPress manually. (Walk-through guide)</div>
					<div class='smallgrey'>Hits: 10,232</div>
				</td>
			</tr>
			<tr>
		...
		<tr><td colspan='3' style='padding-top:20px;'><h2>Managing WordPress content</h2></td></tr>	<tr>
			...
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/wordpress/wordpress-introduction/wordpress-hyperlink'>Creating a link in Wordpress</a>
					<div>Linking to other sites and posts is very common and almost necessary when creating a site. This article will show you how to do that in Wordpress.</div>
					<div class='smallgrey'>Hits: 8,138</div>
				</td>
			</tr>
		<tr><td colspan='3' style='padding-top:20px;'><h2>Managing users</h2></td></tr>	<tr>
			...
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/wordpress/wordpress-introduction/creating-a-wordpress-user'>How to Create a Wordpress User in the Dashboard</a>
					<div>This is a guide on how to create a new user in the Wordpress Dashboard.</div>
					<div class='smallgrey'>Hits: 3,947</div>
				</td>
			</tr>
			</table>
</div>
