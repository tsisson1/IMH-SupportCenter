<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49968:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/domain-names/i-changed-the-primary-domain-then-changed-it-back" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, Sorry to hear you're having problems with the domain name. The main issue is what is known as domain propagation. When you change a domain name, ..." />
  <title>Changed the primary domain and then changed it again | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/domain-names/i-changed-the-primary-domain-then-changed-it-back" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:01f2c38ed519d9cbdf650982125e4eca -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '165.231.83.79']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Changed the primary domain and then changed it again</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-10-07 3:30 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>594</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Now neither domain name is working. How long does it take for this to be in effect? The first change was instant. Is there something else I need to do to get this back? The Domain panel is showing the correct url as the primary domain.</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_4078' id='upvote_answer_4078' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='4078' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_4078').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_4078' id='downvote_answer_4078' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='4078' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_4078').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
Sorry to hear you're having problems with the domain name.  The main issue is what is known as <a href="http://www.inmotionhosting.com/support/domain-names/general-information/how-do-i-change-the-main-domain-name-on-my-account"  target="new">domain propagation</a>.  When you change a domain name, it can typically take up to 24 hours for the name to be updated on the internet servers.  Since you changed it once, the propagation probably occurred quickly, but then you changed it back, and the request to change has happened again - requiring the servers to update again.  The update -like all DNS updates - require up to 24 hours before you see it take effect.  <br />
<br />
Apologies again for the confusion - please let us know if you have any further questions or comments.<br />
<br />
Regards,<br />
Arnel C.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_4078').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_4078' id='form_comment_on_answer_4078' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/domain-names/i-changed-the-primary-domain-then-changed-it-back&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/domain-names/i-changed-the-primary-domain-then-changed-it-back'></div>
<script type='text/javascript'>
  (function() {
