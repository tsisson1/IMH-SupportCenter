<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:63710:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.us/support/edu/prestashop-15/working-with-info-pages/add-store-location" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-08-29T17:56:10-07:00" />
  <meta name="keywords" content="add store location PrestaShop 1.5" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="This article shows you how to add additional store locations to PrestaShop 1.5" />
  <title>Adding store locations in PrestaShop 1.5 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/prestashop-15/working-with-info-pages/add-store-location" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:5a4f0ebc88b52524310a354ec05f8e35 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '66.249.65.54']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Adding store locations in PrestaShop 1.5									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>5,073</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jun 8, 2012'><span style='color:#606060;'>Published:</span> Aug 29, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>If you have more than one physical store, you may want to let your customers know where they are. PrestaShop has a management section where you can add these locations in one master list. To add a store location to the list in your PrestaShop 1.5 store, simply perform the following steps.</p>
<p><strong>To add a a store to the location list in PrestaShop 1.5:</strong></p>
<ol class="article_list">
<li><a href="/support/edu/prestashop-15/getting-started/login-to-dashboard">Log into your PrestaShop 1.5 dashboard.</a></li>
<li>Using the top menu bar, hover over the <strong>Preferences </strong>tab and select the <strong>Store Contacts</strong> option from the menu.</li>
<li>You will now be on the <strong>Store Contacts</strong> page. Click on the green <strong>Add New</strong> button.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Preferences/stores/preferences-stores-add-store.png"><img  alt="preferences-stores-add-store" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Preferences/stores/preferences-stores-add-store.png" /></a></li>
<li>From here you will be able to add all the details of the store location. The required fields are <strong>Address, Zip, City, Country, and State</strong>. A good <strong>Name </strong>will also help your customer identify it on the list. <br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Preferences/stores/preferences-store-add-data.png"><img  alt="preferences-store-add-data" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Preferences/stores/preferences-store-add-data.png" /></a></li>
<li>When finished, click on the <strong>Save </strong>button found in the upper right corner. Your new location will now appear in the Store location list.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Preferences/stores/preferences-stores-add-complete.png"><img  alt="preferences-stores-add-complete" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Preferences/stores/preferences-stores-add-complete.png" /></a></li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 4: Adding store locations in PrestaShop 1.5</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 5: <a href='/support/edu/prestashop-15/working-with-info-pages/edit-store-location'>Editing store location information in PrestaShop 1.5 </a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.us/support/edu/prestashop-15/working-with-info-pages/add-store-location&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.us/support/edu/prestashop-15/working-with-info-pages/add-store-location'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP3RzcmM9cnNiZWR1Jm9wdGlvbj1jb21fY29udGVudCZjYXRpZD0yMzcmaWQ9MTQyOCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="488a38c1d2b461427712dc8fd9992c65" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
        ...
        <tr><td colspan='2'><h4>Store Locations</h4></td></tr>  <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>4.</td>
