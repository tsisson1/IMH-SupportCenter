<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:81342:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/website-design/using-php-and-mysql/database-setup" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-02-07T20:00:04-08:00" />
  <meta name="keywords" content="phpmyadmin create database table" />
  ...
  <title>Setting up a database to handle form data from a website - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/website-design/using-php-and-mysql/database-setup" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<script type="text/javascript">
		...
		_gaq.push(['_setCustomVar', 3, 'DateMonthModified', '2012-02', 3]);
	...
	<!-- cid:24d23935abd8dbce44b119ed52bf3e0e -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '76.116.77.180']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Setting up a database to handle form data from a website									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>81,450</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 25, 2012'><span style='color:#606060;'>Published:</span> Feb 7, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In <a href="/support/edu/website-design/using-php-and-mysql">this tutorial series</a>, we are going to create a website at PHPandMySQL.inmotiontesting.com. This website is going to have 2 pages, and each page is going to allow for comments.</p>
...
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/phpmysql/create-a-database-using-wizard.gif"><img  alt="create-a-database-using-wizard" src="//cdn.inmotionhosting.com/support/images/stories/website/phpmysql/create-a-database-using-wizard.gif" /></a></p>
...
<li>On the right side of the page under "Create new table on database", enter "comments" as the name and 7 as the number of fields and click "Go"<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/phpmysql/create-a-new-table-for-user-comments.gif"><img  alt="create-a-new-table-for-user-comments" src="//cdn.inmotionhosting.com/support/images/stories/website/phpmysql/create-a-new-table-for-user-comments.gif" /></a></li>
...
<p><strong>Field:</strong> id<br /><strong>Type</strong>: INT<br /><strong>A_I:</strong> (put a check in the box)<br />To help manage individual comments, for example to delete one, we want to assign a specific id number to each comment.</p>
<p><strong>Field:</strong> name<br /><strong>Type:</strong> VARCHAR<br /><strong>Length/Values:</strong> 60</p>
<p><strong>Field:</strong> email<br /><strong>Type:</strong> VARCHAR<br /><strong>Length/Values:</strong> 60</p>
<p><strong>Field:</strong> website<br /><strong>Type:</strong> VARCHAR<br /><strong>Length/Values:</strong> 60</p>
<p><strong>Field:</strong> comment<br /><strong>Type:</strong> TEXT</p>
<p><strong>Field:</strong> timestamp<br /><strong>Type:</strong> TIMESTAMP<br /><strong>Default:</strong> CURRENT_TIMESTAMP</p>
<p><strong>Field:</strong> articleid<br /><strong>Type:</strong> INT<br />Each comment needs to belong to a specific article, otherwise we wouldn't know which comments to display for which pages.<br /><br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/phpmysql/setting-specific-details-for-the-table.gif"><img  alt="setting-specific-details-for-the-table" src="//cdn.inmotionhosting.com/support/images/stories/website/phpmysql/setting-specific-details-for-the-table.gif" /></a></p>
</div>
</li>
<li>After you have filled in the details above, click "Save"<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/phpmysql/our-comments-table-has-been-successfully-created.gif"><img  alt="our-comments-table-has-been-successfully-created" src="//cdn.inmotionhosting.com/support/images/stories/website/phpmysql/our-comments-table-has-been-successfully-created.gif" /></a></li>
</ol>
<p>Congratulations, as this point we have successfully created our database and setup our table! In our next article, we'll show you <a href="/support/edu/website-design/using-php-and-mysql/create-html-form">how to create a form using HTML</a> that asks the user for their comment.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 2: Setting up a database to handle form data from a website</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 1: <a href='/support/edu/website-design/using-php-and-mysql/how-to-create-a-custom-php-contact-form'>How to create a custom PHP contact form with validation</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 3: <a href='/support/edu/website-design/using-php-and-mysql/create-html-form'>Creating a simple HTML Form to get user comments</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xNjAmaWQ9MTEzMCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="eef7e3029d5360eaa897f24439567995" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='https://lh3.googleusercontent.com/-vgIlQyV2920/AAAAAAAAAAI/AAAAAAAAABc/gswPRWboVeA/photo.jpg?sz=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='/support/community-support/users/seoconsultant'>seoconsultant</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-08-22 3:26 am</div>
				                <div>Hi Brad,<br />
Thanks for the share, and actually I was really impressed with the way you made it look so simple with all those pics! I was just about to hire some web developers for this task and here your blog came to my rescue and saved me some bucks :).</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8132);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-15387'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/4ede3d4117121de4e36ec3cbf7306d8e?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/4ede3d4117121de4e36ec3cbf7306d8e'>asiskumar</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-23 5:53 am</div>
				                <div><p><span style="color: #3f4549; font-family: Georgia, Times, serif; font-size: 15px; line-height: 21px;">I doubt I can just set them as an admin and myself as a subscriber and be done with it,</span></p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15387);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-23 9:16 am</div>
				                <div>Hello asiskumar,<br />
<br />
Thank you for contacting us. Indeed there is most likely more to the setup. We are happy to help with any specific questions, or steps you are having problems with.<br />
<br />
This guide is part of our full class on <a href="http://www.inmotionhosting.com/support/edu/website-design/using-php-and-mysql">Using PHP to create dynamic pages</a>.<br />
<br />
If you have any further questions, feel free to post them below.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15404);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-16313'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/23514b6a91b9eb057bd88906a2829f4e?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/23514b6a91b9eb057bd88906a2829f4e'>Bob Gaudreau</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-15 4:20 pm</div>
				                <div>Looks A-OK to me</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16313);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-19750'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/471fc404915cbde6c4f91d11b69b3bdb?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/471fc404915cbde6c4f91d11b69b3bdb'>savenhero</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-20 6:03 am</div>
				                <div><p>http://www.******help.com/contactus.html</p>
<p>This is my website, please guide me it's working fine, but the issue is, mail is not coming in proper format, I want to get the mail from any enquiry in table format.</p>
<p>How does it possible. Please guide me..&nbsp;</p>
<p>Many Thanks in Advance</p>
<p>Saven</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19750);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-20 9:24 am</div>
				                <div>To clarify, do you want the contents of the message itself to be within a table?  To do so, you would need to create a table within your code and dynamically insert your field content with PHP.  We cannot provide exact code to do so, but that should give you the general idea of what you need to do.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19760);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-19820'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/eb0922592422ce7ae621d5bc403f003d?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/eb0922592422ce7ae621d5bc403f003d'>Jay McDonough</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-22 12:35 pm</div>
				                <div>Nothing to improve! It's straight to the point and very helpfull.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19820);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-22 12:37 pm</div>
				                <div><p>Web development isn't that dificult with resources like this available.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19821);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-20948'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/47f9f4893e09dab9ef5d1fbf2e6647b3?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/47f9f4893e09dab9ef5d1fbf2e6647b3'>Hais</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-22 8:36 pm</div>
				                <div><p>Hey, how does that work, can I use a plugin to wp to this?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20948);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-23 11:29 am</div>
				                <div>Hello Hais,<br />
<br />
Thanks for the question.  Yes, there are many form plugins available on WordPress that can make this process much easier.  Please go to Wordpress.org and do a search in their plugins section for further details.<br />
<br />
Kindest regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20968);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-24 2:46 pm</div>
				                <div><p style="text-align: justify;">Thank you guy's very much! This was very</p>
<p>helpful and as someone said, in my own words, <strong>PICTURES in tutorials ROCK!</strong></p>
<p>Thanks again, Scott</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30078);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
