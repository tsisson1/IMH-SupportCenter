<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:75318:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/oscommerce/testing-ecommerce-functionality/setting-up-smtp-with-oscommerce" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-04-21T23:02:34-07:00" />
  <meta name="keywords" content="OsCommerce SMTP email" />
  ...
  <link href="http://www.inmotionhosting.com/support/edu/oscommerce/testing-ecommerce-functionality/setting-up-smtp-with-oscommerce" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:0d7058dd908bbb0a0896fc252a050aec -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '41.225.233.248']);
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/oscommerce' itemprop='url'><span itemprop='title'>osCommerce<span></a><div class='dropdown_4columns'><h2>osCommerce Education Channel</h2><div class='col_2'><h3>100 Level Classes</h3><div><a href='/support/edu/oscommerce/new-store'>101: Getting Started with osCommerce</a></div><div><a href='/support/edu/oscommerce/adding-products-content'>102: Adding products and content to osCommerce</a></div><div><a href='/support/edu/oscommerce/config-tax-payment-shipping'>103: Configuring Taxes and Shipping in osCommerce</a></div><div><a href='/support/edu/oscommerce/payment-gateway-configuration'>104: osCommerce payment gateway configuration</a></div><div><a href='/support/edu/oscommerce/testing-ecommerce-functionality'>105: Testing the osCommerce site</a></div></div><div class='col_2'><h3>200 Level Classes</h3><div><a href='/support/edu/oscommerce/change-theme-template-appearance'>201: Changing your osCommerce appearance</a></div><div><a href='/support/edu/oscommerce/manage-users-administrators'>202: Managing Users in osCommerce</a></div><div><a href='/support/edu/oscommerce/add-security-addons'>203: Adding security to osCommerce</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/oscommerce/testing-ecommerce-functionality' itemprop='url'><span itemprop='title'>105: Testing the osCommerce site<span></a><div class='dropdown_3columns'><h2> Testing the osCommerce site</h2><div class='col_3'><div>1. <a style='display:inline;' href='/support/edu/oscommerce/testing-ecommerce-functionality/setting-up-smtp-with-oscommerce'>Setting up SMTP with osCommerce</a></div><div>2. <a style='display:inline;' href='/support/edu/oscommerce/testing-ecommerce-functionality/oscommerce-sending-out-email'>Sending out email in osCommerce Video</a></div><div>3. <a style='display:inline;' href='/support/edu/oscommerce/testing-ecommerce-functionality/oscommerce-backing-up-and-restoring-your-database'>Backing up and restoring your database in osCommerce Video</a></div><div>4. <a style='display:inline;' href='/support/edu/oscommerce/testing-ecommerce-functionality/how-to-upgrade-oscommerce'>How to upgrade osCommerce</a></div><div>5. <a style='display:inline;' href='/support/edu/oscommerce/testing-ecommerce-functionality/locate-db-name'>How to find your database name in osCommerce</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Setting up SMTP with osCommerce</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Setting up SMTP with osCommerce									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>16,761</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Aug 26, 2011'><span style='color:#606060;'>Published:</span> Apr 21, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<p>OsCommerce supports the use of SMTP to send email, but does not allow specification of a username and password for outgoing authentication, which is required when sending mail from our servers.</p>
<p> </p>
...
<p> </p>
<p>Email Line Feels: <strong>LF</strong><br />Use MIME EMail when sending email: <strong>YES</strong><br />Verify E-Mail Addresses Through DNS&nbsp;: <strong>FALSE</strong><br />Use MIME HTML When Sending Emails: <strong>FALSE</strong></p>
...
<h2><br />To install phpMailer:</h2>
<p><br />1.<a href="/support/email/send-email-from-a-page/download-phpmailer"> Download a copy of phpMailer</a></p>
<p><br />2. There are two files,&nbsp;<strong>class.phpmailer.php</strong> and&nbsp;<strong>class.smtp.php</strong>. Open the FTP site to the OScommerce installation, then upload them both into these folders:</p>
<div><br /> <strong>.../admin/includes/classes</strong><br /><strong>.../includes/classes/</strong></div>
<p>3. There are two files in OsCommerce that you need to edit:</p>
<p> </p>
<p><strong>.../includes/classes/email.php </strong><br /><strong>.../admin/includes/classes/email.php</strong></p>
<p>In the email.php file, locate this section: (line 519)</p>
<div class="code_block"><br /><strong> if (EMAIL_TRANSPORT == 'smtp') {</strong><br /><strong> return mail($to_addr, $subject, $this-&gt;output, 'From: ' . $from . $this-&gt;lf . 'To: ' . $to .   $this-&gt;</strong> <strong>lf . implode($this-&gt;lf, $$</strong><br /><strong> } else {</strong><br /><strong> return mail($to, $subject, $this-&gt;output, 'From: '.$from.$this-&gt;lf.implode($this-&gt;lf, $this-&gt;headers).$this-&gt;lf.implode($this$</strong><br /><strong> }</strong><br /><strong> }</strong></div>
<p><br />You'll need to comment out some of these lines, so they look like this:</p>
...
<p><a href="http://www.v-nessa.net/imh_files/email.phps">http://www.v-nessa.net/imh_files/email.phps</a></p>
<div></div> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/oscommerce/testing-ecommerce-functionality'>105: Testing the osCommerce site</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 1: Setting up SMTP with osCommerce</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 2: <a href='/support/edu/oscommerce/testing-ecommerce-functionality/oscommerce-sending-out-email'>Sending out email in osCommerce Video</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/oscommerce/testing-ecommerce-functionality/setting-up-smtp-with-oscommerce&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/oscommerce/testing-ecommerce-functionality/setting-up-smtp-with-oscommerce'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zNzQmaWQ9NTcmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="d6b9453224f54eba70453109b20da732" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/oscommerce/testing-ecommerce-functionality?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Testing the osCommerce site</h3></a>
		<table>  <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/oscommerce/testing-ecommerce-functionality/setting-up-smtp-with-oscommerce?tsrc=rsbedu'>Setting up SMTP with osCommerce</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/oscommerce/testing-ecommerce-functionality/oscommerce-sending-out-email?tsrc=rsbedu'>Sending out email in osCommerce Video</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/oscommerce/testing-ecommerce-functionality/oscommerce-backing-up-and-restoring-your-database?tsrc=rsbedu'>Backing up and restoring your database in osCommerce Video</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/oscommerce/testing-ecommerce-functionality/how-to-upgrade-oscommerce?tsrc=rsbedu'>How to upgrade osCommerce</a></td>
                </tr>
          <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/oscommerce/testing-ecommerce-functionality/locate-db-name?tsrc=rsbedu'>How to find your database name in osCommerce</a></td>
                </tr>
          	</table>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/2b8aed2fc94bff5da398e8686951ff6a?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/2b8aed2fc94bff5da398e8686951ff6a'>neomobil</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-28 10:51 am</div>
				                <div><p>In the second line of the Paste in code there is a mistake.</p>
<p><strong style="font-family: 'Courier New', Courier, monospace; font-size: 12px; line-height: 22px; white-space: nowrap;">$pMail = new PHPMailer(); &gt;$pMail-&gt;From = $from_addr;</strong></p>
<p><strong style="font-family: 'Courier New', Courier, monospace; font-size: 12px; line-height: 22px; white-space: nowrap;">should be changed to </strong></p>
<p><strong style="font-family: 'Courier New', Courier, monospace; font-size: 12px; line-height: 22px; white-space: nowrap;">$pMail = new PHPMailer(); </strong></p>
<p><strong style="font-family: 'Courier New', Courier, monospace; font-size: 12px; line-height: 22px; white-space: nowrap;">$pMail-&gt;From = $from_addr;</strong><strong style="font-family: 'Courier New', Courier, monospace; font-size: 12px; line-height: 22px; white-space: nowrap;">&nbsp;</strong></p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13403);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-23565'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/9eb1829c5ff946d812693519df3620ef?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/9eb1829c5ff946d812693519df3620ef'>zdub</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-05-20 10:35 am</div>
				                <div><p>YES, PLEASE FIX YOUR POST! I only saw the comment correction above after installing &amp; getting a errror due to the extraneous right angle bracket!!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23565);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-05-21 10:49 am</div>
				                <div>Hello Zdub,<br />
<br />
It's been fixed!  If you have any further questions or comments, please let us know.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23586);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-23676'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/264bdb8ad164b65d328e5987950c5fd4?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/264bdb8ad164b65d328e5987950c5fd4'>Ranjit</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-05-26 1:43 am</div>
				                <div><p>Hi There,</p>
<p>I configured smtp with phpmailer and also it works but in some case(not regularaly) it giving following error.</p>
<p>&nbsp;</p>
<p>SMTP Error: Could not authenticate. </p>
<p>Please help me.</p>
<p>&nbsp;</p>
<p>Thanks!!!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23676);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-05-27 12:51 am</div>
				                <div>Hello Ranjit,<br />
<br />
I found a <a href="http://forums.oscommerce.com/topic/94340-smtp-authentication-and-oscommerce/<br />
">forum thread</a> from OS Commerce's website of someone who had a fairly similar issue. Please check it out as it should be able to help your situation.<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23726);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-30184'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/11dd0516df568fdc2557f1d40e44ecff?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/11dd0516df568fdc2557f1d40e44ecff'>Kookie</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-28 8:36 am</div>
				                <div><p>Hello!</p>
<p>I applied the SMTP tweak. Works fine!</p>
<p>Except one thing: the admin normally got an copy of any order confirmation but not anymore.</p>
<p>I edited only the email.php class file and uploaded the main smtp class files from the "package".</p>
<p>&nbsp;</p>
<p>any idea?</p>
<p>Thank you.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30184);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-29 8:54 am</div>
				                <div>This would be hard to diagnose without seeing what you've changed. Sorry, wish we could be more help. </div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30223);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-02-01 7:53 am</div>
				                <div><p>I added a BCC to the mail logic and it works now alltough admin gets the same mail twice now...</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30277);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
