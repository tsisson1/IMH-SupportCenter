<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:81090:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/modsecurity/find-and-disable-specific-modsecurity-rules" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-08-15T18:56:41-07:00" />
  <meta name="keywords" content="disable find modsecurity mod_security domain specific rule rules" />
  <meta name="author" content="Jacob Nicholson" />
  <meta name="description" content="In this article I'm going to discuss how to find and disable specific ModSecurity rules that might be causing 406 errors on your websites on either your VPS (Virtual Private Server) or dedicated server. The rules that ModSecurity uses can help block potential attack attempts from malicious users, but sometimes it can also block legitimate requests, and knowing how to go in and find what rules are getting triggered and how to disable them can be handy." />
  <title>Find and disable specific ModSecurity rules - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/modsecurity/find-and-disable-specific-modsecurity-rules" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:cb0c80cca1ce8b06cb5834bc58442ba2 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Find and disable specific ModSecurity rules									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>35,246</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Feb 8, 2013'><span style='color:#606060;'>Published:</span> Aug 15, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In this article I'm going to discuss how to find and disable specific ModSecurity rules that might be causing 406 errors on your websites on either your VPS (Virtual Private Server) or dedicated server. The rules that ModSecurity uses can help block potential attack attempts from malicious users, but sometimes it can also block legitimate requests, and knowing how to go in and find what rules are getting triggered and how to disable them can be handy.</p>

<p><a name="disable-modsec"></a>This article is going to assume that you already know how to enable a ModSecurity configuration file for your domain which is discussed in my previous article about how to <a href="/support/website/website-troubleshooting/disable-modsecurity-for-a-domain" target="_blank">disable ModSecurity for a domain</a>. However when you get to the part talking about using&nbsp;<strong>SecRuleEngine Off</strong> you won't want to put that in your ModSecurity configuration file. As that completely turns off ModSecurity, in this article we'll discuss using the&nbsp;<strong>SecRuleRemoveById</strong> setting instead to only disable one specific rule.</p>

<p class="&quot;alert">In order to follow along with this guide you'll need <a href="/support/website/general-server-setup/root-access-faq" target="_blank">root access</a> to either your VPS or dedicated server so that you have full access to modify your Apache configuration, and to create the ModSecurity configuration file.</p>
<h2>Find ModSecurity rules getting triggered</h2>

<p>Following the steps below I'll show you how you can use the Apache error log in order to determine what ModSecurity errors are being triggered on your websites.</p>

<ol class="article_list">
<li><a href="/support/website/general-server-setup/how-to-login-ssh" target="”_blank”">Login to your server via SSH</a> as the root user.</li>
<li>Run the following command to determine what ModSecurity rules are being triggered:
<p class="code_block" style="width: 500px;">grep ModSecurity /usr/local/apache/logs/error_log | sed -e 's#^.*\[id "\([0-9]*\).*hostname "\([a-z0-9\-\_\.]*\)"\].*uri "#\1 \2 #' | cut -d\" -f1 | sort -n | uniq -c | sort -n</p>

<p>This will give you something back like this:</p>

<p class="code_block" style="width: 500px;">129 990011 example.com /feed/<br /> 4668 <strong>950004</strong> example.com /wp-content/themes/drone/jquery.cookie.js<br /> 29070 <strong>950004</strong> www.example.com /wp-content/themes/drone/jquery.cookie.js</p>

<p>So we can see that the ModSecurity rule ID <strong>950004</strong> has been triggered at least <strong>33,738</strong> between <strong>example.com</strong> and <strong>www.example.com</strong> when trying to request the <strong>/wp-content/themes/drone/jquery.cookie.js</strong> file.</p>
</li>

<li>In order to disable just the specific ModSecurity rule for the <strong>95004</strong>&nbsp;rule, run the following command:
<p class="code_block" style="width: 500px;">echo "SecRuleRemoveById 950004" &gt;&gt; /usr/local/apache/conf/userdata/std/2/userna5/example.com/modsec.conf</p>
...
<p>You should now know how to locate what ModSecurity rules are being triggered, and how to indivdually disable those specific rules to stop triggering 406 ModSecurity errors on your website.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/modsecurity/find-and-disable-specific-modsecurity-rules&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/modsecurity/find-and-disable-specific-modsecurity-rules'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MDgmaWQ9NTY1JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/general-server-setup/are-the-imh-modsecurity-rules-compliant-with-apache-246?tsrc=rsbraq'>Are the IMH modsecurity rules compliant with apache 2.4.6?</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/897688c1299a189f044229dce73e8436?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/897688c1299a189f044229dce73e8436'>Anon</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-02-28 8:58 pm</div>
				                <div><p>Hi I have a setup with modsec but it wot disable rules that I need to disable to allow directory listing (Indexes). Come across this before?</p>
<p>This is in my /etc/modsecurity/modsecurity.conf file</p>
<p>SecRuleRemoveById 970011SecRuleRemoveById 971200SecRuleRemoveById 971201SecRuleRemoveById 971202</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8700);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-02-28 9:35 pm</div>
				                <div>Hello Anon,<br />
<br />
Since I can't see your account, I am unable to determine if you have the permission to change the Modsec rule - you would need to have <a href="http://www.inmotionhosting.com/support/edu/whm/intro-to-web-hosting/standard-vs-root-access">root access</a>.  If you're finding that you are unable to make the changes, make sure that the file permissions allow you to change it, if you're still having the problem, then contact our <a href="http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support">technical support team</a> through email/phone/chat.  <br />
<br />
The technical support team may need to make the change for you, if you have a hosting account with us.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8701);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/b4fe6706daccb7ca2179d553ddd459bb?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/b4fe6706daccb7ca2179d553ddd459bb'>Martina</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-07 4:55 am</div>
				                <div><p>I have problem with this on my site http://villasdiani.com/ can you halp me with that? :-( For me it realy sounds like chinese:-(</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9453);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-07 12:47 pm</div>
				                <div>Hello Martina,<br />
<br />
Thank you for contacting us. Since your website seems to be hosted with Network Solutions we do not have access to your server.<br />
<br />
We are still happy to help you, but will need more information. What are you trying to accomplish?<br />
<br />
Are you having problems, or getting errors? Can you provide the errors?<br />
<br />
If you have any further questions, feel free to post them below.<br />
Thank you,<br />
<br />
-John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9469);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
				...
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-07 12:47 pm</div>
				                <div>Hello Martina,<br />
<br />
We are happy to help. At what part of the process are you getting stuck? Be sure you have <a href="http://www.inmotionhosting.com/support/website/ssh/root-access-faq">root access</a> in order to begin.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9470);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-15883'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/3a3dddbce5f00ffd3daf4db0c65b79dc?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/3a3dddbce5f00ffd3daf4db0c65b79dc'>James Stratos</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-05 1:10 am</div>
				                <div><p>We have issues when ModSec Rule is enabled and get a 406 error for the User Agent Header. This occures after users pay for items using the SIM payment method and are then re-routed or relayed back to the website. I would like to just disable that rule for the USer Agent Header request. Where can I find that rule number? Also, would enabling Mod_Rewrite in my CMS configuration help at all?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15883);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-06 8:48 am</div>
				                <div>Hello James,<br />
<br />
Following Jacob's instructions above should help you identify and disable the specific rule.  Mod_rewrite is enabled by default on the servers, but it is enabled by the htaccess file usually as well by calling 'RewriteEngine On'.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15903);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-06 2:49 am</div>
				                <div><p><span style="color: #222222; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 15px; line-height: 19.5px; background-color: #f4eaea;">I want to allow request arguements "request.ui_dispatch_app and request.ui_dispatch_view" from "test.local.com" From other domain this should not allow and arguements other than these 2 like "request.something" from any domain including "test.local.com" should not allow in modsecurity. How to achieve this ?</span></p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22363);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-06 3:14 pm</div>
				                <div>Hello Yogesh Patel,<br />
<br />
If you're trying to change the  mod security rules that apply to your websites, you will need to have root access to the account, and knowledge of how to change the rules.  Otherwise, you will need to <a href="http://www.inmotionhosting.com/support/website/getting-started-guides/submitting-and-checking-on-status-of-tickets">submit a request </a>to technical support explaining what you are trying to accomplish.  Bear in mind that changing the mod security rules may not be possible if you are on a shared server.<br />
<br />
I hope this helps to answer your question, please let us know if you require any further  assistance.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22386);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
