<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:70134:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-3/site-settings/changing-url-joomla-website" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-04-30T02:50:38-07:00" />
  <meta name="keywords" content="change alter rename joomla website url domain name" />
  <meta name="author" content="Arnel Custodio" />
  <meta name="description" content="It will occasionally be required to change the URL of a Joomla website due to a business name change or other reason.  Making this change is typically a configuration change and possibly a database change depending on how you have configured your Joomla website.  The following article explains how to make the change using the tools available with your Cpanel account." />
  <title>Changing the URL of a Joomla Website - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-3/site-settings/changing-url-joomla-website" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:a336bbdca9325e05cc46ee58acc92628 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-20']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '201.147.183.50']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Changing the URL of a Joomla Website									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>52,268</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Apr 30, 2013'><span style='color:#606060;'>Published:</span> Apr 30, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Sometimes it is necessary to change the domain name for a website.&nbsp; If you are using Joomla, this will involve making a change to a configuration file and possibly your database.&nbsp; The following article will take you through the steps for changing your Joomla website URL.</p>
<h2><br />Modifying the Domain Name for Your Joomla Website</h2>
<p><strong>Modify the configuration .php file of your Joomla Installation</strong>
</p>
<ol class="article_list">
  <li><a target="_blank" href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">Login to your cPanel</a> and then go to the<a target="_blank" href="/support/website/cpanel/how-do-i-use-the-file-manager-in-the-control-panel-cpanel"> File Manager</a>.</li>
  <li>Locate the installation files for your Joomla files.&nbsp; Search for the <strong>root</strong> folder of your Joomla installation, then open the <strong>CONFIGURATION.PHP</strong> file in one of the <a target="_blank" href="/support/edu/cpanel/cpanel-file-manager/file-manager-code-editor">editing options of the File Manager</a>.</li>
  <li>Look for the following setting:<br /><br /><span class="code_block">public $live_site='domain_name.com';</span><br /><br />The "domain_name.com" represents the current setting.&nbsp; Below the "new_domain.com" represents your new domain name. Replace the text of the current domain name with your new domain name.<br /><br /><span class="code_block">public $live_site='new_domain_name.com';</span><br /><br /></li>
  <li>Once you have completed the change, click on <strong>SAVE CHANGES</strong> in your editor.&nbsp;</li>
</ol>
<p>&nbsp;</p>
<p><strong>Change the Database Settings of Your Joomla Installation</strong>
</p>
<ol class="article_list">
  <li><a target="_blank" href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">Login to your cPanel</a>.</li>
  <li>Scroll down to the <strong>DATABASES</strong> section and<a target="_blank" href="/support/website/cpanel/how-do-i-manage-a-mysql-database-in-phpmyadmin-in-my-control-panel-cpanel"> click on phpMyAdmin</a>.</li>
  <li>Select your Joomla database and then click on <a href="/support/website/databases/export-database-using-phpmyadmin"><strong>EXPORT</strong> </a>in the top menu after the database is selected. The exported format will be SQL (e.g. <em>filename.sql</em>)</li>
  <li>Save the resulting SQL file to your local hard drive.</li>
  <li>Open the SQL file in a <a target="_blank" href="/support/edu/cpanel/cpanel-file-manager/file-manager-code-editor">TEXT EDITOR</a> (e.g. Notepad.)</li>
  <li>Find and Replace all of your old URLs with the new one.&nbsp; Note: the default keyboard shortcut for "find and replace" is CTRL+H (hold down your control key and click on 'H') - this will bring up the Find and Replace dialog.</li>
  <li>Once you have replaced all of the old URLs with your domain name save the SQL file.</li>
  <li>Go back to phpMyAdmin and then <a target="_blank" href="/support/website/databases/import-database-using-phpmyadmin"><strong>IMPORT</strong> </a>your updated SQL file back in as the SAME Joomla database.</li>
</ol>
<p>This completes the steps necessary to change the domain name for your Joomla website.&nbsp; Remember that the changes for the database might not be necessary as it depends on how you configured your Joomla website.&nbsp; If you require further information on Joomla, please go to the <a target="_blank" href="/support/website/joomla/getting-started-guide-joomla"><em>Getting Started Guide:&nbsp; Joomla</em></a>.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/joomla-3/site-settings'>204: How to modify your Site Settings in Joomla 3</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 2: Changing the URL of a Joomla Website</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 1: <a href='/support/edu/joomla-3/site-settings/create-sitemap'>How to Create a Sitemap in Joomla 3</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 3: <a href='/support/edu/joomla-3/site-settings/modify-site-name'>How to change your Site Name in Joomla 3.1</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-3/site-settings/changing-url-joomla-website&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-3/site-settings/changing-url-joomla-website'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNDcmaWQ9MjY3OCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="dfa6fa44da39b77d295da755962e4bb9" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/joomla-3/site-settings?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> How to modify your Site Settings in Joomla 3</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/joomla-3/site-settings/create-sitemap?tsrc=rsbedu'>How to Create a Sitemap in Joomla 3</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/joomla-3/site-settings/changing-url-joomla-website?tsrc=rsbedu'>Changing the URL of a Joomla Website</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/joomla-3/site-settings/modify-site-name?tsrc=rsbedu'>How to change your Site Name in Joomla 3.1</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/joomla-3/site-settings/site-offline?tsrc=rsbedu'>How to put Joomla 3.1 in Offline Mode</a></td>
                </tr>
          <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/joomla-3/site-settings/hide-offline-message?tsrc=rsbedu'>How to hide your Offline Message in Joomla 3.1</a></td>
                </tr>
          <tr >
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/joomla-3/site-settings/change-offline-message?tsrc=rsbedu'>How to change the Offline Message in Joomla 3.1</a></td>
                </tr>
          <tr >
                        <td valign='top'>7.</td>
                        <td><a href='/support/edu/joomla-3/site-settings/offline-image?tsrc=rsbedu'>How to show an Offline Mode Image in Joomla 3.1</a></td>
                </tr>
          <tr >
                        <td valign='top'>8.</td>
                        <td><a href='/support/edu/joomla-3/site-settings/default-editor?tsrc=rsbedu'>How to change the Default Editor in Joomla 3.1</a></td>
                </tr>
          <tr >
                        <td valign='top'>9.</td>
                        <td><a href='/support/edu/joomla-3/site-settings/default-captcha?tsrc=rsbedu'>How to change the Default Captcha in Joomla 3</a></td>
                </tr>
          <tr >
                        <td valign='top'>10.</td>
                        <td><a href='/support/edu/joomla-3/site-settings/default-access-level?tsrc=rsbedu'>How to change the Default Access Level in Joomla 3.1</a></td>
                </tr>
          <tr >
                        <td valign='top'>11.</td>
                        <td><a href='/support/edu/joomla-3/site-settings/default-list-limit?tsrc=rsbedu'>How to change the Default List Limit in Joomla 3.1</a></td>
                </tr>
          	</table>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/6811db2b37e824fdf6c5c4fcdddd4146?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/6811db2b37e824fdf6c5c4fcdddd4146'>rtpHarry</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-12 7:10 pm</div>
				                <div><p>Thanks, this is what I needed. Two points of caution though:</p>
<ol>
<li>If you export your database you shouldn't use Notepad as it doesn't handle double byte characters like Chinese properly and will corrupt everything when you re-import it. Personally I use Notepad++ for this type of task.</li>
<li>If you still value the old domain then make sure right after this you search for a tutorial explaining how to 301 redirect the old domain to the new one or you wont transfer your Google ranking. Make sure that it forwards the subpages and the non-www domain as well as the homepage.</li>
</ol></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20629);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-21274'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/40aeec45d1f30039a043dbcbfcee7349?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/40aeec45d1f30039a043dbcbfcee7349'>Johan</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-03 6:03 pm</div>
				                <div><p>I follow your steps and now our project has several 1064 errors. The databases is not working fine now</p>
<p>&nbsp;</p>
<p>Our project is damage now.</p>
<p>&nbsp;</p>
<p>: (</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21274);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-03 6:12 pm</div>
				                <div>Hello Johan,<br />
<br />
What changes have you made exactly? Have you tried reverting the changes?<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21275);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/6811db2b37e824fdf6c5c4fcdddd4146?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/6811db2b37e824fdf6c5c4fcdddd4146'>Matthew Harris</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-06 6:34 am</div>
				                <div><p>A lot of the time the first error is causing the rest of the thousand errors. What is the first error?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21373);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
