<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:65691:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/using-custom-name-servers" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-03-30T17:05:05-07:00" />
  <meta name="keywords" content="alias custom nameserver nameservers name server name servers 2xram" />
  <meta name="author" content="Jacob Nicholson" />
  <meta name="description" content="In this article we'll discuss how you can ensure that you are using your custom name servers that have been assigned to you. Typically custom name servers are setup as a requirement for having root access to your VPS (Virtual Private Server) or dedicated server." />
  <title>Using custom name servers - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/using-custom-name-servers" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:d3483fb4eaacbfa207050b256763567a -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-22']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '62.131.115.183']);
    ...
    <ul>
		...
		<li><a href='/support/tools/what-is-my-ip-address'>What is my IP address?</a></li>
			...
			<div class='dropdown_3columns' style='width:900px; margin-left:-250px;'>
				<div class='col_1' style='width:290px;'><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/domain-names/dns-nameserver-changes/domain-names-dns-changes'>Domain Names - How long do DNS changes take?</a> (244,033 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/domain-names/dns-nameserver-changes/how-do-i-clear-my-local-dns-cache'>How do I clear my local DNS cache?</a> (56,529 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/domain-names/dns-nameserver-changes/godaddy'>Making DNS Nameserver Changes at GoDaddy.com</a> (43,393 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/domain-names/dns-nameserver-changes/change-domain-nameservers-amp'>How to change your Domain Nameservers in AMP</a> (35,714 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/domain-names/dns-nameserver-changes/change-dns-records-to-use-3rd-party-services'>Change DNS records to use 3rd party services</a> (14,807 hits)</div></div>
				<div class='col_1' style='width:290px;'><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/domain-names/dns-nameserver-changes/updating-your-domains-nameservers'>Updating Your Domain's DNS / Nameservers</a> (175,481 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/domain-names/dns-nameserver-changes/how-do-i-make-custom-dns-records'>How do I make custom DNS records?</a> (51,864 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/domain-names/dns-nameserver-changes/domain-names-registrar-transfer-versus-nameserver-change'>Domain Names - Registrar Transfer versus NameServer Change</a> (37,930 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/domain-names/dns-nameserver-changes/using-custom-name-servers'>Using custom name servers</a> (28,856 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/domain-names/dns-nameserver-changes/opensrs-domain-maintenance'>OpenSRS Domain Maintenance</a> (3,827 hits)</div></div>
				<div class='col_1' style='width:290px;'><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/domain-names/dns-nameserver-changes/what-is-a-name-server'>What is a name server?</a> (125,251 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/domain-names/dns-nameserver-changes/a-record-change'>Adding an A Record</a> (48,685 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/domain-names/dns-nameserver-changes/add-cname-record'>Adding a CNAME Record</a> (37,555 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/domain-names/dns-nameserver-changes/vanity-nameservers-what-are-they-and-how-do-i-set-them-up'>Vanity Nameservers: What are they and how do I set them up?</a> (23,324 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/domain-names/dns-nameserver-changes/change-google-domain-nameservers'>How to Change Name Servers in Google Domains (2)</a> (453 hits)</div></div>
			</div>
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Using custom name servers</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>28,856</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Nov 26, 2012'><span style='color:#606060;'>Published:</span> Mar 30, 2016</div>
  ...
  <h2>Navigation:</h2>
  <button type="button" class="btn btn-primary" onclick="window.location.hash='our-name-servers';">Our public name servers</button>
  <button type="button" class="btn btn-primary" onclick="window.location.hash='using-our-name-servers';">Using our name servers?</button>
  <button type="button" class="btn btn-primary" onclick="window.location.hash='activate';">Activating custom name servers</button>

</div>

<div class="in_this_tutorial">
    <h2>Related:</h2>
    <button type="button" class="btn btn-primary" onclick="window.location='/support/domain-names/dns-nameserver-changes/what-is-a-name-server';">What is a name server?</button>
...
<p>A custom name server allows you to run your own name server to respond to DNS requests for your domains. You can also decide to setup custom name servers for branding purposes, if you would like to hide the fact that your domain's DNS requests are handled by our public name servers. Shared and <a href="http://www.inmotionhosting.com/reseller-hosting">Reseller</a> hosting customers can achieve this same branding affect for their domains by instead setting up <a href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/vanity-nameservers-what-are-they-and-how-do-i-set-them-up" target="_blank">vanity name servers</a>.</p>

<p class="alert" style="color:red">If you are a <a href="http://www.inmotionhosting.com/reseller-hosting" target="_blank" >Reseller</a>, please see our guide on <a href="/support/reseller/custom-name-server">Using Custom Nameservers as a Reseller</a></p>


<a name="our-name-servers"></a>    
<h2>Our public name servers</h2>
<p>By default any websites that we host are going to have DNS records added for that website to our public name servers. Currently these are our public name servers:</p>
<pre class="code_block" style="width: 270px;">ns.inmotionhosting.com 74.124.210.242
ns2.inmotionhosting.com 70.39.150.2
</pre>

<a name="using-our-name-servers"></a>    
<h2>Are you using our public name servers?</h2>

<p>You can use our <a href="http://www.inmotionhosting.com/support/tools/visual-domain-routing" target="_blank">domain routing tool</a> to see if your domain is pointed already at our public name servers. Or you can follow the steps below to check your domain's DNS records directly from your computer.</p>

<ol class="article_list">
<li>Open a command prompt window by going to <strong>Start</strong> and then typing in <strong>cmd</strong> and hitting <strong>Enter</strong>.</li>
<li>Once a command prompt window is up, you'll want to type in the following command and hit <strong>Enter</strong>
<p style="margin-top: 15px;"><span class="code_block">nslookup</span></p>
<p>You should now be at the <strong>nslookup</strong> prompt indicated by a <span class="code_block">&gt;</span></p>
<p>Now you'll want to specify that you are just looking to query the <strong>(NS)</strong> name server records of the domain by typing in the following:</p>
<p><span class="code_block">set q=NS</span></p>
<p>Then hit <strong>Enter</strong> to be dropped to the next line, and here is where you'll type in your domain name:</p>
...
<pre class="code_block" style="width: 500px;">ns.inmotionhosting.com  internet address = 74.124.210.2
ns2.inmotionhosting.com internet address = 70.39.150.2
</pre>
</li>
</ol>
...
<a name="activate"></a>
<h2>Activating custom name servers</h2>
<p>If your server has been setup with custom name servers, but your domains are still pointed at our public name servers you'll want to update these so that they are using your custom name servers instead.</p>
<p>You should have already at this point been given custom name server entries by our system administration team, or you specifically requested for them to be setup. For this example we'll be using the fake domain name <strong>MyCustomNameServer.com</strong>.</p>
<pre class="code_block" style="margin-bottom: 15px;">ns1.MyCustomNameServer.com 123.123.123.123
ns2.MyCustomNameServer.com 123.123.123.123
</pre>
<ol class="article_list">
<li>Login to your domain Registrar where you registered the <strong>MyCustomNameServer.com</strong> domain name.</li>
<li>Most Registrars will have a section similar to <strong>Maintain name servers under this domain</strong>, or it's sometime referred to as <strong>glue</strong>, or <strong>host</strong> records as well.</li>
<li>Typically you'll just need to enter in the part before your domain name <strong>ns1</strong> for instance, and then the IP address you were given for the custom name server.</li>
<li>Repeat the same step again for the <strong>ns2</strong> host as well.</li>
<li>Now update all of your domains to point to your custom name servers</a>.</li>
</ol>

<a name="activate"></a>
<h3>Activate Your New Nameservers in AMP:</h3>
<p>If your domain is register through us, you can activate (also knows as <em>glue</em>) your <strong>Custom Nameservers</strong> in AMP.</p>

<ol class="article_list">

<li><a href="/support/website/amp/how-to-log-into-amp" target="_blank">Login to AMP</a>.</li>

<li>Move your mouse over the <strong>DOMAINS</strong> menu, and click the <strong>MANAGE DOMAINS</strong> link.<br>
...
<li>Click the domain name you want to edit from the list.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/revamp/select-domain.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/revamp/select-domain.png" alt="" /></a></li>

<li>On the next screen click <strong>Create custom nameservers</strong>.</li>

<li>In the <em>Add Name Server</em> section enter your custom nameservers, and your <a href="/support/website/cpanel/how-to-find-your-shared-ip-address-of-your-server-in-cpanel" target="_blank">Shared IP</a> for both nameservers. Click the <strong>Submit</strong> button to save your changes:<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/revamp/setup-custom-nameservers.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/revamp/setup-custom-nameservers.png" alt="" /></a><br><br>
You will then see  your new nameservers listed.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/revamp/glu-nameservers.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/revamp/glu-nameservers.png" alt="" /></a></li>
</ol>

<p style="margin-top: 15px;">After making DNS changes like this, it can take a full 24-48 hours for the settings to fully <a href="/support/domain-names/dns-nameserver-changes/domain-names-dns-changes" target="_blank">propagate</a>. Once they have updated, you should be able to query your domain's name server records again, and it should come back with the custom name server settings as the active name server addresses for that domain.</p>

<h2>How do I find my custom nameserver IP's</h2>
<ol class="article_list">
<li><a href="/support/edu/whm/creating-and-managing-accounts/log-into-whm" target="_blank" title="Click here for info">Log into WHM</a>.</li>
<li>Go to <strong>Home</strong> &gt; <strong>DNS Functions</strong> &gt; <strong>Edit DNS zone</strong>.</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/domains/custom-ip-in-dns-zone.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Finding custom nameserver IP addresses" src="//cdn.inmotionhosting.com/support/images/stories/domains/custom-ip-in-dns-zone.gif" title="Click here to view the larger image" width="100" /></a>Select your main domain from the list and click <strong>Edit</strong>.
<p>You will see your ns1 and ns2 subdomain entries for your custom nameservers. The IP is located there. See image to the right.</p>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/using-custom-name-servers&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/using-custom-name-servers'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD02OCZpZD04NjAmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="fd70c8408cf8c2c088f4f890e8f290c3" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/cpanel/trouble-with-cname-resolution?tsrc=rsbraq'>Trouble with CNAME Resolution</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/0a48406c8b6b5118548867c04ee22005?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/0a48406c8b6b5118548867c04ee22005'>Harold M_c_Murtry</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-12 1:15 pm</div>
				                <div><p>I have a google web site where i use storage and mail. I only want to use your site for hosting web servers. How should I configure DNS is in this cast</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24803);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
				...
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-13 2:22 pm</div>
				                <div>Hello Harold,<br />
<br />
You will want to use A records to point to the correct servers. Watch <a href="https://www.youtube.com/watch?v=yHSLkJw-C1M">this video</a> as it better explains it.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24850);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
