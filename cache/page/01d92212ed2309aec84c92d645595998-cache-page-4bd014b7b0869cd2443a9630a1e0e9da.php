<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:60044:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/tiki-wiki/multi-lingual-setup-tiki/multilingual-language-tiki" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-02-06T22:26:34-08:00" />
  <meta name="keywords" content="multi language multilingual set up enable TikiWiki Tiki Wiki Multilingual_Wiki" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="TikiWiki has built in language features available to create a multi language site. This article will explain how to enable multilingual features in TikiWiki." />
  <title>Setting up the Multilingual feature in TikiWiki - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/tiki-wiki/multi-lingual-setup-tiki/multilingual-language-tiki" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:28470253c06636076d02a72730189f6f -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Setting up the Multilingual feature in TikiWiki									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>1,149</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Feb 6, 2013'><span style='color:#606060;'>Published:</span> Feb 6, 2013</div>
...
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/202/multi-language-tiki/multi-language-site-1-click-i18n.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Click teh i18n link TikiWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/202/multi-language-tiki/multi-language-site-1-click-i18n.gif" title="Click here to view the larger image" width="100" /></a><strong>Click the Flag icon labeled i18n. </strong><br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/202/multi-language-tiki/multi-language-site-2-select-multilingual.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Select MultiLingual TikiWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/202/multi-language-tiki/multi-language-site-2-select-multilingual.gif" title="Click here to view the larger image" width="100" /></a><strong>Click the multilingual check box. </strong><br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/202/multi-language-tiki/multi-language-site-3-enable-multilingual.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Enable the multilingual TikiWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/202/multi-language-tiki/multi-language-site-3-enable-multilingual.gif" title="Click here to view the larger image" width="100" /></a>There will be a red warning stating "<em>You need to set Multilingual</em>" under the Available Languages text.<strong> Click the Multilingual link in the warning.</strong><br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/202/multi-language-tiki/multi-language-site-4-check-box.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Check the multilingual checkbox TikiWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/202/multi-language-tiki/multi-language-site-4-check-box.gif" title="Click here to view the larger image" width="100" /></a>On the Preferences Search Results select the languages you want to have available from the list.
<p><strong>Check the Multilingual check box.</strong></p>
<p><strong>Click Change.</strong></p>
<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/202/multi-language-tiki/multi-language-site-5-change-preferences.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Click change preferences TikiWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/202/multi-language-tiki/multi-language-site-5-change-preferences.gif" title="Click here to view the larger image" width="100" /></a>Go back to <strong>Admin</strong> &gt; <strong>i18n</strong>. You will see the red warning gone now. Check the <strong>Multisite</strong>, <strong>Users can change site language</strong>, and <strong>Restrict supported languages</strong>check boxes.
<p><strong>Select the languages</strong> you want available on your TikiWiki.</p>
<p><strong>Click Change Preferences.</strong></p>
<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/202/multi-language-tiki/multi-language-site-6-profiles.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Go to profiles in TikiWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/202/multi-language-tiki/multi-language-site-6-profiles.gif" title="Click here to view the larger image" width="100" /></a>Now that the Multilingual module is enabled, you will need to install the <strong>Multilingual_Wiki profile</strong>.
<p>Go to <strong>Admin</strong> &gt; <strong>Profiles</strong>.</p>
<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/202/multi-language-tiki/multi-language-site-7-list.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="List of available profiles TikiWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/202/multi-language-tiki/multi-language-site-7-list.gif" title="Click here to view the larger image" width="100" /></a><strong>Click the List button</strong>.<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/202/multi-language-tiki/multi-language-site-8-multilingual-wiki.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Multi language wiki TikiWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/202/multi-language-tiki/multi-language-site-8-multilingual-wiki.gif" title="Click here to view the larger image" width="100" /></a><strong>Select the Multilingual_Wiki profile</strong> from the list of available profiles. <br style="clear: both;" />
<p>Scroll towards the bottom and <strong>click Apply now</strong>.</p>
<p>When the "<em>Are you sure you want to apply the profile Multilingual_Wiki</em>" pop up appears, <strong>click Go</strong>.</p>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/202/multi-language-tiki/multi-language-site-9-earth.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Translate wiki page TikiWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/202/multi-language-tiki/multi-language-site-9-earth.gif" title="Click here to view the larger image" width="100" /></a>Now when you go to your TikiWiki site you will see the option to translate the page towards the top of the page. <br style="clear: both;" /></p>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/202/multi-language-tiki/multi-language-site-10-translate.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Translate a page TikiWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/202/multi-language-tiki/multi-language-site-10-translate.gif" title="Click here to view the larger image" width="100" /></a>At the bottom of each page there will be a translate option. <br style="clear: both;" /></p>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/202/multi-language-tiki/multi-language-site11-language-switch.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Language switcher TikiWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/202/multi-language-tiki/multi-language-site11-language-switch.gif" title="Click here to view the larger image" width="100" /></a>Also, the option for switching the language for the interface will show on the right hand side. <br style="clear: both;" /></p>
</li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/tiki-wiki/multi-lingual-setup-tiki'>202: Setting up a multilingual site in TikiWiki</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 2: Setting up the Multilingual feature in TikiWiki</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 1: <a href='/support/edu/tiki-wiki/multi-lingual-setup-tiki/change-admin-language-tiki'>How to change the admin language in TikiWiki</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/tiki-wiki/multi-lingual-setup-tiki/multilingual-language-tiki&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/tiki-wiki/multi-lingual-setup-tiki/multilingual-language-tiki'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMzQmaWQ9MjIyMSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="5f8c23195aaf73b13aef6cf81408c94a" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/tiki-wiki/multi-lingual-setup-tiki?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Setting up a multilingual site in TikiWiki</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/tiki-wiki/multi-lingual-setup-tiki/change-admin-language-tiki?tsrc=rsbedu'>How to change the admin language in TikiWiki</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/tiki-wiki/multi-lingual-setup-tiki/multilingual-language-tiki?tsrc=rsbedu'>Setting up the Multilingual feature in TikiWiki</a></td>
                </tr>
          	</table>
