<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:62409:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/php-configuration/how-to-upgrade-php-version" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-09-24T18:28:20-07:00" />
  <meta name="keywords" content="how to upgrade php version" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="This article explains how to upgrade your PHP version on your server." />
  <title>How to upgrade your PHP version - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/php-configuration/how-to-upgrade-php-version" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:a49a340902f5d7c4c77577257037c1d6 -->
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/website/php-configuration' itemprop='url'><span itemprop='title'>PHP Configuration<span></a><div class='dropdown_3columns'><div class='col_3'><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/php-configuration/how-to-upgrade-php-version'>How to upgrade your PHP version</a> (27919 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/php-configuration/using-multiple-php-versions-one-account'>Using multiple PHP versions on one account</a> (21884 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/php-configuration/find-php-version-and-options-of-your-server'>Find PHP version and options of your server</a> (15834 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/php-configuration/view-and-clear-php-apc-cache'>View and clear PHP APC cache</a> (11401 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/php-configuration/install-pear-extensions'>How to install PEAR php extensions via the cPanel</a> (10425 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/php-configuration/install-apc-for-php'>Install APC for PHP</a> (6821 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/php-configuration/use-diferent-php-versions-one-account'>Copying the php.ini from a different PHP version</a> (5116 hits)</div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to upgrade your PHP version</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to upgrade your PHP version									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>27,919</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Feb 8, 2013'><span style='color:#606060;'>Published:</span> Sep 24, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>InMotion Hosting has servers many servers that have different versions of PHP for each. This is because each customer has their own version requirements for their website to work. In the event that you need a newer version of PHP on your server, you can upgrade if you are on a Dedicated or VPS server. If you are on a shared server, you can change the PHP version through cPanel (not available on all servers).</p>
<h2>Switching the PHP version in cPanel</h2>
<p>On many of our newer servers, you can switch the PHP version through your cPanel. To learn how to change the PHP version, see our article on "<a target="_blank" href="/support/website/general-server-setup/how-to-change-the-php-version-your-account-uses"><em>How to change the PHP version your account uses</em></a>".</p>
<h2>Upgrading on a VPS or Dedicated server</h2>
<p>On VPS and Dedicated servers, you can upgrade the server PHP version through your WHM. For information on how to do this see our "<a target="_blank" href="/support/edu/whm/302-upgrade-php-using-easyapache"><em>302: Upgrade PHP using EasyApache</em></a>" article.</p>
<h2>If you cannot change the PHP version in cPanel</h2>
<p>If you do not have a VPS or Dedicated server and you cannot change the PHP version in cPanel then you will need to contact <a href="/support/website/website-troubleshooting/how-to-get-great-technical-support" target="_blank" title="Click here for how to contact support">tech support</a> to have your account moved to a server with a newer version of PHP. Moving your account to another server will not have any downtime. The account move is done by our systems support so no action is required on your end.</p>
<p class="alert">When submitting a ticket for this, please let them know what version of PHP you need and verify the account with either the current AMP password, original cpanel password, or the last 4 digits of the credit card on file and our systems support will move you ASAP.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/php-configuration/how-to-upgrade-php-version&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/php-configuration/how-to-upgrade-php-version'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NTImaWQ9NTYzJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="4c971c6e22df2917171c74d7dfde5acb" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/joomla/joomla-15-in-inmotion-hosting?tsrc=rsbraq'>Joomla 1.5 in inMotion Hosting</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/prestashop-15/block-search-working-locally-but-not-on-server?tsrc=rsbraq'>Block search working locally but not on server</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/b2807f7045890899d053629fcef5ec76?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/b2807f7045890899d053629fcef5ec76'>Garrett</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-02-04 10:03 pm</div>
				                <div><p>On my VPS, EasyApache is not listed... now what?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30347);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-02-05 10:10 am</div>
				                <div>Hello Garrett,<br />
<br />
You have to be logged in as root to see the EasyApache option.<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30353);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
