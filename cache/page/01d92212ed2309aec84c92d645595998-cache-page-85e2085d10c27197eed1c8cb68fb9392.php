<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:55423:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/news/general/javascript-failure-jquery-update" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-01-17T18:48:09-08:00" />
  <meta name="keywords" content="jQuery 1.9.0 update broke dynamic sliders in sites that reference the jquery-latest.js" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="jQuery 1.9.0 update broke dynamic sliders in sites that reference the jquery-latest.js." />
  <title>Javascript failure due to jQuery update - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/news/general/javascript-failure-jquery-update" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:d30ed74d1198f4c14b8c43358aa7979d -->
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Javascript failure due to jQuery update</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Javascript failure due to jQuery update									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>7,863</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 17, 2013'><span style='color:#606060;'>Published:</span> Jan 17, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Recently we've been made aware that our customer website JavaScript sliders and other related scripts stopped working a few days ago. This is not a server related issue. The JavaScript runs on the Client side which runs from website coding itself.</p>
<p>On the 15th of January 2013, jQuery released a new 1.9 version. Any website that links to the jquery-latest.js will automatically use the newest version of jQuery. Unfortunately, this new version is not working with some of the older functions. If your site JavaScript sliders or other jQuery related JavaScript stop working from the 15th, you may be using the <strong><em>jquery-latest.js</em></strong> from jQuery.</p>
<p class="alert"><strong>Important!</strong> This is a fix that requires code editing. If you are not a developer and are not comfortable with editing code, you will want to contact your developer to fix the jQuery plugin version on your site.</p>
<h2>General steps to Fix the jQuery JavaScript error</h2>
<ol class="article_list">
<li>The script that links your site to jQuery is located in the head section of the website. Open your website header code in a code editor.</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/news/jquery-update-failure/script-jquery-1.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Scrpt for jQuery" src="//cdn.inmotionhosting.com/support/images/stories/news/jquery-update-failure/script-jquery-1.gif" title="Click here to view the larger image" width="100" /></a>Locate the script that contains the code for your jQuery. It should look like the following.
<p class="code_block" style="margin-left: 20px;">&lt;script type='text/javascript' src='http://code.jquery.com/jquery-latest.js?ver=2358'&gt;&lt;/script&gt;<br style="clear: both;" /></p>
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/news/jquery-update-failure/script-jquery-2.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Download for jquery" src="//cdn.inmotionhosting.com/support/images/stories/news/jquery-update-failure/script-jquery-2.gif" title="Click here to view the larger image" width="100" /></a>Change the link from jquery latest to an older version. You can get the jQuery versions at the following link.
<p><a href="http://jquery.com/download/">Download jQuery</a></p>
<p>When clicking the download link, you can get the url for the jQuery code in the browser address bar.<br style="clear: both;" /></p>
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/news/jquery-update-failure/script-jquery-3.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="jQuery link to jquery-1.8.3.min.js" src="//cdn.inmotionhosting.com/support/images/stories/news/jquery-update-failure/script-jquery-3.gif" title="Click here to view the larger image" width="100" /></a>Get the link for the 1.8.3 Version.
<p style="margin-left: 20px;">http://code.jquery.com/jquery-1.8.3.min.js</p>
<br style="clear: both;" /></li>
<li>Paste the url in your script so it looks like the following:
<p class="code_block" style="margin-left: 20px;">&lt;script type='text/javascript' src='http://code.jquery.com/jquery-1.8.3.min.js'&gt;&lt;/script&gt;</p>
<p>Save the changes.</p>
<p>Now your JavaScript should work again.</p>
</li>
</ol>
<p>If these steps did not fix the issue, then you may have another issue causing the site to not work that is not related to jQuery. You will want to contact your developer for a fix. Unfortunately, we do not have any support on this type of coding issue as it is not server related.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/news/general/javascript-failure-jquery-update&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/news/general/javascript-failure-jquery-update'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD01MCZpZD04OTImdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
