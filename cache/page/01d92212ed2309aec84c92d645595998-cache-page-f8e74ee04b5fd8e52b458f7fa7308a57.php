<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:51076:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/wordpress/do-not-know-wordpress-login-info" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Sharlene, Apologies on this delayed answer. Typically, if you installed with Softaculous, you can RESTART the installation process in Softaculous,..." />
  <title>do not know wordpress login info | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/wordpress/do-not-know-wordpress-login-info" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:482d9c605dc726636bce2057621dd6dc -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>do not know wordpress login info</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/Sharlene'>Sharlene</a>
			<div>13 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-10-17 2:23 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>294</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I installed WordPress via Softaculous.  I am working on a temp URL.  I am not to the login screen for WordPress.  I do not know what the username and password is.  I have tried a couple of things I thought it might be with no luck.  I have tried to get wordpress to send me a link to change my password, but have not received a response.  Can someone help?  <br />
Thank you!</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_1729' id='upvote_answer_1729' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='1729' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_1729').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_1729' id='downvote_answer_1729' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='1729' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_1729').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Sharlene,<br />
<br />
Apologies on this delayed answer.  Typically, if you installed with Softaculous, you can RESTART the installation process in Softaculous, and then you will see the default login - if you did not put one when you installed Wordpress initially.  You can alway un-install it and then re-install it and then specify your login information.  It only takes a few minutes.  If you insist on having the current password, the only way is to replace it.  You can have this done by contacting live technical support and request a password reset after verifying your account.  Make sure you specify that you're requesting the reset of the Wordpress password.  Note that all answers posted here are public, so it would not be wise to ask for a password reset here.  The default Wordpress admin link is yourdomainname/wp-admin (replace 'yourdomainname' with your website url).  <br />
<br />
...
Arnel C.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_1729').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_1729' id='form_comment_on_answer_1729' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/wordpress/do-not-know-wordpress-login-info&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/wordpress/do-not-know-wordpress-login-info'></div>
<script type='text/javascript'>
  (function() {
