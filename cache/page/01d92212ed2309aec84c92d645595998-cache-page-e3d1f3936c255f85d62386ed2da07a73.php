<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49960:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/oscommerce/change-theme-template-appearance" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="keywords" content="change theme template look feel footer header sidebar oscommerce" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="Learn how to change the look and feel of your osCommerce site by following these tutorials." />
  <title>201: Changing your osCommerce appearance | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/oscommerce/change-theme-template-appearance" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:51abfe9d220c822f7d3911e4edec0daf -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '89.154.230.152']);
...
<div class='page-header'>
	<h1>201: Changing your osCommerce appearance</h1>
</div>
<div class='section_listing'>
	<p>To make your osCommerce site more like the site you want, you can customize the look and feel of the theme. This tutorial series will explain how to change the look and feel of your osCommerce shopping cart.</p>
	<table>
	<tr><td colspan='3'><h2>Changing the osCommerce theme</h2><div>Learn how to change your osCommerce theme with these next articles.</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 1:</td>
				<td style='padding-right:10px;'><div class='gold_star'></div></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/oscommerce/change-theme-template-appearance/installing-the-oscommerce-theme-switcher'>Installing the osCommerce Theme Switcher</a>
					<div>Changing themes is difficult in osCommerce. this article will explain how to install the theme Switcher module.</div>
					<div class='smallgrey'>Hits: 10,209</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'><div class='gold_star'></div></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/oscommerce/change-theme-template-appearance/fixing-the-jquery-version-in-oscommerce-2-3-3'>Fixing the jQuery version in osCommerce</a>
					<div>When installing the Theme Switcher you will find the jQuery version is not up to date. This article will explain how to update the version of jQuery for osCommerce 2.3.3.</div>
					<div class='smallgrey'>Hits: 4,963</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'><div class='gold_star'></div></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/oscommerce/change-theme-template-appearance/changing-the-theme-in-oscommerce'>Changing the theme in osCommerce</a>
					<div>You can change your osCommerce theme using the jQuery Theme Roller for osCommerce. This article will show you how.</div>
					<div class='smallgrey'>Hits: 9,587</div>
				</td>
			</tr>
		<tr><td colspan='3' style='padding-top:20px;'><h2>Changing the Banner and Logo in osCommerce</h2><div>Learn how to customize your osCommerce banner and logo in the following tutorials.</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 4:</td>
				<td style='padding-right:10px;'><div class='gold_star'></div></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/oscommerce/change-theme-template-appearance/chaning-oscommerce-logo'>Changing the osCommerce logo</a>
					<div>This article will walk you through the steps in changing the logo in your osCommerce site.</div>
					<div class='smallgrey'>Hits: 3,133</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'><div class='gold_star'></div></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/oscommerce/change-theme-template-appearance/how-change-banner-oscommerce'>How to change the banner in osCommerce</a>
					<div>osCommerce allows you to control a banner graphic that can be used for various purposes.  Generally, it is a opportunity for advertising, but it can also be used for branding or informational use.  The following article shows how to change the banner graphic using the osCommerce Administrator interface.</div>
					<div class='smallgrey'>Hits: 4,091</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/oscommerce/change-theme-template-appearance/disabling-deleting-banners'>Deleting or Disabling a Banner in osCommerce</a>
					<div>Removing banners from being displayed in your osCommerce site is easily done using the back end Banner Manager interface.  The following    article shows how to disable or delete a banner using the osCommerce Administration dashboard.</div>
					<div class='smallgrey'>Hits: 1,568</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/oscommerce/change-theme-template-appearance/managing-banners'>Managing Banners in osCommerce</a>
					<div>The Banner Manager in osCommerce includes the option to add new banners, disable/delete banners, obtain statistics on banner views/clicks, and organize the banners.  The following article explains obtaining statistics and editing the information for banners saved within the osCommerce back end interface.</div>
					<div class='smallgrey'>Hits: 2,658</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/oscommerce/change-theme-template-appearance/oscommerce-managing-your-banners'>Managing your banners in osCommerce Video</a>
					<div>Learn to manage your banners within the OsCommerce program.</div>
					<div class='smallgrey'>Hits: 3,343</div>
				</td>
			</tr>
		<tr><td colspan='3' style='padding-top:20px;'><h2>Editing the osCommerce footer, header and background</h2><div>Follow the tutorials below to learn how to edit the footer, header and background in your osCommerce site.</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 9:</td>
				<td style='padding-right:10px;'><div class='gold_star'></div></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/oscommerce/change-theme-template-appearance/removing-the-branding-from-the-oscommerce-footer'>Removing the branding from the osCommerce footer</a>
					<div>You can edit the footer in osCommerce to fit your theme needs. You can also remove the branded logo at the bottom. This article will explain how.</div>
					<div class='smallgrey'>Hits: 3,537</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/oscommerce/change-theme-template-appearance/changing-the-content-background-style-in-oscommerce'>Changing the content background style in osCommerce</a>
					<div>When you change the background of your osCommerce website you will need to stye the bodyWrapper as well. This article will explain how.</div>
					<div class='smallgrey'>Hits: 4,308</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/oscommerce/change-theme-template-appearance/change-background-image-os'>Changing the background image in osCommerce</a>
					<div>You can change the background image in osCommerce to make your site custom This article will teach you how.</div>
					<div class='smallgrey'>Hits: 3,173</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/oscommerce/change-theme-template-appearance/oscommerce-editing-your-header-and-footer'>Editing your header and footer in osCommerce Video</a>
					<div>Learn to edit your header and footer in the OsCommerce program.</div>
					<div class='smallgrey'>Hits: 5,969</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/oscommerce/change-theme-template-appearance/oscommerce-editing-your-left-and-right-columns'>Editing your left and right columns in osCommerce Video</a>
					<div>This tutorial explains how to edit the left and right sidebars in the OsCommerce program.</div>
					<div class='smallgrey'>Hits: 4,796</div>
				</td>
			</tr>
			</table>
</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zNzUmaWQ9Mzc1JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="53080af61f8a7882e4d7880405571d21" value="1" />	</div>
	</form>
<!-- <br />
