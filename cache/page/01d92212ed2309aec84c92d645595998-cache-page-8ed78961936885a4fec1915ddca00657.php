<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:73500:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/file-manager/compressing-uncompressing-files" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-01-12T16:41:54-08:00" />
  <meta name="keywords" content="compress uncompress zip tar GZiped Bzip2ed archive" />
  <meta name="author" content="John-Paul Briones" />
  <meta name="description" content="How to compress/uncompress files in the File Manager." />
  <title>How can I compress / uncompress files using the File Manager? - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/file-manager/compressing-uncompressing-files" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:5c684d5b6627dc329e4a00d016ad97c6 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '122.161.188.52']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/website/file-manager' itemprop='url'><span itemprop='title'>File Manager<span></a><div class='dropdown_3columns'><div class='col_3'><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/file-manager/show-hidden-files-in-file-manager'>How to show hidden files (htaccess) when using cPanel's File Manager</a> (125062 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/file-manager/compressing-uncompressing-files'>How can I compress / uncompress files using the File Manager?</a> (24106 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/file-manager/create-new-file'>How to create a new file</a> (9199 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/file-manager/understanding-character-encoding-in-the-code-editor-of-cpanel'> Understanding Character Encoding in the Code Editor of cPanel</a> (6391 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/file-manager/move-site-files'>An overview on moving applications from subfolders to your root folder</a> (1298 hits)</div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How can I compress / uncompress files using the File Manager?</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How can I compress / uncompress files using the File Manager?									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>24,106</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Nov 28, 2011'><span style='color:#606060;'>Published:</span> Jan 12, 2016</div>
...
<button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('compress');">Compress Files</button>
<button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('uncompress');">Uncompress Files</button>
</div>

<iframe width="650" height="350" src="//www.youtube.com/embed/94Bx_XLEE3w" frameborder="0" allowfullscreen></iframe>

<p>Your File Manager allows you to both compress (zip) files and uncompress (unzip) them.</p>

<a name="compress"></a>
<h2>How to Compress Files</h2>
<ol class="article_list">
<li><a href="/support/component/content/email/email-client-setup/using-file-manager-in-cpanel?Itemid=242" target="_blank" title="Click here for info">Go to the File Manager</a>.</li>
<li>Navigate to the folder where the files you want to compress are</li>
<li>While holding down your Ctrl key, click on each file that you would like included in the compressed file.</li>
<li>Click the "Compress" button at the top right of the page<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/cpanel/compress-files/choose-the-files-you-want-to-compress-and-click-compress.gif"><img  alt="choose-the-files-you-want-to-compress-and-click-compress" src="//cdn.inmotionhosting.com/support/images/stories/cpanel/compress-files/choose-the-files-you-want-to-compress-and-click-compress.gif" /></a></li>
<li>On the "Compress" page, choose which compression you would like to use (such as zip or tar), enter a name for the file, and then click "Compress File(s)".
<p>When the files have been compressed successfully, you'll see a success page that lists the compressed files similar to the below screenshot:</p>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/cpanel/compress-files/succussfully-compressed-files.gif"><img  alt="succussfully-compressed-files" src="//cdn.inmotionhosting.com/support/images/stories/cpanel/compress-files/succussfully-compressed-files.gif" /></a></p></li>
</ol>


<a name="uncompress"></a>
<h2>How to Uncompress Files</h2>
<ol class="article_list">
<li><a href="/support/component/content/email/email-client-setup/using-file-manager-in-cpanel?Itemid=242" target="_blank" title="Click here for info">Go to the File Manager</a>.</li>
<li>Navigate to the folder location for the file you want to uncompress.</li>
<li>Right click on the file and choose "Extract"<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/cpanel/compress-files/right-click-on-the-file-and-choose-extract.gif"><img  alt="right-click-on-the-file-and-choose-extract" src="//cdn.inmotionhosting.com/support/images/stories/cpanel/compress-files/right-click-on-the-file-and-choose-extract.gif" /></a></li>
<li>On the "Extract" page, choose the directory you would like to extract the files to, and click "Extract File(s)".
<p>When the file has been successfully extracted, you'll see a success page that lists the extracted files similar to the below screenshot:</p>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/cpanel/compress-files/screenshot-of-when-you-extract-files-using-cpanels-file-manager.gif"><img  alt="screenshot-of-when-you-extract-files-using-cpanels-file-manager" src="//cdn.inmotionhosting.com/support/images/stories/cpanel/compress-files/screenshot-of-when-you-extract-files-using-cpanels-file-manager.gif" /></a></p></li>
</ol> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/file-manager/compressing-uncompressing-files&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/file-manager/compressing-uncompressing-files'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MzAmaWQ9MzA4JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="09505f64080029c3f72c5d2a97c49cef" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/file-management/extracting-compressed-file-on-my-ftp?tsrc=rsbraq'>Extracting compressed file on my FTP</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						...
						<div><a style='font-size:16px;' href='/support/community-support/users/Teebird'>Teebird</a></div>
						<div></div>
						<div></div>
						<div>50 <a href='/support/team/points' target='_blank'>Points</a></div>
						
					</td>
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2012-04-27 1:53 pm</div>
				                <div>Forgive the potential &quot;n00b nature&quot; of this question, but is compression method described above for compressing files you want to serve to your websites visitors or is this just for storing files on your hosting space?</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(6529);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2012-04-27 2:01 pm</div>
				                <div>Hi Teebird,<br />
<br />
If you follow the steps above, they will walk you through compressing a file. This compressed file can then be downloaded by your visitors if you wanted to give them a link to it.<br />
<br />
This is a little different than gzip / mod_deflate, which compresses files before sending them to your users (such as html files). You can find more information on that here:<br />
<br />
&lt;a href=&quot;http://www.inmotionhosting.com/support/website/general-server-setup/how-to-enable-gzip-moddeflate&quot; target=&quot;_blank&quot;&gt;An introduction to gzip / mod_deflate&lt;/a&gt;<br />
<br />
Thanks,<br />
- Brad</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(6530);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2012-04-27 2:04 pm</div>
				                <div>Thanks for the quick response!</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(6531);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-8807'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/4094286378f8a7727ed32b9d32b63b08?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/4094286378f8a7727ed32b9d32b63b08'>Greg Kavalec</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-06 5:19 pm</div>
				                <div><p>The extract in File Manager seems to skip nested folders in a zip.Any way to get these to extract properly?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8807);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-07 11:02 am</div>
				                <div>Nested folders should extract perfectly fine.  It may be this specific zip file that you are having trouble with.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8829);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-19744'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/272af99de5e98b402fd90146de1316d4?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/272af99de5e98b402fd90146de1316d4'>Malcolm</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-20 2:30 am</div>
				                <div>It did not tell me how to get to the File Manager</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19744);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-16 11:46 am</div>
				                <div>Hello Malcolm,<br />
<br />
Thank you for contacting us. You can get to the File manager in cPanel, by clicking the <strong>File Manager</strong> button in the <em>Files</em> section.<br />
<br />
<strong>Step 1</strong> in both sections above, include a link to our guide on <a href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-file-manager/using-file-manager-in-cpanel">Using File Manager in cPanel</a>.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28452);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
