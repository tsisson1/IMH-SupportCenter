<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50692:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/how-to/help-with-newrelic-installation" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Thecomputerguy4u, and thanks for your question. In order to install the Newrelic software as a service (SaaS) for monitoring your PHP applications..." />
  <title>Help with Newrelic installation | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/how-to/help-with-newrelic-installation" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:b3bad8918314bd84038931928895b085 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Help with Newrelic installation</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='http://graph.facebook.com/IraBrandstein/picture?type=normal' class='user_avatar' /><br />
			<a href='/support/community-support/users/Thecomputerguy4u'>Thecomputerguy4u</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-05-23 11:43 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>727</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Can anyone help me understand how to install Newrelic into my php.ini?  My first propblem is i do not have a php.ini in my public_html folder.<br />
Secondly how do I get the Newrelic script agent into the file manager and how do I invoke the install line.  Newrelic's instructions just do not make sense to me.<br />
<br />
Thank you</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_3187' id='upvote_answer_3187' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='3187' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_3187').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_3187' id='downvote_answer_3187' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='3187' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_3187').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>9,968 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2013-05-23 12:27 pm EST
                		        </div>
					
		                </div>

				Hello Thecomputerguy4u, and thanks for your question.<br />
<br />
In order to install the Newrelic software as a service (SaaS) for monitoring your PHP applications, you would first sign up for an account, grab your license key information, then install the PHP agent locally on your server. Finally you would configure the settings for both the agent as well as the proxy daemon.<br />
<br />
Your &lt;strong&gt;php.ini&lt;/strong&gt; file would contain the PHP agent settings, however in order to have the PHP agent loaded on the server so that you can alter the settings, it requires first installing the Newrelic PHP module, which unfortunately would only be available on our &lt;a href=&quot;http://www.inmotionhosting.com/dedicated-servers&quot; target=&quot;_blank&quot;&gt;Dedicated Server hosting plans&lt;/a&gt; and if it's something you would like for us to install for you there would be a one-time $25 installation fee.<br />
<br />
If you would like to install Newrelic yourself on a dedicated server, you would need to request &lt;a href=&quot;http://www.inmotionhosting.com/support/website/general-server-setup/root-access-faq&quot; target=&quot;_blank&quot;&gt;root access&lt;/a&gt; for your server, then you could simply follow the instructions they have for &lt;a href=&quot;https://newrelic.com/docs/php/php-agent-installation-redhat-and-centos&quot; target=&quot;_blank&quot; rel=&quot;nofollow&quot;&gt;Newrelic PHP agent installation for CentOS&lt;/a&gt;.<br />
<br />
I hope that helps, and if you had any further questions at all please let us know!<br />
<br />
- Jacob<br />
<br />
<br />
<br />
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_3187').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_3187' id='form_comment_on_answer_3187' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/how-to/help-with-newrelic-installation&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/how-to/help-with-newrelic-installation'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="cf068ac5f79b08679a17f81b655332bb" value="1" />	</div>
	</form>
<!-- <br />
