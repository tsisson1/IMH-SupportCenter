<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49633:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/website-troubleshooting/how-can-i-analyze-page-load-times-of-my-website" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hi johnnymac, Thanks for your question. I'm more than happy to help you today. I recommend using the gtmetrix.com website for looking at ways to improve..." />
  <title>How can I analyze page load times of my website? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/website-troubleshooting/how-can-i-analyze-page-load-times-of-my-website" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:ea9f1c9d8e72c9d00bc40920cbac4dc4 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '104.244.227.6']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>How can I analyze page load times of my website?</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/johnnymac'>johnnymac</a>
			<div>8 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-02-17 9:48 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>3,668</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I have a webpage that is loading too slowly and it must be specific parts of the page. Is there a website that would test the load time of all the parts of my webpage (js, images, includes, etc.) and suggest changes?</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_602' id='upvote_answer_602' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='602' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_602').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_602' id='downvote_answer_602' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='602' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_602').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hi johnnymac,<br />
<br />
Thanks for your question. I'm more than happy to help you today. I recommend using the gtmetrix.com website for looking at ways to improve website page load times. Here's a link to it:<br />
<br />
<a href="http://gtmetrix.com">GTMetrix.com</a><br />
<br />
...
Tim S
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_602').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_602' id='form_comment_on_answer_602' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/website-troubleshooting/how-can-i-analyze-page-load-times-of-my-website&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/website-troubleshooting/how-can-i-analyze-page-load-times-of-my-website'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="d9198a0e7e55647ce1f2047237b9a4fa" value="1" />	</div>
	</form>
<!-- <br />
