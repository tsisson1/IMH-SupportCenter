<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:75347:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.net/support/edu/mediawiki/change-media-wiki-appearance/edit-footer-mediawiki" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-01-03T19:56:20-08:00" />
  <meta name="keywords" content="add adding removing links remove Powered by MediaWiki image logo footer Media Wiki footermanager manager hide visible hiding change changing" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="This tutorial will walk through the steps of adding and removing links and removing the Powered by MediaWiki image from the footer of a MediaWiki site." />
  <title>Editing the Footer in MediaWiki - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/mediawiki/change-media-wiki-appearance/edit-footer-mediawiki" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<script type="text/javascript">
		...
		_gaq.push(['_setCustomVar', 3, 'DateMonthModified', '2013-01', 3]);
	...
	<!-- cid:0f4f5d8dffa7dbed11c56d10060e8499 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '107.175.88.134']);
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/mediawiki' itemprop='url'><span itemprop='title'>MediaWiki<span></a><div class='dropdown_4columns'><h2>MediaWiki Education Channel</h2><div class='col_2'><h3>100 Level Classes</h3><div><a href='/support/edu/mediawiki/getting-started-mediawiki'>101: Getting Started with MediaWiki</a></div><div><a href='/support/edu/mediawiki/adding-content-mediawiki'>102: Adding content to MediaWiki</a></div><div><a href='/support/edu/mediawiki/change-media-wiki-appearance'>103: Changing the MediaWiki appearance</a></div><div><a href='/support/edu/mediawiki/add-contact-form-media-wiki'>104: Adding a contact form in MediaWiki</a></div></div><div class='col_2'><h3>200 Level Classes</h3><div><a href='/support/edu/mediawiki/change-mediawiki-interface-language'>201: Changing the MediaWiki interface Language</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/mediawiki/change-media-wiki-appearance' itemprop='url'><span itemprop='title'>103: Changing the MediaWiki appearance<span></a><div class='dropdown_3columns'><h2> Changing the MediaWiki appearance</h2><div class='col_3'><div>1. <a style='display:inline;' href='/support/edu/mediawiki/change-media-wiki-appearance/changing-mediawiki-skins'>How to change MediaWiki skins</a></div><div>2. <a style='display:inline;' href='/support/edu/mediawiki/change-media-wiki-appearance/upload-custom-logo-mediawiki'>How to change the logo in MediaWiki</a></div><div>3. <a style='display:inline;' href='/support/edu/mediawiki/change-media-wiki-appearance/edit-footer-mediawiki'>Editing the Footer in MediaWiki</a></div><div>4. <a style='display:inline;' href='/support/edu/mediawiki/change-media-wiki-appearance/insert-slideshow-extension-javascriptslideshow'>Inserting a slideshow in MediaWiki</a></div><div>5. <a style='display:inline;' href='/support/edu/mediawiki/change-media-wiki-appearance/changing-css-media-wiki'>Changing the CSS in MediaWiki</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Editing the Footer in Medi...</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Editing the Footer in MediaWiki									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>48,590</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 3, 2013'><span style='color:#606060;'>Published:</span> Jan 3, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>MediaWiki has default links at the bottom of the page as well as a Powered by MediaWiki logo. These can be added and removed from the site to suit your needs. To remove the and add the links at the bottom, you will need an extension called FooterManager. The following can be added or removed from the footer using the FooterManager extension.</p>
<ul style="float: left; width: 200px; margin-top: 0px;">
<li>lastmod</li>
<li>viewcount</li>
<li>numberofwatchingusers</li>
<li>credits</li>
<li>copyright</li>
</ul>
<ul style="float: left; width: 200px; margin-top: 0px;">
...
<p>The Powered by MediaWiki image, also, can be hidden using CSS. This article will explain how to edit the footer links and remove the Powered by MediaWIki image from the footer.</p>
<h2>Download and install the Footer Manager</h2>
<p>The following 2 sections will explain how to download and install the FooterManager Extension.</p>
<h3>Download Extension:FooterManager</h3>
<p>First you will need to download the free Footer Manager. The Extension FooterManager can be downloaded at the following url:</p>
<p style="margin-left: 20px;"><a href="http://www.mediawiki.org/wiki/Extension:FooterManager">Extension:FooterManager</a></p>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/102/edit-footer/change-footer-1-download.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="Footer Manager link mediaWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/102/edit-footer/change-footer-1-download.gif" title="Click here to view the larger image" width="100" /></a>You will want the 0.0.1 version of the extension. Click the FooterManager-v0.0.1-r39.zip link.<br style="clear: both;" /></p>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/102/edit-footer/change-footer-2-footer-manager.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Download MediaWiki FooterManager" src="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/102/edit-footer/change-footer-2-footer-manager.gif" title="Click here to view the larger image" width="100" /></a>Click the current Date/Time link to initiate the download. Once you have downloaded the file you should have a .zip file with the following name on your computer.</p>
<p style="margin-left: 20px;">FooterManager-v0.0.1-r39.zip<br style="clear: both;" /></p>
<h3>Upload the Footer Manager to your Mediawiki</h3>
<p>Now that your have the files required, follow the next steps to install the Footer Manager to your MediaWiki site.</p>
...
<li><a href="/support/edu/cpanel/cpanel-file-manager/using-file-manager-in-cpanel" target="_blank" title="Click here for info">Go to the File Manager</a>. Select your Mediawiki location and click Go. Upload the FooterManager-v0.0.1-r39.zip file to the following directory.
<p style="margin-left: 20px;">public_html/your-mediawiki-folder/extensions</p>
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/102/edit-footer/change-footer-3-upload.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Upload the FooterManagr Extension MediaWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/102/edit-footer/change-footer-3-upload.gif" title="Click here to view the larger image" width="100" /></a><a target="_blank" href="/support/website/cpanel/compressing-uncompressing-files"><strong>Extract the .zip file</strong></a> so the extension folder has the Footermanager folder like the snapshot to the right.<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/102/edit-footer/change-footer-4-edit-localsettings.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Edit LocalSettings.php MediaWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/102/edit-footer/change-footer-4-edit-localsettings.gif" title="Click here to view the larger image" width="100" /></a>Navigate to the LocalSettings.php file in the following location.
<p style="margin-left: 20px;">/public_html/your-mediawiki-folder/LocalSettings.php</p>
<p>Open the LocalSettings.php in the code editor.</p>
<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/102/edit-footer/change-footer-4-require-once.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Add the require_once code MediaWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/102/edit-footer/change-footer-4-require-once.gif" title="Click here to view the larger image" width="100" /></a>Add the require_once script to the LocalSettings.php.
<pre style="margin-left: 20px;">require_once('extensions/FooterManager/FooterManager.php');</pre>
<br style="clear: both;" /></li>
</ol>
<h2>Removing Links from the footer</h2>
<ol class="article_list">
<li><a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel" target="_blank" title="Click here for info">Login into your cPanel</a></li>
<li><a href="/support/edu/cpanel/cpanel-file-manager/using-file-manager-in-cpanel" target="_blank" title="Click here for info">Go to the File Manager</a>. Select your Mediawiki location and click Go.</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/102/edit-footer/change-footer-5-add-php-code.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Add php code to LocalSettings.php MediaWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/102/edit-footer/change-footer-5-add-php-code.gif" title="Click here to view the larger image" width="100" /></a>Navigate to the LocalSettings.php file in the following location.
<p style="margin-left: 20px;">/public_html/your-mediawiki-folder/LocalSettings.php</p>
<p>Add the following lines of code to the bottom of the page and save the page.</p>
<pre style="kmargin-left: 20px;">$wgFooterManagerLinks['numberofwatchingusers']=false;<br />
$wgFooterManagerLinks['credits']=false;<br />
$wgFooterManagerLinks['copyright']=false;<br />
$wgFooterManagerLinks['tagline']=false;<br />
$wgFooterManagerLinks['privacy']=false;<br />
$wgFooterManagerLinks['about']=false;<br />
$wgFooterManagerLinks['disclaimer']=false;<br />
$wgFooterManagerLinks['viewcount']=false;<br />
$wgFooterManagerLinks['lastmod']=false;</pre>
<br style="clear: both;" />
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/102/edit-footer/change-footer-6-without-links.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="MediaWiki footer with no links" src="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/102/edit-footer/change-footer-6-without-links.gif" title="Click here to view the larger image" width="100" /></a>Check your mediawiki site.</p>
<p>Setting these to false will hide them all from the footer of your site.<br style="clear: both;" /></p>
</li>
</ol>
<h2>Adding links to the Footer</h2>
<ol class="article_list">
<li>Repeat the previous steps for finding the LocalSettings.php file. Edit the LocalSettings.php with the code editor.</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/102/edit-footer/change-footer-7-true.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Set code to true MediaWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/102/edit-footer/change-footer-7-true.gif" title="Click here to view the larger image" width="100" /></a>Change the following settings to true and save the page.
<pre style="margin-left: 20px;">$wgFooterManagerLinks['privacy']=false;<br />
$wgFooterManagerLinks['about']=false;<br />
$wgFooterManagerLinks['disclaimer']=false;</pre>
<br style="clear: both;" />
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/102/edit-footer/change-footer-8-with-links.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="MediaWiki Footer with links" src="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/102/edit-footer/change-footer-8-with-links.gif" title="Click here to view the larger image" width="100" /></a>Check your mediawiki site and you will see the links you set to true are now visible. <br style="clear: both;" /></p>
</li>
</ol>
<h2>Removing the powered by mediawiki image</h2>
<ol class="article_list">
<li><a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel" target="_blank" title="Click here for info">Login into your cPanel</a></li>
<li><a href="/support/edu/cpanel/cpanel-file-manager/using-file-manager-in-cpanel" target="_blank" title="Click here for info">Go to the File Manager</a>. Select your mediawiki location and click Go.
<p>Find the following .CSS file.</p>
<p style="margin-left: 20px;">/public_html/your-mediawiki-folder/skins/common/commonContent.css</p>
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/102/edit-footer/change-footer-10-display-none.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Set CSS to display none MediaWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/102/edit-footer/change-footer-10-display-none.gif" title="Click here to view the larger image" width="100" /></a>Open the commonContent.css file with the code editor and add the following code to the bottom of the page.
<pre style="margin-left: 20px;">#footer-poweredbyico { display: none; }</pre>
<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/102/edit-footer/change-footer-11-logo-gone.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="MediaWiki image removed" src="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/102/edit-footer/change-footer-11-logo-gone.gif" title="Click here to view the larger image" width="100" /></a>Save the file and visit your MediaWiki site. You should see the Powered by MediaWiki logo gone now. <br style="clear: both;" /></li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/mediawiki/change-media-wiki-appearance'>103: Changing the MediaWiki appearance</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 3: Editing the Footer in MediaWiki</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 2: <a href='/support/edu/mediawiki/change-media-wiki-appearance/upload-custom-logo-mediawiki'>How to change the logo in MediaWiki</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 4: <a href='/support/edu/mediawiki/change-media-wiki-appearance/insert-slideshow-extension-javascriptslideshow'>Inserting a slideshow in MediaWiki</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMTQmaWQ9MjEzOCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="b4fdac149ba6bc1bad2af7fc53074a0a" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/mediawiki/change-media-wiki-appearance?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Changing the MediaWiki appearance</h3></a>
		<table><tr><td colspan='2'><h4>Themes, templates, and skins</h4></td></tr>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/mediawiki/change-media-wiki-appearance/changing-mediawiki-skins?tsrc=rsbedu'>How to change MediaWiki skins</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/mediawiki/change-media-wiki-appearance/upload-custom-logo-mediawiki?tsrc=rsbedu'>How to change the logo in MediaWiki</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/mediawiki/change-media-wiki-appearance/edit-footer-mediawiki?tsrc=rsbedu'>Editing the Footer in MediaWiki</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/mediawiki/change-media-wiki-appearance/insert-slideshow-extension-javascriptslideshow?tsrc=rsbedu'>Inserting a slideshow in MediaWiki</a></td>
                </tr>
          <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/mediawiki/change-media-wiki-appearance/changing-css-media-wiki?tsrc=rsbedu'>Changing the CSS in MediaWiki</a></td>
                </tr>
          	</table>
...
<a name='comments'></a>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//graph.facebook.com/karthikr.rajan/picture?type=normal' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='/support/community-support/users/intech&per;karthik@gmail&per;com'>intech.karthik@gmail.com</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-07-12 7:59 am</div>
				                <div>I can't Download the  (Extension:FooterManager) Zip file please help , any other way can do it </div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8028);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-07-12 10:08 am</div>
				                <div>It appears the website with the zip file is not accessible at this time. You can download the files here.<br /> <br /> &lt;a href=&quot;http://inmotionhosting.com/support/images/stories/edu/mediawiki/103/FooterManager-v0.0.1-r39.zip&quot;&gt;FooterManager-v0.0.1-r39.zip&lt;/a&gt;</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8029);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/d9ec8a19eafcdb853313576c970503c4?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/d9ec8a19eafcdb853313576c970503c4'>Quang pham</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-02 11:38 pm</div>
				                <div><p>I want change links and powered by mediawiki image by another links and another image, how to change???</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25399);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-03 2:04 pm</div>
				                <div>Hello Quang,<br />
<br />
To do that you would need to learn how to edit the core files. This is not recommended as whenever you perform an update the files you changed will need to be recoded.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25434);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-03 11:07 pm</div>
				                <div><p>&nbsp;I know but i don't find this file. let me know file' name. &nbsp;help me!!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25445);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-04 9:07 am</div>
				                <div>Hello Quang,<br />
<br />
If you are using the default MediaWiki skin then it is Vector. The file you would edit is media_wiki/skins/Vector/VectorTemplate.php around line 152 is the footer that it prints.<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25451);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
