<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:58303:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/wordpress/customize-wp-sidebar/sidebar-image-links" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-01-25T18:32:22-08:00" />
  <meta name="keywords" content="sidebar image link button Wordpress" />
  ...
  <link href="http://www.inmotionhosting.com/support/edu/wordpress/customize-wp-sidebar/sidebar-image-links" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:a7d005e6cbfc64a3c04385da3817611c -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to add images and image links to your WordPress sidebar									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>1,882</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 25, 2013'><span style='color:#606060;'>Published:</span> Jan 25, 2013</div>
...
<ol class="article_list">
	...
	<li>This brings you to the main <em>Editor</em> page for all php and css files for your current theme. Look to the menu on the right-hand side and scroll down until you see the <strong>Sidebar</strong> option. Click on that link to open the <em>sidebar.php</em> file in the editor.<br /><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/wordpress/sidebar/nested-list/select-editor.png"><img  alt="select editor menu option" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/wordpress/sidebar/nested-list/select-editor.png" /></a></li>
	<li>With the <em>sidebar.php</em> file open in the editor, you can edit the code and add your image. The snippet of code below is an image link that points to the XML reference site. Notice the &lt;img&gt; tag uses the URL of an image on the test site. This is an image that was uploaded to the hosting account, which you can do either with the <a href="/support/edu/cpanel/cpanel-file-manager/using-file-manager-in-cpanel">cPanel File Manager</a> or by <a href="/support/website/file-management/getting-started-guide-ftp">FTP</a>. You can also point it to a location on another site if they allow you to do so.<br />
		<div class="code_block">&nbsp;&nbsp;&nbsp;&nbsp; &lt;a href="http://xml.com"<br />&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; title="XML Reference Site"&gt;<br />&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &lt;img src="http://wordpress.inmotiontesting.com/xml.jpg"<br />&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; alt="Valid XHTML 1.0!" /&gt;<br />&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&lt;/a&gt;<br />&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&lt;br /&gt;</div><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/wordpress/sidebar/image-link/add-code.png"><img  alt="adding image link code to file" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/wordpress/sidebar/image-link/add-code.png" /></a></li>
	<li>Once you have entered the code and ensured your image is in the right location, click on the <strong>Update File</strong> button to save the change and activate the code. Below is a shot of the test site with the XML image link pointing to the XMP site.<br /><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/wordpress/sidebar/image-link/image-after.png"><img  alt="image sample after adding" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/wordpress/sidebar/image-link/image-after.png" /></a><br /><br /></li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 4: How to add images and image links to your WordPress sidebar</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 3: <a href='/support/edu/wordpress/customize-wp-sidebar/sidebar-metadata'>Adding Meta Data to your WordPress sidebar</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/wordpress/customize-wp-sidebar/sidebar-image-links&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/wordpress/customize-wp-sidebar/sidebar-image-links'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMjkmaWQ9MjIwOCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="8420aa3fb613667f8a3180d02a022de9" value="1" />	</div>
	</form>
<!-- <br />
