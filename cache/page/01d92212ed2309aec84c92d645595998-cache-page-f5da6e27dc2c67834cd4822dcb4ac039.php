<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:65457:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/drupal-7/getting-started/initial-configuration-of-drupal-installation" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-05-02T16:35:25-07:00" />
  <meta name="keywords" content="drupal configuration install configure" />
  <meta name="author" content="Tim Sisson" />
  <meta name="description" content="After you have uploaded the files for Drupal to your hosting account, this tutorial will show you how to configure the rest of the installation for Drupal. " />
  <title>Manually install Drupal 7 - Part 2/2 - Initial Configuration - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/drupal-7/getting-started/initial-configuration-of-drupal-installation" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:4734ed6dfcdbd978b1dba03fec8717ad -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '123.126.68.101']);
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
				<img src='/support/images/stories/drupal-partner/supporting-partner-80_3.png' style='float:right; margin:0px 0px 15px 15px;' alt='Drupal Association Support Partner'>		<h1>
															Manually install Drupal 7 - Part 2/2 - Initial Configuration									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>5,000</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Feb 13, 2012'><span style='color:#606060;'>Published:</span> May 2, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<p>This article is part 2 of our two part article on manually installing Drupal 7. The first part took you through <a href="/support/edu/drupal-7/getting-started/manually-installing-the-latest-version-of-drupal">database and file setup</a>. This part will walk you through setting up the initial configuration of your Drupal 7 installation. Again, these same steps will apply, regardless of whether you're using Shared, VPS, or <a href="http://www.inmotionhosting.com/drupal-hosting/drupal-dedicated-hosting.html">Drupal Dedicated Hosting</a>.</p>
<p><strong>To configure the Drupal 7 installation:</strong>
</p>
<ol class="article_list">
	<li>Visit <strong>example.com/install.php</strong> (<em>replacing example.com with your actual domain</em>)</li>
	<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/drupal/drupal_install_7.jpg"><img src="//cdn.inmotionhosting.com/support/images/stories/drupal/drupal_install_7.jpg" alt="drupal_install_7"  /></a>
	</p>
	<li>Choose the <strong>Standard</strong> installation and click <strong>Save and Continue</strong></li>
	<li>Select <strong>English</strong> for the language and click <strong>Save and Continue</strong></li>
	<li>Enter in your <em>Database name, Database username, and Database password</em> (these are the details you wrote down from part 1) and click <strong>Save and Continue</strong></li>
	<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/drupal/drupal_install_8.jpg"><img src="//cdn.inmotionhosting.com/support/images/stories/drupal/drupal_install_8.jpg" alt="drupal_install_8"  /></a>
	</p>
	<li>Fill in the Site configuration settings</li>
	<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/drupal/drupal_install_9.jpg"><img src="//cdn.inmotionhosting.com/support/images/stories/drupal/drupal_install_9.jpg" alt="drupal_install_9"  /></a>
	</p>
	<table class="article_table">
		<tbody>
			<tr>
				<th>Site Name</th>
				<td>This is the site's name. You can change it to whatever you like.</td>
			</tr>
			<tr>
				<th>Site Email Address</th>
				<td>This is the email account all emails from your Drupal site will be sent from.</td>
			</tr>
			<tr>
				<th>Username</th>
				<td>This is the administrator account's user name.</td>
			</tr>
			<tr>
				<th>Password</th>
				<td>This is the password for the administrator account.</td>
			</tr>
			<tr>
				<th>Confirm Password</th>
				<td>Re-enter the password here for confirmation.</td>
			</tr>
			<tr>
				<th>Default Country</th>
				<td>Select your default country.</td>
			</tr>
			<tr>
				<th>Default Time Zone</th>
				<td>Select the time zone you want the site to use.</td>
			</tr>
			<tr>
				<th>Update Notifications</th>
				<td>These settings are used to check for updates and send email verifications</td>
			</tr>
		</tbody>
	</table>
	<li>Click <strong>Save and Continue</strong></li>
</ol>
<p>At this point you have configured your Drupal installation. And you can now visit your website to see the default installation of Drupal and to <a href="/support/edu/drupal-7/getting-started/how-to-log-into-the-drupal-admin-dashboard">log into your admin dashboard</a>. For more information on this course please visit <a href="/support/edu/drupal-7/getting-started">Installing and Getting Started with Drupal 7</a>.</p>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/drupal/drupal_install_10.jpg"><img src="//cdn.inmotionhosting.com/support/images/stories/drupal/drupal_install_10.jpg" alt="drupal_install_10"  /></a>
</p>
<p>If you need further assistance please feel free to <a href="/support/community-support">ask a question on our support center</a>.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 4: Manually install Drupal 7 - Part 2/2 - Initial Configuration</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 5: <a href='/support/edu/drupal-7/getting-started/how-to-log-into-the-drupal-admin-dashboard'>How to log into the Drupal 7 Administrator Dashboard</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/drupal-7/getting-started/initial-configuration-of-drupal-installation&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/drupal-7/getting-started/initial-configuration-of-drupal-installation'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yMDEmaWQ9MTE1MiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="ac5cf34b4911b0495270cf1c2251e1d5" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//graph.facebook.com/suzeq522/picture?type=normal' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='/support/community-support/users/Suzannec'>Suzannec</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-09-12 11:51 am</div>
				                <div>My current domain name is in limbo because I can't transfer it to Inmotion for 60 days. I am trying to do a manual install of Drupal so I can begin building my site. I's at part 2/2 Initial configuration, since I can't acces my domain name what are my options.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8208);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-09-13 2:47 pm</div>
				                <div>Hello Suzannec,<br />
<br />
Thanks for the question.  You can get around this issue by simply making what's called a host file mod.  What this does is make it so that your computer THINKS that the URL that you are using is going to a particular IP.  To put it in simpler terms, you can use your domain name - or just the www version of it and direct it to our hosting server - all BEFORE you move your domain to us.  NOTE - if you designate the www version of your domain name to go to our server, then everytime you place it in the browser after the host file mod, it will pull up the website on our server.  The host file mod ONLY applies to the computer where the modification is made.  Follow this tutorial <a href="http://www.inmotionhosting.com/support/website/how-to/modifying-your-hosts-file" target="new">modifying your host file</a> in order to make the changes you need.  You can find your server IP <a href="http://www.inmotionhosting.com/support/website/cpanel/how-to-find-your-shared-ip-address-of-your-server-in-cpanel" target="new">here</a>.<br />
<br />
One last thing - this means that you can use your domain name for the Drupal installation.  Use the www form in the host file mod (e.g. www.domain_name.com) and when it comes time to move your domain to our hosting, you won't need to make any change to your drupal installation. You would just need to remove the host file modification.<br />
<br />
Let us know if you need any further assistance.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8214);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
