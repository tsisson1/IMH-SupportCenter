<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:66405:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/premium-website-builder/web-builder-building-first-website/installing-premium-web-builder" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-06-09T21:39:00-07:00" />
  <meta name="keywords" content="AMP PWB premium web builder install" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="Learn how to install the Premium Web Builder using your Account Management Panel (AMP)." />
  <title>Add/Remove the Premium Web Builder from AMP - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/premium-website-builder/web-builder-building-first-website/installing-premium-web-builder" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:6bd7a0d6f54b6570cb167fae585add37 -->
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/premium-website-builder' itemprop='url'><span itemprop='title'>Premium Website Builder<span></a><div class='dropdown_4columns'><h2>Premium Website Builder Education Channel</h2><div class='col_2'><h3>100 Level Classes</h3><div><a href='/support/edu/premium-website-builder/web-builder-building-first-website'>101: Building a Website</a></div><div><a href='/support/edu/premium-website-builder/customizing-website'>102: Customizing your Website</a></div><div><a href='/support/edu/premium-website-builder/linking-in-the-web-builder'>103: Linking in the Premium Web Builder</a></div><div><a href='/support/edu/premium-website-builder/modules-premium-builder'>104: Working with Modules in the builder</a></div></div><div class='col_2'><h3>200 Level Classes</h3><div><a href='/support/edu/premium-website-builder/create-image-gallery'>201: Creating an Image Gallery</a></div><div><a href='/support/edu/premium-website-builder/create-blog'>202: Creating a Blog</a></div><div><a href='/support/edu/premium-website-builder/create-eshop-online-store'>203: Creating an Online Store - eShop</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/premium-website-builder/web-builder-building-first-website' itemprop='url'><span itemprop='title'>101: Building a Website<span></a><div class='dropdown_3columns'><h2> Building a Website</h2><div class='col_3'><div>1. <a style='display:inline;' href='/support/edu/premium-website-builder/web-builder-building-first-website/installing-premium-web-builder'>Add/Remove the Premium Web Builder from AMP</a></div><div>2. <a style='display:inline;' href='/support/edu/premium-website-builder/web-builder-building-first-website/builder-login'>How to log into the Premium Website Builder</a></div><div>3. <a style='display:inline;' href='/support/edu/premium-website-builder/web-builder-building-first-website/choosing-your-site-type-in-premium-web-builder'>Choosing Your Site Type in Premium Web Builder</a></div><div>4. <a style='display:inline;' href='/support/edu/premium-website-builder/web-builder-building-first-website/finding-a-template-for-your-website'>Finding a Template for your Website</a></div><div>5. <a style='display:inline;' href='/support/edu/premium-website-builder/web-builder-building-first-website/building-website-layout'>Building your Website Layout</a></div><div>6. <a style='display:inline;' href='/support/edu/premium-website-builder/web-builder-building-first-website/adding-content-website'>Adding Content to your Website</a></div><div>7. <a style='display:inline;' href='/support/edu/premium-website-builder/web-builder-building-first-website/insert-image'>How to insert an image in Premium Website Builder</a></div><div>8. <a style='display:inline;' href='/support/edu/premium-website-builder/web-builder-building-first-website/publishing-your-website'>Publishing your Website</a></div><div>9. <a style='display:inline;' href='/support/edu/premium-website-builder/web-builder-building-first-website/creating-headlines-builder'>Creating H1, H2, and H3 headlines in the Builder</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Add/Remove the Premium Web ...</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Add/Remove the Premium Web Builder from AMP									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>21,620</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Sep 7, 2011'><span style='color:#606060;'>Published:</span> Jun 9, 2014</div>
  ...
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('add');">Add the Builder</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('remove');">Remove the Builder</button>
</div>

<div class="alert">Before you add the Premium Website Builder to your account, check to see if <a href="/support/edu/website-design/website-design-basics/can-builder-meet-my-needs">it is right for you</a>.</div>

<p>You can install <strong>Premium Web Builder</strong> on your website using your <strong>Account Management Panel (AMP)</strong>. Premium Web Builder, is installed on the server and does not install anything on your local computer. You access your Premium Web Builder account in a web browser however, it does not install anything onto your web browser.</p>
<p>Please note, that if you already have Premium Web builder installed on a domain, to install it on a subsequent domain there is a $12 per year license fee.&nbsp;</p>

<a name="add"></a>
<h2>Adding the Premium Web Builder:</h2>
<ol class="article_list">

<li>
  <p><a href="/support/website/amp/how-to-log-into-amp">Login to AMP</a>.</p></li>

<li>Under your account name, click the <strong>Install Popular Software</strong> button.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/revamp/install-popular-software.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/revamp/install-popular-software.png" alt="" /></a></li>

<li>On the <em>Install Popular Software</em> page, click the <strong>Install Premium Web Builder</strong> button.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/revamp/install-premium-builder.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/revamp/install-premium-builder.png" alt="" /></a><br><br>
  
You will then see a message stating "<em>The Premium Web Builder has been successfully installed for your account. You can log in from your AMP Home page by clicking the Premium Web Builder icon in your Hosting Controls box.
For our full Builder Library of help articles you can <a href="/support/edu/premium-website-builder">click here</a>.</em>"<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/revamp/successful-builder-install.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/revamp/successful-builder-install.png" alt="" /></a><br><br>

You will now have a <em>Premium Web Builder</em> button on your main AMP page.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/revamp/premium-web-builder-button.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/revamp/premium-web-builder-button.png" alt="" /></a><br></li>
</ol>

<a name="remove"></a>
<h2>Removing The Premium Web Builder from your account</h2>
<ol class="article_list">
  <li><a href="/support/website/amp/how-to-log-into-amp">Login to AMP</a>.</li>
<li>Click the <strong>Billing</strong> link in the main menu.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/revamp/billing.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/revamp/billing.png" alt="" /></a></li>

<li>You will then see all of your subscriptions listed, click the <strong>Cancel Website Builder</strong> link to the right of your <em>Website Builder</em>.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/revamp/cancel-builder.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/revamp/cancel-builder.png" alt="" /></a></li>
<li>Confirm you want to cancel the Builder on the next screen by clicking the <strong>Submit</strong> button.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/revamp/cancel-builder-subscription.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/revamp/cancel-builder-subscription.png" alt="" /></a><br><br>
You will then see a message stating "<em>You have canceled your Website Builder subscription.</em>"<br></li>
<br>
</ol>
<br>
<p>Please check the next article on <a target="_blank" href="/support/edu/premium-website-builder/web-builder-building-first-website/builder-login" title="Click here to view the next article">How to log into the Premium Website Builder</a>. For more information on this course please visit <a target="_blank" href="/support/edu/premium-website-builder/web-builder-building-first-website" title="Click here to view the courses">Building a Website</a></p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/premium-website-builder/web-builder-building-first-website'>101: Building a Website</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 1: Add/Remove the Premium Web Builder from AMP</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 2: <a href='/support/edu/premium-website-builder/web-builder-building-first-website/builder-login'>How to log into the Premium Website Builder</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/premium-website-builder/web-builder-building-first-website/installing-premium-web-builder&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/premium-website-builder/web-builder-building-first-website/installing-premium-web-builder'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xMzcmaWQ9OTkxJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="b6aad2a80d2224e3301d81baa2d544eb" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/premium-website-builder/web-builder-building-first-website?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Building a Website</h3></a>
		<table>  <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/premium-website-builder/web-builder-building-first-website/installing-premium-web-builder?tsrc=rsbedu'>Add/Remove the Premium Web Builder from AMP</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/premium-website-builder/web-builder-building-first-website/builder-login?tsrc=rsbedu'>How to log into the Premium Website Builder</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/premium-website-builder/web-builder-building-first-website/choosing-your-site-type-in-premium-web-builder?tsrc=rsbedu'>Choosing Your Site Type in Premium Web Builder</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/premium-website-builder/web-builder-building-first-website/finding-a-template-for-your-website?tsrc=rsbedu'>Finding a Template for your Website</a></td>
                </tr>
          <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/premium-website-builder/web-builder-building-first-website/building-website-layout?tsrc=rsbedu'>Building your Website Layout</a></td>
                </tr>
          <tr >
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/premium-website-builder/web-builder-building-first-website/adding-content-website?tsrc=rsbedu'>Adding Content to your Website</a></td>
                </tr>
          <tr >
                        <td valign='top'>7.</td>
                        <td><a href='/support/edu/premium-website-builder/web-builder-building-first-website/insert-image?tsrc=rsbedu'>How to insert an image in Premium Website Builder</a></td>
                </tr>
          <tr >
                        <td valign='top'>8.</td>
                        <td><a href='/support/edu/premium-website-builder/web-builder-building-first-website/publishing-your-website?tsrc=rsbedu'>Publishing your Website</a></td>
                </tr>
          <tr >
                        <td valign='top'>9.</td>
                        <td><a href='/support/edu/premium-website-builder/web-builder-building-first-website/creating-headlines-builder?tsrc=rsbedu'>Creating H1, H2, and H3 headlines in the Builder</a></td>
                </tr>
          	</table>
			...
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/billing/web-builder-install-error-message?tsrc=rsbraq'>web builder install error message</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/website-design/cannot-access-website-builder?tsrc=rsbraq'>Cannot access website builder</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/d3463ff163e149d09fdc2e4ab9c21d91?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/d3463ff163e149d09fdc2e4ab9c21d91'>Charles Grooms</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-08 4:05 pm</div>
				                <div>Simple to follow maybe a short Video overview.. also maybe a short over view video to show an actual site and the set-up process unless you already thought of that and i'll see it in the next tutorial.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12504);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-08 4:32 pm</div>
				                <div>Hello Charles,<br />
<br />
Thank you for your comment and suggestion. I'll add this guide to our list of ones that could possibly benefit from a short video!<br />
<br />
Thanks again for taking the time to share your recommendation!<br />
<br />
- Jacob</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12505);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-18541'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/3de5923b49363898d9d4ca12077cff93?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/3de5923b49363898d9d4ca12077cff93'>christinebelle</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-16 4:17 am</div>
				                <div><p>my website http://www.dell-driver.com is build with wordpress, but i have never notice this function. And today i knows from your website. thanks.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(18541);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
