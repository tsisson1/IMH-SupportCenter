<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:65706:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/wordpress/wordpress-security-plugins/how-to-install-the-secure-folder-wp-content-uploads-plugin-for-wordpress" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-04-02T15:50:35-07:00" />
  <meta name="keywords" content="Secure  Folder wp-content/uploads plugin wordpress install" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="You can secure your  WordPress wp-content/uploads folder with the Secure  Folder wp-content/uploads plugin. This article will explain how." />
  <title>How to install the Secure Folder wp-content/uploads plugin for WordPress - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/wordpress/wordpress-security-plugins/how-to-install-the-secure-folder-wp-content-uploads-plugin-for-wordpress" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:d56736c913883e3cae1ccb3ca852f98c -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to install the Secure Folder wp-content/uploads plugin for WordPress									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>3,353</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Apr 1, 2013'><span style='color:#606060;'>Published:</span> Apr 2, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>WordPress by default may not have the wp-content/uploads folder secured with an index page in it. When the wp-content/uploads folder has no index page, the contents of the folder can be viewed through the browser. This article will explain how to install and configure the Secure Folder wp-content/uploads plugin for WordPress.</p>

<h2>Installing the Secure Folder wp-acontent/uploads plugin</h2>
...
<li>Go to the plugins and Click <strong>Add New</strong>. Search for security in the search bar.</li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/205/secure-folder/secure-folder-1-install.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Install Secure Folder wp-content/uploads plugin for WordPress" src="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/205/secure-folder/secure-folder-1-install.png" title="Click here to view the larger image" width="100" /></a>Find the &quot;<em>Secure Folder wp-content/upload plugin</em>&quot; and click <strong>Install Now</strong>.
<br style="clear: both;" />
</li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/205/secure-folder/secure-folder-2-activate.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Activate Secure Folder wp-content/uploads plugin for WordPress" src="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/205/secure-folder/secure-folder-2-activate.png" title="Click here to view the larger image" width="100" /></a>Click <strong>Activate plugin</strong>.
<br style="clear: both;" />
</li>


<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/205/secure-folder/secure-folder-3-settings.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Settings Secure Folder wp-content/uploads plugin for WordPress" src="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/205/secure-folder/secure-folder-3-settings.png" title="Click here to view the larger image" width="100" /></a>Now that the plugin is installed, go to <strong>Settings > Secure Folder</strong> to go to the Secure Folder Plugin Dashboard.
<br style="clear: both;" />
</li>


<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/205/secure-folder/secure-folder-4-check-folder.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Check Folder Secure Folder wp-content/uploads plugin for WordPress" src="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/205/secure-folder/secure-folder-4-check-folder.png" title="Click here to view the larger image" width="100" /></a>Click the link that says, &quot;<em>Click here to check is your wp-content/uploads folder are open</em>&quot;.
<br style="clear: both;" />


<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/205/secure-folder/secure-folder-5-indexing.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="indexing Secure Folder wp-content/uploads plugin for WordPress" src="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/205/secure-folder/secure-folder-5-indexing.png" title="Click here to view the larger image" width="100" /></a>If you see an &quot;<em>Index of</em> &quot; page display you will need to run the Secure Folder script.
<br style="clear: both;" />
</p></li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/205/secure-folder/secure-folder-6-secure-folder.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Claick Secure Folder Secure Folder wp-content/uploads plugin for WordPress" src="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/205/secure-folder/secure-folder-6-secure-folder.png" title="Click here to view the larger image" width="100" /></a>Go back to the Secure Folder Plugin  in your WordPress Dashboard. Click <strong>Secure Folder</strong>.
<br style="clear: both;" />


<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/205/secure-folder/secure-folder-7-secured.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Secured wp-content/uploads Secure Folder wp-content/uploads plugin for WordPress" src="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/205/secure-folder/secure-folder-7-secured.png" title="Click here to view the larger image" width="100" /></a>If the wp-content/uploads file shows a blank screen then the folder is secured.
<br style="clear: both;" />
</p></li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 12: How to install the Secure Folder wp-content/uploads plugin for WordPress</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 11: <a href='/support/edu/wordpress/wordpress-security-plugins/install-and-set-up-the-sucuri-security-sitecheck-malware-scanner-plugin-for-wordpress'>Install and Set up the Sucuri Security - SiteCheck Malware Scanner plugin for WordPress</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 13: <a href='/support/edu/wordpress/wordpress-security-plugins/wp-recaptcha'>How to install WP-reCAPTCHA in WordPress</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/wordpress/wordpress-security-plugins/how-to-install-the-secure-folder-wp-content-uploads-plugin-for-wordpress&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/wordpress/wordpress-security-plugins/how-to-install-the-secure-folder-wp-content-uploads-plugin-for-wordpress'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zNjcmaWQ9MjU2OSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="23e8cd84de3c34a6e103837c3ef7a14e" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
        ...
        <tr><td colspan='2'><h4>Other Security Plugins</h4></td></tr>  <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>12.</td>
