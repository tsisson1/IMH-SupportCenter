<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49804:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/prestashop-15/prestashop-module-causing-access-denied-ip-address-blacklisted-error" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, Sorry to hear about your issue with the PrestaShop plugin. I went to both links you provided and both are giving the same output. I am not seeing..." />
  <title>Prestashop module causing Access denied, ip address blacklisted error | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/prestashop-15/prestashop-module-causing-access-denied-ip-address-blacklisted-error" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:143fdd1bd874c8e4a4c58fb4e08eba55 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '80.32.136.153']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Prestashop module causing Access denied, ip address blacklisted error</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-04-13 3:51 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>299</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I am using prestashop 1.6. And three third party modules are causing error: &quot;Access Denied! Your address is blacklisted. More information about this error may be available in the server error log.&quot;<br />
The modules are from well known developer and he has demostrated me that they work with other hosts. I contacted inmotion hostings technical support live chat, but they were not able to find the problem: telling that the error logs are empty. They also looked at the code an find no error. Also tried updating php.ini and so on but nothing worked.<br />
The file that is causing the error: http://hullhundu.ee/dpd-fetch-test.php<br />
And the output it should give if it would work correctly: http://demo.aktsia.ee/dpd-fetch-test.php <br />
<br />
How is it possible that inmotion hosting is the only one those modules doesn't work with. Can I do something to make it work or do I just need to change the host?<br />
</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_7014' id='upvote_answer_7014' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='7014' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_7014').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_7014' id='downvote_answer_7014' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='7014' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_7014').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
Sorry to hear about your issue with the PrestaShop plugin. I went to both links you provided and both are giving the same output. I am not seeing any sort of error on your page. Were you able to fix the issue? <br />
<br />
Kindest Regards,<br />
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_7014').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_7014' id='form_comment_on_answer_7014' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/prestashop-15/prestashop-module-causing-access-denied-ip-address-blacklisted-error&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/prestashop-15/prestashop-module-causing-access-denied-ip-address-blacklisted-error'></div>
<script type='text/javascript'>
  (function() {
