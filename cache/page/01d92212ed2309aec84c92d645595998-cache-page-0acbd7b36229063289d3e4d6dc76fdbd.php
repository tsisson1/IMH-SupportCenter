<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:46622:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/dokuwiki/geting-started-dokuwiki" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="keywords" content="steps setting up Dokuwiki set setup install installing log in login user manage" />
  <meta name="description" content="The following courses will explain the overview, installation, and login for DokuWiki." />
  <title>101: Getting Started with Dokuwiki | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/dokuwiki/geting-started-dokuwiki" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:deec5c7790463122ce8764e3d6cf6863 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '173.225.247.220']);
...
<div class='page-header'>
	<h1>101: Getting Started with Dokuwiki</h1>
</div>
<div class='section_listing'>
	<h1>DokuWiki 101: Getting started</h1>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/101/getting-started-dokuwiki.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Getting Started with DokuWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/101/getting-started-dokuwiki.gif" title="Click here to view the larger image" width="100" /></a>Welcome to the 101 course for getting started with DokuWiki. This course will cover the basics of installing and logging into DokuWiki. First we will discuss what DokuWiki is. Then we will learn to install DokuWiki with Softaculous or by downloading the software from the DokuWiki site. Lastly, you will learn about the DokuWiki login and user management.<br style="clear: both;" /></p>

<p>The next level of DokuWiki tutorials is the "<a href="/support/edu/dokuwiki/writing-content-dokuwiki">Writing content for DokuWiki - Dokuwiki 102</a>" course.</p>	<table>
	<tr><td colspan='3'><h2>DokuWiki Overview</h2><div>What is DokuWiki? What are the basics steps to create a DokuWiki site?</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 1:</td>
				<td style='padding-right:10px;'><div class='gold_star'></div></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/dokuwiki/geting-started-dokuwiki/what-is-doku'>What is DokuWiki?</a>
					<div>Before beginning with DokuWiki, you will want to know what the software is for. This overview will explain what a basic DokuWiki site is.</div>
					<div class='smallgrey'>Hits: 2,029</div>
				</td>
			</tr>
		<tr><td colspan='3' style='padding-top:20px;'><h2>Installing DokuWiki</h2><div>These article will explain how to install DokuWiki.</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 2:</td>
				<td style='padding-right:10px;'><div class='gold_star'></div></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/dokuwiki/geting-started-dokuwiki/install-dokuwiki-softaculous'>Installing DokuWiki with Softaculous</a>
					<div>DokuWiki is a program that is available in Softaculous for install. This article will explain how to install DokuWiki using Softaculous.</div>
					<div class='smallgrey'>Hits: 1,214</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/dokuwiki/geting-started-dokuwiki/installing-dokuwiki-manually'>Installing DokuWiki Manually</a>
					<div>This tutorial will explain how to install DokuWiki on your server manually.</div>
					<div class='smallgrey'>Hits: 2,262</div>
				</td>
			</tr>
		<tr><td colspan='3' style='padding-top:20px;'><h2>Doku login and user management</h2><div>Below are the basic tutorials for loging in, reseting passwords, and managing users.</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 4:</td>
				<td style='padding-right:10px;'><div class='gold_star'></div></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/dokuwiki/geting-started-dokuwiki/login-dokuwiki'>How to log into DokuWiki</a>
					<div>The purpose of this article is to explain how to log in to DokuWiki..</div>
					<div class='smallgrey'>Hits: 4,463</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/dokuwiki/geting-started-dokuwiki/forgot-username-password-doku'>What if I forgot my DokuWiki username or password?</a>
					<div>When you lose your username or password for DokuWiki, you will need to reset or recover them. This article will explain how to reset and recover your password and username.</div>
					<div class='smallgrey'>Hits: 6,344</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/dokuwiki/geting-started-dokuwiki/manage-user-accounts-dokuwiki'>How to manage users in DokuWiki</a>
					<div>This article explains how to Add, Edit, Delete and manage users in DokuWiki.</div>
					<div class='smallgrey'>Hits: 7,996</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/dokuwiki/geting-started-dokuwiki/user-edit-control-doku'>Controlling user access for edit pages in DokuWiki</a>
					<div>DokuWiki by default allows all users to edit the site. This tutorial will explain how to restrict edit features for users.</div>
					<div class='smallgrey'>Hits: 5,276</div>
				</td>
			</tr>
			</table>
</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMDQmaWQ9MzA0JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="861677e26fd94a121c6669310e3f7a0a" value="1" />	</div>
	</form>
<!-- <br />
