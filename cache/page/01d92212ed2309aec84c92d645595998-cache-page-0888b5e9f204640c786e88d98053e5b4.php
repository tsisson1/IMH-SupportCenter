<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:44366:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/tools/visual-domain-routing" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="keywords" content="%default%" />
  <meta name="description" content="domain routing Category" />
  <title>InMotion Hosting Support - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/tools/visual-domain-routing?domain=dynotune.net%20" rel="canonical" />
  <link href="http://www.inmotionhosting.com/support/tools/visual-domain-routing" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:4d8fbda11326d31ce7a9c217299281f6 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '217.168.152.6']);
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Where is my domain routing?</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='item-page'>
	...
	<form method='get' style='margin-bottom:20px;'>
		<div>
			<input type='text' name='domain' id='domain' value='dynotune.net' style='width:200px;' />
			<input type='submit' value='Submit' class='btn btn-info' />
		</div>
		<div style='font-size:11px;'>Example: google.com<br />At this time, this script does not work with subdomains.</div>
	</form>

	<div>(Click the image below to view a larger version)</div>
				<div><a href='http://www.inmotionhosting.com/support/modules/mod_visual_dig/visual_dig.php?domain=dynotune.net' target='_blank' style='border:0px;' ><img src='http://www.inmotionhosting.com/support/modules/mod_visual_dig/visual_dig.php?domain=dynotune.net' style='width:550px; border:0px;'></a></div>
			
<div style='text-align:right; margin:10px 0px;'>
	<span style='padding-right:15px;'>Like this tool?</span>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/tools/visual-domain-routing&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
	
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/tools/visual-domain-routing'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP2RvbWFpbj1keW5vdHVuZS5uZXQgJm9wdGlvbj1jb21fY29udGVudCZjYXRpZD04NCZpZD04NCZ2aWV3PWNhdGVnb3J5Jkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="c8a88ebc7ddb7734b29188f5ab251bcb" value="1" />	</div>
	</form>
<!-- <br />
