<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:62954:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://192.145.237.216/support/edu/cpanel/getting-started-cpanel/view-disk-bandwidth-usage-cpanel" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-10-01T11:06:42-07:00" />
  <meta name="keywords" content="view disk space bandwidth usage cPanel display" />
  <meta name="author" content="Arnel Custodio" />
  <meta name="description" content="The following article shows how to view disk space and bandwidth usage using the cPanel." />
  <title>How to See your Disk Space and Bandwidth Usage on Shared Servers - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/cpanel/getting-started-cpanel/view-disk-bandwidth-usage-cpanel" rel="canonical" />
  ...
  <link rel="stylesheet" href="http://192.145.237.216/support/modules/mod_slogin/tmpl/compact/slogin.css" type="text/css" />
  ...
  <script src="http://192.145.237.216/support/modules/mod_slogin/media/slogin.js" type="text/javascript"></script>
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:6805cd0dea65e6022e9a54f578e94293 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-20']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '46.161.9.11']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to See your Disk Space and Bandwidth Usage on Shared Servers									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>2,948</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Mar 13, 2014'><span style='color:#606060;'>Published:</span> Oct 1, 2015</div>
							...
							<div style='clear:both;'></div>
								...
								<center><iframe width="560" height="315" src="https://www.youtube.com/embed/qJ--01_wbXw" frameborder="0" allowfullscreen></iframe></center>
<div>
<p>The following tutorials will show you how to view your disk space and bandwidth usage for shared server accounts. The information for each website is displayed in the cPanel specific to the account. If you need a breakdown of all of the stats/info in the cPanel, then go to <a href="http://www.inmotionhosting.com/support/edu/cpanel/getting-started-cpanel/how-to-find-server-specifications-in-cpanel-stats">How to find Server Specifications in cPanel</a>.</p>
</div>


<div>
<h2> How to View Disk Space Usage in cPanel </h2>


<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/cpanel-disk-bw-usage/cpanel-disk-space-usage-3.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="100" alt="cPanel Disk Space Usage" src="//cdn.inmotionhosting.com/support/images/stories/edu/cpanel-disk-bw-usage/cpanel-disk-space-usage-3.png" align="right" /></a>


<p>When you view the disk space usage from a shared server account, you will see that it looks like this:</p>
<div style="clear:both;"></div> 


<p>To see this display:</p>
...
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/cpanel-disk-bw-usage/disk-space-usage.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="100" alt="Close up of disk space usage" src="//cdn.inmotionhosting.com/support/images/stories/edu/cpanel-disk-bw-usage/disk-space-usage.png" align="right" /></a>  

<li>Look at the left hand column when you have logged in.  If necessary, click on the triangle next to the word "STATS".  This will expand the stats section or contract it.  Look for the label <b>Disk Space Usage</b>.</li>
<div style="clear:both;"></div>   
  
</ol>
  <br />
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/cpanel-disk-bw-usage/cpanel-stats.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="100" alt="cPanel Stats" src="//cdn.inmotionhosting.com/support/images/stories/edu/cpanel-disk-bw-usage/cpanel-stats.png" align="right" /></a>

<p>You can also find version numbers or account usage numbers that may help to manage your account.  Here's a short list of the other items that you will see in regards to disk space and bandwidth usage:</p>

<ul>
<li><b>Monthly Bandwidth Transfer</b> - directly beneath <b>Disk Space Usage</b> in the left hand column.  This is the amount of data that is transferred between the web server and a visitor's internet browser for that day. </li>
  <li><b>MySQL Disk space</b> - this data is not calculated as part of <b>Disk Space Usage</b>, but is a good number to watch when you are running multiple databases or if a database is getting so large that the website appears to be running slow.  </li>
</ul>

 
  
<p><b>Disk space usage</b> is displayed in units of megabytes in the left hand column.  Since shared server accounts do not have a stated limit, you will see the symbol of infinity displayed after the forward slash.  Although the web hosting plan states unlimited disk space, the available space is specifically for files that are actively used on your website.  It is not to be used for file storage or archival purposes.  For a more thorough explanation, please see our article on <a href="http://www.inmotionhosting.com/support/website/getting-started-guides/unlimited-disk-space-and-bandwidth">Unlimited Disk Space and Bandwidth</a>.  This article explains the limits as per the terms of service for the account.
</p>
...
<h2>How to View your Bandwidth Usage in cPanel</h2>

<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/cpanel-disk-bw-usage/bw-usage-cpanel.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="100" alt="Bandwidth Usage" src="//cdn.inmotionhosting.com/support/images/stories/edu/cpanel-disk-bw-usage/bw-usage-cpanel.png" align="right" /></a>


  <p>The cPanel provides a few different ways to view the bandwidth being used by your website.  When you see this statistic in the <i>stats column </i> on the left, you are looking at the bandwidth consumption for that day.  Remember that bandwidth usage is the amount of data (in bits or bytes) transferred between the web server and the visitor's internet browser. You can see even more specific data using the <b>bandwidth</b> tool. The screenshot at right displays shows how the graphs and charts are initially displayed when you open the application. </p>

  <div style="clear:both;"></div> 
  
<p>Here are the steps to see the <b>bandwidth</b> tool in your cPanel:</p>

<ol class="article_list">

<li><a href="http://www.inmotionhosting.com/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">Login to the cPanel</a>.
</li>

<li>Scroll to the section of the cPanel labeled <i>Logs</i>, then click on the icon labeled <b>Bandwidth</b>.</li>
</ol>

<h3>The Bandwidth Graphs and Charts</h3>

<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/cpanel-disk-bw-usage/first-3-graphs.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="100" alt="First three graphs in Bandwidth" src="//cdn.inmotionhosting.com/support/images/stories/edu/cpanel-disk-bw-usage/first-3-graphs.png" align="right" /></a>

<p>When you click on the icon, it will open and show you two graphs of the website traffic for the present day (labeled <b>Today</b>) and the <b>Past 7 days</b>.  After that you will see a 12 month graph and summary pie charts of usage for each of the last 9 months. Each graph is broken down to HTTP, IMAP, POP3, SMTP, and FTP usage. the first two graphs measure activity in bits/second, while the third graph summarizes usage for the year in bytes transferred.</p>


<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/cpanel-disk-bw-usage/all-traffic-http-day-breakdown-2.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="100" alt="bandwidth usage by month" src="//cdn.inmotionhosting.com/support/images/stories/edu/cpanel-disk-bw-usage/all-traffic-http-day-breakdown-2.png" align="right" /></a>
<p>You can also click on each pie graph and then see a breakdown of the month for ALL traffic and just the HTTP traffic. </p>

</div>


<p>Using these graphs, you can determine your bandwidth usage and break it down by year, month and each day of the month. If you require further information, you can <a href="http://www.inmotionhosting.com/support/website/getting-started-guides/submitting-and-checking-on-status-of-tickets">submit a support ticket</a>. 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 9: How to See your Disk Space and Bandwidth Usage on Shared Servers</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 8: <a href='/support/edu/cpanel/getting-started-cpanel/using-cpanel-video-tutorials'>Using the cPanel Video Tutorials</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://192.145.237.216/support/edu/cpanel/getting-started-cpanel/view-disk-bandwidth-usage-cpanel&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://192.145.237.216/support/edu/cpanel/getting-started-cpanel/view-disk-bandwidth-usage-cpanel'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xMzImaWQ9MzE0OCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="1c6486e6462ff277873135aa165c3e62" value="1" />	</div>
	</form>
<!-- <br />
