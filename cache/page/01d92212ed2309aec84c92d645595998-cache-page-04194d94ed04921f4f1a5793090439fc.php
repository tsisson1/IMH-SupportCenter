...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/wordpress-plugins/hiding-your-wordpress-admin-url-with-ithemes-security" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-04-26T16:38:01-07:00" />
  <meta name="author" content="Jeff Matson" />
  <meta name="description" content="Hiding your WordPress admin URL is important to the security of your site.  In this article, we will show you how to do so with iThemes Security to prevent brute force attacks." />
  <title>How to Hide your WordPress Admin URL with iThemes Security - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/wordpress-plugins/hiding-your-wordpress-admin-url-with-ithemes-security" rel="canonical" />
...
<script>
  ...
  ga('send', 'pageview');
	...
	<!-- cid:8a7746a9eb182bcfe273215970afad3e -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to Hide your WordPress Admin URL with iThemes Security									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='clear:both;'></div>
								...
								<p>Hiding your WordPress login URL is an excellent way to vastly increase security of your site, especially from <a href="http://www.inmotionhosting.com/support/news/general/wp-login-brute-force-attack">brute force attacks</a>.  In this article, we will show you how to effectively and easily change your WordPress admin URL with just a few clicks.</p>
<ol class="article_list">
  ...
  <li style='clear:both;'><p>This article assumes that you aleady have iThemes Security installed and activated.  If you do not, you may follow our article on <a href="http://www.inmotionhosting.com/support/website/wordpress-plugins/installing-the-ithemes-security-wordpress-plugin">installing iThemes Security</a>.</p></li>
  <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/ithemes-security-hide-url-1.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/ithemes-security-hide-url-1.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>Within your WordPress admin, hover over <strong>Security</strong> on the left side menu, and click on <strong>Secttings</strong>.</p></li>
  <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/ithemes-security-hide-url-2.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/ithemes-security-hide-url-2.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>From here, scroll down to the section labeled <strong>Hide Login Area</strong>.</p></li>
  <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/ithemes-security-hide-url-3.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/ithemes-security-hide-url-3.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>To enable hiding of your WordPress admin, check the box labeled <strong>Hide Backend</strong>.</p></li>
  <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/ithemes-security-hide-url-4.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/ithemes-security-hide-url-4.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>After enabling the checkbox in the previous step, additional options will appear.  In the <strong>Login Slug</strong> field, enter your new login location.</p></li>
  <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/ithemes-security-hide-url-5.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/ithemes-security-hide-url-5.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>There are various other options available here, but the defaults should be fine for the majority of sites.  If you experience issues, you may need to change the <strong>Enable Theme Compatibility</strong> or <strong>Theme Compatibility Slug</strong> options.  These options will not be covered here as the reasoning for changing them can greatly vary.</p></li>
  <li style='clear:both;'><p>Once your changes have been made, click <strong>Save All Changes</strong>.</p></li>
</ol>
<p>Now that you have hidden your login URL with iThemes Security, your site login URL will be harder to locate, and thus make it more secure from brute force attacks.  <strong>Note:</strong> Be sure to remember what you set in the <strong>Login Slug</strong> field as without it, you will not be able to log into your WordPress admin dashboard.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/wordpress-plugins/hiding-your-wordpress-admin-url-with-ithemes-security&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/wordpress-plugins/hiding-your-wordpress-admin-url-with-ithemes-security'></div>
	<script type='text/javascript'>
	  (function() {
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/4b493748030c3b9a0698baab836e92d6?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/4b493748030c3b9a0698baab836e92d6'>Gwen</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-05-20 1:56 pm</div>
				                <div><p><span style="color: #232323; font-family: adelle-sans, Helvetica, Arial, sans-serif; font-size: 13px; line-height: 22px; background-color: #f8f8f8;">"Step 6. After enabling the checkbox in the previous step, additional options will appear. In the&nbsp;</span><strong style="color: #232323; font-family: adelle-sans, Helvetica, Arial, sans-serif; font-size: 13px; line-height: 22px; background-color: #f8f8f8;">Login Slug</strong><span style="color: #232323; font-family: adelle-sans, Helvetica, Arial, sans-serif; font-size: 13px; line-height: 22px; background-color: #f8f8f8;">field, enter your new login location." &nbsp; &nbsp;<strong>How does one know where to locate the new login?</strong></span></p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32847);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-05-20 3:14 pm</div>
				                <div>Hello Gwen,<br />
<br />
What ever you change the slug to would be your new login page such as in the example it would be http://example.com/wplogin<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32848);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
