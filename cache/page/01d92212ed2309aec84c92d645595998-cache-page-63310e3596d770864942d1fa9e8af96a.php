<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:63140:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/file-management/changing-the-document-root-with-root-access" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-08-19T19:42:06-07:00" />
  <meta name="keywords" content="change doc root access vps dedicated" />
  ...
  <link href="http://www.inmotionhosting.com/support/website/file-management/changing-the-document-root-with-root-access" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:59f98e6458b475bdbf93a19e3ce26a9e -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '82.74.34.227']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Changing the document root for your domain</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Changing the document root for your domain									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>20,860</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Mar 28, 2013'><span style='color:#606060;'>Published:</span> Aug 19, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>InMotion Hosting is able to change the Document root location where your Primary domain points to. This allows the file structure to be maintained how the developer wants to reference the files in the website code. This article will explain how to get the document root changed for your primary domain.</p>

<p class="vital_heading"><strong>VERY IMPORTANT!</strong> Changing a primary domain doc root is <strong>NEVER RECOMMENDED</strong> by InMotion Hosting. cPanel  restores packages based on default settings and miss document root changes. So if the account is moved, the accounts with the doc root change may break.</p>

<h2>Accounts on Shared servers</h2>
<p>Shared server accounts cannot change their document root, because root access is not allowed on Shared servers.  Our <a href="/support/website/website-troubleshooting/how-to-get-great-technical-support" target="_blank" title="Click here for how to contact support">tech support</a> can change the document root on your shared server account per your request. You will need to submit this in a ticket to support with the folder (path to the directory location) you want to change the document root to.</p>

<h2>VPS and Dedicated servers</h2>
<p> When an VPS or Dedicated server customer needs to make a document root change, they can with <a href="/support/website/general-server-setup/root-access-faq">Root Access</a>.  Below will explain how to change the document root of the primary domain.</p>
<h3>Changing the Document Root (without root access)</h3>

<p>VPS and Dedicated customers that do not have root access cannot change the document root of their main domain. VPS and Dedicated server customers without root access will need to follow the same process as the Shared server customers. In order to have the main domain changed on your server, you will need to contact <a href="/support/website/website-troubleshooting/how-to-get-great-technical-support" target="_blank" title="Click here for how to contact support">tech support</a> with the request.</p>
<h3>Steps to change the Document Root (with root access)</h3>
<p class="vital_heading"><strong>VERY IMPORTANT!</strong>We do not support changes done as the ROOT user. Any time required by the system administration team to repair, troubleshoot, or restore services due to changes made (as a result of having root access) after taking root access may be billed at rate of up to $75/hr. This does not guarantee resolution of technical issues deemed outside the scope of our support.</p>
<ol class="article_list">
<li>ssh root@your-server.com</li>
<li>sudo su - root</li>
<li>Edit the following file:

  <pre>   /var/cpanel/userdata/USER/DOMAIN</pre>

<p class="vital_heading"><strong>Important!</strong> If you have an SSL certificate on the account, you may need to edit the following file as well.</p>

<pre>   /var/cpanel/userdata/USER/DOMAIN_SSL</pre>

<p>You should see the file like the following. The areas to edit are in <span style="color: #ff0000">RED</span>.</p>
...
<pre>   documentroot: /home/USER/public_html
   path: /home/USER/public_html/cgi-bin</pre>

The changes will look like the following:

<pre>   documentroot: /home/USER/public_html/new_doc_root_dir
   path: /home/USER/public_html/new_doc_root_dir/cgi-bin</pre>
</li>

<li>When finished editing the document root, run the following scripts while logged in as the ROOT user.:
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/file-management/changing-the-document-root-with-root-access&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/file-management/changing-the-document-root-with-root-access'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yMyZpZD0yNTQ2JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/website/change-document-root-primary-domain?tsrc=rsbraq'>Change document root for primary domain</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/cpanel/domain-pointing-to-public_html-directory?tsrc=rsbraq'>Why is my domain pointing to a directory inside public_html?</a>
                                </div>
