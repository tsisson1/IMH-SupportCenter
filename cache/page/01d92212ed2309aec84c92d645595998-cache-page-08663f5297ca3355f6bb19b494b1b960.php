<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:112967:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-3/create-template/add-bootstrap" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-04-10T19:47:00-07:00" />
  <meta name="keywords" content="add bootstrap to Joomla 3.0" />
  ...
  <link href="http://www.inmotionhosting.com/support/edu/joomla-3/create-template/add-bootstrap" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<script type="text/javascript">
		...
		_gaq.push(['_setCustomVar', 3, 'DateMonthModified', '2013-04', 3]);
	...
	<!-- cid:79929092929fe4bfba0ecf4b80ae4493 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '200.30.94.12']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to add Bootstrap to a Joomla 3.1 Template									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>79,267</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Oct 7, 2012'><span style='color:#606060;'>Published:</span> Apr 10, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Now that we have <a href="/support/edu/joomla-3/create-template/add-css-and-js">added CSS and JS files</a> to <a href="/support/edu/joomla-3/create-template">the Joomla 3.0 template that we are creating</a>, we will now add the necessary bootstrap files.</p>
<p>While the necessary bootstrap files can be downloaded from the <a target="_blank" href="http://twitter.github.com/bootstrap/">official site</a>, Joomla 3.0 actually includes the necessary css and javascript bootstrap files as well. As a template developer, this will make incorporating these files much easier.</p>
<p> </p>
<h2>Some bootstrap loaded with &lt;jdoc:include type="head" /&gt;</h2>
<p>When <a href="/support/edu/joomla-3/create-template/add-css-and-js">we added &lt;jdoc:include type="head" /&gt; within our template's head tag</a>, Joomla automatically added a few JavaScript and CSS files. In the list of files below that Joomla added, you will notice that we've highlighted the bootstrap files that it included:</p>
<pre style="margin:10px 0px 10px 20px;padding:5px;">
...
<span style="color: #008000;"><strong>&lt;script src="/media/jui/js/bootstrap.min.js" type="text/javascript"&gt;&lt;/script&gt;</strong></span></pre>
<p> </p>
<h2>What bootstrap files do we need to include?</h2>
<p>According to the <a target="_self" href="http://twitter.github.com/bootstrap/getting-started.html">official bootstrap documentation</a>, we need to include the following files:</p>
<ol>
<li>bootstrap.css (or bootstrap.min.css)</li>
<li>bootstrap.js (or bootstrap.min.js)</li>
</ol>
<p>As <strong>&lt;jdoc:include type="head" /&gt;</strong> already included <em>bootstrap.min.js</em> for us, we only need to include bootstrap.min.css. To do this, we will update our template's <em>index.php</em> on our <a href="http://www.inmotionhosting.com/joomla-hosting.html">Joomla hosting server</a> to include this file. You can see the code we added below that includes <em>bootstrap.min.css</em>, which we've highlighted in green:</p>
<pre style="margin:10px 0px 10px 20px;padding:5px;">
&lt;?php

$doc = JFactory::getDocument();

<span style="color: #008000;"><strong>$doc-&gt;addStyleSheet($this-&gt;baseurl . '/media/jui/css/bootstrap.min.css');</strong></span>
...
&lt;/head&gt;</pre>
<p> </p>
<h2>What Joomla looks like when bootstrap has been added</h2>
...
<tbody>
<tr>
<th><div align="center">BEFORE bootstrap.min.css</div></th> 
<th><div align="center">AFTER bootstrap.min.css</div></th>
</tr>
<tr>
<td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/create-template/before-bootstrap-css.jpg"><img width="240"  alt="before bootstrap css Joomla" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/create-template/before-bootstrap-css.jpg" /></a></td>
<td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/create-template/after-bootstrap-css.jpg"><img width="240"  alt="after bootstrap css Joomla" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/create-template/after-bootstrap-css.jpg" /></a></td>
</tr>
</tbody>
</table> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/joomla-3/create-template'>208: Building a Basic Joomla 3 Template with Bootstrap</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 8: How to add Bootstrap to a Joomla 3.1 Template</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 7: <a href='/support/edu/joomla-3/create-template/add-css-and-js'>How to add CSS and JavaScript files to a Joomla 3.1 Template</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 9: <a href='/support/edu/joomla-3/create-template/make-responsive'>How to make a Joomla 3.1 Template Responsive</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-3/create-template/add-bootstrap&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-3/create-template/add-bootstrap'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNzEmaWQ9MTg0NyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="a0dffbf1665e6effba849f9a495078ee" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/joomla-3/create-template?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Building a Basic Joomla 3 Template with Bootstrap</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/joomla-3/create-template/starting-template?tsrc=rsbedu'>A very basic template soon to be a Joomla 3.1 template</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/joomla-3/create-template/add-module-positions?tsrc=rsbedu'>How to add module positions to a Joomla 3.1 template</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/joomla-3/create-template/template-details-xml?tsrc=rsbedu'>Adding a templateDetails.xml file to a Joomla 3.1 Template</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/joomla-3/create-template/zip-template?tsrc=rsbedu'>How to zip a Joomla 3.1 template</a></td>
                </tr>
          <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/joomla-3/create-template/how-to-install-template?tsrc=rsbedu'>How to install a Joomla 3.1 Template</a></td>
                </tr>
          <tr >
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/joomla-3/create-template/switch-site-template?tsrc=rsbedu'>How to change your Joomla 3.1 Site Template</a></td>
                </tr>
          <tr >
                        <td valign='top'>7.</td>
                        <td><a href='/support/edu/joomla-3/create-template/add-css-and-js?tsrc=rsbedu'>How to add CSS and JavaScript files to a Joomla 3.1 Template</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>8.</td>
                        <td><a href='/support/edu/joomla-3/create-template/add-bootstrap?tsrc=rsbedu'>How to add Bootstrap to a Joomla 3.1 Template</a></td>
                </tr>
          <tr >
                        <td valign='top'>9.</td>
                        <td><a href='/support/edu/joomla-3/create-template/make-responsive?tsrc=rsbedu'>How to make a Joomla 3.1 Template Responsive</a></td>
                </tr>
          <tr >
                        <td valign='top'>10.</td>
                        <td><a href='/support/edu/joomla-3/create-template/security-using-jexec?tsrc=rsbedu'>Adding security to a Joomla 3.1 template using JEXEC</a></td>
                </tr>
        <tr><td colspan='2'><h4>Adding CSS and Style to the template</h4></td></tr>  <tr >
                        <td valign='top'>11.</td>
                        <td><a href='/support/edu/joomla-3/create-template/css-login-form?tsrc=rsbedu'>Adding CSS to the Login Form in a Joomla 3.1 template</a></td>
                </tr>
          <tr >
                        <td valign='top'>12.</td>
                        <td><a href='/support/edu/joomla-3/create-template/css-to-sidebar?tsrc=rsbedu'>Adding CSS to sidebar items in a Joomla 3.1 template</a></td>
                </tr>
          	</table>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//graph.facebook.com/christian.gibson.908/picture?type=normal' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='/support/community-support/users/ClubAero'>ClubAero</a></div>
						<div></div>
						<div></div>
						<div>34 <a href='/support/team/points' target='_blank'>Points</a></div>
						
					</td>
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-03-30 1:02 pm</div>
				                <div>Hi Brad,<br />
You say that &quot;Joomla 3.0 actually includes the necessary css and javascript bootstrap files as well&quot; but in the list of files generated by &lt;jdoc: include type=&quot;head&quot; /&gt; the bootstrap.min.js is not included. You then say we have to add this with:<br />
$doc-&gt;addStyleSheet($this-&gt;baseurl . '/media/jui/css/bootstrap.min.css');<br />
My problem is that bootstrap.min.css is overriding my own css in a form which I am implementing in a Joomla 3.0 site. I decided to try to show the form on a page with my own 'verybasictemplate' which I intend to create by modifying an existing basic template. To avoid bootstrap.min.css overriding my form css I want to omit the file being loaded by the index.php in my 'verybasictemplate'. But if bootstrap.min.css is not automatically loaded by standard Joomla templates, then I don't need to find out how to modify the template to avoid loading the file?<br />
Is bootstrap.min.css automatically loaded by Joomla 3.0 templates or not? That is my question - sorry if I have not been clear......<br />
</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(7612);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-03-30 5:50 pm</div>
				                <div>And since I posted that question I have now noticed that the template.css file in the protostar template actually includes bootstrap.min.css. So even if I can avoid loading the bootstrap file it will still be there in the protostar template.......</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(7613);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-04-01 1:18 pm</div>
				                <div>Joomla 3.0 does not come with it automatically. The bootstrap code can be commented out if you need it disabled. It should not effect the template adversely.<br />
 <br />
 Best Regards,<br />
 James R</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(7614);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-7859'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='http://a0.twimg.com/profile_images/2531367745/image_bigger.jpg' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='/support/community-support/users/jrulle5'>jrulle5</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-05-17 12:20 pm</div>
				                <div>Where is your template getting the arrangement of modules from. What would I need to do to customize the arrangement of modules? <br />
(specifically I don't want any sidebars, just a series of stacked modules.<br />
Thanks.<br />
</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(7859);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-05-17 12:55 pm</div>
				                <div>Hello!<br />
If you want to &lt;a href=&quot;http://www.inmotionhosting.com/support/edu/joomla-25/templates/edit-template&quot; target=&quot;_blank&quot;&gt;edit the code of the template&lt;/a&gt; the following link should help you identify where the code is to edit.<br />
  &lt;a href=&quot;http://www.inmotionhosting.com/support/edu/joomla-3/create-template/starting-template&quot; target=&quot;_blank&quot;&gt;A very basic template soon to be a Joomla 3.0 template&lt;/a&gt;<br />
  <br />
  If you just want to position the modules then you can follow the tutorial below to position the modules.<br />
  &lt;a href=&quot;http://www.inmotionhosting.com/support/edu/joomla-3/create-template/add-module-positions&quot; target=&quot;_blank&quot;&gt;How to add module positions to a Joomla 3.0 template&lt;/a&gt;<br />
  <br />
  Best Regards,<br />
  James R</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(7860);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-7916'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//graph.facebook.com/1Basti/picture?type=normal' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='/support/community-support/users/basti5'>basti5</a></div>
						<div></div>
						<div></div>
						<div>3 <a href='/support/team/points' target='_blank'>Points</a></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-05-30 3:20 pm</div>
				                <div>Hi Brad, <br />
<br />
I purpose to buy this template from https://wrapbootstrap.com/theme/clean-canvas-business-theme-WB02634G3. Do you know if your steps are also working for those kind of bootsrap templates?</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(7916);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-05-30 4:22 pm</div>
				                <div>Hello Basti5,<br />
<br />
As far as we can tell, as long as the theme author's are compatible with the bootstrap code, then it should follow the same steps.  If there are any variances you will need to double-check with the author of the theme.<br />
<br />
Regards,<br />
<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(7917);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-09-24 5:24 am</div>
				                <div>Hi, <br />
<br />
I have done all this. But I cannot seem to install bootstrap. I get the following error:<br />
<br />
Warning<br />
JInstaller: :Install: Cannot find XML setup file</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8270);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-09-24 7:57 am</div>
				                <div>This is caused due to a template or extension that it attempted to be installed which is for an earlier version of Joomla than the one you are running.  The following post on Joomla's forums will provide you with more information as well as steps that you could take to possibly correct the issue:<br />
<br />
&lt;a href=&quot;http://forum.joomla.org/viewtopic.php?t=764742&quot;&gt;JInstaller: :Install: Cannot find Joomla XML setup file&lt;/a&gt;</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8271);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-8433'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//graph.facebook.com/oxoleito/picture?type=normal' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='/support/community-support/users/jleito'>jleito</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-11-29 7:49 am</div>
				                <div>How I can connect bootstrap menu style to Joomla menu?</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8433);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-11-29 5:35 pm</div>
				                <div>&lt;div style=&quot;background-color: #FFF; padding-left: 10px;&quot;&gt;Hello jleito,<br />
<br />
If you're using &lt;strong&gt;Joomla 3.0&lt;/strong&gt; or newer than Bootstrap should already be included, or if you've included Bootstrap to Joomla using the guide above then it should be ready for use as well.<br />
<br />
Then you just need to use the &lt;strong&gt;Module Manager&lt;/strong&gt; to edit your menu by changing the &lt;strong&gt;Menu Class Suffix&lt;/strong&gt; option, like is explained in our guide on &lt;a href=&quot;http://www.inmotionhosting.com/support/edu/joomla-3/menu/horizontal-menu&quot; target=&quot;_blank&quot;&gt;how to create a horizontal menu in Joomla&lt;/a&gt;.<br />
<br />
You'd want to use one of the &lt;a href=&quot;http://getbootstrap.com/components/#nav&quot; target=&quot;_blank&quot;&gt;Bootstrap nav components&lt;/a&gt; such as either &lt;strong&gt;nav-tabs&lt;/strong&gt;, or &lt;strong&gt;nav-pills&lt;/strong&gt; to apply those styles to your menu buttons.<br />
<br />
Please let us know if you had any further questions at all.<br />
<br />
- Jacob&lt;/div&gt;</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8441);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-9919'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/8a401ece86fa5102cc967d9906c11e03?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/8a401ece86fa5102cc967d9906c11e03'>Leon</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-21 4:06 am</div>
				                <div>Hi, It appears that in Joomla 3.2.3,  doesn't include bootstrap.min.js automatically anymore.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9919);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-21 9:20 am</div>
				                <div>I have checked on this with a fresh Joomla 3.2.3 installation and the bootstrap.min.js is indeed still located there.  If you do not see it, you may have issues within your Joomla installation.  I recommend replacing it from the default Joomla files if you need it.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9937);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-21 12:54 pm</div>
				                <div><p>Dear Jeff,</p>
<p>What template did you use?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9944);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-21 1:02 pm</div>
				                <div>This was using the default Joomla template, however, the bootstrap.min.js file is independent of any themes and are stored within &lt;em&gt;/media/jui/js/bootstrap.min.js&lt;/em&gt;.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9945);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-14683'></a>
		<div  style='margin:2px 0px 0px 160px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/9915b5c50dc39bc89d56cfc33da46360?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/9915b5c50dc39bc89d56cfc33da46360'>Gordon Miller</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-03 10:32 pm</div>
				                <div><p>I'm sure this is a dumb question, but where do I locate media/jui/css/bootstrap-rtl.css (in Joomla 3.3.3)? I was given a set of 4 fixes for creating nested menus in protostar. 3 of the 4 are&nbsp;under headings that are easy to locate (e.g.&nbsp;templates/protostar/css/template.css and templates/protostar/less/template.less). But where on earth do I locate media/jui/css/bootstrap-rtl.css ?&nbsp;Many thanks in advance.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14683);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 200px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-04 8:06 am</div>
				                <div>Hello Gordon,<br />
<br />
Look for the '<em>media</em>' folder in the base folder where your Joomla is installed. From there just follow the path looking for the '<em>jui</em>' folder next, then the '<em>js</em>' folder. Once there, you will see the destination file of '<em>bootstrap.min.js</em>'.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14698);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-21 1:25 pm</div>
				                <div><p>The default Joomla template, Protostar, includes the following statement:</p>
<p>JHtml::_('bootstrap.framework');</p>
<p>so I think the statemen &lt;jdoc:include type="head" /&gt; alone would not add bootstarp, as mentioned in this article. My first post wasn't exactly what I ment. My bad.<strong></strong></p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9946);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-21 1:34 pm</div>
				                <div>There are of course several was to include it, but within the method mentioned above, we have included the Bootstrap files within the header file, which will allow the files to be referenced correctly and include Bootstrap support.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9948);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-12677'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/bda9ea0eb78d0f6152667282e945f870?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/bda9ea0eb78d0f6152667282e945f870'>Uriel</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-11 9:23 pm</div>
				                <div><p>hola saludo para todos estoy haciendo una plantilla de cero con mis conocimientos de html y css con dise&ntilde;o propio la cuestion es que al incluir el codigo&nbsp;<strong style="color: rgb(0, 128, 0); font-family: Monaco, Menlo, Consolas, 'Courier New', monospace; font-size: 12px; line-height: 18px; white-space: pre-wrap;">$ Doc-&gt; addStylesheet (. $ This-&gt; baseurl '/ media / jui / css / bootstrap.min.css');me sale este error</strong></p>
<p><strong style="font-family: 'Times New Roman'; font-size: medium;">Parse error</strong><span style="font-family: 'Times New Roman'; font-size: medium;">: syntax error, unexpected 'Doc' (T_STRING), expecting variable (T_VARIABLE) or '$' in&nbsp;</span><strong style="font-family: 'Times New Roman'; font-size: medium;">C:\xampp\htdocs\aprender\templates\vitrinasexhilum\index.php</strong><span style="font-family: 'Times New Roman'; font-size: medium;">&nbsp;on line&nbsp;</span><strong style="font-family: 'Times New Roman'; font-size: medium;">4</strong></p>
<p><strong style="font-family: 'Times New Roman'; font-size: medium;">por fa ayuda</strong></p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12677);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-14 9:41 am</div>
				                <div>It appears that you have a space between the &quot;&lt;em&gt;$&lt;/em&gt;&quot; symbol and the variable name, as well as other unnecessary spaces.  I recommend removing the spaces like the following:<br />
&lt;p class=&quot;code_block&quot;&gt;$doc-&amp;gt;addStyleSheet($this-&amp;gt;baseurl . '/media/jui/css/bootstrap.min.css');&lt;/p&gt;</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12716);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						...
						<div><a style='font-size:16px;' href='/support/community-support/users/jserper'>jserper</a></div>
						<div></div>
						<div></div>
						<div>3 <a href='/support/team/points' target='_blank'>Points</a></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-06 7:21 pm</div>
				                <div>Hello,<br />
<br />
I have an existing Joomla 3.x web site and want to add a bootstrap dashboard as a URL on that site. I'm new to Bootstrap. and the Bootstrap bootstrap template has a completely different layout than the rest of my site. I'm thinking I can insert the HMTL into a Joomla article and point to the correct CSS/JS files on the server and customize it but not sure. Can someone provide me with the few steps I need to do to insert the Bootstrap?<br />
<br />
Thanks,<br />
<br />
Jon</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19257);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-06 7:26 pm</div>
				                <div>It is very likely that Bootstrap is already included within your template, but if not, you would simply add it to the template by following this guide.  Of course, the template will not be the same, but the basic steps in adding the Bootstrap framework will be the same.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19258);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-26860'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/b14615e7e5aba50ddb86f9d7cf76b4b8?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/b14615e7e5aba50ddb86f9d7cf76b4b8'>Syaifulloh</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-22 12:36 am</div>
				                <div><p>Thank you so much for this tutorial ,,.. i was very greatly helped</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26860);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
