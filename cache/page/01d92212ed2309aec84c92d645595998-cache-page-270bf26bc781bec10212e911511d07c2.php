<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:57126:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/php-nuke/getting-started-php-nuke/login-administrator-system" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-02-14T20:41:56-08:00" />
  <meta name="keywords" content="login administration system back end php-nuke phpnuke php nuke [gs]" />
  <meta name="author" content="Arnel Custodio" />
  <meta name="description" content="PHP-Nuke has a back-end interface which is called the Administration System.  The following article shows how to find and login to the Administration system." />
  <title>How to login to the Administrator System in PHP-Nuke - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/php-nuke/getting-started-php-nuke/login-administrator-system" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:9576a02f472800e8685755a60bad3495 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-20']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '74.217.51.193']);
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/php-nuke' itemprop='url'><span itemprop='title'>PHP-Nuke<span></a><div class='dropdown_2columns'><h2>PHP-Nuke Education Channel</h2><div class='col_2'><h3>100 Level Classes</h3><div><a href='/support/edu/php-nuke/getting-started-php-nuke'>101: Getting Started: PHP-Nuke</a></div><div><a href='/support/edu/php-nuke/add-content-php-nuke'>102: Adding the content to PHP-Nuke</a></div><div><a href='/support/edu/php-nuke/php-nuke-modules-blocks'>103: PHP-Nuke Modules and blocks</a></div><div><a href='/support/edu/php-nuke/change-php-nuke-appearance'>104: Changing the PHP-Nuke Appearance</a></div><div><a href='/support/edu/php-nuke/webstats-reporting-php-nuke'>105: PHP-Nuke Web stats and reporting</a></div><div><a href='/support/edu/php-nuke/php-nuke-statistics-reporting'>106: PHP-Nuke Backups and Site security</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/php-nuke/getting-started-php-nuke' itemprop='url'><span itemprop='title'>101: Getting Started: PHP-Nuke<span></a><div class='dropdown_3columns'><h2> Getting Started: PHP-Nuke</h2><div class='col_3'><div>1. <a style='display:inline;' href='/support/edu/php-nuke/getting-started-php-nuke/install-php-nuke-softaculous'>How to Install PHP-Nuke with Softaculous</a></div><div>2. <a style='display:inline;' href='/support/edu/php-nuke/getting-started-php-nuke/login-administrator-system'>How to login to the Administrator System in PHP-Nuke</a></div><div>3. <a style='display:inline;' href='/support/edu/php-nuke/getting-started-php-nuke/change-admin-password-nuke'>Changing the Admin password in PHP-Nuke</a></div><div>4. <a style='display:inline;' href='/support/edu/php-nuke/getting-started-php-nuke/how-to-reset-your-admin-password-for-php-nuke'>How to reset your admin password for PHP-Nuke</a></div><div>5. <a style='display:inline;' href='/support/edu/php-nuke/getting-started-php-nuke/create-new-user'>How to register a user in the PHP-Nuke admin area</a></div><div>6. <a style='display:inline;' href='/support/edu/php-nuke/getting-started-php-nuke/manage-users'>How to modify and delete users in PHP-Nuke</a></div><div>7. <a style='display:inline;' href='/support/edu/php-nuke/getting-started-php-nuke/change-language'>How to Change the Language Used in PHP-Nuke</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to login to the Administrator S...</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to login to the Administrator System in PHP-Nuke									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>6,246</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Mar 13, 2013'><span style='color:#606060;'>Published:</span> Feb 14, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<div>
<p>The login for the PHP-Nuke Administration System requires that you have an administrator user name and password. &nbsp;You will also need to know the URL to login to the Administrator. &nbsp;The following article takes you through the steps to login to the back end for PHP-Nuke.
</p>
</div>

<div>
<h2><img src="//cdn.inmotionhosting.com/support/images/stories/edu/phpnuke/adminlogin/logo-php-nuke.png" width="318" height="124" alt="PHP-Nuke Logo" />&nbsp;</h2>
<h2>How to Sign into the Administration System for PHP-Nuke<span style="font-size: 11px;">&nbsp;</span></h2>
<div><ol class="article_list">
<li>Open your internet browser and go to the URL for your Administration System - typically it will be in this format: &nbsp;<strong><em>http://domainname.com/admin.php</em></strong>.</li>
<li>Type in your super user name in the <strong>Admin ID</strong> field and then click in the <strong>Password</strong> field to type in your password.<br /><br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phpnuke/adminlogin/php-nuke-admin-login-page.png"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/phpnuke/adminlogin/php-nuke-admin-login-page.png" alt="PHP-Nuke Login page"  /></a><br /><br /></li>
<div style="clear: both;"></div>
<li>Click on the <strong>LOGIN</strong> button to login to the Administration System.</li>
</ol>
</div>

<div>
<p>
This will bring you in to the PHP-Nuke Administration system. You should see a screen similar to the one below:<br /><br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phpnuke/adminlogin/phpnuke-admin-screen.png"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/phpnuke/adminlogin/phpnuke-admin-screen.png" alt="Login to PHP-Nuke"  /></a>
</p>
<p>If you need further information on PHP-Nuke, then check out our <a href="http://www.inmotionhosting.com/support/edu/php-nuke">PHP-Nuke education channel</a>.  We also have an article on <a href="http://www.inmotionhosting.com/support/edu/php-nuke/getting-started-php-nuke">Getting Started with PHP-Nuke</a>.
</p>
</div> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/php-nuke/getting-started-php-nuke'>101: Getting Started: PHP-Nuke</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 2: How to login to the Administrator System in PHP-Nuke</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 1: <a href='/support/edu/php-nuke/getting-started-php-nuke/install-php-nuke-softaculous'>How to Install PHP-Nuke with Softaculous</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 3: <a href='/support/edu/php-nuke/getting-started-php-nuke/change-admin-password-nuke'>Changing the Admin password in PHP-Nuke</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/php-nuke/getting-started-php-nuke/login-administrator-system&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/php-nuke/getting-started-php-nuke/login-administrator-system'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zNjEmaWQ9NjQwJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/php-nuke/getting-started-php-nuke?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Getting Started: PHP-Nuke</h3></a>
		<table><tr><td colspan='2'><h4>Installing and logging into PHP-Nuke</h4></td></tr>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/php-nuke/getting-started-php-nuke/install-php-nuke-softaculous?tsrc=rsbedu'>How to Install PHP-Nuke with Softaculous</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/php-nuke/getting-started-php-nuke/login-administrator-system?tsrc=rsbedu'>How to login to the Administrator System in PHP-Nuke</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/php-nuke/getting-started-php-nuke/change-admin-password-nuke?tsrc=rsbedu'>Changing the Admin password in PHP-Nuke</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/php-nuke/getting-started-php-nuke/how-to-reset-your-admin-password-for-php-nuke?tsrc=rsbedu'>How to reset your admin password for PHP-Nuke</a></td>
                </tr>
        <tr><td colspan='2'><h4>Managing Users and Languages</h4></td></tr>  <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/php-nuke/getting-started-php-nuke/create-new-user?tsrc=rsbedu'>How to register a user in the PHP-Nuke admin area</a></td>
                </tr>
          <tr >
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/php-nuke/getting-started-php-nuke/manage-users?tsrc=rsbedu'>How to modify and delete users in PHP-Nuke</a></td>
                </tr>
          <tr >
                        <td valign='top'>7.</td>
                        <td><a href='/support/edu/php-nuke/getting-started-php-nuke/change-language?tsrc=rsbedu'>How to Change the Language Used in PHP-Nuke</a></td>
                </tr>
          	</table>
