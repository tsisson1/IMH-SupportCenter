<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:61127:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/email/outlook/outlook-2013-omapi32-wwlib-errors" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-03-11T19:10:55-07:00" />
  <meta name="author" content="Jeff Matson" />
  <meta name="description" content="Are you getting an error on Outlook that references OLMAPI32.dll or WWLIB.dll?  In this article, we'll show you how to fix it." />
  <title>How to fix OLMAPI32.dll and WWLIB.dll error in Outlook 2013 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/email/outlook/outlook-2013-omapi32-wwlib-errors" rel="canonical" />
...
<script>
  ...
  ga('send', 'pageview');
	...
	<!-- cid:db1b9231b63e3b2cb7f8e503c80eb027 -->
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to fix OLMAPI32.dll and WWLIB.dll error in Outlook 2013</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to fix OLMAPI32.dll and WWLIB.dll error in Outlook 2013									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>35,210</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Mar 11, 2014'><span style='color:#606060;'>Published:</span> Mar 11, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>As of December 2013, some users have reported that <a href="http://www.inmotionhosting.com/support/email/outlook/2013">Outlook 2013</a> is crashing due to a Windows update in which the error references either <strong>OLMAPI32.dll</strong> or <strong>WWLIB.dll</strong>.  In this article, we will show you a few ways to fix this issue to get your Outlook 2013 up and running again.</p>
<h2>What causes this issue?</h2>
<p>This issue is caused by an error within Windows update that breaks either the OLMAPI32.dll or WWLIB.dll file.</p>
<h2>How do I fix the error?</h2>
<p>To fix this error, there are a few possible solutions:</p>
<ol class="article_list">
    <li><p>Install the <a href="http://support.microsoft.com/kb/2850061" target="_blank">January 14, 2014 Outlook 2013 #2850061 update</a>.</p></li>
    <li><p>Install the <a href="http://support.microsoft.com/kb/2825652" target="_blank">Outlook 2013 hotfix package from December 10, 2013</a></p></li>
</ol>
<p>Once you have downloaded one of these packages, simply install them as you would any other program; typically double-clicking on the file.</p>
<p>Once you have applied one of these solutions, your Outlook 2013 software should open and run just as it previously has, and without the errors that reference OLMAPI32.dll or WWLIB.dll.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/email/outlook/outlook-2013-omapi32-wwlib-errors&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/email/outlook/outlook-2013-omapi32-wwlib-errors'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD01NSZpZD0zMTQzJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="b35726acfc3cc51993b5ed0e8eb004b8" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/de62800c9816600e871ad87dce0a2f99?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/de62800c9816600e871ad87dce0a2f99'>Satish</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-18 1:35 am</div>
				                <div><p>thank you this helped me to fix outlook problem which i am facing from 2 days.</p>
<p>Excellent.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14073);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-18614'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/9004a24ad536116b5320c1a8fe33ee01?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/9004a24ad536116b5320c1a8fe33ee01'>shimels</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-17 1:10 pm</div>
				                <div>keep going it is  good.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(18614);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-26926'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/cb9551cd86c5e9eed2871111a916b149?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/cb9551cd86c5e9eed2871111a916b149'>Jorge Aceituno</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-23 6:46 pm</div>
				                <div><p>Ok, i'll get those installation files and let you know if get rid of the problem.</p>
<p>&nbsp;</p>
<p>Thanks.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26926);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-33063'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/adf56637a415c0e7aef2580382f08224?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/adf56637a415c0e7aef2580382f08224'>Lucky</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-05-30 3:22 pm</div>
				                <div><p>i have dowloaded the fix, ill comment tomorrow if they work</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(33063);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
