<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49034:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/html5/using-pusher-with-shared-business-hosting" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, Thanks for the question. As Pusher is a developer tool that involves Javascript, you would need to use a VPS or dedicated server hosting. The bus..." />
  <title>Using Pusher with shared business hosting | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/html5/using-pusher-with-shared-business-hosting" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:79a0cb42793d620d8c8577ee622ea0b6 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Using Pusher with shared business hosting</h1>
		<div style='margin-bottom:20px; margin-top:10px; clear:both; color:#6e6e6e;'>Category: <a href='/support/community-support/html5'>Html5</a></div>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-01-14 10:48 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>49</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Does it possible to use Pusher (pusher.com) PHP library to build web real-time server with your cheap business hosting plans?</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_6301' id='upvote_answer_6301' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='6301' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_6301').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_6301' id='downvote_answer_6301' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='6301' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_6301').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
Thanks for the question.  As Pusher is a developer tool that involves Javascript, you would need to use a <a href="http://www.inmotionhosting.com/vps-hosting">VPS</a> or <a href="http://www.inmotionhosting.com/dedicated-servers">dedicated server</a> hosting.  The business level hosting accounts would not provide enough access in order for you to use the software.  I hope this helps to answer your question, please let us know if you require any further  assistance.<br />
<br />
Kindest regards,<br />
Arnel C.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_6301').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_6301' id='form_comment_on_answer_6301' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/html5/using-pusher-with-shared-business-hosting&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/html5/using-pusher-with-shared-business-hosting'></div>
<script type='text/javascript'>
  (function() {
