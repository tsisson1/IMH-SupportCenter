<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:76984:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/cpanel/set-up-google-apps" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-04-06T14:32:30-07:00" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Learn how to use the Google Apps Wizard in cPanel to connect your Google Apps account to your domain." />
  <title>Setting up Google MX Wizard in cPanel - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/cpanel/set-up-google-apps" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:f8a440c6324b1563c0bc48761f63bc40 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '41.142.101.208']);
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/cpanel' itemprop='url'><span itemprop='title'>cPanel<span></a><div class='dropdown_4columns'><h2>cPanel Education Channel</h2><div class='col_2'><h3>100 Level Classes</h3><div><a href='/support/edu/cpanel/getting-started-cpanel'>101: Getting Started in cPanel</a></div><div><a href='/support/edu/cpanel/cpanel-fantastico'>102: Fantastico de Luxe</a></div><div><a href='/support/edu/cpanel/softaculous'>103: Using Softaculous</a></div></div><div class='col_2'><h3>200 Level Classes</h3><div><a href='/support/edu/cpanel/cpanel-email'>201: Using Email</a></div><div><a href='/support/edu/cpanel/cpanel-file-manager'>202: Managing your Files in cPanel</a></div><div><a href='/support/edu/cpanel/cpanel-manage-domains'>203: Managing your Domains in cPanel</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Setting up Google MX Wizard in cPanel</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Setting up Google MX Wizard in cPanel									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>9,453</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: May 21, 2014'><span style='color:#606060;'>Published:</span> Apr 6, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<p>One of our newest features for our <a href="http://www.inmotionhosting.com/business-hosting">business class accounts</a> allows you to connect your site to Google MX Wizard with a one click wizard. Many customers use Google Apps for their business and would like to have that set up for their site. While simple, it can be tedious. We understand that, so we added the Google Apps wizard to our cPanel so you can do it all in under a minute.</p>

<div class="alert" style="color:red">Note that you must have a <a href="https://support.google.com/a/answer/53926?hl=en" target="_blank">Google MX Wizard account</a> in order to set your domain up with the Google Apps tool.</div>

<div class="alert alert-danger">
  <p>
    If you don't see the <b>Google MX Wizard</b> option in your cPanel, you will need to contact our live technical support team.  This option may not be immediately available on VPS or Dedicated server accounts.
  </p>
</div>

<div class="alert" style="color:red">If you have a VPS or Dedicated server you can make the <a href="/support/reseller/edit-zone">MX modifications to your accounts via the WHM</a>.</div>


<h2>What is Google MX Wizard?</h2>
<p>According to Google: "<em>Google MX Wizard is a suite of Google applications that brings together essential services to help your business. This is a hosted service that lets businesses, schools, and institutions use a variety of Google products -- including Email, Google Docs, Google Calendar, and Google Talk -- on a unique domain (e.g., www.yourcompany.com).</em>"</p>

<h2>How to set up Google MX Wizard within the cPanel</h2>
...
<ol class="article_list">
  ...
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/cpanel/google-apps-tool/1-select-google-apps-icon.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/cpanel/google-apps-tool/1-select-google-apps-icon.png" title="Click here to view the larger image" width="200" /></a>Using the cPanel interface, locate the <em>Email</em> category and click on the <strong>Google Apps Wizard</strong><div style="clear:both;"></div></li>
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/cpanel/google-apps-tool/2-select-domain.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/cpanel/google-apps-tool/2-select-domain.png" title="Click here to view the larger image" width="200" /></a>You are taken to the first step in the Wizard. Select the domain name you want to connect to your Google Apps account from the dropdown list.<div style="clear:both;"></div></li>
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/cpanel/google-apps-tool/3-click-configure.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/cpanel/google-apps-tool/3-click-configure.png" title="Click here to view the larger image" width="200" /></a>On the second step, select any of the optional features you want to set up for your domain, if any. Once you have finished, click on the <strong>Continue and Configure domain with Google Apps</strong> button.<div style="clear:both;"></div></li>
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/cpanel/google-apps-tool/4-click-OK.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/cpanel/google-apps-tool/4-click-OK.png" title="Click here to view the larger image" width="200" /></a>A quick confirmation screen pops up. Click on the <strong>OK</strong> button in order to continue the setup.<div style="clear:both;"></div></li>
</ol>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/cpanel/google-apps-tool/5-success.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/cpanel/google-apps-tool/5-success.png" title="Click here to view the larger image" width="200" /></a>This screen displays the changes that the wizard makes as it goes along. Once it finishes, your Google Apps configuration will be complete.</p>
<br /><br />
<p style="clear:both;"></p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/cpanel'>cPanel</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 4: Setting up Google MX Wizard in cPanel</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 3: <a href='/support/edu/cpanel/mass-migration'>What to expect during a mass server migration</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 5: <a href='/support/edu/cpanel/how-to-import-mysql-databases-in-command-line'>How to Import MySQL Databases in Command Line</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/cpanel/set-up-google-apps&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/cpanel/set-up-google-apps'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD03MCZpZD0zMjUwJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="1a3671d501a169441b2fc4a2bb05747d" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						...
						<div><a style='font-size:16px;' href='//www.gravatar.com/90e411d60c75505abfa415614a9199d6'>Brynn Bellingham</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-22 12:44 pm</div>
				                <div><p>Hi there,&nbsp;</p>
<p>Once I run the wizard, will all of my organization's emails (currently associated with a Google business account) be setup and ready to go? Or is there another step (either on the InMotion or Google side) to make sure that they are pointed in the right direction?</p>
<p>Thanks!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24363);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-22 3:33 pm</div>
				                <div>Hello Brynn,<br />
<br />
After the wizard, all emails headed to your account will go to Google. Just makes sure the Google Apps account is set up for the emails.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24376);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						...
						<div><a style='font-size:16px;' href='/support/community-support/users/nilands55s'>nilands55s</a></div>
						<div><a href='https://twitter.com/nilandsplace' target='_blank'><img src='//www.inmotionhosting.com/img/icon-twitter.png' style='width:20px;' /></a><a href='https://www.facebook.com/nilands.place' target='_blank'><img src='//www.inmotionhosting.com/img/icon-facebook.png' style='width:20px;' /></a><a href='https://plus.google.com/+NilandEnterpriseLaurinburg/posts' target='_blank'><img src='//www.inmotionhosting.com/img/icon-google.png' style='width:20px;' /></a></div>
						<div></div>
						<div>11 <a href='/support/team/points' target='_blank'>Points</a></div>
						
					</td>
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-05 6:26 pm</div>
				                <div>this does not work! the Icon/link gets a HTTP error 404<br />
The requested page was not found.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26387);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-08 1:48 pm</div>
				                <div>Hello nilands55s,<br />
<br />
I am not seeing a 404 on our test account (which is on a live server). What type of account are you using? If you are on a shared server, please let us know the server number so we can take a look (like ecbiz123, for instance).<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26448);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-28319'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/ec559c3695d14bb10f8a679660b93fa0?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/ec559c3695d14bb10f8a679660b93fa0'>Clint</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-10 6:52 pm</div>
				                <div><p>This doco needs updating, as there is no "Google Apps Wizard" application in cPanel. There is "Google MX Wizard" though, which I presume does the same thing :-)</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28319);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-11 12:41 am</div>
				                <div>Hello Clint,<br />
<br />
Thank you for your contribution we will have that updated shortly.<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28332);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-31278'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/8cbb7f90cf8859e511c5f72ccd547ec1?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/8cbb7f90cf8859e511c5f72ccd547ec1'>Nathan</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-16 6:38 pm</div>
				                <div><p>Hello,</p>
<p>I ran the Google MX wizard but I'm thinking I shouldn't have? I'm pretty new to InMotion. Purchased a domain with you guys and I'm starting a simple personal blog. I see that to check e-mail going to an email you setup using your domain name, you need to select a webmail service such as one you have listed like...Horde, Roundcube, SquirrelMail. I simply want my e-mail to go to my gmail account. So I thought maybe I should run the Google MX wizard. Can I revert those changes and what method should I be using to receive my email to my gmail account?</p>
<p>Thanks so much! :)</p>
<p>-Nathan</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31278);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-17 3:12 am</div>
				                <div>Hello Nathan,<br />
<br />
In you cPanel, you have complete control of your DNS including your mail server (MX) settings.  If you want to remove the MX server settings, you can go into the MX settings under EMAIL in cPanel and then remove the old entries.   <br />
<br />
If you have any further questions, please let us know.  <br />
<br />
Kindest regards,<br />
Arnel C.                                                          </div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31287);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-31717'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/54ab3ef6058e1632c55f443cd8cd762d?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/54ab3ef6058e1632c55f443cd8cd762d'>Julius</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-05 6:33 pm</div>
				                <div><p>Im trying to set up an email for my domain using good apps (for my wordpress site) however during set up MX records (to prove I own the domain) I log into the cpanel and go to mail but the google apps wizard doesnt seem to be there? any ideas why not and how I can get it?</p>
<p>Many thanks&nbsp;</p>
<p>Juliis&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31717);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-06 10:28 am</div>
				                <div>Hello Julius,<br />
<br />
If you're on a vps or dedicated server and you do not see the application, then you need to <a href="http://www.inmotionhosting.com/support/website/getting-started-guides/submitting-and-checking-on-status-of-tickets">submit a verified support ticket</a> to our live technical support team.  They can have the app installed for you.  If you're on a shared server - business level or reselller- account, then it should already be on the server.  The solution is the same, though, you need to contact the live support team if it's not there.<br />
<br />
If you have any further questions or comments, please let us know.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31734);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
