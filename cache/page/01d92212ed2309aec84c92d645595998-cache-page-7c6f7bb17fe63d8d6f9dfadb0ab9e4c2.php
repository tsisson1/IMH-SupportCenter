<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:65291:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-3/seo-settings/add-html-suffix" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-07-25T15:52:01-07:00" />
  <meta name="keywords" content="Joomla 3.0 add .html to end suffix url" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="In this tutorial we'll show you how to adust the Adds Suffix to URL setting in Joomla 3.0 to add / remove .html from the end of your URLs." />
  <title>How to add the .html suffix to the end of URLs in Joomla 3.1 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-3/seo-settings/add-html-suffix" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:866a93cf603af7ca3755ece77a99852c -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to add the .html suffix to the end of URLs in Joomla 3.1									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>9,330</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jul 25, 2012'><span style='color:#606060;'>Published:</span> Jul 25, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/global-configuration/seo-settings-adds-suffix-to-url.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="seo-settings-adds-suffix-to-url" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/global-configuration/seo-settings-adds-suffix-to-url.gif" /></a>Joomla 3.0 allows you to toggle on / off whether you want to add the .html suffix to the end of your URLs. This is just one of <a href="/support/edu/joomla-3/seo-settings">several SEO Settings</a> you can adjust in Joomla 3.0. In this tutorial we'll go into more depth on the <em>Adds Suffix to URL</em> option in Joomla 3.0.</p>
<div style="clear: both;"></div>
<p> </p>
<p><strong>To adjust whether .html is added to the end of your Joomla 3.0 URLs:</strong></p>
<ol class="article_list">
<li><a href="/support/edu/joomla-3/getting-started/login-dashboard">Log into your Joomla 3.0 dashboard</a></li>
<li>In the left menu, find and click <strong>Global Configuration</strong>. This link is located under the <strong>SYSTEM</strong> heading.</li>
<li>Ensure you are on the Site tab by clicking <strong>Site</strong> (this is the tab that loads by default)</li>
<li>On the right side of the page, locate the <strong>Adds Suffix to URL</strong> setting (which is highlighted in the screenshot above). Click Yes / No to toggle the setting, and then click <strong>Save</strong> in the top left menu.
<p class="alert"><strong>Please note!</strong><br />This setting will only take effect when if you have <a href="/support/edu/joomla-3/seo-settings/using-sef-urls">enabled SEF URLs</a>.</p>
<p>You can see in the table below how the <strong>Adds Suffix to URL</strong> setting changes our URLs:<br /><br /></p>
<table class="article_table">
<tbody>
<tr>
<th>Adds Suffix to URL - YES</th>
</tr>
<tr>
<td>
<pre class="code_block">http://domain.com/index.php/2-uncategorised/1-this-is-my-first-test-article<span style="color: #ff0000;">.html</span></pre>
</td>
</tr>
<tr>
<th>Adds Suffix to URL - NO</th>
</tr>
<tr>
<td>
<pre class="code_block">http://domain.com/index.php/2-uncategorised/1-this-is-my-first-test-article</pre>
</td>
</tr>
</tbody>
</table>
<p>You may need to scroll to the right to see it, but in our first URL <span style="color: #ff0000;">.html</span> has been added to the end of the URL.</p>
<p><strong>TIP!</strong><br />You may have noticed in the URL that <span style="color: #ff0000;">index.php</span> is included. If you'd like to learn how to remove index.php from your Joomla 3.0 URLs, <a href="/support/edu/joomla-3/seo-settings/remove-index-php">click here</a>.</p>
</li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/joomla-3/seo-settings'>201: Joomla 3 SEO Settings</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 3: How to add the .html suffix to the end of URLs in Joomla 3.1</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 2: <a href='/support/edu/joomla-3/seo-settings/remove-index-php'>How to remove index.php from URLs in Joomla 3</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 4: <a href='/support/edu/joomla-3/seo-settings/unicode-aliases'>How to allow Unicode Aliases in Joomla 3.1</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNDImaWQ9MTYxNiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="7ac25dfd23386a8dd35748da27fd17bf" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/joomla-3/seo-settings?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Joomla 3 SEO Settings</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/joomla-3/seo-settings/using-sef-urls?tsrc=rsbedu'>Using Search Engine Friendly URLs in Joomla 3.1</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/joomla-3/seo-settings/remove-index-php?tsrc=rsbedu'>How to remove index.php from URLs in Joomla 3</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/joomla-3/seo-settings/add-html-suffix?tsrc=rsbedu'>How to add the .html suffix to the end of URLs in Joomla 3.1</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/joomla-3/seo-settings/unicode-aliases?tsrc=rsbedu'>How to allow Unicode Aliases in Joomla 3.1</a></td>
                </tr>
          <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/joomla-3/seo-settings/include-site-name?tsrc=rsbedu'>How to Include your Site Name in your Joomla 3.1 Page Titles</a></td>
                </tr>
          	</table>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/cd77f63a490a976871284e53c7f6764d?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/cd77f63a490a976871284e53c7f6764d'>pepperstreet</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-22 2:03 pm</div>
				                <div><p>Is there any technical or even a SEO reason to use the .html ending? Or just personal preference and makeup?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14250);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-22 2:44 pm</div>
				                <div>Hello Pepperstreet,<br />
<br />
Thanks for the question!  It's a good one!  If your page is already ranking high with the .html ending then it's probably best to leave it there. However, if you have a lot of room to improve your search rankings, then it's often considered a good thing to do because it can help to eliminate the error factor when someone is searching for your content.  Here's a good reference on this topic from <a href="http://moz.com/community/q/removing-html-extension-from-url-benefit" rel="nofollow" target="_blank">Moz</a>.<br />
<br />
Kindest regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14251);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-24 7:48 pm</div>
				                <div><p>Thanks Arnel! Did not expect a comment so soon ;) The link and conversion is not bad. At least I got some confirmation on my own&nbsp;thoughts.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14279);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
