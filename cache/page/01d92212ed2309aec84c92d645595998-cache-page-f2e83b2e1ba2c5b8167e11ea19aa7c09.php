<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:92804:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/what-is-a-name-server" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-02-28T23:05:34-08:00" />
  <meta name="keywords" content="name server servers nameserver nameservers custom vanity" />
  <meta name="author" content="Jacob Nicholson" />
  <meta name="description" content="In this article we'll explain what a name server is, and how name servers are used to direct the traffic of your website to a specific web server at a web host." />
  <title>What is a name server? - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/what-is-a-name-server" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<script type="text/javascript">
		...
		_gaq.push(['_setCustomVar', 4, 'DateMonthPublished', '2012-12', 3]);
	...
	<!-- cid:bd0277d9b51f4073552fbf20407383fd -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-22']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '104.129.194.119']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>125,246</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Dec 19, 2012'><span style='color:#606060;'>Published:</span> Feb 28, 2014</div>
  ...
  <h2>Navigation:</h2>
  <button type="button" class="btn btn-primary" onclick="window.location.hash='explain-name-servers';">Name servers?</button>
  <button type="button" class="btn btn-primary" onclick="window.location.hash='what-am-i-using';">What am I using?</button>
  <button type="button" class="btn btn-primary" onclick="window.location.hash='imh-name-servers';">InMotion's name servers</button>
  <button type="button" class="btn btn-primary" onclick="window.location.hash='update-name-servers';">Update name servers</button>
</div>

<div class="in_this_tutorial">
    <h2>Related:</h2>
    <button type="button" class="btn btn-primary" onclick="window.location='/support/domain-names/dns-nameserver-changes/using-custom-name-servers';">Custom name servers</button>
    <button type="button" class="btn btn-primary" onclick="window.location='/support/domain-names/dns-nameserver-changes/vanity-nameservers-what-are-they-and-how-do-i-set-them-up';">Vanity name servers</button>
    <button type="button" class="btn btn-primary" onclick="window.location='/support/domain-names/dns-nameserver-changes/updating-your-domains-nameservers';">Updating your domain's name servers</button>
</div>

<p>In this article we'll explain what a name server is, and how name servers are used to direct the traffic of your website to a specific web server at a web host.</p>
<p>We'll also go over <a href="#imh-name-servers">InMotion Hosting's public name servers</a>, <a href="#vanity-name-server">vanity name servers</a>, and <a href="#custom-name-server">custom name servers</a>.</p>
<p>The terms name server, and nameserver are interchangeable and refer to the exact same thing. I wanted to point this out explicitly to avoid any confusion as you'll see it displayed both ways across the Internet.</p>

<a name="explain-name-servers"></a>
<h2>What are name servers?</h2>
<p>A name server is a specialized server on the Internet that handles queries or questions from your local computer, about the location of a domain name's various services.</p>
<p>A great simple way to think about name servers is using a phone book analogy. If you were trying to call InMotion Hosting you might have remembered our phone number, but more than likely you'd want to look it up before just guessing at numbers.</p>
<p>This same story is also true for the Internet and domain names. As an example you're reading this article right now on our <strong>InMotionHosting.com</strong> domain name.</p>
<h3>What do DNS requests to name servers look like?</h3>
<p>But just how exactly did your computer know what webpage to display for you, and what server to pull it from?</p>
<div style="background-color: #fafad2; border: 1px #D3D3D3 dashed; border-radius: 5px; padding: 0px 0px 0px 5px; margin-bottom: 5px;">
<p>Your web-browser knows you typed <strong>InMotionHosting.com</strong> into the address bar.</p>
<p>Your computer then uses DNS to retrieve the current nameservers for <strong>InMotionHosting.com</strong>.</p>
<p>Our public nameservers; <strong>ns.inmotionhosting.com</strong> and <strong>ns2.inmotionhosting.com</strong> are retrieved.</p>
<p>Your computer asks our nameservers for the <strong>A (address)</strong> record for <strong>InMotionHosting.com</strong>.</p>
<p>Our public nameservers respond back with the IP address <strong>192.145.237.216</strong></p>
<p>Your computer sends a request to that IP address along with the page you're requesting.</p>
<p>Our web server hosting <strong>InMotionHosting.com</strong> then sends your web-browser the requested page.</p>
</div>
<p>Now if you wanted to, you could bookmark or copy down <strong>http://192.145.237.216</strong> for anytime you'd like to come back to our website.</p>
<p>More than likely though, <strong>InMotionHosting.com</strong> is going to be much easier for you to remember, and this is why nameservers exist on the Internet.</p>

<a name="vanity-name-server"></a>
<h2>Vanity name servers</h2>
<p>A <a href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/vanity-nameservers-what-are-they-and-how-do-i-set-them-up" target="_blank">vanity nameserver</a> is a name server that is branded to a website of your choice, instead of our public name servers. This can make your site appear more professional, by masking the fact you're using our name servers.</p>

<p>With vanity name servers you are just hiding or masking the hostname of our public name servers, but the IP addresses and the physical servers handling your website's DNS requests would still be our public name servers.</p>

<a name="custom-name-server"></a>
<h2>Custom name servers</h2>
<p>A <a href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/using-custom-name-servers" target="_blank">custom name server</a> allows you to run your own name server to respond to DNS requests for your domains. It is also a requirement for <a href="http://www.inmotionhosting.com/vps_hosting.html" target="_blank">VPS</a> and <a href="http://www.inmotionhosting.com/dedicated_servers.html">dedicated server</a> customers who wish to have <a href="http://www.inmotionhosting.com/support/website/general-server-setup/root-access-faq" target="_blank">root access</a> on their servers, since with root access you can modify the DNS zones on the server, and having access to our public name server zones would be a security risk.</p>




<a name="what-am-i-using"></a>
<h2>What name servers am I using?</h2>
<p>To check and see the name servers your domain name is currently set to use, you can either use our <a href="http://www.inmotionhosting.com/support/tools/visual-domain-routing" target="_blank">domain routing tool</a> to view this DNS information, or by using the Windows command prompt following the steps below.</p>

<h3>Check from command prompt</h3>
<ol class="article_list">
<li>In Windows click on <strong>Start</strong>, in the <strong>Search programs and files</strong> field type in <strong>cmd</strong>, then hit <strong>Enter</strong>.</li>
<li>With the command prompt opened, type in the following command and hit <strong>Enter</strong><br /><br /> <span class="code_block">nslookup</span></li>
<li>You should now be at the <strong>nslookup</strong> prompt indicated by <span class="code_block">&gt;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<p style="margin-top: 5px;">Specify you'd just like to see <strong>NS (Name Server)</strong> records of the domain by typing in the following:</p>
<p><span class="code_block">set q=NS</span></p>
<p>Hit <strong>Enter</strong> to be dropped to the next line, and here is where you'll type in your domain name:</p>
<p><span class="code_block">inmotionhosting.com</span></p>
<p>For this example we used <strong>InMotionHosting.com</strong> and we get back our public name servers:</p>
<p class="code_block" style="width: 400px;">ns.inmotionhosting.com internet address = 74.124.210.242<br />ns2.inmotionhosting.com internet address = 70.39.150.2</p>
</li>
</ol>


<a name="imh-name-servers"></a>
<h2>What are InMotion's name servers?</h2>
<p>If you register your domain name through us, by default you'll be using our public name servers automatically. If you registered your domain name somewhere else and would like to have the domain hosted with us, you'll want to update your domain's name server records to point to our public name servers.</p>
<p>Here are InMotion Hosting's public name servers and IP addresses:</p>
<p class="code_block" style="width: 300px;">ns.inmotionhosting.com 74.124.210.242<br /> ns2.inmotionhosting.com 70.39.150.2</p>
<p class="alert">Anytime you're making DNS changes, especially relating to changing your name servers it can take between 24-48 hours for those new settings to fully propagate out over the Internet.</p>
<h3>Do I have to use these?</h3>
<p>Setting your domain's name servers are basically just letting your domain Registrar know where to send DNS requests for your domain to. So technically it is <strong>not</strong> required that you use our public name servers in order to have your domain name hosted with us.</p>
<p>If you already have access to directly modify your DNS records for your domain, you can simply modify your DNS records so they directly point to the IP address of the server you're using with us.</p>
<p>So in our case from the earlier example with <strong>InMotionHosting.com</strong> we saw the IP address we were getting back from our public name servers was <strong>192.145.237.216</strong>.</p>
<p>If we update the <strong>NS (Name Server)</strong> records for <strong>InMotionHosting.com</strong> to use <strong>ns1/2.MyCustomDomain.com</strong> instead of our public name servers. As long as we still have an <strong>A (Address)</strong> DNS record pointing to <strong>192.145.237.216</strong> on those name servers as well, the website would still be pulled from the same physical web server.</p>

<a name="update-name-servers"></a>
<h2>How do I update my name servers?</h2>
<p>In order to update your domain name's name servers, this modification needs to be made at your domain Registrar where the domain name was registered at.</p>
<p>You can read our guide on <a href="/support/domain-names/dns-nameserver-changes/updating-your-domains-nameservers" target="_blank">updating your domain's name servers</a> for more in-depth information on this process. It covers how you can update domain name servers registered through us from our AMP interface, and it also contains links to other popular domain Registrars, and the steps you'd take with them to update your name servers.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/what-is-a-name-server&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/what-is-a-name-server'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD02OCZpZD04NjEmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="924b14229e25cff7e0c50321190952a7" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/domain-names/domain-from-godaddy-and-hostin-with-inmotionhosting?tsrc=rsbraq'>Domain was registered through GoDaddy, do I need to do anything else?</a>
                                </div>
...
<a name='comments'></a>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/45610359722b1240a407823b76ddb765?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/45610359722b1240a407823b76ddb765'>david</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-13 2:00 pm</div>
				                <div>nothing it was great and made sense to me. thank you</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(18459);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-19755'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/3c0002b2014f3bb93371c57049501b96?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/3c0002b2014f3bb93371c57049501b96'>Simona Busuioc</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-20 7:20 am</div>
				                <div>great article. easy to understand for a newbie like me.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19755);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-19921'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/0954fadfb2fe9822214f6b942b4e4b20?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/0954fadfb2fe9822214f6b942b4e4b20'>lydia mamo</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-25 5:09 pm</div>
				                <div><p>Please complete my hosting transfer . Thanks&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19921);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
				...
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-26 11:16 am</div>
				                <div>Hello Lydia,<br />
<br />
Thanks for the question.  Website transfers are handled by our live technical support team.  According to our records, your transfer is complete.  You would have received an email stating the completion of the transfer.  If you have any problems with the transfer, please respond to that email so that the Website Transfer team can address the issue.<br />
<br />
I hope this helps to answer your question, please let us know if you require any further  assistance.<br />
<br />
Kindest regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19946);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-20635'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/b0742f850ae53db337d016f22c8ffea2?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/b0742f850ae53db337d016f22c8ffea2'>Raghava</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-13 2:57 am</div>
				                <div><p>Hi</p>
<p>Thanks for the article, great information, I'm really happy to read this article </p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20635);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-24190'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/d7f58f3e7a82dd912db856ba8c42f305?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/d7f58f3e7a82dd912db856ba8c42f305'>luis vidal</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-14 7:53 am</div>
				                <div><p>I just was reading "passing by" your article and it clears me many things in this&nbsp; web obscure world in which there are as many names and definitioss than in a wb thesaurus; for asimple question like this : who is parking my domain and why?, I have been before my laptop for an unsormantable number of hours and I don't seem to get back a reasonable anser, but just passing the buck answers. I'm gonna try with you:&nbsp; who is parking my domain:</p>
<p>venbiomedi.org</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24190);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-15 2:52 pm</div>
				                <div>Hello Luis,<br />
<br />
That domain seems to be registered by PublicDomainRegistry.com and is pointed to rhostjh.com.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24225);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-27906'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/240fa3634a4a392df3454d669eaee066?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/240fa3634a4a392df3454d669eaee066'>Gwilym</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-27 2:18 pm</div>
				                <div><p>I have a personal domain at home (not fr.com) that I have to give up to a third party. &nbsp;But, I get some emails directed to that domain. &nbsp;How can I set it up so emails going to my old domain get redirected to my new domain?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27906);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-27 2:58 pm</div>
				                <div>Hello Gwilym,<br />
<br />
Unfortunately you can not do that as once the DNS is changed to another host and emails going to that domain will go to the new host. <br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27908);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-29743'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/89c7ce1b02175959c089121405ac0531?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/89c7ce1b02175959c089121405ac0531'>Ian</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-12 2:02 pm</div>
				                <div><p>Hello,</p>
<p>Last week I pointed one of my domain's DNS from Hostmonster to Inmotion. &nbsp;How do I begin&nbsp;building my website (with Wordpress) under that domain? &nbsp;Thank you.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29743);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-12 2:41 pm</div>
				                <div>From this point I recommend you proceed with installing the WordPress software on your account. It is fairly quick and easy to get going. I advise you familiarize yourself with our <a href="http://www.inmotionhosting.com/support/edu/wordpress">WordPress Education Channel</a>, where you can find detailed instructions on setting up your installation and getting started. Once you have installed WordPress you can start publishing posts and pages instantly.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29745);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-30332'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/662e09360ec6f4480e64d7e90abe4ffa?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/662e09360ec6f4480e64d7e90abe4ffa'>Anil</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-02-04 10:32 am</div>
				                <div><p>Hi,</p>
<p>My domain is registered with name.com and in my account the name servers are listed as&nbsp;</p>
<p><span style="color: #343231; font-family: ProximaNova, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 20px;">ns1.name.com&nbsp;</span></p>
<p><span style="color: #343231; font-family: ProximaNova, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 20px;">ns2.name.com and so on. I purchased hosting from Inmotion. how do i point my domain to inmotion.</span></p>
<p><span style="color: #343231; font-family: ProximaNova, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 20px;">Thanks,</span></p>
<p><span style="color: #343231; font-family: ProximaNova, Arial, Helvetica, sans-serif; font-size: 14px; line-height: 20px;">Anil</span></p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30332);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-02-04 1:05 pm</div>
				                <div>Hello Anil,<br />
<br />
Thank you for contacting us. You will need to <a href="https://www.name.com/support/articles/205934547-Changing-Your-Name-Servers" target="_blank" rel="nofollow" >change the nameservers</a> for your domain at name.com to ours:<br />
ns.inmotionhosting.com 74.124.210.242<br />
ns2.inmotionhosting.com 70.39.150.2<br />
<br />
Then allow time for your site to <a href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/domain-names-dns-changes">propagate</a> to our servers.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30339);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-30479'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/5041baf54201521144abedbfd7075db1?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/5041baf54201521144abedbfd7075db1'>refaat</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-02-11 7:21 am</div>
...
<p style="margin: 0px 0px 11px; color: #232323; font-family: adelle-sans, Helvetica, Arial, sans-serif; font-size: 13px; line-height: 22px;">My domain is registered with othe NS server&nbsp;,It is end with .sa&nbsp; &nbsp;</p>
<p style="margin: 0px 0px 11px; color: #232323; font-family: adelle-sans, Helvetica, Arial, sans-serif; font-size: 13px; line-height: 22px;">&nbsp;I purchased hosting from Inmotion. how do i create A record for&nbsp;&nbsp;my domain in NS of&nbsp;inmotion.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30479);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-02-11 4:49 pm</div>
				                <div>Hello refaat,<br />
<br />
Thank you for contacting us. Here is a link to our guide on <a href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/a-record-change">Adding an A record</a>.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30492);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
