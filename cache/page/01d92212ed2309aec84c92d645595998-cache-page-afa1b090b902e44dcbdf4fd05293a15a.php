<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:76619:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/ghost/adding-google-analytics-to-ghost" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-02-03T20:53:20-08:00" />
  <meta name="author" content="Jeff Matson" />
  <meta name="description" content="In this article, we will teach you how to add Google Analytics to your website built with the Ghost blogging platform." />
  <title>Adding Google Analytics to Ghost - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/ghost/adding-google-analytics-to-ghost" rel="canonical" />
...
<script>
  ...
  ga('send', 'pageview');
	...
	<!-- cid:0c28800b94586087a9bd32d1e7e094b7 -->
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/website/ghost' itemprop='url'><span itemprop='title'>Ghost<span></a><div class='dropdown_3columns'><div class='col_3'><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/ghost/how-to-install-the-ghost-blogging-platform'>How to install Ghost</a> (5324 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/ghost/adding-google-analytics-to-ghost'>Adding Google Analytics to Ghost</a> (4542 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/ghost/migrating-your-wordpress-site-content-to-ghost'>Migrating your Wordpress site content to Ghost</a> (4317 hits)</div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Adding Google Analytics to Ghost</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Adding Google Analytics to Ghost									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>4,542</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Oct 16, 2013'><span style='color:#606060;'>Published:</span> Feb 3, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In this article, we will walk you through the process of manually adding <a href="http://www.inmotionhosting.com/support/website/google-tools/installing-google-analytics-on-your-website">Google Analytics</a> to your website built with Ghost.  Unfortunately, at the time of writing this Ghost does not have a plugin or specific setting to integrate Google Analytics to your site, but the process is still fairly straightforward due to the simplicty of Ghost themes.</p>
<h2>Adding a new site to Google Analytics for Ghost to use</h2>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/ghost/ghost-google-analytics-1.png"><img src="//cdn.inmotionhosting.com/support/images/stories/ghost/ghost-google-analytics-1.png"  style='float:right; margin:0px 0px 15px 15px;'></a><p>If this is the first time that you are setting this site up with Google Analytics, you will need to first create a new site within Google Analytics.  To do so, log into your Google Analytics account, then click on Admin.  The left side section will have a dropdown box.  Click on that, then click on "Create new account".</p>
<div style='clear:both;'></div>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/ghost/ghost-google-analytics-2.png"><img src="//cdn.inmotionhosting.com/support/images/stories/ghost/ghost-google-analytics-2.png"  style='float:right; margin:0px 0px 15px 15px;'></a><p>Next, simply enter in your information for your site such as a name for it, the URL, category, and time zone.</p>
<div style='clear:both;'></div>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/ghost/ghost-google-analytics-3.png"><img src="//cdn.inmotionhosting.com/support/images/stories/ghost/ghost-google-analytics-3.png"  style='float:right; margin:0px 0px 15px 15px;'></a><p>After you have created the new account, you will be provided a tracking code.  Be sure tyo keep this in a easy to remember place as you will be using it for the next steps.</p>
<div style='clear:both;'></div>
<h2>Inserting your Google Analytics tracking code into Ghost</h2>
<p>Although we do not yet have a solution available to place Google Analytics within a site made with Ghost directly through the admin dashboard, it can be inserted just as easily within your Ghost theme.</p>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/ghost/ghost-google-analytics-4.png"><img src="//cdn.inmotionhosting.com/support/images/stories/ghost/ghost-google-analytics-4.png"  style='float:right; margin:0px 0px 15px 15px;'></a><p>First, you will need to locate a file that is used on every page within your Ghost theme.  In this example, we are using the default Casper theme in which we can easily insert it into the default.hbs file.  Any themes will be located in their respctive folders inside the /content/themes folder.</p>
<div style='clear:both;'></div>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/ghost/ghost-google-analytics-5.png"><img src="//cdn.inmotionhosting.com/support/images/stories/ghost/ghost-google-analytics-5.png"  style='float:right; margin:0px 0px 15px 15px;'></a><p>From here, locate your default.hbs file and open it.  In here, you will see some familiar HTML tags.  Then, locate the &lt;/head&gt; tag.  Once you have found this HTML tag, simply place your Google Analytics code directly above it.  Once it is in there, save your file and restart Ghost.  You should now see your data being successfully tracked by Google Analytics.</p>
<div style='clear:both;'></div> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/ghost/adding-google-analytics-to-ghost&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/ghost/adding-google-analytics-to-ghost'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NjkmaWQ9Mjg5NyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="b51fdf2ef80d330d314b0a262699e7fb" value="1" />	</div>
	</form>
<!-- <br />
...
<a name='comments'></a>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='https://lh3.googleusercontent.com/-5pdm4vE5li8/AAAAAAAAAAI/AAAAAAAAAFo/Iq0Box1A8gY/photo.jpg?sz=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='/support/community-support/users/cirocosta'>cirocosta</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-02-20 12:16 pm</div>
				                <div>Thanks for the tips. I'd suggest, although, inserting the script at the end of the page as stated on browser diet http://browserdiet.com/#css-on-top-js-on-bottom</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8589);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-02-20 1:05 pm</div>
				                <div>Typically, you would want to place most JavaScript futher down the page, but with Google Analytics, it is recommended by Google to place it within your header for more accurate tracking, as well as it is asynchonous so placing it higher in your code will not affect the loading of other elements even if it is closer to the top.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8590);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-02-20 1:20 pm</div>
				                <div>Thanks for the reply JeffMa. Didn't know it was a recommendation by Google. Will surely consider that.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8591);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/9d182c4deac637baedc3b797045ae86f?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/9d182c4deac637baedc3b797045ae86f'>Tristan</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-07 2:07 pm</div>
				                <div><p>Thanks Jeff. &nbsp;Just got started on ghost and this helped check a task off my list.</p>
<p>&nbsp;</p>
<p>Cheers!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8835);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/953c8523a79569f1527c67cf8f89e0b9?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/953c8523a79569f1527c67cf8f89e0b9'>btburton</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-12 8:00 pm</div>
				                <div><p>All, I've put the tracking in default.hbs and can see it reflected in the page source. Still Google Analytics is telling me tracking is not installed. Does anyone have any tips at this point? Thanks.</p>
<p>FYI - Using the Amazon Ghost AMI on an EC2</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8928);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-14 8:30 am</div>
				                <div>If you're seeing it in the source, it should be all set.  I have seen Google Analytics take a few visits to your site before it is reporting correctly so that could be a possibility.  As long as the tracking code is visible in the source between the opening and closing &amp;lt;head&amp;gt; tags, everything is in place correctly and Google may just be lagging behind in fully detecting the tracking code.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8959);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-14 12:45 pm</div>
				                <div><p>@jeffMa - thanks for the help! you're right. just had to wait a few days and it showed up.&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8961);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-14003'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/bda486b80a2e80a8e22afe69dd621303?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/bda486b80a2e80a8e22afe69dd621303'>Josh Habdas</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-14 2:55 pm</div>
				                <div><p>If &nbsp;you're using CloudFlare as your CDN, no need to modify files. Instead, there's an app for that:&nbsp;http://www.habdas.org/add-google-analytics-ghost-cloudflare/</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14003);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-14 3:07 pm</div>
				                <div>Hello Josh,<br />
<br />
Thank you for your suggestion about using <strong>Cloudflare CDN</strong> services with <strong>Ghost</strong>. If you want to create a post about your app in our <a href="http://www.inmotionhosting.com/support/u">User Submitted</a> section, I would be happy to link your comment to it.<br />
<br />
If you have any further questions, feel free to post them below.<br />
Thank you,<br />
<br />
-John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14005);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
