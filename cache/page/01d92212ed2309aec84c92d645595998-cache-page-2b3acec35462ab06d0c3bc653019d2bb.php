<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:57265:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotion.net/support/edu/php-fusion/getting-started-php-fusion/changing-languages-in-php-fusion" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-03-25T18:54:10-07:00" />
  <meta name="keywords" content="change add modify language locale php-fusion php fusion phpfusion admin panel" />
  <meta name="author" content="Arnel C." />
  <meta name="description" content="In order to select a different language in PHP-Fusion, you must choose a different locale.  The following article explains how to change the locale within the Admin Panel interface." />
  <title>Changing Languages in PHP-Fusion - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/php-fusion/getting-started-php-fusion/changing-languages-in-php-fusion" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:3bfa3e268bc3384f7be8d61963a42cb9 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Changing Languages in PHP-Fusion									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>1,276</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Mar 20, 2013'><span style='color:#606060;'>Published:</span> Mar 25, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Languages are considered LOCALES within the PHP-Fusion system.  In order to change a language, you will need to load the locale which contains all of the hard-coded text. By default, the software is loaded only with the English locale. </p>

<h2>Change Language in PHP-Fusion</h2>
...
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/php-fusion/locales/main-icon.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="200" src="//cdn.inmotionhosting.com/support/images/stories/edu/php-fusion/locales/main-icon.png" alt="Select Settings Tab and then Main icon" align="right" title="Click on Settings Tab and Main icon" class="caption" /></a>Click on the <strong>SETTINGS</strong> tab.<div style="clear:both;"></div></li>
  <li>Scroll down the <strong>SETTINGS</strong> until you get to the section to the <strong>SITE LOCALE</strong>. By default, the site locale is set to <strong>ENGLISH</strong>.  Click on <strong>SITE LOCALE</strong>.<div style="clear:both;"></div></li>.
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/php-fusion/locales/Site-locale-setting.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="200" src="//cdn.inmotionhosting.com/support/images/stories/edu/php-fusion/locales/Site-locale-setting.png" alt="Find and Select Site Locale in Settings" align="right"></a>When you click on <strong>SITE LOCALE</strong> you will see the <strong>LOCAL</strong> options drop-down menu.  In order to get more LOCALES loaded, you will need to obtain them from the support site for the country of the language that you need.  Unfortunately, it is not very easy to find this information on the <a href="http://php-fusion.co.uk" rel="nofollow" target="new">PHP-Fusion home site</a>.  However, if you go to the <a href="http://en.wikipedia.org/wiki/PHP-Fusion" rel="nofollow" target="new">Wikipedia page for PHP-Fusion</a>, you will find that there are many country-specific support sites listed.  Please go to the country-specific support sites in order to obtain the appropriate locale file for language support.<div style="clear:both;"></div></li>
</ol>
<br />
<p><em>Locales</em> are files that contain all of the hard-coded text within your PHP-Fusion site.  You can either go to the specific language site and obtain the entire language-specific installation of PHP-Fusion, or if available, you can get the locale files specific to the language that you wish to support.  The locale file fill need to be saved into the <strong>LOCALE</strong> folder that is located at the root of the installation files for your PHP-Fusion website.
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 5: Changing Languages in PHP-Fusion</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 6: <a href='/support/edu/php-fusion/getting-started-php-fusion/security-options'>Security Options in PHP-Fusion</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotion.net/support/edu/php-fusion/getting-started-php-fusion/changing-languages-in-php-fusion&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotion.net/support/edu/php-fusion/getting-started-php-fusion/changing-languages-in-php-fusion'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP3RzcmM9cnNiZWR1Jm9wdGlvbj1jb21fY29udGVudCZjYXRpZD0zNTEmaWQ9MjQ4OSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="b537c0d6886a989c7b2bc6741ead644e" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
        ...
        <tr><td colspan='2'><h4>Other base configuration settings</h4></td></tr>  <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>5.</td>
