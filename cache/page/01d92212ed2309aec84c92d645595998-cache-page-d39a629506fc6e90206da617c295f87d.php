<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:57414:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://216.193.251.47/support/edu/php-nuke/add-content-php-nuke/managing-forums" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-03-22T18:31:56-07:00" />
  <meta name="keywords" content="forums phpbb php-nuke phpnuke php nuke [gs]" />
  <meta name="author" content="Arnel Custodio" />
  <meta name="description" content="Forums in PHP-Nuke are actually managed by a specific forums program called PHPBB.  The following article provides information on where to find instructions to manage and learn about using PHPBB." />
  <title>Forums in PHP-Nuke - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/php-nuke/add-content-php-nuke/managing-forums" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:41546511a22696c9f28f2f60530aa679 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-20']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '180.76.15.21']);
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/php-nuke' itemprop='url'><span itemprop='title'>PHP-Nuke<span></a><div class='dropdown_2columns'><h2>PHP-Nuke Education Channel</h2><div class='col_2'><h3>100 Level Classes</h3><div><a href='/support/edu/php-nuke/getting-started-php-nuke'>101: Getting Started: PHP-Nuke</a></div><div><a href='/support/edu/php-nuke/add-content-php-nuke'>102: Adding the content to PHP-Nuke</a></div><div><a href='/support/edu/php-nuke/php-nuke-modules-blocks'>103: PHP-Nuke Modules and blocks</a></div><div><a href='/support/edu/php-nuke/change-php-nuke-appearance'>104: Changing the PHP-Nuke Appearance</a></div><div><a href='/support/edu/php-nuke/webstats-reporting-php-nuke'>105: PHP-Nuke Web stats and reporting</a></div><div><a href='/support/edu/php-nuke/php-nuke-statistics-reporting'>106: PHP-Nuke Backups and Site security</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/php-nuke/add-content-php-nuke' itemprop='url'><span itemprop='title'>102: Adding the content to PHP-Nuke<span></a><div class='dropdown_3columns'><h2> Adding the content to PHP-Nuke</h2><div class='col_3'><div>1. <a style='display:inline;' href='/support/edu/php-nuke/add-content-php-nuke/edit-homepage-nuke'>How do I edit the Home page in PHP-Nuke?</a></div><div>2. <a style='display:inline;' href='/support/edu/php-nuke/add-content-php-nuke/create-externale-link-nuke'>How to create an external link in PHP-Nuke</a></div><div>3. <a style='display:inline;' href='/support/edu/php-nuke/add-content-php-nuke/adding-image'>Adding an Image to a Page in PHP-Nuke</a></div><div>4. <a style='display:inline;' href='/support/edu/php-nuke/add-content-php-nuke/creating-content-page'>Creating a Content page in PHP-Nuke</a></div><div>5. <a style='display:inline;' href='/support/edu/php-nuke/add-content-php-nuke/feedback-form'>Working With the Feedback Page in PHP-Nuke</a></div><div>6. <a style='display:inline;' href='/support/edu/php-nuke/add-content-php-nuke/send-newsletter'>Creating a newsletter in PHP-Nuke</a></div><div>7. <a style='display:inline;' href='/support/edu/php-nuke/add-content-php-nuke/managing-forums'>Forums in PHP-Nuke</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Forums in PHP-Nuke</span></li>			</ul>
		</div>
	</div>
</div>
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>969</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Mar 15, 2013'><span style='color:#606060;'>Published:</span> Mar 22, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<div>PHP-Nuke includes forums as part of its functionality, but it actually uses a separate forum program to provide this feature. &nbsp;The forum application is called PHPBB. &nbsp;The following article simply shows what you will see when you go to the forums section. &nbsp;A link will be provided showing how to find the tutorial series from InMotion Hosting on using PHPBB forums. &nbsp;</div>
<div>&nbsp;</div>
<h2>Using Forums in PHP-Nuke</h2>
<div>&nbsp;</div>
<div>Users clicking on FORUMS in the front-end menu of a PHP-Nuke website will see a form of the phpBB forums embedded in the interface. &nbsp;The forum listing may appear like the following (this may vary based on the theme and with available content in the forums):<br /><br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phpnuke/forums/forums-front-end.png"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/phpnuke/forums/forums-front-end.png" alt="Shows how forums would appear in PHP-Nuke interface"  /></a><br /><br /></div>
<div>&nbsp;</div>
<h3>Accessing Forums in the PHP-Nuke Back End</h3>
<div>&nbsp;</div>
<div>As per the introduction, Forumes are not managed in the PHP-Nuke interface. &nbsp;The interface will jump to the PHPBB interface for managing forums. &nbsp;The following steps shows what you will see when accessing forums in the PHP-Nuke Administration interface:</div>
<div>&nbsp;</div>
<div><ol class="article_list">
<li><a href="/support/website/php-nuke/login-administrator-system" target="_blank">Login to the PHP-Nuke Administration interface.</a></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phpnuke/forums/forum-module.png"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/phpnuke/forums/forum-module.png" width="200" height="93" alt="Forums icon in the Administration menu"  style="margin: 0px 0px 15px 15px; float: right;" /></a>Click on the <strong>FORUMS&nbsp;</strong>icon.
<div style="clear: both;">&nbsp;</div>
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phpnuke/forums/forum-management-options.png"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/phpnuke/forums/forum-management-options.png" width="200" height="97" alt="PHPBB Forum management interface"  style="margin: 0px 0px 15px 15px; float: right;" /></a>When you click on the <strong>FORUMS</strong> icon you will be immediately jumped to the <strong>PHPBB Forums interface</strong>.
<div style="clear: both;">&nbsp;</div>
</li>
</ol></div>
<div><a href="/support/edu/phpbb" target="_blank"><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phpnuke/forums/imh-phpbb-forum-tutorials.png"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/phpnuke/forums/imh-phpbb-forum-tutorials.png" width="200" height="199" alt="IMH phpBB Tutorials"  style="margin: 15px 15px 0px 0px; float: left;" /></a></a><br /><br />InMotion Hosting provides a full tutorial series on <strong>PHPBB FORUMS</strong>. &nbsp;Click <a href="/support/edu/phpbb">here to go to the phpBB Tutorials</a>.&nbsp;</div> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/php-nuke/add-content-php-nuke'>102: Adding the content to PHP-Nuke</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 7: Forums in PHP-Nuke</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 6: <a href='/support/edu/php-nuke/add-content-php-nuke/send-newsletter'>Creating a newsletter in PHP-Nuke</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://216.193.251.47/support/edu/php-nuke/add-content-php-nuke/managing-forums&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://216.193.251.47/support/edu/php-nuke/add-content-php-nuke/managing-forums'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zNjImaWQ9NjYyJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="a938fde6e5c70daf879d757df0050b33" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/php-nuke/add-content-php-nuke?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Adding the content to PHP-Nuke</h3></a>
		<table><tr><td colspan='2'><h4>Adding content</h4></td></tr>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/php-nuke/add-content-php-nuke/edit-homepage-nuke?tsrc=rsbedu'>How do I edit the Home page in PHP-Nuke?</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/php-nuke/add-content-php-nuke/create-externale-link-nuke?tsrc=rsbedu'>How to create an external link in PHP-Nuke</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/php-nuke/add-content-php-nuke/adding-image?tsrc=rsbedu'>Adding an Image to a Page in PHP-Nuke</a></td>
                </tr>
        <tr><td colspan='2'><h4>Creating Content, Feedback, Forum, and Newsletter pages</h4></td></tr>  <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/php-nuke/add-content-php-nuke/creating-content-page?tsrc=rsbedu'>Creating a Content page in PHP-Nuke</a></td>
                </tr>
          <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/php-nuke/add-content-php-nuke/feedback-form?tsrc=rsbedu'>Working With the Feedback Page in PHP-Nuke</a></td>
                </tr>
          <tr >
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/php-nuke/add-content-php-nuke/send-newsletter?tsrc=rsbedu'>Creating a newsletter in PHP-Nuke</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>7.</td>
                        <td><a href='/support/edu/php-nuke/add-content-php-nuke/managing-forums?tsrc=rsbedu'>Forums in PHP-Nuke</a></td>
                </tr>
          	</table>
