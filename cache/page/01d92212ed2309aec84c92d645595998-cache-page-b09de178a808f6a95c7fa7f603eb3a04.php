<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:54624:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/moodle/errors-with-moodle-database" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello BrianN, We're sorry to hear about problems reaching the database for your Wordpress site. We apologize for any inconvenience that this has caused ..." />
  <title>Errors with moodle database | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/moodle/errors-with-moodle-database" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:13459e9533aa51e2ee12e617008fb6c1 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-20']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '194.83.68.227']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box straight_bottom'>
                <h1 style='font-size:26px;'>Errors with moodle database</h1>
		<div style='margin-bottom:20px; margin-top:10px; clear:both; color:#6e6e6e;'>Category: <a href='/support/community-support/moodle'>Moodle</a></div>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='http://graph.facebook.com/brian.nacy/picture?type=normal' class='user_avatar' /><br />
			<a href='/support/community-support/users/BrianN'>BrianN</a>
			<div>22 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-08-20 11:39 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>1,429</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>We are currently running Moodle 2.5.1. It was updated in July and had been running smoothly until this past week when trying to enter as admin or students the following error keeps appearing.<br />
&quot;Error reading from database&quot;. What needs to be done to rectify this?<br />
<br />
Thank you - Brian</div>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px;'>
				<div style='font-size:12px; max-width:500px; overflow:auto;'>the moodle path is clase.sbp.mx<br />
<br />
This error also goes for our wordpress webpage with the following error &quot;Error establishing a database connection<br />
...
<br />
The path for this is </div>
				
				
			</td>
			<td style='width:100px;' valign='top'>
				<img src='http://graph.facebook.com/brian.nacy/picture?type=normal' style='width:40px;' class='user_avatar' />
				<div class='smallgrey'>
					<a href='/support/community-support/users/BrianN'>BrianN</a><br />
					22 <a href='/support/team/points' target='_blank'>Points</a><br />
					2013-08-20 11:47 am EST
				</div>
			</td>
		</tr>
	</table>
...
<div style='padding:15px; border:1px solid #d6d6d6; border-top:0px; background:#ebebeb;' class='round_bottom' >
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px;'>
				<div style='font-size:12px; max-width:500px; overflow:auto;'>The path for our website is http://sbp.mx/wp-admin/</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_3767' id='upvote_answer_3767' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='3767' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_3767').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_3767' id='downvote_answer_3767' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='3767' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_3767').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello BrianN,<br />
<br />
We're sorry to hear about problems reaching the database for your Wordpress site.  We apologize for any inconvenience that this has caused for you. Our systems administration is actively working with the server that houses your account to restore service. During this time, connectivity to your site may be sporadic and your site may be temporarily unavailable. We greatly appreciate your patience and understanding while we work on this issue.  They have identified an issue that is affecting the SQL services and they are addressing it.  We unfortunately can't give you an ETA (sorting this out takes a little time), but they are working as fast as they can in order to get everything in working order.<br />
<br />
Apologies again for the service interruption.  Please let us know if you have any further comments or questions.<br />
<br />
Regards,<br />
Arnel C.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_3767').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_3767' id='form_comment_on_answer_3767' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Thank you for your help</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>There are intermittent disruptions to both our moodle database and our wp database. Could you please let me know about progress being made. thanks - Brian </div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>&lt;div style=&quot;background-color: #FFF; padding-left: 10px;&quot;&gt;Hello Brian,<br />
<br />
Sorry for the issues, we are still &lt;a href=&quot;http://www.inmotionhosting.com/support/news/archived/biz136-experiencing-intermittent-database-connectivity-errors&quot; target=&quot;_blank&quot;&gt;experiencing intermittent database connectivity on biz136&lt;/a&gt; where your websites are hosted.<br />
<br />
Our senior system administration team is still in the process of trying to fully mitigate these problems, and I'll have that notice above updated with further information as it becomes available.<br />
<br />
I deeply apologize for the issues and any inconvenience that it's causing you.<br />
<br />
- Jacob&lt;/div&gt; </div>
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="7150704dc71e8422496e747c00acc478" value="1" />	</div>
	</form>
<!-- <br />
