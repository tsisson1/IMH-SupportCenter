<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:54200:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/nginx/getting-started-with-nginx/basic-nginx-commands" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-05-12T18:38:05-07:00" />
  <meta name="keywords" content="nginx, commands" />
  <meta name="author" content="TJ Edens" />
  <meta name="description" content="In this tutorial we will go over basic Nginx commands to get your new installation up and running." />
  <title>Basic Nginx Commands - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/nginx/getting-started-with-nginx/basic-nginx-commands" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:3cf46e2fe8b956edff7e7bdfdac7b7f5 -->
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>573</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Mar 12, 2015'><span style='color:#606060;'>Published:</span> May 12, 2015</div>
							...
							<div style='clear:both;'></div>
								...
								<p>This short tutorial covers a few basic commands or tasks that can be performed with Nginx from the commandline. Understanding the basic commands is the first step to understanding how to manage Nginx on your server. You can invoke the Nginx executable using the -s paramTeter. The correct syntax is as follows:</p>
<
<p><div class="cli"><span style="color:red">nginx -s signal</span></div><div style="clear:both;"></div></p>


<h2>
  Common Commands
</h2>
<p><div class="cli"><span style="color:red">- stop - Shutdown Nginx fast<br />
  - quit - Shutdown Nginx gracefully<br />
- restart - Restarts Nginx while also applying any current configurations.<br />
- reload - forces a reload of the configuration file</span></div><div style="clear:both;"></div></p>
<h2>
 Stop Command
</h2>
<p>Let's say we wanted to stop Nginx right away without finishing the current worker processes. We would use the "stop" command like this:</p>

<p><div class="cli"><span style="color:red">nginx -s stop</span></div><div style="clear:both;"></div></p>
<h2>
  Reload Command
</h2>
<p>Keep in mind, if you edit the configuration file for Nginx it will not be used or applied until the reload command is invoked or you restart Nginx. To force a reload of Nginx, run the command:</p>

<p><div class="cli"><span style="color:red">nginx -s reload</span></div><div style="clear:both;"></div></p>

<p>Once the reload command is ran a signal is sent to the master process. It then checks the syntax of the new configuration file and attempts to apply it. If this is successful, the master process will start new child processes using the new configuration. Old child processes still running will be sent a command to end the current process and restart using the new configuration.</p>

<p>If the new configuration is found to be invalid, the master process will roll back changes and will continue to use the old configuration. This is a great feature as you'll never be able to stop the current configuration and replace it with an invalid one.</p>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 4: Basic Nginx Commands</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 3: <a href='/support/edu/nginx/getting-started-with-nginx/how-to-install-nginx'>How to Install Nginx</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/nginx/getting-started-with-nginx/basic-nginx-commands&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/nginx/getting-started-with-nginx/basic-nginx-commands'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD01MjYmaWQ9MzUxOSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
