<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:83616:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-manage-domains/advanced-dns-editor-cpanel" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-10-26T17:25:38-07:00" />
  <meta name="keywords" content="use create configure A record CNAME txt DNS cpanel advanced editor" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="This cPanel tutorial guides you in using the Advanced DNS Editor." />
  <title>How to use the Advanced DNS Editor in cPanel. - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-manage-domains/advanced-dns-editor-cpanel" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:bcf8bbc96618337822f018f82742b2be -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '97.117.165.90']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to use the Advanced DNS Editor in cPanel.									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>18,976</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Dec 3, 2012'><span style='color:#606060;'>Published:</span> Oct 26, 2015</div>
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Comments:</span> <a href='#comments'>8</a></div>
							<div style='clear:both;'></div>
								...
								<div>A website has many resource records assigned to it. These are used to identify specific locations within the server for different services. For example, when you log into your mail, you can use the URL webmail.yourdomainname.com. The server looks for the DNS record associated with webmail.yourdomainname.com and knows to send you to the Webmail login area. Other records are for use with mail clients or databases. Others can be used for dividing your website into different areas or used to help validate emails or prevent spam.</div>
<div>&nbsp;</div>
<div>DNS records come in a variety of different types. The Basic DNS Editor only allows you to create two types, A and CNAME. You also cannot override or edit any existing records that were generated upon account creation. The Advanced DNS Editor allows you to create A, CNAME, and TXT. It also allows you to override any default records, or those that were generated upon account creation. Follow along below to learn how to access and create records using the Advanced DNS Editor.</div>

<h2>Using the Advanced DNS Editor in cPanel</h2>
<div>
  <ol class="article_list">
    <li><span data-mce-bogus="1"><a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">Log into your cPanel dashboard</a>.</span>
    </li>
    <li>You will see several categories on the right hand panel of the screen. Scroll down to the <em>Domains</em> category and find the <strong>Advanced DNS Editor</strong> icon. Click that to enter the editor.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/cpanel/advanced-dns-editor/select-advanced-dns-editor.png"><img  alt="select-advanced-dns-editor" src="//cdn.inmotionhosting.com/support/images/stories/cpanel/advanced-dns-editor/select-advanced-dns-editor.png" /></a><br /><strong> </strong><span data-mce-bogus="1"></span>
    </li>
    <li>Select the domain you will be working with from the <strong>Select A Domain</strong> dropdown menu. In this example, we selected <em>inmotiontesting.com<br /><br /></em>
    </li>
    <li>Go to the <strong>Add A Record</strong> section and fill out the fields for your desired record.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/cpanel/advanced-dns-editor/enter-record-data.png"><img  alt="enter-record-data" src="//cdn.inmotionhosting.com/support/images/stories/cpanel/advanced-dns-editor/enter-record-data.png" /></a><br />
      <table class="article_table">
        <tbody>
          <tr>
            <th>Name</th>
            <td>Name your record. Be sure that it ends with your domain name and a period. Ex: <em>record.inmotiontesting.com.</em>
            </td>
          </tr>
          <tr>
            <th>TTL</th>
            <td>Time To Live. The record will exist on DNS servers around the world for this fixed amount of time. After it expires, they will need to recontact the server to reset the record. This is set in seconds, so 14400 is 4 hours, which is a good standard. Setting the TTL too low can have an adverse effect on the server.</td>
          </tr>
          <tr>
            <th>Type</th>
            <td>Choose from the dropdown. There are A records, CNAMEs, and TXT records.</td>
          </tr>
          <tr>
            <th>Address</th>
            <td>The server address that the record refers to. It can be set as an IP address, a domain name, or a subdomain. TXT records will be set as text set within quotes.</td>
          </tr>
        </tbody>
      </table><em><br /></em>
    </li>
    <li>Once you have completed entering all information for your record, click on the <strong>Add Record</strong> button just under the data entry fields. <br /></ol><br />
  <br>
  Congratulations! You have just created a DNS record with the Advanced DNS Editor. If necessary, you may edit existing records. Find the record in the list at the bottom of the screen. The left hand side of each row has a <strong>Delete</strong> and <strong>Edit</strong> link for the respective record.</li>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 8: How to use the Advanced DNS Editor in cPanel.</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 7: <a href='/support/edu/cpanel/cpanel-manage-domains/modify-addon-domain-document-root'>Modify an Add-on domain's document root in cPanel</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/cpanel/cpanel-manage-domains/advanced-dns-editor-cpanel&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/cpanel/cpanel-manage-domains/advanced-dns-editor-cpanel'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xMzYmaWQ9MjAzMyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="e82b609f70edbf3b31315726bf109bce" value="1" />	</div>
	</form>
<!-- <br />
          ...
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
			...
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/dns-nameserver-changes/create-new-dns-record?tsrc=rsbraq'>Create a new DNS record</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/email/need-to-setup-mx-txt-records-for-office-365?tsrc=rsbraq'>Need to setup MX &amp; TXT records for Office 365</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/domain-names/my-site-will-not-load-if-i-add-www-to-the-domain?tsrc=rsbraq'>My site will not load if I add &quot;www.&quot; to the domain :(</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/cpanel/do-i-need-split-dns-for-my-domain-setup?tsrc=rsbraq'>Do I need split DNS for my domain setup?</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/cpanel/can-not-create-subdomain?tsrc=rsbraq'>Can not create sub-domain.</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/website/ftp-no-longer-work-on-a-subdomain-in-public-folder?tsrc=rsbraq'>ftp no longer work on a subdomain in public folder</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/dns-nameserver-changes/need-to-create-dns-srv-records?tsrc=rsbraq'>need to create DNS SRV records</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/01a62e0c8418efa8bb3e989c7434fb0d?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/01a62e0c8418efa8bb3e989c7434fb0d'>Charles Sharpe</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-22 8:20 pm</div>
				                <div>This was very helpful, but honestly useless for those looking to make sense of the overall picture. If we make sense and are educated upon 'exactly' how a DNS server works, people will have less trouble trying to figure out how it works &amp; what it is used for. <br />
<br />
At the moment, we are all simply following these awesome tutorials step by step, but in the END, no one really knows what they are DOING. <br />
<br />
We have to understand the context, before we can make use  or sense of what DNS is used for and how it works.<br />
<br />
Overall, awesome tutorial - just not very informative with the context (but that is to save time most likely)</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20947);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						...
						<div><a style='font-size:16px;' href='/support/community-support/users/SharpeTronics'>SharpeTronics</a></div>
						<div><a href='https://twitter.com/csharpego' target='_blank'><img src='//www.inmotionhosting.com/img/icon-twitter.png' style='width:20px;' /></a><a href='https://www.facebook.com/sharpetronics' target='_blank'><img src='//www.inmotionhosting.com/img/icon-facebook.png' style='width:20px;' /></a></div>
						<div></div>
						<div>8 <a href='/support/team/points' target='_blank'>Points</a></div>
						
					</td>
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-22 8:41 pm</div>
				                <div>Setting up the DNS is a IMPORTANT planning step. Esp if you use a re-seller account. My biggest problem is as a web designer, I like flowcharts and diagrams on how the entire process works. It really help me understand the underlying context and how the cogs work so to speak. <br />
<br />
For example, I have purchased a 'Reseller Pkg' from you. I have been working the past two days to get the server setup to transfer my entire workshop / freelancing bus over to InMotion. <br />
<br />
Simply put, when you have your 'custom name server setup'. After we install a new ACCOUNT using WHM, we can login to the cpanel or (clients backend Cpanel)<br />
<br />
**Note: Cpanel Bug** - If you create an account and delete it; we are not capable of using that same username for the clients CPANEL and have to keep coming up with something unique..which can be a daunting task if trying to keep everything simple for the client to use his website. (minor problem nonetheless, but very aggravating)**<br />
<br />
Once the new CPANEL account is created / installed under the root server. The nameservers will automatically update IF the primary name server is already configured.<br />
<br />
For example:  I signed up for www.example.com as my domain &amp; InMotion Hosting as my authoritative Domain and hosting provider. <br />
<br />
Once my account has been setup, I had to go back in and edit the  DNS settings to develop a 'hearty' plan for my future endeavors. Last thing I want is to be changing my name servers with 100's clients underneath me..<br />
<br />
So I followed the tutorials more than once &amp; also have done lots of research upon the web for interest in learning more about the complexities of how a DNS exactly works.<br />
<br />
After the 'primary name server' is set, i go back in to create a new CPANEL account for a new client named: www.example2.com. <br />
<br />
1. The primary nameservers would be: ns1.example.com &amp; ns2.example.com (main hosting re-seller account) and this primary NS would point to my hosting account on InMotion.<br />
<br />
2. The new nameservers for www.example2.com would be ? ns1.example.example2.com &amp; ns2.example.example2.com ?? (All of this is edited in CPANEL DNS Zone Settings for the account that was created?) <br />
<br />
If the above example and methodology is correct, what happens after these are set up? I do know more about how the DNS works now by watching some educational videos, but when I log into FTP server with the ROOT (www.example.com), I do not understand where these files would go for this website without creating a new folder? Normally, after the domain has been added or created, a folder is auto created. (That is how my other domain hosting provider worked anyhow)<br />
<br />
At the moment, my website eventreference.org sends me to a new hosting place, but I have no clue where exactly this hosting place would be at via the root folder / public_html / (primary domain) / <br />
<br />
I have checked through the entire FTP archive / including the hidden files to try and make sense on how this works on InMotion Hosting. If I have to create a new folder in a higher directory(www.example2.com) above (www.example.com); do I need to add a CNAME to ID the folder?<br />
</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20949);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
...
Scott M<br />
						...
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20990);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-27251'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/a434de4ce00fdfac82ab357fee9792f3?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/a434de4ce00fdfac82ab357fee9792f3'>Dan</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-05 11:06 pm</div>
				                <div><p>Here's the problem, after firing your technical writer.</p>
<p>&nbsp;</p>
<p>"Step 4. Go to the <strong>Add A Record</strong> section and fill out the fields for your desired record."</p>
<p>&nbsp;</p>
<p>What is a "record", how do I find my "record" or know what it is?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27251);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-06 11:11 pm</div>
				                <div>Hello Dan,<br />
<br />
Technically the A Record is referring to the name and address fields. I know DNS can be confusing at times but we would like to help any time we can.<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27278);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-31949'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/98b5de287a87fefae9ba74d3a4cca08b?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/98b5de287a87fefae9ba74d3a4cca08b'>Tom Minkler</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-15 4:34 am</div>
				                <div><p>My questions are:</p>


Name
Name your record. Be sure that it ends with your domain name and a period. Ex:<em style="padding: 0px 3px 0px 0px;">record.inmotiontesting.com.Q: &nbsp;If it has to start with "record." please say so. Do i use the current domain or the new one i'm trying to add? I assume the latter?</em>

TTL

<p>Time To Live. The record will exist on DNS servers around the world for this fixed amount of time. After it expires, they will need to recontact the server to reset the record. This is set in seconds, so 14400 is 4 hours, which is a good standard. Setting the TTL too low can have an adverse effect on the server.</p>
<p>Q: First i thought this had to do with how long it takes to add the new domain, but it sounds like this is forever, how long from now on the DNS servers of the world wait from now on to recheck? If it won't change much, couldn't this be a day or two?</p>
<p>&nbsp;</p>


Type

<p>Choose from the dropdown. There are A records, CNAMEs, and TXT records.</p>
<p>Q: What is the difference and why would i choose each one? Since i got here from instructions telling me to add an A record i'll just choose that, but a very short explanation might help? I was like "what are these other ones then?"</p>


Address

<p>The server address that the record refers to. It can be set as an IP address, a domain name, or a subdomain. TXT records will be set as text set within quotes.</p>
<p>Q: What address DOES the record refer to? &nbsp;You tell me! Is this the IP of one of your nameservers? Sorry i'm sure it's obvious i don't know much! i guess that's why this is the "Advanced" editor, but the simple one was just as baffling!&nbsp;Showing my ignorance but thanks for your help.</p>



</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31949);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-15 12:16 pm</div>
				                <div>Hello Tom,<br />
<br />
...
Best Regards.<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31981);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
	...
	<div name='fixComments' id='fixComments' style='width:220px; margin:0px; float:right;'>
		<div class='moduletable'>
			<h3><span class='comment-count'>8</span> Questions & <span class='comment-text'>Comments</span></h3>
