<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:61268:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/ghost/migrating-your-wordpress-site-content-to-ghost" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-02-03T20:51:27-08:00" />
  <meta name="author" content="Jeff Matson" />
  <meta name="description" content="In this article, we will teach you how to migrate your content from a Wordpress site into the new Ghost CMS." />
  <title>Migrating your Wordpress site content to Ghost - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/ghost/migrating-your-wordpress-site-content-to-ghost" rel="canonical" />
...
<script>
  ...
  ga('send', 'pageview');
	...
	<!-- cid:548b1acc0236f946ea553bdbd95d551a -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Migrating your Wordpress site content to Ghost									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>4,317</span></div>
							...
							<div style='clear:both;'></div>
								...
								<p>Partially due to the founder of Ghost being a prior Wordpress developer, it has been made quite simple to import your Wordpress content into Ghost.  Thankfully, a plugin has been developed to import your Wordpress post content into Ghost.  Within minutes, all of your Wordpress posts will be imported into your <a href="http://www.inmotionhosting.com/support/website/ghost/how-to-install-the-ghost-blogging-platform">new Ghost installation</a>.</p>
<h2>Exporting your Wordpress posts</h2>
...
<li><p>Any files that are not images will not be able to be imported.  This includes things such as PDF files.  Of course, you could always add those in afterwards.</p></li>
<li><p>Any linked content using shortcodes would not be imported.</p></li>
<li><p>As Ghost does not natively deal with comments, none of the comment data will be imported from Wordpress.</p></li>
<li><p>custom post types or pages are currently not exported by the tool.</p></li>
</ul>
<h3>Installing the Wordpress plugin to export Wordpress post data to Ghost</h3>
<ol class='article_list'>
<li>
    <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/ghost/export-wordpress-to-ghost-1.png"><img src="//cdn.inmotionhosting.com/support/images/stories/ghost/export-wordpress-to-ghost-1.png"  style='float:right; margin:0px 0px 15px 15px;'></a><p>First, you will need to locate the Ghost plugin for Wordpress.  This can be done quite simply as the Ghost plugin is available within the Wordpress plugin database.  To do so, click on Plugins on the left side of your Wordpress dashboard, then on Add New.  From here, search for the word "Ghost".  The first result should be the one that you are looking for.</p>
</li>
<li style='clear:both;'>
    <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/ghost/export-wordpress-to-ghost-2.png"><img src="//cdn.inmotionhosting.com/support/images/stories/ghost/export-wordpress-to-ghost-2.png"  style='float:right; margin:0px 0px 15px 15px;'></a><p>Once you have located the Ghost plugin, click on "Install Now".  Wordpress will then begin your installation.  When the plugin installation has completed successfully, click "Activate Plugin".  Now that the Ghost plugin is installed and activated, you're now ready to begin exporting your data from Wordpress.</p>
</li>
</ol>
<h3>Exporting your content from Wordpress</h3>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/ghost/export-wordpress-to-ghost-3.png"><img src="//cdn.inmotionhosting.com/support/images/stories/ghost/export-wordpress-to-ghost-3.png"  style='float:right; margin:0px 0px 15px 15px;'></a><p>Now that the Ghost plugin is fully installed and activated, you should now see an option for "Export to Ghost" within your Tools section of the Wordpress dashboard.  Once you're on that page, you should see a button that says "Download Ghost File".  If you click on that, You will be prompted to download a file.  This is the file that will be used to import your posts so be sure to keep it in a safe place.</p>
<div style='clear:both;'></div>
<h2>Importing your Wordpress data into Ghost</h2>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/ghost/export-wordpress-to-ghost-4.png"><img src="//cdn.inmotionhosting.com/support/images/stories/ghost/export-wordpress-to-ghost-4.png"  style='float:right; margin:0px 0px 15px 15px;'></a><p>Now that you have your export file from Wordpress, you will just need to import it into your Ghost site via this very simple process.  To do so, visit your the Ghost debug tools page at http://yourdomainhere.com/ghost/debug.  Once you're on that page, you will see a box that says "Import" and a button to browse for a file.  Click on the Browse button and locate the file that you previously exported from Wordpress, the click Import.  You may be logged out of your Ghost dashboard after doing so.  Simply log back in if you need to.</p>
<div style='clear:both;'></div>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/ghost/export-wordpress-to-ghost-5.png"><img src="//cdn.inmotionhosting.com/support/images/stories/ghost/export-wordpress-to-ghost-5.png"  style='float:right; margin:0px 0px 15px 15px;'></a><p>Within Ghost, you should now see all of your posts that you previously made on your Wordpress site.  Be sure to look at all of them to ensure that everything moved over alright.  If you had any kind of custom content, you may need to edit that as well.  Even requiring a few edits, this method definitely saves a lot of time when migrating your Wordpress site to Ghost.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/ghost/migrating-your-wordpress-site-content-to-ghost&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/ghost/migrating-your-wordpress-site-content-to-ghost'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NjkmaWQ9Mjg5NSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="bd7ff8556ea8d27774a40eb1bd031975" value="1" />	</div>
	</form>
<!-- <br />
