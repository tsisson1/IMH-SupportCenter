<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:64487:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/file-management/how-to-upload-a-file-using-file-manager-in-cpanel" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-04-21T23:27:20-07:00" />
  <meta name="keywords" content="file manager upload file cpanel" />
  <meta name="author" content="Tim Sisson" />
  <meta name="description" content="In this tutorial, we'll show you how to use File Manager in cPanel to upload a file from your local computer to your hosting account. " />
  <title>How to upload a file using File Manager in cPanel - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/file-management/how-to-upload-a-file-using-file-manager-in-cpanel" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:611ad6baeb1077ccff4fea6d3c035459 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '197.228.32.87']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to upload a file using File Manager in cPanel</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to upload a file using File Manager in cPanel									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>34,883</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Dec 7, 2011'><span style='color:#606060;'>Published:</span> Apr 21, 2016</div>
...
<p>Sometimes it's necessary to upload files to your cPanel account. This can be easily accomplished by using the File Manager within your cPanel account. If you are unfamiliar with File Manager in cPanel, please see our article on <a href="/support/edu/cpanel/cpanel-file-manager/using-file-manager-in-cpanel">Using File Manager in cPanel</a>.&nbsp;</p>
<p>In this example, we're going to upload a test.html file to the public_html folder in File Manager. So when you visit the file through a web browser, you'd go to example.com/test.html. If you wanted to place the file in a subfolder called test, then to visit the file in a browser you'd go to example.com/test/test.html</p>
<ol class="article_list">
	<li><a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">Log into cPanel</a>.</li>
	<li>On the home screen under the files section choose "<strong>File Manager</strong>".</li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/filemgr/file_mgr_1.jpg"><img src="//cdn.inmotionhosting.com/support/images/stories/filemgr/file_mgr_1.jpg" alt="file_mgr_1"  /></a>
	<li>&nbsp;Next, choose where you'd like to start in. For this example, we're going to use the Web Root option - which is the public_html folder. Since we're uploading to the public_html &nbsp;folder we do not need to navigate anywhere else.</li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/filemgr/file_mgr_2.jpg"><img src="//cdn.inmotionhosting.com/support/images/stories/filemgr/file_mgr_2.jpg" alt="file_mgr_2"  /></a>
	<li>Select "<strong>Upload</strong>" from the icons at the top.</li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/filemgr/file_mgr_3.jpg"><img src="//cdn.inmotionhosting.com/support/images/stories/filemgr/file_mgr_3.jpg" alt="file_mgr_3"  /></a>
	<li>Navigate to the file you want to upload on your local computer by selecting the "<strong>Choose File</strong>" button.</li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/filemgr/file_mgr_4.jpg"><img src="//cdn.inmotionhosting.com/support/images/stories/filemgr/file_mgr_4.jpg" alt="file_mgr_4"  /></a>
	<li>Select the file and click "<strong>Open</strong>". Once the file is finished uploading you can click on the link in the cetner of the screen to retrun to the folder you uploaded the file to.</li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/filemgr/file_mgr_5.jpg"><img src="//cdn.inmotionhosting.com/support/images/stories/filemgr/file_mgr_5.jpg" alt="file_mgr_5"  /></a>
	<li>Now, in a web browser, we can visit the file and verify it uploaded to the location correctly.&nbsp;</li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/filemgr/file_mgr_6.jpg"><img src="//cdn.inmotionhosting.com/support/images/stories/filemgr/file_mgr_6.jpg" alt="file_mgr_6"  /></a>
</ol>
<ol></ol>
<ol>If you need further assistance please feel free to<a href="/support/website/website-troubleshooting/how-to-get-great-technical-support"> contact our support department</a>.&nbsp;</ol>
<p>Also, read more about all of cPanel's email features <a href="http://www.inmotionhosting.com/cpanel-hosting/cpanel-file-management-feature.html">here</a>.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/file-management/how-to-upload-a-file-using-file-manager-in-cpanel&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/file-management/how-to-upload-a-file-using-file-manager-in-cpanel'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yMyZpZD0zMjcmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/972c727675890b87d3478761b4b03d53?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/972c727675890b87d3478761b4b03d53'>Sanket Naik</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-02-04 12:01 pm</div>
				                <div><p>thank you bro</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30336);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
