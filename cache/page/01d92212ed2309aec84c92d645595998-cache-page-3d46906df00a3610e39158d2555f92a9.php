<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:108420:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-3/create-template/starting-template" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-03-21T16:34:11-07:00" />
  ...
  <link href="http://www.inmotionhosting.com/support/edu/joomla-3/create-template/starting-template" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:aa7586caea9d5d1aafc044bb50967675 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '78.156.128.38']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															A very basic template soon to be a Joomla 3.1 template									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>95,847</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Oct 4, 2012'><span style='color:#606060;'>Published:</span> Mar 21, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Welcome to our tutorial series on <a href="/support/edu/joomla-3/create-template">creating a basic Joomla 3.0 template</a>! Over the next few articles, we plan to show you how to build from scratch a fully functional, responsive Joomla 3.0 template.</p>
...
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/create-template/screenshot-of-starting-template.jpg"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="screenshot-of-starting-template" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/create-template/screenshot-of-starting-template.jpg" /></a>So first things first, you can see to the right what our starting template looks like. As we said, it's not much, but keep reading and watch as we transform this into a Joomla 3.0 template!</p>
<div style="clear: both;">&nbsp;</div>
<p>&nbsp;</p>
<h2>The files that make up our template</h2>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/create-template/basic-template-directory-tree.jpg"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="basic-template-directory-tree" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/create-template/basic-template-directory-tree.jpg" /></a>The following files make up our template:</p>
<pre class="code_block">|-- <a href="#index">index.php</a>
|css
|   |-- <a href="#style">style.css</a>
|js
|   |-- main.js
|images
|   |-- blank_image.jpg
...
<p>&nbsp;</p>
<h3>index.php</h3>
<p>The first file we'll look at is our index file, index.php. It makes a call to 2 other files, a css file and a javascript file. It is very basic now, but in our next tutorial we will <a href="/support/edu/joomla-3/create-template/add-module-positions">add module positions to it using jdoc:include</a>.</p>
<pre class="code_block" style="max-height: 300px;">&lt;!DOCTYPE html&gt;
&lt;html&gt;
&lt;head&gt;
...
<pre class="code_block" style="max-height: 300px;">.main_container {
    width:940px;
    margin-left:auto;
    margin-right:auto;
}
...
<p>We don't have any images in our template at this time, but as you read in the javascript portion above, we will probably have images in the future. Therefore, we created a folder named images and simply created a blank file named blank_image.jpg in it.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 1: A very basic template soon to be a Joomla 3.1 template</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 2: <a href='/support/edu/joomla-3/create-template/add-module-positions'>How to add module positions to a Joomla 3.1 template</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-3/create-template/starting-template&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-3/create-template/starting-template'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNzEmaWQ9MTgzMyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="4db25ca8a34cac2028a90b268c278d68" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-03-20 12:52 pm</div>
				                <div>thanks for this - and the following - tutorial. Just one comment here: I miss the templatesDetail.xml file which I think we need to create the very basic template. I added a templateDetails.xml (with no positions) and the template works! Not great - it doesn't actually create a layout - but the text does show. Here is what it looks like in  Joomla 3.0 site:<br />
Header<br />
Main Content Area<br />
Right SideBar<br />
Footer</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(7594);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-03-20 1:00 pm</div>
				                <div>Hi ClubAero,<br />
<br />
So, it sounds like because you didn't setup a &lt;a href='http://www.inmotionhosting.com/support/edu/joomla-3/create-template/template-details-xml'&gt;templateDetails.xml&lt;/a&gt; file, all the content is simply shown in the browser without actually being contained in any div's or other containers?<br />
<br />
Did you have any questions on how to get this setup?<br />
<br />
Thanks,<br />
- Brad</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(7595);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-03-20 2:13 pm</div>
				                <div>Hallo Brad<br />
That's right! I just copied the index.php, style.css and the empty main.js and the empty blank_image.jph into the directory structure you showed. I then added the templateDetails.xml and zipped the directories. I then installed the template in a joomla 3.0 site.<br />
I assume that as I progress with your tutorial I can see how the template starts to develop but I started like this since I couldn't understand how the screenshot layout you showed at the beginning with the title 'what our template originally looked like' could be made with the code you gave in the 1st tutorial.....</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(7596);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-03-20 6:12 pm</div>
				                <div>Ah yes - I should have looked more carefully, but the index.php code in this tutorial doesn't have any Jdoc:include statements, so I assume the template will not be able to position the text at all, irrespective of whether the positions are included in the templateDetails or not!</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(7597);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-03-21 12:38 pm</div>
				                <div>Sorry about that! I just updated this article and included a brief mention about the &lt;a href='http://www.inmotionhosting.com/support/edu/joomla-3/create-template/add-module-positions'&gt;Jdoc:include&lt;/a&gt; statements above the index.php sample code.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(7598);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-03-21 2:40 pm</div>
				                <div>Thanks for your help. I have now modified the index.php and the very basic template now shows something similar to your screen shot (I also added a grey border to the main_container in the CSS)<br />
&lt;?php<br />
<br />
...
$doc-&gt;addStyleSheet($this-&gt;baseurl . '/media/jui/css/bootstrap-responsive.css');<br />
$doc-&gt;addStyleSheet('templates/' . $this-&gt;template . '/css/style.css');<br />
$doc-&gt;addScript('/templates/' . $this-&gt;template . '/js/main.js', 'text/javascript');<br />
<br />
?&gt;<br />
&lt;!DOCTYPE html&gt;<br />
&lt;html&gt;<br />
...
<br />
        &lt;!-- mid container - includes main content area and right sidebar --&gt;<br />
        &lt;div class='mid_container'&gt;<br />
<br />
            &lt;!-- main content area --&gt;<br />
            &lt;div class='main_content_area'&gt;<br />
                &lt;jdoc:include type=&quot;modules&quot; name=&quot;position-3&quot; style=&quot;xhtml&quot; /&gt;<br />
                &lt;jdoc:include type=&quot;message&quot; /&gt;<br />
                &lt;jdoc:include type=&quot;component&quot; /&gt;<br />
                &lt;jdoc:include type=&quot;modules&quot; name=&quot;position-2&quot; style=&quot;none&quot; /&gt;<br />
            &lt;/div&gt;<br />
<br />
            &lt;!-- right sidebar --&gt;<br />
            &lt;div class='right_sidebar'&gt;<br />
                &lt;jdoc:include type=&quot;modules&quot; name=&quot;position-7&quot; style=&quot;well&quot; /&gt;<br />
            &lt;/div&gt;<br />
<br />
...
<br />
&lt;/html&gt;</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(7599);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-7851'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//graph.facebook.com/knigus.tauzen/picture?type=normal' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='/support/community-support/users/Knigus'>Knigus</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-05-13 9:29 am</div>
				                <div>Hi There,<br />
<br />
I'm not sure how the templateDetails.xml should look like, my one doesn't work, see below:<br />
?xml version=&quot;1.0&quot; encoding=&quot;utf-8&quot;?&gt;<br />
&lt;extension version=&quot;3.03&quot; type=&quot;template&quot;&gt;<br />
        &lt;name&gt;ladtraveltemp&lt;/name&gt;<br />
        &lt;creationDate&gt;2013-05-01&lt;/creationDate&gt;<br />
        &lt;author&gt;&lt;/author&gt;<br />
        &lt;authorEmail&gt;&lt;/authorEmail&gt;<br />
        &lt;authorUrl&gt;http://www.example.com&lt;/authorUrl&gt;<br />
        &lt;copyright&gt;Grzegorz Ksiazek 2013&lt;/copyright&gt;<br />
        &lt;license&gt;GNU/GPL&lt;/license&gt;<br />
        &lt;version&gt;1.0.2&lt;/version&gt;<br />
        &lt;description&gt;ladtraveltemp&lt;/description&gt;<br />
        &lt;files&gt;<br />
        ...
        &lt;/files&gt;<br />
        &lt;positions&gt;<br />
                &lt;position&gt;maincontainer&lt;/position&gt;<br />
                &lt;position&gt;mid_container&lt;/position&gt;<br />
                &lt;position&gt;right_sidebar&lt;/position&gt;<br />
                &lt;position&gt;footer&lt;/position&gt;<br />
        &lt;/positions&gt;<br />
&lt;/extension&gt;</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(7851);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-11-29 7:44 am</div>
				                <div>style=&quot;none&quot; and style=&quot;xhtml&quot; - what's the difference?</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8432);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-11-29 5:13 pm</div>
				                <div>&lt;div style=&quot;background-color: #FFF; padding-left: 10px;&quot;&gt;Hello jleito, and thanks for the comment.<br />
<br />
The &lt;strong&gt;none&lt;/strong&gt; or &lt;strong&gt;xhtml&lt;/strong&gt; applied to the &lt;strong&gt;&amp;lt;style&amp;gt;&lt;/strong&gt; tag are what Joomla calls &lt;a href=&quot;http://docs.joomla.org/What_is_module_chrome%3F&quot; target=&quot;_blank&quot;&gt;module chrome&lt;/a&gt;, which allows you to adjust the way a module is displayed.<br />
<br />
On that page you can see how it changes the appearance of a module based on which module chrome you've decided to use.<br />
<br />
Please let us know if you had any other questions!<br />
<br />
- Jacob&lt;/div&gt;</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8440);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-8625'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/aab9a6434cc3577a7f29765544895174?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/aab9a6434cc3577a7f29765544895174'>panos</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-02-26 3:57 pm</div>
				                <div><p>is this tutorial is useful for the joomla 2.5 ???</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8625);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-02-26 4:57 pm</div>
				                <div>&lt;div style=&quot;background-color: #FFF; padding-left: 10px;&quot;&gt;Hello panos,<br />
<br />
This tutorial should still apply to the basic concepts of creating a Joomla 2.5 template. However keep in mind that Bootstrap and jQuery were added in Joomla 3.0. So if you're downloading a 3.0 template and not creating one from scratch it might not function properly.<br />
<br />
Please let us know if you had any further questions.<br />
<br />
- Jacob&lt;/div&gt;</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8627);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						...
						<div><a style='font-size:16px;' href='//www.gravatar.com/85b445f2c587b02976da5782b5b3ef2b'>Greg</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-29 3:21 pm</div>
				                <div><p>The "original" php file shows calls to the css and js files in a folder called "support" but there is no "support" folder in the folder structure.</p>
<p>So I correct the links. Still, when I copy and paste the code from this tutorial into a file called index.php no browser will open the file. When I change the index.php to index.html then I can see the preview as you show it at the top of the article and browsers will open it. The rest of the tutorial seems easy enough, but this page is confusing for non-coders anbd newbies.</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9294);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-05 3:32 pm</div>
				                <div><p>it took a while till i figured, but you should replace your css link with these - as the one on display does not work not just because you used a support folder, but because of the / in front of the src and href</p>
<p>&lt;head&gt;&nbsp;&nbsp;&nbsp; &lt;link rel="stylesheet" href="/support/css/style.css" type="text/css" /&gt;&nbsp;&nbsp;&nbsp; &lt;script src="/support/js/main.js" type="text/javascript"&gt;&lt;/script&gt;&lt;/head&gt;</p>
<p>hope it helps :)</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9435);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-06 9:34 pm</div>
				                <div>Hello Suzie,<br />
<br />
Thank you for your input. We will make any changes necessary.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9446);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-14409'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/0866a148b2482b311e38e4c0dd4a270f?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/0866a148b2482b311e38e4c0dd4a270f'>jeff</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-27 10:20 pm</div>
				                <div>very easy! thankÂ´s </div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14409);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-16524'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/727ce9df5f3842100c09c32e2f70f815?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/727ce9df5f3842100c09c32e2f70f815'>Luis</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-21 3:20 am</div>
				                <div>Imposible to improve. </div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16524);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-18040'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/191a510b00859871224ff906cab1e25e?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/191a510b00859871224ff906cab1e25e'>MIKO ..</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-01 11:20 pm</div>
...
* Finally,  this is one thing NO sites have- a marker at the top with this week's date saying &quot;This data is current for the latest Joomla 3 as of&quot; an put in a date.  I just wasted time at a site, and then also with several Youtube tutorials, where I started to learn OLD information.  But you guys  99% awesome.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(18040);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-20188'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/ac9258e9fd5da652b7980a72d7acf9c0?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/ac9258e9fd5da652b7980a72d7acf9c0'>Eric</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-31 6:12 am</div>
				                <div><p>Great Tutorial. Thanks for share.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20188);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-20515'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/01a38fb414b918f24b3376ba19c6a481?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/01a38fb414b918f24b3376ba19c6a481'>Dany</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-09 11:35 am</div>
				                <div><p>In the index.php link to css and js files are not correct.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20515);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-09 12:10 pm</div>
				                <div>Hello Dany,<br />
<br />
Thanks for the comment.  We're not sure what you are referring to, though.  If you require assistance,can you please specify a URL for your website, or indicate where your comment applies?  Please provide us a little more information and we would be happy to help.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20524);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-21530'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/b60f1f9c875e01f43c801fcfaf96a059?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/b60f1f9c875e01f43c801fcfaf96a059'>Irfan</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-10 9:02 am</div>
				                <div><p>Firstly thank you very much for putting this tutorial up here... its a great way to understand the basics.</p>
<p>I would like to point out that the link to the CSS stylesheet is wrong in the sample index.php code ... According to the folder structure&nbsp;you have provided it&nbsp;should be</p>
<pre class="code_block" style="padding: 2px; font-family: 'Courier New', Courier, monospace; font-size: 12px; border-radius: 4px; margin-top: 15px; margin-bottom: 15px; line-height: 18px; word-break: break-all; word-wrap: break-word; border: 1px solid rgb(105, 105, 105); max-width: 670px; overflow: auto; max-height: 300px; background: rgb(242, 242, 242);">&lt;link rel="stylesheet" href="/support/css/style.css" type="text/css" /&gt;</pre></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21530);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
