<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:85871:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-25/getting-started/how-to-install-joomla-25" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-05-02T16:33:39-07:00" />
  <meta name="keywords" content="install joomla 2.5" />
  ...
  <link href="http://www.inmotionhosting.com/support/edu/joomla-25/getting-started/how-to-install-joomla-25" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:395e45fd54f7e461a1fd2dfb9f2c13fb -->
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>19,923</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Feb 8, 2012'><span style='color:#606060;'>Published:</span> May 2, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<p class="alert">Joomla 2.5 has reached its end of life as for 12/31/2014. Please be advised this may be a security risk to your website. You can view more information about the end of life <a href="https://docs.joomla.org/Joomla!_CMS_versions">here</a>.</p><p>Joomla 2.5 is a Content Management System (CMS) that you can install on your <a href="http://www.inmotionhosting.com/joomla-hosting.html">hosting account</a> to help manage a website. Joomla has been downloaded millions of times and is used by countless webmasters. Its ease of use makes it simple for setting up basic websites, and its scalability makes it great for complex websites getting lots of traffic.</p>
<p>This tutorial, <strong>installing Joomla 2.5</strong>, is the first tutorial in our <a href="/support/edu/joomla-25/getting-started">getting started with Joomla 2.5</a> tutorial series.</p>
<p><strong>An overview of installing Joomla 2.5:</strong></p>
<ul>
<li><a href="#installation-requirements">Installation Requirements</a></li>
<li><a href="#installation-methods">Installation Methods</a></li>
<li><a href="#installation-steps">Installation Steps</a></li>
<li><a href="#after-installation">After Installing Joomla 2.5</a></li>
</ul>
...
<tbody>
<tr>
<th>Program</th> <th>Minimum Version</th> <th>Recommended Version</th> <th>Additional Details</th>
</tr>
<tr>
<th>PHP</th>
<td>5.2.4</td>
<td>5.3+</td>
<td>PHP is a scripting language, and is the language Joomla is written in. Your server MUST offer PHP.<br /></td>
</tr>
<tr>
<th>MySQL</th>
<td>5.0.4+</td>
<td>5.0.4+</td>
<td>MySQL is a database system (technically a RDBMS). Joomla stores most of its information within a MySQL database.<br /></td>
</tr>
<tr>
<th> Apache </th>
<td>2.*</td>
<td>2.*</td>
<td>Apache is a web server. Most hosting providers use Linux servers, and Apache is one of the most widely used web servers in Linux environments.<br /></td>
</tr>
<tr>
<th> Microsoft IIS </th>
<td>7</td>
<td>7</td>
<td>Apache can also be ran on a Windows server. If you can't use Apache, you can use Microsoft's webserver, Microsoft IIS.<br /></td>
</tr>
</tbody>
</table>
...
<p>When installing Joomla, you can either manually install the software, or you can use a one-click installation tool - like <a href="http://www.inmotionhosting.com/support/edu/cpanel/softaculous" target="_blank">Softaculous</a>.</p>
<table class="article_table">
<tbody>
<tr>
<th width="50%">Manually Installing Joomla 2.5</th> <th width="50%">Joomla 2.5 one-click Installations</th>
</tr>
<tr>
...
<li>As Joomla requires a database, the first step is to <strong>setup a database</strong>. Not only is a database required, but we will need to setup a database user as well. Using the MySQL Database Wizard in your cPanel will guide you through setting up a database and a database user. For more help with setting up a database using the MySQL Database Wizard, please see <a href="/support/website/cpanel/how-do-i-create-a-mysql-database-in-my-control-panel-cpanel">How do I create a MySQL database in cPanel?</a><br /><br />In our example, we used the MySQL Database Wizard and created the following:<br /> 
...
<li>Now that you have download joomla, <a href="/support/website/file-management/how-to-upload-a-file-using-file-manager-in-cpanel">upload the ZIP file using cPanel</a> ( Joomla_2.5.1-Stable-Full_Package.zip in our example ) to the root of where you want Joomla installed. For example, if you are installing Joomla on your main domain, upload the zip file to your public_html directory.</li>
<li>When you have uploaded the Joomla ZIP file, <a href="/support/website/cpanel/compressing-uncompressing-files">use cPanel to extract the zip file</a>.</li>
...
<li>On the <strong>"Choose language" page</strong>, select your language from the list and then click "Next".<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/install-joomla25/joomla-installation-choose-language.gif"><img  alt="joomla-installation-choose-language" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/install-joomla25/joomla-installation-choose-language.gif" /></a></li>
...
<li>You should now be on the <strong>"Database Configuration" page</strong>. Please refer to the table below for more information on what you should enter. After filling out the details, click "Next".<br /><br /> 
<table class="article_table" border="0">
<tbody>
<tr>
<th>Database Type:</th>
...
<li>On the <strong>"Main Configuration" page</strong>, use the table below to help you fill out the form, and then click "Next".<br /><br /> 
<table class="article_table" border="0">
<tbody>
<tr>
<th>Site Name:</th>
...
<p>Whether it's creating new content for your site or installing extensions, you'll be doing most administrative tasks within your Joomla Admin Dashboard. Now that you have installed Joomla, your next step is to learn how to <a href="/support/edu/joomla-25/getting-started/how-to-log-into-dashboard">log into your administrative dashboard</a>.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 1: How to install Joomla 2.5</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 2: <a href='/support/edu/joomla-25/getting-started/how-to-log-into-dashboard'>How to log into your Joomla 2.5 Dashboard</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-25/getting-started/how-to-install-joomla-25&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-25/getting-started/how-to-install-joomla-25'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xODImaWQ9MTEzOCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="fdacc636c531217310b9fcef1a305e30" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						...
						<div><a style='font-size:16px;' href='/support/community-support/users/samiam'>samiam</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2012-04-22 3:53 pm</div>
				                <div>According to Joomla 2.5 tech requirements, it needs a minimum of version 5.2.4 PHP to run Joomla 2.5. According to my cPanel stats on my site the PHP version being used is 5.2.17. Will this cause a problem with installing and using Joomla 2.5?<br />
<br />
Sam Elmore</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(6500);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-04-08 5:44 pm</div>
				                <div>Hello Sam, and thanks for your question.<br />
<br />
Joomla 2.5 should run perfectly fine on your server. The version of PHP that your server has is 5.2.&lt;strong&gt;17&lt;/strong&gt;, which is &lt;strong&gt;13&lt;/strong&gt; revisions newer than the minimum requirement of 5.2.&lt;strong&gt;4&lt;/strong&gt;.<br />
<br />
Please let us know if you have any further questions at all.<br />
<br />
- Jacob</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(7629);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-17900'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//graph.facebook.com/eric.traversy.3/picture?type=normal' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='/support/community-support/users/metauxpro'>metauxpro</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-27 11:30 am</div>
				                <div>C est trop complique pour moi ca  !  <br />
J download ou ma creation de site  ! <br />
<br />
Translated by Google: <br />
C is too complicated for me that!<br />
J or download my creation site!</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17900);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-28 12:27 pm</div>
				                <div>Hello metauxpro,<br />
<br />
Thank you for contacting us. I'm not exactly sure what you are asking, since we only provide support in English.<br />
<br />
But, if you are having trouble installing Joomla, I recommend <a href="http://www.inmotionhosting.com/support/edu/cpanel/softaculous/how-to-instal">using Softaculous</a>. It really simplifies the Joomla installation process.<br />
<br />
If you have any further questions, feel free to post them below.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17926);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-19282'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/a5c93784040ad9d3aeb2102578827748?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/a5c93784040ad9d3aeb2102578827748'>Alexandre</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-07 7:44 pm</div>
				                <div><p>Hi,</p>
<p>&nbsp;</p>
<p>I'm looking for free web hosting hat offers PHP that can allow me to host Joomla 3.X versions. Currently I run Joomla 2.5 on PHP 5.2 something, but I need a free website running Joomla 3.X..Can you give me some advice please?</p>
<p>&nbsp;</p>
<p>Regards</p>
<p>Alexandre</p>
<p>From France</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19282);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-07 9:05 pm</div>
				                <div>Hello Alexandre,<br />
<br />
InMotion Hosting is not a free web hosting service, though we do support Joomla.  Use your favorite search engine and I'm sure you'll find a free hosting service that might meet your needs.<br />
<br />
Kindest regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19286);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-21400'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/6fcdabbac727a09f9685f5d95367bcf9?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/6fcdabbac727a09f9685f5d95367bcf9'>george s mushi</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-07 5:47 am</div>
				                <div><p>hi, i would like to say thank you for the explanation but my problem is tha,i have follow the steps above but still it is not proceed when it reach the database configuaration steps.it take too much time to load with no successfullly.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21400);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-10 7:34 am</div>
				                <div>Hello George,<br />
<br />
Does it give any particular error message? Are you able to access the database separately via a tool such as <a href="http://www.inmotionhosting.com/support/website/database-connections/connecting-heidi-sql-database">HeidiSQL</a> (be sure to <a href='http://www.inmotionhosting.com/support/website/databases/setting-up-a-remote-mysql-connection-in-cpanel">add your IP for remote connection</a>.) <br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21517);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-22420'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/9408d52455eb898a60b28096cc68b3f5?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/9408d52455eb898a60b28096cc68b3f5'>Nick Delonas</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-07 12:36 pm</div>
				                <div><p>Inmotion already hosts several web sites for me, which are all currently FrontPage. &nbsp;I would like to switch to Joomla, I think. &nbsp;Is setting up Joomla on my Windows computer for development and testing, then uploading to Inmotion to replace the current FrontPage versions easily done? &nbsp;I guess I would start with the simplest site and gradually convert them all. &nbsp;Some will take quite a while to convert I would guess. &nbsp;I don't need a lot of power, but I think Joomla might fit my long-term needs better than WordPress.</p>
<p>&nbsp;</p>
<p>Thanks in advance for any advice you can provide. &nbsp;My domain, btw, is cultv.com.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22420);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-07 12:56 pm</div>
				                <div>Hello Nick,<br />
<br />
You would need to set up a WAMP (Windows/Apache/MySQL/PhpMyAdmin) server setup on your local machine in order to install Joomla and create the site on your machine. But after you create it you can simply upload the files and database export file via FTP.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22422);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
