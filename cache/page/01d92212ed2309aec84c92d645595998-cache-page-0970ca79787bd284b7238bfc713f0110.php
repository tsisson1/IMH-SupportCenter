<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:54684:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/general-server-setup/how-do-i-change-php-version-in-shell" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="I found what I believe is a better solution. First, SSH into the server and run the following command: &quot;whereis php&quot;. This will give you a list of all P..." />
  <title>How do I change PHP version in shell? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/general-server-setup/how-do-i-change-php-version-in-shell" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:23da2af0a73672669ab7fbc1bc0038a4 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '82.115.105.34']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>How do I change PHP version in shell?</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-07-13 2:57 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>439</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I have setup my account to use PHP v5.6 through cPanel. I then used phpinfo() to verify that I am using 5.6. However, when I login via SSH (command line/shell) and type &quot;php -v&quot;, it shows I'm using PHP v5.4. I need to run some PHP through command line, but I need these commands to use 5.6, not 5.4. How do I update the shell to use 5.6?</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_7638' id='upvote_answer_7638' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='7638' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_7638').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_7638' id='downvote_answer_7638' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='7638' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_7638').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
Thank you for your question on php version via SSH. The phpinfo page uses the php version in your account or at the folder level you are checking.<br />
<br />
The SSH looks to the server default php version, that is why the versions are different.<br />
<br />
You can set the specific php.ini you want to use (thus changing the version) within the command line using <a href="/support/www.inmotionhosting.com/support/website/php/command-line-settings">these instructions</a>.<br />
<br />
Kindest Regards,<br />
Scott M<br />
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_7638').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_7638' id='form_comment_on_answer_7638' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
...
<div class=' straight_bottom not_best_answer'>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px; width:50px;' valign='top'>
<div class='vote_div'>
	<form method='post' name='upvote_answer_7650' id='upvote_answer_7650' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='7650' />
		<input type='hidden' name='component' id='component' value='qa' />
		<input type='hidden' name='vote_value' id='vote_value' value='1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_7650').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_7650' id='downvote_answer_7650' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='7650' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_7650').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					<img src='/support/images/avatars/default_avatar.jpg' class='user_avatar' style='max-width:60px;' /><br />
                		        <a href='/support/community-support/users/nvillescas'>nvillescas</a>
					
					<div>10 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2015-07-14 6:26 pm EST
                		        </div>
					
		                </div>

				I found what I believe is a better solution. First, SSH into the server and run the following command: &quot;whereis php&quot;. This will give you a list of all PHP versions installed. Find the one you want (i.e. /opt/php56/bin/php).<br />
<br />
Next, find and open the file in your home directory called &quot;.bashrc&quot;. Add the following line to the end of the document (without quotes): &quot;alias php=/opt/php56/bin/php&quot; (change the PHP path if you want a different version)<br />
<br />
Save the file. SSH back into your server and any &quot;php&quot; commands you use will now use the version specified in the bashrc file. Run &quot;php -v&quot; to verify.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_7650').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_7650' id='form_comment_on_answer_7650' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
					                <p>You must <a href='/support/login'>login</a> before you can post a comment about this answer.</p>
					        </div></div></div></div>
					</form>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello Nvillescas,<br />
<br />
I am glad that you found a solution, did you have any further questions regarding this issue?<br />
<br />
Best Regards,<br />
TJ Edens</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/general-server-setup/how-do-i-change-php-version-in-shell&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/general-server-setup/how-do-i-change-php-version-in-shell'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="cbb717d26810856c409af656a67752c2" value="1" />	</div>
	</form>
<!-- <br />
