<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:51753:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/opencart/vat-number-in-invoice" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hi pradeepnambyan, You can add VAT information to your Invoices, but in my research it does not appear to be an included option in OpenCart. Option 1: E..." />
  <title>Adding VAT Number to Invoice in OpenCart | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/opencart/vat-number-in-invoice" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:3b7e9a43c0431347dd9557a8a2f1599b -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Adding VAT Number to Invoice in OpenCart</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='http://graph.facebook.com/pradeep.nambyan/picture?type=normal' class='user_avatar' /><br />
			<a href='/support/community-support/users/pradeepnambyan'>pradeepnambyan</a>
			<div>46 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-08-30 9:37 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>1,896</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>How do we Add VAT register Number to our Invoices</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_3837' id='upvote_answer_3837' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='3837' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_3837').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_3837' id='downvote_answer_3837' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='3837' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_3837').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>5,399 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2013-08-30 9:51 am EST
                		        </div>
					
		                </div>

				Hi pradeepnambyan,<br />
<br />
You can add VAT information to your Invoices, but in my research it does not appear to be an included option in OpenCart.<br />
<br />
&lt;h2&gt;Option 1: Edit your logo&lt;/h2&gt;<br />
As your logo appears in your invoice, by far the easiest option would be to edit your logo and add your VAT number somewhere near the bottom of the image.<br />
<br />
&lt;h2&gt;Option 2: Use an extension&lt;/h2&gt;<br />
I don't have any direct experience with these modules, but it looks like you can use an OpenCart Extension to add your VAT number:<br />
<br />
&lt;a href='http://www.opencart.com/index.php?route=extension/extension/info&amp;extension_id=12209' target='_blank'&gt;Company &amp; VAT No. in Footer &amp; Invoices&lt;/a&gt; - $15<br />
&lt;em&gt;EASILY put your company's trading name, registered company number and VAT registration number within the footer of your website and at the bottom of all your invoices!&lt;/em&gt;<br />
<br />
&lt;a href='http://www.opencart.com/index.php?route=extension/extension/info&amp;extension_id=3640' target='_blank'&gt;detailed vat / custom invoice&lt;/a&gt; - $10<br />
&lt;em&gt;When printing invoice adds detailed VAT to every product bought. Customize the invoice adding shop logo and faded logo on invoice background. Ready to be printed from your admin section.&lt;/em&gt;<br />
<br />
&lt;h2&gt;Option 3: Edit your invoice template&lt;/h2&gt;<br />
In a discussion on this page, &lt;a href='http://forum.opencart.com/viewtopic.php?f=19&amp;t=48686' target='_blank'&gt;Display TAX/VAT number on my invoices&lt;/a&gt;, a community member suggested this file - &lt;em&gt;\admin\view\template\sale\order_invoice.tpl&lt;/em&gt;. That seems to do the trick because the user asking the question stated, &quot;&lt;em&gt;Many thanks! That is just what I was after!&lt;/em&gt;&quot;.<br />
<br />
...
- Brad
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_3837').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_3837' id='form_comment_on_answer_3837' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Thanks Mr. Brad.<br />
i opt your  option 3. and then it is working very nice<br />
regards = pradeep nambyan</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='http://graph.facebook.com/pradeep.nambyan/picture?type=normal' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/pradeepnambyan'>pradeepnambyan</a><br />
									46 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2013-08-31 3:34 am EST
								</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/opencart/vat-number-in-invoice&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/opencart/vat-number-in-invoice'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="c1dc6b82da228c1edc70f1628f7f9b48" value="1" />	</div>
	</form>
<!-- <br />
