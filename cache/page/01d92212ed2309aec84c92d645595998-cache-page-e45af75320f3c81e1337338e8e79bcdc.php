<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:58617:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/everything-email/organizing-email/create-email-list-horde" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-01-29T18:35:32-08:00" />
  <meta name="author" content="Arnel Custodio" />
  <meta name="description" content="If you need to send emails to a multiple people and you need to do it repeatedly, it's best to make a list or distribution list.  The Horde email client is able to make these contact lists using its address books. The following tutorial goes through the step to create an email list." />
  <title>How to Create an Email List in the Horde Webmail Client - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/everything-email/organizing-email/create-email-list-horde" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:2823f56da153ee0980a77c904e5a50e4 -->
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/everything-email' itemprop='url'><span itemprop='title'>Everything Email<span></a><div class='dropdown_4columns'><h2>Everything Email Education Channel</h2><div class='col_2'><h3>100 Level Classes</h3><div><a href='/support/edu/everything-email/introduction-email'>101: Basic Introduction to Email</a></div><div><a href='/support/edu/everything-email/email-features'>102: Email Features</a></div><div><a href='/support/edu/everything-email/organizing-email'>103: Organizing your Email</a></div></div><div class='col_2'><h3>200 Level Classes</h3><div><a href='/support/edu/everything-email/spam-prevention-techniques'>201: Dealing with Spam</a></div><div><a href='/support/edu/everything-email/202-using-dada-mail-for-sending-newsletters'>202: Using DaDa Mail for sending Newsletters</a></div><div><a href='/support/edu/everything-email/203-common-email-errors'>203: Common Email errors</a></div><div><a href='/support/edu/everything-email/mcafee'>203: McAfee Email Protection</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/everything-email/organizing-email' itemprop='url'><span itemprop='title'>103: Organizing your Email<span></a><div class='dropdown_3columns'><h2> Organizing your Email</h2><div class='col_3'><div>1. <a style='display:inline;' href='/support/edu/everything-email/organizing-email/create-email-list-horde'>How to Create an Email List in the Horde Webmail Client</a></div><div>2. <a style='display:inline;' href='/support/edu/everything-email/organizing-email/creating-email-folders'>Creating Email Folders</a></div><div>3. <a style='display:inline;' href='/support/edu/everything-email/organizing-email/setting-up-email-filters'>Setting up Email Filters</a></div><div>4. <a style='display:inline;' href='/support/edu/everything-email/organizing-email/searching-emails'>Searching for Emails</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to Create an Email List in ...</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to Create an Email List in the Horde Webmail Client									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>156</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 29, 2016'><span style='color:#606060;'>Published:</span> Jan 29, 2016</div>
...
<h2>Steps to create Email list</h2>

<ol class="article_list">

<li>
	<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/horde-email-list/choose-webmail-client.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="200" alt="Login to webmail" src="//cdn.inmotionhosting.com/support/images/stories/horde-email-list/choose-webmail-client.png" align="right" /></a>
	<p><a href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-email/logging-into-webmail" target="_blank">Login to the Horde Webmail client</a></p>
	<div style="clear:both;"></div>
</li>

<li>
	<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/horde-email-list/add-contacts.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="200" alt="Add email contacts" src="//cdn.inmotionhosting.com/support/images/stories/horde-email-list/add-contacts.png" align="right" /></a>
	<p>Before you can create the list, all the emails that you want to include in the list must be added to an address book in Horde.  <b>Click on Address book</b> to open the drop-down menu.  <b>Click on New Contact</b> in order to add contacts to an address book.</p>
	<div style="clear:both;"></div>
</li>

<li>
	<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/horde-email-list/select-address-book.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="200" alt="Select the Address book in the drop-down menu" src="//cdn.inmotionhosting.com/support/images/stories/horde-email-list/select-address-book.png" align="right" /></a>
	<p>When you have completed adding the addresses to your Address book, <b>click on Address Book</b> again, and then <b>click on Address Book</b> in the drop down menu.</p>
	<div style="clear:both;"></div>
</li>

<li>
	<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/horde-email-list/address-book-selected.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="200" alt="click on menu item" src="//cdn.inmotionhosting.com/support/images/stories/horde-email-list/address-book-selected.png" align="right" /></a>
	<p>You will see a menu list about the contacts and a drop down menu labeled "to a Contact list".  <b>Click on this drop down menu</b>.</p>
	<div style="clear:both;"></div>
</li>

<li>
	<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/horde-email-list/add-new-contact-list.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="200" alt="Add new contact list to address book" src="//cdn.inmotionhosting.com/support/images/stories/horde-email-list/add-new-contact-list.png" align="right" /></a>
	<p>In the drop down menu you'll see an option that says "Create a new contact list in:" and you'll be able to select an address book.  If you have multiple address books, then you'll see them listed here.  Make sure you choose the one with all of your contacts. <b>Select your address book</b>, if necessary.</p>
	<div style="clear:both;"></div>
</li> 

<li>
	<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/horde-email-list/add-addresses-to-list.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="200" alt="Add contacts to list clicking on check boxes" src="//cdn.inmotionhosting.com/support/images/stories/horde-email-list/add-addresses-to-list.png" align="right" /></a>
	<p>The menu above the listed users will now show the Address Book name.  <b>Click on check boxes for the users</b> that you want in the list.</p>  
	<div style="clear:both;"></div>
</li>

<li>
	<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/horde-email-list/name-contact-list.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="200" alt="Name the new email list" src="//cdn.inmotionhosting.com/support/images/stories/horde-email-list/name-contact-list.png" align="right" /></a>
	<p>Once you have finished selecting the users in your list, <b>click on the ADD button</b> in the menu line (next to the address book name).  This will open up a pop-up window that says, "The page at domain_name.com:2095 says:  Please name the contact list:".  <b>Type in a name for your contact list</b> in the blank, then click on OK to create it.</p>
	<div style="clear:both;"></div>
</li>

<li>
	<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/horde-email-list/webmail-select-list.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="200" alt="Select list when composing email" src="//cdn.inmotionhosting.com/support/images/stories/horde-email-list/webmail-select-list.png" align="right" /></a>
	<p>That completes the creation of your email list!  When the list is created, you will be able to call it up by typing the name of the list in the To: field of the email.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/everything-email/organizing-email'>103: Organizing your Email</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 1: How to Create an Email List in the Horde Webmail Client</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 2: <a href='/support/edu/everything-email/organizing-email/creating-email-folders'>Creating Email Folders</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/everything-email/organizing-email/create-email-list-horde&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/everything-email/organizing-email/create-email-list-horde'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xMTcmaWQ9Mzc0NSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/everything-email/organizing-email?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Organizing your Email</h3></a>
		<table>  <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/everything-email/organizing-email/create-email-list-horde?tsrc=rsbedu'>How to Create an Email List in the Horde Webmail Client</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/everything-email/organizing-email/creating-email-folders?tsrc=rsbedu'>Creating Email Folders</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/everything-email/organizing-email/setting-up-email-filters?tsrc=rsbedu'>Setting up Email Filters</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/everything-email/organizing-email/searching-emails?tsrc=rsbedu'>Searching for Emails</a></td>
                </tr>
          	</table>
