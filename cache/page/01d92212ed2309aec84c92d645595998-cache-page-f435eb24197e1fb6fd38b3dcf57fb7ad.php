<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50117:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/domain-names/cgisyssuspendedpagecgi" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Thank you for your question chimeguy1! Check your .htaccess file to see of there is a rewrite in there. Basically when accounts are suspended, the serve..." />
  <title>cgi-sys/suspendedpage.cgi | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/domain-names/cgisyssuspendedpagecgi" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:9f1f0bc3013a838403461d5b046c9805 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '197.210.172.49']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box straight_bottom'>
                <h1 style='font-size:26px;'>cgi-sys/suspendedpage.cgi</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='http://graph.facebook.com/eld.pierce/picture?type=normal' class='user_avatar' /><br />
			<a href='/support/community-support/users/chimeguy1'>chimeguy1</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-03-21 2:28 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>8,693</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I am not a customer of inmotion<br />
but directnic<br />
I am getting constant (2 weeks) <br />
cgi-sys/suspendedpage.cgi<br />
on domains zen cart based<br />
eztonechime.com<br />
and beamdoorchime.com<br />
proxy shows resoving ok. but when I look on my own computers  I get contstand off and on<br />
cgi-sys/suspendedpage.cgi pages. </div>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px;'>
				<div style='font-size:12px; max-width:500px; overflow:auto;'>sorry to bug you guys but direct nic customers service has so far been unable to solve this<br />
(is this a cpanel issues hack? 301 redirect prob? contact form problem. I am also getting bot spam from the contact form. </div>
				
				
			</td>
			<td style='width:100px;' valign='top'>
				<img src='http://graph.facebook.com/eld.pierce/picture?type=normal' style='width:40px;' class='user_avatar' />
				<div class='smallgrey'>
					<a href='/support/community-support/users/chimeguy1'>chimeguy1</a><br />
					5 <a href='/support/team/points' target='_blank'>Points</a><br />
					2013-03-21 02:30 am EST
				</div>
			</td>
		</tr>
	</table>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_2465' id='upvote_answer_2465' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='2465' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_2465').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_2465' id='downvote_answer_2465' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='2465' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_2465').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>5,889 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2013-03-21 9:08 am EST
                		        </div>
					
		                </div>

				Thank you for your question chimeguy1!<br />
<br />
Check your .htaccess file to see of there is a rewrite in there. Basically when accounts are suspended, the server creates an  .htaccess file with code that redirects to a server generic suspended page. Its possible the code for the rewrite may be in your .htaccess  somewhere due to a system glitch and for some reason every now and then the code is parsed. <br />
<br />
Best Regards,<br />
James R
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_2465').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_2465' id='form_comment_on_answer_2465' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
