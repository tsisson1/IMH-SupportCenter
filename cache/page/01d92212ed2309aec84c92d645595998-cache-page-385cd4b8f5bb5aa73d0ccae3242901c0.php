...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/prestashop-15/pshop15-price-rules" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="This class will focus on cart rules and how to implement and configure them in PrestaShop 1.5" />
  <title>205: Working with Cart Rules in PrestaShop 1.5 | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/prestashop-15/pshop15-price-rules" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:212c5451eac5bad3722250ffd8b3919f -->
...
<div class='page-header'>
	<h1>205: Working with Cart Rules in PrestaShop 1.5</h1>
</div>
<div class='section_listing'>
		<table>
	<tr><td colspan='3'><h2>Cart Rule Settings</h2><div>Learn to tweak the specifics of cart rules</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 1:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/pshop15-price-rules/disable-cart-rule'>Disabling a cart rule in PrestaShop 1.5</a>
					<div>Learn how to disable a cart rule while maintaining its settings for future use in this PrestaShop 1.5 article.</div>
					<div class='smallgrey'>Hits: 2,828</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/pshop15-price-rules/set-coupon-code'>How to set a coupon code in PrestaShop 1.5</a>
					<div>This article teaches you how to set a coupon code in your PrestaShop 1.5 so that the discount is restricted to certain custmers.</div>
					<div class='smallgrey'>Hits: 13,976</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/pshop15-price-rules/change-partial-use'>Changing the  partial use of a coupon voucher in PrestaShop 1.5</a>
					<div>Learn how to change the Partial Use setting in PrestaShop 1.5 as well as the effects of the change on the customer.</div>
					<div class='smallgrey'>Hits: 1,909</div>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/pshop15-price-rules/cart-rule-specific-customer'>Limiting a cart rule to specific customers in PrestaShop1.5</a>
					<div>This PrestaShop 1.5 article discusses how to limit cart rules to specific customers.</div>
					<div class='smallgrey'>Hits: 1,308</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/pshop15-price-rules/cart-rule-date-range'>How to set a date range for cart rules in PrestaShop 1.5</a>
					<div>This Prestashop 1,5 tutorial guides you on how to set a date range for your cart rules.</div>
					<div class='smallgrey'>Hits: 1,581</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/pshop15-price-rules/set-min-amount'>How to set a minimum amount for cart rules in PrestaShop 1.5</a>
					<div>Learn to restrict the use of a cart rule voucher by requiring the customer to have a minimum purchase requirement in Prestashop 1.5</div>
					<div class='smallgrey'>Hits: 4,155</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/pshop15-price-rules/set-total-avaialble'>How to set a quantity limit for cart rules in PrestaShop 1.5</a>
					<div>This article will walk you through setting the total number of vouchers 9coupons) available for cart rules in PrestaShop 1.5</div>
					<div class='smallgrey'>Hits: 6,545</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/pshop15-price-rules/max-times-per-customer'>Setting the max times customers can use a cart rule in PrestaShop 1.5</a>
					<div>This tutorial explains how to set the maximum times a customer can use a cart rule in PrestaShop 1.5</div>
					<div class='smallgrey'>Hits: 1,198</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/pshop15-price-rules/restrict-carriers-per-rule'>Restrict cart rules to work with certain carriers in PrestaShop 1.5 </a>
					<div>This Prestashop 1.5 article explains how to set the cart rules to work only with selected carriers.</div>
					<div class='smallgrey'>Hits: 3,505</div>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/pshop15-price-rules/choose-specific-products'>Setting specific products for using a cart rule in PrestaShop 1.5</a>
					<div>This article for PrestaShop 1.5 covers the ability to restrict a cart rule to customers that have a product with specific criteria in their cart.</div>
					<div class='smallgrey'>Hits: 4,013</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/pshop15-price-rules/cart-specific-shops'>How to set cart rules for specific shops in PrestaShop 1.5</a>
					<div>This tutorial for PrestaShop 1.5 guides you on how to set your cart rules to work with the specific shops you choose.</div>
					<div class='smallgrey'>Hits: 1,279</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/pshop15-price-rules/cart-rule-free-shipping'>How to set free shipping for cart rules in PrestaShop 1.5 </a>
					<div>This short tutorial discusses how to set the free shipping option in PrestaShop 1.5</div>
					<div class='smallgrey'>Hits: 8,713</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/pshop15-price-rules/cart-rule-discounts'>How to set discounts for cart rules in PrestaShop 1.5 </a>
					<div>Learn how to set discounts for your cart rules in PrestaShop 1.5</div>
					<div class='smallgrey'>Hits: 4,221</div>
				</td>
			</tr>
			</table>
</div>
