<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:68627:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/everything-email/introduction-email/checking-email-account" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-01-21T21:06:50-08:00" />
  <meta name="keywords" content="email client check webmail enflateemail imap pop3 pop" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="Learn about the differences between POP3 and IMAP emails. " />
  <title>How email works in general - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/everything-email/introduction-email/checking-email-account" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:dad99248f18055d623da9d30bc5c99ec -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '50.188.220.241']);
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>41,198</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Sep 1, 2011'><span style='color:#606060;'>Published:</span> Jan 21, 2014</div>
...
<p>Please check the next article on <a target="_blank" href="/support/edu/everything-email/introduction-email/writing-sending-email" title="Click here to view the next article">Writing and Sending Email</a>. If you missed our previous article, please see the <a href="/support/edu/everything-email/introduction-email/creating-email-account" title="Click here to view the previous article" target="_blank">Creating an Email Account</a> tutorial. For more information on this course please visit <a target="_blank" href="/support/edu/everything-email/introduction-email" title="Click here to view the courses">Basic Introduction to Email</a></p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 3: How email works in general</div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/everything-email/introduction-email/checking-email-account&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/everything-email/introduction-email/checking-email-account'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xNDMmaWQ9OTMxJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="a2831033aee163fd767b81c90760222c" value="1" />	</div>
	</form>
<!-- <br />
...
<a name='comments'></a>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/99aa6b8c2392d936987ffe47947c8087?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/99aa6b8c2392d936987ffe47947c8087'>Raju Chauhan</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-18 8:51 am</div>
				                <div><p>how to access outlook data file D Drive save in folder.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17543);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-18 10:03 am</div>
				                <div>Could you clarify exactly what you are trying to accomplish?</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17553);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-24425'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/45d059f894f1fe96ea34b0cefe56aa03?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/45d059f894f1fe96ea34b0cefe56aa03'>Jenn</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-24 10:44 pm</div>
				                <div><p>Hello, I am hoping you can help, I have followed the instructions carefully to have my new email appear in on my desktop&nbsp;mac mail and I am still getting errors :(&nbsp;</p>
<p>Here is the error message, I can not send or recieve anything yet.&nbsp;</p>
<p>"There may be a problem with the mail server or network. Verify the settings for account &ldquo;EXAMPLE Designs&rdquo; or try again.</p>
<p>The server returned the error: Connections to the server &ldquo;mail.example.com&rdquo; on the default ports timed out."</p>
<p>&nbsp;</p>
<p>I am using port 465 with ssl. ( as notice in the help section)</p>
<p>Thanks</p>
<p>Jenn</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24425);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-25 2:51 pm</div>
				                <div>Hello Jenn,<br />
<br />
Thank you for contacting us. Since this is a public forum, I have replaced your domain with example.com for security purposes. I recommend verifying your settings with your mail host (I looked at your <a href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-email/modfying-mx-records">MX records</a> and they not pointed to us). <br />
<br />
If your mail is supposed to be with InMotion Hosting, you will have to point your <a href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-email/modfying-mx-records">MX records</a> to us. You can then view your <a href="http://www.inmotionhosting.com/support/edu/everything-email/introduction-email/how-to-find-email-settings">email settings</a> in cPanel, and setup  your <a href="http://www.inmotionhosting.com/support/email/email-client-setup/mac-mail-mavericks-os">Mac Mail</a>.<br />
<br />
If your problems persist, I recommend contacting<a href="http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support"> Live Support</a>, so they can review the email logs in real-time while you are connecting.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24447);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
