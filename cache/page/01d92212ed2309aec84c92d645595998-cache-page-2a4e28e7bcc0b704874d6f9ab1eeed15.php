<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:58897:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/dokuwiki/working-with-menus/custom-menu-plugin" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-01-11T14:11:14-08:00" />
  <meta name="keywords" content="add adding insert inserting menu items plugin doku wiki dokuwiki" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="This will teach you how to add a menu to your DokuWiki pages using the menu plugin." />
  <title>How to use the menu plugin in DokuWiki - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/dokuwiki/working-with-menus/custom-menu-plugin" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:21ccb520faa3c4efb9aacc843ab90879 -->
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/dokuwiki' itemprop='url'><span itemprop='title'>Dokuwiki<span></a><div class='dropdown_4columns'><h2>Dokuwiki Education Channel</h2><div class='col_2'><h3>100 Level Classes</h3><div><a href='/support/edu/dokuwiki/geting-started-dokuwiki'>101: Getting Started with Dokuwiki</a></div><div><a href='/support/edu/dokuwiki/writing-content-dokuwiki'>102: Writing content for DokuWiki</a></div><div><a href='/support/edu/dokuwiki/change-dokuwiki-appearance'>103: Changing the DokuWiki Appearance</a></div><div><a href='/support/edu/dokuwiki/add-contact-form-dokuwiki'>104: Adding a contact form in DokuWiki</a></div><div><a href='/support/edu/dokuwiki/install-configure-plugins-doku'>105: Installing and Configuring plugins in DokuWiki</a></div></div><div class='col_2'><h3>200 Level Classes</h3><div><a href='/support/edu/dokuwiki/working-with-menus'>201: Working with menus in DokuWiki</a></div><div><a href='/support/edu/dokuwiki/change-language-doku-wiki'>202: Changing the language in DokuWiki</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/dokuwiki/working-with-menus' itemprop='url'><span itemprop='title'>201: Working with menus in DokuWiki<span></a><div class='dropdown_3columns'><h2> Working with menus in DokuWiki</h2><div class='col_3'><div>1. <a style='display:inline;' href='/support/edu/dokuwiki/working-with-menus/custom-css-menu'>Inserting a custom CSS menu in DokuWiki</a></div><div>2. <a style='display:inline;' href='/support/edu/dokuwiki/working-with-menus/custom-menu-plugin'>How to use the menu plugin in DokuWiki</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to use the menu plugin in ...</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to use the menu plugin in DokuWiki									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>4,625</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 4, 2013'><span style='color:#606060;'>Published:</span> Jan 11, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>DokuWiki has a plugin called the "<em>menu</em>" plugin that will allow you to place a custom navigation menu in your pages. This menu has nice icons separated out to each menu link catagory. The "<em>menu</em>" plugin that primarily works in the Wiki page code.&nbsp; The following article will explain how to use the "<em>menu</em>" plugin.</p>
<p class="alert"><strong>Important!</strong> This menu only appears in the page you place the code in. To create a menu that is at the top of each page, <a href="/support/edu/dokuwiki/working-with-menus/custom-css-menu">please visit here</a>.</p>
<h2>Adding a menu to your DokuWiki with the menu plugin</h2>
<p>The menu plugin can be a nice aesthetic to a page in your wiki. The menu plugin can be downloaded at the following link. Visit the following link and right click the download link on that page and save the link location.</p>
<p style="margin-left: 20px;"><a href="https://www.dokuwiki.org/plugin:menu">Download menu plugin</a></p>
<p>You should have a link like the following.</p>
<p style="margin-left: 20px;">ftp://ftp.berlios.de/pub/pbbuttons/plugin-menu.tgz</p>
<p>Take that url and use it in the following steps. The following steps will explain how to install install and use the menu module.</p>
...
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/103/custom-menu-plugin/creating-menu-1-login.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="Click the Admin link DokuWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/103/custom-menu-plugin/creating-menu-1-login.gif" title="Click here to view the larger image" width="100" /></a><strong>Click Admin</strong> at the top right. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/103/custom-menu-plugin/creating-menu-2-manage-plugin.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Click Manage Plugins DokuWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/103/custom-menu-plugin/creating-menu-2-manage-plugin.gif" title="Click here to view the larger image" width="100" /></a><strong>Click Manage Plugins.</strong> <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/103/custom-menu-plugin/creating-menu-3-install-direct-url.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Install Direct from URL DokuWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/103/custom-menu-plugin/creating-menu-3-install-direct-url.gif" title="Click here to view the larger image" width="100" /></a><strong>Paste the download link</strong> in the <em>Download and install a new plugin</em>text box. In this case, the download link is the following.
<p style="margin-left: 20px;">ftp://ftp.berlios.de/pub/pbbuttons/plugin-menu.tgz</p>
<p><strong>Click Download</strong><br style="clear: both;" /></p>
<p>You should see a green confirmation box saying (1 plugin(s): menu) successfully installed. <br style="clear: both;" /></p>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/103/custom-menu-plugin/creating-menu-5-installed-plugins.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Upload images DokuWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/103/custom-menu-plugin/creating-menu-5-installed-plugins.gif" title="Click here to view the larger image" width="100" /></a>The menu plugin will now show in the Installed plugin list. <br style="clear: both;" /></p>
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/103/custom-menu-plugin/creating-menu-6-upload-images.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Upload the images to DokuWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/103/custom-menu-plugin/creating-menu-6-upload-images.gif" title="Click here to view the larger image" width="100" /></a><strong>Upload the icon images</strong> to the page you are adding the menu to. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/103/custom-menu-plugin/creating-menu-6b-insert-code.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Insert the code for the plugin DokuWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/103/custom-menu-plugin/creating-menu-6b-insert-code.gif" title="Click here to view the larger image" width="100" /></a><strong>Add the following code to a page.</strong> <a href="/support/edu/dokuwiki/writing-content-dokuwiki/edit-create-delete-restore-dokuwiki">Click here for how to edit a page</a>.<strong><br /></strong>
<pre>&lt;menu col=2,itemwidth=20,align=center,caption="Menu"&gt;
  &lt;item&gt;Item name 1|Item descr 1|[[Wiki link 1]]| {{Image 1}}&lt;/item&gt;
  &lt;item&gt;Item name 2|Item descr 2|[[Wiki link 2]]| {{Image 2}}&lt;/item&gt;
  &lt;item&gt;Item name 3|Item descr 3|[[Wiki link 3]]| {{Image 3}}&lt;/item&gt;
&lt;/menu&gt;
</pre>
You will need to supplement the following for your menu items.
<p><strong>- Item name:</strong> The text you want for the link.<br /> <strong>- Item descr:</strong> Text that follows the link with information.<br /> <strong>- Wiki link:</strong> The path to your wiki page. For example, frequently_asked_question. This is obtained be visiting the page and getting the last variable in the URL.<br /> <strong>- Image:</strong> This is the image name you uploaded in step 5. For example, email.gif.<br style="clear: both;" /></p>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/103/custom-menu-plugin/creating-menu-6a-final-view.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Final view of menu pluigin Dokuwiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/103/custom-menu-plugin/creating-menu-6a-final-view.gif" title="Click here to view the larger image" width="100" /></a><strong>Save the page</strong> and now you should see the menu look like the snapshot to the right.<br style="clear: both;" /></p>
<br style="clear: both;" /></li>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/dokuwiki/working-with-menus'>201: Working with menus in DokuWiki</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 2: How to use the menu plugin in DokuWiki</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 1: <a href='/support/edu/dokuwiki/working-with-menus/custom-css-menu'>Inserting a custom CSS menu in DokuWiki</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/dokuwiki/working-with-menus/custom-menu-plugin&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/dokuwiki/working-with-menus/custom-menu-plugin'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMjQmaWQ9MjE0NiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/dokuwiki/working-with-menus?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Working with menus in DokuWiki</h3></a>
		<table><tr><td colspan='2'><h4>Custom coded menu</h4></td></tr>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/dokuwiki/working-with-menus/custom-css-menu?tsrc=rsbedu'>Inserting a custom CSS menu in DokuWiki</a></td>
                </tr>
        <tr><td colspan='2'><h4>Menu Plugins</h4></td></tr>  <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/dokuwiki/working-with-menus/custom-menu-plugin?tsrc=rsbedu'>How to use the menu plugin in DokuWiki</a></td>
                </tr>
          	</table>
