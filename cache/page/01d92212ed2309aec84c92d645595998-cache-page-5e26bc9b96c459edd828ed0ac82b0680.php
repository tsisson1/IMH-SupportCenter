<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:52075:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/joomla-3/fatal-error-allowed-memory-size-of-33554432-bytes-exhausted-tried-to-allocate-15767-bytes-in-homemixtil5publichtmlcomponentscomeasydiscussclasseslesscincphp-on-line-3311" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello michael_flow, In this case, it is advised to further increase the memory allowance of your php. You can do this via the php.ini file found within ..." />
  <title> Fatal error: Allowed memory size exhausted | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/joomla-3/fatal-error-allowed-memory-size-of-33554432-bytes-exhausted-tried-to-allocate-15767-bytes-in-homemixtil5publichtmlcomponentscomeasydiscussclasseslesscincphp-on-line-3311" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:541e8c83f4e17c78b1581ac84412e585 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'> Fatal error: Allowed memory size exhausted</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/michael_flow'>michael_flow</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-04-25 7:14 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>3,591</span>
			</div>
...
Dear Sir:<br />
<br />
Today I add a easydiscuss extend to my site,and I open the page, I saw:<br />
<br />
Fatal error: Allowed memory size of 33554432 bytes exhausted (tried to allocate 15767 bytes) in /home/mixtil5/public_html/components/com_easydiscuss/classes/lessc.inc.php on line 3311<br />
<br />
My memory is:<br />
Maximum amount of memory a script may consume (32MB)<br />
<br />
May I know how to fix it?</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_2964' id='upvote_answer_2964' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='2964' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_2964').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_2964' id='downvote_answer_2964' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='2964' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_2964').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>37,016 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2013-04-25 9:14 am EST
                		        </div>
					
		                </div>

				Hello michael_flow,<br />
<br />
In this case, it is advised to further increase the memory allowance of your php. You can do this via the php.ini file found within your cpanel.<br />
<br />
Please follow the instructions in our article on <a href="http://www.inmotionhosting.com/support/website/website-troubleshooting/allowed-memory-size-exausted" target="_blank">How to fix the "Allowed memory size Error"</a><br />
<br />
You do not necessarily need to double it to 64MB. In fact, it is recommended to increase it in smaller increments, for example by 2 (to 34MB) or 6 (to 38MB) and see if that helps. If it still exists, increase it again until the error goes away. <br />
<br />
Best Regards,<br />
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_2964').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_2964' id='form_comment_on_answer_2964' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/joomla-3/fatal-error-allowed-memory-size-of-33554432-bytes-exhausted-tried-to-allocate-15767-bytes-in-homemixtil5publichtmlcomponentscomeasydiscussclasseslesscincphp-on-line-3311&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/joomla-3/fatal-error-allowed-memory-size-of-33554432-bytes-exhausted-tried-to-allocate-15767-bytes-in-homemixtil5publichtmlcomponentscomeasydiscussclasseslesscincphp-on-line-3311'></div>
<script type='text/javascript'>
  (function() {
