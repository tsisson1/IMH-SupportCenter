<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:72725:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/opencart/im-using-bulk-export-import-extension-in-opencart-export-is-working-well-butwhen-import-file-erroruploaded-file-is-not-a-valid-spreadsheet-file-or-its-values-are-not-in-the-expected-formats" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="I had the problem like you that is data not match with data table in XLSX file. Example: &quot;Price column&quot; -&gt; If Price = 0, I must enter &quot;0&quot; but my partner..." />
  <title>Opencart Error:Uploaded file is not a valid spreadsheet file or its values are not in the expected formats! | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/opencart/im-using-bulk-export-import-extension-in-opencart-export-is-working-well-butwhen-import-file-erroruploaded-file-is-not-a-valid-spreadsheet-file-or-its-values-are-not-in-the-expected-formats" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:81bc7c2b53363030866b14ee2b3520a3 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '186.212.35.131']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box straight_bottom'>
                <h1 style='font-size:26px;'>Opencart Error:Uploaded file is not a valid spreadsheet file or its values are not in the expected formats!</h1>
		<div style='margin-bottom:20px; margin-top:10px; clear:both; color:#6e6e6e;'>Category: <a href='/support/community-support/opencart'>Opencart</a></div>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='http://graph.facebook.com/munaf.abdul.395/picture?type=normal' class='user_avatar' /><br />
			<a href='/support/community-support/users/munafa1'>munafa1</a>
			<div>44 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-05-16 2:37 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>7,280</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I'm using Bulk Export/ Import Extension in OpenCart .export is working well but,when import file Error:Uploaded file is not a valid spreadsheet file or its values are not in the expected formats!<br />
</div>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px;'>
				<div style='font-size:12px; max-width:500px; overflow:auto;'>any help would be greatly appreciated</div>
				
				
			</td>
			<td style='width:100px;' valign='top'>
				<img src='http://graph.facebook.com/munaf.abdul.395/picture?type=normal' style='width:40px;' class='user_avatar' />
				<div class='smallgrey'>
					<a href='/support/community-support/users/munafa1'>munafa1</a><br />
					44 <a href='/support/team/points' target='_blank'>Points</a><br />
					2013-05-16 06:34 am EST
				</div>
			</td>
		</tr>
	</table>
...
<div style='padding:15px; border:1px solid #d6d6d6; border-top:0px; background:#ebebeb;' class='round_bottom' >
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px;'>
				<div style='font-size:12px; max-width:500px; overflow:auto;'>Uploaded spreadsheet file has validation errors!<br />
See also 'System &gt; Error Logs' for more details.<br />
No server data has been changed. </div>
				
				
			</td>
			<td style='width:100px;' valign='top'>
				<img src='http://graph.facebook.com/fareed.khan.3705/picture?type=normal' style='width:40px;' class='user_avatar' />
				<div class='smallgrey'>
					<a href='/support/community-support/users/fareed'>fareed</a><br />
					0 <a href='/support/team/points' target='_blank'>Points</a><br />
					2015-04-11 05:37 am EST
				</div>
			</td>
		</tr>
	</table>
...
<div class='white_box straight_bottom '>
	<h2 class='best_answer_text'>Best answer chosen by User</h2>
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px; width:50px;' valign='top'>
<div class='vote_div'>
	<form method='post' name='upvote_answer_3122' id='upvote_answer_3122' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='3122' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_3122').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_3122' id='downvote_answer_3122' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='3122' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_3122').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					<img src='https://lh3.googleusercontent.com/-et9qjCJVL08/AAAAAAAAAAI/AAAAAAAAAC4/C539ZYF2HNc/s90-p-rw-no/photo.jpg' class='user_avatar' style='max-width:60px;' /><br />
                		        <a href='/support/community-support/users/scott'>scott</a>
				...
				Hello munafa1,<br />
<br />
I have tested the bulk export import extension on our own <a href="http://www.inmotionhosting.com/support/edu/opencart/installing-opencart-and-adding-products/installing-open-cart-with-softaculous" target="_blank">OpenCart installation</a>. I have not experienced any issues with <a href="http://www.inmotionhosting.com/support/edu/opencart/322-using-the-bulk-export-import-extension-in-opencart" target="_blank">importing</a>, even after changing the data in the file. The error leads me to think the OpenCart has issue with either the format of the file, which should be XLSX, or that the formatting of one or more of the columns is incorrect.  <br />
<br />
I was able to cause the error, but only after intentionally changing the save format of the file.. Changing it back to xls/xlsx allowed it to be imported properly. Be sure that the saved file you are uploading is indeed XLSX. And if that is the case, you will want to check the columns to ensure that they are either numeric, text, or datetime as the original file exported. <br />
<br />
I apologize for being so general, but without a test file to review, I am unable to pinpoint an exact cause. You may feel free to send a copy of the import file to us at docs@inmotionhosting.com and I will be happy to test that file with our setup. If you send the file, please leave a comment below so that we know the data was sent, as we do not actively monitor that email address.<br />
<br />
Best Regards,<br />
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_3122').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_3122' id='form_comment_on_answer_3122' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				...
				<div style='padding:15px 15px 15px 76px; border:1px solid #ddd; border-top:0px; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Thank you for quick reply i send a copy of the import file to your mail.....<br />
 </div>
							...
							<td style='width:96px;' valign='top'>
								...
								<div class='smallgrey'>
									<a href='/support/community-support/users/munafa1'>munafa1</a><br />
									44 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2013-05-16 9:58 am EST
								</div>
				...
				<div style='padding:15px 15px 15px 76px; border:1px solid #ddd; border-top:0px; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello munafa1,<br />
<br />
I have traced the error to the products and categories tabs in the import file. The categories tab is simply a copy of the products tab, so none of the data will match when you attempt to import. This tab in particular is causing the error you are receiving. The products tab is severely out of order and will not import data to the proper columns due to out of sync data types and column location.<br />
<br />
For example, the product ID "MED-001" is invalid as it involves text, whereas the column in oc_product is expecting numeric data. I am not sure where the data came from, or if it was changes after an export, but as it is, it will not import into the OpenCart database.<br />
<br />
Best Regards,<br />
Scott M</div>
							...
							<td style='width:96px;' valign='top'>
								...
								<div class='smallgrey'>
									...
									36,993 <a href='/support/team/points' target='_blank'>Points</a>
				...
				<div style='padding:15px 15px 15px 76px; border:1px solid #ddd; border-top:0px; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>i have sented mail of sample xls sheet plz tell me it z valid or not<br />
 </div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello Munafa1,<br />
<br />
I was able to review the XLSX file that you sent.  Based on what I saw in the spreadsheet, the problem was identified in Scott's previous reply. The data that you are importing does not MATCH with the  OpenCart table variables'  format.  The main example that Scott gave in the reply above was your product ID.  You can easily see, that if you look at your spreadsheet that ALL of your product IDs have text.  You will need to change the values of the data you are importing in order to make it acceptable to the OpenCart database.  All of the variables in your spreadsheet need to match the OpenCart table format, otherwise, it will not work.   If you have any further questions on importing, please refer our documentation on <a href="http://www.inmotionhosting.com/support/edu/opencart/322-using-the-bulk-export-import-extension-in-opencart" target="new">using the bulk export/import extension in OpenCart</a>.<br />
<br />
...
Community Support Team</div>
				...
				<div style='padding:15px 15px 15px 76px; border:1px solid #ddd; border-top:0px; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>i have uploadded xlxs sheet i got error like<br />
Notice: Error: You have an error in your SQL syntax; check the manual that corresponds to your MySQL server version for the right syntax to use near ''','','','','','','',5,' ',27,'',0,875,,NOW(),NOW(),NOW(),0,0,1,,0,,,,'0','0',' at line 1<br />
Error No: 1064<br />
INSERT INTO `oc_product` (`product_id`,`quantity`,`sku`,`upc`,`ean`,`jan`,`isbn`,`mpn`,`location`,`stock_status_id`,`model`,`manufacturer_id`,`image`,`shipping`,`price`,`points`,`date_added`,`date_modified`,`date_available`,`weight`,`weight_class_id`,`status`,`tax_class_id`,`viewed`,`length`,`width`,`height`,`length_class_id`,`sort_order`,`subtract`,`minimum`) VALUES (1,,'','','','','','','',5,' ',27,'',0,875,,NOW(),NOW(),NOW(),0,0,1,,0,,,,'0','0','1','1'); in D:\wamp\www\opencart\upload\system\database\mysql.php on line 50</div>
				...
				<div style='padding:15px 15px 15px 76px; border:1px solid #ddd; border-top:0px; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>products imported sucsesfully but, only 500 prodcuts uploading if i upload more than that error<br />
!Opencart Error:Uploaded file is not a valid spreadsheet file or its values are not in the expected formats! where to change for max product uploads</div>
				...
				<div style='padding:15px 15px 15px 76px; border:1px solid #ddd; border-top:0px; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello Munafa,<br />
<br />
I'm sorry to hear about the error that you are receiving during your import.  The error message that you are having  is not related to a max limit on the import/export tool.  The error message indicates that there is something wrong with the data.  Again, as per our earlier messages, the error is occurring due to a mismatch in the data that is being imported. At least, that is what the current error indicates.  You may need to check the product data again to make sure it complies with the format required by the OpenCart tables.  Also, please be aware, that there are OTHER extensions that you an purchase for transferring your data.  This is an example of one:  <a href="http://opencart.hostjars.com/" target="new">Host Jars import solutions</a>.  Although this is a paid solution, I have been told that it also works better with higher numbers of product in your inventory.<br />
<br />
...
<div class='  not_best_answer'>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px; width:50px;' valign='top'>
<div class='vote_div'>
	<form method='post' name='upvote_answer_4083' id='upvote_answer_4083' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='4083' />
		<input type='hidden' name='component' id='component' value='qa' />
		<input type='hidden' name='vote_value' id='vote_value' value='1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_4083').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_4083' id='downvote_answer_4083' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='4083' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_4083').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					<img src='https://lh3.googleusercontent.com/-XdUIqdMkCWA/AAAAAAAAAAI/AAAAAAAAAAA/4252rscbv5M/photo.jpg?sz=90' class='user_avatar' style='max-width:60px;' /><br />
                		        <a href='/support/community-support/users/mavisko'>mavisko</a>
					
					<div>10 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2013-10-09 2:19 am EST
                		        </div>
					
		                </div>

				Hi. I had the same error. Data image must only use alphabet and number. Remove those which contain other than alphabet and number. That solved mine.
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_4083').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_4083' id='form_comment_on_answer_4083' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
					                <p>You must <a href='/support/login'>login</a> before you can post a comment about this answer.</p>
					        </div></div></div></div>
					</form>
...
<div class='  not_best_answer'>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px; width:50px;' valign='top'>
<div class='vote_div'>
	<form method='post' name='upvote_answer_6669' id='upvote_answer_6669' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='6669' />
		<input type='hidden' name='component' id='component' value='qa' />
		<input type='hidden' name='vote_value' id='vote_value' value='1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_6669').submit();"></div>
	</form>
	<div class='vote_sum'>1</div>
	<form method='post' name='downvote_answer_6669' id='downvote_answer_6669' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='6669' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_6669').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					<img src='http://graph.facebook.com/minh.chau.963/picture?type=normal' class='user_avatar' style='max-width:60px;' /><br />
                		        <a href='/support/community-support/users/kuminh'>kuminh</a>
					
					<div>20 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2015-03-04 3:54 am EST
                		        </div>
					
		                </div>

				I had a same problem like you. And I found the issue, that is data not match table in XLSX file. <br />
Example:  &quot;Price column&quot; -&gt; If   <br />
<br />
 
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_6669').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_6669' id='form_comment_on_answer_6669' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
					                <p>You must <a href='/support/login'>login</a> before you can post a comment about this answer.</p>
					        </div></div></div></div>
					</form>
...
<div class='  not_best_answer'>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px; width:50px;' valign='top'>
<div class='vote_div'>
	<form method='post' name='upvote_answer_6670' id='upvote_answer_6670' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='6670' />
		<input type='hidden' name='component' id='component' value='qa' />
		<input type='hidden' name='vote_value' id='vote_value' value='1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_6670').submit();"></div>
	</form>
	<div class='vote_sum'>1</div>
	<form method='post' name='downvote_answer_6670' id='downvote_answer_6670' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='6670' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_6670').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>20 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2015-03-04 3:59 am EST
                		        </div>
					
		                </div>

				I had the problem like you that is data not match with data table in XLSX file. <br />
Example: &quot;Price column&quot; -&gt; If Price = 0, I must enter &quot;0&quot; but my partner enter &quot;blank&quot; -&gt; This is a problem that I can not import XLSX file in Opencart.  <br />
Thanks and hope my answer will help you.    
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_6670').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_6670' id='form_comment_on_answer_6670' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
					                <p>You must <a href='/support/login'>login</a> before you can post a comment about this answer.</p>
					        </div></div></div></div>
					</form>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/opencart/im-using-bulk-export-import-extension-in-opencart-export-is-working-well-butwhen-import-file-erroruploaded-file-is-not-a-valid-spreadsheet-file-or-its-values-are-not-in-the-expected-formats&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/opencart/im-using-bulk-export-import-extension-in-opencart-export-is-working-well-butwhen-import-file-erroruploaded-file-is-not-a-valid-spreadsheet-file-or-its-values-are-not-in-the-expected-formats'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="533eb89921f0b83adbdb371a721aca7f" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
                                ...
                                <h3>Related Articles</h3><a target='_blank' href='http://inmotionhosting.com/support/free-cloudflare-opencart-ssl'>Using Free Cloudflare for SSL on OpenCart 1.5</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/create-discounts-specials'>348: Creating discounts and specials for your products in OpenCart 1.5</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/347-email-alerts'>347: Enabling email alerts within OpenCart 1.5</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/346-add-admin-via-db'>346: How to add an Admin account in OpenCart 1.5 via MySQL</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/345-common-maintenance-error'>345: "Error: Could not load language common/maintenance!" in OpenCart 1.5</a><br/><br />
		</div>
