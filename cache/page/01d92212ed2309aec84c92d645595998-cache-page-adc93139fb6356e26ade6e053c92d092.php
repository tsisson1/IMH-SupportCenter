<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:64854:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/prestashop-15/advanced-stock-management/instant-stock-status" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-10-17T19:50:41-07:00" />
  <meta name="keywords" content="inventory management instant stock status PrestaShop 1.5 report view" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="In this PrestaShop 1.5 article, you will learn about the details of the Instant Stock Status report." />
  <title>Working with the Instant Stock Status View in PrestaShop 1.5 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/prestashop-15/advanced-stock-management/instant-stock-status" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:1c4315e6bdf6219f832016e438bb9c7f -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Working with the Instant Stock Status View in PrestaShop 1.5									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>1,988</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Oct 17, 2012'><span style='color:#606060;'>Published:</span> Oct 17, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Our last article described the details of the <a href="/support/edu/prestashop-15/advanced-stock-management/view-stock-movement">Stock Movement</a> report view. This next article in the <a href="/support/edu/prestashop-15/advanced-stock-management">Advanced Stock Management</a> course goes into detail on the <em>Instant Stock Status</em> report. This report gives you a snapshot of all inventory and its value which can help make for more efficient inventory management. Below is a guide to help you understand the data in the report.</p>
<div class="alert">In order to view the <em>Instant Stock Status</em> report the <a href="/support/edu/prestashop-15/advanced-stock-management/enable-advanced-stock-management">Advanced Stock Management</a> option must be enabled.</div>
<p><strong>Viewing and understanding Instant Stock Status in PrestaShop 1.5</strong></p>
<ol class="article_list">
<li><a href="/support/edu/prestashop-15/getting-started/login-to-dashboard"> Log into your PrestaShop 1.5 dashboard</a>.</li>
<li>Using the top menu bar, hover over the <strong>Stock</strong> tab and click on the <strong>Instant Stock Managment</strong> option from the menu.</li>
<li>This brings you to the <em>Instant Stock Status </em>page. The table in the center of the page lists all products that you have for your store. You can filter the list by warehouse by using the <strong>Filter By Warehouse</strong> dropdown. If you select one warehouse using that method, two export options appear in the upper right as a buttons named <strong>Export Quantities (CSV)</strong> and <strong>Export Prices (CSV)</strong>. These are for downloading the respective information in a comma separated value format.<br /><br /> As you can see in the screenshot below, you can expand each product to show more details by clicking on the plus icon found on the right hand side of the row for each product. For this example, we have expanded the Macbook item. Below is an explanation of the fields and data shown in the report.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Stock/Instant_Stock_Status/instant-stock-status.png"><img  alt="instant-stock-status" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Stock/Instant_Stock_Status/instant-stock-status.png" /></a><br />
<table class="article_table">
<tbody>
<tr><th>Reference</th>
<td>Optional internal reference used as a unique identifier. This can be either a number or text.</td>
</tr>
<tr><th>EAN13</th>
<td>A bar code number used internationally.</td>
</tr>
<tr><th>UPC</th>
<td>A bar code number primarily used in America, the UK, new Zealand and Australia.</td>
</tr>
<tr><th>Name</th>
<td>The common name of the product.</td>
</tr>
<tr><th>Price (tax excl)</th>
<td>The price of the unit (wholesale or manufacturing cost) excluding tax.</td>
</tr>
<tr><th>Valuation</th>
<td>Value of the entire inventory stock of that product.</td>
</tr>
<tr><th>Physical Quantity</th>
<td>Amount of stock that is physically on hand.</td>
</tr>
<tr><th>Usable Quantity</th>
<td>Number of units that are avaialble for sale (minus any outstanding orders or units tagged for other uses)</td>
</tr>
<tr><th>Real Quantity</th>
<td>Numberof units actually physically available in the warehouse.</td>
</tr>
<tr><th>Actions</th>
<td scope="col" align="left" valign="middle">Clickable icon for expanding or collapsing details. (plus&nbsp;<img alt="plus" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Stock/Instant_Stock_Status/plus.png" style="margin-top: 0px;" /> or minus&nbsp;<img alt="minus" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Stock/Instant_Stock_Status/minus.png" style="margin-top: 0px;" /> icon)</td>
</tr>
</tbody>
</table>
<br />This concludes the explanation of the <em>Instant Stock Status</em> report. Be sure to continue with our course by checking out ournext article on Stock Coverage.</li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/prestashop-15/advanced-stock-management'>118: Advanced Stock Management</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 9: Working with the Instant Stock Status View in PrestaShop 1.5</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 8: <a href='/support/edu/prestashop-15/advanced-stock-management/view-stock-movement'>Understanding the Stock Movement View in PrestaShop 1.5</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 10: <a href='/support/edu/prestashop-15/advanced-stock-management/stock-coverage'>Working with the Stock Coverage View in PrestaShop 1.5</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/prestashop-15/advanced-stock-management/instant-stock-status&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/prestashop-15/advanced-stock-management/instant-stock-status'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP3RzcmM9cnNiZWR1Jm9wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNzkmaWQ9MTg4MiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="d5d80a11ec40bdbc43b462294eaeb8b2" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/prestashop-15/advanced-stock-management?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Advanced Stock Management</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/prestashop-15/advanced-stock-management/enable-advanced-stock-management?tsrc=rsbedu'>Enabling Advanced Stock Management in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/prestashop-15/advanced-stock-management/add-new-warehouse?tsrc=rsbedu'>Adding a new Warehouse in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/prestashop-15/advanced-stock-management/edit-view-delete-warehouse?tsrc=rsbedu'>Managing a Warehouse in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/prestashop-15/advanced-stock-management/add-product-to-warehouse?tsrc=rsbedu'>How to add a product to a warehouse in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/prestashop-15/advanced-stock-management/add-product-stock-mgt?tsrc=rsbedu'>Adding stock for warehouses in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/prestashop-15/advanced-stock-management/remove-warehouse-stock?tsrc=rsbedu'>How to remove stock from warehouses in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>7.</td>
                        <td><a href='/support/edu/prestashop-15/advanced-stock-management/transfer-warehouses?tsrc=rsbedu'>Transferring Stock between warehouses in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>8.</td>
                        <td><a href='/support/edu/prestashop-15/advanced-stock-management/view-stock-movement?tsrc=rsbedu'>Understanding the Stock Movement View in PrestaShop 1.5</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>9.</td>
                        <td><a href='/support/edu/prestashop-15/advanced-stock-management/instant-stock-status?tsrc=rsbedu'>Working with the Instant Stock Status View in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>10.</td>
                        <td><a href='/support/edu/prestashop-15/advanced-stock-management/stock-coverage?tsrc=rsbedu'>Working with the Stock Coverage View in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>11.</td>
                        <td><a href='/support/edu/prestashop-15/advanced-stock-management/configure-supply-order-status?tsrc=rsbedu'>Configuring supply order statuses in PrestaShop 1.5</a></td>
                </tr>
          	</table>
