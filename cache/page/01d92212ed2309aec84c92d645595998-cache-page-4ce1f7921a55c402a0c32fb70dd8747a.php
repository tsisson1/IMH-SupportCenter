<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:70601:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotion.net/support/website/wordpress/create-secure-wordpress-admin-password" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-03-11T21:11:12-07:00" />
  <meta name="keywords" content="wordpress change update admin password secure attack brute force" />
  <meta name="author" content="Jacob Nicholson" />
  <meta name="description" content="In this article I'll show you how to generate a strong password to use for your WordPress site, and how to update WordPress to start using that newer more secure password as well." />
  <title>Create secure WordPress admin password - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/wordpress/create-secure-wordpress-admin-password" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:b31a70156a6e2b3dc7e99f5d935a79ca -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Create secure WordPress admin password									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>10,341</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Apr 15, 2013'><span style='color:#606060;'>Published:</span> Mar 11, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In this article I'll show you how to generate a strong password to use for your WordPress site, and how to update WordPress to start using that newer more secure password as well.</p>

<div style="background-color: #FAFAD2; border: 1px #D3D3D3 dashed; border-radius: 5px; padding: 0px 0px 0px 5px;">
<p>These actions are being strongly recommended due to a recent <a href="/support/news/general/wp-login-brute-force-attack" target="_blank">WordPress wp-login brute force attack</a> that has been ongoing affecting multiple web hosts.</p>
</div>

<h2>Generate secure admin password and apply with phpMyAdmin</h2>

<p>The following steps will walk you through logging into cPanel, using the built-in password generator to create a new strong secure password, and then applying that new password to your WordPress admin login directly via phpMyAdmin.</p>

<a name="generate-password"></a>
<p>Below these steps, there are also instructions for <a href="http://www.inmotionhosting.com/support/website/wordpress/create-secure-wordpress-admin-password#via-dashboard">updating your WordPress admin password via admin dashboard</a>

<ol class="article_list">
  <li><a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel" target="_blank">Login to cPanel.</a></li>
  
  <li style="clear: both;"><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/website/wordpress/update-password/click-on-change-password.png"><img  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/website/wordpress/update-password/click-on-change-password.png" alt="click on change password" /></a>Under the <strong>Administration &amp; Help</strong> section, click on <strong>Change Password</strong>.</li>
  
  <li style="clear: both;"><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/website/wordpress/update-password/click-on-password-generator.png"><img  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/website/wordpress/update-password/click-on-password-generator.png" alt="click on password generator" /></a>Next click on <strong>Password Generator</strong>.</li>
  
  <li style="clear: both;"><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/website/wordpress/update-password/click-generate-password-a-few-times.png"><img  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/website/wordpress/update-password/click-generate-password-a-few-times.png" alt="click generate password a few times" /></a>Now click on <strong>Generate Password</strong> a few times till you get a password you like.</li>
  
  <li style="clear: both;"><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/website/wordpress/update-password/click-on-advanced-options.png"><img  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/website/wordpress/update-password/click-on-advanced-options.png" alt="click on advanced options" /></a>You can also click on <strong>Advanced Options</strong> to control how your password is generated.</li>
  
  <li style="clear: both;"><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/website/wordpress/update-password/copy-password.png"><img  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/website/wordpress/update-password/copy-password.png" alt="copy password" /></a>Highlight the password and press <strong>Ctrl -C</strong> to copy the password.</li>
  
  <li style="clear: both;"><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/website/wordpress/update-password/click-on-cancel.png"><img  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/website/wordpress/update-password/click-on-cancel.png" alt="click on cancel" /></a>Then click on <strong>Cancel</strong>.</li>
  
  <li style="clear: both;"><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/website/wordpress/update-password/click-on-cpanel-home.png"><img  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/website/wordpress/update-password/click-on-cpanel-home.png" alt="click on cpanel home" /></a>Click on <strong>Home</strong> up at the top-right.</li>
  
  <li style="clear: both;"><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/website/wordpress/update-password/click-on-phpmyadmin.png"><img  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/website/wordpress/update-password/click-on-phpmyadmin.png" alt="click on phpmyadmin" /></a>Under the <strong>Databases</strong> section, click on <strong>phpMyAdmin</strong>.</li>
  
<li style="clear: both;"><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/website/wordpress/update-password/click-on-wordpress-database.png"><img  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/website/wordpress/update-password/click-on-wordpress-database.png" alt="click on wordpress database" /></a>Click on the name of your WordPress database.</li>
  
  <li style="clear: both;"><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/website/wordpress/update-password/click-on-wp-users-table.png"><img  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/website/wordpress/update-password/click-on-wp-users-table.png" alt="click on wp users table" /></a>Next click on the <strong>wp_users</strong> table.</li>
  
  <li style="clear: both;"><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/website/wordpress/update-password/click-on-edit-wp-user.png"><img  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/website/wordpress/update-password/click-on-edit-wp-user.png" alt="click on edit wp user" /></a>Click on <strong>Edit</strong> beside your WordPress admin user.</li>
  
  <li style="clear: both;"><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/website/wordpress/update-password/paste-password-select-md5-click-go.png"><img  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/website/wordpress/update-password/paste-password-select-md5-click-go.png" alt="paste password select md5 click go" /></a>In the <strong>user_pass</strong> field, paste your password by pressing <strong>Ctrl - V</strong>.<p>From the drop-down, select <strong>MD5</strong>.</p>
    <p>Finally click on <strong>Go</strong>.</p>
  </li>
  
<li style="clear: both;"><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/website/wordpress/update-password/phpmyadmin-success-of-password-change.png"><img  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/website/wordpress/update-password/phpmyadmin-success-of-password-change.png" alt="phpmyadmin success of password change" /></a>You should now see a success message from phpMyAdmin saying the database record was updated.</li>
  
</ol>

<a name="via-dashboard"></a>
<h2>Update WordPress admin password via dashboard</h2>

    <p>If you already know how to create a very secure password, or you've <a href="http://www.inmotionhosting.com/support/website/wordpress/create-secure-wordpress-admin-password#generate-password">generated one</a> using the steps above, you can also update your WordPress admin password directly in the admin dashboard. Just follow these steps and you should have your password updated and secured in no time:</p>

<ol class="article_list">

<li><a href="/support/edu/wordpress/wordpress-introduction/logging-into-wordpress-dashboard" target="_blank">Login to your WordPress dashboard</a> with your insecure password.</li>

<li style="clear: both;"><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/website/wordpress/update-password/wordpress-click-on-users.png"><img  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/website/wordpress/update-password/wordpress-click-on-users.png" alt="wordpress click on users" /></a>From the left hand menu, click on <strong>Users</strong>.</li>

<li style="clear: both;"><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/website/wordpress/update-password/wordpress-click-on-edit.png"><img  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/website/wordpress/update-password/wordpress-click-on-edit.png" alt="wordpress click on edit" /></a>Hover over your admin user, then click on <strong>Edit</strong></li>

<li style="clear: both;"><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/website/wordpress/update-password/wordpress-fill-out-password-click-update-profile.png"><img  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/website/wordpress/update-password/wordpress-fill-out-password-click-update-profile.png" alt="wordpress fill out password click update profile" /></a>Scroll to the very bottom, fill out your new secure password twice, then click on <strong>Update Profile</strong>.</li>

<li style="clear: both;"><img style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/website/wordpress/update-password/wordpress-profile-updated-successfully.png" alt="wordpress profile updated successfully" />You should now see that your admin profile has been updated:</li>
...
<p>You should now understand how to update your WordPress admin password, this should help ensure that your website doesn't become compromised from the recent increase in brute force attack attempts.</p>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotion.net/support/website/wordpress/create-secure-wordpress-admin-password&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotion.net/support/website/wordpress/create-secure-wordpress-admin-password'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD02MyZpZD0yNjExJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="242b126f58c621532f5a35b855d61d2e" value="1" />	</div>
	</form>
<!-- <br />
