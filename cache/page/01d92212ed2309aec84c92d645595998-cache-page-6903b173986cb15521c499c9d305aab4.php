<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:52680:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/email/sending-mail-with-windows-live-mail-security-certificate-issue" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Chuck, Thanks for the question about the security certificate not being able to be verified. The main issue here is that the security certificates..." />
  <title>Sending mail with Windows Live Mail - Security Certificate Issue | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/email/sending-mail-with-windows-live-mail-security-certificate-issue" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:e1e611d9faa1e3c70c3e70012d108334 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-20']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '78.151.249.85']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Sending mail with Windows Live Mail - Security Certificate Issue</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/cdarney3'>cdarney3</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-05-10 7:25 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>2,049</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>When I send mail out of Windows Live Mail I get the following message:<br />
<br />
The server you are connected to is using a security certificate that could not be verified.<br />
The certificate's CN name does not match the passed value.<br />
Do you want to continue using this server.<br />
<br />
It continues sending the mail  if I say yes.  Am I specifying security I don't need?<br />
<br />
...Chuck<br />
<br />
</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_7213' id='upvote_answer_7213' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='7213' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_7213').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_7213' id='downvote_answer_7213' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='7213' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_7213').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Chuck,<br />
<br />
Thanks for the question about the security certificate not being able to be verified.  The main issue here is that the security certificates used by the hosting server for your type of account does NOT match your domain name.  It's using something like <i>ecbiz111.inmotionhosting.com</i>, because that's the name of the server.  The browser can't figure this out, so it balks trying verify something that looks NOTHING like your probably domain name.  However, the certificates for these servers are definitely valid.  If you want to see an example of this described in a tutorial, check out <a href="http://www.inmotionhosting.com/support/email/mac-mail/mail-cant-verify-the-identity-of">Mac Mail Error - Mail can't verify the identity of "mail.domain.com"</a>.  You can still validate the certificate after ignoring the error.  If you want to be sure of a certificate, try using the <a href="https://www.sslshopper.com/ssl-checker.html">SSL Shopper - SSL checker</a> - just type in the domain name of the server and you'll see if the certificate is valid.  <br />
<br />
...
Arnel C.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_7213').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_7213' id='form_comment_on_answer_7213' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
...
<br />
You can also ADD the certificate so you don't repeatedly get that message.  Here's some instructions I found from a <a href="http://answers.microsoft.com/en-us/windowslive/forum/livemail-wlsettings/getting-warning-about-untrusted-certificate-when/bec7b5c6-1d6a-4c89-bbdd-7b69ca0b7e7c" rel="nofollow" target="_blank">post </a>on the Microsoft support forums: <br />
<br />
 <ol><br />
<li>Sign in to Windows Live Mail.</li><br />
<li>Press Alt + F + O + S simultaneously on your keyboard and you will be re-directed to Safety Options on your Windows Live Mail.</li><br />
<li>Click on Security Tab.</li><br />
<li>Under Secure Mail, click Digital ID.</li><br />
<li>Click Import.</li><br />
<li>A Certificate Import Wizard will appear and click Next.</li><br />
<li>Click on Browse to locate the certicate the double click on it.</li><br />
<li>Click Next.</li><br />
<li>Select Place all certificates in the following store and make sure that you Personal is selected. If not, click Browse then select Personal then click OK.</li><br />
...
Arnel C.<br />
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/email/sending-mail-with-windows-live-mail-security-certificate-issue&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/email/sending-mail-with-windows-live-mail-security-certificate-issue'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="7988ae280a2b6c2fb2714c877af1be1e" value="1" />	</div>
	</form>
<!-- <br />
