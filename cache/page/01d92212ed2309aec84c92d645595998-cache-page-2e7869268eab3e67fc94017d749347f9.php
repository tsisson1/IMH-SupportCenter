<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:51702:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/fighting-spam/how-do-i-change-my-full-name-as-it-is-listed-in-the-whois-directory" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Briana, Thank you for your question on changing the name in the WHOIS information for your domain. The field youa re referring to is the &quot;Registra..." />
  <title>How do I change my full name as it is listed in the whois directory? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/fighting-spam/how-do-i-change-my-full-name-as-it-is-listed-in-the-whois-directory" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:17b89b5d6be6a52814d3687d62065f37 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>How do I change my full name as it is listed in the whois directory?</h1>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_8601' id='upvote_answer_8601' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='8601' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_8601').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_8601' id='downvote_answer_8601' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='8601' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_8601').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Briana,<br />
<br />
Thank you for your question on changing the name in the WHOIS information for your domain. The field youa re referring to is the "Registrant", which is the only field you are unable to change.  Unlike all other fields, the Registrant field is not supposed to change unless ownership changes. It is the name of the owner of the domain. Because of this, it is required that the name of the owner be legitimate. It can be either a person or a company name, but it must be factual. If you change the name to someone else, they are considered the owner of the domain name. Using false information here places you in the same realm as the hackers, which do the same thing. <br />
<br />
Some registrar or hosting companies will allow you to use their name as the registrant, but that means they legally own the domain name and you rely on their graces to return ownership to you if you decide to ever move the domain name. We do not do that so we can avoid any ownership issues.<br />
<br />
If you have a company name or another person who does not mind having their name on the domain, we can certainly change that for you. You will need to contact <a href="http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support">Live Support</a> in order to have them carry out the request.<br />
<br />
If you decide to use a false name, remember that if ownership issues come up, you would not be able to prove you are that person, so proceed with caution here.<br />
<br />
Kindest Regards,<br />
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_8601').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_8601' id='form_comment_on_answer_8601' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/fighting-spam/how-do-i-change-my-full-name-as-it-is-listed-in-the-whois-directory&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/fighting-spam/how-do-i-change-my-full-name-as-it-is-listed-in-the-whois-directory'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="601ba5299aff20e91ae1a7c1b3eaa7f9" value="1" />	</div>
	</form>
<!-- <br />
