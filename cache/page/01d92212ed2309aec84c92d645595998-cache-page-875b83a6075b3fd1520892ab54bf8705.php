<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:64830:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-3/server-settings/change-email-settings" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-10-02T15:08:49-07:00" />
  <meta name="keywords" content="joomla 3.0 email settings" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="If Joomla 3.0 is not sending emails properly from your server, follow the steps on this page to change your settings." />
  <title>Changing Email Settings in Joomla 3.1 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-3/server-settings/change-email-settings" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:db604d14c73c75a6a5eda7dd4fdb6f48 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '190.194.156.168']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Changing Email Settings in Joomla 3.1									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>15,148</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Sep 5, 2012'><span style='color:#606060;'>Published:</span> Oct 2, 2012</div>
...
<li>Next to <em>Site</em> and <em>System</em>, click the <strong>Server</strong> tab towards the top of the page</li>
<li>Find the heading labeled <em>Mail Settings</em>. Fill in the appropriate details underneath, and then click the <strong>Save</strong> button in the top left of the page.<br /><br />Joomla 3.0 gives the following description for each email setting:<br /><br /> 
<table class="article_table">
<tbody>
<tr>
<th>Mailer</th>
<td>Select which mailer for the delivery of site email.</td>
</tr>
<tr>
<th>From email</th>
<td>The email address that will be used to send site email.</td>
</tr>
<tr>
<th>From Name</th>
<td>Text displayed in the header "From:" field when sending a site email. Usually the site name.</td>
</tr>
<tr>
<th>Sendmail Path</th>
<td>Enter the path to the sendmail program directory on the host server.</td>
</tr>
<tr>
<th>SMTP Authentication</th>
<td>Select Yes if your SMTP Host requires SMTP Authentication.</td>
</tr>
<tr>
<th>SMTP Security</th>
<td>Select the security model that your SMTP server uses.</td>
</tr>
<tr>
<th>SMTP Port</th>
<td>Enter the port number of your SMTP server. Use 25 for most unsecure servers and 465 for most secure servers.</td>
</tr>
<tr>
<th>SMTP Username</th>
<td>Enter the username for access to the SMTP host.</td>
</tr>
<tr>
<th>SMTP Password</th>
<td>Enter the password for the SMTP host</td>
</tr>
<tr>
<th>SMTP Host</th>
<td>Enter the name of the SMTP host.</td>
</tr>
</tbody>
</table>
<p>The above are generic steps for updating your email settings in Joomla 3.0. For a specific example, such as setting up email to use SMTP, please see our <a href="/support/edu/joomla-3/306-configure-smtp">Could not instantiate mail function</a> troubleshooter.</p>
</li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 8: Changing Email Settings in Joomla 3.1</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 7: <a href='/support/edu/joomla-3/server-settings/database-settings'>How to change Database Settings within Joomla 3.1</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-3/server-settings/change-email-settings&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-3/server-settings/change-email-settings'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNTgmaWQ9MTc0OCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<table><tr><td colspan='2'><h4>Server Settings</h4></td></tr>  <tr >
                        <td valign='top'>1.</td>
        ...
        <tr><td colspan='2'><h4>Mail Settings</h4></td></tr>  <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>8.</td>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/57596f07a4d3002fc0d2d1eb9e37cbc7?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/57596f07a4d3002fc0d2d1eb9e37cbc7'>Sumesh</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-23 12:48 am</div>
				                <div><p>while sending mails I see sender name as&nbsp;<span class="gD" style="font-size: 12.8px; font-weight: bold; white-space: nowrap; display: inline; vertical-align: top; color: #222222; font-family: arial, sans-serif;">Apache</span><span style="color: #222222; font-family: arial, sans-serif; font-size: 12.8px; white-space: nowrap;">&nbsp;</span><span class="go" style="vertical-align: top; color: #555555; font-family: arial, sans-serif; font-size: 12.8px; white-space: nowrap;">&lt;apache@localhost.localdomain&gt;</span></p>
<p><span class="go" style="vertical-align: top; color: #555555; font-family: arial, sans-serif; font-size: 12.8px; white-space: nowrap;">how to change that???</span></p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28646);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-23 11:28 am</div>
				                <div>It sounds like you need to change the "From Email" address to the email address you wish to send the emails from. </div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28665);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
