<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50688:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/ssl/cpanel-linux-user-privileges" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, Thanks for the question about require root access for installing Jboss. This software is typically installed using the binary files that you down..." />
  <title>cPanel linux user privileges? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/ssl/cpanel-linux-user-privileges" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:92a67a9e1f48a766ea53c795edbe154a -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>cPanel linux user privileges?</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-02-20 1:54 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>90</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I'm new, i receive VPS today.<br />
I need install jboss. cPanel user have enought privileges. Or I need root access?<br />
thanks<br />
<br />
</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_6578' id='upvote_answer_6578' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='6578' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_6578').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_6578' id='downvote_answer_6578' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='6578' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_6578').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
Thanks for the question about require root access for installing Jboss.  This software is typically installed using the binary files that you download.  You would require root access in order to do this.   Check out <a href="http://www.inmotionhosting.com/support/website/cpanel-account-management/obtain-root-access">What is root access and how can I obtain it?</a>  for further information about getting root access for your VPS.<br />
<br />
...
Arnel C.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_6578').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_6578' id='form_comment_on_answer_6578' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/ssl/cpanel-linux-user-privileges&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/ssl/cpanel-linux-user-privileges'></div>
<script type='text/javascript'>
  (function() {
