<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:54893:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/product-guides/reseller-hosting/transfer-emails" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-05-20T16:01:10-07:00" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Need to transfer emails from your old host to your InMotion reseller account? Find out how in this artiocle." />
  <title>How to Transfer Emails From Your Old Host to InMotion - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/product-guides/reseller-hosting/transfer-emails" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<script type="text/javascript">
		...
		_gaq.push(['_setCustomVar', 4, 'DateMonthPublished', '2016-02', 3]);
	...
	<!-- cid:bc17d0c43c4a6744b9ea1f2e7bda4412 -->
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/product-guides' itemprop='url'><span itemprop='title'>Product Guides<span></a><div class='dropdown_2columns'><div class='col_2'><div><a href='/support/product-guides/dedicated-hosting'>Dedicated Hosting</a> (57)</div><div><a href='/support/product-guides/reseller-hosting'>Reseller Hosting</a> (68)</div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/product-guides/reseller-hosting' itemprop='url'><span itemprop='title'>Reseller Hosting<span></a><div class='dropdown_3columns'><div class='col_3'><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/product-guides/reseller-hosting/whm-login'>How to Login to your Reseller WHM</a> (99 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/product-guides/reseller-hosting/what-is-it'>What is Reseller Hosting?</a> (98 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/product-guides/reseller-hosting/whmcs-general-settings-overview'>WHMCS General Settings Overview</a> (92 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/product-guides/reseller-hosting/create-package'>How to Create a Package in your Reseller WHM</a> (89 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/product-guides/reseller-hosting/transfer-old-emails'>How to Transfer Emails from your Old Host to your Reseller Account</a> (68 hits)</div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to Transfer Emails From Your Old Host to InMotion</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to Transfer Emails From Your Old Host to InMotion									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>14</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Feb 17, 2016'><span style='color:#606060;'>Published:</span> May 20, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<p>When you are setting up your new reseller account with us, you will most likely want to bring over your existing email accounts and any emails that exist on your old hosting server. This article will provide you instructions on how to move your emails from a non-cPanel host to InMotion Hosting.</p>

<h2>Moving your emails from your old host</h2>
<p>The steps involved will differ depending on whether you were using the IMAP or POP3 protocols to check your emails prior to the move. If you are unsure which protocol you were using, be sure to check the settings in the email client program you use. 
</p>
<p>You will also need to create the email accounts on your new InMotion Hosting server. If you need assistance with that, check out our article on how to create an email account in cPanel.</p>

<h3>POP3 Accounts</h3>
<p>If you use the POP3 protocol to check your emails, all the emails received are downloaded to the checking device, most commonly a computer. As the emails are already downloaded to your local machine, you will not have to take any further steps to transfer them to the new hosting server.
</p>

<h3>IMAP Accounts</h3>
<p>For those using IMAP, you will need to take steps necessary to move the emails from your old hosting server to your new reseller server. The instructions provided use the Thunderbird email client, but can be followed using other clients, such as Outlook or MacMail. 
</p>

<h2>Transferring the emails</h2>
<ol class="article_list">
  <li><a href="/support/edu/everything-email/introduction-email/create-an-email-account">Create the destination email account</a> on your InMotion server cPanel.<div style="clear:both;"></div></li>
  <li>Set up a new email account in your mail client to point to the new InMotion email account. You will need to use the server name instead of your domain name if your domain is still pointed to your old host.<div style="clear:both;"></div></li>
  <li>Ensure both email accounts are connected via your email client.<div style="clear:both;"></div></li>
  <li>Highlight all emails on the account you are moving from.<div style="clear:both;"></div></li>
  <li>Right click on the messges and select 'Copy To' and then select the Inbox you want to copy the emails over to (the new account.)<div style="clear:both;"></div></li>
  <li>The transfer will begin. You may see a progress message at the bottom of the email client.<div style="clear:both;"></div></li>
  <li>Once completed, click on the new Inbox so you can see the transferred emails.<div style="clear:both;"></div></li>
  <li>As a precaution, you can log directly into your webmail to verify that the emails were transferred to the server. This should match what you see in your email client.<div style="clear:both;"></div></li>
</ol>

<h2>How to ensure you do not lose any new emails after a name server change</h2>
<p>Once you have completed migrating your website to the new server, you will need to finalize it by updating your name servers to point to your InMotion Hosting server. The propagation time after pointing your domain to its new name servers can take up to 24 hours. During this time, you will want to make sure you do not lose any emails that may come your way. Below we outline two different ways to ensure you do not miss any important emails during this time. 
<ol>
  <li><a href="/support/edu/everything-email/email-features/set-up-email-forwarder">Create an email forwarder</a> at your old host that forwards to a third party email account (one that does not have your domain name, such as gmail, hotmail, etc.)</li>
<li>Check your email at your old host with a webmail interface. This will not require your domain name. You may need to contact the old host for the proper URL using the server name.</li>
</ol>
</p>

<h2>Change your MX records</h2>
<p>
If you happen to use third party companies for your email and do not need to use our servers for your email services, you will need to modify your MX records on our servers so that the third party email remains unaffected. It is best if you perform this within the cPanel before you point the domain to us, however be sure to do it as soon as possible afterwards if you did not do so.
</p>

<h2>Summary</h2>
<p>
  Using the instructions above that are relevant to your situation will allow you to transfer your emails over from your old host to your new <a hreef="http://www.inmotionhosting.com/reseller-hosting">InMotion reseller hosting account</a> without any headaches!
</p>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/product-guides/reseller-hosting/transfer-emails&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/product-guides/reseller-hosting/transfer-emails'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD01NTcmaWQ9Mzc3NSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="c4785e0f29e84d6728896afe0393b100" value="1" />	</div>
	</form>
<!-- <br />
