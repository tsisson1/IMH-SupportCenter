<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:44693:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/website-design/website-design-basics" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="keywords" content="introduction web design getting started" />
  <meta name="description" content="In this introductory course, you'll learn website design basics such as the how HTML tags are used and how to add style to your page." />
  <title>101: Website Design Basics | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/website-design/website-design-basics" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:1c3bcca16f44764d092880e9cb403a2a -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '2.51.190.248']);
...
<div class='page-header'>
	<h1>101: Website Design Basics</h1>
</div>
<div class='section_listing'>
		...
		<tr>
				...
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/website-design/website-design-basics/introduction-web-design'>Introduction to Web Design Basics</a>
					<div>Learn how about HTML and why it is so important when building your website. </div>
					<div class='smallgrey'>Hits: 23,594</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/website-design/website-design-basics/can-builder-meet-my-needs'>Can the Builder meet my website building needs?</a>
					<div>Article evaluates your expectations of the Plesk Premium Web Builder to see if it will meet your website building needs.</div>
					<div class='smallgrey'>Hits: 4,140</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/website-design/website-design-basics/basic-html-attributes'>HTML Attributes: Using attributes in HTML tags</a>
					<div>You can change the color in which text is displayed on your website. Learn how to style text using HTML.</div>
					<div class='smallgrey'>Hits: 3,943</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/website-design/website-design-basics/bullet-points-numbered-lists'>Bullet Points and Numbered Lists Explained</a>
					<div>In this education channel we will explain the differences between list types and how to use the HTML tags associated with them. </div>
					<div class='smallgrey'>Hits: 7,407</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/website-design/website-design-basics/comment-php-javascript-html-css-code'>How do I comment my HTML, CSS, JavaScript, and PHP code?</a>
					<div>This article will teach you how to comment your HTML, CSS, JavaScript, and PHP code.</div>
					<div class='smallgrey'>Hits: 23,236</div>
				</td>
			</tr>
			</table>
</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xMTkmaWQ9MTE5JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="1ceae48be9eedf8537939ae9e3f30017" value="1" />	</div>
	</form>
<!-- <br />
