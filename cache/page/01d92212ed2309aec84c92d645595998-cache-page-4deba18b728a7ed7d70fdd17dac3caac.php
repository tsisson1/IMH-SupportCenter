<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:57225:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/opencart/310-installing-vqmod-manager" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-01-18T16:47:39-08:00" />
  <meta name="keywords" content="vqmod manager module opencart" />
  <meta name="author" content="Tim Sisson" />
  <meta name="description" content="Learn how to install vQmod Manager so you can manage all of the vQmod scripts from your OpenCart dashboard. " />
  <title>310: Installing vQmod Manager - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/opencart/310-installing-vqmod-manager" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:bc0375aeef702e4e66fbee918372beb9 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '176.106.204.3']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															310: Installing vQmod Manager									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>9,170</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 18, 2012'><span style='color:#606060;'>Published:</span> Jan 18, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Many modules for OpenCart are written using the vQmod script. If you are not familiar with vQmod or have not installed it yet, please see our guide on<a href="/support/edu/opencart/308-installing-vqmod-on-opencart"> installing vQmod</a>. vQmod manager allows you to manage all the vQmod scripts you currently are using in OpenCart through your dashboard. This module allows you to see all the scripts, any errors caused, and all of the vQmod cache files. You can even upload new vQmod scripts through vQmod manager.</p>
<ol>
<li><a href="http://www.opencart.com/index.php?route=extension/extension/info&amp;extension_id=2969&amp;filter_search=vqmod%20manager&amp;sort=e.date_modified&amp;order=DESC">Download the vQmod manager module</a></li>
<li>Extract the files and upload the contents of the upload folder (not the folder itself) to the root directory of your store</li>
<li>Go to <strong>System &gt; Users &gt; User Groups</strong></li>
<li>Select “<strong>Edit</strong>” for the “<strong>Top Administrators</strong>” </li>
<li>Check the <strong>module/ vqmod_manager</strong> for Access Permission and Modify Permission</li>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/opencart/opencart_vqmod_manager1.jpg"><img src="//cdn.inmotionhosting.com/support/images/stories/opencart/opencart_vqmod_manager1.jpg" alt="opencart_vqmod_manager1"  /></a></p>
<li>Click “<strong>Save</strong>”</li>
<li>Go to <strong>Extensions &gt; Modules</strong></li>
<li>Under the VQMod Manager select “<strong>Install</strong>” and then “<strong>Edit</strong>”</li>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/opencart/opencart_vqmod_manager2.jpg"><img src="//cdn.inmotionhosting.com/support/images/stories/opencart/opencart_vqmod_manager2.jpg" alt="opencart_vqmod_manager2"  /></a></p>
<li>Press the “<strong>Save</strong>” button in the upper right corner to complete the installation</li>
</ol>
<p>Now, you can begin managing your vQMod scripts by accessing the VQMod Manager directly through <strong>Extensions &gt; VQMod Manager</strong></p>
<p><strong><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/opencart/opencart_vqmod_manager3.jpg"><img  alt="opencart_vqmod_manager3" src="//cdn.inmotionhosting.com/support/images/stories/opencart/opencart_vqmod_manager3.jpg" /></a><br /></strong></p>
<p>If you need further assistance please feel free to <a href="/support/support/community-support/">ask a question on our support center website</a>.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 37: 310: Installing vQmod Manager</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 36: <a href='/support/edu/opencart/301-creating-coupon-codes-in-opencart'>301: Creating coupon codes in OpenCart 1.5</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 38: <a href='/support/edu/opencart/312-what-version-of-opencart-am-i-running'>312: What version of OpenCart am I running?</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD04OCZpZD0yMzQxJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="da8a08dbeef1175d49b474da7b4d19da" value="1" />	</div>
	</form>
<!-- <br />
...
<a name='comments'></a>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/7b1df5c4e0903035199469b0efa7097e?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/7b1df5c4e0903035199469b0efa7097e'>Robert Green</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-04 7:19 pm</div>
				                <div><p>Great Article!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8771);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-8869'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/1767d1f855c40aafc8f1fcd26df4edba?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/1767d1f855c40aafc8f1fcd26df4edba'>Oishi</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-10 6:09 am</div>
				                <div><p>Works like a charm. Thanks so much, guys!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8869);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
