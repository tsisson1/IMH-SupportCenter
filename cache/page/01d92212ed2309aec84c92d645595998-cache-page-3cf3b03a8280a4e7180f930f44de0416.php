<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:80991:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-25/create-template/jfactory-get-application" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-04-15T17:05:44-07:00" />
  ...
  <link href="http://www.inmotionhosting.com/support/edu/joomla-25/create-template/jfactory-get-application" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:04f69e5b40640d1f194d1a108519fd0c -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '115.124.79.30']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Joomla 2.5 Templates - JFactory::getApplication()									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>29,424</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jul 12, 2012'><span style='color:#606060;'>Published:</span> Apr 15, 2016</div>
...
<p>According to <a href="http://docs.joomla.org/JFactory_Class">official documentation</a>, there are many other objects that you can call.</p>
<p> </p>
...
<p class="code_block">$app&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; = JFactory::getApplication();<br /><span style="color: #ff0000;">echo "&lt;pre&gt;"; print_r($app); echo "&lt;/pre&gt;"; die();</span></p>
...
<tbody>
<tr>
<th>Actual Data in $app variable</th> <th>Screenshot of our testing code</th>
</tr>
<tr>
<td>
<pre class="code_block" style="max-width: 300px; max-height: 300px; overflow: auto;">JSite Object
(
...
<td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/create-template/data-in-app-variable.gif"><img style="max-width: 240px;"  alt="data-in-app-variable" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/create-template/data-in-app-variable.gif" /></a></td>
</tr>
</tbody>
</table>
<p> </p>
...
(
    [data:protected] =&gt; stdClass Object
        (
            [wrapperSmall] =&gt; 53
            [wrapperLarge] =&gt; 72
            [<span style="color: #ff0000;">logo</span>] =&gt; images/joomla_black.gif
            [sitetitle] =&gt; Joomla!
            [sitedescription] =&gt; Open Source Content Management
            [<span style="color: #ff0000;">navposition</span>] =&gt; left
            [<span style="color: #ff0000;">templatecolor</span>] =&gt; personal
        )
...
$color              = $this-&gt;params-&gt;get('<span style="color: #ff0000;">templatecolor</span>');
$logo               = $this-&gt;params-&gt;get('<span style="color: #ff0000;">logo</span>');
$navposition        = $this-&gt;params-&gt;get('<span style="color: #ff0000;">navposition</span>');
</pre>
<p>In the end, the $templateparams variable is ultimately used in the following context:</p>
<ol class="code_block">
<li>$templateparams-&gt;get('sitetitle')</li>
<li>$templateparams-&gt;get('sitedescription')</li>
</ol>
<p> </p>
...
<ol>
<li style="margin-bottom: 5px;">JFactory::getApplication was used to create the $app variable:<br /><br /><span class="code_block">$app                = JFactory::getApplication();</span></li>
<li style="margin-bottom: 5px;">The $app variable was then used to create the $templateparams variable:<br /><br /><span class="code_block">$templateparams     = $app-&gt;getTemplate(true)-&gt;params;</span></li>
<li>Finally, $templateparams is used to get the following values:<br /><br /><span class="code_block">$templateparams-&gt;get('sitetitle')</span><br /><br />and...<br /><br /><span class="code_block">$templateparams-&gt;get('sitedescription')</span><br /><br /><br />So, in the end it appears that getApplication is used to get the <strong>site's title</strong> and the <strong>site's description</strong>:<br /><br /> 
<table class="article_table">
<tbody>
<tr>
<th>Test code to see the value of sitetitle and sitedescription</th> <th>What are the values of sitetitle and sitedescription?</th>
</tr>
<tr>
<td>
<pre style="max-width: 280px; max-height: 300px; overflow: auto;" class="code_block"><span style="color: #ff0000;">$app                = JFactory::getApplication();</span>
$doc        = JFactory::getDocument();
<span style="color: #ff0000;">$templateparams     = $app-&gt;getTemplate(true)-&gt;params;
<strong>echo "  </strong></span><strong><span style="color: #ff0000;">                templateparams-&gt;get('sitetitle') = " . $templateparams-&gt;get('sitetitle') . "
                templateparams-&gt;get('sitedescription') = " . $templateparams-&gt;get('sitedescription') . "
        </span></strong>
<strong><span style="color: #ff0000;"> "; die();</span></strong></pre>
</td>
<td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/create-template/values-taken-from-templateparams.gif"><img style="max-width: 240px;"  alt="values-taken-from-templateparams" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/create-template/values-taken-from-templateparams.gif" /></a></td>
</tr>
<tr>
<th>Where are these values used within the template?</th> <th>Where are these values defined?</th>
</tr>
<tr>
<td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/create-template/sitetitle-and-sitedescription-in-the-template.gif"><img  alt="sitetitle-and-sitedescription-in-the-template" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/create-template/sitetitle-and-sitedescription-in-the-template.gif" style="max-width: 240px;" /></a></td>
<td>Where are these values defined? That's a really good question! After further research, they do not appear to be set anywhere within the Global Configuration settings, anywhere within the configuration.php file, nor do they appear to be anywhere within the site's language files. They are actually set in the template's configuration (which means they're stored in the database), as seen in the screenshot below:<br /><br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/create-template/sitetitle-and-sitedescription-in-template-config.gif"><img style="max-width: 240px;"  alt="sitetitle-and-sitedescription-in-template-config" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/create-template/sitetitle-and-sitedescription-in-template-config.gif" /></a>&nbsp;</td>
</tr>
</tbody>
</table>
</li>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 5: Joomla 2.5 Templates - JFactory::getApplication()</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 4: <a href='/support/edu/joomla-25/create-template/this-params-get'>Joomla 2.5 Templates - $this->params->get('templatecolor');</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 6: <a href='/support/edu/joomla-25/create-template/jfactory-get-document'>Joomla 2.5 Templates - JFactory::getDocument()</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-25/create-template/jfactory-get-application&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-25/create-template/jfactory-get-application'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yMjQmaWQ9MTU2NyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="358260b426287f46132181aec75f0317" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/5bcfd5d568cfd36d553dd6dbdb759157?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/5bcfd5d568cfd36d553dd6dbdb759157'>webnoos</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-05-19 4:34 pm</div>
				                <div><p>thanks.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23548);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
