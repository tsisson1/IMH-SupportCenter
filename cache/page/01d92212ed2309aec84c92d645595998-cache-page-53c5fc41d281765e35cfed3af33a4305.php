<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:85006:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/wordpress-plugins/auto-posting-social-media" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-04-26T16:31:33-07:00" />
  <meta name="author" content="Jeff Matson" />
  <meta name="description" content="InMotion Hosting Support Center" />
  <title>How to Automatically Post WordPress Content to Social Media - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/wordpress-plugins/auto-posting-social-media" rel="canonical" />
...
<script>
  ...
  ga('send', 'pageview');
	...
	<!-- cid:778b9ddc5b3a0ea0e79351fbdfd3cbff -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '71.175.72.5']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to Automatically Post WordPress Content to Social Media</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to Automatically Post WordPress Content to Social Media									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>1,397</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Feb 10, 2014'><span style='color:#606060;'>Published:</span> Apr 26, 2016</div>
  ...
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('installing');">Installing Social Networks Auto Poster</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('connecting');">Connecting social media accounts</button>
</div>
<p>In this article, we will show you how to automatically post to all of your social media accounts using the NextScripts Social Networks Auto-Poster plugin.  This plugin is especially useful if you have a large number of social media profiles that you need to post content to each time a post is created.  Once complete, your WordPress site will automatically send all updated posts directly to your users' social media feeds.</p>
<a name="installing"></a>
<h2>Installing the NextScripts Social Networks Auto-Poster</h2>
<ol class="article_list">
<li><p>First, be sure that you are <a href="http://www.inmotionhosting.com/support/edu/wordpress/wordpress-introduction/logging-into-wordpress-dashboard">logged into your WordPress admin dashboard</a>.</p></li>
<li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/social-networks-auto-poster-1.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/social-networks-auto-poster-1.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>Now that you are logged into your WordPress admin dashboard, hover over <strong>Plugins</strong>, then click on <strong>Add New</strong>.</p></li>
<li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/social-networks-auto-poster-2.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/social-networks-auto-poster-2.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>In the search box, enter <em>NextScripts Social Networks Auto-Poster</em>, and click <strong>Search Plugins</strong>.  You will then be presented with your search results.</p></li>
<li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/social-networks-auto-poster-3.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/social-networks-auto-poster-3.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>Within your search results, click on <strong>Install Now</strong>.  WordPress will then automatically handle the download and installation of the NextScripts Social Networks Auto-Poster plugin.  Once complete, be sure to click on <strong>Activate Plugin</strong> to ensure that it is active on your WordPress site.</p></li>
</ol>
<a name="connecting"></a>
<h2>Connecting your social media accounts</h2>
<p>Of course, this plugin wouldn't be any good without connecting your social media accounts.  In this section, we will teach you how to connect accounts to NextScripts Social Networks Auto-Poster plugin.  To view the instructions, click on the specific social media account that you want to configure.</p>
<div class="panel-group" id="accordion">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title">
                <a data-toggle="collapse" data-parent="#accordion" href="#twitter">Automatically posting to Twitter</a>
            </h3>
        </div>
        <div id="twitter" class="panel-collapse collapse">
            <div class="panel-body">
                <ol class="article_list">
                    <li style='clear:both;'><p>First, you will need to visit the <a href="https://apps.twitter.com/" target="_blank">Twitter developers website</a>, then click on <strong>Create New App</strong></p></li>
                    <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/social-networks-auto-poster-4.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/social-networks-auto-poster-4.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>Next, you will enter in the appropriate fields on this page:</p>
                        <ul class="article_list">
                            <li><p><strong>Name</strong>: The name of your app.  This is an identifying label that will be shown within any post tweet that you send out.  Be sure to label this something appropriate as your tweets will be labeled with something like "<em>via My Example App</em>".</p></li>
                            <li style='clear:both;'><p><strong>Description</strong>: This is a description that is typically shown on user-facing authorization screens.  As the only thing interacting with your Twitter account will be the WordPress plugin, you may enter anything you want here and it will not be seen by users, but a good description to identify it later if you need to is always a good idea.</p></li>
                            <li style='clear:both;'><p><strong>Website</strong>: Here, you will enter the URL to your WordPress site.  If your WordPress site is in a particular directory such as <em>http://example.com/blog</em>, be sure to adjust this accordingly.</p></li>
                            <li style='clear:both;'><p><strong>Callback URL</strong>: For our purposes of the plugin, this field may be left blank.</p></li>
                        </ul>
                    </li>
                    <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/social-networks-auto-poster-5.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/social-networks-auto-poster-5.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>Now that you have filled in the appropriate fields, scroll to the bottom and click on <strong>Yes, I agree</strong>, then click on <strong>Create your Twitter application</strong>.</p></li>
                    <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/social-networks-auto-poster-6.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/social-networks-auto-poster-6.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>As you have now created your Twitter application which will be used to post to Twitter, you'll need to modify a few of the default settings.  First, click on <strong>modify app permissions</strong>.  Then, select the option that says <strong>Read and Write</strong>, then click on <strong>Update settings</strong></p></li>
                    <li style='clear:both;'><p>Now, you will need to generate an access token to allow the auto-poster to connect to Twitter.  To do so, click on the <strong>API Keys</strong> then click on <strong>Create my access token</strong>.  After generating your access token, refresh your page to view it.</p></li>
                    <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/social-networks-auto-poster-7.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/social-networks-auto-poster-7.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>Back on your WordPress dashboard, hover over <strong>Settings</strong>, then click on <strong>Social Networks Auto Poster</strong>.  From here, click on <strong>Add new account</strong>.  Then, in the dropdown at the top, select <strong>Twitter</strong>.  You will now see several fields to enter information into.  Into these fields, enter the information such as your API key from the Twitter developer page.  Each entry can be found within the API Keys tab.</p></li>
                    <li style='clear:both;'><p>Once all of the information is entered, click <strong>Update Settings</strong>.</p></li>
                </ol>
            </div>
        </div>
    </div>
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title">
                <a data-toggle="collapse" data-parent="#accordion" href="#facebook">Automatically posting to Facebook</a>
            </h3>
        </div>
        <div id="facebook" class="panel-collapse collapse">
            <div class="panel-body">
                <ol class="article_list">
                    <li style='clear:both;'><p>First, you will need to log into your Facebook account.</p></li>
                    <li style='clear:both;'><p>From here, visit the <a href="https://developers.facebook.com/apps" target="_blank">Facebook Developers page</a>.</p></li>
                    <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/social-networks-auto-poster-8.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/social-networks-auto-poster-8.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>On the Facebook Developers site, click the green button that says <strong>Create a New App</strong>.</p></li>
                    <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/social-networks-auto-poster-9.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/social-networks-auto-poster-9.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>When you click the <em>Create a New App</em> button, you will see 3 items to enter.  Enter, your display name, a unique namespace for your app if you want something custom, and choose a category that your website best falls under.  If you leave the <em>Namespace</em> field empty, it will automatically generate this for you.  Once finished, click the <strong>Create App</strong> button.</p></li>
                    <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/social-networks-auto-poster-10.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/social-networks-auto-poster-10.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>Once this form is submitted you will be taking to your Facebook app dashboard.  On this page, you will see both <em>App ID</em> and <em>App Secret</em> fields. To view the content of the <em>App Secret</em> field, click on the <strong>Show</strong> button to the right of it.</p></li>
                    <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/social-networks-auto-poster-11.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/social-networks-auto-poster-11.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>Next, visit the <em>Settings</em> tab and click <strong>Add Platform</strong>.  A box will appear here in which you will then select <strong>Website</strong>.</p></li>
                    <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/social-networks-auto-poster-12.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/social-networks-auto-poster-12.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>You will now have an additional option within the <em>Settings</em> screen labeled <em>Site URL</em>.  In this field, enter the URL of your site that will be posting to Facebook.  Be sure that this is the exact URL of your site, so if your site is at <em>http://example.com/blog</em>, then enter this into the <em>Site URL</em> field.</p></li>
                    <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/social-networks-auto-poster-13.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/social-networks-auto-poster-13.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>Next, you'll need to enter your domain info into the <strong>App Domains</strong> field.</p></li>
                    <li style='clear:both;'><p>Once finished, click the <strong>Save Changes</strong> button on the bottom right.</p></li>
                    <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/social-networks-auto-poster-14.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/social-networks-auto-poster-14.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>Now that you have defined the basic settings of your Facebook app that will be used to automatically post to Facebook, you'll need to enable your app to be viewed by the general public.  To do so, click on <strong>Status & Review</strong>, then you will see a switch that will make your make your app live.  Click it to enable public access.</p></li>
                    <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/social-networks-auto-poster-15.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/social-networks-auto-poster-15.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>Now your Facebook app is all set up to be used to automatically post to Facebook from your WordPress site, we just need to make a few changes to the NextScripts Social Network Auto Poster settings. Be sure to keep your Facebook app page up as we will need some information from it.  To access your settings for the Social Network Auto Poster, hover over <strong>Settings</strong> and click on <strong>Social Networks Auto Poster</strong>.</p></li>
                    <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/social-networks-auto-poster-16.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/social-networks-auto-poster-16.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>To open your settings for auto-posting to Facebook, click the green button that says <strong>Add new account</strong>, then click the dropdown box at the top and select <strong>Facebook</strong>.</p></li>
                    <li style='clear:both;'><p>In here, you will enter the following information which can be obtained from Facebook:</p>
                        <ul>
                            <li style='clear:both;'><p><strong>Account Nickname</strong>:  This is used to identify your account within the Social Networks Auto Poster plugin.  You may enter anything you want here.</p></li>
                            <li style='clear:both;'><p><strong>Facebook URL</strong>:  This is the URL of the Facebook page, profile, or group that you will be posting to.  To obtain this, simply visit your Facebook profile, page, or group and copy the page URL from it.</p></li>
                            <li style='clear:both;'><p><strong>Facebook App ID</strong>:  This is your Facebook App ID that is obtained from your Facebook app page on the Facebook Developers site.  To obtain it, go to your app on the Facebook developers site, and click on Dashboard.  From here, you will see the App ID and App Secret on the top of the page.</p></li>
                            <li style='clear:both;'><p><strong>Facebook App Secret</strong>: Your Facebook app secret will be found in the same location as your app ID.  To show it, click the <strong>Show</strong> button to the right of it.</p></li>
                        </ul>
                    </li>
                    <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/social-networks-auto-poster-17.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/social-networks-auto-poster-17.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>Now that you have updated your settings, click the <strong>Update Settings</strong> button to save them.  After you click this button, you will see a new link on this page that says <strong>Authorize Your Facebook Account</strong>.  Click this to begin the authorization.</p></li>
                    <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/social-networks-auto-poster-18.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/social-networks-auto-poster-18.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>Once you click this link, you will be taken to Facebook and prompted to authorize your app.  Click the <strong>Okay</strong> button to authorize it.  You will also be prompted to allow your app to post to Facebook on your behalf.  Be sure to authorize this as well.</p></li>
                    <li style='clear:both;'>Congratulations!  You will now be able to automatically publish content to Facebook from your WordPress site.</li>
                </ol>
            </div>
        </div>
        <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title">
                <a data-toggle="collapse" data-parent="#accordion" href="#googleplus">Automatically posting to Google Plus</a>
            </h3>
        </div>
        <div id="googleplus" class="panel-collapse collapse">
            <div class="panel-body">
               <p>Automatically posting content to Google Plus does require an additional API.  For information on this, take a look at <a href="http://www.nextscripts.com/google-plus-automated-posting/" target="_blank">NextScripts' Google Plus API</a>.</p>
            </div>
        </div>
    </div>
</div>
</div>
<p>Of course, there are many other social media accounts that you can connect to using the NextScripts social media auto poster, but we are only able to go over a few of them.  For more information on other social media accounts, we recommend consulting <a href="http://www.nextscripts.com/instructions/" target="_blank">Nextscripts' documentation</a>.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/wordpress-plugins/auto-posting-social-media&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/wordpress-plugins/auto-posting-social-media'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NjcmaWQ9MzA5MSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
...
<a name='comments'></a>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/dc5e63101d433bce323aefb8ae850138?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/dc5e63101d433bce323aefb8ae850138'>Shankhajit Dey</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-25 2:53 am</div>
				                <div><p>This is Truely Helpful For Me. Thanx for the Documentation. :)</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13296);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-25 2:55 am</div>
				                <div><p>This Documentation is Really Helpful For Me. :) Thanx For This. :)</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13297);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-25348'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/f7d29e1c5902a14897437373c8d83b7a?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/f7d29e1c5902a14897437373c8d83b7a'>Joe</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-31 4:02 am</div>
				                <div><p>i have some question . If i create that the content on the blog by wordpress, and then share the meat to a Facebook profile, Facebook fanpage, Google plus profile, Google plus for business, Twitter, .Intagram, Pinterest .. Youtube and Line Application or Line @ Or What App. But the header. each of sharing content on Social Media channels do differ header , some social media channel differ Content and differ Schedule time with you. in this program can or not . and How to do it by use plugin or How to do by script it.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25348);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-01 12:34 pm</div>
				                <div>Hello Joe,<br />
<br />
Your post will look slightly different on each social media due to their websites treating your content differently. There may be no way to modify that as it depends on the social media website. You may need to speak to a developer if you are looking to script this on your own.<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25368);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
