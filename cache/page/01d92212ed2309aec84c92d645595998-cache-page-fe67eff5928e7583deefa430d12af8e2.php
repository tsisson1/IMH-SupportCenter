<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:46044:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/mediawiki/getting-started-mediawiki" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="keywords" content="install installing setup setting set up initial MediaWiki media wiki" />
  <meta name="description" content="This section will explain how to install and set up the initial functions of MediaWiki." />
  <title>101: Getting Started with MediaWiki | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/mediawiki/getting-started-mediawiki" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:47cc70b284f121a5403e4c8aa4d2dc90 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '193.128.33.248']);
...
<div class='page-header'>
	<h1>101: Getting Started with MediaWiki</h1>
</div>
<div class='section_listing'>
		<table>
	<tr><td colspan='3'><h2>MediaWiki overview</h2><div>This will explain th erequired reading to follow easy steps to set up a MediaWiki site.</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 1:</td>
				<td style='padding-right:10px;'><div class='gold_star'></div></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/mediawiki/getting-started-mediawiki/overview-media-wiki'>Basic MediaWiki site overview</a>
					<div>This is an overview on basic steps in creating a MediaWiki site.</div>
					<div class='smallgrey'>Hits: 1,793</div>
				</td>
			</tr>
		<tr><td colspan='3' style='padding-top:20px;'><h2>Installing MediaWiki</h2><div>These articles will explain common installation steps.</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 2:</td>
				<td style='padding-right:10px;'><div class='gold_star'></div></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/mediawiki/getting-started-mediawiki/install-mediawiki-softaculous'>Installing MediaWiki with Softaculous</a>
					<div>MediaWiki can easily be installed by using Softaculous in the cPanel Software / Services. This tutorial will explain how to install MediaWiki using Softaculous.</div>
					<div class='smallgrey'>Hits: 1,318</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/mediawiki/getting-started-mediawiki/install-mediawiki-manually'>Installing MediaWiki manually</a>
					<div>This article will explain the steps to install MediaWiki manually on your server.</div>
					<div class='smallgrey'>Hits: 5,031</div>
				</td>
			</tr>
		<tr><td colspan='3' style='padding-top:20px;'><h2>Manage Users and login</h2><div>These following tutorials will explain how to log in, manage the users, and reset passwords when they are lost in MediaWiki.</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 4:</td>
				<td style='padding-right:10px;'><div class='gold_star'></div></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/mediawiki/getting-started-mediawiki/login-username-password'>How to log into MediaWiki</a>
					<div>This section of the Getting started with MediaWiki course will explain logging in to the MediaWiki dashboard.</div>
					<div class='smallgrey'>Hits: 4,583</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/mediawiki/getting-started-mediawiki/password-username-media-wiki'>Managing passwords and usernames in MediaWiki</a>
					<div>Forgetting or losing your MediaWiki password or username is a normal occurrence. This article will explain how to change and reset your passwords and recover your username in MediaWiki.</div>
					<div class='smallgrey'>Hits: 8,858</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'><div class='gold_star'></div></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/mediawiki/getting-started-mediawiki/mediawiki-manage-user-accounts'>Managing User Accounts in MediaWiki</a>
					<div>This section will explain how to create, edit, delete, and restrict users on the MediaWiki site.</div>
					<div class='smallgrey'>Hits: 24,784</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/mediawiki/getting-started-mediawiki/remove-add-account-access'>Adding / Removing account access features in MediaWiki</a>
					<div>This Article will explain how to remove the create account link, restrict viewing and editing accounts, and page creation in MediaWiki.</div>
					<div class='smallgrey'>Hits: 3,800</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/mediawiki/getting-started-mediawiki/change-url'>Changing your URL in Mediawiki</a>
					<div>This guide walks you through changing the URL of a MediaWiki website.</div>
					<div class='smallgrey'>Hits: 1,192</div>
				</td>
			</tr>
			</table>
</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMDMmaWQ9MzAzJnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="6929825cb6a86d0e035a2f736be16723" value="1" />	</div>
	</form>
<!-- <br />
