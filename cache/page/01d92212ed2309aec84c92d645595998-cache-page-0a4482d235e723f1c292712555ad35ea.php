<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:66772:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/mediawiki/getting-started-mediawiki/password-username-media-wiki" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-09-26T20:51:28-07:00" />
  <meta name="keywords" content="lost losing forgot username password reset media wiki mediawiki" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="Forgetting or losing your MediaWiki password or username is a normal occurrence. This article will explain how to change and reset your passwords and recover your username in MediaWiki." />
  <title>Managing passwords and usernames in MediaWiki - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/mediawiki/getting-started-mediawiki/password-username-media-wiki" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:659774f413b9bea79c7ff189ad19469f -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '129.132.70.8']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Managing passwords and usernames in MediaWiki									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>8,856</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 21, 2013'><span style='color:#606060;'>Published:</span> Sep 26, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In the event you cannot log into MediaWiki due to username or password failure, you can change passwords and/or find the username when the username is lost. This section of the Getting started with MediaWiki course will explain changing passwords, resetting the password, and finding the username.</p>
<h2>How do I change my password?</h2>
<p>When the password is reset with the "Forgotten your login details?" link, the password is changed to a generated password. The generated passwords can be difficult to remember as they are random characters. To change the password to a more memorable password, you can change it in the preferences of the MediaWiki preferences page. These are the steps for changing the password in the MediaWiki user preferences.</p>
<ol class="article_list">
<li><a href="#how-to-log-in" title="Click for more information">Log into MediaWiki</a></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/101/login-password-username/log-in-mediawiki-7-preferences.gif"><img  alt="log-in-mediawiki-7-preferences" src="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/101/login-password-username/log-in-mediawiki-7-preferences.gif" style="float: right; margin: 0px 0px 15px 15px; max-width: 100px;" title="Click here to view the larger image" /></a><strong>Click Preferences </strong>at the top left hand side of the site.
<div style="clear: both;">&nbsp;</div>
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/101/login-password-username/log-in-mediawiki-8-change.gif"><img  alt="log-in-mediawiki-8-change" src="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/101/login-password-username/log-in-mediawiki-8-change.gif" style="float: right; margin: 0px 0px 15px 15px; max-width: 100px;" title="Click here to view the larger image" /></a>On the preferences page, <strong>Click Change Password </strong>in the Basic Information section of the Preferences page..
<div style="clear: both;">&nbsp;</div>
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/101/login-password-username/log-in-mediawiki-9-change-old.gif"><img  alt="log-in-mediawiki-9-change-old" src="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/101/login-password-username/log-in-mediawiki-9-change-old.gif" style="float: right; margin: 0px 0px 15px 15px; max-width: 100px;" title="Click here to view the larger image" /></a><strong>Type</strong> your <strong>old password</strong> and your <strong>new password </strong>twice.
<p><strong>Click Change Password</strong>.</p>
<div style="clear: both;">&nbsp;</div>
</li>
</ol>
<div><a name="forgot-password" id=""></a></div>
<h2>What if I forgot my password?</h2>
<p>In the case you forget your MediaWiki password, you can use the forgot password link to reset your password and email your login details. The following will explain how to reset your password an the MediaWiki Log in page.</p>
<h3>Reset the password with the forgot password link</h3>
<ol class="article_list">
<li><a href="#how-to-log-in" title="Click for more information">Navigate to the MediaWiki login page</a></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/101/login-password-username/log-in-mediawiki-3-forgot.gif"><img  alt="log-in-mediawiki-3-forgot" src="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/101/login-password-username/log-in-mediawiki-3-forgot.gif" style="float: right; margin: 0px 0px 15px 15px; max-width: 100px;" title="Click here to view the larger image" /></a><strong>Click Log in </strong>at the top right of your MediaWiki site..
<div style="clear: both;">&nbsp;</div>
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/101/login-password-username/log-in-mediawiki-4-reset.gif"><img  alt="log-in-mediawiki-4-reset" src="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/101/login-password-username/log-in-mediawiki-4-reset.gif" style="float: right; margin: 0px 0px 15px 15px; max-width: 100px;" title="Click here to view the larger image" /></a>On the Log in / create account page, <strong>click Forgotten your login details</strong>. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/101/login-password-username/log-in-mediawiki-5-email-sent.gif"><img  alt="log-in-mediawiki-5-email-sent" src="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/101/login-password-username/log-in-mediawiki-5-email-sent.gif" style="float: right; margin: 0px 0px 15px 15px; max-width: 100px;" title="Click here to view the larger image" /></a>The Reset password special page will prompt for you to enter your username.
<p><strong>Enter the username</strong> and <strong>click E-mail new password</strong>.</p>
<div style="clear: both;">&nbsp;</div>
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/101/login-password-username/log-in-mediawiki5a-reset-fail.gif"><img  alt="log-in-mediawiki5a-reset-fail" src="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/101/login-password-username/log-in-mediawiki5a-reset-fail.gif" style="float: right; margin: 0px 0px 15px 15px; max-width: 100px;" title="Click here to view the larger image" /></a>If the username was found the Reset password will display, <strong>A reminder e-mail has been sent</strong>.
<p>If the username is invalid, the Reset password page will display,</p>
<p style="color: #ff0000; margin-left: 20px;">There is no user by the name of "user". Usernames are case sensitive. Check your spelling or <span style="color: #3366cc;">create a new account</span>.</p>
If this occurs, you will need to obtain your username from PhpMyAdmin.
<div style="clear: both;">&nbsp;</div>
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/101/login-password-username/log-in-mediawiki-6-new-pass.gif"><img  alt="log-in-mediawiki-6-new-pass" src="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/101/login-password-username/log-in-mediawiki-6-new-pass.gif" style="float: right; margin: 0px 0px 15px 15px; max-width: 100px;" title="Click here to view the larger image" /></a>Next, <strong>check your email</strong>. The MediaWiki site will email you a new password. The email should look like the snapshot to the right. <br /><br />Now you will be able to log in with the new password. After you log in you can <a title="Click here for info on changing the password" href="#change-password">reset the Password in the MediaWiki Preferences</a>.
<div style="clear: both;">&nbsp;</div>
</li>
</ol>
<div><a name="shell-password-change" id=""></a></div>
<p>When MediaWiki is installed as a Binary database character set, The password cannot be changed through PhpMyAdmin. If the email address is not valid for whatever reason in your user preferences, the <strong>Forgotten your login details?</strong> link will fail to email your new password. In order to change the password, a bash script can be ran to update the password. The following steps will explain how to change the password through shell.</p>
<h3>Changing or resetting the Password through shell</h3>
<ol class="article_list">
<li><a target="_blank" href="/support/website/general-server-setup/how-to-login-ssh" title="Click for more information on SSH">SSH into your server.</a>
<p class="alert"><strong>Note!</strong> Not all servers have SSH access. On InMotion Hosting servers, only VPS (Virtual Private Server) or Dedicated servers have this available. If you need to change the password through shell on a shared server, contact support.</p>
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/101/login-password-username/log-in-mediawiki-10-bash.gif"><img  alt="log-in-mediawiki-10-bash" style="float: right; margin: 0px 0px 15px 15px; max-width: 100px;" title="Click here to view the larger image" src="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/101/login-password-username/log-in-mediawiki-10-bash.gif" /></a><strong>Navigate to your MediaWiki maintenance directory</strong>. For example:
<p style="margin-left: 20px;">cd /home/userna5/public_html/mediawiki/maintenance</p>
<p><strong>Run the following bash command</strong> (Supplement the admin with your username and the pass1234 with the password you want to change to).</p>
<p style="margin-left: 20px;">php changePassword.php --user-admin --password=pass1234</p>
<div style="clear: both;">&nbsp;</div>
</li>
</ol>
<div><a name="find-username-phpmyadmin" id=""></a></div>
<h2>What if I forgot my username?</h2>
<p>When the Forgotten your login details? link on the Log in / create account page fails to find your username, The username can be retrieved by logging into PhpMyAdmin and locating the username in the database. The following section will explain how to recover your MediaWiki username from your database through PhpMyAdmin.</p>
<ol class="article_list">
<li><a target="_blank" href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel" title="Click for how to log into cpanel">Log into cPanel.</a></li>
<li><a target="_blank" href="/support/website/cpanel/how-do-i-manage-a-mysql-database-in-phpmyadmin-in-my-control-panel-cpanel" title="Click for more information on PhpMyAdmin">Navigate to <strong>Databases</strong> &gt; <strong>PhpMyAdmin</strong>.</a></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/101/login-password-username/log-in-mediawiki-11a-click-database.gif"><img  alt="log-in-mediawiki-11a-click-database" src="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/101/login-password-username/log-in-mediawiki-11a-click-database.gif" style="margin: 0px 0px 15px 15px; float: right; max-width: 100px;" title="Click here to view the larger image" /></a><strong>Select the database</strong> for the MediWiki site. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/101/login-password-username/log-in-mediawiki-12-select-users-table.gif"><img  alt="log-in-mediawiki-12-select-users-table" src="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/101/login-password-username/log-in-mediawiki-12-select-users-table.gif" style="float: right; margin: 0px 0px 15px 15px; max-width: 100px;" title="Click here to view the larger image" /></a><strong>Find the users table</strong>.
<p class="alert"><strong>Note!</strong>The Prefix will vary depending on the installation. Prefixes can look like mw_ or wiki_ depending if it was changed during installation.</p>
<div style="clear: both;">&nbsp;</div>
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/101/login-password-username/log-in-mediawiki-13-find-username.gif"><img  alt="log-in-mediawiki-13-find-username" src="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/101/login-password-username/log-in-mediawiki-13-find-username.gif" style="float: right; margin: 0px 0px 15px 15px; max-width: 100px;" title="Click here to view the larger image" /></a><strong>Find the username</strong> in the <strong>user_name </strong>column of the table row.
<div style="clear: both;">&nbsp;</div>
</li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 5: Managing passwords and usernames in MediaWiki</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 4: <a href='/support/edu/mediawiki/getting-started-mediawiki/login-username-password'>How to log into MediaWiki</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 6: <a href='/support/edu/mediawiki/getting-started-mediawiki/mediawiki-manage-user-accounts'>Managing User Accounts in MediaWiki</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/mediawiki/getting-started-mediawiki/password-username-media-wiki&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/mediawiki/getting-started-mediawiki/password-username-media-wiki'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMDMmaWQ9MjA4NiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="5148b3aec2c0afe2c8015e6039e73b49" value="1" />	</div>
	</form>
<!-- <br />
