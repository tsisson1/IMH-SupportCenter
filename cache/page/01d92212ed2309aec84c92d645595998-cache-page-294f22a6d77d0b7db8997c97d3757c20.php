<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:48021:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/opencart/203-shipping-and-taxes-in-opencart" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="In the follow set of OpenCart tutorials, we'll show you how to work with taxes, geo zones, and various shipping options." />
  <title>203: Shipping and Taxes in OpenCart | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/opencart/203-shipping-and-taxes-in-opencart" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:72de85041fa3fb0f280b7bbe2083e91f -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '62.77.226.122']);
...
<div class='page-header'>
	<h1>203: Shipping and Taxes in OpenCart</h1>
</div>
<div class='section_listing'>
		...
		<tr>
				...
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/opencart/203-shipping-and-taxes-in-opencart/311-introduction-to-geo-zones-in-opencart'>Introduction to Geo Zones in OpenCart</a>
					<div>In this tutorial, we'll explain what Geo Zones are and how they function within your OpenCart website. </div>
					<div class='smallgrey'>Hits: 10,971</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/opencart/203-shipping-and-taxes-in-opencart/creating-a-geo-zone-in-opencart'>Creating a Geo Zone in OpenCart</a>
					<div>In this tutorial, we'll show you how to create a new Geo Zone in OpenCart.</div>
					<div class='smallgrey'>Hits: 8,400</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/opencart/203-shipping-and-taxes-in-opencart/removing-a-geo-zone-in-opencart'>Removing a Geo Zone in OpenCart</a>
					<div>Learn how to remove an existiing Geo Zone in your OpenCart Dashboard.</div>
					<div class='smallgrey'>Hits: 3,603</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/opencart/203-shipping-and-taxes-in-opencart/introduction-to-taxes-in-opencart'>Introduction to Taxes in OpenCart</a>
					<div>In this article, we'll explain the basics of working with taxes in OpenCart.</div>
					<div class='smallgrey'>Hits: 7,235</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/opencart/203-shipping-and-taxes-in-opencart/removing-existing-tax-rates-in-opencart'>Removing Existing Tax Rates in OpenCart</a>
					<div>In this tutorial, you'll learn how to remove existing Tax rates in OpenCart.</div>
					<div class='smallgrey'>Hits: 7,886</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/opencart/203-shipping-and-taxes-in-opencart/adding-a-new-tax-rate-in-opencart'>Adding a New Tax Rate in OpenCart</a>
					<div>In this tutorial we'll show you how to create a new tax rate in OpenCart.</div>
					<div class='smallgrey'>Hits: 13,955</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/opencart/203-shipping-and-taxes-in-opencart/adding-a-new-tax-class-in-opencart'>Adding a New Tax Class in OpenCart</a>
					<div>This short article will teach you how to create a new tax class in OpenCart.</div>
					<div class='smallgrey'>Hits: 4,310</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/opencart/203-shipping-and-taxes-in-opencart/adding-a-tax-rate-to-an-existing-tax-class'>Adding a Tax Rate to an Existing Tax Class</a>
					<div>This article will explain how to add a tax rule to an existing Tax Class in OpenCart.</div>
					<div class='smallgrey'>Hits: 2,691</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/opencart/203-shipping-and-taxes-in-opencart/introduction-to-shipping-in-opencart'>Introduction to Shipping in OpenCart</a>
					<div>In this short tutorial, we'll explain how shipping modules work in OpenCart.</div>
					<div class='smallgrey'>Hits: 3,930</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/opencart/203-shipping-and-taxes-in-opencart/enabling-a-specific-shipping-method-in-opencart'>Enabling a Specific Shipping Method in OpenCart</a>
					<div>In this tutorial, we'll explain how to use a shipping method in OpenCart. The example in the tutorial covers flat rate shipping.</div>
					<div class='smallgrey'>Hits: 6,977</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/opencart/203-shipping-and-taxes-in-opencart/setting-up-weight-based-shipping'>Setting up Weight Based Shipping</a>
					<div>In this tutorial we'll show you the steps to set up weight based shipping in OpenCart</div>
					<div class='smallgrey'>Hits: 23,122</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/opencart/203-shipping-and-taxes-in-opencart/installing-the-pick-up-from-store-shipping-method'>Installing the Pick Up from Store Shipping Method</a>
					<div>This article will show you how to enable the shipping option pick up from store so your customers do not have to pay shipping and can visit your brick and mortar location to pick up their online order they placed in OpenCart. </div>
					<div class='smallgrey'>Hits: 5,584</div>
				</td>
			</tr>
			</table>
</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xNTkmaWQ9MTU5JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="af37a4e3ce94633aa66007f5fb5dd96c" value="1" />	</div>
	</form>
<!-- <br />
