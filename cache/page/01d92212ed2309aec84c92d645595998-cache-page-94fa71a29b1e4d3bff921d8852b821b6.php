<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50269:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/php-configuration" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="InMotion Hosting Support Center" />
  <title>PHP Configuration | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/php-configuration" rel="canonical" />
...
<script>
  ...
  ga('send', 'pageview');
	...
	<!-- cid:ba56e0506cc1b6e5f000265205d9ad89 -->
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>PHP Configuration</span></li>			</ul>
		</div>
	</div>
</div>
...
<form action="http://www.inmotionhosting.com/support/website/php-configuration" method="post" name="adminForm" id="adminForm" class="form-inline">
  ...
  <table class='article_list'>
          ...
          <tr>
                                <td style='padding-right:20px;'><a href='/support/website/php-configuration/how-to-upgrade-php-version'>How to upgrade your PHP version</a></td>
                                <td>27,919</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/website/php-configuration/using-multiple-php-versions-one-account'>Using multiple PHP versions on one account</a></td>
                                <td>21,884</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/website/php-configuration/find-php-version-and-options-of-your-server'>Find PHP version and options of your server</a></td>
                                <td>15,834</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/website/php-configuration/view-and-clear-php-apc-cache'>View and clear PHP APC cache</a></td>
                                <td>11,401</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/website/php-configuration/install-pear-extensions'>How to install PEAR php extensions via the cPanel</a></td>
                                <td>10,425</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/website/php-configuration/install-apc-for-php'>Install APC for PHP</a></td>
                                <td>6,821</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/website/php-configuration/use-diferent-php-versions-one-account'>Copying the php.ini from a different PHP version</a></td>
                                <td>5,116</td>
                        </tr>
                  </table>
	</form>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NTImaWQ9NDUyJnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="302f392ea74228922527a97938c61421" value="1" />	</div>
	</form>
<!-- <br />
