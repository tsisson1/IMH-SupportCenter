<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:64382:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/email/bounceback-errors/550-invalid-address" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-10-30T13:44:22-07:00" />
  <meta name="keywords" content="550 invalid address email error server bounce back bounceback message" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Are you getting a &quot;550 invalid address&quot; error from a returned email? Learn more about the error here." />
  <title>&quot;550 Invalid address&quot; email error - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/email/bounceback-errors/550-invalid-address" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:8097430f1ef40500f3563715a303e1f3 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '84.55.41.204']);
    ...
    <ul>
		...
		<li><a href='/support/tools/what-is-my-ip-address'>What is my IP address?</a></li>
			...
			<div class='dropdown_3columns' style='width:900px; margin-left:-250px;'>
				<div class='col_1' style='width:290px;'><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/email/bounceback-errors/fixing-no-such-user-here'>Fixing the 550 No Such User Here email error</a> (94,093 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/email/bounceback-errors/email-error-552'>Email error 552</a> (50,697 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/email/bounceback-errors/email-bounce-bounceback-error'>Why does Email bounce, bounceback, or error?</a> (39,928 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/email/bounceback-errors/email-error-553'>Email error 553</a> (32,561 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/email/bounceback-errors/550-invalid-address'>"550 Invalid address" email error</a> (16,116 hits)</div></div>
				<div class='col_1' style='width:290px;'><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/email/bounceback-errors/email-error-554'>Email error 554</a> (83,767 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/email/bounceback-errors/what-to-do-if-an-email-is-returned'>What to do if an email is returned?</a> (44,360 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/email/bounceback-errors/email-error-550'>Email error 550</a> (37,051 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/email/bounceback-errors/email-error-450'>Email error 450</a> (26,343 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/email/bounceback-errors/domain-exceeded-max-emails-per-hour'>Domain example.com has exceeded the max emails per hour</a> (11,878 hits)</div></div>
				<div class='col_1' style='width:290px;'><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/email/bounceback-errors/mail-delivery-failed-returning-message-to-sender'>Mail delivery failed: returning message to sender</a> (59,268 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/email/bounceback-errors/email-error-421'>Email error 421</a> (41,981 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/email/bounceback-errors/email-error-mailbox-quota-exceeded'>Email Error- Mailbox Quota Exceeded</a> (32,773 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/email/bounceback-errors/email-bounce-retry-timeout-exceeded'>Email Bounce- Retry timeout exceeded</a> (23,229 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/email/bounceback-errors/535-incorrect-authentication'>535 incorrect authentication</a> (11,591 hits)</div></div>
			</div>
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>&quot;550 Invalid address&quot; email error</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															&quot;550 Invalid address&quot; email error									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>16,116</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Apr 26, 2013'><span style='color:#606060;'>Published:</span> Oct 30, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>When working with emails, there are times when you run into different errors and receive your email back instead of it going forward to the intended recipient. Email servers will give you what is known as <em>bounceback</em> information. This information is very useful in discovering why your email was not delivered. There can be several different types of errors. This article will focus on the "<em>550 invalid address</em>" error.</p>

<h2>What is the "550 invalid address" error?</h2>

<p>This message is basically broken into two parts. The first part is the error number, and the second is the message. The 550 error number means that this is a permanent error, so resending it later will have the same effect. Error numbers that are in the 400's are temporary errors and can usually be tried again at a later time.</p>
 
<p>The message itself indicates that the email address that the message was sent to does not exist. Typically, this means that the recieving server does not have an account registered to that email address. This can be from a recent change in DNS records, or the email address was deleted.</p>

<h2>How can I fix this?</h2>
<p>If you are the one that sent the original message and received this as a bounceback, you will first want to check and ensure there is nothing misspelled in the recipient address. This is a common issue and quickly fixed by entering the correct spelling of the email address. If you have checked and are certain it is correct,  you will want to contact the intended recipient via alternate means and tell them that you received this error. This error is coming from the destination server, so there is nothing you or your hosting provider as a sender can do.</p>

<p>If you have recieved a notice from someone trying to send you email that they have recieved this error, you will want to check a couple of things:<br />
<ul>
   <li>Did the sender misspell your email address?</li>
  
   <li>Did you recently <a href="/support/edu/cpanel/cpanel-email/modfying-mx-records">change mail records</a> to point to another <a href="/support/edu/cpanel/cpanel-email/edit-mx-remote-local">remote server</a>?</li>
  
   <li>Did you recently move your domain name <a href="/support/domain-names/registrations-and-transfers/transfer-domain-name-to-inmotion-hosting">to our servers</a> or to another host or <a href="/support/domain-names/dns-nameserver-changes/change-domain-nameservers-amp">point it to new name servers</a>?</li>
   <li>Does the email address actually exist or does it <a href="/support/edu/everything-email/introduction-email/creating-email-account">need to be created</a>?</li>
</ul>
</p>

<p>If you have gone over all the steps above and the issue is persisting, you will want to <a href="/support/website/website-troubleshooting/how-to-get-great-technical-support">contact our Live Support team</a> so they can troubleshoot the issue further.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/email/bounceback-errors/550-invalid-address&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/email/bounceback-errors/550-invalid-address'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NjImaWQ9MjY3MyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="5d00740e3420036c336588d07edde823" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/cf96bbbfcc89622f298bcd25234d358b?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/cf96bbbfcc89622f298bcd25234d358b'>nisdajam</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-17 8:38 am</div>
				                <div><p>i found it helpful in understanding the situation&nbsp; i was in . therefore, i didn't waste time trying to resend the message.</p>
<p>but could it be that the email was closed after the a dead line to job submission had ellapsed?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21797);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-17 11:56 pm</div>
				                <div>Hello Nisdajam,<br />
<br />
That is very unlikely due to how fast the servers process the request. Can you provide some more clarification on how you think this may occur?<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21822);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-27289'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/b298f206516556a74cfc45392a02da7c?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/b298f206516556a74cfc45392a02da7c'>Ibrahim</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-07 10:54 am</div>
				                <div><p>Hello,</p>
<p>We just changed our server&nbsp;from one provider to another. And after all we see that we are receving SMTP 550 5.2.0 errors when we try to send email to our domain using PHP mail() command. Do you think is it going to fix it itself in sometime later?</p>
<p>&nbsp;</p>
<p>Regards</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27289);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
