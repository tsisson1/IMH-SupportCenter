<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:51443:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/general-server-setup/how-to-increase-php-memory-allocation-to-64mb" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello tony_chen, Thank you for your question. You can view your current PHP settings using a PHP info page. If you want to increase your PHP memory from..." />
  <title>How to increase PHP memory allocation to 64MB | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/general-server-setup/how-to-increase-php-memory-allocation-to-64mb" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:30de14cf937c2912ebc0aa4c83837208 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '188.39.120.178']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>How to increase PHP memory allocation to 64MB</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/tony_chen'>tony_chen</a>
			<div>8 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-07-20 3:15 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>3,091</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I'm building a Wordpress web site. It requires at least 64MB for the PHP memory allocation.  But currently it is 40MB by default. How can I increase it? Thanks!</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_3582' id='upvote_answer_3582' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='3582' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_3582').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_3582' id='downvote_answer_3582' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='3582' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_3582').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello tony_chen,<br />
<br />
Thank you for your question. You can view your current PHP settings using a <a href="http://www.inmotionhosting.com/support/website/general-server-setup/create-phpinfo-page-to-see-php-settings" target="_blank" >PHP info page</a>. If you want to increase your PHP memory from 40MB to 64MB, you must modify the php.ini file.<br />
<br />
Here is a link to our guide on <a href="http://www.inmotionhosting.com/support/website/general-server-setup/update-local-php-settings" target="_blank" >how to update your PHP settings</a>.<br />
<br />
You can also make these rules affect all website in your account, by <a href="http://www.inmotionhosting.com/support/website/general-server-setup/recursive-php-ini" target="_blank" >making it recursive</a>.<br />
<br />
...
-John-Paul
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_3582').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_3582' id='form_comment_on_answer_3582' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Thank you for your reply. By running phpinfo.php, I found the php memory limit has already been set to 512MB on the server. After I added a line &quot;define('WP_MEMORY_LIMIT', '256M');&quot; to the file wp_config.php, the problem was solved! Now, there is no red warning message on the server status page. Thanks!</div>
							...
							<td style='width:96px;' valign='top'>
								...
								<div class='smallgrey'>
									<a href='/support/community-support/users/tony_chen'>tony_chen</a><br />
									8 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2013-07-22 11:57 pm EST
								</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/general-server-setup/how-to-increase-php-memory-allocation-to-64mb&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/general-server-setup/how-to-increase-php-memory-allocation-to-64mb'></div>
<script type='text/javascript'>
  (function() {
