<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:68470:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-3/create-component/add-new-task" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-05-23T20:10:55-07:00" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="InMotion Hosting Support Center" />
  <title>How to add a New Task to your Joomla 3 Component - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-3/create-component/add-new-task" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:bbff28c4352bd61780207d9f0352240f -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '80.153.212.42']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to add a New Task to your Joomla 3 Component									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>10,427</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: May 18, 2014'><span style='color:#606060;'>Published:</span> May 23, 2014</div>
...
<p>So far in this <a href="/support/edu/joomla-3/create-component">tutorial series for creating a component in Joomla 3</a>, we've created <a href="/support/edu/joomla-3/create-component/add-new-view">views</a> and we've created <a href="/support/edu/joomla-3/create-component/formats">formats</a>. The next feature of components we're going to review is tasks.</p>

<h2>What is a task?</h2>

<p>A task is, well... something that can be done. The usage of "<em>tasks</em>" when developing components in Joomla is what it sounds like.</p>

<h3>display() is the default task</h3>

<p>If you do not specify a task, the default task <em>display()</em> will be executed. The screenshot below demonstrates this in action. When we echo the <strong>task</strong> to the screen, it is blank (meaning it is not set). Because there is no task set, the <strong>default()</strong> task / function is then executed.</p>

<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/create-component/display-is-default-task.png"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/create-component/display-is-default-task.png"  style='max-width:100%;' /></a>

<h2>How to add a new task</h2>

<p>Adding a new task to your component is actually quite easy. Here are the steps.</p>

<ol class='article_list'>
  <li>
    <p><strong>Decide on a task name</strong></p>
    <p>In our testing, we are going to create a task named <em>shout</em>.</p>
  </li>
  <li>
    <p><strong>Add a function named after your task within your component's controller class</strong></p>
    <p>Since we're creating a <em>shout</em> task, we need to create a function named <strong>shout()</strong> and add it to our controller's class. Below is our controller.php file, with the new code we added to it highlighted in red.</p>
...
{
  <span style='color:red;'>function <strong>shout()</strong>
  {
...
<h2>Testing your new task</h2>

<p>We're testing our new task by calling it in the URL. To do this, we're passing the task variable via the URL and setting it to <em>shout</em>, as in:</p>

<p class='white_box'>http://example.com/index.php?option=com_helloworld&<span style='color:red;'>task=<strong>shout</strong></span></p>

<p>In the screenshot below, you can see our new task in action:</p>

<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/create-component/executing-our-new-task.png"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/create-component/executing-our-new-task.png"  style='max-width:100%;' /></a>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 6: How to add a New Task to your Joomla 3 Component</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 5: <a href='/support/edu/joomla-3/create-component/formats'>How to add a New Format to your Joomla 3 Component</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 7: <a href='/support/edu/joomla-3/create-component/menu-item'>Creating a Menu Item for your Joomla 3 Component</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-3/create-component/add-new-task&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-3/create-component/add-new-task'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD01MDcmaWQ9MzI0OCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="779b394cd2d7f4e235e2e50da34825e0" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/6d077d76b6390bb48764734766e102c1?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/6d077d76b6390bb48764734766e102c1'>Pascal</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-11 10:03 am</div>
				                <div><p>Many thanks !</p>
<p>And how to do the same on the site part of the component ?</p>
<p>How to see it when we affect the type of link on the menu ?</p>
<p>many thanks for all.</p>
<p>Pascal</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21599);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-12 11:08 am</div>
				                <div>Hello Pascal,<br />
<br />
...
<br />
So, when you render a page, it's already showing the SIte part of the component.  Can you be more specific in what you're trying to do?  Please provide more details and we can try to answer the question.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21653);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-31463'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/9772c3a8d91616edc8e95c38cd257889?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/9772c3a8d91616edc8e95c38cd257889'>mathesh</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-25 5:55 am</div>
				                <div><p>hi,</p>
<p>i need to add featured type in my fof component , how to use it?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31463);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-25 9:32 am</div>
				                <div>Hello Mathesh,<br />
<br />
Can you please elaborate on what you are trying to do?<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31468);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
