<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:83424:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/how-to/how-to-create-a-favicon-for-your-website" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-08-28T16:48:03-07:00" />
  <meta name="keywords" content="favicon icon .ico ico hot to add code link" />
  ...
  <link href="http://www.inmotionhosting.com/support/website/how-to/how-to-create-a-favicon-for-your-website" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:15b1e442d693210c142856d73e64122d -->
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to add a Favicon for your Website</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to add a Favicon for your Website									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>24,845</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Oct 17, 2011'><span style='color:#606060;'>Published:</span> Aug 28, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/howto/add-favicon/create-favicon-1.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="InMotion favicon sample" src="//cdn.inmotionhosting.com/support/images/stories/edu/howto/add-favicon/create-favicon-1.gif" title="Click here to view the larger image" width="100" /></a>When you visit a website, there is an image in the browser tab that displays for each site (See image to the right). This is called a <strong>"<em>favicon</em>"</strong>. The favicon image is in the <strong>.ico</strong> file format. You can have other file formats; however, this article will only explain how to use the <strong>.ico</strong> format. The .ico format is universally accepted in all browsers. To create your own favicon, you can <a target="_blank" title="Click here to use our favicon generator" href="/support/tools/favicon-generator">use our Favicon Generator</a>.</p>
<p class="alert"><strong>Important!</strong> You will want to name your favicon image "<em>favicon.ico</em>". Also, when creating a favicon, you will want to make sure your image is square and not rectangle.</p>
...
<li><a href="/support/edu/cpanel/cpanel-file-manager/using-file-manager-in-cpanel" target="_blank" title="Click here for info">Go to the File Manager</a>, Select your directory for your site (In this case the main domain public_html location) and Click Go.</li>
<li><a target="_blank" href="/support/website/how-to/how-to-edit-a-file" title="How do I upload a file on my server?">Upload the favicon to your server</a>.</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/howto/add-favicon/create-favicon-2.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Where the code goes in the head section" src="//cdn.inmotionhosting.com/support/images/stories/edu/howto/add-favicon/create-favicon-2.gif" title="Click here to view the larger image" width="100" /></a><a target="_blank" href="/support/website/how-to/how-to-edit-a-file">Edit the source code</a> that contains the <code>&lt;head&gt;</code> code of your site. The head section code should look similar to the snapshot to the right. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/howto/add-favicon/create-favicon-3.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Placement of favicon link" src="//cdn.inmotionhosting.com/support/images/stories/edu/howto/add-favicon/create-favicon-3.gif" title="Click here to view the larger image" width="100" /></a>Add the following line of code below the <code>&lt;title&gt; </code>tag.
<p><code style="overflow: scroll;">&lt;link rel='shortcut icon' href='favicon.ico' type='image/x-icon' /&gt;</code></p>
<p>Save the file and preview your site in your browser. You should see the favicon show in your browser.</p>
<br style="clear: both;" />
<p class="alert"><strong>Important!</strong> If you do not see your favicon load in your browser, you may need to <a target="_blank" title="Click here for more info" href="/support/website/how-to/clear-browser-cache"><strong>Clear your browser cache</strong></a>.</p>
</li>
</ol> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/how-to/how-to-create-a-favicon-for-your-website&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/how-to/how-to-create-a-favicon-for-your-website'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zNSZpZD0yNjQmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="fc8cd270238a0c1ceffda84a8f3c16fa" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						...
						<div><a style='font-size:16px;' href='/support/community-support/users/caritative'>caritative</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2012-11-29 5:44 pm</div>
				                <div>I have uploaded the favicon.ico image into my roots directory. It's not appearing on my site. This could be because I do not know how to insert the header code referenced above. I am using a joomla platform.<br />
<br />
Any help is much appreciated!</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(7237);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='/support/images/avatars/default_avatar.jpg' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='/support/community-support/users/edgrac'>edgrac</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-02-28 6:44 pm</div>
				                <div>The tutorial above says to &quot;Edit the source code that contains the code of your site&quot;. Could you tell me in which file it would be? i appreciate your help</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(7528);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-9191'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/9c6dfa17e669669c1ae95970bda6e9c5?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/9c6dfa17e669669c1ae95970bda6e9c5'>Juliana</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-25 12:46 pm</div>
				                <div><p>For anyone having problems with this. If you use the following line of code instead of the one given up top may help.&nbsp;</p>
<p>&nbsp;&lt;link rel="icon" type="image/ico" href="http://www.insertyourwebsite.com/favicon.ico"/&gt;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9191);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-15295'></a>
		<div  style='margin:2px 0px 0px 40px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/3d27afcb949f65887ee786261862126a?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/3d27afcb949f65887ee786261862126a'>Silvia Li</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-22 6:25 am</div>
				                <div><p>works beautifully! thanks!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15295);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-13185'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/86b213d50d3aaad01a7c2eaade3a408e?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/86b213d50d3aaad01a7c2eaade3a408e'>Emanuele</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-23 8:36 am</div>
				                <div><p>I tried both the solutions but i'm still seeing the inmotionhosting favicon...how can i fix it?</p>
<p>Thanks in advance!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13185);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-23 9:45 am</div>
				                <div>Hello Emanuele,<br />
<br />
Thank you for your question. In most cases, you will not see the new Favicon, until you <a href="http://www.inmotionhosting.com/support/website/how-to/clear-browser-cache">clear your browser cache</a>.<br />
<br />
Also, as a test, try to view the favicon, by navigating directly to it.<br />
<br />
If you have any further questions, feel free to post them below.<br />
Thank you,<br />
<br />
-John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13189);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-23 12:00 pm</div>
				                <div>The favicon should be in the root directory for that domain so if it is an addon domain, you would place it in the directory for that addon domain.  If you need to specifically define a favicon directory, you may do so within your code itself.  Please this in your &lt;head&gt; section of your code to define a specific favicon path:<br />
&lt;p class=&quot;code_block&quot;&gt;&amp;lt;link rel=&quot;shortcut icon&quot; href=&quot;http://example.com/myicon.ico&quot; /&amp;gt;&lt;/p&gt;</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13198);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-22658'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/6d45f6e2a578d423adf62964bc34af41?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/6d45f6e2a578d423adf62964bc34af41'>Miles</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-14 5:57 pm</div>
				                <div><p>I uploaded the new favicon which as the exact same name as the old favicon so I replaced upon uploaded. Then I cleared my browser cache. I still don't see it when I navigate to my site. I can navigate directly to it and see displayed correctly but it doesn't appear where it should. I still see the genertic InMotion favicon.</p>
<p>I can't find the file the has the code to edit. I don't see an index.html file in my web root.</p>
<p>Any ideas?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22658);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-15 3:43 pm</div>
				                <div>Hello Miles,<br />
<br />
I can understand the frustration.  Check out this post about <a href="http://stackoverflow.com/questions/2208933/how-do-i-force-a-favicon-refresh" rel="nofollow" target="_blank">forcing a favicon refresh</a>.  I hope this helps to answer your question, please let us know if you require any further  assistance.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22678);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/11f0be6fdcf7c0cc21eae555ff249ff4?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/11f0be6fdcf7c0cc21eae555ff249ff4'>Website Development </a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-22 12:42 am</div>
				                <div><p>Good source of information. Really helpful post for newbies bloggers.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24351);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
