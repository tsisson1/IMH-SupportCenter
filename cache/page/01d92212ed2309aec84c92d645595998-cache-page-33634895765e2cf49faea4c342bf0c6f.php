<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50729:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/website-design/create-responsive-template" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="keywords" content="Responsive templates website display devicecreate CSS HTML" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="Responsive templates are necessary to have a website display correctly on every device. This article will teach you how to create a Responsive Template in CSS and HTML." />
  <title>206: Creating Responsive Templates | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/website-design/create-responsive-template" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:20cbd2289c03582618d669f6481872bd -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '190.6.239.170']);
...
<div class='page-header'>
	<h1>206: Creating Responsive Templates</h1>
</div>
<div class='section_listing'>
	<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/website-design/206/responsive-template-graphic.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Responsive Template Graphic" src="//cdn.inmotionhosting.com/support/images/stories/edu/website-design/206/responsive-template-graphic.png" title="Click here to view the larger image" width="100" /></a><a href="http://www.inmotionhosting.com/support/website/mobile-devices-responsive-templates-rwd" target="_blank">Responsive templates</a> are necessary to have a website display correctly on every device.  This section will teach how to create Responsive Templates in CSS and HTML.

<br style="clear: both;" />

	<table>
	<tr><td colspan='3'><h2>Introduction to Responsive Web Design</h2><div>Learn about Responsive Web Design RWD or Responsive Templates in these tutorials.</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 1:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/website-design/create-responsive-template/introduction-creating-a-responsive-web-design'>Introduction: Creating a Responsive Web Design</a>
					<div>To begin creating your own Responsive Template, you will need to understand the CSS media property and what type of screens mobile phones, tablets and desktop computers are.</div>
					<div class='smallgrey'>Hits: 8,665</div>
				</td>
			</tr>
		<tr><td colspan='3' style='padding-top:20px;'><h2>Creating a Custom Responsive Template</h2><div>These tutorials will walk your through the steps to create a Resposive Template in HTML and CSS.</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 2:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/website-design/create-responsive-template/adding-html-web-design'>Step 1: Adding HTML to the Responsive Template</a>
					<div>The first step to getting your responsive template created is to add the HTML code for the site. This tutorial will show you what to put in your Responsive Website template.</div>
					<div class='smallgrey'>Hits: 6,838</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/website-design/create-responsive-template/adding-css-styles-web'>Step 2: Adding CSS styles to a Responsive Template</a>
					<div>To get the styles for your Responsive website to change, you will need to create a Desktop, Tablet, and Mobile StyleSheet. This tutorial will show you how.</div>
					<div class='smallgrey'>Hits: 7,506</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/website-design/create-responsive-template/links-stylesheets-responsive-templates'>Step 3: Links to the stylesheets in Responsive Templates</a>
					<div>Once you have the stylesheets created for your responsive Template, you will need to link to them. This article will explain how to use the CSS media attributes for lining your Responsive Template stylesheets.</div>
					<div class='smallgrey'>Hits: 8,955</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/website-design/create-responsive-template/viewpoint-meta-tag-website-responsive-template'>Step 4: Adding the Viewpoint Meta Tag to the Responsive Template</a>
					<div>The last step in making a responsive template is to add the viewpoint Meta tag. This article will explain how.</div>
					<div class='smallgrey'>Hits: 43,276</div>
				</td>
			</tr>
		<tr><td colspan='3' style='padding-top:20px;'><h2>Customize the look of your Responsive Template</h2><div>Now that you have the CSS and HTML for the Responsive Web Design, you can use the jQuery Theme Roller to create a dynamic attractive Responsive website.</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 6:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/website-design/create-responsive-template/jquery-theme-roller-responsive-template'>Responsive template design with the jQuery Theme Roller</a>
					<div>Once you have your Responsive template created, you will now need to style it. This article will teach you how to get a theme by using the jQuery Theme Roller.</div>
					<div class='smallgrey'>Hits: 3,822</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/website-design/create-responsive-template/theme-roller-jquery-style-responsive-template'>Styling a Responsive Template with jQuery Theme Roller</a>
					<div>Now that you have a Theme from jQuery Theme Roller you can style your responsive template with it. Follow this tutorial to learn how to customize the look of a responsive theme.</div>
			...
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/website-design/create-responsive-template/bootstrap-theme-roller'>Custom CSS Styles with the Bootstrap Theme Roller</a>
					<div>You can style your website themes using the Bootstrap Theme Roller. Bootstrap will allow you to reuse CSS classes that will make styling your website easy.</div>
					<div class='smallgrey'>Hits: 8,917</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/website-design/create-responsive-template/adding-the-bootstrap-files-to-your-responsive-template'>Adding the Bootstrap files to your Responsive Template</a>
					<div>After you download the Bootstrap Theme Roller theme from the website, you will need to put the files in to your Responsive template. This article will teach you how.</div>
					<div class='smallgrey'>Hits: 2,468</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/website-design/create-responsive-template/adding-the-bootstrap-menu-buttons-to-your-responsive-template'>Adding the Bootstrap Menu Buttons to your Responsive Template</a>
					<div>You can add dropdown menu buttons to your Responsive Template using the code in Bootstrap. This article will teach you how.</div>
					<div class='smallgrey'>Hits: 10,497</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/website-design/create-responsive-template/bootstrap-common-css-html-classes'>Twitter Bootstrap Common classes and HTML styles</a>
					<div>You can use the Twitter Bootstrap css classes and html to achieve a nicely styled site. Read this article to learn how.</div>
					<div class='smallgrey'>Hits: 4,870</div>
				</td>
			</tr>
		<tr><td colspan='3' style='padding-top:20px;'><h2>Free Responsive Web Design Themes</h2><div>These articles contain Free Responsive Web Design themes that you can customize to your liking.</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 12:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/website-design/create-responsive-template/free-responsive-templates-with-jquery-theme-roller-styles'>Free Responsive Templates with jQuery Theme Roller styles</a>
					<div>You can create many different styles with the jQuery Theme Roller for your Responsive Template. Feel free to download one of the templates and edit it to your specifications.</div>
					<div class='smallgrey'>Hits: 4,934</div>
				</td>
			</tr>
			</table>
</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zOTMmaWQ9MzkzJnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="3919fb9af2def05d324202e116affac2" value="1" />	</div>
	</form>
<!-- <br />
