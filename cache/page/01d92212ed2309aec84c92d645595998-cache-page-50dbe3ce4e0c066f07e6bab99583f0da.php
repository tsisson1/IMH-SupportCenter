...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/cpanel/why-cant-i-log-into-my-cpanel-i-get-an-error-message" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello mrtadesign, I am not getting an error when visiting the cpanel login link, however that link may be blocked on the network you are on due to port ..." />
  <title>Why do I see :2083/login/ when I try to login to cPanel? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/cpanel/why-cant-i-log-into-my-cpanel-i-get-an-error-message" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:b5cb53810393b299a42cb857fe512bcd -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Why do I see :2083/login/ when I try to login to cPanel?</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/mrtadesign'>mrtadesign</a>
			<div>26 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-07-19 9:41 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>2,395</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I can't seem to log into my cPanel. I get the following: https://secure124.inmotionhosting.com:2083/login/<br />
<br />
Also, I am unable to log into my website: mrtanyc.com/admin.php</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_1320' id='upvote_answer_1320' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='1320' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_1320').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_1320' id='downvote_answer_1320' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='1320' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_1320').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello mrtadesign,<br />
<br />
I am not getting an error when visiting the cpanel login link, however that link may be blocked on the network you are on due to port security settings. You can try to get to the cpanel login via http://cpanel.mrtanyc.com this will allow you to go around the port blocking by using the standard internet port 80.<br />
<br />
As to the login at mrtanyc.com/admin.php, I have no way of checking the credentials to ensure they are correct without access to the  database itself. For that, I would need the current cpanel password. If you would like to provide that information for further testing, you can send it to docs@inmotionhosting.com Be sure to validate your account with either the last 4 digits of the credit card on file, or the current Account Management Panel (AMP) password. <br />
<br />
As we do not actively monitor that address, be sure to leave a comment below so we know the information was sent.<br />
<br />
Best Regards,<br />
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_1320').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_1320' id='form_comment_on_answer_1320' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/cpanel/why-cant-i-log-into-my-cpanel-i-get-an-error-message&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/cpanel/why-cant-i-log-into-my-cpanel-i-get-an-error-message'></div>
<script type='text/javascript'>
  (function() {
