<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:61526:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/ftp-client-setup/troubleshoot-filezilla-error-logs" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-01-07T13:05:18-08:00" />
  <meta name="keywords" content="FileZilla Error Log" />
  <meta name="author" content="John-Paul Briones" />
  <meta name="description" content="Learn how to troubleshoot FileZilla Error Logs in this tutorial." />
  <title>Troubleshooting FileZilla Error Logs - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/ftp-client-setup/troubleshoot-filezilla-error-logs" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:8a16b2c51c026bfae65e68b459676b03 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '147.194.188.124']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Troubleshooting FileZilla Error Logs</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Troubleshooting FileZilla Error Logs									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>4,935</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 2, 2015'><span style='color:#606060;'>Published:</span> Jan 7, 2015</div>
...
<button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('530-error');">530 Login authentication failed</button>
<button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('500-error');">500 unrecognized command</button>
<button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('missing-domain');">EAI_NONAME - Neither nodename nor servname provided, or not known</button>
</div>

<p>When you are experiencing issues using <strong>FileZilla</strong> to connect via <strong>FTP</strong>, you can review the <strong>error logs</strong> for common problems. In this guide we will discuss the cause and solution of FileZilla errors. <a href="/support/website/ftp-client-setup/enable-filezilla-logging">Enabling error logging in FileZilla</a>, allows you to save errors in a text file, and view them when needed.</p>


<a name="530-error"></a>
<h2>Response: 530 Login authentication failed</h2>
<pre class="code_block" style="width: 500px;"><span style="color:green">Response: 530 Login authentication failed</span><br>
<span style="color:red">Error: Critical error<br>
Error:  Could not connect to server</span></pre>

<p>This error is caused by an <em>incorrect</em> <strong>username</strong>, or <strong>password</strong>.</p>
<ul><li>Check your <a href="/support/website/ftp/getting-started-guide#view-settings">FTP username/password</a> for spelling errors.</li>
<li><a href="/support/website/ftp/resetting-your-ftp-password-in-cpanel">Reset your FTP password</a></li></ul>


<a name="500-error"></a>
<h2>Response: 500 unrecognized command</h2>

<pre class="code_block" style="width: 500px;"><span style="color:green">Response: 500 unrecognized command</span><br>
<span style="color:red">Error:  Could not connect to server</span></pre>

<p>In my tests, this error is caused by an incorrect <strong>port</strong> setting.</p>
<ul><li>Check that you are using <strong>port 21</strong>.</li></ul>


<a name="missing-domain"></a>
<h2>Status:  Connection attempt failed with "EAI_NONAME - Neither nodename nor servname provided, or not known".</h2>

<pre class="code_block" style="width: 500px;"><span >Status: Connection attempt failed with "EAI_NONAME - Neither nodename nor servname provided, or not known".</span><br>
<span style="color:red">Error:  Could not connect to server</span></pre>

<p>This error occurs when you enter a <strong>hostname</strong> that does not exist. There are several things you can do to fix this problem.</p>
<ul><li>Review the hostname for spelling mistakes.</li>
  <li>Make sure you <a href="/support/domain-names/registrations-and-transfers/registering-a-new-domain-name">registered the Domain</a></li>
  <li>Ensure the domain is <a href="/support/domain-names/dns-nameserver-changes/updating-your-domains-nameservers">pointed to InMotion Hosting</a>.</li>
  <li>Rule out <a href="/support/domain-names/dns-nameserver-changes/domain-names-dns-changes">propagation</a>.</li>
<li>Use the <a href="/support/website/cpanel/how-to-find-your-shared-ip-address-of-your-server-in-cpanel">Shared SSL</a> instead.</li>
</ul>

<p>Congratulations, now you know how to troubleshoot error logs in FileZilla!</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/ftp-client-setup/troubleshoot-filezilla-error-logs&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/ftp-client-setup/troubleshoot-filezilla-error-logs'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MDEmaWQ9MzQ4MiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="e8b96224b3cea305b53799a0100d47a0" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/cyberduck/ftp-connection-via-cyberduck-to-inmotion-skips-some-files?tsrc=rsbraq'>FTP connection via Cyberduck to Inmotion skips some files</a>
                                </div>
