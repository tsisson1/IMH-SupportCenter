...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/moodle/advanced-tutorials" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="keywords" content="moodle advanced" />
  <meta name="description" content="This sections includes the more advanced guides in our Moodle Education Channel" />
  <title>300: Advanced Tutorials | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/moodle/advanced-tutorials" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:f644d79d43bbd70ae870df2e7cbe50dc -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '200.238.102.234']);
...
<div class='section_listing'>
		...
		<tr>
				...
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/advanced-tutorials/import-export-roles'>How to Import & Export Role Definitions in Moodle</a>
					<div>This Moodle guide walks you through exporting and importing role definitions.</div>
					<div class='smallgrey'>Hits: 331</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/advanced-tutorials/additional-name-fields'>Displaying Additional Name Fields in Moodle</a>
					<div>Learn how to choose which name fields show in Moodle profiles.</div>
					<div class='smallgrey'>Hits: 767</div>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/advanced-tutorials/moodle-manual-installation-steps'>How to install Moodle 2.3.2 manually</a>
					<div>This article is a step by step tutorial on how to perform a manual install and setup of Moodle 2.3.2 on a Linux/cpanel hosting server.</div>
					<div class='smallgrey'>Hits: 15,753</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/advanced-tutorials/install-moodle-using-fantastico'>How to install Moodle using Fantastico</a>
					<div>In this tutorial, we will review how to install Moodle using Fantastico in your cPanel account with InMotion Hosting.</div>
					<div class='smallgrey'>Hits: 5,775</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/advanced-tutorials/moodle-requires-php-523-work-around'>Moodle Requires PHP 5.3.2 - Work Around</a>
					<div>Learn the work around for installing Moodle 2.1 since it requires PHP 5.3</div>
					<div class='smallgrey'>Hits: 5,997</div>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/advanced-tutorials/rss-feed-block'>Adding a Remote RSS Feed block in Moodle</a>
					<div>The RSS feed capability in Moodle 2.3 is a great addition to the sites navigation. In Moodle 2.3, RSS feeds can be configured in the Remote RSS Feed Block. This article will explain the Remote RSS feed block.</div>
					<div class='smallgrey'>Hits: 2,599</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/advanced-tutorials/vs-blackboard'>Moodle vs Blackboard</a>
					<div>This guide compares Moodle and Blackboard, so you can better decide which educational software program will better suit  your school or class.</div>
					<div class='smallgrey'>Hits: 1,190</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/advanced-tutorials/install-poodll-plugin'>Installing PoodLL plugins for Moodle</a>
					<div>This guide shows you how to install the PoodLL plugins in Moodle; which adds audio video functionality.</div>
					<div class='smallgrey'>Hits: 380</div>
				</td>
			</tr>
			</table>
</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00ODcmaWQ9NDg3JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="ba883da4b686a1b852307985caed2ee9" value="1" />	</div>
	</form>
<!-- <br />
