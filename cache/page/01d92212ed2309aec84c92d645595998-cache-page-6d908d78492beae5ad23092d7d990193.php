<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:57033:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/php-nuke/add-content-php-nuke/create-externale-link-nuke" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-03-22T18:09:21-07:00" />
  <meta name="keywords" content="create insert internal link php nuke PHP-Nuke" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="This article will explain how to create an external link in PHP-Nuke." />
  <title>How to create an external link in PHP-Nuke - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/php-nuke/add-content-php-nuke/create-externale-link-nuke" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:770333b9b1e4bb25b9a32c3935a69b70 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to create an external link in PHP-Nuke									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>810</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Mar 14, 2013'><span style='color:#606060;'>Published:</span> Mar 22, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>You can create links to external sites through the PHP-Nuke WYSIWYG editor in the admin dashboard. In the tutorials below, we are going to make a link that takes you to <em>http://google.com</em> when clicked.</p>
<h2>Creating an external link</h2>
<ol class="article_list">
<li><a target="_blank" href="/support/website/php-nuke/login-administrator-system" title="Click for more information">Log into your PHP-Nuke Dashboard</a>.</li>
<li><span style="font-weight: bold;"><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phpnuke/102/create-link/create-links-1-edit-page.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Edit the page PHP-Nuke" src="//cdn.inmotionhosting.com/support/images/stories/edu/phpnuke/102/create-link/create-links-1-edit-page.png" title="Click here to view the larger image" width="100" /></a>Edit</span> the page you want to insert a link into. <br style="clear: both;" /></li>
<li><span style="font-weight: bold;"><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phpnuke/102/create-link/create-links-2-insert-edit-link.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Insert/edit link PHP-Nuke" src="//cdn.inmotionhosting.com/support/images/stories/edu/phpnuke/102/create-link/create-links-2-insert-edit-link.png" title="Click here to view the larger image" width="100" /></a>Highlight</span> the text you want to make into a link and click the Insert/edit link button in the WYSIWYG editor. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phpnuke/102/create-link/create-links-3-insert.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Click Insert PHP-Nuke" src="//cdn.inmotionhosting.com/support/images/stories/edu/phpnuke/102/create-link/create-links-3-insert.png" title="Click here to view the larger image" width="100" /></a><strong>Type the url</strong> you want the link to go to. Click <strong>Insert</strong>. <br style="clear: both;" />
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phpnuke/102/create-link/create-links-4-link.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Preview of link PHP-Nuke" src="//cdn.inmotionhosting.com/support/images/stories/edu/phpnuke/102/create-link/create-links-4-link.png" title="Click here to view the larger image" width="100" /></a>Now the text will work as a link that will take you to the url you put in the Insert/edit link box. <br style="clear: both;" /></p>
</li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 2: How to create an external link in PHP-Nuke</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 1: <a href='/support/edu/php-nuke/add-content-php-nuke/edit-homepage-nuke'>How do I edit the Home page in PHP-Nuke?</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 3: <a href='/support/edu/php-nuke/add-content-php-nuke/adding-image'>Adding an Image to a Page in PHP-Nuke</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/php-nuke/add-content-php-nuke/create-externale-link-nuke&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/php-nuke/add-content-php-nuke/create-externale-link-nuke'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zNjImaWQ9NjU0JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="7a1e9d9d5fdb085f4a4b33c754690798" value="1" />	</div>
	</form>
<!-- <br />
