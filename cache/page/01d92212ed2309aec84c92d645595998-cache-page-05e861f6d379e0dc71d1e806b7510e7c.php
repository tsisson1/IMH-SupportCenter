<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:52319:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/dns-nameserver-changes/how-to-point-domain-in-office-365-to-inmotion" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, Thank you for your question on pointing to our servers from another DNS controller. If you have GoDaddy pointing to 365's name servers, then to h..." />
  <title>How to point domain in Office 365 to InMotion  | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/dns-nameserver-changes/how-to-point-domain-in-office-365-to-inmotion" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:dc591b16000d0337e4bdde8d8c90a095 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>How to point domain in Office 365 to InMotion </h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-11-02 1:32 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>236</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>The domain I'm working with used to be hosted somewhere my friend forgot the logins to. So we wanted to migrate everything into InMotion. I duplicated the Wordpress files and uploaded it to the new host. Now, all we had to do was change the nameservers for the domain in GoDaddy to the InMotion nameservers, which we'd done before. But the problem is, the nameservers in GoDaddy point to Office 365 where the DNS is managed. We don't want to mess up the email setup on Office 365 so we wanted to redirect from Office 365 to the new host. <br />
<br />
I went into Office 365 and added a new A record in the DNS management section to point to InMotion. I also added a CNAME record for www. I was able to extract the files and login to the Wordpress dashboard at mydomain.com/wp-admin. But whenever I try accessing the domain itself, it gives me the Domain Default Page.<br />
<br />
I'm guessing I didn't add enough records to Office 365 to properly point to InMotion? Office 365 is not very helpful with this type of setup. I tried reading up but they only have one article on it that isn't very helpful at all. <br />
<br />
Would appreciate a little help with this.<br />
<br />
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_8434' id='upvote_answer_8434' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='8434' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_8434').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_8434' id='downvote_answer_8434' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='8434' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_8434').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
Thank you for your question on pointing to our servers from another DNS controller. If you have GoDaddy pointing to 365's name servers, then to have the site display from our servers, they should need nothing more than <a href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/updating-your-domains-nameservers">an A record pointing to your server here</a>.<br />
<br />
I checked all the domains on your site and found only one that points to other nameservers. In checking that domain, it is indeed pointing to us. There is an index.html page that appears to be blocking visitors from viewing the front page of the site (index.php page) so simply renaming that or removing it will show your actual site.<br />
<br />
Kindest Regards,<br />
Scott M<br />
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_8434').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_8434' id='form_comment_on_answer_8434' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>It worked! Thanks a lot, Scott! I would have died trying different DNS settings before figuring out to change the name of the index.html file! </div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='/support/images/avatars/default_avatar.jpg' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/manolomartinez36@yahoo&per;com'>manolomartinez36@yahoo.com</a><br />
									8 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2015-11-02 1:52 pm EST
								</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/dns-nameserver-changes/how-to-point-domain-in-office-365-to-inmotion&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/dns-nameserver-changes/how-to-point-domain-in-office-365-to-inmotion'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="02f40dfccc5a52627577adac624511e0" value="1" />	</div>
	</form>
<!-- <br />
