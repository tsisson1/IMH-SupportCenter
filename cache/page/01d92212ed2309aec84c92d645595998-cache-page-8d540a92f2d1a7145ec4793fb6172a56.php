...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-3/getting-started" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Learn how to install Joomla 3.0 and what your next steps are after installation." />
  <title>101: Getting started with Joomla 3 | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-3/getting-started" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:0522df26b1c2cf4c56b79002c4686ccd -->
...
<div class='page-header'>
	<h1>101: Getting started with Joomla 3</h1>
</div>
<div class='section_listing'>
		...
		<tr>
				...
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-3/getting-started/install-joomla-3'>How to install Joomla 3</a>
					<div>Learn how to install Joomla 3.0 by following these easy installation steps.</div>
					<div class='smallgrey'>Hits: 40,244</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-3/getting-started/login-dashboard'>How to log into the Joomla 3.1 Administrator Dashboard</a>
					<div>After installing Joomla 3.0, your next step will be to log into your Joomla 3.0 admin dashboard. This is where you will do most of your site administration from.</div>
					<div class='smallgrey'>Hits: 31,864</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-3/getting-started/remind-admin-username'>I forgot my Joomla 3 admin username</a>
					<div>If you've forgotten your Joomla 3.0 admin username, you can tell Joomla to email it to you.</div>
					<div class='smallgrey'>Hits: 7,000</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-3/getting-started/super-admin-cant-request-password'>Reset password failed: A Super Administrator can't request a password reminder</a>
					<div>If you're forgotten your joomla 3.0 admin password, you can easily use phpMyAdmin to reset it. Let us show you how.</div>
					<div class='smallgrey'>Hits: 13,324</div>
				</td>
			</tr>
			</table>
</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yMjYmaWQ9MjI2JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
