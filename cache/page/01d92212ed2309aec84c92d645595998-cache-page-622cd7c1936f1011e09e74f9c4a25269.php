<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:82832:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/getting-started-guides/awstats-statistics-website-traffic" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-05-14T23:15:53-07:00" />
  <meta name="keywords" content="awstats statisitcs cpanel tool visitors" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="Learn what the AWSTATS tool is, how often it updates, and what information it displays." />
  <title>AWStats: View Statistics about your Website Traffic - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/getting-started-guides/awstats-statistics-website-traffic" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:9aeb1aedddf15babbc5da8c1569cfed6 -->
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>AWStats: View Statistics about your Website Traffic</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															AWStats: View Statistics about your Website Traffic									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>8,862</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Aug 25, 2011'><span style='color:#606060;'>Published:</span> May 14, 2014</div>
  ...
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('what');">What Information Can I View</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('access');">How to Access AWSTATS</button>
  <button type="button" class="btn btn-danger" onclick="trackAnchorClickSC('troubleshoot');">Troubleshooting</button>
</div>
<p><strong>AWSTATS</strong> is a tool in your <em>cPanel</em> that produces visual statistics about visitors to your website.</p>
<p class="alert alert-info">View our <a href="http://www.inmotionhosting.com/support/website/stats-logging/awstats-review-website-stats" target="_blank">reviewing website stats with AWStats</a> guide for screenshots of what you can view with AWStats.</p>

<a name="what"></a><h2>What Information can I View in AWSTATS?</h2>
<ul>
<li>&nbsp;Top 25 Pages</li>
<li>&nbsp;Visit Duration</li>
<li>&nbsp;Number of visitors to your site each month</li>
<li>&nbsp;Number of visitors to your site per each day in a month</li>
<li>&nbsp;Number of hits to your site per country</li></ul>

<a name="access"></a><h2>How to Access AWSTATS:</h2>
<ol class="article_list">
  <li><a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel" target="_blank">Login to your cPanel</a>.</li>
<li>Under <em>Logs</em> click the <strong>AWSTATS</strong> button.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/awstats/awstats-button.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/awstats/awstats-button.png" alt="opening awstats from cpanel" title="clicking awstats button" /></a><br><br>
You will then see a listing of the domain names on your account. Click the magnifying glass icon next to the domain name you wish to see stats for.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/awstats/awstats-magnify.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/awstats/awstats-magnify.png" alt="Viewing awstats in cpanel" title="magnify button awstats" /></a><br></li>
<br>
</ol>

<a name="troubleshoot"></a><h2>Troubleshooting:</h2>
Vital processes for keeping your website up, have a higher priority than statistic processing, so sometimes a server can get behind on its report calculations.  If your stats have not updated in over <strong>36 hours</strong>, you can manually run them from cPanel. This guide will walk-you through:<br><br>
<ul><li><a href="/support/website/stats-logging/update-awstats" target="_blank">Manually updating your Awstats through cPanel</a></li></ul>

<h3>Additional Information:</h3>
<p>AWSTATS uses terms such as: unique visitors, number of visits, pages, hits, and a few others. Many of these terms do sound very similar. For a detailed explanation of these terms, please see the following link:<br>
<a href="http://awstats.sourceforge.net/docs/awstats_glossary.html" target="_blank" >http://awstats.sourceforge.net/docs/awstats_glossary.html</a></p> 
...
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/getting-started-guides/awstats-statistics-website-traffic'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MiZpZD0zNiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/cpanel/stats-program-is-locked-out-by-administrator?tsrc=rsbraq'>Stats program is locked out by administrator.</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/website/any-way-to-find-out-about-web-site-traffic?tsrc=rsbraq'>Any way to find out about web site traffic?</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/cpanel/interpreting-awstats?tsrc=rsbraq'>Interpreting AWSTATS</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/blacklist-check/see-more-visitor-ip-address-from-previous-calendar-dates?tsrc=rsbraq'>See more visitor IP address from previous calendar dates </a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/22b71daf50b01f44b1f8c7872afd67cb?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/22b71daf50b01f44b1f8c7872afd67cb'>Nazir Bhagat</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-26 8:13 am</div>
				                <div><p>Carlos was very helpful today. Thanks.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10156);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-27 11:57 pm</div>
				                <div>Hello Nazir,<br />
<br />
Thank you for the compliment, we will pass on the information to Carlos and his supervisor!<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10210);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-13 5:16 pm</div>
				                <div><p>AW stats is fascinating. &nbsp;Now that I know it's there, I need to decide how I can benefit from it and improve my traffic.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10615);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-13 5:24 pm</div>
				                <div>Hello Preston,<br />
<br />
Thanks for the comment!  Check out our latest article on <a href="http://www.inmotionhosting.com/support/website/stats-logging/awstats-review-website-stats">AWstats</a> for more information!<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10616);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-24618'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/0fc111de7c92c635831964807ae6859c?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/0fc111de7c92c635831964807ae6859c'>Harpreet Singh</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-04 9:23 am</div>
				                <div><p>Awstats are not working correctally for me. Its showing correct page views and hits but not showing correct visitors.</p>
<p>Can you please help me on this ?.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24618);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-06 3:59 pm</div>
				                <div>If you are one of our customers, you can contact our Live Support for account specific investigation.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24667);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-14 11:16 pm</div>
				                <div>for wordpress sites do you know of a plugin that does more/better than  AWStats? i've been using Counterize plugin and it hasn't been updated for 2 years. it seems to me AWStats gives all the same data as Counterize. so i'm going to remove Counterize for sure and use AWStats or a better one if you have a suggestion.<br />
thank you!</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24888);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-15 2:06 pm</div>
				                <div>Hello TheBoatPeople,<br />
<br />
We don't have a particular recommendation, though you may want to consider using something like Google Analytic.  There are also many comparisons such as <a href="http://allbloggingtips.com/2012/01/15/10-best-statistics-plugin-for-wordpress/" rel="nofollow" target="_blank">this one</a> which may provide different soul.<br />
<br />
If you have any further questions or comments, please let us know.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24912);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-28440'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/40c3cee89f901f51f55afeb4f3090c7f?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/40c3cee89f901f51f55afeb4f3090c7f'>Rogen</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-16 2:55 am</div>
				                <div><p><span style="color: #232323; font-family: adelle-sans, Helvetica, Arial, sans-serif;"><span style="font-size: 13px; line-height: 22px;">Awstats are not&nbsp;&lt;a href="http://www.rozapk.com"&gt;working&lt;/a&gt;&nbsp;correctally for me. Its showing correct page views and hits but not&nbsp;showing correct visitors.</span></span></p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28440);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-16 11:08 am</div>
				                <div>Hello Rogen,<br />
<br />
Sorry for the problem with the Awstats.  If you are a hosting customer, then you <a href="http://www.inmotionhosting.com/support/website/getting-started-guides/submitting-and-checking-on-status-of-tickets">submit a verified support ticket</a> to have the stats checked.  Otherwise, you will need to speak with your hosting support to determine what's happening with your website stats.  <br />
<br />
Apologies that we can't help you directly on this issue.  If you have any further questions or comments, please let us know.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28449);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
