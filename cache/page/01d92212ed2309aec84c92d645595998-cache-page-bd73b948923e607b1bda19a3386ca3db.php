<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:56094:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/wordpress/organize-posts-alphabetical-order" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-04-20T17:51:48-07:00" />
  <meta name="author" content="Christopher Maiorana" />
  <meta name="description" content="InMotion Hosting Support Center" />
  <title>How To Organize Posts in Alphabetical Order in WordPress - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/wordpress/organize-posts-alphabetical-order" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:00f16f6961f4d4356d0301c70e787ef0 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '81.61.154.129']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How To Organize Posts in Alphabetical Order in WordPress									</h1>
			
																
				
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Written by Christopher Maiorana</div>
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>118</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Dec 24, 2015'><span style='color:#606060;'>Published:</span> Apr 20, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In our <a href="http://www.inmotionhosting.com/support/edu/wordpress">WordPress tutorial series</a> you have already seen how to install the WordPress core files and begin publishing content to your site in the form of posts, pages, media, etc. After reading this article you will know how to organize your posts alphabetically for your readers.</p>

<p>By default, WordPress will display published posts in the order they were published. This can be changed by adding a snippet of code to the <strong>functions.php</strong> file in the WordPress core configuration.</p>
<p>Bear in mind, editing the source code of your WordPress installation can be hazardous. Make sure to copy the code samples and paste them exactly.</p>
<h2 id="editing-the-functions-php-file">Editing the &quot;functions.php&quot; File</h2>
<p>You will need to access the <strong>functions.php</strong> file in the <em>wp-content/themes</em> folder for the WordPress theme you&#39;re using. In this example, I&#39;m using the default &quot;twentysixteen&quot; theme.</p>
<p>Here is the code you will need:</p>
<pre class="editor-colors lang-text"><div class="line"><span class="text plain"><span class="meta paragraph text"><span>function&nbsp;foo_modify_query_order(&nbsp;$query&nbsp;)&nbsp;{</span></span></span></div><div class="line"><span class="text plain"><span>&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="meta paragraph text"><span>if&nbsp;(&nbsp;$query-&gt;is_home()&nbsp;&amp;&amp;&nbsp;$query-&gt;is_main_query()&nbsp;)&nbsp;{</span></span></span></div><div class="line"><span class="text plain"><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="meta paragraph text"><span>$query-&gt;set(&nbsp;&#39;orderby&#39;,&nbsp;&#39;title&#39;&nbsp;);</span></span></span></div><div class="line"><span class="text plain"><span class="meta paragraph text"><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$query-&gt;set(&nbsp;&#39;order&#39;,&nbsp;&#39;ASC&#39;&nbsp;);</span></span></span></div><div class="line"><span class="text plain"><span>&nbsp;&nbsp;&nbsp;&nbsp;</span><span class="meta paragraph text"><span>}</span></span></span></div><div class="line"><span class="text plain"><span class="meta paragraph text"><span>}</span></span></span></div><div class="line"><span class="text plain"><span class="meta paragraph text"><span>add_action(&nbsp;&#39;pre_get_posts&#39;,&nbsp;&#39;foo_modify_query_order&#39;&nbsp;);</span></span></span></div></pre><p>Place the above snippet of text on the first available line after the initial comments.</p>

<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/sort-posts-abc/alphcode.png"><img   alt="Post in alphabetical order" src="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/sort-posts-abc/alphcode.png" title="Click here to view the larger image" width="200"></a>

<p>You can <a href="http://www.webhostinghub.com/help/learn/website/managing-files/file-management">edit</a> the functions.php file with any text editor or via FTP or the cPanel File manager.</p>
<p>After adding the code snippet, save the file, and reload your Wordpress front page. You&#39;ll now notice your posts diplay in alphabetical order on your front page.</p>
<p>This <a href="https://codex.wordpress.org/Alphabetizing_Posts">modification</a> can also be applied to individual categories.</p>
<h2 id="word-of-warning">Word of Warning</h2>
<p>Whenever editing the source code of any WordPress installation it is always wise to save a backup of the original file. An accidental edit can inadvertently wipe out critical data.</p>
<p>In the case of WordPress themes, you can keep an untouched copy in a safe location to be restored if necessary; or, if possible, you can re-download the source files from the developer.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 3: How To Organize Posts in Alphabetical Order in WordPress</div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/wordpress/organize-posts-alphabetical-order&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/wordpress/organize-posts-alphabetical-order'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD03MSZpZD0zNjk4JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="621aa255e6d0f89d79d5eca79a8c036c" value="1" />	</div>
	</form>
<!-- <br />
