<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50203:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/ssl/certificate-warning-despite-installation-of-ssl" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, Thanks for the question! The SSL certificate on your VPS is set to a self-signed certificate by default. In order to change it, you would need to..." />
  <title>Service Certificate still assigned to Self-signed Certificate | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/ssl/certificate-warning-despite-installation-of-ssl" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:3c269e8751aba0c1da7d48b9c3f01c0b -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-20']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '174.92.199.96']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Service Certificate still assigned to Self-signed Certificate</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-01-30 5:29 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>136</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>hi I have confirmation of successful installation of ssl on my vps but i am continuing to receive certificate warning on accessing email via the your url for the web</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_6423' id='upvote_answer_6423' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='6423' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_6423').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_6423' id='downvote_answer_6423' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='6423' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_6423').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
Thanks for the question!  The SSL certificate on your VPS is set to a <a href="http://www.inmotionhosting.com/support/website/ssl/self-signed-ssl-certificate-warning">self-signed certificate</a> by default.  In order to change it, you would need to login to your WHM, then go to the Manage Service SSL Certificates.  Scroll down the screen and you will see the area where you can assign your SSL.  Remember that it is URL specific, so don't assign one that's not associated to your domain.  If you are unable to see this section, then you will need to <a href="http://www.inmotionhosting.com/support/website/getting-started-guides/submitting-and-checking-on-status-of-tickets">submit a verified support ticket</a>  via email.  <br />
<br />
...
Arnel C.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_6423').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_6423' id='form_comment_on_answer_6423' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/ssl/certificate-warning-despite-installation-of-ssl&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/ssl/certificate-warning-despite-installation-of-ssl'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="edafea4ad407a64cb7dd11abe08c0d74" value="1" />	</div>
	</form>
<!-- <br />
