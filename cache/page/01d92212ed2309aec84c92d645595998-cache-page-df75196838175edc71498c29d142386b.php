<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:81921:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/wordpress/wordpress-security-plugins/recommended-security-plugins" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-03-04T16:05:43-08:00" />
  <meta name="keywords" content="recommended security plugins wordpress" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="This article lists the most popular and recommended security plugins from WordPress." />
  <title>Recommended WordPress Security plugins - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/wordpress/wordpress-security-plugins/recommended-security-plugins" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:6bbbf3842bc686857cd7ed2bfca4380d -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '192.116.55.118']);
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/wordpress' itemprop='url'><span itemprop='title'>WordPress<span></a><div class='dropdown_4columns'><h2>WordPress Education Channel</h2><div class='col_2'><h3>100 Level Classes</h3><div><a href='/support/edu/wordpress/wordpress-updates-beta'>100: Wordpress Updates</a></div><div><a href='/support/edu/wordpress/wordpress-introduction'>101: An introduction to WordPress</a></div><div><a href='/support/edu/wordpress/wordpress-features'>102: WordPress Features</a></div><div><a href='/support/edu/wordpress/installing-wordpress-theme'>103: Installing a Theme</a></div><div><a href='/support/edu/wordpress/wordpress-plugins-widgets'>104: Introduction to Plugins and Widgets</a></div><div><a href='/support/edu/wordpress/change-wordpress-appearance'>105: Changing the Wordpress Appearance</a></div></div><div class='col_2'><h3>200 Level Classes</h3><div><a href='/support/edu/wordpress/recommended-wordpress-plugins'>201: Recommended WordPress Plugins</a></div><div><a href='/support/edu/wordpress/migrating-wordpress-inmotion-hosting'>202: Migrating your Existing WordPress site to InMotion Hosting</a></div><div><a href='/support/edu/wordpress/wordpress-mu-network'>203: WordPress MU/ Network</a></div><div><a href='/support/edu/wordpress/customize-wp-sidebar'>204: Customizing your Wordpress Sidebar</a></div><div><a href='/support/edu/wordpress/wordpress-security-plugins'>205: WordPress security Plugins</a></div><div><a href='/support/edu/wordpress/wordpress-image-galleries'>206:Using WordPress for Showing Images</a></div><div><a href='/support/edu/wordpress/photographers-guide-wordpress'>207: Photographers Guide to a Simple WordPress Site</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/wordpress/wordpress-security-plugins' itemprop='url'><span itemprop='title'>205: WordPress security Plugins<span></a><div class='dropdown_3columns'><h2> WordPress security Plugins</h2><div class='col_3'><div>1. <a style='display:inline;' href='/support/edu/wordpress/wordpress-security-plugins/recommended-security-plugins'>Recommended WordPress Security plugins</a></div><div>2. <a style='display:inline;' href='/support/edu/wordpress/wordpress-security-plugins/wordfence-security-plugin'>Using the WordFence Security plugin for WordPress</a></div><div>3. <a style='display:inline;' href='/support/edu/wordpress/wordpress-security-plugins/wordpress-bulletproof-security-plugin-configuration'>WordPress BulletProof Security plugin configuration</a></div><div>4. <a style='display:inline;' href='/support/edu/wordpress/wordpress-security-plugins/configuring-the-wordpress-better-wp-security'>Configuring the WordPress Better WP Security</a></div><div>5. <a style='display:inline;' href='/support/edu/wordpress/wordpress-security-plugins/installing-the-wordpress-mvis-security-center-plugin'>Installing the WordPress MVIS Security Center plugin</a></div><div>6. <a style='display:inline;' href='/support/edu/wordpress/wordpress-security-plugins/using-the-login-security-solutions-wordpress-plugin'>Using the Login Security Solutions WordPress plugin</a></div><div>7. <a style='display:inline;' href='/support/edu/wordpress/wordpress-security-plugins/installing-the-simple-security-wordpress-plugin'>Installing the Simple Security WordPress plugin.</a></div><div>8. <a style='display:inline;' href='/support/edu/wordpress/wordpress-security-plugins/wanggaurd-plugin'>Seting up the WangGaurd plugin for WordPress</a></div><div>9. <a style='display:inline;' href='/support/edu/wordpress/wordpress-security-plugins/how-to-install-and-use-the-security-ninja-lite-wordpress-plugin'>How to install and use the Security Ninja Lite WordPress plugin</a></div><div>10. <a style='display:inline;' href='/support/edu/wordpress/wordpress-security-plugins/installing-the-look-see-security-plugin-for-wordpress'>Installing the Look-See Security plugin for WordPress</a></div><div>11. <a style='display:inline;' href='/support/edu/wordpress/wordpress-security-plugins/install-and-set-up-the-sucuri-security-sitecheck-malware-scanner-plugin-for-wordpress'>Install and Set up the Sucuri Security - SiteCheck Malware Scanner plugin for WordPress</a></div><div>12. <a style='display:inline;' href='/support/edu/wordpress/wordpress-security-plugins/how-to-install-the-secure-folder-wp-content-uploads-plugin-for-wordpress'>How to install the Secure Folder wp-content/uploads plugin for WordPress</a></div><div>13. <a style='display:inline;' href='/support/edu/wordpress/wordpress-security-plugins/wp-recaptcha'>How to install WP-reCAPTCHA in WordPress</a></div><div>14. <a style='display:inline;' href='/support/edu/wordpress/wordpress-security-plugins/cleff-login-no-phone-service'>Logging in with Clef when you have no Internet connection on your Phone</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Recommended WordPress Security pl...</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Recommended WordPress Security plugins									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>12,876</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Mar 27, 2013'><span style='color:#606060;'>Published:</span> Mar 4, 2014</div>
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Comments:</span> <a href='#comments'>6</a></div>
							<div style='clear:both;'></div>
								...
								<p>There are many different security plugins available for WordPress. Below are the most recommended plugins and a brief explanation of the plugin from the developers.</p>

<h2><a href="http://www.wordfence.com/" target="_blank" title="Click here for the plugin developers site">Wordfence Security</a></h2>
<p style="margin-top:0px;margin-left:10px;"><strong>Plugin site URL:</strong> http://www.wordfence.com/<br /><strong>Notes from the plugin developer:</strong> &quot;Wordfence Security is a free enterprise class security plugin that includes a firewall, anti-virus scanning, malicious URL scanning and live traffic including crawlers. Wordfence is the only WordPress security plugin that can verify and repair your core, theme and plugin files, even if you don't have backups.
Wordfence is now Multi-Site compatible.&quot;</p>



<h2><a href="http://www.ait-pro.com/" target="_blank" title="Click here for the plugin developers site">BulletProof Security</a></h2>
<p style="margin-top:0px;margin-left:10px;"><strong>Plugin site URL:</strong> http://www.ait-pro.com/<br /><strong>Notes from the plugin developer:</strong> &quot;WordPress Website Security Protection: BulletProof Security protects your WordPress website against XSS, RFI, CRLF, CSRF, Base64,
...
bb-config.php, php.ini, php5.ini, install.php and readme.html with .htaccess security protection. Security Logging. HTTP Error Logging.&quot;</p>
  
<h2><a href="http://bit51.com/" target="_blank" title="Click here for the plugin developers site">Better WP Security</a></h2>
<p style="margin-top:0px;margin-left:10px;"><strong>Plugin site URL:</strong> http://bit51.com/<br /><strong>Notes from the plugin developer:</strong> &quot;Better WP Security takes the best Wordpress security features and techniques and combines them in a single plugin thereby ensuring that as many security holes as possible are patched without having to worry about conflicting features or the possibility of missing anything on your site.&quot;</p>
  
<h2><a href="https://www.sec-consult.com/en" target="_blank" title="Click here for the plugin developers site">MVIS Security Center</a></h2>
<p style="margin-top:0px;margin-left:10px;"><strong>Plugin site URL:</strong> https://www.sec-consult.com/en<br /><strong>Notes from the plugin developer:</strong> &quot;Official Launch
The beta phase is officially over and we are very happy with the feedback and reception so far! Thanks for all your support!
We have implemented a coupon system, so upon subscribing multiple sites you will receive coupons that can be entered to activate any other plugin.
This allows you to share subscription costs and get a juicy discount!
Security has never been this simple!&quot;</p>


<h2><a href="http://www.analysisandsolutions.com/" target="_blank" title="Click here for the plugin developers site">Login Security Solution</a></h2>
<p style="margin-top:0px;margin-left:10px;"><strong>Plugin site URL:</strong> http://www.analysisandsolutions.com/<br /><strong>Notes from the plugin developer:</strong> &quot;A simple way to lock down login security for multisite and regular
...
If a login failure uses data matching a past failure, the plugin.&quot;</p>



<h2><a href="http://www.artistscope.com/" target="_blank" title="Click here for the plugin developers site">Secure Image Protection</a></h2>
<p style="margin-top:0px;margin-left:10px;"><strong>Plugin site URL:</strong> http://www.artistscope.com/<br /><strong>Notes from the plugin developer:</strong> &quot;Insert Secure Image Pro encrypted images to pages and posts from your WordPress page editor that are supported across all web browsers on all operating systems, ie: Windows, Mac and Linux. Hand-held devices that can use Java will also be supported.
Easy install.
Upload and embed encrypted images using WordPress native media tools.&quot;</p>


<h2><a href="http://mywebsiteadvisor.com/" target="_blank" title="Click here for the plugin developers site">Simple Security</a></h2>
<p style="margin-top:0px;margin-left:10px;"><strong>Plugin site URL:</strong> http://mywebsiteadvisor.com/<br /><strong>Notes from the plugin developer:</strong> &quot;Simple Security Plugin for WordPress is an Access Log to track Logins and Failed Login Attempts for the admin area of your WordPress Website
...
Configurable email alert notifications when selected conditions are met.&quot;</p>



<h2><a href="http://www.webfactoryltd.com/" target="_blank" title="Click here for the plugin developers site">Security Ninja Lite</a></h2>
<p style="margin-top:0px;margin-left:10px;"><strong>Plugin site URL:</strong> http://www.webfactoryltd.com/ <br /><strong>Notes from the plugin developer:</strong> &quot;Visit Security Ninja's homepage for more details, FAQ and documentation.
perform numerous security tests with one click
...
more test coming daily.&quot;</p>


<h2><a href="http://www.seomix.fr/" target="_blank" title="Click here for the plugin developers site">User Name Security - By SeoMix</a></h2>
<p style="margin-top:0px;margin-left:10px;"><strong>Plugin site URL:</strong> http://www.seomix.fr/<br /><strong>Notes from the plugin developer:</strong> &quot;WordPress automaticaly uses User login to fill in User Display Name. WordPress also allows everyone to use the same value for Nickanme, Display Name and Login. A hacker may use this information to find your login. And the body_class function also shows to everyone your User ID and Nicename ont author pages.
Once activated, User Name Security will prevent WordPress from showing those informations.&quot;</p>



<h2><a href="http://www.blobfolio.com/" target="_blank" title="Click here for the plugin developers site">Look-See Security Scanner</a></h2>
<p style="margin-top:0px;margin-left:10px;"><strong>Plugin site URL:</strong> http://www.blobfolio.com/<br /><strong>Notes from the plugin developer:</strong> &quot;Look-see Security Scanner is a relatively quick and painless way to locate the sorts of file irregularities that turn up when a site is hacked. This is broken down into multiple searches:
...
Search wp-content/uploads/ for hidden PHP scripts;.&quot;</p>


<h2><a href="http://www.iosec.org/" target="_blank" title="Click here for the plugin developers site">IOSEC HTTP Anti Flood/DoS Security Gateway Module</a></h2>
<p style="margin-top:0px;margin-left:10px;"><strong>Plugin site URL:</strong> http://www.iosec.org/<br /><strong>Notes from the plugin developer:</strong> &quot;This module provides security enhancements against (HTTP) Flood & Brute Force Attacks for Wordpress.
...
<h2><a href="http://ruanglaba.com/" target="_blank" title="Click here for the plugin developers site">Secure Folder wp-content/uploads</a></h2>
<p style="margin-top:0px;margin-left:10px;"><strong>Plugin site URL:</strong> http://ruanglaba.com/<br />
<strong>Notes from the plugin developer:</strong> &quot;This is plugin will put empty index.html on every folders on wp-content/uploads to prevent content theft.&quot;</p> 
  
  
  
<h2><a href="http://wordpress.org/extend/plugins/transparency-secured-images/" target="_blank" title="Click here for the plugin developers site">Transparent Secured Images</a> </h2>
<p style="margin-top:0px;margin-left:10px;"><strong>Plugin site URL:</strong> http://wordpress.org/extend/plugins/transparency-secured-images/<br /><strong>Notes from the plugin developer:</strong> &quot;This plugin will use jQuery and JavaScript, as well as CSS3, to secure your images a little bit more.
...
The plugin will replace your image with a transparent image and set your image, you want to show to the user, as background.&quot;</p>



<h2><a href="http://wordpress.org/plugins/all-in-one-wp-security-and-firewall/" target="_blank" title="Click here for the plugin developers site">All In One WP Security & Firewall</a></h2>
<p style="margin-top:0px;margin-left:10px;"><strong>Plugin site URL:</strong> http://wordpress.org/plugins/all-in-one-wp-security-and-firewall/<br /><strong>Notes from the plugin developer:</strong> &quot;WordPress itself is a very secure platform. However, it helps to add some extra security and firewall to your site by using a security plugin that enforces a lot of good security practices.  The All In One WordPress Security plugin will take your website security to a whole new level.  This plugin is designed and written by experts and is easy to use and understand.  It reduces security risk by checking for vulnerabilities, and by implementing and enforcing the latest recommended WordPress security practices and techniques.&quot;</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/wordpress/wordpress-security-plugins'>205: WordPress security Plugins</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 1: Recommended WordPress Security plugins</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 2: <a href='/support/edu/wordpress/wordpress-security-plugins/wordfence-security-plugin'>Using the WordFence Security plugin for WordPress</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/wordpress/wordpress-security-plugins/recommended-security-plugins&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/wordpress/wordpress-security-plugins/recommended-security-plugins'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zNjcmaWQ9MjU0MSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="b046f188b22b6db9306517acf8584c40" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/wordpress/wordpress-security-plugins?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> WordPress security Plugins</h3></a>
		<table><tr><td colspan='2'><h4>Overview of Security Plugins</h4></td></tr>  <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/wordpress/wordpress-security-plugins/recommended-security-plugins?tsrc=rsbedu'>Recommended WordPress Security plugins</a></td>
                </tr>
        <tr><td colspan='2'><h4>Complete Security plugins</h4></td></tr>  <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/wordpress/wordpress-security-plugins/wordfence-security-plugin?tsrc=rsbedu'>Using the WordFence Security plugin for WordPress</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/wordpress/wordpress-security-plugins/wordpress-bulletproof-security-plugin-configuration?tsrc=rsbedu'>WordPress BulletProof Security plugin configuration</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/wordpress/wordpress-security-plugins/configuring-the-wordpress-better-wp-security?tsrc=rsbedu'>Configuring the WordPress Better WP Security</a></td>
                </tr>
          <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/wordpress/wordpress-security-plugins/installing-the-wordpress-mvis-security-center-plugin?tsrc=rsbedu'>Installing the WordPress MVIS Security Center plugin</a></td>
                </tr>
          <tr >
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/wordpress/wordpress-security-plugins/using-the-login-security-solutions-wordpress-plugin?tsrc=rsbedu'>Using the Login Security Solutions WordPress plugin</a></td>
                </tr>
          <tr >
                        <td valign='top'>7.</td>
                        <td><a href='/support/edu/wordpress/wordpress-security-plugins/installing-the-simple-security-wordpress-plugin?tsrc=rsbedu'>Installing the Simple Security WordPress plugin.</a></td>
                </tr>
          <tr >
                        <td valign='top'>8.</td>
                        <td><a href='/support/edu/wordpress/wordpress-security-plugins/wanggaurd-plugin?tsrc=rsbedu'>Seting up the WangGaurd plugin for WordPress</a></td>
                </tr>
        <tr><td colspan='2'><h4>Security Analysis Plugins</h4></td></tr>  <tr >
                        <td valign='top'>9.</td>
                        <td><a href='/support/edu/wordpress/wordpress-security-plugins/how-to-install-and-use-the-security-ninja-lite-wordpress-plugin?tsrc=rsbedu'>How to install and use the Security Ninja Lite WordPress plugin</a></td>
                </tr>
          <tr >
                        <td valign='top'>10.</td>
                        <td><a href='/support/edu/wordpress/wordpress-security-plugins/installing-the-look-see-security-plugin-for-wordpress?tsrc=rsbedu'>Installing the Look-See Security plugin for WordPress</a></td>
                </tr>
          <tr >
                        <td valign='top'>11.</td>
                        <td><a href='/support/edu/wordpress/wordpress-security-plugins/install-and-set-up-the-sucuri-security-sitecheck-malware-scanner-plugin-for-wordpress?tsrc=rsbedu'>Install and Set up the Sucuri Security - SiteCheck Malware Scanner plugin for WordPress</a></td>
                </tr>
        <tr><td colspan='2'><h4>Other Security Plugins</h4></td></tr>  <tr >
                        <td valign='top'>12.</td>
                        <td><a href='/support/edu/wordpress/wordpress-security-plugins/how-to-install-the-secure-folder-wp-content-uploads-plugin-for-wordpress?tsrc=rsbedu'>How to install the Secure Folder wp-content/uploads plugin for WordPress</a></td>
                </tr>
          <tr >
                        <td valign='top'>13.</td>
                        <td><a href='/support/edu/wordpress/wordpress-security-plugins/wp-recaptcha?tsrc=rsbedu'>How to install WP-reCAPTCHA in WordPress</a></td>
                </tr>
          <tr >
                        <td valign='top'>14.</td>
                        <td><a href='/support/edu/wordpress/wordpress-security-plugins/cleff-login-no-phone-service?tsrc=rsbedu'>Logging in with Clef when you have no Internet connection on your Phone</a></td>
                </tr>
          	</table>
			...
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/wordpress/web-site-hack-which-will-be-better-wordfence-or-bollet-proof?tsrc=rsbraq'>Web site hack  which will be better Wordfence or bollet proof</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/01fad27562a90aeb03be3aa5923b6a95?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/01fad27562a90aeb03be3aa5923b6a95'>peter</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-04 3:54 am</div>
				                <div><p>Hi,</p>
<p>Is there any chance that you could please include the All In One WP Security &amp; Firewall plugin on your "recommended-security-plugins" page?</p>
<p>http://wordpress.org/plugins/all-in-one-wp-security-and-firewall/</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8750);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-04 12:07 pm</div>
				                <div>As this is indeed a great plugin to use, I have added it to our list.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8765);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-10691'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/8d605dd29dce57402bf98a9531ec4914?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/8d605dd29dce57402bf98a9531ec4914'>Thomas Popp</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-17 8:30 pm</div>
				                <div><p>Do you need to install more than one? I was thinking of installing the All In One WP with the &nbsp;Wordfence security plugins. Bad Idea?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10691);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-19 8:42 am</div>
				                <div>It is typically a good idea to only install one of these as multiple installations of different security plugins can cause unexpected results.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10705);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-15029'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/2d489e72acc29760a32338338b404277?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/2d489e72acc29760a32338338b404277'>Susan</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-14 3:03 am</div>
				                <div><p>Do you recommend the in the order in which you listed them? -- i.e. WordFence is no. 1 on your list? Are there any that you think are simpler for "regular people" to manage, but still give good protection. I know that for some of these plugins, there are some dangerous settings! Thanks.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15029);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-15 8:29 am</div>
				                <div>Hello Susan,<br />
<br />
They are not listed in order of preference, but WordFence was one of the better ones. As for which one is easier to use, that is entirely up to the individual so feel free to see which one you are more comfortable with.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15053);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
	...
	<div name='fixComments' id='fixComments' style='width:220px; margin:0px; float:right;'>
		<div class='moduletable'>
			<h3><span class='comment-count'>6</span> Questions & <span class='comment-text'>Comments</span></h3>
