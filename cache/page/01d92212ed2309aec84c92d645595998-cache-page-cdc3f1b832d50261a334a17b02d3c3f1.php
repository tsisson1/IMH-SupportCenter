<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:61766:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/moodle/user-roles-moodle/remove-guest-login" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-12-07T14:17:28-08:00" />
  <meta name="keywords" content="remove removing hide hiding show showing deleting delete guest login button moodle 2.3 login page" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="This article will explain how to remove the guest login button from the moodle 2.3 login page." />
  <title>Removing the Guest login button from the Moodle login page - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/moodle/user-roles-moodle/remove-guest-login" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:412d553d638dc0276917ba4c15718959 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '31.184.238.119']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Removing the Guest login button from the Moodle login page									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>6,153</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Dec 3, 2012'><span style='color:#606060;'>Published:</span> Dec 7, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/105/removing-guest-login/disable-guest-login-1-first.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="disable-guest-login-1-first" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/105/removing-guest-login/disable-guest-login-1-first.gif" title="Click here to view the larger image" width="200" /></a> When setting up the Moodle login for users, the <strong>Login as a Guest button</strong> displays by default. When the site is set to <a href="/support/edu/moodle/user-roles-moodle/skip-guest-login">Auto-login guests</a>, the <strong>login as guest button</strong> does not need to display, as the guest visiting the site will be logged in automaticallyn. Also, most schools using the Moodle software will only want their students to login and not guests. This can be removed from the login page through the Site administration section. This article will explain how to hide the Guest login button from the Moodle 2.3 login page.<br style="clear: both;" /></p>
<h3>Removing the Guest login</h3>
...
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/105/removing-guest-login/disable-guest-login-2-click.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="disable-guest-login-2-click-moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/105/removing-guest-login/disable-guest-login-2-click.gif" title="Click here to view the larger image" width="200" /></a>Navigate to <strong>Site administration</strong> &gt; <strong>Plugins</strong> &gt; <strong>Authentication</strong> &gt; <strong>Manage authentication</strong> in the settings.<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/105/removing-guest-login/disable-guest-login-3-hide.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="disable-guest-login-3-hide-moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/105/removing-guest-login/disable-guest-login-3-hide.gif" title="Click here to view the larger image" width="200" /></a>On the <strong>Manage authentication</strong> page, select Hide on the <strong>Guest login button</strong> field.<br style="clear: both;" /> <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/105/removing-guest-login/disable-guest-login-4-final.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="disable-guest-login-4-final-moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/105/removing-guest-login/disable-guest-login-4-final.gif" title="Click here to view the larger image" width="200" /></a>Now when visiting the Moodle login page, the Login as a guest button will not appear.<br style="clear: both;" /></li>
</ol>
<p>This concludes the article for Removing the Guest login button from the Moodle login page. For more information on this Education Course, please visit <a target="_blank" href="#" title="Click here to view the courses">User Accounts and Permissions in Moodle</a></p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 8: Removing the Guest login button from the Moodle login page</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 7: <a href='/support/edu/moodle/user-roles-moodle/upload-users'>Importing or Uploading users in Moodle</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 9: <a href='/support/edu/moodle/user-roles-moodle/permissions-user-policies'>Configuring the User Permission policies in Moodle</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/moodle/user-roles-moodle/remove-guest-login&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/moodle/user-roles-moodle/remove-guest-login'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yODcmaWQ9MjAzMiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="6049c85d0db51a31a312bf644894cc63" value="1" />	</div>
	</form>
<!-- <br />
