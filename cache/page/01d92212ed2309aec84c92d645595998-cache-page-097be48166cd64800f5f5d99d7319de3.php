<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:63665:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/moodle/new-to-moodle/backup-moodle" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-07-16T16:19:27-07:00" />
  <meta name="keywords" content="Moodle back up  site backed up  backing Creating create  configuring configure Scheme Settings restore database Perform  created" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="Moodle has its own back up feature where the site can be backed up through the Moodle dashboard. The following article will outline the process of backing up Moodle through the Moodle Dashboard." />
  <title>Creating a Backup of Moodle - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/moodle/new-to-moodle/backup-moodle" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:f6045fbde6b307e0bb091db97b9d64d1 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '189.190.66.197']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Creating a Backup of Moodle									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>6,162</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Oct 16, 2012'><span style='color:#606060;'>Published:</span> Jul 16, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<iframe width="640" height="360" src="//www.youtube.com/embed/h5-EonW3PNc" frameborder="0" allowfullscreen></iframe>
<p>Now that course settings are understood from the last tutorial <a target="_blank" href="/support/edu/moodle/creating-courses/moodle-course-settings" title="Click here for more information">What are the Moodle Course settings?</a>, learning how to back up Moodle is the next topic. Moodle has its own back up feature where the site can be backed up through the Moodle dashboard. The following article will outline the process of backing up Moodle through the Moodle Dashboard.</p>
<h2>Create a backup of Moodle through the Moodle Dashboard</h2>
<ol class="article_list">
<li><a target="_blank" href="/support/edu/moodle/new-to-moodle/moodle-login-administrator" title="Click here for more information">Log into Moodle</a></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/102/backup-moodle/backup-moodle-step-1.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="backup-moodle-step-1" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/102/backup-moodle/backup-moodle-step-1.gif" title="Click here to view the larger image" width="200" /></a>Click <strong>Backup </strong>in the Settings on the left. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/102/backup-moodle/backup-moodle-step-2.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="backup-moodle-step-2" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/102/backup-moodle/backup-moodle-step-2.gif" title="Click here to view the larger image" width="200" /></a>The Initial settings page should display. There should be a list of Backup Settings that can be selected for configuring the Moodle backup. Select the values that need to be backed up and click <strong>Next</strong>.<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/102/backup-moodle/backup-moodle-step-3.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="backup-moodle-step-3" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/102/backup-moodle/backup-moodle-step-3.gif" title="Click here to view the larger image" width="200" /></a>The next page that displays is the <strong>Scheme Settings</strong>. This is the database information that Moodle will need for the restore. To back up the entire site, select <strong>ALL</strong>. There is the option to only backup specific database information; However, for learning purposes, All the database information will be selected in this example. Click <strong>Next</strong>.<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/102/backup-moodle/backup-moodle-step-4.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="backup-moodle-step-4" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/102/backup-moodle/backup-moodle-step-4.gif" title="Click here to view the larger image" width="200" /></a>The Confirmation and review page should load. This page will display the backup settings and the database information that is being backed up. Click <strong>Perform backup</strong>. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/102/backup-moodle/backup-moodle-step-5.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="backup-moodle-step-5" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/102/backup-moodle/backup-moodle-step-5.gif" title="Click here to view the larger image" width="200" /></a>After the <strong>Perform backup</strong> runs, the page should show "<strong>The backup file was successfully created</strong>." Click <strong>Continue</strong>. Congratulations, the backup of the Moodle site was successful and can be restored at a later date.<br style="clear: both;" /></li>
</ol>
<p>Now that the Moodle site is backed up, the backup can be restored at a later date. Please see the following tutorial on <a target="_blank" href="/support/edu/moodle/new-to-moodle/restoring-moodle-backup" title="Click here to view the next article">Restoring Moodle from a backup</a>. For more information creating courses, please visit our education channel on <a target="_blank" href="/support/component/content/edu/prestashop-15/create-restore-backup?Itemid=280" title="Click here to view the courses">Creating and restoring backups in Moodle</a>. this article is also in the <a target="_blank" href="/support/edu/moodle/new-to-moodle" title="Click here to view the courses">Getting Started with Moodle</a> after the tutorial on <a target="_blank" href="/support/edu/moodle/new-to-moodle/question-bank" title="Click here for more information">Managing the Moodle question bank</a></p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 11: Creating a Backup of Moodle</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 10: <a href='/support/edu/moodle/new-to-moodle/question-bank'>Managing the Moodle question bank</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/moodle/new-to-moodle/backup-moodle&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/moodle/new-to-moodle/backup-moodle'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNzQmaWQ9MTg3NSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="dea7c035255fb23485054603d493741a" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
        ...
        <tr><td colspan='2'><h4>Backup & Restore</h4></td></tr>  <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>11.</td>
        ...
        <tr><td colspan='2'><h4>Configuring Languages</h4></td></tr>  <tr >
			...
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/moodle/moodle-backup-error?tsrc=rsbraq'>Moodle Backup not working after migration</a>
                                </div>
