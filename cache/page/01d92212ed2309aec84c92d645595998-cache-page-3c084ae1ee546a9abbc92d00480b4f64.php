<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:52822:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/dns-nameserver-changes/problems-with-dns-server-tests" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Wedplan, Actually, there is nothing wrong with the name servers configured for the hosting here. It's probably being misread by whatever test prog..." />
  <title>Problems with DNS server tests | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/dns-nameserver-changes/problems-with-dns-server-tests" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:68e1014a2fa7e3d20a75e08fece28de0 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-20']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '84.111.6.47']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Problems with DNS server tests</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/wedplan'>wedplan</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-11-16 9:33 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>5,391</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Hi!<br />
When I test DNS servers with my two domain names I receive the following messages. Would you please tell me how I can fix these problems.<br />
Thank you.<br />
<br />
aheavenlyhawaiianwedding.com<br />
2012-11-17 00:19:28<br />
Nameserver<br />
ns.inmotionhosting.com.<br />
Name server ns.inmotionhosting.com (74.124.210.242) is recursive.<br />
...
ns2.inmotionhosting.com.<br />
Name server ns2.inmotionhosting.com (70.39.150.2) is recursive.<br />
The name server answers recursive queries for 3rd parties (such as DNSCheck). By making a recursive query to a name server that provides recursion, an attacker can cause a name server to look up and cache information contained in zones under their control. Thus the victim name server is made to query the attackers malicious name servers, resulting in the victim caching and serving bogus data.<br />
<br />
blisseventplanners.com<br />
2012-11-17 00:05:48<br />
Nameserver<br />
NS1.DOMAIN-IS-4-SALE-AT-DOMAINMARKET.com.<br />
Name server NS1.DOMAIN-IS-4-SALE-AT-DOMAINMARKET.com (174.137.135.164) does not answer queries over TCP.<br />
...
NS2.DOMAINMARKET.com.<br />
Name server NS2.DOMAINMARKET.com (77.245.48.84) does not answer queries over TCP.<br />
The name server failed to answer queries sent over TCP. This is probably due to the name server not correctly set up or due to misconfgured filtering in a firewall. It is a rather common misconception that DNS does not need TCP unless they provide zone transfers - perhaps the name server administrator is not aware that TCP usually is a requirement.<br />
Consistency<br />
2 different serials found.<br />
The SOA serial is not the same on all name servers. This is usually due to misconfiguration, but can sometimes be the result of slow zone propagation to secondary name servers.<br />
SOA<br />
Reverse for 174.137.132.100 points to an unknown host name (www1dm.webair.com).<br />
The PTR record for the address points to an unknown host name.<br />
Delivery over IPv4 to hostmaster@blisseventplanners.com could not be done.<br />
Failed to deliver email for SOA RNAME of blisseventplanners.com (hostmaster.blisseventplanners.com) using hostmaster@blisseventplanners.com.<br />
DNSCheck failed to deliver email to the email address listed as the one responsible for the zone.<br />
</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_1890' id='upvote_answer_1890' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='1890' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_1890').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_1890' id='downvote_answer_1890' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='1890' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_1890').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
...
Arnel C.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_1890').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_1890' id='form_comment_on_answer_1890' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/dns-nameserver-changes/problems-with-dns-server-tests&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/dns-nameserver-changes/problems-with-dns-server-tests'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="7498b6688603a5015439f87989acd2cb" value="1" />	</div>
	</form>
<!-- <br />
