<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:76199:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-3/languages/overrides" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-10-18T16:32:36-07:00" />
  <meta name="keywords" content="joomla 3.0 change language overrides" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="In this Joomla 3.0 tutorial, we'll walk you through the steps for creating a new Language Override." />
  <title>Changing Text in Joomla 3.1 using Language Overrides - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-3/languages/overrides" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:16b634f3ffad008f68eca2a89e6f0037 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '132.189.79.10']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Changing Text in Joomla 3.1 using Language Overrides									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>14,038</span></div>
							...
							<div style='clear:both;'></div>
								...
								<p>In our last tutorial, we gave you a <a href="/support/edu/joomla-3/languages/language-files">brief introduction about Joomla 3.0 language files</a>. If you remember, there are three basic things involved:</p>
<ol>
<li><strong>Language</strong> (such as <em>English</em> or <em>Spanish</em>)</li>
<li><strong>Constant</strong> (such as <em>COM_CONTENT_WRITTEN_BY</em>)</li>
<li><strong>Value</strong> (such as <em>Written by</em> or <em>Excrito por</em>)</li>
</ol>
<p>&nbsp;</p>
<h2>Can I modify standard text in Joomla?</h2>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/language/overrides/written-by.jpg"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="written-by" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/language/overrides/written-by.jpg" /></a>If you refer to the screenshot to the right, you can see how Joomla shows the author of an article by displaying under the title, <strong>Written by </strong><em>Super User</em>.</p>
<p><strong>Question:</strong><br />What if you didn't want it to say, <em>Written by</em>? What if instead you wanted it to read, <em>Article author</em>?</p>
<p>You could edit the language file and change <em>Written by </em><strong>to </strong><em>Article author</em>, but if you upgraded Joomla, you run the risk of losing those changes if any of the language files get overwritten.</p>
<p><strong>Answer:</strong><br />Joomla 3.0 includes a feature called <strong>Language Overrides</strong>. Using language overrides allows you to change the <span style="text-decoration: underline;">Value</span> (<em>Written By</em>) of a <span style="text-decoration: underline;">Constant</span> (<em>COM_CONTENT_WRITTEN_BY</em>) without editing any <span style="text-decoration: underline;">Language Files</span> (<em>language/en-GB/en-GB.com_content.ini</em>).</p>
<div style="clear: both;">&nbsp;</div>
<h2>Using Language Overrides in Joomla 3.0</h2>
<p>In the following steps, we'll show you how to use language overrides. We will change <em>Written by </em><strong>to </strong><em>Article Author</em>.</p>
<ol class="article_list">
<li><a href="/support/edu/joomla-3/getting-started/login-dashboard">Log into your Joomla 3.0 Admin Dashboard</a></li>
<li>In the <em>top menu</em>, click <strong>Extensions</strong> and then click <strong>Language Manager</strong></li>
<li>In the <em>left menu</em>, click <strong>Overrides</strong></li>
<li>In the <em>top left of the page</em>, click <strong>New</strong></li>
<li><strong>Find the Constant or Value to change</strong>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/language/overrides/creating-a-new-language-override.jpg"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="creating-a-new-language-override" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/language/overrides/creating-a-new-language-override.jpg" /></a>Under <span style="text-decoration: underline;"><em>Search text you want to change</em></span> and next to <span style="text-decoration: underline;"><em>Search for</em></span> choose <strong>Value</strong>. Then, type in the text you want to change (<strong>Written by</strong> in our example) and click <strong>Search</strong>.<br /><br />Under <span style="text-decoration: underline;"><em>Search Results</em></span>, click on the only result. This will automatically fill in the details for you under <span style="text-decoration: underline;"><em>Create a New Override</em></span>.</p>
</li>
<li><strong>Change the Text</strong><br /><br />Under <span style="text-decoration: underline;"><em>Create a new Override</em></span> and next to <span style="text-decoration: underline;"><em>Text</em></span>, you'll see the Value. In this case it reads <em>Written by %s</em>. Change this to the text your prefer, in our case <strong>Article Author: %s</strong>.</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/language/overrides/language-overrides-example.jpg"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="language-overrides-example" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/language/overrides/language-overrides-example.jpg" /></a>Click <strong>Save</strong> in the top left of the page and then test your results! As you can see in the screenshot to the right, the <em>Written by</em> text has been changed to <em>Article Author</em>.
<div style="clear: both;">&nbsp;</div>
</li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 3: Changing Text in Joomla 3.1 using Language Overrides</div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-3/languages/overrides&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-3/languages/overrides'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNzAmaWQ9MTg5MCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="b046a3fd82e25fb204e6364c4ffaa16b" value="1" />	</div>
	</form>
<!-- <br />
...
<a name='comments'></a>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/6741262c20380b2465e8bbc9eb058e2b?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/6741262c20380b2465e8bbc9eb058e2b'>abdullah</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-05 12:21 pm</div>
				                <div><p>thanks, its help to translation in urdu (pakstani) language. Arabic to Urdu because urdu translation pakage is not availabel.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11212);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-15562'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/835f42dde4563a3f668b740e954666b0?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/835f42dde4563a3f668b740e954666b0'>Mat</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-26 4:56 pm</div>
				                <div><p>when i try to search for an existing constant like PLG_SYS_EPRIVACY_MESSAGE - or a value I know exists (extension is active and working) it returns no results. Maybe the search function doesn't search plugins constants starting PLG_ and only searches MOD's and COM's and so on?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15562);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-26 5:06 pm</div>
				                <div>Hello Mat,<br />
<br />
Thanks for the question.  The tutorial above demonstrates that the function is used to search for text within the Joomla site presented on the web.  It's not used to search for code, like the plugin code or values.  If you have text that's appearing on the Joomla site, this function can be used to search and override it.<br />
<br />
I hope that helps to clear up the issue.  Please let us know if you have any further questions.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15564);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-26 5:27 pm</div>
				                <div><p>Hey Arn,</p>
<p>Well it's a production site I am search on and the plugin is active and the text does show on the site. I have seached for a common string and although I got over 100 results there were no constants returned with prefix PLG_ - only JLIB_&nbsp; TPL_ JLIB_ PHPMAILER_ JERROR_ JGLOBAL_ COM_ FILES which makes me think plugins are not being included in the search? :/</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15568);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-26 5:44 pm</div>
				                <div>Hi Mat,<br />
<br />
...
<br />
Sorry if our answer is unhelpful for your particular issue.  You may want to contact the plugin's author if you are trying to change its output.    <br />
<br />
Kindest regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15570);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-17764'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/1e9cacdf1a030b7e6a2ca735527ef3af?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/1e9cacdf1a030b7e6a2ca735527ef3af'>Duresa</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-24 7:42 am</div>
				                <div><p>What is the constant for the "Search" text ?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17764);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-24 9:58 am</div>
				                <div>Hello Duresa,<br />
<br />
You can find a list of Joomla constants on their site along with descriptions of what they do.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17774);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-18161'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/951198360421502a99b820890249356d?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/951198360421502a99b820890249356d'>spiderman</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-04 2:59 pm</div>
				                <div><p>Hi,</p>
<p>If the search function return no results, use the common search of windows (for me windows xp) and search the string INTO THE FILE, not the name of the file. choose "language" folder in your root folder.&nbsp;Open it in notepad or pspad and search with the program. then copy the result in the joomla overide language manager.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(18161);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
