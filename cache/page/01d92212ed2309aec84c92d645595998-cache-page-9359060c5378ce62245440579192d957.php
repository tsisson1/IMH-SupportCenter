<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:63872:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/joomla-25/virtuemart-search-module-customize" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-05-04T15:20:53-07:00" />
  <meta name="keywords" content="joomla virtuemart search module button customize" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="In this VirtueMart tutorial, we'll show you how to customize your VirtueMart Search Module." />
  <title>How to Customize the VirtueMart Search Module - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/joomla-25/virtuemart-search-module-customize" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<script type="text/javascript">
		...
		_gaq.push(['_setCustomVar', 3, 'DateMonthModified', '2012-05', 3]);
	...
	<!-- cid:1f76f66104f1167fa6c10c76813380a7 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '200.72.158.46']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to Customize the VirtueMart Search Module</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to Customize the VirtueMart Search Module									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>11,774</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: May 4, 2012'><span style='color:#606060;'>Published:</span> May 4, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>The VirtueMart Search Module has several settings you can customize. Adjusting the attributes described below will help transform the ordinary search module from standard to unique. A customized VirtueMart search module can also make it easier for your customers to find products within your e-commerce store.</p>
<p><strong>To customize the VirtueMart Search Module:</strong></p>
...
<li>In the top menu, hover over <strong>Extensions</strong> and then click <strong>Module Manager</strong></li>
<li>Type <strong>VM</strong> into the <strong>filter</strong> box, and then click <strong>Search</strong>.</li>
<li>In the results, click <strong>VM - Search in Shop</strong>.<br /><br />Below, we have outlined each group of settings you can customize and how you can make them different:
<h2>Details</h2>
<table class="article_table">
<tbody>
<tr>
<th>Title</th>
<td>The title is the heading that shows above the VirtueMart search module. By default it says VM - Search in Shop, however you can change it to something more appropriate such as "Search our online store".
<p> </p>
</td>
</tr>
<tr>
<th>Show Title</th>
<td>If you don't want the title to show, set <strong>Show Title</strong> to <strong>Hide</strong>.<br /></td>
</tr>
<tr>
<th>Position</th>
<td>The position controls where on the page your VirtueMart search module will show. You can find more information here on <a href="/support/edu/joomla-25/extensions/how-to-move-module-position">changing module positions</a>.<br /></td>
</tr>
<tr>
<th>Status</th>
<td>The status controls whether the module is shown on the page or not. If you don't want this module to show, update the status to read Unpublished.<br /></td>
</tr>
</tbody>
</table>
<h2>Basic Options</h2>
...
<tr>
<th>Input Width</th>
<td>The default input width is set to 20, and this controls how side the input box is. If you wanted to make the search box wider for example, you could adjust this option to say 30. This is one of those settings that may require you to tweak it a few times before it is just right.<br /></td>
</tr>
<tr>
<th>Text</th>
<td>The text option is by default blank, and before your user types in a search query the search box says "search...". If you wanted to alter this text, modify this feild with your custom text.</td>
</tr>
<tr>
<th>Search filter category</th>
<td>This option by default is set neither to Yes or No. It's hard to tell if this option actually does anything, as the description text is simply "Search Filter Category". When enabling this setting, we didn't see any changes in the search. Until knowing what this feature will disable, we don't recommend making the adjustment.<br /></td>
</tr>
<tr>
<th>Search Button</th>
<td>By default, the search form only includes a text field where users type in their search terms. If you would like to show a button users can click to submit their search, enable this option.</td>
</tr>
<tr>
<th>Button Position</th>
<td>If you enabled the search button, button position controls where the button is in relation to the search box. For example, if you wanted the search button to the left of the text box, select left.</td>
</tr>
<tr>
<th>Search button as image</th>
<td>If you'd like to set the search button to an image, enable this option and then upload your image to /component/com_virtuemart/assets/images/vmgeneral/search.png</td>
</tr>
<tr>
<th>Button name</th>
<td>The search button by default says "Search". If you wanted the text on the button to read differently, modify this value.</td>
</tr>
</tbody>
</table>
</li>
<li>After you are done customizing your VirtueMart search module, click the <strong>Save</strong> button in the top right menu. Visit your VirtueMart store and test out your new search module!</li>
</ol> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/joomla-25/virtuemart-search-module-customize&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/joomla-25/virtuemart-search-module-customize'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD04OSZpZD00MjMmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="40d9f168999c669d250fb8fa8239c518" value="1" />	</div>
	</form>
<!-- <br />
