<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:74309:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.us/support/edu/prestashop-15/301-troubleshooting-database-link" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-07-26T17:50:49-07:00" />
  <meta name="keywords" content="troubleshoot fix error database connection PrestaShop 1.5" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Database errors can be pesky and stop your site dead in its tracks. This article shows you how to troubleshoot a database connection error in PrestaShop 1.5" />
  <title>301: PrestaShop 1.5 - Error - Link to database cannot be established - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/prestashop-15/301-troubleshooting-database-link" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:b724b2b568e26121409b422272d8a6d5 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '66.249.65.33']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															301: PrestaShop 1.5 - Error - Link to database cannot be established									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>17,029</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jun 22, 2012'><span style='color:#606060;'>Published:</span> Jul 26, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>If you have a database configuration error, it can display in different ways. If error reporting is not turned on, it will show differently according to the browser.</p>
<table class="article_table">
<tbody>
<tr>
<th>Googe Chrome</th>
<td>
<p>The website encountered an error while retrieving http://domain.com/ It may be down for maintenance or configured</p>
</td>
</tr>
<tr>
<th>FireFox</th>
<td>Generally displays a blank page</td>
</tr>
<tr>
...
<p>While these messages are fairly general and can be for different errors as well, it is best to then <a href="/support/edu/prestashop-15/set-configure-catalog-modes/enable-error-reporting">turn on the error reporting</a> as shown in a previous article. The error should then display  with the beginning portion reading "<strong>Fatal error: Uncaught exception 'PrestaShopDatabaseException' with message 'Link to database cannot be established.</strong>"</p>
<p><strong>To troubleshoot the database configuration: </strong></p>
<ol class="article_list">
<li>Log into your hosting control panel, SSH, or FTP client.</li>
<li>Navigate to the PrestaShop 1.5 root folder.</li>
<li>From there, find your way to the <strong>config </strong>folder.</li>
<li>Once in the config folder, locate the file named <strong>settings.inc.php</strong> This is the file with all of the database settings.</li>
<li>The table below shows your the four database settings. Ensure that each one is correct. The data shown is sample data, so you will need to know the connection data for your own installation.<br /> 
<table class="article_table">
<tbody>
<tr>
<td>
<p>define('_DB_SERVER_', 'localhost');</p>
</td>
</tr>
<tr>
<td>
<p>define('_DB_NAME_', 'your_database_name');</p>
</td>
</tr>
<tr>
<td>
<p>define('_DB_USER_', 'your_database_user_name');</p>
</td>
</tr>
<tr>
<td>
<p>define('_DB_PASSWD_', 'your_database_password');</p>
</td>
</tr>
</tbody>
</table>
</li>
<li>Once you have corrected the database settings and saved the file, refresh the page to see if the site displays. If so, you may turn off the error reporting.</li>
</ol>
<p>That is how you troubleshoot a database connection error in PrestaShop 1.5.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 39: 301: PrestaShop 1.5 - Error - Link to database cannot be established</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 38: <a href='/support/edu/prestashop-15/344-reset-admin-password'>344: How to reset your admin password in PrestaShop 1.5</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 40: <a href='/support/edu/prestashop-15/enable-geolocation'>304: How to enable Geolocation in PrestaShop 1.5</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.us/support/edu/prestashop-15/301-troubleshooting-database-link&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.us/support/edu/prestashop-15/301-troubleshooting-database-link'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD05OSZpZD0yMzg5JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="f25c56e73cebd211e3430c2f746ea3cc" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-02 4:43 am</div>
				                <div><p>Where do i check the database settings?<span style="color: #232323; font-family: adelle-sans, Helvetica, Arial, sans-serif;"><span style="font-size: 13px; line-height: 22px; background-color: #f8f8f8;">&nbsp;</span></span></p>




<p style="margin: 0px 0px 11px;">define('_DB_SERVER_', 'localhost');</p>




<p style="margin: 0px 0px 11px;">define('_DB_NAME_', 'your_database_name');</p>




<p style="margin: 0px 0px 11px;">define('_DB_USER_', 'your_database_user_name');</p>




<p style="margin: 0px 0px 11px;">define('_DB_PASSWD_', 'your_database_password');</p>



</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21213);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-02 10:07 am</div>
				                <div>Hello Vivian,<br />
<br />
Thank you for your question. You will need to <a href="http://www.inmotionhosting.com/support/website/database-setup/how-do-i-create-a-mysql-database-in-my-control-panel-cpanel">create the database</a>, then <a href="http://www.inmotionhosting.com/support/website/databases/create-db-user">create the database user, and password and attach them to the database</a>.<br />
<br />
If you have any further questions, feel free to post them below.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21214);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-03 12:05 am</div>
				                <div><p>It was database on my phpmyadmin. The server and database name is correct but i am not sure what is the database password. Where i can check the database password? Can i check this on my phpmyadmin?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21251);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-03 12:14 pm</div>
				                <div>Hello,<br />
<br />
Unfortunately the password would not be displayed anywhere but you could create a new user with a new password, attach it to the database, then edit the <em>settings.inc.php</em> with the new user and password.<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21264);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-03 11:50 pm</div>
				                <div><p>May i know what is going wrong for my cms page? Cms is showing&nbsp;<span style="font-family: 'Times New Roman'; font-size: medium;">Category cannot be loaded</span>&nbsp;at the back office, all cms page on my website is show&nbsp;This page does not exist.</p>
<p>Here is my error page&nbsp;http://shoppingononline.com/cms/About-Us.html. Please help me recover the cms problem. I am appreciate your help.</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21285);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-04 11:25 am</div>
				                <div>Hello Vivian,<br />
<br />
Sorry for the problem with your ABOUT US page.  The problem is probably linked to the CMS Block Module (under Modules), and also the CMS information that should be filled out (under Preferences >CMS).   Please make sure that both of those areas are active, and have the correct information  for your About Us page. <br />
<br />
I hope this helps to answer your question, please let us know if you require any further  assistance.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21300);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-21398'></a>
		<div  style='margin:2px 0px 0px 40px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/5228726f5402aaf9f8bc6d18baee4df0?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/5228726f5402aaf9f8bc6d18baee4df0'>Fadi</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-07 12:59 am</div>
				                <div><p>I have the same error, any one was able to find a solution for this?</p>
<p><strong>CMS</strong>: <em><strong>Category cannot be loaded</strong></em></p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21398);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-10 7:30 am</div>
				                <div>Hello Fadi,<br />
<br />
 The error itself is  cause by a missing category ID in the category table. Did you perform a CSV import prior to getting this error? You should be able to correct it by accessing the database via phpmyadmin and then adding the row with the appropriate category ID so that it can be found<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21516);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
