<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:57512:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/email-client-setup/android-email-client-instructions-dont-work" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, thank you for your question. I've gone ahead and replaced your domain with example.com in this post, as this is a public Q&amp;A page and I wanted to..." />
  <title>Android email client instructions don't work | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/email-client-setup/android-email-client-instructions-dont-work" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:5faf1b6871263922848e293057a15f0f -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-22']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '86.59.198.103']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Android email client instructions don't work</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2014-01-31 8:29 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>11,261</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I have a Samsung Galaxy S4 Android phone. I've tried setting up e-mail using your instructions, but get a 'unable to connect to server' error when using pop.example.com. I've tried using IMAP, also without success. I tried the specific &quot;How to setup email on a Galaxy S phone&quot; instructions, using both IMAP and POP settings, trying server settings of 'mail.example.com' 'pop.example.com' and just 'example.com' as your instructions indicate, all with no success.</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_4488' id='upvote_answer_4488' class='f_vote_option'>
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_4488').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_4488' id='downvote_answer_4488' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='4488' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_4488').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>9,968 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2014-02-01 1:49 am EST
                		        </div>
					
		                </div>

				Hello, thank you for your question.<br />
<br />
I've gone ahead and replaced your domain with &lt;strong&gt;example.com&lt;/strong&gt; in this post, as this is a public Q&amp;A page and I wanted to ensure your privacy.<br />
<br />
Two common errors you might get when trying to access email from our server on your Android device would be:<br />
<br />
&lt;strong&gt;Alert | Unable to connect to email server to verify your account information. No response from server&lt;/strong&gt; - In this case the information you have typed into the &lt;strong&gt;server&lt;/strong&gt; field is either incorrect, or your phone can't establish a connection to the server for some other reason.<br />
<br />
&lt;strong&gt;Setup could not finish | Incorrect user name or password&lt;/strong&gt; - This error is pretty much as it sounds, either the user name or password being sent to the server are being denied for being incorrect.<br />
<br />
Some things to possibly look out for when you first create an email account such as &lt;strong&gt;user@domain.com&lt;/strong&gt; on your Android device:<br />
<br />
When you click &lt;strong&gt;Manual setup&lt;/strong&gt; button as mentioned in our &lt;a href=&quot;http://www.inmotionhosting.com/support/email/email-client-setup/galaxy&quot; target=&quot;_blank&quot;&gt;setup email on a Galaxy S phone&lt;/a&gt; guide on step 2, then select &lt;strong&gt;IMAP account&lt;/strong&gt; you'll need to change the &lt;strong&gt;User name&lt;/strong&gt; back to your full email address as it would have been stripped down to just &lt;strong&gt;user&lt;/strong&gt; instead of what our server is expecting &lt;strong&gt;user@example.com&lt;/strong&gt;.<br />
<br />
You also want to remove &lt;strong&gt;imap.&lt;/strong&gt; in front of your domain from the &lt;strong&gt;IMAP server&lt;/strong&gt; section.<br />
<br />
That should ensure that you're using the proper user name, as well as server. Also of course also double-check and make sure that you are in fact entering in your email account's password correctly.<br />
<br />
If you're still having any problems at all, please let us know if you're receiving either of the errors mentioned above or possibly even another one.<br />
<br />
- Jacob
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_4488').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_4488' id='form_comment_on_answer_4488' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
...
<br />
I have had this problem since the beginning of this month only, I have had the email link running on my Samsung S4 since December last year, but since the beginning of this month it just doesn't connect. I get the same message as below, but cannot figure out what I am doing wrong. <br />
<br />
Can you help?<br />
<br />
'Alert | Unable to connect to email server to verify your account information. No response from server - In this case the information you have typed into the server field is either incorrect, or your phone can't establish a connection to the server for some other reason.'</div>
							...
							<td style='width:96px;' valign='top'>
								...
								<div class='smallgrey'>
									<a href='/support/community-support/users/BSRees'>BSRees</a><br />
									3 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2014-10-29 6:54 am EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello BSRees,<br />
<br />
Thank you for your question. Since this error seems to be related to the server name, there are several things to check.<br />
<ul><li>Make sure your domain has not expired. You can look this up in the <a href="http://www.inmotionhosting.com/support/domain-names/general-information/how-to-look-up-domain-whois">Whois</a> record, or <a href="http://www.inmotionhosting.com/support/website/billing/viewing-renewal-dates-in-the-account-management-panel">AMP</a> if you purchased the domain from us.</li/><li>Check your Nameservers to make sure they are pointed to the right DNS host.</li><li>Check your <a href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-email/modfying-mx-records">MX records</a> to ensure they haven't changed.</li></ul><br />
<br />
...
John-Paul</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Jacob, I've done all the steps that you stated but I keep getting the same error message. Alert | Unable to connect to email server to verify your account information. No response from server.<br />
<br />
Any help would be great. Thanks Scott</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='/support/images/avatars/default_avatar.jpg' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/Scott Sheppard'>Scott Sheppard</a><br />
									3 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2015-12-09 11:08 pm EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Scott, I'd suggest contacting the <a href="http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support">Support Department</a> to verify your settings. Unfortunately, this is a public forum and we can't verify your settings here. </div>
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="a99324e6a9c2967693413b5a61d833ca" value="1" />	</div>
	</form>
<!-- <br />
