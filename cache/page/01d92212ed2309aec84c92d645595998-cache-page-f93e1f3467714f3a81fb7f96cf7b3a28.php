<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:56224:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/news/general/link-template-php-suspected" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-06-10T15:44:33-07:00" />
  <meta name="author" content="John-Paul Briones" />
  <meta name="description" content="InMotion Hosting Support Center" />
  <title>WordPress link-template.php.suspected Issue - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/news/general/link-template-php-suspected" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:bd62effd725baae8ef275bb07324579d -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '216.120.224.149']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>WordPress link-template.php.suspected Issue</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															WordPress link-template.php.suspected Issue									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>2,322</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jun 10, 2015'><span style='color:#606060;'>Published:</span> Jun 10, 2015</div>
  ...
  <td>Some WordPress user are reporting a <strong>link-template.php.suspected</strong> error message. This is possibly related to a previous security vulnerabilty, or hack that was never fixed.</td></tr>

<tr><th>Status:</th> <td>InMotion Hosting and the WordPress community are currently investigating this report.</td> </tr>

  <tr><th>Who is impacted?</th><td>Only <em>some</em> users of WordPress are reporting this issue</a>.</td> </tr>

<tr><th>Additional information:</th> <td valign="top">See the post regarding the "<strong>link-template.php.suspected</strong>" issue in the Official <a href="https://wordpress.org/support/topic/link-templatephpsuspected" target="_blank">WordPress Support Forums</a>.</td> </tr> </table>

<h2>What can I do?</h2>
<p>While the WordPress community is still trying to determine the origin of this issue, we have found ways to determine files that may be compromised.</p> 
<ul><li>The following command has been successful in identifying injected code (run it in <a href="/support/website/ssh/shared-reseller-ssh">SSH</a>):<br>
  <div class="code_block">egrep -Rl '\$GLOBALS.*\\x|function.*for.*strlen.*isset' public_html</div></li><br>
<li>If you find files that have been injected with code, or hacked, we recommend the following guide:</p>
<a href="/support/website/hacks/recovering-from-a-hack">Recovering after a Hack</a></li></ul>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/news/general/link-template-php-suspected&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/news/general/link-template-php-suspected'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD01MCZpZD0zNTgxJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="fda11db4d954481461cae4f2346d92a7" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/5a8690209b6c80b2a5d8d69e6b130baf?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/5a8690209b6c80b2a5d8d69e6b130baf'>Devin Young</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-10 3:06 pm</div>
				                <div><p>I've been actively working on remediating this hack for a few days now. Documenting it here:&nbsp;http://www.devinyoungweb.com/blog/php-suspected-hack</p>
<p>I would also suggest changing the grep command to this:&nbsp;</p>
<p><span style="color: rgb(248, 248, 242); font-family: Menlo, Monaco, Consolas, 'Courier New', monospace; font-size: 14px; line-height: 20px; white-space: pre-wrap; background-color: rgb(35, 36, 31);">egrep -Rl '\$GLOBALS.</span><span class="hljs-emphasis" style="box-sizing: border-box; color: rgb(168, 168, 162); font-style: italic; font-family: Menlo, Monaco, Consolas, 'Courier New', monospace; font-size: 14px; line-height: 20px; white-space: pre-wrap;">*\\x|function.*</span><span style="color: rgb(248, 248, 242); font-family: Menlo, Monaco, Consolas, 'Courier New', monospace; font-size: 14px; line-height: 20px; white-space: pre-wrap; background-color: rgb(35, 36, 31);">for.</span><span class="hljs-emphasis" style="box-sizing: border-box; color: rgb(168, 168, 162); font-style: italic; font-family: Menlo, Monaco, Consolas, 'Courier New', monospace; font-size: 14px; line-height: 20px; white-space: pre-wrap;">*strlen.*</span><span style="color: rgb(248, 248, 242); font-family: Menlo, Monaco, Consolas, 'Courier New', monospace; font-size: 14px; line-height: 20px; white-space: pre-wrap; background-color: rgb(35, 36, 31);">isset|isset.*eval' public_html/</span>It's a small change but found an additional 20 compromised files for me.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24100);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
