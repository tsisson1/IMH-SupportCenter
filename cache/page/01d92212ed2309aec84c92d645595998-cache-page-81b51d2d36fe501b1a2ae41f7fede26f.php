<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:51047:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/prestashop-15/different-header-component-position-in-chrome-and-other-browsers" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello skulsh, Sorry to hear you are having issues with your custom PrestaShop layout on different browsers. I looked at your sites live with Chrome and ..." />
  <title>Different header component position in Chrome and other browsers | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/prestashop-15/different-header-component-position-in-chrome-and-other-browsers" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:664e2046c931944cb9f0fc7c702ded5e -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '180.76.15.141']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box straight_bottom'>
                <h1 style='font-size:26px;'>Different header component position in Chrome and other browsers</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/skulsh@gmail&per;com'>skulsh@gmail.com</a>
			<div>0 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2016-05-07 6:49 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>21</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>My site is having different positions of the modules in header, I did most of my customization using chrome and it looks like i want on chrom, but on other browsers, position of logo, cart , and search box is different. I am new to prestashop  and web programming and did this site just by trial and error, so it is quite possible that i have missed some basic requirement.  In addition, my site is also facing some problem in displaying cart and horizontal menu in mobile, I am not sure these two problems are linked with each other orr are different and need to be put  under separate questions. I am providing links to screenshots to make myself more clear:  <br />
screenshot on chrome browser:  http://prnt.sc/b19l9n<br />
Screenshot of site on Mozilla : http://prnt.sc/b19lou<br />
Screenshot of the site on mobile:  http://prnt.sc/b1ae4d<br />
My current prestashop version is 1.6.0.9<br />
I hope that I have made myself clear, please let me know, if more information is required.<br />
Thanks<br />
</div>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px;'>
				<div style='font-size:12px; max-width:500px; overflow:auto;'>It appears that i added the question to Category Prestashop 15 instead of Prestashop 16,  can someone also guide me how to change the category of the query.</div>
			...
			<td style='width:100px;' valign='top'>
				...
				<div class='smallgrey'>
					<a href='/support/community-support/users/skulsh@gmail&per;com'>skulsh@gmail.com</a><br />
					0 <a href='/support/team/points' target='_blank'>Points</a><br />
					2016-05-07 07:08 am EST
				</div>
			</td>
		</tr>
	</table>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_9858' id='upvote_answer_9858' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='9858' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_9858').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_9858' id='downvote_answer_9858' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='9858' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_9858').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello skulsh,<br />
<br />
Sorry to hear you are having issues with your custom PrestaShop layout on different browsers. I looked at your sites live with Chrome and FireFox. They both look the same on my screens. They look like the Mozilla screenshot you provided. <br />
<br />
The issue will likely just be in the way you customize your CSS. There are many times when one browser acts differently than another. The only way to find to make them the same is trial and error, and learning how the different commands work in the differenent browsers.<br />
<br />
Unfortunately there is nothing specific we can provide that will fix the issue for you since this falls under coding.<br />
<br />
Kindest Regards,<br />
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_9858').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_9858' id='form_comment_on_answer_9858' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/prestashop-15/different-header-component-position-in-chrome-and-other-browsers&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/prestashop-15/different-header-component-position-in-chrome-and-other-browsers'></div>
<script type='text/javascript'>
  (function() {
