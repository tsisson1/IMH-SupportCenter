<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:58352:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/product-guides/dedicated-hosting" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="InMotion Hosting Support Center" />
  <title>Dedicated Hosting | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/product-guides/dedicated-hosting" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:0d5089a59b990edc603b69899ab99002 -->
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/product-guides' itemprop='url'><span itemprop='title'>Product Guides<span></a><div class='dropdown_2columns'><div class='col_2'><div><a href='/support/product-guides/dedicated-hosting'>Dedicated Hosting</a> (57)</div><div><a href='/support/product-guides/reseller-hosting'>Reseller Hosting</a> (68)</div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Dedicated Hosting</span></li>			</ul>
		</div>
	</div>
</div>
...
<div id='hp_ps' class='white_box' style='margin-bottom:15px; width: 95%'>
	<h2 style='color:#000;'>Dedicated Product Guide</h2>
	<p>Thank you for purchasing a new dedicated hosting plan! We're excited not only to have you as a new customer but also to introduce you to our product guides! This guide is designed to show you how to perform some of the most common tasks our dedicated hosting customers often request. If you're not familiar with AMP you'll want to start with our <a href="http://www.inmotionhosting.com/support/product-guides/dedicated-hosting/amp-overview-dedicated-acct">AMP for Dedicated Hosting</a> article. </p>
	<p style='margin-bottom:20px; padding-left:180px;'>The topics covered on this page are more advanced and are largely specific to either Reseller or Root access. For basic hosting related information please see our <a href="http://www.inmotionhosting.com/support/">Support Center</a>. You can also ask us a question</a> in our <a href="/support/community-support">Community Support</a> area.</p>
	<div style='clear:both;'></div>
</div>
<!-- Top Section -->
<!-- Top left -->
<div class="white_box" style="float: left; width: 44%;margin-top: 15px;">
<h2 style="background:url('http://cdn.inmotionhosting.com/support/templates/supportcentertemplate/images/red_icons/red_star.png') no-repeat;  color:#c52228;margin-top:0px; background-size: 20px;   padding-left: 30px;">Getting Started with WHM</h2>
<ul>
<li><a href="/support/product-guides/dedicated-hosting/log-in-whm">How to log into WHM</a></li>
<li><a href="/support/product-guides/dedicated-hosting/create-cpanel-accounts-in-whm">How to create cPanel accounts in WHM</a></li>
<li><a href="http://www.inmotionhosting.com/support/product-guides/dedicated-hosting/access-cpanel-whm">How to access cPanels from WHM</a></li>
<li><a href="http://www.inmotionhosting.com/support/product-guides/dedicated-hosting/resetting-cpanel-pw-whm">How to reset passwords in WHM</a></li>
<li><a href="http://www.inmotionhosting.com/support/product-guides/dedicated-hosting/how-to-change-the-time-zone-in-whm">How to change your time zone in WHM</a></li>
</ul>

</div>

<!-- Top right -->
<div class="white_box" style="float: right; width: 44%;margin-right:15px;margin-top: 15px;">
<h2 style="background:url('http://cdn.inmotionhosting.com/support/templates/supportcentertemplate/images/red_icons/icon_transfers.png') no-repeat;  color:#c52228;margin-top:0px; background-size: 20px;   padding-left: 30px;">Transferring your Websites</h2>
<ul>
<li><a href="/support/product-guides/dedicated-hosting/cpanel-transfer-tool-whm">How to transfer from cPanel to cPanel in WHM</a></li>
<li><a href="/support/product-guides/dedicated-hosting/non-cpanel-website-transfer">How to transfer from a non-cPanel server</a></li>
<li><a href="/support/product-guides/dedicated-hosting/move-dedicated-server-email">Moving emails to your dedicated server</a></li>
<li><a href="/support/product-guides/dedicated-hosting/exporting-database-for-transfer">Exporting your database for transfer</a></li>
<li><a href="/support/product-guides/dedicated-hosting/install-ssl-whm">How to install or move an SSL in WHM</a></li>
</ul>
...
<!--  left -->
<div class="white_box" style="float: left; width: 44%;margin-top: 15px;">
<h2 style="background:url('http://cdn.inmotionhosting.com/support/templates/supportcentertemplate/images/red_icons/icon-education.png') no-repeat;  color:#c52228;margin-top:0px; background-size: 20px;   padding-left: 30px;">Common Tasks</h2>
<ul>
<li><a href="/support/product-guides/dedicated-hosting/dedicated-server-support">Getting support for your dedicated server</a></li>
  <li><a href="http://www.inmotionhosting.com/support/product-guides/dedicated-hosting/do-i-need-root">When to request root access</a></li>
  <li><a href="/support/product-guides/dedicated-hosting/how-to-request-root-access-to-your-dedicated-server">How to request root access</a></li>
<li><a href="/support/product-guides/dedicated-hosting/connect-via-ssh">How to connect to your server via SSH</a></li>
 <li><a href="http://www.inmotionhosting.com/support/product-guides/dedicated-hosting/using-the-process-manager">How to use the Process Manager in WHM</a></li>
</ul>
...
<!--  right -->
<div class="white_box" style="float: right; width: 44%;margin-right:15px;margin-top: 15px;">
<h2 style="background:url('http://cdn.inmotionhosting.com/support/templates/supportcentertemplate/images/red_icons/icon_whmcs.png') no-repeat;  color:#c52228;margin-top:0px; background-size: 20px;   padding-left: 30px;">Server Configuration</h2>
<ul>
<li><a href="/support/product-guides/dedicated-hosting/checking-and-upgrading-server-software">Checking & updating server software</a></li>
<li><a href="/support/product-guides/dedicated-hosting/basic-apf-commands">Basic APF commands</a></li>
 <li><a href="/support/product-guides/dedicated-hosting/how-to-allow-ports-in-apf-on-your-dedicated-server">How to allow ports in APF</a></li>
<li><a href="http://www.inmotionhosting.com/support/product-guides/dedicated-hosting/how-to-upgrade-mysql-on-centos">How to upgrade MySQL in CentOS</a></li>
<li><a href="/support/product-guides/dedicated-hosting/how-to-upgrade-apache">How to upgrade Apache</a></li>
</ul>
...
<!--  left -->
<div class="white_box" style="float: left; width: 44%;margin-top: 15px;">
<h2 style="background:url('http://cdn.inmotionhosting.com/support/templates/supportcentertemplate/images/red_icons/icon-tools.png') no-repeat;  color:#c52228;margin-top:0px; background-size: 20px;   padding-left: 30px;">Server Optimization</h2>
<ul>
<li><a href="/support/product-guides/dedicated-hosting/installing-and-configuring-varnish">Installing & configuring Varnish</a></li>
  <li><a href="/support/product-guides/dedicated-hosting/installing-zendopcache">Installing ZendOpCache</a></li>
<li><a href="/support/product-guides/dedicated-hosting/installing-dso-ruid2">Installing DSO + RUID2</a></li>
<li><a href="/support/product-guides/dedicated-hosting/how-to-switch-your-dedicated-server-from-suphp-to-fastcgi">How to switch to suPHP to FastCGI</a></li>
<li><a href="/support/product-guides/dedicated-hosting/the-basics-of-tuning-mysql-on-your-dedicated-server">The basics of tuning MySQL</a></li>
</ul>
...
<!--  right -->
<div class="white_box" style="float: right; width: 44%;margin-right:15px;margin-top: 15px;">
<h2 style="background:url('http://cdn.inmotionhosting.com/support/templates/supportcentertemplate/images/red_icons/icon_ssl.png') no-repeat;  color:#c52228;margin-top:0px; background-size: 20px;   padding-left: 30px;">Basic Server Security</h2>
<ul>
<li><a href="/support/product-guides/dedicated-hosting/whm-password-configuration">How to set the password strength in WHM</a></li>
<li><a href="/support/product-guides/dedicated-hosting/install-csf">How to install CSF on your dedicated server</a></li>
<li><a href="/support/product-guides/dedicated-hosting/setup-cphulk">How to setup cPHulk on your dedicated server</a></li>
<li><a href="/support/product-guides/dedicated-hosting/update-cpanel">How to update cPanel on a dedicated server</a></li>
<li><a href="http://www.inmotionhosting.com/support/product-guides/dedicated-hosting/how-to-update-repo-a-package-on-centos">How to update repos in CentOS</a></li>
</ul>
...
<!--  left -->
<div class="white_box" style="float: left; width: 44%;margin-top: 15px;">
<h2 style="background:url('http://cdn.inmotionhosting.com/support/templates/supportcentertemplate/images/red_icons/icon-email.png') no-repeat;  color:#c52228;margin-top:0px; background-size: 20px;   padding-left: 30px;">Email Service Configuration</h2>
<ul>
<li><a href="/support/product-guides/dedicated-hosting/whm-email-troubleshooting">How to use the WHM for email troubleshooting</a></li>
<li><a href="/support/product-guides/dedicated-hosting/how-to-enable-smtp-restrictions">How to enable SMTP restrictions</a></li>
<li><a href="/support/product-guides/dedicated-hosting/enable-greylisting">How to enable greylisting in WHM</a></li>
<li><a href="/support/product-guides/dedicated-hosting/how-to-enable-disable-spam-assassin">How to enable/disable Spam Assassin</a></li>
<br/>
  </ul>
...
<!--  right -->
<div class="white_box" style="float: right; width: 44%;margin-right:15px;margin-top: 15px;">
<h2 style="background:url('http://cdn.inmotionhosting.com/support/templates/supportcentertemplate/images/red_icons/icon-globe.png') no-repeat;  color:#c52228;margin-top:0px; background-size: 20px;   padding-left: 30px;">Advanced Tasks</h2>
<ul>
<li><a href="/support/product-guides/dedicated-hosting/how-to-upgrade-mysql-on-centos">How to upgrade MySQL on CentOS</a></li>
<li><a href="/support/product-guides/dedicated-hosting/how-to-install-python-on-your-dedicated-server">How to install Python on your dedicated server</a></li>  
<li><a href="/support/product-guides/dedicated-hosting/add-php-modules-to-dedicated-server">How to add PHP modules</a></li>
<li><a href="/support/product-guides/dedicated-hosting/add-apache-modules">How to add Apache modules </a></li>
  <li><a href="/support/product-guides/dedicated-hosting/how-to-add-repos-in-centos">How to add repos in CentOS</a></li>
</ul>

</div>

<!-- Last Section -->
<div class="white_box" style="float: left; width: 44%;margin-top:15px; margin-bottom:15px;">
<h2 style="background:url('http://cdn.inmotionhosting.com/support/templates/supportcentertemplate/images/red_icons/icon-community.png') no-repeat;  color:#c52228;margin-top:0px; background-size: 20px;   padding-left: 30px;">Community Support</h2>
        <p>Ask questions and receive help from the community.</p>
        <ul>
            <li><a href='/support/community-support'>Browse Questions</a></li>
            <li><a href='/support/community-support/ask-a-question'>Ask a Question</a></li>
        </ul>
...
<!-- bottom 4 -->
<div class="white_box" style="float: right; width: 44%;margin-right:15px;margin-top:15px;margin-bottom:15px;">
       <h2 style="background:url('http://cdn.inmotionhosting.com/support/templates/supportcentertemplate/images/red_icons/youtube-icon.png') no-repeat;  color:#c52228;margin-top:0px;  background-size: 20px;  padding-left: 30px;">Youtube Channel</h2>
  <p>We record weekly video tutorials to help with web hosting questions. If you have a video in mind, let us know on our channel page.</p><p>Subscribe to our <a href="https://www.youtube.com/subscription_center?add_user=InMotionSupport">YouTube Channel</a>.</p>
</div>

<form action="http://www.inmotionhosting.com/support/product-guides/dedicated-hosting" method="post" name="adminForm" id="adminForm" class="form-inline">
  ...
  <table class='article_list'>
          ...
          <tr>
                                <td style='padding-right:20px;'><a href='/support/product-guides/dedicated-hosting/view-running-processes'>How to View Running Processes on your Dedicated Server</a></td>
                                <td>146</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/product-guides/dedicated-hosting/install-csf'>How to Install CSF on your Dedicated Server</a></td>
                                <td>77</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/product-guides/dedicated-hosting/installing-and-configuring-varnish'>Installing and Configuring Varnish</a></td>
                                <td>49</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/product-guides/dedicated-hosting/add-php-modules-to-dedicated-server'>How to Add PHP Modules on Dedicated Hosting</a></td>
                                <td>48</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/product-guides/dedicated-hosting/how-to-upgrade-mysql-on-centos'>How to Upgrade MySQL on CentOS</a></td>
                                <td>46</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/product-guides/dedicated-hosting/cpanel-transfer-tool-whm'>How to Transfer from cPanel to cPanel in WHM</a></td>
                                <td>45</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/product-guides/dedicated-hosting/how-to-enable-disable-spam-assassin'>How to Enable/Disable SpamAssassin</a></td>
                                <td>43</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/product-guides/dedicated-hosting/using-the-process-manager'>Using the Process Manager</a></td>
                                <td>43</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/product-guides/dedicated-hosting/log-in-whm'>How to Log in to WHM on your Dedicated Server</a></td>
                                <td>43</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/product-guides/dedicated-hosting/how-to-request-root-access-to-your-dedicated-server'>How to Request Root Access to your Dedicated Server</a></td>
                                <td>41</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/product-guides/dedicated-hosting/update-cpanel'>How to Update cPanel on a Dedicated Hosting Plan</a></td>
                                <td>40</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/product-guides/dedicated-hosting/how-to-upgrade-apache'>How to Upgrade Apache</a></td>
                                <td>40</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/product-guides/dedicated-hosting/exporting-database-for-transfer'>Exporting your Database for Transfer</a></td>
                                <td>38</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/product-guides/dedicated-hosting/whm-email-troubleshooting'>How to use WHM for Email Troubleshooting</a></td>
                                <td>38</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/product-guides/dedicated-hosting/installing-dso-ruid2'>Installing DSO + RUID2</a></td>
                                <td>35</td>
                        </tr>
                  </table>
		...
		<ul><li class="pagination-start"><span class="pagenav">Start</span></li><li class="pagination-prev"><span class="pagenav">Prev</span></li><li><span class="pagenav">1</span></li><li><a href="/support/product-guides/dedicated-hosting?start=15" class="pagenav">2</a></li><li><a href="/support/product-guides/dedicated-hosting?start=30" class="pagenav">3</a></li><li><a href="/support/product-guides/dedicated-hosting?start=45" class="pagenav">4</a></li><li class="pagination-next"><a title="Next" href="/support/product-guides/dedicated-hosting?start=15" class="hasTooltip pagenav">Next</a></li><li class="pagination-end"><a title="End" href="/support/product-guides/dedicated-hosting?start=45" class="hasTooltip pagenav">End</a></li></ul>	</div>
	</form>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD01NTYmaWQ9NTU2JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="688e20f5078329044733990da68210c0" value="1" />	</div>
	</form>
<!-- <br />
