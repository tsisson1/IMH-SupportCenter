<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:62520:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-25/users/reset-user-password" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-09-28T23:07:34-07:00" />
  <meta name="keywords" content="reset user admin joomla 2.5 password database" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="If you've forgotten a Joomla 2.5 user's password, you can easily reset it using phpMyAdmin or any other MySQL client. This will work for both standard Joomla 2.5 users and administrators." />
  <title>How to reset a Joomla 2.5 user password directly in the database - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-25/users/reset-user-password" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:143d9e984ec5ee786b7ef0f016f24199 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '37.14.0.86']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to reset a Joomla 2.5 user password directly in the database									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>38,626</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: May 15, 2012'><span style='color:#606060;'>Published:</span> Sep 28, 2015</div>
							...
							<div style='clear:both;'></div>
								...
								<p class="alert">Joomla 2.5 has reached its end of life as for 12/31/2014. Please be advised this may be a security risk to your website. You can view more information about the end of life <a href="https://docs.joomla.org/Joomla!_CMS_versions">here</a>.</p><br /><p>If you've forgotten a Joomla 2.5 user's password, either a standard user or an administrator, you can reset their password directly within the Joomla 2.5 database. There are several ways to manage a Joomla 2.5 database. One of the more popular database clients is phpMyAdmin, which we will use in this tutorial to reset a Joomla 2.5 user password.</p>
<p><strong>To change a Joomla 2.5 user password from within the database:</strong></p>
<ol class="article_list">
<li>Log into phpMyAdmin and access your Joomla 2.5 database<br /><br />If you are an InMotion Hosting customer you can do this by <a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">logging into your cPanel</a>, clicking the phpMyAdmin icon, and then clicking your Joomla 2.5 database in the left menu.</li>
<li>Open your users table<br /><br />You can do this by clicking the users table in the left menu. If you setup a prefix for your tables when installing Joomla 2.5, such as i8ee, then the table name will look similar to i8ee_users.</li>
<li>Find the user you want to reset the password for and click the edit icon next to them (which is a pencil icon)</li>
<li>Next to "password", choose MD5 in the drop down, type in a new password, and then click Go.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/reset-user-password-in-database/choose-md5.gif"><img  alt="choose-md5" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/reset-user-password-in-database/choose-md5.gif" /></a>
<p>Congratulations, you have successfully reset a Joomla 2.5 user password using phpMyAdmin! Log into your Joomla 2.5 dashboard as this user and ensure it saved correctly.</p>
</li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 7: How to reset a Joomla 2.5 user password directly in the database</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 6: <a href='/support/edu/joomla-25/users/prevent-passwords-in-email'>Prevent passwords in Joomla 2.5 new user account activation emails</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 8: <a href='/support/edu/joomla-25/users/change-user-email'>How to change a Joomla 2.5 user's email address</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-25/users/reset-user-password&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-25/users/reset-user-password'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xODgmaWQ9MTMxMyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="a4c31d6bd2e2d31b9cb9c7ad582863d4" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/533e96fe42bc8a3a7fa4a5f051aa6bc5?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/533e96fe42bc8a3a7fa4a5f051aa6bc5'>Rasika Nanayakkara</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-16 9:07 am</div>
				                <div>Wonderful article...
Really helpful... 
Thanks.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16351);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
