<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:52318:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/cpanel/how-can-i-get-access-to-my-php-configuration-file-phpini" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Thanks for posting your question talkrite! On all our servers, the directory specific php.ini (Not the global php.ini for the server) is placed in the p..." />
  <title>How can I get access to my PHP Configuration file: php.ini? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/cpanel/how-can-i-get-access-to-my-php-configuration-file-phpini" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:b099bd733e524c3b4d44cb9f899f20f9 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '94.69.193.232']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>How can I get access to my PHP Configuration file: php.ini?</h1>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_1665' id='upvote_answer_1665' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='1665' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_1665').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_1665' id='downvote_answer_1665' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='1665' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_1665').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>5,889 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2012-10-09 9:23 am EST
                		        </div>
					
		                </div>

				Thanks for posting your question talkrite!<br />
<br />
On all our servers, the directory specific php.ini (Not the global php.ini for the server) is placed in the public_html folder. This php.ini can be copied and placed in whatever directory you want to make directory specific php configuration changes.<br />
<br />
When placing a php.ini in a specific directory, you will need to make that php.ini recursive so the changes will work for all the subfolders from that location. Please see the following url for &quot;How can I make my php.ini file recursive ?&quot;<br />
<br />
http://www.inmotionhosting.com/support/website/general-server-setup/recursive-php-ini<br />
<br />
If for whatever reason you do not have a php.ini file in your public_html folder, you can try restoring the file through shell by doing the following (VPS and Dedicated servers only).<br />
<br />
1. SSH into your server<br />
2. Navigate to your cpanel user where you need the php.ini restored.<br />
3. use the following command<br />
cp /usr/local/lib/php.ini public_html<br />
<br />
This will restore the php.ini to that specific cpanel acount public_html directory. If you can't restore the php.ini through shell, then you will need to contact support for our tech staff to restore it. You can email them at support@inmmotionhosting.com with the request or contact them through the chat system and they can restore the php.ini ASAP.<br />
<br />
For further information on &quot;How to update your local php settings&quot; please see the following link.<br />
<br />
http://www.inmotionhosting.com/support/website/general-server-setup/update-local-php-settings<br />
<br />
If you have any further questions please post them below.<br />
<br />
Take Care!<br />
James R
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_1665').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_1665' id='form_comment_on_answer_1665' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/cpanel/how-can-i-get-access-to-my-php-configuration-file-phpini&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/cpanel/how-can-i-get-access-to-my-php-configuration-file-phpini'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="87eb519c1b17c6b5dd1dab1cdbb65ec7" value="1" />	</div>
	</form>
<!-- <br />
