<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:64346:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/magento/203-troubleshooting-magento/enabling-system-and-exception-logging-in-magento" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-01-15T15:11:52-08:00" />
  <meta name="keywords" content="system.log exception.log logging error debugging magento system exception log enable how" />
  <meta name="author" content="Tim Sisson" />
  <meta name="description" content="In this short tutorial, learn how to enable the logging system in Magento." />
  <title>How to Enable System and Exception Logging in Magento 1.6 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/magento/203-troubleshooting-magento/enabling-system-and-exception-logging-in-magento" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:a88334b2aaa58d225895ff5c7d6fa63f -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '121.244.95.61']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to Enable System and Exception Logging in Magento 1.6									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>9,916</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Mar 28, 2012'><span style='color:#606060;'>Published:</span> Jan 15, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Magento 1.6 has a powerful logging system that can be extremely helpful when debugging any issues you may have. If there's an error there is almost always an entry in the system or exceptions log. By default though, logging is not enabled. Enabling the logs in Magento 1.6 is relatively easy and is accomplished through the Magento Admin Backend.</p>

<h2>Enabling System and Exception Logging</h2>
...
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/magento/magento_dashboard_1.jpg"><img  alt="magento_dashboard_1" src="//cdn.inmotionhosting.com/support/images/stories/magento/magento_dashboard_1.jpg" /></a></p>
<li>Click on "<strong>Developer</strong>" in the left side menu pane</li>
<li>Open the "<strong>Log Settings</strong>" section</li>
<li>Change the "<strong>Enabled</strong>" to "<strong>Yes</strong>"</li>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/magento/magento_log_files_1.jpg"><img  alt="magento_log_files_1" src="//cdn.inmotionhosting.com/support/images/stories/magento/magento_log_files_1.jpg" /></a></p>
<li>Click "<strong>Save Config</strong>"</li>
</ol>
<p>Now, any system events that are logged will be to a system.log file located in the /var/log folder. Any exceptions that are to be logged will be in a file called exception.log in the /var/log folder as well.</p>
<p>If you need further assistance please feel free to <a href="/support/community-support">ask a question on our support center</a>.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/magento/203-troubleshooting-magento'>203: Troubleshooting Magento 1.6</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 1: How to Enable System and Exception Logging in Magento 1.6</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 2: <a href='/support/edu/magento/203-troubleshooting-magento/enabling-the-debug-profiler-in-magento'>Enabling the Debug Profiler in Magento 1.6</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/magento/203-troubleshooting-magento/enabling-system-and-exception-logging-in-magento&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/magento/203-troubleshooting-magento/enabling-system-and-exception-logging-in-magento'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xNzQmaWQ9MTI0NCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="7b86936f1f2c49632a59aa2d265706b6" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/magento/203-troubleshooting-magento?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Troubleshooting Magento 1.6</h3></a>
		<table>  <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/magento/203-troubleshooting-magento/enabling-system-and-exception-logging-in-magento?tsrc=rsbedu'>How to Enable System and Exception Logging in Magento 1.6</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/magento/203-troubleshooting-magento/enabling-the-debug-profiler-in-magento?tsrc=rsbedu'>Enabling the Debug Profiler in Magento 1.6</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/magento/203-troubleshooting-magento/fixing-php-memory-errors-in-magento?tsrc=rsbedu'>Fixing PHP Memory Errors in Magento 1.6</a></td>
                </tr>
          	</table>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/d9cb6708fc76ac0c06b9d010605b76a1?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/d9cb6708fc76ac0c06b9d010605b76a1'>sdfor</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-01 2:56 pm</div>
				                <div><p>How do you view the log if you don't have ssh access</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12226);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-01 4:33 pm</div>
				                <div>Hello sdfor,<br />
<br />
If you don't have &lt;a href=&quot;http://www.inmotionhosting.com/support/website/ssh/how-to-login-ssh&quot; target=&quot;_blank&quot;&gt;SSH&lt;/a&gt; access to the server you can connect with either &lt;a href=&quot;http://www.inmotionhosting.com/support/website/ftp/getting-started-guide&quot; target=&quot;_blank&quot;&gt;FTP&lt;/a&gt; or by using the &lt;a href=&quot;http://www.inmotionhosting.com/support/edu/cpanel/cpanel-file-manager/using-file-manager-in-cpanel&quot; target=&quot;_blank&quot;&gt;cPanel File Manager&lt;/a&gt;.<br />
<br />
The Magento exception log should be stored in the &lt;span style=&quot;color: red;&quot;&gt;/magento/var/log/&lt;/span&gt; directory relative to your Magento installation, and not the server's main &lt;span style=&quot;color: red;&quot;&gt;/var/log/&lt;/span&gt; directory.<br />
<br />
- Jacob</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12231);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-29812'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/81e97e992004eae00e6030e6c6c9ab0f?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/81e97e992004eae00e6030e6c6c9ab0f'>Joshua</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-14 11:16 am</div>
				                <div><p>How would one go about turning on this feature from command line vs Magento backend?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29812);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-15 11:44 am</div>
				                <div>Hello Joshua,<br />
<br />
Thank you for contacting us. I spent some time looking into this, and while you can find the log files, it must still be enabled in the dashboard.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29826);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
