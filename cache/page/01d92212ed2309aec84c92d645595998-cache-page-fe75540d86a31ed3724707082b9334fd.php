<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:65115:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/wordpress/fix-save-session-path-ecommerce-plugin" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-03-07T15:48:09-08:00" />
  <meta name="keywords" content="ecommerce plugin woo commerce wp wordpress save session path session.save_path" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="WordPress ecommerce plugin not saving products to cart? This article will tell you how to fix it." />
  <title>302: Fixing the Save Sessions Path for WordPress eCommerce plugins - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/wordpress/fix-save-session-path-ecommerce-plugin" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:116401da60178b8ec355ed61db65f97f -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '93.119.16.164']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															302: Fixing the Save Sessions Path for WordPress eCommerce plugins									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>8,311</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Mar 7, 2013'><span style='color:#606060;'>Published:</span> Mar 7, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>WordPress has ecommerce plugins that allow you to use your WordPress as a shopping cart as well. Occasionally, the ecommerce plugin will not save to the Shopping cart products. When visiting the shopping cart after products are added, the site still says the cart is empty. This is caused by the Sessions save path (session.save_path in the <em>php.ini</em>) not being set to the correct directory.</p>
<h2>Known issues with ecommerce plugins</h2>
<p>This is a common issue with WordPress ecommerce plugins. The following plugins are known to have this issue:</p>
<ol>
<li>WP Ecommerce</li>
<li>Woo Commerce</li>
</ol>
<p>Below will show you the steps to fix the sessions path in your cPanel File Manager.</p>
<h2>Fixing the sessions problem</h2>
<p>This sessions save path is a relatively easy fix. This can be done in the cPanel File Manager. To get the shopping cart to allow the products to add to the cart, you will need to fix the sessions path to the folder location on the server where the sessions ar stored.</p>
...
<li><a href="/support/edu/cpanel/cpanel-file-manager/using-file-manager-in-cpanel" target="_blank" title="Click here for info">Go to the File Manager</a>. Select the <em>Web Root</em> <em>public_html</em> directory and click Go.</li>
<li>Find your <em>php.ini</em> and <a target="_blank" href="/support/website/how-to/how-to-edit-a-file">edit</a> it.</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/302/session-save-path.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="php.ini view of sessions path" src="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/302/session-save-path.gif" title="Click here to view the larger image" width="100" /></a>You will need to change the "<em>Sessions path</em>" in the php.ini for the WordPress Shopping cart.
<p>Update the <em>php.ini</em> save path sits similar to the following.</p>
<pre style="margin-left: 20px;">session.save_path = /tmp</pre>
<p>Change the path to the following:</p>
<pre style="margin-left: 20px;">session.save_path = home/username/session foldername</pre>
<p class="alert"><strong>Note!</strong> You will need to create a folder in your "<em>Home</em>" directory. You will need to change the name from "<em>foldername</em>" to the name you want the folder to be and the" <em>username</em>" to your cPanel username.</p>
<p>The folder must be <a target="_blank" href="/support/website/how-to/change-file-permissions">writeable with 755 permissions</a>.</p>
<p>Save the changes to your php.ini.</p>
<p class="alert"><strong>Note!</strong> You may need to <a href="/support/website/general-server-setup/recursive-php-ini" target="_blank" title="Click here for info">make the <em>php.ini</em> recursive in the .htaccess</a> to see the changes take effect.</p>
<br style="clear: both;" /></li>
<li>Test your ecommerce shopping cart again. You should see the cart save the products in the cart now.</li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 33: 302: Fixing the Save Sessions Path for WordPress eCommerce plugins</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 32: <a href='/support/edu/wordpress/326-change-url-in-admin-dash'>326: How to change your site URL in your WordPress admin dashboard</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 34: <a href='/support/edu/wordpress/319-deleting-a-wordpress-theme'>319: How to delete a WordPress theme</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD03MSZpZD0yNDgzJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-17 2:34 am</div>
				                <div><p>Hello guys</p>
<p>Currentally i am using woocommerce pluging, there i am getting problem.</p>
<p>how to identify user logged . mean how did get session.</p>
<p>i am doing when user login then "Login Button hide" and "Logout button showing".</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15107);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-17 9:56 am</div>
				                <div>Hello Rajkaran,<br />
<br />
Thank you for contacting us today. We are happy to help, but are not sure what you are asking.<br />
<br />
Can you provide more details on what you are trying to accomplish?<br />
<br />
If you have any further details, feel free to post them below.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15123);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-10 11:20 am</div>
				                <div><p>Hi good day,</p>
<p>I'm not sure if this is the same problem, however, my issue is Woocommerce related... specifically, I'm unable to add products to the cart more than once.</p>
<p>What I mean is, after clearing the cache in a browser, I'm able to add a product to the cart and then view that product... great!&nbsp;</p>
<p>However, if I remove that product from the cart, return to the shop and attempt to add that same product, or another to the cart, I'm not allowed to.</p>
<p>There's no error message. But the notification "XYZ product was added to your&nbsp;cart" that usually appears above the product page, does not appear the second time around.</p>
<p>Is there any way to fix this? I've done numerous things - increased memory limit in Wordpress, resetting Woocommerce options under System Status, excluding my cart, checkout and my account pages in W3 Total Cache - and nothing has worked.</p>
<p>I'm in desperate need of a fix here.</p>
<p>Thanks. Yuri&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24768);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-13 12:11 pm</div>
				                <div>Hello Yuri,<br />
<br />
Thank you for contacting us. I first recommend <a href="http://www.inmotionhosting.com/support/website/wordpress/turning-on-wordpress-debugging">turning WordPress debugging on</a>. With debugging turned on, it is much easier to locate any errors within your WordPress site as well as any plugins and themes that may be causing errors. <br />
<br />
If your problems persist, please see our <a href="http://www.inmotionhosting.com/support/website/website-troubleshooting/common-wordpress-troubleshooting-techniques">Common WordPress Troubleshooting Techniques</a>. It provides additional testing steps, to help you narrow down the cause of the problem.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24826);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
