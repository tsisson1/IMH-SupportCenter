<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:80596:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/moodle/changing-appearance-moodle/edit-navigation-block" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-11-26T16:52:41-08:00" />
  <meta name="keywords" content="Moodle 2.3, navigation block configured specifications will Navigation block configuration edit editing edits change changes changing configure configuring blocks main menu settings" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="In Moodle 2.3, the navigation block can be configured to the administrators specifications. This tutorial will go over the Navigation block configuration." />
  <title>Configuring the Navigation block in Moodle - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/moodle/changing-appearance-moodle/edit-navigation-block" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:84fb81ca5609a95aa2b5d4a75caf5b21 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '158.169.150.4']);
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/moodle' itemprop='url'><span itemprop='title'>Moodle<span></a><div class='dropdown_4columns'><h2>Moodle Education Channel</h2><div class='col_2'><h3>100 Level Classes</h3><div><a href='/support/edu/moodle/new-to-moodle'>101: Getting Started with Moodle</a></div><div><a href='/support/edu/moodle/creating-courses'>102: Creating Courses in Moodle</a></div><div><a href='/support/edu/moodle/activity-resource'>103: Adding an activity or resource to a course in Moodle</a></div><div><a href='/support/edu/moodle/create-restore-backup'>104: Creating and restoring backups in Moodle</a></div><div><a href='/support/edu/moodle/question-bank'>104: Working with the Question Bank</a></div><div><a href='/support/edu/moodle/user-roles-moodle'>105: User Accounts and Permissions in Moodle</a></div><div><a href='/support/edu/moodle/moodle-grading-reports'>106: Moodle Grading and Reports</a></div><div><a href='/support/edu/moodle/changing-appearance-moodle'>107: Changing the Appearance of Moodle</a></div><div><a href='/support/edu/moodle/moodle-plugins'>108: Managing Moodle Plugins</a></div><div><a href='/support/edu/moodle/additional-moodle-features'>109: Additional Moodle features</a></div></div><div class='col_2'><h3>200 Level Classes</h3><div><a href='/support/edu/moodle/moodle-site-security'>201: Moodle site security and server settings</a></div><div><a href='/support/edu/moodle/custom-moodle-reports'>202: Making Custom Moodle Reports</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/moodle/changing-appearance-moodle' itemprop='url'><span itemprop='title'>107: Changing the Appearance of Moodle<span></a><div class='dropdown_3columns'><h2> Changing the Appearance of Moodle</h2><div class='col_3'><div>1. <a style='display:inline;' href='/support/edu/moodle/changing-appearance-moodle/changing-default-theme'>Changing the default Standard theme in Moodle</a></div><div>2. <a style='display:inline;' href='/support/edu/moodle/changing-appearance-moodle/change-logo-footer'>Changing the Logo and Footer in Moodle themes</a></div><div>3. <a style='display:inline;' href='/support/edu/moodle/changing-appearance-moodle/add-logo-fusion-theme-code'>Adding a logo through the theme code in Moodle</a></div><div>4. <a style='display:inline;' href='/support/edu/moodle/changing-appearance-moodle/manual-theme-install'>Manually installing a theme for Moodle 2.3</a></div><div>5. <a style='display:inline;' href='/support/edu/moodle/changing-appearance-moodle/removing-branded-logo'>Removing the branded Moodle image from a theme footer</a></div><div>6. <a style='display:inline;' href='/support/edu/moodle/changing-appearance-moodle/change-theme-font'>Changing the default font in the Moodle Standard theme</a></div><div>7. <a style='display:inline;' href='/support/edu/moodle/changing-appearance-moodle/purge-clear-cache'>Clearing or Purging the cache from Moodle 2.3</a></div><div>8. <a style='display:inline;' href='/support/edu/moodle/changing-appearance-moodle/customize-front-page'>Customizing the Moodle Frontpage Appearance</a></div><div>9. <a style='display:inline;' href='/support/edu/moodle/changing-appearance-moodle/blocks-overview'>Moodle Blocks Overview</a></div><div>10. <a style='display:inline;' href='/support/edu/moodle/changing-appearance-moodle/calendar-appearance'>Changing the Appearance of the Calendar in Moodle</a></div><div>11. <a style='display:inline;' href='/support/edu/moodle/changing-appearance-moodle/edit-navigation-block'>Configuring the Navigation block in Moodle</a></div><div>12. <a style='display:inline;' href='/support/edu/moodle/changing-appearance-moodle/add-delete-blocks'>Adding and Deleting blocks from the Moodle sidebar</a></div><div>13. <a style='display:inline;' href='/support/edu/moodle/changing-appearance-moodle/comments-block'>Comments block configuration in Moodle</a></div><div>14. <a style='display:inline;' href='/support/edu/moodle/changing-appearance-moodle/managing-blocks'>Managing Blocks within Moodle 2.3</a></div><div>15. <a style='display:inline;' href='/support/edu/moodle/changing-appearance-moodle/changing-the-default-my-moodle-page'>Changing the Default My Moodle page</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Configuring the Navigation bl...</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Configuring the Navigation block in Moodle									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>11,201</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Nov 13, 2012'><span style='color:#606060;'>Published:</span> Nov 26, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>When navigating through the Moodle 2.3 site, the left navigation tree can be a bit annoying when it keeps expanding out every time the site is navigated. This can be set to a different configuration by editing the <strong>Navigation block</strong>. The principle for editing the navigation block is the same with all the other blocks as well. For example, the <strong>Main menu</strong> and the <strong>Settings blocks</strong> can be edited in the same way the Navigation block is configured. Previously, <a href="/support/edu/moodle/changing-appearance-moodle/calendar-appearance" title="Click here to view the previous article" target="_blank">the appearance of the calendar was changed</a>. In this article, the appearance of the Navigation block will be discussed.</p>
<h3>Editing the Navigation block</h3>
<ol class="article_list">
<li><a target="_blank" href="/support/edu/moodle/new-to-moodle/moodle-login-administrator" title="Click for more information">Log into the Moodle Dashboard</a>
<p class="alert"><strong>Important!</strong> Keep in mind that <a target="_blank" href="/support/edu/moodle/creating-courses/creating-courses-in-moodle" title="Click for more information">Editing must be turned on</a> in the Settings section in order to edit any of these options.</p>
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/107/edit-navigation-block/edit-navigation-block-1-before.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="edit-navigation-block-1-before-moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/107/edit-navigation-block/edit-navigation-block-1-before.gif" title="Click here to view the larger image" width="200" /></a>Navigate to the home page of the Moodle site. On the sidebar where the navigation block is located, the courses will display a tree style navigation for the courses.
<p>The courses will by default expand the <strong>Categories</strong>, <strong>Courses</strong>, and the <strong>Activities</strong> in the courses similar to the snapshot to the right.</p>
<br style="clear: both;" />
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/107/edit-navigation-block/edit-navigation-block-2-edit.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="edit-navigation-block-2-edit-moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/107/edit-navigation-block/edit-navigation-block-2-edit.gif" title="Click here to view the larger image" width="200" /></a>To edit the way this displays the Courses in this block, click the configuration <img src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/107/edit-navigation-block/edit.gif" alt="edit" style="margin: 0px; paddding: 0px;" height="11" width="11" /> link on the navigation block header. <br style="clear: both;" /></p>
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/107/edit-navigation-block/edit-navigation-block-3-configure.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="edit-navigation-block-3-configure-moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/107/edit-navigation-block/edit-navigation-block-3-configure.gif" title="Click here to view the larger image" width="200" /></a>On the <strong>Configuring a Navigation block</strong>page, change the options to have the navigation block display differently. In this tutorial, change the following:
<p>- Set <strong> Display categories as links</strong> to Yes<br /> - Set <strong>Generate navigation for the following</strong> to Categories and courses</p>
<p>Below are the available settings for configuring the Navigation block.</p>
<br style="clear: both;" />
<table class="article_table" border="0">
<tbody>
<tr><th colspan="3" style="background: #cccccc;" valign="top">Configuring a Navigation block</th></tr>
<tr><th valign="top" width="168"><strong>Block settings</strong></th>
<td colspan="2" valign="top" width="945"><strong>Allow the user to dock this block:</strong> Users can have the capability to move the navigation blocks from one location to another. By default this is set to Yes. This capability can be turned off by setting it to No.<br /> <strong>Display categories as links:</strong> The Categories are not links by default. This setting will allow the links to the categories in the Navigation block to be links.<br /> <strong>Trim mode:</strong> This truncates long Course, category and activity names to display in a set width of the navigation block.<br /> <strong>How many characters to trim to:</strong> Sets the number of characters to trim.<br /> <strong>Generate navigation for the following:</strong> The Categories can be set to display the course structures or the course activities as sub menus under the course. The default will display the course activities on the navigation block.</td>
</tr>
<tr><th valign="top" width="168"><strong>Where this block appears</strong></th>
<td colspan="2" valign="top" width="945"><strong>Original block location:</strong> The block location is set to system by default.<br /> <strong>Page contexts:</strong> The navigation block can be set to only display on the Front page, throughout the site, or on the front page and any pages added to the front page.<br /> <strong>Default region:</strong> The Navigation block can be displayed on the left or the right of the site.<br /> <strong>Default weight: The weight will place the block in a specific position on the site. The lower the number, the higher on the sidebar. The higher the number, the further down it will display on the sidebar.</strong></td>
</tr>
<tr><th valign="top" width="168"><strong>On this page</strong></th>
<td colspan="2" valign="top" width="945"><strong>Visible:</strong> The block can be hidden or shown on a per page basis.<br /> <strong>Region:</strong> The navigation block can be displayed left or right on a per page basis.<br /> <strong>Weight:</strong> The weight will place the block in a specific position on the sidebar on a per page basis.</td>
</tr>
</tbody>
</table>
<p>When finished. click <strong>Save changes</strong>.</p>
<br style="clear: both;" />
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/107/edit-navigation-block/edit-navigation-block-4-after.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="edit-navigation-block-4-after-moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/107/edit-navigation-block/edit-navigation-block-4-after.gif" title="Click here to view the larger image" width="200" /></a>Now when visiting the Navigation block, the categories will be click-able links and the Courses will not have the Activities tree menu displayed anymore. <br style="clear: both;" /></p>
</li>
</ol>
<p>This concludes the article for Configuring the Navigation block in Moodle. To learn how to remove blocks, see the article on <a target="_blank" href="/support/edu/moodle/changing-appearance-moodle/add-delete-blocks" title="Click here to view the next article">Adding and Deleting blocks from the Moodle sidebar</a>. For more information about articles on the appearance of Moodle, please visit <a target="_blank" href="/support/edu/moodle/changing-appearance-moodle" title="Click here to view the courses">Changing the Appearance of Moodle</a>.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/moodle/changing-appearance-moodle'>107: Changing the Appearance of Moodle</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 11: Configuring the Navigation block in Moodle</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 10: <a href='/support/edu/moodle/changing-appearance-moodle/calendar-appearance'>Changing the Appearance of the Calendar in Moodle</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 12: <a href='/support/edu/moodle/changing-appearance-moodle/add-delete-blocks'>Adding and Deleting blocks from the Moodle sidebar</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/moodle/changing-appearance-moodle/edit-navigation-block&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/moodle/changing-appearance-moodle/edit-navigation-block'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yOTQmaWQ9MTk5MCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="ca1c251e2828f1de44d977b588ae2bea" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/moodle/changing-appearance-moodle?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Changing the Appearance of Moodle</h3></a>
		<table><tr><td colspan='2'><h4>Moodle Themes</h4></td></tr>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/moodle/changing-appearance-moodle/changing-default-theme?tsrc=rsbedu'>Changing the default Standard theme in Moodle</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/moodle/changing-appearance-moodle/change-logo-footer?tsrc=rsbedu'>Changing the Logo and Footer in Moodle themes</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/moodle/changing-appearance-moodle/add-logo-fusion-theme-code?tsrc=rsbedu'>Adding a logo through the theme code in Moodle</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/moodle/changing-appearance-moodle/manual-theme-install?tsrc=rsbedu'>Manually installing a theme for Moodle 2.3</a></td>
                </tr>
          <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/moodle/changing-appearance-moodle/removing-branded-logo?tsrc=rsbedu'>Removing the branded Moodle image from a theme footer</a></td>
                </tr>
          <tr >
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/moodle/changing-appearance-moodle/change-theme-font?tsrc=rsbedu'>Changing the default font in the Moodle Standard theme</a></td>
                </tr>
          <tr >
                        <td valign='top'>7.</td>
                        <td><a href='/support/edu/moodle/changing-appearance-moodle/purge-clear-cache?tsrc=rsbedu'>Clearing or Purging the cache from Moodle 2.3</a></td>
                </tr>
          <tr >
                        <td valign='top'>8.</td>
                        <td><a href='/support/edu/moodle/changing-appearance-moodle/customize-front-page?tsrc=rsbedu'>Customizing the Moodle Frontpage Appearance</a></td>
                </tr>
        <tr><td colspan='2'><h4>Moodle Blocks</h4></td></tr>  <tr >
                        <td valign='top'>9.</td>
                        <td><a href='/support/edu/moodle/changing-appearance-moodle/blocks-overview?tsrc=rsbedu'>Moodle Blocks Overview</a></td>
                </tr>
          <tr >
                        <td valign='top'>10.</td>
                        <td><a href='/support/edu/moodle/changing-appearance-moodle/calendar-appearance?tsrc=rsbedu'>Changing the Appearance of the Calendar in Moodle</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>11.</td>
                        <td><a href='/support/edu/moodle/changing-appearance-moodle/edit-navigation-block?tsrc=rsbedu'>Configuring the Navigation block in Moodle</a></td>
                </tr>
          <tr >
                        <td valign='top'>12.</td>
                        <td><a href='/support/edu/moodle/changing-appearance-moodle/add-delete-blocks?tsrc=rsbedu'>Adding and Deleting blocks from the Moodle sidebar</a></td>
                </tr>
          <tr >
                        <td valign='top'>13.</td>
                        <td><a href='/support/edu/moodle/changing-appearance-moodle/comments-block?tsrc=rsbedu'>Comments block configuration in Moodle</a></td>
                </tr>
          <tr >
                        <td valign='top'>14.</td>
                        <td><a href='/support/edu/moodle/changing-appearance-moodle/managing-blocks?tsrc=rsbedu'>Managing Blocks within Moodle 2.3</a></td>
                </tr>
          <tr >
                        <td valign='top'>15.</td>
                        <td><a href='/support/edu/moodle/changing-appearance-moodle/changing-the-default-my-moodle-page?tsrc=rsbedu'>Changing the Default My Moodle page</a></td>
                </tr>
          	</table>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/716967b77d6a6b9ba4621ca4a3f2350a?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/716967b77d6a6b9ba4621ca4a3f2350a'>vignesh</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-14 3:35 am</div>
				                <div><p>HI.</p>
<p>&nbsp;</p>
<p>Thnak for ur information..i want to know how to get the menu againg..if once hide the section..</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12714);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-14 10:28 am</div>
				                <div>Your question is a bit unclear.  Could you clarify?</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12723);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-15257'></a>
		<div  style='margin:2px 0px 0px 80px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/71511f6df0e815cfe5d35ebc9dfe13d6?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/71511f6df0e815cfe5d35ebc9dfe13d6'>Clarification</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-20 6:41 am</div>
				                <div><p>If I hide navigation block on first page, how do I get it back?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15257);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-22 2:05 pm</div>
				                <div>Hello Clarification,<br />
<br />
Thank you for your question. In <strong>Step 3</strong> see if the "<em>On this Page</em>" section has <em>Visible</em> set to: <strong>Yes</strong>. The picture next to "Step 3" shows the setting.<br />
<br />
If that doesn't work, we are happy to help, but will need to know some additional information, such as how you hid the navigation.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15343);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-14076'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/14ff0264b9a268ae0effd6b464c32dbd?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/14ff0264b9a268ae0effd6b464c32dbd'>bhavana</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-18 6:02 am</div>
				                <div><p>Thanks for sharing moodle related information</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14076);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-15383'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/cb6794840d164cbda7b6b9d20fcb8a10?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/cb6794840d164cbda7b6b9d20fcb8a10'>anil</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-23 2:01 am</div>
				                <div><p>can i restrict the course and category links in navigation block to only one role</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15383);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-23 10:09 am</div>
				                <div>Hello anil,<br />
<br />
Thank you for your question. I found a possible solution in the <a href="https://moodle.org/mod/forum/discuss.php?d=199765">Official Moodle forums</a>, you have to create a free account to view it.<br />
<br />
Jason De Donno provided the following solution:<br />
<ol><li>"<em>Go to the Front Page.</li><br />
<li>Add the block you want using the Add Block control</li><br />
<li>Once the block is present, click on the block's configuration (hand holding pen) and make sure that it's set to display on the Front Page only<br><br />
This takes care of the making it display on the front page only. </li></ol><br />
Next:<br />
<ol><li>Click on the Assign Roles button on your block (face)</li><br />
<li>Ignoring the "You are not able to assign any roles here" message, go to the settings block and click on "Permissions"</li><br />
<li>Where it says "view Block" click on the "+" sign and add "Manager".</li><br />
<li>Remove all the other types of users by clicking on the crosses after their them.</em>"</li></ol><br />
<br />
If you have any further questions, feel free to post them below.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15409);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
	...
	<div name='fixComments' id='fixComments' style='width:220px; margin:0px; float:right;'>
		<div class='moduletable'>
			<h3><span class='comment-count'>7</span> Questions & <span class='comment-text'>Comments</span></h3>
