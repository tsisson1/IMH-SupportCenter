...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-3/remove-base-tag" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-06-24T15:27:09-07:00" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="If you need to remove the base tag in your joomla template, this article will give you the two lines of code to remove it." />
  <title>How to remove the &quot;base href&quot; tag Joomla 3 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-3/remove-base-tag" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:5e4d0799de4567b45990b4b09aadd0c7 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '62.42.143.150']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to remove the &quot;base href&quot; tag Joomla 3									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>3,678</span></div>
							...
							<div style='clear:both;'></div>
								...
								<h2>Joomla uses the base tag</h2>

<p>By default, Joomla adds the <strong>base</strong> tag to your header (as in the example below):</p>

<pre class='code_block'>&lt;head&gt;
    <span style='background:yellow;'>&lt;base href='http</strong>://www.domain.com/page.php' /&gt;</span>
&lt;/head&gt;</pre>

<h2>The base tag can cause problems</h2>

<p>There may be scenarios, however, in which this base tag can cause a problem. For example, if your base tag uses http and your site uses https, this can cause <a href="/support/website/website-troubleshooting/protocol-relative-urls-not-working">problems when calling css / js files using relative urls</a>.</p>

<h2>You can remove the base tag</h2>

<p>If you don't use the base tag and simply want to remove it, you can easily do so. This base tag is stored in $doc / $document. You can use <strong>unset</strong>, as in the following example, to remove the base tag:</p>

<pre class='code_block'>$doc = <a href="/support/edu/joomla-25/create-template/jfactory-get-document">JFactory::getDocument</a>();
unset($doc->base);</pre>

<p>Using the code sample above in your Joomla template should remove the base tag.</p>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 4: How to remove the &quot;base href&quot; tag Joomla 3</div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-3/remove-base-tag&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-3/remove-base-tag'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xMDEmaWQ9MzMyMiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
