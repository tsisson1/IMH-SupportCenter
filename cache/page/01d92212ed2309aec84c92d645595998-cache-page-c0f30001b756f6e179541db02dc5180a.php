<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:59471:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/cpanel/site-going-to-cgisysdefaultwebpagecgi" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Thank you for your question SouthWest! Usually when you see the default Apache page, the IP address set for the A record is not the same IP that was ass..." />
  <title>site going to cgi-sys/defaultwebpage.cgi | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/cpanel/site-going-to-cgisysdefaultwebpagecgi" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:f9d5927133ccd899f801f0b4f1dbd6ea -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>site going to cgi-sys/defaultwebpage.cgi</h1>
		<div style='margin-bottom:20px; margin-top:10px; clear:both; color:#6e6e6e;'>Category: <a href='/support/community-support/cpanel'>Cpanel</a></div>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/SouthWest'>SouthWest</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-10-24 7:38 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>33,899</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I've just re-pointed several of my websites from my previous host to inmotionhosting.  When I purchased my dedicated server I was given 15 IP addresses which all connect to my server, and I'm assigning each to a website.  The problem I'm getting shows &quot;Template Error: The template file must be given&quot; on my pages and instead of my pages pointing to the root, they now point to cgi-sys/defaultwebpae.cgi.  <br />
 I'm not using cgi with any of my websites.  When I contacted customer support they told me it was because my ip addresses were not active, but that's not true since I can type in &quot;http://74.124.215.231/~ky7p8q2/&quot; and get directly to my site.  <br />
My website is http://www.ssgims.com<br />
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_1771' id='upvote_answer_1771' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='1771' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_1771').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_1771' id='downvote_answer_1771' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='1771' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_1771').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Thank you for your question  SouthWest!<br />
<br />
Usually when you see the default Apache page, the IP address set for the A record is not the same IP that was assigned to that domain on your server. Unfortunately, in this case, http://www.ssgims.com is loading a website and we do not get that error. Please try clearing your cache.<br />
<br />
&lt;a href=&quot;http://www.inmotionhosting.com/support/website/how-to/clear-browser-cache&quot; target=&quot;_blank&quot;&gt;How to clear your browser's cache&lt;/a&gt;<br />
<br />
&lt;a href=&quot;http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/how-do-i-clear-my-local-dns-cache&quot; target=&quot;_blank&quot;&gt;How do I clear my local DNS cache?&lt;/a&gt;<br />
<br />
You will want to double check the IP address that was set for that domain to make sure it is the correct IP. You can see the IP address for the domain by checking the cPanel stats on the left. The Ip will either be the &quot;Shared IP address&quot; or &quot;Dedicated IP Address&quot; depending on if a dedicated IP was assigned to that cpanel or not.<br />
<br />
Regads<br />
<br />
James R
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_1771').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_1771' id='form_comment_on_answer_1771' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>I'm having a similar problem.  My website www.homegrownhits.com (dedicated server) frequently redirects to http://www.homegrownhits.com/cgi-sys/defaultwebpage.cgi.  This happens a few times a day and is causing trouble for us with potential customers.  This occurs sporadically, and it clears in a few minutes (browser starts seeing www.homegrownhits.com/ again), but a lot of users are having their experiences interrupted and getting turned off of our site.  <br />
<br />
Why should the server even think it has to point to this page?  Shouldn't the default server location be www.homegrownhits.com?  Doesn't the fact that it is loading a page on the same machine as my website mean that the DNS is functioning properly?  What causes the Apache server to decide that there is no website available at ~user/public_html and to instead pull up this page?  <br />
<br />
I've brought this to the attention of inmotionhosting support but they were unable to reproduce the issue, and so refused to help.  As I said, the issue is sporadic, you can't just call it up.  But I think an investigation of what can cause Apache to redirect to defaultwebpage.cgi might suggest a solution.<br />
<br />
Jim Ingalls<br />
HomeGrownHits.com</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='http://graph.facebook.com/jim.ingalls.71/picture?type=normal' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/ingalls'>ingalls</a><br />
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello Jim,<br />
<br />
This definitely seems to be an IP or DNS related issue, because if the issue was caused by apache it would be consistent, and replicable.<br />
<br />
I also confirmed by digging @ the nameservers that the IP addresses are correct.<br />
<br />
Your network or ISP may have an old IP or DNS information stored. I recommend <a href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/how-do-i-clear-my-local-dns-cache">flushing your DNS</a> and testing if the issue occurs again.<br />
<br />
If you are still experiencing issues, then as a test perform a <a href="http://www.inmotionhosting.com/support/website/how-to/modifying-your-hosts-file">host file modification</a>, and point your domain to your specific <a href="http://www.inmotionhosting.com/support/website/cpanel/how-to-find-your-shared-ip-address-of-your-server-in-cpanel">IP address on the server</a>. <br />
<br />
If your site works after a host file modification, then you know it is a local DNS issue.<br />
<br />
You can also check if your site is working by using tools such as <a href="http://just-ping.com/">just-ping</a>, or <a href="http://gtmetrix.com/">GTMetrix</a>.<br />
<br />
...
<br />
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello ingalls,<br />
<br />
If your server's IP address changed for some reason it may have stored the old IP. <br />
<br />
I also checked the logs, and this is only happening to your IP address. Are you working in the Dashboard or a specific location when this occurs?, as it appears your software is requesting that address directly.<br />
<br />
It is difficult to tell, but this could also be related to a plugin that is running on your website.<br />
<br />
It could possibly be an <a href="http://www.inmotionhosting.com/support/website/general-server-setup/htaccess-reference-list">.htaccess rule</a> causing this as well.<br />
<br />
Let us know if this issue persist after  a host file modification too.<br />
<br />
If you have any further questions, feel free to post them below.<br />
Thank you,<br />
<br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
                                ...
                                <h3>Related Articles</h3><a target='_blank' href='http://inmotionhosting.com/support/how-to-disable-security-alert-notifications-in-whm'>How to Disable Security Advisor Alerts in WHM</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/what-is-your-default-php-ini-file'>What is your default PHP.ini file?</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/how-to-use-cpanel-shortcuts'>How to Use cPanel Shortcuts</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/cpanel-two-form-authentication'>Two Factor Authentication for cPanel</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/cpanel-11-38-enforces-security-tokens'>cPanel 11.38 enforces security tokens</a><br/><br />
		</div>
