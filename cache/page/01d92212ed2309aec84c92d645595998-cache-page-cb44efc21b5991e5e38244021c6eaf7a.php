<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49444:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/general-server-setup/server-hosting" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello debug406, While we do allow remote access to our dedicated and VPS servers, we do not have windows platforms available. You may want to check out ..." />
  <title>server hosting | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/general-server-setup/server-hosting" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:0e6db72f8f2d5bdc9726f5f284f3f602 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>server hosting</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/debug406'>debug406</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-08-29 8:51 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>444</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>hello. i need a server with remote connection option. and to this server, i can install windows services. do you have such product?</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_1493' id='upvote_answer_1493' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='1493' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_1493').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_1493' id='downvote_answer_1493' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='1493' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_1493').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello debug406,<br />
<br />
While we do allow remote access to our dedicated and VPS servers, we do not have windows platforms available.<br />
<br />
You may want to check out our <a href="http://www.inmotionhosting.com/alternatives/" target="_blank">alternative hosting list</a> for windows hosting providers.<br />
<br />
Best Regards,<br />
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_1493').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_1493' id='form_comment_on_answer_1493' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/general-server-setup/server-hosting&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/general-server-setup/server-hosting'></div>
<script type='text/javascript'>
  (function() {
