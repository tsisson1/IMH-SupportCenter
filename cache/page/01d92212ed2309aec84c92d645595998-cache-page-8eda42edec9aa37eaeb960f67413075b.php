<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:61027:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/movable-type/change-theme-template-movable-type/add-logo-to-header-movable-type" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-04-21T22:24:02-07:00" />
  <meta name="keywords" content="logo upload add insert header template" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="Movable Type does not have a Logo uploaded by default. This article will explain how to upload a logo to your Movable Type website." />
  <title>Adding a Logo to your Movable Type site - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/movable-type/change-theme-template-movable-type/add-logo-to-header-movable-type" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:fca95a4168199acc224cdebc3ebe9215 -->
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/movable-type' itemprop='url'><span itemprop='title'>Movable Type<span></a><div class='dropdown_4columns'><h2>Movable Type Education Channel</h2><div class='col_2'><h3>100 Level Classes</h3><div><a href='/support/edu/movable-type/geting-started-movable-type'>101: Getting Started with Movable Type</a></div><div><a href='/support/edu/movable-type/adding-content-movable-type'>102: Adding Content to Movable Type</a></div><div><a href='/support/edu/movable-type/change-theme-template-movable-type'>103: Changing the Appearance of Movable Type</a></div><div><a href='/support/edu/movable-type/widgets-movable-type'>104: Working with Widgets in Movable Type</a></div><div><a href='/support/edu/movable-type/create-blog-movable-type'>105: Creating a Blog in Movable Type</a></div></div><div class='col_2'><h3>200 Level Classes</h3><div><a href='/support/edu/movable-type/site-security-in-movable-type'>201: Site Security in Movable Type</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/movable-type/change-theme-template-movable-type' itemprop='url'><span itemprop='title'>103: Changing the Appearance of Movable Type<span></a><div class='dropdown_3columns'><h2> Changing the Appearance of Movable Type</h2><div class='col_3'><div>1. <a style='display:inline;' href='/support/edu/movable-type/change-theme-template-movable-type/change-theme-movable-type'>How to change the theme in Movable Type</a></div><div>2. <a style='display:inline;' href='/support/edu/movable-type/change-theme-template-movable-type/add-logo-to-header-movable-type'>Adding a Logo to your Movable Type site</a></div><div>3. <a style='display:inline;' href='/support/edu/movable-type/change-theme-template-movable-type/edit-footer-banner-module'>Editing the Footer Banner module text in Movable Type</a></div><div>4. <a style='display:inline;' href='/support/edu/movable-type/change-theme-template-movable-type/remove-powered-by-reference'>Removing the Powered By information in Movable Type</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Adding a Logo to ...</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Adding a Logo to your Movable Type site									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>1,632</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Mar 11, 2013'><span style='color:#606060;'>Published:</span> Apr 21, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<p><strong>Movable Type</strong> does not have any logo in the template by default. In order to place your logo in the header section of your site, you will need to upload your image to the <strong>Assets</strong>, then add the HTML code in the template <strong>Header Banner</strong> linking your logo in the code. Below are the steps to insert a logo into your <strong>Movable Type</strong> websites Default theme.</p> 
<h2>Steps to upload a Logo</h2>
<ol class="article_list">
<li><a target="_blank" href="/support/edu/movable-type/geting-started-movable-type/moveable-type-admin" title="Click for more information">Log into your Movable Type Dashboard</a>.</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mt/103/add-logo/upload-logo-header-1-assets-new.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Add New Asset Movable Type" src="//cdn.inmotionhosting.com/support/images/stories/edu/mt/103/add-logo/upload-logo-header-1-assets-new.png" title="Click here to view the larger image" width="100" /></a>On the left side where it shows "<em>Assets</em>", click <strong>New</strong>. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mt/103/add-logo/upload-logo-header-2-browse.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Browse for logo Movable Type" src="//cdn.inmotionhosting.com/support/images/stories/edu/mt/103/add-logo/upload-logo-header-2-browse.png" title="Click here to view the larger image" width="100" /></a><strong>Upload</strong> your Logo to the server. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mt/103/add-logo/upload-logo-header-3-manage-assets.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Manage Assets Movable Type" src="//cdn.inmotionhosting.com/support/images/stories/edu/mt/103/add-logo/upload-logo-header-3-manage-assets.png" title="Click here to view the larger image" width="100" /></a><strong>Click your logo</strong> on the Manage Assets page. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mt/103/add-logo/upload-logo-header-4-get-path.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Get logo path Movable Type" src="//cdn.inmotionhosting.com/support/images/stories/edu/mt/103/add-logo/upload-logo-header-4-get-path.png" title="Click here to view the larger image" width="100" /></a><strong>Find the path </strong>to your logo image. In this case, the logo was uploaded to the main folder of the Movable Type install directory.
<p>In this case, the logo was uploaded to the main install directory. You can use the url in the image tag on step 8.</p>
<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mt/103/add-logo/upload-logo-header-5-templates.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Templates Movable Type" src="//cdn.inmotionhosting.com/support/images/stories/edu/mt/103/add-logo/upload-logo-header-5-templates.png" title="Click here to view the larger image" width="100" /></a>Go to "<em>Design</em>" on the left and click <strong>Templates</strong>. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mt/103/add-logo/upload-logo-header-6-template.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Template Module Movable Type" src="//cdn.inmotionhosting.com/support/images/stories/edu/mt/103/add-logo/upload-logo-header-6-template.png" title="Click here to view the larger image" width="100" /></a>Under the "<em>Template Modules</em>", click the <strong>Banner Header</strong>. <br style="clear: both;" />
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mt/103/add-logo/upload-logo-header-7-banner.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Header Banner Movable Type" src="//cdn.inmotionhosting.com/support/images/stories/edu/mt/103/add-logo/upload-logo-header-7-banner.png" title="Click here to view the larger image" width="100" /></a>You should see the code for the header name and description. <br style="clear: both;" /></p>
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mt/103/add-logo/upload-logo-header-8-image-code.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Image code Movable Type" src="//cdn.inmotionhosting.com/support/images/stories/edu/mt/103/add-logo/upload-logo-header-8-image-code.png" title="Click here to view the larger image" width="100" /></a>Add the following code after the &lt;div id="header-content"&gt;.<br style="clear: both;" />
<pre>&lt;img src="http://example.com/logo.png" alt="My Logo" style="float:left;padding: 0px 20px 0px 0px" /&gt; </pre>
<p><strong>Save</strong> the Changes.</p>
</li>
<li><strong><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mt/103/add-logo/upload-logo-header-9-publish.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Publish the site Movable Type" src="//cdn.inmotionhosting.com/support/images/stories/edu/mt/103/add-logo/upload-logo-header-9-publish.png" title="Click here to view the larger image" width="100" /></a></strong>Publish the site by clicking the <strong>Publish</strong> button at the top right. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mt/103/add-logo/upload-logo-header-10-publish-site.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Click the Publish button Movable Type" src="//cdn.inmotionhosting.com/support/images/stories/edu/mt/103/add-logo/upload-logo-header-10-publish-site.png" title="Click here to view the larger image" width="100" /></a>Click <strong>Publish</strong>. <br style="clear: both;" />
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mt/103/add-logo/upload-logo-header-11-close.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Close the publish success box Movable Type" src="//cdn.inmotionhosting.com/support/images/stories/edu/mt/103/add-logo/upload-logo-header-11-close.png" title="Click here to view the larger image" width="100" /></a>You should see a <strong>successful</strong> published notice. <strong>Close</strong> the publishing box. <br style="clear: both;" /></p>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mt/103/add-logo/upload-logo-header-12-final.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Final view with logo on site Movable Type" src="//cdn.inmotionhosting.com/support/images/stories/edu/mt/103/add-logo/upload-logo-header-12-final.png" title="Click here to view the larger image" width="100" /></a>Now when you go to your website you will see you logo at the top left like the snapshot to the right. <br style="clear: both;" /></p>
</li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/movable-type/change-theme-template-movable-type'>103: Changing the Appearance of Movable Type</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 2: Adding a Logo to your Movable Type site</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 1: <a href='/support/edu/movable-type/change-theme-template-movable-type/change-theme-movable-type'>How to change the theme in Movable Type</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 3: <a href='/support/edu/movable-type/change-theme-template-movable-type/edit-footer-banner-module'>Editing the Footer Banner module text in Movable Type</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/movable-type/change-theme-template-movable-type/add-logo-to-header-movable-type&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/movable-type/change-theme-template-movable-type/add-logo-to-header-movable-type'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zNDQmaWQ9MjI4NyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="00fa35539a1187614a899304d655666d" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/movable-type/change-theme-template-movable-type?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Changing the Appearance of Movable Type</h3></a>
		<table><tr><td colspan='2'><h4>Changing Themes</h4></td></tr>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/movable-type/change-theme-template-movable-type/change-theme-movable-type?tsrc=rsbedu'>How to change the theme in Movable Type</a></td>
                </tr>
        <tr><td colspan='2'><h4>Editing Templates</h4></td></tr>  <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/movable-type/change-theme-template-movable-type/add-logo-to-header-movable-type?tsrc=rsbedu'>Adding a Logo to your Movable Type site</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/movable-type/change-theme-template-movable-type/edit-footer-banner-module?tsrc=rsbedu'>Editing the Footer Banner module text in Movable Type</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/movable-type/change-theme-template-movable-type/remove-powered-by-reference?tsrc=rsbedu'>Removing the Powered By information in Movable Type</a></td>
                </tr>
          	</table>
