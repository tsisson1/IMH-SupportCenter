<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50616:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/wordpress/what-is-the-mysql-hostname-for-the-wpconfigphp-entry" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello markwj, and thanks for your question. You only need to add the MySQL hostname of localhost for that DB_HOST variable. There are 4 places in total ..." />
  <title>What is  the MySQL hostname for the wp-config.php entry | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/wordpress/what-is-the-mysql-hostname-for-the-wpconfigphp-entry" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:1dde4c097278a735581de5368497611f -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-22']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '99.1.197.39']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>What is  the MySQL hostname for the wp-config.php entry</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/markwj'>markwj</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-12-24 5:01 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>7,514</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>This is the /** MySQL hostname */<br />
define('DB_HOST', 'localhost/markja5_LoveFood');<br />
<br />
I have add the above localhost syntax is this correct?</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_2028' id='upvote_answer_2028' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='2028' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_2028').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_2028' id='downvote_answer_2028' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='2028' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_2028').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>9,968 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2012-12-24 5:38 pm EST
                		        </div>
					
		                </div>

				Hello markwj, and thanks for your question.<br />
<br />
You only need to add the MySQL hostname of &lt;strong&gt;localhost&lt;/strong&gt; for that &lt;strong&gt;DB_HOST&lt;/strong&gt; variable. There are 4 places in total where you will need to configure the WordPress database settings, and there is a separate &lt;strong&gt;DB_NAME&lt;/strong&gt; variable that you need to set for your database name.<br />
<br />
You can take a look at our article on &lt;a href=&quot;http://www.inmotionhosting.com/support/edu/wordpress/migrating-wordpress-inmotion-hosting/configuring-wordpress-after-a-migration#editing-the-wpconfigphp-file&quot; target=&quot;_blank&quot;&gt;configuring WordPress&lt;/a&gt; to see the &lt;strong&gt;wp-config.php&lt;/strong&gt; settings that are needed.<br />
<br />
...
- Jacob
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_2028').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_2028' id='form_comment_on_answer_2028' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/wordpress/what-is-the-mysql-hostname-for-the-wpconfigphp-entry&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/wordpress/what-is-the-mysql-hostname-for-the-wpconfigphp-entry'></div>
<script type='text/javascript'>
  (function() {
