<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:96670:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/wordpress/reinstall-wordpress-after-a-hack" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-06-10T13:35:29-07:00" />
  <meta name="keywords" content="reinstall wordpress hack clean clean up clean-up" />
  <meta name="author" content="Jacob Nicholson" />
  <meta name="description" content="In this article we'll discuss the steps you'd want to take after a WordPress site has been hacked, to get your site back up and running quickly." />
  <title>How to Re-Install WordPress after a Hack  - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/wordpress/reinstall-wordpress-after-a-hack" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:0e402e0297d87b6b6b0d29e78038eecd -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to Re-Install WordPress after a Hack 									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>32,244</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Nov 13, 2012'><span style='color:#606060;'>Published:</span> Jun 10, 2015</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In this article we'll discuss the steps you'd want to take after a WordPress site has been hacked, to get your site back up and running quickly. In most cases when a WordPress site is hacked, it is because you are not running the latest secure version of WordPress, or one of the plugins that you have installed is outdated and has been used by a hacker to exploit the site.</p>

<p>A lot of the time a hacker will inject malicious code in your PHP scripts that can make it very hard to clean up manually after the injections took place. In some cases this might require our system administration department to quarantine your entire WordPress site outside of your [/public_html] directory, so that we can ensure further hacks aren't taking place and further damage isn't done to your WordPress database.</p>

<p>If you happen to have read our previous article on <a href="/support/website/website-troubleshooting/clean-up-code-injection-attack">how to clean up a code injection attack</a>, the steps mentioned in that article might allow you to clean up any injections that have taken place to get your site back online.</p>
<p>In the steps below we'll walk through an example site&nbsp;<strong>PrimaryDomain.com</strong> that has been maliciously injected to the point where it's not going to be easy to remove all the malicious code and ensure we've caught all of it. So in this case we're simply going to reinstall WordPress and then link up the new install with our old database.</p>


<h2>Reinstalling WordPress after a Hack</h2>
<ol class="article_list">
<li>First you'll want to <a href="http://wordpress.org/download/" rel="nofollow">download the latest version of WordPress</a> to your local computer.</li>

<li>Extract the files in the&nbsp;<strong>.zip</strong>&nbsp;archive you downloaded to a local folder.</li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/wordpress-hack/filezilla-upload-files-to-public-html.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/wordpress-hack/filezilla-upload-files-to-public-html.png" alt="filezilla upload files to public html"  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;"/></a>Using <a href="/support/website/file-management/getting-started-guide-ftp">FTP</a>, upload all of the folders and files contained within the&nbsp;<strong>wordpress</strong> directory to your <b>public_html</b> directory. Or if your domain was an addon domain and its document root was in a sub-directory make sure you're uploading it there. You can do this by hitting&nbsp;<strong>Ctrl-A</strong> in your FTP client when you're in the left-hand pane to select all the files, then simply drag them onto the server.</li>

<li style="clear: both;"><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/wordpress-hack/filezilla-view-quarantined-wp-config.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/wordpress-hack/filezilla-view-quarantined-wp-config.png" alt="filezilla view quarantined wp-config"  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;" /></a>Once the files are done uploading, navigate to the&nbsp;<strong>quarantine</strong> directory on the server side, right-click on&nbsp;<strong>wp-config.php</strong> and choose&nbsp;<strong>View/Edit</strong>. Your FTP application should prompt you for what application you'd like to open the file with, you can just use a text editor such as&nbsp;<strong>Notepad</strong>. Then finally copy down the database information from the&nbsp;<strong>define('DB_...)</strong> sections.</li>

<li style="clear: both;"><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/wordpress-hack/wordpress-no-wp-config-file.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/wordpress-hack/wordpress-no-wp-config-file.png" alt="wordpress no wp-config file"  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;" /></a>At this point if you try to simply access the site you'll get a WordPress error about no&nbsp;<strong>wp-config.php</strong> file.</li>

  <li style="clear: both;"><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/wordpress-hack/filezilla-save-wp-config-sample.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/wordpress-hack/filezilla-save-wp-config-sample.png" alt="filezilla save wp-config sample"  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;" /></a>Back in your FTP client, navigate to your&nbsp;<strong>public_html</strong> directory and you should see a file called&nbsp;<strong>wp-config-sample.php</strong>, right-click on this file and choose&nbsp;<strong>View/Edit</strong>, open the file in&nbsp;<strong>Notepad</strong> then fill in your database name, database user, and database user password.<p>&nbsp;</p> <p>Then hit&nbsp;<strong>Ctrl-S</strong> to save the file, in a few seconds your FTP client should prompt you if you'd like to save this back to the server, click&nbsp;<strong>Yes</strong>. You can also place a check beside&nbsp;<strong>Finish editing and delete local file</strong> if your FTP client gives you that option.</p></li>

<li style="clear: both;">Now in your FTP client right-click on&nbsp;<strong>wp-config-sample.php</strong> choose&nbsp;<strong>Rename</strong>, and then name the file just&nbsp;<strong>wp-config.php</strong>.<br /></li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/wordpress-hack/filezilla-download-custom-theme.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/wordpress-hack/filezilla-download-custom-theme.png" alt="filezilla download custom theme"  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;" /></a>Now in this case if we try to go to our site again it's an all blank page, the reason for this is because our site used a custom theme, and those theme files are still quarantined. So next in your FTP client navigate to the&nbsp;<strong>/quarantine/wp-content/themes</strong> directory, and drag over the&nbsp;<strong>pinboard</strong> directory (or whichever theme you used) to your local computer.
...
<li style="clear: both;"><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/wordpress-hack/filezilla-upload-custom-theme.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/wordpress-hack/filezilla-upload-custom-theme.png" alt="filezilla upload custom theme"  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;" /></a>Now navigate on the server side to the&nbsp;<strong>/public_html/wp-content/themes</strong> directory, and then drag the&nbsp;<strong>pinboard</strong> directory from the local computer to the server.</li>

<li style="clear: both;"><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/wordpress-hack/wordpress-site-restored-successfully.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/wordpress-hack/wordpress-site-restored-successfully.png" alt="wordpress site restored successfully"  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;" /></a>You should now be able to hopefully pull up your website again free of any malicious hacks.</li>
  
  <p style="clear: both;">&nbsp;</p>

</ol>

<p style="clear: both;">Depending on the complexity of your WordPress site, you might want to also go in and reinstall any plugins that you had setup to get your site fully functional again. These steps above should at least get you to the point where you can start logging back into your WordPress administration panel again, and get your site back online for your visitors.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/wordpress/reinstall-wordpress-after-a-hack&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/wordpress/reinstall-wordpress-after-a-hack'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD02MyZpZD00NzUmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/wordpress/existing-mysql-new-install-of-wordpress-data-pages-not-appearing?tsrc=rsbraq'>Existing mySQL; new install of WordPress. Data (pages) not appearing.</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='http://a0.twimg.com/profile_images/2317372673/1x1zyTEp_bigger' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='/support/community-support/users/rduinmayer'>rduinmayer</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-05-07 11:23 am</div>
				                <div>You should always check the theme for fake pages as well....<br />
<br />
Don't ever just copy it from the quarantined installation to your new fresh installation.<br />
<br />
Just drag it on to your local computer, do a full and extended virus sweep first (with avg and maybe spybot too). <br />
Then download the original theme and compare the two theme-folders with each other (with winmerge).<br />
<br />
If all oke, you can put your theme back :) If not oke, put the new downloaded theme back.<br />
<br />
P.s. I am talking from personal experience here. They put a file in my theme in this directory (guess what it looked like a online bank's login page):<br />
 ?/wp-content?/themes?/delight?/scripts?/cache?/xxx?/logon.htm </div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(7828);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-05-07 1:25 pm</div>
				                <div>&lt;div style=&quot;background-color: #FFF; padding-left: 10px;&quot;&gt;Hello rduinmayer, and thanks for your comment and sharing your experience.<br />
<br />
I've gone ahead and updated step #8 above to suggest to others that might also read this article that they should scan their theme's folders for signs of a virus or malware, or preferably download a fresh copy of their theme.<br />
<br />
Thanks again for your comment!<br />
<br />
- Jacob&lt;/div&gt;</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(7829);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-8221'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//graph.facebook.com/zeeshansum/picture?type=normal' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='/support/community-support/users/learningall123'>learningall123</a></div>
						<div></div>
						<div></div>
						<div>3 <a href='/support/team/points' target='_blank'>Points</a></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-09-14 11:08 pm</div>
				                <div>sir, i want to install security in my site www.learningall.com, if i edit .htaccess file, my site is not working please check whats problem and where i add .htaccess coding in my .htaccess.<br />
thanks<br />
</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8221);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-09-16 11:32 am</div>
				                <div>When adding your the lines to your .htaccess file according the below article, be sure that you are adding these in addition to what you already have there.  Removing the existing lines that Wordpress requires for permalinks will cause 404 errors.<br />
<br />
&lt;a href=&quot;http://www.inmotionhosting.com/support/website/wordpress/lock-down-wordpress-admin-login-with-htaccess&quot;&gt;Lock down WordPress admin login with .htaccess&lt;/a&gt;</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8222);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-14649'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/2d6ea1377d05e6ca1f97e2eeecd7dd95?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/2d6ea1377d05e6ca1f97e2eeecd7dd95'>Raja</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-03 9:40 am</div>
				                <div>It just resolved the issue, someone has hacked our site and we could able to restore it using the methods mentioned above</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14649);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-15285'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/0dc2e1c0f428627515ef054b564dabb2?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/0dc2e1c0f428627515ef054b564dabb2'>Mansdorf</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-21 9:32 pm</div>
				                <div><p>Before step 3 (<span style="color: #232323; font-family: adelle-sans, Helvetica, Arial, sans-serif; font-size: 13px; line-height: 22px; background-color: #f8f8f8;">upload all of the folders and files contained within the&nbsp;</span><strong style="color: #232323; font-family: adelle-sans, Helvetica, Arial, sans-serif; font-size: 13px; line-height: 22px; background-color: #f8f8f8;">wordpress</strong><span style="color: #232323; font-family: adelle-sans, Helvetica, Arial, sans-serif; font-size: 13px; line-height: 22px; background-color: #f8f8f8;">&nbsp;directory to your&nbsp;</span><strong style="color: #232323; font-family: adelle-sans, Helvetica, Arial, sans-serif; font-size: 13px; line-height: 22px; background-color: #f8f8f8;">public_html</strong><span style="color: #232323; font-family: adelle-sans, Helvetica, Arial, sans-serif; font-size: 13px; line-height: 22px; background-color: #f8f8f8;">&nbsp;directory)</span>, should everything be deleted from that folder first?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15285);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
...
Scott M<br />
		...
		<a name='comment-15846'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/86ce4c33b4768ee914740cb31bb4bf7e?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/86ce4c33b4768ee914740cb31bb4bf7e'>Joseph</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-03 12:26 pm</div>
				                <div><p>I dont know if the service tech will get this. But Chris from Virgina beach did an amazing job helping me on this issue. Jesus name!!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15846);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-16793'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/78c1604419d7e5d1bd7a6cd60411ee3d?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/78c1604419d7e5d1bd7a6cd60411ee3d'>Hieru</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-27 11:53 pm</div>
				                <div><p>Hi,</p>
<p>How do you "quarantine" files that's currently in the folder containing the Wordpress installation?&nbsp; When I got to step 3 the FTP ask me if I want to overwrite all of the files that were in the Wordpress folder on my local machine... So what should I do?&nbsp; Thank you!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16793);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-28 8:31 am</div>
				                <div>To relocate your current files, you may simply create a new folder within your FTP client, then move those files into that new folder.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16802);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-28087'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/0223786d069b8d76d62a8dd39625cbea?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/0223786d069b8d76d62a8dd39625cbea'>Russ</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-02 4:13 am</div>
				                <div><p>Hi, My sites were recently hacked and I was redirected by support to this page. In steps 1 - 3, why can't we reinstall using Softaculous in CPanel? Could you please explain why, if it's linked to the latest version of Wordpress, it isn't safe to use/install?Also, I don't know what I'm doing wrong, but I follow the steps above and don't get a config error in step 5. I get a Wordpress setup dialog.After that, it doesn't get any better.</p>
<p>Thanks,</p>
<p>Russ</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28087);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-02 4:24 pm</div>
				                <div>Hello Russ,<br />
<br />
As long as you are uploading to a blank directory, you would be OK to use the Softaculous to install WordPress. However, it would install a new database and connect to it. You would need to change the wp-config.php file (or replace it with the old one) to direct it to the old database. Then you would want to delete the unused database.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28115);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-03 12:19 am</div>
				                <div><p>Hi Scott,I see, thanks for clarifying. I guess I would delete the old db from MySQL in CPanel - is this correct?Also, what are the implications if I didn't delete it?Thanks,Russ</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28119);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-03 12:07 pm</div>
				                <div>Hello Russ,<br />
<br />
I think there may be a misunderstanding here. In order for you to recover your website you need to direct the new WordPress files to the old database. Such as by using the old WordPress wp-config.php file.<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28127);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
