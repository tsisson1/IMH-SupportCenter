<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:60392:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/email/fighting-spam/create-spf-record-whm" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-04-22T21:15:44-07:00" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Learn how to create basic SPF records within WHM." />
  <title>Creating a basic SPF Record in WHM - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/email/fighting-spam/create-spf-record-whm" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:1e3df49f13ce3448e0530e75e43d6919 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '187.51.127.173']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Creating a basic SPF Record in WHM</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Creating a basic SPF Record in WHM									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>7,836</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Apr 22, 2014'><span style='color:#606060;'>Published:</span> Apr 22, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>If you are on a <a href="http://www.inmotionhosting.com/vps-hosting">VPS</a> or <a href="http://www.inmotionhosting.com/dedicated-servers">Dedicated server</a> hosting plan you have the ability to access your WebHost Manager tool, also known as WHM. This allows you access to many more tools to manage your server and hosting accounts. Within the WHM, you have the ability to add custom DNS records. As SPF records are a type of DNS records, you can customize these records should you have the need to do so. This guide will show you how to create a basic SPF record within your WHM.</p>

<p style="color:black; border: 1px solid #000000; border-radius: 5px;"><img  class="" style="float:left; margin:2px 5px 2px 0px; height:20px; width:20px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/email/spf/whm/exclamation.jpg" title="Click here to view the larger image" width="200" /> You need to know the syntax of your SPF record before entering it below. If you do not know the syntax you need, check out our article on Creating Custom SPF Records.</p>

<h2>Creating SPF records within your WHM</h2>

<ol class="article_list">
  <li><a href="/support/edu/whm/creating-and-managing-accounts/log-into-whm">Log into your WHM interface</a>.<div style="clear:both;"></div></li>
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/email/spf/whm/1-click-edit-dns-zone.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/email/spf/whm/1-click-edit-dns-zone.png" title="Click here to view the larger image" width="200" /></a>Look to the left sidebar menu,locate the <em>DNS Functions</em> category and click on <strong>Edit DNS Zone</strong>.<div style="clear:both;"></div></li>
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/email/spf/whm/2-select-domain.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/email/spf/whm/2-select-domain.png" title="Click here to view the larger image" width="200" /></a>To the right is a list of the domains on your hosting account. Highlight the domain name you want to create the SPF record for and click the <strong>Edit</strong> button. <div style="clear:both;"></div></li>
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/email/spf/whm/3-enter-spf-info.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/email/spf/whm/3-enter-spf-info.png" title="Click here to view the larger image" width="200" /></a>The <em>DNS Zone editor</em> page will appear. Scroll to the bottom of the screen and create your SPF record using the form under  <strong>Add New Entries Below this Line</strong>. There are four separate sections.
    <div style="clear:both;"></div>
    <table class="article_table" style="width:100%">
<tr>
  <th>Domain</th>
  <td>Enter the domain name to add a period (.) at the end of the domain name.</td>
</tr>

<tr>
  <th>TTL (Time to Live)</th>
  <td>This is the time in seconds the record exists before checking for updates. Leaving it at 14400 seconds (4 hours) is recommended.</td>
</tr>
      
<tr>
  <th>Record Type</th>
  <td>SPF records always need to be a type of TXT.</td>
</tr>      

<tr>
  <th>Record Data</th>
  <td>Here enter the actual SPF record within the quotation marks.</td>
</tr>          
</table>
<div style="clear:both;"></div></li>

  <li>After entering the information for your SPF record, click on the <strong>Save</strong> button at the bottom of the page. This will activate your new SPF record for your domain.<div style="clear:both;"></div></li>
</ol>

<br />
<p class="alert" style="color:red">Note that DNS changes take up to 24 hours to propagate. This means you need to allow a full 24 hours from the time you make any changes for them to take place across the internet.</p>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/email/fighting-spam/create-spf-record-whm&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/email/fighting-spam/create-spf-record-whm'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NiZpZD0zMjEwJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="03b74d62ce619023681ff95856ef04dc" value="1" />	</div>
	</form>
<!-- <br />
...
<a name='comments'></a>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//graph.facebook.com/justin.patnode.7/picture?type=normal' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='/support/community-support/users/WebEZ&per;net'>WebEZ.net</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-23 9:42 am</div>
				                <div>Its much easier than this, simply go in to WHM and &quot;List Accounts&quot; click the little plus sign next to the account and then click on the &quot;Modify account&quot; button, on the next page simply check the SPF box and then click save, the new SPF record will be added to that domains zone formatted properly.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10853);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-31883'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/75e5641298e1f5b37c223fbc20282d73?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/75e5641298e1f5b37c223fbc20282d73'>Smartit.org</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-13 4:28 am</div>
				                <div><p>Thank you that was very helpful</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31883);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
