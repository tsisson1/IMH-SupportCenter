<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:53575:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/joomla-25/fatal-error-maximum-execution-time-of-30-seconds-exceeded-in-homeso" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Charley, and thanks for your question. The PHP error that you are encountering is caused when a PHP script takes longer to execute then the server..." />
  <title>Fatal error: Maximum execution time of 30 seconds exceeded in /home/so | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/joomla-25/fatal-error-maximum-execution-time-of-30-seconds-exceeded-in-homeso" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:0ecf365a6abec1729ad9781c47323ca6 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Fatal error: Maximum execution time of 30 seconds exceeded in /home/so</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2014-03-11 1:24 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>909</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>http://www.southark.edu<br />
<br />
My Joomla 2.5 site was hacked.  All of the root files were deleted.  With help from Nick W in Tech Support, we got the index page to load.  But, clicking on any menu items returns the following error:<br />
Fatal error: Maximum execution time of 30 seconds exceeded in /home/southa13/public_html/libraries/joomla/html/html.php on line 214<br />
<br />
sometimes the line number will be 222 or a different line number.   <br />
I have reloaded the core Joomla files for the latest version.<br />
<br />
I have added a new .htacces file and a new php.ini.<br />
<br />
Thanks,<br />
Charley</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_4640' id='upvote_answer_4640' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='4640' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_4640').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_4640' id='downvote_answer_4640' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='4640' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_4640').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>9,968 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2014-03-11 1:50 pm EST
                		        </div>
					
		                </div>

				Hello Charley, and thanks for your question.<br />
<br />
The PHP error that you are encountering is caused when a PHP script takes longer to execute then the server allows for in the &lt;strong&gt;php.ini&lt;/strong&gt; file on the server.<br />
<br />
It can occur like you've seen, at different lines in your scripts, because it could be getting held up at different points each time.<br />
<br />
We have a guide on how to &lt;a href=&quot;http://www.inmotionhosting.com/support/website/joomla/fix-joomla-hack-and-upgrade-for-security&quot; target=&quot;_blank&quot;&gt;fix a Joomla hack and upgrade for security&lt;/a&gt; which might offer some help into this problem.<br />
<br />
It unfortunately looks like something has occurred in your Joomla files which is causing them to seemingly loop and hang when a sub section of your site is pulled up. I also noticed that you've had over 89,000 requests today from the User-Agent &lt;strong&gt;SiteLockSpider&lt;/strong&gt; as they seem to be scanning your site and keep hitting non existent URLs. If this is an external scan that you started, you might wish to have it stopped until your issues with Joomla are resolved.<br />
<br />
- Jacob
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_4640').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_4640' id='form_comment_on_answer_4640' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>&lt;div style=&quot;background-color: #FFF; padding-left: 10px;&quot;&gt;Hello Charley,<br />
<br />
When I took a look through your Joomla database, I noticed that you had 2 separate prefixes on your tables. Had you recently attempted to upgrade Joomla and the process was unable to complete all the way?<br />
<br />
- Jacob&lt;/div&gt;</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/joomla-25/fatal-error-maximum-execution-time-of-30-seconds-exceeded-in-homeso&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/joomla-25/fatal-error-maximum-execution-time-of-30-seconds-exceeded-in-homeso'></div>
<script type='text/javascript'>
  (function() {
