<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:53065:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/cpanel/better-tool-than-ip-deny-to-block-countries-ips" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, and thanks for your question. The WordFence Security plugin does work great if you have a WordPress website. We also already utilize server-wide ..." />
  <title>Better Tool Than IP Deny to Block Countries IPs | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/cpanel/better-tool-than-ip-deny-to-block-countries-ips" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:a5c88424dab11643cee3c758f402105f -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Better Tool Than IP Deny to Block Countries IPs</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2014-04-18 12:51 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>354</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>There is a tool for Wordpress called http://www.wordfence.com/<br />
<br />
It would save InMotionHosting significant bandwith ( = $ ) if they included this product on an account wide basis.  <br />
<br />
Manually entering all the IPs for countries not wanted is laborius and can be difficult for your basic user.  Certainly including this kind of tool on CPanel would be to InMotionHosting's advantage as well as every user.<br />
<br />
Please consider an easier tool than the IP Deny Tool.</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_4837' id='upvote_answer_4837' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='4837' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_4837').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_4837' id='downvote_answer_4837' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='4837' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_4837').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
...
<br />
The &lt;a href=&quot;http://www.inmotionhosting.com/support/edu/wordpress/wordpress-security-plugins/wordfence-security-plugin&quot; target=&quot;_blank&quot;&gt;WordFence Security plugin&lt;/a&gt; does work great if you have a WordPress website. We also already utilize server-wide ModSecurity rules to protect all of our users from &lt;a href=&quot;http://www.inmotionhosting.com/support/news/general/wp-login-brute-force-attack&quot; target=&quot;_blank&quot;&gt;WordPress brute force attacks&lt;/a&gt;.<br />
<br />
Because not all of our customers run WordPress, it's not something we'd want to include on every account by default. Most WordPress security plugins can cause you to have &lt;a href=&quot;http://www.inmotionhosting.com/support/website/server-usage/viewing-resource-usage-with-cpu-graphs&quot; target=&quot;_blank&quot;&gt;higher CPU usage&lt;/a&gt; as they analyze your traffic.<br />
<br />
If you'd like to block a specific country from any website no matter the CMS you're running, you can always use a tool like the &lt;a href=&quot;http://www.ip2location.com/free/visitor-blocker&quot; target=&quot;_blank&quot;&gt;IP2Location Block Visitors by Country&lt;/a&gt;, then like you said manually put them in your &lt;span style=&quot;color: red;&quot;&gt;.htaccess&lt;/span&gt; file. But take note that the China IP block for instance is about &lt;span style=&quot;color: red;&quot;&gt;6,200&lt;/span&gt; lines in itself. That means if you had China and a few other countries with large IP pools blocked via your &lt;span style=&quot;color: red;&quot;&gt;.htaccess&lt;/span&gt; file, your good visitors you're expecting from the USA or other places will have to have every single one of their requests processed through those &lt;span style=&quot;color: red;&quot;&gt;.htaccess&lt;/span&gt; rules which can lead to slower response times.<br />
<br />
We can look into possibly developing a better IP Deny plugin for use within cPanel, so that WordPress or any other type of website can be more easily protected. In my experience the best method for this is reviewing your website access logs via a cronjob and if problematic requests are coming in, then add that IP to the &lt;span style=&quot;color: red;&quot;&gt;.htaccess&lt;/span&gt; rules. That way if you just have 1 person from China trying to access your website maliciously you don't need to have the server check through every possible Chinese IP range for all requests, just block the single one causing problems.<br />
<br />
...
<br />
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_4837').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_4837' id='form_comment_on_answer_4837' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/cpanel/better-tool-than-ip-deny-to-block-countries-ips&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/cpanel/better-tool-than-ip-deny-to-block-countries-ips'></div>
<script type='text/javascript'>
  (function() {
