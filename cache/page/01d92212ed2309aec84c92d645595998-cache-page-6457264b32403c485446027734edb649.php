<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:59404:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/everything-email/mcafee/allow-address" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-04-29T23:01:00-07:00" />
  <meta name="keywords" content="mcafee control console allowed sender list whitelist email address" />
  <meta name="author" content="John-Paul Briones" />
  <meta name="description" content="In this tutorial we will show you how to add an email address to the Allowed Sender List, or Whitelist an address in the McAfee Control Console." />
  <title>Allowing / Whitelisting an Email Address in the McAfee Control Console - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/everything-email/mcafee/allow-address" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:0e4542601874485ee5224cd6127b89a5 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Allowing / Whitelisting an Email Address in the McAfee Control Console									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='clear:both;'></div>
								...
								<div>In this guide we will show you how to add an email address to your allowed list (or whitelist) which lets emails from that address bypass the spam filter and make it to your Inbox.&nbsp;<br /><br /></div>
<p class="alert">This tutorial is for people who are using the<a href="/support/edu/everything-email/mcafee/email-protection" target="_blank"> McAfee email protection</a>.</p>
<h1>How to Allow / Whitelist an address:</h1>
<ol class="article_list">
<li><a href="/support/edu/everything-email/mcafee/control-console-user" target="_blank">Login to the McAfee Control Console as an email user</a>.</li>
<li>Click the <strong>Allowed Senders</strong> tab.</li>
<li>In the field next to the <em>New </em>button, enter the address you want to allow through the spam filter, then click the <strong>New</strong> button.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/mcafee/allowed-list/adding-sender.png"><img src="//cdn.inmotionhosting.com/support/images/stories/mcafee/allowed-list/adding-sender.png" alt="whitelisting a sender in the mcafee control console"  style="margin: 15px;" /></a></li>
<li>You will then see the email listed in the field above, click the <strong>Apply</strong> button to save. <br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/mcafee/allowed-list/applying-save.png"><img src="//cdn.inmotionhosting.com/support/images/stories/mcafee/allowed-list/applying-save.png" alt="saving changes in the McAfee Control Console"  style="margin: 15px;" /></a><br />They will now be able to bypass the spam filter and email you successfully.<br /><br /></li>
</ol>
<div>&nbsp;</div>
<div>Congratulations, now you are able to add an address to the Allowed Senders list in the McAfee Control Console.</div>
<div>&nbsp;</div> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 3: Allowing / Whitelisting an Email Address in the McAfee Control Console</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 2: <a href='/support/edu/everything-email/mcafee/control-console-user'>Accessing the McAfee Control Console as an Email User</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 4: <a href='/support/edu/everything-email/mcafee/block-blacklist'>Blocking / Blacklisting an Email Address in the McAfee Control Console</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/everything-email/mcafee/allow-address&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/everything-email/mcafee/allow-address'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMzcmaWQ9MjI0MSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
        ...
        <tr><td colspan='2'><h4>Working with the Allowed / Blocked Senders List</h4></td></tr>  <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>3.</td>
