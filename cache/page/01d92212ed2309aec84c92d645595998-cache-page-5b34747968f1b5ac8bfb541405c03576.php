<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:51536:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/cpanel/softaculous" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="keywords" content="softaculous" />
  <meta name="description" content="In this set of tutorials, we'll show you how to use Softaculous to install and manage software within your hosting account." />
  <title>103: Using Softaculous | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/cpanel/softaculous" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:b340b6b270f28e5763f5dbc6116c021a -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '92.0.176.123']);
...
<div class='page-header'>
	<h1>103: Using Softaculous</h1>
</div>
<div class='section_listing'>
	<h1 style="margin-top: 0px;">Softaculous</h1>


<div class='white_box' style='float:right; width:300px; margin:0px 0px 15px 15px;'>
  <h2 style='margin-top:5px;'>Frequently Asked Questions</h2>
  <ul>
    <li><strong>TRANSFERS</strong><br />Softaculous is a tool for installing software. If you're looking for information on transferring a website instead, please <a href="/support/website/how-to/migrate-website-from-another-host">click here</a>.</li>
    <li><strong>PHP VERSION ERRORS</strong><br /> Getting errors similar to <em>Required PHP version greater than equal to...</em>? <a href='/support/community-support/joomla/problem-trying-to-download-joomla'>See this question</a></li>
    <li><strong>WHERE TO INSTALL</strong><br /><a href="/support/edu/cpanel/softaculous/faq-installing-programs-with-softaculous">Can I install more than one program? Can I install it on my temporary url, in a sub folder, or in a subdomain?</a></li>
  </ul>
</div>


<p>Softaculous is a tool located within your cPanel you can use to help you easily install other programs. Softaculous does the tedious work involved with software installation. No more uploading installation files or creating and configuring databases, you can now install programs such as WordPress and Joomla by simply clicking a link.</p>
<p>On this page, you'll find a complete tutorial series that walks you through all of the great features included within Softaculous!</p>
<p>Softaculous is free with every Shared Hosting account, VPS or dedicated hosting customers can <a href="/support/edu/cpanel/softaculous/how-to-purchase-a-softaculous-license-in-amp">purchase a Softaculous license from AMP</a>.</p>
<div style="clear: both;">&nbsp;</div>
	<table>
	<tr><td colspan='3'><h2>Installing and Uninstalling programs</h2><div>Learn how to use Softaculous to easily install or remove applications from your account.</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 1:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/cpanel/softaculous/faq-installing-programs-with-softaculous'>FAQ - Installing programs with Softaculous</a>
					<div>Before we show you how to install programs with Softaculous, we'll first review commonly asked installation related questions.</div>
					<div class='smallgrey'>Hits: 4,104</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/cpanel/softaculous/list-programs-softaculous'>List of programs in Softaculous</a>
					<div>This is a list of programs that can be installed through Softaculous.</div>
					<div class='smallgrey'>Hits: 24,941</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/cpanel/softaculous/how-to-install'>How to install programs using Softaculous</a>
					<div>In this tutorial, we'll show you how to install a program using Softaculous.</div>
					<div class='smallgrey'>Hits: 36,925</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/cpanel/softaculous/softaculous-uninstall'>How to uninstall programs using Softaculous</a>
					<div>Removing programs in Softaculous is as easy as installing them, and we'll walk you through the uninstall steps in this guide.</div>
					<div class='smallgrey'>Hits: 14,572</div>
				</td>
			</tr>
		<tr><td colspan='3' style='padding-top:20px;'><h2>Managing your programs</h2><div>Once a program is installed, Softaculous continues to provide great features, such as a simple way to backup, restore, and upgrade your applications.</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 5:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/cpanel/softaculous/whats-installed'>How to manage software installed using Softaculous</a>
					<div>Managing several different programs through Softaculous is easy to do with the Scripts Installations page.</div>
					<div class='smallgrey'>Hits: 3,699</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/cpanel/softaculous/upgrade-within-softaculous'>How to upgrade a program installed with Softaculous</a>
					<div>Keeping your software up to date is very important, and in this tutorial we'll show you how to upgrade programs within Softaculous.</div>
					<div class='smallgrey'>Hits: 4,628</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/cpanel/softaculous/enable-auto-upgrade'>How to enable Auto Upgrade feature in Softaculous</a>
					<div>Learn how to enable the auto upgrade feature for specific programs in Softaculous.</div>
					<div class='smallgrey'>Hits: 2,638</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/cpanel/softaculous/softaculous-update-rollback'>Softaculous Auto Upgrade and Rollback</a>
					<div>Learn how to use the AutoUpdate and Rollback features in Softaculous.</div>
					<div class='smallgrey'>Hits: 797</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/cpanel/softaculous/create-backup'>How to Back up your Website with Softaculous</a>
					<div>In this tutorial, we'll show you how to generate and restore backups using Softaculous.</div>
					<div class='smallgrey'>Hits: 8,024</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/cpanel/softaculous/restore-backup'>How to Restore a Softaculous Backup</a>
					<div>Learn how to Restore a website Backup created using Softaculous.</div>
					<div class='smallgrey'>Hits: 662</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/cpanel/softaculous/cloning-your-site'>How to clone your site with Softaculous</a>
					<div>This article will walk you through cloning your site using the Softaculous tool.</div>
					<div class='smallgrey'>Hits: 12,716</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/cpanel/softaculous/import-programs'>How to import programs into Softaculous</a>
					<div>Softaculous includes an import feature, which you can use to help Softaculous find other software you've installed using other installers such as Fantastico.</div>
					<div class='smallgrey'>Hits: 3,601</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/cpanel/softaculous/syncing-software-softaculous'>Importing software in Softaculous when Sync fails</a>
					<div>This article is about Importing programs into Softaculous through the import feature.</div>
					<div class='smallgrey'>Hits: 2,078</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/cpanel/softaculous/email-notification-settings'>Configuring Email Notifications within Softaculous</a>
					<div>Softaculous provides update notifications for software upgrades or patches for the software that it has installed.  These notifications also include other email notifications and options.  The following tutorial explains how to find and use these settings within the Softaculous interface in cPanel.</div>
					<div class='smallgrey'>Hits: 1,148</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/cpanel/softaculous/how-to-purchase-a-softaculous-license-in-amp'>How to purchase a Softaculous license in AMP</a>
					<div>In this article we'll discuss how your can purchase a Softaculous license to have the popular auto installer addon for cPanel added to your VPS or dedicated server.</div>
					<div class='smallgrey'>Hits: 7,188</div>
				</td>
			</tr>
			</table>
</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNTcmaWQ9MjU3JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="113fc4bfd9c7712806450472bc68ea6b" value="1" />	</div>
	</form>
<!-- <br />
