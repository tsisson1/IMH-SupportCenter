<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:130320:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/php/update-local-php-settings" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-07-17T16:48:11-07:00" />
  <meta name="keywords" content="PHP phpinfo.php local php settngs changing php settings recursive php.ini phpinfo suPHP_ConfigPath what version php do I have" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="Learn to change php settings via your php.ini file." />
  <title>How to Change PHP settings in your hosting account - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/php/update-local-php-settings" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:0ea48f73a45f302560fc7e410dba10ac -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '192.187.100.154']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to Change PHP settings in your hosting account</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to Change PHP settings in your hosting account									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>149,082</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Aug 25, 2011'><span style='color:#606060;'>Published:</span> Jul 17, 2015</div>
							...
							<div style='clear:both;'></div>
								...
								<p>PHP is a scripting language used primarily on the web and is available on our shared, VPS, and <a href="http://www.inmotionhosting.com/dedicated-servers">Dedicated servers</a>. PHP is highly customizable and has many settings that our users can modify themselves. This article will advise you how to change PHP settings in your php.ini file.</p>
<div class="alert alert-info" role="alert">We also have a helpful guide on <a href="/support/website/php/command-line-settings">Setting your PHP Settings in Command Line</a>.</div>

<h2>How to view your current PHP settings</h2>
<p>To view your current PHP settings, create a PHPinfo page. If you're not sure how to do this, please see <a href="/support/website/general-server-setup/create-phpinfo-page-to-see-php-settings">How can I view my PHP settings using a PHPinfo page ?</a></p>
<p>The steps in updating the values listed in your PHP info page depend on how PHP is setup on your particular server. In general, PHP runs on our servers as either:</p>
<ul>
<li>Apache module</li>
<li>CGI Module</li>
</ul>
<p>To find out how PHP is configured on your server, create a PHP info page (via the above instructions) and look at the "<em>Server API</em>"' value. If the "<em>Server API</em>" is <strong>"</strong><em>CGI</em>", then PHP is running as <em>"CGI module"</em>. If "<em>Apache</em>" is listed, then your server is running PHP as an "<em>Apache module"</em>.</p>
<h3>Server API: Apache</h3>
<p>If your server runs PHP as an "<em>Apache module</em>", you can change your PHP settings via a .htaccess file. A .htaccess file is a configuration file you can create and use to change many server settings, including PHP settings. The basic syntax to use in your .htaccess file for updating PHP settings is:</p>
<pre class="code_block" style="margin-left: 20px;">php_value Directive value</pre>
<p>For example, if you wanted to change the max_input_time from 60 seconds to 120 seconds, add the following to your .htaccess file:</p>
<pre class="code_block" style="margin-left: 20px;">php_value max_input_time 120</pre>
<p>After making this change, refresh your PHP info page, and you should see the changes. If you receive a 500 error, please double check the syntax you used as you may have made a misspelling.</p>
<p>If you don't have a .htaccess file, you can simply create a new file named .htaccess. As the .htaccess file begins with a dot (.), it is considered a hidden file. If you are using the cPanel's File Manager, please be sure to select the option to&nbsp;<em>Show Hidden Files (dotfiles)</em>, otherwise you will not be able to see your .htaccess file. If you do not see this prompt when opening your File Manager, click the, "reset all interface settings" link at the bottom of your cPanel to reset your File Manager settings.</p>
<h3>Server API: CGI</h3>
<p style="float: right; width: 150px; margin: 0px 0px 15px 15px;"><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/cpanel/php-ini-view.gif"><img src="//cdn.inmotionhosting.com/support/images/stories/cpanel/php-ini-view.gif" alt="the-php-temporary-directory-is-not-set"  width="150" /></a><br />View of the php.ini in the File Manager</p>
<p>If your server runs PHP as a CGI module, you can change your local php.ini file in order to make modifications to your PHP setup. php.ini is a PHP configuration file with a list of PHP directives and their values. In the above example, we modified the max_input_time value. If you open your php.ini file and search for max_input_time, you should see something similar to:</p>
<pre class="code_block" style="margin-left: 20px;">;;;;;;;;;;;;;;;;;;;<br />; Resource Limits ;<br />;;;;;;;;;;;;;;;;;;;<br />
max_execution_time = 30<br /><b>max_input_time = 60</b><br />memory_limit = 256M<br />upload_max_filesize = 10M</pre>
<p>To change the <em>max_input_time</em> from 30 seconds to 120, for example, simply change 30 to 120 and save the file. Refresh your PHP info page, and you should see the changes.<br style="clear: both;" /></p>
<h3>Increasing PHP memory in the php.ini</h3>
<p>A common issue when using free open source software or other PHP intensive programs is the &quot;<em>exhausted memory</em>&quot; error. If you have a PHP memory error on your site, you can increase the memory limit PHP uses for the scripts. To learn how to change the memory limit in your php.ini, please see the following link.</p>

  <p style="margin-left:20px"><a href="http://www.inmotionhosting.com/support/website/website-troubleshooting/allowed-memory-size-exausted">Fixing the Allowed memory size exhausted error</a></p>



<h2>Modifying the PHP.INI file</h2>
<p>Here is a quick step-by-step tutorial on editing the PHP.INI file.</p>
<p></p>

<ol class="article_list">
<li><a href="http://www.inmotionhosting.com/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel" target="new">Login to the cPanel</a>.<div style="clear:both;"></div></li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/edit-php-ini/file-manager-cpanel.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="200" src="//cdn.inmotionhosting.com/support/images/stories/edu/edit-php-ini/file-manager-cpanel.png" alt="File Manager in the cPanel" align="right" ></a>Find the File Manager in File section of the Cpanel.  Review our tutorial on using the <a href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-file-manager/file-manager-code-editor" rel="nofollow" target="new">Code Editor</a> within the File manager if you're looking on information how to use it.<div style="clear:both;"></div></li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/edit-php-ini/file-manager-icons.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="200" src="//cdn.inmotionhosting.com/support/images/stories/edu/edit-php-ini/file-manager-icons.png" alt="File Manager icons" align="right" ></a>Navigate to the directory where you will either save or edit the PHP.INI file and then select the file and use the Code Editor. To open the file, you can click on it to select the file and then click on the Code Editor icon in the menu bar of the File Manager.  You can also right-click with your mouse and select Code Editor from the menu that appears.<div style="clear:both;"></div></li>

<li>Edit the section of the PHP.INI that you wish to change.<div style="clear:both;"></div></li>

<li>Click on <strong>SAVE CHANGES</strong> in the top right hand corner in order to save your modifications or additions to the file.<div style="clear:both;"></div></li>

</ol>

<h2>Common Problems when Updating your php.ini file</h2>
<h3>I don't have a php.ini file!</h3>
<p>Only users running on a server with PHP loaded as a "<em>CGI module</em>" will have a php.ini file. The php.ini file by default will be located at <strong>public_html/php.ini</strong>. If you do not see a file named php.ini in your public_html, please contact our Support Department and request that we create one for you.</p>
<h3>I made changes to the php.ini file, however I do not see the changes!</h3>
<p>The php.ini file is not recursive. Updating your php.ini values in <strong>public_html/php.ini</strong> will not affect PHP files in subfolders of your public_html, such as public_html/staff. To correct this problem, you can make your php.ini file recursive so that it affects all sub folders. More help on this can be found in <a href="/support/website/general-server-setup/recursive-php-ini">How can I make my php.ini file recursive?</a></p>
<h2>Considering a VPS or Dedicated Server?</h2>
<p>With a VPS or dedicated server, a site owner can truly customize the server to their exact specification. If you are on a Shared Hosting account, and are thinking about upgrading from to a VPS or <a href="http://www.inmotionhosting.com/dedicated-servers">dedicated server</a>, click here to read more about a <a href="http://www.inmotionhosting.com/vps_hosting/articles/vps-vs-dedicated.html">VPS vs dedicated</a> server.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/php/update-local-php-settings&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/php/update-local-php-settings'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MTImaWQ9NDQmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="1d27f6775f4603705a768a71e1807c92" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/opencart/import-problem?tsrc=rsbraq'>In OpenCart, page goes blank when importing</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/website-troubleshooting/htacess-adddefaultcharset-dontwork?tsrc=rsbraq'>Unable to change default charset</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support//?tsrc=rsbraq'>What can I do about a slow RSS feed?</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/file-management/default-folders-and-files-in-publichtml-directory?tsrc=rsbraq'>Default Folders and Files in public_html Directory</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/website/can-i-increase-phpvalue-maxinputvars-on-my-server?tsrc=rsbraq'>Can I increase php_value max_input_vars on my server?</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/drupal-7/too-many-connections-error-on-quite-site?tsrc=rsbraq'>Too many connections error on quite site</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/website-troubleshooting/when-i-upload-pdf-documents-my-php-returns-blank-pages-no-error-in-log?tsrc=rsbraq'>when I upload PDF documents my php returns blank pages No error in log</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/prestashop-15/in-prestashop-php-configuration-limits?tsrc=rsbraq'> In PrestaShop - PHP configuration limits</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/file-management/phpini-file-needed-on-my-server?tsrc=rsbraq'>php.ini file needed on my server</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/drupal-7/drupal-website-view-cannot-be-edited?tsrc=rsbraq'>Drupal website view cannot be edited</a>
                                </div>
...
<a name='comments'></a>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='https://lh6.googleusercontent.com/-KxirtZu_9oc/AAAAAAAAAAI/AAAAAAAAC-0/7AKEIPuaMMs/photo.jpg?sz=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='/support/community-support/users/klathmon'>klathmon</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-05-15 10:40 am</div>
				                <div>I just wanted to thank you for this. I have spent 2 hours combing through blog-spam and other crap on the internet until i found this. This was hands down one of the best tutorials on anything i have seen in a long time. It worked perfectly the first time with no issues.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(7855);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-9963'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/c5d447e240e4775a6c7743c8b1d4f033?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/c5d447e240e4775a6c7743c8b1d4f033'>Matt</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-22 1:53 am</div>
				                <div><p>Thanks for this article. It quite clear.</p>
<p>But, how do you change the max input vars when using a CGI server?</p>
<p>There is no max_input_vars in the local php.ini.</p>
<p>&nbsp;</p>
<p>Thanks in advance.</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9963);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-22 7:49 am</div>
				                <div>While it may not already be located in your local file, you may always add the line which will change what is defined there.  The php.ini variables are still the same regardless of how you are running PHP.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9973);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-14652'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/02f81c0a9e1d18bc00811861ee6ec135?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/02f81c0a9e1d18bc00811861ee6ec135'>Enzo</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-03 11:08 am</div>
				                <div><p>And how that line should be to change vars?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14652);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-03 1:07 pm</div>
				                <div>Hello Enzo,<br />
<br />
Thank you for your question. To change the variable, just adjust modify the number following the rule you want to change. For example:<br />
<code>memory_limit = 256M</code><br />
<br />
To increase the memory_limit in this case, just change the number to what you need:<br />
<code>memory_limit = 512M</code><br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14663);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-16480'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/e75c6a1c64ca79e03ad0f8fd3db89884?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/e75c6a1c64ca79e03ad0f8fd3db89884'>ajay</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-20 6:40 am</div>
				                <div><p>Hi,</p>
<p><span style="color: rgb(35, 35, 35); font-family: adelle-sans, Helvetica, Arial, sans-serif; font-size: 12px; line-height: 22px; background-color: rgb(235, 235, 235);">how to increase &nbsp;max_input_vars &nbsp;values.... &nbsp;In htaccess it is throwing error. &nbsp; &nbsp;&nbsp;</span></p>
<p>It is not working for me.!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16480);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-20 8:51 am</div>
				                <div>Hello ajay,<br />
<br />
Thank you for your question. Typically, you would increase the  max_input_vars value in the php.ini file.<br />
<br />
...
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16481);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-16852'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/88f9161851d3959dd251da7e3bd33eb9?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/88f9161851d3959dd251da7e3bd33eb9'>Debiprasad Sahoo</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-29 10:33 am</div>
				                <div><p>How can I use local php setting while using php in CLI. For example, if I am using composer and the command is "php composer update", how can I use local settings for this? I am getting out of memory while running "php composer update".</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16852);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-29 11:04 am</div>
				                <div><p>Later I checked it and found that CLI uses local settings. Unfortunately, I could not solve my out of memory issue while using composer.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16855);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-29 11:12 am</div>
				                <div>Hello Debiprasad,<br />
<br />
Thanks for the question.  I am unable to find out if you are an InMotion customer, so that I could see the server type you're using.  When I researched this issue, I was told that there need to be some type of configuration added to your CLI command to help with the memory management.  Otherwise, memory would be managed by the server php.ini settings.  In order to change the server settings you would need to have access to the server as a root user.  This would not be possible on a shared server account with InMotion.  <br />
<br />
I hope this helps to provide some clarity on the issue.  Please let us know if you continue to have any further questions or comments.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16856);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-30 2:28 am</div>
				                <div><p>My client is an InMotion customer. And it's a shared hosting. Is there any chance to run the CLI command without the out of memory error (in other words to increase allowed memory).</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16884);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-30 9:54 am</div>
				                <div>Hello Debiprasad,<br />
<br />
Thank you for your question. You can specify the php.ini file in command in for example:<br />
<p class="code_block">php -c /home/userna5/public_html/php.ini /home/userna5/public_html/somefile.php</p><br />
You also, can specify php.ini settings in the command, such as:<br />
<p class="code_block">php -c /home/userna5/public_html/php.ini /home/userna5/public_html/somefile.php -d memory_limit=256M</p><br />
If you have any further questions, feel free to post them below.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16898);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 160px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-31 2:04 am</div>
				                <div><p>Thank you for letting me know about those two tricks. But unfortunately, I am unable to run "php composer update" properly. Even if I set the memory to&nbsp;2048M, it's not working and showing out of memory error.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16930);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 200px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-31 10:37 am</div>
				                <div>Hello Debiprasad,<br />
<br />
Thank you for the additional information. I found the official Composer guide on troubleshooting <a href="https://getcomposer.org/doc/articles/troubleshooting.md#memory-limit-errors" target="_blank" >Memory errors in Composer</a>.<br />
<br />
It provides several solutions, and you can even submit a ticket to them directly to investigate further.<br />
<br />
If you have any further questions, feel free to post them below.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16946);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-21741'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/67c32510d33dd54c36a902fe1e86fe6a?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/67c32510d33dd54c36a902fe1e86fe6a'>Paresh Shah</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-16 10:14 am</div>
				                <div><p>i am having error when uploading bulk product data through csv of internal server,&nbsp;tried all changes in the php but still same out of 7k product list only 200 or 300 some times get uploaded and i get 500 internal server error&nbsp;i am using Prestashop 1.6.1.14 version</p>
<p>thanks in advance3</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21741);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-16 2:37 pm</div>
				                <div>Hello Paresh Shah,<br />
<br />
...
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21779);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-22546'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/48d664e952143cf1a14810b6e77cb82a?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/48d664e952143cf1a14810b6e77cb82a'>BiBoy</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-12 12:10 am</div>
				                <div><p>It doesn't work...</p>
<p>I have changed the value of max_file_uploads = 100 (its default is 20) and check it by &lt;? phpinfo(); ?&gt;.</p>
<p>the max_file_uploads value has changed to 100 but i still can upload only 20 files as the default.</p>
<p>Why?</p>
<p>Thanks...</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22546);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-13 11:43 am</div>
				                <div>Hello BiBoy,<br />
<br />
Have you set the <a href="http://www.inmotionhosting.com/support/website/php/recursive-php-ini">php.ini to be recursive</a> to all folders under that directory?<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22585);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-23999'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/b10be932eda86ddb5e63aadbae7e481e?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/b10be932eda86ddb5e63aadbae7e481e'>Shawn Gaske</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-06 11:22 am</div>
				                <div><p>I updated my php.ini file to allow 512mb uploads, but it's been over a day and WordPress still reports that I can only upload 128mb. How do I get the server to accept my changes?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23999);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-08 2:59 pm</div>
				                <div>Hello Shawn,<br />
<br />
You will also need to ensure the <a href="http://www.inmotionhosting.com/support/website/php/recursive-php-ini">php.ini file is recursive</a>.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24025);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-24401'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/8bd45d31a83ec145007ac901756d0fa6?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/8bd45d31a83ec145007ac901756d0fa6'>Ashwini</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-24 7:55 am</div>
				                <div><p>Hiiiiii Friends,</p>
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; I want to receive mail on my own website mailbox can you help me for this type code for the receive unread mail using core php</p>
<p>&nbsp;&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24401);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-24 3:16 pm</div>
				                <div>Hello Ashwini,<br />
<br />
We do not provide programming services through the support center so we cannot provide custom  code for you to set up your own mail service.  If you want to use the existing mail service, you can use <a href="http://www.inmotionhosting.com/support/website/sending-email-from-site/using-the-php-mail-function-to-send-emails">phpMail</a>  or you can use the existing mail interfaces and administration through the cPanel.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24416);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-25598'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/3011ab9c46177b62854a667d561d576b?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/3011ab9c46177b62854a667d561d576b'>eric</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-07 7:09 pm</div>
				                <div><p>hello, how do i change maximum execution time from 60 to 300sec from my cpanel, when i open my &nbsp;.htaccess file this what i find&nbsp;</p>
...
<p># END WordPress</p>
<p>&nbsp;</p>
<p>and i do not have any php.ini &nbsp;file in all my file folders so i created one for my cpanel and open it with the code editor and pasted the command code</p>
<p>max_execution_time = 300 &nbsp;and clicked o save but when i checked my php.infor of my website the max execution time still remains at 60 no changes were noticed, what do i do, thanks in advance</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25598);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-10 8:17 am</div>
				                <div>Hello Eric,<br />
<br />
That may be a hard setting set by your host. As to ensure customers do not run processes for long periods I believe we also have ours set to 60 seconds as the max. However your php.ini insert is the correct method to increase the max_execution_time if you were able to.<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25623);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-26577'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/a96bfe48d0d07ca1dd3082aa1258e277?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/a96bfe48d0d07ca1dd3082aa1258e277'>Sheila</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-11 5:36 pm</div>
				                <div><p>I can't tell you how grateful I am for your site, thank you.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26577);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-27757'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/b2b1124984a6ac3eb5393a3e1230cff7?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/b2b1124984a6ac3eb5393a3e1230cff7'>Mark Chang</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-21 11:06 pm</div>
				                <div><p>Hi, I don't have a php.ini. Can I just make one? or are there special configurations needed?</p>
<p>&nbsp;</p>
<p>Thanks</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27757);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-22 9:58 am</div>
				                <div>Hello Mark,<br />
<br />
Thank you for contacting us. <em>Only users running on a server with PHP loaded as a "CGI module" will have a php.ini file. The php.ini file by default will be located at public_html/php.ini. If you do not see a file named php.ini in your public_html, please contact our <a href="http://www.inmotionhosting.com/contact">Support Department</a> and request that we create one for you.</em><br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27772);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-30712'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/58e202af27ca961c23e6f3385dd1d5ab?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/58e202af27ca961c23e6f3385dd1d5ab'>Fahad M.</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-02-21 6:26 pm</div>
				                <div><p>Hello!</p>
<p>I intend to move my website, and I'm looking for a reliable</p>
<p>hosting. With the ex-hosting company I faced a problem related to:</p>
<h3>"<strong>php.ini</strong>" + "<strong>htaccess</strong>" + "<strong>Creating Redirect URL</strong>".</h3>
<p>&nbsp;</p>
<h2>The Issue Details:</h2>
<p>It is an ordinary thing; some websites structures need to change the</p>
<p>php.ini&nbsp;values such as <strong>"<span style="color: #272727; font-family: Verdana, Geneva, sans-serif; font-size: 14px; line-height: 20px;">max_input_vars" </span></strong>to ensure a good performance</p>
<p>of the site.</p>
<p>&nbsp;</p>
<p>When the ex-hosting support team have changed</p>
<p>the values, they had to set "<strong>suPHP_ConfigPath</strong>" as a line</p>
<p>inside "<strong>htaccess</strong>" to make it effective in my blog subfolder, but</p>
<p>I got an error while I was creating</p>
<p>a redirect URL between my domains, as it is in this screenshot:</p>
<p>http://i.imgur.com/AM4EeEF.jpg</p>
<p>&nbsp;</p>
<p>Once I removed, I made a redirect without any errors, but</p>
<p>I lost all "<strong>php.ini</strong>" values like it is not existing!</p>
<p>&nbsp;</p>
<p>Do you think I will face the same problem with your</p>
<p>hosting?</p>
<p>&nbsp;</p>
<p>Thank you.</p>
<p>Fahad M.</p>
<p>:)</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30712);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-02-22 9:39 am</div>
				                <div>Hello Fahad,<br />
<br />
Sorry for the problems with the re-direct.  In general, if we can see the re-direct commands being set, then we can determine the cause and fix the issue.  We can't guarantee you that your particular re-direct will work without seeing what it is that you're trying to do,  but it doesn't make any sense that local php.ini files written to your account would just disappear.  At the very lease, we would recommend making backups of the file so that we would be able to recover if something did happen.   Finding a particular host will always be YOUR choice, and you're welcome to try our service if you wish.  <br />
<br />
If you have any further questions or comments, please let us know.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30729);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
