<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:62178:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/ftp/connecting-scp-sftp" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-08-14T12:33:09-07:00" />
  <meta name="keywords" content="fail PCI compliance FTP being open  use SFTP SCP connect  server" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="When you fail PCI compliance for FTP being open, you can use SFTP or SCP to connect to your server." />
  <title>Connecting with SCP and SFTP - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/ftp/connecting-scp-sftp" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:5fb24976df6c84c3417f4855b5e98184 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '193.201.228.27']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Connecting with SCP and SFTP									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>9,537</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Feb 22, 2013'><span style='color:#606060;'>Published:</span> Aug 14, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>With the rise of security risks on Websites that process credit cards, some&nbsp;<a href="/support/website/website-troubleshooting/pci-compliance" target="_blank">PCI compliance</a> companies, like <a href="https://www.trustwave.com/" target="_blank">Trustwave</a> are requiring FTP to be shut off and a different method of uploading and downloading files be used. In order to accommodate these PCI compliance requirements, you can use SFTP or SCP to copy files from your local computer to your server.</p>
<h2>What is SFTP and SCP?</h2>
<p><strong>SFTP</strong> is <strong><a target="_blank" href="/support/website/general-server-setup/what-is-shell-access">SSH</a> File Transfer Protocol</strong>, <strong>Secure File Transfer Protocol</strong>, or <strong>Secure FTP</strong>. An SFTP connection uses port 22 through the command line or another SFTP client. SFTP connects securely so the data is encrypted over the network. You can restrict certain IP addresses and allow certain IP addresses making the&nbsp;<a target="_blank" href="/support/website/general-server-setup/what-is-shell-access">SSH</a> port 22 open only to specific users.</p>
<p><strong>SCP</strong> is <strong>Secure copy</strong> based off of the Secure Shell Protocol (<a target="_blank" href="/support/website/general-server-setup/what-is-shell-access">SSH</a>). SCP is a Secure connection over port 22 that allows only certain IP addresses to access the server the same as SFTP.</p>
<h2>Why would I want to use SCP and SFTP?</h2>
<p>If you are running a website that requires credit card payment transactions, you will need to follow <a href="/support/website/website-troubleshooting/pci-compliance" target="_blank">PCI compliance</a> standards. This is to ensure that the site will not be compromised by hackers trying to steal personal information. Website owners run PCI compliance scans on their server to find any potential risks to website attacks. When the server fails to pass the PCI scan due to FTP <a target="_blank" href="/support/website/website-troubleshooting/close-open-ports-for-pci-compliance">port 21 being open</a>, the web developer is forced to use a different method to upload and download files from the server. This is where <strong>SCP</strong> and <strong>SFTP</strong> come in. <strong>SFTP</strong> and <strong>SCP</strong> allow the developer to connect to your server on a secure connection.</p>
<h2>What hosting accounts support SCP and SFTP?</h2>
<p>The only servers that allow a developer to connect using SFTP or SCP are <strong>VPS</strong> and <strong>Dedicated</strong> servers. <strong>Shared servers do not have SSH access</strong>, so if you fail a PCI scan for FTP being accessible, you will need to <a target="_blank" href="/support/website/general-server-setup/upgrade-downgrade-hosting-plan">upgrade to a VPS or Dedicated</a> to be able to use SCP or SFTP.</p>
<h2>How do I connect / use SCP and SFTP?</h2>
<p>You can use <strong>SSH Secure Shell</strong>, <strong>PuTTy</strong>, <strong>FileZilla</strong> or another program to connect to your server using SFTP. WinSCP can connect to your server using SCP protocol. You can even use some HTML editors to connect with SFTP like <a target="_blank" href="/support/website/dreamweaver">DreamWeaver</a>.</p>
<h3>Connecting with SFTP with FileZilla</h3>
<ol class="article_list">
<li><a target="_blank" href="/support/website/file-management/configuring-your-site-in-filezilla" title="Click for more information">Open FileZilla</a>.</li>
<li>Click the site manager button at the top right of the FileZilla client.</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/scp-sftp-connection/scp-sftp-1-filezilla.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Conecting SFTP with FileZilla" src="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/scp-sftp-connection/scp-sftp-1-filezilla.gif" title="Click here to view the larger image" width="100" /></a>Set your connection to the following settings.
<pre style="margin-left: 20px;">Host: your-server.com
Port: 22
Protocol: SFTP (SSH File transfer Protocol)
Logon  type: Normal
User: The cPanel username
Password: The cPanel password
Account: Leave blank</pre>
<p class="alert"><strong>Important!</strong> You must have your local <a target="_blank" href="/support/website/general-server-setup/add-ip-to-firewall">IP address added to your server Firewall</a> through the WHM.</p>
<br style="clear: both;" /></li>
</ol>
<h3>Connecting with SCP with WinSCP</h3>
<ol class="article_list">
<li><a target="_blank" href="/support/website/file-management/how-to-connect-using-ftp-and-winscp" title="Click for more information">Open WinSCP</a>.</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/scp-sftp-connection/scp-sftp-2-winscp.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Connecting with SCP WinSCP" src="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/scp-sftp-connection/scp-sftp-2-winscp.gif" title="Click here to view the larger image" width="100" /></a>Set your connection to the following settings.
<pre style="margin-left: 20px;">Host name: your-server.com
Port number: 22
File Protocol: SCP 
User name: The cPanel username
Password: cPanel password</pre>
<p class="alert"><strong>Important!</strong> You must have your local&nbsp;<a target="_blank" href="/support/website/general-server-setup/add-ip-to-firewall">IP address added to your server Firewall</a> through the WHM.</p>
<br style="clear: both;" /></li>
</ol> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/ftp/connecting-scp-sftp&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/ftp/connecting-scp-sftp'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MDImaWQ9NTg0JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="cfe52a0fe9155f272ba49d60ef1d1111" value="1" />	</div>
	</form>
<!-- <br />
