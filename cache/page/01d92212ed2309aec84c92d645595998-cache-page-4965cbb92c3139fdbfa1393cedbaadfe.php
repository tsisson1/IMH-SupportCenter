<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:59554:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/prestashop-15/312-configure-1-click-upgrade" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-10-30T16:32:54-07:00" />
  <meta name="keywords" content="1-click upgrade module configure PrestaShop 1.5" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="This PrestaShop 1.5 article walks you through configuring the 1-click Upgrade module." />
  <title>312: How to configure the 1-click Upgrade module in PrestaShop 1.5 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/prestashop-15/312-configure-1-click-upgrade" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:d35458f8809036e0d8842f4b4506e8a2 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															312: How to configure the 1-click Upgrade module in PrestaShop 1.5									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>3,495</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Oct 30, 2012'><span style='color:#606060;'>Published:</span> Oct 30, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<div>Our previous article demonstrated <a href="/support/edu/prestashop-15/install-1-click-upgrade-module">how to install the 1-click Upgrade module</a> for your PrestaShop 1.5 store. This article will now guide you on the configuration of the module. Follow the steps below to learn how to set up the 1-click upgrade module for Prestashop 1.5.</div>
<p><strong>Configuring the 1-Click Upgrade Module in PrestaShop 1.5</strong></p>
...
<li>This will bring you to the Modules list page. From here, you will want to scroll along the right-hand panel until you locate the 1-click Upgrade module. Click on the <strong>Configure</strong> link to go to the configuration screen.<br /><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/prestashop1.5/Modules/1-Click-Upgrade-Configure/configure-1-click-upgrade.png"><img  alt="configure-1-click-upgrade" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/prestashop1.5/Modules/1-Click-Upgrade-Configure/configure-1-click-upgrade.png" /></a><br /><br /><br /></li>
<li>You are now on the configuration page for the 1-click Upgrade module. You will see several sections on this page. First,&nbsp; you will want to go over the checklist in <strong>The pre-Upgrade checklist</strong> and ensure that all selections are green.<br /><br /></li>
<li>Next, scroll down to the bottom two sections named <strong>Backup Options</strong> and <strong>Upgrade Options</strong>. From here you can set the different options that will take place during the upgrade.<br /><br /><strong>Backup Options</strong><br />
<table class="article_table">
<tbody>
<tr><th>Backup my files and database</th>
<td>If selected, this will ensure you have a backup copy of your current shop should things go awry.&nbsp; This is enabled by default.</td>
</tr>
<tr><th>Backup my images</th>
<td>If selected, all images will be backed up in case of a failure. If disabled, please ensure you have your own backup copies for all images.</td>
</tr>
</tbody>
</table>
<br /><strong>Upgrade Options<br />
<table class="article_table">
<tbody>
<tr><th>Server performance</th>
<td>Select the server performance. If not on a dedicated server, it is recommended to choose 'Low'.</td>
</tr>
<tr><th>Disable non-native modules</th>
<td>Some non-native modules have compatibility issues. It is advised to have them disabled during the upgrade.</td>
</tr>
<tr><th>Upgrade the "default" theme</th>
<td>Select to update the default theme. If selected, you will lose any customizations or modifications that were made.</td>
</tr>
<tr><th>Upgrade the default e-mails</th>
<td>Select to update the default emails. If selected, you will lose any customizations or modifications that were made to the emails.</td>
</tr>
</tbody>
</table>
<br /> </strong></li>
<li>After selecting your preferred options, scroll back up to the <strong>Start Your Upgrade</strong> section. Click on the <strong>Upgrade PrestaShop Now!</strong> button to begin the upgrade. You will see a processing screen during the upgrade. Below is a screenshot of that screen.<br /><br /><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/prestashop1.5/Modules/1-Click-Upgrade-Configure/1-click-upgrade-processing.png"><img  alt="1-click-upgrade-processing" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/prestashop1.5/Modules/1-Click-Upgrade-Configure/1-click-upgrade-processing.png" /></a></li>
<li>After the install is complete, be sure to <a href="/support/edu/prestashop-15/set-configure-catalog-modes/how-to-set-maintenance-mode-in-prestashop-15">take your store out of maintenance mode</a>. You can also now see the new version listed at the bottom of each page in the shop. In this case, we installed the 1.5.2 version.<br /><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/prestashop1.5/Modules/1-Click-Upgrade-Configure/current-version-corner.png"><img  alt="current-version-corner" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/prestashop1.5/Modules/1-Click-Upgrade-Configure/current-version-corner.png" /></a></li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 55: 312: How to configure the 1-click Upgrade module in PrestaShop 1.5</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 54: <a href='/support/edu/prestashop-15/313-setup-authorize-net-module'>313: Setting up  the Authorize.net module in PrestaShop 1.5</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 56: <a href='/support/edu/prestashop-15/302-an-error-occurred-during-installation'>302: PrestaShop 1.5 - Configure shop information - an error occurred during installation</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/prestashop-15/312-configure-1-click-upgrade&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/prestashop-15/312-configure-1-click-upgrade'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD05OSZpZD0yNDEwJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="38ea146fee9742de306f64aaa6e74f9d" value="1" />	</div>
	</form>
<!-- <br />
