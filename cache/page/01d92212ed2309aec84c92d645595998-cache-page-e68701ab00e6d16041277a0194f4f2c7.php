<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:51796:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/domain-names/i-dont-want-my-addon-domains-to-create-subdomains" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Diagabro, Thanks for the question! First, if you an InMotion customer and you are subscribed to a Business level hosting account, then your accoun..." />
  <title>i don't want my add-on domains to create subdomains | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/domain-names/i-dont-want-my-addon-domains-to-create-subdomains" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:e156994bcb7911ad1c906a0834ffe035 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-20']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '99.180.93.171']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>i don't want my add-on domains to create subdomains</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='https://lh6.googleusercontent.com/-sHxZ2BtML9I/AAAAAAAAAAI/AAAAAAAAAb0/WPuAiiczLFE/photo.jpg?sz=90' class='user_avatar' /><br />
			<a href='/support/community-support/users/diagabro'>diagabro</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-01-21 1:28 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>217</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I am a new user trying to wrap my head around the idea of add-on domains. Say I own abc.com and xyz.com and I have set abc as primary. I want to set one website on abc and another independent website on xyz. <br />
<br />
My understanding is that if I set xyz as add-on domain, that automatically creates a sub-domain in abc and when visitors type xyz.com they actually get routed to xyz.abc.com - but i don't want that. if someone visits my xyz.com website I want their address bar to say exactly that and not reroute to a sub-domain of my primary domain.<br />
<br />
Not sure if I got my premises right tho. Can someone explain how parked domains function once I set them up? The tutorial says they automatically create subdomains. So if I don't want those, can I set my both domains to be &quot;primary&quot;?</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_6356' id='upvote_answer_6356' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='6356' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_6356').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_6356' id='downvote_answer_6356' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='6356' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_6356').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Diagabro,<br />
<br />
Thanks for the question!  First, if you an InMotion customer and you are subscribed to a Business level hosting account, then your account creates a cPanel account on the server.  cPanel's design allows a single primary account to be assigned to that created cPanel account.  In order to allow multiple hosting accounts under that ONE cPanel account, subfolders are automatically created under the account.  These subfolders are (by default) assigned to the add-on domains.  The server knows -through DNS- where the account is located and considers the add-on domains as <i>separate</i> websites, even though they're on the same cPanel account.  So, unless someone knows your directory structure, they normally will never see the files of any add-on domain that has been created as a subdomain to your primary domain (under public_html).  I know that was a mouthful, so my apologies.  Basically, the default file structures for the website look like this:<br />
<br />
home<br />
     public_html (where your primary website files live)<br />
          sub-domain/subdirectory (where the add-on files live)<br />
<br />
As I said, this is the default way in which cPanel works.  The subdomain relationship is something that cannot be removed because of how this add-on domain setup was created.  If you don't want add-on domains, then you would either need to get separate hosting accounts, or upgrade to a VPS or Dedicated server account where you can have multiple cPanel accounts.   <br />
<br />
Some people do not like the actual files to be UNDER the <b>public_html</b> folder.  Fortunately, you can change this.  When you <a href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-manage-domains/adding-add-on-domain-in-cpanel">create the add-on domain</a>, you can change where the files are located .  Change the <b>Document Root</b> line by typing in the name that you want to use for the site's directory. <br />
<br />
Parked domains re-direct to the primary domain.  You cannot have two primary domains.  <br />
<br />
...
Arnel C.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_6356').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_6356' id='form_comment_on_answer_6356' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/domain-names/i-dont-want-my-addon-domains-to-create-subdomains&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/domain-names/i-dont-want-my-addon-domains-to-create-subdomains'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="339d729b89bca25297b987e38c9ac6b6" value="1" />	</div>
	</form>
<!-- <br />
