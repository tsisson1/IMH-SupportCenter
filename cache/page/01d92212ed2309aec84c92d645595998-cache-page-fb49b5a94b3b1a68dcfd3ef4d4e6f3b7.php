<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:52024:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/opencart/i-need-help-with-an-upgrading-issue-with-opencart" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, During the upgrade process sometimes the database does not get updated. I would suggest contacting OpenCart forums regarding their upgrade script..." />
  <title>I need help with an upgrading issue with Opencart | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/opencart/i-need-help-with-an-upgrading-issue-with-opencart" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:eb5046b8772c6cea799465f054b06e4a -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>I need help with an upgrading issue with Opencart</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-10-20 5:39 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>48</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Ok I just did the beta upgrade for opencart 14x to 15x and I'm getting all these errors. Can someone help me determine what I need to do? Im not sure where to go from here... I contacted inmotion tech support and they said you might know how to fix this?  <br />
Here are the errors:<br />
OpenCart 1.x Upgrade Script (BETA)<br />
<br />
The following errors occured:<br />
<br />
Could not execute this query: SELECT @dat:=`value` FROM oc_setting WHERE `group` = 'config' and `key` = 'config_description_1'; Unknown column 'group' in 'where clause'<br />
<br />
Could not execute this query: SELECT @id:=`setting_id` FROM oc_setting WHERE `group` = 'config' and `key` = 'config_description_1'; Unknown column 'group' in 'where clause'<br />
<br />
Could not execute this query: SELECT @dat:=`value` FROM oc_setting WHERE `group` = 'config' and `key` = 'config_welcome_1'; Unknown column 'group' in 'where clause'<br />
<br />
Could not execute this query: INSERT INTO `oc_option` (`option_id`, `type`, `sort_order`)SELECT `product_option_id`, &quot;select&quot;, `sort_order` FROM `oc_product_option`; Unknown column 'sort_order' in 'field list'<br />
<br />
Could not execute this query: INSERT INTO `oc_option_description` (`option_id`, `language_id`, `name`)SELECT `product_option_id`, `language_id`, `name` FROM `oc_product_option_description`; Table 'vipera6_ocar197.oc_product_option_description' doesn't exist<br />
<br />
Could not execute this query: INSERT INTO `oc_option_value` (`option_value_id`, `option_id`, `sort_order`)SELECT `product_option_value_id`, `product_option_id`, `sort_order` FROM `oc_product_option_value`; Unknown column 'sort_order' in 'field list'<br />
<br />
Could not execute this query: INSERT INTO `oc_option_value_description` (`option_value_id`, `language_id`, `option_id`, `name`)SELECT `pov`.`product_option_value_id` , `language_id` , `pov`.`product_option_id` , `name`FROM `oc_product_option_value_description` AS `povd` INNER JOIN `oc_product_option_value` AS `pov` ON `pov`.`product_option_value_id` = `povd`.`product_option_value_id`; Table 'vipera6_ocar197.oc_product_option_value_description' doesn't exist<br />
<br />
The above errors occurred because the script could not properly determine the existing state of those db elements. Your store may not need those changes. Please post any errors on the forums to ensure that they can be addressed in future versions!</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_8362' id='upvote_answer_8362' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='8362' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_8362').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_8362' id='downvote_answer_8362' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='8362' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_8362').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
During the upgrade process sometimes the database does not get updated. I would suggest contacting OpenCart forums regarding their upgrade script to see if just simply creating the columns/tables that are missing will resolve the issue. If so you can do that within PHPMyAdmin.<br />
<br />
Best Regards,<br />
TJ Edens
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_8362').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_8362' id='form_comment_on_answer_8362' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/opencart/i-need-help-with-an-upgrading-issue-with-opencart&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/opencart/i-need-help-with-an-upgrading-issue-with-opencart'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="088763b6df2273489d902e742be2f0bf" value="1" />	</div>
	</form>
<!-- <br />
