<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:91295:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/everything-email/spam-prevention-techniques/spf-records-domain-keys-combating-spam" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-04-21T15:00:09-07:00" />
  <meta name="keywords" content="domain key SPF Spam records authentication" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="In this tutorial, learn what Domain Keys and SPF records are. " />
  <title>SPF Records and Domain Keys: Combating Spam - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/everything-email/spam-prevention-techniques/spf-records-domain-keys-combating-spam" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:d7e83d8f602b31a7a2fc3509bea21c47 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '67.219.123.254']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															SPF Records and Domain Keys: Combating Spam									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>68,851</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Sep 1, 2011'><span style='color:#606060;'>Published:</span> Apr 21, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<iframe width='675' height='315' src='https://www.youtube.com/embed/lCGCGKI9x5M' frameborder='0' allowfullscreen></iframe>
<div style="float:right; width:275px; margin-bottom:15px; text-align:right;"><em>Like this video? You can find more on <a href="http://www.youtube.com/user/InMotionSupport" target="_blank">InMotion Hosting's YouTube page</a>!</em></div>
<div style="clear:both;'></div>


<p>Beginning in late March of 2010, our shared servers are being upgraded to the latest version of cPanel, which now allows users to create their own SPF records and Domain Keys. SPF and Domain Keys are tools used by many mail servers in an effort to combat spam, so if you're having an issue with your email being bounced back or arriving in the junk/spam folders of your recipients, it is suggested to enable these settings. Please keep in mind that as these are DNS settings, they may take up to <strong>24 hours or more</strong> before they begin to take effect.</p>

<p class="alert" style="color:red"><strong>Important!</strong> cPanel will show the following error when setting up your DKIM and SPF records.
<pre style="margin-left:20ps">(Warning: cPanel is unable to verify that this server is an authoritative nameserver for example.com [?])</pre>
This is a known bug within cPanel and can be disregarded. cPanel checks the local server for DNS in cPanel causing this error. 
</p></p></div>
<h1 style="background-color: #e8e8e8; padding: 10px;">About Domain Keys and SPF Records</h1>
<div style="padding: 10px;"><b>Domain Keys</b><br />
...
<p><b>SPF</b><br />SPF will specify which machines are authorized to send email from your domain(s). This means that only mail sent through this server will appear as valid mail from your domain(s) when the SPF records are checked.</p>
<p><b>Additional Info</b><br />
Yahoo - Domain keys -&nbsp;<a href="http://help.yahoo.com/l/us/yahoo/mail/classic/context/context-07.html" target="_new" style="outline-style: none; outline-width: initial; outline-color: initial; color: #306090;">http://help.yahoo.com/l/us/yahoo/mail/classic/context/context-07.html</a><br />
Google - SPF -&nbsp;<a href="http://www.google.com/support/a/bin/answer.py?hl=en&amp;answer=33786" target="_new" style="outline-style: none; outline-width: initial; outline-color: initial; color: #306090;">http://www.google.com/support/a/bin/answer.py?hl=en&amp;answer=33786</a><br />AOL - SPF -&nbsp;<a href="http://postmaster.aol.com/spf/details.html" target="_new" style="outline-style: none; outline-width: initial; outline-color: initial; color: #306090;">http://postmaster.aol.com/spf/details.html</a><br />
AOL - Domain keys -&nbsp;<a href="http://postmaster.aol.com/Postmaster.DKIM.html" target="_new" style="outline-style: none; outline-width: initial; outline-color: initial; color: #306090;">http://postmaster.aol.com/Postmaster.DKIM.html</a></p>
</div>
<h1 style="background-color: #e8e8e8; padding: 10px;">How to Implement Domain Keys and SPF Records</h1>
<div style="padding: 10px;">SPF Records and Domain Keys can be set within the "<strong>Email Authentication</strong>" section of your cPanel. The specific instructions are in the cPanel, and you can also visit cPanel's own website for more details:<br /><a href="http://docs.cpanel.net/twiki/bin/view/AllDocumentation/CpanelDocs/EmailAuthentication" target="_new" style="outline-style: none; outline-width: initial; outline-color: initial; color: #306090;">http://docs.cpanel.net/twiki/bin/view/AllDocumentation/CpanelDocs/EmailAuthentication</a>
<p>If you need further assistance, or, if you do not have the "<strong>Email Authentication</strong>" icon in your cPanel, please email <a href="mailto:support@inmotionhosting.com">support@inmotionhosting.com</a> for further assistance.</p>
</div>
<p>If you missed our previous article, please see the <a href="/support/edu/everything-email/spam-prevention-techniques/combating-spam-spamassassin" title="Click here to view the previous article" target="_blank">Combating Spam: Using SpamAssassin</a> tutorial. For more information on this course please visit <a target="_blank" href="/support/edu/everything-email/spam-prevention-techniques" title="Click here to view the courses">Preventing Spam</a>. Please see the next article on how to <a href="/support/email/fighting-spam/spamcop-net-how-to-stop-spam">Permanently stop spam with SpamCop</a>.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 5: SPF Records and Domain Keys: Combating Spam</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 4: <a href='/support/edu/everything-email/spam-prevention-techniques/combating-spam-spamassassin'>Combating Spam: Using SpamAssassin</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 6: <a href='/support/edu/everything-email/spam-prevention-techniques/550-spam-message'>550 This message was classified as SPAM and may not be delivered </a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/everything-email/spam-prevention-techniques/spf-records-domain-keys-combating-spam&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/everything-email/spam-prevention-techniques/spf-records-domain-keys-combating-spam'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xMTgmaWQ9OTQ0JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="ecfa42762f1de16339bb0ce05500918c" value="1" />	</div>
	</form>
<!-- <br />
          ...
          <tr >
			...
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/fighting-spam/spf-error?tsrc=rsbraq'>SPF error &quot;unable to verify that this server is an authoritative name&quot;</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/email/permerror-spf-permanent-error-include-has-trivial-recursion?tsrc=rsbraq'>PermError SPF Permanent Error: include has trivial recursion</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/fighting-spam/how-can-fix-spam-mail-problem?tsrc=rsbraq'>How can I stop email from being flagged as spam?</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/fighting-spam/does-moving-a-message-to-the-roundcube-junk-folder-do-anything?tsrc=rsbraq'>Does moving a message to the Roundcube Junk folder do anything?</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/18aa3e9ef298d5038b99b93caaefdf4a?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/18aa3e9ef298d5038b99b93caaefdf4a'>Chris Conner</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-26 1:22 pm</div>
				                <div><p>this is the email address that correspondence was sent.</p>
<p>the msg. was sent on Tuesday morning and I didn't recieve it unitl Friday morning.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10164);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-28 12:16 am</div>
				                <div>Hello Chris,<br />
<br />
SPF records would not delay email delivery. Although email was intended to be delivered within 24 hours, it can be delayed longer at times due to other issues with one or more email servers along the route.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10215);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-11010'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/676efd84ff0ee6ccae33033a7d13e21e?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/676efd84ff0ee6ccae33033a7d13e21e'>Marco Tancredi</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-30 6:37 pm</div>
				                <div><p>Hello there,I'm trying to figure out WHY most of the e-mail I send are always going to others SPAM box... I just send a couple of e-mails per dayand of course I'm NOT a spammer! Can someone&nbsp;please&nbsp;help me?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11010);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
...
Arnel C.<br />
		...
		<a name='comment-19837'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/555416706bcac6eb6ffb89147e43a43a?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/555416706bcac6eb6ffb89147e43a43a'>BOBBY WILLIAMS</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-22 10:25 pm</div>
				                <div><p>my e-mailing of invoices and purchase orders &nbsp;from quickbooks pro are suddenly going into spam files to those i'm sending to. I'm using exede as an internet provider,outlook as my e-mail,the invoices are sent pdf format.my e-mail is yahoo. all parties are clueless,as am i. there is no notification on my end anything is wrong. just in much digging with my customers,could i fing this out. any miracle would be appreciated. my livlihood depends on this getting straightened out.</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19837);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-23 10:37 am</div>
				                <div>Hello Bobby,<br />
<br />
The receiving server is typically the one that determines whether to place the email in the Spam folder or not. If you can log into the yahoo mail server to see if it is the same there. That will confirm the server is the one that placed it in the spam folder. As to why, I can only guess that something in the spam algorithm has changed where it is flagging those specific email. Is there a way to whitelist the email address it comes from?<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19854);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-19996'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/049e08c7429859e02ff23a6166a6baa0?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/049e08c7429859e02ff23a6166a6baa0'>Eid</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-27 4:11 am</div>
				                <div><p>allways gmail and other domains&nbsp; think my domain is send spam and block our domain .the question hot to resolve this problems.</p>
<p>example :MDaemon Delivery Status Notification - http://www.altn.com/dsn/--------------------------------------------------------------------------</p>
<p>The attached message had PERMANENT fatal delivery errors.</p>
<p>After one or more unsuccessful delivery attempts the attached message hasbeen removed from the MDaemon mail queue on this server. The number andfrequency of delivery attempts are determined by local configuration.</p>
<p>--------------------------------------------------------------------------YOUR MESSAGE WAS NOT DELIVERED TO ONE OR MORE RECIPIENTS--------------------------------------------------------------------------</p>
<p>Failed address: aeed2000@gmail.com</p>
<p>--- Session Transcript ---Sun 2015-01-25 11:34:46: Session 216355; child 0001Sun 2015-01-25 11:34:46: Parsing message &lt;xxxxxxxxxxxxxxxxxxxxxxxx\pd35000076253.msg&gt;Sun 2015-01-25 11:34:46: * From: eid@krcsd.comSun 2015-01-25 11:34:46: * To: aeed2000@gmail.comSun 2015-01-25 11:34:46: * Subject: testSun 2015-01-25 11:34:46: * Size (bytes): 2172Sun 2015-01-25 11:34:46: * Message-ID: &lt;WC20150125083443.950125@krcsd.com&gt;Sun 2015-01-25 11:34:46: Attempting SMTP connection to [gmail.com]Sun 2015-01-25 11:34:46: Resolving MX records for [gmail.com] (DNS Server: 196.202.139.242)...Sun 2015-01-25 11:34:46: * P=005 S=000 D=gmail.com TTL=(24) MX=[gmail-smtp-in.l.google.com]Sun 2015-01-25 11:34:46: * P=010 S=001 D=gmail.com TTL=(24) MX=[alt1.gmail-smtp-in.l.google.com]Sun 2015-01-25 11:34:46: * P=020 S=002 D=gmail.com TTL=(24) MX=[alt2.gmail-smtp-in.l.google.com]Sun 2015-01-25 11:34:46: * P=030 S=003 D=gmail.com TTL=(24) MX=[alt3.gmail-smtp-in.l.google.com]Sun 2015-01-25 11:34:46: * P=040 S=004 D=gmail.com TTL=(24) MX=[alt4.gmail-smtp-in.l.google.com]Sun 2015-01-25 11:34:46: Attempting SMTP connection to [gmail-smtp-in.l.google.com:25]Sun 2015-01-25 11:34:46: Resolving A record for [gmail-smtp-in.l.google.com] (DNS Server: 196.202.139.242)...Sun 2015-01-25 11:34:46: * D=gmail-smtp-in.l.google.com TTL=(4) A=[74.125.195.26]Sun 2015-01-25 11:34:46: Attempting SMTP connection to [74.125.195.26:25]Sun 2015-01-25 11:34:46: Waiting for socket connection...Sun 2015-01-25 11:34:46: * Connection established (172.16.0.2:51405 -&gt; 74.125.195.26:25)Sun 2015-01-25 11:34:46: Waiting for protocol to start...Sun 2015-01-25 11:34:46: &lt;-- 220 mx.google.com ESMTP w8si13460231wjw.51 - gsmtpSun 2015-01-25 11:34:46: --&gt; EHLO mail.krcsd.comSun 2015-01-25 11:34:46: &lt;-- 250-mx.google.com at your service, [212.0.145.90]Sun 2015-01-25 11:34:46: &lt;-- 250-SIZE 35882577Sun 2015-01-25 11:34:46: &lt;-- 250 SMTPUTF8Sun 2015-01-25 11:34:46: --&gt; MAIL From:&lt;eid@krcsd.com&gt; SIZE=2172Sun 2015-01-25 11:34:46: &lt;-- 250 2.1.0 OK w8si13460231wjw.51 - gsmtpSun 2015-01-25 11:34:46: --&gt; RCPT To:&lt;aeed2000@gmail.com&gt;Sun 2015-01-25 11:34:47: &lt;-- 250 2.1.5 OK w8si13460231wjw.51 - gsmtpSun 2015-01-25 11:34:47: --&gt; DATASun 2015-01-25 11:34:47: &lt;-- 354 End data with a single dot on a lineSun 2015-01-25 11:34:47: Sending &lt;xxxxxxxxxxxxxxxxxxxxxxxx\pd35000076253.msg&gt; to [74.125.195.26]Sun 2015-01-25 11:34:47: Transfer CompleteSun 2015-01-25 11:34:58: &lt;-- 550-5.7.1 [212.0.145.90 12] Our system has detected that this message isSun 2015-01-25 11:34:59: &lt;-- 550-5.7.1 likely unsolicited mail. To reduce the amount of spam sent to Gmail,Sun 2015-01-25 11:34:59: &lt;-- 550-5.7.1 this message has been blocked. Please visitSun 2015-01-25 11:34:59: &lt;-- 550-5.7.1 http://support.google.com/mail/bin/answer.py?hl=en&amp;answer=188131 forSun 2015-01-25 11:34:59: &lt;-- 550 5.7.1 more information. w8si13460231wjw.51 - gsmtpSun 2015-01-25 11:34:59: --&gt; QUIT--- End Transcript ---</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19996);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-27 10:07 am</div>
				                <div>It appears that Gmail may have blocked the server IP due to suspected spam.  If your account is hosted with us, you may &lt;a href=&quot;http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support&quot;&gt;submit a ticket with live support&lt;/a&gt; in which they will be happy to assist you.  If you are sending this email from outside of our server, you will need to request delisting from Google.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20005);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-27263'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/f479b41d3069919d25ac84fe6cba4685?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/f479b41d3069919d25ac84fe6cba4685'>Josh N</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-06 9:56 am</div>
				                <div><p>Hello! ALL of our company emails from yarngirls@*******.com get sent to the SPAM folder if the recipient is a GMAIL user - every single time! This has been happening for years... I've just taken over as webmaster and I'd love to see if I can do something about it. We're on a low-end server... I know we could upgrade and try that... but that's a larger task and I'd like to exhaust all other options first. Does anybody have any insight for me? It would be greatly appreciated!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27263);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-28072'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/e361989eb9b012c6c7af3312187a73d7?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/e361989eb9b012c6c7af3312187a73d7'>rathankar</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-01 12:39 am</div>
				                <div><p>I am also experiencing similar problems.</p>
<p>&nbsp;</p>
<p>I have a website, which takes in external registration and confirmation of these registrants will be sent to the user's email. upon clicking on this link in the email, the user will be registered and can he can use this website.</p>
<p>&nbsp;</p>
<p>The email containing the confirmation link is sent to spam email box. So really dont know how to overcome this issue. spf records are already been added in the dns settings. what else should i do. can someone shedlight on it</p>
<p>&nbsp;</p>
<p>Thanks in advance</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28072);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-02 4:05 pm</div>
				                <div>Hello rathankar,<br />
<br />
You may want to contact the server that is hosting the email and have them take a look at a copy of the email so they can see why their server may think it is spam.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28107);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-30034'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/bca334b5f91293f738a39d10f98d9009?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/bca334b5f91293f738a39d10f98d9009'>Caren</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-22 4:02 pm</div>
				                <div><p>If mail is being sent through GMail (from address ____@mydomain.org) do I still need to set up SPF records on my site here?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30034);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-23 3:08 am</div>
				                <div>Hello Caren,<br />
<br />
I would suggest it just to be safe as some servers may block the email as it would look like spoofing to them.<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30045);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
