<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:51906:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/prestashop-15/catalog-setup" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="In this PrestaShop 1.5 class, you will go through setting up your catalog." />
  <title>109: Catalog Setup in PrestaShop 1.5 | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/prestashop-15/catalog-setup" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:46f809c04c037043fd8357bb5d374342 -->
...
<div class='page-header'>
	<h1>109: Catalog Setup in PrestaShop 1.5</h1>
</div>
<div class='section_listing'>
		<table>
	<tr><td colspan='3'><h2>Features</h2><div>Tweaking order configuration</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 1:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/catalog-setup/allow-out-of-stock-orders'>How to allow orders on out-of-stock products in PrestaShop 1.5</a>
					<div>Learn how to allow ordering on out-of-stock products in PrestaShop 1.5</div>
					<div class='smallgrey'>Hits: 5,472</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/catalog-setup/set-new-orcer-notification'>How to enable/disable the new order notification in PrestaShop 1.5</a>
					...
					<div class='smallgrey'>Hits: 18,922</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/catalog-setup/allow-backorders'>How to allow back orders in PrestaShop 1.5</a>
					<div>This PrestsShop 1.5 article goes over how to set your product to allow back orders for when it is out of stock. </div>
					<div class='smallgrey'>Hits: 3,935</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/catalog-setup/set-minimum-order-quantity'>Setting a minimum order  quantity in PrestaShop 1.5</a>
					<div>This PrestaShop 1.5 article will show you how to set a minimum order quantity for a product.</div>
					<div class='smallgrey'>Hits: 6,724</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/catalog-setup/add-new-store-location'>Adding a new Store Locations list in PrestaShop 1.5</a>
					<div>This PrestaShop 1.5 tutorial explains how to add new store locations to your location list.</div>
					<div class='smallgrey'>Hits: 1,672</div>
				</td>
			</tr>
		<tr><td colspan='3' style='padding-top:20px;'><h2>Products</h2><div>Product display configuration</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 6:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/catalog-setup/edit-enable-stock-management'>How to edit the Stock Management option in PrestaShop 1.5 </a>
					<div>Learn how to edit the Enable Stock Management option in PrestaShop 1.5. This can be useful for digital products.</div>
					<div class='smallgrey'>Hits: 4,775</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/catalog-setup/products-per-page'>Changing the Number of Products per Page in PrestaShop 1.5</a>
					<div>Learn how to change the number of products displayed per page in PrestaShop 1.5</div>
					<div class='smallgrey'>Hits: 12,223</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/catalog-setup/change-product-prder-display'>Changing the order Products are displayed in PrestaShop 1.5</a>
					<div>Find out how to change the order in which products display on the page in PrestaShop 1.5</div>
					<div class='smallgrey'>Hits: 13,250</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/catalog-setup/asending-descending-order'>Listing products in ascending or descending order in PrestaShop 1.5</a>
					<div>Learn how to set your product order to either the ascending or descending method in PrestaShop 1.5 </div>
					<div class='smallgrey'>Hits: 2,919</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/catalog-setup/display-remove-available-quantity'>How to display/remove available product quantities in PrestaShop 1.5</a>
					<div>This article shows how to display or remove the available quantity for products in PrestaShop 1.5</div>
					<div class='smallgrey'>Hits: 22,662</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/catalog-setup/setting-days-new'>Setting the days a product is considered New in PrestaShop 1.5</a>
					<div>This tutorial for PrestaShop 1.5 demonstrates how to set the number of days a product will display as new.</div>
					<div class='smallgrey'>Hits: 9,969</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/catalog-setup/set-max-product-image'>How to set the max product image size in PrestaShop 1.5</a>
					<div>This tutorial for PrestaShop 1.5 guides you through setting the maximum file size for product images.</div>
					<div class='smallgrey'>Hits: 6,013</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/catalog-setup/set-max-downloadable'>Setting the max size for downloadable products in PrestaShop 1.5</a>
					<div>This tutorial for PrestaShop 1.5 guides you through setting the file size for downloadable products in the back office interface.</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yMzYmaWQ9MjM2JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="8efd2e51357d921f4572d1d509094f40" value="1" />	</div>
	</form>
<!-- <br />
