...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-3/create-component/add-new-view" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-05-23T20:09:20-07:00" />
  ...
  <link href="http://www.inmotionhosting.com/support/edu/joomla-3/create-component/add-new-view" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:983eca7fc5956ff349dc0bacf001b925 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to add a New View to your Joomla 3 Component									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>8,369</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: May 15, 2014'><span style='color:#606060;'>Published:</span> May 23, 2014</div>
...
<p>In our last tutorial, we showed you <a href="/support/edu/joomla-3/create-component/add-default-view">how to create the default view</a> for <a href="/support/edu/joomla-3/create-component">the component that we are creating</a>. The component's name is com_<span style='color:red;'>helloworld</span>, so the default view is <span style='color:red;'>helloworld</span> - this is just how the "default view" works.</p>
...
<ol class='article_list'>
  <li>
    <strong>Create the view's folder:</strong> /components/helloworld/views/<span style='color:red;'><strong>h</strong>owdy<strong>f</strong>riends</span><br /><br />Because we are referring to this new view as <span style='color:red;'>"Howdy Friends"</span>, we will name this view <span style='color:red;'><strong>h</strong>owdy<strong>f</strong>riends</span>.
  </li>
  <li>
    <p><strong>Create the HTML version of the view:</strong> /components/helloworld/views/howdyfriends/<span style='color:red;'>view.html.php</span></p>
 ...
 */
class <span style='color:orange;'>HelloWorld</span>View<span style='color:red;'>HowdyFriends</span> extends JViewLegacy
{
  ...
  <li>
    <strong>Create the "templates" folder:</strong> /components/helloworld/views/howdyfriends/<span style='color:red;'>tmpl</span>
  </li>
  <li>
    <strong>Create the default template file:</strong> /components/helloworld/views/howdyfriends/tmpl/<span style='color:red;'>default.php</span>
    <pre class='code_block'>&lt;?php
// No direct access to this file
defined('_JEXEC') or die('Restricted access');
?&gt;
&lt;h1&gt;&lt;?php echo $this-&gt;msg; ?&gt;&lt;/h1&gt;</pre>
  </li>
</ol>
...
<p class='white_box'>http://example.com/index.php?option=com_helloworld&view=<span style='color:red;'>howdyfriends</span></p>

<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/create-component/howdyfriends-view.png"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/create-component/howdyfriends-view.png"  style="float:right; margin:0px 0px 15px 15px;" /></a>
...
<div style='clear:both;'></div>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 4: How to add a New View to your Joomla 3 Component</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 3: <a href='/support/edu/joomla-3/create-component/add-default-view'>How to add a Default View to your Joomla 3 Component</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-3/create-component/add-new-view&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-3/create-component/add-new-view'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD01MDcmaWQ9MzI0MyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/514054520c0347d826739bfe324e7d9f?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/514054520c0347d826739bfe324e7d9f'>Enrique</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-12 7:19 am</div>
				                <div><p>Hi there!Nice collection of tutorials, ive found some good stuff here for my own developmentJust 1 question:lets pretend that i have a very simple component and i need 3 views: a list, a simple form and a show. Do i have to create this structure for each view? maybe i'm missing something for switching between de default view to anotherThanks a lot for the answer!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29734);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-12 12:24 pm</div>
				                <div>If you're asking if you need a separate structure for a form or list then no, you should be able to put in a form or list on any page without a dedicated structure. You do not need to create a separate structure for each one.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29742);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
