<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:61332:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-25/database/change-joomla25-db-user-pass" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-08-08T16:54:57-07:00" />
  <meta name="keywords" content="change update joomla 2.5 database username and password" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="You can change your Joomla 2.5 database username and password through either your Joomla 2.5 admin screen or by manually editing your Joomla configuration.php file. We'll show you how to do both, but we recommend the manual configuration.php change." />
  <title>How to change your Joomla 2.5 database username and password - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-25/database/change-joomla25-db-user-pass" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:b00ff75c91706ad6dd2d58551aa5df20 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '92.70.88.11']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to change your Joomla 2.5 database username and password									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>63,282</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: May 10, 2012'><span style='color:#606060;'>Published:</span> Aug 8, 2015</div>
							...
							<div style='clear:both;'></div>
								...
								<p class="alert">Joomla 2.5 has reached its end of life as for 12/31/2014. Please be advised this may be a security risk to your website. You can view more information about the end of life <a href="https://docs.joomla.org/Joomla!_CMS_versions">here</a>.</p><br />
<p>Your Joomla 2.5 database username and password is stored in a file named <a href="/support/edu/joomla-25/how-to/configuration-settings">configuration.php</a>. If you've changed your database username and password through your Joomla 2.5 web hosting providers control panel, you will need to update your Joomla 2.5 database configuration with the new database credentials. You can make this change in Joomla 2.5 by either editing the configuration.php file directly or you can make the changes from your Joomla 2.5 administrator dashboard.</p>
<p>If you need to know how to change the actual database username and password, you need to contact your Joomla 2.5 host for further help. However, if you've already changed those details and you need to tell Joomla of your new database user and pass, keep reading!</p>
<p> </p>
<h2>Understanding Joomla 2.5 database login credentials:</h2>
<p>Your Joomla 2.5 database login credentials are your database username and your database password. In order for Joomla 2.5 to connect to your database, the following things need to be true:</p>
<ol>
<li>You (or your Joomla 2.5 hosting provider) need to have created a database for you</li>
<li>Besides having a database, you also need to have a database username and a database password</li>
<li>Finally, your database user needs to have appropraite privileges to access your database</li>
</ol>
<p>So in summary, you need a database, a database username and password, and your database user needs to have the appropriate privileges to access the database. When we refer to database privilegs, we are referring to MySQL privileges such as SELECT, UPDATE, and DELETE.</p>
<p> </p>
<h2>To change your Joomla 2.5 database username through your administrator dashboard:</h2>
<p>In your Joomla 2.5 dashboard, you only have access to change your database username, you cannot change your database password. If you need to change your database password, continue further down this page to where we show you how to update your configuration.php file.</p>
<p>Updating your database username through the Joomla 2.5 dashboard can be tricky. If you change your database username through your host, you won't be able to log into your admin dashboard as you'll see database errors.</p>
<ol class="article_list">
  <li>  <a href="/support/edu/joomla-25/getting-started/how-to-log-into-dashboard">Log into your Joomla 2.5 administrator dashboard</a></li>
<li>In the top menu, hover over <strong>Site</strong> and click <strong>Global Configuration</strong></li>
<li>There are five tabs at the top: Site, System, Server, Permissions, Text filters. Click the <strong>Server</strong> tab.</li>
<li>At this time, you'll want to change your database username through your Joomla 2.5 web host's control panel.</li>
<li>After changing your database username through your host's control panel, you can now update it in your Joomla 2.5 administrator screen. Under <strong>Database Settings</strong>, change the <strong>Database Username</strong> and then click <strong>Save</strong> in the top menu.</li>
</ol>
<p> </p>
<h2>To change your Joomla 2.5 database username and password by editing your configuration.php file:</h2>
<ol class="article_list">
<li>Using your favorite editor, open <strong>configuration.php</strong>. This file is in the top level of your Joomla 2.5 website, so you should not need to navigate to any folders already in your file structure.</li>
<li>The following lines define your Joomla 2.5 database username and file:
<p class="code_block">public $user = 'database_user';<br />public $password = 'database_pass';</p>
<p>To update the database username and password, change the values between the single quotes. For example, if you change your database username to newuser and your database password to newpass, the changes would look like this:</p>
<p class="code_block">public $user = 'newuser';<br />public $password = 'newpass';</p>
</li>
<li>Save the changes</li>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 3: How to change your Joomla 2.5 database username and password</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 2: <a href='/support/edu/joomla-25/database/database-name'>What is my Joomla 2.5 database name?</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 4: <a href='/support/edu/joomla-25/database/database-connection-error-2-could-not-connect-to-mysql'>Joomla database connection error (2): could not connect to mysql</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-25/database/change-joomla25-db-user-pass&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-25/database/change-joomla25-db-user-pass'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yMDAmaWQ9MTMwNyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
