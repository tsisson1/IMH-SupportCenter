<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:43269:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/php-nuke" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="InMotion Hosting Support Center" />
  <title>PHP-Nuke | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/php-nuke" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:ea5bdf3a95e80f7a22e04a1dc576e7dd -->
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>PHP-Nuke</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	...
	<div class='item-page'>
		<div class='page-header'>
			<h1>PHP-Nuke Education Channel</h1>
		</div>
...
<div class='edu_class_listing white_box'>
	<h2>PHP-Nuke Tutorials</h2>
	<ul style='float:left; width:300px; margin-right:20px;'>
<li  ><a href='/support/edu/php-nuke/getting-started-php-nuke'>101: Getting Started: PHP-Nuke</a></li>
<li  ><a href='/support/edu/php-nuke/add-content-php-nuke'>102: Adding the content to PHP-Nuke</a></li>
<li  ><a href='/support/edu/php-nuke/php-nuke-modules-blocks'>103: PHP-Nuke Modules and blocks</a></li>
<li  ><a href='/support/edu/php-nuke/change-php-nuke-appearance'>104: Changing the PHP-Nuke Appearance</a></li>
<li  ><a href='/support/edu/php-nuke/webstats-reporting-php-nuke'>105: PHP-Nuke Web stats and reporting</a></li>
<li  ><a href='/support/edu/php-nuke/php-nuke-statistics-reporting'>106: PHP-Nuke Backups and Site security</a></li></ul><div style='clear:both;'></div></div>
...
<div class='edu_most_popular white_box'>
	<h2>Most Popular Articles</h2>
		<div style='width:300px; height:75px; float:left; margin-right:20px;'>
							<a href='/support/edu/php-nuke/add-content-php-nuke/adding-image'>Adding an Image to a Page in PHP-Nuke</a>
							<div class='smallgrey'>Hits: 7,549</div>
						</div>
						<div style='width:300px; height:75px; float:left; margin-right:20px;'>
							<a href='/support/edu/php-nuke/getting-started-php-nuke/login-administrator-system'>How to login to the Administrator System in PHP-Nuke</a>
							<div class='smallgrey'>Hits: 6,246</div>
						</div>
						<div style='width:300px; height:75px; float:left; margin-right:20px;'>
							<a href='/support/edu/php-nuke/getting-started-php-nuke/how-to-reset-your-admin-password-for-php-nuke'>How to reset your admin password for PHP-Nuke</a>
							<div class='smallgrey'>Hits: 3,593</div>
						</div>
						<div style='width:300px; height:75px; float:left; margin-right:20px;'>
							<a href='/support/edu/php-nuke/php-nuke-modules-blocks/add-a-new-custom-module-in-php-nuke'>Add new custom module in PHP-Nuke</a>
							<div class='smallgrey'>Hits: 2,506</div>
						</div>
						<div style='width:300px; height:75px; float:left; margin-right:20px;'>
							<a href='/support/edu/php-nuke/webstats-reporting-php-nuke/use-google-analytics'>How to use Google Analytics with PHP-Nuke</a>
							<div class='smallgrey'>Hits: 2,092</div>
						</div>
						<div style='width:300px; height:75px; float:left; margin-right:20px;'>
							<a href='/support/edu/php-nuke/getting-started-php-nuke/change-language'>How to Change the Language Used in PHP-Nuke</a>
							<div class='smallgrey'>Hits: 2,024</div>
						</div>
						<div style='clear:both;'></div>
</div>
...
<div class='edu_300 white_box'>
		...
		<h2>PHP-Nuke - Advanced Tutorials</h2>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xMTUmaWQ9MTE1JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
