...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/email/dkim-verification-procedure-info" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, Thank you for contacting us about DKIM verification. Here is a helpful link to our guide on SPF Records and Domain Keys. There is states: &quot;cPanel..." />
  <title>DKIM verification procedure info | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/email/dkim-verification-procedure-info" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:909db837d9b30aff0cc3fa8e027e73df -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>DKIM verification procedure info</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-10-22 12:14 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>243</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I want to use DKIM for email authentication.  How do I verify that this server is an authoritative nameserver for cybersignage.com?  DKIM is Enabled but shows following message...&quot;Status: Enabled WARNING: The system cannot verify that this server is an authoritative nameserver for “******.com&quot;</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_8375' id='upvote_answer_8375' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='8375' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_8375').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_8375' id='downvote_answer_8375' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='8375' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_8375').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
Thank you for contacting us about DKIM verification. Here is a helpful link to our guide on <a href="http://www.inmotionhosting.com/support/edu/everything-email/spam-prevention-techniques/spf-records-domain-keys-combating-spam">SPF Records and Domain Keys</a>. There is states: "<em>cPanel shows this error when setting up your DKIM and SPF records. This is a known bug within cPanel and can be disregarded. cPanel checks the local server for DNS in cPanel causing this error.</em>"<br />
<br />
As long as you have added them in cPanel, and your domain is <a href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/what-is-a-name-server#imh-name-servers">pointed to our nameservers</a> it will work.<br />
<br />
...
John-Paul
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_8375').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_8375' id='form_comment_on_answer_8375' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/email/dkim-verification-procedure-info&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/email/dkim-verification-procedure-info'></div>
<script type='text/javascript'>
  (function() {
