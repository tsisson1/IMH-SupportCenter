<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:56833:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/website/website-unavailable-but-not-suspended" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello GameMaster, Thank you for your question. We sent you a notification email regarding the performance of your Wordpres website, and I see you contac..." />
  <title>Website Unavailable But Not Suspended? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/website/website-unavailable-but-not-suspended" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:34d2a1b3c076c90c633058cddf893500 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box straight_bottom'>
                <h1 style='font-size:26px;'>Website Unavailable But Not Suspended?</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/GameMaster'>GameMaster</a>
			<div>15 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-03-24 12:22 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>1,074</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I went to my website at www.generationztarot.com this morning and got this message:<br />
<br />
&quot;We apologize for the inconvenience, but unfortunately this website is currently unavailable.&quot;<br />
<br />
Now my account has been suspended before, but this isn't the same message. What does this mean 'unavailable', and what can I do to solve it?<br />
<br />
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px;'>
				<div style='font-size:12px; max-width:500px; overflow:auto;'>I have the same problem. My domain is www.therapists.com.hk. What I could do to fix? Thank you.</div>
			...
			<td style='width:100px;' valign='top'>
				...
				<div class='smallgrey'>
					<a href='/support/community-support/users/vitako'>vitako</a><br />
					0 <a href='/support/team/points' target='_blank'>Points</a><br />
					2013-03-27 02:48 am EST
				</div>
			</td>
		</tr>
	</table>
...
<div style='padding:15px; border:1px solid #d6d6d6; border-top:0px; background:#ebebeb;'  >
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px;'>
				<div style='font-size:12px; max-width:500px; overflow:auto;'>Hello vitako,<br />
<br />
Thank you for your question. What you are seeing is the suspension page, I recommend contacting live support so they can provide more specific information.<br />
<br />
A detailed email was also sent to you from our systems team, regarding the performance of your website.<br />
<br />
...
-John-Paul</div>
			...
			<td style='width:100px;' valign='top'>
				...
				<div class='smallgrey'>
					...
					22,986 <a href='/support/team/points' target='_blank'>Points</a><br />
					2013-03-27 09:07 am EST
				</div>
			</td>
		</tr>
	</table>
...
<div style='padding:15px; border:1px solid #d6d6d6; border-top:0px; background:#ebebeb;' class='round_bottom' >
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px;'>
				<div style='font-size:12px; max-width:500px; overflow:auto;'>My server suspended 12 hours ago, no reason, no warning, no notice. I try to contact with 2 support via live chat, 2 support via email but they can't help you resolve it.<br />
Can you please check and give me a guys can help to resolve? </div>
				
				
			</td>
			<td style='width:100px;' valign='top'>
				<img src='https://lh4.googleusercontent.com/-ejstu8ajG24/AAAAAAAAAAI/AAAAAAAAAO0/EOTXqka0nzA/photo.jpg?sz=90' style='width:40px;' class='user_avatar' />
				<div class='smallgrey'>
					<a href='/support/community-support/users/haosucu'>haosucu</a><br />
					11 <a href='/support/team/points' target='_blank'>Points</a><br />
					2013-09-27 12:56 am EST
				</div>
			</td>
		</tr>
	</table>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_2540' id='upvote_answer_2540' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='2540' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_2540').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_2540' id='downvote_answer_2540' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='2540' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_2540').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello GameMaster,<br />
<br />
Thank you for your question. We sent you a notification email regarding the performance of your Wordpres website, and I see you contacted live support, and were able to get this issue resolved. <br />
<br />
Here is a helpful link to our article regarding <a href="http://www.inmotionhosting.com/support/website/website-troubleshooting/account-suspensions">account suspensions</a>.<br />
<br />
At this time your site is loading successfully for me, let us know if you experience any additional issues.<br />
<br />
If you have any further questions, feel free to post them below.<br />
Thank you,<br />
<br />
-John-Paul
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_2540').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_2540' id='form_comment_on_answer_2540' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Joe:<br />
Just curious, why is this keep happening?<br />
<br />
Joe:<br />
This is like 2-3 times happened to my sites.<br />
<br />
Joe:<br />
Anyway, I just wait for 4-7 hours and do nothing right?<br />
<br />
Joe:<br />
hello?<br />
<br />
Bryan Y.:<br />
that answer I do not know, however I am currently checking with my ssytems admnistration as to why this keeps happening but yes 4 - 7 hours<br />
<br />
Joe:<br />
This is really bad for my business as you may guest, it's no warning, nothing. I have no way in knowing that my sites are down. Is there anyway I can prevent this?<br />
</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='https://lh4.googleusercontent.com/-xcOTIBBV1mM/AAAAAAAAAAI/AAAAAAAAFm4/rG2BfotuDr8/photo.jpg?sz=90' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/macinuse'>macinuse</a><br />
									6 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2013-09-14 1:33 am EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>This is not only the problem. I contacted support and they said &quot;ok found the issue, manually updated the DNS entries to resolve this as I am seeing the domain pointed at the wrong server. this will have a propgation time, tpyically between 4 - 7 hours&quot; <br />
<br />
As you can see. This is really bad for my business as you may guest, it's no warning, nothing. I have no way in knowing that my sites are down. Is there anyway I can prevent this?</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>I'm sorry that you have had this issue and I'm glad that the issue was found.  Unfortunately, due to how DNS works, there is no way around DNS propagation as it is something that varies from person to person.  I, however, do see this site up and running without any issues now as well as the majority of the world should see it correctly as well.</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/website/website-unavailable-but-not-suspended&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/website/website-unavailable-but-not-suspended'></div>
<script type='text/javascript'>
  (function() {
