<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:64037:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/drupal-7/configure-rss-feeds/set-rss-content-display" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-07-18T19:54:11-07:00" />
  <meta name="keywords" content="set RSS feed display Drupal 7 content" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="This tutorial will guide you on how to change the display settings in the RSS feeds for Drupal 7" />
  <title>How to configure RSS feed content in Drupal 7 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/drupal-7/configure-rss-feeds/set-rss-content-display" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:c45acdb7ecd80d34cbf05cbe04c41055 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '204.141.128.10']);
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
				<img src='/support/images/stories/drupal-partner/supporting-partner-80_3.png' style='float:right; margin:0px 0px 15px 15px;' alt='Drupal Association Support Partner'>		<h1>
															How to configure RSS feed content in Drupal 7									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>16,432</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jul 2, 2012'><span style='color:#606060;'>Published:</span> Jul 18, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Editing what your RSS feed displays can be easily done from within Drupal 7. You have the option of displaying the feed by Titles, Titles and teaser, or even the entire text itself. Setting the display options for RSS feed is easy within Drupal 7 by performing the following instructions.</p>
<p><strong>To set the RSS feed content display in Drupal 7:</strong></p>
<ol class="article_list">
<li><a href="/support/edu/drupal-7/getting-started/how-to-log-into-the-drupal-admin-dashboard">Log into your Drupal 7 admin dashboard. <br /></a></li>
<li>Click on the <strong>Configuration </strong>menu option, located in the&nbsp; menu bar at the top of the screen.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Configuration/_main-dashboard-configuration.png"><img  alt="_main-dashboard-configuration" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Configuration/_main-dashboard-configuration.png" /></a></li>
<li>From the lower right corner of the <strong>Configuration </strong>page, find the <strong>Web Services</strong> category and click on the <strong>RSS Publishing</strong> link.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Configuration/Development/Web_Services/config-web-rss.png"><img  alt="config-web-rss" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Configuration/Development/Web_Services/config-web-rss.png" /></a></li>
<li>You are now on the <strong>RSS Publishing</strong> screen. Now you want to find the <strong>Feed Content</strong> dropdown and select your setting from <strong>Titles Only</strong>, <strong>Titles plus Teaser</strong>, or <strong>Full Text</strong>.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Configuration/Development/Web_Services/config-web-rss-display.png"><img  alt="config-web-rss-display" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Configuration/Development/Web_Services/config-web-rss-display.png" /></a></li>
<li>Once selected, click the <strong>Save Configuration</strong> button at the bottom of the screen. As you can see below, the entire text of the post comes through in the feed display.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Configuration/web_services/rss-items-sample.png"><img  alt="rss-items-sample" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Configuration/web_services/rss-items-sample.png" /></a></li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/drupal-7/configure-rss-feeds'>207: Configuring RSS Feeds in Drupal 7</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 4: How to configure RSS feed content in Drupal 7</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 3: <a href='/support/edu/drupal-7/configure-rss-feeds/set-number-of-feed-items'>How to change the number of items in an RSS feed in Drupal 7</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/drupal-7/configure-rss-feeds/set-rss-content-display&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/drupal-7/configure-rss-feeds/set-rss-content-display'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yMjAmaWQ9MTU0MiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="dc1a0cae6db40d18de7f54fa1361b138" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/drupal-7/configure-rss-feeds?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Configuring RSS Feeds in Drupal 7</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/drupal-7/configure-rss-feeds/intro-to-rss?tsrc=rsbedu'>Introduction to RSS Feeds in Drupal 7</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/drupal-7/configure-rss-feeds/edit-rss-description?tsrc=rsbedu'>How to Edit the RSS description in Drupal 7</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/drupal-7/configure-rss-feeds/set-number-of-feed-items?tsrc=rsbedu'>How to change the number of items in an RSS feed in Drupal 7</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/drupal-7/configure-rss-feeds/set-rss-content-display?tsrc=rsbedu'>How to configure RSS feed content in Drupal 7</a></td>
                </tr>
          	</table>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/d4a437b0503eb2347729341cfa510e8e?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/d4a437b0503eb2347729341cfa510e8e'>bart</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-23 2:53 pm</div>
				                <div><p>Sorry it's not working. I don't see my feed (it's empty).</p>
<p>&nbsp;</p>
<p>I gues the only way is to use views rss.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26923);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-24 10:10 am</div>
				                <div>Hello Bart,<br />
<br />
Sorry for the problem with RSS.  If you can provide us some information, we might be able to investigate the problem.  You may also want to check out this <a href="http://drupal.stackexchange.com/questions/70994/how-to-create-an-rss-xml-feed-on-my-drupal-7-site" rel="nofollow" target="_blank">post</a> on an external support forum.  The users in the forum have provided another possible answer to the question of using RSS feeds in Drupal 7.<br />
<br />
If you have any further questions or comments, please let us know.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26945);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-27245'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/3863effd6d6e44ddb68b3c35ce229164?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/3863effd6d6e44ddb68b3c35ce229164'>bart</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-05 4:57 pm</div>
				                <div><p>Thanks for fast reply. content "promoted to front page" was a blocker here.</p>
<p>&nbsp;</p>
<p>It would be nice to update this artile about miltilingual RSS :)</p>
<p>&nbsp;</p>
<p>Thanks!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27245);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
