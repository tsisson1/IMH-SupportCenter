<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50256:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/magento/database-connection-error-during-magento-install-help" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello jasonotr, I'm sorry you're having trouble installing Magento. I would caution that Magento is not compatible with our shared hosting plans. If you..." />
  <title>Database connection error during magento install, help!  | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/magento/database-connection-error-during-magento-install-help" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:71579c4449f923fa9026f36c6a9270a3 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-37']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '95.97.184.166']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Database connection error during magento install, help! </h1>
		<div style='margin-bottom:20px; margin-top:10px; clear:both; color:#6e6e6e;'>Category: <a href='/support/community-support/magento'>Magento</a></div>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/jasonotr'>jasonotr</a>
			<div>8 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-05-11 12:09 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>20,186</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Intalling magento v. 1.6.2.0.. <br />
<br />
Followed the guide for the installation. <br />
<br />
Entered the proper database / user / password on MySQL Databases.. Give the proper permissions to the user. <br />
<br />
I uploaded magento/sample data to the database. <br />
<br />
Went to mywebsite.com/magento/install and followed the walk-through, I got a &quot;Database connection error.&quot; My current setting were: local host, user, password. <br />
<br />
http://s78.photobucket.com/albums/j88/importgeek/?action=view&amp;amp;current=Screenshot2012-05-11at120504PM.png<br />
<br />
How can i configure my database? make sure the local host is the correct host? </div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_1012' id='upvote_answer_1012' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='1012' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_1012').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_1012' id='downvote_answer_1012' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='1012' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_1012').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello jasonotr,<br />
<br />
I'm sorry you're having trouble installing Magento. I would caution that Magento is not compatible with our shared hosting plans. If you would like to run Magento on your site, we recommend upgrading to at least a &lt;a href=&quot;http://www.inmotionhosting.com/vps_hosting.html&quot;&gt;VPS plan&lt;/a&gt;.<br />
<br />
If you are seeing a database connection error, that is due to one of the following:<br />
&lt;ol&gt;<br />
&lt;li&gt;Incorrect host name (should be localhost)&lt;/li&gt;<br />
&lt;li&gt;Incorrect database name (should look something similar to userna5_dbname)&lt;/li&gt;<br />
&lt;li&gt;Incorrect database user (should look something similar to userna5_dbuser)&lt;/li&gt;<br />
&lt;li&gt;Incorrect password (make sure you use the password you assigend to the user when you created the database and database user)&lt;/li&gt;&lt;/ol&gt;<br />
For step-by-step instructions, please see our article on &lt;a href=&quot;http://www.inmotionhosting.com/support/edu/magento/getting-started-tutorial/how-to-install-magento&quot;&gt;How to install Magento&lt;/a&gt;<br />
<br />
Please let us know if you have any additional questions or need further assistance.<br />
<br />
Regards,<br />
<br />
Christi N.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_1012').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_1012' id='form_comment_on_answer_1012' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/magento/database-connection-error-during-magento-install-help&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/magento/database-connection-error-during-magento-install-help'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="9fecbe87bb0dec9ad66304f8937c1fa2" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
                                ...
                                <h3>Related Articles</h3><a target='_blank' href='http://inmotionhosting.com/support/how-to-change-url'>How to Change your Magento URL</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/how-to-change-your-url'>How to Change your Magento URL</a><br/><br />
		</div>
