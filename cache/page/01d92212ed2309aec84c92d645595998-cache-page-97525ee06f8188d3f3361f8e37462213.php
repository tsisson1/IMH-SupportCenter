<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:54462:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/fighting-spam/does-moving-a-message-to-the-roundcube-junk-folder-do-anything" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Mikehsg, In this case it would be similar as hitting delete. However there are may ways that you can combat spam to reduce the amount you receive...." />
  <title>Does moving a message to the Roundcube Junk folder do anything? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/fighting-spam/does-moving-a-message-to-the-roundcube-junk-folder-do-anything" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:749a305080778aa4d9f810c9ce30e999 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Does moving a message to the Roundcube Junk folder do anything?</h1>
		<div style='margin-bottom:20px; margin-top:10px; clear:both; color:#6e6e6e;'>Category: <a href='/support/community-support/fighting-spam'>Fighting Spam</a></div>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/mikehsg'>mikehsg</a>
			<div>16 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-07-31 8:32 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>164</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Kind of a simple question, really. I'm using Roundcube for my webmail. <br />
I'm used to SmarterMail which has a &quot;Mark As Spam&quot; button that teaches the Declude spam engine using the email attributes - IP, sender, subject, body keyword combos, etc... so that with some use I stop seeing that spam coming in.<br />
<br />
When I move a message to the Junk folder in Roundcube, does it do anything or is it just a plain-old folder? Does SpamAssasin learn from this folder? Does it in some way teach the engine or is it exactly as effective as simply hitting delete?</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_7782' id='upvote_answer_7782' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='7782' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_7782').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_7782' id='downvote_answer_7782' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='7782' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_7782').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Mikehsg,<br />
<br />
Not from one of the clients itself no. The method you are most likely looking for is something that would come from an email client application such as Thunderbird or Outlook. You can set up an account level or <a href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-email/user-account-level-filtering">user level</a> filters to help weed out the spam as well. <br />
<br />
Best Regards,<br />
TJ Edens
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_7782').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_7782' id='form_comment_on_answer_7782' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
...
<div class=' straight_bottom not_best_answer'>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px; width:50px;' valign='top'>
<div class='vote_div'>
	<form method='post' name='upvote_answer_7780' id='upvote_answer_7780' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='7780' />
		<input type='hidden' name='component' id='component' value='qa' />
		<input type='hidden' name='vote_value' id='vote_value' value='1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_7780').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_7780' id='downvote_answer_7780' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='7780' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_7780').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Mikehsg,<br />
<br />
In this case it would be similar as hitting delete. However there are may ways that you can <a href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-email/spamassassin-fighting-spam">combat spam</a> to reduce the amount you receive.<br />
<br />
Best Regards,<br />
TJ Edens
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_7780').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_7780' id='form_comment_on_answer_7780' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
					                <p>You must <a href='/support/login'>login</a> before you can post a comment about this answer.</p>
					        </div></div></div></div>
					</form>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>TJ - Is there any way to feed SpamAssasin from within one of the webmail clients? I'm all about spam fighting, but hitting a &quot;junk&quot; button to teach the system has proven to be a pretty effective tool over the years.</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='/support/images/avatars/default_avatar.jpg' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/mikehsg'>mikehsg</a><br />
									16 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2015-07-31 9:25 am EST
								</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/fighting-spam/does-moving-a-message-to-the-roundcube-junk-folder-do-anything&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/fighting-spam/does-moving-a-message-to-the-roundcube-junk-folder-do-anything'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="1f9f8930b0da29d956ec7913a610a509" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
                                ...
                                <h3>Related Articles</h3><a target='_blank' href='http://inmotionhosting.com/support/dmarc-setup'>How to Setup DMARC records in cPanel</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/add-ip-to-spf'>Adding IP addresses to your SPF records in cPanel</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/email-filtering-an-ip-range'>Email filtering an IP Range</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/create-custom-spf'>Creating custom SPF records</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/create-spf-record-whm'>Creating a basic SPF Record in WHM</a><br/><br />
		</div>
