<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:61247:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/ssh/what-is-shell-access" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-07-17T15:46:08-07:00" />
  <meta name="keywords" content="ssh 2xram" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="Shell access is remote command line access to your server, also commonly referred to as ssh." />
  <title>What is Shell Access? - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/ssh/what-is-shell-access" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:44d4286c3e5e52caa8c124592eaf69c5 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '119.154.242.46']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>What is Shell Access?</span></li>			</ul>
		</div>
	</div>
</div>
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>24,763</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Nov 29, 2011'><span style='color:#606060;'>Published:</span> Jul 17, 2015</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Shell access, commonly referred to as ssh (secure shell), is remote command line access to a server. Having command line access (if you're familiar with using it) can be very helpful. It can not only help you speed up certain tasks, but it also can give you access to do certain things that you cannot do within your cPanel.</p>
<h2>What is the Command Line?</h2>
<div style="float: left; margin-right: 15px; margin-bottom: 15px;"><i>The Windows Command Line</i><br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/whm-edu/what-is-shell-access/windows_command_line_access.gif"><img  alt="windows_command_line_access" src="//cdn.inmotionhosting.com/support/images/stories/whm-edu/what-is-shell-access/windows_command_line_access.gif" /></a></div>
<p>The command line is an interface that allows you to perform tasks by running text based commands. Most users are more familiar with graphical user interfaces and not the command line interface. In a GUI (graphical user interface) such as cPanel's File Manager, you can perform tasks by pointing and clicking. For example, you can right click on a file and click "Change Permissions" if you want to update the permissions of a file. In the command line, you would instead type a command to change files, such as:<br />chmod 755 some_perl_script.pl</p>
<div style="clear: both;"></div>
<h2>Do I need Shell Access?</h2>
<p>For the majority of our users, shell access is not needed. Shell Access is generally required by our more advanced users. Those users are either familiar with the Linux command line and prefer to work this way, or they need install server side applications and need shell access to do so.</p>
<h2>How can I get Shell Access?</h2>
<p>Shell access is only available with our <a href="http://www.inmotionhosting.com/vps-hosting">VPS</a> Hosting and <a href="http://www.inmotionhosting.com/dedicated-servers">Dedicated Server Hosting</a> accounts. You'll log into shell using your cPanel username and password. If you are wanting root access to the server (similar to the Windows' "Administrator" user), please see: <a href="/support/?id=1075:standard-vs-root-access&amp;catid=148">Standard SSH Access vs. Root SSH Access</a></p>
<p>More information on getting started with Shell access can be found here: <a href="/support/website/general-server-setup/do-you-provide-ssh-access">Do you provide SSH access?</a></p>
<p class="alert" style="min-height: 30px;">Business Class accounts (shared accounts) do not have shell access.</p>
<p>If shell access is needed, a VPS or dedicated server is required. Read more about why InMotion has the <a href="http://www.inmotionhosting.com/vps_hosting/articles/top-vps.html">top VPS</a> solutions.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/ssh/what-is-shell-access&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/ssh/what-is-shell-access'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MTEmaWQ9MzA5JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="ac8139c71180282f93c88818b90f15c3" value="1" />	</div>
	</form>
<!-- <br />
