<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:44561:" 
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:41e8b67088738bffb816c952378cbef9 -->
...
<div class='container'>
	...
	<div class='item-page'>
		<div class='page-header'><h1>Search results for: <span style='color:#aaa;'>nginx</span></h1></div>
		<form method='get' action='/support/search' >
                        <input type='text' name='searchword' id='mod-search-searchword' style='width:500px;' value='nginx' />
                        <button class='button btn btn-info' onclick='this.form.searchword.focus();' style='display:inline-block; width:80px; border-radius:3px; height:32px; line-height:22px; margin:0px;'>Search</button>
                	        ...
                	        <p><a href='http://www.inmotionhosting.com/support/edu/nginx/getting-started-with-nginx/how-to-install-nginx'>How to Install <b>Nginx</b> - InMotion Hosting</a><br />Nov 2, 2015 <b>...</b> In the previous article we went over <b>Nginx</b> and what it is. In this article we will go <br>
over how to setup <b>Nginx</b> as a reverse proxy for apache which&nbsp;...</p>
	                
                	        <p><a href='http://www.inmotionhosting.com/support/edu/nginx/getting-started-with-nginx/what-is-nginx'>What is <b>Nginx</b>? - InMotion Hosting</a><br />Feb 16, 2015 <b>...</b> <b>Nginx</b> (engine-x) is a HTTP and reverse proxy server, which is very similar to <br>
Apache. It directs traffic to the correct location on the server based&nbsp;...</p>
	                
                	        <p><a href='http://www.inmotionhosting.com/support/edu/nginx/getting-started-with-nginx'>101: Getting Started With <b>Nginx</b> </a><br />Section 1: How to uninstall <b>Nginx</b>. In this article we will discuss how to remove <br>
<b>Nginx</b> from your server and set Apache to run on port 80 again. Hits: 398.</p>
	                
                	        <p><a href='http://www.inmotionhosting.com/support/edu/nginx/getting-started-with-nginx/basic-nginx-commands'>Basic <b>Nginx</b> Commands - InMotion Hosting</a><br />May 12, 2015 <b>...</b> This short tutorial covers a few basic commands or tasks that can be performed <br>
with <b>Nginx</b> from the commandline. Understanding the basic&nbsp;...</p>
	                
                	        <p><a href='http://www.inmotionhosting.com/support/edu/nginx/getting-started-with-nginx/how-to-uninstall-nginx'>How to uninstall <b>Nginx</b> - InMotion Hosting</a><br />May 12, 2015 <b>...</b> Now that you know how to install <b>Nginx</b> on your server, for some cases you will <br>
need to know how to uninstall this software as well. An example&nbsp;...</p>
	                
                	        <p><a href='http://www.inmotionhosting.com/support/edu/nginx'><b>Nginx</b> </a><br />Basic <b>Nginx</b> Commands. Hits: 553. How to uninstall <b>Nginx</b>. Hits: 408. There are <br>
no articles in this category. If subcategories display on this page, they may&nbsp;...</p>
	                
                	        <p><a href='http://www.inmotionhosting.com/support/community-support/general-server-setup/i-cannot-log-into-nginx-admin'>I cannot log into <b>Nginx</b> Admin </a><br />Mar 3, 2015 <b>...</b> After Inmotion installed for me <b>Nginx</b> and Memcached, I wanted to configure it but <br>
I&#39;ve always got this message: You do not have the proper&nbsp;...</p>
	                
                	        <p><a href='http://www.inmotionhosting.com/support/website/server-usage/view-level-of-traffic-with-apache-access-log'>View level of traffic with Apache access log - InMotion Hosting</a><br />Jan 23, 2013 <b>...</b> Another issue is that when I tried these commands, I had to go to my /var/logs/<br>
<b>nginx</b> and many of my logs are already gzipped by logrotate. eg. i&nbsp;...</p>
	                
                	        <p><a href='http://www.inmotionhosting.com/support/community-support/ssl/force-https-and-www'>Force https and www </a><br />Sep 4, 2015 <b>...</b> Hello, In order to perform these redirects you would need to put them in the <b>nginx</b>.<br>
conf as that will take priority over your Apaches .htaccess file.</p>
	                
                	        <p><a href='http://www.inmotionhosting.com/support/website/new-customers/getting-started'>New Customer Getting Started Guide - InMotion Hosting</a><br />Apr 21, 2016 <b>...</b> We can install <b>nginx</b> on any VPS or Dedicated hosting account. There may be a <br>
one-time fee for this installation, but they will let you know at the&nbsp;...</p>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP3NlYXJjaHdvcmQ9bmdpbngmb3B0aW9uPWNvbV9jb250ZW50JmNhdGlkPTM1NiZpZD0zNTYmdmlldz1jYXRlZ29yeSZJdGVtaWQ9MTAx" />
