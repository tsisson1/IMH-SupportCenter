<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:65566:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotion.net/support/website/website-troubleshooting/my-wordpress-site-is-displaying-a-blank-page" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-01-16T21:15:12-08:00" />
  <meta name="keywords" content="wordpress blank screen php error error_log php.ini viewing errors display_errors" />
  ...
  <title>My WordPress site is displaying a blank page - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/website-troubleshooting/my-wordpress-site-is-displaying-a-blank-page" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:5a2c774a2653e8aa8106e7e471b7f9a4 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															My WordPress site is displaying a blank page									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>24,489</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Nov 4, 2011'><span style='color:#606060;'>Published:</span> Jan 16, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>We've had a lot of our customers and WordPress users in general have an issue where their site is showing a blank page. This blank page is typically caused by a PHP error. If you have your php.ini file set to hide php errors, you'll get a blank page displayed.</p>
<p>To find your error messages you have two options:</p>
<ol>
<li>Enable display_errors in your php.ini file</li>
<li>Review your error_log file(s)</li>
</ol>
<h2>Updating your php.ini file to show error messages</h2>
<p><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/blank_screen_1.jpg"><img style="float: right; margin: 0px 0px 15px 15px;" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/blank_screen_1.jpg" alt="Wordpress without errors"  width="100" /></a>To diagnose PHP errors in WordPress, we will place a line of bad code in the site to show what happens when WordPress encounters and error. The image to the right shows my fully functional WordPress website.<br style="clear: both;" /></p>
<p><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/blank_screen_2.jpg"><img style="float: right; margin: 0px 0px 15px 15px;" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/blank_screen_2.jpg" alt="Breaking the Wordpress code"  width="100" /></a><strong>We will add code to the site to intentionally break the WordPress site for testing purposes.</strong> See image to the right where it says "<em>I am forgetting my closing quote</em>".<br style="clear: both;" /></p>
<p><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/blank_screen_3.jpg"><img style="float: right; margin: 0px 0px 15px 15px;" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/blank_screen_3.jpg" alt="Blank screen with errors off Wordpress"  width="100" /></a>Now that we've added the code to intentionally break the website, you will see the WordPress website displays a blank page.</p>
<p class="alert"><strong>Note!</strong> We don't see the PHP error message because we have set the directive in the php.ini file to hide error message. <br style="clear: both;" /></p>
<h3>Enabling error_reporting in the php.ini</h3>
<ol class="article_list">
<li><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/blank_screen_4.jpg"><img style="float: right; margin: 0px 0px 15px 15px;" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/blank_screen_4.jpg" alt="Find error_reporting Wordpress"  width="100" /></a>To fix this, we'll simply need to update it so it shows error message. <strong>Edit your php.ini in your public_html folder.</strong> To learn how to edit your php.ini page, see our tutorial on "<em>How to update your local php settings</em>".
<p>Find the error_reporting section in your php.ini like the image to the right.<br style="clear: both;" /></p>
</li>
<li><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/blank_screen_5.jpg"><img style="float: right; margin: 0px 0px 15px 15px;" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/blank_screen_5.jpg" alt="Turn errors ON Wordpress"  width="100" /></a><strong>Change the display_errors from Off to On.</strong>
<p><strong>Save the changes</strong>.<br style="clear: both;" /></p>
<p><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/blank_screen_6.jpg"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Displayed errors in Wordpress site" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/blank_screen_6.jpg" width="100" /></a>Now, since we have adjusted the display_errors in the php.ini file, as you can see our site now displays the exact error message causing the issue and we can start to troubleshoot it! See snapshot to the right.<br style="clear: both;" /></p>
</li>
</ol>
<h2>How to view your error_log to find error messages</h2>
<p>One way to find error messages is to view the error_log file in file manager. All PHP error messages are logged to this file. You can use <a href="/support/website/file-management/getting-started-guide-ftp">FTP </a>or the <a href="/support/website/cpanel/how-do-i-use-the-file-manager-in-the-control-panel-cpanel">File Manager in cPanel</a> to view this file and any of the error messages logged.</p>
<ol class="article_list">
<li><a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel" title="Click here for info" target="_blank"><strong>Login into your cPanel</strong></a> and <strong>go to the public_html in your <a href="/support/edu/cpanel/cpanel-file-manager/using-file-manager-in-cpanel" target="_blank" title="Click here for info">File Manager</a></strong> and <strong>click go</strong>.</li>
<li><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/blank_screen_7.jpg"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="View the error_log" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/blank_screen_7.jpg" width="100" /></a><strong>Find the error_log file</strong>.
<p><strong>Right click the file</strong> and <strong>select view</strong>.<br style="clear: both;" /></p>
<p><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/blank_screen_8.jpg"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Errors in the Error log" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/blank_screen_8.jpg" width="100" /></a>Now you can see the list of errors that your website is causing. In this case, the syntax error shows because we broke a line of code intentionally.<br style="clear: both;" /></p>
</li>
</ol>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotion.net/support/website/website-troubleshooting/my-wordpress-site-is-displaying-a-blank-page&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotion.net/support/website/website-troubleshooting/my-wordpress-site-is-displaying-a-blank-page'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zNCZpZD0yODgmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
