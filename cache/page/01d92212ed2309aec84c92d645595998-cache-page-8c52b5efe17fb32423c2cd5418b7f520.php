<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50444:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/file-management/cannot-login-to-ftp-server" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, Thank you for your question. The IP you provided (46.252.199.50) is owned by Godaddy, so if you are trying to publish to InMotion servers it is i..." />
  <title>Cannot login to FTP server | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/file-management/cannot-login-to-ftp-server" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:fb6963de534376a41b6a4f2bc68e43d2 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '96.233.51.54']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Cannot login to FTP server</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2014-05-29 12:02 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>1,908</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Hi support, I am trying to login to my FTP account using Cyberduck but it replied 530 Login authentication failed. I used the Cyberduck configuration file, as well as reset the password just to make sure but it is not working still. At the moment, my DNS of FTP is pointing to 46.252.199.50. Is this correct? If so, what will the problem be? Thank you.</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_5033' id='upvote_answer_5033' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='5033' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_5033').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_5033' id='downvote_answer_5033' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='5033' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_5033').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
Thank you for your question. The IP you provided (46.252.199.50) is owned by Godaddy, so if you are trying to publish to InMotion servers it is <em>incorrect</em>.<br />
<br />
To connect to InMotion Hosting, you can use your domain name if it is <a href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/updating-your-domains-nameservers">pointed to us</a> already, or your <a href="http://www.inmotionhosting.com/support/website/cpanel/how-to-find-your-shared-ip-address-of-your-server-in-cpanel">Shared IP</a> address.<br />
<br />
The error <strong>530 Login authentication failed</strong> error usually means your username, or password is incorrect. I recommend confirming they are accurate, which is covered in our FTP guide <a href="http://www.inmotionhosting.com/support/website/ftp/getting-started-guide">here</a>.<br />
<br />
...
-John-Paul
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_5033').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_5033' id='form_comment_on_answer_5033' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/file-management/cannot-login-to-ftp-server&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/file-management/cannot-login-to-ftp-server'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="d3d5ef5680c4f7453c785df92c856b39" value="1" />	</div>
	</form>
<!-- <br />
