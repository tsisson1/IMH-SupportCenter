<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:40853:" 
...
<meta name="viewport" content="width=device-width" />
  ...
  <link href="http://www.inmotionhosting.com/support/component/users/?view=reset&amp;layout=complete" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:90e42c12dd415f265d23e6ed9da306f3 -->
...
<div class='container'>
	...
	<form action="/support/component/users?task=reset.complete" method="post" class="form-validate">

				<p>To complete the password reset process, please enter a new password.</p>		<fieldset>
			<dl>
							<dt><label id="jform_password1-lbl" for="jform_password1" class="hasTooltip required" title="&lt;strong&gt;Password&lt;/strong&gt;&lt;br /&gt;Enter your new password.">
	Password:<span class="star">&#160;*</span></label></dt>
				<dd><input type="password" name="jform[password1]" id="jform_password1" value="" autocomplete="off" class="validate-password required" size="30" maxlength="99" required aria-required="true" /></dd>
							<dt><label id="jform_password2-lbl" for="jform_password2" class="hasTooltip required" title="&lt;strong&gt;Confirm Password&lt;/strong&gt;&lt;br /&gt;Confirm your new password.">
	Confirm Password:<span class="star">&#160;*</span></label></dt>
				<dd><input type="password" name="jform[password2]" id="jform_password2" value="" autocomplete="off" class="validate-password required" size="30" maxlength="99" required aria-required="true" /></dd>
						</dl>
		</fieldset>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP3ZpZXc9cmVzZXQmbGF5b3V0PWNvbXBsZXRlJm9wdGlvbj1jb21fdXNlcnM=" />
