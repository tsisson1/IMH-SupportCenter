<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49742:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/website-troubleshooting/edits-to-data-in-phpmyadmin-not-showing" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, Sorry to hear you are having trouble with data displaying on your pages. Data changed in phpmyadmin should display immediately. However, if your ..." />
  <title>Changes to database using PHPmyAdmin not displaying on Webpage | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/website-troubleshooting/edits-to-data-in-phpmyadmin-not-showing" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:44816b7b592fffdce8bd34a108872ac7 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '66.244.213.74']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Changes to database using PHPmyAdmin not displaying on Webpage</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-03-28 8:45 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>182</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>When I add new data or edit old data in PhpMyAdmin the changes/additions are not appearing on my webpage.</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_6904' id='upvote_answer_6904' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='6904' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_6904').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_6904' id='downvote_answer_6904' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='6904' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_6904').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
Sorry to hear you are having trouble with data displaying on your pages. Data changed in phpmyadmin should display immediately. However, if your browser has the page cached, it may not display until it is cleared. Try <a href="http://www.inmotionhosting.com/support/website/how-to/clear-browser-cache">clearing the browser cache</a> and see if that helps.<br />
<br />
Kindest Regards,<br />
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_6904').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_6904' id='form_comment_on_answer_6904' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/website-troubleshooting/edits-to-data-in-phpmyadmin-not-showing&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/website-troubleshooting/edits-to-data-in-phpmyadmin-not-showing'></div>
<script type='text/javascript'>
  (function() {
