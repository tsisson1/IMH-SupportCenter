<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50377:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/how-to/how-to-block-regular-users-from-getting-to-my-admin-page" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, Yes there are couple ways that you can limit access to your admin page. You could either restrict access to the /admin folder by your IP address ..." />
  <title>How to block regular users from getting to my admin page. | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/how-to/how-to-block-regular-users-from-getting-to-my-admin-page" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:4ce318ec80c920901bba0e31eed28314 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>How to block regular users from getting to my admin page.</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2014-06-28 3:14 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>23</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>My admin control panel is <br />
http://23.235.195.101/admin/users/login<br />
I don't want any regular users from the internet guess this admin url and try to messup my site.<br />
Is there a way I can block those regular users and only aloow me and my other administrators on this admin url link? Like any permissions/firewall rule I can setup? Now any one can access this link from the internet.<br />
Please help.<br />
Thanks.<br />
<br />
<br />
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_5184' id='upvote_answer_5184' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='5184' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_5184').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_5184' id='downvote_answer_5184' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='5184' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_5184').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
Yes there are couple ways that you can limit access to your admin page. You could either restrict access to the &lt;span style=&quot;color: red;&quot;&gt;/admin&lt;/span&gt; folder by your IP address by adding this to your &lt;span style=&quot;color: red;&quot;&gt;.htaccess&lt;/span&gt; file:<br />
<br />
&lt;pre class=&quot;code_block&quot; style=&quot;margin: -10px 0px -30px 0px; line-height: .9em&quot;&gt;RewriteEngine on<br />
RewriteCond %{REQUEST_URI} ^/admin<br />
RewriteCond %{REMOTE_ADDR} !^123\.123\.123\.123$<br />
RewriteRule .* - [F,L]&lt;/pre&gt;<br />
<br />
Or you could &lt;a href=&quot;http://www.inmotionhosting.com/support/website/protecting-files/how-do-i-password-protect-a-directory-in-my-control-panel-cpanel&quot; target=&quot;_blank&quot;&gt;password protect your directory&lt;/a&gt;.<br />
<br />
...
- Jacob
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_5184').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_5184' id='form_comment_on_answer_5184' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/how-to/how-to-block-regular-users-from-getting-to-my-admin-page&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/how-to/how-to-block-regular-users-from-getting-to-my-admin-page'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="4d1e302b05905b2543c5bd93645dcb4c" value="1" />	</div>
	</form>
<!-- <br />
