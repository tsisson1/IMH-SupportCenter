<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:110961:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/ftp/too-many-simultaneous-connections" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-04-06T14:36:28-07:00" />
  <meta name="keywords" content="ftp connections too many simultaneous cpanel filezilla" />
  <meta name="author" content="John-Paul Briones" />
  <meta name="description" content="This guide show you how to fix the 421 too many connections error by managing your simultaneous FTP connections in FileZilla and cPanel." />
  <title>421 Too many connections - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/ftp/too-many-simultaneous-connections" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:cda177af7b258e8b823f51ec5d68c1e5 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '217.115.58.190']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/website/ftp' itemprop='url'><span itemprop='title'>FTP<span></a><div class='dropdown_3columns'><div class='col_3'><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/ftp/getting-started-guide'>Getting Started Guide: FTP</a> (144555 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/ftp/too-many-simultaneous-connections'>421 Too many connections</a> (54116 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/ftp/resetting-your-ftp-password-in-cpanel'>Resetting your FTP Password in cPanel</a> (20951 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/ftp/create-delete-account'>How to Create / Delete an FTP Account in cPanel</a> (15322 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/ftp/using-ftp-with-your-addon-domain'>Using FTP with your Addon domain</a> (10869 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/ftp/connecting-scp-sftp'>Connecting with SCP and SFTP</a> (9537 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/ftp/how-to-use-your-publicftp-folder'>How to use your Public_FTP folder</a> (7316 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/ftp/shared-sftp-setup'>Connecting to SFTP for Shared Accounts</a> (5219 hits)</div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>421 Too many connections</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>54,116</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Feb 19, 2014'><span style='color:#606060;'>Published:</span> Apr 6, 2016</div>
  ...
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('view-close');">View/Close Connections</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('set-connections');">Limit Simultaneous Connections</button>
</div>

<p>In this tutorial, we will show you how to <strong>view and drop idle FTP connections</strong> in cPanel and <strong>limit</strong> your FTP connections in <strong>FileZilla</strong>. These steps should help fix or avoid the <strong>421 Too many connections</strong> error.</p>


  <h2>Idle FTP Connections</h2>
  
  <h3>What is / causes an idle FTP connection?</h3>
  <p>Idle FTP connections are caused when an FTP client opens multiple connections, without closing the previous ones, or due to an incorrect setting.</p>
 
 <p><a href="http://www.inmotionhosting.com/vps-hosting">VPS</a>, <a href="http://www.inmotionhosting.com/dedicated-servers">Dedicated</a>, and <a href="http://www.inmotionhosting.com/managed-hosting">Managed</a> hosting plans have the ability to modify the number of simultaneous connections allowed in their <a href="/support/website/whm/whm-web-host-manager">WHM</a>; the default setting is usually 8 or 10. Increasing this limit will prevent the error messages that we will review later in this tutorial. Our <a href="http://www.inmotionhosting.com/business-hosting">Shared</a> and <a href="http://www.inmotionhosting.com/reseller-hosting">Reseller</a> plans allow up to <strong>8 simultaneous</strong> FTP connections from 1 IP address at a time, but cannot raise this limit.</p>
  
<h3>Response: 421 Too many connections (8) from this IP</h3>
  
  <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/ftp/421-too-many-connections-error-filezilla.png"><img  style="float: right; margin:0px 0px 15px 15px; max-width:290px;" src="//cdn.inmotionhosting.com/support/images/stories/ftp/421-too-many-connections-error-filezilla.png" alt="view of 421 too many connections error in filezilla" title="click to zoom in" /></a>

<p>If your FTP client is using more than 8 connections at the same time, you will get refused with a message similar to this:</p>

<pre class='code_block'>Response: 421 Too many connections (8) from this IP
Error: Could not connect to server</pre>



<a name="view-close"></a>
<h2>Viewing / Closing Idle Connections in cPanel</h2>
<ol class="article_list">
  <li><a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">Login to cPanel</a>.</li>
<li>Click the <strong>FTP Session Control</strong> button in the <em>Files</em> section.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/ftp/ftp-session-controll.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/ftp/ftp-session-controll.png" alt="access ftp session list" /></a></li>
<li>You will then see a list of all your current FTP connections. Click the red <strong>X</strong> in the <em>Disconnect</em> column.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/ftp/disconnect-ftp-session.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/ftp/disconnect-ftp-session.png" alt="" /></a></li>
<li>You will then see a message similar to this "<em>Are you sure you want to disconnect testuser@example.com FTP user?</em>." Click the <strong>Disconnect</strong> button to proceed.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/ftp/confirm-disconnect-ftp-session.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/ftp/confirm-disconnect-ftp-session.png" alt="" /></a><br><br>
You are finished when you see a message like this:"<em>The FTP session with PID 27510 was terminated. </em>"</li>
</ol>

<a name="set-connections"></a>
<h2>Limiting Simultaneous Connections in FileZilla</h2>
<ol class="article_list">
<li>Open <a href="/support/website/ftp-client-setup/configuring-your-site-in-filezilla">FileZilla</a>.</li>
<li>Access the <strong>Site Manager</strong>.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/ftp/access-site-manager.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/ftp/access-site-manager.png" alt="site manager in filezilla" title="view of the filezilla ftp site manager" /></a></li>
<li>Click your site, then select the <strong>Transfer Settings</strong> tab.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/ftp/filezilla-transfer-settings.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/ftp/filezilla-transfer-settings.png" alt="" /></a></li>
<li>Check the box for <strong>Limit number of simultaneous connections</strong>, and set the <em>Maximum number of connections</em> to <strong>8</strong>.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/ftp/limit-simultaneous-connections.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/ftp/limit-simultaneous-connections.png" alt="" /></a></li>
  <li>Click the <strong>OK</strong> button. Now when you are using FileZilla, it will <em>not</em> allow you to go over your limitation of 8 simultaneous FTP connections.</li>
</ol>
<br>

<p>Congratulations, now you know how to <strong>drop idle FTP connections</strong> in cPanel, and <strong>limit your FTP connections</strong> in FileZilla. We also have helpful guides on how to <a href="/support/website/ftp-client-setup/enable-filezilla-logging">Enable Logging in FileZilla</a>, <a href="/support/website/ftp-client-setup/troubleshoot-filezilla-error-logs">Troubleshooting FileZilla Error Logs</a>, and <a href="/support/website/ftp-client-setup/managing-your-files-in-filezilla">Managing your files in FileZilla</a>.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/ftp/too-many-simultaneous-connections&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/ftp/too-many-simultaneous-connections'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MDImaWQ9MzExMSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="2826e280d2c1f07abfec409a94cddf9b" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/file-management/ftp-too-many-connections?tsrc=rsbraq'>FTP Too Many Connections</a>
                                </div>
...
<a name='comments'></a>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='https://lh5.googleusercontent.com/-BcE5Kq85IPw/AAAAAAAAAAI/AAAAAAAAUyY/DH2MZ84a4iA/photo.jpg?sz=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='/support/community-support/users/Kavalec'>Kavalec</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-07 6:49 pm</div>
				                <div>Even at only ONE connection in Filezilla, this problem occurs on a fast connection. Any other help out there?<br />
</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8838);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-18465'></a>
		<div  style='margin:2px 0px 0px 40px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/fdf1cb9d68666e8cea3b870af1efe481?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/fdf1cb9d68666e8cea3b870af1efe481'>Ivan</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-13 3:49 pm</div>
				                <div><p>I had this issue with my IDEs when working on remote proyects which I handle with FTP connection. Anyways, i was having this multiple connections issue 421 and i followed these instruction on here but i was still having the same issue, then, after reading this article&nbsp;http://slacksite.com/other/ftp.html I checked the passive move on my IDE(PHPStorm) and it worked, so i would probably suggest you give this a try, chack passive mode, and ofcourse read the article.</p>
<p>Good luck</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(18465);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-10 9:21 am</div>
				                <div>While this connection may be fast, it could be unstable causing the client to incorrectly send the appropriate information to close that FTP connection.  When that happens, connections continue to be opened without being closed which would cause this error.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8874);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-12131'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/fd51d791e927046db60da11958458374?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/fd51d791e927046db60da11958458374'>dusan</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-29 6:00 pm</div>
				                <div><p>I have same problem on New cloud fast vps server. I terminated 1 connexion and then come back and want to termiante next but it comes back and again they are 7 !</p>
<p>Also im tired to change hositng now as thsi before didnt do. some help? as this is not normal to uploading joomla via ftp 1 all day :(</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12131);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-30 8:28 am</div>
				                <div>Hello dusan,<br />
<br />
Thank you for your comment? We are happy to help, but will need some additional information.  Have you tried <a href="http://www.inmotionhosting.com/support/website/ftp/simultaneous-connection#set-connections">limiting the simultaneous connections</a> as described in the article?<br />
<br />
If you have any further questions, feel free to post them below.<br />
Thank you,<br />
<br />
-John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12146);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-30 11:32 am</div>
				                <div><p>Well I dont understand why you send me link to this article and ask IF I TRIED this?? If I'm writting fro mthis article it means yes i supposed, and also HAVE YOU READ my post? If so you will know that i tried as i described there that.</p>
<p>I think you just some spam robot thats why i block your website on my antivirus and firewall!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12175);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-30 12:14 pm</div>
				                <div>Hello Dusan,<br />
<br />
We are sorry you were offended but you would be surprised at the number of people who come to an article and then ask how to do something without having tried what the article suggests. John-Paul was not trying to be offensive but to understand exactly what you have done so far. <br />
<br />
If you are using FileZilla and have it set to not allow more than one connection, then only one should be connecting from that location. If there are more, you may want to check with your hosting company to see if they are all from you or if there are external connections. <br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12180);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/6a85baaa917e0e53f77ec5976f476335?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/6a85baaa917e0e53f77ec5976f476335'>Former Filezilla user</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-02 4:06 am</div>
				                <div><p>This is a known problem with Filezilla, although the developers will not admit it (they get angry at anyone who tries to report it, you can see in their support forums).</p>
<p>The only solution I found was to switch to another FTP client, which of course was difficult because otherwise Filezilla is the best one out there (except for this bug!). I have experimented with about 10 other FTP clients and this just doesn't happen with other programs, only Filezilla. Argh!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15792);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/4f7cf27e2d960e761f88957ed912f1ec?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/4f7cf27e2d960e761f88957ed912f1ec'>Ankit</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-10 2:40 pm</div>
				                <div>It was good for me. </div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16109);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/6f1025ab958c904822f06b222a890ef3?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/6f1025ab958c904822f06b222a890ef3'>rafael sanchez</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-26 4:01 pm</div>
				                <div><p>try SFTP no problems for me.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16739);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-24188'></a>
		<div  style='margin:2px 0px 0px 40px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/bc45b419392a3ce03a3d6495051a86ba?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/bc45b419392a3ce03a3d6495051a86ba'>Bob the Website Builder</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-14 2:29 am</div>
				                <div><p>I can confirm that this worked for me.&nbsp;</p>
<p>Thanks for the solution.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24188);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-17574'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/794b9a658a9ddc94f2669d678434c6e7?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/794b9a658a9ddc94f2669d678434c6e7'>Heba</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-18 7:03 pm</div>
				                <div><p>I faced the same problem and i did what you wrot here but still have the same problem and didn't end .. may be the problem with server??</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17574);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-18 7:11 pm</div>
				                <div>It sounds like the FTP client isn't fully closing out the connections.  What FTP client are you using?</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17577);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-17804'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/e6e2895e437de6588fab84d51c8bdb06?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/e6e2895e437de6588fab84d51c8bdb06'>Ambarish</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-25 4:08 am</div>
				                <div><p>I tried this but its not solving my proble its again generates the connection after login</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17804);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-25 9:44 am</div>
				                <div>Be sure to check over your existing FTP connections in cPanel to ensure that they have all disconnected.  Then, check over your FTP client to ensure that it is not attempting to open too many connections.  Set the connection number to as low as possible in case the client causes a disconnection issue and opens up another connection before the previous is fully closed.  Try also restarting any computers that may be connected to ensure that there are not any residual connections there.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17811);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-19301'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/4e9096d7ba4377b0dee92d47115f1009?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/4e9096d7ba4377b0dee92d47115f1009'>Antonio</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-08 8:31 am</div>
				                <div><p>Thanks for information, it's helpful :)</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19301);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-19543'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/682ea246dfa6eb464a8af594dc13ca3d?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/682ea246dfa6eb464a8af594dc13ca3d'>TJ</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-14 4:37 pm</div>
				                <div><p>My site is down and I need to upload my backup. Will my other 10 or more connections log out in time? or how should I go about connecting.&nbsp;</p>
<p>Thanks</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19543);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-14 11:24 pm</div>
				                <div>Hello TJ,<br />
<br />
Sorry to hear that you're having a problem with your website.   If your site is down and you're not able to connect to it via the internet, then you will need to <a href="http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support" target="_blank">contact our live technical support team</a>.  They can help you determine the cause of your connection problem.  They can also help to determine the best way to get your backup restored and your website backup.<br />
<br />
I hope this helps to resolve your problem.  If you have any further questions or comments, please let us know.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19548);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-21861'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/7f5a10d7c7648420d02ebac44b05c0ff?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/7f5a10d7c7648420d02ebac44b05c0ff'>Mizhar</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-19 9:20 am</div>
				                <div>Excellent Article</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21861);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-22692'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/126cf7730ed4cda8e70e0517518d9c88?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/126cf7730ed4cda8e70e0517518d9c88'>mileana</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-16 1:00 am</div>
				                <div><p>The same problem facing here for my&nbsp;http://************.co.in/home/ cant access to ftp</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22692);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-16 1:40 pm</div>
				                <div>Hello,<br />
<br />
Thank you for contacting us. Since your site is not hosted on our servers, I cannot check that the services are functional. So, you way want to contact your web host to verify everything is working.<br />
<br />
Next, verify your FTP settings are correct, and there are no typos, or misspellings.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22713);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-24428'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/e6ef436ba61dc4ccfd2b58adc5f0104d?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/e6ef436ba61dc4ccfd2b58adc5f0104d'>Bharat</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-25 1:48 am</div>
				                <div><p>Hi There,</p>
<p>Great post. It's really works for me. Appreciate your help.</p>
<p>&nbsp;</p>
<p>Bharat.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24428);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/776ec6d924bf67f1342c1fb05ccc1ec7?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/776ec6d924bf67f1342c1fb05ccc1ec7'>Necati Aksu</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-02 5:41 pm</div>
				                <div><p>Thank you. &Ccedil;ok te?ekk&uuml;r ederiz.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26302);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-29510'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/b710c3b76d31136d00984d61a59cefa1?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/b710c3b76d31136d00984d61a59cefa1'>Mihai Badea</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-02 6:26 pm</div>
				                <div><p>The solutions suggested in the above posts did not work for me, except for the one suggesting to switch to a different client. I used WinSCP. It was significantly slower than FileZilla, but the 421 error didn't occur and the transfer completed successfully.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29510);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-31718'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/a32a76277bbf90cd121ee60f2b2e92e3?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/a32a76277bbf90cd121ee60f2b2e92e3'>y3y0</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-05 9:19 pm</div>
				                <div><p>Thank you&nbsp;<a style="color: #3f89c2; outline: 0px; font-family: adelle-sans, Helvetica, Arial, sans-serif; font-size: 12px; line-height: 22px; background-color: #f9f9f9;" href="https://plus.google.com/u/0/114162951489960418846?rel=author">John-Paul Briones</a></p>
<p>For me works well. When I have more than 8 connections, simply reset the other and that's it.</p>
<p>&nbsp;</p>
<p>Cheers!&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31718);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
