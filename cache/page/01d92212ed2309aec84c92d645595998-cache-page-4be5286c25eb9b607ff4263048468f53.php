<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:68240:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/wordpress/335-upload-video-content" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-04-09T18:13:04-07:00" />
  <meta name="keywords" content="upload video content wordpress post page posts pages" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="If you have decided to upload video content to your Wordpress site, check out this article for instructions." />
  <title>335: How to upload video content in WordPress - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/wordpress/335-upload-video-content" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:e226d81657ba8fb32f40f6da1ca146ea -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '36.78.40.98']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															335: How to upload video content in WordPress									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>5,302</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Apr 9, 2013'><span style='color:#606060;'>Published:</span> Apr 9, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>When working with video content for your site, you have two options, uploading and embedding. You can learn the differences between the two in our article on <a href="/support/edu/wordpress/334-embed-vs-upload-video">Embedding vs Uploading Videos</a>. If you decided to upload the content to your WordPress site, follow the simple guide below.</p>

<h2>Uploading video content to your WordPress site</h2>

<ol class="article_list">
<li><a href="/support/edu/wordpress/wordpress-introduction/logging-into-wordpress-dashboard">Log into your WordPress admin dashboard</a>.<div style="clear:both;"></div></li>
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/add-video/upload/new-media.png "><img style="float: right; margin: 0px 0px 15px 15px;"  alt="click on new media" src="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/add-video/upload/new-media.png " title="Click here to view the larger image" width="200" /></a>Once on the admin dashboard, hover over the <strong>Media</strong> option from the left hand side menu and click on the <strong>Add New</strong> from the popup menu.<div style="clear:both;"></div></li>
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/add-video/upload/upload-media.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="click select files button" src="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/add-video/upload/upload-media.png" title="Click here to view the larger image" width="200" /></a>This leads you to the <em>Upload New Media</em> page. Click on the <strong>Select Files</strong> button to continue.<div style="clear:both;"></div></li>
<li>This opens a window for you to browse your local computer and select the video. Once you find it, upload it to your server.<div style="clear:both;"></div></li>
  <li>To add the video to your site, select either <strong>Pages</strong> or <strong>Posts</strong> from the left hand menu. For our example, we selected <em>Posts</em>.<div style="clear:both;"></div></li>
  <li>Click on the post/page you want to edit, or click on <strong>Add New</strong>. We selected to edit a current post entitled <em>Hello World</em>.<div style="clear:both;"></div></li>
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/add-video/upload/post-add-video.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="click add media button" src="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/add-video/upload/post-add-video.png" title="Click here to view the larger image" width="200" /></a>Now that you are in the post/page editor, you will see a small <strong>Add media</strong> icon above the body content editor. Click that button.<div style="clear:both;"></div></li>
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/add-video/upload/insert-media-page.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="insert media into post or page" src="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/add-video/upload/insert-media-page.png" title="Click here to view the larger image" width="200" /></a>This brings you to the <strong>Insert Media</strong> page. Click on the <strong>Media Library</strong>. This will bring up a list of existing data to select from. Click on the video you want to insert and click on the <strong>Insert into post</strong> button.<div style="clear:both;"></div></li>
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/add-video/upload/after.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="with inserted video link" src="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/add-video/upload/after.png" title="Click here to view the larger image" width="200" /></a>You will be brought back to the post editor where the code will be inserted for your video. Click on the <strong>update</strong> link in order to save the changes and make the video link live on your site. The code inserted for the sample below simply creates a link.<div style="clear:both;"></div>
    <div class="code_block">&lt;a href="http://example.com/wp-content/uploads/2013/04/Moon_and_Clouds.wmv"&gt;Moon_and_Clouds&lt;/a&gt;</div></li>
<li><div style="clear:both;"></div></li>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 17: 335: How to upload video content in WordPress</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 16: <a href='/support/edu/wordpress/336-embed-video'>336: How to embed video content in a WordPress site</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 18: <a href='/support/edu/wordpress/334-embed-vs-upload-video'>334: Embedding vs Uploading videos in WordPress posts and pages</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/wordpress/335-upload-video-content&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/wordpress/335-upload-video-content'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD03MSZpZD0yNTk2JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="b71b4af481617ff692ca3b650ab41341" value="1" />	</div>
	</form>
<!-- <br />
...
<a name='comments'></a>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/76cebd157b96f9322e69560348435c55?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/76cebd157b96f9322e69560348435c55'>Rick McElderry</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-23 12:08 pm</div>
				                <div><p>I get errors every single time I try to use this method. Instead I use the file manger in the cpanel to upload my video files.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13200);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-23 12:16 pm</div>
				                <div>If you would rather use the media uploader, I'm happy to help.  What specific errors are you getting?</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13201);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-14193'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/681d11f9933a8980ab381c4712aa2dcd?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/681d11f9933a8980ab381c4712aa2dcd'>praveen</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-21 7:26 am</div>
				                <div><p><span style="color: #232323; font-family: adelle-sans, Helvetica, Arial, sans-serif; font-size: 13px; line-height: 22px;">I get errors every single time I try to use this method. Instead I use the file manger in the cpanel to upload my video files.</span></p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14193);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-21 8:06 am</div>
				                <div>Hello Praveen,<br />
<br />
What type of errors are you receiving when working with this method? Also, cPanel and FTP are always good alternatives for those who know how to use them.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14201);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-24044'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/87ccb27551ea2ef02a0b30df61cb0bd6?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/87ccb27551ea2ef02a0b30df61cb0bd6'>Ali Hyder</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-09 3:23 am</div>
				                <div><p>i upoad videos but me have HTTP Eror showing ani time upload last time video showing HTTP Eror plz salve my prob.&nbsp;</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24044);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-09 8:18 am</div>
				                <div>Hello Ali,<br />
<br />
Has this always been happening? I have seen this error with uploading images but never videos. Can you install the <a href="https://wordpress.org/plugins/force-regenerate-thumbnails/">Force Regenerate Thumbnails</a> plugin as I am curious if that will work.<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24058);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
