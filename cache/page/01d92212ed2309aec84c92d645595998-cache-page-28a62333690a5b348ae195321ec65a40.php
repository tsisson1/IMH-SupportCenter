<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:82506:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/wordpress/fix-fatal-error-allowed-memory-size-exhausted" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-11-12T21:11:02-08:00" />
  <meta name="keywords" content="wordpress php fatal error allowed memory exhausted php.ini wp-config.php WP_MEMORY_LIMIT" />
  ...
  <title>Fix WordPress Fatal error: Allowed memory size exhausted - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/wordpress/fix-fatal-error-allowed-memory-size-exhausted" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:c91020c9be901569ec099ebbd2441cf9 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Fix WordPress Fatal error: Allowed memory size exhausted									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>16,322</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Nov 12, 2013'><span style='color:#606060;'>Published:</span> Nov 12, 2013</div>
  ...
  <h2>Navigation:</h2>
  <button type="button" class="btn btn-primary" onclick="window.location.hash='show-php-error';">Find PHP error behind blank WordPress page</button>
  <button type="button" class="btn btn-primary" onclick="window.location.hash='fix-memory-exhausted';">Fix Allowed memory size exhausted error</button>
</div>

<p>WordPress can encounter a blank page sometimes, and the most common issue is a <strong>PHP Fatal error</strong> regarding the <strong>Allowed memory size of xxxxxxx bytes exhausted</strong> and in this guide I'll show you how to easily fix this problem.</p>

<a name="show-php-error"></a>
<h2>Find PHP error behind blank WordPress page</h2>
...
<p>If you'd like more in-depth information you can also review our guide on <a href="http://www.inmotionhosting.com/support/website/php-troubleshooting/troubleshoot-php-errors" target="_blank">displaying and logging errors in PHP</a>.</p>

<ol class="article_list">
<li>
    <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress/memory-size-exhausted/wordpress-dashboard-blank.png"><img  style="float: right; width: 190px; margin-left: 15px;" src="//cdn.inmotionhosting.com/support/images/stories/wordpress/memory-size-exhausted/wordpress-dashboard-blank.png" alt="wordpress dashboard blank"></a>
    <p>Navigate to the WordPress page that is coming up blank, in this case it is our WordPress dashboard at <strong>/wp-admin</strong> causing issues.</p>    
</li>

<li style="clear: both;">
    <div style="background-color: #DFDFDF; padding: 5px">
    <p>You'll want to modify your <a href="http://www.inmotionhosting.com/support/website/php/update-local-php-settings" target="_blank">php.ini</a> file and also ensure that you <a href="http://www.inmotionhosting.com/support/website/php/recursive-php-ini" target="_blank">make your php.ini file recursive</a>.</p>
...
<pre class="code_block" style="width: 500px; margin-bottom: 5px;">SuPHP_ConfigPath /home/<strong style="color: red;">userna5</strong>/public_html</pre>
...
<li>
    <p>Now you'll want to edit your <strong>php.ini</strong> file with the following settings:</p>
<pre class="code_block" style="width: 500px; margin-bottom: 5px;">display_errors = On</pre>
    <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress/memory-size-exhausted/wordpress-dashboard-showing-memory-error.png"><img  style="float: right; width: 190px;" src="//cdn.inmotionhosting.com/support/images/stories/wordpress/memory-size-exhausted/wordpress-dashboard-showing-memory-error.png" alt="wordpress dashboard showing memory error"></a>
...
<pre class="code_block" style="width: 662px; margin-top: 25px; max-width: 800px; position: relative; right: 58px;">Fatal error: Allowed memory size of 1048576 bytes exhausted (tried to allocate 122880 bytes) in /home/example/public_html/wordpress/wp-admin/includes/dashboard.php on line 546</pre>    
    
    
</li>
</ol>

<a name="fix-memory-exhausted"></a>
<h2>Fix WordPress Fatal error: Allowed memory size exhausted</h2>
...
<ol class="article_list">
<li>
    <p>Take <strong style="color: red;">note</strong> of the error you're getting, and how much memory is trying to be allowed:</p>
<pre class="code_block" style="width: 662px; margin-top: 25px; max-width: 800px; position: relative; right: 58px;">Fatal error: Allowed memory size of <strong style="color: red;">1048576 bytes exhausted</strong> (tried to <strong style="color: red;">allocate 122880 bytes</strong>) in <strong style="color: red;">/home/example/public_html/wordpress/wp-admin/includes/dashboard.php</strong> on line 546</pre>
    <table class="article_table" style="width: 665px; position: relative; right: 55px;">
    <tr>
        <th style="width: 50px;">Allowed memory size</th>
        <th style="width: 50px;">Tried to allocate</th>
        <th style="width: 50px;">Filename causing memory problems</th>
    </tr>
    <tr>
        <td>1048576 bytes</td>
        <td>122880 bytes</td>
        <td>/home/example/public_html/wordpress/wp-admin/includes/dashboard.php</td>
    </tr>
    <tr>
        <td>1 MB</td>
        <td>120 KB</td>
    ...
    <p style="margin-top: 15px;">Here we can see <strong>PHP</strong> is allowed to use up to <strong>1 MB</strong> of memory, and it's exhausting this limit by the time it gets to our <strong>dashboard.php</strong> script on line <strong>546</strong> which is trying to allocate an additional <strong>120 KB</strong></p>
</li>

<li>
    <div style="background-color: #DFDFDF; padding: 5px">
    <p>Now you'll want to take a look at your <a href="http://www.inmotionhosting.com/support/website/php/update-local-php-settings" target="_blank">php.ini file</a> and raise your <strong>memory_limit</strong> setting:</p>
    
<pre class="code_block" style="width: 175px; margin-top: 25px;">;;;;;;;;;;;;;;;;;;;
; Resource Limits ;
;;;;;;;;;;;;;;;;;;;

max_execution_time = 30
max_input_time = 60
<strong style="color: red;">memory_limit = 1M</strong>
</pre>

    <p style="margin-top: 20px;">You see that I've only got it set to <strong>1 M</strong> which is causing our PHP error, and I can simply raise it some:</p>
    
<pre class="code_block" style="width: 175px; margin-top: 15px;"><strong style="color: red;">memory_limit = 32M</strong></pre>
</div>
</li>

<li>
    <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress/memory-size-exhausted/wordpress-dashboard-fixed.png"><img  style="float: right; width: 190px;" src="//cdn.inmotionhosting.com/support/images/stories/wordpress/memory-size-exhausted/wordpress-dashboard-fixed.png" alt="wordpress dashboard fixed"></a>
    <p>Now you'll want to verify your <strong>php.ini</strong> settings are <a href="http://www.inmotionhosting.com/support/website/php/recursive-php-ini" target="_blank">recursive</a> and then try to access your WordPress website again. You should get your admin normal dashboard disaplying now.</p>
</li>

<li style="clear: both;">
<div style="background-color: #DFDFDF; padding: 5px">
    <p>If you're still getting a <strong>memory exhausted</strong> error verify your <strong>php.ini</strong> setting is being read by setting up a <a href="http://www.inmotionhosting.com/support/website/php/create-phpinfo-page-to-see-php-settings" target="_blank">phpinfo() page</a> that can simply be named <strong>info.php</strong> inside your WordPress directory and look like: </p>
<pre class="code_block" style="width: 175px; margin-top: 15px;">&lt;?php
phpinfo();
?></pre>
    <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress/memory-size-exhausted/phpinfo-page-showing-memory-limit.png"><img  style="float: right; width: 190px; margin-left: 35px;" src="//cdn.inmotionhosting.com/support/images/stories/wordpress/memory-size-exhausted/phpinfo-page-showing-memory-limit.png" alt="phpinfo page showing memory limit"></a>
    <p style="margin-top: 15px;">Access the <strong>info.php</strong> script you created in your web-browser, then hit <strong>Ctrl-F</strong> and do a search and look for <strong>memory_limit</strong> and make sure it matches what you set for this varible.</p>
</div>
</li>

<li>
    <p>If this still isn't working for you, as a last resort you can add <strong>define('WP_MEMORY_LIMIT', '32M');</strong> towards the top of your <strong>wp-config.php</strong> file:</p>
<pre class="code_block" style="width: 550px; margin-top: 15px;"> * @package WordPress
*/
<strong style="color: red;">define('WP_MEMORY_LIMIT', '32M');</strong>

// ** MySQL settings - You can get this info from your web host ** //</pre>
    <p style="margin-top: 15px;">This is also covered in the offical WordPress documentation for <a href="http://codex.wordpress.org/Editing_wp-config.php#Increasing_memory_allocated_to_PHP" target="_blank">increasing memory allocated to PHP</a>.</p>   
</li>

</ol>

<p style="margin-top: 15px;">You should hopefully now not be encountering any further WordPress memory related errors. If these steps didn't help resolve your particular issue, please leave a comment so that we can keep adding different errors to it to help others.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/wordpress/fix-fatal-error-allowed-memory-size-exhausted&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/wordpress/fix-fatal-error-allowed-memory-size-exhausted'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD02MyZpZD0yOTY2JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="87ce4991ef3a62ff4251e34a93c74cf1" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/25f49cc1de2429672f2111cafaf64ee0?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/25f49cc1de2429672f2111cafaf64ee0'>Jonathan (@parlox)</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-09 1:22 am</div>
				                <div><p>It is a very useful article. It helped me find out how to fix the error.</p>
<p>Just in addition to what the article says: <strong>there is a php.ini file in the public_html which has a lot of words</strong> that apparently don't make sense. But, there is a 'section' that says "Resource Limits".<strong> If you change this from xxM (16M for example) to 256M</strong> you will fix the issue and havo no more problems:</p>
<p style="padding-left: 30px;">Maximum amount of time each script may spend parsing request data <strong>memory_limit = 256M</strong> &nbsp; &nbsp; &nbsp;; Maximum amount of <strong>memory a script may consume (256MB)</strong></p>
<p>Have a great day! Blessing to you all!</p>
<p>Regards,</p>
<p>Jonathan (www.parlox.net)</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9525);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-09 2:10 am</div>
				                <div>Hello Jonathan, and thank you for your comment.<br />
<br />
Yes as mentioned in step #2 in this guide, the &lt;span style=&quot;color: red;&quot;&gt;php.ini&lt;/span&gt; file is where you'll want to modify your &lt;span style=&quot;color: red;&quot;&gt;memory_limit&lt;/span&gt; setting at, to be higher than how much memory WordPress is trying to consume.<br />
<br />
- Jacob</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9526);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/e70f899f94e622807c2597a6b028e3f5?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/e70f899f94e622807c2597a6b028e3f5'>sudeep gangal</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-27 2:55 pm</div>
				                <div><p>Thanks... It worked for me well.&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10200);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-14804'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/9ae6ba4787c6e1a760f47af1c759d281?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/9ae6ba4787c6e1a760f47af1c759d281'>Bart</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-07 5:00 pm</div>
				                <div>It helped me a lot, many thanks!</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14804);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-16197'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/2ff76db5210791766c063b96facb67cc?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/2ff76db5210791766c063b96facb67cc'>Pushpak Patel</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-14 3:34 am</div>
				                <div><p>Thanks for the great info guys. Was getting blank dashboard but no error or notice was being reported in the log. tried ur solution and boom, it worked.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16197);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-20496'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/8b75dcb234b545e485b127f78c558b4e?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/8b75dcb234b545e485b127f78c558b4e'>Chris</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-08 8:41 pm</div>
				                <div><p>My problem is that I do not have access to the php.ini file. What do I do then?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20496);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-09 10:48 am</div>
				                <div>Hello Chris,<br />
<br />
Thank you for your question. If you do not see a file named <strong>php.ini</strong> in your public_html, please contact our <a href="http://www.inmotionhosting.com/contact">Support Department</a> and request that we create one for you.<br />
<br />
If you have any further questions, feel free to post them below.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20507);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
