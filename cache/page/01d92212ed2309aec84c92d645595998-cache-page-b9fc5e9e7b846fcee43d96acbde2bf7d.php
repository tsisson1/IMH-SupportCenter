<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49640:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/domain-names/mx-records-3" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello OutdoorRecreation, If your domain name is not registered through our domain registrar AND you are not pointing the domains to our name servers, th..." />
  <title>MX Records | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/domain-names/mx-records-3" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:795cf938c30b33c9ece17737a9a76db4 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/OutdoorRecreation'>OutdoorRecreation</a>
			<div>10 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-03-21 6:23 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>927</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Hello! I am moving our account and DNS over to you guys! However I noticed there is no option to edit MX records only A, CNAME and TXT.<br />
<br />
We use Google Apps and would like to manage our MX records. Is this possible?<br />
</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_2491' id='upvote_answer_2491' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='2491' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_2491').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_2491' id='downvote_answer_2491' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='2491' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_2491').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>32,263 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2013-03-21 6:30 pm EST
                		        </div>
					
		                </div>

				Hello OutdoorRecreation,<br />
<br />
If your domain name is not registered through our domain registrar AND you are not pointing the domains to our name servers, then you will need to change the DNS records so that the MX records point to our hosting service.  If you simply change the name servers, then you will still need to change the mail records to be able to use your Google Apps email.  Check out this article for further information:<br />
<a href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-email/modfying-mx-records" target="new">Changing the MX records</a>.<br />
<br />
Hopefully, this will be all the information you need.  If you need more, you can contact live support 24/7 or through email and chat.  <br />
<br />
...
Arnel C.<br />
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_2491').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_2491' id='form_comment_on_answer_2491' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/domain-names/mx-records-3&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/domain-names/mx-records-3'></div>
<script type='text/javascript'>
  (function() {
