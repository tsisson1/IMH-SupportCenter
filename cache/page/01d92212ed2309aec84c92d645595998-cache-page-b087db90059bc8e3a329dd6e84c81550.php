<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50924:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/wordpress/can-not-get-to-admin-page-on-rabbittrapus" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Grizzly34 Thank you for your question today. Generally speaking there is up to a 4-24 hours period of propagation for any DNS changes that are mad..." />
  <title>Can not get to admin page on rabbittrap.us | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/wordpress/can-not-get-to-admin-page-on-rabbittrapus" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:d72203e42ceb52d8001ab0456f6e02ab -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Can not get to admin page on rabbittrap.us</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='http://graph.facebook.com/GrizzlyMcAdams/picture?type=normal' class='user_avatar' /><br />
			<a href='/support/community-support/users/grizzly34'>grizzly34</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-11-16 6:57 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>722</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I just installed wordpress to domain rabbittrap.us and it gave me a successful load notice. I clicked the link to the admin page but chrome gives me the following &quot;Oops! Google Chrome could not find rabbittrap.us<br />
Try reloading: rabbittrap.­us&quot;.<br />
Is there a waiting period after adding-on a domain, pointing it to the servers and installing WP?</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_4233' id='upvote_answer_4233' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='4233' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_4233').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_4233' id='downvote_answer_4233' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='4233' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_4233').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Grizzly34<br />
<br />
Thank you for your question today. Generally speaking there is up to a 4-24 hours <a href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/domain-names-dns-changes">period of propagation</a> for any DNS changes that are made on the server. This includes pointing to different name servers and adding a domain to your account. The addition of a domain to an account, if it is a brand new domain, can be much shorter. I have seen it take place within just a few minutes, but at times it takes the normal propagation time.  <br />
<br />
So if things don't happen right away, particularly if you have name servers involved, do not fear, it is likely that the change is simply in propagation.<br />
<br />
Kindest Regards,<br />
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_4233').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_4233' id='form_comment_on_answer_4233' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/wordpress/can-not-get-to-admin-page-on-rabbittrapus&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/wordpress/can-not-get-to-admin-page-on-rabbittrapus'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="5b4015fd12f5d469e1b418e58a180619" value="1" />	</div>
	</form>
<!-- <br />
