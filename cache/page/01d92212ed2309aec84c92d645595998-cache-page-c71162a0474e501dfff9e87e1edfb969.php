<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:66971:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/ftp-client-setup/how-to-create-a-network-drive" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-04-21T23:34:32-07:00" />
  <meta name="keywords" content="create ftp network drive location" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="Creating a network drive allows you to connect to your hosting account and manage your files similar to how you manage local files and folders on your computer. For example, you can easily drag and drop files to upload them, delete files, etc." />
  <title>How to create a Network Drive - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/ftp-client-setup/how-to-create-a-network-drive" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:86a4495b2d254ba728e58b1436ba0c2f -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '88.192.74.174']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to create a Network Drive									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>7,505</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 10, 2012'><span style='color:#606060;'>Published:</span> Apr 21, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Creating a network drive allows you to connect to your hosting account and manage your files similar to how you manage local files and folders on your computer. For example, you can easily drag and drop files to upload them, delete files, etc.</p>
<p>This article references a username and password, which is your FTP username and password. If you're unfamiliar with FTP, you can find more information in our <a href="/support/website/file-management/getting-started-guide-ftp">FTP Getting Started Guide</a>.</p>
<p><strong>To create a Network Drive in Windows 7:</strong></p>
<ol>
<li>Click your Start Menu and then click "Computer"</li>
<li>Find and click the button at the top labeled "Map Network Drive"<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/windows/create-network-drive/click-map-network-drive.gif"><img  alt="click-map-network-drive" src="//cdn.inmotionhosting.com/support/images/stories/windows/create-network-drive/click-map-network-drive.gif" /></a></li>
<li>Click the link that says, "Connect to a website that you can use to store your documents and pictures"</li>
<li>Click "Next" to the introduction screen</li>
<li>Click the option that says, "Choose a custom network location" and then click "Next"</li>
<li>At "Internet or Network Address", enter ftp://example.com (be sure to replace example.com with your actual domain), and click "Next"</li>
<li>Uncheck the option to "Log on Anonymously" and enter your FTP user as the username (which is your cPanel username), then click "Next"</li>
<li>Type in a name to reference your network location and then click "Next"</li>
<li>Click Finish</li>
<li>From here you can now click on your Start Menu and then click Computer. Under "Network Location" you should see the shortcut we've just created.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/windows/create-network-drive/start-computer-network-location-has-been-created.gif"><img  alt="start-computer-network-location-has-been-created" src="//cdn.inmotionhosting.com/support/images/stories/windows/create-network-drive/start-computer-network-location-has-been-created.gif" /></a></li>
<li>After you double click to open the network location, you will be prompted for your ftp password. Enter it here and then click "Log On"</li>
<li>After you have connected, you should see a folder open with a listing of all the files on your hosting account. The functionality will be very similar to what you can do when you open folders on your local computer.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/windows/create-network-drive/what-a-network-location-looks-like.gif"><img  alt="what-a-network-location-looks-like" src="//cdn.inmotionhosting.com/support/images/stories/windows/create-network-drive/what-a-network-location-looks-like.gif" /></a></li>
</ol> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/ftp-client-setup/how-to-create-a-network-drive&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/ftp-client-setup/how-to-create-a-network-drive'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MDEmaWQ9MzUxJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/97d30dcecb822f9cfa05accb4f2ba074?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/97d30dcecb822f9cfa05accb4f2ba074'>kent</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-14 3:24 am</div>
				                <div><p>HOw do I do this in Linux, say, with the Nautilus or Konqueror file managers?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31901);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-14 11:54 am</div>
				                <div>Hello Kent,<br />
<br />
Thank you for contacting us. I found a post via online search where they offer a possible solution on how to <a href="https://linuxconfig.org/mount-remote-ftp-directory-host-locally-into-linux-filesystem" target="_blank">Mount remote ftp directory host locally into linux filesystem</a>.<br />
<br />
I hope this helps,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31922);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-15 2:55 am</div>
				                <div><p>Hey, it worked. Overall, a bit complicated, but in the end it works well. I followed the&nbsp;instructions in your link for the Linux curlftpfs setupt. Then I set up a network drive in Konqueror, basically like the instructions above for a Windows network drive, and it works like a regular directory now.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31946);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
