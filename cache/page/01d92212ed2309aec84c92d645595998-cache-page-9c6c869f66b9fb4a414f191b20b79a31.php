<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:84645:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-3/banners/side-by-side" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-11-06T17:18:01-08:00" />
  <meta name="keywords" content="joomla 3.0 banner side by side" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="The default behavior for banners is to show one on top of the other. In this Joomla 3.0 tutorial, we will show you how to display banners side by side." />
  <title>How to show Joomla 3.1 banners side by side - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-3/banners/side-by-side" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:0978a104a4ab6b6a3b7b62614a3331d9 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '223.240.143.11']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to show Joomla 3.1 banners side by side									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>5,778</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Nov 6, 2012'><span style='color:#606060;'>Published:</span> Nov 6, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>As we dive deeper into another tutorial about <a href="/support/edu/joomla-3/banners">using banners in Joomla</a>, we will now teach you how to show your banners side by side.</p>
<p>By default, banners are shown in div tags, which by default are block elements. Our goal in this tutorial is to turn them into inline elements instead. Does this CSS jargon not make sense? That's OK, simply follow the steps below to show your banners horizontally instead of vertically.</p>
<ol class="article_list">
<li><a href="/support/edu/joomla-3/getting-started/login-dashboard">Log into your Joomla 3.0 admin dashboard</a></li>
<li>In the top menu, click <strong>Extensions</strong> and then click <strong>Template Manage</strong>r</li>
<li>In the left menu, click <strong>Templates</strong></li>
<li>Next to the template you are using, click the <strong>Details and Files</strong> link</li>
<li><strong>Edit your template's CSS file</strong><br /><br />In our testing, we are using the <a href="/support/edu/joomla-3/protostar">Protostar template</a>, so we clicked on the link that says <strong>Edit css/template.css</strong>. If you are using a different template, your css file may be named differently.<br /><br />When your template's css file is open, add the following code to the bottom and then click the <strong>Save </strong>button in the top left:
<pre class="code_block">.banneritem,<br />.banneritem .clr{<br />   display: inline;<br />}</pre>
<p>When you visit your site again, you will notice that your banners are now showing side by side.</p>
<table class="article_table">
<tbody>
<tr><th>Default Banner Display</th><th>Banners side by side after CSS update</th></tr>
<tr>
<td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/banners/default-banner-display.jpg"><img style="max-width: 240px;"  alt="default-banner-display" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/banners/default-banner-display.jpg" /></a></td>
<td>&nbsp;<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/banners/banners-showing-side-by-side.jpg"><img style="max-width: 240px;"  alt="banners-showing-side-by-side" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/banners/banners-showing-side-by-side.jpg" /></a></td>
</tr>
</tbody>
</table>
</li>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 10: How to show Joomla 3.1 banners side by side</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 9: <a href='/support/edu/joomla-3/banners/rotating'>Rotating Banners in Joomla 3.1</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-3/banners/side-by-side&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-3/banners/side-by-side'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yOTImaWQ9MTk3MCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="c741ca22d3fb89e566ebb285976708b8" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/19a20a91cd3c1f274d5c66d8f13db6b4?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/19a20a91cd3c1f274d5c66d8f13db6b4'>Husted</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-26 11:11 am</div>
				                <div><p>This extension to the CSS file used to work, but after an update to Joomla 3.3.0 it does not seem to work any longer.</p>
<p>Any good ideas?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10903);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-27 8:40 am</div>
				                <div>Are you still using the Protostar template?  If not, this can vary between themes.  Could you provide us with a link to the site that you are having trouble with?</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10918);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-28 8:03 am</div>
				                <div><p>Yes, I am using the Protostar template.</p>
<p>This is the site in question: http://www.kogecykelmotion.dk/site/</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10950);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-28 8:14 am</div>
				                <div>It appears that you simply had removed a space from what was provided in this article which caused the issue.  You should have a space between &lt;strong&gt;.banneritem&lt;/strong&gt; and &lt;strong&gt;.clr{&lt;/strong&gt;. </div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10952);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 160px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-28 8:32 am</div>
				                <div><p>Thanks a lot. The strange thing is I have just done a copy/paste so I never thought there could be errors in that. Never mind. Now it works again.</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10954);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-16 1:03 pm</div>
				                <div><p>All files in protostar template in my site are not writable and when I tried to change the attributes I got those read-only file system messages. What do I do? Thanks</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12853);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-16 4:55 pm</div>
				                <div>Hello Spyropk,<br />
<br />
Sorry for the problems.  Unfortunately, you've given us no information on your domain, so we need a little more information if you wish for us to troubleshoot the problem.  Can you provide the domain name?  If you're hosted with us, you should be able to log into the <a href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-file-manager/using-file-manager-in-cpanel">cPanel to use the File manager</a>.  There you can change the file attributes.  I'm not sure how you're making changes to the files, so we need to know exactly what you're doing in order to pinpoint the problem.  Please provide the steps you're doing for us to replicate the problem.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12866);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-17 6:43 am</div>
				                <div>Thanks for the reply.
Files are ok today. Must have been a server thing. I sort of paniced yesterday  and forgot the details, but all seem ok today. Thanks anyhow.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12889);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-22706'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/8395e70b5bd02d45c8fe7bff066ad208?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/8395e70b5bd02d45c8fe7bff066ad208'>Stefan</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-16 11:43 am</div>
				                <div><p>Hi,</p>
<p>your description was really helpful. I did manage to get my banners side by side. I would like to get them centered on a page, they are aligned left right now...</p>
<p>Thanks in advance</p>
<p>www.airguns-srbija.com&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22706);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-16 3:49 pm</div>
				                <div>Hello Stefan,<br />
<br />
Thank you for your question. You will have to custom edit the css to modify your Joomla site.<br />
<br />
Please see our guide on <a href="http://www.inmotionhosting.com/support/edu/website-design/insert-images-website/align-float-images-css">Align and float images with CSS</a>.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22715);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-31079'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/43c5c035c0dd8d7c75b1432afb6787a9?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/43c5c035c0dd8d7c75b1432afb6787a9'>athina</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-09 8:09 am</div>
				                <div><p>Hi!</p>
<p>thanks a lot for your Courses!</p>
<p>I don't use protostar template and this code doesn't work. Any idea?</p>
<p>I have changed the file css/general.css</p>
<p>thanks in advance</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31079);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-09 9:32 pm</div>
				                <div>Hello Athina,<br />
<br />
We would need to know the template you're using.  You may need to speak with the developer of that template if the codes not working in it.  The code is made to change the CSS in the template, so that may be the issue you're facing.<br />
<br />
If you have any further questions, please let us know.  <br />
<br />
Kindest regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31100);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
