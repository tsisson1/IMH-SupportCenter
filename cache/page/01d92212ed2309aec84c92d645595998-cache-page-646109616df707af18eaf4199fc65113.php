<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:72688:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/cpanel/find-server-name-in-cpanel" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-01-28T22:36:12-08:00" />
  <meta name="keywords" content="find locate host name hostname server name number" />
  <meta name="author" content="Jacob Nicholson" />
  <meta name="description" content="In this article I'll teach you how to quickly locate the server name for your cPanel account. The server name refers to the physical server that hosts your website files and is something good to know especially when your website hasn't gone live yet." />
  <title>Find server name in cPanel - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/cpanel/find-server-name-in-cpanel" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:de63a6fe6613b1b2728100c53a212899 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-22']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '188.40.100.186']);
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>36,690</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 28, 2013'><span style='color:#606060;'>Published:</span> Jan 28, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In this article I'll teach you how to quickly find the server name for your cPanel account. The server name refers to the physical server that hosts your website files and is something good to know especially when your website hasn't gone live yet.</p>
<h2>Locate server name in cPanel</h2>
<ol class="article_list">
<li><a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel" target="”_blank”">Login to your cPanel</a>.</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/cpanel/find-server-name/click-on-expand-stats.png"><img src="//cdn.inmotionhosting.com/support/images/stories/cpanel/find-server-name/click-on-expand-stats.png" alt="click on expand stats"  style="width: 160px; margin-left: 10px; position: relative; bottom: 15px; float: right;" /></a>Under the <strong>Stats</strong> section on the left, click on <strong>expand stats</strong></li>
<li style="clear: both;"><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/cpanel/find-server-name/view-server-name.png"><img src="//cdn.inmotionhosting.com/support/images/stories/cpanel/find-server-name/view-server-name.png" alt="view server name"  style="width: 160px; margin-left: 10px; position: relative; bottom: 15px; float: right;" /></a>Scroll down till your see the <strong>Server Name</strong> field, in this case we can see our server name is <strong>biz104</strong></li>
<li style="clear: both;">Now that you know your server name you can use it in the following format for example to access your site over the temporary URL:
<p class="code_block" style="width: 500px;">http://biz104.inmotionhosting.com/~userna5</p>
<p>Or if you were trying to access your shared SSL certificate you can do this by replacing the <strong>biz</strong> part of the server name with <strong>secure</strong>which would end up looking like this:</p>
<p class="code_block" style="width: 500px;">https://secure104.inmotionhosting.com/~userna5</p>
</li>
</ol>
<p>You should now know how to find the server name in cPanel for your account, so in case you need to access the server and your domain name isn't pointed to the server you can still access the server.</p> 
...
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/cpanel/find-server-name-in-cpanel'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD01NyZpZD01MjUmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/dns-nameserver-changes/dns-max-speed-zone?tsrc=rsbraq'>DNS &amp; Max Speed Zone</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/file-management/cannot-use-ftp-with-cpanel-credentials-for-alexartloftorg?tsrc=rsbraq'>Cannot use FTP with cpanel credentials for alexartloft.org</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/382d82902e711847f3799cf0b083c36d?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/382d82902e711847f3799cf0b083c36d'>Joyce Cunha</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-26 11:33 am</div>
				                <div><p>My website is down. www.*******.com</p>
<p>my current available email is: ***********@gmail.com please advise if you guys can fix it.</p>
<p>thanks</p>
<p>Joyce ************</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12026);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-26 11:50 am</div>
				                <div>Hello Joyce,<br />
<br />
Thank you for contacting us. Since this is a public forum, I have marked out your personal information for security purposes.<br />
<br />
I recommend contacting <a href="http://www.inmotionhosting.com/contact" >Live Tech Support</a>, so you can provide account specific information, and we can further assist you.<br />
<br />
If you have any further questions, feel free to post them below.<br />
Thank you,<br />
<br />
-John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12027);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-18513'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/b5f32b4305bcb9eb7ba17d4e0f45e5aa?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/b5f32b4305bcb9eb7ba17d4e0f45e5aa'>Shane P.</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-15 12:05 pm</div>
				                <div>This article does the job, and well. The only thing I would add are links to different articles that show ways of finding your server name that isn't through cPanel. Maybe with Godaddy, WP Engine, Amazon, or even a cut and paste PHP solution.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(18513);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						...
						<div><a style='font-size:16px;' href='/support/community-support/users/otakei'>otakei</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-01 10:18 pm</div>
				                <div>Hello,I cannot view cpanel from your AMP.<br />
<br />
Browser : chrome 40.0.2214.94 m<br />
Errer:ERR_CONNECTION_ABORTED<br />
<br />
Do you need some account information?<br />
Thank you.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20233);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
...
Arnel C.<br />
						...
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20250);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
