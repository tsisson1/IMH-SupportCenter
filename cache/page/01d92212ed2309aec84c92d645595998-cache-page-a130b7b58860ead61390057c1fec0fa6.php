<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50003:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/file-management/cannot-connect-to-ftp-server" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello jiafeng, Thank you for the connection information above, it was very helpful. The issue is the port. Our shared servers require SSH access for the..." />
  <title>cannot connect to ftp server | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/file-management/cannot-connect-to-ftp-server" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:c02820dca1a3f5782025e733bfd7c565 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '81.61.136.56']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>cannot connect to ftp server</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/jiafeng'>jiafeng</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-07-11 3:43 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>1,677</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I used filezilla to connect but failed every time. What should I do?<br />
<br />
Status:	Connecting to ftp.ricefilm.com...<br />
Response:	fzSftp started<br />
Command:	open &quot;jiafeng@ricefilm.com@ftp.ricefilm.com&quot; 22<br />
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_1278' id='upvote_answer_1278' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='1278' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_1278').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_1278' id='downvote_answer_1278' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='1278' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_1278').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello jiafeng,<br />
<br />
Thank you for the connection information above, it was very helpful. The issue is the port. Our shared servers require SSH access for the use of port 22 and SFTP. SSH access is not available for our shared server accounts. <br />
<br />
I do have an article here on <a href="http://www.inmotionhosting.com/support/website/file-management/securely-connecting-your-website-using-ftp">how to securely connect to FTP</a> on a shared server. This will get you set up properly and still be secure.<br />
<br />
...
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_1278').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_1278' id='form_comment_on_answer_1278' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/file-management/cannot-connect-to-ftp-server&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/file-management/cannot-connect-to-ftp-server'></div>
<script type='text/javascript'>
  (function() {
