<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50244:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-3/article-options" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="keywords" content="joomla 3.0 article options" />
  <meta name="description" content="In the following set of tutorials, we'll review the various options that you can configure that control how articles are displayed in Joomla 3.0" />
  <title>103: Configuring Article Options in Joomla 3 | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-3/article-options" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:feb16d080e9afd92d022b1615cd3fa7e -->
...
<div class='page-header'>
	<h1>103: Configuring Article Options in Joomla 3</h1>
</div>
<div class='section_listing'>
		...
		<tr>
				...
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-3/article-options/show-title'>How to Hide Article Titles in Joomla 3.1</a>
					<div>In this tutorial, we'll show you how to hide article titles in Joomla 3.0</div>
					<div class='smallgrey'>Hits: 16,815</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-3/article-options/linked-titles'>How to Disabled Linked Titles in Joomla 3.1</a>
					<div>When looking at articles in Joomla 3.0, the default setting has the article title set as a link back to the article itself. In this tutorial, we'll show you how to toggle this link setting.</div>
					<div class='smallgrey'>Hits: 5,084</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-3/article-options/hide-category'>How to Hide Article Categories in Joomla 3.1</a>
					<div>Joomla 3.0 gives you the option of whether or not to display the category an article belongs to. This setting is referred to as SHOW CATEGORY, and we'll cover it more in this tutorial.</div>
					<div class='smallgrey'>Hits: 8,204</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-3/article-options/link-category'>How to Disable Linked Categories in Joomla 3.1</a>
					<div>When you view an article in Joomla 3.0, the default behavior is to link to the category the article belongs to. You can turn off this feature in Joomla 3.0, and in this tutorial we'll show you how using the LINK CATEGORY setting.</div>
			...
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-3/article-options/show-parent-category'>How to Show Parent Categories for Articles in Joomla 3.1</a>
					<div>Within Joomla 3.0, you have the option to show or hide the parent categories of the category your article belongs to. We'll show you how this feature works in this tutorial.</div>
					<div class='smallgrey'>Hits: 5,083</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-3/article-options/link-parent'>Using the Link Parent setting in Joomla 3.1</a>
					<div>If you followed our previous tutorial on showing parent categories, we'll now show you how to link to those parent categories.</div>
					<div class='smallgrey'>Hits: 2,331</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-3/article-options/show-author'>How to hide the Article Author in Joomla 3.1</a>
					<div>In this tutorial, we'll show you how to hide an Article's Author in Joomla 3.0 using the Show Author setting.</div>
					<div class='smallgrey'>Hits: 4,733</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-3/article-options/show-create-date'>How to Show Create Date for Articles in Joomla 3.1</a>
					<div>If you want to show the date an article was created within Joomla 3.0, you can use the Show Create Date setting to toggle this feature.</div>
					<div class='smallgrey'>Hits: 4,045</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-3/article-options/show-modify-date'>How to Show Last Modify Date for articles in Joomla 3.1</a>
					<div>You have the option to show users the last time an Article was updated in Joomla 3.0 using the Show Last Modify setting. In this tutorial, we'll show you how to toggle this setting.</div>
					<div class='smallgrey'>Hits: 4,287</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-3/article-options/show-publish-date'>How to hide when an Article was Published in Joomla 3.1</a>
					<div>If you don't want to show users the date an article was Published in Joomla 3.0, you can use the Show Publish Date setting to toggle this option.</div>
					<div class='smallgrey'>Hits: 3,345</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-3/article-options/show-navigation'>How to hide Prev and Next Navigation buttons in Joomla 3.1 articles</a>
					<div>When you have several articles in a category, Joomla 3.0 will show previous and next buttons to help users navigate. In this tutorial, we'll show you how to hide these buttons using the Show Navigation setting.</div>
					<div class='smallgrey'>Hits: 21,289</div>
				</td>
			</tr>
			</table>
</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNjAmaWQ9MjYwJnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
