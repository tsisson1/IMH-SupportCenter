<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:51005:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/moodle/new-to-moodle" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="keywords" content="Welcome to Moodle 101, our set of tutorials designed to help you install and get started with using Moodle." />
  <meta name="description" content="Welcome to Moodle 101, our set of tutorials designed to help you install and get started with using Moodle." />
  <title>101: Getting Started with Moodle | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/moodle/new-to-moodle" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:72074248145be390fcc5984074d8befc -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '125.63.79.94']);
...
<div class='page-header'>
	<h1>101: Getting Started with Moodle</h1>
</div>
<div class='section_listing'>
		...
		<tr>
				...
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/new-to-moodle/getting-started-guide-moodle'>Getting Started Guide: Moodle</a>
					<div>In this article we will introduce you to Moodle, a course management system or a virtual learning environment.</div>
					<div class='smallgrey'>Hits: 6,153</div>
				</td>
			</tr>
		<tr><td colspan='3' style='padding-top:20px;'><h2>Installing and Logging in</h2><div>This section will explain how to install and  log in to Moodle 2.3.</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 2:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/new-to-moodle/install-moodle-softaculous'>Installing Moodle with Softaculous</a>
					<div>Moodle 2.3 can be installed through Softaculous with little effort. This article will explain how to install Moodle through the cPanel Softaculous application.</div>
					<div class='smallgrey'>Hits: 4,096</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-bottom:10px;'>
					...
					<div>This tutorial explains the steps for logging into the Moodle Dashboard.</div>
					<div class='smallgrey'>Hits: 31,641</div>
				</td>
			</tr>
		<tr><td colspan='3' style='padding-top:20px;'><h2>Resetting your Moodle Password</h2><div>If you've forgotten your Moodle password, the following articles will help based upon your current scenario.</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 4:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/new-to-moodle/forgot-moodle-username-password'> I forgot / How to reset Moodle 2.3 username or password</a>
					<div>This tutorial will explain the process for recovering or resetting the username and password for Moodle 2..2</div>
					<div class='smallgrey'>Hits: 6,698</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/new-to-moodle/change-username-password-moodle'>How to change the Username and Password in Moodle</a>
					<div>To change the username and/or password for your Moodle Login, you can log in the Moodle Dashboard and change it in the Admin Profile.</div>
					<div class='smallgrey'>Hits: 14,628</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-bottom:10px;'>
					...
					<div>Forgot your Moodle username or password and the forgot password link is not sending the email for the login credentials. This will show how to change the password in PhpMyAdmin.</div>
					<div class='smallgrey'>Hits: 32,207</div>
				</td>
			</tr>
		<tr><td colspan='3' style='padding-top:20px;'><h2>Front Page Settings</h2><div>This section will discuss updating, editing and changing the home page in Moodle 2.3.</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 7:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/new-to-moodle/edit-front-page-settings'>How to edit the Front page settings in Moodle</a>
					<div>This tutorial will focus on editing the Moodle 2.3 Front page settings. </div>
					<div class='smallgrey'>Hits: 5,433</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/new-to-moodle/edit-frontpage-summary'>Editing the summary on the Moodle Frontpage</a>
					<div>By default, Moodle has no text on the frontpage summary. This tutorial will explain how to add content to the Moodle 2.3 Frontpage.</div>
					<div class='smallgrey'>Hits: 2,254</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/new-to-moodle/inset-iframe-frontpage'>Inserting an iframe in the Moodle Frontpage</a>
					<div>Moodle 2.3 has the capability of not only editing the Frontpage with a WYSIWYG editor, but adding code to the page itself. This tutorial will explain how to add an iframe to the Moodle Frontpage.</div>
					<div class='smallgrey'>Hits: 4,842</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/new-to-moodle/question-bank'>Managing the Moodle question bank</a>
					<div>This tutorial will briefly explain the Moodle 2.3 Question Bank and what it is used for.</div>
					<div class='smallgrey'>Hits: 2,487</div>
				</td>
			</tr>
		<tr><td colspan='3' style='padding-top:20px;'><h2>Backup & Restore</h2></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 11:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/new-to-moodle/backup-moodle'>Creating a Backup of Moodle</a>
					<div>Moodle has its own back up feature where the site can be backed up through the Moodle dashboard. The following article will outline the process of backing up Moodle through the Moodle Dashboard.</div>
					<div class='smallgrey'>Hits: 6,162</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/new-to-moodle/restoring-moodle-backup'>Restoring Moodle from a backup</a>
					<div>Once the backup is created through the Moodle Dashboard, like what was outlined in the Creating a backup of Moodle tutorial, the backup can be restored through the Moodle Dashboard. This article will demonstrate how to import or restore the backup created by the Moodle dashboard.</div>
					<div class='smallgrey'>Hits: 2,649</div>
				</td>
			</tr>
		<tr><td colspan='3' style='padding-top:20px;'><h2>My Profile Settings</h2><div>The My Profile Settings are available in Moodle 2.3 for editing and adding information to the users profile. The following tutorials will focus on the "My Profile settings" in the Moodle Settings section. </div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 13:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/new-to-moodle/edit-profile'>Editing the User profile in the My Profile Settings of Moodle</a>
					<div>Users can edit their profiles within the My profile settings of the Settings section in Moodle 2.3. This tutorial will briefly explain the User profile settings.</div>
					<div class='smallgrey'>Hits: 2,723</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/new-to-moodle/user-messaging'>Configuring notification methods for incoming messages in Moodle</a>
					<div>Moodle 2.3 has the capability to message users when certain actions occur on the site. This article will discuss how to configure the incoming message notification methods.</div>
					<div class='smallgrey'>Hits: 6,185</div>
				</td>
			</tr>
		<tr><td colspan='3' style='padding-top:20px;'><h2>Configuring Languages</h2><div>Moodle 2.3 has the ability to incorporate multiple Languages. This section will explain how to change the Language settings in Moodle.</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 15:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/new-to-moodle/language-pack'>Installing a Language pack in Moodle</a>
					<div>Moodle includes a vast array of Language packs that can be installed or removed, allowing the site to be viewed in multiple languages. This article will focus on installing a language pack for Spanish in Moodle 2.3.</div>
					<div class='smallgrey'>Hits: 3,400</div>
				</td>
			</tr>
			</table>
</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNzQmaWQ9Mjc0JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="858d1560bf4a25194fd9553374619f15" value="1" />	</div>
	</form>
<!-- <br />
