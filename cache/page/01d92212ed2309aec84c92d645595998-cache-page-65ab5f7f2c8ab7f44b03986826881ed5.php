...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/databases/magento-frequent-error2006-mysql-server-has-gone-away" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, Thank you for contacting us about the Magento error concerning MySQL &quot;server has gone away&quot;. There are many different factors that can cause this..." />
  <title>Magento frequent error&quot;2006 MySQL server has gone away...&quot; | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/databases/magento-frequent-error2006-mysql-server-has-gone-away" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:b361ae9fda3d8b3dfcbbb0102930e1f4 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Magento frequent error&quot;2006 MySQL server has gone away...&quot;</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2016-04-11 10:12 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>24</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Hello,<br />
I'm ready to upgrade my site,, the new website uses &quot;Magento 1.9.2.2&quot; System?But in the test often this error &quot;SQL state [HY000]: general error: 2006 MySQL server has gone away...&quot;, My site is not much data, I did all I could do to optimize, But the problem still exists. Please help me, I was troubled by this problem for a long time.</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_9676' id='upvote_answer_9676' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='9676' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_9676').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_9676' id='downvote_answer_9676' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='9676' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_9676').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					<img src='https://lh3.googleusercontent.com/-AmEnso4E7cE/AAAAAAAAAAI/AAAAAAAAAB8/-OBGtrb_6VM/s90-p-rw-no/photo.jpg' class='user_avatar' style='max-width:60px;' /><br />
                		        <a href='/support/community-support/users/christopherm'>christopherm</a>
				...
				Hello,<br />
<br />
Thank you for contacting us about the Magento error concerning MySQL "server has gone away".  There are many different factors that can cause this error. It is a very general error. However, there is some <a href="http://dev.mysql.com/doc/refman/5.5/en/gone-away.html" rel="nofollow">MySQL documentation</a> that may be helpful to you.<br />
<br />
If you are uncertain of how to proceed you can submit a request for a server review to our <a href="http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support#submit-ticket">Live Support</a>.<br />
<br />
Best,<br />
Christopher M. 
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_9676').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_9676' id='form_comment_on_answer_9676' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/databases/magento-frequent-error2006-mysql-server-has-gone-away&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/databases/magento-frequent-error2006-mysql-server-has-gone-away'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="c905f13c23e93f25ad8aa6bad100fba7" value="1" />	</div>
	</form>
<!-- <br />
