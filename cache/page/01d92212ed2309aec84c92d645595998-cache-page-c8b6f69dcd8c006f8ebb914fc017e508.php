<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:60587:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/drupal-7/views-module-tutorial/create-view" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-07-27T13:26:18-07:00" />
  <meta name="keywords" content="create view Drupal 7 module" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="This article kicks off the Views module course by walking you through creating your very first view." />
  <title>Creating your first View in Drupal 7 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/drupal-7/views-module-tutorial/create-view" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:904953f7508c3c38945bd29a4a626c9d -->
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
				<img src='/support/images/stories/drupal-partner/supporting-partner-80_3.png' style='float:right; margin:0px 0px 15px 15px;' alt='Drupal Association Support Partner'>		<h1>
															Creating your first View in Drupal 7									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>23,139</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jul 26, 2012'><span style='color:#606060;'>Published:</span> Jul 27, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>This article will guide you in creating a very basic view in Drupal 7. Views can be used to create very complex lists, but as we are just learning, we will be walking through the basic steps. This is designed to give you some familiarity to the Views module and make it a bit less daunting as it may first seem. In this example, we will be creating a view to display articles on a page, much like a blog index. To get started with creating a view in Drupal 7, simply follow the steps below.</p>
<p><strong>Creating a View in Drupal 7</strong></p>
...
<li>You have now entered the <strong>Views </strong>module screen. To create a new View, simply find and click on the <strong>Add New View</strong> link.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Views/new-view.png"><img  alt="new-view" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Views/new-view.png" /></a></li>
<li>From this page, we will set up our view. First we have to name the View, this required. We next set it to show the content type of Article. We ensure the Create a Page is selected to show the list as an independent page. Page Title and Path fill in based on the title, but they are adjustable. I keep the default settings for the formatting and move on to check the Create a Menu Link option so the page shows in the main menu. Just under that is a dropdown to select the type of menu you want to add it to from the <strong>Menu</strong> dropdown. We want <em>Main Menu</em> for this View.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Views/add-new-view.png"><img  alt="add-new-view" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Views/add-new-view.png" /></a></li>
<li>Once finished, scroll to the bottom and select the <strong>Save and Exit</strong> button. Now you can see your new view page from the main menu. Below is a screenshot of the view we just created.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Views/new-view-sample.png"><img  alt="new-view-sample" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Views/new-view-sample.png" /></a></li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 2: Creating your first View in Drupal 7</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 1: <a href='/support/edu/drupal-7/views-module-tutorial/views-intro'>Introduction to Views in Drupal 7</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/drupal-7/views-module-tutorial/create-view&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/drupal-7/views-module-tutorial/create-view'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNDUmaWQ9MTYyNyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="443a5fa66ae9229bbe17b1268a3cc41e" value="1" />	</div>
	</form>
<!-- <br />
