<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:73233:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.info/support/website/security/protect-data-fix-openssl-heartbleed-bug" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-04-10T20:28:47-07:00" />
  <meta name="keywords" content="openssl heartbleed heart bleed heartbeat heart beat secure security SSL TLS TDLS support vulnerable vulnerability insecure patch check test" />
  ...
  <link href="http://www.inmotionhosting.com/support/website/security/protect-data-fix-openssl-heartbleed-bug" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:e220ac9cb7421446e0f6388f87a1af64 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-22']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '54.172.201.205']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Protect your data and fix OpenSSL Heartbleed bug</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Protect your data and fix OpenSSL Heartbleed bug									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>3,264</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Apr 9, 2014'><span style='color:#606060;'>Published:</span> Apr 10, 2014</div>
  ...
  <h2>Navigation:</h2>
  <button type="button" class="btn btn-primary" onclick="window.location.hash='openssl-disclosure';">OpenSSL vulnerability disclosure</button>
  <button type="button" class="btn btn-primary" onclick="window.location.hash='check-for-heartbleed-bug';">Check for Heartbleed bug</button>
  <button type="button" class="btn btn-primary" onclick="window.location.hash='security-risks';">Security risks</button>
</div>

<div style="width: 49%; float: left; margin: 10px 0px 0px 0px;"><p>On April 7th, 2014, a very alarming security flaw was exposed in multiple versions of <span style="color: red;">OpenSSL 1.0.1 - 1.0.1f</span>.</p><p>OpenSSL is the open source software responsible for implementing SSL and TLS encryption and decryption for a large number of websites on the Internet.</p>
...
<div style="float: right;">
  <img src="//cdn.inmotionhosting.com/support/images/stories/website/security/openssl-heartbleed/heartbleed-logo.png" alt="openssl heartbleed logo">
</div>
...
<div class="alert alert-success">
  ...
  <p>We released a news update about the <a href="http://www.inmotionhosting.com/support/news/general/heartbleed-0-day-openssl-security-bug" target="_blank">Heartbleed 0-day exploit</a> when we first found out about this issue.</p>
</div>

<a name="openssl-disclosure"></a>
<h2>Offical OpenSSL vulnerability disclosure</h2>

<p>The official <span style="color: red;">CVE</span> or <span style="color: red;">Common Vulnerabilities and Exposures</span> notice, is <a href="http://web.nvd.nist.gov/view/vuln/detail?vulnId=CVE-2014-0160" target="_blank">CVE-2014-0160</a> for this OpenSSL exploit.</p>

<p>This is a <a href="http://cwe.mitre.org/data/definitions/119.html" target="_blank">memory buffer</a> exploit, and it was reported on the <a href="https://www.openssl.org/news/vulnerabilities.html#2014-0160" target="_blank">OpenSSL website</a> affecting versions <span style="color: red;">1.0.1 - 1.0.1f</span>.</p>

<button class="btn btn-success collapsed" data-toggle="collapse" data-target="#viewdetails" style="width: 100%; box-shadow: 4px 4px 6px #000;">Click Here To Expand OpenSSL disclosure</button>
...
A missing bounds check in the handling of the TLS heartbeat extension can be used to reveal up to 64kB of memory to a connected client or server. This issue did not affect versions of OpenSSL prior to 1.0.1.<br><br>
Fixed in OpenSSL 1.0.1g (Affected 1.0.1f, 1.0.1e, 1.0.1d, 1.0.1c, 1.0.1b, 1.0.1a, 1.0.1)</em></p>
...
<a name="check-for-heartbleed-bug"></a>
<h2>Checking for OpenSSL Heartbleed bug</h2>

<p>It's important to point out that OpenSSL itself is not vulnerable. Only the <span style="color: red;">Heartbeat</span> feature, developed back in <span style="color: red;">December of 2011</span>, and then released in the <a href="http://www.openssl.org/news/openssl-1.0.1-notes.html" target="_blank">OpenSSL 1.0.1 release branch</a> on <span style="color: red;">March 14th 2012</span> introduced the bug.</p>

<button class="btn btn-success collapsed" data-toggle="collapse" data-target="#viewdetails2" style="width: 100%; box-shadow: 4px 4px 6px #000;">Click Here To Expand Checking For The Heartbleed bug</button>
...
<pre class="cli" style="width: 125px; float: right; margin: -10px 20px 0px 0px;">&lt;?php
phpinfo();
?&gt;</pre>

<p style="clear: both;">Access that script at <span style="color: red;">http://example.com/info.php</span>, then in your browser hit <strong>Ctrl-F</strong> and search for <strong>openssl</strong>:</p>

<img style="display: block; margin: auto; margin-bottom: 10px;" src="//cdn.inmotionhosting.com/support/images/stories/website/security/openssl-heartbleed/checking-openssl-version-in-phpinfo.png" alt="check openssl version for heartbleed bug">
...
<p>You need to have <a href="http://www.inmotionhosting.com/support/edu/whm/intro-to-web-hosting/standard-vs-root-access" target="_blank">root access</a> on your server to check the OpenSSL changelog for applied patches.</p>
...
<pre class="cli" style="margin-bottom: 10px;">openssl-1.0.1e-16.el6_5.7.x86_64
* <span style="color: red;">Mon Apr 07 2014</span> TomÃ¡Å¡ MrÃ¡z &lt;tmraz@redhat.com&gt; 1.0.1e-16.7
<span style="color: red;">- fix CVE-2014-0160 - information disclosure in TLS heartbeat extension</span>

* Tue Jan 07 2014 TomÃ¡Å¡ MrÃ¡z &lt;tmraz@redhat.com&gt; 1.0.1e-16.4
- fix CVE-2013-4353 - Invalid TLS handshake crash</pre>
...
<button class="btn btn-success collapsed" data-toggle="collapse" data-target="#viewdetails3" style="width: 100%; box-shadow: 4px 4px 6px #000;">Click Here To Expand Further Security Advice</button>
...
<div class="collapse-group">
  ...
  <p>There has been a list of sites that were affected by the Heartbleed bug put together by Mashable in their <a href="http://mashable.com/2014/04/09/heartbleed-bug-websites-affected/" target="_blank">Heartbleed hitlist</a>. Some big players like FaceBook, Instagram, Pinterest, Tumblr, Google, Yahoo, DropBox, OKCupid, SoundCloud, and more could have been affected.</p>

  <p class="alert alert-danger">It's highly recomended due to the possibly security implications of this exploit that all Internet users update all of their online account passwords. You should consider using a <a href="http://www.inmotionhosting.com/support/website/security/password-strength" target="_blank">strong password</a> for all of your accounts, and possibly storing them in a secure password safe.</p>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.info/support/website/security/protect-data-fix-openssl-heartbleed-bug&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.info/support/website/security/protect-data-fix-openssl-heartbleed-bug'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NDUmaWQ9MzE5NiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/43b2a1890479fb7d50b8f3206fa6ed38?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/43b2a1890479fb7d50b8f3206fa6ed38'>Michael Prewitt</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-21 11:08 am</div>
				                <div><p>The website&nbsp;http://filippo.io/Heartbleed/ which is a commonly used tool for checking for the Heartbleed bug, was reporting our site as "vulnerable". This was after InMotion applied their patch, etc. It was not until I manually restarted Apache and SSH on my server that filippo.io said the issue was "fixed" on our site. Just an FYI to others who might have the same issue.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9940);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-21 11:19 am</div>
				                <div>Hello Michael,<br />
<br />
Thank you for your comment. You are correct, at times it does  require an Apache service reset. We will ensure that information is included.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9941);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-10081'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/bace3be3b543d65504280dfee3541cd7?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/bace3be3b543d65504280dfee3541cd7'>Mikael</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-23 12:28 pm</div>
				                <div><p>totally agree, this needs to be mentioned, Apache restart worked for me too ! thanks inmotion !</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10081);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
