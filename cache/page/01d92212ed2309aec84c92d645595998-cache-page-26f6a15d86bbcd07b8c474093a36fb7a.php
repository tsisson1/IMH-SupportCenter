...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/email/email-client-setup/configure-iphone6-email" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-04-01T02:11:12-07:00" />
  <meta name="author" content="Arnel Custodio" />
  <meta name="description" content="Familiarizes you with the iPhone 6 email client so that you can set it up to receive and send email" />
  <title>Configuring your iPhone 6 for Email - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/email/email-client-setup/configure-iphone6-email" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:79872272f3d6e0845d77d0551f7aa9ef -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Configuring your iPhone 6 for Email									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='clear:both;'></div>
								...
								<p>Email setup on your iPhone 6 can appear to be a difficult task, but it's actually a simple process.  This tutorial will walk you through the process of configuring email on your iPhone 6.</p>
...
<h2>How to Configure iPhone 6 for Email</h2>
<ol class="article_list">

<li>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/iphone6-email/iphone6-email-start.png"><img style= "float:right; margin: 0px 0px 15px 15px;"  alt="iphone6 start screen" src="//cdn.inmotionhosting.com/support/images/stories/iphone6-email/iphone6-email-start.png" width="" align="right"/></a>

<p>Unlock your iPhone 6 so that you can see the icons on the screen.</p> 
<div style="clear:both;"></div>
</li>

<li>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/iphone6-email/iphone6-email-start.png"><img style= "float: right; margin: 0px 0px 15px 15px;"  alt="iphone6 start screen" src="//cdn.inmotionhosting.com/support/images/stories/iphone6-email/iphone6-email-start.png" width="" align="right"/></a>
  <p>Look for your <b>Settings</b> icon.  Click on it to start.</p>
<div style="clear:both;"></div>
</li>

<li>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/iphone6-email/mail-icon-settings.png"><img style= "float: right; margin: 0px 0px 15px 15px;"  alt="Change mail settings" src="//cdn.inmotionhosting.com/support/images/stories/iphone6-email/mail-icon-settings.png" width="" align="right"/></a>

  <p>Look for the icon labeled <i>Mail,Contacts, Calendars</i>.</p>
  <div style="clear:both;"></div>
...
<li>
  ...
  <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/iphone6-email/mail-menu.png"><img style= "float: right; margin: 0px 0px 15px 15px;"  alt="Add account" src="//cdn.inmotionhosting.com/support/images/stories/iphone6-email/mail-menu.png" width="" align="right"/></a>
  <p>Next, click on <b>Add Account</b>.  It will be near the top of the screen in the section labeled "<i>Accounts</i>".</p>
  <div style="clear:both;"></div>
</li>

<li>
    <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/iphone6-email/mail-menu.png"><img style= "float: right; margin: 0px 0px 15px 15px;"  alt="Add account" src="//cdn.inmotionhosting.com/support/images/stories/iphone6-email/mail-menu.png" width="" align="right"/></a>
  <p>Choose <b>Other</b> in order to add a InMotion Hosting email account.</p>
  <div style="clear:both;"></div>
...
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/iphone6-email/add-other-options.png"><img style= "float: right; margin: 0px 0px 15px 15px;"  alt="Add account" src="//cdn.inmotionhosting.com/support/images/stories/iphone6-email/add-other-options.png" width="" align="right"/></a>

<p>Strangely, you will see yet another option that asks you to <b>Add Mail Account</b>.  Click on this option to proceed.</p>
<div style="clear:both;"></div>
</li>

<li>

<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/iphone6-email/new-mail-account-details.png"><img style= "float: right; margin: 0px 0px 15px 15px;"  alt="Add account" src="//cdn.inmotionhosting.com/support/images/stories/iphone6-email/new-mail-account-details.png" width="" align="right"/></a>

<p>You will then be asked to fill in the information for your email account. This includes your name, your email address, password and a description of the mail account.</p>
<div style="clear:both;"></div>

</li>

<li>
  <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/iphone6-email/mail-acct-server-details.png"><img style= "float: right; margin: 0px 0px 15px 15px;"  alt="Email server settings" src="//cdn.inmotionhosting.com/support/images/stories/iphone6-email/mail-acct-server-details.png" width="" align="right"/></a>

  <p>After you fill in your information, the next screen includes the settings for both the incoming and outgoing mail server.  Go here to find help with your <a href="http://www.inmotionhosting.com/support/edu/everything-email/introduction-email/how-to-find-email-settings">email settings</a>.  Use the settings in the mail article to fill in each section.  </p>
  <div style="clear:both;"></div>
...
<li>
  <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/iphone6-email/cannot-verify-1.png"><img style= "float: right; margin: 0px 0px 15px 15px;"  alt="Cannot verify warning" src="//cdn.inmotionhosting.com/support/images/stories/iphone6-email/cannot-verify-1.png" width="" align="right"/></a>

    <p>After you fill in each section for the incoming and outgoing server, your phone will attempt to verify the server. If you see this warning, please click on <b>Details</b>.  You will then see the details for the certificate in use.  Make sure to select to trust the certificate.  The certificate is a self-signed certificate used by email server.  The certificate information should show that it is coming from your mail server.  If it is, then click the options to trust the certificate and then your iPhone will be able to confirm the server.</p>
    <div style="clear:both;"></div>

</li>

<li>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/iphone6-email/save-screen.png"><img style= "float: right; margin: 0px 0px 15px 15px;"  alt="Save screen" src="//cdn.inmotionhosting.com/support/images/stories/iphone6-email/save-screen.png" width="" align="right"/></a>

  <p>You will briefly see a screen checking off everything for the email account followed by a screen which has sliders for enabling <b>Mail</b> and <b>Notes</b>.  At the top of the screen will be options to <b>Cancel</b> or <b>Save</b>.  Click on <b>Save</b> to proceed with adding your email account.  </p>
  <div style="clear:both;"></div>
</li>
</ol>
<br>
<p>Congratulations, you have completed the configuration of email for your iPhone 6!  Note that this applies to both IMAP or POP3 protocols.  When you have completed the email setup, return to the main screen of your iPhone and click on the Mail icon.  You will see the account in the <b>Mail-boxes</b> section listed by your email description. Here's how it looks on my iPhone 6:</p>  

<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/iphone6-email/see-added-accounts.png"><img  alt="Account setup complete" src="//cdn.inmotionhosting.com/support/images/stories/iphone6-email/see-added-accounts.png" width="" a/></a>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/email/email-client-setup/configure-iphone6-email&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/email/email-client-setup/configure-iphone6-email'></div>
	<script type='text/javascript'>
	  (function() {
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/email/my-iphone-5c-mail-is-not-downloading?tsrc=rsbraq'>My iPhone 5C mail is not downloading. </a>
                                </div>
...
<a name='comments'></a>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/01c93d015df28c4ba54d30174ba76b32?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/01c93d015df28c4ba54d30174ba76b32'>Tracie</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-13 12:16 pm</div>
				                <div><p>THANK YOU!!!!!!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29775);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-30331'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/a8e2ad94ebc0c2a6fb8387fdc3d20ff2?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/a8e2ad94ebc0c2a6fb8387fdc3d20ff2'>Tony Finch</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-02-04 9:09 am</div>
				                <div><p>When I try to add an email account to my iphone 6S I press SETTINGS but instead of seeing MAIL, CONTACTS, CALENDAR on the screen I only see details of my present email address with no way of adding another. &nbsp;How do reach the correct screen?</p>
<p>&nbsp;</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30331);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-02-04 1:17 pm</div>
				                <div>Hello Tony,<br />
<br />
Thank you for contacting us. I tested the steps on an iPhone 6s, and confirmed they are accurate.<br />
<br />
What version of ios are you running on your iPhone?<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30340);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-30472'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/676ef8c590133a7d0b041e748258855d?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/676ef8c590133a7d0b041e748258855d'>umesh sharma</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-02-11 5:42 am</div>
				                <div><p>Can we have different id for receiving and sending mails. Actually we create forward mail ids which are configured on iphone and desktop. so incomming is not a problem but while replying main id should be shown to recipient.</p>
<p>regards</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30472);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-02-11 3:23 pm</div>
				                <div>Hello umesh,<br />
<br />
Thank you for contactingus. You should reply from the specific address you want to use by authenticating with the username/password for that address.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30491);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-31948'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/3b3393236402b2ed1498612b77f2c3c3?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/3b3393236402b2ed1498612b77f2c3c3'>srikanth</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-15 4:30 am</div>
				                <div><p>HI,</p>
<p>Iam writing from Bangladesh, i use i phone 6s. my incoming is for my office mail is working fine, but out going is a problem.</p>
<p>the same settings on my ipad 3 and adroid are working, but on i phone 6s not working.</p>
<p>i have changed different servers like 587m465,25 and 26.. none of them are working.</p>
<p>where as my ipad is working fine .&nbsp;</p>
<p>breaking my head with no solution for 2 months.</p>
<p>can any one help pls.</p>
<p>dont give me basic answers like delete password, re enter password and all that.. i have done them enough number of times.</p>
<p>i need a real technical answer .. pl help if any one out there..</p>
<p>&nbsp;</p>
<p>regarsd</p>
<p>srikanth</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31948);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-15 10:27 am</div>
				                <div>Hello Srikanth,<br />
<br />
Is there an error when you try send an outbound email? With the outgoing mail server settings are you authenticating with the server? It is usually a hidden setting somewhere. Also you may want to <a href="http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support">contact our support team</a> if you host on our servers so we can view the logs when you try to send an outbound email.<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31960);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
