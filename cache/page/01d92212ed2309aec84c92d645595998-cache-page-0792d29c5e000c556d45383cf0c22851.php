<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:67326:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/wordpress/using-the-limit-login-attempts-wordpress-plugin" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-05-17T12:42:34-07:00" />
  <meta name="keywords" content="security securing wordpress plugin limit login attempts brute force cracker hacker" />
  <meta name="author" content="Tim Sisson" />
  <meta name="description" content="In this tutorial, we'll show you how to install and configure the WordPress plugin limit login attempts to help secure your WordPress dashboard. " />
  <title>Using the “Limit Login Attempts” WordPress Plugin - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/wordpress/using-the-limit-login-attempts-wordpress-plugin" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:646d61cae06a16395b447222721a3e74 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '131.96.253.27']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Using the “Limit Login Attempts” WordPress Plugin									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>15,330</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Feb 10, 2012'><span style='color:#606060;'>Published:</span> May 17, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Securing your WordPress site from hackers is extremely important to protect your website. One of the most common ways hackers gain access to WordPress is through brute force password cracking. Hackers use special tools to try multiple usernames and passwords to gain access to your WordPress dashboard. The easiest way to stop a hacker attempting to guess your username and password is to use a plugin that limits the number of login attempts.</p>
<p>In addition to using the “<strong>Limit Login Attempts</strong>” plugin we recommend changing your administrator username to something other than “<strong>Admin</strong>”. For more information on how to do this, please read our article on <a href="/support/website/wordpress/securing-wordpress-using-a-unique-administrative-username">using a WordPress username other than admin</a> for security reasons.</p>
<h2>Steps to installing the plugin:</h2>
...
<li>Go to Plugins in the left side menu pane</li>
<li>At the top of the screen click “<strong>Add New</strong>”</li>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/security/wp_limit_login_1.jpg"><img src="//cdn.inmotionhosting.com/support/images/stories/security/wp_limit_login_1.jpg" alt="wp_limit_login_1"  /></a></p>
<li>In the search bar type “<strong>limit login attempts</strong>”</li>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/security/wp_limit_login_2.jpg"><img src="//cdn.inmotionhosting.com/support/images/stories/security/wp_limit_login_2.jpg" alt="wp_limit_login_2"  /></a></p>
<li>The first results displayed should read “<strong>Limit Login Attempts</strong>”. Click “<strong>Install Now</strong>”</li>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/security/wp_limit_login_3.jpg"><img src="//cdn.inmotionhosting.com/support/images/stories/security/wp_limit_login_3.jpg" alt="wp_limit_login_3"  /></a></p>
<li>Click “<strong>Activate Plugin</strong>”</li>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/security/wp_limit_login_4.jpg"><img src="//cdn.inmotionhosting.com/support/images/stories/security/wp_limit_login_4.jpg" alt="wp_limit_login_4"  /></a></p>
</ol>
<h2>Configuring the plugin</h2>
<ol class="article_list">
<li>Go to <strong>Settings &gt; Limit Login Attempts</strong> in the WordPress Dashboard</li>
<li>Choose the settings you wish to use. In our example we’ve changed the default settings</li>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/security/wp_limit_login_5.jpg"><img src="//cdn.inmotionhosting.com/support/images/stories/security/wp_limit_login_5.jpg" alt="wp_limit_login_5"  /></a></p>
<li>Click “<strong>Change Options</strong>”</li>
<p>You’re now finished configuring the WordPress “<strong>Limit login Attempts</strong>” plugin. When someone reaches the limit you have set for failed login attempts they will see a message similar to the one below:</p>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/security/wp_limit_login_6.jpg"><img src="//cdn.inmotionhosting.com/support/images/stories/security/wp_limit_login_6.jpg" alt="wp_limit_login_6"  /></a></p>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/wordpress/using-the-limit-login-attempts-wordpress-plugin&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/wordpress/using-the-limit-login-attempts-wordpress-plugin'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD02MyZpZD0zNzImdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="9157f519ced9ad2f99aa1b64d4314fd0" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/98f3cae747278884a158e0b2d77a73bb?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/98f3cae747278884a158e0b2d77a73bb'>Elizabeth</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-07 3:00 pm</div>
				                <div><p>I did install the <strong>limit login attempts </strong>plugin the first time I experienced this issue, but 2 months later it is happening again... and no, my user name is not admin, it is an unusual name.<strong></strong></p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10480);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-07 3:10 pm</div>
				                <div>Hello Elizabeth,<br />
<br />
Sorry to hear that you're having problem with the WordPress login.  Due to brute force attacks on WordPress sites, mod security rules have been put in place that may affect your login.  There are some other steps that you can take that can help secure your site and also resolve the login issues.  Please review the <a href="http://www.inmotionhosting.com/support/news/general/wp-login-brute-force-attack#top-10">Top 10 steps to secure WordPress</a>.  If you continue to have issues with the login, please reply to this post with more details on the problem.  <br />
<br />
If you have any further questions or comments, please let us know. <br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10481);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
