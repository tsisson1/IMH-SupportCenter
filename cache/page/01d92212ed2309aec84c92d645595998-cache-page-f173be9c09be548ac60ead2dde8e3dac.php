<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:71607:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/tiki-wiki/getting-started-tiki-wiki/tiki-wiki-login-help" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-01-14T21:14:38-08:00" />
  <meta name="keywords" content="tiki tikiwiki wiki lost username user name password reset recover change" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="When you loose your TikiWiki admin login, the password, can be reset and you can also recover your username. This tutorial will explain how to change your Tiki password, reset the password, and recover the username of TikiWiki. " />
  <title>My TikiWIki login is not working - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/tiki-wiki/getting-started-tiki-wiki/tiki-wiki-login-help" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:6747d7a8034013804eb09e364a364ab7 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '84.210.190.108']);
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/tiki-wiki' itemprop='url'><span itemprop='title'>Tiki Wiki<span></a><div class='dropdown_4columns'><h2>Tiki Wiki Education Channel</h2><div class='col_2'><h3>100 Level Classes</h3><div><a href='/support/edu/tiki-wiki/getting-started-tiki-wiki'>101: Getting started with TikiWiki</a></div><div><a href='/support/edu/tiki-wiki/add-content-tikiwiki'>102: Adding content to TikiWIki</a></div><div><a href='/support/edu/tiki-wiki/change-appearance-tikiwiki'>103: Changing the appearance of TikiWiki</a></div><div><a href='/support/edu/tiki-wiki/configurint-forms-tikiwiki'>104: Configuring contact forms in TikiWiki</a></div></div><div class='col_2'><h3>200 Level Classes</h3><div><a href='/support/edu/tiki-wiki/create-menu-tikiwiki'>201: Creating menus in TikiWIki</a></div><div><a href='/support/edu/tiki-wiki/multi-lingual-setup-tiki'>202: Setting up a multilingual site in TikiWiki</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/tiki-wiki/getting-started-tiki-wiki' itemprop='url'><span itemprop='title'>101: Getting started with TikiWiki<span></a><div class='dropdown_3columns'><h2> Getting started with TikiWiki</h2><div class='col_3'><div>1. <a style='display:inline;' href='/support/edu/tiki-wiki/getting-started-tiki-wiki/tiki-wiki-overview'>TikiWiki overview</a></div><div>2. <a style='display:inline;' href='/support/edu/tiki-wiki/getting-started-tiki-wiki/installing-tikiwiki-softaculous'>Installing TikiWiki through Softaculous</a></div><div>3. <a style='display:inline;' href='/support/edu/tiki-wiki/getting-started-tiki-wiki/install-tikiwiki-manually'>Installing TikiWiki manually</a></div><div>4. <a style='display:inline;' href='/support/edu/tiki-wiki/getting-started-tiki-wiki/login-tikiwiki'>Logging into TikiWiki</a></div><div>5. <a style='display:inline;' href='/support/edu/tiki-wiki/getting-started-tiki-wiki/tiki-wiki-login-help'>My TikiWIki login is not working</a></div><div>6. <a style='display:inline;' href='/support/edu/tiki-wiki/getting-started-tiki-wiki/user-administration-tikiwiki'>User Administration in TikiWiki</a></div><div>7. <a style='display:inline;' href='/support/edu/tiki-wiki/getting-started-tiki-wiki/editing-permissions-anonymous'>Allow editing for the TikiWiki anonymous user</a></div><div>8. <a style='display:inline;' href='/support/edu/tiki-wiki/getting-started-tiki-wiki/upgrade-tikiwiki'>How to upgrade TikiWiki from 9.2 to 9.3</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>My TikiWIki login is not worki...</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															My TikiWIki login is not working									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>1,947</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 14, 2013'><span style='color:#606060;'>Published:</span> Jan 14, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In the previous article on <a target="_blank" title="Click here for info on logging into TikiWiki" href="/support/edu/tiki-wiki/getting-started-tiki-wiki/login-tikiwiki">logging into TikiWiki</a>, we learned how to log in. When administrating a TikiWIki site, you may want to rotate your passwords for security reasons this article will explain how chage your TikiWiki password.</p>
<p>If for whatever reason your TikiWiki username or password does not work, you can reset the password or recover the username to get your self logged it.&nbsp; This article will explain how to change and reset the admin password, and how to find and change the username and email address for your Tiki admin login through PhpMyAdmin.</p>
<h2>How do I change the Admin Password?</h2>
<p>For security reasons, its a good idea to rotate your TikiWiki passwords. The administrators password can be changed in the TikiWiki User Preferences. The following will explain the steps to change the TikiWiki password in the preferences of the User Information section.</p>
<ol class="article_list">
<li><a target="_blank" href="/support/edu/tiki-wiki/getting-started-tiki-wiki/login-tikiwiki" title="Click for more information">Log into TikiWiki</a></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/101/login-tikiwiki/admin-profile-pass-tikiwiki-1.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="admin-profile-pass-tikiwiki-1" src="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/101/login-tikiwiki/admin-profile-pass-tikiwiki-1.gif" title="Click here to view the larger image" width="100" /></a>Hover over the login Link and <strong>click your Admin username</strong>. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/101/login-tikiwiki/admin-profile-pass-tikiwiki-2.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="admin-profile-pass-tikiwiki-2" src="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/101/login-tikiwiki/admin-profile-pass-tikiwiki-2.gif" title="Click here to view the larger image" width="100" /></a><strong>Click Preferences</strong> on the User Information page.. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/101/login-tikiwiki/admin-profile-pass-tikiwiki-3.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="admin-profile-pass-tikiwiki-3" src="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/101/login-tikiwiki/admin-profile-pass-tikiwiki-3.gif" title="Click here to view the larger image" width="100" /></a>Type the New password twice and enter the current password.
<p><strong>Click Save.</strong></p>
<br style="clear: both;" />
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/101/login-tikiwiki/admin-profile-pass-tikiwiki-4.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="admin-profile-pass-tikiwiki-4" src="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/101/login-tikiwiki/admin-profile-pass-tikiwiki-4.gif" title="Click here to view the larger image" width="100" /></a>The page will display "<em>Password has been changed.</em>" Congratulations, the password was changed.</p>
<br style="clear: both;" /></li>
</ol>
<h2>How do I Reset the Admin password?</h2>
<p>This section will explain how to reset your TikiWiki password. If you forget your admin email and admin username, this section will also cover how to recover them in PhpMyAdmin.</p>
<h3>Using the "I forgot my password" link</h3>
<p>It the event you lose your TikiWiki password, TikiWiki has the "<em>I forgot my password</em>" link to reset the password. To use this, you will need to know the email address or username and you will need to have access to the email address in the administrators user preferences. The following details how to reset the admin password through the TikiWiki "<em>I forgot my password link</em>."</p>
<ol class="article_list">
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/101/login-tikiwiki/forgot-password-tikiwiki-1.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="forgot-password-tikiwiki-1" src="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/101/login-tikiwiki/forgot-password-tikiwiki-1.gif" title="Click here to view the larger image" width="100" /></a>Hover over the login link and <strong>click "I forgot my password."</strong><br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/101/login-tikiwiki/forgot-password-tikiwiki-2.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="forgot-password-tikiwiki-2" src="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/101/login-tikiwiki/forgot-password-tikiwiki-2.gif" title="Click here to view the larger image" width="100" /></a>Enter the Admin username or the email address in the admin profile.
<p><strong>Click Request Password Reset.</strong></p>
<p class="alert"><strong>Important!</strong> If you do not know your username and the email address for the admin, please <strong>click the I don't know my Admin Username or Email address</strong> lnk to the right to recover the username and email address.<br style="clear: both;" /></p>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/101/login-tikiwiki/forgot-password-tikiwiki-3.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="forgot-password-tikiwiki-3" src="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/101/login-tikiwiki/forgot-password-tikiwiki-3.gif" title="Click here to view the larger image" width="100" /></a>The site will display.</p>
<p style="margin-left: 20px;">"An email with a link to reset your password has been sent to the registered email address for admin. Please contact the Administrator if you do not get the email, or if there is an issue with resetting the password." <br style="clear: both;" /></p>
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/101/login-tikiwiki/forgot-password-tikiwiki-4.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="forgot-password-tikiwiki-4" src="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/101/login-tikiwiki/forgot-password-tikiwiki-4.gif" title="Click here to view the larger image" width="100" /></a><strong>Check your email.</strong>You should receive an email similar to the snapshot to the right.
<p><strong>Click link in the email</strong> to confirm the password reset.</p>
<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/101/login-tikiwiki/forgot-password-tikiwiki-5.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="forgot-password-tikiwiki-5" src="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/101/login-tikiwiki/forgot-password-tikiwiki-5.gif" title="Click here to view the larger image" width="100" /></a>The Browser will load the "<em>Change password enforced</em>" page.
<p><strong>Enter a new password and click Change.</strong></p>
<br style="clear: both;" /></li>
</ol>
<h3>I don't know my Admin Username or Email address</h3>
<p>If the "<em>I forgot my password</em>" reset link does not work or if you forgot the admin username or email address, the admin email address and username can be found in the database through PhpMyAdmin. These are the steps to recover the admin email address and admin username.</p>
<ol class="article_list">
<li><strong></strong><a target="_blank" title="Click here for how to log into cPanel" href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel"><strong>Log into cPanel</strong></a> and <strong>Navigate to the Databases</strong> &gt; <strong>PhpMyAdmin</strong>.</li>
<li><strong>Click the database</strong> on the left hand side in PhpMyAdmin.<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/101/login-tikiwiki/find-username-tikiwiki-1.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="find-username-tikiwiki-1" src="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/101/login-tikiwiki/find-username-tikiwiki-1.gif" title="Click here to view the larger image" width="100" /></a><strong>Scroll to</strong> the bottom where the <strong>users_users</strong> table is located. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/101/login-tikiwiki/find-username-tikiwiki-2.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="find-username-tikiwiki-2" src="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/101/login-tikiwiki/find-username-tikiwiki-2.gif" title="Click here to view the larger image" width="100" /></a>In the <strong>users_users</strong> table, you should see the row that contains the admin user information. The snapshot to the right shows where the email address and username are located in the database.<br style="clear: both;" /></li>
</ol>
<h3>Changing the Admin Password or Email in PhpMyAdmin</h3>
<p>If the "<em>I forgot my password</em>" fails to reset the password for your TikiWiki admin login because the email address is incorrect, the admin password and email address can be changed directly in PhpMyAdmin. The following steps will explain how to change the admin email address and the admin password through PhpMyAdmin.</p>
<ol class="article_list">
<li><strong></strong><a target="_blank" title="Click here for how to log into cPanel" href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel"><strong>Log into cPanel</strong></a> and <strong>Navigate to the Databases</strong> &gt; <strong>PhpMyAdmin</strong>.</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/101/login-tikiwiki/reset-pass-phpmyadmin-tikiwiki-1.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="reset-pass-phpmyadmin-tikiwiki-1" src="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/101/login-tikiwiki/reset-pass-phpmyadmin-tikiwiki-1.gif" title="Click here to view the larger image" width="100" /></a><strong>Select the users_users table</strong> on the left hand side.<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/101/login-tikiwiki/reset-pass-phpmyadmin-tikiwiki-2.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="reset-pass-phpmyadmin-tikiwiki-2" src="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/101/login-tikiwiki/reset-pass-phpmyadmin-tikiwiki-2.gif" title="Click here to view the larger image" width="100" /></a><strong>Click Edit</strong> next to thee row for the user you want to change the email for.<br style="clear: both;" />
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/101/login-tikiwiki/reset-pass-phpmyadmin-tikiwiki-3.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="reset-pass-phpmyadmin-tikiwiki-3" src="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/101/login-tikiwiki/reset-pass-phpmyadmin-tikiwiki-3.gif" title="Click here to view the larger image" width="100" /></a><strong>To change the email:</strong></p>
<div style="margin-left: 20px;">
<p>Find the <strong>email</strong> column and enter a new email address.</p>
<p><strong>Click Go.</strong><br style="clear: both;" /></p>
</div>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/101/login-tikiwiki/reset-pass-phpmyadmin-tikiwiki-4.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="reset-pass-phpmyadmin-tikiwiki-4" src="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/101/login-tikiwiki/reset-pass-phpmyadmin-tikiwiki-4.gif" title="Click here to view the larger image" width="100" /></a><strong>To Change the Password:</strong></p>
<div style="margin-left: 20px;">
<p>Find the <strong>hash</strong> Field in the users table.</p>
<p><strong>Enter a new password</strong>.</p>
<p><strong>Select MD5</strong> from the drop box</p>
<p><strong>Click Go.</strong></p>
</div>
<p>Now the email address and password is changed.</p>
<br style="clear: both;" /></li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/tiki-wiki/getting-started-tiki-wiki'>101: Getting started with TikiWiki</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 5: My TikiWIki login is not working</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 4: <a href='/support/edu/tiki-wiki/getting-started-tiki-wiki/login-tikiwiki'>Logging into TikiWiki</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 6: <a href='/support/edu/tiki-wiki/getting-started-tiki-wiki/user-administration-tikiwiki'>User Administration in TikiWiki</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/tiki-wiki/getting-started-tiki-wiki/tiki-wiki-login-help&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/tiki-wiki/getting-started-tiki-wiki/tiki-wiki-login-help'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMDUmaWQ9MjE3NSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="0e2b6101271eb73690e2562888d88b98" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/tiki-wiki/getting-started-tiki-wiki?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Getting started with TikiWiki</h3></a>
		<table><tr><td colspan='2'><h4>TikiWiki Overview</h4></td></tr>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/tiki-wiki/getting-started-tiki-wiki/tiki-wiki-overview?tsrc=rsbedu'>TikiWiki overview</a></td>
                </tr>
        <tr><td colspan='2'><h4>TikiWiki Installation</h4></td></tr>  <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/tiki-wiki/getting-started-tiki-wiki/installing-tikiwiki-softaculous?tsrc=rsbedu'>Installing TikiWiki through Softaculous</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/tiki-wiki/getting-started-tiki-wiki/install-tikiwiki-manually?tsrc=rsbedu'>Installing TikiWiki manually</a></td>
                </tr>
        <tr><td colspan='2'><h4>Logging in and managing Tiki users</h4></td></tr>  <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/tiki-wiki/getting-started-tiki-wiki/login-tikiwiki?tsrc=rsbedu'>Logging into TikiWiki</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/tiki-wiki/getting-started-tiki-wiki/tiki-wiki-login-help?tsrc=rsbedu'>My TikiWIki login is not working</a></td>
                </tr>
          <tr >
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/tiki-wiki/getting-started-tiki-wiki/user-administration-tikiwiki?tsrc=rsbedu'>User Administration in TikiWiki</a></td>
                </tr>
          <tr >
                        <td valign='top'>7.</td>
                        <td><a href='/support/edu/tiki-wiki/getting-started-tiki-wiki/editing-permissions-anonymous?tsrc=rsbedu'>Allow editing for the TikiWiki anonymous user</a></td>
                </tr>
        <tr><td colspan='2'><h4>Upgrading TikiWiki</h4></td></tr>  <tr >
                        <td valign='top'>8.</td>
                        <td><a href='/support/edu/tiki-wiki/getting-started-tiki-wiki/upgrade-tikiwiki?tsrc=rsbedu'>How to upgrade TikiWiki from 9.2 to 9.3</a></td>
                </tr>
          	</table>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/9af382cbaf5d6943173aa65858b973ef?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/9af382cbaf5d6943173aa65858b973ef'>Marc Baril</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-12-29 7:37 pm</div>
				                <div><p>I tryed all your suggestion and none working for men.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29435);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-12-29 9:51 pm</div>
				                <div>Hello Marc,<br />
<br />
I regret to hear none of these solutions are working for you. What were trying to do with Tiki Wiki? Were you trying to reset a password? Or, what aspect of the article did you have trouble with specifically?</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29439);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
