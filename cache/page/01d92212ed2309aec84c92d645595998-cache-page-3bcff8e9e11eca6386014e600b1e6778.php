<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:63823:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-3/getting-started/install-joomla-3" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-02-19T16:40:51-08:00" />
  <meta name="keywords" content="install joomla 3.0" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="Learn how to install Joomla 3.0 by following these easy installation steps." />
  <title>How to install Joomla 3 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-3/getting-started/install-joomla-3" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:3268db2fee4ea93b82fa07642e6d604c -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '113.210.189.226']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Manually Installing Joomla 3									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>40,244</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jul 13, 2012'><span style='color:#606060;'>Published:</span> Feb 19, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In this tutorial, we will walk you through the steps on how to install Joomla 3.0. As Joomla 3.0 was recently released, we are eager to install it on our <a href="http://www.inmotionhosting.com/joomla-hosting.html">joomla hosting account</a> and begin using it!</p>
<h2>Joomla 3.0 Requirements</h2>
<p>The following requirement changes are in effect for Joomla 3.0:</p>
<ol>
<li><strong>PHP 5.3.1</strong> is the minimum version of PHP required</li>
<li>PHP's <strong>register_globals</strong> must be turned off</li>
<li><a href="/support/website/general-server-setup/turn-magic-quotes-gpc-off" target="_blank">PHP's <strong>magic_quotes_gpc</strong> must be disabled</a></li>
</ol>
<h2>Joomla 3.0 Installation Steps</h2>
<ol class="article_list">
<li>
<h3>Download Joomla 3.0</h3>
<p>The first step in installing Joomla 3.0 is to actually download it. Visit <a href="http://www.joomla.org/download.html#j3">this page</a> and download one of the compressed versions of Joomla 3.0, either .zip, .tar.gz, or .tar.bz2</p>
</li>
<li>
<h3>Upload Joomla 3.0</h3>
<p>After downloaded Joomla 3.0, upload it to your server. If your server allows you to uncompress files, then you can save time by uploading the compressed file and then uncompressing it on the server. Otherwise you will need to uncompress the file on your desktop and then use FTP to upload all of the individual files.</p>
</li>
<li>
<h3>Create a database for Joomla 3.0</h3>
<p>Joomla requires a database for installation. If you are on a cPanel server, <a href="/support/website/cpanel/how-do-i-create-a-mysql-database-in-my-control-panel-cpanel">use the MySQL Database wizard</a> to setup your new database. If your hosting provider does not use cPanel, you'll need to contact them for the steps on creating a new database.<br /><br />Be sure to take note of your database name, database username, and database password. You will need these later during the installation.</p>
</li>
<li>
<h3>Run the Joomla 3.0 Installation Wizard</h3>
<p>In our testing we installed Joomla 3.0 into a subfolder named joomla3.0. To access the installation wizard we will go to http://domain.com/joomla3.0<br /><br />If you get any error messages about the version of PHP your server is running, <a href="/support/edu/joomla-3/301-need-php-5-3-1">click here</a> for further help.</p>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/getting-started/install-joomla-configuration.gif"><img  alt="install-joomla-configuration" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/getting-started/install-joomla-configuration.gif" style="float: right; margin: 0px 0px 15px 15px; max-width: 230px;" /></a><strong>1. Configuration</strong><br />On the configuration page, you'll need to select your language, enter a name and description for your site, and setup your administrative details (such as username, password, and email address). Click the screenshot to the right to see how we filled out our configuration details. Click Next to continue the installation.</p>
<div style="clear: both;">&nbsp;</div>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/getting-started/install-joomla-database-settings.gif"><img  alt="install-joomla-database-settings" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/getting-started/install-joomla-database-settings.gif" style="float: right; margin: 0px 0px 15px 15px; max-width: 230px;" /></a><strong>2. Database</strong><br />In step 2, you will configure Joomla with the database you setup in Step 3 above. On most servers, you can set the <strong>Database Type</strong> to <em>MySQLi</em> and set the <strong>Host Name</strong> to <em>localhost</em>. When finished entering your database credentials, click <strong>Next</strong>.</p>
<div style="clear: both;">&nbsp;</div>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/getting-started/install-joomla-overview.gif"><img  alt="install-joomla-overview" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/getting-started/install-joomla-overview.gif" style="float: right; margin: 0px 0px 15px 15px; max-width: 230px;" /></a><strong>3. Overview</strong><br />If this is your first time using Joomla 3.0, you may want to use the option to <strong>install sample data</strong> (<a href="/support/edu/joomla-3/302-blog-brochure-default">learn more here about the different types of sample data included</a>). This will help you learn how Joomla 3.0 works because your new Joomla website will include sample articles. Also, You can select <strong>Yes</strong> next to <em>Email Configuration</em> if you want to have a copy of the installation details emailed to you. When finished with this page, click the <strong>Install</strong> button.</p>
<div style="clear: both;">&nbsp;</div>
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/getting-started/joomla-installation-successful.gif"><img  alt="joomla-installation-successful" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/getting-started/joomla-installation-successful.gif" style="float: right; margin: 0px 0px 15px 15px; max-width: 230px;" /></a> You should then see a success message, stating that Joomla 3.0 has been successfully installed.<br /><br />At this point, click the <strong>Remove installation</strong> folder button. Now that you have installed Joomla 3.0, you can then <a href="/support/edu/joomla-3/getting-started/login-dashboard">log into your Joomla 3.0 dashboard</a> and begin <a href="/support/edu/joomla-3/writing-articles">writing your first articles</a>.
<div style="clear: both;">&nbsp;</div>
</li>
</ol>
<h2>Installation Complete!</h2>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/joomla-3/getting-started'>101: Getting started with Joomla 3</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 1: How to install Joomla 3</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 2: <a href='/support/edu/joomla-3/getting-started/login-dashboard'>How to log into the Joomla 3.1 Administrator Dashboard</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-3/getting-started/install-joomla-3&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-3/getting-started/install-joomla-3'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yMjYmaWQ9MTU2OSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="8aa0128fdc2e38310b87e981ecc05dc1" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/joomla-3/getting-started?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Getting started with Joomla 3</h3></a>
		<table>  <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/joomla-3/getting-started/install-joomla-3?tsrc=rsbedu'>Install Joomla 3</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/joomla-3/getting-started/login-dashboard?tsrc=rsbedu'>How to log into the Joomla 3.1 Administrator Dashboard</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/joomla-3/getting-started/remind-admin-username?tsrc=rsbedu'>I forgot my Joomla 3 admin username</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/joomla-3/getting-started/super-admin-cant-request-password?tsrc=rsbedu'>Reset password failed: A Super Administrator can't request a password reminder</a></td>
                </tr>
          	</table>
			...
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/joomla-3/joomla-3-on-inmotion-hosting?tsrc=rsbraq'>Joomla 3.1 on InMotion Hosting</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/2176e3f872a97ca6cc6ed79daeeefc14?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/2176e3f872a97ca6cc6ed79daeeefc14'>xinmama</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-29 8:11 am</div>
				                <div><p>For the newbies (like me)&nbsp;installing Joomla on&nbsp;their add-on domains, in step 2, the Joomla files need to be uploaded to the corresponding&nbsp;sub-folder in public-html.</p>
<p>For instance, my add-on domain is http://www.cheztaobao.fr/, so the Joomla zip file needs to be uploaded to the folder public-html/cheztaobao.fr, and a Joomla folder needs to be created in the same folder.&nbsp;</p>
<p>Hope this helps.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30222);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
