<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:44833:" 
...
<meta name="viewport" content="width=device-width" />
  ...
  <link href="http://www.inmotionhosting.com/support/search?searchword=mx%20records" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:117e7ee452318297d22c09bfab783944 -->
...
<div class='container'>
	...
	<div class='item-page'>
		<div class='page-header'><h1>Search results for: <span style='color:#aaa;'>mx records</span></h1></div>
		<form method='get' action='/support/search' >
                        <input type='text' name='searchword' id='mod-search-searchword' style='width:500px;' value='mx records' />
                        <button class='button btn btn-info' onclick='this.form.searchword.focus();' style='display:inline-block; width:80px; border-radius:3px; height:32px; line-height:22px; margin:0px;'>Search</button>
                	        ...
                	        <p><a href='http://www.inmotionhosting.com/support/edu/cpanel/cpanel-email/modfying-mx-records'>Modifying your <strong>MX records</strong></a><br />In this tutorial, we will cover how to view / modify your <strong>MX records</strong>.</p>
	                
                	        <p><a href='http://www.inmotionhosting.com/support/email/general-information/third-party-mx'>Changing <b>MX records</b> to point to InMotion servers from third party DNS</a><br />May 2, 2016 <b>...</b> <b>MX records</b> help move email to the right place by specifying which server <br>
handles the email. If you have an account with us here, but have a&nbsp;...</p>
	                
                	        <p><a href='http://www.inmotionhosting.com/support/edu/cpanel/cpanel-email/modfying-mx-records'>Modifying your <b>MX records</b> - InMotion Hosting</a><br />Jun 3, 2014 <b>...</b> In this tutorial, we will cover how to modify your <b>MX records</b>.</p>
	                
                	        <p><a href='http://www.inmotionhosting.com/support/email/general-information/updating-your-mx-records-if-you-use-a-third-party-filtering-service'>Updating your <b>MX records</b> if you use a Third Party Filtering Service <b>...</b></a><br />May 2, 2016 <b>...</b> If you are using such a service, you&#39;ll need to make sure to set up the <b>MX records</b> <br>
to deliver the emails to their servers first. Once the emails are&nbsp;...</p>
	                
                	        <p><a href='http://www.inmotionhosting.com/support/edu/cpanel/cpanel-email/edit-mx-remote-local'>Setting domain <b>MX records</b> to remote settings in cPanel - InMotion <b>...</b></a><br />Mar 27, 2015 <b>...</b> <b>MX records</b> (short for mail exchanger records) are DNS (Domain Name System) <br>
resources that specify a server that will be handling your email&nbsp;...</p>
	                
                	        <p><a href='http://www.inmotionhosting.com/support/community-support/domain-names/mx-records-3'><b>MX Records</b> </a><br />Mar 21, 2013 <b>...</b> Hello! I am moving our account and DNS over to you guys! However I noticed <br>
there is no option to edit <b>MX records</b> only A, CNAME and TXT.</p>
	                
                	        <p><a href='http://www.inmotionhosting.com/support/community-support/dns-nameserver-changes/configure-mx-records-and-migrate-email-to-gmail'>Configure <b>MX records</b> and migrate email to Gmail </a><br />Jun 10, 2013 <b>...</b> In order to use Google Apps on a domain, you first typically need to modify the <br>
domain name&#39;s &lt;strong&gt;<b>MX</b>&lt;/strong&gt; Mail Exchange <b>records</b> to&nbsp;...</p>
	                
                	        <p><a href='http://www.inmotionhosting.com/support/community-support/dns-nameserver-changes/create-txt-or-mx-record'>How do I create a txt or <b>mx record</b>? </a><br />Nov 8, 2013 <b>...</b> Hello, Both TXT and <b>MX records</b> can be modified/created from cPanel: You can <br>
add a TXT record from cPanel, using the Advanced Zone Editor,&nbsp;...</p>
	                
                	        <p><a href='http://www.inmotionhosting.com/support/community-support/email-troubleshooting/configuring-mx-record-switch-over-to-hosted-exchange'>Configuring <b>MX record</b> switch over to hosted Exchange </a><br />May 26, 2015 <b>...</b> In MX Entry in CPanel, change the radio button to Backup Exchange. 2. Add the <br>
Exchange server <b>MX record</b> and give it a priortiy of 0 3.</p>
	                
                	        <p><a href='http://www.inmotionhosting.com/support/community-support/email/switching-back-from-google-apps-to-local-mail-what-mx-records'>Switching back from Google Apps to local mail - what <b>MX records</b> <b>...</b></a><br />Jan 14, 2015 <b>...</b> Hello Mfigrs, Thanks for the question! If you modified your <b>MX records</b> to go to <br>
Google&#39;s mail server, then you will need to remove those entries&nbsp;...</p>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP3NlYXJjaHdvcmQ9bXggcmVjb3JkcyZvcHRpb249Y29tX2NvbnRlbnQmY2F0aWQ9MzU2JmlkPTM1NiZ2aWV3PWNhdGVnb3J5Jkl0ZW1pZD0xMDE=" />
