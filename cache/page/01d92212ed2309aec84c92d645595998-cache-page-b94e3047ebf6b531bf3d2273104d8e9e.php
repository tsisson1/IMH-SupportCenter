<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:99718:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/file-management/corrupt-file-ftp-transfer" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-01-18T16:43:59-08:00" />
  <meta name="keywords" content="corrupt file ftp filezilla ws_ftp This image can not be displayed because it contains errors does not display correctly" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="This article will explain how to fix file corruption that occurs over FTP." />
  <title>File corruption during ftp transfer ASCII vs. BINARY - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/file-management/corrupt-file-ftp-transfer" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:d3a73ffa1dff19fd1bc799420496e1f6 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '162.95.148.250']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															File corruption during ftp transfer ASCII vs. BINARY									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>32,482</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 14, 2013'><span style='color:#606060;'>Published:</span> Jan 18, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Occasionally, issues occur with files becoming corrupt when uploading through FTP. When viewing the corrupted file through the browser, the following error will be thrown.</p>
<p style="margin-left: 20px;">"<em>This image can not be displayed because it contains errors</em>"</p>
<p>This is typically caused by uploading files through FTP as ASCII file transfer type. The <strong>"<em>ASCII transfer type"</em></strong> will transfer the files as regular text files. The<strong> <em>"Binary transfer type"</em></strong> will transfer the data in binary mode which handles the files as binary data instead of text data. Setting your FTP client to <strong>Binary</strong> will prevent your files from becoming corrupted through ftp transit. Please see the following on how to switch your FTP program to Binary.</p>

<p>It's also been brought to our attention that another possible cause of file corruption during FTP transfers, could be from your local firewall. Please also check for any updates to your firewall software, and possibly restart your router as well, if switching your FTP client settings to binary doesn't work.</p>

<h2>Changing your ftp program to binary transfer</h2>
<p>You can change the transfer type in your ftp program to Binary. All FTP programs should have this functionality. The following steps will demonstrate how to change the transfer type from ASCII to Binary in <a target="_blank" title="Clikc here to lear how to configure filezilla" href="/support/website/file-management/configuring-your-site-in-filezilla">Filezilla</a>.</p>
<ol class="article_list">
<li>Open your <a target="_blank" title="Clikc here to lear how to configure filezilla" href="/support/website/file-management/configuring-your-site-in-filezilla">Filezilla ftp program</a>.</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/corrupt-file-ftp/ftp-file-corruption-1-settings.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Settings in FileZilla" src="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/corrupt-file-ftp/ftp-file-corruption-1-settings.gif" title="Click here to view the larger image" width="100" /></a><strong>Select "<em>Edit</em>" and click "<em>Settings</em>"</strong> from the drop Box. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/corrupt-file-ftp/ftp-file-corruption-2-transfer.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Transfer settings FileZilla" src="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/corrupt-file-ftp/ftp-file-corruption-2-transfer.gif" title="Click here to view the larger image" width="100" /></a>In the "<em>Select page:</em>" box, under "<em>Transfers</em>", <strong>click "<em>File Types</em>"</strong>. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/corrupt-file-ftp/ftp-file-corruption-3-binary.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Binary radio button FileZilla" src="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/corrupt-file-ftp/ftp-file-corruption-3-binary.gif" title="Click here to view the larger image" width="100" /></a>In the "<em>Default transfer type</em>" section, <strong>select the "<em>Binary</em>" radio button</strong>.
<p><strong>Click OK.</strong></p>
<p>Now when you connect to your server with ftp, files will be treated as Binary files. This should prevent the files from becoming corrupted.</p>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/file-management/corrupt-file-ftp-transfer&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/file-management/corrupt-file-ftp-transfer'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yMyZpZD01MDQmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="ea4029918395841a8ecd3f7dae73cb24" value="1" />	</div>
	</form>
<!-- <br />
...
<a name='comments'></a>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/bffc385dce1e6fcb6e4b49d8e3b60638?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/bffc385dce1e6fcb6e4b49d8e3b60638'>Natasha</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-08 5:35 am</div>
				                <div>its fine<br />
</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15994);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-16621'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/8c14319d604e9591388a83be5627eff4?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/8c14319d604e9591388a83be5627eff4'>Philip</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-23 8:05 am</div>
				                <div>Why if settings above are correct file is still corruption on destination server </div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16621);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-23 11:23 am</div>
				                <div>Hello Philip,<br />
<br />
...
<br />
You can enable <strong>logging in FileZilla</strong>, which can provide more details. <br />
<ol><li>Open fileZilla</li><li>Go to <strong>Edit</strong>--><strong>Settings</strong></li><li>In the <em>File editing</em> section, click <strong>Logging</strong></li><li>Check the <strong>Log to file</strong> box, and enter a file name.</li></ol><br />
You may want to try <a href="http://www.inmotionhosting.com/support/website/file-management/compress-file">zipping the file</a> first (to protect it from corruption), then uploading it via FTP. Then unzipping it once it is uploaded.<br />
<br />
If you have any further questions, feel free to post them below.<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16631);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-23 8:09 am</div>
				                <div><p>Although transfer setting in Filezilla, Winscp and MobaXterm were set to transfer a .mp4 file as binary to a remote server, and the file was transferred, it seemed to have been converted to ASCII.</p>
<p>How do I prevent this?</p>
<p>Could it be the setup of the remote server.</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16622);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-23 11:45 am</div>
				                <div>Hello Philip,<br />
<br />
Thank you for your question. Transferring a file via <em>binary</em>, or <em>ASCII</em> should not convert the file in any way. It is just the means of transferring.<br />
<br />
For example, it is like using Fedex, instead of UPS for shipping. In the end the package will be the same.<br />
<br />
How are you viewing the file? Can you provide a link to it?<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16635);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-19873'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/0c442f69ef8d9c49808433e441b47e85?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/0c442f69ef8d9c49808433e441b47e85'>Megan</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-23 2:20 pm</div>
				                <div><p>Hi,</p>
<p>I have a couple of 1GB .mov file which after FTP download are damaged. Each stopps playing in the middle of the file.</p>
<p>Any advise how to fix it? Is it FTP settings which is causing it?</p>
<p>Thanks,megan</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19873);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-23 2:23 pm</div>
				                <div>Hello Megan,<br />
<br />
Have you had any luck by switching to Binary transfer?<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19874);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-23838'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/7ab8c97f8b7eca61e1c0b069af1574ec?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/7ab8c97f8b7eca61e1c0b069af1574ec'>Sameer</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-01 5:08 am</div>
				                <div><p>Hi,</p>
<p>I am also facing the same issue even after the settings are made to Binary the file when downloaded and unzipped gets corrupt I have tried it multiple times assuming the file didnt download properly but its still keeps on getting corrupt.</p>
<p>Is there any other setting that needs to be checked I have verified the filesize when uploaded is the same and after download also the file size is same. But when unzipped the file it is found corrupted.</p>
<p>&nbsp;</p>
<p>Regards</p>
<p>Sam</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23838);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-01 2:36 pm</div>
				                <div>Hello Sam,<br />
<br />
Have you tried the instructions above for switching on the logging in FileZilla?<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23859);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-03 5:20 am</div>
				                <div><p>Yes I tried setting it to Binary but no luck the files keep on corrupting when downloaded intermittently.</p>
<p>Is there any other settings that can be tried out</p>
<p>&nbsp;</p>
<p>Regards</p>
<p>Sam</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23894);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-03 3:51 pm</div>
				                <div>Hello Sameer,<br />
<br />
The reason for turning ON the logging is to see if something is happening during the transfer.  Have you checked the log file to see if any messages or errors are being recorded?  You need to go to EDIT > Settings and then select LOGGING to see the location of your log file.  The issue is most likely dropped data causing the file to become corrupt - but we would need know if it's happening to see if we can do anything about it.  The log file helps us to identify possible issues.  Please let us know if the log file caught anything.  <br />
<br />
regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23911);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-27135'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/18be901fc3fe21a4bf9011595b9f7f3f?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/18be901fc3fe21a4bf9011595b9f7f3f'>sree</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-01 1:37 pm</div>
				                <div><p>I have a shell script that does logarchive from remote build linux server on all the production linux servers . &nbsp;This script runs nightly. &nbsp;Duirng this process, the log files on the production linux servers are changing to binary format and since this is production environment, cannot restart the servers. &nbsp;Is there a way to fix this. &nbsp;The line that basically does the logArchive in my script is below.</p>
<p>ssh weblogic@$SERVERNAME cat \/dev\/null \&gt; \/home\/weblogic\/$DOMAIN\/$RMTLOGFILE</p>
<p>I can provide the entire script for reference.</p>
<p>&nbsp;</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27135);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-01 2:42 pm</div>
				                <div>Hello sree,<br />
<br />
Thank you for contacting us. Yes, can you provide the entire script for reference? This will help us narrow down the cause of the problems.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27145);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-01 11:07 pm</div>
				                <div><p>Hi John,</p>
<p>&nbsp;</p>
<p>Please find my script below.</p>
<p>&nbsp;</p>
<p>TODAY=`date +%Y%m%d`</p>
<p>SCRIPT_CONFIG=~/script-config</p>
<p>LOGARCHIVE=/logArchive</p>
<p>ROTATE_LOG=$LOGARCHIVE/rotate.log</p>
<p>&nbsp;</p>
<p>for SERVER in `cat $SCRIPT_CONFIG/log-rotate.properties`;do</p>
<p>&nbsp; &nbsp; &nbsp; &nbsp; echo</p>
<p>&nbsp; &nbsp; &nbsp; &nbsp; SERVERNAME=`echo $SERVER | awk -F '|' '{ print $1 }'`</p>
<p>&nbsp; &nbsp; &nbsp; &nbsp; DOMAIN=`echo $SERVER | awk -F '|' '{ print $2 }'`</p>
<p>&nbsp; &nbsp; &nbsp; &nbsp; RMTLOGFILE=`echo $SERVER | awk -F '|' '{ print $3 }'`</p>
<p>&nbsp; &nbsp; &nbsp; &nbsp; LOGFILE=`echo $SERVER | awk -F '|' '{ print $3 }'`</p>
<p>&nbsp;</p>
<p>&nbsp; &nbsp; &nbsp; &nbsp; if [ `ls $LOGARCHIVE/$SERVERNAME/$DOMAIN/ | grep $LOGFILE.$TODAY | wc -l` &gt; 1 ];then</p>
<p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;NUMFILES=`ls $LOGARCHIVE/$SERVERNAME/$DOMAIN/ | grep "$LOGFILE.$TODAY" | wc -l`</p>
<p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;LOGFILE=$LOGFILE.$TODAY.$(($NUMFILES + 1))</p>
<p>&nbsp; &nbsp; &nbsp; &nbsp; else</p>
<p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;LOGFILE=$LOGFILE.$TODAY</p>
<p>&nbsp; &nbsp; &nbsp; &nbsp; fi</p>
<p>&nbsp;</p>
<p>&nbsp; &nbsp; &nbsp; &nbsp; echo "`date` : scp -p weblogic@$SERVERNAME:/home/weblogic/$DOMAIN/$RMTLOGFILE $LOGARCHIVE/downloadtmp/$LOGFILE" &gt;&gt; $ROTATE_LOG</p>
<p>&nbsp; &nbsp; &nbsp; &nbsp; scp -p weblogic@$SERVERNAME:/home/weblogic/$DOMAIN/$RMTLOGFILE $LOGARCHIVE/downloadtmp/$LOGFILE &gt;&gt; $ROTATE_LOG</p>
<p>&nbsp;</p>
<p>&nbsp; &nbsp; &nbsp; &nbsp; if [ $? == 0 ];then</p>
<p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; ssh weblogic@$SERVERNAME cat \/dev\/null \&gt; \/home\/weblogic\/$DOMAIN\/$RMTLOGFILE</p>
<p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; mv $LOGARCHIVE/downloadtmp/$LOGFILE $LOGARCHIVE/$SERVERNAME/$DOMAIN/$LOGFILE</p>
<p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; #echo "mv $LOGARCHIVE/downloadtmp/$LOGFILE $LOGARCHIVE/$SERVERNAME/$DOMAIN/$LOGFILE"</p>
<p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; gzip $LOGARCHIVE/$SERVERNAME/$DOMAIN/$LOGFILE</p>
<p>&nbsp; &nbsp; &nbsp; &nbsp; else</p>
<p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; log "Failed to download $SERVERNAME:/home/weblogic/$DOMAIN/$RMTLOGFILE"</p>
<p>&nbsp; &nbsp; &nbsp; &nbsp; fi</p>
<p>&nbsp; &nbsp; &nbsp; &nbsp; echo</p>
<p>done</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27161);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-02 12:18 pm</div>
				                <div>Hello sree,<br />
<br />
Thank you for contacting us. We spent some time looking into this, and recommend using <a href="http://www.inmotionhosting.com/support/website/file-management/use-rsync-to-transfer-files">rsync</a> command instead.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27181);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-32633'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/3c4c349538144ce324e09987aa792aab?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/3c4c349538144ce324e09987aa792aab'>Vinoth </a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-05-12 10:53 am</div>
				                <div><p>Hi,</p>
<p>I face similar problem. I could transfer the file in Binary Mode. Btw, the file contain Mixed characters of Greek and English.</p>
<p>Once the file is receive, how we need to decode the file from Binary. Because, the data look junk in the Linux server where I send this file.</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32633);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-05-12 12:33 pm</div>
				                <div>Hello Vinoth,<br />
<br />
Thank you for contacting us. Can you provide a link to the site for testing?<br />
<br />
Best Regards,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32639);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
