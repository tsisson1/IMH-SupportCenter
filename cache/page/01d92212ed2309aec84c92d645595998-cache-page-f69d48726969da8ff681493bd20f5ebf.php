<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50230:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/whm/automatic-provisioning-is-failed-code-6" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, Thank you for contacting us about Automatic provisioning issues with WHMCS. Here is a helpful link to the official WHMCS guide on Auto Setup Issu..." />
  <title>Automatic provisioning is failed code 6 | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/whm/automatic-provisioning-is-failed-code-6" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:5422b2cc558a48b1dd7f2cd95a31527e -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Automatic provisioning is failed code 6</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-05-28 7:24 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>65</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Hi my automatic provisioning is failed.<br />
Once someone place an order on my website www.dellhosting.co.uk<br />
they receive email about payment and invoices but they dont get confirmed on whm <br />
I checked my WHMCS server setup and its successfully connecting the server at wHM<br />
<br />
but i dont know why its still failing.</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_7350' id='upvote_answer_7350' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='7350' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_7350').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_7350' id='downvote_answer_7350' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='7350' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_7350').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
Thank you for contacting us about Automatic provisioning issues with WHMCS. Here is a helpful link to the official WHMCS guide on <a href="http://docs.whmcs.com/Auto_Setup_Issues" target="_blank" >Auto Setup Issues</a>. There is also an official WHMCS video on <a href="https://youtu.be/Ug3wbYRpUgI" target="_blank">WHMCS Troubleshooting Automatic Hosting Setup Failure</a>.<br />
<br />
We are happy to help you troubleshoot further, but will need some additional information. When you say "<em>they dont get confirmed on whm</em>" what do you mean by this. For example, where can i view if they are confirmed?<br />
<br />
Can you provide the full error message?<br />
<br />
...
John-Paul B
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_7350').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_7350' id='form_comment_on_answer_7350' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/whm/automatic-provisioning-is-failed-code-6&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/whm/automatic-provisioning-is-failed-code-6'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="764c438f7039b2b2d951cb6897bf052f" value="1" />	</div>
	</form>
<!-- <br />
