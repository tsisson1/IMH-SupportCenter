<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:114544:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/what-is/how-to-enable-gzip-moddeflate" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-10-03T18:19:26-07:00" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="Here we introduce you to gzip / mod_deflate" />
  <title>An introduction to gzip / mod_deflate - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/what-is/how-to-enable-gzip-moddeflate" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:e57fafe519f7043dd61f89914312056d -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '86.38.221.33']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															An introduction to gzip / mod_deflate									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>48,620</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 5, 2012'><span style='color:#606060;'>Published:</span> Oct 3, 2014</div>
  ...
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('what');">What is it?</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('install');">How to install</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('use');">How to use</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('test');">Is it working?</button>
</div>

<a name="what"></a>
<h2>What is mod_deflate?</h2>
<p>Mod_deflate is an apache module that can be used to compress data using gzip compression before sending it to the user. For bandwidth intensive websites, using this feature can offer a benefit, as the server is compressing data before sending it you will be using less bandwidth. The major drawback to using mod_deflate however is that the server may need to use more resources to compress each file and this in turn can cause performance issues on older servers. As our <a href="http://www.inmotionhosting.com/business-hosting">shared accounts</a> included unlimited bandwidth, using mod_deflate to reduce bandwidth usage is not usually a concern for shared users.</p>
<p>It's important to understand that gzip compression does not reduce resource usage on a server, nor is it guaranteed to reduce page load times for your website. To reduce possible resource usage and reduce page load time, a better solution is a caching option for your site. If your site is created with a Content Management System such as WordPress, Joomla, Drupal, etc.; there are modules or settings for each of those that will enable caching for your site. For example, the <a href="/support/edu/wordpress/recommended-wordpress-plugins/optimizing-wordpress-with-wp-super-cache">WP Super Cache Plugin</a> will help you optimize your WordPress site. In Joomla, caching is a built-in module which you can <a href="/support/edu/joomla-25/caching/global-module-caching">enable in your Joomla administration panel</a>.</p>
<p class="alert"><strong>Please note</strong>: Due to the performance issues that can be caused by mod_deflate, it should not be used on older shared servers. If you do not see the option for Optimize Website in your cPanel, you are on an older server that does not support gzip compression (mod_deflate).</p>

<a name="install"></a>
<h2>How do I install mod_deflate?</h2>
<p>The mod_deflate apache module is already installed on our servers.</p>

<a name="use"></a>
<h2>How do I use mod_defalte?</h2>
<p>To use mod_deflate, you have two options:</p>
<ul>
<li>Use the Website Optimization option in cPanel.</li>
<li>Add a few lines to your .htaccess file.</li>
</ul>
<h3>Enabling mod_deflate (gzip compression) in cPanel</h3>
<p>Under <strong>Software/Services</strong> in your cPanel click on the <strong>Website Optimization</strong> icon.</p>
<p>Select <strong>Compress all content</strong> or specific MIME types. To limit which types of content are compressed, choose <strong>Compress the specified MIME types</strong> and input the particular MIME types you want to compress.</p>
<p class="alert">If you specify particular MIME types, it is best not to add image, video, audio, PDF or other types of binary files. These file formats are already compressed, so it is not necessary to compress these further.</p>
<p>Once you have chosen your settings, click <strong>Update Settings</strong> to save your changes and enable gzip compression on your account.</p>
<p>To turn off gzip compression, select <strong>Disabled</strong> on the Website Optimization page and click <strong>Update Settings</strong>.</p>
<h3>Enabling mod_deflate (gzip compression) in .htaccess</h3>
<p>Edit your <a href="/support/website/general-server-setup/what-is-the-htaccess-file-and-what-do-i-use-it-for">.htaccess file</a> and add the following code:</p>
<p class="code_block" style="white-space: nowrap;">&lt;IfModule mod_deflate.c&gt;<br />AddOutputFilterByType DEFLATE text/text text/html text/plain text/xml text/css application/x-javascript application/javascript<br />&lt;/IfModule&gt;</p>

<a name="test"></a>
<h2>How can I test if mod_deflate is working?</h2>
<p>There are several sites online that you can use to help test whether mod_deflate is working for your site or not. One site we found rather easy to use is:</p>
<p><a href="http://www.whatsmyip.org/http-compression-test/">http://www.whatsmyip.org/http-compression-test/</a></p>
<p>All you need to do is enter a URL and click the "Test" button. Below we have showed before and after screenshots that show when mod_deflate is enabled, and when it is not.</p>
<table border="0">
<tbody>
<tr>
<td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/gzip/when-mod_deflate-is-not-enabled.gif"><img style="max-width: 250px;"  alt="when-mod_deflate-is-not-enabled" src="//cdn.inmotionhosting.com/support/images/stories/website/gzip/when-mod_deflate-is-not-enabled.gif" /></a></td>
<td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/gzip/when-mod_deflate-is-enabled.gif"><img style="max-width: 250px;"  alt="when-mod_deflate-is-enabled" src="//cdn.inmotionhosting.com/support/images/stories/website/gzip/when-mod_deflate-is-enabled.gif" /></a></td>
</tr>
</tbody>
</table> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/what-is/how-to-enable-gzip-moddeflate&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/what-is/how-to-enable-gzip-moddeflate'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MTUmaWQ9MzUwJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="d10ad837545f4a0e6a7a8967bcd4df08" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2012-04-27 2:35 pm</div>
				                <div>For those on shared InMotion hosting, I've added the following code snippet to the top of my WordPress themes' header.php files in order to achieve Gzip compression:<br />
<br />
&lt;?php ini_set('zlib.output_compression', 'On'); ini_set('zlib.output_compression_level', '1'); ?&gt;<br />
<br />
So far I haven't run into any performance issues.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(6532);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='/support/images/avatars/default_avatar.jpg' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='/support/community-support/users/CNick'>CNick</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2012-04-27 3:00 pm</div>
				                <div>Hi Teebird,<br />
<br />
Thank you for the input. Modifying your core WordPress files is not recommended, and in this case is not needed. You can simply add the code shown above to your .htaccess file (either before or after any code added by WordPress).<br />
<br />
Please let us know if you have any questions or need any assistance.<br />
<br />
Regards,<br />
<br />
Christi N.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(6533);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2012-04-27 3:19 pm</div>
				                <div>Hi CNick,<br />
<br />
I would use the above method if I wasn't on a shared hosting plan. The tutorial above says that mod_deflate is NOT recommended for InMotion shared hosting: <br />
<br />
&quot;Please note: Due to the performance issues that can be caused by 'mod_deflate, it should not be used on our shared servers', and instead only be used on VPS and Dedicated accounts. Also, as our shared accounts included unlimited bandwidth, this further reduces the need to use mod_deflate to reduce bandwidth usage.&quot;<br />
<br />
Also, I don't believe files in a Wordpress theme are considered a part of <br />
the WordPress Core files. :-) <br />
<br />
The method I am using is also pretty common among wordpress users: http://bit.ly/IpEOOC<br />
<br />
Thanks</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(6534);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2012-04-27 4:04 pm</div>
				                <div>Hi Teebird,<br />
<br />
We apologize for the confusion. That note mod_deflate on shared servers was in reference to older shared servers that do not support mod_deflate. I have updated the article to clarify this.<br />
<br />
While your theme files may not be technically core files (I apologize for the incorrect reference) if you are not using a Child Theme and your theme is updated, your changes could be overwritten and lost.<br />
<br />
To speed up WordPress, a caching plugin like http://www.inmotionhosting.com/support/edu/wordpress/recommended-wordpress-plugins/optimizing-wordpress-with-wp-super-cache is a preferred solution.<br />
<br />
Regards,<br />
<br />
Christi N.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(6535);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2012-04-27 5:39 pm</div>
				                <div>Ah, thanks for the update and good points about WP theme updates.<br />
<br />
I have gzipped my InMotion sites via &quot;Software Optimization&quot; wizard in my cPanels. Thanks! :-)</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(6536);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2012-04-30 10:23 am</div>
				                <div>You're welcome Teebird. Thank you for bringing this to our attention so we could clarify the information.<br />
<br />
Please feel free to contact us anytime you have questions or need assistance. We're always happy to help!<br />
<br />
Regards,<br />
<br />
Christi N.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(6538);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-04-04 8:22 pm</div>
				                <div>I have been unable to get compression to work. I have a VPS, and I don't have the Software Optimization option. I added the code to my .htaccess (and tried other code I found on Apache's site), and I still fail the compression test.<br />
<br />
What am I doing wrong? <br />
<br />
www.alvingolf.com</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(7618);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-04-04 9:12 pm</div>
				                <div>Hello Farreldoc,<br />
<br />
...
Community Support</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(7619);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-8001'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='https://lh6.googleusercontent.com/-zn1HLdJR5GM/AAAAAAAAAAI/AAAAAAAAAE4/lwXo_JRSrSk/photo.jpg?sz=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='/support/community-support/users/alegiac'>alegiac</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-07-04 5:52 am</div>
				                <div>Thanks, Brad. Very useful notes. I added to our .htaccess file on our web site http://www.itware.com the instructions you see at the bottom of this message, sligtly different oy yours, but it seems they work perfectly.<br />
My question is: why the Joomla developer team doesn't include this code by default on the .htaccess file? All Joomla webmaster could save a lot of time, expecially the ones at the beginning of their experience, just like me:  we got a very poor ranking from Google Page Speed, so I worked about solving the several items they put in the &quot;to do list&quot;. I found your note after several hours of navigation. <br />
Why don't you suggest them this improvement?<br />
Thanks<br />
Ciao<br />
Alessandro<br />
<br />
...
&lt;/ifmodule&gt;<br />
#End Gzip</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8001);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-07-05 12:03 pm</div>
				                <div>Hi alegiac,<br />
<br />
This compression isn't enabled in most programs by default because in addition to its benefits, it has its drawbacks as well. While compression sends smaller files to the end user, the server has to work hard to compress everything it's sending. Some servers, especially those getting lots of traffic, may ultimately fail / crash if they can't keep up with all of the compression requests.<br />
<br />
So, basically, gzip compression can be really hard on servers in some situations, and sometimes the consequences are worse than the benefits that can be gained.<br />
<br />
Does that make sense?</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8007);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-07-06 11:28 am</div>
				                <div>Yes, off course! Thanks Brad. You are certainly rigjht, even if today CPU power is not anymore a big constrain. Thanks indeed<br />
Alessandro</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8014);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-10269'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/fb198eb78dcceefa4072d4e0117fbe6d?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/fb198eb78dcceefa4072d4e0117fbe6d'>Flick</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-28 5:48 pm</div>
				                <div><p>Sorry to revive such an old topic but it does seem to be one of the more 'up-to-date' ones regarding gzip and mod deflate. &nbsp;In light of BradM's response, I was wondering therefore if there a critical point where if a site reaches a certain size or traffic, then gzip compression should not be enabled? &nbsp;Or does this also depend on the server it resides on?</p>
<p>Thanks in advance :)</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10269);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-28 6:44 pm</div>
				                <div>Hello Flick, we love it when an old article gets some new comments so thanks for that!<br />
<br />
The critical point where you would want to figure out if &lt;strong&gt;gzip&lt;/strong&gt; is going to really help you or not, is really going to depend on the content of your website itself, as well as the amount of CPU usage you have available to your account.<br />
<br />
For instance if you have very high traffic to your website, and you primarily serve up dynamically generated pages from something like PHP that are rather large in size (&gt; 200K), having the server compress that data on the fly can be a bit taxing and lead to higher CPU usage. Also if you are trying to serve up images using &lt;strong&gt;gzip&lt;/strong&gt; compression that have already been compressed for the web, this can waste CPU time doing unnecessary work. This is why in this guide it just mentions enabling the compression on plain-text files instead of everything on your site.<br />
<br />
In most cases having &lt;strong&gt;gzip&lt;/strong&gt; compression turned on is a good idea all around. If you are on a shared hosting account you'd just want to &lt;a href=&quot;http://www.inmotionhosting.com/support/website/server-usage/viewing-resource-usage-with-cpu-graphs&quot; target=&quot;_blank&quot;&gt;view your resource usage&lt;/a&gt; to ensure you're not taxing the server's CPU resources too much. If you are on a VPS or dedicated server with more resources, more than likely you won't run into any issues at all with it enabled for your sites.<br />
<br />
Hope that answered your question, let us know if you had anymore!<br />
<br />
- Jacob<br />
</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10270);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-16 4:58 pm</div>
				                <div>This is ALL making my head hurt... as a beginner, I don't understand most of all this tech talk... and wish someone from IMH would just take over our sites for 10 minutes and FIX all these technical things to WPress, server settings, cache, and all the other things that are evidently hurting BOTH of us.  The problem is it takes a beginner a month to even figure out what to do, and wasting the techs time etc...   I am reading OLD info mixed in with new and that is making it worst.  I am ready to scream.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12867);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-17330'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/6aa313bae3e78bc539e0398731b1d152?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/6aa313bae3e78bc539e0398731b1d152'>Marlin Gevin</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-12 6:15 am</div>
				                <div><p>I've been reading about this GZIP compression for about an hour or two now and so far I got it to work. But there's one thing I still don't get. Is there a difference between enabling GZIP(mod_gzip) and mod_deflate or is it all the same thing. Just been reading a article about this on another website (http://www.giftofspeed.com/enable-gzip-compression/ ) which says there is a difference between the two mods. Anyone to help me explain this?&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17330);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-12 7:48 am</div>
				                <div>Hello Marlin!<br />
<br />
Great question!  This is well discussed on the internet and in the responses above.  You can a great discussion as well as reference links by going <a href="http://stackoverflow.com/questions/10255453/mod-deflate-vs-mod-gzip" rel="nofollow" target="_blank">here</a>.  However, to summarize the issue:  mod_deflate  and mod_gzip use the same compression algorithm, but in different ways.  Mod_deflate is configured to compress files differently (using gzip) than mod_gzip.   If you want a really thorough breakdown, check out the <a href="http://www.linuxjournal.com/article/6802" rel="nofollow" target="_blank">Linux Journal article</a> on using mod_gzip and mod_deflate. The article clearly states that when you compress with either method, you're using gzip.  <br />
<br />
However, for issues of performance, mod_gzip is better with the shared server as it uses less CPU.  Both of these options have pro's and cons, but it appears that InMotion recommend using mod_gzip.    I hope this helps to clear up the issue.  If you have any further questions or comments, please let us know.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17333);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-20139'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/28a20514e2a94eadd8d8c5b83017e1ac?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/28a20514e2a94eadd8d8c5b83017e1ac'>Advante360</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-30 2:58 am</div>
				                <div><p>I am new to CPanel and i have to redirect IP address to Domain Name of my comany website, how can i do this using CPanel? And i already tried .htaccess code but it's not working..... Thanks in advance</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20139);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-30 7:55 am</div>
				                <div>Hello Advante360,<br />
<br />
Sorry for the problem with the re-direct.  Your question is on the wrong page within our support center.  You should go to the <a href="http://www.inmotionhosting.com/support/website/redirects/setting-up-a-301-permanent-redirect-via-htaccess">301 Permanent Re-direct page</a> for more information.  The re-direct in .htaccess will be the best way for you to make this happen.  The cPanel re-directs simply write the code in the .htaccess for you.  If you're using an IP address, then you edit the .htaccess file directly.  Remember that the re-direct should be at the TOP of the file since actions within the .htaccess file are done within sequence.  If there's a conflicting rule, then it may bypass your re-direct causing it not to work.  If you require further assistance with the issue, please post a reply with either your URL(if you are an InMotion customer), or further information on the code being used in the .htaccess.  <br />
<br />
If you have any further questions or comments, please let us know.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20152);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-21709'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/a5bedb18d1c69b016acd5fd505b81336?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/a5bedb18d1c69b016acd5fd505b81336'>Bankim</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-14 3:45 pm</div>
				                <div><p>Hi ,</p>
<p>I have a Magento website . Is it safe to turn on Website optimisation - from Cpanel .&nbsp;</p>
<p>I only Plan to compress html and xml .</p>
<p>&nbsp;</p>
<p>Will it be safe . do i need backup before enabling it&nbsp;</p>
<p>thanks</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21709);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-16 2:03 pm</div>
				                <div>Hello Bankim,<br />
<br />
That should be fine, but you should definitely back up the site beforehand just in case.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21777);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-22452'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/84c774182b6cedc283c6f7cce2eac050?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/84c774182b6cedc283c6f7cce2eac050'>Muhammed Mubarak</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-08 3:33 am</div>
				                <div><p>Hi,</p>
<p>&nbsp; I am&nbsp;having shared hosting linux account &amp; it does not have "Optimize Website" option in Cpanel. Also i added mod_deflate code in &nbsp;.htaccess file. But still my website &nbsp;<strong>http://www.bismicaterersperambur.com/ </strong>not compressed. Can someone help me out for this issue ?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22452);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-08 9:08 am</div>
				                <div>Hello Muhammed,<br />
<br />
Are you one of our customers? This option should be within your cPanel if you are. If you are not, you may want to see if they have another option.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22462);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/a5bedb18d1c69b016acd5fd505b81336?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/a5bedb18d1c69b016acd5fd505b81336'>Bankim Chandra</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-08 9:20 am</div>
				                <div><p>Well in the cpanel , most of the times you have the Optimize website option. That is the GZip function . all u have to enable it .. Hope it Helps.</p>
<p>&nbsp;</p>
<p>Many Thanks</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22464);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-24341'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/d328b8c505045279fe8d8d07afda7b1c?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/d328b8c505045279fe8d8d07afda7b1c'>f</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-20 5:10 pm</div>
				                <div><p>very good.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24341);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-24761'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/7d505b9eeb82a9d3de1c5ed1d46b822f?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/7d505b9eeb82a9d3de1c5ed1d46b822f'>Cyn</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-10 5:20 am</div>
				                <div><p>Thank you very much!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24761);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
