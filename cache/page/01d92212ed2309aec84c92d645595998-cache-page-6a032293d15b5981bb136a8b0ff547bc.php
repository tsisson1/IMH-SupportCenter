<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50535:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/how-to/gallery3-image-upload-cpuproblem" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, I apologize for the emails you have received. The size of the image does not matter but having multiple or long convert processes do. I would sug..." />
  <title>Gallery3  image upload  -CPU_problem | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/how-to/gallery3-image-upload-cpuproblem" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:d8a4dce12174e29be4d86272d43199af -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Gallery3  image upload  -CPU_problem</h1>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_7964' id='upvote_answer_7964' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='7964' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_7964').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_7964' id='downvote_answer_7964' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='7964' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_7964').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
I apologize for the emails you have received. The size of the image does not matter but having multiple or long convert processes do. I would suggest trying to either resize the images locally on your machine or upload one a time. This software usually does not cause any problems which is why I am curious to why it is now. Please let us know if the emails continue to come.<br />
<br />
Best Regards,<br />
TJ Edens
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_7964').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_7964' id='form_comment_on_answer_7964' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/how-to/gallery3-image-upload-cpuproblem&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/how-to/gallery3-image-upload-cpuproblem'></div>
<script type='text/javascript'>
  (function() {
