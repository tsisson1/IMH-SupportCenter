<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:64411:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/phpbb/general-settings/user-registration-settings" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-12-22T21:49:56-08:00" />
  <meta name="keywords" content="user registration settings edit modify change" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="This article explains the different settings found in phpBB for user registration." />
  <title>How to Configure User Registration Settings in phpBB 3.0 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/phpbb/general-settings/user-registration-settings" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:904abf78b5445cdbc292947440c565fd -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '50.65.174.245']);
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/phpbb' itemprop='url'><span itemprop='title'>phpBB<span></a><div class='dropdown_4columns'><h2>phpBB Education Channel</h2><div class='col_2'><h3>100 Level Classes</h3><div><a href='/support/edu/phpbb/getting-started-phpbb'>101: Getting Started in phpBB 3.0</a></div><div><a href='/support/edu/phpbb/manage-forums'>102: Creating Forums in phpBB 3.0</a></div><div><a href='/support/edu/phpbb/working-with-users'>103: Working with Users in phpBB 3.0</a></div></div><div class='col_2'><h3>200 Level Classes</h3><div><a href='/support/edu/phpbb/general-settings'>201: Working with General Settings in phpBB 3</a></div><div><a href='/support/edu/phpbb/manage-posting-settings'>202: Working with posting settings in phpBB 3.0</a></div><div><a href='/support/edu/phpbb/managing-permissions'>203: Managing permissions in phpBB 3.0</a></div><div><a href='/support/edu/phpbb/manage-styles'>204: Managing styles and themes in phpBB 3.0</a></div><div><a href='/support/edu/phpbb/maintaining-forum'>205: Forum moderation in phpBB 3.0</a></div><div><a href='/support/edu/phpbb/manage-system-settings'>206: Manging System Settings in phpBB 3.0</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/phpbb/general-settings' itemprop='url'><span itemprop='title'>201: Working with General Settings in phpBB 3<span></a><div class='dropdown_3columns'><h2> Working with General Settings in phpBB 3</h2><div class='col_3'><div>1. <a style='display:inline;' href='/support/edu/phpbb/general-settings/smtp-setup'>How to Setup SMTP Settings in phpBB</a></div><div>2. <a style='display:inline;' href='/support/edu/phpbb/general-settings/modify-signature-settings'>How to adjust signature settings in phpBB 3.0</a></div><div>3. <a style='display:inline;' href='/support/edu/phpbb/general-settings/attachment-settings'>How to manage attachments in phpBB 3.0</a></div><div>4. <a style='display:inline;' href='/support/edu/phpbb/general-settings/board-settings'>Managing board settings in phpBB 3.0</a></div><div>5. <a style='display:inline;' href='/support/edu/phpbb/general-settings/avatar-settings'>Editing avatar settings in phpBB 3.0</a></div><div>6. <a style='display:inline;' href='/support/edu/phpbb/general-settings/private-message-settings'>How to configure private message settings in phpBB 3.0</a></div><div>7. <a style='display:inline;' href='/support/edu/phpbb/general-settings/post-settings'>How to manage post settings in phpBB 3.0</a></div><div>8. <a style='display:inline;' href='/support/edu/phpbb/general-settings/syndication-feed-settings'>Editing syndication feed settings in phpBB 3.0</a></div><div>9. <a style='display:inline;' href='/support/edu/phpbb/general-settings/user-registration-settings'>How to Configure User Registration Settings in phpBB 3.0</a></div><div>10. <a style='display:inline;' href='/support/edu/phpbb/general-settings/spambot-countermeasures'>Managing spambot countermeasures in phpBB 3.0</a></div><div>11. <a style='display:inline;' href='/support/edu/phpbb/general-settings/change-footer'>How to edit a template footer in phpBB 3.0</a></div><div>12. <a style='display:inline;' href='/support/edu/phpbb/general-settings/change-title'>Modifying your header title in phpBB 3.0</a></div><div>13. <a style='display:inline;' href='/support/edu/phpbb/general-settings/change-language'>How to activate a new language in phpBB 3.0</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to Configure User R...</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to Configure User Registration Settings in phpBB 3.0									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>9,231</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 2, 2013'><span style='color:#606060;'>Published:</span> Dec 22, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>When customizing your site and its behavior, you do not want to forget the user registration settings. From within the <em>administrative dashboard</em> in <strong>phpBB</strong>, you can tailor the settings for such features as password width, username width, the number of posts a user must hit before no longer being considered 'new', etc. This article discusses all the different settings found for <strong>user registration</strong> in your <strong>phpBB</strong> 3.0 site.</p>
<h2>Setting up User Registration Settings in phpBB 3.0</h2>
<ol class="article_list">
  <li><a href="/support/edu/phpbb/getting-started-phpbb/phpbb-login">Log into your phpBB admin dashboard</a>.</li>
  <li>From there, click on the <strong>General</strong> tab if the screen is not already focused on it.</li>
  <li>Once you land on the General tab you will see several categories listed on the left hand sidebar. Click on the <strong>User Registration Settings</strong> link found under the <em>Board Configuration</em> category.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/general/user-registration-settings/user-registration-settings.png"><img  alt="user settings menu" src="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/general/user-registration-settings/user-registration-settings.png" /></a></li>
  <li>This brings you to the <em>User Registration Settings</em> page. The settings are divided up into three categories: <em>General Settings</em>, <em>General Options</em>, and <em>COPPA</em>. <br /><strong>General Settings</strong><br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/general/user-registration-settings/general-settings.png"><img  alt="general settings list" src="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/general/user-registration-settings/general-settings.png" /></a><br /><br />
    <table class="article_table">
      <tbody>
        <tr>
          <th>Account Activation</th>
          <td>This setting is the master switch and will turn the ATOM feeds either on or off entirely. This setting supercedes all other settings on the page.</td>
        </tr>
        <tr>
          <th>New Member Post Limit</th>
          <td>Enabling this setting allows the display of individual statistics on the feed items such as views, replies, date and time, etc.</td>
        </tr>
        <tr>
          <th>Set Newly Registered Users Group to Default</th>
          <td>This setting can be used to enable HTTP authentication to allow users to receive content otherwise hidden to guest users.</td>
        </tr>
        <tr>
          <th>Username Length</th>
          <td>This setting allows you to control the minimum and maximum length of user names.</td>
        </tr>
        <tr>
          <th>Password Length</th>
          <td>As above with the username, this setting allows you to set the minimum and maximum length of the user password.</td>
        </tr>
        <tr>
          <th>Limit Username Chars</th>
          <td>This setting lets you set the allowed composition of the username from the dropdown. The settings are as follows:<br />
            <table>
              <tbody>
                <tr>
                  <td>Any Character</td>
                ...
                <tr>
                  <td>Alphanumeric and spacers</td>
                </tr>
                <tr>
                  <td>Any letter and number</td>
                </tr>
                <tr>
                  <td>Any letter, number, and spacer</td>
                </tr>
                <tr>
                  <td>ASCII (no international unicode)</td>
                </tr>
              </tbody>
            </table>
          </td>
        ...
        <tr>
          ...
          <td>Allows you to set the required complexity of the password from the dropdown list.<br />
            <table>
              <tbody>
                <tr>
                ...
                <tr>
                  <td>Must be mixed case</td>
                </tr>
                <tr>
                  <td>Must contain letters and numbers</td>
                </tr>
                <tr>
                  <td>Must contain symbols</td>
                </tr>
              </tbody>
            </table>
          </td>
        ...
        <tr>
          ...
          <td>&nbsp;This setting forces users to change their passwords after the set number of days. Setting this to 0 disables this feature.</td>
        </tr>
      </tbody>
    </table><br /><strong>General Options</strong><br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/general/user-registration-settings/general-options.png"><img  alt="list of general options" src="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/general/user-registration-settings/general-options.png" /></a><br />
    <table class="article_table">
      <tbody>
        <tr>
          <th>Allow username changes</th>
          <td>Set to Yes if you wish to allow users to have the ability to change their usernames.</td>
        </tr>
        <tr>
          <th>Allow e-mail address re-use</th>
          <td>If enabled, this allows the use of an email address for more than one user account.</td>
        </tr>
        <tr>
          <th>Enable spambot countermeasures for registrations</th>
          <td>This requires users to pass an anti-spambot task to prove they are human, if enabled.</td>
        </tr>
        <tr>
          <th>Maximum number of login attempts per username</th>
          <td>Sets the nuber of login failures that will then trigger an anti-spambot task. Setting to 0 prevents it from being triggered.</td>
        </tr>
        <tr>
          <th>Registration attempts</th>
          <td>The number of attempts a user can try with the anti-spambot task before they are locked out of that.</td>
        </tr>
      </tbody>
    </table><strong><br />COPPA<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/general/user-registration-settings/coppa.png"><img  alt="coppa settings" src="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/general/user-registration-settings/coppa.png" /></a><br />
<table class="article_table">
<tbody>
<tr><th>Enable COPPA</th>
<td>Enabling this requires users to state whether they are over the age of 13 in compliance with the U.S. Children's Online Privacy Protection Act.</td>
</tr>
<tr><th>COPPA mailing address</th>
<td>The mailing address to which parents will send COPPA registration forms.</td>
</tr>
<tr><th>COPPA Fax Number</th>
<td>Fax number for COPPA verifications.</td>
</tr>
</tbody>
</table><br /></strong></li>
  <li>Once you have your desired settings configured, click on the <strong>Submit</strong></li>
</ol>

<p>Congratulations, now you know how to <em>configure</em> <strong>user registration</strong> settings in <strong>phpBB</strong>!</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/phpbb/general-settings'>201: Working with General Settings in phpBB 3</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 9: How to Configure User Registration Settings in phpBB 3.0</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 8: <a href='/support/edu/phpbb/general-settings/syndication-feed-settings'>Editing syndication feed settings in phpBB 3.0</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 10: <a href='/support/edu/phpbb/general-settings/spambot-countermeasures'>Managing spambot countermeasures in phpBB 3.0</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/phpbb/general-settings/user-registration-settings&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/phpbb/general-settings/user-registration-settings'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMTImaWQ9MjEzMSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="c4e34d46c36533c70bc338a4df35f3d7" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/phpbb/general-settings?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Working with General Settings in phpBB 3</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/phpbb/general-settings/smtp-setup?tsrc=rsbedu'>How to Setup SMTP Settings in phpBB</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/phpbb/general-settings/modify-signature-settings?tsrc=rsbedu'>How to adjust signature settings in phpBB 3.0</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/phpbb/general-settings/attachment-settings?tsrc=rsbedu'>How to manage attachments in phpBB 3.0</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/phpbb/general-settings/board-settings?tsrc=rsbedu'>Managing board settings in phpBB 3.0</a></td>
                </tr>
          <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/phpbb/general-settings/avatar-settings?tsrc=rsbedu'>Editing avatar settings in phpBB 3.0</a></td>
                </tr>
          <tr >
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/phpbb/general-settings/private-message-settings?tsrc=rsbedu'>How to configure private message settings in phpBB 3.0</a></td>
                </tr>
          <tr >
                        <td valign='top'>7.</td>
                        <td><a href='/support/edu/phpbb/general-settings/post-settings?tsrc=rsbedu'>How to manage post settings in phpBB 3.0</a></td>
                </tr>
          <tr >
                        <td valign='top'>8.</td>
                        <td><a href='/support/edu/phpbb/general-settings/syndication-feed-settings?tsrc=rsbedu'>Editing syndication feed settings in phpBB 3.0</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>9.</td>
                        <td><a href='/support/edu/phpbb/general-settings/user-registration-settings?tsrc=rsbedu'>How to Configure User Registration Settings in phpBB 3.0</a></td>
                </tr>
          <tr >
                        <td valign='top'>10.</td>
                        <td><a href='/support/edu/phpbb/general-settings/spambot-countermeasures?tsrc=rsbedu'>Managing spambot countermeasures in phpBB 3.0</a></td>
                </tr>
          <tr >
                        <td valign='top'>11.</td>
                        <td><a href='/support/edu/phpbb/general-settings/change-footer?tsrc=rsbedu'>How to edit a template footer in phpBB 3.0</a></td>
                </tr>
          <tr >
                        <td valign='top'>12.</td>
                        <td><a href='/support/edu/phpbb/general-settings/change-title?tsrc=rsbedu'>Modifying your header title in phpBB 3.0</a></td>
                </tr>
          <tr >
                        <td valign='top'>13.</td>
                        <td><a href='/support/edu/phpbb/general-settings/change-language?tsrc=rsbedu'>How to activate a new language in phpBB 3.0</a></td>
                </tr>
          	</table>
