<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:44857:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/opencart/204-working-with-affiliates-in-opencart" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="keywords" content="opencart affiliate commission" />
  <meta name="description" content="In this section, we'll discuss OpenCart's ability to support an affiliate program. " />
  <title>204: Working with Affiliates in OpenCart | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/opencart/204-working-with-affiliates-in-opencart" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:33ad9fac9ca522cc31842adec44dbdef -->
...
<div class='page-header'>
	<h1>204: Working with Affiliates in OpenCart</h1>
</div>
<div class='section_listing'>
		...
		<tr>
				...
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/opencart/204-working-with-affiliates-in-opencart/introduction-to-affiliates-in-opencart'>Introduction to Affiliates in OpenCart</a>
					<div>In this tutorial, we will explain the basics behind what affiliates are and how they work.</div>
					<div class='smallgrey'>Hits: 20,746</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/opencart/204-working-with-affiliates-in-opencart/manually-creating-affiliate-accounts-in-opencart'>Manually creating Affiliate accounts in OpenCart</a>
					<div>In this tutorial, we'll show you how to create an affiliate account manually in OpenCart.</div>
					<div class='smallgrey'>Hits: 6,850</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/opencart/204-working-with-affiliates-in-opencart/creating-an-affiliate-account-as-a-customer-in-opencart'>Creating an Affiliate account as a customer in OpenCart</a>
					<div>Learn how customers can create affiliate accounts on your OpenCart store without the administrator manually creating them. </div>
					<div class='smallgrey'>Hits: 5,812</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/opencart/204-working-with-affiliates-in-opencart/approving-affiliate-accounts-in-opencart'>Approving Affiliate accounts in OpenCart</a>
					<div>In this short tutorial, we'll show you how to approve affiliate accounts so they can be used to promote your products on your OpenCart website. </div>
					<div class='smallgrey'>Hits: 5,482</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/opencart/204-working-with-affiliates-in-opencart/deleting-an-affiliate-account-in-opencart'>Deleting an Affiliate Account in OpenCart</a>
					<div>In this tutorial, we'll show you how to delete an affiliate account in OpenCart.</div>
					<div class='smallgrey'>Hits: 2,910</div>
				</td>
			</tr>
			</table>
</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xNjEmaWQ9MTYxJnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
