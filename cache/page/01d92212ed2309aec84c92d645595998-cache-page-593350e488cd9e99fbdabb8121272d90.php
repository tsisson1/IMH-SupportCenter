<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:76790:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/general-server-setup/edit-mysql-my-cnf" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-07-14T00:59:44-07:00" />
  <meta name="keywords" content="edit change my cnf mycnf my.cnf mysql settings set configuration editing editing changing view viewing nano cat" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="Users with root access can edit their my.cnf through shell. This will explain how." />
  <title>How to edit the MySQL my.cnf file - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/general-server-setup/edit-mysql-my-cnf" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:e52f532fcb5aa5e8f8b47e716b27fe77 -->
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to edit the MySQL my.cnf file</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to edit the MySQL my.cnf file									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>97,597</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Dec 28, 2012'><span style='color:#606060;'>Published:</span> Jul 14, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>VPS and Dedicated server customers with <a target="_blank" href="/support/website/general-server-setup/root-access-faq">root access</a> can change their MySQL settings in the <strong>my.cnf</strong> file. To do this, you simply log in the server and edit the my.cnf file using Nano. This article will explain the steps to view and edit your my.cnf file.</p>
<h2>How to view MySQL settings in the my.cnf file</h2>
<ol class="article_list">
<li><a href="/support/website/general-server-setup/how-to-login-ssh" title="Click here for info" target="_blank"><strong>Login to your server via SSH</strong></a></li>
<li>To view the MySQL my.cnf settings <strong>type the following</strong>:
<pre style="margin-left: 20px;">cat /etc/my.cnf</pre>
<div style="clear: both;">&nbsp;</div>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/server-usage/edit-mysql-my-cnf/edit-my-cnf-1-cat.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="edit-my-cnf-1-cat" src="//cdn.inmotionhosting.com/support/images/stories/website/server-usage/edit-mysql-my-cnf/edit-my-cnf-1-cat.gif" title="Viewing the my.cnf with teh cat command" width="100" /></a>The contents of the my.cnf file will display similar to the snapshot to the right. <br style="clear: both;" /></p>
</li>
</ol>
<h2>Editing the MySQL my.cnf file</h2>
<ol class="article_list">
<li><a href="/support/website/general-server-setup/how-to-login-ssh" title="Click here for info" target="_blank"><strong>Login to your server via SSH</strong></a></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/server-usage/edit-mysql-my-cnf/edit-my-cnf-2-nano.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="image-moodle" src="//cdn.inmotionhosting.com/support/images/stories/website/server-usage/edit-mysql-my-cnf/edit-my-cnf-2-nano.gif" title="Using nano in shell" width="100" /></a>To edit the MySQL settings with nano <strong>type the following</strong>:
<pre style="margin-left: 20px;">nano /etc/my.cnf</pre>
...
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/server-usage/edit-mysql-my-cnf/edit-my-cnf-3-nano-view.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Nano the my.cnf in shell" src="//cdn.inmotionhosting.com/support/images/stories/website/server-usage/edit-mysql-my-cnf/edit-my-cnf-3-nano-view.gif" title="Click here to view the larger image" width="100" /></a><strong>Find the line to edit. </strong>For example, if you want to edit the max_connections, find the following line.
<pre style="margin-left: 20px;">max_connections=100</pre>
<br style="clear: both;" />
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/server-usage/edit-mysql-my-cnf/edit-my-cnf-4-change.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Changing the my.cnf with nano" src="//cdn.inmotionhosting.com/support/images/stories/website/server-usage/edit-mysql-my-cnf/edit-my-cnf-4-change.gif" title="Click here to view the larger image" width="100" /></a>To increase the max_connections to 110 change it to the following.</p>
<pre style="margin: 0px 0px 0px 20px;">max_connections=110</pre>
<br style="clear: both;" /></li>
...
<pre style="margin-left: 20px;">service mysql restart</pre>
<p>Now the max_connections is increased to 110 instead of 100.</p>
</li>
</ol>
<h2>Viewing the MySQL variables through shell.</h2>
<ol class="article_list">
<li><a href="/support/website/general-server-setup/how-to-login-ssh" title="Click here for info" target="_blank"><strong>Login to your server via SSH</strong></a></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/server-usage/edit-mysql-my-cnf/edit-my-cnf-5-variables.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Viewing the MySQL variables" src="//cdn.inmotionhosting.com/support/images/stories/website/server-usage/edit-mysql-my-cnf/edit-my-cnf-5-variables.gif" title="Click here to view the larger image" width="100" /></a>Type the following command.
<pre style="margin-left: 20px;">mysqladmin variables</pre>
<p>The variables will display similar to the snapshot to the right.<br style="clear: both;" /></p>
</li>
</ol>
<h2>Viewing MySQL variables in PhpMyAdmin</h2>
<ol class="article_list">
<li><strong>Log into your <a href="/support/website/cpanel/how-do-i-manage-a-mysql-database-in-phpmyadmin-in-my-control-panel-cpanel" target="_blank" title="Click here for info">phpMyAdmin</a></strong></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/server-usage/edit-mysql-my-cnf/edit-my-cnf-6-phpmyadmmin-variables.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Click variables tab in PhpMyAdmin" src="//cdn.inmotionhosting.com/support/images/stories/website/server-usage/edit-mysql-my-cnf/edit-my-cnf-6-phpmyadmmin-variables.gif" title="Click here to view the larger image" width="100" /></a><strong>Click the Variables tab</strong> at the top right. <br style="clear: both;" />
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/server-usage/edit-mysql-my-cnf/edit-my-cnf-7-mysql-variables.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="PhpMyAdmin list of MySQL variables" src="//cdn.inmotionhosting.com/support/images/stories/website/server-usage/edit-mysql-my-cnf/edit-my-cnf-7-mysql-variables.gif" title="Click here to view the larger image" width="100" /></a>PhpMyAdmin will list all the variables and there settings on your server..</p>
<br style="clear: both;" /></li>
</ol> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/general-server-setup/edit-mysql-my-cnf&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/general-server-setup/edit-mysql-my-cnf'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NCZpZD01MDImdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="6cb8b4b1f513697f2867839d941f9870" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/databases/i-want-to-change-maxconnections-on-dedicated-server?tsrc=rsbraq'>I want to change max_connections on dedicated server</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/7735fdc7561c6e3fb580420ced7cecfa?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/7735fdc7561c6e3fb580420ced7cecfa'>vivek</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-13 10:40 am</div>
				                <div><p>-bash and command not found error is coming when i m using this command in the ssh console plz help for this and thank you in advance :)</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12698);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-13 9:01 pm</div>
				                <div>Hello vivek,<br />
<br />
While looking at the commands, I did notice a typo in one of them. It should read as below:<br />
<div class="code_block">mysqladmin variables</div><br />
<br />
I have made the change on the article to display correctly.  It was wrong for a time, it seems. Thank you for finding that!<br />
<br />
If that is not the command giving you the error please let us know which one is giving you trouble as I do not see any others that should give an error.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12708);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-24904'></a>
		<div  style='margin:2px 0px 0px 80px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/2f27406d748016f8269c583265c7dcfb?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/2f27406d748016f8269c583265c7dcfb'>Julian</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-15 8:02 am</div>
				                <div><p></p>
<p></p>
<p class="MsoNormal" style="margin-bottom: .0001pt; line-height: normal; mso-layout-grid-align: none; text-autospace: none;"><span lang="EN-US" style="font-size: 9.0pt; font-family: 'Lucida Console'; mso-bidi-font-family: 'Lucida Console'; mso-ansi-language: EN-US;">I use:</span></p>
<p class="MsoNormal" style="margin-bottom: .0001pt; line-height: normal; mso-layout-grid-align: none; text-autospace: none;">&nbsp;</p>
<p class="MsoNormal" style="margin-bottom: .0001pt; line-height: normal; mso-layout-grid-align: none; text-autospace: none;"><span lang="EN-US" style="font-size: 9.0pt; font-family: 'Lucida Console'; mso-bidi-font-family: 'Lucida Console'; mso-ansi-language: EN-US;">mysqladmin -u db_user -pPASSWORD variables;</span></p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24904);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-16683'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/fee5795584f01ebcc14d0a342141795d?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/fee5795584f01ebcc14d0a342141795d'>Tisha</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-24 2:27 pm</div>
				                <div><p>Nice article.Thanks! I done for my mysql :)</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16683);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-23765'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/3e9ffc3b57ac4cb10810d64a4d22cc50?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/3e9ffc3b57ac4cb10810d64a4d22cc50'>Anurag</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-05-28 6:52 am</div>
				                <div><p>Hi,&nbsp;</p>
<p>I have made the bind address as 0.0.0.0 and can also see that my security group in AWS EC2 instance has outbound access for port 3306. Still i get connection failure with db. Any probable reasons plz ?&nbsp;</p>
<p>Regards,</p>
<p>Anurag</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23765);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-05-29 10:19 am</div>
				                <div>Hello Anurag,<br />
<br />
Thank you for contacting us. I recommend contacting Amazon, so they can help you review the server logs for records of connections, or failures.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23806);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
