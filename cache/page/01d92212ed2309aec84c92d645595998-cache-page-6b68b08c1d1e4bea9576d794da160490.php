<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:61293:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/whm/creating-and-managing-accounts/change-cpanel-username" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-07-17T15:53:23-07:00" />
  <meta name="keywords" content="cpanel username change WHM VPS Dedicated" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Learn how to change a cPanel username using your WHM (Web Host Manager)." />
  <title>How to change your cPanel username for VPS/Dedicated accounts - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/whm/creating-and-managing-accounts/change-cpanel-username" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:033daa286575517626975f4487d8a5d9 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to change your cPanel username for VPS/Dedicated accounts									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>4,553</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Oct 2, 2013'><span style='color:#606060;'>Published:</span> Jul 17, 2015</div>
							...
							<div style='clear:both;'></div>
								...
								<p>A fairly common request we see is how to change the cPanel username for an account. This is not allowed on a shared server and requires <a href="/support/website/ssh/root-access-faq">root access</a> even on the <a href="http://www.inmotionhosting.com/vps-hosting">VPS</a> and Dedicated accounts. The instructions below demonstrate how to change the cPanel username of an account within the Web Host manager (WHM).</p>

<h2>Changing the cPanel username in WHM </h2>

<ol class="article_list">
  <li><a href="/support/edu/whm/creating-and-managing-accounts/log-into-whm">Log into your WHM</a><div style="clear:both;"></div></li>
  <li>Locate <strong>Modify Account</strong> in the left hand sidebar and click on that option.<div style="clear:both;"></div></li>
    <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu//whm/change-cpanel-username/1-select-account.png"><img  style="float:right; margin:0px 0px 15px 15px;" alt="Select account to work with" src="//cdn.inmotionhosting.com/support/images/stories/edu//whm/change-cpanel-username/1-select-account.png" title="Click here to view the larger image" width="200" /></a>This leads you to the list of accounts on the server. Locate the account you want to work with. Click it to highlight it and then click on the <strong>Modify</strong> button.<div style="clear:both;"></div></li>
    <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/whm/change-cpanel-username/2-change-username-field.png"><img  style="float:right; margin:0px 0px 15px 15px;" alt="Edit the Username field" src="//cdn.inmotionhosting.com/support/images/stories/edu/whm/change-cpanel-username/2-change-username-field.png" title="Click here to view the larger image" width="200" /></a>You will now see a list of attributes you can change. Located at the top of the page is the <strong>Username</strong> field. Erase the current username and enter your new one there.<div style="clear:both;"></div></li>
    <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/whm/change-cpanel-username/3-new-username-list.png"><img  style="float:right; margin:0px 0px 15px 15px;" alt="View new username in list" src="//cdn.inmotionhosting.com/support/images/stories/edu/whm/change-cpanel-username/3-new-username-list.png" title="Click here to view the larger image" width="200" /></a>Once you have changed the cPanel username, click on the <strong>Save</strong> button. You should get a success message indicating that the name has been changed. The image below displays a new cPanel username as it will appear in the account list.<div style="clear:both;"></div></li>
</ol>

            <p></p>
            <p>Once the cPanel username is changed, you can use it to log into the cPanel. Be aware that you may need to alter the code for any program that uses thecPanel username to connect to the site or server.</p>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 2: How to change your cPanel username for VPS/Dedicated accounts</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 1: <a href='/support/edu/whm/creating-and-managing-accounts/change-theme'>How to Change your Softaculous Theme in WHM</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 3: <a href='/support/edu/whm/creating-and-managing-accounts/log-into-whm'>How to log into your Web Host Manager (WHM)</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/whm/creating-and-managing-accounts/change-cpanel-username&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/whm/creating-and-managing-accounts/change-cpanel-username'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xNDkmaWQ9Mjg2MyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/915292cba516f4d84b72b73943c65b99?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/915292cba516f4d84b72b73943c65b99'>muhammad adil</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-24 9:39 am</div>
				                <div><p>gooooooooooooooooooooooooooood</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10881);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
