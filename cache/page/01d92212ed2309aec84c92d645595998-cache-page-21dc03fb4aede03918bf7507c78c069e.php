<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50745:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/website-troubleshooting/run-php-via-shtml" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, The best way to do this would to have the server treat your .shtml as a .php file by adding the following to your .htaccess: ForceType applicatio..." />
  <title>run php via shtml | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/website-troubleshooting/run-php-via-shtml" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:787a1d6ea6c880f87d3934fbf17a892e -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>run php via shtml</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2014-12-07 3:36 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>93</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Hello, I am trying to include/run a php file via a shtml. I have the following two files inside my public_html directory:<br />
<br />
[file: hello.shtml]<br />
<br />
&lt;!DOCTYPE HTML&gt;<br />
...
?&gt;<br />
<br />
When I try to browse to www.[my_domain].com/hello.shtml, all it shows is &quot;[an error occurred while processing this directive]&quot;<br />
<br />
I know the php file has correct syntax because www.[my_domain].com/hello.php shows &quot;Hello, World!&quot;.<br />
<br />
I have created a .htaccess  and filled it as suggested here: http://www.inmotionhosting.com/support/website/php/php-code-in-html-file?tsrc=aaq<br />
<br />
AddType text/html .shtml .shtm .htm .html<br />
AddHandler server-parsed .shtml .shtm .htm .html <br />
Options Indexes FollowSymLinks Includes<br />
AddHandler application/x-httpd-php54 .shtml<br />
<br />
Now the error is gone but the shtml page is blank. I'd expect to see &quot;Hello, World!&quot;<br />
<br />
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_6094' id='upvote_answer_6094' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='6094' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_6094').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_6094' id='downvote_answer_6094' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='6094' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_6094').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
The best way to do this would to have the server treat your .shtml as a .php file by adding the following to your .htaccess:<br />
<br />
<Files *.shtml><br />
ForceType application/x-httpd-php<br />
</Files><br />
<br />
Then you would be able to use the php include code to add your hello world script to your .shtml file.<br />
<br />
Kindest Regards,<br />
TJ Edens
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_6094').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_6094' id='form_comment_on_answer_6094' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/website-troubleshooting/run-php-via-shtml&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/website-troubleshooting/run-php-via-shtml'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="432438c31878dd6dfa6fe3dc57ea6c29" value="1" />	</div>
	</form>
<!-- <br />
