<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:53853:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/joomla/kunena-forum-latest-module-for-joomla-351" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, Thank you for your question regarding Kunena Modules. There has to be some sort of caching going on either with your browser or with your Joomla...." />
  <title>Kunena Forum Latest Module For Joomla 3.51 | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/joomla/kunena-forum-latest-module-for-joomla-351" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:ca2d538a7967fb766d650449235caa33 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Kunena Forum Latest Module For Joomla 3.51</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2016-04-29 12:15 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>27</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Kunena Forum Latest Module is installed on a website with Joomla 3.5.1  with the cache turned off in system preferences and in the Kunena configuration.  There are two modules configured.  One has no issue at all.  I duplicate that module and I change one setting - to display a favorite instead of a recent post and it  only works sometimes. When the module is not showing content I have to go back to the forum post and un-favorite it and then select favorite again and it works.  I've deleted the module and tried again and no luck. Also that same module is now displaying content in Safari but not FireFox.</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_9796' id='upvote_answer_9796' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='9796' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_9796').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_9796' id='downvote_answer_9796' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='9796' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_9796').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
Thank you for your question regarding Kunena Modules. There has to be some sort of caching going on either with your browser or with your Joomla. Have you tried opening your browser in something like private or incognito mode?<br />
<br />
Best Regards,<br />
TJ Edens
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_9796').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_9796' id='form_comment_on_answer_9796' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>I appreciate the response TJ. I disabled the cache in Joomla and Kunena for that reason. The second module does not load in FireFox or Chrome at all but the first one does. I disabled the module until I can get this one solved. I was wondering if it could be an issue with the template? </div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='/support/images/avatars/default_avatar.jpg' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/bjb'>bjb</a><br />
									3 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2016-04-29 1:51 pm EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello Bjb,<br />
<br />
It is very possible it is due to the theme but it would not explain why it is showing in one browser and not the others. However there have been things in the past if websites do not have correct view-ports for safari browsers.<br />
<br />
Best Regards,<br />
TJ Edens</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/joomla/kunena-forum-latest-module-for-joomla-351&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/joomla/kunena-forum-latest-module-for-joomla-351'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="e18b4acf651eadd67e2ac46826992251" value="1" />	</div>
	</form>
<!-- <br />
