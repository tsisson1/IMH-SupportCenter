<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50477:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/general-server-setup/can-you-please-increase-max-allowed-packet-size-for-my-server" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Thank you for your question canna! We checked your php.ini on line 160 and the max_allowed_packet = 32m. You can edit this by going to your php.ini in y..." />
  <title>Can you please increase max allowed packet size for my server?   | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/general-server-setup/can-you-please-increase-max-allowed-packet-size-for-my-server" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:08dda97a703b2168022a6d9c98738fa5 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Can you please increase max allowed packet size for my server?  </h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/canna'>canna</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-12-07 4:25 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>2,273</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Right now it is <br />
&quot;MAX_ALLOWED_PACKET 	5242880&quot;<br />
<br />
Can you please increase it to at least 16mb? 64mb or more would be nice, but i need at least 16mb to run my applications.  Thanks!</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_1967' id='upvote_answer_1967' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='1967' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_1967').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_1967' id='downvote_answer_1967' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='1967' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_1967').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>5,889 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2012-12-07 9:55 am EST
                		        </div>
					
		                </div>

				Thank you for your question canna!<br />
<br />
We checked your php.ini on line 160 and the &lt;strong&gt;max_allowed_packet = 32m&lt;/strong&gt;. You can edit this by going to your php.ini in your public_html and changing the value. Please see the following link on this.<br />
&lt;a href=&quot;http://www.inmotionhosting.com/support/website/general-server-setup/update-local-php-settings&quot; target=&quot;_blank&quot;&gt;How to update your local php settings&lt;/a&gt;<br />
<br />
The php.ini will need to be recursive to work in the subfolders. Please see the following link.<br />
&lt;a href=&quot;http://www.inmotionhosting.com/support/website/general-server-setup/recursive-php-ini&quot; target=&quot;_blank&quot;&gt;How can I make my php.ini file recursive ?&lt;/a&gt;<br />
<br />
Also, the .htaccess has &lt;strong&gt;php_flag&lt;/strong&gt; and &lt;strong&gt;php_value&lt;/strong&gt; settings in there. These will be problematic on a SuPhp server because the directives are set in the php.ini not the .htaccess. You will want to comment these lines by adding a # in front of them on the line.<br />
<br />
If these changes do not fix your errors, we will need steps to replicate the problem.<br />
<br />
Regards<br />
James R
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_1967').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_1967' id='form_comment_on_answer_1967' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/general-server-setup/can-you-please-increase-max-allowed-packet-size-for-my-server&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/general-server-setup/can-you-please-increase-max-allowed-packet-size-for-my-server'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="77815ba4d57a6bec6fe7024f5e7c40e3" value="1" />	</div>
	</form>
<!-- <br />
