<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:64808:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/moodle/user-roles-moodle/browse-list-of-users" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-10-24T20:35:01-07:00" />
  <meta name="keywords" content="browse search list users user site administration filter add accounts new show advanced remove filters profile" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="Once the users are set up in Moodle 2.3, the administrator may need to view certain users in the database. This tutorial will explain the Browse list of users in the Site administration section." />
  <title>Browsing and filtering users in the Moodle Site Administration - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/moodle/user-roles-moodle/browse-list-of-users" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:4945dadf9fc5468f2842667c75e403ff -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '62.210.111.43']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Browsing and filtering users in the Moodle Site Administration									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>174,069</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Oct 24, 2012'><span style='color:#606060;'>Published:</span> Oct 24, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Once the users are set up in Moodle, the administrator may need to view certain users in the database. The <strong>Browse list of users</strong> in the Site administration section is available for this. The following article will walk through the basics of how to search users in Moodle 2.3. If the last article was missed, please visit <a target="_blank" href="/support/edu/moodle/user-roles-moodle/bulk-user-actions" title="Click here to view the previous article">Running bulk user actions in Moodle</a>.</p>
<h3>Viewing, filtering, and browsing the list of users</h3>
...
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/105/browse-list-of-users/browse-list-of-users-1-click.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="browse-list-of-users-1-click-moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/105/browse-list-of-users/browse-list-of-users-1-click.gif" title="Click here to view the larger image" width="200" /></a>In the <strong>Settings</strong> section on the left, navigate to <strong>Site administration</strong> &gt; <strong>Users</strong> &gt; <strong>Accounts</strong> &gt; <strong>Browse list of users</strong>.
<p class="alert"><strong>Important!</strong> <a target="_blank" href="/support/edu/moodle/creating-courses/creating-courses-in-moodle" title="Click for more information">Editing must be turned on</a> in the <strong>Settings</strong> &gt; <strong>Front Page Settings</strong> section in order to edit any of these options.</p>
<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/105/browse-list-of-users/browse-list-of-users-2-new.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="browse-list-of-users-2-new-moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/105/browse-list-of-users/browse-list-of-users-2-new.gif" title="Click here to view the larger image" width="200" /></a>In this section, the users will list according to the <em>First name / Surname</em>. The fields shown when viewing the list of users are <em>First name / Surname, Email address, City/town, Country, Last access,</em> and <em>Edit</em>. The list can be filtered in the<strong> New Filter</strong> box. The users by default can be filtered by <em>User Full Name</em>. For more Filtering options, click the <strong>Show Advanced</strong> button.<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/105/browse-list-of-users/browse-list-of-users-3-advanced.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="browse-list-of-users-3-advanced-moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/105/browse-list-of-users/browse-list-of-users-3-advanced.gif" title="Click here to view the larger image" width="200" /></a>In the <strong>Advanced filter</strong> section, additional options for searching users is available. First name, email address, City/Town, Country, the user role, modification dates. and site access are available for searching. In this tutorial, a filter for finding a misspelled City/Town will be set up. Once the parameters are set click <strong>Add filter</strong>.<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/105/browse-list-of-users/browse-list-of-users-4-narrowed.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="browse-list-of-users-4-narrowed-moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/105/browse-list-of-users/browse-list-of-users-4-narrowed.gif" title="Click here to view the larger image" width="200" /></a>Next the list will show with the filtered parameters. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/105/browse-list-of-users/browse-list-of-users-5-remove.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="browse-list-of-users-5-remove-moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/105/browse-list-of-users/browse-list-of-users-5-remove.gif" title="Click here to view the larger image" width="200" /></a>To remove the filter, check the check box next to the filter and click <strong>Remove selected</strong>. To remove all filters click <strong>Remove all filters</strong>. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/105/browse-list-of-users/browse-list-of-users-6-select.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="browse-list-of-users-6-select-moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/105/browse-list-of-users/browse-list-of-users-6-select.gif" title="Click here to view the larger image" width="200" /></a>To view a specific profile for a user click the <em>First name / Surname</em> of the user. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/105/browse-list-of-users/browse-list-of-users-7-view.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="browse-list-of-users-7-view-moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/105/browse-list-of-users/browse-list-of-users-7-view.gif" title="Click here to view the larger image" width="200" /></a>The Users Public Profile will load. <br style="clear: both;" /></li>
</ol>
<p>This concludes the tutorial for Browsing and filtering users in the Moodle Site Administration. Please check the next article on <a target="_blank" href="/support/edu/moodle/user-roles-moodle/user-cohorts" title="Click here to view the next article">Creating Cohorts in the Moodle site administration</a>. For more information on this Education Channel please visit <a target="_blank" href="/support/edu/moodle/user-roles-moodle" title="Click here to view the courses">Managing users and roles in Moodle</a></p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 4: Browsing and filtering users in the Moodle Site Administration</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 3: <a href='/support/edu/moodle/user-roles-moodle/bulk-user-actions'>Running bulk user actions in Moodle</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 5: <a href='/support/edu/moodle/user-roles-moodle/user-cohorts'>Creating Cohorts in the Moodle site administration</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yODcmaWQ9MTkyMyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="410ae59fe657e79f55585832fd8069b4" value="1" />	</div>
	</form>
<!-- <br />
