<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:69951:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/prestashop-15/getting-started/manual-install" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-02-10T18:05:36-08:00" />
  <meta name="keywords" content="manually install prestashop 1.5" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="In this PrestaShop 1.5 tutorial, we'll walk you through the steps for manually installing PrestaShop 1.5." />
  <title>How to manually install Prestashop 1.5 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/prestashop-15/getting-started/manual-install" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:2f693d21c24b0966cea56efea0df4b1d -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to manually install Prestashop 1.5									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>11,641</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: May 14, 2012'><span style='color:#606060;'>Published:</span> Feb 10, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Prestashop 1.5 is an online shopping cart that can be installed on most web hosting accounts. You can install PrestaShop 1.5 to run an e-commerce website and sell both tangible products and downloadable products. It's relatively new in the e-commerce world, but over the last few years PrestaShop has made quite a name for itself. In this PrestaShop 1.5 tutorial, we'll walk you through the steps for installing PrestaShop 1.5.</p>
<h2>Manually installing PrestaShop 1.5</h2>
<ol class="article_list">
<li>Visit the <a rel="nofollow" target="_blank" href="http://www.prestashop.com/en/developers-versions">PrestaShop Download</a> page and click on <strong>Download Now</strong><br /><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/prestashop1.5/install-prestashop/download-prestashop-1.5.gif"><img src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/prestashop1.5/install-prestashop/download-prestashop-1.5.gif" alt="download-prestashop-1.5"  /></a></li>
<li>Extract the file you just download - <strong>prestashop_1.5.0.9.zip</strong></li>
<li>When you extract the files, you will see a folder named <strong>prestashop_1.5.0.9</strong> and within that another named <strong>prestashop</strong>. Open the "prestashop" folder and upload to your server all the files within that folder (do not upload the folder itself).</li>
<li>PrestaShop requires a database in order to run, so you'll want to make sure you have a database setup. If you are an InMotion Hosting customer, use the <a href="/support/website/cpanel/how-do-i-create-a-mysql-database-in-my-control-panel-cpanel">MySQL Database Wizard</a>. Please be sure to keep note of your database name, username, and password.</li>
<li>Access the <strong>PrestaShop Wizard Installer</strong> by Visiting the URL you uploaded the PrestaShop files to. In our testing here, we visited prestashop.inmotiontesting.com<br /><br /><strong>Step 1: Welcome</strong><br />On the "Welcome" step, choose your installer language, read and accept the terms and conditions, and then click Next<br /><br /><strong>Step 2: System Compatibility</strong><br />The next step will check to ensure your server is compatible with PresaShop 1.5. InMotion Hosting's default server setup will pass the minimum requirements, so simply click Next.<br /><br /><strong>Step 3: System Configuration</strong><br />Update your Database name, Database login, and Database password with the MySQL credentials you created above. For most servers, you can leave the other settings to their default. Click Verify Now, and if your settings pass, click Next<br /><br /><strong>Step 4: Shop Configuration</strong><br />On this page, enter the basic details about your shop. If you're new to PrestaShop 1.5, we recommend choosing the option to install the sample data as well. Click Next to continue.<br /><br /><strong>Step 5: Installation process</strong><br />At this time, you will see a progress bar on the screen. It should take less than 1 minute as the Prestashop installer configures your database and the rest of your shop. When the installer is complete, you will see a success message:<br /><br />Your installation is finished!<br />You have just finished to install and configure your shop, thank you for using PrestaShop!<br />WARNING: For security purposes, you must delete the "install" folder.</li>
<li>As per the installation instructions, <strong>delete the install folder</strong>. After deleting the install folder, you have successfully installed PrestaShop 1.5! Visit your website and you should see PrestaShop installed, as per our screenshot below:<br /><br /><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/prestashop1.5/install-prestashop/prestashop-1.5-successfully-installed.gif"><img src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/prestashop1.5/install-prestashop/prestashop-1.5-successfully-installed.gif" alt="prestashop-1.5-successfully-installed"  /></a></li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 2: How to manually install Prestashop 1.5</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 1: <a href='/support/edu/prestashop-15/getting-started/how-to-install-prestashop-with-softaculous'>How to install PrestaShop with Softaculous</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 3: <a href='/support/edu/prestashop-15/getting-started/login-to-dashboard'>How to log into PrestaShop 1.5 Dashboard</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/prestashop-15/getting-started/manual-install&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/prestashop-15/getting-started/manual-install'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yMjkmaWQ9MTMwOSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="9b17f91cbbcf2df450ec07983c4a2a81" value="1" />	</div>
	</form>
<!-- <br />
          ...
          <tr >
			...
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/prestashop-15/prestashop-how-to-delete-install-folder?tsrc=rsbraq'>prestashop- how to delete &quot;/install folder?</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/prestashop-15/what-happened-to-prestashop-v15?tsrc=rsbraq'>What happened to Prestashop v1.5?</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/5013550b811f5bdcf6cdcb5f282c7149?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/5013550b811f5bdcf6cdcb5f282c7149'>Murugappan Ramanathan</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-20 2:31 am</div>
				                <div><p>The instructions given does clearly define how to upload the files and also the location to upload the files to. I want to install the latest version of Prestashop without the sample data. Please help.</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29940);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-20 10:47 am</div>
				                <div>Hello Murugappan,<br />
<br />
There does not appear to be a way to load PrestaShop WITHOUT the demo data.  However, there is an option in the PrestaShop dashboard called DEMO MODE.  You can turn it off.  Here's a <a href="http://screencast.com/t/kLGITEbz" rel="nofollow" target="_blank">screen shot</a>.  I hope this helps to answer your question, please let us know if you require any further  assistance.<br />
<br />
Regards,<br />
Arnel C.<br />
<br />
</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29951);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-21 9:52 pm</div>
				                <div><p>Dear Arnel,</p>
<p>&nbsp;</p>
<p>This does not answer the problem. I checked Prestashop site and they have a version without the sample data which i have installed in my local server. Its seems the in motion has a whole bunch of outdated apps.</p>
<p>Please check and advise if i am paying for outdated material in your hosting site and may result in me requested for money-back and also publishing my finding in a blog.</p>
<p>&nbsp;</p>
<p>Thank you.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30014);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-23 3:15 am</div>
				                <div>Hello Murugappan,<br />
<br />
If you are on our shared servers then you may see slightly outdated software in the Softaculous feature as we have to test and approve software to make sure it would have vastly negative effects if may people use it on the same server. This is to help prevent downtime from overloaded servers. Alternatively you could manually install the software or go to a VPS as then you would have control over the version that are displayed in your Softaculous. <br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30048);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
