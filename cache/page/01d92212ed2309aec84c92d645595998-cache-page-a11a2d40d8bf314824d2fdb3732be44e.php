<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:74326:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/how-to/how-do-i-restart-my-server" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-12-01T15:40:14-08:00" />
  <meta name="keywords" content="Restart Server WHM ssh AMP 2xram" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="You can restart your server by using the AMP panel, Shell, or WHM. Read this article to learn how." />
  <title>How do I restart my server? - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/how-to/how-do-i-restart-my-server" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<script type="text/javascript">
		...
		_gaq.push(['_setCustomVar', 4, 'DateMonthPublished', '2013-07', 3]);
	...
	<!-- cid:2eeb16f3c982eb1faec54a8f71197e45 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '109.2.159.30']);
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>26,967</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jul 9, 2013'><span style='color:#606060;'>Published:</span> Dec 1, 2015</div>
							...
							<div style='clear:both;'></div>
								...
								<center><iframe width="560" height="315" src="https://www.youtube.com/embed/q6_R7JT5BEk" frameborder="0" allowfullscreen></iframe></center>
Here's a quick summary of how to <strong>reboot</strong> <a href="http://www.inmotionhosting.com/vps-hosting">VPS</a> and <a href="http://www.inmotionhosting.com/dedicated-servers">Dedicated</a> <strong>servers</strong>.
<div class="in_this_tutorial">

  <p><button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('shared');">Request Support for reboot</button></p><p>Business Level accounting: Contact Live Technical Support to request reboot</p>
  

  <p> <button type="button" class="btn btn-success" onclick="trackAnchorClickSC('whm-restart');">WHM restart</button><button type="button" class="btn btn-success" onclick="trackAnchorClickSC('amp-restart');">AMP Restart</button> </p><p>VPS (without Root access): Able to restart services in WHM.  They can also restart services by using AMP.</p>

<p><button type="button" class="btn btn-success" onclick="trackAnchorClickSC('amp-restart');">AMP Restart</button><button type="button" class="btn btn-warning" onclick="trackAnchorClickSC('whm-restart');">WHM Restart</button><button type="button" class="btn btn-warning" onclick="trackAnchorClickSC('cmdline');">Command Line Reset</button></p><p>VPS (with Root access): Able to restart all services in WHM, AMP, or through Command line. <b>A restart button for the server is available in WHM, but do not use it.</b> </p>

<p><button type="button" class="btn btn-success" onclick="trackAnchorClickSC('whm-restart');">WHM restart</button></p><p>Dedicated(without Root access) can restart services in WHM. <a href="http://www.inmotionhosting.com/support/component/content/help/how-to-get-great-technical-support?Itemid=204">Contact Live Technical Support</a> to request reboot</p>


  <p><button type="button" class="btn btn-success" onclick="trackAnchorClickSC('whm-restart');">WHM restart</button><button type="button" class="btn btn-warning" onclick="trackAnchorClickSC('cmdline');">Command Line Reset</button></p><p><a href="http://www.inmotionhosting.com/dedicated-servers">Dedicated Server</a> (with Root access): Can restart services or the server in WHM or with the command line.</p>

</div>


<p>For different reasons, VPS customers may want to restart their server services. This is similar to rebooting the server; except, rebooting the actual hardware is "rebooting" the server. Restarting the services restarts the <strong>Apache</strong>, <strong>MySQL</strong>, or <strong>Email</strong> <strong>services</strong> that run on the server. The services for VPS servers can be restarted through the WHM or through shell access. In the event you cannot use shell or the WHM, you can restart your VPS through the Account Management Panel. This article will show you how.</p>

<p class="alert"><strong>Note!</strong> Before your restart your VPS services, you will want to read our article on <a href="http://www.inmotionhosting.com/support/website/server-usage/when-should-i-restart-my-vps" target="_blank">When should I restart my VPS</a>.</p>

<a name='shared'></a>
<h2>Restarting shared business plan servers</h2>

<p>Shared server services do not need to be restarted unless our systems support sees an issue requiring the server to be restarted. If you believe your server services need to be restarted, please contact <a href="/support/component/content/help/how-to-get-great-technical-support?Itemid=204" target="_blank" title="Click here for how to contact support">tech support</a> and they can look further into this.</p>

<a name='amp-restart'></a>
<h2>Steps to restart your VPS in AMP</h2>
...
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/amp/restart-vps-server/restart-vps.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="AMP VPS Restart services click details" src="//cdn.inmotionhosting.com/support/images/stories/amp/restart-vps-server/restart-vps.png" title="Click here to view the larger image" width="100" /></a>Locate your server and click the <strong>Restart VPS</strong> button.
<br style="clear: both;" />
</li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/amp/restart-vps-server/amp-vps-restart-3-select.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="AMP VPS Restart services Select" src="//cdn.inmotionhosting.com/support/images/stories/amp/restart-vps-server/amp-vps-restart-3-select.png" title="Click here to view the larger image" width="100" /></a>Expand the <em>Restart VPS</em> drop box and click the "<em>Restart VPS</em>" button. Then, allow time for the server to restart.
<br style="clear: both;" /></p></li>
</ol>

<a name='cmdline'></a>
<h2>Restarting VPS and dedicated server with command line</h2>

<p>Customers can restart their server services through the WHM or through Shell access. Please see the below tutorials on how to restart your services through WHM and through command line. You can <a href="/support/component/content/domain-names/general-information/how-to-login-ssh?Itemid=214" target="_blank">shell into your server</a> and stop and start your httpd services for your website. See the following commands.</p>

<div class="img-rounded" style="border:1px solid #cccccc;padding:0px 10px 10px 10px">
<h3>Stop Apache</h3>
<pre style="padding:5px;">root@vps### [~]# service httpd stop</pre>
<h3>Start Apache</h3>
<pre style="padding:5px;">root@vps### [~]# service httpd start</pre>
<h3>Checks the Apache server status</h3>
<pre style="padding:5px;">root@vps### [~]# service httpd status</pre>

<p>You can also restart MySQL also with the following commands</p>
<h3>Stop MySQL</h3>
<pre style="padding:5px;">root@vps### [~]# service mysql stop</pre>
<h3>Start MySQL</h3>
<pre style="padding:5px;">root@vps### [~]# service mysql start</pre>
<h3>Checks the MySQL server status</h3>
<pre style="padding:5px;">root@vps### [~]# service mysql status</pre>
</div>


<a name ='whm-restart'></a>
<h2>Restarting a VPS or Dedicated server with WHM</h2>

<ol class="article_list white_box">

<li><a href="/support/component/content/email/email-client-setup/log-into-whm?Itemid=242" target="_blank" title="Click here for info">Log into WHM</a>.</li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/amp/restart-vps-server/amp-vps-restart-6-type.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="type AMP VPS Restart services" src="//cdn.inmotionhosting.com/support/images/stories/amp/restart-vps-server/amp-vps-restart-6-type.png" title="Click here to view the larger image" width="100" /></a>Type "<em>restart</em>" in the search box at the top left to find the "<em>Restart Services</em>" section.
<br style="clear: both;" /></li>
 
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/amp/restart-vps-server/amp-vps-restart-7-click.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="AMP VPS Restart services click restart" src="//cdn.inmotionhosting.com/support/images/stories/amp/restart-vps-server/amp-vps-restart-7-click.png" title="Click here to view the larger image" width="100" /></a>To restart Apache, select <strong>HTTP Server (Apache)</strong> and click <strong>Yes</strong>.
<br style="clear: both;" />
</li>
...
<div style='display:inline-block;'>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zNSZpZD0yNzgyJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="a7b282ad5b4172632fa43bfa8d5e4ddf" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/6a9c97d6dce5df519ef80af2cb147965?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/6a9c97d6dce5df519ef80af2cb147965'>JOSEPH MUMO</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-25 6:47 am</div>
				                <div><p>The outlook in my computor is not displaying any email. What should i do?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15496);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-25 9:33 am</div>
				                <div>Hello JOSEPH,<br />
<br />
Thank you for your question. First, I recommend following our <a href="http://www.inmotionhosting.com/support/email/outlook/2013">Outlook Setup</a> guide. This should allow you to check your email.<br />
<br />
If you have already set your email up successfully, and it just stopped displaying email, restarting Outlook may help.<br />
<br />
I you have any further questions, feel free to post them below.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15509);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-24753'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/c3776c72da1ecc59d4e662ff4ad02731?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/c3776c72da1ecc59d4e662ff4ad02731'>Kawaljit Singh</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-10 12:36 am</div>
				                <div><p>http://example.com/journals/index.php/jisct/article/download/161/117. After migration I am not able to access pdf file. I am using OJS script. Will you help me?</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24753);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-10 1:47 pm</div>
				                <div>Hello Kawaljit,<br />
<br />
Thank you for contacting us. I tested the link you provided, and the pdf file downloaded successfully for me at this time.<br />
<br />
Are you still experiencing issues with downloading this pdf file?<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24773);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
