<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:75880:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/general-server-setup/install-mbstring-easy-apache" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-12-21T19:14:08-08:00" />
  <meta name="keywords" content="mbsting extension installed  server Easy Apache how to install easyapache checking" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="The mbsting extension can be installed on a server using Easy Apache. This will explain how to install the mbstring extension." />
  <title>Installing the mbstring extension with Easy Apache - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/general-server-setup/install-mbstring-easy-apache" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:10a6b57876ee97a79dcb7c4790798fd1 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '212.178.206.241']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Installing the mbstring extension with Easy Apache									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>23,973</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Dec 21, 2012'><span style='color:#606060;'>Published:</span> Dec 21, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>When configuring a website to work with different languages on a Linux server, the mbstring extension will need to be installed on the server for the website functionality to work. The mbstring extension is what php uses to parse different language encoding's. This article will explain how to install the mbstring extension through shell.</p>
<p class="alert">NOTE! In order to follow any of these instructions, you must have Root access on your VPS or Dedicated server. If you are on a shared server, <a target="_blank" href="/support/website/website-troubleshooting/how-to-get-great-technical-support">you will need to contact support</a> to have the extension installed.</p>
<h2>Checking for the mbstring through shell</h2>
<p>Check your server for the mbstring extension through Linux Command line. Running the following command will display the mbstring information on your server.</p>
<div style="margin-left: 20px;">
<p style="font-family: Courier New, Courier, monospace;">root@vps#### [~]# php -m | grep mbstring</p>
</div>
<p>If the results show nothing, then the mbstring is not installed on the server. The next section will explain how to install the mbstring extension through shell with Root access.</p>
<h2>Steps to install the mbstring extension</h2>
<p>The mbstring extension can be installed through shell by using Easy Apache. The following steps will explain how to install mbstring through Easy Apache.</p>
<p class="alert"><strong>Important!</strong> This is for Virtual Private Servers or Dedicated server with <a target="_blank" href="/support/website/general-server-setup/root-access-faq">ROOT ACCESS</a>. If you do not have root access, you will need to <a target="_blank" title="Click here for info on SSH" href="/support/website/website-troubleshooting/how-to-get-great-technical-support">have support install</a> the mbstring extension for you.</p>
<ol class="article_list">
<li><a target="_blank" href="/support/website/general-server-setup/how-to-login-ssh" title="Click for more information">Shell (SSH) into the server.</a></li>
<li>Start a screen session by typing the following. <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/server-usage/installing-mbstring-easy-apache/mbstring-install-1-screen-session.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="Installing mbsting step one set up Screen Session" src="//cdn.inmotionhosting.com/support/images/stories/website/server-usage/installing-mbstring-easy-apache/mbstring-install-1-screen-session.gif" title="Click here to view the larger image" width="100" /></a>
<div style="margin-left: 20px;">
<p class="code_block">root@vps#### [~]# screen -S screenname</p>
</div>
<br style="clear: both;" />
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/server-usage/installing-mbstring-easy-apache/mbstring-install-2-check-screen.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Checking the Screen session" src="//cdn.inmotionhosting.com/support/images/stories/website/server-usage/installing-mbstring-easy-apache/mbstring-install-2-check-screen.gif" title="Click here to view the larger image" width="100" /></a>You can check the screen by typing the following.</p>
<div style="margin-left: 20px;">
<p class="code_block">root@vps#### [~]# screen -ls<br /> There is a Screen on:<br /> <span style="margin-left: 50px;">22342.upgrade</span> <span style="margin-left: 25px;">(Attached)</span><br /> 1 Socket in /var/run/screen/S-root</p>
</div>
<p>The screen session will allow the server to run in the background. This is to prevent the process from being interupted during the recompile process. If the window is closed, The process can still be found on the server. Otherwise, the process will be killed which could break the server.<br style="clear: both;" /></p>
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/server-usage/installing-mbstring-easy-apache/mbstring-install-3-type-easy-apache-path.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Type the Easy Apache Path" src="//cdn.inmotionhosting.com/support/images/stories/website/server-usage/installing-mbstring-easy-apache/mbstring-install-3-type-easy-apache-path.gif" title="Click here to view the larger image" width="100" /></a>Type the path for Easy Apache.
<div style="margin-left: 20px;">
<p class="code_block">root@vps#### [~]# /scripts/easyapache</p>
<br style="clear: both;" /></div>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/server-usage/installing-mbstring-easy-apache/mbstring-install-4-cpanel-update.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Cpanel Update Screen Select No" src="//cdn.inmotionhosting.com/support/images/stories/website/server-usage/installing-mbstring-easy-apache/mbstring-install-4-cpanel-update.gif" title="Click here to view the larger image" width="100" /></a>When you get the <em>"cPanel update available"</em> box saying "<em>would you like to update now</em>," <strong>select No and hit Enter</strong>.<br style="clear: both;" /></p>
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/server-usage/installing-mbstring-easy-apache/mbstring-install-5-start-customizing.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Start Customizing based on profile" src="//cdn.inmotionhosting.com/support/images/stories/website/server-usage/installing-mbstring-easy-apache/mbstring-install-5-start-customizing.gif" title="Click here to view the larger image" width="100" /></a><strong>Select Start customizing based on profile and hit Enter.</strong><br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/server-usage/installing-mbstring-easy-apache/mbstring-install-6-choose-apache-build.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Choosing the specific apache to build" src="//cdn.inmotionhosting.com/support/images/stories/website/server-usage/installing-mbstring-easy-apache/mbstring-install-6-choose-apache-build.gif" title="Click here to view the larger image" width="100" /></a>On the <em>"Please choose which apache to build</em> screen," <strong>leave the selected build</strong>.
<p><strong>Select Next step and hit Enter.</strong><br style="clear: both;" /></p>
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/server-usage/installing-mbstring-easy-apache/mbstring-install-7-choose-php-version.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Choose specific php to build" src="//cdn.inmotionhosting.com/support/images/stories/website/server-usage/installing-mbstring-easy-apache/mbstring-install-7-choose-php-version.gif" title="Click here to view the larger image" width="100" /></a><strong>Leave the selected php version</strong> on the <em>"Please choose which specific PHP version (s) to build" </em>screen.
<p><strong>Select Next Step and hit Enter.</strong><br style="clear: both;" /></p>
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/server-usage/installing-mbstring-easy-apache/mbstring-install-8-short-options.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Short list Options" src="//cdn.inmotionhosting.com/support/images/stories/website/server-usage/installing-mbstring-easy-apache/mbstring-install-8-short-options.gif" title="Click here to view the larger image" width="100" /></a>The "<em>Short Options List"</em>will appear.
<p><strong>Select "Exhaustive options list" and hit Enter.</strong><br style="clear: both;" /></p>
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/server-usage/installing-mbstring-easy-apache/mbstring-install-9-select-mbstring.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Select mbstring from the list" src="//cdn.inmotionhosting.com/support/images/stories/website/server-usage/installing-mbstring-easy-apache/mbstring-install-9-select-mbstring.gif" title="Click here to view the larger image" width="100" /></a>Page down till you see the Mbstring extension listed.
<p><strong>Arrow down to the Mbstring extension and hit the space bar</strong> to select the Mbstring.</p>
<p><strong>Select Next Step and hit enter.</strong><br style="clear: both;" /></p>
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/server-usage/installing-mbstring-easy-apache/mbstring-install-10-save-build.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Save the Apache Php build" src="//cdn.inmotionhosting.com/support/images/stories/website/server-usage/installing-mbstring-easy-apache/mbstring-install-10-save-build.gif" title="Click here to view the larger image" width="100" /></a>Now the server will ask <em>"What do you want to do now?"</em>
<p class="alert"><strong style="color: #ff0000;">!! EXTREMELY IMPORTANT !! IF YOU ARE NOT IN A SCREEN SESSION. DO NOT INTERUPT THE SERVER PROCESS</strong>. Interrupting the server process will break the server and will require systems support to fix the apache configuration. If you are not comfortable continuing, please contact support and we can do this for no charge.</p>
<p><strong>Select Save and Build and hit enter.</strong><br style="clear: both;" /></p>
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/server-usage/installing-mbstring-easy-apache/mbstring-install-11-confirm-build.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Confirm the PHP Apache build" src="//cdn.inmotionhosting.com/support/images/stories/website/server-usage/installing-mbstring-easy-apache/mbstring-install-11-confirm-build.gif" title="Click here to view the larger image" width="100" /></a>In the <em>Confirm build screen</em>, <strong>Select Yes and hit Enter</strong>.<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/server-usage/installing-mbstring-easy-apache/mbstring-install-12-i-understand.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Select I Understand to continue the php apache rebuild" src="//cdn.inmotionhosting.com/support/images/stories/website/server-usage/installing-mbstring-easy-apache/mbstring-install-12-i-understand.gif" title="Click here to view the larger image" width="100" /></a>Easy Apache will finally ask to <em>Please acknowledge</em>.
<p><strong>Select "I Understand" and hit Enter</strong>.</p>
<br style="clear: both;" />
<p>Apache and PHP will now rebuild. Wait for the process to finish. The process time can vary; however, typically it should take ~10 to 30 minutes. Once the process is finished, check your phpinfo. You should see the Mbstring extension <a target="_blank" title="Click here for info on phpinfo" href="/support/website/general-server-setup/update-local-php-settings">in the phpinfo now</a>.</p>
</li>
</ol> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/general-server-setup/install-mbstring-easy-apache&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/general-server-setup/install-mbstring-easy-apache'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NCZpZD01MDAmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="20f962639b757be30ce4a237bbd70d94" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/a017cabac1d13a7bb611c103276d6a56?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/a017cabac1d13a7bb611c103276d6a56'>MITHUN DESHMUKH</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-18 12:53 am</div>
				                <div><p>Hello,</p>
<p>Thanks for nice artical.</p>
<p>&nbsp;</p>
<p>I am getting "<strong>Fatal error</strong>: Call to undefined function mb_strlen() in <strong>/home/username/public_html/admin/model/sms/sms.php</strong> on line <strong>1"</strong></p>
<p>So I request you to please help me slove this issue.</p>
<p>Will you able to help me?</p>
<p>Regards,</p>
<p>Mithun Deshmukh</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15167);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-18 8:49 am</div>
				                <div>Hello Mithun,<br />
<br />
Thank you for contacting us. We are happy to help, but will need some additional information. This guide in on how to install <strong>mbstring</strong><br />
<br />
In your error it says <strong> mb_strlen</strong> is undefined. You must install this function, if it is missing.<br />
<br />
This can be installed using EasyApache, I found this solution in the official<a href="http://forums.cpanel.net/f5/whm-how-set-up-mb_strlen-mb_substr-348711.html" target="_blank"> cPanel forums</a>.<br />
<br />
If you have any further questions, feel free to post them below.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15187);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-28233'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/c36b2825e4e0dab1ccfc4ee74ad12513?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/c36b2825e4e0dab1ccfc4ee74ad12513'>Dan</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-06 2:41 am</div>
				                <div><p>Very helpful! Thank you so much.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28233);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
