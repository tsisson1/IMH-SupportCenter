<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:69147:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/drupal-7/views-module-tutorial/display-view-sql-query" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-08-02T20:58:10-07:00" />
  <meta name="keywords" content="Views preview sql query drupal 7" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="This Drupal 7 article covers how to display the SQL Query in the preview when using the Views module." />
  <title>Displaying the SQL query for a view when previewing in Drupal 7 Views  - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/drupal-7/views-module-tutorial/display-view-sql-query" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:23367ee1a431bb1c004a364e74a69902 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '72.226.114.183']);
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
				<img src='/support/images/stories/drupal-partner/supporting-partner-80_3.png' style='float:right; margin:0px 0px 15px 15px;' alt='Drupal Association Support Partner'>		<h1>
															Displaying the SQL query for a view when previewing in Drupal 7 Views 									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>13,761</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Aug 2, 2012'><span style='color:#606060;'>Published:</span> Aug 2, 2012</div>
...
<li>From the top menu bar, locate the <strong>Structure</strong> option and click it.    <br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/structure.png"><img  alt="structure" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/structure.png" /></a></li>
<li>Click on the <strong>Views</strong> option to move to the next screen.     <br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Views/structure-views.png"><img  alt="structure-views" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Views/structure-views.png" /></a></li>
<li>You are now on the <em>Views</em> list screen. Look to the upper right and you will see two tabs. Click on the one that is labeled <strong>Settings</strong>.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Views/view-settings.png"><img  alt="view-settings" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Views/view-settings.png" /></a> </li>
<li>Once you get to the <em>Settings </em>page scroll down to the bottom of the screen to the <strong>Live Preview Settings</strong> and find the checkbox labeled <strong>Show the SQL query</strong>. Click the checkbox to enable the feature.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Views/Show_SQL_Query/set-query-preview.png"><img  alt="set-query-preview" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Views/Show_SQL_Query/set-query-preview.png" /></a></li>
<li>Once finished, click on the <strong>Save Configuration</strong> button at the bottom. Preview one of your views and you will now see the SQL code.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Views/Show_SQL_Query/show-query-after.png"><img  alt="show-query-after" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Views/Show_SQL_Query/show-query-after.png" /></a> </li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/drupal-7/views-module-tutorial'>211: Views Module Tutorial</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 8: Displaying the SQL query for a view when previewing in Drupal 7 Views </div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 7: <a href='/support/edu/drupal-7/views-module-tutorial/disable-view-cache'>How to disable caching in Drupal 7 Views module </a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/drupal-7/views-module-tutorial/display-view-sql-query&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/drupal-7/views-module-tutorial/display-view-sql-query'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNDUmaWQ9MTY0NyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="6dcef1a441e9c86c15fb13888c90f861" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/drupal-7/views-module-tutorial?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Views Module Tutorial</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/drupal-7/views-module-tutorial/views-intro?tsrc=rsbedu'>Introduction to Views in Drupal 7</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/drupal-7/views-module-tutorial/create-view?tsrc=rsbedu'>Creating your first View in Drupal 7</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/drupal-7/views-module-tutorial/enable-view?tsrc=rsbedu'>Enabling a view in Drupal 7 Views</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/drupal-7/views-module-tutorial/create-block-display?tsrc=rsbedu'>Creating a block display for a View in Drupal 7</a></td>
                </tr>
          <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/drupal-7/views-module-tutorial/change-view-title?tsrc=rsbedu'>Changing the title for a view in the Drupal 7 Views Module</a></td>
                </tr>
          <tr >
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/drupal-7/views-module-tutorial/config-view-menu?tsrc=rsbedu'>How to link to a view within a menu in Drupal 7 Views module</a></td>
                </tr>
          <tr >
                        <td valign='top'>7.</td>
                        <td><a href='/support/edu/drupal-7/views-module-tutorial/disable-view-cache?tsrc=rsbedu'>How to disable caching in Drupal 7 Views module </a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>8.</td>
                        <td><a href='/support/edu/drupal-7/views-module-tutorial/display-view-sql-query?tsrc=rsbedu'>Displaying the SQL query for a view when previewing in Drupal 7 Views </a></td>
                </tr>
          	</table>
...
<a name='comments'></a>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/c59152a77c0bc073fe6f2a3141b99010?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/c59152a77c0bc073fe6f2a3141b99010'>Wolf_22</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-31 9:29 pm</div>
				                <div><p>That still only shows a partial query...</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9321);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-01 8:38 am</div>
				                <div>This shows the full MySQL query that is being executed to generate the information displayed.  Could you clarify what additional information you are looking for?</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9328);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-27308'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/71827032ba1a3342c77c1c232f26f3ae?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/71827032ba1a3342c77c1c232f26f3ae'>Said Bakr</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-07 7:55 pm</div>
				                <div><p>The query generated is not working. For example, copy and paste the sql string into PHPMyAdmin SQL input and run it, it will generate syntax errors related to, { for example, and sometimes it makes unavailable tables such as the SQL:</p>
<p>&nbsp;</p>
<p style="margin-top: 0px; margin-bottom: 0px; padding: 0px; border: 0px; vertical-align: baseline; font-size: 1.231em; white-space: pre-wrap; color: #666666; line-height: 20.0063px; background-color: #f9f9f9;"><code>SELECT node.created AS node_created, node.nid AS nid FROM {node} node LEFT JOIN {users} users_node ON node.uid = users_node.uid WHERE (( (node.status = '1') AND (node.type IN ('rai')) AND (node.uid IN ('1000')) )) ORDER BY node_created DESC LIMIT 10 OFFSET 0</code></p>
<p style="margin-top: 0px; margin-bottom: 0px; padding: 0px; border: 0px; vertical-align: baseline; font-size: 1.231em; white-space: pre-wrap; color: #666666; line-height: 20.0063px; background-color: #f9f9f9;">In the above example, users_node table is not found. However, the above SQL query is generated from properly working view!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27308);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-08 10:54 am</div>
				                <div>Hello Said Bakr,<br />
<br />
Sorry for the problem with the generated query.  Unfortunately, the solution  may involve making changes with Drupal which is a third party product.  This <a href="https://www.drupal.org/node/1899920" rel="nofollow" target="_blank">post</a> in the Drupal Support forums might provide some insight on the issue.  Also, it is probably the best location to get free help with the problem that you're facing.  I did hunt around trying to find anything else related, but it doesn't appear to have a precedent.  So, you may need to post your question with the Drupal community for further assistance.  Apologies that I can't provide a direct answer here.  <br />
<br />
If you have any further questions or comments, please let us know.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27330);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
