<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:56330:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/fighting-spam/my-website-is-attacked-by-phishing-attack" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, The link that Google gave you is incorrect. It references an account on your server, but it is not yours. Google sends that message out to anyone..." />
  <title>My website is attacked by phishing attack | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/fighting-spam/my-website-is-attacked-by-phishing-attack" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:fc85b97621e031a88e4b0ecad377a71b -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '31.223.139.58']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>My website is attacked by phishing attack</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2014-10-25 11:00 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>3,628</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Hi there, <br />
<br />
Google sent me a phishing notification email few days ago. <br />
Could anyone let me know how to solve the problem?<br />
Also, I found a post with similar issue, but not sure it is the exactly the same problem: http://www.inmotionhosting.com/support/community-support/fighting-spam/phishing-on-my-site<br />
<br />
<br />
The message in the email is here:<br />
<br />
Dear site owner or webmaster of sprintron.com,<br />
<br />
<br />
...
<br />
http://www.sprintron .com/~nidhip5/cgi-bin/ggdocsggdocs/<br />
<br />
Here is a link to a sample warning page:<br />
http://www.google.com/interstitial?url=http%3A//www.sprintron.com/~nidhip5/cgi-bin/ggdocsggdocs/<br />
<br />
...
http://www.google.com/safebrowsing/report_error/?tpl=emailer<br />
...
<br />
Note: if you have an account in Google's Webmaster Tools, you can verify the authenticity of this message by logging into https://www.google.com/webmasters/tools/siteoverview and going to the Message Center, where a warning will appear shortly.<br />
<br />
</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_5853' id='upvote_answer_5853' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='5853' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_5853').submit();"></div>
	</form>
	<div class='vote_sum'>1</div>
	<form method='post' name='downvote_answer_5853' id='downvote_answer_5853' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='5853' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_5853').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
...
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_5853').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_5853' id='form_comment_on_answer_5853' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
...
However I found the link from Google is correct (there is a blank in between, I removed it):<br />
<br />
http://www.sprintron.com/~nidhip5/cgi-bin/ggdocsggdocs/<br />
In the link it shows &quot;Phishing attack ahead&quot;<br />
It makes me concern since it is really under our domain name (http://www.sprintron .com)<br />
<br />
Also, I wonder the really hacked account you mentioned is &quot;nidhip5&quot;?<br />
<br />
Thank you!</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='http://graph.facebook.com/arthur.chen.1232/picture?type=normal' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/FollowUpQuestion'>FollowUpQuestion</a><br />
...
Scott M</div>
							...
							<td style='width:96px;' valign='top'>
								...
								<div class='smallgrey'>
									...
									37,003 <a href='/support/team/points' target='_blank'>Points</a>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Got it! Thanks for the explanation~</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/fighting-spam/my-website-is-attacked-by-phishing-attack&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/fighting-spam/my-website-is-attacked-by-phishing-attack'></div>
<script type='text/javascript'>
  (function() {
