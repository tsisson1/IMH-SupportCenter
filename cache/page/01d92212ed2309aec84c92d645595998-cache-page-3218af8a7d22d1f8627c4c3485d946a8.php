<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:56070:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/wordpress-development" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="keywords" content="wordpress development dev plugin plugins create creating make making php" />
  <meta name="description" content="Learn about WordPress development and extending the features of your WordPress website. Then you can create your first WordPress plugin with ease." />
  <title>WordPress Development | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/wordpress-development" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:4c4e9a9ad505c2bf4c1c82e5666fdd4c -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-22']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '103.231.46.147']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>WordPress Development</span></li>			</ul>
		</div>
	</div>
</div>
...
<p>Written by <a href='https://plus.google.com/114847242487896512921'>Jacob Nicholson</a></p>

<p>With the huge popularity of WordPress today, many users want to be able to extend the powerful CMS further. This means going out to the <a href="https://wordpress.org/plugins/" target="_blank" rel="nofollow">WordPress plugin directory</a> and trying out a few plugins for the task at hand.</p>

<p>Sometimes plugins aren't kept up to date, or a specific feature you really want just doesn't exist. In these cases you can hire a WordPress plugin developer, or you can dive in for free and start making your own!</p>

<div class="white_box">
<h2 style="margin-top:0px;padding-top:0px;">Creating your first WordPress plugin</h2>
<div style="margin: 5px 15px 5px 10px">
<p>In this guide we'll create our first WordPress plugin, highlighting important things to keep in mind.</p>
  <p><a href="http://www.inmotionhosting.com/support/website/wordpress-development/create-your-first-wordpress-plugin" target="_blank">Create your first WordPress plugin</a> to begin learning WordPress plugin developmnet step by step.</p>
  <p>If you want to see the finished result, look at the <a href="http://www.inmotionhosting.com/support/website/wordpress-development/extra-post-info-wordpress-plugin" target="_blank">Extra Post Info WordPress plugin</a> for the source code.</p>
  <img style="width: 595px; display: block; margin: 0px auto 10px auto;" src="http://www.inmotionhosting.com/support/images/stories/wordpress-development/plugins/admin-menu/extra-post-info-admin-page-read-setting-from-database.png" alt="extra post info admin page read setting from database">
  
  <div class="alert alert-info" style="font-size: 1.6em; line-height: 1.4em; text-align: center;"><p>This tutorial series covers the following topics:</p>
  <p><a href="http://www.inmotionhosting.com/support/website/wordpress-development/create-wordpress-plugin-script" target="_blank">Create WordPress plugin script</a></p>
<p><a href="http://www.inmotionhosting.com/support/website/wordpress-development/wordpress-plugin-file-header" target="_blank">WordPress plugin file header</a></p>
<p><a href="http://www.inmotionhosting.com/support/website/wordpress-development/create-wordpress-plugin-function" target="_blank">Create WordPress plugin function</a></p>
<p><a href="http://www.inmotionhosting.com/support/website/wordpress-development/create-wordpress-admin-menu-for-your-plugin" target="_blank">Create WordPress admin menu</a></p>
<p><a href="http://www.inmotionhosting.com/support/website/wordpress-development/create-wordpress-plugin-page" target="_blank">Create WordPress plugin page</a></p>
<p><a href="http://www.inmotionhosting.com/support/website/wordpress-development/save-wordpress-plugin-settings-with-form" target="_blank">Save WordPress plugin settings with form</a></p>
<p><a href="http://www.inmotionhosting.com/support/website/wordpress-development/register-wordpress-plugin-settings-to-database" target="_blank">Register WordPress plugin settings to database</a></p>
<p><a href="http://www.inmotionhosting.com/support/website/wordpress-development/read-wordpress-plugin-settings-from-database" target="_blank">Read WordPress plugin settings from database</a></p> 
  </div>   

  
</div>
</div>
<form action="http://www.inmotionhosting.com/support/website/wordpress-development" method="post" name="adminForm" id="adminForm" class="form-inline">
  ...
  <table class='article_list'>
          ...
          <tr>
                                <td style='padding-right:20px;'><a href='/support/website/wordpress-development/save-wordpress-plugin-settings-with-form'>Save WordPress plugin settings with form</a></td>
                                <td>7,513</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/website/wordpress-development/register-wordpress-plugin-settings-to-database'>Register WordPress plugin settings to database</a></td>
                                <td>3,995</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/website/wordpress-development/create-wordpress-admin-menu-for-your-plugin'>Create WordPress admin menu for your plugin</a></td>
                                <td>2,785</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/website/wordpress-development/create-your-first-wordpress-plugin'>Create your first WordPress plugin</a></td>
                                <td>1,643</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/website/wordpress-development/read-wordpress-plugin-settings-from-database'>Read WordPress plugin settings from database</a></td>
                                <td>1,006</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/website/wordpress-development/create-wordpress-plugin-page'>Create WordPress plugin page</a></td>
                                <td>932</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/website/wordpress-development/extra-post-info-wordpress-plugin'>Extra Post Info WordPress Plugin</a></td>
                                <td>786</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/website/wordpress-development/create-wordpress-plugin-script'>Create WordPress plugin script</a></td>
                                <td>451</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/website/wordpress-development/create-wordpress-plugin-function'>Create WordPress plugin function</a></td>
                                <td>352</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/website/wordpress-development/the-has-action-wordpress-function'>The has_action() WordPress function</a></td>
                                <td>315</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/website/wordpress-development/wordpress-plugin-file-header'>Wordpress plugin file header</a></td>
                                <td>216</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/website/wordpress-development/the-add-action-wordpress-function'>The add_action WordPress function</a></td>
                                <td>163</td>
                        </tr>
                  </table>
	</form>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD01MDQmaWQ9NTA0JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="3f20bbe2f91bc621da503689fb5d19a0" value="1" />	</div>
	</form>
<!-- <br />
