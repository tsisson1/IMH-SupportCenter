<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:97743:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/social-media/adding-social-media-buttons-to-your-website" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-11-27T00:31:55-08:00" />
  <meta name="keywords" content="social media button buttons links widget widgets" />
  <meta name="author" content="Jacob Nicholson" />
  <meta name="description" content="To help increase your website's reach you can add social media buttons to your site to easily allow visitors to add you to their favorite social network." />
  <title>Adding Social Media buttons to your website - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/social-media/adding-social-media-buttons-to-your-website" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:385603e380d5710e4e8f420530ff994a -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-22']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '116.86.230.165']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/website/social-media' itemprop='url'><span itemprop='title'>Social Media<span></a><div class='dropdown_3columns'><div class='col_3'><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/social-media/adding-social-media-buttons-to-your-website'>Adding Social Media buttons to your website</a> (20683 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/social-media/using-social-media-to-bring-traffic-to-your-site'>Using Social Media to bring traffic to your site</a> (1542 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/social-media/social-media-plugins-for-your-website'>Social Media plugins for your website</a> (485 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/social-media/use-twitter-drive-website-traffic'>How to use Twitter to drive traffic to your website?</a> (355 hits)</div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Adding Social Media buttons to your website</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Adding Social Media buttons to your website									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>20,683</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Nov 26, 2013'><span style='color:#606060;'>Published:</span> Nov 27, 2013</div>
  ...
  <h2>Navigation:</h2>
  <button type="button" class="btn btn-primary" onclick="window.location.hash='social-media-buttons';">What are Social Media buttons?</button>
  <button type="button" class="btn btn-primary" onclick="window.location.hash='html-buttons';">How to add Social Media buttons to HTML</button>
  <button type="button" class="btn btn-primary" style="margin-top: 5px; margin-left: 115px;" onclick="window.location.hash='facebook-buttons';">Facebook buttons</button>
  <button type="button" class="btn btn-primary" style="margin-top: 5px;" onclick="window.location.hash='googleplus-buttons';">Google+ buttons</button>
  <button type="button" class="btn btn-primary" style="margin-top: 5px;" onclick="window.location.hash='twitter-buttons';">Twitter buttons</button>
</div>

<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/social-media/integration/social-media-buttons-all-together.png"><img  style="max-height: 800px; width: 150px; float: right; margin-left: 60px; margin-right: 100px;" src="//cdn.inmotionhosting.com/support/images/stories/social-media/integration/social-media-buttons-all-together.png" alt="social media buttons all together"></a>

<p>If you understand how <a href="http://www.inmotionhosting.com/support/website/social-media/using-social-media-to-bring-traffic-to-your-site" target="_blank">using social media can bring traffic to your website</a>, another thing to keep in mind is that using your website, you can help build up your social network with social media buttons.</p>

<p>A visitor that finds your website might like the products or services that you offer, but might not need them just yet. Instead of relying on them to hopefully bookmark your website and remember to return at another time when they are in need of your services, having them add you to their social network can help you stay relevant.</p>

<p>In this guide I'll try to cover some of the many ways you can help add social media buttons to your website to easily allow visitors to start following you on their favorite social networks.</p>
<div style="clear: both;"></div>

<!--- //NOTE What are Social Media buttons? --------------------------------------------------------------------------->
<a name="social-media-buttons"></a>
<h2>What are Social Media buttons?</h2>

<p>I doubt you've been able to navigate the Internet much over the last few years without running into some form of social media buttons. These are basically just small icons that you place on your website linking to your social media networks.</p>

<p>As a matter of fact, if you scroll to the bottom of this article, you should see a <strong>Facebook</strong>, <strong>Google+</strong>, and <strong>Twitter</strong> like buttons. That way if you enjoy this article and want some of your friends on one of these social networks to also read it, you can easily share it with them</p>

<p>Typically there are 2 main types of social media buttons, ones that simply link to your social profiles, and then ones that keep track of how many likes, followers, shares you have on that page or on your website.</p>

<!--- //NOTE How to add Social Media buttons to HTML? --------------------------------------------------------------------------->
<a name="html-buttons"></a>
<h2>How to add Social Media buttons to HTML</h2>

<p>In the simplest form, if you just have some <strong>HTML</strong> pages making up your website, you can easily add social media buttons to these pages with some simple code from each social network.</p>

<p>For the examples below I'll just be using this quick dummy page I created on <strong>example.com</strong>:</p>

<center><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/social-media/integration/example-site-no-social-media-yet.png"><img  style="max-width: none; max-height: none; width: 350px;" src="//cdn.inmotionhosting.com/support/images/stories/social-media/integration/example-site-no-social-media-yet.png" alt="example site no social media yet"></a></center>

<!--- //NOTE Facebook buttons --------------------------------------------------------------------------->
<a name="facebook-buttons"></a>
<h2>Facebook buttons</h2>

<p>Adding some Facebook social media buttons to your website can help you spread your message via word of mouth to your visitor's friends. They have both a <a href="#facebook-like-button">like button</a> you can use on any page, and a <a href="#facebook-like-box">like box</a> you can use if you have a Facebook page for your business.</p>

<!--- //NOTE Facebook like button --------------------------------------------------------------------------->
<a name="facebook-like-button"></a>
<h3>Facebook Like button</h3>

<p>Visit the <a href="https://developers.facebook.com/docs/plugins/like-button/" target="_blank">Facebook Like button</a>, page and simply fill in some info for your button then click <strong>Get Code</strong></p>

<center><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/social-media/integration/facebook-click-get-code-for-like-button.png"><img  style="max-width: none; max-height: none; width: 350px;" src="//cdn.inmotionhosting.com/support/images/stories/social-media/integration/facebook-click-get-code-for-like-button.png" alt="facebook click get code for like button"></a></center>

<p style="margin-top: 15px;">Select the <strong>JavaScript</strong> code from the top box, and paste it in your HTML page right after the <strong>&lt;body&gt;</strong> tag.</p>

<p>Next select the <strong>HTML</strong>  from the bottom box, and paste it where you want the button to display on your page.</p>

<center><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/social-media/integration/insert-facebook-html-code-in-html-page.gif"><img  style="max-width: none; max-height: none; width: 600px;" src="//cdn.inmotionhosting.com/support/images/stories/social-media/integration/insert-facebook-html-code-in-html-page.gif" alt="insert facebook html code in html page"></a></center>

<p style="margin-top: 15px;">You should now see your <strong>Facebook</strong> like button on your page where you placed it:</p>

<center><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/social-media/integration/example-site-with-facebook-like-button.png"><img  style="max-width: none; max-height: none; width: 350px;" src="//cdn.inmotionhosting.com/support/images/stories/social-media/integration/example-site-with-facebook-like-button.png" alt="example site with facebook like button"></a></center>

<!--- //NOTE Facebook like box (grey) --------------------------------------------------------------------------->
<a name="facebook-like-box"></a>
<div style="background-color: #DFDFDF; padding: 5px; margin-top: 25px;">
<h3>Facebook Like box</h3>

<p>Visit the <a href="https://developers.facebook.com/docs/plugins/like-box-for-pages/" target="_blank">Facebook Like box</a>, page if you already have a Facebook page you're trying to promote on your website. Then click the <strong>Get Code</strong> button after filling in your page details.</p>

<center><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/social-media/integration/facebook-click-get-code-for-like-box.png"><img  style="max-width: none; max-height: none; width: 350px;" src="//cdn.inmotionhosting.com/support/images/stories/social-media/integration/facebook-click-get-code-for-like-box.png" alt="facebook click get code for like box"></a></center>

<p>Since we already have the <strong>JavaScript</strong> in our <strong>HTML</strong> page from the <a href="#facebook-like-button">like button</a> above, now you just need to copy the like box's <strong>HTML</strong> and paste it on your page where you want it to display.</p>

<center><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/social-media/integration/insert-facebook-html-code-in-html-page-for-like-box.gif"><img  style="max-width: none; max-height: none; width: 600px;" src="//cdn.inmotionhosting.com/support/images/stories/social-media/integration/insert-facebook-html-code-in-html-page-for-like-box.gif" alt="insert facebook html code in html page for like box"></a></center>

<p style="margin-top: 15px;">Now you should see both the <strong>Facebook</strong> like button, and like box on our page:</p>

<center><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/social-media/integration/example-site-with-facebook-like-button-and-like-box.png"><img  style="max-width: none; max-height: none; width: 350px;" src="//cdn.inmotionhosting.com/support/images/stories/social-media/integration/example-site-with-facebook-like-button-and-like-box.png" alt="example site with facebook like button and like box"></a></center>
</div>

<!--- //NOTE Google+ buttons --------------------------------------------------------------------------->
<a name="googleplus-buttons"></a>
<h2>Google+ buttons</h2>

<p>Google+ is one of the younger social media networks, but it's already surpassed Twitter and is on track to give Facebook a run for their money as well. Google lets you use a various array of buttons, from a <a href="#googleplus-1-button">+1 button</a> you can use on any page, a <a href="#googleplus-badge">badge</a> to get people to follow you, a <a href="#googleplus-follow">follow button</a>, and finally a <a href="#googleplus-share">share button</a> as well.</p>

<!--- //NOTE Google+ +1 button --------------------------------------------------------------------------->
<a name="googleplus-1-button"></a>
<h3>Google+ +1 button</h3>

<p>Visit the <a href="https://developers.google.com/+/web/+1button/" target="_blank">Google+ +1 button</a> page, and fill in all the details for your button.</p>

<p>Next copy the resulting code and paste it into your page.</p>

<center><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/social-media/integration/insert-googleplus-html-code-in-html-page-for-+1-button.gif"><img  style="max-width: none; max-height: none; width: 600px;" src="//cdn.inmotionhosting.com/support/images/stories/social-media/integration/insert-googleplus-html-code-in-html-page-for-+1-button.gif" alt="insert googleplus html code in html page for +1 button"></a></center>

<p style="margin-top: 15px;">You should now see your <strong>Google+</strong> +1 button where you placed the code on your page:</p>

<center><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/social-media/integration/example-site-with-googleplus-1-button.png"><img  style="max-width: none; max-height: none; width: 350px;" src="//cdn.inmotionhosting.com/support/images/stories/social-media/integration/example-site-with-googleplus-1-button.png" alt="example site with googleplus +1 button"></a></center>

<!--- //NOTE Google+ badge (grey) --------------------------------------------------------------------------->
<a name="googleplus-badge"></a>
<div style="background-color: #DFDFDF; padding: 5px; margin-top: 25px;">
<h3>Google+ badge</h3>

<p>Visit the <a href="https://developers.google.com/+/web/badge/" target="_blank">Google+ badge button</a> page, and customize your badge to your liking.</p>

<p>Then copy the resulting code you get and paste it into your page.</p>

<center><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/social-media/integration/insert-googleplus-html-code-in-html-page-for-badge.gif"><img  style="max-width: none; max-height: none; width: 600px;" src="//cdn.inmotionhosting.com/support/images/stories/social-media/integration/insert-googleplus-html-code-in-html-page-for-badge.gif" alt="insert googleplus html code in html page for badge"></a></center>

<p style="margin-top: 15px;">Now you'll see our new <strong>Google+</strong> badge right beside our +1 button:</p>

<center><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/social-media/integration/example-site-with-googleplus-1-button-and-badge.png"><img  style="max-width: none; max-height: none; width: 350px;" src="//cdn.inmotionhosting.com/support/images/stories/social-media/integration/example-site-with-googleplus-1-button-and-badge.png" alt="example site with googleplus +1 button and badge"></a></center>
</div>

<!--- //NOTE Google+ follow button --------------------------------------------------------------------------->
<a name="googleplus-follow"></a>
<h3>Google+ follow button</h3>

<p>Visit the <a href="https://developers.google.com/+/web/follow/" target="_blank">Google+ follow button</a> page, and adjust the size and settings.</p>

<p>Then you'll want to copy the code and paste it into your page.</p>

<center><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/social-media/integration/insert-googleplus-html-code-in-html-page-for-follow-button.gif"><img  style="max-width: none; max-height: none; width: 600px;" src="//cdn.inmotionhosting.com/support/images/stories/social-media/integration/insert-googleplus-html-code-in-html-page-for-follow-button.gif" alt="insert googleplus html code in html page for follow button"></a></center>

<p style="margin-top: 15px;">Now we've got a <strong>Google+</strong> +1 button, a badge, and the new follow button we just created!</p>

<center><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/social-media/integration/example-site-with-googleplus-1-button-badge-and-follow-button.png"><img  style="max-width: none; max-height: none; width: 350px;" src="//cdn.inmotionhosting.com/support/images/stories/social-media/integration/example-site-with-googleplus-1-button-badge-and-follow-button.png" alt="example site with googleplus +1 button badge and follow button"></a></center>

<!--- //NOTE Google+ share button (grey) --------------------------------------------------------------------------->
<a name="googleplus-share"></a>
<div style="background-color: #DFDFDF; padding: 5px; margin-top: 25px;">
<h3>Google+ share button</h3>

<p>Visit the <a href="https://developers.google.com/+/web/share/" target="_blank">Google+ share button</a> page, and choose your settings.</p>

<p>Next you'll want to copy the code and paste it into your page where you'd like the button.</p>

<center><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/social-media/integration/insert-googleplus-html-code-in-html-page-for-share-button.gif"><img  style="max-width: none; max-height: none; width: 600px;" src="//cdn.inmotionhosting.com/support/images/stories/social-media/integration/insert-googleplus-html-code-in-html-page-for-share-button.gif" alt="insert googleplus html code in html page for share button"></a></center>

<p style="margin-top: 15px;">Now we've got our <strong>Google+</strong> +1 button, a badge, a follow button, and the new share button we just created!</p>

<center><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/social-media/integration/example-site-with-googleplus-1-button-badge-follow-and-share-button.png"><img  style="max-width: none; max-height: none; width: 350px;" src="//cdn.inmotionhosting.com/support/images/stories/social-media/integration/example-site-with-googleplus-1-button-badge-follow-and-share-button.png" alt="example site with googleplus 1 button badge follow and share button"></a></center>
</div>

<!--- //NOTE Twitter buttons --------------------------------------------------------------------------->
<a name="twitter-buttons"></a>
<h2>Twitter buttons</h2>

<p>With <strong>Twitter</strong> they offer 4 different types of social media buttons for your website. There is the ability to <a href="#twitter-share-link">share a link</a>, a <a href="#twitter-follow">follow button</a>, a <a href="#twitter-hashtag">Hashtag button</a>, and finally a <a href="#twitter-mention">mention button</a>.</p>

<!--- //NOTE Twitter share a link button --------------------------------------------------------------------------->
<a name="twitter-share-link"></a>
<h3>Twitter share a link button</h3>

<p>Visit the <a href="https://about.twitter.com/resources/buttons#tweet" target="_blank">Twitter share a link button</a> page, then type in all the details for the page you'd like to share.</p>

<p>Then you need to copy and paste the code into your page where you'd like the button.</p>

<center><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/social-media/integration/insert-twitter-html-code-in-html-page-for-share-a-link.gif"><img  style="max-width: none; max-height: none; width: 600px;" src="//cdn.inmotionhosting.com/support/images/stories/social-media/integration/insert-twitter-html-code-in-html-page-for-share-a-link.gif" alt="insert twitter html code in html page for share a link"></a></center>

<p style="margin-top: 15px;">Now we can see our <strong>Twitter</strong> share a link button, and if you click it shows the details we typed in.</p>

<center><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/social-media/integration/example-site-with-twitter-share-a-link-button.png"><img  style="max-width: none; max-height: none; width: 350px;" src="//cdn.inmotionhosting.com/support/images/stories/social-media/integration/example-site-with-twitter-share-a-link-button.png" alt="example site with twitter share a link button"></a></center>

<!--- //NOTE Twitter follow button (grey) --------------------------------------------------------------------------->
<a name="twitter-follow"></a>
<div style="background-color: #DFDFDF; padding: 5px; margin-top: 25px;">
<h3>Twitter follow button</h3>

<p>Visit the <a href="https://about.twitter.com/resources/buttons#follow" target="_blank">Twitter follow button</a> page, and select the <strong>Twitter</strong> handle you'd like the button to follow.</p>

<p>Then copy the resulting <strong>HTML</strong> code and paste it into your webpage where you'd like the follow button.</p>

<center><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/social-media/integration/insert-twitter-html-code-in-html-page-for-follow-button.gif"><img  style="max-width: none; max-height: none; width: 600px;" src="//cdn.inmotionhosting.com/support/images/stories/social-media/integration/insert-twitter-html-code-in-html-page-for-follow-button.gif" alt="insert twitter html code in html page for follow button"></a></center>

<p style="margin-top: 15px;">Now we can see our <strong>Twitter</strong> share a link button, and the new follow button we just created. If you click on our new follow button, you can see that it will bring up the <strong>Twitter</strong> handle that we entered into the form.</p>

<center><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/social-media/integration/example-site-with-twitter-share-a-link-and-follow-button.png"><img  style="max-width: none; max-height: none; width: 350px;" src="//cdn.inmotionhosting.com/support/images/stories/social-media/integration/example-site-with-twitter-share-a-link-and-follow-button.png" alt="example site with twitter share a link and follow button"></a></center>
</div>

<!--- //NOTE Twitter hashtag button --------------------------------------------------------------------------->
<a name="twitter-hashtag"></a>
<h3>Twitter hashtag button</h3>

<p>Visit the <a href="https://about.twitter.com/resources/buttons#hashtag" target="_blank">Twitter hashtag button</a> page, and fill out the details you'd like to use with your hashtag button.</p>

<p>Next copy the <strong>HTML</strong> code then paste it where you want the button on your site.</p>

<center><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/social-media/integration/insert-twitter-html-code-in-html-page-for-hashtag-button.gif"><img  style="max-width: none; max-height: none; width: 600px;" src="//cdn.inmotionhosting.com/support/images/stories/social-media/integration/insert-twitter-html-code-in-html-page-for-hashtag-button.gif" alt="insert twitter html code in html page for hashtag button"></a></center>

<p style="margin-top: 15px;">We've now got our <strong>Twitter</strong> share a link button, the follow button and the new hashtag button we created. When you click on it, you'll see the hashtag and details we typed in, in the pop-up window.</p>

<center><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/social-media/integration/example-site-with-twitter-hashtag-button.png"><img  style="max-width: none; max-height: none; width: 350px;" src="//cdn.inmotionhosting.com/support/images/stories/social-media/integration/example-site-with-twitter-hashtag-button.png" alt="example site with twitter hashtag button"></a></center>

<!--- //NOTE Twitter mention button --------------------------------------------------------------------------->
<a name="twitter-mention"></a>
<div style="background-color: #DFDFDF; padding: 5px; margin-top: 25px;">
<h3>Twitter mention button</h3>

<p>Visit the <a href="https://about.twitter.com/resources/buttons#mention" target="_blank">Twitter mention button</a> page, then fill out details you'd like to use.</p>

<p>Then copy the resulting <strong>HTML</strong> code and paste it where you'd like the button to display on your site.</p>

<center><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/social-media/integration/insert-twitter-html-code-in-html-page-for-mention-button.gif"><img  style="max-width: none; max-height: none; width: 600px;" src="//cdn.inmotionhosting.com/support/images/stories/social-media/integration/insert-twitter-html-code-in-html-page-for-mention-button.gif" alt="insert twitter html code in html page for mention button"></a></center>

<p style="margin-top: 15px;">Now we have the <strong>Twitter</strong> share a link button, the follow button, the hashtag button, and the new mention button we created. When you click on it, the message you typed in will be presented for you to submit.</p>

<center><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/social-media/integration/example-site-with-twitter-mention-button.png"><img  style="max-width: none; max-height: none; width: 350px;" src="//cdn.inmotionhosting.com/support/images/stories/social-media/integration/example-site-with-twitter-mention-button.png" alt="example site with twitter mention button"></a></center>
</div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/social-media/adding-social-media-buttons-to-your-website&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/social-media/adding-social-media-buttons-to-your-website'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00ODAmaWQ9MzAwNCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="fc73a3a53401d268162c1806ac4113bb" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/eeea3fa597f91d93f7d42ca991fce2f0?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/eeea3fa597f91d93f7d42ca991fce2f0'>chohan</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-24 2:54 am</div>
				                <div><p>Hi</p>
<p>Great stuff. U made the life very easy. Keep it up.&nbsp;</p>
<p>My chrome is not showing all the social media icons where as all other browsers are showing the result correctly, Can u tell me why?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9129);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-24 10:13 am</div>
				                <div>It sounds like it may just be a caching issue.  Try &lt;a href=&quot;http://www.inmotionhosting.com/support/website/how-to/clear-browser-cache&quot;&gt;clearing your browser cache&lt;/a&gt;.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9147);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-9568'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/0f184678289fbecf4b1c11b205e946e6?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/0f184678289fbecf4b1c11b205e946e6'>Terry </a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-09 9:07 pm</div>
				                <div><p>Hi</p>
<p>I added a facebook like button to my &nbsp;web-page. Pressing the like button&nbsp;returns&nbsp;a like for Inmotion Hosting instead of my website. How can I rectify this problem ?</p>
<p>Cheers</p>
<p>Terry&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9568);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-09 9:44 pm</div>
				                <div>Hello Terry,<br />
<br />
You need to generate the Facebook code using YOUR domain URL not, InMotion's.  Please go through the instructions above and replace the InMotion URL with yours and it will go to the URL of your choice.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9569);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-17250'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/8592968f5c67f7147e9ffb510660349f?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/8592968f5c67f7147e9ffb510660349f'>Harinder</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-09 3:55 pm</div>
				                <div><p>I have pasted the code the display like button and box. But still not getting any thing on my page. I have one doubt. I have not publist the site . its still in my local system . So is it due to that. do we have live website to see the button appearing properly ?&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17250);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-10 10:26 am</div>
				                <div>Hello Harinder,<br />
<br />
Thank you for your question. It is difficult for me to say without seeing the site published, but you should still be able to test it.<br />
<br />
What kind of environment/software are you testing with?<br />
<br />
You may have to allow the software out of your firewall to communicate with the social media networks.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17267);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/ac0ce3acd6795b6696d761e20fb562c5?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/ac0ce3acd6795b6696d761e20fb562c5'>Michael Dowling</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-09 6:33 am</div>
				                <div><p>Hi,</p>
<p>&nbsp;</p>
<p>Great website - exetremely useful!&nbsp;</p>
<p>One issue, I am using modx and I have inserted the generated code into the HTML.</p>
<p>The twitter icon has not appeared but only the text.</p>
<p>Please see link to website:&nbsp;http://www.totterdells.ie/bottom-menu/totterdells/tech-blogs/totterdells_chosen_charity_peter_mcverry_trust.html&nbsp;</p>
<p>Any help would be much appreciated,</p>
<p>thank you.&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21450);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-10 9:58 am</div>
				                <div>Hello Michael,<br />
<br />
I am able to test in a non-modx environment successfully. Your javascript in your page looks to be correct. It may have something to do with Modx. I have an article link to <a href="http://rtfm.modx.com/revolution/2.x/developing-in-modx/basic-development/snippets/adding-css-and-js-to-your-pages-through-snippets">modx documentation</a> that I hope helps you.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21537);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-24433'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/8d52576aca0e8f4f7daf0fc6366ed887?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/8d52576aca0e8f4f7daf0fc6366ed887'>Priyanka jain</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-25 4:30 am</div>
				                <div><p>It is really nice post very well, elaborated, and it is well perceptible. Social Media is one of the important platform through which we&nbsp;can generate massive visitor flows to our&nbsp;website. Even few website includes plugin for these social icons.&nbsp;many people make the mistake of putting their social media buttons (particularly the 'follow me' buttons for Twitter, Linked In, et all) at the bottom of the page. In my view adding these in a prominent position - like the top of the home page.&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24433);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
	...
	<div name='fixComments' id='fixComments' style='width:220px; margin:0px; float:right;'>
		<div class='moduletable'>
			<h3><span class='comment-count'>11</span> Questions & <span class='comment-text'>Comments</span></h3>
