<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49506:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/prestashop-15/image-upload-error-in-backend" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, Sorry to hear you are having issues with uploading images in PrestaShop. Though we are able to duplicate the issue, we are not able to determine ..." />
  <title>Image Upload Error in Backend of PrestaShop | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/prestashop-15/image-upload-error-in-backend" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:3c019a4d6b47b71b2b6bc82ef4313e61 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '41.225.231.56']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Image Upload Error in Backend of PrestaShop</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2016-01-11 6:08 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>189</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Hello there,<br />
<br />
i have been tying to add an image to my product in my online store but when i try to upload the image, i get an error saying &quot;error while creating additional image&quot; and i observed that this error was due to my database i guess. please i need this fixed as soon as possible. <br />
thanks </div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_8923' id='upvote_answer_8923' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='8923' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_8923').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_8923' id='downvote_answer_8923' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='8923' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_8923').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
Sorry to hear you are having issues with uploading images in PrestaShop. Though we are able to duplicate the issue, we are not able to determine the exact cause. It is within PrestaShop itself, however. There can be different fixes, depending on what is causing it and what version you are on, etc. First, be sure to  upgrade to the latest version. If that does not correct the issue, you will want to go through the <a href="https://www.google.com/url?sa=t&rct=j&q=&esrc=s&source=web&cd=1&cad=rja&uact=8&ved=0ahUKEwj_r53iwaLKAhUL1R4KHdDUCnAQFggdMAA&url=https%3A%2F%2Fwww.prestashop.com%2Fforums%2F&usg=AFQjCNGvWUhdBW26gSz8xF4sqnZ4Sx3hrA&sig2=rpHvsR4wMdkSNXUKd4rmnw">PrestaShop forums</a> and try the different fixes they provide.<br />
<br />
Kindest Regards,<br />
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_8923').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_8923' id='form_comment_on_answer_8923' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="c2885f7dee4f24af93e8dab7bbf2e649" value="1" />	</div>
	</form>
<!-- <br />
