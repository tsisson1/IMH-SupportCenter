<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:53433:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/drupal-8/clean-urls" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-02-17T19:33:32-08:00" />
  <meta name="keywords" content="clean urls drupal 8" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Wondering what happened to Clean URLs in Drupal 8? Check out this article to find out." />
  <title>300: Clean URLs in Drupal 8 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/drupal-8/clean-urls" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:6120d761d636b36eba28a92d11be5d57 -->
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>1,077</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Nov 1, 2013'><span style='color:#606060;'>Published:</span> Feb 17, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<h2>What are SEF URLs?</h2>
<p>SEF URLs are also known as <em>Search Engine Friendly URLs</em>, or <em>Clean URLs</em>. Most websites today are not built using pages but rather the pages the visitor sees are built on demand by using a <em>Content Management System</em>, or <em>CMS</em>, like <a href="/support/drupal.org">Drupal</a>. Since the pages are built on the fly by pulling content from a database, the human-friendly URLs are not quite as common, resulting in URLs that appear cryptic and are harder to remember. For instance, Drupal may create content such as <em>http://example.com/node/1</em> or <em>http://example.com/?q=home</em>. Clean URLs will allow a more human-readable URL to be presented for both the visitors as well as Search Engines.</p>

<h2>Where are the Clean URL settings in Drupal 8?</h2>
<p>Drupal 8 differs from previous versions in that it has removed the <em>clean_url</em> configuration setting. Drupal 8 now uses URLs in a format similar to <em>/node/1</em> instead of the old <em>/?q=home</em> style. Drupal 8 still allows you to create relevant path and URL names by setting up URL Aliases. </p>

<h2>What is a URL Alias?</h2>
<p>URL Aliases are still a form of Search Engine Friendly URLs, or clean URLs in that they can make the paths more relevant to both the visitor and search engines. For example, instead of having the <em>About Us</em> home page point to <em>http://example.com/node/3</em> it can point to <em>http://example.com/about</em>.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/drupal-8'>Drupal 8</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 11: 300: Clean URLs in Drupal 8</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 10: <a href='/support/edu/drupal-8/301-create-url-alias'>301: Creating URL Aliases in Drupal 8</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/drupal-8/clean-urls&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/drupal-8/clean-urls'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zNzkmaWQ9MjkzNSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="c3501d243d04bcd501918eafe0a4d489" value="1" />	</div>
	</form>
<!-- <br />
