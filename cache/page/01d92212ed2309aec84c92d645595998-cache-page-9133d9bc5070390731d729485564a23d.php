<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:79952:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-3/writing-articles/change-alias" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-07-24T14:27:48-07:00" />
  <meta name="keywords" content="change alias joomla 3.0" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="After writing a new article in Joomla 3.0, you may notice the URL of the article includes the article's title. This section of the URL is referred to as the alias, and we'll show you how to change article aliases in this Joomla 3.0 tutorial." />
  <title>How to change the URL alias of Joomla 3.1 articles - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-3/writing-articles/change-alias" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:7338c5aa3803f13b4764415348965d6c -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '68.114.80.142']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to change the URL alias of Joomla 3.1 articles									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>22,261</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jul 24, 2012'><span style='color:#606060;'>Published:</span> Jul 24, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Thus far in our Joomla 3.0 testing, we have <a href="/support/edu/joomla-3/writing-articles/write-new-article">created a new article</a> and <a href="/support/edu/joomla-3/writing-articles/set-featured-article">published it to the front page</a>. When we visit this new article in our browser, the url becomes:</p>
<pre class="code_block">http://domain.com/index.php/2-uncategorised/1-<span style="color: #ff0000;">this-is-my-first-test-article</span></pre>
<p>As we set the title of the article to, "<span style="color: #ff0000;">This is my first test article</span>", Joomla used the article's title as the alias. In this tutorial, we'll show you how to change this alias. The steps below walk through this process after you have already published the article, but you can easily set this option while you're writing the article for the first time.</p>
<p><strong>Setting an article's alias in Joomla 3.0:</strong></p>
...
<li>In the list of articles, click on the title of the article that you would like to change the alias for</li>
<li>In the top menu, click <strong>Publishing Options</strong>. You will then see the <strong>Alias</strong> shown. Make the adjustments that you would like, and then click <strong>Save</strong> in the top left menu.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/writing-new-articles/change-alias-under-publishing-options.gif"><img  alt="change-alias-under-publishing-options" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/writing-new-articles/change-alias-under-publishing-options.gif" /></a><br /><br />When you visit your article again by navigating to it from your Joomla 3.0 homepage, you will see that the URL has changed. In our testing, we changed the alias from <em>this-is-my-first-test-article</em> to <span style="color: #ff0000;">new-alias-goes-here</span>.<br />
<pre class="code_block">http://domain.com/index.php/2-uncategorised/1-<span style="color: #ff0000;">new-alias-goes-here</span></pre>
</li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 3: How to change the URL alias of Joomla 3.1 articles</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 2: <a href='/support/edu/joomla-3/writing-articles/set-featured-article'>How to feature an article on your Joomla 3.1 homepage</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 4: <a href='/support/edu/joomla-3/writing-articles/new-article-category'>How to create a new Article Category in Joomla 3.1</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-3/writing-articles/change-alias&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-3/writing-articles/change-alias'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNDAmaWQ9MTYwOSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="99a53a379441414a32e1211ecf790fc3" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/150955d0a9b5edbf156211c719e45901?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/150955d0a9b5edbf156211c719e45901'>ray john</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-01 12:53 am</div>
				                <div><p>How do you get rid of those annoying numbers in the page url. Take a look at this page url for instance:</p>
<p>http://www.backpainjournals.com/8-blog/2-lower-back-pain-symptoms-and-treatment.html</p>
<p>I tried the above steps but somehow those numbers 8 and 2 still show up out of nowhere. Thanks</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9323);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-01 8:46 am</div>
				                <div>To do so, all you have to do is edit your template file located at:<br />
&lt;em&gt;components/com_content/router.php&lt;/em&gt; located within your template's HTML folder, and change this line:<br />
&lt;p class=&quot;code_block&quot;&gt;$advanced    = $params-&gt;get('sef_advanced_link', 0);&lt;/p&gt;<br />
To this:<br />
&lt;p class=&quot;code_block&quot;&gt;$advanced    = $params-&gt;get('sef_advanced_link', 1);&lt;/p&gt;<br />
Once complete, you should see that your URLs have changed.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9329);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-10597'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/95bf06544dcdf9ad0592865d8bf40c02?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/95bf06544dcdf9ad0592865d8bf40c02'>faiza</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-13 2:15 am</div>
				                <div><p>How i can correct the URL of joomla site. Please take a look at this page URL&nbsp;</p>
<p>http://www.pic.qld.edu.au/courses/certificate-iv-in-business.html</p>
<p>I want to remove courses alias &nbsp;from this URL .</p>
<p>Thanks</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10597);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-13 11:32 am</div>
				                <div>Hello Fazia,<br />
<br />
To remove the courses category form the URL you will need to <a href="/support/www.inmotionhosting.com/support/edu/joomla-3/menu/create-menu-and-module">create a menu item</a> of the type 'article'. From there  you can also set the alias for the article. Also, on the same page, there is a 'select article' field. For that field, enter the article you wish to display. <br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10608);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-12741'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/8766d92d3e88475d81eca95eb8771ae4?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/8766d92d3e88475d81eca95eb8771ae4'>Lisa</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-14 3:19 pm</div>
				                <div>Hello Lisa,<br />
<br />
Without being able to see what is going on within the dashboard it is not possible to give a definitive answer. As a shot in the dark, you may want to rebuild the categories to see if that helps.<br />
<br />
If you want us to poke around and you feel comfortable with that, you can email the admin username and password to docs@inmotionhosting.com. We can then take a look at your actual setup. If you do that, please comment back here with the subject of the email so we can find it as we get thousands of emails a day.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12743);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-12886'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/55a68df12c83a7dfdf78a00da4024d8d?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/55a68df12c83a7dfdf78a00da4024d8d'>David Kley</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-17 4:44 am</div>
				                <div><p>Without an extension, the only way to remove the article id is to create a menu item leading to the article. Once you have done this, the id will disappear, and will also get rid of the leading category URL.</p>
<p>&nbsp;</p>
<p>Example before: www.yourdomain.com/category/12-cool-post</p>
<p>Example before: www.yourdomain.com/cool-post</p>
<p>&nbsp;</p>
<p>IMO this is much better for seo, unless you need the subcategories displayed</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12886);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-19614'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/ba2ed611813673bbbd27b9952f983d0b?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/ba2ed611813673bbbd27b9952f983d0b'>Joseph</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-16 6:09 am</div>
				                <div><p>Hi</p>
<p>my website main language isn't english but Persian. regarding optimization, i changed the title of my articles into Persian but the changes i make in Alias can't be applied. it produces a random number for alias! my website is in joomla 2.5! please help! my language at backend is english. is it the cause of this trouble?</p>
<p>&nbsp;</p>
<p>tnx</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19614);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-16 12:53 pm</div>
				                <div>Hello Joseph,<br />
<br />
Sorry for the problem with your Joomla aliases.  It appears that this particular issue was discussed and resolved in the Joomla forums.  Check out this <a href="http://forum.joomla.org/viewtopic.php?f=544&t=692406&view=previous" rel="nofollow" target="_blank">discussion</a> and see if it doesn't address the situation that you are encountering.  <br />
<br />
Kindest regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19636);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
