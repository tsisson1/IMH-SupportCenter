<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:51274:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/cpanel/can-not-log-in-to-cpanel" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Arcana, It appears that there is a record of some issues with the server at the time this question posted. The issue was resolved by our systems t..." />
  <title>Connection Timed Out error when accessing cPanel | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/cpanel/can-not-log-in-to-cpanel" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:41a020aa804faa8610e46102baee14ae -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Connection Timed Out error when accessing cPanel</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/Arcana'>Arcana</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-12-30 10:37 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>2,546</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I have opened on the inbound side the proper ports. It use to work and I could log in but i can not any more. The following is the error message i am getting.<br />
<br />
<br />
The connection has timed out<br />
      ...
      <br />
        <br />
        <br />
          The server at secure129.inmotionhosting.com is taking too long to respond.<br />
        <br />
<br />
        <br />
        <br />
<br />
  ...
  If your computer or network is protected by a firewall or proxy, make sure<br />
    that Firefox is permitted to access the Web.</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_2049' id='upvote_answer_2049' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='2049' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_2049').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_2049' id='downvote_answer_2049' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='2049' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_2049').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Arcana,  <br />
<br />
It appears that there is a record of some issues with the server at the time this question posted.  The issue was resolved by our systems team and everything should be normal again.  Our sincere apologies for any disruption in service.  Please check again (make sure to clear your  browser cache) and let us know immediately of the problem persists.<br />
<br />
...
Arnel C.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_2049').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_2049' id='form_comment_on_answer_2049' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/cpanel/can-not-log-in-to-cpanel&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/cpanel/can-not-log-in-to-cpanel'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="12feff243d69e5a90da417f7f04099ee" value="1" />	</div>
	</form>
<!-- <br />
