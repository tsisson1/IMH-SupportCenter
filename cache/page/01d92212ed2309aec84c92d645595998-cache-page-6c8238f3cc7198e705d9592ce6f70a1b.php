<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:54026:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/nginx/getting-started-with-nginx/what-is-nginx" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-02-16T20:33:48-08:00" />
  <meta name="keywords" content="nginx, apache" />
  <meta name="author" content="TJ Edens" />
  <meta name="description" content="In this series of articles we will be going over Nginx and how to use it versus Apache. " />
  <title>What is Nginx? - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/nginx/getting-started-with-nginx/what-is-nginx" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:e036e3ad15c00c3bf727cf80999934a8 -->
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>1,005</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Feb 16, 2015'><span style='color:#606060;'>Published:</span> Feb 16, 2015</div>
							...
							<div style='clear:both;'></div>
								...
								<p> Nginx (engine-x) is a HTTP and reverse proxy server, which is very similar to Apache. It directs traffic to the correct location on the server based on its configuration files. Using/Installing this software does require <a href="http://www.inmotionhosting.com/support/website/cpanel-account-management/obtain-root-access">root access</a> to your server. Throughout this series we will go over how to install Nginx and remove Apache from your server (if it is installed by default, like our servers) as well as how to use Nginx in advanced situations, such as including Varnish.</p>
<h2>How is Nginx different from Apache?</h2>
<p>Nginx is an event-based web server that handles the traffic as it comes in with one process. Apache on the other hand will spawn a new process for every instance it needs to perform the same job. Also unlike Apache, Nginx will cache static content throughout your website to provide a quicker load time for your visitors.</p>
<h2>System Requirements for Nginx</h2>
<p>Currently Nginx is available and runs great on the following operating systems:
   <ul>
     <li>FreeBSD 9.3, 10.0 (amd64)</li>
    <li>RedHat 5.9, 6.5, 7 (i386, x86_64)</li>
    <li>CentOS 5.9, 6.5, 7 (i386, x86_64)</li>
    <li>Debian 6, 7 (i386, x86_64)</li>
    <li>Ubuntu 10.04 LTS, 12.04 LTS, 14.04 LTS, 14.10 (i386, x86_64)</li>
    <li>Ubuntu 14.04 LTS (AArch64/ARM64)</li>
    <li>SUSE Linux Enterprise Server 11 SP3, 12 (x86_64)</li>
    <li>Amazon EC2</li>
    <li>Microsoft Azure</li>
</ul>
  In the next guide we will go over how to install Nginx on a <a href="http://www.inmotionhosting.com/vps-hosting">VPS</a> or Dedicated <a href="http://www.inmotionhosting.com/dedicated-servers">server</a>. </p>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 2: What is Nginx?</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 1: <a href='/support/edu/nginx/getting-started-with-nginx/how-to-uninstall-nginx'>How to uninstall Nginx</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/nginx/getting-started-with-nginx/what-is-nginx&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/nginx/getting-started-with-nginx/what-is-nginx'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD01MjYmaWQ9MzQ4OCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
