...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/oscommerce/adding-products-content/add-manufacturers" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-05-16T16:27:14-07:00" />
  <meta name="keywords" content="add manufacturer osCommerce" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="You will need manufacturers to which you will tie your products. This quick tutorial shows you how to add them in osCommerce." />
  <title>Adding manufacturers in osCommerce - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/oscommerce/adding-products-content/add-manufacturers" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:90a5a8d58097df8dc60107bc644bb33a -->
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/oscommerce' itemprop='url'><span itemprop='title'>osCommerce<span></a><div class='dropdown_4columns'><h2>osCommerce Education Channel</h2><div class='col_2'><h3>100 Level Classes</h3><div><a href='/support/edu/oscommerce/new-store'>101: Getting Started with osCommerce</a></div><div><a href='/support/edu/oscommerce/adding-products-content'>102: Adding products and content to osCommerce</a></div><div><a href='/support/edu/oscommerce/config-tax-payment-shipping'>103: Configuring Taxes and Shipping in osCommerce</a></div><div><a href='/support/edu/oscommerce/payment-gateway-configuration'>104: osCommerce payment gateway configuration</a></div><div><a href='/support/edu/oscommerce/testing-ecommerce-functionality'>105: Testing the osCommerce site</a></div></div><div class='col_2'><h3>200 Level Classes</h3><div><a href='/support/edu/oscommerce/change-theme-template-appearance'>201: Changing your osCommerce appearance</a></div><div><a href='/support/edu/oscommerce/manage-users-administrators'>202: Managing Users in osCommerce</a></div><div><a href='/support/edu/oscommerce/add-security-addons'>203: Adding security to osCommerce</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/oscommerce/adding-products-content' itemprop='url'><span itemprop='title'>102: Adding products and content to osCommerce<span></a><div class='dropdown_3columns'><h2> Adding products and content to osCommerce</h2><div class='col_3'><div>1. <a style='display:inline;' href='/support/edu/oscommerce/adding-products-content/how-to-add-a-product-to-oscommerce'>How to Add a Product to osCommerce</a></div><div>2. <a style='display:inline;' href='/support/edu/oscommerce/adding-products-content/oscommerce-adding-products'>Adding products in OSCommerce Video</a></div><div>3. <a style='display:inline;' href='/support/edu/oscommerce/adding-products-content/new-category'>How to add a new category in osCommerce</a></div><div>4. <a style='display:inline;' href='/support/edu/oscommerce/adding-products-content/oscommerce-adding-categories'>Adding categories in OSCommerce Video</a></div><div>5. <a style='display:inline;' href='/support/edu/oscommerce/adding-products-content/move-items'>Rearranging products and categories in osCommerce</a></div><div>6. <a style='display:inline;' href='/support/edu/oscommerce/adding-products-content/change-sort-order'>Modifying the sort order of categories and products in osCommerce</a></div><div>7. <a style='display:inline;' href='/support/edu/oscommerce/adding-products-content/remove-categories-products'>Deleting categories and products in osCommerce</a></div><div>8. <a style='display:inline;' href='/support/edu/oscommerce/adding-products-content/add-subcategory'>How to add a subcategory in osCommerce</a></div><div>9. <a style='display:inline;' href='/support/edu/oscommerce/adding-products-content/add-manufacturers'>Adding manufacturers in osCommerce</a></div><div>10. <a style='display:inline;' href='/support/edu/oscommerce/adding-products-content/how-to-add-a-product-attribute-in-oscommerce'>How to Add a Product Attribute in osCommerce</a></div><div>11. <a style='display:inline;' href='/support/edu/oscommerce/adding-products-content/bulk-price-change'>How to perform a bulk price change for all products in OSCommerce</a></div><div>12. <a style='display:inline;' href='/support/edu/oscommerce/adding-products-content/oscommerce-adding-product-attributes'>Adding product attributes in OSCommerce Video</a></div><div>13. <a style='display:inline;' href='/support/edu/oscommerce/adding-products-content/oscommerce-creating-specials'>Creating specials in osCommerce Video</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Adding manufactur...</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Adding manufacturers in osCommerce									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>798</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Apr 18, 2013'><span style='color:#606060;'>Published:</span> May 16, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>This tutorial will explain how to add a manufacturer to your osCommerce shopping cart. Manufacturers are important as they are where the products come from. To add a manufacturer in osCommerce, simply follow the steps below.</p>

<h2>How to add a manufacturer in osCommerce</h2>

<ol class="article_list">
<li><a href="/support/edu/oscommerce/new-store/how-to-log-into-oscommerce">Log into your osCommerce admin interface</a>.<div style="clear:both;"></div></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/oscommerce/102/add-manufacturer/1-click-catalog.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="click catalog menu option" src="//cdn.inmotionhosting.com/support/images/stories/edu/oscommerce/102/add-manufacturer/1-click-catalog.png" title="Click here to view the larger image" width="200" /></a>Under the left hand menu find and click the <strong>Catalog</strong> button.<div style="clear:both;"></div></li>
<li>From the <em>Catalog</em> menu, click on <strong>Manufacturers</strong>.<div style="clear:both;"></div></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/oscommerce/102/add-manufacturer/2-click-insert.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="click insert button" src="//cdn.inmotionhosting.com/support/images/stories/edu/oscommerce/102/add-manufacturer/2-click-insert.png" title="Click here to view the larger image" width="200" /></a>This brings up a list of all your manufacturers. Click the <strong>+Insert</strong> button located under the list.<div style="clear:both;"></div></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/oscommerce/102/add-manufacturer/3-add-data.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="add manufacturer data" src="//cdn.inmotionhosting.com/support/images/stories/edu/oscommerce/102/add-manufacturer/3-add-data.png" title="Click here to view the larger image" width="200" /></a>The <em>New Manufacturer</em> screen will appear. From here, enter data into the following fields:<br />

<table class="article_table">
<tr><th>Setting</th><th>Description</th><tr>
<tr><td>Manufacturer's Name</td><td>The name of the manufacturer.</td></tr>
<tr><td>Manufacturer's Image</td><td>Upload an image of the manufacturer's logo by clicking the <strong>Browse</strong> button and uploading it from your local machine.</td></tr>
<tr><td>Manufacturer's URL</td><td>This is the web address for the manufacturer.</td></tr>
</table>
<div style="clear:both;"></div></li>
<li>Once you have filled out the data, click on the <strong>Save</strong> button. This will now add the new manufacturer to the list.
  <table class="article_table">
<tr><th>Before</th><th>After</th><tr>
<tr><td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/oscommerce/102/add-manufacturer/4-before.png"><img  alt="before the new manufacturer added" src="//cdn.inmotionhosting.com/support/images/stories/edu/oscommerce/102/add-manufacturer/4-before.png" title="Click here to view the larger image" width="200" /></a></td><td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/oscommerce/102/add-manufacturer/4-after.png"><img  alt="after the new manufacturer added" src="//cdn.inmotionhosting.com/support/images/stories/edu/oscommerce/102/add-manufacturer/4-after.png" title="Click here to view the larger image" width="200" /></a></td></tr>
</table>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/oscommerce/adding-products-content'>102: Adding products and content to osCommerce</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 9: Adding manufacturers in osCommerce</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 8: <a href='/support/edu/oscommerce/adding-products-content/add-subcategory'>How to add a subcategory in osCommerce</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 10: <a href='/support/edu/oscommerce/adding-products-content/how-to-add-a-product-attribute-in-oscommerce'>How to Add a Product Attribute in osCommerce</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/oscommerce/adding-products-content/add-manufacturers&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/oscommerce/adding-products-content/add-manufacturers'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP3RzcmM9cnNiZWR1Jm9wdGlvbj1jb21fY29udGVudCZjYXRpZD0zNzEmaWQ9MjYyMiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="3464879a5dd09ede03e4095cfbff31ab" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/oscommerce/adding-products-content?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Adding products and content to osCommerce</h3></a>
		<table><tr><td colspan='2'><h4>Adding Products in osCommerce</h4></td></tr>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/oscommerce/adding-products-content/how-to-add-a-product-to-oscommerce?tsrc=rsbedu'>How to Add a Product to osCommerce</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/oscommerce/adding-products-content/oscommerce-adding-products?tsrc=rsbedu'>Adding products in OSCommerce Video</a></td>
                </tr>
        <tr><td colspan='2'><h4>Creating categories in osCommerce</h4></td></tr>  <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/oscommerce/adding-products-content/new-category?tsrc=rsbedu'>How to add a new category in osCommerce</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/oscommerce/adding-products-content/oscommerce-adding-categories?tsrc=rsbedu'>Adding categories in OSCommerce Video</a></td>
                </tr>
          <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/oscommerce/adding-products-content/move-items?tsrc=rsbedu'>Rearranging products and categories in osCommerce</a></td>
                </tr>
          <tr >
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/oscommerce/adding-products-content/change-sort-order?tsrc=rsbedu'>Modifying the sort order of categories and products in osCommerce</a></td>
                </tr>
          <tr >
                        <td valign='top'>7.</td>
                        <td><a href='/support/edu/oscommerce/adding-products-content/remove-categories-products?tsrc=rsbedu'>Deleting categories and products in osCommerce</a></td>
                </tr>
          <tr >
                        <td valign='top'>8.</td>
                        <td><a href='/support/edu/oscommerce/adding-products-content/add-subcategory?tsrc=rsbedu'>How to add a subcategory in osCommerce</a></td>
                </tr>
        <tr><td colspan='2'><h4>Product options and attributes in osCommerce</h4></td></tr>  <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>9.</td>
                        <td><a href='/support/edu/oscommerce/adding-products-content/add-manufacturers?tsrc=rsbedu'>Adding manufacturers in osCommerce</a></td>
                </tr>
          <tr >
                        <td valign='top'>10.</td>
                        <td><a href='/support/edu/oscommerce/adding-products-content/how-to-add-a-product-attribute-in-oscommerce?tsrc=rsbedu'>How to Add a Product Attribute in osCommerce</a></td>
                </tr>
          <tr >
                        <td valign='top'>11.</td>
                        <td><a href='/support/edu/oscommerce/adding-products-content/bulk-price-change?tsrc=rsbedu'>How to perform a bulk price change for all products in OSCommerce</a></td>
                </tr>
          <tr >
                        <td valign='top'>12.</td>
                        <td><a href='/support/edu/oscommerce/adding-products-content/oscommerce-adding-product-attributes?tsrc=rsbedu'>Adding product attributes in OSCommerce Video</a></td>
                </tr>
          <tr >
                        <td valign='top'>13.</td>
                        <td><a href='/support/edu/oscommerce/adding-products-content/oscommerce-creating-specials?tsrc=rsbedu'>Creating specials in osCommerce Video</a></td>
                </tr>
          	</table>
