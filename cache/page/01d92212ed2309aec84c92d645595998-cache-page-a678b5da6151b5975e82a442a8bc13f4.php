<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:56520:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/wordpress/http-error-wordpress-upload-media-large-filesize" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Mwmconsulting, Sorry for the problem with uploading the files into WordPress. It's hard for us to determine what you have changed without having m..." />
  <title>HTTP Error - Wordpress Upload Media (Large Filesize) | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/wordpress/http-error-wordpress-upload-media-large-filesize" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:6671c7aed5e22ef2b9799e29acd5ae5d -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box straight_bottom'>
                <h1 style='font-size:26px;'>HTTP Error - Wordpress Upload Media (Large Filesize)</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/mwmconsulting'>mwmconsulting</a>
			<div>14 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-07-15 6:02 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>649</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I continually get the dreaded &quot;HTTP Error&quot; when uploading large sized files via Wordpress. I've tried increasing all memory and upload limits, to no avail.<br />
<br />
Does anyone know how to fix this issue? Your help is most appreciated. Thank you!</div>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px;'>
				<div style='font-size:12px; max-width:500px; overflow:auto;'>Disabling mod_security via Cpanel seems to have helped, but what in mod_security would cause this issue? I'd like to have mod_security enabled for the protection it offers.</div>
			...
			<td style='width:100px;' valign='top'>
				...
				<div class='smallgrey'>
					<a href='/support/community-support/users/mwmconsulting'>mwmconsulting</a><br />
					14 <a href='/support/team/points' target='_blank'>Points</a><br />
					2015-07-15 06:28 pm EST
				</div>
			</td>
		</tr>
	</table>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_7663' id='upvote_answer_7663' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='7663' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_7663').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_7663' id='downvote_answer_7663' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='7663' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_7663').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>32,263 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2015-07-15 6:31 pm EST
                		        </div>
					
		                </div>

				Hello Mwmconsulting,<br />
<br />
Sorry for the problem with uploading the files into WordPress.  It's hard for us to determine what you have changed without having more information.  Did you change the PHP.INI file and the WP-CONFIG.PHP file? What values have you changed?  We do have an article that you can reference - <a href="http://www.inmotionhosting.com/support/website/php/increase-the-max-file-upload-size-in-php-ini" target="_blank">Increasing the max file upload size in PHP.INI</a>.  This might help with the problem that you're having.  If you continue to have problems, please provide more specific information about the issue so that we can investigate it in more depth.<br />
<br />
Kindest regards,<br />
Arnel C.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_7663').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_7663' id='form_comment_on_answer_7663' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>The problem is with mod_security. It's spitting out these errors for large files:<br />
<br />
ModSecurity: Request body (Content-Length) is larger than the configured limit (134217728).<br />
<br />
How can I increase the upload limit for large files in mod_security?<br />
<br />
I tried this in /usr/local/apache/conf/modsec2.conf, but it didn't work.<br />
<br />
SecRequestBodyInMemoryLimit 268435456<br />
<br />
It still spits out the same error.</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>This seems to be the directive which fixes the problem:<br />
<br />
SecRequestBodyLimit<br />
<br />
I put the following in modsec2.conf and it fixed the problem:<br />
<br />
SecRequestBodyLimit 268435456</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello Mwmconsulting,<br />
<br />
If you're having problems with the Modsecurity, you will need to send a request through email to our  <a href="http://www.inmotionhosting.com/support/website/getting-started-guides/submitting-and-checking-on-status-of-tickets" target="_blank">live support team</a>.  They will have access to be able to disable or modify modsecurity rules.  The Support Center staff cannot make that change for you.<br />
<br />
...
Arnel C.</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Actually, it's this combo which works to solve the problem for me:<br />
<br />
SecRequestBodyInMemoryLimit 1073741823<br />
SecRequestBodyLimit 1073741823<br />
LimitRequestBody 1073741823</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/wordpress/http-error-wordpress-upload-media-large-filesize&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/wordpress/http-error-wordpress-upload-media-large-filesize'></div>
<script type='text/javascript'>
  (function() {
