<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50007:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/email-troubleshooting/deleted-imap-emails-reappear" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, Thanks for your question about the reappearing IMAP emails on your Galaxy S6 phone. I recommend reviewing the instructions for the email setup on..." />
  <title>Deleted IMAP emails reappear | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/email-troubleshooting/deleted-imap-emails-reappear" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:7ce1e299ff1cb5ff64f54cb06c6c3594 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-20']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '190.172.165.250']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Deleted IMAP emails reappear</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-04-15 12:35 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>2,229</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>When I delete emails on my Galaxy S6, which is setup through IMAP on the default email app, the deleted emails disappear temporarily from the inbox and then reappear soon. Is there a way to keep emails deleted on the email app? Thanks.</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_7037' id='upvote_answer_7037' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='7037' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_7037').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_7037' id='downvote_answer_7037' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='7037' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_7037').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
Thanks for your question about the reappearing IMAP emails on your Galaxy S6 phone.  I recommend reviewing the instructions for the <a href="http://www.inmotionhosting.com/support/email/email-client-setup/galaxy">email setup on your Galaxy</a>.  There is an option in the DELETE section that allows you to remove emails from the server after deleting them from your phone.  That should hopefully take care of the problem.  <br />
<br />
...
Arnel C.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_7037').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_7037' id='form_comment_on_answer_7037' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/email-troubleshooting/deleted-imap-emails-reappear&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/email-troubleshooting/deleted-imap-emails-reappear'></div>
<script type='text/javascript'>
  (function() {
