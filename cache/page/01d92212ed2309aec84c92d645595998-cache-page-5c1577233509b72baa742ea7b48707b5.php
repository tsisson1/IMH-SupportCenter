<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:68133:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/prestashop-15/pshop15-price-rules/choose-specific-products" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-09-05T18:58:09-07:00" />
  <meta name="keywords" content="select specific products PrestaShop 1.5 cart rule" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="This article for PrestaShop 1.5 covers the ability to restrict a cart rule to customers that have a product with specific criteria in their cart." />
  <title>Setting specific products for using a cart rule in PrestaShop 1.5 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/prestashop-15/pshop15-price-rules/choose-specific-products" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:97e3ee1cc3a8e097c266b7a679abeca3 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '88.212.35.6']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Setting specific products for using a cart rule in PrestaShop 1.5									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>4,012</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Aug 15, 2012'><span style='color:#606060;'>Published:</span> Sep 5, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Cart rules allow for a lot of specialization and customization. This tutorial walks you through how to set your cart rule to be used with specific products or product groups. If you want to offer discounts for customers that purchase a specific product, group of products, or even from specific manufacturers or suppliers, this is the setting that allows that. Setting the cart rules to work with specific products and product groups are simple in PrestaShop 1.5. To learn how to do that, see the steps below.</p>
<p><strong>Setting specific products for using a cart rule in PrestaShop 1.5</strong></p>
...
<li>Using the top menu bar, hover over the <strong>Price Rules</strong> tab and click on the <strong>Cart Rules</strong> option.                                            <br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Price_Rules/cart_rules.png"><img  alt="cart_rules" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Price_Rules/cart_rules.png" /></a></li>
<li>You are now on the <strong>Cart Rules</strong> screen. Find the rule you want to work with and click on the <strong>Edit</strong> icon (the one that looks like a pencil and paper) on the right side of that specific row.                                    <br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Price_Rules/Cart_Rules/cart-rule-edit.png"><img  alt="cart-rule-edit" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Price_Rules/Cart_Rules/cart-rule-edit.png" /></a></li>
<li>From within the <strong>Cart Rules</strong> click the <strong>Conditions</strong> tab on the left sidebar tab and find the checkbox labeled <strong>Product Selection</strong>. Selecting this checkbox will open an area where you can select your preferred producstand/or groups. There is a dropdown that allows you to select the specific feature you want to limit the cart rule to. <br /> 
<table class="article_table">
<tbody>
<tr>
<th>Products</th>
<td>specific products such as an iPod</td>
</tr>
<tr>
<th>Attribute</th>
<td>an attribute of a product such as color, type of CPU. etc</td>
</tr>
<tr>
<th>Categories</th>
<td>group of products such as laptops, or mp3 players</td>
</tr>
<tr>
<th>Manufacturers</th>
<td>company that builds the products, such as Apple</td>
</tr>
<tr>
<th>Suppliers</th>
<td>company that ships the product to you, often the same as the manufacturer</td>
</tr>
</tbody>
</table>
<br /> After you select the type of feature you are limiting the cart rule to, you can opt to add more, further customizing the cart rule.</li>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Price_Rules/Cart_Rules/Select_Product/select-product.png"><img  alt="select-product" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Price_Rules/Cart_Rules/Select_Product/select-product.png" /></a>
<li>Once your have built your product specifications, click on the green <strong>Save</strong> button in the upper right corner. Now any customer that has a product in thier cart that meets your criteria will have the cart rule applied.</li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/prestashop-15/pshop15-price-rules'>205: Working with Cart Rules in PrestaShop 1.5</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 12: Setting specific products for using a cart rule in PrestaShop 1.5</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 11: <a href='/support/edu/prestashop-15/pshop15-price-rules/specific-customer-group'>Restrict cart rules to work with certain groups in PrestaShop 1.5</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 13: <a href='/support/edu/prestashop-15/pshop15-price-rules/cart-specific-shops'>How to set cart rules for specific shops in PrestaShop 1.5</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/prestashop-15/pshop15-price-rules/choose-specific-products&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/prestashop-15/pshop15-price-rules/choose-specific-products'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNTImaWQ9MTY4NCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="60124143e74ebd0126380e4f90aac38c" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/prestashop-15/pshop15-price-rules?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Working with Cart Rules in PrestaShop 1.5</h3></a>
		<table><tr><td colspan='2'><h4>Cart Rule Settings</h4></td></tr>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/prestashop-15/pshop15-price-rules/disable-cart-rule?tsrc=rsbedu'>Disabling a cart rule in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/prestashop-15/pshop15-price-rules/set-coupon-code?tsrc=rsbedu'>How to set a coupon code in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/prestashop-15/pshop15-price-rules/change-partial-use?tsrc=rsbedu'>Changing the  partial use of a coupon voucher in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/prestashop-15/pshop15-price-rules/set-cart-rule-priority?tsrc=rsbedu'>Setting the priority for cart rules in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/prestashop-15/pshop15-price-rules/cart-rule-specific-customer?tsrc=rsbedu'>Limiting a cart rule to specific customers in PrestaShop1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/prestashop-15/pshop15-price-rules/cart-rule-date-range?tsrc=rsbedu'>How to set a date range for cart rules in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>7.</td>
                        <td><a href='/support/edu/prestashop-15/pshop15-price-rules/set-min-amount?tsrc=rsbedu'>How to set a minimum amount for cart rules in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>8.</td>
                        <td><a href='/support/edu/prestashop-15/pshop15-price-rules/set-total-avaialble?tsrc=rsbedu'>How to set a quantity limit for cart rules in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>9.</td>
                        <td><a href='/support/edu/prestashop-15/pshop15-price-rules/max-times-per-customer?tsrc=rsbedu'>Setting the max times customers can use a cart rule in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>10.</td>
                        <td><a href='/support/edu/prestashop-15/pshop15-price-rules/restrict-carriers-per-rule?tsrc=rsbedu'>Restrict cart rules to work with certain carriers in PrestaShop 1.5 </a></td>
                </tr>
          <tr >
                        <td valign='top'>11.</td>
                        <td><a href='/support/edu/prestashop-15/pshop15-price-rules/specific-customer-group?tsrc=rsbedu'>Restrict cart rules to work with certain groups in PrestaShop 1.5</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>12.</td>
                        <td><a href='/support/edu/prestashop-15/pshop15-price-rules/choose-specific-products?tsrc=rsbedu'>Setting specific products for using a cart rule in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>13.</td>
                        <td><a href='/support/edu/prestashop-15/pshop15-price-rules/cart-specific-shops?tsrc=rsbedu'>How to set cart rules for specific shops in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>14.</td>
                        <td><a href='/support/edu/prestashop-15/pshop15-price-rules/cart-rule-free-shipping?tsrc=rsbedu'>How to set free shipping for cart rules in PrestaShop 1.5 </a></td>
                </tr>
          <tr >
                        <td valign='top'>15.</td>
                        <td><a href='/support/edu/prestashop-15/pshop15-price-rules/cart-rule-discounts?tsrc=rsbedu'>How to set discounts for cart rules in PrestaShop 1.5 </a></td>
                </tr>
          	</table>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						...
						<div><a style='font-size:16px;' href='/support/community-support/users/yuvauk'>yuvauk</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-12-25 6:59 pm</div>
				                <div>Hello, I'd like to offer free shipping only on products from specific manufacturers for the order value of above $50. I setup the manufacturer in the cart rule and everything is fine. However with this setting if a customer places an order above $50 from 2 manufacturers, the discount is still applied whereas if the order value from the specific manufacturer is not above $50 I do not want to offer free shipping. How can I achieve this setup?<br />
<br />
Thanks </div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8502);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
