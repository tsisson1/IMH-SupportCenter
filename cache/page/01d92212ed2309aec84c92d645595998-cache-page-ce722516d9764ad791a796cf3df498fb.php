<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:62822:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/dokuwiki/writing-content-dokuwiki/edit-delete-restore-pages" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-01-09T21:20:59-08:00" />
  <meta name="keywords" content="edit delete restore page doku wiki dokuwiki" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="This first step in creating content in DokuWiki is to edit the pages. This article will explain how to edit and elete pages from DokuWiki." />
  <title>How to edit and delete DokuWiki pages - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/dokuwiki/writing-content-dokuwiki/edit-delete-restore-pages" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:75f6e1c419505fd5c1612ccb037329bc -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '108.6.12.224']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to edit and delete DokuWiki pages									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>9,549</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 9, 2013'><span style='color:#606060;'>Published:</span> Jan 9, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Editing pages in DokuWiki is a basic process of creating a wiki. Users visiting the site have the ability to edit pages by default. In some cases, users can edit or delete a page by accident. other times, a malicious use my deface a page. Pages created in Dokuwiki are stored as revisions. These can be restored at a later date if necessary. This article will explain how to edit, delete, and restore pages in DokuWiki.</p>
<h2>Editing DokuWiki pages</h2>
<p style="margin: 0px;">Editing pages is the basic necessary function of any wiki. The following section will explain how to edit pages in DokuWiki.</p>
<h3>How to edit a page</h3>
<ol class="article_list">
<li><a target="_blank" href="/support/edu/dokuwiki/geting-started-dokuwiki/login-dokuwiki" title="Click for more information">Log into DokuWiki</a></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/101/create-edit-delete-restore/edit-page-dokuwiki-1.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="edit-page-dokuwiki-1-dokuwiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/101/create-edit-delete-restore/edit-page-dokuwiki-1.gif" title="Click here to view the larger image" width="100" /></a><strong>Navigate to the page </strong>you want to edit.
<p><strong>Select the Pencil</strong> icon in the right menu and <strong>click Edit this page</strong>.</p>
<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/101/create-edit-delete-restore/edit-page-dokuwiki-2.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="edit-page-dokuwiki-2-dokuwiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/101/create-edit-delete-restore/edit-page-dokuwiki-2.gif" title="Click here to view the larger image" width="100" /></a>Add the Header, content and a signature to the page.
<p><strong>Click Save.</strong></p>
<br style="clear: both;" /></li>
</ol>
<h2>Deleting and restoring pages</h2>
<p>When users add pages that are not needed or are filled with content that is offensive, the page can be removed from the site by deleting the content from the article and saving it. When deleting a page, its not terribly critical if you delete it by mistake because the page is actually not deleted. The page is actually removed from the site and still available for restore. This section will explain how to delete or remove a page from your DokuWiki site.</p>
<h3>How to delete a page</h3>
<p>The following will explain the steps for deleting a page from your wiki.</p>
<ol class="article_list">
<li><a target="_blank" href="/support/edu/dokuwiki/geting-started-dokuwiki/login-dokuwiki" title="Click for more information">Log into DokuWiki</a></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/101/create-edit-delete-restore/delete-pages-dokuwiki-1.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="delete-pages-dokuwiki-1-dokuwiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/101/create-edit-delete-restore/delete-pages-dokuwiki-1.gif" title="Click here to view the larger image" width="100" /></a><strong>Find the page you want to delete</strong>. In this case, the page "<em>Playground</em>" is being deleted. <br style="clear: both;" /></li>
<li><strong>Click the Edit</strong> (Pencil) in the menu on the right. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/101/create-edit-delete-restore/delete-pages-dokuwiki-2-remove-text.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="delete-pages-dokuwiki-2-remove-text-dokuwiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/101/create-edit-delete-restore/delete-pages-dokuwiki-2-remove-text.gif" title="Click here to view the larger image" width="100" /></a><strong>Delete the contents of the page </strong>so that there is no text in the text area.
<p><strong>Click Save</strong>.</p>
<p>Now the page was removed from the Wiki.</p>
<br style="clear: both;" /></li>
</ol>
<h3>How to restore a page</h3>
...
<ol class="article_list">
<li><a target="_blank" href="/support/edu/dokuwiki/geting-started-dokuwiki/login-dokuwiki" title="Click for more information">Log into DokuWiki</a></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/101/create-edit-delete-restore/restore-deleted-page-dokuwiki-1-search.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="restore-deleted-page-dokuwiki-1-search-dokuwiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/101/create-edit-delete-restore/restore-deleted-page-dokuwiki-1-search.gif" title="Click here to view the larger image" width="100" /></a><strong>Search for the page that was deleted</strong>. In this case, the page "<em>Restore deleted page</em>" is being restored. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/101/create-edit-delete-restore/restore-deleted-page-dokuwiki-2-old-revisions.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="restore-deleted-page-dokuwiki-2-old-revisions" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/101/create-edit-delete-restore/restore-deleted-page-dokuwiki-2-old-revisions.gif" title="Click here to view the larger image" width="100" /></a>The Search results should show "<em>Nothing was found.</em>"
<p>In the menu on the left, <strong>click the "clock" icon and click Old revisions</strong>.</p>
<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/101/create-edit-delete-restore/restore-deleted-page-dokuwiki-3-select-version.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="restore-deleted-page-dokuwiki-3-select-version" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/101/create-edit-delete-restore/restore-deleted-page-dokuwiki-3-select-version.gif" title="Click here to view the larger image" width="100" /></a><strong>Click the name of the page </strong>to load the content of that page. You can select from different revision dates.
<p>This can be used to restore previous versions as well.</p>
<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/101/create-edit-delete-restore/restore-deleted-page-dokuwiki-4-edit.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="restore-deleted-page-dokuwiki-4-edit-dokuwiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/101/create-edit-delete-restore/restore-deleted-page-dokuwiki-4-edit.gif" title="Click here to view the larger image" width="100" /></a><strong>Click the Edit this page </strong>(the Pencil) in the menu on the right.
<p><strong>Click Save</strong> to restore the content to the specific revision date. Now you can see the page in your wiki again as it was prior to it being deleted.</p>
<br style="clear: both;" /></li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 3: How to edit and delete DokuWiki pages</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 2: <a href='/support/edu/dokuwiki/writing-content-dokuwiki/create-namespace-doku'>How to create namespaces in DokuWiki</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 4: <a href='/support/edu/dokuwiki/writing-content-dokuwiki/delete-rename-namespaces-doku'>How to delete and rename namespaces in DokuWiki</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/dokuwiki/writing-content-dokuwiki/edit-delete-restore-pages&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/dokuwiki/writing-content-dokuwiki/edit-delete-restore-pages'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMTkmaWQ9MjE2MCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="fe04ba3eacc04e07aa88ad26a6a44a30" value="1" />	</div>
	</form>
<!-- <br />
