<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:62231:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/drupal-7/getting-started/install-drupal-using-fantastico" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-05-02T16:31:37-07:00" />
  <meta name="keywords" content="Drupal 7 Fantastico cPanel install CMS" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="In this tutorial, we will show you how to install Drupal 7 using Fantastico De Luxe using cPanel." />
  <title>How to install Drupal using Fantastico - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/drupal-7/getting-started/install-drupal-using-fantastico" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:a04746eb4f8d4e1d0c0c257689cdf203 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '74.123.0.44']);
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
				<img src='/support/images/stories/drupal-partner/supporting-partner-80_3.png' style='float:right; margin:0px 0px 15px 15px;' alt='Drupal Association Support Partner'>		<h1>
															How to install Drupal using Fantastico									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>6,672</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Aug 24, 2011'><span style='color:#606060;'>Published:</span> May 2, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<div style="border: 1px solid #B85F00; padding: 4px; margin-bottom: 10px; background: #FFF0E0;">Fantastico, a feature in cPanel that helps you easily install programs to your account, is no longer available. As of September 17<sup>th</sup>, 2012, Fantastico has been replaced by <a href="/support/edu/cpanel/softaculous">Softaculous</a>.<br /><br /> This article is being kept in our Support Center for our VPS and Dedicated Customers who may still be using Fantastico. For all other users, please see our <a href="/support/edu/cpanel/softaculous/how-to-install">Softaculous software installation guide</a> for more help with installing programs such as WordPress and Joomla.</div>
<p>After you know that your server meets <a href="http://www.inmotionhosting.com/drupal-hosting/drupal-requirements.html">Drupal's system requirements</a>, you can then begin to install Drupal 7. From the uploading of the Drupal 7 core files all the way to your database setup and configuration, a good Drupal 7 walkthrough will include thorough installation steps. This article will assist you with installing Drupal using Fantastico, a tool provided through InMotion Hosting that automates software installation and makes the installation process much easier.</p>
<p>If you're not hosting with InMotion Hosting and don't have Fantastico included with your account, you may instead need to manually install Drupal 7. While this route does include more steps, follow our guide here on <a href="/support/edu/drupal-7/getting-started/manually-installing-the-latest-version-of-drupal">manually installing Drupal 7 </a>and get Drupal installed in no time.</p>
<p>You can install Drupal using Fantastico which is located within cPanel.</p>
<ol class="article_list">
	<li>You'll first need to<a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel"> log into cPanel</a>.</li>
	<li>Access the Fantastico de Luxe section of cPanel by clicking on the icon.</li>
	<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/drupal/click_fantastico.gif"><img  alt="click_fantastico" src="//cdn.inmotionhosting.com/support/images/stories/drupal/click_fantastico.gif" /></a>
	</p>
	<li>Click the Drupal link, which is beneath the Content Management label.</li>
	<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/drupal/click_drupal.gif"><img  alt="click_drupal" src="//cdn.inmotionhosting.com/support/images/stories/drupal/click_drupal.gif" /></a>
	</p>
	<li>Click the "<strong><em>New Installation</em></strong>" link.</li>
	<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/drupal/click_new_installation.gif"><img  alt="click_new_installation" src="//cdn.inmotionhosting.com/support/images/stories/drupal/click_new_installation.gif" /></a>
	</p>
	<li>In step 1/3 for installing Drupal, you will be providing the basic settings needed to setup Drupal.</li>
	<h2>Installing on a domain</h2>
	<p>If you have more than one domain name, select the domain you which to install Drupal onto from the drop down menu.</p>
	<h2>Installing &nbsp;in a directory</h2>
	<p>If you would like to install Drupal into a sub directory, enter the directory path here. For example, if your domain name is domain.com and you would like Drupal to be accessed via <strong>example.com/support</strong>, then you would enter <strong>support</strong> as the install in directory.</p>
	<h2>Admin Access Data</h2>
	<p>You will need to enter a username and password in order to access the administrative area of Drupal, which you need to create here.</p>
	<h2>Base Configuration</h2>
	<p>Your Drupal installation at times may send the administrator email updates. In this field, enter the email address you would like to receive those emails. It's very important to enter in a valid email address.</p>
	<p>&nbsp;</p>
	<p>At the bottom, you will see a button labeled <strong>Install Drupal</strong>. Click that to move to the next step.</p>
	<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/drupal/step1.gif"><img  alt="step1" src="//cdn.inmotionhosting.com/support/images/stories/drupal/step1.gif" /></a>
	</p>
	<p>On the "<strong><em>Install Drupal (2/3)</em></strong>" page, simply click "<strong><em>Finish Installation</em></strong>"</p>
	<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/drupal/step2.gif"><img  alt="step2" src="//cdn.inmotionhosting.com/support/images/stories/drupal/step2.gif" /></a>
	</p>
	<p>When you've reached the "<strong><em>Install Drupal (3/3)</em></strong>" page, your Drupal installation has been successful. You are given a link to the site as well as the admin username and password. If you would like to have a summary of the installation details and admin information emailed to you for future reference, enter your email address in field and click "<strong><em>Send E-mail</em></strong>"</p>
	<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/drupal/step3.gif"><img  alt="step3" src="//cdn.inmotionhosting.com/support/images/stories/drupal/step3.gif" /></a>
	</p>
</ol>
<p>Congratulations, you have successfully installed Drupal! Get started by visiting the link given to your site during the last part of the install. You should see the screen below when visiting the site. Be sure to check out our article on <a href="/support/edu/drupal-7/getting-started/how-to-log-into-the-drupal-admin-dashboard">how to log into the admin dashboard</a> to continue your customizing your site. For more information on this course please visit <a href="/support/edu/drupal-7/getting-started">Installing and Getting Started with Drupal 7</a>.
</p>
<div><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/drupal/drupal_installed.jpg"><img  alt="drupal_installed" src="//cdn.inmotionhosting.com/support/images/stories/drupal/drupal_installed.jpg" width="500" height="249" /></a>
</div> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/drupal-7/getting-started'>101: Installing and Getting Started with Drupal 7</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 2: How to install Drupal using Fantastico</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 1: <a href='/support/edu/drupal-7/getting-started/getting-started-guide-drupal'>Getting Started Guide Drupal</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 3: <a href='/support/edu/drupal-7/getting-started/manually-installing-the-latest-version-of-drupal'>Manually install Drupal 7 - Part 1/2 - Database and file setup</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/drupal-7/getting-started/install-drupal-using-fantastico&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/drupal-7/getting-started/install-drupal-using-fantastico'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yMDEmaWQ9MTA2MyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/drupal-7/getting-started?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Installing and Getting Started with Drupal 7</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/drupal-7/getting-started/getting-started-guide-drupal?tsrc=rsbedu'>Getting Started Guide Drupal</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/drupal-7/getting-started/install-drupal-using-fantastico?tsrc=rsbedu'>How to install Drupal using Fantastico</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/drupal-7/getting-started/manually-installing-the-latest-version-of-drupal?tsrc=rsbedu'>Manually install Drupal 7 - Part 1/2 - Database and file setup</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/drupal-7/getting-started/initial-configuration-of-drupal-installation?tsrc=rsbedu'>Manually install Drupal 7 - Part 2/2 - Initial Configuration</a></td>
                </tr>
          <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/drupal-7/getting-started/how-to-log-into-the-drupal-admin-dashboard?tsrc=rsbedu'>How to log into the Drupal 7 Administrator Dashboard</a></td>
                </tr>
          	</table>
