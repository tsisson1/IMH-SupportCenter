<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:84906:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/database-setup/upload-large-database-over-50-mb" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-09-24T17:19:40-07:00" />
  <meta name="keywords" content="upload 50mb 50 larger than database phpmyadmin softaculous mb" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="If you want to upload a large database on your own you can install PhpMyAdmin on a subdomain. This article explains how." />
  <title>How to upload a database that's larger than 50mb - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/database-setup/upload-large-database-over-50-mb" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:84c00d43cc5ef7d8c8024003db7c7db3 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '143.132.131.145']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to upload a database that's larger than 50mb									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>27,325</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Feb 26, 2013'><span style='color:#606060;'>Published:</span> Sep 24, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>When migrating your site from another server to ours or if you are restoring a large website backup, you may need to upload or import a MySQL database that is larger than 50mb. Currently, all our shared servers have a limit of 50MB for the database upload in cPanel PhpMyAdmin. This is a global setting on the server that cannot be changed.</p>
<p>You can make a work around to get your database uploaded from your cPanel without contacting support. Softaculous has the ability to install PhpMyAdmin on a subdomain on your account. Installing PhpMyAdmin on a subdomain will allow you to change the <em>php.ini</em> settings that restrict the default PhpMyAdmin from uploading large databases. The following steps will explain how to do this.</p>
<h2>Installing a PhpMyAdmin through Softaculous</h2>
<p>All shared accounts have the ability to use Softaculous. PhpMyAdmin is available in your <a target="_blank" href="/support/edu/cpanel/softaculous">Softaculous program</a> for install. The following will show you how to install it.</p>
...
<li><a target="_blank" href="/support/website/cpanel/how-do-i-create-a-subdomain-in-my-control-panel-cpanel">Create a subdomain</a> for your PhpMyAdmin.</li>
<li>Go to <strong>Software</strong> / <strong>Services</strong> and click <strong>Softaculous</strong>.</li>
<li>Select <strong>PhpMyAdmin</strong> from the <strong>Database Tools</strong> section.</li>
<li>Click install and select the subdomain you created in the <strong>Choose Domain</strong> Drop box. Leave the <strong>In Directory</strong> box blank.</li>
<li>Click <strong>install</strong>.</li>
</ol>
<p>Next you will need to set the <em>php.ini</em> to allow larger file uploads.</p>
<h2>Editing the php.ini to allow large database uploads</h2>
<ol class="article_list">
<li><a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel" target="_blank" title="Click here for info">Login into your cPanel</a>.</li>
<li><a target="_blank" href="/support/website/how-to/how-to-move-files-on-server" title="How do I move files on my server?">Copy</a> your <em>php.ini</em> from your main domain to your subdomain <a target="_blank" href="/support/website/general-server-setup/where-are-my-files-located">document root folder</a>.</li>
<li><a target="_blank" href="/support/website/how-to/how-to-edit-a-file">Edit</a> the <em>php.ini</em> you copied to your subdomain for your PhpMyAdmin.</li>
<li>Change the following to be larger than 100MB. You can make the settings like the example below.
<pre style="margin-left: 20px;">upload_max_filesize = 256mb
memory_limit = 256mb
post_max_size = 100mb</pre>
<p><strong>Save</strong> the file.</p>
</li>
<li><a href="/support/website/general-server-setup/recursive-php-ini" target="_blank" title="Click here for info">Make the php.ini recursive in the .htaccess </a>by editing the .htaccess in the subdomain directory and adding the path to your subdomain document root folder.
<p>That's all there is to it. You will now be able to use your Softaculous installed PhpMyAdmin to upload a database larger than 50mb.</p>
</li>
</ol> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/database-setup/upload-large-database-over-50-mb&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/database-setup/upload-large-database-over-50-mb'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MzQmaWQ9NTkxJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/cpanel/need-help-for-restoring-my-backuptargz-to-new-server?tsrc=rsbraq'> Need help for restoring my backup.tar.gz to new server</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/databases/import-large-sql-database?tsrc=rsbraq'>Import large SQL DATABASE </a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/cpanel/how-to-access-mysql-database-using-phpmyadmin?tsrc=rsbraq'>how to access mysql database using phpmyadmin ?</a>
                                </div>
...
<a name='comments'></a>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/280fa8c4bdc0725d1da896897405c328?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/280fa8c4bdc0725d1da896897405c328'>leo</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-06 3:15 pm</div>
				                <div>Its really helpful article. When i lost my hope to install Magento. i was looking in google i got an link of this website so, finally i fixed my problem Thanks</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(18229);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/f85656be759ac0d00a9721774d94f6ed?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/f85656be759ac0d00a9721774d94f6ed'>Rene Aguiluz</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-04 9:05 am</div>
				                <div><p>This seems a good option, however I am stack at the php.ini where can I copied it from? there is no php.ini in my main domain. if I copy one from my own computer then the phpmyadmin doesn't load.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24617);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-06 3:58 pm</div>
				                <div>If you are one of our customers. You can contact our Live Support team for a copy of the server's php.ini folder to be placed on your account.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24666);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/9cc0206ad447bb59802c35cc970982f1?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/9cc0206ad447bb59802c35cc970982f1'>Md.saiful islam</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-14 9:06 am</div>
				                <div><p>I Need help upload for larg database table</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26611);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-14 1:53 pm</div>
				                <div>We are glad to take a look. What type of issue are you having?</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26641);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						...
						<div><a style='font-size:16px;' href='/support/community-support/users/hssnusmn09'>hssnusmn09</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-12-21 8:59 am</div>
				                <div>Hi, I have installed phpmyadmin from softaculous in my addon domain 'faiez.co' in 'public_html &gt; faiez.co &gt; phpmyadmin<br />
I filled 'In directory' field as 'phpmyadmin', also got the php.ini file from the inmotion support and editted it, I need to know from where can I upload the database? from cPanel phpmyadmin or somewhere else, becuase it shows 50 MB limit from cPanel phpmyadmin.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29300);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-12-21 5:18 pm</div>
				                <div>The newly installed phpMyAdmin for your domain does not follow the 50MB limit for importing databases. You can simply import the new file within phpMyAdmin and it should work, even if it is over 50MB.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29319);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-12-22 2:57 am</div>
				                <div>Thank you for the response Does it mean that after changing my domain nameserver, and when my website will load from inmotion, then I have to access my new phpmyadmin from mydomain.co/phpmyadmin ? or directly from cpanel. I'm confused because when I try from cpanel, it show the 50mb limit error. </div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29327);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-12-22 8:42 am</div>
				                <div>Anytime importing a SQL file in phpmyadmin via cPanel, it will have a 50MB limit. If its installed via softaculous, then you should be able to load the file. </div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29333);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='/support/images/avatars/default_avatar.jpg' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='/support/community-support/users/rkjamvi'>rkjamvi</a></div>
						<div></div>
						<div></div>
						<div>6 <a href='/support/team/points' target='_blank'>Points</a></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-02 3:35 pm</div>
				                <div>i am getting<br />
<br />
...
<br />
http://phpmyadmin.munchtickets.com/</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30949);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-03 5:06 am</div>
				                <div>Hello Rkijamvi,<br />
<br />
Can you please provide more information about your account?  What server are you on?  How have you configured phpmyadmin?  We need a little more information in order to investigate the issue, please.<br />
<br />
If you have any further questions or comments, please let us know.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30965);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-07 3:23 pm</div>
				                <div>My domain is munchtickets.com and yes I installed phpmyadmin but its giving me internal server error. Even I removed this sub domain and created a new one pma.munchtickets.com but still the same error.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31028);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-07 4:26 pm</div>
				                <div>Hello, I see the http://pma.munchtickets.com/ URL is working. Are you not having that experience?</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31035);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
