<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:58499:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/opencart/attributes-products-specifications/product-tags" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-04-22T17:32:47-07:00" />
  <meta name="keywords" content="opencart product tags" />
  <meta name="author" content="John-Paul Briones" />
  <meta name="description" content="This guide explains how to work with Product Tags in OpenCart." />
  <title>Working with Product Tags in OpenCart 1.5 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/opencart/attributes-products-specifications/product-tags" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:ff02a42540638fbf1fc136479ad5e4f9 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '41.65.101.79']);
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/opencart' itemprop='url'><span itemprop='title'>OpenCart<span></a><div class='dropdown_4columns'><h2>OpenCart Education Channel</h2><div class='col_2'><h3>100 Level Classes</h3><div><a href='/support/edu/opencart/installing-opencart-and-adding-products'>101: Installing OpenCart and Adding Products</a></div><div><a href='/support/edu/opencart/managing-customers'>102: Managing Customers through OpenCart</a></div><div><a href='/support/edu/opencart/setting-up-payment-gateways'>103: Setting up a Payment Gateway</a></div><div><a href='/support/edu/opencart/testing-your-store'>104: Testing your OpenCart Store</a></div><div><a href='/support/edu/opencart/processing-orders'>105: Processing Orders in OpenCart</a></div><div><a href='/support/edu/opencart/customizing-store-look-and-feel'>106: Customizing the Look and Feel of OpenCart</a></div><div><a href='/support/edu/opencart/reports'>107: Using OpenCart Reports</a></div></div><div class='col_2'><h3>200 Level Classes</h3><div><a href='/support/edu/opencart/admin-tools'>201: OpenCart Administration</a></div><div><a href='/support/edu/opencart/security'>202: OpenCart Security</a></div><div><a href='/support/edu/opencart/203-shipping-and-taxes-in-opencart'>203: Shipping and Taxes in OpenCart</a></div><div><a href='/support/edu/opencart/204-working-with-affiliates-in-opencart'>204: Working with Affiliates in OpenCart</a></div><div><a href='/support/edu/opencart/attributes-products-specifications'>205: Adding Attributes to OpenCart products</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/opencart/attributes-products-specifications' itemprop='url'><span itemprop='title'>205: Adding Attributes to OpenCart products<span></a><div class='dropdown_3columns'><h2> Adding Attributes to OpenCart products</h2><div class='col_3'><div>1. <a style='display:inline;' href='/support/edu/opencart/attributes-products-specifications/product-tags'>Working with Product Tags in OpenCart 1.5</a></div><div>2. <a style='display:inline;' href='/support/edu/opencart/attributes-products-specifications/creating-attribute-groups-in-opencart'>Creating Attribute Groups in OpenCart 1.5</a></div><div>3. <a style='display:inline;' href='/support/edu/opencart/attributes-products-specifications/adding-attributes-to-attribute-groups-in-opencart'>Adding Attributes to Attribute Groups in OpenCart 1.5</a></div><div>4. <a style='display:inline;' href='/support/edu/opencart/attributes-products-specifications/adding-attributes-to-products-in-opencart'>Adding Attributes to products in OpenCart 1.5</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Working with Product T...</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Working with Product Tags in OpenCart 1.5									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>5,901</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Nov 15, 2013'><span style='color:#606060;'>Published:</span> Apr 22, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<strong>Product</strong> tags in OpenCart help you <em>group and categorize</em> products together, which helps customers navigate your store and find items they are looking for. In this tutorial we will show you how to work with <strong>Product Tags</strong> in <em>OpenCart</em>.

<h2>Where do Product Tags Display?</h2>
<p>When you add a <em>Product Tag</em> to an item in OpenCart, it will display below the <em>Product Description</em>, here is an example:<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/opencart/product-tags/view-of-product-tag.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/opencart/product-tags/view-of-product-tag.png" alt="view of product tag" title="OpenCart Tag" /></a></p>

<h2>What Can I use Product Tags for?</h2>
<p><em>Product Tags</em> help you group products together in your OpenCart store. For example, if you add a <strong>monitor</strong> tag to 2 products, when you click the tag the products will be listed. As a test, I added a <em>monitor</em> tag to 2 items, now when I click the <strong>monitor</strong> tag it displays like this:<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/opencart/product-tags/product-tag-search.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/opencart/product-tags/product-tag-search.png" alt="view of products tagged" title="OpenCart tag search result" /></a></p>

<h2>How to Add Product Tags in OpenCart</h2>
<ol class="article_list">
  <li><a href="/support/edu/opencart/installing-opencart-and-adding-products/logging-into-the-opencart-dashboard" target="_blank">Login to the OpenCart Dashboard</a>.</li>
  <li>Roll your mouse over <em>Catalog</em>, and click <strong>Products</strong>.<br>
  <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/opencart/product-tags/edit-products.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/opencart/product-tags/edit-products.png" alt="editing products" title="opencart edit" /></a></li>
  <li>Click the <strong>Edit</strong> button next to the item you want to edit the <em>Product Tags</em> for.</li>
  <li>On the <em>Product Page</em> scroll down to the bottom and you can add tags there. Use a comma to separate the words, here is an example:<br>
  <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/opencart/product-tags/adding-tags.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/opencart/product-tags/adding-tags.png" alt="example tags" title="adding product tags" /></a></li>
  <li>Click the <strong>Save</strong> button on the top right when you are finished.</li>
</ol><br>
Congratulations, now you know how to work with <strong>Product Tags</strong> in OpenCart! 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/opencart/attributes-products-specifications'>205: Adding Attributes to OpenCart products</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 1: Working with Product Tags in OpenCart 1.5</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 2: <a href='/support/edu/opencart/attributes-products-specifications/creating-attribute-groups-in-opencart'>Creating Attribute Groups in OpenCart 1.5</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/opencart/attributes-products-specifications/product-tags&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/opencart/attributes-products-specifications/product-tags'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zODgmaWQ9Mjk3OCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="51e5e26e02177114d7a26663329a65d8" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/opencart/attributes-products-specifications?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Adding Attributes to OpenCart products</h3></a>
		<table>  <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/opencart/attributes-products-specifications/product-tags?tsrc=rsbedu'>Working with Product Tags in OpenCart 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/opencart/attributes-products-specifications/creating-attribute-groups-in-opencart?tsrc=rsbedu'>Creating Attribute Groups in OpenCart 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/opencart/attributes-products-specifications/adding-attributes-to-attribute-groups-in-opencart?tsrc=rsbedu'>Adding Attributes to Attribute Groups in OpenCart 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/opencart/attributes-products-specifications/adding-attributes-to-products-in-opencart?tsrc=rsbedu'>Adding Attributes to products in OpenCart 1.5</a></td>
                </tr>
          	</table>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/c9814e5fb7c56a23094a8149b6e4c729?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/c9814e5fb7c56a23094a8149b6e4c729'>Jamunabhaskar</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-30 10:52 am</div>
				                <div><p>The information given is very useful for me.Thanks alot</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27081);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
