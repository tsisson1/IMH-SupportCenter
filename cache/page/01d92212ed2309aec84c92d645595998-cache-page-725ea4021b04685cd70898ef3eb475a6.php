<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50792:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/cpanel/i-cannot-log-into-vitiger-crm" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, The error you are getting means that the php version on the server is not supported by the vtiger program. This is due to a php 5.4 upgrade on ou..." />
  <title>I cannot log into Vitiger CRM | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/cpanel/i-cannot-log-into-vitiger-crm" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:7d0040c57b84839b87a4132aaec3ea4f -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>I cannot log into Vitiger CRM</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2014-08-05 2:16 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>68</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Dear sir,<br />
i am getting below error while log in to Vtiger CRM, please do the needful asap.<br />
<br />
Fatal error: Cannot re-assign auto-global variable _FILES in /home/vinsak5/public_html/vtiger.vinsak.com/crm/include/utils/CommonUtils.php on line 1395</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_5388' id='upvote_answer_5388' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='5388' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_5388').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_5388' id='downvote_answer_5388' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='5388' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_5388').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
The error you are getting means that the php version on the server is not supported by the vtiger program. This is due to a php 5.4 upgrade on our servers.  I tested your vtiger installation by setting it to php 5.4 and did see the error, however, it is now running on php version 5.2 and not getting the error. <br />
<br />
Are you still seeing that error anywhere? If so, please tell us the exact steps to duplicate it so we may look into it further.<br />
<br />
Kindest Regards,<br />
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_5388').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_5388' id='form_comment_on_answer_5388' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/cpanel/i-cannot-log-into-vitiger-crm&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/cpanel/i-cannot-log-into-vitiger-crm'></div>
<script type='text/javascript'>
  (function() {
