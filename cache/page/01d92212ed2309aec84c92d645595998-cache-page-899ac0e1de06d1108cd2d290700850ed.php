<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:53872:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/email/email-client-setup/email-client-configuration-email-over-ssl" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-02-13T19:44:45-08:00" />
  <meta name="keywords" content="SSL email port settings configuration email client" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="In this article, we will how to configure your port settings to send and receive email over SSL" />
  <title>Email Client Configuration - Email Over SSL - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/email/email-client-setup/email-client-configuration-email-over-ssl" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:04d70f8513267c9cda7b4d2ed5274218 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '184.60.121.2']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Email Client Configuration - Email Over SSL									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>17,710</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Aug 29, 2011'><span style='color:#606060;'>Published:</span> Feb 13, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>When setting up your email client to send and receive email over SSL the following ports will need to be used:</p>
<p style="padding-left: 30px;"><strong>POP: 995</strong><br /><strong>IMAP: 993</strong><br /><strong>SMTP: 465</strong></p>
<p>If you have any trouble you will want to set them back to the default ports:</p>
<p style="padding-left: 30px;"><strong>POP: 110</strong><br /><strong>IMAP: 143</strong><br /><strong>SMTP: 587</strong></p>
<p>You may receive a domain mismatch error in your mail client, and in that case you can change your incoming and/or outgoing server to match the secure server name of the machine your site is hosted on, for example,</p>
<p style="padding-left: 30px;"><strong>secure##.inmotionhosting.com</strong></p>
<p>Please refer to your Technical details <a href="/support/website/how-to/how-to-log-into-amp">in AMP</a> for your server information. Keep in mind you should only use the secure server name over SSL!</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/email/email-client-setup/email-client-configuration-email-over-ssl&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/email/email-client-setup/email-client-configuration-email-over-ssl'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NyZpZD02ODkmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="c7d862b51fe8c7ba6e74042cb1727400" value="1" />	</div>
	</form>
<!-- <br />
