<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50668:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/joomla-3/joomla-3-on-inmotion-hosting" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Joomla 3.1 will work well within our hosting services and is actually highly recommended by us. We have a full education channel on Joomla 3.1 which wil..." />
  <title>Joomla 3.1 on InMotion Hosting | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/joomla-3/joomla-3-on-inmotion-hosting" rel="canonical" />
...
<script>
  ...
  ga('send', 'pageview');
	...
	<!-- cid:1b2bcb05aee58f9a6b4ba853d28fce2f -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Joomla 3.1 on InMotion Hosting</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/philcpa'>philcpa</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-09-14 2:51 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>626</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>You have joomla 2.5 available for download on your website. I noticed that at joomla.org, joomla 3.1 is available. If I download joomla 3.1, is that useable to create my website for Inmotion web hosting?</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_3952' id='upvote_answer_3952' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='3952' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_3952').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_3952' id='downvote_answer_3952' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='3952' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_3952').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>11,186 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2013-09-16 8:15 am EST
                		        </div>
					
		                </div>

				Joomla 3.1 will work well within our hosting services and is actually highly recommended by us.  We have a full education channel on Joomla 3.1 which will walk you through the entire process of installation and configuration.<br />
<br />
&lt;a href=&quot;http://www.inmotionhosting.com/support/edu/joomla-3&quot;&gt;Joomla 3.1 Education Channel&lt;/a&gt;
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_3952').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_3952' id='form_comment_on_answer_3952' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="e72898a0a10d2a633e117bbd0ecefd99" value="1" />	</div>
	</form>
<!-- <br />
