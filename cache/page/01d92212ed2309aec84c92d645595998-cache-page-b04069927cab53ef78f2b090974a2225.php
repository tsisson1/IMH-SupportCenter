<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:59153:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.net/support/edu/prestashop-15/managing-price-rules/intro-cart-rules" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-08-10T18:13:31-07:00" />
  <meta name="keywords" content="intro cart rules what are PrestaShop 1.5" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="This PrestaShop 1.5 article gives you an introduction to cart rules." />
  <title>Introduction to Cart Rules in PrestaShop 1.5 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/prestashop-15/managing-price-rules/intro-cart-rules" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:41448e0cf54e1e259c0467fe58795272 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Introduction to Cart Rules in PrestaShop 1.5									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>2,114</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Aug 10, 2012'><span style='color:#606060;'>Published:</span> Aug 10, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p><strong>Introduction to Price Rules in PrestaShop 1.5</strong></p>
<p>Pricing rules in PrestaShop allow for you to customize your shopper's experience. This lets them feel special by allowing you to give deals and discounts (also known as vouchers or coupons) to specific people or on specific items. Rules built around customers are known as Cart Rules and rules built around product categories are known as Catalog Price Rules.</p>
<p><strong>Cart Rules</strong></p>
<p>One of the newer features in PrestaShop 1.5 is the upgrade to cart pricing rules. Known as <em>vouchers</em> in PrestaShop 1.4, these cart rules are ways for you to provide discounts to specific customers in certain ways. Upgrades to the previous voucher abilities include:</p>
<ul>
<li>Using discounts with customers who use specific carriers.</li>
<li>Use discounts with specific products, suppliers, categories, manufacturers or any combination.</li>
<li>Use the discounts as free shipping, free gifts, from the total amount or even all of these options.</li>
</ul>
<p>Cart rules are defined by three tabs that contain the many different settings. This allows the shop admin to customize the rule to almost any customer or specific group of customers.</p>
<p><strong>Catalog Price Rules</strong></p>
<p>In addition to cart rules, you can also include Catalog Price Rules. These discounts apply to all products within a certain category. You can further talor the discount by restricting it by customer attributes such as their geographic location, the amount of items purchased, or even the currency used.</p>
<p>Additional filtering can be done on the product level by setting conditions that the product must meet. For example, if you set the rule to apply to laptops, you can customize it for all laptops of a specific brand, or even CPU, color, RAM, or any other attribute you wish. In essence, you can limit it down to one specific product if you apply enough conditions.</p>
<p>Between the two types of rules, you will be able to set discounts for almost any occasion. Use them wisely to make your customers feel special and they will keep coming back. You may want to continue on to our article on <a href="/support/edu/prestashop-15/managing-price-rules/create-cart-rule">creating a cart rule</a> in order to get started with customizing your visitor's shopping experience.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/prestashop-15/managing-price-rules'>204: Cart Rule Basics in PrestaShop 1.5</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 1: Introduction to Cart Rules in PrestaShop 1.5</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 2: <a href='/support/edu/prestashop-15/managing-price-rules/create-cart-rule'>How to create a cart rule in PrestaShop 1.5</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNzYmaWQ9MTY3MiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="65b547439ff0aa14b46ba5db741b8a78" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/prestashop-15/managing-price-rules?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Cart Rule Basics in PrestaShop 1.5</h3></a>
		<table><tr><td colspan='2'><h4>Basic Cart Rule (voucher) Management</h4></td></tr>  <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/prestashop-15/managing-price-rules/intro-cart-rules?tsrc=rsbedu'>Introduction to Cart Rules in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/prestashop-15/managing-price-rules/create-cart-rule?tsrc=rsbedu'>How to create a cart rule in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/prestashop-15/managing-price-rules/delete-cart-rule?tsrc=rsbedu'>How to delete a cart rule in PrestaShop 1.5</a></td>
                </tr>
          	</table>
