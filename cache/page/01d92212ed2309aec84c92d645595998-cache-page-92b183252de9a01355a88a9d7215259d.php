<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:53458:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/file-management/why-does-my-favicon-not-work-on-my-website" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hi suncoaster77, Thanks for posting your question. I'm more than happy to assist you. I've looked over your website and it appears the favicon loads as ..." />
  <title>Why does my favicon not work on my website? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/file-management/why-does-my-favicon-not-work-on-my-website" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:95ee45182882a2cbfbc349a308475497 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box straight_bottom'>
                <h1 style='font-size:26px;'>Why does my favicon not work on my website?</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/suncoaster77'>suncoaster77</a>
			<div>8 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-02-11 3:21 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>10,613</span>
			</div>
...
<br />
my favicon does not work. <br />
First I uploaded a finished favicon.ico file to the root public_html folder. As it did not appear, I tried to upload a jpg-file and rename it to .ico as mentioned in the tutorial. Did not work again. <br />
Just to make sure, I uploaded the favicon.ico also to the very root directory, but it does not appear.<br />
<br />
The link I am using in my html-file looks like this:  an I added type=&quot;image/x-icon&quot; / inside the tag when I used the .jpg-file. <br />
<br />
What did I do wrong? What (root) folder does the .ico-file have to be stored in? Any comments on the tag?<br />
<br />
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px;'>
				<div style='font-size:12px; max-width:500px; overflow:auto;'>Hi,<br />
<br />
I am also having trouble with my favicon. I am getting many /favicon.ico under pagenot found.</div>
				
				
			</td>
			<td style='width:100px;' valign='top'>
				<img src='https://lh4.googleusercontent.com/-OF5USQUyMAo/AAAAAAAAAAI/AAAAAAAAAJI/wIQJdG3WgAc/photo.jpg?sz=90' style='width:40px;' class='user_avatar' />
				<div class='smallgrey'>
					<a href='/support/community-support/users/UniqJDsgn'>UniqJDsgn</a><br />
					0 <a href='/support/team/points' target='_blank'>Points</a><br />
					2014-01-03 03:20 pm EST
				</div>
			</td>
		</tr>
	</table>
...
<div style='padding:15px; border:1px solid #d6d6d6; border-top:0px; background:#ebebeb;' class='round_bottom' >
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px;'>
				<div style='font-size:12px; max-width:500px; overflow:auto;'>&lt;div style=&quot;background-color: #FFF; padding-left: 10px;&quot;&gt;Hello UniqJDsgn,<br />
<br />
It appears that your website has a lot of requests for &lt;strong&gt;/img/favicon.ico?1387689441&lt;/strong&gt;. If you follow our guide on &lt;a href=&quot;http://www.inmotionhosting.com/support/website/how-to/how-to-create-a-favicon-for-your-website&quot; target=&quot;_blank&quot;&gt;how to add a Favicon for your website&lt;/a&gt; you should see that you'd typically want to end up with a link like this in your website's source code:<br />
<br />
&lt;pre class=&quot;code_block&quot; style=&quot;width: 500px; white-space: normal; margin-bottom: -30px;&quot;&gt;&amp;lt;link rel='shortcut icon' href='favicon.ico' type='image/x-icon' /&amp;gt;&lt;/pre&gt;<br />
<br />
I'd double-check your settings in PrestaShop to see what might be adding that extra content onto the end of your image. However it looks like the Favicon itself is showing up on your website, but I do see 404'd requests for &lt;strong&gt;favicon.ico&lt;/strong&gt;. This is because you don't have that file in your main &lt;strong&gt;/public_html/&lt;/strong&gt; directory, but rather inside the &lt;strong&gt;/public_html/img&lt;/strong&gt; directory.<br />
<br />
To stop the 404 errors, you can either simply copy your &lt;strong&gt;favicon.ico&lt;/strong&gt; file to your main &lt;strong&gt;/public_html/&lt;/strong&gt; directory, or correct the linking on certain pages to go to the &lt;strong&gt;/public_html/img&lt;/strong&gt; one.<br />
<br />
Please let us know if you had any further problems at all.<br />
<br />
- Jacob&lt;/div&gt;</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_569' id='upvote_answer_569' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='569' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_569').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_569' id='downvote_answer_569' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='569' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_569').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hi suncoaster77,<br />
<br />
Thanks for posting your question. I'm more than happy to assist you. I've looked over your website and it appears the favicon loads as expected. It appears a green square with a leaf cut out of the center. Are you still having issues with your favicon? If so, what website/ folder are you working in?<br />
<br />
Also, try clearing your web browser cache and see if that corrects the issue. <br />
<br />
...
Tim S
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_569').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_569' id='form_comment_on_answer_569' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/file-management/why-does-my-favicon-not-work-on-my-website&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/file-management/why-does-my-favicon-not-work-on-my-website'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="793dca59374d4a7bc18ef14759db279e" value="1" />	</div>
	</form>
<!-- <br />
