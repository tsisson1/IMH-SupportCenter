<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:73106:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/website-design/website-design-basics/introduction-web-design" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-08-15T18:04:09-07:00" />
  <meta name="keywords" content="web design HTML code tag create basic syntax doc type body head html title" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="Learn how about HTML and why it is so important when building your website. " />
  <title>Introduction to Web Design Basics - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/website-design/website-design-basics/introduction-web-design" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:68c7241a05d26a1146551ba6c24b1f95 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '117.197.181.119']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Introduction to Web Design Basics									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>23,597</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Sep 1, 2011'><span style='color:#606060;'>Published:</span> Aug 15, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>HTML can be a little intimidating for those not accustomed to looking at code. Once you familiarize your self with the basics, it becomes easier to write your website using HTML code. This article will break down the basics of how to get your HTML page created. We will go over what HTML is, how to create an HTML page, HTML basics, and what program you can use to edit the HTML.</p>
<h2>What is HTML?</h2>
<p>HTML is <strong>Hyper Text Markup language</strong>. Web pages read HTML in order to display your website content. Saying "<em>HTML page</em>" is the same as saying "<em>Web page</em>". HTML tags format the document and adds functionality. For example, the headline of your site can use the headline tags <code>&lt;h1&gt;</code>, <code>&lt;h2&gt;</code>, <code>&lt;h2&gt;</code> and so forth. This makes text larger and bold for headline. The <code>&lt;h1&gt;</code> being the largest. The <code>&lt;p&gt;</code> tag is for paragraphs and so forth. You will learn more about this in our next article called <a target="_blank" href="/support/edu/website-design/website-design-basics/understanding-basic-html-tags" title="Click here to view the next article">Understanding Basic HTML Tags</a>.</p>
<p class="alert"><strong>Important!</strong> In order for your home page to load, you will need to name it "<em>index</em>" (all lower case because Linux is case sensitive). If you name your home page home for example, the server will not recognize it as the home page.</p>
<h2>What program do I use to edit my HTML</h2>
<p>There are many ways to create HTML pages. You can use the <a target="_blank" href="/support/edu/cpanel/cpanel-file-manager/file-manager-code-editor">File Manager code editor</a>, a program like <a href="/support/website/dreamweaver/getting-started-guide-dreamweaver" target="_blank">DreamWeaver</a>, <a href="http://notepad-plus-plus.org/" target="_blank">Notepad ++</a>, <a href="http://www.kompozer.net/" target="_blank">Kompozer</a>, <a href="http://www.pagebreeze.com/" target="_blank">PageBreez</a>e, <a href="http://www.coffeecup.com/free-editor/" target="_blank">CoffeCup</a>, <a href="http://www.editplus.com/" target="_blank">Edit Plus</a> or any text editor to create an HTML page. HTML is stored in regular text files. You simply name the file <strong>.html</strong> or <strong>.htm</strong> file extension. Our servers view .htm before .html in the normal file indexing. So if you have a file called index.htm and a file called index.html, the index.htm will load and not the index.html when visiting your site.</p>
<h2>HTML basics: open and closed tags</h2>
<p>In HTML, there are 2 types of tags: Open and Closed tags.</p>
<h3>The opening and closing tag</h3>
<p>A tag that closes has 2 tags: an opening and a closing tag. See the following example;</p>
<pre style="margin-left: 20px;">&lt;body&gt;&lt;/body&gt;</pre>
<p>The <code>&lt;body&gt;</code> is the beginning or opening tag and the <code>&lt;/body&gt;</code> is the ending or closing tag. These tags have content or other HTML tags within them. Tags within another tag is called an "<em>Element</em>". The following example shows the <code>&lt;body&gt;</code> with an "<em>Element</em>" in it.</p>
<pre style="margin-left: 20px;">&lt;body&gt;
  &lt;p&gt;This is text in my website.&lt;/p&gt;
&lt;/body&gt;</pre>
<p>The beginning <code>&lt;body&gt;</code> tag tells the browser that the body of the page starts there and the <code>&lt;/body&gt;</code> tag tells the browser the body of the page stops there. The <code>&lt;p&gt;</code> that is within the <code>&lt;body&gt;</code> tag is called an <strong>Element</strong>. This is because the <code>&lt;p&gt;</code> tag is <strong>Nested</strong> within the <code>&lt;body&gt;</code> tag.</p>
<h3>The self closing tag</h3>
<p>The tag that is left open has only one tag. The end of the tag contains a ( / ) telling the browser that the tag ends. An example of a tag that is left open is the following:</p>
<p style="margin-left: 20px;"><code>&lt;link href="/support/" rel="" type="" /&gt;</code></p>
<p>There is not content that goes in this type of tag. These tags store HTML attributes that are used to reference other files or have attributes added to them. Common tags that don't close are the <code>&lt;link /&gt;</code> <code>&lt;input /&gt; &lt;br /&gt; and</code> <code>&lt;hr /&gt;</code>.</p>
<h2>How to create your first HTML page</h2>
<p>In order to create a web page so it is properly read by the web browser, you will need 4 different HTML tags. Below is a table explaining the necessary tags for your webpage.</p>
<p class="alert"><strong>Important!</strong> <code>&lt;!DOCTYPE html&gt;</code> The <code>&lt;!DOCTYPE html&gt;</code> type tells the browser how the webpage is coded. This allows some sites to be rendered strict to the newest coding standard or to use a transitional type that allows older deprecated HTML tags in the document type. Don't worry about the type of document type for now. This is not a tag; however, it is needed at very top of the webpage code.</p>
<table class="table table-bordered table-striped" border="0">
<tbody>
<tr><th colspan="2"><div align="center">Basic webpage tags</div></th></tr>
<tr><th width="193"><code>&lt;html&gt;&lt;/html&gt;</code></th>
<td width="830"><div align="left">The <code>&lt;html&gt;</code> tag tells the browser that the code is an html document.</div></td>
</tr>
<tr><th><code>&lt;title&gt;&lt;/title&gt;</code></th>
<td><div align="left">The <code>&lt;title&gt;</code> tag sets the text of the page for the browser toolbar and search results. This is not seen on the webpage itself. This is required in the head section of your Webpage.</div></td>
</tr>
<tr><th><code>&lt;head&gt;&lt;/head&gt;</code></th>
<td><div align="left">The <code>&lt;head&gt;</code> tag is where code is stored that processes styles, scripts and links to internal documents and so forth. These do not display on the webpage. The tags used in the head section are <code>&lt;title&gt;</code>, <code>&lt;style&gt;,</code> <code>&lt;base&gt;</code>, <code>&lt;link&gt;,</code> <code>&lt;meta&gt;,</code> <code>&lt;script&gt;,and </code> <code>&lt;noscript&gt;</code></div></td>
</tr>
<tr><th><code>&lt;body&gt;&lt;/body&gt;</code></th>
<td><div align="left">The <code>&lt;body&gt;</code> tag is where all the content for your website is stored. This is what is visible to the visitor of the webpage.</div></td>
</tr>
</tbody>
</table>
<p>&nbsp;</p>
<p>To see this code in context, see the example below with the HTML tags in use in an actual webpage.</p>
<pre style="margin-left: 20px;">&lt;!DOCTYPE html /&gt;<br />
&lt;html&gt;
  &lt;head&gt;
...
&lt;/html&gt;</pre>
<p>&nbsp;</p>
<p>That's how you set up a basic HTML page. Next you will need to know how to add the HTML code to your site for your content. Please check the next article on <a target="_blank" href="/support/edu/website-design/website-design-basics/understanding-basic-html-tags" title="Click here to view the next article"> Understanding Basic HTML Tags</a>. For more information on this course please visit <a target="_blank" href="/support/edu/website-design/website-design-basics" title="Click here to view the courses">Website Design Basics</a></p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 1: Introduction to Web Design Basics</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 2: <a href='/support/edu/website-design/website-design-basics/understanding-basic-html-tags'>Understanding Basic HTML Tags</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/website-design/website-design-basics/introduction-web-design&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/website-design/website-design-basics/introduction-web-design'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xMTkmaWQ9OTQ1JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="bd864fa5d3dc81e4b359ba87d46d96a7" value="1" />	</div>
	</form>
<!-- <br />
          ...
          <tr >
			...
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/website-design/code-post?tsrc=rsbraq'>How can I code a post in my website?</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/dreamweaver/what-are-nontext-items-on-a-webpage?tsrc=rsbraq'>what are non-text items on a webpage</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						...
						<div><a style='font-size:16px;' href='/support/community-support/users/SEO4Profit'>SEO4Profit</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2011-12-25 1:17 pm</div>
				                <div>This is how to bold text on a page</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(5847);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2011-12-25 1:18 pm</div>
				                <div>This is how to bold text on a page, but it doesn't look bold to me</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(5848);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2011-12-27 12:12 pm</div>
				                <div>Hi SEO4Profit,<br />
<br />
Thanks for posting your comment. You're right, it's not bold since we limit the HTML code you can place into comments. If you look in the tutorial, you'll see the code in one place, then undrneath it we display how the bold text looks. <br />
<br />
...
<br />
Tim S</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(5851);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='/support/images/avatars/default_avatar.jpg' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='/support/community-support/users/modernninja'>modernninja</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2012-02-13 6:49 pm</div>
				                <div>should recommend notepad++ for notepad editors...it actually helps immensely in recognizing whether or not you forgot to close your tags and other things like that. And it's open source...</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(6125);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2012-02-13 7:43 pm</div>
				                <div>Also, w3schools.com is a comprehensive outline for all web formats as well...I'm enjoying learning from here, but where I can't find it here, it's available there.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(6128);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-15590'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/721c3e5b65036df581b33cbee90f1e68?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/721c3e5b65036df581b33cbee90f1e68'>Francesca</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-27 12:00 pm</div>
				                <div>nothing much to comment on that i am a beginner student, the current topic or syllabus is on web design. i like your site it is user friendly will continue to visit it thank you.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15590);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
