<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:56564:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/oscommerce/add-security-addons/how-to-secure-your-oscommerce-site-with-the-htaccess-htpasswd" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-02-03T20:36:28-08:00" />
  <meta name="keywords" content="oscommerce htaccess htpasswd error security" />
  <meta name="author" content="John-Paul Briones" />
  <meta name="description" content="This is a tutorial on how to add extra security to your osCommerce site by using the htaccess/htpasswd method, which will also remove the error message." />
  <title>How to Secure Your osCommerce Site with the htaccess/htpasswd - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/oscommerce/add-security-addons/how-to-secure-your-oscommerce-site-with-the-htaccess-htpasswd" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:ed9f6e6a2cd55f99966de058483d7bd3 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to Secure Your osCommerce Site with the htaccess/htpasswd									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>4,792</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Apr 18, 2013'><span style='color:#606060;'>Published:</span> Feb 3, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/oscommerce/101/htaccess/additional-protection.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/edu/oscommerce/101/htaccess/additional-protection.png" alt="" align="right" /></a>The first time you access the Administrators section in the admin panel for osCommerce, you will see a message stating "This osCommerce Online Merchant Administration Tool installation is not additionally secured through htaccess/htpasswd means. Enabling the htaccess/htpasswd security layer will automatically store administrator username and passwords in a htpasswd file when updating administrator password records."
<br><br>
In this guide we will show you how to protect your osCommerce powered website with the htaccess/htpasswd means.
<h2>Securing osCommerce:</h2>
<ol class="article_list">
  <li><a href="/support/edu/oscommerce/new-store/oscommerce-admin-login">Login to the Admin Panel for osCommerce</a>.</li>
<li>Click the <strong>Administrators</strong> link.</li>
<li>You will see the users listed toward the bottom. Click the <strong>Edit</strong> button to the right of your administrator.
  <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/oscommerce/101/htaccess/edit-settings.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/edu/oscommerce/101/htaccess/edit-settings.png" alt="" /></a></li>
  <li>Enter a password in the <em>New Password</em> field, check the box for Protect With htaccess/htpasswd, then click the <strong>Save</strong> button.</li>
  <li>A box will pop up asking for a username and password, enter the ones you just set, and click the <strong>OK</strong> button.
  <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/oscommerce/101/htaccess/login-via-htaccess.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/edu/oscommerce/101/htaccess/login-via-htaccess.png" alt="" /></a></li>
<li>Instead of the red warning message, you will now see a green message stating "This osCommerce Online Merchant Administration Tool installation is additionally secured through htaccess/htpasswd means."<br>
  <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/oscommerce/101/htaccess/green-secured-message.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/edu/oscommerce/101/htaccess/green-secured-message.png" alt="" /></a><br><br></li>
</ol>
<br>
Congratulations, now you know how to protect your osCommerce powered website with the htaccess/htpasswd option. 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/oscommerce/add-security-addons'>203: Adding security to osCommerce</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 2: How to Secure Your osCommerce Site with the htaccess/htpasswd</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 1: <a href='/support/edu/oscommerce/add-security-addons/how-to-secure-the-configure-php-file-for-oscommerce'>How to Secure the configure.php File for osCommerce</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 3: <a href='/support/edu/oscommerce/add-security-addons/securing-your-oscommerce-contact-form-with-the-simple-captcha-add-on'>Securing your osCommerce contact form with the Simple Captcha Add-On</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/oscommerce/add-security-addons/how-to-secure-your-oscommerce-site-with-the-htaccess-htpasswd&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/oscommerce/add-security-addons/how-to-secure-your-oscommerce-site-with-the-htaccess-htpasswd'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zNzcmaWQ9MjYyMSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="be38dc7d334b9809bbf2412b88eccf74" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/oscommerce/add-security-addons?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Adding security to osCommerce</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/oscommerce/add-security-addons/how-to-secure-the-configure-php-file-for-oscommerce?tsrc=rsbedu'>How to Secure the configure.php File for osCommerce</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/oscommerce/add-security-addons/how-to-secure-your-oscommerce-site-with-the-htaccess-htpasswd?tsrc=rsbedu'>How to Secure Your osCommerce Site with the htaccess/htpasswd</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/oscommerce/add-security-addons/securing-your-oscommerce-contact-form-with-the-simple-captcha-add-on?tsrc=rsbedu'>Securing your osCommerce contact form with the Simple Captcha Add-On</a></td>
                </tr>
          	</table>
