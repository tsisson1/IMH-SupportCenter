...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/cpanel/precautions-to-protect-my-site-from-virus-malwareetc" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Thank you for your question jandan! There are many steps to take to fully secure your server. We have an article with these steps at the following link...." />
  <title>Precautions  to protect my site from Virus, malware..etc | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/cpanel/precautions-to-protect-my-site-from-virus-malwareetc" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:a62c9d8407efc573be45ec4004f9cdf2 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Precautions  to protect my site from Virus, malware..etc</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/jandan'>jandan</a>
			<div>10 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-02-17 7:48 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>1,003</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'><br />
I have an online freelance website , and I am giving the members options to load files for there daily work. I was concerned that some members could have upload an infected file with virus or malware therefore, I have restricted file upload to the following file types:<br />
(mpge, wmv, mp4, mp3, flv, txt, xlsx, xls, csv, dot, dotm, docx, doc, ico, psd, png, jpg, jpeg, gif, pdf)<br />
As I read in the internet that this can not prevent uploading viruses 100%, I did more reading in the support center and I found this ClamAV plugin for the cpanel. <br />
My question is is ClamAV enough for protecting my website and what to do if I find infected files , and if I delete those infected files will it effect the functionality of the website. <br />
Another question is : is there any other precautions I could use to protect my website, as I heard some websites scan the uploaded files immediately, if they can do that what is the process to follow their track. <br />
<br />
thanks<br />
</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_2288' id='upvote_answer_2288' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='2288' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_2288').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_2288' id='downvote_answer_2288' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='2288' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_2288').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>5,889 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2013-02-18 11:01 am EST
                		        </div>
					
		                </div>

				Thank you for your question jandan!<br />
<br />
There are many steps to take to fully secure your server. We have an article with these steps at the following link.<br />
<br />
&lt;a href=&quot;http://www.inmotionhosting.com/support/website/website-troubleshooting/steps-to-take-after-a-hack&quot; target=&quot;_blank&quot;&gt;Steps to Take After a Hack&lt;/a&gt;<br />
<br />
Clam AV is good for scanning for known malicious scripts. Of course there are always new scripts that antivirus software does not have in their database that can be potentially missed. <br />
<br />
Best Regards,<br />
James R
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_2288').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_2288' id='form_comment_on_answer_2288' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/cpanel/precautions-to-protect-my-site-from-virus-malwareetc&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/cpanel/precautions-to-protect-my-site-from-virus-malwareetc'></div>
<script type='text/javascript'>
  (function() {
