<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:94007:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/databases/check-repair-database" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-05-12T15:12:34-07:00" />
  <meta name="keywords" content="check repair database phpmyadmin" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="In this article, we'll explain how you can check for corrupt tables and repair a database " />
  <title>How to Check and Repair a Database - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/databases/check-repair-database" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:b4956acdb7dcb810ec7587a5a19cbd92 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '23.25.81.109']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to Check and Repair a Database									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>26,551</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Oct 19, 2011'><span style='color:#606060;'>Published:</span> May 12, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<p>There may be times when troubleshooting your website that you need to check and repair tables in your database, as they may have become corrupt.</p>
<p>Before continuing, be sure that you <a href="/support/website/general-server-setup/do-you-run-backups-of-your-servers">make a backup of the database</a> you are working with in the event this does not resolve your issue.</p>
<h2>How to check your tables</h2>
<ol class="article_list">
<li><a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">Log into your cPanel</a></li>
<li>Click the phpMyAdmin icon</li>
<li>Choose the database you are working with by clicking on it in the left menu</li>
<li>On the right side of the page, you will see a listing of your tables. Click "<strong>Check All</strong>" and then from the drop down choose "<strong>Check Table</strong>"<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/phpmyadmin/check-repair/phpMyAdmin_check_tables.gif"><img src="//cdn.inmotionhosting.com/support/images/stories/phpmyadmin/check-repair/phpMyAdmin_check_tables.gif" alt="how to check tables in phpMyAdmin"  /></a></li>
<li>The page will refresh and give you a summary of table that may be corrupted. As you can see from the screenshot below, all the tables are OK. If you receive any errors, you can continue reading to find how to repair your tables.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/phpmyadmin/check-repair/phpMyAdmin_checked_tables.gif"><img src="//cdn.inmotionhosting.com/support/images/stories/phpmyadmin/check-repair/phpMyAdmin_checked_tables.gif" alt="after checking tables in phpMyAdmin"  /></a></li>
</ol>
<h2>How to repair your tables</h2>
<ol class="article_list">
<li><a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">Log into your cPanel</a></li>
<li>Click the phpMyAdmin icon</li>
<li>Choose the database you are working with by clicking on it in the left menu</li>
<li>On the right side of the page, you will see a listing of your tables. Click "<strong>Check All</strong>" and then from the drop down choose "<strong>Repair Table</strong>"<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/phpmyadmin/check-repair/phpMyAdmin_repair_tables.gif"><img src="//cdn.inmotionhosting.com/support/images/stories/phpmyadmin/check-repair/phpMyAdmin_repair_tables.gif" alt="how to repair tables in phpMyAdmin"  /></a></li>
<li>The page will refresh and give you a summary of the tables that were repaired.</li>
</ol> 
...
<div style='display:inline-block;'>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMyZpZD0yNjcmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/wordpress/i-cant-log-in-to-my-wpadmin?tsrc=rsbraq'>i can't log in to my wp-admin.</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/prestashop-15/my-websites-not-working?tsrc=rsbraq'>my websites not working</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-28 4:14 pm</div>
				                <div><p>Does ANYONE know how to set-up a cron job in order to perform database checks and/or repair? &nbsp;I have searched on this for hours and NOTHING is working with InMotion.&nbsp;</p>
<p>Thanks.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10255);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-28 4:41 pm</div>
				                <div>Hello Jason,<br />
<br />
The basic command structure you need to run that is below:<br />
<div class="code_block">mysqlcheck -r userna5_wrdp1 -u userna5_wrdp1 -pPassWordHere</div><br />
<em>userna5</em> - replace with your database username<br /><br />
<em>wrdp1</em> - replace with your wordpress database name.<br /><br />
<em>PassWordHere</em> - replace with your database user's password<br /><br /><br />
Be sure to follow the instructions from our article on <a href="/support/www.inmotionhosting.com/support/edu/cpanel/301-run-cron-job">how to run a cron</a> job for it to run properly.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10259);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/e1b1bd06c2626bdb7d2b6b531d3bade9?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/e1b1bd06c2626bdb7d2b6b531d3bade9'>Jason</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-28 4:48 pm</div>
				                <div><p>Well, there is a bit of CRITICAL information missing in your reply. It's not simply "-pPasswordHere" it MUST be --password='PasswordHere' &nbsp;The password MUST be in single quotes, not in brackets or double-quotes. So, for anyone else like me out there here it is:</p>
<p>mysqlcheck -u CPANELNAME_DBUSER --password='DBPassword' --auto-repair --optimize --all-databases</p>
<p>In place of CPANELNAME_DBUSER you can also use your WHM username, it works as well I have found.</p>
<p>I tried many others and this is the one that works with InMotion.</p>
<p>Jason</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10262);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-29 1:57 pm</div>
				                <div>Hello Jason, and thanks for your comment.<br />
<br />
Sorry for the lack in clarification, while typing in &lt;span style=&quot;color: red;&quot;&gt;-pPasswordHere&lt;/span&gt;, you literally have a &lt;span style=&quot;color: red;&quot;&gt;-p&lt;/span&gt; then no space, then your password. You can also just leave the password option off altogether and it will prompt you for one, but that wouldn't be ideal for a cronjob. I'm guessing you might have a character such as a &lt;span style=&quot;color: red;&quot;&gt;!&lt;/span&gt; in your password possibly causing the shell to interpret it as another command, so that's why only using quotes works in your case.<br />
<br />
The long hand form that you've mentioned also works, so thanks for pointing that out as well. Here is the part when you do a &lt;span style=&quot;color: red;&quot;&gt;man mysqlcheck&lt;/span&gt; on the server about the command itself and how it functions:<br />
<br />
&lt;pre class=&quot;code_block&quot; style=&quot;width: 500px; margin: -10px 0px -30px 0px; line-height: .9em&quot;&gt;The password to use when connecting to the server. If you use the short option form (-p), you cannot have a space between the option and the password. If you omit<br />
           the password value following the --password or -p option on the command line, mysqlcheck prompts for one.&lt;/pre&gt;<br />
<br />
Thanks again!<br />
<br />
- Jacob</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10287);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-15273'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/e4db378dc985521eb139957358b005cb?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/e4db378dc985521eb139957358b005cb'>Mansour Khalifa</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-21 4:18 am</div>
				                <div><p>i don't know always my databases shot down and my site stop and saying Error in databases!!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15273);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-22 7:54 am</div>
				                <div>Hello Mansour,<br />
<br />
Did you run the repair on the databases? Did it work for you or are you still getting errors?<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15306);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-15274'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/0401bfe39a459a42f7d3ff5693037220?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/0401bfe39a459a42f7d3ff5693037220'>Matt Kizer</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-21 8:45 am</div>
				                <div>I have the error &quot;Error establishing a database connection.&quot;     I was sent here from support.inmotionhosting.com during a broad problem where apparently many people were  experiencing this due to a server error.   <br />
<br />
The messages on the site imply that I should be able to get my site back up on my own by following these instructions.<br />
<br />
I now anticipate that I am about to call InMotionHosting back, wait on hold for a while (tying up your resources and wait times), and I expect to be told that this will be fixed at your end as soon as possible.   But I am not sure, so I have to call.<br />
<br />
I have checked my tables using the steps above.   There are no errors shown.    This article does not say what to do if the error persists, but there are no bad tables.<br />
<br />
Thank you for putting up the information that you HAVE put up, but this article is not quite on the mark for what is needed today, I think.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15274);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-22 7:57 am</div>
				                <div>Hello Matt,<br />
<br />
First, we thank you for your patience and understanding during the issue, you are quite the gentleman here. The fix was indeed meant for the vast majority, however there are some databases that may need individual attention. You may want to <a href="http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support">contact the Live Support team</a> so they can take a more in-depth look at your database since you have already tried the recommended fix.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15307);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						...
						<div><a style='font-size:16px;' href='//www.gravatar.com/2b46856d3da83a2de4835db64430b1f0'>aa</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-22 3:35 pm</div>
				                <div>Followed instructions, says &quot;table doesn't exist&quot; even though I can click on it.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15352);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-22 6:04 pm</div>
				                <div>You may need to run a full database check from cPanel.  To do so, log into cPanel and click on Databases.  Inside there, there is an option to check a particular database.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15357);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-15453'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/b50062f25bfdfb5d382778b47a55c7fd?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/b50062f25bfdfb5d382778b47a55c7fd'>Roger Cas</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-24 11:25 am</div>
				                <div><p>What about errors like "Too many connections"?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15453);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-24 11:41 am</div>
				                <div>Hello Roger,<br />
<br />
It will never hurt to check and repair your database. If you are still getting errors, you can always <a href="http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support">contact the Live Support</a> team so they can take a look at what is causing that many connections to your database.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15459);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-18098'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/f99a3e78655ddb90a7ee38d0077c8a7b?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/f99a3e78655ddb90a7ee38d0077c8a7b'>Mark</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-03 1:27 am</div>
				                <div><p>Here are the another methods that will help in case, phpmyadmin has shown it has been repaired but actually it is not.</p>
<p><strong>Method 1</strong>:&nbsp;</p>
<ul>
<li>Login into your mysql as admin</li>
<li>Select the database that contains the corrupt table</li>
<li>Use Show tables to show all the corrupted table in the database</li>
<li>Now Repair table</li>
</ul>
<p><strong>Method 2</strong>:</p>
<ul>
<li>Login to MySQL server using SSH.</li>
<li>Repair MyISAM mySQL Tables.</li>
</ul>
<p><strong>Method 3</strong>.</p>
<p>If this is not your area of expertise then hire someone that do this job of you or try 3rd party software like <strong>Stellar Phoenix </strong>(Vist here to get detaled information&nbsp;http://www.stellarinfo.com/mysql-repair.htm)</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(18098);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						...
						<div><a style='font-size:16px;' href='/support/community-support/users/ggardner5@outlook&per;com'>ggardner5@outlook.com</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-19 5:55 pm</div>
				                <div>Apparently I have no database connection. Only some of my tables are showing up. They're all okay. But I need to check and repair the others so I can get my site back up. Here's the error message I got. Please help! Thanks.<br />
<br />
wp_users: Table 'steppe9_wp814.wp_users' doesn't exist<br />
wp_usermeta: Table 'steppe9_wp814.wp_usermeta' doesn't exist<br />
wp_posts: Table 'steppe9_wp814.wp_posts' doesn't exist<br />
wp_comments: Table 'steppe9_wp814.wp_comments' doesn't exist<br />
wp_links: Table 'steppe9_wp814.wp_links' doesn't exist<br />
wp_options: Table 'steppe9_wp814.wp_options' doesn't exist<br />
wp_postmeta: Table 'steppe9_wp814.wp_postmeta' doesn't exist<br />
wp_terms: Table 'steppe9_wp814.wp_terms' doesn't exist<br />
wp_term_taxonomy: Table 'steppe9_wp814.wp_term_taxonomy' doesn't exist<br />
wp_term_relationships: Table 'steppe9_wp814.wp_term_relationships' doesn't exist<br />
wp_commentmeta: Table 'steppe9_wp814.wp_commentmeta' doesn't exist</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29925);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-19 7:39 pm</div>
				                <div>Sorry to hear those tables are reported missing. It's possible the tables are there but there is an issue with your SQL service. If you have a VPS or Dedicated server I advise restarting the SQL services. Or, if you're unsure of that you can contact our <a href="http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support">Live Support</a> and request a restart.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29932);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
