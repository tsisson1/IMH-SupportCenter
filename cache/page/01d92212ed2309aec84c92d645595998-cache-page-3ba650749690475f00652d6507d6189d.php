<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:67045:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/drupal-7/blocks-and-regions/create-custom-sidebar" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-11-30T14:46:56-08:00" />
  <meta name="keywords" content="sidebar block custom Drupal 7" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="In this Drupal 7 tutorial you will learn to create a custom sidebar block." />
  <title>How to customize your sidebar blocks in Drupal 7 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/drupal-7/blocks-and-regions/create-custom-sidebar" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:8c4b3c18dd07c77f41d354d432837fbd -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '195.130.213.11']);
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
				<img src='/support/images/stories/drupal-partner/supporting-partner-80_3.png' style='float:right; margin:0px 0px 15px 15px;' alt='Drupal Association Support Partner'>		<h1>
															How to customize your sidebar blocks in Drupal 7									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>15,793</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Nov 30, 2012'><span style='color:#606060;'>Published:</span> Nov 30, 2012</div>
...
<li>This brings you to the New block creation screen. From here, fill out the fields to display your desired content. In our example, we will enter a table that displays hours for a phisycal store. Other ideas would be contact information, special announcements, ads, etc.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/structure/blocks/custom-sidebar/sidebar-data.png"><img  alt="sidebar-data" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/structure/blocks/custom-sidebar/sidebar-data.png" /></a><br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/structure/blocks/custom-sidebar/sidebar-region.png"><img  alt="sidebar-region" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/structure/blocks/custom-sidebar/sidebar-region.png" /></a><br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/structure/blocks/custom-sidebar/sidebar-visibility.png"><img  alt="sidebar-visibility" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/structure/blocks/custom-sidebar/sidebar-visibility.png" /></a><br />
...
<td>A set of dropdowns for each theme. Select which area you want the new block to appear. In this example, we chose sidebar first, which is the left sidebar area of the Bartik theme. Note that different themes can have different areas and names.</td>
</tr>
...
<li>After entering all the data for your new block, click the <strong>Save Block</strong> button at the bottom of the page to finalize the creation.</li>
<li>Now that the sidebar blockis created, we want to confirm that the new block is lsited correctly on the Blocks list. It should show correctly under the Sidebar First. section based on how we set it in the Regions setting upon creation. <br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/structure/blocks/new-footer/5-confirm.png"><img  alt="5-confirm" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/structure/blocks/new-footer/5-confirm.png" /></a><br /><br />Now your new sidebar information should display on your site. Below is a before and after screenshot of the changes made in this tutorial.<br />
<table class="article_table">
<tbody>
<tr><th>Before</th><th>After</th></tr>
<tr>
<td>&nbsp;<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/structure/blocks/custom-sidebar/sidebar-before.png"><img style="max-width: 250px;"  alt="sidebar-before" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/structure/blocks/custom-sidebar/sidebar-before.png" /></a></td>
<td>&nbsp;<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/structure/blocks/custom-sidebar/sidebar-after.png"><img style="max-width: 250px;"  alt="sidebar-after" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/structure/blocks/custom-sidebar/sidebar-after.png" /></a></td>
</tr>
</tbody>
</table>
</li>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 6: How to customize your sidebar blocks in Drupal 7</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 5: <a href='/support/edu/drupal-7/blocks-and-regions/create-custom-footer'>How to create a custom footer block in Drupal 7</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/drupal-7/blocks-and-regions/create-custom-sidebar&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/drupal-7/blocks-and-regions/create-custom-sidebar'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yMDUmaWQ9MjAyNyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/823b5767c4a9714640b8fdd3d59b2fdd?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/823b5767c4a9714640b8fdd3d59b2fdd'>Mohanraj</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-06 8:16 am</div>
				                <div><p>its work</p>
<p>but not enough for me............</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13688);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-27093'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/00094291368cba9d28dace54b10870d0?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/00094291368cba9d28dace54b10870d0'>Meggie</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-30 5:28 pm</div>
				                <div><p>I followed these steps and my ridght sidebar was placed below the main content but to the right. It does not appear next to the main content</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27093);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-01 10:27 am</div>
				                <div>Hello Meggie, <br />
<br />
Sorry for the problem with the side bar.  We would need a little information in order to troubleshoot the issue Meggie.  What version of Drupal, are you using any specific theme, is it possible to access your Drupal site.  It's hard for us to troubleshoot without seeing the site, so if you can provide that information we can also review it.  Provide us a little information and we can review it further.<br />
<br />
If you have any further questions or comments, please let us know.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27122);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
