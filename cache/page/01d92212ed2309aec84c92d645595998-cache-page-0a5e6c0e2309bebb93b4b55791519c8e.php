<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:76458:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/phpbb/manage-forums/new-topic" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-01-15T16:22:45-08:00" />
  <meta name="keywords" content="create topic forum customer phpBB 3.0 [gs]" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Take a visitor's point of view and learn to create a new topic in phpBB 3.0" />
  <title>How to create a new forum topic in phpBB 3.0 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/phpbb/manage-forums/new-topic" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:98424e036b572b6dfe03c890e3e4a8ef -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to create a new forum topic in phpBB 3.0									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>7,938</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 9, 2013'><span style='color:#606060;'>Published:</span> Jan 15, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>After members <a href="/support/edu/phpbb/working-with-users/create-user">create an account</a> (we will cover this soon), they will want to jump right in and start contributing to the site. As an administrator, you will need to know how to create topics and replies so you can help create the foundation of your community.</p>
<p>Topics are the individual conversations, or threads, that should be related to the forum they are under. For example, you would not want to create a topic on <em>recipes</em> in a <em>Sports</em> forum. The steps below will walk you through creating a new topic in your phpBB site. Within each forum, you will have individual topics. For example, if you have a Sports forum, you may have baseball and basketball topics within. Both regular users and site admins can create these topics and follow the same process.</p>
<h2>Creating a new topic in phpBB</h2>
<ol class="article_list">
<li><a href="/support/edu/phpbb/getting-started-phpbb/phpbb-login">Log into your phpBB website.</a> Users will sign in as themselves, Administrators can sign in as either Admin or a user account, if they have one. In this example, we have created a test user named <em>Bob</em> who will be creating a new topic.</li>
<li>The main page returns and you will see the account you are logged in as in the upper right corner of the page. On the page is a list of categories. Categories are divisions of forums, usually grouped by topic. From here, select which category you want to create your topic under. Click on the forum name to continue to the next screen. For our example, Bob is going to add a new topic under the <em>Your First Forum</em> forum.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/general/new-topic/1-category-list.png"><img  alt="list of categories" src="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/general/new-topic/1-category-list.png" /></a></li>
<li>You are now on the topic list page. As we are creating the first topic, there are no others listed on the screen. To create a new topic, click on the <strong>NEW TOPIC</strong> button found in the upper left hand corner of the screen.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/general/new-topic/new-topic.png"><img  alt="click new topic button" src="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/general/new-topic/new-topic.png" /></a></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/general/new-topic/create-topic.png"><img  alt="add topic content" src="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/general/new-topic/create-topic.png" style="float: right; margin: 0px 0px 15px 15px;" /></a>This is the New Topic page where you will create your initial topic.<br /><br /><strong>Subject</strong><br />First enter your topic in the Subject line.&nbsp; For example, our new topic is entitled <em>New Smartphone! How do I use it?.</em><br /><br /><strong>Body</strong><br />Under that is large a text area where you can create the body of your message.<em> </em>It has several buttons across the top to help you format your text such as Bold, Italics, adding hyperlinks, etc.<br /><br /><strong>Preview and/or Submit</strong><br />Although optional, it is recommended you take a look at what your new topic will look like by clicking the <strong>Preview </strong>button. Once you have entered your new topic data, click on the <strong>Submit</strong> button found just underneath the body area. <br />
<div style="clear: both;">&nbsp;</div>
<p>&nbsp;</p>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/general/new-topic/forum-topic-list.png"><img  alt="list of forum topics" src="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/general/new-topic/forum-topic-list.png" style="float: right; margin: 0px 0px 15px 15px;" /></a>After submitting your topic, it will be published to the forum and you will be redirected to your new topic page. This appears just as all website visitors will see it. Your post will also now appear under the forum <em>Your First Forum.</em> Also, now that a user has created a topic, other users will be able to <a href="/support/edu/phpbb/manage-forums/new-reply">reply </a>to it, starting a conversation.
<div style="clear: both;">&nbsp;</div>
</li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 2: How to create a new forum topic in phpBB 3.0</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 1: <a href='/support/edu/phpbb/manage-forums/add-new-forum'>Creating a new forum in phpBB 3.0</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 3: <a href='/support/edu/phpbb/manage-forums/new-reply'>How to reply to a topic in phpBB 3.0</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/phpbb/manage-forums/new-topic&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/phpbb/manage-forums/new-topic'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMDkmaWQ9MjE1NyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="5c4960c3de958c6d4ca2591681db7416" value="1" />	</div>
	</form>
<!-- <br />
...
<a name='comments'></a>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/c03c5a1c74735a191a6adce624893dfe?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/c03c5a1c74735a191a6adce624893dfe'>Harikumar</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-06 11:56 am</div>
				                <div><p>Thanks for sharing</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11238);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/0fc456b8bcf394f334c4392aee07dac3?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/0fc456b8bcf394f334c4392aee07dac3'>happy valentines day messages</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-11 9:35 pm</div>
				                <div><p>&nbsp;great post thanks for teaching how to create new topic ..</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20588);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-25364'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/cbbcb298cd6954c0b625d2f2addffe31?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/cbbcb298cd6954c0b625d2f2addffe31'>akram</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-01 5:33 am</div>
				                <div><p>was.great..thaks</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25364);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-03 9:06 am</div>
				                <div>Hello Akram,<br />
<br />
I am glad to know that you found this article helpful. Please remember that if you have any questions regarding this software please let us know so we may work out the issue.<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25418);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-25430'></a>
		<div  style='margin:2px 0px 0px 80px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/3ec975d7f821b04e8ba87de020fab875?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/3ec975d7f821b04e8ba87de020fab875'>Luke Collinson</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-03 12:58 pm</div>
				                <div><p>Hi, I am trying to get my forum setup (http://www.galaxyplay.co/), but I can't seem to get my forums to appear on the home page of the forum. Please would you be able to assist me as I am new to this software. Thanks</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25430);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-03 2:23 pm</div>
				                <div>Hello Luke,<br />
<br />
Have you gone through our phpbb education channel? If so, what article and step are you stuck on? What are the exact steps you are taking?<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25437);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-25985'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/a923a38b329ae8de754515240990933b?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/a923a38b329ae8de754515240990933b'>agnes</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-23 3:18 am</div>
				                <div><p>I've just installed the phpbb forum - and am in the process of getting used to it.</p>
<p>&nbsp;</p>
<p>However, I've been testing it with a few users and there is no 'new post' or 'new topic' button when I go into the various sub-forums - please help!!</p>
<p>&nbsp;</p>
<p>I don't understand why it is not coming up. Strange... </p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25985);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-24 4:07 pm</div>
				                <div>Hello Agnes,<br />
<br />
I have removed your link but I visited that page and it did not seem to have a PHPbb forum located on the link you provided.<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26048);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-31578'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/4b5a96d937b5e2e6107809a7f3fefc34?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/4b5a96d937b5e2e6107809a7f3fefc34'>ranjith</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-31 10:43 am</div>
				                <div><p>Hello how to integrate phpbb with my site using single login.If i logged in my site with username and password then phpBB forum should allow that user automatically without login again.</p>
<p>Please help me with the code i could find the apt code for it since session is not setting for the forum externally.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31578);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-31 11:07 am</div>
				                <div>Hello ranjith,<br />
<br />
Thank you for contacting us. I found a post via online search, where they are discussing <a href="http://stackoverflow.com/questions/279655/how-can-i-integrate-users-logins-from-my-site-into-phpbb" target="_blank" rel="nofollow">How can I integrate users' logins from my site into phpBB</a>.<br />
<br />
I hope this helps,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31580);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
