<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:61917:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/moodle/activity-resource/label-module" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-10-23T12:37:39-07:00" />
  <meta name="keywords" content="Activities resources module  add label course section organizing" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="To separate the Activities and resources, the Label module can be used to add a header between modules for organizing them under sections in Moodle 2.3." />
  <title>Labeling Activities and Resources with the label Module in Moodle - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/moodle/activity-resource/label-module" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:1ced941bf811ef7856ea0329f47680d6 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Labeling Activities and Resources with the label Module in Moodle									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>1,118</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Oct 22, 2012'><span style='color:#606060;'>Published:</span> Oct 23, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Now that the Activities and Resources are being added to the Course sections, headers may need to be added to the Course Sections to separate multiple Activity and resource modules. The previous tutorial touched on <a target="_blank" href="/support/edu/moodle/activity-resource/file-resource-module" title="Click here to view the previous article">Adding the File Resource Module to Moodle Courses</a>. This article will outline how to add a label to the Course modules to separate them.</p>
<h3>Adding a Label to the Course sections to separate the modules with a header.</h3>
...
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/103/label-module/label-module-1-add.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="label-module-1-add" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/103/label-module/label-module-1-add.gif" title="Click here to view the larger image" width="200" /></a>Once in the Moodle Dashboard, select the course and click the <strong>Add an activity or resource</strong> button to add a File. Select the <strong>Label radio button</strong> and click <strong>Add</strong>.
...
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/103/label-module/label-module-2-new.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="label-module-2-new" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/103/label-module/label-module-2-new.gif" title="Click here to view the larger image" width="200" /></a>Add the text that will display in the Course Section. Click <strong>Save and Return to Course</strong>.<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/103/label-module/label-module-3-final.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="label-module-3-final" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/103/label-module/label-module-3-final.gif" title="Click here to view the larger image" width="200" /></a>Now there will be a Label separating the Course Description from the individual modules in the Course section. The Label should look similar to the following snapshot. <br style="clear: both;" /></li>
</ol>
<p>This concludes the tutorial on Adding a Label Module to a Course in Moodle. Please check the next article on <a target="_blank" href="/support/edu/moodle/activity-resource/page-module" title="Click here to view the next article">Making pages for courses with the page module in Moodle</a>. For more information on this Education Channel please visit <a href="/support/edu/moodle/activity-resource" target="_blank" title="Click here to view the courses">Adding an activity or resource to a course in Moodle</a>.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 13: Labeling Activities and Resources with the label Module in Moodle</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 12: <a href='/support/edu/moodle/activity-resource/file-resource-module'>Adding the File Resource Module to Moodle Courses</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 14: <a href='/support/edu/moodle/activity-resource/page-module'>Making pages for courses with the page module in Moodle</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/moodle/activity-resource/label-module&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/moodle/activity-resource/label-module'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP3RzcmM9cnNiZWR1Jm9wdGlvbj1jb21fY29udGVudCZjYXRpZD0yODEmaWQ9MTkwNiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
