<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:63412:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-25/menus/how-to-link-to-an-article-in-a-menu" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-07-21T16:58:07-07:00" />
  <meta name="keywords" content="joomla 2.5 menu link to article" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="In this tutorial, we'll show you how to add a menu item to a Joomla 2.5 menu that links to an article." />
  <title>How to link to an Article in a Joomla 2.5 Menu - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-25/menus/how-to-link-to-an-article-in-a-menu" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:3796369fd9967e72817caae451ccc417 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to link to an Article in a Joomla 2.5 Menu									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>13,791</span></div>
							...
							<div style='clear:both;'></div>
								...
								<p class="alert">Joomla 2.5 has reached its end of life as for 12/31/2014. Please be advised this may be a security risk to your website. You can view more information about the end of life <a href="https://docs.joomla.org/Joomla!_CMS_versions">here</a>.</p><br /><p>In our previous article, <a href="/support/edu/joomla-25/menus/creating-a-menu-and-menu-module-in-joomla-25">we created a new Joomla 2.5 Menu</a> called "My First Menu". We've also previously <a href="/support/edu/joomla-25/articles/how-to-write-a-new-article">created a new article</a> called Test Article 1. In this tutorial, we will show you how to add a link to an Article in a Joomla 2.5 menu using our test article.</p>
<p><strong>To add an Article menu type to a menu:</strong></p>
<ol class="article_list">
<li><a href="/support/edu/joomla-25/getting-started/how-to-log-into-dashboard">Log into your Joomla Dashboard</a></li>
<li>In the top menu under <strong>Menus</strong>, hover over the menu you would like to add a new menu item to and then click <strong>Add New Menu Item<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/link-to-article-from-menu/click-add-new-menu-item.gif"><img  alt="click-add-new-menu-item" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/link-to-article-from-menu/click-add-new-menu-item.gif" /></a></strong></li>
<li>Click <strong>Select</strong> next to <strong>Menu Item Type</strong>, and then click <strong>Single Article<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/link-to-article-from-menu/select-single-article.gif"><img  alt="select-single-article" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/link-to-article-from-menu/select-single-article.gif" /></a></strong></li>
<li>Type in a <strong>Title</strong> for the Menu Item<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/link-to-article-from-menu/type-in-a-menu-title.gif"><img  alt="type-in-a-menu-title" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/link-to-article-from-menu/type-in-a-menu-title.gif" /></a></li>
<li>Next to Select Article, click <strong>Select / Change</strong>.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/link-to-article-from-menu/click-select-change.gif"><img  alt="click-select-change" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/link-to-article-from-menu/click-select-change.gif" /></a></li>
<li>Use the <strong>Filter</strong> feature to find your article, and then click on the article title<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/link-to-article-from-menu/click-on-article-title.gif"><img  alt="click-on-article-title" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/link-to-article-from-menu/click-on-article-title.gif" /></a></li>
<li>Click <strong>Save &amp; close</strong>.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/link-to-article-from-menu/click-save-and-close.gif"><img  alt="click-save-and-close" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/link-to-article-from-menu/click-save-and-close.gif" /></a></li>
</ol>
<p>When you create a new menu in Joomla 2.5, it will not show on your website until you add your first menu item to it. Now that we have added our first menu item, the menu will now show on our website.</p>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/link-to-article-from-menu/menu-now-showing-on-homepage.gif"><img  alt="menu-now-showing-on-homepage" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/link-to-article-from-menu/menu-now-showing-on-homepage.gif" /></a></p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 10: How to link to an Article in a Joomla 2.5 Menu</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 11: <a href='/support/edu/joomla-25/menus/how-to-add-a-category-menu-item'>How to link to a Category in a Joomla 2.5 Menu</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-25/menus/how-to-link-to-an-article-in-a-menu&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-25/menus/how-to-link-to-an-article-in-a-menu'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xODYmaWQ9MTE1NCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
