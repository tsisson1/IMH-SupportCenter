<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:88147:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/email/email-troubleshooting/imap-archiving" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-05-20T16:13:14-07:00" />
  <meta name="keywords" content="IMAP archive archiver Horde RoundCube Squirrelmail imap-archiver" />
  <meta name="author" content="Jacob Nicholson" />
  <meta name="description" content="In this article we'll explain the process of our automated IMAP archiving process, and show what it looks like in our various webmail clients." />
  <title>How our automated IMAP archiving works - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/email/email-troubleshooting/imap-archiving" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:9dfc5bd1d7a578f8907e085ad2048020 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-22']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '73.179.135.216']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How our automated IMAP archiving works									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>9,954</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Oct 9, 2012'><span style='color:#606060;'>Published:</span> May 20, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>If you read our previous article, you should have a good understanding of <a href="/support/email/email-troubleshooting/imap-resource-usage">why IMAP can cause resource usage issues on the server.</a></p>
<p>Our System Administration team has the ability to run an automated IMAP archive process for you to keep your e-mail account automatically organized to be efficient. This would run once a week and always keep your Inbox tidy with a predetermined time-frame worth of messages.</p>
<p>We’ve found typically 30 days is a good time-frame to set, and any messages older than 30 days would simply be moved automatically for you into an archive folder with the name of the month those messages were received.</p>
<p>Below you can see the way this would look in our various webmail clients:</p>
<table style="width: 100%;" class="article_table">
<tbody>
<tr><th style="text-align: center;">Horde</th><th style="text-align: center;">RoundCube</th><th style="text-align: center;">Squirrelmail</th></tr>
<tr>
<td style="padding: 15px;"><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/email/imap-ra/Horde-IMAP-auto-archive.png"><img  alt="Horde-IMAP-auto-archive" height="204" width="148" src="//cdn.inmotionhosting.com/support/images/stories/email/imap-ra/Horde-IMAP-auto-archive.png" /></a></td>
<td style="padding: 15px;"><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/email/imap-ra/RoundCube-IMAP-auto-archive.png"><img  alt="RoundCube-IMAP-auto-archive" height="225" width="163" src="//cdn.inmotionhosting.com/support/images/stories/email/imap-ra/RoundCube-IMAP-auto-archive.png" /></a></td>
<td style="padding: 15px;"><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/email/imap-ra/SquirrelMail-IMAP-auto-archive.png"><img  alt="SquirrelMail-IMAP-auto-archive" height="145" width="153" src="//cdn.inmotionhosting.com/support/images/stories/email/imap-ra/SquirrelMail-IMAP-auto-archive.png" /></a></td>
</tr>
</tbody>
</table>
<p>You also have the ability to subscribe to these server-side IMAP folders from your favorite e-mail client. We already have an article explaining <a href="/support/email/outlook/how-to-subscribe-to-specific-imap-folders-in-outlook-2010">how to subscribe to specific IMAP folders in Outlook 2010</a>, as well as <a href="/support/email/iphone/syncing-your-imap-folders-on-your-iphone">syncing your IMAP folders on your iPhone</a>.</p>
<p>The instructions should be very similar for any other mail clients. If you're still having issues getting your mail client to subscribe to these IMAP folders, please comment below with the mail client you use, so that we can write additional articles for your specific mail client.</p>
<p>To have our automated IMAP archiving setup on any of your e-mail accounts for you, please <a href="/support/website/getting-started-guides/submitting-and-checking-on-status-of-tickets#submit-ticket">open a ticket</a> letting us know which e-mail accounts you'd like this applied to.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/email/email-troubleshooting/imap-archiving&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/email/email-troubleshooting/imap-archiving'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NSZpZD03NzUmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="fed8e8f475363dca6889ab0b2da2bdc6" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						...
						<div><a style='font-size:16px;' href='/support/community-support/users/lrning'>lrning</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-03-17 8:09 am</div>
				                <div>Hi, <br />
<br />
I have recently migrated emails from Google to my own account. As you can imagine, I had several thousand emails archived from different years in my inbox. However, when the automated IMAP archiving kicked in, all it did was to create a folder for March 2013. How about all the other months before that, and years before 2012? Does the IMAP archiving work only with new incoming mail and not for older mail?</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(7586);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-04-08 12:49 pm</div>
				                <div>Hello Irning,<br />
<br />
Sorry for the delayed response. It looks like you do have some older Archive folders on the server already going back as far as 2005. Were you still having issues viewing those? Because the IMAP archiving should work with older mail that was on the account as well.<br />
<br />
- Jacob</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(7628);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/c18ba0bd1481f61989f2941ed858096f?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/c18ba0bd1481f61989f2941ed858096f'>Netpay Staff</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-07 7:50 pm</div>
				                <div><p>I had a few questions for your support staff regarding IMAP archiving and wanted to share them here for anyone else who might run into them down the line.1. &nbsp;Does IMAP archiving result in a temporary, or permanent, increase in the amount of hard drive space the email account requires? &nbsp;The cPanel documentation states the following:</p>
<p><span style="color: rgb(0, 0, 255); font-family: verdana, arial, helvetica, sans-serif; font-size: 12px; background-color: rgb(223, 223, 223);">"Note: When you enable Email Archiving, the amount of disk space used can quickly double depending on the length of time you store messages. Verify that your disk drive has ample space before you enable Email Archiving"</span></p>
<p>from:</p>
<p>http://docs.cpanel.net/twiki/bin/view/AllDocumentation/CpanelDocs/EmailArchiving</p>
<p>&nbsp;</p>
<p>2. &nbsp;How does your automated IMAP archiving process (I am assuming this is&nbsp;<span style="font-family: arial, verdana, sans-serif; font-size: 14px; line-height: 20.474998474121094px;">&nbsp;</span><code style="color: rgb(122, 71, 7); line-height: 20.474998474121094px;">email_archive_maintenance&nbsp;</code>from the cPanel documentation) handle existing directories? &nbsp;Are emails removed from them, and recategorized by date in Archives -&gt; Year -&gt; day/month folders? &nbsp;Are year -&gt; day/month folders created within each existing directory? &nbsp;Or are existing directories not archived?</p>
<p>3. &nbsp;Is it possible to specify which directories to archive, and which directories to not archive?</p>
<p>4.&nbsp;Your doc "<span class="m"><strong>Possible server resource usage problems when using IMAP</strong>", describes how&nbsp;IMAP connections must loop through all of the messages in the Inbox folder, which can lead to performance issues. &nbsp;Do IMAP connections also need to loop through other <strong>subscribed</strong> imap folders?Is the key to lower the overall number of emails in the Inbox, or is it to lower the overall number of emails in any&nbsp;subscribed folder which has a large number of emails?</span></p>
<p>Thanks from&nbsp;Netpay!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8839);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-10 10:02 am</div>
				                <div>When email archiving is turned on, it will only archive the main inbox and will not affect your created folders.  The subscribed email folders are also reviewed, but only when reviewed by your mail client.  So in most clients, unless you click on the folder, it will not loop through the mail within it.  This saves on resources as it is looping through folders only when requested.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8877);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/5987769e82e785d89f9b829809d8d19b?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/5987769e82e785d89f9b829809d8d19b'>Bill Kuba</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-22 1:47 pm</div>
				                <div><p>We have an employee that accesses his email account through Gmail (set up as iMAP). If we set his account to auto archive on the server will he be able see, as described above and for an iPhone, the the archive folders in Gmail?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(18785);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-22 1:51 pm</div>
				                <div>Yes, Gmail will automatically detect the folders without any issues.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(18786);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-19020'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/6167045bca3480684ca19974bcf74afa?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/6167045bca3480684ca19974bcf74afa'>Sean</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-30 2:08 pm</div>
				                <div><p>I have a few questions about&nbsp;how Automated Archiving works.</p>
<p>1. When it says inbox, does that also include trash and sent folders?</p>
<p>2. Can it be set for a different time frame then 30 days?</p>
<p>3. If I dont like how it effects my work flow, can I turn it off? if yes what hapens to the archived messages?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19020);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-30 2:17 pm</div>
				                <div>The inbox does indeed include the trash and junk mail.  Different time frames can indeed be set, depending on your preference as well as thresholds such as number of emails (ex: keep 100 emails and archive the rest).  You may ask for email archiving to be disabled, however, it is not easily reversed.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19021);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-30 2:22 pm</div>
				                <div><p>Are there some better screen shots?</p>
<p>Do I adjust the settings or does tech support?</p>
<p>can I have it just archive my trash and sent folders?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19023);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-30 2:30 pm</div>
				                <div>Unfortunately, we do not have any addition screenshots.  <br />
<br />
Email archiving is done by technical support via a &lt;a href=&quot;http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support&quot;&gt;verified ticket&lt;/a&gt;.<br />
<br />
Archiving your trsh and sent folders do not typically have the performance impact that your inbox does as sent and trash folders are not accessed frequently.  The reason that archiving your inbox helps is due to the entire inbox being loaded when accessing it.  If the inbox is archived, only content that is being accessed in that particular archive is being loaded.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19024);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-30 2:18 pm</div>
				                <div>In addition, not archiving your mail if you have a large inbox using IMAP can cause resource usage so archiving your mail is typically a good idea if you have a large inbox.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19022);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-30 2:47 pm</div>
				                <div><p>my actual inbox is ussally under 150&nbsp;messages. I like to hold on to my sent and trash mailboxes for work purposes for longer and it seems auto archive would work well</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19026);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-30 3:09 pm</div>
				                <div>If solely for the purposes of keeping specific messages, I recommend simply placing them in different folders.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19028);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-12-18 3:46 am</div>
				                <div><p>Please does the archiving works for mail box set up with POP.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29250);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-12-18 2:30 pm</div>
				                <div>Hello Mike,<br />
<br />
Unfortunately it does not as POP does not handle seperate folders correctly. It combines them all so if you have your email account archived you should be using IMAP.<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29259);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
