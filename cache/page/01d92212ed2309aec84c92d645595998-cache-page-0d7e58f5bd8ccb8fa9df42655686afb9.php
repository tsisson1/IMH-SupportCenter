<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:101104:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/database-connections/is-mysql-available" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-09-24T17:19:16-07:00" />
  <meta name="keywords" content="MySQL service up running server database connection error" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Don't be afraid of a database connection error. This article guides you in testing to see if the MySQL service is running on your server." />
  <title>Database connection error - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/database-connections/is-mysql-available" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:8134df466cbbd9343f1f5d3e406de449 -->
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>13,775</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 29, 2013'><span style='color:#606060;'>Published:</span> Sep 24, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Getting a database connection error, <a href="/support/edu/joomla-25/database/database-connection-error-2-could-not-connect-to-mysql">such as this one in Joomla</a>, can be a scary thing to see on your website. It means that a program running on your site is not able to communicate with the MySQL database service to retrieve data. There are two main reasons for getting this error, either the program itself is not connecting properly due to login credentials mismatch from the program's configuration files, or the MySQL service is currently not running on the server. Below are instructions on how to check both.</p>
...
<div class="alert">Note that newer versions of Windows do not have the Telnet service enabled by default. You may have to enable it before running this test. You can find instructions on how to do this in our article on <a href="/support/website/how-to/enable-telnet">enabling telnet on a Windows computer</a>.</div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/database-connections/is-mysql-available&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/database-connections/is-mysql-available'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MDUmaWQ9NTI4JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="7f2da55934271b99bc1c2266a5d9d752" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/website/database-connection-error?tsrc=rsbraq'>Database connection error (2): Could not connect to MySQL</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/joomla-3/joomla-database-connection-error-2-could-not-connect-to-mysql?tsrc=rsbraq'>joomla- Database connection error (2): Could not connect to MySQL</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/databases/why-does-the-mysql-database-keep-disconnecting?tsrc=rsbraq'>Why does the mysql database keep disconnecting?</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/drupal/need-help-with-database-settings-in-drupal-settingsphp-file?tsrc=rsbraq'>Need help with database settings in Drupal &quot;settings.php&quot; file</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/databases/error-establishing-a-database-connection-6?tsrc=rsbraq'>Error establishing a database connection</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/databases/connect-to-mysql-localhost-from-private-folder?tsrc=rsbraq'>Connect to mysql localhost from private folder</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/e4fa63c8d13006cf0176a93d501b1413?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/e4fa63c8d13006cf0176a93d501b1413'>Enrique</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-08 3:33 am</div>
				                <div>Re write your tutorials covering common errors</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12482);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-08 10:51 am</div>
				                <div>Hello Enrique,<br />
<br />
Thank you for your feedback. This is a pretty standard guide, and I did not see any errors withing the article. We are happy to help you, but will need some additional information.<br />
<br />
What problems are  you having?<br />
<br />
Is there a step or section here that is not working for you?<br />
<br />
Can you provide a link to the database connection error you are having?<br />
<br />
If you have any further questions, feel free to post them below.<br />
Thank you,<br />
<br />
-John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12488);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-14784'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/48fe3e98a818d1442e27a68958a920c8?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/48fe3e98a818d1442e27a68958a920c8'>paul velasco</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-06 5:10 am</div>
				                <div>When we get this error:<br />
Error establishing a database connection<br />
It also means that cpanel is not working so making the changes on cPanel as described is impossible<br />
</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14784);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-21 11:25 am</div>
				                <div>Hello Paul,<br />
<br />
If you cannot access the cPanel, it is possible the MySQL service itself is down. To test that you would run the Telnet Test that is discussed in the second portion of the article.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15277);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-21073'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/13d1ebf6e92213ede4822cf133474b0c?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/13d1ebf6e92213ede4822cf133474b0c'>Belle</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-25 11:59 pm</div>
				                <div><p>Hi this&nbsp;</p>
<h1 style="font-family: 'Times New Roman';">Error establishing a database connection</h1>
<p>&nbsp;</p>
<p>Seems to be happend a couple of times and the chat staff said your server is down..</p>
<p>&nbsp;</p>
<p>Can please help to resolve asap.</p>
<p>&nbsp;</p>
<p>Thanks</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21073);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-26 9:56 am</div>
				                <div>Hello Belle,<br />
<br />
Sorry for the database issues.  If the server was reported down, then the database connection would not work.  However, as per the support ticket in your account, it does look as they have fixed the issue for you.  If you continue to have any further problems, please let us know.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21092);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-26 10:03 am</div>
				                <div>Hello Belle,<br />
<br />
You are on a server that is currently having MYSQL service issues. Our Systems team is working hard to get that back up as quickly as possible for you.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21093);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-26 10:36 am</div>
				                <div><p>Hi Arnel and Scott,</p>
<p>&nbsp;</p>
<p>Thanks for responding to me.</p>
<p>I have spoken to 3 of your staff and they all say different things...</p>
<p>1) Host server is down.</p>
<p>2) Host server is not down but my Cloudproxy settings are causing the problem.</p>
<p>Could a technician please help me look into the issue and let me know please..</p>
<p>&nbsp;</p>
<p>Thanks in advance</p>
<p>Belle</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21098);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-26 12:19 pm</div>
				                <div>Hello Belle,<br />
<br />
The MySQL service issue was fixed on the server, so that should no longer be a factor. The tempURL seems to work and if the domain has been pointed to us recently, then it could still be showing cached information from the CDN. This may take some time to propagate out.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21103);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-26 12:25 pm</div>
				                <div><p>Hi Scott,</p>
<p>Actually only my main page http://www.catalogue.com.sg shows the error message.</p>
<p>My other pages are fine.</p>
<p>Why is this so?</p>
<p>Can you help me look into the issue please.</p>
<p>Thanks</p>
<p>Belle</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21104);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-27 8:25 am</div>
				                <div>Hello Belle,<br />
<br />
It appears the site just needed the time to get rid of the cloudproxy cache and propagation to the server itself. I am showing your site quite fine now and am not getting any errors. <br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21130);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						...
						<div><a style='font-size:16px;' href='/support/community-support/users/dm5400'>dm5400</a></div>
						<div></div>
						<div></div>
						<div>46 <a href='/support/team/points' target='_blank'>Points</a></div>
						
					</td>
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-10 9:53 am</div>
				                <div>I have been having a ton of connection errors (too many connections, can't fetch mysqli, and others) and they can't seemed to be fixed.  I am told it is an OpenCart problem but I couldn't connect to my Wordpress site last night on the same server.   Why is that? I did the Telnet yesterday and could not connect to my site.  Plus when I have made changes and refreshed my site, the site doesn't load the colors/template properly at times. <br />
<br />
They just changed my PHP version to the previous one.  Now today I can't add pictures that are already uploaded or make any changes at all and keep getting all those connection errors. <br />
<br />
What can be done?   I am at a loss. I need to have this resolved or I can't launch my website.<br />
<br />
Thanks,<br />
Diana</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21536);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-10 11:53 pm</div>
				                <div>Hello Diana,<br />
<br />
Generally the problem comes from software opening connections to mysql and not closing them in a timely manner. The reason your wordpress website was not working was most likely due to your account using all of the allotted mysql space each account is allowed. What is your domain so we may try to troubleshoot further. <br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21577);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-11 9:38 am</div>
				                <div>www.christiancoverings.com<br />
<br />
I have found out from support that the max user connects  is set to 30. <br />
Also doing some research on OpenCart forum shows it is a server problem and not an OpenCart problem. I have read it should be: max_connections = 1000<br />
max_user_connections=200<br />
(this is a system wide mysql variable)<br />
Most are 500/100.<br />
</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21597);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-12 10:40 am</div>
				                <div>Hello Dm5400,<br />
<br />
Setting max connections to 1000 doesn't solve the issue of why several hundred connections to the database are required by OpenCart.  If you want to make that change, it would be better suited to using the installation in a VPS or Dedicated server environment where resources can be more focused to the application.   Making these type of changes in a shared server environment can lead to problems  with resource usage.  If you have a plugin that is requiring that many open database connections, it should not be recommended for shared server use.  Also, if you consider that database connections are usually made in conjunction with the number of users in the applications, having several hundred open at the same time should only be made if you have that many <b>concurrent</b> users in the application.  If you're seeing that kind of traffic, then you should definitely not be on a shared server.  <br />
<br />
Database connections are not typically held open.  They are opened, then shut as soon as a query or update is made.  Requiring many concurrent database openings for minimal application use is indicative of an issue that the developer should correct.  In the case of OpenCart, I would recommend you review your plugins/extensions.  Our web design team uses it for many of our clients, and the max connections setting is never an issue.<br />
<br />
Regards,<br />
Arnel C.<br />
<br />
</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21651);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 160px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-12 10:54 am</div>
				                <div>I am new to OpenCart. The only extension I have is a total based shipping extension by clearthinking. I am using the Journal responsive theme made for OpenCart (modified to suit my simple design). That is it. I do not have a large store nor do I have a lot of traffic to my site. I have always been on a shared server and never had any issues with my site.  I have been in contact with the theme support and according to them, it would not cause these  issues. I have been able to work on my site the past two days without any error messages, etc. so it's not everyday I see them.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21652);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-22106'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/51e7858b73dee482c82dfdb8655b991b?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/51e7858b73dee482c82dfdb8655b991b'>Carlos Salazar-Velasquez</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-27 3:58 pm</div>
				                <div><p>I am getting the error: "Failed to connect to the database" - tried the the Telnet Test and I am getting the following message:</p>
<p>Mac-0026b0ef185e:~ w16141$ telnet strategicanalytics-cip.com 3306</p>
<p>Trying 173.247.252.218...</p>
<p>Connected to strategicanalytics-cip.com.</p>
<p>Escape character is '^]'.</p>
<p>N</p>
<p>5.6.21-logb;MN#bDm?7F:1&amp;fTPtvvmmysql_native_passwordConnection closed by foreign host.</p>
<p>Any help will be appreciated!</p>
<p>&nbsp;</p>
<p>Carlos</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22106);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-27 4:30 pm</div>
				                <div>Hello Carlos,<br />
<br />
Have you added your IP to allow <a href="http://www.inmotionhosting.com/support/website/databases/setting-up-a-remote-mysql-connection-in-cpanel">remote connection to MySQL</a> in the cPanel?<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22109);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
