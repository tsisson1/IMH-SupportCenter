<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:63226:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/prestashop-15/339-remove-footer-information" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-12-05T18:46:54-08:00" />
  <meta name="keywords" content="delete information blocks modules footer PrestaShop 1.5" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Have too much information in your PrestaShop footer? Learn to remove the different blocks of information in this tutorial." />
  <title>339: How to remove footer information in PrestaShop 1.5 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/prestashop-15/339-remove-footer-information" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:d153b34538a6cf25807e443d796abf6a -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '51.9.127.156']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															339: How to remove footer information in PrestaShop 1.5									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>23,400</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 16, 2013'><span style='color:#606060;'>Published:</span> Dec 5, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>The default PrestaShop setup displays a lot of different information in the footer area. There are seven  basic blocks of information for the footer that correspond to different modules. The five basic blocks are <em>Categories</em>, <em>Information</em>, <em>My Account</em>, <em>Follow Us</em>, and <em>Contact Us</em>. Above the basic blocks is a gray area with several icons that run the width of the store, this is the <em>Customer Assurance block</em>. Last is a block that has no visible content in the footer, it is the <em>Data mining for statistics</em> block and is used for tracking different customer metrics. Below we demonstrate  how to disable any of these blocks in the footer area.</p>

<h2>Deleting information from the footer in PrestaShop 1.5</h2>

<ol class="article_list">
<li><a href="/support/edu/prestashop-15/getting-started/login-to-dashboard">Log into your PrestaShop 1.5 dashboard</a>.<div style="clear:both;"></div></li>

<li>Using the top menu bar, hover over the <strong>Modules</strong> tab and select the <strong>Positions</strong> option from the dropdown menu.<div style="clear:both;"></div></li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/339/1-modules-list.png"><img  style="float:right; margin:0px 0px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/339/1-modules-list.png" title="Click here to view the larger image" width="200" /></a><p>You are led to a page for module positioning all throughout your PrestaShop store. As you can see, there are many sections listed. The one you want to work with is simply named <em>Footer</em> and should display as <strong>Footer - 7 Modules</strong>. You will see a list of all the modules that are hooked  into the <em>Footer</em> block of your PrestaShop site. Locate the module you want to remove, or '<em>unhook</em>' from your the footer area.</p>
<div style="clear:both;"></div>
<h3>Removing a single module</h3>
<p>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/339/2-delete-icon.png"><img  style="float:right; margin:0px 0px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/339/2-delete-icon.png" title="Click here to view the larger image" width="200" /></a>If you wish to remove only one module, simply click on the <strong>Delete</strong> icon that looks like a trashcan.</p>
<div style="clear:both;"></div>
<h3>Removing multiple  modules</h3>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/339/3-unhook-button.png"><img  style="float:right; margin:0px 0px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/339/3-unhook-button.png" title="Click here to view the larger image" width="200" /></a>If you have multiple modules by selecting the checkboxes on the left hand side of the screen, you can unhook them all at the same time. Simply scroll to the bottom of the screen and click on the <strong>Unhook the selection</strong> button.</p>
<div style="clear:both;"></div>
<p>Once you have unhooked the module you can return to your site and see that the information in the footer is now missing. In our example, we removed the <em>Categories</em> information. You can see that the information still exists in the left hand sidebar of the store, however.
</p>

<table class="article_table">
<tr><th>Before</th><th>After</th><tr>
<tr><td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/339/before.png"><img   alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/339/before.png" title="Click here to view the larger image" width="200" /></a></td><td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/339/after.png"><img   alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/339/after.png" title="Click here to view the larger image" width="200" /></a></td></tr>
</table>
...
<div style="clear:both;"></div>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 28: 339: How to remove footer information in PrestaShop 1.5</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 27: <a href='/support/edu/prestashop-15/340-mass-price-update'>340: Making a mass price change for PrestaShop using phpMyAdmin</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/prestashop-15/339-remove-footer-information&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/prestashop-15/339-remove-footer-information'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD05OSZpZD0yNDU2JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="cb0c8e5901f5cc098c34b2b7eae9d806" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/prestashop-15/edit-cms-block-footer-in-prestashop-put-in-columns-and-other-styling?tsrc=rsbraq'>Edit CMS Block Footer in PrestaShop (Put in columns and other styling)</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						...
						<div><a style='font-size:16px;' href='//www.gravatar.com/71c0d0be1e6c10da4e1c12f7cb03ed93'>Ahsan</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-13 1:30 pm</div>
				                <div><p>Great information about it, I uncheck powered by link from back office from my &lt;a href="http://zobishop.com"&gt;Store&lt;/a&gt;, But it still showing powered by prestashop, Please tell, What I should do more to remove it.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22593);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-13 5:18 pm</div>
				                <div>Hello Ahsan,<br />
<br />
That would require editing a core tpl file. We do not recommend editing core files as they will simply be replaced once an update occurs.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22611);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
