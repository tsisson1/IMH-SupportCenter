<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:64655:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/prestashop-15/prices-and-taxes/new-tax-rule" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-08-23T14:43:19-07:00" />
  <meta name="keywords" content="prestashop 1.5 new tax rule" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="In this tutorial, we'll show you how to create new tax rules in PrestaShop 1.5" />
  <title>Creating a new Tax Rule in PrestaShop 1.5 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/prestashop-15/prices-and-taxes/new-tax-rule" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:821428074c1b229e4c1cb21beaf167ef -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Creating a new Tax Rule in PrestaShop 1.5									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>3,991</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Aug 23, 2012'><span style='color:#606060;'>Published:</span> Aug 23, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>After <a href="/support/edu/prestashop-15/prices-and-taxes/create-new-tax">setting up a new tax</a> in PrestaShop 1.5, your next step is to create a new <strong>tax rule</strong>. After you have setup a tax rule by following the directions on this page, you can then <a href="/support/edu/prestashop-15/prices-and-taxes/tax-rule">associate this tax rule to a product</a>.</p>
<p class="alert">Taxes can be a bit confusing, if you have any questions please see our article here on <a href="/support/edu/prestashop-15/prices-and-taxes/tax-and-tax-rules">understanding taxes and tax rules</a> in PrestaShop 1.5</p>
<p><strong>Adding a new tax rule in PrestaShop 1.5:</strong></p>
<ol class="article_list">
<li><a href="/support/edu/prestashop-15/getting-started/login-to-dashboard">Log into your PrestaShop 1.5 Dashboard</a></li>
<li>In the top menu, hover over <strong>Localization</strong> and then click <strong>Tax Rules</strong></li>
<li>In the top right menu, click <strong>Add new</strong></li>
<li>Type in a <strong>Name</strong> for the tax rule, select the green check next to <strong>Enable</strong>, and then click <strong>Save and stay</strong> in the top right menu<br /><br />In our testing, we set the Name to:<br /><em>US-VaBeach Rate (4.5%)</em></li>
<li>After you click <strong>Save and stay</strong>, a new button will appear in the top left menu - <em>Add new tax rule</em>. Click the <strong>Add new tax rule</strong> button.</li>
<li>Under <strong>New tax rule</strong>, enter the following details:<br /><br /> 
<table class="article_table">
<tbody>
<tr>
<th>Country</th>
<td>Select the appropriate country from the drop down list</td>
</tr>
<tr>
<th>Zip Code range</th>
<td>You can define a range (eg: 75000-75015) or a simple zipcode</td>
</tr>
<tr>
<th>Behavior</th>
<td>Define the behavior if an address matches multiple rules:<br /> <b>This Tax Only:</b> Will apply only this tax<br /> <b>Combine:</b> Combine taxes (eg: 10% + 5% =&gt; 15%)<br /> <b>One After Another:</b> Apply taxes one after another (eg: 100€ + 10% =&gt; 110€ + 5% =&gt; 115.5€)</td>
</tr>
<tr>
<th>Tax</th>
<td>Select a tax from the drop down menu<br /></td>
</tr>
<tr>
<th>Description</th>
<td>Enter a description about this tax rule<br /></td>
</tr>
</tbody>
</table>
<p>You can see below how the Virginia tax rule is setup:<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/taxes/virginia-tax-rule.gif"><img  alt="virginia-tax-rule" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/taxes/virginia-tax-rule.gif" /></a></p>
</li>
<li>When finished enter the <em>New tax rule</em> information, click the <strong>Save and stay</strong> button (<em>which is under the Description field</em>)</li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 12: Creating a new Tax Rule in PrestaShop 1.5</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 11: <a href='/support/edu/prestashop-15/prices-and-taxes/delete-tax'>How to remove a tax in PrestaShop 1.5 </a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 13: <a href='/support/edu/prestashop-15/prices-and-taxes/edit-tax-rule'>How to modify a tax rule in PrestaShop 1.5 </a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/prestashop-15/prices-and-taxes/new-tax-rule&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/prestashop-15/prices-and-taxes/new-tax-rule'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yMzQmaWQ9MTcxNiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="15df0801d864675e464d70788bf9a78e" value="1" />	</div>
	</form>
<!-- <br />
