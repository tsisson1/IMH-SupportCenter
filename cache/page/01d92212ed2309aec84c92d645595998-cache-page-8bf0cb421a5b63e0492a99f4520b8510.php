<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:60309:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/wordpress/change-database-port" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-03-20T14:21:43-07:00" />
  <meta name="author" content="Jeff Matson" />
  <meta name="description" content="In this article, we will show you how to change your database port that WordPress connects to." />
  <title>Changing your database port in WordPress - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/wordpress/change-database-port" rel="canonical" />
...
<script>
  ...
  ga('send', 'pageview');
	...
	<!-- cid:23aab2517b2da1558abc18b4f06ad200 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '23.106.254.202']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Changing your database port in WordPress</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Changing your database port in WordPress									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;' title='Originally published: Mar 6, 2014'><span style='color:#606060;'>Published:</span> Mar 20, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>If your database is located on a different port, you will need to adjust your connection settings within WordPress to connect to it.  In this article, we will show you how to define a custom database port within your WordPress configuration.</p>
<ol class="article_list">
  <li><p>First, <a href="http://www.inmotionhosting.com/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">log into cPanel</a> and open the <a href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-file-manager/using-file-manager-in-cpanel">file manager</a>.  If you don't use cPanel, you may edit open any text editor you like.</p></li>
    <li><p>Within the file manager, you will navigate to your <em>wp-config.php</em> file.  This file will be located within your root WordPress directory, typically your <em>public_html</em> directory.  Right-click it and click on <strong>Code Edit</strong>.</p></li>
    <li><p>Now that you have the <em>wp-config.php</em> open, you will want to edit the following line:</p>
      <p class="code_block">define( 'DB_HOST', 'localhost:<font color="red">3306</font>' );</p>
      <p>As you can see, a port number has been added after the "<em>:</em>".  Here, simply add the port number of your database server.</p>
    </li>
</ol>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/wordpress/change-database-port&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/wordpress/change-database-port'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD02MyZpZD0zMTM1JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="36134327284acfba928a734e62bbbf5d" value="1" />	</div>
	</form>
<!-- <br />
