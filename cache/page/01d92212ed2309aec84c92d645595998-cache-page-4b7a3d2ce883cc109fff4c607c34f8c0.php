<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:64166:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/whm/303-install-and-configure-clamav" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-02-04T17:33:35-08:00" />
  <meta name="keywords" content="install configure clamav clam av anti virus anti-virus antivirus scan cpanel" />
  <meta name="author" content="Jacob Nicholson" />
  <meta name="description" content="In this article we'll discuss how you can install and configure the ClamAV plugin for cPanel. ClamAV is a popular open source anti-virus scanner, and with the ClamAV plugin you can allow your cPanel users to scan their e-mails as well as scan their home directories for malicious files." />
  <title>303: Install and configure ClamAV plugin for cPanel - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/whm/303-install-and-configure-clamav" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:a6659b729b74be6e6751a2a35b75bcaf -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-22']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '110.55.0.4']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															303: Install and configure ClamAV plugin for cPanel									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>15,162</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Nov 15, 2012'><span style='color:#606060;'>Published:</span> Feb 4, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<iframe width="560" height="315" src="https://www.youtube.com/embed/IarWF-41FZE" frameborder="0" allowfullscreen></iframe>

<p>In this article we'll discuss how you can install and configure the ClamAV plugin for cPanel. ClamAV is a popular open source anti-virus scanner, and with the ClamAV plugin you can allow your cPanel users to scan their e-mails as well as scan their home directories for malicious files.</p>
<p>Getting this installed yourself would require <a href="/support/website/general-server-setup/root-access-faq">root access</a> on either your VPS (Virtual Private Server) or dedicated server, or you can contact support to have us install the ClamAV anti-virus plugin for you for a $25 installation fee.&nbsp;You can follow the steps below to get ClamAV setup if you already have root access.</p>
<h2>Install and configure ClamAV plugin in WHM</h2>
<ol class="article_list">
<li><a href="/support/edu/whm/creating-and-managing-accounts/log-into-whm">Log into WHM</a>.</li>
<li>In the top-left <strong>Find</strong> box, type in <strong>plugins</strong>, then click on <strong>Manage Plugins</strong>.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/cpanel/clam-av/click-on-manage-plugins.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/cpanel/clam-av/click-on-manage-plugins.png" alt="click-on-manage-plugins"  /></a></li>
<li>Place a check beside&nbsp;<strong>ClamAV</strong>&nbsp;in the&nbsp;<strong>Install and keep updated</strong> selection box, then click&nbsp;<strong>Save</strong> at the bottom.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/cpanel/clam-av/clam-av-select-install-click-save.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/cpanel/clam-av/clam-av-select-install-click-save.png" alt="clam-av-select-install-click-save"  /></a><strong><br /></strong></li>
<li>The install process can take a good amount of time, upwards of 10 minutes, so be patient and don't close the web-browser until it completes. When it finishes you'll see a&nbsp;<strong>Process Complete</strong> message at the bottom of the screen.<br /><img src="//cdn.inmotionhosting.com/support/images/stories/website/cpanel/clam-av/process-complete.png" width="121" height="47" alt="process-complete" /></li>
<li>Log out, and then back into WHM again.</li>
<li>In the top-left&nbsp;<strong>Find</strong> box, type in <b>clamav</b>, then click on&nbsp;<strong>Configure ClamAV Scanner</strong>.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/cpanel/clam-av/click-on-configure-clam-av-scanner.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/cpanel/clam-av/click-on-configure-clam-av-scanner.png" alt="click-on-configure-clam-av-scanner"  /></a></li>
<li>Now you can set the global scan permissions you'd like to set. If you'd simply like to allow any cPanel user to scan any of their stuff you can place a check beside&nbsp;<strong>Scan Entire Home Directory</strong>,&nbsp;<strong>Scan Mail</strong>,&nbsp;<strong>Scan Public FTP Space</strong>, and&nbsp;<strong>Scan Public Web Space</strong>, then click on&nbsp;<strong>Save</strong>.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/cpanel/clam-av/check-global-scans-click-save.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/cpanel/clam-av/check-global-scans-click-save.png" alt="check-global-scans-click-save"  /></a></li>
</ol>
<h2>&nbsp;</h2>
<h2>Run ClamAV virus scan from cPanel</h2>
<div>&nbsp;</div>
<ol class="article_list">
<li>Now <a href="/support/”index.php?option=com_content&amp;view=article&amp;id=970:how-to-log-into-cpanel&amp;catid=132&amp;Itemid=101">login to your cPanel</a> to use the virus scanner.</li>
<li>Under the <strong>Advanced</strong> section, click on <strong>Virus Scanner</strong>.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/cpanel/clam-av/cpanel-click-on-virus-scanner.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/cpanel/clam-av/cpanel-click-on-virus-scanner.png" alt="cpanel-click-on-virus-scanner"  /></a></li>
<li>Now to start a new scan, select the type of scan you want, in this example we're doing&nbsp;<strong>Scan Entire Home Directory</strong>, then click on&nbsp;<strong>Scan Now</strong>.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/cpanel/clam-av/select-scan-entire-home-directory-click-scan-now.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/cpanel/clam-av/select-scan-entire-home-directory-click-scan-now.png" alt="select-scan-entire-home-directory-click-scan-now"  /></a></li>
<li>After the scan is complete there will be a list of infected files in the&nbsp;<strong>Infected Files:</strong> section, click&nbsp;<strong>OK</strong> on the confirmation window that pops-up to continue.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/cpanel/clam-av/virus-scan-complete-found-hacks-click-ok.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/cpanel/clam-av/virus-scan-complete-found-hacks-click-ok.png" alt="virus-scan-complete-found-hacks-click-ok"  /></a></li>
<li>In this case all 3 of the files that were found are coming up for known variants of a PHP mailer or PHP shell, so we can just leave&nbsp;the selections in the&nbsp;<strong>Quarantine</strong> column to place these files outside of our&nbsp;<strong>/public_html</strong> directory so they are not still accessible to the outside world. We could also just outright&nbsp;<strong>Destroy</strong> them, or&nbsp;<strong>Ignore</strong> them by changing our selection to those columns. Then simply click on&nbsp;<strong>Process Cleanup</strong>.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/cpanel/clam-av/click-on-process-cleanup.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/cpanel/clam-av/click-on-process-cleanup.png" alt="click-on-process-cleanup"  /></a><b><br /></b></li>
<li>You should now see the cleanup process complete page.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/cpanel/clam-av/virus-scan-clean-up-complete.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/cpanel/clam-av/virus-scan-clean-up-complete.png" alt="virus-scan-clean-up-complete"  /></a></li>
<li>Now if you use cPanel's <a href="/support/edu/cpanel/cpanel-file-manager/using-file-manager-in-cpanel">File Manager</a>&nbsp;you can navigate to the newly created&nbsp;<strong>quarantine_clamavconnector</strong> directory in your home directory to see the quarantined files.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/cpanel/clam-av/cpanel-file-manager-click-on-quarantine.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/cpanel/clam-av/cpanel-file-manager-click-on-quarantine.png" alt="cpanel-file-manager-click-on-quarantine"  /></a></li>
</ol>
<h2>&nbsp;</h2>
<h2>Run ClamAV scan from console (SSH)</h2>
<div>&nbsp;</div>
<ol class="article_list">
<li><a href="/support/website/general-server-setup/how-to-login-ssh">Login to your server via SSH</a>.</li>
<li>Run the following command to scan the entire&nbsp;<strong>/home/userna5/public_html</strong> directory:<br /><br /> <span class="code_block">clamscan -ri /home/userna5/public_html</span>
<p>The <strong>r</strong> flag is for recursive, and the <strong>i</strong> flag is to only show infected files.</p>
<p>You should end up with a listing of any infected files that were found such as:</p>
<p class="code_block" style="width: 500px;">/home/userna5/public_html/uploads/mail.php: PHP.Mailer-7 FOUND<br /> /home/userna5/public_html/uploads/sh.php: PHP.C99-13 FOUND<br /><span style="font-family: 'Courier New', Courier, monospace;">/home/userna5/public_html/uploads/view.php: PHP.C99-13 FOUND</span><br /><br /> ----------- SCAN SUMMARY -----------<br /> Known viruses: 1324142<br /> Engine version: 0.97.6<br /> Scanned directories: 4979<br /> Scanned files: 13835<br /> Infected files: 3<br /> Data scanned: 583.20 MB<br /> Data read: 1193.90 MB (ratio 0.49:1)<br /> Time: 372.032 sec (6 m 12 s)</p>
</li>
<li>To see all of the options available to you for the <strong>clamscan</strong> command append the <strong>--help</strong> flag.<br /><br /> <span class="code_block">clamscan --help</span><br /><br /></li>
</ol>
<p>You should now understand how to install and configure the ClamAV plugin for cPanel to help protect your accounts against virus threats.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/whm'>Web Host Manager</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 8: 303: Install and configure ClamAV plugin for cPanel</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 7: <a href='/support/edu/whm/302-upgrade-php-using-easyapache'>302: Upgrade PHP using EasyApache</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 9: <a href='/support/edu/whm/304-install-munin-plugin-for-whm'>304: Install Munin plugin for WHM</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/whm/303-install-and-configure-clamav&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/whm/303-install-and-configure-clamav'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD04NiZpZD0yNDI5JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="921d74553bec539b5b8241db08a1c769" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/44851afb30de0e2fabd61d8e1d400f44?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/44851afb30de0e2fabd61d8e1d400f44'>Jon</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-17 1:20 pm</div>
				                <div><p>Hi. I post a comment earlier but it seems like it wasn't saved.&nbsp;</p>
<p>I'm a bit new to cPanel and WHM. &nbsp;I want to install clamav so I can use it to scan for viruses with my php script. I have this version.</p>
<p>CENTOS 6.7 x86_64 virtuozzo &ndash; vps13703 WHM 11.50.0 (build 30)</p>
<p>My problem is I that I can't find the "Manage Plugins" link which I assume was removed. How can I install clamav in this version?</p>
<p>&nbsp;</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26745);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-17 5:39 pm</div>
				                <div>Hello Jon,<br />
<br />
Thank you for contacting us. Make sure you are <a href="http://www.inmotionhosting.com/support/edu/whm/creating-and-managing-accounts/log-into-whm">logging into WHM</a> as <a href="http://www.inmotionhosting.com/support/website/general-server-setup/root-access-faq">root</a>.<br />
<br />
If you don't have root access, you can <a href="http://www.inmotionhosting.com/support/website/getting-started-guides/submitting-and-checking-on-status-of-tickets#submit-ticket">submit a ticket</a> request. They will inform you of any charges (if necessary) before proceeding.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26756);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
