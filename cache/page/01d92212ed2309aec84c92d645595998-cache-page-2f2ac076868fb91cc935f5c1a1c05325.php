<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:52365:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-25/articles" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="How to write articles in Joomla 2.5" />
  <title>102: Writing Articles in Joomla 2.5 | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-25/articles" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:8135b9b6d29826ab2480a5280c5cbf83 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '182.239.185.30']);
...
<div class='page-header'>
	<h1>102: Writing Articles in Joomla 2.5</h1>
</div>
<div class='section_listing'>
		...
		<tr>
				...
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/articles/how-to-write-a-new-article'>How to write a new Article in Joomla 2.5</a>
					<div>In this article, we'll show you the basics of writing a new article in Joomla.</div>
					<div class='smallgrey'>Hits: 12,997</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/articles/how-to-add-a-new-category'>Working with Article Categories in Joomla 2.5</a>
					<div>In this tutorial, we'll give you an introduction to Joomla 2.5 categories, and we'll also guide you through creating a new category.</div>
					<div class='smallgrey'>Hits: 20,341</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/articles/how-to-upload-images'>How to Upload and Add Images into Joomla 2.5 Articles</a>
					<div>In this tutorial, we will walk you through how to upload and add an image to a Joomla 2.5 article.</div>
					<div class='smallgrey'>Hits: 18,383</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/articles/link-to-other-articles'>How to link to other articles within a Joomla 2.5 article</a>
					<div>In this tutorial, we'll show you how to link to another article within a Joomla 2.5 article.</div>
					<div class='smallgrey'>Hits: 57,034</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/articles/read-more-articles'>How to add a Read More link in Joomla 2.5 Articles</a>
					<div>In this Joomla 2.5 tutorial we will walk you through the steps for adding a Read More link to one of your articles. Adding a Read More link helps break up your articles into smaller pieces, which can make them fit better of featured article pages.</div>
					<div class='smallgrey'>Hits: 30,542</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/articles/unlock-locked-article'>How to unlock a locked article in Joomla 2.5</a>
					<div>If an article is locked in Joomla 2.5, you will see a lock icon next to it and you will not be able to edit it. In this Joomla 2.5 tutorial, we'll walk you through the steps for unlocking an article.</div>
					<div class='smallgrey'>Hits: 13,066</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/articles/wysiwyg-html-editor'>Switching between the WYSIWYG and HTML editor in Joomla 2.5</a>
					<div>In this Joomla 2.5 tutorial, we'll show you how to switch between the WYSIWYG editor and the HTML code editor when editing an article.</div>
					<div class='smallgrey'>Hits: 15,224</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/articles/insert-horizontal-line'>Adding a Horizontal Line in a Joomla 2.5 article</a>
					<div>The article editor in Joomla 2.5 includes an easy way to add a horizontal rule to any article.</div>
					<div class='smallgrey'>Hits: 5,087</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/articles/anchors'>Working with anchors in Joomla 2.5</a>
					<div>Working with anchors is easy in Joomla 2.5, and is a great way to help users navigate long pages on your site. In this tutorial, we'll walk you through the steps for creating and linking to an anchor in a Joomla 2.5 article.</div>
					<div class='smallgrey'>Hits: 27,257</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/articles/align-text'>How to full, left, right, and center justify text in Joomla 2.5</a>
					<div>In this Joomla 2.5 article, we'll walk you through the steps for left, right, center, and full justifying text.</div>
					<div class='smallgrey'>Hits: 6,735</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/articles/page-break'>How to use Page Break in Joomla 2.5</a>
					<div>Adding Page Breaks to Joomla 2.5 articles helps to organize very long articles. Each Page Break you create will be added to a table of contents for the article. We'll show you how to work with Page Breaks in this tutorial.</div>
					<div class='smallgrey'>Hits: 9,192</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-bottom:10px;'>
					...
					<div>In this tutorial, we'll show you how to prevent iframes from being stripped from your articles. This will make it easier to insert iframe code into Joomla 2.5 articles.</div>
			...
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/articles/allow-javascript'>How to add javascript to Joomla 2.5 articles</a>
					<div>Javascript / script tags are removed by Joomla when you save your articles. Review this tutorial to learn how to add javascript to your Joomla pages.</div>
					<div class='smallgrey'>Hits: 35,230</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/articles/add-pdf-to-article'>How to embed a PDF in a Joomla 2.5 Article</a>
					<div>We'll show you how you can use Google Docs to embed PDF files in a Joomla 2.5 article.</div>
					<div class='smallgrey'>Hits: 47,104</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/articles/editor-for-joomla-25'>Joomla 2.5 Editor</a>
					<div>Within Joomla 2.5 you can use various types of editors, such as WYSIWYG, HTML, and text editors. You can also edit different things, from article text to PHP in template code.</div>
					<div class='smallgrey'>Hits: 5,618</div>
				</td>
			</tr>
			</table>
</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yMTQmaWQ9MjE0JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="32ba70c6de3fbf8da1f82642aaa0696c" value="1" />	</div>
	</form>
<!-- <br />
