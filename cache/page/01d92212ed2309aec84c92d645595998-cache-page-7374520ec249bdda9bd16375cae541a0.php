<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:69904:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/wordpress/wordpress-introduction/install-wordpress" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-07-17T14:47:15-07:00" />
  <meta name="keywords" content="WordPress install softaculous" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="WordPress is free and can be installed on your server. This article explains the methods for installing WordPress on your server." />
  <title>Getting Started: How to install Wordpress - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/wordpress/wordpress-introduction/install-wordpress" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:13640305a4ae278ebbce3f266367296c -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Getting Started: How to install Wordpress									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>59,629</span></div>
							...
							<div style='clear:both;'></div>
								...
								<p>WordPress is a free open source software that can be installed on your server. Installing WordPress is not a terribly difficult task. This article will explain the basics in installing WordPress on your server. Learn more about <a href="http://www.inmotionhosting.com/wordpress-hosting">WordPress Hosting</a> here.</p>
<h2>What's the difference between Installing WordPress and WordPress.com</h2>
...
<p><a href="/support/website/wordpress/how-to-migrate-your-wordpresscom-site-to-inmotion-hosting">How to Migrate your WordPress.com site to InMotion Hosting</a></p>


<h2>Methods to install  WordPress on your server</h2>

<p>WordPress is a free program that you can get online. There are 2 ways you can install WordPress on your server.</p>
<ul>
<li><a href="/support/edu/cpanel/softaculous/how-to-install">Install using Softaculous</a></li>
<li><a href="/support/website/getting-started-guides/manual-installation-of-php-software">Manually Installing the Software</a></li>
</ul>

<h2>Installing WordPress with Softaculous</h2>
<p>For servers that have Softaculous installed in the cPanel, you can install WordPress with only a couple clicks. Softaculous will upload the files, configure the database, and set up the installation all for you without having to download any files or configure anything.</p>
<p><a href="/support/edu/wordpress/wordpress-introduction/install-wordpress-using-softaculous">Install WordPress using Softaculous</a></p>

<h2>Installing WordPress manually</h2>
<p>Servers that do not have Softaculous installed (<a href="http://www.inmotionhosting.com/cloud-vs-vps">VPS</a> and Dedicated servers do not have Softaculous installed. This requires a license.), you can install WordPress by downloading the files and uploading them to your server. You will need to set up a database and database user, upload the files with FTP or the File manager, and configure the config.php file on the server.</p>
<p><a href="/support/edu/wordpress/wordpress-introduction/installing-wordpress-manually">Installing WordPress 3.5 manually</a></p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 8: Getting Started: How to install Wordpress</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 7: <a href='/support/edu/wordpress/wordpress-introduction/wordpress-site-structure-explained'>The WordPress Site Structure Explained</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 9: <a href='/support/edu/wordpress/wordpress-introduction/install-wordpress-using-softaculous'>How to install WordPress using Softaculous</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/wordpress/wordpress-introduction/install-wordpress&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/wordpress/wordpress-introduction/install-wordpress'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xMzgmaWQ9MTA1OCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="742434a9ba954d69e73a8ddb7992c777" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
        ...
        <tr><td colspan='2'><h4>Installing Wordpress</h4></td></tr>  <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>8.</td>
          ...
          <tr >
			...
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/getting-started-guides/how-to-edit-website?tsrc=rsbraq'>How do I edit my website?</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/wordpress/domain-name-and-wordpress?tsrc=rsbraq'>Domain name and WordPress</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						...
						<div><a style='font-size:16px;' href='/support/community-support/users/panchal'>panchal</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2012-03-02 2:43 am</div>
				                <div>Very useful post. I don’t have fantastico so this post might help me to install word press manually.<br />
Thanks.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(6263);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-12589'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/2032a547a71e2177ca9e144b5b43b553?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/2032a547a71e2177ca9e144b5b43b553'>Drvan lehj</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-10 7:34 am</div>
				                <div><p>Really helpful material. like the way you describe</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12589);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-24632'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/66d103e2d29c25a4d6dae6aa67af1fe6?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/66d103e2d29c25a4d6dae6aa67af1fe6'>Daniel Keith</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-06 1:14 am</div>
				                <div><p>Hi there,</p>
<p>One of the best tutorial. Installing a WordPress website has become so easy after reading this.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24632);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
