<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50684:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/wordpress/fatal-error-cannot-redeclare-optionsframeworkinit" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello miaizzo, Sorry to hear you are getting an error with your WordPress. Researching the error, it seems to have to do with the theme, though without ..." />
  <title>Fatal error: Cannot redeclare optionsframework_init() | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/wordpress/fatal-error-cannot-redeclare-optionsframeworkinit" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:e064aa22fa6cbfcea2928cc4fff4c58e -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '141.101.18.92']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Fatal error: Cannot redeclare optionsframework_init()</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/miaizzo'>miaizzo</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-06-28 6:13 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>48</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I am trying to open my Wordpress Admin Dashboard and keep getting this error message that begins with Fatal error: Cannot redeclare optionsframework_init() followed by my dir ,  This error started after I tried to access a template called Hathor in live preview. How can I fix this?</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_7538' id='upvote_answer_7538' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='7538' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_7538').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_7538' id='downvote_answer_7538' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='7538' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_7538').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello miaizzo,<br />
<br />
Sorry to hear you are getting an error with your <a href="http://www.inmotionhosting.com/support/edu/wordpress">WordPress</a>. Researching the error, it seems to have to do with the theme, though without the directory path in the error I cannot confirm this. You may want to check out <a href="https://wordpress.org/support/topic/changed-theme-and-caused-fatal-error-in-page">this thread</a> from the WordPress forum regarding the issue. If you want us to take a further look, we can do so, but would need the directory path given in the error so we could find the involved files.<br />
<br />
Kindest Regards,<br />
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_7538').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_7538' id='form_comment_on_answer_7538' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/wordpress/fatal-error-cannot-redeclare-optionsframeworkinit&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/wordpress/fatal-error-cannot-redeclare-optionsframeworkinit'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="0bf62f5ad77f4df3c28466b57facaedf" value="1" />	</div>
	</form>
<!-- <br />
