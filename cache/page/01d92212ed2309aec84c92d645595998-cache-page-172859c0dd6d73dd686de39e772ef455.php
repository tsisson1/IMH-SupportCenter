<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:53068:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/prestashop-15/working-with-orders" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="keywords" content="Prestashop 1.5 orders" />
  <meta name="description" content="This class helps you work with orders in your PresrtaShop 1.5 store." />
  <title>116: Working with Orders in PrestaShop 1.5 | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/prestashop-15/working-with-orders" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:639e506450a52fd1c8f5a0a924705ee0 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '41.13.232.41']);
...
<div class='page-header'>
	<h1>116: Working with Orders in PrestaShop 1.5</h1>
</div>
<div class='section_listing'>
		<table>
	<tr><td colspan='3'><h2>Managing Orders</h2><div>Learn how to add, edit, and cancel orders in PrestaShop 1.5.</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 1:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/working-with-orders/create-order'>How to create an Order in PrestaShop 1.5 back office </a>
					<div>This article explains how to create a new order within the PrestaShop 1.5 back office.</div>
					<div class='smallgrey'>Hits: 6,943</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/working-with-orders/edit-order'>How to Edit an Order in PrestaShop 1.5 back office </a>
					<div>This article will walk you through editing an order in the PrestaShop 1.5 dashboard</div>
					<div class='smallgrey'>Hits: 8,672</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/working-with-orders/cancel-order'>How to remove an Order in the PrestaShop 1.5 back office </a>
					<div>This article will walk you through Canceling an order in the PrestaShop 1.5 back office.</div>
					<div class='smallgrey'>Hits: 12,714</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/working-with-orders/create-invoice'>How to create an invoice report  in PrestaShop 1.5</a>
					<div>This tutorial explains how to generate an invoice for orders based on either a date range or status in PrestaShop 1.5 dashboard.</div>
					<div class='smallgrey'>Hits: 3,452</div>
				</td>
			</tr>
		<tr><td colspan='3' style='padding-top:20px;'><h2>Order Messages</h2><div>Learn how to manage order messages, which are predefined emails you can easily send to your customers.</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 5:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/working-with-orders/add-order-message'>How to add an Order Message in PrestaShop 1.5</a>
					<div>This PrestaShop 1.5 tutorial will explain how to create a new order message for your store.</div>
					<div class='smallgrey'>Hits: 3,415</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/working-with-orders/edit-order-message'>How to edit an Order Message in PrestaShop 1.5 </a>
					<div>This PrestaShop 1.5 article walks you through editing an Order Message.</div>
					<div class='smallgrey'>Hits: 2,672</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/working-with-orders/remove-order-message'>How to delete an Order Message in PrestaShop 1.5 </a>
					<div>In this PrestaShop 1.5 tutorial you will learn to remove Order Messages.</div>
					<div class='smallgrey'>Hits: 1,335</div>
				</td>
			</tr>
		<tr><td colspan='3' style='padding-top:20px;'><h2>Merchandise Returns</h2><div>How to enable and process product returns</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 8:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/working-with-orders/enable-merchandise-return'>How to enable merchandise returns in PrestaShop 1.5 </a>
					<div>This article explains how to enable merchandise returns in PrestaShop 1.5</div>
					<div class='smallgrey'>Hits: 2,651</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/working-with-orders/process-merchandise-return'>How to process merchandise returns in PrestaShop 1.5 </a>
					<div>This article guides you through processing a merchandise return in PrestaShop 1.5</div>
					<div class='smallgrey'>Hits: 2,926</div>
				</td>
			</tr>
		<tr><td colspan='3' style='padding-top:20px;'><h2>Orders Statuses</h2><div>How to manage product orders statuses</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 10:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/working-with-orders/new-order-status'>Adding a new order status in PrestaShop 1.5 </a>
					<div>This PrestaShop 1.5 article is a guide to creating an order status for your store.</div>
					<div class='smallgrey'>Hits: 4,743</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/working-with-orders/edit-order-status'>Editing an order status in PrestaShop 1.5 </a>
					<div>This article will guide you on modifying an order status in PrestaShop 1.5</div>
					<div class='smallgrey'>Hits: 1,556</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/working-with-orders/delete-status'>Deleting an order status in PrestaShop 1.5 </a>
					<div>Learn how to delete an order status in this PrestaShop 1.5 article.</div>
					<div class='smallgrey'>Hits: 2,033</div>
				</td>
			</tr>
		<tr><td colspan='3' style='padding-top:20px;'><h2>Credit and Delivery Slips</h2><div>Learn to manage credit and delivery slips.</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 13:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/working-with-orders/create-credit-slip'>Creating a credit slip in PrestaShop 1.5 </a>
					<div>This PrestaShop 1.5 tutorial will show you how to crate a credit slip for a returned item.</div>
					<div class='smallgrey'>Hits: 3,774</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/working-with-orders/delete-credit-slip'>Deleting a credit slip in PrestaShop 1.5 </a>
					<div>This PrestaShop 1.5 article will walk you through deleting a credit slip in your admin dashboard.</div>
					<div class='smallgrey'>Hits: 2,785</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/working-with-orders/create-delivery-slip'>How to create delivery slips in PrestaShop 1.5 </a>
					<div>This PrestaShop 1.5 article will show you how to create a delivery slip in your admin dashboard.</div>
					<div class='smallgrey'>Hits: 2,850</div>
				</td>
			</tr>
			</table>
</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNTUmaWQ9MjU1JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="c721ef8ab6f4eea55c44c60e46acea30" value="1" />	</div>
	</form>
<!-- <br />
