<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:58355:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/drupal-7/views-module-tutorial/views-intro" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-02-17T19:28:50-08:00" />
  <meta name="keywords" content="drupal 7 views intro introduction" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="This article is the first of the Views class and just gives a brief overview of what it does for the Drupal admin." />
  <title>Introduction to Views in Drupal 7 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/drupal-7/views-module-tutorial/views-intro" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:6eaaeca5ca8f6645150f3db946ecce34 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '23.25.87.169']);
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
				<img src='/support/images/stories/drupal-partner/supporting-partner-80_3.png' style='float:right; margin:0px 0px 15px 15px;' alt='Drupal Association Support Partner'>		<h1>
															Introduction to Views in Drupal 7									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>5,960</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jul 26, 2012'><span style='color:#606060;'>Published:</span> Feb 17, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Drupal has many plugins, or <a href="http://www.inmotionhosting.com/support/edu/drupal-7/intro-to-modules">modules</a>, that you can install and enable. Drupal has a large set of 'Core' modules that, while installed, simply need to be enabled to be used. Others, however, need to be installed and then can be enabled and used. Views is one of these types of modules.</p>
<p>Views is extremely popular, and while not a core module, is considered to be one of the first modules users should install to enhance their Drupal capabilites and make editing their site easier. It gives a very easy way to pull data from the database and organize it in an easy to manage format.</p>
<p>The Views module enables you to create lists of content and format it to display as you wish within your Drupal site. These lists are referred to as Views and can be displayed in both page and block form. Page form means the view is its own page, whereas a block can be inserted as part of a page, sidebar, or any other region of the site.</p>
<p><br />While there are many parameters available in Views, one of the great things is that they are only activated if needed. This allows the user to make the View as simple or complex as they want.</p>
<p>The Views module is very complex and has many capabilities. Our class here will focus on some of its basic abilities for new users of the module.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 1: Introduction to Views in Drupal 7</div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/drupal-7/views-module-tutorial/views-intro&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/drupal-7/views-module-tutorial/views-intro'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNDUmaWQ9MTYyNiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
