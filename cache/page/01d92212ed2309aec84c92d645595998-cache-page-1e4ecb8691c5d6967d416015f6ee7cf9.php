...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/php-nuke/add-content-php-nuke/feedback-form" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-03-22T18:13:15-07:00" />
  <meta name="keywords" content="php-nuke feedback contact page" />
  <meta name="author" content="John-Paul Briones" />
  <meta name="description" content="This is a guide on how to work with the default feedback/contact page in PHP-Nuke." />
  <title>Working With the Feedback Page in PHP-Nuke - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/php-nuke/add-content-php-nuke/feedback-form" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:11cbc573f3a744aaefd6ca04f2c2f71d -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Working With the Feedback Page in PHP-Nuke									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>811</span></div>
							...
							<div style='clear:both;'></div>
								...
								<div><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/php-nuke/feedback-form.png"><img src="//cdn.inmotionhosting.com/support/images/stories/php-nuke/feedback-form.png" alt="view of the PHP-Nuke feedback form"  style="margin: 15px; float: right;" /></a>After doing a lot of research, we found the built in feedback form for PHP-Nuke to be very limited and simple. When we looked for an Add-On module for a customizable contact form, or formmail we found many dead links.</div>
<div>&nbsp;</div>
<div>In this tutorial we will show you how to work with the feedback module settings in PHP-Nuke.</div>
<div style="clear: both;">
<h1>View Feedback Page Settings:</h1>
<ol class="article_list">
<li><a href="/support/website/php-nuke/login-administrator-system" target="_blank">Login to the Admin section for PHP-Nuke</a>.</li>
<li>Click the <strong>Edit</strong> link on the bottom of the page.</li>
<li>Click the <strong>Modules</strong> button in the <em>Administration Menu</em>.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/php-nuke/clicking-modules-button.png"><img src="//cdn.inmotionhosting.com/support/images/stories/php-nuke/clicking-modules-button.png" alt="selecting modules settings"  style="margin: 15px;" /></a></li>
<li>Scroll down and click the <strong>Edit</strong> button to the right of the <em>Feedback</em>. You can then edit the name of the module, choose who can view it, and whether you want it displayed in the Modules block. Click the <strong>Save Changes</strong> button when you are done.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/php-nuke/feedback-module-settings.png"><img src="//cdn.inmotionhosting.com/support/images/stories/php-nuke/feedback-module-settings.png" alt="view of options for feedback page"  style="margin: 15px;" /></a></li>
</ol>
<div>&nbsp;</div>
<div>Congratulations, now you know how to work with the feedback form in PHP-Nuke!</div>
<div>&nbsp;</div>
</div> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 5: Working With the Feedback Page in PHP-Nuke</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 4: <a href='/support/edu/php-nuke/add-content-php-nuke/creating-content-page'>Creating a Content page in PHP-Nuke</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/php-nuke/add-content-php-nuke/feedback-form&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/php-nuke/add-content-php-nuke/feedback-form'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP3RzcmM9cnNiZWR1Jm9wdGlvbj1jb21fY29udGVudCZjYXRpZD0zNjImaWQ9NjUxJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
