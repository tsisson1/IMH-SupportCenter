<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:89996:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-3/310-newsfeeds" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-12-17T20:28:29-08:00" />
  <meta name="keywords" content="joomla 3.0 newsfeed rss component" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="In this tutorial, we'll show you how to use Joomla's Newsfeeds component to display RSS feeds on your website." />
  <title>310: Joomla 3.1 RSS Newsfeeds Component Tutorial - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-3/310-newsfeeds" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:205c3011f09a9228c4a3ad6b7db97504 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '114.40.41.211']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															310: Joomla 3.1 RSS Newsfeeds Component Tutorial									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>27,210</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Dec 17, 2012'><span style='color:#606060;'>Published:</span> Dec 17, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>The Joomla 3.0 Newsfeed component allows you to show RSS feeds on your site. Besides using the Newsfeed component, you can also use the Feed Display module to show RSS feeds. The first part of this tutorial covers using the <strong>Newsfeed component</strong>, and the latter part of this guide will cover the <strong>Feed Display</strong> module.</p>
<p class="alert">Please note that throughout this article we will be using "<em>rss</em>" and "<em>newsfeed</em>" interchangeably.</p>
<h2>How to create a new NewsFeeds Category</h2>
<p>Before you add your first newsfeed, you may want to first create a new newsfeed category. When you're adding new RSS feeds, you assign them to specific newsfeed categories. There is an <em>Uncategorized</em> category by default, and you certainly can assign everything to uncategorized if you wanted to. If organization is important to you though, follow the steps below and learn to create a new newsfeeds category.</p>
<ol class="article_list">
<li><a href="/support/edu/joomla-3/getting-started/login-dashboard">Log into your Joomla 3.0 admin dashboard</a></li>
<li>In the top menu, click <strong>Components</strong>, hover over <strong>Newsfeeds</strong>, and then click <strong>Categories</strong></li>
<li>In the top left of the page, click <strong>New</strong></li>
<li>Enter the details for your new Category, and then click the <strong>Save</strong> button in the top left of the page.<br /><br />In our testing, we are going to create a page that contains SEO rss feeds, so we are creating a SEO Newsfeeds category. Here are the details we entered on the new Newsfeeds Category page:<br /><br />
...
<td>RSS feeds about SEO will be assigned to this category.</td>
</tr>
</tbody>
</table>
</li>
</ol>
<h2>How to add a new Newsfeed</h2>
<p>As we just created a Newsfeed category called SEO, we will now add a RSS feed to this category.</p>
<ol class="article_list">
<li><a href="/support/edu/joomla-3/getting-started/login-dashboard">Log into your Joomla 3.0 admin dashboard</a></li>
<li>In the top menu, click <strong>Components</strong>, hover over <strong>Newsfeeds</strong>, and then click <strong>Feeds</strong></li>
<li>Click <strong>New</strong> in the top left of the page</li>
<li>Fill out the details of your new Newsfeed / RSS feed, and then click <strong>Save</strong> in the top left of the page<br /><br />We entered the following details:<br /><br />
<table class="article_table">
<tbody>
<tr><th>Title</th>
<td>SEOmoz</td>
...
<tr><th>Link</th>
<td>http://feeds.feedburner.com/seomoz</td>
</tr>
<tr><th>Category</th>
<td>SEO (<em>the category we created above</em>)</td>
</tr>
<tr><th>Description</th>
<td>The description for the SEOmoz RSS feed goes here.</td>
</tr>
</tbody>
</table>
</li>
</ol>
<h2>How to create a Newsfeed menu item</h2>
<p>If you want your website visitors to see your newsfeeds, you'll need to link to them. To do so, you'll need to create a new Newsfeed menu item. In the steps below, we will walk you through setting up the three newsfeed menu items that are available, and we'll also show you what each of them looks like.</p>
<div><ol class="article_list">
<li><a href="/support/edu/joomla-3/getting-started/login-dashboard">Log into your Joomla 3.0 admin dashboard</a></li>
<li>In the top menu, click <strong>Menus</strong>, hover of the menu of your choice, and then click <strong>Add New Menu Item</strong></li>
<li>Next to <strong>Menu Item Type</strong>, click <strong>Select</strong>.</li>
<li>
<div>Click <strong>Newsfeeds</strong>.<br /><br />You will then see 3 available options for new pages:<br /><br />- List all News Feed Categories<br />- List News Feeds in a Category<br />- Single News Feed<br /><br />Below, we will show you how to create each of these types of pages.</div>
<p>&nbsp;</p>
<h3>List All News Feed Categories</h3>
<p>The <em>List All News Feed Categories</em> does just what it says, it creates a page that lists all of the newsfeed categories that you've created.</p>
<p>4A 1. Click <strong>List All News Feed Categories</strong>.<br />4A 2. Next to <strong>Select a Top Level Category</strong>, choose the category to show all Newsfeeds within. We left this to the default setting of <strong>Root</strong>.<br />4A 3. Enter a title next to <strong>Menu Title</strong> - we entered <em>All Rss feeds</em>.<br />4A 4. Click Save in the top left of the page<br /><br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/components/newsfeeds/all-rss-feeds.jpg"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="all-rss-feeds" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/components/newsfeeds/all-rss-feeds.jpg" /></a>We have two categories of RSS feeds, <em>SEO</em> and <em>PHP</em>. As you see in the screenshot to the right, the new page we created simply lists the categories themselves.</p>
<div style="clear: both;">&nbsp;</div>
<h3>List News Feeds in a Category</h3>
<p>The <em>List News Feeds in a Category</em> option allows you to select a specific newsfeed category that you created, and it will generate a page listing all of the individual rss feeds that you've assigned to that category.</p>
<p>4B 1. Click <strong>List News Feeds in a Category</strong><br />4B 2. Next to <strong>Category</strong>, choose the Newsfeeds category to show feeds from - we chose <em>SEO</em><br />4B 3. Next to <strong>Menu Title</strong>, enter a title for the menu - we entered <em>SEO RSS feeds</em><br />4B 4. Click <strong>Save</strong> in the top left of the page<br /><br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/components/newsfeeds/seo-rss-feeds.jpg"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="seo-rss-feeds" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/components/newsfeeds/seo-rss-feeds.jpg" /></a>When we visit our Joomla website, we now see a link in the right menu that says <strong>SEO RSS feeds</strong>. When we click on that link, it brings us to a page listing the RSS feeds that we setup for the <em>SEO</em> Newsfeeds category.</p>
<div style="clear: both;">&nbsp;</div>
<h3>Single News Feed</h3>
<p>The Single News Feed page is the one that will finally show the contents of the RSS feed. With this option, you select the specific newsfeed you want to show, and it will create a page that shows the latest entries in the newsfeed.</p>
<p>4C 1. <strong>Click Single News Feed</strong><br />4C 2. Next to <strong>Feed</strong>, click <strong>Select</strong>. In the list of feeds, click on the feed you would like to show - we chose the <em>Matt Cutts</em> RSS feed<br />4C 3. Next to <strong>Menu Title</strong>, enter a title for this page - we entered <em>Matt Cutts RSS feed</em><br />4C 4. Click <strong>Save</strong> in the top left menu<br /><br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/components/newsfeeds/matt-cutts-rss-feed.jpg"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="matt-cutts-rss-feed" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/components/newsfeeds/matt-cutts-rss-feed.jpg" /></a>After following the above steps, visiting our Joomla website now shows us a <em>Matt Cutts RSS feed</em> link in our right menu. When we click on this link, it brings us to a page listing 5 entries that belong to Matt Cutts' RSS feed.</p>
</li>
</ol></div>
<div style="clear: both;">&nbsp;</div>
<h2>How to show a Newsfeed on your site with a module</h2>
<p>The <strong>Feed Display</strong> module in Joomla allows you to show an RSS feed on your website using a module. This module does not tie into the newsfeeds component at all, it is totally separate. If you need an easy way to show an RSS feed on your site, as in your sidebar, follow the steps below to learn how to setup the Feed Display module.</p>
<ol class="article_list">
<li><a href="/support/edu/joomla-3/getting-started/login-dashboard">Log into your Joomla 3.0 admin dashboard</a></li>
<li>In the top menu, click <strong>Extensions</strong> and then click <strong>Module Manager</strong></li>
<li>Click <strong>New</strong> in the top left of the page</li>
<li>Under <em>Select a Module Type</em>, click <strong>Feed Display</strong></li>
<li>Enter the details of your new Feed Display module, and then click <strong>Save</strong> in the top left of the page.<br /><br />We entered the following:<br /><br />
<table class="article_table">
<tbody>
<tr><th>Title</th>
<td>Matt Cutts</td>
...
<tr><th>Position</th>
<td>Right [position-7]<br />If you're not sure where to place the module on your page, <a href="/support/edu/joomla-3/extension/viewing-module-positions">click here</a> to find out more.</td>
</tr>
<tr><th>Feed URL</th>
<td>http://feeds.mattcutts.com/mattcutts/uJBW<br /><br />Please note: This setting is found under the <strong>basic options</strong> tab.</td>
</tr>
</tbody>
</table>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/components/newsfeeds/matt-cutts-rss-feed-in-right-sidebar.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="matt-cutts-rss-feed-in-right-sidebar" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/components/newsfeeds/matt-cutts-rss-feed-in-right-sidebar.gif" /></a>After clicking save, the RSS feed module (Newsfeed) you just created will show in the position and pages you specified. You can see in the screenshot that we setup the Matt Cutts RSS feed to show in our right sidebar.</p>
<div style="clear: both;">&nbsp;</div>
</li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 33: 310: Joomla 3.1 RSS Newsfeeds Component Tutorial</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 32: <a href='/support/edu/joomla-3/311-search-component'>311: Joomla 3.1 Search Component Tutorial</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 34: <a href='/support/edu/joomla-3/309-messaging-tutorial'>309: Joomla 3.1 Messaging Tutorial</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-3/310-newsfeeds&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-3/310-newsfeeds'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xMDEmaWQ9MjQ1MSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="67af7c71cc0c3389cfd910d085983826" value="1" />	</div>
	</form>
<!-- <br />
...
<a name='comments'></a>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/c75b3dd71f9347cea75b08f10511f638?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/c75b3dd71f9347cea75b08f10511f638'>Ali</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-12 2:14 pm</div>
				                <div><p>Hi. Very helpfull. But I need news feed modul not only text. With sizeable photo.. Can you help me plase?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9674);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-14 8:28 am</div>
				                <div>Unfortunately, I unaware of a specific module that will work in this way, but I do recommend to take a look through the &lt;a href=&quot;http://extensions.joomla.org/&quot;&gt;Joomla Extensions Directory&lt;/a&gt; to locate a module that will work well for you.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9688);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-10696'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/136afac0542f509266e944524534ae94?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/136afac0542f509266e944524534ae94'>Jamal A N</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-18 4:22 pm</div>
				                <div><p>Thanks.. this really helpful. Even for a noob like me, what you write here is nice and understandable</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10696);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-12687'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/a319dc13c76eec29a97d2dd216c9372d?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/a319dc13c76eec29a97d2dd216c9372d'>opperdienaar</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-12 10:39 am</div>
				                <div><p>I can't find what I am looking for, because I always end up with some list of articles grouped in some form visible on some part of the screen.</p>
<p>What I want is in joomla 3, to have the articles that I publish to be available for subscription into someone else's newsfeed. Like a little RSS icon they can click on at the bottom of the screen and they get my articles in their news reader. I bought ultimate feed display component, but that is about feeding other news into your site.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12687);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-14 9:53 am</div>
				                <div>If you want your own feed to display, you could simply use your own feed URL within the steps described by this article.  To configure your own RSS feed, you may use one of the various &lt;a href=&quot;http://extensions.joomla.org/extensions/content-&amp;-news/rss-syndicate&quot;&gt;RSS feed Joomla extensions&lt;/a&gt;.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12717);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-16 2:39 pm</div>
				                <div><p>But to get that link to carry the feed you need to install a syndicator and on the extention page there is no syndicator for joomla 3</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12860);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-12924'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/986569b847274ab74ad14af989a60f44?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/986569b847274ab74ad14af989a60f44'>spyropk</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-17 12:55 pm</div>
				                <div><p>I have a problem with News Feed and Feed Display:</p>
<p>&nbsp;my site is http://users.sch.gr/spyropk. This line here '&Nu;?&alpha; &kappa;&alpha;&iota; &Alpha;&nu;&alpha;&kappa;&omicron;&iota;&nu;?&sigma;&epsilon;&iota;&sigmaf; &gamma;&iota;&alpha; &tau;&eta;&nu; &Epsilon;&kappa;&pi;&alpha;&iota;&delta;&epsilon;&upsilon;&sigma;&eta;' (3rd from last in the menu on the left) is a 'List News Feeds in a Category' menu item. On clicking it, you get a list of all neesfeeds. While clicking on the actual link, i.e. '<span class="list pull-left"> <a href="http://srv-dide-v-ath.att.sch.gr/dide/index.php?option=com_content&amp;view=featured&amp;Itemid=3">http://srv-dide-v-ath.att.sch.gr/dide/index.php?option=com_content&amp;view=featured&amp;Itemid=3</a></span>' works fine, clicking on the name gives a '0- No registered feed parser for type html.' error. The line rading '&Delta;&Iota;&Epsilon;&Upsilon;&Theta;&Upsilon;&Nu;&Sigma;&Eta; &Delta;&Epsilon;&Upsilon;&Tau;&Epsilon;&Rho;&Omicron;&Beta;&Alpha;&Theta;&Mu;&Iota;&Alpha;&Sigma; &Epsilon;&Kappa;&Pi;&Alpha;&Iota;&Delta;&Epsilon;&Upsilon;&Sigma;&Eta;&Sigma; &Beta;' &Alpha;&Theta;&Eta;&Nu;&Alpha;&Sigma;' is a Single News Feed menu item, which, when clicked, gives the same error message. The line reading '&Delta;&Delta;&Epsilon; &Beta;?&Alpha;&theta;?&nu;&alpha;&sigmaf; - &Alpha;&nu;&alpha;&kappa;&omicron;&iota;&nu;?&sigma;&epsilon;&iota;&sigmaf;' is a feed&nbsp; display with the same feed URL (http://srv-dide-v-ath.att.sch.gr/dide/index.php?option=com_content&amp;view=featured&amp;Itemid=3) which gives a feed not found message.</p>
<p>What am I missing here? I'm using Joomla3.3.1. The esct same feed display is set on http://gym-n-erythr.att.sch.gr/ on joomla1.5.26 and works fine.</p>
<p>Any help would be much appreciated. Thank you</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12924);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-17 2:04 pm</div>
				                <div>It appears that this is an issue several users have had according to a &lt;a href=&quot;http://forum.joomla.org/viewtopic.php?f=710&amp;t=826432&quot;&gt;post on the Joomla forums&lt;/a&gt;.  Within that post, various users have suggested using a different feed reader extension which seems to solve some of the issues.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12929);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-13054'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/4484abc715506ebbeed60e3efbb56d40?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/4484abc715506ebbeed60e3efbb56d40'>Michael P Rolfes</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-20 4:39 pm</div>
				                <div><p>How often does the news feed manager pull the RSS data? Is there any way to change it to hourly?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13054);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-21 10:15 am</div>
				                <div>Hello Michael P Rolfes,<br />
<br />
Thank you for your question. The feed manager should just pull any new RSS data going forward.<br />
<br />
The only time setting I could find for this module was for <strong>cache time</strong>, which should only work if you are using caching.<br />
<br />
You can find the <strong>Cache Time</strong> setting for the module, by going to <strong>Options</strong>, then <strong>Advanced Options</strong>.<br />
<br />
If you have any further questions, feel free to post them below.<br />
Thank you,<br />
<br />
-John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13081);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-24961'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/e86c441878ab7361200f120d0304192b?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/e86c441878ab7361200f120d0304192b'>Bertha</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-17 10:27 am</div>
				                <div><p>Hi. I am trying to make ONE link pull RSS feeds from 3 Joomla Categories.</p>
<p>I have created News Feeds Category and a feed (which has the automatic rss link from the website, not external), published syndication modules and made a Menu link pulling from all News Feeds Categories (there is only one such)</p>
<p>Nothing happened until a friend pointed out that the articles within those 3 Joomla Categories needed to be featured.Now they show up, but only from one Category, not all 3..Any help is appreciated</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24961);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-17 10:37 am</div>
				                <div>Hello Bertha,<br />
<br />
Apologies for the RSS issues that you're having.  Typically, if the RSS feeds aren't working it's either your configuration, or there's something you're trying to do , that the built-in functionality doesn't really handle very well.  We'd have to look at your installation and administration settings in order to troubleshoot the issue.  I would recommend looking at some of the extension you can load for CSS.  Check out this <a href="http://extensions.joomla.org/extension/simple-rss-feed-reader" rel="nofollow" target="_blank">Simple RSS Feed Reader</a>.  You may find a better solution with some these free extensions.  <br />
<br />
I hope this helps to answer your question, please let us know if you require any further  assistance.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24962);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
