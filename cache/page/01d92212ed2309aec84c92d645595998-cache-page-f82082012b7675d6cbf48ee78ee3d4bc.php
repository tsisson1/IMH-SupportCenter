...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/cpanel/whm-cpanel-branding-paper-lantern-ready" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello dwebbd, Thank you for your question about cPanel branding. At this time, with this version of WHM/cPanel, Paper Lantern cannot be branded. See mor..." />
  <title>WHM Cpanel branding - Paper Lantern ready? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/cpanel/whm-cpanel-branding-paper-lantern-ready" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:0585c36dfe43f8a05f68dd3146b56efb -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>WHM Cpanel branding - Paper Lantern ready?</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/dwebbd'>dwebbd</a>
			<div>21 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-03-26 12:55 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>363</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>The default CPanels that are created with the current version of WHM 11.44.3 end up being the Paper Lantern theme which I LOVE.<br />
<br />
However when I try to brand the template the only available options are based on the &quot;x3&quot; style.<br />
Any idea when these tow will get synced up?</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_6882' id='upvote_answer_6882' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='6882' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_6882').submit();"></div>
	</form>
	<div class='vote_sum'>1</div>
	<form method='post' name='downvote_answer_6882' id='downvote_answer_6882' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='6882' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_6882').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello dwebbd,<br />
<br />
Thank you for your question about cPanel branding. At this time, with this version of WHM/cPanel, Paper Lantern cannot be branded. See more in the official <a href="http://forums.cpanel.net/threads/branding-paper_lantern.396921/" target="_blank">cPanel discussions</a>.<br />
<br />
This seems to be fixed in cPanel/WHM 11.48, which we will upgrade to once it reaches the Long Term Support (LTS) stage of the release.<br />
<br />
...
John-Paul
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_6882').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_6882' id='form_comment_on_answer_6882' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/cpanel/whm-cpanel-branding-paper-lantern-ready&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/cpanel/whm-cpanel-branding-paper-lantern-ready'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="67072ed5cc28d2e22cec5cc306588428" value="1" />	</div>
	</form>
<!-- <br />
