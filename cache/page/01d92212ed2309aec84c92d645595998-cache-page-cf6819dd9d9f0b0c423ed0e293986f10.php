<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:96501:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/domain-names-dns-changes" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-01-14T14:59:45-08:00" />
  <meta name="keywords" content="DNS propagation changes" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="Frustrated with the time it takes for your DNS changes to propagate? Learn about propagation here." />
  <title>Domain Names - How long do DNS changes take? - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/domain-names-dns-changes" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:09fd1411fb09dd7a28b9a3a4c80d534a -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '81.7.237.244']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Domain Names - How long do DNS changes take?									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>244,020</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Aug 29, 2011'><span style='color:#606060;'>Published:</span> Jan 14, 2015</div>
							...
							<div style='clear:both;'></div>
								...
								<p>When a domain is newly registered, the <a target="_blank" href="/support/domain-names/dns-nameserver-changes/what-is-a-name-server">nameservers</a> are changed, or DNS changes are made, you can expect a propagation time <strong>up to 24 hours</strong>. This is because it takes time for the DNS to take effect across the internet. The actual time of propagation may vary in some locations based on your network setup.</p>
<h2>What is DNS propagation?</h2>
<p>When you make a DNS change, it takes time for the changes to take effect. This is called DNS propagation. It is the time it takes for the domain DNS to refresh the cache on the network.</p>
<h2>How long does it take to refresh my DNS cache?</h2>
<p>The cache is cleared over a certain amount of time. We suggest waiting up to 24 hours for the DNS cache to be fully refreshed. DNS will refresh according to the "<em>TTL</em>" or "<em>Time To Live</em>". When the DNS refreshes according to its TTL, the propagation is complete and your site will load.</p>
<h2>How do I check if my domain DNS is propagated?</h2>
<p>You can always check where your domain is pointing by the following domain routing tool.</p>
<p style="margin-left: 20px;"><a href="/support/tools/visual-domain-routing">Visual Domain Routing Tool</a></p>
<p>You can also <a href="/support/website/website-troubleshooting/why-is-my-server-slow-how-do-i-run-a-ping-and-tracert-test">ping and trace route your domain</a> locally from your Windows/Mac command prompt to verify what IP you are actually seeing. If the ping and traceroute test show your server with us in the outcome, you know the DNS is propagated.</p>
<h2>Can I speed up the propagation process?</h2>
<p>The quick answer is no. You can try speeding up the propagation time by having your TTL set to a lower number (not recommended). This will refresh the DNS at a quicker rate. We set the default TTL to 14400 (4 hours); however the network that you are using to access the internet may update at a slower rate.</p>
<p>You can try Clearing your DNS cache or "<em>Flush the DNS</em>". For information on how to flush your DNS, please see our article on <a target="_blank" href="/support/domain-names/dns-nameserver-changes/how-do-i-clear-my-local-dns-cache">How do I clear my local DNS cache?</a>. Clearing your DNS cache does not always work, so sometimes you will just need to wait.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/domain-names-dns-changes&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/domain-names-dns-changes'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD02OCZpZD04NDUmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="a560f75ecae7ff7718b95be74824b794" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/dns-nameserver-changes/changed-primary-domain?tsrc=rsbraq'>Website not showing after change of name servers</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/domain-names/subdomain-not-propagating?tsrc=rsbraq'>Subdomain not propagating</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/dns-nameserver-changes/how-to-know-when-nameserver-change-has-occurred?tsrc=rsbraq'>how to know when nameserver change has occurred</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/dns-nameserver-changes/nameserver-replication-of-mx-records?tsrc=rsbraq'>Nameserver replication of MX records</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/website/cannot-access-website?tsrc=rsbraq'>Cannot access website</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/domain-names/domain-not-resolving-to-dedicated-server?tsrc=rsbraq'>Domain is not resolving to dedicated server</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/cpanel/cpanel-and-website-are-unavailable?tsrc=rsbraq'>cPanel and website are unavailable</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/wordpress/can-not-get-to-admin-page-on-rabbittrapus?tsrc=rsbraq'>Can not get to admin page on rabbittrap.us</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/dns-nameserver-changes/trying-to-point-my-domain-to-godaddy-hosting-account?tsrc=rsbraq'>Trying to point my domain to GoDaddy hosting account</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						...
						<div><a style='font-size:16px;' href='/support/community-support/users/unityman'>unityman</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2012-07-17 9:33 pm</div>
				                <div>It would help if you explained how you pong your domain, locally or otherwise.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(6764);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2012-07-17 9:34 pm</div>
				                <div>I meant to say &quot;ping,&quot; not &quot;pong&quot;!</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(6765);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2012-07-18 8:27 am</div>
				                <div>Hello unityman,<br />
<br />
I agree! I have inserted a link to the instructions on how to do a ping and trace test. Thank you for pointing that out!<br />
<br />
Best Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(6766);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-10984'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/318491a93021a3fbb2e24e06437adef7?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/318491a93021a3fbb2e24e06437adef7'>siva</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-30 2:40 am</div>
				                <div><p>Hi,</p>
<p>&nbsp;</p>
<p>Is there anyway to stop the propagation beacuse i updated wrong name server.</p>
<p>&nbsp;</p>
<p>please check and clarify with me.</p>
<p>&nbsp;</p>
<p>Thanks in advance.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10984);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-30 6:07 am</div>
				                <div>Hello siva, and thanks for the comment.<br />
<br />
Unfortunately there is no way to stop propagation if your updated name servers have already started spreading around the web. You could simply set your domain to the correct name server, and then that correct value would begin to propagate around the web at that point.<br />
<br />
However if some servers already got the update for your domain pointing at the wrong name server, they will continue to point to the incorrect server and won't default back to the correct value until you update it and fix it.<br />
<br />
Please let us know if you had any further questions at all.<br />
<br />
- Jacob</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10990);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-30 2:07 pm</div>
				                <div><p>Hi&nbsp;<span style="color: rgb(35, 35, 35); font-family: adelle-sans, Helvetica, Arial, sans-serif; font-size: 13px; line-height: 22px;">Jacob,</span></p>
<p>Thanks for your reply.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11000);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-16 1:05 am</div>
				                <div>This page was linked to from the add subdomain portion of cPanel. It discusses how DNS propagation works for a newly registered domain, but does not mention if there are any differences between that and just adding a subdomain.  Otherwise, very informative, thanks!</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16334);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-26 2:29 am</div>
				                <div><p>Hello, my website&nbsp;http://www.gadgetghor.com/ is not loading properly. When I visit the site its showing this page&nbsp;http://www.gadgetghor.com/cgi-sys/defaultwebpage.cgi</p>
<p>Please help me..&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17833);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-26 9:16 am</div>
				                <div>Hello Saimon,<br />
<br />
Sorry you're having problems seeing the page properly.  When we look, we see the store page with no problem.  It may simply be a caching issue.  Make sure that your <a href="http://www.inmotionhosting.com/support/website/how-to/clear-browser-cache">browser cache</a> is clear before reloading the page. I hope this helps to resolve your problem.  Please let us know if you have any further questions or comments.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17844);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-19978'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/e8fbc082ef8e3a84598121e2d4a3cfb7?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/e8fbc082ef8e3a84598121e2d4a3cfb7'>kipe</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-26 5:04 pm</div>
				                <div><p>Am trying to move my site from one host to another but on accessing my site it redirects to an entirely different site altogether. Pls what is the reason for this.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19978);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-26 6:07 pm</div>
				                <div>Hello Kipe,<br />
<br />
Thanks for the question.  Unfortunately, you have given us NO information about your domain name so that we could research it.  If you're moving a domain from one host to another, the name servers that were assigned to your domain are what determine WHERE you site is pulling its files from.   You can use <a href="http://www.inmotionhosting.com/support/domain-names/general-information/how-to-look-up-domain-whois">WHOIS</a>  to determine where your site is pointing to.    If you're an InMotion customer, we have an <a href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/updating-your-domains-nameservers">article</a> that explains how to change your DNS. <br />
<br />
I hope this helps to answer your question, please let us know if you require any further  assistance.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19982);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-23902'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/d4af8ee13834d742b5200ee593387b2d?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/d4af8ee13834d742b5200ee593387b2d'>Stefanie</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-03 10:39 am</div>
				                <div><p>We recently set up a mobile site and our webmaster has told us he set up the CNAME records, however when we check it &nbsp;we get an error message. &nbsp;It has been over 24 hours. &nbsp;Here is our mobile link</p>
<p>m.cwihomes.com</p>
<p>Thank you for your help!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23902);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-04 10:32 am</div>
				                <div>Hello Stefanie,<br />
<br />
I double checked this today, and it seems to be okay.  If you have any further questions or comments, please let us know.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23940);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/0720da4a4bb4b29e0417edcc67a3acab?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/0720da4a4bb4b29e0417edcc67a3acab'>John</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-18 11:31 am</div>
				                <div>A tool i like to use to check my domains dns propagation is http://isthissitedown.net/dns-propagation-checker</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25873);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-29127'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/79431f0c666c25ffdb3f64cd4b3866f9?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/79431f0c666c25ffdb3f64cd4b3866f9'>Anuar</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-12-10 12:04 pm</div>
				                <div><p>I am trying to sign in to my newly addon domain cpanel; &nbsp;http://www.******.com:2082/ , it does not authenticate my name &amp; password. I tried removing and I addon again, but still remains the same. My domain provider has said to wait for 8-12hours for the propagation. Now five hours has passed.&nbsp;Is the issue because of the propagation time, or do I need to redirect? Please help!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29127);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-12-10 3:32 pm</div>
				                <div>Hello Anuar,<br />
<br />
Thank you for contacting us. Yes, propagation can take up to 24 hours to propagate. Also, <a href="http://www.inmotionhosting.com/support/domain-names/registrations-and-transfers/add-another-domain-name-account">adding a new domain</a> name to your account takes time to propagate.<br />
<br />
As long as you are pointed to the correct <a href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes">nameservers</a>, it should resolve successfully.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29128);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-29648'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/53420084134b4657dbfdec33ce78a2ec?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/53420084134b4657dbfdec33ce78a2ec'>Syed Hussain</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-08 1:10 am</div>
				                <div><p>I recently purchased a domain "simplepsd.com".</p>
<p>I changed the nameserves but the site is still not active. Please help me with the status. Am i missing anything?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29648);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-08 12:18 pm</div>
				                <div>Hello Syed,<br />
<br />
Is it still not working as I am loading up a WordPress website using the Porto theme.<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29662);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/53420084134b4657dbfdec33ce78a2ec?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/53420084134b4657dbfdec33ce78a2ec'>Syed</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-10 5:11 am</div>
				                <div><p>Hello TJ</p>
<p>Its working now.. I had to add a secondary domain from my cpanel,</p>
<p>Thanks to Jason K, he sorted out the issue :)</p>
<p>Regards,</p>
<p>`Syed</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29685);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-11 12:54 pm</div>
				                <div>Hello Syed,<br />
<br />
Thank you for contacting us and letting us know. We're happy you were able to get it working!<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29705);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
