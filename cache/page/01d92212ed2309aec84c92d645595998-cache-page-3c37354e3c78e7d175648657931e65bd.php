...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/phpmyadmin/drop-table" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-03-26T18:14:54-07:00" />
  <meta name="keywords" content="drop delete database phpmyadmin table" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Looking to drop a table from your database? Learn how in this phpMyAdmin article." />
  <title>How to delete or drop a table in phpMyAdmin - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/phpmyadmin/drop-table" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:cfa11babb499b1afeef79d852bb5d5fa -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '181.56.160.55']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to delete or drop a table in phpMyAdmin									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>10,169</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Apr 22, 2013'><span style='color:#606060;'>Published:</span> Mar 26, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>When working with databases, you can use the <a href="/support/website/database-setup/how-do-i-manage-a-mysql-database-in-phpmyadmin-in-my-control-panel-cpanel">phpMyAdmin tool</a> to create database, tables, and add content. Along with normal data addition, you may also need to reorganize the way your data is stored. This may involved removing data, or even deleting tables from you databases. This tutorial will guide you on the process of dropping a table within the phpMyAdmin database management tool.</p>

<p class="alert">Note that when deleting or dropping a table, the data will be removed <em>permanently</em>. Please ensure that you do not need the data for any program before dropping the table.</p>

<h2>Deleting or dropping a table in phpMyAdmin</h2>
...
<li>From the main cPanel screen, look for the <em>Databases</em> category and click on the <strong>phpMyAdmin</strong> tool icon.<div style="clear:both;"></div></li>
  
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phpmyadmin/drop-table/click-db.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="click databases button" src="//cdn.inmotionhosting.com/support/images/stories/edu/phpmyadmin/drop-table/click-db.png" title="Click here to view the larger image" max-width="200"></a> Once you are in the phpMyAdmin tool, find and click on the database name that contains the table you want to drop.<div style="clear:both;"></div></li>

  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phpmyadmin/drop-table/2-click-drop.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="select the drop link for desired table" src="//cdn.inmotionhosting.com/support/images/stories/edu/phpmyadmin/drop-table/2-click-drop.png" title="Click here to view the larger image" max-width="200" /></a>After clicking the database name, the tables will be listed in the right hand panel. Locate the table you want to drop and select the <strong>Drop</strong> link.<div style="clear:both;"></div></li>
<li>You will receive a popup. Click the <strong>OK</strong> button to confirm the delete.<div style="clear:both;"></div></li>
<li>You will receive a deletion success message and see your table disappear from the list. Below is a quick before and after shot of the table list for a successful deletion.

<table class="article_table">
<tr><th>Before</th><th>After</th><tr>
<tr><td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phpmyadmin/drop-table/before.png"><img  alt="before table deletion" src="//cdn.inmotionhosting.com/support/images/stories/edu/phpmyadmin/drop-table/before.png" title="Click here to view the larger image" width="225" /></a></td><td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phpmyadmin/drop-table/after.png"><img  alt="after table deletion" src="//cdn.inmotionhosting.com/support/images/stories/edu/phpmyadmin/drop-table/after.png" title="Click here to view the larger image" width="225" /></a></td></tr>
</table>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/phpmyadmin/drop-table&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/phpmyadmin/drop-table'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MDMmaWQ9MjY0NCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/147f8c2e21fa001311657552faafb9e1?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/147f8c2e21fa001311657552faafb9e1'>Table Dropper</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-31 4:00 am</div>
				                <div><p>What would be really useful is to teach us how to drop the prefix too "_test"</p>
<p>and what if there are many of them?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26213);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-31 1:21 pm</div>
				                <div>Hello,<br />
<br />
Are you meaning the prefix of the tables? such as wp_options (for wordpress tables) or the database itself such as userna5_test?  Prefixes of tables are set within their specific CMS. Table prefixes are set by the server and not possible to remove on a shared environment.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26226);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
