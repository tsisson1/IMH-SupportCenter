<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49189:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.net/support/edu/website-design" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="keywords" content="%default%" />
  <meta name="description" content="Website Design Category" />
  <title>Website Design | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/website-design" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:79cebe1d05aa4a4c9b5429c3c9386965 -->
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Website Design</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	...
	<div class='item-page'>
		<div class='page-header'>
			<h1>Website Design Education Channel</h1>
		</div>
	
<div style='clear:both;'></div>

<div class='edu_class_listing white_box'>
	<h2>Website Design Tutorials</h2>
	<ul style='float:left; width:300px; margin-right:20px;'>
<li  ><a href='/support/edu/website-design/website-design-basics'>101: Website Design Basics</a></li>
<li  ><a href='/support/edu/website-design/insert-images-website'>102: Inserting Images into a Website</a></li>
<li  ><a href='/support/edu/website-design/inserting-links-into-website'>103: Inserting Links into a Website</a></li>
<li  ><a href='/support/edu/website-design/meta-tags-explained'>104: Meta Tags Explained</a></li>
<li  ><a href='/support/edu/website-design/html-5-syntax'>105: HTML 5 Basic syntax</a></li></ul><ul style='float:left; width:300px; margin-right:20px;'>
<li  ><a href='/support/edu/website-design/adding-videos-website'>201: Adding Videos to a Website</a></li>
<li  ><a href='/support/edu/website-design/adding-contact-forms'>202: Adding Contact Forms </a></li>
<li  ><a href='/support/edu/website-design/using-css'>203: Using and Understanding CSS</a></li>
<li  ><a href='/support/edu/website-design/website-design-best-practices'>204: Website Design Best Practices</a></li>
<li  ><a href='/support/edu/website-design/using-php-and-mysql'>205: Using PHP to create dynamic pages</a></li>
<li  ><a href='/support/edu/website-design/create-responsive-template'>206: Creating Responsive Templates</a></li>
<li class='features collapse' ><a href='/support/edu/website-design/search-engine-optimization'>207: Search Engine Optimization</a></li></ul><div style='clear:both;'></div></div>
...
<div class='edu_most_popular white_box'>
	<h2>Most Popular Articles</h2>
		<div style='width:300px; height:75px; float:left; margin-right:20px;'>
							...
							<div class='smallgrey'>Hits: 498,540</div>
						</div>
						<div style='width:300px; height:75px; float:left; margin-right:20px;'>
						...
						<div style='width:300px; height:75px; float:left; margin-right:20px;'>
							...
							<div class='smallgrey'>Hits: 318,190</div>
						</div>
						<div style='width:300px; height:75px; float:left; margin-right:20px;'>
...
<form action="http://www.inmotionhosting.net/support/edu/website-design" method="post" name="adminForm" id="adminForm" class="form-inline">
	...
	<option value="0">All</option>
		...
		<h2>Website Design - Advanced Tutorials</h2>
		<table style='margin-top:20px;'>
			...
			<tr>
				...
				<td valign='top' style='padding-bottom:15px;'>
					<div><a href='/support/edu/website-design/301-adding-a-table-to-your-website'>301: Adding a Table to your Website</a></div>
					<div>Learn how to use a table in your HTML to better organize your content. </div>
					<div class='smallgrey'>
			...
			<tr>
				<td valign='top' style='padding:6px 15px 0px 0px;'><img src='https://lh3.googleusercontent.com/-NBh2f5kDJfQ/AAAAAAAAAAI/AAAAAAAAACU/6SP6_r-gSAQ/s90-p-rw-no/photo.jpg' class='sc_rc' style='width:55px;' /></td>
				<td valign='top' style='padding-bottom:15px;'>
					<div><a href='/support/edu/website-design/302-server-side-includes-an-introduction'>302: Server Side Includes: An Introduction</a></div>
					<div>Learn what a server side include is and how to set up your first Hello World SSI. </div>
					<div class='smallgrey'>
						Written by Tim Sisson<br />
						Hits: 4,660
					</div>
			...
			<tr>
				<td valign='top' style='padding:6px 15px 0px 0px;'><img src='https://lh3.googleusercontent.com/-NBh2f5kDJfQ/AAAAAAAAAAI/AAAAAAAAACU/6SP6_r-gSAQ/s90-p-rw-no/photo.jpg' class='sc_rc' style='width:55px;' /></td>
				<td valign='top' style='padding-bottom:15px;'>
					<div><a href='/support/edu/website-design/303-using-server-side-includes-with-html'>303: Using Server Side Includes with HTML Files</a></div>
					<div>Learn how to edit your .htaccess file to allow Server Side Includes in regular HTML files.</div>
					<div class='smallgrey'>
						Written by Tim Sisson<br />
						Hits: 5,374
					</div>
			...
			<tr>
				...
				<td valign='top' style='padding-bottom:15px;'>
					<div><a href='/support/edu/website-design/html-reference'>304: HTML Tag Reference List</a></div>
					<div>This is a current HTML 5 tag reference list.</div>
					<div class='smallgrey'>
			...
			<tr>
				...
				<td valign='top' style='padding-bottom:15px;'>
					<div><a href='/support/edu/website-design/minifying-css'>Minifying CSS</a></div>
					<div>The following article explains the benefits of minifying CSS.  There will also be an example of how it is done and a short list of online tools that can help in the task.</div>
					<div class='smallgrey'>
			...
			<tr>
				<td valign='top' style='padding:6px 15px 0px 0px;'><img src='https://lh3.googleusercontent.com/-np8xy9GiNy8/AAAAAAAAAAI/AAAAAAAAAEU/Eu1yKGoTxiA/photo.jpg?sz=50' class='sc_rc' style='width:55px;' /></td>
				<td valign='top' style='padding-bottom:15px;'>
					<div><a href='/support/edu/website-design/minifying-html'>Minifying HTML</a></div>
					<div>This article discusses minifying HTML to optimize web page performance. You will see a simple example and also see a short list of online minifying HTML tools.</div>
					<div class='smallgrey'>
						Written by Arnel Custodio<br />
						Hits: 572
					</div>
