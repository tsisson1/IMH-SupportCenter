<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:54226:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/website-troubleshooting/cpanel-login-prompt" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Ambler0, Sorry to hear your site was hacked. It sounds like you are seeing the cPanel login prompt, which is correct, but I would be happy to take..." />
  <title>cPanel login prompt stealing my password? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/website-troubleshooting/cpanel-login-prompt" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:521b9c690d088fb17b53899f00a97497 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>cPanel login prompt stealing my password?</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='http://graph.facebook.com//picture?type=normal' class='user_avatar' /><br />
			<a href='/support/community-support/users/Ambler0'>Ambler0</a>
			<div>8 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-09-09 1:18 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>1,395</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>My account was hacked recently, a directory removed and files created in public_html. I notice that when I log into CPanel, a windows dialog pops up and asks me for my password before the CPanel dialog does. It has the text &quot;A username and password are being requested by https://... The site says Cpanel&quot;. Now I X it out. I'm wondering if they got my password through that additional dialog. I have a screenshot of it if you are interested. </div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_3906' id='upvote_answer_3906' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='3906' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_3906').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_3906' id='downvote_answer_3906' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='3906' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_3906').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Ambler0,<br />
<br />
Sorry to hear your site was hacked. It sounds like you are seeing the cPanel login prompt, which is correct, but I would be happy to take a look at your screenshot. You can email it to <a href="mailto:docs@inmotionhosting.com">docs@inmotionhosting.com</a> with the subject: <strong>Attn: Customer Community</strong>, then leave a comment here letting us know.<br />
<br />
Typically when a website is hacked, it is due to a <a href="http://www.inmotionhosting.com/support/website/how-to/an-introduction-to-password-security" target="_blank" >weak password</a>, or the software/plugins you are running. For example an outdated Wordpress, Joomla, etc.<br />
<br />
Here is a helpful link to our article on <a href="http://www.inmotionhosting.com/support/website/hacks/steps-to-take-after-a-hack" target="_blank" >what to do after a hack</a>, and I recommend reading our <a href="http://www.inmotionhosting.com/support/website/new-customers/website-security" target="_blank" >guide on website security</a>.<br />
<br />
...
-John-Paul
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_3906').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_3906' id='form_comment_on_answer_3906' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
...
Thanks for the response--I have sent you the screenshot. I don't really understand why I have to enter the password twice, but OK. Meanwhile I have cleaned up my website a bit and I'll be disabling the Sitebuilder blog which I think is the main cause of my troubles. I'll go through the documents you sent also.  Thanks again. Andrew.</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>&lt;div style=&quot;background-color: #FFF; padding-left: 10px;&quot;&gt;Hello Ambler0,<br />
<br />
I took a look at the screen shot you sent, and that's just the standard cPanel login prompt. It prompts your web-browser to display a pop-up login box, and if you cancel that, then you get the actual cPanel branded login prompt.<br />
<br />
If you type in your correct username and password into the first pop-up login box, it should let you right into cPanel, and then depending on your settings your web-browser should ask you if you'd like it to remember those credentials for you.<br />
<br />
- Jacob&lt;/div&gt;</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/website-troubleshooting/cpanel-login-prompt&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/website-troubleshooting/cpanel-login-prompt'></div>
<script type='text/javascript'>
  (function() {
