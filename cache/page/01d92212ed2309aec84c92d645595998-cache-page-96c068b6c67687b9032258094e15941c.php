<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:48628:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/prestashop-15/b2b-mode-in-prestashop" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Unfortunately your request is a bit unclear. B2B mode is use to denote special pricing for individuals belonging to a particular customer group. For exa..." />
  <title> B2B mode in PrestaShop | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/prestashop-15/b2b-mode-in-prestashop" rel="canonical" />
...
<script>
  ...
  ga('send', 'pageview');
	...
	<!-- cid:4449aa4c8bd216c85a0222594e6edbef -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'> B2B mode in PrestaShop</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2014-01-01 8:18 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>2,661</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>i use Enable B2B Mode in PrestaShop but i want after loging any one in my web site then show me wholesale price it that posibale <br />
<br />
so how its work please reply me</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_4371' id='upvote_answer_4371' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='4371' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_4371').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_4371' id='downvote_answer_4371' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='4371' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_4371').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>11,186 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2014-01-02 1:21 pm EST
                		        </div>
					
		                </div>

				Unfortunately your request is a bit unclear.  B2B mode is use to denote special pricing for individuals belonging to a particular customer group.  For example, if you want regular customers to purchase a product at $100, but you want a special group of people to be able to purchase it for $50, you would set B2B mode for that particular customer group.
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_4371').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_4371' id='form_comment_on_answer_4371' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
