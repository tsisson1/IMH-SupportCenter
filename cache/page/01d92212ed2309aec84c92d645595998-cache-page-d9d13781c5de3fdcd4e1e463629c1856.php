...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/ssl/curl-reports-error-35-ssl-connect-error-when-connecting-to-paypal" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, Sorry to hear you are having issues with your cURL version. While I cannot locate the specific version needed in my search, it seems that you may..." />
  <title>CURL Reports Error 35 (SSL Connect Error) when Connecting to PayPal | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/ssl/curl-reports-error-35-ssl-connect-error-when-connecting-to-paypal" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:27d69a2165f20c3586bcdcd0160fff96 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>CURL Reports Error 35 (SSL Connect Error) when Connecting to PayPal</h1>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_9350' id='upvote_answer_9350' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='9350' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_9350').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_9350' id='downvote_answer_9350' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='9350' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_9350').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
Sorry to hear you are having issues with your cURL version. While I cannot locate the specific version needed in my search, it seems that you may need a cURL version upgrade in order for your connection to work with the PayPal.  <br />
<br />
If your server has a version of 7.19.7 and needs a newer curl version, that is not something that can be changed at the account level on a shared servers. To have a higher cURL version, you would need to upgrade to a VPS or Dedicated plan.<br />
<br />
Kindest Regards,<br />
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_9350').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_9350' id='form_comment_on_answer_9350' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/ssl/curl-reports-error-35-ssl-connect-error-when-connecting-to-paypal&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/ssl/curl-reports-error-35-ssl-connect-error-when-connecting-to-paypal'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="c25eac28a507daa7089f85b7f043117c" value="1" />	</div>
	</form>
<!-- <br />
