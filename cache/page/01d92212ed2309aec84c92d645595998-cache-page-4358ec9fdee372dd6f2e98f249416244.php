...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotion.net/support/website/wordpress/removing-expired-transients" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-10-30T16:35:04-07:00" />
  <meta name="author" content="Jeff Matson" />
  <meta name="description" content="Old transient data can sometimes clutter up your WordPress database and cause moz will show you how to remove expired transients." />
  <title>Removing expired transients - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/wordpress/removing-expired-transients" rel="canonical" />
...
<script>
  ...
  ga('send', 'pageview');
	...
	<!-- cid:7c451d3171b28ec67d9026e5ba28e0a3 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Removing expired transients									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>845</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Oct 8, 2014'><span style='color:#606060;'>Published:</span> Oct 30, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>To increase performance, WordPress plugins may use the transients API to store some data in the database.  While this does increase performance, some old data can be left by disabled or removed plugins that can <a href="http://www.inmotionhosting.com/support/website/server-usage/how-can-i-view-my-accounts-resource-usage">adversely affect performance</a>.  In this article, we will show you how to remove expired transients from your WordPress database.</p>
<div class="in_this_tutorial">
  <h2>In this tutorial:</h2>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('installing');">Installing the Transient Manager plugin</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('removing');">Removing expired transients</button>
</div>
<a name="installing"></a>
<h2>Install the Transient Manager plugin</h2>
<ol class="article_list">
  <li style='clear:both;'><p>Begin by <a href="http://www.inmotionhosting.com/support/edu/wordpress/wordpress-introduction/logging-into-wordpress-dashboard">logging into your WordPress admin dashboard</a>.</p></li>
  <li style='clear:both;'><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/wordpress/expired-transients-1.png"><img src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/wordpress/expired-transients-1.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>Next, hover over <strong>Plugins</strong> and click on <strong>Add New</strong> on the left side admin menu bar.</p></li>
  <li style='clear:both;'><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/wordpress/expired-transients-2.png"><img src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/wordpress/expired-transients-2.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>In the search box at the top right, enter <strong>Transients Manager</strong> and press the <strong>Enter</strong> key to search for the Transients Manager plugin.</p></li>
  <li style='clear:both;'><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/wordpress/expired-transients-3.png"><img src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/wordpress/expired-transients-3.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>You should now see a list of plugins that match your search query.  In this case, the plugin your are looking for should be the first result.  To install it, click the <strong>Install Plugin</strong> button.</p></li>
  <li style='clear:both;'><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/wordpress/expired-transients-4.png"><img src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/wordpress/expired-transients-4.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>WordPress will now handle the download and installation of the Transients Manager plugin for you.  Once complete, be sure to click <strong>Activate Plugin</strong> to activate it.</p></li>
  <div style='clear:both;'></div>
</ol>
<a name="removing"></a>
<h2>Removing expired transients</h2>
<p>Now that you have the Transient Manager plugin installed, removing any expired transients is a breeze.  In the next steps, we will show you how to do so.</p>
<ol class="article_list">
  <li><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/wordpress/expired-transients-5.png"><img src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/wordpress/expired-transients-5.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>In the menu bar to the left side of your WordPress admin dashboard, hover over <strong>Tools</strong> and click on <strong>Transients</strong>.</p></li>
  <li><p>On the top left of the page, click the button that says <strong>Delete Expired Transients</strong>.  The plugin will now delete any expired transients in your database.</p></li>
  <div style='clear:both;'></div>
</ol>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotion.net/support/website/wordpress/removing-expired-transients&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotion.net/support/website/wordpress/removing-expired-transients'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD02MyZpZD0zNDAxJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
