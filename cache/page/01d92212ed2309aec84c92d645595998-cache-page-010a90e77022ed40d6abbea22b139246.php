<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:69074:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/server-usage/edit-main-phpini" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-07-17T13:24:47-07:00" />
  <meta name="keywords" content="php.ini edit main server VPS dedicated 2xram" />
  ...
  <link href="http://www.inmotionhosting.com/support/website/server-usage/edit-main-phpini" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:ce22f8c7266b6df8a24b2c8f21b15e38 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '116.72.208.83']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Editing your main php.ini on VPS and Dedicated accounts</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Editing your main php.ini on VPS and Dedicated accounts									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>10,880</span></div>
							...
							<div style='clear:both;'></div>
								...
								<p>All servers have a main <em>php.ini</em> file. This is a file that allows you to control the php settings. The main php.ini file controls the settings for the entire server. By placing a <em>php.ini</em> file within a folder, it will override the main server php.ini and allow you to customize settings for the files and folders under it.</p>

<p>Most of the time, <a href="/support/website/php/update-local-php-settings">editing a <em>php.ini</em></a> file at a more local level is sufficient, however there are times when you may want to alter the main php.in file to provide the setting change as a default to the entire server. This can only be done with the root access on <a href="http://www.inmotionhosting.com/vps-hosting">VPS</a> and <a href="http://www.inmotionhosting.com/dedicated-servers">dedicated servers</a>. The instructions below walk you through how to do that.</p>

<h2>How to change your main <em>php.ini</em> file on VPS and Dedicated servers</h2>

<ol class="article_list">
<li>Log into your server via SSH.<div style="clear:both;"></div></li>
<li>Use the following command to open the file for editing.<br />
<div class="cli">nano /usr/local/lib/php.ini</div><div style="clear:both;"></div></li>
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/server/php-ini/edit-main-php-ini/1-search-for-settings.png"><img  style="float:right; margin:0px 0px 15px 15px;" alt="Search for desired setting" src="//cdn.inmotionhosting.com/support/images/stories/edu/server/php-ini/edit-main-php-ini/1-search-for-settings.png" title="Click here to view the larger image" width="200" /></a>Activate the <em>Find</em> feature by pressing <strong>crtl+W</strong> and then entering desired setting. The interface will scroll to that setting. In our case, we searched for <em>post_max_size</em>.<div style="clear:both;"></div></li>
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/server/php-ini/edit-main-php-ini/2-setting-changed.png"><img  style="float:right; margin:0px 0px 15px 15px;" alt="After the setting is changed" src="//cdn.inmotionhosting.com/support/images/stories/edu/server/php-ini/edit-main-php-ini/2-setting-changed.png" title="Click here to view the larger image" width="200" /></a>Alter the setting to your desired configuration. We changed the <strong>post_max_size</strong> setting to 16M.<div style="clear:both;"></div></li>
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/server/php-ini/edit-main-php-ini/3-name-file.png"><img  style="float:right; margin:0px 0px 15px 15px;" alt="Name file during save." src="//cdn.inmotionhosting.com/support/images/stories/edu/server/php-ini/edit-main-php-ini/3-name-file.png" title="Click here to view the larger image" width="200" /></a>Save the changes by pressing <strong>crtl+O</strong>. You will be prompted for a filename, press <strong>Enter</strong> to keep the same name.<div style="clear:both;"></div></li>
  <li>Exit the editor by pressing <strong>ctrl+X</strong>.<div style="clear:both;"></div></li>
<li>Exit your SSH Client.<div style="clear:both;"></div></li>
</ol>


Now that your <em>php.ini</em> settings have been saved, they will begin to work for your server. 
<br />
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/server-usage/edit-main-phpini&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/server-usage/edit-main-phpini'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD04NSZpZD0yODY1JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="e91bedbb50210d5abfa2e2378ae461e3" value="1" />	</div>
	</form>
<!-- <br />
...
<a name='comments'></a>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/493c95714f0ecfb8de597e2d43fa933d?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/493c95714f0ecfb8de597e2d43fa933d'>Joseph Nguyen</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-08 3:15 am</div>
				                <div>It's enough!</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15990);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-21277'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/f59f71a50d34e41f61c72c61cb093b1b?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/f59f71a50d34e41f61c72c61cb093b1b'>Carl</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-03 6:25 pm</div>
				                <div>No need. Worked well for me.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21277);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-30695'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/a43801f24e9860945aa1f9927cf24b49?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/a43801f24e9860945aa1f9927cf24b49'>Mohamed</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-02-19 4:48 pm</div>
				                <div><p>after doing everything and try to save it says&nbsp;&nbsp;Permission denied, any ideas?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30695);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-02-19 5:47 pm</div>
				                <div>Hello Mohamed,<br />
<br />
It means that your user does not have permissions to edit the file you are attempting to save.<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30696);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
