<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:54415:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/email/transferring-web-and-email-domain-to-inmotion" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Rfoszcz, Thanks for the question! Moving email accounts to a new host isn't always a straightforward issue. It will depend on how the client was s..." />
  <title>Transferring Web and Email domain to InMotion | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/email/transferring-web-and-email-domain-to-inmotion" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:d5dff40cbbdc6cd0dac41e35a8e21927 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Transferring Web and Email domain to InMotion</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='http://graph.facebook.com/rusty.foszcz/picture?type=normal' class='user_avatar' /><br />
			<a href='/support/community-support/users/rfoszcz'>rfoszcz</a>
			<div>13 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-04-19 7:36 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>991</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>A client of mine is transferring both their domain and email services to InMotion. No problem with the website - we change the NS records and we're OK.<br />
<br />
However, the email is hosted by ATT / Yahoo and we want to move the email accounts to InMotion for the domain. Because web services and email services are split for this client, I'm assuming we need to change the MX record at the registering agent site to reflect the fact that email will be hosted at InMotion and not at ATT. Am I correct there?<br />
<br />
...
<br />
Appreciate any input if people have migrated their mail domain from ATT to InMotion.</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_2929' id='upvote_answer_2929' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='2929' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_2929').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_2929' id='downvote_answer_2929' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='2929' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_2929').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Rfoszcz,<br />
<br />
Thanks for the question!  Moving email accounts to a new host isn't always a straightforward issue.  It will depend on how the client was setup previously.  If you change the name servers for the domain name,  the DNS settings (including the MX server settings) will NOT transfer over.  So, any email that was previously going to the old server is not going there anymore.  Mail will be routed to the new server, unless you make DNS changes in our servers here to re-direct the email.  <br />
<br />
Email accounts unfortunately do NOT just transfer, you will actually have to create the accounts in the cPanel here.  If you need more information on migrating your email check out this article:<br />
<br />
<a href="http://www.inmotionhosting.com/support/email/general-information/transferring-emails-from-your-old-host-to-inmotion-hosting" target="new">Transferring emails from your old host</a><br />
<br />
The DNS settings that will be created here are set (by default) to use our email server here.  So, to answer your question,  no you will not need to make any DNS changes for the MX server.  Remember that any DNS change <a href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/domain-names-dns-changes" target="new">may require up to 24 hours of propagation time.  </a><br />
<br />
...
Community Support
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_2929').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_2929' id='form_comment_on_answer_2929' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>You made my life much easier - especially if I don't have to worry about the MX record. All of the email accounts are already POP so they'll have all mail locally. If they just access mail during the propagation stage via the webmail interface until the propagation is complete we should be fine.<br />
<br />
Is it possible to predefine the email addresses on InMotion prior to changing the NS records? There's about 25 or so.</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='http://graph.facebook.com/rusty.foszcz/picture?type=normal' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/rfoszcz'>rfoszcz</a><br />
									13 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2013-04-19 8:04 pm EST
								</div>
				...
				<div style='padding:15px 15px 15px 76px; border:1px solid #ddd; border-top:0px; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello Rfoszcz,<br />
<br />
Yes, you can pre-define email addresses prior to changing the NS records.  The main thing though is that emails will not come to the account until AFTER the propagation has completed .    Emails will continue delivering to the old email until the MX records change to the new address.   After the propagation occurs, then emails being sent will see the new MX records and will be delivered to that new server (the email server here).  <br />
<br />
Make sure to read the bottom of the article I sent you if you're interested in trying to avoid. It details how not to lose emails during propagation time after a Nameserver change.<br />
<br />
<a href="http://www.inmotionhosting.com/support/email/general-information/transferring-emails-from-your-old-host-to-inmotion-hosting  " target="new">Migrating emails.</a>    <br />
<br />
If you have any further questions, please contact technical support or post another comment here.<br />
<br />
Regards,<br />
<br />
Arnel C.<br />
Community Support</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/email/transferring-web-and-email-domain-to-inmotion&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/email/transferring-web-and-email-domain-to-inmotion'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="7fcff01b4ff291db0457d94199a93e81" value="1" />	</div>
	</form>
<!-- <br />
