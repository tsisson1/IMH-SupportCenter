<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:60624:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/drupal-7/menus/disable-secondary-menu" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-07-17T16:36:42-07:00" />
  <meta name="keywords" content="Drupal 7 disable turn off theme secondary menu" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="This Drupal 7 tutorial demonstrates how to disable the secondary menu for a theme" />
  <title>How to disable the secondary menu in a Drupal 7 theme - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/drupal-7/menus/disable-secondary-menu" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:eccb5202ef73056c6d97957c5de7e207 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '195.68.126.94']);
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
				<img src='/support/images/stories/drupal-partner/supporting-partner-80_3.png' style='float:right; margin:0px 0px 15px 15px;' alt='Drupal Association Support Partner'>		<h1>
															How to disable the secondary menu in a Drupal 7 theme									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>8,362</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jun 21, 2012'><span style='color:#606060;'>Published:</span> Jul 17, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>You may want to hide the secondary menu that appears on the site pages of your themes. This can be done by either using the global setting or by individual themes in the Drupal 7 admin dashboard. This tutorial guides you through setting the global setting. Note that not all themes offer global setting support, so it may be necessary to set the same setting in the individual theme setting if the global setting does not work. Hiding or disabling the secondary menu is very simple in Drupal 7 and can be done by following these instructions.</p>
<p><strong>How to hide the secondary menu in Drupal 7:</strong></p>
...
<li>This brings you to the main <strong>Appearance </strong>page. You will see <strong>Global Settings </strong>followed by the name of all enabled themes as a top menu bar. To set the option globally, click on the <strong>Global Settings</strong> option. To set it for a particular theme, simply click on the name of  the desired theme. This will bring you to the settings page.</li>
<li>Locate the <strong>Toggle Display</strong> section on the page. Find the <strong>Secondary Menu</strong> setting. Simply click the checkbox to disable it. There should no longer be a check in the box.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Appearance/appearance-toggle-secondary-menu.png"><img  alt="appearance-toggle-secondary-menu" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Appearance/appearance-toggle-secondary-menu.png" /></a></li>
<li>Click on the Save <strong>Configuration </strong>button at the bottom of the page to save the change. Below is a before and after comparison to demonstrate the effect of disabling the secondary menu. In the before screenshot the red arrow shows you the location of the menu within this particular theme.<br /> 
...
<tr>
<td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Appearance/Theme/disable-secondary-menu-before.png"><img style="max-width: 250px;"  alt="disable-secondary-menu-before" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Appearance/Theme/disable-secondary-menu-before.png" /></a></td>
<td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Appearance/Theme/disable-secondary-menu-after.png"><img style="max-width: 250px;"  alt="disable-secondary-menu-after" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Appearance/Theme/disable-secondary-menu-after.png" /></a></td>
</tr>
</tbody>
</table>
</li>
</ol>
<p>That is how you turn off the Secondary menu for a theme in Drupal 7!</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 8: How to disable the secondary menu in a Drupal 7 theme</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 7: <a href='/support/edu/drupal-7/menus/disable-main-menu'>How to disable the main menu in a Drupal 7 theme</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/drupal-7/menus/disable-secondary-menu&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/drupal-7/menus/disable-secondary-menu'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yMDQmaWQ9MTUwNCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="e53e69966a9c416078547e8afa3efbff" value="1" />	</div>
	</form>
<!-- <br />
