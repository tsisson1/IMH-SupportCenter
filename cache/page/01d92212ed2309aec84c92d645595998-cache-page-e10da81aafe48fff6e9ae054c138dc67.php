<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:71009:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/email/fighting-spam/create-custom-spf" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-04-23T20:02:37-07:00" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Learn how to construct your own custom SPF records." />
  <title>Creating custom SPF records - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/email/fighting-spam/create-custom-spf" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:f3a2ff8452b7ceacb2d89f5828635299 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '88.217.226.9']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Creating custom SPF records</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Creating custom SPF records									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>11,617</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Apr 23, 2014'><span style='color:#606060;'>Published:</span> Apr 23, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>When working with <a href="/support/email/fighting-spam/spf-records-guide">SPF records</a> to prevent spoofing, most customers use the default records <a href="/support/email/fighting-spam/create-spf-cpanel">created via the cPanel</a>. You may, however, want to create a custom SPF record for your domain. These can be set through the Web Host Manger (WHM) on your <a href="http://www.inmotionhosting.com/vps-hosting">VPS</a> or <a href="http://www.inmotionhosting.com/dedicated-servers">Dedicated server</a> account. Also, if you are on a shared account, you can either customize existing or create new SPF records using the Advanced DNS Zone editor. No matter how you decide to create it, you will need to understand the various settings to create a proper records. This article goes over the settings that can be in an SPF record so  you can create one to fit your needs.</p>

<p>When creating a custom SPF record you want to be sure that you allow all the servers you need to send email and properly deal with any 'falsely sending' servers. This is done by using settings known as '<em>mechanisms</em>'. Each mechanism uses a prefix in order to tell the receiving server how to deal with any sending server that qualifies for that mechanism.</p>

<h2>Qualifiers</h2>
<p>There are four qualifiers that can be used to determine how a mechanism handles an email. These qualifiers precede a mechanism and declare how any server that matches them is dealt with.</p>

  <table class="article_table" style="width:100%">
    <tr>
      <td> + </td><td>Pass</td><td>Allowed</td>
    </tr>
    <tr>
      <td> - </td><td>Fail</td><td>Rejection</td>
    </tr>
    <tr>
      <td> ~ </td><td>SoftFail</td><td>Allowed, but marked</td>
    </tr>
    <tr>
      <td> ? </td><td>Neutral</td><td>Allowed</td>
    </tr>
  </table>
<p>For example, a record that has '+a' will allow all IP addresses that match the a mechanism to pass through, while '-a' will fail all IP addresses that match the mechanism. As you can see, three out of the four will still allow an email through so it is important to use the right qualifier in front of your chosen mechanisms. What are the mechanisms? We are glad you asked! They are described below.</p>


<h2>Mechanisms</h2>
<p>There are several mechanisms you may want to include in your SPF record. Only include the mechanisms that are necessary and end the SPF record with the '<em>all</em>' mechanism as it will catch all other servers that do not fall into the others.</p>

<h3>The 'a' Mechanism</h3>
<strong>Syntax</strong><br />
<div class="code_block" style="width:350px">
a<br />
a:&lt;domain&gt;<br />
a/&lt;prefix-length&gt;<br />
a:&lt;domain&gt;/&lt;prefix-length&gt;
</div>
<p>This mechanism allows all IP addresses associated with the domain's <em>a</em>' records to send email. The IP must be an exact match unless a range is used.</p>
  <div class="code_block" style="background-color: Wheat; padding-top:5px; padding-bottom:5px; padding-right:5px; padding-left:5px;"><strong>Examples:</strong><br />
    "v=spf1 a -all"<br />
    The current-domain is used. All IPs under the A records match.<br /><br />

    "v=spf1 a:example.com -all"<br />
    This is equivalent to the above example if the current-domain is example.com.<br /><br />

    "v=spf1 a:mail.example.com -all"<br />
    Useful if the domain has chosen to list all the outbound mailers in a special A record<br /> under the name mail.example.com.
  </div>


<h3>The 'all' Mechanism</h3>
<strong>Syntax</strong><br />
<div class="code_block" style="width:350px">
all
</div>
<p>The '<em>all</em>' mechanism is the catch-all setting that should be placed at the end of the SPF record. All servers will match this setting.</p>
  <div class="code_block" style="background-color: Wheat; padding-top:5px; padding-bottom:5px; padding-right:5px; padding-left:5px;"><strong>Examples:</strong><br />
    "v=spf1 mx -all"<br />
    Allows a domain's MX records to send mail for the domain. All others will fail.<br /><br />

    "v=spf1 -all"<br />
    This is used for domains that no mail whatsoever.<br /><br />

    "v=spf1 +all"<br />
    Allows all domains to pass. NOT RECOMMENDED!<br />
  </div>


<h3>The 'exists' Mechanism</h3>
<strong>Syntax</strong><br />
<div class="code_block" style="width:350px">
exists:&lt;domain&gt;
</div>
<p>This mechanism does a lookup for '<em>a</em>' records for the domain named. All records that match that domain will match.</p>
  <div class="code_block" style="background-color: Wheat; padding-top:5px; padding-bottom:5px; padding-right:5px; padding-left:5px;"><strong>Examples:</strong><br />
    "v=spf1 exists:example.com -all"<br />
    If example.com resolves this mechanism will pass. It will fail if the domain does not <br />resolve.
  </div>

<h3>The 'includes' Mechanism</h3>
<strong>Syntax</strong><br />
<div class="code_block" style="width:350px">
include:&lt;domain&gt;
</div>
<p>Domains listed in this mechanism will be searched for a match. If the lookup provides neither a match nor an error, it will continue to evaluate the next directive.</p>
  <div class="code_block" style="background-color: Wheat; padding-top:5px; padding-bottom:5px; padding-right:5px; padding-left:5px;"><strong>Examples:</strong><br />
      "v=spf1 include:example.com, example2.com -all"<br />
      A records from either example.com or example2.com will match. Care must be used when <br />adding additional domains. If they have no SPF records themselves, this opens you up to <br />passing spoofed emails from those insecure domains.  
  </div>


<h3>The 'ip4' Mechanism</h3>
<strong>Syntax</strong><br />
<div class="code_block" style="width:350px">
ip4:&lt;ip4-address&lt;<br />
ip4:&lt;ip4-network-address&lt;/&lt;prefix-length&lt;
</div>
<p>Any IP address listed for this mechanism will match. You can use individual IPs or IP ranges as well.</p>
  <div class="code_block" style="background-color: Wheat; padding-top:5px; padding-bottom:5px; padding-right:5px; padding-left:5px;"><strong>Examples:</strong><br />
      "v=spf1 ip4:123.123.123.123 -all"<br />
      Only IP address 123.123.123.123 will mach.<br /><br />

      "v=spf1 ip4:123.123.0.1/16 -all"<br />
      Allow any IP address between 123.123.0.1 and 123.123.255.255.
  </div>

<h3>The 'ip6' Mechanism</h3>
<strong>Syntax</strong><br />
<div class="code_block" style="width:350px">
ip4:&lt;ip6-address&gt;<br />
ip4:&lt;ip6-network-address&lt;/&lt;prefix-length&gt;
</div>
<p>Just like the ipv4 mechanism, any IP listed in this mechanism will match. It can also use either individual IPs or ranges.</p>
  <div class="code_block" style="background-color: Wheat; padding-top:5px; padding-bottom:5px; padding-right:5px; padding-left:5px;"><strong>Examples:</strong><br />
    "v=spf1 ip6:1080::8:800:68.0.3.1/96 -all"<br />
    Allow any IPv6 address between 1080::8:800:0000:0000 and 1080::8:800:FFFF:FFFF.
  </div>

<h3>The 'mx' Mechanism</h3>
<strong>Syntax</strong><br />
<div class="code_block" style="width:350px">
mx<br />
mx/&lt;prefix-length><br />
mx:&lt;domain&gt;<br />
mx:&lt;domain&gt;/&lt;prefix-length&gt;<br />
</div>
<p>A lookup for all IPs used in the MX record settings is performed. If it matches any of the IPs in the MX record list, it will pass.</p>
  <div class="code_block" style="background-color: Wheat; padding-top:5px; padding-bottom:5px; padding-right:5px; padding-left:5px;"><strong>Examples:</strong><br />
    "v=spf1 mx -all"<br />
    Allows all IP addresses for the MX records with the domain.<br /><br />

    "v=spf1 mx mx:example2.com -all"<br />
    In this example a domain sends mail through its own MX servers plus other servers <br />for a second domain.
  </div>


<h3>The 'ptr' Mechanism</h3>
<strong>Syntax</strong><br />
<div class="code_block" style="width:350px">
ptr
ptr:&lt;domain&gt;
</div>
<p>The Client IPs hostnames are checked with PTR lookups. If at least one of the hostnames match the original client IP, it will pass.</p>

  <div class="code_block" style="background-color: Wheat;"><strong>Examples:</strong><br />
    "v=spf1 ptr -all"<br />
    A domain that controls all its servers allows them all to send mail. <br />One example may be hotmail.com<br /><br />

    "v=spf1 ptr:example2.com -all"<br />
    Any server whose hostname ends in example2.com will pass. 
  </div>


<h2>Putting it all together</h2>
<p>After evaluating the different mechanisms to decide what you need for your SPF record, you are ready to create it. Be sure to make it as small as possible. It is not necessary to more mechanisms involved than you need.</p>

<p>The SPF syntax must begin with the spf version. The currently most accepted and secure version is version 1. Begin your record syntax with the code below.</p>
<div class="code_block" style="width:350px">
  "v=spf1"
</div>
<br />
<p>Next you will add any of the mechanisms you decide apply to your particular situation. Including +a, +mx, and +ip4:###.###.###.### will be sufficient for most setups. This is particularly true  for those that use their hosting server to send email, as is our default here at Inmotion.  Add them after the version. Keep in mind the record is evaluated left to right, so place the higher priority ones on the left.</p>
<div class="code_block" style="width:350px">
  "v=spf1 +a +mx +ip4:123.123.123.123"
</div>
<br />
<p>Lastly, it is HIGHLY recommended to end the record with an '<em>all</em>' mechanism. This handles any servers that have not yet passed any of the previous mechanisms in the list. To help prevent spoofing, it is also recommended to use the '-' qualifier to cause any check against this mechanism to be rejected with a hard fail.</p>
<div class="code_block" style="width:350px">
  "v=spf1 +a +mx +ip4:123.123.123.123 -all"
</div>  
<br />
<p>Once you have your syntax prepared, you can enter it in your DNS entries either with your <a href="/support/email/fighting-spam/create-spf-record-whm">WHM</a> or the Advanced DNS Zone editor.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/email/fighting-spam/create-custom-spf&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/email/fighting-spam/create-custom-spf'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NiZpZD0zMjE1JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="106bb447a700895141ad86ba78b1d2dd" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/b621c2a3b9bd1f0b26cc9e187a05a769?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/b621c2a3b9bd1f0b26cc9e187a05a769'>Rajenra Yadav</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-23 10:29 am</div>
				                <div><p>hi</p>
<p>give me exist domain list...how to find spf pass exist domain.</p>
<p>&nbsp;</p>
<p>plz healp</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22889);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-23 10:54 am</div>
				                <div>Hello Rajenra,<br />
<br />
Thank you for contacting us. Unfortunately, it is not clear what you are trying to accomplish. Could you provide more information?<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22890);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-27 9:21 am</div>
				                <div><div dir="ltr">
<p>Hi sirI never seen the&nbsp; The 'exists' Mechanism domain.</p>
<p><strong>Examples:</strong> "v=spf1 exists:<a href="http://example.com" target="_blank">example.com</a> -all" like..Just i wan a this domain 2 or more.. just purpose of study.Please give me any domain which is i seen...in DNS watch..</p>
</div></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22975);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-27 5:03 pm</div>
				                <div>Hello Rajenra,<br />
<br />
The 'exists' setting is rarely used. I do not have any 'live' examples, but you can learn all about SPF records at the <a href="http://www.openspf.org/">official SPF site</a>.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23001);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
