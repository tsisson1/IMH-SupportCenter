<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:62253:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/drupal-7/working-with-images/remove-label-field" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-07-26T20:19:51-07:00" />
  <meta name="keywords" content="remove image label Drupal 7" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Learn how to remove the label on an image field that was added to different content types in Drupal 7." />
  <title>How to remove the label from an image field in Drupal 7 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/drupal-7/working-with-images/remove-label-field" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:877433bcc4ba01951a6487ac9606f367 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '197.211.53.34']);
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
				<img src='/support/images/stories/drupal-partner/supporting-partner-80_3.png' style='float:right; margin:0px 0px 15px 15px;' alt='Drupal Association Support Partner'>		<h1>
															How to remove the label from an image field in Drupal 7									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>7,915</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jul 26, 2012'><span style='color:#606060;'>Published:</span> Jul 26, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>When you add an image field to a content type, that field will display a label by default. For instance, if you named the field 'image' then just above the picture you upload will be the word 'IMAGE'. This may not be something you want to display on your pages. Drupal does have a way to turn off the field setting, or hide it, so that it does not display above the image. You can hide the label for an image field in Drupal 7 by following the steps below.</p>
<p><b>Removing the label from an Image field in Drupal 7</b></p>
...
<li>On the <strong>Content Types</strong> page, find the type of content you want to work with. I have been working with <strong>Basic Pages</strong> so I will stick with that. After locating your desired content type, click on the correct<strong> Manage Display</strong> link.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Content_Types/content-manage-display.png"><img  alt="content-manage-display" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Content_Types/content-manage-display.png" /></a></li>
<li>From this page you will need to find the image row and then the Label dropdown. Set the Label field to &lt;Hidden&gt; to remove the label from the image field. <br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Content_Types/image-hide-label.png"><img  alt="image-hide-label" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Content_Types/image-hide-label.png" /></a></li>
<li>Once finished, click on the Save button at the bottom. From the before and after images below, you can see how the label is no longer displaying for the image field.<br /> 
...
<tr>
<td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Content_Types/image-label-before.png"><img style="max-width: 250px;"  alt="image-label-before" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Content_Types/image-label-before.png" /></a></td>
<td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Content_Types/image-label-after.png"><img style="max-width: 250px;"  alt="image-label-after" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Content_Types/image-label-after.png" /></a></td>
</tr>
</tbody>
</table>
</li>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 12: How to remove the label from an image field in Drupal 7</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 11: <a href='/support/edu/drupal-7/working-with-images/change-preview-style'>How to modify image preview style in Drupal 7 </a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/drupal-7/working-with-images/remove-label-field&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/drupal-7/working-with-images/remove-label-field'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNDEmaWQ9MTYyNSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="c540a4e367f27d734b4d5b7fbe8b7f40" value="1" />	</div>
	</form>
<!-- <br />
