<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:60386:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/moodle/creating-courses/editing-course-settings-moodle" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-10-18T13:05:33-07:00" />
  <meta name="keywords" content="Editing Course Settings courses updated  mistakes mistake update Setting" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="The course settings may need to be updated due to restructuring the classes or when mistakes where made when setting up the course. This article will explain how to update the course settings in Moodle 2.3.2." />
  <title>How do I edit the Course Settings in Moodle - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/moodle/creating-courses/editing-course-settings-moodle" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:f74fe23234feb3c70c28deb8474e4254 -->
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/moodle' itemprop='url'><span itemprop='title'>Moodle<span></a><div class='dropdown_4columns'><h2>Moodle Education Channel</h2><div class='col_2'><h3>100 Level Classes</h3><div><a href='/support/edu/moodle/new-to-moodle'>101: Getting Started with Moodle</a></div><div><a href='/support/edu/moodle/creating-courses'>102: Creating Courses in Moodle</a></div><div><a href='/support/edu/moodle/activity-resource'>103: Adding an activity or resource to a course in Moodle</a></div><div><a href='/support/edu/moodle/create-restore-backup'>104: Creating and restoring backups in Moodle</a></div><div><a href='/support/edu/moodle/question-bank'>104: Working with the Question Bank</a></div><div><a href='/support/edu/moodle/user-roles-moodle'>105: User Accounts and Permissions in Moodle</a></div><div><a href='/support/edu/moodle/moodle-grading-reports'>106: Moodle Grading and Reports</a></div><div><a href='/support/edu/moodle/changing-appearance-moodle'>107: Changing the Appearance of Moodle</a></div><div><a href='/support/edu/moodle/moodle-plugins'>108: Managing Moodle Plugins</a></div><div><a href='/support/edu/moodle/additional-moodle-features'>109: Additional Moodle features</a></div></div><div class='col_2'><h3>200 Level Classes</h3><div><a href='/support/edu/moodle/moodle-site-security'>201: Moodle site security and server settings</a></div><div><a href='/support/edu/moodle/custom-moodle-reports'>202: Making Custom Moodle Reports</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/moodle/creating-courses' itemprop='url'><span itemprop='title'>102: Creating Courses in Moodle<span></a><div class='dropdown_3columns'><h2> Creating Courses in Moodle</h2><div class='col_3'><div>1. <a style='display:inline;' href='/support/edu/moodle/creating-courses/creating-courses-in-moodle'>How to create courses in Moodle</a></div><div>2. <a style='display:inline;' href='/support/edu/moodle/creating-courses/editing-course-settings-moodle'>How do I edit the Course Settings in Moodle</a></div><div>3. <a style='display:inline;' href='/support/edu/moodle/creating-courses/moodle-course-settings'>What are the Moodle Course settings?</a></div><div>4. <a style='display:inline;' href='/support/edu/moodle/creating-courses/understanding-course-formats'>Moodle Course Formats - SCORM / Social / Topics / Weekly</a></div><div>5. <a style='display:inline;' href='/support/edu/moodle/creating-courses/edit-sections-topic-weekly-social'>Editing the sections for Topic, Weekly, and Social  Formatted courses.</a></div><div>6. <a style='display:inline;' href='/support/edu/moodle/creating-courses/course-defaults'>Changing the Course defaults in Moodle</a></div><div>7. <a style='display:inline;' href='/support/edu/moodle/creating-courses/creating-categories-moodle'>How to create and edit categories in Moodle</a></div><div>8. <a style='display:inline;' href='/support/edu/moodle/creating-courses/courses-categories-moodle'>How to set a Course to a specific Category in Moodle</a></div><div>9. <a style='display:inline;' href='/support/edu/moodle/creating-courses/delete-category'>Removing and deleting Categories in Moodle</a></div><div>10. <a style='display:inline;' href='/support/edu/moodle/creating-courses/editing-news-forum'>How to edit the News Forum in a Moodle Course</a></div><div>11. <a style='display:inline;' href='/support/edu/moodle/creating-courses/adding-forum-post'>Adding posts to the News Forum in Moodle</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How do I edit the Course Settings in...</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How do I edit the Course Settings in Moodle									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>1,538</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Oct 15, 2012'><span style='color:#606060;'>Published:</span> Oct 18, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Now that courses are created for your Moodle site from the last article on "<a target="_blank" href="/support/edu/moodle/creating-courses/creating-courses-in-moodle" title="Click here for more information">How to create courses in Moodle</a>", the course settings may need to be updated due to restructuring the classes or when mistakes where made when setting up the course. This article will explain how to update the course settings in Moodle 2.3.2.</p>
<p><strong>Editing the Course Settings</strong></p>
<ol class="article_list">
<li><a target="_blank" href="/support/edu/moodle/new-to-moodle/moodle-login-administrator">Log into the Moodle Dashboard</a>.</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/102/create-courses/creating-courses-in-moodle-available-courses.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="creating-courses-in-moodle-available-courses" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/102/create-courses/creating-courses-in-moodle-available-courses.gif" /></a> Click <strong>home</strong> in the navigation section on the left to show the available courses. Select the Course that requires different settings.<br style="clear: both;" /> <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/102/create-courses/creating-courses-in-moodle-view-course.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="creating-courses-in-moodle-view-course" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/102/create-courses/creating-courses-in-moodle-view-course.gif" /></a>
<p>The course will look similar to the following screenshot.</p>
<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/102/create-courses/creating-courses-in-moodle-edit-settings.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="creating-courses-in-moodle-edit-settings" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/102/create-courses/creating-courses-in-moodle-edit-settings.gif" /></a> Click <strong>Edit settings</strong> and the <strong>Edit course settings</strong> page for the course will load. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/102/course-settings/editing-course-settings-save.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="editing-course-settings-save" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/102/course-settings/editing-course-settings-save.gif" /></a>Next you should see the <strong>Edit Course Settings</strong> page. This is where the Course Settings can be edited. Edit the Settings to the specifications need and click <strong>Save Changes</strong>. <br style="clear: both;" /></li>
</ol>
<p>This concludes the tutorial for editing the Course Settings. Please see our next article on <a target="_blank" href="/support/edu/moodle/creating-courses/moodle-course-settings" title="Click here to view the next article">What are the Moodle Course settings?</a>. For more information creating courses, please visit our education channel on <a target="_blank" href="/support/edu/moodle/creating-courses" title="Click here to view the courses">Creating Courses in Moodle</a></p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/moodle/creating-courses'>102: Creating Courses in Moodle</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 2: How do I edit the Course Settings in Moodle</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 1: <a href='/support/edu/moodle/creating-courses/creating-courses-in-moodle'>How to create courses in Moodle</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 3: <a href='/support/edu/moodle/creating-courses/moodle-course-settings'>What are the Moodle Course settings?</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/moodle/creating-courses/editing-course-settings-moodle&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/moodle/creating-courses/editing-course-settings-moodle'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yODAmaWQ9MTg2OSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="ecf688dbf3671753898b778b13b68414" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/moodle/creating-courses?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Creating Courses in Moodle</h3></a>
		<table><tr><td colspan='2'><h4>Creating Courses</h4></td></tr>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/moodle/creating-courses/creating-courses-in-moodle?tsrc=rsbedu'>How to create courses in Moodle</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/moodle/creating-courses/editing-course-settings-moodle?tsrc=rsbedu'>How do I edit the Course Settings in Moodle</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/moodle/creating-courses/moodle-course-settings?tsrc=rsbedu'>What are the Moodle Course settings?</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/moodle/creating-courses/understanding-course-formats?tsrc=rsbedu'>Moodle Course Formats - SCORM / Social / Topics / Weekly</a></td>
                </tr>
          <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/moodle/creating-courses/edit-sections-topic-weekly-social?tsrc=rsbedu'>Editing the sections for Topic, Weekly, and Social  Formatted courses.</a></td>
                </tr>
          <tr >
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/moodle/creating-courses/course-defaults?tsrc=rsbedu'>Changing the Course defaults in Moodle</a></td>
                </tr>
        <tr><td colspan='2'><h4>Course Categories</h4></td></tr>  <tr >
                        <td valign='top'>7.</td>
                        <td><a href='/support/edu/moodle/creating-courses/creating-categories-moodle?tsrc=rsbedu'>How to create and edit categories in Moodle</a></td>
                </tr>
          <tr >
                        <td valign='top'>8.</td>
                        <td><a href='/support/edu/moodle/creating-courses/courses-categories-moodle?tsrc=rsbedu'>How to set a Course to a specific Category in Moodle</a></td>
                </tr>
          <tr >
                        <td valign='top'>9.</td>
                        <td><a href='/support/edu/moodle/creating-courses/delete-category?tsrc=rsbedu'>Removing and deleting Categories in Moodle</a></td>
                </tr>
        <tr><td colspan='2'><h4>The Course News Forum</h4></td></tr>  <tr >
                        <td valign='top'>10.</td>
                        <td><a href='/support/edu/moodle/creating-courses/editing-news-forum?tsrc=rsbedu'>How to edit the News Forum in a Moodle Course</a></td>
                </tr>
          <tr >
                        <td valign='top'>11.</td>
                        <td><a href='/support/edu/moodle/creating-courses/adding-forum-post?tsrc=rsbedu'>Adding posts to the News Forum in Moodle</a></td>
                </tr>
          	</table>
