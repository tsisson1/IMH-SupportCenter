<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:61405:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/boldgrid/installing-boldgrid/view-connect-key" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-05-09T13:22:18-07:00" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Your Boldgrid connect key is needed to activating different features. Learn how to locate it in your AMP in this tutorial." />
  <title>How to get to Your BoldGrid Connect Key - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/boldgrid/installing-boldgrid/view-connect-key" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<script type="text/javascript">
		...
		_gaq.push(['_setCustomVar', 4, 'DateMonthPublished', '2015-11', 3]);
	...
	<!-- cid:699f51a05dddfbe25c2a80f72b7c7d30 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to get to Your BoldGrid Connect Key									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>1,989</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Nov 19, 2015'><span style='color:#606060;'>Published:</span> May 9, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<p class="alert alert-danger">Before you can follow the directions below for the Connect Key make sure that <b>BoldGrid</b> has been installed</p>

<p>When working with BoldGrid, you will need a unique connect key. This key identifies your account and is used to activate the BoldGrid suite. It also is used in conjunction with your BoldGrid Coins account. If you install BoldGrid using the installation tool in the AMP (Account Management Panel) you likely will not even see the key during the process. But, if you do a manual install you will need to find it. Below we show you how to find it within your AMP.</p>

<h2>Finding Your BoldGrid Connect Key</h2>

<ol class="article_list">
  <li><a href="/support/website/amp/how-to-log-into-amp">Log into your AMP (Account Management Panel) dashboard</a>.<div style="clear:both;"></div></li>
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/boldgrid/find-connect-key/01-click-boldgrid-icon.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="Click the BoldGrid icon." src="//cdn.inmotionhosting.com/support/images/stories/boldgrid/find-connect-key/01-click-boldgrid-icon.png" title="Click here to view the larger image" width="200" /></a> Look under the <em>Manage My Account</em> section and click on the <strong>Manage BoldGrid</strong> icon.<div style="clear:both;"></div></li>
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/boldgrid/find-connect-key/02-click-view-connect-key.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="Click the View Connect Key link." src="//cdn.inmotionhosting.com/support/images/stories/boldgrid/find-connect-key/02-click-view-connect-key.png" title="Click here to view the larger image" width="200" /></a> On the <em>Manage BoldGrid</em> page, locate and click on the <strong>View Connect Key</strong> link.<div style="clear:both;"></div></li>
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/boldgrid/find-connect-key/03-key-popup.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="BoldGrid Connect Key Popup." src="//cdn.inmotionhosting.com/support/images/stories/boldgrid/find-connect-key/03-key-popup.png" title="Click here to view the larger image" width="200" /></a> A popup will appear that contains your BoldGrid Connect Key.<div style="clear:both;"></div></li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 5: How to get to Your BoldGrid Connect Key</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 6: <a href='/support/edu/boldgrid/installing-boldgrid/boldgrid-staging-with-existing-site'>Using BoldGrid with an existing WordPress Site</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/boldgrid/installing-boldgrid/view-connect-key&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/boldgrid/installing-boldgrid/view-connect-key'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD01MzYmaWQ9MzY4NCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/3856885cb0b81a9853cf202aa04eb9b8?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/3856885cb0b81a9853cf202aa04eb9b8'>Peter</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-02 11:26 am</div>
				                <div><p>If Boldgrid does not appear under "Manage My Account" - does that mean I cannot get Boldgrid? - is it free for existing customers?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31652);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-04 3:37 pm</div>
				                <div>That icon should appear after you install BoldGrid from the Install Popular Software option in your AMP.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31690);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
