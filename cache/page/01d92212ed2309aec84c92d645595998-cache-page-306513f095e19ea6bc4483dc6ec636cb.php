<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:68340:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-25/how-to/enable-debug-system" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-07-21T17:01:04-07:00" />
  <meta name="keywords" content="enable joomla 2.5 debug system session profile information memory usage number database queries" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="In this tutorial, we'll show you how to enable the Joomla 2.5 Debug System to help view data about your site's resource usage." />
  <title>How to enable the Debug System in Joomla 2.5 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-25/how-to/enable-debug-system" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:351c81de83425d53fdcb2bbe74624aea -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '122.176.82.67']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to enable the Debug System in Joomla 2.5									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>25,385</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Feb 24, 2012'><span style='color:#606060;'>Published:</span> Jul 21, 2015</div>
							...
							<div style='clear:both;'></div>
								...
								<p class="alert">Joomla 2.5 has reached its end of life as for 12/31/2014. Please be advised this may be a security risk to your website. You can view more information about the end of life <a href="https://docs.joomla.org/Joomla!_CMS_versions">here</a>.</p><br /><p>As with many applications that run on the internet, Joomla 2.5 can at times use excessive CPU time or memory. When websites use excessive server resources, it can cause the website to load slowly and can make the server unstable (which may result in a server crashing and websites going down). If you're faced with optimizing a Joomla website, the first thing you'll want to do is actually gather some data on how much CPU time and memory your site is using. The Joomla Debug System can help with this task, and below we'll show you how to enable Joomla 2.5 debugging.</p>
<p><strong>To enable the Joomla 2.5 Debug System:</strong></p>
<ol class="article_list">
<li><a href="/support/edu/joomla-25/getting-started/how-to-log-into-dashboard">Log into your Joomla dashboard</a></li>
<li>Click the <strong>Global Configuration icon</strong><br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/enable-system-debug/click-global-configuration.gif"><img  alt="click-global-configuration" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/enable-system-debug/click-global-configuration.gif" /></a></li>
<li>Click the <strong>System</strong> tab. Under <strong>Debug Settings</strong>, set <strong>Debug System</strong> to <strong>Yes</strong>. Then click <strong>Save</strong><br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/enable-system-debug/set-debug-system-to-yes.gif"><img  alt="set-debug-system-to-yes" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/enable-system-debug/set-debug-system-to-yes.gif" /></a></li>
</ol>
<p>The Joomla 2.5 Debug System is now enabled! If you visit your website now, at the bottom of the page you'll see a list of options you can click on to see more information:</p>
...
<tbody>
<tr>
<th>Before enabling the Debug System</th> <th>After enabling the Debug System</th>
</tr>
<tr>
<td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/enable-system-debug/before_joomla_debug.gif"><img style="max-width: 250px;"  alt="before_joomla_debug" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/enable-system-debug/before_joomla_debug.gif" /></a></td>
<td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/enable-system-debug/after_joomla_debug.gif"><img style="max-width: 250px;"  alt="after_joomla_debug" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/enable-system-debug/after_joomla_debug.gif" /></a></td>
</tr>
</tbody>
</table>
<p>Viewing your current server resource usage is only the first step in optimizing a Joomla 2.5 website. In future articles, we will explain further upon what you can do to help Joomla run more efficiently.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/joomla-25/how-to'>208: Joomla 2.5 Configuration - How to questions</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 4: How to enable the Debug System in Joomla 2.5</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 3: <a href='/support/edu/joomla-25/how-to/configure-email-over-smtp'>How to configure Joomla 2.5 to send email using SMTP</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 5: <a href='/support/edu/joomla-25/how-to/change-timezone-in-error-log'>How to configure Joomla 2.5 error.php timezone</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-25/how-to/enable-debug-system&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-25/how-to/enable-debug-system'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xOTYmaWQ9MTE4NSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="8360e18f6b619db8ee6cab97bd895217" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/joomla-25/how-to?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Joomla 2.5 Configuration - How to questions</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/joomla-25/how-to/configuration-settings?tsrc=rsbedu'>How can I view my Joomla 2.5 configuration.php settings?</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/joomla-25/how-to/change-timezone?tsrc=rsbedu'>How to change the timezone in Joomla 2.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/joomla-25/how-to/configure-email-over-smtp?tsrc=rsbedu'>How to configure Joomla 2.5 to send email using SMTP</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/joomla-25/how-to/enable-debug-system?tsrc=rsbedu'>How to enable the Debug System in Joomla 2.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/joomla-25/how-to/change-timezone-in-error-log?tsrc=rsbedu'>How to configure Joomla 2.5 error.php timezone</a></td>
                </tr>
          <tr >
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/joomla-25/how-to/maintenance-mode?tsrc=rsbedu'>How to put your Joomla 2.5 site in Maintenance Mode</a></td>
                </tr>
          	</table>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/5dfa14e651df07c64d756bcc291b73c5?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/5dfa14e651df07c64d756bcc291b73c5'>gail</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-19 12:11 pm</div>
				                <div><p>How do you turn it off if setting the debug no doesn't change it to off?</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9037);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-19 5:26 pm</div>
				                <div>&lt;div style=&quot;background-color: #FFF; padding-left: 10px;&quot;&gt;Hello gail,<br />
<br />
To turn off the Joomla debug system, you should just be able to select &lt;strong&gt;No&lt;/strong&gt; beside &lt;strong&gt;Debug System&lt;/strong&gt;.<br />
<br />
If that is not working for you, you might want to be sure to &lt;a href=&quot;http://www.inmotionhosting.com/support/edu/joomla-25/caching/clear-cache&quot; target=&quot;_blank&quot;&gt;clear the Joomla cache&lt;/a&gt; as well as &lt;a href=&quot;http://www.inmotionhosting.com/support/website/how-to/clear-browser-cache&quot; target=&quot;_blank&quot;&gt;clear your browser's cache&lt;/a&gt; to ensure that the setting is taking.<br />
<br />
If you're still having any issues at all, please let us know.<br />
<br />
- Jacob&lt;/div&gt;</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9045);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-19 6:34 pm</div>
				                <div><p>Actually had to reset the logging level.&nbsp;</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9046);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-19 7:59 pm</div>
				                <div>&lt;div style=&quot;background-color: #FFF; padding-left: 10px;&quot;&gt;Hello Gail,<br />
<br />
Thank you for letting us know! When you mention the &lt;strong&gt;logging level&lt;/strong&gt; are you talking about adjusting this in Joomla itself? As that option isn't available on the &lt;strong&gt;System&lt;/strong&gt; tab that this article walks through.<br />
<br />
- Jacob&lt;/div&gt;</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9049);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
