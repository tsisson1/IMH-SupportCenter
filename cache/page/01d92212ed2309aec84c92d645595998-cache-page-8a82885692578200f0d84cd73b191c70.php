<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:67786:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/how-do-i-make-custom-dns-records" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-05-02T16:17:48-07:00" />
  <meta name="keywords" content="advanced DNS MX CNAME custom change record simple dns editor a mx record change" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="In this tutorial we will explain how to make custom DNS changes." />
  <title>How do I make custom DNS records? - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/how-do-i-make-custom-dns-records" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:22b4e4aca86c885b75c2a189bd111726 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '71.72.5.1']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How do I make custom DNS records?</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How do I make custom DNS records?									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>51,863</span></div>
				...
				<iframe width='675' height='315' src='https://www.youtube.com/embed/lCGCGKI9x5M' frameborder='0' allowfullscreen style='margin-bottom:15px;'></iframe>
								...
								<p class="alert" style="color:red"><strong>Please note:</strong><br />In order to follow any of the steps in this tutorial, you must have a hosting account. If you have a domain name only account (IE you have only purchased a domain name but no hosting), you will not have access to cPanel in order to make any DNS changes.</p>
<a id="define-dns"></a>
<h2>What is DNS?</h2>
<div>DNS is the component of the Internet which converts human-readable domain names (example.com) into computer-readable IP addresses (208.77.188.166). It does this according to DNS zone files that reside on your server and tie domain names to IP addresses.</div>
<p><h2>What is a DNS Record?</h2><br />A DNS record points specific parts of your DNS to a domain or IP. For example, we have many users that subscribe to Google Apps. If you want to use Google's mail servers for your email instead of InMotion Hosting's, you will need to point your <strong>MX records</strong> to Google's mail servers. Google will provide you with these records. They also have a service you can use to point calendar.example.com to the Google Calendar application. This requires that you add "calendar" as a <strong>CNAME record</strong>, and Google will provide you with the necessary settings.</p>

<p><h2>How long do DNS changes Take?</h2><br />DNS changes can take up to 24 hours to take affect, or <a href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/domain-names-dns-changes" target="new"> propagate</a>. </p>


<h2>How do I see my DNS records?</h2>
<p>You can view most of your DNS records in the <strong><a href="/support/edu/cpanel/cpanel-manage-domains/advanced-dns-editor-cpanel" target="_blank">Advanced DNS Zone Editor</a></strong>, which is in cPanel under <em>Domains</em>.</p> Your MX records can be viewed in cPanel by clicking the <strong>MX Entry</strong> button under <em>Mail</em>.
<h2>How to add A and CNAME records</h2>
<h3>Shared Servers</h3>
  <p>To add <em>A and CNAME</em> records, you will need to access the, "Advanced DNS Zone Editor" within your cPanel. This feature is located within the, "<strong>Domains</strong>" section. Here is a link to the <a href="/support/edu/cpanel/cpanel-manage-domains/advanced-dns-editor-cpanel" target="_blank">full guide on using the Advanced DNS Editor</a>.</p>

<h3>VPS and Dedicated Servers</h3>
<p>If you are on a <a href="http://www.inmotionhosting.com/vps_hosting.html" target="_blank">Virtual Private Server</a> or Dedicated server, you also will have access to the&nbsp;<i>Advanced DNS Editor</i>. Not only will the Advanced DNS Editor allow you to add DNS records, but it will allow you to edit current records as well.</p>
<p>Instructions on adding A records and CNAME records in both cPanel and WHM can be found here:</p>
<ul>
<li><a href="/support/domain-names/dns-nameserver-changes/a-record-change">A Records</a></li>
<li><a href="/support/domain-names/dns-nameserver-changes/add-cname-record">CNAME Records</a></li>
</ul>
<h2>How to add MX records</h2>
<div style="padding: 10px;">To add a MX record, you will need to access the, "MX Entry" feature within your cPanel. This feature is located within the, "Mail" section. Please view our <a href="/support/edu/cpanel/cpanel-email/modfying-mx-records">MX records</a> article for more information.</div>
<h2>SPF and DomainKeys</h2>
<div style="padding: 10px;">SPF and DomainKeys are types of DNS records, and are tools used by many mail servers in an effort to combat spam. To find out more information on these types of records, please see the following page:<br /><a style="outline-style: none; outline-width: initial; outline-color: initial; color: #306090;" target="_new" href="https://support.inmotionhosting.com/cgi-bin/kb.cgi?do=read&amp;id=107">https://support.inmotionhosting.com/cgi-bin/kb.cgi?do=read&amp;id=107</a></div> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/how-do-i-make-custom-dns-records&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/how-do-i-make-custom-dns-records'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD02OCZpZD04NDImdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="eb769c88b465279243f631b9d3b05a97" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-02 2:44 pm</div>
				                <div><p>I added the Google mail servers, but left my domain as a back up with a priority of 11 for now to make sure the Google ones take. I added the Google SPF record as shown in the "included" section. But above my DKIM and SPF records section it says:</p>
<p>Warning: cPanel is unable to verify that this server is an authoritative nameserver for &ldquo;creationgraphx.com&rdquo;.</p>
<p>I do not know if this is because I still have creationgraphx.com still in my MX Records or if there is another issue. Can you please help so my mail does not bounce. </p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24595);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-02 3:09 pm</div>
				                <div>Hello Matt,<br />
<br />
Thank you for contacting us. This is a known bug within cPanel and can be disregarded. cPanel checks the local server for DNS in cPanel causing this error.  This is covered in more detail in our guide on <a href="http://www.inmotionhosting.com/support/edu/everything-email/spam-prevention-techniques/spf-records-domain-keys-combating-spam">SPF and Domain Keys</a>.  <br />
<br />
That guide includes a helpful link to <a href="http://www.google.com/support/a/bin/answer.py?hl=en&answer=33786" target="_blank"1>Google's SPF instructions</a> as well.<br />
<br />
If you have any further questions, feel free to post them below.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24597);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-30392'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/4ee34292a798f5ef3a36a945c8f2f180?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/4ee34292a798f5ef3a36a945c8f2f180'>Karla</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-02-08 10:35 am</div>
				                <div><p>How can I sync my email across all devices using In Motion?&nbsp; Please advise.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30392);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-02-08 12:26 pm</div>
				                <div>Hello Karla,<br />
<br />
Thank you for contacting us. I recommend setting up all devices as IMAP, which stores the emails on the server by default, and allows all devices to see the same emails.<br />
<br />
Our <a href="http://www.inmotionhosting.com/support/email/general-information/getting-started-guide-email">Email Getting Started</a> includes setup guides for many devices.<br />
<br />
...
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30404);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
