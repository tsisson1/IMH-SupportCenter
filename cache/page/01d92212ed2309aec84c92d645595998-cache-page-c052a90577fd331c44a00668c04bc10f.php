<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:58397:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/server-security/disable-ftp-clear-plain-text-authentication" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-03-19T23:25:00-07:00" />
  <meta name="keywords" content="pci compliance compliant scan scans dss credit card cards disable ftp clear plain text authentication" />
  <meta name="author" content="Jacob Nicholson" />
  <meta name="description" content="In this article we'll discuss disabling FTP clear/plain text authentication using WHM." />
  <title>Disable FTP clear/plain text authentication - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/server-security/disable-ftp-clear-plain-text-authentication" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:83772f3fc70e407d170a27182e7b8d5b -->
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/website/server-security' itemprop='url'><span itemprop='title'>Server Security<span></a><div class='dropdown_3columns'><div class='col_3'><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/server-security/disable-ftp-clear-plain-text-authentication'>Disable FTP clear/plain text authentication</a> (8598 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/server-security/how-to-install-csf'>How to install CSF</a> (71 hits)</div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Disable FTP clear/plain text authentication</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Disable FTP clear/plain text authentication									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>8,598</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Nov 5, 2012'><span style='color:#606060;'>Published:</span> Mar 19, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>If you've read our previous article on <a href="/support/website/website-troubleshooting/how-to-pass-pci-scans">how to pass PCI compliance scans</a>, you might notice that you failed a PCI scan due to FTP clear/plain text authentication being used. In this article we'll discuss disabling FTP clear/plain text authentication.</p>
<p>By default when you establish an FTP connection to the server, your credentials are passed to the server as clear/plain text. What this can mean is that if someone was sniffing the network traffic from your computer to the server because you were on a open WiFi network for instance, they could potentially compromise your account. So requiring an encrypted connection instead of a clear/plain text one can help protect your account against this.</p>
<p>It's important to note that this change would require you having <a href="/support/website/general-server-setup/root-access-faq">root access</a>&nbsp;on your VPS or dedicated server, as this is an advanced setting and the default can't be changed on our shared servers.</p>
<ol class="article_list">
<li><a href="/support/edu/whm/creating-and-managing-accounts/log-into-whm">Log into WHM</a>.</li>
<li>In the top-left&nbsp;<strong>Find</strong> box enter in <strong>ftp</strong>, then click on&nbsp;<strong>FTP Server Configuration.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/pci-compliance/whm-click-on-ftp-server-configuration.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/pci-compliance/whm-click-on-ftp-server-configuration.png" alt="whm-click-on-ftp-server-configuration"  /></a><br /></strong></li>
<li><span data-mce-bogus="true">In the&nbsp;<strong>TLS Encryption Support</strong> drop-down, select&nbsp;<strong>Required (Command)</strong>.</span></li>
<li><span data-mce-bogus="true"><span data-mce-bogus="true"><span data-mce-bogus="true"><span data-mce-bogus="true"><span data-mce-bogus="true">Scroll to the bottom of the page and click on <b>Save</b>.</span></span></span></span></span></li>
</ol>
<p><span data-mce-bogus="true"><span data-mce-bogus="true"><span data-mce-bogus="true"><span data-mce-bogus="true"><span data-mce-bogus="true"><span data-mce-bogus="true">You should now know how to disable FTP clear/plain text authentication on your server. Now that you know how to disable this you'll also more than likely want to learn about <a href="/support/website/file-management/securely-connecting-your-website-using-ftp">securely connecting to your website using an FTP client</a> as well.</span></span></span></span></span></span></p> 
...
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/server-security/disable-ftp-clear-plain-text-authentication'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NTgmaWQ9NDU2JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="fde9005d821322cabff33bb04d4c88d5" value="1" />	</div>
	</form>
<!-- <br />
