<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:51285:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/wordpress/i-created-editcom-but-when-i-access-editeditcomwpadmi" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Scott, Thank you for your question on your WordPress URL. Have you also changed the URL for your subdomain? If not, ..." />
  <title>I created edit.*****.com, but when I access editedit.*****.com/wp-admi | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/wordpress/i-created-editcom-but-when-i-access-editeditcomwpadmi" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:f2d01afbef6ba479cd023896329352a6 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '124.121.223.171']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>I created edit.*****.com, but when I access editedit.*****.com/wp-admi</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-06-22 4:40 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>42</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Dear Jeff,<br />
<br />
Your video for replicating a WordPress site using a subdomain was useful for creating a site to edit my webpage online.  I created edit.*****.com, which is a replica of my original webpage www.***.com.  However, when I attempt to login as an administrator for editing edit.****.com using edit.*****.com/wp-admin, I am taken to my original page (www.*****.com) for editing.  Where did I miss a database link to www.*****.com, since I am unable to locate the missing point with the search option.  Kindly let me know if I need to supply you with additional information to assist with debugging this problem.<br />
<br />
Thanks,<br />
<br />
Scott</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_7497' id='upvote_answer_7497' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='7497' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_7497').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_7497' id='downvote_answer_7497' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='7497' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_7497').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Scott,<br />
<br />
Thank you for your question on your WordPress URL.  Have you also changed the URL for your subdomain? If not, <a href="http://www.inmotionhosting.com/support/website/wordpress/wordpress-changing-the-site-url-and-home-settings":http://www.inmotionhosting.com/support/website/wordpress/wordpress-changing-the-site-url-and-home-settings">change it in the wp_config.php file</a> first so you can then log into the admin dashboard and change them in the General settings. Then you can remov the wp-config.php modification you made so everything is back to standard setup.<br />
<br />
Kindest Regards,<br />
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_7497').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_7497' id='form_comment_on_answer_7497' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/wordpress/i-created-editcom-but-when-i-access-editeditcomwpadmi&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/wordpress/i-created-editcom-but-when-i-access-editeditcomwpadmi'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="fc94e82216aea4b596f345f1b44488fe" value="1" />	</div>
	</form>
<!-- <br />
