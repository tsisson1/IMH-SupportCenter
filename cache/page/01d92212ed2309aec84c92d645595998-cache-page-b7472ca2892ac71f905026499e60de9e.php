<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49809:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/horde-webmail/html-email-in-horde" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Andrew, You are correct, the configuration file that governs Horde's ability to view HTML is a global file, so it cannot be configured on a shared..." />
  <title>HTML email in Horde? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/horde-webmail/html-email-in-horde" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:5de14d75abe5d1d55e74519dd44a5893 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '139.0.77.102']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>HTML email in Horde?</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/alseymour'>alseymour</a>
			<div>16 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-06-05 1:21 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>2,953</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Greetings!<br />
<br />
I'm new to IMH and Horde, and I was wondering if I can get Horde to show HTML email?<br />
<br />
From what I have found on Google, the mime_drivers.php file appears to be a Global file, but these references are OLD...<br />
<br />
Thoughts?<br />
<br />
Andrew</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_1111' id='upvote_answer_1111' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='1111' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_1111').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_1111' id='downvote_answer_1111' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='1111' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_1111').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Andrew,<br />
<br />
You are correct, the configuration file that governs Horde's ability to view HTML is a global file, so it cannot be configured on a shared server. Our VPS and Dedicated plans do allow for this configuration if desired. As an alternative, I do know that the Roundcube email interface allows you to view the HTML emails by default. You may want to simply switch over to Roundcube to view any HTML emails even if you use Horde for your main interface.<br />
<br />
...
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_1111').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_1111' id='form_comment_on_answer_1111' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/horde-webmail/html-email-in-horde&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/horde-webmail/html-email-in-horde'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="d4adf5931953e61b7b1c88dd1972f794" value="1" />	</div>
	</form>
<!-- <br />
