<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:57051:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/prestashop-16/manual-install" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-05-06T17:50:40-07:00" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Learn how to manually install PrestaShop 1.6 into your web hosting account." />
  <title>How to manually install PrestaShop 1.6 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/prestashop-16/manual-install" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:ecb5c02432662dad1b1163c464d213d3 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '93.156.62.20']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to manually install PrestaShop 1.6									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>7,196</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Feb 11, 2014'><span style='color:#606060;'>Published:</span> May 6, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>PrestaShop has become one of the most popular shopping cart programs over the last few years. It can be installed very easily on most web hosting servers, especially <a href="http://www.inmotionhosting.com/prestashop-hosting">here at InMotion Hosting</a>. PrestaShop will allow you to create your own online store where you can sell products to customers right from your website. These products can be physical, such as book or pet supplies, or digital such as downloadable software, ebooks, or educational courses. This article shows you how to download and install the newest version of PrestaShop, 1.6.</p>

<h2>Download PrestaShop 1.6</h2>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/ps16/101/manual-install/1-download-prestashop.png"><img   style="float:right; margin:0px 0px 15px 15px;" alt="Prestashop download page" src="//cdn.inmotionhosting.com/support/images/stories/edu/ps16/101/manual-install/1-download-prestashop.png" title="Click here to view the larger image" width="200" /></a>The first thing you will need to do is <a href="http://www.prestashop.com/en/developers-versions" target="_blank">download a copy of PrestaShop</a> to your local machine. This will later be uploaded to your hosting account and unpacked so that it can be installed. To obtain the most current copy of PrestaShop, visit the <a href="http://www.prestashop.com/en/developers-versions">PrestaShop download page</a>. You will see a button entitled <strong>Download Now</strong>. Click that button to save the PrestaShop zip file to your local machine.</p>
<div class="alert" style="color:red;"><strong>NOTE:</strong> As of the time of this writing, <a href="http://www.inmotionhosting.com/support/edu/prestashop-16/prestashop16-updates/prestashop16-feature-list-update#ps16-progress">PrestShop 1.6 is still in Beta</a>. This means that the link provided will point to the Developer's version, which is not advisable for use in a production website.</div>

<h2>Create a Database in your hosting account</h2>
<p>After downloading the PrestaShop file to your computer, the next step you will need to take is establishing a database within your hosting account. The database is extremely important as this is where all your product, order, and customer information is kept. <a href="/support/website/database-setup/how-do-i-create-a-mysql-database-in-my-control-panel-cpanel">Click here</a> for the steps on how to create a database in your cPanel account.</p>
<p class="alert" style="color:red;"><strong>NOTE:</strong> Be sure to write down your database name, username, and password as you will need it later in the installation process</p>

<h2>Uploading PrestaShop</h2>
<p>Now that your empty database has been created, you can upload the PrestaShop file to your hosting account using <a href="/support/website/managing-files/how-to-upload-files-server">either the File Manager or FTP</a>.</p>

<h2>Extracting the files</h2>
<p>Extracting the files from the uploaded .zip file and placing them in the right place is a two step process. First you need to unzip, or extract, the files from the .zip file into your hosting account. You can do that by following the instructions on <a href="/support/website/file-manager/compressing-uncompressing-files">uncompressing files using the File Manager</a>.</p>
<p>Once that is complete, you will see that the files were extracted into a folder named <em>PrestaShop</em>. To have an active store, you will need to move the files out of that folder into your main folder. This is likely the folder where the original .zip file is located. Don't worry, you can move all the files at once. If you are not familiar with how to move files in the cPanel File Manager, just follow our instructions by <a href="/support/website/managing-files/how-to-move-files-on-server">clicking here</a>.</p>

<h2>Run the install program</h2>
<p>To begin the installer program, simply visit your site. Be sure that you visit the proper subfolder if you installed PrestShop into one. For instance, if you placed PrestaShop in a folder named <em>shop</em>, then you would visit <em>example.com/shop</em>. This should bring you to the first page of the install section. There are five steps to this section. Below are screenshots and explanations for each of the steps.</p>
<ol class="article_list">
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/ps16/101/manual-install/2-step1.png"><img   style="float:right; margin:0px 0px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/ps16/101/manual-install/2-step1.png" title="Click here to view the larger image" width="200" /></a><strong>Choose your language</strong> - this is the welcome step. From here you will chose your installation language. For our install, we kept the default English selection.<div style="clear:both;"></div></li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/ps16/101/manual-install/3-step2.png"><img   style="float:right; margin:0px 0px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/ps16/101/manual-install/3-step2.png" title="Click here to view the larger image" width="200" /></a><strong>License Agreements</strong> - This screen is for the licensing agreement. Read the agreement and then click on the checkbox next to <strong>I agree to the above terms and conditions</strong>.<div style="clear:both;"></div></li>

<li><strong>System Compatibility</strong> - This step will only stop if there is an incompatibility in your server settings, for instance if you have an outdated php of MySQL version.<div style="clear:both;"></div></li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/ps16/101/manual-install/4-step3.png"><img   style="float:right; margin:0px 0px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/ps16/101/manual-install/4-step3.png" title="Click here to view the larger image" width="200" /></a><strong>Store Information</strong> - Here you will enter the basic information for your store. All information here can be changed later on, so if you have yet to come up with a great store name, simply enter a temporary one for now.<div style="clear:both;"></div></li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/ps16/101/manual-install/5-step4.png"><img   style="float:right; margin:0px 0px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/ps16/101/manual-install/5-step4.png" title="Click here to view the larger image" width="200" /></a><strong>System Configuration</strong> - From this screen you will be entering the database information such as the name, user and password. This is the information you should have kept from when you created the database above.<div style="clear:both;"></div></li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/ps16/101/manual-install/6-step5.png"><img   style="float:right; margin:0px 0px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/ps16/101/manual-install/6-step5.png" title="Click here to view the larger image" width="200" /></a><strong>Store Installation</strong> - As long as all the previous steps have passed, the program will now create the database and install all the base data. Once the progress bar hits 100% your login information will appear on the screen. Be sure to write that down so you can remember it when you log in for the first time.<div style="clear:both;"></div></li>
</ol>
<h2>Delete the Install folder</h2>
<p>Now that you have successfully installed PrestaShop 1.6, you will need to <a href="/support/website/managing-files/how-to-delete-a-file">delete the Install folder</a> before you can use it. This is for security purposes, otherwise someone else could come and run the install program, possibly damaging your existing store.
</p>

<h2>Next Steps</h2>
<p>Now that we have installed prestashop, we'll next show you how to <a href="/support/prestashop-16/admin-login">login to the prestashop 1.6 dashboard</a>.</p>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/prestashop-16/manual-install&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/prestashop-16/manual-install'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00OTMmaWQ9MzA5NSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="27bab00f97c7526c57898ec93f95f37e" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/website/problems-installing-prestashop-cms?tsrc=rsbraq'>problems installing prestashop cms</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/website/how-can-i-visualize-my-website?tsrc=rsbraq'>How do I use my primary domain name for my PrestaShop URL?</a>
                                </div>
