<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:57333:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/everything-email/introduction-email/writing-sending-email" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-10-30T15:44:16-07:00" />
  <meta name="keywords" content="writing sending email compose multiple addresses" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="Learn the basics behind composing and sending emails." />
  <title>Writing and Sending Email - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/everything-email/introduction-email/writing-sending-email" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:2cb22e537c2eed42c766e744ee73e32f -->
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>7,873</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Sep 1, 2011'><span style='color:#606060;'>Published:</span> Oct 30, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Sending emails is one of the most important features of your email client. Whether you use a desktop client such as Mozilla Thunderbird, Mac Mail, or Outlook or Webmail knowing the bascis behind sending emails will be important.</p>
<h1>Composing and Sending Emails</h1>
<p>Keep in mind every email client is different. We have created Knowledge Base articles on using many of the more popular email clients:</p>
<ul>
<li><a href="/support/email/squirrelmail-webmail">SquirrelMail</a></li>
<li><a href="/support/email/horde-webmail">Horde</a></li>
<li><a href="/support/email/roundcube-webmail">RoundCube</a></li>
<li><a href="/support/email/outlook">Outlook</a></li>
<li><a href="/support/email/thunderbird">Thunderbird</a></li>
</ul>
<h1>Sending an Email to Multiple Addresses at Once</h1>
<p>There are two options when sending emails to mutliple addresses at one time. Please keep in mind that are servers are restricted to sending email to no more than 50 recipients at one time. Also, there is a bulk email limit of 250 emails per hour. This limit can be adjusted. For more information please read: <a href="/support/email/mailing-lists/email-limit-exception-request-amp">Bulk Email Exemption Request</a></p>
<p>Knowing the difference between CC and BCC is important but not complicated to understand.</p>
<p><strong>CC</strong>: CC is an acronym for <em>Carbon Copy</em>. This basically means you are sending the email to multiple recipients at one time. When you use CC, everyone on the list of recipients can see who you sent the email to.</p>
<p><strong>BCC</strong>: BCC stands <em>Blind Carbon Copy</em>. This works the same way as carbon copy but it hides the email addresses from the other recipients. This is handy of you are emails a sizable list of customers , and do not want the customer to see the others email addresses.&nbsp;</p>
<p>One of the most popular free email clients is Thunderbird. In Thunderbird, the CC and BCC fields of the email look like the screen shot below. In this illiustration, Bill And Bob will be able to see each other's email addresses but both Bod and Bill will not see Jill's email address since she is in the BCC field:</p>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/email/bcc.jpg"><img src="//cdn.inmotionhosting.com/support/images/stories/email/bcc.jpg" alt="bcc"  /></a></p>
<p>Please check the next article on <a target="_blank" href="/support/edu/everything-email/introduction-email/changing-email-password-in-cpanel" title="Click here to view the next article">Changing an email password in cPanel</a>. If you missed our previous article, please see the <a href="/support/edu/everything-email/introduction-email/checking-email-account" title="Click here to view the previous article" target="_blank">Checking your Email Account</a> tutorial. For more information on this course please visit <a target="_blank" href="/support/edu/everything-email/introduction-email" title="Click here to view the courses">Basic Introduction to Email</a></p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 5: Writing and Sending Email</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 4: <a href='/support/edu/everything-email/introduction-email/how-to-find-email-settings'>How do I find my email settings?</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 6: <a href='/support/edu/everything-email/introduction-email/changing-email-password-in-cpanel'>How to Change an Email Password in cPanel and Webmail</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/everything-email/introduction-email/writing-sending-email&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/everything-email/introduction-email/writing-sending-email'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP3RzcmM9cnNiZWR1Jm9wdGlvbj1jb21fY29udGVudCZjYXRpZD0xNDMmaWQ9OTMyJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
