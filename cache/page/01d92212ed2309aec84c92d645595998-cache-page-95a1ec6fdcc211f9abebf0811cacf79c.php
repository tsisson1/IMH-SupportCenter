<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49889:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/domain-names/domain-not-resolving-to-dedicated-server" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="I currently see the domain resolving correctly to the server without any issues. Could you clarify what you see? If you have pointed the domain less tha..." />
  <title>Domain is not resolving to dedicated server | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/domain-names/domain-not-resolving-to-dedicated-server" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:862f2188309011484a7004654597bba1 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Domain is not resolving to dedicated server</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='http://graph.facebook.com/marloneveline/picture?type=normal' class='user_avatar' /><br />
			<a href='/support/community-support/users/marloneveline@yahoo&per;com'>marloneveline@yahoo.com</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-10-10 11:34 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>674</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>in this week i buy an elite dedicated server , i start to set up, and everything was going good, but today i have to continue set it up and i found the domain stops working , the DNS cant resolve infopvirtual.info<br />
<br />
please help me because i was intend to start using it this monday but i cant do it, through this unstable situation, please help me.<br />
<br />
</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_4090' id='upvote_answer_4090' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='4090' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_4090').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_4090' id='downvote_answer_4090' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='4090' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_4090').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>11,186 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2013-10-11 7:39 am EST
                		        </div>
					
		                </div>

				I currently see the domain resolving correctly to the server without any issues.  Could you clarify what you see?  If you have pointed the domain less than 24 hours ago, it can take up to 24 hours for the domain to &lt;a href=&quot;http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/domain-names-dns-changes&quot;&gt;propagate&lt;/a&gt;.  I also see the domain is resolving for &lt;a href=&quot;http://cloudmonitor.ca.com/en/ping.php?vtt=1381491349&amp;varghost=infopvirtual.info&amp;vhost=_&amp;vaction=ping&amp;ping=start&quot;&gt;multiple locations across the world&lt;/a&gt; as well.  If you are still having trouble, I recommend a &lt;a href=&quot;http://www.inmotionhosting.com/support/website/slow-websites/why-is-my-server-slow-how-do-i-run-a-ping-and-tracert-test&quot;&gt;ping and traceroute test&lt;/a&gt; to locate any possible issues as to why you specifically may be unable to access the site.
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_4090').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_4090' id='form_comment_on_answer_4090' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/domain-names/domain-not-resolving-to-dedicated-server&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/domain-names/domain-not-resolving-to-dedicated-server'></div>
<script type='text/javascript'>
  (function() {
