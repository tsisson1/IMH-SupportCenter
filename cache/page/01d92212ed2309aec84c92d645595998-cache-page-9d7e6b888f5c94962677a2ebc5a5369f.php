<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50928:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/website/cant-reach-subdomain-website-with-temporary-ufl" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello lbickley, Thank you for your question on accessing the subdomain via the Temp URL. I do see you already discovered the answer but will answer agai..." />
  <title>Can't reach subdomain website with temporary URL | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/website/cant-reach-subdomain-website-with-temporary-ufl" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:3442307c9ecf8ca25c55948b7269a020 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box straight_bottom'>
                <h1 style='font-size:26px;'>Can't reach subdomain website with temporary URL</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/lbickley'>lbickley</a>
			<div>13 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-05-30 2:06 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>460</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I'm a new client of InMotion and easily set up my primary website and tested it using my temporary URL. Now I want to setup a number of other domains and subdomains - but haven't figured out how to access them for testing.  More specifically, how to I access a domain other than my primary and/or a subdomain for testing using a temporary URL?</div>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px;'>
				<div style='font-size:12px; max-width:500px; overflow:auto;'>-----------------------------------------------------------------------------------------------------------<br />
Found the answer myself. Use  http://tempservername/~username/addon-*domain-to-access</div>
			...
			<td style='width:100px;' valign='top'>
				...
				<div class='smallgrey'>
					<a href='/support/community-support/users/lbickley'>lbickley</a><br />
					13 <a href='/support/team/points' target='_blank'>Points</a><br />
					2015-05-30 09:31 pm EST
				</div>
			</td>
		</tr>
	</table>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_7366' id='upvote_answer_7366' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='7366' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_7366').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_7366' id='downvote_answer_7366' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='7366' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_7366').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello lbickley,<br />
<br />
Thank you for your question on accessing the <a href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-manage-domains/creating-a-subdomain">subdomain</a> via the Temp URL.  I do see you already discovered the answer but will answer again for anyone else who has the same question.<br />
<br />
Accessing your main domain with the temp URL is done using the format:  </em>http://server###.inmotionhosting.com/~userna5/</em>  <br />
<br />
A subdomain accesses a folder under the public_html, so if you want to access the temp URL for test.example.com then the temp URL format will point to the subfolder as such:  <em>http://server###.inmotionhosting.com/~userna5/test</em><br />
<br />
Kindest Regards,<br />
Scott M<br />
<br />
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_7366').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_7366' id='form_comment_on_answer_7366' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/website/cant-reach-subdomain-website-with-temporary-ufl&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/website/cant-reach-subdomain-website-with-temporary-ufl'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="91dfc6283a57c8f9e85f31ad8f072265" value="1" />	</div>
	</form>
<!-- <br />
