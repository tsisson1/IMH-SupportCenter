<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:63903:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/file-management/how-to-enable-ssh-through-whm" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-12-19T02:14:16-08:00" />
  <meta name="keywords" content="Shell access is not enabled on your account! enable ssh access whm" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="If you get the &quot;Shell access is not enabled on your account!&quot; error when connecting using shell, you will need to enable shell access in your WHM. This article will teach you how." />
  <title>How to enable SSH through WHM - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/file-management/how-to-enable-ssh-through-whm" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:b996c2317bd5be0d8bf23b76fcd3a419 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '69.70.216.26']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to enable SSH through WHM</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to enable SSH through WHM									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>43,187</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: May 14, 2013'><span style='color:#606060;'>Published:</span> Dec 19, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/enable-ssh-whm/enable-ssh-whm-1-disabled.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Disabled SSH access Shell access is not enabled on your account" src="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/enable-ssh-whm/enable-ssh-whm-1-disabled.png" title="Click here to view the larger image" width="100" /></a><a href="/support/website/general-server-setup/do-you-provide-ssh-access" target="_blank">Shell access</a> is enabled by default on our <a href="http://www.inmotionhosting.com/business-hosting" target="_blank">Shared Hosting Accounts</a>, <a href="http://www.inmotionhosting.com/vps-hosting" target="_blank">VPS</a> and <a href="http://www.inmotionhosting.com/dedicated-servers" target="_blank">Dedicated servers</a>. When you try to <a href="/support/website/general-server-setup/how-to-login-ssh" target="_blank">SSH into your server</a> and you get the following error: (Also, see image to the right.)</p>
<div style="width:400px;margin-left: 20px;">
<p class="cli">Shell access is not enabled on your account!<br />
If you need shell access please contact support.</p>
</div>
<p>Your server may have SSH disabled by mistake. This can be fixed easily through your <a href="/support/website/general-server-setup/whm-web-host-manager" target="_blank">WHM</a>. The following tutorial will explain how to enable shell access on your server through the WHM.<br style="clear: both;" />
</p>


<h2>Enabling SSH through the WHM</h2>
...
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/enable-ssh-whm/enable-ssh-whm-2-account-functions.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Account Functions in WHM" src="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/enable-ssh-whm/enable-ssh-whm-2-account-functions.png" title="Click here to view the larger image" width="100" /></a>Go to <strong>Account Functions</strong>.
<br style="clear: both;" />
</li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/enable-ssh-whm/enable-ssh-whm-3-modify-account.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Modify the Account in WHM" src="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/enable-ssh-whm/enable-ssh-whm-3-modify-account.png" title="Click here to view the larger image" width="100" /></a>Select <strong>Modify Account</strong>.
<br style="clear: both;" />
</li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/enable-ssh-whm/enable-ssh-whm-4-click-modify.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Click Modify the Account" src="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/enable-ssh-whm/enable-ssh-whm-4-click-modify.png" title="Click here to view the larger image" width="100" /></a>Select the account to change and click <strong>Modify</strong>.
<br style="clear: both;" />
</li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/enable-ssh-whm/enable-ssh-whm-5-shell-access.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Shell Access checkbox in WHM" src="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/enable-ssh-whm/enable-ssh-whm-5-shell-access.png" title="Click here to view the larger image" width="100" /></a>Scroll down to the bottom of the page where it shows <em>Shell Access check box</em>. Click the <strong>checkbox</strong>.
<p><strong>Save</strong> the changes.<br style="clear: both;" />
</p>
</li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/enable-ssh-whm/enable-ssh-whm-6-proceed.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Proceed with enabling SSH" src="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/enable-ssh-whm/enable-ssh-whm-6-proceed.png" title="Click here to view the larger image" width="100" /></a>To make SSH available for all the accounts, Select the Update package radio button to apply the SHell Access change across all your cPanel accounts that are on the same package.
  <p>Click <strong>Proceed</strong>.<br style="clear: both;" />
</p>

<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/enable-ssh-whm/enable-ssh-whm-7-final-access.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Now you can access the server using shell" src="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/enable-ssh-whm/enable-ssh-whm-7-final-access.png" title="Click here to view the larger image" width="100" /></a>Now try accessing your server using SSH. You should have a login screen like the snapshot to the right.
<br style="clear: both;" /></p></li>

</ol>
<p>Interested in information about hosting that supports SSH access? Learn more about <a href="http://www.inmotionhosting.com/ssh-hosting">SSH Hosting</a>.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/file-management/how-to-enable-ssh-through-whm&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/file-management/how-to-enable-ssh-through-whm'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yMyZpZD0yNzEyJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="2337c4f181b01b63b09e4a2e18095096" value="1" />	</div>
	</form>
<!-- <br />
