<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:69928:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/ftp-client-setup/configuring-your-site-in-filezilla" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-04-21T22:41:56-07:00" />
  <meta name="keywords" content="Configuring site FileZilla" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="This video tutorial demonstrates how to configure your site with FileZilla" />
  <title>How to Setup FTP with FileZilla  - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/ftp-client-setup/configuring-your-site-in-filezilla" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:0842859f329938c8918831632467f332 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to Setup FTP with FileZilla 									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>29,537</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Sep 13, 2011'><span style='color:#606060;'>Published:</span> Apr 21, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<center><iframe width="560" height="315" src="https://www.youtube.com/embed/8vPhIyZQHW0" frameborder="0" allowfullscreen></iframe></center>
<p>One of the most popular FTP programs is FileZilla. FileZilla is a free open source software you can download at the following link.</p>
<p><a href="http://filezilla-project.org/download.php" target="_blank">FileZilla Free Client download</a></p>
<p>You will need to download the Client version for whatever operating system you have. Once you install FileZilla, open the program. You will need to use your FTP credentials which are the same as the cPanel login credentials. If you need more general information on your FTP server settings, please see our <a href="/support/website/file-management/getting-started-guide-ftp" target="_blank" title="Click here for info">Getting started FTP guide</a>.</p>
<div>Once you have FileZilla installed and you have your login information, we can go over the steps to configure FileZilla. The following sections will explain how to connect using FileZilla with the Quick Connect and the Site manager.</div>
<h2>FileZilla Quick connect setup</h2>
<p>When setting up FileZilla, you can have different custom settings in the site manager that you cannot do in the Quick Connect. .</p>
<ol class="article_list">
<li><strong><a target="_blank" title="Click for more information">Open up your FileZilla program</a></strong>.</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/configure-filezilla/configure-1-quickconnect.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Quickconnect FileZilla" src="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/configure-filezilla/configure-1-quickconnect.gif" title="Click here to view the larger image" width="100" /></a><strong>Enter your FTP connection credentials </strong>in the Quick connect bar at the top of FileZilla.
<p class="alert"><strong>Important!</strong> Keep in mind each server has different connection settings. You will need to use the credentials for your cpanel in your AMP home in the "<em>Technical details</em>."</p>
<p>The connection settings are as follows:<br /> - Host: example.com<br /> - Username: your cpanel username<br /> - Password: Your cpanel password<br /> - Port: 21</p>
<p><strong>Click the Quickconnect button.</strong></p>
<br style="clear: both;" />
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/configure-filezilla/configure-2-failure.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Failure error FileZilla" src="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/configure-filezilla/configure-2-failure.gif" title="Click here to view the larger image" width="100" /></a>If the connection fails you will get an error similar to the image to the right.</p>
<pre style="margin-left: 20px;">Failure:
Response:  530 Login incorrect.
Error:  Critical error
Error:  Could not connect to serverSuccess</pre>
<p>If you get this failure, most likely either the username and password are incorrect, or the host name you are connecting with is not connecting to your server. If you have trouble finding you username, password, and host, please contact support and they will be able to point you to them.<br style="clear: both;" /></p>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/configure-filezilla/configure-3-success.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Success connection FileZilla" src="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/configure-filezilla/configure-3-success.gif" title="Click here to view the larger image" width="100" /></a>A successfully connection will show the following.</p>
<pre style="margin-left: 20px;">Success:
Command:  MLSD
Response:  150 Accepted data connection
Response:  226-Options: -a -l 
Response:  226 27 matches total
Status:  Directory listing successful<br style="clear: both;" /></pre>
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/configure-filezilla/configure-4-history.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="History of FTP connections FileZilla" src="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/configure-filezilla/configure-4-history.gif" title="Click here to view the larger image" width="100" /></a><strong>Your Quickconnect connection will be stored in the history.</strong> You can check it by clicking the down arrow next to the quickconnect button. See image to the right. <br style="clear: both;" />
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/configure-filezilla/configure-5-filename.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="File listing in FileZilla" src="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/configure-filezilla/configure-5-filename.gif" title="Click here to view the larger image" width="100" /></a> Navigate to the bottom right window that says "<em>Filename</em>". You should see your public_html folder where your site files go in the list just like the image to the right.</p>
<p><strong>Now you can just drag your files into the public_html folder to get your site uploaded.</strong></p>
<br style="clear: both;" /></li>
</ol>
<h2>FileZilla Site manager configuration</h2>
<p>The <strong>Site Manager</strong> in FileZilla is another way you can set up your FTP connection. The Connection is saved in your FileZilla Site manager and can be restarted again at a later date. The difference between the site manager and the Quickconnect is the Site Manager has options for changing the type of connections. The following steps will explain how to set up FileZilla through the Site Manager.</p>
<ol class="article_list">
<li><strong><a target="_blank" title="Click for more information">Open up your FileZilla program</a>.</strong></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/configure-filezilla/configure-6-site-manager.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Site Manager in FileZilla" src="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/configure-filezilla/configure-6-site-manager.gif" title="Click here to view the larger image" width="100" /></a>On the top right, <strong>click the Site manager button</strong>. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/configure-filezilla/configure-7-new-site.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Create New Site FileZilla" src="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/configure-filezilla/configure-7-new-site.gif" title="Click here to view the larger image" width="100" /></a><strong>Click "<em>New Site</em>"</strong> and give the site a name. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/configure-filezilla/configure-8-login-credentials.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Login Credentials for FleZilla" src="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/configure-filezilla/configure-8-login-credentials.gif" title="Click here to view the larger image" width="100" /></a><strong>Fill in your FTP connection information</strong>.
<p class="alert"><strong>Important!</strong> Keep in mind each server has different connection settings. You will need to use the credentials for your cpanel in your AMP home in the "<em>Technical details</em>."</p>
<p>- Host: example.com<br /> - Protocol: FTP - File Transfer Protocol - Encryption: Use Plain FTP<br /> - Login type: Normal<br /> - User: your cpanel username<br /> - Password: Your cpanel password<br /> - Account: blank<br /> - Comments blank</p>
<p><strong>Click OK.</strong></p>
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/configure-filezilla/configure-9-select-yoursite.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Select your Site to connect in FileZilla" src="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/configure-filezilla/configure-9-select-yoursite.gif" title="Click here to view the larger image" width="100" /></a>Next, <strong>connect to your server by clicking the down arrow next to the site manager button</strong>.
<p><strong>Click your site</strong> that you just created and Filezilla will connect to your server.</p>
<br style="clear: both;" />
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/configure-filezilla/configure-10-successful-listing.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Suck sucsessful connection FileZilla" src="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/configure-filezilla/configure-10-successful-listing.gif" title="Click here to view the larger image" width="100" /></a>You should see your server files load and the connection successful like the graphic to the right. <br style="clear: both;" /></p>
</li>
</ol>
<p>For more information about configuring your site using FileZilla please watch the following flash tutorial:</p>
<p><a class="ddtut" href="http://support.inmotionhosting.com/userguides/filezilla_flash/filezilla_configure.swf">Configuring your site in FileZilla </a></p> 
...
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/ftp-client-setup/configuring-your-site-in-filezilla'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MDEmaWQ9MTEmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/file-management/better-file-manager-than-cpanel?tsrc=rsbraq'>Better File Manager than cPanel ?!?</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/7ea022b681730fb3b6a9557a2b6ca774?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/7ea022b681730fb3b6a9557a2b6ca774'>Doug Bennett</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-02-10 11:25 am</div>
				                <div><p>Excellent video.&nbsp; Quick and to the point!&nbsp; I am new to the web building world and I can heartily say that In Motion Hosting has excellent support!&nbsp; Just about any question can be answered by searching In Motion.&nbsp; If you don't find what you need there, they are easy to reach on the phone.&nbsp; Couldn't ask for better support anywhere!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30457);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
