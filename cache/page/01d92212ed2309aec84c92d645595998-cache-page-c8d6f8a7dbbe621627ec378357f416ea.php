<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:63760:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/wordpress/wordpress-http-error-when-uploading-media" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="https://dl.dropboxusercontent.com/u/19806890/Shari's-Women-Bible-Study_WordPressEventGFX.jpg..." />
  <title>WordPress &quot;HTTP Error&quot; when uploading media | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/wordpress/wordpress-http-error-when-uploading-media" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:8b3baaf6f8a8d4624f9985115a783ab0 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>WordPress &quot;HTTP Error&quot; when uploading media</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2014-09-22 10:38 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>520</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Hello,<br />
<br />
Since approx. Wednesday, Sept. 17th 2014, I have ran into an http error when I tried to upload any media to my Wordpress site. The very last time I remember my uploading working would have been that Monday. Weekly we update my church's website with that Sunday's sermon audio, so that was for sure the last time I remember it working.<br />
<br />
I have tried plenty of solutions, like adding a line in my public_html/.htaccess:<br />
suPHP_ConfigPath /home/username/public_html<br />
<br />
I've tried upgrading my maximum file size upload to 512mbs (which seemed ridiculous because my files are never over 20mb in size, but tried it anyway).<br />
<br />
I've tried disabling all of my plugins, and one by one turning them on to see if any of them were the culprit, but that didn't work either.<br />
<br />
I have tried different computers, different local networks, different browsers, etc., but they all still produce an http error.<br />
<br />
Most forums that I have skimmed have mostly said this was a host issue, not a WordPress issue, so I'm hoping someone here can help me out.</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_5671' id='upvote_answer_5671' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='5671' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_5671').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_5671' id='downvote_answer_5671' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='5671' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_5671').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
We are having one of our WordPress people check into the situation for you. We will reply here when we have some information for you. Thank you for your patience.<br />
<br />
Kindest Regards,<br />
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_5671').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_5671' id='form_comment_on_answer_5671' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
...
<div class=' straight_bottom not_best_answer'>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px; width:50px;' valign='top'>
<div class='vote_div'>
	<form method='post' name='upvote_answer_5673' id='upvote_answer_5673' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='5673' />
		<input type='hidden' name='component' id='component' value='qa' />
		<input type='hidden' name='vote_value' id='vote_value' value='1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_5673').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_5673' id='downvote_answer_5673' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='5673' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_5673').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>11,186 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2014-09-22 12:58 pm EST
                		        </div>
					
		                </div>

				I have successfully uploaded an image to your WordPress admin and was unable to replicate the error.  Are you still having this issue?  If so, could you provide me with the exact steps that you are performing as well as the specific image that you are trying to upload?
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_5673').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_5673' id='form_comment_on_answer_5673' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
					                <p>You must <a href='/support/login'>login</a> before you can post a comment about this answer.</p>
					        </div></div></div></div>
					</form>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>First, it is infuriating that to respond to this is ridiculous. I'm sorry to go off subject here, but I don't want to use Facebook or Google+ to login, and when I try to login with Facebook, it says this App isn't developed yet...and the additional &quot;regular&quot; login with AMP isn't an option...this is just compounding what frustration there already is today.<br />
<br />
I just tried to upload an image and I'm still receiving the http error.<br />
<br />
What I've been trying to do is this (in dashboard):<br />
Events &gt; All Events&gt;Women's Sunday Night Bible Study &gt; Set Featured Image &gt; Drag and Drop/Select my image &gt; See uploading progress bar, then HTTP error.<br />
<br />
I've also tried an alternate route of (In Dashboard):<br />
Media Files &gt; Add New &gt; Drag and Drop/Select image file &gt; See upload progress bar, and then HTTP error.<br />
<br />
The specific image is a .jpg, 377w. x196h., 97.3kb...nothing out of the ordinary.</div>
							...
							<td style='width:96px;' valign='top'>
								...
								<div class='smallgrey'>
									<a href='/support/community-support/users/ironorr'>ironorr</a><br />
									19 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2014-09-22 1:38 pm EST
								</div>
...
<br />
I have successfully uploaded a 16.5MB audio file just now. Since it was a larger file, I was able to actually see the upload progress bar, and then the usual &quot;upload complete&quot; msg.<br />
<br />
I just tried to &quot;refresh&quot; my .jpg in photoshop, just in case it was somekind of corrupt .jpg file, and it still gets an http error. I even saved the file as a .png, since you uploaded a png file as well, but MY png file give me an http error...so we can pretty much narrow it down a little bit there...</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>I have followed the exact steps that you have and am unable to replicate the issue with any images that I have tried uploading.  It appears that it may be related to the specific file that you are trying to upload.  Could you provide me with a link to this specific file in an attempt to replicate the issue?</div>
...
<div class=' straight_bottom not_best_answer'>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px; width:50px;' valign='top'>
<div class='vote_div'>
	<form method='post' name='upvote_answer_5675' id='upvote_answer_5675' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='5675' />
		<input type='hidden' name='component' id='component' value='qa' />
		<input type='hidden' name='vote_value' id='vote_value' value='1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_5675').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_5675' id='downvote_answer_5675' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='5675' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_5675').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					<img src='https://lh3.googleusercontent.com/-XdUIqdMkCWA/AAAAAAAAAAI/AAAAAAAAAAA/4252rscbv5M/photo.jpg?sz=90' class='user_avatar' style='max-width:60px;' /><br />
                		        <a href='/support/community-support/users/ironorr'>ironorr</a>
					
					<div>19 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2014-09-22 3:08 pm EST
                		        </div>
					
		                </div>

				https://dl.dropboxusercontent.com/u/19806890/Shari's-Women-Bible-Study_WordPressEventGFX.jpg
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_5675').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_5675' id='form_comment_on_answer_5675' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
					                <p>You must <a href='/support/login'>login</a> before you can post a comment about this answer.</p>
					        </div></div></div></div>
					</form>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>It appears that the error is due to the file name.  Some symbols (such as apostrophes and quotes) within file names can sometimes cause unexpected results, especially when handled by the browser on Linux servers in which mod_security has blocked the request.  To resolve the issue, simply remove the apostrophe from the file name.</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>I hate that this is actually the reason why I had my issues...I should have known/realized what was causing this issues...Really? It was the apostrophe this whole time!<br />
<br />
How infuriating, haha...Thanks JeffMa for your help, even though it was completely a dumb reason in the first place...</div>
