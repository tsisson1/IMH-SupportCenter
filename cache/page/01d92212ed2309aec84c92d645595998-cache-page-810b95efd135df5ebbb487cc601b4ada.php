<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:51394:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/wordpress/wordpress-security-plugins" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="keywords" content="WordPress security plugins" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="To learn about WordPress security plugins, read the tutorials in this course." />
  <title>205: WordPress security Plugins | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/wordpress/wordpress-security-plugins" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:e166a030cc1e1f9df3b95bbb4d9ccb3d -->
...
<div class='page-header'>
	<h1>205: WordPress security Plugins</h1>
</div>
<div class='section_listing'>
	<p>This course will focus on different plugins that are available to secure your WordPress site.</p>	<table>
	<tr><td colspan='3'><h2>Overview of Security Plugins</h2><div>This section will give you an overview of popular WordPress security plugins.</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 1:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/wordpress/wordpress-security-plugins/recommended-security-plugins'>Recommended WordPress Security plugins</a>
					<div>This article lists the most popular and recommended security plugins from WordPress.</div>
					<div class='smallgrey'>Hits: 12,876</div>
				</td>
			</tr>
		<tr><td colspan='3' style='padding-top:20px;'><h2>Complete Security plugins</h2><div>These plugins will secure your WordPress site from hackers and malicious scripts. Each one of these programs not only analyze your WordPress Security, you can configure security settings like secure login, htaccess tweaks, and more.</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 2:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/wordpress/wordpress-security-plugins/wordfence-security-plugin'>Using the WordFence Security plugin for WordPress</a>
					<div>This tutorial will explain how to install and use the WordFence Security plugin for WordPress.</div>
					<div class='smallgrey'>Hits: 4,768</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/wordpress/wordpress-security-plugins/wordpress-bulletproof-security-plugin-configuration'>WordPress BulletProof Security plugin configuration</a>
					<div>This article will explain the basics of the BulletProof Security plugin for WordPress.</div>
					<div class='smallgrey'>Hits: 4,833</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/wordpress/wordpress-security-plugins/configuring-the-wordpress-better-wp-security'>Configuring the WordPress Better WP Security</a>
					<div>This article will teach you how to set up the Better WP Security plugin for WordPress.</div>
					<div class='smallgrey'>Hits: 3,085</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/wordpress/wordpress-security-plugins/installing-the-wordpress-mvis-security-center-plugin'>Installing the WordPress MVIS Security Center plugin</a>
					<div>This tutorial will explain how to install and configure the WordPress MVIS Security Center plugin.</div>
					<div class='smallgrey'>Hits: 1,007</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/wordpress/wordpress-security-plugins/using-the-login-security-solutions-wordpress-plugin'>Using the Login Security Solutions WordPress plugin</a>
					<div>To secure your WordPress login, you can use the WordPress Login Security Solutions plugin. This article will explain how.</div>
					<div class='smallgrey'>Hits: 1,725</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/wordpress/wordpress-security-plugins/installing-the-simple-security-wordpress-plugin'>Installing the Simple Security WordPress plugin.</a>
					<div>This article will explain how to instal the Simple Security Plugin for WordPress.</div>
					<div class='smallgrey'>Hits: 910</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/wordpress/wordpress-security-plugins/wanggaurd-plugin'>Seting up the WangGaurd plugin for WordPress</a>
					<div>This article will explain how to set up the WangGaurd security plugin for WordPress.</div>
					<div class='smallgrey'>Hits: 1,052</div>
				</td>
			</tr>
		<tr><td colspan='3' style='padding-top:20px;'><h2>Security Analysis Plugins</h2><div>The following tutorials will explain how to install security plugins for analyzing your WordPress security.</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 9:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/wordpress/wordpress-security-plugins/how-to-install-and-use-the-security-ninja-lite-wordpress-plugin'>How to install and use the Security Ninja Lite WordPress plugin</a>
					<div>You can analyze your WordPress website security with the Security Ninja Lite Plugin. This article will show you how.</div>
					<div class='smallgrey'>Hits: 1,179</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/wordpress/wordpress-security-plugins/installing-the-look-see-security-plugin-for-wordpress'>Installing the Look-See Security plugin for WordPress</a>
					<div>This article will teach you how to install the Look-See Security scanner for WordPress.</div>
					<div class='smallgrey'>Hits: 894</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/wordpress/wordpress-security-plugins/install-and-set-up-the-sucuri-security-sitecheck-malware-scanner-plugin-for-wordpress'>Install and Set up the Sucuri Security - SiteCheck Malware Scanner plugin for WordPress</a>
					<div>Installing and setting up the Sucuri Security - SiteCheck Malware Scanner plugin for WordPress.</div>
					<div class='smallgrey'>Hits: 1,756</div>
				</td>
			</tr>
		<tr><td colspan='3' style='padding-top:20px;'><h2>Other Security Plugins</h2><div>These plugins are miscellaneous plugins for WordPress security.</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 12:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/wordpress/wordpress-security-plugins/how-to-install-the-secure-folder-wp-content-uploads-plugin-for-wordpress'>How to install the Secure Folder wp-content/uploads plugin for WordPress</a>
					<div>You can secure your  WordPress wp-content/uploads folder with the Secure  Folder wp-content/uploads plugin. This article will explain how.</div>
					<div class='smallgrey'>Hits: 3,353</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/wordpress/wordpress-security-plugins/wp-recaptcha'>How to install WP-reCAPTCHA in WordPress</a>
					<div>Installing the WP-reCAPTCHA plugin in WordPress</div>
					<div class='smallgrey'>Hits: 3,797</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/wordpress/wordpress-security-plugins/cleff-login-no-phone-service'>Logging in with Clef when you have no Internet connection on your Phone</a>
					<div>Clef two-factor authentication is a great plugin that helps to secure your WordPress login from many of the common threats affecting WordPress installations today.  However, it is a plugin that requires a smartphone app in order to login. What happens when your smartphone cannot connect to the internet or its carrier? The following tutorial walks you through steps that Clef has built into the plugin for logging into offline mode.</div>
					<div class='smallgrey'>Hits: 171</div>
				</td>
			</tr>
			</table>
</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zNjcmaWQ9MzY3JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="afdb5732865b56ba2484c3e073778293" value="1" />	</div>
	</form>
<!-- <br />
