<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:66234:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/prestashop-16/enable-error-reporting" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-05-16T18:19:19-07:00" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Learn how to enable the error reporting feature in PrestaShop 1.6." />
  <title>How to enable error reporting in PrestaShop 1.6 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/prestashop-16/enable-error-reporting" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:fce09530c945fa43c42ebc2d3c271212 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '98.219.83.119']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to enable error reporting in PrestaShop 1.6									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>18,780</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: May 8, 2014'><span style='color:#606060;'>Published:</span> May 16, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Once you have <a href="/support/prestashop-16/install-with-softaculous">installed your PrestaShop 1.6</a> store and began working with it, you will inevitably come upon errors from time to time. Although the developers do their best to code error checking and error messages into the code, some errors are not code related. These other errors may be due to server settings or the hosting environment.</p> 
  
<p>Many times the screen may go white or simply something will not look right on the screen. When this happens, the first thing you want to do is to enable the error reporting ability. This allows you to see the specific error messages on the screen. From here, you will either be able to troubleshoot further or give the error message to your friendly InMotion Hosting support team for additional help.
</p>

<div class="alert" style="color:red">The following instructions are for cPanel hosted accounts. More specifically, they are designed for accounts hosted at Inmotion Hosting. While you may use the instructions as a guide, keep in mind they may not be exact if your hosting company is different.</div>

<h2>How to enable error reporting in PrestaShop 1.6</h2>

<ol class="article_list">
  <li><a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">Log into your cPanel admin dashboard</a>.<div style="clear:both;"></div></li>
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/ps16/errors/modules/upscarrier/enable-error-reporting/1-click-file-manager2.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/ps16/errors/modules/upscarrier/enable-error-reporting/1-click-file-manager2.png" title="Click here to view the larger image" width="200" /></a>From here, locate the <em>Files</em> category and click on the <strong>File Manager</strong> icon.<div style="clear:both;"></div></li>
  
  <li>Once inside the <em>File Manager</em>, navigate to the root folder for your PrestaShop installation. This is most often the primary domain for the account and you will already be in the <em>public_html</em> folder, which is the correct place. If you have your store installed in a subfolder, such as <em>/store</em>, then locate that folder and double click to enter it. If your store is in an addon domain, locate the folder with that domain name, such as <em>example.com</em> and then enter it.<div style="clear:both;"></div></li>
  
  <li>Once in the PrestaShop root folder, double click the folder named <strong>config</strong> and then open the file named <strong>defines.inc.php</strong> for editing.<div style="clear:both;"></div></li>
  <li>Find the line of code below:
  <div class="code_block">
  /* Debug only */
  define('_PS_MODE_DEV_', false);
  </div>
  <div style="clear:both;"></div></li>
  <li>Change the '<em>false</em>' to '<em>true</em>' and then click the <strong>Save Changes</strong> button to save and activate the change. The changed line should read as follows:
    <div class="code_block">/* Debug only */ define('_PS_MODE_DEV_', true); </div><div style="clear:both;"></div></li>
</ol>
<br />
<p>Now you can return to your site and see if there is an error message at the spot you were having trouble with. Note that there are times when there is no message and further troubleshooting is required. Below is an example of an error that you may see. This is only a sample of many php errors you may run across.</p>
...
<tr>
  <td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/ps16/errors/modules/upscarrier/enable-error-reporting/before.png"><img   style="" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/ps16/errors/modules/upscarrier/enable-error-reporting/before.png" title="Click here to view the larger image" width="100%" /></a></td>
  <td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/ps16/errors/modules/upscarrier/enable-error-reporting/after.png"><img   style="" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/ps16/errors/modules/upscarrier/enable-error-reporting/after.png" title="Click here to view the larger image" width="100%" /></a></td>
</tr>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/prestashop-16/enable-error-reporting&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/prestashop-16/enable-error-reporting'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00OTMmaWQ9MzIzOCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="7c45cfa03cc4a607b5ac90233aaf5862" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/prestashop-15/white-screen-error-after-new-theme?tsrc=rsbraq'>White Screen Error After New Theme install </a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/prestashop-15/prestashop-16-file-upload-failed?tsrc=rsbraq'>Prestashop 1.6 file upload failed</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/website/404-error-because-my-link-is-adding-in-extra-word-to-url-2?tsrc=rsbraq'>404 error because my link is adding in extra word to URL</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/website-troubleshooting/site-does-not-display?tsrc=rsbraq'>PrestaShop site does not display</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/prestashop-15/getting-a-white-screen-on-configuration-information-prestashop-16?tsrc=rsbraq'>Getting a white screen on Configuration Information Prestashop 1.6</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support//?tsrc=rsbraq'>Can anyone recomend a company that can fix an error in address form?</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/prestashop-15/shipstation-unable-to-postback-tracking-info-to-prestashop-store?tsrc=rsbraq'>Shipstation unable to post-back tracking info to prestashop store</a>
                                </div>
...
<a name='comments'></a>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/ffb80145c161511480f6b3d5c795593e?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/ffb80145c161511480f6b3d5c795593e'>Nodek</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-22 4:45 pm</div>
				                <div>It is perfect for me</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16601);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-16907'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/8e8cd913ec6862cbad524b05faec11ab?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/8e8cd913ec6862cbad524b05faec11ab'>ruu</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-30 12:09 pm</div>
				                <div><p>thanks, I will look into this from my current host..</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16907);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-26722'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/c6ceeaf2395c7dab82ce1685fe07264f?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/c6ceeaf2395c7dab82ce1685fe07264f'>bhawin</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-17 1:51 am</div>
				                <div><p>do we have any option to do it from backend</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26722);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-17 12:00 pm</div>
				                <div>Hello bhawin,<br />
<br />
Thank you for contacting us. Unfortunately, there is no option for enabling error reporting in PrestaShop from the backend.<br />
<br />
If you have any further questions, feel free to post them below.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26739);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-29087'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/0659b201f19f44516b3a74a9d3a9d894?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/0659b201f19f44516b3a74a9d3a9d894'>krish</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-12-09 1:25 am</div>
				                <div><p><strong style="font-family: 'Times New Roman'; font-size: medium;">i can get this error how to clear this Fatal error</strong><span style="font-family: 'Times New Roman'; font-size: medium;">: Class 'search' not found in&nbsp;</span><strong style="font-family: 'Times New Roman'; font-size: medium;">/home/imiktech/public_html/classes/controller/Controller.php</strong><span style="font-family: 'Times New Roman'; font-size: medium;">&nbsp;on line&nbsp;</span><strong style="font-family: 'Times New Roman'; font-size: medium;">134</strong></p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29087);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-12-09 9:19 am</div>
				                <div>You're calling a class it cannot find. You need to make sure you have defined the "search" class accordingly. </div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29099);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
