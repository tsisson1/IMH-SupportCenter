<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:52987:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/website/how-to-read-the-results-of-a-ping-test" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello and thanks for the great question, Here's some answers to your specific questions: What is a ping test? Why would I run one? A ping test is simply..." />
  <title>How to read the results of a ping test | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/website/how-to-read-the-results-of-a-ping-test" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:2bd3d8818fd24dcd60dc6ef4ec2dcce4 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-22']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '83.166.177.162']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>How to read the results of a ping test</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-10-04 1:09 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>42,192</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>My website is kinda slow, so I ran a ping test. I'm pretty lost, lol, sorry. I was hoping you could answer the following questions:<br />
<br />
* What does a ping test do / why would I want to run a ping?<br />
* What does &quot;time=80ms&quot; mean? What is a good time, and what is a bad time?<br />
* What should I be looking for in the &quot;ping statistics&quot;? Are *'s good?<br />
<br />
&quot;InMotionFans&quot;, lol, true that!</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_4063' id='upvote_answer_4063' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='4063' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_4063').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_4063' id='downvote_answer_4063' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='4063' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_4063').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello and thanks for the great question,<br />
<br />
Here's some answers to your specific questions:<br />
<br />
&lt;h2&gt;What is a ping test? Why would I run one?&lt;/h2&gt;<br />
<br />
A &lt;strong&gt;ping&lt;/strong&gt; test is simply a way for your computer to send a small packet to the server, and to measure the amount of time it takes to get there. You would want to run a &lt;strong&gt;ping&lt;/strong&gt; test in order to see if you can communicate with another computer, and how laggy that connection would be between the two devices.<br />
<br />
&lt;h2&gt;What does &quot;time=80ms&quot; mean? What is a good ping time? &lt;/h2&gt;<br />
<br />
The &lt;strong&gt;time=80ms&lt;/strong&gt; at the end of each &lt;strong&gt;ping&lt;/strong&gt; reply is the measured time that last packet took to get to the destination. In this case &lt;strong&gt;80 milliseconds&lt;/strong&gt; or &lt;strong&gt;0.08 seconds&lt;/strong&gt;. So you'd need to achieve a &lt;strong&gt;1000ms&lt;/strong&gt; reply before your packet is delayed 1 second.<br />
<br />
Depending on what you're trying to do, the time of your ping might matter more. For instance if you're playing an online multiplayer game, a ping over 100ms or so could be a severe disadvantage for you as other players could possibly see the games action a bit quicker than you, and you could experience &lt;strong&gt;lag&lt;/strong&gt; where your actions aren't applied instantly. <br />
<br />
The same applies for websites and servers. For instance if you are streaming videos from your website, a lower ping time to your server would be ideal so that more data can be transmitted without delay.<br />
<br />
However if you have a simple text website with web optimized images, ping times around the &lt;strong&gt;400-500ms&lt;/strong&gt; time-frame can still be acceptable. The user doesn't need everything to display on the page all at once, and then change to another frame. The server simply loads everything up on the visitors computer, and then sits and waits for the next request, so there is not a lot of back and forth data transmitted to notice a delay or lag in the connection.<br />
<br />
&lt;h2&gt;What should I look for in the &quot;ping stats&quot;? Are *'s good?&lt;/h2&gt;<br />
<br />
You'd ideally want to look for a consistently low ping time, one that doesn't fluctuate a whole lot if you have heavy data demands. If your website isn't very intense then medium to high ping times won't affect overall performance too much.<br />
<br />
But if you're receiving &lt;strong&gt;*&lt;/strong&gt; replies in your ping test this is a time-out and could potentially cause issues if you're getting a lot. This however could be caused at any number of networking levels from your local Internet connection, your router, and any of the routers your packet goes through in order to end up at the destination server.<br />
<br />
This is when &lt;a href=&quot;http://www.inmotionhosting.com/support/website/slow-websites/why-is-my-server-slow-how-do-i-run-a-ping-and-tracert-test&quot; target=&quot;_blank&quot;&gt;running a trace route test&lt;/a&gt; also comes into play, as it will show you the ping times of every router your connection has to hop through on its way to the server, so you can know if it's a possible temporary regional problem or closer to the server's location.<br />
<br />
For more information, see our full guide on &lt;a href=&quot;http://www.inmotionhosting.com/support/website/how-to/read-traceroute&quot;&gt;How to Read a TraceRoute&lt;/a&gt;.<br />
<br />
Hope that helps, let us know if you had any further questions!<br />
<br />
- Jacob<br />
<br />
<br />
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_4063').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_4063' id='form_comment_on_answer_4063' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/website/how-to-read-the-results-of-a-ping-test&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/website/how-to-read-the-results-of-a-ping-test'></div>
<script type='text/javascript'>
  (function() {
