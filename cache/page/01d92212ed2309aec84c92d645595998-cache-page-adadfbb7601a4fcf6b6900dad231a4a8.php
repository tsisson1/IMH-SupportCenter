<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:58646:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/prestashop-15/managing-error-logs/view-error-logs" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-01-21T17:28:00-08:00" />
  <meta name="keywords" content="view error logs PrestaShop 1.5" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="This PrestaShop 1.5 article shows you how to view error logs that are generated in your shop." />
  <title>Viewing error logs in PrestaShop 1.5  - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/prestashop-15/managing-error-logs/view-error-logs" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:c057d5c5910496db36716d768249bc50 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Viewing error logs in PrestaShop 1.5 									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>8,419</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Oct 4, 2012'><span style='color:#606060;'>Published:</span> Jan 21, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Continuing on with our course on <a href="/support/edu/prestashop-15/managing-error-logs">Managing Error Logs</a>,&nbsp; this article will cover where to view your error logs and how to get notices to your email. Errors will inevitably occur and being able to view them or get notices about them can be very important. Below are the instructions on setting that up in PrestaShop 1.5</p>
<p><strong>How to view error logs in PrestaShop 1.5</strong></p>
<ol class="article_list">
<li><a href="/support/edu/prestashop-15/getting-started/login-to-dashboard"> Log into your PrestaShop 1.5 dashboard</a>.</li>
<li>Using the top menu bar, hover over the <strong>Advanced Parameters</strong> tab and click on the <strong>Logs</strong> option from the menu.</li>
<li>You are now on the <em>Logs</em> page where you will find a list of all errors after they occur. If there are errors listed, simply click on the row to view the error log. <br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Advanced_Paramaters/Logs/View/logs-list.png"><img  alt="logs-list" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Advanced_Paramaters/Logs/View/logs-list.png" /></a></li>
<li>Setting your notifications is done below the list under the <em>Logs by email</em> section. To set them, find the <strong>Minimum Severity Level</strong> and set the number (1-4) that you would like to be notified for. For example, if you select 2, you will be emailed for any errors generated that are of severity 2 or above. Placing 5 in the field disables the email notification completely.</li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/prestashop-15/managing-error-logs'>214: Managing Error Logs in PrestaShop 1.5</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 2: Viewing error logs in PrestaShop 1.5 </div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 1: <a href='/support/edu/prestashop-15/managing-error-logs/error-log-intro'>Introduction to error logs in PrestaShop 1.5 </a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 3: <a href='/support/edu/prestashop-15/managing-error-logs/configure-email-notifications'>Configuring email notifications for error logs in PrestaShop 1.5 </a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/prestashop-15/managing-error-logs/view-error-logs&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/prestashop-15/managing-error-logs/view-error-logs'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNzMmaWQ9MTgzOCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/prestashop-15/managing-error-logs?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Managing Error Logs in PrestaShop 1.5</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/prestashop-15/managing-error-logs/error-log-intro?tsrc=rsbedu'>Introduction to error logs in PrestaShop 1.5 </a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/prestashop-15/managing-error-logs/view-error-logs?tsrc=rsbedu'>Viewing error logs in PrestaShop 1.5 </a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/prestashop-15/managing-error-logs/configure-email-notifications?tsrc=rsbedu'>Configuring email notifications for error logs in PrestaShop 1.5 </a></td>
                </tr>
          	</table>
