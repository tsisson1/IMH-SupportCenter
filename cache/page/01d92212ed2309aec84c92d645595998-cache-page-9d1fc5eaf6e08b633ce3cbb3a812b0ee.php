...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/email/email-client-setup" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="keywords" content="%default%" />
  <meta name="description" content="Email Client Setup Category" />
  <title>Email Client Setup | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/email/email-client-setup" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:4b2a2d527dca64e3ba69047fdb61d277 -->
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Email Client Setup</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='item-page'>
        ...
        <div class='page-header'>
                <h1>Email Client Setup</h1>
        </div>

<div></div>
<form action="http://www.inmotionhosting.com/support/email/email-client-setup" method="post" name="adminForm" id="adminForm" class="form-inline">
  ...
  <table class='article_list'>
          ...
          <tr>
                  ...
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/email/email-client-setup/common-3rd-party-smtp-settings'>Common 3rd party SMTP settings</a></td>
                                <td>1,836</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/email/email-client-setup/installing-opera-mail-client'>Setting up the Opera Mail Client</a></td>
                                <td>254</td>
                        </tr>
                  </table>
	</form>
