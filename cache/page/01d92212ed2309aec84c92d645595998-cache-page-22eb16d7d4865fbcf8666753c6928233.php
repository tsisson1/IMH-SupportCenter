<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:68886:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/wordpress/wordpress-security-plugins/wp-recaptcha" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-05-09T17:59:42-07:00" />
  <meta name="keywords" content="WP-reCAPTCHA WordPress install how to" />
  <meta name="author" content="John-Paul Briones" />
  <meta name="description" content="Installing the WP-reCAPTCHA plugin in WordPress" />
  <title>How to install WP-reCAPTCHA in WordPress - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/wordpress/wordpress-security-plugins/wp-recaptcha" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<script type="text/javascript">
		...
		_gaq.push(['_setCustomVar', 4, 'DateMonthPublished', '2015-02', 3]);
	...
	<!-- cid:8fc80a5f3b37ac0d0c1bf5f4fd759776 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '109.151.250.177']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to install WP-reCAPTCHA in WordPress									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>3,797</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Feb 18, 2015'><span style='color:#606060;'>Published:</span> May 9, 2016</div>
...
<button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('install-wp-recaptcha');">Install WP-reCAPTCHA</button>
<button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('recaptcha-api-keys');">Setup re-CAPTCHA API Keys</button>
</div>

<p>The <strong>WP-reCAPTCHA</strong> plugin is a good tool for fighting spam in <strong><a href="/support/edu/wordpress">WordPress</a></strong>. It can prevent spammers from posting unwanted comments in your WordPress blog. A captcha is an image made up of letters and numbers, and a user is required to type those same letters and numbers correctly to prove they are not a spam bot. It is difficult for bots to read the image, and therefore prevents automated spam bots from posting in your blog. In this article we'll show you how to install the WP-reCAPTCHA WordPress plugin.</p>

<a name="install-wp-recaptcha"></a>
<h2>Installing WP-reCAPTCHA</h2>
<ol class="article_list">
<li><a href="/support/edu/wordpress/wordpress-introduction/logging-into-wordpress-dashboard">Log into your WordPress Dashboard</a></li>
<li>Roll your mouse over <strong>Plugins</strong>, then click <strong>Add New</strong>.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress/re-captcha/plugins-add-new.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/wordpress/re-captcha/plugins-add-new.png" alt="Installing the WP-reCAPTCHA plugin for WordPress" title="Adding a new plugin in WordPress" /></a></li>
<li>In the search box type <strong>wp-recaptcha</strong> and hit enter. Click <strong>Install Now</strong> next to the <em>WP-reCAPTCHA</em> plugin.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress/re-captcha/wp-recaptcha-install-now.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/wordpress/re-captcha/wp-recaptcha-install-now.png" alt="Setup WordPress Captcha" title="Install WP-reCAPTCHA now." /></a></li>
<li>On the next screen click the <strong>Activate Plugin</strong> link, and the WP-reCAPTCHA plugin will be installed and enabled.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress/re-captcha/activate-wp-recaptcha-plugin.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/wordpress/re-captcha/activate-wp-recaptcha-plugin.png" alt="Turning WP-reCPTCHA plugin on" title="Activating the WP-reCAPTCHA plugin in WordPress" /></a><br></li>
</ol>



<a name="recaptcha-api-keys"></a>
<h2>How to setup the reCAPTCHA API Keys</h2>

<ol class="article_list">
<li>Go to the Google reCAPTCHA Admin page (<a href="https://www.google.com/recaptcha/admin" target="_blank">https://www.google.com/recaptcha/admin</a>), click the doamin you want to use the reCAPTCHA keys for.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress/re-captcha/manage_your_recaptcha_keys.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/wordpress/re-captcha/manage_your_recaptcha_keys.png" alt="WP-reCAPTCHA setup" title="Accessing reCAPTCHA Keys" /></a><br><br>
<div class="alert alert-danger">If you have not registered your site for Google reCAPTCHA, you can do so on the bottom of this page. It is also covered in our guide <public-private-key-google-recaptcha>How to get the public and private keys for Google reCAPTCHA</a></div></li>

<li>On the next page click the <strong>Keys</strong> link, under <em>Adding reCAPTCHA to your site</em>. You will then see your <strong>Site key</strong>, and <strong>Secret Key</strong> listed, save them for later use. For example, you can copy and paste them into a <em>.txt</em> document.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress/re-captcha/recaptcha-site-secret-keys.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/wordpress/re-captcha/recaptcha-site-secret-keys.png" alt="WP-reCAPTCHA setup" title="Secret Keys in reCAPTCHA" /></a></li>

<li><a href="/support/edu/wordpress/wordpress-introduction/logging-into-wordpress-dashboard">Log into your WordPress Dashboard</a></li>

<li>Click <strong>Plugins</strong>, then click <strong>Settings</strong> under <em>WP-reCAPTCHA</em>.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress/re-captcha/plugins-wp-recaptcha-settings.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/wordpress/re-captcha/plugins-wp-recaptcha-settings.png" alt="WordPress Captcha settings" title="WP-reCAPTCHA Settings" /></a></li>
<li>Enter your <strong>Site Key</strong>, and <strong>Secret Key</strong>, then click the <strong>Save reCAPTCHA Changes</strong> button. You are finished when you see a <em>Settings saved</em> message.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress/re-captcha/wp-recaptcha-settings-saved.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/wordpress/re-captcha/wp-recaptcha-settings-saved.png" alt="WordPress CAPTCHA Setup" title="WP-reCAPTCHA Setup Complete" /></a><br>
<p>Now when visitors post a <em>Comment</em> or <em>Register</em> for your site, they will have to complete a re-CAPTCHA validation, to prove they are human. See the examples below.</p>
<table class="article_table" align="center" border="0">
<tbody>
<tr><th colspan="4">
<div align="center">Examples of WP-reCAPTCHA</div>
</th></tr>
<tr><th style="text-align: center;">Comment Page:</th><th style="text-align: center;">Registration Page:</th></tr>
<tr>
<td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress/re-captcha/wp-recaptcha-comment.png"><img style="display: block; margin-left: auto; margin-right: auto;"  src="//cdn.inmotionhosting.com/support/images/stories/wordpress/re-captcha/wp-recaptcha-comment.png" alt="Example of WP-reCAPTCHA" title="WP-reCAPTCHA on Comment" width="200" /></a></td>
<td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress/re-captcha/wp-recaptcha-registration-page.png"><img style="display: block; margin-left: auto; margin-right: auto;"  src="//cdn.inmotionhosting.com/support/images/stories/wordpress/re-captcha/wp-recaptcha-registration-page.png" alt="Example of WP-reCAPTCHA" title="WP-reCAPTCHA on Registration page" width="200" /></a></td>
</tr>
</tbody>
</table></li>
</ol>
<br>
<p>You now have a CAPTCHA system for your <a href="/support/edu/wordpress">WordPress</a> blog, and the amount of Spam to your site should be reduced!</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 13: How to install WP-reCAPTCHA in WordPress</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 12: <a href='/support/edu/wordpress/wordpress-security-plugins/how-to-install-the-secure-folder-wp-content-uploads-plugin-for-wordpress'>How to install the Secure Folder wp-content/uploads plugin for WordPress</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 14: <a href='/support/edu/wordpress/wordpress-security-plugins/cleff-login-no-phone-service'>Logging in with Clef when you have no Internet connection on your Phone</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zNjcmaWQ9MzUwNyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="e884db88e99b1909c6c9fabac742c3bc" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<table><tr><td colspan='2'><h4>Overview of Security Plugins</h4></td></tr>  <tr >
                        <td valign='top'>1.</td>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/5feac1ee92a330be501a2e932b46928e?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/5feac1ee92a330be501a2e932b46928e'>Biking in Bangkok</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-02-22 8:11 am</div>
				                <div><p>Thank you for this article. I had a massive problem on my gobangkoktours website and thanks to your article I managed to get it sorted!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30722);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
