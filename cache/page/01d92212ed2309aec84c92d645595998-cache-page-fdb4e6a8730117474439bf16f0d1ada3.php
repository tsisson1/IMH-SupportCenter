<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:64761:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/prestashop-15/working-with-orders/edit-order-message" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-09-05T18:46:12-07:00" />
  <meta name="keywords" content="edit order message PrestaShop 1.5" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="This PrestaShop 1.5 article walks you through editing an Order Message." />
  <title>How to edit an Order Message in PrestaShop 1.5  - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/prestashop-15/working-with-orders/edit-order-message" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:bb5b8001f62c6301923a157c21c7b5bc -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '154.52.129.34']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to edit an Order Message in PrestaShop 1.5 									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>2,672</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Aug 21, 2012'><span style='color:#606060;'>Published:</span> Sep 5, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>This tutorial will demonstrate how to change an order message in PrestaShop 1.5. After learning how to <a href="/support/edu/prestashop-15/working-with-orders/add-order-message">create an order message</a>, you may want to learn how to edit it. This way you can change your message accordingly without having to create a brand new one. Follow along below as we show you how.</p>
<p><strong>Modifying order messages in PrestaShop 1.5</strong></p>
...
<li>Using the top menu bar, hover over the <strong>Orders</strong> tab and click on the <strong>Order Messages</strong> option.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Orders/Order_Messages/_order-messages.png"><img  alt="_order-messages" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Orders/Order_Messages/_order-messages.png" /></a> </li>
<li>You are now on the <strong>Order Messages</strong> screen. Find the message you want to work with, for example you may want to edit the default <em>Delay </em>message, or your newly added messages.. To edit the message, simply click on the <strong>Edit</strong> button located on the right hand side of the row. The edit button is the pencil and paper icon. <br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Orders/Order_Messages/Edit/edit-message.png"><img  alt="edit-message" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Orders/Order_Messages/Edit/edit-message.png" /></a></li>
<li>This brings you to the <strong>Order Messages</strong> edit screen. From here, simply make the changes you require in the Title or Message fields.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Orders/Order_Messages/Edit/edit-message-done.png"><img  alt="edit-message-done" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Orders/Order_Messages/Edit/edit-message-done.png" /></a></li>
<li>Once you have made your changes, click on the green <strong>Save</strong> button in the upper right corner. This saves your edited message and brings you back to the order message list page.      <br />&nbsp;<br /><br /></li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 6: How to edit an Order Message in PrestaShop 1.5 </div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 5: <a href='/support/edu/prestashop-15/working-with-orders/add-order-message'>How to add an Order Message in PrestaShop 1.5</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 7: <a href='/support/edu/prestashop-15/working-with-orders/remove-order-message'>How to delete an Order Message in PrestaShop 1.5 </a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/prestashop-15/working-with-orders/edit-order-message&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/prestashop-15/working-with-orders/edit-order-message'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNTUmaWQ9MTcwNiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="5dd937a10653a304d552f02eb8e5d978" value="1" />	</div>
	</form>
<!-- <br />
