<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:64928:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/wordpress-plugins/monitoring-wordpress-file-changes-with-ithemes-security" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-12-17T17:02:27-08:00" />
  <meta name="author" content="Jeff Matson" />
  <meta name="description" content="In this article, we will show you how to monitor file changing within your WordPress site using iThemes Security." />
  <title>Monitoring WordPress file changes with iThemes Security - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/wordpress-plugins/monitoring-wordpress-file-changes-with-ithemes-security" rel="canonical" />
...
<script>
  ...
  ga('send', 'pageview');
	...
	<!-- cid:78e5c84c75235f5a169a5c681697d8cc -->
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Monitoring WordPress file changes with iThemes Security</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Monitoring WordPress file changes with iThemes Security									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>338</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Nov 13, 2014'><span style='color:#606060;'>Published:</span> Dec 17, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>If you are running a WordPress site, one of the most important things to do is ensure that you know what is going on at all times.  plugins such as <a href="http://www.inmotionhosting.com/support/website/wordpress-plugins/viewing-your-wordpress-site-activity-with-stream">Stream</a> and <a href="http://www.inmotionhosting.com/support/website/wordpress/configuring-text-message-notifications-in-wordpress">WP SMS Notifications</a> can easily notify you of changes in the WordPress admin as well as via text message, but what if you need to simply receive emails of file changes without any additional reporting?  Thankfully, iThemes Security has you covered.  In this article, we will show you how to use iThemes Security to monitor any files that have been changed on your site.</p>
<ol class="article_list">
  ...
  <li style='clear:both;'><p>This article assumes that you already have iThemes Security installed.  If you do not yet have it installed, you may follow our guide on <a href="http://www.inmotionhosting.com/support/www.inmotionhosting.com/support/website/wordpress-plugins/installing-the-ithemes-security-wordpress-plugin">installing iThemes Security</a>.</p></li>
  <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/ithemes-security-file-change-1.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/ithemes-security-file-change-1.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>Next, you will need to navigate the the iThemes Security settings page.  To do so, hover over <strong>Security</strong> on the left side menu and click on <strong>Settings</strong></p></li>
  <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/ithemes-security-file-change-2.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/ithemes-security-file-change-2.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>Within the <strong>Settings</strong> page, scroll down to the heading labeled <strong>File Change Detection</strong>.</p></li>
  <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/ithemes-security-file-change-3.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/ithemes-security-file-change-3.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>In this section, enable the checkbox labeled <strong>File Change Detection</strong>.</p></li>
  <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/ithemes-security-file-change-4.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/ithemes-security-file-change-4.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>Next, it is a good idea to select the option labeled <strong>Split File Scanning</strong>.  The reason behind this is because it splits the file scan into several different chunks, ensuring that you use less resources on the server.</p></li>
  <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/ithemes-security-file-change-5.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/ithemes-security-file-change-5.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>If you have any files that change regularly, such as a caching plugin, you can exclude it within the <strong>Files and Folders List</strong>.  This will ensure that you will not be alerted of changes to content that is expected to change constantly such as a cache file.</p></li>
  <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/ithemes-security-file-change-6.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/ithemes-security-file-change-6.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>If you enable the <strong>Email File Change Notifications</strong> checkbox, emails will be sent to the email address defined within the global settings for iThemes Security when any files are changed.  Most users will want this setting enabled, but if you don't simply uncheck the box.</p></li>
  <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/ithemes-security-file-change-7.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/ithemes-security-file-change-7.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>The <strong>Display file change admin warning</strong> checkbox will allow you to be notified within your WordPress dashboard when files have been changed.  If you want to enabled this, simply check the checkbox.</p></li>
  <li style='clear:both;'><p>Once you settings are set as you want them, click the <strong>Save All Changes</strong> button.</p></li>
</ol>
<p>You should now receive notifications within your dashboard, via email, or both when files are changed.</p>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/wordpress-plugins/monitoring-wordpress-file-changes-with-ithemes-security&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/wordpress-plugins/monitoring-wordpress-file-changes-with-ithemes-security'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NjcmaWQ9MzQ1MCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="caa173bbfadac43902f23b95632775a5" value="1" />	</div>
	</form>
<!-- <br />
