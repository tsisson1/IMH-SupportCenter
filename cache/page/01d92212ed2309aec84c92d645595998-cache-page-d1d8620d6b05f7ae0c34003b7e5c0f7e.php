<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:61588:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/ssh/how-to-edit-files-using-nano" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-04-21T23:08:36-07:00" />
  <meta name="keywords" content="edit file ssh pico nano vi vim" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="Learn how to edit files using nano via SSH." />
  <title>How to edit files while in ssh using nano - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/ssh/how-to-edit-files-using-nano" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:b447adb15af94e7f66874b9878585fe1 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '89.146.95.78']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to edit files while in ssh using nano									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>16,046</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Dec 8, 2011'><span style='color:#606060;'>Published:</span> Apr 21, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<p>There are several programs available for you to use to edit files while in the Linux command line. Here at InMotion Hosting, our System Administration team primarily uses programs called nano and vi. Vi is a very sophisticated program with somewhat of a high learning curve. Because of this, we're going to show you how to edit files using nano.</p>
<p>When editing files with nano, the first thing you'll need to do is make sure that you've connected to your server via SSH. If you need assistance with doing this, please see <a href="/support/website/general-server-setup/how-to-login-ssh">How to login to your server via SSH</a>.</p>
<p>We're currently logged in, so let's run pwd to see what directory we're in, and then ls to see what files are in this directory:</p>
<p class="cli"><em>user5@example.com [~/testa]#</em> <strong>pwd</strong><br /> /home/user5/testa<br /> <em>user5@example.com [~/testa]#</em> <strong>ls -alh</strong><br /> total 8.0K<br /> drwxr-xr-x   2 user5 user5 4.0K Dec  7 18:43 ./<br /> drwx--x--x  10 user5 user5 4.0K Dec  6 08:16 ../<br /> -rw-r--r--   1 user5 user5    0 Dec  7 18:43 file1.txt<br /> -rw-r--r--   1 user5 user5    0 Dec  7 18:43 file2.txt<br /> -rw-r--r--   1 user5 user5    0 Dec  7 18:43 file3.txt</p>
<p>As you can see, we're in the testa folder, and there are currently three files: file1.txt, file2.txt, and file3.txt. If we wanted to edit file2.txt using nano, enter the following command:</p>
<p class="cli"><em>user5@user5.bradmarkle.com [~/testa]#</em> <strong>nano file2.txt</strong></p>
<p>After running this command, the nano file editor will open and load the contents of file2.txt:</p>
<p class="cli">GNU nano 1.2.4&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;File: file2.txt<br /> <br /> <br /> <br /> <br /> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[ Read 0 lines ]<br /> <strong>^G</strong> Get Help  <strong>^O</strong> WriteOut  <strong>^R</strong> Read File <strong>^Y</strong> Prev Page <strong>^K</strong> Cut Text  <strong>^C</strong> Cur Pos<br /> <strong>^X</strong> Exit      <strong>^J</strong> Justify   <strong>^W</strong> Where Is  <strong>^V</strong> Next Page <strong>^U</strong> UnCut Txt <strong>^T</strong> To Spell</p>
<p>What you're looking at above is a blank file loaded into nano. The top line shows the version of nano you're using and the name of the file you're editing. The bottom part of the screen includes all of the commands that you can run.</p>
...
<p>Then what?</p>
<p>The commands at the bottom of the page are executed by holding down Ctrl on your keyboard followed by the letter listed. For example, if you wanted to save the file (referred to as "WriteOut"), hold <strong>Ctrl + O</strong> on your keyboard. When you're ready to exit nano, hold <strong>Ctrl + X</strong> and you will be exited from the application.</p>
<h3>Looking For Dedicated Hosting?</h3>
<p>Using SSH provides a faster method for managing a dedicated server hosting environment. You can learn more about what makes else makes dedicated servers so fast <a href="/support/../dedicated_servers/articles/fast-dedicated-server.html">here</a>.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/ssh/how-to-edit-files-using-nano&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/ssh/how-to-edit-files-using-nano'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MTEmaWQ9Nzcmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="1e88e6d077308c8eeb4380b987e3bb96" value="1" />	</div>
	</form>
<!-- <br />
