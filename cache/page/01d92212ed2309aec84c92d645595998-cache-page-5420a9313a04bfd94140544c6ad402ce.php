...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-3/admin-tools/brute-force-protection" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-02-25T13:59:23-08:00" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="The password-protect administrator feature within the Admin Tools Joomla component can help protect your site from brute force login attempts." />
  <title>Protect your Joomla 3 admin dashboard from Brute Force logins - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-3/admin-tools/brute-force-protection" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:034d20da5aef56d4fef25a51f130354f -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Protect your Joomla 3 admin dashboard from Brute Force logins									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>2,623</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Feb 20, 2014'><span style='color:#606060;'>Published:</span> Feb 25, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>The <a href="/support/edu/joomla-3/admin-tools">Admin Tools Joomla component</a> can be used to protect your Joomla website against <a href="/support/website/security/stopping-brute-force-and-spam-attacks">brute force attacks</a>. In a nutshell, a brute force attack is when hackers repeatedly guess your Joomla password over and over again until they get it right and login to your dashboard.</p>


<p>Enabling the <strong>password-protect administrator</strong> feature within <em>Admin Tools</em> adds another layer of security to your Joomla dashboard, making it even harder for hackers to guess your <a href="/support/website/security/an-introduction-to-password-security">secure password</a> and get into your dashboard.</p>
...
<li><a href="/support/edu/joomla-3/getting-started/login-dashboard">Log into your Joomla 3 dashboard</a></li>
  ...
  <li>If you haven't already, <a href="/support/edu/joomla-3/admin-tools/install">install the Admin Tools component</a></li>

<li>In the top menu of your Joomla Dashboard, click <strong>Components</strong> and then click <strong>Admin Tools</strong></li>

<li>Find and click on the button that says <strong>Password-protect Administrator</strong></li>

<li>Enter a <strong>Username</strong>, enter a <strong>Password</strong>, and then <strong>Retype password</strong>.</li>

<li>
  <p>Click the <strong>Password-protect</strong> button.</p>
  
  <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/admin-tools/htaccess-login.jpg"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/admin-tools/htaccess-login.jpg"  style="float:right; margin:0px 0px 15px 15px;" /></a>
  
  <p>As soon as you click the <em>Password-protect</em> button, your admin dashboard will be password protected. You will then be required to type in the username and password that you just setup.</p>
  
  <p>Your Joomla dashboard is now protected from brute force login attempts with an additional layer of security. If there are any bots attempting to guess your passwords, they will now need to guess two sets of username and passwords, making the task much more infeasible.</p>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/joomla-3/admin-tools'>212: Joomla 3 Admin Tools Core Component</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 2: Protect your Joomla 3 admin dashboard from Brute Force logins</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 1: <a href='/support/edu/joomla-3/admin-tools/install'>Admin Tools Core - Installation guide for Joomla 3</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-3/admin-tools/brute-force-protection&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-3/admin-tools/brute-force-protection'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00OTgmaWQ9MzExNSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="08d7be1ccc072e33697a085529037967" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/joomla-3/admin-tools?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Joomla 3 Admin Tools Core Component</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/joomla-3/admin-tools/install?tsrc=rsbedu'>Admin Tools Core - Installation guide for Joomla 3</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/joomla-3/admin-tools/brute-force-protection?tsrc=rsbedu'>Protect your Joomla 3 admin dashboard from Brute Force logins</a></td>
                </tr>
          	</table>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/19982941c2b5e1e7a1b3ea9f579d265c?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/19982941c2b5e1e7a1b3ea9f579d265c'>Sid Nadakatti</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-11 5:40 am</div>
				                <div><p>It will not solve the problem. When the access is blocked, how can a person can log in to the site?</p>
<p>&nbsp;</p>
<p>You need to provide solution via c panel or some other solution</p>
<p>&nbsp;</p>
<p>http://***********domains.com</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13867);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-11 1:04 pm</div>
				                <div>Hello Sid,<br />
<br />
Thank you for your question. The official <a href="https://www.akeebabackup.com/documentation/admin-tools/admin-pw-protection.html" target="_blank" >Admin Tools</a> page states you can "<em>gain access to your site's administrator back-end is to remove the .htaccess and .htpasswd files from your administrator directory using an <a href="http://www.inmotionhosting.com/support/website/ftp/getting-started-guide">FTP</a> application or the <a href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-file-manager/using-file-manager-in-cpanel">File Manager</a></em>."<br />
<br />
You do not need to login to the <a href="http://www.inmotionhosting.com/support/edu/joomla-3/getting-started/login-dashboard">Joomla Dashboard</a> to use <strong>FTP</strong> or <strong>File manager</strong>.<br />
If you have any further questions, feel free to post them below.<br />
Thank you,<br />
<br />
-John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13894);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
