<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:57726:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/prestashop-15/325-geolocation-install" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-11-13T20:13:55-08:00" />
  <meta name="keywords" content="install configure use geolocation module prestashop 1.5" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Learn to install and use the Geolocation module in PrestaShop 1.5" />
  <title>325: Prestashop 1.5 Geolocation module installation and configuration - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/prestashop-15/325-geolocation-install" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:99ead11b465ea50749ec36c7cfaa1e2c -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '174.129.228.67']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															325: Prestashop 1.5 Geolocation module installation and configuration									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>1,194</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Nov 13, 2012'><span style='color:#606060;'>Published:</span> Nov 13, 2012</div>
...
<li>From the Modules list screen, scroll down until you find the module named <strong>Geolocation</strong>. Click on the <strong>Install</strong> button located to the right of the module's row.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Modules/geolocation-module/1-geolocation-install.png"><img  alt="1-geolocation-install" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Modules/geolocation-module/1-geolocation-install.png" /></a></li>
<li>Once installed, you will see a successful installation message on the screen. Fromhere, click on the <strong>Configure</strong> link to go to the next step.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Modules/geolocation-module/2-click-configure.png"><img  alt="2-click-configure" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Modules/geolocation-module/2-click-configure.png" /></a></li>
<li>Once on the configuration screen, be sure to check any and all valid countries by clicking on the name and validating its location on the map.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Modules/geolocation-module/3-configure.png"><img  alt="3-configure" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Modules/geolocation-module/3-configure.png" /></a><br /><br />To view the module data, usethe top menu bar, hover over the <strong>Stats</strong> tab and select the <strong>Stats</strong> option. From there, look to the left hand sidebar, locate the <strong>Geolocation</strong> option from the menu, anc click on it to display the information map.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Modules/geolocation-module/4-module-view.png"><img  alt="4-module-view" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Modules/geolocation-module/4-module-view.png" /></a><br /><br /></li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 18: 325: Prestashop 1.5 Geolocation module installation and configuration</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 17: <a href='/support/edu/prestashop-15/326-install-google-analytics-module'>326: Prestashop 1.5 Google analytics module installation</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 19: <a href='/support/edu/prestashop-15/334-product-tooltips-module'>334: Configuring the Product Tooltips module in PrestaShop 1.5</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/prestashop-15/325-geolocation-install&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/prestashop-15/325-geolocation-install'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD05OSZpZD0yNDI3JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="86c220b0b6850969986954807a81b586" value="1" />	</div>
	</form>
<!-- <br />
