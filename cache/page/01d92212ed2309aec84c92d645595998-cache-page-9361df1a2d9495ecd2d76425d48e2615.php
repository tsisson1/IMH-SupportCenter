<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:57682:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/cpanel/how-do-i-give-my-developer-access-to-cpanel" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hi steve55, Thanks for posting your question. I'm more than happy to help you today. We have a great article on giving your developer cPanel access. Giv..." />
  <title>How do I give my developer access to cPanel? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/cpanel/how-do-i-give-my-developer-access-to-cpanel" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:1131ba0f58be8a830bc2e975db8b4345 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>How do I give my developer access to cPanel?</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/steve55'>steve55</a>
			<div>8 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-02-16 2:33 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>13,400</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>thanks for the quick response.  A couple of more related questions:<br />
<br />
.1)  How do they access cpanel without going through AMP?<br />
<br />
.2)  The developer can access FTP via Cpanel,so is it necessary to set-up a new FTP user/password?</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_595' id='upvote_answer_595' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='595' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_595').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_595' id='downvote_answer_595' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='595' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_595').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hi Steve55,<br />
<br />
Thanks for posting your additional questions. I'm more than happy to help you today. <br />
<br />
The developers can access cPanel by going to yourdomain.com/cpanel and replacing yourdomain.com with your actual domain. Here's an article outlining the different ways to access cPanel:<br />
<br />
<a href="http://www.inmotionhosting.com/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">How to log into cPanel</a><br />
<br />
As for your second question, there's a few different answers. Your cPanel username and password can actually be used as FTP credentials. There's no need to create another FTP account, especially since they will have access to creating FTP accounts in cPanel anyways. If they wanted you to create a special FTP account for them to use, you could certainly do this as well. Here's an article about creating FTP accounts:<br />
<br />
<a href="http://www.inmotionhosting.com/support/website/file-management/how-do-i-create-a-ftp-account-in-my-control-panel-cpanel">Creating FTP accounts in cPanel</a><br />
<br />
The link above has a flash video on the page. There's no sound on the videos however it will show you the steps to creating a new FTP account in cPanel. <br />
<br />
...
Tim S
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_595').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_595' id='form_comment_on_answer_595' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
...
<div class=' straight_bottom not_best_answer'>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px; width:50px;' valign='top'>
<div class='vote_div'>
	<form method='post' name='upvote_answer_593' id='upvote_answer_593' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='593' />
		<input type='hidden' name='component' id='component' value='qa' />
		<input type='hidden' name='vote_value' id='vote_value' value='1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_593').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_593' id='downvote_answer_593' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='593' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_593').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hi steve55,<br />
<br />
Thanks for <a href='http://www.inmotionhosting.com/support/community-support'>posting your question</a>. I'm more than happy to help you today. We have a great article on giving your developer cPanel access. <br />
<br />
<a href="http://www.inmotionhosting.com/support/website/new-customers/giving-your-developer-account-access">Giving your Developer the right access</a><br />
<br />
If you need further assistance please feel free to contact us.<br />
<br />
Thanks!<br />
...
Tim S
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_593').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_593' id='form_comment_on_answer_593' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
					                <p>You must <a href='/support/login'>login</a> before you can post a comment about this answer.</p>
					        </div></div></div></div>
					</form>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello Tim, Can I not set up a tempoary user and password for my developer for my cpanel?   I really didn't want to change my signon information.</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='/support/images/avatars/default_avatar.jpg' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/triforce'>triforce</a><br />
									9 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2016-02-03 1:32 pm EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello  Triforce,<br />
<br />
There is only  one user for cPanel access.  There is no temporary user.  If you  want to give your developer access, then you're either providing the access piecemeal (as per the  <a href="http://www.inmotionhosting.com/support/website/new-customers/giving-your-developer-account-access" target="_blank">link</a> above), or you're giving complete access.  You can always change the password later in the Account Management Panel (AMP), but that is up to you.  <br />
<br />
...
Arnel C.</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/cpanel/how-do-i-give-my-developer-access-to-cpanel&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/cpanel/how-do-i-give-my-developer-access-to-cpanel'></div>
<script type='text/javascript'>
  (function() {
