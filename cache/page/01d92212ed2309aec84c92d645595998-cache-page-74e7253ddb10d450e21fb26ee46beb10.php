<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:66787:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/wordpress/uploading-a-demo-file-to-wordpress" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Jones105, and thanks for your question! When you attempt to upload your demo.xml file within WordPress, are you using the Tools &amp;gt; Import &amp;gt; W..." />
  <title>Uploading a Demo file to Wordpress | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/wordpress/uploading-a-demo-file-to-wordpress" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:e5eab6ef732f2a3a64459f2d5e1220f0 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box straight_bottom'>
                <h1 style='font-size:26px;'>Uploading a Demo file to Wordpress</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='http://graph.facebook.com/JoshuaNJones/picture?type=normal' class='user_avatar' /><br />
			<a href='/support/community-support/users/Jones105'>Jones105</a>
			<div>36 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-06-10 4:11 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>3,061</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Hi, I purchased a theme for Wordpress from Themeforest.net and installed on Wordpress 3.5.1 with no problems. However, in trying to upload their demo.xml file (with sample page layouts, postings, etc.) the importer will not read the file properly. I contacted the theme designer for support, and they said that it appears to have something to do with file permissions on my server side. Any insight or thoughts on this? Website is www.sagaciastrategies.com  Thanks!<br />
</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_3293' id='upvote_answer_3293' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='3293' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_3293').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_3293' id='downvote_answer_3293' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='3293' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_3293').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Jones105, and thanks for your question!<br />
<br />
When you attempt to upload your &lt;strong&gt;demo.xml&lt;/strong&gt; file within WordPress, are you using the &lt;strong&gt;Tools &amp;gt; Import &amp;gt; WordPress&lt;/strong&gt; option?<br />
<br />
Does it give you a specific error such as it can't create a particular directory or file? You can read our guide about &lt;a href=&quot;http://www.inmotionhosting.com/support/website/how-to/change-file-permissions&quot; target=&quot;_blank&quot;&gt;changing file permissions&lt;/a&gt; that goes over how you can modify your folder and file permissions using cPanel if this is the case.<br />
<br />
I believe what might have happened is that it looks like your &lt;strong&gt;/wp-content/uploads/&lt;/strong&gt; directory had the incorrect permissions of &lt;strong&gt;777&lt;/strong&gt; so I bumped that down to &lt;strong&gt;755&lt;/strong&gt; for you.<br />
<br />
Please let us know if you're still encountering any issues getting it uploaded now.<br />
<br />
- Jacob
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_3293').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_3293' id='form_comment_on_answer_3293' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>That didn't quite do the trick. When I try to upload using Tools&gt;Import&gt;Word Press, it processes the upload, but then asks me to select which user to assign the posts to. I know the demo file has 4 users, but in the &quot;Import Author ()&quot; line there are no users selected to match. If I proceed anyway, it just gives a hundred errors or so and the blog looks the same as before.<br />
<br />
 If there is an option here to attach a file, I can upload either a screenshot of the page, or the xml file if it would help.</div>
							...
							<td style='width:96px;' valign='top'>
								...
								<div class='smallgrey'>
									<a href='/support/community-support/users/Jones105'>Jones105</a><br />
									36 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
...
Arnel C.</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Thanks, Arnel. I have uploaded the demo.xml file to the themes folder under wp-content.<br />
<br />
I do have an existing administrator user and that is an option in the &quot;assign posts to a specific user&quot; - the problem is that it is not actually reading the posts (I know this because the Import Author box does not list any authors from the demo file)<br />
<br />
Thanks for your help!</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Were you able to find it?</div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello Jones105,<br />
<br />
Yes, I was able to get the XML file and test both on my blank Wordpress test site (without the template) and then I created a testadmin (that has since been removed) on your Wordpress account in order to test it on your site.  I only tested it after backing up the database and the WP files. <br />
<br />
I followed the directions in the XML file which asks you to download the Wordpress tool under Import.  When the file is downloaded in my test site, it shows 4 different users but the import does not appear to go - possibly due to missing structures in the site that need to be there. <br />
<br />
After that, I decided to test it on your website since you have the theme loaded.  It gave me a different set of errors, but I can tell that the import is at least partially working.  Here's a screenshot that summarizes all of the errors I'm seeing:  http://grab.by/nqdK.<br />
<br />
...
<br />
Apologies that we cannot find the factor that's causing the import to fail, but at this point it does appear to be something to do with the contents of the import as opposed to server permission settings.  Please let us know if you require any further assistance!<br />
<br />
Regards,<br />
<br />
Arnel C.</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Ok, I removed Wordpress completely and reinstalled. I then grabbed an XML export from an entirely separate wordpress site, and had the same trouble attempting to import. I then deactivated the import tool and installed ReadyMade WordPress Importer and had the same trouble trying to import with it. It seems at this point that it is not the XML file, but something to do with how the server is setup regarding permissions or something. Any advice would be greatly appreciated!<br />
<br />
I installed Wordpress using the script in control panel, and it is the latest version.</div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello Jones105,<br />
<br />
I did not see an error report  within your Wordpress files, to help in troubleshooting, I recommend enabling <a href="http://codex.wordpress.org/Debugging_in_WordPress">WP-DEBUG</a>, as it will provide specific errors when an issue occurs. <br />
<br />
If you suspect a PHP limitation is causing this to fail, you can <a href="http://www.webhostinghub.com/support/website/how-to/update-local-php-settings">increase the limit in the PHP.ini</a> file.<br />
<br />
Please reply with any error messages you receive, after turning on debug mode, and we can provide a specific answer.<br />
<br />
...
-John-Paul</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>I changed the debug settings as you requested and am still having issues. the problem is that as soon as I choose the xml file to upload, the importer is not recognizing it properly. I can proceed to attempt the import, but get over 100 errors, such as:<br />
<br />
Failed to import <br />
Failed to import “test-image-landscape”: Invalid post type <br />
Failed to import “test-image-portrait”: Invalid post type <br />
Failed to import “spectacles”: Invalid post type <br />
Failed to import “canola2”: Invalid post type <br />
Failed to import “dsc20050315_145007_132”: Invalid post type <br />
Failed to import “dsc20050727_091048_222”: Invalid post type <br />
Failed to import “dsc20050813_115856_52”: Invalid post type <br />
etc. etc.<br />
<br />
I dont know anything about modifying the php.ini - not sure I should be the one messing with this??</div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello Jones105,<br />
<br />
After doing some research, this seems to be a common problem. Here is a <a href="http://wordpress.org/support/topic/failed-to-import-invalid-post-type-possible-workaround">link to a workaround</a> I found on Wordpress' official support forum.<br />
<br />
If you have any further questions, feel free to post them below.<br />
Thank you,<br />
<br />
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="187163c178de50bcdd5f55a49d166937" value="1" />	</div>
	</form>
<!-- <br />
