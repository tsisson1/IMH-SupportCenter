<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:58357:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/email/email-client-setup/thunderbird-leaving-a-copy-of-an-email-message-on-the-server-using-pop3" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2011-11-21T18:50:31-08:00" />
  <meta name="keywords" content="pop3 copy message email server" />
  <meta name="author" content="Tim Sisson" />
  <meta name="description" content="Learn how to set up thunderbird to leave a copy of your email message on the server if you are using POP3." />
  <title>Thunderbird: Leaving a copy of an email message on the server using POP3 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/email/email-client-setup/thunderbird-leaving-a-copy-of-an-email-message-on-the-server-using-pop3" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:c6c5a85e1175b6e8c6103e23743cc62f -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '185.75.57.65']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Thunderbird: Leaving a copy of an email message on the server using POP3									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>7,145</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Nov 21, 2011'><span style='color:#606060;'>Published:</span> Nov 21, 2011</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Most email clietns, including Thunderbird, allow you to leave a copy of the emails in your inbox on the server. This can be important since by default POP3 email protocol downlaods the email message from your inbox on the server, then deletes it. For more information about the <a href="/support/edu/everything-email/introduction-email/checking-email-account">differences between POP3 and IMAP</a> please read out article.&nbsp;</p>
<p>If you need help <a href="/support/email/thunderbird/creating-an-email-account-in-thunderbird">configuring your email client</a>, please read our tutorial. Changing your settings to leave a copy on the server is easy. If this is an existing account, you'll need to go to: <strong>Tools &gt; Account Settings &gt; Server Settings</strong></p>
<p>Look under the section "<strong>Server Settings</strong>" and be sure the check box is marked next to "<strong>Leave messages on server</strong>"&nbsp;</p>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/thunderbird.jpg"><img  alt="thunderbird" src="//cdn.inmotionhosting.com/support/images/stories/thunderbird.jpg" /></a></p>
<p class="alert">On newer versions of Mozilla Thunderbird, this box is checked by default.&nbsp;</p>
<p>If you need further assistance please feel free to <a href="/support/website/website-troubleshooting/how-to-get-great-technical-support">contact out support department</a>.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/email/email-client-setup/thunderbird-leaving-a-copy-of-an-email-message-on-the-server-using-pop3&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/email/email-client-setup/thunderbird-leaving-a-copy-of-an-email-message-on-the-server-using-pop3'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NyZpZD03NjImdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="b4bd1bf3d6cb29472010c8c20260d943" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/381191e6886808d05446d3f97af57dcf?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/381191e6886808d05446d3f97af57dcf'>Evelyn</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-06 5:27 pm</div>
				                <div><p>How can I leave a copy of a sent message in the server when using Thunderbird? &nbsp;I can see my inbox but I would like to see message in the sent box.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11246);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-06 6:59 pm</div>
				                <div>Hello Evelyn,<br />
<br />
If you'd like to save a copy of your sent messages on the server you just need to click on the &lt;strong&gt;Copies &amp;amp; Folders&lt;/strong&gt; section under the account.<br />
<br />
Then under the &lt;strong&gt;When sending messages, automatically&lt;/strong&gt; section, ensure that &lt;strong&gt;Place a copy in&lt;/strong&gt; is checked and that the &lt;strong&gt;&quot;Sent&quot; Folder On&lt;/strong&gt; drop-down has your IMAP account selected.<br />
<br />
Please let us know if you had any other questions at all!<br />
<br />
- Jacob</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11248);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
