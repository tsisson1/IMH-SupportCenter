<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49833:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/domain-names/specialized-redirect-with-exceptions" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, Thanks for the question! If you want to re-direct only a certain number of pages from an older site and not ALL of them, then you would need to m..." />
  <title>Specialized redirect with exceptions | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/domain-names/specialized-redirect-with-exceptions" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:1b2ad862ce74205f7877bdc32ee6a428 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Specialized redirect with exceptions</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2014-02-26 6:43 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>27</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>We are about to launch a new site that will eventually replace an older site (both on your server). For now, we want all but a few pages of the old site to redirect to the new site. We would like to have those few pages available as links from the new site.<br />
<br />
Do we need to manually redirect all the pages of the old site (and not the exceptions) or is there an easier way?<br />
<br />
Thank you.</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_4579' id='upvote_answer_4579' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='4579' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_4579').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_4579' id='downvote_answer_4579' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='4579' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_4579').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
Thanks for the question!  If you want to re-direct only a certain number of pages from an older site and not ALL of them, then you would need to manually re-direct them.  If you want to redirect ALL of them, then you can create a re-direct with the wildcard option in the <a href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-manage-domains/setting-up-redirect-cpanel">cPanel Redirects</a>.  You can also use this section of the cPanel to create your individual redirects. <br />
<br />
I hope that helps to clear up the issue!  Please let us know if you require any further assistance.<br />
<br />
Regards,<br />
Arnel C.<br />
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_4579').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_4579' id='form_comment_on_answer_4579' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/domain-names/specialized-redirect-with-exceptions&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/domain-names/specialized-redirect-with-exceptions'></div>
<script type='text/javascript'>
  (function() {
