<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:59991:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-3/contacts-component/contact-redirect" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-11-27T15:18:54-08:00" />
  <meta name="keywords" content="joomla 3.0 contact form redirect" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="You can modify the Contact Redirect setting to change what page users see after filling out a contact form on your Joomla 3.0 website. We'll show you how to find and change this setting in this tutorial." />
  <title>Redirecting forms to specific pages in Joomla 3.1 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-3/contacts-component/contact-redirect" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:5aaa6a2f0d169f9edb7e0192d7dd255d -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Redirecting forms to specific pages in Joomla 3.1									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>7,637</span></div>
							...
							<div style='clear:both;'></div>
								...
								<p>In our <a href="/support/edu/joomla-3/contacts-component/understanding-contact-pages">previous tutorial</a> we showed you how contact forms work in Joomla 3.0. One of the points that we mentioned is that when you submit the form, the page reloads and shows the user a confirmation message that the form was submitted.</p>
<p>You have the option to configure what URL is shown after the form is submitted. By default the same page the form was on will load, but you can change this to anything you'd like (both to another page on your site, or any other page on the web). This setting is referred to as <strong>Contact Redirect</strong>, and we'll show you how to find and change it.</p>
<h2>Changing the Contact Redirect Page</h2>
<ol class="article_list">
<li><a href="/support/edu/joomla-3/getting-started/login-dashboard">Log into your Joomla 3.0 admin dashboard</a></li>
<li>In the top menu, click <strong>Menus</strong> and then click on the menu where your <a href="/support/edu/joomla-3/contacts-component/menu-item">contacts menu item</a> is.</li>
<li>In the list of menu items, click on the <strong>Contacts</strong> menu item you want to change the redirection of</li>
<li>Click the <strong>Advanced Options</strong> tab towards top of the page</li>
<li>Click <strong>Mail Options</strong> to expand the available options under this setting.</li>
<li>Find the <strong>Contact Redirect</strong> setting, enter a url to redirect users to after the form has been submitted, and then click Save in the top left of the page.<br /><br />By default, this setting is blank. In our testing, we set the <em>Contact Redirect</em> setting to another page within our site:<br /><br /><strong>My first blog post</strong><br />http://domain.com/index.php/7-my-first-blog-post<br /><br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/components/contacts/contact-redirect-setting.jpg"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="contact-redirect-setting" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/components/contacts/contact-redirect-setting.jpg" /></a>If you look in the screenshot to the right, you can see that after we submitted the form the user was redirected to index.php/7-my-first-blog-post. The user will still see the confirmation message that their email was sent, that message will instead be shown on the page you setup the redirect to.</li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/joomla-3/contacts-component'>210: Joomla 3 Contacts Component Tutorial</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 5: Redirecting forms to specific pages in Joomla 3.1</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 4: <a href='/support/edu/joomla-3/contacts-component/understanding-contact-pages'>How Contact Forms work in Joomla 3.1</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 6: <a href='/support/edu/joomla-3/contacts-component/captcha-setup'>Using a Captcha with the Contacts Component in Joomla 3.1</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-3/contacts-component/contact-redirect&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-3/contacts-component/contact-redirect'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yOTYmaWQ9MjAxMyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/joomla-3/contacts-component?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Joomla 3 Contacts Component Tutorial</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/joomla-3/contacts-component/new-category?tsrc=rsbedu'>How to create a new Contacts Category in Joomla 3.1</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/joomla-3/contacts-component/new-contact?tsrc=rsbedu'>How to create a new Contact in Joomla 3.1</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/joomla-3/contacts-component/menu-item?tsrc=rsbedu'>How to Create a Contacts Menu Item in Joomla 3.1</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/joomla-3/contacts-component/understanding-contact-pages?tsrc=rsbedu'>How Contact Forms work in Joomla 3.1</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/joomla-3/contacts-component/contact-redirect?tsrc=rsbedu'>Redirecting forms to specific pages in Joomla 3.1</a></td>
                </tr>
          <tr >
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/joomla-3/contacts-component/captcha-setup?tsrc=rsbedu'>Using a Captcha with the Contacts Component in Joomla 3.1</a></td>
                </tr>
          <tr >
                        <td valign='top'>7.</td>
                        <td><a href='/support/edu/joomla-3/contacts-component/search?tsrc=rsbedu'>The Joomla search feature finds your Contacts</a></td>
                </tr>
          	</table>
