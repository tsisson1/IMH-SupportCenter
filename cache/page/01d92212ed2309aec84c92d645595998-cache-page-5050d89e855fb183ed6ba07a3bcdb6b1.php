<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:52627:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/email/cannot-set-returnpath-in-phps-mail-function" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, If you specify a return address within the php mail script the it should go to that address and not you cpanel account. Best Regards, TJ Edens..." />
  <title>Cannot set Return-Path in PHP's Mail Function | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/email/cannot-set-returnpath-in-phps-mail-function" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:73113609707061cd19e634eebda901ba -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Cannot set Return-Path in PHP's Mail Function</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/justbgun'>justbgun</a>
			<div>24 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-03-06 2:40 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>191</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Can you confirm that because I am on a shared server, using PHP's Mail function, the &quot;Return-Path&quot; I specify in my script is going to be over-ridden and set to my-cpanel-username at ecbizXXX.inmotionhosting.com because the address I specify is not in EXIM's trusted users configuration and that cannot be done on a shared server?<br />
<br />
Thanks<br />
Rick</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_6702' id='upvote_answer_6702' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='6702' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_6702').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_6702' id='downvote_answer_6702' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='6702' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_6702').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
If you specify a return address within the php mail script the it should go to that address and not you cpanel account.<br />
<br />
Best Regards,<br />
TJ Edens
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_6702').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_6702' id='form_comment_on_answer_6702' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
...
I have a From: Reply-To: and Return-Path: all set to the same valid my-domain address in the header.  The message is sent to a valid my-domain address and the valid yahoo address.  In both cases, the &quot;Return-Path&quot; I specified is removed and replaced with a &quot;Return-path&quot; (lowercase &quot;p&quot; intentional) pointing to the cpanel user.<br />
I'm glad the messages are going through but I'd also like any Delivery Failure Notifications to come to the correct email address.<br />
Regards,<br />
Rick</div>
							...
							<td style='width:96px;' valign='top'>
								...
								<div class='smallgrey'>
									<a href='/support/community-support/users/justbgun'>justbgun</a><br />
									24 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2015-03-06 7:58 pm EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>I finally got it to accept the fifth parameter &quot;-r valid my-domain address&quot; and it stopped over-riding the Return-Path.<br />
<br />
Regards,<br />
Rick</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello Justbgun,<br />
<br />
I wanted to make sure that everything is working for you now. <br />
<br />
Best Regards,<br />
TJ Edens.</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/email/cannot-set-returnpath-in-phps-mail-function&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/email/cannot-set-returnpath-in-phps-mail-function'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="a4290fba4174257540f82ff8a93081cf" value="1" />	</div>
	</form>
<!-- <br />
