<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:54750:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/phplist/301-process-bounces-from-gmail-in-phplist" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-03-19T23:25:00-07:00" />
  <meta name="keywords" content="phplist gmail bounce bounces bounce-back" />
  ...
  <title>301: Process bounces from Gmail in phpList - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/phplist/301-process-bounces-from-gmail-in-phplist" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:245a9cf6c646b08f4aef3af2396bcc18 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-22']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '86.98.11.10']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															301: Process bounces from Gmail in phpList									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;' title='Originally published: Apr 2, 2013'><span style='color:#606060;'>Published:</span> Mar 19, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In this article I'll go over how you can process your phpList bounces when you are using a Gmail account as your bounce address.</p>

<p>If you've ready my previous article on <a href="/support/edu/phplist/sending-messages/handling-bounces" target="_blank">handling bounces with phpList</a>, that covers how you can use phpList to process bounce-back messages for the mailings you've been sending out via phpList.</p>
...
<p>In order to correctly connect to Gmail's servers the following files need to be modified. I would recommend taking a look at our guide on <a href="/support/website/how-to/how-to-edit-a-file" target="_blank">how do I edit a file on my server</a> if you are unsure how to navigate to these files to modify them.</p>

<p><strong>/config/config.php</strong></p>

<p class="code_block" style="width: 500px;">
$message_envelope = 'username@gmail.com';<br />
$bounce_protocol = 'pop';<br /><br />  
  
$bounce_mailbox_host = 'pop.gmail.com';<br />
$bounce_mailbox_user = 'username@gmail.com';<br />
...
<p class="code_block" style="width: 500px;">
  $bounce_mailbox_port = "<strong style="color: red;">995/pop3/ssl</strong>";
</p>
...
<p class="code_block" style="width: 500px;">
  function processPop ($server,$user,$password) {<br />
$port =  $GLOBALS["bounce_mailbox_port"];<br />
if (!$port) {<br />
$port = '110/pop3/notls';<br />
}
</p>
...
<p class="code_block" style="width: 500px;">
  function processPop ($server,$user,$password) {<br />
  $port =  $GLOBALS["bounce_mailbox_port"];<br />
  <strong style="color: red;">#</strong>if (!$port) {<br />
  <strong style="color: red;">#</strong>$port = '110/pop3/notls';<br />
  <strong style="color: red;">$port = '995/pop3/ssl';</strong><br />
...
<p>You should now understand how you can configure phpList so that it can process bounces for you from a Gmail account.</p>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/phplist'>phpList</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 2: 301: Process bounces from Gmail in phpList</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 1: <a href='/support/edu/phplist/302-disable-browser-resize-in-phplist'>302: Disable browser resize in phpList</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/phplist/301-process-bounces-from-gmail-in-phplist&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/phplist/301-process-bounces-from-gmail-in-phplist'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xMDkmaWQ9MjU3OSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="3101a56b107d7ab3eb2a154b4644ebe9" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/01165a5a5dfdae47c8491d8926d907ea?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/01165a5a5dfdae47c8491d8926d907ea'>JH</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-17 3:27 pm</div>
				                <div><p>You cannot edit <strong>processbounces.php</strong>Just Add<strong> $bounce_mailbox_port = "995/pop3/ssl/novalidate-cert";</strong></p>
<p><strong>in config.pgo</strong></p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28502);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
