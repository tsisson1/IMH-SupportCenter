<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:85781:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/prestashop-16/change-shop-name" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-03-17T14:44:58-07:00" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Learn how to change your PrestaShop 1.6 shop name." />
  <title>How to change your shop name in PrestaShop 1.6 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/prestashop-16/change-shop-name" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:1ab9c03988ad094258410e1e262135f5 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '109.173.144.52']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to change your shop name in PrestaShop 1.6									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>9,368</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Mar 27, 2014'><span style='color:#606060;'>Published:</span> Mar 17, 2015</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Changing the shop name can be done in two ways - through the PrestaShop Administrator interface and through the database. The easy way is definitely using the Administrator, but there may be occasions where the name has to be changed through the database.  Changing the shop name through the database may seem a bit daunting to anyone unfamiliar with moving around the cPanel and database tool. There are two ways to alter the data in the databse using the <em>phpMyAdmin</em> tool. One is to run a query and the other is to navigate the rows and do a direct edit. We cover both methods below.

<h3>Using the PrestaShop 1.6 Administrator Dashboard</h3>
<ol class="article_list">
  <li>Log into your <a href="http://www.inmotionhosting.com/support/prestashop-16/admin-login">PrestaShop 1.6 Administrator Dashabord</a>.<div style="clear:both;"></div></li>
  <li>Once you're in the PrestaShop Administrator, click on <b>PREFERENCES</b>, then scroll down to and click on <b>Store Contacts</b>.</li>
  <li>In <b>Store Contacts</b>, click on the <i>Shop Name</i> field and change the name entry as needed.<div style="clear:both;"></div></li>  
  <li>Click on <b>SAVE</b> to preserve your changes.</li>
</ol>   
  
  
<h3>Accessing the phpMyAdmin tool</h3>
<p>First we need to get to the phpMyAdmin tool.</p>
<ol class="article_list">
  <li>Log into your cPanel dashboard.<div style="clear:both;"></div></li>
  <li>Find the <em>Databases</em> category and click on the <strong>phpMyAdmin</strong> icon.<div style="clear:both;"></div></li>
  <li>Once inside the phpMyAdmin tool, click on the Databases tab. This brings up a list of databases in your account. Click on the name of your PrestaShop database.<div style="clear:both;"></div></li>  
</ol>

<h3>Using a direct table edit</h3>
<ol class="article_list">
  <li>Once you select the database the screen will list all of the tables. <div style="clear:both;"></div></li>
  <li>Scroll down and click on the <strong>ps_configuration</strong> table. (note this assumes you are using the default <em>ps_</em> prefix.)<div style="clear:both;"></div></li>
  <li>The new screen displays all the rows in the <em>ps_configuration</em> table. Scroll down and click on the <strong>Value</strong> column (the 5th one) of the <em>PS_SHOP_NAME</em> row. In the default PrestaShop 1.6 database, this is around row number 235. The <em>'value'</em> column has the current shop name in it.<div style="clear:both;"></div></li>
  <li>The column will allow you to edit the name of the shop. Enter the new name and click <em>Enter</em>.<div style="clear:both;"></div></li>
</ol>


<h3>Using a SQL Query</h3>
<p>If you are familiar with using a SQL Query, this can be a faster method.</p>
<ol class="article_list">
  <li>Once the database tables appear on the screen, look to the tabs at the top of the screen and click on the <strong>SQL</strong> tab.<div style="clear:both;"></div></li>
  <li>This brings you a blank SQL Query screen where you can enter and run your query. The specific query you need to run is below. The only thing you need to change is "New Shop Name". Change that to be your desired store name, be sure to keep the quotes around the name.
    <div class="code_block">UPDATE ps_configuration SET value = "New Shop Name" WHERE name ="PS_SHOP_NAME"</div>
  <div style="clear:both;"></div></li>
  <div>Once entered, click on the <strong>Go</strong> button in the lower right corner. Once the query runs you should get a success message at the top of the screen.<div style="clear:both;"></div></li>
</ol>

<p>Now that you have changed the shop name in the database, visit your site. The shop name will appear in the tab of the browser for the storefront. It will also appear in the upper left corner of the back office. Enjoy your newly named store.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/prestashop-16/change-shop-name&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/prestashop-16/change-shop-name'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00OTMmaWQ9MzE3NyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="e111d7310c690f0346275a7cf419b467" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/prestashop-15/showing-as-my-store-in-search-engines-2?tsrc=rsbraq'>showing as my store in search engines</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/14afbf977108b88feca63fb09cc5869e?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/14afbf977108b88feca63fb09cc5869e'>RPP</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-25 6:41 am</div>
				                <div><p>Hi,</p>
<p>&nbsp;</p>
<p>thanks for the guide. I changed it in BO, which did not work, followed your guide and the correct name is already in the field, but still will not display in BO.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11973);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-25 9:28 am</div>
				                <div>Hello RPP,<br />
<br />
I am happy your shop name changed on the front end. You say it is not showing the new name in the BO? In my testing I am seeing the new name in the BO. Where in the BO are you seeing the old shop name? If it is something I can identify and fix I would like to update the article.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11985);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-25 9:34 am</div>
				                <div><p>I am still seeing "my ecommerce" in the top left of the BO, also at the end of page titles.http://puu.sh/9Jqzm/3cfc63d0cd.png</p>
<p>Strange thing is that when viewed in myphpadmin it does show the updated name.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11986);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-25 9:41 am</div>
				                <div>Hello RPP,<br />
<br />
Thanks for the quick response. The corner does get that info from the field that was changed. Try and clear your browser cache to see if that is the issue. <br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11987);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 160px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-25 9:53 am</div>
				                <div><p>Hi,</p>
<p>No, that still does not work. In fact I have had this issue since 1.5 on different projects I have worked on, even when it has been changed in the database it never seem to update the BO.</p>
<p>Thank you for your help!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11989);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 200px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-25 10:01 am</div>
				                <div>Hello RPP,<br />
<br />
That is very odd, it should change immediately for you or at least after clearing cache. Are you one of our customers? If so, I could try and take a look for you. I would need the domain name to do so, but I can remove it from a post before it goes public if you like.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11990);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-17537'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/2035e717ef6c4fdcf7cca76dbd7ee281?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/2035e717ef6c4fdcf7cca76dbd7ee281'>muhte?em k&uuml;&ccedil;&uuml;k</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-18 5:59 am</div>
				                <div><p>thanks &nbsp;</p>
<h1 style="margin: 0px; font-family: adelle, sans-serif; line-height: 33px; text-rendering: optimizelegibility; padding: 0px; font-size: 24px; background-color: rgb(249, 249, 249);">How to change your contack mail adress in PrestaShop 1.6 ???????????</h1>
<p>&nbsp;</p>
<div style="font-family: adelle-sans, Helvetica, Arial, sans-serif; line-height: 22px; font-size: 12px; color: rgb(170, 170, 170); margin-bottom: -10px; padding-top: 5px; background-color: rgb(249, 249, 249);">&nbsp;</div></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17537);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-18 9:54 am</div>
				                <div>To do so, click on &lt;strong&gt;Modules&lt;/strong&gt;, and edit the block named &lt;strong&gt;Contact Information Block&lt;/strong&gt;.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17549);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/2035e717ef6c4fdcf7cca76dbd7ee281?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/2035e717ef6c4fdcf7cca76dbd7ee281'>muhtesem </a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-20 1:12 pm</div>
				                <div><p>I say save the site name and email address, change the settings menu. When I update the page comes reinstated.</p>
<p>How can I change the e-mail address with the php my admin as we change the site name.?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17666);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-20 2:29 pm</div>
				                <div>Hello muhtesem,<br />
<br />
Thank you for contacting us. Yes,  you can change your email address via PHPmyAdmin. <br />
<br />
It is located in the <strong>employees</strong> table. Just replace the existing email address with the new one.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17668);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-21718'></a>
		<div  style='margin:2px 0px 0px 80px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/57420486209d6ac9b60a5ee2f079ce48?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/57420486209d6ac9b60a5ee2f079ce48'>Jack</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-15 9:55 am</div>
				                <div><p>I tried this on one prestashop 1.6+ Prestashop and it worked. But on another with a copy of the same database it did not?&nbsp; In both cases I left the code varchar(128) the same.&nbsp; The password I changed using the cookie and MD5 but when I try to log in it tells me that either the password or the email address is wrong.&nbsp; When I go to the employee line&nbsp;in the database it shows the correct email address and the password in code.&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21718);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-19035'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/c938a3051728585fe6a309a7964e5982?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/c938a3051728585fe6a309a7964e5982'>Jeff Restuccio</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-30 8:00 pm</div>
				                <div>file is not called PS_shop_name<br />
<br />
does not even exist in the database!!!<br />
mine is qjg_shop<br />
totally different<br />
</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19035);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-16 4:18 pm</div>
				                <div>Hello Jeff,<br />
<br />
Thanks for pointing this out.  I will have the article updated in the next few days.  The correct table would be PS_SHOP.  However, it may differ depending on how you configure the table names for your installation (as it was in yours since you used "qjg" instead of "ps").  <br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21780);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
...
Arnel C.</div>
		...
		<a name='comment-29158'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/0755d71df7324a17db230bed563ccd20?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/0755d71df7324a17db230bed563ccd20'>Jeffisnotdead</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-12-13 11:32 pm</div>
				                <div><p>Hi all,</p>
<p>I had changed my shop name with succesful but I have another problem when I upload&nbsp;new logo.</p>
<p>It take for prefix the old name shop. I didn't found in DB or in a file any configuration a line to change to get the new name shop when I upload new logos.&nbsp;</p>
<p>Do you have any suggestion ? Thanks a lot!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29158);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-12-14 1:51 pm</div>
				                <div>Hello,<br />
<br />
You will want to <a href="http://www.inmotionhosting.com/support/edu/prestashop-15/working-with-multi-shops/enable-multistore">activate the Multi-Store</a> setting. Then visit that area. Your shop will appear with the old name. Click on the Edit button and you will be able to rename it. Once you have renamed it, you can then go back and disable multi-shop so that once again have a single store. Then, reupload your logo and it will use the new store's name when creating the URL.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29169);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
