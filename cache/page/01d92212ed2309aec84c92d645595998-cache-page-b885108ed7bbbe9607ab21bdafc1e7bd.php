<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:56352:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/php-nuke/php-nuke-modules-blocks/add-a-new-custom-module-in-php-nuke" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-03-19T23:25:00-07:00" />
  <meta name="keywords" content="phpnuke php-nuke php nuke add new custom module" />
  ...
  <link href="http://www.inmotionhosting.com/support/edu/php-nuke/php-nuke-modules-blocks/add-a-new-custom-module-in-php-nuke" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:ea426ed48646d21606141d09b4ca5e1e -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Add new custom module in PHP-Nuke									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>2,506</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Mar 14, 2013'><span style='color:#606060;'>Published:</span> Mar 19, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In this article I'm going to teach you how to add a new custom module to your PHP-Nuke website.</p>
...
<li>Under the <strong>Files</strong> section, click on <strong>File Manager</strong>, select <strong>Web Root</strong> and click on <strong>Go</strong>.</li>
...
<p class="code_block" style="width: 500px;">&lt;?php<br /> if (!eregi("modules.php", $PHP_SELF)) {<br /> die ("You can't access this file directly...");<br /> }<br /> $index = 1;<br /> require_once("mainfile.php");<br /> $module_name = basename(dirname(__FILE__));<br /> get_lang($module_name);<br /> include("header.php");<br /> <br />echo "&lt;p&gt;This is a test module!&lt;/p&gt;";<br /> <br /> echo '&lt;a href="http://inmotionhosting.com/support"&gt;InMotion Support Center&lt;/a&gt;';<br /> <br /> <br /> include("footer.php");<br /> ?&gt;</p>
</li>
...
<li>Now if you navigate back to your PHP-Nuke main page, you should see under the <strong>Modules</strong> menu the new <strong>Support</strong> one, and clicking on it will take you to the page that includes our text and link!
</ol>
...
<p>You should now understand the very basics of creating a new custom module to use with PHP-Nuke.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 3: Add new custom module in PHP-Nuke</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 2: <a href='/support/edu/php-nuke/php-nuke-modules-blocks/module-management'>How to manage modules from the sidebar </a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 4: <a href='/support/edu/php-nuke/php-nuke-modules-blocks/removing-modules'>Removing Modules from the Menu PHP-Nuke</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/php-nuke/php-nuke-modules-blocks/add-a-new-custom-module-in-php-nuke&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/php-nuke/php-nuke-modules-blocks/add-a-new-custom-module-in-php-nuke'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zNjMmaWQ9NjU5JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
