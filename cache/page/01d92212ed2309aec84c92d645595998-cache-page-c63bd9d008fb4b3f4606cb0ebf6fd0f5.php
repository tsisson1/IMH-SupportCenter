<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:45164:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/moodle/moodle-site-security" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="keywords" content="Moodle 2.3 security Site administrator secure data transmissions https http ssl" />
  <meta name="description" content="Moodle 2.3 has security features available in the Site administrator that allows Moodle to be secure with the data transmissions. This section will discuss the Site Security for Moodle 2.3." />
  <title>201: Moodle site security and server settings | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/moodle/moodle-site-security" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:7ab55a3aa2e96a99749cc0b23fe7cddc -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '82.197.0.10']);
...
<div class='page-header'>
	<h1>201: Moodle site security and server settings</h1>
</div>
<div class='section_listing'>
		<table>
	<tr><td colspan='3'><h2>Site Security</h2><div>This section will detail the security settings in the Site administration section of Moodle.</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 1:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/moodle-site-security/force-ssl-login'>Setting the Moodle login to work over HTTPS</a>
					<div>This article will explain how to make Moodle 2.3 force HTTPS logins.</div>
					<div class='smallgrey'>Hits: 14,209</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/moodle-site-security/forcing-ssl-sitewide'>Forcing Moodle 2.3 to work over SSL</a>
					<div>Moodle 2.3 can work over an SSL site wide. This tutorial will explain how to force Moodle 2.3 to work over an SSL connection.</div>
					<div class='smallgrey'>Hits: 9,804</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/moodle-site-security/block-ips'>Blocking IP's in the Moodle Site administrator</a>
					<div>In Moodle 2.3, IP addresses can be blocked or allowed access to the site. This article will explain how to block IP addresses in Moodle.</div>
					<div class='smallgrey'>Hits: 2,752</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/moodle-site-security/clamav-anti-virus'>Setting up ClamAV AntiVirus for Moodle file uploads</a>
					<div>Moodle 2.3 has the Antivirus capability to accomplish this. Moodle uses ClamAV to scan uploaded files. This article will explain the how to set up antivirus in Moodle.</div>
					<div class='smallgrey'>Hits: 4,149</div>
				</td>
			</tr>
		<tr><td colspan='3' style='padding-top:20px;'><h2>Server settings</h2><div>This course section will explain how to work with the server settings in the Site administrator.</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 5:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/moodle-site-security/maintenance-mode-moodle'>Enable / Disable maintenance mode in Moodle</a>
					<div>Moodle 2.3 has the feature that allows the site to be set to Maintenance mode (or an under construction page). This tutorial will show how to enable and disable the maintenance mode.</div>
					<div class='smallgrey'>Hits: 4,063</div>
				</td>
			</tr>
			</table>
</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yOTgmaWQ9Mjk4JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="669b6941f0fb687e570c1dcaf1bf4bd5" value="1" />	</div>
	</form>
<!-- <br />
