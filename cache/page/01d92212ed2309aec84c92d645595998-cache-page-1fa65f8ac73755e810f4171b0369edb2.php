<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:77525:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-25/phoca-photo-gallery/hide-powered-by-phoca-gallery" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-01-11T15:50:51-08:00" />
  <meta name="keywords" content="remove powered by phoca gallery joomla 2.5" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="In this Phoca Gallery, we'll show you how to remove the Powered By Phoca Gallery message in your galleries." />
  <title>How to remove Powered By Phoca Gallery in Joomla 2.5 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-25/phoca-photo-gallery/hide-powered-by-phoca-gallery" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:2f427b3b23e83525420e373afb99d991 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '198.23.238.188']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to remove Powered By Phoca Gallery in Joomla 2.5									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>38,483</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jun 15, 2012'><span style='color:#606060;'>Published:</span> Jan 11, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<p class="alert">Joomla 2.5 has reached its end of life as for 12/31/2014. Please be advised this may be a security risk to your website. You can view more information about the end of life <a href="https://docs.joomla.org/Joomla!_CMS_versions">here</a>.</p><br /><p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/delete-powered-by/powered-by-phoca-gallery.gif"><img style="margin: 0px 0px 10px 10px; float: right;"  alt="powered-by-phoca-gallery" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/delete-powered-by/powered-by-phoca-gallery.gif" /></a>On all Phoca Gallery pages in Joomla 2.5 is a link that reads, Powered By Phoca Gallery. When using free and open source software, it's general courtesy to link back to the people who have built the software you're using. There may be times however that you want to remove those links added by the developers. In this tutorial, we'll walk you through the steps for removing the <em>Powered By Phoca Gallery</em> links in your <a href="/support/edu/joomla-25/phoca-photo-gallery">Joomla 2.5 photo gallery</a>.</p>
<div style="clear: both;"></div>
<p><strong>How to delete Powered By Phoca Gallery in Joomla 2.5:</strong></p>
<ol class="article_list">
<li>Open for edit this file:<br /><strong>administrator/components/com_phocagallery/libraries/phocagallery/render/renderfront.php</strong><br /><br />Around line 680, you should see the following:<br />
<pre class="code_block" style="max-width: 500px;">function renderInfo() {
...
<pre class="code_block" style="max-width: 500px;">function renderInfo() {
        <strong><span style="color: #ff0000;">return;</span></strong>
        return '&lt;div style="text-align: center; color: rgb(211, 211, 211);"&gt;Powe'
                        . 'red by &lt;a href="http://www.ph'
                        . 'oca.cz" style="text-decoration: none;" target="_blank" title="Phoc'
                        . 'a.cz"&gt;Phoca&lt;/a&gt; &lt;a href="http://www.phoca.cz/phocaga'
...
<li> There is another file you need to edit:<br /><strong>components/com_phocagallery/views/category/view.html.php<br /><br /></strong>Around line 663, find the following code:<strong><br /></strong>
<pre class="code_block" style="max-width: 500px;">$this-&gt;tmpl['mac'] = '&lt;div style="text-align: center; color: rgb(211, 211, 211);"&gt;Powe'. 'red by &lt;a href="http://www.ph'. 'oca.cz" style="text-decoration: none;" target="_blank" title="Phoc'. 'a.cz"&gt;Phoca&lt;/a&gt; &lt;a href="http://www.phoca.cz/phocaga'. 'llery" style="text-decoration: none;" target="_blank" title="Phoca Gal'. 'lery"&gt;Gall'. 'ery&lt;/a&gt;&lt;/div&gt;';</pre>
<p>Replace the above code with the following:</p>
<pre class="code_block" style="max-width: 500px;"><strong><span style="color: #ff0000;">$this-&gt;tmpl['mac'] = '';</span></strong><br /><strong><span style="color: #ff0000;">//</span></strong> $this-&gt;tmpl['mac'] = '&lt;div style="text-align: center; color: rgb(211, 211, 211);"&gt;Powe'. 'red by &lt;a href="http://www.ph'. 'oca.cz" style="text-decoration: none;" target="_blank" title="Phoc'. 'a.cz"&gt;Phoca&lt;/a&gt; &lt;a href="http://www.phoca.cz/phocaga'. 'llery" style="text-decoration: none;" target="_blank" title="Phoca Gal'. 'lery"&gt;Gall'. 'ery&lt;/a&gt;&lt;/div&gt;';</pre>
</li>
<li>One more file to edit is:<br /><strong>administrator/components/com_phocagallery/libraries/phocagallery/utils/utils.php<br /><br /></strong>Around line 118, find the following code:<strong><br /></strong>
<pre class="code_block" style="max-width: 500px;">echo '&lt;div style="text-align: center; color: rgb(211, 211, 211);"&gt;Powe'.'red by &lt;a href="http://www.ph' .'oca.cz" style="text-decoration: none;" target="_blank" title="Phoc'.'a.cz"&gt;Phoca&lt;/a&gt; &lt;a href="http://www.phoca.cz/phocaga'.'llery" style="text-decoration: none;" target="_blank" title="Phoca Gal' .'lery"&gt;Gall'.'ery&lt;/a&gt;&lt;/div&gt;';</pre>
<p>Replace the above code with the following:</p>
<pre class="code_block" style="max-width: 500px;"><strong><span style="color: #ff0000;">//</span></strong> echo '&lt;div style="text-align: center; color: rgb(211, 211, 211);"&gt;Powe'.'red by &lt;a href="http://www.ph' .'oca.cz" style="text-decoration: none;" target="_blank" title="Phoc'.'a.cz"&gt;Phoca&lt;/a&gt; &lt;a href="http://www.phoca.cz/phocaga'.'llery" style="text-decoration: none;" target="_blank" title="Phoca Gal' .'lery"&gt;Gall'.'ery&lt;/a&gt;&lt;/div&gt;';</pre>
</li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/joomla-25/phoca-photo-gallery'>213: Setting up a Joomla 2.5 Photo Gallery using Phoca Gallery</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 5: How to remove Powered By Phoca Gallery in Joomla 2.5</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 4: <a href='/support/edu/joomla-25/phoca-photo-gallery/list-phoca-gallery-categories'>Link to a listing of your Phoca Gallery Image Categories</a>
								</td>
...
<div style='display:inline-block;'>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yMTUmaWQ9MTQ2NiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="22d16b02a379d718d63429cbd3d2c47e" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/joomla-25/phoca-photo-gallery?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Setting up a Joomla 2.5 Photo Gallery using Phoca Gallery</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/joomla-25/phoca-photo-gallery/install?tsrc=rsbedu'>How to install Phoca Gallery for Joomla 2.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/joomla-25/phoca-photo-gallery/create-category?tsrc=rsbedu'>How to create an image category in Phoca Gallery</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/joomla-25/phoca-photo-gallery/upload-image?tsrc=rsbedu'>Uploading an image to Phoca Gallery</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/joomla-25/phoca-photo-gallery/list-phoca-gallery-categories?tsrc=rsbedu'>Link to a listing of your Phoca Gallery Image Categories</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/joomla-25/phoca-photo-gallery/hide-powered-by-phoca-gallery?tsrc=rsbedu'>How to remove Powered By Phoca Gallery in Joomla 2.5</a></td>
                </tr>
          	</table>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/21a73feb201a169d56ca0fe3202b94d6?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/21a73feb201a169d56ca0fe3202b94d6'>Mohamed Mahrous</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-13 9:35 am</div>
				                <div>you can remove it by change this code :<br />
<br />
echo '&lt;div style=&quot;text-align: center; color: rgb(211, 211, 211);display:block;&quot;&gt;Powered by &lt;a href=&quot;http://www.phoca.cz/phocagallery&quot; style=&quot;text-decoration: none;&quot;&gt;Phoca Gallery&lt;/a&gt;&lt;/div&gt;';<br />
<br />
you can but ( // ) befor it <br />
<br />
in line 83 in dir  components/com_phocagallery/views/categories/tmpl/default.php<br />
<br />
it will work ;) </div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12697);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-13994'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/092db3c5760645f18479be42b1391276?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/092db3c5760645f18479be42b1391276'>Julie</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-14 12:20 pm</div>
				                <div><p>Thanks so much!!&nbsp; This worked great!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13994);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/0c9bd6de83e9dcb5c2c558054581364b?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/0c9bd6de83e9dcb5c2c558054581364b'>Mehdi</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-31 7:29 pm</div>
				                <div><p>I can not change anything because&nbsp;the misage is&nbsp;<span style="color: rgb(51, 51, 51); font-family: Arial; font-size: 13px; line-height: 15.859999656677246px; white-space: pre-wrap;">Permission denied,please help me.</span></p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14532);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-02 1:21 pm</div>
				                <div>Hello Mehdi,<br />
<br />
Please provide the full message as well as list the steps you take to get the error. This way we can test or try and troubleshoot why you are getting the error.<br />
<br />
Kindest Message,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14590);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-15884'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/d80d336f8f796d0ba240798ef30b56bf?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/d80d336f8f796d0ba240798ef30b56bf'>apkza</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-05 4:40 am</div>
				                <div><p>Thanks so much!!&nbsp; This worked great!</p>
</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15884);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-27427'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/15b5f60fa7bc97498ab5280adffe6a9d?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/15b5f60fa7bc97498ab5280adffe6a9d'>somayeh</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-11 6:14 am</div>
				                <div><p>hiIs it useful for joomla3?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27427);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-12 9:09 am</div>
				                <div>Hello somayeh,<br />
<br />
You may try this in Joomla 3.x but it is not guaranteed to work as we have not tested it.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27455);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-29584'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/adfbb8b11b7e07abefcfc50d34e9d1eb?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/adfbb8b11b7e07abefcfc50d34e9d1eb'>Ayd?n</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-05 8:09 pm</div>
				                <div><p>Remove copyright for Phoca gallery 4.2.2</p>
<p><strong>Open:</strong></p>
<p>components\com_phocagallery\views\category\tmpl\default.php</p>
<p><strong>Find:</strong></p>
<p><code>echo $this-&gt;tmpl['elf'];</code></p>
<p><strong>Replace:</strong></p>
<p><code>//echo $this-&gt;tmpl['elf'];</code></p>
<p>&nbsp;</p>
<p><strong>Open:</strong></p>
<p>components\com_phocagallery\views\categories\tmpl\default.php</p>
<p><strong>Find:</strong></p>
<p><code>echo $this-&gt;tmpl['ems'];</code></p>
<p><strong>Replace:</strong></p>
<p><code>//echo $this-&gt;tmpl['ems'];</code></p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29584);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
