<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:59309:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-3/optimization" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-01-13T16:14:22-08:00" />
  <meta name="keywords" content="Joomla Optimize" />
  <meta name="author" content="John-Paul Briones" />
  <meta name="description" content="This guide explains the best steps to take when you want to optimize a Joomla website." />
  <title>How to Optimize your Joomla Site - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-3/optimization" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:def64063861d2865ba60e007727d6010 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to Optimize your Joomla Site									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>1,306</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Dec 24, 2014'><span style='color:#606060;'>Published:</span> Jan 13, 2015</div>
  ...
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('caching');">Joomla Caching</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('extensions');">Intensive Extensions</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('robots');">Block Robots</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('block');">Block Unwanted Visitors</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('spam');">Fight Comment Spam</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('update');">Update Joomla</button>
   <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('support');">Request assistance from Support</button>
</div>

<p>Joomla is a powerful CMS (Content Management System) that makes it easy to create and maintain a custom website. But, if it is not optimized well, it can cause high resource usage. In this guide we will show you the common steps to take when <strong>Optimizing</strong> a <strong>Joomla</strong> website.</p>

<a name="caching"></a>
<h2>Enable Joomla caching</h2>
<ul>
<li><a href="/support/edu/joomla-25/caching/global-module-caching">Understanding Global Module Caching in Joomla</a>.</li>
<li><a href="/support/edu/joomla-3/install-jotcache">Install the JotCache Extension in Joomla 3</a>.</li>
</ul>


<a name="extensions"></a>
<h2>Be Careful of Intensive Extensions</h2>
<p>Joomla Extensions can affect your site in many different ways, since anyone can make them. If you are having problems with a specific extension, you can try to find an alternative plugin with less problems. As a test, you can disable the problem plugin to see if it brings your resource usage down enough, or if it's really necessary to your site's function you could upgrade to a <a href="http://www.inmotionhosting.com/vps-hosting" >VPS</a>. Here are some Extensions we've seen customers have issues with before as they seem to utilize a large amount of resource usage compared to other extensions. This list will be updated as needed.</p>
<ul>
<li><a href="http://extensions.joomla.org/extensions/extension/authoring-a-content/content-construction/k2" target="_blank" >K2</a></li>
</ul>


<a name="robots"></a>
<h2>Block Robot Traffic</h2>
<p>By using a <strong>robots.txt</strong> file, you can block or deny robots from crawling your website.</p>

<ul>
<li><a href="/support/website/restricting-bots/how-to-stop-search-engines-from-crawling-your-website">How to stop Search Engines from crawling your Website</a>.</li>
</ul>


<a name="block"></a>
<h2>Stop Unwanted Visitors</h2>
<p>You can <strong>block</strong> specific <strong>IP addresses</strong>, or <strong>User-Agents</strong> from getting to your site by using <em>.htaccess</em> rules.</p>
<ul><li><a href="/support/website/security/block-unwanted-users-from-your-site-using-htaccess">Block unwanted users from your site using .htaccess</a>.</li>
</ul>


<a name="spam"></a>
<h2>Fight Comment Spam</h2>
<p>Ensure you are using some type of <a href="/support/email/fighting-spam/what-is-captcha">CAPTCHA</a> in Joomla to fight against comment spam.</p>
<ul>
<li><a href="/support/edu/joomla-25/301-setup-recaptcha-for-joomla">How to enable ReCaptcha in Joomla 2.5</a></li>
<li><a href="/support/edu/joomla-3/site-settings/default-captcha">How to change the Default Captcha in Joomla 3</a></li>
<li><a href="/support/website/comment-spam/excessive-amount-of-spam-comments-or-guestbook-entries">Learn more about Excessive amount of spam comments, or guestbook entries</a></li>
</ul>


<a name="update"></a>
<h2>Keep Joomla Updated</h2>
<p>Updating Joomla regularly installs the latest security patches and fixes, and ensures you are running the most optimum version.</p>
<ul>
<li><a href="/support/website/joomla/upgrade-joomla-1-5-security-vulnerabilities">How to upgrade joomla 1.5 to 2.5</a></li>
<li><a href="/support/edu/joomla-25/update">Keeping Joomla 2.5 up to date</a></li>
<li><a href="/support/edu/joomla-3/news/should-i-upgrade">Should I upgrade Joomla 2.5 to Joomla 3.0?</a></li>
<li><a href="/support/edu/joomla-3/news/should-i-upgrade-to-joomla-3-1">Should I upgrade to Joomla 3.1?</a></li>
<li><a href="/support/edu/cpanel/softaculous/upgrade-within-softaculous">Upgrade Joomla with Softaculous</a></li>
</ul>


<a name="support"></a>
<h2>Request Further Assistance</h2>
<p>If your Joomla website does not run faster and use less resources, a deeper investigation probably needs to be done on your access logs to see what's really being requested.<br><br>
<a href="/support/website/stats-logging/enable-raw-access-logs-in-cpanel">Enabling raw access logs</a> for your account in cPanel can help gather evidence. This assists Tech Support when they are investigating the cause of high resource usage from your website.<br><br>
Once you have at least a full day of logs, feel free to contact Live Tech Support via <strong>Ticket</strong> for further help. </p>
<ul>
<li><a href="/support/website/getting-started-guides/submitting-and-checking-on-status-of-tickets#submit-ticket">Submitting a Ticket Request</a></li>
</ul>


<p>Congratulations, now you know the common steps to take when <strong>Optimizing</strong> a <strong>Joomla</strong> website.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 2: How to Optimize your Joomla Site</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 1: <a href='/support/edu/joomla-3/install-jotcache'>Installing the JotCache Extension in Joomla 3</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 3: <a href='/support/edu/joomla-3/move-subfolder-to-root'>How to move your Joomla application from a subfolder to the root folder.</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-3/optimization&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-3/optimization'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xMDEmaWQ9MzQ3NSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="b2d901ba9976dc7c7494da97460f5f4c" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/joomla-3/setting-up-a-cookieless-subdomain-for-a-joomla-site?tsrc=rsbraq'>Setting up a cookieless subdomain for a Joomla site</a>
                                </div>
