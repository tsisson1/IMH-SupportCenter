<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:63460:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/moodle/new-to-moodle/change-username-password-moodle" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-06-30T16:33:11-07:00" />
  <meta name="keywords" content="change username password moodle 2.3.2 admin profile" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="To change the username and/or password for your Moodle Login, you can log in the Moodle Dashboard and change it in the Admin Profile." />
  <title>How to change the Username and Password in Moodle - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/moodle/new-to-moodle/change-username-password-moodle" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:7e177ff00c7a027e81a7547ef4155886 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '207.250.135.226']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to change the Username and Password in Moodle									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>14,628</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Oct 12, 2012'><span style='color:#606060;'>Published:</span> Jun 30, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<iframe width="640" height="360" src="//www.youtube.com/embed/pSpWmTnv0UU" frameborder="0" allowfullscreen></iframe>
<p>The previous tutorial in the <a target="_blank" title="Click here for more information" href="/support/edu/moodle/new-to-moodle">Getting Started with Moodle course</a> was <a target="_blank" href="/support/edu/moodle/new-to-moodle/forgot-moodle-username-password">what to do when the username or password is los</a>t. For security reasons, the Moodle administrator may want to change the Username and Password. This tutorial will explain how the username and password can be changed through the Moodle dashboard.</p>
<p><strong>Resetting the Moodle Admin Login within the Moodle Dashboard</strong></p>
<ol class="article_list">
<li>Log into your Moodle.</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/password-reset/moodle-reset-password-username-admin-user.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="moodle-reset-password-username-admin-user" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/password-reset/moodle-reset-password-username-admin-user.gif" width="200" /></a>Navigate to the <strong>Admin User</strong> link towards the top right side of the Moodle site. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/password-reset/moodle-reset-password-username-edit-profile.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="moodle-reset-password-username-edit-profile" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/password-reset/moodle-reset-password-username-edit-profile.gif" width="200" /></a>Click <strong>Edit profile</strong> in the <strong>Settings</strong> section of the left. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/password-reset/moodle-reset-password-username-password-change.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="moodle-reset-password-username-password-change" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/password-reset/moodle-reset-password-username-password-change.gif" width="200" /></a>In the <strong>General</strong> settings of the <strong>Admin User</strong> Section, enter the new user name and/or password. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/password-reset/moodle-reset-password-username-update-profile.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="moodle-reset-password-username-update-profile" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/password-reset/moodle-reset-password-username-update-profile.gif" width="200" /></a>After the New Username and Password are entered click Update Profile. <br style="clear: both;" /></li>
</ol>
<p>Another way to change the password for Moodle is through the database. Next is on <a target="_blank" href="/support/edu/moodle/new-to-moodle/moodle-password-reset-phpmyadmin">how to change the password through PhpMyAdmin</a> on cPanel Hosting servers.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 5: How to change the Username and Password in Moodle</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 6: <a href='/support/edu/moodle/new-to-moodle/moodle-password-reset-phpmyadmin'>Changing the Moodle admin password through PhpMyAdmin</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/moodle/new-to-moodle/change-username-password-moodle&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/moodle/new-to-moodle/change-username-password-moodle'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNzQmaWQ9MTg2MiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="51c3be41db2f5e682cefd2ea4e04530e" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='https://lh5.googleusercontent.com/-RIgkEVgfr08/AAAAAAAAAAI/AAAAAAAAAE0/cdvr4EQMc_g/photo.jpg?sz=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='/support/community-support/users/Deenaveerappan'>Deenaveerappan</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-07-29 1:09 am</div>
				                <div>Dear James Richardson, thanks lot this session more useful for me..... keep it up</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8066);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
