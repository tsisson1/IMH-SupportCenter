<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:56480:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/email/outlook/email-signature-2003" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-02-17T18:47:59-08:00" />
  <meta name="keywords" content="outlook 2003 add create email signature" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="In this Outlook 2003 article, we teach you how to add an email signature." />
  <title>How to create an email signature in Outlook 2003 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/email/outlook/email-signature-2003" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:bcfcbc6fe0656969dcad6dbc96837b87 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '81.139.13.204']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to create an email signature in Outlook 2003</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to create an email signature in Outlook 2003									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>26,460</span></div>
							...
							<div style='clear:both;'></div>
								...
								<div>
  <div>Email signatures are traditionally used to display the sender's name and contact information at the end of an email. Some people find furhter use for them and use them to give website links, insert logos, or even memorable anecdotes. It is much easier if this information is automatically added to the end of every email by default instead of having to add it manually each time you create and send an email. Below are instructions that teach you how to create and add your own custom email signature within your <a href="http://www.inmotionhosting.com/support/email/outlook/creating-an-email-account-in-outlook-2003">Outlook 2003</a> email client.</div>
<div>&nbsp;</div>
<div><strong>Creating an email signature in Outlook 2003&nbsp;&nbsp;</strong> &nbsp;<br />&nbsp;&nbsp; &nbsp;<ol>
<li>Launch your Microsoft Outlook 2003 application.</li>
<li>From the main window, click on the <strong>Tools</strong> menu, then <strong>Options</strong>.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/email/outlook/2003/select-options.png"><img  alt="select-options" src="//cdn.inmotionhosting.com/support/images/stories/edu/email/outlook/2003/select-options.png" /></a> </li>
<li>This brings you to a popup menu with several tabs on it. Click the <strong>Mail Format</strong> tab to continue.</li>
<li>Under the <em>Message Format</em> seciton, look for the <strong>Compose in this message format</strong> dropdown list, click the message format that you want to use the signature with. In this example, we have <strong>HTML</strong> selected.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/email/outlook/2003/message-format.png"><img  alt="message-format" src="//cdn.inmotionhosting.com/support/images/stories/edu/email/outlook/2003/message-format.png" /></a></li>
<li>Under <strong>Signature</strong>, click <strong>Signatures</strong>, and then click <strong>New</strong>.<br /><br /></li>
<li>In the <strong>Enter a name for your new signature box</strong>, enter an indentifying name.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/email/outlook/2003/new-signature-id.png"><img  alt="new-signature-id" src="//cdn.inmotionhosting.com/support/images/stories/edu/email/outlook/2003/new-signature-id.png" /></a></li>
<li>Under <strong>Choose how to create your signature</strong>, select the option you want and then click <strong>Next</strong>.</li>
<li>In the <strong>Signature</strong> text box, type the text you want to include in the signature.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/email/outlook/2003/new-signature-data.png"><img  alt="new-signature-data" src="//cdn.inmotionhosting.com/support/images/stories/edu/email/outlook/2003/new-signature-data.png" /></a></li>
<li>Click <strong>Finish</strong> to complete and save your signature. You will be taken to a screen to see your signature listing.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/email/outlook/2003/signature-list-after.png"><img  alt="signature-list-after" src="//cdn.inmotionhosting.com/support/images/stories/edu/email/outlook/2003/signature-list-after.png" /></a></li>
</ol></div>
</div> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/email/outlook/email-signature-2003&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/email/outlook/email-signature-2003'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD01NSZpZD03OTUmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
