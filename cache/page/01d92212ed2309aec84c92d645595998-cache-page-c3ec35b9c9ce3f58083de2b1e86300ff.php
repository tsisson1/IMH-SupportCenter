<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:63912:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/wordpress/wordpress-introduction/what-is-wordpress" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-10-21T18:26:54-07:00" />
  <meta name="keywords" content="WordPress what is blog free-ware" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="In this educational channel we will discuss WordPress, what is it used for, and  " />
  <title>What is WordPress?  - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/wordpress/wordpress-introduction/what-is-wordpress" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:2fb5b6abbc117cc55cdec8f7b18460e2 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '32.212.196.10']);
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>19,692</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Aug 30, 2011'><span style='color:#606060;'>Published:</span> Oct 21, 2014</div>
...
<p>WordPress is a completely free tool used to create dynamic websites. Originally, WordPress was developed as blogging software. In recent times, since WordPress is so robust everyone from web developers to average computer users have used it to build beautiful websites. With WordPress there really are no limits!</p>
<h2>What is a blog?</h2>
<p>A blog is a type of website or part of a website that is maintained on a regular basis by it's owner with entries regarding commentary, reviews, opinions, and other media such as video. The term blog is actually short for "web log" but can also be used as a verb. In the verb form, "<a href="http://firstsiteguide.com/create-blog/">blogging</a>" means to post to your blog.&nbsp;</p>
<h2>WordPress, it's completely free?</h2>
<p>WordPress is completely free. There is no trial version to "test" or no "free" version that lacks all the full features. WordPress is a free and open source software. Open source software typically relies on the community of developers to develope and test the software, provide support via forums, and . Without the "community" WordPress would cease to exist and would not be as robust as it is.</p>
<h2>How does WordPress work?</h2>
<p>WordPress is dynamically driven through the use of a database. You must have the ability to create and utilize a database to use WordPress. WordPress stores all of the information such as posts, articles, and pages in the database. Installing WordPress on <a href="/support/edu/wordpress/wordpress-introduction/install-wordpress">your hosting account</a> is easy. WordPress has touted itself as having a "5-minute" install, and it's true. Even a novice can install WordPress in five minutes!</p>
<h2>Need Wordpress VPS Hosting?</h2>
<p><a href="http://www.inmotionhosting.com/vps_hosting/articles/compare-vps.html">Compare VPS</a> plans by InMotion. See our plans and how they differ in terms of specs and pricing. Take your Wordpress site to new heights.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 5: What is WordPress? </div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 6: <a href='/support/edu/wordpress/wordpress-introduction/what-kind-of-website-can-i-build-with-wordpress'>What kind of website can I build with WordPress?</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/wordpress/wordpress-introduction/what-is-wordpress&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/wordpress/wordpress-introduction/what-is-wordpress'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xMzgmaWQ9MTAyNCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="0c596f894a5946273fc108c0e1376020" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
        ...
        <tr><td colspan='2'><h4>About WordPress</h4></td></tr>  <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>5.</td>
