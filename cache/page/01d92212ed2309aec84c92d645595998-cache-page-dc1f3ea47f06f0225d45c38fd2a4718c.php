<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:89170:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/moodle/image-slider-moodle-jquery" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-04-21T22:30:00-07:00" />
  <meta name="keywords" content="jquery simple slider moodle image" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="In order to have an image slider in your Moodle you will have to use the jQuery plugin. This explains how to use the Simple jQuery plugin in Moodle." />
  <title>302: Inserting an image slider in Moodle - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/moodle/image-slider-moodle-jquery" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:cddd381acd6a4fd4acc86f2654d6fec8 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '195.154.161.94']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															302: Inserting an image slider in Moodle									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>9,449</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Feb 15, 2013'><span style='color:#606060;'>Published:</span> Apr 21, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Moodle does not have a built in slider available in the Moodle plugins, so, in order to add a slider, you will need to code it into your page using jQuery. There are many free jQuery plugins you can use to get a slider working. In this tutorial we will use the <a href="http://basic-slider.com/" target="_blank">Simple jQuery slider</a>. The jQuery plugin is available at the following url.</p>
<div><code>https://github.com/jcobb/basic-jquery-slider/zipball/master</code></div>
<p>After you get the plugin zip file named <code>jcobb-basic-jquery-slider-8ffe118.zip</code> you will be able to upload the files necessary for the slider to work. Below are the steps to insert the Simple slider in your Moodle site.</p>
<p class="alert"><strong>Important!</strong> This tutorial explains how to add the jQuery slider in the AfterBurner theme. The steps are basicaly the same for the other themes as well.</p>
<h2>Adding the Simple jQuery slider to Moodle</h2>
<ol class="article_list">
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/301/add-slider-jquery-1-upload.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Location of files in cPanel" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/301/add-slider-jquery-1-upload.gif" title="Click here to view the larger image" width="100" /></a><a target="_blank" href="/support/website/how-to/how-to-edit-a-file" title="How do I upload a file on my server?">Upload the slider zip file</a> to the theme folder. In this case the afterburner theme is in the <code>/theme/afterburner</code> directory. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/301/add-slider-jquery-2-move-files.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Extract the file to the them folder" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/301/add-slider-jquery-2-move-files.gif" title="Click here to view the larger image" width="100" /></a><a target="_blank" href="/support/website/cpanel/compressing-uncompressing-files">Extract the .zip file</a> so the files are in the directory like the snapshot to the right. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/301/add-slider-jquery-5-add-code-to-head.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Add code to the head sections" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/301/add-slider-jquery-5-add-code-to-head.gif" title="Click here to view the larger image" width="100" /></a><a target="_blank" href="/support/website/how-to/how-to-edit-a-file">Edit </a>the following files in your Moodle theme files.
  <pre style="margin-left: 20px;">/theme/afterburner/layout/default.php<br />
/theme/afterburner/layout/embedded.php</pre>
<p>Paste the following code in the head section of your theme files.</p>
<pre class="code_block" style="margin-left: 20px;">&lt;!-- bjqs.css contains the *essential* css needed for the slider to work --&gt;
...
&lt;script src="/support/js/bjqs-1.3.min.js"&gt;&lt;/script&gt;</pre>
<p class="alert"><strong>Important!</strong> Make sure you make the links in your code go to your server location with the URL. Instead of :<br /> <code style="margin-left: 20px;">&lt;link rel="stylesheet" href="/support/bjqs.css"&gt;</code><br /> You will need to reference your files like this:<br /> <code style="margin-left: 20px;">&lt;link rel="stylesheet" href="http://example.com/theme/afterburner/bjqs.css"&gt;</code></p>
<p>Save the changes.</p>
<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/301/add-slider-jquery-3-edit-html.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Edit HTML in Moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/301/add-slider-jquery-3-edit-html.gif" title="Click here to view the larger image" width="100" /></a><a href="/support/edu/moodle/new-to-moodle/moodle-login-administrator" target="_blank">Log into Moodle.</a> Edit the page you want the slider to show up on. Click the Edit HTML Source button in the WYSIWYG editor. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/301/add-slider-jquery-4-add-html.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Paste the  code in the page" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/301/add-slider-jquery-4-add-html.gif" title="Click here to view the larger image" width="100" /></a>Paste the following code into your page where you want the slider to show.
<pre class="code_block" style="margin-left: 20px;">&lt;!--  Outer wrapper for presentation only, this can be anything you like --&gt;
&lt;div id="banner-fade"&gt;
  &lt;!-- start Basic Jquery Slider --&gt;
  &lt;ul class="bjqs"&gt;
    &lt;li&gt;&lt;img src="http://example.com/theme/afterburner/img/banner01.jpg" title="Automatically generated caption"&gt;&lt;/li&gt;
    &lt;li&gt;&lt;img src="http://example.com/theme/afterburner/img/banner02.jpg" title="Automatically generated caption"&gt;&lt;/li&gt;
    &lt;li&gt;&lt;img src="http://example.com/theme/afterburner/img/banner03.jpg" title="Automatically generated caption"&gt;&lt;/li&gt;
  &lt;/ul&gt;
...
&lt;/script&gt;</pre>
<p class="alert"><strong>Important!</strong> Make sure you make the links in your code go to your server location with the URL and that your images are stored in the <code>theme/afterburner/img</code> folder location. Instead of :<br /> <code style="margin-left: 20px;">src="img/banner03.jpg"</code><br /> You will need to reference your files like this:<br /> <code style="margin-left: 20px;">src="http://example.com/theme/afterburner/img/banner03.jpg"</code><br /> If not the images will not load.</p>
<p>Save the files.</p>
<br style="clear: both;" />
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/301/add-slider-jquery-6-final-view.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="View of image slider in Moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/301/add-slider-jquery-6-final-view.gif" title="Click here to view the larger image" width="100" /></a>Now your Moodle will have a slider with your images on it. <br style="clear: both;" /></p>
</li>
</ol> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/moodle/image-slider-moodle-jquery&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/moodle/image-slider-moodle-jquery'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xMDImaWQ9MjQ2MyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="81bb212983d3852d77dbe11cf151adbd" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/31e2c5a751b2340eef58a4d187becaf0?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/31e2c5a751b2340eef58a4d187becaf0'>beyk</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-15 9:55 am</div>
				                <div><p>Tanks abt this .that was really useful but...</p>
<p>i dont use afterburner them ,i use Binarius.</p>
<p>in my them files dosnt exist any file like that you say!!(Defualt.php and...)</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8967);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-17 8:50 am</div>
				                <div>The steps should be the same for most themes.  If you do not see the files referenced, I recommend speaking the the developer of your theme for more information on how to modify it to do this.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8981);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-10430'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/100acda692ac368936c0e298c5363d33?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/100acda692ac368936c0e298c5363d33'>RDM</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-06 11:15 am</div>
				                <div><p>That's great. It works perfectly with my Moodle.</p>
<p>However I have got problems viewing it from a mobile phone. I am currently testing it from my iPhone.</p>
<p>Would you be able to provide some support with this?</p>
<p>Thanks</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10430);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-06 1:47 pm</div>
				                <div>Hello RDM,<br />
<br />
Sorry for the problems with the slider on the iPhone.  This code is based on a third-party developed solution and is provided in order to give a simple solution for a Moodle installation. It's difficult to tell how you have setup the slider and determine why it's not working on iPhone without having some specific details on your installation (and a link to the problem page).  I would highly recommend that you use a different jQuery slider that is made for IOS.  Here's an option that you may want to try:  <a href="http://www.idangero.us/sliders/swiper/" rel="nofollow" target="_blank">Swiper</a>.  If you want to keep using the one in this article, then you may want to contact the author(s) of this jquery by going to this link: <a href="https://github.com/jcobb/basic-jquery-slider/" rel="nofollow" target="_blank">Github page  for the jquery</a>.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10436);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-11496'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/65d25c9f3c8cb3361e4e1329d4f3f4d6?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/65d25c9f3c8cb3361e4e1329d4f3f4d6'>Jitender</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-13 6:48 am</div>
				                <div><p>nice slider, it save my time</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11496);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-13525'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/94f803be2f6c8727b7957be7a2cd4d11?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/94f803be2f6c8727b7957be7a2cd4d11'>lalit</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-01 7:44 am</div>
				                <div><p>it is not working . and i m unable to find demo.css and bjqs.css file so my css is not add to images that is in html editor</p>
<p>Help me</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13525);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-01 9:48 am</div>
				                <div>Hello lalit,<br />
<br />
Thank  you for your question. The <strong>demo.css</strong>, and <strong>bjqs.css</strong> files are downloaded by following the link in the top of the article:<br />
<a href="https://github.com/jcobb/basic-jquery-slider/zipball/master" target="_blank" >https://github.com/jcobb/basic-jquery-slider/zipball/master</a><br />
<br />
It is included in the compressed file titled <strong>jcobb-basic-jquery-slider-8ffe118.zip</strong>.<br />
<br />
If you have any further questions, feel free to post them below.<br />
Thank you,<br />
<br />
-John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13537);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-14993'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/13ac109a2ffbdb7dab6932ad20650cfe?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/13ac109a2ffbdb7dab6932ad20650cfe'>Pavel</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-12 9:06 am</div>
				                <div><p>Hello!</p>
<p>Thanx for slider.&nbsp;</p>
<p>One question, how to put this slider on front page only? Is there any ways for that?</p>
<p>I'm using Moodle 2.6, theme "Clean".</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14993);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-12 10:37 am</div>
				                <div>Hello Pavel,<br />
<br />
Thank you for your question about putting a slider on the Moodle front page. In <strong>Step 4</strong>, just edit the front page.<br />
<br />
This should only add the slider to the front page. If it is added to every page by default, you will most likely have to use a <a href="http://www.inmotionhosting.com/support/edu/moodle/changing-appearance-moodle/changing-default-theme">different theme</a>, or create a custom <a href="http://www.inmotionhosting.com/support/edu/moodle/changing-appearance-moodle/customize-front-page">front page in Moodle</a>.<br />
<br />
Feel free to post any additional questions below.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15001);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-15393'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/374882996ca8aa06265838446ee834a9?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/374882996ca8aa06265838446ee834a9'>Maria</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-23 7:40 am</div>
				                <div><p>hi there, my images are shoing but not as a banner... they show with bullet points, as if they were subjects.</p>
<p>I've realized that, when I update the scritp into the HTLM editor, this part:</p>
<p><strong>&lt;script class="secret-source"&gt;</strong>&nbsp;&nbsp;&nbsp; jQuery(document).ready(function($) {&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; $('#banner-fade').bjqs({&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; height&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : 320,&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; width&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : 620,&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; responsive&nbsp; : true&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; });&nbsp;&nbsp;&nbsp; });<strong>&lt;/script&gt;</strong></p>
<p>&nbsp;</p>
<p>automatically changes to:</p>
<p><strong>&lt;script type="text/javascript"&gt;// &lt;![CDATA[</strong>&nbsp;&nbsp; &nbsp;jQuery(document).ready(function($) {&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;$('#banner-fade').bjqs({&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;height&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : 320,&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;width&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; : 620,&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;responsive&nbsp; : true&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;});&nbsp;&nbsp; &nbsp;});<strong>// ]]&gt;&lt;/script&gt;</strong></p>
<p>What am I doing wrong?</p>
<p>I mean, the images do display, and I've changed everything accordingly, I belive the issue is the transformation, I don't know why the script changes automatically.</p>
<p>Thank you for the help.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15393);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-23 10:44 am</div>
				                <div>Hello Maria,<br />
<br />
Thank you for your question. We are happy to help, but will need some additional information.<br />
<br />
Can you provide a link to the banner/bullet points, so we can replicate the problem.<br />
<br />
Also, what theme/plugins are you using for Moodle ?<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15416);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						...
						<div><a style='font-size:16px;' href='//www.gravatar.com/1aedb8d9dc4751e229a335e371db8058'>Test Moodle</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-16 8:41 am</div>
				                <div><p>Hey, tanks for your explanations.</p>
<p>Slider Moodle JQuery does not for me, Images are shown but as elements of list.</p>
<p>I have this error in Console : bjqs is not a function. How can i deal with it ?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24247);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-17 12:56 am</div>
				                <div>Hello Test Moodle,<br />
<br />
Are you sure that you are loading your jQuery before the script you are using?<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24265);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-31573'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/2fd16f359fe18922a6e0d12cb5159235?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/2fd16f359fe18922a6e0d12cb5159235'>Khan</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-31 5:14 am</div>
				                <div><p>Hi&nbsp;</p>
<p>how to change automatically generated caption in slider??</p>
<p>Please tell me</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31573);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-01 1:29 pm</div>
				                <div>Hello Khan,<br />
<br />
You should only have to change the image title if you are following the code above.<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31623);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
