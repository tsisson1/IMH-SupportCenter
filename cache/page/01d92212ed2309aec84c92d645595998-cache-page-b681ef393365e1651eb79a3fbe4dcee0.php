<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49721:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/file-manager" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="InMotion Hosting Support Center" />
  <title>File Manager | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/file-manager" rel="canonical" />
...
<script>
  ...
  ga('send', 'pageview');
	...
	<!-- cid:5c0e44c264ffeab250008ca23a0661f4 -->
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>File Manager</span></li>			</ul>
		</div>
	</div>
</div>
...
<form action="http://www.inmotionhosting.com/support/website/file-manager" method="post" name="adminForm" id="adminForm" class="form-inline">
  ...
  <table class='article_list'>
          ...
          <tr>
                                <td style='padding-right:20px;'><a href='/support/website/file-manager/show-hidden-files-in-file-manager'>How to show hidden files (htaccess) when using cPanel's File Manager</a></td>
                                <td>125,063</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/website/file-manager/compressing-uncompressing-files'>How can I compress / uncompress files using the File Manager?</a></td>
                                <td>24,107</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/website/file-manager/create-new-file'>How to create a new file</a></td>
                                <td>9,199</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/website/file-manager/understanding-character-encoding-in-the-code-editor-of-cpanel'> Understanding Character Encoding in the Code Editor of cPanel</a></td>
                                <td>6,391</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/website/file-manager/move-site-files'>An overview on moving applications from subfolders to your root folder</a></td>
                                <td>1,298</td>
                        </tr>
                  </table>
	</form>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MzAmaWQ9NDMwJnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
