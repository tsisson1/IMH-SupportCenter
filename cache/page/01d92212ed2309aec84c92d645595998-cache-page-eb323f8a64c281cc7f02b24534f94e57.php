<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50109:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/website-troubleshooting/suexec-policy-violation-in-php-script" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, Thank you for your question on the syEXEC policy violation. This is largely due to permissions. Check your folders and ensure they are set to 755..." />
  <title>suEXEC policy violation in PHP script | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/website-troubleshooting/suexec-policy-violation-in-php-script" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:03329a0361838aedd6aa6aa7c7923b2f -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '24.222.12.90']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>suEXEC policy violation in PHP script</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-09-12 10:09 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>1,243</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I'm transferring one of my websites from my old host to InMotionHosting and I'm getting a 500 and an odd error in the logs when I attempt to access my home page (www.apoc-media.com):<br />
<br />
[Sat Sep 12 19:01:49.097849 2015] [cgi:error] [pid 46699:tid 139800415237888] [client 24.207.184.54:50036] AH01215: suexec policy violation: see suexec log for more details: /home/blackh31/public_html/PAMEDIA/cgi-bin/default.php, referer: http://apoc-media.com/<br />
<br />
Since I do not appear to have access to the suexec log (or any additional Apache logs), I'm not sure what header, directive, or attribute is causing this.  Any ideas on what might cause this or how to access the suexec logs?</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_8100' id='upvote_answer_8100' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='8100' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_8100').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_8100' id='downvote_answer_8100' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='8100' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_8100').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
Thank you for your question on the syEXEC policy violation. This is largely due to permissions. Check your folders and ensure they are set to 755 with the php files themselves being 644. <br />
<br />
Kindest Regards,<br />
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_8100').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_8100' id='form_comment_on_answer_8100' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/website-troubleshooting/suexec-policy-violation-in-php-script&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/website-troubleshooting/suexec-policy-violation-in-php-script'></div>
<script type='text/javascript'>
  (function() {
