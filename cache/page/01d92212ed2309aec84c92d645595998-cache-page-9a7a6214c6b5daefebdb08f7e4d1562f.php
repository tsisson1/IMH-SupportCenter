<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:90238:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-3/extension/hide-module-after-login" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-10-26T14:59:53-07:00" />
  <meta name="keywords" content="joomla 3.0 hide modules after login" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="In this Joomla 3.0 tutorial, we'll show you how hide modules after a user has logged into your site." />
  <title>How to hide a module after login in Joomla 3.1 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-3/extension/hide-module-after-login" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:cac53faf8c1d34c9c45f01878d268418 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '46.161.9.32']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to hide a module after login in Joomla 3.1									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>11,513</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Oct 26, 2012'><span style='color:#606060;'>Published:</span> Oct 26, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In our Joomla 3.0 testing site, we have the following custom HTML module showing in our right sidebar:</p>
<p style="border: 1px solid #ccc; background: #eee; padding: 4px;"><strong>Become a Registered User</strong><br /><em>Register for an account on this website to gain access to all features that we offer</em></p>
<p>We don't want our registered and logged in users to see this message, as they're already registered. <strong>How do we hide this module after login?</strong> Keep reading to find out.</p>
<h2>How to hide a module when a user is logged in</h2>
<ol class="article_list">
<li><a href="/support/edu/joomla-3/getting-started/login-dashboard">Log into your Joomla 3.0 dashboard</a></li>
<li>In the top menu, click <strong>Extensions</strong> and then click <strong>Module Manager</strong></li>
<li>In the list of modules on the page, click the module that you don't want to show for logged in users</li>
<li>In the list of settings on the page, find the <em>Access</em> setting:<br /><br /><strong>Access</strong><br /><em>The access level group that is allowed to view this item.</em><br /><br />The default setting is Public, which is everyone that visits your site. This includes both guests and logged in users. To hide this module for users logged in, change the setting value to <strong>Guest</strong>, which means only guests will have permission to view it. Click Save in the top left of the page to save your settings.<br /><br />In the screenshots below, both are taken as a logged in user. One screenshot represents when the <strong>Public Access</strong> is set, and the other shows the <strong>Guest Access</strong> set.<br />
<table class="article_table">
<tbody>
<tr><th>Access: Public</th><th>Access: Guest</th></tr>
<tr>
<td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/extensions/module-showing-for-logged-in-users.jpg"><img style="max-width: 240px;"  alt="module-showing-for-logged-in-users" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/extensions/module-showing-for-logged-in-users.jpg" /></a></td>
<td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/extensions/joomla-hide-module-when-logged-in.jpg"><img style="max-width: 240px;"  alt="joomla-hide-module-when-logged-in" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/extensions/joomla-hide-module-when-logged-in.jpg" /></a></td>
</tr>
</tbody>
</table>
<br /><br /></li>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/joomla-3/extension'>104: Using Extensions in Joomla 3</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 5: How to hide a module after login in Joomla 3.1</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 4: <a href='/support/edu/joomla-3/extension/hide-module-title'>How to hide a module title in Joomla 3.1</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 6: <a href='/support/edu/joomla-3/extension/module-access-control'>New in Joomla 3.2 - Access Control and Easy Editing for Modules</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-3/extension/hide-module-after-login&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-3/extension/hide-module-after-login'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNjImaWQ9MTk0MiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="ecd81771bf44b6bd63f7063ae1b63784" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/joomla-3/extension?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Using Extensions in Joomla 3</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/joomla-3/extension/joomla-app-store?tsrc=rsbedu'>Using the Joomla App Store to install extensions in Joomla 3.2</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/joomla-3/extension/viewing-module-positions?tsrc=rsbedu'>How to View Module Positions in Joomla 3</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/joomla-3/extension/move-module-position?tsrc=rsbedu'>How to move a module's position in Joomla 3.1</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/joomla-3/extension/hide-module-title?tsrc=rsbedu'>How to hide a module title in Joomla 3.1</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/joomla-3/extension/hide-module-after-login?tsrc=rsbedu'>How to hide a module after login in Joomla 3.1</a></td>
                </tr>
          <tr >
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/joomla-3/extension/module-access-control?tsrc=rsbedu'>New in Joomla 3.2 - Access Control and Easy Editing for Modules</a></td>
                </tr>
          	</table>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/f502a1b6fed916fb3cb04b4e2177a1a7?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/f502a1b6fed916fb3cb04b4e2177a1a7'>Nadav Levy</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-10 6:40 am</div>
				                <div>You are saying to choose 'guest' but I don't have such option. Do I need to create this?<br />
<br />
Thanks</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12586);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-10 10:37 am</div>
				                <div>Hello Navdav,<br />
<br />
The &lt;strong&gt;Guest&lt;/strong&gt; group should be a default unless you've removed it. You should be able to navigate to &lt;strong&gt;Users &amp;gt; User Manager&lt;/strong&gt; in the Joomla admin, and then click on &lt;strong&gt;User Groups&lt;/strong&gt; on the right hand side too see all the available ones.<br />
<br />
I'm seeing this in a default &lt;strong&gt;Joomla 3&lt;/strong&gt; installm:<br />
<br />
&lt;img src=&quot;http://www.inmotionhosting.com/support/images/stories/questions/joomla/joomla-user-groups-guest-user-group-is-default.png&quot; alt=&quot;Joomla user groups guest group is default&quot; /&gt;<br />
<br />
If you don't see this, you should be able to click on &lt;strong&gt;+ New&lt;/strong&gt; still in the &lt;strong&gt;User Manager &amp;gt; User Groups section&lt;/strong&gt;.  Select &lt;strong&gt;Public&lt;/strong&gt; as the parent of this group and name it something like &lt;stron&gt;Guest&lt;/strong&gt;.<br />
<br />
Then click on &lt;strong&gt;Viewing Access Levels&lt;/strong&gt; from the left-hand side. Click on the &lt;strong&gt;Guest&lt;/strong&gt; level, and then under the &lt;strong&gt;User Groups Having Viewing Access&lt;/strong&gt; place a check-mark beside the &lt;strong&gt;Guest&lt;/strong&gt; user group you created.<br />
<br />
Please let us know if that helps!<br />
<br />
- Jacob</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12599);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-14252'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/2a44a0fe67a4f5f75819753461334a72?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/2a44a0fe67a4f5f75819753461334a72'>Juanita</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-22 5:00 pm</div>
				                <div><p>Hi, i choose Guest from the acces level in the menu, but when a refresh the page, the menu dessapear even if i'm not loggued in :S</p>
<p>why could this happen?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14252);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-22 5:48 pm</div>
				                <div>Hello Juanita, <br />
<br />
Thanks for the question.  Without knowing how your Joomla is setup, the cause to your module showing not appearing after you have assigned it to a specific group could be few different possibilities.  I would double-check to make sure that you are not logged in through a cached page (<a href="http://www.inmotionhosting.com/support/website/how-to/clear-browser-cache">clear the browser cache</a>. Also, double-check your "guest" user and make sure it is assigned properly in the Users Module.  Lastly, look at the module you where you modified the access - make sure it is set correctly, saved and published.  If it continues to be a problem, we would need further information about your site.  A URL would help, as well as the exact steps you're taking when assigning the user values to the module.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14253);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-14729'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/417ba916e23a499d199aee0d6497bc16?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/417ba916e23a499d199aee0d6497bc16'>Saman</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-04 5:28 pm</div>
				                <div>Go to UserManager?Options?Component and set "GuestUserGroup" to Guest</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14729);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-04 6:19 pm</div>
				                <div>Hello Saman,<br />
<br />
If you have a specific question, could please state it again?  We are not sure if you are asking a question.<br />
<br />
Kindest regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14731);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						...
						<div><a style='font-size:16px;' href='//www.gravatar.com/e8797590dd49d9ce4e9b7a6137df22d8'>arnie</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-10 10:06 am</div>
				                <div><p>Hello Arn,</p>
<p>I am having a strange problem.</p>
<p>My guest user access was working correctly. however suddenly all the menus that are set to guest are no longer dissappearing when I login. this is causing a lot of problems I wonder if you could help urgently. my site is uk.africansbay.com. The menus that are set to guest are login and advertise. The menus set to registered all work correctly just the guest user menus. let me know if you can help and I will send you some login details. thanks.</p>
<p>&nbsp;</p>
<p>Arnie</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14908);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-10 12:48 pm</div>
				                <div>Hello Arnie,<br />
<br />
Thank you for your question. We are happy to help, but when I navigate to your site to test it, I get the message "This site is down for maintenance. Please check back again soon."<br />
<br />
Also if you made changes recently, you may need to <a href="http://www.inmotionhosting.com/support/website/how-to/clear-browser-cache">clear your browser cache</a> before testing.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14918);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 160px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-10 1:02 pm</div>
				                <div><p>hi John-paul</p>
<p>I have now enabled the site. I have also cleared both joomla and browser caches since the problem began. Thank you for your quick response. Can you tell me how I can send you login details privately so you can test what I am talking about?</p>
<p>&nbsp;</p>
<p>Best regards,</p>
<p>&nbsp;</p>
<p>Arnie</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14919);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 200px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-10 1:45 pm</div>
				                <div>Hello Arnie, <br />
<br />
Sorry to hear that you're still having the problem with Joomla.  You can always send us a new question with private information and we can remove it before the question is published.  <br />
<br />
In terms of this problem, I looked up the forums to see if the issue was common.  Check out these posts as it seems that they're discussing the same problem:  <a href="http://forum.joomla.org/viewtopic.php?f=624&t=583868" rel="nofollow" target="_blank">Joomla Fourm</a>.<br />
<br />
I hope that helps to clarify the issue and provide you answer.  Please provide us more information if required.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14920);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 240px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-10 3:18 pm</div>
				                <div><p>Hi Arn/john-paul</p>
<p>can you use the following to login to the front end of the site. As you suggested please delete these details before making the post live. I would like the Advertise menu and Login menu to disappear as soon as someone logs in. I have been able to implement this for several other sites but I cannot see what is stopping this working correctly on this site. (login info has been removed).</p>
<p>&nbsp;</p>
<p>The logins will only be active this evening, so your prompt help will be much appreciated. Please remember to remove them from the post before making it live. &nbsp;</p>
<p>&nbsp;</p>
<p>Best regards,</p>
<p>&nbsp;</p>
<p>Arnie</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14923);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 320px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-11 4:01 pm</div>
				                <div><p>The problem I am trying to solve is exactly related. I have set all the permissions correctly but they are not working as expected.</p>
<p>Thank you for trying to help anyway. I had chosen to enquire on this forum because your help is usually useful and quick.</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>best regards,</p>
<p>&nbsp;</p>
<p>arnie &nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14970);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/30a78d1d85baa6eeb4bc59650800275a?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/30a78d1d85baa6eeb4bc59650800275a'>John</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-23 10:11 am</div>
				                <div><p>PERFECT!</p>
<p>Thank you for this tip and well described.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24387);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
