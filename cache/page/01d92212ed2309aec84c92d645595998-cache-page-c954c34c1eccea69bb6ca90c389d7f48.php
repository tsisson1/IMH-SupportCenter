<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:85369:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/prestashop-15/getting-started/login-to-dashboard" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-06-26T13:38:41-07:00" />
  <meta name="keywords" content="log in into prestashop 1.5 login dashboard how to [gs]" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="In this PrestaShop 1.5 tutorial, we'll show you how to log into your PrestaShop 1.5 Dashboard for the first time. Your PrestaShop dashboard is where you will login and manage your store." />
  <title>How to log into PrestaShop 1.5 Dashboard - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/prestashop-15/getting-started/login-to-dashboard" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:adb30d306eb2f9015be7112adb5bb98a -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to log into PrestaShop 1.5 Dashboard									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>33,487</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: May 15, 2012'><span style='color:#606060;'>Published:</span> Jun 26, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p style='margin-bottom:0px;'><iframe width="675" height="315" src="http://www.youtube.com/embed/e6oSkdau-R8" frameborder="0" allowfullscreen></iframe></p><p style='background:#ffffcc; padding:4px; margin-top:0px; border:1px solid #000;'>Following our <a href="/support/edu/prestashop-15">PrestaShop getting started guide</a>? Your next step is to learn <a href="/support/edu/prestashop-15/add-products-categories/add-categories">how to add categories to your store</a>.</p>

<p>Now that you have successfully <a href="/support/edu/prestashop-15/getting-started/manual-install">installed PrestaShop 1.5</a>, you are ready to log into the Admin Dashboard so you can begin creating your shopping cart. The PrestaShop 1.5 Dashboard is the administrative area of your store where you can add new products and manage all other aspects of the storefront as well.</p>
<h2>Before logging into the PrestaShop 1.5 Dashboard for the first time (manual installs only)</h2>
<p>If you installed PrestaShop 1.5 using Softacluous, then you can move to the next section on <a href="#login-to-dashboard">how to log into the PrestaShop 1.5 dashboard</a>. Otherwise, you will need to have completed the following tasks for security reasons:</p>
<ol>
<li>Deleted the install folder</li>
<li>Renamed the Admin folder (for example admin123, adminxyz, 123admin, xyzadmin, etc.) For sample purposes only, we will use admin123 as the new admin folder name.</li>
</ol>
<p class="alert">If you manually installed PrestaShop 1.5, failure to do both of these will prevent you from being able to log into the dashboard.</p>
<a name="login-to-dashboard"></a><h2>To log into the PrestaShop 1.5 Dashboard:</h2>
<ol class="article_list">
<li><strong>Visit your PrestaShop 1.5 Dashboard login page</strong><br /><br />To get to the login area, type in your new admin URL based on what you renamed your admin folder. Using the example above (admin123), it would be http://www.sampledomain.com/admin123. You should see a login page like the one below:
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/login-to-dashboard/prestashop-15-dashboard-login.gif"><img  alt="prestashop-15-dashboard-login" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/login-to-dashboard/prestashop-15-dashboard-login.gif" /></a></p>
</li>
<li>
<p><strong>Login using your email address and password</strong><br /><br />From there you will sign in with the email address and password you entered when installing the program. Upon successfully logging in, you should see your dashboard and all the tools necessary to build your new shopping cart.</p>
</li>
</ol>

<p>Next, learn how to <a href="/support/edu/prestashop-15/add-products-categories/add-categories">add categories to PrestaShop 1.5</a>.</p>

<p>If you have any further questions or receive any errors when attempting to log in, please feel free to <a href="/support/community-support">submit a question</a>.</p>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/prestashop-15/getting-started'>101: Getting Started with Prestashop 1.5</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 3: How to log into PrestaShop 1.5 Dashboard</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 2: <a href='/support/edu/prestashop-15/getting-started/manual-install'>How to manually install Prestashop 1.5</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/prestashop-15/getting-started/login-to-dashboard&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/prestashop-15/getting-started/login-to-dashboard'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yMjkmaWQ9MTMxMCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/prestashop-15/getting-started?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Getting Started with Prestashop 1.5</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/prestashop-15/getting-started/how-to-install-prestashop-with-softaculous?tsrc=rsbedu'>How to install PrestaShop with Softaculous</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/prestashop-15/getting-started/manual-install?tsrc=rsbedu'>How to manually install Prestashop 1.5</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/prestashop-15/getting-started/login-to-dashboard?tsrc=rsbedu'>How to log into PrestaShop 1.5 Dashboard</a></td>
                </tr>
          	</table>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/11ac92383c206f2fb9ea088e250639e2?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/11ac92383c206f2fb9ea088e250639e2'>helene talbot</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-14 6:14 pm</div>
				                <div><p>I tried every password and &nbsp;username I have and no result.</p>
<p>domain &nbsp; moutnet.ca &nbsp; &nbsp;username ? &nbsp;&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11585);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-15 8:39 am</div>
				                <div>Hello Helene,<br />
<br />
The username for PrestaShop is an email address. This would have been specified when you installed the program, so if you remember entering an email address then, use that one and see if it allows you to log in.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11610);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-26 9:27 am</div>
				                <div><p>I installed prestashop using softaculous. I then received an email with the links and info.&nbsp;</p>
<p>I clicked on the admin link http://techmethod.com/admin123 and it said "Oops. Google Chrome could not find techmethod.com".&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12017);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-26 9:58 am</div>
				                <div>Hello Gary,<br />
<br />
Thank you for your question. I looked up the <a href="http://www.inmotionhosting.com/support/domain-names/general-information/how-to-look-up-domain-whois" target="_blank">Whois</a> for your domain, and it is not pointed to our nameservers.<br />
<br />
After <a href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/change-domain-nameservers-amp">pointing to our nameservers in AMP</a>. <br />
<br />
Here are our Nameservers:<br />
<strong>Primary</strong>: ns.inmotionhosting.com<br />
<strong>Secondary </strong>: ns2.inmotionhosting.com<br />
<br />
Be sure to allow up to 24 for the DNS change to <a href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/domain-names-dns-changes">propagate</a>.<br />
<br />
If you have any further questions, feel free to post them below.<br />
Thank you,<br />
<br />
-John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12018);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-26 6:48 pm</div>
				                <div><p>Huh???</p>
<p>I'll take a wild stab at translating this: You fixed it and I should wait 24 hours to see if it works, right?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12038);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-26 7:24 pm</div>
				                <div>Hello Gary,<br />
<br />
Sorry for the confusion, it looks like John Paul accidentally linked to the Whois article twice instead of the &lt;a href=&quot;http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/change-domain-nameservers-amp&quot; target=&quot;_blank&quot;&gt;changing your name servers in AMP&lt;/a&gt; guide, so you might have went on a bit of a wild goose chase.<br />
<br />
Essentially right now your domain is registered with us, but set to use the following name servers:<br />
<br />
&lt;strong&gt;Primary:&lt;/strong&gt; NS3.LIVEDNS.CO.UK<br />
&lt;strong&gt;Secondary:&lt;/strong&gt; NS1.LIVEDNS.CO.UK<br />
<br />
If you want your domain name to pull from our web-server, you need to point it at our name servers instead:<br />
<br />
&lt;strong&gt;Primary:&lt;/strong&gt; NS.INMOTIONHOSTING.COM<br />
&lt;strong&gt;Secondary:&lt;/strong&gt; NS2.INMOTIONHOSTING.COM<br />
<br />
After making that change, it can take up to 24 hours for the DNS settings to fully propagate across the Internet and for your site to be available everywhere. If you're interested at all about why this needs to change, check out our &lt;a href=&quot;http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/what-is-a-name-server&quot; target=&quot;_blank&quot;&gt;what is a name server&lt;/a&gt; guide.<br />
<br />
Unfortunately I can't change this for you because public comments aren't a verifiable medium, you could either follow the steps in that guide or &lt;a href=&quot;http://www.inmotionhosting.com/support/website/getting-started-guides/submitting-and-checking-on-status-of-tickets#submit-ticket&quot; target=&quot;_blank&quot;&gt;submit a ticket&lt;/a&gt; and we'd be glad to help you out!<br />
<br />
- Jacob</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12039);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-27 12:10 pm</div>
				                <div><p>Thanks. Being that I am totally clueless, the last thing I need is a wild goose chase. I made the changes (I think) and now time will tell if I did it right.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12082);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-27 2:27 pm</div>
				                <div>Hello Gary,<br />
<br />
No problem at all, sorry again for the confusion. It looks like your domain is resolving now to our server successfully, so hopefully you should be seeing that as well now.<br />
<br />
- Jacob</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12084);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-20467'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/ef714d2f5b2e8d121036a2ec5ad0518f?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/ef714d2f5b2e8d121036a2ec5ad0518f'>Sastha</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-07 2:49 am</div>
				                <div><p>When am tried to acces my customer backoffice&nbsp;</p>
<p><strong>http://cosmecare-shop.dk/Backoffice/</strong></p>
<p>am getting following error . but customer told this error getting when hosting provider upgraded php5.6.</p>
<p>&nbsp;</p>
<p>http://prntscr.com/622b1t</p>
<p>&nbsp;</p>
<p>am cleared cache and cookies...</p>
<p>&nbsp;</p>
<p>can you please help me</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20467);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-09 10:32 am</div>
				                <div>Hello Sastha,<br />
<br />
That error typically comes from redirects. You will want to check your .htaccess file and investigate any redirect code in there.  Look for things that conflict, like having code that says a redirects to b and another line that says b redirects to a. That would cause a redirect loop.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20505);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-25343'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/2ae3959a92d46550442a483a97c96fc7?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/2ae3959a92d46550442a483a97c96fc7'>David</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-30 9:52 pm</div>
				                <div><p>I'm attempting to install Prestashop on one of my addon domains first so that my office admin can learn how it works. We'll install it on a diferent addon domain for public access after that</p>
<p>I installed it here:&nbsp; /home/myserver/public_html/addon.com</p>
<p>I clicked on the url&nbsp;&nbsp; http://addon.com</p>
<p>I landed on a Parked Domain page at GoDaddy, our previous host. So I went over there and changed nameservers to</p>
<p>ns.inmotionhosting.com and</p>
<p>ns2.inmotionhosting.com</p>
<p>I did that at 1730 Pacific. I know it could take 24+ hours to propagate (I'm in Phoenix and 6 hours is what I usually see).</p>
<p>Is there anything else I need to do?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25343);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-01 1:20 pm</div>
				                <div>Hello David,<br />
<br />
That should be all you need to do as long as the domain is setup as an addon domain on your cPanel account and you have modified the name servers at this time you would just need to wait for the propagation.<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25372);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
