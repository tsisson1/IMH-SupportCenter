<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:58381:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/cpanel/how-to-give-ftp-access-to-hired-web-developer-part2" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hi Becket, While someone logged into cPanel can click on the Update Billing Info icon in cPanel, unless they are already logged into AMP, they will be p..." />
  <title>How to give FTP access to hired web developer : part2 | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/cpanel/how-to-give-ftp-access-to-hired-web-developer-part2" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:2cf86309c5daa1b74006cbaeed3e22f6 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>How to give FTP access to hired web developer : part2</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/Becket'>Becket</a>
			<div>19 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2011-10-24 5:47 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>20,893</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Hi Tim S or somebody else.<br />
It's me again.<br />
<br />
I wish to request your help once again.<br />
I was going to let the hired web expert log into the Cpanel, having taken care to change the password Cpanel shared with AMP. Then I noticed that through the Cpanel they would be able to access the AMP through the button &quot;update billing info&quot; that comes under &quot;preferences&quot;( here you find payment details, credit card...)<br />
SO, since Cpanel and Amp are connected through that, I figured it is best to avoid CPanel access altogether.<br />
<br />
So now I have installed WP as you advised (a piece of cake... :-)<br />
<br />
...
<br />
2. For their access to my site's databases do I do that through the &quot;Remote MYSQL button&quot;.<br />
<br />
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_200' id='upvote_answer_200' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='200' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_200').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_200' id='downvote_answer_200' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='200' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_200').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					<img src='/support/images/avatars/default_avatar.jpg' class='user_avatar' style='max-width:60px;' /><br />
                		        <a href='/support/community-support/users/CNick'>CNick</a>
					
					<div>1,344 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2011-10-24 6:07 pm EST
                		        </div>
				...
				Hi Becket,<br />
<br />
While someone logged into cPanel can click on the Update Billing Info icon in cPanel, unless they are already logged into AMP, they will be presented with an AMP login screen. So, they would still need to know your AMP login information to be able to access AMP.<br />
<br />
With that being said, I thought you might like a little more information on FTP and Remote MySQL access in case you ever need it.<br />
<br />
Please check out our &lt;a href=&quot;http://www.inmotionhosting.com/support/website/file-management/getting-started-guide-ftp&quot; target=&quot;new&quot;&gt;FTP Getting Started Guide&lt;/a&gt; for more information about setting up and working with FTP.<br />
<br />
There is, however, a way to allow your developer to use phpMyAdmin without cPanel access.<br />
<br />
Below are the instructions that guide you through the process of giving your developers this access:<br />
<br />
1. Go to http://www.phpmyadmin.net/home_page/downloads.php<br />
2. Select the file named phpMyAdmin-3.4.1-all-languages.tar.gz<br />
3. Login to your cpanel &gt; File Manager<br />
4. Upload the phpMyAdmin-3.4.1-all-languages.tar.gz file<br />
5. Right click and extract the file (it will extract into a folder named phpMyAdmin-3.4.1-all-languages)<br />
6. Rename the folder to whatever name you want (commonly phpmyadmin)<br />
7. Still in cpanel, go to the MySQL Databases tool.<br />
8. Create a user for your developer (commonly dev) (Take note of the password as you cannot go back to view it and you have to remove and readd the user to change the password)<br />
9. Add the user to whichever databases you want the developers to have access to.<br />
10. The developers can now log into phpmyadmin by using the URL http://domain.com/phpmyadmin using the database username given them.<br />
11. They will be able to work on the databases using phpmyadmin without cpanel access.<br />
12. You can also &lt;a href=&quot;http://www.inmotionhosting.com/support/website/cpanel/how-do-i-password-protect-a-directory-in-my-control-panel-cpanel&quot; target=&quot;new&quot;&gt;password protect&lt;/a&gt; this folder for an additional layer of security.<br />
<br />
...
Christi N.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_200').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_200' id='form_comment_on_answer_200' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
...
<div class='  not_best_answer'>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px; width:50px;' valign='top'>
<div class='vote_div'>
	<form method='post' name='upvote_answer_201' id='upvote_answer_201' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='201' />
		<input type='hidden' name='component' id='component' value='qa' />
		<input type='hidden' name='vote_value' id='vote_value' value='1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_201').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_201' id='downvote_answer_201' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='201' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_201').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
...
Christi N.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_201').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_201' id='form_comment_on_answer_201' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
					                <p>You must <a href='/support/login'>login</a> before you can post a comment about this answer.</p>
					        </div></div></div></div>
					</form>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/cpanel/how-to-give-ftp-access-to-hired-web-developer-part2&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/cpanel/how-to-give-ftp-access-to-hired-web-developer-part2'></div>
<script type='text/javascript'>
  (function() {
