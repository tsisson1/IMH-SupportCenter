<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:48486:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/email/squirrelmail-webmail" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="keywords" content="%default%" />
  <meta name="description" content="SquirrelMail Webmail Category" />
  <title>SquirrelMail Webmail | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/email/squirrelmail-webmail" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:c0f9c15909b581d86965a49b5b0ae55c -->
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>SquirrelMail Webmail</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='item-page'>
        ...
        <div class='page-header'>
                <h1>SquirrelMail Webmail</h1>
        </div>

<p>If you want to check your email while on the road or do not have a desktop email client, you can check and send your email using one of the webmail clients included with your hosting.&nbsp; SquirrelMail is the most basic webmail client currently offered, however it makes it easy to write, send, and receive emails.&nbsp; You can also create folders, add contacts, and much more.&nbsp; Below we have many guides to get you started with SquirrelMail, along with video tutorials.</p>
<form action="http://www.inmotionhosting.com/support/email/squirrelmail-webmail" method="post" name="adminForm" id="adminForm" class="form-inline">
  ...
  <table class='article_list'>
          ...
          <tr>
                                <td style='padding-right:20px;'><a href='/support/email/squirrelmail-webmail/create-signature'>How to create an email signature in SquirrelMail</a></td>
                                <td>14,626</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/email/squirrelmail-webmail/using-boxtrapper'>Using BoxTrapper</a></td>
                                <td>6,049</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/email/squirrelmail-webmail/creating-an-email-filter'>Video: Creating an email filter</a></td>
                                <td>4,716</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/email/squirrelmail-webmail/how-to-login-to-squirrelmail'>How to login to SquirrelMail</a></td>
                                <td>4,578</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/email/squirrelmail-webmail/managing-your-address-book-squirrelmail'>Managing your address book in SquirrelMail</a></td>
                                <td>3,481</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/email/squirrelmail-webmail/modifying-folder-preferences'>Modifying folder preferences in SquirrelMail</a></td>
                                <td>3,260</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/email/squirrelmail-webmail/modifying-display-preferences-squirrelmail'>Modifying display preferences in SquirrelMail</a></td>
                                <td>3,256</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/email/squirrelmail-webmail/composing-a-new-email-message'>Composing a new email message</a></td>
                                <td>3,219</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/email/squirrelmail-webmail/modifying-index-order-squirrelmail'>Modifying Index Order in SquirrelMail</a></td>
                                <td>3,162</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/email/squirrelmail-webmail/folders-squirrelmail'>Creating Folders in SquirrelMail</a></td>
                                <td>1,847</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/email/squirrelmail-webmail/subscribe-webmail-folders'>How to subscribe to folders in Squirrel Mail</a></td>
                                <td>1,361</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/email/squirrelmail-webmail/message-highlighting'>Using Message Highlighting in SquirrelMail </a></td>
                                <td>163</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/email/squirrelmail-webmail/edit-profile'>Editing your profile in SquirrelMail</a></td>
                                <td>107</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/email/squirrelmail-webmail/read-email'>Reading an email in SquirrelMail</a></td>
                                <td>93</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/email/squirrelmail-webmail/create-email'>How to create an email in SquirrelMail</a></td>
                                <td>85</td>
                        </tr>
                  </table>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD03NCZpZD03NCZ2aWV3PWNhdGVnb3J5Jkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="03b5375e197c7866191c8493f78e8af5" value="1" />	</div>
	</form>
<!-- <br />
