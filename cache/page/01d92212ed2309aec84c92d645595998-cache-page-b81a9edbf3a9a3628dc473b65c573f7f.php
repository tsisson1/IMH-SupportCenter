<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:55221:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/dreamweaver/dreamweaver-web-design-software-spry" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello greenDaf, From what I see from the official Dreamweaver documentation, the accordion widget that you are referring to uses a single CSS file for a..." />
  <title>Dreamweaver Web Design Software, Spry | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/dreamweaver/dreamweaver-web-design-software-spry" rel="canonical" />
...
<script>
  ...
  ga('send', 'pageview');
	...
	<!-- cid:7f82c7c656fd8e38d190fe056c93a7d3 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box straight_bottom'>
                <h1 style='font-size:26px;'>Dreamweaver Web Design Software, Spry</h1>
		<div style='margin-bottom:20px; margin-top:10px; clear:both; color:#6e6e6e;'>Category: <a href='/support/community-support/dreamweaver'>Dreamweaver</a></div>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px;'>
				<div style='font-size:12px; max-width:500px; overflow:auto;'>I want to add that this is an issue only when the web page is saved to a particular site root folder.   I can make individual accordions that look different (have different .css) when I'm working in my other site folders.  I know that the .css and .js files for each accordion are saved within the SpryAssets folder in the site root folder.  I thought something might be wrong related to the SpryAssets folder.</div>
			...
			<td style='width:100px;' valign='top'>
				...
				<div class='smallgrey'>
					<a href='/support/community-support/users/greenDaf'>greenDaf</a><br />
					74 <a href='/support/team/points' target='_blank'>Points</a><br />
					2015-01-26 10:51 pm EST
				</div>
			</td>
		</tr>
	</table>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_6390' id='upvote_answer_6390' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='6390' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_6390').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_6390' id='downvote_answer_6390' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='6390' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_6390').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello greenDaf,<br />
<br />
From what I see from the &lt;a href=&quot;http://helpx.adobe.com/dreamweaver/using/spry-accordion-widget.html&quot;&gt;official Dreamweaver documentation&lt;/a&gt;, the accordion widget that you are referring to uses a single CSS file for all pages in which if you cange it on one page, it will change it on the others.<br />
<br />
Normally, you could just make a copy of that CSS file, rename it to something else, and include it on the other page in which edits to that second CSS file would not affect the initial page, but I am unsure of how Dreamweaver would handle it.<br />
<br />
Best regards,<br />
JeffMa
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_6390').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_6390' id='form_comment_on_answer_6390' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hi Jeff, Thank you for your reply.  Dreamweaver will let you have differently styled accordions in the same site.  I know this because I currently have three up on the web and they are different.  I know that the accordion is dependent on the SpryAccordion.css and SpryAccordion.js files that are automatically put in the SpryAssets folder when you make an accordion.  I have 3 different accordions yet there's been only two pairs of the above mentioned files in the SpryAssets folder.  Dreamweaver will no longer insert a Spry Accordion for me with anything but my previous css (colors,etc.).  When I change this .css it changes the other accordions.  </div>
							...
							<td style='width:96px;' valign='top'>
								...
								<div class='smallgrey'>
									<a href='/support/community-support/users/greenDaf'>greenDaf</a><br />
									74 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2015-01-27 6:24 pm EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hi Jeff, again.  I am happy to report I seemed to have solved my problem.  What I did was save my new accordion-to-be page in a subfolder of my site folder.  When I inserted an accordion, SpryAssets folder and files were put in the sub folder.  New Spry Assets know nothing about old Spry Assets!  Thanks again.<br />
greenDaf</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>It sounds like they are all sharing the same CSS files in which styles are inherited from the others.  You would need to add additional styling to it on the additional pages.  Unfortunately, none of us here are Dreamweaver users and don't have a whole lot of information on it outside of Google searches, so contacting Adobe may be your best option for more specific information.</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hi Jeff, again.  Thank you for your reply.  I wanted to come back to tell you a new discovery.  Two of my three previous accordion pages that were saved in a similar location actually were the same and I didn't even realize it.  The other one which was obviously different looking had worked out because it was saved in a sub folder, which led me to my discovery.  </div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/dreamweaver/dreamweaver-web-design-software-spry&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/dreamweaver/dreamweaver-web-design-software-spry'></div>
<script type='text/javascript'>
  (function() {
