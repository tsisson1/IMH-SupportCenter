...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/moodle" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Welcome to our Moodle Education Channel, our online tutorial series dedicated to teaching you everything moodle!" />
  <title>Moodle | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/moodle" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:41096218984b68b0bf9066994fd96791 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '31.51.228.145']);
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Moodle</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	...
	<div class='item-page'>
		<div class='page-header'>
			<h1>Moodle Education Channel</h1>
		</div>
...
<li  ><a href='/support/edu/moodle/new-to-moodle'>101: Getting Started with Moodle</a></li>
<li  ><a href='/support/edu/moodle/creating-courses'>102: Creating Courses in Moodle</a></li>
<li  ><a href='/support/edu/moodle/activity-resource'>103: Adding an activity or resource to a course in Moodle</a></li>
<li  ><a href='/support/edu/moodle/question-bank'>104: Working with the Question Bank</a></li>
<li  ><a href='/support/edu/moodle/user-roles-moodle'>105: User Accounts and Permissions in Moodle</a></li>
<li  ><a href='/support/edu/moodle/moodle-grading-reports'>106: Moodle Grading and Reports</a></li>
<li class='features collapse' ><a href='/support/edu/moodle/changing-appearance-moodle'>107: Changing the Appearance of Moodle</a></li>
<li class='features collapse' ><a href='/support/edu/moodle/moodle-plugins'>108: Managing Moodle Plugins</a></li>
<li class='features collapse' ><a href='/support/edu/moodle/additional-moodle-features'>109: Additional Moodle features</a></li></ul><ul style='float:left; width:300px; margin-right:20px;'>
<li  ><a href='/support/edu/moodle/moodle-site-security'>201: Moodle site security and server settings</a></li>
<li  ><a href='/support/edu/moodle/custom-moodle-reports'>202: Making Custom Moodle Reports</a></li></ul><ul style='float:left; width:300px; margin-right:20px;'>
<li  ><a href='/support/edu/moodle/advanced-tutorials'>300: Advanced Tutorials</a></li></ul><div style='clear:both;'></div></div>
...
<form action="http://www.inmotionhosting.com/support/edu/moodle" method="post" name="adminForm" id="adminForm" class="form-inline">
	...
	<option value="0">All</option>
		...
		<h2>Moodle - Advanced Tutorials</h2>
		<table style='margin-top:20px;'>
			...
			<tr>
				...
				<td valign='top' style='padding-bottom:15px;'>
					<div><a href='/support/edu/moodle/errors-unicode-database-undefined-constant'>301: Fixing common errors when installing Moodle</a></div>
					<div>Fixing the Use of undefined constant, Database driver, and Database unicode errors when installing Moodle 2.3.</div>
					<div class='smallgrey'>
			...
			<tr>
				<td valign='top' style='padding:6px 15px 0px 0px;'><img src='https://lh5.googleusercontent.com/-sqOlcmmeoz4/AAAAAAAAAAI/AAAAAAAAAIM/EKb76fhiG6s/photo.jpg?sz=50' class='sc_rc' style='width:55px;' /></td>
				<td valign='top' style='padding-bottom:15px;'>
					<div><a href='/support/edu/moodle/image-slider-moodle-jquery'>302: Inserting an image slider in Moodle</a></div>
			...
			<tr>
				<td valign='top' style='padding:6px 15px 0px 0px;'><img src='https://lh5.googleusercontent.com/-sqOlcmmeoz4/AAAAAAAAAAI/AAAAAAAAAIM/EKb76fhiG6s/photo.jpg?sz=50' class='sc_rc' style='width:55px;' /></td>
				<td valign='top' style='padding-bottom:15px;'>
					<div><a href='/support/edu/moodle/303-enabling-error-reporting-in-moodle'>303: Enabling Error Reporting in Moodle</a></div>
					<div>To diagnose your Moodle site when pages stop loading you can enable error reporting. This article will show you how.</div>
					<div class='smallgrey'>
						Written by James Richardson<br />
						Hits: 5,555
					</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xMDImaWQ9MTAyJnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="fc4a03901d61209b69129bd96158713c" value="1" />	</div>
	</form>
<!-- <br />
