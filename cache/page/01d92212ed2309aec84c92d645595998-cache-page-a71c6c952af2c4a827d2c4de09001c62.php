<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:70224:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/ssl/what-is-ssl-and-why-is-it-important" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-12-10T03:20:48-08:00" />
  <meta name="keywords" content="SSL What is Secure Sockets Layer HTTPS certificate authentication" />
  <meta name="author" content="Tim Sisson" />
  <meta name="description" content="Learn the basics behind what an SSL certificate is and why they are important to some websites. " />
  <title>What is SSL and why is it important? - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/ssl/what-is-ssl-and-why-is-it-important" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:da5a537b4a2aaa8ad81f0694ca7179db -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '24.197.103.80']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>What is SSL and why is it important?</span></li>			</ul>
		</div>
	</div>
</div>
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>27,855</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Nov 2, 2011'><span style='color:#606060;'>Published:</span> Dec 10, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<h2>What is SSL?</h2>
<p>SSL (Secure Sockets Layer) is a standard technology behind establishing an encrypted connection between a web server (host) and a web browser (client). This connection between the two makes sure that all the data passed between them remain private and intrinsic. SSL is an industry standard and is used by millions of websites to protect their online transactions with their customers. If you have ever visited a website using the <em>https://</em> in the address bar you were creating a secure connection via SSL. If you have an eshop or sell items via your website, SSL helps in establishing trust with your customers. </p>


<h2>Understanding how the SSL connection protects your data</h2>

<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/ssl/secure-ssl-connection.png"><img   alt="Secure SSL connection protects against intrusion" src="//cdn.inmotionhosting.com/support/images/stories/edu/ssl/secure-ssl-connection.png" /></a>

<p>Using an SSL certificate creates an encrypted connection between the user's web browser and the web server.  This means that any data transmitted between the web server and the web browser can not be read without first being decrypted.  This protects the data from being spied upon by someone else on the internet because they will not be able to understand the encrypted data.</p>

<h2>How the encrypted connection is established</h2>


<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/ssl/secure-connection-illustration.png"><img   alt="Secure SSL connection illustration" src="//cdn.inmotionhosting.com/support/images/stories/edu/ssl/secure-connection-illustration.png" /></a>

<p>There a few basic steps that occur when you attempt to establish secure connection.  Here's a summary of the steps:</p>

<ol class="article_list">
<li>You type in or select the secure URL (e.g. "https://abcdefg.com")</li>
<li>The web server receives your request and then submits a reply that attempts to establish trusted connection between the web browser and the web server - also called the "SSL handshake."</li>
<li>After the SSL certificate is verified through the SSL handshake, the data transferred between the web server and web browser is encrypted to keep it private and secure.</li>
</ol>


<h2>How to tell if a site is using SSL</h2>
<p>While the details of the SSL protocol are not displayed to the visitor, most browsers will display a lock or some other form of identification in the address bar. This will indicate if you are currently protected by an SSL encrypted session. If you would like the details of the SSL certificate you can simply click on the lock.</p>


<h2>What does the SSL mean to visitors?</h2>
<p>Most SSL Certificates contain the domain name, company name, address, city, state, and country. It also contains an expiration date of the certificate and the details of the Certificate Authority (the company who issued the SSL). When a browser attempts to establish an SSL connection to a website it checks to make sure the certificate is not expired, has been issued by a trusted authority, and is being used for the correct website. If any of these checks fails your web browser will display a warning letting the user know that the site is not secured by SSL.</p>

<h2>How do I get an SSL for my website?</h2>
<p>Please read our article on <a href="/support/website/ssl/how-do-i-obtain-an-ssl-certificate">Ordering an SSL</a> if you'd like more information. For further assistance or if you have any more questions please feel free to contact our<a href="/support/website/website-troubleshooting/how-to-get-great-technical-support"> support department</a>.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/ssl/what-is-ssl-and-why-is-it-important&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/ssl/what-is-ssl-and-why-is-it-important'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD03NiZpZD0yODQmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/ssl/install-ssl-before-i-have-my-domain?tsrc=rsbraq'>Install SSL before I have my domain pointed</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/ssl/when-using-https-secure-connection-failed?tsrc=rsbraq'>when using https: = &quot;secure connection failed&quot;</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/prestashop-15/new-cms-page-errors-out-prestashop-1609-bug-report?tsrc=rsbraq'>NEW CMS PAGE ERRORS OUT Prestashop  1.6.0.9 BUG REPORT</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/ssl/change-ssl-cert-to-a-different-domain?tsrc=rsbraq'>Change SSL Cert to a different domain</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/server-usage/examples-of-second-ip-uses?tsrc=rsbraq'>Examples of Second IP Uses</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/ssl/ssl-certificate-security-issue?tsrc=rsbraq'>SSL Certificate security issue </a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-11 11:57 pm</div>
				                <div><p>My SSL connection makes a mess of my web page because it expects included files like css files and Wordpress plugins to begin with https, not http. Short of duplicating dozens of files and changing their names so they begin with https I'm not sure what to do.</p>
<p>Try this URL: https://www.artleasecanada.ca and you'll see what I mean</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16118);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-13 7:51 am</div>
				                <div>Hello Stu,<br />
When preparing for SSL, you do not have to change file names, but rather ensure the paths are not absolute. For example, if you call an image called 'dog.jpg', then it should just be called with a relative path. This means in your code, you just have to place the part of the path from where the calling file is. If the image is in a folder named images, and your page is in the primary folder, then you only have to place '<em>images/dog.jpg</em>' as opposed to '<em>http://example.com/images/dog/jpg</em>'. In the latter, you can see it has the absolute path, including the protocol.<br />
<br />
Even so, the files should still work, no matter the protocol used. The consequence of having a full path with non SSL protocol when using SSL is just that the green lock will not appear. It will give a warning that some items are being called via normal protocol.<br />
<br />
This explanation may not be as thorough as the article I wrote on <a href="http://www.inmotionhosting.com/support/website/security/ssl-lock-display">why the lock is not displaying</a>. Check that out if you like as it is a bit clearer.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16145);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-24411'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/12b0fe275181f37f3853f82398bff0a6?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/12b0fe275181f37f3853f82398bff0a6'>Derrick</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-24 2:16 pm</div>
				                <div><p>Simple example to use local paths.</p>
<p>&nbsp;</p>
<p>website.com/css/stylesheet.css</p>
<p>('images/arrow.jpg')</p>
<p>this would point to:&nbsp; website.com/css/images/arrow.jpg</p>
<p>&nbsp;</p>
<p>('/images/arrow.jpg') &lt;-- notice the first forward slash.&nbsp; This defines the root of the website.</p>
<p>this would point to:&nbsp; website.com/images/arrow.jpg</p>
<p>&nbsp;</p>
<p>If you are using a &lt;A HREF&gt;......</p>
<p>&nbsp;</p>
<p>website.com/gallery/index.html</p>
<p>&lt;a href='images/pluto.jpg'&gt;</p>
<p>This would look for the jpg in:&nbsp; website.com/gallery/images/pluto.jpg</p>
<p>&nbsp;</p>
<p>&lt;a href='/images/pluto.jpg'&gt;</p>
<p>This would look for the jpg in:&nbsp; website.com/images/pluto.jpg</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>All your links should use the relative path.&nbsp; You could also use two dots, &lt;a href='../images/pluto.jpg'&gt; to go back one directory, but that can get tricky if you move files around.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24411);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
