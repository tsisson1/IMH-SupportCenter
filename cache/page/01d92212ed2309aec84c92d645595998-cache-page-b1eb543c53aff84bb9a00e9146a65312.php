<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:64012:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/email/exim/find-email-delivery-failures-in-exim" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-03-19T23:25:00-07:00" />
  <meta name="keywords" content="find locate email deliver failure failures error errors" />
  ...
  <link href="http://www.inmotionhosting.com/support/email/exim/find-email-delivery-failures-in-exim" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:76de67a06bad4c921af944781216c690 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-22']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '39.40.67.99']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Find email delivery failures in Exim									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>9,535</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 16, 2013'><span style='color:#606060;'>Published:</span> Mar 19, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In this article we are going to go over how to quickly review the entire mail log for your VPS or dedicated server in order to find delivery failures that are occurring.</p>
<p>Email delivery failures can happen for a large number of reasons, for a more in-depth explanation on these types of issues you can check out my article on <a href="/support/email/email-troubleshooting/email-bounce-bounceback-error">why does email bounce</a>?</p>
<p class="alert">In order to follow the steps below you'll need <a href="/support/website/general-server-setup/root-access-faq">root access</a> to your server.</p>
...
<li>Run the following command to get a sorted report of the users with the highest amounts of delivery failures:
<p class="code_block" style="width: 500px;">grep "for .*@.*" /var/log/exim_mainlog | grep "&lt;= &lt;&gt;" | awk -F"T=" '{print $2}' | awk '{print $NF,$0}' | awk -F" for" '{print $1}' | sort | uniq -c | sort -n</p>
<p><strong>Code breakdown:</strong></p>
<table class="article_table">
<tbody>
<tr><th style="width: 55%; padding: 15px;">grep "for .*@.*" /var/log/exim_mainlog</th>
<td style="padding: 15px;">Locate lines in the Exim mail log that include any variation of "for user@domain.com"</td>
</tr>
<tr><th style="width: 55%; padding: 15px;">grep "&lt;= &lt;&gt;"</th>
<td style="padding: 15px;">Locate lines that are being sent from a null sender, which indicates a bounce back</td>
</tr>
<tr><th style="width: 55%; padding: 15px;">awk -F"T=" '{print $2}'</th>
...
<tr><th style="width: 55%; padding: 15px;">awk '{print $NF,$0}' | awk -F" for" '{print $1}'</th>
...
<p>This will give you back data looking like this:</p>
  <p class="code_block" style="width: 500px;">573 support@example.com "<a href="/support/email/email-troubleshooting/mail-delivery-failed-returning-message-to-sender">Mail delivery failed: returning message to sender</a><br /> 663 user@example.com "Mail delivery failed: returning message to sender<br /> 871 test@example.com "Mail delivery failed: returning message to sender<br /> 1282 help@example.com "Mail delivery failed: returning message to sender</p>
</li>
</ol>
...
<ol class="article_list">
<li>Run the following command to find the latest delivery failure:
<p class="code_block" style="width: 500px;">grep "Mail delivery failed:" /var/log/exim_mainlog | grep help@example.com | tail -1</p>
<p>This should give you back the full line from the Exim mail log that contains that error:</p>
<p class="code_block" style="width: 500px;">2013-01-16 14:45:34 1TvYvW-0006AC-ER &lt;= &lt;&gt; R=1TvYvW-00069r-Au U=mailnull P=local S=2012 T="Mail delivery failed: returning message to sender" for help@example.com</p>
<p>Copy the messaged ID following <strong>R=</strong>, so in this case it would be <strong>1TvYvW-00069r-Au</strong></p>
</li>
<li>Using the message ID you copied, run the following command:<br /><br /> <span class="code_block">exigrep -I -l 1TvYvW-00069r-Au /var/log/exim_mainlog</span>
<p>This will display the full message transaction for the message that bounced:</p>
<p class="code_block" style="width: 500px;">2013-01-16 14:45:34 cwd=/var/spool/exim 3 args: /usr/sbin/exim -Mc 1TvYvW-00069r-Au<br /> 2013-01-16 14:45:34 cwd=/var/spool/exim 7 args: /usr/sbin/exim -t -oem -oi -f &lt;&gt; -E1TvYvW-00069r-Au<br /><br /> 2013-01-16 14:45:34 1TvYvW-00069r-Au &lt;= help@example.com H=localhost (secure103.inmotionhosting.com) [127.0.0.1]:40726 P=esmtpa A=courier_login:help@example.com S=1172 id=f25ddf5d4e8c56e73ab82081c9011a34@atomlabs.net T="Test" for no-reply@example.com<br /> 2013-01-16 14:45:34 1TvYvW-00069r-Au ** no-reply@example.com R=virtual_aliases: No Such User Here"<br /> 2013-01-16 14:45:34 1TvYvW-00069r-Au Completed<br /><br /> 2013-01-16 14:45:34 1TvYvW-0006AC-ER &lt;= &lt;&gt; R=1TvYvW-00069r-Au U=mailnull P=local S=2012 T="Mail delivery failed: returning message to sender" for help@example.com<br /> 2013-01-16 14:45:34 1TvYvW-0006AC-ER =&gt; help &lt;help@example.com&gt; R=virtual_user T=virtual_userdelivery<br /> 2013-01-16 14:45:34 1TvYvW-0006AC-ER Completed</p>
<p>So in this case we can see the reason the message bounced was <strong>** no-reply@example.com R=virtual_aliases: No Such User Here</strong>. Basically, <strong>help@example.com</strong>&nbsp;had tried to send a message to an email address that didn't exist so it bounced.</p>
</li>
<li>You can repeat the sames steps to investigate other bounces that user has been generating. Or an alternative method would be to directly look at the user's mail with the following commands:
<p class="code_block" style="width: 500px;">grep "Mail delivery failed" /home/userna5/mail/example.com/help/{cur,new} -R</p>
<p>This gives back something like:</p>
<p class="code_block" style="width: 500px;">/home/userna5/mail/example.com/help/cur/1358366803.H952383P10133.ecbiz103.inmotionhosting.com,S=2120:2,:Subject: Mail delivery failed: returning message to sender<br /> /home/userna5/mail/example.com/help/cur/1358366759.H640077P7532.ecbiz103.inmotionhosting.com,S=2115:2,:Subject: Mail delivery failed: returning message to sender<br /> /home/userna5/mail/example.com/help/cur/1358365534.H479296P23705.ecbiz103.inmotionhosting.com,S=2107:2,:Subject: Mail delivery failed: returning message to sender<br /> /home/userna5/mail/example.com/help/cur/1358366776.H336048P8578.ecbiz103.inmotionhosting.com,S=2123:2,:Subject: Mail delivery failed: returning message to sender</p>
<p>You can then read one of the bounce backs for further details with this command:</p>
<p class="code_block" style="width: 500px;">less /home/userna5/mail/example.com/help/cur/1358366776.H336048P8578.ecbiz103.inmotionhosting.com,S=2123:2,</p>
<p>When you're done looking at the file, you can hit <strong>q</strong> to quit and get back to the command line.</p>
</li>
</ol>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/email/exim/find-email-delivery-failures-in-exim&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/email/exim/find-email-delivery-failures-in-exim'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NjMmaWQ9ODAxJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="0e5fdf5ffc6937e025714957e9edd4cc" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/roundcube-webmail/i-am-not-able-to-send-mail-in-roundcube?tsrc=rsbraq'>I am not able to send mail in roundcube.</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/e4c897a5361273da931018f2b17c76e0?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/e4c897a5361273da931018f2b17c76e0'>Mr. Byte</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-11 9:29 am</div>
				                <div><p>I've found a douzen messages not sent because of a "No user here" error.</p>
<p>I've fixed it by creating the user; but can I somehow resend the messages?</p>
<p>The messages were generated by a web-page contact form on the same domain, practically I see the errors on the WHM Mail Delivery Status; but I'm not sure how to resend them.</p>
<p>P.S. The messages are 1-2 days old.</p>
<p>Thanks for your time, and help.</p>
<p>Mr. Byte</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10540);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-12 9:12 am</div>
				                <div>Hello Mr. Byte,<br />
<br />
Thank you for your question. If the form was sending the emails from PHP, it is possible there is a copy if the message on the server. If that is the case, you may be able to view them by <a href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-email/logging-into-webmail">logging into Webmail</a> with your <a href="http://www.inmotionhosting.com/support/website/amp/what-is-my-username-and-password#cpanel">cPanel username</a> and password.<br />
<br />
If the contact form was attempting to send from the email account that was not created, then it most likely failed before hitting the server, and there will be no log available.<br />
<br />
If you have any further questions, feel free to post them below.<br />
Thank you,<br />
<br />
-John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10558);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
