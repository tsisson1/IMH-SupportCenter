<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:63442:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/prestashop-16/add-product-images" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-03-04T19:02:05-08:00" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Learn how to add images to your products in PrestaShop 1.6." />
  <title>Adding images for products in PrestaShop 1.6 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/prestashop-16/add-product-images" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:510fd57434e84de411768dae95fe1a22 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Adding images for products in PrestaShop 1.6									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>3,369</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Feb 28, 2014'><span style='color:#606060;'>Published:</span> Mar 4, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>One of the more important selling points for your products is the image. With a proper image, more customers will buy your items. Products without images typically do not sell as well. In this article, we will show how to add images to your products in PrestaShop 1.6</p>
</p>

<h2>How to add product images in PrestaShop 1.6</h2>

<ol class="article_list">
  <li><a href="/support/prestashop-16/admin-login">Log into the PrestaShop 1.6 admin area</a>.<div style="clear:both;"></div></li>
  <li>You are now on the main admin screen. From here, click on <strong>Catalog</strong> and then the <strong>Products</strong> option.<div style="clear:both;"></div></li>
  <li>This is the <em>Products</em> list page.  Look for the product you  want to add images to and click on the <strong>Edit</strong> button on the right side of the product row.<div style="clear:both;"></div></li>
  <li>This leads you to the <em>Information</em> screen for the product, click on the <strong>Images</strong> tab on the left hand menu.<div style="clear:both;"></div></li>

  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/ps16/products/add-images/1-images-tab.png"><img   style="float:right; margin:0px 0px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/ps16/products/add-images/1-images-tab.png" title="Click here to view the larger image" width="200" /></a>The image tab has just a couple of fields.
<div style="clear:both;"></div>
      <table class="article_table">
      <tr>
        <th>Add a new image to this product</th>
        <td>Click on the <strong>Add Files</strong> button to add a file to the list of images to upload from your local computer.</td>
      </tr>

      <tr>
        <th>Legend</th>
        <td>This is the text description of the image.</td>
      </tr>
      </table>
    <div style="clear:both;"></div></li>
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/ps16/products/add-images/2-upload-image.png"><img   style="float:right; margin:0px 0px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/ps16/products/add-images/2-upload-image.png" title="Click here to view the larger image" width="200" /></a>After you add one or more images to the upload list, click on the <strong>Upload Files</strong> button to upload them to your product profile.<div style="clear:both;"></div></li>
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/ps16/products/add-images/3-after.png"><img   style="float:right; margin:0px 0px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/ps16/products/add-images/3-after.png" title="Click here to view the larger image" width="200" /></a>Next, you must also select one of the images to be the main image. This is called the <em>Cover</em>. To do so, click the box in the <strong>Cover</strong> column. If you only have one image, it is automatically selected for you.<div style="clear:both;"></div></li>
  <li>After you have uploaded the image and entered the legend, click on the <strong>Save</strong> or <strong>Save and Stay</strong> buttons on the right hand side. This will activate the changes.<div style="clear:both;"></div></li>
</ol>
<div style="clear:both;"></div>
<br />
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/ps16/products/add-images/after.png"><img   style="float:right; margin:0px 0px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/ps16/products/add-images/after.png" title="Click here to view the larger image" width="200" /></a>Once you have saved the settings you can visit your site and see the new image for your product.</p>
<div style="clear:both;"></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/prestashop-16/add-product-images&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/prestashop-16/add-product-images'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00OTMmaWQ9MzEzMCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="7c4fcc33f3fd0b436caab892e0fa6e8c" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/f3c060d61cc71552b3d1b2322960bba5?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/f3c060d61cc71552b3d1b2322960bba5'>Aditya</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-24 7:00 am</div>
				                <div><p>I am getting image format not recognized error in ps 1.6.0.6. any solution???</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10110);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-24 8:27 am</div>
				                <div>Could you clarify the specific image format that you are attempting to upload?</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10114);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/f3c060d61cc71552b3d1b2322960bba5?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/f3c060d61cc71552b3d1b2322960bba5'>Aditya Patel</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-24 10:32 am</div>
				                <div><p>I tried all the formats i.e. jpg,PNG.......but nothing seems to work....plss help</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10117);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-24 11:31 am</div>
				                <div>It could potentially be caused by the file name.  Try renaming the file to include all lowercase letters without any spaces in the file name.  Be sure that the extension is all lower case as well.<br />
<br />
If you have only tried files that you have stored locally, try downloading another image from somewhere on the internet and uploading that to isolate the issue.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10118);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-12113'></a>
		<div  style='margin:2px 0px 0px 40px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/1923c62e78075ea352e834f8a54632ca?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/1923c62e78075ea352e834f8a54632ca'>M.Rahi</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-28 3:40 pm</div>
				                <div><p>Thank You :)</p>
<p>My problem solved !</p>
<p>I changed file name and file uploaded succesfully ;)</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12113);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-21685'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/ab1ef5db99a952b84108fc4439b6aba8?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/ab1ef5db99a952b84108fc4439b6aba8'>Micheal Paul</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-13 9:34 am</div>
				                <div><p>Hi, I have seen this module here:&nbsp;http://www.fmemodules.com/en/70-product-images-by-customers.html which helps merchants to upload different product images by customers to offer them discount. I liked it :)</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21685);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
