<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:115677:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/ssl/install-third-party-ssl" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-05-13T20:37:43-07:00" />
  <meta name="keywords" content="third party ssl install csr" />
  <meta name="author" content="null" />
  <meta name="description" content="This article will explain the steps needed to request installation of a third party SSL ordered from another vendor." />
  <title>Creating a CSR and Installing a Third Party SSL - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/ssl/install-third-party-ssl" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<script type="text/javascript">
		...
		_gaq.push(['_setCustomVar', 4, 'DateMonthPublished', '2012-04', 3]);
	...
	<!-- cid:46176ba62a92bda08b4e71c6b8c13f8d -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-37']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '73.164.145.46']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Creating a CSR and Installing a Third Party SSL</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Creating a CSR and Installing a Third Party SSL									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>22,801</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Apr 30, 2012'><span style='color:#606060;'>Published:</span> May 13, 2015</div>
  ...
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('request');">Request a CSR</button>
  
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('install');">Third Party SSL</button>
  
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('wildcard');">Wildcard SSL</button>
  <button type="button" class="btn btn-danger" onclick="trackAnchorClickSC('status');">Check Status</button>
  </div>
  
<p>You can purchase a dedicated SSL for your website either through InMotion Hosting or from a third party SSL vendor. This article focuses on the steps to take when ordering an SSL from a third party. If you would like to order an SSL through InMotion Hosting, please see our article on <a href="/support/website/ssl/how-do-i-obtain-an-ssl-certificate">ordering an SSL certificate</a>.</p>
<a name="request"></a>


<h2>Request a CSR for a Third Party SSL</h2>

<p>In order to properly key your website's SSL, your third party vendor will need a CSR (Certificate Signing Request). This CSR needs to be generated for your website by us, and our Support Team will be happy to assist you with the creation of your CSR. To request your CSR, please follow the steps below:</p>
<ol class="article_list">
  <li><a href="/support/website/amp/how-to-log-into-amp">Log into your Account Management Panel (AMP)</a>.<div style="clear:both;"></div></li>
  <li><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/amp/csr-request/1-click-csr-request.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/amp/csr-request/1-click-csr-request.png" title="Click here to view the larger image" width="200" /></a>
    Select the <strong>Simple CSR Request for 3rd party SSL</strong> icon.<div style="clear:both;"></div></li>
  <li>The next page will provide some information, to help you decide if you need a CSR. Click the <strong>Request a CSR</strong> button to continue.</li>
  <li><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/amp/csr-request/3-enter-domain.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/amp/csr-request/3-enter-domain.png" title="Click here to view the larger image" width="200" /></a>Enter the domain name in the field and click <strong>Continue</strong>. You may enter either the www or non-www version (ex: www.example.com or example.com) as our provider will issue an SSL that works for both.<div style="clear:both;"></div></li>
  <li><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/amp/csr-request/4-fill-out-form.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/amp/csr-request/4-fill-out-form.png" title="Click here to view the larger image" width="200" /></a>Here is the form you will need to complete. <em>Certificate Name</em> will be the domain name you entered in the step above.<em>Company Name</em> is required, but can simply be set to 'Unknown' for personally owned sites. <em>Company Division</em> can be left blank as it is not required. Once you have completed the form, click the <strong>Next</strong> button.<div style="clear:both;"></div></li>
</ol>

<a name="install"></a><h2>Installation of your Third Party SSL</h2>
<p>Once your CSR request is submitted, our Support Team will respond via email with your CSR. The email should be the one referenced by the SSL and not necessarily with the primary email address on the hosting account. You will then provide the CSR to your SSL vendor so they can properly key your SSL. When you receive the SSL from your vendor, please respond to our email and attach your SSL. Our Support Team will then install your third party SSL.</p>
<p class="alert">SSL certificates require a dedicated IP address at a cost of $2.00 per month, billed yearly for $24.00. With all SSL certificates (ordered through us or through a third party vendor) there is a one-time $25 installation fee.</p>

<a name="wildcard"></a><h2>Wildcard SSL Installations</h2>

<p>You can have <a href="/support/edu/cpanel/cpanel-manage-domains/wildcard-subdomains-and-dns" target="_blank">Wildcard SSL certificates</a> installed on <a href="http://www.inmotionhosting.com/vps-hosting" target="_blank">VPS</a> or <a href="http://www.inmotionhosting.com/dedicated-servers" target="_blank">Dedicated servers</a>. We do not sell Wildcard SSL certificates, so you will need to contact a 3rd party SSL provider to obtain one. Also, Wildcard SSL certificates cannot be installed on <a href="http://www.inmotionhosting.com/business-hosting" target="_blank">shared hosting plans</a>.</p>

<p class="alert"><strong>Important!</strong> In order to install a Wilcard certificates on VPS and Dedicated server, that each site needs to be on a<a href="/support/edu/whm/creating-and-managing-accounts/how-to-create-a-cpanel-account" target="_blank"> separate cpanel account</a> in order for us to install the certificate on your server.</p>
<p>To have a Wildcard SSL installed, you will need a CSR generated for each domain on your server that will use the Wildcard SSL. You then take the CSR and key the Wildcard certificate for each domain. You then email the CRT to <a href="/support/component/content/help/how-to-get-great-technical-support?Itemid=204" target="_blank">support</a> for installation. We install the same certificate to each cPanel account you created for each domain that will use the SSL.</p>

<a name="status"></a><h2>How do I check on the status of my CSR request?</h2>
<p class="alert" style="color:red">There is no need to check on the <strong>status</strong> of a <em>CSR</em>, since you will be emailed to the email address referenced by the SSL immediately, when it is generated.</p>
<p><strong>Here is some additional information:</strong> When you request a CSR, it creates a <em>ticket</em> for <strong>Tech Support</strong>. They answer these tickets in the order they are received, and you will get an email as soon as your CSR is generated.</p>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/ssl/install-third-party-ssl&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/ssl/install-third-party-ssl'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD03NiZpZD00MTkmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="7b597190a48403053e8494f8c25586ee" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/opencart/insecure-form-call-error-in-indexhtml-file?tsrc=rsbraq'>Insecure &lt;form&gt; call error in index.html file</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/d86d08c28c184c596c2aadfcf2c061bb?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/d86d08c28c184c596c2aadfcf2c061bb'>Erin Christey</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-29 11:26 am</div>
				                <div><p>The article is helpful, but I noticed two things that would be VERY helpful to know while doing this process.</p>
<p>1.) Under "Installation of your Third Party SSL" and "How do I check on the status" &nbsp;you should include the fact that you email the CSR to the email address associated with the SSL certificate, NOT the email address on file with the InMotion Hosting account. This will inform your customers of what to expect.</p>
<p>My experience - I requested a CSR yesterday via my account at inmotionhosting.com at 9:28 AM CDT and assumed that it would take a few hours to work through the queue. I still had not&nbsp;received the emailed CSR info at 9:58 AM CDT today, so I called tech support. My email account is on file with InMotion Hosting since I am handling this migration for our company. I am really frustrated that I waited all day yesterday for the CSR to arrive, only to find out today that&nbsp;it WAS emailed yesterday at 10:48 AM to my boss's email address (it's associated with the SSL certificate). If I had known to expect the CSR to arrive at her account, I would have communicated with her to forward it to me. She went on vacation yesterday afternoon and I do not have access to her email. I have since received the CSR from a helpful tech agent (Sean B), but this information about where it was emailed would have been incredibly helpful yesterday.</p>
<p>2.) Clarify these instructions: "<span style="font-size: 11px;">When you receive the SSL from your vendor, please respond to our email and attach your SSL." You should tell the customer&nbsp;to&nbsp;email support@inmotionhosting.com with the subject "SSL install" instead of responding to "our email" - tech agent Sean B advised me of this. Also, you should tell the customer to include their verification code to verify the account (either last 4 of credit card on file or the AMP password). If they don't include that phrase in their support email, the response&nbsp;will be delayed. Lastly, the customer should include that they authorize the charges for the install and the dedicated IP address to be charged to the credit card on file - again, so as not to delay the process.</span></p>
<p><span style="font-size: 11px;">I appreciate the assistance I've received from tech support, but I do feel that if these pieces of information had been available in your support articles, I would not have needed to call them so many times during this process.</span></p>
<p>&nbsp;</p>
<p><span style="font-size: 11px;">Thank you!</span></p>
<p><span style="font-size: 11px;">Erin</span></p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14484);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
...
Scott M</div>
		...
		<a name='comment-15085'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='https://lh6.googleusercontent.com/-UTwVm9uqDtI/AAAAAAAAAAI/AAAAAAAAAJg/F3b6NwXwrsY/photo.jpg?sz=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='/support/community-support/users/ronnietrainham'>ronnietrainham</a></div>
						<div><a href='https://facebook.com/rtwebsites' target='_blank'><img src='//www.inmotionhosting.com/img/icon-facebook.png' style='width:20px;' /></a><a href='https://plus.google.com/102980218222747983598/' target='_blank'><img src='//www.inmotionhosting.com/img/icon-google.png' style='width:20px;' /></a></div>
						<div></div>
						<div>6 <a href='/support/team/points' target='_blank'>Points</a></div>
						
					</td>
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-16 12:35 am</div>
				                <div>I completely, 100% agree with everything Erin suggested in her response.. Not bashing the customer service  from anyone at all, because mainly it seems like a process/software issue. I've had the exact same thing has happened to me multiple times during my switch over to IMH. Following all the instructions I submit requests for migrations, Simple CSR requests, Dedicated IP's, etc. around 9-10AM in the morning, only to wake up the following day with emails saying in order to continue with your order, please verify your account.  <br />
...
<br />
						...
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15085);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-15376'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/ea62df97a032d96e77a3a5d43c2f85ae?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/ea62df97a032d96e77a3a5d43c2f85ae'>Tracey McCartney</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-22 11:32 pm</div>
				                <div><p>Here's another suggested clarification. &nbsp;When you request a CSR and are asked to fill in the information about the domain you are seeking to secure, you are cautioned that the info you fill in will be validated against the WHOIS information for the domain. &nbsp;My domain is registered at Hover, and apparently there's some sort of domain privacy on it, so my registrar's contact information was gathered from the WHOIS and pre-filled in the form. &nbsp;Having just been warned that whatever I entered would be checked against the WHOIS, I left it that way. &nbsp;That was Friday the 19th.</p>
<p>Today, the 22nd, I wrote to check on my CSR request and was told it had been cancelled because the information I put in the form didn't check out. &nbsp;So I submitted a new request, this time ignoring the pre-filled info from the WHOIS and putting our actual info in there.</p>
<p>I have NO idea when they cancelled my CSR request, but I know they didn't bother to tell me until I asked about the status. &nbsp;This is a time-sensitive web site move for me, and I could have saved a couple of days if I'd known about the problem.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15376);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-23 9:41 am</div>
				                <div>Hello Tracey,<br />
<br />
Sorry to hear about the trouble you experienced. We are actually in the process of re-wording the section regarding "<em>the info you fill in will be validated against the WHOIS information for the domain</em>."<br />
<br />
The main thing for the CSR is that it is generated with valid information (or business information) for the person requesting it. Since private Whois registration usually uses the registrar's contact info, it would not be valid for you or your business.<br />
<br />
Sorry you were not notified about the original CSR cancellation. The email notification should have been automatically generated by the system, and sent. It is also possible it got stopped by a spam filter/rule (you may have to check your spam box) or there was an email issue at the time.<br />
<br />
I see when it was requested with accurate Whois information, your CSR was generated and sent within 4 minutes. You should be able to proceed with your SSL installation at this time.<br />
<br />
If you have any further questions, feel free to post them below.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15405);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-17353'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/1968900aa8b099edec2933fd4602e56e?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/1968900aa8b099edec2933fd4602e56e'>M Leung</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-12 6:55 pm</div>
				                <div><p>What about SSL renewal?&nbsp; Is there a fee associate with it?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17353);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-12 7:24 pm</div>
				                <div>Hello M. Leung,<br />
<br />
Thanks for the question.  SSL certificates are finite meaning that they have an expiration date.  Therefore, there is a renewal process.  There is a few associated with the renewal.  This cost my vary depending on where and what you purchased for your SSL certificate.  For example, if you purchased the <a href="http://www.inmotionhosting.com/support/website/ssl/how-do-i-obtain-an-ssl-certificate">SSL Certificate</a> from InMotion, then it is typically $99.99 per year.  <br />
<br />
I hope that helps to answer your question.  Please let us know if you have any further questions or comments.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17355);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-20960'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/758eae1e077ef594baddaf3b4e40c839?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/758eae1e077ef594baddaf3b4e40c839'>Randy T</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-23 3:24 am</div>
				                <div><p>Is there a fee to renew a 3rd party SSL Cert? I am new to Inmotion my current SSL Cert from comodo bought through my previous host Bluehost I will have to renew. I paid the $25 to have this one installed. When I renew (new cert) will I have to then AGAIN pay this $25!?&nbsp;</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20960);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-23 10:26 am</div>
				                <div>Hello Randy,<br />
<br />
Thank you for your question. There is a 1-time installation fee of $25 when we install the SSL. This will only be charged once.<br />
<br />
There is also a $2/month charge for the dedicated IP address, which comes to $24/year. This will be charged yearly.<br />
<br />
If you have any further questions, fee free to post them below.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20965);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-23061'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/49c4f567f61e539c589753c0674f474f?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/49c4f567f61e539c589753c0674f474f'>K Andrews</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-30 3:00 am</div>
				                <div><p>Re wildcard SSL certificates, you say:</p>
<p class="alert"><strong>Important!</strong> In order to install a Wilcard certificates on VPS and Dedicated server, that each site needs to be on a<a href="/support/../../edu/whm/creating-and-managing-accounts/how-to-create-a-cpanel-account" target="_blank"> separate cpanel account</a> in order for us to install the certificate on your server.</p>

<p>A common use-case for subdomains would be a WordPress multisite installation, with a <strong>single</strong> parent WordPress install on the main domain domain.com, and a lot of subsites set up within it on a.domain.com, b.domain.com, c.domain.com.</p>
<p>Obviously, this is a case where you can't possibly put all the different subdomains in different CPanel installations, because they're running from within the same single Wordpress installation.</p>
<p>My question is - is it possible to use a wildcard certificate in this situation to secure both the installation itself and the subsites within it?&nbsp; So https://domain.com,&nbsp; https://a.domain.com, https://b.domain.com etc can all use the same wildcard certificate and will work properly?</p>
<p>Thanks.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23061);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-30 10:58 am</div>
				                <div>Hello K,<br />
<br />
Thank you for contacting us. Yes, you can setup a <a href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-manage-domains/wildcard-subdomains-and-dns">WildCard Subdomain</a> in cpanel, but you will have to purchase the WilCard SSL from a 3rd party, since we do not provide this.<br />
<br />
This is a good option if your sites are pretty minimal (Landing page, or online Business card), or you are <em>very</em> familiar with WordPress Multisites. This is because multisite problems tend to be more difficult to troubleshoot and resolve, than a standard WordPress installation.<br />
<br />
Otherwise, it may be easier to purchase a <a href="http://www.inmotionhosting.com/reseller-hosting">Reseller</a> account, and <a href="http://www.inmotionhosting.com/support/edu/whm/creating-and-managing-accounts/how-to-create-a-cpanel-account">create separate cPanels</a> for each WordPress website.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23071);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-30 12:45 pm</div>
				                <div><p>Hi John-Paul,</p>
<p>So, let's say I already have a *working* WordPress Multisite installation set up on my VPS, with all its subsites working properly on subdomains of the same parent domain.&nbsp; (Which is actually the case.)</p>
<p>In this situation, if I order a wildcard certificate for the parent domain, can I expect that InMotion will be able to install it on the relevant CPanel account, and that my *working* WordPress Multisite installation and all its *working* sub-sites will be able to use it?</p>
<p>&nbsp;</p>
<p>Cheers.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23075);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-30 5:58 pm</div>
				                <div>Hello K,<br />
<br />
Thank you for your question. Yes, InMotion Hosting can install a wildcard SSL, and your subdomains will be able to use it.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23085);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-28496'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/6c84f7b724a1ecf44ca3c7347eb1eac0?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/6c84f7b724a1ecf44ca3c7347eb1eac0'>Dilshod</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-17 11:55 am</div>
				                <div><p>Hi, i would like to ask something if you dont mind please. How long will it take to be installed 3d party SSL, cos im awaiting second day already.</p>
<p>Thank you</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28496);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-17 12:01 pm</div>
				                <div>Hello Dilshod,<br />
<br />
Generally it happens quickly however sometimes the request do get backed up. I would suggest <a href="http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support">contacting our support department</a> to have them provide you with an updated status of your installation.<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28497);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-29672'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/3cf5901be86bf2a0612186eb467b060f?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/3cf5901be86bf2a0612186eb467b060f'>Janus</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-08 8:09 pm</div>
				                <div><p>thanks for the warning&nbsp;<a style="color: #3f89c2; outline: 0px; outline-offset: -2px; font-family: adelle-sans, Helvetica, Arial, sans-serif; line-height: 22px; font-size: 16px; background-color: #f9f9f9;" href="http://www.gravatar.com/d86d08c28c184c596c2aadfcf2c061bb">Erin Christey</a>&nbsp;i thought it was because it was sent to the private-dns email :)</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29672);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/3cf5901be86bf2a0612186eb467b060f?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/3cf5901be86bf2a0612186eb467b060f'>Janus rokkj&aelig;r</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-10 5:46 am</div>
				                <div><p>Actually it is much faster to generate the CSR from within the WHM of your hosting account then you get it almost instantly.&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29686);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						...
						<div><a style='font-size:16px;' href='/support/community-support/users/inform70'>inform70</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-07 4:41 pm</div>
				                <div>I tried to generate the CSR through AMP for a wildcard domain but *.mydomainname.com in the domain name field won't be accepted. How can I get this done?</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31036);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-07 4:52 pm</div>
				                <div>While we can do multi-domain SSLs, we cannot create a CSR for an 'all-inclusive' or * subdomain.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31037);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-07 5:02 pm</div>
				                <div>In that case, what should I do about the CSR, should I just give the parent domain &quot;mydomainname.com&quot;, or any of the subdomains? I'm getting the SSL through a 3rd party who will be able to provide me wildcard SSL.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31038);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-31117'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/98f84f0c04f9b2016bfec070c04889fc?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/98f84f0c04f9b2016bfec070c04889fc'>Jason</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-10 9:06 am</div>
				                <div><p>I got a certificate from StartCom and generated the CSR from cPanel under the SSL/TLS Manager. &nbsp;Everything worked and I was able to upload the certificate but when I try to go to the https of my site I get an SSL Connection Error ERR_SSL_PROTOCOL_ERROR. &nbsp;Am I missing a step?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31117);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-10 4:31 pm</div>
				                <div>Hello Jason,<br />
<br />
Thank you for contacting us. Depending on how you built your site, you typically must enable SSL (https) in the backend, or configuration settings.<br />
<br />
For example, in WordPress you must <a href="http://www.inmotionhosting.com/support/website/wordpress/enable-https">update your site URL from http to https</a> in the settings.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31133);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
