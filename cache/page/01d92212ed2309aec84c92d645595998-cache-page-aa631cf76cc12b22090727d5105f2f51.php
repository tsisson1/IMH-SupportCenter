...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/wordpress/recommended-wordpress-plugins" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="keywords" content="wordpress recommended plugin" />
  <meta name="description" content="This class covers the more popular and useful plugins for use with your Wordpress site." />
  <title>201: Recommended WordPress Plugins | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/wordpress/recommended-wordpress-plugins" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:dc1b33593af42d35d6eb70b541ee7280 -->
...
<div class='item-page'>
        ...
        <div class='page-header'>
                <h1>201: Recommended WordPress Plugins</h1>
        </div>

<p>A great strength of WordPress is the ability to add on a ton of additional features by way of the awesome plugin system. In this section we'll go over some of the top recommended plugins for handling certain tasks.</p>

<div class="in_this_tutorial">
  <h2>Navigation:</h2>
  <button type="button" class="btn btn-primary" onclick="window.location.hash='cache';">Cache</button>
  <button type="button" class="btn btn-primary" onclick="window.location.hash='customize';">Customize</button>
  <button type="button" class="btn btn-primary" onclick="window.location.hash='security';">Security</button>
  <button type="button" class="btn btn-primary" onclick="window.location.hash='seo';">SEO</button>
  <button type="button" class="btn btn-primary" onclick="window.location.hash='photos';">Photos</button>
  <button type="button" class="btn btn-primary" onclick="window.location.hash='social';">Social Media</button>
  <button type="button" class="btn btn-primary" onclick="window.location.hash='advertising';">Advertising</button>
  <button type="button" class="btn btn-primary" onclick="window.location.hash='ecommerce';" style="margin-top: 5px; margin-left: 90px;">eCommerce</button>
</div>

<!-- //NOTE WordPress cache plugins -->
<a name="cache"></a>
<div class="white_box">
<h2 style="margin-top:0px;padding-top:0px;">WordPress cache plugins</h2>
<div style="margin: 5px 15px 5px 10px">
<p>Using a <a href="http://www.inmotionhosting.com/support/website/wordpress/use-wordpress-cache-to-speed-up-your-site" target="_blank">WordPress cache plugin</a> can help speed up your site for visitors, while at the same time reducing your CPU usage. If you're on shared hosting you should defintely consider running a WordPress caching plugin to help prevent any sudden usage spikes.</p>

<ul>
<li><a href="http://www.inmotionhosting.com/support/edu/wordpress/recommended-wordpress-plugins/optimizing-wordpress-with-w3-total-cache" target="_blank">W3 Total Cache</a><p>WordPress is a dynamic CMS that can waste a lot of resources needlessly, in this article we discuss installing and configuring the W3 Total Cache caching plugin to help reduce the performance impact of running a WordPress site.</p></li>
<li><a href="http://www.inmotionhosting.com/support/edu/wordpress/recommended-wordpress-plugins/optimizing-wordpress-with-wp-super-cache" target="_blank">WP Super Cache</a><p>Using WP Super Cache can help optimize your WordPress website.</p></li>
<li><a href="http://www.inmotionhosting.com/support/edu/wordpress/recommended-wordpress-plugins/simple-wordpress-caching-with-wp-fastest-cache" target="_blank">WP Fastest Cache</a><p>Using the WordPress WP Fastest Cache plugin is one of the easiest ways to add caching and speed up your WordPress website.</p></li>
<li><a href="http://www.inmotionhosting.com/support/edu/wordpress/recommended-wordpress-plugins/cache-mobile-pages-wordpress-super-cache-wptouch-plugin" target="_blank">Cache mobile pages with WP Super Cache and WP Touch plugin</a><p>Learn how to enable mobile support in WP Super Cache in WordPress.</p></li>
<li><a href="http://www.inmotionhosting.com/support/edu/wordpress/recommended-wordpress-plugins/clearing-cache-in-wordpress" target="_blank">Clearing cache in WordPress</a><p>If you do not see your website changes in WordPress you may have caching on This article explains how to empty your cache in WordPress.</p></li>
</ul>
</div>
</div>
<br>
...
<!-- //NOTE WordPress security plugins -->
<a name="security"></a>
<div class="white_box">
<h2 style="margin-top:0px;padding-top:0px;">WordPress security plugins</h2>
<div style="margin: 5px 15px 5px 10px">
<p>The security of your WordPress installation can be greatly increased by using security plugins that make it harder for would be attackers to get into your site.</p>

<ul>
<li><a href="http://www.inmotionhosting.com/support/website/wordpress/using-the-limit-login-attempts-wordpress-plugin" target="_blank">Limit login attempts</a><p>This is a plugin that will limit the number of failed login attempts allowed, and will temporarily ban the IP address from trying anymore login attempts.</p></li>
<li><a href="http://www.inmotionhosting.com/support/edu/wordpress/317-wp-recaptcha-for-wordpress" target="_blank">WP-reCAPTCHA</a><p>This is a plugin that will use an advanced CAPTCHA system to help deter automated spam bots from being able to leave spam comments on your posts.</p></li>

<li><a href="http://www.inmotionhosting.com/support/website/wordpress/secure-wordpress-with-wordpress-captcha-plugin" target="_blank">Captcha</a><p>This is a CAPTCHA plugin that operates by asking simple math questions to prove a human is filling out a form instead of a spam bot.</p></li>

<li><a href="http://www.inmotionhosting.com/support/website/wordpress-plugins/wordpress-comment-spam-prevention-with-akismet" target="_blank">Akismet</a><p>Akismet is a powerful plugin that is bundled with all WordPress installations and is extremely effective in stopping spam comments on your WordPress site.</p></li>
</ul>
</div>
</div>
<br>
...
<!-- //NOTE WordPress SEO plugins -->
<a name="seo"></a>
<div class="white_box">
<h2 style="margin-top:0px;padding-top:0px;">WordPress SEO plugins</h2>
<div style="margin: 5px 15px 5px 10px">
<ul>
<li><a href="http://www.inmotionhosting.com/support/website/wordpress-plugins/generating-xml-sitemaps" target="_blank">Google XML Sitemaps</a><p>Generating XML sitemaps can be a lot of work, but with the Google XML Sitemaps plugin for WordPress, sitemaps can be created automatically and with ease.</p></li>
</ul>
</div>
</div>
<br>
...
<!-- //NOTE WordPress photos and slide show plugins -->
<a name="photos"></a>
<div class="white_box">
<h2 style="margin-top:0px;padding-top:0px;">WordPress photos and slide show plugins</h2>
<div style="margin: 5px 15px 5px 10px">
<ul>
<li><a href="http://www.inmotionhosting.com/support/edu/wordpress/recommended-wordpress-plugins/photo-gallery-and-slide-show-plugins-for-wordpress" target="_blank">Photo Gallery and Slide Show Plugins for WordPress</a><p>Photo galleries and slide shows are great ways to display images to your website's visitors. WordPress has many different options for handling images that can add this functionality to your.</p></li>
</ul>
</div>
</div>
<br>
...
<!-- //NOTE WordPress social media plugins -->
<a name="social"></a>
<div class="white_box">
<h2 style="margin-top:0px;padding-top:0px;">WordPress social media plugins</h2>
<div style="margin: 5px 15px 5px 10px">
<ul>
  <li><a href="http://www.inmotionhosting.com/support/edu/wordpress/recommended-wordpress-plugins/plugins-for-facebook-and-twitter" target="_blank">WordPress plugins for Facebook and Twitter</a><p>Social media can be an important aspect in <a href="http://firstsiteguide.com/promote-content/">promoting your content</a>.</p></li>
</ul>
</div>
</div>
<br>
...
<!-- //NOTE WordPress advertising plugins -->
<a name="advertising"></a>
<div class="white_box">
<h2 style="margin-top:0px;padding-top:0px;">WordPress advertising plugins</h2>
<div style="margin: 5px 15px 5px 10px">
<ul>
<li><a href="http://www.inmotionhosting.com/support/edu/wordpress/recommended-wordpress-plugins/plugins-for-advertising" target="_blank">WordPress plugins for advertising</a><p>There are available plugin that allow you to run advertisements on your website. Typically, you would need to edit the actual HTML code to perform this however these plugins can save you time and effort if you wish to have advertising on your website.</p></li>
</ul>
</div>
</div>
<br>
...
<!-- //NOTE WordPress eCommerce plugins -->
<a name="ecommerce"></a>
<div class="white_box">
<h2 style="margin-top:0px;padding-top:0px;">WordPress eCommerce plugins</h2>
<div style="margin: 5px 15px 5px 10px">
<ul>
<li><a href="http://www.inmotionhosting.com/support/edu/wordpress/recommended-wordpress-plugins/install-ecommerce-for-wordpress-plugin" target="_blank">eCommerce for WordPress</a><p>You can set up a simple eCommerce shopping cart in WordPress using the ecommerce for WordPress. This article will show you how.</p></li>
</ul>
  </div></div>
  <br>
<!-- //NOTE WordPress Theme Customization Plugins -->
<a name="customize"></a>
<div class="white_box">
<h2 style="margin-top:0px;padding-top:0px;">WordPress Customization plugins</h2>
<div style="margin: 5px 15px 5px 10px">
<ul>
<li><a href="http://www.inmotionhosting.com/support/edu/wordpress/recommended-wordpress-plugins/easy-google-fonts-plugin" target="_blank">Easy Google Fonts Plugin</a><p>Use this plugin to quickly add fonts from the free Google Fonts library to your WordPress site.</p></li>
</ul>
</div>  
...
<form action="http://www.inmotionhosting.com/support/edu/wordpress/recommended-wordpress-plugins" method="post" name="adminForm" id="adminForm" class="form-inline">
  ...
  <table class='article_list'>
          ...
          <tr>
                  ...
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/edu/wordpress/recommended-wordpress-plugins/cache-mobile-pages-wordpress-super-cache-wptouch-plugin'>Cache Mobile pages with the WordPress Super Cache and WPTouch Plugin </a></td>
                                <td>4,754</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/edu/wordpress/recommended-wordpress-plugins/plugins-for-facebook-and-twitter'>WordPress Plugins for Facebook and Twitter</a></td>
                                <td>4,159</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/edu/wordpress/recommended-wordpress-plugins/plugins-for-advertising'>Plugins for Advertising</a></td>
                                <td>3,844</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/edu/wordpress/recommended-wordpress-plugins/install-ecommerce-for-wordpress-plugin'>Installing the eCommerce for WordPress plugin</a></td>
                                <td>2,718</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/edu/wordpress/recommended-wordpress-plugins/easy-google-fonts-plugin'>How to use the Easy Google Fonts Plugin for WordPres</a></td>
                                <td>398</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/edu/wordpress/recommended-wordpress-plugins/wp-converting-tags-categories-tool'>Using the Convert Categories to Tags Tool in WordPress</a></td>
                                <td>221</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/edu/wordpress/recommended-wordpress-plugins/jetpack-whats-new'>Jetpack 3.4 What's New</a></td>
                                <td>161</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/edu/wordpress/recommended-wordpress-plugins/add-social-media-widgets'>How to Add the Social Media Widgets Plugin to WordPress</a></td>
                                <td>63</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/edu/wordpress/recommended-wordpress-plugins/using-lightbox-gallery'>How to Install and Use the Lightbox Gallery Plugin in WordPress</a></td>
                                <td>11</td>
                        </tr>
                  </table>
	</form>
