<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:61519:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/dokuwiki/writing-content-dokuwiki/delete-rename-namespaces-doku" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-01-10T19:08:29-08:00" />
  <meta name="keywords" content="rename delete move namespace page doku wiki dokuwiki" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="You can delete or rename namespaces in DokuWiki to update the site structure. This article will teach you how to rename and delete namespaces." />
  <title>How to delete and rename namespaces in DokuWiki - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/dokuwiki/writing-content-dokuwiki/delete-rename-namespaces-doku" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:6351aa69c019f663087229c2bea8ac8d -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to delete and rename namespaces in DokuWiki									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>7,290</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 10, 2013'><span style='color:#606060;'>Published:</span> Jan 10, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>DokuWiki sites are constantly changing due to the contributions of the website patrons. When topics get too big, change in scope, or become obsolete, it becomes necessary to rename or delete the namespaces from DokuWiki. This article will go through the steps in renaming and deleting namespaces form DokuWiki.</p>
<h2>Renaming a namespace in DokuWiki</h2>
<ol class="article_list">
<li><a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel" title="Click here for info" target="_blank"><strong>Login into your cPanel</strong></a>.</li>
<li><a href="/support/edu/cpanel/cpanel-file-manager/using-file-manager-in-cpanel" title="Click here for info" target="_blank"><strong>Go to the File Manager</strong></a>, select your DokuWiki install directory and click Go.</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/rename-delete-namespace/rename-delete-namespace-1-navigate.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Navigate to the Sitemap DokuWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/rename-delete-namespace/rename-delete-namespace-1-navigate.gif" title="Click here to view the larger image" width="100" /></a><strong>Navigate to the following </strong>location in your DokuWiki site.
<p style="margin-left: 20px;">/data/pages</p>
<p><strong>Find the folder for the namespace</strong> you want to rename similar to the snapshot to the right.</p>
<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/rename-delete-namespace/rename-delete-namespace-2-rename.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Rename the folder for the namespace DokuWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/rename-delete-namespace/rename-delete-namespace-2-rename.gif" title="Click here to view the larger image" width="100" /></a><strong>Select the folder and click rename </strong>in the File manager at the top.
<p><strong>Name the folder to a different name</strong> and hit enter. (In this case we renamed the folder to "<em>new_namespace</em>")</p>
<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/rename-delete-namespace/rename-delete-namespace-3-visit-sitemap.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Visit the site map with renamed namespace DokuWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/rename-delete-namespace/rename-delete-namespace-3-visit-sitemap.gif" title="Click here to view the larger image" width="100" /></a><strong>Click your sitemap link</strong> at the top right of your DokuWiki site. Now you will see the namespace renamed in your sitemap.<br style="clear: both;" /></li>
</ol>
<h2>Deleting namespaces in DokuWiki</h2>
<ol class="article_list">
<li><span class="style1"><a target="_blank" href="/support/edu/dokuwiki/geting-started-dokuwiki/login-dokuwiki" title="Click for more information">Log into DokuWiki</a>.</span></li>
<li><strong>Click sitemap </strong>at the top right.
<p><strong>Find the namespace you want to remove.</strong> (In this case the "<em>html5</em>" namespace is being removed.)</p>
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/rename-delete-namespace/rename-delete-namespace-4-visit-sitemap.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Visit the sitemap of yoru DokuWIki" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/rename-delete-namespace/rename-delete-namespace-4-visit-sitemap.gif" title="Click here to view the larger image" width="100" /></a><strong>Select the page</strong> in the namespace. (In this case "<em>html_5_video</em>s".) <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/rename-delete-namespace/rename-delete-namespace-5-edit-page.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Click edit this page DokuWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/rename-delete-namespace/rename-delete-namespace-5-edit-page.gif" title="Click here to view the larger image" width="100" /></a><strong>Click the pencil</strong> to the right that says "<em>Edit this page</em>". <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/rename-delete-namespace/rename-delete-namespace-6-delete-content.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Remove content from page to delete DokuWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/rename-delete-namespace/rename-delete-namespace-6-delete-content.gif" title="Click here to view the larger image" width="100" /></a><strong>Delete all the text from the page.</strong>
<p><strong>Click Save</strong>.</p>
<br style="clear: both;" />
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/rename-delete-namespace/rename-delete-namespace-6-preview-sitemap.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Sitemap with namespace deleted DokuWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/rename-delete-namespace/rename-delete-namespace-6-preview-sitemap.gif" title="Click here to view the larger image" width="100" /></a><strong>Now visit the sitemap link</strong> at the top right. The namespace will be gone from the sitemap.</p>
<p class="alert"><strong>Note!</strong> For the namespace to disappear completely, if there are multiple pages in one namespace, each page in the namespace will need to have its content deleted. Once all pages have no content in the namespace, the namespace will no longer appear in the sitemap.<br style="clear: both;" /></p>
</li>
</ol>
<p>Now that you are familiar with renaming and deleting namespaces, you can see our next article on how to redirect old pages that were removed from your DokuWiki site.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 4: How to delete and rename namespaces in DokuWiki</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 3: <a href='/support/edu/dokuwiki/writing-content-dokuwiki/edit-delete-restore-pages'>How to edit and delete DokuWiki pages</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 5: <a href='/support/edu/dokuwiki/writing-content-dokuwiki/redirect-page-doku'>Redirecting pages in DokuWiki</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/dokuwiki/writing-content-dokuwiki/delete-rename-namespaces-doku&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/dokuwiki/writing-content-dokuwiki/delete-rename-namespaces-doku'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMTkmaWQ9MjE2MyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
