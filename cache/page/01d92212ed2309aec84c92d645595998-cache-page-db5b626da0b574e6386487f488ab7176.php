<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:64083:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/prestashop-15/prices-and-taxes/disable-tax-rule" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-09-12T15:15:38-07:00" />
  <meta name="keywords" content="disable tax rule PrestaShop 1.5" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="This article will explain how to disable a tax rule in PrestaShop 1.5" />
  <title>How to disable a tax rule in PrestaShop 1.5  - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/prestashop-15/prices-and-taxes/disable-tax-rule" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:5d964269ecd4b43f1879bb430feb022a -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to disable a tax rule in PrestaShop 1.5 									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>1,743</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Sep 12, 2012'><span style='color:#606060;'>Published:</span> Sep 12, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>After learning how to <a href="/support/edu/prestashop-15/prices-and-taxes/new-tax-rule">add</a> and <a href="/support/edu/prestashop-15/prices-and-taxes/edit-tax-rule">edit</a> a tax rule, this article you guide you on how to disable one. This is useful when you have the tax rule data and do not want to allow it to be used at the present time. This way, you can remove a tax rule from the active list but retain all the data in case you want to re-activate it in the future. The instructions below will guide you on disabling a tax rule in your PrestaShop 1.5 store.</p>
<p><strong>Preventing a tax rule from displaying in PrestaShop 1.5</strong></p>
...
<li>Using the top menu bar, hover over the <strong>Localizations</strong> tab and click on the <strong>Tax Rules</strong> option.</li>
<li>This brings you to the <em>Tax Rules</em> list screen. From here, locate the rule you want to disable and select the checkbox to the left side of that row. You may select more than one tax if you wish, in case you are disabling multiple tax rules. Once selected, click the <strong>Disable Selection</strong> button that is located underneath the rule list.<br /><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/prestashop1.5/Localization/Tax_Rules/Disable/disable-rule.png"><img  alt="disable-rule" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/prestashop1.5/Localization/Tax_Rules/Disable/disable-rule.png" /></a> </li>
<li>Once disabled, the list will refresh and you will see a red X in the <em>Enabled</em> column for the tax rules you were working with.     <br /><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/prestashop1.5/Localization/Tax_Rules/Disable/disable-after.png"><img  alt="disable-after" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/prestashop1.5/Localization/Tax_Rules/Disable/disable-after.png" /></a></li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 14: How to disable a tax rule in PrestaShop 1.5 </div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 15: <a href='/support/edu/prestashop-15/prices-and-taxes/remove-tax-rule'>How to delete a tax rule in PrestaShop 1.5 </a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/prestashop-15/prices-and-taxes/disable-tax-rule&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/prestashop-15/prices-and-taxes/disable-tax-rule'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yMzQmaWQ9MTc3MSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="7fecb4b5208fae2cc9b93fed165bb528" value="1" />	</div>
	</form>
<!-- <br />
