<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:53817:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/news/general/rc4-chrome-issue" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-01-22T18:49:37-08:00" />
  <meta name="author" content="TJ Edens" />
  <meta name="description" content="InMotion Hosting Support Center" />
  <title>SSL Cipher error with version 48 of Chrome - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/news/general/rc4-chrome-issue" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:dd046b4ad8b034a3cf73f707d292b0f1 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '213.249.249.82']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															SSL Cipher error with version 48 of Chrome									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>3,984</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 22, 2016'><span style='color:#606060;'>Published:</span> Jan 22, 2016</div>
  ...
  <pre>A secure connection cannot be established because this site uses an unsupported protocol or cipher suite. This is likely to be caused when the server needs RC4, which is no longer considered secure.</pre><br />
This can be resolved by editing your Apache configuration settings within your WHM (this action does require <a href="http://www.inmotionhosting.com/support/website/cpanel-account-management/obtain-root-access">root access</a> to your VPS or Dedicated server).
</p>

<h2>How to Fix</h2>

<ol class="article_list">
  <li><a href="http://www.inmotionhosting.com/support/edu/whm/creating-and-managing-accounts/log-into-whm">Log into WHM</a> with your <strong>root user</strong>.<div style="clear:both;"></div></li>
  <li>Type <strong>Apache Configuration</strong> in the search box then select it.<div style="clear:both;"></div></li>
  <li>Click on <strong>Global Configuration</strong>.<div style="clear:both;"></div></li>
	<li>The first section will be <strong>SSL Cipher Suite</strong>.<div style="clear:both;"></div></li>
	<li>Select the third option (the one with the editable input field).<div style="clear:both;"></div></li>
	<li>Copy and paste the code below into the field then click <strong>Save</strong>.<div style="clear:both;"></div></li>
  	<li>The screen will now show the current settings, just click the button that says <strong>Rebuild Configuration and Restart Apache</strong>.<div style="clear:both;"></div></li>
  <li>You can use <a href="https://www.ssllabs.com/ssltest/">SSLLabs.com</a> to test your website to make sure the cipher suite updated accordingly.<div style="clear:both;"></div></li>
</ol>

<br />
<pre>ECDHE-RSA-AES256-GCM-SHA384:ECDHE-RSA-AES128-GCM-SHA256:DHE-RSA-AES256-GCM-SHA384:DHE-RSA-AES128-GCM-SHA256:ECDHE-RSA-AES256-SHA384:ECDHE-RSA-AES128-SHA256:ECDHE-RSA-AES256-SHA:ECDHE-RSA-AES128-SHA:DHE-RSA-AES256-SHA256:DHE-RSA-AES128-SHA256:DHE-RSA-AES256-SHA:DHE-RSA-AES128-SHA:ECDHE-RSA-DES-CBC3-SHA:EDH-RSA-DES-CBC3-SHA:AES256-GCM-SHA384:AES128-GCM-SHA256:AES256-SHA256:AES128-SHA256:AES256-SHA:AES128-SHA:DES-CBC3-SHA:HIGH:!aNULL:!eNULL:!EXPORT:!CAMELLIA:!DES:!MD5:!PSK:!RC4
</pre>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/news/general/rc4-chrome-issue&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/news/general/rc4-chrome-issue'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD01MCZpZD0zNzI3JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="e10c45ee2ed4135f1288024d0f4af27b" value="1" />	</div>
	</form>
<!-- <br />
