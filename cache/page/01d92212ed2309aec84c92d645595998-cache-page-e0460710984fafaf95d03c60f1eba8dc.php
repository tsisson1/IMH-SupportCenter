<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:54211:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/magento/302-magento-regular-ssl-protocol" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-11-05T20:55:44-08:00" />
  <meta name="keywords" content="Magento protocol regular secure set up" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="This Magento article demonstrates how to get your installation to work with both regular and secure protocols." />
  <title>302: How to get Magento to use both regular and secure connections - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/magento/302-magento-regular-ssl-protocol" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:fa94cee787bc439a2dc993c0aa7158fc -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															302: How to get Magento to use both regular and secure connections									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>5,555</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Nov 5, 2012'><span style='color:#606060;'>Published:</span> Nov 5, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Many site owners want customers to be able to access their Magento catalog via normal http protocol, but switch over to https (secure) protocol for checkouts. This helps secure the data and prevent snooping or insecure data collection that can result in identity theft or other malicious activities.</p>
<p>To enable Magento to function with both protocols, it must be set up in a particular way. The instructions below demonstrate how to set up your Magento installation so that it can use both regular and secure protocols.</p>
<p class="alert">This article assumes you have purchased and SSL for your site. Please see our articles on <a href="/support/website/ssl/how-do-i-obtain-an-ssl-certificate">SSL information</a> if you need one.</p>
<div><strong>Getting Magento to allow both regular and secure connections</strong></div>
<ol class="article_list">
<li>Install Magento using the regular standard http protocol. This example demonstrates an installation being done with the Softaculous software installer. Note that we selected the http protocol from the <strong>Choose Protocol</strong> dropdown list.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/magento/with-and-wthout-ssl/http-magento-install.png"><img  alt="http-magento-install" src="//cdn.inmotionhosting.com/support/images/stories/edu/magento/with-and-wthout-ssl/http-magento-install.png" /></a></li>
<li>After your Magento installation is complete, log into your Magento Admin panel. Our magento test site is located at <em>magento.inmotiontesting.com</em> so the admin login is located at <em>magento.inmotiontesting.com/admin</em>.</li>
<li>From the admin dashboard, using the top menu bar, hover over the <strong>System</strong> option and click on <strong>Configuration</strong> from the pop-up menu.</li>
<li>This brings you to the configuration section. Using the left hand sidebar and click on the <strong>Web</strong> option found in the General section. This will display the <strong>Web</strong> options in the right-hand panel.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/magento/with-and-wthout-ssl/general-web.png"><img  alt="general-web" src="//cdn.inmotionhosting.com/support/images/stories/edu/magento/with-and-wthout-ssl/general-web.png" /></a></li>
<li>Click on the Secure label so the options will expand. From there, find the field entitled <strong>Use Secure URLs in Frontend</strong> and select the <strong>Yes</strong> option from the dropdown.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/magento/with-and-wthout-ssl/secure-url-frontend.png"><img  alt="secure-url-frontend" src="//cdn.inmotionhosting.com/support/images/stories/edu/magento/with-and-wthout-ssl/secure-url-frontend.png" /></a></li>
<li>Once the option is set, click the <strong>Save Config</strong> button found in the upper right corner of the scree to save the changes. This enables your SSL security certificate to perform when a customer checks out.</li>
</ol> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/magento/302-magento-regular-ssl-protocol&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/magento/302-magento-regular-ssl-protocol'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD05MiZpZD0yNDEzJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="6bf0ee32de463ccf95e126ab62fc805a" value="1" />	</div>
	</form>
<!-- <br />
