<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:60004:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/php-fusion/changing-appearance-php-fusion/modify-the-copyright-footer-in-php-fusion" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-03-21T22:15:10-07:00" />
  <meta name="keywords" content="modify copyright footer php-fusion php fusion" />
  <meta name="author" content="Jacob Nicholson" />
  <meta name="description" content="As PHP-Fusion is free open-source software release under the AGPL (Affero General Public License), it displays a copyright notice in the footer of every page by default. This can be modified to a certain extent, and in this article I'll explain the process." />
  <title>Modify the copyright footer in PHP-Fusion - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/php-fusion/changing-appearance-php-fusion/modify-the-copyright-footer-in-php-fusion" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:2e20cf0e7ab61a01dd2acb4418f3a9b7 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-22']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '69.30.197.170']);
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/php-fusion' itemprop='url'><span itemprop='title'>PHP-Fusion<span></a><div class='dropdown_2columns'><h2>PHP-Fusion Education Channel</h2><div class='col_2'><h3>100 Level Classes</h3><div><a href='/support/edu/php-fusion/getting-started-php-fusion'>101: Getting started with PHP-Fusion</a></div><div><a href='/support/edu/php-fusion/adding-content-to-php-fusion'>102: Adding content to your PHP-Fusion website</a></div><div><a href='/support/edu/php-fusion/working-with-menus-php-fusion'>103: Working with menus in PHP-Fusion</a></div><div><a href='/support/edu/php-fusion/changing-appearance-php-fusion'>104: Changing the PHP-Fusion Appearance</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/php-fusion/changing-appearance-php-fusion' itemprop='url'><span itemprop='title'>104: Changing the PHP-Fusion Appearance<span></a><div class='dropdown_3columns'><h2> Changing the PHP-Fusion Appearance</h2><div class='col_3'><div>1. <a style='display:inline;' href='/support/edu/php-fusion/changing-appearance-php-fusion/modifying-the-footer-in-php-fusion'>Modifying the Footer in PHP-Fusion</a></div><div>2. <a style='display:inline;' href='/support/edu/php-fusion/changing-appearance-php-fusion/main-site-settings-php-fusion-overview'>PHP-Fusion Main Site Settings Overview</a></div><div>3. <a style='display:inline;' href='/support/edu/php-fusion/changing-appearance-php-fusion/editing-site-introduction'>Editing the site introduction in PHP-Fusion</a></div><div>4. <a style='display:inline;' href='/support/edu/php-fusion/changing-appearance-php-fusion/modifying-the-sub-footer-in-php-fusion'>Modify the sub-footer in PHP-Fusion</a></div><div>5. <a style='display:inline;' href='/support/edu/php-fusion/changing-appearance-php-fusion/change-banner-logo'>Changing the banner/logo in PHP-Fusion</a></div><div>6. <a style='display:inline;' href='/support/edu/php-fusion/changing-appearance-php-fusion/modify-the-copyright-footer-in-php-fusion'>Modify the copyright footer in PHP-Fusion</a></div><div>7. <a style='display:inline;' href='/support/edu/php-fusion/changing-appearance-php-fusion/switching-your-php-fusion-theme'>Switching your PHP-Fusion theme</a></div><div>8. <a style='display:inline;' href='/support/edu/php-fusion/changing-appearance-php-fusion/installing-free-theme-php-fusion'>How to install a free theme to your PHP-Fusion site</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Modify the copyright foo...</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Modify the copyright footer in PHP-Fusion									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>10,157</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Mar 21, 2013'><span style='color:#606060;'>Published:</span> Mar 21, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>As PHP-Fusion is free open-source software release under the AGPL (Affero General Public License), it displays a copyright notice in the footer of every page by default. This can be modified to a certain extent, and in this article I'll explain the process.</p>

<h2>Footers in PHP-Fusion</h2>

<p>Below you can see the 3 different type of footers that are available in PHP-Fusion, this article is going to cover the copyright one at the absolute bottom of your pages. If you'd like, you can also read about <a href="/support/education-channels-content/modifying-the-footer-in-php-fusion">modifying the footer in PHP-Fusion</a> if you're interested in changing the main footer, or <a href="/support/edu/php-fusion/changing-appearance-php-fusion/modifying-the-sub-footer-in-php-fusion">modify the sub-footer in PHP-Fusion</a>.</p>

<center><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/php-fusion/footer/php-fusion-different-footer-options.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/edu/php-fusion/footer/php-fusion-different-footer-options.png" alt="php-fusion different footer options" /></a></center>

<h2>Changing the copyright footer</h2>

<p>The copyright notice content is controlled by the <strong>/includes/theme_functions_include.php</strong> file, in my case the full path to this file is <strong>/home/userna5/public_html/phpfusion/includes/theme_functions_include.php</strong>. Using the steps below I'll show you how you can modify what this footer displays.</p>

<ol class="article_list">
  
  <li>If you don't already know how to, read our guide on <a href="/support/website/how-to/how-to-edit-a-file" target="_blank">how do I edit a file on my server?</a></li>
  
  <li>Once you have the file opened, around line <strong>203</strong> you'd want to look for the following code:
  
    <p class="code_block" style="width: 500px;">
      function showcopyright($class = "", $nobreak = false) {<br />
        $link_class = $class ? " class='$class' " : "";<br />
    ...
    <p>Now technically when making modifications to the PHP-Fusion copyright notice, you'd want to adhere to the guidelines laid out under the <a href="http://www.php-fusion.co.uk/viewpage.php?page_id=6" target="_blank" rel="nofollow">PHP-Fusion Free Licensing</a>.</p>
    
    <p>In this case the text <strong>"Powered by PHP-Fusion"</strong> is optional, so I'm going to be removing that for this example. I ended up with this text:</p>
    
    <p class="code_block" style="width: 500px;">
      function showcopyright($class = "", $nobreak = false) {<br />
        $link_class = $class ? " class='$class' " : "";<br />
      <strong style="color:red;">$res = "Copyright &copy; &lt;a href='http://www.php-fusion.co.uk'".$link_class."&gt;PHP-Fusion&lt;/a&gt; 2002 - ".date("Y")." by Nick Jones.";</strong><br />
        $res .= ($nobreak ? "&nbsp;" : "&lt;br /&gt;\n");<br />
        $res .= "Released as free software without warranties under &lt;a href='http://www.fsf.org/licensing/licenses/agpl-3.0.html'".$link_class."&gt;GNU Affero GPL&lt;/a&gt; v3.\n";<br />
        return $res;
}
    ...
    <p>Here is the copyright footer before our edits:</p>
    
    <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/php-fusion/footer/copyright-footer-before-edit.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/edu/php-fusion/footer/copyright-footer-before-edit.png" alt="copyright footer before edit" /></a>
    <p>&nbsp;</p>
    <p>Here it is after:</p>
    
    <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/php-fusion/footer/copyright-footer-after-edit.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/edu/php-fusion/footer/copyright-footer-after-edit.png" alt="copyright footer after edit" /></a>
    
  </li>
  
</ol>

<p>You should now understand how to modify your copyright footer in PHP-Fusion.</p>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/php-fusion/changing-appearance-php-fusion'>104: Changing the PHP-Fusion Appearance</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 6: Modify the copyright footer in PHP-Fusion</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 5: <a href='/support/edu/php-fusion/changing-appearance-php-fusion/change-banner-logo'>Changing the banner/logo in PHP-Fusion</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 7: <a href='/support/edu/php-fusion/changing-appearance-php-fusion/switching-your-php-fusion-theme'>Switching your PHP-Fusion theme</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/php-fusion/changing-appearance-php-fusion/modify-the-copyright-footer-in-php-fusion&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/php-fusion/changing-appearance-php-fusion/modify-the-copyright-footer-in-php-fusion'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zNjAmaWQ9MjUwOSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="cbdfd32a02efcb2d7618083545c7ab62" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/php-fusion/changing-appearance-php-fusion?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Changing the PHP-Fusion Appearance</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/php-fusion/changing-appearance-php-fusion/modifying-the-footer-in-php-fusion?tsrc=rsbedu'>Modifying the Footer in PHP-Fusion</a></td>
                </tr>
        <tr><td colspan='2'><h4>Main site settings and appearance options</h4></td></tr>  <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/php-fusion/changing-appearance-php-fusion/main-site-settings-php-fusion-overview?tsrc=rsbedu'>PHP-Fusion Main Site Settings Overview</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/php-fusion/changing-appearance-php-fusion/editing-site-introduction?tsrc=rsbedu'>Editing the site introduction in PHP-Fusion</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/php-fusion/changing-appearance-php-fusion/modifying-the-sub-footer-in-php-fusion?tsrc=rsbedu'>Modify the sub-footer in PHP-Fusion</a></td>
                </tr>
          <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/php-fusion/changing-appearance-php-fusion/change-banner-logo?tsrc=rsbedu'>Changing the banner/logo in PHP-Fusion</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/php-fusion/changing-appearance-php-fusion/modify-the-copyright-footer-in-php-fusion?tsrc=rsbedu'>Modify the copyright footer in PHP-Fusion</a></td>
                </tr>
        <tr><td colspan='2'><h4>Changing PHP-Fusion themes</h4></td></tr>  <tr >
                        <td valign='top'>7.</td>
                        <td><a href='/support/edu/php-fusion/changing-appearance-php-fusion/switching-your-php-fusion-theme?tsrc=rsbedu'>Switching your PHP-Fusion theme</a></td>
                </tr>
          <tr >
                        <td valign='top'>8.</td>
                        <td><a href='/support/edu/php-fusion/changing-appearance-php-fusion/installing-free-theme-php-fusion?tsrc=rsbedu'>How to install a free theme to your PHP-Fusion site</a></td>
                </tr>
          	</table>
