<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:51030:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/wordpress/syntax-error-when-i-increase-memory-limit-in-defaultconstantsphp" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Tin, Sorry for the problem with the syntax error that you're seeing in your WordPress site. Your best course of action is go back and revert your ..." />
  <title>syntax error when I increase memory limit in default-constants.php | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/wordpress/syntax-error-when-i-increase-memory-limit-in-defaultconstantsphp" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:b8a48441bb3e164fd1df122ee6397c77 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>syntax error when I increase memory limit in default-constants.php</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/tinmaunghtay'>tinmaunghtay</a>
			<div>8 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-10-07 11:47 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>81</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Hi, <br />
I tried to modify home/zeekwe5/public_html/wp-includes/default-constants.php as I wanted to increase memory limit. But I am having my below error and my site is unaccessible. Please help ! I have tried replacing the file with fresh default_constants.php , but it did not work.<br />
<br />
Parse error: syntax error, unexpected '');' (T_CONSTANT_ENCAPSED_STRING) in /home/zeekwe5/public_html/wp-includes/default-constants.php on line 27<br />
<br />
Thanks, <br />
Tin</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_8267' id='upvote_answer_8267' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='8267' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_8267').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_8267' id='downvote_answer_8267' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='8267' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_8267').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Tin,<br />
<br />
Sorry for the problem with the syntax error that you're seeing in your WordPress site.  Your best course of action is go back and revert your default-constants.php file so that it is the same as prior to your change.  If necessary, you can download a fresh copy of WordPress and obtain the default file.  If you need to increase memory limits, check out this article:  <a href="http://www.inmotionhosting.com/support/website/php-troubleshooting/allowed-memory-size-exausted">Fixing the Allowed memory size exhausted error</a>.<br />
<br />
...
Arnel C.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_8267').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_8267' id='form_comment_on_answer_8267' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/wordpress/syntax-error-when-i-increase-memory-limit-in-defaultconstantsphp&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/wordpress/syntax-error-when-i-increase-memory-limit-in-defaultconstantsphp'></div>
<script type='text/javascript'>
  (function() {
