<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49139:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/prestashop-15/attributes-and-features" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="In this PrestaShop 1.5 class, we'll teach you how to setup and manage product attributes and features." />
  <title>104: PrestaShop 1.5 Product Attributes and Features | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/prestashop-15/attributes-and-features" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:fffb94e2f31e50d6188c0d7913663663 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '201.163.213.189']);
...
<div class='page-header'>
	<h1>104: PrestaShop 1.5 Product Attributes and Features</h1>
</div>
<div class='section_listing'>
		<table>
	<tr><td colspan='3'><h2>Product Attributes</h2><div>Product attributes can be thought of as product options, such as size and color.</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 1:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/attributes-and-features/add-attribute'>How to add an Attribute in PrestaShop 1.5</a>
					<div>In this PrestaShop 1.5 tutorial you will learn how to add attributes to the main attributes list.</div>
					<div class='smallgrey'>Hits: 7,792</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/attributes-and-features/add-attribute-values'>How to add Attribute Values in PrestaShop 1.5</a>
					<div>This PrestaShop 1.5 tutorial guides you on how to add values to product attributes.</div>
					<div class='smallgrey'>Hits: 6,103</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/attributes-and-features/remove-attribute'>How to remove an Attribute in PrestaShop 1.5</a>
					<div>This PrestaShop 1.5 article will show you how to remove Attributes from the Attribute list.</div>
					<div class='smallgrey'>Hits: 2,386</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/attributes-and-features/add-attributes-to-product'>How to add attributes to your products in PrestaShop 1.5 </a>
					<div>This tutorial walks you through attaching attributes to your products by adding adding 'Combinations' in PrestaShop 1.5</div>
					<div class='smallgrey'>Hits: 28,035</div>
				</td>
			</tr>
		<tr><td colspan='3' style='padding-top:20px;'><h2>Product Features</h2><div>Product features help to describe a product, such as the product's height and weight.</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 5:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/attributes-and-features/add-feature'>How to add a Feature in PrestaShop 1.5</a>
					<div>This PrestaShop 1.5 tutorial will demonstrate how to add a new Feature to the Features list.</div>
					<div class='smallgrey'>Hits: 3,184</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/attributes-and-features/add-feature-value'>How to add a Feature Value in PrestaShop 1.5</a>
					<div>This PrestaShop 1.5 tutorial demonstrates how to add values to a feature. </div>
					<div class='smallgrey'>Hits: 2,888</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/attributes-and-features/remove-feature'>How to remove a Feature in PrestaShop 1.5</a>
					<div>This PrestaShop 1.5 tutorial demonstrates how to remove a feature from the main features list.</div>
					<div class='smallgrey'>Hits: 2,055</div>
				</td>
			</tr>
			</table>
</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNTQmaWQ9MjU0JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="d5cdcce3c7f8cb05211bbb85ecb1ed89" value="1" />	</div>
	</form>
<!-- <br />
