<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:65133:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/moodle/activity-resource/build-lesson" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-10-19T12:51:17-07:00" />
  <meta name="keywords" content="moodle add question content lesson module import powerpoint cluster page" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="This article will focus on building the Lesson for functionality in Moodle. The focus of this article is to explain the different options available for the Lessons. " />
  <title>Building a Lesson in Moodle - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/moodle/activity-resource/build-lesson" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:a80e7b1ea33b446457a48bfc00e33fea -->
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/moodle' itemprop='url'><span itemprop='title'>Moodle<span></a><div class='dropdown_4columns'><h2>Moodle Education Channel</h2><div class='col_2'><h3>100 Level Classes</h3><div><a href='/support/edu/moodle/new-to-moodle'>101: Getting Started with Moodle</a></div><div><a href='/support/edu/moodle/creating-courses'>102: Creating Courses in Moodle</a></div><div><a href='/support/edu/moodle/activity-resource'>103: Adding an activity or resource to a course in Moodle</a></div><div><a href='/support/edu/moodle/create-restore-backup'>104: Creating and restoring backups in Moodle</a></div><div><a href='/support/edu/moodle/question-bank'>104: Working with the Question Bank</a></div><div><a href='/support/edu/moodle/user-roles-moodle'>105: User Accounts and Permissions in Moodle</a></div><div><a href='/support/edu/moodle/moodle-grading-reports'>106: Moodle Grading and Reports</a></div><div><a href='/support/edu/moodle/changing-appearance-moodle'>107: Changing the Appearance of Moodle</a></div><div><a href='/support/edu/moodle/moodle-plugins'>108: Managing Moodle Plugins</a></div><div><a href='/support/edu/moodle/additional-moodle-features'>109: Additional Moodle features</a></div></div><div class='col_2'><h3>200 Level Classes</h3><div><a href='/support/edu/moodle/moodle-site-security'>201: Moodle site security and server settings</a></div><div><a href='/support/edu/moodle/custom-moodle-reports'>202: Making Custom Moodle Reports</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/moodle/activity-resource' itemprop='url'><span itemprop='title'>103: Adding an activity or resource to a course in Moodle<span></a><div class='dropdown_3columns'><h2> Adding an activity or resource to a course in Moodle</h2><div class='col_3'><div>1. <a style='display:inline;' href='/support/edu/moodle/activity-resource/activity-resource-overview'>Moodle Activity or Resource Overview</a></div><div>2. <a style='display:inline;' href='/support/edu/moodle/activity-resource/adding-assignment'>How do I add an  Assignment to a Course in Moodle</a></div><div>3. <a style='display:inline;' href='/support/edu/moodle/activity-resource/add-lesson-module'>Adding the Lesson module to a course in Moodle</a></div><div>4. <a style='display:inline;' href='/support/edu/moodle/activity-resource/build-lesson'>Building a Lesson in Moodle</a></div><div>5. <a style='display:inline;' href='/support/edu/moodle/activity-resource/add-content-page-lesson'>Adding a content page in the Moodle Lesson module</a></div><div>6. <a style='display:inline;' href='/support/edu/moodle/activity-resource/add-question-page'>Adding questions to the Lesson module in Moodle</a></div><div>7. <a style='display:inline;' href='/support/edu/moodle/activity-resource/create-glossary'>Creating a Glossary for a Moodle Course Section</a></div><div>8. <a style='display:inline;' href='/support/edu/moodle/activity-resource/quiz-module'>How to add the Quiz Module in Moodle</a></div><div>9. <a style='display:inline;' href='/support/edu/moodle/activity-resource/adding-questions-quiz'>Adding questions to a quiz using the Question bank</a></div><div>10. <a style='display:inline;' href='/support/edu/moodle/activity-resource/view-quiz-statistics-report'>Viewing the Quiz Statistics Report in Moodle</a></div><div>11. <a style='display:inline;' href='/support/edu/moodle/activity-resource/forum-module'>Creating a discussion with the Moodle Forum module</a></div><div>12. <a style='display:inline;' href='/support/edu/moodle/activity-resource/file-resource-module'>Adding the File Resource Module to Moodle Courses</a></div><div>13. <a style='display:inline;' href='/support/edu/moodle/activity-resource/label-module'>Labeling Activities and Resources with the label Module in Moodle</a></div><div>14. <a style='display:inline;' href='/support/edu/moodle/activity-resource/page-module'>Making pages for courses with the page module in Moodle</a></div><div>15. <a style='display:inline;' href='/support/edu/moodle/activity-resource/external-url-module'>Placing an External URL using the Moodle URL module</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Building a...</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Building a Lesson in Moodle									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>1,646</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Oct 18, 2012'><span style='color:#606060;'>Published:</span> Oct 19, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>The last article outlined <a target="_blank" href="/support/edu/moodle/activity-resource/add-lesson-module" title="Click here to view the previous article">how to add a lesson to a course in Moodle 2.3</a>. This article will focus on building the Lesson for functionality. The focus of this article is to explain the different options available for the Lessons. Some of these articles will not be explained further; however, the <strong>Add a content page</strong> and <strong>Add a question page</strong> will be discussed in detail in other articles.</p>
...
<h3>Options to build the Lessons</h3>
...
<li>Select the course on the left in the <strong>Navigation</strong>. Click the <strong>Add an activity or resource </strong>link, for the course section, to access the module list.</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/103/build-lesson/build-lesson-1-edit-tab.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="build-lesson-1-edit-tab" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/103/build-lesson/build-lesson-1-edit-tab.gif" title="Click here to view the larger image" /></a>Next there should be a page that defaults to the <strong>Edit</strong> tab and shows <strong>What would you like to do first?</strong>. This is where the different functions can be added to the Lesson. The options are <strong>Import questions</strong>, <strong>Import PowerPoint</strong>, <strong>Add a cluster</strong>, <strong>Add a content page</strong>, and <strong>Add a question page</strong>. Below is a description of Each section. <br style="clear: both;" /></li>
<h3>Import questions</h3>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/103/build-lesson/build-lesson-2-import-questions.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="build-lesson-2-import-questions" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/103/build-lesson/build-lesson-2-import-questions.gif" title="Click here to view the larger image" /></a>In the Import Questions section, an existing file can be Imported into the lesson. The type of file that is imported into this section comes from previous file formats like Blackboard, Learnwise, or Moodle XML format. In most cases, the Import questions will not be used as it requires a file format form another educational software; therefore, this option will only be discussed in this overview.<br style="clear: both;" /></p>
<h3>Import PowerPoint</h3>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/103/build-lesson/build-lesson-3-import-powerpoint.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="build-lesson-3-import-powerpoint" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/103/build-lesson/build-lesson-3-import-powerpoint.gif" title="Click here to view the larger image" /></a> This option allows the administrator to upload a Power Point presentation to the Lesson. Attempts to get the PowerPoint file to work in this section yielded no useful results, so this section will not be discussed beyond this article. The non-functionality of this feature is know by the Moodle developers. No update is available whether it will be fixed or not.<br style="clear: both;" /></p>
<h3>Add a cluster</h3>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/103/build-lesson/build-lesson-4-add-cluster.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="build-lesson-4-add-cluster" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/103/build-lesson/build-lesson-4-add-cluster.gif" title="Click here to view the larger image" /></a> This option allows the administrator to include a random group of questions through the Lesson. The clusters are an advanced option within the Lesson build. <br style="clear: both;" /></p>
<h3>Add a content page</h3>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/103/build-lesson/build-lesson-5-content-page.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="build-lesson-5-content-page" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/103/build-lesson/build-lesson-5-content-page.gif" title="Click here to view the larger image" /></a> The content page is the part of the lesson that allows the administrator to set up basic information and goals of the lesson. While there are no specific questions, quizzes, or other types of functionality in this feature, it is good for setting up the Information needed for the user to understand the scope of the Lesson. Basic Title, Text and navigation to different pages for the Lesson can be created here. This is a necessary portion of the Lesson module and will be discussed in detail in a separate article.<br style="clear: both;" /></p>
<h3>Add a question page</h3>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/103/build-lesson/build-lesson-6-question-page.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="build-lesson-6-question-page" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/103/build-lesson/build-lesson-6-question-page.gif" title="Click here to view the larger image" /></a>Like the content page, the Add a question page will allow the user to answer certain questions that pertain to the Lesson. This is different from the Quiz module in that the questions appear as a part of Lesson content. This will be discussed in more detail in a separate article.<br style="clear: both;" /></p>
</ol>
<p>This concludes the overview on Building a Lesson in Moodle. Please check the next article on <a target="_blank" href="/support/edu/moodle/activity-resource/add-content-page-lesson" title="Click here to view the next article">Adding a content page in the Moodle Lesson module</a>. For more information on this Education Channel please visit <a target="_blank" href="/support/edu/moodle/activity-resource" title="Click here to view the courses">Adding an activity or resource to a course</a>.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/moodle/activity-resource'>103: Adding an activity or resource to a course in Moodle</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 4: Building a Lesson in Moodle</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 3: <a href='/support/edu/moodle/activity-resource/add-lesson-module'>Adding the Lesson module to a course in Moodle</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 5: <a href='/support/edu/moodle/activity-resource/add-content-page-lesson'>Adding a content page in the Moodle Lesson module</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/moodle/activity-resource/build-lesson&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/moodle/activity-resource/build-lesson'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yODEmaWQ9MTg5MiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="75e030b9acecaff925bbf0746186fa79" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/moodle/activity-resource?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Adding an activity or resource to a course in Moodle</h3></a>
		<table><tr><td colspan='2'><h4>Overview</h4></td></tr>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/moodle/activity-resource/activity-resource-overview?tsrc=rsbedu'>Moodle Activity or Resource Overview</a></td>
                </tr>
        <tr><td colspan='2'><h4>Activities</h4></td></tr>  <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/moodle/activity-resource/adding-assignment?tsrc=rsbedu'>How do I add an  Assignment to a Course in Moodle</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/moodle/activity-resource/add-lesson-module?tsrc=rsbedu'>Adding the Lesson module to a course in Moodle</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/moodle/activity-resource/build-lesson?tsrc=rsbedu'>Building a Lesson in Moodle</a></td>
                </tr>
          <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/moodle/activity-resource/add-content-page-lesson?tsrc=rsbedu'>Adding a content page in the Moodle Lesson module</a></td>
                </tr>
          <tr >
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/moodle/activity-resource/add-question-page?tsrc=rsbedu'>Adding questions to the Lesson module in Moodle</a></td>
                </tr>
          <tr >
                        <td valign='top'>7.</td>
                        <td><a href='/support/edu/moodle/activity-resource/create-glossary?tsrc=rsbedu'>Creating a Glossary for a Moodle Course Section</a></td>
                </tr>
          <tr >
                        <td valign='top'>8.</td>
                        <td><a href='/support/edu/moodle/activity-resource/quiz-module?tsrc=rsbedu'>How to add the Quiz Module in Moodle</a></td>
                </tr>
          <tr >
                        <td valign='top'>9.</td>
                        <td><a href='/support/edu/moodle/activity-resource/adding-questions-quiz?tsrc=rsbedu'>Adding questions to a quiz using the Question bank</a></td>
                </tr>
          <tr >
                        <td valign='top'>10.</td>
                        <td><a href='/support/edu/moodle/activity-resource/view-quiz-statistics-report?tsrc=rsbedu'>Viewing the Quiz Statistics Report in Moodle</a></td>
                </tr>
          <tr >
                        <td valign='top'>11.</td>
                        <td><a href='/support/edu/moodle/activity-resource/forum-module?tsrc=rsbedu'>Creating a discussion with the Moodle Forum module</a></td>
                </tr>
        <tr><td colspan='2'><h4>Resources</h4></td></tr>  <tr >
                        <td valign='top'>12.</td>
                        <td><a href='/support/edu/moodle/activity-resource/file-resource-module?tsrc=rsbedu'>Adding the File Resource Module to Moodle Courses</a></td>
                </tr>
          <tr >
                        <td valign='top'>13.</td>
                        <td><a href='/support/edu/moodle/activity-resource/label-module?tsrc=rsbedu'>Labeling Activities and Resources with the label Module in Moodle</a></td>
                </tr>
          <tr >
                        <td valign='top'>14.</td>
                        <td><a href='/support/edu/moodle/activity-resource/page-module?tsrc=rsbedu'>Making pages for courses with the page module in Moodle</a></td>
                </tr>
          <tr >
                        <td valign='top'>15.</td>
                        <td><a href='/support/edu/moodle/activity-resource/external-url-module?tsrc=rsbedu'>Placing an External URL using the Moodle URL module</a></td>
                </tr>
          	</table>
