<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:53560:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/joomla-3/error-in-joomla-page-site" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, Sorry for the problems with PostgreSQL with your Joomla installation. Unfortunately, there are reported issues with PostgreSQL, so based on the i..." />
  <title>error in joomla page site | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/joomla-3/error-in-joomla-page-site" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:d05caf1c145ff3ac695f2e8a6469bf4a -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>error in joomla page site</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2014-12-03 8:15 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>36</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>i make joomla site with postgresql database but when load site page display this error:<br />
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_6059' id='upvote_answer_6059' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='6059' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_6059').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_6059' id='downvote_answer_6059' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='6059' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_6059').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
Sorry for the problems with PostgreSQL with your Joomla installation.  Unfortunately, there are reported issues with PostgreSQL, so based on the information you have provided it could many things.  If you were having problems after installing a language, then you may want to check out this <a href="http://joomlacode.org/gf/project/joomla/tracker/%3Faction=TrackerItemEdit&tracker_item_id=17430/?action=TrackerItemEdit&tracker_item_id=33675&start=8775" rel="nofollow" target="_blank">post</a> and see if they don't have a solution for you.  Or, you may want seek assistance from the Joomla community on this issue as there multiple possibilities that cause the failed database query issue that you're seeing.  Please try reviewing the <a href="http://forum.joomla.org/viewtopic.php?f=706&t=838120" rel="nofollow" target="_blank">Joomla Forum posts on PostgreSQL issues</a> for more information.<br />
<br />
We would also recommend using Joomla with  MySQL by using the default installations (in <a href="http://www.inmotionhosting.com/support/edu/cpanel/softaculous">Softaculous</a> if you are in InMotion customer).   Apologies again for the problems with PostgreSQL in Joomla.  We do support the database use on our servers, but for use with Joomla, it's more stable to use Joomla with MySQL.<br />
<br />
Regards,<br />
Arnel C.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_6059').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_6059' id='form_comment_on_answer_6059' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/joomla-3/error-in-joomla-page-site&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/joomla-3/error-in-joomla-page-site'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="16dd19a7a5983d801ca3ea3a9fc6c933" value="1" />	</div>
	</form>
<!-- <br />
