<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:61019:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/joomla-25/virtuemart-search-engine-friendly-urls" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-02-21T20:17:39-08:00" />
  <meta name="keywords" content="joomla 2.5 virtuemart search engine friendly urls" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="Beginning with VirtueMart 2, Search Engine Friendly (SEF) URLs is a feature now built in! 3rd party plugins and extensions for VirtueMart are no longer needed to setup Search Engine Friendly URLs." />
  <title>VirtueMart SEF URLs - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/joomla-25/virtuemart-search-engine-friendly-urls" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:d62ed308cfd4f5f994d77208d98ec053 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '113.170.136.218']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>VirtueMart SEF URLs</span></li>			</ul>
		</div>
	</div>
</div>
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>4,433</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: May 10, 2012'><span style='color:#606060;'>Published:</span> Feb 21, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>VirtueMart search engine friendly urls use to be a popular topic / request for VirtueMart store administrators. If you're not running VirtueMart 2 (released in early 2012), obtaining VirtueMart SEF URLs required the use of third party extensions and VirtueMart plugins. As of VirtueMart 2, search engine friendly URLs is a feature including by default!</p>

<p>In our testing, we have a <a href="/support/website/joomla-25/add-new-virtuemart-category">product category</a> named <em>Operating Systems</em>, and a <strong>product</strong> called <em>Working at the Ubuntu Command-Line Prompt</em> (a book). When we browse our store and find the product, the URL is:</p>

<p>http://domain.com/index.php/<strong>operating-systems</strong>/<strong>working-at-the-ubuntu-command-line-prompt</strong>-detail</p>

<p>As you can see, there are no numbers or variables in the URL (such as id=5). Instead, the product category and the product title cleanly show! If you're looking for SEF in VirtueMart, look no further. VirtueMart 2 now includes search engine friendly URLs out of the box!</p> 
...
<div style='display:inline-block;'>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD04OSZpZD00Mjgmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="ce8e649c010125fd7814ec6b70418500" value="1" />	</div>
	</form>
<!-- <br />
