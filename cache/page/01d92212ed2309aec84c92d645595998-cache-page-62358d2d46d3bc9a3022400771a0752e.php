<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:53288:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.net/support/edu/prestashop-15/managing-customers" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Learn to customize settings for, and manage, your customers in your PrestaShop 1.5 store." />
  <title>201: Managing Customers in PrestaShop 1.5 | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/prestashop-15/managing-customers" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:7a408b768a9b3bd3f259e429841658e4 -->
...
<div class='page-header'>
	<h1>201: Managing Customers in PrestaShop 1.5</h1>
</div>
<div class='section_listing'>
		<table>
		<tr>
				<td style='width:75px; font-weight:bold;'>Section 1:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/managing-customers/manually-delete-a-customer'>How to manually delete a customer in PrestaShop 1.5</a>
					<div>There may be times you need to delete customers in the PrestaShop 1.5 back office. This tutorial guides you through the process.</div>
					<div class='smallgrey'>Hits: 2,246</div>
				</td>
			</tr>
		<tr><td colspan='3' style='padding-top:20px;'><h2>Other Customer Settings</h2><div>Manage other settings for specific customers</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 2:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/managing-customers/change-group-access'>Changing user group access in PrestaShop 1.5</a>
					<div>this article shows you how to change a user's group access in the PrestaShop 1.5 back office interface.</div>
					<div class='smallgrey'>Hits: 2,594</div>
				</td>
			</tr>
			<tr>
				<td style='width:75px; font-weight:bold;'>Section 3:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/managing-customers/change-newsletter-setting'>Changing a customer's newsletter setting in PrestaShop 1.5</a>
					<div>This article demonstrates how to set a customer's newsletter setting in the PrestaShop 1.5 back office interface.</div>
					<div class='smallgrey'>Hits: 2,820</div>
				</td>
			</tr>
			<tr>
				<td style='width:75px; font-weight:bold;'>Section 4:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/managing-customers/changing-opt-in-status'>Changing a customer's opt-in status in PrestaShop 1.5</a>
					<div>This PrestaShop 1.5 tutorial walks you through changing a customer's opt-in status in the back office interface.</div>
					<div class='smallgrey'>Hits: 2,325</div>
				</td>
			</tr>
			<tr>
				<td style='width:75px; font-weight:bold;'>Section 5:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/managing-customers/disable-user-login'>How to disable a customer's login in PrestaShop 1.5</a>
					<div>This PrestasHop 1.5 article shows you how to disable the login ability of a user in the back office.</div>
					<div class='smallgrey'>Hits: 6,492</div>
				</td>
			</tr>
		<tr><td colspan='3' style='padding-top:20px;'><h2>Customer address management</h2><div>Mangage a customers address</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 6:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/managing-customers/add-customer-address'>How to add a customer address in PrestaShop 1.5</a>
					<div>This tutorial shows you how to add an customer address in PrestaShop 1.5.</div>
					<div class='smallgrey'>Hits: 2,084</div>
				</td>
			</tr>
			<tr>
				<td style='width:75px; font-weight:bold;'>Section 7:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/managing-customers/edit-customer-address'>How to edit a customer address in PrestaShop 1.5</a>
					<div>Changing a customer's address in PrestaShop 1.5 is very easy by following these steps.</div>
					<div class='smallgrey'>Hits: 1,683</div>
				</td>
			</tr>
		<tr><td colspan='3' style='padding-top:20px;'><h2>Managing Customer Groups</h2><div>Learn to add and delete customer groups as wella s creating customer discounts</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 8:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/managing-customers/adding-a-new-customer-group'>Adding a customer group in PrestaShop 1.5</a>
					<div>This PrestaShop 1.5 article will show you how to add a new customer group in your back office.</div>
					<div class='smallgrey'>Hits: 2,313</div>
				</td>
			</tr>
			<tr>
				<td style='width:75px; font-weight:bold;'>Section 9:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/managing-customers/create-a-group-discount'>Creating a group discount in PrestaShop 1.5</a>
					<div>This article for PrestaShop 1.5 demonstrates how to create a discount for a customer group.</div>
					<div class='smallgrey'>Hits: 3,361</div>
				</td>
			</tr>
		<tr><td colspan='3' style='padding-top:20px;'><h2>General Customer Settings</h2><div>Manage settings that affect all customers</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 10:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/managing-customers/changing-registration-process-type'>Changing Registration Process Type in PrestaShop 1.5</a>
					<div>Set the registration process to either quick registration or full registration for PrestaShop 1.5</div>
					<div class='smallgrey'>Hits: 11,823</div>
				</td>
			</tr>
			<tr>
				<td style='width:75px; font-weight:bold;'>Section 11:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/managing-customers/changing-regenerate-password'>Changing the regenerate password minimum time in Prestashop 1.5</a>
					<div>Setting the minimum time between password regenerations in PrestaShop 1.5 for security.</div>
					<div class='smallgrey'>Hits: 1,915</div>
				</td>
			</tr>
			<tr>
				<td style='width:75px; font-weight:bold;'>Section 12:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/managing-customers/adding-a-contact-email'>How to add a contact email address in PrestaShop 1.5</a>
					<div>Learn how to add a new contact point for your customers in your PrestaShop 1.5 back office.</div>
					<div class='smallgrey'>Hits: 9,556</div>
				</td>
			</tr>
			<tr>
				<td style='width:75px; font-weight:bold;'>Section 13:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/managing-customers/add-gender-title'>How to add a new gender title in PrestaShop 1.5</a>
					<div>This article demonstrates how to add a new gender title in PrestaShop 1.5</div>
					<div class='smallgrey'>Hits: 4,136</div>
				</td>
			</tr>
			<tr>
				<td style='width:75px; font-weight:bold;'>Section 14:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/managing-customers/set-new-message-notification'>How to enable/disable the new message notification in PrestaShop 1.5</a>
					<div>This article guides you through enabling or disabling the new order notification in the PrestaShop 1.5 back office dashboard panel.</div>
					<div class='smallgrey'>Hits: 4,268</div>
				</td>
			</tr>
			<tr>
				<td style='width:75px; font-weight:bold;'>Section 15:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/managing-customers/set-new-customer-notification'>How to enable/disable the new customer notification in PrestaShop 1.5</a>
					<div>This article guides you through enabling or disabling the new order notification in the PrestaShop 1.5 back office dashboard panel.</div>
					<div class='smallgrey'>Hits: 4,849</div>
				</td>
			</tr>
			</table>
</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yMzgmaWQ9MjM4JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
