<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49985:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/website-troubleshooting/website-not-responding-technical-description-is-502-bad-gateway" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello rheinsohn, Your site is up and running fine now. I do apologize,it seems you may have been working on the site when the server restarted some of i..." />
  <title>Website not responding, Technical Description is 502 Bad Gateway. | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/website-troubleshooting/website-not-responding-technical-description-is-502-bad-gateway" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:49f020febe568ac0ceb7a15ad29571e4 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Website not responding, Technical Description is 502 Bad Gateway.</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/rheinsohn'>rheinsohn</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-08-29 12:56 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>1,523</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I am working on a new website for my church.  In the process of doing so this morning, the website and the domain all went dead.  I am getting a &quot;Response Error.<br />
Technical Description:<br />
502 Bad Gateway - Response Error, a bad response was received from another proxy server or the destination orgin server.&quot;<br />
I've checked this on multiple computers on different networks, and it keeps saying the same thing.  Please advise.<br />
www.palmerdevelopment.org</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_1495' id='upvote_answer_1495' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='1495' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_1495').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_1495' id='downvote_answer_1495' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='1495' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_1495').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello rheinsohn,<br />
<br />
Your site is up and running fine now. I do apologize,it seems you may have been working on the site when the server restarted some of its services to prevent an issue. All should be well now. Please let us know if you have any further issues.<br />
<br />
Best Regards,<br />
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_1495').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_1495' id='form_comment_on_answer_1495' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/website-troubleshooting/website-not-responding-technical-description-is-502-bad-gateway&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/website-troubleshooting/website-not-responding-technical-description-is-502-bad-gateway'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="fb02bb12faa7b206acb939d0e4cd8e29" value="1" />	</div>
	</form>
<!-- <br />
