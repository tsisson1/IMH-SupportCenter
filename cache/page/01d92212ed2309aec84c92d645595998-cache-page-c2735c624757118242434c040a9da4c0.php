<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:67419:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/amp/what-is-my-hostname" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-04-21T23:15:46-07:00" />
  <meta name="keywords" content="ftp mysql hostname localhost" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="This article will assist you with finding your hostname." />
  <title>What is my hostname ? - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/amp/what-is-my-hostname" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:125e855b604629520dd5394c6af23eba -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '50.242.185.70']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>What is my hostname ?</span></li>			</ul>
		</div>
	</div>
</div>
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>35,046</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Oct 13, 2011'><span style='color:#606060;'>Published:</span> Apr 21, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<p>If you need to know your hostname, it will vary depending on which protocol you're using.</p>
<h2>FTP Hostname</h2>
<p>When connecting via ftp, your ftp hostname will be example.com (your actual domain name)</p>
<p>More information can be found in our <a href="/support/website/file-management/getting-started-guide-ftp">FTP Getting Started Guide</a></p>
<h2>MySQL Hostname</h2>
<p>When you are running an application on the server that connects to MySQL, use 'localhost' (without the quotes) as your MySQL hostname.</p>
<h2>Server Hostname</h2>
<p>Your server hostname can be found quite simply from directly within AMP using the following steps.</p>
<ol class='article_list'>
  <li><p><a href="http://www.inmotionhosting.com/support/website/amp/how-to-log-into-amp">Log into AMP.</a></p></li>
  <li><p>Scroll to the bottom of the AMP home page and click on Technical Details.</p></li>
  <li><p>On this page, you will see your hostname listed, such as <em>biz42.inmotionhosting.com</em></p></li>
</ol>
<h2>IP Address</h2>
  <p>Locating your IP address can be done directly from within cPanel, listed on the left side details section.  For step-by-step instructions, you may view our <a href="http://www.inmotionhosting.com/support/website/cpanel/how-to-find-your-shared-ip-address-of-your-server-in-cpanel">article on locating your shared IP</a>.</p>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/amp/what-is-my-hostname&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/amp/what-is-my-hostname'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MjcmaWQ9MjU5JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="cbe4a8836bc33703e16cefc9e6868db9" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='https://lh6.googleusercontent.com/-BtFqzrPFJg0/AAAAAAAAAAI/AAAAAAAAA4A/-3tk7kEV-KE/photo.jpg?sz=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='/support/community-support/users/Julio_Inostroza'>Julio_Inostroza</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-09 11:04 pm</div>
				                <div>hello again<br />
<br />
to enter the site, thanks to all who gave me support<br />
<br />
now, install prestashop, the installation was conducted with success, but by going to my domain tells me is registered with pairNIC!<br />
<br />
I have to do??<br />
 I have a domain leased for 5 years</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9570);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-10 5:14 am</div>
				                <div>Hello Julio,<br />
<br />
Did you just recently purchase your domain name? It sounds like you might need to &lt;a href=&quot;http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/updating-your-domains-nameservers&quot; target=&quot;_blank&quot;&gt;update your domain's name servers&lt;/a&gt; to resolve your domain name to your server.<br />
<br />
- Jacob</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9578);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-20 5:58 am</div>
				                <div><p><code class="php comments">"Hostname of the mail server AND Hostname under </code><code class="php comments">AMP&gt;&gt;Technical Details" are they same?</code></p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14140);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-20 9:37 am</div>
				                <div>Hello Sudip,<br />
<br />
Thank you for your question. Yes, you can use the hostname listed in your <a href="http://www.inmotionhosting.com/support/website/amp/viewing-account-technicial-information-in-amp">Account Technical Details</a>.<br />
<br />
You can also see your <a href="http://www.inmotionhosting.com/support/edu/everything-email/introduction-email/how-to-find-email-settings">email settings in cPanel</a> at any time.<br />
<br />
If you have any further questions, feel free to post them below.<br />
Thank you,<br />
<br />
-John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14144);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
