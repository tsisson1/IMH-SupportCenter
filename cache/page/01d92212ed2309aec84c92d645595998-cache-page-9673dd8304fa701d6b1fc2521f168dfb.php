...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/php/create-phpinfo-page-to-see-php-settings" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-04-21T23:21:09-07:00" />
  <meta name="keywords" content="phpinfo page php local master settings" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="In this tutorial, we'll show you how to create a phpinfo page so you can view your php settings." />
  <title>How can I view my php settings using a phpinfo page ? - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/php/create-phpinfo-page-to-see-php-settings" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:175cf42722c3347d8c82acb3074a736d -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How can I view my php settings using a phpinfo page ?									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='clear:both;'></div>
								...
								<center><iframe width="560" height="315" src="https://www.youtube.com/embed/_s870uRCFZg" frameborder="0" allowfullscreen></iframe></center>
<div class="in_this_tutorial">
  <h2>In this tutorial:</h2>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('create-phpinfo-page');">Create phpinfo Page</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('view');">View PHP Settings</button>
</div>

<p>PHP has many environmental variables that you are able to update as needed. For example, you may need to update your php memory_limit to prevent certain scripts from running out of memory. In order to change these values, you must first be able to see what they are. To do that, you will need to create a phpinfo page. A phpinfo page shows you all of your php environment settings.</p>
<p>A phpinfo page is simply a php page with the following code:</p>
<p class="code_block">&lt;? phpinfo(); ?&gt;</p>

<a name="create-phpinfo-page"></a>
<h2>How to Create a phpinfo Page</h2>
<p>If you're not familiar with how to create a php page, follow the steps below to create a <strong>phpinfo</strong> page using your File Manager.</p>
<ol class="article_list">
<li><a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">Log into your cPanel</a>.</li>
  <li><a href="/support/edu/cpanel/cpanel-file-manager/using-file-manager-in-cpanel">Open your File Manager</a>.</li>
  <li>Navigate to the directory you are working with. This is important because each folder can actually be set to have different php settings. In this example, we are viewing the php settings for our main domain, so we are navigating to the <strong>public_html</strong> folder.</li>
<li>In the top menu, click <strong>New File</strong>.</li>
...
<li>Find the phpinfo.php file in your list of files (it should have automatically updated). Right click on it and choose "Edit". If you see a "Text Editor" prompt, choose "utf-8" from the drop down list and then click "Edit".</li>
<li>Enter the following text:
<div class="code_block">&lt;? phpinfo(); ?&gt;</div>
Then click <strong>Save Changes</strong>.</li><br>
</ol>

<a name="view"></a>
<h2>How to View your PHP Settings</h2>
<ol class="article_list">
<li>You can now access this page from your browser. If you created the file in your public_html folder, then you would visit http://example.com/phpinfo.php. The results should look similar to the below screenshot:<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/php/create-php-info-page/this-is-what-a-phpinfo-file-loos-like.gif"><img  alt="this-is-what-a-phpinfo-file-loos-like" src="//cdn.inmotionhosting.com/support/images/stories/php/create-php-info-page/this-is-what-a-phpinfo-file-loos-like.gif" /></a></li>

  <li>To find the specific value of a setting, search the page for what you're looking for. In this case, we used our browser's search feature ( <strong>Ctrl + f</strong> ) and searched for <em>memory_limit</em>. The first value you see is what is set for the current directory (local value), and the setting value is the master value. The local value is the actual setting and is the important value, because the local values will override the master value:</p>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/php/create-php-info-page/this-is-a-phpinfo-page-showing-the-memory_limit-setting.gif"><img  alt="this-is-a-phpinfo-page-showing-the-memory_limit-setting" src="//cdn.inmotionhosting.com/support/images/stories/php/create-php-info-page/this-is-a-phpinfo-page-showing-the-memory_limit-setting.gif" /></a></p>
<p class="alert">Please note that your phpinfo page has many php settings that you don't want to broadcast to the world. When you're finished using the file, be sure to delete it. Another route you can take instead of deleting it however is naming the file something other than phpinfo.php. As phpinfo.php is such a common name, 'bots' on the web will randomly search for files named phpinfo.php. Setting the file name to something like 9823592374823.php would never be guessed by a bot (so no one would ever find it) however it may be difficult for you to remeber this in the future.</p>
<p>If you need to change any of these values, please see our article: <a href="/support/website/general-server-setup/update-local-php-settings">How to update your local php settings</a></p></li>
</ol>

<h2>Dedicated PHP Hosting</h2>
<p>InMotion dedicated servers come with PHP. A popular programming language used by many CMS platforms. If you are interested in running your own server, read more about our <a href="http://www.inmotionhosting.com/dedicated_servers/articles/dedicated-hosting-plans.html">dedicated hosting plans</a>.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/php/create-phpinfo-page-to-see-php-settings&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/php/create-phpinfo-page-to-see-php-settings'></div>
	<script type='text/javascript'>
	  (function() {
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support//?tsrc=rsbraq'>My PHP code is not running on XAMPP</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/cpanel/turn-errors-off-for-php?tsrc=rsbraq'>Turn errors off for PHP</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/general-server-setup/pdo-library-configuration-on-vps?tsrc=rsbraq'>PDO library configuration on vps</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/wordpress/cannot-save-product-variables-in-woocommerce?tsrc=rsbraq'>Cannot save product variables in woocommerce</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/databases/wavemaker-browser-app-support?tsrc=rsbraq'>wavemaker browser app support</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/cpanel/please-turn-on-mcrypt-extension?tsrc=rsbraq'>Please Turn On Mcrypt Extension</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/1726d34e68c8f017f2431b17e2cc3cf1?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/1726d34e68c8f017f2431b17e2cc3cf1'>vijay gupta</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-17 8:51 am</div>
				                <div><p>Hello,&nbsp;</p>
<p>Please let me know how can i check that Email service is enabled or not in my server. I have print phpinfo() function and it show whole detail LIKE- sendmail_from, sendmail_path.</p>
<p>But how i know my email service is working or not ?&nbsp;</p>
<p>Thanks</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20774);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-17 12:02 pm</div>
				                <div>Hello Vijay,<br />
<br />
The phpinfo would not inform you if the email service is working, for that please contact your hosts technical department to have them check the mail logs to be sure the service is working.<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20784);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-23820'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/e637a7692f0626eb5bcf273c5190d945?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/e637a7692f0626eb5bcf273c5190d945'>Ann</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-05-29 7:48 pm</div>
				                <div><p>Excellent video! Thank you; this gave me the exact instructions that I needed to configure my site!</p>
<p>Ann</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23820);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-25282'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/95ef7827dc716d379fa4f874d04bf45a?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/95ef7827dc716d379fa4f874d04bf45a'>gig</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-29 5:29 am</div>
				                <div><p>hi it said it not enable</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25282);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-29 9:18 am</div>
				                <div>Hello Gig,<br />
<br />
We would need more information about what you're doing in order to determine how to help you.  If you're following the directions in the article above, the phpinfo page will appear.  <br />
<br />
Regards,<br />
Arnel</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25289);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-30120'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/965e6292c199d0d267cfaf046a557dde?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/965e6292c199d0d267cfaf046a557dde'>CURL version</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-26 2:34 am</div>
				                <div><p>DEar all.</p>
<p>&nbsp;</p>
<p>I have&nbsp; a problems with my current hosting contract because it is not possible to connect to paypal sandbox environment since paypal has recently changed the protocols .Right now, TLSv1.2 and http 1.1 are required.</p>
<p>The limitations of my current hosting is that the curl version is 7.20 and we need to have 7.34 and above.</p>
<p>Please, could you tell me the overall php characteristivs provided by phpoinfo(). What is the culr version ?</p>
<p>&nbsp;</p>
<p>It is very important for us because we are looking for a new hosting service.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30120);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-26 7:15 pm</div>
				                <div>All of the printed data available in the phpinfo file are too numerous to list here. I recommend checking the official PHP documentation if you need more information. If you have a VPS account with us we can work with you to get  cURL to whatever specifications you require.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30138);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-30827'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/8d843a015ae17b6e49b9188d23e89ee4?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/8d843a015ae17b6e49b9188d23e89ee4'>Rehana</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-02-26 12:11 pm</div>
				                <div><p>I want to upgrade php on specific folder in my server, i have diffrent websites and dont want to upgrade php for all websites. will it work perfect on specific folder in my server without disturbing the other websites?</p>
<p>I have nerver tried it before, so afrid if it effect on other folders as well :(</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30827);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-02-26 12:37 pm</div>
				                <div>Hello Rehana,<br />
<br />
As long as the server you are on has multiple versions of PHP installed you can use the .htaccess file to change the version for the folder it resides in. To do this you would use the following code in your .htaccess file:<br />
<br />
AddHandler application/x-httpd-php54 .php<br />
<br />
Where php54 is PHP version 5.4.<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30829);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
