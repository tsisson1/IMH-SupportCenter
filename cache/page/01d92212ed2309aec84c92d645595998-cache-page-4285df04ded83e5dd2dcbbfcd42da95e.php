<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:83620:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/wordpress-plugins/optimize-wordpress-images" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-04-26T16:00:56-07:00" />
  <meta name="author" content="Jeff Matson" />
  <meta name="description" content="Optimizing the images on your WordPress site is something that is quite simple when you have a great plugin to do it for you." />
  <title>How to Optimize WordPress images with the EWWW Image Optimizer plugin - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/wordpress-plugins/optimize-wordpress-images" rel="canonical" />
...
<script>
  ...
  ga('send', 'pageview');
	...
	<!-- cid:f45b288fd2946d654ac7d574f297b3cd -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '31.215.30.170']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to Optimize WordPress images with the EWWW Image Optimizer plug...</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to Optimize WordPress images with the EWWW Image Optimizer plugin									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>8,332</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Apr 18, 2014'><span style='color:#606060;'>Published:</span> Apr 26, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Optimizing your images on your website is something that most users overlook. It can dramatically affect the speed at which your website loads as well as improve resource usage. This article describes how to use the EWWW Image Optimizer plugin. It can automatically optimize your images without sacrificing the quality of the image.</p>
<h2>Installing the EWWW Image Optimizer plugin</h2>
<ol class="article_list">
    ...
    <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/optimize-images-1.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/optimize-images-1.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>Once logged into your WordPress admin dashboard, hover over <strong>Plugins</strong>, and click on <strong>Add New</strong>.  You will then be taken to the plugin installation page.</p></li>
    <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/optimize-images-2.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/optimize-images-2.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>On the plugin installation page, you will see a search box.  In this search box, enter <em>EWWW Image Optimizer</em> and click on <strong>Search Plugins</strong>.  Once you have submitted your search, you will be presented with a list of plugins that match your search query.</p></li>
    <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/optimize-images-3.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/optimize-images-3.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>Within your search results page, the top result will be <em>EWWW Image Optimizer</em> which is the plugin that we are looking for.  To install it, click on <strong>Install Now</strong>.  WordPress will then handle the download and installation of the EWWW Image Optimizer plugin.  Once complete, be sure to click the <strong>Activate Plugin</strong> link to ensure that it is active on your site.</p></li>
</ol>
<h2>Recommended settings for the EWWW Image Optimizer plugin</h2>
<p>Now that you have installed the EWWW Image Optimizer plugin, it's time to set it up.</p>
<ol class="article_list">
<li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/optimize-images-4.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/optimize-images-4.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>To access the settings for EWWW Image Optimizer plugin, hover over <strong>Settings</strong> to the left side of your WordPress dashboard, and click on <strong>EWWW Image Optimizer</strong>.  You will then be taken to the settings page where all of your image optimization settings will be defined.</p></li>
<li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/optimize-images-5.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/optimize-images-5.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>First, be sure that all of the optimization methods are enabled.  To do so, scroll down under <em>General Settings</em> and ensure that the boxes for <strong>disable jpegtran</strong>, <strong>disable optipng</strong>, <strong>disable pngout</strong>, and <strong>disable gifsicle</strong> are all unchecked.</p></li>
<li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/optimize-images-6.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/optimize-images-6.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>We also recommend that you remove all metadata from the image.  Metadata is the extra information such as comments and creation date that is stored within the image file.  Over all of your images, removing the metadata can save a large amount of space.  To remove all metadata from the images, select the checkbox labeled <strong>Remove metadata</strong>.</p></li>
<li style='clear:both;'>Once your settings are defined, scroll to the bottom and click on <strong>Save Changes</strong>.</li>
</ol>
<h2>Optimizing your images with the EWWW Image Optimizer plugin</h2>
<ol class="article_list">
    <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/optimize-images-7.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/optimize-images-7.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>To begin optimizing your images, hover over <strong>Media</strong> on the left side of the WordPress dashboard and click on <strong>Bulk Optimize</strong>.  Once on this page, click the <strong>Import Images</strong> button to import all of your images into the EWWW Image Optimizer plugin.</p></li>
    <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/optimize-images-8.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/optimize-images-8.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>First, I recommend setting a delay between images being optimized as this will assist you server loads during the conversion.  In the text field at the top of the page, change it to delay a few seconds.  Usually 5 seconds or so is a good delay to set here.</p></li>
    <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/optimize-images-9.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/optimize-images-9.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>Next, you will want to optimize your Media Library.  To do so, click on <strong>Start optimizing</strong> under the <em>Optimize Media Library</em> heading.</p></li>
    <li><p>After you have started optimizing your media library, you will see a screen that will shows the progress of each file as well as how much it was reduced.</p></li>
    <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/optimize-images-10.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/optimize-images-10.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>Once complete, jump back over to the <em>Bulk Optimize</em> page and look for the heading labeled <em>Optimize Everything Else</em>.  Under this heading, click <strong>Scan and optimize</strong>.  The EWWW Image Optimizer plugin will then go through all other images such as those within your theme and optimize them.</p></li>
  <div style="clear:both;"></div>
</ol><br>
<p>Once your images are finished being optimized, the optimized images are now in use on your site and will allow for lower server loads and quicker page load times for your users.</p>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/wordpress-plugins/optimize-wordpress-images&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/wordpress-plugins/optimize-wordpress-images'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NjcmaWQ9MzIwMyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/8b244a0502412408b3da5d5648109632?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/8b244a0502412408b3da5d5648109632'>SandIp Roy</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-03 1:50 am</div>
				                <div>Enlarge the attached pics on the right side of the instruction Steps, for better visibility.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15831);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-24 4:01 pm</div>
				                <div>Hello SandIp,<br />
<br />
Thank you for contacting us. You can click the images to see an enlarged version.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26046);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-22922'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/f0ac2680b44c4e27224959b502d7f3a8?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/f0ac2680b44c4e27224959b502d7f3a8'>Amit Ramani</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-24 1:14 pm</div>
				                <div><p>Thank you for this nice guide. I am doing this image optimization now using EWWW. I hope it reduces the page load time.&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22922);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-16 3:18 pm</div>
				                <div><p>I have run this and still get gigged on Google Page Speed. &nbsp;I am running again. &nbsp;I think I remember a question for "delete originals after optimized"... should we delete the originals ?</p>
<p>Does this plugin automatically "optimize" new JPGs, PNGs, that you add after you get this plugin running ? &nbsp;Or do we need to periodically come back and re-run this bulk optimizer ?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24255);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-17 12:13 am</div>
				                <div>Hello Paul Alford,<br />
<br />
You will need to re-run the plugin for your newly uploaded images. I would suggest removing the originals after you have an optimized version.<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24260);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-25718'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/c424f7434554b4d8ac603636e1ca5a29?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/c424f7434554b4d8ac603636e1ca5a29'>shopify image optimizer</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-12 9:28 am</div>
				                <div><p>There is some basic things you need to do to get your images ready to use on your website.Reducing your image size can cut your page size and load time in half, which makes your page load time much quicker and everyone much happier right away.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25718);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/c424f7434554b4d8ac603636e1ca5a29?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/c424f7434554b4d8ac603636e1ca5a29'>joomla image optimizer</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-24 7:37 am</div>
				                <div><p>Thanks for making us understand in a very easy manner and in complete detail about optimization of wordpress images.</p>
<p>This is excellent information. I will be waiting for other interesting posts from you in the nearest future.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26014);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-29834'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/feef1a843c7a1b7e53d75d2a39b6cd0b?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/feef1a843c7a1b7e53d75d2a39b6cd0b'>John Blum</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-15 12:42 pm</div>
				                <div><p>You may also want to try these other image optimization pluginshttps://wordpress.org/plugins/shortpixel-image-optimiser/https://wordpress.org/plugins/kraken-image-optimizer/</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29834);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-31052'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/6be859d6b43a1421e051acc0d0999753?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/6be859d6b43a1421e051acc0d0999753'>Vikas Singh</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-08 11:08 am</div>
				                <div><p>Nice and very informative article. I have used EWWW image optimizer as well as WP Smush. Both are good but</p>
<p>I preferably go for EWWW because of fast optimization as WP Smush sends the file to Yahoo server and then Yahoo server sends smushed images back to WP Smush.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31052);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
