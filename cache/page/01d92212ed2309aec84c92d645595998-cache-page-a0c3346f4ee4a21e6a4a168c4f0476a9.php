<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:62041:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-file-manager/complete-cpanel-backup" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-10-09T20:30:41-07:00" />
  <meta name="keywords" content="cPanel Backup Complete Full" />
  <meta name="author" content="John-Paul Briones" />
  <meta name="description" content="Learn how to backup your entire cPanel in this walk-through guide." />
  <title>How to Perform a Full Backup in cPanel - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-file-manager/complete-cpanel-backup" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:bb5e6923470fb5da4764da7207f5270d -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to Perform a Full Backup in cPanel									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>10,819</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Oct 7, 2015'><span style='color:#606060;'>Published:</span> Oct 9, 2015</div>
							...
							<div style='clear:both;'></div>
								...
								<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/backups/cpanel-files-backup.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/backups/cpanel-files-backup.png" alt="cPanel Backups" title="Backup Files in cPanel" class="pull-right" style="margin: 15px 15px 15px 15px;" /></a>
<p>In this tutorial we will show you how to do a <strong>Full cPanel Backup</strong> of your account. Backing up your website is a necessary step for all users. Before making any changes to your website, it's best practice to always create a backup. Cpanel has a built-in backup tool to assist you with creating backups. This handy utility will create a zip file (compressed file) that you then can download to your local computer for storage.<br>
  Please be advised, we do not allow anyone to store backups in File Manager, you must store them off of the server. Creating a full backup ensures you back up everything and is the safest method to ensure all your website files and emails are safe. We recommend that all of our customers maintain their own backups. Be sure to read our <a href="/support/website/backup-and-restore/do-you-run-backups-of-your-servers">Do you run backups of your servers?</a> article for an overview of how backups are maintained for our servers.</p>

<h2>Performing a Complete cPanel Backup</h2>
<ol class="article_list">
<li><a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">Login to your cPanel</a>.</li>
<li>Click the <strong>Backups</strong> button in the <em>Files</em> section of cPanel.</li>
<li>In the <em>Full Backup</em> section, click the <strong>Download a Full Website Backup</strong> button.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/backups/cpanel-full-backup-download.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/backups/cpanel-full-backup-download.png" alt="Complete Back Up in cPanel" title="Download Full Backup from cPanel" /></a></li>
<li>On the next screen make sure the <strong>Home Directory</strong> option is selected.</li>
<li>If you want an email notification when the backup completes, enter your email address. If you <em>do not</em> want an email, check the box next to <strong>Do not send email notification of backup completion</strong>.</li>
<li>Click the <strong>Generate Backup</strong> buton to begin the <strong>Full cPanel Backup</strong>strong>.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/backups/cpanel-generate-backup.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/backups/cpanel-generate-backup.png" alt="Create a Complete Back Up" title="Generating a Full Backup in cPanel" /></a><br><br>
You will then see a message stating "<em>Full Backup in Progress...</em>" Allow some time for the backup to complete, you will receive an email notification upon completion (if you entered your email address in the last step).</li>
<li>Download the file from your cPanel. It will be located in your <strong>/home</strong> directory, begin with backup, and include the date. For example: backup-10.9.2015_15-52-08_exampl99.tar.gz<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/backups/download-full-cpanel-backup.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/backups/download-full-cpanel-backup.png" alt="Backup Download from File manager in cPanel" title="Download a Full cPanel Backup" /></a></li>
</ol>
<br>
<p>Congratulations, now you know how to perform a <strong>Full cPanel backup</strong>! We also have walk-through guide on <a href="/support/website/backup-and-restore/backup-website-files-in-cpanel">backing up your website files</a>, and <a href="/support/website/backup-and-restore/backup-your-database-in-cpanel">backing up a database in cPanel</a>.</p>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 1: How to Perform a Full Backup in cPanel</div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/cpanel/cpanel-file-manager/complete-cpanel-backup&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/cpanel/cpanel-file-manager/complete-cpanel-backup'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xMzUmaWQ9MzY2NSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/1ed27e2bcbc62c01bf82d252bb1603fe?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/1ed27e2bcbc62c01bf82d252bb1603fe'>kraig</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-21 11:34 am</div>
				                <div><p>Maybe I missed it but it would be nice to be able to print these out to have on hand.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32150);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-21 12:47 pm</div>
				                <div>Hello kraig,<br />
<br />
Thank you for contacting us. You should be able to "right-click" in the browse and choose <strong>Print</strong>, or use "Ctrl + P" at the same time to bring the print menu up.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32152);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
