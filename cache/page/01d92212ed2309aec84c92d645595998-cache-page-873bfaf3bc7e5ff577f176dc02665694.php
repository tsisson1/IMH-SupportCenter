<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:59896:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/prestashop-15/sql-manager/export-custom-query" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-12-18T16:52:33-08:00" />
  <meta name="keywords" content="export custom query PrestaShop 1.5" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Learn to export your custom query results in PrestaShop 1.5" />
  <title>How to export a custom SQL Query in PrestaShop 1.5  - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/prestashop-15/sql-manager/export-custom-query" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:2e69ea33aaab7d03be99c847082bcf6c -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '79.56.102.158']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to export a custom SQL Query in PrestaShop 1.5 									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>4,635</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Oct 5, 2012'><span style='color:#606060;'>Published:</span> Dec 18, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In our last article in the <a href="/support/edu/prestashop-15/sql-manager">Working with SQL Manager</a> course we went over viewing your custom query results. We will now go over how to export your query. This allows you to export a CSV file of the results. Follow the steps below to learn how to export your query in PrestaShop 1.5</p>
<p><strong>Exporting custom SQL query results in PrestaShop 1.5</strong></p>
...
<li>You are now on the <em>SQL Manager</em> page. From the custom query list, find the one you want to view results for and click on the <strong>Export</strong> icon. This icon looks like a piece of paper with a green arrow pointing upwards.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Advanced_Paramaters/SQL_Manager/Export/export-file.png"><img  alt="export-file" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Advanced_Paramaters/SQL_Manager/Export/export-file.png" /></a></li>
<li>Once you click on the icon yuor CSV file will be saved to your local computer. Depending on your browser, you may be prompted with a pop up box to save your CSV file. In that case, click on <strong>OK</strong> to save the file to your computer.</li>
<li>Once saved, you can open the file with your favorite text editor. Below is a sample of what our test CSV file looks like. The first set of data is the column headers after which you can see the data rows, all separated by a semi-colon delimiter.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Advanced_Paramaters/SQL_Manager/Export/view-results.png"><img  alt="view-results" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Advanced_Paramaters/SQL_Manager/Export/view-results.png" /></a></li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 3: How to export a custom SQL Query in PrestaShop 1.5 </div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 4: <a href='/support/edu/prestashop-15/sql-manager/delete-custom-query'>How to delete a custom SQL Query in PrestaShop 1.5 </a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/prestashop-15/sql-manager/export-custom-query&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/prestashop-15/sql-manager/export-custom-query'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNzImaWQ9MTg0MSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="65ba276e19fa04cc246eb30da6acd340" value="1" />	</div>
	</form>
<!-- <br />
