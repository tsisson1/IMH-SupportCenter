<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50006:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/email-client-setup/i-want-to-know-how-i-can-go-directly-to-my-email" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Thank you for your question Brian12! You can access your email directly through your browser using webmail. Check the following link on how to log in. Y..." />
  <title>I want to know how I can go directly to my email? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/email-client-setup/i-want-to-know-how-i-can-go-directly-to-my-email" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:3f4a29cda4e10c4a9967495e70308fb9 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '82.145.223.85']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>I want to know how I can go directly to my email?</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='http://graph.facebook.com/brian.pekarek.90/picture?type=normal' class='user_avatar' /><br />
			<a href='/support/community-support/users/Brian12'>Brian12</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-06-21 12:29 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>5,328</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>http://unwindbodycare.com:2095/horde/login.php<br />
<br />
First it asks me for a username &amp; Password.  This is not the same as my email and password after I click cancel.<br />
<br />
Thanks</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_3384' id='upvote_answer_3384' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='3384' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_3384').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_3384' id='downvote_answer_3384' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='3384' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_3384').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>5,889 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2013-06-21 12:37 pm EST
                		        </div>
					
		                </div>

				Thank you for your question Brian12!<br />
 <br />
 You can access your email directly through your browser using webmail. Check the following link on how to log in. You use your email address you set up in your cPanel for the username and the email password to login. This is different than the login for your AMP panel.<br />
 <br />
 &lt;a href=&quot;http://www.inmotionhosting.com/support/edu/cpanel/cpanel-email/logging-into-webmail&quot; target=&quot;_blank&quot;&gt;How to log into Webmail&lt;/a&gt;<br />
 <br />
 The link you provided looks correct; however, you may want to go to the following:<br />
 <br />
 cpanel.unwindbodycare.com<br />
 <br />
 You may have an issue with the port 2095 with the login. That link is the proxy link that works over port 80. If you are using the correct email and password then you may just need the proxy URL. <br />
 <br />
 Best Regards,<br />
 James R
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_3384').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_3384' id='form_comment_on_answer_3384' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/email-client-setup/i-want-to-know-how-i-can-go-directly-to-my-email&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/email-client-setup/i-want-to-know-how-i-can-go-directly-to-my-email'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="e0a09d8434847ef30656c2604f506101" value="1" />	</div>
	</form>
<!-- <br />
