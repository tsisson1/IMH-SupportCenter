<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:58101:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-manage-domains/delete-addon-domain" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-10-21T21:49:04-07:00" />
  <meta name="keywords" content="delete addon remove add-on add on removal steps possible conflicts" />
  <meta name="author" content="Arnel Custodio" />
  <meta name="description" content="This tutorial discusses the steps to delete an addon domain.  It also includes information on possible conflicts that would cause problems to the removal.  " />
  <title>Deleting an Addon Domain - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-manage-domains/delete-addon-domain" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:f010e05602f813864fc2aeab366576e0 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-20']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '141.0.15.221']);
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>3,583</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Oct 18, 2013'><span style='color:#606060;'>Published:</span> Oct 21, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>The following tutorial discusses how to remove add-on domains and how to correct possible conflicts due to established subdomains.</p>

<h2>Removing an Addon Domain</h2>

<p>When you are removing add-on domains it important to remember that the cPanel automatically creates the folder where the website files are saved.  If the folder is also a subdomain to the primary domain, then you may need to remove the subdomain <em>before</em> you can delete the addon domain. </p>

<ol>
<li><a href="http://www.inmotionhosting.com/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel" target="new">Login to the cPanel</a></li>
<li>Check to see if your addon domain is also identified as a subdomain.  Go to Domains, then click on the <b>Subdomains</b> icon.  If you see your add-on domain folder listed, then remove it.</li>
<li>Click on the <b>Addon Domains</b> icon and find the addon domain that you wish to remove.</li>
<li>Go to the <b>Actions</b> column and then click on <b>Remove</b> in order to remove the domain.  Confirm the action and it's complete.</li>
</ol>

<h3>Add-on domain error: Domain already configured</h3>

<p>On rare occasions, some domains will appear to be removed from add-on domains section, but the DNS settings remain.  This will cause an error to appear if you try to re-add the domain that you think had already been deleted.  If the domain was abc.com, then error message would look like this:</p>
<br />
<p><em>abc.com is already configured</em></p>
<br />
<p>If you see this error, please contact live technical support by phone/email/chat.  Verify your account (with either the last 4 digits of the credit card or the Account Management Panel (AMP) password. Then explain that you have deleted the domain, but you're still having problems with it -give the error.  They can remove the DNS entries for you if you do not have <a href="http://www.inmotionhosting.com/support/website/ssh/root-access-faq" target="new">root access to the account</a>.  </p>

<p>This completes the tutorial for removing Addon domains through the cPanel. Remember that removing a domain in the Domains section of the cPanel does not <em>delete</em> a domain name.  To cancel a domain, go to <a href="http://www.inmotionhosting.com/support/domain-names/general-information/cancel-domain-registration" target="new">Cancelling a domain registration</a> for further information.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 3: Deleting an Addon Domain</div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/cpanel/cpanel-manage-domains/delete-addon-domain&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/cpanel/cpanel-manage-domains/delete-addon-domain'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xMzYmaWQ9MjkwNSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="bd4e9c83ce4ec41464fdefe1d29d2827" value="1" />	</div>
	</form>
<!-- <br />
          ...
          <tr >
			...
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/dns-nameserver-changes/i-am-unable-to-create-an-addon-domain?tsrc=rsbraq'>I am unable to create an addon domain</a>
                                </div>
