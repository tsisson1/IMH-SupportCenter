...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/wordpress-plugins" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="InMotion Hosting Support Center" />
  <title>Wordpress Plugins | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/wordpress-plugins" rel="canonical" />
...
<script>
  ...
  ga('send', 'pageview');
	...
	<!-- cid:3778d9aaff999b425ef9df4b051c267e -->
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Wordpress Plugins</span></li>			</ul>
		</div>
	</div>
</div>
...
<form action="http://www.inmotionhosting.com/support/website/wordpress-plugins" method="post" name="adminForm" id="adminForm" class="form-inline">
  ...
  <table class='article_list'>
          ...
          <tr>
                  ...
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/website/wordpress-plugins/apppresser-push-notifications'>How to Send Android push notifications in AppPresser</a></td>
                                <td>3,600</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/website/wordpress-plugins/editing-wordpress-fonts-with-the-wp-google-fonts-plugin'>WordPress font plugins - WP Google Fonts</a></td>
                                <td>3,224</td>
                        </tr>
                  <tr>
                  ...
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/website/wordpress-plugins/p3-plugin-performance-plugin-for-wordpress'>How to Identify Intensive Plugins in WordPress with the P3 (Plugin Performance Profiler)</a></td>
                                <td>2,301</td>
                        </tr>
                  </table>
		...
		<ul><li class="pagination-start"><span class="pagenav">Start</span></li><li class="pagination-prev"><span class="pagenav">Prev</span></li><li><span class="pagenav">1</span></li><li><a href="/support/website/wordpress-plugins?start=15" class="pagenav">2</a></li><li><a href="/support/website/wordpress-plugins?start=30" class="pagenav">3</a></li><li><a href="/support/website/wordpress-plugins?start=45" class="pagenav">4</a></li><li class="pagination-next"><a title="Next" href="/support/website/wordpress-plugins?start=15" class="hasTooltip pagenav">Next</a></li><li class="pagination-end"><a title="End" href="/support/website/wordpress-plugins?start=45" class="hasTooltip pagenav">End</a></li></ul>	</div>
	</form>
