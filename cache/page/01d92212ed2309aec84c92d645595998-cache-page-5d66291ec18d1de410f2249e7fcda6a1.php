<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:58554:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/drupal-8/contact-form/configure" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-12-12T18:23:02-08:00" />
  <meta name="keywords" content="configure drupal 8 contact form" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Learn how to configure your contact form for your Drupal 8 site." />
  <title>Configuring a contact form in Drupal 8 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/drupal-8/contact-form/configure" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:e44a9b5a56664c4907d4c53c92b5b58b -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '202.67.47.22']);
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
				<img src='/support/images/stories/drupal-partner/supporting-partner-80_3.png' style='float:right; margin:0px 0px 15px 15px;' alt='Drupal Association Support Partner'>		<h1>
															Configuring a contact form in Drupal 8									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>4,747</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Nov 9, 2013'><span style='color:#606060;'>Published:</span> Dec 12, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>One of the more common pages found on websites is the contact form page. This is normally a page with some type of a form that the user can fill out. The content is then sent to a specific email address so the feedback can be reviewed and responded to. This tutorial will guide you on how to configure the contact form in Drupal 8.</p>

<h2>How to configure your contact form</h2>
...
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/_common-images/select-menu.png"><img  style="float:right; margin:0px 0px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/_common-images/select-menu.png" title="Click here to view the larger image" width="200" /></a>From the the topmost  menu bar, select the <strong>Menu</strong> tab.<div style="clear:both;"></div></li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/_common-images/select-structure.png"><img  style="float:right; margin:0px 0px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/_common-images/select-structure.png" title="Click here to view the larger image" width="200" /></a>Next, click on the the <strong>Structure</strong> link from the second menu bar that appears.<div style="clear:both;"></div></li>

<li>You are now presented with the <em>Structure</em> page where you can see all the different structure types. Click on the <strong>Content form categories</strong>.<div style="clear:both;"></div></li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/203/configure-contact-form/1-edit-contact-form.png"><img  style="float:right; margin:0px 0px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/203/configure-contact-form/1-edit-contact-form.png" title="Click here to view the larger image" width="200" /></a>This page shows the different contact form categories. By default there are two, one named <em>Personal feedback</em> and one named <em>Website feedback</em>. We will be working with the <em>Website feedback</em>. Click on the <strong>Edit</strong> link to the right of that category.<div style="clear:both;"></div></li>


  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/203/configure-contact-form/2-enter-contact-form-data.png"><img  style="float:right; margin:0px 0px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/203/configure-contact-form/2-enter-contact-form-data.png" title="Click here to view the larger image" width="200" /></a>The <em>Edit contact category</em> page appears where you can edit the standard information for the contact form. Be sure to check the box labeled <strong>Make this the default category</strong> to use this form for your site.<div style="clear:both;"></div>

<table class="article_table">
<tr><th>Label</th><td>This is the name of the contact form that displays in the category list. This can be anything you like, but be sure to give it a descriptive name.</td></tr>
<tr><th>Recipients</th><td>This is the list of email addresses that will receive the feedback. You can enter more than one, simply separate each email address with a comma.</td></tr>
<tr><th>Auto-reply</th><td>If you wish to send an auto-reply message, enter your message here.</td></tr>
<tr><th>Weight</th><td>This affects how the contact category displays in the list, the lower the number, the 'lighter' the category so the higher on the list it will appear. Categories with the same weight will be sorted alphabetically.</td></tr>
<tr><th>Make this the default category</th><td>Checking this checkbox will select this category as the default form.</td></tr>
</table>

<div style="clear:both;"></div></li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/203/configure-contact-form/3-contact-link.png"><img  style="float:right; margin:0px 0px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/203/configure-contact-form/3-contact-link.png" title="Click here to view the larger image" width="200" /></a>Once you have entered the information for the category, click on the <strong>Save</strong> button in order to save and activate the data. Visit the site and you will see a <em>Contact</em> link in the lower left corner of the page. If you wish to make the Contact form part of the menu, you will need to refer to our article entitled    <a href="/support/edu/drupal-8/contact-form/add-to-menu">Adding a contact form to a menu in Drupal 8</a>.
<div style="clear:both;"></div>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/drupal-8/contact-form'>203: Managing contact forms in Drupal 8</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 2: Configuring a contact form in Drupal 8</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 1: <a href='/support/edu/drupal-8/contact-form/add-to-menu'>Adding a contact form to a menu in Drupal 8</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/drupal-8/contact-form/configure&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/drupal-8/contact-form/configure'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NzQmaWQ9Mjk1MSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="1e449176cf90f87ba829d2fe11e696db" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/drupal-8/contact-form?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Managing contact forms in Drupal 8</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/drupal-8/contact-form/add-to-menu?tsrc=rsbedu'>Adding a contact form to a menu in Drupal 8</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/drupal-8/contact-form/configure?tsrc=rsbedu'>Configuring a contact form in Drupal 8</a></td>
                </tr>
          	</table>
