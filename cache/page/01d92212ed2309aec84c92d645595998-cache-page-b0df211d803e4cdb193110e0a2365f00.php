<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:47064:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/wordpress/change-wordpress-appearance" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="keywords" content="Wordpress editor css customized appearance kitchen sink" />
  <meta name="description" content="WordPress can be customized by editing the themes in the Appearance section of the dashboard. This course will tell you how." />
  <title>105: Changing the Wordpress Appearance | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/wordpress/change-wordpress-appearance" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:dfee3f59873c52c9890fa35fba270a41 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '66.183.88.183']);
...
<div class='page-header'>
	<h1>105: Changing the Wordpress Appearance</h1>
</div>
<div class='section_listing'>
		...
		<tr>
				...
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/wordpress/change-wordpress-appearance/theme-customizer'>How to Access & Use the Theme Customizer in WordPress</a>
					<div>How to use the WordPress Theme Customizer.</div>
					<div class='smallgrey'>Hits: 737</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/wordpress/change-wordpress-appearance/add-new-media-wordpress-351'>Add New Media in Wordpress 3.5.1</a>
					<div>Media can be added directly into the  files and managed with Wordpress.  The following tutorial shows to use this direct interface and shows how the media will appear in a page when added.</div>
					<div class='smallgrey'>Hits: 1,283</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/wordpress/change-wordpress-appearance/how-to-edit-wordpress-theme'>How do I edit my WordPress theme?</a>
					<div>WordPress comes with a built in Theme editor. This article will explain the basics of the WordPress theme editor.</div>
					<div class='smallgrey'>Hits: 3,852</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/wordpress/change-wordpress-appearance/appearance-editor-css-code'>How do I use the Appearance editor in WordPress?</a>
					<div>To change the CSS style of your WordPress you will need to use the Appearance editor. This article will tell you how.</div>
					<div class='smallgrey'>Hits: 7,302</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/wordpress/change-wordpress-appearance/using-kitchen-sink'>Using the Kitchen Sink in WordPress</a>
					<div>You can show more options in the WordPress WYSIWYG editor. This article will show you how.</div>
					<div class='smallgrey'>Hits: 1,864</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/wordpress/change-wordpress-appearance/change-header-banner-image'>How to change the header banner image in WordPress</a>
					<div>You can customize the header banner in WordPress through the Theme Appearance. This article will show you how.</div>
					<div class='smallgrey'>Hits: 17,783</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/wordpress/change-wordpress-appearance/change-footer-text-brand'>Changing the Branded footer text in WordPress</a>
					<div>When you have a new WordPress, you may want to remove the branded footer text from the site. This article will show you how.</div>
					<div class='smallgrey'>Hits: 37,146</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/wordpress/change-wordpress-appearance/change-font-globally'>Changing your font globally in WordPress</a>
					<div>To change the font globally in your WordPress site, you can edit the style for your site. This tutorial will show you how.</div>
					<div class='smallgrey'>Hits: 16,328</div>
				</td>
			</tr>
			</table>
</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMzkmaWQ9MzM5JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="ebd768387092349a956ed9131add3377" value="1" />	</div>
	</form>
<!-- <br />
