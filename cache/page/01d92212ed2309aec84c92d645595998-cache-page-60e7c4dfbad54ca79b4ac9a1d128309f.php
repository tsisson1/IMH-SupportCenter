<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:55858:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/boldgrid/intermediate-topics/creating-sitemap" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-08-14T16:30:14-07:00" />
  <meta name="author" content="John-Paul Briones" />
  <meta name="description" content="InMotion Hosting Support Center" />
  <title>How to Create a sitemap in WordPress using Yoast - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/boldgrid/intermediate-topics/creating-sitemap" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:605d7321546497a6315a06b3b076e128 -->
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/boldgrid' itemprop='url'><span itemprop='title'>BoldGrid<span></a><div class='dropdown_2columns'><h2>BoldGrid Education Channel</h2><div class='col_2'><h3>100 Level Classes</h3></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/boldgrid/intermediate-topics' itemprop='url'><span itemprop='title'>Intermediate Topics<span></a><div class='dropdown_3columns'><h2> Topics</h2><div class='col_3'><div>1. <a style='display:inline;' href='/support/edu/boldgrid/intermediate-topics/how-to-add-a-blog-in-a-boldgrid-site'>How to Add a Blog in a BoldGrid Site</a></div><div>2. <a style='display:inline;' href='/support/edu/boldgrid/intermediate-topics/deploy-staging'>How to Make Your Staging Site Live in BoldGrid</a></div><div>3. <a style='display:inline;' href='/support/edu/boldgrid/intermediate-topics/creating-sitemap'>How to Create a sitemap in WordPress using Yoast</a></div><div>4. <a style='display:inline;' href='/support/edu/boldgrid/intermediate-topics/active-staging'>Active vs Staging</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to Create a sitemap in WordPress using Yoa...</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to Create a sitemap in WordPress using Yoast									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>170</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jul 31, 2015'><span style='color:#606060;'>Published:</span> Aug 14, 2015</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In this tutorial we will show you how to <strong>generate a sitemap</strong> in <strong>WordPress</strong> using the Yoast plugin. This plugin is very popular<em>it automatically creates XML sitemaps and notifies Google & Bing of the sitemaps existence.</em></p>

<a name="install-yoast"></a>
<h2>Installing the Yoast plugin</h2>
<ol class="article_list">
<li><a href="/support/edu/wordpress/wordpress-introduction/logging-into-wordpress-dashboard">Login to WordPress</a>.</li>
<li>Roll your mouse over <strong>Plugins</strong>, then click <strong>Add New</strong>.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/boldgrid/create-sitemap/wordpress-plugins-add-new.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/edu/boldgrid/create-sitemap/wordpress-plugins-add-new.png" alt="Install WordPress Plugin" title="Adding a new plugin in WordPress" /></a></li>
<li>In the search box, type yoast, then click <strong>Enter</strong>.</li>
<li>You will see <em>Yoast SEO</em> listed. Click the <strong>Install Now</strong> button.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/boldgrid/create-sitemap/installing-yoast-plugin.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/edu/boldgrid/create-sitemap/installing-yoast-plugin.png" alt="Adding Yoast in BoldGrid for WordPress" title="Install Yoast Plugin for WordPress" /></a></li>
<li>On the next screen, click the <strong>Activate Plugin</strong> button.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/boldgrid/create-sitemap/activate-yoast-plugin.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/edu/boldgrid/create-sitemap/activate-yoast-plugin.png" alt="BoldGrid Sitemap Yoast" title="Activating Yoast Plugin for WordPress" /></a></li><br>
</ol>



<a name="create-sitemap"></a>
<h2>Creating a SiteMap</h2>
<ol class="article_list">
<li><a href="/support/edu/wordpress/wordpress-introduction/logging-into-wordpress-dashboard">Login to WordPress</a>.</li>
<li>In your Admin menu, click <strong>SEO</strong>, then click <strong>XML Sitemaps</strong>.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/boldgrid/create-sitemap/seo-yoast-xml-sitemaps.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/edu/boldgrid/create-sitemap/seo-yoast-xml-sitemaps.png" alt="Creating a WordPress Sitemap" title="SEO Yoast Sitemaps" /></a></li>
<li>You will see a message stating "<em>Check this box to enable XML sitemap functionality</em>." Make sure this box is checked.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/boldgrid/create-sitemap/enable-xml-sitemap-functionality.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/edu/boldgrid/create-sitemap/enable-xml-sitemap-functionality.png" alt="XML Sitemap creating in BoldGrid using Yoast" title="Enable sitemap functionality" /></a><br><br>

You can also find your Sitemap, by clicking the <strong>XML Sitemap</strong> button.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/boldgrid/create-sitemap/xml-sitemap-button-yoast-wordpress.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/edu/boldgrid/create-sitemap/xml-sitemap-button-yoast-wordpress.png" alt="Creating XML Sitemap in Yoast for BoldGrid" title="XML Sitemap button" /></a></li>
<li>Click the <strong>Save Changes</strong> button when you are finished.</li>
</ol>
<br>

<p>Congratulations, now you know how to <strong>generate a sitemap</strong> in <strong>WordPress</strong> using the Yoast plugin!</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/boldgrid/intermediate-topics'>Intermediate Topics</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 3: How to Create a sitemap in WordPress using Yoast</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 2: <a href='/support/edu/boldgrid/intermediate-topics/how-to-add-a-blog-in-a-boldgrid-site'>How to Add a Blog in a BoldGrid Site</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/boldgrid/intermediate-topics/creating-sitemap&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/boldgrid/intermediate-topics/creating-sitemap'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD01MzgmaWQ9MzYyNyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/boldgrid/intermediate-topics?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Topics</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/boldgrid/intermediate-topics/how-to-add-a-blog-in-a-boldgrid-site?tsrc=rsbedu'>How to Add a Blog in a BoldGrid Site</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/boldgrid/intermediate-topics/deploy-staging?tsrc=rsbedu'>How to Make Your Staging Site Live in BoldGrid</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/boldgrid/intermediate-topics/creating-sitemap?tsrc=rsbedu'>How to Create a sitemap in WordPress using Yoast</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/boldgrid/intermediate-topics/active-staging?tsrc=rsbedu'>Active vs Staging</a></td>
                </tr>
          	</table>
