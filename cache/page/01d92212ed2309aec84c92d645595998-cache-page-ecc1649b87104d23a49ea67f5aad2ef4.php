<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:61114:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/prestashop-15/configure-checkout/changing-order-processing-type" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-08-24T13:03:46-07:00" />
  <meta name="keywords" content="order process type Prestashop 1.5 edit" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="This Prestashop 1.5 article will explain how to change the order process type for how your customers check out." />
  <title>Changing the Order Process Type in PrestaShop 1.5 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/prestashop-15/configure-checkout/changing-order-processing-type" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:c823c75ac1218d28c14164fff09ddead -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '78.159.138.73']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Changing the Order Process Type in PrestaShop 1.5									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>13,075</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jun 5, 2012'><span style='color:#606060;'>Published:</span> Aug 24, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>When configuring your PrestaShop 1.5, there are several <a href="/support/edu/prestashop-15/configure-checkout">checkout settings</a> that you can configure. One of these is the <strong>order process type</strong>. This is how the order process is presented to the customer when they are ready to buy your products and go through the check out. The order processing type has two options; either a five step process (one step per page) or a single order processing form.</p>
<p> </p>
<h2>What is the checkout process like for customers?</h2>
<p>Regardless of which checkout option you choose, your users will go through the follow steps during checkout:</p>
<ol class="article_list">
<li><strong>Addresses</strong><br />This is where the user will configure their billing address and delivery address.</li>
<li><strong>Delivery Methods</strong><br />The user will select their preferred shipping option and whether or not they want the items gift wrapped.</li>
<li><strong>Payment Method</strong><br />The user will decide how they will pay for their products, such as by check or credit card.</li>
<li><strong>Order Summary</strong><br />The user will see a summary of their total purchase price and their payment method, and they will be asked to confirm their order.</li>
<li><strong>Order Confirmation</strong><br />The user will see a confirmation message stating their order has gone through.</li>
</ol>
<p> </p>
<h2>To configure either the one page or five page checkout option:</h2>
<ol class="article_list">
<li><a href="/support/edu/prestashop-15/getting-started/login-to-dashboard">Log into your PrestaShop 1.5 dashboard.</a></li>
<li>Using the top menu bar, hover over the <strong>Preferences </strong>tab and select the <strong>Orders </strong>option.</li>
<li>From the <strong>Preferences : Orders</strong> screen, find the <strong>Order process type</strong> field and select your desired option from the dropdown menu. They are:<br /> 
<table class="article_table">
<tbody>
<tr>
<th>Standard (5 steps)</th>
<td>breaks the order process into 5 separate steps</td>
</tr>
<tr>
<th>One Page Checkout </th>
<td>makes the checkout process an all-in-one page</td>
</tr>
</tbody>
</table>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/preferences-order-order-process-type/preferences-orders-order-processs-type.png"><img  alt="preferences-orders-order-processs-type" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/preferences-order-order-process-type/preferences-orders-order-processs-type.png" /></a></li>
<li>Once finished, click on the <strong>Save </strong>button in the upper right corner of the screen.</li>
</ol>
<p>You have now edited the Order process type in PrestaShop 1.5!</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/prestashop-15/configure-checkout'>108: Configuring the Checkout Process in PrestaShop 1.5</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 1: Changing the Order Process Type in PrestaShop 1.5</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 2: <a href='/support/edu/prestashop-15/configure-checkout/edit-guest-checkout'>How to edit the Guest Checkout option in Prestashop 1.5</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/prestashop-15/configure-checkout/changing-order-processing-type&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/prestashop-15/configure-checkout/changing-order-processing-type'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yMzUmaWQ9MTQwMCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/prestashop-15/configure-checkout?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Configuring the Checkout Process in PrestaShop 1.5</h3></a>
		<table>  <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/prestashop-15/configure-checkout/changing-order-processing-type?tsrc=rsbedu'>Changing the Order Process Type in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/prestashop-15/configure-checkout/edit-guest-checkout?tsrc=rsbedu'>How to edit the Guest Checkout option in Prestashop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/prestashop-15/configure-checkout/set-minimum-purchase-requirement?tsrc=rsbedu'>How to set a minimum purchase in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/prestashop-15/configure-checkout/allowing-multiple-shipping-addresses?tsrc=rsbedu'>Allowing multiple shipping addresses in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/prestashop-15/configure-checkout/setting-delayed-shipping?tsrc=rsbedu'>Setting Delayed Shipping in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/prestashop-15/configure-checkout/setting-terms-of-service-rule?tsrc=rsbedu'>Setting the Terms of Service rule in PrestaShop 1.5</a></td>
                </tr>
          	</table>
