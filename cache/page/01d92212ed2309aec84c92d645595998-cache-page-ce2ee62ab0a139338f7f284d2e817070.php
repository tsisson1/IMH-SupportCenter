<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:69573:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-25/backups/akeeba-restore-using-kickstart" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-08-27T17:36:41-07:00" />
  <meta name="keywords" content="akeeba kickstart backup restore restoration angie next generation installer engine" />
  <meta name="author" content="Arnel Custodio" />
  <meta name="description" content="The following article shows how to use the Akeeba Kickstart application to restart.  It uses ANGIE (Akeeba Next Generation Installer Engine) to automate the processes.  You will learn how to restore the Akeeba backup and where to make the appropriate settings changes." />
  <title>Using Akeeba Kickstart to Restore a Backup - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-25/backups/akeeba-restore-using-kickstart" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<script type="text/javascript">
		...
		_gaq.push(['_setCustomVar', 3, 'DateMonthModified', '2013-08', 3]);
	...
	<!-- cid:56c71ecce370340b0533082460a34d90 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-20']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '185.20.238.52']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Using Akeeba Kickstart to Restore a Backup									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>6,634</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Aug 27, 2013'><span style='color:#606060;'>Published:</span> Aug 27, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/akeeba-restore/base-akeeba-page.png"><img style="float: right; margin: 0px 0px 15px 15px;"  src="//cdn.inmotionhosting.com/support/images/stories/edu/akeeba-restore/base-akeeba-page.png" alt="Akeeba backup manager" width="100" /></a>If you need to review your backups, go to the Akeeba Backup by clicking on the <strong>COMPONENTS</strong> menu item near the top of the screen.  Then click on <strong>Akeeba Backup</strong>. Here you can manage the backups that have been made with Akeeba. You can also <a href="http://www.inmotionhosting.com/support/edu/joomla-25/backups/creating-your-first-akeeba-backup" target="new">create a backup from this point</a>.</p><div style="clear:both;"></div>


<h2>Restoring a Joomla Backup from Akeeba</h2>
<p>Before you begin the restoration, make sure to review the following checklist.  You should know these items <em>BEFORE</em> you restore your backup.</p>
<div style="background-color: #FAFAD2; border: 1px #D3D3D3 dashed; border-radius: 5px; padding: 0px 0px 0px 5px; margin-top: 20px;">
<p>Caution: Be aware of the version of Joomla you are restoring; may require a specific version of PHP (for example:  Joomla 1.5 requires PHP 5.2).  </p>
</div><div style="clear:both;"></div>
<ul>
<li>Are you restoring over top of an existing Joomla installation? The simplest restore using Akeeba is to replace the existing installation without changing any of the settings.</li>
<li>Do you know the database user and password? If you are moving the database to a new host, then you will need to makes sure the user name and password meet the host's requirements.</li>
<li>Do you know the Admin password? The Super settings require that you enter the password</li>
<li>Directory location (only if the restore is occurring in a differen directory)</li>
<li>Did you download Kickstart from Akeeba? </li>
<li>If you are working in  different language, you will need the language file included with the Kickstart files.</li>
</ul>
<p></p>
<p></p>
<ol class="article_list">
<li>Obtain your backup file from Akeeba and make sure that it's at the root of the directory where you are going to restore it.  If you're restoring over top of another installation, then the compressed file should be in root directory of the Joomla installation.</li>
<li>Copy your <strong>KICKSTART.PHP</strong> file into the directory where you are restoring the backup. If you're working in a different language, make sure to also copy the corresponding language file(s).</li>
  
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/akeeba-restore/akeeba-kickstart.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="200" src="//cdn.inmotionhosting.com/support/images/stories/edu/akeeba-restore/akeeba-kickstart.png" alt="Akeeba Kickstart notes" align="right" ></a>Run the URL based on the Kickstart file and location.  For example:  http://domain_name.com/joomla-backup-folder/kickstart.php.  You will see a warning screen labeled "Things you should know about Akeeba Kickstart."  Make sure that youre backup is in the same folder as the kickstart file.  Please make sure to read through the warnings.<br style="clear: both;" /></li>

<li>Click on ESC or the link to close the message.</li> 
  
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/akeeba-restore/akeeba-backup-restore-start-1.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="200" src="//cdn.inmotionhosting.com/support/images/stories/edu/akeeba-restore/akeeba-backup-restore-start-1.png" alt="ANGIE-Akeeba Next Generation Installer Engine" align="right" /></a>You should see the <strong>ANGIE</strong>(Akeeba Next Generation Installer Engine) Pre-installation check running before you start the restoration.  Once you review all of the settings here, click on the blue button that labeled NEXT.<div style="clear:both;"></div></li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/akeeba-restore/akeeba-restore-2.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="200" src="//cdn.inmotionhosting.com/support/images/stories/edu/akeeba-restore/akeeba-restore-2.png" alt="Database restoration settings" align="right" /></a>The next step is the <strong>DATABASE RESTORATION</strong> phase.  You will see all of the setting for the database that you can change here.  Make sure these setting match with your current restore.  If you're restoring an Akeeba database from a different host, then you need to double-check the name conventions used by the host for their databases.  You might need to change them.  For example, InMotion Hosting uses database names that start with the account user name:  username5_databasename  or username5_dbusername.<div style="clear:both;"></div></li>

<li>Once you have reviewed your DB settings, click on <strong>NEXT</strong> in order to proceed.  </li>
  
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/akeeba-restore/database-restore-success.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="200" src="//cdn.inmotionhosting.com/support/images/stories/edu/akeeba-restore/database-restore-success.png" alt="Database Restore successful" align="right" /></a>When the database restoration is complete, you will see a confirmation of this.  Click on the green button labeled <strong>NEXT STEP</strong>.<div style="clear:both;"></div></li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/akeeba-restore/akeeba-restore-3-after-db.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="200" src="//cdn.inmotionhosting.com/support/images/stories/edu/akeeba-restore/akeeba-restore-3-after-db.png" alt="Site Settings" align="right" /></a>The next phase of the restoration is called <strong>SITE SETTINGS</strong>.  Again, as in the database section, you need to make sure that your user name, password and other site settings are setup the way you want them.  This section is where you would change the directory settings if they are different from the previous installation when you did the backup.  Click on the blue <strong>NEXT</strong> button to continue.<div style="clear:both;"></div></li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/akeeba-restore/akeeba-restore-completed-final.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="200" src="//cdn.inmotionhosting.com/support/images/stories/edu/akeeba-restore/akeeba-restore-completed-final.png" alt="Restoration warnings" align="right" /></a>You will then get a completion screen with a warning reminding you of the possible differences if you're moving a restoration between servers.  Click on the remove installation folder.<br style="clear: both;" /></li>
 
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/akeeba-restore/akeeba-kickstart-cleanup.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="200" src="//cdn.inmotionhosting.com/support/images/stories/edu/akeeba-restore/akeeba-kickstart-cleanup.png" alt="Akeeba Restoration and Clean Up" align="right" /></a>You will then see a screen labeled "6- Restoration and Clean Up." Click on the green button.<br style="clear: both;" /></li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/akeeba-restore/akeeba-kickstart-37-after-cleanup.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="200" src="//cdn.inmotionhosting.com/support/images/stories/edu/akeeba-restore/akeeba-kickstart-37-after-cleanup.png" alt="Links to front end and backend" align="right" ></a>Your restore is now complete!  The last screen allows you to view the front end and backend of the site in order to see if it's working.  It also provides you a link in case something has gone wrong with the restoration.<br style="clear: both;" /></li>  
</ol>

<p>That completes the restoration steps for Akeeba's Kickstart application.  Remember to make use of their documentation and videos if you have any questions regardsing the settings or operation of the Kickstart program.  For information on the creating a backup with Akeeba, go to <a href="http://www.inmotionhosting.com/support/edu/joomla-25/backups" target="new">Joomla Backups Education Channel</a>.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/joomla-25/backups'>206: Backing up your Joomla 2.5 website</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 5: Using Akeeba Kickstart to Restore a Backup</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 4: <a href='/support/edu/joomla-25/backups/download-your-akeeba-backup'>Joomla 2.5 backup - Downloading a copy of your Akeeba Backup</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-25/backups/akeeba-restore-using-kickstart&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-25/backups/akeeba-restore-using-kickstart'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xOTQmaWQ9MjgxOCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="002f976430ec5c4e289858d7c3da7b7a" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/joomla-25/backups?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Backing up your Joomla 2.5 website</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/joomla-25/backups/install-akeeba-backup?tsrc=rsbedu'>Joomla 2.5 Backup - Installing Akeeba Backup</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/joomla-25/backups/akeeba-backup-post-installation-configuration?tsrc=rsbedu'>Joomla 2.5 backup - Akeeba Backup Post-installation configuration</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/joomla-25/backups/creating-your-first-akeeba-backup?tsrc=rsbedu'>Joomla 2.5 backup - Creating your first Akeeba Backup</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/joomla-25/backups/download-your-akeeba-backup?tsrc=rsbedu'>Joomla 2.5 backup - Downloading a copy of your Akeeba Backup</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/joomla-25/backups/akeeba-restore-using-kickstart?tsrc=rsbedu'>Using Akeeba Kickstart to Restore a Backup</a></td>
                </tr>
          	</table>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/41053236c2aa6230206e62629d27d62a?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/41053236c2aa6230206e62629d27d62a'>kanchan</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-05-12 1:09 am</div>
				                <div><p>Dear sir/madam,</p>
<p>i am using joomla 1.5 i have downloaded my website backup file (.jpa extension) using Akeeba now want to restore my site another PC.So i want kickstart for joomla 1.5.plz provide me suitable kickstart.</p>
<p>&nbsp;</p>
<p>Thank you</p>
<p>Ms. Kanchan Sonawane</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23341);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-05-12 8:26 am</div>
				                <div>Hello Kanchan,<br />
<br />
The kickstart.php file is provided from your Akeeba backup software. Also <a href="https://www.akeebabackup.com/products/akeeba-kickstart.html">this page</a> may help you get the files you need as well.<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23353);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
