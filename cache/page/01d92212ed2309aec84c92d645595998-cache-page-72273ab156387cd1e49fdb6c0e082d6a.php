<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:59858:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/smf/forum-management/censored-words" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-12-21T20:12:58-08:00" />
  <meta name="keywords" content="censored word list SMF 2.0" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Learn to create and add to your censored word list in this SMF 2.0 tutorial." />
  <title>How to configure your SMF 2.0 censored words list - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/smf/forum-management/censored-words" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:bb7a874571fe34955e2fd3005f9793b2 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '113.142.228.152']);
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/smf' itemprop='url'><span itemprop='title'>SMF<span></a><div class='dropdown_4columns'><h2>SMF Education Channel</h2><div class='col_2'><h3>100 Level Classes</h3><div><a href='/support/edu/smf/getting-started-smf'>101: Getting Started in SMF</a></div><div><a href='/support/edu/smf/forum-management'>102: Managing your Forums in SMF 2.0</a></div><div><a href='/support/edu/smf/managing-users'>103: Managing Users in SMF 2.0</a></div></div><div class='col_2'><h3>200 Level Classes</h3><div><a href='/support/edu/smf/forum-maintenance'>201: Forum maintenance for SMF 2.0</a></div><div><a href='/support/edu/smf/administration'>202: General Administration in SMF 2.0</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/smf/forum-management' itemprop='url'><span itemprop='title'>102: Managing your Forums in SMF 2.0<span></a><div class='dropdown_3columns'><h2> Managing your Forums in SMF 2.0</h2><div class='col_3'><div>1. <a style='display:inline;' href='/support/edu/smf/forum-management/post-settings'>Editing your SMF 2.0 post settings</a></div><div>2. <a style='display:inline;' href='/support/edu/smf/forum-management/new-forum'>How to create a new forum in SMF 2.0</a></div><div>3. <a style='display:inline;' href='/support/edu/smf/forum-management/manage-categories'>How to manage Categories in SMF 2.0</a></div><div>4. <a style='display:inline;' href='/support/edu/smf/forum-management/topic-settings'>How to modify your SMF 2.0 Topic settings</a></div><div>5. <a style='display:inline;' href='/support/edu/smf/forum-management/bbcode-settings'>Editing your SMF 2.0 Bulletin Board Code settings</a></div><div>6. <a style='display:inline;' href='/support/edu/smf/forum-management/censored-words'>How to configure your SMF 2.0 censored words list</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to configure your SMF 2.0 cens...</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to configure your SMF 2.0 censored words list									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>1,464</span></div>
							...
							<div style='clear:both;'></div>
								...
								<p>While administering your online community in SMF 2.0, you may want to add some words to a censor list. This prevents users from offending each other or posts possibly getting indexed by search engines under words you do not want them to. Using the instructions below, you will learn how to create your censored words list in the SMF 2.0 back office.</p>
<h2>Creating your censored words list</h2>
<ol class="article_list">
<li><a href="/support/edu/smf/getting-started-smf/smf-admin-login">Log into your SMF admin dashboard</a>.</li>
<li>From the entry page, click <strong>Admin</strong> from the upper menu. This will reveal a second menu just underneath the first. Hover over <strong>Forum</strong> and click on <strong>Posts and Topics</strong> from the popup submenu.</li>
<li>You are now on the <em>Manage Posts and Topics</em> screen. From the page menu, click on the <strong>Censored Words</strong> option.</li>
<li>This brings you to the <em>Censored Words</em> list page.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/smf/forums/censored-words/censored-words-section.png"><img  alt="censored-words-section" src="//cdn.inmotionhosting.com/support/images/stories/edu/smf/forums/censored-words/censored-words-section.png" /></a><br />When adding a new word, place the word you want to be replaced in the left hand field and the word you want to replace it with in the right field. In our example, we want to replace the word 'jerk' with the words 'silly person'. There are two options to consider when configuring the censored words.<br />
<table class="article_table">
<tbody>
<tr><th>Check only whole words</th>
<td>Checks only whole words. For example, if this option is selected then the word 'jerky' will not be censored.</td>
</tr>
<tr><th>Ignore case when censoring</th>
<td>When checked, the targeted word will be censored regardless of case.</td>
</tr>
</tbody>
</table>
</li>
<li>You may add additional words by clicking the link entitled <strong>Click here to add another word</strong>. Once you have added your words, click on the <strong>Save</strong> button to ensure the words are added to the list.</li>
<li>You may test your words on the screen by entering the targeted word in the text field and click the <strong>Test</strong> button. The screen should refresh with the replacement word in the text box.</li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/smf/forum-management'>102: Managing your Forums in SMF 2.0</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 6: How to configure your SMF 2.0 censored words list</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 5: <a href='/support/edu/smf/forum-management/bbcode-settings'>Editing your SMF 2.0 Bulletin Board Code settings</a>
								</td>
...
<div style='display:inline-block;'>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP3RzcmM9cnNiZWR1Jm9wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMDgmaWQ9MjEwOSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="63d4846d3b0a468dd78a14595429aa4f" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/smf/forum-management?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Managing your Forums in SMF 2.0</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/smf/forum-management/post-settings?tsrc=rsbedu'>Editing your SMF 2.0 post settings</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/smf/forum-management/new-forum?tsrc=rsbedu'>How to create a new forum in SMF 2.0</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/smf/forum-management/manage-categories?tsrc=rsbedu'>How to manage Categories in SMF 2.0</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/smf/forum-management/topic-settings?tsrc=rsbedu'>How to modify your SMF 2.0 Topic settings</a></td>
                </tr>
          <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/smf/forum-management/bbcode-settings?tsrc=rsbedu'>Editing your SMF 2.0 Bulletin Board Code settings</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/smf/forum-management/censored-words?tsrc=rsbedu'>How to configure your SMF 2.0 censored words list</a></td>
                </tr>
          	</table>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/4a294e4bb15cb03b1686ecd63b018bdf?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/4a294e4bb15cb03b1686ecd63b018bdf'>CrazyBoy</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-11 11:20 am</div>
				                <div><p>Thanks, but how to remove the words from the list?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9642);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-11 11:58 am</div>
				                <div>Hello CrazyBoy,<br />
<br />
Thank you for your question. In my tests, I was able to remove the words by bringing up the censored word list,deleting the text from the boxes, then clicking the <strong>Save</strong> button.<br />
<br />
If you have any further questions, feel free to post them below.<br />
Thank you,<br />
<br />
-John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9647);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
