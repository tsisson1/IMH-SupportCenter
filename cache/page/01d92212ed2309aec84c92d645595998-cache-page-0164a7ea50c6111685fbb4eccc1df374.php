<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49866:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/website/our-web-sitexoloin-redirecting" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, You will want to check two things that usually control the https functionality in your site. First, since the site is made with Drupal, you will ..." />
  <title>our web site(xolo.in) redirecting | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/website/our-web-sitexoloin-redirecting" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:3f7b104594b8b5cd11a3a9ca3394efee -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>our web site(xolo.in) redirecting</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='https://lh5.googleusercontent.com/-PZiNmkzG3wg/AAAAAAAAAAI/AAAAAAAAASI/ra-o_yaU9Iw/photo.jpg?sz=90' class='user_avatar' /><br />
			<a href='/support/community-support/users/giit&per;vivek'>giit.vivek</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2014-06-27 4:44 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>33</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Hi All,<br />
Actually the problem is, We have a website of our company. When we normally try to open the website by its name, e.g xolo.in it directly redirects to https:// and even if i type full address http://xolo.in it again redirects the page to https://xolo.in......<br />
So I want to correct that. When I open http://xolo.in it should go to http://xolo.in and when i open https://xolo.in it should go to https://xolo.in only....<br />
How can we correct this.....Please suggest....</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_5172' id='upvote_answer_5172' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='5172' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_5172').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_5172' id='downvote_answer_5172' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='5172' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_5172').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
You will want to check two things that usually control the https functionality in your site.  First, since the site is made with Drupal, you will want to check the sites/settings.inc file to see if there is a $conf['https'] = TRUE; line in there. If so, you can remove it.<br />
<br />
Second, check the .htaccess file and see if there is a redirect line for https:. If so, comment that out or remove it.<br />
<br />
Kindest Regards,<br />
Scott M<br />
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_5172').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_5172' id='form_comment_on_answer_5172' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/website/our-web-sitexoloin-redirecting&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/website/our-web-sitexoloin-redirecting'></div>
<script type='text/javascript'>
  (function() {
