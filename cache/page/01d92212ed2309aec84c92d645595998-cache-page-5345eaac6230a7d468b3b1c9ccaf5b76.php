<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:51659:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/cpanel/cannot-install-apachegeoip-199-in-cpanel" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Thank you for your question ejbang! Sorry for the trouble with the Apache::GeoIP modules not installing on your server. The available Perl modules are l..." />
  <title>Cannot install Apache::GeoIP (1.99) in cPanel | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/cpanel/cannot-install-apachegeoip-199-in-cpanel" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:d32bb92e3c14a32ec2988cdc95701243 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Cannot install Apache::GeoIP (1.99) in cPanel</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/ejbang'>ejbang</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-01-02 4:17 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>1,068</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I have trouble in installing Apache::GeoIP (1.99) perl module in cPanel.<br />
Here are steps to reproduce the problem.<br />
1. I log in AMP.<br />
2. I link to cPanel.<br />
3. I link to Perl Module Installer.<br />
4. I click [Show Available Perl Module(s).<br />
5. I browse Apache::GeoIP (1.99) perl module and click [Install] button of Apache::GeoIP (1.99).<br />
<br />
then it is not installed saying as below:<br />
...<br />
CPAN: File::Temp loaded ok (v0.22)<br />
CPAN: Parse::CPAN::Meta loaded ok (v1.4401)<br />
CPAN: CPAN::Meta loaded ok (v2.112621)<br />
<br />
  CPAN.pm: Building R/RK/RKOBES/Apache-GeoIP-1.99.tar.gz<br />
<br />
perl-64bit-hack: enabled<br />
Please install either mod_perl 1 or mod_perl 2 first at Makefile.PL line 118.<br />
No 'Makefile' createdCPAN: YAML loaded ok (v0.77)<br />
  RKOBES/Apache-GeoIP-1.99.tar.gz<br />
  /usr/local/cpanel/scripts/cpan_sandbox/x86_64/perl Makefile.PL PREFIX=/home/senaco5/perl/usr OTHERLDFLAGS=-L/usr/lib64 LDFLAGS=-L/usr/lib64 EXTRALIBDIR=/usr/lib64 -- NOT OK<br />
...
perlmod--Install done<br />
<br />
Would you tell me how to install it?<br />
<br />
Thanks.</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_2053' id='upvote_answer_2053' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='2053' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_2053').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_2053' id='downvote_answer_2053' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='2053' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_2053').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>5,889 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2013-01-02 11:31 am EST
                		        </div>
					
		                </div>

				Thank you for your question ejbang!<br />
<br />
Sorry for the trouble with the Apache::GeoIP modules not installing on your server. The available Perl modules are listed to show &quot;Existing&quot; modules; however, not all of the modules are supported on the Shared server platform. mod_perl  will need to be installed on the server; unfortunately, this cannot be installed on our shared server environment. We do apologize for this. You can upgrade to a VPS or Dedicated server to have mod_perl installed. Sorry for the trouble.<br />
<br />
Best Regards,<br />
James R
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_2053').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_2053' id='form_comment_on_answer_2053' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/cpanel/cannot-install-apachegeoip-199-in-cpanel&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/cpanel/cannot-install-apachegeoip-199-in-cpanel'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="dd87d44c88b09af4ef554385a0216a19" value="1" />	</div>
	</form>
<!-- <br />
