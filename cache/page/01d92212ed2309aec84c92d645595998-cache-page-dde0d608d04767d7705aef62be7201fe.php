<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:73022:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-3/308-redirect-manager" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-10-16T16:40:17-07:00" />
  <meta name="keywords" content="joomla 3.0 redirect manager 404" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="Using the Redirect Manager in Joomla 3.0 is an easy way to monitor and manage 404 pages in your website." />
  <title>308: Using the Redirect Manager in Joomla 3.1 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-3/308-redirect-manager" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:c2e150b937864772bc4aa91a0cd6dfd8 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '84.253.153.158']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															308: Using the Redirect Manager in Joomla 3.1									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>16,008</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Oct 16, 2012'><span style='color:#606060;'>Published:</span> Oct 16, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Joomla 3.0 includes a <em>component</em> named <strong>Redirect Manager</strong>. The <em>Redirect Manager</em> helps you identify URLs that your visitors are accessing that don't actually exist, pages that return a <strong>404 not found</strong> status.</p>
<p>&nbsp;</p>
<h2>Know your 404 pages</h2>
<p>It is important to eliminate 404 pages for several reasons, two of them being:</p>
<ol>
<li><strong>Usability</strong> - You may have visitors trying to reach a popular page of yours that either has been deleted or moved, and you have the potential of losing readers if they can't find what it is they're looking for.</li>
<li><strong>Search Engine Optimization</strong> - Search engines expect for websites to move pages around or delete them. Having an excessive number of these types of pages however may cause some search engines to penalize your site.</li>
</ol>
<p>&nbsp;</p>
<h2>How to Redirect pages with the Redirect Manager</h2>
<p>The Redirect manager in Joomla 3.0 allows you to see what URLs users are accessing on your site that don't exist. For example, on our Joomla 3.0 website, the following URL does not exist: <em>http://domain.com/this-page/does-not/exist</em></p>
<p>When we access that page, the Redirect Manager will log the for us the fact that someone visited that URL and got a 404 page. It will also give us the ability to automatically redirect users that visit that URL to another page, such as <strong>/index.php/7-my-first-blog-post</strong>. In this tutorial, we'll show you how to do just that.</p>
<p>&nbsp;</p>
<h2>To redirect a page with the Joomla 3.0 Redirect Manager:</h2>
<ol class="article_list">
<li><a href="/support/edu/joomla-3/getting-started/login-dashboard">Log into your Joomla 3.0 Admin Dashboard</a></li>
<li>In the top menu, click <strong>Components</strong> and then click <strong>Redirect</strong></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/components/redirect/click-url-you-want-to-redirect.jpg"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="click-url-you-want-to-redirect" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/components/redirect/click-url-you-want-to-redirect.jpg" /></a>On this page you will see a list of bad URLs that Joomla has logged for you. Click the URL that you would like to setup a redirect for.
<div style="clear: both;">&nbsp;</div>
</li>
<li>There are a few things you can input for this redirect, but we will enter only the essentials, the Destination URL and Status.<br /><br /><strong><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/components/redirect/configuring-our-new-redirect.jpg"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="configuring-our-new-redirect" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/components/redirect/configuring-our-new-redirect.jpg" /></a>Destination URL</strong><br /><em>Enter here the URL to be redirected to.</em><br /><br />In our testing, we entered http://domain.com/index.php/7-my-first-blog-post as the destination URL.<br /><br /><strong>Status</strong><br /><em>Set publication status.</em><br /><br />Change status from <em>Disabled</em> to <strong>Enabled</strong>.<br /><br />After entering the full URL to redirect to and updating the status, click <strong>Save</strong> in the top left of the page.<br /><br />Now you can test your new redirect! In our testing, when we go to:<br /><em>http://domain.com/this-page/does-not/exist</em><br />...we are automatically redirected to:<br /><em>http://domain.com/index.php/7-my-first-blog-post</em>
<div style="clear: both;">&nbsp;</div>
</li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 35: 308: Using the Redirect Manager in Joomla 3.1</div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-3/308-redirect-manager&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-3/308-redirect-manager'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xMDEmaWQ9MjQwMyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="8bab629c410604b5e79a085d1e61012c" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/9b3c7d0cdd115f705ae04f7df5982d2c?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/9b3c7d0cdd115f705ae04f7df5982d2c'>Hi there!</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-04 7:25 pm</div>
				                <div><p>Everytime I click on the logo of my website, I get this:&nbsp;</p>
<h1 style="font-family: 'Times New Roman';">Not Found</h1>
<p style="font-family: 'Times New Roman'; font-size: medium;">The requested URL (address)&nbsp;was not found on this server.</p>
...
Apache Server at www.xxxxxxx.xx&nbsp;Port 80&nbsp;&nbsp;What can I do to fix this? Cause I think the abovementioned explanation is not relevant for this problem, or is it?</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9419);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-04 7:37 pm</div>
				                <div>Hello,<br />
<br />
Thanks for the question.  Generally, if you're getting a 404, you should double-check to make sure that the file is actually there and if the path being used to reference that file is correct.  The article above is used for re-directs when you have a path change that is required because a Joomla page has been replaced or changed so that the previous URL is no longer available or valid.  In this case, since it appears to be a graphic, then you most likely will not need to create a re-direct. You should check to make sure that the path and file are good.  Remember also that  the file and path name is case sensitive on InMotion Hosting servers.  <br />
<br />
I hope that helps to resolve your issue!  If you require further assistance, then please provide more specific information so that we can continue investigating the problem.<br />
<br />
Regards,<br />
Arnel C. </div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9420);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-11273'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/e8405a4e1570fb385687c9ad05dacc03?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/e8405a4e1570fb385687c9ad05dacc03'>Penn</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-09 11:05 am</div>
				                <div><p>The problem I have found with using the redirect manager is that at the end of the day, you've got 10 pages of URLs that you've then got to delete. Is there any way around this?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11273);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-09 1:34 pm</div>
				                <div>Hello Penn,<br />
<br />
Thank you for your question. I recommend taking a look at the URL's to see if you can determine the origin, or nature of them. You could also review the apache logs for a specific referrer or user agents.<br />
<br />
For example, if you are being crawled by bots, it can generate a lot of bad URL's. Adding a <a href="http://www.inmotionhosting.com/support/website/restricting-bots/how-to-stop-search-engines-from-crawling-your-website">robots.txt</a> file could block bots that are causing the issue.<br />
<br />
If it is too much of a problem, you could also disable the redirect manager.<br />
<br />
If you have any further questions, feel free to post them below.<br />
Thank you,<br />
<br />
-John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11284);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-09 3:13 pm</div>
				                <div><p>That there is no way that I am searching through each URL, It will take me a month of Sundays, it generates over 1000 in just a few hours. I have disabled it now, I just can't be doing with it, it's far too much trouble.</p>
<p>Thanks for the advice though, I will look for something else that I can use to redirect URLs after I have restructured my menu</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11294);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-17540'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/83c55fdfb44040d4cb118a0eceba366c?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/83c55fdfb44040d4cb118a0eceba366c'>FLora</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-18 6:46 am</div>
				                <div><p>Hi,&nbsp;</p>
<p>I am using Joomla redirect to try and redirect old pages, we revamped our site and changed servers. &nbsp;However the pages do not redirect.&nbsp;</p>
<p>&nbsp;</p>
<p>I have followed every step. I tried usitn .htacees as well. And there was nothing.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17540);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-18 9:57 am</div>
				                <div>If you have made the changes outlined in this article and did not see a change, you may simply have a caching issue.  Try &lt;a href=&quot;http://www.inmotionhosting.com/support/website/how-to/clear-browser-cache&quot;&gt;clearing your browser cache&lt;/a&gt;.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17551);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
