...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/boldgrid/getting-started/add-new-pages" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-12-24T16:20:04-08:00" />
  <meta name="keywords" content="Add Pages BoldGrid WordPress" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Learn how to Add new Pages to your BoldGrid for WordPress site." />
  <title>How to Add new Pages in BoldGrid - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/boldgrid/getting-started/add-new-pages" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:268ddd8866159a963a0fe6649fa072b6 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to Add new Pages in BoldGrid									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>284</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Aug 14, 2015'><span style='color:#606060;'>Published:</span> Dec 24, 2015</div>
							...
							<div style='clear:both;'></div>
								...
								<center><iframe width="560" height="315" src="https://www.youtube.com/embed/hQLtoJBtSXY" frameborder="0" allowfullscreen></iframe></center>
<p>Once you have finished <a href="/support/edu/boldgrid/getting-started/install-inspiration">installing your Inspiration</a> you may find that you still want to add more pages to your BoldGrid site. This article will demonstrate how to further customize your site by adding additional pages to your current theme.
</p>

<h2>Adding Additional Pages</h2>

<ol class="article_list">
  <li><a href="/support/edu/boldgrid/getting-started/how-to-login">Log into your BoldGrid dashboard.</a><div style="clear:both;"></div></li>
  
    <li>Click on the <strong>Pages</strong> option from the left hand menu.<div style="clear:both;"></div></li>
  
    <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/boldgrid/add-pages/1-click-add-new.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="Click on the Add New link" src="//cdn.inmotionhosting.com/support/images/stories/boldgrid/add-pages/1-click-add-new.png" title="Click here to view the larger image" width="" /></a>Next, click on the <strong>Add New</strong> option.<div style="clear:both;"></div></li>
  
    <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/boldgrid/add-pages/2-title-page.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="Give the page a title" src="//cdn.inmotionhosting.com/support/images/stories/boldgrid/add-pages/2-title-page.png" title="Click here to view the larger image" width="200" /></a>Once the blank page comes up you will want to give it a name.<div style="clear:both;"></div></li>
  
    <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/boldgrid/add-pages/3-click-add-media.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="Click on the Add Media button." src="//cdn.inmotionhosting.com/support/images/stories/boldgrid/add-pages/3-click-add-media.png" title="Click here to view the larger image" width="200" /></a>To begin adding BoldGrid layouts, click on the <strong>Add Media</strong> button.<div style="clear:both;"></div></li>
  
    <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/boldgrid/add-pages/4-click-insert-gridblock.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="Click on the Inser GridBlock link." src="//cdn.inmotionhosting.com/support/images/stories/boldgrid/add-pages/4-click-insert-gridblock.png" title="Click here to view the larger image" width="200" /></a>Select <strong>Insert GridBlock</strong> from the left sidebar menu.<div style="clear:both;"></div></li>
  
    <li>Look to the right hand panel and select your preferred layout. You can select from theme specific GridBlocks, Basic Image GridBlocks, and Basic Text GridBlocks.Click on the one you want and click the <strong>Insert into page</strong> button. <br /><br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/boldgrid/add-pages/5-gridblock-choices.png"><img   style="float:left; margin:0px 15px 15px 15px;" alt="Select a GridBlock" src="//cdn.inmotionhosting.com/support/images/stories/boldgrid/add-pages/5-gridblock-choices.png" title="Click here to view the larger image" width="200" /></a><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/boldgrid/add-pages/5a-click-insert.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/boldgrid/add-pages/5a-click-insert.png" title="Click here to view the larger image" width="200" /></a><div style="clear:both;"></div></li>
  
    <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/boldgrid/add-pages/6-edit-with-drag-handles.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="Edit the page content by using drag handles." src="//cdn.inmotionhosting.com/support/images/stories/boldgrid/add-pages/6-edit-with-drag-handles.png" title="Click here to view the larger image" width="200" /></a>From here you can edit the page using the drag handles and their options.<div style="clear:both;"></div></li>
  
    <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/boldgrid/add-pages/7-select-group.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="Select your development group." src="//cdn.inmotionhosting.com/support/images/stories/boldgrid/add-pages/7-select-group.png" title="Click here to view the larger image" width="200" /></a>After you have added your content, scroll down to the <em>Publish</em> are and select either <strong>Active</strong> or <strong>Staging</strong> as the <em>development Group</em>. <em>Active</em> saves the page to the live site and <em>Staging</em> saves it to the development staging site.<div style="clear:both;"></div></li>
  
    <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/boldgrid/add-pages/8-click-publish.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="Click the publish button to finish." src="//cdn.inmotionhosting.com/support/images/stories/boldgrid/add-pages/8-click-publish.png" title="Click here to view the larger image" width="200" /></a>Click <strong>Publish</strong> to complete your page and send it to the proper site.<div style="clear:both;"></div></li>
</ol>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 9: How to Add new Pages in BoldGrid</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 8: <a href='/support/edu/boldgrid/getting-started/evaluate'>Evaluating your BoldGrid site</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 10: <a href='/support/edu/boldgrid/getting-started/edit-page'>How to Edit Pages using the BoldGrid Editor</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/boldgrid/getting-started/add-new-pages&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/boldgrid/getting-started/add-new-pages'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD01MzcmaWQ9MzY0MyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
