...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-25/users" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Joomla 2.5 makes running user driven websites very easy. In the following tutorial series, we'll cover topics such as how to allow only registered users access to certain pages, preventing user registration, and much more." />
  <title>108: Working with Users in Joomla 2.5 | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-25/users" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:1dde5ad2e7a8166ea7e8078ba14c9df8 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '188.79.35.204']);
...
<div class='page-header'>
	<h1>108: Working with Users in Joomla 2.5</h1>
</div>
<div class='section_listing'>
		...
		<tr>
				...
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/users/registered-users-only'>Allowing registered users only access in Joomla 2.5</a>
					<div>In this article, we'll show you how to setup Joomla 2.5 so that you can prevent the public from viewing certain pages in your site. After you follow these steps, only registered users will be able to view the pages that you specify.</div>
					<div class='smallgrey'>Hits: 12,326</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/users/change-please-login-first'>Changing the Please login first text in Joomla 2.5</a>
					<div>When a public users tries to visit a registered users only page in Joomla 2.5, they will see a message stating Please login first. In this Joomla 2.5 tutorial, we'll show you how to change that Please login first text to anything you'd like.</div>
					<div class='smallgrey'>Hits: 9,316</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/users/disable-user-registration'>How to disable user registration in Joomla 2.5</a>
					<div>If your Joomla 2.5 website is not community driven, in this article we'll show you how to prevent new users from registering.</div>
					<div class='smallgrey'>Hits: 44,915</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/users/create-new-admin-account'>How to create a new Joomla 2.5 Administrator</a>
					<div>In this article, we'll walk you through the steps for creating a new Joomla 2.5 admin user.</div>
					<div class='smallgrey'>Hits: 6,277</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/users/prevent-new-user-email-notification'>Prevent New Account activation email sent to Joomla 2.5 Administrator</a>
					<div>You can easily disable notification emails to administrators in Joomla 2.5 after new users register for an account.</div>
					<div class='smallgrey'>Hits: 9,023</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/users/prevent-passwords-in-email'>Prevent passwords in Joomla 2.5 new user account activation emails</a>
					<div>Be default, Joomla 2.5 is configured to send passwords through email. Using the Language Override tool, you can strip these emails of any passwords they include.</div>
					<div class='smallgrey'>Hits: 8,044</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/users/reset-user-password'>How to reset a Joomla 2.5 user password directly in the database</a>
					<div>If you've forgotten a Joomla 2.5 user's password, you can easily reset it using phpMyAdmin or any other MySQL client. This will work for both standard Joomla 2.5 users and administrators.</div>
					<div class='smallgrey'>Hits: 38,627</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/users/change-user-email'>How to change a Joomla 2.5 user's email address</a>
					<div>If you need to manually update a Joomla 2.5 user's email address, you can use the User Manager to do so.</div>
					<div class='smallgrey'>Hits: 3,973</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/users/add-new-user-note'>How to Add a New Note for a Joomla 2.5 user</a>
					<div>In this article, we'll walk you through the steps for creating a new note for a Joomla 2.5 users. Notes allow you to keep track of user activity and makes it easy to share information among other administrators.</div>
					<div class='smallgrey'>Hits: 2,504</div>
				</td>
			</tr>
			</table>
</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xODgmaWQ9MTg4JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="50bfa6a4926cd57b1ef44330394f367a" value="1" />	</div>
	</form>
<!-- <br />
