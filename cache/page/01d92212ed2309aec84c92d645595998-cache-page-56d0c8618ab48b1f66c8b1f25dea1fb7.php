<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:61176:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/php/turn-magic-quotes-gpc-off" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-04-21T22:34:31-07:00" />
  <meta name="keywords" content="Magic Quotes magic_quotes_gpc Off  php.ini On" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="You can turn Magic Quotes magic_quotes_gpc Off in your php.ini. This article will teach you how." />
  <title>How to turn magic_quotes_gpc off - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/php/turn-magic-quotes-gpc-off" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:78af33503973d0399584b3aa54e2038c -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '182.182.125.195']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to turn magic_quotes_gpc off</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to turn magic_quotes_gpc off									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>15,524</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: May 10, 2013'><span style='color:#606060;'>Published:</span> Apr 21, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/350/magic-quotes-on.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Parameters OK Prestashop" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/350/magic-quotes-on.png" title="Click here to view the larger image" width="100" /></a>Many Open Source Software programs like Drupal, Prestashop, Joomla, Etc., require <em>magic_quotes_gpc</em> to be turned off. The snapshot to the right shows the magic quotes <em>On</em> <a href="/support/website/general-server-setup/create-phpinfo-page-to-see-php-settings" target="_blank">in the phpinfo.php page</a>. This article will show you how to turn <em>maging_quotes_gpc</em> off on your server.<br style="clear: both;" />
</p>
<h2>Turning  magic_quotes_gpc off</h2>
...
<li><a href="/support/edu/cpanel/cpanel-file-manager/using-file-manager-in-cpanel" target="_blank" title="Click here for info">Go to the File Manager</a>, select your<em> public_html</em> directory and click <strong>Go</strong>.</li>

<li>Open your<em> php.ini</em> with the <a href="/support/edu/cpanel/cpanel-file-manager/file-manager-code-editor" target="_top">code editor</a>.

  
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/350/fix-open-error-4-magic-quotes.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Code view of magicquotes Prestashop" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/350/fix-open-error-4-magic-quotes.png" title="Click here to view the larger image" width="100" /></a>Find the <strong>magic_quotes_gpc</strong> line like the code below and change it <strong>from On to Off</strong>. (See image to the right)</p>


<pre style="margin-left:20px">;Magic quotes
;

; Magic quotes for incoming GET/POST/Cookie data.
magic_quotes_gpc = On</pre>
<p>Your php.ini should have the following code.</p>
<pre style="margin-left:20px">;Magic quotes
;

; Magic quotes for incoming GET/POST/Cookie data.
magic_quotes_gpc = Off</pre>
<p>Save the changes.<br style="clear: both;" /></p></li>


<li><a href="/support/component/content/domain-names/general-information/recursive-php-ini?Itemid=214" target="_blank" title="Click here for info">Make the php.ini recursive in the .htaccess</a>.</li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/350/magic-quotes-off.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Parameters OK Prestashop" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/350/magic-quotes-off.png" title="Click here to view the larger image" width="100" /></a>Visit your <em>phpinfo</em> page by going to your domain and adding phpinfo.php at the end of the URL like the example below.
  <pre style="adding:0px;">http://example.com/phpinfo.php</pre>
<br style="clear: both;" />
</li>
</ol> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/php/turn-magic-quotes-gpc-off&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/php/turn-magic-quotes-gpc-off'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MTImaWQ9MjcwMiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
