<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:57175:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/email/bounceback-errors/email-error-550" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-05-02T16:09:25-07:00" />
  <meta name="keywords" content="email e-mail error 550 bounce bounceback bounce-back error errors message messages" />
  <meta name="author" content="Jacob Nicholson" />
  <meta name="description" content="550 email errors are generally encountered when the recipient's mailbox is unavailable due to being incorrectly typed or not found." />
  <title>Email error 550 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/email/bounceback-errors/email-error-550" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:97541df9f913125515f98eec1117576c -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-22']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '64.202.160.161']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Email error 550</span></li>			</ul>
		</div>
	</div>
</div>
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>37,049</span></div>
							...
							<div style='clear:both;'></div>
								...
								<p>A<strong> 550 email error</strong>&nbsp;is generally encountered when the recipient's mailbox is unavailable due to being incorrectly typed or not found.</p>
<p>You should receive a bounce-back message from the server with a variation of&nbsp;<strong>email error 550</strong> in the subject, and the body should contain your original message that you attempted to deliver.</p>
<h2>Example bounce-back message</h2>
<div class="cli">
<p>Delivery-date: Thu, 25 Oct 2012 14:49:59 -0700<br />Received: from mailnull by biz24.inmotionhosting.com with local (Exim 4.77)<br />id 1TRVJP-0006jL-Qq<br />for <strong>sender@example.com</strong>; Thu, 25 Oct 2012 14:49:59 -0700<br />X-Failed-Recipients: <strong>recipient@RemoteDomain.com</strong><br />Auto-Submitted: auto-replied<br />From: Mail Delivery System &lt;Mailer-Daemon@biz24.inmotionhosting.com&gt;<br />To: <strong>sender@example.com</strong><br />Subject: Mail delivery failed: returning message to sender<br />Message-Id: &lt;E1TRVJP-0006jL-Qq@biz24.inmotionhosting.com&gt;<br />Date: Thu, 25 Oct 2012 14:49:59 -0700</p>
...
<div>&nbsp;</div>
<div><strong>recipient@RemoteDomain.com</strong></div>
<div><br />SMTP error from remote mail server after RCPT TO:&lt;<strong>recipient@RemoteDomain.com</strong>&gt;:<br />host RemoteDomain.com [123.123.123]: 550 Requested action was not taken because this server doesn't handle mail for that user</div>
<div>&nbsp;</div>
<div>------ This is a copy of the message, including all the headers. ------</div>
<div>Return-path: &lt;<strong>sender@example.com</strong>&gt;<br />Received: from comcast.net ([123.123.123]:63548 helo=Admin)<br />by biz24.inmotionhosting.com with esmtp (Exim 4.77)<br />(envelope-from &lt;<strong>sender@example.com</strong>&gt;)<br />id 1TRVJK-0006g1-VL<br />for <strong>recipient@RemoteDomain.com</strong>; Thu, 25 Oct 2012 14:49:55 -0700<br />From: "Sender" &lt;<strong>sender@example.com</strong>&gt;<br />To: &lt;<strong>recipient@RemoteDomain.com</strong>&gt;</div>
</div>
<h2>Common variations of the 550 email error</h2>
<div>
<ul>
<li>550 No such person at this address</li>
<li>550 No such recipient here</li>
<li>550 No Such User Here</li>
<li>550 No such user - psmtp</li>
<li>550 No such user (recipient@RemoteDomain.com)</li>
<li>550 permanent failure for one or more recipients</li>
<li>550 Recipient does not exist here</li>
<li>550 Recipient Rejected: No account by that name here</li>
<li>550 &lt;recipient@RemoteDomain.com&gt;: invalid address</li>
<li>550 &lt;recipient@RemoteDomain.com&gt;&nbsp;No such user here</li>
<li>550 recipient@RemoteDomain.com...User unknown</li>
<li>550 Rejected</li>
<li>550 relaying denied</li>
<li>550 Requested action not taken: mailbox unavailable</li>
<li>550 Requested action was not taken because this server doesn't handle mail for that user</li>
<li>550 sorry, no mailbox here by that name (#5.1.1)</li>
<li>550 sorry, no mailbox here by that name. (#5.7.17)</li>
<li>550 This user's mailbox is full (recipient@RemoteDomain.com) - Try again later</li>
<li>550 Unknown user</li>
<li>550 unrouteable address</li>
<li>550 User [recipient@RemoteDomain.com] does not exist</li>
<li>550 User unknown</li>
</ul>
<h2>Resolving a 550 email error bounceback</h2>
<p>The 550 series of errors are referred to as hard bounces. This means the problem is permanent and attempting to send the message again in the same fashion won't work. For a more in-depth explanation on hard bounces and general email bounceback reasons you can read <a href="/support/email/email-troubleshooting/email-bounce-bounceback-error">why does email bounce, bounceback, or error?</a></p>
<p>In our example bounce-back error above the reason the message has failed is because the server for <strong>RemoteDomains.com</strong> doesn't handle mail for the user&nbsp;<strong>recipient@RemoteDomain.com</strong>&nbsp;so it's unable to deliver the message for you.</p>
</div> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/email/bounceback-errors/email-error-550&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/email/bounceback-errors/email-error-550'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NjImaWQ9NzgwJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="2211da4d4365b43a226ebf5d89105e67" value="1" />	</div>
	</form>
<!-- <br />
