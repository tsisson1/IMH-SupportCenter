<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:56924:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/outlook/the-server-is-using-a-security-certificate-that-cannot-be-verified" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hi, I was having the same issue on my VPS and it brought me to this topic, so here is my 2 cents maybe it will help you. When you open outlook and the m..." />
  <title>The server ... is using a security certificate that cannot be verified | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/outlook/the-server-is-using-a-security-certificate-that-cannot-be-verified" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:1f6096e9870ce447e0b095dacd6de269 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '1.39.33.198']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>The server ... is using a security certificate that cannot be verified</h1>
		<div style='margin-bottom:20px; margin-top:10px; clear:both; color:#6e6e6e;'>Category: <a href='/support/community-support/outlook'>Outlook</a></div>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/BobBeacon'>BobBeacon</a>
			<div>8 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-02-21 6:07 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>16,815</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Whenever I open Outlook 2010, I get the message: &quot;The server you are connected to is using a security certificate that cannot be verified&quot;. Despite &quot;installing&quot; the certificate or saying 'yes' to continuing, the message reappears every time I start Outlook. I am using 'secure115.inmotionhosting.com' as the server and SSL with 993 Incoming and SSL with 465 Outgoing as suggested.<br />
What can I do to stop this message?</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_625' id='upvote_answer_625' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='625' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_625').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_625' id='downvote_answer_625' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='625' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_625').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hi BobBeacon,<br />
<br />
From my pervious experience, if you are getting a warning in Outlook about your security certificate and you accept it, it will no longer prompt you with the warning. If it continues to however, it is generally related to one of two items:<br />
<br />
&lt;strong&gt;Issue 1. There is a problem with the SSL certificate&lt;/strong&gt;<br />
<br />
I reviewed the SSL certificate on the server, and it does not expire until Dec 15th, 2014. The SSL is valid, so most likely it does not have to do with the actual certificate itself.<br />
<br />
&lt;strong&gt;Issue 2. You have more than one email account setup in Outlook, and not all share the same settings&lt;/strong&gt;<br />
<br />
From previous experience, I've seen users have more than one account setup in Outlook, and not all of them are setup with the same settings. If you do have more than one account in Outlook connecting to this server, be sure they all share the same SSL settings.<br />
<br />
<br />
If either of the above two don't help resolve your issue, please post a comment on the bottom of this page with the EXACT error Outlook is giving you, and I'll be more than happy to review further.<br />
<br />
Thanks!<br />
- Brad
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_625').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_625' id='form_comment_on_answer_625' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
...
<div class=' straight_bottom not_best_answer'>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px; width:50px;' valign='top'>
<div class='vote_div'>
	<form method='post' name='upvote_answer_4489' id='upvote_answer_4489' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='4489' />
		<input type='hidden' name='component' id='component' value='qa' />
		<input type='hidden' name='vote_value' id='vote_value' value='1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_4489').submit();"></div>
	</form>
	<div class='vote_sum'>1</div>
	<form method='post' name='downvote_answer_4489' id='downvote_answer_4489' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='4489' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_4489').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					<img src='https://lh3.googleusercontent.com/-XdUIqdMkCWA/AAAAAAAAAAI/AAAAAAAAAAA/4252rscbv5M/photo.jpg?sz=90' class='user_avatar' style='max-width:60px;' /><br />
                		        <a href='/support/community-support/users/alannocko'>alannocko</a>
					
					<div>10 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2014-02-02 1:49 am EST
                		        </div>
				...
				Hi,<br />
<br />
I was having the same issue on my VPS and it brought me to this topic, so here is my 2 cents maybe it will help you.<br />
<br />
When you open outlook and the message appears for the cert, press view certificate. Then at the bottom it will have the name something like.. 23453.vps-45.com or something similar. make a copy of this in notepad.<br />
<br />
Then just close that box and click install certificate as you have done previously. After this goto your account settings for your email. And in your incoming and outgoing change it to the one you wrote down in notepad. do this for all other emails in outlook that you use through your server. Text it again then by closing everything and re-opening, that done the trick for me. See you cannot use example: (mail.yourserver.com) as your incoming and outgoing because you need to get a certificate installed for each area, or at least a certificate that would need to be configured for all clients etc..<br />
<br />
Hope this solves it for you.<br />
<br />
Regards,<br />
Alan
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_4489').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_4489' id='form_comment_on_answer_4489' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
					                <p>You must <a href='/support/login'>login</a> before you can post a comment about this answer.</p>
					        </div></div></div></div>
					</form>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>I'm having this problem, however, it doesn't give me an option to click on View Certificate. It's greyed out! What do I do now?</div>
							...
							<td style='width:96px;' valign='top'>
								...
								<div class='smallgrey'>
									<a href='/support/community-support/users/indcwby'>indcwby</a><br />
									3 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2015-09-15 9:54 pm EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello indcwby,<br />
<br />
Thank you for contacting us. We are happy to help, but will need some additional information. Did you try the two suggestions above by BradM? You can test your SSL with an online tool such as <a href="https://www.sslshopper.com/ssl-checker.html">SSL checker</a>.<br />
<br />
Thank you,<br />
John-Paul</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/outlook/the-server-is-using-a-security-certificate-that-cannot-be-verified&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/outlook/the-server-is-using-a-security-certificate-that-cannot-be-verified'></div>
<script type='text/javascript'>
  (function() {
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
                                ...
                                <h3>Related Articles</h3><a target='_blank' href='http://inmotionhosting.com/support/issues-with-outlook-2007-running-on-windows-10'>Issues with Outlook 2007 Running on Windows 10</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/outlook-2013-omapi32-wwlib-errors'>How to fix OLMAPI32.dll and WWLIB.dll error in Outlook 2013</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/inbox-subscribe'>Outlook 2013/Office 365 - Subscribing to your Inbox</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/prevent-winmaildat'>Preventing Outlook from formatting mail as winmail.dat</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/2013'>How to Setup Outlook 2013 to Check Your Email</a><br/><br />
		</div>
