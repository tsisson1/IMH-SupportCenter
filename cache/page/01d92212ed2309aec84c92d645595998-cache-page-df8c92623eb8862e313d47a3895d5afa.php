<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:53689:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/whm/whm-firewall-wothout-fixed-ip" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, Thank you for your question on adding your IP to your firewall. Yes, you can certainly add a range with the 'Add IP to Firewall' tool. Kindest Re..." />
  <title>WHM firewall wothout fixed IP | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/whm/whm-firewall-wothout-fixed-ip" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:0ea8292d2ba8c94df4b9d43f2136c80c -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>WHM firewall wothout fixed IP</h1>
		<div style='margin-bottom:20px; margin-top:10px; clear:both; color:#6e6e6e;'>Category: <a href='/support/community-support/whm'>Whm</a></div>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-02-20 11:11 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>113</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I don't have fixed IP I can disable firewall or i can put range of IP?<br />
otherwise i need modify every day the configuration.<br />
thanks</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_6595' id='upvote_answer_6595' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='6595' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_6595').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_6595' id='downvote_answer_6595' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='6595' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_6595').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
Thank you for your question on adding your IP to your firewall. Yes, you can certainly add a range with the '<a href="http://www.inmotionhosting.com/support/website/ssh/add-ip-to-firewall">Add IP to Firewall</a>' tool. <br />
<br />
Kindest Regards,<br />
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_6595').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_6595' id='form_comment_on_answer_6595' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>thanks, i can add my mac addres instead of ip range for more security?<br />
thanks again.<br />
</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='https://lh5.googleusercontent.com/--C3O7BkkIDw/AAAAAAAAAAI/AAAAAAAACBQ/3MqDDD4HbHs/photo.jpg?sz=90' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/ssharoian'>ssharoian</a><br />
									9 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2015-02-23 9:00 pm EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello ssharoian,<br />
<br />
The tool only works with IP addresses and ranges. Unfortunately it does not work with MAC addresses.<br />
<br />
Kindest Regards,<br />
Scott M</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>with root acces is possible?</div>
...
<br />
No, the tool is the same, even with root access.<br />
<br />
Kindest Regards,<br />
Scott M</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/whm/whm-firewall-wothout-fixed-ip&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/whm/whm-firewall-wothout-fixed-ip'></div>
<script type='text/javascript'>
  (function() {
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
                                ...
                                <h3>Related Articles</h3><a target='_blank' href='http://inmotionhosting.com/support/change-default-whm-language'>How to Change the Language in Your WHM</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/reset-cpanel-password'>How to Reset a cPanel password in WHM</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/change-max-user-connections'>How to change max_user_connections in VPS/Dedicated</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/disable-spamcop-in-whm'>Disabling SpamCop RBL in WHM</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/install-ssl-whm'>How to create a CSR and install a SSL Certificate in WHM</a><br/><br />
		</div>
