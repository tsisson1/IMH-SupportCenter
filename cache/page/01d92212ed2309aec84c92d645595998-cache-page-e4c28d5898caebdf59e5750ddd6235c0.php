<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:54061:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/wordpress-34/wordpress-home-page-no-longer-loads" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello bobwil6, That error points to a theme error. You will want to switch themes via your wp-admin dashboard to get the site functioning correctly whil..." />
  <title>Wordpress home page no longer loads? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/wordpress-34/wordpress-home-page-no-longer-loads" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:fcdd41974d1bb04e930beb6103f8034c -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Wordpress home page no longer loads?</h1>
		<div style='margin-bottom:20px; margin-top:10px; clear:both; color:#6e6e6e;'>Category: <a href='/support/community-support/wordpress-34'>Wordpress 34</a></div>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/bobwil6'>bobwil6</a>
			<div>11 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-07-28 6:08 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>1,662</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>When I go to my Wordpress blog (http://www.bobwillet.com/wordpress/) I receive the following message:<br />
Warning: Cannot modify header information - headers already sent by (output started at /home/bobwil6/public_html/wordpress/wp-content/themes/fragrance/functions.php:20) in /home/bobwil6/public_html/wordpress/wp-includes/pluggable.php on line 881</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_1359' id='upvote_answer_1359' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='1359' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_1359').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_1359' id='downvote_answer_1359' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='1359' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_1359').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello bobwil6,<br />
<br />
That error points to a theme error. You will want to switch themes via your wp-admin dashboard to get the site functioning correctly while you fix the issue. <br />
<br />
That particular error typically means there are some blank spaces in the file that are getting in the way. You would need to edit the file /home/bobwil6/public_html/wordpress/wp-content/themes/fragrance/functions.php at line 20 and remove any extra spaces.<br />
<br />
That should take care of the issue. If that is not the case or if you do remove them and it persists, please get back with us immeditely by <a href="http://www.inmotionhosting.com/contact.html" target="_blank">contacting our support department</a> (open 24/7). Be sure to validate your account with either the last 4 digits of the credit card on file, or the current Account Management Panel (AMP) password.<br />
<br />
Best Regards,<br />
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_1359').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_1359' id='form_comment_on_answer_1359' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
...
<div class='  not_best_answer'>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px; width:50px;' valign='top'>
<div class='vote_div'>
	<form method='post' name='upvote_answer_1360' id='upvote_answer_1360' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='1360' />
		<input type='hidden' name='component' id='component' value='qa' />
		<input type='hidden' name='vote_value' id='vote_value' value='1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_1360').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_1360' id='downvote_answer_1360' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='1360' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_1360').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
...
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_1360').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_1360' id='form_comment_on_answer_1360' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
					                <p>You must <a href='/support/login'>login</a> before you can post a comment about this answer.</p>
					        </div></div></div></div>
					</form>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/wordpress-34/wordpress-home-page-no-longer-loads&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/wordpress-34/wordpress-home-page-no-longer-loads'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="486285ade0cd441250aeddeaace49ed5" value="1" />	</div>
	</form>
<!-- <br />
