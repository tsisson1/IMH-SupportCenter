<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50623:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/server-usage/php-files-downloading-instead-of-executing" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, This is normally due to an improper handler code. In the .htaccess file, you will want to ensure the handler code matches your version of php. If..." />
  <title>PHP files downloading instead of executing. | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/server-usage/php-files-downloading-instead-of-executing" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:ea4ddf2598a5d506d2e8eda7c7217b8f -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '190.128.226.86']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>PHP files downloading instead of executing.</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2014-09-21 12:47 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>1,771</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>My account was recently downgraded from a dedicated account to a VPS account. I've just discovered that the primary domain on my account (circa75.co) is having issues with with PHP files. Instead of PHP files executing, they are downloading. I've uploaded a test index.php file for testing purposes.</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_5662' id='upvote_answer_5662' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='5662' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_5662').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_5662' id='downvote_answer_5662' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='5662' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_5662').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
This is normally due to an improper handler code. In the .htaccess file, you will want to ensure the handler code matches your version of php. If it does not, the php files may try to download instead of process. <br />
<br />
To use the default php version on the server, use the following code:<br />
<div class="code_block"># Use system PHP5 as default<br /><br />
AddHandler application/x-httpd-php5 .php</div><br />
<br />
You may also specify different php versions, depending on your need:<br />
<div class="code_block"># Use system PHP5.2 as default<br /><br />
AddHandler application/x-httpd-php52 .php</div><br />
<div class="code_block"># Use system PHP5.3 as default<br /><br />
AddHandler application/x-httpd-php53.php</div><br />
<div class="code_block"># Use system PHP5.4 as default<br /><br />
AddHandler application/x-httpd-php54 .php</div><br />
<div class="code_block"># Use system PHP5.5 as default<br /><br />
AddHandler application/x-httpd-php55 .php</div><br />
<br />
If any of the above are the default version, then the first code mentioned will be the correct handler. <br />
<br />
Kindest Regards,<br />
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_5662').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_5662' id='form_comment_on_answer_5662' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/server-usage/php-files-downloading-instead-of-executing&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/server-usage/php-files-downloading-instead-of-executing'></div>
<script type='text/javascript'>
  (function() {
