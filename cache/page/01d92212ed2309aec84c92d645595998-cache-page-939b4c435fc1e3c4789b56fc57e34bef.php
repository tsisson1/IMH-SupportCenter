<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:79971:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/email-troubleshooting/php-mail-function-returns-false" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="I ended up calling technical support. They explained that the php.ini file for a VPS account points to a different directory for the php libraries than ..." />
  <title>php mail() function returns false | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/email-troubleshooting/php-mail-function-returns-false" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:36bc5cb82d37ced4c0ecec89e897b04f -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '46.13.114.253']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>php mail() function returns false</h1>
		<div style='margin-bottom:20px; margin-top:10px; clear:both; color:#6e6e6e;'>Category: <a href='/support/community-support/email-troubleshooting'>Email Troubleshooting</a></div>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='https://lh3.googleusercontent.com/-XdUIqdMkCWA/AAAAAAAAAAI/AAAAAAAAAAA/4252rscbv5M/photo.jpg?sz=90' class='user_avatar' /><br />
			<a href='/support/community-support/users/InMotionFans'>InMotionFans</a>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-08-07 12:02 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>649</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Our domain was previously hosted on a VPS account and a php mail() function created to query the server and return database changes in a human-readable format worked without any problems.<br />
<br />
Recently, we switched to a shared hosting plan, and now that same php mail() function returns false. I have searched around for answers, and it may be related to the fact that we are now on a shared hosting account?  Most of the related questions had to do with PrestaShop, which does not appear to apply to us in this situation. We do not use any pre-installed applications.<br />
<br />
The email account configuration information is as follows:<br />
<br />
Secure SSL/TLS Settings<br />
(Recommended)<br />
<br />
Username:	admin@[my-domain].org<br />
Password:	Use the email account’s password.<br />
Incoming Server:	secure170.inmotionhosting.com<br />
  IMAP Port: 993<br />
  POP3 Port: 995<br />
Outgoing Server:	secure170.inmotionhosting.com<br />
  SMTP Port: 465<br />
Authentication is required for IMAP, POP3, and SMTP.<br />
<br />
For reference, the script simply sets the $email, $subject, $message and $headers variables.  The only thing explicitly set in the $headers variable is &quot;From: admin@[my-domain].org&quot;.  No additional_parameters are normally set, though I did try &quot;-fadmin@[my-domain].org&quot; and &quot;-f admin@[my-domain].org&quot; in further troubleshooting.<br />
<br />
Thank you.</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_7854' id='upvote_answer_7854' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='7854' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_7854').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_7854' id='downvote_answer_7854' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='7854' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_7854').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					<img src='http://lh3.googleusercontent.com/-Qzm5Afwbl4g/AAAAAAAAAAI/AAAAAAAAAEc/CXPngTPySFA/s120-c/photo.jpg?sz=90' class='user_avatar' style='max-width:60px;' /><br />
                		        <a href='/support/community-support/users/John-Paul'>John-Paul</a>
				...
				Hello,<br />
<br />
Thank you for contacting us about issues with the php mail() function. Several of us looked into this, and we cannot determine what code would work on a vps, but not on shared. Especially, if nothing is explicitly set (such as paths, etc).<br />
<br />
We are happy to help you troubleshoot your script further, but will need to see the actual coding to proceed. <br />
<br />
...
John-Paul
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_7854').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_7854' id='form_comment_on_answer_7854' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>I will get the code posted, I just need to clean it up and check for any sensitive information first.<br />
<br />
Thanks.</div>
							...
							<td style='width:96px;' valign='top'>
								...
								<div class='smallgrey'>
									<a href='/support/community-support/users/nealb'>nealb</a><br />
									32 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
...
<div class=' straight_bottom not_best_answer'>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px; width:50px;' valign='top'>
<div class='vote_div'>
	<form method='post' name='upvote_answer_7855' id='upvote_answer_7855' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='7855' />
		<input type='hidden' name='component' id='component' value='qa' />
		<input type='hidden' name='vote_value' id='vote_value' value='1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_7855').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_7855' id='downvote_answer_7855' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='7855' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_7855').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					<img src='/support/images/avatars/default_avatar.jpg' class='user_avatar' style='max-width:60px;' /><br />
                		        <a href='/support/community-support/users/nealb'>nealb</a>
				...
				Most of this code is the manipulation of data retrieved from the db, but I included all of it just in case.  And again, this all worked as recently as May of this year.  The only thing that changed, that I am aware of, was the account switch at the end of that same month.<br />
<br />
In the future, is there a way to format code, such as when posting to StackOverflow?  If necessary and possible, I can also upload the code as a file.<br />
<br />
CODE:<br />
-------------------------------------------------------<br />
&lt;?php<br />
    include(&quot;../globalsession.php&quot;);<br />
<br />
    $edits_array = array();<br />
    $type = $_GET['type'];<br />
<br />
    $current_time = date('Y-m-d H:i:s');<br />
    $past_time = date('Y-m-d H:i:s', strtotime('-1 weeks Sunday')); // get previous Sunday at midnight<br />
    $past_time = date('y-m-d H:i:s', strtotime('+17 hours', strtotime($past_time))); // convert to previous Sunday at 5:00 pm<br />
<br />
    $query = $db-&gt;prepare(&quot;<br />
        ...
        WHERE<br />
            active = :active<br />
        ORDER BY team ASC, title DESC, on_campus DESC, gender DESC, lastname ASC<br />
    &quot;);<br />
    $params = array(':active' =&gt; 1);<br />
    $didwork = $query-&gt;execute($params);<br />
    if ($didwork) {<br />
        $all_users = $query-&gt;fetchAll();<br />
        $num_users = count($all_users);<br />
<br />
        for ($i = 0; $i &lt; $num_users; $i++) {<br />
            $get_edits = $db-&gt;prepare(&quot;<br />
                SELECT<br />
                    edit_log.stat_type,<br />
                    edit_log.table_name,<br />
                    edit_log.old_stat,<br />
                    edit_log.new_stat,<br />
                    edit_log.member_id,<br />
                    edit_log.week,<br />
                    edit_log.semester,<br />
                    edit_log.year,<br />
                    all_members.firstname AS att_fname,<br />
                    all_members.lastname AS att_lname,<br />
                    users_stats.firstname AS user_fname,<br />
                    users_stats.lastname AS user_lname,<br />
                    edit_log.timestamp,<br />
                    edit_log.type<br />
                FROM edit_log<br />
                LEFT JOIN all_members ON edit_log.member_id = all_members.id<br />
                LEFT JOIN users_stats ON edit_log.user_id = users_stats.id<br />
                WHERE<br />
                    edit_log.user_id = :user_id<br />
                    AND<br />
                    edit_log.timestamp BETWEEN :first AND :last<br />
                    AND<br />
                    edit_log.type = :type<br />
            &quot;);<br />
            $get_edits_params = array(':user_id' =&gt; $all_users[$i]['id'], ':first' =&gt; $past_time, ':last' =&gt; $current_time, ':type' =&gt; 'u');<br />
            $didget = $get_edits-&gt;execute($get_edits_params);<br />
            if ($didget) {<br />
<br />
                $edits = $get_edits-&gt;fetchAll();<br />
                $num_edits = count($edits);<br />
                if (!empty($edits)) {<br />
                    array_push($edits_array, $edits);<br />
                }<br />
            }<br />
            else {<br />
                echo 'Failed getting edits for ' . $all_users[$i]['firstname'] . ' ' . $all_users[$i]['lastname'] . '&lt;br&gt;';<br />
            }<br />
        }<br />
<br />
        $num_user_edits = count($edits_array); // count the number of users that submitted edits<br />
<br />
        $subject = 'Edits made during week ' . $semester_week . '';<br />
        if ($_GET['num'] == 'all') {<br />
            $emails = '[other-addresses]@domain.com';<br />
        }<br />
        else {<br />
            $emails = '[my-address]@domain.com';<br />
        }<br />
<br />
        $headers = &quot;Content-type: text/html; charset=iso-8859-1\r\n&quot;;<br />
        $headers .= &quot;From: admin@[my-domain].org&quot;;<br />
<br />
        if ($num_user_edits &gt; 0) { // check if anybody submitted edits<br />
<br />
            for ($k = 0; $k &lt; $num_user_edits; $k++) { // loop through all users that submitted edits<br />
            <br />
                $loop_info = null;<br />
<br />
                if ($k !== 0) {<br />
                    $loop_info .= &quot;&lt;br&gt;&lt;br&gt;&lt;br&gt;&quot;;<br />
                }<br />
                else {<br />
                    $loop_info .= 'The following edits were made between ' . date('m/j/y', strtotime($past_time)).<br />
                    ' @ ' . date('g:i a' , strtotime($past_time)).<br />
                    ' and ' . date('m/j/y', strtotime($current_time)) . ' @ ' . date('g:i a', strtotime($current_time)) . ' &lt;br&gt;&lt;hr&gt;&lt;br&gt;';<br />
                }<br />
<br />
                $loop_info .= $edits_array[$k][0]['user_fname'] . &quot; &quot; . $edits_array[$k][0]['user_lname'] . &quot; updated the following stat(s):&lt;br&gt;&quot;;<br />
                <br />
                $num_edits_by_user = count($edits_array[$k]);<br />
<br />
                for ($j = 0; $j &lt; $num_edits_by_user; $j++) { // loop through all edits made by current minister<br />
<br />
                    // get timestamp and convert into report format<br />
                    $timestamp = strtotime($edits_array[$k][$j]['timestamp']);<br />
                    $day1 = date('l', $timestamp);<br />
                    $mon = date('M', $timestamp);<br />
                    $day2 = date('j', $timestamp);<br />
                    $time = date('g:i a', $timestamp);<br />
                    $time_string = $day1 . ', ' . $mon . '. ' . $day2 . ' at ' . $time;<br />
<br />
                    if (!empty($edits_array[$k][$j]['member_id'])) { // checks if edit was for a member's attendance and adjusts wording<br />
                        $stats = &quot; - Week &quot; . $edits_array[$k][$j]['week'] . ' ' . $edits_array[$k][$j]['stat_type'] . &quot; for &quot; . $edits_array[$k][$j]['att_fname'] . &quot; &quot; . $edits_array[$k][$j]['att_lname'] . &quot; from &quot; . $edits_array[$k][$j]['old_stat'] . &quot; to &quot; . $edits_array[$k][$j]['new_stat'] . &quot; &lt;i&gt;(&quot; . $time_string . &quot;)&lt;/i&gt;&quot;;<br />
                        if ($j == ($num_edits_by_user - 1)) {<br />
                            $loop_info .= $stats;<br />
                        }<br />
                        else {<br />
                            $loop_info .= $stats . &quot;&lt;br&gt;&quot;;<br />
                        }<br />
                    }<br />
                    else if ($edits_array[$k][$j]['table_name'] == 'guest info') { // check if edit was to guest information<br />
                        if ($edits_array[$k][$j]['stat_type'] == 'not submitted') {<br />
                            $stats = &quot; - Submitted a &quot; . $edits_array[$k][$j]['new_stat'] . &quot; guest for Week &quot; . $edits_array[$k][$j]['week'] . &quot;  &lt;i&gt;(&quot; . $time_string . &quot;)&lt;/i&gt;&quot;;<br />
                        }<br />
                        else if ($edits_array[$k][$j]['stat_type'] == 'deleted') {<br />
                            $stats = &quot; - Deleted guest &quot; . $edits_array[$k][$j]['old_stat'] . &quot; for Week &quot; . $edits_array[$k][$j]['week'] . &quot;  &lt;i&gt;(&quot; . $time_string . &quot;)&lt;/i&gt;&quot;;<br />
                        }<br />
                        else {<br />
                            $stats = &quot; - Week &quot; . $edits_array[$k][$j]['week'] . ' ' . $edits_array[$k][$j]['table_name'] . ' &quot;' . $edits_array[$k][$j]['stat_type'] . '&quot; from ' . $edits_array[$k][$j]['old_stat'] . &quot; to &quot; . $edits_array[$k][$j]['new_stat'] . &quot; &lt;i&gt;(&quot; . $time_string . &quot;)&lt;/i&gt;&quot;;<br />
                        }<br />
                        <br />
                        if ($j == ($num_edits_by_user - 1)) {<br />
                            $loop_info .= $stats;<br />
                    ...
                    else { // edit was for user's stats<br />
                        if ($edits_array[$k][$j]['table_name'] == 'dorm_stats') {<br />
                            $stats = &quot; - Week &quot; . $edits_array[$k][$j]['week'] . ' ' . $edits_array[$k][$j]['stat_type'] . &quot; in dorms from &quot; . floatval($edits_array[$k][$j]['old_stat']) . &quot; to &quot; . floatval($edits_array[$k][$j]['new_stat']) . &quot; &lt;i&gt;(&quot; . $time_string . &quot;)&lt;/i&gt;&quot;;<br />
                        }<br />
                        else {<br />
                            $stats = &quot; - Week &quot; . $edits_array[$k][$j]['week'] . ' ' . $edits_array[$k][$j]['stat_type'] . &quot; from &quot; . floatval($edits_array[$k][$j]['old_stat']) . &quot; to &quot; . floatval($edits_array[$k][$j]['new_stat']) . &quot; &lt;i&gt;(&quot; . $time_string . &quot;)&lt;/i&gt;&quot;;    <br />
                        }<br />
                        if ($j == ($num_edits_by_user - 1)) {<br />
                            $loop_info .= $stats;<br />
                        }<br />
...
/* testing<br />
            ...
            echo $headers.'&lt;br&gt;';<br />
*/<br />
            $mailed = mail($emails, $subject, $message, $headers);<br />
<br />
            if ($mailed) {<br />
            	echo 'Email(s) sent';<br />
            } else {<br />
            	echo 'Email(s) not sent...';<br />
            }<br />
        }<br />
        else { // no edits so adjust email message<br />
            $message .= 'There were no edits made between ' . date('m/j/y', strtotime($past_time)).<br />
            ' @ ' . date('g:i a' , strtotime($past_time)).<br />
            ' and ' . date('m/j/y', strtotime($current_time)) . ' @ ' . date('g:i a', strtotime($current_time)) . ' &lt;br&gt;&lt;hr&gt;&lt;br&gt;';<br />
<br />
            mail($emails, $subject, $message, $headers);<br />
            echo 'Email(s) sent';<br />
        }<br />
    }<br />
    else {<br />
        die(&quot;Couldn't get list of users.&quot;);<br />
    }<br />
?&gt;
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_7855').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_7855' id='form_comment_on_answer_7855' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
					                <p>You must <a href='/support/login'>login</a> before you can post a comment about this answer.</p>
					        </div></div></div></div>
					</form>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello nealb,<br />
<br />
Thank you for providing additional information. Since PHP error logging is disabled by default on shared server, I first recommend <a href="http://www.inmotionhosting.com/support/website/php-troubleshooting/troubleshoot-php-errors">Displaying and logging errors for PHP</a>. This may provide more detailed error messages.<br />
<br />
To rule out a long-running query; as a test, trying running your code without the following section:<br />
<pre class="code_block">$query = $db->prepare("<br />
SELECT firstname, lastname, id<br />
FROM users_stats<br />
WHERE<br />
active = :active<br />
...
");</pre><br />
<br />
Also, check your variables to make sure they are correct, such as free of misspellings, etc.<br />
<br />
Thank you,<br />
John-Paul</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>I simplified the code as you suggested, and simply included the following:<br />
<br />
BEGIN CODE<br />
------------------------------------------------------------------------------------------<br />
$subject = 'Test';<br />
$emails = '[my-email]@[mail-host].com';<br />
<br />
$headers = &quot;Content-type: text/html; charset=iso-8859-1\r\n&quot;;<br />
$headers .= &quot;From: admin@[my-domain].org&quot;;<br />
<br />
$message = 'Some test text here!';<br />
<br />
$mailed = mail($emails, $subject, $message, $headers);<br />
    if ($mailed) {<br />
    	echo 'Email sent';<br />
...
END CODE<br />
<br />
I still receive a bool(false) from the $mailed variable.  After enabling the error_logging, I tested it by simulating a fatal error which was reported both via the website (non-production) and in the error_log file. However, nothing beyond that has been reported after running the simplified script multiple times.<br />
</div>
...
<div class=' straight_bottom not_best_answer'>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px; width:50px;' valign='top'>
<div class='vote_div'>
	<form method='post' name='upvote_answer_7894' id='upvote_answer_7894' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='7894' />
		<input type='hidden' name='component' id='component' value='qa' />
		<input type='hidden' name='vote_value' id='vote_value' value='1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_7894').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_7894' id='downvote_answer_7894' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='7894' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_7894').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					<img src='https://lh3.googleusercontent.com/-fI7zh5HdUcw/AAAAAAAAAAI/AAAAAAAAADs/nezrUM_KGls/s50-p-rw-no/photo.jpg' class='user_avatar' style='max-width:60px;' /><br />
                		        <a href='/support/community-support/users/TJEdens'>TJEdens</a>
					<div style='padding-left:20px; background:url(/support/templates/supportcentertemplate/images/gold_star.png) no-repeat 0px 2px;background-size:15px 15px;'>Staff</div>
...
TJ Edens
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_7894').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_7894' id='form_comment_on_answer_7894' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
					                <p>You must <a href='/support/login'>login</a> before you can post a comment about this answer.</p>
					        </div></div></div></div>
					</form>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Is there anything one can check in regards to this functionality issue?</div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello nealb,<br />
<br />
Thank you for contacting us. We spent some time looking into this. As a test, try <a href="http://www.inmotionhosting.com/support/website/php/how-to-change-the-php-version-your-account-uses">switching your PHP version</a> to the same one that was used on your VPS server.<br />
<br />
A VPS comes with a standard version of PHP, for example 5.5. But shared servers often come with a different version (such as 5.3), but you have a switcher tool that allows you to change versions.<br />
<br />
Also, I see in your initial question, you listed your SMTP settings. Ensure you are authenticating with the server with these settings.<br />
<br />
If your problems persist, it may be easier to contact <a href="http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support">Live Support</a> so they can review the <a href="http://www.inmotionhosting.com/support/website/getting-started-guides/cpanel-logs-for-access-apache-email-error-ftp-mysql-whm">mail logs</a> in real-time, while you are testing the mail functionality of your script.<br />
<br />
Thank you,<br />
John-Paul</div>
...
<div class='  not_best_answer'>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px; width:50px;' valign='top'>
<div class='vote_div'>
	<form method='post' name='upvote_answer_7952' id='upvote_answer_7952' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='7952' />
		<input type='hidden' name='component' id='component' value='qa' />
		<input type='hidden' name='vote_value' id='vote_value' value='1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_7952').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_7952' id='downvote_answer_7952' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='7952' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_7952').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				I ended up calling technical support. They explained that the php.ini file for a VPS account points to a different directory for the php libraries than a shared hosting account does.<br />
<br />
Once a fresh php.ini file was generated, the function worked fine.
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_7952').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_7952' id='form_comment_on_answer_7952' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
					                <p>You must <a href='/support/login'>login</a> before you can post a comment about this answer.</p>
					        </div></div></div></div>
					</form>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/email-troubleshooting/php-mail-function-returns-false&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/email-troubleshooting/php-mail-function-returns-false'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="51539591ba915dae44be38a0d7ea3389" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
                                ...
                                <h3>Related Articles</h3><a target='_blank' href='http://inmotionhosting.com/support/imap-issues-affecting-outlook-2013-and-office-365-functionality'>IMAP issues affecting Outlook 2013 and Office 365 functionality</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/smtp-and-esmtp-error-code-list'>SMTP and ESMTP error code list</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/request-a-delisting-from-a-blacklist'>Request a delisting from a blacklist</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/why-do-mail-servers-get-blacklisted'>Why do mail servers get blacklisted?</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/send-mail-via-gmail-when-server-ip-is-blocked'>Send mail via Gmail when server IP is blocked</a><br/><br />
		</div>
