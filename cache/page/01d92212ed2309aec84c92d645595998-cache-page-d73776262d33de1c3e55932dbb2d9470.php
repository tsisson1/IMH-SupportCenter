<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49478:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/everything-email/mcafee" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="keywords" content="mcafee email spam protection" />
  <meta name="description" content="This is a class on how to use McAfee Email Protection, which protects you from receiving Spam, Viruses, and Malware." />
  <title>203: McAfee Email Protection | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/everything-email/mcafee" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:e88282b8e6a831cc18e6fd2ca86ccb09 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '202.56.197.65']);
...
<div class='page-header'>
	<h1>203: McAfee Email Protection</h1>
</div>
<div class='section_listing'>
	<div class="width_1"><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/mcafee/control-console.png"><img src="//cdn.inmotionhosting.com/support/images/stories/mcafee/control-console.png" alt="McAfee Control Console Inmotion Hosting"  style="margin: 15px; float: right;" /></a>McAfee provides spam &nbsp;blocking, virus and worm scanning, email attack protection, fraud protection and much more based upon McAfee’s dynamic algorithm which is constantly being updated to protect your inbox against the latest threats. It does all of this right out of the box with little to no configuration required.</div>
<div class="width_1">&nbsp;</div>
<div class="width_1">Below you will find the tutorials we have written covering McAfee Email Protection, here is a link to 
   <a href="http://www.mxlogic.com/training/presentations/user_experience/index.cfm" target="_blank">McAfee's official tutorial video</a>.</div><embed src="http://www.mxlogic.com/training/presentations/user_experience/1210/Email_Protection_End_User_Experience_for_Spam_Quarantine_Report.swf" width="600" height="400" scale="aspect" controller="true">
<div class="width_1">&nbsp;</div>
	<table>
		<tr>
				...
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/everything-email/mcafee/recover-lost-password-control-console'>Recover the Lost Password for the McAfee Control Console</a>
					<div>The following article shows how to recover the lost password for the McAfee Control Console.  This option can also be used to change the Admin password.  </div>
					<div class='smallgrey'>Hits: 4,105</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/everything-email/mcafee/control-console-user'>Accessing the McAfee Control Console as an Email User</a>
					<div>In this tutorial we show you how to create a password and login to the Control Console for your McAfee Protected email.</div>
					<div class='smallgrey'>Hits: 6,097</div>
				</td>
			</tr>
		<tr><td colspan='3' style='padding-top:20px;'><h2>Working with the Allowed / Blocked Senders List</h2></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 3:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/everything-email/mcafee/allow-address'>Allowing / Whitelisting an Email Address in the McAfee Control Console</a>
					<div>In this tutorial we will show you how to add an email address to the Allowed Sender List, or Whitelist an address in the McAfee Control Console.</div>
					<div class='smallgrey'>Hits: 3,439</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/everything-email/mcafee/block-blacklist'>Blocking / Blacklisting an Email Address in the McAfee Control Console</a>
					<div>In this tutorial we show you how to add an email address to the blocked senders list (or blacklist), in the McAfee Control Console.</div>
					<div class='smallgrey'>Hits: 2,484</div>
				</td>
			</tr>
		<tr><td colspan='3' style='padding-top:20px;'><h2>Basic McAfee Options & Settings</h2></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 5:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/everything-email/mcafee/quarantine-list'>Using the Quarantined List for McAfee Email Protection</a>
					<div>This is a tutorial on how to use the McAfee Quarantine list in the Control Console.</div>
					<div class='smallgrey'>Hits: 1,412</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/everything-email/mcafee/time-zone'>Changing Your Time Zone in the McAfee Control Console</a>
					<div>This tutorial walks you through changing your time-zone setting in the McAfee Control Console.</div>
					<div class='smallgrey'>Hits: 819</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/everything-email/mcafee/changing-pasword'>Changing the Password and Security Question for the McAfee Control Console</a>
					<div>This tutorial walks you through changing the Password and Security Question in the McAfee Control Console.</div>
					<div class='smallgrey'>Hits: 1,421</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/everything-email/mcafee/language-preference'>How to Change the Language in the McAfee Control Console</a>
					<div>This is a tutorial in how to change the language your McAfee Control Console displays in.</div>
					<div class='smallgrey'>Hits: 4,062</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/everything-email/mcafee/spam-reporting'>Set How Often You Receive a McAfee Spam Report</a>
					<div>This is a tutorial on how to set your spam report frequency for the McAfee Control Console.</div>
					<div class='smallgrey'>Hits: 1,250</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/everything-email/mcafee/spam-report-format'>Setting the Format for Your McAfee Spam Report</a>
					<div>This is a tutorial on how to choose what type of email spam report you will receive when using McAfee Email Protection.</div>
					<div class='smallgrey'>Hits: 984</div>
				</td>
			</tr>
		<tr><td colspan='3' style='padding-top:20px;'><h2>Administration</h2><div>This section is for Administrators of the McAfee Email Protection.</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 11:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/everything-email/mcafee/mcafee-email'>View / Change Your McAfee Admin Email Address</a>
					<div>This is a tutorial on how to find and change your Mcafee Email address that is used for logging into the Control Console as an Administrator.</div>
					<div class='smallgrey'>Hits: 1,409</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/everything-email/mcafee/admin-login'>Accessing the McAfee Control Console as an Admin</a>
					<div>This is a tutorial on how to create your password, and how to login to the McAfee Control Console</div>
					<div class='smallgrey'>Hits: 3,809</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/everything-email/mcafee/profanity-filter'>Turning the Profanity Filter Off in the McAfee Control Console</a>
					<div>In this tutorial we will show you how to disable the profanity filter as an Administrator in the McAfee Control Console.</div>
					<div class='smallgrey'>Hits: 1,258</div>
				</td>
			</tr>
			</table>
</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMzcmaWQ9MzM3JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="fcb441cd79a0231565e63cc39bb6c044" value="1" />	</div>
	</form>
<!-- <br />
