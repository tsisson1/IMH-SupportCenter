<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50582:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/general-server-setup/indexphp-downloading-instead-of-opening-in-browser" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hi Chris, Whenever I try to open a php file the browser tries to download it instead of loading it normally. I've seen this issue a few times in the pas..." />
  <title>index.php downloading instead of opening in browser | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/general-server-setup/indexphp-downloading-instead-of-opening-in-browser" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:3ae30c5edc0156d6c0bbd9760f37d105 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '182.71.116.22']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>index.php downloading instead of opening in browser</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/BobSacamano'>BobSacamano</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-05-12 2:26 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>2,691</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>My website http://www.************.com/ is working fine, apart from the fact that when ever I try to open http://www.*************.com/rss/ instead of the browser opening the feed, it tries to download it.<br />
<br />
I tried fixing it by altering .htaccess, but that didn't seem to work.<br />
<br />
Has something changed on the server side that would account for this problem?<br />
<br />
Chris</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_1014' id='upvote_answer_1014' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='1014' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_1014').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_1014' id='downvote_answer_1014' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='1014' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_1014').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hi Chris,<br />
<br />
&lt;strong&gt;Whenever I try to open a php file the browser tries to download it instead of loading it normally.&lt;/strong&gt;<br />
<br />
I've seen this issue a few times in the past. Most of the time, the problem is due to conflicting code in your .htaccess file. I tested the URL you provided, but I was not able to replicate the issue. I assume that you were able to resolve the issue?<br />
<br />
One of the things to keep in mind is that .htaccess files are recursive. What this means, is that if your rss folder is located here:<br />
<br />
/public_html/rss<br />
<br />
... all of the following .htaccess files could be affected files in the rss folder:<br />
<br />
/public_html/rss/&lt;strong&gt;.htaccess&lt;/strong&gt;<br />
/public_html/&lt;strong&gt;.htaccess&lt;/strong&gt;<br />
/&lt;strong&gt;.htaccess&lt;/strong&gt;<br />
<br />
I'll assume you were able to resolve this issue, as I tested in several browsers and was not able to replicate the problem. If by chance you are still having an issue, feel free to post a comment at the bottom of this page with more information, and I'll be happy to look into this further.<br />
<br />
Thanks!<br />
- Brad
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_1014').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_1014' id='form_comment_on_answer_1014' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/general-server-setup/indexphp-downloading-instead-of-opening-in-browser&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/general-server-setup/indexphp-downloading-instead-of-opening-in-browser'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="d509fd4638b91a148df6ee522a797712" value="1" />	</div>
	</form>
<!-- <br />
