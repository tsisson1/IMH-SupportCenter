<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:58092:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/drupal-7/configure-rss-feeds/set-number-of-feed-items" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-07-18T18:13:35-07:00" />
  <meta name="keywords" content="set edit number of items display Drupal 7" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="This article shows you how to set the number of items displayed in each RSS feed in Drupal 7" />
  <title>How to change the number of items in an RSS feed in Drupal 7 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/drupal-7/configure-rss-feeds/set-number-of-feed-items" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:20d3d129c89768e0161e1b339bee45e1 -->
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
				<img src='/support/images/stories/drupal-partner/supporting-partner-80_3.png' style='float:right; margin:0px 0px 15px 15px;' alt='Drupal Association Support Partner'>		<h1>
															How to change the number of items in an RSS feed in Drupal 7									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>6,040</span></div>
							...
							<div style='clear:both;'></div>
								...
								<p>Part of managing your RSS Feed is managing the number of items displayed at once. This tutorial will walk you through how to set the number of displayed items in each RSS feed. To do so, simply perform the following instructions.</p>
...
<li>Using the top menu bar, click on the <strong>Configuration </strong>menu item.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Configuration/_main-dashboard-configuration.png"><img  alt="_main-dashboard-configuration" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Configuration/_main-dashboard-configuration.png" /></a></li>
<li>From the <strong>Configuration </strong>page, find the <strong>Web Services</strong> category at the lower right corner and then click on the <strong>RSS Publishing</strong> link.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Configuration/Development/Web_Services/config-web-rss.png"><img  alt="config-web-rss" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Configuration/Development/Web_Services/config-web-rss.png" /></a></li>
<li>This brings you to the <strong>RSS Publishing</strong> page. Find the <strong>Number of items in each feed</strong> dropdown. Here you can choose settings 1-20, 15, 20, 25, and 30. The feed will then display that number of the most recent items that were posted (or promoted) to the front page of your site.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Configuration/web_services/config-web-rss-items.png"><img  alt="config-web-rss-items" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Configuration/web_services/config-web-rss-items.png" /></a></li>
<li>Click the <strong>Save Configuration</strong> button at the bottom of the screen to save the changes. Below is a sample of our feed with the 4 item setting.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Configuration/web_services/rss-items-sample.png"><img  alt="rss-items-sample" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Configuration/web_services/rss-items-sample.png" /></a></li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 3: How to change the number of items in an RSS feed in Drupal 7</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 2: <a href='/support/edu/drupal-7/configure-rss-feeds/edit-rss-description'>How to Edit the RSS description in Drupal 7</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 4: <a href='/support/edu/drupal-7/configure-rss-feeds/set-rss-content-display'>How to configure RSS feed content in Drupal 7</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/drupal-7/configure-rss-feeds/set-number-of-feed-items&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/drupal-7/configure-rss-feeds/set-number-of-feed-items'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yMjAmaWQ9MTU0MyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
