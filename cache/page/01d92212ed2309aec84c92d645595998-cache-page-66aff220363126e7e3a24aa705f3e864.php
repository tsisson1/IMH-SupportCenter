<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:59671:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/drupal-7/views-module-tutorial/enable-view" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-07-27T21:41:31-07:00" />
  <meta name="keywords" content="view module enable Drupal 7" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="This article gives a very basic run through enabling a view to be used in your Drupal 7 site." />
  <title>Enabling a view in Drupal 7 Views - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/drupal-7/views-module-tutorial/enable-view" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:1c0582be0bfc8f98408c69d79a637c1e -->
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
				<img src='/support/images/stories/drupal-partner/supporting-partner-80_3.png' style='float:right; margin:0px 0px 15px 15px;' alt='Drupal Association Support Partner'>		<h1>
															Enabling a view in Drupal 7 Views									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>5,902</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jul 27, 2012'><span style='color:#606060;'>Published:</span> Jul 27, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Once you have the Views <a href="/support/edu/drupal-7/intro-to-modules/how-to-upload-a-new-module-to-drupal">module installed and enabled</a>, you may want to enable one of the stock modules, such as the Glossary or Archive views. All views are easily enabled for your site within the Drupal 7 Views module. Just follow the steps below to understand how to enable a view in Drupal 7.</p>
<p><strong>Enabling a View in the Drupal 7 Views Module<br /></strong></p>
...
<li>You are now on the Views list screen. Available Views are listed below with enabled view listed at the top above the grayed out views, which are disabled. Simply click on the <strong>Enable </strong>option to the right of your chosen View. In this case, we are going to enable the <em>Glossary </em>View.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Views/Enable_View/enable-view.png"><img  alt="enable-view" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Views/Enable_View/enable-view.png" /></a></li>
<li>Once enabled, the <em>Glossary </em>view will moved to the top and no longer be grayed out. This means it is ready to be used in your Drupal 7 site. Unlike most settings, there is no Save button to click. The view is automatically saved in its enabled status.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Views/Enable_View/enable-view-after.png"><img  alt="enable-view-after" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Views/Enable_View/enable-view-after.png" /></a><br /><br /></li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 3: Enabling a view in Drupal 7 Views</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 2: <a href='/support/edu/drupal-7/views-module-tutorial/create-view'>Creating your first View in Drupal 7</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 4: <a href='/support/edu/drupal-7/views-module-tutorial/create-block-display'>Creating a block display for a View in Drupal 7</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/drupal-7/views-module-tutorial/enable-view&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/drupal-7/views-module-tutorial/enable-view'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNDUmaWQ9MTYyOSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
