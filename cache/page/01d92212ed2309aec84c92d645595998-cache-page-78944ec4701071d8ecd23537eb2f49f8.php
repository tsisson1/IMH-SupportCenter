...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/email/attachment-size" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="It depends on the email account you have from the service or hosting provider you are using. For most platforms you can have extra plugins from third pa..." />
  <title>Attachment size | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/email/attachment-size" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:040a45159fea7c78ae17ceca14bfe704 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Attachment size</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='http://graph.facebook.com/michael.costello.3975/picture?type=normal' class='user_avatar' /><br />
			<a href='/support/community-support/users/ScottRoach'>ScottRoach</a>
			<div>8 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-05-08 12:10 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>597</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>What is the maximum attachment size for e-mail attachments?  We send and received large data and graphic files as part of our business.</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_3063' id='upvote_answer_3063' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='3063' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_3063').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_3063' id='downvote_answer_3063' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='3063' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_3063').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>9,968 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2013-05-08 12:32 pm EST
                		        </div>
					
		                </div>

				Hello ScottRoach, and thank you for your question.<br />
<br />
Our &lt;a href=&quot;http://www.inmotionhosting.com/support/email/email-troubleshooting/max-email-size&quot; target=&quot;_blank&quot;&gt;max email attachment limit&lt;/a&gt; is set at 50MB for the total attachment size of your email messages.<br />
<br />
Typically email isn't the best medium for large file transfers these days, and you might also want to take a look at collaborative file storage services such as Google Drive, DropBox, or Box, depending on your team's needs.<br />
<br />
If you had any other questions at all, please don't hesitate to let us know!<br />
<br />
- Jacob
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_3063').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_3063' id='form_comment_on_answer_3063' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Yeah, we use our own internal ftp site for really large files but a few of our customers are not tech savvy enough to figure out how to use an ftp.  I will check out the other options you suggested and see if they look appropriate.  <br />
<br />
I appreciate your help!  Knowing the limit will allow me to better determine when we should use one method over another for receiving files.</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='http://graph.facebook.com/michael.costello.3975/picture?type=normal' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/ScottRoach'>ScottRoach</a><br />
									8 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2013-05-08 12:43 pm EST
								</div>
				...
				<div style='padding:15px 15px 15px 76px; border:1px solid #ddd; border-top:0px; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>No problem at all Scott! Glad I could help.</div>
...
<div class='  not_best_answer'>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px; width:50px;' valign='top'>
<div class='vote_div'>
	<form method='post' name='upvote_answer_3062' id='upvote_answer_3062' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='3062' />
		<input type='hidden' name='component' id='component' value='qa' />
		<input type='hidden' name='vote_value' id='vote_value' value='1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_3062').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_3062' id='downvote_answer_3062' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='3062' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_3062').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					<img src='http://a0.twimg.com/profile_images/2013060147/Metal_Guru_bigger.jpg' class='user_avatar' style='max-width:60px;' /><br />
                		        <a href='/support/community-support/users/Fancys'>Fancys</a>
					
					<div>54 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2013-05-08 12:30 pm EST
                		        </div>
					
		                </div>

				It depends on the email account you have from the service or hosting provider you are using. For most platforms you can have extra plugins from third party organizations that help you send large files. You might also consider cloud hosting storage services. 
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_3062').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_3062' id='form_comment_on_answer_3062' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
					                <p>You must <a href='/support/login'>login</a> before you can post a comment about this answer.</p>
					        </div></div></div></div>
					</form>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/email/attachment-size&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/email/attachment-size'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="a473d2711e00b2d9445c422beeb21aa0" value="1" />	</div>
	</form>
<!-- <br />
