<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:59009:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-25/307-could-not-instantiate-mail-function" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-06-13T16:26:48-07:00" />
  <meta name="keywords" content="joomla 2.5 could not instantiate mail function" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="Most users can resolve the Could not instantiate mail function error by setting up Joomla 2.5 to use SMTP Authentication" />
  <title>307: Joomla 2.5 - Could not instantiate mail function - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-25/307-could-not-instantiate-mail-function" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:2369eed74e32e3f61533c93d9deb13be -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '46.234.114.127']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															307: Joomla 2.5 - Could not instantiate mail function									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>20,278</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jun 13, 2012'><span style='color:#606060;'>Published:</span> Jun 13, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Joomla 2.5 can send email using both the PHP mail() function and with standard SMTP authentication. If you try to use the standard PHP mail() function but your server does not support it, you may receive the following error:</p>
<p><strong>Could not instantiate mail function</strong></p>
<p>To resolve this issue, we recommend setting up Joomla to use SMTP Authentication rather than the PHP mail function().</p>
<table class="article_table">
<tbody>
<tr>
<th>Problem:</th>
<td>Could not instantiate mail function</td>
</tr>
<tr>
<th>Solution:</th>
<td><a href="/support/edu/joomla-25/how-to/configure-email-over-smtp">Setup Joomla to send email using SMTP Authentication</a></td>
</tr>
</tbody>
</table> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 6: 307: Joomla 2.5 - Could not instantiate mail function</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 7: <a href='/support/edu/joomla-25/308-blog-extension'>308: How to create a Joomla 2.5 Blog</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-25/307-could-not-instantiate-mail-function&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-25/307-could-not-instantiate-mail-function'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD05NyZpZD0yMzg3JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="28d408da48dc72305c47ab36120502ef" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/726138cd44066c03861276ea45b6cc0c?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/726138cd44066c03861276ea45b6cc0c'>moses</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-13 4:28 pm</div>
				                <div><p>Could not instantiate mail function</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12705);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-13 9:24 pm</div>
				                <div>Hello Moses,<br />
<br />
Did you follow the link provided as a solution to this error?<br />
<a href="http://www.inmotionhosting.com/support/edu/joomla-25/how-to/configure-email-over-smtp">Setup Joomla to send email using SMTP Authentication</a><br />
<br />
If that did not work, please comment on that article with any specific issues you had so we can assist you.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12709);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
