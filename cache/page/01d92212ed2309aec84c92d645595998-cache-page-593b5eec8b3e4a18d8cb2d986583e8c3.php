<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:60230:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-3/create-component/menu-item" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-05-22T18:22:07-07:00" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="InMotion Hosting Support Center" />
  <title>Creating a Menu Item for your Joomla 3 Component - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-3/create-component/menu-item" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:b61a78048b44ea150283970da479de59 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Creating a Menu Item for your Joomla 3 Component									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>8,703</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: May 22, 2014'><span style='color:#606060;'>Published:</span> May 22, 2014</div>
...
<p>So far in <a href="/support/edu/joomla-3/create-component">this tutorial series</a> we've been testing our new component by visiting our Joomla site and adding <span style='color:red;'>index.php?option=com_helloworld</span> to the url, as in:</p>

<p class="white_box">http://example.com/<span style="color:red;">index.php?option=com_helloworld</span></p>

<p>In this tutorial, we will show you how to create a <a href="/support/edu/joomla-3/menu/menu-item-types">menu item</a> for your component. This will allow you to add a link to your menu that points to your component with a URL similar to:</p>

<p class="white_box">http://example.com/<span style="color:red;">hello-world</span></p>

<h2>To create a menu item:</h2>

<ol class='article_list'>
  <li><strong>Decide which view</strong><br /><br />Components can have multiple <a href="/support/edu/joomla-3/create-component/add-new-view">views</a>. Decide on which view you want to create a menu item for.</li>
  <li><strong>Go to tmpl folder</strong><br /><br />Navigate to the <strong>tmpl</strong> folder of the view you chose in step 1.</li>
  <li><strong>Create default.xml</strong><br /><br />Create a default.xml file in the tmpl folder with the following text:
    <pre class='code_block'>&lt;?xml version="1.0" encoding="utf-8"?&gt;
&lt;metadata&gt;
        &lt;layout title="<span style='color:red;'>Title</span>"&gt;
                &lt;message&gt;<span style='color:red;'>message</span>&lt;/message&gt;
        &lt;/layout&gt;
&lt;/metadata&gt;</pre>
    <p></p>
    <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/create-component/title-and-message-of-menu-item.png"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/create-component/title-and-message-of-menu-item.png"  style="float:right; margin:0px 0px 15px 15px;" /></a>
    <p>When going through the process of creating a menu item, the <strong>Title</strong> and <strong>message</strong> in the code above will be shown in the listing of item types (as in the screenshot to the right):</p>
    <div style='clear:both;'></div>
  </li>
</ol>

<h2>Testing our new menu item</h2>

<p>The whole process thus far of creating a new menu item for our component has been actually quite easy. If everything's not "clicking" yet for you, review the following screenshot (<em>hopefully it'll tie everything together</em>).</p>

<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/create-component/follow-route-of-component-menu-item-creation.png"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/create-component/follow-route-of-component-menu-item-creation.png"  style='max-width:100%; max-height:500px;' /></a>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 7: Creating a Menu Item for your Joomla 3 Component</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 8: <a href='/support/edu/joomla-3/create-component/add-new-model'>How to add the default Model to your Joomla 3 component</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-3/create-component/menu-item&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-3/create-component/menu-item'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD01MDcmaWQ9MzI1MSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
