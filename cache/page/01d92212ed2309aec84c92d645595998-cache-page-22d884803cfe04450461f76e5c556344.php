<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:60959:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/drupal-8/108-managing-images-in-drupal-8/set-max-upload-size" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-11-27T15:55:40-08:00" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Learn how to set the maximum file upload size for a content type's image field in Drupal 8." />
  <title>Setting max file upload size in Drupal 8 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/drupal-8/108-managing-images-in-drupal-8/set-max-upload-size" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:37288fc7299fb914390edf44199322b9 -->
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
				<img src='/support/images/stories/drupal-partner/supporting-partner-80_3.png' style='float:right; margin:0px 0px 15px 15px;' alt='Drupal Association Support Partner'>		<h1>
															Setting max file upload size in Drupal 8									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>940</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Nov 27, 2013'><span style='color:#606060;'>Published:</span> Nov 27, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>When working with images, you may want to restrict them in ways that will help keep your site optimized. While you may <a href="/support/edu/drupal-8/108-managing-images-in-drupal-8/set-max-min-size">limit them in physical size</a>, you may also want to restrict them as far as maximum file size. This will force the node creators to optimize images if they exceed the limit even if they fit within any size restrictions you may have set..</p>

<h2>How to set maximum file upload size in Drupal 8</h2>
...
<ol class="article_list">
  ...
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/_common-images/select-menu.png"><img  style="float:right; margin:0px 0px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/_common-images/select-menu.png" title="Click here to view the larger image" width="200" /></a>
  Using the top menu bar, <strong>Menu</strong> Tab.<div style="clear:both;"></div></li>

  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/_common-images/select-structure.png"><img  style="float:right; margin:0px 0px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/_common-images/select-structure.png" title="Click here to view the larger image" width="200" /></a>
  Now a second menu bar will appear. Click on the <strong>Structure</strong> tab to continue.<div style="clear:both;"></div></li>
  
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/_common-images/select-content-type.png"><img  style="float:right; margin:0px 0px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/_common-images/select-content-type.png" title="Click here to view the larger image" width="200" /></a>
  From here, click on the <strong>Content Types</strong> option from the <em>Structure</em> page.
  <div style="clear:both;"></div></li>

  <li>
  <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/108/set-size-settings/1-select-manage-fields.png"><img  style="float:right; margin:0px 0px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/108/set-size-settings/1-select-manage-fields.png" title="Click here to view the larger image" width="200" /></a>
  Now that you are on the <em>Content Types</em> page, find the content type you want to set the image settings for. In our example, we will work with the <em>Article</em> type.  Look tot he dropdown ont he right side of the <em>Article</em> row and Click on <strong>Manage Fields</strong>.<div style="clear:both;"></div></li>
  
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/108/set-size-settings/2-select-edit.png"><img  style="float:right; margin:0px 0px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/108/set-size-settings/2-select-edit.png" title="Click here to view the larger image" width="200" /></a>
  You are now taken to the <em>Manage Fields</em> page. From here you see a list of the current fields for <em>Article</em> content types. Click on the <strong>Edit</strong> option from the dropdown to the right side of the <em>Image</em> field row.<div style="clear:both;"></div></li>

  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/108/set-max-upload-filesize/4-set-max-filesize.png"><img  style="float:right; margin:0px 0px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/108/set-max-upload-filesize/4-set-max-filesize.png" title="Click here to view the larger image" width="200" /></a>
   The <em>Image Settings</em> page appears, where you will need to find the <strong>Maximum Upload Size</strong> field. Here you can enter the maximum size you want any uploaded files to be. You may set the size by kb, MB, orFor our example, we are setting them at 2MB. 
   <div style="clear:both;"></div>
    <div class="alert"><strong style="color:red">Note:</strong>The maximum size entered here must first pass the settings in your php.ini file. This size setting is noted under the field itself. If you set a size here that is larger than the php.ini file setting, the file will be restricted by the php.ini setting. You may need to <a href="/support/website/php/update-local-php-settings">change your <strong>upload_max_filesize</strong> setting in your php.ini</a> as well.</div>
   
   <div style="clear:both;"></div></li>

  <li>Once you have entered your size restrictions for either one or both fields, click on the <strong>Save Settings</strong> button. Your new filesize settings will now be active.<div style="clear:both;"></div></li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/drupal-8/108-managing-images-in-drupal-8'>108: Managing Images in Drupal 8</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 5: Setting max file upload size in Drupal 8</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 4: <a href='/support/edu/drupal-8/108-managing-images-in-drupal-8/set-max-min-size'>Setting max and min upload sizes for images in Drupal 8</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 6: <a href='/support/edu/drupal-8/108-managing-images-in-drupal-8/add-subfolder'>Adding a subfolder to image upload directories in Drupal 8</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/drupal-8/108-managing-images-in-drupal-8/set-max-upload-size&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/drupal-8/108-managing-images-in-drupal-8/set-max-upload-size'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NzkmaWQ9MzAwNiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="5a40433054911f7f131a09700bf22513" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/drupal-8/108-managing-images-in-drupal-8?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Managing Images in Drupal 8</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/drupal-8/108-managing-images-in-drupal-8/create-default?tsrc=rsbedu'>Creating a default image for content types in Drupal 8</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/drupal-8/108-managing-images-in-drupal-8/enable-image-field?tsrc=rsbedu'>Enabling the image field for content types in Drupal 8</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/drupal-8/108-managing-images-in-drupal-8/adjust-types-allowed?tsrc=rsbedu'>Adjusting the image types allowed in Drupal 8</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/drupal-8/108-managing-images-in-drupal-8/set-max-min-size?tsrc=rsbedu'>Setting max and min upload sizes for images in Drupal 8</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/drupal-8/108-managing-images-in-drupal-8/set-max-upload-size?tsrc=rsbedu'>Setting max file upload size in Drupal 8</a></td>
                </tr>
          <tr >
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/drupal-8/108-managing-images-in-drupal-8/add-subfolder?tsrc=rsbedu'>Adding a subfolder to image upload directories in Drupal 8</a></td>
                </tr>
          	</table>
