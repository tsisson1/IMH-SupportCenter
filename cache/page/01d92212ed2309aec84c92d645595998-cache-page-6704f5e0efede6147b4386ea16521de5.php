<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:51692:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/cpanel/need-help-for-restoring-my-backuptargz-to-new-server" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, Thank you for your question on restoring a large database backup. You can attempt to bypass the 50MB limit for shared servers by installing your ..." />
  <title> Need help for restoring my backup.tar.gz to new server | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/cpanel/need-help-for-restoring-my-backuptargz-to-new-server" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:f600aec6815737b8550c480a1bab5edd -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'> Need help for restoring my backup.tar.gz to new server</h1>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_7010' id='upvote_answer_7010' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='7010' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_7010').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_7010' id='downvote_answer_7010' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='7010' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_7010').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello, <br />
<br />
Thank you for your question on restoring a large database backup. You can attempt to bypass the 50MB limit for shared servers by installing your own phpMyAdmin instance. We have an article that explains that <a href="http://www.inmotionhosting.com/support/website/database-setup/upload-large-database-over-50-mb">here</a>. Also, you can <a href="http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support">FTP</a> the file up to your account and then have our <A href="http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support">Support Team</a> restore it for you.<br />
<br />
Kindest Regards,<br />
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_7010').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_7010' id='form_comment_on_answer_7010' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/cpanel/need-help-for-restoring-my-backuptargz-to-new-server&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/cpanel/need-help-for-restoring-my-backuptargz-to-new-server'></div>
<script type='text/javascript'>
  (function() {
