<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:51161:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/databases/too-many-connections" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello SergeyGorbachov, Thank you for your question. You are on a shared server, which limits the amount of simultaneous database connections, flushing t..." />
  <title>Too many connection errors - can I run 'mysqladmin flush-hosts' | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/databases/too-many-connections" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:a948bff0694e59370a79145610f8b264 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '121.242.90.60']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Too many connection errors - can I run 'mysqladmin flush-hosts'</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='http://graph.facebook.com/sergey.gorbachov.96/picture?type=normal' class='user_avatar' /><br />
			<a href='/support/community-support/users/SergeyGorbachov'>SergeyGorbachov</a>
			<div>73 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-09-18 9:54 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>8,193</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Host '***.**.*.***' is blocked because of many connection errors; unblock with 'mysqladmin flush-hosts'.<br />
<br />
How I can unblocked my IP?</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_3981' id='upvote_answer_3981' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='3981' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_3981').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_3981' id='downvote_answer_3981' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='3981' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_3981').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>22,986 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2013-09-18 11:31 am EST
                		        </div>
					
		                </div>

				Hello SergeyGorbachov,<br />
<br />
Thank you for your question. You are on a shared server, which limits the amount of simultaneous database connections, flushing this ('mysqladmin flush-hosts') will clear the whole list on the server.<br />
<br />
To accomplish this, you would have to be on a <a href="http://www.inmotionhosting.com/vps-hosting" target="_blank" >VPS</a> or <a href="http://www.inmotionhosting.com/dedicated-servers" target="_blank" >Dedicated server</a>.<br />
<br />
I recommend limiting the amount of simultaneous connections you are making, or closing one when you open a new one.<br />
<br />
For more detailed assistance regarding your connections, <a href="http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support" target="_blank" >contact live tech Support</a>, so they can review your logs and provide a specific answer:<br />
They are available 24/7 via:<br />
Email: support@inmotionhosting.com<br />
Phone: 888-321-HOST (4678)	 x2<br />
&<br />
Chat (there is a link on the top right).<br />
<br />
Thank you,<br />
<br />
-John-Paul
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_3981').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_3981' id='form_comment_on_answer_3981' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>HI Im having the same issue but I dont believe Im on a shared server.</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='https://lh4.googleusercontent.com/-b6PLi3-Cdi8/AAAAAAAAAAI/AAAAAAAAADg/IOiWr2OG1Rw/photo.jpg?sz=90' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/MrFlow'>MrFlow</a><br />
									8 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2014-03-09 6:57 pm EST
								</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/databases/too-many-connections&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/databases/too-many-connections'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="a40903653281d879a13e2982f58745f3" value="1" />	</div>
	</form>
<!-- <br />
