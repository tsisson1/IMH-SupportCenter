<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50301:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/moodle/how-do-i-correct-an-error-while-attempting-to-reinstall-moodle-using-fantastico" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hi billwilson, Thanks for posting your question. I'm more than happy to assist you. If you install software using Fantastico, you must remove the instal..." />
  <title>How do I correct an error while attempting to re-install Moodle using Fantastico? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/moodle/how-do-i-correct-an-error-while-attempting-to-reinstall-moodle-using-fantastico" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:b0c2cba3f40594e6cc12b51e34021adf -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>How do I correct an error while attempting to re-install Moodle using Fantastico?</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/billwilson'>billwilson</a>
			<div>15 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2011-12-31 7:29 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>5,322</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I uninstalled and reinstalled my Moodle site using Fantastico.  I am now getting the following error:<br />
<br />
<br />
The installation can not be completed:<br />
<br />
- You cannot install more than one script in the root directory of a domain.<br />
<br />
I thought I had completely uninstalled and I see no Moodle files or directories in the file manager.  This is the only thing I installed with Fantastico.  </div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_356' id='upvote_answer_356' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='356' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_356').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_356' id='downvote_answer_356' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='356' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_356').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hi billwilson,<br />
<br />
Thanks for posting your question. I'm more than happy to assist you. If you install software using Fantastico, you must remove the installation through Fantastico as well. If you do not do this critical step, it will produce the error you got. Basically, Fantastico has a file called "installed_in_root". This file needs to be modified and you would need to remove the entry for the Moodle installation. Once you do this, you'll be able to re-install the software.<br />
<br />
I'm more than happy to assist you with this. Please feel free to contact us if you need further assistance.<br />
<br />
Thanks!<br />
<br />
Tim S<br />
<br />
<div style="border: 1px solid #B85F00; padding: 4px; margin-bottom: 10px; background: #FFF0E0;">Fantastico, a feature in cPanel that helps you easily install programs to your account, is no longer available. As of September 17<sup>th</sup>, 2012, Fantastico has been replaced by <a href="/support/component/content/news/general/softaculous?Itemid=237">Softaculous</a>.<br /><br /> This article is being kept in our Support Center for our VPS and Dedicated Customers who may still be using Fantastico. For all other users, please see our <a href="/support/edu/cpanel/softaculous/how-to-install">Softaculous software installation guide</a> for more help with installing programs such as WordPress and Joomla.</div>
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_356').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_356' id='form_comment_on_answer_356' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/moodle/how-do-i-correct-an-error-while-attempting-to-reinstall-moodle-using-fantastico&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/moodle/how-do-i-correct-an-error-while-attempting-to-reinstall-moodle-using-fantastico'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP2RvPWFuc3dlciZvcHRpb249Y29tX2NvbW11bml0eXN1cHBvcnQmSXRlbWlkPTEwMDAy" />
		<input type="hidden" name="7bfeca6c794da1b4f1761af9b41a1989" value="1" />	</div>
	</form>
<!-- <br />
