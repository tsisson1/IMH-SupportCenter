<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:55430:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/php-nuke/php-nuke-modules-blocks/module-management" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-03-22T18:14:28-07:00" />
  <meta name="keywords" content="manage activate deactivate module PHP-Nuke" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Learn how to activate or deactivate modules for your PHP-Nuke site with this short tutorial." />
  <title>How to manage modules from the sidebar  - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/php-nuke/php-nuke-modules-blocks/module-management" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:d5c6f1e3c28b09306614408a19032b04 -->
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/php-nuke' itemprop='url'><span itemprop='title'>PHP-Nuke<span></a><div class='dropdown_2columns'><h2>PHP-Nuke Education Channel</h2><div class='col_2'><h3>100 Level Classes</h3><div><a href='/support/edu/php-nuke/getting-started-php-nuke'>101: Getting Started: PHP-Nuke</a></div><div><a href='/support/edu/php-nuke/add-content-php-nuke'>102: Adding the content to PHP-Nuke</a></div><div><a href='/support/edu/php-nuke/php-nuke-modules-blocks'>103: PHP-Nuke Modules and blocks</a></div><div><a href='/support/edu/php-nuke/change-php-nuke-appearance'>104: Changing the PHP-Nuke Appearance</a></div><div><a href='/support/edu/php-nuke/webstats-reporting-php-nuke'>105: PHP-Nuke Web stats and reporting</a></div><div><a href='/support/edu/php-nuke/php-nuke-statistics-reporting'>106: PHP-Nuke Backups and Site security</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/php-nuke/php-nuke-modules-blocks' itemprop='url'><span itemprop='title'>103: PHP-Nuke Modules and blocks<span></a><div class='dropdown_3columns'><h2> PHP-Nuke Modules and blocks</h2><div class='col_3'><div>1. <a style='display:inline;' href='/support/edu/php-nuke/php-nuke-modules-blocks/how-to-create-a-block-in-php-nuke'>How to create a block in PHP-Nuke</a></div><div>2. <a style='display:inline;' href='/support/edu/php-nuke/php-nuke-modules-blocks/module-management'>How to manage modules from the sidebar </a></div><div>3. <a style='display:inline;' href='/support/edu/php-nuke/php-nuke-modules-blocks/add-a-new-custom-module-in-php-nuke'>Add new custom module in PHP-Nuke</a></div><div>4. <a style='display:inline;' href='/support/edu/php-nuke/php-nuke-modules-blocks/removing-modules'>Removing Modules from the Menu PHP-Nuke</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to manage modules from the si...</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to manage modules from the sidebar 									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>695</span></div>
							...
							<div style='clear:both;'></div>
								...
								<p>Within PHP-Nuke, you will see there are many different content modules on the sidebar. You have the ability to add and remove them from within the administration panel. Follow the steps below as we demonstrate how to enable or disable modules in your PHP-Nuke site.</p>
<h2>Managing modules in PHP-Nuke</h2>
<ol class="article_list">
<li>Log into the <a href="/support/website/php-nuke/login-administrator-system">PHP-Nuke administrative interface</a>.
<div style="clear: both;">&nbsp;</div>
</li>
<li>From the main admin page, find and click on the <strong>Modules</strong> icon from the <em>Administration Menu</em>.
<div style="clear: both;">&nbsp;</div>
</li>
<li>The list of modules will appear below the menus. From here you can see all the modules, both active and inactive. The active icons appear as a set ot two gears, while the inactive modules appear as the same set of gears with a red block. Find your desired module and click on the icon in the <em>Functions</em> column. In this example, we will activate the <em>Content</em>module.
<div style="clear: both;">&nbsp;</div>
</li>
<li>After clicking on the icon for activation/deactivation, the screen will refresh displaying the current status. In our example, the <em>Content</em>module now lists in the sidebar of our website. Below is a before and after comparison.
<div style="clear: both;">&nbsp;</div>
...
<tr></tr>
<tr>
<td>&nbsp;<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phpnuke/manage-modules/before.png"><img style="max-width: 250px;"  alt="before the module addition" src="//cdn.inmotionhosting.com/support/images/stories/edu/phpnuke/manage-modules/before.png" /></a></td>
<td>&nbsp;<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phpnuke/manage-modules/after.png"><img style="max-width: 250px;"  alt="after the module addition" src="//cdn.inmotionhosting.com/support/images/stories/edu/phpnuke/manage-modules/after.png" /></a></td>
</tr>
</tbody>
</table>
</li>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/php-nuke/php-nuke-modules-blocks'>103: PHP-Nuke Modules and blocks</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 2: How to manage modules from the sidebar </div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 1: <a href='/support/edu/php-nuke/php-nuke-modules-blocks/how-to-create-a-block-in-php-nuke'>How to create a block in PHP-Nuke</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 3: <a href='/support/edu/php-nuke/php-nuke-modules-blocks/add-a-new-custom-module-in-php-nuke'>Add new custom module in PHP-Nuke</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/php-nuke/php-nuke-modules-blocks/module-management&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/php-nuke/php-nuke-modules-blocks/module-management'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zNjMmaWQ9NjUzJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="eac17bcec7730f5c0d868790c945be35" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/php-nuke/php-nuke-modules-blocks?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> PHP-Nuke Modules and blocks</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/php-nuke/php-nuke-modules-blocks/how-to-create-a-block-in-php-nuke?tsrc=rsbedu'>How to create a block in PHP-Nuke</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/php-nuke/php-nuke-modules-blocks/module-management?tsrc=rsbedu'>How to manage modules from the sidebar </a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/php-nuke/php-nuke-modules-blocks/add-a-new-custom-module-in-php-nuke?tsrc=rsbedu'>Add new custom module in PHP-Nuke</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/php-nuke/php-nuke-modules-blocks/removing-modules?tsrc=rsbedu'>Removing Modules from the Menu PHP-Nuke</a></td>
                </tr>
          	</table>
