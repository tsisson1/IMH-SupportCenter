<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:71990:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/databases/how-to-change-mysql-server-time-zone" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-11-26T19:23:30-08:00" />
  <meta name="keywords" content="convert change mysql time timezone timestamp" />
  ...
  <link href="http://www.inmotionhosting.com/support/website/databases/how-to-change-mysql-server-time-zone" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:638850e2f5b6155342bcf473fa322195 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-22']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '185.70.174.28']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to change MySQL server time zone</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to change MySQL server time zone									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>71,837</span></div>
							...
							<div style='clear:both;'></div>
								...
								<p>In this article we'll discuss how you can change the MySQL time zone on your server so that data stored in your databases will by default use the time zone that you have specified.</p>
...
<p>This change would require <a href="/support/website/general-server-setup/root-access-faq">root access</a> to either a VPS (Virtual Private Server) or dedicated server hosting plan, or you can contact our support department to have this changed on your server. You might also simply need to know <a href="/support/website/databases/how-to-convert-mysql-time">how to convert MySQL time</a>&nbsp;which wouldn't require root access and can be done on a shared server.</p>
<ol class="article_list">
<li><a href="/support/website/general-server-setup/how-to-login-ssh">Login to your server via SSH</a> as the root user.</li>
<li>You can view MySQL's current time zone settings using the following command from the console:<br /><br /> <span class="code_block">mysql -e "SELECT @@global.time_zone;"</span>
<p>By default you should get back something similar to:</p>
...
<p>This is because by default your MySQL time zone will be set to the server's default <strong>SYSTEM</strong> time. If you're interested in changing the entire server's time zone this can be accomplished by <a href="/support/website/general-server-setup/setting-the-server-time-zone-in-whm">setting the time zone in WHM</a>.</p>
</li>
<li>You can see the server's <strong>SYSTEM</strong> time stamp using the following command:<br /><br /> <span class="code_block">date</span>
<p>Which will give back:</p>
<span class="code_block">Mon Nov 26 12:50:07 EST 2012</span><br /><br /></li>
<li>You can see the current time stamp reported by the MySQL server using the following command:<br /><br /> <span class="code_block">mysql -e "SELECT NOW();"</span>
<p>This should give back the current time stamp:</p>
<pre class="code_block" style="width: 500px;">+---------------------+
| NOW()               |
+---------------------+
| 2012-11-26 12:50:15 |
...
<li>Now you can edit your MySQL configuration file with your favorite text editor:<br /><br /> <span class="code_block">vi /etc/my.cnf</span>
<p>Then add the following line to change from EST (<strong>GMT -5:00</strong>) to CST (<strong>GMT -6:00</strong>):</p>
<span class="code_block">default-time-zone = '-06:00'</span>
<p>Now save the <strong>/etc/my.cnf</strong> file with your new default.</p>
</li>
<li>To make the change active you'll want to restart the MySQL service with the following command:<br /><br /> <span class="code_block">service mysql restart</span><br /><br /></li>
<li>Now if you try to see the global time zone setting again with the command:<br /><br /> <span class="code_block">mysql -e "SELECT @@global.time_zone;"</span>
<p>You should now get back your new default:</p>
<pre class="code_block" style="width: 500px;">+--------------------+
| @@global.time_zone |
+--------------------+
| -06:00             |
...
<li>You should also see now that the <strong>NOW()</strong> function has updated as well:<br /><br /> <span class="code_block">mysql -e "SELECT NOW();"</span>
<p>This should give back the current time stamp:</p>
<pre class="code_block" style="width: 500px;">+---------------------+
| NOW()               |
+---------------------+
...
<p>You should now know how to update the MySQL server's time zone setting, to help make sure the data stored in databases is easy for you to work with. You can also used named time zones instead of the <strong>GMT -6:00</strong> format, but this would first require you loading the time zone tables into the <strong>mysql</strong> database. More information on this can be found on the MySQL site regarding <a href="http://dev.mysql.com/doc/refman/5.1/en/mysql-tzinfo-to-sql.html" rel="nofollow">mysql_tzinfo_to_sql and loading the time zone tables</a>.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/databases/how-to-change-mysql-server-time-zone&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/databases/how-to-change-mysql-server-time-zone'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMyZpZD00NzMmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="f0aebed92b8050dad979cac1b956b92f" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/5971d762b09c3e604edf1dfc632badc8?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/5971d762b09c3e604edf1dfc632badc8'>SanX</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-27 4:46 am</div>
				                <div><p>$ sudo service mysql starterror: Found option without preceding group in config file: /etc/my.cnf at line: 1Fatal error in defaults handling. Program aborted</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12054);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-27 7:56 am</div>
				                <div>Hello SanX,<br />
<br />
Thank you for contacting us. I am not sure what you are asking, but we are happy to help.<br />
<br />
Can you provide more details, such as a link to the error, or the steps you are taking to see it?<br />
<br />
What type of CMS are you using? For example Joomla, Wordpress, Concrete5, etc.<br />
<br />
If you have any further questions, feel free to post them below.<br />
Thank you,<br />
<br />
-John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12062);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-21856'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/63b0ac308bb84ffba263db5c7b8b4924?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/63b0ac308bb84ffba263db5c7b8b4924'>waerfsdrf</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-19 5:40 am</div>
				                <div>nice its helpfull to me. Thanks</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21856);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-26762'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/24ef5c671efde80290bed45fab935977?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/24ef5c671efde80290bed45fab935977'>Maggie</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-17 9:49 pm</div>
				                <div><p>For anyone reading this, my.cnf should look something like this (unless you have other configurations):</p>
<p>&nbsp;</p>
<pre>[mysqld]
default-time-zone = 'Etc/UTC'
</pre>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26762);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-31634'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/ee737d3bb624151ef9e76ab91618b194?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/ee737d3bb624151ef9e76ab91618b194'>Divy Shah</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-01 5:00 pm</div>
				                <div><p>It worked like charm.</p>
<p>Thank You Very Much!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31634);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
