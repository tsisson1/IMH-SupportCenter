<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:81703:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/prestashop-15/set-configure-catalog-modes/enable-error-reporting" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-02-17T19:50:48-08:00" />
  <meta name="keywords" content="enable turn on error reporting PrestaShop 1.5 debug troubleshoot" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="This PrestaShop 1.5 tutorial explains how to turn on error reporting for troubleshooting and debugging." />
  <title>How to turn on error reporting in PrestaShop 1.5 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/prestashop-15/set-configure-catalog-modes/enable-error-reporting" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:f56fd92ace67909c9a847ed95118bdd3 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '90.225.120.42']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to turn on error reporting in PrestaShop 1.5									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>31,577</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jun 22, 2012'><span style='color:#606060;'>Published:</span> Feb 17, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>When developing your store, there may be times when you run into problems and need to see the error messages. By default, error reporting is turned off. This prevents error messages from being displayed in the browser. Enabling the error reporting will allow the message to display in the browser to give you an idea of there the problem may lie. This is a very handy tool when debugging or troubleshooting any odd store behavior. Turning on error reporting in PrestaShop 1.5 is fairly simple and is described below.</p>
<h2>Enabling error reporting in PrestaShop 1.5</h2>
<ol class="article_list">
  <li>Log into your hosting admin dashboard, <a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">control panel</a>, SSH, or FTP client.</li>
<li>Navigate to the PrestaShop 1.5 root folder.</li>
<li>From there, navigate the path <strong>/config/defines.inc.php</strong></li>
<li>Open up the <strong>defines.inc.php</strong> file in your preferred text editor.</li>
<li>Find the line of code that reads "<strong>@ini_set('display_errors', 'off')</strong>"&nbsp; This is line 39 by default as of PrestaShop 1.5.6</li>
<li>Change it to read "<strong>@ini_set('display_errors', 'on')</strong>"</li>
<li>Save the <strong>config.inc.php</strong> file back to the path, overwriting the existing file if needed.</li>
</ol>
<p></p>
<p class="alert"><strong style="color:red;">NOTE:</strong> Be sure to turn it back off once you do not need it, this is for troubleshooting only!</p>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/prestashop-15/set-configure-catalog-modes'>112: Setting and Configuring Catalog Modes</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 7: How to turn on error reporting in PrestaShop 1.5</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 6: <a href='/support/edu/prestashop-15/set-configure-catalog-modes/setting-search-engine-friendly-urls'>How to set up Search Engine Friendly URLs in PrestaShop 1.5</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/prestashop-15/set-configure-catalog-modes/enable-error-reporting&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/prestashop-15/set-configure-catalog-modes/enable-error-reporting'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yOTEmaWQ9MTI0OCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="26914ce6576eb8375ca2f840557773dd" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/prestashop-15/set-configure-catalog-modes?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Setting and Configuring Catalog Modes</h3></a>
		<table><tr><td colspan='2'><h4>Modes</h4></td></tr>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/prestashop-15/set-configure-catalog-modes/set-catalog-mode?tsrc=rsbedu'>How to set Catalog Mode in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/prestashop-15/set-configure-catalog-modes/enable-b2b-mode?tsrc=rsbedu'>How to enable B2B mode in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/prestashop-15/set-configure-catalog-modes/how-to-set-maintenance-mode-in-prestashop-15?tsrc=rsbedu'>How to set Maintenance mode in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/prestashop-15/set-configure-catalog-modes/redirection-after-adding-product?tsrc=rsbedu'>Changing Page Redirection After Adding Products in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/prestashop-15/set-configure-catalog-modes/show-previous-shopping-cart?tsrc=rsbedu'>How to show the last shopping cart in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/prestashop-15/set-configure-catalog-modes/setting-search-engine-friendly-urls?tsrc=rsbedu'>How to set up Search Engine Friendly URLs in PrestaShop 1.5</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>7.</td>
                        <td><a href='/support/edu/prestashop-15/set-configure-catalog-modes/enable-error-reporting?tsrc=rsbedu'>How to turn on error reporting in PrestaShop 1.5</a></td>
                </tr>
          	</table>
			...
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/prestashop-15/prestashop-no-front-or-back-office-access-after-server-upgrade-white?tsrc=rsbraq'>prestashop no front or back office access after server upgrade (white)</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='https://lh4.googleusercontent.com/-nvDFIZzOcwI/AAAAAAAAAAI/AAAAAAAAAAA/4SAPI7E8YGQ/photo.jpg?sz=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='/support/community-support/users/LuisKCRs'>LuisKCRs</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-11-03 9:15 am</div>
				                <div>I can not find that line code you say in Step 5. The more closes to that is:<br />
 /* Improve PHP configuration to prevent issues */<br />
ini_set('upload_max_filesize', '100M');<br />
ini_set('default_charset', 'utf-8');<br />
ini_set('magic_quotes_runtime', 0);<br />
<br />
I am using the default theme but an upgrade of my ISP to PHP and MySQL broke the normal behavior of my shop and they say I have to upgrade too.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8345);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-11-04 11:23 am</div>
				                <div>Hello LuisKCRs,<br />
<br />
Thank you for finding the error in our article. Things have changed since the original writing. I have edited the article with the correct information so you should now be able to follow it with confidence. Thank you!<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8346);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-11-04 11:50 am</div>
				                <div>Hey, thanks! ... I just found it. :)</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8347);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-9165'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/1e80b9d1dac535c590afc63d5ff15cb4?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/1e80b9d1dac535c590afc63d5ff15cb4'>MAx</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-24 5:37 pm</div>
				                <div><p>Step 7: replace config.inc.php with defines.inc.php</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9165);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-13565'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/8ba31677d7eb8a20cf223691b4db2edd?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/8ba31677d7eb8a20cf223691b4db2edd'>Fernando</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-02 3:44 am</div>
				                <div><p>There is an error. The&nbsp;code&nbsp;@ini_set('display_errors', 'off') is at config.ini.php file.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13565);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-04 9:38 am</div>
				                <div>Hello Fernando,<br />
<br />
That was changed at some point in the lifespan of PrestaShop 1.5. While it used to be located in the config.inc.php, it is now in the defines.inc.php file. <br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13605);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-14135'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/c152b19b6140bd0a03d3c0800d80642b?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/c152b19b6140bd0a03d3c0800d80642b'>Victor</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-19 10:32 pm</div>
				                <div><p>am using prestashop 1.5 and having been using the back office for some time now and there was no problem all of a sudden when i upload a new payment module i downloaded online, it started given me errors when opening the module page at the back office, so now i cant access my module page on my back office....... it says</p>
<p>[PrestaShop] Fatal error in module widget:Call to undefined function add_action()</p>
<p>and gives me a url page</p>
<p>index.php?controller=AdminModules&amp;token=ade34b9297fb4614d71a99c8efd3c016</p>
<p>Please any help with what i have to do to solve this?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14135);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-20 10:56 am</div>
				                <div>Hello,<br />
<br />
The php error you received means that the program is looking for a function that somehow does not exist. Without having access to the module list, it is impossible to delete the offending module from within the back office.<br />
<br />
If you are CERTAIN of which module is causing the error, you may want to remove it from the database. I have a list of scripts below that will do that, however it will completely remove the module from the database and it will no longer show in the list of modules once you gain access to that area.<br />
<br />
First, you need the module ID from the database. To find that you need to access your phpMyAdmin and look in the ps_module table. Find the name of the module and look at the column id_module. The number there is the module id to be used in place of the # below. Run each statement individually.  I got an error on the one running against the ps_module_exceptions table, but there were no rows in that table. You can also delete the rows manually from within the phpMyAdmin interface (under the Browse feature, then click the delete button on the relevant row) if you choose. Just be sure to look through all the tables listed to remove any reference to the module.<br />
<br />
<div class="code_block">DELETE from ps_module WHERE id_module = #;<br />
DELETE from ps_module_access WHERE id_module = #;<br />
DELETE from ps_module_country WHERE id_module = #;<br />
DELETE from ps_module_currency WHERE id_module = #;<br />
DELETE from ps_module_group WHERE id_module = #;<br />
DELETE from ps_module_preference WHERE id_module = #;<br />
DELETE from ps_module_shop WHERE id_module = #;<br />
DELETE from ps_hook_module WHERE id_module = #;<br />
DELETE from ps_hook_module_exceptions WHERE id_module = #;</div><br />
<br />
Keep in mind this will completely remove the module from PrestaShop so you will not be able to activate it again. This is an extreme measure but the only answer I currently have to remove a module from PrestaShop manually. Please do not do this unless you are certain that it is that module causing the error and you do not want to try and use it again.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14152);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-15837'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/263745582a0718a5b21fb96e0f4d6aed?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/263745582a0718a5b21fb96e0f4d6aed'>Garry</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-03 6:50 am</div>
				                <div><p>In prestashop - when saving a products the screen goes blank with some =404</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15837);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-03 9:24 am</div>
				                <div>Hello Garry,<br />
<br />
Have you followed the instructions above to enable the error reporting? What error are you getting?<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15840);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
