<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:56620:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/email-client-setup/my-outlook-2013-can-write-email-and-send-them-but-not-receive-email" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Hubumct, What do you see when you try checking your email with webmail? Have you tried removing your account from outlook and setting outlook back..." />
  <title>My outlook 2013 can write email and send them, but not receive email | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/email-client-setup/my-outlook-2013-can-write-email-and-send-them-but-not-receive-email" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:2ef012431e8a60f07037a563adc5a392 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '41.150.205.152']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>My outlook 2013 can write email and send them, but not receive email</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/M&per;Giroux'>M.Giroux</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-08-19 11:05 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>66,982</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Since last thursday, i cannot receive my email in my outlook. I did not change anything that I am aware of. How could that happended.<br />
<br />
I can still send email from outlook2013.<br />
<br />
Could you tell me please how to correct this.<br />
<br />
Thanks a lot<br />
<br />
Michelle</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_3757' id='upvote_answer_3757' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='3757' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_3757').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_3757' id='downvote_answer_3757' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='3757' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_3757').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello M.Giroux,<br />
<br />
Thank you for your question. Sorry to hear you are able to <strong>send email</strong> but not <strong>receive</strong> it. <br />
<br />
As a test, I sent you an email and it was delivered successfully, have you tried to <a href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-email/logging-into-webmail" target="_blank" >check your email in Webmail</a>?<br />
<br />
If you can, then it is most likely a setting in Outlook, or possibly a port is blocked on your network. I recommend checking that your <a href="http://www.inmotionhosting.com/support/email/outlook/2013" target="_blank" >Incoming</a> settings are correct in Outlook. <br />
<br />
You can view your specific <a href="http://www.inmotionhosting.com/support/edu/everything-email/introduction-email/how-to-find-email-settings" target="_blank" >email settings in cPanel</a>.<br />
<br />
If they are correct, I recommend trying the alternate settings (for incoming only): If you are using the Standard settings, try the Secure SSL settings, and vice versa. If this works, most likely your network is blocking a port.<br />
<br />
If your issues persist, it may be easier to <a href="http://www.inmotionhosting.com/support/search?searchword=contact+support" target="_blank" >contact live support</a>, so they can review the logs in real-time. Our Tech Support Team is available 24/7, 365 days a year.<br />
<br />
...
-John-Paul
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_3757').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_3757' id='form_comment_on_answer_3757' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>I also get trouble like this, but can't solve. i try like you told but cannot. what should I do?</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='http://graph.facebook.com/bui.thanh.huy.1987/picture?type=normal' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/hubumct'>hubumct</a><br />
									3 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2014-11-07 4:49 am EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>I have the same issue as does several of my colleagues. This isn't a port issue in my opinion caused locally. I upgraded last week with MS's new update. After that - exactly the same issue. To further assist in your evaluation I can advise a simple though annoying remedy for the situation. If I go to the sent folder and then back to the inbox emails come in. There seems to be a bug in the latest update.</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='https://lh4.googleusercontent.com/-qTMbwhTVXUM/AAAAAAAAAAI/AAAAAAAAAE4/b3gSznTl_38/photo.jpg?sz=90' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/fitzytwo'>fitzytwo</a><br />
									3 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2015-12-23 1:22 am EST
								</div>
...
<div class='  not_best_answer'>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px; width:50px;' valign='top'>
<div class='vote_div'>
	<form method='post' name='upvote_answer_5901' id='upvote_answer_5901' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='5901' />
		<input type='hidden' name='component' id='component' value='qa' />
		<input type='hidden' name='vote_value' id='vote_value' value='1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_5901').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_5901' id='downvote_answer_5901' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='5901' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_5901').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Hubumct,<br />
<br />
What do you see when you try <a href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-email/logging-into-webmail">checking your email with webmail</a>? Have you tried removing your account from outlook and <a href="http://www.inmotionhosting.com/support/email/outlook/2013">setting outlook back up to check your email</a>?<br />
<br />
Kindest Regards,<br />
TJ Edens<br />
<br />
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_5901').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_5901' id='form_comment_on_answer_5901' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
					                <p>You must <a href='/support/login'>login</a> before you can post a comment about this answer.</p>
					        </div></div></div></div>
					</form>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/email-client-setup/my-outlook-2013-can-write-email-and-send-them-but-not-receive-email&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/email-client-setup/my-outlook-2013-can-write-email-and-send-them-but-not-receive-email'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="1f9d1c69cc30e4bdf229ba5df8a855e6" value="1" />	</div>
	</form>
<!-- <br />
