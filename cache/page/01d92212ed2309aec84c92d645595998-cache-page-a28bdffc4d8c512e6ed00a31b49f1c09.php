...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/cpanel/cpanel-change-password" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hi cheapcontainerhomes, Thanks for posting your question. I'm more than happy to assist you today. First, you'll need to change you cPanel password in A..." />
  <title>cpanel change password | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/cpanel/cpanel-change-password" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:b04de4291036814bf1dbaaaabe7fcf50 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>cpanel change password</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/cheapcontainerhomes'>cheapcontainerhomes</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-03-16 8:09 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>1,503</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>i changed password but still no log in</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_738' id='upvote_answer_738' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='738' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_738').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_738' id='downvote_answer_738' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='738' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_738').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>11,071 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2012-03-19 6:38 am EST
                		        </div>
					
		                </div>

				Hi cheapcontainerhomes,<br />
<br />
Thanks for posting your question. I'm more than happy to assist you today. First, you'll need to change you cPanel password in AMP. Once you have changed your cPanel password in AMP, then you should be able to log into cPanel from the AMP interface. Here's our guide on changing your cpanel password and how to log into cPanel:<br />
<br />
<a href="http://www.inmotionhosting.com/support/website/cpanel/resetting-cpanel-password-amp">Changing your cPanel password in AMP</a><br />
<br />
...
Tim S
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_738').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_738' id='form_comment_on_answer_738' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/cpanel/cpanel-change-password&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/cpanel/cpanel-change-password'></div>
<script type='text/javascript'>
  (function() {
