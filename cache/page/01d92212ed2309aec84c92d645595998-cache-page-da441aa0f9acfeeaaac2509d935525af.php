...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/file-management" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="keywords" content="%default%" />
  <meta name="description" content="FTP and File Management section" />
  <title>File Management | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/file-management" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:a2934aa41645779e709286785bdb92ef -->
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>File Management</span></li>			</ul>
		</div>
	</div>
</div>
...
<div style="float:left;display:inline-block;vertical-align:top;width:45%;margin:0px 10px 10px 0px;height:350px" class="white_box" target="_blank">
<h2 style="margin-top:0px;padding-top:0px;" target="_blank">Basics:</h2>
    <div style="margin: 5px 15px 5px 10px" target="_blank">
        <p>If you are new to FTP, the basics can be found in this section.</p>
        <ul>
            <li><a href="/support/website/file-management/getting-started-guide" target="_blank">Getting Started Guide: FTP</a></li>
            <li><a href="/support/website/file-management/how-do-i-create-a-ftp-account-in-my-control-panel-cpanel" target="_blank">How do I create a FTP account in my control panel (cpanel)?</a></li>
            <li><a href="/support/website/file-management/resetting-your-ftp-password-in-cpanel" target="_blank">Resetting your FTP Password in cPanel</a></li>
            <li><a href="/support/website/file-management/using-ftp-with-your-addon-domain" target="_blank">Using FTP with your Addon domain</a></li>
        </ul>
    </div>
</div>
...
<div style="float:left;display:inline-block;vertical-align:top;width:45%;margin:0px 10px 10px 0px;height:350px" class="white_box" target="_blank">
<h2 style="margin-top:0px;padding-top:0px;" target="_blank">Client Setup:</h2>
    <div style="margin: 5px 15px 5px 10px" target="_blank">
        <p>Learn how to access your account with different clients, and also how to connect securely.</p>
        <ul>
            <li><a href="/support/website/file-management/configuring-your-site-in-filezilla" target="_blank">FileZilla </a></li>
            <li><a href="/support/website/file-management/smartftp" target="_blank">SmartFTP </a></li>
            <li><a href="/support/website/file-management/configure-cyberduck" target="_blank">Cyberduck</a></li>
            <li><a href="/support/website/file-management/how-to-connect-using-ftp-and-winscp" target="_blank">WinSCP</a></li>
            <li><a href="/support/website/file-management/connect-ftp-notepad-plus" target="_blank">Notepad++</a></li>
           
            <li><a href="/support/website/file-management/ws-ftp" target="_blank">WS_FTP </a></li>
            <li><a href="/support/website/file-management/ftping-your-files-in-dreamweaver-mx" target="_blank">DreamWeaver MX</a></li>
            <li><a href="/support/website/file-management/cute-ftp" target="_blank">Cute FTP </a></li>
            <li><a href="/support/website/file-management/connecting-scp-sftp" target="_blank">Connecting with SCP and SFTP</a></li>
            <li><a href="/support/website/file-management/securely-connecting-your-website-using-ftp" target="_blank">Securely Connecting to your Website using FTP</a></li>
        </ul>
    </div>
</div>
<br />

<div style="float:left;display:inline-block;vertical-align:top;width:45%;margin:0px 10px 10px 0px;height:300px" class="white_box" target="_blank">
<h2 style="margin-top:0px;padding-top:0px;" target="_blank">Managing Files:</h2>
    <div style="margin: 5px 15px 5px 10px" target="_blank">
        <p>Learn how to work with your files using several different FTP clients.</p>
        <ul>
            <li><a href="/support/website/file-management/managing-your-files-in-smart-ftp" target="_blank">SmartFTP</a></li>
            <li><a href="/support/website/file-management/managing-your-files-in-cute-ftp" target="_blank">Cute FTP </a></li>
            <li><a href="/support/website/file-management/managing-your-files-in-filezilla" target="_blank">FileZilla</a></li>
            <li><a href="/support/website/file-management/managing-your-files-in-wsftp" target="_blank">WS_FTP </a></li>
            <li><a href="/support/website/file-management/using-lftp-mirror-to-copy-your-website-files" target="_blank">Using lftp mirror to copy your website files</a></li>
        </ul>
    </div>
</div>
<br />
...
<div style="float:left;display:inline-block;vertical-align:top;width:45%;margin:0px 10px 10px 0px;height:300px" class="white_box" target="_blank">
<h2 style="margin-top:0px;padding-top:0px;" target="_blank">Transferring Files:</h2>
    <div style="margin: 5px 15px 5px 10px" target="_blank">
        <p>You can learn how to transfer files in several clients in this section.</p>
        <ul>
            <li><a href="/support/website/file-management/transferring-files-in-smart-ftp" target="_blank">SmartFTP </a></li>
            <li><a href="/support/website/file-management/transferring-files-in-wsftp" target="_blank">WS_FTP </a></li>
            <li><a href="/support/website/file-management/transferring-files-in-cute-ftp" target="_blank">Cute FTP </a></li>
            <li><a href="/support/website/file-management/transferring-files-in-filezilla" target="_blank">FileZilla </a>  </li>
            <li><a href="/support/website/file-management/how-to-upload-a-file-using-file-manager-in-cpanel" target="_blank">File Manager in cPanel</a></li>
            <li><a href="/support/website/file-management/upload-files-to-server-without-domain-pointing" target="_blank">Upload files to server without domain name pointing there</a></li>
            
            <li><a href="/support/website/file-management/use-rsync-to-transfer-files" target="_blank">Use rsync to transfer files</a></li>
...
<div style="float:left;display:inline-block;vertical-align:top;width:45%;margin:0px 10px 10px 0px;height:300px" class="white_box" target="_blank">
<h2 style="margin-top:0px;padding-top:0px;" target="_blank">Backup & Restoration:</h2>
    <div style="margin: 5px 15px 5px 10px" target="_blank">
        <p>This section covers creating and restoring a backup of your databases. I recommend performing regular backups, in case you run into issues on your site, and need to revert back to a previous date.</p>
        <ul>
            <li><a href="/support/website/file-management/create-backup-using-ftp" target="_blank">How to create a backup using FTP</a></li>
            <li><a href="/support/website/file-management/how-to-restore-a-file-from-your-own-backup" target="_blank">How to Restore a File from your own Backup</a></li>
        </ul>
    </div>
</div>
<br />
...
<h2 style="margin-top:0px;padding-top:0px;" target="_blank">General/Other:</h2>
    <div style="margin: 5px 15px 5px 10px" target="_blank">
        <p>This section includes various tutorials on FTP and File Management.</p>
        <ul>
            <li><a href="/support/website/file-management/compress-file" target="_blank">Compressing a File Using 7-Zip</a></li>
            <li><a href="/support/website/file-management/how-to-enable-ssh-through-whm" target="_blank">How to enable SSH through WHM</a></li>
            <li><a href="/support/website/file-management/view-ftp-uploads-with-archived-raw-logs" target="_blank">View FTP uploads with archived raw logs</a></li>
            <li><a href="/support/website/file-management/add-a-ftp-site-to-your-windows-favorites" target="_blank">Add a FTP site to your Windows favorites</a></li>
            <li><a href="/support/website/file-management/resolve-ftp-eainodata-error" target="_blank">Resolve FTP EAI_NODATA error</a></li>
            <li><a href="/support/website/file-management/corrupt-file-ftp-transfer" target="_blank">File corruption during ftp transfer ASCII vs. BINARY</a></li>
            <li><a href="/support/website/file-management/how-to-create-a-network-drive" target="_blank">How to create a Network Drive</a></li>
            <li><a href="/support/website/file-management/an-introduction-to-webdav-web-disk" target="_blank">An introduction to webdav / web disk</a></li>
        </ul>
    </div>
</div>
<br />
<form action="http://www.inmotionhosting.com/support/website/file-management" method="post" name="adminForm" id="adminForm" class="form-inline">
  ...
  <table class='article_list'>
          ...
          <tr>
                  ...
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/website/file-management/how-to-restore-a-file-from-your-own-backup'>How to Restore a File from your own Backup</a></td>
                                <td>5,935</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/website/file-management/view-ftp-uploads-with-archived-raw-logs'>View FTP uploads with archived raw logs</a></td>
                                <td>3,208</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/website/file-management/best-practice-for-naming-files-in-linux'>Best practice for naming files in Linux</a></td>
                                <td>1,663</td>
                        </tr>
                  </table>
	</form>
