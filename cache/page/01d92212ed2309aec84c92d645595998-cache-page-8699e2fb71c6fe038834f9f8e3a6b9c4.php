<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:54731:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/reseller" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="keywords" content="reseller reseller_whmcs" />
  <meta name="description" content="This section includes tutorials for users with Reseller accounts." />
  <title>Everything Reseller | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/reseller" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:fd56b3569c1c5d6a0172d9892d34f94a -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '196.12.225.242']);
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Everything Reseller</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='item-page'>
        ...
        <div class='page-header'>
                <h1>Everything Reseller</h1>
        </div>

 <div class="white_box" style="margin-bottom: 20px;padding: 15px; width: 605px;">
  <div style="float:left; width:295px; margin-right: 15px;">
    <h2 style="margin-top:0px; color: #888; background: url('/support/templates/supportcentertemplate/images/red_icons/icon_im_new.png') no-repeat left center; padding-left: 35px; ">Getting Started</h2>
    <p>If you are new to the <a href="http://www.inmotionhosting.com/reseller-hosting">Reseller</a> program, we recommend reading these first.</p>
    <ul>
      <li><a href="/support/getting-started/InMotion_Managing_Your_Reseller_Account.pdf" target="_blank" >Getting Started Guide (PDF)</a></li>
      <li><a href="/support/reseller/faq" target="_blank">What is Reseller Hosting?</a></li>
      <li><a href="/support/domain-names/dns-nameserver-changes" target="_blank" >DNS and Nameserver Changes</a></li>
      <li><a href="/support/edu/whm/creating-and-managing-accounts/log-into-whm" target="_blank">Login to WHM</a></li>
      <li><a href="/support/edu/whm/creating-and-managing-accounts/how-to-create-a-cpanel-account" target="_blank" >Creating Additional cPanel accounts</a></li>
      <li><a href="/support/edu/whm/creating-and-managing-accounts/create-a-package-within-whm" target="_blank">Create packages</a></li>
      <li><a href="/support/reseller/shared-reseller-ssh" target="_blank">SSH access for resellers</a></li>
      <li><a href="/support/edu/everything-email/introduction-email/how-to-find-email-settings" target="_blank">View your email settings for configuring email cients</a></li>
      <li><a href="/support/website/backup-and-restore/do-you-run-backups-of-your-servers" target="_blank">Do you run backups of your servers?</a></li>
    </ul>
  </div><!-- end left div -->
  
  <div style="float:left;margin-bottom:15px;width:295px;" >
    <h2 style="margin-top:0px; color: #888; background: url('/support/templates/supportcentertemplate/images/red_icons/icon_domains.png') no-repeat left center; padding-left: 35px;">eNom: Resell Domains</h2>
    <p>In our InMotion Store, you'll be able to resell popular gTLD's and SSL Certs (including Comodo and GeoTrust) through eNom.</p>
    <ul>
      <li><a href="/support/reseller/imhstore-login" target="_blank">How to Login to the InMotion Store</a></li>
      <li><a href="/support/reseller/register-domain-inmotion-store" target="_blank">How to Register a Domain in the InMotion Store</a></li>
      <li><a href="/support/reseller/add-id-protect" target="_blank">How to Add ID Protect (Domain Privacy) via the InMotion Store</a></li>
      <li><a href="/support/team/update-whois" target="_blank">How to update WHOIS in the InMotion Store</a></li>
      <li><a href="/support/reseller/purchase-ssl" target="_blank">How to Purchase an SSL Certificate from the InMotion Store</a></li>
      <li><a href="/support/reseller/sub-accounts">What is the difference between eNom Sub-Retail and Sub-Reseller account?</a></li>
    </ul>
  </div><!-- end right div-->
</div><!-- end white_box -->
...
<div class="white_box" style="margin-bottom: 20px; padding: 15px; width: 605px;">
  <div style="float:left; width:295px; margin-right: 15px;">
    <h2 style="margin-top:0px; color: #888;  background: url('/support/templates/supportcentertemplate/images/red_icons/icon_transfers.png') no-repeat left center; padding-left: 35px;">Transfer Guides</h2>
    <p>These tutorials will help you when on-boarding new customers into your account.</p>
    <ul>
      <li><a href="/support/website/how-to/migrate-your-website-another-host-uses-cpanel" target="_blank">Transfer guide for cPanel customers</a></li>
      <li><a href="/support/website/how-to/migrate-website-from-another-host" target="_blank">Transfer guide for non cPanel customers</a></li>
      <li><a href="/support/domain-names/dns-nameserver-changes/updating-your-domains-nameservers" target="_blank">DNS and Nameserver Changes</a></li>
    </ul>
  </div><!-- end left div -->
  
  <div style="float:left; margin-bottom:15px; width:295px;" >
    <h2 style="margin-top:0px; color: #888; background: url('/support/templates/supportcentertemplate/images/red_icons/icon_whmcs.png') no-repeat left center; padding-left: 35px;">WHMCS</h2>
    <p>If you are a reseller and are looking for a one-stop hosting solution for things such as handling Billing and Support ticket requests, WHMCS is an incredible solution.</p>
    <ul>
      <li><a href="/support/reseller/request-whmcs-license" target="_blank">How to request a license for WHMCS</a></li>
      <li><a href="/support/reseller/whmcs" target="_blank">What is &amp; how to use WHMCS</a></li>
    </ul>
  </div><!-- end right div-->
</div><!-- end white_box -->
...
<div class="white_box" style="margin-bottom: 20px; padding: 15px; width: 605px;">
  <div style="float:left; width:295px; margin-right: 15px;">
    <h2 style="margin-top:0px; color: #888; background: url('/support/templates/supportcentertemplate/images/red_icons/icon_managecust.png') no-repeat left center; padding-left: 35px;">Managing Your Customers</h2>
    <p>As a reseller, you have the ability to create and administer accounts for your customers.</p>
    <ul>
      <li><a href="/support/edu/whm/creating-and-managing-accounts/how-to-create-a-cpanel-account" target="_blank" >Create a cPanel account</a></li>
      <li><a href="/support/edu/whm/delete-cpanel" target="_blank" >Delete a cPanel</a></li>
      <li><a href="/support/edu/whm/creating-and-managing-accounts/suspend-unsuspend-accounts" target="_blank">Suspend an account</a></li>
      <li><a href="/support/reseller/how-to-force-a-password-change-in-whm" target="_blank">Force a password change in WHM</a></li>
      <li><a href="/support/website/general-server-setup/view-bandwidth-and-disk-usage" target="_blank">Viewing Disk Space and Bandwidth Usage</a></li>
      <li><a href="/support/reseller/edit-zone" target="_blank">Modify DNS from WHM</a></li>
      <li><a href="/support/website/file-management/how-to-enable-ssh-through-whm" target="_blank">Enable SSH</a></li>
    </ul>
  </div><!-- end left div -->
  
  <div style="float:left; margin-bottom:15px; width:295px; " >
    <h2 style="margin-top:0px; color: #888;background: url('/support/templates/supportcentertemplate/images/red_icons/icon_ssl.png') no-repeat left center; padding-left: 35px;">Managing SSLs</h2>
    <p>As a reseller, you will have to manage the SSLs for your customers. These articles will assist you with this. </p>
    <ul>
      <li><a href="/support/reseller/purchase-ssl" target="_blank">How to Purchase an SSL Certificate from the InMotion Store</a></li>
      <li><a href="/support/reseller/install-ssl-whm">Managing SSLs as a Reseller</a></li>
      <li><a href="/support/website/how-to/adding-a-dedicated-ip-address-to-your-server" target="_blank" >Request an IP address/assign to account</a></li>
    </ul>
  </div><!-- end right div-->
</div><!-- end white_box -->
...
<div style="float:left;margin-bottom:15px; padding: 15px; width: 605px;" class="white_box">
  <h2 style="margin-top:0px; color: #888; background: url('/support/templates/supportcentertemplate/images/red_icons/icon_branding.png') no-repeat left center; padding-left: 35px;">Branding &amp; Customizations</h2>
  <p>When you are setting up your Reseller account, this section will help you setup your branding.</p>
  <ul style="float: left; width: 250px;">
    <li><a href="/support/reseller/custom-name-server" target="_blank">How to setup custom Nameservers</a></li>
    <li><a href="/support/reseller/cpanel-news-setup" target="_blank" >Setup cPanel news</a></li>
    <li><a href="/support/reseller/customize-cpanel" target="_blank" >Customize cPanel Using the Branding Editor</a></li>
    <li><a href="/support/reseller/custom-default-page" target="_blank" >Using a Custom Landing Page</a></li>
  </ul>
  <ul style="float: left;">
    <li><a href="/support/reseller/custom-suspended-page" target="_blank" >Using a Custom Suspension page</a></li>
    <li><a href="/support/reseller/softaculous-branding" target="_blank">Softaculous - How to modify the branding </a></li>
    <li><a href="/support/edu/whm/creating-and-managing-accounts/feature-lists" target="_blank" >Managing features in cPanel</a></li>
    <li><a href="/support/reseller/cpanel-demo" target="_blank" >How to Create a Demo cPanel Account</a></li>
  </ul>
</div>
    
<br style="clear: both;"/>
<form action="http://www.inmotionhosting.com/support/reseller" method="post" name="adminForm" id="adminForm" class="form-inline">
  ...
  <table class='article_list'>
          ...
          <tr>
                                <td style='padding-right:20px;'><a href='/support/reseller/custom-name-server'>Using Custom Nameservers as a Reseller</a></td>
                                <td>23,114</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/reseller/whmcs'>What is & how to use WHMCS</a></td>
                                <td>10,031</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/reseller/request-whmcs-license'>How to Request a License for WHMCS in AMP</a></td>
                                <td>9,115</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/reseller/imhstore-login'>How to Login to the InMotion Store</a></td>
                                <td>4,662</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/reseller/faq'>What is Reseller Hosting?</a></td>
                                <td>4,635</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/reseller/sub-accounts'>What is the difference between eNom Sub-Retail and Sub-Reseller account in the InMotion Store?</a></td>
                                <td>4,027</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/reseller/customize-cpanel'>Customize cPanel Using the Branding Editor</a></td>
                                <td>3,692</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/reseller/custom-suspended-page'>Using a Custom Suspension Page</a></td>
                                <td>3,173</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/reseller/custom-default-page'>Using a Custom Landing Page</a></td>
                                <td>2,686</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/reseller/how-to-force-a-password-change-in-whm'>How to force a password change in WHM</a></td>
                                <td>1,778</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/reseller/register-domain-inmotion-store'>How to Register a Domain in the InMotion Store</a></td>
                                <td>1,739</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/reseller/edit-zone'>Modifying DNS in WHM</a></td>
                                <td>1,606</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/reseller/purchase-ssl'>Purchasing an SSL Certificate from the InMotion Store</a></td>
                                <td>1,605</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/reseller/cpanel-demo'>How to Make a cPanel Account a Demo</a></td>
                                <td>1,002</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/reseller/softaculous-branding'>Softaculous - How to modify the branding</a></td>
                                <td>569</td>
                        </tr>
                  </table>
		...
		<ul><li class="pagination-start"><span class="pagenav">Start</span></li><li class="pagination-prev"><span class="pagenav">Prev</span></li><li><span class="pagenav">1</span></li><li><a href="/support/reseller?start=15" class="pagenav">2</a></li><li class="pagination-next"><a title="Next" href="/support/reseller?start=15" class="hasTooltip pagenav">Next</a></li><li class="pagination-end"><a title="End" href="/support/reseller?start=15" class="hasTooltip pagenav">End</a></li></ul>	</div>
	</form>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MjQmaWQ9NDI0JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="7bf3e7d3a3244ee2755eb4db8e09c07b" value="1" />	</div>
	</form>
<!-- <br />
