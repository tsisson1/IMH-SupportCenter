<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:65951:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/boldgrid/getting-started/edit-page" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-10-12T19:31:45-07:00" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Confused about how to edit your page in BoldGrid? Check out this article to learn how!" />
  <title>How to Edit Pages using the BoldGrid Editor - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/boldgrid/getting-started/edit-page" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<script type="text/javascript">
		...
		_gaq.push(['_setCustomVar', 4, 'DateMonthPublished', '-0001-11', 3]);
	...
	<!-- cid:7d56cfdc4c7b55ce85e8ed2e906eab09 -->
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/boldgrid' itemprop='url'><span itemprop='title'>BoldGrid<span></a><div class='dropdown_2columns'><h2>BoldGrid Education Channel</h2><div class='col_2'><h3>100 Level Classes</h3></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/boldgrid/getting-started' itemprop='url'><span itemprop='title'>Getting Started<span></a><div class='dropdown_3columns'><h2> Started</h2><div class='col_3'><div>1. <a style='display:inline;' href='/support/edu/boldgrid/getting-started/new-boldgrid-user-no-website'>BoldGrid - First Steps for New Website Creators</a></div><div>2. <a style='display:inline;' href='/support/edu/boldgrid/getting-started/how-to-install'>How to Install BoldGrid</a></div><div>3. <a style='display:inline;' href='/support/edu/boldgrid/getting-started/how-to-login'>How to Login to BoldGrid</a></div><div>4. <a style='display:inline;' href='/support/edu/boldgrid/getting-started/install-inspiration'>How to install your first Inspiration</a></div><div>5. <a style='display:inline;' href='/support/edu/boldgrid/getting-started/evaluating-boldgrid-inspirations'>How to Evaluate the Inspirations</a></div><div>6. <a style='display:inline;' href='/support/edu/boldgrid/getting-started/change-themes'>How to Change Themes in BoldGrid for WordPress</a></div><div>7. <a style='display:inline;' href='/support/edu/boldgrid/getting-started/setup-staging'>How to Set Up Staging in BoldGrid</a></div><div>8. <a style='display:inline;' href='/support/edu/boldgrid/getting-started/evaluate'>Evaluating your BoldGrid site</a></div><div>9. <a style='display:inline;' href='/support/edu/boldgrid/getting-started/add-new-pages'>How to Add new Pages in BoldGrid</a></div><div>10. <a style='display:inline;' href='/support/edu/boldgrid/getting-started/edit-page'>How to Edit Pages using the BoldGrid Editor</a></div><div>11. <a style='display:inline;' href='/support/edu/boldgrid/getting-started/desktop-tablet-phone-view'>Using the Desktop, Tablet, and Phone Views in the Editor</a></div><div>12. <a style='display:inline;' href='/support/edu/boldgrid/getting-started/create-new-menu'>Creating a New Menu in BoldGrid</a></div><div>13. <a style='display:inline;' href='/support/edu/boldgrid/getting-started/edit-footer'>How to change your BoldGrid Footer Information</a></div><div>14. <a style='display:inline;' href='/support/edu/boldgrid/getting-started/start-over'>How to start over in BoldGrid for WordPress</a></div><div>15. <a style='display:inline;' href='/support/edu/boldgrid/getting-started/remove'>How to remove BoldGrid</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to Edit Pages using the BoldGrid Editor</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to Edit Pages using the BoldGrid Editor									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>402</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jul 24, 2015'><span style='color:#606060;'>Published:</span> Oct 12, 2015</div>
							...
							<div style='clear:both;'></div>
								...
								<center><iframe width="560" height="315" src="https://www.youtube.com/embed/rWctSnE60bM" frameborder="0" allowfullscreen></iframe></center>
<p>When you choose an Inspiration in BoldGrid, the site will be full of sample data. You will naturally want to edit the content to reflect your own purpose, whether it is an informational site or a business site. This tutorial gives you basic instructions on how to edit your pages using the BoldGrid editor.
</p>

<h2>Opening the Editor</h2>
<ol class="article_list">
  <li><a href="/support/edu/boldgrid/getting-started/how-to-login">Log into your site's admin dashboard</a>.<div style="clear:both;"></div></li>
    <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/boldgrid/edit-pages/1-click-all-pages.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/boldgrid/edit-pages/1-click-all-pages.png" title="Click here to view the larger image" width="" /></a>Next, click on the <strong>Pages</strong> option from the left-hand sidebar and then clock on <strong>All Pages</strong>.<div style="clear:both;"></div></li>
    <li>F<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/boldgrid/edit-pages/2-click-edit.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/boldgrid/edit-pages/2-click-edit.png" title="Click here to view the larger image" width="200" /></a> rom the <em>Pages</em> list screen, find the page you want to work with, hover over it, and click on the <em>Edit</em> option.<div style="clear:both;"></div></li>
    <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/boldgrid/edit-pages/3-click-visual-tab.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/boldgrid/edit-pages/3-click-visual-tab.png" title="Click here to view the larger image" width="200" /></a> Be sure you are in the Visual mode and not the Text mode. You can change the mode in the upper right corner of the editor area.<div style="clear:both;"></div></li>
</ol>

<p>From here, we will demonstrate how to edit <em>columns</em>, <em>rows</em>, or specific <em>elements</em> within a column-row.</p>

<h2>Working with Columns</h2>
<ol class="article_list">
    <li>Open the editor as described above.<div style="clear:both;"></div></li>
    <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/boldgrid/edit-pages/4-column-drag-handle.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/boldgrid/edit-pages/4-column-drag-handle.png" title="Click here to view the larger image" width="200" /></a>Place your mouse cursor into the column you wish to edit. You will see a blue drag handle appear at the top of the current column.<div style="clear:both;"></div></li>
    <li>To move the column, click and hold on the directional button of the drag handle. Then, drag your column to the desired location on the page.<div style="clear:both;"></div></li>
    <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/boldgrid/edit-pages/5-column-menu.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/boldgrid/edit-pages/5-column-menu.png" title="Click here to view the larger image" width="" /></a> If you wish to edit the specific content of the column, click the edit button of the blue drag handle. This will present a menu with the following options:

   	 <table class="article_table" style="width:100%">
   	 <tr>
   	   <th>Insert Media</th><td>Takes you to the Inser Media page to insert images and other content.</td>
   	 </tr>

   	 <tr>
   	   <th>Clone</th><td>Creates a new column to the right of the current one with exactly the same data.</td>
   	 </tr>

   	 <tr>
   	   <th>Clear Contents</th><td>Deletes the contents of the current column, leaving it blank.</td>
   	 </tr>
   	 <tr>
   	   <th>Delete</th><td>Delete the current row and all its contents.</td>
   	 </tr>   	 
   	 <tr>
   	   <th>Add Form</th><td>Allows you to add a form to your column.</td>
   	 </tr>   	 
   	 </table>
...
<ol class="article_list">
    <li>First open the editor as described above.<div style="clear:both;"></div></li>
    <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/boldgrid/edit-pages/6-row-drag-handle.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/boldgrid/edit-pages/6-row-drag-handle.png" title="Click here to view the larger image" width="200" /></a> Hover into the row you wish to edit. You will see a yellow drag handle appear on the right side of the row.<div style="clear:both;"></div></li>
    <li>To move the row, click and hold on the directional button. Then, drag your row up or down the page. <div style="clear:both;"></div></li>
    <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/boldgrid/edit-pages/7-row-menu.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/boldgrid/edit-pages/7-row-menu.png" title="Click here to view the larger image" width="" /></a> If you wish to edit the specific content of the row, click the edit button of the yellow drag handle. This will present a menu allowing you various options.

   	 <table class="article_table" style="width:100%">
   	 <tr>
   	   <th>Insert Layout</th><td>Allows you to select from a premade layout and insert it above the current row.</td>
   	 </tr>

   	 <tr>
   	   <th>Add Empty Row</th><td>Adds a new row with no content above the current row.</td>
   	 </tr>

   	 <tr>
   	   <th>Add Column</th><td>Adds a new column within the current row.</td>
   	 </tr>

   	 <tr>
   	   <th>Nest Row</th><td>Select the current row to be nested.</td>
   	 </tr>

   	 <tr>
   	   <th>Clone</th><td>Creates a new row above the current one with exactly the same data.</td>
   	 </tr>

   	 <tr>
   	   <th>Clear Contents</th><td>Deletes the contents of the current row, leaving it blank.</td>
   	 </tr>
...
<ol class="article_list">
    <li>Open the editor as described above.<div style="clear:both;"></div></li>
    <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/boldgrid/edit-pages/8-content-drag-handle.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/boldgrid/edit-pages/8-content-drag-handle.png" title="Click here to view the larger image" width="200" /></a> Place your mouse cursor over the element you wish to edit. You will see a red drag handle appear to the left of the current column.<div style="clear:both;"></div></li>
    <li>To move the element, click and hold on the directional button of the drag handle. Then, drag the element to the desired location on the page.<div style="clear:both;"></div></li>
    <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/boldgrid/edit-pages/9-content-menu.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/boldgrid/edit-pages/9-content-menu.png" title="Click here to view the larger image" width="" /></a> Clicking the Edit button of the red drag handle will bring up a menu with the following options:

   	 <table class="article_table" style="width:100%">
   	 <tr>
   	   <th>Clone</th><td>Creates a new element underneath the current one exactly the same data.</td>
   	 </tr>
   	 <tr>
   	   <th>Delete</th><td>Deletes the current element and all its contents.</td>
   	 </tr>   	 
   	 </table>
    <div style="clear:both;"></div></li>
</ol>
...
<h3>Text Elements</h3>
<p>Elements with text in them are the simplest to work with if you want to directly edit the content. Double-click on the element and your cursor will appear. You can then add or delete text in the element.
</p>

<h3>Image Elements</h3>
<p>Image Elements are a bit different than text elements when editing. Double-clicking the element brings up a menu at the top displaying the following options:
   	 <table class="article_table" style="width:100%">
   	 <tr>
   	   <th>Align Left</th><td>Aligns the image to the left side of the element.</td>
   	 </tr>

   	 <tr>
   	   <th>Align Center</th><td>Aligns the image to the center of the element.</td>
   	 </tr>

   	 <tr>
   	   <th>Align Right</th><td>Aligns the image to the right of the element.</td>
   	 </tr>

   	 <tr>
   	   <th>No Alignment</th><td>Uses the default alignment.</td>
   	 </tr>

   	 <tr>
   	   <th>Add Media</th><td>Opens the page to add new media to the element.</td>
   	 </tr>

   	 <tr>
   	   <th>Edit</th><td>Opens the page for the settings of the image.</td>
   	 </tr>

   	 <tr>
   	   <th>Remove</th><td>Deletes the image from the element.</td>
   	 </tr>   	 
   	 </table>
</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/boldgrid/getting-started'>Getting Started</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 10: How to Edit Pages using the BoldGrid Editor</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 9: <a href='/support/edu/boldgrid/getting-started/add-new-pages'>How to Add new Pages in BoldGrid</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 11: <a href='/support/edu/boldgrid/getting-started/desktop-tablet-phone-view'>Using the Desktop, Tablet, and Phone Views in the Editor</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/boldgrid/getting-started/edit-page&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/boldgrid/getting-started/edit-page'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP3RzcmM9cnNiZWR1Jm9wdGlvbj1jb21fY29udGVudCZjYXRpZD01MzcmaWQ9MzYyMCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/boldgrid/getting-started?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Started</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/boldgrid/getting-started/new-boldgrid-user-no-website?tsrc=rsbedu'>BoldGrid - First Steps for New Website Creators</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/boldgrid/getting-started/how-to-install?tsrc=rsbedu'>How to Install BoldGrid</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/boldgrid/getting-started/how-to-login?tsrc=rsbedu'>How to Login to BoldGrid</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/boldgrid/getting-started/install-inspiration?tsrc=rsbedu'>How to install your first Inspiration</a></td>
                </tr>
          <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/boldgrid/getting-started/evaluating-boldgrid-inspirations?tsrc=rsbedu'>How to Evaluate the Inspirations</a></td>
                </tr>
          <tr >
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/boldgrid/getting-started/change-themes?tsrc=rsbedu'>How to Change Themes in BoldGrid for WordPress</a></td>
                </tr>
          <tr >
                        <td valign='top'>7.</td>
                        <td><a href='/support/edu/boldgrid/getting-started/setup-staging?tsrc=rsbedu'>How to Set Up Staging in BoldGrid</a></td>
                </tr>
          <tr >
                        <td valign='top'>8.</td>
                        <td><a href='/support/edu/boldgrid/getting-started/evaluate?tsrc=rsbedu'>Evaluating your BoldGrid site</a></td>
                </tr>
          <tr >
                        <td valign='top'>9.</td>
                        <td><a href='/support/edu/boldgrid/getting-started/add-new-pages?tsrc=rsbedu'>How to Add new Pages in BoldGrid</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>10.</td>
                        <td><a href='/support/edu/boldgrid/getting-started/edit-page?tsrc=rsbedu'>How to Edit Pages using the BoldGrid Editor</a></td>
                </tr>
          <tr >
                        <td valign='top'>11.</td>
                        <td><a href='/support/edu/boldgrid/getting-started/desktop-tablet-phone-view?tsrc=rsbedu'>Using the Desktop, Tablet, and Phone Views in the Editor</a></td>
                </tr>
          <tr >
                        <td valign='top'>12.</td>
                        <td><a href='/support/edu/boldgrid/getting-started/create-new-menu?tsrc=rsbedu'>Creating a New Menu in BoldGrid</a></td>
                </tr>
          <tr >
                        <td valign='top'>13.</td>
                        <td><a href='/support/edu/boldgrid/getting-started/edit-footer?tsrc=rsbedu'>How to change your BoldGrid Footer Information</a></td>
                </tr>
          <tr >
                        <td valign='top'>14.</td>
                        <td><a href='/support/edu/boldgrid/getting-started/start-over?tsrc=rsbedu'>How to start over in BoldGrid for WordPress</a></td>
                </tr>
          <tr >
                        <td valign='top'>15.</td>
                        <td><a href='/support/edu/boldgrid/getting-started/remove?tsrc=rsbedu'>How to remove BoldGrid</a></td>
                </tr>
          	</table>
