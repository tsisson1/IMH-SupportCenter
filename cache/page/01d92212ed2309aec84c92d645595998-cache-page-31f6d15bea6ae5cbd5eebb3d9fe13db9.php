<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:58403:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/drupal-7/configure-caching/enable-anonymous-caching" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-06-29T12:12:04-07:00" />
  <meta name="keywords" content="enable set configure anonymous cache user Drupal 7" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="This Drupal 7 turotial guides  you on enabling caching for anonymous users." />
  <title>Enabling caching for anonymous users in Drupal 7 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/drupal-7/configure-caching/enable-anonymous-caching" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:292cc02462943a32284aecef44697931 -->
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
				<img src='/support/images/stories/drupal-partner/supporting-partner-80_3.png' style='float:right; margin:0px 0px 15px 15px;' alt='Drupal Association Support Partner'>		<h1>
															Enabling caching for anonymous users in Drupal 7									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>3,590</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jun 28, 2012'><span style='color:#606060;'>Published:</span> Jun 29, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In order to enhance site performance, Drupal 7 has several options on tuning its caching abilities. Caching for non-registered users is not enabled by default. Turning this on will cause Drupal to keep html copies of pages on hand for faster serving, increasing site speed and limiting repeated queries. Turning on caching for anonymous users in Drupal 7 can be done by following the simple instructions below.</p>
<p><strong>How to enable anonymous user caching in Drupal 7:</strong></p>
...
<li>Find the <strong>Configuration </strong>option on the top menu bar and click on that option.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Configuration/_main-dashboard-configuration.png"><img  alt="_main-dashboard-configuration" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Configuration/_main-dashboard-configuration.png" /></a></li>
<li>You are now on the <strong>Configuration </strong>screen. Find the <strong>Developlment </strong>category and click on the <strong>Performance </strong>link.</li>
<li>This brings you to the <strong>Performance </strong>screen. Look for the <strong>Caching </strong>section and find the <strong>Cache pages for anonymous users setting</strong>. From there, click the checkbox to turn on the feature.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Configuration/Development/Performance/config-deve-perf-cache-anon.png"><img  alt="config-deve-perf-cache-anon" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Configuration/Development/Performance/config-deve-perf-cache-anon.png" /></a></li>
<li>Scroll to the bottom of the screen and click on the <strong>Save Configuration </strong>button.</li>
</ol>
<p>Now you know how to configurecaching for non-registered users in Drupal 7.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/drupal-7/configure-caching'>206: Configuring Caching in Drupal 7</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 3: Enabling caching for anonymous users in Drupal 7</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 2: <a href='/support/edu/drupal-7/configure-caching/clear-caching'>How to clear caching in Drupal 7</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 4: <a href='/support/edu/drupal-7/configure-caching/enable-cache-blocks'>How to enable cache blocks in Drupal 7</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/drupal-7/configure-caching/enable-anonymous-caching&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/drupal-7/configure-caching/enable-anonymous-caching'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yMTkmaWQ9MTUzMyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="7cc09a5529fdf125d2fda27e3ec3eb48" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/drupal-7/configure-caching?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Configuring Caching in Drupal 7</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/drupal-7/configure-caching/optimize-drupal?tsrc=rsbedu'>How to optimize Drupal</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/drupal-7/configure-caching/clear-caching?tsrc=rsbedu'>How to clear caching in Drupal 7</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/drupal-7/configure-caching/enable-anonymous-caching?tsrc=rsbedu'>Enabling caching for anonymous users in Drupal 7</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/drupal-7/configure-caching/enable-cache-blocks?tsrc=rsbedu'>How to enable cache blocks in Drupal 7</a></td>
                </tr>
          <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/drupal-7/configure-caching/config-min-cache-lifespan?tsrc=rsbedu'>How to configure minimum cache lifespan in Drupal 7</a></td>
                </tr>
          <tr >
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/drupal-7/configure-caching/config-expiration-of-cached-pages?tsrc=rsbedu'>Configuring expiration of cached pages setting  in Drupal 7</a></td>
                </tr>
          	</table>
