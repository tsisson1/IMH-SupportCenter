<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:80209:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/javascript/diagnose-javascript-errors" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-02-25T22:27:32-08:00" />
  <meta name="keywords" content="diagnose  JavaScript error through FireFox Internet Explorer Chrome Opera safari IE console" />
  ...
  <link href="http://www.inmotionhosting.com/support/website/javascript/diagnose-javascript-errors" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:d0e38fd732686ae1e8675ac3bb7c91b7 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How do I diagnose JavaScript errors on my site?									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>26,360</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Feb 26, 2013'><span style='color:#606060;'>Published:</span> Feb 25, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Websites use several different Website coding languages to work. All websites use <a href="http://www.inmotionhosting.com/support/website/html" target="_blank">HTML</a>, <a href="http://www.inmotionhosting.com/support/edu/website-design/using-css/the-benefits-of-css" target="_blank">CSS</a>, and <a href="http://www.inmotionhosting.com/support/website/javascript" target="_blank">JavaScript</a> to render the webpage to the visitor.</p>

<p>When the website is loading but the website is not displaying correctly, this is usually due to a coding error on the site. Usually this is caused by JavaScript or CSS errors. This article will focus on diagnosing JavaScript coding errors.</p>
...
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/how-to/diagnose-error-console/javascript-problems-1-simple-pop-up.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Simple JavaScript pou up Error Console" src="//cdn.inmotionhosting.com/support/images/stories/website/how-to/diagnose-error-console/javascript-problems-1-simple-pop-up.gif" title="Click here to view the larger image" width="100" /></a>In order to explain how to diagnose a JavaScript error, we will use the simple "<em>pop up</em>" script below (Snapshot to the right shows what it does):</p>
<pre style="margin-left: 20px;">&lt;script&gt;
function myFunction()
{
alert (<span style="color: #006600;">"I am an alert box!"</span>);
}
&lt;/script&gt;</pre>
...
function myFunction()
{
alert (<span style="color: #ff0000;">I am an alert box!"</span>);
}
&lt;/script&gt;</pre>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/how-to/diagnose-error-console/javascript-problems-1-x-code.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Broken code for example Error Console" src="//cdn.inmotionhosting.com/support/images/stories/website/how-to/diagnose-error-console/javascript-problems-1-x-code.gif" title="Click here to view the larger image" width="100" /></a>When the website is ran, the code will break where the quote is missing. The snapshot to the right shows the code that's broken, and where the lines are in the code. <br style="clear: both;" /></p>
...
<li>Open FireFox.</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/how-to/diagnose-error-console/javascript-problems-2-firefox-tools.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Fire fox Error Console tools" src="//cdn.inmotionhosting.com/support/images/stories/website/how-to/diagnose-error-console/javascript-problems-2-firefox-tools.gif" title="Click here to view the larger image" width="100" /></a>Go to <strong>Tools</strong> &gt; <strong>Web Developer</strong> &gt; <strong>Error Console</strong>. If you do not have Tools at the top you can use the following shortcut:
<pre style="margin-left: 20px;">Ctrl + Shift + J</pre>
<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/how-to/diagnose-error-console/javascript-problems-3-firefox-javascript-console.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="FireFox Error Console window" src="//cdn.inmotionhosting.com/support/images/stories/website/how-to/diagnose-error-console/javascript-problems-3-firefox-javascript-console.gif" title="Click here to view the larger image" width="100" /></a>Visit the page with the error. In this case you will see the error on Line 33 in the FireFox Error Console. See image to the right. <br style="clear: both;" /></li>
</ol>
...
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/how-to/diagnose-error-console/javascript-problems-4-internet-explorer-error-console.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Internet Explorer Error Console" src="//cdn.inmotionhosting.com/support/images/stories/website/how-to/diagnose-error-console/javascript-problems-4-internet-explorer-error-console.gif" title="Click here to view the larger image" width="100" /></a>Visit your webpage with the error. You will see the error with the line number of where the error occurs in the document in the bottom Error Console window. The snapshot to the right shows the error on line 33. <br style="clear: both;" /></li>
</ol>
...
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/how-to/diagnose-error-console/javascript-problems-5-chrome-tools.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Chrome tools Error Console" src="//cdn.inmotionhosting.com/support/images/stories/website/how-to/diagnose-error-console/javascript-problems-5-chrome-tools.gif" title="Click here to view the larger image" width="100" /></a>From the drop menu, go to <strong>Tools</strong> &gt; <strong>JavaScript console</strong>. Or you can press:
<pre style="margin-left: 20px;">Ctrl + Shift + J</pre>
<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/how-to/diagnose-error-console/javascript-problems-6-chrome-error-console.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Chrome Error Console window" src="//cdn.inmotionhosting.com/support/images/stories/website/how-to/diagnose-error-console/javascript-problems-6-chrome-error-console.gif" title="Click here to view the larger image" width="100" /></a>Visit the site with the error. In the Error Console window you will see the error show on line 33. See image to the right. <br style="clear: both;" /></li>
</ol>
...
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/how-to/diagnose-error-console/javascript-problems-7-opera-page-developer.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Opera page developer Error Console" src="//cdn.inmotionhosting.com/support/images/stories/website/how-to/diagnose-error-console/javascript-problems-7-opera-page-developer.gif" title="Click here to view the larger image" width="100" /></a>Navigate to <strong>Page</strong> &gt; <strong>Developer Tools</strong> &gt; <strong>Error Console</strong>. Or you can press the following keyboard keys:
<pre style="margin-left: 20px;">Ctrl + Shift + O</pre>
<br style="clear: both;" /> <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/how-to/diagnose-error-console/javascript-problems-8-opera-error-console.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Opera Error Console window" src="//cdn.inmotionhosting.com/support/images/stories/website/how-to/diagnose-error-console/javascript-problems-8-opera-error-console.gif" title="Click here to view the larger image" width="100" /></a>The Error Console will pop up. You can move the window to the side while you visit your site. You will see the errors list when you visit the site with the broken code. The image to the right shows the error on line 33. <br style="clear: both;" /></li>
</ol>
...
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/how-to/diagnose-error-console/javascript-problems-9-preferences-safari.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Safari Preferences Error Console" src="//cdn.inmotionhosting.com/support/images/stories/website/how-to/diagnose-error-console/javascript-problems-9-preferences-safari.gif" title="Click here to view the larger image" width="100" /></a>Click <strong>Preferences</strong>.<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/how-to/diagnose-error-console/javascript-problems-10-show-develop.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Safari Show Develop menu Error Console" src="//cdn.inmotionhosting.com/support/images/stories/website/how-to/diagnose-error-console/javascript-problems-10-show-develop.gif" title="Click here to view the larger image" width="100" /></a>On the <strong>Advanced</strong> tab, make sure you have the "<em>Show Develop menu in menu bar</em>" box checked. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/how-to/diagnose-error-console/javascript-problems-11-show-error-console.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Show the Error Console in Safari" src="//cdn.inmotionhosting.com/support/images/stories/website/how-to/diagnose-error-console/javascript-problems-11-show-error-console.gif" title="Click here to view the larger image" width="100" /></a>"<em>Display a menu for the current page</em>" icon towards the top right that looks like a paper with a bent corner.
...
<p>&nbsp;</p>
<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/how-to/diagnose-error-console/javascript-problems-12-safari-error-console.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Safari Error Console window" src="//cdn.inmotionhosting.com/support/images/stories/website/how-to/diagnose-error-console/javascript-problems-12-safari-error-console.gif" title="Click here to view the larger image" width="100" /></a>Visit your webpage that is broken and check the Error Console at the bottom. The errors will list when you refresh your browser. In this case you can see the error on line 33 in the snapshot to the right. <br style="clear: both;" /></li>
</ol> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/javascript/diagnose-javascript-errors&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/javascript/diagnose-javascript-errors'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NTEmaWQ9NTg5JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="aecc258f7997b0c52e7fae903037a1e6" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/d373ed062921cda425a1aec1a01b173a?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/d373ed062921cda425a1aec1a01b173a'>Bally Chohan</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-08 5:43 am</div>
				                <div><p>How to relove these errors.. as I am not able to resolve these errors</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14815);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-08 9:21 am</div>
				                <div>Hello Bally,<br />
<br />
...
<br />
Can you provide a link to the error, or domain  name?<br />
<br />
What are you trying to accomplish?<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14828);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-18181'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/5fc4addb72adaea79f0cc445c63add0b?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/5fc4addb72adaea79f0cc445c63add0b'>sarthak</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-05 10:50 am</div>
				                <div><p>how would i know the exact error in javascript like error shown in c c++ etc in those programming language we get the exact line no. where the error is what is missing finally my question is why javascript is not showing exact error, exact line number details of error on console, sometime it shows error in jquery.js etc its tooo frustrating to debug the js can anybody help to resolve the js issues...thanks</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(18181);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-05 11:21 am</div>
				                <div>Hello Sarthak,<br />
<br />
I am not sure if we are following you completely, can you provide us the code that is providing an error but not specifics so we may attempt to solve the issue. <br />
<br />
Kindest Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(18187);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-30166'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/9fee7e572f737f37a3622d1c15f81631?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/9fee7e572f737f37a3622d1c15f81631'>Ashraf</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-27 6:57 pm</div>
				                <div><p>Hi,</p>
<p>I need relove these errors.. as I am not able to resolve these errors on firefox can you please </p>
<p>hatlaky.com</p>
<p>&nbsp;</p>
<p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30166);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-28 8:46 am</div>
				                <div>Hello Ashraf,<br />
<br />
we need a little more information in regards to the errors before we can attempt to resolve them.  Please provide us a little information as to the error message, steps you're taking to get to the error, and any version information.<br />
<br />
If you have any further questions, please let us know.  <br />
<br />
Kindest regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30186);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
