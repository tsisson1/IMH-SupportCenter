<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:55500:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/how-to/how-can-i-delete-my-current-website" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hi eu64997, Thanks for posting your question. I'm more than happy to assist you today. Basically, if you want to remove an existing website, you can del..." />
  <title>How can I delete my current website | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/how-to/how-can-i-delete-my-current-website" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:02c50afd1e7592c1e505cb0cb3c752b0 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '193.93.68.138']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box straight_bottom'>
                <h1 style='font-size:26px;'>How can I delete my current website</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/eu6497'>eu6497</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2011-10-29 11:09 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>14,737</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I want to publish a new website and remove the current one</div>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px;'>
				<div style='font-size:12px; max-width:500px; overflow:auto;'>Hi - (I'm a raging novice!)  I deleted the files, though still can't find a way to delete the folder for my zencart, out of the public_html folder. Next I see this when I type in the domain name..(already cleared cache) so how do I fix this security blunder?<br />
Index of /<br />
    404.shtml<br />
    blog/<br />
    cgi-bin/<br />
    default.htm.1330287721<br />
    fantastico_fileslist.txt<br />
    fantversion.php<br />
    home/<br />
    joomlADir/<br />
    php.ini<br />
    ...
    zc_admin</div>
			...
			<td style='width:100px;' valign='top'>
				...
				<div class='smallgrey'>
					<a href='/support/community-support/users/Carrott'>Carrott</a><br />
					0 <a href='/support/team/points' target='_blank'>Points</a><br />
					2013-11-13 10:28 pm EST
				</div>
			</td>
		</tr>
	</table>
...
<div style='padding:15px; border:1px solid #d6d6d6; border-top:0px; background:#ebebeb;' class='round_bottom' >
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px;'>
				<div style='font-size:12px; max-width:500px; overflow:auto;'>Hello Carott,<br />
<br />
If you installed your current website using <a href="http://www.inmotionhosting.com/support/edu/cpanel/softaculous/how-to-install" target="_blank" >Softaculous</a>, it can be easily uninstalled from there too, <a href="http://www.inmotionhosting.com/support/edu/cpanel/softaculous/softaculous-uninstall" target="_blank" >this guide</a> will walk you through the process.<br />
<br />
We also have a guide on how to <a href="http://www.inmotionhosting.com/support/website/managing-files/how-to-delete-a-file" target="_blank" >delete a file from your sever</a>, that explains 2 options for deleting files (via FTP or File Manager).<br />
<br />
We also have a guide on <a href="http://www.inmotionhosting.com/support/website/pwb/unpublish-site" target="_blank" >deleting a "Premium Website Builder" site</a>, which will be the same process for most websites.<br />
<br />
If your website has a database associated with it, you can also <a href="http://www.inmotionhosting.com/support/website/database-setup/how-to-delete-a-database-in-cpanel" target="_blank" >delete databases from cPanel</a>.<br />
<br />
When you get an "Index of" listing, it is because there is no index file to load, so it is just listing the files. When you <a href="http://www.inmotionhosting.com/support/website/getting-started-guides/where-to-upload-files" target="_blank" >upload</a>, or <a href="http://www.inmotionhosting.com/support/edu/cpanel/softaculous/how-to-install" target="_blank" >install</a> your website, it will load in place of this listing.<br />
<br />
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_210' id='upvote_answer_210' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='210' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_210').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_210' id='downvote_answer_210' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='210' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_210').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hi eu64997,<br />
<br />
Thanks for posting your question. I'm more than happy to assist you today. Basically, if you want to remove an existing website, you can delete the files in the public_html folder. If your website is built with a content management system you installed through Fantastico you can remove it through the fantastico interface within cPanel. <br />
<br />
Before you remove any files or folders, I suggest you make a backup of your website. That way, if you delete anything that shouldn't have been removed you can restore it.<br />
<br />
Here's a link on how to backup your website:<br />
<br />
Backing Up Your cPanel<br />
<br />
I hope this helps!<br />
<br />
Let me know if you need any further assistance or information. <br />
<br />
Thanks!<br />
<br />
Tim S
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_210').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_210' id='form_comment_on_answer_210' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				...
				<div style='padding:15px 15px 15px 76px; border:1px solid #ddd; border-top:0px; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>hi i have such this question i deleted files in puplic _html folder but it not chame</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='https://lh3.googleusercontent.com/-XdUIqdMkCWA/AAAAAAAAAAI/AAAAAAAAAAA/4252rscbv5M/photo.jpg?sz=90' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/sahereh'>sahereh</a><br />
									3 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2013-11-07 6:34 am EST
								</div>
				...
				<div style='padding:15px 15px 15px 76px; border:1px solid #ddd; border-top:0px; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>If you have deleted all files from your public_html directory, there would not be any files to read from.  If you are still seing your site, it could be caused by browser cache.  Try &lt;a href=&quot;http://www.inmotionhosting.com/support/website/how-to/clear-browser-cache&quot;&gt;clearing your browser cache&lt;/a&gt; to ensure no offline data is being stored.</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/how-to/how-can-i-delete-my-current-website&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/how-to/how-can-i-delete-my-current-website'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="653934201497982be0c3b24744b05beb" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
                                ...
                                <h3>Related Articles</h3><a target='_blank' href='http://inmotionhosting.com/support/read-traceroute'>How to read a traceroute</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/how-to-install-webcalendar'>How to install WebCalendar</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/how-do-i-restart-my-server'>How do I restart my server?</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/how-to-view-the-source-code-of-your-website'>How to view the source code of your website</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/delete-files'>How to delete files using your cPanel</a><br/><br />
		</div>
