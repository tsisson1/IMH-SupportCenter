<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:59398:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-3/install-jotcache" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-01-13T16:03:31-08:00" />
  <meta name="keywords" content="JotCache Joomla Cache Extension" />
  <meta name="author" content="John-Paul Briones" />
  <meta name="description" content="Need help with Caching in Joomla? Learn how replace System-Cache in Joomla with JotCache." />
  <title>Installing the JotCache Extension in Joomla 3 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-3/install-jotcache" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:f71c08fd6f5a0252dd56703840ba9865 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Installing the JotCache Extension in Joomla 3									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>788</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 12, 2015'><span style='color:#606060;'>Published:</span> Jan 13, 2015</div>
  ...
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('install-jotcache');">1. Install the JotCache Extension</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('disable-system-cache');">2. Disable the System-Cache plugin</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('enable-jotcache');">3. Enable JotCache</button>
</div>

<p>In this tutorial, we will show you how to <strong>install</strong> the <strong>JotCache</strong> Extension in <strong>Joomla</strong> 3. JotCache provides more in-depth control of caching in Joomla. There are 3 steps to installing the JotCache Joomla Extension, we will cover them now.</p>

<a name="install-jotcache"></a>
<h2>Upload & Install the JotCache Extension</h2>
<ol class="article_list">
  <li>Download the latest <em>stable</em> version of JotCache <a href="http://www.jotcomponents.net/web-programming/jotcache/download" target="_blank">here</a>. At the time this article was written the latest version was <strong>JotCache 5.0(Stable)</strong>, and the file was titled <strong>pkg_jotcache_5.0.6_j33.zip</strong>.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/joomla/jotcache/jotcache-download.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/joomla/jotcache/jotcache-download.png" alt="JotCache file download" title="Downloading the JotCache Extension" /></a></li>
<li><a href="/support/edu/joomla-3/getting-started/login-dashboard">Login to the Joomla Admin Dashboard</a>.</li>
<li>In the main menu click <strong>Extensions</strong>, then click <strong>Extension Manager</strong>. See the steps below.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/joomla/jotcache/joomla-extension-manager.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/joomla/jotcache/joomla-extension-manager.png" alt="Viewing additional Joomla 3 plugins" title="Accessing the Joomla Extension Manager" /></a></li>
<li>Click <strong>Choose File</strong> in the <em>Upload & Install Joomla Extension</em> section, then select and open the <strong>JotCache</strong> file you downloaded in <strong>Step 1</strong>. Then, click the <strong>Upload & Install</strong> button.</li>
</ol>


<a name="disable-system-cache"></a>
<h2>Disabling System-Cache plugin</h2>
<p>The System-Cache plugin was already disabled by default in my tests, but you can easily disable it from the Admin Dashboard if it is enabled.</p>
<ol class="article_list">
<li><a href="/support/edu/joomla-3/getting-started/login-dashboard">Login to the Joomla Admin Dashboard</a>.</li>
<li>Roll your mouse over <strong>System</strong>, then click <strong>Global Configuration</strong>.</li>
<li>Click the <strong>System</strong> tab on the <em>Global Configuration</em> page.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/joomla/jotcache/system-global-configuration.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/joomla/jotcache/system-global-configuration.png" alt="Accessing Joomla Configuration" title="Joomla Global settings" /></a></li>
<li>Click the drop-down box next to <strong>Cache*</strong>, and click the <strong>OFF - Caching disabled</strong> option.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/joomla/jotcache/caching-disabled.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/joomla/jotcache/caching-disabled.png" alt="Turning Joomla System-Cache off" title="Caching disabled in Joomla" /></a></li>
<li>Click the <strong>Save</strong> button, and your System-Cache plugin will be disabled.</li></ol>


<a name="enable-jotcache"></a>
<h2>Enabling JotCache plugin</h2>
<p>After installing the Jotcache Extensions, and disabling System-Cache (if necessary), you can finally turn the Jotcache plugin on. We will now walk you through enabling the JotCache plugin in Joomla 3.</p>
<ol class="article_list">
<li><a href="/support/edu/joomla-3/getting-started/login-dashboard">Login to the Joomla Admin Dashboard</a>.</li>
<li>In the <em>navigation menu</em> click <strong>Components</strong>, then <strong>JotCache</strong>.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/joomla/jotcache/jotcache-component.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/joomla/jotcache/jotcache-component.png" alt="Joomla 3 caching Extension" title="Accessing the JotCache plugin" /></a></li>
<li>You will see a <span style="color:red"><em>JotCache plugin disabled</em></span> message, click the povided link. See the image below.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/joomla/jotcache/jotcache-plugin-disabled.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/joomla/jotcache/jotcache-plugin-disabled.png" alt="Caching Extension for Joomla 3" title="JotCache disabled message" /></a></li>
<li>On the JotCache plugin page, click the <strong>Disabled</strong> menu, then change it to <strong>Enabled</strong>.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/joomla/jotcache/jotache-status-enabled.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/joomla/jotcache/jotache-status-enabled.png" alt="JotCache settings page" title="Enabling the JotCache Extension" /></a></li>
<li>Click the <strong>Save</strong> button to enable the JotCache plugin. At this time you can choose your JotCache settings. For more detailed information about JotCache plugin administration, see their official guide <a href="http://kbase.jotcomponents.net/jotcache:help:direct50j3x:plugin_administration" target=-"_blank" >here</a>.</li>
</ol>

<p>Congratulations, now you know how to install the JotCache extension in Joomla 3!</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 1: Installing the JotCache Extension in Joomla 3</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 2: <a href='/support/edu/joomla-3/optimization'>How to Optimize your Joomla Site</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-3/install-jotcache&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-3/install-jotcache'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xMDEmaWQ9MzQ5MSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="19770ffe05c73e226057858662f24d75" value="1" />	</div>
	</form>
<!-- <br />
