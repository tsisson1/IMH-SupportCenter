<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:48545:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-25/contact-form" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Learn to add a contact for in Joomla 2.5" />
  <title>214: Joomla 2.5 Contact Form | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-25/contact-form" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:216c49259a4f98d614f852545f71ae9b -->
...
<div class='page-header'>
	<h1>214: Joomla 2.5 Contact Form</h1>
</div>
<div class='section_listing'>
		...
		<tr>
				...
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/contact-form/install-aicontactsafe'>How to install aiContactSafe in Joomla 2.5</a>
					<div>In the first article of our aiContactForm tutorial series, we'll show you how to install this contact form component.</div>
					<div class='smallgrey'>Hits: 7,701</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/contact-form/create-contact-us'>Create a Contact Us page in Joomla 2.5 using aiContactSafe</a>
					<div>Now that we have installed aiContactSafe, we will now link to the default contact form using a Contact Us link.</div>
					<div class='smallgrey'>Hits: 12,501</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/contact-form/change-to-address'>Changing the TO address in an aiContactSafe Joomla 2.5 contact form</a>
					<div>You can change the recipient address for aiContactForms by changing the Email Address option in each profile.</div>
					<div class='smallgrey'>Hits: 7,451</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/contact-form/change-contact-information'>How to change contact information shown within aiContactSafe forms</a>
					<div>Contact information, such as name, address, and website url are shown by default to the right of each aiContactSafe contact form. In this tutorial, we'll show you how to change this contact information using aiContactSafe.</div>
					<div class='smallgrey'>Hits: 5,993</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/contact-form/add-new-field'>How to add a new field to aiContactSafe forms</a>
					<div>By adding new fields to your aiContactSafe forms, you can get more information from your site visitors. In this tutorial, we'll show you how to add a field for website url, allow users to enter the address to their website.</div>
			...
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/contact-form/rearrange-fields'>How to change the order of fields in aiContactSafe forms</a>
					<div>New fields will by default show last in your aiContactSafe form. In this tutorial, we'll show you how to rearrange fields in a form.</div>
			...
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/contact-form/change-field-width'>How to change the width of fields in aiContactSafe forms</a>
					<div>Each aiContactSafe profile has its own CSS file you can edit to style your forms. In this tutorial, we'll show you how to change field widths by adjusting the profile's CSS.</div>
					<div class='smallgrey'>Hits: 5,577</div>
				</td>
			</tr>
			</table>
</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yMTYmaWQ9MjE2JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="0c6c758a3898aa32a7ba707b44fe5d5c" value="1" />	</div>
	</form>
<!-- <br />
