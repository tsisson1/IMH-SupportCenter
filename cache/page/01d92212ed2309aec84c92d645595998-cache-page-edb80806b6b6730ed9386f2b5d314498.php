<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:73292:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/how-to/clear-browser-cache" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-08-27T18:09:45-07:00" />
  <meta name="keywords" content="clear browser cache" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="In this article we'll show you how to clear your browser's cache in several of the more popular web browsers." />
  <title>How to Clear your Browser cache - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/how-to/clear-browser-cache" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:df40c23fb3690d144e340c2e9fbb26e2 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to Clear your Browser cache									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>41,312</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Nov 11, 2011'><span style='color:#606060;'>Published:</span> Aug 27, 2015</div>
							...
							<div style='clear:both;'></div>
								...
								<p>When you visit websites on the internet, you're downloading from that website many different files. For example, not only will you download the html code for the page, but you may download javascript and CSS files, and you may also download media files such as jpg or gif images. Your computer saves a copy of these files so that if they're needed again, your computer and load them instantaneously instead of having to download them again from the web. This downloading and storing of files is referred to as caching, and can speed up website loading speeds for sites you visit often.</p>
<p>The problem we see many times however is that if you're editing a website and you make changes, you're not going to see those changes right away until your browser's cache clears. For example, if you update a CSS file to change the font-size of some text, if your browser loads the cached version of the CSS file, you won't see the changes. You need a way to tell your computer not to use the version of that CSS file it downloaded previously, and to instead download a fresh copy of it. Sometimes you can hit the refresh button in your browser to download all the files from the website and not use cache, but if that does not work you can clear all of your browser's cache.</p>

<p>Below we have listed the basic steps to clear your browser's cache in several of the more common web browsers. If you're not sure which browser version you're using, in most browsers click "Help" in the top toolbar, and then click "About".</p>


<p>If after following these steps your caching issue is not resolved, you may want to read more about <a href="/support/domain-names/dns-nameserver-changes/how-do-i-clear-my-local-dns-cache">clearing your local dns cache</a>.</p>

<h1>Clearing your Browser Cache</h1>

<p style="clear: both; margin-top: 20px; border-top: 1px solid #ccc;"></p>
<img alt="browser_internet_explorer" src="//cdn.inmotionhosting.com/support/images/stories/browser-icons/browser_internet_explorer.png" height="50" width="50" style="float: left; padding-right: 15px;" />
<h2>Microsoft Internet Explorer 9</h2>
<div style="clear: both;"></div>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/browser-icons/clear-cache/clear_cache_ie9.png"><img style="margin-right: 15px; margin-bottom: 15px; float: left;"  alt="clear_cache_ie9" src="//cdn.inmotionhosting.com/support/images/stories/browser-icons/clear-cache/clear_cache_ie9.png" /></a></p>
<ol>
<li>Open Internet Explorer.</li>
<li>Click Tools in the left menu bar (if opened) or click on the Gear icon in the right toolbar.</li>
<li>Click Internet Options and choose the General tab.</li>
<li>Click the Delete... button under the "Browsing History" section.</li>
<li>Make sure you uncheck "Preserve Favorites Website Data" at the top of this window.</li>
<li>Make sure you check all options below "Preserve Favorites Website Data".</li>
<li>Click the Delete button.</li>
<li>Click OK to close window.</li>
</ol>

<p style="clear: both; margin-top: 20px; border-top: 1px solid #ccc;"></p>
<img alt="browser_internet_explorer_ie8" src="//cdn.inmotionhosting.com/support/images/stories/browser-icons/browser_internet_explorer_ie8.png" style="float: left; padding-right: 15px;" />
<h2>Microsoft Internet Explorer 8</h2>

<div style="clear: both;"></div>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/browser-icons/clear-cache/clear_cache_ie8.gif"><img style="margin-right: 15px; margin-bottom: 15px; float: left;"  alt="clear_cache_ie8" src="//cdn.inmotionhosting.com/support/images/stories/browser-icons/clear-cache/clear_cache_ie8.gif" /></a></p>
<ol>
<li>Open Internet Explorer.</li>
<li>Click Tools in the left menu bar (if opened) or click on Tools in the lower right menu bar.</li>
<li>Click Internet Options and choose the General tab.</li>
<li>Click the Delete... button under the "Browsing History" section.</li>
<li>Make sure you uncheck "Preserve Favorites Website Data" at the top of this window.</li>
<li>Make sure you check all options below "Preserve Favorites Website Data".</li>
...
<p style="clear: both; margin-top: 20px; border-top: 1px solid #ccc;"></p>
<img alt="browser_internet_explorer_ie7" src="//cdn.inmotionhosting.com/support/images/stories/browser-icons/browser_internet_explorer_ie7.png" height="50" width="50" style="float: left; padding-right: 15px;" />
<h2>Microsoft Internet Explorer 7</h2>

<div style="clear: both;"></div>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/browser-icons/clear-cache/clear_cache_ie7.gif"><img style="margin-right: 15px; margin-bottom: 15px; float: left;"  alt="clear_cache_ie7" src="//cdn.inmotionhosting.com/support/images/stories/browser-icons/clear-cache/clear_cache_ie7.gif" /></a></p>
<ol>
<li>Open Internet Explorer.</li>
<li>Click Tools in the upper toolbar or click on the Tools icon.</li>
<li>Click Internet Options to open Internet Properties.</li>
<li>Click the General tab</li>
<li>Click Delete under "Browsing History".</li>
<li>Click Delete Files under "Temporary Internet Files".</li>
<li>Click Yes on the Delete Files dialog box.</li>
<li>Click Close and then OK.</li>
</ol>

<p style="clear: both; margin-top: 20px; border-top: 1px solid #ccc;"></p>
<img alt="browser_internet_explorer_ie6" src="//cdn.inmotionhosting.com/support/images/stories/browser-icons/browser_internet_explorer_ie6.png" height="50" width="50" style="float: left; padding-right: 15px;" />
<h2>Microsoft Internet Explorer 6</h2>

<div style="clear: both;"></div>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/browser-icons/clear-cache/clear_cache_ie6.jpg"><img style="margin-right: 15px; margin-bottom: 15px; float: left;"  alt="clear_cache_ie6" src="//cdn.inmotionhosting.com/support/images/stories/browser-icons/clear-cache/clear_cache_ie6.jpg" /></a></p>
<ol>
<li>From the Tools menu, select Internet Options.</li>
<li>On the General tab, in the Temporary Internet Files section, click Delete Files.</li>
<li>In the Delete Files dialog box, click OK.</li>
</ol>

<p style="clear: both; margin-top: 20px; border-top: 1px solid #ccc;"></p>
<img alt="browser_firefox" src="//cdn.inmotionhosting.com/support/images/stories/browser-icons/browser_firefox.png" height="50" width="50" style="float: left; padding-right: 15px;" />
<h2>Firefox</h2>

<div style="clear: both;"></div>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/browser-icons/clear-cache/clear_cache_ff.jpg"><img style="margin-right: 15px; margin-bottom: 15px; float: left;"  alt="clear_cache_ff" src="//cdn.inmotionhosting.com/support/images/stories/browser-icons/clear-cache/clear_cache_ff.jpg" /></a></p>
<ol>
<li>From the top toolbar, click "Tools" and then click "Clear Recent History"</li>
<li>Set "Time range to clear" to "Everything"</li>
<li>Under "Details", ensure only "Cache" is selected and then click "Clear Now"</li>
</ol>

<p style="clear: both; margin-top: 20px; border-top: 1px solid #ccc;"></p>
<img alt="browser_safari" src="//cdn.inmotionhosting.com/support/images/stories/browser-icons/browser_safari.png" height="50" width="50" style="float: left; padding-right: 15px;" />
<h2>Safari 4.0 and up</h2>

<div style="clear: both;"></div>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/browser-icons/clear-cache/clear_cache_safari.gif"><img style="margin-right: 15px; margin-bottom: 15px; float: left;"  alt="clear_cache_safari" src="//cdn.inmotionhosting.com/support/images/stories/browser-icons/clear-cache/clear_cache_safari.gif" /></a></p>
<ol>
<li>Open Safari.</li>
<li>Click Tools in the left menu bar (if opened) or click on the Gear icon in the right toolbar.</li>
<li>Select Reset Safari from the drop-down.</li>
<li>Choose what history and other elements to clear.</li>
<li>Click the Reset button.</li>
<li>Exit and re-launch the browser.</li>
</ol>

<p style="clear: both; margin-top: 20px; border-top: 1px solid #ccc;"></p>
<img alt="browser_opera" src="//cdn.inmotionhosting.com/support/images/stories/browser-icons/browser_opera.png" height="50" width="50" style="float: left; padding-right: 15px;" />
<h2>Opera</h2>

<div style="clear: both;"></div>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/browser-icons/clear-cache/clear_cache_opera.gif"><img style="margin-right: 15px; margin-bottom: 15px; float: left;"  alt="clear_cache_opera" src="//cdn.inmotionhosting.com/support/images/stories/browser-icons/clear-cache/clear_cache_opera.gif" /></a></p>
<ol>
<li>In Opera, click the Tools menu. If you don't see the menu bar, click the "Opera" tab in the upper left of the browser and click "Show Menu Bar"</li>
<li>Click Preferences.</li>
<li>Select the Advanced tab.</li>
<li>Click History.</li>
<li>In the "Disk cache" section, click Empty Now.</li>
<li>Click OK to close the Preferences window.</li>
</ol>

<p style="clear: both; margin-top: 20px; border-top: 1px solid #ccc;"></p>
<img alt="browser_chrome" src="//cdn.inmotionhosting.com/support/images/stories/browser-icons/browser_chrome.png" height="50" width="50" style="float: left; padding-right: 15px;" />
<h2>Chrome</h2>

<div style="clear: both;"></div>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/browser-icons/clear-cache/clear_cache_chrome.gif"><img style="margin-bottom: 15px; float: left; margin-right: 15px;"  alt="clear_cache_chrome" src="//cdn.inmotionhosting.com/support/images/stories/browser-icons/clear-cache/clear_cache_chrome.gif" /></a></p>
<ol>
<li>Click the 3 stripe icon at the top-right on the browser toolbar.</li>
<li>Select Tools.</li>
<li>Select Clear browsing data.</li>
<p class="alert">You can also hit <strong>Ctrl-Shift-Delete</strong> on your keyboard to end up at this same section.
</p>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/how-to/clear-browser-cache&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/how-to/clear-browser-cache'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zNSZpZD0yOTYmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="0a02d7054d417a2c3d4fe2499c69ffa9" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/cpanel/code-editor-doesnt-display-properly-in-chrome?tsrc=rsbraq'>Code editor doesn't display properly in Chrome</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/website-troubleshooting/omg-what-did-i-do-cant-access-my-joomla-website?tsrc=rsbraq'>OMG! What did I do.. Can't access my Joomla website.. </a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/wordpress/wordpress-home-link-not-working?tsrc=rsbraq'>WordPress Home Link Not Working</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/fighting-spam/how-long-for-mcafeee-email-protection-to-become-available-after-order?tsrc=rsbraq'>How long for McAfee Email Protection to become available after order?</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/wordpress/wordpress-not-saving-properly?tsrc=rsbraq'>Wordpress Not Saving Properly</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/website-troubleshooting/edits-to-data-in-phpmyadmin-not-showing?tsrc=rsbraq'>Changes to database using PHPmyAdmin not displaying on Webpage</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/wordpress/cannot-log-in-wp?tsrc=rsbraq'>Cannot log in WP</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/opencart/seo-friendly-urls-and-opencart-20?tsrc=rsbraq'>SEO Friendly URLS and Opencart 2.0+</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/prestashop-15/loading-in-the-back-of-prestashop?tsrc=rsbraq'>Loading in the back of Prestashop</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/whm/suspension-page-does-not-appear?tsrc=rsbraq'>Suspension Page does not appear</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/website-troubleshooting/website-is-displayed-as-it-is-under-maintainance?tsrc=rsbraq'>website is displayed as it is under maintainance</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/f9bff1efac806909a16c72c83a5f59d8?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/f9bff1efac806909a16c72c83a5f59d8'>Marvel</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-11 4:13 am</div>
				                <div><h3><span id="BlackBerry_6.0" class="mw-headline"> BlackBerry 6.0</span></h3>
<p><span class="mw-headline">- </span><strong class="whb">From the BlackBerry Browser, press the BlackBerry butto</strong></p>
<p>- <strong class="whb">Choose Options</strong></p>
<p><strong class="whb">- Toggle on "Cache" </strong></p>
<p><strong class="whb">- </strong><strong class="whb">Press "Clear Now" </strong></p>
<p><strong class="whb">Regards, &lt;a href="http://marvelessay.com/"&gt;essay helper&lt;/a&gt;</strong></p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26565);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
