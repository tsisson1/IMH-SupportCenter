<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:64331:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/moodle/user-roles-moodle/bulk-user-actions" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-10-24T20:32:45-07:00" />
  <meta name="keywords" content="moodle 2.3 bulk user actions delete all users message confirm download password" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="Bulk actions ran on users are convenient and saves time. For example, messaging a whole class of users with a uptade. This article will explain how to perform a User bulk action in Moodle 2.3." />
  <title>Running bulk user actions in Moodle - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/moodle/user-roles-moodle/bulk-user-actions" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:b00a39e31480d326d8f823d558614612 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '106.79.57.203']);
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/moodle' itemprop='url'><span itemprop='title'>Moodle<span></a><div class='dropdown_4columns'><h2>Moodle Education Channel</h2><div class='col_2'><h3>100 Level Classes</h3><div><a href='/support/edu/moodle/new-to-moodle'>101: Getting Started with Moodle</a></div><div><a href='/support/edu/moodle/creating-courses'>102: Creating Courses in Moodle</a></div><div><a href='/support/edu/moodle/activity-resource'>103: Adding an activity or resource to a course in Moodle</a></div><div><a href='/support/edu/moodle/create-restore-backup'>104: Creating and restoring backups in Moodle</a></div><div><a href='/support/edu/moodle/question-bank'>104: Working with the Question Bank</a></div><div><a href='/support/edu/moodle/user-roles-moodle'>105: User Accounts and Permissions in Moodle</a></div><div><a href='/support/edu/moodle/moodle-grading-reports'>106: Moodle Grading and Reports</a></div><div><a href='/support/edu/moodle/changing-appearance-moodle'>107: Changing the Appearance of Moodle</a></div><div><a href='/support/edu/moodle/moodle-plugins'>108: Managing Moodle Plugins</a></div><div><a href='/support/edu/moodle/additional-moodle-features'>109: Additional Moodle features</a></div></div><div class='col_2'><h3>200 Level Classes</h3><div><a href='/support/edu/moodle/moodle-site-security'>201: Moodle site security and server settings</a></div><div><a href='/support/edu/moodle/custom-moodle-reports'>202: Making Custom Moodle Reports</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/moodle/user-roles-moodle' itemprop='url'><span itemprop='title'>105: User Accounts and Permissions in Moodle<span></a><div class='dropdown_3columns'><h2> User Accounts and Permissions in Moodle</h2><div class='col_3'><div>1. <a style='display:inline;' href='/support/edu/moodle/user-roles-moodle/add-new-user'>Adding new users to the Moodle User Accounts</a></div><div>2. <a style='display:inline;' href='/support/edu/moodle/user-roles-moodle/user-profile-fields'>Editing User profile fields in Moodle</a></div><div>3. <a style='display:inline;' href='/support/edu/moodle/user-roles-moodle/bulk-user-actions'>Running bulk user actions in Moodle</a></div><div>4. <a style='display:inline;' href='/support/edu/moodle/user-roles-moodle/browse-list-of-users'>Browsing and filtering users in the Moodle Site Administration</a></div><div>5. <a style='display:inline;' href='/support/edu/moodle/user-roles-moodle/user-cohorts'>Creating Cohorts in the Moodle site administration</a></div><div>6. <a style='display:inline;' href='/support/edu/moodle/user-roles-moodle/download-bulk-users'>Exporting or Downloading users in Moodle</a></div><div>7. <a style='display:inline;' href='/support/edu/moodle/user-roles-moodle/upload-users'>Importing or Uploading users in Moodle</a></div><div>8. <a style='display:inline;' href='/support/edu/moodle/user-roles-moodle/remove-guest-login'>Removing the Guest login button from the Moodle login page</a></div><div>9. <a style='display:inline;' href='/support/edu/moodle/user-roles-moodle/permissions-user-policies'>Configuring the User Permission policies in Moodle</a></div><div>10. <a style='display:inline;' href='/support/edu/moodle/user-roles-moodle/site-administrator-roles'>Modifying Site Administrators in the User permissions section of Moodle</a></div><div>11. <a style='display:inline;' href='/support/edu/moodle/user-roles-moodle/define-roles'>Defining Roles in Moodle </a></div><div>12. <a style='display:inline;' href='/support/edu/moodle/user-roles-moodle/assign-system-roles'>Assigning system roles in Moodle</a></div><div>13. <a style='display:inline;' href='/support/edu/moodle/user-roles-moodle/check-system-permissions'>Checking user permissions in Moodle</a></div><div>14. <a style='display:inline;' href='/support/edu/moodle/user-roles-moodle/enrolling-users'>How to Enrol a student in a Moodle course</a></div><div>15. <a style='display:inline;' href='/support/edu/moodle/user-roles-moodle/skip-guest-login'>Allowing Guest access without logging into Moodle</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Running bulk user actio...</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Running bulk user actions in Moodle									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>3,689</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Oct 23, 2012'><span style='color:#606060;'>Published:</span> Oct 24, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>While maintaining users in Moodle, there are times when the administrator will need to submit a bulk request across all users. For example, if a specific lot of users need a message sent to them, or if all the users of a course need to be deleted, the <strong>User bulk actions</strong> feature is a handy utility. The following article will explain the basics of bulk user actions. For further information on the last tutorial in t his series, please visit <a target="_blank" href="/support/edu/moodle/user-roles-moodle/user-profile-fields" title="Click here to view the previous article">Editing User profile fields in Moodle</a>.</p>
<h3>Performing bulk actions on users</h3>
...
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/105/user-bulk-actions/bulk-user-actions-1-select.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="bulk-user-actions-1-select" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/105/user-bulk-actions/bulk-user-actions-1-select.gif" title="Click here to view the larger image" width="200" /></a>Navigate to <strong>Settings</strong> &gt; <strong>Site administration</strong> &gt; <strong>Users</strong> &gt; <strong>Accounts</strong> and select <strong>Bulk user actions</strong>.
<p class="alert"><strong>Important!</strong> Keep in mind that <a target="_blank" href="/support/edu/moodle/creating-courses/creating-courses-in-moodle" title="Click for more information">Editing must be turned on</a> in the <strong>Settings</strong> &gt; <strong>Front Page Settings</strong> section in order to edit any of these options. <br style="clear: both;" /></p>
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/105/user-bulk-actions/bulk-user-actions-3-add-selected.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="bulk-user-actions-3-add-selected-moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/105/user-bulk-actions/bulk-user-actions-3-add-selected.gif" title="Click here to view the larger image" width="200" /></a>Next the <strong>Bulk user actions</strong> page will display. In this section, users can be filtered by the <strong>User Full name</strong>. The <strong>Users in list</strong> section is for selecting the users for the actionn. All users or particular users can be added from the <strong>Available</strong> to the <strong>Selected</strong> areas and vise versa. For testing, Add users to the Selected area.<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/105/user-bulk-actions/bulk-user-actions-4-send-message.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="bulk-user-actions-4-send-message-moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/105/user-bulk-actions/bulk-user-actions-4-send-message.gif" title="Click here to view the larger image" width="200" /></a>In the <strong>With Selected users 'Choose'</strong> Drop box, select the option to run on the users that were added to the Selected area. In this tutorial, the <strong>Send a message</strong> option will be used.<br style="clear: both;" />
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/105/user-bulk-actions/bulk-user-actions-5a-wysiwyg.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="bulk-user-actions-5a-wysiwyg-moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/105/user-bulk-actions/bulk-user-actions-5a-wysiwyg.gif" title="Click here to view the larger image" width="200" /></a>Type the email message that is being sent in the <strong>Message body</strong> of the Message box and click <strong>Save Changes</strong>.</p>
<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/105/user-bulk-actions/bulk-user-actions-5-confirmation.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="bulk-user-actions-5-confirmation-moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/105/user-bulk-actions/bulk-user-actions-5-confirmation.gif" title="Click here to view the larger image" width="200" /></a>Next, there will be a Confirmation page asking "<strong>Do you really want to send the message above to all these users?</strong>" Click <strong>Yes</strong>. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/105/user-bulk-actions/bulk-user-actions-6-message-sentgif.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="bulk-user-actions-6-message-sentgif-moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/105/user-bulk-actions/bulk-user-actions-6-message-sentgif.gif" title="Click here to view the larger image" width="200" /></a>All the users that were Selected will receive an email similar to the following snapshot. Other actions can run on users using the User bulk actions like Delete, Display on Page, Confirm, Download, Force Password Change and Add to cohort. <br style="clear: both;" /></li>
</ol>
<p>This concludes the tutorial for the Running bulk user actions in Moodle. Please check the next article on <a target="_blank" href="/support/edu/moodle/user-roles-moodle/browse-list-of-users" title="Click here to view the next article">Browsing and filtering users in the Moodle Site Administration</a>. For more information on this Education Channel please visit <a target="_blank" href="/support/edu/moodle/user-roles-moodle" title="Click here to view the courses">Managing users and roles in Moodle</a></p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/moodle/user-roles-moodle'>105: User Accounts and Permissions in Moodle</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 3: Running bulk user actions in Moodle</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 2: <a href='/support/edu/moodle/user-roles-moodle/user-profile-fields'>Editing User profile fields in Moodle</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 4: <a href='/support/edu/moodle/user-roles-moodle/browse-list-of-users'>Browsing and filtering users in the Moodle Site Administration</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/moodle/user-roles-moodle/bulk-user-actions&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/moodle/user-roles-moodle/bulk-user-actions'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yODcmaWQ9MTkxMSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="85f6f1aa159eb7a0d4c5c17ca93d96f0" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/moodle/user-roles-moodle?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> User Accounts and Permissions in Moodle</h3></a>
		<table><tr><td colspan='2'><h4>User Accounts</h4></td></tr>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/moodle/user-roles-moodle/add-new-user?tsrc=rsbedu'>Adding new users to the Moodle User Accounts</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/moodle/user-roles-moodle/user-profile-fields?tsrc=rsbedu'>Editing User profile fields in Moodle</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/moodle/user-roles-moodle/bulk-user-actions?tsrc=rsbedu'>Running bulk user actions in Moodle</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/moodle/user-roles-moodle/browse-list-of-users?tsrc=rsbedu'>Browsing and filtering users in the Moodle Site Administration</a></td>
                </tr>
          <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/moodle/user-roles-moodle/user-cohorts?tsrc=rsbedu'>Creating Cohorts in the Moodle site administration</a></td>
                </tr>
          <tr >
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/moodle/user-roles-moodle/download-bulk-users?tsrc=rsbedu'>Exporting or Downloading users in Moodle</a></td>
                </tr>
          <tr >
                        <td valign='top'>7.</td>
                        <td><a href='/support/edu/moodle/user-roles-moodle/upload-users?tsrc=rsbedu'>Importing or Uploading users in Moodle</a></td>
                </tr>
          <tr >
                        <td valign='top'>8.</td>
                        <td><a href='/support/edu/moodle/user-roles-moodle/remove-guest-login?tsrc=rsbedu'>Removing the Guest login button from the Moodle login page</a></td>
                </tr>
        <tr><td colspan='2'><h4>User Roles and Permissions</h4></td></tr>  <tr >
                        <td valign='top'>9.</td>
                        <td><a href='/support/edu/moodle/user-roles-moodle/permissions-user-policies?tsrc=rsbedu'>Configuring the User Permission policies in Moodle</a></td>
                </tr>
          <tr >
                        <td valign='top'>10.</td>
                        <td><a href='/support/edu/moodle/user-roles-moodle/site-administrator-roles?tsrc=rsbedu'>Modifying Site Administrators in the User permissions section of Moodle</a></td>
                </tr>
          <tr >
                        <td valign='top'>11.</td>
                        <td><a href='/support/edu/moodle/user-roles-moodle/define-roles?tsrc=rsbedu'>Defining Roles in Moodle </a></td>
                </tr>
          <tr >
                        <td valign='top'>12.</td>
                        <td><a href='/support/edu/moodle/user-roles-moodle/assign-system-roles?tsrc=rsbedu'>Assigning system roles in Moodle</a></td>
                </tr>
          <tr >
                        <td valign='top'>13.</td>
                        <td><a href='/support/edu/moodle/user-roles-moodle/check-system-permissions?tsrc=rsbedu'>Checking user permissions in Moodle</a></td>
                </tr>
          <tr >
                        <td valign='top'>14.</td>
                        <td><a href='/support/edu/moodle/user-roles-moodle/enrolling-users?tsrc=rsbedu'>How to Enrol a student in a Moodle course</a></td>
                </tr>
          <tr >
                        <td valign='top'>15.</td>
                        <td><a href='/support/edu/moodle/user-roles-moodle/skip-guest-login?tsrc=rsbedu'>Allowing Guest access without logging into Moodle</a></td>
                </tr>
          	</table>
