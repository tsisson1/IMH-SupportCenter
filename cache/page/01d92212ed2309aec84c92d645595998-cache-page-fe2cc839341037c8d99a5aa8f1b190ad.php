<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:59521:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/zen-cart/finding-db-name" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-02-14T14:41:24-08:00" />
  <meta name="keywords" content="locate find database name Zen Cart" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="If you are looking for the database name your Zen Cart application is using, you can find out how to locate it with this short tutorial." />
  <title>Finding the database name for your Zen Cart website - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/zen-cart/finding-db-name" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:e4b090bf4c56edd6ef673ec24d27f05e -->
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/website/zen-cart' itemprop='url'><span itemprop='title'>Zen Cart<span></a><div class='dropdown_3columns'><div class='col_3'><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/zen-cart/getting-started-guide-zen-cart'>Getting Started Guide Zen Cart</a> (12800 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/zen-cart/resetting-your-zencart-admin-password'>Resetting your Zen Cart 1.5 Admin Password in PHPMyAdmin</a> (11656 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/zen-cart/set-up-ssl-with-oscommerce-and-zencart'>Set up SSL with OsCommerce and Zen Cart</a> (5743 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/zen-cart/how-to-upgrade-zencart'>How to upgrade Zen Cart</a> (2946 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/zen-cart/admin-dash-login'>Logging into the ZenCart admin dashboard</a> (2723 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/zen-cart/mass-price-adjustment'>How to perform a mass price increase for all products in Zen Cart.</a> (2508 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/zen-cart/finding-db-name'>Finding the database name for your Zen Cart website</a> (2465 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/zen-cart/installing-a-theme-in-zencart'>Installing a theme in Zencart</a> (2009 hits)</div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Finding the database name for your Zen Cart website</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Finding the database name for your Zen Cart website									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>2,465</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Feb 14, 2013'><span style='color:#606060;'>Published:</span> Feb 14, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Zen Cart's administrative area gives you the ability to handle most features and changes you will need to make on a regular basis. However, you may, at some point, need to work with the database directly, normally while using a tool like phpMyAdmin. This may be due to a particular database change that needs to be made that cannot be done via the admin panel, or perhaps you need to troubleshoot an issue. Regardless, knowing the right database name is important and guessing can be dangerous if you have more than a couple of databases in your account. Below are the steps to find the exact database name for your Zen Cart application. </p>
<h2>How to locate the database name for your Zen Cart</h2>
<ol class="article_list">
<li>L<a target="_blank" href="/support/component/content/email/email-client-setup/how-to-login-to-cpanel?Itemid=242">og into your cPanel</a> dashboard.</li>
<li>Now that you are in the main cPanel area, <a target="_blank" href="/support/component/content/email/email-client-setup/file-manager?Itemid=242">enter the File Manager</a>.</li>
<li>From the <em>File Manager</em>, find and enter the root folder for your Zen Cart store. In our example, the folder is named <em>zcstore</em> and is under the <em>public_html</em> root folder (<em>public_html/zcstore</em>). If you are using an addon domain, look for the domain name under the public_html folder. The files for an addon domain named example.com would be under the <em>public_html/example.com </em>folder</li>
<li>Under the root folder for your <em>Zen Cart</em> store, locate and click on the <strong>includes </strong>folder. Using our main domain as an example, the file path would be <em>public_html/includes</em>.</li>
<li>Once in in the <em>includes </em>folder, you will need to open the <strong>configure.php</strong> file for viewing. To open the file, highlight it and click on the <strong>Edit</strong> icon located in the toolbar across the top.</li>
<li>From the editor, you will see the text for the file. There is quite a bit so you may want to use the search feature or scroll down to find the line with the DB_DATABASE variable. Using the line of code below as an example, the second parameter is the full database name. The name is prefixed by your cPanel username (userna5) and the database name is the last portion (_zen123). <br /><br />
<div class="code_block">define('DB_DATABASE', 'userna5_zen123');</div>
</li>
<li>Write the database name down for later reference. You can now quickly locate your database when using tools like <a href="/support/component/content/edu/managing-databases-through-phpmyadmin?Itemid=203">phpMyAdmin</a> regerdless of how many databases your hosting account is using.</li>
</ol>
<p>&nbsp;</p>
<p>&nbsp;</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/zen-cart/finding-db-name&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/zen-cart/finding-db-name'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zOCZpZD01NzAmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="e5bf6839c84914666bcbd1d0a0cd263e" value="1" />	</div>
	</form>
<!-- <br />
