<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50511:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/wordpress/how-do-i-uninstall-wordpress" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hi Rooster, Thanks for posting your question. I'm more than happy to assist you today. If you installed WordPress through Fantastico de Luxe in cPanel, ..." />
  <title>How do I uninstall WordPress? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/wordpress/how-do-i-uninstall-wordpress" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:2757d12d1354cb380c55d886dc68abe1 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>How do I uninstall WordPress?</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/Rooster'>Rooster</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-02-06 9:50 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>5,097</span>
			</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_532' id='upvote_answer_532' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='532' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_532').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_532' id='downvote_answer_532' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='532' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_532').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hi Rooster,<br />
<br />
Thanks for posting your question. I'm more than happy to assist you today. If you installed WordPress through Fantastico de Luxe in cPanel, you can use the "Remove" option in Fantastico to un-install WordPress. This will remove all the files as well as the database. <br />
<br />
If you installed WordPress manually, you'll need to delete all the files associated with WordPress, and then you can delete the database. All of this can be done through cPanel using the Databases option (to remove the database) and file manager (to delete the files).<br />
<br />
<a href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-file-manager/using-file-manager-in-cpanel">Using File Manager</a><br />
<br />
...
Tim S
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_532').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_532' id='form_comment_on_answer_532' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/wordpress/how-do-i-uninstall-wordpress&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/wordpress/how-do-i-uninstall-wordpress'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="86c23e172fc29707b5d2f912f684303e" value="1" />	</div>
	</form>
<!-- <br />
