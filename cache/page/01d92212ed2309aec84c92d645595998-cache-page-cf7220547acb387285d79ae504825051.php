<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:71110:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/website-unavailable/why-is-my-website-down" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-04-21T23:12:14-07:00" />
  <meta name="keywords" content="website troubleshooting down problems" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="Learn the most common reasons as to why your website may be down." />
  <title>Why is my Website Down? - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/website-unavailable/why-is-my-website-down" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:25aac7b3c04b746f0a7472f1b05c06a1 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '1.136.96.163']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/website/website-unavailable' itemprop='url'><span itemprop='title'>Website Is Unavailable<span></a><div class='dropdown_3columns'><div class='col_3'><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/website-unavailable/why-is-my-website-down'>Why is my Website Down?</a> (40992 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/website-unavailable/account-suspensions'>Account suspensions</a> (17236 hits)</div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Why is my Website Down?</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>40,992</span></div>
  ...
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('downtime_reasons');">Website does not show up at all</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('errors');">Common error messages</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('suspensions');">Suspensions</button>
</div>
<p>If your website is not currently showing up when you try to visit it, there are a few different things that can be causing the issue.</p>

<h2>Domain Checker</h2>

<p>In this tutorial, we review many reasons your website may be down, ranging from dns to server issues. We are developing a new tool that attempts to automate the troubleshooting for many of the more common issues. You can use this tool <a href='/support/tools/domain-checker'>here</a>, or you can use the tool by entering your domain name below and clicking "Check Domain".</p>

<form method='get' action='/support/tools/domain-checker' target='_blank'>
    <strong style='padding-right:20px;'>Domain:</strong> <input type='text' name='domain' id='domain' style='width:300px;' value='' /><input type='submit' value='check domain' class='btn btn-primary' />
    <div style='color:#aaa; font-size:11px; padding:5px 0px 0px 83px;'>Enter only your domain name, such as "example.com". DO NOT include "www" or "http://"</div>
</form>
...
<a name='downtime_reasons'></a>
<h2>Problem: My website will not show up at all</h2>
<p>A website is generally "down" when:</p>
<ul class='article_list'>
<li>
  <h3>You're having an issue with your Internet Service Provider</h3> <p>This is most likely not the cause if you're reading this article online. If your Internet Service Provider is experiencing problems or your router is no longer working, you won't be able to see any websites.</p>
  </li>
  <li>
<h3>Connection issues between your ISP and us.</h3><p>There is a connection issue between your current location and our servers. When you visit any website, your request for that website is routed through several different routers. If one of those routers is down and no longer working, you may need to run a ping and trace route test to your domain and email our support@inmotionhosting.com with the results.</p>
  </li>
  <li>
<h3>There is a problem with our servers.</h3><p>We monitor our servers 24/7. If there's a problem, we're generally already aware of it and working to resolve it as quickly as possible. </p>
      </li>
  <li>
<h3>You recently updated your DNS or registered your domain.</h3><p>Any recent DNS changes can take up to 24 hours for these changes to take effect (aka DNS Propagation), so your website may appear down during this time. This includes newly registered domains as well. </p>
      </li>
  
  
  
  <li>
    <a name='server-ip-changed'></a>
    <h3>InMotion Hosting changed your server / IP address</h3>
    <p>There are some instances in which your account will be moved to another server, or the IP address of your server will be changed. Because of this, your site may not work for a few hours at most due to <a href="/support/domain-names/dns-nameserver-changes/domain-names-dns-changes">propagation</a>. If you're trying to <a href="/support/website/dreamweaver/dreamweaver-cs5-how-to-configure-server-settings">connect to your server with software like Dreamweaver</a>, try connecting using <a href="/support/website/cpanel/how-to-find-your-shared-ip-address-of-your-server-in-cpanel">your server's IP address</a> as the <strong>server name</strong> instead of your domain name.</p>
  </li>
  
  
  
  <li>
<h3>You spelled your domain wrong when typing it in.</h3><p>It happens to the best of us! Check the URL and make sure it is correct.</p>
      </li>
  <li>
    <a name="ipblock"> </a>
<h3>Your IP address has been blocked from the server</h3><p>Our System Administration team at times may block IP addresses from the server for several different reasons. If you are not able to get to your website, but other people can, your IP address might be blocked. In this case, please contact Tech Support, and provide them with your IP address. There are many different ways to get your IP address, here are a couple:
    <ul>
      <li>The easiest way is to visit our <a href="http://support.inmotionhosting.com/ipcheck.php"><strong>IP Checker</strong> tool</a>. Your IP address will be displayed on top of the page.</li>
      <li>You can also use a <a href="http://google.com" rel="nofollow" target="new">Google Search</a>.  In the search box, simply type "IP Address" and hit search. Google will return your IP address at the top of the search results.</li>
    </ul>
...
<a name='errors'></a>
<h2>Problem: My website is showing an error message</h2>
<p>There are different types of error messages that can cause a website to be down.</p>
<ul class='article_list'>
<li>
<h3>403 Forbidden Error:</h3><p>This is typically a permissions issue. If your website file or folder is set to "777" the error will display to protect it against hackers and attacks. Files should be set to "644" and folder are usually "755" or "750"</p>
  <p>Further information on 403 errors may be found at the following:</p>
  <a href="http://www.inmotionhosting.com/support/website/error-numbers/403-forbidden-error">403 Forbidden Error</a>
</li>
<li><h3>406 Not Acceptable:</h3><p>This error is usually caused by mod_security settings on your account. By default mod_security is enabled on all accounts. Some programs require mod_security be disabled. To disable you can contact our support department by emailing support@inmotionhosting.com</p>
    <p>Further information on 406 errors may be found at the following:</p>
  <a href="http://www.inmotionhosting.com/support/website/error-numbers/406-error">406 Error - Not Acceptable</a>
</li>
<li><h3>500 Internal Server Error:</h3><p>500 errors are usually general errors. These sometimes can be related to file permissions or incorrect coding in the .htaccess file. IF you need help with a 500 error please feel free to contact support.</p>
    <p>Further information on 500 errors may be found at the following:</p>
  <a href="http://www.inmotionhosting.com/support/website/error-numbers/500-internal-server-error">500 Internal Server Error</a>
</li>
<li><h3>"Server Not Found", "The Page Cannot Be Displayed".</h3><p>For more help with these errors, please see the information above, under "Problem: My website will not display at all".
</p>
    </li>
</ul>
<a name='suspensions'></a>
<h2>Problem: My website loads but says "This Account Has Been Suspended"!</h2>
<p>If your account is currently suspended, please contact support so you can speak to one of our system adminstrators to resolve this issue as quickly as possible.</p>
<p>Our system administrators are availible via phone at 1-888-321-HOST, or responding the the suspension email that you will receive to your primary email address.</p>
<p>Furhter information on account suspension may be found at the following:</p>
<a href="http://www.inmotionhosting.com/support/website/website-unavailable/my-website-is-suspended">"This site is currently Unavailable" My Website is suspended</a><br>
<a href="http://www.inmotionhosting.com/support/website/website-unavailable/account-suspensions">Account suspensions</a> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/website-unavailable/why-is-my-website-down&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/website-unavailable/why-is-my-website-down'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NTkmaWQ9MjM2JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="6f8df22a4d31f19dcb5eb1c19b5795ea" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support//?tsrc=rsbraq'>VPS offline?</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/website-troubleshooting/website-is-down?tsrc=rsbraq'>Website down - wont load in Firefox, Explorer</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/website-troubleshooting/site-down-help?tsrc=rsbraq'>My website is down, please help</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support//?tsrc=rsbraq'>Blocked from my website</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						...
						<div><a style='font-size:16px;' href='/support/community-support/users/Val123'>Val123</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2012-08-17 12:33 am</div>
				                <div>How does InMotion communicate server problems to customers? Some months ago the servers were hacked by a genius from Bangladesh. Today the &quot;disk is full&quot; with no ETA. Is every customer supposed to line up for a chat/phone session with tech support, or is there a server status page where we can find out what's happening? (My other hosting service offers that)</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(6879);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2012-08-20 10:49 am</div>
				                <div>Hello Val123,<br />
<br />
We do have a server status page located at: http://status.inmotionhosting.com/<br />
<br />
If any server connection issues are occurring they will be listed here along with any information they have.<br />
<br />
Best Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(6872);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-7923'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//graph.facebook.com/rdechevigny/picture?type=normal' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='/support/community-support/users/wpgrichard'>wpgrichard</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-06-03 11:56 pm</div>
				                <div>The servers have been having issues for over an hour now and the status appears to be normal.  There has been frequent down times lately.  I hope this gets resolved because it's pretty embarrassing when it goes down for extended periods.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(7923);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-06-03 11:57 pm</div>
				                <div>And I would like to add that your chat function doesn't work while the servers are down and I have been on hold to talk with someone for 45 minutes.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(7924);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
