<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:59890:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/ask-a-question" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="InMotion Hosting Support Center" />
  <title>Community Support</title>
  <link href="http://www.inmotionhosting.com/support/community-support/ask-a-question" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:43bbf6f856347de4a3dd61b64cc7b4ac -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '68.80.39.232']);
...
<div class='aaq_step' name='aaq_step_1' id='aaq_step_1'>
	...
	<div style='float:right; margin:0px 0px 15px 15px; width:200px;'>
        ...
        <p>It's time to get an answer! Our InMotion Hosting Support Team monitors all questions asked within the Community, and we guarantee a response within 60 minutes for current customers (<strong>8am - 9pm EST, Monday - Friday</strong>)!</p>
	...
	<div class='t-and-b'>
				...
				<p class='help-text'>
                                        ...
                                        <span style='color:#aaa;'>Example: <i>I cannot log into cPanel</i></span>
                                                                ...
                                                                <input maxlength="70" type='text' name='question' id='question' style='width:97%; display:inline;' onKeyUp="enough_details_for_question_submission();" value="" />
                                <div>
				...
				<p class='help-text'>
                                        ...
                                        <span style='color:#aaa;'>Example: <i>When I type in my cPanel username and password, it is rejected. What should I do, can I reset it?</i></span>
                                                                ...
                                                                <textarea name='details' id='details' style='width:97%; height:100px; margin-bottom:0px;' onKeyUp="enough_details_for_question_submission();"></textarea>
                                <div>
...
<div class='aaq_step' name='aaq_step_4' id='aaq_step_4'>
	...
	<table class='table table-striped table-bordered final-details'>
		<tr>
                	<th>Category</th>
			<td><select name='category_id' id='category_id' onChange='previewQuestion()' style='color:#000;'><option value='2055'>General Information</option><option value='2056'>Dns Nameserver Changes</option><option value='2057'>Billing</option><option value='2058'>Email Troubleshooting</option><option value='2060'>Wordpress</option><option value='2061'>Website</option><option value='2063'>Cyberduck</option><option value='2064'>File Management</option><option value='2065'>Domain Names</option><option value='2066'>New Customers</option><option value='2067'>Cpanel</option><option value='2068'>Databases</option><option value='2069'>How To</option><option value='2070'>Send Email From A Page</option><option value='2071'>Moodle</option><option value='2072'>General Server Setup</option><option value='2073'>Website Troubleshooting</option><option value='2074'>Registrations And Transfers</option><option value='2075'>Drupal</option><option value='2076'>Google Tools</option><option value='2077'>Website Design</option><option value='2078'>Email</option><option value='2079'>Ssl</option><option value='2080'>Email Client Setup</option><option value='2081'>Dreamweaver</option><option value='2082'>Iweb</option><option value='2083'>Premium Website Builder</option><option value='2084'>Outlook</option><option value='2085'>Iphone</option><option value='2086'>Joomla</option><option value='2087'>Mailing Lists</option><option value='2088'>Phpbb</option><option value='2089'>Zen Cart</option><option value='2090'>Frontpage</option><option value='2091'>Fighting Spam</option><option value='2092'>Wordpress 34</option><option value='2093'>Server Usage</option><option value='2094'>Oscommerce</option><option value='2095'>Everything Email</option><option value='2096'>Joomla 25</option><option value='2097'>Cube Cart</option><option value='2098'>Opencart</option><option value='2099'>Tools</option><option value='2100'>Website Transfers</option><option value='2101'>Html5</option><option value='2102'>Soho Web Builder</option><option value='2103'>Python</option><option value='2104'>Whm</option><option value='2105'>Magento</option><option value='2106'>Roundcube Webmail</option><option value='2107'>Horde Webmail</option><option value='2108'>Getting Started Guides</option><option value='2109'>Blacklist Check</option><option value='2110'>Image Editing</option><option value='2111'>Visual Domain Routing</option><option value='2112'>Edu</option><option value='2113'>Drupal 7</option><option value='2114'>Open Source</option><option value='2115'>Microsoft Publisher</option><option value='2116'>Prestashop 15</option><option value='2117'>Joomla 3</option><option value='2118'>Thunderbird</option><option value='2119'>Team</option><option value='2120'>Phplist</option><option value='2121'>Resources</option></select></td>
		</tr>
		<tr><td colspan='2'><p class='help-text'>Please select a category above that best describes your question.</p></td></tr>
		
	        <tr>
        	        <th>Email Address</th>
                	<td><input type='text' name='guest_email' id='guest_email' value='' /></td>
	        </tr>
        	<tr>
                	<td colspan='2'>
				...
				<u>This information will only be available to InMotion Hosting staff</u>, it will not show on your question page.</p>
	        		...
	        		<tr>
			<th>Domain name</td>
			<td><input type='text' name='cpanel_username_or_domain' id='cpanel_username_or_domain' value='' /></td>
		</tr>
		<tr>
			<td colspan='2'>
...
<input type="hidden" name="04452dc7fde3a472fdcf741e5a9fe384" value="1" /><input id="website" class="website" name="website" type="text"/>
...
9 + 10 = 
	...
	<p><button class='btn btn-success' style='text-transform:none;' onClick="postQuestion();return false;" />Post your question!</button></p>
	<input type='hidden' name='last_ajax_query_sent' id='last_ajax_query_sent' style='width:200px; display:block;' />
	<input type='hidden' name='currently_searching' id='currently_searching' value='0' />
	<input type='hidden' name='number_ajax_search_results' id='number_ajax_search_results' value='0' />
...
function get_ajax_search_results()
{
	...
	if(run_ajax == true)
	{
		...
		jQuery.get("/support/gadgets/search/",
...
function enough_details_for_question_submission()
{
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="04452dc7fde3a472fdcf741e5a9fe384" value="1" />	</div>
	</form>
<!-- <br />
