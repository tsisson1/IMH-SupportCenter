<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:80305:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-3/system-settings/session-lifetime" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-08-16T04:17:37-07:00" />
  <meta name="keywords" content="joomla 3.0 session lifetime" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="The Session Lifetime setting in Joomla 3.0 allows you to control when a user is auto logged out after they have been inactive for a certain amount of time." />
  <title>How to change the Session Lifetime in Joomla 3.1 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-3/system-settings/session-lifetime" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:dfbbdff0eb5b8575d48fdd434b0396cd -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '41.142.146.200']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to change the Session Lifetime in Joomla 3.1									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>10,232</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Aug 16, 2012'><span style='color:#606060;'>Published:</span> Aug 16, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>When you visit a website managed by Joomla 3.0, a session is started. Sessions help Joomla track specific information about specific users.</p>
<p> </p>
<h2>What are sessions?</h2>
<p>Let's say that two people are sitting side by side in an office. Each user visits the same website at the same time, and that particular website is driven by Joomla 3.0. If one user logs in and another doesn't, how does Joomla keep track of this? Sessions. Because of sessions, Joomla can easily keep track of certain values for each unique visitor to the website.</p>
<p> </p>
<h2>What is session lifetime?</h2>
<p>In this tutorial, we are focusing specifically on <strong>session lifetime</strong>. Session lifetime refers to how long an idle session is left open. The default value is 15 minutes. If you log into a Joomla 3.0 site and do nothing, after the default 15 minutes Joomla will no longer see you as a logged in user if you navigate to another page.</p>
<p>Joomla allows you to change the length of time that idle sessions stay open. This setting is referred to as <strong>Session Lifetime</strong>, and Joomla 3.0 gives the following description:</p>
<p><strong>Session Lifetime:</strong><br /><em>Auto log out a User after they have been inactive for the entered number of minutes. Do not set too high.</em></p>
<p> </p>
<h2>To adjust the Session Lifetime in Joomla 3.0:</h2>
<ol class="article_list">
<li><a href="/support/edu/joomla-3/getting-started/login-dashboard">Log into your Joomla 3.0 Administrator Control Panel</a></li>
<li>In the left menu, click the link <strong>Global Configuration</strong></li>
<li>Within the list of tabs at the top of the page, click <strong>System</strong>.</li>
<li>Towards the bottom of the page, under the <em>Session Settings</em> header you'll find the <strong>Session Lifetime</strong> setting. Make your desired changes, and then click the <strong>Save</strong> button in the top left of the page.
<p class="alert"><strong>Remember!</strong><br />The value you enter for <em>Session Lifetime</em> is in minutes. If you want to allow your users to stay logged in for up to one hour after being idle on your website, set the value to 60.</p>
<p class="alert"><strong>Please note!</strong><br />This setting affects both session for the front end of your website and the backend.</p>
</li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/joomla-3/system-settings'>205: Working with System Settings in Joomla 3</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 4: How to change the Session Lifetime in Joomla 3.1</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 3: <a href='/support/edu/joomla-3/system-settings/debug-language'>Understanding the Joomla 3.1 Debug Language setting</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 5: <a href='/support/edu/joomla-3/system-settings/session-handler'>A look at the Joomla 3.1 Session Handler Setting</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNDMmaWQ9MTY4NiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="dd8f32d50374751985e4cd8b3df59701" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/joomla-3/system-settings?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Working with System Settings in Joomla 3</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/joomla-3/system-settings/path-to-log-folder?tsrc=rsbedu'>Changing the folder logs are stored in within Joomla 3.1</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/joomla-3/system-settings/debug-system?tsrc=rsbedu'>How to put Joomla 3.1 in debug mode</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/joomla-3/system-settings/debug-language?tsrc=rsbedu'>Understanding the Joomla 3.1 Debug Language setting</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/joomla-3/system-settings/session-lifetime?tsrc=rsbedu'>How to change the Session Lifetime in Joomla 3.1</a></td>
                </tr>
          <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/joomla-3/system-settings/session-handler?tsrc=rsbedu'>A look at the Joomla 3.1 Session Handler Setting</a></td>
                </tr>
          	</table>
...
<a name='comments'></a>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/4a3c0d774733b6914520d83a0d5914de?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/4a3c0d774733b6914520d83a0d5914de'>Duckworth</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-14 5:46 am</div>
				                <div><p>Very helpful. It's really a nuisance having to log in after every 15 minutes or so. Normally, I change it 525600 minutes - practically impossible to go beyond that!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9685);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-12377'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/d5b7c03b7f237e3df136c1377547be93?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/d5b7c03b7f237e3df136c1377547be93'>Jeff</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-06 12:47 am</div>
				                <div><p>This is probably the wrong place for this comment, but I don't know where to put it. I'm having an issue with session lifetimes in Joomla 2.5. After searching for help, I found this article.</p>
<p>The problem is that I can't seem to change the session lifetime to anything except 15 minutes. If I change the number and click Save, there's a delay before the browser does anything visible (unusual), and then the page refreshes and it says 15 again. ???</p>
<p>I don't want to set it really high; maybe just 60 or so. But I can't change it.</p>
<p>Do you all have an article on this feature in Joomla 2.5?</p>
<p>Thanks!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12377);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-06 6:24 am</div>
				                <div>Hello Jeff,<br />
<br />
The steps are the same in Joomla 2.5 for changing the session time. It looks like when I do it in a test Joomla 2.5 install, it simply says &lt;strong&gt;Configuration successfully saved.&lt;/strong&gt; after clicking &lt;strong&gt;Save&lt;/strong&gt;.<br />
<br />
I'd be curious why yours is any different. If you possibly have access to your website's access logs I would look at the requests that happened at the time you made the change. Here is what I saw in mine:<br />
<br />
&lt;pre class=&quot;code_block&quot; style=&quot;margin: -10px 0px -30px 0px; line-height: .9em&quot;&gt;POST /joomla/administrator/index.php?option=com_config HTTP/1.1&quot; 303<br />
GET /joomla/administrator/index.php?option=com_config HTTP/1.1&quot; 200&lt;/pre&gt;<br />
<br />
Also do you happen to have the &lt;strong&gt;Session handler&lt;/strong&gt; set to &lt;strong&gt;None&lt;/strong&gt;? I would assume this has to be set to &lt;strong&gt;Database&lt;/strong&gt; in order to save the session value itself.<br />
<br />
- Jacob</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12388);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-11 4:17 pm</div>
				                <div><p>Hi Jacob! Thanks for answering.</p>
<p>Unfortunately I will need some help understanding what an access log is and how to find it. I will be happy to check with some help. I'm a paying InMotion customer so maybe someone on your end could do it more safely?</p>
<p>And my Session Handler is set to Database.</p>
<p>??? Thanks for your help.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12659);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-11 6:32 pm</div>
				                <div>Hello Jeff,<br />
<br />
The access log for your website is simply a log of all the requests that have happened to your site. You can &lt;a href=&quot;http://www.inmotionhosting.com/support/website/stats-logging/accessing-the-raw-access-logs-in-cpanel&quot; target=&quot;_blank&quot;&gt;access the raw access logs in cPanel&lt;/a&gt; in order to view them.<br />
<br />
I tried to take a look at your Joomla site, but I was unable to access the Joomla admin dashboard using the typical login process.<br />
<br />
If you'd like us to take a look into this issue for you, please provide the exact steps and credentials you're using to attempt to make the change. We will not make your comment public until removing any sensitive information from the post.<br />
<br />
- Jacob</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12666);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-14 6:46 pm</div>
				                <div><p>Yes, I would love to have someone else look at this for me because I am a little intimidated by "access logs". :-)</p>
<p>I think what you mean is that you couldn't find my administrator login URL? I don't mind giving it to you all because I trust InMotion... but I would rather not share it unless that's actually what you need. So you're saying... you need my admin login URL, admin username, and password?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12751);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-14 8:23 pm</div>
				                <div>Hello Jeff,<br />
<br />
...
<br />
Please provide the information and we can proceed.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12754);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-15 6:48 pm</div>
				                <div><p>&nbsp;</p>
<p>So after logging in I open Global Configuration, and click the System tab. Then, I try to change the Session Lifetime to anything other than 15. Really, I would just like it to be 60 (minutes). Then, the browser pauses for a long time (which is unusual) and then refreshes the page, and it says 15 again. ??? I appreciate your help.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12816);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-16 2:52 am</div>
				                <div>Hello Jeff,<br />
<br />
Apologies for the delay on this response.  I was looking at earlier, then came back to it after something occurred to me.  Although caching is disabled, its value should be the same (or greater) than the session lifetime.  When I set it to be the same, the session lifetime change saved with no problems.  I will see to updating this article after I confirm this for the version of Joomla that is referenced.<br />
<br />
Thanks for your patience!<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12829);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-17 7:16 pm</div>
				                <div><p>Thanks very much, Arn, Jacob, and InMotion! You're the best hosts. Problem solved.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12950);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
