<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:48898:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/wordpress/photographers-guide-wordpress" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Photographer's guide to creating a quick and simple WordPress website" />
  <title>207: Photographers Guide to a Simple WordPress Site | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/wordpress/photographers-guide-wordpress" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:2642caf7e511bb76df840d88da0a4cba -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-20']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '149.88.154.133']);
...
<div class='page-header'>
	<h1>207: Photographers Guide to a Simple WordPress Site</h1>
</div>
<div class='section_listing'>
	If you're a photographer and you want to build a quick website to show your pictures to your clients or a community. Look no farther than WordPress for a quick and easy solution to your portfolio needs.  	<table>
		<tr>
				<td style='width:75px; font-weight:bold;'>Section 1:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/wordpress/photographers-guide-wordpress/how-to-build-a-simple-photo-portfolio-website'>How to Build a Simple Photo Portfolio Website</a>
					<div>Need to build a quick Wordpress website that shows your photos?  This tutorial will show you how to build a portfolio website,using the default Wordpress theme and no plugins. We will cover, posts, pages, static pages, header images, menus, footers, and how to remove comments from pages/posts.</div>
					<div class='smallgrey'>Hits: 394</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/wordpress/photographers-guide-wordpress/manual-wp-install'>Manual WordPress Installation</a>
					<div>Learn how to install WordPress on your web server.  This tutorial covers the database setup and the famous WordPress 5 minute installation.</div>
					<div class='smallgrey'>Hits: 243</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/wordpress/photographers-guide-wordpress/creating-a-static-page'>Creating a Static Page in Wordpress</a>
					<div>Static pages are used to display information for a website typically without user interaction.  Many themes use static pages as the front or title page.</div>
					<div class='smallgrey'>Hits: 324</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/wordpress/photographers-guide-wordpress/creating-wp-photo-header'>Creating a Header Image for your WordPress Photo Site</a>
					<div>See how to create a banner or header image that will grace your Wordpress photo portfolio website</div>
					<div class='smallgrey'>Hits: 699</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/wordpress/photographers-guide-wordpress/creating-wp-page-or-post'>Creating a Page or Post in WordPress</a>
					<div>Follow this quick tutorial to learn the basics of adding a page or post in WordPress</div>
					<div class='smallgrey'>Hits: 57</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/wordpress/photographers-guide-wordpress/create-wp-photo-menu'>Creating a Menu for your WordPress Photography Site</a>
					<div>Create a menu using the twenty-fourteen theme for your WordPress photo portfolio website</div>
					<div class='smallgrey'>Hits: 108</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/wordpress/photographers-guide-wordpress/create-wp-footer'>Create a Footer for WordPress</a>
					<div>learn how to create a footer for your Wordpress website</div>
					<div class='smallgrey'>Hits: 134</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/wordpress/photographers-guide-wordpress/create-simple-wp-gallery'>How to Create a Gallery in Wordpress without a plugin</a>
					<div>Create a simple WordPress gallery without a plugin.  The image gallery can be created in a post or page with built-in functionality of WordPress</div>
					<div class='smallgrey'>Hits: 858</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/wordpress/photographers-guide-wordpress/remove-comments-2'>Remove Comments from a WordPress Page or Post</a>
					<div>When creating a portfolio site with WordPress, you may not need the user interactivity. This tutorial will walk you through removing comments from a page or post.</div>
					<div class='smallgrey'>Hits: 94</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/wordpress/photographers-guide-wordpress/changing-theme-colors'>Changing Colors in WordPress</a>
					<div>Portfolio websites for photographers often work with a specific color theme.  This tutorial will walk you through changing the color of the base WordPress theme</div>
					<div class='smallgrey'>Hits: 62</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/wordpress/photographers-guide-wordpress/changing-the-font-sizes'>Changing the Font Sizes in WordPress</a>
					<div>In some cases, you may need to change the font sizes for your pages and posts.  This tutorial will walk you through changing font sizes with the WordPress interface and Editor.</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD01MjkmaWQ9NTI5JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="71a2114dacd81e3d2340d3b10cc29a17" value="1" />	</div>
	</form>
<!-- <br />
