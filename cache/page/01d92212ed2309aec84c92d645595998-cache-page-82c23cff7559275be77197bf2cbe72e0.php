<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:51301:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/file-management/i-cant-compress-files-through-the-file-manager-on-the-cpanel" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Ecordova06, Sorry to hear that you're having problems with the compression of files. You should be able to use the File Manager to compress/uncomp..." />
  <title>I can't compress files through the File Manager on the cpanel | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/file-management/i-cant-compress-files-through-the-file-manager-on-the-cpanel" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:d4128e0b8b68ed7d27f3e17de2463c50 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>I can't compress files through the File Manager on the cpanel</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='http://graph.facebook.com/WorKing.OshitU/picture?type=normal' class='user_avatar' /><br />
			<a href='/support/community-support/users/ecordova06'>ecordova06</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-09-04 3:56 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>752</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>As soon as I select the files and clic on compress the system keeps showing the 'compressing' window... I have waited hours and it never actually compresses the files. </div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_3878' id='upvote_answer_3878' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='3878' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_3878').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_3878' id='downvote_answer_3878' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='3878' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_3878').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Ecordova06,<br />
<br />
Sorry to hear that you're having problems with the compression of files.   You should be able to use <a href="http://www.inmotionhosting.com/support/website/cpanel/compressing-uncompressing-files" target="new">the File Manager to compress/uncompress files</a>.  I logged into your File Manager, selected a few files and it worked for me.  The steps are basically:<br />
<br />
1) Select the file(s) to compress - Click on Compress.<br />
2) Select the compression type you want to use<br />
3) Click on the Compress Files button and the files are compressed.<br />
<br />
Are you able to go through all of these steps for a single file?  If you're having continual problems, please reply to this message and indicate the exact steps you are taking so that we can attempt to duplicate the issue.  Also indicate the files you are trying to compress.<br />
<br />
Apologies again for the issues!  Please let us know if you continue to require further assistance.<br />
<br />
Regards,<br />
Arnel C.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_3878').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_3878' id='form_comment_on_answer_3878' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/file-management/i-cant-compress-files-through-the-file-manager-on-the-cpanel&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/file-management/i-cant-compress-files-through-the-file-manager-on-the-cpanel'></div>
<script type='text/javascript'>
  (function() {
