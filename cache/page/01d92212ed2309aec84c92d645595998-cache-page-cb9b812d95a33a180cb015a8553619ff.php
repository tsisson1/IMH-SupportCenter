<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:60451:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/how-to/image-homepage" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-01-16T17:20:33-08:00" />
  <meta name="keywords" content="image front page website htaccess index" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="The front page of your website can be changed to use an image, follow this tutorial to learn how." />
  <title>How to place an image file as your homepage - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/how-to/image-homepage" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:0ec92d52c34281d5c49f267a42dfc649 -->
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to place an image file as your homepage</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to place an image file as your homepage									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>2,927</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 16, 2013'><span style='color:#606060;'>Published:</span> Jan 16, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>By default, the webservers at InMotion Hosting look for specific file names to display as the first page of a website. They also look for these pages in a specific order. The file names, in order, are <em>index.htm</em>, <em>index.html</em>, <em>index.php</em></p>
<p>If you want to use a different file, such as an image, you will need to tell the server to look specifically for that file and to ignore the default file names. Perhaps you created a nice image with your business logo and 'Coming Soon!' as the text and wish to use that image as your main page. Follow along with the instructions below to learn how to set an image as the first page of your site.</p>
<p class="alert">NOTE: This is not a recommended method as the image will display in different locations on the visitor's screen depending on which browser they are using. The recommended method would be to create a single index.htm or index.html file with just that image. This way it would display uniformly across the browsers.</p>
<h2>Setting an image as your website's homepage</h2>
<ol class="article_list">
<li><a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">Log into your cpanel</a></li>
<li><a href="/support/edu/cpanel/cpanel-file-manager/using-file-manager-in-cpanel">Using the File Manager</a>, navigate to the home folder for the domain you want to work with.</li>
<li>Once inside the correct folder, you will need to edit your <em>.htaccess</em> file by highlighting the file and clicking the <strong>Edit</strong> icon located across the top of the panel. If you do not have one in the folder, you will first need to create a new one by clicking the <strong>New File</strong> icon located in the list of icons at the top of the screen. (note the correct name is .htaccess complete with the . in the front)</li>
<li>Once the editor page comes up on the screen, you will want to enter the code <em>DirectoryIndex [filename] </em>at the top of the file. Be sure to change [filename] to your image filename. For example, if your image is named splash.jpg then you would enter the code below.<br />
<div class="code_block">DirectoryIndex splash.jpg</div>
</li>
<li>Once you have entered the code, click the <strong>Save Changes</strong> button found in the upper right hand screen. You can now visit your site and see your image as the first page.<em><br /></em></li>
</ol> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/how-to/image-homepage&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/how-to/image-homepage'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zNSZpZD01MDMmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
