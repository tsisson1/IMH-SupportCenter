<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:60104:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/prestashop-15/edit-cust-reassurance-info" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-12-05T22:24:24-08:00" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Looking to remove the Money Back Guarantee or In-Store Exchange icons from your store? Learn how in this PrestaShop 1.5 tutorial" />
  <title>356: Editing the Customer Reassurance information in Prestashop 1.5 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/prestashop-15/edit-cust-reassurance-info" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:6acd41251e64654fed437711347ea7a0 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															356: Editing the Customer Reassurance information in Prestashop 1.5									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>1,229</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Dec 5, 2013'><span style='color:#606060;'>Published:</span> Dec 5, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>When you first install PrestaShop you will see there is a lot of default information on your site that is common to a large portion of online businesses. Specifically there is a section at the top of the footer area that displays icons relating to <em>Money Back Guarantee</em>, <em>In-Store Exchange</em>, <em>Payment Upon Shipment</em>, <em>Free Shipping</em> and  <em>100% Secure Payment Processing</em>.</p>

<p>This information is known as '<em>Customer Reassurance</em>' as it is used to reassure the customer that they are safe by shopping with you due to these features. Your store may not have some or even any of these features. In that case, you may want to remove them from the section so that your customers do not get the wrong idea.</p>

<h2>Removing Customer Assurance information in PrestaShop</h2>
<p>Depending on whether you are removing individual items or the entire section, you will need to take a different route. Below are instructions for each method.</p>

<h3>Removing the Customer Assurance section from the footer area</h3>
<ol class="article_list">
  ...
  <li>From the menu bar at the top of your admin screen, hover over the <strong>Modules</strong> tab and select the <strong>Positions</strong> option from the dropdown menu.<div style="clear:both;"></div></li>

  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/356/1-select-customer-reassurance.png"><img  style="float:right; margin:0px 0px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/356/1-select-customer-reassurance.png" title="Click here to view the larger image" width="200" /></a>
  <p>The lands you on the <em>Module Positions</em> page where you can adjust data that is displayed in different sections of the site. Look for the section entitled <em>Footer</em>, it should appear similar to <strong>Footer - 7 Modules</strong>. Find the module named <em>Customer reassurance block</em>, which should be the first in the list. Click on the <strong>Delete</strong> icon on the right side of the module's row. It appears as a trashcan. The deletion is automatic and you can return to your site to see that the row of icons is now gone.</p>
  
  <div style="clear:both;"></div>
  
  <table class="article_table">
    <tr><th>Before</th><th>After</th><tr>
    <tr><td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/356/before.png"><img   alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/356/before.png" title="Click here to view the larger image" width="200" /></a></td><td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/356/after1.png"><img   alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/356/after1.png" title="Click here to view the larger image" width="200" /></a></td></tr>
  </table>
  <div style="clear:both;"></div></li>
</ol>

  
<h3>Removing a single item from the Customer Assurance list</h3>
<ol class="article_list">
  <li><a href="/support/edu/prestashop-15/getting-started/login-to-dashboard">Log into your admin interface</a>.<div style="clear:both;"></div></li>

  <li>Hover over the <strong>Modules</strong> tab from the top menu and then select the <strong>Modules</strong> option from the dropdown.<div style="clear:both;"></div></li>

  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/356/2-select-customer-reassurance-module.png"><img  style="float:right; margin:0px 0px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/356/2-select-customer-reassurance-module.png" title="Click here to view the larger image" width="200" /></a>
  <p>This leads you to the main module list page. Locate the <em>Customer Reassurance Block</em> module and click on the <strong>Configure</strong> link.</p>
  <div style="clear:both;"></div></li>
  
  <li><p>You can now edit the list of features that appear. To remove one, simply click on the <strong>Delete</strong> icon (the trashcan) to the right side of the item's row. In our example, we want to remove the <em>In-store exchange</em> as we do not have a physical store for someone to make a return.<div style="clear:both;"></div>
  </p>
  <p>After you have deleted the item, you can visit your site again and see that the <em>In-Store Exchange</em> icon is now missing from the <em>Customer Reassurance</em> area.
  </p><div style="clear:both;"></div>
  <table class="article_table">
<tr><th>Before</th><th>After</th><tr>
<tr><td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/356/before.png"><img   alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/356/before.png" title="Click here to view the larger image" width="200" /></a></td><td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/356/after2.png"><img   alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/356/after2.png" title="Click here to view the larger image" width="200" /></a></td></tr>
</table>
  </li>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 1: 356: Editing the Customer Reassurance information in Prestashop 1.5</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 2: <a href='/support/edu/prestashop-15/reset-prestashop-admin-password'>355: How to Reset the PrestaShop Administrator Password</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/prestashop-15/edit-cust-reassurance-info&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/prestashop-15/edit-cust-reassurance-info'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD05OSZpZD0zMDIyJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
