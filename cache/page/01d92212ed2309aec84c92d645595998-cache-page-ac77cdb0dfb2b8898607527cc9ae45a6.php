<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:40751:" 
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:e62aa99a8475e408118b06878e1812bd -->
...
<div class='container'>
	...
	<div class='item-page'>
		<div class='page-header'><h1>Search results for: <span style='color:#aaa;'>set_magik</span></h1></div>
		<form method='get' action='/support/search' >
                        <input type='text' name='searchword' id='mod-search-searchword' style='width:500px;' value='set_magik' />
		...
		<p class='alert' style='margin-top:20px;'>Sorry, we did not find any search results. Please search again or feel free to <a href='/support/community-support/ask-a-question'>ask us a question</a>.</p>
	</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP3NlYXJjaHdvcmQ9c2V0X21hZ2lrJm9wdGlvbj1jb21fY29udGVudCZjYXRpZD0zNTYmaWQ9MzU2JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
