<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:60749:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/email/exim/manage-the-exim-mail-queue-via-ssh" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-03-19T23:25:00-07:00" />
  <meta name="keywords" content="exim mail queue management ssh" />
  ...
  <link href="http://www.inmotionhosting.com/support/email/exim/manage-the-exim-mail-queue-via-ssh" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:9eaaf50000208c2c58a8a6d31b5eddee -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-22']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '86.35.0.82']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Manage the Exim mail queue via SSH									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>16,884</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 18, 2013'><span style='color:#606060;'>Published:</span> Mar 19, 2014</div>
...
<p class="alert">To follow this guide you'll have to have <a href="/support/website/general-server-setup/root-access-faq">root access</a> to either your VPS or dedicated server so you can access the Exim commands.</p>
...
<li>Run the following command to view the current Exim mail queue:<br /><br /> <span class="code_block">exim -bp</span>
<p>You should get back something that looks like:</p>
<p class="code_block" style="width: 500px;">8m 13K 1TwJgO-0001q8-E5 &lt;sender@example.com&gt; *** frozen ***<br /> user@example.com<br /><br /> 7m 7.5K 1TwJhK-00037o-U8 &lt;sender@example.com&gt; *** frozen ***<br /> user@example.com<br /><br /> 5m 8.0K 1TwJic-00047T-70 &lt;sender@example.com&gt; *** frozen ***<br /> user@example.com<br /><br /> 3m 7.6K 1TwJlQ-0006MV-84 &lt;sender@example.com&gt; *** frozen ***<br /> user@example.com</p>
...
<li>Now you can take one of the Exim message IDs from the queue and further investigate it in the Exim mail log as to why the message can't deliver with this command:<br /><br /> <span class="code_block">exigrep -I -l 1TwJlQ-0006MV-84 /var/log/exim_mainlog</span>
<p>This will give you back the full transaction of that message ID exposing</p>
<p class="code_block" style="width: 500 px;">2013-01-18 16:46:16 1TwJlQ-0006MV-84 &lt;= sender@example.com H=localhost [127.0.0.1] T="Update on employee contacts" for user@example.com<br /> 2013-01-18 16:46:16 1TwJlQ-0006MV-84 ** user@example.com R=virtual_user_maildir_overquota: Mailbox quota exceeded<br /> 2013-01-18 16:46:16 1TwJlQ-0006MV-84 Completed</p>
</li>
...
<span class="code_block">exim -M 1TwJlQ-0006MV-84</span>
<p>If you wanted to remove the message from the mail queue.</p>
<span class="code_block">exim -Mrm 1TwJlQ-0006MV-84</span></li>
</ol>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/email/exim/manage-the-exim-mail-queue-via-ssh&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/email/exim/manage-the-exim-mail-queue-via-ssh'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NjMmaWQ9ODA4JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/a3ab4a31c9fcf9637c416c48ab9b69ab?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/a3ab4a31c9fcf9637c416c48ab9b69ab'>Sameer Kulkarni</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-21 3:38 am</div>
				                <div><p>This was very helpful for me to clear the frozen mail Queue.</p>
<p>Thank you!!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13061);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-21 3:45 am</div>
				                <div>You can improve this by providing a meaning of commands like -I, -Mrm, etc.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13062);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-21 10:25 am</div>
				                <div>Hello Sameer,<br />
<br />
Thank you for your suggestions. We have been updating our article on <a href="http://www.inmotionhosting.com/support/website/linux/command-list" >Linux Commands</a>, and we will look into adding these.<br />
<br />
If you have any further questions, feel free to post them below.<br />
Thank you,<br />
<br />
-John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13084);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
