<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:54610:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/opencart/opencart-menu-banner-issue" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="It sounds like something else on your site may be offsetting it. Could you provide me with the URL of where I can see this?..." />
  <title>opencart menu banner issue | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/opencart/opencart-menu-banner-issue" rel="canonical" />
...
<script>
  ...
  ga('send', 'pageview');
	...
	<!-- cid:d59760bc8a414ba20cf0eeb2306ecdab -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>opencart menu banner issue</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2014-04-01 11:39 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>79</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I am using opencart template. on the main menu banner I have 4 categories(Mens, Womens, Kids,...). For some reason, the most left categories(&quot;Mens&quot;) is displayed one or two pixels higher that other categories. Can't figure out what the problem is. Do you know which file i need to take a look?</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_4748' id='upvote_answer_4748' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='4748' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_4748').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_4748' id='downvote_answer_4748' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='4748' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_4748').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>11,186 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2014-04-02 7:48 am EST
                		        </div>
					
		                </div>

				It sounds like something else on your site may be offsetting it.  Could you provide me with the URL of where I can see this?
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_4748').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_4748' id='form_comment_on_answer_4748' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>http://www.tannersavenue.com/index.php<br />
<br />
you can see Men is about 2 pixels higher than other categories.</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>&lt;div style=&quot;background-color: #FFF; padding-left: 10px;&quot;&gt;Hello,<br />
<br />
It looks like you had this code affecting the first menu item by having a &lt;span style=&quot;color: red;&quot;&gt;11px&lt;/span&gt; margin at the top:<br />
<br />
&lt;span style=&quot;color: red;&quot;&gt;/catalog/view/theme/selling/stylesheet/stylesheet.css&lt;/span&gt;<br />
<br />
&lt;pre class=&quot;code_block&quot; style=&quot;margin: -10px 0px -30px 0px; line-height: .9em&quot;&gt;#menu-light &amp;gt; ul &amp;gt; li:first-child &amp;gt; a {<br />
    padding: &lt;span style=&quot;color: red;&quot;&gt;11px&lt;/span&gt; 10px 11px 10px;<br />
}&lt;/pre&gt;<br />
<br />
These rules only affect the first menu item because of the &lt;span style=&quot;color: red;&quot;&gt;li:first-child&lt;/span&gt; part of the rule. I changed this for you to:<br />
<br />
&lt;pre class=&quot;code_block&quot; style=&quot;margin: -10px 0px -30px 0px; line-height: .9em&quot;&gt;#menu-light &amp;gt; ul &amp;gt; li:first-child &amp;gt; a {<br />
    padding: &lt;span style=&quot;color: red;&quot;&gt;13px&lt;/span&gt; 10px 11px 10px;<br />
}&lt;/pre&gt;<br />
<br />
This will move the margin down &lt;span style=&quot;color: red;&quot;&gt;2px&lt;/span&gt; more, which seems to be how far it is off. You will need to be sure to &lt;a href=&quot;http://www.inmotionhosting.com/support/website/how-to/clear-browser-cache&quot; target=&quot;_blank&quot;&gt;clear your browser's cache&lt;/a&gt;, so that you download the fresh copy of the CSS stylesheet from the server.<br />
<br />
...
- Jacob&lt;/div&gt;</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>&lt;div style=&quot;background-color: #FFF; padding-left: 10px;&quot;&gt;Hello again,<br />
<br />
No problem at all, glad to help!<br />
<br />
- Jacob&lt;/div&gt;</div>
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="94ed634738683c8c8eec52f532e9b6d6" value="1" />	</div>
	</form>
<!-- <br />
