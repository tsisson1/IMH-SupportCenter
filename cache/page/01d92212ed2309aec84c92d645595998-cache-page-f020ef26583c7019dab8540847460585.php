<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:52870:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/ssl" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="keywords" content="%default%" />
  <meta name="description" content="SSL Category" />
  <title>Secure Socket Layer (SSL) Tutorials | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/ssl" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:11f6481b80d5b9ed8ee2b7c8ba2b3cbe -->
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Secure Socket Layer (SSL) Tutorials</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='item-page'>
        ...
        <div class='page-header'>
                <h1>Secure Socket Layer (SSL) Tutorials</h1>
        </div>

<div class="white_box">
<h2 style="margin-top:0px;padding-top:0px;">Learn about SSL</h2>
    <div style="margin: 5px 15px 5px 10px">
        <p>This section teaches you the basics of SSL certificates.</p>
        <ul>
          <li><a href="/support/website/ssl/what-is-ssl-and-why-is-it-important">What is SSL and why is it important?</a></li>
            <li><a href="/support/website/ssl/how-does-the-shared-ssl-work">How does the shared SSL work?</a></li>
...
<div class="white_box">
<h2 style="margin-top:0px;padding-top:0px;">Obtain an SSL</h2>
    <div style="margin: 5px 15px 5px 10px">
        <p>Learn how to acquire an SSL.</p>
      <ul> <li><a href="/support/website/ssl/how-do-i-obtain-an-ssl-certificate">How do I obtain an SSL certificate?</a></li></ul>   
  </div>
<br />
</div><br>

<div class="white_box">
<h2 style="margin-top:0px;padding-top:0px;">Using an SSL</h2>
    <div style="margin: 5px 15px 5px 10px">
        <p>Learn how to use an SSL.</p>
      <ul><li><a href="/support/website/ssl/how-to-force-ssl-using-the-htaccess-file">How to force a dedicated SSL using the .htaccess file</a></li>
      <li><a href="/support/website/ssl/install-third-party-ssl">Installing a Third Party SSL</a></li>  <li><a href="/support/website/ssl/forcing-your-websites-visitors-to-use-ssl">Forcing your Website's visitors to use the shared SSL</a></li>       </ul>    
  </div>
<br />
</div>
<form action="http://www.inmotionhosting.com/support/website/ssl" method="post" name="adminForm" id="adminForm" class="form-inline">
  ...
  <table class='article_list'>
          ...
          <tr>
                                <td style='padding-right:20px;'><a href='/support/website/ssl/how-do-i-obtain-an-ssl-certificate'>How to Purchase/Cancel an SSL from AMP</a></td>
                                <td>112,017</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/website/ssl/how-to-force-https-using-the-htaccess-file'>How to force HTTPS using the .htaccess file</a></td>
                                <td>74,211</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/website/ssl/self-signed-ssl-certificate-warning'>Self signed SSL certificate warning</a></td>
                                <td>37,647</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/website/ssl/what-is-ssl-and-why-is-it-important'>What is SSL and why is it important?</a></td>
                                <td>27,855</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/website/ssl/how-does-the-shared-ssl-work'>How does the shared SSL work?</a></td>
                                <td>25,034</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/website/ssl/install-third-party-ssl'>Creating a CSR and Installing a Third Party SSL</a></td>
                                <td>22,801</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/website/ssl/how-do-i-show-the-secure-seal-for-my-site'>How do I show the secure seal for my site?</a></td>
                                <td>12,865</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/website/ssl/forcing-your-websites-visitors-to-use-ssl'>Forcing your Website's visitors to use the shared SSL</a></td>
                                <td>8,308</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/website/ssl/sha-1'>How to Fix the Insecure SSL Error due to SHA-1 Deprecation </a></td>
                                <td>2,079</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/website/ssl/comodo-ssl-certificate-details'>Comodo SSL certificate details</a></td>
                                <td>1,267</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/website/ssl/request-csr-in-amp'>Requesting a CSR for 3rd Party SSLs in AMP</a></td>
                                <td>910</td>
                        </tr>
                  </table>
	</form>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD03NiZpZD03NiZ2aWV3PWNhdGVnb3J5Jkl0ZW1pZD0xMDE=" />
