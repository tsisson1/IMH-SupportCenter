<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:60371:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/website-troubleshooting/protocol-relative-urls-not-working" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-06-24T14:49:26-07:00" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="Protocol Relative URLs not working? The problem may be with the base tag in your header." />
  <title>Protocol Relative URLs not working - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/website-troubleshooting/protocol-relative-urls-not-working" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:389e8360a827384121fa041e21161d8d -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '24.233.171.54']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Protocol Relative URLs not working</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Protocol Relative URLs not working									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;' title='Originally published: Jun 24, 2014'><span style='color:#606060;'>Published:</span> Jun 24, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<style>
  .item-page h2 {border:0px;color:#000;padding-right:15px;margin:0px;}
  table tr td,
...
<table>
  <tr>
    <th><h2>Problem:</h2></th>
    <td>
      <p>I am using Protocol Relative URLs / relative URLs when referencing css and javascript. When I access my page over <span style='color:green; font-weight:bold;'>https / ssl</span>, the css and js is being called over <span style='color:red; font-weight:bold;'>http / no ssl</span>.</p>
      
      <p>It is resulting in the following <a href="/support/website/javascript/diagnose-javascript-errors">javascript error</a>:</p>
      
      <p class='alert alert-danger'><strong>[blocked] The page at</strong> 'https://www.domain.com/page.php' <strong>was loaded over HTTPS, but ran insecure content from '</strong>http://www.domain.com/style.css<strong>': this content should also be loaded over HTTPS.</strong></p>
    </td>
  </tr>
  <tr>
    <th><h2 style='color:green;'>Solution:</h2></th>
    <td>
      <p>If you are using the base tag within your header, the protocol being used in your base tag will be used when calling scripts using <em>Protocol Relative URLs</em> <strong>/</strong> <em>relative URLs</em>.</p>
      
      <pre class='code_block'>&lt;head&gt;
    &lt;base href='<strong style='background:yellow;'>http</strong>://www.domain.com/page.php' /&gt;
&lt;/head&gt;</pre>
      
      <p><strong>If you need to use the base tag in your head</strong>, make sure to adjust it so that it uses <span style='color:green; font-weight:bold;'>https when using ssl</span>, and <span style='color:red; font-weight:bold;'>http when not using ssl</span>.</p>
    </td>
  </tr>
</table>
...
<div style='display:inline-block;'>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zNCZpZD0zMzIxJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="4d7eaf6b20ca93d4e16b7bd0b3d4d23c" value="1" />	</div>
	</form>
<!-- <br />
