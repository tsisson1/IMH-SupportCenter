<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:59249:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/wordpress/customize-wp-sidebar/sidebar-list" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-01-24T17:47:10-08:00" />
  <meta name="keywords" content="nested list add Wordpress" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Customize your WordPress sidebar by adding nested lists with this tutorial." />
  <title>Adding Nested Links to your sidebar in Wordpress  - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/wordpress/customize-wp-sidebar/sidebar-list" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:2b9f9aaaa018de4bdaeec63163a42425 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Adding Nested Links to your sidebar in Wordpress 									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>1,499</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 24, 2013'><span style='color:#606060;'>Published:</span> Jan 24, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Default and older WordPress themes use nested lists to present their sidebar information. A nested list is simply a list of unordered items inside one another. A simple example of a nested list is below:</p>
<ul>
	<li>Flowers
		<ul>
			<li>Lilies</li>
...
<p>You may have your own nested lists you wish to add to your sidebar for your selected Wordpress theme. This article demonstrates how to add nested lists of items into your theme's sidebar. Note this example uses the Twenty Twelve default theme found in WordPress 3.5</p>
<ol class="article_list">
	...
	<li>Once logged into the Admin area, look to the left hand menu and click on the <em>Appearance</em> mneu category. This will reveal several sub-options. Click on the <strong>Editor</strong> option to continue.</li>
	<li>You are now on the main Editor page for all php and css files for your theme. Look to the menu on the right-hand side, scroll down until you see the <strong>Sidebar</strong> option. Click on that link to open the <em>sidebar.php</em> file in the editor.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/sidebar/nested-list/select-editor.png"><img  alt="select editor menu option" src="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/sidebar/nested-list/select-editor.png" /></a></li>
	<li>Once the file opens you will see the php code that governs the sidebar display and behavior. The highlighted line of code below is the code that calls the widgets. To add a nested list before the widgets, you will add your code before this line. To add the nested list after the widgets, add the code after the line. We will add the same list as above to our sidebar. The exact code for that list is below.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/sidebar/nested-list/sidebar-edit.png"><img  alt="sidebar code editor" src="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/sidebar/nested-list/sidebar-edit.png" /></a><br />
		<div class="code_block">&lt;ul style="list-style-type: disc;"&gt;<br />&nbsp;&nbsp; &nbsp;&lt;li&gt;Flowers<br />&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&lt;ul style="margin-left: .5em;"&gt;<br />&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&lt;li&gt;Lilies&lt;/li&gt;<br />&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&lt;li&gt;Roses&lt;/li&gt;<br />&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&lt;/ul&gt;&lt;/li&gt;<br />&nbsp;&nbsp; &nbsp;&lt;li&gt;Dogs<br />&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&lt;ul style="margin-left: .5em;"&gt;<br />&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&lt;li&gt;Boxer&lt;/li&gt;<br />&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&lt;li&gt;Poodle&lt;/li&gt;<br />&nbsp;&nbsp; &nbsp;&nbsp;&nbsp; &nbsp;&lt;/ul&gt;&lt;/li&gt;<br />&lt;/ul&gt;</div></li>
	<li>Insert your own custom code into the appropriate spot in the file editor. Our sample list will be added before the widgets as shown below. Click the Update File button and the new code will be saved to the sidebar.php file. Below is a screenshot of the blog with the nested list in the sidebar. Note that your particular format (font, indentation,e tc) may vary according to your theme.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/sidebar/nested-list/add-code.png"><img  alt="add new code to sidebar" src="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/sidebar/nested-list/add-code.png" /></a><br /><br />
	  <table class="article_table">
			<tbody>
				...
				<tr>
					<td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/sidebar/nested-list/add-list-before.png"><img style="max-width: 250px;"  alt="before nested list add" src="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/sidebar/nested-list/add-list-before.png" /></a>
					</td>
					<td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/sidebar/nested-list/add-list-after.png"><img style="max-width: 250px;"  alt="add-list-after" src="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/sidebar/nested-list/add-list-after.png" /></a>
					</td>
				</tr>
			</tbody>
		</table></li>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/wordpress/customize-wp-sidebar'>204: Customizing your Wordpress Sidebar</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 1: Adding Nested Links to your sidebar in Wordpress </div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 2: <a href='/support/edu/wordpress/customize-wp-sidebar/sidebar-navigation'>How to add navigation to your sidebar in WordPress</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/wordpress/customize-wp-sidebar/sidebar-list&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/wordpress/customize-wp-sidebar/sidebar-list'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMjkmaWQ9MjIwNSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="69347e448f234c30b0aafc69337a96dc" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/wordpress/customize-wp-sidebar?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Customizing your Wordpress Sidebar</h3></a>
		<table>  <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/wordpress/customize-wp-sidebar/sidebar-list?tsrc=rsbedu'>Adding Nested Links to your sidebar in Wordpress </a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/wordpress/customize-wp-sidebar/sidebar-navigation?tsrc=rsbedu'>How to add navigation to your sidebar in WordPress</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/wordpress/customize-wp-sidebar/sidebar-metadata?tsrc=rsbedu'>Adding Meta Data to your WordPress sidebar</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/wordpress/customize-wp-sidebar/sidebar-image-links?tsrc=rsbedu'>How to add images and image links to your WordPress sidebar</a></td>
                </tr>
          	</table>
