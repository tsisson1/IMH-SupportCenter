<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:108143:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-25/database/database-connection-error-2-could-not-connect-to-mysql" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-07-21T17:00:38-07:00" />
  <meta name="keywords" content="joomla 2.5 database error could not connect error mysql has gone away" />
  ...
  <title>Joomla database connection error (2): could not connect to mysql - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-25/database/database-connection-error-2-could-not-connect-to-mysql" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:328768a01b3f374690faad5b301078b7 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '212.99.84.194']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Joomla database connection error (2): could not connect to mysql									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>156,488</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Feb 23, 2012'><span style='color:#606060;'>Published:</span> Jul 21, 2015</div>
							...
							<div style='clear:both;'></div>
								...
								<p class="alert">Joomla 2.5 has reached its end of life as for 12/31/2014. Please be advised this may be a security risk to your website. You can view more information about the end of life <a href="https://docs.joomla.org/Joomla!_CMS_versions">here</a>.</p><br /><p>Joomla 2.5 utilizes a database to store a majority of a site's content. For example, if you write a new article in Joomla, the article is written to the database. As the database is vital for Joomla to run, if Joomla cannot connect to your database and access information, you will see database related error messages on your site. In this article, we'll show you a few common errors and how you can resolve them.</p>
<p><strong>Common Joomla 2.5 Database Connection Error Messages:</strong></p>
<ul>
<li><a href="#database-connection-error-2">Database connection error (2): Could not connect to MySQL</a></li>
<li><a href="#database-connection-error-3">Database connection error (3): Could not connect to database</a></li>
<li><a href="#mysql-server-has-gone-away">MySQL server has gone away</a></li>
</ul>
<p> </p>
<p><a name="database-connection-error-2"></a></p>
<h2>Database connection error (2): Could not connect to MySQL.</h2>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/joomla-database-errors/database-connection-error-2-could-not-connect-to-mysql.gif"><img  alt="database-connection-error-2-could-not-connect-to-mysql" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/joomla-database-errors/database-connection-error-2-could-not-connect-to-mysql.gif" style="float: right; margin: 0px 0px 15px 15px;" /></a></p>
...
<p><strong>Solution:</strong><br />You should <a href="/support/edu/joomla-25/database/change-joomla25-db-user-pass">review your configuration.php file and ensure you are using the correct MySQL username and password</a>. These settings will appear in the file as:</p>
<p class="code_block">public $user = 'userna5_dbuser';<br />public $password = 'dbpass';</p>
<p>If you are sure the settings are correct, it is recommend to <a href="/support/website/databases/reset-database-password">reset your database user's password</a> and update your configuration.php file with the new password. This will help ensure that you have the correct database password set.</p>
<div style="clear: both;"></div>
<p> </p>
<p><a name="database-connection-error-3"></a></p>
<h2>Database connection error (3): Could not connect to database</h2>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/joomla-database-errors/database-connection-error-3-could-not-connnect-to-database.gif"><img  alt="database-connection-error-3-could-not-connnect-to-database" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/joomla-database-errors/database-connection-error-3-could-not-connnect-to-database.gif" style="float: right; margin: 0px 0px 15px 15px;" /></a></p>
...
<p><strong>Solution:</strong><br />If your Joomla site is setup like most, <a href="/support/edu/joomla-25/how-to/configuration-settings">check your configuration.php file</a> and ensure your database host is set to "localhost". This is setting looks like the following in your config file:</p>
<p class="code_block">public $host = 'localhost';</p>
<div style="clear: both;"></div>
<p> </p>
<p><a name="mysql-server-has-gone-away"></a></p>
<h2>MySQL server has gone away</h2>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/joomla-database-errors/mysql-server-has-gone-away.gif"><img  alt="mysql-server-has-gone-away" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/joomla-database-errors/mysql-server-has-gone-away.gif" style="float: right; margin: 0px 0px 15px 15px;" /></a></p>
...
<p>Most often, if Joomla has been working fine and suddenly stops working due to a database error, there is a problem with the database on your server. You'll want to contact your hosting provider for further assistance. If you have recently made a change to Joomla and then you begin to see database errors, instead of contacting your host you should first check your database settings in your configuration.php file.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/joomla-25/database'>212: Joomla 2.5 Advanced Database Information</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 4: Joomla database connection error (2): could not connect to mysql</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 3: <a href='/support/edu/joomla-25/database/change-joomla25-db-user-pass'>How to change your Joomla 2.5 database username and password</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-25/database/database-connection-error-2-could-not-connect-to-mysql&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-25/database/database-connection-error-2-could-not-connect-to-mysql'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yMDAmaWQ9MTE4MyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/joomla-25/database?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Joomla 2.5 Advanced Database Information</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/joomla-25/database/which-databases-are-available?tsrc=rsbedu'>Which databases can be used with Joomla 2.5?</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/joomla-25/database/database-name?tsrc=rsbedu'>What is my Joomla 2.5 database name?</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/joomla-25/database/change-joomla25-db-user-pass?tsrc=rsbedu'>How to change your Joomla 2.5 database username and password</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/joomla-25/database/database-connection-error-2-could-not-connect-to-mysql?tsrc=rsbedu'>Joomla database connection error (2): could not connect to mysql</a></td>
                </tr>
          	</table>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						...
						<div><a style='font-size:16px;' href='/support/community-support/users/name'>name</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-01-25 2:26 am</div>
				                <div>i had Database connection error (2): Could not connect to MySQL.<br />
After following ur article it works...<br />
Thank u sooo much n...Thanks a lot..<br />
May God bless u with full grace..</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(7409);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-9006'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/55f069abca5d0b1d016c21883defb295?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/55f069abca5d0b1d016c21883defb295'>Maycon (Michael in English)</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-18 8:47 am</div>
				                <div><p>I'm very grateful because your site help-me. Thanks a lot.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9006);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-9172'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/af45fc590d46220ff6d9a4513bd6322b?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/af45fc590d46220ff6d9a4513bd6322b'>Pankaj</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-25 3:27 am</div>
				                <div><p>Thanks. Why this error comes even when there is no change in MySQL db.&nbsp; The fact is that if you open the site ,It is&nbsp;opeing at first&nbsp;and then&nbsp;when I am&nbsp;refreshing it 3-4 times that error is coming. Plz help. You&nbsp; can check the error at my site at www.lifeinglife.com&nbsp;&nbsp;&nbsp; Thanks in advance</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9172);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-25 8:04 am</div>
				                <div>I was unable to produce any errors on your site so it appears to be just a previous intermittent issue that is now resolved.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9184);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-9681'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/3773f043dd96f91949f486258659e0aa?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/3773f043dd96f91949f486258659e0aa'>rwothomio</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-13 4:26 pm</div>
				                <div><p>Very useful and resourceful, helped me save so much time figuring out the cause of the error..Thanks so so much..</p>
<p>Much appreciation:)</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9681);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-11514'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/c237081b265a92332654602472fffdaa?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/c237081b265a92332654602472fffdaa'>Victor Masias</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-13 10:12 am</div>
				                <div><p>Excelente, muchas gracias por la soluci&oacute;n.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11514);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-11742'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/6e33d0b8a4bf7495b842453ffe737240?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/6e33d0b8a4bf7495b842453ffe737240'>carolina</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-18 12:30 pm</div>
				                <div><p>please help</p>
<p>www.edibledesignimages.com</p>
<p><span style="font-family: 'Times New Roman'; font-size: medium;">Database connection error (2): Could not connect to MySQL.</span></p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11742);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-18 1:32 pm</div>
				                <div>Hello Carolina,<br />
<br />
I'm sorry to hear you're having problems with connecting to your Joomla database.  Unfortunately, you have given us no details with which to help you.  Have you at least gone through the steps above and checked to see that the correct user name and password are being used for the database.  One way to check is to use the database program that comes with your hosting.  Since it doesn't appear that you're hosted with our service, we can't really check from here.  You can reference our article on <a href="http://www.inmotionhosting.com/support/website/database-connections/connect-database-remotely-mysql-workbench">connecting to a database with MySQL workbench</a> for further information on testing (using a different program).  <br />
<br />
I hope this helps give you at least a starting point.  If you wish for us to investigate the issue further, we need further information on how you're connecting to the database.  <br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11744);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-13066'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/80b3f77e207affb653a86d297b87215b?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/80b3f77e207affb653a86d297b87215b'>Abdiwali Mohamed Abdulahi</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-21 5:18 am</div>
				                <div><p><strong>I'm very grateful because your site help-me. Thanks a lot. May Allah bless u with full grace</strong></p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13066);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-14631'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/e0bfe1223ad9afef2387487cb9d392cd?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/e0bfe1223ad9afef2387487cb9d392cd'>Maanda</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-03 3:24 am</div>
				                <div><p><span style="font-family: 'Times New Roman'; font-size: medium;">Database connection error (2): Could not connect to MySQL. my joomla website was working very fine but after i have inserted the module for cintact suddely it started to show me that it cant connect to the database.....izt a module or server it self</span></p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14631);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-03 11:28 am</div>
				                <div>Hello Maanda,<br />
<br />
Thank you for your question. This could be caused by an issue with your server's services, or a misconfiguration of your database settings.<br />
<br />
I first recommend reading our detailed guide <a href="http://www.inmotionhosting.com/support/website/database-connections/is-mysql-available">database connection errors</a>.<br />
<br />
We would be happy to further assist you, but will need additional information such as the domain name of the site, and a link to the error message.<br />
<br />
If you have any further questions, feel free to post them below.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14654);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-14714'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/d229fafbec8a1f564270960faadf7e50?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/d229fafbec8a1f564270960faadf7e50'>Victor</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-04 12:22 pm</div>
				                <div><p>Hey guys, thats for the page it's been really usefule although &nbsp;I've tried to follow the steps which are great but when I click on the link&nbsp;reviewing the php file and it asks me to go to the administrator page I get the same SQL error as I do on my homepage which means I can't access the admin section to correct the configuration.php content. Any ideas?</p>
<p>URL:&nbsp;http://www.mixedmartialartsden.com/</p>
<p>&nbsp;</p>
<p>Thanks a lot,</p>
<p>&nbsp;</p>
<p>Victor</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14714);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-04 12:31 pm</div>
				                <div>To adjust the configuration.php file, you would do so within the &lt;a href=&quot;http://www.inmotionhosting.com/support/edu/cpanel/cpanel-file-manager/using-file-manager-in-cpanel&quot;&gt;cPanel File Manager&lt;/a&gt; which is available without any access to the Joomla Administration panel.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14716);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-18471'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/61cfac3cee54ec82b378fb6396e98c2f?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/61cfac3cee54ec82b378fb6396e98c2f'>constantin chirita</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-14 5:00 am</div>
				                <div><p>Please help me :</p>
<p>www.constantin-chirita.ro</p>
<p>Thank you</p>
<p>Constantin Chirita</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(18471);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-15 10:13 am</div>
				                <div>Hello Constantin,<br />
<br />
I see your site has the same error as described in the article. Have you followed the instructions? If so, where are you stuck? <br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(18508);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-19420'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/c661a7a7a5dee7556cc7d66fb044706f?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/c661a7a7a5dee7556cc7d66fb044706f'>nansi Awad</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-12 7:55 am</div>
				                <div><p>i've done all u said more than one but problem still&nbsp; here &gt;&gt;plz help me</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19420);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-12 10:00 am</div>
				                <div>Hello Nansi,<br />
<br />
Sorry for the problem that you're having.  However, you have not provided any details to the issue, so we can't help you without any further information.  Please describe the problem, provide details on any error messages, and explain steps that you take to duplicate the error.  If you can provide us a URL or other information on the website, it would also help us (if you are a customer).  <br />
<br />
Kindest regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19424);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-19746'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/3c6b2d021e07b45e51016c21c5f58875?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/3c6b2d021e07b45e51016c21c5f58875'>Naheed</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-20 3:26 am</div>
				                <div><p>This article is good. Hands on approach to resolving errors. It helped me solvemine and my site is now up and running.</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19746);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-22313'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/3840e52458c49cc019f2f5b3f7a5b232?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/3840e52458c49cc019f2f5b3f7a5b232'>Yahaya</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-03 5:00 am</div>
				                <div><p>I need help with this error pls:</p>
<p>Got error 28 from storage engine SQL=SELECT a.id, a.title, a.alias, a.title_alias, a.introtext, a.checked_out, a.checked_out_time, a.catid, a.created, a.created_by, a.created_by_alias, CASE WHEN a.modified = 0 THEN a.created ELSE a.modified END as modified, a.modified_by, uam.name as modified_by_name,CASE WHEN a.publish_up = 0 THEN a.created ELSE a.publish_up END as publish_up, a.publish_down, a.attribs, a.metadata, a.metakey, a.metadesc...</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22313);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-03 1:13 pm</div>
				                <div>Hello Yahaya,<br />
<br />
Sorry to hear that you're getting an error with your database.  The error you're seeing is not related to a connection issue.  It's more related to the space you have available for your database.  I researched the error and it is related to the  space available to the database or temporary files.  You may need to speak with your hosting provider technical support.  If InMotion Hosting is your host, then you will need to submit a support ticket to live support.  You may also want to check the size of your database and use the cPanel option to repair it to see if it will help.<br />
<br />
I hope this helps to answer your question, please let us know if you require any further  assistance.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22326);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-26623'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/54341cfe9a439fcd35cdd70c6d452914?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/54341cfe9a439fcd35cdd70c6d452914'>Aris</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-14 11:55 am</div>
				                <div><h1 style="color: rgb(51, 51, 51); font-size: 1.6em; font-weight: normal; line-height: 1.25em; margin-bottom: 16px; margin-top: 0px; font-family: 'Segoe UI', Tahoma, sans-serif; background-color: rgb(247, 247, 247);">This webpage is not available</h1>
<p>my website is created in joomla inside the linux centos6.0</p>
<p>I cant access the website in the internet&nbsp;</p>
<h1 style="color: rgb(51, 51, 51); font-size: 1.6em; font-weight: normal; line-height: 1.25em; margin-bottom: 16px; margin-top: 0px; font-family: 'Segoe UI', Tahoma, sans-serif; background-color: rgb(247, 247, 247);">This webpage is not available</h1>
<p style="display: inline; color: rgb(100, 100, 100); font-family: 'Segoe UI', Tahoma, sans-serif; font-size: 15px; line-height: 24px; background-color: rgb(247, 247, 247);" hidden="">&nbsp;</p>
<p>&nbsp;</p>
<div class="error-code" style="color: rgb(119, 119, 119); font-size: 0.86667em; margin-top: 15px; opacity: 0.5; text-transform: uppercase; font-family: 'Segoe UI', Tahoma, sans-serif; line-height: 24px; background-color: rgb(247, 247, 247);">ERR_NAME_NOT_RESOLVED</div>
<p>but i can access it in the LAN networks ...</p>
<p>Can you help fix this error?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26623);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-14 2:02 pm</div>
				                <div>Hello Aris,<br />
<br />
This is not a database connection issue, but a general connection issue. Is it only that device? Have you tried others on that network? Other browsers on that device? Other networks? Cleared caching for the browsers? Checked other sites on the same computer?<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26644);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
