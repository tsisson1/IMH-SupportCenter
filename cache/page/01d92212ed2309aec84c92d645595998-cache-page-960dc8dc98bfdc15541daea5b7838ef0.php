<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:73237:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-3/create-template/switch-site-template" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-04-10T16:59:02-07:00" />
  <meta name="keywords" content="change joomla 3.0 site template" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="After installing a Joomla 3.0 template, your next step is to activate your new template." />
  <title>How to change your Joomla 3.1 Site Template - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-3/create-template/switch-site-template" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:c11f39abe461a135465d047f421bb280 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to change your Joomla 3.1 Site Template									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>47,556</span></div>
							...
							<div style='clear:both;'></div>
								...
								<p>Welcome to another article in our tutorial series on <a href="/support/edu/joomla-3/create-template">creating a Joomla 3.0 template</a>. In our last tutorial, we showed you <a href="/support/edu/joomla-3/create-template/how-to-install-template">how to install the Joomla 3.0 template</a> that we are in the middle of creating. Installing a template does not immediately activate it, and so we will show you how to activate / change Joomla 3.0 site templates in this tutorial.</p>
<p class="alert"><strong>Please note!</strong> The steps in this tutorial for changing site templates applies regardless of whether you are following our tutorial series and installing the template we are creating, or if you <a href="/support/edu/joomla-3/templates">downloaded a Joomla 3.0 template</a> from the web.</p>
<p><strong>Changing your Joomla 3.0 Site Template:</strong></p>
...
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/create-template/click-star-to-change-template.jpg"><img style="float: right; margin: 0px 0px 15px 15px;" width="150"  alt="click star to change Joomla template" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/create-template/click-star-to-change-template.jpg" /></a>You will see two types of templates, <em>Site</em> and <em>Administrator</em>. In this tutorial, we are changing <em>Site templates</em> (the templates that affect the front end of our website).<br /><br />In the list of templates, click the hollow star next to the Site Template that you would like to activate. You will then receive the following message:<pre style="margin: 10px 0px 10px 20px;"><strong>Message</strong><br /><em>Default style successfully set</em></pre>

<p>In the screenshots below, you can see that after choosing a new site template, the look and feel of our Joomla 3.0 website has changed.<br style="clear: both;" /></p>
<table class="article_table" align="center">
<tbody>
<tr>
<th><div align="center">BEFORE: <br />
  Default Protostar Template</div></th> 
<th><div align="center">AFTER: <br />
  Basic Joomla 3.0 Template selected</div></th>
</tr>
<tr>
<td valign="top" align="center"><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/create-template/previous-template.jpg"><img  alt="previous template Joomla" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/create-template/previous-template.jpg" width="240" /></a></td>
<td valign="top" align="center"><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/create-template/new-template-installed.jpg"><img  alt="new template installed Joomla" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/create-template/new-template-installed.jpg" width="240" /></a></td>
</tr>
</tbody>
</table><br />
<br />

<p class="alert"><strong>Please note!</strong> If you're following along with our tutorial series on creating a Joomla 3.0 template, you'll want to read our next article on <a href="/support/edu/joomla-25/articles/allow-javascript">How to add javascript to Joomla 2.5 articles</a>. If you can see in the screenshot above, the template does not look all that impressive, at this point it is just a mess because our CSS file is not being loaded (which we will explain more in our next tutorial).</p>
</li>
</ol>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 6: How to change your Joomla 3.1 Site Template</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 5: <a href='/support/edu/joomla-3/create-template/how-to-install-template'>How to install a Joomla 3.1 Template</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-3/create-template/switch-site-template&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-3/create-template/switch-site-template'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNzEmaWQ9MTg0NSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
          ...
          <tr >
			...
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/joomla-3/headline-and-slogan-joomla-3-artisteer?tsrc=rsbraq'>Headline and slogan in Joomla 3 with Artisteer</a>
                                </div>
...
<a name='comments'></a>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/edb50800f379bb7a300147d49495d232?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/edb50800f379bb7a300147d49495d232'>Percetakan Online</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-19 5:14 am</div>
				                <div><p>Nice share,.. And very helpful,...</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9020);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-17068'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/cbb54f40656a7dfb4ff1b9f6dca94a5b?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/cbb54f40656a7dfb4ff1b9f6dca94a5b'>Jim Brooking</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-04 8:24 am</div>
				                <div><p>I've been through the entire tutorial and have two issues:</p>
<ol>
<li>The heading that shows in all your examples from #6 onward doesn't show in my being-built template. Is there something missing that isn't in the series?</li>
<li>When I open the Prostar template I see an "Advanced" tab where I can set a logo file and control colors. That was a nice convenience for quickly getting a Prostar site looking familiar and I wonder how to do that with this example.</li>
</ol>
<p>Thanks. Getting the feel of J3 templating and fluid design.</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17068);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-04 10:08 am</div>
				                <div>Could you clarify what specifically is missing?  Could you provide a link to the site you are working on?</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17076);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-04 3:51 pm</div>
				                <div><p>Thanks for the reply. he site is http://j3.fearringtonfha.org and i've made my in-progress tewmplate the default. If you email me I can send you the source for the index.php file and any others you might like.</p>
<p>&nbsp;</p>
<p>Jim</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17087);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-04 5:20 pm</div>
				                <div>Are you referring to the green leaf image at the top?  This image is simply a banner and can be added by logging following our guide on &lt;a href=&quot;http://www.inmotionhosting.com/support/edu/joomla-3/banners&quot;&gt;adding banners in Joomla 3&lt;/a&gt;.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17095);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
