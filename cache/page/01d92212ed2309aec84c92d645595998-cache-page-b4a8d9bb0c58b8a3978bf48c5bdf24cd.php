<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:44902:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/dokuwiki/change-dokuwiki-appearance" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="keywords" content="edit change changing editing logo logos theme templates template theme dokuwiki doku wiki" />
  <meta name="description" content="These tutorials will explain how to edit the themes and logo sections in your DokuWiki site." />
  <title>103: Changing the DokuWiki Appearance | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/dokuwiki/change-dokuwiki-appearance" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:72b9bd63f9ce202553472d77194ea1fc -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '193.95.188.74']);
...
<div class='page-header'>
	<h1>103: Changing the DokuWiki Appearance</h1>
</div>
<div class='section_listing'>
	<h1>Dokuwiki 103: Changing the DokuWiki Appearance</h1>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/103/dokuwiki-theme.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Custom theme in DokuWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/103/dokuwiki-theme.gif" title="Click here to view the larger image" width="100" /></a>Once you are done writing the content for the basic DokuWiki site, you can change the appearance of the site to personalize it. The DokuWiki 103 course section will explain Basic Settings (like the title and the theme) and how to change the header, footer and logo.<br style="clear: both;" /></p>
	<table>
	<tr><td colspan='3'><h2>Basic Settings</h2><div>The following section will explain changes basic settings such as tile, site urls and templates.</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 1:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/dokuwiki/change-dokuwiki-appearance/site-title-url-license-basic-settings'>DokuWiki Basic Settings: Site title, Site URL, and License</a>
					<div>The DokuWiki Basic settings are for configuring settings like the site url, title, template, and license. This article will explain these settings.</div>
					<div class='smallgrey'>Hits: 6,963</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/dokuwiki/change-dokuwiki-appearance/change-template-dokuwiki'>Changing the DokuWiki template</a>
					<div>This article explains how to change the template, sidebar and theme in DokuWiki.</div>
					<div class='smallgrey'>Hits: 12,595</div>
				</td>
			</tr>
		<tr><td colspan='3' style='padding-top:20px;'><h2>Header, Footer, and Logo</h2><div>These articles will explain how to edit the header, footer, and logo sections of DokuWiki.</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 3:</td>
				<td style='padding-right:10px;'><div class='gold_star'></div></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/dokuwiki/change-dokuwiki-appearance/change-dokuwiki-logo'>How to change the DokuWiki logo</a>
					<div>This article explains how to change the logo in DokuWiki through cPanel File manager and DokuWiki Media Manager.</div>
					<div class='smallgrey'>Hits: 29,008</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/dokuwiki/change-dokuwiki-appearance/removing-footer-buttons-text'>Removing the DokuWiki footer buttons and text</a>
					<div>This article will explain how to remove the buttons at the bottom of the dokuwiki theme footer and how to remove the license text.</div>
					<div class='smallgrey'>Hits: 7,797</div>
				</td>
			</tr>
			</table>
</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMjUmaWQ9MzI1JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="bc21e8fc8f2078775acd42d044eab711" value="1" />	</div>
	</form>
<!-- <br />
