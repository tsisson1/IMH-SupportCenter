...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/website-troubleshooting/run-system-file-checker" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-08-11T14:33:42-07:00" />
  <meta name="keywords" content="sfc Windows 10 System File Checker" />
  <meta name="author" content="John-Paul Briones" />
  <meta name="description" content="Learn how to fix your Windows 10 files with the System File Checker (sfc) tool." />
  <title>How to Run the Windows 10 System File Checker  - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/website-troubleshooting/run-system-file-checker" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:0a84810501da27c8dd7e2a91522ce850 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to Run the Windows 10 System File Checker 									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='clear:both;'></div>
								...
								<p>In this tutorial, we will show you how to <strong>run</strong> the <strong>Windows 10 File checker</strong> tool. This will find and fix broken Windows files, and is included in Windows 10.</p>

<a name="run"></a>
<h2>Run the System File Checker Tool</h2>

<ol class="article_list">
  <li>Login to <strong>Windows 10</strong>.</li>
<li>Click the Search button on the bottom left, and type <strong>command prompt</strong>.</li>
<li>When you see the <em>Command Prompt</em> program listed, <strong>Right-click</strong> it, then click <strong>Run as administrator</strong>. See the steps outlined below:<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/windows/system-file-checker/run-command-prompt-as-administrator.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/windows/system-file-checker/run-command-prompt-as-administrator.png" alt="Windows 10 elevated cmd" title="Run Command Prompt as Administrator" /></a></li>
<li>When the <em>command prompt</em> box comes up type the following then click <strong>Enter</strong>:
<pre class="code_block">sfc /scannow</pre><br>
The <em>System File Checker</em> will then begin running:<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/windows/system-file-checker/system-file-checker-tool.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/windows/system-file-checker/system-file-checker-tool.png" alt="sfc command run" title="Run the System File Checker" /></a><br><br>
You are finished when you see a <em>completed</em> message. It will also tell you if it found any <em>integrity violations</em>.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/windows/system-file-checker/sfc-verification-complete.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/windows/system-file-checker/sfc-verification-complete.png" alt="sfc cmd complete" title="System File Scanner complete" /></a></li>
<br>
</ol>
<br>
<p>Congratulations, now you know how to run the <strong>Windows 10 File checker tool</strong>!</p>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/website-troubleshooting/run-system-file-checker&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/website-troubleshooting/run-system-file-checker'></div>
	<script type='text/javascript'>
	  (function() {
