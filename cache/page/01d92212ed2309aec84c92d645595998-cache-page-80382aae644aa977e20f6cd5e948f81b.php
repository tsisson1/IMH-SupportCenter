<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:58728:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/wordpress/htaccess-error-with-w3-total-cache" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Due to the security plugins, other plugins lost their writing permission to .htaccess and other files. Even you could not see the image which was recent..." />
  <title>.htaccess error with W3 Total Cache | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/wordpress/htaccess-error-with-w3-total-cache" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:5a64392af9d1096ccc4b1a9bf61729a0 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '86.168.27.71']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>.htaccess error with W3 Total Cache</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-02-07 7:34 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>2,343</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Hi,<br />
i'm having a problem trying' to install W3 Total Cache plugin on Wordpress. It give me this error:<br />
FTP credentials don't allow to write to file /.htaccess<br />
W3 Total Cache Error: Files and directories could not be automatically created to complete the installation.<br />
Please execute commands manually or use FTP form to allow W3 Total Cache make it automatically.<br />
After a long chat with your customer service, I didn't find a solution.<br />
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_6494' id='upvote_answer_6494' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='6494' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_6494').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_6494' id='downvote_answer_6494' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='6494' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_6494').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Simone,<br />
<br />
Sorry to hear you are having issues with your <a href="http://www.inmotionhosting.com/support/edu/wordpress/recommended-wordpress-plugins/optimizing-wordpress-with-w3-total-cache">W3 Total Cache</a> install. I gave it a shot on my own server and it installed without issue. I compared permissions of the domain root folder and the htaccess file and they are the same as my own server. <br />
<br />
...
<br />
Then you will want to rename each of the individual plugins folder one at a time and try to install W3 total cache. When you rename one and are able to install W3 Totat cache, then you know that is the interfering plugin.<br />
<br />
If you are not able to install W3 with the plugins folder renamed, it may be something within your htaccess file itself and will need to be looked at line by line.  Htaccess files can be finicky as they grow in size and a single line can cause things to fail. <br />
<br />
Kindest Regards,<br />
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_6494').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_6494' id='form_comment_on_answer_6494' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Scott,<br />
Thank you very much for your deep explanation! :)<br />
To make what you suggest, I need to put my website in maintenance mode, but since I moved in InMotion recently after bad experience with my previous host, I can't make this 'cause I need to keep my website 'alive' for a while.. Google rank...... you know what I mean, right? ;)<br />
I will take my time and I try your suggestions very soon :)<br />
By the way, I installed WP Fastest Cache plugin, just to keep a good browsing experience on website. Do you think it's a good alternative ?<br />
I will let you know my results with W3 plugin :)<br />
...
Simone</div>
							...
							<td style='width:96px;' valign='top'>
								...
								<div class='smallgrey'>
									<a href='/support/community-support/users/Korgzero'>Korgzero</a><br />
									43 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2015-02-10 5:54 am EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello Simone,<br />
<br />
I have not used that plugin directly but I have found that WP Super Cache is a decent alternative to W3 Total Cache. <br />
<br />
Kindest Regards,<br />
TJ Edens</div>
...
Thank you very much, really appreciate your help! :)</div>
...
<div class='  not_best_answer'>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px; width:50px;' valign='top'>
<div class='vote_div'>
	<form method='post' name='upvote_answer_6880' id='upvote_answer_6880' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='6880' />
		<input type='hidden' name='component' id='component' value='qa' />
		<input type='hidden' name='vote_value' id='vote_value' value='1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_6880').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_6880' id='downvote_answer_6880' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='6880' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_6880').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					<img src='/support/images/avatars/default_avatar.jpg' class='user_avatar' style='max-width:60px;' /><br />
                		        <a href='/support/community-support/users/luckybhumkar'>luckybhumkar</a>
					
					<div>23 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2015-03-26 8:17 am EST
                		        </div>
					
		                </div>

				Due to the security plugins, other plugins lost their writing permission to .htaccess and other files. Even you could not see the image which was recently updated. The solution is simple.<br />
1. Check the directory permission level is &lt;strong&gt;755&lt;/strong&gt; (in case WordPress installed in the directory).<br />
2. Now check the file permission for .htaccess which is necessary to be &lt;strong&gt;644&lt;/strong&gt;. Otherwise, you will encounter the error.<br />
<br />
Source: &lt;a href=&quot;http://www.doubtsolver.com/wordpress/ftp-credentials-dont-allow-to-write-to-htaccess/&quot;&gt;DoubtSolver&lt;/a&gt;
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_6880').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_6880' id='form_comment_on_answer_6880' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
					                <p>You must <a href='/support/login'>login</a> before you can post a comment about this answer.</p>
					        </div></div></div></div>
					</form>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/wordpress/htaccess-error-with-w3-total-cache&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/wordpress/htaccess-error-with-w3-total-cache'></div>
<script type='text/javascript'>
  (function() {
