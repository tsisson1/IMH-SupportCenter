<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:76570:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/website-troubleshooting/common-wordpress-troubleshooting-techniques" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-04-11T14:44:45-07:00" />
  <meta name="keywords" content="wordpress error troubleshooting memory error blank page database corruption" />
  <meta name="author" content="Tim Sisson" />
  <meta name="description" content="WordPress is a great tool to build a website with. However, at times you can find yourself troubleshooting errors. Here you will learn some basic steps to troubleshooting WordPress." />
  <title>Common WordPress Troubleshooting Techniques - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/website-troubleshooting/common-wordpress-troubleshooting-techniques" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:0fc1ed65a4bb26467bb11db19a7cbc45 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '94.72.41.50']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Common WordPress Troubleshooting Techniques									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>7,456</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Oct 25, 2011'><span style='color:#606060;'>Published:</span> Apr 11, 2016</div>
...
<button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('debugging');">Enable Debugging</button>
<button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('disable-plugins');">Disable Plugins</button>
<button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('disable-theme');">Disable Theme</button>
<button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('errors');">Other Errors</button>
</div>
...
<a name="debugging"></a>
<h2>Turn on WordPress Debugging</h2>
<p> With debugging turned on, it is much easier to locate any errors within your WordPress site as well as any plugins and themes that may be causing errors. This is covered in our full guide:<br>
  <a href="/support/website/wordpress/turning-on-wordpress-debugging">Turning on WordPress debugging</a>.</p>

<a name="disable-plugins"></a>
<h2>Disabling your WordPress Plugins</h2>
<p>Some plugins may interfere with other plugins and cause your WordPress site not to load correctly. A common troubleshooting technique is to disable all of your WordPress plugins. If this resolves the issue, then you'll want to enable each plugin one by one and test your site until you determine which plugin is causing the issue.</p>
<p>Some problems caused by plugins will prevent you from logging into your dashboard. If you still can log into your dashboard, then navigate to your plugins page and continue to disable all your plugins and test as described above. If you do not have access to your WordPress dashboard, however, you can use an FTP client such as FileZilla to rename your plugins folder (which will disable all of your plugins). Click here for more information on <a href="/support/website/wordpress/disable-wordpress-plugins">disabling your WordPress plugins</a>.</p>

<a name="disable-theme"></a>
<h2>Disabling your Current Theme and reverting to the Default</h2>
<p>Some themes include custom functions that, at times can cause errors. When troubleshooting issues, it is important to determine if the error is related to a theme. To do this, you should change your theme to the default theme in your WordPress installation.&nbsp;This should be one of the first steps you take in troubleshooting errors in WordPress. If your error is resolved by reverting the theme to the default, then you know it's an issue with your chosen theme.&nbsp;</p>
<p>If you have access to the WordPress dashboard this is achieved by going into the themes option on the left side menu pane and activating the default theme. If you do not have WordPress dashboard access, and in some cases with errors this may be true, &nbsp;you can disable your theme by FTP as well. Once you are connected via FTP with an FTP client such as FileZilla, you then will navigate to your themes folder. Rename your current theme and WordPress will automatically revert to the default theme.&nbsp;</p>

<a name="errors"></a>
<h2>Other Common Errors</h2>
<p><strong>404 File not found errors</strong>: When you see a file not found error, you will see see a full path to the file that is missing. Retrace the path via FTP and see if the file exists. Remember, you are on a linux server so file names are case sensitive. Test.php is not the same file as test.php. 404 errors are commonly associated with permalinks or the coding in the index or search files as well. <a href="/support/edu/wordpress/wordpress-features/reset-permalinks">Resetting WordPress Permalinks</a> often will rebuild the links and correct the problem.</p>
<p><strong>Memory Exhausted errors</strong>: This is an error that typically mean you have not allocated enough memory for php to run the desired action. The error message will look similar to this:</p>
<p class="code_block">Fatal error: Allowed memory size of 33554432 bytes exhausted (tried to allocate 1966080 bytes) in /home2/user1/public_html/fantasy/wp-includes/class-simplepie.php on line 5353</p>
<p>This can be corrected by adjusting your memory allocation in your php.ini file. You should have a php.ini file in your default folder where you installed WordPress. If you do not, &nbsp;you can find the file in your public_html folder and copy to the same location as WordPress. Once the file is in it's correct place, you will need to open it up in an editor. You can do this in File Manager in cPanel. Find the line of code that says:</p>
<p class="code_block">memory_limit = 8M</p>
<p>Now you will need to change it to something like this:</p>
<p class="code_block">memory_limit = 16M</p>
<p>NOTE: you may need to keep adjusting this number to find out how much memory you need to allocate. If 16M does not work increase the number to 32M.</p>
<p>If you need help updating your php.ini please read the article on, <a href="/support/website/general-server-setup/update-local-php-settings">updating your php settings.</a></p>
<p><strong>Database Corruption Issues</strong>: At times, it is possible that your WordPress database has become corrupt. You can find out more information on <a href="/support/website/databases/check-repair-database">checking and fixing corrupt tables in a database</a> by reviewing our article.&nbsp;</p>
<p><strong>WordPress showing a blank page</strong>: If your WordPress website is showing a blank page, it's typically caused by a php error. If php is configured to hide this error, you'll get a blank page displaying on your website. Please read our article on <a href="/support/website/website-troubleshooting/my-wordpress-site-is-displaying-a-blank-page">how to handle blank pages in WordPress</a></p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/website-troubleshooting/common-wordpress-troubleshooting-techniques&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/website-troubleshooting/common-wordpress-troubleshooting-techniques'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zNCZpZD0yNzMmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="369a763b51ee1ad4e671334cafb4d6d6" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/wordpress/backend-extremely-slow?tsrc=rsbraq'>Wordpress Backend EXTREMELY SLOW</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/wordpress/issues-uploading-images-in-wp?tsrc=rsbraq'>Issues uploading images in WP</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/website/what-does-this-message-mean?tsrc=rsbraq'>What does this message mean?</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/wordpress/the-page-was-blank-error-404-not-found?tsrc=rsbraq'>Page was blank (Error 404 - Not Found)</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/wordpress/new-cpanel-from-whm?tsrc=rsbraq'>NEW CPANEL FROM WHM</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/website-troubleshooting/problems-adding-products-to-woocommerce-cart?tsrc=rsbraq'>Problems adding products to WooCommerce Cart</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/email-troubleshooting/email-arriving-as-plain-text?tsrc=rsbraq'>Email arriving as plain text</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/wordpress/windowslocation-is-not-working?tsrc=rsbraq'>windows.location is not working</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/25fbc2e3de29994895984605466de8c3?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/25fbc2e3de29994895984605466de8c3'>Shashaa</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-30 8:43 am</div>
				                <div><p>I have an issue in disabling the current theme to get back to the default one. any help?</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25323);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-30 11:31 am</div>
				                <div>Hello Shashaa,<br />
<br />
Thank you for contacting us. As described above, you can disable your theme by <a href="http://www.inmotionhosting.com/support/website/ftp/getting-started-guide">FTP</a>. Once you are connected via FTP with an FTP client such as FileZilla, you then will navigate to your themes folder. Rename your current theme and WordPress will automatically revert to the default theme. <br />
<br />
Have you tried this?<br />
<br />
Please explain the symptoms you are having, when you try to change themes.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25329);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-31075'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/a33ac39c3f26d8417c2336089d264fb2?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/a33ac39c3f26d8417c2336089d264fb2'>Anand</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-09 6:21 am</div>
				                <div><p>In wordpress dashboard when I click on Pages, I get this message "Oops! That page can&rsquo;t be found.</p>
<p>It looks like nothing was found at this location. Maybe try one of the links below or a search?"</p>
<p>Please help me to fix this issue. Im using wordpress 4.4.2 and zerif lite theme.</p>
<p>Please click in this link to see the problem. &nbsp; http://prnt.sc/ad0ag5</p>
<p>My website is http://www.fortunapet.com</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31075);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
