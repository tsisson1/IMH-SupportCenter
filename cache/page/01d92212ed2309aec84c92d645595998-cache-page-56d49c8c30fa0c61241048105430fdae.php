<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:62682:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/htaccess/access-protected-dir" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-08-16T19:54:00-07:00" />
  <meta name="keywords" content=".htaccess htaccess access specific one single file password protected directory" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Have a password protected directory but need to give access to a specific file? Learn how to do it in your .htaccess file." />
  <title>Allow public access to a file in a protected directory using .htaccess - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/htaccess/access-protected-dir" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:dd407b3d5eb9f1e8db8c82de72fe781b -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '91.64.86.14']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Allow public access to a file in a protected directory using .htaccess</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Allow public access to a file in a protected directory using .htaccess									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>15,198</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Feb 7, 2013'><span style='color:#606060;'>Published:</span> Aug 16, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<div>Within your website structure, there are many times when you may want to protect directories from outside access. This prevents any user from accessing a subdirectory of your site, and its files, without a username and password. There may be a time, however, when you want to allow access to a single file within a password directory and it is not feasible to move the file to an unprotected directory or folder. The instructions below will guide you in how to allow access to a single file in a password protected directory using your .htaccess file.</div>
<div>&nbsp;</div>
<h2>How to allow access to a file in a protected directory</h2>
<div>&nbsp;</div>
<div><ol class="article_list">
<li><a target="_blank" href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">Log into your cPanel</a> dashboard.</li>
<li><a target="_blank" href="/support/edu/cpanel/cpanel-file-manager/using-file-manager-in-cpanel">Access the <strong>File Manager</strong></a> and navigate to the password protected folder. Make sure you enable the ability to <a target="_blank" href="/support/website/cpanel/show-hidden-files-in-file-manager">show hidden files</a>.</li>
<li>Within the password protected folder will be an .<em>htaccess</em> file that contains the security code to activate the password popup. Highlight the .<em>htaccess</em> file and click on the <strong>Edit</strong> icon from the toolbar across the top of the page.</li>
<li>Once inside the editor, you will see the security code. It will appear similar to the example below. Our example directory was test, so attempting to access<em> inmotiontesting.com/test</em> resulted in a popup box asking for username and password.<br />
<div class="code_block">AuthName "test-protect"<br />AuthUserFile "/home/userna5/.htpasswds/public_html/test/passwd"<br />AuthType Basic<br />require valid-user</div>
</li>
<div>You will need to add the following code for each file you want to allow access to after the code above. In this example, we are allowing access to a file named <em>test.php</em>. Note the \ before the . in the filename and the $ at the end. You will want to do this for your file name as well to ensure access is given to that exact file.</div>
<div class="code_block">&lt;FilesMatch "test\.php$"&gt;<br />Satisfy Any<br />Allow from all<br />&lt;/FilesMatch&gt;</div>
<li>Click on the <strong>Save Changes</strong> button in the upper right corner to finalize and activate the code. Now you will be able to access the specific file named test.php but no other files within that directory.</li>
</ol></div> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/htaccess/access-protected-dir&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/htaccess/access-protected-dir'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MTMmaWQ9NTU5JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="41569589a6ef9b6ca26577a9505051f1" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/8ac2a60c9f5850edcb5c68ad4ef7850e?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/8ac2a60c9f5850edcb5c68ad4ef7850e'>Name</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-20 10:52 am</div>
				                <div><p>Test.</p>
<p>&nbsp;</p>
<p>Really nice comment box.</p>
<p>&nbsp;</p>
<p>Thanks.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20893);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
