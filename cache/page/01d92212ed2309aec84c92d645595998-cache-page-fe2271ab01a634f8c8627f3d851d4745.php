<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:70091:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/drupal-7/blocks-and-regions/create-custom-footer" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-11-30T14:19:15-08:00" />
  <meta name="keywords" content="Drupal 7 custom footer create change modify alter" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="This Drupal 7 article demonstrates how to create and insert a custom footer." />
  <title>How to create a custom footer block in Drupal 7 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/drupal-7/blocks-and-regions/create-custom-footer" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:10a535d55d5c4d31e1bad32b0cb388ba -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '115.112.80.242']);
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
				<img src='/support/images/stories/drupal-partner/supporting-partner-80_3.png' style='float:right; margin:0px 0px 15px 15px;' alt='Drupal Association Support Partner'>		<h1>
															How to create a custom footer block in Drupal 7									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>19,031</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Nov 29, 2012'><span style='color:#606060;'>Published:</span> Nov 30, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>When customizing your site to best represent you or your company, you will want to change some areas from the default displays. One of these is the footer. The default footer displays the text 'Powered by Drupal'. While this may be fine, perhaps you want to add a copyright for your business, or contact information such as an address and phone number. This article will explain how to create your custom footer to replace the default one in your Drupal 7 website.</p>
<p><strong>Creating a custom foooter in Drupal 7</strong></p>
<ol class="article_list">
<li><a href="/support/edu/drupal-7/getting-started/how-to-log-into-the-drupal-admin-dashboard">Log into your Drupal 7 admin dashboard</a>.</li>
<li>From the top menu bar, locate the <strong>Structure</strong> option and click it.</li>
<li>This leads you to the Structure menu. From here, find and click on the <strong>Blocks</strong>option.</li>
<li>From the main block list, select the <strong>Add Block</strong> option.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/structure/blocks/new-footer/1-select-add-block.png"><img  alt="1-select-add-block" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/structure/blocks/new-footer/1-select-add-block.png" /></a></li>
<li>This brings you to the New block creation screen. From here fill out the appropriate fields on the page.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/structure/blocks/new-footer/2-new-block-data.png"><img  alt="2-new-block-data" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/structure/blocks/new-footer/2-new-block-data.png" /></a><br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/structure/blocks/new-footer/3-more-block-data.png"><img  alt="3-more-block-data" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/structure/blocks/new-footer/3-more-block-data.png" /></a><br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/structure/blocks/new-footer/4-end-data.png"><img  alt="4-end-data" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/structure/blocks/new-footer/4-end-data.png" /></a><br />
<table class="article_table">
<tbody>
<tr><th>Block Title</th>
<td>Optional title for the block. The text entered here will display on the page.</td>
</tr>
<tr><th>Block Description</th>
<td>The title that will appear in the back end. This is the name displayed in the Block list.</td>
</tr>
<tr><th>Block Body</th>
<td>The content you want to display on the webpage footer.</td>
</tr>
<tr><th>Region Settings</th>
<td>A set of dropdowns for each theme. Select which area you want the new block to appear. In this case, the Footer area of the Bartik theme.</td>
</tr>
<tr><th>Visibility Settings</th>
<td>Various restriction options. By default, it will display on all pages and for all users.</td>
</tr>
</tbody>
</table>
</li>
<li>Once you have the settings inserted, click the <strong>Save Block</strong> button at the bottom of the page.</li>
<li>You now want to confirm that the new block is showing in the <strong>Footer</strong> are of the theme.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/structure/blocks/new-footer/5-confirm.png"><img  alt="5-confirm" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/structure/blocks/new-footer/5-confirm.png" /></a><br /><br />Your new footer should now display on yoru website. Below is a before and after screenshot of the changes made in this tutorial.<br />
<table class="article_table">
<tbody>
<tr><th>Before</th><th>After</th></tr>
<tr>
<td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/structure/blocks/new-footer/new-footer-before.png"><img style="max-width: 250px;"  alt="new-footer-before" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/structure/blocks/new-footer/new-footer-before.png" /></a></td>
<td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/structure/blocks/new-footer/new-footer-after.png"><img style="max-width: 250px;"  alt="new-footer-after" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/structure/blocks/new-footer/new-footer-after.png" /></a></td>
</tr>
</tbody>
</table>
</li>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/drupal-7/blocks-and-regions'>104: Working with Blocks and Regions in Drupal 7</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 5: How to create a custom footer block in Drupal 7</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 4: <a href='/support/edu/drupal-7/blocks-and-regions/how-to-use-blocks-in-drupal-7'>Changing the region a block is assigned to in Drupal 7</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 6: <a href='/support/edu/drupal-7/blocks-and-regions/create-custom-sidebar'>How to customize your sidebar blocks in Drupal 7</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/drupal-7/blocks-and-regions/create-custom-footer&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/drupal-7/blocks-and-regions/create-custom-footer'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yMDUmaWQ9MjAyNiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/drupal-7/blocks-and-regions?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Working with Blocks and Regions in Drupal 7</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/drupal-7/blocks-and-regions/nodes-blocks-regions?tsrc=rsbedu'>Understanding Nodes - Blocks - Regions in Drupal 7</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/drupal-7/blocks-and-regions/find-regions?tsrc=rsbedu'>How to view block regions in Drupal 7</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/drupal-7/blocks-and-regions/create-block?tsrc=rsbedu'>How to create a new block in Drupal 7</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/drupal-7/blocks-and-regions/how-to-use-blocks-in-drupal-7?tsrc=rsbedu'>Changing the region a block is assigned to in Drupal 7</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/drupal-7/blocks-and-regions/create-custom-footer?tsrc=rsbedu'>How to create a custom footer block in Drupal 7</a></td>
                </tr>
          <tr >
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/drupal-7/blocks-and-regions/create-custom-sidebar?tsrc=rsbedu'>How to customize your sidebar blocks in Drupal 7</a></td>
                </tr>
          	</table>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/30bce2233ee737e364ed1895684ff74a?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/30bce2233ee737e364ed1895684ff74a'>Jim</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-09 3:15 pm</div>
				                <div>Tell me how to centre the text in the footer</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12566);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-11 1:59 am</div>
				                <div>Hello Jim, and thanks for your question.<br />
<br />
You can center Drupal footer text by applying the following CSS rule to your footer:<br />
<br />
&lt;p class=&quot;cli&quot; style=&quot;margin: -10px 0px -30px 0px;&quot;&gt;text-align: center;&lt;/p&gt;<br />
<br />
It could be a bit different depending on your theme, but here is what I had to edit and &lt;span style=&quot;color: red;&quot;&gt;add&lt;/span&gt;:<br />
<br />
&lt;span style=&quot;color: red;&quot;&gt;/themes/bartik/css/style.css&lt;/span&gt; &lt;strong&gt;Line 841&lt;/strong&gt;<br />
<br />
&lt;p class=&quot;cli&quot; style=&quot;margin: -10px 0px -30px 0px;&quot;&gt;/* ------------------ Footer ------------------ */<br />
<br />
#footer-wrapper {<br />
  color: #c0c0c0;<br />
  color: rgba(255, 255, 255, 0.65);<br />
  font-size: 0.857em;<br />
  &lt;span style=&quot;color: red;&quot;&gt;text-align: center;&lt;/span&gt;<br />
}&lt;/p&gt;<br />
<br />
Please let us know if that does the trick for you!<br />
<br />
- Jacob<br />
<br />
</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12635);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-20087'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/00c9fd7d93ca62b594f2d56d15796c86?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/00c9fd7d93ca62b594f2d56d15796c86'>ACASP</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-29 9:31 am</div>
				                <div><p>Excellent article helped me a lot!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20087);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-32774'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/2ceebf068cdeefb02ed95ff591c65346?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/2ceebf068cdeefb02ed95ff591c65346'>CathyRoberson</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-05-18 1:54 am</div>
				                <div><p style="text-align: justify;"><strong>Step 1</strong>. Go to your theme folder and look for &ldquo;.info&rdquo; file. I am using theme &ldquo;corporate&rdquo; so info &lt;a href="http://essayservices.org/"&gt;file&lt;/a&gt; will be located &ldquo;themes\corporate\corporate.info&rdquo;. You will see different location/blocks in your theme. like below:</p>
<pre>regions[header]         = Header
regions[content]        = Content
regions[help]           = Help
regions[footer]         = Footer
</pre>
<p style="text-align: justify;"><strong>Step 2</strong>. Add your block into the file like below:</p>
<pre>regions[header]         = Header
regions[content]        = Content
regions[help]           = Help
regions[footer]         = Footer
<strong>regions[welcome_header] = Welcome Header</strong>
</pre>
<p style="text-align: justify;"><strong>Step 3</strong>. Update your template file with this new block. Open &ldquo;page.tpl.php&rdquo; located in &ldquo;themes\corporate\templates&rdquo; and add your block like below:</p>
<pre>&lt;?php if ($page['welcome_header']): ?&gt;
...
<p style="text-align: justify;"><strong>Step 4</strong>. Release the cache from admin -&gt; Configuration -&gt; Performance. And click &ldquo;Clear Cache&rdquo; button to release the cache. Now if you go the block in structure, you can see &ldquo;welcome Header&rdquo; section is getting listed in region drop down. Now you can select &ldquo;Welcome Header&rdquo; region for your block.</p>
<p style="text-align: justify;">&nbsp;</p>
<p style="text-align: justify;">- Source from sforsuresh.in</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32774);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
