<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:73250:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/boldgrid/installing-boldgrid/manually" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-04-04T14:38:38-07:00" />
  <meta name="author" content="John-Paul Briones" />
  <meta name="description" content="Learn how to manually install BoldGrid in this tutorial." />
  <title>How to Manually Install BoldGrid - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/boldgrid/installing-boldgrid/manually" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<script type="text/javascript">
		...
		_gaq.push(['_setCustomVar', 4, 'DateMonthPublished', '2015-10', 3]);
	...
	<!-- cid:1f40dc3dd8ca4cd97e9ccd9f9d111a0d -->
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/boldgrid' itemprop='url'><span itemprop='title'>BoldGrid<span></a><div class='dropdown_2columns'><h2>BoldGrid Education Channel</h2><div class='col_2'><h3>100 Level Classes</h3></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/boldgrid/installing-boldgrid' itemprop='url'><span itemprop='title'>Installing BoldGrid<span></a><div class='dropdown_3columns'><h2> BoldGrid</h2><div class='col_3'><div>1. <a style='display:inline;' href='/support/edu/boldgrid/installing-boldgrid/manually'>How to Manually Install BoldGrid</a></div><div>2. <a style='display:inline;' href='/support/edu/boldgrid/installing-boldgrid/what-is-boldgrid-advanced'>What is BoldGrid (Advanced Users)</a></div><div>3. <a style='display:inline;' href='/support/edu/boldgrid/installing-boldgrid/introduction'>Introduction to BoldGrid Powered by WordPress</a></div><div>4. <a style='display:inline;' href='/support/edu/boldgrid/installing-boldgrid/how-to-install'>How to Install BoldGrid</a></div><div>5. <a style='display:inline;' href='/support/edu/boldgrid/installing-boldgrid/view-connect-key'>How to get to Your BoldGrid Connect Key</a></div><div>6. <a style='display:inline;' href='/support/edu/boldgrid/installing-boldgrid/boldgrid-staging-with-existing-site'>Using BoldGrid with an existing WordPress Site</a></div><div>7. <a style='display:inline;' href='/support/edu/boldgrid/installing-boldgrid/boldgrid-wp-subdirectory-install'>How to Install WordPress in a Subdirectory</a></div><div>8. <a style='display:inline;' href='/support/edu/boldgrid/installing-boldgrid/installing-first-boldgrid-site'>Installing your first BoldGrid Site</a></div><div>9. <a style='display:inline;' href='/support/edu/boldgrid/installing-boldgrid/boldgrid-use-different-domain'>How to use BoldGrid in a Different Domain</a></div><div>10. <a style='display:inline;' href='/support/edu/boldgrid/installing-boldgrid/site-hosted-elsewhere'>How to Use BoldGrid when your site is not hosted with InMotion Hosting</a></div><div>11. <a style='display:inline;' href='/support/edu/boldgrid/installing-boldgrid/move-wordpress-folder'>Move WordPress folder</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to Manually Install BoldGrid</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to Manually Install BoldGrid									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>3,821</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Oct 20, 2015'><span style='color:#606060;'>Published:</span> Apr 4, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In this tutorial we will show you how to install the BoldGrid plugin suite for WordPress. You can then begin building your <a href="http://www.boldgrid.com/website-templates-themes/">BoldGrid</a> website. Note that this tutorial is for those looking to install BoldGrid on an existing WordPress installation. If you have not already done so, <a href="http://www.inmotionhosting.com/support/edu/wordpress/wordpress-introduction/install-wordpress-using-softaculous">install WordPress</a> to your desired domain.</p>

<a name="menus"></a>
<h2>Manually Installing BoldGrid</h2>

<ol class="article_list">
  <li><a href="https://github.com/BoldGrid/boldgrid-inspirations/archive/master.zip">Download the BoldGrid plugin</a>, and <a href="/support/edu/wordpress/wordpress-introduction/logging-into-wordpress-dashboard">login to the WordPress Dashboard.</a></li>
<li>Roll your mouse over the <strong>Plugins</strong> link, and click <strong>Add New</strong>.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/boldgrid/how-to-install/manual/plugins-add-new.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/boldgrid/how-to-install/manual/plugins-add-new.png" alt="Installing BoldGrid Plugin" title="Adding a new Plugin" /></a></li>
<li>Click the <strong>Upload Plugin</strong> button.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/boldgrid/how-to-install/manual/boldgrid-upload-plugin.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/boldgrid/how-to-install/manual/boldgrid-upload-plugin.png" alt="Uploading BoldGrid" title="Uploading BoldGrid Plugin" /></a></li>
<li>Click the <strong>Choose File</strong> button on the <em>Add Plugins</em> page, choose and open the <strong>BoldGrid</strong> plugin, then click the <strong>Install Now</strong> button.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/boldgrid/how-to-install/manual/boldgrid-choose-file-install-now.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/boldgrid/how-to-install/manual/boldgrid-choose-file-install-now.png" alt="Choosing BoldGrid File in Dashboard" title="Installing BoldGrid Plugin" /></a></li>
<li>When you see a "<em>Plugin installed successfully</em>" message, click the <strong>Activate Plugin</strong> button.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/boldgrid/how-to-install/manual/activate-boldgrid-plugin.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/boldgrid/how-to-install/manual/activate-boldgrid-plugin.png" alt="BoldGrid Activation" title="Activating BoldGrid Plugin in WordPress" /></a></li>
<li>You will then be on the <em>Plugins</em> page. Enter your <strong>32 digit BoldGrid Connect Key</strong> in the <em>BoldGrid API Check</em> section, then click the <strong>Submit</strong> button.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/boldgrid/how-to-install/manual/boldgrid-connect-key-api-check.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/boldgrid/how-to-install/manual/boldgrid-connect-key-api-check.png" alt="BoldGrid API Check" title="Entering BoldGrid Connect Key" /></a></li>
<li>You will then see a message stating "<em>The BoldGrid Inspirations plugin requires these other plugins for best results. Please click to install and activate</em>." Make sure the listed plugins are checked, then click the <strong>Install</strong> button.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/boldgrid/how-to-install/manual/installing-additional-boldgrid-plugins.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/boldgrid/how-to-install/manual/installing-additional-boldgrid-plugins.png" alt="BoldGrid Additional Plugins Installation" title="Install required Plugins for BoldGrid" /></a></li>
<li>You are finished manually installing the BoldGrid plugin when you see a "<em>Installation successful!</em>" message. Click the <strong>Plugins</strong> link in the Dashboard, to see them listed.</li>
</ol>
<br>
<p>Congratulations, now you know how to manually install BoldGrid. <a href="/support/edu/boldgrid/getting-started/install-inspiration">Install your first Inspiration</a> to begin creating your BoldGrid site.</p>

<p>
  <br />
  If you are not an InMotion customer, you can visit the <a href="http://www.boldgrid.com/support/how-to-manually-install-the-boldgrid-plugin/">Manual Installation of BoldGrid</a> and other articles <a href="http://www.boldgrid.com/support">click here</a> to visit the BoldGrid Support Center.
</p>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/boldgrid/installing-boldgrid'>Installing BoldGrid</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 1: How to Manually Install BoldGrid</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 2: <a href='/support/edu/boldgrid/installing-boldgrid/what-is-boldgrid-advanced'>What is BoldGrid (Advanced Users)</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/boldgrid/installing-boldgrid/manually&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/boldgrid/installing-boldgrid/manually'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD01MzYmaWQ9MzY3NyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/boldgrid/installing-boldgrid?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> BoldGrid</h3></a>
		<table>  <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/boldgrid/installing-boldgrid/manually?tsrc=rsbedu'>How to Manually Install BoldGrid</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/boldgrid/installing-boldgrid/what-is-boldgrid-advanced?tsrc=rsbedu'>What is BoldGrid (Advanced Users)</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/boldgrid/installing-boldgrid/introduction?tsrc=rsbedu'>Introduction to BoldGrid Powered by WordPress</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/boldgrid/installing-boldgrid/how-to-install?tsrc=rsbedu'>How to Install BoldGrid</a></td>
                </tr>
          <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/boldgrid/installing-boldgrid/view-connect-key?tsrc=rsbedu'>How to get to Your BoldGrid Connect Key</a></td>
                </tr>
          <tr >
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/boldgrid/installing-boldgrid/boldgrid-staging-with-existing-site?tsrc=rsbedu'>Using BoldGrid with an existing WordPress Site</a></td>
                </tr>
          <tr >
                        <td valign='top'>7.</td>
                        <td><a href='/support/edu/boldgrid/installing-boldgrid/boldgrid-wp-subdirectory-install?tsrc=rsbedu'>How to Install WordPress in a Subdirectory</a></td>
                </tr>
          <tr >
                        <td valign='top'>8.</td>
                        <td><a href='/support/edu/boldgrid/installing-boldgrid/installing-first-boldgrid-site?tsrc=rsbedu'>Installing your first BoldGrid Site</a></td>
                </tr>
          <tr >
                        <td valign='top'>9.</td>
                        <td><a href='/support/edu/boldgrid/installing-boldgrid/boldgrid-use-different-domain?tsrc=rsbedu'>How to use BoldGrid in a Different Domain</a></td>
                </tr>
          <tr >
                        <td valign='top'>10.</td>
                        <td><a href='/support/edu/boldgrid/installing-boldgrid/site-hosted-elsewhere?tsrc=rsbedu'>How to Use BoldGrid when your site is not hosted with InMotion Hosting</a></td>
                </tr>
          <tr >
                        <td valign='top'>11.</td>
                        <td><a href='/support/edu/boldgrid/installing-boldgrid/move-wordpress-folder?tsrc=rsbedu'>Move WordPress folder</a></td>
                </tr>
          	</table>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/0094439784375e3efee71edd44623f34?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/0094439784375e3efee71edd44623f34'>Robert Haught</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-25 1:12 pm</div>
				                <div><p>plugin page won't open 500 internal error</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30094);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-25 7:00 pm</div>
				                <div>Hello Robert,<br />
<br />
That is not good! This should not be a BoldGrid specific error, however.  A 500 error on your plugin page would need to be checked out by our Live Support team. Give them a try and I'm sure they will have you fixed in a jiff!<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30111);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-30220'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/27a060ddbb4ef851af8abab8bb68251e?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/27a060ddbb4ef851af8abab8bb68251e'>Ada</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-29 7:18 am</div>
				                <div><p>I have a reseller account, but i have not download Boldgrid. Where do i find that to download and I want&nbsp;<strong style="color: #232323; font-family: adelle-sans, Helvetica, Arial, sans-serif; font-size: 13px;">32 digit BoldGrid Connect Key</strong><span style="color: #232323; font-family: adelle-sans, Helvetica, Arial, sans-serif; font-size: 13px; background-color: #f8f8f8;">&nbsp;in the&nbsp;</span><em style="padding: 0px 3px 0px 0px; color: #232323; font-family: adelle-sans, Helvetica, Arial, sans-serif; font-size: 13px;">BoldGrid API Check</em></p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30220);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-29 9:15 am</div>
				                <div>Ada, BoldGrid is not currently available for Resellers. Hopefully, this will change in the coming months. </div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30226);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/36e5c07154423ee5892095562d8649ca?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/36e5c07154423ee5892095562d8649ca'>John Knehans</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-13 4:20 am</div>
				                <div>What are the concerns when using BoldGrid for VPS users?</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31187);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-14 5:34 pm</div>
				                <div>There should not be any. It is the same as using WordPress.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31218);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-31279'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/38b114066217586bcd40cc5f3e492eda?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/38b114066217586bcd40cc5f3e492eda'>John Knehans</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-16 7:26 pm</div>
				                <div><p>You mainly need to tack on your ID number found in the AMP Panel onto the back end of the download URL then upload that zip file like any other plugin. Then you need to activate, follow the prompts to activate a couple of other plugins and insert your 30 to 35 character key and activate.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31279);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
