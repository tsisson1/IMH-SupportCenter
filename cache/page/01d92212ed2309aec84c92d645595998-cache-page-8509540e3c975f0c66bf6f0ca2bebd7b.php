<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:51369:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/dns-nameserver-changes/error-when-updating-name-servers" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello orangeriverdesign, Thank you for contacting us about errors when updating Nameservers in AMP. There is a know bug at this time, that causes that e..." />
  <title>Error When Updating Name Servers | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/dns-nameserver-changes/error-when-updating-name-servers" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:c6a3f41b5917e9e209abebbeb6c77ee1 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Error When Updating Name Servers</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/orangeriverdesign'>orangeriverdesign</a>
			<div>8 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-04-23 12:29 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>217</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I had transferred my domain to an InMotion reseller account.  Now I am trying to update the name servers, but am receiving the following error:  There was a problem with processing your request. Ensure that the nameservers you are trying to set have been created. If they have not, you can go here to do so.<br />
<br />
Clicking the &quot;here&quot; link in the error message takes me to a page that says, &quot;Oops...there was an error with your request.&quot;  I am trying to use ns1.servconfig.com and ns2.servconfig.com but also tried the ns1/ns2.inmotionhosting.com just out of curiosity.    Any ideas for what I'm doing wrong?  Thanks! </div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_7100' id='upvote_answer_7100' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='7100' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_7100').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_7100' id='downvote_answer_7100' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='7100' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_7100').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>22,986 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2015-04-23 12:48 pm EST
                		        </div>
					
		                </div>

				Hello orangeriverdesign,<br />
<br />
Thank you for contacting us about errors when <a href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/change-domain-nameservers-amp">updating Nameservers</a> in AMP. <br />
<br />
There is a know bug at this time, that causes that error. Our Development team is currently working to correct this.<br />
<br />
 Please <a href="http://www.inmotionhosting.com/support/website/getting-started-guides/submitting-and-checking-on-status-of-tickets#submit-ticket">submit a ticket</a>, and Live Support can make the update for you.<br />
<br />
...
John-Paul B
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_7100').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_7100' id='form_comment_on_answer_7100' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Thank you for the quick response!  I will get the ticket submitted.</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='/support/images/avatars/default_avatar.jpg' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/orangeriverdesign'>orangeriverdesign</a><br />
									8 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2015-04-23 12:50 pm EST
								</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/dns-nameserver-changes/error-when-updating-name-servers&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/dns-nameserver-changes/error-when-updating-name-servers'></div>
<script type='text/javascript'>
  (function() {
