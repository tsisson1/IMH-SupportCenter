<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50224:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/dns-nameserver-changes/how-do-i-setup-a-launch-rock-page-by-redirecting-my-inmotion-page" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="RWJackson, When creating a CNAME, you will need a domain name to point to. An A record needs an IP address. To set your domain name to either, simply se..." />
  <title>How do I setup a Launch Rock Page by redirecting my inmotion page? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/dns-nameserver-changes/how-do-i-setup-a-launch-rock-page-by-redirecting-my-inmotion-page" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:b9918f2a4720ca9ca2af7b3f39fb831a -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>How do I setup a Launch Rock Page by redirecting my inmotion page?</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/RWJackson'>RWJackson</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-06-26 12:42 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>1,851</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I am trying to set up a Launch Rock page and I have the option of creating a CNAME record or setting A Record.  I do not see any step by step directions for doing this on launchrock's website or inmotions.  Thx!</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_1209' id='upvote_answer_1209' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='1209' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_1209').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_1209' id='downvote_answer_1209' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='1209' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_1209').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				RWJackson,<br />
<br />
When creating a CNAME, you will need a domain name to point to. An A record needs an IP address.  <br />
<br />
To set your domain name to either, simply send the information from Launch Rock to our support team and they can create that record for you. <br />
<br />
To do that, simply <a href="http://www.inmotionhosting.com/contact.html" target="_blank">contact our support department</a> (open 24/7) with that request. Be sure to validate your account with either the last 4 digits of the credit card on file, or the current Account Management Panel (AMP) password.<br />
<br />
I hope this answers your question. If you have any more questions or information specific to the issue please leave a comment below so we can further assist you.<br />
<br />
Best Regards,<br />
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_1209').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_1209' id='form_comment_on_answer_1209' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/dns-nameserver-changes/how-do-i-setup-a-launch-rock-page-by-redirecting-my-inmotion-page&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/dns-nameserver-changes/how-do-i-setup-a-launch-rock-page-by-redirecting-my-inmotion-page'></div>
<script type='text/javascript'>
  (function() {
