<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:45241:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/opencart/admin-tools" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="In this OpenCart class, we'll show you how to do simple but important management tasks, such as changing your admin password and creating backups of your site." />
  <title>201: OpenCart Administration | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/opencart/admin-tools" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:ebdc9fa748c8f6b67851e47b5b509256 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '216.166.20.1']);
...
<div class='page-header'>
	<h1>201: OpenCart Administration</h1>
</div>
<div class='section_listing'>
		...
		<tr>
				...
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/opencart/admin-tools/fix-opencart-email-notifications'>Fixing the Email issue with OpenCart 1.5</a>
					<div>Opencart 1.5x notifications have been identified as having issues with some InMotion Hosting servers.  If you have an account with InMotion and you're not seeing new account or new order notifications, please make sure to follow this tutorial to resolve the problem.</div>
					<div class='smallgrey'>Hits: 637</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/opencart/admin-tools/forgot-password-link'>Resetting your OpenCart 1.5 Admin Password with the Forgot Password link</a>
					<div>This guide walks you through resetting your OpenCart Admin password using the Forgot  Password link on the dashboard login page.</div>
					<div class='smallgrey'>Hits: 9,199</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/opencart/admin-tools/backup-restore'>Using the Backup/Restore option in OpenCart 1.5</a>
					<div>In this tutorial we will walk you through backing up and restoring your OpenCart Database from the Dashboard.</div>
					<div class='smallgrey'>Hits: 5,281</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/opencart/admin-tools/changing-your-admin-password-in-opencart'>Changing your Admin Password in OpenCart</a>
					<div>In this tutorial, you'll learn how to change your administrator's password from the OpenCart dashboard</div>
					<div class='smallgrey'>Hits: 20,190</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/opencart/admin-tools/what-are-opencart-extensions-and-modules'>What are OpenCart Extensions and Modules?</a>
					<div>In this tutorial, we'll explain what modules and extensions are and how they can help you customize your OpenCart store even further.</div>
					<div class='smallgrey'>Hits: 8,930</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/opencart/admin-tools/restoring-a-database-backup-in-opencart'>Restoring a Database Backup in OpenCart</a>
					<div>This tutorial will show you the process to restoring a database backup for your OpenCart site.</div>
					<div class='smallgrey'>Hits: 3,548</div>
				</td>
			</tr>
			</table>
</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xNTcmaWQ9MTU3JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
