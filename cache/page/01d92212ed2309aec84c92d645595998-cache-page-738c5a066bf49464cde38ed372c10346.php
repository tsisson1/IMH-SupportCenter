<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:61227:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/drupal-7/menus/adding-links-to-a-menu-in-drupal-7" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-02-27T16:25:23-08:00" />
  <meta name="keywords" content="add link menu create drupal 7" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Learn how to add a link to a menu in Drupal 7. " />
  <title> Creating Menus in Drupal 7 - Part 2 - Adding links and Displaying  - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/drupal-7/menus/adding-links-to-a-menu-in-drupal-7" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:6fe29b00760d2670347c6aefbe19050e -->
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
				<img src='/support/images/stories/drupal-partner/supporting-partner-80_3.png' style='float:right; margin:0px 0px 15px 15px;' alt='Drupal Association Support Partner'>		<h1>
															 Creating Menus in Drupal 7 - Part 2 - Adding links and Displaying 									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>17,166</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Feb 21, 2012'><span style='color:#606060;'>Published:</span> Feb 27, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Welcome to part two of the menu creation tutorial series. At this point, we have already <a href="/support/edu/drupal-7/menus/how-to-create-a-menu-in-drupal-7">created a new menu</a> in Drupal 7 and are ready to add links to it. The links are the actual menu items that your visitors will click on to visit pages within your website. Here is where we will learn to add those to our menu. After that, we will configure settings to display the menu on your site.</p>

<h2>Adding menu items</h2>

<ol class="article_list">
  <li><a href="/support/edu/drupal-7/getting-started/how-to-log-into-the-drupal-admin-dashboard">Log into your Drupal admin Dashboard</a>.<div style="clear:both;"></div></li>
  
  <li>Click on the <strong>Structure</strong> menu item from the top menu bar and then click on <strong>Menus</strong>.<div style="clear:both;"></div></li>
  
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/drupal/drupal_menu_link_1.jpg"><img  style="float:right; margin:0px 0px 15px 15px;" alt=""  src="//cdn.inmotionhosting.com/support/images/stories/drupal/drupal_menu_link_1.jpg" title="Click here to view the larger image" width="200" /></a>
Find your new menu structure from the list of menus and then click on the <strong>Add Link</strong> link on the far right for that menu.<div style="clear:both;"></div></li>
  
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/drupal/drupal_menu_link_2.jpg"><img  style="float:right; margin:0px 0px 15px 15px;" alt=""  src="//cdn.inmotionhosting.com/support/images/stories/drupal/drupal_menu_link_2.jpg" title="Click here to view the larger image" width="200" /></a>You are taken to a screen where you will add the specific data for the link.  
<div style="clear:both;"></div>
  <table class="article_table">
  <tr><th>Field Name</th><th>Required?</th><th>Description</th></tr>
  <tr><td>Menu Link Title</td><td>Yes</td><td>This is the name of the item, also known as anchor text, that will display on screen.</td></tr>
  <tr><td>Path</td><td>Yes</td><td>This is the path to the page you want to display. It can be an absolute url like <em>http://google.com</em> or a relative link (for example my Hello World page) like <em>/node/8</em>. To find the path, you may need to visit the page on your site and get the URL from the address bar of your browser.</td></tr>
  <tr><td>Description</td><td>No</td><td>This is a description that will appear when hovering over the menu item.</td></tr>
  <tr><td>Enabled</td><td>No</td><td>Tells whether the item will be displayed in the menu. It is turned on by default.</td></tr>
  <tr><td>Show as expanded</td><td>No</td><td>If this is enabled and the menu item has sub items, they will all display under the parent menu item. Think of it like creating subcategories. It is turned off by default.</td></tr>
  <tr><td>Parent Link</td><td>No</td><td>Set to the menu structure itself by default, this dropdown allows you to place the menu item under another item or menu if desired.</td></tr>
  <tr><td>Weight</td><td>No</td><td>This number is used to set the order of the menu items. Lower numbers are listed first.</td></tr>
  </table>
<div style="clear:both;"></div></li>

<li>Once you have finished filling in the desired fields, click the <strong>Save</strong> button at the bottom to save your link. Repeat this process for each menu item you want to add to your menu. Your newly added link will show in the <em>Menu Link</em> list. Since this is the first link for our <em>Test 1</em> menu, it is the only one listed at this time.<div style="clear:both;"></div></li>
</ol>


<p>You now have created your custom menu on your Drupal 7 site! This concludes part two of the two part article series. Next, you will learn how to <a href="/support/edu/drupal-7/menus/enable-custom-menu">enable your custom menu</a> for your site. You may either replace the main or secondary menus, or you can place the menu in one of your site regions. If you need further assistance please feel free to ask a question on our support center.</p>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/drupal-7/menus'>105: Working with Menus in Drupal 7</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 3:  Creating Menus in Drupal 7 - Part 2 - Adding links and Displaying </div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 2: <a href='/support/edu/drupal-7/menus/how-to-create-a-menu-in-drupal-7'>Creating Menus in Drupal 7 - Part 1 - Menu Structure</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 4: <a href='/support/edu/drupal-7/menus/enable-custom-menu'>Enabling your custom menu in Drupal 7</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/drupal-7/menus/adding-links-to-a-menu-in-drupal-7&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/drupal-7/menus/adding-links-to-a-menu-in-drupal-7'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yMDQmaWQ9MTE3NSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="03a861ddf11485d65b865c1df10c476e" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/drupal-7/menus?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Working with Menus in Drupal 7</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/drupal-7/menus/introduction-to-menus-in-drupal-7?tsrc=rsbedu'>Introduction to menus in Drupal 7</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/drupal-7/menus/how-to-create-a-menu-in-drupal-7?tsrc=rsbedu'>Creating Menus in Drupal 7 - Part 1 - Menu Structure</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/drupal-7/menus/adding-links-to-a-menu-in-drupal-7?tsrc=rsbedu'> Creating Menus in Drupal 7 - Part 2 - Adding links and Displaying </a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/drupal-7/menus/enable-custom-menu?tsrc=rsbedu'>Enabling your custom menu in Drupal 7</a></td>
                </tr>
          <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/drupal-7/menus/rearranging-menu-links-in-drupal-7?tsrc=rsbedu'>Rearranging menu links in Drupal 7</a></td>
                </tr>
          <tr >
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/drupal-7/menus/how-to-delete-a-menu-in-drupal-7?tsrc=rsbedu'>How to delete a menu in Drupal 7</a></td>
                </tr>
          <tr >
                        <td valign='top'>7.</td>
                        <td><a href='/support/edu/drupal-7/menus/disable-main-menu?tsrc=rsbedu'>How to disable the main menu in a Drupal 7 theme</a></td>
                </tr>
          <tr >
                        <td valign='top'>8.</td>
                        <td><a href='/support/edu/drupal-7/menus/disable-secondary-menu?tsrc=rsbedu'>How to disable the secondary menu in a Drupal 7 theme</a></td>
                </tr>
          	</table>
