...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/email/email-troubleshooting/one-or-more-outbox-windows-live-error" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-12-04T21:08:07-08:00" />
  <meta name="keywords" content="One or more messages in your Outbox do not have a valid account specified. Would you like to use yourdefault acct to send these messages?" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="Windows Live Mail One or more messages in your Outbox do not have a valid account specified. Would you like to use your
default acct to send these messages? error." />
  <title>Windows Live &quot;One or more messages in your Outbox&quot; error - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/email/email-troubleshooting/one-or-more-outbox-windows-live-error" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<script type="text/javascript">
		...
		_gaq.push(['_setCustomVar', 3, 'DateMonthModified', '2013-12', 3]);
	...
	<!-- cid:10a1142f0fb9fbc733214309644c1ba3 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Windows Live &quot;One or more messages in your Outbox&quot; error									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='clear:both;'></div>
								...
								<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/email/email-troubleshooting/outbox-cannot-send-error/live-mail-outbox-error.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Snapshot of One or more messages in your Outbox do not have a valid account specified. error" src="//cdn.inmotionhosting.com/support/images/stories/email/email-troubleshooting/outbox-cannot-send-error/live-mail-outbox-error.gif" title="Click here to view the larger image" width="100" /></a>Recently we had a customer with an error in their <a href="/support/email/email-client-setup/setting-up-windows-live-mail" target="_blank" title="How to Set up Windows Live Mail">Windows Live Mail</a> IMAP account. This happened after they were moved to a different server and the email settings for the email client were changed. Below is an excerpt of the error message.</p>
<pre style="margin-left: 20px;">One or more messages in your Outbox do not have a valid account specified.
Would you like to use your default acct to send these messages?</pre>
<h2>Problem</h2>
<p>The problem is that you have an email stuck in your outbox (that failed to send for previously), which was initially written from an email address that no longer exists in your Windows Live Mail. This email account may technically "no longer exist", for example, if you've updated the email account's settings within Live Mail. When you then attempt to send and receive, Live Mail will not send the email stuck in the outbox because the original email account that created it no longer exists.</p>
<h2>Solution #1</h2>
<p>The easiest solution is to simply re-create the email messages that you want send that are stuck in the outbox. It is as easy as going through each email in the outbox and copy / pasting it into a new message, and then sending.</p>
<h2>Solution #2</h2>
<p>During our research in finding out what causes this problem, we read many online forums that suggested the problem may be due to a conflict with an anti-virus program running on your desktop. While we don't believe this is the case, you may want to try <strong>temporarily</strong> disabling any anti-virus programs (or related programs) and attempting to send the emails again.</p>
<h2>How to fix the error</h2>
<ol class="article_list">
<li>Open your Windows Live mail program.</li>
<li>Select the Home tab at the top right of your Windows Live Mail.</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/email/email-troubleshooting/outbox-cannot-send-error/live-mail-outbox-error-1.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Windows Live Mail Outbox" src="//cdn.inmotionhosting.com/support/images/stories/email/email-troubleshooting/outbox-cannot-send-error/live-mail-outbox-error-1.gif" title="Click here to view the larger image" width="100" /></a>Click the Outbox to the left.
<p>Find any emails that are not sending out. You will need to copy the content of the email and send it as a new email with the new account.</p>
<br style="clear: both;" /></li>
<li>Once you send the email again, you can delete the email in the Outbox. The error will go away after the sent email is deleted.</li>
</ol> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/email/email-troubleshooting/one-or-more-outbox-windows-live-error&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/email/email-troubleshooting/one-or-more-outbox-windows-live-error'></div>
	<script type='text/javascript'>
	  (function() {
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/48ce22a3fedab9ace0bd2330c29a77e3?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/48ce22a3fedab9ace0bd2330c29a77e3'>Ron</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-06 6:21 pm</div>
				                <div><p>Open your Windows Live mail program. I can't the only thing that opens is the window on my desktop says executing under status send 2 message(s) using verizon</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8809);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-07 11:07 am</div>
				                <div>Hello Ron,<br />
<br />
It sounds like something may be stuck in your outbox. I found a <a href="http://answers.microsoft.com/en-us/windowslive/forum/livemail-email/windows-live-mail-is-stuck-sending-something/ab160134-0bc6-4708-ab7d-194d9dce8d48">similar post</a> on the official Microsoft website, where they provide a possible solution.<br />
<br />
Have you tried restarting your computer?<br />
<br />
If you have any further questions, feel free to post them below.<br />
Thank you,<br />
<br />
-John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8830);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-07 11:36 am</div>
				                <div><p>Ok I got it I opened up task manager and end task on live mail then proceeded to open my email then I could do my thing. Delete the outgoing mail.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8832);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-14760'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/d8191db3b7f47f5a44a54c61517c7532?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/d8191db3b7f47f5a44a54c61517c7532'>Bob</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-05 10:30 am</div>
				                <div>I'm getting an error message that says "Error can not delete this e-mail" sometimes it tells me it can not open the e-mail.
<p>what do I do?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14760);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-05 12:20 pm</div>
				                <div>Hello Bob,<br />
<br />
Thank you for your question. I found an article in the <a href="http://support.microsoft.com/kb/2503266" target="_blank">Official Microsoft support</a> forums, where they provide several solutions to problems deleting emails.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14764);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-18697'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/5009b57eda07efb49e3256925497959c?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/5009b57eda07efb49e3256925497959c'>Donna</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-19 2:00 pm</div>
				                <div><p>I like to use my live.ca email sometimes, but lately I am getting an error that I have 5 emails stuck in OUTBOX. When I check I don't have an OUTBOX listed on the left with the other options. So where are those emails going? Thanks for your help.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(18697);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-19 2:27 pm</div>
				                <div>Hello Donna,<br />
<br />
Sorry for the problem with your LIVE mail client.  Fortunately, the issue does have a solution.  Follows these steps:<br />
<br />
<ol><br />
<li>Login to your Windows Live Mail application </li><br />
<li>Click <b>Work Offline</b> - you will need to be on the HOME page of Windows Live mail to see the option. </li><br />
<li>When you are offline, you will then see the <b>Outbox</b> folder.  Click on it to open it. </li><br />
<li>Click on the message(s) that you want to delete, then click on the DELETE key to remove them. </li><br />
</ol><br />
<br />
If you want to keep a copy of the email that's failing to send, then make sure to copy the offending email to another folder so that you can try editing it and re-sending at a later point.<br />
<br />
If you are having trouble finding the Outbox folder, you will need make sure that you are in the HOME menus (Microsoft calls the set of menus a "ribbon"), make sure you can see ALL of your folders.  In the MAIL folder you should be able to select <b>Outbox</b>.  This issue is fairly common for Microsoft users, so out the solution for it in their <a href="http://answers.microsoft.com/en-us/windowslive/forum/livemail-email/emails-are-stuck-in-outbox-using-windows-live-mail/19ee9c05-0e47-401b-85ea-9959e4be380d" rel="nofollow" target="_blank">forum</a>.<br />
<br />
I hope this helps to answer your question, please let us know if you require any further  assistance.<br />
<br />
Kindest regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(18700);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/413ed6088b64acb625ac0243dbceafd2?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/413ed6088b64acb625ac0243dbceafd2'>Daniel Keith</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-12-16 4:29 am</div>
				                <div><p>My problem is there IS NO OUTBOX. There IS NO WORK OFFLINE tab. And there's a message stuck in the nonexistant outbox causing trouble. Srsly wtf do they do this to us. Clicking on the HOME tab gets me nowhere.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29211);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-12-16 4:32 am</div>
				                <div><p>sry, NM. The outbox just appeared. problem solved. thx.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29212);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-30001'></a>
		<div  style='margin:2px 0px 0px 80px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/3d767e852d0f1fef3dd30365bcfffe7b?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/3d767e852d0f1fef3dd30365bcfffe7b'>brian</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-21 3:47 pm</div>
				                <div><p>doesn't work.</p>
<p>when I click work offline it give me error at lower left "error ! working offline"</p>
<p>still no "outbox" appears.</p>
<p>though months ago there would be one.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30001);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-21 5:27 pm</div>
				                <div>Hello brian,<br />
<br />
Thank you for contacting us. The outbox should be able to be deleted from the WIndows Live mail client, is this what you are using?<br />
<br />
Thank you ,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30008);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/5a9c0d23eedf14fb3837685030119690?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/5a9c0d23eedf14fb3837685030119690'>Carol Mitchell</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-22 12:55 pm</div>
				                <div>Good as is..Had no idea about the &quot;outbox&quot;.  Thanks</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(18782);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-19169'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/fca98581f30d1fcac14b02ec600ed771?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/fca98581f30d1fcac14b02ec600ed771'>Jon S</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-04 5:20 pm</div>
				                <div>I would rename the article along the lines of &quot;Error Pop Up When Trying to Send/Receive Messages&quot; and messages  cannot be sent.  I kept looking in the Sent folder and other folders, but could not find my goofed up message.<br />
The Outbox folder is so far down the list of folders that I never thought to look for it. Once your article reminded me to look at that, I was able to easily fix my problem. <br />
<br />
You could point out that it is not necessary to resend all messages - just fixing the bad message as noted in the error message is all that it takes - hit send/receive again and all blocked messages that are ok will go. It takes only one bad message to stop all subsequent messages from being sent.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19169);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-31146'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/f5c2a540744284333895ee229193f8b4?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/f5c2a540744284333895ee229193f8b4'>Lucas</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-11 7:04 am</div>
				                <div><p>Hello,</p>
<p>I am using Windows Live Mail (Version 2012 (Build 16.4.3528.0331)) and I have messages stuck in my outbox. But the people receive the e-mails (I am not sure everyone receives them).</p>
<p>Furthermore some e-mails goes directly to send items and others are stuck in the outbox.&nbsp;</p>
<p>What can I do? Can someone helps me?</p>
<p>Cheers, Lucas</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31146);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
