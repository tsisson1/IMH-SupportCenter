<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:69410:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/cpanel-account-management/changing-language" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-02-03T20:39:08-08:00" />
  <meta name="keywords" content="cpanel change language" />
  <meta name="author" content="John-Paul Briones" />
  <meta name="description" content="This tutorial walks you through changing the language your cPanel displays in." />
  <title>Changing Your cPanel Display Language - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/cpanel-account-management/changing-language" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:3e3d406a4d91221638fc8fa2913e083a -->
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Changing Your cPanel Display Language</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Changing Your cPanel Display Language									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>7,546</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Mar 7, 2013'><span style='color:#606060;'>Published:</span> Feb 3, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<div>This guide will show you how to <strong>change your language preference in cPanel</strong>.</div>
<div><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/cpanel/language/arabic-cpanel.png"><img src="//cdn.inmotionhosting.com/support/images/stories/cpanel/language/arabic-cpanel.png" alt="cpanel displayed in a different language"  style="margin: 15px; float: right;" /></a>When you first access your cPanel it will be in English, but there may be times when you want to change this to a different language. As an example your designer may prefer the cPanel in German, or Chinese.</div>
<div>&nbsp;</div>

<div style="clear: both;">
<h1>How to Change Your Language:</h1>
<ol class="article_list">
  <li><a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">Access your cPanel</a>.</li>
<li>In the <em>Preference</em> section, click <strong>Change Language</strong>.</li>
<li>To the left of the <em>Change</em> button, click the drop-down menu, and select the language you want to change to.<br />Below is a list of languages cPanel can be displayed in:<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/cpanel/language/language-dropdown.png"><img src="//cdn.inmotionhosting.com/support/images/stories/cpanel/language/language-dropdown.png" alt="view of the available languages in cpanel"  style="margin: 15px; float: right;" /></a>
...
<li>Save your settings by clicking the <strong>Change</strong> button.<br /><br /></li>
</ol>
<div>&nbsp;</div>
<div>Congratulations, now you know how to modify your language preference in cPanel!</div>
<div>&nbsp;</div>
</div> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/cpanel-account-management/changing-language&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/cpanel-account-management/changing-language'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MzUmaWQ9NjE3JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="8dedf456513f266a5ce6dfaea9f5f4ea" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/04e837deca8be8373d767e2d0d4e3482?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/04e837deca8be8373d767e2d0d4e3482'>St</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-07 6:08 pm</div>
				                <div><p>I want to find out how to do the same in WHM.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29642);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-07 7:14 pm</div>
				                <div>Hello St,<br />
<br />
Thank you for contacting us. Here are the steps for changing your default cPanel language from WHM: <ol><li><a href="http://www.inmotionhosting.com/support/edu/whm/creating-and-managing-accounts/log-into-whm">Login to your WHM</a>.</li><li>Click <strong>Modify Account</strong> in the <em>Account Functions</em> section</li><li>Click the account you want to change the language for, then click the <strong>Modify</strong> button</li><li>Next to <em>Default Locale</em> choose your preferred language, then click the <strong>Save</strong> button.</li></ol>If you have any further questions, feel free to post them below.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29643);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-09 11:03 am</div>
				                <div><p>No, I mean WHM interface language.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29679);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-11 4:00 pm</div>
				                <div>Hello ST,<br />
<br />
To set the default language in your WHM, go to "Tweak Settings". Then on the "All" tab, scroll down to "Server Locale" and you will see a dropdown. There you can select your langauge.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29718);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
