<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49208:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/prestashop-15/catagory-images-pixelated-1609" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, Thank you for your question. Here is a link to a similar question about Changing Product Image Size On Category Pages in the Official Prestashop ..." />
  <title>catagory images pixelated 1.6.0.9 | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/prestashop-15/catagory-images-pixelated-1609" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:dabb15db859baaa4ee6bd4fb1a23fd99 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>catagory images pixelated 1.6.0.9</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2014-08-06 3:33 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>96</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Upgraded Presta to 1.6.0.9 and category images are expanding too big and becoming pixelated.  Tried to increase image size but effect.  Did run thumbnail refresh.  Is there a way to constrain the size of the image?</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_5398' id='upvote_answer_5398' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='5398' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_5398').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_5398' id='downvote_answer_5398' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='5398' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_5398').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello, <br />
<br />
Thank you for your question. Here is a link to a similar question about <a href="http://www.prestashop.com/forums/topic/266026-solved-changing-product-image-size-on-category-pages/" target="_blank" >Changing Product Image Size On Category Pages</a> in the Official Prestashop support forums.<br />
<br />
We are happy to help you further, but will need some additional information. Can you provide a link to the error? Are you using any 3rd party themes, or addons? Which ones?<br />
<br />
...
-John-Paul
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_5398').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_5398' id='form_comment_on_answer_5398' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/prestashop-15/catagory-images-pixelated-1609&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/prestashop-15/catagory-images-pixelated-1609'></div>
<script type='text/javascript'>
  (function() {
