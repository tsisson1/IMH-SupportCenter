<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:43349:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/dokuwiki/working-with-menus" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="keywords" content="menu menus dokuwiki doku wiki add adding inserting plugin" />
  <meta name="description" content="This course will explain how to add different menu functions to your DokuWiki site." />
  <title>201: Working with menus in DokuWiki | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/dokuwiki/working-with-menus" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:e4054c9542b3fabf13b182349b02a685 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '123.231.64.130']);
...
<div class='page-header'>
	<h1>201: Working with menus in DokuWiki</h1>
</div>
<div class='section_listing'>
	<h1>Adding menu functionality to DokuWiki</h1>
<p>Customizing the menus in DokuWiki is a difficult task. DokuWiki does not have any menu editing features within the administrative section of the site.&nbsp; Also, menus can vary in construction depending on which template you are using. In these tutorials, we will show you various methods availble for creating menus for your DokuWiki site.</p>
	<table>
	<tr><td colspan='3'><h2>Custom coded menu</h2><div>How to code a custom menu in the template.</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 1:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/dokuwiki/working-with-menus/custom-css-menu'>Inserting a custom CSS menu in DokuWiki</a>
					<div>DokuWiki has default links at the top right for their menu. This tutorial will explain how to add your own custom menu to your DokuWiki theme.</div>
					<div class='smallgrey'>Hits: 3,773</div>
				</td>
			</tr>
		<tr><td colspan='3' style='padding-top:20px;'><h2>Menu Plugins</h2><div>menu plugins can be used to create pleasing navigation.</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 2:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/dokuwiki/working-with-menus/custom-menu-plugin'>How to use the menu plugin in DokuWiki</a>
					<div>This will teach you how to add a menu to your DokuWiki pages using the menu plugin.</div>
					<div class='smallgrey'>Hits: 4,625</div>
				</td>
			</tr>
			</table>
</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMjQmaWQ9MzI0JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="2a8c0f6c16c198e0302be14b10d31112" value="1" />	</div>
	</form>
<!-- <br />
