<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:69117:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.net/support/edu/cpanel/softaculous/softaculous-update-rollback" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-07-29T12:15:33-07:00" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Learn how to use the AutoUpdate and Rollback features in Softaculous." />
  <title>Softaculous Auto Upgrade and Rollback - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/cpanel/softaculous/softaculous-update-rollback" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:63655ac5447477681bb2cb95a5a5f5f7 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '207.46.13.12']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Softaculous Auto Upgrade and Rollback									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>797</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jun 13, 2014'><span style='color:#606060;'>Published:</span> Jul 29, 2014</div>
  ...
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('update');">Enabling Auto-update</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('rollback');">Performing a rollback</button>
 </div>
...
<a name="update"></a>
<h2>Setting the Auto Upgrade for Softaculous Programs</h2>
<h3>List of Softaculous programs with Auto Upgrade feature</h3>
<p>Not all programs in the Softaculous suite have this feature yet. Below is a list of the ones we have found to have the auto-update option.</p>
<ul>    
<li>Adminer</li>
<li>Chive</li>
<li>Collabtive</li>
...
<li>PmWiki</li>
<li>ProjectSend</li>
<li>Prosmotube Express</li>
<li>PyroCMS</li>
<li>qdPM</li>
<li>selfoss</li>
<li>Storytlr</li>
<li>TinyWebGallery</li>
<li>Vanilla</li>
<li>WordPress</li>
</ul>    


<h3>Enabling Auto Upgrade feature for new installations</h3>

<ol class="article_list">
  <li><a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">Log into your cPanel</a><div style="clear:both;"></div></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/softaculous/auto-upgrade/1-click-softaculous-icon.png"><img  style="float:right; margin:0px 0px 15px 15px;" alt="click the softaculous icon" src="//cdn.inmotionhosting.com/support/images/stories/edu/softaculous/auto-upgrade/1-click-softaculous-icon.png" title="Click here to view the larger image" width="200" /></a>Click on the <strong>Softaculous</strong> icon located in the <em>Software/Services</em> category.<div style="clear:both;"></div></li>
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/softaculous/auto-upgrade/2-install-wp.png"><img  style="float:right; margin:0px 0px 15px 15px;" alt="instaall WordPress" src="//cdn.inmotionhosting.com/support/images/stories/edu/softaculous/auto-upgrade/2-install-wp.png" title="Click here to view the larger image" width="200" /></a>Select the program you wish to install. In this example, we will select the <em>WordPress</em> application.<div style="clear:both;"></div></li>
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/softaculous/auto-upgrade/3-enable-auto-upgrade.png"><img  style="float:right; margin:0px 0px 15px 15px;" alt="Enable the Auto Upgrade feature" src="//cdn.inmotionhosting.com/support/images/stories/edu/softaculous/auto-upgrade/3-enable-auto-upgrade.png" title="Click here to view the larger image" width="200" /></a>While filling in the appropriate details for the installation, ensure you select the checkbox labeled <strong>Auto Upgrade</strong> which is located under the <strong>Advanced Options</strong> section. <div style="clear:both;"></div></li>
<li>Click on the <strong>Install</strong> button. This will install the program with the Auto Upgarde feature enabled.<div style="clear:both;"></div></li>
</ol>


<h3>Enabling Auto Upgrade feature for existing installations</h3>

<ol class="article_list">
<li><a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">Log into your cPanel</a><div style="clear:both;"></div></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/softaculous/auto-upgrade/1-click-softaculous-icon.png"><img  style="float:right; margin:0px 0px 15px 15px;" alt="click the softaculous icon" src="//cdn.inmotionhosting.com/support/images/stories/edu/softaculous/auto-upgrade/1-click-softaculous-icon.png" title="Click here to view the larger image" width="200" /></a>Locate the <em>Software/Services</em> category and click on the <strong>Softaculous</strong> icon.<div style="clear:both;"></div></li>
  
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/softaculous/auto-upgrade/4-show-all-installations.png"><img  style="float:right; margin:0px 0px 15px 15px;" alt="display all current installations" src="//cdn.inmotionhosting.com/support/images/stories/edu/softaculous/auto-upgrade/4-show-all-installations.png" title="Click here to view the larger image" width="200" /></a>Look to the upper right corner qnd click on the <strong>All Installations</strong> or <strong>Application Installs</strong> icon (depending on whether you are on shared or VPS/Dedicated plan).<div style="clear:both;"></div></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/softaculous/auto-upgrade/5-click-edit-button.png"><img  style="float:right; margin:0px 0px 15px 15px;" alt="select the edit icon" src="//cdn.inmotionhosting.com/support/images/stories/edu/softaculous/auto-upgrade/5-click-edit-button.png" title="Click here to view the larger image" width="200" /></a>You will see a list of currently installed applications. Find the one you want to enable the <em>Auto Upgrade</em> for and click on the <strong>Edit Details</strong> icon. It looks like a piece of paper with a pencil on it.<div style="clear:both;"></div></li>
<li>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/softaculous/auto-upgrade/6-edit-details.png"><img  style="float:right; margin:0px 0px 15px 15px;" alt="select auto upgrade" src="//cdn.inmotionhosting.com/support/images/stories/edu/softaculous/auto-upgrade/6-edit-details.png" title="Click here to view the larger image" width="200" /></a>This brings you to a screen that has several settings you can change for the installation. One of them is the <strong>Auto Upgrade</strong> checkbox. Check this to enable it.<div style="clear:both;"></div></li>
<li>After enabling the feature, click on the <strong>Edit Installation Details</strong> button. The feature will now be enabled.<div style="clear:both;"></div></li>
</ol>

<h3>How often will the program upgrade?</h3>
<p>Softaculous has a automatic script, also known as a <a href="/support/edu/cpanel/301-run-cron-job">Cron job</a>, that runs once every 24 hours. Among other things, such as automated backups (if enabled) this script runs the <em>Auto Upgrade</em> check so if any new updates are available, it will upgrade the program at that time.</p>

<a name="rollback"></a>
<h2>Performing a Rollback</h2>
<p>In a perfect world, every update would go without a hitch. However, things occasionally go wrong when updates run. Thankfully Softaculous makes a backup of your site just in case something goes awry. You can then perform a rollback and revert to the previously working version. Below are the instructions on how to do that.</p>

<ol class="article_list">
  <li><a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">Log into your cPanel dashboard</a>.<div style="clear:both;"></div></li>
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/softaculous/auto-update-rollback/1-select-softaculous.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/softaculous/auto-update-rollback/1-select-softaculous.png" title="Click here to view the larger image" width="200" /></a>Find the <em>Software/Services</em> category and click on the <strong>Softaculous</strong> icon.<div style="clear:both;"></div></li>
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/softaculous/auto-update-rollback/4-select-backup-restore.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/softaculous/auto-update-rollback/4-select-backup-restore.png" title="Click here to view the larger image" width="200" /></a>From the main <em>Softaculous</em> page, look at the icons in the upper right corner. Click on the <strong>Backup/Restore</strong> link.<div style="clear:both;"></div></li>
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/softaculous/auto-update-rollback/5-click-restore.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/softaculous/auto-update-rollback/5-click-restore.png" title="Click here to view the larger image" width="200" /></a>To perform the restore, click on the <strong>Restore</strong> arrow. It is the light blue arrow pointing sideways.<div style="clear:both;"></div></li>
  <li>A new page appears asking if you want to restore the database and the files. Keep both checkboxes selected and click on the <strong>Restore Installation</strong> button.<div style="clear:both;"></div></li>
</ol>
<p>After a few moments your installation should be restored. Below is a before and after displaying how the restore rolled back my WordPress version.</p>
...
<tr>
  <td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/softaculous/auto-update-rollback/before.png"><img   style="" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/softaculous/auto-update-rollback/before.png" title="Click here to view the larger image" width="100%" /></a></td>
  <td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/softaculous/auto-update-rollback/after.png"><img   style="" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/softaculous/auto-update-rollback/after.png" title="Click here to view the larger image" width="100%" /></a></td>
</tr>
</table> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 9: Softaculous Auto Upgrade and Rollback</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 8: <a href='/support/edu/cpanel/softaculous/enable-auto-upgrade'>How to enable Auto Upgrade feature in Softaculous</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 10: <a href='/support/edu/cpanel/softaculous/create-backup'>How to Back up your Website with Softaculous</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.net/support/edu/cpanel/softaculous/softaculous-update-rollback&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.net/support/edu/cpanel/softaculous/softaculous-update-rollback'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNTcmaWQ9MzMwNyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="69b5738aff57e224383e98716b8be615" value="1" />	</div>
	</form>
<!-- <br />
