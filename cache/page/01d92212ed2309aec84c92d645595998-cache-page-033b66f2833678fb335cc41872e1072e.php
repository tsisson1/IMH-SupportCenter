<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:76031:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/website-transfers/migrating-opencart-to-woocommerce" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-04-22T17:32:25-07:00" />
  <meta name="author" content="Jeff Matson" />
  <meta name="description" content="Migrating your website from OpenCart to WooCommerce could be a hard process, but within our article, we'll show you how to migrate your site using Cart2Cart." />
  <title>Migrating OpenCart 1.5 to WooCommerce - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/website-transfers/migrating-opencart-to-woocommerce" rel="canonical" />
...
<script>
  ...
  ga('send', 'pageview');
	...
	<!-- cid:12e9a0b817965daa1e3811a0cc12dd21 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '80.74.244.18']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Migrating OpenCart 1.5 to WooCommerce									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>3,439</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Apr 21, 2014'><span style='color:#606060;'>Published:</span> Apr 22, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Migrating from one shopping cart to another can sometimes be quite a difficult process at times, but in this article, we will be showing you how to migrate from OpenCart to WooCommerce using Cart2Cart in just a few simple steps.  Depending on the amount of content that you need to migrate, this is a paid service offered by Cart2Cart.</p>
<ol class="article_list">
    <li><p>You will need to have your target installation ready to go.  If you do not already have WordPress and WooCommerce installed, you may follow our articles on <a href="http://www.inmotionhosting.com/support/edu/wordpress/wordpress-introduction/install-wordpress-using-softaculous">installing WordPress</a>, then the article on <a href="http://www.inmotionhosting.com/support/website/woocommerce/how-to-install-the-woocommerce-wordpress-plugin">installing WooCommerce</a>.</p></li>
  <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website-transfers/opencart-to-woocommerce-11.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website-transfers/opencart-to-woocommerce-11.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>Next, you will need to visit the <a href="http://www.shopping-cart-migration.com/" target="_blank">Cart2Cart website</a>.  On the Cart2Cart site, select <strong>OpenCart</strong> in the first dropdown, and <strong>WooCommerce</strong> in the second dropdown.  Once both are selected, click <strong>Start Free Demo</strong>.</p></li>
    <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website-transfers/opencart-to-woocommerce-12.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website-transfers/opencart-to-woocommerce-12.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>As you clicked the button on the previous page, you'll now be taken to the account registration page.  Enter in your email, name, and password into the required fields, then select the checkbox stating that you agree to the terms of service, and click <strong>Register Now</strong>.</p></li>
    <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website-transfers/opencart-to-woocommerce-1.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website-transfers/opencart-to-woocommerce-1.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>Once your account is registered, you will be taken to the migrations page.  To start your first migration, click the green button that says <strong>Start Migration Now!</strong>.</p></li>
    <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website-transfers/opencart-to-woocommerce-2.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website-transfers/opencart-to-woocommerce-2.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>You should now be on the <em>Source Cart Setup</em> page.  On this page, there are a few settings to set:</p>
        <p><strong>Source Cart Type</strong>: In this dropdown, select <strong>OpenCart</strong>.</p>
        <p><strong>Source Cart URL</strong>: In this field, enter the URL of your site that is currently running OpenCart.</p>
        <p>Before you proceed to the next step, you will also need to set up the Cart2Cart Connection Bridge.  To do so, click the link labeled <strong>Download</strong> and save the zip file.  Inside this zip file, there is a folder labeled <em>bridge2cart</em>.  You will need to upload this full folder to both your OpenCart and WooCommerce root directories <a href="http://www.inmotionhosting.com/support/website/ftp/getting-started-guide">using FTP</a>.</p>
    </li>
    <li><p>Once all of your settings for the source cart are defined and the connection bridge is installed, click the <strong>Proceed to Next Step</strong> button.</p></li>
    <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website-transfers/opencart-to-woocommerce-3.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website-transfers/opencart-to-woocommerce-3.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>You will now be presented with the <em>Target Cart Setup</em> page.  On this page, enter the details for your WooCommerce cart and click on <strong>Proceed to Next Step.</strong></p></li>
    <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website-transfers/opencart-to-woocommerce-4.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website-transfers/opencart-to-woocommerce-4.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>On this next page, you will be selecting the specific data that you want migrated from OpenCart to WooCommerce.  There is also an <em>Additional Options</em> section that will allow you to migrate additional items such as your permalinks, or additional images that may be within your product descriptions.  Once complete, click the button labeled <strong>Proceed to Next Step</strong>.</p></li>
    <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website-transfers/opencart-to-woocommerce-5.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website-transfers/opencart-to-woocommerce-5.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>Next, you will need to map your currencies from OpenCart to WooCommerce.  On the left side, you will see currencies from your OpenCart site that you are migrating from, and on the right you will be able to select the currencies that are in use on your WooCommerce site that you are migrating to.  Select your currency and click <strong>Proceed to Next Step</strong>.</p></li>
    <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website-transfers/opencart-to-woocommerce-6.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website-transfers/opencart-to-woocommerce-6.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>Just as we mapped the currencies in the previous step, we will now need to map the order status of existing orders.  To do so, review the order statuses that are in the list to the left and use the dropdown boxes to select the new status that they will be on your WooCommerce site once the migration has finished.  Once all of your order statuses are set, click the button labeled <strong>Proceed to Next Step</strong>.</p></li>
    <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website-transfers/opencart-to-woocommerce-7.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website-transfers/opencart-to-woocommerce-7.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>Your OpenCart site is almost ready to migrate to WooCommerce. You should now be on the <strong>Demo Migration</strong> page in which you will be presented with the option to continue with the demo migration, or purchase a full migration of all information.  As you can see, the demo migration is made solely for demonstration purposes and you will most likely need a full migration service.  If you want to start the demo migration to test the Cart2Cart service and purchase the full migration at a later time, click the <strong>Start Demo Migration</strong> button.  If you want to migrate the entire OpenCart installation to WooCommerce now, select the checkbox labeled <strong>Skip Demo Migration</strong> checkbox, and click <strong>Skip Demo Migration</strong>.</p></li>
    <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website-transfers/opencart-to-woocommerce-8.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website-transfers/opencart-to-woocommerce-8.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>Next, you will be asked if you want migration insurance.  The migration insurance option allows you to complete the migration again at a later date if you need to.  On this page, you may either select the migration insurance that you want, or skip the step, then proceed to the next step.</p></li>
    <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website-transfers/opencart-to-woocommerce-9.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website-transfers/opencart-to-woocommerce-9.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>If you are only doing a demo migration, the migration will begin now.  If you are doing a full migration, you will confirm your order on this step.  Simply confirm your purchase of your migration package, and continue on to the next step.</p></li>
    <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website-transfers/opencart-to-woocommerce-10.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website-transfers/opencart-to-woocommerce-10.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>If you purchased the full migration, your site is now being migrated from OpenCart to WooCommerce.  Be sure not to make any changes to the site while the migration is being processed.  Once the migration has completed, be sure to log into your WordPress/WooCommerce site to ensure that everything was migrated successfully.</p></li>
</ol> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/website-transfers/migrating-opencart-to-woocommerce&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/website-transfers/migrating-opencart-to-woocommerce'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NDMmaWQ9MzIwNyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="c7bae9878214ce231dcd665c1daa440d" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/83f8f7e1713f9c3cbfbe4414a2504c76?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/83f8f7e1713f9c3cbfbe4414a2504c76'>Rob Healey</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-28 9:21 pm</div>
				                <div><p>Thanks for the excellent info. I am held up with one problem, cart2cart say the source and target urls must be different, but I need to maintain the same URL because it is well established,&nbsp; bookmarks, SEO, Adwords etc.</p>
<p>I have created an account on a different server, but of course only the source site is visible until I change thee DNS.What's the best way to handle this?Rob</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14455);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-29 10:32 am</div>
				                <div>Hello Rob,<br />
<br />
You can always set up a temporary subfolder and then switch it back to the main once you have finished the conversion. Ex: example.com is the current cart, set up example.com/shop for the conversion. Once done, move the example.com/shop to example.com once you have cleared out the original store from that domain.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14477);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-30159'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/e9769da89c52c85a8b1ad84d556a70b8?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/e9769da89c52c85a8b1ad84d556a70b8'>Stefano Masciocchi</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-27 12:49 pm</div>
				                <div><p>Hello and thanks for the infos, just was I hoped to find.</p>
<p>This article's title describes exactly my upcoming project, with a kind of big store to be imported into a brand new Wordpress structure.My only concern is: considering that items should be somewhere around 4,000, will I fall&nbsp;short in the long run if I opt for WooCommerce rather than, say, Magento?</p>
<p>What your experience would say about it?</p>
<p>Thank you again,Stefano</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30159);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-28 7:47 am</div>
				                <div>Hello Stefano,<br />
<br />
It's a great question and problem one of opinion alone.  Using Magento or Woocommerce for any ecommerce solution will have varying degrees of learning curve depending on the user.  Based on what I have read, Magento is excellent for large ecommerce stores.  WooCommerce is great too, but it 's not a complete ecommerce solution out of the box and may be more suitable for smaller ecommerce stores.  Don't get me wrong, WooCommerce is a fantastic solution, but some functionality may need to be  purchased via added extensions.  There are many opinions from people who create the stores for a living.  Check out this <a href="https://www.watermelonwebworks.com/magento-vs-woocommerce/" rel="nofollow" target="_blank">one</a> for a pretty well rounded opinion.<br />
<br />
I hope that helps to answer your question!  If you require further assistance, please let us know!<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30179);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
