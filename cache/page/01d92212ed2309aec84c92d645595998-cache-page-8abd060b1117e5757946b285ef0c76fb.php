<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:87807:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/htaccess/what-is-the-htaccess-file-and-what-do-i-use-it-for" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-07-17T19:26:27-07:00" />
  <meta name="keywords" content="htaccess .htaccess file server configuration" />
  <meta name="author" content="Tim Sisson" />
  <meta name="description" content="Learn what an .htaccess file is and what you can do with it." />
  <title>What is the .htaccess file and what do I use it for? - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/htaccess/what-is-the-htaccess-file-and-what-do-i-use-it-for" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:eccaf08cec8ae256d1ec263a84a11137 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															What is the .htaccess file and what do I use it for?									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>32,916</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Nov 3, 2011'><span style='color:#606060;'>Published:</span> Jul 17, 2015</div>
...
<button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('what');">What can a .htaccess file do?</button>
<button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('troubleshooting');">Troubleshooting .htaccess</button>
</div>

<p>Htaccess files are hidden plain text files that are on the server to help control how your visitors interact with your website. The htaccess file is also used to block specific traffic from being able to view your website. If you look for your .htaccess file you'll see that there's no filename. The extension is .htaccess which tells the server what type of file it is. In cPanel you can see if you have a current .htaccess file using file manager but you will need to make sure you have selected to view hidden files. If you are not familiar with <a href="/support/edu/cpanel/cpanel-file-manager/using-file-manager-in-cpanel">using file manager</a> please read our article. &nbsp;To view hidden files in file manager, select the '<strong>file manager</strong>' icon in cPanel and make sure the box is checked next to '<strong>Show Hidden Files.'</strong>&nbsp;Then click '<strong>OK</strong>' and you will be able to view hidden files.&nbsp;</p>

<a name="what"></a>
<h2>What can you do with a .htaccess file?</h2>
<p>You might have a private area of your website you wish to keep password protected. This password protection is actually set up in the .htaccess file. Most of the functions of the htaccess file, you do not have to concern yourself with as they will be automatically written through cPanel. This is the case of <a href="/support/website/cpanel/how-do-i-password-protect-a-directory-in-my-control-panel-cpanel">password protecting directories</a>. While you set it up in cPanel, it actually writes a directive to your htaccess file.&nbsp;</p>
<p>Other functions of the htaccess file include, <a href="/support/website/cpanel/how-do-i-enable-hotlink-protection-in-my-control-panel-cpanel">prohibiting hotlinks</a>, rewriting URLs, <a href="/support/website/htaccess/htaccess-change-index-page">setting default pages</a>, creating redirects, reconfiguring account settings, and much more. It's really important to realize how the htaccess file can affect your entire account. Changing something in the htaccess file can alter how your website functions so it's really important BEFORE making changes to your htaccess to backup your current htaccess file.</p>

<a name="troubleshooting"></a>
<h2>Troubleshooting Errors caused by the .htaccess File</h2>
<p>If you are getting errors on your website, the .htaccess file can often be the culprit.</p>
<ul><li>This is easily tested by renaming your current htaccess file. Often, during troubleshooting I'll simply rename the .htaccess to .htaccess.old and now I'll reload the website. If the site loads I then know the issue resides in my configuration of the .htaccess file. If it does not fix the issue I was having, I'll rename the htaccess by removing the .old I added to the end. That way, it won't affect my website after I resolve the issue.</li>
  <li>If you are not seeing a change in your PHP settings, you may have to make your php.ini file affect all child folders as well. This is referred to as making the file "<strong>recursive</strong>". In this case, see our full guide: <a href="/support/website/php/recursive-php-ini">How can I make my php.ini file recursive</a>.</li> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/htaccess/what-is-the-htaccess-file-and-what-do-i-use-it-for&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/htaccess/what-is-the-htaccess-file-and-what-do-i-use-it-for'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MTMmaWQ9Mjg1JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="6fe3d2b35c1f8990fc29162b979920ba" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/domain-names/stop-subdomain-from-redirecting?tsrc=rsbraq'>Stop Subdomain From Redirecting</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/domain-names/i-made-a-primary-domain-change-and-now-cannot-get-access-to-my-site?tsrc=rsbraq'>Redirect after primary domain change</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/joomla/i-cant-able-to-load-my-site?tsrc=rsbraq'>I am not able to load my site</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/phpbb/htacess-working-on-1server-but-not-on-another?tsrc=rsbraq'>.htacess working on 1 server but not on another</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/general-server-setup/host-a-3rd-party-website-from-my-account?tsrc=rsbraq'>Host a 3rd party website from my account</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/how-to/i-want-to-show-customized-url-on-address-bar?tsrc=rsbraq'>I want to show customized url on address bar</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/299899108c5b68cf779f1542b4ab478f?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/299899108c5b68cf779f1542b4ab478f'>biruhtesfa tadese</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-11 11:32 am</div>
				                <div><p>I am having question on .htaccess file.&nbsp; i accidentally override with another file content then my website come with errror, then i found the file and removed all the content inside .htaccess file then it started working fine but my question is when i deleted the content if i also deleted important document, pls tell me if there is some content deleted.</p>
<p>thank you</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13878);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-11 11:45 am</div>
				                <div>Hello biruhtesfa,<br />
<br />
Thank you for your question. There is no way to tell if the content you deleted in the <strong>.htaccess</strong> file is important.<br />
<br />
This is because websites can be coded many ways.<br />
<br />
I recommend testing all aspects of your website (shopping carts, forms, scripts, etc.) to make sure it is still functioning after editing your <strong>.htaccess</strong> file.<br />
<br />
If you have any further questions, feel free to post them below.<br />
Thank you,<br />
<br />
-John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13881);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-17447'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/fcf6ed2982103aa1d4f98264e552813a?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/fcf6ed2982103aa1d4f98264e552813a'>yusuf</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-15 8:49 am</div>
				                <div><p>if i delete .htaccess by mistake what must i do</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17447);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-17 9:13 am</div>
				                <div>Hello yusuf,<br />
<br />
Thank you for your question. If you deleted your .htaccess file, you can just <a href="http://www.inmotionhosting.com/support/website/file-manager/create-new-file">create a new file</a> and name it: <strong>.htaccess</strong><br />
<br />
Then add your rules back as needed.<br />
<br />
If you have any further questions, feel free to post them below.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17472);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-19091'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/f746534e70a5814ba89db17bbdde7016?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/f746534e70a5814ba89db17bbdde7016'>remya</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-02 1:58 am</div>
				                <div><p>I am unable to find .htaccess file in c9ppanel</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19091);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-02 10:09 am</div>
				                <div>Hello remya,<br />
<br />
The .htaccess file is hidden by default (hence the . at the beginning of the file name) which can be viewed by following the steps in <a href="http://www.inmotionhosting.com/support/website/file-manager/show-hidden-files-in-file-manager">this guide</a>. Also you may not have a .htaccess file as it is not a default file pre-loaded to your account.<br />
<br />
Kindest Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19100);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-20306'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/5488568941519d0d2fe191cc1094707e?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/5488568941519d0d2fe191cc1094707e'>Sharon</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-02 8:17 pm</div>
				                <div><p>how does the .htaccess file and CPanel interact.</p>
<p>it appears .htaccess updates CPanel?</p>
<p>I do need an .htaccess for redirection of some files ; need to clarify "what goes where?"</p>
<p>can you advise?</p>
<p>the</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20306);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-03 9:41 am</div>
				                <div>Simply put, the .htaccess file defines extra options for the Apache web server.  For more information on redirects, you could check our article on &lt;a href=&quot;http://www.inmotionhosting.com/support/website/redirects/setting-up-a-301-permanent-redirect-via-htaccess&quot;&gt;301 redirects with .htaccess&lt;/a&gt;.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20317);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-28473'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/686ae8e2cab423a20c84c182be6dbd59?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/686ae8e2cab423a20c84c182be6dbd59'>teresa</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-16 4:24 pm</div>
				                <div><p>I ever since the .htaaccess was changed, all the installed pluggins, mystile, wordpress are dissappeared. Is there a way to get them back without any re-installation?</p>
<p>Please advise?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28473);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-16 4:42 pm</div>
				                <div>Hello Teresa,<br />
<br />
Did you rename the .htaccess file? If so, rename it back as it should contain the information to make those things work.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28476);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-32211'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/0c03a7024b093b5df75d9661e0bdf832?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/0c03a7024b093b5df75d9661e0bdf832'>Manivannan</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-25 5:32 am</div>
				                <div><p>Hi,</p>
<p>I can able to redirect URL using .htaccess file but i cant mask server IP address with domain name.</p>
<p>http://mydomain.com &nbsp;is pointed to http://xxx.xxx.xxx.x:8080/abc.html &nbsp;(ip address) now i need to redrect /xyz/home.html to http://mydomain.com/xyz/home.html, i was able to redirect but i get redirected URL http://xxx.xxx.xxx.x:8080/xyz/home.html but i need to mask that ip address to http://mydomainname.com</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32211);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-25 1:56 pm</div>
				                <div>For security purposes, we do not allow masking. The closest you can get is to add a parked domain. Specifically creating a parked domain for the primary domain will have sort of a masking effect.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32228);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
