<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:51799:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/whm" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="keywords" content="%default%" />
  <meta name="description" content="Web Host Manager Category" />
  <title>Web Host Manager | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/whm" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:2a904f77bf1b50daa95dda9e72b480fd -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '96.81.95.26']);
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Web Host Manager</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	...
	<div class='item-page'>
		<div class='page-header'>
			<h1>Web Host Manager Education Channel</h1>
		</div>
	
<div style='clear:both;'></div>

<div class='edu_class_listing white_box'>
	<h2>Web Host Manager Tutorials</h2>
	<ul style='float:left; width:300px; margin-right:20px;'>
<li  ><a href='/support/edu/whm/creating-and-managing-accounts'>102: Creating and Managing Accounts with WHM</a></li>
<li  ><a href='/support/edu/whm/reseller-access'>103: Managing Reseller Access within WHM</a></li>
<li  ><a href='/support/edu/whm/using-whm'>104: Managing Your Dedicated or VPS Server through WHM</a></li></ul><div style='clear:both;'></div></div>
...
<div class='edu_most_popular white_box'>
	<h2>Most Popular Articles</h2>
		<div style='width:300px; height:75px; float:left; margin-right:20px;'>
						...
						<div style='width:300px; height:75px; float:left; margin-right:20px;'>
							<a href='/support/edu/whm/creating-and-managing-accounts/modify-an-account'>How to modify a cPanel account within WHM</a>
							<div class='smallgrey'>Hits: 11,501</div>
						</div>
						<div style='width:300px; height:75px; float:left; margin-right:20px;'>
							<a href='/support/edu/whm/creating-and-managing-accounts/intro-to-branding-cpanel'>An Introduction to Branding cPanel for your users</a>
							<div class='smallgrey'>Hits: 5,148</div>
						</div>
						<div style='clear:both;'></div>
</div>
...
<form action="http://www.inmotionhosting.com/support/edu/whm" method="post" name="adminForm" id="adminForm" class="form-inline">
	...
	<option value="0">All</option>
		...
		<h2>Web Host Manager - Advanced Tutorials</h2>
		<table style='margin-top:20px;'>
			...
			<tr>
				...
				<td valign='top' style='padding-bottom:15px;'>
					<div><a href='/support/edu/whm/301-upgrade-apache-using-easyapache'>301: Upgrade Apache using EasyApache</a></div>
					<div>In this article we'll discuss how you can upgrade your server's version of the Apache web server using the EasyApache script in WHM.</div>
					<div class='smallgrey'>
			...
			<tr>
				<td valign='top' style='padding:6px 15px 0px 0px;'><img src='https://lh6.googleusercontent.com/-71IjFLXWAbo/AAAAAAAAAAI/AAAAAAAAZoM/rUwpCEjduSw/photo.jpg?sz=50' class='sc_rc' style='width:55px;' /></td>
				<td valign='top' style='padding-bottom:15px;'>
					<div><a href='/support/edu/whm/302-upgrade-php-using-easyapache'>302: Upgrade PHP using EasyApache</a></div>
					<div>In this article we'll discuss how you can upgrade your server's version of PHP using the EasyApache script in WHM.</div>
					<div class='smallgrey'>
						Written by Jacob Nicholson<br />
						Hits: 15,803
					</div>
			...
			<tr>
				<td valign='top' style='padding:6px 15px 0px 0px;'><img src='https://lh6.googleusercontent.com/-71IjFLXWAbo/AAAAAAAAAAI/AAAAAAAAZoM/rUwpCEjduSw/photo.jpg?sz=50' class='sc_rc' style='width:55px;' /></td>
				<td valign='top' style='padding-bottom:15px;'>
					<div><a href='/support/edu/whm/303-install-and-configure-clamav'>303: Install and configure ClamAV plugin for cPanel</a></div>
					<div>In this article we'll discuss how you can install and configure the ClamAV plugin for cPanel. ClamAV is a popular open source anti-virus scanner, and with the ClamAV plugin you can allow your cPanel users to scan their e-mails as well as scan their home directories for malicious files.</div>
					<div class='smallgrey'>
						Written by Jacob Nicholson<br />
						Hits: 15,162
					</div>
			...
			<tr>
				<td valign='top' style='padding:6px 15px 0px 0px;'><img src='https://lh6.googleusercontent.com/-71IjFLXWAbo/AAAAAAAAAAI/AAAAAAAAZoM/rUwpCEjduSw/photo.jpg?sz=50' class='sc_rc' style='width:55px;' /></td>
				<td valign='top' style='padding-bottom:15px;'>
					<div><a href='/support/edu/whm/304-install-munin-plugin-for-whm'>304: Install Munin plugin for WHM</a></div>
					<div>In this article we'll discuss installing the Munin plugin for cPanel/WHM. With the Munin Server Monitor plugin you can get a quick overview of what your server has been up to with reports on Apache, Disk Usage, Exim, MySQL, Network, Processes, and other System activities.</div>
					<div class='smallgrey'>
						Written by Jacob Nicholson<br />
						Hits: 10,564
					</div>
			...
			<tr>
				...
				<td valign='top' style='padding-bottom:15px;'>
					<div><a href='/support/edu/whm/305-change-mysql-root-pass'>305: How to change your MySQL root password in WebHost Manager  (WHM)</a></div>
					<div>In this WHM tutorial, we teach you how to change the MYSQL root password.</div>
					<div class='smallgrey'>
			...
			<tr>
				<td valign='top' style='padding:6px 15px 0px 0px;'><img src='https://lh3.googleusercontent.com/-et9qjCJVL08/AAAAAAAAAAI/AAAAAAAAAC4/C539ZYF2HNc/s90-p-rw-no/photo.jpg' class='sc_rc' style='width:55px;' /></td>
				<td valign='top' style='padding-bottom:15px;'>
					<div><a href='/support/edu/whm/306-configuring-advanced-dns'>306: How to enable or disable Advanced DNS editor in WHM.</a></div>
					<div>In this WHM article we explain how to configure the Advanced DNS editor for your cpanels via the WHM.</div>
					<div class='smallgrey'>
						Written by Scott Mitchell<br />
						Hits: 25,696
					</div>
			...
			<tr>
				<td valign='top' style='padding:6px 15px 0px 0px;'><img src='https://lh3.googleusercontent.com/-et9qjCJVL08/AAAAAAAAAAI/AAAAAAAAAC4/C539ZYF2HNc/s90-p-rw-no/photo.jpg' class='sc_rc' style='width:55px;' /></td>
				<td valign='top' style='padding-bottom:15px;'>
					<div><a href='/support/edu/whm/disable-spamcop-in-whm'>Disabling SpamCop RBL in WHM</a></div>
					<div>Tired of SpamCop blocking emails to your server? Learn how to disable it in your WHM.</div>
					<div class='smallgrey'>
						Written by Scott Mitchell<br />
						Hits: 259
					</div>
			...
			<tr>
				<td valign='top' style='padding:6px 15px 0px 0px;'><img src='https://lh3.googleusercontent.com/-et9qjCJVL08/AAAAAAAAAAI/AAAAAAAAAC4/C539ZYF2HNc/s90-p-rw-no/photo.jpg' class='sc_rc' style='width:55px;' /></td>
				<td valign='top' style='padding-bottom:15px;'>
					<div><a href='/support/edu/whm/change-default-whm-language'>How to Change the Language in Your WHM</a></div>
					<div></div>
					<div class='smallgrey'>
						Written by Scott Mitchell<br />
						Hits: 702
			...
			<tr>
				...
				<td valign='top' style='padding-bottom:15px;'>
					<div><a href='/support/edu/whm/delete-cpanel'>How to Delete a cPanel in WHM</a></div>
					<div>This is a walk-through tutorial on how to delete a cPanel via Web Host Manager (WHM).</div>
					<div class='smallgrey'>
			...
			<tr>
				<td valign='top' style='padding:6px 15px 0px 0px;'><img src='https://lh3.googleusercontent.com/-et9qjCJVL08/AAAAAAAAAAI/AAAAAAAAAC4/C539ZYF2HNc/s90-p-rw-no/photo.jpg' class='sc_rc' style='width:55px;' /></td>
				<td valign='top' style='padding-bottom:15px;'>
					<div><a href='/support/edu/whm/reset-cpanel-password'>How to Reset a cPanel password in WHM</a></div>
					<div>Need to know how to change the password for a cPanel? Learn how in this WHM tutorial!</div>
					<div class='smallgrey'>
						Written by Scott Mitchell<br />
						Hits: 2,210
					</div>
			...
			<tr>
				<td valign='top' style='padding:6px 15px 0px 0px;'><img src='https://lh3.googleusercontent.com/-et9qjCJVL08/AAAAAAAAAAI/AAAAAAAAAC4/C539ZYF2HNc/s90-p-rw-no/photo.jpg' class='sc_rc' style='width:55px;' /></td>
				<td valign='top' style='padding-bottom:15px;'>
					<div><a href='/support/edu/whm/change-max-user-connections'>How to change max_user_connections in VPS/Dedicated</a></div>
					<div>Need to increase the number of simultaneous users on your MySQL? We tell you how in this article.</div>
					<div class='smallgrey'>
						Written by Scott Mitchell<br />
						Hits: 2,066
					</div>
			...
			<tr>
				<td valign='top' style='padding:6px 15px 0px 0px;'><img src='http://lh3.googleusercontent.com/-Qzm5Afwbl4g/AAAAAAAAAAI/AAAAAAAAAEc/CXPngTPySFA/s120-c/photo.jpg?sz=90' class='sc_rc' style='width:55px;' /></td>
				<td valign='top' style='padding-bottom:15px;'>
					<div><a href='/support/edu/whm/install-ssl-whm'>How to create a CSR and install a SSL Certificate in WHM</a></div>
					<div>This guide shows you how to work with SSL's in WHM.</div>
					<div class='smallgrey'>
						Written by John-Paul Briones<br />
						Hits: 9,512
					</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD04NiZpZD04NiZ2aWV3PWNhdGVnb3J5Jkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="f1c6cf7781b355c6b596ab3b79948ade" value="1" />	</div>
	</form>
<!-- <br />
