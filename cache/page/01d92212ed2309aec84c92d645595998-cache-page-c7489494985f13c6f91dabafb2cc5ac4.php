...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/ssl/how-does-the-shared-ssl-work" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-03-24T14:49:32-07:00" />
  <meta name="keywords" content="how shared ssl works inmotion" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="This article will explain how the shared SSL works on InMotion Hosting servers." />
  <title>How does the shared SSL work? - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/ssl/how-does-the-shared-ssl-work" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:f0ca844dc791fca9f3b79f2d72877431 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How does the shared SSL work?									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='clear:both;'></div>
								...
								<p>InMotion Hosting allows <a href="http://www.inmotionhosting.com/business-hosting">Shared Hosting</a> plans to share an SSL certificate on the server. The shared SSL certificate does not use your domain. The server hostname is used in your domains place to allow an SSL connection without purchasing an SSL. This article explains the basics of how the Shared SSL works. Click here to learn more about <a href="http://www.inmotionhosting.com/prestashop-hosting">ecommerce hosting</a>.</p>
<p>If you wish to purchase an SSL certificate that is specific to your domain name, please see our article on <a href="http://www.inmotionhosting.com/support/website/ssl/how-do-i-obtain-an-ssl-certificate">How do I obtain an SSL certificate?</a></p>
<h2>What is the Shared SSL?</h2>

<p>The Shared SSL can be used to bypass the requirement for purchasing an SSL certificate. The Shared certificate does not use your domain name. The server host name is used in conjunction with the cPanel username to allow a secure connection to happen. The Shared SSL looks identical to the Temporary url for your account except for the server name and username. An example of a temporary URL is like following example:</p>

<h3>Temporary URL</h3>
<pre style="margin-left:20px;"><span style="color:#ff0000;">http:</span>//<span style="color:#ff0000;">biz91</span>.inmotionhosting.com/~userna5</pre>

<p>The Shared SSL will look the same except the server name changes to <em>secure</em> and the <em>http</em> is <em>https</em>.</p>
<h3>Shared SSL URL</h3>
<pre style="margin-left:20px;"><span style="color:#ff0000;">https:</span>//<span style="color:#ff0000;">secure91</span>.inmotionhosting.com/~userna5</pre>
<p>You can access your server through both the Temp url and the Shared URL. To test this find your Temp URL in your <a target="_blank" title="Click here for info on your cPanel username " href="/support/website/how-to/viewing-account-technicial-information-in-amp">technical details in AMP</a> and view it on your browser. Then alter the Temp URL so its the Shared SSL and view it in your browser.</p>
<h2>How does Shared SSL work?</h2>

<p>When you access your website normally you access over <strong>port 80</strong>. Port 80 is a non SSL connection. There is no encryption over this port. the Shared <strong>SSL works over port 443</strong>. The data that travels over port 443 can be encrypted using SSL.</p>
<p>SSL certificates require a hostname to work. InMotion Hosting installs a valid SSL certificate on all our shared servers main hostname.  An example hostname is secure91.inmotiohosting.com. Any connection over that specific hostname will allow the data to be encrypted. What makes the shared SSL &quot;<em>shared</em>&quot; is that the username at the end of the server hostname can change to the specific cPanel username for that account. When the url is accessed with your cPanel username attached at the end, the server knows to find your website by the username.</p>
<h2>Basic implementation of the Shared SSL</h2>
<p>To implement the shared SSL in your website, you can (in most cases) just add the url into your shopping cart configuration. For information on how to use the Shared SSL in your Shopping cart software, you can check our articles below or you will need to check with your website developer on how your shopping cart was set up.</p>
<p><a href="http://www.inmotionhosting.com/support/edu/php-nuke/php-nuke-statistics-reporting/use-a-ssl-certificate-with-php-nuke" target="_blank">Use a SSL certificate with PHP-Nuke</a><br />
<a href="http://www.inmotionhosting.com/support/edu/opencart/setting-up-payment-gateways/how-to-enable-ssl-connection-in-opencart" target="_blank">How to enable SSL connection in OpenCart</a> <br />
<a href="http://www.inmotionhosting.com/support/website/cube-cart/ssl-setup-for-cubecart" target="_blank">SSL Setup for CubeCart </a><br />
<a href="/support/How to Force SSL in Joomla 3.0" target="_blank">How to Force SSL in Joomla 3.0</a><br />
<a href="http://www.inmotionhosting.com/support/edu/moodle/moodle-site-security/forcing-ssl-sitewide" target="_blank">Forcing Moodle 2.3 to work over SSL</a> <br />
<a href="http://www.inmotionhosting.com/support/edu/movable-type/site-security-in-movable-type/use-shared-ssl" target="_blank">How to use a Shared SSL with Movable Type</a> <br />
<p>We also have our Ecommerce Getting Started guide that helps you with the SSL set up at the following link.</p>
<p><a href="http://www.inmotionhosting.com/support/website/how-to/e-commerce-step-6-configuring-ssl">E-Commerce: Step 6 - Configuring SSL </a></p>
<p>You can also force the site to go to https using the htaccess file. Please see the following link on this.</p>
<p><a href="http://www.inmotionhosting.com/support/website/ssl/how-to-force-ssl-using-the-htaccess-file" target="_blank">How to force a dedicated SSL using the .htaccess file</a><br />
<a href="http://www.inmotionhosting.com/support/website/ssl/forcing-your-websites-visitors-to-use-ssl" target="_blank">Forcing your Website's visitors to use the shared SSL</a> </p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/ssl/how-does-the-shared-ssl-work&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/ssl/how-does-the-shared-ssl-work'></div>
	<script type='text/javascript'>
	  (function() {
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/ssl/using-a-shared-ssl-with-woocommerce-for-wordpress?tsrc=rsbraq'>Using a shared SSL with WooCommerce (for WordPress)</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/ssl/is-shared-ssl-included-with-the-reseller-hosting-plan?tsrc=rsbraq'>Is Shared SSL included with the Reseller Hosting plan?</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/ssl/will-shared-ssl-protect-confidentiality-of-emails?tsrc=rsbraq'>Will shared SSL protect confidentiality of emails?</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/f73f095074751299c8756ee9adad83d2?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/f73f095074751299c8756ee9adad83d2'>Mr. Oki</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-06 6:49 pm</div>
				                <div><p>I have registered a domain yesterday in Godaddy. And I want to host this domain in your hosting with Shared SSL 24 Months 3.49/mo to br installed prestashop inside. How does it work ? How do I do with my domain in godaddy if I buy shared SSL in your hosting company?</p>
<p>Thank you,</p>
<p>Oki</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9443);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-07 10:57 am</div>
				                <div>Hello Mr. Oki,<br />
<br />
Having the domain registered at GoDaddy is not an issue. You will simply need to <a href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/updating-your-domains-nameservers">point it to our name servers</a>.  <br />
<br />
There may be an issue with using the shared SSL with your PrestaShop site, however. PrestaShop uses a single domain name, using a shared SSL effectively uses a different domain name (sever###.inmotionhosting.com vs the regular domain name) when connecting.  Ultimately, you may need to purchase an SSL in order to use it with PrestaShop. This would be true for any host that uses shared SSL.<br />
<br />
If you purchase and have an SSL installed onto your hosting account, it will use the same domain name for both insecure and secure portions, so there will be no issue then. <br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9461);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-13587'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/2fafdabf211c6009718144bf281df584?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/2fafdabf211c6009718144bf281df584'>Lulu</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-03 10:55 pm</div>
				                <div><p>What is the cost to purchase a SSL certificate?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13587);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-04 10:58 am</div>
				                <div>A dedicated SSL certificate will cost $99 per year in addition to a one-time installation fee of $25.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13619);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-16961'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/03f691949487d0ea3cc3cecae14e6008?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/03f691949487d0ea3cc3cecae14e6008'>Bob Reckhow</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-31 6:23 pm</div>
				                <div><p>1. Is there anything I can or should do when setting up a new WordPress site (or upgrading an old one) to make it as simple and reliable as possible to require all visitors to the site to always use HTTPS?</p>
<p>2. Which of the two articles about using the htaccess file (links at the bottom of the above article) should I be following to implement this scenario?</p>
<p>3. (I'm not sure if this is the right place to ask this question...) Is there a way to require all access to email mailboxes to use the secure server, like there is for websites (HTTPS versus HTTP)? I know how to configure my own email clients to use the secure server. My question is about whether there is a way to make that mandatory for everyone else who has mailboxes on my site.</p>
<p>Thanks</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16961);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-31 6:59 pm</div>
				                <div>Hello Bob,<br />
<br />
Thank you for your question. 1. After <a href="http://www.inmotionhosting.com/support/edu/cpanel/softaculous/how-to-install">installing Wordpress</a>, you basically just change the URL to whatever the SSL address is (shared SSL or not). Be sure to include the https:// in the address. <br />
<br />
This will cause visitors to access your WordPress site via https. Here is a link to the official guide on <a href="https://make.wordpress.org/support/user-manual/web-publishing/https-for-wordpress/#implementing-https-for-wordpress" target="_blank" >Implementing https</a> in <strong>WordPress</strong>. <br />
<br />
2. You don't have to make any changes to your .htaccess, since WordPress will handle the address change for you.<br />
<br />
3. There is no way to make it <em>mandatory</em> for users to connect via SSL, but this can be done on VPS, and Dedicated servers. As a work around, if you only provide the SSL version of the settings to them, it is the only way they will know how to connect. You can see your <a href="http://www.inmotionhosting.com/support/edu/everything-email/introduction-email/how-to-find-email-settings">SSL email settings</a> in cPanel.<br />
<br />
In the future you can create your own question on our <a href="http://www.inmotionhosting.com/support/community-support/ask-a-question" target="_blank">Ask a Question</a> page.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16962);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-17066'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/56a37340b60d9d45ee31941449e09e78?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/56a37340b60d9d45ee31941449e09e78'>Rob</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-04 6:15 am</div>
				                <div><p></p>
<p></p>
<p></p>
<p class="MsoNormal">@lulu - A cost of ssl depends on its type. there are several types of ssl available in the market from domain validation to extended validated certs. dv cert is available in the market from $10 to $100 per annum and if you go for ev which is available from $150 to $1000 per annum. This price depicts resellers price, but if you directly purchase it from certificate authority you will need to pay 25-40% extra.</p>
<p class="MsoNormal">So price doesn't matter until you findout your perfect need. I use to purchase ssl cert for my clients from cheapsslshop.com &ndash; they are quit affordable than others. if do not require ev cert for your domain then you should get domain validation or business validation certificate.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17066);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						...
						<div><a style='font-size:16px;' href='/support/community-support/users/Baruch'>Baruch</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-30 11:13 am</div>
				                <div>What do I need to do to enable https://mydomainname.com/wp-admin to access the admin area of my wp securely on shared hosting using shared SSL certificate?</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19012);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-30 11:57 am</div>
				                <div>To access your WordPress admin over SSL using your domain, you would not be able to use a shared SSL and would instead need to &lt;a href=&quot;http://www.inmotionhosting.com/support/website/ssl/how-do-i-obtain-an-ssl-certificate&quot;&gt;purchase a dedicated SSL certificate&lt;/a&gt;.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19014);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-30 12:28 pm</div>
				                <div>Is there a possibility to enable only SSL login to my wp using a shared certificate?<br />
</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19015);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-30 12:34 pm</div>
				                <div>Is there a way to have SSL login (or all admin access) to my wp using shared URL and shared certificate?  (By redirecting?)</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19016);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-30 1:16 pm</div>
				                <div>It appears that the &lt;a href=&quot;https://wordpress.org/plugins/wordpress-https/&quot;&gt;WordPress HTTPS plugin&lt;/a&gt; will allow you to define custom HTTPS routes for the admin.  With this plugin, you can access the WordPress admin using the shared SSL.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19018);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-28013'></a>
		<div  style='margin:2px 0px 0px 80px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/107138daf52bdcc629620243cf3aa177?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/107138daf52bdcc629620243cf3aa177'>Corey</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-30 5:19 am</div>
				                <div><p>This plugin didn't work for me with WordPress 4.3.1 (inmotion's current version), I believe because the login page did not end up being secured.</p>
<p>Is there any other way to use a&nbsp;shared certificate and host to administer the wordpress instance securely?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28013);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-30 11:05 am</div>
				                <div>Hello Corey,<br />
<br />
Sorry for the problem with the plugin for the WordPress SSL.  As per the warning on the plugin, it has not been updated for awhile.  This is a third-party solution, so unfortunately, if they did not update it, then it is probably of date and no longer functional.  <br />
<br />
However, there are others which have been created with the later versions of WordPress.  Check out <a href="https://wordpress.org/plugins/really-simple-ssl/" rel="nofollow" target="_blank">Really Simple SSL</a>.  The plugin page says it works with version 4.3.1.<br />
<br />
By the way, the  WordPress version isn't something governed by InMotion.  WordPress regularly updates the software version and 4.3.1 is the latest.  There will be other updates to the software by December per their <a href="https://wordpress.org/news/" rel="nofollow" target="_blank">blog</a>. <br />
<br />
...
<br />
						...
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28032);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-27661'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/25744caf03b5802189defc956286f234?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/25744caf03b5802189defc956286f234'>Johnna</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-19 3:10 pm</div>
				                <div><p>Do I need a SSL Certificate if I am using PayPal to take payments?</p>
<p>&nbsp;</p>
<p>Thank You</p>
<p>Johnna</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27661);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-19 5:55 pm</div>
				                <div>Hello Johanna,<br />
<br />
Not if you are connecting to PayPal itself, then it will be using PayPals SSL.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27679);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-30379'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/b4c545919c95f2196812bc5cafcbac2b?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/b4c545919c95f2196812bc5cafcbac2b'>Mishra129</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-02-07 6:58 am</div>
				                <div><p>I have Domian register in Godaddy can i only purchase SSL certificate from you?&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30379);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-02-08 12:02 pm</div>
				                <div>Hello Mishra129,<br />
<br />
Thank you for contacting us. You can <a href="http://www.inmotionhosting.com/support/website/ssl/how-do-i-obtain-an-ssl-certificate">purchase an SSL</a> from us directly, or from any <a href="http://www.inmotionhosting.com/support/website/ssl/install-third-party-ssl">3rd party SSL</a> provider.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30399);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-31083'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/8f05653f437e59b93409e69ea0258798?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/8f05653f437e59b93409e69ea0258798'>Fred B</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-09 1:59 pm</div>
				                <div><p>Paypal sent us an email specifying that we will need to add SSL SHA-256 to and use TLS 1.2 and http/1.1 on our site (joomla 3+ running virtuemart).</p>
<p>Paypal proceeses our purchases but we do record user addresses and email addresses.</p>
<p>Can we use shared SSL? Does InMotion support the required protocols and how do we implement them? &nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31083);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-09 10:12 pm</div>
				                <div>Hello Fred B.,<br />
<br />
...
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31103);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-32117'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/6a6a7684dc51bbfeba926eed592cee98?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/6a6a7684dc51bbfeba926eed592cee98'>Jim Parker</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-20 5:33 pm</div>
				                <div><p>This doesn't need to be posted but I thought that you would like to know that the link for </p>
<p><a href="/support/../../How%20to%20Force%20SSL%20in%20Joomla%203.0" target="_blank">How to Force SSL in Joomla 3.0</a></p>
<p>is broken.</p>
<p>Jim</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32117);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-20 9:19 pm</div>
				                <div>Hello Jim,<br />
<br />
Thanks for the information Jim!  I'll have issue fixed tomorrow morning!<br />
<br />
If you have any further questions, please let us know.  <br />
<br />
Kindest regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32125);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
