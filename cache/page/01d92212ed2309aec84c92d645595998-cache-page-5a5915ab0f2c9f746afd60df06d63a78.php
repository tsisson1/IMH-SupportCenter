<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:54414:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/wordpress/issue-with-adminajaxphp-get-cart-and-get-checkout-in-woocommerce" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, Thank you for your question regarding your WordPress website. How many plugins do you have installed as this can slow down your website as well s..." />
  <title>Issue with admin-ajax.php, GET cart, and GET checkout in Woocommerce | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/wordpress/issue-with-adminajaxphp-get-cart-and-get-checkout-in-woocommerce" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:77314a2608da4a62e05c62a77b90dc21 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '95.13.212.43']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Issue with admin-ajax.php, GET cart, and GET checkout in Woocommerce</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2016-05-27 2:05 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>33</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I'm working on my Woocommerce website, and I'm having trouble with slow 'add to cart' and 'checkout'. For an ecommerce site, this is quite a serious issue as each of these processes takes about 13-15 seconds to load...sometimes even longer. As I checked with GTMetrix and Pingdom (&gt;&gt; Waterfall), it seems that the slow load is mainly due to 'GET cart' for Cart page (about 7.8 seconds according to GTMetrix) and both 'GET checkout' and 'GET cart' for Checkout page (about 11 seconds according to GTMetrix).<br />
<br />
Please note on the following: <br />
- I'm using WP Rocket as my cache plugin.<br />
- I'm using Avada as my wordpress theme.<br />
- My site has WPML installed.<br />
- My site is on Inmotion VPS hosting plan. <br />
- My site has Heartbeat Control installed and set to &quot;Allow only on post edit pages&quot; and &quot;60 seconds&quot; for override heartbeat frequency.<br />
- My site's WP Memory Limit is 512MB<br />
<br />
Please advise.<br />
<br />
John</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_10005' id='upvote_answer_10005' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='10005' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_10005').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_10005' id='downvote_answer_10005' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='10005' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_10005').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
...
TJ Edens
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_10005').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_10005' id='form_comment_on_answer_10005' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hi TJEdens, <br />
<br />
I have about 50 plugins installed and activated. I understand that it's quite a lot, but according to GTMetrix &gt; Waterfall, none of these seem to be causing significant load to the [add to cart] and [checkout] process. Each of them takes about 500ms or less, as opposed to GET cart (there are 2 of them) and GET checkout (there are also 2 of them) that takes more than 3 seconds each.<br />
<br />
As for the plugins in the link you share, I came across them too, but I'm afraid they're not exactly the solution I'm looking for since they don't really address the GET issue, but rather reduce the checkout process by skipping the Cart page and going straight to Checkout. <br />
<br />
Best regards, <br />
<br />
John</div>
							...
							<td style='width:96px;' valign='top'>
								...
								<div class='smallgrey'>
									<a href='/support/community-support/users/Piyawit'>Piyawit</a><br />
									3 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2016-05-27 3:56 pm EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello Piyawit,<br />
<br />
I would suggest contacting our support department to get an account review as there may be some plugins that use up a lot of resources that can result in slow page load times. You may want to also look into some server-side caching instead of just WordPress caching.<br />
<br />
Best Regards,<br />
TJ Edens</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/wordpress/issue-with-adminajaxphp-get-cart-and-get-checkout-in-woocommerce&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/wordpress/issue-with-adminajaxphp-get-cart-and-get-checkout-in-woocommerce'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="7f2c5fc60c66bcfe1794e2add6be26bd" value="1" />	</div>
	</form>
<!-- <br />
