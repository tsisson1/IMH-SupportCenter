<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49705:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/whm/how-to-recompile-phpmysql-in-a-website" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Luca, Thank you for your question on recompiling php on your server. You can do that via the EasyApache tool located in your WHM. You will need to..." />
  <title>How to recompile php/mysql in a website? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/whm/how-to-recompile-phpmysql-in-a-website" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:d2288353308ae421631c4f29936fa4f5 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>How to recompile php/mysql in a website?</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/Manekineko'>Manekineko</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-05-31 5:56 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>108</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Hello! I need to recompile php  installed in my website but I can't find any option to do it in cPanel or WHM.  What should I do? I have a website hosted on   a dedicated server.<br />
Thank's for help!<br />
Luca</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_7367' id='upvote_answer_7367' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='7367' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_7367').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_7367' id='downvote_answer_7367' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='7367' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_7367').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Luca,<br />
<br />
Thank you for your question on recompiling php on your server. You can do that <a href="http://www.inmotionhosting.com/support/edu/whm/302-upgrade-php-using-easyapache">via the EasyApache tool</a> located in your <a href="http://www.inmotionhosting.com/support/edu/whm/creating-and-managing-accounts/log-into-whm">WHM</>. You will need to <a href="http://www.inmotionhosting.com/support/website/cpanel-account-management/obtain-root-access">have root access</a> in order to access it.<br />
<br />
Kindest Regards,<br />
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_7367').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_7367' id='form_comment_on_answer_7367' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/whm/how-to-recompile-phpmysql-in-a-website&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/whm/how-to-recompile-phpmysql-in-a-website'></div>
<script type='text/javascript'>
  (function() {
