<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:84228:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/a-record-change" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-10-29T18:50:29-07:00" />
  <meta name="keywords" content="a record dns zone cpanel ip address subdomain" />
  <meta name="author" content="null" />
  <meta name="description" content="This article walks you through creating an A record in your cPanel and WHM." />
  <title>Adding an A Record - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/a-record-change" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:40590693f2176d6038115a397d5a890f -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-37']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '145.253.103.10']);
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>48,678</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Sep 20, 2011'><span style='color:#606060;'>Published:</span> Oct 29, 2013</div>
...
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/cpanel/cpanel-simple-dns-editor.jpg"><img  style="float:right; margin:0px 0px 15px 15px;" alt="the configuration screen for the module" src="//cdn.inmotionhosting.com/support/images/stories/cpanel/cpanel-simple-dns-editor.jpg" title="Click here to view the larger image" width="200" /></a><p>First, log into your cPanel account and click on the <strong>Simple DNS Zone Editor</strong> icon located in the <strong>Domains</strong> area of cPanel.</p><div style="clear:both;"></div></li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/cpanel/cPanel-add-a-record.jpg"><img  style="float:right; margin:0px 0px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/cpanel/cPanel-add-a-record.jpg" title="Click here to view the larger image" width="200" /></a> Next, select your domain from the drop down menu (if you have more than one domain entered in your cPanel).&nbsp; The editor will load new options which allows you to add an A record. Under the <em>Add an A Record header</em> fill in the subdomain and IP address you want to point your subdomain to.</p>
<p>In this example, we will point my blog to the IP Address 1.1.1.1:</p>
<div style="clear:both;"></div></li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/cpanel/cPanel-a-record-added.jpg"><img  style="float:right; margin:0px 0px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/cpanel/cPanel-a-record-added.jpg" title="Click here to view the larger image" width="200" /></a><p>Finally, click the <strong>Add A Record</strong> button and you will now see the subdomain an corresponding IP address listed under <em>User Defined Records</em> at the bottom of the screen.</p>
<div style="clear:both;"></div></li>

<p class="alert"><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/cpanel/cPanel-a-record-error.jpg"><img  style="float:right; margin:0px 0px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/cpanel/cPanel-a-record-error.jpg" title="Click here to view the larger image" width="200" /></a><strong>Please note:</strong> You will not be able to create or modify an A Record for your domain name or any subdomains that are already created and reserved when your account is setup on the server. You can only create an A record for newly created subdomains. If you try to create an A Record on a reserved subdomain (for example mail, webmail, and cpanel), cPanel will give an error message. In order to edit or remove a reserved subdomain, you will need to use the <strong>Advanced DNS Zone Editor</strong>.</p>
...
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/WHM/whm-edit-dns-zone.jpg"><img  title="Editing DNS in WHM" alt="whm-edit-dns-zone" src="//cdn.inmotionhosting.com/support/images/stories/WHM/whm-edit-dns-zone.jpg" /></a></p>

<!-- <p>A common A record change for a reservered subdomain would be for the mail subdomain. In order to request an A record change for a reserved subdomain, please contact our support team at <a href="mailto:support@inmotionhosting.com">support@inmotionhosting.com</a> and include account verification with your request. We'll be happy to help.</p>
-->
...
<p>VPS and Dedicated plans include a feature in WHM for editing DNS Zones for all cpanel accounts on the server. (looking for a VPS? Find one <a href="/vps_hosting/articles/vps-sale.html">on sale</a>). This editor provides greater control over DNS records than the Simple and Advanced DNS Zone editor in cPanel. It allows other record types such as <em>SRV, MX, PTR, and NS</em> records These are not as common and thus are not in the cPanel level tools.</p>

<p><strong>Note, as above, please allow up to 24 hours for your DNS changes to take effect.<br /></strong></p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/a-record-change&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/a-record-change'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD02OCZpZD04NTQmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="cc4bcb34d737a94f33d6b705ef74b5a7" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						...
						<div><a style='font-size:16px;' href='/support/community-support/users/hmann54'>hmann54</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-24 9:44 am</div>
				                <div>I bought a domain name from 1 and 1 , hosting by Inhost, website from Open Class. How do I set the dns numbers to my site. Have already contacted 1&amp;1, they said numbers need to be installed at host, can someone please help me with this problem. 2 days of frustration.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13246);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-24 10:12 am</div>
				                <div>Hello hmann54,<br />
<br />
Thank you for your question. We are happy to help, but will need more information.<br />
<br />
If you want to host/modify your DNS with us, first make sure your 1&1 domain is <a href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/updating-your-domains-nameservers">pointed to our Nameservers</a>.<br />
<br />
Then you can use the <a href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-manage-domains/advanced-dns-editor-cpanel">Advanced DNS Zone Editor</a> in cPanel to make changes to your DNS.<br />
<br />
Also keep in mind, any DNS change can take up to 24 hours to <a href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/domain-names-dns-changes">propagate</a>, or resolve across the world.<br />
<br />
If you have any further questions, feel free to post them below.<br />
Thank you,<br />
<br />
-John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13249);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-20946'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/335af9906e47de7fc5fa3937f3c8b874?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/335af9906e47de7fc5fa3937f3c8b874'>Kirk</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-22 7:22 pm</div>
				                <div><p>I just signed up with paper.li. I also created a domain name through inmotion and have read the directions on paper.li about pointing that domain to my paper at paper.li.</p>
<p>Their directions say to "point an A record to their ip address". Through my inmotion control panel I created an a record and added that ip, but do I need to go in and point the main nameservers to that ip address too?</p>
<p>Thanks in advance for any help on this.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20946);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
...
Arnel C.</div>
		...
		<a name='comment-23233'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/d46b4e6a4b1997340d1466e23a31a06f?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/d46b4e6a4b1997340d1466e23a31a06f'>Param</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-05-07 5:37 am</div>
				                <div><p>i have purchased hosting from inmotionhosting.com and change dns record but my site is not still up after 18 hours.</p>
<p>What can be the problem. </p>
<p>Regards,</p>
<p>http://www.***************.com</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23233);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-05-07 2:54 pm</div>
				                <div>Hello Param,<br />
<br />
Thank you for contacting us. In some cases <a href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/domain-names-dns-changes">DNS propagation</a> can take up to 24 hours, though it usually occurs much faster.<br />
<br />
I tested your site, and it is resolving successfully at this time. If you are still experiencing trouble accessing our site, I recommend performing a <a href="http://www.inmotionhosting.com/support/website/slow-websites/why-is-my-server-slow-how-do-i-run-a-ping-and-tracert-test">Ping/Traceroute</a> to provide specific clues to your path to the site. Here is our helpful guide on <a href="http://www.inmotionhosting.com/support/website/how-to/read-traceroute">How to read a traceroute</a>.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23254);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-24513'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/151f0a72027f59c17dc430396ed7ab54?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/151f0a72027f59c17dc430396ed7ab54'>Theary</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-28 11:47 pm</div>
				                <div><p>Dear Sir/Mrs</p>
<p>I am Theary from Cambodia. i have problem i cannot piont to other IP with my subdomain i created.</p>
<p>can you give me the command?</p>
<p>&nbsp;</p>
<p>thanks&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24513);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-29 1:30 pm</div>
				                <div>Hello Theary,<br />
<br />
The instructions above should be all you need. If you are having issues with any particular step, please provide specific information on that step and what you are trying to do and we may be able to advise further.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24529);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/38da0ea953147aaa7659f9cb34ccf3cd?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/38da0ea953147aaa7659f9cb34ccf3cd'>Abdul</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-02 2:47 am</div>
				                <div><p>Hi,</p>
<p>I subscribe Shopify for my online sales. I was give the IP address and web address to point to. After make changes to my website A and CName, I can get the website domain to point to account in Shopify but my email now is not working. Kidly assist.</p>
<p>Regards.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26277);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-02 11:12 am</div>
				                <div>Hello Abdul, <br />
<br />
You most likely need to make changes to your MX record. Check out this tutorial:  <a href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/change-dns-records-to-use-3rd-party-services#website-with-3rdparty">Change DNS records to use 3rd party services while mail with mail hosted by InMotion</a>.  Mx records are related to the Mail server, so pay close attention to those particular settings.<br />
<br />
I hope this helps to answer your question, please let us know if you require any further  assistance.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26291);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-27488'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/985c0de4e0f56ffbb98db4aacf279c66?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/985c0de4e0f56ffbb98db4aacf279c66'>Daniel Lehrke</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-13 6:11 am</div>
				                <div><p>Hi,</p>
<p>&nbsp;</p>
<p>I have a domain (www.lunarpupil.com) registered with inmotion and am trying to point it at my tumblr page. How can I do this, I can't see access to cPanelx as I don't have hosting currently???</p>
<p>Thanks,</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27488);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-13 11:12 am</div>
				                <div>Hello Daniel,<br />
<br />
You will either need to have a hosting plan somewhere or point your domain to a 3rd party DNS service like <a href="http://dyn.com/dns/">DynDNS</a>. <br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27500);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
