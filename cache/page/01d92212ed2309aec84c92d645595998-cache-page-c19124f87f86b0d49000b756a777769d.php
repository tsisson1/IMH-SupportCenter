...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:a45b4f3085ec9eb0db69848ce99dae19 -->
...
<form action="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes" method="post" name="adminForm" id="adminForm" class="form-inline">
  ...
  <table class='article_list'>
		...
		<ul><li class="pagination-start"><span class="pagenav">Start</span></li><li class="pagination-prev"><span class="pagenav">Prev</span></li><li><span class="pagenav">1</span></li><li><a href="/support/domain-names/dns-nameserver-changes?start=15" class="pagenav">2</a></li><li class="pagination-next"><a title="Next" href="/support/domain-names/dns-nameserver-changes?start=15" class="hasTooltip pagenav">Next</a></li><li class="pagination-end"><a title="End" href="/support/domain-names/dns-nameserver-changes?start=15" class="hasTooltip pagenav">End</a></li></ul>	</div>
	</form>
