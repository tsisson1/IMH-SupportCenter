<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:58267:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/moodle/moodle-plugins/uninstall-plugin" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-11-27T20:29:36-08:00" />
  <meta name="keywords" content="uninstall remove  plugin  Moodle 2.3 removing delete deleting ininstalling plugins" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="This tutorial will explain how to uninstall or remove a plugin from a Moodle 2.3 site." />
  <title>Uninstalling or removing a Moodle plugin - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/moodle/moodle-plugins/uninstall-plugin" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:22372953ac9e9aefa3d673c4d8609d08 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '168.235.197.44']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Uninstalling or removing a Moodle plugin									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>11,000</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Nov 27, 2012'><span style='color:#606060;'>Published:</span> Nov 27, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>When managing plugins on a Moodle 2.3 site, there may be a need to completely remove a plugin from the Moodle site. This is necessary when plugins are not used anymore, out of date, or not compatible. In the previous article, installing a plugin was discussed. In this article, we will remove or uninstall a plugin from the Moodle 2.3 site. For tutorial purposes, the plugin that will be removed is the same plugin from the <a href="/support/edu/moodle/moodle-plugins/install-plugin" title="Click here to view the previous article" target="_blank">previous article</a>. Now we will look at how to delete a plugin from Moodle.</p>
<h3>Removing a plugin from Moodle</h3>
...
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/108/uninstall-plugin/uninstall-plugin-1-select.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="uninstall-plugin-1-select-moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/108/uninstall-plugin/uninstall-plugin-1-select.gif" title="Click here to view the larger image" width="200" /></a>Navigate the <strong>Site administration</strong> &gt; <strong>Plugins</strong> &gt; <strong>Plugins overview</strong> page in the Settings on the left. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/108/uninstall-plugin/uninstall-plugin-2-uninstall.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="uninstall-plugin-2-uninstall-moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/108/uninstall-plugin/uninstall-plugin-2-uninstall.gif" title="Click here to view the larger image" width="200" /></a> Find the plugin that will be removed from the Moodle site. In this case the Progress bar plugin will be removed. <strong>Click Uninstall</strong> for the plugin to be removed<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/108/uninstall-plugin/uninstall-plugin-3-continue.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="uninstall-plugin-3-continue-moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/108/uninstall-plugin/uninstall-plugin-3-continue.gif" title="Click here to view the larger image" width="200" /></a>The Blocks page will load stating:
<p style="margin-left: 20px;">You are about to completely delete the block 'Progress bar'. This will completely delete everything in the database associated with this block. Are you SURE you want to continue?</p>
<p><strong>Click Continue</strong>.</p>
<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/108/uninstall-plugin/uninstall-plugin-4-final.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="uninstall-plugin-4-final-moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/108/uninstall-plugin/uninstall-plugin-4-final.gif" title="Click here to view the larger image" width="200" /></a>Now the block progress should show Success.
<p class="alert"><strong>Important!</strong> When uninstalling a plugin, theme or other function in Moodle, you will need to go to the folder location where the plugin resides and delete the plugin folder from the server. Otherwise, the plugin will be reinstalled when logging back into the Site administrator section.</p>
<p>To remove the plugin permanently from Moodle, <a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel" target="_blank" title="Click here for more information">Log into cPanel</a> or use an <a href="/support/website/file-management/getting-started-guide-ftp" target="_blank" title="Click here for more information">FTP client</a> and find the plugin folder on the server. Delete the plugin folder. At this time, when logging into Moodle, Moodle will not prompt to install the plugin again.</p>
<br style="clear: both;" /></li>
</ol>
<p>This concludes the article for Uninstalling or removing a Moodle plugin.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/moodle/moodle-plugins'>108: Managing Moodle Plugins</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 3: Uninstalling or removing a Moodle plugin</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 2: <a href='/support/edu/moodle/moodle-plugins/install-plugin'>How to install a plugin in Moodle 2.3</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 4: <a href='/support/edu/moodle/moodle-plugins/enrollment-plugin'>Managing Enrollments in the Moodle plugins</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/moodle/moodle-plugins/uninstall-plugin&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/moodle/moodle-plugins/uninstall-plugin'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yOTcmaWQ9MjAxNyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="cdfa2cbc2f6aa4fe55cae6428975d612" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/moodle/moodle-plugins?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Managing Moodle Plugins</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/moodle/moodle-plugins/plugin-overview?tsrc=rsbedu'>Moodle 2.3 Plugin Overview</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/moodle/moodle-plugins/install-plugin?tsrc=rsbedu'>How to install a plugin in Moodle 2.3</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/moodle/moodle-plugins/uninstall-plugin?tsrc=rsbedu'>Uninstalling or removing a Moodle plugin</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/moodle/moodle-plugins/enrollment-plugin?tsrc=rsbedu'>Managing Enrollments in the Moodle plugins</a></td>
                </tr>
          <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/moodle/moodle-plugins/messaging-email-plugin?tsrc=rsbedu'>Setting up an SMTP connection in Moodle</a></td>
                </tr>
          	</table>
