<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:57435:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotion.host/support/edu/php-fusion/305-database-errors" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-08-14T11:29:52-07:00" />
  <meta name="keywords" content="upgrade migration connection SQL database errors php-fusion phpfusion php fusion" />
  ...
  <title>305: Dealing with Database Errors in PHP-Fusion - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/php-fusion/305-database-errors" rel="canonical" />
  ...
  <link rel="stylesheet" href="http://www.inmotion.host/support/modules/mod_slogin/tmpl/compact/slogin.css" type="text/css" />
  ...
  <script src="http://www.inmotion.host/support/modules/mod_slogin/media/slogin.js" type="text/javascript"></script>
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:59d28fd7c751792fc5e0b37d67023147 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-20']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '180.76.15.159']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															305: Dealing with Database Errors in PHP-Fusion									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>979</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Mar 25, 2013'><span style='color:#606060;'>Published:</span> Aug 14, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Occasionally, there is the need to move or migrate a PHP-Fusion installation.  With the move there is a risk of getting the information for the database server set wrong, or there might be a problem with the SQL server.  The following articles describes the database errors that you may see when encountering these issues with a PHP-Fusion installation.</p>

<h2>Understanding Database Errors in PHP-Fusion</h2>

<h4>Database Connection Errors</h4>
<p>Database Connection errors differ from authorization errors in that the error specifically states that it cannot connect through the network services used to connect to the database.  Here's an example of a connection error: <br />
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/php-fusion/dberrors/db-service-not-avail.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/edu/php-fusion/dberrors/db-service-not-avail.png" alt="Database Server not available." ></a>
  <br />
  ...
  <p>The status of a MYSQL server can be directly determined only if you have access to the Web Host Manager (WHM) or <em><a href="/support/website/how-to/gaining-root">root access </a></em> to the server via a terminal client.  Access to these options are only going to be available with a VPS or Dedicated server.  When you have access to the secure shell terminal, the status messages for the server will look like this:</p>

    <p>This error indicates that the service is running:</p>
    <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/php-fusion/dberrors/vps-status-running.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/edu/php-fusion/dberrors/vps-status-running.png" alt="VPS or dedicated message showing that MYSQL service." ></a>
    <p></p>
   <p>This error indicates that service is not running or service is unavailable:</p>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/php-fusion/dberrors/vps-error-not-running.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/edu/php-fusion/dberrors/vps-error-not-running.png" alt="VPS or dedicated message showing that MYSQL service." ></a>
  <p></p>
    <p>If you are in the Web Host Manager (WHM), then you can also check Services to see if MYSQL services have been selected or phpMyAdmin to see if it will make a connection.  If phpMyAdmin generates an error, then the mySQL service is not running. For more information on seeing if your SQL server is running, go to the article named <a href="/support/website/how-to/is-mysql-available">Database connection error</a>, or contact our Live Technical Support team available 24/7.</p><br />
...
<h4>Database Connection Errors Caused by Database Authorization Errors </h4>      
    ...
    <div><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/php-fusion/dberrors/wrong-db.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/edu/php-fusion/dberrors/wrong-db.png" alt="Unable to select database " ></a></div>
  <br />
    <div><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/php-fusion/dberrors/wrong-user.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/edu/php-fusion/dberrors/wrong-user.png" alt="Unable to establish connection" ></a>  </div>
  <br />
  
  These type of errors are easily corrected if you have access to <em>config.php</em> file.  The following directions take you through editing the values in the <em>config.php</em> file using the Cpanel File Manager):
  
<ol class="article_list">  
<li><a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">Log into cPanel</a><div style="clear:both;"></div></li>
<li>Scroll down the Files section and Click on the <strong>FILE MANAGER</strong> icon.<div style="clear:both;"></div></li>
<li>Navigate in the File Manager until you get to the root of the PHP-Fusion installation files.  Scroll down the list of files until youFind the <em> CONFIG.PHP</em>.  Click to highlight the <em>CONFIG.PHP</em> file, then click on <strong>CODE EDIT</strong> in the top of the File Manager.<div style="clear:both;"></div></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/php-fusion/dberrors/config-php-file.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="200" src="//cdn.inmotionhosting.com/support/images/stories/edu/php-fusion/dberrors/config-php-file.png" alt="Edit the Config File" align="right" ></a>When you edit the file you will be looking for all the database parameters to make sure that they are correct.  These parameters include:  database host (db_host), database user name (db_user), database password (db_pass), and the database name (db_name).  If any of these parameters are misspelled or incorrect, then a database error will occur. <div style="clear:both;"></div></li>
  <li>Click on <strong>SAVE CHANGES</strong> in the top right hand corner to save any changes you may have made with the <em>CONFIG.PHP</em> file.<div style="clear:both;"></div></li>
  </ol><br />
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/php-fusion'>PHP-Fusion</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 8: 305: Dealing with Database Errors in PHP-Fusion</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 9: <a href='/support/edu/php-fusion/adding-google-analytics-code-to-php-fusion'>Adding Google Analytics Code to PHP-Fusion</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotion.host/support/edu/php-fusion/305-database-errors&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotion.host/support/edu/php-fusion/305-database-errors'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xMTYmaWQ9MjUyMSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="715939af2e973b1283d275d9ed225acc" value="1" />	</div>
	</form>
<!-- <br />
