<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49716:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/billing/multiple-site-referal-discount" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, and thanks for your question. Are you talking about our affiliate program? Someone just signing up for hosting with 3 websites won't necessarily ..." />
  <title>multiple site referal discount  | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/billing/multiple-site-referal-discount" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:3016afb21bfd3c69fed2333b762fcfc5 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>multiple site referal discount </h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2014-06-17 9:51 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>35</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>If I refer someone that hosts 3 or more sites, do they get a discount?</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_5128' id='upvote_answer_5128' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='5128' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_5128').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_5128' id='downvote_answer_5128' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='5128' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_5128').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
...
<br />
Are you talking about our &lt;a href=&quot;http://www.inmotionhosting.com/hosting-affiliate-program&quot; target=&quot;_blank&quot;&gt;affiliate program&lt;/a&gt;? Someone just signing up for hosting with 3 websites won't necessarily get a discount, unless you mean they are singing up for 3 or more individual accounts.<br />
<br />
We mainly deal with technical stuff on this public forum, but you can directly contact our sales department at &lt;a href=&quot;mailto:sales@inmotionhosting.com&quot; id=&quot;mailto:sales@inmotionhosting-1&quot;&gt;sales@inmotionhosting.com&lt;/a&gt; or give them a call at &lt;strong&gt;888-321-4678 x1&lt;/strong&gt; if you'd like to discuss any discounts with them.<br />
<br />
- Jacob
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_5128').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_5128' id='form_comment_on_answer_5128' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/billing/multiple-site-referal-discount&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/billing/multiple-site-referal-discount'></div>
<script type='text/javascript'>
  (function() {
