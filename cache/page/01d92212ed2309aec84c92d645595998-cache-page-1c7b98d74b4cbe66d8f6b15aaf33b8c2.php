<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:67572:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/pci-compliance/disable-cpanel-guestbook-cgi-script" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-04-21T23:41:17-07:00" />
  <meta name="keywords" content="pci compliance compliant scan scans dss credit card cards guestbook guestbook.cgi cpanel" />
  ...
  <link href="http://www.inmotionhosting.com/support/website/pci-compliance/disable-cpanel-guestbook-cgi-script" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:515edd7bb41a6b731fc031a4a9e97e35 -->
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/website/pci-compliance' itemprop='url'><span itemprop='title'>PCI Compliance<span></a><div class='dropdown_3columns'><div class='col_3'><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/pci-compliance/disable-cpanel-guestbook-cgi-script'>Disable default cPanel guestbook CGI script</a> (38460 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/pci-compliance/how-to-pass-pci-scans'>How to pass PCI compliance scans</a> (12040 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/pci-compliance/close-open-ports-for-pci-compliance'>Close open ports for PCI compliance</a> (8543 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/pci-compliance/pci-compliance'>What is PCI Compliance?</a> (5459 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/pci-compliance/exim-pci-scan-false-positive'>Exim PCI scan false positive</a> (4453 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/pci-compliance/openssl-pci-scan-false-positive'>OpenSSL PCI scan false positive</a> (2729 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/pci-compliance/bind-pci-scan-false-positive'>BIND PCI scan false positive</a> (1887 hits)</div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Disable default cPanel guestbook CGI script</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Disable default cPanel guestbook CGI script									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>38,460</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Nov 7, 2012'><span style='color:#606060;'>Published:</span> Apr 21, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In this article we'll discuss the built-in <strong>guestbook.cgi</strong> script that is available from cPanel, and how to disable it in case it is causing your website to fail a PCI compliance scan. If you happened to have read our previous article on <a href="/support/website/website-troubleshooting/how-to-pass-pci-scans">how to pass PCI compliance scans</a>, the cPanel <strong>/cgi-sys/guestbook.cgi</strong> script is a common test that will cause a PCI scan to fail for your website.</p>
<p>You can read our article on <a href="/support/website/cpanel/using-cpanel-simple-guestbook-script">using cPanel's simple guestbook script</a>&nbsp;to get a good idea of exactly what the guestbook script does and how to use it on your website.</p>
<p>Disabling the cPanel <strong>guestbook.cgi</strong> script requires two steps, first accessing the <strong>Feature Manager</strong> in WHM (Web Host Manager) with <a href="/support/website/general-server-setup/root-access-faq">root access</a> already being setup on your server to disable the feature showing up in cPanel so a user doesn't try to install it and ends up with an error. Then you need to <a href="/support/website/general-server-setup/how-to-login-ssh">login to your server via SSH</a> as the root user to modify your Apache configuration to prevent the script from being accessible.</p>
...
<li>In the&nbsp;<strong>Find</strong> box type in&nbsp;<strong>feature</strong>, then click on&nbsp;<strong>Feature Manager</strong>.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/pci-compliance/whm-click-on-feature-manager.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/pci-compliance/whm-click-on-feature-manager.png" alt="whm-click-on-feature-manager"  /></a><b><br /></b></li>
<li><span data-mce-bogus="true"><span data-mce-bogus="true"><span data-mce-bogus="1"><span data-mce-bogus="true">Under the&nbsp;<strong>Edit a Feature List</strong> drop-down, leave&nbsp;<strong>default</strong> selected, then click on&nbsp;<strong>Edit</strong>.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/pci-compliance/whm-feature-manager-click-on-edit.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/pci-compliance/whm-feature-manager-click-on-edit.png" alt="whm-feature-manager-click-on-edit"  /></a><br /></span></span></span></span></li>
<li><span data-mce-bogus="true"><span data-mce-bogus="true"><span data-mce-bogus="1"><span data-mce-bogus="true"><span data-mce-bogus="1"><span data-mce-bogus="true"><span data-mce-bogus="1">Scroll down the page and un-check&nbsp;<strong>Simple Guestbook</strong>, then click on&nbsp;<strong>Save</strong> at the bottom of the page.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/pci-compliance/whm-feature-manager-uncheck-guestbook-click-save.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/pci-compliance/whm-feature-manager-uncheck-guestbook-click-save.png" alt="whm-feature-manager-uncheck-guestbook-click-save"  /></a><br /></span></span></span></span></span></span></span></li>
<li><span data-mce-bogus="true"><span data-mce-bogus="true"><span data-mce-bogus="1"><span data-mce-bogus="true"><span data-mce-bogus="1"><span data-mce-bogus="true"><span data-mce-bogus="1"><span data-mce-bogus="1"><span data-mce-bogus="true"><span data-mce-bogus="1"><span data-mce-bogus="true">You should now see that the <b>default</b>&nbsp;feature list was saved.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/pci-compliance/whm-feature-manager-saved.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/pci-compliance/whm-feature-manager-saved.png" alt="whm-feature-manager-saved"  /></a><br /></span></span></span></span></span></span></span></span></span></span></span></li>
<li><span data-mce-bogus="true"><span data-mce-bogus="true"><span data-mce-bogus="1"><span data-mce-bogus="true"><span data-mce-bogus="1"><span data-mce-bogus="true"><span data-mce-bogus="1"><span data-mce-bogus="1"><span data-mce-bogus="true"><span data-mce-bogus="1"><span data-mce-bogus="true">Now when viewing the&nbsp;<strong>CGI Center</strong> in cPanel, you'll notice the&nbsp;<strong>Simple GuestBook</strong> link is not longer available.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/pci-compliance/cpanel-cgi-center-minus-guestbook.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/pci-compliance/cpanel-cgi-center-minus-guestbook.png" alt="cpanel-cgi-center-minus-guestbook"  /></a><strong><br /></strong></span></span></span></span></span></span></span></span></span></span></span></li>
<li>Now to disable the script from being accessible <a href="/support/website/general-server-setup/how-to-login-ssh">login to your server via SSH</a>.</li>
<li>Make a copy of your current Apache configuration with the following command:<br /><br /> <span class="code_block">cp -frp /usr/local/apache/conf/httpd.conf{,.backup}</span> <br /><br /></li>
<li>Now edit your Apache configuration with your favorite text editor, in this example we are using <strong>vim</strong>.<br /><br /> <span class="code_block">vim /usr/local/apache/conf/httpd.conf</span>
<p>Navigate down to your <strong>VirtualHosts</strong> section for your domain which should look like the following:</p>
<pre class="code_block" style="width: 500px;">&lt;VirtualHost 123.123.123.123:80&gt;
...
<p class="code_block" style="width: 500px;"># Include "/usr/local/apache/conf/userdata/std/2/dummydom/example.com/*.conf"</p>
<p>By placing your cursor over the pound symbol <strong>#</strong> and hitting <strong>Delete</strong> on your keyboard:</p>
<p class="code_block" style="width: 500px;">Include "/usr/local/apache/conf/userdata/std/2/dummydom/example.com/*.conf"</p>
<p>Now you can save the file by hitting <strong>:</strong> to enter command mode, and then entering in <strong>wq</strong> for <strong>w</strong>rite and <strong>q</strong>uit.</p>
</li>
<li>Next create the Apache include directory with the following command of course using the paths for your account instead of this example one: <br /><br /> <span class="code_block">mkdir -p /usr/local/apache/conf/userdata/std/2/<span style="font-family: 'Courier New', Courier, monospace;">dummydom</span>/example.com/</span> <br /><br /></li>
<li>Now you'll want to echo the following value into a <strong>disable_cgisys.conf</strong> file inside that directory you just created:<br /><br />
<p class="code_block" style="width: 500px;">echo "ScriptAlias /cgi-sys/ /home/dummydom/public_html/cgi-bin/" &gt; /usr/local/apache/conf/userdata/std/2/dummydom/example.com/disable_cgisys.conf</p>
</li>
<li>Next rebuild the Apache configuration so that the new include path is built-in with the following command:<br /><br /> <span class="code_block">/scripts/rebuildhttpdconf</span> <br /><br /> You should get back the response:<br /><br /> <span class="code_block">Built /usr/local/apache/conf/httpd.conf OK</span><br /><br /></li>
<li>Now you want to restart Apache using the following command:<br /><br /> <span class="code_block">service httpd restart</span><br /><br /></li>
<li>Finally you'll want to create a symbolic link to handle HTTPS requests as well in case you have an SSL certificate setup on your domain using the following command:<br /><br />
<p class="code_block" style="width: 500px;">ln -s /usr/local/apache/conf/userdata/std/2/dummydom/example.com/disable_cgisys.conf /usr/local/apache/conf/userdata/ssl/2/dummydom/example.com/disable_cgisys.conf</p>
The difference above is the <strong>/std/</strong> and <strong>/ssl/</strong> part of the path.<br /><br /></li>
<li>Now if you try to view a guestbook page you'll see it is no longer found:<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/pci-compliance/guestbook-cgi-not-found.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/pci-compliance/guestbook-cgi-not-found.png" alt="guestbook-cgi-not-found"  /></a></li>
</ol>
<p>So now that the cPanel <strong>guestbook.cgi</strong> script is no longer accessible on the server, you should be able to pass a PCI scan that previously had failed your website for having it accessible.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/pci-compliance/disable-cpanel-guestbook-cgi-script&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/pci-compliance/disable-cpanel-guestbook-cgi-script'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MDcmaWQ9NDY5JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="411c3916a39eb7cfdf3c5a9db0dbe3e1" value="1" />	</div>
	</form>
<!-- <br />
