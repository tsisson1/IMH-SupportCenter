<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49734:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/how-to/how-to-allow-pdf-downloads-from-site" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hi raylie, Thanks for posting your question. I'm more than happy to assist you today. If you want people to be able to download PDF files off your site,..." />
  <title>how to allow PDF downloads from site | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/how-to/how-to-allow-pdf-downloads-from-site" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:373d64f7588f9320cf8fd5031f677376 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>how to allow PDF downloads from site</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/raylie'>raylie</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2011-11-01 2:14 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>16,064</span>
			</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_214' id='upvote_answer_214' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='214' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_214').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_214' id='downvote_answer_214' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='214' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_214').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hi raylie,<br />
<br />
Thanks for posting your question. I'm more than happy to assist you today. If you want people to be able to download PDF files off your site, it's relatively easy. <br />
<br />
Basically, if you upload the PDF files to your public_html folder you will be able to then link to the file. So take a basic example:<br />
<br />
We have a pdf file called "test.pdf"<br />
<br />
We upload it to our website, "yourdomain.com" and place the file in the public_html folder.<br />
<br />
We then create a link on the webpage to: http://yourdomain.com/test.pdf<br />
<br />
When the user clicks on the file, it will open it in the web browser. If the website visitor wants to download the file, they can simply "save" the pdf. <br />
<br />
...
Tim S
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_214').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_214' id='form_comment_on_answer_214' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/how-to/how-to-allow-pdf-downloads-from-site&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/how-to/how-to-allow-pdf-downloads-from-site'></div>
<script type='text/javascript'>
  (function() {
