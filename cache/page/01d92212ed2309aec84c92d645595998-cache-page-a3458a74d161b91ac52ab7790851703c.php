...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/general-server-setup/check-disk-space-through-shell" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-07-17T14:35:34-07:00" />
  <meta name="keywords" content="disk space error vps dedicated du find server large files" />
  ...
  <link href="http://www.inmotionhosting.com/support/website/general-server-setup/check-disk-space-through-shell" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:86aa0928c8a0bea619af04cd00f4de50 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to find what is using the most disk space on my server									</h1>
...
<pre style="margin-left: 20px;">Sorry for the inconvenience!
...
Please ask your system admin to remove any files not in use on that partition. </pre>
<p class="alert"><strong>Important!</strong> This is for <a href="http://www.inmotionhosting.com/cloud-vs-vps">VPS</a> or Dedicated server customers only. If you are getting this error and you are not on a VPS or a Dedicated server, you will need to contact <a href="/support/website/website-troubleshooting/how-to-get-great-technical-support" target="_blank" title="Click here for how to contact support">tech support</a> to have our systems support check the server disk space.</p>
<p>You can check your Disk space usage through <a target="_blank" href="/support/website/general-server-setup/how-to-login-ssh">shell</a> or you can <a href="/support/website/general-server-setup/view-bandwidth-and-disk-usage" target="_blank">check the disk space through the WHM</a>. The purpose of this article is to show you how to check the disk space through shell.</p>
<h2>How to view your overall disk size and usage</h2>
<h3>Checking disk space through Shell</h3>
...
<pre class="cli" style="margin-left: 20px;">df -h</pre>
<p>You will get a similar to the following output.</p>
<pre class="cli" style="margin-left: 20px;">root@vps#### [~]# df  -h
...
<h3>Using the Web Host Manager</h3>
<p>If you are not familiar with using command line, you can look at your disk space usage through the WHM . The WHM will show you the accounts with the highest usage. For more information on checking your Disk space through WHM, see our article on <a href="/support/website/general-server-setup/view-bandwidth-and-disk-usage" target="_blank">How to Monitor Disk Space and Bandwidth Usage in WHM</a>. Unfortunately, you cannot remove files through the WHM, you will need to access the cPanel <a href="/support/edu/cpanel/cpanel-file-manager/using-file-manager-in-cpanel" target="_blank" title="Click here for info">File Manager</a> for the account that has the large disk space usage and remove the files / folder through File manager.</p>
<p>&nbsp;</p>
<h2>How to find files with a certain size</h2>
...
<p class="alert"><strong>Important!</strong> You must have permission to access the files you are searching for. If not you will get permissions errors.</p>
<h3>Finding all file sizes with the "<em>du</em>" command</h3>
<p>The following command will display all files and folders sorted by MegaBytes.</p>
<pre class="cli" style="margin-left: 20px;">du --max-depth=1 | sort -n | awk 'BEGIN {OFMT = "%.0f"} {print $1/<span style="color: #ff0000;"><strong>1024</strong></span>,"MB", $2}'</pre>
<p>You should see an output of all your folders with the size of them in megabytes similar to the following:</p>
<pre class="cli" style="margin-left: 20px;">0 MB ./.htpasswds
0 MB ./.trash
0 MB ./public_ftp
0 MB ./etc
0 MB ./.fontconfig
...
<h3>Finding specific file sizes using the "<em>find</em>" command</h3>
...
<pre class="cli" style="margin-left: 20px;">find /home -type f -size +<span style="color: #ff0000;">500000k</span> -exec ls -lh {} \; | awk '{ print $9 ": " $5 }'</pre>
<p>The previous command will output a similar result like the following.</p>
<pre class="cli" style="margin-left: 20px;">/home/userna5/public_html/error_log: 514M
/home/userna5/backup-userna5.tar.gz: 738M</pre>
...
<p>If you cannot fix the disk space issue on your server, you can have <a href="/support/website/website-troubleshooting/how-to-get-great-technical-support" target="_blank" title="Click here for how to contact support">tech support</a> look into the matter for you. If you do not have any space to free up and cannot find files to remove, you can always <a target="_blank" href="/support/website/general-server-setup/upgrade-downgrade-hosting-plan">upgrade your hosting plan</a> to a plan with a larger disk.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/general-server-setup/check-disk-space-through-shell&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/general-server-setup/check-disk-space-through-shell'></div>
	<script type='text/javascript'>
	  (function() {
...
<a name='comments'></a>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/e58239cee703399d88eb1d852b688fd2?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/e58239cee703399d88eb1d852b688fd2'>Amin Vanda</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-05 9:40 am</div>
				                <div><p>Perfect!Thanks for the tutorial!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8777);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-10190'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/b0187a946221a4839d43835037a2b8de?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/b0187a946221a4839d43835037a2b8de'>Mummy Ninja</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-27 1:03 am</div>
				                <div><p>Very useful. THis helped me find folders with lots of useless chuncks of data</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10190);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-12630'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/e356766dc9bd4d6cdfe28d0fe5b2aab4?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/e356766dc9bd4d6cdfe28d0fe5b2aab4'>Mark</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-10 10:25 pm</div>
				                <div><p>Very helpful. Thanks for the info.............</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12630);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-19338'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/b1c1f40a789a652966a93fffba6acde9?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/b1c1f40a789a652966a93fffba6acde9'>Phani</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-09 5:20 am</div>
				                <div>good one</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19338);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-22959'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/e6535c10ebc06631fed7277556ccbd80?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/e6535c10ebc06631fed7277556ccbd80'>Hamza Iqbal</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-26 2:32 pm</div>
				                <div>Receiving some errors???
...
du: cannot access `./proc/29976/task/4816': No such file or directory</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22959);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-27 4:40 pm</div>
				                <div>Hello Hamza,<br />
<br />
The error you are receiving is due to the process not being able to find specific files as they do not exist. Are you one of our customers? If so, are you on a VPS or Dedicated server? If so, you may want to contact our Live Support as this command should run fine for you.<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22995);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/79294421d07d24574a2cdce59b17f6c7?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/79294421d07d24574a2cdce59b17f6c7'>Srirama Raju</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-16 12:56 am</div>
				                <div><p>Very helpful... there were some hidden files which caused disk space discrepency in my case. This is bang on.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24241);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-24899'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/f256678460c5afe31bdab98049fcde6f?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/f256678460c5afe31bdab98049fcde6f'>anon</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-15 6:51 am</div>
				                <div><p>You can just use <strong>"du -h --max-depth=1 | sort -h" </strong>, so you dont need this awk-foo.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24899);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-24929'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/91c5c05a21527ee359842bc16c5acbd4?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/91c5c05a21527ee359842bc16c5acbd4'>Mithun chakravarti</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-16 4:55 am</div>
				                <div><p>my domain is example.in how may check my domain web space ,how uses and how free space in my site reply please.......</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24929);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-16 12:05 pm</div>
				                <div>Hello Mithun,<br />
<br />
Thank you for contacting us. The above guide explains how to check your disk space, are you having trouble with a step?<br />
<br />
If you are on shared server, we have a helpful guide on <a href="http://www.inmotionhosting.com/support/edu/cpanel/getting-started-cpanel/view-disk-bandwidth-usage-cpanel">How to See your Disk Space and Bandwidth Usage on Shared Servers</a>.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24942);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
