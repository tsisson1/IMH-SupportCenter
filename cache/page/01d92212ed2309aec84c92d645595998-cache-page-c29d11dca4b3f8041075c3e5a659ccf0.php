<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:70083:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-25/create-plugin/add-stylesheet" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-05-02T16:38:06-07:00" />
  <meta name="keywords" content="joomla 2.5 plugin add css using addstylesheet" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="You can use the addStyleSheet document function to add external css stylesheets to your Joomla 2.5 plugin." />
  <title>How to add a css StyleSheet to a Joomla 2.5 content plugin - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-25/create-plugin/add-stylesheet" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:c42e4e42f37f80e62b8572b233cce529 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to add a css StyleSheet to a Joomla 2.5 content plugin									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>17,951</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jun 25, 2012'><span style='color:#606060;'>Published:</span> May 2, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<p class="alert">Joomla 2.5 has reached its end of life as for 12/31/2014. Please be advised this may be a security risk to your website. You can view more information about the end of life <a href="https://docs.joomla.org/Joomla!_CMS_versions">here</a>.</p><br /><p>In <a href="/support/edu/joomla-25/create-plugin/hello-world">our Hello World Joomla 2.5 content plugin</a>, we only had the most necessary files - helloworld.php, helloworld.xml, and index.html. If you want to include css files within your plugin, you can easily do that using the addStyleSheet function. In this tutorial, we'll show you how to add css stylesheet files to your plugin.</p>
<p> </p>
<h2>Step 1: Create the CSS Stylesheet</h2>
<p>The first thing to do is to actually create the css stylesheet. In our example, we created a css file named mystyle.css</p>
<p> </p>
<h2>Step 2: Reference your css file in your XML file</h2>
<p>After you've created your css file, you need to update your plugin's XML file to include the css file. In our example, we need to add mystyle.css to our helloworld.xml file. Here is the section of code we used to accomplish this:</p>
<pre class="code_block" style="max-width: 560px;">&lt;files&gt;
    &lt;filename plugin="helloworld"&gt;helloworld.php&lt;/filename&gt;
    &lt;filename&gt;index.html&lt;/filename&gt;
    <span style="color: #ff0000;"><strong>&lt;filename&gt;mystyle.css&lt;/filename&gt;</strong></span>
&lt;/files&gt;
</pre>
<p>In this example, we used <span style="color: #ff0000;"><strong>&lt;filename&gt;</strong></span> to include <span style="color: #ff0000;"><strong>mystyle.css</strong></span>.</p>
<p> </p>
<h2>Step 3: Load the stylesheet using addStyleSheet</h2>
<p>The last thing we need to do is load the stylesheet using addStyleSheet. We can do this within the onContentPrepare function, as in:</p>
<pre class="code_block" style="max-width: 560px;">public function onContentPrepare($context, &amp;$row, &amp;$params, $page = 0)
{
    <span style="color: #ff0000;"><strong>$document = JFactory::getDocument();
    $document-&gt;addStyleSheet(JURI::base(). "plugins/content/helloworld/mystyle.css");</strong></span>
}
</pre>
<p>As you can see, we first declared $document, and then we used the $document-&gt;addStyleSheet to add the URL of the stylesheet to the document. As this css file is now included within the plugin, we can get the absolute URL of the plugin using a combination of <strong>JURI::base()</strong> along with the path to the file starting with <strong>plugins/content</strong>.</p>
<p>The above lines of code add the following reference in the head of our Joomla 2.5 page:</p>
<p class="code_block">&lt;link rel="stylesheet" href="http://example.com/plugins/content/helloworld/mystyle.css" type="text/css" /&gt;</p>
<p> </p>
<p>If you have any trouble with adding css files to a Joomla 2.5 plugin, post a question in the comments at the bottom of this page and we'll more than happy to help!</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 14: How to add a css StyleSheet to a Joomla 2.5 content plugin</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 13: <a href='/support/edu/joomla-25/create-plugin/changing-text-using-oncontentprepare'>Use onContentPrepare to change Article text in a Joomla 2.5 plugin</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 15: <a href='/support/edu/joomla-25/create-plugin/add-javascript'>How to add external js javascript files to a Joomla 2.5 plugin</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-25/create-plugin/add-stylesheet&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-25/create-plugin/add-stylesheet'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yMTcmaWQ9MTUwOSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="807a2d5deca228a842b3604957feb2f9" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-11-20 11:04 am</div>
				                <div>Thanks for this helpful tutorial. FYI, &amp; JFactory throws strict warning (if it is enabled) &quot;Strict Standards: Only variables should be assigned by reference&quot;. Following works flawlessly without warnings.<br />
$document = JFactory::getDocument();<br />
<br />
Same thing applies here http://www.inmotionhosting.com/support/edu/joomla-25/create-plugin/add-javascript</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8408);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-11-20 5:48 pm</div>
				                <div>&lt;div style=&quot;background-color: #FFF; padding-left: 10px;&quot;&gt;Hello hassanz,<br />
<br />
Thank you for the information, I did some quick searching and confirmed from the PHP manual about &lt;a href=&quot;http://php.net/manual/en/language.operators.assignment.php&quot; target=&quot;_blank&quot;&gt;PHP assignment by reference&lt;/a&gt;:<br />
<br />
&lt;em&gt;&quot;As of PHP 5, the new operator returns a reference automatically, so assigning the result of new by reference results in an E_DEPRECATED message in PHP 5.3 and later, and an E_STRICT message in earlier versions.&quot;&lt;/em&gt;<br />
<br />
I've gone ahead and updated both articles. Thanks again for the input!<br />
<br />
- Jacob&lt;/div&gt;</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8410);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-13491'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/7512a2ea7f2a630882a86a85842fcbd5?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/7512a2ea7f2a630882a86a85842fcbd5'>samir</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-31 5:52 am</div>
				                <div><p>nice tutorial...</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13491);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
