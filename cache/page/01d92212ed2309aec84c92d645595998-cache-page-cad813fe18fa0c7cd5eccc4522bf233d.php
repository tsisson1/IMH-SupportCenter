<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:56047:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-3/301-need-php-5-3-1" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-10-23T18:59:13-07:00" />
  <meta name="keywords" content="joomla 3.0 php 5.3.1" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="If your hosting provider is not running PHP version 5.3.1 or higher, you will receive the following error message when installing Joomla 3.0 : Your host needs to use PHP 5.3.1 or higher to run this version of Joomla!" />
  <title>301: Your host needs to use PHP 5.3.1 or higher to run this version of Joomla! - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-3/301-need-php-5-3-1" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:6d498268aaf78251a36703fbe29da3e3 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '107.151.136.194']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															301: Your host needs to use PHP 5.3.1 or higher to run this version of Joomla!									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>25,760</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jul 13, 2012'><span style='color:#606060;'>Published:</span> Oct 23, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/alpha-1/you-need-php-5.3.1.gif"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/alpha-1/you-need-php-5.3.1.gif" alt="you-need-php-5.3.1"  style="margin: 0px 0px 15px 15px; float: right;" /></a></p>
<p>While <a href="/support/edu/joomla-3/getting-started/install-joomla-3">installing Joomla 3.0</a> Alpha-1, we ran into the following error message as soon as we began testing:</p>
<p><strong>Your host needs to use PHP 5.3.1 or higher to run this version of Joomla!</strong></p>
<div style="clear: both;">&nbsp;</div>
<p>&nbsp;</p>
<h2>Fixing the problem - do you host with InMotion Hosting?</h2>
<table class="article_table">
<tbody>
<tr><th>I DO NOT host with InMotion Hosting</th><th>I DO host with InMotion Hosting!</th></tr>
<tr>
<td>
<p>If you don't host your website with InMotion Hosting, you'll need to contact your hosting provider for more help with this error. The problem is that you're not running the latest version of PHP, and so your host will need to address this issue.</p>
</td>
<td>
<p>If you do host with InMotion Hosting, you're in luck becase we make it easy to switch between different versions of PHP. <a href="/support/website/general-server-setup/how-to-change-the-php-version-your-account-uses">Follow this guide</a> and learn how to easily toggle the version of PHP your account uses.</p>
</td>
</tr>
</tbody>
</table>
<p>&nbsp;</p>
<h2>After upgrading to PHP 5.3.1</h2>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/alpha-1/php-version-fixed.gif"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/alpha-1/php-version-fixed.gif" alt="php-version-fixed"  style="margin: 0px 0px 15px 15px; float: right;" /></a>After you have upgraded to PHP version 5.3.1, you should no longer receive the warning message, and should instead be able to view step 1 of the <a href="/support/edu/joomla-3/getting-started/install-joomla-3">Joomla 3.0 installation process</a>.</p>
<div style="clear: both;">&nbsp;</div> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 31: 301: Your host needs to use PHP 5.3.1 or higher to run this version of Joomla!</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 30: <a href='/support/edu/joomla-3/edit-template'>How to edit a Joomla 3 template</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-3/301-need-php-5-3-1&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-3/301-need-php-5-3-1'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xMDEmaWQ9MjM5MiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="5ccecb72775defae4e22b334fde912d0" value="1" />	</div>
	</form>
<!-- <br />
