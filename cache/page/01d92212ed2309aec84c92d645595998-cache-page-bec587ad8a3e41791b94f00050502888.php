<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49940:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/dns-nameserver-changes/dns-entries" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Thank you for your question uprooted! You can point your domain nameservers to our nameservers to direct the entire domain DNS to our server. Changing t..." />
  <title>DNS Entries | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/dns-nameserver-changes/dns-entries" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:f94b5664011dc12e4e0426ff25389a4e -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>DNS Entries</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/uprooted'>uprooted</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-03-27 1:28 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>319</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I Have created a new Joomla site on my new inmotionhosting account. however I wanted to know where to point my dns to. right now www.mydomain.com, ftp.mydomain.com point to my old host. Let me know so that I can point my domain to the new joomla site.</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_2582' id='upvote_answer_2582' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='2582' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_2582').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_2582' id='downvote_answer_2582' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='2582' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_2582').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>5,889 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2013-03-27 1:38 pm EST
                		        </div>
					
		                </div>

				Thank you for your question uprooted!<br />
<br />
You can point your domain nameservers to our nameservers to direct the entire domain DNS to our server. Changing the nameservers to ours will load all DNS entries on your server with us.<br />
<br />
&lt;a href=&quot;http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/updating-your-domains-nameservers&quot;&gt;Updating your domain's dns / nameservers&lt;/a&gt;<br />
<br />
Or you can point the A records for your domain to your server IP address. This will keep the DNS at your current host and point the www and ftp subdomains to your server with us. Email will stay at your old host.<br />
<br />
&lt;a href=&quot;http://www.inmotionhosting.com/support/website/cpanel/how-to-find-your-shared-ip-address-of-your-server-in-cpanel&quot;&gt;How to find your Shared IP address of your server in cPanel&lt;/a&gt;<br />
<br />
Best regards,<br />
James R<br />
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_2582').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_2582' id='form_comment_on_answer_2582' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/dns-nameserver-changes/dns-entries&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/dns-nameserver-changes/dns-entries'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="6a0b8c212891204e4ffe2c318f500cf0" value="1" />	</div>
	</form>
<!-- <br />
