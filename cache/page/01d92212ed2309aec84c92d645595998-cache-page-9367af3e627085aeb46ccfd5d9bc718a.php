<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50275:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/drupal-7/managing-users" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="How to add and manages the users of your Drupal 7 site. " />
  <title>107: Managing Users in Drupal 7 | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/drupal-7/managing-users" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:f817fbe93aae6c5195ea4acc8bd6e0da -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '93.198.197.115']);
...
<div class='page-header'>
	<h1>107: Managing Users in Drupal 7</h1>
</div>
<div class='section_listing'>
		...
		<tr>
				...
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/drupal-7/managing-users/creating-a-new-user-account-in-drupal-7'>Creating a New User Account in Drupal 7</a>
					<div>In this tutorial, we'll show you how to create a new user account in your Drupal 7 website. </div>
					<div class='smallgrey'>Hits: 10,831</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/drupal-7/managing-users/edit-who-can-register'>Editing who can register accounts in Drupal 7</a>
					<div>Drupal 7 allows you to choose who can register accounts. This setting is modified in the admin dashboard. This turorial walks you through how to do that.</div>
					<div class='smallgrey'>Hits: 3,657</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/drupal-7/managing-users/block-user-account'>How to block a user account in Drupal 7 </a>
					<div>Learn to block a user's account access in this Drupal 7 article.</div>
					<div class='smallgrey'>Hits: 3,004</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/drupal-7/managing-users/enable-user-signature'>How to enable user signatures in Drupal 7</a>
					<div>This Drupal 7 tutorial explains how to enable user signatures.</div>
					<div class='smallgrey'>Hits: 4,756</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/drupal-7/managing-users/disable-user-images'>How to disable user pictures in Drupal 7</a>
					<div>Here you will learn how to turn off the ability for users to use pictures in Drupal 7</div>
					<div class='smallgrey'>Hits: 3,574</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/drupal-7/managing-users/edit-image-directory'>How to change the picture upload directory in Drupal 7</a>
					<div>Wondering how to modify the directory your Drupal 7 stores images? This tutorial shows you how.</div>
			...
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/drupal-7/managing-users/set-default-user-pic'>How to set a default user picture in Drupal 7</a>
					<div>Learn how to set a default user picture in Drupal 7 with this tutorial.</div>
					<div class='smallgrey'>Hits: 9,160</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/drupal-7/managing-users/edit-image-display'>How to change the user image display style in Drupal 7</a>
					<div>This article demonstrates how to edit the image display style in Drupal 7.</div>
					<div class='smallgrey'>Hits: 6,680</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/drupal-7/managing-users/set-image-file-size'>How to modify the max picture upload file size in Drupal 7</a>
					<div>This tutorial for Drupal 7 shows you how to set the max file size for user image uploads.</div>
					<div class='smallgrey'>Hits: 2,837</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/drupal-7/managing-users/change-welcome-text'>How to change Welcome Mail text in Drupal 7</a>
					<div>This Drupal 7 article walks you through editing the body text for the Welcome Mail.</div>
					<div class='smallgrey'>Hits: 6,844</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/drupal-7/managing-users/set-activation-email'>How to edit Account Activation email text in Drupal 7</a>
					<div>This Drupal 7 tutorial explans how to edit the body text for the Account Activation email.</div>
					<div class='smallgrey'>Hits: 6,218</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/drupal-7/managing-users/edit-password-recovery'>How to modify the Password Recovery email text in Drupal 7</a>
					<div>This Drupal7 tutorial takes you through editing the Password Recovery email.</div>
					<div class='smallgrey'>Hits: 6,263</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/drupal-7/managing-users/disable-email-verification'>How to disable registration email verification for Drupal 7</a>
					<div>This Drupal 7 article walks you through disabling the email verification requirement for new users.</div>
			...
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/drupal-7/managing-users/edit-anonymous-username'>How to change the username for Anonymous users in Drupal 7</a>
					<div>This Drupal 7 article explains how to set the username used by Anonymous users.</div>
					<div class='smallgrey'>Hits: 3,658</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/drupal-7/managing-users/terminate-user-account'>How to cancel a user account in Drupal 7 </a>
					<div>Learn how to cancel accounts within the Drupal 7 admin dashboard.</div>
					<div class='smallgrey'>Hits: 8,190</div>
				</td>
			</tr>
			</table>
</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yMDcmaWQ9MjA3JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="50960830e044a3b645051dc0ee748da1" value="1" />	</div>
	</form>
<!-- <br />
