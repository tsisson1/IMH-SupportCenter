<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:57946:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/opencart/admin-tools/fix-opencart-email-notifications" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-04-22T17:32:20-07:00" />
  <meta name="author" content="Arnel Custodio" />
  <meta name="description" content="Opencart 1.5x notifications have been identified as having issues with some InMotion Hosting servers.  If you have an account with InMotion and you're not seeing new account or new order notifications, please make sure to follow this tutorial to resolve the problem." />
  <title>Fixing the Email issue with OpenCart 1.5 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/opencart/admin-tools/fix-opencart-email-notifications" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:fe03d11467292f1b811398de31b321b8 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-20']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '182.77.104.184']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Fixing the Email issue with OpenCart 1.5									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>636</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jul 17, 2015'><span style='color:#606060;'>Published:</span> Apr 22, 2016</div>
...
<p>If you are are an OpenCart ecommerce software user and find that emails never seem to come to you, then the information share below is for you. At present, this issue is known to affect OpenCart 1.5x users.  </p>


<h2>What is the problem?</h2>

<p>OpenCart can send emails back to an administrator for a variety of notices.  If you find that you're missing notification emails, such as a new user, order confirmation, and user feedback, then instructions below can fix your problem.</p>



<h2>How to fix the OpenCart Email Issue?</h2>

<ol class="article_list">

<li>If you are on a Business Hosting account or have a VPS/Dedicated server hosting account without root access, please submit a support ticket to our live support team asking to whitelist your domain on the server.   The command will look like this:  <i>sa_whitelist -a domain_name.com</i>.
</li>

<li><a href="http://www.inmotionhosting.com/support/edu/opencart/installing-opencart-and-adding-products/dashboard-login">Log into the OpenCart Administrator Dashboard</a> </li>

<li>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/fixing-opencart-email/opencart-sys-settings.jpg"><img style="float: right; margin: 0px 0px 15px 15px;" width="150"  alt="Select store from menu" src="//cdn.inmotionhosting.com/support/images/stories/fixing-opencart-email/opencart-sys-settings.jpg" align="right" /></a>

	<p>Click on <b>System</b>, then select your store and click on <b>Edit</b> at the far right of the screen. </p>
<div style="clear:both;"></div>
</li>


<li>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/fixing-opencart-email/opencart-settings-main.jpg"><img style="float: right; margin: 0px 0px 15px 15px;" width="150"  alt="Select store from menu" src="//cdn.inmotionhosting.com/support/images/stories/fixing-opencart-email/opencart-settings-main.jpg" align="right" /></a>
	<p>Click on the tab labeled <b>Mail</b></p>
<div style="clear:both;"></div>
</li>

<li>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/fixing-opencart-email/opencart-mail-parameters.jpg"><img style="float: right; margin: 0px 0px 15px 15px;" width="150"  alt="Select store from menu" src="//cdn.inmotionhosting.com/support/images/stories/fixing-opencart-email/opencart-mail-parameters.jpg" align="right" /></a>
<p>Click on the field in <b>Mail Parameters</b> and then type the following:  <b>-fnoreply@emailaddress.com</b>.  The "emailaddress.com" should be the URL for your domain.</p>
<div style="clear:both;"></div>
</li>
</ol>
<br />
<p>Once you have the mail parameter changed and saved you will need to test it. Test the changes by using the "Contact us" form. You should also run a test with test orders and new account alerts to verify that the email notifications from OpenCart are working properly. If you continue to have problems, please make sure to <a href="http://www.inmotionhosting.com/support/website/getting-started-guides/submitting-and-checking-on-status-of-tickets">submit a support ticket</a> to our live technical support department to double-check the email functionality on your server</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 1: Fixing the Email issue with OpenCart 1.5</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 2: <a href='/support/edu/opencart/admin-tools/forgot-password-link'>Resetting your OpenCart 1.5 Admin Password with the Forgot Password link</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/opencart/admin-tools/fix-opencart-email-notifications&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/opencart/admin-tools/fix-opencart-email-notifications'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xNTcmaWQ9MzYwMiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
