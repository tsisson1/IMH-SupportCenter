<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:54439:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/wordpress/method-not-implemented-get-to-not-supported-additionally-a-404-n" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Angello, Thanks for the question and sorry for the problem! If you had a problem after installing a plugin, then it may be the cause of your probl..." />
  <title>Method Not Implemented  GET to / not supported.  Additionally, a 404 N | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/wordpress/method-not-implemented-get-to-not-supported-additionally-a-404-n" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:296d4000cfd789240809de553542c3dd -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Method Not Implemented  GET to / not supported.  Additionally, a 404 N</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-11-20 8:57 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>1,608</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>hi, i installed the hello bar in my site and then got this error, can´t get even in the admin login page anymore, i hope i did not screw it, thanks for any support</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_4246' id='upvote_answer_4246' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='4246' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_4246').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_4246' id='downvote_answer_4246' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='4246' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_4246').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Angello,<br />
<br />
Thanks for the question and sorry for the problem!  If you had a problem after installing a plugin, then it may be the cause of your problem.  Check our article on <a href="http://www.inmotionhosting.com/support/edu/wordpress/338-troubleshooting-wordpress-plugins" target="new">Troubleshooting WordPress plugins</a>.  Basically, manually disable your plugin and then see if your site comes up.  If it works, then the plugin most likely not compatible or the source of the issue.<br />
<br />
Kindest regards,<br />
Arnel C.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_4246').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_4246' id='form_comment_on_answer_4246' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hi Arn, the thing is that I had a blank page, with the error, no way to get into the admin to uninstall anything, I had to delete the whole site and upload it from scratch ( it was just installed anyway, I did not lose anything but a couple of hours maybe) anyway I got scared, I installed the GENESIS framework with it´s default template, and I thought it may be unstable, have you heard anything about it? or I think it might be instead the Hello bar for Wordpress, I really don´t know what happened but it could be a total disaster and want to know what happened so if it happens to me again in the future when the site is already running it don´t crash again.<br />
Thanks for your support</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>&lt;div style=&quot;background-color: #FFF; padding-left: 10px;&quot;&gt;Hello Angello,<br />
<br />
As is mentioned in our &lt;a href=&quot;http://www.inmotionhosting.com/support/edu/wordpress/338-troubleshooting-wordpress-plugins&quot; target=&quot;_blank&quot;&gt;troubleshooting WordPress plugins&lt;/a&gt; guide, you don't need to login to your WordPress admin in order to disable a problematic plugin.<br />
<br />
For instance if you simply re-named your &lt;strong&gt;/wp-content/plugins/&lt;span style=&quot;color: red;&quot;&gt;hellobar&lt;/span&gt;&lt;/strong&gt; directory over FTP or in the cPanel file manager to &lt;strong&gt;/wp-content/plugins/&lt;span style=&quot;color: red;&quot;&gt;hellobar-old&lt;/span&gt;&lt;/strong&gt; this would disable that plugin from loading and hopefully allow you to access the admin interface again.<br />
<br />
If you take a look at the &lt;a href=&quot;http://wordpress.org/plugins/hellobar/&quot; target=&quot;_blank&quot;&gt;WordPress The Hello Bar&lt;/a&gt; plugin page, you'll see that it has a warning about the plugin being over 2 years old and no longer being maintained. So it's very possible that it has issues with a default WordPress install, or one using the &lt;strong&gt;Genesis framework&lt;/strong&gt;.<br />
<br />
...
- Jacob&lt;/div&gt;</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/wordpress/method-not-implemented-get-to-not-supported-additionally-a-404-n&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/wordpress/method-not-implemented-get-to-not-supported-additionally-a-404-n'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="4bbab9426316fda452783f83ffbf9abb" value="1" />	</div>
	</form>
<!-- <br />
