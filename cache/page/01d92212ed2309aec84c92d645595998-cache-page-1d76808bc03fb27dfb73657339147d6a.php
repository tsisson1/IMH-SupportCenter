<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49128:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/dreamweaver/where-can-i-find-the-correct-root-directory-for-my-website" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello ReelVisionMM, The root directory for your primary domain is the public_html folder. For addon domains (separate websites) it would be public_html/..." />
  <title>Where can I find the correct root directory for my website? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/dreamweaver/where-can-i-find-the-correct-root-directory-for-my-website" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:8b4fb0d1fd4778b0e016c0795225b4c5 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Where can I find the correct root directory for my website?</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/ReelVisionMM'>ReelVisionMM</a>
			<div>10 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-06-20 12:17 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>20,298</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I need to know where to find the correct root directory?</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_1173' id='upvote_answer_1173' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='1173' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_1173').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_1173' id='downvote_answer_1173' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='1173' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_1173').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>36,990 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2012-06-20 1:04 pm EST
                		        </div>
					
		                </div>

				Hello ReelVisionMM,<br />
<br />
The root directory for your primary domain is the public_html folder. For addon domains (separate websites) it would be public_html/domain.com  and for subdomains (like subdomain.domain.com) it would be public_html/subdomain.<br />
<br />
The Home directory (which is one level above the root for the primary domain name) is home/username  and can be found in the cpanel on the left sidebar under the label 'Home Directory'<br />
<br />
...
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_1173').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_1173' id='form_comment_on_answer_1173' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/dreamweaver/where-can-i-find-the-correct-root-directory-for-my-website&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/dreamweaver/where-can-i-find-the-correct-root-directory-for-my-website'></div>
<script type='text/javascript'>
  (function() {
