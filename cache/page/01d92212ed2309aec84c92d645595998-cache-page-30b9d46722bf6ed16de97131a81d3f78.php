<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50962:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/joomla-25/failed-to-authenticate-joomle-login-error" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello zishan! It looks like you may have enabled a plugin on your last login that requires authentication on the login. You can disable the plugin by fo..." />
  <title>&quot;Failed to authenticate&quot; error: Joomla login | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/joomla-25/failed-to-authenticate-joomle-login-error" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:480d92c7dbade1d4f60f5524a06b8d2e -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '37.255.69.93']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>&quot;Failed to authenticate&quot; error: Joomla login</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='http://graph.facebook.com/zishanforevryone/picture?type=normal' class='user_avatar' /><br />
			<a href='/support/community-support/users/zishan'>zishan</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-07-09 5:43 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>3,128</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>When i am login my joomla 2.5 it show -Failed to authenticate: Result Unknown. Access Denied what i do? How i login my a/c.</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_3517' id='upvote_answer_3517' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='3517' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_3517').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_3517' id='downvote_answer_3517' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='3517' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_3517').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello zishan!<br />
<br />
It looks like you may have enabled a plugin on your last login that requires authentication on the login. You can disable the plugin by following the tutorial for disabling a gmail plugin below.<br />
<br />
&lt;a href=&quot;&quot;http://forum.joomla.org/viewtopic.php?f=624&amp;t=709168&quot; target=&quot;_blank&quot;&gt;how to disable &quot;Authentication - GMail &quot; plugin ?&lt;/a&gt;<br />
<br />
You may have activated a different plugin, the instructions are generic for disabling a plugin through PhpMyAdmin.<br />
<br />
Best Regards,<br />
James R<br />
<br />
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_3517').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_3517' id='form_comment_on_answer_3517' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/joomla-25/failed-to-authenticate-joomle-login-error&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/joomla-25/failed-to-authenticate-joomle-login-error'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="554beacfdf8df7c5f1504b9a2636600a" value="1" />	</div>
	</form>
<!-- <br />
