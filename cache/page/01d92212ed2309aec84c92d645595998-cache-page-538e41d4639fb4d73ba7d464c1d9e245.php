<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:66871:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/smf/administration/new-theme-install" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-01-23T18:45:44-08:00" />
  <meta name="keywords" content="install theme template SMF 2.0" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Make your site stand out from the crowd with a new theme! Learn how to install one here with this SMF 2.0 tutorial." />
  <title>How to install a new theme in SMF 2.0 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/smf/administration/new-theme-install" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:12630660984c252df395a81c60be381b -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '15.65.252.14']);
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/smf' itemprop='url'><span itemprop='title'>SMF<span></a><div class='dropdown_4columns'><h2>SMF Education Channel</h2><div class='col_2'><h3>100 Level Classes</h3><div><a href='/support/edu/smf/getting-started-smf'>101: Getting Started in SMF</a></div><div><a href='/support/edu/smf/forum-management'>102: Managing your Forums in SMF 2.0</a></div><div><a href='/support/edu/smf/managing-users'>103: Managing Users in SMF 2.0</a></div></div><div class='col_2'><h3>200 Level Classes</h3><div><a href='/support/edu/smf/forum-maintenance'>201: Forum maintenance for SMF 2.0</a></div><div><a href='/support/edu/smf/administration'>202: General Administration in SMF 2.0</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/smf/administration' itemprop='url'><span itemprop='title'>202: General Administration in SMF 2.0<span></a><div class='dropdown_3columns'><h2> General Administration in SMF 2.0</h2><div class='col_3'><div>1. <a style='display:inline;' href='/support/edu/smf/administration/theme-settings'>How to manage your theme settings in SMF 2.0</a></div><div>2. <a style='display:inline;' href='/support/edu/smf/administration/editing-groups'>How to edit group permissions in SMF 2.0</a></div><div>3. <a style='display:inline;' href='/support/edu/smf/administration/smtp'>Setting SMTP settings in SMF 2.0</a></div><div>4. <a style='display:inline;' href='/support/edu/smf/administration/title-change'>How to change the header title in SMF 2.0</a></div><div>5. <a style='display:inline;' href='/support/edu/smf/administration/upload-logo'>Changing your logo in SMF 2.0</a></div><div>6. <a style='display:inline;' href='/support/edu/smf/administration/footer-change'>How to edit the footer in SMF 2.0</a></div><div>7. <a style='display:inline;' href='/support/edu/smf/administration/new-theme-install'>How to install a new theme in SMF 2.0</a></div><div>8. <a style='display:inline;' href='/support/edu/smf/administration/remove-stock-logo'>How to remove the SMF logo from your header</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to install a new theme in SM...</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to install a new theme in SMF 2.0									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>1,898</span></div>
							...
							<div style='clear:both;'></div>
								...
								<p>When working with your SMF community forum website, you will work hard to make it stand out. The most popular way to customize the site is to install a new theme, sometimes called a template. Themes and templates come in many different styles, so you may need to try a few to decide which is best for your site. You may even want to install more than one and use different ones seasonally. The article below will guide you on installing a new theme in your SMF 2.0 site.</p>
<h2>Installing a theme in SMF 2.0</h2>
<ol class="article_list">
<li>Find the theme you desire. The SMF main site has an area <a href="http://custom.simplemachines.org/themes/">dedicated to themes</a>.</li>
<li><a href="/support/edu/smf/getting-started-smf/smf-admin-login">Log into your SMF admin dashboard</a>.</li>
<li>From the entry page, click <strong>Admin</strong> from the upper menu. This will reveal a second menu just underneath the first. Hover over <strong>Configuration</strong> and click on <strong>Themes and Layout</strong> from the popup submenu.</li>
<li>A new third menu will appear under the second related to Themes. Select the first option, named <strong>Manage and Install</strong> to continue to the next screen.</li>
<li>This screen is the for theme management. To install the theme you downloaded, scroll down to the bottom and find the <em>Install a New Theme</em> section.</li>
<li>Click on the <strong>Browse</strong> button to select the theme file from your local machine. Once you select your theme, click on the <strong>Install</strong> button to begin the install. A popup will appear and ask you to confirm the install, click the <strong>OK</strong> button to confirm.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/smf/theme/install/select-theme.png"><img  alt="select theme to install" src="//cdn.inmotionhosting.com/support/images/stories/edu/smf/theme/install/select-theme.png" /></a></li>
<li>After installing, you will receive an installation success message. Click the <strong>Back</strong> button to return to the previous page so you can activate the new theme.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/smf/theme/install/install-complete.png"><img  alt="theme install complete" src="//cdn.inmotionhosting.com/support/images/stories/edu/smf/theme/install/install-complete.png" /></a></li>
<li>Now that you have installed the theme, look for the <em>Themes and Layout Settings</em> section. There will be a dropdown entitled <strong>Overall Forum Default:</strong>. Find and select your new theme. In our example, we installed the <em>Bluebird</em> theme.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/smf/theme/install/theme-drop.png"><img  alt="select theme dropdown" src="//cdn.inmotionhosting.com/support/images/stories/edu/smf/theme/install/theme-drop.png" /></a></li>
<li>Click the <strong>Save</strong> button to activate the new theme. You can see below how the install and activation of the Bluebird theme gives our test site a whole new look. Good luck with your own site!<br />
<table class="article_table">
<tbody>
<tr><th>Before</th><th>After</th></tr>
<tr>
<td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/smf/theme/install/theme-before.png"><img style="max-width: 250px;"  alt="before theme install" src="//cdn.inmotionhosting.com/support/images/stories/edu/smf/theme/install/theme-before.png" /></a></td>
<td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/smf/theme/install/theme-after.png"><img style="max-width: 250px;"  alt="after new theme activated" src="//cdn.inmotionhosting.com/support/images/stories/edu/smf/theme/install/theme-after.png" /></a></td>
</tr>
</tbody>
</table>
</li>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/smf/administration'>202: General Administration in SMF 2.0</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 7: How to install a new theme in SMF 2.0</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 6: <a href='/support/edu/smf/administration/footer-change'>How to edit the footer in SMF 2.0</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 8: <a href='/support/edu/smf/administration/remove-stock-logo'>How to remove the SMF logo from your header</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/smf/administration/new-theme-install&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/smf/administration/new-theme-install'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMTMmaWQ9MjIwMSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="6ac3e6c8cae5c1e77b4cf2670e6037d3" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/smf/administration?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> General Administration in SMF 2.0</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/smf/administration/theme-settings?tsrc=rsbedu'>How to manage your theme settings in SMF 2.0</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/smf/administration/editing-groups?tsrc=rsbedu'>How to edit group permissions in SMF 2.0</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/smf/administration/smtp?tsrc=rsbedu'>Setting SMTP settings in SMF 2.0</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/smf/administration/title-change?tsrc=rsbedu'>How to change the header title in SMF 2.0</a></td>
                </tr>
          <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/smf/administration/upload-logo?tsrc=rsbedu'>Changing your logo in SMF 2.0</a></td>
                </tr>
          <tr >
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/smf/administration/footer-change?tsrc=rsbedu'>How to edit the footer in SMF 2.0</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>7.</td>
                        <td><a href='/support/edu/smf/administration/new-theme-install?tsrc=rsbedu'>How to install a new theme in SMF 2.0</a></td>
                </tr>
          <tr >
                        <td valign='top'>8.</td>
                        <td><a href='/support/edu/smf/administration/remove-stock-logo?tsrc=rsbedu'>How to remove the SMF logo from your header</a></td>
                </tr>
          	</table>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/e25ad142e66c4ad829278fe3ed72e080?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/e25ad142e66c4ad829278fe3ed72e080'>Filip Dimovski</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-09 1:39 pm</div>
				                <div><p>well pls help i dont have a install theme when i scroll down</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29681);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-11 12:06 pm</div>
				                <div>Hello Filip,<br />
<br />
Thank you for contacting us. I first recommend <a href="http://www.inmotionhosting.com/support/website/php-troubleshooting/troubleshoot-php-errors">enabling error reporting</a>.We are happy to help, but will need some additional information to replicate the problem. What version of SMF are you running?<br />
<br />
What <a href="http://www.inmotionhosting.com/support/edu/smf/administration/new-theme-install">SMF theme</a> are you using?<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29704);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-14 11:17 am</div>
				                <div><p>i have problem with instaling smf it says &nbsp;<strong style="font-size: 12.48px; line-height: 16.224px; text-decoration: underline;">Critical Error!</strong></p>
<div style="font-size: 12.48px; line-height: 16.224px; padding-left: 6ex;">Cannot connect to the database server with the supplied data.If you are not sure about what to type in, please contact your host.
<div style="margin: 2.5ex; font-family: monospace;"><strong>Access denied for user 'a8241681_filip'@'10.1.1.27' (using password: YES)</strong></div>
</div></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29813);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-14 5:15 pm</div>
				                <div>Hello Filip,<br />
<br />
Thank you for contacting us. Since it seems you remotely connecting to a database, ensure you have added your IP address to the firewall of the server you are connecting to. This is covered in our guide <a href="http://www.inmotionhosting.com/support/website/databases/setting-up-a-remote-mysql-connection-in-cpanel">Setting up a Remote MySQL connection in cPanel</a>.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29819);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
