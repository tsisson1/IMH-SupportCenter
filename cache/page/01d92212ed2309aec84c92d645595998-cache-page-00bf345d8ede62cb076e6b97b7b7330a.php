<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:51380:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/how-to/how-to-login-to-resellers-customer-cpanel-account" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, Sorry to hear you are having issues with cpanel login. All domains should be able to access their cpanel via the format &quot;example.com/cpanel&quot;. Thi..." />
  <title>How to login to Reseller's Customer cpanel account? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/how-to/how-to-login-to-resellers-customer-cpanel-account" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:9fce01759d1480a0ee6d184a7c803d01 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '92.232.195.200']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>How to login to Reseller's Customer cpanel account?</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-06-12 1:48 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>293</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>After creating customer cpanel accounts in my reseller account, how do the customers login to their cpanel a/c?  <br />
domain/cpanel or domain:2083 redirects to my reseller url &amp;  returns 'invalid login'. <br />
 Logged in as a reseller I can switch cpanel accounts, but could you help with instructions to login as the individual cpanel owner.  I've even reset the password within WHM but cant guarantee 100% success logging in.</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_7436' id='upvote_answer_7436' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='7436' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_7436').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_7436' id='downvote_answer_7436' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='7436' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_7436').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
Sorry to hear you are having issues with <a href="http://www.inmotionhosting.com/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">cpanel login</a>. All domains should be able to access their cpanel via the format "example.com/cpanel". This is true however, only if the domain name is pointed to us. Failing that, they should also be able to access via the server name format "res###.servconfig.com/cpanel" (be sure to enter the server number in place of the ###).<br />
<br />
If you are continuing to have issues, then there may be an account specific reason. For that, you will need to contact our <a href="http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support">Live Support</a> so you can verify the account and they can assist with specific details.<br />
<br />
Kindest Regards,<br />
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_7436').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_7436' id='form_comment_on_answer_7436' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/how-to/how-to-login-to-resellers-customer-cpanel-account&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/how-to/how-to-login-to-resellers-customer-cpanel-account'></div>
<script type='text/javascript'>
  (function() {
