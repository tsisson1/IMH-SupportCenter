<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:44949:" 
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:dc0ba27d54707d34e7d15ae6c65caca7 -->
...
<div class='container'>
	...
	<div class='item-page'>
		<div class='page-header'><h1>Search results for: <span style='color:#aaa;'>soa</span></h1></div>
		<form method='get' action='/support/search' >
                        <input type='text' name='searchword' id='mod-search-searchword' style='width:500px;' value='soa' />
                        <button class='button btn btn-info' onclick='this.form.searchword.focus();' style='display:inline-block; width:80px; border-radius:3px; height:32px; line-height:22px; margin:0px;'>Search</button>
                	        ...
                	        <p><a href='http://www.inmotionhosting.com/support/community-support/dns-nameserver-changes/how-to-customize-my-soa-record-for-my-reseller-domain'>How to customize my <b>soa</b> record for my reseller domain? </a><br />Nov 18, 2015 <b>...</b> Thanks for the question about the <b>SOA</b> (Statement of Authority). Basically, if you <br>
have just changed it, it is possible that you&#39;re running into DNS&nbsp;...</p>
	                
                	        <p><a href='http://www.inmotionhosting.com/support/community-support/dns-nameserver-changes/i-just-created-an-addon-domain-but-making-nameserver-changes-its-telling-me-that-the-zone-check-failed-and-no-soa-record-is-being-returned'>I just created an add-on domain, but making nameserver changes <b>...</b></a><br />Apr 24, 2013 <b>...</b> I just created an add-on domain, but making nameserver changes, it&#39;s telling me <br>
that the zone check failed and no <b>SOA</b> record is being returned.</p>
	                
                	        <p><a href='http://www.inmotionhosting.com/support/community-support/dns-nameserver-changes/problems-with-dns-server-tests'>Problems with DNS server tests </a><br />Nov 16, 2012 <b>...</b> The <b>SOA</b> serial is not the same on all name servers. This is usually due to <br>
misconfiguration, but can sometimes be the result of slow zone&nbsp;...</p>
	                
                	        <p><a href='http://www.inmotionhosting.com/support/community-support'>Community Support </a><br />4 days ago <b>...</b> InMotionFans asks: I recently set up a new email account on my domain. I am <br>
using the Roundcube webmail client. I followed the instructions to&nbsp;...</p>
	                
                	        <p><a href='http://www.inmotionhosting.com/support/community-support/email-troubleshooting/missing-spf-due-to-unable-to-verify-authoritative-name-server'>Missing SPF - Due to unable to verify authoritative name server <b>...</b></a><br />Apr 8, 2014 <b>...</b> dns voxperitus.com <b>SOA</b> Refresh Value is outside of the recommended range <br>
dns voxperitus.com <b>SOA</b> Expire Value out of recommended&nbsp;...</p>
	                
                	        <p><a href='http://www.inmotionhosting.com/support/community-support/domain-names/how-can-i-tell-when-my-dns-was-last-updated'>How can I tell when my dns was last updated? </a><br />Oct 4, 2013 <b>...</b> A DNS &lt;strong&gt;<b>SOA</b> serial&lt;/strong&gt; can be read as the time-stamp when the <br>
DNS records were last seen to be updated. In this case our:</p>
	                
                	        <p><a href='http://www.inmotionhosting.com/support/community-support/dns-nameserver-changes/nameserver-requirements-to-de-domain-name'>nameserver requirements to .de domain name </a><br />Oct 22, 2012 <b>...</b> You must have a Start of Authority (<b>SOA</b>) refresh value between 10000 and <br>
86400 seconds. You must have a retry value between 1800 and&nbsp;...</p>
	                
                	        <p><a href='http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes'>DNS and Nameserver Changes </a><br />To get your domain working on your server with InMotion Hosting, you will need <br>
to point your domain to our server. You can point your domain Using a DNS&nbsp;...</p>
	                
                	        <p><a href='http://www.inmotionhosting.com/support/community-support/website-transfers/move-website-form-one-account-to-another-within-inmotion'>Move website form one account to another within InMotion </a><br />Nov 28, 2013 <b>...</b> The first thing to look for would be the &lt;strong&gt;<b>SOA</b>&lt;/strong&gt; string and <br>
specifically the &lt;strong&gt;Serial Number&lt;/strong&gt; which would look&nbsp;...</p>
	                
                	        <p><a href='http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/updating-your-domains-nameservers'>Updating Your Domain&#39;s DNS / Nameservers - InMotion Hosting</a><br />Dec 20, 2014 <b>...</b> ... the nameservers in home.pl it returns an error message saying that the DNS <br>
servers are not configured properly - <b>SOA</b> records are missing.</p>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP3NlYXJjaHdvcmQ9c29hJm9wdGlvbj1jb21fY29udGVudCZjYXRpZD0zNTYmaWQ9MzU2JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
