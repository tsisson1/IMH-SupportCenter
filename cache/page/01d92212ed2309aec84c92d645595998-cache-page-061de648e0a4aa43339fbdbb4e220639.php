<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50850:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/wordpress/wordpress-admin-login-not-working" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello MikeT, Sorry for the problem with your WordPress Admin login not working. It appears that you are forcing an HTTPS connection somewhere. You do NO..." />
  <title>Wordpress Admin login not working??? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/wordpress/wordpress-admin-login-not-working" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:46b633a0b7e8ec958dfa38b5f996f1a6 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Wordpress Admin login not working???</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/MikeT'>MikeT</a>
			<div>10 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-08-12 11:49 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>111</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I just installed WordPress to my site and received the confirmation email with logins and password, but when I click the link to the /wp-admin/ I get a site error message:<br />
&quot;This webpage is not available<br />
<br />
ERR_CONNECTION_CLOSED&quot;<br />
<br />
Any ideas as to why?</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_7897' id='upvote_answer_7897' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='7897' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_7897').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_7897' id='downvote_answer_7897' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='7897' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_7897').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello MikeT,<br />
<br />
Sorry for the problem with your WordPress Admin login not working.  It appears that you are forcing an HTTPS connection somewhere.  You do NOT have an SSL certificate setup for that domain name, so it will fail.  You can <a href="http://www.inmotionhosting.com/support/website/ssl/how-do-i-obtain-an-ssl-certificate">purchase an SSL certificate through AMP</a> if needed.  Shared servers do have an SSL certificate installed, but bear in mind that they are made to work with the server name, as opposed to any specific customer domain name.  Remove the SSL requirement and your login will work.  If you set it up through a plugin, you will need to disable that plugin.  You could also very quickly delete the current WordPress site and reinstall it using Softaculous.<br />
<br />
...
Arnel C.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_7897').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_7897' id='form_comment_on_answer_7897' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
...
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/wordpress/wordpress-admin-login-not-working'></div>
<script type='text/javascript'>
  (function() {
