<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:61848:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/joomla/how-to-add-contact-form-inside-articles-of-joomla" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello pirate_love20, You can easily Add a google map to your contact form in Joomla. Also, you can assign where the contact form redirects to in the Con..." />
  <title>How to add contact form inside articles of joomla | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/joomla/how-to-add-contact-form-inside-articles-of-joomla" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:17c7b08103afabee6616e4bc59aa53e0 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box straight_bottom'>
                <h1 style='font-size:26px;'>How to add contact form inside articles of joomla</h1>
		<div style='margin-bottom:20px; margin-top:10px; clear:both; color:#6e6e6e;'>Category: <a href='/support/community-support/joomla'>Joomla</a></div>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='http://graph.facebook.com/lohith.manjunath.7/picture?type=normal' class='user_avatar' /><br />
			<a href='/support/community-support/users/lohitm86'>lohitm86</a>
			<div>14 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-06-24 4:56 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>10,710</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Hi.. i am new to joomla. could you tell me how to add contact form in articles.. I have created contact form but i have to add the same contact form in the other article pages of joomla site.. i am using joomla 1.8 version.. Need a severe help.. thank you...</div>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px;'>
				<div style='font-size:12px; max-width:500px; overflow:auto;'>sorry its joomla 1.5.9 version</div>
				
				
			</td>
			<td style='width:100px;' valign='top'>
				<img src='http://graph.facebook.com/lohith.manjunath.7/picture?type=normal' style='width:40px;' class='user_avatar' />
				<div class='smallgrey'>
					<a href='/support/community-support/users/lohitm86'>lohitm86</a><br />
					14 <a href='/support/team/points' target='_blank'>Points</a><br />
					2013-06-24 02:38 pm EST
				</div>
			</td>
		</tr>
	</table>
...
<div style='padding:15px; border:1px solid #d6d6d6; border-top:0px; background:#ebebeb;' class='round_bottom' >
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px;'>
				<div style='font-size:12px; max-width:500px; overflow:auto;'>I would like a Joomla 3.1 Article with content (e.g : google map, paragraph, etc) and then the contact form at the bottom of the article.<br />
I've  copy the html code from one of my contacts , i think it works and send email but after the submit its redirect to that  contact . <br />
how can stop or change the redirection or what is the best solution to do ?<br />
Thanks<br />
</div>
			...
			<td style='width:100px;' valign='top'>
				<img src='https://lh4.googleusercontent.com/-ISTnjQ33i44/AAAAAAAAAAI/AAAAAAAAAOg/lo8pJCL0SPE/photo.jpg?sz=90' style='width:40px;' class='user_avatar' />
				<div class='smallgrey'>
					<a href='/support/community-support/users/pirate_love20'>pirate_love20</a><br />
					0 <a href='/support/team/points' target='_blank'>Points</a><br />
					2013-12-16 04:42 am EST
				</div>
			</td>
		</tr>
	</table>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_3402' id='upvote_answer_3402' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='3402' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_3402').submit();"></div>
	</form>
	<div class='vote_sum'>1</div>
	<form method='post' name='downvote_answer_3402' id='downvote_answer_3402' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='3402' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_3402').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					<img src='https://lh5.googleusercontent.com/-sqOlcmmeoz4/AAAAAAAAAAI/AAAAAAAAAIM/EKb76fhiG6s/photo.jpg?sz=90' class='user_avatar' style='max-width:60px;' /><br />
                		        <a href='/support/community-support/users/jamesr'>jamesr</a>
					
					<div>5,889 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2013-06-24 9:53 am EST
                		        </div>
				...
				Hello lohitm86!<br />
<br />
You can use the Contact forms and menus to do this. Please see the following.<br />
<br />
&lt;a href=&quot;http://www.inmotionhosting.com/support/edu/joomla-3/contacts-component/understanding-contact-pages&quot; target=&quot;_blank&quot;&gt;How Contact Forms work in Joomla 3.0 &lt;/a&gt;<br />
<br />
&lt;a href=&quot;http://www.inmotionhosting.com/support/edu/joomla-3/contacts-component/menu-item&quot; target=&quot;_blank&quot;&gt;How to Create a Contacts Menu Item in Joomla 3.0&lt;/a&gt;<br />
<br />
Unfortunately, we do not have any information for the 1.8 version of Joomla. Sorry for this.<br />
<br />
Best Regards,<br />
James R
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_3402').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_3402' id='form_comment_on_answer_3402' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hi.. jamesr.. thank you for your reply. sorry i have given wrong joomla version.. its 1.5.9.... the plugin whatever i got are not supporting to this.. example article contact us form, rapid contact us form... i tried with chrono forms and flexi contact form also but they are providing menu option.. any suggestions for this.... need a severe help..........................</div>
							...
							<td style='width:96px;' valign='top'>
								...
								<div class='smallgrey'>
									<a href='/support/community-support/users/lohitm86'>lohitm86</a><br />
									14 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2013-06-24 2:03 pm EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>I m sorry for the trouble. Unfortunately, the Joomla 1.X versions are not longer supported and are labeled a security risk by Joomla. Please see the below.<br /> <br /> &lt;a href=&quot;http://www.inmotionhosting.com/support/website/joomla/upgrade-joomla-1-5-security-vulnerabilities&quot; target=&quot;_blank&quot;&gt;upgrade joomla 1.5 to 2.5&lt;/a&gt;<br /> <br /> Sorry we could bot be more help on this.<br /> <br /> </div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='https://lh5.googleusercontent.com/-sqOlcmmeoz4/AAAAAAAAAAI/AAAAAAAAAIM/EKb76fhiG6s/photo.jpg?sz=90' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/jamesr'>jamesr</a><br />
									5,889 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2013-06-24 2:38 pm EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>James.. but i dont know anything i mean the working process of the website.. if i migrate to newer version of joomla.. is it not going to affect the functionality of the site.. or any other supporting plugins and extensions.. etc...</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Because Joomla 1.x versions are outdated and unsupported, you will see loss of functionality when upgrading. You may want to rebuild the site on a separate testing domain to get the site up to date with the newest features. Sorry for the trouble.</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Ok.. thank you James.... thanks alot for your valuable suggestions....</div>
...
<div class='  not_best_answer'>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px; width:50px;' valign='top'>
<div class='vote_div'>
	<form method='post' name='upvote_answer_4323' id='upvote_answer_4323' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='4323' />
		<input type='hidden' name='component' id='component' value='qa' />
		<input type='hidden' name='vote_value' id='vote_value' value='1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_4323').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_4323' id='downvote_answer_4323' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='4323' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_4323').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>22,986 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2013-12-16 9:55 am EST
                		        </div>
					
		                </div>

				Hello pirate_love20,<br />
<br />
You can easily <a href="http://forum.joomla.org/viewtopic.php?t=474910" target="_blank" >Add a google map</a> to your contact form in Joomla.<br />
<br />
Also, you can assign where the contact form redirects to in the <strong>Contact Redirect</strong> setting of the Joomla dashboard, here is a link to our guide titled "<a href="http://www.inmotionhosting.com/support/edu/joomla-3/contacts-component/contact-redirect" target="_blank" >Redirecting forms to specific pages in Joomla 3.1</a>." <br />
<br />
This is part of our Education Channel titled "<a href="http://www.inmotionhosting.com/support/edu/joomla-3/contacts-component" target="_blank" >Joomla 3.1 Contacts Component Tutorial</a>," which will help you setup a contact form.<br />
<br />
If your problems persist, please provide <em>step-by-step</em> instructions on what you are doing/clicking, so we can replicate the error. <br />
<br />
...
-John-Paul
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_4323').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_4323' id='form_comment_on_answer_4323' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
					                <p>You must <a href='/support/login'>login</a> before you can post a comment about this answer.</p>
					        </div></div></div></div>
					</form>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/joomla/how-to-add-contact-form-inside-articles-of-joomla&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/joomla/how-to-add-contact-form-inside-articles-of-joomla'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="77de8ece54e44590ccce7b7079317a75" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
                                ...
                                <h3>Related Articles</h3><a target='_blank' href='http://inmotionhosting.com/support/fix-joomla-hack-and-upgrade-for-security'>Fix Joomla Hack and Upgrade for Security</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/upgrade-joomla-1-5-security-vulnerabilities'>How to upgrade joomla 1.5 to 2.5</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/nivo-carousel-slide-settings'>Nivo Carousel Scroll Settings</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/reset-joomla-password'>How to reset your Joomla Password</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/install-joomla-to-temp-url'>How to install Joomla on your Temporary URL</a><br/><br />
		</div>
