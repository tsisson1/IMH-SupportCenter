<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:54104:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/nginx/getting-started-with-nginx/how-to-install-nginx" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-11-02T14:29:16-08:00" />
  <meta name="keywords" content="nginx proxy vps dedicated reverse cpanel nginxcp" />
  <meta name="author" content="TJ Edens" />
  <meta name="description" content="This article will explain how to install and start up nginx as a reverse proxy on your VPS or Dedicated server." />
  <title>How to Install Nginx - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/nginx/getting-started-with-nginx/how-to-install-nginx" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:dfa7cdc003ecc06c8f7416fc64384b63 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '100.9.200.56']);
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/nginx' itemprop='url'><span itemprop='title'>Nginx<span></a><div class='dropdown_2columns'><h2>Nginx Education Channel</h2><div class='col_2'><h3>100 Level Classes</h3><div><a href='/support/edu/nginx/getting-started-with-nginx'>101: Getting Started With Nginx</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/nginx/getting-started-with-nginx' itemprop='url'><span itemprop='title'>101: Getting Started With Nginx<span></a><div class='dropdown_3columns'><h2> Getting Started With Nginx</h2><div class='col_3'><div>1. <a style='display:inline;' href='/support/edu/nginx/getting-started-with-nginx/how-to-uninstall-nginx'>How to uninstall Nginx</a></div><div>2. <a style='display:inline;' href='/support/edu/nginx/getting-started-with-nginx/what-is-nginx'>What is Nginx?</a></div><div>3. <a style='display:inline;' href='/support/edu/nginx/getting-started-with-nginx/how-to-install-nginx'>How to Install Nginx</a></div><div>4. <a style='display:inline;' href='/support/edu/nginx/getting-started-with-nginx/basic-nginx-commands'>Basic Nginx Commands</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to Install Nginx</span></li>			</ul>
		</div>
	</div>
</div>
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>1,265</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Mar 10, 2015'><span style='color:#606060;'>Published:</span> Nov 2, 2015</div>
							...
							<div style='clear:both;'></div>
								...
								<p class="alert">This requires Apache version 2.2 as mod_remote is not available for Apache version 2.4.
</p>
</p><p>In the previous article we went over Nginx and what it is. In this article we will go over how to setup Nginx as a reverse proxy for apache which works natively on our <a href="http://www.inmotionhosting.com/vps-hosting">VPS</a>/<a href="http://www.inmotionhosting.com/dedicated-servers">Dedicated servers</a>. We will be using a cPanel addon called NginxCP, please also remember that this article does assume you already have <a href="http://www.inmotionhosting.com/support/website/cpanel-account-management/obtain-root-access">root access to your server</a>.</p>

<ol class="article_list">
  <li><a href="http://www.inmotionhosting.com/support/website/ssh/how-to-login-ssh">Log into your server via SSH</a> as the root user.<div style="clear:both;"></div></li>
  <li>Download our pre-made script which will download the addon and install it to your cPanel. Please run the following commands.<div class="cli"><span style="color:red">wget http://inmotionhosting.com/support/scripts/nginxcp.sh<br />chmod a+x nginxcp.sh<br />./nginxcp.sh</span>
    </div><div style="clear:both;"></div></li>
  <li>To finalize the installation you will need to restart apache.  <div class="cli"><span style="color:red">service httpd restart</span><br /></div><div style="clear:both;"></div></li>
</ol>

<p>At this time Nginx will be working natively on your server. In the next few articles we will go over controlling the server and how to modify the configuration.</p>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/nginx/getting-started-with-nginx'>101: Getting Started With Nginx</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 3: How to Install Nginx</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 2: <a href='/support/edu/nginx/getting-started-with-nginx/what-is-nginx'>What is Nginx?</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 4: <a href='/support/edu/nginx/getting-started-with-nginx/basic-nginx-commands'>Basic Nginx Commands</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/nginx/getting-started-with-nginx/how-to-install-nginx&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/nginx/getting-started-with-nginx/how-to-install-nginx'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD01MjYmaWQ9MzUxNCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="2ce7435e1c504c4707050b65c6c03bd0" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/nginx/getting-started-with-nginx?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Getting Started With Nginx</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/nginx/getting-started-with-nginx/how-to-uninstall-nginx?tsrc=rsbedu'>How to uninstall Nginx</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/nginx/getting-started-with-nginx/what-is-nginx?tsrc=rsbedu'>What is Nginx?</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/nginx/getting-started-with-nginx/how-to-install-nginx?tsrc=rsbedu'>How to Install Nginx</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/nginx/getting-started-with-nginx/basic-nginx-commands?tsrc=rsbedu'>Basic Nginx Commands</a></td>
                </tr>
          	</table>
			...
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/magento/need-some-help-regarding-new-vps?tsrc=rsbraq'>Need Some Help Regarding New VPS</a>
                                </div>
