<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:53905:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/horde-webmail/adding-image-to-signature" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Duffin, and thanks for your question. Unfortunately the Horde webmail client that we have doesn't support HTML code in the emails so it wouldn't b..." />
  <title>Adding image to signature | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/horde-webmail/adding-image-to-signature" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:5104be4020de7dcbb48e8c9c5d2210f6 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-22']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '200.189.56.49']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Adding image to signature</h1>
		<div style='margin-bottom:20px; margin-top:10px; clear:both; color:#6e6e6e;'>Category: <a href='/support/community-support/horde-webmail'>Horde Webmail</a></div>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/duffin'>duffin</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-11-09 1:10 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>25,091</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Howdy all<br />
How do I add an image to my email signature.<br />
I'm using the Inmotion Horde email system.<br />
Any way to add an image to Signature?<br />
<br />
Thanks<br />
Duffin</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_1856' id='upvote_answer_1856' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='1856' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_1856').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_1856' id='downvote_answer_1856' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='1856' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_1856').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>9,968 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2012-11-09 2:03 pm EST
                		        </div>
					
		                </div>

				Hello Duffin, and thanks for your question.<br />
<br />
Unfortunately the Horde webmail client that we have doesn't support HTML code in the emails so it wouldn't be able to directly embed an image in your signature.<br />
<br />
We do have another webmail client called RoundCube that does support this functionality though and you can read the following article about how to create an email signature using it:<br />
<br />
&lt;a href=&quot;http://www.inmotionhosting.com/support/email/roundcube-webmail/create-signature&quot;&gt;How to create an e-mail signature in RoundCube&lt;/a&gt;<br />
<br />
Under step 4 where it mentions placing a check mark on the &lt;strong&gt;HTML Signature&lt;/strong&gt; option, you'd want to do that and then follow these steps.&lt;br /&gt; <br />
&lt;ol class=&quot;article_list&quot;&gt;<br />
&lt;li&gt;Click on the &lt;strong&gt;HTML&lt;/strong&gt; icon which is for editing HTML source code.&lt;/li&gt;<br />
&lt;li&gt;In the pop-up HTML Source Editor window, enter in the following code replacing this image path with your own:&lt;br /&gt;<br />
<br />
&amp;lt;img src=&quot;http://img01.inmotionhosting.com/_img/head_logo.gif&quot;&amp;gt;<br />
&lt;br /&gt;<br />
&lt;/li&gt;<br />
&lt;li&gt;Click on &lt;strong&gt;Update&lt;/strong&gt; to be dropped back to the signature editing page.&lt;/li&gt;<br />
&lt;li&gt;Then click on &lt;strong&gt;Save&lt;/strong&gt; to save the signature.&lt;/li&gt;<br />
&lt;li&gt;Now once this has been done you'll want to click on &lt;strong&gt;Settings&lt;/strong&gt; up at the top-right.&lt;/li&gt;<br />
&lt;li&gt;From the left-hand menu click on &lt;strong&gt;Composing Messages&lt;/strong&gt;.&lt;/li&gt;<br />
&lt;li&gt;Then on the &lt;strong&gt;Compose HTML messages&lt;/strong&gt; drop-down menu, select &lt;strong&gt;Always&lt;/strong&gt;, and then click on &lt;strong&gt;Save&lt;/strong&gt;.&lt;/li&gt;<br />
&lt;/ol&gt;<br />
<br />
Now when you go to compose a new e-mail, you should see your image automatically appended to your signature at the bottom.<br />
<br />
I hope this information was helpful to you. If you run into any issues or have any further questions at all please let us know.<br />
<br />
- Jacob
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_1856').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_1856' id='form_comment_on_answer_1856' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Great, really works , thanksss</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='http://graph.facebook.com/rakel.vasquez.7/picture?type=normal' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/IdeaGenial'>IdeaGenial</a><br />
									3 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2013-10-21 9:26 pm EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>&lt;div style=&quot;background-color: #FFF; padding-left: 10px;&quot;&gt;Hello IdeaGenial,<br />
<br />
No problem, glad that worked for you!<br />
<br />
- Jacob&lt;/div&gt;</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Awesome, it works. Thanks a lot.</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='/support/images/avatars/default_avatar.jpg' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/zakiur83'>zakiur83</a><br />
									3 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2015-08-06 7:53 am EST
								</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/horde-webmail/adding-image-to-signature&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/horde-webmail/adding-image-to-signature'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="4657e2c4ab3c8dc1be8eec7339c69df6" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
                                ...
                                <h3>Related Articles</h3><a target='_blank' href='http://inmotionhosting.com/support/add-signature-image'>Adding an image or logo to your signature in Horde Mail</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/using-horde-mail-templates'>Using Horde mail templates</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/horde-groupware-webmail-edition-5'>Horde Groupware Webmail Edition 5</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/create-signature'>How to create an email signature in Horde Mail</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/configuring-global-options-in-horde'>Configuring global options in Horde</a><br/><br />
		</div>
