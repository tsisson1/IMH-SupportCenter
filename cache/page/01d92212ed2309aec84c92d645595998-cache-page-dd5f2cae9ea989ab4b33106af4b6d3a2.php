<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49393:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/email/how-can-i-move-my-email-to-google-apps" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello fitsweep, You are on the right track in regards to your MX records. I see all the correct records for Google in your account. There is one thing m..." />
  <title>How can I move my e-mail to google apps? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/email/how-can-i-move-my-email-to-google-apps" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:34ad4c2b51b7687975e3b159b4a3750e -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '86.154.34.237']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>How can I move my e-mail to google apps?</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/fitsweep'>fitsweep</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-08-13 11:51 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>924</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I am having issues moving my email to google apps. I changed my MX records but it is still not working. Please help.</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_1426' id='upvote_answer_1426' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='1426' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_1426').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_1426' id='downvote_answer_1426' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='1426' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_1426').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello fitsweep,<br />
<br />
You are on the right track in regards to your MX records. I see all the correct records for Google in your account. There is one thing more you need to do, however. You did not remove the original record that is set to priority 0. Since that one is still there, the emails will try to be delivered to your account here first and only use the Google MX records if it fails.<br />
<br />
Simply go back to the MX Entry tool where you entered the MX records and delete the first one (the non-Google one). This will take care of it and within a few hours (as the rest of the world gets the news that the record was deleted) your email will use Google Apps instead.<br />
<br />
Best Regards,<br />
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_1426').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_1426' id='form_comment_on_answer_1426' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/email/how-can-i-move-my-email-to-google-apps&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/email/how-can-i-move-my-email-to-google-apps'></div>
<script type='text/javascript'>
  (function() {
