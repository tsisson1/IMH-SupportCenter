<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:120366:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/hacks/recovering-from-a-hack" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-01-31T16:43:15-08:00" />
  <meta name="keywords" content="recover hack steps to fix hack after" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="Recovering from a hack can be difficult. This article will explain how to secure your site from hacks." />
  <title>Recovering after a Hack - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/hacks/recovering-from-a-hack" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:eff339d10479dde5545e69e0b19b023a -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '75.70.169.101']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/website/hacks' itemprop='url'><span itemprop='title'>Troubleshooting Hacked Websites<span></a><div class='dropdown_3columns'><div class='col_3'><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/hacks/i-think-my-website-has-been-hacked'>I think my website has been hacked</a> (30551 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/hacks/cleaning-up-a-htaccess-hack'>.htaccess hack cleanup</a> (26216 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/hacks/recovering-from-a-hack'>Recovering after a Hack</a> (24279 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/hacks/clean-up-code-injection-attack'>Clean up a code injection attack</a> (21273 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/hacks/removing-your-domain-from-security-block-lists'>Removing your Domain from Security Block Lists</a> (5668 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/hacks/malicious-user-activity-and-hacks'>Malicious user activity and hacks</a> (4442 hits)</div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Recovering after a Hack</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>24,279</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Feb 7, 2013'><span style='color:#606060;'>Published:</span> Jan 31, 2014</div>
  ...
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('password');">Change Password</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('computer');">Scan Computer</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('cpanel');">Secure cPanel</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('update');">Update/Backup</button>
  <button type="button" class="btn btn-danger" onclick="trackAnchorClickSC('cleaning');">Clean Hacks</button>
</div>

<p>Recovering from a Hack can be overwhelming. Not only do you have to deal with restoring your site to a good working state, you also need to take steps to help prevent a repeated attack on your site. The following is a series of recommended steps for recovering from a hack (regardless of the nature of the hack). While this may seem overwhelming, this is an exhaustive list. You will want to try and close any open doors the hacker might have used (or may have left behind) to compromise your site.</p>
<p class="alert" style="color:red"><strong>Note!</strong> If you are not sure whether your site has been hacked or not, see our guide titled "<a href="/support/website/hacks/i-think-my-website-has-been-hacked" target="_blank">I think my website has been hacked</a>".</p>
<a name="password"></a><h2>Change Your Passwords</h2>
<p>The first step you want to take is to make sure you change all passwords associated with your account. The following is a list of different passwords you will want to update.</p>
<ul>
<li><a href="http://www.inmotionhosting.com/support/edu/cpanel/getting-started-cpanel/change-password" target="_blank">cPanel Password</a></li>
<li><a href="http://www.inmotionhosting.com/support/email/general-information/changing-your-email-password" target="_blank">Email Passwords</a></li>
<li><a href="http://www.inmotionhosting.com/support/website/ftp/resetting-your-ftp-password-in-cpanel" target="_blank">FTP passwords</a></li>
<li>Passwords for any Content Management Systems (CMS) such as <a href="http://www.inmotionhosting.com/support/website/wordpress/resetting-your-wordpress-admin-password" target="_blank">WordPress</a>, <a href="http://www.inmotionhosting.com/support/website/joomla/reset-joomla-password" target="_blank">Joomla</a> or <a href="http://www.inmotionhosting.com/support/edu/drupal-8/getting-started/reset-password" target="_blank">Drupal</a></li>
</ul>

<a name="computer"></a><h2>Scan your Computer</h2>
<p>Hacks can come to our servers through your local computer. When a computer is compromised by a virus, hack code can be uploaded to your site through FTP programs and HTML editors. When accessing the Internet, make sure the network you are on is secure. If it isn't, or you aren't sure if it is, do not connect to your cPanel/server (this includes using an FTP program, publishing from design software, logging into email, or logging into a CMS admin area). The following explains the steps to take to prevent hacks from your local computer.</p>

<ol class="article_list">
<li>Update any anti virus programs you have on your local computer and run a full scan of local machine. If you do not have anti virus on your local computer, it is highly recommended that you install an anti virus program, keep it up to date, and run regular scans (yes this includes Mac and Linux users as well). Both AVG and Avast offer free anti virus programs from Windows, Linux and Mac users.</li>
<li>If you use a wireless router to connect to the Internet, make sure it is a secured connection. If you are not sure how to secure your wireless router, consult your router's documentation or do a search online for your router model and how to secure it. Your router manufacturer may also be able to assist you further.</li>
<li>If you use any local web design/development software (e.g. Dreamweaver, iWeb, Microsoft Expression Web, etc.) make sure your software is up to date.</li>
<li>Make sure that all Adobe products (including Adobe Acrobat and Adobe Acrobat Reader) are updated.</li>
<li>Check your browser version and update as needed. If you have more than one browser installed on your computer, check all browsers installed.</li>
</ol>
<p>If you antivirus software fails to detect any viruses, or you are having trouble removing a particular virus, several resources are available in which individuals will assist you in removing the virus for free:</p>
<ul class="article_list">
  <li><a href="http://www.malwareremoval.com" target="_blank">malwareremoval.com</a></li>
  <li><a href="http://asap.maddoktor2.com" target="_blank">asap.maddoktor2.com</a></li>
  <li><a href="http://www.bleepingcomputer.com" target="_blank">www.bleepingcomputer.com</a></li>
  <li><a href="http://spywarewarrior.com" target="_blank">spywarewarrior.com</a></li>
  <li><a href="http://spywarehammer.com" target="_blank">spywarehammer.com</a></li>
  <li><a href="http://www.malwareremoval.com/forum" target="_blank">www.malwareremoval.com/forum</a></li>
  <li><a href="http://www.wilderssecurity.com" target="_blank">www.wilderssecurity.com</a></li>
  <li><a href="http://gladiator-antivirus.com/forum" target="_blank">gladiator-antivirus.com/forum</a></li>
  <li><a href="http://forums.pcpitstop.com" target="_blank">forums.pcpitstop.com</a></li>
</ul>
<a name="cpanel"></a><h2>Securing your cPanel</h2>
<p>The cpanel is your hosting account control panel. It is recommended to secure your server through your cPanel. Below are steps to do this.</p>
<ol class="article_list">
<li><a href="http://www.inmotionhosting.com/support/edu/cpanel/getting-started-cpanel/change-password" target="_blank">Change your cPanel password.</a></li>
<li>Make sure all of the <a href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-file-manager/creating-ftp-account-cpanel" target="_blank">FTP accounts</a> listed are in use. If they are not, remove them. Make sure <a href="http://www.inmotionhosting.com/support/website/ftp/resetting-your-ftp-password-in-cpanel" target="_blank">passwords for all FTP</a> accounts have been changed.</li>
<li>Check that all <a href="http://www.inmotionhosting.com/support/edu/everything-email/introduction-email/creating-email-account">email accounts</a> listed are in use. If there are any listed that are not in use, <a href="http://www.inmotionhosting.com/support/community-support/general-information/how-can-i-delete-email" target="_blank">delete the accounts</a>. <a href="http://www.inmotionhosting.com/support/email/general-information/changing-your-email-password" target="_blank">Change your email account passwords</a>.</li>
<li>In the <a href="http://www.inmotionhosting.com/support/edu/everything-email/email-features/set-up-email-forwarder" target="_blank">Email Forwarders</a> area of cPanel, make sure any forwarders listed are ones that you created and are still forwarding from and to the correct email addresses.</li>
<li>Review the <a href="http://www.inmotionhosting.com/support/edu/cpanel/301-run-cron-job" target="_blank">Cron Jobs</a> area of cPanel and make sure any cron jobs listed are legitimate and still contain the correct commands.</li>
<li>Check the <a href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/a-record-change" target="_blank">Simple DNS Zone Editor</a> in cPanel. Under "<em>User-Defined Records</em>", check for any records pointing site away that shouldn't be there. Of course, if you use a third party for email or other services (like <a href="http://www.google.com/intx/en/enterprise/apps/business/" target="_blank">Google Apps</a> for instance) you will expect to see records for those things. Just make sure that any <a href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/how-do-i-make-custom-dns-records" target="_blank">DNS records</a> listed are correct.</li>
<li>In <a href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-manage-domains/setting-up-redirect-cpanel" target="_blank">Redirects</a>, review any redirects listed. If there are any redirects you did not create, remove them. If you have redirects you have created, make sure the redirection is still set up properly.</li>
</ol>

<a name="update"></a><h2>Update/Backup Software:</h2>
<p>After you verify that your server and your computer is secure, you will want to secure other areas of your server like your CMS software and maintaining a backup.</p>
<ul>
<li>If you are using a CMS (e.g. WordPress, Joomla, Drupal, etc.) to create your site, make sure you are <a href="http://www.inmotionhosting.com/support/edu/cpanel/softaculous/upgrade-within-softaculous" target="_blank">running the latest version</a>. Update if necessary.</li>

<li><a href="http://www.inmotionhosting.com/support/edu/cpanel/softaculous/create-backup" target="_blank">Create and download regular backups of your website with Softaculous</a> or with <a href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-file-manager/backing-up-your-cpanel" target="new">cPanel</a>. We cannot stress how important this is. Downloading your backups is essential. In the event something goes wrong, having the backup stored separately from your account is vital.</li>
</ul><br>

<a name="cleaning"></a><h2>Cleaning up Hacks:</h2>

<h3>Clean up a Code Injection</h3>
<p>Typically code injections are carried out by an attacker uploading a PHP shell script to your account, either by compromising your FTP credentials, or by exploiting outdated software that you might have running on your website. If your site is trying to load malicious content for your visitors, or preventing your site from displaying properly, please see our guide on:<br>
<a href="/support/website/hacks/clean-up-code-injection-attack" target="_blank">Cleaning up a code injection attack</a></p>

<h3>Cleaning up a .htaccess Hack</h3>
<p>The .htaccess file is used to primarily setup rewrite rules to control the way your site is accessed. You might not notice that your .htaccess file has been hacked until either a manual investigation, or you happen to get a malware warning on your website that it's redirecting to a malicious site. The fix is explained in the following guide:<br>
<a href="/support/website/hacks/cleaning-up-a-htaccess-hack" target="_blank">Cleaning up a .htaccess Hack</a></p>

<h3>Reinstall Wordpress after a Hack</h3>
<p>In most cases when a WordPress site is hacked, it is because you are not running the latest secure version of WordPress, or one of the plugins that you have installed is outdated and has been used by a hacker to exploit the site. To get your site back up and running after a hack, see our guide on:<br>
<a href="/support/website/wordpress/reinstall-wordpress-after-a-hack" target="_blank">Reinstall WordPress after a Hack</a></p>

<h2>Malicious User Activity/Hacks, and How it Affects your Account:</h2>
<p>The following article explains why stopping malicious user activity and hacks from running on your account, is important to keeping your account's resource usage low:<br>
<a href="/support/website/hacks/malicious-user-activity-and-hacks" target="_blank">Malicious User Activity and Hacks</a></p>
<br>
<p>We are here 24/7 to help you with your server. If you are hacked and need assistance, you can contact  <a href="/support/website/website-troubleshooting/how-to-get-great-technical-support" target="_blank" title="Click here for how to contact support">tech support</a> to see if we can help. Even though coding support is beyond our support, we are always happy to see what we can do to help you get your site working.</p>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/hacks/recovering-from-a-hack&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/hacks/recovering-from-a-hack'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MDYmaWQ9NTYwJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="40e30672fe813d10ea7f2558e1c70471" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/website/hacked-account-notification?tsrc=rsbraq'>Hacked Account Notification</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/website-troubleshooting/my-url-used-for-phishing-attack-notice-from-google?tsrc=rsbraq'>My URL used for Phishing attack??!!! Notice from Google...</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/google-tools/received-google-phishing-notice?tsrc=rsbraq'>Received Google Phishing notice</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/wordpress/website-being-redirected-at-random-times?tsrc=rsbraq'>Website being redirected at random times</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/24ae03cad6cb8452eb0766917c60c1ee?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/24ae03cad6cb8452eb0766917c60c1ee'>Kam Yau</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-23 5:11 pm</div>
				                <div><p>My master domain is example.com and I've been hacked and all domain/files have been removed. I need to have all files as refrence. You guys move to quanrantine dir before but nothing for this time... Where I can have all the files... ?</p>
<p>Thanks</p>
<p>Kam</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13220);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-23 5:21 pm</div>
				                <div>Hello Kam, and thanks for your comment.<br />
<br />
I see that your files in the &lt;span style=&quot;color: red;&quot;&gt;/public_html&lt;/span&gt; directory were quarantined to the &lt;span style=&quot;color: red;&quot;&gt;/quarantine&lt;/span&gt; directory, however it looks like the permissions were not setup correctly to allow you to view them.<br />
<br />
You should be able to login to your account now and view all of your files. You can begin to move them back into your &lt;span style=&quot;color: red;&quot;&gt;/public_html&lt;/span&gt; directory now. But please be mindful for any suspicious looking files that might still contain active hacks that could lead to your account being compromised by more malicious activity.<br />
<br />
Please let us know if you have any further questions.<br />
<br />
- Jacob</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13221);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-22661'></a>
		<div  style='margin:2px 0px 0px 80px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/f139821e1e59a6acc1e2773cb11fbfca?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/f139821e1e59a6acc1e2773cb11fbfca'>Lean</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-14 10:11 pm</div>
				                <div><p>Hello,</p>
<p>I have the same problem as above. www.*************.com has been hacked and was quarantined. I need to access the contents of the website as reference if we will need to recreate the website from scratch. Hope you can help me retrieve my files.</p>
<p>Your prompt response would be greatly appreciated.</p>
<p>Thanks</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22661);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-15 8:49 pm</div>
				                <div>Hello Lean,<br />
<br />
As per Jacob's response above, your files are in a QUARANTINE folder.  You just need to login to your account and look in that folder to see your files.   If you have any trouble getting to them, please let us know.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22686);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-14159'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/31f4d624993670b9eadb844e52abc866?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/31f4d624993670b9eadb844e52abc866'>davy</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-20 11:40 am</div>
				                <div><p>I'ver already sent a email use postcardxp@gmail.com. But it seemed the email can't recieve email correctly. Please reply my email with this email: postcardxp@163.com. My master domain is www.postcardxp.com and I've been hacked. I tried to update all files backuped by myself. but the site still can not work properly. Please help me restore all files of my site use your backup before 1st July. After that day, I havn't upload any file onto my site. Thank a lot! Davy</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14159);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-20 12:01 pm</div>
				                <div>Hello Davy,<br />
<br />
If you need any files restored, you will need to contact the <a href="http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support">Live Support team</a> or <a href="http://www.inmotionhosting.com/support/website/backup-and-restore/restoring-a-backup">submit a restoration request</a> via the AMP (Account Management Panel).  The caveat is that our backups are no more than 24 hours old, so if you need a backup beyond the last 24 hours, you will need to provide those files yourself.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14161);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-20705'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/05d1dcce358f8943f0bbbb3fd14f6756?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/05d1dcce358f8943f0bbbb3fd14f6756'>S. Khandker</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-15 1:24 pm</div>
				                <div><p id="yui_3_16_0_1_1424019960281_2316" dir="ltr" data-setdir="false">Hi,&nbsp;</p>
<p id="yui_3_16_0_1_1424019960281_2442" dir="ltr" data-setdir="false">for your kind information, I can't open my any documents type file such as .docx, .xlx, .pdf, .jpeg etc. its happened after received a mail massage with attached ZIP file. I just extract ZIP and lost my file type. now all the file contain the file type as like <strong id="yui_3_16_0_1_1424019960281_2643">PROFORMA.PDF.wmugstg</strong></p>
<p>&nbsp;</p>
<p id="yui_3_16_0_1_1424019960281_2442" dir="ltr" data-setdir="false"><span id="yui_3_16_0_1_1424019960281_3026">&nbsp;nOTE : PLEASE FIND OUT THE EMAIL ATTACHMENT AND TRY TO HELP ME IN YOUR LEVEL BEST.</span></p>
<p id="yui_3_16_0_1_1424019960281_3141" dir="ltr" data-setdir="false"><span id="yui_3_16_0_1_1424019960281_3026"></span></p>
<p id="yui_3_16_0_1_1424019960281_3140" dir="ltr" data-setdir="false"><span id="yui_3_16_0_1_1424019960281_3026">Best regards</span></p>
<p id="yui_3_16_0_1_1424019960281_3172" dir="ltr" data-setdir="false"><span id="yui_3_16_0_1_1424019960281_3026"></span></p>
<p><span id="yui_3_16_0_1_1424019960281_3026">S. Khandker</span></p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20705);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-16 12:52 pm</div>
				                <div>Hello S. Khandker,<br />
<br />
We would need a bit more information. When you say you cannot open specific files, what are you trying to open them with? Do you mean on your local computer or are you linking within a website?</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20745);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-24257'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/09d587341bee8588f5e57d438c057d52?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/09d587341bee8588f5e57d438c057d52'>tim newman</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-16 10:29 pm</div>
				                <div><p>hi- i have a site that is hosted by Inmotion and it has reported hacks each day for the last 3 days.</p>
<p>each time it has been restored to an unhacked version, and worked until the next day.</p>
<p>I have contacted IM and was sent a standard "what to do if your site it hacked" link. I have found that WP update checksums dont match, and dont think it is a hack, but rather a problem with an update.</p>
<p>Can you please assist as we are thinking of moving to another Host as having to restore every day is growing old quickly.</p>
<p>&nbsp;</p>
<p>thanks,</p>
<p>tim</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24257);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-17 1:14 pm</div>
				                <div>Hello Tim,<br />
<br />
...
<br />
Apologies that I don't have a direct solution to get directly to the heart of the matter, but since the issue is not widespread at this point, we would like to eliminate the possible issues on your WordPress installation.  Also, make sure that you have changed your passwords for your account.<br />
<br />
If you have any further comments or questions, please let us know.<br />
<br />
Kindest regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24276);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-25927'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/56e952c3424575e96383692e464be389?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/56e952c3424575e96383692e464be389'>Jeffrey</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-20 3:48 pm</div>
				                <div><p>Actually none of this helps. &nbsp;We had the site kind of hacked. &nbsp;Someone FTPed an index.html file. &nbsp;When checking the FTP log the ip address traces back to inmotionhosting. &nbsp;So someone in inmotionhosting ftped a index.html to hack our site. &nbsp;Trying to work with support yielded no help. &nbsp;Within 10 seconds the response was we didn't do it, even though the IP address traces directly to inmotionhosting.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25927);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-20 5:52 pm</div>
				                <div>Hello Jeffrey,<br />
<br />
Thank you for contacting us. We understand your concern, and certainly take this type of report extremely seriously. I spent some time reviewing your server's logs, and do see where the index.html file was uploaded.<br />
<br />
The IP address is from your cPanel; meaning someone logged into your cPanel with your credentials and uploaded the file.<br />
<br />
Since this was not you, I highly recommend <a href="http://www.inmotionhosting.com/support/edu/cpanel/getting-started-cpanel/change-password">changing your cPanel Password</a> immediately. Be sure to use strong passwords. For detailed information see our full guide on <a href="http://www.inmotionhosting.com/support/website/security/password-strength">Password Strength and Security</a>.<br />
<br />
It may also be beneficial to scan any computers you are connecting from, just to be safe.<br />
<br />
Also, since it seems you are running WordPress, ensure it is updated regularly along with any 3rd party Themes/plugins. There have been a lot of WordPress updates recently. Here is a helpful link to our <a href="http://www.inmotionhosting.com/support/edu/wordpress/secure-wordpress">10 recommended steps to lock down and secure WordPress</a>.<br />
<br />
If you have any further questions, feel free to post them below.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25933);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-20 6:21 pm</div>
				                <div><p>Interesting now to get this reponse that suddenly the finger is pointed at "our cpanel" when support said it was because that IP address belongs to several sites on the same server it could have been anyone. &nbsp;You might want to get your stories straight, &nbsp;And do tell can't someone at inmotion log into our cpanel and upload the file? &nbsp;Also, wordpress plugins have nothing to do with cpanel so why are you even trying to focus blame on wordpress. &nbsp;Focus, Focus, Focus.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25934);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-20 6:59 pm</div>
				                <div>Hello Jeffrey,<br />
<br />
Thank you for contacting us. Yes, in a shared server setting, multiple cPanel accounts share an IP address.<br />
<br />
Almost everything in cPanel is <a href="http://www.inmotionhosting.com/support/website/getting-started-guides/cpanel-logs-for-access-apache-email-error-ftp-mysql-whm">logged</a>. The FTP log in question, includes the username of the cPanel account that uploaded it. While InMotion has access to your cPanel, we do not know your password (since it is secret to you). With our access level, if we uploaded a file via cPanel it would list our IP in the log.<br />
<br />
There are many reports (such as <a href="http://stackoverflow.com/questions/23535599/wordpress-site-was-hacked-no-access-admin-cpanel" target="_blank">this</a>) of cPanel's being compromised via WordPress. Since WordPress is so popular, it is often the most targeted. It just depends on the nature of the Vulnerability, and the security of the specific 3rd party Themes/plugins you are using. Keep in mind they are all developed by individual people and companies.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25935);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-27151'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/7317d329fb4842a3368ef990b74ca437?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/7317d329fb4842a3368ef990b74ca437'>jamie</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-01 6:00 pm</div>
				                <div><p>Our website was hacked how do we get it back up and running after going through all the steps in this article. i moved uninfected items back into the public html&nbsp; older but our site is still showing me an inmotion hosting screen instead of our page</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27151);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-01 6:48 pm</div>
				                <div>Hello jamie,<br />
<br />
Thank you for contacting us. Upload an index file (either index.htm index.html or index.php) and that file will load instead.<br />
<br />
When you visit a website, it will always attempt to display an index page which can be named index.html, index.php, etc. Due to how our servers are configured, our default coming soon page will be displayed in the event that the typical file names do not exist. To resolve the issue, upload an index file such as a file named index.php, index.html, etc. to your account within the public_html directory.<br />
<br />
This is taken from our full article <a href="http://www.inmotionhosting.com/support/website/getting-started-guides/how-to-remove-the-inmotion-coming-soon-page">How to remove the InMotion Coming Soon page</a>.<br />
<br />
Often, if you are using a CMS such as WordPress, Joomla, etc. you can download the same version from their download site, and use the included index.php file.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27152);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-29621'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/34107697f6f4afeb4552e1fef7e45606?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/34107697f6f4afeb4552e1fef7e45606'>Arvind</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-07 2:19 am</div>
				                <div><p>Hello,</p>
<p>&nbsp;</p>
<p>My company website seems to be have been hacked. I can see many pages added which are ad-ware. Not sure, what the root cause it and how do I go about correcting it.&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29621);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-07 9:52 am</div>
				                <div>I regret to hear you suspect your site was compromised. If you have a hosting plan with us you can certainly contact our <a href="http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support">Live Support</a> for a scan of your site. Or, if you don't have a hosting plan with us, the steps in the article above can be applied to troubleshooting in a general sense.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29628);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-31265'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/74a8b353209a88b101df7ddf09c6bb49?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/74a8b353209a88b101df7ddf09c6bb49'>Amit Sinha</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-16 3:32 am</div>
				                <div><p>my website is getting hacked again and again. The hacker is deleting all files and folders via ftp or cpanel and uploading his own files which redirects to xyz.com. I am frustrated what to do. The hosting team is not assisting me, they are blaming that is coding issue. I don't understand how the hacker is deleting all the files and folders. The technology which I used to develop the website is PHP.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31265);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-17 12:36 am</div>
				                <div>Hello Amit,<br />
<br />
I'm sorry that you are frustrated with the hacks on your website.  Make sure that you've taken all the steps to reset your passwords, and also make sure that all of your own systems have been scanned in case they are part of the security issue.  I would also recommend reviewing  articles like this one <a href="https://www.addedbytes.com/articles/writing-secure-php/writing-secure-php-1/" rel="nofollow" target="_blank">Writing Secure PHP</a>.  PHP is not totally secure against hackers if the necessary steps are not taken to harden against intrusion.  <br />
<br />
I hope that helps to answer your question!  If you require further assistance, please let us know!<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31283);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-19 3:12 am</div>
				                <div><p>Can I use, mysqli (pdo) query, instead of mysql, will it make it secure from hacking?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31330);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-21 6:07 pm</div>
				                <div>While mysqli or pdo is now recommended since mysql has been deprecated in php, that is not going to make it any less susceptible to hacking. Hacking is due to a hole in the code itself, so better coding will make for a stronger site.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31367);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
	...
	<div name='fixComments' id='fixComments' style='width:220px; margin:0px; float:right;'>
		<div class='moduletable'>
			<h3><span class='comment-count'>24</span> Questions & <span class='comment-text'>Comments</span></h3>
