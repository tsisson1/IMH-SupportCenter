<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:102235:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/php-troubleshooting/troubleshoot-php-errors" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-03-22T13:51:31-07:00" />
  <meta name="keywords" content="PHP errors turned On Off logged  turn display error log logging ini_set() error_reporting display_errors  log_errors error_log" />
  ...
  <title>Display and log errors for PHP - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/php-troubleshooting/troubleshoot-php-errors" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:415766c5a2fea04f4de8f439790f757c -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '198.96.185.7']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/website/php-troubleshooting' itemprop='url'><span itemprop='title'>PHP Troubleshooting<span></a><div class='dropdown_3columns'><div class='col_3'><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/php-troubleshooting/allowed-memory-size-exausted'>Fixing the Allowed memory size exhausted error</a> (103714 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/php-troubleshooting/troubleshoot-php-errors'>Display and log errors for PHP</a> (66014 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/php-troubleshooting/php-ownershippermission-issues'>PHP Ownership/Permission Issues</a> (6476 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/php-troubleshooting/fatal-error-call-to-undefined-function-error'>Fatal error: Call to undefined function mb_substr() Error</a> (6200 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/php-troubleshooting/php-files-do-not-show-changes'>PHP files do not show the changes</a> (3449 hits)</div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Display and log errors for PHP</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Display and log errors for PHP									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>66,014</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 24, 2013'><span style='color:#606060;'>Published:</span> Mar 22, 2016</div>
  ...
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('editing_the_php_ini');">Editing the php.ini</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('php_ini_settings');">Php.ini error reporting settings</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('turning_on');">Turning Error logging on</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('using_int_set');">Using int_set()</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('maintain');">Maintain your log files</button>
</div>
<p>By default, InMotion disabled PHP error logging on all servers. In order to troubleshoot your PHP code, <strong>PHP errors</strong> can be enabled to display and log errors using your local php.ini file or ini_set() in a specific PHP file. This article will cover how to turn display errors On and Off, error reporting settings, error logging, and the ini_set() function for individual error checking on specific pages.</p>
<a name='editing_the_php_ini'></a>
<h2>Editing the php.ini to display errors</h2>
<p>The php.ini by default should have the errors enabled; however, for the production environment, errors can be turned off. Sometimes when developing PHP scripts you may want to turn specific errors Off or On. Displaying errors is typically turned-off for production and Enabled for development. Displaying errors is disabled for production to protect sensitive information and not interfere with the format of the pages. This section will explain how to turn error reporting <em>On</em> and <em>Off</em>.</p>
...
<li><a href="/support/edu/cpanel/cpanel-file-manager/using-file-manager-in-cpanel" target="_blank" title="Click here for info">Go to the File Manager</a>. Select the public_html directory and click Go.</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/error_reporting/error-logging-2-report-all.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Report all PHP errors" src="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/error_reporting/error-logging-2-report-all.gif" title="Click here to view the larger image" width="100" /></a>Find the "<em>Error handling and logging</em>" section in the php.ini. You can enable the error_reporting by removing the ( ; ) from in front to the line. You can disable error_reporting by adding a ( ; ) in front of the line and add "<em>error_reporting = none</em>". See the following.
<p>Error reporting set to server default.</p>
<pre style="margin-left: 20px;">;   - Show all errors, except for notices
;
;error_reporting = E_ALL &amp; ~E_NOTICE
;
</pre>
<p>Error reporting set to specifically report all errors.</p>
<pre style="margin-left: 20px;">;   - Show all errors, except for notices
;
error_reporting = E_ALL &amp; ~E_NOTICE
;
...
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/error_reporting/error-logging-3-display.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Display PHP errors On" src="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/error_reporting/error-logging-3-display.gif" title="Click here to view the larger image" width="100" /></a>Next you can set the display_errors to On or Off to either show the errors on your website or not. Look for the display_errors line in the php.ini and set it to On to display errors or Off to turn errors off. The code looks like the following.
<pre style="margin-left: 20px;">display_errors = On
</pre>
<br style="clear: both;" /></li>
</ol>
<a name='php_ini_settings'></a>
<h2>Php.ini error reporting settings</h2>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/error_reporting/error-logging-1-list.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="List of PHP Error reporting settings" src="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/error_reporting/error-logging-1-list.gif" title="Click here to view the larger image" width="100" /></a>PHP has a list of different error reporting settings within the php.ini file itself. For example if you just want to display warnings only you can change the error_reporting to the following.</p>
<pre style="margin-left: 20px;">error_reporting = E_WARNING</pre>
<p>The following table was created from the settings found in a standard php.ini file. The following table shows the available options.<br style="clear: both;" /></p>
<table class="article_table" border="0">
<tbody>
<tr><th colspan="2">List of available options taken from php.ini</th></tr>
<tr><th>E_ALL</th>
<td>All errors and warnings</td>
</tr>
<tr><th>E_ERROR</th>
<td>fatal run-time errors</td>
</tr>
<tr><th>E_WARNING</th>
<td>run-time warnings (non-fatal errors)</td>
</tr>
<tr><th>E_PARSE</th>
<td>compile-time parse errors</td>
</tr>
<tr><th>E_DEPRECATED</th>
<td>notices for the use of functions that will be retired in a future version</td>
</tr>  
<tr><th>E_NOTICE</th>
<td>run-time notices (these are warnings which often result from a bug in your code, but it's possible that it was intentional (e.g., using an uninitialized variable and relying on the fact it's automatically initialized to an empty string)</td>
</tr>
<tr><th>E_CORE_ERROR</th>
<td>fatal errors that occur during PHP's initial startup</td>
</tr>
<tr><th>E_CORE_WARNING</th>
<td>warnings (non-fatal errors) that occur during PHP's initial startup</td>
</tr>
<tr><th>E_COMPILE_ERROR</th>
<td>fatal compile-time errors</td>
</tr>
<tr><th>E_COMPILE_WARNING</th>
<td>compile-time warnings (non-fatal errors)</td>
</tr>
<tr><th>E_USER_ERROR</th>
<td>user-generated error message</td>
</tr>
<tr><th>E_USER_WARNING</th>
<td>user-generated warning message</td>
</tr>
<tr><th>E_USER_NOTICE</th>
<td>user-generated notice message</td>
</tr>
</tbody>
</table>
<a name='turning_on'></a>
<h2>Turning Error logging on</h2>
<p>By default errors are set to error_log is set to /dev/null which means, it won't have error logging on. When errors are turned on will be stored in the directory the error occurs in. For example, if you have a PHP file called index.php in a subdirectory like public_html/wordpress, if you have any PHP errors in the index.php file of that location, the error log will be stored in that folder. You can specify in the php.ini what file to store all errors in.</p>
<p class="alert"><strong>Important!</strong>You can place the following code in the .htaccess to make the local php.ini work for the current directory where the .htaccess resides and all subdirectories beyond.</p>
<pre style="margin-left: 20px;">&lt;IfModule mod_suphp.c&gt;
suPHP_ConfigPath /home/USERNAME/public_html
&lt;/IfModule&gt;
</pre>
<div>The IfModule makes Apache load the directive only if suPHP is used, so the site doesn't break if switched to another PHP handler such as DSO.</div>
<p>For more information on suPHP please see our article on <a target="_blank" title="Click here for info on suPHP" href="/support/website/general-server-setup/choosing-the-best-php-handler">Choosing the best PHP handler</a>.</p>
<ol class="article_list">
<li><a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel" target="_blank" title="Click here for info">Login into your cPanel</a>.</li>
<li><a href="/support/edu/cpanel/cpanel-file-manager/using-file-manager-in-cpanel" target="_blank" title="Click here for info">Go to the File Manager</a>. Select the public_html directory and click Go.</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/error_reporting/error-logging-4-log-errors.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Log PHP errors On" src="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/error_reporting/error-logging-4-log-errors.gif" title="Click here to view the larger image" width="100" /></a>You can set the following line of code to On to log errors or off to turn error logging off.
<pre style="margin-left: 20px;">log_errors = On
</pre>
<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/error_reporting/error-logging-5-path-to-log.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Path to PHP Error log" src="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/error_reporting/error-logging-5-path-to-log.gif" title="Click here to view the larger image" width="100" /></a>Next you can save errors from any page in your files to a specific location the error_log for all your to a specific path on the server or leave the log.
<p>This will place the error_log in the directory the error occurs in</p>
<pre style="margin-left: 20px;">; Log errors to specified file.
error_log = error_log
</pre>
<p>This s will place all errors in the error log inside the public_html</p>
<pre style="margin-left: 20px;">; Log errors to specified file.
error_log = /home/userna5/public_html/error_log
</pre>
<p>Now your errors will all be stored in the error_log in the public_html.</p>
<br style="clear: both;" /></li>
</ol>
<a name='using_int_set'></a>
<h2>Using int_set() to display errors</h2>
...
<pre style="margin-left: 20px;">string ini_set ( string $varname , string $newvalue )</pre>
<p>This can be placed at the top of your PHP page to with the error_reporting variable in it to allows error checking for that particular page. Below are the steps on how to do this.</p>
<ol class="article_list">
<li><a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel" target="_blank" title="Click here for info">Login into your cPanel</a>.</li>
<li><a href="/support/edu/cpanel/cpanel-file-manager/using-file-manager-in-cpanel" target="_blank" title="Click here for info">Go to the File Manager</a>. Select the public_html directory and click Go.</li>
If error logging is off in php.ini you can place this in a page for errors specific to this page Place the following
<li>Navigate to the PHP file you want to check errors for.
<p>Open the file in the code editor.</p>
</li>
<li>In the page, add the following to the top of the page.
<pre style="margin-left: 20px;">ini_set('display_errors', '1');</pre>
<p>1 = On<br /> 0 = Off</p>
<p>Save the page.</p>
<p>Now your PHP page only will display errors.</p>
</li>
</ol>
<a name='maintain'></a>
<h2>Maintain your log files</h2>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/php-troubleshooting/troubleshoot-php-errors&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/php-troubleshooting/troubleshoot-php-errors'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MDkmaWQ9NTE0JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="82cf9ff26cd7bff97fb2f4bec4a2b6ef" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/open-source/error-message-when-calling-docebo?tsrc=rsbraq'>Error message when calling Docebo</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/wordpress/inmotion-hosting-using-security-that-blocks-xml-rpc-protocol?tsrc=rsbraq'>Does InMotion Hosting use security that blocks XML RPC protocol?</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/send-email-from-a-page/phpmailer-does-not-send?tsrc=rsbraq'>phpmailer does not send</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/website/errors-depreciation-on-website-and-cannot-get-module-data?tsrc=rsbraq'>Errors: Depreciation on website and  cannot get module data </a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/iweb/500-internal-server-error-4?tsrc=rsbraq'>500 Internal Server Error</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/de37a2200797f09759d9ccf513ed3a3a?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/de37a2200797f09759d9ccf513ed3a3a'>Rakesh</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-02 8:31 am</div>
				                <div><p>&lt;?php</p>
<p>&nbsp;if(isset ($_POST['user'])){</p>
<p>&nbsp; &nbsp; &nbsp;$user = $_POST['user'];</p>
<p>&nbsp; &nbsp; &nbsp;$pass = $_POST['pass'];</p>
<p>&nbsp; &nbsp; &nbsp;</p>
<p>&nbsp; &nbsp; &nbsp;$con = mysql_cnnection("lochost","root"'"");</p>
<p>&nbsp; &nbsp; &nbsp; &nbsp;if(!$con){die(Could not connect: '.mysql_error());}</p>
<p>&nbsp; mysql_select_db("test",$con);</p>
<p>&nbsp; if(mysql_num_rows(mysql_query("SELECT * FROM user where username = '$user AND password = '$pass'")))</p>
<p>&nbsp; {</p>
<p>&nbsp; $result =mysql_query("SELECT * FROM users where username ='$user' AND password ='pass'");</p>
<p>&nbsp; while($row =mysql_fetch_array($result))</p>
<p>&nbsp; {</p>
<p>&nbsp; $expire =time()+60*60*24*30;</p>
<p>&nbsp; setcookie("uid",$row['uid']$expire));</p>
<p>&nbsp; } &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;</p>
<p>&nbsp; &nbsp; &nbsp;}</p>
<p>&nbsp; &nbsp; else{</p>
<p>&nbsp; &nbsp; echo"&lt;br&gt;username or password&lt;/b&gt;&lt;br&gt;&lt;br&gt;";</p>
<p>&nbsp; &nbsp; }</p>
<p>&nbsp; &nbsp; }</p>
<p>&nbsp; &nbsp; mysql_close($con);</p>
<p>&nbsp; &nbsp; }&nbsp;</p>
<p>&nbsp; &nbsp; echo"&lt;form method = 'post'&gt;</p>
<p>&nbsp; &nbsp;Username:&lt;input type='text' name='user'&gt;&lt;br&gt;</p>
<p>&nbsp; &nbsp;Password:&lt;input type='password' name='pass'&gt;&lt;br&gt;</p>
<p>&nbsp; &nbsp;&lt;input type='submit' value='LOGIN'&gt;</p>
<p>&nbsp; &nbsp;&lt;/form&gt;"</p>
<p>&nbsp; &nbsp;?&gt; &nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10342);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-02 9:13 am</div>
				                <div>Hello Rakesh,<br />
<br />
Thank you for contacting us today. Do you need assistance? Are you having trouble with this script? Are you getting any errors?<br />
<br />
If you have any further questions, feel free to post them below.<br />
Thank you,<br />
<br />
-John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10343);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/26e7c4db43ee2663d53852dae8a3e37d?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/26e7c4db43ee2663d53852dae8a3e37d'>sanjay</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-06 8:17 am</div>
				                <div><p>hello friend i am php devloper&nbsp;</p>
<p>i one site devlopd but one erro&nbsp;</p>
<p>send mail function not work in public_html and i create public_html in any folder in check to work adn run&nbsp;</p>
<p>this &nbsp;code same &nbsp;in public_html and any foldre&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12389);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-06 8:25 am</div>
				                <div><p>i am sanjay and php developer &nbsp;but one error&nbsp;</p>
<p>i am send mail function code is wright in public_html in any foulder to run this code&nbsp;</p>
<p>but error in public_html in my page run mail.php this error&nbsp;</p>
<pre> PHP Startup: Unable to load dynamic library '/opt/php54/lib/php/extensions/no-debug-non-zts-20100525/homeloader.so' - /opt/php54/lib/php/extensions/no-debug-non-zts-20100525/homeloader.so: cannot open shared object file: No such file or directory in Unknown on line 0
</pre></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12390);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-06 4:06 pm</div>
				                <div>Hello sanjay,<br />
<br />
It looks like you might want to &lt;a href=&quot;http://www.inmotionhosting.com/support/website/php/update-local-php-settings&quot; target=&quot;_blank&quot;&gt;edit your php.ini file&lt;/a&gt; and look for the line that mentions &lt;span style=&quot;color: blue;&quot;&gt;homeloader.so&lt;/span&gt; and comment it out by placing a &lt;span style=&quot;color: red;&quot;&gt;;&lt;/span&gt; in front of that line and then saving it.<br />
<br />
You might want to check with your host if the main &lt;a href=&quot;http://www.inmotionhosting.com/support/website/sending-email-from-site/using-the-php-mail-function-to-send-emails&quot; target=&quot;_blank&quot;&gt;PHP mail() function&lt;/a&gt; is disabled on your server.<br />
<br />
You might want to &lt;a href=&quot;http://www.inmotionhosting.com/support/email/send-email-from-a-page/using-phpmailer-to-send-mail-through-php&quot; target=&quot;_blank&quot;&gt;use phpMailer to send mail&lt;/a&gt; from your website instead using the SMTP authentication that a normal email client would use.<br />
<br />
Please let us know if you have any further questions.<br />
<br />
- Jacob</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12401);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-12374'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/776b1b70adfc30f08016c1d6c7122f1c?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/776b1b70adfc30f08016c1d6c7122f1c'>Themesrefinery</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-05 3:05 pm</div>
				                <div><p>We can easily turn on or off wordpress error reporting with just one line code in wp-config.php. Here is the link for code</p>
<p>http://www.themesrefinery.com/turn-wordpress-error-reporting/</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12374);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-19176'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/8751b84c411a775794ec049388d61da9?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/8751b84c411a775794ec049388d61da9'>sudhanshu kumar</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-05 7:57 am</div>
				                <div><p>In joomla backend i am getting this error&nbsp;</p>
<h1 class="page-header" style="margin: 2px 0px 10px; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; line-height: 28px; color: #333333; text-rendering: optimizelegibility; font-size: 26px; padding-bottom: 5px; border-bottom-width: 1px; border-bottom-style: solid; border-bottom-color: #eeeeee;">An error has occurred.</h1>
<blockquote style="padding: 0px 0px 0px 15px; margin: 0px 0px 18px; border-left-width: 5px; border-left-style: solid; border-left-color: #eeeeee; color: #333333; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 13px; line-height: 18px;">&nbsp;<span class="label label-inverse" style="display: inline-block; padding: 2px 4px; font-size: 10.998px; font-weight: bold; line-height: 14px; color: #ffffff; vertical-align: baseline; white-space: nowrap; text-shadow: rgba(0, 0, 0, 0.247059) 0px -1px 0px; border-top-left-radius: 3px; border-top-right-radius: 3px; border-bottom-right-radius: 3px; border-bottom-left-radius: 3px; background-color: #333333;">0</span>&nbsp;String could not be parsed as XML</blockquote>
<p style="margin: 0px 0px 9px; color: #333333; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 13px; line-height: 18px;"><a class="btn" style="color: #333333; text-decoration: none; display: inline-block; padding: 4px 12px; margin-bottom: 0px; text-align: center; vertical-align: middle; cursor: pointer; text-shadow: rgba(255, 255, 255, 0.74902) 0px 1px 1px; border-width: 1px; border-style: solid; border-color: #bbbbbb #bbbbbb #a2a2a2; border-top-left-radius: 4px; border-top-right-radius: 4px; border-bottom-right-radius: 4px; border-bottom-left-radius: 4px; -webkit-box-shadow: rgba(255, 255, 255, 0.2) 0px 1px 0px inset, rgba(0, 0, 0, 0.0470588) 0px 1px 2px; box-shadow: rgba(255, 255, 255, 0.2) 0px 1px 0px inset, rgba(0, 0, 0, 0.0470588) 0px 1px 2px; background-image: linear-gradient(#ffffff, #e6e6e6); background-color: #f5f5f5; background-repeat: repeat-x;" href="http://sudhanshutesting.skylux.bangalore/administrator">&nbsp;Return to Control Panel</a></p>
<p style="margin: 0px 0px 9px; color: #333333; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 13px; line-height: 18px;">due to this error i am not able to open the backend. Please any body can helpme.&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19176);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-05 11:26 am</div>
				                <div>Hello Sudhanshu Kumar,<br />
<br />
Sorry for the problem.  The issue you're having has been reported in the <a href="http://forum.joomla.org/viewtopic.php?f=708&t=820072" rel="nofollow" target="_blank">Joomla Forums here</a>.    Your best bet is to follow their suggestions and see if it doesn't resolve the problem you're seeing.<br />
<br />
Kindest regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19183);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-19814'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/f132b0b73f4fccdcfcf264643e5fdf2a?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/f132b0b73f4fccdcfcf264643e5fdf2a'>Anant singh</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-22 8:38 am</div>
				                <div><p>Hi sir,</p>
<p>I am php developer , I have some problem I want to know about error log becouse client demand to <strong>error log</strong>, show <strong>error message and save in db with all error detals and remove by user.(means client). how to solve problem .</strong></p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19814);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-22 10:01 am</div>
				                <div>Hello Anant,<br />
<br />
Thanks for the question.  We can't help you with code, but we can try to provide some guidance that will lead to what you need.  I found this post in a forum concerning your question:<br />
<br />
"Use set_error_handler('myErrorFunction'); (See PHP Manual set_error_handler) define myErrorFunction with database inserts, turn off standard error reporting display with ini_get('display_errors', 0);"<br />
<br />
(<a href="http://stackoverflow.com/questions/9655663/how-to-save-php-errors-in-database" rel="nofollow" target="_blank">How to save PHP errors in Database</a>)<br />
<br />
I hope this helps to answer your question, please let us know if you require any further  assistance.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19815);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-25982'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/145b933f6af199542e9842f2d4d2ef85?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/145b933f6af199542e9842f2d4d2ef85'>ashleyka</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-22 6:57 pm</div>
				                <div><p>I am in need of editing my php.ini file. The article says that the php.ini file is located in the public_html directory, but the file isn't there. Am I looking the wrong place?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25982);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-24 3:27 pm</div>
				                <div>Hello Ashleyka,<br />
<br />
That is the correct location but it may have been removed. I would suggest <a href="http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support">contacting the technical support department</a> of your host to have a copy added to your public_html so you may make edits.<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26042);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-31065'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/51d758e706880f74450542029ddce64b?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/51d758e706880f74450542029ddce64b'>Guruprasad G</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-09 12:08 am</div>
				                <div><p>hi, im using joomla 3.4.8 version for my website and a error seems to be keep on repeating "PHP Notice: Undefined index: HTTP_HOST in /home/novelteamnew/public_html/libraries/joomla/uri/uri.php on line 174". i dont knw how to handle this? can anyone help with this??</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31065);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-09 6:30 pm</div>
				                <div>Hello Guruprasad G,<br />
<br />
Sorry for the problems with Joomla. I tried looking for information on this error and this is what I found:  <a href="http://forum.joomla.org/viewtopic.php?t=666220" rel="nofollow" target="_blank">Joomla forum post</a>.   It may help with your issue, or at least help get  you going in the right direction.  <br />
<br />
I hope that helps to answer your question!  If you require further assistance, please let us know!<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31090);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
