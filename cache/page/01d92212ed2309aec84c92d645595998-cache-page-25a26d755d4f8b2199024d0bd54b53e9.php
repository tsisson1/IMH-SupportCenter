<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:61222:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/cpanel/create-custom-error-pages" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-06-25T13:01:40-07:00" />
  <meta name="keywords" content="Custom Error Page cPanel" />
  <meta name="author" content="John-Paul Briones" />
  <meta name="description" content="Creating a Custom Error page in cPanel" />
  <title>How to Create Custom Error Pages in cPanel - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/cpanel/create-custom-error-pages" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:efda61a46a5b4225977b5e9529edfa9e -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to Create Custom Error Pages in cPanel									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>2,251</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jun 24, 2015'><span style='color:#606060;'>Published:</span> Jun 25, 2015</div>
							...
							<div style='clear:both;'></div>
								...
								<iframe width="560" height="315" src="https://www.youtube.com/embed/UPslzEo_gkM" frameborder="0" allowfullscreen></iframe>
<div class="in_this_tutorial">
  <h2>In this tutorial:</h2>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('create-error-page');">Creating a Custom Error Page</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('setup-htaccess');">Setup .htaccess File</button>
</div>


<p>When a visitor to your site receives an error message, such as <strong>404 (Not found)</strong>, or <strong>500 (Internal server error)</strong>; they will see the default error page. You can easily customize these pages in your cPanel with the <em>Error Pages</em> button. For example you may want to personalize the error message. In this tutorial we will show you how to create a custom error page in cPanel. Then, we will show you how to add an .htaccess rule, so your custom error pages will load when needed.</p>

<a name="create-error-page"></a>
<h2>Creating a Custom Error page</h2>

<ol class="article_list">
<li><a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">Login to your cPanel</a>.</li>
<li>Click the <strong>Error Pages</strong> button, in the <em>Advanced</em> section of cPanel.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/cpanel/error-page/error-pages.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/cpanel/error-page/error-pages.png" alt="cPanel Advanced Error Pages" title="cPanel Error Pages" /></a></li>
<li>If you have multiple domains in your cPanel, select it from the <em>Managing</em> menu.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/cpanel/error-page/select-domain-to-manage-error-pages-cpanel.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/cpanel/error-page/select-domain-to-manage-error-pages-cpanel.png" alt="cPanel Domain Error Pages" title="Choose domain to modify error pages for" /></a></li>
<li>You will see a list of <em>Common Error Codes</em>, click the one you want to create a custom error page for. The available choices are <strong>400 (Bad request)</strong>, <strong>401 (Authorization required)</strong>, <strong>403 (Forbidden)</strong>, <strong>404 (Not found)</strong>, and <strong>500 (Internal server error)</strong>. To edit additional error codes, click the <strong>Show All HTTP Error Status Codes</strong> tab. In my tests, I am selecting <strong>404 (Not found)</strong></li>
<li>You will then be on an editor page. You can enter HTML code here, or insert premade tags if you want. Below is a brief description of the available tags.<br>
...
<tr>
<td>Referring URL</td>
<td>Lists the URL you came from.</td>
</tr>

<tr>
<td>Visitor's IP address</td>
<td>Lists the IP address of your site visitor.</td>
</tr>

<tr>
<td>Requested URL</td>
<td>Shows the URL you are attempting to access</td>
</tr>

<tr>
<td>Server Name</td>
<td>Shows the name of the server.</td>
</tr>

<tr>
<td>Visitor's Browser</td>
<td>Lists the the visitor's browser type.</td>
</tr>

<tr>
<td>Redirect Status Code</td>
<td>This will display the error message code, such as 500, or 404, etc.</td>
</tr>
</tbody>
</table> 
</li>
<li>Click the <strong>Save</strong> button at the bottom when you are finished.</li>
</ol>


<a name="setup-htaccess"></a>
<h2>Setup your .htaccess File</h2>

<ol class="article_list">
<li><a href="/support/website/managing-files/how-to-edit-a-file">Edit</a> the .htaccess file for your site, and add a rule for the errors you created. If you need help locating your .htaccess file, see our guide "<a href="/support/website/htaccess/where-is-my-htaccess-file">Where is my .htaccess file?</a>." Below is an example of the file formatting:<br>
<div class="code_block">ErrorDocument 400 /400.shtml<br>
ErrorDocument 401 /401.shtml<br>
ErrorDocument 403 /403.shtml<br>
ErrorDocument 404 /404.shtml<br>
ErrorDocument 500 /500.shtml</div></li>
<li>Save your .htaccess file. Now when someone triggers an error message on your site, it will display your Custom Error Page.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/cpanel/error-page/example-error-page.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/cpanel/error-page/example-error-page.png" alt="Error Page example" title="New cPanel Error Page" /></a><br><br></li>
</ol>
<br>
<p>Congratulations, now you know how to <strong>create custom Error Pages in cPanel</strong>!  For additional reading, here is a link to the official cPanel documentation on <a href="https://documentation.cpanel.net/display/ALD/Error+Pages" target="_blank">Error Pages</a>.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 1: How to Create Custom Error Pages in cPanel</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 2: <a href='/support/edu/cpanel/prevent-index-of-page-in-htaccess'>Preventing the Index Of page in .htaccess</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/cpanel/create-custom-error-pages&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/cpanel/create-custom-error-pages'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD03MCZpZD0zNTkwJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="8a5f4dfee9b127cd1c004f858b0e1ec6" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/859670d9b3f13c8781029be44fadfbdf?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/859670d9b3f13c8781029be44fadfbdf'>Muhammad Attahiru Jibrin</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-03 6:57 am</div>
				                <div><p>I have a custom error page I created in php named 404.php</p>
<p>I used "ErrorDocument 404 http://nativedge.com/404" to direct all&nbsp;<span style="color: rgb(33, 33, 33); font-family: Roboto, 'Helvetica Neue', Helvetica, sans-serif; font-size: 13px; line-height: 20px;">non-existent page to my error page and it seems to be working perfectly.</span></p>
<p><span style="color: rgb(33, 33, 33); font-family: Roboto, 'Helvetica Neue', Helvetica, sans-serif; font-size: 13px; line-height: 20px;">The only problem I have is that google is showing that it is not returning the appropriate 404 response code. How can I fix it?</span></p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26327);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-03 5:14 pm</div>
				                <div>Hello Muhammad Attahiru Jibrin,<br />
<br />
Try changing your file name and following the format shown in the tutorial above.  I think your 404 is not working properly because of how you have set it up in .htaccesss.  It appears to be acting more like a re-direct.   Here's another couple of resources about creating custom 404s:<br />
<br />
<a href="http://www.htmlgoodies.com/beyond/reference/article.php/3472591" rel="nofollow" target="_blank">Creating Custom 404 pages - HTML Goodies</a><br />
<br />
<a href="https://support.google.com/webmasters/answer/93641" rel="nofollow" target="_blank">Google - 404 pages</a><br />
<br />
<br />
...
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26346);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
