<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:56302:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/wordpress/wordpress-dashboard-you-do-not-have-sufficient-permissions-gah" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Roger, Sorry to hear you are having issues with your WordPress site. Unfortunately without specific domain names, I am unable to take a look at wh..." />
  <title>Wordpress - Dashboard - You do not have sufficient permissions! Gah! | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/wordpress/wordpress-dashboard-you-do-not-have-sufficient-permissions-gah" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:dcdd9d179e5ff13b7b9f89050c1b9101 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '84.42.143.250']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Wordpress - Dashboard - You do not have sufficient permissions! Gah!</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/rknipp'>rknipp</a>
			<div>8 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-09-28 1:53 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>157</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Hello Community Support,<br />
I really need some help with a frustrating Wordpress issue that I have been unable to resolve.  <br />
<br />
Earlier this week, InMotion detected a security breach on one of my four WP sites and took them down.  They were able to restore them from a 9/19 backup so I could go through them, remove outdated themes/plugins/etc. <br />
<br />
public_html (main account site) = Everything OK!<br />
     sub_domain#1site.com = Everything OK!<br />
     sub_domain#2site.com = Everything OK!<br />
     sub_domain#3site.org = Problem!<br />
<br />
All files/users/content/plugins/etc appear to have been restored correctly on all four Wordpress installations.  All 4 sites display correctly to the outside world after updating a few folder perms.  <br />
<br />
The Problem - I am getting the infamous &quot;You Do Not Have Sufficient Permissions to access this page&quot; when attempting to get to /wp-admin/profile.php.  <br />
<br />
&gt;&gt; This is ONLY happening with site#3.org.  All the other wordpress installation admin pages can be accessed normally.<br />
&gt;&gt; The admin account DOES logon though.  If I navigate to the site#3.org main page, the admin account does show as logged on (top right toolbar).<br />
&gt;&gt; The top toolbar also shows my theme settings (iFeaturePro) options link.  If I click the theme options, I am able to get to the administration menus... BUT the Dashboard / Home / Updates links at the top left of the page are missing entirely.  O.o<br />
&gt;&gt; Any administration links above &quot;Posts&quot; are not displayed or accessible.<br />
&gt;&gt; I am able to add/deactivate plugins and make other administrative changes on the admin menu panel.<br />
<br />
Admin Page View - Dashboard/Updates links missing at top left.<br />
http://i.imgur.com/DZzn4XU.jpg<br />
<br />
<br />
I've opened multiple tickets with InMotion and reviewed several suggestions on other sites, but have been unable to get this resolved so far.  <br />
<br />
&gt;&gt; Checked Folder / File permissions... problem remains.<br />
&gt;&gt; .htaccess - renamed current file, copied in .htaccess from main public_html folder, problem persists.  Reverted back to original .htaccess.<br />
&gt;&gt; Plugins - Deactivated all.  Problem persists.  Deleted and reinstalled all plugins.  Problem persists.<br />
&gt;&gt; Dumped browser caches and reproduced issue on separate browser.<br />
&gt;&gt; Second admin account - InMotion created a second admin account and received the same results, could not see the Dashboard/Home/Updates links on the top left of page.<br />
&gt;&gt; Renamed wp-admin and wp-includes folders (wp-content untouched), FTP upload fresh wp-admin and wp-includes.  Still unable to access Dashboard correctly or see links.<br />
<br />
&gt;&gt;MySQL Database<br />
Ran database check - http://www.inmotionhosting.com/support/website/databases/check-repair-database<br />
All tables Check Status OK<br />
<br />
http://www.wpwhitesecurity.com/wordpress-tutorial/you-do-not-have-sufficient-permissions-to-access-this-page-fix/<br />
Reviewed these suggestions.  Prefix is already set to wp_ and matches tables.<br />
<br />
wp_usermeta &gt; wp_capabilities = a:1:{s:13:&quot;administrator&quot;;s:1:&quot;1&quot;;}<br />
Attempted a recommended change to &quot;a:1:{s:13:&quot;administrator&quot;;b:1;}&quot; but problem remains, reverted back to original.<br />
<br />
wp_usermeta<br />
http://i.imgur.com/EqEXu1N.jpg<br />
<br />
<br />
I did originally have the plugin Shareaholic installed but deleted it from all four sites after they were restored.  I am unsure why site#3.org is the only one that has reference to it in the wp_usermeta table or if that is an issue?<br />
<br />
Anyone see anything glaring in wp_usermeta that I have missed or have any recommendations on where to look?<br />
<br />
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_8210' id='upvote_answer_8210' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='8210' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_8210').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_8210' id='downvote_answer_8210' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='8210' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_8210').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
...
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_8210').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_8210' id='form_comment_on_answer_8210' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
...
I had hoped that a refresh of files in wp-admin and wp-includes would address any file corruption.  I even swapped out themes temporarily to make sure my regular theme wasn't the culprit.<br />
<br />
I am not 100% positive that both the files and the database were restored at the same time when I was coordinating with support.  The db wasn't mentioned specifically as far as I recall.  <br />
<br />
I've checked WordPress forums and other sites for solutions.  The &quot;sufficient permissions&quot; error message comes up in a lot of different scenarios and I've attempted to use a few of the resolutions that I detailed above to find a fix but without success.  Since I refreshed the files I was more focused on the database and wp_usermeta.<br />
<br />
Regards,<br />
Roger</div>
							...
							<td style='width:96px;' valign='top'>
								...
								<div class='smallgrey'>
									<a href='/support/community-support/users/rknipp'>rknipp</a><br />
									8 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2015-09-28 4:21 pm EST
								</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/wordpress/wordpress-dashboard-you-do-not-have-sufficient-permissions-gah&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/wordpress/wordpress-dashboard-you-do-not-have-sufficient-permissions-gah'></div>
<script type='text/javascript'>
  (function() {
