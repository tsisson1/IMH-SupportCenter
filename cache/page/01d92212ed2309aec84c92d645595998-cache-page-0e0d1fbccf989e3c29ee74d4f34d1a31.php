<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:63145:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-file-manager/using-file-manager-in-cpanel" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-07-14T18:21:30-07:00" />
  <meta name="keywords" content="files file manager cpanel" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="In this short tutorial, you will learn how to use the file manager in cPanel." />
  <title>Using File Manager in cPanel - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-file-manager/using-file-manager-in-cpanel" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:09b18862e5cc1e2362e6dce6db78522d -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Using File Manager in cPanel									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>48,199</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Sep 6, 2011'><span style='color:#606060;'>Published:</span> Jul 14, 2015</div>
							...
							<div style='clear:both;'></div>
								...
								<iframe width="560" height="315" src="https://www.youtube.com/embed/AYN0HOjLPkg" frameborder="0" allowfullscreen></iframe>

<div class="in_this_tutorial">
  <h2>In this tutorial:</h2>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('access');">Accessing the File Manager</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('features');">File Manager Features</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('additional');">Additional Guides</button>
</div>

<p>Your cPanel account has the ability to allow you to <em>access</em>, <em>view</em>, <em>modify</em>, <em>add</em>, and <em>delete</em> files from your account effortlessly, using the <strong>File Manager</strong>. In this tutorial we will show you how to access the File Manager, then go over the features available there.</p>

<a name="access"></a><h2 >Accessing the File Manager:</h2>
<ol class="article_list">
<li><a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel" target="_blank">cPanel Login</a>Login to your cPanel</a></li>
<li>Click on the "<strong>File Manager</strong>" in the "<em>Files</em>" section.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/cpanel/file-mgr.jpg"><img style="border-style: initial; border-color: initial;"  alt="file-mgr" src="//cdn.inmotionhosting.com/support/images/stories/cpanel/file-mgr.jpg" /></a></p></li>
  <li>You will get prompted with a pop-up menu asking what directory you would like to start in. To go directly to where your website files are stored make sure to check the "<strong>Web Root</strong>" and press "<strong>Go</strong>." It's wise to make sure that the "<em>Show Hidden Files</em>" box is checked in case you need to work with the php.ini or the .htaccess files.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/cpanel/file-mgr-popup.jpg"><img  alt="file-mgr-popup" src="//cdn.inmotionhosting.com/support/images/stories/cpanel/file-mgr-popup.jpg" /></a></li></ol>
...
<a name="features"></a><h2>cPanel File Manager Features</h2>
<p>Now that you are logged into file manager, let's take a few minutes to understand some of the basic features of File Manager.</p>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/cpanel/file-mgr-layout.jpg"><img  alt="file-mgr-layout" src="//cdn.inmotionhosting.com/support/images/stories/cpanel/file-mgr-layout.jpg" /></a></p>
<ul>
  <li><strong>Task Bar <span style="color: #682dd2;">(Purple Outline)</span></strong>- This is where you can perform basic tasks like create a new folder, delete a file, edit a file and much more.</li>
  <li><strong>Current Location <span style="color: #ff6600;">(Orange Outline)</span></strong>- This tells you where you currently located. Also you can specify a path here to navigate to somewhere else.</li>
  <li><strong>File Tree <span style="color: #ff0000;">(Red Outline)</span></strong> - This is also for navigation, but shows you a visual representation of how your files are structured.</li>
  <li><strong>Current Folder Contents <span style="color: #339966;">(Green Outline)</span></strong> - This lets you know what the contents are of the current folder you are in.&nbsp;</li>
</ul>
...
<a name="additional"></a><h2>Additional Guides</h2>
This section includes additional walk-through guides, for comon task that are performed in the cPanel File Manager:<br>

<ul>
  <li><a href="/support/website/file-manager/create-new-file#file-manager">Create a File</a></li>
  <li><a href="/support/website/managing-files/how-to-upload-files-server#file-manager">Upload a File</a></li>
  <li><a href="/support/website/managing-files/how-to-move-files-on-server#file-manager">Move a File</a></li>
  <li><a href="/support/website/managing-files/how-to-edit-a-file#file-manager">Edit a File</a></li>
  <li><a href="/support/website/managing-files/how-to-delete-a-file#file-manager">Delete a File</a></li>
</ul>

<br>
<p>cPanel makes it easy for you to manage your files. Read more about the <a href="http://www.inmotionhosting.com/cpanel-hosting/cpanel-file-management-feature.html">cPanel file management features</a>.</p>
<p>Please check the next article on <a target="_blank" href="/support/edu/cpanel/cpanel-file-manager/backing-up-your-cpanel" title="Click here to view the next article">Backing Up your Website</a>. For more information on this course please visit <a target="_blank" href="/support/edu/cpanel/cpanel-file-manager" title="Click here to view the courses">Managing your Files in cPanel</a></p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 3: Using File Manager in cPanel</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 2: <a href='/support/edu/cpanel/cpanel-file-manager/renaming-files-folders'>Renaming files and folders in cPanel</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/cpanel/cpanel-file-manager/using-file-manager-in-cpanel&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/cpanel/cpanel-file-manager/using-file-manager-in-cpanel'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xMzUmaWQ9OTgzJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
          ...
          <tr >
			...
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/website/site-is-not-available?tsrc=rsbraq'>Site is not available</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support//?tsrc=rsbraq'>I need to change my Pinterest click through?</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/drupal-7/several-databases-and-websites?tsrc=rsbraq'>Several databases and websites.</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/joomla/joomlah-redirect-for-administrator?tsrc=rsbraq'>joomlah redirect for administrator</a>
                                </div>
...
<a name='comments'></a>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/3ad5b86d47d04521e4de6f19dd29ad85?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/3ad5b86d47d04521e4de6f19dd29ad85'>abhishek malik</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-19 8:18 am</div>
				                <div><p>thanks usefull information, this prblm created in my site, then i am using your trick, and now everthing is ok, thankalot to giving this wonderfull info.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19681);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-25630'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/77f946564828daa341a3ff695054e584?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/77f946564828daa341a3ff695054e584'>Gilda</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-10 10:35 am</div>
				                <div><p>Thanks a lot for the detailed tutorial! I spent so much time to figure out that issue.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25630);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
