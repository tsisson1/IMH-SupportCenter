<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:51774:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/file-management/421-too-many-connections-8-from-this-ip" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello TheWattsMan, Apologies for the problems with FTP! Sometimes FTP connections do not terminate properly and must be manually disconnected. You can d..." />
  <title>421 Too many connections (8) from this IP | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/file-management/421-too-many-connections-8-from-this-ip" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:8183b5eccffc2e6d576531805278a7cc -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box straight_bottom'>
                <h1 style='font-size:26px;'>421 Too many connections (8) from this IP</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/TheWattsMan'>TheWattsMan</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-05-01 8:13 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>27,689</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>When attempting my initial upload via FTP of my existing wordpress site, this error started coming up in FileZilla after a minute or so, and all the transfers stopped. I shouldn't have 8 connections going, as FileZilla is currently configured to transfer 2 files at a time. How do I fix this?</div>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px;'>
				<div style='font-size:12px; max-width:500px; overflow:auto;'>I also tried setting the server up with the site manager function, and setting the maximum number of connections to &quot;1&quot;, and it did the same thing, though it did manage to transfer several files before going back to denying the connection. </div>
			...
			<td style='width:100px;' valign='top'>
				...
				<div class='smallgrey'>
					<a href='/support/community-support/users/TheWattsMan'>TheWattsMan</a><br />
					5 <a href='/support/team/points' target='_blank'>Points</a><br />
					2013-05-01 08:25 pm EST
				</div>
			</td>
		</tr>
	</table>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_3020' id='upvote_answer_3020' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='3020' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_3020').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_3020' id='downvote_answer_3020' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='3020' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_3020').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>32,263 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2013-05-01 8:39 pm EST
                		        </div>
					
		                </div>

				Hello TheWattsMan,<br />
<br />
Apologies for the problems with FTP!  Sometimes FTP connections do not terminate properly and must be manually disconnected.  You can do this in the cPanel under FTP Session control.<br />
<br />
Instructions:<br />
<br />
1) <a href="http://www.inmotionhosting.com/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel" target="new">Login to your cPanel</a><br />
2) Scroll down the menu until you find FTP Session Control.<br />
3) You will see a list of your connections.  Click on the button in the DISCONNECT column as long as the status of the connection states IDLE.  You might have to click on the DISCONNECT button several times to remove all of the connections.  <br />
<br />
Just make sure that you clear out all of the connections listed and then try logging again.  I did just go in myself and clear the connections.  The connections should clear out when you disconnect from FTP.<br />
<br />
Also, see our full article on the <a href="http://www.inmotionhosting.com/support/website/ftp/too-many-simultaneous-connections" target="_blank" ><strong>421 Too many connections</strong></a> error. It explains how to <strong>view</strong>, <strong>close</strong>, and <strong>limit</strong> <em>simultaneous connections</em>.<br />
<br />
...
Community Support
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_3020').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_3020' id='form_comment_on_answer_3020' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/file-management/421-too-many-connections-8-from-this-ip&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/file-management/421-too-many-connections-8-from-this-ip'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="dad8951a5d65d9da5ed048f639ddb930" value="1" />	</div>
	</form>
<!-- <br />
