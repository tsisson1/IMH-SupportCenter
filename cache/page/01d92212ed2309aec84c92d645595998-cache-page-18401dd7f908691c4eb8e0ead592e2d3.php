<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:83980:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-3/menu/add-menu-item" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-01-31T19:07:07-08:00" />
  <meta name="keywords" content="joomla 3.0 create menu item" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="After creating a menu in Joomla 3.0, your next step is to add new items to your menu. We'll walk you through the steps for adding those links in this Joomla 3.0 tutorial." />
  <title>Adding a Menu Item to a Menu in Joomla 3.1 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-3/menu/add-menu-item" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:f7c7e8defb5d4f349a9714cd04009b21 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '181.56.232.15']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Adding a Menu Item to a Menu in Joomla 3.1									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>18,883</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Sep 27, 2012'><span style='color:#606060;'>Published:</span> Jan 31, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In our last Joomla 3.0 tutorial, we walked you through the steps for <a href="/support/edu/joomla-3/menu/create-menu-and-module">setting up a menu in Joomla 3.0</a>. The menu will not show until we add items to the menu, and so we'll now walk you through the steps for adding links to your menu.</p>
<h2>How to add a new menu item to a menu in Joomla 3.0</h2>
<ol class="article_list">
<li><a href="/support/edu/joomla-3/getting-started/login-dashboard">Log into your Joomla 3.0 admin dashboard</a></li>
<li>In the top menu, click <strong>Menus</strong> and then click the menu to which you'd like to add a link to. If you're following along with our <a href="/support/edu/joomla-3/menu">Joomla 3.0 Menu Tutorial</a>, we clicked on the <em>Test Articles</em> menu.</li>
<li>In the top left of the page, click the <strong>New</strong> button</li>
<li>There are quite a few settings you can adjust for your new menu item. In order to make this tutorial a little less complicated, we are only going to enter the following settings:<br /> 
<table class="article_table">
<tbody>
<tr>
<th width="100px">Setting</th> <th>Description</th> <th width="125px">What we entered</th>
</tr>
<tr>
<td>Menu Item Type</td>
<td>The type of link: Component, URL, Alias or Separator</td>
<td>Single Article</td>
</tr>
<tr>
<td>Select Article</td>
<td>Select the desired article from the list.</td>
<td>Test Article 1</td>
</tr>
<tr>
<td>Menu Title</td>
<td>The title of the menu item that will display in the menu.</td>
<td>Test Article 1</td>
</tr>
<tr>
<td>Alias</td>
<td>The Alias will be used in the SEF URL. Leave this blank and Joomla will fill in a default value from the title. This value will depend on the SEO settings (Global Configuration-&gt;Site).<br />Using Unicode will produce UTF-8 aliases. You may also enter manually any UTF-8 character. Spaces and some forbidden characters will be changed to hyphens.<br />When using default transliteration it will produce an alias in lower case and with dashes instead of spaces. You may enter the Alias manually. Use lowercase letters and hyphens (-). No spaces or underscores are allowed. Default value will be a date and time if the title is typed in non-latin letters .</td>
<td>testing-article-1</td>
</tr>
</tbody>
</table>
<p class="alert">Please note!<br />There are many different types of menu items you can create. For example, you can link to articles, categories, and content created by 3rd party extensions. In this tutorial, we are simply linking to a single article.</p>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/menus/menu-now-shows-on-homepage.gif"><img  alt="menu-now-shows-on-homepage" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/menus/menu-now-shows-on-homepage.gif" style="float: right; margin: 0px 0px 15px 15px;" /></a>
<p>After configuring the settings above, click the <strong>Save</strong> button in the top left of the page.<br /><br />Now that we've added our first menu item to the menu, the menu will now show on our website, as see in the screenshot to the right.</p>
<div style="clear: both;"></div>
</li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 2: Adding a Menu Item to a Menu in Joomla 3.1</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 1: <a href='/support/edu/joomla-3/menu/create-menu-and-module'>How to Create a Menu and Menu Module in Joomla 3.1</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-3/menu/add-menu-item&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-3/menu/add-menu-item'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNjMmaWQ9MTgxNCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="3be77eda99b3b2732a2fdde745504065" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//graph.facebook.com/lindahagar/picture?type=normal' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='/support/community-support/users/linda@lindahagar&per;com'>linda@lindahagar.com</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-07-29 12:03 pm</div>
				                <div>The feed back form didn't work.  I followed these directions on how to create a menu and module, but it didn't work.  </div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8068);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-07-29 3:19 pm</div>
				                <div>Hello Linda,<br />
<br />
Sorry for the problem with the feedback form.  We needed to see your files in order to see what was happening, or at least a URL. If you are hosting with us, can you provide some account information?  You can also email us at docs@inmotionhosting.com, just make sure that you place attn: Community Support in the subject line of the email so that we can receive it.  Emailed  information is handled privately.  If you provide us access to your account we can get in there and see what's causing the problem.  Otherwise, please provide us more information or a link to help us troubleshoot the issue.  <br />
<br />
Thanks for your patience!<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8069);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-12823'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/3f4fb8a435b20df7b285fc9cf4a73c63?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/3f4fb8a435b20df7b285fc9cf4a73c63'>MohammadIrfan</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-15 11:50 pm</div>
				                <div>almost clean..!!<br />
Thanx</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12823);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-15130'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/aebd0b766705d6f65fa1f22e58e95288?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/aebd0b766705d6f65fa1f22e58e95288'>Barbara</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-17 12:08 pm</div>
				                <div><p>I can't seem to add new menu items, I keep getting an internal error. What am I doing wrong?</p>
<h1 style="font-family: 'Times New Roman';">Internal Server Error</h1>
<p><span style="font-family: 'Times New Roman'; font-size: medium;">The server encountered an internal error or misconfiguration and was unable to complete your request.</span></p>
<p style="font-family: 'Times New Roman'; font-size: medium;">Please contact the server administrator to inform of the time the error occurred and of anything you might have done that may have caused the error.</p>
<p style="font-family: 'Times New Roman'; font-size: medium;">More information about this error may be available in the server error log.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15130);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-17 12:19 pm</div>
				                <div>Typically, this error is caused by an issue within your .htaccess file.  I recommend checking this file to ensure that there are not any issues within it.<br />
<br />
It could also be caused by various extensions that you have installed.  Try removing any additional extensions that you have added as well to see if that resolves the issue.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15131);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-15607'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/f1eef71b15278f76338914f1372e6896?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/f1eef71b15278f76338914f1372e6896'>Pier</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-28 12:31 pm</div>
				                <div><p>Hello,</p>
<p>I'd like to add the left column into inmotionhosting joomla template. How can i do? Thanks</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15607);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-29 12:31 pm</div>
				                <div>Hello Pier,<br />
<br />
Thank you for your question. There are several steps to this setup as follows:<br />
<br />
<ul><li><a href="http://www.inmotionhosting.com/support/edu/joomla-3/menu/create-menu-and-module">Create a Menu, and Menu Module</a> (Be sure to assign the module to the position you want it located.)</li><li><a href="http://www.inmotionhosting.com/support/edu/joomla-3/menu/add-menu-item">Add Menu Items to the menu</a> (It will display vertically by default)</li></ul><br />
If you have any further questions, feel free to post them below.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15634);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-07 8:02 am</div>
				                <div><p>Hi John-Paul,</p>
<p>my problem is to add a new position (for example position-8) that it coulde be the new column in the left side.. I suppose i need some php code or not?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15960);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-07 8:07 am</div>
				                <div>You would indeed need to modify both the PHP and CSS within your theme to do so.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15963);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/d1835f0c53b5bfa2deae312bdc19f903?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/d1835f0c53b5bfa2deae312bdc19f903'>roicarl</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-20 5:07 pm</div>
				                <div><p>Usually a menu item is linked to an article. But what if the menu item is just a container for sub menu items. In other words, there should be no direct link to an article. Is there a way of telling Joomla this?&nbsp;</p>
<p>For example, the container menu item is Our Work. Under Our Work&nbsp;is each&nbsp;sub menu item&nbsp;about the work we do. Clicking on Our Work&nbsp;should be a noop. How should&nbsp;Our Work be coded in the Joomla menu system?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25017);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-20 5:45 pm</div>
				                <div>Hello roicarl,<br />
<br />
Do you have the articles separated into categories so you can set the menu item to use a Category List for the Menu Item Type? Is that the behavior you are looking for?<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25019);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-21 7:42 pm</div>
				                <div><p>Scott:</p>
<p>No I do not. But here's what I did and it seems to work. I went into menu manager for the "Our Work" menu item. Selected System Links| External URL. Then I entered # in the Link field. In effect, "Our Work" menu item links to itself and becomes a noop-and it seems to be smart enough not to reload the page.</p>
<p>Thank you for your assistance-maybe this will help someone else.</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25049);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
