<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:67372:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/email/exim/locate-spam-activity-by-subject-with-exim" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-08-14T22:31:13-07:00" />
  <meta name="keywords" content="exim find locate spam activity subject subjects" />
  ...
  <link href="http://www.inmotionhosting.com/support/email/exim/locate-spam-activity-by-subject-with-exim" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:443aa432739f12933e8df1f14f54eee7 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Locate spam activity by subject with Exim									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>14,712</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 22, 2013'><span style='color:#606060;'>Published:</span> Aug 14, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In this article I'm going to review how you can locate possible spam activity by subject on your VPS (Virtual Private Server) or dedicated server using the Exim mail log.</p>

<p>If you've read my previous article on <a href="/support/email/email-troubleshooting/locate-email-accounts-being-used-to-spam" target="_blank">how to find email accounts being used to spam</a>, you should already know how to track down spam activity by looking for email accounts that send out mail from multiple IP addresses. Now we're going to cover finding spam activity by looking at duplicate subjects that are happening on your server.</p>

<p class="alert">To be able to follow along with this guide you'll need to already have <a href="/support/website/general-server-setup/root-access-faq" target="_blank">root access</a> to your VPS or dedicated server so that you have access to the Exim mail log.</p>
...
<table class="article_table">
  ...
  <p>So in this case we can see that by far the subject <strong>Melt Fat Naturally</strong> is the most duplicated subject currently in the Exim mail log.</p>
...
<li>
  ...
  <p>So in this case we can see that it looks like the <strong>user01@example.com</strong> account was used to relay this spam message.</p>

</li>

<li>

  You can now locate all of the IP addresses the <strong>user01@example.com</strong> account has been sending mail from, and possibly block them at your server's firewall if the activity looks malicious to you.

  <p>Use the following command to find all the IP addresses the account has been relaying mail with:</p>
  ...
  <p>So we can see that all <strong>1,763</strong> messages the <strong>user01@example.com</strong> user sent out, all came from the same <strong>123.123.123.123</strong> IP address.</p>
</li>
...
<li>
  It would also be recommended to <a href="/support/edu/everything-email/introduction-email/changing-email-password-in-cpanel" target="_blank">change the email password in cPanel</a> for the email account being used to send this spam. As otherwise the spammer could possibly come back from another computer with a different IP address and still attempt to relay spam out through your account.
</li>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/email/exim/locate-spam-activity-by-subject-with-exim&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/email/exim/locate-spam-activity-by-subject-with-exim'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NjMmaWQ9ODE0JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/7626ba34a31f5131351b7225c52c0768?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/7626ba34a31f5131351b7225c52c0768'>David Goodwin</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-16 7:20 am</div>
				                <div><p>Exim doesn't always log the subject in /var/log/exim4/mainlog. I'd suggest you just grep through /var/spool/exim4/input/* looking for whatever and pipe that through to exim -Mrm .....</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11639);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-28 4:07 am</div>
				                <div>Hello David,<br />
<br />
Thanks for the great tip! That would be a good way of looking at the live Exim queue for any possible spam, although not quite as effective for tracking down extended spamming issues.<br />
<br />
All of our Exim logs always contain the subjects and you can set this up on your servers as well by adding this to your &lt;span style=&quot;color: red;&quot;&gt;/etc/exim.conf&lt;/span&gt; file:<br />
<br />
&lt;pre class=&quot;code_block&quot; style=&quot;margin: -10px 0px -30px 0px; line-height: .9em&quot;&gt;log_selector = +subject&lt;/pre&gt;<br />
<br />
Or you could just log everything as well with:<br />
<br />
&lt;pre class=&quot;code_block&quot; style=&quot;margin: -10px 0px -30px 0px; line-height: .9em&quot;&gt;log_selector = +all&lt;/pre&gt;<br />
<br />
You can read more about all the things you can enable in Exim logs in this &lt;a href=&quot;http://www.exim.org/exim-html-current/doc/html/spec_html/ch-log_files.html#SECTlogselector&quot; target=&quot;_blank&quot;&gt;reducing or increasing what is logged in Exim&lt;/a&gt; guide.<br />
<br />
- Jacob</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12102);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-31758'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/f97d8270afca616280445a01e7f3a690?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/f97d8270afca616280445a01e7f3a690'>goodbyeplanet</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-07 8:22 am</div>
				                <div><p>Instead of test01@example.com I am seeing just the username test01. &nbsp;how do i tailor the command to include only the username test01 without the @example.com</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31758);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-07 9:40 am</div>
				                <div>Using the above example you can try adding the following: <br />
<br />
grep "Melt Fat Naturally" /var/log/exim_mainlog | awk '{print $6}' | cud -d@ -f1 | sort | uniq -c | sort -n<br />
</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31768);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
