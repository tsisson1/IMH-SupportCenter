...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/everything-email/what-is-mailbox-quota" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hi Dredrick, Thanks for posting your question. I'm more than happy to explain what the mailbox quota is. It gives you two options by default. The standa..." />
  <title>What is mailbox quota? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/everything-email/what-is-mailbox-quota" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:a52168d100ded248d6ce90a0c70a54d9 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>What is mailbox quota?</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/Dredrick'>Dredrick</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-04-20 2:27 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>11,836</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Im setting up my email account, and there's 2 options for mailbox quota: 250mb and unlimited. I wanted to know exactly what it is, so I know what to choose. I know it has something thing to do with space.</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_924' id='upvote_answer_924' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='924' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_924').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_924' id='downvote_answer_924' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='924' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_924').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hi Dredrick,<br />
<br />
Thanks for posting your question. I'm more than happy to explain what the mailbox quota is. It gives you two options by default. The standard option is 250MB and the other option is unlimited. <br />
<br />
If you set the mailbox quota to 250MB, once the limit in size is reached, you will not be able to receive emails since the mailbox would be deemed full. <br />
<br />
However, if you set it to unlimited, you will never actually fill up your mailbox.<br />
<br />
Keep in mind, as long as you are regularly cleaning out your email account, having a quota would not be an issue, since you're deleting the emails. <br />
<br />
You do have unlimited storage space on shared hosting with InMotion. However, you may not want mail boxes to grow out of control and a quota helps to remind you of that.<br />
<br />
It's really entirely up to you whether you set a mailbox quota or not. <br />
<br />
Attachments do count towards the quota as well, so if you receive a lot of large files such as images, it may be prudent to set it to unlimited. <br />
<br />
...
Tim S
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_924').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_924' id='form_comment_on_answer_924' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
