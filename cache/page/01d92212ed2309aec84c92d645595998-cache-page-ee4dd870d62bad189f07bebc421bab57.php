<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:56213:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/phpbb/301-fixing-the-specified-forum-image-does-not-exist-error" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-03-26T17:32:28-07:00" />
  <meta name="keywords" content="Warning The specified forum image does not exist phpbb error" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="This article will explain how to fix the Warning: The specified forum image does not exist error." />
  <title>302: Fixing &quot;The specified forum image does not exist&quot; error in phpBB - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/phpbb/301-fixing-the-specified-forum-image-does-not-exist-error" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:348f556fc1db4c4bdcf436102f8889a7 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '204.44.78.158']);
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/phpbb' itemprop='url'><span itemprop='title'>phpBB<span></a><div class='dropdown_4columns'><h2>phpBB Education Channel</h2><div class='col_2'><h3>100 Level Classes</h3><div><a href='/support/edu/phpbb/getting-started-phpbb'>101: Getting Started in phpBB 3.0</a></div><div><a href='/support/edu/phpbb/manage-forums'>102: Creating Forums in phpBB 3.0</a></div><div><a href='/support/edu/phpbb/working-with-users'>103: Working with Users in phpBB 3.0</a></div></div><div class='col_2'><h3>200 Level Classes</h3><div><a href='/support/edu/phpbb/general-settings'>201: Working with General Settings in phpBB 3</a></div><div><a href='/support/edu/phpbb/manage-posting-settings'>202: Working with posting settings in phpBB 3.0</a></div><div><a href='/support/edu/phpbb/managing-permissions'>203: Managing permissions in phpBB 3.0</a></div><div><a href='/support/edu/phpbb/manage-styles'>204: Managing styles and themes in phpBB 3.0</a></div><div><a href='/support/edu/phpbb/maintaining-forum'>205: Forum moderation in phpBB 3.0</a></div><div><a href='/support/edu/phpbb/manage-system-settings'>206: Manging System Settings in phpBB 3.0</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>302: Fixing &quot;The specified forum image does not exist&quot; err...</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															302: Fixing &quot;The specified forum image does not exist&quot; error in phpBB									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>4,507</span></div>
							...
							<div style='clear:both;'></div>
								...
								<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/301/warning-image-does-not-exist-1-error.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Warning image deos not exist error phpBB" src="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/301/warning-image-does-not-exist-1-error.png" title="Click here to view the larger image" width="100" /></a>When editing or creating a forum in phpBB, you may encounter the following error: (See image to the right)</p>
<div align="center"><pre style="width:300px;">   Warning
The specified forum image does not exist </pre></div>
<h2>What causes this Warning?</h2>
<p>This error is caused by a broken image link in your phpBB forum settings or a missing image file on your server.  Simply removing the link will fix it. If you want the image to shop you will need to upload the image to the server again.<br style="clear: both;" />
</p>


<h2>Fixing the Warning </h2>
<p>This error can be fixed a couple ways. One way is to remove the image link from the <em>Forum image</em> box and the other is to upload the correct image. Below are two options for fixing  &quot;<em>The specified forum image does not exist</em>&quot; warning in phpBB.
</p>
<h3>Option 1: Removing the Forum image url/filename</h3>
<ol class="article_list">

<li><a href="http://www.inmotionhosting.com/support/edu/phpbb/getting-started-phpbb/phpbb-login" title="Click for more information">Log into your phpBB Administrator Control Panel (ACP)</a>.</li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/301/warning-image-does-not-exist-1-forum.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Select Forum Tab phpBB" src="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/301/warning-image-does-not-exist-1-forum.png" title="Click here to view the larger image" width="100" /></a>Click the <strong>Forums tab</strong> at the top right.<br style="clear: both;" />
</li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/301/warning-image-does-not-exist-1-select-edit.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Select teh edit button phpBB" src="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/301/warning-image-does-not-exist-1-select-edit.png" title="Click here to view the larger image" width="100" /></a>Select the <strong>Edit</strong> icon in the right section of the forum category.
<br style="clear: both;" />
</li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/301/warning-image-does-not-exist-1-take-old-name-out.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Remove the old image name phpBB" src="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/301/warning-image-does-not-exist-1-take-old-name-out.png" title="Click here to view the larger image" width="100" /></a><strong>Remove</strong> the Forum Image name from the text box.
...
<h3>Option 2: Uploading a new  Forum image to the server</h3>
<ol class="article_list">

<li><a target="_blank" href="/support/website/how-to/how-to-edit-a-file" title="How do I upload a file on my server?">Upload the image to your server</a>.

  <p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/301/warning-image-does-not-exist-2-filename.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Upload new image to server phpBB" src="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/301/warning-image-does-not-exist-2-filename.png" title="Click here to view the larger image" width="100" /></a>In this example we uploaded an image to the <em>/images</em> folder.
<br style="clear: both;" />
  </p></li>

<li><a href="http://www.inmotionhosting.com/support/edu/phpbb/getting-started-phpbb/phpbb-login" title="Click for more information">Log into your phpBB Administrator Control Panel (ACP)</a>.
</li>

<li>Click the <strong>Forums tab</strong> and edit a forum category.</li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/301/warning-image-does-not-exist-3-fixed.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Fixed the error phpBB" src="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/301/warning-image-does-not-exist-3-fixed.png" title="Click here to view the larger image" width="100" /></a>Type the location to the specific file in the <strong>Forum Image text box</strong>. In this example the following is used:
  <pre style="margin-left:20px;">/images/recycle.png</pre>
<p><strong>Save</strong> the changes. Now you should see your image below the Forum Image box.<br style="clear: both;" /></p>
</li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/phpbb'>phpBB</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 6: 302: Fixing &quot;The specified forum image does not exist&quot; error in phpBB</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 5: <a href='/support/edu/phpbb/306-change-group-display-color'>306: How to change your group's display color in phpbb</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 7: <a href='/support/edu/phpbb/301-edit-registration-page'>301: How to Modify the Registration Page Text in phpBB</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/phpbb/301-fixing-the-specified-forum-image-does-not-exist-error&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/phpbb/301-fixing-the-specified-forum-image-does-not-exist-error'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xMDQmaWQ9MjUyNyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="b3a609da4be09e9a651026eaca7deee7" value="1" />	</div>
	</form>
<!-- <br />
