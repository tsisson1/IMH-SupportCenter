<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:48964:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-3/server-settings" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="keywords" content="joomla 3.0 server settings" />
  <meta name="description" content="In the following set of tutorials, we will review the various server settings that are available within Joomla 3.0" />
  <title>206: Configuring Server Settings in Joomla 3 | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-3/server-settings" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:66796ec9b9fbda16aa24f81b5c484915 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '120.150.197.173']);
...
<div class='page-header'>
	<h1>206: Configuring Server Settings in Joomla 3</h1>
</div>
<div class='section_listing'>
		<table>
	<tr><td colspan='3'><h2>Server Settings</h2></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 1:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-3/server-settings/change-path-to-temp-folder'>How to change the path to your Temp Directory in Joomla 3.1</a>
					<div>In this tutorial, we'll explain how Joomla 3.0 uses the temp folder setting, and how you can change the location of the temp folder.</div>
					<div class='smallgrey'>Hits: 41,847</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-3/server-settings/gzip-page-compression'>How to use Gzip Page Compression in Joomla 3.1</a>
					<div>With gzip page compression, you can compress pages before they are sent to your users, which may make your site load faster for them.</div>
					<div class='smallgrey'>Hits: 8,197</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-3/server-settings/error-reporting'>Joomla 3.1 Error Reporting</a>
					<div>In this tutorial, we'll review the Error Reporting setting in Joomla 3.0, which allows you to control the level of information displayed in error messages.</div>
					<div class='smallgrey'>Hits: 7,538</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-3/server-settings/force-ssl-setting'>How to Force SSL in Joomla 3.1</a>
					<div>Joomla 3.0 gives you the option to force ssl within your website. Be careful that you do have SSL for your domain before setting this value, otherwise you could potentially lock yourself out of your website!</div>
					<div class='smallgrey'>Hits: 12,583</div>
				</td>
			</tr>
		<tr><td colspan='3' style='padding-top:20px;'><h2>Location Settings</h2></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 5:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-3/server-settings/server-time-zone'>Joomla 3.1 Server TimeZone</a>
					<div>The Server Time Zone in Joomla 3.0 allows you to adjust the timezone used by your website.</div>
					<div class='smallgrey'>Hits: 7,485</div>
				</td>
			</tr>
		<tr><td colspan='3' style='padding-top:20px;'><h2>FTP Settings</h2><div>Settings for using the built in FTP functionality</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 6:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-3/server-settings/ftp-settings'>Configuring FTP Settings in Joomla 3.1</a>
					<div>If your server requires, you can follow these instructions to configure your FTP settings within Joomla 3.0</div>
					<div class='smallgrey'>Hits: 17,087</div>
				</td>
			</tr>
		<tr><td colspan='3' style='padding-top:20px;'><h2>Database Settings</h2></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 7:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-3/server-settings/database-settings'>How to change Database Settings within Joomla 3.1</a>
					<div>In this tutorial, we'll show you how to change your Joomla 3.0 database settings. Please note that these steps are usually only taken if you move hosting providers.</div>
					<div class='smallgrey'>Hits: 3,946</div>
				</td>
			</tr>
		<tr><td colspan='3' style='padding-top:20px;'><h2>Mail Settings</h2><div>Configure Joomla so it can send emails from the server</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 8:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-3/server-settings/change-email-settings'>Changing Email Settings in Joomla 3.1</a>
					<div>If Joomla 3.0 is not sending emails properly from your server, follow the steps on this page to change your settings.</div>
					<div class='smallgrey'>Hits: 15,149</div>
				</td>
			</tr>
			</table>
</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNTgmaWQ9MjU4JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="f62929d48f0f003b61741d08ee245ece" value="1" />	</div>
	</form>
<!-- <br />
