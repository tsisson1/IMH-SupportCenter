<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:54063:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/how-to/help-with-pointing-my-domain-name" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Willrsylvester@gmail.com, Thanks for the question! IN order to point your current host, you will need to change the name server for the domain. Th..." />
  <title>Help with pointing my domain name | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/how-to/help-with-pointing-my-domain-name" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:134af15bf868be92649e11d60d6f45b3 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Help with pointing my domain name</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/willrsylvester@gmail&per;com'>willrsylvester@gmail.com</a>
			<div>8 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-12-05 2:20 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>1,611</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I own the domain name curedinstitute.com with your company. I am hosting with strikingly.com.<br />
Please help me point the domain to strikingly. I have read your tutorials and still am unable to do this. I know very little about the technical aspects of this process. I would greatly appreciate it if you could take a look and give me clear step by step instructions so I can accomplish this task?<br />
Thank you</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_4289' id='upvote_answer_4289' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='4289' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_4289').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_4289' id='downvote_answer_4289' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='4289' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_4289').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>32,263 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2013-12-05 2:46 pm EST
                		        </div>
					
		                </div>

				Hello Willrsylvester@gmail.com,<br />
<br />
Thanks for the question!  IN order to point your current host, you will need to change the name server for the domain.  This can be done through your <a href="http://www.inmotionhosting.com/support/website/amp/how-to-log-into-amp" target="new">Account Management Panel (AMP) login</a>.   You will need to obtain your name servers from your current host, and then login to AMP and <a href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/change-domain-nameservers-amp" target="new">change the domain name servers</a>.  The change requires about 24 hours in order to take effect. This period of time is called <a href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/domain-names-dns-changes" target="new">domain propagation</a>.  When the change is complete all web and email traffic will be directed to your new host location.<br />
<br />
Regards,<br />
Arnel C.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_4289').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_4289' id='form_comment_on_answer_4289' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Thank you. Can you clarify what a name server is, what it looks like, and how I go about changing it?</div>
							...
							<td style='width:96px;' valign='top'>
								...
								<div class='smallgrey'>
									<a href='/support/community-support/users/willrsylvester@gmail&per;com'>willrsylvester@gmail.com</a><br />
									8 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2013-12-06 1:04 pm EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello Willrsylvester@gmail.com,<br />
<br />
Name servers are the servers that are assigned to a domain per the domain registrar that indicate how and where the domain name is being used.  For example, if you want to see the name servers of curedinstitute.com, you can run a WHOIS query or look up a WHOIS service on the web.  The results (abbreviated) will look something like this:<br />
<br />
Domain details for curedinstitute.com from http://www.melbourneit.com<br />
Registrar:      MELBOURNE IT, LTD. D/B/A INTERNET NAMES WORLDWIDE<br />
Status:         ok<br />
Created:        2013-12-03<br />
Changed:        2013-12-05<br />
Expires:        2014-12-03<br />
Admin email:    crensfield@aol.com<br />
Name server:    freedns1.registrar-servers.com  184.172.206.242<br />
Name server:    freedns2.registrar-servers.com  50.30.32.27<br />
Name server:    freedns3.registrar-servers.com  184.173.112.217<br />
Name server:    freedns4.registrar-servers.com  173.236.55.100<br />
Name server:    freedns5.registrar-servers.com  81.19.183.115<br />
<br />
If you want more information on name servers, please read our tutorial labeled <a href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/what-is-a-name-server" target="new">What is a name server?</a><br />
<br />
I also searched for documentation provided through Strikingly.com to connect a custom domain (which is what you're basically asking).  Here is the <a href="http://support.strikingly.com/knowledgebase/articles/192451" rel="nofollow" target="new">link</a> for the steps they give for you to do this.  <br />
<br />
I hope this helps to clear it up!<br />
<br />
Regards,<br />
Arnel C.<br />
</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/how-to/help-with-pointing-my-domain-name&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/how-to/help-with-pointing-my-domain-name'></div>
<script type='text/javascript'>
  (function() {
