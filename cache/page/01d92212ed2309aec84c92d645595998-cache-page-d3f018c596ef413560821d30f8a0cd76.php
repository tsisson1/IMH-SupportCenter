<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:60639:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.net/support/edu/prestashop-15/set-configure-catalog-modes/enable-b2b-mode" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-09-18T18:07:06-07:00" />
  <meta name="keywords" content="enable b2b PrestaShop 1.5" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="This PrestaShop 1.5 tutorial shows you how to enable B2B (business to business) mode." />
  <title>How to enable B2B mode in PrestaShop 1.5 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/prestashop-15/set-configure-catalog-modes/enable-b2b-mode" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:bee3ff06825634649b1d6f7366e953b5 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to enable B2B mode in PrestaShop 1.5									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>9,459</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jun 7, 2012'><span style='color:#606060;'>Published:</span> Sep 18, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>You may want to enable b2b (business to business) mode in your PrestaShop 1.5 store. This will enable some special b2b modules. Setting the brb mode in PrestaShop 1.5 is a simple procedure.</p>
<p><strong>To enable B2B mode in PrestaShop 1.5:</strong></p>
<ol class="article_list">
<li><a href="/support/edu/prestashop-15/getting-started/login-to-dashboard">Log into your PrestaShop 1.5 dashboard.</a></li>
<li>Using the top menu bar, hover over the <strong>Preferences </strong>tab and select the <strong>Customers </strong>option.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Preferences/customers/preferences-tab-customers.png"><img  alt="preferences-tab-customers" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Preferences/customers/preferences-tab-customers.png" /></a></li>
<li>You are now on the <strong>Preferences : Customers</strong> screen. Find the <strong>Enable B2B Mode</strong> setting on the screen. Click the <strong>Yes </strong>option to enable the mode.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Preferences/customers/preferences-customers-enable-b2b.png"><img  alt="preferences-customers-enable-b2b" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Preferences/customers/preferences-customers-enable-b2b.png" /></a></li>
<li>Once set, click on the <strong>Save </strong>button on the top of the screen.</li>
</ol>
<p>You have now successfully enabled B2B mode in PrestaShop 1.5</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 2: How to enable B2B mode in PrestaShop 1.5</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 1: <a href='/support/edu/prestashop-15/set-configure-catalog-modes/set-catalog-mode'>How to set Catalog Mode in PrestaShop 1.5</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 3: <a href='/support/edu/prestashop-15/set-configure-catalog-modes/how-to-set-maintenance-mode-in-prestashop-15'>How to set Maintenance mode in PrestaShop 1.5</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.net/support/edu/prestashop-15/set-configure-catalog-modes/enable-b2b-mode&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.net/support/edu/prestashop-15/set-configure-catalog-modes/enable-b2b-mode'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yOTEmaWQ9MTQyNiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="7dc4ed2cdc79d75fb25475e681de9157" value="1" />	</div>
	</form>
<!-- <br />
