<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:51607:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/file-management/ftp-no-longer-working-in-windows-explorer" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, Thank you for contacting us today. Since this is just our public forums, I have marked out your personal information for security purposes. This ..." />
  <title>FTP No Longer Working in Windows Explorer | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/file-management/ftp-no-longer-working-in-windows-explorer" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:8ceee5c26b977f1060355c6f63ec5a48 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '159.10.134.170']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>FTP No Longer Working in Windows Explorer</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2014-07-21 10:43 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>2,523</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Dear Folks at Inmotion Support,<br />
<br />
Hello.  My account is wonderprofessor.com.  My e-mail is fpaiano@swccd.edu.  I used to be able to use Windows Explorer for FTP.  However, as of yesterday, Sunday, July 20th, 2014, it is giving me a very strange message. Here is the message: The folder 'ftp://wonder28:&lt;password&gt;@wonderprofessor.com/' is read-only because the proxy server is not set up to allow full access.  To move, paste, rename, or delete files, you must use a different proxy.  For information on changing your proxy, contact your administrator.&quot; <br />
<br />
Thankfully, I can still use the File Manager in cPanel but it is not very flexible.  Did you make a change to your proxy (whatever that is)?  To the best of my knowledge, I did not change anything on my computer.  Do you know what I have to do to allow me to continue to use Windows Explorer?<br />
<br />
...
fpaiano@swccd.edu<br />
Mobile: 619-248-0945<br />
<br />
P.S. I did search through your documentation first, thank you.</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_5286' id='upvote_answer_5286' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='5286' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_5286').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_5286' id='downvote_answer_5286' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='5286' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_5286').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
Thank you for contacting us today. Since this is just our public forums, I have marked out your personal information for security purposes.<br />
<br />
This seems like a common problem, since I was able to find a similar post in the <a href="http://support.microsoft.com/kb/199376" target="_blank">Official Microsoft Support Forums</a>.<br />
<br />
In that post Microsoft provides several possible <em>causes</em> for this error, including the following: To resolve this issue, disable the Web-based FTP option. To do this, follow these steps (on  your computer):<ul><li>Click <strong>Start</strong>, point to <strong>Settings</strong>, and then click <strong>Control Panel</strong>.</li><li>Double-click <strong>Internet Options</strong>.</li><li>On the <em>Advanced</em> tab, click to clear the <strong>Enable folder view for FTP sites check box</strong>, and then click <strong>OK</strong>.</li></ul>If this still does not work, I recommend using a true FTP client such as <a href="http://www.inmotionhosting.com/support/website/ftp-client-setup/configuring-your-site-in-filezilla">FileZilla</a>.<br />
<br />
...
-John-Paul
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_5286').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_5286' id='form_comment_on_answer_5286' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/file-management/ftp-no-longer-working-in-windows-explorer&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/file-management/ftp-no-longer-working-in-windows-explorer'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="1ea3485c9a5d473291d43ab1e14516f5" value="1" />	</div>
	</form>
<!-- <br />
