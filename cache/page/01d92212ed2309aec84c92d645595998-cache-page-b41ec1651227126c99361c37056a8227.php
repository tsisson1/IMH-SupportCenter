<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:52281:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/databases/where-can-i-change-maxallowedpacket-for-mysql" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello AlexCampean, You will most likely have to actually the local php.ini file. You will not be able to change the CNF file specific to the server sinc..." />
  <title>Where can I change &quot;max_allowed_packet&quot; for MySQL? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/databases/where-can-i-change-maxallowedpacket-for-mysql" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:8efaabf00b44286a5379206ee1ada8de -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-20']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '2.103.211.91']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box straight_bottom'>
                <h1 style='font-size:26px;'>Where can I change &quot;max_allowed_packet&quot; for MySQL?</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/AlexCampean'>AlexCampean</a>
			<div>8 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-03-21 5:28 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>5,649</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I'm trying to upload some files larger than 5Meg to Tiki Wiki CMS.  Tiki uses MySQL.  So I added &quot;max_allowed_packet=128M&quot; to &quot;my.cnf&quot; (reference http://tinyurl.com/c9ol9za ) but MySQL still reports that &quot;max_allowed_packet=5M&quot;.  So where do I change max_allowed_packet so it takes in MySQL?</div>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px;'>
				<div style='font-size:12px; max-width:500px; overflow:auto;'>Update: It turns out that something else was the bottleneck to uploading files larger than 5Meg to Tiki Wiki CMS.  After updating to Tiki 10.2, I uploaded a 6Meg file.  Don't know if it was an application issue (likely) or inmotion reconfigured something with their MySQL server (unlikely).</div>
			...
			<td style='width:100px;' valign='top'>
				...
				<div class='smallgrey'>
					<a href='/support/community-support/users/AlexCampean'>AlexCampean</a><br />
					8 <a href='/support/team/points' target='_blank'>Points</a><br />
					2013-04-05 03:18 pm EST
				</div>
			</td>
		</tr>
	</table>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_2488' id='upvote_answer_2488' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='2488' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_2488').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_2488' id='downvote_answer_2488' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='2488' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_2488').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>32,263 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2013-03-21 6:15 pm EST
                		        </div>
					
		                </div>

				Hello AlexCampean,<br />
<br />
You will most likely have to actually the local php.ini file.  You will not be able to change the CNF file specific to the server since you're on a Shared server.  The change you're looking for will need to made in PHP.INI, though.  Check out this article - you will see the section for max upload:<br />
<br />
<a href="/support/www.inmotionhosting.com/support/website/general-server-setup/update-local-php-settings" target="new">Update Local PHP Settings</a><br />
<br />
...
Arnel C.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_2488').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_2488' id='form_comment_on_answer_2488' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Unfortunately, updating the php.ini file does nothing.  Taking the further step of making php.ini recursive broke my other website (500 server error). <br />
<br />
I read the MySQL documentation and this variable is supposed to be set in a MySQL configuration file.  So I tried it on a non-hosted test server and it worked (&quot;max_allowed_packet=128M&quot; in /etc/my.cnf).<br />
<br />
So how do change &quot;max_allowed_packet&quot; on this MySQL server?</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/databases/where-can-i-change-maxallowedpacket-for-mysql&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/databases/where-can-i-change-maxallowedpacket-for-mysql'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="dc16949464586d4b7171c1a25925f49c" value="1" />	</div>
	</form>
<!-- <br />
