<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:54103:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/everything-email/why-do-so-many-of-our-emails-go-into-receivers-junkemailspam-folders" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello SecondHalf, I'm sorry to hear that you're frustrated with the spam issues on the web. The fact is that about 80-90% of ALL email on the web is spa..." />
  <title>Why do so many of our emails go into receiver's junk-email/spam folders? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/everything-email/why-do-so-many-of-our-emails-go-into-receivers-junkemailspam-folders" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:06544dc99a5104cd887a0dd554380720 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-20']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '87.224.11.194']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Why do so many of our emails go into receiver's junk-email/spam folders?</h1>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_2653' id='upvote_answer_2653' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='2653' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_2653').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_2653' id='downvote_answer_2653' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='2653' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_2653').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello SecondHalf,<br />
<br />
I'm sorry to hear that you're frustrated with the spam issues on the web.  The fact is that about 80-90% of ALL email on the web is spam.  What people do to receive their normal email is create filters, or buy company services that filter email so that they receive only content that they deem relevant to them.  So, whether or not your email is legitimate, if a receiving host or email spam program is aggressive or set a certain way, your emails could very easily get marked as spam.  <br />
<br />
This is unfortunately NOT a server or hosting issue.  This is a general issue with email that you will find no matter where you host your business emails.  Is there anything that you can do? There are several things that may help:<br />
<br />
1) Make sure that you are not in violation of the <a href="http://en.wikipedia.org/wiki/CAN-SPAM_Act_of_2003" target="new">CAN-SPAM Act of 2003</a>.  Verify that your emails make the grade and you're not falling into common filtering rules.<br />
<br />
2)Send your customers a normal email message requesting that they white-list your domain, so that you don't get filtered into Spam.<br />
<br />
3)Check to make sure that your Email Authentication is enabled.  This helps stop spam coming from your email address (even if you're not sending any that you know of).   Here's an article on these settings:  <a href="http://www.inmotionhosting.com/support/email/fighting-spam/email-authentication-spf-domainkeys" target="new">Email Authentication Settings.</a><br />
<br />
3)If all else fails, you might want to consider a paid service or use a large service for sending business emails- like Google mail.  There are services for sending out emails for marketing - such as mailchimp.com.  Check them out as possible <a href="http://www.inmotionhosting.com/vps-hosting">solutions</a> since they are also possible solutions to your dilemma.<br />
<br />
The other that you should be doing is examining your bounces.  When an email bounces, it will tell you WHY it's being bounced and give you a source for the bounce.  If you're being listed on a service (that you may not be aware of), then you should see it.  You can also send an email to an email administrator for the service to find out why your emails are being blocked.  Though, I would only do this after examining the reason for the block and you done your due diligence by reading their bounce messages and made sure you're not sending spam.<br />
<br />
Ultimately, as I said in the beginning, you cannot force people to receive your emails or control how they control what get's labeled as spam or junk email.   You can only control those factors that may lead your domain or email as being labeled as a spam generator.   Apologies again for the frustration,  as I'm well aware of what you're facing having faced both sides of this problem.  Hopefully the information that I have provided will help you (and anyone else reading this post) in at least stopping spam being inadvertently being sent as well as providing possible solutions that will lead to successfully marketing your business through email.<br />
<br />
...
Community Support
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_2653').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_2653' id='form_comment_on_answer_2653' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Thank you Arnel for your thoughtful answer. I will look more closely at your suggestions and develop a plan of action. </div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='/support/images/avatars/default_avatar.jpg' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/SecondHalf'>SecondHalf</a><br />
									8 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2013-04-01 6:18 pm EST
								</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/everything-email/why-do-so-many-of-our-emails-go-into-receivers-junkemailspam-folders&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/everything-email/why-do-so-many-of-our-emails-go-into-receivers-junkemailspam-folders'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="12599d5b0de5869e6f52883125648c10" value="1" />	</div>
	</form>
<!-- <br />
