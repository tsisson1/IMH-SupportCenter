<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:57634:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/wordpress/forbidden-error-during-installation" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hi MatijaP, I could be wrong, but I don't think the error you're receiving is because of installing WordPress and sharing the database of another WordPr..." />
  <title>403 error when installing WordPress and sharing a database | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/wordpress/forbidden-error-during-installation" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:09987c1231d97537f0c73886b137a50a -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>403 error when installing WordPress and sharing a database</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='https://lh5.googleusercontent.com/-8oxUgVkRqm0/AAAAAAAAAAI/AAAAAAAAAKY/GezZGOaFMEc/photo.jpg?sz=90' class='user_avatar' /><br />
			<a href='/support/community-support/users/MatijaP'>MatijaP</a>
			<div>22 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-08-30 9:45 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>4,810</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Hello,<br />
I tryed to install second wordpress manually (not from cpanel) inside subdomain's folder with wp-config set to use same database with different prefixes and same user tables.  The Followind error occured at installation (actually at anything):<br />
<br />
...
<br />
If I delete wp-config.php then I can run installation to the point where wp-config file is created. Error shows again. If I install wordpress through cpanel it works, but that is not what I want since database is not shared.<br />
There are no .htaccess files in subdomain folder nor file permissions are any different than on working main wordpress.</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_3838' id='upvote_answer_3838' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='3838' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_3838').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_3838' id='downvote_answer_3838' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='3838' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_3838').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hi MatijaP,<br />
<br />
I could be wrong, but I don't think the error you're receiving is because of installing WordPress and sharing the database of another WordPress installation.<br />
<br />
&lt;h2&gt;403 errors - check your permissions&lt;/h2&gt;<br />
&lt;a href='/support/website/error-numbers/403-forbidden-error' target='_blank'&gt;403 errors&lt;/a&gt; are usually caused by incorrect file permissions. You'll want to make sure that your folders have permissions of 755 and your files have permissions of 644. If you're installing WordPress manually, it could be that when you unzipped a file or uploaded the files that one of them was set not using 755 / 644.<br />
<br />
If it is a file permissions issue, or even it if it isn't, the &lt;em&gt;error log&lt;/em&gt; section of your cPanel may give you more details of what is causing the problem. For example, &lt;em&gt;403 forbidden error&lt;/em&gt; is very vague, the error log may tell you which file has incorrect permissions. The following tutorial has more information about the error log in cPanel:<br />
&lt;a href='/support/website/cpanel/how-to-view-cpanel-error-logs' target='_blank'&gt;How to view cPanel Error logs&lt;/a&gt;<br />
<br />
If the problem is file permissions, you can follow the steps in the below article to learn how to modify your file permissions:<br />
&lt;a href='/support/website/how-to/change-file-permissions' target='_blank'&gt;How to change file permissions within cPanel&lt;/a&gt;<br />
<br />
&lt;h2&gt;What has caused 403 errors for others when installing WordPress?&lt;/h2&gt;<br />
<br />
On this page, &lt;a href='http://wordpress.org/support/topic/403-during-install-on-step-5-run-the-install-script' target='_blank'&gt;403 during install on step 5 (Run the install script)&lt;/a&gt;, the user stated their solution included:<br />
&lt;em&gt;This worked: Initially, I had moved the directory where the tarball was untar-ed to the html directory and changed the permissions. That did not work. Later on, I created a directory and copied all the files to that directory. That worked fine.&lt;/em&gt; <br />
<br />
Here, &lt;a href='http://wordpress.org/support/topic/403-forbidden-for-installphp' target='_blank'&gt;403 Forbidden for install.php&lt;/a&gt;, the user's solution was:<br />
&lt;em&gt;I had this problem on my own server. It turns out I was installing the blog into a directory which was not permissibe enough. For example, installing at http://myserver/blogs/blogname/ didn't work until I set both the 'blogs' and 'blogname' directory to 775. (In addition to making sure install.php was 777 and wp-config.php was 775).&lt;/em&gt;<br />
<br />
Let us know if the information about helps or not. Thanks!<br />
- Brad
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_3838').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_3838' id='form_comment_on_answer_3838' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Thank you on fast and detail reply,<br />
It looks like my subdomain folder was 740 instead 745, and both install.php and wp-config.php were 644.<br />
Subdomain folder owner was same, but group was different for some reason.<br />
<br />
I changed that, and tryed different folders, and copying all files to the new folders but it still didn't work. Finally figured out that plugin WP better security of my main wordpress has done changes to .htaccess file so it redirects any attempt of accessing wp-login, wp-admin, install.php etc., not just in root but in all folders everywhere ever. Is there a way I could make .htaccess file in my subdomain folder that sets all rules to default or something ignoring parent folders? I really don't want to disable that plugin or any other on my main wordpress. </div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='https://lh5.googleusercontent.com/-8oxUgVkRqm0/AAAAAAAAAAI/AAAAAAAAAKY/GezZGOaFMEc/photo.jpg?sz=90' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/MatijaP'>MatijaP</a><br />
									22 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
...
Arnel C.</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Finally it works.<br />
I somehow managed to disable the right .htaccess statements, manually installed other wordpress in same database, and installed same plugin to make rewrites in subfolder. Now it works.<br />
Thx for bearing with me.</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/wordpress/forbidden-error-during-installation&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/wordpress/forbidden-error-during-installation'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="01ea19723ec6634b0fb3745992642f44" value="1" />	</div>
	</form>
<!-- <br />
