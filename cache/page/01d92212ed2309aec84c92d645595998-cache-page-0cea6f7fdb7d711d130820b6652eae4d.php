<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:45518:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.info/support/edu/joomla-3/registered-users" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="keywords" content="joomla 3.0 users" />
  <meta name="description" content="In the following set of tutorials, we'll show you how to work with registered users within your site." />
  <title>106: Working with Users in Joomla 3 | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-3/registered-users" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:6e10665f6fa9e38fac37a7bcd190ca29 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '173.208.91.136']);
...
<div class='page-header'>
	<h1>106: Working with Users in Joomla 3</h1>
</div>
<div class='section_listing'>
		...
		<tr>
				...
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-3/registered-users/disabling-user-registration'>How to Disable User Registration in Joomla 3.1</a>
					<div>Not all websites need to allow users to register for accounts. You can disable user registration in Joomla 3.0, and we'll show you how in this tutorial.</div>
					<div class='smallgrey'>Hits: 20,330</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-3/registered-users/hide-login-module'>How to hide the login module in Joomla 3.1</a>
					<div>If you no longer want to show the login form on your Joomla 3.0 website, you can hide it by disabling the login form module.</div>
					<div class='smallgrey'>Hits: 12,663</div>
				</td>
			</tr>
			</table>
</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNjcmaWQ9MjY3JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="270e195492c75ed1c5057b74f249176d" value="1" />	</div>
	</form>
<!-- <br />
