<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:51174:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/wordpress/wordpress-422-500-internal-server-error-when-featured-image-pic" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, Thank you for your question on the WordPress theme error. You may want to switch the live server to php 5.5 and see if that helps. That is at lea..." />
  <title>Wordpress 4.2.2 -  500 Internal Server Error when &quot;featured image&quot; pic | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/wordpress/wordpress-422-500-internal-server-error-when-featured-image-pic" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:ff0afdcbf723a547537186803033b1d2 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Wordpress 4.2.2 -  500 Internal Server Error when &quot;featured image&quot; pic</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-07-04 11:20 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>90</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I'm getting a  500 Internal Server Error when I click on navigation link for page containing a post that has a &quot;featured image.&quot;   Wordpress 4.2.2 / PHP 5.4.35 / Centos 6.5 VPS server.  This is also an Envato Wordpress theme called &quot;Matador.&quot;   If I remove the &quot;featured image&quot; it works.  When loaded on my Centos 6.5 / PHP 5.5.18 test server I have no problems.  Also, I just switched the theme away from Matador and it worked.  So I clearly  have a theme issue, which I will also take up with the vendor.  Has anyone else experienced this.  PHP config setting perhaps?  Database parameter, maybe?</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_7583' id='upvote_answer_7583' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='7583' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_7583').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_7583' id='downvote_answer_7583' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='7583' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_7583').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
Thank you for your question on the WordPress theme error. You may want to switch the live server to php 5.5 and see if that helps. That is at least what I would do if I have no other reason to stay on 5.4. It may clear the error up.  We have not have any other reports of this specific issue, though to be fair, we have not had any other reports of issues with that theme at all.<br />
<br />
Perhaps another reader may have run across this and can provide additional information.<br />
<br />
Kindest Regards,<br />
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_7583').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_7583' id='form_comment_on_answer_7583' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/wordpress/wordpress-422-500-internal-server-error-when-featured-image-pic&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/wordpress/wordpress-422-500-internal-server-error-when-featured-image-pic'></div>
<script type='text/javascript'>
  (function() {
