<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49643:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/file-management/what-cant-i-upload-files-using-google-chrome" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hi photoholic, Thanks for posting your question. Where are you uploading the files to? Are you using the cPanel file manager? If so, and you re-fresh fi..." />
  <title>What can't I upload files using Google Chrome? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/file-management/what-cant-i-upload-files-using-google-chrome" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:b5935311fb075b7f094d95cd6b8d47ef -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '70.199.194.99']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>What can't I upload files using Google Chrome?</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/photoholic'>photoholic</a>
			<div>8 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-01-22 11:55 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>10,345</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I just downloaded the latest version of Google Chrome for the MAC and have not been able to upload files using it. All I get is a popup box saying the files are uploading and never get a final message saying the upload was complete the way I do in Firefox.</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_441' id='upvote_answer_441' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='441' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_441').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_441' id='downvote_answer_441' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='441' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_441').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hi photoholic,<br />
<br />
Thanks for posting your question. Where are you uploading the files to? Are you using the cPanel file manager? If so, and you re-fresh file manager are the files present? Keep in mind, every browser works differently. Let me know if you need further assistance and I'll be happy to look into it further for you.<br />
<br />
Thanks!<br />
<br />
Tim S
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_441').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_441' id='form_comment_on_answer_441' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/file-management/what-cant-i-upload-files-using-google-chrome&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/file-management/what-cant-i-upload-files-using-google-chrome'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="83913d69040e5c5708f5e6881885a385" value="1" />	</div>
	</form>
<!-- <br />
