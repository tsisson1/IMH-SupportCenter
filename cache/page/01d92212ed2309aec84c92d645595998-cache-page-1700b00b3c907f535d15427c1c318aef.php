<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:51963:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/how-to/how-do-i-execute-php-code-in-a-html-page" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hi sandiego, Thanks for posting your question. I'm more than happy to assist you today. You have two options when facing the problem that your PHP code ..." />
  <title>How do I execute PHP code in a HTML page? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/how-to/how-do-i-execute-php-code-in-a-html-page" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:475ba4751a875dac04027fc5acb5400a -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '103.255.4.77']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>How do I execute PHP code in a HTML page?</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/sandiego'>sandiego</a>
			<div>8 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-02-11 7:18 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>16,945</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Ultimately, I'd like to insert a short line of PHP to get the current date and format it a specific way.<br />
<br />
Right now, if I put PHP into my HTML it sends the PHP to the browser!<br />
<br />
I need the server to run the PHP and insert the output into my HTML.  What do I need to do?<br />
<br />
For example, I added two lines to the 'default.htm' that came out of the box.   First line is &quot;TESTING...&quot;<br />
Second line is <br />
<br />
<br />
TESTING...<br />
...
<br />
<br />
When I refresh the page, &quot;TESTING...&quot; shows up, but not &quot;HELLO&quot;.  If I use the browser to inspect the page source, I see my PHP code.<br />
<br />
Thanks!</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_567' id='upvote_answer_567' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='567' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_567').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_567' id='downvote_answer_567' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='567' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_567').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hi sandiego,<br />
<br />
Thanks for posting your question. I'm more than happy to assist you today. You have two options when facing the problem that your PHP code is not executing in an HTML page. Since the web server thinks the page is written in HTML, it does not know to execute the PHP code. You can save the page as a .php file and this should resolve the issue.<br />
<br />
Alternatively, if you have a alot of links to that page, changing the file extension will break all the links. You can tell the server in your .htaccess file to execute all HTML pages as though they are PHP. Here's the code to do that:<br />
<br />
<p class="code_block">AddType application/x-httpd-php .html</p><br />
<br />
This tells the server to execute all files with the .html extension as a PHP file. <br />
<br />
If you are using the .htm extension on your files you'd add this code:<br />
<br />
<p class="code_block">AddType application/x-httpd-php .htm</p><br />
<br />
Lastly, if you wanted to execute just one file that's got the extension of .html or .htm as a PHP file you could add this line of code:<br />
<br />
<p class="code_block">&lt;Files yourpage.html><br />
AddType application/x-httpd-php .html<br />
&lt;/Files><p><br />
<br />
Remember, you'll need to replace the yourpage.html with your actual file name. If you need further assistance please feel free to contact us.<br />
<br />
Thanks!<br />
<br />
Tim S
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_567').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_567' id='form_comment_on_answer_567' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>The above didn't work for me. However this did:<br />
AddHandler application/x-httpd-php5 .html .htm<br />
							...
							<td style='width:96px;' valign='top'>
								...
								<div class='smallgrey'>
									<a href='/support/community-support/users/billj9000'>billj9000</a><br />
									3 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2013-04-13 9:10 am EST
								</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/how-to/how-do-i-execute-php-code-in-a-html-page&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/how-to/how-do-i-execute-php-code-in-a-html-page'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="802c73d295b7dbc902b814b37b3e9061" value="1" />	</div>
	</form>
<!-- <br />
