<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49332:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/databases/ipv6-additional-mysql-access-hosts" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, At this time it seems that ipv6 is not currently supported by cPanel as in regards to remote mysql access. Do you have an ipv4 address? Best Rega..." />
  <title>ipv6 Additional MySQL Access Hosts | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/databases/ipv6-additional-mysql-access-hosts" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:1d81d8f14b20df7b260596007a5b2120 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>ipv6 Additional MySQL Access Hosts</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-09-11 4:07 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>123</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>How can I add ipv6 address into &quot;Additional MySQL Access Hosts&quot;?</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_8089' id='upvote_answer_8089' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='8089' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_8089').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_8089' id='downvote_answer_8089' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='8089' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_8089').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
At this time it seems that ipv6 is not currently supported by cPanel as in regards to remote mysql access. Do you have an ipv4 address? <br />
<br />
Best Regards,<br />
TJ Edens
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_8089').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_8089' id='form_comment_on_answer_8089' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/databases/ipv6-additional-mysql-access-hosts&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/databases/ipv6-additional-mysql-access-hosts'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="c60ee1ded3ea95ccfc5fe8d0b1f67f15" value="1" />	</div>
	</form>
<!-- <br />
