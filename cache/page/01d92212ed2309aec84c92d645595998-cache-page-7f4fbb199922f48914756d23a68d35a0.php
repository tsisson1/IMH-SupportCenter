<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:53910:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-3/registered-users/quiz" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="InMotion Hosting Support Center" />
  <title>QUIZ | 106: Working with Users in Joomla 3 | InMotion Hosting</title>
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:e27e2dd7e66c127448b84411966dab1c -->
...
<div class='item-page'>
	<div class='page-header'>
		<h1>QUIZ | 106: Working with Users in Joomla 3</h1>
	</div>

	<div class='page-header about-quiz'>
                <p>
                        The information in this quiz has been taken from the following course:<br />
                        <a href='http://www.inmotionhosting.com/support/edu/joomla-3/registered-users'>106: Working with Users in Joomla 3</a>
                </p>

                <p>This quiz is not official, it's just for fun. Successfully completing this quiz will however earn you 1,000 points towards your user profile!</p>

                <p style='color:red;'>You are not logged in! Please <a href='/support/login'>login</a> save your results and earn points!</p>
        </div>
	...
	<form method='post'>
		<div class='question'><p>By default, Joomla! has <strong>user registration</strong> disabled.</p>
			<div class='possible_answer'>
				<input type='radio' name='question_1' id='question_1' value='1'  /><p>True</p>
			</div>
		
			<div class='possible_answer'>
				<input type='radio' name='question_1' id='question_1' value='2'  /><p>False</p>
			</div>
		
		</div>
	
		<div class='question'><p>If you disable user registration in Joomla!, the login module will hide automatically.</p>
			<div class='possible_answer'>
				<input type='radio' name='question_2' id='question_2' value='3'  /><p>True</p>
			</div>
		
			<div class='possible_answer'>
				<input type='radio' name='question_2' id='question_2' value='4'  /><p>False</p>
			</div>
		
		</div>
	
		<div class='question'><p>After disabling user registration, which of the following features will no longer show on your <strong>login form</strong>?</p>
			<div class='possible_answer'>
				<input type='radio' name='question_3' id='question_3' value='5'  />Create an account
			</div>
		
			<div class='possible_answer'>
				<input type='radio' name='question_3' id='question_3' value='6'  />Remember Me
			</div>
		
			<div class='possible_answer'>
				<input type='radio' name='question_3' id='question_3' value='7'  />User Name
			</div>
		
			<div class='possible_answer'>
				<input type='radio' name='question_3' id='question_3' value='8'  />Password
			</div>
		
		</div>
	
			<input type='hidden' name='taska' id='taska' value='process_answers' />
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNjcmaWQ9MzM1MyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/joomla-3/registered-users?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Working with Users in Joomla 3</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/joomla-3/registered-users/disabling-user-registration?tsrc=rsbedu'>How to Disable User Registration in Joomla 3.1</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/joomla-3/registered-users/hide-login-module?tsrc=rsbedu'>How to hide the login module in Joomla 3.1</a></td>
                </tr>
          	</table>
