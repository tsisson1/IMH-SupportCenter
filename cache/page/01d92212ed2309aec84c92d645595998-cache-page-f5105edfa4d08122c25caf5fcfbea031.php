<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:62167:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/cpanel/getting-started-cpanel/using-cpanel-video-tutorials" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-09-23T02:27:08-07:00" />
  <meta name="keywords" content="video tutorial help cPanel how to" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="Learn how to use the resources built into cPanel to help you with various tasks." />
  <title>Using the cPanel Video Tutorials - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/cpanel/getting-started-cpanel/using-cpanel-video-tutorials" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:b2950025c66e1fee30904e65eb6c1178 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Using the cPanel Video Tutorials									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>5,806</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Sep 2, 2011'><span style='color:#606060;'>Published:</span> Sep 23, 2015</div>
							...
							<div style='clear:both;'></div>
								...
								<p>With so many robust features built into cPanel it is important to know what resources are available. cPanel has some wonderful video tutorials built into it and provide you with step-by-step instructions on how to perform various tasks.</p>
<p>To access the video tutorials, make sure you are logged into cPanel and click on one of the icons available:</p>
<p class="alert"><strong>Important!</strong> The cPanel videos are the same for all accounts. Some of the videos may only work on VPS or Dedicated servers. Ths is because the cPanel software is a 3rd party software that comes with the videos. They are not server specific.</p>
<p>&nbsp;<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/cpanel/video-backup.jpg"><img  alt="video-backup" src="//cdn.inmotionhosting.com/support/images/stories/cpanel/video-backup.jpg" /></a></p>
<p>The video tutorial button is located towards the top of the page. Once the tutorial button is clicked the video will automatically load.&nbsp;</p>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/cpanel/cpanel-backup-video.jpg"><img  alt="cpanel-backup-video" src="//cdn.inmotionhosting.com/support/images/stories/cpanel/cpanel-backup-video.jpg" /></a></p>
<p>Notice, the buttons on the bottom of the video which allows you to control the actual video. At any time if you need to stop, start, rewind, or pause the video you can.</p>
<p>With any InMotion server package, you can put these tutorials to use because we offer <a href="http://www.inmotionhosting.com/cpanel-hosting/free-cpanel-hosting.html">free cpanel hosting</a> to all of our customers!</p>
<p>Please check the next article on <a target="_blank" href="/support/edu/cpanel/getting-started-cpanel/change-cpanel-password" title="Click here to view the next article">How to change your cPanel password</a>. If you missed our previous article, please see the <a href="/support/edu/cpanel/getting-started-cpanel/cpanel-layout" title="Click here to view the previous article" target="_blank">The cPanel Layout</a> tutorial. For more information on this course please visit <a target="_blank" href="/support/edu/cpanel/getting-started-cpanel" title="Click here to view the courses">Getting Started in cPanel</a>.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 8: Using the cPanel Video Tutorials</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 9: <a href='/support/edu/cpanel/getting-started-cpanel/view-disk-bandwidth-usage-cpanel'>How to See your Disk Space and Bandwidth Usage on Shared Servers</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP3RzcmM9cnNiZWR1Jm9wdGlvbj1jb21fY29udGVudCZjYXRpZD0xMzImaWQ9OTcyJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/fbfd204b9f819c481be4f841d8e7ae50?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/fbfd204b9f819c481be4f841d8e7ae50'>Hilary</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-22 1:53 pm</div>
				                <div><p>The second word of this page is mis-spelled. I imagine you meant to write "With so many" instead of what is written "With some many"</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26878);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-22 10:26 pm</div>
				                <div>Hello Hilary,<br />
<br />
Thank you for pointing that out. This article is old and was most likely just overlooked as we are human too. I appreciate your input and I have fixed the typo.<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26895);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
