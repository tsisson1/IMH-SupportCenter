<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:51599:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/ssl/can-i-buy-a-dedicated-ssl-certificate-for-an-addon-domain" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="You may purchase an SSL for an addon domain just as you would any other SSL certificate, however, keep in mind that you may only have one SSL certificat..." />
  <title>Can I buy a dedicated SSL certificate for an add-on domain? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/ssl/can-i-buy-a-dedicated-ssl-certificate-for-an-addon-domain" rel="canonical" />
...
<script>
  ...
  ga('send', 'pageview');
	...
	<!-- cid:00adac17bd77830d8e4139cecc0ba646 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Can I buy a dedicated SSL certificate for an add-on domain?</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='http://graph.facebook.com/tedcychow/picture?type=normal' class='user_avatar' /><br />
			<a href='/support/community-support/users/tedchow'>tedchow</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-09-23 4:02 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>1,607</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Can I buy a dedicated SSL certificate for an add-on domain? For example, the add-on domain is abc.com. I want to access https://www.abc.com. </div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_4003' id='upvote_answer_4003' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='4003' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_4003').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_4003' id='downvote_answer_4003' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='4003' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_4003').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>11,186 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2013-09-23 8:41 am EST
                		        </div>
					
		                </div>

				You may purchase an SSL for an addon domain just as you would any other SSL certificate, however, keep in mind that you may only have one SSL certificate valid per cPanel account.  For more information on purchasing SSL certificates, you may view the following article:<br />
<br />
&lt;a href=&quot;http://www.inmotionhosting.com/support/website/ssl/how-do-i-obtain-an-ssl-certificate&quot;&gt;How do I obtain an SSL certificate?&lt;/a&gt;
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_4003').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_4003' id='form_comment_on_answer_4003' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>So to be clear - if I have abc.com as my primary domain, and then I create a new add-on domain xyz.com, I cannot buy a separate SSL for each domain since I'm only using one cpanel for the account?</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='/support/images/avatars/default_avatar.jpg' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/gschaadt'>gschaadt</a><br />
									3 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2015-11-17 12:37 am EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello Gschaadt,<br />
<br />
This is correct you may only have one SSL per cPanel account.<br />
<br />
Best Regards,<br />
TJ Edens</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/ssl/can-i-buy-a-dedicated-ssl-certificate-for-an-addon-domain&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/ssl/can-i-buy-a-dedicated-ssl-certificate-for-an-addon-domain'></div>
<script type='text/javascript'>
  (function() {
