<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:65014:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/stats-logging/how-to-view-cpanel-error-logs" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-04-21T22:35:59-07:00" />
  <meta name="keywords" content="how view cPanel logs server" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="This article will teach you how to view your cPanel logs on your server." />
  <title>How to view cPanel Error logs - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/stats-logging/how-to-view-cpanel-error-logs" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:5aead6220a436fdb7b696e14327bc75f -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '195.234.238.38']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/website/stats-logging' itemprop='url'><span itemprop='title'>Statistics/Logging<span></a>
			<div class='dropdown_3columns' style='width:900px; margin-left:-250px;'>
				<div class='col_1' style='width:290px;'><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/stats-logging/how-to-view-cpanel-error-logs'>How to view cPanel Error logs</a> (33,995 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/stats-logging/view-request-type-url-and-response-codes-apache-access-log'>View request type, URL, and response codes from Apache access log</a> (9,602 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/stats-logging/finding-out-the-latest-visitors-to-your-website-in-cpanel'>Finding out the latest visitors to your website in cPanel</a> (6,550 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/stats-logging/create-stat-parsing-script-to-review-website-visits'>Create stat parsing script to review website visits</a> (3,489 hits)</div></div>
				<div class='col_1' style='width:290px;'><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/stats-logging/accessing-the-raw-access-logs-in-cpanel'>Accessing the Raw Access Logs in cPanel</a> (12,584 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/stats-logging/enable-raw-access-logs-in-cpanel'>Enabling raw access log archiving in cPanel</a> (9,344 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/stats-logging/update-awstats'>Manually updating your Awstats through cPanel</a> (6,223 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/stats-logging/unable-to-update-the-log'>AWStats: Unable to update the log error</a> (3,076 hits)</div></div>
				<div class='col_1' style='width:290px;'><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/stats-logging/delete-awstats-data'>How to delete AWStats data</a> (10,877 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/stats-logging/view-stats-reports-with-webalizer'>Viewing statistics reports with Webalizer</a> (9,133 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/stats-logging/view-stats-reports-with-logaholic'>Viewing statistics reports with Logaholic</a> (5,763 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/stats-logging/awstats-review-website-stats'>AWStats - Reviewing website statistics</a> (1,597 hits)</div></div>
			</div>
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to view cPanel Error logs</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to view cPanel Error logs									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>33,995</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: May 22, 2013'><span style='color:#606060;'>Published:</span> Apr 21, 2016</div>
  ...
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('apache_errors');">Apache error logs</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('php_errors');">PHP error logs</button>
</div>
<p>cPanel comes with an error log section that allows you to view errors generated by your website. In this article, we will review how to view your error logs for both Apache and PHP from within cPanel. For more information, we have a full guide that also lists the locations of <a href="/support/website/getting-started-guides/cpanel-logs-for-access-apache-email-error-ftp-mysql-whm">cPanel logs for <strong>access</strong>, <strong>Apache</strong>, <strong>email</strong>, <strong>error</strong>, <strong>ftp</strong>, <strong>mysql</strong>, and <strong>WHM</strong></a>.</p>

<h2>What is the Error Log?</h2>

<p>cPanel states, "<em>This function will display the last 300 errors for your site. This can be very useful for finding broken links or problems with missing files. Checking this log frequently can help keep your site running smoothly.</em>" What this means is when your site is visited by someone, the server receives a request from that visitors browser and location to your server. When the visitor hits a section of your website and they cause an error, the error log will log the date, time, IP , page the error occurred and so forth. These errors could be caused for a number of reasons. Below are a few reasons why errors would be thrown.</p>

<ul>
<li>Page Alias Changed (<a href="/support/edu/joomla-3/seo-settings/using-sef-urls" target="_blank">SEF URL's</a> or <a href="/support/edu/wordpress/wordpress-features/setting-up-permalinks-on-your-wordpress-site" target="_blank">Permalinks</a> changed)</li>
<li>File was deleted or renamed</li>
<li><a href="http://www.inmotionhosting.com/support/website/how-to/what-is-a-spambot" target="_blank">SpamBots</a> trying to manipulate a url</li>
<li>Missing <a href="/support/website/cpanel/how-do-i-create-a-custom-error-page-in-my-control-panel-cpanel" target="_blank">error pages</a> or robots.txt</li>
<li>Menu links changed with out <a href="/support/edu/cpanel/cpanel-manage-domains/setting-up-redirect-cpanel" target="_blank">redirecting</a></li>
<li>Old URLS <a href="/support/website/google-tools/how-do-i-get-google-to-reconsider-crawling-my-site" target="_blank">cached in search engines</a></li>
</ul>

<p>There are many reasons your site could have errors. Its a good idea to check you error log frequently to fix web crawler problems that effect your search engine ranking and website functionality.</p>
<a name='apache_errors'></a>
<h2>cPanel Error log</h2>
<p>You can find your cPanel Error log by following the steps below.</p>
...
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/cpanel/error-log/cpanel-error-log-1-click.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="cPanel Error log" src="//cdn.inmotionhosting.com/support/images/stories/cpanel/error-log/cpanel-error-log-1-click.png" title="Click here to view the larger image" width="100" /></a>Go to <strong>Logs</strong> > <strong>Error log</strong>.
<br style="clear: both;" />

<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/cpanel/error-log/cpanel-error-log-2-view.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="cPanel Error log view" src="//cdn.inmotionhosting.com/support/images/stories/cpanel/error-log/cpanel-error-log-2-view.png" title="Click here to view the larger image" width="100" /></a>Your error log will display in the box. 
See the image to the right.
</p>
<p>Cpanel will display the last 300 errors through the Error log interface.<br style="clear: both;" /></p></li>

</ol>



<h2>How do I read error log?</h2>

<p>Below is an excerpt of a typical error in the cPanel Error log. There are many different error types you may receive. The below is an error on a missing file with a brief description.</p>

<pre style="padding:10px;">
<strong>Date and Time logged</strong>          <strong>Type</strong>      <strong>Visitor IP Address</strong>
[Fri May 17 21:07:47 2013]   [error]   [client 122.96.59.103] 

<strong>Location of the Error</strong>
File does not exist: /home/userna5/public_html/400.shtml, 

<strong>Domain Referrer</strong>
referer: http://example.com/?m=200911
</pre>
<a name='php_errors'></a>
<h2>PHP Error Logging</h2>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/cpanel/error-log/cpanel-error-log-3.png"><img src="//cdn.inmotionhosting.com/support/images/stories/cpanel/error-log/cpanel-error-log-3.png"  style='float:right; margin:0px 0px 15px 15px;'></a><p>By default, InMotion disabled PHP error logging on all servers. In order to troubleshoot your PHP code, PHP errors can be enabled to display and log errors using your local php.ini file or ini_set() in a specific PHP file. Then, any errors will be logged within a file labeled error_log in the same directory that the script produced the error. For more information, see our full guide on <a href="/support/website/php-troubleshooting/troubleshoot-php-errors">How to Display and log errors for PHP</a>.</p>
<div style='clear:both;'></div>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/cpanel/error-log/cpanel-error-log-4.png"><img src="//cdn.inmotionhosting.com/support/images/stories/cpanel/error-log/cpanel-error-log-4.png"  style='float:right; margin:0px 0px 15px 15px;'></a><p>Within the file, you will see each error that was logged on a separate line.  First, it will list the date and time that the error was produced, then the actual error.  Reviewing this periodically will help you provide the best experience possible for your visitors to ensure that they are not seeing repeat errors on your website.</p>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/stats-logging/how-to-view-cpanel-error-logs&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/stats-logging/how-to-view-cpanel-error-logs'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MzMmaWQ9MjczMiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="877545a7051599b361b254a7d337d890" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/website-design/401-unauthorized-error-with-inline-svg?tsrc=rsbraq'>401 - Unauthorized error with inline svg</a>
                                </div>
