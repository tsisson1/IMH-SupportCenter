<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:56993:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/joomla-25/404-error-on-all-links-exept-homepage-on-a-migrated-website" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Angello, Sorry to hear that you're getting 404 errors. If you are getting 404 errors and you know that all of your files are on the server, then t..." />
  <title>I'm getting 404 errors on all links exept the homepage for my migrated Joomla 2.5 website. | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/joomla-25/404-error-on-all-links-exept-homepage-on-a-migrated-website" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:37e20d9fef824fb92d5e49dec94a24e3 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-20']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '76.19.135.185']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>I'm getting 404 errors on all links exept the homepage for my migrated Joomla 2.5 website.</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='https://lh4.googleusercontent.com/-0ANsumF4XSo/AAAAAAAAAAI/AAAAAAAAFBU/kHTGb4tSEJ4/photo.jpg?sz=90' class='user_avatar' /><br />
			<a href='/support/community-support/users/Angello'>Angello</a>
			<div>19 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-07-24 7:53 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>11,722</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Hi, i just got this hosting and wanted to migrate my website from the other hosting company to this one, but i´m having a lot of trouble, somebody helped me and it looked Ok on the homepage, but if you click an ANY link except for the Facebook and Twitter links, you get a 404 error, i really don´t have an idea of what might been causing this error, any help on this will be very appreciated.<br />
Thank you.<br />
P.S.<br />
This is a Joomla 25 site</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_3606' id='upvote_answer_3606' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='3606' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_3606').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_3606' id='downvote_answer_3606' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='3606' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_3606').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Angello,<br />
<br />
Sorry to hear that you're getting 404 errors.  If you are getting 404 errors and you know that all of your files are on the server, then the problem is most likely an issue with the path that is being used to access the files that make up the pages of your Joomla 2.5 website.  The first thing you need to do is disable/remove the option to use <a href="http://docs.joomla.org/Search_Engine_Friendly_URLs" rel="nofollow" target="new">Search Engine Friendly links</a>.   These links will often be referenced in the database and will usually store the OLD paths to your website.  You will need to disable or remove them, save them (as being disabled), then re-enable them so that Joomla re-builds the links based on its new location.  We do not have an article for SEF links in Joomla 2.5, but you may want to review the 3.0 version <a href="http://www.inmotionhosting.com/support/edu/joomla-3/seo-settings/using-sef-urls" target="new">here</a>, or, you can also reference this <a href="http://docs.joomla.org/Enabling_Search_Engine_Friendly_(SEF)_URLs_on_Apache" rel="nofollow" target="new">article on enabling SEF URLs</a> through Joomla's documentation.  <br />
<br />
If you are still having problem with the paths, please review the migration steps for <a href="http://forum.joomla.org/viewtopic.php?t=187461" rel="nofollow" target="new">for moving a Joomla installation to another server</a> in order to verify that all of your site files migrated to the new hosting location successfully.<br />
<br />
If you're still having problems and you need further assistance, please let us know.<br />
<br />
Regards,<br />
Arnel C.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_3606').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_3606' id='form_comment_on_answer_3606' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Thank you very much Arn, i disabled the SEF and now it works, no i have to find the table in the DB to empty it and enable the SEF links again in joomla, because i disable them and re-enable them again and the problem persists.<br />
<br />
thank you very much for your support. very helpful !!</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='https://lh4.googleusercontent.com/-0ANsumF4XSo/AAAAAAAAAAI/AAAAAAAAFBU/kHTGb4tSEJ4/photo.jpg?sz=90' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/Angello'>Angello</a><br />
				...
				<div style='padding:15px 15px 15px 76px; border:1px solid #ddd; border-top:0px; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hi Arn, your answer was really helpful, but I have a doubt: I have already ranked with a couple of keywords in my domain, so if I change the friendly URL for another and if you click on Google SERP´s  in my domain you will get a 404 or a NOT found error, so instead of erasing my old friendly URL´s how can I keep them after the hosting change?<br />
 Thanks for your support.</div>
				...
				<div style='padding:15px 15px 15px 76px; border:1px solid #ddd; border-top:0px; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hi Angello,<br />
<br />
Sorry for the problems with Google's SERP links.  The main issue here is that your SEF links are based on an OLD URL that no longer exists.  The reason that it's important to use the newer links is because it links to where the server now exists.  So, unfortunately, you can't use the old links.  You will need to go to <a href="https://accounts.google.com/ServiceLogin?service=sitemaps&passive=1209600&continue=https://www.google.com/webmasters/tools/&followup=https://www.google.com/webmasters/tools/&authuser=0" rel="nofollow" target="new">Google's Webmaster tools</a> and ask for an update for your website links since you re-located.  That way, they can update their links to your new location.  <br />
<br />
Sorry again for the problems dealing with the change in URL.  I hope this helps to clarify the issue.<br />
<br />
Regards,<br />
Arnel C.</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/joomla-25/404-error-on-all-links-exept-homepage-on-a-migrated-website&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/joomla-25/404-error-on-all-links-exept-homepage-on-a-migrated-website'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="470b07f4650cceeecfccd5aabf0a2392" value="1" />	</div>
	</form>
<!-- <br />
