<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:59987:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/slow-websites/inefficient-coding-of-your-website" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-03-19T23:25:00-07:00" />
  <meta name="keywords" content="inefficient code coding" />
  <meta name="author" content="Jacob Nicholson" />
  <meta name="description" content="In this article I'll discuss why inefficient coding of your website could lead to problems with the level of your account's resource usage." />
  <title>Inefficient coding of your website - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/slow-websites/inefficient-coding-of-your-website" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:e064375df38950169ffb57e5fba99f2a -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Inefficient coding of your website									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>4,383</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Mar 4, 2013'><span style='color:#606060;'>Published:</span> Mar 19, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In this article I'll discuss why inefficient coding of your website could lead to problems with the level of your account's resource usage.</p>
<h2>What is inefficient code?</h2>
<p>One of the best ways to think of computer code is as a set of instructions, or even a recipe, to get to the expected end result again and again. That's why computers are great at repetive tasks, because they can be given instructions to do a certain task, and then they will follow those steps exactly over and over again.</p>
<p>The set of instructions the computer is going to follow is provided by a human, and typically for web hosting, it will be in a scripting language such as PHP. There are many ways to end up at the same result when coding, and just because you end up with the correct result, doesn't mean it was the most efficient way of getting there.</p>
<p>For instance with most dynamic CMS (Content Managment Systems) like WordPress, they are going to have a database back-end where information is stored. Then each time a visitor comes to the site, the PHP scripts interact with the database to retreive that information. In this case WordPress builds up a HTML page to hand off to a web-browser each time one is requested.</p>
<p>Now if don't get very much traffic at all, or you're on a VPS (Virtual Private Server) or dedicated server, the default way that WordPress or another CMS like it operates might be efficient enough. However if you're on shared hosting, and you get a decent amount of traffic, continually regenerating the same HTML page again and again for each visitor's request can be very inefficient.</p>
<h2>Resolving ineffcient code</h2>
<p>If you're using a popular CMS like WordPress you can typically use a caching plugin to reduce the resource usage required from having to regenerate the same content over and over again. For more advanced WordPress users your could read about <a href="/support/edu/wordpress/recommended-wordpress-plugins/optimizing-wordpress-with-w3-total-cache" target="_blank">optimizing WordPress with W3 Total Cache plugin</a> or for basic WordPress users about <a href="/support/edu/wordpress/recommended-wordpress-plugins/optimizing-wordpress-with-wp-super-cache" target="_blank">optimizing WordPress with WP Super Cache plugin</a>.</p>
<p>You typically would also want to look at reducing the amount of active extensions, modules, or plugins that you have active. Certain plugins can be known to be more resource intensive than others due to the way they are coded.</p>
<p>If your website is custom coded and isn't using a CMS or orther type of back-end, you'd want to make sure that your scripts can run in a timely manner, typically under 1 second execution time each. The more you attempt to do in each script, the more potential it has for causing a large amount of resource usage. So if you have a script that does a whole lot, you typically wouldn't want that to be one of your scripts that is accessed very frequently such as your front page.</p>
<p>A script with inefficient code in it could eventually lead to an <a href="/support/website/website-troubleshooting/account-suspensions" target="_blank">account suspension</a> in extreme cases, especially if there are bots or a large volume of people accessing it. So ensuring that your scripts are coded as efficiently as possible can help safeguard you from this.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/slow-websites/inefficient-coding-of-your-website&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/slow-websites/inefficient-coding-of-your-website'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NTcmaWQ9NjAyJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="ffbd9f5ee04ae57eb89a13e5b95eb490" value="1" />	</div>
	</form>
<!-- <br />
