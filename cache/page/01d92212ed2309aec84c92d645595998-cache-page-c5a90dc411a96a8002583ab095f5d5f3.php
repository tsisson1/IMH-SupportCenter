<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:78649:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-25/slideshow/slideshow-on-homepage" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-04-15T17:03:52-07:00" />
  <meta name="keywords" content="joomla 2.5 slideshow homepage" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="Now that we've created a Unite Nivo Slider with slides, our next step is to show this slideshow on our Joomla 2.5 homepage." />
  <title>Inserting a slideshow on your Joomla 2.5 Homepage - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-25/slideshow/slideshow-on-homepage" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:7ea142a996c622a663ac000dc2eb52b6 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '173.188.75.182']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Inserting a slideshow on your Joomla 2.5 Homepage									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>30,001</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jul 10, 2012'><span style='color:#606060;'>Published:</span> Apr 15, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<p class="alert">Joomla 2.5 has reached its end of life as for 12/31/2014. Please be advised this may be a security risk to your website. You can view more information about the end of life <a href="https://docs.joomla.org/Joomla!_CMS_versions">here</a>.</p><br /><p>In our last few articles, we have been <a href="/support/edu/joomla-25/slideshow">creating a slideshow within Joomla 2.5</a> using the <strong>Unite Nivo Slider</strong> extension. Our ultimate goal is to display this slideshow on our Joomla 2.5 frontpage, and in this article we'll show you how to insert the slider in your <a href="http://www.inmotionhosting.com/support/edu/joomla-25/slideshow/slideshow-on-homepage">Joomla Hosting</a>.</p>
<p>Before continuing, you need to make sure you have a good understanding of the following topics, as they will all be used in this tutorial:</p>
<ol>
<li><a href="/support/edu/joomla-25/extensions/module-in-article">How to put a module in an article</a></li>
<li><a href="/support/edu/joomla-25/featured-articles">What is displayed on your Joomla 2.5 homepage</a></li>
</ol>
<h2>To show a Unite Nivo Slider on your homepage:</h2>
<ol class="article_list">
<li>
<h3>Create a module for your Unite Nivo Slider</h3>
<p>- Log into your Joomla 2.5 Admin<br />- In the top menu, hover over <strong>Extensions</strong> and then click <strong>Module Manager</strong><br />- In the top right menu, click <strong>New</strong><br />- In the list of module types, click on <strong>Unite Nivo Slider</strong><br /><br />Enter the following details for your new module and then click Save in the top right menu:</p>
<table class="article_table">
<tbody>
<tr>
<th>Title</th>
<td>Enter a title for this slider. In our example, we entered <em>homepage slideshow</em>.</td>
</tr>
<tr>
<th>Show Title</th>
<td>If you don't want the title for the module to show, select <strong>Hide</strong>.</td>
</tr>
<tr>
<th>Position</th>
<td>Instead of clicking the <strong>Select position</strong> button, enter a position name. We entered <em>my_homepage_slideshow</em></td>
</tr>
<tr>
<th>Status</th>
<td>Set status to <strong>Published</strong> so that it is an active module.</td>
</tr>
<tr>
<th>Slider</th>
<td>Select the slider that you want to show. In our testing, we selected <em>Test Slider 1</em></td>
</tr>
</tbody>
</table>
<p>There are numerous other settings you can select, such as the width and height of the slideshow and various effects. For now, we are only covering the basics, but feel free to experiment with all of the other settings.</p>
</li>
<li>
<h3>Load the new module within a featured article</h3>
<p>Our homepage currently contains one featured article (see the 2nd link at the top of the page). What we will need to do is edit that article and insert the necessary code to load the module we just created (see the 1st link at the top of the page). Because we placed our module in a position named my_homepage_slideshow, we referenced that position when using <strong>loadposition</strong> in our featured article:<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/unite-nivo-slider/use-load-position-for-slideshow.gif"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/unite-nivo-slider/use-load-position-for-slideshow.gif" alt="use-load-position-for-slideshow"  /></a></p>
</li>
<li>
<h3>Test your homepage!</h3>
<p>In our testing, you can see below a screenshot of how our slideshow is appearing on our homepage:<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/unite-nivo-slider/slideshow-is-now-showing-on-homepage.gif"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/unite-nivo-slider/slideshow-is-now-showing-on-homepage.gif" alt="slideshow-is-now-showing-on-homepage"  /></a></p>
</li>
<li>
<h3>Please take note</h3>
<p class="alert">If the slide does not show for you, in the modules advanced settings enabled the option to <strong>Add JS to body</strong>. This will load the necessary javascript after jquery is loaded, and the problem should be resolved. If there are any additional problems, enable the jQuery.noConflict() option (in version 1.0.5+)<br /><br />The size of the slider is set by the sizes of the images within the slideshow. If you need the slideshow to show in different dimenions, you will need to resize your images. In the <a href="http://www.unitecms.net/free-joomla-extensions/unite-nivo-slider-pro/nivo-slider-pro-demo" target="_blank">pro version</a>, auto resizing and cropping features are available.</p>
</li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/joomla-25/slideshow'>218: Joomla 2.5 Slideshow</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 4: Inserting a slideshow on your Joomla 2.5 Homepage</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 3: <a href='/support/edu/joomla-25/slideshow/adding-slides'>How to add new slides to a Unite Nivo Slider in Joomla 2.5</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-25/slideshow/slideshow-on-homepage&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-25/slideshow/slideshow-on-homepage'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yMjMmaWQ9MTU2MiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="c1d3a0399a8055ce6091e92131a37666" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/joomla-25/slideshow?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Joomla 2.5 Slideshow</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/joomla-25/slideshow/install-unite-nivo-slider?tsrc=rsbedu'>How to install Unite Nivo Slider for Joomla 2.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/joomla-25/slideshow/create-new-slider?tsrc=rsbedu'>How to create a new Slider in Unite Nivo Slider for Joomla 2.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/joomla-25/slideshow/adding-slides?tsrc=rsbedu'>How to add new slides to a Unite Nivo Slider in Joomla 2.5</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/joomla-25/slideshow/slideshow-on-homepage?tsrc=rsbedu'>Inserting a slideshow on your Joomla 2.5 Homepage</a></td>
                </tr>
          	</table>
			...
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/joomla-3/help-with-joomla-website?tsrc=rsbraq'>Help with joomla website</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/10b30ef8fb75bcbabe3a88b6e77f0752?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/10b30ef8fb75bcbabe3a88b6e77f0752'>chris</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-02-28 11:22 am</div>
				                <div><p>not working with JA_purity_ii, can see just one slide, how to correct ?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8692);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-02-28 11:57 am</div>
				                <div>Hello chris,<br />
<br />
Thank you for your question. The moderator of the JA_purity_ii website recommends just using a plugin. See his post <a href="http://www.joomlart.com/forums/showthread.php?49079-Is-there-a-Slide-show-for-JA-Purity-2">here</a>, and view available plugins <a href="http://extensions.joomla.org/extensions/photos-a-images/slideshow">here</a>.<br />
<br />
If you are getting any javascript errors, we have a guide on diagnosing them <a href="http://www.inmotionhosting.com/support/website/javascript/diagnose-javascript-errors">here</a>.<br />
<br />
Also, I see you are using <strong>ja purity II</strong>, when the stable version of <strong>ja purity III</strong> was released last month.  You can access it <a href="http://www.joomlart.com/joomla/templates/purity-iii">here</a>. Have you tried testing with the updated version?<br />
<br />
If you have any further questions, feel free to post them below.<br />
Thank you,<br />
<br />
-John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8693);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-8845'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/057b9d01e291195be09804cd4c98da9c?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/057b9d01e291195be09804cd4c98da9c'>manos</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-08 5:19 am</div>
				                <div><p>Hello,</p>
<p>I have tried to use&nbsp;Unite Nivo Slider to show a slideshow in a specific position&nbsp;on my homepage, folllowing your instructions here.</p>
<p>Unfortunately, it doesn't show the slideshow there,&nbsp;only&nbsp;the&nbsp;</p>
<p><span style="font-family: 'book antiqua', palatino; font-size: 19px; line-height: 25px; text-align: center;">{</span><strong style="margin: 0px; padding: 0px; font-size: 13px; text-align: center; background-color: rgb(248, 248, 248); border: 0px; font-family: verdana; outline: 0px; vertical-align: baseline; color: rgb(35, 35, 35); line-height: 22px;">loadposition life_slides</strong><span style="font-family: 'book antiqua', palatino; font-size: 19px; line-height: 25px; text-align: center;">}</span></p>
<p><span style="font-family: 'book antiqua', palatino; font-size: 19px; line-height: 25px; text-align: center;">I can see there.</span></p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8845);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-10 10:20 am</div>
				                <div>Be sure that you have set the Postition within the slider settings to reflect the code that you are trying to use.  For emails, the code that you have provided will need to have a position defined of life_slides.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8881);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-11048'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/1f27bdab6c534c6154dc7718dc62c203?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/1f27bdab6c534c6154dc7718dc62c203'>Elia</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-02 11:56 am</div>
				                <div><p>Hi, i install Unite Nivo Slider pro, all the slide are with state Published, a put Include nivo_slider.js in on Body, but i can see just the first slide, the rest nothing? How can i resolve? Thank You</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11048);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-02 12:26 pm</div>
				                <div>Hello Elia,<br />
<br />
Are you getting any specific javascript errors on your page? You may want to check out our article on <a href="http://www.inmotionhosting.com/support/website/javascript/diagnose-javascript-errors">how to diagnose javascript errors</a>. Feel free to reply with any that you find so we can help.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11050);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-20310'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/e369649240e54bcf0872addb8d9929ce?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/e369649240e54bcf0872addb8d9929ce'>roman</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-03 1:46 am</div>
				                <div><p><em>hello,</em></p>
<p><em>I am a <strong>joomla</strong> beginer. I want to conver my website <strong>psd</strong> to <strong>joomla</strong>. how can I do it in joomla. please tell me some step or give me some link where i can know about this.</em></p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20310);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-03 9:56 am</div>
				                <div>There is not a simple way to convert it, and you would need to build an entire Joomla template.  To get started, you may see our series on &lt;a href=&quot;http://www.inmotionhosting.com/support/edu/joomla-3/create-template&quot;&gt;building Joomla templates&lt;/a&gt;.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20318);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
