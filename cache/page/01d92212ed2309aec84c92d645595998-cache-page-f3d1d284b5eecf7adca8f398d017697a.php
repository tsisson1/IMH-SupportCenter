<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:51183:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/how-to/transfer-domains-without-downtime" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Jim, We have a guide on how to perform your own website transfer that goes over the process involved for moving over sites to our servers. Is the ..." />
  <title>transfer domains without downtime | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/how-to/transfer-domains-without-downtime" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:ed8d4940b7632c2a29fa47e54df2d96b -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-22']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '208.115.113.88']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>transfer domains without downtime</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2014-07-30 3:01 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>149</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I am not happy with my current hosting company and I want to move. I currently have around 10 domains that I would like to move. Some of them are business's and others are personal. We have a small company and we are growing rapidly and I need a hosting company that wants to help.<br />
<br />
I have no idea how to transfer my critically important domains to your hosting company and I'd like to know if  someone can help us with that.<br />
<br />
Thank you<br />
Jim Tovet<br />
Tovet Consulting Group</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_5342' id='upvote_answer_5342' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='5342' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_5342').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_5342' id='downvote_answer_5342' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='5342' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_5342').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Jim,<br />
<br />
We have a guide on &lt;a href=&quot;http://www.inmotionhosting.com/support/website/getting-started-guides/perform-your-own-website-transfer&quot; target=&quot;_blank&quot;&gt;how to perform your own website transfer&lt;/a&gt; that goes over the process involved for moving over sites to our servers.<br />
<br />
Is the previous web host you're coming from using cPanel? If so if you just have one cPanel account with you 10 domain setup underneath it, you can simply do a full cPanel backup and then restore that onto our server.<br />
<br />
The other thing to keep in mind when migrating your websites is the process of &lt;a href=&quot;http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/updating-your-domains-nameservers&quot; target=&quot;_blank&quot;&gt;updating your domain's name servers&lt;/a&gt; to point to your new host.<br />
<br />
It can take up to 24 hours for new DNS settings for a domain to fully propagate. So typically what you want to do is backup your websites, restore them to a new host, update the DNS to point to the new server, then wait for the DNS propagation to finish.<br />
<br />
During that 24 hour window, your websites would remain &quot;live&quot; on both the old web host as well as the new. If someone had never been to your website before, they wouldn't have a cached DNS lookup, and would instantly pull your site up from the new server. If they had been to your website before, then they could continue to see the site from the old server for up to 24 hours while those DNS settings propagate across the internet.<br />
<br />
We also have a &lt;a href=&quot;http://www.inmotionhosting.com/launch-assist&quot; target=&quot;_blank&quot;&gt;Launch Assist&lt;/a&gt; program where someone from our managed hosting team can migrate your websites to our servers for you.<br />
<br />
...
- Jacob
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_5342').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_5342' id='form_comment_on_answer_5342' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/how-to/transfer-domains-without-downtime&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/how-to/transfer-domains-without-downtime'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="f3ce3129b208c42a6013b9197388c77d" value="1" />	</div>
	</form>
<!-- <br />
