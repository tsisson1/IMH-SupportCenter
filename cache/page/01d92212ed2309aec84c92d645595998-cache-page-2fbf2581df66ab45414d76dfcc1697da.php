<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50024:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/premium-website-builder/font-size-differs-between-browsers-plesk" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Cliveje, I couldn't find an account related to your Support Center login in order to check and see what was happening. However, there is already a..." />
  <title>Font size differs between browsers (plesk) | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/premium-website-builder/font-size-differs-between-browsers-plesk" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:cb9d538c6d1ce5d5d8817a3e8ecfc4eb -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Font size differs between browsers (plesk)</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/cliveje'>cliveje</a>
			<div>17 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-09-10 4:17 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>517</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I'm using the plesk site builder to build and publish my website. However. the font sizes are different between browsers.<br />
<br />
Is there a way to make them the same. In html an CSS tag could define an absolute font size.<br />
<br />
Thanks,<br />
    Clive<br />
    </div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_1539' id='upvote_answer_1539' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='1539' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_1539').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_1539' id='downvote_answer_1539' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='1539' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_1539').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Cliveje,<br />
<br />
I couldn't find an account related to your Support Center login in order to check and see what was happening.  However, there is already a CSS tag generally in place for the Builder templates, so unless the browser is zoomed in on one and not the other, you will need to provide more information as to where this happening.  I need the URL of the website you're view in order to check it - and also the browsers where you're seeing the difference.  <br />
<br />
...
Arnel C.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_1539').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_1539' id='form_comment_on_answer_1539' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/premium-website-builder/font-size-differs-between-browsers-plesk&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/premium-website-builder/font-size-differs-between-browsers-plesk'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="aa81cd1deda4bbec314f077656f98904" value="1" />	</div>
	</form>
<!-- <br />
