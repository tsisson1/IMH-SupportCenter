<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:60447:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/magento/202-magento-cache-management/how-to-clear-the-magento-cache" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-09-03T19:15:22-07:00" />
  <meta name="keywords" content="clear magento manual flush cache storage" />
  <meta name="author" content="Tim Sisson" />
  <meta name="description" content="In this tutorial, we'll explain how to clear your cache files in Magento through the Admin Panel and manually. " />
  <title>How to Clear the Magento 1.6 Cache - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/magento/202-magento-cache-management/how-to-clear-the-magento-cache" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:f04e3b037f2857f32488db831f1b98d3 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '66.152.148.12']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to Clear the Magento 1.6 Cache									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>31,943</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Mar 22, 2012'><span style='color:#606060;'>Published:</span> Sep 3, 2014</div>
...
<h2>Clearing Cache in the Admin Panel</h2>
...
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/magento/magento_cache_management_1.jpg"><img src="//cdn.inmotionhosting.com/support/images/stories/magento/magento_cache_management_1.jpg" alt="magento_cache_management_1"  /></a></p>
<li>Click on the “<strong>Flush Cache Storage</strong>” button</li>
</ol>


<p>Let’s take a quick look at the difference between the “<strong>Flush Magento Cache</strong>” and “<strong>Flush Cache Storage</strong>” functions. “<strong>Flush Cache Storage</strong>” removes all the cache files regardless of any perimeters. “<strong>Flush Magento Cache</strong>” tries to do a check for invalidated pages and will remove them accordingly. If you’re unsure of which to use, using the “<strong>Flush Cache Storage</strong>” will ensure that <strong>ALL CACHE FILES</strong> are removed.</p>

<a name="manually"></a>
<h2>Manually Clearing the Magento Cache</h2>
<p>You can clear the Magento 1.6 cache manually as well. If you’re working in FTP or cPanel File Manager and need to quickly clear your Magento 1.6 Cache files it’s relatively easy. All the cache files for Magento are stored in the <strong>/var/cache</strong> folder.</p>
<ol class="article_list">
<li>With your FTP program or cPanel File Manager, navigate to the root directory of your Magento cart</li>
<li>Open the var/cache folder</li>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/magento/magento_manual_cache_1.jpg"><img src="//cdn.inmotionhosting.com/support/images/stories/magento/magento_manual_cache_1.jpg" alt="magento_manual_cache_1"  /></a></p>
<li>Select all the contents in the folder and delete them</li>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/magento/magento_manual_cache_2.jpg"><img src="//cdn.inmotionhosting.com/support/images/stories/magento/magento_manual_cache_2.jpg" alt="magento_manual_cache_2"  /></a></p>
</ol>
<p>Now, when you refresh your website, you should be able to see all the changes you have made.</p>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/magento/202-magento-cache-management/how-to-clear-the-magento-cache&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/magento/202-magento-cache-management/how-to-clear-the-magento-cache'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xNzImaWQ9MTIyNiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/magento/202-magento-cache-management?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Magento 1.6 Cache Management</h3></a>
		<table>  <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/magento/202-magento-cache-management/how-to-clear-the-magento-cache?tsrc=rsbedu'>How to Clear the Magento 1.6 Cache</a></td>
                </tr>
          	</table>
			...
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/magento/flush-magento-cache-storage?tsrc=rsbraq'>Flush Magento cache storage</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/magento/i-am-getting-an-error-every-time-i-try-to-delate-products?tsrc=rsbraq'>I am getting an error every time I try to delate products</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/51ef108f1747c94fea15b098f070091e?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/51ef108f1747c94fea15b098f070091e'>What about Sessions in the Database?</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-09 11:16 am</div>
				                <div><p>My sessions are set &lt;session_save&gt;&lt;![CDATA[db]]&gt;&lt;/session_save&gt;, so I have no files to flush. What about flushing core_sessions table?</p>
<p>Thanks James Niland</p>
<p>**********.com</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22506);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-09 4:36 pm</div>
				                <div>Hello James,<br />
<br />
Thank you for your question. The core_sessions table typically stores information such as the customer's cart contents, and not the cache of your site.<br />
<br />
I found a<a href="http://stackoverflow.com/questions/8701456/clear-magento-cache"> post online</a> where they offer alternate suggestion, but you will have to test it to verify whether it works for you. (I recommend backing up your site first).<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22512);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
