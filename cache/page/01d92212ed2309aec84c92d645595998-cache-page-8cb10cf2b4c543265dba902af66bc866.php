<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:60510:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/general-server-setup/how-to-run-exim-on-an-additional-port" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-05-02T16:48:34-07:00" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="Learn how to use WHM and APF to run exim off of an additional port, such as port 26." />
  <title>How to run Exim on an additional port - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/general-server-setup/how-to-run-exim-on-an-additional-port" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:2bbf1dbc310a33ff310415b9baa4da66 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '78.246.41.102']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to run Exim on an additional port</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to run Exim on an additional port									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>2,334</span></div>
							...
							<div style='clear:both;'></div>
								...
								<p>By default, exim runs on port 25. Because a lot of internet services providers block port 25, this can cause many users <a href="/support/email/email-troubleshooting/problems-sending-mail-receiving-is-fine">problems when sending email</a>. If you are on a <a href='http://www.inmotionhosting.com/vps-hosting'>VPS server</a> or have <a href='http://www.inmotionhosting.com/dedicated-servers'>Dedicated hosting</a>, and you have <a href="/support/website/general-server-setup/root-access-faq">root access</a>, you can setup exim to run on an additional port.</p>

<p>In this tutorial, we are going to run exim off of port 26 (in addition to port 25). This will allow users to connect and send email over port 26.</p>

<ol class='article_list'>

  <li><a href="/support/edu/whm/creating-and-managing-accounts/log-into-whm">Log into your WHM</a></li>

  <li>In the left menu, under <em>Service Configuration</em>, click on <strong>Service Manager</strong>.</li>

  <li>Find the setting labeled <strong>exim on another port</strong>. Check the box under <strong>Enabled</strong>, enter <strong>26</strong> next to <em>Allow exim to listen on port</em>, and then click on <strong>save</strong> at the bottom of the page.</li>

  <li><a href="/support/website/general-server-setup/how-to-open-a-port-in-your-firewall">Edit your APF configuration file</a>, and ensure port 26 is open.</li>

  <li>
    <p>Test! At this point, you can <a href="/support/email/email-troubleshooting/communicating-email-server-telnet">use telnet to test</a> if exim is listening on port 26!</p>

    <pre class='cli'>C:\Users\Brad><span style='color:red;'>telnet example.com 26</span>
Connecting To example.com...

<span style='color:orange;'>220-vps###.inmotionhosting.com ESMTP Exim 4.80 #2 Fri, 17 May 2013 06:33:38 -0700
220-We do not authorize the use of this system to transport unsolicited,
220 and/or bulk e-mail.</span></pre>
  </li>
</ol>
<p>As you can see above, <span style='color:orange;'>exim responded</span>, which shows exim is now running off of port 26.</p>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/general-server-setup/how-to-run-exim-on-an-additional-port&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/general-server-setup/how-to-run-exim-on-an-additional-port'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NCZpZD0yNzIzJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
