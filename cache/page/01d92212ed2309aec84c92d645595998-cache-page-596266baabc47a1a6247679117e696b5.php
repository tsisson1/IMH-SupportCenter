<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50634:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/wordpress/how-to-perform-automated-nightly-backups-of-wordpress-websites" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello alehrfeld1, Thank you for your question. There are many Wordpress plugins available for backing up your website, I recommend trying them to find t..." />
  <title>How to perform automated, nightly back-ups of WordPress websites | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/wordpress/how-to-perform-automated-nightly-backups-of-wordpress-websites" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:a23fc77717625d5402db38ec9c62bf58 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>How to perform automated, nightly back-ups of WordPress websites</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='http://graph.facebook.com/andrew.lehrfeld/picture?type=normal' class='user_avatar' /><br />
			<a href='/support/community-support/users/alehrfeld1'>alehrfeld1</a>
			<div>29 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-09-01 1:32 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>252</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>What's the best way to perform automated, nightly back-ups of my clients' WordPress sites that are hosted on InMotion?  Is there a WP plugin that will handle this?</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_3855' id='upvote_answer_3855' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='3855' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_3855').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_3855' id='downvote_answer_3855' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='3855' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_3855').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
...
<br />
There are many Wordpress plugins available for backing up your website, I recommend trying <a href="http://wordpress.org/plugins/tags/backup" target="_blank" >them to find the one that works</a> for you.<br />
<br />
You can also hand <a href="http://www.inmotionhosting.com/support/edu/cpanel/301-run-cron-job" target="_blank" >code a cron job</a> to perform reoutine tasks, if you are familiar with coding.<br />
<br />
...
-John-Paul
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_3855').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_3855' id='form_comment_on_answer_3855' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/wordpress/how-to-perform-automated-nightly-backups-of-wordpress-websites&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/wordpress/how-to-perform-automated-nightly-backups-of-wordpress-websites'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="1f80fc02ead56fd6b6598b40844c23e8" value="1" />	</div>
	</form>
<!-- <br />
