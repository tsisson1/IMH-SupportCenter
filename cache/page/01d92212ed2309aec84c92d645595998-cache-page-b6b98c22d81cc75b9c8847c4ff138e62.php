<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:52744:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/opencart/php-syntax-error-after-uploading-open-cart" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello munafa1! Sorry for the trouble with the error in your Open Cart. It appears you are on a Windows server at Hosting Spaces greenhub. Make sure you ..." />
  <title>PHP error after uloading files for OpenCart | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/opencart/php-syntax-error-after-uploading-open-cart" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:56001e0eeb2200103a4420a409ed4c80 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '114.39.88.138']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box straight_bottom'>
                <h1 style='font-size:26px;'>PHP error after uloading files for OpenCart</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-06-08 10:42 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>2,623</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>i uploaded my opencart store into ftp and iam getting error Parse error: syntax error, unexpected T_ELSE, expecting T_FUNCTION in C:\HostingSpaces\greenhub\deccan-dental.com\wwwroot\products\system\database\mysqli.php on line 54 ?</div>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px;'>
				<div style='font-size:12px; max-width:500px; overflow:auto;'>mysqli.php<br />
--------------<br />
&lt;?php<br />
final class MySQLi {<br />
	private $mysqli;<br />
	<br />
	public function __construct($hostname, $username, $password, $database) {<br />
		$this-&gt;mysqli = new mysqli($hostname, $username, $password, $database);<br />
		<br />
		if ($this-&gt;mysqli-&gt;connect_error) {<br />
      		trigger_error('Error: Could not make a database link (' . $this-&gt;mysqli-&gt;connect_errno . ') ' . $this-&gt;mysqli-&gt;connect_error);<br />
		}<br />
		<br />
		$this-&gt;mysqli-&gt;query(&quot;SET NAMES 'utf8'&quot;);<br />
		$this-&gt;mysqli-&gt;query(&quot;SET CHARACTER SET utf8&quot;);<br />
		$this-&gt;mysqli-&gt;query(&quot;SET CHARACTER_SET_CONNECTION=utf8&quot;);<br />
		$this-&gt;mysqli-&gt;query(&quot;SET SQL_MODE = ''&quot;);<br />
  	}<br />
		<br />
  	public function query($sql) {<br />
		$result = $this-&gt;mysqli-&gt;query($sql);<br />
<br />
		<br />
<br />
		if ($this-&gt;mysqli-&gt;errno) {<br />
		//$mysqli-&gt;errno<br />
		}<br />
		<br />
...
<br />
				$result-&gt;close();<br />
				<br />
				$query = new stdClass();<br />
				$query-&gt;row = isset($data[0]) ? $data[0] : array();<br />
				$query-&gt;rows = $data;<br />
				$query-&gt;num_rows = $result-&gt;num_rows;<br />
				<br />
				unset($data);<br />
				<br />
				<br />
			...
			trigger_error('Error: ' . mysql_error($this-&gt;link) . '&lt;br /&gt;Error No: ' . mysql_errno($this-&gt;link) . '&lt;br /&gt;' . $sql);<br />
			exit();<br />
    	}<br />
  	}<br />
	<br />
	public function escape($value) {<br />
		return $this-&gt;mysqli-&gt;real_escape_string($value);<br />
	}<br />
	<br />
  	public function countAffected() {<br />
    	return $this-&gt;mysqli-&gt;affected_rows;<br />
  	}<br />
<br />
  	public function getLastId() {<br />
    	return $this-&gt;mysqli-&gt;insert_id;<br />
  	}	<br />
	<br />
	public function __destruct() {<br />
		$this-&gt;mysqli-&gt;close();<br />
	}<br />
}<br />
?&gt;</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_3290' id='upvote_answer_3290' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='3290' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_3290').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_3290' id='downvote_answer_3290' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='3290' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_3290').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello munafa1!<br />
<br />
Sorry for the trouble with the error in your Open Cart. It appears you are on a Windows server at Hosting Spaces greenhub. Make sure you uploaded all the files, make sure no partial files are uploaded,  and you follow the set up below.<br />
<br />
&lt;a href=&quot;http://www.inmotionhosting.com/support/edu/opencart/installing-opencart-and-adding-products/installing-opencart-manually&quot;&gt;Installing OpenCart Manually&lt;/a&gt;<br />
<br />
Best Regards,<br />
James R<br />
<br />
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_3290').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_3290' id='form_comment_on_answer_3290' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/opencart/php-syntax-error-after-uploading-open-cart&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/opencart/php-syntax-error-after-uploading-open-cart'></div>
<script type='text/javascript'>
  (function() {
