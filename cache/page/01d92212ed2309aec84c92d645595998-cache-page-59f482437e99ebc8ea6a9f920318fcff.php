<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:65238:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/wordpress-plugins/the-social-contact-display-plugin-widget-for-wordpress" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-04-26T16:36:50-07:00" />
  <meta name="author" content="Jeff Matson" />
  <meta name="description" content="In this article, we will teach ou how to use the Social Contact Display plugin for Wordpress to show information such as name, address, and social media links within an attractive widget." />
  <title>Install and Setup the Social Contact Display Plugin/Widget for Wordpress - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/wordpress-plugins/the-social-contact-display-plugin-widget-for-wordpress" rel="canonical" />
...
<script>
  ...
  ga('send', 'pageview');
	...
	<!-- cid:795023d5be91ee29a589d75e831c345a -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '93.164.209.45']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Install and Setup the Social Contact Display Plugin/Widget for Word...</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Install and Setup the Social Contact Display Plugin/Widget for Wordpress									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>1,211</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Nov 13, 2013'><span style='color:#606060;'>Published:</span> Apr 26, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In this article, we will introduce you to the Social Contact Display plugin for Wordpress as well as teach you how to install and use it.  The Social Contact Display plugin is an excellent way to show information about yourself of your business attractively through a widget area on your Wordpress site.  With it, you will help individuals contact you as well as follow you on popular social media sites such as Facebook, Twitter, Google Plus, and LinkedIn.</p>
<h2>Installing the Social Contact Display Wordpress plugin</h2>
<p>The Social Contact Display plugin can easily be installed right through the Wordpress dashboard.  A simple search in your Wordpress dashboard will have you up and running with a working copy of the Social Contact Display plugin ready to configure with your social media and other information.</p>
<ol class="article_list">
  <li><p>First, simply <a href="http://www.inmotionhosting.com/support/edu/wordpress/wordpress-introduction/logging-into-wordpress-dashboard">log into your Wordpress dashboard</a>.</p></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/social-contact-display-1.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/social-contact-display-1.png"  style='float:right; margin:0px 0px 15px 15px;'></a><p>Next, you will need to navigate to the Plugins section of your Wordpress dashboard to locate the Social Contact Display plugin.  To do so, click on Plugins over to the left side of your dashboard, then click on Add New.</p><div style='clear:both;'></div></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/social-contact-display-2.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/social-contact-display-2.png"  style='float:right; margin:0px 0px 15px 15px;'></a><p>Once there, enter the words "Social Contact Display" into the search box.  The first result should show the plugin that you are looking for.</p><div style='clear:both;'></div></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/social-contact-display-3.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/social-contact-display-3.png"  style='float:right; margin:0px 0px 15px 15px;'></a><p>Now that you have located the Social Contact Display plugin, click on Install Now.  Wordpress will then handle the download installation of the Social Contact Display plugin for you.  Once successfully installed, click on Activate Plugin to ensure that it is active and running on your Wordpress site.</p><div style='clear:both;'></div></li>
</ol>
<h2>Setting up the Social Contact display plugin within Wordpress</h2>
<p>Now that the Social contact Display plugin is successfully installed on your Wordpres dashboard, its now time to set it all up.  The developers of the Social Contact display plugin have made it very easy to configure.</p>
<ol class="article_list">
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/social-contact-display-4.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/social-contact-display-4.png"  style='float:right; margin:0px 0px 15px 15px;'></a><p>As the plugin is fully configured from right within the widget area that you place it in, look over to the left side menu bar of your Wordpress dashboard and click on Appearance, then Widgets.  Here, you will see a listing of all widgets currently installed on your Wordpress site, as well as any widget areas that are configured in your theme.  In this example, I am using the default theme in Wordpress.</p><div style='clear:both;'></div></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/social-contact-display-5.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/social-contact-display-5.png"  style='float:right; margin:0px 0px 15px 15px;'></a><p>Next, find the widget that is labeled as Social Contact Display and drag it over to the widget area that you want it to be shown in.  In this example, I am placing it into the secondary widget area as I want it to be displayed on the right sidebar.  Of course, you may place it anywhere you want depending on your theme and particular preferences.</p><div style='clear:both;'></div></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/social-contact-display-6.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/social-contact-display-6.png"  style='float:right; margin:0px 0px 15px 15px;'></a><p>Now that the Social Contact Display widget is active in your desired area, click on the item and it will open up into more options.  Here, you may set your name, address, phone number, and social media profiles to display all of your desired information.  Once done, be sure to click the <em>Save</em> button to keep your changes.</p><div style='clear:both;'></div></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/social-contact-display-7.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/social-contact-display-7.png"  style='float:right; margin:0px 0px 15px 15px;'></a><p>Now that everything is all set up, head over to your Wordpress site to see the Social Contact Display plugin in action!</p><div style='clear:both;'></div></li>
</ol> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/wordpress-plugins/the-social-contact-display-plugin-widget-for-wordpress&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/wordpress-plugins/the-social-contact-display-plugin-widget-for-wordpress'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NjcmaWQ9Mjk3MCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="bbc47d9b5174c4735b962b4b4277e875" value="1" />	</div>
	</form>
<!-- <br />
