<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:59420:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/prestashop-15/sending-failed-using-mail-as-phps-default-mail" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Martin, I'm currently working on this issue now - it's just taking a little time to test. I'll be posting an answer after I've checked everything ..." />
  <title>Sending failed using mail() as PHP's default mail() | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/prestashop-15/sending-failed-using-mail-as-phps-default-mail" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:cc75c544896fee1602bbf7384ff30740 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-20']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '93.151.136.213']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Sending failed using mail() as PHP's default mail()</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2014-07-29 4:31 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>5,865</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>When a customer visit my shop and use the contact form  the mail goes to my prestashop backoffice as it should, but no forwarded mails, all new orders &amp; mails from my site should be forwarded i´ve set that up. Also the mail system at my customer service in my prestashop 1.6 backoffice are not working, the customers are not receiving any emails. <br />
<br />
I have tested the email configuration at prestashop backoffice, &quot;advanced parameters&quot; - &quot;email&quot; - &quot;test your email configuration&quot; - The result are: Fejl: Kontroller venligst din konfiguration<br />
Sending failed using mail() as PHP's default mail() function returned boolean FALSE.<br />
<br />
I´ve tried out this one http://www.inmotionhosting.com/support/edu/prestashop-15/349-php-mail-error - it does not work.<br />
<br />
I´ve also tried out to update my mail.php file with another - it still does not work.<br />
<br />
I´ve also tried to reinstall the mail module at the backoffice, - it didnt work either.<br />
<br />
Perhabs some translations folders are missing from my theme after I updated my shop version to 1.6.0.8, got these errors: (A mail directory exists for the &quot;da&quot; language, but not for the default language in /themes/default-bootstrap/modules/sendtoafriend/mails/da/) -  i´ve tried to copy some folders from the root and then to my theme, and it went down from 9 errors to show only 2 errors. <br />
<br />
But still have this error: Fejl: Kontroller venligst din konfiguration<br />
Sending failed using mail() as PHP's default mail() function returned boolean FALSE.<br />
<br />
Any help much appreciated, this error drives me crazy, also I need to get in touch with clients through the customerservice at my back office.<br />
<br />
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_5330' id='upvote_answer_5330' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='5330' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_5330').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_5330' id='downvote_answer_5330' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='5330' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_5330').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Martin,<br />
<br />
I'm currently working on this issue now - it's just taking a little time to test.  I'll be posting an answer after I've checked everything out.<br />
<br />
Regards,<br />
Arnel C.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_5330').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_5330' id='form_comment_on_answer_5330' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Thank you so much Arnel. I've received mails about a new installation and a customer contact message.</div>
...
<br />
Okay, I took a long look at this issue.  The problem has to do with PHP mail settings and how outgoing email is being handled on shared servers.  There has been a security increase in the way outbound emails are being sent - they can not be sent anonymously by the PHP mail service any longer.  You will need to use the SMTP settings in order to identify who the email is being sent from.  When I used the PHP settings, the email would not go.  However, when I set the SMTP settings (which can be found in the PrestaShop admin>Advanced parameters > email), then ALL of my test emails worked with no problem.  I do apologize that the change in security has affected your current emails.  Please use the tutorial on<a href="http://www.inmotionhosting.com/support/edu/everything-email/introduction-email/how-to-find-email-settings" rel="nofollow" target="_blank">how to find your email settings</a> in order to determine your correct SMTP settings, or you can simply use the following.  They should be as follows:<br />
<br />
outgoing mail server:  mail.pitstop-international.com<br />
user= someone@pitstop-international.com (you'd use your admin email address for this setting)<br />
email password<br />
port = 587<br />
(no encoding)<br />
<br />
The test I ran was from your server installation, so I know that your mail does work properly.   Please let us know if you require any further assistance.<br />
<br />
Regards,<br />
Arnel C.<br />
</div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello Martin,<br />
<br />
Just a quick FYI - the emails you received were from the test installation on your account.  I will be deleting them immediately following this reply.<br />
<br />
Regards,<br />
Arnel C.</div>
				...
				<div style='padding:15px 15px 15px 76px; border:1px solid #ddd; border-top:0px; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Thank you very much, i'll try to setup the SMTP a little later when i arrive at my office. Really appreciated have used enough time on this issue. If I encounter any problems i'll make a new contact.</div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello Martin,<br />
<br />
You're welcome - sorry for the problems and the frustration in dealing with the email issue.<br />
<br />
Regards,<br />
Arnel C.</div>
				...
				<div style='padding:15px 15px 15px 76px; border:1px solid #ddd; border-top:0px; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Good news now the mails are working, the SMTP did the trick. Bad news now my theme are messed up, dont ask why, cause i´ve no idea, anyway am I able to rollback without losing any products, images, catagories etc?</div>
				...
				<div style='padding:15px 15px 15px 76px; border:1px solid #ddd; border-top:0px; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Could you clarify the exact issues that you are having with the appearance of your site?</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/prestashop-15/sending-failed-using-mail-as-phps-default-mail&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/prestashop-15/sending-failed-using-mail-as-phps-default-mail'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="dd587aed76f06ffc4db5ffc4f5aee97a" value="1" />	</div>
	</form>
<!-- <br />
