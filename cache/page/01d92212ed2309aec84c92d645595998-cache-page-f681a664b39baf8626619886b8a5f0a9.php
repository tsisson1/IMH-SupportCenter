<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:52090:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/file-management/how-do-i-change-the-settings-in-cpanel-file-manager-to-display-hidden-files-like-htaccess" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello stejohns1, Thank you for your question. If it is not prompting you to view hidden files anymore, you can reset the settings: Login to the cPanel, ..." />
  <title>How do I change the settings in cPanel file manager to display hidden files like .htaccess?  | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/file-management/how-do-i-change-the-settings-in-cpanel-file-manager-to-display-hidden-files-like-htaccess" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:14e1fca71ef4df0c1285fd3bd8c12c57 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '223.196.18.216']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box straight_bottom'>
                <h1 style='font-size:26px;'>How do I change the settings in cPanel file manager to display hidden files like .htaccess? </h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='https://lh5.googleusercontent.com/-L_TKlaZo35k/AAAAAAAAAAI/AAAAAAAABHc/J9DsjOUutIY/photo.jpg?sz=90' class='user_avatar' /><br />
			<a href='/support/community-support/users/stejohns1'>stejohns1</a>
			<div>26 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-06-29 2:01 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>6,344</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I can view them with the legacy file manager but not with the regular one.</div>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px;'>
				<div style='font-size:12px; max-width:500px; overflow:auto;'>The first time I logged in I remember a question about viewing hidden files, and I don't recall whether I set this to yes or no.  I am no longer given that option to change it.</div>
				
				
			</td>
			<td style='width:100px;' valign='top'>
				<img src='https://lh5.googleusercontent.com/-L_TKlaZo35k/AAAAAAAAAAI/AAAAAAAABHc/J9DsjOUutIY/photo.jpg?sz=90' style='width:40px;' class='user_avatar' />
				<div class='smallgrey'>
					<a href='/support/community-support/users/stejohns1'>stejohns1</a><br />
					26 <a href='/support/team/points' target='_blank'>Points</a><br />
					2013-06-29 02:03 pm EST
				</div>
			</td>
		</tr>
	</table>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_3450' id='upvote_answer_3450' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='3450' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_3450').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_3450' id='downvote_answer_3450' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='3450' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_3450').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello stejohns1,<br />
<br />
Thank you for your question. If it is not prompting you to view hidden files anymore, you can reset the settings: <a href="http://www.inmotionhosting.com/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">Login to the cPanel</a>, then on the <em>bottom</em> click the link to <strong>reset all interface settings</strong>.<br />
<br />
Then, when you <a href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-file-manager/using-file-manager-in-cpanel">access the File Manager</a>, the directory selection window will pop up. Click the check box for <strong>view hidden files</strong>.<br />
<br />
...
-John-Paul
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_3450').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_3450' id='form_comment_on_answer_3450' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/file-management/how-do-i-change-the-settings-in-cpanel-file-manager-to-display-hidden-files-like-htaccess&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/file-management/how-do-i-change-the-settings-in-cpanel-file-manager-to-display-hidden-files-like-htaccess'></div>
<script type='text/javascript'>
  (function() {
