<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:62608:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-25/users/prevent-passwords-in-email" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-05-02T16:37:30-07:00" />
  <meta name="keywords" content="joomla 2.5 prevent password email" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="Be default, Joomla 2.5 is configured to send passwords through email. Using the Language Override tool, you can strip these emails of any passwords they include." />
  <title>Prevent passwords in Joomla 2.5 new user account activation emails - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-25/users/prevent-passwords-in-email" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:f8304a842f892164bdce73e7e8543caa -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Prevent passwords in Joomla 2.5 new user account activation emails									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>8,044</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Mar 29, 2012'><span style='color:#606060;'>Published:</span> May 2, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<p class="alert">Joomla 2.5 has reached its end of life as for 12/31/2014. Please be advised this may be a security risk to your website. You can view more information about the end of life <a href="https://docs.joomla.org/Joomla!_CMS_versions">here</a>.</p><br /><p>When registering for a new account in Joomla 2.5, the new user will be emailed a confirmation email, which will include their password:</p>
<div class="code_block">
<p>Hello Brad,</p>
<p>http://example.com/index.php?option=com_users&amp;task=registration.activate&amp;token=12312312312313123123</p>
<p>After activation you may login to http://example.com/ using the following username and password:</p>
<p>Username: test-user-1<br /><strong>Password: password1234</strong></p>
</div>
<p>As emailing passwords can be a security concern, you may want to adjust the emails Joomla 2.5 sends so that they do not contain any passwords.</p>
<p>The email message that you see above is declared in a language file, language/en-GB/en-GB.com_users.ini. In a previous article, we showed you how to use the <a href="/support/edu/joomla-25/language/add-new-language-override">Joomla 2.5 language override</a> feature to change language specific text within Joomla. We will use that same feature to disable passwords being sent through email.</p>
<p><strong>To disable passwords being sent through email in Joomla 2.5 new account activation emails:</strong></p>
<ol class="article_list">
<li><a href="/support/edu/joomla-25/getting-started/how-to-log-into-dashboard">Log into your Joomla Dashboard</a></li>
<li>In the to menu, hover over <strong>Extensions</strong> and click <strong>Language Manager</strong></li>
<li>Click the <strong>Overrides</strong> tab, and then click <strong>New</strong></li>
<li>Under Search text you want to change, enter <strong>COM_USERS_EMAIL_REGISTERED_WITH_ACTIVATION_BODY</strong>, select <strong>Constant</strong>, and then click <strong>Search</strong></li>
<li>In the search results, click the result labeled <strong>COM_USERS_EMAIL_REGISTERED_WITH_ACTIVATION_BODY</strong>. This will load the text for the email next to the Text field.</li>
<li>Remove the following text:<br /><br />using the following username and password:\n\nUsername: %s\nPassword: %s<br /><br />... and then click <strong>Save &amp; Close<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/strip-passwords-from-email/change-language-override.gif"><img  alt="change-language-override" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/strip-passwords-from-email/change-language-override.gif" /></a></strong></li>
<li>The changes you make, you must make for BOTH of the following constants:
<p>* COM_USERS_EMAIL_REGISTERED_WITH_ACTIVATION_BODY<br /> * COM_USERS_EMAIL_REGISTERED_WITH_ADMIN_ACTIVATION_BODY</p>
If there are any other emails that Joomla sends out which includes the password, you can use the same process as above to adjust those emails.<br /><br />After making the change, your new account activiation emails will look similar to:<br />
<div class="article_block" style="max-width: 400px; background: #fff;">Hello brad,
<p>Thank you for registering at Joomla 2.5 Testing Site. Your account is created and must be activated before you can use it. To activate the account click on the following link or copy-paste it in your browser:     <span class="moz-txt-link-freetext">http://example.com/index.php?option=com_users&amp;task=registration.activate&amp;token=456456456456456456</span></p>
<p>After activation you may login to <span class="moz-txt-link-freetext">http://example.com/</span></p>
</div>
</li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 6: Prevent passwords in Joomla 2.5 new user account activation emails</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 5: <a href='/support/edu/joomla-25/users/prevent-new-user-email-notification'>Prevent New Account activation email sent to Joomla 2.5 Administrator</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 7: <a href='/support/edu/joomla-25/users/reset-user-password'>How to reset a Joomla 2.5 user password directly in the database</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-25/users/prevent-passwords-in-email&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-25/users/prevent-passwords-in-email'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xODgmaWQ9MTI1MiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="03a9ae377b185f573f994508b84198ca" value="1" />	</div>
	</form>
<!-- <br />
