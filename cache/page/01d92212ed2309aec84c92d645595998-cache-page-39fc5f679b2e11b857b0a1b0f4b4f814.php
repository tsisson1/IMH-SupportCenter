<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:56108:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/email/general-information/updating-your-mx-records-if-you-use-a-third-party-filtering-service" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-05-02T16:06:59-07:00" />
  <meta name="keywords" content="filtering service email MX record postini" />
  <meta name="author" content="Tim Sisson" />
  <meta name="description" content="This tutorial will describe what you need to do if you are transferring your email to InMotion Hosting and you use a third party filtering service." />
  <title>Updating your MX records if you use a Third Party Filtering Service - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/email/general-information/updating-your-mx-records-if-you-use-a-third-party-filtering-service" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:89d5d6f4bcdc066e45f9dc78e5b17224 -->
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Updating your MX records if you use a Third Party Filter...</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Updating your MX records if you use a Third Party Filtering Service									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>4,491</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Dec 22, 2011'><span style='color:#606060;'>Published:</span> May 2, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Some businesses may find the need to use a third party filtering service such as Postini, to filter their emails. If you are using such a service, you'll need to make sure to set up the MX records to deliver the emails to their servers first. Once the emails are filtered through their servers the messages will be forwarded on to our servers and delivered locally.</p>
<p>If you are updating your domain's nameservers you'll need to retrieve the MX records you previously used. Once you have the MX records that need to be created. You can follow the steps in our article on <a href="/support/edu/cpanel/cpanel-email/modfying-mx-records">modifying MX records</a>. Your MX records will look something like these:</p>
<p class="code_block" style="width: 40%;">example.com.s7a1.psmtp.com.<br />example.com.s7a2.psmtp.com.<br /> example.com.s7b1.psmtp.com.<br /> example.com.s7b2.psmtp.com.</p>
<p class="alert">Please do not use these records becuase they will not work. You must get your MX records from the filtering service provider.</p>
<p class="alert">Also when you're following the instructions on how to modify your MX records, it's important to leave the&nbsp;<strong>Email Routing</strong> option selected as&nbsp;<strong>Local Mail Exchanger</strong> if you're setting up a 3rd party filtering service. So that when they attempt to deliver the mail back to our server it knows to accept them as a local delivery.</p>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/email/cpanel-mx-entry-select-local-mail-exchanger.png"><img style="margin: 0 0 0 30%;" src="//cdn.inmotionhosting.com/support/images/stories/email/cpanel-mx-entry-select-local-mail-exchanger.png" alt="cpanel-mx-entry-select-local-mail-exchanger"  /></a>
<p>Please keep in mind, any change to DNS records such as MX records can take up to 24 hours to fully propagate. Also, You will want to make sure you remove any current MX records and replace them with your filtering service's MX records.</p>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/email/general-information/updating-your-mx-records-if-you-use-a-third-party-filtering-service&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/email/general-information/updating-your-mx-records-if-you-use-a-third-party-filtering-service'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNiZpZD03Njkmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
