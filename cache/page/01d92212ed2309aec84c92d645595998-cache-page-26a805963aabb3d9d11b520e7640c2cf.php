<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:74506:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/wordpress/enable-https" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-01-07T21:18:59-08:00" />
  <meta name="keywords" content="WordPress https SSL" />
  <meta name="author" content="John-Paul Briones" />
  <meta name="description" content="Learn how to use https on your WordPress site in this guide." />
  <title>How to Enable https (SSL) in WordPress - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/wordpress/enable-https" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:c5b8054f1c82053f91a9c8bdcf8ffd6d -->
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to Enable https (SSL) in WordPress</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to Enable https (SSL) in WordPress									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>2,511</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Nov 24, 2014'><span style='color:#606060;'>Published:</span> Jan 7, 2015</div>
							...
							<div style='clear:both;'></div>
								...
								<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress/https/https-in-browser.png"><img   style="margin: 0px 0px 15px 0px;" src="//cdn.inmotionhosting.com/support/images/stories/wordpress/https/https-in-browser.png" alt="SSL enabled on WP site" title="Https WordPress Site" align="right" /></a>
<p>In this tutorial, we will show you how to <strong>enable https</strong> in <strong>WordPress</strong>, so you can connect to your website securely over SSL. For more information, see our guide titled "<a href="/support/website/ssl/what-is-ssl-and-why-is-it-important">What is SSL and why is it important?</a>"</p>
<div style="clear:both;"></div>
<div class="alert alert-danger">You will need an <a href="/support/website/ssl/how-do-i-obtain-an-ssl-certificate">SSL</a> before attempting to complete this tutorial.</div>

  <div style="clear:both;"></div>

<h2>Enabling https in WordPress</h2>
...
<li>Roll your mouse over <strong>Settings</strong> in the navigation menu, then click <strong>General</strong>. Below is a depiction of the steps:<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress/https/settings-general-wordpress.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/wordpress/https/settings-general-wordpress.png" alt="WP settings menu" title="Accessing General WordPress settings" /></a></li>
<li>In the <em>WordPress Address (URL)</em> field, enter your <strong>https</strong> address.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress/https/wordpress-address-url.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/wordpress/https/wordpress-address-url.png" alt="WP URL update" title="Updating URL in WordPress Dashboard" /></a></li>
<li>Enter your <strong>https</strong> address in the <em>Site Address (URL)</em> field. WordPress advises "<em>Enter the address here if you want your site homepage to be different from the directory you installed WordPress.</em>"<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress/https/site-address-url-wordpress.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/wordpress/https/site-address-url-wordpress.png" alt="WP URL update to https" title="WordPress site address update" /></a></li>
<li>Click the <strong>Save Changes</strong> button on the bottom.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress/https/save-wordpress-changes.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/wordpress/https/save-wordpress-changes.png" alt="Save https address" title="Saving Changes in WordPress Dashboard" /></a><br><br>
You are finished when you see a "<em>Settings saved</em>" message.</li></ol>


<p>Congratulations, now you know how to <strong>Enable SSL</strong> in <strong>WordPress</strong>! You will now be able to connect to your WordPress site over an SSL connection.</p>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/wordpress/enable-https&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/wordpress/enable-https'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD02MyZpZD0zNDU2JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/1b28e75bd75e523d7a91fa336d43e9fb?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/1b28e75bd75e523d7a91fa336d43e9fb'>SV</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-31 1:14 pm</div>
				                <div><p>Hi there. &nbsp;This feature does not work - in my Wordpress install I cannot see an option to edit the site URL. &nbsp;It's all greyed out.&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28067);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-02 12:46 pm</div>
				                <div>Hello SV,<br />
<br />
Thank you for contacting us. I recommend checking/setting your <a href="http://www.inmotionhosting.com/support/website/wordpress/wordpress-changing-the-site-url-and-home-settings#change-address-wpconfig">WordPress URL in the wp-config</a> file, or in your <a href="http://www.inmotionhosting.com/support/website/wordpress/wordpress-changing-the-site-url-and-home-settings#change-address-database">database</a>.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28094);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-29340'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/7291ff8b48887701ef43f7ebd2635ba8?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/7291ff8b48887701ef43f7ebd2635ba8'>Oluwaseyi</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-12-22 6:11 pm</div>
				                <div><p>I have done that but it simply locked me out of my Dashboard. I cant access my dashboard any more. How do i revert it back</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29340);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-12-23 12:37 pm</div>
				                <div>Hello Oluwaseyi,<br />
<br />
You can stop using the SSL by using the following lines in your wp-config.php file.<br />
<br />
...
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29357);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-32045'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/73e63426c60f8eb28711fa4e5e06eb0f?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/73e63426c60f8eb28711fa4e5e06eb0f'>Ken</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-19 12:53 am</div>
				                <div><p>Hi,I have purchased ssl from you. After change http to https site urls in admin i am unable to access site admin and front. Its showing following error:</p>
<p>Secure Connection FailedAn error occurred during a connection to mayanoil.com. SSL received a record that exceeded the maximum permissible length. Error code: SSL_ERROR_RX_RECORD_TOO_LONGmy domain is mayanoil.com and id is kcengle@roadrunner.comPlease check and assist me is it installed on my server and wordpress.ThanksKen</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32045);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-19 8:55 am</div>
				                <div>If our Support technicians installed the SSL they will be happy to take another look to see if something may have happened. I advise you contact <a href="http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support">Live Support</a> for more information regarding the SSL installation. Or, if you have any comments or questions about the steps in the article above, using https with Wordpress, let us know.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32054);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
