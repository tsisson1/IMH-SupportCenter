<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:61053:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/drupal-7/blocks-and-regions/create-block" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-07-17T17:15:36-07:00" />
  <meta name="keywords" content="create new block drupal 7" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="Creating a new block in Drupal 7 will allow you to literally create a block of content and place it anywhere within your website." />
  <title>How to create a new block in Drupal 7 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/drupal-7/blocks-and-regions/create-block" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:2e7d21af4b7e549cf7fa2ae6f7fd034e -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '212.1.102.59']);
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
				<img src='/support/images/stories/drupal-partner/supporting-partner-80_3.png' style='float:right; margin:0px 0px 15px 15px;' alt='Drupal Association Support Partner'>		<h1>
															How to create a new block in Drupal 7									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>17,405</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jul 17, 2012'><span style='color:#606060;'>Published:</span> Jul 17, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Now that we know <a href="/support/edu/drupal-7/blocks-and-regions/nodes-blocks-regions">the idea behind blocks in Drupal 7</a>, we can create a new block. In the following tutorial we'll show you how to create a new block in Drupal 7. We'll also review the various settings that each block can be configured with.</p>
<p><strong>To create a new block in Drupal 7:</strong></p>
<ol class="article_list">
<li><a href="/support/edu/drupal-7/blocks-and-regions/create-block">Log into Drupal 7</a> as an administrator</li>
<li>In the top menu, click <strong>Structure</strong></li>
<li>Click <strong>Blocks</strong></li>
<li>Click <strong>Add block</strong></li>
<li>
<div style="margin-bottom: 15px;">There are several fields that we need to fill out for this new block. We've outlined these values below.</div>
<h2>Initial Block Settings</h2>
<table class="article_table">
<tbody>
<tr>
<th>Block title</th>
<td>Enter a title for your block. If you enable the option to show a title for your block, this is what will show.</td>
</tr>
<tr>
<th>Block description</th>
<td>The block description is used primarily to identify this particular block in your Drupal 7 admin section. If you had 20 different blocks for example, unique descriptions will help you organize and manage your blocks more efficiently.</td>
</tr>
<tr>
<th>Block body</th>
<td>The block body is the bulk of your block. For example, if you  were creating a block to show social media icons, the HTML code would be  entered in the Block body.</td>
</tr>
<tr>
<th>Text format</th>
<td>The Text format controls if and how your block body will be filtered. For example, there are some options that allow HTML code and others that don't. If you select a different Text format from the drop down menu, you will see the text below it change to highlight the details of the particular format that you selected.</td>
</tr>
</tbody>
</table>
<br /> 
...
<tbody>
<tr>
<th>Creating our Block</th> <th>How it will appear on our site</th>
</tr>
<tr>
<td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Blocks/creating-a-new-block.gif"><img style="max-width: 240px;"  alt="creating-a-new-block" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Blocks/creating-a-new-block.gif" /></a></td>
<td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Blocks/how-the-block-displays-on-our-site.gif"><img style="max-width: 240px;"  alt="how-the-block-displays-on-our-site" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Blocks/how-the-block-displays-on-our-site.gif" /></a></td>
</tr>
</tbody>
</table>
<h2>Region Settings</h2>
<p>The region settings allow you to setup where each of your blocks will appear. Beneath each listed theme, select the region to display the block in. In order to know how to choose a region, you'll first need to know <a href="/support/edu/drupal-7/blocks-and-regions/find-regions">where each region is within your theme</a>. Keep in mind too that you can <a href="/support/edu/drupal-7/blocks-and-regions/how-to-use-blocks-in-drupal-7">change the region blocks are assigned to</a> at any time.</p>
<h2>Visibility settings</h2>
<table class="article_table">
<tbody>
<tr>
<th>Pages</th>
<td>The <em>Pages</em> setting allows you to restrict which pages this block will be displayed in. For example, if you had a block that showed a Google map of where your business is located, you may only what that block to show in your <em>Contact Us</em> page.</td>
</tr>
<tr>
<th>Content types</th>
<td>The <em>Content types</em> setting allows you to control which content types this block will appear with.</td>
</tr>
<tr>
<th>Roles</th>
<td>The <em>Roles</em> setting allows you to specify which types of users can see this block. For example, if you only want logged in users to be able to see the block, you can specify that here.</td>
</tr>
<tr>
<th>Users</th>
<td>Drupal 7 gives each user the ability to customize how your site will display for them, this includes the option to show or hide certain blocks. If you want users to be able to toggle on/off the display of this block, you'll do that within the <em>Users</em> settings.</td>
</tr>
</tbody>
</table>
</li>
<li> When you are finished configuring your block, click the <strong>Save block</strong> button at the bottom of the page. You should now be able to visit your site and view your new block (depending on the <em>Region Settings</em> as described above).</li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 3: How to create a new block in Drupal 7</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 2: <a href='/support/edu/drupal-7/blocks-and-regions/find-regions'>How to view block regions in Drupal 7</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/drupal-7/blocks-and-regions/create-block&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/drupal-7/blocks-and-regions/create-block'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yMDUmaWQ9MTU1MyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="a6e6c71a8d3f1996047f1cf03007ec96" value="1" />	</div>
	</form>
<!-- <br />
