<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:56546:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/opencart/312-what-version-of-opencart-am-i-running" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-01-24T13:47:55-08:00" />
  <meta name="keywords" content="opencart version what running using" />
  <meta name="author" content="Tim Sisson" />
  <meta name="description" content="In this short tutorial, we'll show you how to determine what version of OpenCart you are using." />
  <title>312: What version of OpenCart am I running? - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/opencart/312-what-version-of-opencart-am-i-running" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:57103117da3c8075cddaf4c5e0e4c93f -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															312: What version of OpenCart am I running?									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>13,743</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 24, 2012'><span style='color:#606060;'>Published:</span> Jan 24, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Sometimes it can be important to know what version of OpenCart you are running. This is the case, especially when installing new extensions as not all extensions are compatible with every version of OpenCart. Finding out what version of OpenCart you are running is quite simple.</p>
<ol>
<li>Visit your OpenCart dashboard in a web browser</li>
<li>Look at the bottom of the footer and you will see the version information</li>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/opencart/opencart_version_1.jpg"><img  alt="opencart_version_1" src="//cdn.inmotionhosting.com/support/images/stories/opencart/opencart_version_1.jpg" /></a></p>
</ol>
<p>If you need further assistance please feel free to <a href="/support/community-support/">ask a question on our support center</a>.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 38: 312: What version of OpenCart am I running?</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 37: <a href='/support/edu/opencart/310-installing-vqmod-manager'>310: Installing vQmod Manager</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 39: <a href='/support/edu/opencart/320-adding-google-1-buttons-using-vqmod-in-opencart'>320: Adding Google +1 buttons using vQmod in OpenCart 1.5</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/opencart/312-what-version-of-opencart-am-i-running&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/opencart/312-what-version-of-opencart-am-i-running'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD04OCZpZD0yMzQzJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="91ec048282646b47bca344d7c5a60361" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/3b8230b72d978fe7b3fae3b69204d85a?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/3b8230b72d978fe7b3fae3b69204d85a'>Ankit K</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-28 9:28 am</div>
				                <div><p>Opencart doesn't display which version i'm using what can i do??</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17912);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-28 12:12 pm</div>
				                <div>Hello Ankit,<br />
<br />
Thank you for yoru OpenCart question. I found a post in the Official <a href="http://forum.opencart.com/viewtopic.php?f=19&t=4753">OpenCart Forum</a>, where they state:<br />
"<em>the version is defined as a constant VERSION for programatic use at the top of the index.php and admin/index.php (since version 1.4.7 I believe) and it is shown in the admin footer for visual reference (since around 1.4.4 or so)</em>"<br />
<br />
I hope this helps,<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17923);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
