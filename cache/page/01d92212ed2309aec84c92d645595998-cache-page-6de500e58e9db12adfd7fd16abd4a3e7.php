<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50780:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/email-troubleshooting/why-do-some-email-attachments-get-converted-into-a-dat-file" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Talismanip, Thanks for the question and sorry to hear you're having problems with the email attachment. If you post in the future, it helps to ide..." />
  <title>Why do some E-Mail attachments get converted into a .dat file? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/email-troubleshooting/why-do-some-email-attachments-get-converted-into-a-dat-file" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:d71e30d5c6a71ff917a51ce066117e65 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-20']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '23.25.154.65']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Why do some E-Mail attachments get converted into a .dat file?</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='https://lh5.googleusercontent.com/-CcFvXNrOpBE/AAAAAAAAAAI/AAAAAAAAAEo/kWz9qhn9s8Y/photo.jpg?sz=90' class='user_avatar' /><br />
			<a href='/support/community-support/users/Talismanip'>Talismanip</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-07-29 11:02 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>22,309</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Sometimes we send a .pdf file attached to an E-Mail and the user cannot open the attachment because it has been converted into a .dat file.</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_3623' id='upvote_answer_3623' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='3623' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_3623').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_3623' id='downvote_answer_3623' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='3623' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_3623').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Talismanip,<br />
<br />
Thanks for the question and sorry to hear you're having problems with the email attachment.  If you post in the future, it helps to identify the email program that you're using and its version because this problem has been identified before.  However, I'll take a guess and hope that the solution I present identifies and resolves your problem correctly.  <br />
<br />
It's a problem that generally occurs with Outlook.  Check out <a href="http://email.about.com/od/outlooktips/qt/Prevent_Winmail_dat_Attachments_from_Being_Sent_in_Outlook.htm" rel="nofollow" target="new">How to prevent the Winmail .DAT attachments</a> article.  It explains why it happens and how to resolve.  Basically, the formatting commands that are included in your message are placed in the .dat file due to the receiving email client not being able to understand those commands.  And this also happens to include attachments.    <br />
<br />
If you happen to be using a Mac, there is also a link <a href="http://email.about.com/od/macosxmailaddons/gr/omic.htm" rel="nofollow" target="new">replace this text</a> that talks about a solution for handling this issue as well.  <br />
<br />
I hope this helps to resolve your problem!  If you still need assistance, please let us know.<br />
<br />
Regards,<br />
Arnel C.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_3623').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_3623' id='form_comment_on_answer_3623' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/email-troubleshooting/why-do-some-email-attachments-get-converted-into-a-dat-file&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/email-troubleshooting/why-do-some-email-attachments-get-converted-into-a-dat-file'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="e843bdd7e798c289196e97a7a18f3fd9" value="1" />	</div>
	</form>
<!-- <br />
