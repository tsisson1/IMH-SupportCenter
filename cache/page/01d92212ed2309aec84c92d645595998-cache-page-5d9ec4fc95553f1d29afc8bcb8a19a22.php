<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50426:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/how-to/map-domain-to-squarespace" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Thank you for your question Bob_Z!Your domain can be pointed to Squarespace by changing the DNS A record. You can set up custom DNS records in your cPan..." />
  <title>Map domain to squarespace | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/how-to/map-domain-to-squarespace" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:625eb0b1f8990be2eabea5023cf0b84d -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Map domain to squarespace</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/Bob_Z'>Bob_Z</a>
			<div>10 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-03-25 12:50 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>3,095</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I have created site with Squarespace and want to use my domain that is hosted here.  How to I map the domain to Squarespace?</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_2543' id='upvote_answer_2543' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='2543' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_2543').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_2543' id='downvote_answer_2543' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='2543' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_2543').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>5,889 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2013-03-25 1:18 pm EST
                		        </div>
					
		                </div>

				&lt;p&gt;Thank you for your question Bob_Z!&lt;/p&gt;&lt;p&gt;Your domain can be pointed to &lt;strong&gt;Squarespace&lt;/strong&gt; by changing the DNS &lt;em&gt;A record&lt;/em&gt;. You can set up custom DNS records in your cPanel &lt;em&gt;Simple DNS Zone editor&lt;/em&gt;. Below are some links on editing your DNS.&lt;/p&gt;<br />
&lt;p&gt;&lt;a href=&quot;http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/how-do-i-make-custom-dns-records&quot;&gt;How do I make custom DNS records? &lt;/a&gt;&lt;/p&gt;&lt;p&gt;&lt;a href=&quot;http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/a-record-change&quot;&gt;Adding an A Record &lt;/a&gt;&lt;/p&gt;<br />
&lt;p&gt;You will need to get the DNS settings at Squarespce in order to update them on our end. If you get the DNS settings at Squarespace and you have trouble changing them in the &lt;em&gt;Simple DNS Zone Editor&lt;/em&gt;,  you can have &lt;a href=&quot;index.php?option=com_content&amp;amp;amp;view=article&amp;amp;amp;id=255:how-to-get-great-technical-support&amp;amp;amp;catid=34&amp;amp;amp;Itemid=101&quot; target=&quot;_blank&quot; title=&quot;Click here for how to contact support&quot;&gt;tech support&lt;/a&gt; update the records for you.&lt;/p&gt; <br />
&lt;p&gt;Email this request to &lt;strong&gt;support@inmotionhosting.com&lt;/strong&gt;. Tell them the domain and and the DNS changes you need. You will need to verify the account in the email include the last 4 of the credit card number or the current AMP password and they can process it from there&lt;/p&gt;<br />
&lt;p&gt;Best Regards,&lt;br /&gt;James R&lt;/p&gt;
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_2543').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_2543' id='form_comment_on_answer_2543' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/how-to/map-domain-to-squarespace&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/how-to/map-domain-to-squarespace'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="35022c9a5b6d951571ed6cfb25b27ac6" value="1" />	</div>
	</form>
<!-- <br />
