<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49590:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/dns-nameserver-changes/change-primary-domain-name-option-not-available" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hi General B, I'm sorry to hear you are having issues changing your primary domain. I'm more than happy to help you. If you dont have the option to chan..." />
  <title>&quot;Change Primary Domain Name&quot; Option Not Available | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/dns-nameserver-changes/change-primary-domain-name-option-not-available" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:5bc9b866d11d74f78e37fe6e3beb1498 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>&quot;Change Primary Domain Name&quot; Option Not Available</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/general b'>general b</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-11-18 2:13 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>77</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I need to change my primary domain name from thcjobsearch.com to thcskills.com.  The support FAQs show how to do it, but the link is not available in AMP.</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_8552' id='upvote_answer_8552' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='8552' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_8552').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_8552' id='downvote_answer_8552' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='8552' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_8552').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hi General B,<br />
<br />
I'm sorry to hear you are having issues changing your primary domain. I'm more than happy to help you. If you dont have the option to change it via AMP, I'd suggest calling Support at 888.321.HOST to help you. <br />
<br />
Thanks!<br />
<br />
Tim S
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_8552').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_8552' id='form_comment_on_answer_8552' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/dns-nameserver-changes/change-primary-domain-name-option-not-available&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/dns-nameserver-changes/change-primary-domain-name-option-not-available'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="490ffabbe27da39bea65b1509f101609" value="1" />	</div>
	</form>
<!-- <br />
