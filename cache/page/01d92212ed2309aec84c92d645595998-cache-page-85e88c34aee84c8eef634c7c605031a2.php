<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:69872:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/htaccess/password-single-file-htaccess" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-09-26T13:13:44-07:00" />
  <meta name="keywords" content="htaccess password protect single file" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="This article helps you in password protecting a single file on your account via the htaccess" />
  <title>How to password protect a single file with htaccess - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/htaccess/password-single-file-htaccess" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:5fb4c673951abe7f9be05f8a1ba407d0 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to password protect a single file with htaccess									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>14,555</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Aug 3, 2012'><span style='color:#606060;'>Published:</span> Sep 26, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>The .htaccess file is a powerful tool where many behind the scene things are handled. In addition to things such as forcing a specific url formatting, it can also help with access to certain pages. Many sites have members only areas of their websites. These are either coded to check against a database with languages such as php, or grouped together into a single subfolder that is password protected via the cPanel.</p>
...
<li>Next, you want to <a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">log into your cPanel</a>.&nbsp;</li>
...
<li>A popup box will appear. We need to make a quick stop in the Home directory so we can create a file that is not accessible directly from a web browser. Select the <em>Home Directory</em> option. Also ensure the <em>Show Hidden Files</em> option is checked. From there, click on the <strong>Go</strong> button at the bottom.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/htaccess/Password_Single_File/file-manager-home-dir.png"><img  alt="file-manager-home-dir" src="//cdn.inmotionhosting.com/support/images/stories/edu/htaccess/Password_Single_File/file-manager-home-dir.png" /></a></li>
<li>You are now in the home directory of the hosting account. The home directory is not accessible from the web via a URL, so it is more secure. We want to create a password file here that will be used to check access for users trying to get to the file we are going to protect. You will want to create a new text file. To do so, find the <strong>New File</strong> icon from the top menu bar and click it.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/htaccess/Password_Single_File/cpanel-new-file.png"><img  alt="cpanel-new-file" src="//cdn.inmotionhosting.com/support/images/stories/edu/htaccess/Password_Single_File/cpanel-new-file.png" /></a></li>
<li>A popup will appear, asking to name the file. Here we named it <em>.htpassword</em> (Note that the filename begins with a period. This is intentional as it makes the file hidden.) Below that is a field to enter a path to store the file. Leave it blank so it will default to the root folder. Click on <strong>Create New File</strong> to continue.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/htaccess/Password_Single_File/name-password-file.png"><img  alt="name-password-file" src="//cdn.inmotionhosting.com/support/images/stories/edu/htaccess/Password_Single_File/name-password-file.png" /></a></li>
<li>The new file is now in your account. In the right hand pane, scroll down until you find the file, then right click on it. Click on the <strong>Edit</strong> option from the menu that appears. A popup will appear, simply click on the <strong>Edit</strong> button in the lower right to continue.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/htaccess/Password_Single_File/find-htpassword.png"><img  alt="find-htpassword" src="//cdn.inmotionhosting.com/support/images/stories/edu/htaccess/Password_Single_File/find-htpassword.png" /></a></li>
<li>We are now in the editor. Cut and paste the username and password code you were given before. Keep the code as a single line and do not edit it. Click on the <strong>Save Changes</strong> button to save the file.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/htaccess/Password_Single_File/save-htpassword.png"><img  alt="save-htpassword" src="//cdn.inmotionhosting.com/support/images/stories/edu/htaccess/Password_Single_File/save-htpassword.png" /></a></li>
...
<li>You are now in the text editor for the <em>.htaccess</em> file. Place the following code into your htaccess so that it prompts the visitor for a login.      <br />
...
<li>Third, the file name needs to reflect the name of the page you are protecting. Change '<em>mypage.html</em>' to the actual file name.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/htaccess/Password_Single_File/save-htaccess.png"><img  alt="save-htaccess" src="//cdn.inmotionhosting.com/support/images/stories/edu/htaccess/Password_Single_File/save-htaccess.png" /></a></li>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/htaccess/password-single-file-htaccess&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/htaccess/password-single-file-htaccess'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MTMmaWQ9NDM5JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="4da1fea2e58f81aba901f19dada11d08" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/b1583c79e8356d0773d3f45639a74901?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/b1583c79e8356d0773d3f45639a74901'>Ahmed</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-11 9:56 am</div>
				                <div><p>Thank you for your support,</p>
<p>I did all these steps well, but the login don't accept my user/password.</p>
<p>Regards</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25669);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-12 12:19 am</div>
				                <div>Hello Ahmed,<br />
<br />
Can you post what you put in your .htaccess file so we can make sure you have all of the required information? You can modify anything that is considered sensitive such as your cPanel username.<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25688);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
