<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:60266:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-25/slideshow/adding-slides" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-04-15T17:03:27-07:00" />
  <meta name="keywords" content="add slides joomla 2.5 slideshow unite nivo slider" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="After creating a new Slider within Unite Nivo Slider, our next step is to add images (slides) to this new slideshow." />
  <title>How to add new slides to a Unite Nivo Slider in Joomla 2.5 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-25/slideshow/adding-slides" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:636585ade3f088a64935623d27f4e38b -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '190.181.25.175']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to add new slides to a Unite Nivo Slider in Joomla 2.5									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>11,018</span></div>
							...
							<div style='clear:both;'></div>
								...
								<p class="alert">Joomla 2.5 has reached its end of life as for 12/31/2014. Please be advised this may be a security risk to your website. You can view more information about the end of life <a href="https://docs.joomla.org/Joomla!_CMS_versions">here</a>.</p><br /><p>In our last two tutorials, we walked you through the steps for <a href="/support/edu/joomla-25/slideshow/install-unite-nivo-slider">installing Unite Nivo Slider for Joomla 2.5</a> and <a href="/support/edu/joomla-25/slideshow/create-new-slider">creating your first slider</a>. The slider we created is the parent item that will contain the individual images for our slideshow.</p>
<p>In our tutorial, we will create a slideshow full of animal photos. We will now show you how to upload one image to your slider. You will need to repeat the steps below for each additional image that you would like to add.</p>
<p><strong>To add an image to a Unite Nivo Slider:</strong></p>
<ol class="article_list">
<li>Log into your Joomla 2.5 admin section</li>
<li>In the top menu, hover over <strong>Components</strong> and then click <strong>Unite Nivo Slider</strong></li>
<li>Click the <strong>Slides</strong> tab (next to <em>Sliders</em>)</li>
<li>If you have multiple sliders, select the appropriate slider next to the <strong>Select Slider</strong> drop down menu<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/unite-nivo-slider/select-the-slider-to-add-slides-to.gif"><img  alt="select-the-slider-to-add-slides-to" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/unite-nivo-slider/select-the-slider-to-add-slides-to.gif" /></a></li>
<li>In the top right menu, click New</li>
<li>On the new slide page, enter the following details:<br /> 
<table class="article_table">
<tbody>
<tr>
<th>Title</th>
<td>Enter a title for this picture<br /></td>
</tr>
<tr>
<th>Slider</th>
<td>Select the slider the image should belong to<br /></td>
</tr>
<tr>
<th>State</th>
<td>If you want the image to show in your slideshow, ensure <strong>State</strong> is set to <strong>Published</strong>.<br /></td>
</tr>
<tr>
<th>Slide image</th>
<td>Click Select to either select a current image you've previously uploaded or upload a new image<br /></td>
</tr>
<tr>
<th>Slide description</th>
<td>Each slide can show text below the image. If you want this text to have a description, enter it here<br /></td>
</tr>
<tr>
<th>Activate Link</th>
<td>You can setup the text to be clickable so that it links users to another page. If you want it to be clickable, select <strong>Yes</strong> for <strong>Activate Link</strong>.<br /></td>
</tr>
<tr>
<th>Link</th>
<td>Enter the URL for page you would like the slide to link to</td>
</tr>
<tr>
<th>Link Open In</th>
<td>Select whether the link should open in either a <strong>new window</strong> or the <strong>same window</strong></td>
</tr>
</tbody>
</table>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/unite-nivo-slider/example-slide.gif"><img  alt="example-slide" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/unite-nivo-slider/example-slide.gif" /></a> </li>
<li>When finished filling out the above details, click the <strong>Save</strong> button in the top right menu.<br /><br />Our next step will be to <a href="/support/edu/joomla-25/slideshow/slideshow-on-homepage">create a module for our slideshow so that we can display it on our homepage</a>!</li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 3: How to add new slides to a Unite Nivo Slider in Joomla 2.5</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 2: <a href='/support/edu/joomla-25/slideshow/create-new-slider'>How to create a new Slider in Unite Nivo Slider for Joomla 2.5</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 4: <a href='/support/edu/joomla-25/slideshow/slideshow-on-homepage'>Inserting a slideshow on your Joomla 2.5 Homepage</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-25/slideshow/adding-slides&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-25/slideshow/adding-slides'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yMjMmaWQ9MTU2MSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="646a1de80df64960bdb6ae5ed1407eeb" value="1" />	</div>
	</form>
<!-- <br />
