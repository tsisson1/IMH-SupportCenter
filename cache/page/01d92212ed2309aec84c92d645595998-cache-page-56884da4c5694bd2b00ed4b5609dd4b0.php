<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:47285:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/dokuwiki/writing-content-dokuwiki" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="keywords" content="basics creating create editing edit delete deleting add adding content doku wiki DokuWiki pages" />
  <meta name="description" content="This course section will explain the basics for creating, editing and adding content to your DokuWiki pages." />
  <title>102: Writing content for DokuWiki | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/dokuwiki/writing-content-dokuwiki" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:f46fe678e55307a518d0d13500e64dfb -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '195.65.184.230']);
...
<div class='page-header'>
	<h1>102: Writing content for DokuWiki</h1>
</div>
<div class='section_listing'>
	<h1>DokuWiki 102: Writing content</h1>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/102-dokuwiki.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="Formatted page in DokuWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/102-dokuwiki.gif" title="Click here to view the larger image" width="100" /></a> After completing the Getting started with DokuWiki course, we now come to the 102 course on writing content in DokuWiki. DokuWiki 102 will explain creating and editing pages and creating namespaces. Namespaces are like categories pages are created in. This makes the site easier to navigate by grouping pages together. DokuWiki also stores pages&nbsp; in revisions so they can be restored if they are deleted. Writing content is the next step in building your DokuWiki site.<br style="clear: both;" /></p>

<p>The next course in DokuWiki is the <a href="/support/edu/dokuwiki/change-dokuwiki-appearance">Changing the DokuWiki Appearance - Dokuwiki 103</a> course.</p>	<table>
	<tr><td colspan='3'><h2>Pages and Namespaces</h2><div>This articles will explain how to create pages and namespaces in DokuWiki.</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 1:</td>
				<td style='padding-right:10px;'><div class='gold_star'></div></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/dokuwiki/writing-content-dokuwiki/edit-create-delete-restore-dokuwiki'>How to create pages in DokuWiki</a>
					<div>This article will explain the basics of how to create pages in DokuWiki.</div>
					<div class='smallgrey'>Hits: 12,849</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'><div class='gold_star'></div></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/dokuwiki/writing-content-dokuwiki/create-namespace-doku'>How to create namespaces in DokuWiki</a>
					<div>Creating namespaces is an essential part of site navigation in DokuWiki. This article explains how to create namespaces in DokuWIki.</div>
					<div class='smallgrey'>Hits: 14,181</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/dokuwiki/writing-content-dokuwiki/edit-delete-restore-pages'>How to edit and delete DokuWiki pages</a>
					<div>This first step in creating content in DokuWiki is to edit the pages. This article will explain how to edit and elete pages from DokuWiki.</div>
					<div class='smallgrey'>Hits: 9,549</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/dokuwiki/writing-content-dokuwiki/delete-rename-namespaces-doku'>How to delete and rename namespaces in DokuWiki</a>
					<div>You can delete or rename namespaces in DokuWiki to update the site structure. This article will teach you how to rename and delete namespaces.</div>
					<div class='smallgrey'>Hits: 7,290</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/dokuwiki/writing-content-dokuwiki/redirect-page-doku'>Redirecting pages in DokuWiki</a>
					<div>When deleting pages from DokuWiki, you will want to redirect the removed page to a valid url to prevent 404 not found errors. This article will explain how to use the Page Redirect plugin to redirect removed pages.</div>
					<div class='smallgrey'>Hits: 2,343</div>
				</td>
			</tr>
		<tr><td colspan='3' style='padding-top:20px;'><h2>Editing content</h2><div>This section will explain the basic concepts of editing and formatting DokuWiki pages.</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 6:</td>
				<td style='padding-right:10px;'><div class='gold_star'></div></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/dokuwiki/writing-content-dokuwiki/format-doku-content'>How to format content in DokuWiki</a>
					<div>DokuWiki has its own wiki code for formatting. This article will explain the DokuWIki formatting options and how to bold, headline, and number text.</div>
					<div class='smallgrey'>Hits: 6,126</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/dokuwiki/writing-content-dokuwiki/internal-external-links-doku'>Inserting internal and external links in DokuWiki</a>
					<div>Creating internal and External links in DokuWiki are important for site navigation. This article will explain how to make an internal and external link in DokuWiki.</div>
					<div class='smallgrey'>Hits: 4,961</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/dokuwiki/writing-content-dokuwiki/inserting-images-doku'>How to insert images into a DokuWIki page</a>
					<div>This article will explian how to insert an image in DokuWiki.</div>
					<div class='smallgrey'>Hits: 3,366</div>
				</td>
			</tr>
			</table>
</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMTkmaWQ9MzE5JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="e048a474b4cac33a0f55f3f5784044bb" value="1" />	</div>
	</form>
<!-- <br />
