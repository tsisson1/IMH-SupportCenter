<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49963:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/domain-names/i-cannot-send-and-login-with-filezilla" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, Sorry to hear that you're having problems with FTP. That error can occur if you're trying to put an HTTP address in the FTP client (in the HOST f..." />
  <title>I cannot send and login with FileZilla | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/domain-names/i-cannot-send-and-login-with-filezilla" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:dbe2aa32d40092ca49cd75c726c6e12a -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-20']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '64.4.82.146']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>I cannot send and login with FileZilla</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-03-25 9:43 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>497</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Why my FileZilla have a text like it:<br />
<br />
Invalid protocol specified. Valid protocols are:<br />
ftp:// for normal FTP with optional encryption,<br />
sftp:// for SSH file transfer protocol,<br />
ftps:// for FTP over TLS (implicit) and<br />
ftpes:// for FTP over TLS (explicit).<br />
<br />
Thanks for your answer ^_^</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_6879' id='upvote_answer_6879' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='6879' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_6879').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_6879' id='downvote_answer_6879' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='6879' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_6879').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
Sorry to hear that you're having problems with FTP.  That error can occur if you're trying to put an HTTP address in the FTP client (in the HOST field).  Filezilla is not made to handle HTTP requests.  If that isn't the problem , we don't have enough detail from you to understand why you're getting the error message in Filezilla.  Could you please provide the URL that you were trying to use when you got the error?  And what settings were you using? If the issue is not resolved, please provide us this information and we can investigate the issue further.  If you need more information on using FTP, check out <a href="http://www.inmotionhosting.com/support/website/ftp/getting-started-guide">Getting Started with FTP</a>.<br />
<br />
...
Arnel C.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_6879').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_6879' id='form_comment_on_answer_6879' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/domain-names/i-cannot-send-and-login-with-filezilla&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/domain-names/i-cannot-send-and-login-with-filezilla'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="bebf205e7ebfb3ab0dee22678b22947b" value="1" />	</div>
	</form>
<!-- <br />
