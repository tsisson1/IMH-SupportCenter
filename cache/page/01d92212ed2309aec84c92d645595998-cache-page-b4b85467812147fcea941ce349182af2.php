<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:59054:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/domain-management/how-do-i-create-an-add-on-domain-in-my-control-panel-cpanel" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-09-24T17:56:35-07:00" />
  <meta name="keywords" content="cPanel add-on domain multiple domains" />
  <meta name="author" content="Tim Sisson" />
  <meta name="description" content="In this article, we will explain how to create an add-on domain in cPanel." />
  <title>How do I create an add-on domain in my control panel (cpanel)? - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/domain-management/how-do-i-create-an-add-on-domain-in-my-control-panel-cpanel" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:5a67eb21e4bfd832d96a18991e0e038e -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How do I create an add-on domain in my control panel (cpanel)?									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>6,817</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Aug 29, 2011'><span style='color:#606060;'>Published:</span> Sep 24, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>To create an add-on domain in your control panel, please watch this flash tutorial:</p>
<p><a href="http://support.inmotionhosting.com/userguides/cpflash/cpanel_xv2_addon.htm" target="_blank">http://support.inmotionhosting.com/userguides/cpflash/cpanel_xv2_addon.htm</a></p>
<p>For information on other cpanel features, please visit:</p>
<p><a href="http://support.inmotionhosting.com/userguides/cpanel_flash_guide.htm" target="_blank">http://support.inmotionhosting.com/userguides/cpanel_flash_guide.htm</a></p> 
...
<div style='display:inline-block;'>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NDkmaWQ9ODcmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/ef11f774f44ffc3731baecca92013ee8?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/ef11f774f44ffc3731baecca92013ee8'>Sharon Brodin</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-18 11:20 am</div>
				                <div>For much of the info on your site, one already has to be familiar with the jargon. For non-technical newbies like me, that's not helpful!</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13006);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
