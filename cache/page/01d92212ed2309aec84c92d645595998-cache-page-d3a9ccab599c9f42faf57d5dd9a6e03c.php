<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:46612:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/boldgrid/installing-boldgrid" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="keywords" content="Install BoldGrid" />
  <meta name="description" content="How to Install BoldGrid for WordPress." />
  <title>Installing BoldGrid | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/boldgrid/installing-boldgrid" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:fc7ffd0a34089eb118c3ba2380538e6a -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '76.114.140.50']);
...
<div class='page-header'>
	<h1>Installing BoldGrid</h1>
</div>
<div class='section_listing'>
	This class goes over how to install and set up BoldGrid using different methods.	<table>
		<tr>
				<td style='width:75px; font-weight:bold;'>Section 1:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/boldgrid/installing-boldgrid/manually'>How to Manually Install BoldGrid</a>
					<div>Learn how to manually install BoldGrid in this tutorial.</div>
			...
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/boldgrid/installing-boldgrid/what-is-boldgrid-advanced'>What is BoldGrid (Advanced Users)</a>
					<div>Are you and advanced WordPresss user Looking for information on BoldGrid? Check out this article to learn more!</div>
					<div class='smallgrey'>Hits: 1,455</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/boldgrid/installing-boldgrid/introduction'>Introduction to BoldGrid Powered by WordPress</a>
					<div>Learn about the BoldGrid website Builder, powered by WordPress.</div>
					<div class='smallgrey'>Hits: 5,449</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/boldgrid/installing-boldgrid/how-to-install'>How to Install BoldGrid</a>
					<div>The Connect Key is automatically installed with Business level accounts (shared servers), but may need to be manually installed with VPS or Dedicated server accounts.  The following tutorial walks you through obtaining and using the connect key for the BoldGrid plugin installation.</div>
					<div class='smallgrey'>Hits: 3,519</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/boldgrid/installing-boldgrid/view-connect-key'>How to get to Your BoldGrid Connect Key</a>
					<div>Your Boldgrid connect key is needed to activating different features. Learn how to locate it in your AMP in this tutorial.</div>
					<div class='smallgrey'>Hits: 1,991</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/boldgrid/installing-boldgrid/boldgrid-staging-with-existing-site'>Using BoldGrid with an existing WordPress Site</a>
					<div>BoldGrid allows you to work with existing sites by setting up the Staging and Active development environment.  This allows you to have a staging site that cannot be viewed by website visitors until the staging site has been deployed.  You can build a completely different WordPress site and only release it when you feel that it's ready. </div>
					<div class='smallgrey'>Hits: 712</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/boldgrid/installing-boldgrid/boldgrid-wp-subdirectory-install'>How to Install WordPress in a Subdirectory</a>
					<div>This article shows how to install WordPress into a subdirectory using Softaculous.</div>
					<div class='smallgrey'>Hits: 112</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/boldgrid/installing-boldgrid/installing-first-boldgrid-site'>Installing your first BoldGrid Site</a>
					<div>BoldGrid is a comprehensive plugin used to build beautiful and complete WordPress-based websites. The following tutorial walks you through the setup of your first BoldGrid website using the Inspirations option provided in the installation.</div>
					<div class='smallgrey'>Hits: 1,203</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/boldgrid/installing-boldgrid/boldgrid-use-different-domain'>How to use BoldGrid in a Different Domain</a>
					<div>A common question when creating websites is "How do I use a different domain name?"  When using BoldGrid, you will need to change the domain name based on your WordPress installation.  InMotion Hosting uses Softaculous for quick and easy installations. This tutorial will walk you through adding the add-on domain and using the add-on domain within the Softaculous installation.</div>
					<div class='smallgrey'>Hits: 337</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/boldgrid/installing-boldgrid/site-hosted-elsewhere'>How to Use BoldGrid when your site is not hosted with InMotion Hosting</a>
					<div>This guide explains how to use the BoldGrid for Wordpress builder, when you are not hosted with InMotion Hosting.</div>
					<div class='smallgrey'>Hits: 384</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/boldgrid/installing-boldgrid/move-wordpress-folder'>Move WordPress folder</a>
					<div>There may be times when you need to move your WordPress installation folder.  This tutorial walks you through the steps for making this change of directory.</div>
					<div class='smallgrey'>Hits: 109</div>
				</td>
			</tr>
			</table>
</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD01MzYmaWQ9NTM2JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="eebeabc52a8853195a165d1132c9c8b0" value="1" />	</div>
	</form>
<!-- <br />
