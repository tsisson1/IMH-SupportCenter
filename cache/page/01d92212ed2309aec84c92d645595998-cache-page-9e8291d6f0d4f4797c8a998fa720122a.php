<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50407:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/premium-website-builder/google-analytics-code-disappears" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello DonnieC, and thanks for the question. In order to use the Google Analytics code with your Premium Website Builder site. You'd want to add the (Scr..." />
  <title>Google Analytics Code Disappears | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/premium-website-builder/google-analytics-code-disappears" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:cb0804bdca1b64dcf8b1e631a2238b76 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Google Analytics Code Disappears</h1>
		<div style='margin-bottom:20px; margin-top:10px; clear:both; color:#6e6e6e;'>Category: <a href='/support/community-support/premium-website-builder'>Premium Website Builder</a></div>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/donniec'>donniec</a>
			<div>21 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-10-22 11:55 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>574</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>After pasting Google analytics code on each page, the code disappears from all pages the next time I make any change to any page. I am using the Plesk Site Biuilder Zeug-13 template, but can't find it anywhere. Is there a master page or template page that will not be modified on which to place the GA code?<br />
Thanks,<br />
DonnieC</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_1755' id='upvote_answer_1755' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='1755' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_1755').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_1755' id='downvote_answer_1755' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='1755' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_1755').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>9,968 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2012-10-22 12:22 pm EST
                		        </div>
					
		                </div>

				Hello DonnieC, and thanks for the question.<br />
<br />
In order to use the Google Analytics code with your Premium Website Builder site. You'd want to add the (Script) module from the right-hand side-bar to each page that you have, with your GA JavaScript code entered into there.<br />
<br />
Unfortunately there is not a centralized template or master page that you can add this code to and have it propagated to all of your other pages. So this is something that would need to be done on each and every page that you wish to track.<br />
<br />
I see currently that you have this code placed on your (index.php) and (Home.php) pages, are you manually going in and adding the code after publishing from the Premium Web Builder? Or are you utilizing the script module already? If you're using the script module from within the Premium Web Builder then it should be staying put on edits to that page, so long as you aren't removing that module.<br />
<br />
Please provide us with some further information such as what pages the code seems to go missing from if this didn't exactly answer your question, so that we can provide you with a better explanation.<br />
<br />
- Jacob
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_1755').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_1755' id='form_comment_on_answer_1755' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/premium-website-builder/google-analytics-code-disappears&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/premium-website-builder/google-analytics-code-disappears'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="943197e49ae6c6c49c485166a70532aa" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
                                ...
                                <h3>Related Articles</h3><a target='_blank' href='http://inmotionhosting.com/support/builder-video-tutorial'>Video Tutorial on How to Use the Builder to Build a Website</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/faq-adding-image-builder'>FAQ: Adding Images or Graphics in the Builder</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/understanding-image-gallery-builder'>Understanding the Image Gallery in the Builder</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/dealing-with-comment-spam-builder'>Dealing with comment spam</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/changing-page-file-names-builder'>Changing the Page and File names in the Builder</a><br/><br />
		</div>
