<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:60118:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/send-email-from-a-page/how-can-i-prevent-xsource-and-xphpscript-email-headers" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hi, I have 100% solution for disable X-AntiAbuse and X-Get-Message-Sender. Step 1: Login as ROOT with PuTTY Step 2: type nano /etc/exim.pl.local Demo: h..." />
  <title>How can I prevent X-Source and X-PHP-Script email headers? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/send-email-from-a-page/how-can-i-prevent-xsource-and-xphpscript-email-headers" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:85495dde11a72495fc3cb80732741f71 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>How can I prevent X-Source and X-PHP-Script email headers?</h1>
		<div style='margin-bottom:20px; margin-top:10px; clear:both; color:#6e6e6e;'>Category: <a href='/support/community-support/send-email-from-a-page'>Send Email From A Page</a></div>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/michaelv8'>michaelv8</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-02-06 5:20 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>10,309</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Hi,<br />
Recently I noticed that all the mails sent via my website include a lot of headers that look like a (potential) security risk to me. You can find the full header below, the tags that concern me are: X-PHP-Script, X-Source, X-Source-Args, X-Source-Dir<br />
These tags include the full path of my home folder, path to php binary etc.<br />
<br />
How can I remove/change these headers?<br />
<br />
...
Michael<br />
<br />
X-PHP-Script: www.my-website.com/index.php for 12.34.56.78<br />
From: My Website <br />
Reply-To: My Website <br />
Date: Sun, 05 Feb 2012 11:30:15 +0100<br />
X-LibVersion: 3.3.2<br />
MIME-Version: 1.0<br />
Content-Type: text/html; charset=iso-8859-1; format=flowed<br />
Content-Transfer-Encoding: 8bit<br />
Message-ID: <br />
X-AntiAbuse: This header was added to track abuse, please include it with any abuse report<br />
X-AntiAbuse: Primary Hostname - ecbiz115.inmotionhosting.com<br />
X-AntiAbuse: Original Domain - gmail.com<br />
X-AntiAbuse: Originator/Caller UID/GID - [1645 32007] / [47 12]<br />
X-AntiAbuse: Sender Address Domain - ecbiz115.inmotionhosting.com<br />
X-Source: /usr/bin/php<br />
X-Source-Args: /usr/bin/php /home/my_username/public_html/index.php <br />
X-Source-Dir: my-website.com:/public_html</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_530' id='upvote_answer_530' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='530' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_530').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_530' id='downvote_answer_530' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='530' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_530').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hi michaelv8,<br />
<br />
I was aware of those headers, but wasn't exactly sure what or why they were there. After some research, it appears that those headers are added by the server to help document where the email is originating from. For example, if a user's account was compromised and someone was sending large amounts of spam from PHP, you could look at the email headers to determine where on the server the email was originating from.<br />
<br />
&lt;strong&gt;What is adding the X-Source and X-PHP-Script headers?&lt;/strong&gt;<br />
If you're using the php mail() function, those headers are automatically added by our server. If you use a class, such as &lt;a href='http://www.inmotionhosting.com/support/email/send-email-from-a-page/using-phpmailer-to-send-mail-through-php' target='_blank'&gt;phpMailer&lt;/a&gt;, those headers are not actually sent.<br />
<br />
&lt;strong&gt;Can I disable these headers / what is the solution?&lt;/strong&gt;<br />
For security purposes, we have enabled these headers to help track down spam originating from our servers. Because of this, the headers will not be toggled on/off on the shared platform. If you are on a VPS or Dedicated server, you can &lt;a href='http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support' target='_blank'&gt;contact our Support Department&lt;/a&gt; and request to have this feature disabled for your server.<br />
<br />
If you are on the shared environment and are worried about these headers, we suggest that you look into using something other than the php mail() function to send email. If you are using 3rd party software, such as WordPress or Joomla, usually they have an option to change how email is sent from the server (the alternative would be to send email using &quot;SMTP Authentication&quot;). If you are writing the code yourself, you can reference the phpMailer link above to learn more on using the phpMailer class. If you have any questions on how to use it, please feel free to ask!<br />
<br />
I hope this helps! Please let us know if we can assist further.<br />
<br />
Thanks!<br />
- Brad
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_530').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_530' id='form_comment_on_answer_530' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>But doesn't phpMailer use the mail() function?</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='/support/images/avatars/default_avatar.jpg' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/jghomestead'>jghomestead</a><br />
...
<div class=' straight_bottom not_best_answer'>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px; width:50px;' valign='top'>
<div class='vote_div'>
	<form method='post' name='upvote_answer_7485' id='upvote_answer_7485' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='7485' />
		<input type='hidden' name='component' id='component' value='qa' />
		<input type='hidden' name='vote_value' id='vote_value' value='1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_7485').submit();"></div>
	</form>
	<div class='vote_sum'>1</div>
	<form method='post' name='downvote_answer_7485' id='downvote_answer_7485' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='7485' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_7485').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					<img src='https://lh5.googleusercontent.com/-n6MdsvIRBHI/AAAAAAAAAAI/AAAAAAAAAOw/gnP544zY1B4/photo.jpg?sz=90' class='user_avatar' style='max-width:60px;' /><br />
                		        <a href='/support/community-support/users/ExtraApps'>ExtraApps</a>
				...
				Hi,<br />
<br />
I have 100% solution for disable X-AntiAbuse and X-Get-Message-Sender.<br />
<br />
Step 1: Login as ROOT with PuTTY<br />
Step 2: type nano /etc/exim.pl.local<br />
<br />
Demo: http://snag.gy/neoVc.jpg<br />
<br />
Step 3: Press Enter, After open exim.pl.local file. Click CTRL+W for search.<br />
<br />
Demo: http://snag.gy/G9poT.jpg<br />
<br />
Step 4: Type &quot;Abuse&quot; and press enter to search.<br />
Step 5: Then you can see X-AntiAbuse Headers like below..<br />
<br />
Demo: http://snag.gy/wWMaj.jpg<br />
<br />
Step 6: Just add a line above &quot;my $headers = &quot; like bellow and change old &quot;my $headers = ..&quot; to &quot;my $headers_clear = ..&quot;<br />
<br />
Change and Add like below<br />
<br />
my $headers = &quot;&quot;;<br />
my $headers_clear =<br />
<br />
Demo: http://snag.gy/cketX.jpg<br />
<br />
Step 7: After done, above like, Press CTRL+X for save and Press &quot;Y&quot; for Confirm after finally press &quot;Enter&quot; for Save and Exit.<br />
<br />
Now, Try a Test Email. Where No X-AntiAbuse Headers.<br />
<br />
Result like: http://snag.gy/eeVFR.jpg
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_7485').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_7485' id='form_comment_on_answer_7485' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
					                <p>You must <a href='/support/login'>login</a> before you can post a comment about this answer.</p>
					        </div></div></div></div>
					</form>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Isn't that gonna cause some email provider/recipients to reject your email due to the &quot;anti-spam&quot; headers being missing? I understand about not wanting the &quot;X-Source-Args&quot; and other items that list private information. <br />
</div>
							...
							<td style='width:96px;' valign='top'>
								<img src='/support/images/avatars/default_avatar.jpg' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/kleehsupport'>kleehsupport</a><br />
...
Arnel C.</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/send-email-from-a-page/how-can-i-prevent-xsource-and-xphpscript-email-headers&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/send-email-from-a-page/how-can-i-prevent-xsource-and-xphpscript-email-headers'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="ecb50419d0ff9b326fd98a6bbe29655e" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
                                ...
                                <h3>Related Articles</h3><a target='_blank' href='http://inmotionhosting.com/support/download-phpmailer'>Download PHPMailer</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/why-wont-my-php-app-send-mail'>Why won't my PHP app send mail?</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/how-to-set-up-formmail'>How to set up FormMail</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/using-phpmailer-to-send-mail-through-php'>Using phpMailer to Send Mail through PHP</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/how-to-send-email-from-a-web-page'>How to send email from a web page</a><br/><br />
		</div>
