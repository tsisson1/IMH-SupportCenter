<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49099:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/opencart/installing-opencart-and-adding-products" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="In our first OpenCart class, we'll show you how to install OpenCart and add your first products." />
  <title>101: Installing OpenCart and Adding Products | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/opencart/installing-opencart-and-adding-products" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:8fba73ed44b1f6ee9f2ddc1179b733f4 -->
...
<div class='page-header'>
	<h1>101: Installing OpenCart and Adding Products</h1>
</div>
<div class='section_listing'>
		...
		<tr>
				...
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/opencart/installing-opencart-and-adding-products/installing-open-cart-with-softaculous'>Installing Open Cart with Softaculous</a>
					<div>You can install Open Cart easy with Softaculous. This article will show you how.</div>
					<div class='smallgrey'>Hits: 6,440</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/opencart/installing-opencart-and-adding-products/installing-opencart-manually'>Installing OpenCart Manually</a>
					<div>In this tutorial, learn how to manually install OpenCart, a free shopping cart program that will help you create an online store. </div>
					<div class='smallgrey'>Hits: 18,587</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/opencart/installing-opencart-and-adding-products/dashboard-login'>How to Login to the OpenCart 1.5 Dashboard</a>
					<div>This is a walk-through guide on logging into the Admin Dashboard for OpenCart.</div>
					<div class='smallgrey'>Hits: 28,647</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/opencart/installing-opencart-and-adding-products/configuring-the-general-settings-in-opencart'>Configuring the general settings in OpenCart</a>
					<div>In this tutorial, we'll show you how to configure the general settings for your OpenCart installation.</div>
					<div class='smallgrey'>Hits: 11,928</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/opencart/installing-opencart-and-adding-products/removing-categories-for-products-in-opencart'>Removing Categories for Products in OpenCart</a>
					<div>In this tutorial, we'll show you how to remove the default categories set up in OpenCart so you can start adding your own.</div>
					<div class='smallgrey'>Hits: 8,657</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/opencart/installing-opencart-and-adding-products/adding-product-categories-in-opencart'>Adding Product Categories in OpenCart 1.5</a>
					<div>In this tutorial we'll show you how to add new product categories so your visitors can find products that you group together.</div>
					<div class='smallgrey'>Hits: 19,715</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/opencart/installing-opencart-and-adding-products/removing-products-from-opencart'>Removing Products from OpenCart</a>
					<div>In this tutorial, we'll show you how to remove your default products in your OpenCart shopping cart.</div>
					<div class='smallgrey'>Hits: 9,181</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/opencart/installing-opencart-and-adding-products/adding-new-products-to-opencart'>Adding New Products to OpenCart</a>
					<div>This tutorial will show you how to add new products to your OpenCart shopping cart.</div>
					<div class='smallgrey'>Hits: 11,499</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/opencart/installing-opencart-and-adding-products/listing-your-products-manufacturers-in-opencart'>Listing your Product's Manufacturers in OpenCart</a>
					<div>In this tutorial, we'll explain what manufacturers are in OpenCart and how you can use them to further categorize your products.</div>
					<div class='smallgrey'>Hits: 10,829</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-bottom:10px;'>
					...
					<div>In this tutorial, you will learn how to update the information pages listed in the footer of your OpenCart website.</div>
			...
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/opencart/installing-opencart-and-adding-products/setting-up-shipping-options-in-opencart'>Setting up Shipping Options in OpenCart</a>
					<div>Learn how to configure shipping options in OpenCart.</div>
					<div class='smallgrey'>Hits: 12,750</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/opencart/installing-opencart-and-adding-products/setting-up-options-in-opencart'>Setting up Options in OpenCart</a>
					<div>in this tutorial we'll show you how to add global options to use on products in OpenCart.</div>
					<div class='smallgrey'>Hits: 13,758</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/opencart/installing-opencart-and-adding-products/adding-options-to-products-in-opencart'>Adding Options to Products in OpenCart</a>
					<div>In this article, we will show you how to add options to a specific product in OpenCart.</div>
					<div class='smallgrey'>Hits: 34,743</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/opencart/installing-opencart-and-adding-products/related-products-open-cart'>How to add Related Products in OpenCart:</a>
					<div>OpenCart has a great related product feature. This article will explain how to add related products.</div>
					<div class='smallgrey'>Hits: 8,389</div>
				</td>
			</tr>
			</table>
</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xNTAmaWQ9MTUwJnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
