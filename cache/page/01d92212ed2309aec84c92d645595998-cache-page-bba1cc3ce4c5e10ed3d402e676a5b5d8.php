<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:58322:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/smf/forum-management/bbcode-settings" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-12-21T18:12:09-08:00" />
  <meta name="keywords" content="BBC BBCode Bulletin Board Code settings SMF 2.0" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="In this SMF 2.0 guide, we introduce you to Bulletin Board Code settings." />
  <title>Editing your SMF 2.0 Bulletin Board Code settings - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/smf/forum-management/bbcode-settings" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:82d194a244f326c448fce25c23d5d0cf -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Editing your SMF 2.0 Bulletin Board Code settings									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>2,429</span></div>
							...
							<div style='clear:both;'></div>
								...
								<p>When setting up your site, you have a lot of control over what tags and codes you allow your members to use. You may want to allow them to use BBC, also known as Bulletin Board Code. Additionally, you may or may not want them to use HTML in their posts. This can be for design reasons, or to keep users from abusing the code. Whatever you decide, the steps below will guide you in how to set them in your SMF 2.0 website.</p>
<h2>How to edit Bulletin board Code settings</h2>
<ol class="article_list">
	...
	<li>This brings you to the <em>Posts and Topics</em> screen. From the page menu, click on the <strong>Bulletin Board Code</strong> option.</li>
	<li>You are now on the <em>Bulletin Board Code Settings</em> page. From here you will be able to configure your desired <em>BBCode</em> settings.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/smf/forums/bbcode-settings/bbcode-settings.png"><img  alt="list of bulletin board code settings" src="//cdn.inmotionhosting.com/support/images/stories/edu/smf/forums/bbcode-settings/bbcode-settings.png" /></a><br />
		<table class="article_table">
			<tbody>
				<tr>
					<th>Enable bulletin board code (BBC)</th>
					<td>Enable the ability to use BBCode in posts.</td>
				</tr>
				<tr>
					<th>Enable <em>basic</em> HTML code in posts</th>
					<td>Enables the use of a few HTML tags</td>
				</tr>
				<tr>
					<th>Automatically link posted URLs</th>
					<td>Automatically creates links for URLS in posts.</td>
				</tr>
			</tbody>
		</table>
		<p>At the bottom of the page is a list of the BBCode tags that are allowed. You can enable or disable each tag individually.</p>
		<table class="article_table">
			<tbody>
				<tr>
					<th>abbr</th>
				...
				<tr>
					<th>glow</th>
					<td>produces glow effect on text</td>
				</tr>
				<tr>
					<th>green</th>
					<td>green text</td>
				...
				<tr>
					<th>iurl</th>
					<td>makes link that opens in the same window</td>
				</tr>
				<tr>
					<th>left </th>
					<td>left align</td>
				...
				<tr>
					<th>list</th>
					<td>inserts item in a list</td>
				</tr>
				<tr>
					<th>ltr</th>
					<td>sets text direction left to right</td>
				</tr>
				<tr>
					<th>move</th>
					<td>marquee effect</td>
				</tr>
				<tr>
					<th>nobbc</th>
					<td>turns off BBCode</td>
				</tr>
				<tr>
					<th>pre</th>
				...
				<tr>
					<th>rtl</th>
					<td>sets text direction from right to left</td>
				</tr>
				<tr>
					<th>shadow</th>
					<td>creates shadow effect on text</td>
				</tr>
				<tr>
					<th>size</th>
					<td>set text size</td>
				...
				<tr>
					<th>url</th>
					<td>makes links that open in a new window</td>
				</tr>
			</tbody>
		</table></li>
  <li>Once you have made adjustments to the settings, click the <strong>Save</strong> button at the bottom to save your configuration.</li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 5: Editing your SMF 2.0 Bulletin Board Code settings</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 4: <a href='/support/edu/smf/forum-management/topic-settings'>How to modify your SMF 2.0 Topic settings</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 6: <a href='/support/edu/smf/forum-management/censored-words'>How to configure your SMF 2.0 censored words list</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/smf/forum-management/bbcode-settings&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/smf/forum-management/bbcode-settings'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMDgmaWQ9MjEwOCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
