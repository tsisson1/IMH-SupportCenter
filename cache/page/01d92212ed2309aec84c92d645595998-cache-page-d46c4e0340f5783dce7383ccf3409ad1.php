<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:61739:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/wordpress/get-post-wordpress-function" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-09-02T21:36:33-07:00" />
  <meta name="author" content="Jeff Matson" />
  <meta name="description" content="In this article, we will show you the get_post() function that can be used to show post information within your WordPress plugins and themes." />
  <title>The get_post() WordPress function - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/wordpress/get-post-wordpress-function" rel="canonical" />
...
<script>
  ...
  ga('send', 'pageview');
	...
	<!-- cid:de104d86bfcdde4eba60236dae02e80d -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '185.59.124.18']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>The get_post() WordPress function</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															The get_post() WordPress function									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>6,717</span></div>
							...
							<div style='clear:both;'></div>
								...
								<p>The <em>get_post()</em> WordPress function is one of the most important functions within WordPress.  It allows you to get the post content or other information regarding the post easily.  In this article, we will introduce you to how you can use the <em>get_post()</em> function to display post data in your plugin or theme.</p>
...
<h2>Basic usage</h2>
<p class="code_block">&lt;?php get_post( $id, $output, $filter ); ?&gt;</p>
<h3>Parameters</h3>
<p><strong>$id</strong>: This optional parameter allows you to define the ID of the post that you would like to gather information from.  By default, it will get the current post.</p>
<p><strong>$output</strong>: By default, it will return a WP_Post object.  If you would like an associative or numeric array of field values instead, you may define either <em>ARRAY_A</em> or <em>ARRAY_N</em>.</p>
<p><strong>$filter</strong>: Here, you can optionally sanitize the post fields.  This parameter defaults to <em>raw</em> which will not filter the content at all.  Optional values are <em>raw</em>, <em>edit</em>, <em>db</em>, <em>display</em>, <em>attribute</em> or <em>js</em>.</p>
<h2>What is returned?</h2>
<p>The <em>get_post()</em> function returns a WP_Post object.  The variables that can be defined are the following:</p>
<ul class="article_list">
    <li><p>ID</p></li>
    <li><p>post_author</p></li>
    <li><p>post_name</p></li>
    <li><p>post_type</p></li>
    <li><p>post_title</p></li>
    <li><p>post_date</p></li>
    <li><p>post_date_gmt</p></li>
    <li><p>post_content</p></li>
    <li><p>post_excerpt</p></li>
    <li><p>post_status</p></li>
    <li><p>comment_status</p></li>
    <li><p>ping_status</p></li>
    <li><p>post_password</p></li>
    <li><p>post_parent</p></li>
    <li><p>post_modified</p></li>
    <li><p>post_modified_gmt</p></li>
    <li><p>comment_count</p></li>
    <li><p>menu_order</p></li>
</ul>
<p>For example, we could use the <em>get_post()</em> function to get the author of the post and display it in the following code:</p>
<p class="code_block">&lt;?php<br/>
$post_author = get_post();<br/>
echo $post_author-&gt;post_author;<br/>
?&gt;</p>
<h2>Resources</h2>
<p>You may find more information on the <em>get_post()</em> function on the <a href="http://codex.wordpress.org/Function_Reference/get_post" target="_blank"><em>get_post</em> WordPress Codex page</a>.</p>
...
<div style='display:inline-block;'>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD02MyZpZD0zMzMzJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
