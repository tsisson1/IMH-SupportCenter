...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/general-information/i-want-my-vps-to-be-upgraded-to-the-latest-cento" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello technics, Thank you for your question on a Centos upgrade for your VPS. This would need to be a request sent to our Live Support team. They will b..." />
  <title>I want my VPS to be upgraded to the latest Cento | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/general-information/i-want-my-vps-to-be-upgraded-to-the-latest-cento" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:60f5fd2d5a975a63306926049f374afd -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>I want my VPS to be upgraded to the latest Cento</h1>
		<div style='margin-bottom:20px; margin-top:10px; clear:both; color:#6e6e6e;'>Category: <a href='/support/community-support/general-information'>General Information</a></div>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/technics'>technics</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-11-08 8:12 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>87</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Currently my VPS is on Centos 5.11. I want to upgrade to the Centos latest version<br />
Thanks</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_8483' id='upvote_answer_8483' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='8483' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_8483').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_8483' id='downvote_answer_8483' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='8483' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_8483').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello technics,<br />
<br />
Thank you for your question on a Centos upgrade for your VPS.  This would need to be a request sent to our <a href="http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support">Live Support</a> team. They will be able to tell you how they can upgrade Centos for you.<br />
<br />
Kindest Regards,<br />
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_8483').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_8483' id='form_comment_on_answer_8483' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/general-information/i-want-my-vps-to-be-upgraded-to-the-latest-cento&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/general-information/i-want-my-vps-to-be-upgraded-to-the-latest-cento'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="84b69be011f705175f39cb6cc8c56e98" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
                                ...
                                <h3>Related Articles</h3><a target='_blank' href='http://inmotionhosting.com/support/ip-address-change-info'>My IP address has changed, what do I do?</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/using-the-under-construction-page-imh'>Using the Under Construction Page provided by InMotion Hosting</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/copy-all-mail-to-a-email-address-in-exim'>Copy all mail to a email address in Exim</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/third-party-mx'>Changing MX records to point to InMotion servers from third party DNS</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/microsoft-exchange-server'>Microsoft Exchange Servers and your cPanel Hosting Account</a><br/><br />
		</div>
