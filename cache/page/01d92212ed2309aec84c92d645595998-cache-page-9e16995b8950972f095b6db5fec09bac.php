<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:105165:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/website-transfers/migrate-your-website-another-host-uses-cpanel" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-05-11T18:22:45-07:00" />
  <meta name="keywords" content="website migration moving website cpanel" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="In this article we will explain how to migrate your website FROM another host that uses cPanel to InMotion Hosting." />
  <title>How to migrate your website FROM another host that uses cPanel TO InMotion Hosting - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/website-transfers/migrate-your-website-another-host-uses-cpanel" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:a60649002a8a89ca7805865c767348e6 -->
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/website/website-transfers' itemprop='url'><span itemprop='title'>Website Transfers<span></a><div class='dropdown_3columns'><div class='col_3'><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/website-transfers/upload-website-files'>Upload your website files</a> (2736 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/website-transfers/download-website-files-from-previous-host'>Download a copy of your website files</a> (2458 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/website-transfers/update-configuration-file-with-database-settings'>Update configuration file with your new database settings</a> (2254 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/website-transfers/creating-a-full-cpanel-backup-at-your-previous-host'>Creating a full cPanel Backup at your previous host</a> (1539 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/website-transfers/upload-your-full-cpanel-backup-to-inmotion-hosting'>Upload your full cPanel backup to InMotion Hosting</a> (1421 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/website-transfers/download-database-previous-host'>Download a copy of your database</a> (1312 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/website-transfers/email-tech-support-to-restore-a-full-cpanel-backup'>Email Tech Support to restore a full cPanel Backup</a> (1222 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/website-transfers/restore-copy-of-database'>Restore a copy of your database</a> (881 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/website-transfers/what-you-need-to-know-about-your-email-when-transferring-your-website'>What you need to know about your email when transferring your website</a> (850 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/website-transfers/create-a-blank-database'>Create a blank database</a> (844 hits)</div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to migrate your website FROM another host that uses cPanel TO I...</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to migrate your website FROM another host that uses cPanel TO InMotion Hosting									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>55,555</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Aug 24, 2011'><span style='color:#606060;'>Published:</span> May 11, 2016</div>
...
<p>
  <i>Please note that restoring a cPanel account wipes out the files currently loaded on that account. Additionally, it is not possible to restore multiple cPanel backups to a shared server account.  A shared server account can only hold one cPanel account at a time. </i>  
</p>
</div>

<div>This article will assist you with migrating your website from another hosting company that uses cPanel to InMotion Hosting. Please see our link if you are interested in learning more about our <a href="http://www.inmotionhosting.com/shared-cpanel-hosting">cPanel Hosting</a> options.</div>
<h1>Evaluate your Site</h1>
<div>If your previous hosting company uses cPanel, the website migration process will be much easier than if not. InMotion Hosting uses cPanel, and cPanel includes an excellent backup tool that will backup your entire account (including website files, emails, and databases). If you're cPanel account is under 3GB, please continue reading to learn more. If your account is over 3GB in size, you will want to migrate your website following the steps found here:</div>
<p> </p>
<div><a href="/support/website/how-to/migrate-website-from-another-host">How to migrate your website FROM another host TO InMotion Hosting</a></div>
<p> </p>
<div>You can find your cPanel account size by logging into your cPanel and looking in the left menu under "<em>Disk Space Usage</em>".</div>
<div></div>
<div></div>
<div></div>
<h1>Generate a cPanel Backup</h1>
<div>To generate a cPanel backup, follow the steps in this tutorial:</div>
<div><a href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-file-manager/complete-cpanel-backup">Backup your cPanel</a></div>
<h1>Download your cPanel Backup</h1>
<div>After you have generated a backup, download the backup file to your desktop using FTP. For more help with using FTP, please see: <a href="/support/website/file-management/getting-started-guide-ftp">Getting Started Guide: FTP</a></div>
<div></div>
<div></div>
<div></div>
<h1>Upload your cPanel Backup to your InMotion Hosting account</h1>
<div>Using FTP, upload the cPanel Backup to your InMotion Hosting account. Refer to the<a href="/support/website/file-management/getting-started-guide-ftp"> FTP Getting Started Guide</a> above for more help with using FTP to upload files.</div>
<div></div>
<div></div>
<div></div>
<h1>Request for your cPanel Backup to be restored</h1>
<div>After you have uploaded your cPanel Backup, email <a href="mailto:support@inmotionhosting.com">support@inmotionhosting.com</a> and request that we restore this backup for you. When you email, include for verification purposes either your original cPanel account password, the current AMP password, or the last four digits of the current credit card that we have on your account.</div>
<div></div>
<h1>Test your site</h1>
<div>
<p>Once we respond and let you know your backup has been restored you will want to test your site to make sure everything is working properly. If you have not yet pointed your domain to our Nameservers, you can test your site through either your <a href="/support/website/how-to/using-your-temporary-url">Temporary URL</a> or by making a <a href="/support/website/how-to/modifying-your-hosts-file">hosts file modification</a>.</p>
</div> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/website-transfers/migrate-your-website-another-host-uses-cpanel&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/website-transfers/migrate-your-website-another-host-uses-cpanel'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NDMmaWQ9MTU3JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support//?tsrc=rsbraq'>Looking to move to inMotion</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/1e32d9ee4611e7760e1926cb11cccd8b?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/1e32d9ee4611e7760e1926cb11cccd8b'>Jeremy</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-26 2:38 am</div>
				                <div><p>May I know the typical response times for such migration? I have uploaded the Cpanel backup and would like to know when it would be restored? As the site is a live site, it is important for InMotion to expedite the case, as I have let the customer support know. However, it has been two hours and no response form the InMotion team. Thanks!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16732);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-27 9:40 am</div>
				                <div>Hello Jeremy,<br />
<br />
Thank you for contacting us. All requests to Live Support are answered in the order received, so it depends how many request they have at that given time.<br />
<br />
Also, the size of the files they are restoring can affect the time it takes to complete.<br />
<br />
Since this is just the public forum, I recommend contacting <a href="http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support">Live Support</a> for more account-specific information.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16765);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-17435'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/9ca3ebf1c19fe82abf44b1121b0b1c73?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/9ca3ebf1c19fe82abf44b1121b0b1c73'>Russ Archer</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-14 3:20 pm</div>
				                <div>Since I'm not a customer (I am looking for a new host site and am considering yours) , I am not sure what an AMP password is. I'm guessing that it is the cpanel password on your system. Right?</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17435);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-28 11:39 am</div>
				                <div>Helo Russ,<br />
<br />
Thank you for your question. <a href="http://www.inmotionhosting.com/support/website/amp/amp-vs-cpanel">AMP</a> stands for the Account Management Panel, and it is where you can reset passwords, view/change billing information, submit tickets, etc.<br />
<br />
When you sign up with us, you will receive an <em>AMP login email</em> which lets you access your account including cPanel.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17916);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-17880'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/f40e08a95c2b567e5256c0ac0af3512b?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/f40e08a95c2b567e5256c0ac0af3512b'>Murray</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-27 12:36 am</div>
				                <div><p>I intend to do a Cpanel to Cpanel migration however I want to have a new root domain at inmotion and have set up the new root domain name.&nbsp; This root domain name is an existing site at my old host. If doing a CP to CP migration at what stage can this change be taken into account?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17880);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-28 11:44 am</div>
				                <div>Hello Murray,<br />
<br />
Thank you for your question. After you have tested your website successfully using the <a href="http://www.inmotionhosting.com/support/website/how-to/using-your-temporary-url">Temp URL</a>, or a <a href="http://www.inmotionhosting.com/support/website/how-to/modifying-your-hosts-file">Host File Modification</a>, it should be safe to <a href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/updating-your-domains-nameservers">switch the DNS</a> over to us.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17917);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-22024'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/7fd9676723ab4c2c236e3e971538a13d?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/7fd9676723ab4c2c236e3e971538a13d'>Ayodeji Agboola</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-25 1:11 pm</div>
				                <div><p>Hello, I just bought a reseller account on inmotion. Does what is covered here deal with multiple sites movement from my old reseller account? It seems this only addresses single websites. Is there a way to move all sites from a cpanel reseller to my new inmostion reseller? Thank you.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22024);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-26 1:49 pm</div>
				                <div>Hello Ayodeji,<br />
<br />
Thanks for the question.  Unfortunately, only the technical support team here could do a mass migration to reseller accounts.  It's not possible from the user standpoint at this time.  <br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22071);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-26338'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/6694322bc96844ab6fa19c5dc5b836e0?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/6694322bc96844ab6fa19c5dc5b836e0'>piyush trivedi</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-03 12:37 pm</div>
				                <div><p>Please tell me if i take cpanel backup then doest it contain database backup also .&nbsp; if i install cpanel backup to u r hosting will this restore my entire database . i have 5 website running in my current host and i wanna transfer those sites form there.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26338);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-03 1:44 pm</div>
				                <div>Hello piyush,<br />
<br />
Thank you for contacting us. Yes, if you perform a <a href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-file-manager/backing-up-your-cpanel">Full cPanel backup</a>, it will include all the site files, and databases.<br />
<br />
If you have any further questions, feel free to post them below.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26341);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-27061'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/41f94259afb19104edf31983a123f0d4?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/41f94259afb19104edf31983a123f0d4'>Mark Ingram</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-29 9:59 pm</div>
				                <div><p>I understand that my hosting account allows me to host more than one domain. Please tell me how to do that.</p>
<p>&nbsp;</p>
<p>Thanks,</p>
<p>Mark</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27061);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-30 12:33 pm</div>
				                <div>Hello Mark,<br />
<br />
Thanks for the question about using multiple domains. You would first have to register the domain, then have it point to our hosting service.  Then you could add it as an add-on domain.  Check out this <a href="http://www.inmotionhosting.com/support/domain-names/registrations-and-transfers/add-another-domain-name-account">tutorial</a> for more details.<br />
<br />
If you have any further questions or comments, please let us know.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27086);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-27155'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/2404bf08a9beb69970f177eac76f6ace?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/2404bf08a9beb69970f177eac76f6ace'>Cam Hui</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-01 9:21 pm</div>
				                <div><p>Two questions:</p>
<p>1) I am a new client and I am just trying to find my way around your site. When I signed up Wordpress was installed for me. How do I access the Wordpress panel from CPanel and how can I tell what is "live" and what is in development mode in Wordpress?</p>
<p>2) I did a full CPanel backup from my previous service provider and I am ready to do a restore. However, the files that I brought over are Wordpress files that are only in development mode and not ready to go live. How do I make sure that when it is restored it doesn't show up on the live website?</p>
<p>Thank you.</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27155);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-02 2:52 pm</div>
				                <div>Hello Cam,<br />
<br />
Thank you for contacting us. Here is a link to our guide on how to <a href="http://www.inmotionhosting.com/support/edu/wordpress/wordpress-introduction/logging-into-wordpress-dashboard">Login to the WordPress Dashboard</a>.<br />
<br />
Everything by default is Live and accessible, you can <a href="http://www.inmotionhosting.com/support/website/protecting-files/how-do-i-password-protect-a-directory-in-my-control-panel-cpanel">password protect</a> the WordPress folder to make it unavailable to the public.<br />
<br />
If you do a full cPanel restore, it will <strong>overwrite</strong> all existing files in your cPanel. You can <a href="http://www.inmotionhosting.com/support/website/protecting-files/how-do-i-password-protect-a-directory-in-my-control-panel-cpanel">password protect</a> the files after they are restored, to make them inaccessible.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27186);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-28441'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/266997fb546d4cdcfdf17f7b787659f5?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/266997fb546d4cdcfdf17f7b787659f5'>Swati</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-16 3:49 am</div>
				                <div><p>Hello... how can i configure source code of &nbsp;livesite on our localhost appache server. &nbsp;advanced thank u very much for providing me solution.</p>
<p>&nbsp;</p>
<p>With Warm Regards</p>
<p>swati</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28441);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						...
						<div><a style='font-size:16px;' href='/support/community-support/users/Ksvendlund'>Ksvendlund</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-02-09 3:51 pm</div>
				                <div>Hi, I'm ready to upload the backup using FTP but what folder should it be uploaded to? It does not say in the guide above.<br />
Can the restore functionality under the backup tab not be used to restore a full site backup?</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30444);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-02-09 7:29 pm</div>
				                <div>You can upload the backup your home directory or public_html, whichever you prefer. Just let us know where you decide and we can take it from there. I'm not sure what you mean by "backup tab"?</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30448);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-02-10 3:25 am</div>
				                <div>That is great thanks. I'll do that.<br />
By the &quot;Backup tab&quot; I mean the place in cPanel where you do the Backups, it's in the files section. I see now that there is a difference between &quot;Full Backup&quot; and &quot;Home Directory Backup&quot;.  So to answer my own question - I cannot restore the full backup from the cPanel backup section, this has to be done by an admin.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30454);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-02-10 8:58 am</div>
				                <div>You are correct, full cPanel backups must be restored by us. Customers do not have the ability to. </div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30456);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
