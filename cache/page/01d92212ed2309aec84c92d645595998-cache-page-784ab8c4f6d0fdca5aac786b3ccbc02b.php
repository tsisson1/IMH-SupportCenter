...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-3/create-template/css-login-form" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-10-14T20:29:28-07:00" />
  <meta name="keywords" content="joomla 3.0 login form css" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="Now that we've created our basic template, we will begin adding CSS to our css/style.css file to help make modules stand out. We will first update the login form." />
  <title>Adding CSS to the Login Form in a Joomla 3.1 template - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-3/create-template/css-login-form" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:fa09deb1cd3f2b72649b772713211d49 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '105.184.138.79']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Adding CSS to the Login Form in a Joomla 3.1 template									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>23,876</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Oct 14, 2012'><span style='color:#606060;'>Published:</span> Oct 14, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>As we continue to <a href="/support/edu/joomla-3/create-template">create a Joomla 3.0 template</a>, the next task we will do is add a bit of style to it. Starting off, we'll focus on the login form.</p>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/create-template/before-adding-css-to-login-form.jpg"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="before-adding-css-to-login-form" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/create-template/before-adding-css-to-login-form.jpg" /></a>As you can see to the screenshot to the right, the login form is very bland. There is no background color to it, no border, and it does not stand apart from the rest of the items in the sidebar.</p>
<div style="clear: both;">&nbsp;</div>
<h2>Styling the Joomla 3.0 login form using CSS</h2>
<p>The Joomla 3.0 login form has an id of login-form. To add css to this form, you'll want to add a css declaration for #login-form.</p>
<ol class="article_list">
	<li><strong>Open css/style.css</strong><br /><br />Using your favorite text editor, in your template's folder, open css/style.css. Your css file may be different, but this is the name of the file we included in our template.</li>
	<li><strong>Add CSS for #login-form and then save the file</strong><br /><br />You can add any CSS that you would like for your login form, however we decided to give the form rounded corners with a grey background. Below is the CSS that we inserted into our css/style.css file:
		<pre class="code_block"><span style="color: #ff0000;"><strong>#login-form</strong></span> {<br />         -moz-border-radius: 5px;<br />         -webkit-border-radius: 5px;<br />         -khtml-border-radius: 5px;<br />         border-radius: 5px;<br />         background:#eee;<br />         border:1px solid #ccc;<br />         padding:5px;<br />         margin:0px 0px 10px 0px;<br />}</pre>
		<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/create-template/login-form-now-has-css.jpg"><img  alt="login-form-now-has-css" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/create-template/login-form-now-has-css.jpg" style="float: right; margin: 0px 0px 15px 15px;" /></a>After adding this code and saving the changes, you can see in the screenshot to the right how our Joomla 3.0 login form now has a bit more style to it.</p>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 11: Adding CSS to the Login Form in a Joomla 3.1 template</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 10: <a href='/support/edu/joomla-3/create-template/security-using-jexec'>Adding security to a Joomla 3.1 template using JEXEC</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 12: <a href='/support/edu/joomla-3/create-template/css-to-sidebar'>Adding CSS to sidebar items in a Joomla 3.1 template</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-3/create-template/css-login-form&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-3/create-template/css-login-form'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNzEmaWQ9MTg2MyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="e418a581ce1b96d23581bafe638c5d5e" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
        ...
        <tr><td colspan='2'><h4>Adding CSS and Style to the template</h4></td></tr>  <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>11.</td>
