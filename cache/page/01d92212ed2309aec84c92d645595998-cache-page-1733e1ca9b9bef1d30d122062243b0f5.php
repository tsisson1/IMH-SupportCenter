<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:57631:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/phpbb/manage-styles/install-theme" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-01-23T17:10:37-08:00" />
  <meta name="keywords" content="install theme template phpBB 3.0" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Customize your phpBB 3.0 forum community site by installing a theme." />
  <title>Installing a new template in phpBB 3.0 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/phpbb/manage-styles/install-theme" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:b852d3c484ba2138e8de3d9558fddc1b -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Installing a new template in phpBB 3.0									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 17, 2013'><span style='color:#606060;'>Published:</span> Jan 23, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>A new template, or theme, can give your website a completely new look. Templates help to individualize a site with colors, images, and icons that are different from the defaults. The following tutorial will guide you on how to install a new them for your phpbb 3.0 website.</p>
<ol class="article_list">
	<li>First you will want to find a new template. You can find many different designs at the <a href="https://www.phpbb.com/customise/db/styles-2" target="_blank">styles database</a>.</li>
	<li>Once you have the template zip file downloaded onto your computer, you will want to extract the file onto your computer. You may need a program sich as <em>7zip</em> or another file compression program to do this. Be sure to remember the location you extract the files to as you will need access to it later.</li>
	<li>Next, <a href="/support/website/file-management/getting-started-guide-ftp">using FTP</a>, you will need to upload the extracted folder to your /styles folder in your phpBB application. For instance, if your phpBB application is your website names example.com, then you will want to upload the template folder to the example.com/styles folder. We uploaded a folder named <em>ChesterBlue</em> as our test template.</li>
	<li>Once you have uploaded the template folder, <a href="/support/edu/phpbb/getting-started-phpbb/phpbb-login">log into your Administrative Control Panel</a>.</li>
	<li>Now that you are in the ACP, find and click on the <strong>Styles</strong> tab found in the row of tabs across the top of the page.<br /><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/phpbb/template/install/1-styles-tab.png"><img  alt="click on style tab" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/phpbb/template/install/1-styles-tab.png" /></a></li>
	<li>You will now be on the Styles main tab area. Look to the left hand sidebar menu and click on the <strong>Styles</strong> option under the <em>Style Management</em> category.<br /><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/phpbb/template/install/2-select-styles.png"><img  alt="click on styles option" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/phpbb/template/install/2-select-styles.png" /></a></li>
	<li>This takes you to a list of styles that display the installed and uninstalled themes. You will notice that the theme you just uploaded is in the list under the <em>Uninstalled Styles</em> category. You can see our test style <em>ChesterBlue</em> in the screenshot. Click on the <strong>Install</strong> link to continue. Note you may need to have another 'parent' style installed in order to install your selected style. In order to install our test template, we also had to ensure the default template <em>subsilver2</em> was installed beforehand. You will get an on-screen notice if you run into this problem.<br /><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/phpbb/template/install/3-find-template.png"><img  alt="find the template to install" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/phpbb/template/install/3-find-template.png" /></a></li>
	<li>Next, you will see a quick summary page about the style you are installing. Setting the <strong>Make Default Style</strong> to <strong>Yes</strong> will turn on the new template for your site. Leaving it set to <strong>No</strong> keeps the current style, but you can select your new style from the <em>Board Settings</em> in the <em>General Tab</em>. Below is a before and after shot using the ChesterBlue template as our test.<br /><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/phpbb/template/install/4-install.png"><img  alt="install new template" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/phpbb/template/install/4-install.png" /></a><br />
		<table class="article-table">
			<tbody>
				...
				<tr>
					<td><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/phpbb/template/install/new-template-before.png"><img style="max-width: 250px;"  alt="before the new template" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/phpbb/template/install/new-template-before.png" /></a>
					</td>
					<td><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/phpbb/template/install/new-template-after.png"><img style="max-width: 250px;"  alt="after new template install" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/phpbb/template/install/new-template-after.png" /></a>
					</td>
				</tr>
			</tbody>
		</table></li>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 1: Installing a new template in phpBB 3.0</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 2: <a href='/support/edu/phpbb/manage-styles/remove-footer'>How to Remove Powered by phpBB in phpBB 3.R</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/phpbb/manage-styles/install-theme&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/phpbb/manage-styles/install-theme'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMTgmaWQ9MjE4NiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="996e417443c6840bdc3e78820c6d260b" value="1" />	</div>
	</form>
<!-- <br />
