<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:59319:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-email/edit-mx-remote-local" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-03-27T14:43:21-07:00" />
  <meta name="keywords" content="remote mail settings cpanel Mx records" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="This article guides you on how to set your MX records to remote mail settings in cPanel." />
  <title>Setting domain MX records to remote settings in cPanel - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-email/edit-mx-remote-local" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:0b9f8b7cc7aed66c45d24d5de5459a62 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '173.162.101.22']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Setting domain MX records to remote settings in cPanel									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>25,283</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Aug 3, 2012'><span style='color:#606060;'>Published:</span> Mar 27, 2015</div>
							...
							<div style='clear:both;'></div>
								...
								<p>MX records (short for mail exchanger records) are DNS (Domain Name System) resources that specify a server that will be handling your email for your domain. When working with the default settings, you will likely never need to adjust your MX records settings on your server. Some people have an external DNS manager that has the domain name looking here, but the MX records pointing elsewhere. This is perfect for the vast majority of instances.</p>
<p>However, if someone from the very same server sends an email to this domain, there can be an issue if the MX records are not set to Remote, despite the fact the mail is not even handled here. The servers always check themselves first and if it sees a domain name here, will attempt an email delivery if the MX record is not set to look remotely. Everyone that has an external DNS and MX setup will need to perform this to prevent this occurence. To learn how to do this in your cPanel, simply follow these instructions.</p>
<h2>How to set MX records to remote settings in cPanel.</h2>
<ol class="article_list">
<li><a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">Log into your cpanel account</a>.</li>
<li>Find the <em>Mail </em>category and click on the <strong>MX Entry</strong> icon.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/cpanel/email/MX-Entry.png"><img  alt="MX-Entry" src="//cdn.inmotionhosting.com/support/images/stories/edu/cpanel/email/MX-Entry.png" /></a></li>
<li>From the next screen, use the dropdown near the top to select the domain name you want to work with if it is not already displayed. Next, look under the <em>Email Routing</em> section and click on the radio button labeled <strong>Remote Mail Exchanger</strong>.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/cpanel/email/MX-set-remote.png"><img  alt="MX-set-remote" src="//cdn.inmotionhosting.com/support/images/stories/edu/cpanel/email/MX-set-remote.png" /></a></li>
<li>Click on the <strong>Change</strong> button to save the settings.</li>
</ol>
<p>Please check the next article on <a target="_blank" href="/support/edu/cpanel/cpanel-email/user-account-level-filtering" title="Click here to view the next article">Creating user level filtering in cPanel</a>. If you missed our previous article, please see the <a href="/support/edu/cpanel/cpanel-email/spamassassin-fighting-spam" title="Click here to view the previous article" target="_blank">SpamAssassin: Fighting Spam</a> tutorial. For more information on this course please visit <a target="_blank" href="/support/edu/cpanel/cpanel-email" title="Click here to view the courses">Using Email</a>.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 7: Setting domain MX records to remote settings in cPanel</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 6: <a href='/support/edu/cpanel/cpanel-email/spamassassin-fighting-spam'>SpamAssassin: Fighting Spam</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 8: <a href='/support/edu/cpanel/cpanel-email/user-account-level-filtering'>Creating user level filtering in cPanel</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xMzQmaWQ9MTY0OSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="d02d171b4deead791afef03f142f423f" value="1" />	</div>
	</form>
<!-- <br />
          ...
          <tr >
			...
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/cpanel/website-contact-form-does-not-send-emails-to-a-specific-email?tsrc=rsbraq'>Website contact form does not send e-mails to a specific email</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/email-troubleshooting/error-550-when-verifying-email-address-to-be-used-with-gmail?tsrc=rsbraq'>Error 550 when verifying email address to be used with gmail </a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/email-troubleshooting/emails-are-not-send-via-php-pages-why?tsrc=rsbraq'>emails are not send via php pages. why?</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/email-troubleshooting/not-receiving-emails-to-new-email-but-can-send-checked-settings?tsrc=rsbraq'>Not receiving emails to new email but can send checked settings</a>
                                </div>
