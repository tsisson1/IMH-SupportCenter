<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49673:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/how-to/mysql-timezone" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hi Iragasa, Thanks for posting your question. I'm more than happy to assist you. Unfortunately, you cannot update the MySQL timezone on a shared account..." />
  <title>mysql timezone | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/how-to/mysql-timezone" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:dc18133c87c0099a13028165bbd5dc7c -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>mysql timezone</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/lragasa'>lragasa</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-03-20 7:07 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>1,716</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>&lt;p&gt;I'd like to change the timezone of mysql server to Asia/Manila how do i sort this on cpanel ? the time should be in 24 hour format ( military time )&lt;/p&gt;</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_750' id='upvote_answer_750' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='750' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_750').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_750' id='downvote_answer_750' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='750' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_750').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hi Iragasa,<br />
<br />
Thanks for posting your question. I'm more than happy to assist you. Unfortunately, you cannot update the MySQL timezone on a shared account. The timezone is set for the entire server, not individual accounts. <br />
<br />
However, there is a work around for updating the timezone in MySQL. Basically, you'll define the timezone in PHP and then set an offset for the time after connecting to the database. Here's a link to how to synchronize PHP and MySQL:<br />
<br />
<a href="http://www.sitepoint.com/synchronize-php-mysql-timezone-configuration/">How to synchronize timezones in PHP and MySQL</a><br />
<br />
...
Tim S
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_750').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_750' id='form_comment_on_answer_750' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/how-to/mysql-timezone&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/how-to/mysql-timezone'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="a308892f7338c653e636fecc652a8fca" value="1" />	</div>
	</form>
<!-- <br />
