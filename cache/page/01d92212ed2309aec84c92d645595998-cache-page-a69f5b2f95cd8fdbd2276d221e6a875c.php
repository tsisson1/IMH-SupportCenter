<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:91061:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/website-transfers/inmotion-hosting-pre-website-transfer-checklist" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-05-10T12:44:59-07:00" />
  <meta name="keywords" content="InMotion Hosting transfer website guidlines" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="To learn what is needed for InMotion Hosting to transfer your website to our server, you will need to follow this article." />
  <title>InMotion Hosting Pre Website Transfer checklist - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/website-transfers/inmotion-hosting-pre-website-transfer-checklist" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:a49fd07d5a55d69a682e039e2590fc16 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '96.254.200.128']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															InMotion Hosting Pre Website Transfer checklist									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>12,889</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Apr 9, 2013'><span style='color:#606060;'>Published:</span> May 10, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Website transfers are considered on a case-by-case basis depending on the size of your site, complexity of programming, and the platform/OS of your previous host.  We will need the following information pertaining to your previous host in order to review your site and determine whether we will be able to move it for you, and as well as any costs involved. If you want to transfer your website on your own, you will want to read our articles on <a href="/support/website/how-to/migrate-website-from-another-host">How to migrate your website FROM another host TO InMotion Hosting</a> and <a href="/support/website/getting-started-guides/perform-your-own-website-transfer">Perform your own website transfer</a>.</p>

<p class="alert"><strong>Please note!</strong> that while we take care to ensure that your site will be as fully operational as possible on our servers, we are unable to provide technical support for programming matters or in-depth configuration and dependencies of your site, or other issues that are not directly server-related. For websites over 5G in size, sufficient SSH access must be provided to your old server.  Your site transfer may be subject to additional terms, such as pricing, time frame, and scope of configuration.<br /><br />
While we do try to complete all site moves in a timely manner, the volume of requests to transfer websites we recieve will directly impact the timeliness of the site moves. Please keep this in mind when submitting a website transfer request. </p>
<p>The following article will explain to you the general process for having your Website transferred by InMotion Hosting staff.</p>


<h2>What to do before the transfer</h2>
<h3>Setting your website to Maintenance mode</h3>

<p>Before you have your website transferred to InMotion Hosting, you will want to communicate to our tech support staff the best time to have your files and databases transferred. In some cases the transfer may take days. We understand you cannot have your site in maintenance mode for days, so, you will want to coordinate with tech support to make sure your data is not lost in the transfer. You will want to set your site to <a href="/support/website/how-to/redirect-visitors-under-construction-page">maintenance or under construction mode</a> during the transfer process. The reason for setting your site to maintenance mode is to prevent data loss during the file transfer. While your website is in Maintenance Mode, no new content, database entries, shopping cart purchases and so forth will not occur during the transfer. </p>

<h3>Complete the Website Transfer Request Form</h3>
<p>When you are ready, fill out the <a href="/support/website/amp/wtr">website transfer form</a> and then your transfer process will begin.</p>


<h2>When the Website Transfer is completed</h2>
<h3>Testing your site with a Hosts file mod</h3>
<p>You can test your web pages using a <a href="/support/website/how-to/modifying-your-hosts-file">hosts file modification</a> on your computer, to make the DNS requests for domains go to a specified IP address. For information on performing a hosts file modification, please visit <a href="/support/website/how-to/modifying-your-hosts-file">Modifying Your Hosts File</a>. By using the Hosts file modification, you can fake your local computer to go to your website allowing you to see a live view without allowing acces to the site on the web.</p>

<host file mod lines go here>

<h3>Pointing your Nameservers</h3>
Once you see your website working on a hosts file modification, you can point your domain to <a href="/support/domain-names/dns-nameserver-changes/updating-your-domains-nameservers">InMotion Hosting nameservers</a>. Below are our nameserver hostnames and IP addresses.

<table class="article_table" border="0" align="center">
  <tr>
    <th colspan="2"><div align="center">InMotion Hosting's Nameservers</div></th>
  </tr>
  <tr>
    <th width="184"><div align="center">Hostname</div></th>
    <th width="215"><div align="center">IP Address</div></th>
  </tr>
  <tr>
    <th width="184"><div align="center">ns.inmotionhosting.com</div></th>
    <td width="215"><div align="center">74.124.210.242</div></td>
  </tr>
  <tr>
    <th><div align="center">ns2.inmotionhosting.com</div></th>
    <td><div align="center">70.39.150.2</div></td>
  </tr>
</table>
<br />

<p>When you make changes to your DNS, Please allow up to <a href="/support/domain-names/dns-nameserver-changes/domain-names-dns-changes">24 hours for propagation</a> after making the change.</p>

<h3>Speeding up your DNS propagation</h3>
<p>To speed up DNS propagation, you can change the <a href="/support/domain-names/dns-nameserver-changes/a-record-change">DNS A record</a> for your domain (at the old host nameservers) to have the new IP address for your website here.  The TTL (Time To Live) value on DNS A records is typically 14400 (4 hours), which is quicker than the TTL on nameserver records typically 86400 (1 day).</p> 
...
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/website-transfers/inmotion-hosting-pre-website-transfer-checklist'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NDMmaWQ9MjU5OCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="5132f1894056eb2682ef25c2435950df" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/website-transfers/website-transfer-requirements?tsrc=rsbraq'>Website Transfer Requirements</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/cpanel/how-to-i-transfer-a-account-from-other-server-to-inmotion?tsrc=rsbraq'>How to I transfer a account from other server to inmotion?</a>
                                </div>
...
<a name='comments'></a>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-10 3:07 pm</div>
				                <div><p>Sounds like I have to do a lot of work! Not hassle free at all.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8889);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-11 7:51 am</div>
				                <div>It is actually quite simple.  To do so, simply provide us with the information from your old host over a verified ticket so that we can move your site for you.  Simply follow the steps in this article and your website can be transferred quite easily.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8896);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-8955'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/609340eac1094ebd99ef6c28739347ff?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/609340eac1094ebd99ef6c28739347ff'>Rafael</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-14 12:36 am</div>
				                <div><p>I need only to migrate emails from a Hosting with cpanel. My domains are .com.uy sites.</p>
<p>&nbsp;How to migrate if I buy&nbsp;a Inmotion Reseller Hosting ?</p>
<p>Could I translate domains .com.uy ?</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8955);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-14 9:49 am</div>
				                <div>We do not currently  register .com.uy domains, but you may still keep your domain elsewhere while pointing to us by adjusting your nameservers.  If your other host uses cPanel, all you would need to do is obtain a cPanel backup from them, then import it with us.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8960);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-20840'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/215061c6efd352084248f2673bdeea37?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/215061c6efd352084248f2673bdeea37'>jerry</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-19 1:05 am</div>
				                <div><p>do you have tech support in spanish?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20840);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-19 12:51 pm</div>
				                <div>Hello jerry,<br />
<br />
Thank you for your question. Unfortunately, at this time our Tech Support is provided in English only.<br />
<br />
If you have any further questions, feel free to post them below.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20862);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-19 7:09 pm</div>
				                <div><p>How can I transfer my current domain to Inmotionhosting if I don't speek english very well? What kind of support will I have?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20880);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-22 10:29 pm</div>
				                <div>Hello Jerry,<br />
<br />
Our support will still be here to try and help as much as we can, however it may be more productive to result to tickets instead of using our phone system. <br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20952);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-23090'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/d25923595b3876f2fcb66f1c62587602?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/d25923595b3876f2fcb66f1c62587602'>Louis</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-30 8:35 pm</div>
				                <div><p>Hi Team..... :-)</p>
<p>Just wondering when transfering a site over will it fetch the emails over as well</p>
<p>looking forward to a reply</p>
<p>&nbsp;</p>
<p>Best Regards</p>
<p>Louis...</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23090);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-05-01 10:15 am</div>
				                <div>Hello Louis,<br />
<br />
Thank you for your question. You will have to transfer email separately, see our helpful full guide on <a href="http://www.inmotionhosting.com/support/email/general-information/transferring-emails-from-your-old-host-to-inmotion-hosting">Transferring Emails from your old host to InMotion Hosting</a>.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23100);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-23841'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/20c4600ea1418089b5d114c4cdc510fd?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/20c4600ea1418089b5d114c4cdc510fd'>Goerge</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-01 8:46 am</div>
				                <div><p>Hey i've been trying to transfer my website to your server but . notting is happening one of your staff send me back an error that occurs onces he was restoring my website can i give you my cpanel from another host and fo it for me if its possible please. its been a week we working on this and my client is not happy now, also me too</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23841);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-01 2:55 pm</div>
				                <div>Hello George,<br />
<br />
The Customer Community Center is a public area for questions and comments. You would need to <a href="http://www.inmotionhosting.com/support/website/amp/wtr">request a website transfer within the AMP</a> and our Live Support team would follow up with you.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23861);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-29688'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/eed2456cd0373233e28c43ba7b3b300a?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/eed2456cd0373233e28c43ba7b3b300a'>Cliff</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-10 10:11 am</div>
				                <div><p>I'm interested in transferring my website to your company for the Power Small Business package. Its an e-commerce wordpress website using woocommerce. Right now its hosted with discountasp.net on a windows server and the domain name has an SSL cert and is with godaddy. Do you anticipate any problems with this setup or downtime when transferring to your company?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29688);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-11 4:12 pm</div>
				                <div>Hello Cliff,<br />
<br />
Thank you for contacting us. This should not be a problem. I recommend testing with a <a href="http://www.inmotionhosting.com/support/website/how-to/modifying-your-hosts-file">Host file modification</a> before finally pointing your domain to our <a href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes">nameservers</a>.<br />
<br />
If you have any further questions, feel free to post them below.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29720);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
