<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50765:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/image-editing/cant-see-media-files" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello turtle24, Thank you for contacting us about missing images after a Primary Domain Change. When I check your images they are linking to a different..." />
  <title>Can't see media files after Primary Domain Change | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/image-editing/cant-see-media-files" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:2cbfe1d13430c9114bede5ef015cbbd4 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Can't see media files after Primary Domain Change</h1>
		<div style='margin-bottom:20px; margin-top:10px; clear:both; color:#6e6e6e;'>Category: <a href='/support/community-support/image-editing'>Image Editing</a></div>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/turtle24'>turtle24</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-04-23 12:09 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>47</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I have called support. They were unable to resolve the problem I am having. I changed the primary domain on my account today. Not sure if this has to do with the problem. Now, I am unable to see the images in the media center. Even when I download new images they all display as a blank thumbnail. The tech support thought it might have to do with the coding through the theme on wordpress. <br />
Any images that were downloaded prior to the change, have remained intact on the actual website. <br />
Also, I want to link a second domain name to a specific page on my website. Is this possible? Is it not advised? Am I going to run into the same challenges? </div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_7097' id='upvote_answer_7097' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='7097' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_7097').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_7097' id='downvote_answer_7097' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='7097' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_7097').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello turtle24,<br />
<br />
Thank you for contacting us about missing images after a <a href="http://www.inmotionhosting.com/support/domain-names/general-information/how-do-i-change-the-main-domain-name-on-my-account">Primary Domain Change</a>. When I check your images they are linking to a different domain name (I marked the actual domain name out with a "*" for security purposes).<br />
<br />
For example, when I go to: <br />
http://*****cahale.org/<br />
<br />
There is a missing image titled: "cropped-thinking-man_368978411.jpg"<br />
<br />
When I roll my mouse over this image, it lists the URL as:<br />
http://***lehuddle.com/wp-content/uploads/2015/03/cropped-thinking-man_368978411.jpg<br />
<br />
Since a primary domain change does not modify your website, you will have to <a href="http://www.inmotionhosting.com/support/website/wordpress/wordpress-changing-the-site-url-and-home-settings">update the URL<a href="http://www.inmotionhosting.com/support/website/wordpress/wordpress-changing-the-site-url-and-home-settings"> for your site too.<br />
<br />
You can <a href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-manage-domains/setting-up-redirect-cpanel">redirect a domain</a> to a specific folder from cpanel. Make sure you have <a href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-manage-domains/adding-addon-domains-in-cpanel">added the domain</a> to your cPanel first.<br />
<br />
...
John-Paul B
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_7097').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_7097' id='form_comment_on_answer_7097' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
                                ...
                                <h3>Related Articles</h3><a target='_blank' href='http://inmotionhosting.com/support/installing-gimp-to-edit-images'>Installing GIMP to edit Images</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/learning-the-basics-in-creating-graphics-in-flash-mx'>Learning the basics in creating graphics in Flash MX</a><br/><br />
		</div>
