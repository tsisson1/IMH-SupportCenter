<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:75596:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-3/create-template/add-css-and-js" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-10-07T21:57:20-07:00" />
  <meta name="keywords" content="adding css and javascript joomla 3.0 template" />
  ...
  <title>How to add CSS and JavaScript files to a Joomla 3.1 Template - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-3/create-template/add-css-and-js" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:a4dbad061ad8401fb722a61e9059a58c -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to add CSS and JavaScript files to a Joomla 3.1 Template									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>62,200</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Oct 7, 2012'><span style='color:#606060;'>Published:</span> Oct 7, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/create-template/new-template-installed.jpg"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="new-template-installed" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/create-template/new-template-installed.jpg" /></a>If you've been following along in our tutorials series on <a href="/support/edu/joomla-3/create-template">creating Joomla 3.0 templates</a>, you would have seen in our last tutorial after <a href="/support/edu/joomla-3/create-template/switch-site-template">changing site templates</a> that the template does not look very nice at all (see screenshot to the right).</p>
...
<p>In this tutorial we will show you how to properly include CSS and JS files within a Joomla 3.0 template.</p>
<div style="clear: both;"></div>
<p> </p>
...
<li><strong>Open for edit your index.php file</strong><br /><br />As our template's index.php file is already on our <a href="http://www.inmotionhosting.com/joomla-hosting.html" target="_blank">Joomla Hosting</a> account, we are going to use the file manager within our cPanel to edit the file.</li>
<li><strong>Use $doc-&gt;addStyleSheet and $doc-&gt;addScript to include files</strong><br /><br />At the top of your template, use <strong>$doc-&gt;addStyleSheet</strong> to include your <em>css/style.css</em> file and <strong>$doc-&gt;addScript</strong> to add your <em>js/main.js</em> files. For these functions to work, we must also add <strong>$doc = JFactory::getDocument()</strong>. So far, we've updated the top portion of our index.php file, and the code in green below shows those changes.<br /><br />
<pre class="code_block" style="max-width: 510px;"><span style="color: #008000;"><strong>&lt;?php
...
<li><strong>Remove the previous calls to include these files</strong><br /><br />Within our head tag, we previously included css/style.css and js/main.js. We are now going to remove these two lines of code, which you can see below crossed through.<br /><br />
<pre class="code_block" style="max-width: 510px;">&lt;!DOCTYPE html&gt;
&lt;html&gt;

&lt;head&gt;

    <span style="color: #008000;"><strong><span style="text-decoration: line-through;">&lt;link rel="stylesheet" href="/support/css/style.css" type="text/css" /&gt;
    &lt;script src="/support/js/main.js" type="text/javascript"&gt;&lt;/script&gt;</span></strong></span>
...
<li><strong>Add &lt;jdoc:include type="head" /&gt; within your head tag</strong><br /><br />The next thing you'll need to do is use &lt;jdoc:include type="head" /&gt; to programmatically print code within your header. Basically what this will do is add the necessary HTML within your head tag to include the CSS and Javascript files.<br /><br />The example code below shows what the top of our index.php file looks like after performing all the steps in this article:<br />
<pre class="code_block" style="max-width: 510px;"><span style="color: #008000;"><strong>&lt;?php
...
&lt;body&gt;</pre>
<p>Once we make these changes and save our index.php file, we'll go back to our Joomla site and refersh the page. As you can see, our template is looking a bit better than when compared to the screenshot at the top of this article.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/create-template/template-after-incorporating-css.jpg"><img  alt="template-after-incorporating-css" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/create-template/template-after-incorporating-css.jpg" /></a></p>
</li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 7: How to add CSS and JavaScript files to a Joomla 3.1 Template</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 6: <a href='/support/edu/joomla-3/create-template/switch-site-template'>How to change your Joomla 3.1 Site Template</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 8: <a href='/support/edu/joomla-3/create-template/add-bootstrap'>How to add Bootstrap to a Joomla 3.1 Template</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-3/create-template/add-css-and-js&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-3/create-template/add-css-and-js'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNzEmaWQ9MTg0NiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						...
						<div><a style='font-size:16px;' href='//www.gravatar.com/85b445f2c587b02976da5782b5b3ef2b'>Greg Ledger</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-21 2:28 pm</div>
				                <div><p>I'm at wit's end. I built a template by using this tutorial. All went very well. But recently I found that there are two js files loading before jquery.min.js (which is included (from&nbsp;&lt;jdoc:include type="head" /&gt;). The files are tabs-state.js and caption.js. Both rely on jquery loading first.I don't know why these files are loaded (I disabled and reenabled all plugins and modules one at a time, so it is not that.) I also tried adding&nbsp;JHtml::_('jquery.framework'); to the very top of the index.php file, without success.I'm trying other forums as well but they want to give cryptic answers, like I have to alter the core...NOT!</p>
<p>&nbsp;</p>
<p>Why does it just work on the sample template but not on mine?&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10783);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-21 3:19 pm</div>
				                <div>Hello Greg, and thank you for your comment!<br />
<br />
I did some searching and found other Joomla users that were also having issues with the order in which some JavaScript files were loaded and the impact they had on jQuery.<br />
<br />
To help narrow this down a bit, what's the exact version of Joomla that you are running? There were changes to the way jQuery was included in Joomla from version 3.1 to 3.2 and according to this &lt;a href=&quot;http://issues.joomla.org/tracker/joomla-cms/3188&quot; target=&quot;_blank&quot;&gt;Joomla tabs-state.js in com_content frontend&lt;/a&gt; issue reported on the Joomla site, was patched in Joomla 3.2.4.<br />
<br />
So that could possibly explain the issue you're having. Most of the fixes I see floating around do indicate that you would need to manually edit the &lt;span style=&quot;color: red;&quot;&gt;com_content&lt;/span&gt; component as that's where the include is coming from, but do mention it could break some functionality as well:<br />
<br />
&lt;span style=&quot;color: red;&quot;&gt;/components/com_content/content.php&lt;/span&gt;<br />
<br />
&lt;pre class=&quot;code_block&quot; style=&quot;margin: -10px 0px -30px 0px; line-height: .9em&quot;&gt;defined('_JEXEC') or die;<br />
JHtml::_('behavior.tabstate');&lt;/pre&gt;<br />
<br />
You would want to comment out the &lt;span style=&quot;color: red;&quot;&gt;behavior.tabstate&lt;/span&gt; line with two backslashes like this:<br />
<br />
&lt;pre class=&quot;code_block&quot; style=&quot;margin: -10px 0px -30px 0px; line-height: .9em&quot;&gt;defined('_JEXEC') or die;<br />
&lt;span style=&quot;color: red;&quot;&gt;//&lt;/span&gt;JHtml::_('behavior.tabstate');&lt;/pre&gt;<br />
<br />
If we could take a look at your site and your template we might be able to better guess at what could be the issue if this doesn't fix it. Feel free to post any helpful info in your comment on this article and we can remove any private info before approving the comment and making it public.<br />
<br />
- Jacob</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10784);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-20 3:05 am</div>
				                <div><p>al tratar de instalar mi plantilla html5 me sale este mensaje</p>
<p><strong style="font-family: 'Times New Roman'; font-size: medium;">Fatal error</strong><span style="font-family: 'Times New Roman'; font-size: medium;">&nbsp;: Llamada a una funci&oacute;n miembro (atributos) en un no-objeto en</span><strong style="font-family: 'Times New Roman'; font-size: medium;">/home/entihma1/public_html/vistamardorada/libraries/cms/installer/adapter/template.php</strong><span style="font-family: 'Times New Roman'; font-size: medium;">&nbsp;en la l&iacute;nea&nbsp;</span><strong style="font-family: 'Times New Roman'; font-size: medium;">81</strong></p>
<p>Translated by Google:
when trying to install my html5 template I get this message

Fatal error: Call to a member function (attributes ) on a non-object in / home / entihma1 / public_html / vistamardorada / libraries / cms / installer / adapter / template.php on line 81</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17641);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-20 11:58 am</div>
				                <div>Hello cesar,<br />
<br />
Thank you for contacting us. We are happy to help, but will need some additional information.<br />
<br />
What version of Joomla are you using?<br />
<br />
What template are you attempting to install?<br />
<br />
Can you provide a link to the error?<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17661);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
