<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:60936:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/everything-email/mcafee/profanity-filter" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-04-29T23:02:40-07:00" />
  <meta name="keywords" content="mcafee profanity filter control console disable" />
  <meta name="author" content="John-Paul Briones" />
  <meta name="description" content="In this tutorial we will show you how to disable the profanity filter as an Administrator in the McAfee Control Console." />
  <title>Turning the Profanity Filter Off in the McAfee Control Console - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/everything-email/mcafee/profanity-filter" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:5d9744a043b4c4a9e5eefb74c60a5054 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Turning the Profanity Filter Off in the McAfee Control Console									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>1,258</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Feb 22, 2013'><span style='color:#606060;'>Published:</span> Apr 29, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<div>By default, <a href="/support/edu/everything-email/mcafee" target="_blank">McAfee Email Protection</a> has a profanity filter, that blocks any email that contains specific "bad words." Depending on your site / business you may want to turn off this option.</div>
<div>In this guide we will show you how to disable the profanity filter in the McAfee Control Console.</div>
<p class="alert">You must be the <a href="/support/edu/everything-email/mcafee/admin-login" target="_blank">Administrator of the McAfee Email Protection</a> to perform this modification.</p>
<h1>How to Turn Off the Profanity Filter:</h1>
<ol class="article_list">
<li><a href="/support/edu/everything-email/mcafee/admin-login" target="_blank">Login to the McAfee Conrtrol Console as an Administrator</a>.</li>
<li>Click the <strong>Policies</strong> tab.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/mcafee/profanity-filter/policy-tab.png"><img src="//cdn.inmotionhosting.com/support/images/stories/mcafee/profanity-filter/policy-tab.png" alt="selecting the policy tab in the mcafee control console"  style="margin: 15px;" /></a></li>
<li>Click the <strong>Default Inbound [Default]</strong> policy, then click the <strong>Edit</strong> button.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/mcafee/profanity-filter/edit-policy.png"><img src="//cdn.inmotionhosting.com/support/images/stories/mcafee/profanity-filter/edit-policy.png" alt="editing the profanity filter in the mcafee control console"  style="margin: 15px;" /></a></li>
<li>Click the <strong>Content</strong> tab.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/mcafee/profanity-filter/content-tab.png"><img src="//cdn.inmotionhosting.com/support/images/stories/mcafee/profanity-filter/content-tab.png" alt="selecting the content tab in the mcafee control console"  style="margin: 15px;" /></a></li>
<li>Double click the <strong>Profanity</strong> option, you will see a green check mark signifying it is enabled.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/mcafee/profanity-filter/profanity-filter.png"><img src="//cdn.inmotionhosting.com/support/images/stories/mcafee/profanity-filter/profanity-filter.png" alt="Double clicking the profanity filter in the mcafee control console"  style="margin: 15px;" /></a></li>
<li>Click the <strong>Enabled</strong> option to un-check it, then click the <strong>Save</strong> button.&nbsp;<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/mcafee/profanity-filter/disable-filter.png"><img src="//cdn.inmotionhosting.com/support/images/stories/mcafee/profanity-filter/disable-filter.png" alt="turning the profanity filter off in the mcafee control console"  style="margin: 15px;" /></a><br />You will see a notification stating, "Profanity was updated successfully. It may take several minutes for changes to take effect." The Profanity filter is now disable, you can confirm this by viewing the red <strong><span style="background-color: #ffffff; color: #ff0000;">X</span></strong> under the Enabled header.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/mcafee/profanity-filter/disabled.png"><img src="//cdn.inmotionhosting.com/support/images/stories/mcafee/profanity-filter/disabled.png" alt="viewing the filters that are not enable in the mcafee control console"  style="margin: 15px;" /></a></li>
</ol>
<div>&nbsp;</div>
<div>Congratulations, now you know how to turn the<em> Profanity Filter</em> off in the McAfee Control Console!</div>
<div>&nbsp;</div> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 13: Turning the Profanity Filter Off in the McAfee Control Console</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 12: <a href='/support/edu/everything-email/mcafee/admin-login'>Accessing the McAfee Control Console as an Admin</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/everything-email/mcafee/profanity-filter&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/everything-email/mcafee/profanity-filter'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMzcmaWQ9MjI0NCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="4e7f7a3213afdad5781b95c89788b5e9" value="1" />	</div>
	</form>
<!-- <br />
