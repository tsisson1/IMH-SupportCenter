<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:68468:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/database-setup/how-to-delete-a-database-in-cpanel" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-11-15T15:36:02-08:00" />
  <meta name="keywords" content="cpanel remove delete database" />
  <meta name="author" content="Tim Sisson" />
  <meta name="description" content="Learn how to delete a database from cPanel if you are not using it." />
  <title>How to Delete a Database in cPanel - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/database-setup/how-to-delete-a-database-in-cpanel" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:14847f8993fa6cd0ec6ff5d3b87f6de2 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '99.66.179.13']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to Delete a Database in cPanel									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>16,769</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Feb 7, 2012'><span style='color:#606060;'>Published:</span> Nov 15, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Sometimes, you may want to remove a third party piece of software that requires a database. It’s best practice to keep your account free of unused items such as databases. Removing a database is relatively simple using cPanel. In this guide we will show you how to delete a database from your cPanel.</p>
...
<li>Find the icon “<strong>MySQL Databases</strong>” and click on it</li>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/database/remove_db_1.jpg"><img  alt="remove_db_1" src="//cdn.inmotionhosting.com/support/images/stories/database/remove_db_1.jpg" /></a></p>
<li>Find the database you want to delete in the list of “<strong>Current Databases</strong>” and click “<strong>Delete Database</strong>”</li>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/database/remove_db_2.jpg"><img  alt="remove_db_2" src="//cdn.inmotionhosting.com/support/images/stories/database/remove_db_2.jpg" /></a></p>
<li>On the next screen, you’ll be prompted to confirm the deletion of the selected database. Make sure you are deleting the correct database and click “<strong>Delete Database</strong>”</li>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/database/remove_db_3.jpg"><img  alt="remove_db_3" src="//cdn.inmotionhosting.com/support/images/stories/database/remove_db_3.jpg" /></a></p>
</ol><br>
<p>Congratulations, now you know how to remove a database from your cPanel! If you need further assistance please feel free to <a href="/support/community-support/">ask a question in our support center</a>.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/database-setup/how-to-delete-a-database-in-cpanel&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/database-setup/how-to-delete-a-database-in-cpanel'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MzQmaWQ9MzY4JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="9165852662038a4d78bc9ed5de80b776" value="1" />	</div>
	</form>
<!-- <br />
...
<a name='comments'></a>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/3f8ba254671ad4fea0096c9b6b2c4152?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/3f8ba254671ad4fea0096c9b6b2c4152'>ramjanam</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-30 1:50 am</div>
				                <div>Nice Post</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13452);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-18755'></a>
		<div  style='margin:2px 0px 0px 40px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/c1fb34466b671af6b6050c138bf1e459?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/c1fb34466b671af6b6050c138bf1e459'>Arpit Parekh</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-22 9:36 am</div>
				                <div><p>Thanks, after work of 20 hard minutes, I fund that &nbsp;How to remove database in CPAnel ?</p>
<p>In cPanel --&gt; &nbsp;Mysql Wizards --&gt; Remove Database</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(18755);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-22 10:35 am</div>
				                <div>Hello Arpit,<br />
<br />
I'm not sure what you're asking   the MySQL Database Wizard is only used to CREATE databases.  If you want to delete databases, then as per the documentation above, go into MySQL databases and click on <b>DELETE</b> if you are trying to remove the database.<br />
<br />
If you have any further questions or comments, please let us know.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(18773);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-15803'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/6d79a3eeed5227f2f440cb3763cd9f36?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/6d79a3eeed5227f2f440cb3763cd9f36'>nirosh</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-02 9:47 am</div>
				                <div><p>Hi,</p>
<p>After deleting the database as instructed by you above database name is still showing under phpMyAdmin. Please help me to delete it from phpMyAdmin also.</p>
<p>Thanks,</p>
<p>Nirosh</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15803);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-02 9:51 am</div>
				                <div>This is highly uncommon.  Could you provide me with the primary domain on your account and the name of the database that you are referring to?</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15804);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
