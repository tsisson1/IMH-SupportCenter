<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:65885:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/magento/102-customizing-magento/how-to-add-a-custom-favicon-in-magento" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-06-27T13:58:48-07:00" />
  <meta name="keywords" content="custom favicon magento shopping cart add new" />
  <meta name="author" content="Tim Sisson" />
  <meta name="description" content="This Magento Tutorial willteach you how to add a custom favicon to your Magento shopping cart. " />
  <title>How to Add a Custom Favicon in Magento 1.6 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/magento/102-customizing-magento/how-to-add-a-custom-favicon-in-magento" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:06e49c6f012b26f4aa246e41f19150d7 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to Add a Custom Favicon in Magento 1.6									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>9,776</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Mar 22, 2012'><span style='color:#606060;'>Published:</span> Jun 27, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Magento 1.6 allows you to further customize your shopping cart by adding a custom favicon. By default, the favicon is set to the Magento 1.6 logo. You can add a favicon of your logo or change it to any other custom image you wish. Customizing the favicon in Magento 1.6 is done through your Magento Admin Backend.</p>
...
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/magento/magento_edit_footer_1.jpg"><img  alt="magento_edit_footer_1" src="//cdn.inmotionhosting.com/support/images/stories/magento/magento_edit_footer_1.jpg" /></a></p>
<li>In the left menu pane under “<strong>General</strong>” select “<strong>Design</strong>”</li>
<li>Click on the “<strong>HTML Head</strong>” section in the center of your browser screen to open it</li>
<li>Next to the “<strong>Favicon Icon</strong>” heading click “<strong>Choose File</strong>” to upload your favicon image</li>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/magento/magento_favicon_1.jpg"><img  alt="magento_edit_footer_1" src="//cdn.inmotionhosting.com/support/images/stories/magento/magento_favicon_1.jpg" /></a></p>
...
<p>If you need further assistance please feel free to <a href="/support/community-support">ask a question on our support center</a>.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 2: How to Add a Custom Favicon in Magento 1.6</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 1: <a href='/support/edu/magento/102-customizing-magento/changing-the-default-welcome-message-in-magento'>Changing the Default Welcome Message in Magento 1.6</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 3: <a href='/support/edu/magento/102-customizing-magento/how-to-change-the-default-title-in-magento'>How to Change the Default Title in Magento 1.6</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/magento/102-customizing-magento/how-to-add-a-custom-favicon-in-magento&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/magento/102-customizing-magento/how-to-add-a-custom-favicon-in-magento'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP3RzcmM9cnNiZWR1Jm9wdGlvbj1jb21fY29udGVudCZjYXRpZD0xNjMmaWQ9MTIyMSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="c14108d6bc11d869a112f1140b99a03e" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/bd436fcff32f21389602255a7b9ad701?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/bd436fcff32f21389602255a7b9ad701'>Aravindakumar</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-30 9:34 am</div>
				                <div><p>I dont have that favicon upload option in my magento configuration page. What to do now? How can I upload my favicon.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10996);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-30 12:16 pm</div>
				                <div>Hello Aravindakumar,<br />
<br />
Thank you for your question. I tested for the <em>Favicon</em> setting in Magento 1.7, and 1.9 (since they are the versions available in Softaculous), and it is as described in this article.<br />
<br />
 What version of Magento are you running? If you are running Magento 1.6, I recommend upgrading the software for security purposes.  <br />
<br />
If you are using a custom template, the setting may be in a modified location. You may have to contact the template developer for more information.<br />
<br />
If you have any further questions, feel free to post them below.<br />
Thank you,<br />
<br />
-John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10999);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
