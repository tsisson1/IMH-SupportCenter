<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:53991:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/prestashop-15/error-500-server-prestashop-16" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, I will need a bit more information in order to test. I did some research but so far have not been able to identify a full fix. What specific vers..." />
  <title>error 500 server prestashop 1.6 | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/prestashop-15/error-500-server-prestashop-16" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:160d660379d09f1b9dbe0cd98c2ef4ca -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '62.197.108.41']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box straight_bottom'>
                <h1 style='font-size:26px;'>error 500 server prestashop 1.6</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2014-10-19 7:08 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>1,718</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I have a problem with my site,when do I make payment with when do I make payment by bank transfer me the following errorI also changed the write permissions on the file from 644 to 755 I also did debug if you want I can send you the file<br />
<br />
-----------------------<br />
[PrestaShopException]<br />
<br />
Can't load Order status<br />
at line 174 in file classes/PaymentModule.php<br />
<br />
168. <br />
169. 		$order_status = new OrderState((int)$id_order_state, (int)$this-&gt;context-&gt;language-&gt;id);<br />
170. 		if (!Validate::isLoadedObject($order_status))<br />
171. 		{<br />
172. 			PrestaShopLogger::addLog('PaymentModule::validateOrder - Order Status cannot be loaded', 3, null, 'Cart', (int)$id_cart, true);<br />
173. 			throw new PrestaShopException('Can\'t load Order status');<br />
174. 		}<br />
175. <br />
176. 		if (!$this-&gt;active)<br />
177. 		{<br />
178. 			PrestaShopLogger::addLog('PaymentModule::validateOrder - Module is not active', 3, null, 'Cart', (int)$id_cart, true);<br />
<br />
•PaymentModuleCore-&gt;validateOrder - [line 64 - modules/bankwire/controllers/front/validation.php] - [9 Arguments]<br />
<br />
<br />
<br />
<br />
•BankwireValidationModuleFrontController-&gt;postProcess - [line 171 - classes/controller/Controller.php]<br />
<br />
<br />
•ControllerCore-&gt;run - [line 373 - classes/Dispatcher.php]<br />
<br />
<br />
•DispatcherCore-&gt;dispatch - [line 28 - index.php]<br />
------------------------------<br />
<br />
can you help me? <br />
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px;'>
				<div style='font-size:12px; max-width:500px; overflow:auto;'>version use prestashop 1.6 </div>
			...
			<td style='width:100px;' valign='top'>
				...
				<div class='smallgrey'>
					<a href='/support/community-support/users/dsufficio'>dsufficio</a><br />
					14 <a href='/support/team/points' target='_blank'>Points</a><br />
					2014-10-19 07:11 am EST
				</div>
			</td>
		</tr>
	</table>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_5821' id='upvote_answer_5821' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='5821' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_5821').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_5821' id='downvote_answer_5821' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='5821' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_5821').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
...
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_5821').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_5821' id='form_comment_on_answer_5821' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>thank you for interested scott<br />
my version  di PrestaShop 1.6.0.9 -the problem occurs when my customer buys products on the site and pay by bank transfer-other payment systems work well<br />
thank<br />
<br />
</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello Dsufficio,<br />
<br />
You asked this question (as a comment) in an article.  You can see my answer by going to the response at the bottom of the page of the <a href="http://www.inmotionhosting.com/support/website/error-numbers/500-internal-server-error">500 internal server page</a> error.   I turned on the error reporting to see the error detail and provided a suggested solution.  The solution requires that you take two tables from a fresh PrestsShop  1.6 installation and then import into the database you are using for your current PrestaShop installation.  Please review my response to you and then let us know if you continue to have any further problems.<br />
<br />
Regards,<br />
Arnel C.</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/prestashop-15/error-500-server-prestashop-16&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/prestashop-15/error-500-server-prestashop-16'></div>
<script type='text/javascript'>
  (function() {
