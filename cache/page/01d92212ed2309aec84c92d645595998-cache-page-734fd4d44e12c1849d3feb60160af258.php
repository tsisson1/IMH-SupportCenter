<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:52421:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/prestashop-15/increase-the-maxinputvars-in-phpini" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Andre_Sa, Thank you for your question regarding your PHP settings. The php.ini file is where you can set limits in PHP, including the max_input_va..." />
  <title>Increase the max_input_vars in php.ini | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/prestashop-15/increase-the-maxinputvars-in-phpini" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:2d8a0a9614dfa098d65ee6ea7b078c4b -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '139.193.131.3']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box straight_bottom'>
                <h1 style='font-size:26px;'>Increase the max_input_vars in php.ini</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/Andre_Sa'>Andre_Sa</a>
			<div>10 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-11-22 3:05 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>29,566</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I am stuck with an error:<br />
&quot;&lt;strong&gt;Warning, your PHP configuration limits the maximum number of fields to post in a form: 1000 for max_input_vars.<br />
Please ask your hosting provider to increase the this limit to 1318 at least or edit the translation file manually.&lt;/strong&gt;&quot;  when I try to alter some translations on my front Office. Is it possible to increase the max_input_vars from the 1000 default to 1500 ou 2000?</div>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px;'>
				<div style='font-size:12px; max-width:500px; overflow:auto;'>i increase  max_input_vars : 5000 but not increase menu after 80 if i add menu so what i do???<br />
</div>
			...
			<td style='width:100px;' valign='top'>
				...
				<div class='smallgrey'>
					<a href='/support/community-support/users/rashmibawankule'>rashmibawankule</a><br />
					5 <a href='/support/team/points' target='_blank'>Points</a><br />
					2013-05-10 12:13 am EST
				</div>
			</td>
		</tr>
	</table>
...
<div style='padding:15px; border:1px solid #d6d6d6; border-top:0px; background:#ebebeb;' class='round_bottom' >
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px;'>
				<div style='font-size:12px; max-width:500px; overflow:auto;'>any other solution for that which i write in htaccess file??</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_1908' id='upvote_answer_1908' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='1908' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_1908').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_1908' id='downvote_answer_1908' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='1908' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_1908').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Andre_Sa,<br />
<br />
Thank you for your question regarding your PHP settings. The <strong>php.ini</strong> file is where you can set limits in PHP, including the <strong>max_input_vars</strong> setting. <br />
<br />
Here is a link to an article in our support center titled "<a href="http://www.inmotionhosting.com/support/website/general-server-setup/update-local-php-settings">How to update your local php settings</a>."<br />
<br />
It explains how to successfully modify your PHP settings, so you will know how to <strong>increase the max_input_vars</strong> setting. <br />
<br />
...
-John-Paul
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_1908').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_1908' id='form_comment_on_answer_1908' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Sorry for the trouble with your php.ini setting. You will need to make your php.ini recursive for the change to be seen in subfolders. Please see the following article.<br />
<br />
&lt;a href=&quot;http://www.inmotionhosting.com/support/website/general-server-setup/recursive-php-ini&quot;&gt; How can I make my php.ini file recursive ?&lt;/a&gt;<br />
<br />
Once you set the recursive path you should see it work.<br />
<br />
Best Regards,<br />
James R</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/prestashop-15/increase-the-maxinputvars-in-phpini&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/prestashop-15/increase-the-maxinputvars-in-phpini'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="fee94cf0e64664652fbce5d86ec3805e" value="1" />	</div>
	</form>
<!-- <br />
