<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:63403:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotion.net/support/website/how-to/find-config-files" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-03-11T17:41:22-07:00" />
  <meta name="keywords" content="find configuration file program web" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Looking for a configuration file for your program? Check this list to quickly locate the file or files." />
  <title>How to find program configuration files - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/how-to/find-config-files" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:8cb243d7bfd6d3067a198138fcfd4e79 -->
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to find program configuration files</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to find program configuration files									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>10,786</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 16, 2013'><span style='color:#606060;'>Published:</span> Mar 11, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>There are many different programs out on the web that you can use to enhance or create your website hosted here at InMotion Hosting. Each one of these programs has one or more configuration files that may need to be edited in order to get the results you want.</p>
<p>The location of the configuration files are dependent upon the program as each one has its own way of doing things. Below is a list of configuration file locations for some of the programs that are available both through our <a href="/support/edu/cpanel/softaculous/how-to-install">Softaculous installer</a> program and elsewhere across the web. This list can help you quickly locate a configuration file instead of having to search through each folder.</p>
<p>This list will continue to be updated as we run across new programs.</p>
<p class="alert">Note that the paths listed for each program are relative to the folder the program was installed. For instance, if you installed Concrete5 in <em>example.com/concrete </em>the location of the configruation file would be <em>example.com/concrete/site/config.php</em> whereas if it was simply installed on <em>example.com</em> it would be located at <em>example.com/site/config.php</em>
</p>
<table class="article_table">
	<tbody>
		<tr>
			<th>4Images Gallery</th>
			<td>/config.php</td>
		</tr>
		<tr>
			<th>B2 Evolution</th>
		...
		<tr>
			<th>Boonex Dolphin</th>
			<td>/inc/header.inc.php</td>
		</tr>
		<tr>
			<th>Concrete5</th>
			<td>/site/config.php</td>
		</tr>
		<tr>
			<th>Coppermine Photo Gallery</th>
			<td>/include/config.inc.php</td>
		</tr>
		<tr>
			<th>Crafty Syntax Live Help</th>
			<td>/config.php</td>
		</tr>
		<tr>
			<th>Cube Cart</th>
		...
		<tr>
			<th>Geeklog</th>
			<td>/db-config.php<br /> /siteconfig.php<br /> /lib-common.php</td>
		</tr>
		<tr>
			<th>glfusion</th>
		...
		<tr>
			<th>osCommerce</th>
			<td>/includes/configure.php<br /> /admin/includes/configure.php</td>
		</tr>
		<tr>
			<th>PHP-Nuke</th>
			<td>/config.php</td>
		...
		<tr>
			<th>phpFormGenerator</th>
			<td>/index.php<br /> /mysql.class.php</td>
		</tr>
		<tr>
			<th>PHPlist</th>
		...
		<tr>
			<th>PhpWiki</th>
			<td>/admin.php<br /> /lib/config.php</td>
		</tr>
		<tr>
			<th>Pligg</th>
		...
		<tr>
			<th>Serendipity</th>
			<td>/serendipity_config_local.inc.php</td>
		</tr>
		<tr>
			<th>Siteframe</th>
			<td>/config.php</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotion.net/support/website/how-to/find-config-files&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotion.net/support/website/how-to/find-config-files'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zNSZpZD01MDgmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="5d81eaaa0c2287e661201ebe871a2694" value="1" />	</div>
	</form>
<!-- <br />
