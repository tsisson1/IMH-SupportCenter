<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:53188:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/moodle/just-set-up-a-moodle-but-didnt-think-carefully-about-the-url-and-so-ive-tried-to-change-it-would-i-be-able-to-simply-move-the-moodle-to-a-different-url-by-editing-this-on-cpanel-or-do-i-need-to-start-over-from-scratch" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello beth543, Thank you for your question. You can change your URL or move moodle using cPanel, here is the Official guide on migrating moodle (I recom..." />
  <title>Can I change my Moodle URL? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/moodle/just-set-up-a-moodle-but-didnt-think-carefully-about-the-url-and-so-ive-tried-to-change-it-would-i-be-able-to-simply-move-the-moodle-to-a-different-url-by-editing-this-on-cpanel-or-do-i-need-to-start-over-from-scratch" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:f3c98e4cd8340d2081d9ced29d761c44 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '182.72.174.174']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Can I change my Moodle URL?</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='http://graph.facebook.com/elisabeth.w.harvey/picture?type=normal' class='user_avatar' /><br />
			<a href='/support/community-support/users/beth543'>beth543</a>
			<div>16 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-08-08 9:53 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>2,881</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Just set up a moodle, but didn't think carefully about the URL and so I've tried to change it. Would I be able to simply move the moodle to a different url by editing this on Cpanel? Or do I need to start over from scratch?</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_3693' id='upvote_answer_3693' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='3693' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_3693').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_3693' id='downvote_answer_3693' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='3693' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_3693').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello beth543,<br />
<br />
Thank you for your question. You can change your URL or move moodle using cPanel, here is the <a href="http://docs.moodle.org/23/en/Moodle_migration" target="_blank" >Official guide on migrating moodle</a> (I recommend using <strong>method 1</strong>, <strong>option (a)</strong>). It also explains how to change your URL.<br />
<br />
If you are not familiar with managing files on your server, I recommend <a href="http://www.inmotionhosting.com/support/website/how-to/how-to-manage-files-server" target="_blank" >this full guide</a>.<br />
<br />
...
-John-Paul
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_3693').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_3693' id='form_comment_on_answer_3693' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hi John-Paul! That sounds like it would have the answer for me, but I can't find it at the link. The link simply takes me to the general Support Center main page. And looking through the Moodle helps I don't find this tutorial!  ~ ??</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='http://graph.facebook.com/elisabeth.w.harvey/picture?type=normal' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/beth543'>beth543</a><br />
									16 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2013-08-08 11:59 am EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello beth543,<br />
<br />
Thank you for letting me know, sorry the link did not work. I have fixed it and tested it successfully at this time.<br />
<br />
If you have any further questions, feel free to post them below.<br />
Thank you,<br />
<br />
-John-Paul</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/moodle/just-set-up-a-moodle-but-didnt-think-carefully-about-the-url-and-so-ive-tried-to-change-it-would-i-be-able-to-simply-move-the-moodle-to-a-different-url-by-editing-this-on-cpanel-or-do-i-need-to-start-over-from-scratch&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/moodle/just-set-up-a-moodle-but-didnt-think-carefully-about-the-url-and-so-ive-tried-to-change-it-would-i-be-able-to-simply-move-the-moodle-to-a-different-url-by-editing-this-on-cpanel-or-do-i-need-to-start-over-from-scratch'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="3dba481d02d97f9cfb3631154a8f1b15" value="1" />	</div>
	</form>
<!-- <br />
