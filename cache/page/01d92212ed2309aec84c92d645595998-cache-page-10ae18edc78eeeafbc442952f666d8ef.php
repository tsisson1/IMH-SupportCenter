<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:60895:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/drupal-8/menus/add-items" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-10-11T17:21:22-07:00" />
  <meta name="keywords" content="menu items add drupal 8" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Let us guide you on how to enter new items into your menu in the Drupal 8 admin dashboard." />
  <title>How to add items to your menus in Drupal 8 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/drupal-8/menus/add-items" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:f583000b020f919b32c0f810c8f8418a -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '90.190.233.190']);
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
				<img src='/support/images/stories/drupal-partner/supporting-partner-80_3.png' style='float:right; margin:0px 0px 15px 15px;' alt='Drupal Association Support Partner'>		<h1>
															How to add items to your menus in Drupal 8									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>1,894</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jun 26, 2013'><span style='color:#606060;'>Published:</span> Oct 11, 2013</div>
...
<ol class="article_list">
  ...
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/_common-images/select-menu.png"><img  style="float:right; margin:0px 0px 15px 15px;" alt="click on the Menu item" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/_common-images/select-menu.png" title="Click here to view the larger image" width="200" /></a>From the top menu select the <strong>Menu</strong> option.<div style="clear:both;"></div></li>

  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/_common-images/select-structure.png"><img  style="float:right; margin:0px 0px 15px 15px;" alt="select the Structure option" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/_common-images/select-structure.png" title="Click here to view the larger image" width="200" /></a>A secondary menu will appear just under the first. From here, click on the <strong>Structure</strong> option.<div style="clear:both;"></div></li>

  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/104/add-menu-items/3-click-menu-option.png"><img  style="float:right; margin:0px 0px 15px 15px;" alt="click on the menu option" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/104/add-menu-items/3-click-menu-option.png" title="Click here to view the larger image" width="200" /></a>Now you are on the list of Structure types within Drupal 8. Click on the <strong>Menus</strong> option to continue.<div style="clear:both;"></div></li>

  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/104/add-menu-items/4-select-menu.png"><img  style="float:right; margin:0px 0px 15px 15px;" alt="select the menu to work with and click Add Link" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/104/add-menu-items/4-select-menu.png" title="Click here to view the larger image" width="200" /></a>From the list of existing menus, find the one you want to work with and click on the down arrow next to the <em>Edit Menu</em> option. This brings up a list of options. Click on the <strong>Add Link</strong> option. In this example, we are working with the <em>Test-Menu</em> menu.<div style="clear:both;"></div></li>

  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/104/add-menu-items/5-link-info-page.png"><img  style="float:right; margin:0px 0px 15px 15px;" alt="Enter settings data for the link" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/104/add-menu-items/5-link-info-page.png" title="Click here to view the larger image" width="200" /></a>
  Now you arrive at the Link information page for your new link. Enter the appropriate data in the fields displayed.
  <table class="article_table">
    <tr><th>Menu Link Title</th><td>This is the text that will show on the menu.</td></tr>
    <tr><th>Path</th><td>This is either an internal path, which you will need to know> This can be either the  standard node assigned vy Drupal, such as <em>node/2</em> or the alias assigned in the URL Path Settings of the content item, if you assigned one. You can also use absolute URLs, especially if you are going to point to an external address, such as <em>http://google.com</em>.</td></tr>
    <tr><th>Description</th><td>This text is displayed when you hover over the menu item, like a tool tip.</td></tr>
    <tr><th>Enabled</th><td>Is checked, the menu item will display in the menu. If unchecked, it will not display.</td></tr>
    <tr><th>Show as expanded</th><td>If checked, any children this menu item has will also appear. If unchecked or if the item has no children, it will display normally.</td></tr>
    <tr><th>Parent Link</th><td>Select the menu or parent link for this link. In this example, it will be a top item in the <em>Test-Menu</em> menu.</td></tr>
    <tr><th>Weight</th><td>Helps determine the order of the menu links, lighet numbers (lower) are near the top or left, while heavier numbers (higher) are more towards the bottom or right.</td></tr>
  </table>
  <div style="clear:both;"></div></li>

  <li>Once you have entered all the data necessary, click on the <strong>Save</strong> button to save all the settings for your new link.<div style="clear:both;"></div></li>

  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/104/add-menu-items/6-save-menu.png"><img  style="float:right; margin:0px 0px 15px 15px;" alt="save menu changes" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/104/add-menu-items/6-save-menu.png" title="Click here to view the larger image" width="200" /></a>You are now taken back to the main page for the menu. You will see your newly added link in the <em>Menu Link</em> list. Click the <strong>Save</strong> button to confirm any changes you have made to the menu.<div style="clear:both;"></div></li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/drupal-8/menus'>104: Working with Menus in Drupal 8</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 2: How to add items to your menus in Drupal 8</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 1: <a href='/support/edu/drupal-8/menus/menu-introduction'>How to create a custom menu in Drupal 8</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 3: <a href='/support/edu/drupal-8/menus/add-menu-block-to-page'>Assigning a menu to your pages in Drupal 8</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zOTUmaWQ9Mjc3NyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/drupal-8/menus?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Working with Menus in Drupal 8</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/drupal-8/menus/menu-introduction?tsrc=rsbedu'>How to create a custom menu in Drupal 8</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/drupal-8/menus/add-items?tsrc=rsbedu'>How to add items to your menus in Drupal 8</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/drupal-8/menus/add-menu-block-to-page?tsrc=rsbedu'>Assigning a menu to your pages in Drupal 8</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/drupal-8/menus/change-link-order?tsrc=rsbedu'>Changing link order in Drupal 8 menus</a></td>
                </tr>
          <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/drupal-8/menus/delete-menu?tsrc=rsbedu'>Deleting a custom menu in Drupal 8</a></td>
                </tr>
          <tr >
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/drupal-8/menus/disable-main-secondary-menus?tsrc=rsbedu'>Disabling main and secondary menus in Drupal 8</a></td>
                </tr>
          	</table>
