<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49625:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/everything-email/image-in-email-signature" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Some mail clients will allow you to create it as an attachment that created each time a message is sent, but the most common way would be to simply use ..." />
  <title>image in email signature | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/everything-email/image-in-email-signature" rel="canonical" />
...
<script>
  ...
  ga('send', 'pageview');
	...
	<!-- cid:a273d63e64ef40b00d2f65ff4af08417 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>image in email signature</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2014-02-17 11:47 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>41</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I would like to add an image to my email signature.  Where do I store the image?  How do I know what the image path is?</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_4541' id='upvote_answer_4541' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='4541' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_4541').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_4541' id='downvote_answer_4541' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='4541' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_4541').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>11,186 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2014-02-18 8:38 am EST
                		        </div>
					
		                </div>

				Some mail clients will allow you to create it as an attachment that created each time a message is sent, but the most common way would be to simply use an HTML tag which would look like the following:<br />
&lt;p class=&quot;code_block&quot;&gt;&amp;lt;img src=&quot;http://example.com/pathtoyourimage.jpg&quot;&amp;gt;&lt;/p&gt;<br />
As far as the path that you will use, it depends on where you upload the image. For ease of access, you could upload it to our public_html directory using the cPanel File Manager in which it would then be located at &lt;em&gt;http://example.com/imagefilename.jpg&lt;/em&gt;
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_4541').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_4541' id='form_comment_on_answer_4541' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/everything-email/image-in-email-signature&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/everything-email/image-in-email-signature'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="44c6cd19fa5f7ed6886cfe33f5a9d670" value="1" />	</div>
	</form>
<!-- <br />
