<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49130:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://192.145.237.216/support/edu/prestashop-15/images-and-descriptions" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="In this Prestashop 1.5 class, we'll teach you how to setup and manage product images." />
  <title>103: PrestaShop 1.5 Product Images and Descriptions | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/prestashop-15/images-and-descriptions" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:3fe508ffad07c3094c24c49b4c41315a -->
...
<div class='page-header'>
	<h1>103: PrestaShop 1.5 Product Images and Descriptions</h1>
</div>
<div class='section_listing'>
		<table>
	<tr><td colspan='3'><h2>Product Images</h2><div>Learn how to upload and manage images for your products.</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 1:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/images-and-descriptions/add-product-image'>Adding product images in PrestaShop 1.5</a>
					<div>This tutorial will show you how to add images for your products in PrestaShop 1.5</div>
					<div class='smallgrey'>Hits: 7,533</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/images-and-descriptions/multiple-images'>Adding multiple images to products in PrestaShop 1.5</a>
					<div>Adding multiple images to products within PrestaShop is easy to do, and in this tutorial we'll show you how it works.</div>
					<div class='smallgrey'>Hits: 3,893</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/images-and-descriptions/changing-the-main-product-image'>How to change the main product image in PrestaShop 1.5</a>
					<div>This PrestaShop 1.5 tutorial shows how to change the main image, also known as the cover image, for a product.</div>
					<div class='smallgrey'>Hits: 6,232</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/images-and-descriptions/change-image-position'>How to order images for a product in PrestaShop 1.5</a>
					<div>In this tutorial we'll show you how to change the order images are displayed in for a particular product.</div>
					<div class='smallgrey'>Hits: 1,685</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/images-and-descriptions/removing-product-images'>Removing product images in PrestaShop 1.5</a>
					<div>This tutorial demonstrates how to delete an image from the product image list in PrestaShop 1.5</div>
					<div class='smallgrey'>Hits: 3,854</div>
				</td>
			</tr>
		<tr><td colspan='3' style='padding-top:20px;'><h2>Product Descriptions</h2><div>Tutorials on adding and modifying product descriptions</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 6:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/images-and-descriptions/product-description'>Adding a PrestaShop 1.5 Product Description</a>
					<div>In this tutorial, we'll show you how to enter descriptions for your products.</div>
					<div class='smallgrey'>Hits: 2,959</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/prestashop-15/images-and-descriptions/change-short-description-max-length'>Changing the max length of the short description in PrestaShop 1.5</a>
					<div>Learn how to set the maximum length of a product's short description in PrestaShop 1.5.</div>
					<div class='smallgrey'>Hits: 15,496</div>
				</td>
			</tr>
			</table>
</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNTMmaWQ9MjUzJnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="4ada703added8b8a3093584e1a7bb890" value="1" />	</div>
	</form>
<!-- <br />
