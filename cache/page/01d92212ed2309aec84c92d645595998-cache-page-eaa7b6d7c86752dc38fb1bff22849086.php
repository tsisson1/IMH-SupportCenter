<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:87059:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.info/support/website/wordpress-plugins/change-wordpress-admin-url-with-lockdown-wp-admin" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-04-26T16:03:09-07:00" />
  <meta name="keywords" content="WordPress lockdown wp admin plugin wp-admin wp-login wp-login.php change hide admin url brute force attack security" />
  <meta name="author" content="Jacob Nicholson" />
  <meta name="description" content="Use the WordPress Lockdown WP Admin plugin to secure your WordPress website and change your admin URL to not use the default /wp-admin or wp-login.php" />
  <title>How to Change your WordPress admin URL with Lockdown WP Admin - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/wordpress-plugins/change-wordpress-admin-url-with-lockdown-wp-admin" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:4875336f8b9475bab1653c8d8971a3e8 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-22']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '173.234.165.247']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to Change your WordPress admin URL with Lockdown WP Admin</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to Change your WordPress admin URL with Lockdown WP Admin									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>5,591</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 21, 2014'><span style='color:#606060;'>Published:</span> Apr 26, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Because <a href="http://www.inmotionhosting.com/support/news/general/wp-login-brute-force-attack" target="_blank">WordPress brute force attacks</a> are on the rise, using a WordPress plugin like <strong>Lockdown WP Admin</strong> can help by allowing you to change the WordPress default login URL. This way attackers won't have access to your admin login form, so they can't continually try to guess your password and break in.</p>

<p>If you're curious if your WordPress site has already had malicious users trying to login to your admin dashboard, you can check out my guide on <a href="http://www.inmotionhosting.com/support/website/wordpress/review-wordpress-login-attempts" target="_blank">reviewing WordPress login attempts</a> for easy steps on how to find out.</p>

<p>You also want to make sure after you <a href="#install-plugin">install Lockdown WP Admin</a>,  be sure to <a href="#hide-secret-url">hide the secret URL from the Meta widget</a> so that an attacker can't discover your new server admin address.</p>

<a name="install-plugin"></a>
<h2>Install and configure the Lockdown WP Admin WordPress plugin</h2>

<p>Using the steps below you can quickly install the <strong>Lockdown WP Admin</strong> plugin and configure it so that your normal WordPress login URLs of <strong>/wp-admin</strong> and <strong>wp-login.php</strong> are changed.</p>

<ol class="article_list">

<li><a href="http://www.inmotionhosting.com/support/edu/wordpress/wordpress-introduction/logging-into-wordpress-dashboard" target="_blank">Login to WordPress admin dashboard</a></li>
<li>For this plugin to function correctly your site must first be be using <a href="http://www.inmotionhosting.com/support/edu/wordpress/wordpress-features/setting-up-permalinks-on-your-wordpress-site" target="_blank">WordPress permalinks</a></li>
<li>
    <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/lockdown-wp-admin/hover-over-plugins-click-on-add-new.png"><img  style="float: right; width: 190px;" src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/lockdown-wp-admin/hover-over-plugins-click-on-add-new.png" alt="hover over plugins click on add new"></a>
    <p>Hover over <strong>Plugins</strong>, then click on <strong>Add New</strong></p>
    <div style="clear: both;"></div>
</li>

<li>
    <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/lockdown-wp-admin/type-in-lockdown-wp-admin-click-search-plugins.png"><img  style="float: right; width: 190px;" src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/lockdown-wp-admin/type-in-lockdown-wp-admin-click-search-plugins.png" alt="type in lockdown wp-admin click search plugins"></a>
    <p>Type in <strong>Lockdown WP Admin</strong>, then click on <strong>Search Plugins</strong></p>
    <div style="clear: both;"></div>
</li>

<li>
    <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/lockdown-wp-admin/click-install-now-beside-lockdown-wp-admin.png"><img  style="float: right; width: 190px;" src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/lockdown-wp-admin/click-install-now-beside-lockdown-wp-admin.png" alt="click install now beside lockdown wp-admin"></a>
    <p>Click on <strong>Install Now</strong> beside the <strong>Lockdown WP Admin</strong> plugin</p>
    <div style="clear: both;"></div>
</li>

<li>
    <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/lockdown-wp-admin/click-ok-on-pop-up.png"><img  style="float: right; width: 190px;" src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/lockdown-wp-admin/click-ok-on-pop-up.png" alt="click ok on pop up"></a>
    <p>Click <strong>OK</strong> on the confirmation pop-up window</p>
    <div style="clear: both;"></div>
</li>

<li>
    <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/lockdown-wp-admin/click-activate-plugin.png"><img  style="float: right; width: 190px;" src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/lockdown-wp-admin/click-activate-plugin.png" alt="click activate plugin"></a>
    <p>Click <strong>Activate Plugin</strong></p>
    <div style="clear: both;"></div>
</li>

<li>
    <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/lockdown-wp-admin/hover-over-lockdown-wp-click-lockdown-wp.png"><img  style="float: right; width: 190px;" src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/lockdown-wp-admin/hover-over-lockdown-wp-click-lockdown-wp.png" alt="hover over lockdown wp click lockdown wp"></a>
    <p>Hover over the new <strong>Lockdown WP</strong>, then click on <strong>Lockdown WP</strong></p>
    <div style="clear: both;"></div>
</li>

<li>
    <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/lockdown-wp-admin/configure-lockdown-wp-admin-plugin-click-save-options.png"><img  style="float: right; width: 190px; margin-left: 5px;" src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/lockdown-wp-admin/configure-lockdown-wp-admin-plugin-click-save-options.png" alt="configure lockdown wp admin plugin click save options"></a>
    <p>Place a check beside <strong>Yes, please hide WP Admin from the user...</strong></p>
    <p>Change your <strong>WordPress Login URL</strong> to something like <strong>secret-admin</strong></p>
    <p>Leave <strong>Disable HTTP Auth</strong> selected, click <strong>Save Options</strong></p>
    <div style="background-color: #FAFAD2; border: 1px #D3D3D3 dashed; border-radius: 5px; padding: 0px 0px 0px 5px; margin-top: 20px;">
    <p><em>If you use the <strong>HTTP Auth</strong> options the plugin will let you also <a href="http://www.inmotionhosting.com/support/website/wordpress/prevent-unauthorized-wp-admin-wp-login-php-attempts" target="_blank">create a secondary WordPress admin .htaccess password</a>. This secondary password would have to be entered in, even if someone guessed your secret login URL.</em></p>
    <p><em>Selecting <strong>WordPress Login Credentials</strong> will prompt you for your normal WordPress admin username and password, prior to gaining access to the actual WordPress admin login page.</em></p>
    <p><em>If you instead use <strong>Private Usernames/Passwords</strong> you can configure a new secondary login from the <strong>Lockdown WP &gt; Private Users</strong> section.</em></p>
    <p><em>In my testing of this plugin I didn't have great success with the secondary password protection, which is why I've recommended to leave it disabled as is default.</em></p>
    </div>
    <div style="clear: both;"></div>
</li>

<li>
    <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/lockdown-wp-admin/hover-over-howdy-user-click-log-out.png"><img  style="float: right; width: 190px;" src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/lockdown-wp-admin/hover-over-howdy-user-click-log-out.png" alt="hover over howdy user click log out"></a>
    <p>Hover over <strong>Howdy, User</strong>, then click on <strong>Log Out</strong></p>
    <div style="clear: both;"></div>
</li>

<li>
    <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/lockdown-wp-admin/after-lockdown-wp-admin-plugin-installed-wp-login-url-changed.png"><img  style="float: right; width: 190px;" src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/lockdown-wp-admin/after-lockdown-wp-admin-plugin-installed-wp-login-url-changed.png" alt="after lockdown wp-admin plugin installed wp-login url changed"></a>
    <p>You should see the <strong>secret-admin</strong> URL you set</p>
    <div style="clear: both;"></div>
</li>

<li>
    <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/lockdown-wp-admin/after-lockdown-wp-admin-plugin-installed-404-errors-for-login.png"><img  style="float: right; width: 190px;" src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/lockdown-wp-admin/after-lockdown-wp-admin-plugin-installed-404-errors-for-login.png" alt="after lockdown wp-admin plugin installed 404 errors for login"></a>
    <p>Try to directly access <strong>/wp-admin</strong> or <strong>wp-login.php</strong>, you get a 404 page</p>
    <div style="clear: both;"></div>
</li>

<li>
    <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/lockdown-wp-admin/after-lockdown-wp-admin-plugin-installed-login-with-secret-url.png"><img  style="float: right; width: 190px;" src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/lockdown-wp-admin/after-lockdown-wp-admin-plugin-installed-login-with-secret-url.png" alt="after lockdown wp-admin plugin installed login with secret url"></a>
    <p>Access the <strong>/secret-admin</strong> URL and you get your WordPress login page</p>
    <div style="clear: both;"></div>
</li>

</ol>

<a name="hide-secret-url"></a>
<h2>Prevent WordPress Meta widget from exposing secret login URL</h2>

<p>Unfortunately while the <strong>Lockdown WP Admin</strong> plugin does a great job securing your site from bots that might continually try to hit the default login URLs, it also updates the <strong>Meta widget</strong> in WordPress with the new updated URL as seen below:</p>

<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/lockdown-wp-admin/wordpress-meta-log-in-link-still-links-to-secret-admin.png"><img  style="display: block; margin-left: auto; margin-right: auto"  src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/lockdown-wp-admin/wordpress-meta-log-in-link-still-links-to-secret-admin.png" alt="wordpress meta log in link still links to secret admin"></a>

<p>There are two ways in which you can prevent your secret login URL from being shown like this.</p>

<h3>Remove Meta widget from WordPress</h3>

<ol class="article_list">
<li><a href="http://www.inmotionhosting.com/support/edu/wordpress/wordpress-introduction/logging-into-wordpress-dashboard" target="_blank">Login to WordPress admin dashboard</a></li>

<li>
    <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/lockdown-wp-admin/hover-over-appearance-click-on-widgets.png"><img  style="float: right; width: 190px;" src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/lockdown-wp-admin/hover-over-appearance-click-on-widgets.png" alt="hover over appearance click on widgets"></a>
    <p>Hover over <strong>Appearance</strong>, then click on <strong>Widgets</strong></p>
    <div style="clear: both;"></div>
</li>

<li>
    <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/lockdown-wp-admin/click-on-meta-then-on-delete.png"><img  style="float: right; width: 190px;" src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/lockdown-wp-admin/click-on-meta-then-on-delete.png" alt="click on meta then on delete"></a>
    <p>Click on the <strong>Meta</strong> widget, then click on <strong>Delete</strong></p>
    <div style="clear: both;"></div>
</li>
</ol>

<h3>Edit WordPress general-template.php file to hide Log In link</h3>

<ol class="article_list">
<p>You can also simply edit the <strong>Log in</strong> link from displaying on your WordPress site by editing your template file. Although note that if you are doing it this way, future WordPress updates might override the files in your <strong>/wp-includes</strong> and revert your changes, so keep that in mind.</p>
<li>Use the <a href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-file-manager/file-manager-code-editor" target="_blank">cPanel File Manager Code Editor</a></li>

<li>
    <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/lockdown-wp-admin/cpanel-file-manager-edit-general-template.png"><img  style="float: right; width: 190px;" src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/lockdown-wp-admin/cpanel-file-manager-edit-general-template.png" alt="cpanel file manager edit general template"></a>
    <p>Navigate to your <strong>/wp-includes</strong> directory</p>
    <p><strong>Right-click</strong> on <strong>general-template.php</strong>, then click <strong>Edit</strong></p>
    <div style="clear: both;"></div>
</li>

<li>
    <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/lockdown-wp-admin/cpanel-file-manager-edit-general-template-before.png"><img  style="float: right; width: 190px;" src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/lockdown-wp-admin/cpanel-file-manager-edit-general-template-before.png" alt="cpanel file manager edit general template before"></a>
    <p>Look for this line of code:</p>
    <div style="clear: both;"></div>
    <pre class="code_block" style="width: 500px;">$link = '&lt;a href="' . esc_url( wp_login_url($redirect) ) . '"&gt;' . __('Log in') . '&lt;/a&gt;';</pre>
    
    <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/lockdown-wp-admin/cpanel-file-manager-edit-general-template-after.png"><img  style="float: right; width: 190px;" src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/lockdown-wp-admin/cpanel-file-manager-edit-general-template-after.png" alt="cpanel file manager edit general template after"></a>
    <p>Comment out the line above with two forward slashes <strong>//</strong></p>
    <div style="clear: both;"></div>
    <p>On the line below it, set the <strong>$link</strong> variable to be blank with this code:</p>
    <pre class="code_block" style="width: 500px;">$link = '';</pre>
    <p>You should end up with the final code looking like this, with your changes in <strong style="color: red;">red</strong>:</p>
    <pre class="code_block" style="width: 500px;">function wp_loginout($redirect = '', $echo = true) {
if ( ! is_user_logged_in() )
<strong style="color: red;">//</strong>$link = '&lt;a href="' . esc_url( wp_login_url($redirect) ) . '"&gt;' . __('Log in') . '&lt;/a&gt;';
<strong style="color: red;">$link = '';</strong>
        else</pre>
</li>

<li>
    <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/lockdown-wp-admin/log-in-link-gone-from-meta-widget.png"><img  style="float: right; width: 190px;" src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/lockdown-wp-admin/log-in-link-gone-from-meta-widget.png" alt="log in link gone from meta widget"></a>
    <p>You should now see that the <strong>Log in</strong> link is gone from the <strong>Meta</strong> widget</p>
    <div style="clear: both;"></div>
</li>

</ol>

<p>You should now know how to add an extra level of security to your WordPress site by making sure that bots and malicious users can't easily get to your admin log in anymore.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.info/support/website/wordpress-plugins/change-wordpress-admin-url-with-lockdown-wp-admin&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.info/support/website/wordpress-plugins/change-wordpress-admin-url-with-lockdown-wp-admin'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NjcmaWQ9MzA3NSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="ca23203db676f81fff6b836502bee209" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/59ae98935eabd85c338a5f2452600f06?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/59ae98935eabd85c338a5f2452600f06'>Kumi</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-27 9:48 am</div>
				                <div>Now the meta widget is gone. How does the admin sign in? And how do join the site and sign in?</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10926);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-27 10:53 am</div>
				                <div>Hello Kumi,<br />
<br />
Your admin login area is now the new 'slug' you created in the plugin, such as '<em>http://example.com/secret</em>'.  Any members that need to log in will also need to use that  URL. <br />
<br />
If the membership plugin you use does use the meta widget, then simply re-enable it and use the other method described above that removes the login link from the page but still allowing all other links.<br />
<br />
Kindest Regards,<br />
Scott M </div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10929);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-28 12:56 am</div>
				                <div><p>How about creating a link to the new path using the Text Widget? I am also worried about those who want to register or join the site for the first time.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10941);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-28 7:54 am</div>
				                <div>Placing an HTML link within a text widget would indeed be a good solution to direct those users to the correct page.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10947);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-23752'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/651d943c8212701eade15f6581596efa?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/651d943c8212701eade15f6581596efa'>John</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-05-27 10:10 pm</div>
				                <div><p>Hi, I have used lockdown WP admin. Our computer accidentally stopped and when I typed the URL login that I created it redirects to the wordpress login but even when I typed my password and username, it redirects me to the website but not with the dashboard.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23752);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-05-28 5:53 pm</div>
				                <div>Hello John,<br />
<br />
Thank you for contacting us. We are happy to help, but will need some additional information.  Are you getting any errors? Putting WordPress in <a href="http://www.inmotionhosting.com/support/website/wordpress/turning-on-wordpress-debugging">Debug mode</a> may provide a more detailed error message.<br />
<br />
Can you provide a link to the site for testing?<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23780);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
