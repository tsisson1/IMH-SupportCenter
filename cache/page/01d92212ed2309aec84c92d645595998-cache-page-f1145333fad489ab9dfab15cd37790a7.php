<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:51402:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/wordpress/fatal-error-calltime-passbyreference-has-been-removed" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, and sorry for the issues! Your server's default PHP version was recently upgraded to PHP 5.4 to enforce better security across the server. Someth..." />
  <title>Fatal error: Call-time pass-by-reference has been removed | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/wordpress/fatal-error-calltime-passbyreference-has-been-removed" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:e08b93561a0e086e543dfea320b9091b -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-22']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '150.70.188.171']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Fatal error: Call-time pass-by-reference has been removed</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2014-07-02 6:34 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>905</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I just tried to log into the admin panel of my site but when I go to http://example.com/wp-admin I get the following error message:<br />
<br />
Fatal error: Call-time pass-by-reference has been removed in /home/userna5/public_html/example.com/wp-content/themes/gymbase_custom/nav-menu-dropdown-walker.php on line 18<br />
<br />
can't acces my site or my WP admin i have no clue what to do!</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_5203' id='upvote_answer_5203' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='5203' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_5203').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_5203' id='downvote_answer_5203' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='5203' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_5203').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>9,968 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2014-07-02 6:44 pm EST
                		        </div>
					
		                </div>

				Hello, and sorry for the issues!<br />
<br />
Your server's default PHP version was recently upgraded to &lt;strong&gt;PHP 5.4&lt;/strong&gt; to enforce better security across the server.<br />
<br />
Somethings have been &lt;a href=&quot;http://en.wikipedia.org/wiki/Deprecation&quot; target=&quot;_blank&quot;&gt;deprecated&lt;/a&gt; in this newer version, and it looks like one of your theme's files was trying to use such a feature.<br />
<br />
I've gone ahead and resolved this for your by setting your account back to &lt;strong&gt;PHP 5.3&lt;/strong&gt; as the default. In the future if you run into similar problems you can always &lt;a href=&quot;http://www.inmotionhosting.com/support/website/php/how-to-change-the-php-version-your-account-uses&quot; target=&quot;_blank&quot;&gt;change the PHP version in cPanel&lt;/a&gt; or even &lt;a href=&quot;http://www.inmotionhosting.com/support/website/php-configuration/using-multiple-php-versions-one-account&quot; target=&quot;_blank&quot;&gt;run multiple versions of PHP&lt;/a&gt; on your account in the event that some of your directories require a specific version of PHP to function properly.<br />
<br />
...
- Jacob
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_5203').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_5203' id='form_comment_on_answer_5203' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/wordpress/fatal-error-calltime-passbyreference-has-been-removed&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/wordpress/fatal-error-calltime-passbyreference-has-been-removed'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="640a911abae267d7a363ea345364fc84" value="1" />	</div>
	</form>
<!-- <br />
