...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/amp" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="InMotion Hosting Support Center" />
  <title>Welcome to AMP | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/amp" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:a3b5a09f465a80828fea38b1b54f7309 -->
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Welcome to AMP</span></li>			</ul>
		</div>
	</div>
</div>
...
<p>The <strong>Account Management Panel</strong> is your Launching Pad to access almost any tool you'll use in relation to your hosting account with us.  In addition to that, it will be used primarily for managing the billing and domain management aspects of your account. Within AMP, you can do many things such as:
<ul><li>Register, Transfer, & Manage Domains</li>
<li>Access your Hosting/Server Control Panel (cPanel)</li>
<li>Install Software</li>
<li>Update Billing & Contact Information</li>
<li>Renew your subscriptions</li>
<li>Order additional services, hosting, domains, SSL Certificates, IP Addresses, etc.</li></ul></p>

  
  <p class="alert" style="color:red"><strong>***AMP has been revAMP'd to improve your experience***</strong><br>
Our newly updated AMP has had a redesign to:<br>
Update the look & feel.<br>
Improve useability and flow.<br>
Reduce clicks to your most accessed features.<br>
  ...and more!  Enjoy your new AMP!</p>
 ...
 <div class="white_box" style="margin-bottom: 20px;padding: 15px; width: 605px;">
  <div style="float:left; width:295px; margin-right: 15px;">
    ...
    <p>If you are new to the AMP, we recommend reading these first.</p>
    <ul>
      <li><a href="/support/website/amp/how-to-log-into-amp">How to Login to AMP</a></a></li>
      <li><a href="/support/website/amp/amp-vs-cpanel">AMP vs. cPanel</a></li>
      <li><a href="/support/website/amp/what-is-my-username-and-password">What is my username and password (I forgot)?</a></li>
      <li><a href="/support/website/amp/viewing-account-technicial-information-in-amp">Viewing Your Account's Technical Information in AMP</a></li>
    </ul>
  </div><!-- end left div -->
  
  <div style="float:left;margin-bottom:15px;width:295px;" >
    <h2 style="margin-top:0px; color: #888; background: url('/support/templates/supportcentertemplate/images/red_icons/icon_domains.png') no-repeat left center; padding-left: 35px;">Manage my account</h2>
    <p>In AMP you can manage many aspects of your account.</p>
    <ul>
      <li><a href="/support/website/amp/change-amp-password">Change your AMP Password</a></li>
      <li>change my contact information (login address)</a></li>
...
<div class="white_box" style="margin-bottom: 20px; padding: 15px; width: 605px;">
  <div style="float:left; width:295px; margin-right: 15px;">
    <h2 style="margin-top:0px; color: #888;  background: url('/support/templates/supportcentertemplate/images/red_icons/icon_transfers.png') no-repeat left center; padding-left: 35px;">Billing</h2>
    <p>These tutorials will show you how to perform billing related tasks in AMP.</p>
    <ul>
      <li><a href="/support/website/billing/update-billing-contact-information">Update your Billing/Contact Information</a></li>
      <li><a href="/support/website/billing/renew-current-plan-amp">Renew your Subscriptions</a></li>
      <li><a href="/support/website/amp/upgrade-downgrade-hosting-plan">Upgrade or Downgrade your Hosting Plan</a></li>
      <li><a href="/support/team/additional-hosting">Purchase Additional Hosting Plans</a></li>
    </ul>
  </div><!-- end left div -->
  
  <div style="float:left; margin-bottom:15px; width:295px;" >
    <h2 style="margin-top:0px; color: #888; background: url('/support/templates/supportcentertemplate/images/red_icons/icon_whmcs.png') no-repeat left center; padding-left: 35px;">Domains</h2>
    <p>Aspects of your domain can be managed in AMP, these guides will walk you through these options.</p>
    <ul>
      <li><a href="/support/domain-names/registrations-and-transfers/registering-a-new-domain-name">Register a New Domain</a></li>
      <li><a href="/support/domain-names/general-information/add-privacy-existing-domains">Add Domain Privacy</a></li>
      <li><a href="/support/domain-names/registrations-and-transfers/transfer-domain-name-to-inmotion-hosting">Transfer your Domain Name</a></li>
      <li><a href="/support/domain-names/dns-nameserver-changes/change-domain-nameservers-amp">Change your Nameservers</a></li>
      <li><a href="/support/domain-names/dns-nameserver-changes/using-custom-name-servers">Use custom nameservers</a></li>
      <li><a href="/support/domain-names/general-information/cancel-domain-registration">Cancel Domain Registration</a></li>
    </ul>
  </div><!-- end right div-->
</div><!-- end white_box -->
...
<div class="white_box" style="margin-bottom: 20px; padding: 15px; width: 605px;">
  <div style="float:left; width:295px; margin-right: 15px;">
    <h2 style="margin-top:0px; color: #888;  background: url('/support/templates/supportcentertemplate/images/red_icons/icon_transfers.png') no-repeat left center; padding-left: 35px;">SSL</h2>
    <p>These tutorials will show you how to perform billing related tasks in AMP.</p>
    <ul>
      <li><a href="/support/website/ssl/how-do-i-obtain-an-ssl-certificate">Purchase an SSL</a></li>
      <li><a href="/support/website/ssl/install-third-party-ssl">Request a CSR</li>
      <li><a href="/support/website/ip-addresses/purchase-dedicated-ip-address-amp">Obtain a Dedicated IP</a></li>   
    </ul>
  </div><!-- end left div -->
  
  <div style="float:left; margin-bottom:15px; width:295px;" >
    <h2 style="margin-top:0px; color: #888; background: url('/support/templates/supportcentertemplate/images/red_icons/icon_whmcs.png') no-repeat left center; padding-left: 35px;">Email</h2>
    <p>AMP provides access to email options, which are covered in this section.</p>
    <ul>
      <li><a href="/support/edu/everything-email/introduction-email/creating-email-account">Create an Email Address</a></li>
      <li><a href="/support/edu/cpanel/cpanel-email/logging-into-webmail">Login to Webmail</a></li>
    </ul>
  </div><!-- end right div-->
</div><!-- end white_box -->  
...
<br style="clear: both;"/>
<form action="http://www.inmotionhosting.com/support/website/amp" method="post" name="adminForm" id="adminForm" class="form-inline">
  ...
  <table class='article_list'>
          ...
          <tr>
                  ...
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/website/amp/viewing-account-technicial-information-in-amp'>Viewing Your Account's Technical Information in AMP</a></td>
                                <td>63,049</td>
                        </tr>
                  <tr>
                  ...
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/website/amp/wtr'>Request a website transfer in AMP</a></td>
                                <td>10,838</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/website/amp/my-account-has-been-moved-to-another-server'>My Account has been moved to another server</a></td>
                                <td>6,023</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/website/amp/i-forgot-my-account-management-panel-amp-password'>I forgot my Account Management Panel (AMP ) password</a></td>
                                <td>5,079</td>
                        </tr>
                  <tr>
		...
		<ul><li class="pagination-start"><span class="pagenav">Start</span></li><li class="pagination-prev"><span class="pagenav">Prev</span></li><li><span class="pagenav">1</span></li><li><a href="/support/website/amp?start=15" class="pagenav">2</a></li><li class="pagination-next"><a title="Next" href="/support/website/amp?start=15" class="hasTooltip pagenav">Next</a></li><li class="pagination-end"><a title="End" href="/support/website/amp?start=15" class="hasTooltip pagenav">End</a></li></ul>	</div>
	</form>
