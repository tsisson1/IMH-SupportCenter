<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:51987:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/wordpress/multiple-wordpress-installs-domain" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Mike, Thanks for the question about the WordPress installation limits. Yes, you install multiple wordpress installations using subdomains. For exa..." />
  <title>Can you have Multiple WordPress installations under one domain? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/wordpress/multiple-wordpress-installs-domain" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:5a92b29dd21036a54e6f41feab7a7a9c -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '104.129.9.196']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Can you have Multiple WordPress installations under one domain?</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/spike71'>spike71</a>
			<div>13 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-03-16 2:26 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>171</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Can you have multiple Wordpress installs on the same server or domain? I currently have a wordpress install on the root on my domain.<br />
<br />
http://www.standrewsshippensburg.org<br />
<br />
can i have another one? Reason why is that someone whats to learn wordpress and help me out. I just do not want them playing in the production install. So could i have another website just for test like...<br />
<br />
http://www.standrewsshippensburg.org\test<br />
<br />
or should i make a sub domain like<br />
<br />
http://www.test.standrewsshippensburg.org?<br />
<br />
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_6786' id='upvote_answer_6786' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='6786' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_6786').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_6786' id='downvote_answer_6786' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='6786' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_6786').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Mike,<br />
<br />
Thanks for the question about the WordPress installation limits.  Yes, you install multiple wordpress installations using subdomains.  For example, http://domain_name.com/wordpress1, http://domain_name.com/wordpress2, etc.   If you are a customer of InMotion, check out <a href="http://www.inmotionhosting.com/support/edu/wordpress/wordpress-introduction/install-wordpress-using-softaculous">Installing Wordpress with Softaculous</a>.  It would make the installations much easier .  <br />
<br />
...
<br />
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_6786').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_6786' id='form_comment_on_answer_6786' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>thanks Arn! I appreciate it! oh yeah! i am an InMotion customer.. You guys are great!!!<br />
</div>
							...
							<td style='width:96px;' valign='top'>
								...
								<div class='smallgrey'>
									<a href='/support/community-support/users/spike71'>spike71</a><br />
									13 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2015-03-16 3:50 pm EST
								</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/wordpress/multiple-wordpress-installs-domain&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/wordpress/multiple-wordpress-installs-domain'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="ae9ed0650cbb2ee10891bfe59aa62947" value="1" />	</div>
	</form>
<!-- <br />
