<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:53139:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/email-client-setup/how-can-i-forward-email-to-a-hotmail-or-gmail-account" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Doug, You can access your email from the InMotion servers at any time and from anywhere by accessing the webmail login at yourdomain.com/webmail (..." />
  <title>How can I forward email to a Hotmail or Gmail account? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/email-client-setup/how-can-i-forward-email-to-a-hotmail-or-gmail-account" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:3bab1a5dd5756ad6b9987425c0ac68c9 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '193.206.55.34']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box straight_bottom'>
                <h1 style='font-size:26px;'>How can I forward email to a Hotmail or Gmail account?</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/Doug Nienhuis'>Doug Nienhuis</a>
			<div>25 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-09-14 10:48 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>12,959</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I set up an email account for my blog. However, I have no idea how to use it. I read all the articles and watched all the videos, but I can't connect the dots somehow.<br />
<br />
The easiest way to access my email from anywhere in the world seems to be to have email for my Inmotion email account forwarded to either Hotmail or Gmail. <br />
<br />
But to do that, do I still have to set up an email client? I assume I have to use a Webmail client (like Squirrelmail), but I see no option to set up Squirrelmail or any other webmail client. When I follow the steps in the tutorial videos, I am given a list of Outlook Express options and that's all. <br />
<br />
So, I don't understand how my email account, the email client, and the forwarding work together and what steps to follow to set them up. In the end, I can't figure out where the emails actually would go and how to access them.<br />
<br />
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px;'>
				<div style='font-size:12px; max-width:500px; overflow:auto;'>i am not sure where to start<br />
</div>
				
				
			</td>
			<td style='width:100px;' valign='top'>
				<img src='http://graph.facebook.com/lee.ellingson1/picture?type=normal' style='width:40px;' class='user_avatar' />
				<div class='smallgrey'>
					<a href='/support/community-support/users/hunter9o'>hunter9o</a><br />
					0 <a href='/support/team/points' target='_blank'>Points</a><br />
					2013-03-29 02:23 am EST
				</div>
			</td>
		</tr>
	</table>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_1557' id='upvote_answer_1557' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='1557' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_1557').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_1557' id='downvote_answer_1557' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='1557' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_1557').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
...
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_1557').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_1557' id='form_comment_on_answer_1557' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
...
I was reading through your comment it was very helpful, but I need to configure my web account (me@mydoamin.com) to gmail or hotmail/outlook. Is there any way to do this ?<br />
<br />
Little weak in English Grammer.<br />
<br />
Regards,<br />
Haris Ola </div>
							...
							<td style='width:96px;' valign='top'>
								<img src='http://graph.facebook.com/harisola/picture?type=normal' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/harisola'>harisola</a><br />
									3 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2013-04-12 12:21 pm EST
								</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/email-client-setup/how-can-i-forward-email-to-a-hotmail-or-gmail-account&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/email-client-setup/how-can-i-forward-email-to-a-hotmail-or-gmail-account'></div>
<script type='text/javascript'>
  (function() {
