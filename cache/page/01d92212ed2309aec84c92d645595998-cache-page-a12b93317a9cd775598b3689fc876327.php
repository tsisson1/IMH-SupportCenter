<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:66797:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotion.net/support/email/mac-mail/disable-imap-idle-mac-mail" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-02-04T21:41:58-08:00" />
  <meta name="keywords" content="mac mail imap idle disable turn off" />
  <meta name="author" content="Jacob Nicholson" />
  <meta name="description" content="In this article we discuss the possible negative impact of having IMAP IDLE enabled in Mac Mail, and how to disable it." />
  <title>Disable IMAP IDLE in Mac Mail - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/email/mac-mail/disable-imap-idle-mac-mail" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:d887c060f669aab606cb1c7df3faa92e -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Disable IMAP IDLE in Mac Mail									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>15,011</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Oct 31, 2012'><span style='color:#606060;'>Published:</span> Feb 4, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Most email clients these days offer the ability to utilize the IDLE function of IMAP. What the IMAP IDLE function does is leave a connection open on the mail server, then as soon as a new email has arrived it alerts the mail client and pushes the new message to the client.</p>
<p>In theory this sounds like a very good thing to have configured for your mailbox, unfortunately we've seen some problems with the way that Apple's Mac Mail handles this function of the IMAP protocol, it seems to leave open multiple IMAP connections instead of just one and over time they can pile up and become problematic.</p>
<p>So if you're using Mac Mail you might want to think about disabling this specific function, especially if you've received a notice from our system administration department regarding <a href="http://www.inmotionhosting.com/support/email/email-troubleshooting/imap-resource-usage" target="_blank">excessive resource usage coming from your IMAP activity</a>.</p>
<ol class="article_list">
<li>From the <em>Mail </em>drop-down, click on <strong>Preferences</strong>.<strong><br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/macmail/imap-idle/mac-mail-preferences.png"><img src="//cdn.inmotionhosting.com/support/images/stories/macmail/imap-idle/mac-mail-preferences.png" alt="mac-mail-preferences"  /></a><br /><br /></strong></li>
<li>Click on<strong> Accounts</strong>.</li>
<li>Select your IMAP account from the list on the left.</li>
<li>Click on the <strong>Advanced</strong> tab.</li>
<li>Now disable the <strong>Use Idle</strong> setting.</li>
</ol>
<p>&nbsp;</p>
<p>That should be all that is necessary in order to go ahead and disable the IMAP IDLE function in your Mac Mail client. This should help ensure that your email client is causing any adverse problems on the server while it's trying to continually synchronize messages.</p>
<p>&nbsp;</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotion.net/support/email/mac-mail/disable-imap-idle-mac-mail&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotion.net/support/email/mac-mail/disable-imap-idle-mac-mail'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD01OSZpZD03ODcmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/e5db791443e6e6e040a4789e6177ac4f?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/e5db791443e6e6e040a4789e6177ac4f'>Glenn</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-29 3:10 pm</div>
				                <div>In Mac Mail the Idle Command is grated out and cannot be unchecked. Because of this my Mac Mail will not get new mail unless you quit and restart or go offline then online.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14498);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-10 12:06 pm</div>
				                <div>Hello Glenn,<br />
<br />
Thank you for your question. This may be 2 separate issues, since Apple recently announced a known issue  where "<em><a href="http://support.apple.com/en-us/TS5367" target="_blank" >New email messages not received until Mail is quit and reopened</a></em>." There is a work around included in that Apple article.<br />
<br />
The "greyed out" Idle setting seems to be a problem with some <a href="http://forums.macrumors.com/showthread.php?t=1613694" target="_blank" rel="nofollow">email providers</a>. <br />
<br />
I tested on a Mac mail account connected to our servers, and this option is not grayed out. If your email is handled by us and this setting is not working, please provide more details such as your domain name, so we can investigate further.<br />
<br />
If you have any further questions, feel free to post them below.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17279);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						...
						<div><a style='font-size:16px;' href='/support/community-support/users/alvinlim'>alvinlim</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-24 11:26 am</div>
				                <div>Has InMotion submitted this issue to Apple? I would imagine that you guys would be in the best position to do so since you handle lots of Mac Mail + IMAP issues - enough for you to write this!<br />
<br />
thanks for the support so far.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22916);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/6118165929b472bfa43c912c75f1a89c?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/6118165929b472bfa43c912c75f1a89c'>Edouard Kestemont</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-17 6:15 am</div>
				                <div><p>What is the state of this problem. Has Apple taken any action ?</p>
<p>Is it still a problem in El Capitan 10.11.1 ?</p>
<p>&nbsp;</p>
<p>Thanks</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28485);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-17 10:08 am</div>
				                <div>Hello Edouard,<br />
<br />
Yes at this time, this is still a problem even with the new Mac Mail software.<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28492);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-28498'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/baefe9acce4f978d83064fb9405d496f?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/baefe9acce4f978d83064fb9405d496f'>Lee Dronick</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-17 12:40 pm</div>
				                <div><p>Is the problem with Apple or is it with your software?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28498);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-17 12:43 pm</div>
				                <div>Hello Lee,<br />
<br />
This is a problem with Mac Mail specifically as it has affects on all email hosting providers.<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28499);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
