<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:62038:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/wordpress/wordpress-plugins-widgets/add-remove-sidbar-widgets" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-12-06T13:30:30-08:00" />
  <meta name="keywords" content="customize WordPress sidebar footer widgets links calendar blogroll page pages" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="This tutorial will discuss how to customize the WordPress sidebar/footer widgets." />
  <title>Deactivating widgets from the sidebar in WordPress - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/wordpress/wordpress-plugins-widgets/add-remove-sidbar-widgets" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:a64634a79b4972d4dac9d03b75016ece -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '72.24.185.131']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Deactivating widgets from the sidebar in WordPress									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>5,749</span></div>
							...
							<div style='clear:both;'></div>
								...
								<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/104/add-remove-widgets/add-remove-sidebar-1.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="add-remove-sidebar-1" src="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/104/add-remove-widgets/add-remove-sidebar-1.gif" title="Click here to view the larger image" width="100" /></a>Widgets are plugins that are used to customize the appearance of the WordPress site. If you have not already, please visit the <a href="/support/edu/wordpress/wordpress-plugins-widgets/what-are-plugins-and-widgets" target="_blank" title="Click here for more information">What are Plugins and Widgets?</a> for more information. Default WordPress sites can have widgets that are undesirable and can make the site look poor.</p>
<p>In this tutorial, the sidebar/footer widgets will be customized to display a more palatable site. The theme used in this article will be the birdsite theme. Let's go forward in customizing the WordPress widgets.</p>
<div><br style="clear: both;" /></div>
<h3>Deactivate widgets from wordpress</h3>
...
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/104/add-remove-widgets/add-remove-sidebar-2.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="add-remove-sidebar-2-wordpress" src="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/104/add-remove-widgets/add-remove-sidebar-2.gif" title="Click here to view the larger image" width="100" /></a>Navigate to <strong>Appearance</strong> &gt; <strong>Widgets </strong>on the left side of the WordPresss dashboard.
<p class="alert"><strong>Important!</strong> Removing all the widgets will cause the Wordpress site to display a default sidebar link setting (Search, Categories, Archives, Meta). To remove the widgets completely, the code will need to be edited.</p>
<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/104/add-remove-widgets/add-remove-sidebar-3.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="add-remove-sidebar-3-wordpress" src="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/104/add-remove-widgets/add-remove-sidebar-3.gif" title="Click here to view the larger image" width="100" /></a>On the Widgets page, the sidebar links and other features can be removed or added. The table below briefly explains what each area is for.<br style="clear: both;" />
<table class="article_table" border="0">
<tbody>
<tr><th colspan="2" style="background: #cccccc; text-align: center;" valign="top">Widgets</th></tr>
<tr><th valign="top">Available Widgets</th>
<td valign="top">The Available Widgets section will not display on the site. They are available for use by dragging them to the widget-area.</td>
</tr>
<tr><th valign="top">widget-area</th>
<td valign="top">The widget-area is the list of current widgets that are displaying on the site.</td>
</tr>
<tr><th valign="top">Inactive widgets</th>
<td valign="top">The Inactive widgets are for removing widgets from the site, while keeping the settings.</td>
</tr>
</tbody>
</table>
<br style="clear: both;" />
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/104/add-remove-widgets/add-remove-sidebar-4.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="add-remove-sidebar-4-wordpress" src="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/104/add-remove-widgets/add-remove-sidebar-4.gif" title="Click here to view the larger image" width="100" /></a><strong>Drag a Widget from the widgets-area to the Available Widgets.</strong> Drag back and forth the different Widgets you want to display on the site. In this tutorial, the Blogroll, Pages, and Meta widgets will only be used.</p>
<p>Dragging the widgets to the Available widgets area will automatically save. <strong>No publishing is required</strong>.</p>
<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/104/add-remove-widgets/add-remove-sidebar-5.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="add-remove-sidebar-5-wordpress" src="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/104/add-remove-widgets/add-remove-sidebar-5.gif" title="Click here to view the larger image" width="100" /></a>Now when visiting the site, only the Blogroll, Pages, and Meta links will display. <br style="clear: both;" /></li>
</ol>
<p>To learn more about Widgets, please visit <a target="_blank" href="/support/edu/wordpress/wordpress-plugins-widgets" title="Click here to view the courses">Introduction to Plugins &amp; Widgets</a></p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 6: Deactivating widgets from the sidebar in WordPress</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 7: <a href='/support/edu/wordpress/wordpress-plugins-widgets/remove-sidebar-links-completely'>Completely disabling the sidebar links/widgets in WordPress</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/wordpress/wordpress-plugins-widgets/add-remove-sidbar-widgets&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/wordpress/wordpress-plugins-widgets/add-remove-sidbar-widgets'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xMjgmaWQ9MjA0MCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="32e6d0343e3c88ed660ce56f0c8cd10b" value="1" />	</div>
	</form>
<!-- <br />
