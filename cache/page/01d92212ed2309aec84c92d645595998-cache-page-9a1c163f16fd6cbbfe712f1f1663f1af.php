<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50953:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/wordpress/back-ups-and-http-issues" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello JohnSnowLabs, Thank you for your questions on backups and HTTPS. For your first question, we do backup accounts regularly. As long as your account..." />
  <title>Back Ups and http issues | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/wordpress/back-ups-and-http-issues" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:9eca2b8b7775bdc5e45de81875db7365 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Back Ups and http issues</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/JohnSnowLabs'>JohnSnowLabs</a>
			<div>0 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2016-05-07 4:03 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>14</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Hello and thanks for your help!<br />
<br />
We have 2 questions:<br />
<br />
1. We need a weekly/monthly (depending on your services) back up. Can you do this automatically or do we need to hire someone to do it? Please advice, as we do remember this was on the plan.<br />
<br />
2. What is the procedure to switch from http to https? We've noticed that Linkedin needs https to redirect people to our site. Please advise if you can do this.<br />
<br />
Many thanks.</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_9855' id='upvote_answer_9855' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='9855' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_9855').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_9855' id='downvote_answer_9855' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='9855' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_9855').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>36,987 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2016-05-09 8:50 am EST
                		        </div>
					
		                </div>

				Hello JohnSnowLabs,<br />
<br />
Thank you for your questions on backups and HTTPS. For your first question, we do backup accounts regularly. As long as your account is under 10GB, it should be backed up daily. Only a single backup is kept, so it will only have what was present 24 hours before. We always recommend customers doing their own backups as well, for extra insurance. You can <a href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-file-manager/complete-cpanel-backup">make backups at any time via the cPanel</a>.<br />
<br />
For the second question, in order for your site to appear on the HTTPS protocol, you would need to <a href="http://www.inmotionhosting.com/support/website/ssl/how-do-i-obtain-an-ssl-certificate">purchase an SSL</a> and have us install it on your site. That is all that is needed.<br />
<br />
Kindest Regards,<br />
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_9855').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_9855' id='form_comment_on_answer_9855' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/wordpress/back-ups-and-http-issues&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/wordpress/back-ups-and-http-issues'></div>
<script type='text/javascript'>
  (function() {
