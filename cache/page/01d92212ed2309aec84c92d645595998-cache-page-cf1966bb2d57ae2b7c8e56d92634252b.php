<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:57281:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/phpbb/working-with-users/create-user" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-01-15T16:41:26-08:00" />
  <meta name="keywords" content="create new user phpBB 3.0 [gs]" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Learn to create a user in this phpBB 3.0 tutorial." />
  <title>How to create a user in phpBB 3.0 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/phpbb/working-with-users/create-user" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:12c30f6c354e97e1fe39a88c021db245 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to create a user in phpBB 3.0									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>5,750</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Dec 6, 2012'><span style='color:#606060;'>Published:</span> Jan 15, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Users are the members of your site that will help you build your community by creating and responding to conversations within your community. By default, there is not a way to add a user in the admin dashboard of phpBB 3.0, so the purpose of this tutorial is to show you from a user's perspective what it's like to register for an account. Follow the instructions below to learn how to add a user in phpBB 3.0.</p>
<p><strong>Creating a new user in phpBB 3.0</strong></p>
<ol class="article_list">
<li>Visit your phpBB board's main page. Locate and click on the Register link found in the upper right corner of the screen.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/users-and-groups/create-new-user/1-click-register.png"><img  alt="1-click-register" src="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/users-and-groups/create-new-user/1-click-register.png" /></a></li>
<li>Next is the Terms of Service screen. This explains the general terms and conditions of behavior for your board. Click on <strong>I Agree To These Terms</strong> to continue to the next step.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/users-and-groups/create-new-user/2-terms-of-service.png"><img  alt="2-terms-of-service" src="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/users-and-groups/create-new-user/2-terms-of-service.png" /></a></li>
<li>The next page is the basic registration page with several fields. All fields on this page are required. At the bottom of the page is a captcha security feature that must be passed to continue. This prevents 'bots', or automated programs, from creating fake users. Click the <strong>Submit</strong> button at the bottom of the page to complete the form and save the information.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/users-and-groups/create-new-user/3-basic-information.png"><img  alt="3-basic-information" src="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/users-and-groups/create-new-user/3-basic-information.png" /></a></li>
<li>The last page is the confirmation of the account creation. It means all data entered was valid and saved to the database. This new user can low <a href="/support/edu/phpbb/getting-started-phpbb/phpbb-login">log into</a> the forum.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/users-and-groups/create-new-user/4-account-created.png"><img  alt="4-account-created" src="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/users-and-groups/create-new-user/4-account-created.png" /></a></li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 2: How to create a user in phpBB 3.0</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 1: <a href='/support/edu/phpbb/working-with-users/change-user-password'>How to change a user's password in phpBB</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 3: <a href='/support/edu/phpbb/working-with-users/delete-user'>How to delete a user account in phpBB 3.0</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/phpbb/working-with-users/create-user&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/phpbb/working-with-users/create-user'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMDEmaWQ9MjA1MSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="0076e11448be71fc3a5fec532b594c87" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
        ...
        <tr><td colspan='2'><h4>User Management</h4></td></tr>  <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>2.</td>
