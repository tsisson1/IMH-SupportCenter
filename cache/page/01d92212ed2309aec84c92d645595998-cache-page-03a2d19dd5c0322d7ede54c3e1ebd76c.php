<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:92931:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/server-usage/view-level-of-traffic-with-apache-access-log" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-01-23T18:22:39-08:00" />
  <meta name="keywords" content="use using view apache website access log logs stats statistics" />
  ...
  <link href="http://www.inmotionhosting.com/support/website/server-usage/view-level-of-traffic-with-apache-access-log" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:470136df0e1ddfe5fbfb3f2dda672b5a -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-22']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '207.109.138.40']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															View level of traffic with Apache access log									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>44,707</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 23, 2013'><span style='color:#606060;'>Published:</span> Jan 23, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In this article I'll be teaching you how to use the Apache access logs on your VPS (Virtual Private Server) or dedicated server to inspect the levels of traffic your websites are receiving.</p>
...
<p>If you've been having problems with the load average on your server spiking by either following the steps in my guide on <a href="/support/website/server-usage/create-server-load-monitoring-bash-script" target="_blank">creating a server load monitoring script</a>, or by using some <a href="/support/website/server-usage/advanced-server-load-monitoring" target="_blank">advanced server load monitoring</a> tactics, then reviewing your Apache access logs is a good thing to do.</p>
<p>I already covered in my article on <a href="/support/website/website-troubleshooting/determine-cause-of-server-usage-spike" target="_blank">how to determine cause of a server usage spike</a> how you can track down a specific time range in your Apache access log to correlate it with a recent server load spike. In this particular article I'm going to focus more broadly on reviewing the entire Apache access log for your website rather than just a small portion of it.</p>
...
<li><a href="/support/website/general-server-setup/how-to-login-ssh" target="”_blank”">Login to your server via SSH</a>.</li>
<li>Navigate to your <strong>/access-logs</strong> directory with the following command, in this example our username is <strong>userna5</strong>:
<p class="code_block" style="width: 500px;">cd ~userna5/access-logs</p>
</li>
<li>Run the following command to view what Apache access logs are currently in the directory:
<p class="code_block" style="width: 500px;">ls -lahtr</p>
<p>You should get back a listing similar to this:</p>
<p class="code_block" style="width: 500px;">drwxr-xr-x 3 root at0m 4.0K Dec 31 16:47 .<br /> drwx--x--x 9 root wheel 4.0K Jan 4 06:01 ..<br /> -rw-r----- 2 root at0m 15K Jan 9 05:09 ftp.example.com-ftp_log<br /> -rw-r----- 2 root at0m 3M Jan 23 13:10 example.com</p>
</li>
<h3>View Apache requests per day</h3>
<li>Run the following command to see requests per day:
<p class="code_block" style="width: 500px;">awk '{print $4}' example.com | cut -d: -f1 | uniq -c</p>
<p><strong>Code breakdown:</strong></p>
<table class="article_table">
<tbody>
<tr><th style="width: 55%; padding: 15px;">awk '{print $4}' example.com</th>
...
<tr><th style="width: 55%; padding: 15px;">cut -d: -f1 | uniq -c</th>
...
<p class="code_block" style="width: 500px;">6095 [20/Jan/2013<br /> 7281 [21/Jan/2013<br /> 6517 [22/Jan/2013<br /> 5278 [23/Jan/2013</p>
</li>
<h3>View Apache requests per hour</h3>
<li>Run the following command to see requests per hour:
<p class="code_block" style="width: 500px;">grep "23/Jan" progolfdeal.com | cut -d[ -f2 | cut -d] -f1 | awk -F: '{print $2":00"}' | sort -n | uniq -c</p>
<p><strong>Code breakdown:</strong></p>
<table class="article_table">
<tbody>
<tr><th style="width: 55%; padding: 15px;">grep "23/Jan" progolfdeal.com</th>
<td style="padding: 15px;">Use the <strong>grep</strong> command to only show hits from today from the Apache access log.</td>
</tr>
<tr><th style="width: 55%; padding: 15px;">cut -d[ -f2 | cut -d] -f1</th>
...
<tr><th style="width: 55%; padding: 15px;">awk -F: '{print $2":00"}'</th>
...
<tr><th style="width: 55%; padding: 15px;">sort -n | uniq -c</th>
<td style="padding: 15px;">Finally sort the hours numerically, and then uniquely count them up.</td>
</tr>
</tbody>
</table>
<p>You should get back something like this:</p>
<p class="code_block" style="width: 500px;">200 00:00<br /> 417 01:00<br /> 244 02:00<br /> 242 03:00<br /> 344 04:00<br /> 402 05:00<br /> 522 06:00<br /> 456 07:00<br /> 490 08:00<br /> 438 09:00<br /> 430 10:00<br /> 357 11:00<br /> 284 12:00<br /> 391 13:00<br /> 163 14:00</p>
</li>
<h3>View Apache requests per minute</h3>
<li>Run the following command to see requests per minute:
<p class="code_block" style="width: 500px;">grep "23/Jan/2013:06" example.com | cut -d[ -f2 | cut -d] -f1 | awk -F: '{print $2":"$3}' | sort -nk1 -nk2 | uniq -c | awk '{ if ($1 &gt; 10) print $0}'</p>
<p><strong>Code breakdown:</strong></p>
<table class="article_table">
<tbody>
<tr><th style="width: 55%; padding: 15px;">grep "23/Jan/2013:06" example.com</th>
...
<tr><th style="width: 55%; padding: 15px;">awk -F: '{print $2":"$3}'</th>
...
<tr><th style="width: 55%; padding: 15px;">sort -nk1 -nk2 | uniq -c</th>
...
<tr><th style="width: 55%; padding: 15px;">awk '{ if ($1 &gt; 10) print $0}'</th>
...
<p class="code_block" style="width: 500px;">12 06:10<br /> 11 06:11<br /> 16 06:12<br /> 13 06:20<br /> 11 06:21<br /> 12 06:28<br /> 12 06:30<br /> 16 06:31<br /> 14 06:39<br /> 11 06:40<br /> 15 06:52<br /> 32 06:53<br /> 43 06:54<br /> 14 06:55</p>
</li>
</ol>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/server-usage/view-level-of-traffic-with-apache-access-log&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/server-usage/view-level-of-traffic-with-apache-access-log'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD04NSZpZD01MTImdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="e378244fd11b13df0e0ebf06fb0772eb" value="1" />	</div>
	</form>
<!-- <br />
...
<a name='comments'></a>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/9b5ed83b3288d0b0659743705c474620?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/9b5ed83b3288d0b0659743705c474620'>ASK</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-13 7:17 am</div>
				                <div><p>Great article! That's what I was looking for. Thank you.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8934);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-9005'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/0602087b28ab89876c8a363d898ef8e3?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/0602087b28ab89876c8a363d898ef8e3'>Alexis</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-18 8:40 am</div>
				                <div><p>Thanks a lot!, this info was very useful for me.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9005);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/39b45176ba9702957ccfea6497c9d659?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/39b45176ba9702957ccfea6497c9d659'>Dimitry</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-11 7:50 am</div>
				                <div>if you feature some sh-scripts with these commands which I can copy and use.<br />
<br />
Another issue is that when I tried these commands, I had to go to my /var/logs/nginx and many of my logs are already gzipped by logrotate. eg. i have small mysite.log and then mysite.log.1 and then mysite.log.2.gz mysite.log.3.gz and so on. So I was only able to use this command on the last short log. If you show how to ease parsing of the logs.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16114);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-31571'></a>
		<div  style='margin:2px 0px 0px 40px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/237b4ca752d456e3d3741d6e20d72314?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/237b4ca752d456e3d3741d6e20d72314'>duppaduudiks</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-31 5:04 am</div>
				                <div><p>This is propably too late to help you, but it may help someone else. If your logs are in gzip form, you can use zcat.</p>
<p>&nbsp;</p>
<p>For example:</p>
<p>zcat /site/mysite.com/logs/access.log.gz | awk '{print $4}' | cut -d: -f1 | uniq -c</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31571);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-17123'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/78a01def9065b6893a626d0700a97de4?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/78a01def9065b6893a626d0700a97de4'>Oliver</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-05 11:59 am</div>
				                <div><p>Thanks, this site was very helpful!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17123);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-20601'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/f00b85a52433f398d14b112e849a976e?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/f00b85a52433f398d14b112e849a976e'>Rahul Raveendran</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-12 6:13 am</div>
				                <div><p>This site was very helpful to me.Thanks</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20601);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-21743'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/f63ff38750b0b8e5f582f1965edd30fb?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/f63ff38750b0b8e5f582f1965edd30fb'>Alexander</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-16 10:18 am</div>
				                <div><p>Thank you very mutch! It's very helpfull fo me</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21743);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-23375'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/f6a5ae014439225634afbeb9fcde4b0c?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/f6a5ae014439225634afbeb9fcde4b0c'>Sam</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-05-12 3:29 pm</div>
				                <div><p>Thanks for this detailed view into Apache logs. Very informative. &nbsp;I was actually looking to calculate "traffic" for a particular website, but these views are VERY helpful as well. cheers for a great post.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23375);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-24449'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/06db06e68f1203101b8286f73aa0a778?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/06db06e68f1203101b8286f73aa0a778'>Jimi Spire</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-25 3:33 pm</div>
				                <div><p>Hi, thanks a bunch for this quite informative article.So i tried your commands on my http/access.log and weirdly, i got different number of hits if I search by hour or by minutes. Explaining:</p>
<p>This command is to filter the log by hours:</p>
<pre>grep "25/Jun" access.log | cut -d[ -f2 | cut -d] -f1 | awk -F: '{print $2":00"}' | sort -n | uniq -c</pre>
<p>It gives me this for the hour 03:</p>
<pre>118 03:00</pre>
<p>But if i search by the minute with this command:</p>
<pre>grep "25/Jun/2015:03" access.log | cut -d[ -f2 | cut -d] -f1 | awk -F: '{print $2":"$3}' | sort -nk1 -nk2 | uniq -c | awk '{ if ($1 &gt; 10) print $0}'</pre>
<p>it gives me this for the hour 03:</p>
<pre>&nbsp; &nbsp; &nbsp;19 03:21</pre>
<pre>&nbsp; &nbsp; &nbsp;52 03:41</pre>
<p>&nbsp;</p>
<p>So 118 against 71 hits for the same hour 03.</p>
<p>&nbsp;</p>
<p>Could you please try to explain that?</p>
<p>&nbsp;</p>
<p>Thank you anyway, those will be useful commands from now on.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24449);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-25 8:04 pm</div>
				                <div>Hello Jimi,<br />
<br />
Thank you for contacting us, we're glad the article was helpful. Several of us looked at this, and unfortunately could not determine why it differs either. If we are able to find any additional information, we will let you know.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24470);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-15 8:06 am</div>
				                <div><p>I am sorry John-Paul, it is my bad.&nbsp;I didn't notice that with the last awk command, we are filtering out minutes for which there is less than 10 hits.&nbsp;It all makes sense now!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24905);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-25233'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/7030f0210adeef0f676b7757f0e1d56f?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/7030f0210adeef0f676b7757f0e1d56f'>Keshav</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-28 7:13 am</div>
				                <div><p>If i have to check for particular application in the access log then what way I have to use the command</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25233);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-28 11:55 pm</div>
				                <div>Hello Keshav,<br />
<br />
In order to view the hits per hour from the application you can use something like the following:<br />
<br />
awk '{print $4}' example.com | grep "application_name" |cut -d: -f1 | uniq -c<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25274);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-29104'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/26839a577e71db42be9f7f737bcf912f?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/26839a577e71db42be9f7f737bcf912f'>ashish</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-12-09 10:10 am</div>
				                <div><p>great article</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29104);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
