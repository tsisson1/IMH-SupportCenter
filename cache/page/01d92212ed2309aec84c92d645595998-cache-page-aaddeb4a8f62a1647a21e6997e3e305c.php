<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:52814:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/cpanel/how-to-exclude-files-from-backup" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, and thanks for the great question! If you'd like to backup your account, but exclude certain files or directories, this can be done with a cpback..." />
  <title>How to exclude files from backup? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/cpanel/how-to-exclude-files-from-backup" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:09fa640df6dfa388970454369c9b43b2 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>How to exclude files from backup?</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-11-28 3:45 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>1,948</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I'd like to back up my home directory but exclude a couple of massive video files which I don't need to back up.  Otherwise my back up file will be unnecessarily big and take much time to download. Is this possible?</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_4268' id='upvote_answer_4268' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='4268' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_4268').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_4268' id='downvote_answer_4268' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='4268' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_4268').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
...
<br />
If you'd like to backup your account, but exclude certain files or directories, this can be done with a &lt;strong&gt;cpbackup-exclude.conf&lt;/strong&gt; file placed inside your home directory such as &lt;strong&gt;/home/userna5&lt;/strong&gt;.<br />
<br />
It's important to note, that this will only exclude files when you are doing a &lt;strong&gt;Full Backup&lt;/strong&gt;. Either from the &lt;strong&gt;Backups&lt;/strong&gt; tool under &lt;strong&gt;Files&lt;/strong&gt;, and clicking on &lt;strong&gt;Download or Generate a Full Website Backup&lt;/strong&gt;. Or when using the &lt;strong&gt;Backup Wizard&lt;/strong&gt;, and clicking on &lt;strong&gt;Full Backup --&amp;gt;&lt;/strong&gt;, and then &lt;strong&gt;Generate Backup&lt;/strong&gt;.<br />
<br />
If you you just click on &lt;strong&gt;Home Directory&lt;/strong&gt; to download your &lt;strong&gt;/home/userna5/public_html/&lt;/strong&gt; files, the exclude file will be ignored and your large movie files will still download.<br />
<br />
Also keep in mind that as this would be a &lt;strong&gt;Full Backup&lt;/strong&gt;, you probably want to exclude some other directories such as your mail if you're storing a lot on the server. That way you don't have excessive redundant backups on your account, or have to spend longer times downloading files to your computer.<br />
<br />
So in your case, I'd probably recommend a &lt;strong&gt;cpbackup-exclude.conf&lt;/strong&gt; file something along the lines of this:<br />
<br />
&lt;pre class=&quot;code_block&quot; style=&quot;width: 500px; white-space: normal; margin-bottom: -30px;&quot;&gt;access-logs/*<br />
.*<br />
mail/*<br />
public_ftp/*<br />
tmp/*<br />
&lt;strong style=&quot;color: red;&quot;&gt;/public_html/videos/large_vid001.avi&lt;/strong&gt;<br />
&lt;strong style=&quot;color: red;&quot;&gt;/public_html/videos/large_vid002.avi&lt;/strong&gt;&lt;/pre&gt;<br />
<br />
The files I highlighted in &lt;strong style=&quot;color: red;&quot;&gt;red&lt;/strong&gt; would be how you'd want to exclude them one by one. Or as you can see above those, if you want to exclude all the files from a directory, use an asterisk &lt;strong&gt;*&lt;/strong&gt; after the directory.<br />
<br />
If you have a very large account though, you'd more than likely instead want to select certain files specifically to archive with a cronjob. Then connect via FTP to your account to retrieve that backup for safe keeping.<br />
<br />
I'll try to update this question with some guides, as it seem we don't have any written in our support center regarding this. Thanks again for the question and let us know if you had any others!<br />
<br />
- Jacob
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_4268').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_4268' id='form_comment_on_answer_4268' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/cpanel/how-to-exclude-files-from-backup&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/cpanel/how-to-exclude-files-from-backup'></div>
<script type='text/javascript'>
  (function() {
