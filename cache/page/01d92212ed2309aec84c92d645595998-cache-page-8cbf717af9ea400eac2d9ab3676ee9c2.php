<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:67825:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/cpanel-account-management/copy-multiple-accounts-from-another-server-with-root-access" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-03-19T23:25:00-07:00" />
  <meta name="keywords" content="copy transfer migrate multiple account accounts from another server cpanel root access" />
  <meta name="author" content="Jacob Nicholson" />
  <meta name="description" content="In this article we'll go over how you can copy multiple accounts from either your previous host or another server of ours, to your new server with root access." />
  <title>Copy multiple accounts from another server with root access - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/cpanel-account-management/copy-multiple-accounts-from-another-server-with-root-access" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:179f0eca993e3c5332afc4da23f8da4f -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-22']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '187.177.135.34']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Copy multiple accounts from another server with root access</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Copy multiple accounts from another server with root access									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;' title='Originally published: Dec 7, 2012'><span style='color:#606060;'>Published:</span> Mar 19, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In this article we'll go over how you can copy multiple accounts from either your previous host or another server of ours, to your new server with root access.</p>
<p>In this example we'll be transferring <strong>WHM / cPanel</strong> accounts. Other control panels are also supported in the account copy process, but since we also use <strong>WHM / cPanel</strong> this would be the least accident prone way to copy accounts over.</p>
<p class="alert">To copy multiple accounts this way you'll need to have <a href="/support/website/general-server-setup/root-access-faq">root access</a> on either your VPS or dedicated server. You'll also need to have SSH access to your old server, and your new server's IP address with us must be allowed to connect via SSH to your previous server.</p>
<ol class="article_list">
<li><a href="/support/edu/whm/creating-and-managing-accounts/log-into-whm">Log into WHM</a> on our server.</li>
<li>In the top-left <strong>Find</strong> box, type in <strong>transfer</strong>, then click on <strong>Copy multiple accounts/packages from another server</strong>.<br /> <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/cpanel/account-copy/multi-with-root/click-on-copy-multiple-accounts-packages-from-another-server.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/cpanel/account-copy/multi-with-root/click-on-copy-multiple-accounts-packages-from-another-server.png" alt="click-on-copy-multiple-accounts-packages-from-another-server"  /></a></li>
<li>
<h4>Remote Server Info section</h4>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/cpanel/account-copy/multi-with-root/remote-server-info.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/cpanel/account-copy/multi-with-root/remote-server-info.png" alt="remote-server-info"  /></a>
<p>Now you'll be presented with a drop-down list for <strong>Remote Server Type</strong>, in this example we're going to assume your previous host was using <strong>WHM/cPanel</strong> and select that from the drop-down.</p>
<p>For the <strong>Remote Server Address</strong> field you'll want to type in the current IP address of your website on the old server, or your domain name if it's still pointed to that server.</p>
<p>By default the <strong>Remote SSH port</strong> should be <strong>22</strong>, you can click on <strong>Check SSH Connection</strong> directly below this setting to ensure it's set correctly.</p>
<p>If you receive an error of <strong>Connecting to Remote Server Failed</strong> this typically means that your server's IP address with us isn't allowed in your old server's firewall. You'll want to add your IP address to the firewall following these steps:</p>
<ul style="counter-reset: toc 0; padding: 0px 0px 0px 50px; margin: 0px; border: 1px solid #CCC; background: #F8F8F8;">
<li>To fix this you'll want to login to your old server's WHM interface.</li>
<li>In the top-left <strong>Find</strong> box type in <strong>firewall</strong>, then click on the <strong>Add IP to Firewall</strong> link.</li>
<li>Now in the <strong>Allow Rule</strong> field, type in the IP address of your server with us. Then click on <strong>Add Rule / Restart</strong>.</li>
</ul>
<p>Once you establish a SSH connection successfully you should get a message like:</p>
<span class="code_block">Remote Server Ok: SSH-2.0-OpenSSH_5.3</span>
<p>We would recommend leaving the <strong>Don't Compress Transfers</strong> option disabled. <strong>Use SSL</strong> should be enabled if possible, as well as <strong>Use Incremental Backups speed-up options.</strong></p>
<h4>Authentication section</h4>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/cpanel/account-copy/multi-with-root/authentication-transfer-account.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/cpanel/account-copy/multi-with-root/authentication-transfer-account.png" alt="authentication-transfer-account"  /></a>
<p>In this section for <strong>Login</strong>, select <strong>Root</strong></p>
<p>Then you can choose either option for <strong>Authentication Method</strong> and enter in either the <strong>Root</strong> password or public key.</p>
<p>Finally click on the <strong>Fetch Account List</strong> button at the bottom of the page to start the copy process.</p>
<p>&nbsp;</p>
</li>
<li>At the bottom of screen you can select the cPanel accounts that you'd like to transfer. For this example we are not copying over any packages just the accounts.
<p>You can also select to skip certain parts of the account copy if you'd like by placing a checkmark in the column for each option.</p>
<p>Finally click the <strong>Copy</strong> button at the bottom of the screen to begin the copy process.</p>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/cpanel/account-copy/multi-with-root/select-accounts-to-transfer-click-copy.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/cpanel/account-copy/multi-with-root/select-accounts-to-transfer-click-copy.png" alt="select-accounts-to-transfer-click-copy"  /></a>
<p>You'll get a pop-up window telling you not to close the web-browser while the copy takes place, click <strong>OK</strong> to continue and be sure to leave your web-browser open until the copy completes.</p>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/cpanel/account-copy/multi-with-root/do-not-close-window-click-ok.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/cpanel/account-copy/multi-with-root/do-not-close-window-click-ok.png" alt="do-not-close-window-click-ok"  /></a></li>
<li>After the copy has completed you'll get another pop-up warning you not to click the back button in your web-browser, click <strong>OK</strong>.<br /> <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/cpanel/account-copy/multi-with-root/copy-complete-click-ok.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/cpanel/account-copy/multi-with-root/copy-complete-click-ok.png" alt="copy-complete-click-ok"  /></a></li>
<li>You'll now be on the <strong>Review Copied Accounts</strong> page, you can click on <strong>View Log</strong> beside any account to review the log of that account's copy process. Or you can simply close this new window in your web-browser which should drop you back to your window with the main WHM interface.<br /> <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/cpanel/account-copy/multi-with-root/review-copied-accounts.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/cpanel/account-copy/multi-with-root/review-copied-accounts.png" alt="review-copied-accounts"  /></a></li>
<li>Now still in WHM, up in the top-left <strong>Find</strong> box, type in <strong>list</strong>, then click on <strong>List Accounts</strong>.<br /> <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/cpanel/account-copy/with-root/click-on-list-accounts.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/cpanel/account-copy/with-root/click-on-list-accounts.png" alt="click-on-list-accounts"  /></a></li>
<li>You should now see the accounts that we copied over <strong>userna1</strong>, and <strong>userna2</strong> on your server:<br /> <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/cpanel/account-copy/multi-with-root/list-accounts.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/cpanel/account-copy/multi-with-root/list-accounts.png" alt="list-accounts"  /></a></li>
</ol>
<p>Now that you've successfully copied over your accounts from an old server to your new server, you'll want to be sure to check it on the new server using the <a href="/support/website/how-to/using-your-temporary-url">temporary URL</a>, or by <a href="/support/website/how-to/modifying-your-hosts-file">modifying your local hosts file</a>.</p>
<p>Once you've verified that everything seems to be properly copied over you'll want to <a href="/support/domain-names/dns-nameserver-changes/updating-your-domains-nameservers">update your domain's name servers to point to us</a> so that when people try to access your domain name the new IP address of your new server is where they're getting directed to.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/cpanel-account-management/copy-multiple-accounts-from-another-server-with-root-access&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/cpanel-account-management/copy-multiple-accounts-from-another-server-with-root-access'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MzUmaWQ9NDk2JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="3f3e41093b48cd83383fc30195d9881f" value="1" />	</div>
	</form>
<!-- <br />
