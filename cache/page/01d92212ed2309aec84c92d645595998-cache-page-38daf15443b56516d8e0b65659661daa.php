<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:65996:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/prestashop-15/pshop15-price-rules/restrict-carriers-per-rule" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-08-15T15:30:27-07:00" />
  <meta name="keywords" content="set specific carriers certain only customer PrestaShop 1.5" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="This Prestashop 1.5 article explains how to set the cart rules to work only with selected carriers." />
  <title>Restrict cart rules to work with certain carriers in PrestaShop 1.5  - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/prestashop-15/pshop15-price-rules/restrict-carriers-per-rule" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:d2c0219ff8f0b04e786d78f9eb502cca -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Restrict cart rules to work with certain carriers in PrestaShop 1.5 									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>3,505</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Aug 15, 2012'><span style='color:#606060;'>Published:</span> Aug 15, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>The cart rules features included in PrestaShop 1.5 offer a lot of room for customization. In this article, we are going to explain how to set your cart rule to be used with specific carriers. Perhaps you want the customers to use certain carriers as it benefits you fiscally. You can set up a cart rule for your customers to use only if they select your preferred carriers. Learn how to set your cart rule to work with specific carriers in PrestaShop 1.5 by using the instructions below.</p>
<p><strong>Setting specific carriers for using a cart rule in PrestaShop 1.5</strong></p>
...
<li>From within the <strong>Cart Rules</strong> click the <strong>Conditions</strong> tab on the left sidebar tab and find the checkbox labeled <strong>Select Carrier</strong>. Select this checkbox so it expands and brings up an area to select the carriers. From here you will see two columns. The left column is where the carriers that are NOT able to be used for the cart rule are listed. The right column has the list of carriers that CAN be used with this cart rule. <br />By default, all carriers are listed in the right column. To limit the carriers, you will want to highlight a carrier you want to remove, and click on the <strong>&lt;&lt; Remove</strong> button. This moves that carrier to the other side. You can move it back to the right column at any time by clicking the <strong>Add &gt;&gt;</strong> button. Move your carriers until you have your preferred use carriers in the right hand column.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Price_Rules/Cart_Rules/Select_Carriers/select-carrier.png"><img  alt="select-carrier" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Price_Rules/Cart_Rules/Select_Carriers/select-carrier.png" /></a><br /><br /> </li>
<li>Once your setting is selected, click on the green <strong>Save</strong> button in the upper right corner. Now your cart rule can only be used if the customer uses the selected carriers. If they choose a different carrier, the cart rule will not apply.</li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 10: Restrict cart rules to work with certain carriers in PrestaShop 1.5 </div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 9: <a href='/support/edu/prestashop-15/pshop15-price-rules/max-times-per-customer'>Setting the max times customers can use a cart rule in PrestaShop 1.5</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/prestashop-15/pshop15-price-rules/restrict-carriers-per-rule&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/prestashop-15/pshop15-price-rules/restrict-carriers-per-rule'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNTImaWQ9MTY4MiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="da6a47a67596227a2b5fa78a32f3a67c" value="1" />	</div>
	</form>
<!-- <br />
