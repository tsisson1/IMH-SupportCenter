<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:64577:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/wordpress/using-smtp-authentication-to-send-mail-in-wordpress" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-04-18T12:34:40-07:00" />
  <meta name="author" content="Jeff Matson" />
  <meta name="description" content="InMotion Hosting Support Center" />
  <title>Using SMTP authentication to send mail in WordPress - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/wordpress/using-smtp-authentication-to-send-mail-in-wordpress" rel="canonical" />
...
<script>
  ...
  ga('send', 'pageview');
	...
	<script type="text/javascript">
		...
		_gaq.push(['_setCustomVar', 4, 'DateMonthPublished', '2014-09', 3]);
	...
	<!-- cid:ef13079a4af9cd105848eb73f5f2c880 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '5.2.202.151']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Using SMTP authentication to send mail in WordPress</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Using SMTP authentication to send mail in WordPress									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>11,716</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Sep 15, 2014'><span style='color:#606060;'>Published:</span> Apr 18, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<p>When sending email, it is usually a good idea to send using SMTP authentication.  Authenticating with the server will prevent issues such as your message being marked as outgoing spam when being sent.  In this article, we will show you how to configure SMTP authentication within WordPress. This guide uses the <strong>WP Mail SMTP</strong> plugin, we also have a guide on how to use the <a href="/support/website/wordpress/install-setup-smtp">Easy WP SMTP</a> plugin in WordPress.</p>


<div class="in_this_tutorial">
  <h2>In this tutorial:</h2>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('installation');">Installation</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('configuration');">Configuration</button>
</div>
<a name="installation"></a>
<h2>Install the WP Mail SMTP WordPress plugin</h2>
<ol class="article_list">
  ...
  <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress/wp-mail-smtp-1.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress/wp-mail-smtp-1.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>Once logged in, hover over <strong>Plugins</strong> and click on <strong>Add New</strong>.  On this page, enter <strong>WP Mail SMTP</strong> into the search field and press the <strong>Enter</strong> key.</p></li>
  <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress/wp-mail-smtp-2.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress/wp-mail-smtp-2.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>You should now see a list of your search results.  As you have searched for the exact file name, the <em>WP Mail SMTP</em> plugin should be the first result.  To install it, click <strong>Install Now</strong>.</p></li>
  <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress/wp-mail-smtp-3.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress/wp-mail-smtp-3.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>WordPress will now handle the download and installation of the WP Mail SMTP plugin for you.  Once complete, be sure to click <strong>Activate Plugin</strong> to activate it.</p></li>
  <div style='clear:both;'></div>
</ol>
<a name="configuration"></a>
<h2>Configuring WordPress to send using SMTP authentication</h2>
<p>Now that you have installed the WP Mail SMTP plugin, you will just now need to configure it.  In the following steps, we will be configuring the SMTP settings for the WP Mail SMTP plugin.</p>
<ol class="article_list">
  <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress/wp-mail-smtp-4.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress/wp-mail-smtp-4.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>On the left side navigation menu of your WordPress admin dashboard, hover over <strong>Settings</strong> and click on <strong>Email</strong>.</p></li>
  <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress/wp-mail-smtp-5.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress/wp-mail-smtp-5.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>Next, scroll down to the <strong>SMTP Options</strong> section.</p></li>
  <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress/wp-mail-smtp-6.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress/wp-mail-smtp-6.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>Within the <strong>SMTP Options</strong> section, set <strong>Authentication</strong> to <strong>Yes</strong>.</p></li>
  <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress/wp-mail-smtp-7.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress/wp-mail-smtp-7.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>Next up is the <strong>Username</strong> and <strong>Password</strong> fields.  In these fields, enter the email address that you will be sending from within the <strong>Username</strong> field, as well as the password for that account within the <strong>Password</strong> field.</p></li>
  <li style='clear:both;'><p>Now that you have entered the proper authentication information, click the <strong>Save Changes</strong> button.</p></li>
  <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress/wp-mail-smtp-8.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress/wp-mail-smtp-8.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>If you want to test your settings, you may go to the <strong>Send a Test Email</strong> section and enter an email address that you want to send to, then click the <strong>Send Test</strong> button.</p></li>
  <div style='clear:both;'></div>
</ol>
<p>Congratulations!  You have now configured WordPress to use SMTP authentication when sending mail on the server.</p>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/wordpress/using-smtp-authentication-to-send-mail-in-wordpress&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/wordpress/using-smtp-authentication-to-send-mail-in-wordpress'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD02MyZpZD0zMzg1JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="12b96fb1cf236a8127eb30b1464c2f58" value="1" />	</div>
	</form>
<!-- <br />
