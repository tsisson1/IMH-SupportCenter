<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:60658:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/email/bounceback-errors/email-error-mailbox-quota-exceeded" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-08-10T19:43:44-07:00" />
  <meta name="keywords" content="cpanel email mailbox mail box quota exceeded maildirsize error change" />
  <meta name="author" content="Tim Sisson" />
  <meta name="description" content="Learn how to change your mailbox quota in cPanel." />
  <title>Email Error- Mailbox Quota Exceeded - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/email/bounceback-errors/email-error-mailbox-quota-exceeded" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:d4d484c8e63b165139f45aa1ed736ca5 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '62.15.126.26']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Email Error- Mailbox Quota Exceeded</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Email Error- Mailbox Quota Exceeded									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>32,770</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Nov 1, 2011'><span style='color:#606060;'>Published:</span> Aug 10, 2015</div>
							...
							<div style='clear:both;'></div>
								...
								<iframe width="560" height="315" src="https://www.youtube.com/embed/Pjng0Cm9Ydw" frameborder="0" allowfullscreen></iframe>
<p>If you get an error in webmail that says "<strong>Mailbox Quota Exceeded</strong>" you can correct this error in cPanel. This error is due to having too much mail in your account or the quota size was set too low when the address was created in cPanel. One option is to simply delete emails to lower the size of your existing mail box.&nbsp;</p>

<p>Another solution is to raise the quota that you set for the email account in cPanel, which is explained in this guide.
<h2>Increasing eMail Quota in cPanel:</h2>
<ol class="article_list">

<li><a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel" target="_blank">Login to your cPanel</a>.</li>

<li>Once you have logged into cpanel, click on the "<strong>Email Accounts</strong>" icon under the email heading. You'll see that our '<strong>tim@inmotiontesting.com</strong>' account is labeled in '<span style="color: #ff0000;"><strong><span style="background-color: #ffffff;">red</span></strong></span>'</p>

<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/cpanel/quota/email_1.jpg"><img  alt="email_1" src="//cdn.inmotionhosting.com/support/images/stories/cpanel/quota/email_1.jpg" /></a></p></li>

<li>Click on the '<strong>Change Quota</strong>' link next to the email address you are working with.<br>

<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/cpanel/quota/email_2.jpg"><img  alt="email_2" src="//cdn.inmotionhosting.com/support/images/stories/cpanel/quota/email_2.jpg" /></a></p></li>

<li>Next, you'll want to either change the nurmerical value for the size of the mailbox or you can set it to '<strong>Unlimited</strong>', for this tutorial we're going to change the setting to '<strong>Unlimited</strong>'

<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/cpanel/quota/email_3.jpg"><img  alt="email_3" src="//cdn.inmotionhosting.com/support/images/stories/cpanel/quota/email_3.jpg" /></a></p>

<p>And as you can see we have successfully changed the mailbox quota to 'Unlimited'</p></li></ol>

<h2>Cannot Change MailDir Size! Error</h2>

<p>At times, when you try to update the mail box quota size, you may receive an error message. If you get this error message, don't worry it is easily corrected. 
<ol class="article_list">

<li>Login to cPanel.</li> 

<li>Click <strong>File Manager</strong>, under the <em>File</em> section.<br>

<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/cpanel/quota/email_4.jpg"><img  alt="email_4" src="//cdn.inmotionhosting.com/support/images/stories/cpanel/quota/email_4.jpg" /></a></li>

<li>Now, go to your "<strong>Home Directory</strong>" from the directory Selection Menu.

<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/cpanel/quota/email_5.jpg"><img src="//cdn.inmotionhosting.com/support/images/stories/cpanel/quota/email_5.jpg" alt="email_5"  /></a></p></li>

<li>Select the "<strong>mail</strong>" folder from the file tree in the left side pane.<br>

<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/cpanel/quota/email_6.jpg"><img  src="//cdn.inmotionhosting.com/support/images/stories/cpanel/quota/email_6.jpg" alt="email_6" /></a></li>

<li>Select the email address you were attempting to change the mailbox quota for.<br>

<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/cpanel/quota/email_7.jpg"><img src="//cdn.inmotionhosting.com/support/images/stories/cpanel/quota/email_7.jpg" alt="email_7"  /></a></p></li>

<li>Find the file "<strong>maildirsize</strong>" and right-click on it, then select <strong>delete</strong>. Once the file is deleted you will have the ability to change the mailbox quota as the above steps instruct you.&nbsp;</li></ol><br>

<p>Congratulations, now you know how to fix the <strong>Mailbox Quota Exceeded</strong> error!</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/email/bounceback-errors/email-error-mailbox-quota-exceeded&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/email/bounceback-errors/email-error-mailbox-quota-exceeded'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NjImaWQ9NzUxJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/d60411d6864f2835618e5b5d7e77714a?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/d60411d6864f2835618e5b5d7e77714a'>sameer</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-21 3:36 am</div>
				                <div><p>This can not help in outlook account</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25030);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-21 9:19 am</div>
				                <div>Hello Sameer,<br />
<br />
What parts are you saying does not work for outlook? Also this is supposed to be done on the server not within the client itself.<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25040);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
