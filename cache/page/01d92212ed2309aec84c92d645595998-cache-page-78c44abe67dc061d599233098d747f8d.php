<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:59257:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/email/mailing-lists/phplist-create-subscribe-form" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-03-20T14:56:24-07:00" />
  ...
  <link href="http://www.inmotionhosting.com/support/email/mailing-lists/phplist-create-subscribe-form" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:ecf0d3e0af8fb6291b9d972c4057bed1 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '180.153.236.41']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to create a subscribe form for your phpList mailing list									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>15,989</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Dec 20, 2011'><span style='color:#606060;'>Published:</span> Mar 20, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>If you're following along in our phpList tutorial, we previously have installed phpList and created a mailing list that users can subscribe to. The next step is to actually create a form that allows users to subscribe to your list. For example, in the right sidebar of your website, you may have an area where it says, "Subscribe to our mailing list!" and then asks for the user's email address. We will create that form in this tutorial.</p>
...
<tr>
<td><strong>Language File</strong><br /><strong>to us:</strong></td>
<td>english</td>
</tr>
<tr>
<td><strong>Select the lists</strong><br /><strong>to offer:</strong></td>
...
<li>In our example, our subscribe page URL is <a href="http://phplist.inmotiontesting.com/phplist/?p=subscribe&amp;id=1">http://phplist.inmotiontesting.com/phplist/?p=subscribe&amp;id=1</a> and it looks like this:<a href="http://phplist.inmotiontesting.com/phplist/?p=subscribe&amp;id=1"><br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/whm-edu/bandwidth-and-disk/phplist/example-subscribe-page-in-phplist.gif"><img  alt="example-subscribe-page-in-phplist" src="//cdn.inmotionhosting.com/support/images/stories/whm-edu/bandwidth-and-disk/phplist/example-subscribe-page-in-phplist.gif" /></a></a></li>
</ol>
<p>On your website, you can now link to your custom subscribe page so your users can sign up for your mailing list!<a href="http://phplist.inmotiontesting.com/phplist/?p=subscribe&amp;id=1"><br /></a></p>
...
<ol>
<li>If you haven't already, create a custom subscribe page as we have described above. After you have created the subscribe page, visit the URL. In this example, we'll visit<a href="http://phplist.inmotiontesting.com/phplist/?p=subscribe&amp;id=1"> http://phplist.inmotiontesting.com/phplist/?p=subscribe&amp;id=1</a>.</li>
<li>We will be copying the form code created by phpList. View the current page's source code, and copy the code that begins with &lt;form and ends with /form&gt; into an editor on your computer, such as notepad in windows. In our example, the code we copied is:<br />
...
<li>Next, you'll need to update the form action to point to your actual subscribe page. In this step, you'll be updating the code that you copied into a text editor. The original code will look like this:<br /><span class="code_block">&lt;form method=post name="subscribeform"&gt;</span><br />You need to add an 'action' attribute and point it to your subscribe page. In our example, the updated code looks like this:<br />
<div class="code_block">&lt;form method=post name="subscribeform" action="http://phplist.inmotiontesting.com/phplist/?p=subscribe&amp;id=1"&gt;</div>
</li>
<li>You now have the necessary code to use on your site to insert into your subscribe form! In our WordPress site, we copied the code into a new Text widget:<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/whm-edu/bandwidth-and-disk/phplist/insert-phplist-code-into-text-widget-in-wordpress.gif"><img  alt="insert-phplist-code-into-text-widget-in-wordpress" src="//cdn.inmotionhosting.com/support/images/stories/whm-edu/bandwidth-and-disk/phplist/insert-phplist-code-into-text-widget-in-wordpress.gif" /></a></li>
...
<tr>
<td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/whm-edu/bandwidth-and-disk/phplist/before-subscribe-form-in-wordpress.gif"><img  alt="before-subscribe-form-in-wordpress" src="//cdn.inmotionhosting.com/support/images/stories/whm-edu/bandwidth-and-disk/phplist/before-subscribe-form-in-wordpress.gif" style="max-width: 200px;" /></a></td>
<td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/whm-edu/bandwidth-and-disk/phplist/after-subscribe-form-in-wordpress.gif"><img  alt="after-subscribe-form-in-wordpress" src="//cdn.inmotionhosting.com/support/images/stories/whm-edu/bandwidth-and-disk/phplist/after-subscribe-form-in-wordpress.gif" style="max-width: 200px;" /></a></td>
</tr>
</tbody>
</table>
</li>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/email/mailing-lists/phplist-create-subscribe-form&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/email/mailing-lists/phplist-create-subscribe-form'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNCZpZD03NjUmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="0f451a393386d0469ae2cbdc52ecfc53" value="1" />	</div>
	</form>
<!-- <br />
