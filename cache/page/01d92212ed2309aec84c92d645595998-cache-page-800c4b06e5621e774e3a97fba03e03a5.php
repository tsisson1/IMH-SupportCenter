<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:52427:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/prestashop-15/after-transfer-my-website-prestashop-log-in-is-not-working" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="While hidden in the background of your Prestashop admin, so it is quite hard to see, I do see some text there that prevents you from logging in without ..." />
  <title>After transfer my website Prestashop Log In is not working | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/prestashop-15/after-transfer-my-website-prestashop-log-in-is-not-working" rel="canonical" />
...
<script>
  ...
  ga('send', 'pageview');
	...
	<!-- cid:225217bc4aca3676f6d532bd8014cc4c -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>After transfer my website Prestashop Log In is not working</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-12-26 5:12 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>983</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I cant log in as admin or user on my prestashop. The domain is kenkomuri.com. I have clean cache and compile also run the admin (backoffice) and user (front office) interface and tried to log in without success, remains the same window. If I set a wrong password appears an error message. If a set the correct information it says nothing.<br />
<br />
My version is 1.5.0.17 with ssl certificate activated. I have tried to log in with the ssl deactivated but it does not work also.</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_4354' id='upvote_answer_4354' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='4354' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_4354').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_4354' id='downvote_answer_4354' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='4354' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_4354').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>11,186 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2013-12-26 8:45 am EST
                		        </div>
					
		                </div>

				While hidden in the background of your Prestashop admin, so it is quite hard to see, I do see some text there that prevents you from logging in without https within the URL so that could be causing issues with logging in.  In this, there is also an alternative URL that you could log in with which you may try that as well.  Be sure that when you attempt this from either URL, your browser cache is fully clear your browser may be passing the information incorrectly causing the failed logins.  Also try using another browser as well when accessing your admin backend directly as the browser you are using may still be having issues.  
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_4354').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_4354' id='form_comment_on_answer_4354' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>I have try to log in with the https but it does not work also. I have tried IE, Firefox, Chrome, incognito tabs clearing cache and cookies and nothing works. I opened a ticket and the team install the original installation core files for Prestashop version 1.5.0.17 and it works but many functionalities that I modified was lost so its a workaround.</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='http://graph.facebook.com/FeRb0/picture?type=normal' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/FerBO9'>FerBO9</a><br />
									22 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2014-01-01 5:23 pm EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>&lt;div style=&quot;background-color: #FFF; padding-left: 10px;&quot;&gt;Hello FerBO9,<br />
<br />
I see from your account notes that we did resolve the initial issues you were having logging into PrestaShop after your website transfer to us by replacing the PrestaShop core files.<br />
<br />
Being that when your website was first transferred to us it did not work, are you aware of what custom modifications you had made to PrestaShop on your previous host? It sounds like you very well could have made something work specifically with your old host, that in turn doesn't carry over to the way our servers work.<br />
<br />
Because using the core files worked, but just lost the functionality of some custom modifications that you've made. It would seem that pinpointing the custom modifications made so that you can see if any adjustments need to be made to work on our servers would be the best option.<br />
<br />
- Jacob&lt;/div&gt;</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/prestashop-15/after-transfer-my-website-prestashop-log-in-is-not-working&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/prestashop-15/after-transfer-my-website-prestashop-log-in-is-not-working'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="ccecfcf07aee3121e50513112deb5a3e" value="1" />	</div>
	</form>
<!-- <br />
