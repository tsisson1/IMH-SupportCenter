<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:64863:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/wordpress/wordpress-plugins-widgets/remove-sidebar-links-completely" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-12-06T13:29:54-08:00" />
  <meta name="keywords" content="completely remove sidebar links widgets birdsite theme Widgets editor Appearance editor delete deleting removing disable disabling" />
  ...
  <title>Completely disabling the sidebar links/widgets in WordPress - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/wordpress/wordpress-plugins-widgets/remove-sidebar-links-completely" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:5b679303f2a13f7eb00f519402cc9d87 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '84.120.246.4']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Completely disabling the sidebar links/widgets in WordPress									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>18,879</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Dec 5, 2012'><span style='color:#606060;'>Published:</span> Dec 6, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/104/removing-sidebar-links-widgets-completely/remove-sidbar-links-completely-1.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="remove-sidbar-links-completely-1-wordpress" src="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/104/removing-sidebar-links-widgets-completely/remove-sidbar-links-completely-1.gif" title="Click here to view the larger image" width="100" /></a>When working with a WordPress theme, occasionally, the webmaster may want to completely remove the sidebar links and widgets from the theme. This can be done through the Widgets or by editing the source code of the sidebar.php file in the WordPress Appearance editor.</p>
<p>There are several ways the sidebar widgets can be disabled. This article will explain how to completely remove the sidebar links and widgets from the birdsite theme through the Widget editor and through the Appearance editor. <br style="clear: both;" /></p>
<h3>Removing sidebar widgets completely through the widgets editor</h3>
...
<li>Navigate to <strong>Appearance</strong> &gt; <strong>Widgets</strong>. <a href="/support/edu/wordpress/wordpress-plugins-widgets/add-remove-sidbar-widgets" target="_blank" title="Click here for more informtion">Click here</a> for information on removing and adding widgets. <br style="clear: both;" /></li>
<li>Add a blank text widget.
<p>Now the links and widgets will not display.</p>
...
<ol class="article_list">
<li><a href="/support/edu/wordpress/wordpress-introduction/logging-into-wordpress-dashboard" target="_blank" title="Click for more information">Log into the Wordpress Dashboard</a></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/104/removing-sidebar-links-widgets-completely/remove-sidbar-links-completely-2.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="remove-sidbar-links-completely-2-wordpress" src="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/104/removing-sidebar-links-widgets-completely/remove-sidbar-links-completely-2.gif" title="Click here to view the larger image" width="100" /></a>Navigate to <strong>Appearance</strong> &gt; <strong>Editor</strong> on the left in the Wordpress Dashboard. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/104/removing-sidebar-links-widgets-completely/remove-sidbar-links-completely-3.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="remove-sidbar-links-completely-3.-wordpress" src="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/104/removing-sidebar-links-widgets-completely/remove-sidbar-links-completely-3.gif" title="Click here to view the larger image" width="100" /></a>On the <strong>Edit Themes</strong> page, select the <strong>sidbar.php</strong> page on the right hand side in the <strong>Templates</strong> section. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/104/removing-sidebar-links-widgets-completely/remove-sidbar-links-completely-4.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="remove-sidbar-links-completely-4-wordpress" src="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/104/removing-sidebar-links-widgets-completely/remove-sidbar-links-completely-4.gif" title="Click here to view the larger image" width="100" /></a>The code for the <strong>sidebar.php </strong>will load in the Theme editor window.
...
<p>Add a comment to the code like in the snapshot to the right. HTML comments look like the following:</p>
<pre>&lt;!-- Begin Comment<br />
Code goes in between here<br />
End Comment --&gt;
</pre>
<p><strong>Add the comment code</strong> to the page in the Theme editor and <strong>Click Update File</strong><br style="clear: both;" /></p>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/104/removing-sidebar-links-widgets-completely/remove-sidbar-links-completely-5.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="remove-sidbar-links-completely-5-wordpress" src="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/104/removing-sidebar-links-widgets-completely/remove-sidbar-links-completely-5.gif" title="Click here to view the larger image" width="100" /></a>Now when visiting the WordPress site, the sidebar will not display any widgets or links at all. <br style="clear: both;" /></p>
</li>
</ol>
<p>To learn more about Widgets, please visit <a target="_blank" href="/support/edu/wordpress/wordpress-plugins-widgets" title="Click here to view the courses">Introduction to Plugins &amp; Widgets</a></p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/wordpress/wordpress-plugins-widgets'>104: Introduction to Plugins and Widgets</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 7: Completely disabling the sidebar links/widgets in WordPress</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 6: <a href='/support/edu/wordpress/wordpress-plugins-widgets/add-remove-sidbar-widgets'>Deactivating widgets from the sidebar in WordPress</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 8: <a href='/support/edu/wordpress/wordpress-plugins-widgets/completely-remove-comments'>Completely disabling Comments from WordPress in the code</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/wordpress/wordpress-plugins-widgets/remove-sidebar-links-completely&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/wordpress/wordpress-plugins-widgets/remove-sidebar-links-completely'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xMjgmaWQ9MjA0MSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="ef5c12f5651076153a07702286a6e150" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/wordpress/wordpress-plugins-widgets?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Introduction to Plugins and Widgets</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/wordpress/wordpress-plugins-widgets/what-are-plugins-and-widgets?tsrc=rsbedu'>What are Plugins and Widgets?</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/wordpress/wordpress-plugins-widgets/searching-for-a-installing-plugins?tsrc=rsbedu'>Searching for & Installing Plugins</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/wordpress/wordpress-plugins-widgets/finding-and-installing-widgets-in-wordpress?tsrc=rsbedu'>Finding and Installing Widgets in WordPress</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/wordpress/wordpress-plugins-widgets/wordpress-text-widget?tsrc=rsbedu'>How to use the WordPress Text Widget</a></td>
                </tr>
          <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/wordpress/wordpress-plugins-widgets/disable-comments?tsrc=rsbedu'>How to disable the comments on a page in WordPress</a></td>
                </tr>
          <tr >
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/wordpress/wordpress-plugins-widgets/add-remove-sidbar-widgets?tsrc=rsbedu'>Deactivating widgets from the sidebar in WordPress</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>7.</td>
                        <td><a href='/support/edu/wordpress/wordpress-plugins-widgets/remove-sidebar-links-completely?tsrc=rsbedu'>Completely disabling the sidebar links/widgets in WordPress</a></td>
                </tr>
          <tr >
                        <td valign='top'>8.</td>
                        <td><a href='/support/edu/wordpress/wordpress-plugins-widgets/completely-remove-comments?tsrc=rsbedu'>Completely disabling Comments from WordPress in the code</a></td>
                </tr>
          <tr >
                        <td valign='top'>9.</td>
                        <td><a href='/support/edu/wordpress/wordpress-plugins-widgets/disable-blog-features?tsrc=rsbedu'>How to disable blogging features in WordPress </a></td>
                </tr>
          	</table>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/bc457013350decfc2b23b4a448742b5d?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/bc457013350decfc2b23b4a448742b5d'>Ravindra</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-13 8:11 am</div>
				                <div><p>Thank you so much. this worked for me. very simple logic, great.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24174);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
