<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:46888:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/drupal-8/create-content" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="InMotion Hosting Support Center" />
  <title>102: Managing Content in Drupal 8 | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/drupal-8/create-content" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:564b305b44b3f2b616e50d15a933c7d0 -->
...
<div class='page-header'>
	<h1>102: Managing Content in Drupal 8</h1>
</div>
<div class='section_listing'>
	<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/102/main-screen.png"><img  style="float:right; margin:0px 0px 15px 15px;" alt="content type selection screen" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/102/main-screen.png" title="Click here to view the larger image" width="200" /></a>This course walks you through how to manage the different content types within Drupal 8. We will go over the various types and then guide you on how to build nodes (units of content such as Articles, Pages, etc) of each content type.<br /><br /><div style="clear:both;"></div>
	<table>
	<tr><td colspan='3'><h2>Introduction to Content Types</h2></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 1:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/drupal-8/create-content/content-types'>Content Types in Drupal 8</a>
					<div>There are many different content types in Drupal 8. Read this article for a description of the different types.</div>
					<div class='smallgrey'>Hits: 2,718</div>
				</td>
			</tr>
		<tr><td colspan='3' style='padding-top:20px;'><h2>Creating different content types</h2></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 2:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/drupal-8/create-content/create-basic-page'>How to create a Basic Page in Drupal 8</a>
					<div>This article will guide you on how to make your first Basic Page in the Drupal 8 program.</div>
					<div class='smallgrey'>Hits: 1,555</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/drupal-8/create-content/add-new-article'>Adding new Articles in Drupal 8</a>
					<div>Read here to understand how to add Artices to your Drupal 8 website.</div>
					<div class='smallgrey'>Hits: 1,559</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/drupal-8/create-content/create-custom-content-type'>How to create a custom content type in Drupal 8</a>
					<div>Drupal allows you to create your own custom content type. Learn how to do so in the Drupal 8 admin interface.</div>
					<div class='smallgrey'>Hits: 3,087</div>
				</td>
			</tr>
		<tr><td colspan='3' style='padding-top:20px;'><h2>Placing content types in menus</h2></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 5:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/drupal-8/create-content/add-node-to-menu'>How to add a node to a menu in Drupal 8</a>
					<div>After creating a node, you may want to allow it to be seen in one of your navigation menus. Learn how to set this in this Drupal 8 article.</div>
			...
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/drupal-8/create-content/change-node-alias'>Changing aliases for nodes in Drupal 8</a>
					<div>You will likely want to make your node URLs more memorable and readable by giving them aliases. Follow this Drupal 8 tutorial to learn how.</div>
					<div class='smallgrey'>Hits: 1,035</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/drupal-8/create-content/create-new-revision'>Drupal 8 - Create new revision</a>
					<div></div>
					<div class='smallgrey'>Hits: 1,185</div>
				</td>
			</tr>
			</table>
</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zOTEmaWQ9MzkxJnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
