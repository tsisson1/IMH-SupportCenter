<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49969:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/cpanel" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="keywords" content="%default%" />
  <meta name="description" content="cPanel category" />
  <title>cPanel | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/cpanel" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:98f5d438bff030f08db7a385a6ab1b86 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '173.14.113.122']);
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>cPanel</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	...
	<div class='item-page'>
		<div class='page-header'>
			<h1>cPanel Education Channel</h1>
		</div>
	
<div style='clear:both;'></div>

<div class='edu_class_listing white_box'>
	<h2>cPanel Tutorials</h2>
	<ul style='float:left; width:300px; margin-right:20px;'>
<li  ><a href='/support/edu/cpanel/getting-started-cpanel'>101: Getting Started in cPanel</a></li>
<li  ><a href='/support/edu/cpanel/cpanel-fantastico'>102: Fantastico de Luxe</a></li>
<li  ><a href='/support/edu/cpanel/softaculous'>103: Using Softaculous</a></li></ul><ul style='float:left; width:300px; margin-right:20px;'>
<li  ><a href='/support/edu/cpanel/cpanel-email'>201: Using Email</a></li>
<li  ><a href='/support/edu/cpanel/cpanel-file-manager'>202: Managing your Files in cPanel</a></li>
<li  ><a href='/support/edu/cpanel/cpanel-manage-domains'>203: Managing your Domains in cPanel</a></li></ul><div style='clear:both;'></div></div>
...
<div class='edu_most_popular white_box'>
	<h2>Most Popular Articles</h2>
		<div style='width:300px; height:75px; float:left; margin-right:20px;'>
							...
							<div class='smallgrey'>Hits: 604,908</div>
						</div>
						<div style='width:300px; height:75px; float:left; margin-right:20px;'>
							<a href='/support/edu/cpanel/cpanel-email/logging-into-webmail'>How to log into Webmail</a>
							<div class='smallgrey'>Hits: 309,533</div>
						</div>
						<div style='width:300px; height:75px; float:left; margin-right:20px;'>
							<a href='/support/edu/cpanel/cpanel-manage-domains/setting-up-redirect-cpanel'>Setting up a Redirect for a Domain in your cPanel</a>
							<div class='smallgrey'>Hits: 96,883</div>
						</div>
						<div style='width:300px; height:75px; float:left; margin-right:20px;'>
							<a href='/support/edu/cpanel/cpanel-email/modfying-mx-records'>Modifying your MX records</a>
							<div class='smallgrey'>Hits: 71,819</div>
						</div>
						<div style='width:300px; height:75px; float:left; margin-right:20px;'>
						...
						<div style='width:300px; height:75px; float:left; margin-right:20px;'>
							<a href='/support/edu/cpanel/cpanel-manage-domains/creating-a-subdomain'>Creating a Subdomain in cPanel</a>
							<div class='smallgrey'>Hits: 58,910</div>
						</div>
						<div style='clear:both;'></div>
</div>
...
<form action="http://www.inmotionhosting.com/support/edu/cpanel" method="post" name="adminForm" id="adminForm" class="form-inline">
	...
	<option value="0">All</option>
		...
		<h2>cPanel - Advanced Tutorials</h2>
		<table style='margin-top:20px;'>
			...
			<tr>
				...
				<td valign='top' style='padding-bottom:15px;'>
					<div><a href='/support/edu/cpanel/301-run-cron-job'>301: How to run a cron job</a></div>
					<div>In this tutorial we will explain how to run a Cron job.</div>
					<div class='smallgrey'>
			...
			<tr>
				...
				<td valign='top' style='padding-bottom:15px;'>
					<div><a href='/support/edu/cpanel/create-custom-error-pages'>How to Create Custom Error Pages in cPanel</a></div>
					<div>Creating a Custom Error page in cPanel</div>
					<div class='smallgrey'>
			...
			<tr>
				...
				<td valign='top' style='padding-bottom:15px;'>
					<div><a href='/support/edu/cpanel/find-database-users'>How to find which users are attached to databases</a></div>
					<div>Do you need to find which user is assigned to a particular database? Learn how to locate them in the cPanel in this quick article.</div>
					<div class='smallgrey'>
			...
			<tr>
				...
				<td valign='top' style='padding-bottom:15px;'>
					<div><a href='/support/edu/cpanel/how-to-force-ssl-using-the-htaccess-file'>How to force a dedicated SSL using the .htaccess file</a></div>
					<div>Learn how to use mod_rewrite and your .htaccess file to force your website's visitors to use the SSL. </div>
					<div class='smallgrey'>
			...
			<tr>
				<td valign='top' style='padding:6px 15px 0px 0px;'><img src='https://lh3.googleusercontent.com/-et9qjCJVL08/AAAAAAAAAAI/AAAAAAAAAC4/C539ZYF2HNc/s90-p-rw-no/photo.jpg' class='sc_rc' style='width:55px;' /></td>
				<td valign='top' style='padding-bottom:15px;'>
					<div><a href='/support/edu/cpanel/remove-index-listing'>Preventing the "Index Of" listing page using the Index Manager</a></div>
					<div>Tired of the Index Of listing in your subdirectories? Learn how to stop that with Index Manager in the cPanel.</div>
					<div class='smallgrey'>
						Written by Scott Mitchell<br />
						Hits: 11,622
					</div>
			...
			<tr>
				<td valign='top' style='padding:6px 15px 0px 0px;'><img src='https://lh3.googleusercontent.com/-et9qjCJVL08/AAAAAAAAAAI/AAAAAAAAAC4/C539ZYF2HNc/s90-p-rw-no/photo.jpg' class='sc_rc' style='width:55px;' /></td>
				<td valign='top' style='padding-bottom:15px;'>
					<div><a href='/support/edu/cpanel/prevent-index-of-page-in-htaccess'>Preventing the Index Of page in .htaccess</a></div>
					<div></div>
					<div class='smallgrey'>
						Written by Scott Mitchell<br />
						Hits: 429
			...
			<tr>
				<td valign='top' style='padding:6px 15px 0px 0px;'><img src='https://lh3.googleusercontent.com/-et9qjCJVL08/AAAAAAAAAAI/AAAAAAAAAC4/C539ZYF2HNc/s90-p-rw-no/photo.jpg' class='sc_rc' style='width:55px;' /></td>
				<td valign='top' style='padding-bottom:15px;'>
					<div><a href='/support/edu/cpanel/set-up-google-apps'>Setting up Google MX Wizard in cPanel</a></div>
					<div>Learn how to use the Google Apps Wizard in cPanel to connect your Google Apps account to your domain.</div>
					<div class='smallgrey'>
						Written by Scott Mitchell<br />
						Hits: 9,453
					</div>
			...
			<tr>
				<td valign='top' style='padding:6px 15px 0px 0px;'><img src='https://lh3.googleusercontent.com/-et9qjCJVL08/AAAAAAAAAAI/AAAAAAAAAC4/C539ZYF2HNc/s90-p-rw-no/photo.jpg' class='sc_rc' style='width:55px;' /></td>
				<td valign='top' style='padding-bottom:15px;'>
					<div><a href='/support/edu/cpanel/mass-migration'>What to expect during a mass server migration</a></div>
					<div>Are you on a server that is being mass migrated? Check here for what to expect.</div>
					<div class='smallgrey'>
						Written by Scott Mitchell<br />
						Hits: 282
					</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD03MCZpZD03MCZ2aWV3PWNhdGVnb3J5Jkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="10e1438b61f2d7a59b79b4968262e903" value="1" />	</div>
	</form>
<!-- <br />
