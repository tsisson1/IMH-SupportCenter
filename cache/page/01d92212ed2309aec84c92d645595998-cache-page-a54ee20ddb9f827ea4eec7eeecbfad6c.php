<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50772:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/file-management/filezilla-failed-to-parse-returned-path" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Marcasg, It appears that you just opened up your account with us. If you're using your domain name, either it was just registered today or the nam..." />
  <title>Filezilla Failed to parse returned path | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/file-management/filezilla-failed-to-parse-returned-path" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:7ec22352384ca733923d64bd8e4e8e63 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-20']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '98.121.118.12']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Filezilla Failed to parse returned path</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/marcasg'>marcasg</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-07-24 6:03 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>4,022</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>&lt;p&gt;I'm attempting to connect to the ftp server via Filezilla. After reading the tutorial on how to securely connect to a shared server I was able to successfully get the certificate, however I'm unable to complete the connection and actually see my file. I've included the error messages that are returned to me. What am I doing wrong?  Command:	PWD Response:	257 &quot;/&quot; is your current location Error:	Failed to parse returned path. Error:	Failed to retrieve directory listing&lt;/p&gt;</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_1341' id='upvote_answer_1341' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='1341' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_1341').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_1341' id='downvote_answer_1341' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='1341' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_1341').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Marcasg,<br />
<br />
It appears that you just opened up your account with us.  If you're using your domain name, either it was just registered today or the name servers were just changed.  In either case you should not be using them, since it requires up to 24 hours for propagation to complete (see <a href="http://www.inmotionhosting.com/support/community-support/general-information/what-is-propagation-and-how-long-does-it-take" target="new">Propagation Information</a>).<br />
<br />
You can use Explicit FTP over TLS with port 21 in Filezilla per the instructions I'm assuming you found through our support site. But you will need to use your server name for the FTP host - this is:  biz123.inmotionhosting.com. You should be using your cpanel user name and password to login - that would be easiest.  If you need that information you can obtain it in the Account Management Panel (AMP) and also reset the Cpanel password if required.  <br />
<br />
Note that you cannot use SFTP with your account type - this is only available with VPS or Dedicated server accounts.<br />
<br />
...
Arnel C.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_1341').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_1341' id='form_comment_on_answer_1341' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/file-management/filezilla-failed-to-parse-returned-path&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/file-management/filezilla-failed-to-parse-returned-path'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="ad65ac659b7456a57bc3045275b9000b" value="1" />	</div>
	</form>
<!-- <br />
