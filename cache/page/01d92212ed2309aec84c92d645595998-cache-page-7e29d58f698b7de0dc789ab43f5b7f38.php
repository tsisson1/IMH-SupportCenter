<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:48404:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/wordpress/wordpress-features" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="keywords" content="wordpress features" />
  <meta name="description" content="This class goes over various features of Wordpress and how they can enhance your site." />
  <title>102: WordPress Features | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/wordpress/wordpress-features" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:846c90d1774f82f685850bd9fbdee148 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '84.76.205.124']);
...
<div class='section_listing'>
		...
		<tr>
				...
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/wordpress/wordpress-features/change-language-timezone'>How to change your WordPress Language and Time Zone</a>
					<div>Learn how to change your WordPress language and time zone in this article.</div>
					<div class='smallgrey'>Hits: 119</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/wordpress/wordpress-features/change-language'>How to Change your WordPress Dashboard Language</a>
					<div>Learn how to change your WordPress Dashboard language in this tutorial.</div>
					<div class='smallgrey'>Hits: 396</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/wordpress/wordpress-features/change-timezone'>How to Change your WordPress Timezone</a>
					<div>Learn how to customize your WordPress Timezone in the Dashboard.</div>
					<div class='smallgrey'>Hits: 36</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/wordpress/wordpress-features/manage-comments'>How to Manage Comments in WordPress</a>
					<div>Learn how to deal with WordPress Comments in this guide.</div>
					<div class='smallgrey'>Hits: 126</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/wordpress/wordpress-features/enable-disable-wp-updates'>How to Enable or Disable WordPress Automatic Updates</a>
					<div>Automatic updates were updates were introduced into WordPress at version 3.7.  It is possible to remove or enable the updates based on a setting within the WP-CONFIG.PHP file.  The following tutorial walks you through the process or enable the updates.</div>
					<div class='smallgrey'>Hits: 419</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/wordpress/wordpress-features/setting-up-permalinks-on-your-wordpress-site'>Setting Up Permalinks on your WordPress Site</a>
					<div>Permalinks are permanent URLs to your individual posts and pages. creating permanent links to your content can make it easier to share links and help SEO</div>
					<div class='smallgrey'>Hits: 5,597</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/wordpress/wordpress-features/reset-permalinks'>How to Reset WordPress Permalinks</a>
					<div>Learn how to Reset your Permalinks in WordPress, which can often resolve 404 errors.</div>
					<div class='smallgrey'>Hits: 145</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/wordpress/wordpress-features/change-title-tagline'>How to Change the WordPress Title and Tagline</a>
					<div>Changing the title and tagline in WordPress is easy in the Dashboard. This article explains how to change the site title and tagline in WordPress.</div>
					<div class='smallgrey'>Hits: 5,955</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/wordpress/wordpress-features/wp-remove-tags'>How to Remove Tags from WordPress</a>
					<div>As your WordPress site gets older, the need for deleting tags may be needed.  This tutorial shows you how to use the WordPress interface to delete tags in bulk or one-by-one.</div>
					<div class='smallgrey'>Hits: 138</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/wordpress/wordpress-features/wp-managing-tags'>Managing Tags in WordPress</a>
					<div>Tags are a great tool for helping to manage content in your WordPress site.  Keep your tags updated and in order by using the tools provided in the WordPress interface.</div>
					<div class='smallgrey'>Hits: 88</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/wordpress/wordpress-features/set-category-tag-url-base'>How to set the Category or Tag URL base</a>
					<div>The categories and tags have a URL can be specified in the Permalinks section of the WordPress Administrator settings.  Follow the directions in this tutorial to see how you specify these settings.</div>
					<div class='smallgrey'>Hits: 166</div>
				</td>
			</tr>
			</table>
</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xMjYmaWQ9MTI2JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="6e15b4a201d57640411fff9eb4ba4a90" value="1" />	</div>
	</form>
<!-- <br />
