<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:68824:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/email/general-information/third-party-mx" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-05-02T16:15:39-07:00" />
  <meta name="keywords" content="point change DNS MX record third party service InMotion server" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Point your MX records from your third party DNS to InMotion Hosting servers." />
  <title>Changing MX records to point to InMotion servers from third party DNS - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/email/general-information/third-party-mx" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:b8f4f8c16235c5d662e320e1ebb32ccc -->
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Changing MX records to point to InMotion servers from th...</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Changing MX records to point to InMotion servers from third party DNS									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>11,468</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 9, 2013'><span style='color:#606060;'>Published:</span> May 2, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<p>MX records help move email to the right place by specifying which server handles the email. If you have an account with us here, but have a domain hosted somewhere else that does not offer email services, you may want to host your email with us here on your InMotion account. This is most certainly possible but does take working with both your InMotion account and your third party DNS service. Follow the instructions below to learn how to change MX records to point to InMotion email servers from your third party DNS service.</p>
<h2>Setting up the InMotion Server</h2>
<p>First, you want to set the InMotion server side to be ready to receive the emails once you make the changes with your third party DNS. You will need to be sure you have two tasks completed below.</p>
<ol class="article_list">
	<li><strong>Adding the domain as addon or parked domain.</strong> Even though you will not be using the domain on our server to display the website, it will need to be added to your account as an addon or a parked domain to be able to create email accounts and receive email. It is recommended to set up the domain as a parked domain, as addon domain slots are more limited.</li>
	<li><strong>Creating an email address on your server.</strong> Next, you will need to create email addresses on your InMotion server. Without the proper email addresses, the emails will simply come to the server and get rejected, or bounces, as they will have no email box to be delivered to.</li>
</ol>
<h2>Setting up with your third party DNS</h2>
<p>After setting up the email domain and email address on the InMotion account, you need to visit your third party DNS service and log into your account there. You will be editing some of the records to have them point to your InMotion account server.</p>
<ol class="article_list">
	<li><strong>Create a mail A record.</strong>You will first need to check to see if you have a mail record. If you do, you simply need to edit the current one. If not, you will need to create a new one. The mail record will have several parts.
<p></p>
		<h3>A Record Details</h3>
		<table class="article_table">
			<tbody>
				<tr>
					<th>Record Name</th>
					<td>The name will simply be <em>mail</em>
					</td>
				</tr>
				<tr>
					<th>TTL</th>
					<td>TTL (Time To Live) is the number of seconds the record information is kept on record&nbsp; before refreshing. 14400 is standard, but you if your DNS service uses a different number, use that.</td>
				</tr>
				<tr>
					<th>TYPE</th>
					<td>The Type of record. In this case it will be <em>A</em>
					</td>
				</tr>
				<tr>
					<th>IP Address</th>
					<td>The IP address of your InMotion server. You can find this IP address from <a href="/support/website/cpanel/how-to-find-your-shared-ip-address-of-your-server-in-cpanel">within your cPanel</a>.</td>
				</tr>
			</tbody>
		</table></li>
	<li><strong>Edit your MX record. </strong>After creating or modifying the A record for the domain, you will want to edit the MX record to point to that A record. Like the A record, there are several parts to it. The table below explains how to set your MX record.
	  <p></p>
		<h3>MX Record Details</h3>
		<table class="article_table">
			<tbody>
				<tr>
					<th>Record Name</th>
					<td>The name ofthe MX record will be <em>example.com.</em> (Be sure to replace 'example.com' with your actual domain name.) Also be sure to include the . at the end of the domain name as it is very important.</td>
				</tr>
				<tr>
					<th>TTL</th>
					<td>TTL (Time To Live) is the number of seconds the record information is kept on record before refreshing. 14400 is standard, but you if your DNS service uses a different number, use that.</td>
				...
				<tr>
					<th>TYPE</th>
					<td>The Type of record. In this case it will be <em>MX</em>
					</td>
				</tr>
				<tr>
					<th>Priority</th>
					<td>Useful if you have more than one MX record. 0 is the highest priority and means that record will be used first.</td>
				</tr>
				<tr>
					<th>Servername</th>
					<td>This is the record that wil be used to send email. This should be set to <em>mail.example.com.</em> Note that 'example.com' should be changed to your actual domain name and the . at the end of the record is part of the record and must be present.</td>
				</tr>
			</tbody>
		</table></li>
</ol>
<p>&nbsp;Now that you have made all the changes necessary and saved the new DNS settings with your DNS provider, you will need to allow for propagation time. This is when the DNS servers around the world allow the current information to expire. This can usually take from 4-24 hours. Once that information expires, your new information will take over and you should then be able to receive email to and from your InMotion server.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/email/general-information/third-party-mx&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/email/general-information/third-party-mx'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNiZpZD03OTkmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="e22e6ec3c3f05f039a51ea510d613f62" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/c94556f80fbf60827f488041b59836b1?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/c94556f80fbf60827f488041b59836b1'>Austin Passy</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-06 4:03 pm</div>
				                <div><p>I'd like to add a note for users using Namecheap. This may be a rare use case because my primary domain is pointing to another server IP address, but everything worked if you add the sub-domain <em>mail</em> to point to the InM IP. Only thing that had to be modified is Namecheaps Mail Setttings <strong>Host Name</strong> to "@" (no quotes) and their <strong>Mailserver Host Name</strong> to be the <em>mail.youraddress.tld.</em> (Namecheap auto appends the period if you forget it).</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19254);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						...
						<div><a style='font-size:16px;' href='//www.gravatar.com/98958c5b7722836a9605627d233fa418'>Avishay Biton</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-28 7:29 am</div>
				                <div><p>It's impossible to add A record with "mail" string. It says that each A record has to contain domain name inside.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23017);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-28 10:19 am</div>
				                <div>Hello Avishay,<br />
<br />
By entering 'mail' for the name, the actual record name is 'mail.example.com'<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23026);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-30000'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/2d4b7a2138d1b96809987beaac30b21d?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/2d4b7a2138d1b96809987beaac30b21d'>ALPHA</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-21 3:23 pm</div>
				                <div><p>good day</p>
<p>kindly assist me with my emails...when i try to send emails outside south africa they bounce back with fatal error messages and i dont know why..buyt when i send emails within south africa all works well....recently i was trying to send an email to info@****.co.za and everything just bounces back...please help</p>
<p>alpha&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30000);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-21 4:14 pm</div>
				                <div>Hello ALPHA,<br />
<br />
Thank you for contacting us. Since there are many reasons for an email to be returned, they must be handled on a case-by-case basis. I recommend reviewing the following helpful articles:<br />
<a href="http://www.inmotionhosting.com/support/email/bounceback-errors/email-bounce-bounceback-error">Why does Email bounce, bounceback, or error?</a><br />
<a href="http://www.inmotionhosting.com/support/email/bounceback-errors/what-to-do-if-an-email-is-returned">What to do if an email is returned?</a><br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30005);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
