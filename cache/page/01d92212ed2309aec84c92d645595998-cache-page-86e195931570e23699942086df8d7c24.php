<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:44979:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/phpbb/getting-started-phpbb" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="keywords" content="getting started introduction phpBB" />
  <meta name="description" content="Learn the basics of phpBB in this introductory course." />
  <title>101: Getting Started in phpBB 3.0 | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/phpbb/getting-started-phpbb" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:c2abf7055feebb85466b955512ce695e -->
...
<div class='page-header'>
	<h1>101: Getting Started in phpBB 3.0</h1>
</div>
<div class='section_listing'>
	<div style="float: right; margin: 0px 0px 10px 10px; width: 320px;"><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/overview/forum-overview.png"><img  alt="learn phpBB" src="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/overview/forum-overview.png" /></a><em>Learn how to use phpBB to build an online bulletin board!</em></div>
<div>Welcome to our first course on phpBB. This short class will get you started by first explaining <a href="/support/edu/phpbb/getting-started-phpbb/overview">how a forum community works</a>. We then take you through the different <a href="/support/edu/phpbb/getting-started-phpbb/phpbb-softaculous-install">installation methods</a> of the program. Finally, we will teach you how to <a href="/support/edu/phpbb/getting-started-phpbb/phpbb-login">log into the program</a> with your administrative user account.</div>
<div style="clear: both;">&nbsp;</div>

<p>When you're finished installing phpBB, <a href="/support/edu/phpbb/manage-forums">click here</a> to learn how to create your first forums and topics.</p>	<table>
		<tr>
				<td style='width:75px; font-weight:bold;'>Section 1:</td>
				<td style='padding-right:10px;'><div class='gold_star'></div></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/phpbb/getting-started-phpbb/overview'>How phpBB community software works</a>
					<div>Before we begin our tutorial series on using phpBB to create a website, let's first review how the software works and what you can expect.</div>
					<div class='smallgrey'>Hits: 2,481</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'><div class='gold_star'></div></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/phpbb/getting-started-phpbb/phpbb-softaculous-install'>How to install phpBB with Softaculous</a>
					<div>Softaculous is a tool to help you install programs quickly and easily. This phpBB tutorial shows you how to install the phpBB 3.0 program via the Softaculous installer tool.</div>
					<div class='smallgrey'>Hits: 2,047</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/phpbb/getting-started-phpbb/phpbb-manual-install'>How to manually install phpBB</a>
					<div>This phpBB tutorial walks you through installing the program manually in cpanel.</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP3RzcmM9cnNiZWR1Jm9wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMDAmaWQ9MzAwJnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="d6fdcf0f82c9dac52ee61865858d6bd6" value="1" />	</div>
	</form>
<!-- <br />
