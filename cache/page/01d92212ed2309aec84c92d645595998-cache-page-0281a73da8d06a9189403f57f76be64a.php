<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:71169:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-25/media-manager/upload-using-media-manager" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-05-02T16:37:46-07:00" />
  <meta name="keywords" content="upload file pdf joomla 2.5 media manager link" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="In this Joomla 2.5 tutorial, we'll show you how to upload and link to a PDF file within your site. This tutorial is specific towards .pdf files, but will work with other files as well, such as .ppt .docx" />
  <title>How to upload a file using the Joomla 2.5 Media Manager - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-25/media-manager/upload-using-media-manager" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:e3a33ab06d1ce077615f026ec1c356b7 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '99.233.183.7']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to upload a file using the Joomla 2.5 Media Manager									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>20,649</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: May 22, 2012'><span style='color:#606060;'>Published:</span> May 2, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<p class="alert">Joomla 2.5 has reached its end of life as for 12/31/2014. Please be advised this may be a security risk to your website. You can view more information about the end of life <a href="https://docs.joomla.org/Joomla!_CMS_versions">here</a>.</p><br /><p>If you need to upload images to your Joomla 2.5 website for use within an article, it's easiest to <a href="/support/edu/joomla-25/articles/how-to-upload-images">upload the images as you're writing the article</a>. What do you do however when you need to upload something else other than an image? For example, how do you upload a pdf file and give someone a link to that file? In this Joomla 2.5 tutorial, we'll show you how to upload files (other than images) using your Joomla 2.5 media manager. We'll also show you how to find the URL to that file so that you can link to it.</p>
<p>In this article, we're specifically focusing on a .pdf file. Keep in mind however that these steps will apply to all document types, such as .docx, .xlsx, and .pptx.</p>
<p><strong>To upload a file using the Joomla 2.5 media manager:</strong></p>
<ol class="article_list">
<li><a href="/support/edu/joomla-25/getting-started/how-to-log-into-dashboard">Log into your Joomla 2.5 admin</a></li>
<li>In the top menu, hover over <strong>Content</strong> and then click <strong>Media Manager</strong></li>
<li>In the left menu under <strong>Media Folders</strong>, navigate to the folder where you want to upload the file to by clicking on the individual folders. If you need to create a new folder, in the right side of the page enter a name for the new folder and then click <strong>Create Folder</strong>.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/upload-using-media-manager/create-new-folder-in-media-manager.gif"><img  alt="create-new-folder-in-media-manager" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/upload-using-media-manager/create-new-folder-in-media-manager.gif" /></a></li>
<li><strong>Upload your file</strong><br /><br />After navigating to the folder where you want to upload your file to, under <strong>Upload Files</strong> click the <strong>Browse</strong> button. Find the file on your computer, select it by clicking on it, and then click <strong>Open</strong>. Finally click <strong>Start Upload</strong>.<br /><br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/upload-using-media-manager/upload-file.gif"><img  alt="upload-file" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/upload-using-media-manager/upload-file.gif" /></a></li>
<li>After the file has been uploaded, you will see a message similar to:<br /><strong> Upload Complete: /pdfs/my-pdf-file.pdf</strong><br /><br />If you need to link to this file, you need to find the path to it. The path is actually given to you after uploading the file. In our case, the path was /pdfs/my-pdf-file.pdf. The link to your new file will be:<br /><br /><span style="color: #ff0000;">Your Joomla site's URL</span> + <span style="color: #008000;">/images</span> + <span style="color: #ff6600;">your uploaded file's path</span>:<br /><strong><span style="color: #ff0000;">http://example.com</span><span style="color: #008000;">/images</span><span style="color: #ff6600;">/pdfs/my-pdf-file.pdf</span></strong></li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/joomla-25/media-manager'>103: Using the Joomla 2.5 Media Manager</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 1: How to upload a file using the Joomla 2.5 Media Manager</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 2: <a href='/support/edu/joomla-25/media-manager/media-manager-thumbnail-vs-detail'>Joomla 2.5 Media Manager - Thumbnail vs. Detail View</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-25/media-manager/upload-using-media-manager&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-25/media-manager/upload-using-media-manager'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xODMmaWQ9MTM0OSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="47eab464976af22c788b948defaa4eee" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/joomla-25/media-manager?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Using the Joomla 2.5 Media Manager</h3></a>
		<table>  <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/joomla-25/media-manager/upload-using-media-manager?tsrc=rsbedu'>How to upload a file using the Joomla 2.5 Media Manager</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/joomla-25/media-manager/media-manager-thumbnail-vs-detail?tsrc=rsbedu'>Joomla 2.5 Media Manager - Thumbnail vs. Detail View</a></td>
                </tr>
          	</table>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-23 9:34 am</div>
				                <div><p>I click on upload and nothing happens? Any suggestions?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13188);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-23 9:49 am</div>
				                <div>Hello Christy,<br />
<br />
Thank you for your question. We are happy to  help, but will need some additional information.<br />
<br />
<a href="http://www.inmotionhosting.com/support/website/php-troubleshooting/troubleshoot-php-errors">Displaying and logging errors in PHP</a> may help you get a more specific message.<br />
<br />
Are you using 3rd party extensions, themes, or modules? Have you tried disabling them?<br />
<br />
If you have any further questions, feel free to post them below.<br />
Thank you,<br />
<br />
-John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13190);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-23 9:58 am</div>
				                <div><p>No Plug ins, the issue is that I am not getting anything when I click start upload. The PDF is much smaller than the max, and it does nothing with I click the button. No error message or anything. Any thoughts?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13192);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-23 11:09 am</div>
				                <div>Have you tried using another browser?</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13194);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-27 4:09 pm</div>
				                <div><p>i am trying to retrive a .xls file to my article using ari doc viewer. Please help me out the solution regarding the path..../images/excel.xls isnt working!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16781);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-27 4:22 pm</div>
				                <div>Hello Darshan,<br />
<br />
If you are getting an error please provide the error message you are getting. If not, pleased explain the behavior you are getting and how to duplicate it so we can take a look.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16784);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
