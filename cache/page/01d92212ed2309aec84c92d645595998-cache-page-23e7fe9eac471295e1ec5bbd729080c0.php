<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:52833:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/cpanel/cannot-log-in-to-cpanel" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Neeraj, I checked your login, and we do apologize for the problems. I know that support has sent you the article for understanding the cpanel logi..." />
  <title>Cannot log into cpanel through amp | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/cpanel/cannot-log-in-to-cpanel" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:0ff04e4b2c6acc2c2f91fbf994c1476f -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Cannot log into cpanel through amp</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/neeraj'>neeraj</a>
			<div>26 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-05-13 7:04 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>2,255</span>
			</div>
...
<br />
After logging into AMP successfully, I'm having problems logging into cPanel even though I'm entering the correct username and password (caps lock is off).  After entering the correct username/password, a new window pops up asking me to enter username/password.  I'm not sure why this is happening and have double-checked and triple-checked the username/password.  I've even reset the password several times and I'm still having the same problems.  I know I'm using the correct username as I checked the &quot;Details&quot; under Account and Billing.<br />
<br />
After my account (bharar5) was moved to a new server in February/March, my site has been having a lot of problems.<br />
<br />
I need to make some changes in the back end so I'll appreciate if you can look into this problem quickly.  Why cannot I log in?<br />
<br />
Site: www.bharari.net<br />
Server:	ecbiz135<br />
Hostname:	ecbiz135.inmotionhosting.com<br />
<br />
Thanks,<br />
Neeraj</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_3106' id='upvote_answer_3106' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='3106' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_3106').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_3106' id='downvote_answer_3106' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='3106' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_3106').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Neeraj,<br />
<br />
I checked your login, and we do apologize for the problems.  I know that support has sent you the article for understanding <a href="http://www.inmotionhosting.com/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel" target="new">the cpanel login instructions</a>,  but I went ahead and double-checked the issue myself.  The problem was an issue on the server side. I walked the issue over to our systems team and they fixed it immediately.  You should now be able to login with the password that you provided in the last emailed ticket response that you sent.  I will be responding to that ticket momentarily.  We apologize for the frustrations you have had with the login!  Please let us know if you require any further assistance!<br />
<br />
...
Community Support Team
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_3106').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_3106' id='form_comment_on_answer_3106' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Thank you, Arnel.</div>
							...
							<td style='width:96px;' valign='top'>
								...
								<div class='smallgrey'>
									<a href='/support/community-support/users/neeraj'>neeraj</a><br />
									26 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2013-05-14 6:45 pm EST
								</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/cpanel/cannot-log-in-to-cpanel&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/cpanel/cannot-log-in-to-cpanel'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="97a0dc2d623a55f42f1e1aad17d17b2d" value="1" />	</div>
	</form>
<!-- <br />
