<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:68998:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/email/outlook-2010/rejected-login" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-09-26T17:19:43-07:00" />
  <meta name="keywords" content="outlook 2010 rejected login error message email" />
  <meta name="author" content="Tim Sisson" />
  <meta name="description" content="Learn how to resolve an email server rejected your login error message in Outlook 2010." />
  <title>Outlook 2010: Server Rejected your Login - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/email/outlook-2010/rejected-login" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:4e88ab8c53b26b44fa3bb14592520eb3 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '68.0.226.97']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Outlook 2010: Server Rejected your Login									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>23,620</span></div>
...
<td>Your e-mail server rejected your login. Verify your user name and password for this account in Account Settings<br />
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/email/outlook2010/outlook-rejected-login.jpg"><img  title="outlook 2010 - rejected login" alt="outlook-rejected-login" src="//cdn.inmotionhosting.com/support/images/stories/email/outlook2010/outlook-rejected-login.jpg" /></a></p>
</td>
</tr>
<tr>
<td style="text-align: right;"><strong>Solution:</strong></td>
<td>
<div>Close the window and edit your username and password in Account Settings. To get to your account settings, click on file in the upper left hand corner. Then click Account Settings.</div>
<p>Please refer to the <a href="/support/email/outlook/how-to-set-up-outlook-2010">Outlook 2010 set up guide</a>&nbsp;for more information on setting up Outlook 2010 to check your email.</p>
<p><strong>What is the correct username?</strong><br />Your user name should be your full email address, in all lowercase. This should be the same credentials for both incoming and outgoing mail servers.&nbsp;</p>
</td>
</tr>
</tbody>
</table> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/email/outlook-2010/rejected-login&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/email/outlook-2010/rejected-login'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NjEmaWQ9NzQxJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="8eb2d16ef9d7cfee54bb205f7fa854d4" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/2f791a61c63b2f8796722082d0102392?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/2f791a61c63b2f8796722082d0102392'>Molly Fisher</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-12 9:27 am</div>
				                <div><p>Why is my new login and password beign rejected by ISP. Now I can't get any emails. I needed to change password due to spam emails that were being sent from my email. Now it is rejecting new password.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9668);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-12 11:03 am</div>
				                <div>Hello Molly,<br />
<br />
The most common cause for a rejected email login attempt is an invalid email username or password. Does your ISP provide you webmail access as well where you can attempt to directly login to your email account from your web-browser? If so this is a good way to double-check and test and make sure that you're able to verify your account with their server, using the credentials you're using in your mail client.<br />
<br />
If you are able to login to webmail, then it's possible that the mail server settings you're using in your mail client are incorrect and causing the connection problem. I'd double-check with your ISP to ensure you're using the correct server in the &lt;strong&gt;Incoming Server&lt;/strong&gt; setting.<br />
<br />
- Jacob</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9671);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-17891'></a>
		<div  style='margin:2px 0px 0px 40px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/8b96f4e8923bf489df9dd9340832e034?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/8b96f4e8923bf489df9dd9340832e034'>umesh</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-27 6:40 am</div>
				                <div><p>Log onto incoming mail server (POP3): Your e-mail server rejected your login. Verify your user name and password for this account in Account Settings. &nbsp;The server responded: -ERR [AUTH] Web login required: https://support.google.com/mail/bin/answer.py?answer=78754</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>Send test e-mail message: Your e-mail server rejected your login. Verify your user name and password for this account in Account Settings.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17891);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-28 11:59 am</div>
				                <div>Hello umesh,<br />
<br />
Thank you for contacting us. Did you follow the suggestions on the <a href="https://support.google.com/mail/bin/answer.py?answer=78754" target="_blank" >Google guide</a> you were linked to in the error?<br />
<br />
It provides specific suggestions for your problem. The main thing you should check is your username and password.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17920);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-13856'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/37a20b8e107310e1449a6f7ed6392a4e?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/37a20b8e107310e1449a6f7ed6392a4e'>William Patterson</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-10 4:55 pm</div>
				                <div>provide information that solves the problem</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13856);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-28 12:02 pm</div>
				                <div>Hello WIlliam,<br />
<br />
Thank you for contacting us. This specific error is caused by an incorrect <em>username</em> or <em>password</em>.<br />
<br />
Your user name should be your full email address, in all lowercase. This should be the same credentials for both incoming and outgoing mail servers. <br />
<br />
Your email password is private to you, but if you do not know it, you can easily <a href="http://www.inmotionhosting.com/support/edu/everything-email/introduction-email/changing-email-password-in-cpanel">reset it in cPanel</a>.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17921);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-20022'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/2081f3903e6f1873fba0886837b12d68?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/2081f3903e6f1873fba0886837b12d68'>Carrie Beveridge</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-27 4:23 pm</div>
				                <div><p>I'm getting this error as well, however, intermittently. I have the correct login information already stored and entered for this account and I do receive my email if I manually force send/receive, but this error occurs frequently and I'm prompted to enter my passwod again and again and again.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20022);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-27 4:54 pm</div>
				                <div>It sounds like an intermittent issue with your connection or possibly within Outlook.  First, of course restart your computer to rule out any small issues with Outlook.  If you're still having the issue, try running a &lt;a href=&quot;http://www.inmotionhosting.com/support/website/slow-websites/why-is-my-server-slow-how-do-i-run-a-ping-and-tracert-test&quot;&gt;ping/trace&lt;/a&gt; to check for latency between your computer and the server.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20024);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
