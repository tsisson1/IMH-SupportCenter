<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:63921:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-25/caching/clear-cache" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-09-28T23:09:30-07:00" />
  <meta name="keywords" content="joomla 2.5 clear cache" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="If you've enabled caching in Joomla 2.5, you may need to clear the cache before the cache timeout is reached. We'll show you how to do just that in this Joomla 2.5 tutorial." />
  <title>How to clear cache in Joomla 2.5 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-25/caching/clear-cache" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:a5db65e715b0a4bbd2adf34c75ccde6e -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '87.90.168.51']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to clear cache in Joomla 2.5									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>28,963</span></div>
							...
							<div style='clear:both;'></div>
								...
								<p class="alert">Joomla 2.5 has reached its end of life as for 12/31/2014. Please be advised this may be a security risk to your website. You can view more information about the end of life <a href="https://docs.joomla.org/Joomla!_CMS_versions">here</a>.</p><br /><p><a href="/support/edu/joomla-25/caching/global-module-caching">Joomla 2.5 includes caching options</a>, which when used can help speed up your site and reduce the load on your Joomla 2.5 hosting account. You can configure the cache to clear on its own after a set number of minutes, but sometimes you may need to clear the cache before that time limit is reached.</p>
<p><strong>To clear cache in Joomla 2.5:</strong></p>
<ol class="article_list">
<li><a href="/support/edu/joomla-25/getting-started/how-to-log-into-dashboard">Log into your Joomla Administrator dashboard</a></li>
<li>In the top menu, hover over <strong>Site</strong> &gt;&gt; <strong>Maintenance</strong>, and then click <strong>Clear Cache</strong></li>
<li>Put a check in the top left box. This will select all groups that have cache that can be cleared. Then, click the <strong>Delete</strong> icon in the top right menu.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/clear-cache/clear-cache.gif"><img  alt="clear-cache" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/clear-cache/clear-cache.gif" /></a><br /><br />You have now cleared the cache in Joomla 2.5!</li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/joomla-25/caching'>207: Joomla 2.5 Caching</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 4: How to clear cache in Joomla 2.5</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 3: <a href='/support/edu/joomla-25/caching/purge-expired-cache'>How to Purge Expired Cache in Joomla 2.5</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-25/caching/clear-cache&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-25/caching/clear-cache'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xOTUmaWQ9MTMyMyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="0111c1f81ee07b3f62d1607d862834ad" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/joomla-25/caching?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Joomla 2.5 Caching</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/joomla-25/caching/global-module-caching?tsrc=rsbedu'>Understanding Global Module Caching in Joomla</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/joomla-25/caching/clear-vs-purge-cache?tsrc=rsbedu'>Clear Cache vs. Purge Expired Cache in Joomla 2.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/joomla-25/caching/purge-expired-cache?tsrc=rsbedu'>How to Purge Expired Cache in Joomla 2.5</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/joomla-25/caching/clear-cache?tsrc=rsbedu'>How to clear cache in Joomla 2.5</a></td>
                </tr>
          	</table>
			...
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/billing/alphauserpoints-aup-integration-in-joomla-336?tsrc=rsbraq'>Alphauserpoints (AUP) integration in Joomla 3.3.6</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='https://lh4.googleusercontent.com/-qsShu7yaD6Y/AAAAAAAAAAI/AAAAAAAAADM/EJvbiEOXej8/photo.jpg?sz=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='/support/community-support/users/repoman'>repoman</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-05-15 12:33 pm</div>
				                <div>I'm getting hit with an error code when I try to enter in the address:  Save failed with the following error: The source URL must be unique.  I don't see it listed elsewhere in the list, so I'm at a loss...</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(7856);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-05-15 1:27 pm</div>
				                <div>Hello repoman, <br />
<br />
It sounds like you are trying to <a href="http://www.inmotionhosting.com/support/edu/joomla-3/308-redirect-manager">use the redirect manager</a> in Joomla. Here is a link to a <a href="http://forum.joomla.org/viewtopic.php?t=730382">solution on their official support forum</a> regarding this error.<br />
<br />
I am happy to help, but I would need more information to provide a specific answer, such as the specific steps you are taking (what address you are going to, what link you are clicking, etc.).<br />
<br />
If you have any further questions, feel free to post them below.<br />
Thank you,<br />
<br />
-John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(7857);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-28528'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/0f762c688424f1ba22ef927ae1a90df4?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/0f762c688424f1ba22ef927ae1a90df4'>Alan</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-18 2:38 pm</div>
				                <div>Thank you for this page ! ! !</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28528);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
