<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:52033:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/opencart/sql-technical-problems" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello simonbk, I apologize for the issues that you've been having. There were some recent issues with the MySQL service on the server that your site is ..." />
  <title>SQL technical problems | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/opencart/sql-technical-problems" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:c55e061aff146f53e04e86831e769844 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>SQL technical problems</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-01-03 10:11 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>1,760</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I have called about this two times.  Since you started working on the SQL at Inmotion, I have had multiple problems.  I have lost work because OpenCart won't save my work at times.  Every other time I login to my C panel my Top Applications will not load......including today.  When I tried to access my OpenCart site I got the message below.  Fix it!<br />
<br />
heartlandpetbeds.com/test<br />
<br />
<br />
Warning: mysql_connect() [function.mysql-connect]: Can't connect to local MySQL server through socket '/var/lib/mysql/mysql.sock' (11) in /home/heartl43/public_html/test/system/database/mysql.php on line 6<br />
<br />
Notice: Error: Could not make a database link using heartl43_heart@localhost in /home/heartl43/public_html/test/system/database/mysql.php on line 7<br />
<br />
Warning: mysql_select_db() expects parameter 2 to be resource, boolean given in /home/heartl43/public_html/test/system/database/mysql.php on line 10<br />
<br />
Notice: Error: Could not connect to database heartl43_heart in /home/heartl43/public_html/test/system/database/mysql.php on line 11<br />
<br />
Warning: mysql_query() expects parameter 2 to be resource, boolean given in /home/heartl43/public_html/test/system/database/mysql.php on line 14<br />
<br />
Warning: mysql_query() expects parameter 2 to be resource, boolean given in /home/heartl43/public_html/test/system/database/mysql.php on line 15<br />
<br />
Warning: mysql_query() expects parameter 2 to be resource, boolean given in /home/heartl43/public_html/test/system/database/mysql.php on line 16<br />
<br />
Warning: mysql_query() expects parameter 2 to be resource, boolean given in /home/heartl43/public_html/test/system/database/mysql.php on line 17<br />
<br />
Warning: mysql_query() expects parameter 2 to be resource, boolean given in /home/heartl43/public_html/test/system/database/mysql.php on line 21<br />
<br />
Warning: mysql_error() expects parameter 1 to be resource, boolean given in /home/heartl43/public_html/test/system/database/mysql.php on line 49<br />
<br />
Warning: mysql_errno() expects parameter 1 to be resource, boolean given in /home/heartl43/public_html/test/system/database/mysql.php on line 49<br />
<br />
Notice: Error: <br />
Error No: <br />
SELECT * FROM oc_setting WHERE store_id = '0' in /home/heartl43/public_html/test/system/database/mysql.php on line 49<br />
<br />
Warning: mysql_close() expects parameter 1 to be resource, boolean given in /home/heartl43/public_html/test/system/database/mysql.php on line 67</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_2058' id='upvote_answer_2058' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='2058' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_2058').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_2058' id='downvote_answer_2058' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='2058' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_2058').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>9,968 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2013-01-03 11:47 am EST
                		        </div>
					
		                </div>

				Hello simonbk, I apologize for the issues that you've been having.<br />
<br />
There were some recent issues with the MySQL service on the server that your site is hosted on. I've spoken with our system administration department and they've told me that these issues shouldn't continue.<br />
<br />
It seems that there was an issue temporarily with MySQL writing to the /tmp location on the hard drive, and also we just recently updated MySQL to patch a new security threat in the wild, so MySQL service would have been affected briefly during that upgrade.<br />
<br />
If you continue to notice any issues please let us know so that we can continue to investigate any problems.<br />
<br />
- Jacob
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_2058').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_2058' id='form_comment_on_answer_2058' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/opencart/sql-technical-problems&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/opencart/sql-technical-problems'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="82e1f8c1d54605f464232ba69e638689" value="1" />	</div>
	</form>
<!-- <br />
