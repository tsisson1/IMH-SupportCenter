<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:73738:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/drupal-7/306-manual-update" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-11-26T21:34:09-08:00" />
  <meta name="keywords" content="manual update install Drupal 7" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="This Drupal 7 article walks you through updating your Drupal 7 installation manually." />
  <title>306: How to update Drupal 7 manually. - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/drupal-7/306-manual-update" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:beae2717c4a961bd77bfc6c2113dc634 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '161.0.102.125']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															306: How to update Drupal 7 manually.									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>5,853</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Nov 26, 2012'><span style='color:#606060;'>Published:</span> Nov 26, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>One of the greatest threats to any website is outdated software. You will want to stay up to date with your Drupal 7 site. Updates are released often to fix bugs or add small features. Just as often, however, updates are released with new security plugs. This helps keep hackers at bay and keep your website strong. While not a complicated procedure, Drupal 7 does not have an auto-update feature. Below are the instructions for updating your Drupal 7 site manually.</p>
<p class="alert"><em>This article assumes you are using a cPanel host.</em></p>
<p><strong>Manually updating your Drupal 7 site</strong></p>
<ol class="article_list">
<li>You will first need to download the newest version of Drupal 7 to your local computer. You can find that by visiting <a href="http://drupal.org/download">http://drupal.org/download</a>.<br /><br /></li>
<li><a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">Log into your cPanel account</a>.<br /><br /></li>
<li>Once logged in, find the Files category and click on the File Manager icon. Be sure to select the web root location.<br /><br /></li>
<li>Look through your folder structure and locate the folder your Drupal 7 installation is housed. <strong>Do Not</strong> go into the folder. If it is in the public_html folder itself, be sure to click on the Up One Level icon at the top of the right panel.<br /><br /></li>
<li>Once you have located the folder, click on the name to highlight the folder, then click on the Copy icon found in the upper menu bar over to the left side. You will see a popup where you can name the folder the copy will be assigned to. As long as it is unique, you can name it anything you like. For example, in this case, we named it Drupal7-copy. Click on the <strong>Copy Files</strong> button to save a copy of the folder.<br /><br /></li>
<li>One more thing we want to preserve is the <em>Sites</em> folder in the original Drupal 7 location, go ahead and enter that folder (by double clicking it). Find the <em>Sites</em> folder, click it to highlight it, and then select the <strong>Rename</strong> icon. Rename the file, for example, to <em>Sites_copy</em>.<br /><br /></li>
<li>Now that is complete, we want to upload the compressed file that you downloaded onto your computer. Be sure you are back in the folder <strong>above</strong> the Drupal 7 installation as you were previously. Click on the <strong>Upload</strong> button and browse to the file. Once you have find it and click on <strong>Open</strong>, the download will begin automatically. After uploading, click on the link in the middle of the page to take you back to your previous folder.<br /><br /></li>
<li>Find the compressed file, click on it to highlight it, and click on the <strong>Extract</strong> icon. You will see a popup where you will be able to assign the folder for the content to be extracted to. Be sure to make it the same folder your Drupal installation resides.<br /><br /></li>
<li>Once extracted, double click on the folder to get to the Drupal install. The new files are not there yet. They are in a subfolder that is named after the current version, for example <em>drupal-7.17</em>. Double click on that folder as well to enter it. Select all files and folders that appear in this folder by holding the <strong>Ctrl</strong> key and pressing the <strong>A</strong> key simultaneously. Then click on the <strong>Move</strong> icon so we can move them up to the correct folder above. A popup will appear enabling you to give the destination folder, simply remove the last folder from the path and click <strong>Move Files</strong>.<br /><br /></li>
<li>After the move, go back up one folder by clicking the <strong>Up One Folder</strong> icon. You are now in the folder with all the new version files. We now need to ensure the <em>Sites-copy</em> file is returned to use&gt;. Find the <em>Sites</em> folder, click on it to highlight it, and click the <strong>Delete</strong> icon to remove it. After that, click on the <em>Sites-copy</em> to highlight the folder and click on the <strong>Rename</strong> icon. From here, rename it to <em>Sites</em>.<br /><br /></li>
<li>It is now time to ensure your Drupal site uses all the new files. Visit your site and and go to the <em>install.php</em> page. For example, if your domain name is ThisIsMySite.com, you will go to ThisIsMySite.com/install.php<br /><br /></li>
<li>An install screen will appear notifying you Drupal is installed. Click on the link at the end of the statement <strong>To upgrade an existing installation, proceed to the update script.</strong> and it will update the configuration.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/update/install.png"><img  alt="install" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/update/install.png" /></a><br /><br /></li>
<li>After completing the update, you can ensure you have the correct version of Drupal by <a href="/support/edu/drupal-7/getting-started/how-to-log-into-the-drupal-admin-dashboard">logging into your admin dashboard</a> and clicking on <strong>Administration</strong>. From that page, click on the <strong>Reports</strong> option and then <strong>Status Report</strong>. This screen will give you the version number on the first line.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/update/update-complete.png"><img  alt="update-complete" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/update/update-complete.png" /></a></li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/drupal-7'>Drupal 7</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 8: 306: How to update Drupal 7 manually.</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 7: <a href='/support/edu/drupal-7/307-install-youtube-module'>307: How to install and set up the YouTube module for Drupal 7</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 9: <a href='/support/edu/drupal-7/305-facebook-like-module'>305: How to install and set up the Facebook Like module for Drupal 7</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/drupal-7/306-manual-update&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/drupal-7/306-manual-update'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD05OCZpZD0yNDM2JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="37967bf34748352b544ef9cbe9281624" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/drupal-7/security-updates-for-drupal?tsrc=rsbraq'>Security updates for drupal</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						...
						<div><a style='font-size:16px;' href='//www.gravatar.com/2b1839220ccdb11182e6d45656a0af31'>benman</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-17 12:32 pm</div>
				                <div><p>Thanks - it worked perfectly.</p>
<p>&nbsp;</p>
<p>One question though - when I run cron I see the following message below. Clicking on the link, tells me that the solution is to upgrade to 7.24. But I bypassed that version to get to the current version on 7.31.&nbsp; Thoughts?</p>
<p>&nbsp;</p>
...
See <a href="http://drupal.org/SA-CORE-2013-003" target="_parent">http://drupal.org/SA-CORE-2013-003</a> for information about the recommended .htaccess file which should be added to the <em class="placeholder">/tmp</em> directory to help protect against arbitrary code execution.


</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15133);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-17 12:53 pm</div>
				                <div>The security issues that are referenced were resolved in versions above 7.24, but it would be a good idea to place the recommended lines inside a .htaccess file in your /tmp directory for additional security.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15134);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-17 2:17 pm</div>
				                <div><p>Thank you for that - I had not realized I had to do anything manual other than update drupal.</p>
<p>&nbsp;</p>
<p>but then I followed the instructions but am still getting the same error. Any thoughts? What I did is below:</p>
<p>&nbsp;</p>
<p>1) For the tmp directory - I assume&nbsp; we are referring to tmp directory in above the public html level. There was .htaccess one so I created one and filled it with the text as per the instructions.</p>
<p>2) I also found a .htaccess in .../sites/default/files and I replaced it accordingly.</p>
<p>&nbsp;</p>
<p>I cleared cache and ran cron....</p>
<p>&nbsp;</p>
<p>Cheers</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15137);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-17 2:59 pm</div>
				                <div>Hello Benman,<br />
<br />
I can only speculate at this point because I have not had this issue myself. What version were you upgrading from? What version are you upgrading to? Also, have you changed the temp directory from '/tmp' to 'tmp' at ' www.yoursite.com/admin/config/media/file-system' suggested in the link you provided?<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15139);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-17 5:32 pm</div>
				                <div><p>Hi</p>
<p>I think if I understand you correctly, I might have messed up on the tmp directory. Do the instructions mean that I need to create a tmp directory on my computer and not use the one on my website? I added the .htaccess to the existing tmp folder that is at the same level (hierarchy) as the public_html folder.</p>
<p>Am I making any sense?</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15149);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-17 5:41 pm</div>
				                <div><p>Further to my last email I seem to have fixed it.</p>
<p>The directory for my TMP folder was fine. What I needed to do was&nbsp; changed the temp directory from '/tmp' to '../tmp' at&nbsp;&nbsp; /admin/config/media/file-system&nbsp; (not sure if that was what you werre suggesting - I am still a novice). I found the hint here:https://www.ostraining.com/blog/drupal/drupal-724-tmp-directory/</p>
<p>&nbsp;</p>
<p>Thanks for your help</p>
<p>&nbsp;</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15153);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-17 6:02 pm</div>
				                <div>Hello Benman,<br />
<br />
Thanks for clarifying the issue.  I'll speak to the author of the issue and see if we can't make sure that the instructions for the tmp directory are clearer.  <br />
<br />
Thanks again!<br />
<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15156);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
