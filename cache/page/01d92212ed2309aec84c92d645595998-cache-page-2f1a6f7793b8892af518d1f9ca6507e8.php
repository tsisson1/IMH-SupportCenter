<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:64968:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/google-tools/google-api-keys" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-04-09T15:14:16-07:00" />
  ...
  <link href="http://www.inmotionhosting.com/support/website/google-tools/google-api-keys" rel="canonical" />
...
<script>
  ...
  ga('send', 'pageview');
	...
	<!-- cid:a95c56ead6338b0b5558ca4666ca0fc0 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '188.146.134.119']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Generating Google API keys</span></li>			</ul>
		</div>
	</div>
</div>
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>2,045</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Mar 28, 2014'><span style='color:#606060;'>Published:</span> Apr 9, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Getting Google API keys is quite an easy process.  If you need to connect to services such as Google Drive or Google Maps from your website or another remote server, you will need a Google API key. The Google Developers Console can be used to obtain Google API keys with just a few simple steps.</p>
<ol class="article_list">
    <li style='clear:both;'><p>First, you will need to log into the <a href="https://code.google.com/apis/console/" target="_blank">Google Developers Console</a>.</p></li>
    <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/google-tools/google-api-keys-1.png"><img src="//cdn.inmotionhosting.com/support/images/stories/google-tools/google-api-keys-1.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>Once on your Google Developers Console, create a new project.  To do so, click the <strong>Create Project</strong> button on the top left.</p></li>
    <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/google-tools/google-api-keys-2.png"><img src="//cdn.inmotionhosting.com/support/images/stories/google-tools/google-api-keys-2.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>Once the button is clicked, enter a project name.  You may use the project ID that is already populated for you as this is simply a unique identifier used on Google's end, or you can create your own.  Then, click <strong>Create</strong>.</p></li>
    <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/google-tools/google-api-keys-3.png"><img src="//cdn.inmotionhosting.com/support/images/stories/google-tools/google-api-keys-3.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>It can take a few minutes to create the project for you.  Once created, you will be taken to that project.</p></li>
    <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/google-tools/google-api-keys-4.png"><img src="//cdn.inmotionhosting.com/support/images/stories/google-tools/google-api-keys-4.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>From within your new project, click on <strong>APIs & auth</strong>.  You should now see a list of services.  Locate the API service that you want to use, and click on <strong>OFF</strong> to switch it to <strong>ON</strong>.  That API service is now active on your account.</p></li>
    <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/google-tools/google-api-keys-5.png"><img src="//cdn.inmotionhosting.com/support/images/stories/google-tools/google-api-keys-5.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>Now, you'll need to generate your API credentials.  To do so, click on <strong>Credentials</strong> on the left side of the page.</p></li>
    <li style='clear:both;'><p>The information that you need to generate will vary depending on your application that uses the Google API.  If you are using a service that will require user authentication such as uploading files to Google Drive, then you will need to create an <em>OAuth Client ID</em>.  If you are creating an application that simply relays data from Google such as generating maps with Google Maps, then you will need a <em>Public API Key</em>.</p>
    <h2>Key generation for OAuth applications</h2>
        <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/google-tools/google-api-keys-6.png"><img src="//cdn.inmotionhosting.com/support/images/stories/google-tools/google-api-keys-6.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>To generate an OAuth Client ID, click on the button that says <strong>Create New Client ID</strong>.  You will then be presented with a popup box that asks for the type of application, as well as authorized JavaScript origins and redirect URI.</p>
      <div style='clear:both;'></div>
...
<p><strong>Service account</strong>: This application type will allow your server to make a request to Google's servers, but the response back will not require user consent.  For more information on this type, take a look at <a href="https://developers.google.com/accounts/docs/OAuth2#serviceaccount" target="_blank">Google's documentation</a>.</p>
<p><strong>Installed application</strong>: This application type is used for an application that is physically installed onto a user's hard drive and runs locally on their computer.</p>
        ...
        <p>In this box, you will enter the location that your API calls are coming from.  For example, you could enter <em>http://example.com</em> in this box.  If you have additional domains that will be accessing the Google API, you may enter them on new lines.</p>
        <h3>Authorized redirect URI</h3>
        <p>In this field, you would define the exact url that will be used to process OAuth requests.  For more information on this, take a look at <a href="https://developers.google.com/accounts/docs/OAuth2#serviceaccount" target="_blank">Google's Redirect URI documentation.</a></p>
    <h2>Public API key generation</h2>
    <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/google-tools/google-api-keys-7.png"><img src="//cdn.inmotionhosting.com/support/images/stories/google-tools/google-api-keys-7.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>To access services that do not require user authentication, such as Google Maps, you will need to use a public API key.  To generate one, click on <strong>Create New Key</strong>.  You will have a few different key options to generate:</p>
...
<p><strong>iOS key</strong>: This option is used for making API calls from an iPhone, iPad, or iPod.</p>
    </li>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/google-tools/google-api-keys&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/google-tools/google-api-keys'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD03OCZpZD0zMTgzJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="f3586b900bd2b0894c996cf9528cd761" value="1" />	</div>
	</form>
<!-- <br />
