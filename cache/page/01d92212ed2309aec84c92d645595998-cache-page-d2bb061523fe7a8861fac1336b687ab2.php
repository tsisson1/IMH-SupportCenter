<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:61932:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/cpanel/domain-is-already-configured-owned-by-another-user" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-10-21T14:29:40-07:00" />
  <meta name="author" content="Jeff Matson" />
  <meta name="description" content="In this article, we will teach you how to resolve errors such as &quot;Domain is already configured&quot; or &quot;Domain is owned by another user&quot; in cPanel when adding a new domain." />
  <title>Domain is already configured/owned by another user - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/cpanel/domain-is-already-configured-owned-by-another-user" rel="canonical" />
...
<script>
  ...
  ga('send', 'pageview');
	...
	<!-- cid:7bb4180a92c40dd933be30b69ee79dda -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '69.27.47.6']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Domain is already configured/owned by another user</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Domain is already configured/owned by another user									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>2,600</span></div>
							...
							<div style='clear:both;'></div>
								...
								<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/cpanel/error-creating-domain-1.png"><img src="//cdn.inmotionhosting.com/support/images/stories/cpanel/error-creating-domain-1.png"  style='float:right; margin:0px 0px 15px 15px;'></a><p>When trying to configure an addon or parked domain in cPanel, may receive an error such as: <em>example.com is already configured</em> or <em>example.com is owned by another user</em>.  These errors can be caused by several different issues, and in this tutorial we will outline the various reasons that you may be receiving such an error.</p>
<div style='clear:both;'></div>
<h2>The domain is already within your cPanel account</h2>
<p>The most common reason for this error is because the domain already exists within your cPanel account as an <a href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-manage-domains/adding-add-on-domain-in-cpanel">addon domain</a> or <a href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-manage-domains/adding-a-parked-domain-to-cpanel">parked domain</a>.  To resolve this error, be sure to check through your addon and parked domains to ensure that it is not listed there.  If it is, you could either remove it or <a href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-manage-domains/modify-addon-domain-document-root">change the document root of the addon domain.</a></p>
<h2>The domain is within another cPanel account on the same server</h2>
<p>A less common, but still possible reason could be that the domain already exists within another cPanel account on the server.  This is more common on VPS and dedicated servers as you may have already added it to a separate account that you forgot about.  As each domain can only be added to a single cPanel account, you'll need to review each of your cPanel accounts to ensure that the domain is not the primary domain or an addon/parked domain within a previous account before you can add it to another cPanel account.</p>
<h2>There may be a configuration error on the server</h2>
<p>If the issue was unable to be resolved by the previous steps and you do not see the domain anywhere on your account, there could be some leftover configuration information still within the server that is causing it to still show as configured when it is not.  To resolve this, you would need to <a href="http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support">contact Technical Support</a> to take a further look at the issue.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/cpanel/domain-is-already-configured-owned-by-another-user&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/cpanel/domain-is-already-configured-owned-by-another-user'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD01NyZpZD0yOTA2JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="93a7799be3712ddb1261c528307ed017" value="1" />	</div>
	</form>
<!-- <br />
