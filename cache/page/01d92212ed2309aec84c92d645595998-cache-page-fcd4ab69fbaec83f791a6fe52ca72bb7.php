<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:56611:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/general-server-setup/php-fatal-error-message-out-of-memory" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello CanopyValley, When you change the settings in the php.ini file, they will only function for the files in that particular folder. The subfolders do..." />
  <title>PHP Fatal Error message Out of memory. | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/general-server-setup/php-fatal-error-message-out-of-memory" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:e9e17cca05163bb20b0d711516222ab9 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>PHP Fatal Error message Out of memory.</h1>
		<div style='margin-bottom:20px; margin-top:10px; clear:both; color:#6e6e6e;'>Category: <a href='/support/community-support/general-server-setup'>General Server Setup</a></div>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/CanopyValley'>CanopyValley</a>
			<div>32 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-06-19 11:27 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>1,801</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Hello Team,<br />
Could you please kindly shine me some light on the PHP out of memory error? <br />
I have a local PHP.ini setup with memory_limit set to 512.  I have redirect the error log to ~/public_html/logs/my_php_error.log <br />
<br />
What puzzle me is the error message we get is something similar to the one below <br />
&quot;[19-Jun-2013 07:14:30 America/Los_Angeles] PHP Fatal error:  Out of memory (allocated 45875200) (tried to allocate 72 bytes) in ...&quot;  <br />
<br />
We have validate our memory setting using phpinfo() and confirm the memory_limit is set to 512.  We also use a memory script to test the memory actually can went up to 512M.  However, the error indicate a fatal error of out of memory, allocated 45875200 (about 43.7 MB) <br />
<br />
Can you please help address the issue? thanks</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_3371' id='upvote_answer_3371' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='3371' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_3371').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_3371' id='downvote_answer_3371' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='3371' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_3371').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello CanopyValley,<br />
<br />
When you change the settings in the php.ini file, they will only function for the files in that particular folder. The subfolders do not abide by the changes in the php.ini unless you have it set to be recursive. You will need to set the <a href="http://www.inmotionhosting.com/support/website/general-server-setup/recursive-php-ini" target="_blank">php.ini to be recursive via the .htaccess</a> file. This will pass the 512MB limit to all folders under the public_html folder.  Give that a try and see if it helps with the memory error.<br />
<br />
Best Regards,<br />
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_3371').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_3371' id='form_comment_on_answer_3371' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
							...
							<td style='width:96px;' valign='top'>
								...
								<div class='smallgrey'>
									<a href='/support/community-support/users/CanopyValley'>CanopyValley</a><br />
...
Arnel C.</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>From my research, we come across this post about Cpanel RlimitMEM might affect script to run: http://forums.cpanel.net/f5/rlimitmem-troubles-136257.html<br />
I am not able to review the httpd.conf file and please validate if we can remoe rlimitmem or rlimitcpu setting? </div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello Canopyvalley,<br />
<br />
Regarding rlimitmem or rlimitcpu:  Neither of those are set on your server(or any of our servers.  The tier2 double-checked and its not on the server at all.<br />
<br />
Regards,<br />
<br />
Arnel C.</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/general-server-setup/php-fatal-error-message-out-of-memory&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/general-server-setup/php-fatal-error-message-out-of-memory'></div>
<script type='text/javascript'>
  (function() {
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
                                ...
                                <h3>Related Articles</h3><a target='_blank' href='http://inmotionhosting.com/support/how-to-run-exim-on-an-additional-port'>How to run Exim on an additional port</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/how-to-open-a-port-in-your-firewall'>How to open a port in your firewall</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/incrrease-file-display-limit'>How to increase the FTP visible file limits via command line</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/uid-smaller-than-min-uid'>SoftException UID is smaller than min_uid</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/understanding-linux-inodes'>Understanding Linux Inode basics</a><br/><br />
		</div>
