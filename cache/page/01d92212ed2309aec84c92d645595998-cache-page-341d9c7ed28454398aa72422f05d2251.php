<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:85289:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/ssl/self-signed-ssl-certificate-warning" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-03-24T20:18:04-07:00" />
  <meta name="keywords" content="ssl self signed self-signed cert certificate error warning" />
  <meta name="author" content="Jacob Nicholson" />
  <meta name="description" content="In this article I'm going to discuss why you would be receiving a warning or error in your web-browser when trying to access your server via the self signed SSL certificate while using a secure connection." />
  <title>Self signed SSL certificate warning - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/ssl/self-signed-ssl-certificate-warning" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:8d16116c97c6cb2296c071470e7c6652 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-22']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '119.235.50.118']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Self signed SSL certificate warning</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Self signed SSL certificate warning									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>37,647</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Mar 27, 2013'><span style='color:#606060;'>Published:</span> Mar 24, 2015</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In this article I'm going to discuss why you would be receiving a warning or error in your web-browser when trying to access your server via the self signed SSL certificate while using a secure connection.</p>

<h2>Self-signed SSL errors</h2>

<p>When you are trying to access a service such as <a href="/support/website/general-server-setup/whm-web-host-manager" target="_blank">WHM</a> on your server, over the SSL (Secure Socket Layer) protocol, the server has to identify itself with a SSL certificate to the web-browser.</p>
...
<p>By default the SSL certificate that would be configured on your server would be a self-signed one, essentially meaning that it has not been issued by a CA, but instead your own server has signed the certificate as being valid.</p>

<p>This works perfectly fine for encrypting data, but it will present you with an error or warning in your web-browser when trying to access the secure content. Below are examples of this from popular web-browsers:</p>

<h3>Google Chrome</h3>

<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/errors/ssl/chrome-your-connection-is-not-private.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/website/errors/ssl/chrome-your-connection-is-not-private.png" alt="Shared SSL Insecure warning" title="Chrome SSL error" /></a>

<p>Click on <strong>Advanced</strong>, then <strong>Proceed to <em>example.com</em> (unsafe)</strong> to bypass SSL warning in Chrome.</p>

<h3>Mozilla FireFox</h3>

<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/errors/ssl/firefox-self-signed-ssl-warning.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/website/errors/ssl/firefox-self-signed-ssl-warning.png" alt="firefox self signed ssl warning" /></a>

<p>Click on <strong>I Understand the Risks</strong>, then click on <strong>Add Exception...</strong>.</p><p>Next click on <strong>Get Certificate</strong>, and finally <strong>Confirm Security Exception</strong> to bypass SSL warning in FireFox.</p>

<h3>Microsoft Internet Explorer</h3>

<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/errors/ssl/internet-explorer-self-signed-ssl-warning.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/website/errors/ssl/internet-explorer-self-signed-ssl-warning.png" alt="internet explorer self signed ssl warning" /></a>

<p>Click on <strong>Continue to this website (not recommended)</strong> to bypass SSL warning in Internet Explorer.</p>

<br />

<p>This warning is simply letting you know that the SSL certificate was self-signed. In the case of accessing your own server this isn't a problem at all, and you can simply tell your web-browser to accept the self-signed SSL certificate and continue.</p>

<p>Where you would typically take caution on these types of errors would be if you were accessing your bank or a credit card's website, as that could be an indication your secure data isn't properly going to the right server.</p>

<p>If you'd like to not have a self-signed SSL certificate error when accessing your server via SSL, you can read our guide on <a href="/support/website/ssl/how-do-i-obtain-an-ssl-certificate" target="_blank">how do I obtain an SSL certificate</a>, as that explains how you could purchase a dedicated SSL certificate that would be issued via a Certificate Authority and not display the same warning.</p>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/ssl/self-signed-ssl-certificate-warning&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/ssl/self-signed-ssl-certificate-warning'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD03NiZpZD0yNTQ0JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="062ef4191a955a7755dfa54d197312b8" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/ssl/certificate-warning-despite-installation-of-ssl?tsrc=rsbraq'>Service Certificate still assigned to Self-signed Certificate</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/0c716deb3c8ec17c4d22d2394319606a?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/0c716deb3c8ec17c4d22d2394319606a'>S. Thomas</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-11 8:31 am</div>
				                <div><p>In Explorer or Mozilla neither display "Continue to this Website (not recommended)" or&nbsp; "I understand the risks".&nbsp; Is there a way to bypass this?&nbsp; Currently there is no way to proceed.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10539);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-12 9:01 am</div>
				                <div>Hello S. Thomas,<br />
<br />
Thank you for your question. We are happy to help, but will need some additional information to troubleshoot the problem.<br />
<br />
Since it is not displaying the "<em>Continue to this Website (not recommended)</em>" or  "<em>I understand the risks</em>" message, what is happening?<br />
<br />
Are you getting errors? What errors are you getting?<br />
<br />
If you have any further questions, feel free to post them below.<br />
Thank you,<br />
<br />
-John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10557);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-16 7:49 am</div>
				                <div><p>Hi John Paul,</p>
<p>This is the message I get in Firefox:</p>
<p>The certificate is not trusted because no issuer chain was provided. The certificate is only valid for mail The certificate expired on 3/1/2012 9:31 AM. The current time is 5/16/2014 7:31 AM. (Error code: sec_error_unknown_issuer)</p>
<p>It is strange because this is my work email portal and my coworkers say they can get in.&nbsp; I have tried intallling earlier versions of Explorer (per&nbsp;the IT guys at work)&nbsp;and I set my computer's date back to 2011 to no avail.&nbsp; The IT guys at work say I can get Puffin for my smart phone but I am old school-no smart phone.&nbsp;</p>
<p>Any ideas?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10670);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-15 8:22 am</div>
				                <div>Hi &lt;em&gt;S. Thomas&lt;/em&gt; - If you search google for:<br />
<br />
&amp;bull; Continue to this Website (not recommended) &lt;em&gt;is missing&lt;/em&gt;, or<br />
&amp;bull; I understand the risks &lt;em&gt;is missing&lt;/em&gt;<br />
<br />
... you'll see that quite a few others are having a similar problem. The &lt;a href='http://stackoverflow.com/questions/13418923/cant-access-my-local-site-through-ie-using-https-and-self-signed-certificate' target='_blank' rel='nofollow'&gt;solution for Internet Explorer&lt;/a&gt; sounds a little tricky (here's &lt;a href='http://www.evilbytes.com/forums/viewtopic.php?p=1364&amp;sid=894912c0e2e7c75904cdbf6db7c739d9' target='_blank'&gt;another solution&lt;/a&gt; to try), but if you want to test in Firefox, someone recommends &lt;a href='https://support.mozilla.org/en-US/questions/912832' target='_blank'&gt;this solution&lt;/a&gt;:<br />
<br />
&lt;ol class='article_list'&gt;&lt;li&gt;Start Firefox and go to the &quot;offending site.&quot;&lt;/li&gt;&lt;li&gt;Open a new tab and enter &quot;about:certerror&quot; to get the add exception panel.&lt;/li&gt;&lt;li&gt;Copy the URL of the offending site from the first tab and paste it into the URL field of the exception panel.&lt;/li&gt;&lt;li&gt;Follow the directions to make the exception permanent.&lt;/li&gt;&lt;/ol&gt;</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10657);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-16 7:43 am</div>
				                <div><p>Thanks Brad for your reply.&nbsp; Unfortunately it did not work for me.&nbsp;</p>
<p>In the <strong>Add Security Exception </strong>pop up when I enter the URL in the location field the only way to proceed is to click on the "Get Certificate" button.&nbsp; Once I do this Firefox says "Attempting to Verify the site..." then says "Unable to obtain identification for the given site".&nbsp;</p>
<p>This is my work email I am trying to get into&nbsp;and I coworkers say they can get in with no problem.</p>
<p>Thanks again though!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10667);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-16 8:22 am</div>
				                <div>It will indeed state &lt;em&gt;Attempting to Verify the site...&lt;/em&gt; until you enter the URL into the &lt;strong&gt;Location&lt;/strong&gt; field.  Be sure to enter this and it will then generate the certificate for the site entered within that field.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10672);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-21245'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/4bd8266586d3c61fb49b8385ee2540d5?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/4bd8266586d3c61fb49b8385ee2540d5'>Tom Pyle</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-02 6:55 pm</div>
				                <div><p>Some of the good info posted in the past few months is helpful in describing the impact of using the <strong>default self-signed certificate</strong> when accessing cpanel using the initial VPS domain alias. &nbsp; So it seems to me that we just have to step thru&nbsp;typical browser warning that this https certificate is not trusted, and establish permanent transparent SSL access to cpanel via our domain name, like: "https://www.mydomain.com/cpanel". &nbsp;AMP&nbsp;offers non-HTTPS links by default, but we are not stuck with that. &nbsp; &nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21245);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-24240'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/f032bc3a8026c2c0a4952fa5dea13430?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/f032bc3a8026c2c0a4952fa5dea13430'>joepostscript</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-15 10:44 pm</div>
				                <div><p>Would the addition of a fee paid SSL certificate to that server stop the error and enhance the credibility of that SMTP server?&nbsp; I don't want to bypass the error, I want for all the ISP on the web who reverse my mail server to verify it to not see errors.</p>
<p>Im more interested in the clear and clean validation and reputation than how to hotwire it around the error that every ISP will see when they look at my setup.&nbsp; The $60 to that mail.mydomain.com makes it all go away right?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24240);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-17 1:00 am</div>
				                <div>Hello Joepostscript,<br />
<br />
Yes if you purchased an ssl for mail.yourdomain.com it would remove the secure SMTP errors when connecting to the server. <br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24266);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/39fdad9596338d121328d41a6f385dde?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/39fdad9596338d121328d41a6f385dde'>G.Manjunatha</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-28 2:25 am</div>
				                <div><p>The Server you are connected to is using a security certificate that cannot be verified</p>
<p>The signature of the certificate can not be verified&nbsp;</p>
<p>View Certificate</p>
<p>Do you want to continue using this server?</p>
<p>Yes &nbsp; No</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25227);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-28 8:41 am</div>
				                <div>Hello G.Manjunatha,<br />
<br />
Yes that is the default response of this error. Are you getting this on your website? Do you need any assistance on this topic?<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25236);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
