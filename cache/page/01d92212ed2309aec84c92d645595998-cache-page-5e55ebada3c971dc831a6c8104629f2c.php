<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:73825:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-25/menus/menu-items-in-new-tab" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-11-30T19:41:10-08:00" />
  <meta name="keywords" content="joomla 2.5 menu item new window tab" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="In this Joomla 2.5 tutorial, we'll walk you through the steps for configuring menu items to open either in new window or new tab." />
  <title>Forcing Joomla 2.5 menu items to open in a new window - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-25/menus/menu-items-in-new-tab" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:d1d7fde3287ac2fcc3036f047bfc5fe5 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Forcing Joomla 2.5 menu items to open in a new window									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>8,253</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: May 25, 2012'><span style='color:#606060;'>Published:</span> Nov 30, 2015</div>
							...
							<div style='clear:both;'></div>
								...
								<p class="alert">Joomla 2.5 has reached its end of life as for 12/31/2014. Please be advised this may be a security risk to your website. You can view more information about the end of life <a href="https://docs.joomla.org/Joomla!_CMS_versions">here</a>.</p><br /><p>When creating new menu items in Joomla 2.5, the default behavior is for those links to open in the same window. Joomla 2.5 includes an option to open menu item links in a new window / tab, and in this tutorial we'll show you how to set this up.</p>
<p><strong>To force Joomla 2.5 menu items to open in a new tab:</strong></p>
<ol class="article_list">
<li><a href="/support/edu/joomla-25/getting-started/how-to-log-into-dashboard">Log into your Joomla 2.5 admin</a></li>
<li>In the top menu, hover over <strong>Menus</strong> and then then click on the menu group which contains the menu item you want to edit</li>
<li>In the list of menu items, click the menu item that you want to edit</li>
<li>Next to <strong>Target Window</strong>, choose one of the following options:<br /><br /> 
<table class="article_table">
<tbody>
<tr>
<th width="200">Parent</th>
<td><em>Parent</em> is the default setting, which opens links in the same window.<br /></td>
</tr>
<tr>
<th>New Window with Navigation</th>
<td>While the setting says New Window, this value will force links to open in a <span style="text-decoration: underline;"><strong>new tab</strong></span> (in most modern browsers)<br /><br />This new tab will include your basic navigation buttons such as refresh and back. It will also show any bookmarks you have in addition to any search engines that you have configured.<br /><br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/menu-new-window/links-with-navigation.gif"><img style="max-width: 240px;"  alt="links-with-navigation" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/menu-new-window/links-with-navigation.gif" /></a></td>
</tr>
<tr>
<th>New Without Navigation</th>
<td>New Without Navigation actually opens links in a <span style="text-decoration: underline;"><strong>new window</strong></span> all together, but doesn't include navigation.<br /><br />This new window will only show the address bar with the URL in it. It will not contain any bookmarks, navigation buttons, or any search engines. Also, this will prevent users from chaning the URL in the address bar.<br /><br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/menu-new-window/links-without-navigation.gif"><img style="max-width: 240px;"  alt="links-without-navigation" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/menu-new-window/links-without-navigation.gif" /></a></td>
</tr>
</tbody>
</table>
<br />After making your change, click <strong>Save</strong> in the top right menu.</li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 8: Forcing Joomla 2.5 menu items to open in a new window</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 9: <a href='/support/edu/joomla-25/menus/star-in-menu'>Why in Joomla 2.5 is there a star next to a menu item?</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-25/menus/menu-items-in-new-tab&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-25/menus/menu-items-in-new-tab'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xODYmaWQ9MTM3NCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='https://lh3.googleusercontent.com/-tnat-s9aE6E/AAAAAAAAAAI/AAAAAAAABwI/6iR6nKRhYmY/photo.jpg?sz=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='/support/community-support/users/vinuta'>vinuta</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-08-28 3:19 pm</div>
				                <div>Thanks  Brad Markle, how can set the width and height of the new window..? I want to open in a small window, currently it opens to full size.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8157);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-08-28 3:19 pm</div>
				                <div>how to set the width and height of the new window..? I want to open in a small window, currently it opens to full size.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8158);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-08-28 5:55 pm</div>
				                <div>Hello Vinuta, <br />
<br />
Thanks for the question!  Been searching around for this answer for quite a bit.  Not sure if this will do the trick. You were not the only one to ask, but there were very few answers for the question.   Here' s one way that may work - though it appears to be for another version:  <a href="http://forum.joomla.org/viewtopic.php?p=2060515" rel="nofollow" target="new">Joomla Forum- Menu Link window size</a>.  <br />
<br />
Hopefully those links will guide you toward a solution that will work for you.  Please let us know if you require any further assistance.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8159);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-08-29 12:34 am</div>
				                <div>Thanks Arnel, sure i will refer those links and hope they will help me.<br />
</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8160);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-22 5:29 am</div>
				                <div><p>How to set submenu to horizontal Joomla menu?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15294);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-22 1:19 pm</div>
				                <div>To set your menu as horizontal, you may follow our guide on &lt;a href=&quot;http://www.inmotionhosting.com/support/edu/joomla-25/menus/create-horizontal-menu&quot;&gt;horizontal submenus in Joomla&lt;/a&gt;.  Regarding submenu items, you would simply add them as you would any other submenu item by placing them under the parent menu item.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15338);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
