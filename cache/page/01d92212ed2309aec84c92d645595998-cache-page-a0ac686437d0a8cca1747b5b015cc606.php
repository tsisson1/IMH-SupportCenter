<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:59722:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/magento/how-to-change-url" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-10-15T21:16:04-07:00" />
  <meta name="author" content="John-Paul Briones" />
  <meta name="description" content="InMotion Hosting Support Center" />
  <title>How to Change your Magento URL - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/magento/how-to-change-url" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:d73bc24fb392cb297adaae6623ba3d74 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '182.72.135.230']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/website/magento' itemprop='url'><span itemprop='title'>Magento<span></a><div class='dropdown_3columns'><div class='col_3'><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/magento/how-to-change-url'>How to Change your Magento URL</a> (1493 hits)</div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to Change your Magento URL</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to Change your Magento URL									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>1,493</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Sep 16, 2014'><span style='color:#606060;'>Published:</span> Oct 15, 2014</div>
  ...
  <h2>In this tutorial:</h2>
    <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('dashboard');">Change URL in Dashboard</button>
    <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('phpmyadmin');">Change URL in phpMyAdmin</button>
  </div>

<p>There may be times when you need to change the URL, or domain name for your Magento website. For example, you may want to change your URL from <em>www.example.com</em> to <em>example.com</em>. In this guide I will show you how to <strong>change</strong> the <strong>URL</strong> for your <strong>Magento</strong> website.</p>

<a name="dashboard"></a>
<h2>Changing URL in the Dashboard</h2>
<ol class="article_list">
  <li><a href="/support/edu/magento/getting-started-tutorial/how-to-log-into-magento-admin-panel">Login to your Magento Dashboard</a>.</li>
  <li>In the main menu, roll your mouse over <strong>System</strong>, and click <strong>Configuration</strong>.<br>
  <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/magento/system-configuration.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/magento/system-configuration.png" alt="Changing your Magento URL" title="Accessing system configuration in Magento" /></a></li>
  <li>On the next screen click the <strong>Web</strong> button.<br>
  <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/magento/clicking-web-in-magento.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/magento/clicking-web-in-magento.png" alt="Web settings menu" title="Web settings in Magento" /></a></li>
  <li>You will then be on the <em>Web</em> menu, click the <strong>Unsecure</strong> link, and it will drop down. In the <strong>Base URL</strong> section, update your URL.<br>
  <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/magento/changing-unsecure-base-url-magento.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/magento/changing-unsecure-base-url-magento.png" alt="updating domain name in magento" title="Changing Magento Secure URL " /></a></li>
  <li>Click the <strong>Secure</strong> link now. Fill in the <em>Base URL</em> in this section.<br>
  <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/magento/changing-secure-base-url-magento.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/magento/changing-secure-base-url-magento.png" alt="updating domain name in Magento" title="Changing your Secure URlin Magento" /></a></li>
  <li>Click the <strong>Save Config</strong> button in the top right when you are finished. You will then see a message stating "<em>The configuration has been saved.</em>"</li>
  <li><a href="/support/edu/magento/202-magento-cache-management/how-to-clear-the-magento-cache">Clear your Magento cache data</a>.</li><br></ol>


<a name="phpmyadmin"></a>
<h2>Changing URL in phpMyAdmin</h2>
<ol class="article_list">
  <li><a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">Login to cPanel</a>.</li>
  <li>Click the <strong>phpMyAdmin</strong> button in the <em>Databases</em> section.<br>
  <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/magento/php-my-admin.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/magento/php-my-admin.png" alt="Database access in cPanel" title="Accessing phpMyAdmin" /></a></li>
  <li>On the left menu, click the database that is associated wit your Magento website.</li>
  <li>Locate the table ending in <strong>core_config_data</strong>, and click it.<br>
  <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/magento/core_config_data.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/magento/core_config_data.png" alt="Magento URL update in database" title="Updating core_config_data in Magento" /></a></li>
  <li>In the <em>path</em> column, locate and update the URL in following lines, by clicking the <strong>Edit</strong> buttons:
  <strong>web/unsecure/base_url</strong><br>
  <strong>web/secure/base_url</strong>
  </li>
  <li>Click the <strong>Go</strong> button after updating each URL to save your changes.</li>
  <li><a href="/support/edu/magento/202-magento-cache-management/how-to-clear-the-magento-cache">Clear your Magento cache data</a>.</li><br></ol>
<p>Congratulations, now you know how to change your Magento URL in the dashboard, and phpMyAdmin!</p>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/magento/how-to-change-url&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/magento/how-to-change-url'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD03OSZpZD0zMzg3JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="27d1895bebedbf7920b2cd14cbd264d9" value="1" />	</div>
	</form>
<!-- <br />
