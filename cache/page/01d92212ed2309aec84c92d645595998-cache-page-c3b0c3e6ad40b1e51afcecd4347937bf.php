<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:82096:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-3/joomla-blog/read-more" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-09-28T17:03:35-07:00" />
  <meta name="keywords" content="joomla 3.0 read more link button" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="If you write very long blog posts, you'll want to learn how to add a read more button. This will help prevent your frontpage from being a mile long, and makes it easier for users to navigate your site." />
  <title>How to add a Read more button in Joomla 3.1 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-3/joomla-blog/read-more" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:f7da0d5887c2eee7f88a4ebfaee8e6d8 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '41.217.7.106']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to add a Read more button in Joomla 3.1									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>25,258</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Sep 28, 2012'><span style='color:#606060;'>Published:</span> Sep 28, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/blog/long-blog-post.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="long-blog-post" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/blog/long-blog-post.gif" /></a>In our last tutorial, we showed you <a href="/support/edu/joomla-3/joomla-blog/write-blog-post">how to write a blog post in Joomla 3.0</a>. Our example was a very short post, but if you write a very long post, then entire post will show on your homepage (as in the screenshot to the right).</p>
<p>You can make your homepage look much cleaner if you add a <strong>Read More</strong> button within the article. In this tutorial, we'll show you just how to do that.</p>
<div style="clear: both;"></div>
<p><strong>Adding a Read More link in Joomla 3.0</strong></p>
<ol class="article_list">
<li><a href="/support/edu/joomla-3/getting-started/login-dashboard">Log into your Joomla 3.0 admin dashboard</a></li>
<li><strong>Open the blog post you want to edit</strong><br /><br />In the top menu, click <strong>Content</strong> and then click <strong>Article Manager</strong>. Within the list of articles, click on the title of the article that you want to add the <em>read more</em> link to.</li>
<li><strong>Add the read more link</strong><br /><br />Within the article editor, place your cursor where you want the read more link to appear. Then, under the editor, click the <strong>Read More</strong> button. You will notice a red dotted line appear within the editor, which shows where you just inserted the button.<br /><br />Joomla is actually adding the following code to the article:
<pre class="code_block">&lt;hr id="system-readmore" /&gt;
</pre>
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/blog/read-more-button-seen-on-homepage.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="read-more-button-seen-on-homepage" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/blog/read-more-button-seen-on-homepage.gif" /></a>When finished, click the <strong>Save</strong> button at the top left of the page. Comparing the screenshot to the right to the one at the top of this tutorial, you can see that we now have the following button under the article:<br /><br /><strong>Read more: My first blog post</strong><br /><br />This makes our homepage look much cleaner and professional.
<div style="clear: both;"></div>
</li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 2: How to add a Read more button in Joomla 3.1</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 1: <a href='/support/edu/joomla-3/joomla-blog/write-blog-post'>How to write a blog post in Joomla 3.1</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 3: <a href='/support/edu/joomla-3/joomla-blog/new-banner-image'>How to change the banner image in Joomla 3.1</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-3/joomla-blog/read-more&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-3/joomla-blog/read-more'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNjkmaWQ9MTgxOCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="1c452919e58aa6f830ead659009328a7" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						...
						<div><a style='font-size:16px;' href='/support/community-support/users/mueva8'>mueva8</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-07-07 10:31 am</div>
				                <div>Hi<br />
I've tried to insert a readmore button in an article but it don't work.<br />
In the article edition it appear the &lt;hr id=&quot;system-readmore&quot; /&gt; code but than it doesn't appear in the site. and also no readmore button.<br />
my site is beta.thewanderlust.pt<br />
can you help me?</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8015);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-07-08 2:41 pm</div>
				                <div>&lt;div style=&quot;background-color: #FFF; padding-left: 10px;&quot;&gt;Hello mueva8, and thanks for your comment.<br />
<br />
I took a look through several of your pages, and didn't see the &lt;strong&gt;&amp;lt;hr id=&quot;system-readmore&quot;&amp;gt;&lt;/strong&gt; code anywhere. It sounds like when you're clicking on the &lt;strong&gt;Read more&lt;/strong&gt; button in Joomla, you are seeing this code added in the source?<br />
<br />
It sounds like possibly with the way your caching or publishing settings are setup, that the most recent version of the article you're updating is being used.<br />
<br />
It doesn't look like that domain is hosted with us, so I was unable to take a closer look on the server, you might want to contact your current host and see if they can see anything for you.<br />
<br />
- Jacob&lt;/div&gt;<br />
<br />
</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8017);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-8332'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='https://lh3.googleusercontent.com/-s0zNhoa5_HU/AAAAAAAAAAI/AAAAAAAAAsw/zK5KCzfvqK0/photo.jpg?sz=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='/support/community-support/users/thief1959'>thief1959</a></div>
						<div></div>
						<div></div>
						<div>3 <a href='/support/team/points' target='_blank'>Points</a></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-10-30 5:14 am</div>
				                <div>Hi!<br />
I have simular problem. I have made site with Joomla 3, insert &quot;system-readmore&quot; in JCKEditor, but it doesn't work (appear). However, I can see it in editor source view, but in site (using localhost for now) it simple disapper (you can not find it on view source looking).<br />
I have readed in some forums that is important what kind of articles are you using (must be blog layout)? <br />
Can someone explain cause for this problem and show solution?</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8332);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-10-30 11:21 am</div>
				                <div>Hello thief1959,<br />
<br />
It sounds like you may be viewing a cached version of the site which is causing it to not be displayed.  Try &lt;a href=&quot;http://www.inmotionhosting.com/support/website/how-to/clear-browser-cache&quot;&gt;clearing your browser cache&lt;/a&gt; to ensure everything is fresh.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8335);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/ed21c64eb579f0a326b173c6ed19630f?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/ed21c64eb579f0a326b173c6ed19630f'>franc</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-13 9:52 am</div>
				                <div><p>i have had this problem of read more for long. please if possible i request anyone to help me.</p>
<p>1 if i use readmore in an article it doesnt work (eg article manager-&gt; new article)</p>
<p>2 if i use feutured article the readmore appears but now the problem come. all my articles appear in every page of the menu eg if tou have menu home aboutus news and articles tom , chali, cell,dom all appear in every menu home aboutus news etc</p>
<p>&nbsp;</p>
<p>please help</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11510);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-13 9:59 am</div>
				                <div>Could you clarify what exactly happens when you attempt to add the Read More link to your article using the article manager?</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11512);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-13 10:04 am</div>
				                <div><p>the readmore doesnt appear</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11513);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-13 10:24 am</div>
				                <div>When inserting the &lt;em&gt;Read More&lt;/em&gt; link, it will simply intert a red line at the place of your cursor.  Be sure that you are clicked within your content, then click it.  If you do not see it, you may have a deeper issue within your Joomla installation in which I would then recommend that you disable any extensions as well as replace all of your Joomla core files.  </div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11516);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-13 10:26 am</div>
				                <div><p>the red line is there bur readmore on output is the issue it doesn't appear</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11517);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-13 10:44 am</div>
				                <div>If you're not seeing it on the front end, it sounds like it is an issue with your theme.  I recommend contacting the developer of the theme you are using for more information.  It could potentially also be caused by any extensions you may have as well.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11520);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
