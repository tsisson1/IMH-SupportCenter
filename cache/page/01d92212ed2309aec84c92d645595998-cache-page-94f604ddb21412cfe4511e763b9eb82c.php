<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:56279:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/joomla-3/how-to-change-template-background-color" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello rchorsch, Thank you for your question. Here is a link to our walk-through guide on how to change the background color of a joomla template. In the..." />
  <title>Change a template background color in Joomla? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/joomla-3/how-to-change-template-background-color" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:472220193f4c94516dc7b17f3c54e0fc -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Change a template background color in Joomla?</h1>
		<div style='margin-bottom:20px; margin-top:10px; clear:both; color:#6e6e6e;'>Category: <a href='/support/community-support/joomla-3'>Joomla 3</a></div>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='https://lh6.googleusercontent.com/-DBAEi8hIeAY/AAAAAAAAAAI/AAAAAAAAAAA/QM5I7SkscHw/photo.jpg?sz=90' class='user_avatar' /><br />
			<a href='/support/community-support/users/rchorsch'>rchorsch</a>
			<div>23 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-09-09 9:53 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>10,160</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>How do I edit template source code?<br />
<br />
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_3910' id='upvote_answer_3910' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='3910' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_3910').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_3910' id='downvote_answer_3910' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='3910' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_3910').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello rchorsch,<br />
<br />
Thank you for your question. Here is a link to our walk-through guide on how to <a href="http://www.inmotionhosting.com/support/edu/joomla-3/protostar/background-colour" target="_blank" ><strong>change the background color of a joomla template</strong></a>.<br />
<br />
In the example we modify the Protostart Joomla template.<br />
<br />
...
-John-Paul
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_3910').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_3910' id='form_comment_on_answer_3910' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Thank you but I am NOT talking about the site background color. I am asking about the background color WITHIN the remplate. I believe I will have to edit the remplate source.<br />
<br />
Thank you.<br />
</div>
							...
							<td style='width:96px;' valign='top'>
								<img src='https://lh6.googleusercontent.com/-DBAEi8hIeAY/AAAAAAAAAAI/AAAAAAAAAAA/QM5I7SkscHw/photo.jpg?sz=90' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/rchorsch'>rchorsch</a><br />
									23 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2013-09-10 12:06 pm EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>&lt;div style=&quot;background-color: #FFF; padding-left: 10px;&quot;&gt;Hello rchorsch,<br />
<br />
If you wanted to directly &lt;strong&gt;modify&lt;/strong&gt; the &lt;strong&gt;templates&lt;/strong&gt; instead of using the &lt;a href=&quot;http://www.inmotionhosting.com/support/edu/joomla-3/edit-template&quot;&gt;template editor&lt;/a&gt;, you'd simply open up the CSS file that is causing the change for your template.<br />
<br />
For instance I'm using the &lt;strong&gt;beez_20&lt;/strong&gt; template on my Joomla site, and it has a grey background by default for the entire page, and a white background for the area around the content.<br />
<br />
My theme's &lt;strong&gt;personal.css&lt;/strong&gt; file contains this CSS rule for the &lt;strong&gt;body&lt;/strong&gt; tag causing the background to be grey:<br />
<br />
&lt;pre class=&quot;code_block&quot; style=&quot;width: 500px; white-space: normal; margin-bottom: -30px;&quot;&gt;body<br />
{<br />
        background: #e0dedf  url(../images/personal/bg2.png) repeat-x;&lt;/pre&gt;<br />
<br />
I changed this to:<br />
<br />
&lt;pre class=&quot;code_block&quot; style=&quot;width: 500px; white-space: normal; margin-bottom: -30px;&quot;&gt;body<br />
{<br />
        background: black;&lt;/pre&gt;<br />
<br />
The &lt;strong&gt;#header&lt;/strong&gt; class making the background white:<br />
<br />
&lt;pre class=&quot;code_block&quot; style=&quot;width: 500px; white-space: normal; margin-bottom: -30px;&quot;&gt;#header<br />
{<br />
        background:#fff;&lt;/pre&gt;<br />
<br />
I changed to blue:<br />
<br />
&lt;pre class=&quot;code_block&quot; style=&quot;width: 500px; white-space: normal; margin-bottom: -30px;&quot;&gt;#header<br />
{<br />
        background: blue;&lt;/pre&gt; <br />
<br />
Also finally the &lt;strong&gt;#contentarea&lt;/strong&gt; class making that section white as well:<br />
<br />
&lt;pre class=&quot;code_block&quot; style=&quot;width: 500px; white-space: normal; margin-bottom: -30px;&quot;&gt;#contentarea,<br />
#contentarea2<br />
{<br />
        background:#fff&lt;/pre&gt;<br />
<br />
Which I changed to grey with:<br />
<br />
&lt;pre class=&quot;code_block&quot; style=&quot;width: 500px; white-space: normal; margin-bottom: -30px;&quot;&gt;#contentarea,<br />
#contentarea2<br />
{<br />
        background: grey;&lt;/pre&gt;<br />
<br />
Here were the results of those quick edits, please don't critique my color scheme as I was just trying to show very clearly what each one did :)<br />
<br />
&lt;img src=&quot;http://www.inmotionhosting.com/support/images/stories/questions/joomla-css-edits.png&quot; alt=&quot;Showing Joomla CSS edits changing template colors&quot;&gt;<br />
<br />
If you happen to be unaware how to directly edit files on the server, you can take a look at our guide on &lt;a href=&quot;http://www.inmotionhosting.com/support/website/how-to/how-to-edit-a-file&quot; target=&quot;_blank&quot;&gt;how to edit a file on my server&lt;/a&gt; which covers some various methods.<br />
<br />
I hope that answered your specific question, if I misunderstood what you're trying to do please clarify a bit what end result you're hoping for and we can provide further assistance.<br />
<br />
- Jacob&lt;/div&gt;</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/joomla-3/how-to-change-template-background-color&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/joomla-3/how-to-change-template-background-color'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="5859e49533ca7c4ad26d28bd58562880" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
                                ...
                                <h3>Related Articles</h3><a target='_blank' href='http://inmotionhosting.com/support/install-jotcache'>Installing the JotCache Extension in Joomla 3</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/optimization'>How to Optimize your Joomla Site</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/move-subfolder-to-root'>How to move your Joomla application from a subfolder to the root folder.</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/remove-base-tag'>How to remove the "base href" tag Joomla 3</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/param'>@param - Joomla DocBlock headers</a><br/><br />
		</div>
