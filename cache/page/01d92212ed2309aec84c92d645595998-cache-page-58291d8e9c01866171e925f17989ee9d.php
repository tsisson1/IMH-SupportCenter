<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:64168:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/moodle/question-bank/calculated-tolerance" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-11-06T14:16:56-08:00" />
  <meta name="keywords" content="Moodle 2.3 calculated questions tolerance answers" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="Moodle 2.3 can have calculated questions set to a specific tolerance. This allows answers to be correct, even if they are close to the correct answer. This tutorial will explain using the tolerance in the Moodle 2.3 calculated question." />
  <title>Working with the calculated question Tolerance in Moodle 2.3 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/moodle/question-bank/calculated-tolerance" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:d585dda642905dd725bd4bfe095e5993 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '108.28.103.163']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Working with the calculated question Tolerance in Moodle 2.3									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>1,376</span></div>
							...
							<div style='clear:both;'></div>
								...
								<p>In the previous tutorial in on <a href="/support/edu/moodle/question-bank/calculated-question-bank" title="Click here to view the previous article" target="_blank">Inserting a Calculated question in the Moodle Question Bank</a>, there was a setting called <strong>Tolerance</strong>. The <strong>Tolerance</strong> of a question is used to allow answers to be correct, even if they are close to the correct answer. For example, if a math question is <strong>2.3 x 2.011</strong>. The correct answer is <strong>4.6253</strong>. If the student answers <strong>4.63</strong>, the tolerance can accept that answer as correct, even though its not the exact answer. This is similar to "<em>Grading on a curve</em>". This tutorial will explain using the tolerance in the Moodle 2.3 calculated question.</p>
<h3>Setting the Tolerance for a calculated question</h3>
...
<li>Navigate to the <strong>Front page settings</strong> &gt; <strong>Question bank</strong> &gt; <strong>Questions</strong>. Click one of the calculated questions that were created. If there are no calculated questions <a href="/support/edu/moodle/question-bank/calculated-question-bank" target="_blank" title="Click here for more information">create one</a>.</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/104/calculated-tolerance/calculated-tolerance.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="calculated-tolerance" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/104/calculated-tolerance/calculated-tolerance.gif" title="Click here to view the larger image" width="200" /></a>On the <strong>Editing a Calculated multichoice question</strong> page, go to the <strong>Answer </strong>section. The following chart will explain the different tolerances. <br style="clear: both;" />
<p class="alert"><strong>Note!</strong> The tolerance is designed to match the answer with a specific parameter. An answer of <strong>15.7</strong> can be answer as <strong>16</strong>, <strong>27</strong> as <strong>30</strong>, and or <strong>50</strong> as <strong>50.0</strong> and so forth. For example, a Nominal tolerance with the correct answer as <strong>100</strong> and the tolerance as <strong>0.01</strong>, the Formula will be <strong>(100)*(0.01) &lt;=1</strong>. The tolerance is <strong>&lt;= 1</strong>. So the answer will be correct if its between <strong>99</strong> and <strong>101</strong>.</p>
<br style="clear: both;" />
<table style="width: 100%;" class="article_table" border="0">
<tbody>
<tr><th colspan="3" style="background: #cccccc;" valign="top">Calculating the tolerance type for correct answers</th></tr>
<tr>
<td colspan="3" valign="top"><strong> Tolerance</strong> = <span style="color: #330000;">T</span><br /><strong>Correct Answer</strong> = <span style="color: #cc0000;">c</span><br /><strong>Tolerance±=</strong> = <span style="color: #339900;">X</span></td>
</tr>
<tr>
<td valign="top"><strong>Nominal</strong></td>
<td colspan="2" valign="top">The Nominal tolerance will mark an answer correct if the answer is within the parameters of <span style="color: #339900;">X</span><span style="color: #cc0000;">c</span> &lt;=<span style="color: #330000;">T</span>.</td>
</tr>
<tr>
<td valign="top"><strong>Relative</strong></td>
<td colspan="2" valign="top">The Relative tolerance will mark an answer correct if the answer is within the parameters of <span style="color: #339900;">X</span><span style="color: #cc0000;">c</span> / <span style="color: #cc0000;">c</span> &lt;= <span style="color: #330000;">T</span>.</td>
</tr>
<tr>
<td valign="top"><strong>Geometric </strong></td>
<td colspan="2" valign="top">The Geometric tolerance will mark an answer correct if the answer is within the parameters of <span style="color: #339900;">X</span><span style="color: #cc0000;">c</span><sup>2</sup> / <span style="color: #cc0000;">c</span><sup>2</sup> &lt;= <span style="color: #330000;">T</span><sup>2</sup></td>
</tr>
</tbody>
</table>
<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/104/calculated-tolerance/calculated-tolerance-final.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="calculated-tolerance-final" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/104/calculated-tolerance/calculated-tolerance-final.gif" title="Click here to view the larger image" width="200" /></a>Finally, preview the question. The answer should look like the following snapshot. The Tolerance is something that will need to be expirimented with to find the perfect setting for each question.<br style="clear: both;" /></li>
</ol>
<p>This concludes the article for Working with the calculated question Tolerance. Please check the next article on <a target="_blank" href="/support/edu/moodle/question-bank/calculated-multichoice-bank" title="Click here to view the next article">Adding a Calculated multichoice question in the Moodle Question Bank</a>. Please visit <a target="_blank" href="/support/edu/moodle/question-bank" title="Click here to view the courses">Working with the Question Bank</a> for more information on questions in the question bank.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 4: Working with the calculated question Tolerance in Moodle 2.3</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 3: <a href='/support/edu/moodle/question-bank/calculated-question-bank'>Inserting a Calculated question in the Moodle  Question Bank</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 5: <a href='/support/edu/moodle/question-bank/calculated-multichoice-bank'>Adding a Calculated multichoice question in the Moodle Question Bank</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/moodle/question-bank/calculated-tolerance&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/moodle/question-bank/calculated-tolerance'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yODkmaWQ9MTk1NyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="41fe6fab6914f6204983cbbedd7b498a" value="1" />	</div>
	</form>
<!-- <br />
