<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:73186:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/backup-and-restore/automatic-remote-backup-service" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-03-19T22:54:05-07:00" />
  <meta name="keywords" content="automatic remote backups backup back up ups service restore" />
  <meta name="author" content="Jacob Nicholson" />
  <meta name="description" content="We offer an automatic backup service for all of our servers, that lets you exceed the default free 10GB of disaster recovery backup storage that comes with either a VPS or shared hosting account." />
  <title>Automatic remote backup service - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/backup-and-restore/automatic-remote-backup-service" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:057ab8a8056a5941a9876942674ea66e -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-22']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '186.4.225.5']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Automatic remote backup service									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>7,878</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Sep 3, 2013'><span style='color:#606060;'>Published:</span> Mar 19, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>We offer an automatic remote backup service on all servers for disaster recovery.</p>

<p>These backups run every <strong>24-36 hours for emergency purposes</strong>, and a <a href="http://www.inmotionhosting.com/support/website/website-troubleshooting/restoring-a-backup" target="_blank">data restoration</a> can be requested in AMP.</p>

<p>Backups <strong>overwrite previous backup data</strong>, so we <strong>strongly recommend</strong> maintaining backups of your own as well.</p>

<h2>Remote backup levels and cost</h2>

<p><a href="http://www.inmotionhosting.com/business-hosting" target="_blank">Shared</a>, <a href="http://www.inmotionhosting.com/vps_hosting.html" target="_blank">VPS</a>, and Reseller accounts come with the first <strong>10GB</strong> block of remote backups <strong>free</strong>.  

<p><a href="http://www.inmotionhosting.com/dedicated_servers.html" target="_blank">Dedicated servers</a> have larger local drives and can <a href="/support/website/backup-and-restore/configure-local-backups-in-whm" target="_blank">configure local backups in WHM</a>, or pay for remote backups.</p> 
            
<table class="article_table" style="width: 650px; margin-bottom: 15px;">
<tbody>
 <tr><th style="padding: 15px; text-align: center; width: 100px;">Platform</th>
     <th style="padding: 15px; text-align: center; width: 25px;">Free 10GB</th>
     <th style="padding: 15px; text-align: center;">Account Size</th>
     <th style="padding: 15px; text-align: center;">Backup Size</th>             
     <th style="padding: 15px; text-align: center; width: 150px;">10GB Blocks Needed</th>
     <th style="padding: 15px; text-align: center;">Cost</th>
</tr>
<tr><td style="padding: 15px; text-align: center; width: 100px;">Shared and VPS</td>
    <td style="padding: 15px; text-align: center; width: 25px;"><strong style="color: green;">Yes</strong></td>
<td style="padding: 15px; text-align: center;">18GB</td>
<td style="padding: 15px; text-align: center;">20GB</td>    
<td style="padding: 15px; text-align: justify; width: 155px;">1 x 10GB @ FREE<br />1 x 10GB @ $7.50 / Month</td>    
<td style="padding: 15px; text-align: center; width: 90px;">$7.50 / Month</td>    
</tr>
<tr><td style="padding: 15px; text-align: center; width: 100px;">Dedicated</td>
    <td style="padding: 15px; text-align: center; width: 25px;"><strong style="color: red;">No</strong></td>
<td style="padding: 15px; text-align: center;">18GB</td>
<td style="padding: 15px; text-align: center;">20GB</td> 
<td style="padding: 15px; text-align: center; width: 155px;">2 x 10GB @ $7.50 / Month</td>     

<td style="padding: 15px; text-align: center; width: 90px;">$15.00 / Month</td>    
</tr>    
</tbody>
</table>

<h2>Get alerted when backup level changes</h2>

<p>You can setup an <a href="http://www.inmotionhosting.com/support/website/general-server-setup/email-alert-when-backup-limit-exceeded" target="_blank">email alert when your backup limit is exceeded</a> so that you can be sure to either reduce your disk-usage or start paying for additional blocks of disk-space.</p>

<h2>Request remote backup service</h2>

<p>If you'd like to have our automatic backup service turned on, or the size of your backups adjusted. Please contact us at <a href="mailto:support@inmotionhosting.com">support@inmotionhosting.com</a> and include account verification either in the form of your current AMP password, or the last 4 digits of the credit card on file.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/backup-and-restore/automatic-remote-backup-service&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/backup-and-restore/automatic-remote-backup-service'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MjImaWQ9MjgyMSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="371b8a791bfab671d5973e54f13030c0" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/f69226d88bf7b143f55dbdfcdb2f840c?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/f69226d88bf7b143f55dbdfcdb2f840c'>Robert Hatch</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-05 9:41 am</div>
				                <div><p>I would like to sign up for backup services for my account. My password is *removed by moderator*</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23978);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-05 10:16 am</div>
				                <div>Hello Robert,<br />
<br />
We are unable to make such adjustments here as the public area is for general questions and advice. To have account specific adjustments made, you will need to contact the Live Support team.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23983);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-31796'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/8bde59b67bcec5fadae77ee3ef7dd73c?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/8bde59b67bcec5fadae77ee3ef7dd73c'>fabian silva</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-08 10:13 am</div>
				                <div><p>this service by default is turned on and no request have to be made to enable it? &nbsp;the last paragraph not leave it clean if have to request it or is enabled by default. thanks in advance :)</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31796);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-08 1:26 pm</div>
				                <div>Hello Fabian,<br />
<br />
You do not have to request this service unless your account is over the limits stated above.<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31802);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-32180'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/5ca500a8da5a9ab0954caba74bfb0d7b?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/5ca500a8da5a9ab0954caba74bfb0d7b'>Eva Capobianco</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-22 4:36 pm</div>
				                <div><p>Does In Motion offer any services to store backups longer than 24 to 36 hours?&nbsp; I lost my wordpress site and by the time I requested a restore, the most recent backup had been done about 12 hours earlier.&nbsp; If it had been 36 hours, I might have had a chance.&nbsp; But I was too late.&nbsp; And I had not been diligent about saving the backups to a separate location.&nbsp; My bad....</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32180);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-22 6:52 pm</div>
				                <div>Hello Eva,<br />
<br />
Unfortunately we do not, however if you are on a VPS+ server we can setup different backups solutions that would be stored on your server.<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32183);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
