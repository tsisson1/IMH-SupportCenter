<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:63332:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/email/fighting-spam/create-spf-cpanel" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-04-22T14:40:35-07:00" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="This article guides you on creating an SPF record for your domain within your cPanel." />
  <title>Creating a basic SPF Record in cPanel - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/email/fighting-spam/create-spf-cpanel" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:84f2c14aa1ecc0dacb39e7d9a7d70bbc -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '196.210.34.16']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Creating a basic SPF Record in cPanel</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Creating a basic SPF Record in cPanel									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>4,911</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Apr 21, 2014'><span style='color:#606060;'>Published:</span> Apr 22, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>SPF records are necessary in order to help prevent your email addresses from being spoofed. If you do not understand what spoofing or an SPF record is, please see our Guide to SPF Records. This article is part of that series where we demonstrate how to set up a basic SPF record from within your cPanel.</p>

<h2>Creating a basic SPF Record within cPanel</h2>
<ol class="article_list">
  ...
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/email/spf/guide/1-click-email-authentication.png"><img   style="float:right; margin:0px 0px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/email/spf/guide/1-click-email-authentication.png" title="Click here to view the larger image" width="200" /></a>From the main cPanel page, look for the <em>Email</em> category. From there, click on the <strong>Email Authentication</strong> icon.<div style="clear:both;"></div></li>

  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/email/spf/cpanel/1-set-all.png"><img   style="float:right; margin:0px 0px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/email/spf/cpanel/1-set-all.png" title="Click here to view the larger image" width="200" /></a>This brings you to the <em>Email Authentication</em> screen. Begin by finding the <em>SPF</em> subsection, which is the vast majority of the page. Scroll down to the lower part of the screen and check the checkbox for the <strong>All Entry (ALL):</strong>.
    <br /><br />
    <div class="alert"><span style="color:red">This is important as it adds the '<em>-all</em>' to the end of the record so that all addresses that fail the other checks will be rejected.</span></div><div style="clear:both;"></div></li>

  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/email/spf/cpanel/2-enable-spf.png"><img   style="float:right; margin:0px 0px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/email/spf/cpanel/2-enable-spf.png" title="Click here to view the larger image" width="200" /></a>Now that you have set the basic SPF settings, scroll back up to the top and click the <strong>Enable</strong> button for the <em>SPF</em> section.<div style="clear:both;"></div></li>
</ol>

<br />

<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/email/spf/cpanel/3-spf-success2.png"><img   style="float:right; margin:0px 0px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/email/spf/cpanel/3-spf-success2.png" title="Click here to view the larger image" width="200" /></a>The server now creates the SPF record for your hosting account. You will receive a success message along with the SPF record's full syntax on the screen.</p>
<div style="clear:both;"></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/email/fighting-spam/create-spf-cpanel&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/email/fighting-spam/create-spf-cpanel'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NiZpZD0zMjA4JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="82c70982ac6fcd42294771f90c854ab1" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						...
						<div><a style='font-size:16px;' href='/support/community-support/users/madness'>madness</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-04 12:39 am</div>
				                <div>The above did not work and I have this information in my Cpanel<br />
<br />
Email Authentication<br />
Email authentication helps to prevent spam. The options below attempt to equip email messages with verifiable information so that your server can automatically detect the nature of incoming and outgoing messages.<br />
<br />
Enable these features to reduce the number of failed delivery notifications you receive when spammers forge messages from your domain(s). These features also stop spammers who forge messages that claim to be from your domain(s).<br />
<br />
In order to ensure that SPF or DKIM takes effect, you must confirm that this server is an authoritative nameserver for “madnessphotography.com.au”. If you need help, contact your hosting provider.<br />
<br />
DKIM<br />
<br />
DKIM allows your server to verify incoming email and prevent incoming spam messages. This feature ensures that incoming messages are unmodified and are genuinely from the indicated sender.<br />
<br />
Status: Enabled WARNING: The system cannot verify that this server is an authoritative nameserver for “madnessphotography.com.au)”. [?]	<br />
Disable<br />
Your current raw DKIM record is:<br />
default._domainkey	14400	IN	TXT	&quot;v=DKIM1; k=rsa; p=MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEAyaDE/cK6qPFIH7/LdEjdyWovAOPJad4gxVfCKuK81jYvrE02HNrncvifAnYeX7i+ZRZgkYSfiyDsmPKchAa9VDkFitlFM2GvsF8jP5+T9Un1Ovhf1T27rYnHtlnMzefG+q6v33e7IEZ3crAergva2srDrHdpAdKruZgBD5nWhw4KZcNMeverOTv97kTdBMXVY&quot; jeWlVsSQO/0JLTtEBqUBt75T24SEUcVD17zMhAhuG5/kxImgNWXkF9spn9APBJrsL4DSEuIt5PAwofnWxy4ix6KreTn7OnLyiO8zGiISqCvyQyDYKWm5tWRxqiXEW/bebgNqOlFwSbyfSNqQUssIwIDAQAB\;<br />
SPF<br />
<br />
The SPF system allows you to authorize servers and IP addresses to send mail from your domain(s). This feature prevents outgoing spam messages.<br />
<br />
Status: Enabled WARNING: The system cannot verify that this server is an authoritative nameserver for “madnessphotography.com.au”. [?]	Disable<br />
Your current raw SPF record is: v=spf1 +a +mx +ip4:192.145.239.30 +ip4:23.235.208.205 -all</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28154);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-04 5:24 pm</div>
				                <div>Hello Madness,<br />
<br />
Sorry for the problem with the settings not apparently working.  The settings are correct.  The main issue is that there are some servers  who not use these systems.  They will only be effective with those that do use SPK and DKIM.   The warnings about the authoritative nameservers can be ignored.  As long as those domain names are pointed to our servers, then these settings will be valid.  <br />
<br />
You also have the option of using services like <a href="http://www.inmotionhosting.com/support/email/fighting-spam/stop-spam-by-forwarding-spam-to-spamcop">SpamCop</a> or <a href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-email/spamassassin-fighting-spam">SpamAssassin</a> that can help in fighting spam. <br />
<br />
If you have any further questions or comments, please let us know.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28180);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
