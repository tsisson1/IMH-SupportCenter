<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:88150:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/php/increase-the-max-file-upload-size-in-php-ini" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-10-07T16:28:38-07:00" />
  <meta name="keywords" content="increase max upload file sizephp.ini" />
  <meta name="author" content="Arnel Custodio" />
  <meta name="description" content="This article will teach you how to increase the max upload file size in your php.ini." />
  <title>Changing the maximum upload size in php.ini - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/php/increase-the-max-file-upload-size-in-php-ini" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:a6dea7e9cab93151915128836db601e8 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-20']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '78.8.11.41']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Changing the maximum upload size in php.ini									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>57,499</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Apr 8, 2013'><span style='color:#606060;'>Published:</span> Oct 7, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>There are a few common errors that occur in Wordpress and other PHP-based programs that use the <strong>php.ini</strong> for certain settings.  One of the most common of these settings is the maximum upload filesize ("upload_max_filesize"). This is a setting commonly found within a file known as the <strong>php.ini</strong> file.&nbsp; Here's an example screenshot of a program with max file size limits exceeded during an upload attempt:<br /><br />
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phpini/upload-wp-error.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/edu/phpini/upload-wp-error.png" alt="Upload error occurring in Wordpress due to PHP.INI limit" ></a>  
  <br /><br />Error text: <strong>file_name" has failed to upload due to an error - This file exceeds the maximum upload size for this site.</strong><br /><br />You will need to increase the allowed memory in your <strong>php.ini</strong> file. The instructions below will show you on how to fix the php memory error by adjusting the appropriate sections of your local <strong>php.ini</strong> file.</p>
...
<ol class="article_list">
  ...
  <li>Scroll down to the <strong>FILES</strong> section of your Cpanel, and then click on the icon labeled <strong>FILE MANAGER</strong>.</li>
  <li>Use the File Manager to navigate to the web root. For more information on understanding your web root or document root, see <a href="/support/website/general-server-setup/where-are-my-files-located"><em>What folder are my website files located within?</em></a></li>
  <li>Locate the <strong>php.ini</strong> file in your <em>public_html</em> folder. If you do not have one, our <a href="/support/website/website-troubleshooting/how-to-get-great-technical-support">Technical Support team</a> can place a default one in your account, or you can create a blank file by clicking on the <strong>New File</strong> icon and naming it <strong>php.ini</strong> so you can edit and add your own settings. Once you have a <strong>php.ini</strong> file, click on the file name to highlight it in the right side of the File Manager. If you need further information on editing with the File Manager editors, go to <a href="/support/edu/cpanel/cpanel-file-manager/file-manager-code-editor">Using the File Manager Code Editor</a>.</li>
  <li>Search the <strong>php.ini</strong> file for the following text:<br />
    <div class="code_block">
      <p>;;;;;;;;;;;;;;;;<br />; File Uploads ;<br />;
         ;;;;;;;;;;;;;;<br /></p>
      <p>; Whether to allow HTTP file uploads.<br />file_uploads = On</p>
      <p>; Temporary directory for HTTP uploaded files (will use system default if not<br />; specified).<br />;upload_tmp_dir =</p>
      <p>; Maximum allowed size for uploaded files.<br />upload_max_filesize = 128M</p></div></li>
 The <em>file_uploads</em> should be set to "on" and "<em>Maximum allowed size for uploaded files</em>" should be set to the file size that you need.
  <li>Click the <strong>Save Changes</strong> button to save your changes.</li>
</ol>
<p>This change affects all files within the directory that a <strong>php.ini</strong> is saved, unless the file is set to be recursive.&nbsp; If it is set to be recursive, then it affects all directories as per the setting in the .HTACCESS file.&nbsp; For more information, see <a href="/support/website/general-server-setup/recursive-php-ini"><em>How can I make my <strong>php.ini</strong> file recursive?</em></a>
</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/php/increase-the-max-file-upload-size-in-php-ini&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/php/increase-the-max-file-upload-size-in-php-ini'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MTImaWQ9MjU5NSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="6c20b0ee9e8f69e2f351811544872ad1" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/file-management/max-upload-size-change?tsrc=rsbraq'>Max Upload size Change</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/wordpress/http-error-wordpress-upload-media-large-filesize?tsrc=rsbraq'>HTTP Error - Wordpress Upload Media (Large Filesize)</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/file-management/maximum-upload-file-size-in-opencart?tsrc=rsbraq'>Maximum upload file size in Opencart</a>
                                </div>
...
<a name='comments'></a>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/6ad2d64cb2a9ac9c4c24e0af265a4b11?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/6ad2d64cb2a9ac9c4c24e0af265a4b11'>Bwire Brian</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-22 7:05 am</div>
				                <div>i find it clear enough, am comfortable with the way it is right now</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15296);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-20551'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/7b2973fbf9772f9ee03b85498eb53e09?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/7b2973fbf9772f9ee03b85498eb53e09'>Amandeep Singh</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-10 8:25 am</div>
				                <div>it is very helpful for me</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20551);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-25867'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/f508ba15dd85b01a0b842fa184a62966?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/f508ba15dd85b01a0b842fa184a62966'>Asomix</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-18 8:59 am</div>
				                <div><p>Please what if i am using my PC as local host, how do i solve this same issue?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25867);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-18 9:07 am</div>
				                <div>Hello Asimix,<br />
<br />
What are you using as your webserver on your localhost?<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25869);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-19 4:31 am</div>
				                <div><p>I am using WAMP SERVER. Thanks alot. Please any idea how to upload sample_data contating pictures and media in general to a wordpress theme like interior woo commerce. Thanks.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25892);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-19 12:04 pm</div>
				                <div>Hello Asomix,<br />
<br />
Sorry for the problem with WAMP.  We unfortunately do not support it as it involves the use of a server outside of the typical hosting environment.  Our answers are based on a hosting server installation.  Typically, in order to upload files (like graphics), you would need to know how to use FTP - that would be the best way to put files into the website. <br />
<br />
If you have any further questions or comments, please let us know.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25905);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-19 4:32 am</div>
				                <div><p>i am using WAMP. Thanks</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25893);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-26558'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/e82ba695213413280985792205e70157?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/e82ba695213413280985792205e70157'>saasin</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-10 11:43 pm</div>
				                <div><p>First am a creative designer and not a teche guy... but i use to work with the help of google. when i tried to upload a theme it says excwwds the upload limit 2M. and tried to solve it&nbsp;the way it is mentioned. But PHP.ini file was missing in my folder. then i created it and copied the code which is given here and changed the limit alone and saved it. But still it is showing me the same error. Can u pls help me to take it through.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26558);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-14 9:51 am</div>
				                <div>Hello saasin,<br />
<br />
Did you also make sure the php.ini file is set to be recursive?<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26615);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-31413'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/aad7f7c70cbdbdb6876c5555634b9b80?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/aad7f7c70cbdbdb6876c5555634b9b80'>Seth</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-23 12:51 pm</div>
				                <div><p>Hi,</p>
<p>On my webserver, I can't find a 'php.ini' file. I created one, and copied the code snippet from this page, but it hasn't increased the file size.</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>Thanks</p>
<p>Seth</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31413);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-23 1:27 pm</div>
				                <div>Hello Seth,<br />
<br />
Sorry for the problems with the PHP.INI file.  The problem may be the file itself (based on its entries), or that the file is not applying to the installation.  Try making the file recursive.  We have a <a href="http://www.inmotionhosting.com/support/website/php/recursive-php-ini">tutorial</a> that can show you how to do this.   If that doesn't help, then please <a href="http://www.inmotionhosting.com/support/website/getting-started-guides/submitting-and-checking-on-status-of-tickets">submit a verified support ticket</a> to have the php.ini file placed in your account.<br />
<br />
If you have any further questions or comments, please let us know.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31416);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-33012'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/94137cf2db000da2f1bf7456f4dc1b66?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/94137cf2db000da2f1bf7456f4dc1b66'>Thad Wilkinson</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-05-27 11:36 pm</div>
				                <div><p>Absurd. Every person who uses it needs to upload wordpress themes and the default setting is smaller than most themes. Why? Why doesn't your article address how large can it be? Why is it set so small? What does 512m even mean? Does that mean 512MB? Why can't you just take 5 minutes and write a meaningful explanation.&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(33012);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-05-31 8:47 am</div>
				                <div>php.ini is not made for WordPress, it is a general configuration file set for php. WordPress just happens to be one of thousands of programs that are coded in php. As for a max size, you should not make it any larger than is needed. You COULD make it 1GB  if you wanted (1000M) but you may have to move to a VPS or Dedicated server if you were using that many resources. Yes, 512M means 512 MB. 1G means 1GB. The php.ini file just doesn't have the need for the B at the end.<br />
<br />
So far no one else has notified us of any confusion, so we are not sure where this is occurring. We are happy to expand or make the article more clear if you can tell us exactly where you are getting confused.  This of course goes for anyone.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(33080);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
