<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:91803:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/new-customers/website-security" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-10-28T19:59:48-07:00" />
  <meta name="keywords" content="website security vulnerabilities hack securing  website" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="In this article we will discuss website security and a few techniques you can employ to secure your website. " />
  <title>Website Security - Preventative Measures - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/new-customers/website-security" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:50f3bdaf2fd8c87301436803c17ef54e -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '105.112.42.109']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Website Security - Preventative Measures									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>21,502</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Aug 25, 2011'><span style='color:#606060;'>Published:</span> Oct 28, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p class="alert"><span style="color:red;">Please Note:</span>&nbsp;<em>This article includes links to sources online about website security, that pertain specifically to individual programs like Wordpress and Microsoft Windows. While it is not possible for us to publish every security article for every program, a search on the web regarding security and updates for the software you run should return numerous results.</em></p>
<p>Website security is a topic on a lot of users' minds. If you search the web for&nbsp;<i>How to hack a website</i>, you will literally get millions of hits. Taking the necessary precautions now with your website will help prevent a big headache later on in the event anything does happen to your website.</p>
<p class="alert" style="color:red">**Note: If you suspect you have already been hacked, please see our article on <a href="/support/website/website-troubleshooting/recovering-from-a-hack" target="_blank">recovering from a hack</a></p>

<h2>Backing up your account</h2>
<div>We're starting this article on website security with an introduction to backups. Making regular backups of your website is very important, and is one of the best recommendations that we can provide. cPanel includes an easy backup utility that you can use to backup your entire website, including your databases, email, and files. For more information on backing up your website, please view the following flash based tutorial for working with the Backups section of cPanel:
<p><a href="http://support.inmotionhosting.com/userguides/cpflash_x3/cpanel_x3_backup.htm" style="outline-style: none; outline-width: initial; outline-color: initial; color: #306090;">http://support.inmotionhosting.com/userguides/cpflash_x3/cpanel_x3_backup.htm</a></p>
</div>
<p>There are numerous techniques that hackers can use to compromise a website, however the reasons these techniques are successful are usually because of:</p>
<ol>
<li>Vulnerabilities in the software you run on your hosting account</li>
<li>Vulnerabilities in software that you run on your local computer</li>
</ol>
<p> </p>

<h2>Vulnerabilities in the software you run on your hosting account</h2>
<p>Most software that users run on their website is Open Source software. Open Source software is software that is freely available for anyone to download and use. For example, both Joomla and Wordpress are very commonly used, and they are both Open Source. One of the drawbacks of Open Source software is that anyone can download and view the software's code, which makes it easier for hackers to find ways to compromise a website. The authors of such Open Source Applications release updates and security patches on a regular basis. Please be sure that you are running the most current versions of any third party software on your website, as the most current version is usually the most secure version as well.</p>
<p>The following is a list of links, for Wordpress and Joomla specifically, that point to the software's own information about security:</p>
<p> </p>
<h3>WordPress</h3>
<p>Wordpress.org - How to Keep WordPress Secure<br /><a href="http://wordpress.org/development/2009/09/keep-wordpress-secure/" style="outline-style: none; outline-width: initial; outline-color: initial; color: #306090;">http://wordpress.org/development/2009/09/keep-wordpress-secure/</a></p>
<p> </p>
<p>Wordpress.org - Hardening WordPress<br /><a href="http://codex.wordpress.org/Hardening_WordPress" style="outline-style: none; outline-width: initial; outline-color: initial; color: #306090;">http://codex.wordpress.org/Hardening_WordPress</a></p>
<p> </p>
<p>Wordpress.org - Upgrading Wordpress<br /><a href="http://codex.wordpress.org/Upgrading_WordPress" style="outline-style: none; outline-width: initial; outline-color: initial; color: #306090;">http://codex.wordpress.org/Upgrading_WordPress</a></p>
<p> </p>
<h3>Joomla</h3>
<p>Joomla.org - Joomla Security Center<br /><a href="http://developer.joomla.org/security.html" style="outline-style: none; outline-width: initial; outline-color: initial; color: #306090;">http://developer.joomla.org/security.html</a></p>
<p> </p>
...
<p> </p>
<p>Joomla.org - Upgrade Instructions<br /><a href="http://docs.joomla.org/Upgrade_Instructions" style="outline-style: none; outline-width: initial; outline-color: initial; color: #306090;">http://docs.joomla.org/Upgrade_Instructions</a></p>
<p> </p>
<p> </p>
<p> </p>
...
<p> </p>
<p>Keeping any third party plugins / extensions on your website up to date is just as important as keeping the core software up to date as well. We've compiled a short list of links for more information about this topic as well.</p>

<h3>Joomla</h3>
<div>Joomla.org - Vulnerable Extensions List<br /><a href="http://docs.joomla.org/Vulnerable_Extensions_List" style="outline-style: none; outline-width: initial; outline-color: initial; color: #306090;">http://docs.joomla.org/Vulnerable_Extensions_List</a></div>
<h3>Wordpress</h3>
<div>Wordpress.org - Hardening WordPress - Plugins<br /><a href="http://codex.wordpress.org/Hardening_WordPress#Plugins" style="outline-style: none; outline-width: initial; outline-color: initial; color: #306090;">http://codex.wordpress.org/Hardening_WordPress#Plugins</a></div>
<p> </p>
<p> </p>

<h2>Did you code and develop your website yourself?</h2>
<div>If you coded your own website, knowing common techniques hackers use can help you take steps to make your own software more secure. The following is a list of links to articles on Wikipedia that provide more information on common hacking techniques:<br /><br />
<p class="alert"><span style="color:red;">Please Note:</span>&nbsp;<em>Although direct coding support is out of the realm of what our Support Department can assist with, a search on the web regarding the topics below will return many results that include how to update your code and take preventive measures.</em></p>

<h3>Common ways websites are hacked</h3>
<p><strong>SQL injection</strong><br /><a href="http://en.wikipedia.org/wiki/Sql_injection" style="outline-style: none; outline-width: initial; outline-color: initial; color: #306090;">http://en.wikipedia.org/wiki/Sql_injection</a></p>
<p><strong>Code injection</strong><br /><a href="http://en.wikipedia.org/wiki/Code_injection" style="outline-style: none; outline-width: initial; outline-color: initial; color: #306090;">http://en.wikipedia.org/wiki/Code_injection</a></p>
<p><strong>Cross-site scripting (XSS)</strong><br /><a href="http://en.wikipedia.org/wiki/Cross_Site_Scripting" style="outline-style: none; outline-width: initial; outline-color: initial; color: #306090;">http://en.wikipedia.org/wiki/Cross_Site_Scripting</a></p>
<p><strong>Remote File Inclusion</strong><br /><a href="http://en.wikipedia.org/wiki/Remote_File_Inclusion" style="outline-style: none; outline-width: initial; outline-color: initial; color: #306090;">http://en.wikipedia.org/wiki/Remote_File_Inclusion</a></p>
</div>


<h2>Vulnerabilities in software that you run on your local computer</h2>
<div>Not only do Open Source applications like Joomla and Wordpress release updates on a regular basis, but so do companies such as Microsoft and Adobe. The following is a list of links to major software titles and information about the security updates they have available:
<h3>Adobe</h3>
<p>Adobe.com Security bulletins and advisories<br /><a href="http://www.adobe.com/support/security/" style="outline-style: none; outline-width: initial; outline-color: initial; color: #306090;">http://www.adobe.com/support/security/</a><br />For example, Adobe offers many popular products, such as:<br />Adobe Reader -&nbsp;<a href="#readerwin" style="outline-style: none; outline-width: initial; outline-color: initial; color: #306090;">http://www.adobe.com/support/security/#readerwin</a><br />Adobe Dreamweaver -&nbsp;<a href="#dreamweaver" style="outline-style: none; outline-width: initial; outline-color: initial; color: #306090;">http://www.adobe.com/support/security/#dreamweaver</a><br />Adobe GoLive -&nbsp;<a href="#golive" style="outline-style: none; outline-width: initial; outline-color: initial; color: #306090;">http://www.adobe.com/support/security/#golive</a></p>

<h3>Microsoft</h3>
<p>Microsoft.com - Windows Update<br /><a href="http://windowsupdate.microsoft.com/" style="outline-style: none; outline-width: initial; outline-color: initial; color: #306090;">http://windowsupdate.microsoft.com/</a><br />Microsoft provides&nbsp;<i>Windows Update</i> to help keep your copy of Windows and other Microsoft products up to date. Be sure that your version of Windows has installed the most up to date security patches available.</p>

<h3>Apple</h3>
<p>Apple.com - Apple security updates<br /><a href="http://support.apple.com/kb/HT1222" style="outline-style: none; outline-width: initial; outline-color: initial; color: #306090;">http://support.apple.com/kb/HT1222</a><br />Apple is well known for the security and stability that their products come with, but even Apple has to releases security updates. Please see the link above for more information regarding Apple security updates.</p>
</div>
<p>The IT industry is changing every day, especially when it comes to the Internet and security. Keeping your software up to date, both on your hosting account and on your own computer is one of the best ways to secure your website. You should also regularly scan your computer for viruses and malware, maintain regular backups of your website, and be sure to contact the InMotion Hosting Support Department if you have any additional questions.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/new-customers/website-security&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/new-customers/website-security'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yOCZpZD00NiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="cdadeb5631a360cf2150a13d61a92643" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/3031d62993955a39331341f47853db31?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/3031d62993955a39331341f47853db31'>yutthakan</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-27 12:58 pm</div>
				                <div><p><span style="color: #222222; font-family: arial, sans-serif; font-size: 14px;">my new site was hacked please check ,who hacked me?</span></p>
<p><code><span style="color: #222222; font-family: arial, sans-serif;"><span style="font-size: 14px;">cb-pipeliningsystems.com/wp-login.php</span></span></code></p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20012);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-27 1:14 pm</div>
				                <div>Your site was likely hacked due to an outdated WordPress installation or an outdated/insecure plugin.  I recommend restoring from any backups you may have, as well as keeping all plugins up to date.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20013);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-24602'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/07bac07eeea20d9b59f630c562eb1e7e?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/07bac07eeea20d9b59f630c562eb1e7e'>Joe</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-03 12:20 am</div>
				                <div><p>How does InMotion help with hacking? For instance, if a site on a shared server is compromised, what will you do to protect the other sites? (Do you have a list of your security features?)</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24602);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-06 3:18 pm</div>
				                <div>Hello Joe,<br />
<br />
We do not have a list of security features for public display for obvious reasons. If an account is hacked no things run on it can affect the other accounts as it is only run as that cPanel user. It is limited to that account.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24657);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-25225'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/2235764e8a8dafd942e5d5e63c7c1305?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/2235764e8a8dafd942e5d5e63c7c1305'>Mohammed </a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-27 11:39 pm</div>
				                <div><p>Is there any way to get a back up that is even a week, month or even a year old?&nbsp; My site got hacked and they say they have 24 to 36 hours of back up.&nbsp; I called to get the backup but even the backup had bad files in them.&nbsp; The funny thing is just less then 24 hours it was working because someone bought something from my site.&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25225);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-29 12:08 am</div>
				                <div>Hello Mohammed,<br />
<br />
We do not keep backups longer than 36 hours and we only keep one backup per customer. I do apologize for the inconvenience. <br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25275);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-31899'></a>
		<div  style='margin:2px 0px 0px 80px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/b1e8076ff846bddeaccc1b7a9887ca7d?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/b1e8076ff846bddeaccc1b7a9887ca7d'>Mike Robinson</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-13 4:10 pm</div>
				                <div><p>TJ, I just did my first manual backup in Cpanel</p>
<p>Based on your reply above, it sounds like inmotion does an automated back up for last 36 hours for their client. Is this correct? Is this in print somewhere? I assume this 36 hours is what inmotion means by "FREE Data Backups (Others Charge!)" in the pricing table?</p>
<p>Please describe some common hack problems and how you help customers keep their web site secure.</p>
<p>Please confirm, thanks. &nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31899);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-14 9:23 am</div>
				                <div>Hello Mike,<br />
<br />
In order to provide a free and current backup the system is set as a progressive 24-36 hour backup that overwrites any existing backup (up to 10 GB per the terms of service).  This is not in print, but it is the free backup. <br />
<br />
Typical hack issues  include brute force attacks, file overwrites or spam scripts.  We can only protect the accounts to an extent.  We have mod security and firewalls that combine to help prevent brute force attacks that are used to access websites.  There's also active monitoring by our systems team to make sure that servers are kept at an optimum level.  They will actively stop attacks or force password changes when issues are detected.  Hacked sites that are part of a shared system may also be taken offline in order to prevent them from affecting other sites on a server.   Besides the hardware and software options put into place to help provide security, the main thing we can do is to recommend/promote best practices such as strong passwords or secure code for websites that are loaded or created on our hosting service.  This is done to allow for an open environment that does not impair a variety of different types of website development. <br />
<br />
I hope this helps to answer your question, please let us know if you require any further  assistance.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31917);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-32096'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/6f532552d7448591aedad3b863bb4bae?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/6f532552d7448591aedad3b863bb4bae'>Marija</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-20 9:46 am</div>
				                <div><p><strong>ERROR</strong>: This user account has been locked until <strong>April 20, 2016 2:52 pm</strong> due to too many failed login attempts. You can login again after the Lockout Time above has expired.</p>
<p><span id="result_box" lang="en">I got a message, but no one opened my dashboard, only me. I know the password. How much time do I have to wait? What should I do? <span>Thanks</span><span>.</span></span></p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32096);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-20 10:19 am</div>
				                <div>Hello Marija,<br />
<br />
The response you're seeing is related to a brute force attempt to get into your admin.  The security rules on the server have stopped the access, but in doing so they lock the account - they normally do this for about 20 minutes and then the account is unlocked.  <br />
<br />
I hope that helps to answer your question!  If you require further assistance, please let us know!<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32100);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-32904'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/9e2c39be74ea7078a65a8a63b64f9663?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/9e2c39be74ea7078a65a8a63b64f9663'>Chance Gardner</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-05-24 2:31 am</div>
				                <div><p>When I bought my domain name here (actually the free one) I had an option to add security for more $ and denied it. can I still add it on?&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32904);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-05-24 9:18 am</div>
				                <div>You may be referring to domain privacy. If so, yes, you can add it in your <a href="http://www.inmotionhosting.com/support/domain-names/general-information/add-privacy-existing-domains">Account Management Panel</a>.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32918);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
