<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:70651:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-3/docblocks" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-06-18T16:19:38-07:00" />
  ...
  <link href="http://www.inmotionhosting.com/support/edu/joomla-3/docblocks" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:405de8702ab09b7e61f4abac29cc3442 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															DocBlocks - Documentation headers in Joomla									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>409</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: May 30, 2014'><span style='color:#606060;'>Published:</span> Jun 18, 2014</div>
...
<p>The knowledge is this article has been obtained from <a href='http://joomla.github.io/coding-standards/?coding-standards/chapters/docblocks.md' target='_blank'>this page</a>. While learning about DocBlocks, we felt the information in that article would be more easily absorbed if reformatted.</p>
...
<table class='table table-striped table-bordered'>
  <tr>
    ...
    <td><ul><li>Instead of using a tab / indent, use <strong>two spaces</strong>.</li></ul></td>
  </tr>
  <tr>
    <th>Credit</th>
    <td><ul><li>Instead of getting credit for the code you've contributed using the @author tag, update the CREDITS.php file.</li></ul></td>
  </tr>
  <tr>
    <th>3rd&nbsp;Party&nbsp;Code</th>
    <td><ul><li>Leave 3rd party DocBlocks as they are.</li></ul></td>
  </tr>
</table>
...
<div class="in_this_tutorial">
  ...
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('file');">Files</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('definition');">Class Definitions</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('property');">Class Properties</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('method');">Class Methods</button>
</div>
...
<table class='table table-striped'>
  ...
  <tr>
    ...
    <td>Followed by a blank line.</td>
      ...
      <tr>
    <th><a href="/support/edu/joomla-3/category">@category</a></th>
    <td><span style='color:green;'>optional</span></td>
    <td>Rarely used</td>
  </tr>
  <tr>
    <th><a href="/support/edu/joomla-3/package">@package</a></th>
    <td><span style='color:orange;'>generally optional</span></td>
    <td>Required when files contain only procedural code</td>
  </tr>
    <tr>
    <th><a href="/support/edu/joomla-3/subpackage">@subpackage</a></th>
    <td><span style='color:green;'>optional</span></td>
    <td></td>
  </tr>
    <tr>
    <th><a href="/support/edu/joomla-3/author">@author</a></th>
    <td><span style='color:green;'>optional</span></td>
    <td>Only allowed on non-joomla source files (like 3rd party extensions)</td>
  </tr>
        <tr>
    <th><a href="/support/edu/joomla-3/copyright">@copyright</a></th>
        <td><span style='color:red;'>required</span></td>
    <td></td>
  </tr>
      <tr>
    <th><a href="/support/edu/joomla-3/license">@license</a></th>
    <td><span style='color:red;'>required</span></td>
    <td>Must be compatible with the Joomla license</td>
  </tr>
      <tr>
    <th><a href="/support/edu/joomla-3/deprecated">@deprecated</a></th>
    <td><span style='color:green;'>optional</span></td>
    <td></td>
  </tr>
      <tr>
    <th><a href="/support/edu/joomla-3/link">@link</a></th>
    <td><span style='color:green;'>optional</span></td>
    <td></td>
  </tr>
      <tr>
    <th><a href="/support/edu/joomla-3/see">@see</a></th>
    <td><span style='color:green;'>optional</span></td>
    <td></td>
  </tr>
        <tr>
    <th><a href="/support/edu/joomla-3/since">@since</a></th>
    <td><span style='color:orange;'>generally optional</span></td>
    <td>Required when files contain only procedural code</td>
  </tr>
</table>
...
<table class='table table-striped'>
  ...
  <tr>
    ...
    <tr><th><a href="/support/edu/joomla-3/deprecated">@deprecated</a></th><td><span style='color:green;'>optional</span></td><td></td></tr>
    <tr><th><a href="/support/edu/joomla-3/link">@link</a></th><td><span style='color:green;'>optional</span></td><td></td></tr>
    <tr><th><a href="/support/edu/joomla-3/see">@see</a></th><td><span style='color:green;'>optional</span></td><td></td></tr>
  <tr>
    <th><a href="/support/edu/joomla-3/since">@since</a></th>
    <td><span style='color:red;'>required</span></td>
...
<table class='table table-striped'>
  ...
  <tr>
    <th><a href="/support/edu/joomla-3/var">@var</a></th>
    <td><span style='color:red;'>required</span></td>
...
<table class='table table-striped'>
  ...
  <tr>
    ...
    <tr>
      <th><a href="/support/edu/joomla-3/return">@return</a></th>
      <td><span style='color:red;'>required</span></td>
      <td>Followed by a blank line.</td>
  </tr>
    <tr>
...
<pre class='code_block'>
    <span style='color:green;word-wrap:normal'>/**
...
<table class='table table-striped table-bordered'>
  <tr style='color:red;'><td>File DocBlock</td><td>highlighted in red</td></tr>
  <tr style='color:green;'><td>Class Definition DocBlock</td><td>highlighted in green</td></tr>
  <tr style='color:orange;'><td>Class Property DocBlock</td><td>highlighted in orange</td></tr>
  <tr style='color:purple;'><td>Class Method DocBlock</td><td>highlighted in purple</td></tr>
</table>
...
<pre class='code_block' style='word-wrap:normal;'>
EXAMPLE FILE: components/com_content/models/categories.php

&lt;?php
<span style='color:red;font-weight:bold;background:#FFE5E5;'>/**
 * @package     Joomla.Site
...
<span style='color:green;font-weight:bold;background:#E5FFE5;'>/**
...
{
        <span style='color:orange;font-weight:bold;background:#FFFFE5;'>/**
        ...
        <span style='color:purple;font-weight:bold;background:#FFE5F2;'>/**
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 17: DocBlocks - Documentation headers in Joomla</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 18: <a href='/support/edu/joomla-3/increase-hits-cache'>Updating article hits when using Joomla cache</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-3/docblocks&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-3/docblocks'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xMDEmaWQ9MzI2MiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="38b9e1cbfd895405d32afcc5c9bc6d8a" value="1" />	</div>
	</form>
<!-- <br />
