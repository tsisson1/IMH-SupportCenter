<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:67612:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotion.net/support/edu/joomla-25/menus/creating-a-menu-and-menu-module-in-joomla-25" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-07-21T16:57:27-07:00" />
  <meta name="keywords" content="create new joomla 2.5 menu" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="In this tutorial, we'll walk you through the basic steps of creating a new Joomla 2.5 menu and menu module." />
  <title>How to create a new Menu and Menu Module in Joomla 2.5 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-25/menus/creating-a-menu-and-menu-module-in-joomla-25" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:ae6f7dc88f70b334ef08c46275ea09d1 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to create a new Menu and Menu Module in Joomla 2.5									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>63,587</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Feb 14, 2012'><span style='color:#606060;'>Published:</span> Jul 21, 2015</div>
							...
							<div style='clear:both;'></div>
								...
								<p class="alert">Joomla 2.5 has reached its end of life as for 12/31/2014. Please be advised this may be a security risk to your website. You can view more information about the end of life <a href="https://docs.joomla.org/Joomla!_CMS_versions">here</a>.</p><br /><p>In this tutorial, we will walk you through the steps of creating a new menu in Joomla 2.5. If you don't have any previous experience with Joomla 2.5 menus, we suggest taking a look first at <a href="/support/edu/joomla-25/menus/intro-to-joomla-menus">An Introduction to Joomla 2.5 Menus</a>.</p>
<p><strong>To create a Joomla 2.5 menu:</strong></p>
<ol class="article_list">
<li><a href="/support/edu/joomla-25/getting-started/how-to-log-into-dashboard">Log into your Joomla Dashboard</a></li>
<li>In the top menu under <strong>Menus</strong>, click <strong>Menu Manager</strong></li>
<li>Click the <strong>New</strong> button in the top right menu</li>
<li>Type in a menu <strong>title</strong>, <strong>type</strong>, and <strong>description</strong>. Then click <strong>Save &amp; Close</strong> in the top right menu<br /><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/joomla25/how-to-create-a-menu/add-a-new-menu-in-joomla-25.gif"><img  alt="add-a-new-menu-in-joomla-25" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/joomla25/how-to-create-a-menu/add-a-new-menu-in-joomla-25.gif" /></a></li>
<li>Find and click <strong>Add a module for this menu type</strong> next to the menu you just created<br /><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/joomla25/how-to-create-a-menu/click-add-a-module-for-this-menu-type.gif"><img  alt="click-add-a-module-for-this-menu-type" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/joomla25/how-to-create-a-menu/click-add-a-module-for-this-menu-type.gif" /></a></li>
<li>Type in a <strong>Title</strong>, <a href="/support/edu/joomla-25/extensions/how-to-move-module-position">choose a Position for the menu</a>, and then click <strong>Save &amp; Close<br /><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/joomla25/how-to-create-a-menu/type-a-title-and-choose-a-position-for-your-menu.gif"><img  alt="type-a-title-and-choose-a-position-for-your-menu" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/joomla25/how-to-create-a-menu/type-a-title-and-choose-a-position-for-your-menu.gif" /></a></strong></li>
</ol>
<p>At this point, we have successfully created a new Joomla Menu. The menu is not going to show on our Joomla 2.5 site until we first add a menu item to it. For information on changing the display order of the menus, see our guide on <a href="/support/edu/joomla-25/menus/changing-menu-order" target="_blank">Joomla Menu Re-Ordering</a></p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 3: How to create a new Menu and Menu Module in Joomla 2.5</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 2: <a href='/support/edu/joomla-25/menus/intro-to-joomla-menus'>An Introduction to Joomla 2.5 Menus</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotion.net/support/edu/joomla-25/menus/creating-a-menu-and-menu-module-in-joomla-25&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotion.net/support/edu/joomla-25/menus/creating-a-menu-and-menu-module-in-joomla-25'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xODYmaWQ9MTE1MyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="ff02373ed8d2a51826392fb8ed394900" value="1" />	</div>
	</form>
<!-- <br />
...
<a name='comments'></a>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/bf41622e318fb981ef3a18fef310e977?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/bf41622e318fb981ef3a18fef310e977'>Bex Sweegah</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-24 3:20 pm</div>
				                <div><p>I find this site very&nbsp; helpfull alot</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9160);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-15115'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/9b75f92dd2be3652e630acc26871a0d2?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/9b75f92dd2be3652e630acc26871a0d2'>Sunil Singh</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-17 8:05 am</div>
				                <div>your article is superb</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15115);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-07 5:57 am</div>
				                <div><p>Thanks it is useful post.</p>
<p>I also refer very useful and helpful article about&nbsp;Menu Manager in Joomla.</p>
<p>Please visit this helpful article.</p>
<p>http://www.mindstick.com/Articles/861112d7-33ba-4c36-9fe0-01128fd8f24f/Menu%20Manager%20in%20Joomla#.Ve1eARFViko</p>
<p>https://docs.joomla.org/Portal:Menu_Management</p>
<p>&nbsp;&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26404);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
