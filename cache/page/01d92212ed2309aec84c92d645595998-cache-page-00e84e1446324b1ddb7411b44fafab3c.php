<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:59205:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.info/support/website/databases/" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="keywords" content="%default%" />
  <meta name="description" content="This section includes guides on how to administer your databases." />
  <title>Working with Databases | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.info/support/website/databases" rel="canonical" />
  <link href="http://www.inmotionhosting.com/support/website/databases" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:dd299ec4c22cb59d855e79c0287e5364 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '66.249.65.19']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Working with Databases</span></li>			</ul>
		</div>
	</div>
</div>
...
Most websites these days are driven by a database, which stores and organizes information.<br><br>
<div style="float:left;display:inline-block;vertical-align:top;width:45%;margin:0px 5px 0px 0px;height:300px" class="white_box" target="_blank">
<h2 style="margin-top:0px;padding-top:0px;" target="_blank">Creating, Importing, Exporting:</h2>
    <div style="margin: 5px 15px 5px 10px" target="_blank">
        <p>Learn how to create, import, and export databases in this section.</p>
        <ul>
            <li><a href="/support/website/databases/creating-importing-and-exporting-mysql-databases" target="_blank">Creating, Importing, and Exporting MySQL Databases</a></li>
      <li><a href="/support/website/databases/create-db-user" target="_blank">How to create and attach a database user in cPanel</a></li>
      <li><a href="/support/website/databases/import-database-through-shell" target="_blank">Import a database through shell</a></li>
            <li><a href="/support/website/databases/import-database-using-phpmyadmin" target="_blank">Import a MySQL Database using phpMyAdmin</a></li>
            <li><a href="/support/website/databases/export-database-using-phpmyadmin" target="_blank">Export a Database using phpMyAdmin</a></li>
...
<div style="float:left;display:inline-block;vertical-align:top;width:45%;margin:0px 5px 0px 0px;height:300px" class="white_box" target="_blank">
<h2 style="margin-top:0px;padding-top:0px;" target="_blank">Connecting:</h2>
    <div style="margin: 5px 15px 5px 10px" target="_blank">
        <p>This section includes popular articles regarding making a database connection.</p>
        <ul>
            <li><a href="/support/website/databases/connect-database-remotely-mysql-workbench" target="_blank">Connecting to a database with MySQL Workbench 5.2</a></li>
            <li><a href="/support/website/databases/connecting-heidi-sql-database" target="_blank">Connecting Remotely to your Database with Heidi SQL</a></li>
            <li><a href="/support/website/databases/connect-database-navicat" target="_blank">Connecting to your database with Navicat for MySQL 10</a></li>
            <li><a href="/support/website/databases/connecting-to-a-database-using-php" target="_blank">Connecting to a Database using PHP</a></li>
            <li><a href="/support/website/databases/setting-up-a-remote-mysql-connection-in-cpanel" target="_blank">Setting up a Remote MySQL connection in cPanel</a></li>
      <li><a href="/support/website/databases/mysql-command-line" target="_blank">How to access MySQL via command line</a></li>
        </ul>
    </div>
</div>
<br />
...
<div style="float:left;display:inline-block;vertical-align:top;width:45%;margin:0px 5px 0px 0px;height:300px" class="white_box" target="_blank">
<h2 style="margin-top:0px;padding-top:0px;" target="_blank">Troubleshooting Errors:</h2>
    <div style="margin: 5px 15px 5px 10px" target="_blank">
        <p>This section covers some of the common errors you may experience regarding databases.</p>
        <ul>
            <li><a href="/support/website/databases/mysql-1044-access-denied-error-message" target="_blank">MySQL - 1044 Access Denied Error Message</a></li>
            <li><a href="/support/website/databases/why-do-i-get-a-maxuserconnections-error" target="_blank">Why do I get a max_user_connections error?</a></li>
            <li><a href="/support/website/databases/explaining-the-maxuserconnections-error" target="_blank">Explaining the Max_User_Connections Error</a></li>
            <li><a href="/support/website/databases/error-1064" target="_blank">MySQL Error 1064: You have an error in your SQL syntax</a></li>
            <li><a href="/support/website/databases/error-1052" target="_blank">Error 1052  Column in where clause is ambiguous</a></li>
        </ul>
    </div>
</div>
<br />
...
<div style="float:left;display:inline-block;vertical-align:top;width:45%;margin:0px 5px 0px 0px;height:300px" class="white_box" target="_blank">
<h2 style="margin-top:0px;padding-top:0px;" target="_blank">Working with phpMyAdmin:</h2>
    <div style="margin: 5px 15px 5px 10px" target="_blank">
        <p>This section includes walk-through guides for the phpMyAdmin tool, which is available in the cPanel, and lets you administer your MySQL Databases.</p>
        <ul>
            <li><a href="/support/website/databases/how-to-use-phpmyadmin-to-optimize-a-database" target="_blank">How to Use phpMyAdmin To Optimize a Database</a></li>
            <li><a href="/support/website/databases/installing-phpmyadmin-on-your-account" target="_blank">Installing PHPMyAdmin on your Account</a></li>
            <li><a href="/support/website/databases/drop-table" target="_blank">How to delete or drop a table in phpMyAdmin</a></li>
      <li><a href="/support/website/databases/find-mysql-database" target="_blank">How to determine the data type of a data column in phpMyAdmin</a></li>
        </ul>
    </div>
</div>
<br />
...
<div style="float:left;display:inline-block;vertical-align:top;width:94%;margin:0px 5px 0px 0px;height:250px" class="white_box" target="_blank">
<h2 style="margin-top:0px;padding-top:0px;" target="_blank">General:</h2>
    <div style="margin: 5px 15px 5px 10px" target="_blank">
      <p>General database articles are included within this section.</p>
      <ul>
      <li><a href="/support/website/databases/reset-database-password" target="_blank">How to reset your database password within cPanel</a></li>
      <li><a href="/support/website/databases/check-repair-database" target="_blank">How to Check and Repair a Database</a></li>
      <li><a href="/support/website/databases/how-to-convert-a-database-to-utf-8" target="_blank">How to Convert a Database to UTF-8</a></li>
      <li><a href="/support/website/databases/how-to-convert-mysql-time" target="_blank">How to convert MySQL time</a></li>
      <li><a href="/support/website/databases/how-to-change-mysql-server-time-zone" target="_blank">How to change MySQL server time zone</a></li>
      <li><a href="/support/website/databases/storage-engines-innodb-and-myisam" target="_blank">MySQL Storage Engines - InnoDB and MyISAM</a></li>
      <li><a href="/support/website/databases/mysql-datatypes" target="_blank">Learning the different data types in MySQL</a></li>
      <li><a href="/support/website/databases/find-mysql-version" target="_blank">How to determine your MySQL version number</a></li>
      
    </div></ul>
</div>

<form action="http://www.inmotionhosting.info/support/website/databases/" method="post" name="adminForm" id="adminForm" class="form-inline">
  ...
  <table class='article_list'>
          ...
          <tr>
                                <td style='padding-right:20px;'><a href='/support/website/databases/setting-up-a-remote-mysql-connection-in-cpanel'>Setting up a Remote MySQL connection in cPanel</a></td>
                                <td>80,262</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/website/databases/how-to-change-mysql-server-time-zone'>How to change MySQL server time zone</a></td>
                                <td>71,837</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/website/databases/reset-database-password'>How to reset your database password within cPanel</a></td>
                                <td>28,155</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/website/databases/check-repair-database'>How to Check and Repair a Database</a></td>
                                <td>26,552</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/website/databases/creating-importing-and-exporting-mysql-databases'>Creating, Importing, and Exporting MySQL Databases</a></td>
                                <td>22,152</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/website/databases/how-to-convert-a-database-to-utf-8'>How to Convert a Database to UTF-8</a></td>
                                <td>19,947</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/website/databases/mysql-command-line'>How to access MySQL via command line</a></td>
                                <td>19,414</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/website/databases/create-db-user'>How to create and attach a database user in cPanel</a></td>
                                <td>14,328</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/website/databases/find-mysql-version'>How to determine your MySQL version number</a></td>
                                <td>8,542</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/website/databases/storage-engines-innodb-and-myisam'>MySQL Storage Engines - InnoDB and MyISAM</a></td>
                                <td>8,060</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/website/databases/mysql-datatypes'>Learning the different data types in MySQL</a></td>
                                <td>4,993</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/website/databases/monitor-mysql-performance'>Monitoring MySQL performance</a></td>
                                <td>4,240</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/website/databases/import-database-through-shell'>How to import a database through shell</a></td>
                                <td>3,565</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/website/databases/how-to-convert-mysql-time'>How to convert MySQL time</a></td>
                                <td>3,266</td>
                        </tr>
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/website/databases/check-and-repair-databases-in-cpanel'>Check and repair databases in cPanel</a></td>
                                <td>1,192</td>
                        </tr>
                  </table>
	</form>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMyZpZD0zMyZ2aWV3PWNhdGVnb3J5Jkl0ZW1pZD0xMDE=" />
