<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:70913:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-3/jevents-calendar/add-new-event" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-02-26T14:25:13-08:00" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="In this walk through we'll show you how easy it is for your users to add events to your JEvents Joomla 3 Calendar." />
  <title>How to add an event in Joomla 3 using JEvents Calendar - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-3/jevents-calendar/add-new-event" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:30a4fa0373f669292e4ea3eda9b4aa12 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '186.93.203.58']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to add an event in Joomla 3 using JEvents Calendar									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>6,768</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Feb 14, 2014'><span style='color:#606060;'>Published:</span> Feb 26, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In our last tutorial, we showed you how to <a href="/support/edu/joomla-3/jevents-calendar/create-event-menu-item">create an <em>Add an event</em> page</a> to allow users to create events within your JEvents Calendar in Joomla 3. In this tutorial, we'll walk you through the steps a user would take to add an event.</p>

<ol class='article_list'>

<li>
  <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/jevents/click-add-an-event.jpg"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/jevents/click-add-an-event.jpg"  style='float:right; margin:0px 0px 15px 15px;' /></a>
  <p><strong>Click the link</strong></p>
  <p>Now that you have added a menu link allowing users to create an event (<em>see the link above</em>), go to the frontend of your website and click the <strong>Add an event</strong> link.</p>
</li>

<li>
  <p><strong>Login</strong></p>
  <p>If you are not logged in, login to the frontend of your Joomla 3 site, otherwise you will see the the following warning:</p>
  <p class='alert alert-warning'><strong>Message</strong><br />You are not authorised to create/edit events</p>
</li>

<li>
  <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/jevents/add-event-details.jpg"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/jevents/add-event-details.jpg"  style='float:right; margin:0px 0px 15px 15px;' /></a>
  <p><strong>Add the event details</strong></p>
  <p>After you login and visit the <em>Add an event</em> page, you will see a form where you can add an event. For example, you can type in a <em>subject</em>, choose an <em>event colour</em>, and type in details about the <em>activity</em>.</p>
  
  <p>In our testing, we did the following:</p>
  
  <table class='table table-striped'>
    <tr>
      <th>Subject</th>
      <td>Brad's Birthday</td>
    </tr>
    <tr>
      <th>Activity</th>
      <td>Wed Apr 9, help us celebrate Brad's birthday at Paul's Pizzeria.</td>
    </tr>
  </table>
  
  <p>We then clicked the <strong>Calendar</strong> tab (<em>see screenshot above</em>), set the <strong>Start date</strong> and <strong>End date</strong>, and then clicked the green <strong>Save</strong> button towards the top of the page. The event will be added and you will see the following message:</p>
  
  <p class='alert alert-warning'><strong>Message</strong><br />Event Saved</p>
  
  <p>Now that we've added a new event, let's show you how to <a href="/support/edu/joomla-3/jevents-calendar/events-by-month">display a calendar</a> on your Joomla 3 site so you can see the event!</p>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/joomla-3/jevents-calendar'>211: Joomla 3 Calendar with JEvents</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 3: How to add an event in Joomla 3 using JEvents Calendar</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 2: <a href='/support/edu/joomla-3/jevents-calendar/create-event-menu-item'>Creating an Add Event JEvents menu item in Joomla 3</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 4: <a href='/support/edu/joomla-3/jevents-calendar/events-by-month'>How to display a JEvents Calendar in Joomla 3</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00OTYmaWQ9MzEwMyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="11abde59d2c006f0713b236bd605c07a" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/joomla-3/jevents-calendar?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Joomla 3 Calendar with JEvents</h3></a>
		<table><tr><td colspan='2'><h4>Install</h4></td></tr>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/joomla-3/jevents-calendar/install?tsrc=rsbedu'>Installing the JEvents Calendar in Joomla 3</a></td>
                </tr>
        <tr><td colspan='2'><h4>Events</h4></td></tr>  <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/joomla-3/jevents-calendar/create-event-menu-item?tsrc=rsbedu'>Creating an Add Event JEvents menu item in Joomla 3</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/joomla-3/jevents-calendar/add-new-event?tsrc=rsbedu'>How to add an event in Joomla 3 using JEvents Calendar</a></td>
                </tr>
        <tr><td colspan='2'><h4>Calendars</h4></td></tr>  <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/joomla-3/jevents-calendar/events-by-month?tsrc=rsbedu'>How to display a JEvents Calendar in Joomla 3</a></td>
                </tr>
          	</table>
...
<a name='comments'></a>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/3763270aec965944facb6b10c7cb667c?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/3763270aec965944facb6b10c7cb667c'>Don</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-12 10:20 pm</div>
				                <div>There is a jevents error  when trtying to save  &quot;Please add required field: Title&quot;  -- there is no title field??</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12694);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-14 10:09 am</div>
				                <div>Unfortunately, I was unable to replicate the same error that you are having.  Be sure that you are using Joomla 3, and have added all fields within the calendar.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12719);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-18048'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/a55e9ed14f133f39fbf0c63bd37fdc83?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/a55e9ed14f133f39fbf0c63bd37fdc83'>Nikola</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-02 8:03 am</div>
				                <div><p>I have the same problem, in the backend configuration (Configuration - Event Editing) there is a multiselect box "Required fields", where you must choose at least one required field from the core fields... the problem is I really don't need any of those :( this was not the case in the previous versions where I kept things neat and simple by selecting a category, entering the title and start/end time/date. Is there a way to avoid this? Thanks in advance!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(18048);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-02 9:47 am</div>
				                <div>Unfortunately, I am unaware of a way to avoid the required fields without making significant code changes to the plugin itself.  You may want to contact the developer of the plugin for more information.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(18056);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-19005'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/c05b68ac968448dfd75c40c9026cbd1a?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/c05b68ac968448dfd75c40c9026cbd1a'>Marvin</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-30 9:50 am</div>
				                <div><p>Unfortunatly I can not add an event...I get an error that says I'm not authorised to add ot edit an event, even though I have login as the super user..Please help me.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19005);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-30 10:56 am</div>
				                <div>Unfortunately, I was unable to replicate your issue, but was able to find a &lt;a href=&quot;http://www.jevents.net/forum/viewtopic.php?f=29&amp;t=15133&quot;&gt;post on the JEvents forums&lt;/a&gt; which may resolve your issue.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19009);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
