<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:85084:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/website-design/website-design-basics/comment-php-javascript-html-css-code" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-02-25T22:34:24-08:00" />
  <meta name="keywords" content="comment your php javascript css html code how do to" />
  ...
  <title>How do I comment my HTML, CSS, JavaScript, and PHP code? - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/website-design/website-design-basics/comment-php-javascript-html-css-code" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:f14f35898c86667e47fdb36ddbd8579d -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '213.184.113.50']);
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/website-design' itemprop='url'><span itemprop='title'>Website Design<span></a><div class='dropdown_4columns'><h2>Website Design Education Channel</h2><div class='col_2'><h3>100 Level Classes</h3><div><a href='/support/edu/website-design/website-design-basics'>101: Website Design Basics</a></div><div><a href='/support/edu/website-design/insert-images-website'>102: Inserting Images into a Website</a></div><div><a href='/support/edu/website-design/inserting-links-into-website'>103: Inserting Links into a Website</a></div><div><a href='/support/edu/website-design/meta-tags-explained'>104: Meta Tags Explained</a></div><div><a href='/support/edu/website-design/html-5-syntax'>105: HTML 5 Basic syntax</a></div></div><div class='col_2'><h3>200 Level Classes</h3><div><a href='/support/edu/website-design/adding-videos-website'>201: Adding Videos to a Website</a></div><div><a href='/support/edu/website-design/adding-contact-forms'>202: Adding Contact Forms </a></div><div><a href='/support/edu/website-design/using-css'>203: Using and Understanding CSS</a></div><div><a href='/support/edu/website-design/website-design-best-practices'>204: Website Design Best Practices</a></div><div><a href='/support/edu/website-design/using-php-and-mysql'>205: Using PHP to create dynamic pages</a></div><div><a href='/support/edu/website-design/create-responsive-template'>206: Creating Responsive Templates</a></div><div><a href='/support/edu/website-design/search-engine-optimization'>207: Search Engine Optimization</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/website-design/website-design-basics' itemprop='url'><span itemprop='title'>101: Website Design Basics<span></a><div class='dropdown_3columns'><h2> Website Design Basics</h2><div class='col_3'><div>1. <a style='display:inline;' href='/support/edu/website-design/website-design-basics/introduction-web-design'>Introduction to Web Design Basics</a></div><div>2. <a style='display:inline;' href='/support/edu/website-design/website-design-basics/understanding-basic-html-tags'>Understanding Basic HTML Tags</a></div><div>3. <a style='display:inline;' href='/support/edu/website-design/website-design-basics/can-builder-meet-my-needs'>Can the Builder meet my website building needs?</a></div><div>4. <a style='display:inline;' href='/support/edu/website-design/website-design-basics/basic-html-attributes'>HTML Attributes: Using attributes in HTML tags</a></div><div>5. <a style='display:inline;' href='/support/edu/website-design/website-design-basics/bullet-points-numbered-lists'>Bullet Points and Numbered Lists Explained</a></div><div>6. <a style='display:inline;' href='/support/edu/website-design/website-design-basics/comment-php-javascript-html-css-code'>How do I comment my HTML, CSS, JavaScript, and PHP code?</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How do I comment my HTML, CSS, Ja...</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How do I comment my HTML, CSS, JavaScript, and PHP code?									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>23,236</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Mar 6, 2013'><span style='color:#606060;'>Published:</span> Feb 25, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>When you are designing your website, there are many instances that require you to comment out code in your website. Commenting code is good for diagnosing website problems, hiding code instead of deleting the code, placing notes in a file to explain what was done, and many more reasons. This article will explain the basics of commenting code in your website files.</p>
<h2>HTML Comments</h2>
<p>HTML comments are specifically designed to comment out code when you are in an <a href="http://www.inmotionhosting.com/support/website/html" target="_blank">HTML</a> coded document. Below is the syntax for HTML comments.</p>
<h3>HTML comment</h3>
<pre style="margin-left: 20px; color: #999999;">&lt;!--
&lt;code to be commented out&gt;
 --&gt;</pre>
<h3>Example of an HTML comment</h3>
<p>An Example of a usage of this is shown in the following code.</p>
<pre style="margin-left: 20px; color: #336699;">&lt;html&gt;
  &lt;head&gt;
...
<span style="color: #999999;">&lt;!-- This is code commented out
...
<p>CSS comments are done in the <a href="http://www.inmotionhosting.com/support/edu/website-design/using-css/the-benefits-of-css" target="_blank">CSS</a> <em>.css</em> stylesheet or in the Internal Style sheet. <a href="http://www.inmotionhosting.com/support/website/javascript" target="_blank">JavaScript</a> comments can be placed inside HTML documents or in a <em>.js</em> file where JavaScript is ran. PHP code will be in <em>.php</em> files between <code style="color: #ff0000;">&lt;?php</code> and <code style="color: #ff0000;">?&gt;</code> code. The following code shows the syntax for commenting out CSS, JavaScript, and PHP code.</p>
<h3>Single Line comment</h3>
<pre style="margin-left: 20px; color: #999999;">// &lt;code to be commented out&gt;</pre>
...
<pre style="margin-left: 20px; color: #ff0000;"><span style="color: #336699;">&lt;body&gt;</span>
&lt;?php  
<span style="color: #ea7500;">// This is a comment on one line</span>
echo '&lt;p&gt;HTML code echoed by PHP.&lt;/p&gt;';
  
<span style="color: #ea7500;">/* This is code commented out
echo '&lt;h1&gt;An HTML Title from PHP&lt;/h1&gt;';
echo '&lt;p&gt;HTML code echoed by PHP.&lt;/p&gt;';
*/</span>
?&gt;
<span style="color: #336699;">&lt;/body&gt;
&lt;/html&gt;</span></pre> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/website-design/website-design-basics'>101: Website Design Basics</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 6: How do I comment my HTML, CSS, JavaScript, and PHP code?</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 5: <a href='/support/edu/website-design/website-design-basics/bullet-points-numbered-lists'>Bullet Points and Numbered Lists Explained</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/website-design/website-design-basics/comment-php-javascript-html-css-code&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/website-design/website-design-basics/comment-php-javascript-html-css-code'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP3RzcmM9cnNiZWR1Jm9wdGlvbj1jb21fY29udGVudCZjYXRpZD0xMTkmaWQ9MjI2MyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="e6a587848b4bdf257ac99c9624a5b286" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/website-design/website-design-basics?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Website Design Basics</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/website-design/website-design-basics/introduction-web-design?tsrc=rsbedu'>Introduction to Web Design Basics</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/website-design/website-design-basics/understanding-basic-html-tags?tsrc=rsbedu'>Understanding Basic HTML Tags</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/website-design/website-design-basics/can-builder-meet-my-needs?tsrc=rsbedu'>Can the Builder meet my website building needs?</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/website-design/website-design-basics/basic-html-attributes?tsrc=rsbedu'>HTML Attributes: Using attributes in HTML tags</a></td>
                </tr>
          <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/website-design/website-design-basics/bullet-points-numbered-lists?tsrc=rsbedu'>Bullet Points and Numbered Lists Explained</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/website-design/website-design-basics/comment-php-javascript-html-css-code?tsrc=rsbedu'>How do I comment my HTML, CSS, JavaScript, and PHP code?</a></td>
                </tr>
          	</table>
...
<a name='comments'></a>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/3df7e6028a022130f2d372a8a31fcd64?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/3df7e6028a022130f2d372a8a31fcd64'>Jasa SEO Profesional</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-28 5:44 pm</div>
				                <div><p>Thanks for article. By: <strong>Jasa SEO Profesional</strong></p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13417);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-24857'></a>
		<div  style='margin:2px 0px 0px 40px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/cc6ca9de35e04193b86e1f638c4ff01c?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/cc6ca9de35e04193b86e1f638c4ff01c'>Umesh</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-13 2:57 pm</div>
				                <div><p>Hello</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24857);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-31661'></a>
		<div  style='margin:2px 0px 0px 80px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/1b228439f3ce66482906e9a5959cd0a1?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/1b228439f3ce66482906e9a5959cd0a1'>sazan</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-03 11:15 am</div>
				                <div><p><strong>Perfect</strong></p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31661);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-04 1:57 am</div>
				                <div><p>Nice post.</p>
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; very useful for php coding thank you so much...</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14689);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-20 12:57 pm</div>
				                <div><p>Very Nice information about HTML. 
Thanks</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16496);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						...
						<div><a style='font-size:16px;' href='//www.gravatar.com/37ebc4bb66629e8ebc9dad2061f3beb9'>lluulnw</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-14 5:21 am</div>
				                <div><p><span id="ouHighlight__0_14TO0_13" style="padding: 0px; margin: 0px; color: rgb(68, 68, 68); font-family: Leelawadee; font-size: 14px; line-height: 20px;">Thanks for the</span><span id="noHighlight_0.3416833698283881" style="padding: 0px; margin: 0px; color: rgb(68, 68, 68); font-family: Leelawadee; font-size: 14px; line-height: 20px;">&nbsp;</span><span id="ouHighlight__15_18TO15_19" style="padding: 0px; margin: 0px; color: rgb(68, 68, 68); font-family: Leelawadee; font-size: 14px; line-height: 20px;">share.</span></p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17419);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-19743'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/75eb00e6d1fd0929e390be99fc95786a?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/75eb00e6d1fd0929e390be99fc95786a'>roberthoot</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-20 12:04 am</div>
				                <div><p><span id="docs-internal-guid-3cf60542-0583-20fb-946c-770a23934ed9" style="font-size: 15px; font-family: Calibri; color: #000000; background-color: transparent; font-weight: normal; font-style: normal; font-variant: normal; text-decoration: none; vertical-align: baseline;">We absolutely love your blog and find a lot of your post&rsquo;s to be exactly I&rsquo;m looking for. Does one offer guest writers to write content for you personally? I wouldn&rsquo;t mind creating a post or elaborating on a lot of the subjects you write regarding here. Again, awesome weblog!</span></p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19743);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-27 10:28 am</div>
				                <div>Hello roberthoot,<br />
<br />
Thank you for your question. You can create posts in the InMotion Hosting's <a href="http://www.inmotionhosting.com/support/u">User Submitted</a> section.<br />
<br />
You can also setup your <a href="/support/">Google Authorship</a>, so you are listed as a <strong>contributor</strong> to our site.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22977);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-20921'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/b181231d82d5f8414ab5d00135069198?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/b181231d82d5f8414ab5d00135069198'>jayed</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-21 1:58 am</div>
				                <div><p>thank</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20921);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-21086'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/d6642a208d2c302f9f0daa83cbade7c8?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/d6642a208d2c302f9f0daa83cbade7c8'>Lavinia</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-26 9:07 am</div>
				                <div><p>I've been told that in order to find the code of my faulty website the new dev needs to get it from the server. &nbsp;I would like to kmow whehter this is a fact and whether is a difficult task. &nbsp;Thanks</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21086);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-26 10:12 am</div>
				                <div>Hello Lavinia,<br />
<br />
As this question does not relate to the article topic, it has been moved and created as a new question <ahref='http://www.inmotionhosting.com/support/community-support/how-to/how-do-i-get-to-the-code-files">here</a>. To maintain topic relevance please only comment on related articles. You can always <a href="http://www.inmotionhosting.com/support/community-support/ask-a-question">ask a new question</a> if you cannot find your answer in our article lists.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21094);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-22682'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/8127c0b8d840d8643b1fbb52188fc1ce?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/8127c0b8d840d8643b1fbb52188fc1ce'>Ronnie</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-15 5:13 pm</div>
				                <div><p>Awesome!! Just used this to edit some JS.</p>
<p>&nbsp;</p>
<p>I had never thought of this until now. Much better solution than deleting code.&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22682);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						...
						<div><a style='font-size:16px;' href='//www.gravatar.com/02c30ce8359e0b374e12d0ede715bbc7'>php course in chennai</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-05-21 3:03 am</div>
				                <div><p>Thanks for sharing this blog....</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23573);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/5c272fa015fe5ef03db9aff35d8c04bd?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/5c272fa015fe5ef03db9aff35d8c04bd'>NMV</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-22 9:28 am</div>
				                <div><p style="text-align: left;">Nice Comment format</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25071);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-26260'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/3a0155bed00fd3a257272e6137645bea?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/3a0155bed00fd3a257272e6137645bea'>ron</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-01 7:14 pm</div>
				                <div><p>Thank you so much it helped</p>
</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26260);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
