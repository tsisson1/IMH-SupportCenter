<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:69724:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/databases/postgresql/import-database" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-12-19T01:49:17-08:00" />
  <meta name="keywords" content="import PostgreSQL database phpPgAdmin" />
  <meta name="author" content="John-Paul Briones" />
  <meta name="description" content="This guide walks you through importing a PostgreSQL database into cpanel using phpPgAdmin." />
  <title>How to Import a PostgreSQL database using phpPgAdmin - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/databases/postgresql/import-database" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:9cb27202a8bc5a0d9e3653b078b24720 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '104.129.196.75']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/website/databases/postgresql' itemprop='url'><span itemprop='title'>PostgreSQL<span></a></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to Import a PostgreSQL database using phpPgAdmin</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to Import a PostgreSQL database using phpPgAdmin									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>6,434</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Apr 3, 2014'><span style='color:#606060;'>Published:</span> Dec 19, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Now that you've <a href="/support/website/databases/postgresql/install-setup">installed PostgreSQL and phpPgAdmin</a> on your server, you can begin to create and manage databases. In this tutorial, we'll show you how to <strong>import</strong> a <strong>PostgreSQL database</strong> using <strong>phpPgAdmin</strong> in cPanel.</p>

<div class="alert alert-danger">You must <a href="/support/website/databases/postgresql/create-database">create a PostgreSQL database</a> before you can complete this guide.</div>
...
<li>Click the <strong>phpPgAdmin</strong> button in the <em>Databases</em> section.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/postgresql/export-db/phppgadmin.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/postgresql/export-db/phppgadmin.png" alt="" title="accessing phpPgAdmin in cPanel" /></a><br>
<br><div class="alert alert-warning"><strong>Note:</strong> The <em>phpPgAdmin</em> button, is only available after <a href="/support/website/databases/postgresql/install-setup">installing PostGreSQL</a> on your VPS, or Dedicated server.</div></li>
<li>On the <em>top left</em>, click the database you want to import the backup into.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/postgresql/import-db/select-database.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/postgresql/import-db/select-database.png" alt="" title="choose database" /></a></li>
<li>Click the <strong>SQL</strong> tab.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/postgresql/import-db/sql-tab.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/postgresql/import-db/sql-tab.png" alt="" title="opening the SQL menu in phppgadmin" /></a></li>
<li>Click the <strong>Browse</strong> button, and select your database backup file, and click <strong>Open</strong>.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/postgresql/import-db/choosing-database-to-import.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/postgresql/import-db/choosing-database-to-import.png" alt="" title="opening your postgresql database to import" /></a></li>
<li>Click the <strong>Execute</strong> button to begin the import process. This will take some time depending on the size of the database. When you see a <em>SQL Executed</em> message, you are finished. You will also see that your tables are now populated.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/postgresql/import-db/sql-executed.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/postgresql/import-db/sql-executed.png" alt="" title="successful SQL execution" /></a></li>
<br></ol>
<br>
<p>Congratulations, now you know how to <strong>import</strong> a <strong>PostgreSQL database</strong> using <strong>phpPgAdmin</strong>! Learn more about <a href="http://www.inmotionhosting.com/postgresql-hosting">PostgreSQL Hosting</a> options.</p> 
...
<div style='display:inline-block;'>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD01MDMmaWQ9MzE4OCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/65debf5d73c4d643b7fcd85969531ed8?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/65debf5d73c4d643b7fcd85969531ed8'>Paris M</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-05-28 2:33 pm</div>
				                <div><p>When I follow these steps, I get an error that says "No server supplied!"</p>
<p>&nbsp;</p>
<p>Any advice?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23773);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-05-29 11:03 am</div>
				                <div>Hello Paris,<br />
<br />
Thank you for contacting us.  I found a <a href="http://sourceforge.net/p/phppgadmin/bugs/372/" target="_blank">similar post</a>, where they suggest you can update your <a href="http://www.inmotionhosting.com/support/website/php/update-local-php-settings">settings in the php.ini</a>.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23812);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-24041'></a>
		<div  style='margin:2px 0px 0px 80px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/0687f820809f42cf361bd9c05a284d62?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/0687f820809f42cf361bd9c05a284d62'>Arvind Kumar Gupta</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-08 11:44 pm</div>
				                <div><p>Hi,</p>
<p>I am getting the same error "No server supplied!" while importing the database.</p>
<p>However I have configured the php.in as:</p>
<pre class="code_block" style="margin-left: 20px;">max_execution_time = 120<strong>max_input_time = 180</strong>memory_limit = 1024Mupload_max_filesize = 128MPlease help.</pre>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24041);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-09 7:10 pm</div>
				                <div>Hello Arvind,<br />
<br />
Do you have an account with us so we may investigate further? There may be something in the file you are trying to import. If you could just provide us your domain name we can attempt to look into this issue further for you.<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24080);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
