<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:66568:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-3/site-settings/create-sitemap" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-03-24T14:25:05-07:00" />
  <meta name="keywords" content="joomla 3 sitemap sitemap.xml" />
  <meta name="author" content="John-Paul Briones" />
  <meta name="description" content="This guide shows you how to generate a sitemap in Joomla 3 using the free Xmap extension," />
  <title>How to Create a Sitemap in Joomla 3 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-3/site-settings/create-sitemap" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:ac4d939d2ebf249893bd26205f48c5a9 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '103.251.244.42']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to Create a Sitemap in Joomla 3									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>15,204</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: May 2, 2014'><span style='color:#606060;'>Published:</span> Mar 24, 2015</div>
							...
							<div style='clear:both;'></div>
								...
								<p class="alert alert-danger"><b>Note that development for this plugin has ceased. The download link is no longer valid.  If you follow the link, it will bring you alternatives.  The following article will remain for archive purposes. </b></p>


<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/joomla/example-sitemap.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/joomla/example-sitemap.png" alt="Xmap site map in joomla 3" title="Example of a joomla sitemap made with Xmap" align="right" /></a>
<div class="in_this_tutorial">
  <h2>In this tutorial:</h2>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('install');">Install Xmap</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('generate');">Generate a Sitemap</button>
</div>

<p>The easiest way to create a <strong>Sitemap</strong> for a <strong>Joomla 3</strong> website is to use one of the many Extensions available. In this guide we will walk you through creating a <em>sitemap.xml</em> file for a Joomla 3 website, using the <em>Xmap</em> extension.  Creating a sitemap can help Google crawl your website more accurately, since it provides a list of all your pages. Click here to learn more about <a href="http://www.inmotionhosting.com/joomla-hosting">Joomla Hosting</a>.</p>

<div style="clear:both;"></div>
<a name="install"></a>
<h2>Installing the Xmap Extension</h2>
<ol class="article_list">
  <li>Download the <strong>Xmap Package</strong> </a><a href="http://www.jooxmap.com/downloads.html" target="_blank">here</a>.</li>
<li><a href="/support/edu/joomla-3/getting-started/login-dashboard">Login to the Admin Dashboard for Joomla 3</a>.</li>
<li>In the main menu, click <strong>Extensions</strong>, then click <strong>Extension Manager</strong></li>
<li>Click the <strong>Choose File</strong> button and select the file you downloaded in <em>step 1</em>.</li>
<li>Click the <strong>Upload & Install</strong> button. You will then see a message stating "<em>Installing package was successful.</em>"</li>
<li>Click <strong>Extensions</strong> in the main menu, then click <strong>Plugin Manager</strong>.</li>
<li>In the search box, type <strong>Xmap</strong>, then hit the <strong>Enter</strong> key to search.</li>
<li>You will see a list of all the included <em>Xmap</em> plugins. Click the red <strong>X</strong> next to <em>Xmap - WebLinks Plugin</em>, and <em>Xmap - Content Plugin</em> to enable them. You will see a green check beside them once they are enabled successfully.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/joomla/enable-xmap-plugin.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/joomla/enable-xmap-plugin.png" alt="turning the xmap features on to create a xml sitemap" title="enabling the Xmap extension for Joomla" /></a></li>
</ol>
...
<ol class="article_list">
<li><a href="/support/edu/joomla-3/getting-started/login-dashboard">Login to the Admin Dashboard for Joomla 3</a>.</li>
<li>In the main menu, click <strong>Components</strong>, then <strong>Xmap</strong>.</li>
<li>Click the <strong>New</strong> button.</li>
<li>On the next screen, enter a name for sitemap in the <em>Title</em> field, and change the <em>Status</em> to <strong>Published</strong>. Make sure the <em>Access</em> setting is set to <strong>Public</strong>.</li>
<li>Select the <strong>Menus</strong> tab. Click the <em>check box</em> next to the menus you want included in the sitemap.</li>
<li>The other fields are not required, click the <strong>Save</strong> button when you are finished. You will then see a message stating "<em>Item successfully saved.</em>"</li>
<br></ol>
<br>
  <p>Congratulations, now you know how to a generate a <em>sitemap.xml</em> file for a Joomla 3 website, using the <em>Xmap</em> extension.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 1: How to Create a Sitemap in Joomla 3</div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-3/site-settings/create-sitemap&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-3/site-settings/create-sitemap'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNDcmaWQ9MzIyOCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/f8c8347be96647daafd95f0d13937f20?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/f8c8347be96647daafd95f0d13937f20'>Jean Carlo Garcia</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-04 12:50 pm</div>
				                <div><p>The download link is wrong: http://www.jooxmap.com/downloads.html, it don't work.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21304);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-04 1:39 pm</div>
				                <div>Hello Jean,<br />
<br />
Unfortunately, they have discontinued support for it.  I have added a note to the top of the page warning people about the issue.  The link for the software does lead to other possible solutions.  The article will remain for archive purposes.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21306);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
