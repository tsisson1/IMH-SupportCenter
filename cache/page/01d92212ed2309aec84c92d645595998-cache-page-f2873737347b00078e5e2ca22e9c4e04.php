<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:57277:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/mediawiki/change-media-wiki-appearance/changing-css-media-wiki" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-02-25T16:43:12-08:00" />
  <meta name="keywords" content="change css add media wiki mediawiki  how to" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="MediaWiki has a way to edit CSS through the Admin. This article will teach how to add CSS to your MediaWiki." />
  <title>Changing the CSS in MediaWiki - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/mediawiki/change-media-wiki-appearance/changing-css-media-wiki" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:1ee8edac0886713b320544d92b71b8c0 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Changing the CSS in MediaWiki									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>9,785</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Feb 25, 2013'><span style='color:#606060;'>Published:</span> Feb 25, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>MediaWiki has a unique way of making style sheet changes. There is a MediaWiki:Common.css page built into the program that stores global CSS changes. Instead of editing the .css files directly on the server, you can edit the MediaWiki:Common.css file through your MediaWiki admin. Below are the steps to add custom CSS code to your MediaWiki site.</p>
<h2>How to change the CSS in MediaWiki</h2>
...
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/103/edit-css-common/edit-css-common-1-url.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Go to the MediaWili:Common.php url MediaWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/103/edit-css-common/edit-css-common-1-url.gif" title="Click here to view the larger image" width="100" /></a>Visit the following url. Make sure you change your-mediawiki.com to your domain name.
<pre style="margin-left: 20px;">http://your-mediawiki.com/index.php?title=MediaWiki:Common.css</pre>
<br style="clear: both;" />
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/103/edit-css-common/edit-css-common-2-css-page.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="The CSS page should load MediaWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/103/edit-css-common/edit-css-common-2-css-page.gif" title="Click here to view the larger image" width="100" /></a>You should see the page say, "<em>/* CSS placed here will be applied to all skins */</em>". If you do not see this, then you are on the wrong page. Make sure you typed it correctly.<br style="clear: both;" /></p>
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/103/edit-css-common/edit-css-common-3-edit-page.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Click Edit MediaWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/103/edit-css-common/edit-css-common-3-edit-page.gif" title="Click here to view the larger image" width="100" /></a>Click <strong>Edit</strong> towards the top left of the page.. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/103/edit-css-common/edit-css-common-4-add-css-code.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Add the CSS cdoe MediaWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/103/edit-css-common/edit-css-common-4-add-css-code.gif" title="Click here to view the larger image" width="100" /></a>On the "<em>Editing MediaWiki:Common.css</em>", add the code you want to change the style for. In this example, we will change the font of the entire site to "<em>Courier New</em>".
<p>Click <strong>Save Page</strong>.</p>
<br style="clear: both;" />
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/103/edit-css-common/edit-css-common-5-changed-font.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="View of CSS change MediaWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/103/edit-css-common/edit-css-common-5-changed-font.gif" title="Click here to view the larger image" width="100" /></a>The CSS change will apply globally to the MediaWiki site. The image to the right shows the font change to "<em>Courier New</em>". <br style="clear: both;" /></p>
</li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 5: Changing the CSS in MediaWiki</div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/mediawiki/change-media-wiki-appearance/changing-css-media-wiki&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/mediawiki/change-media-wiki-appearance/changing-css-media-wiki'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMTQmaWQ9MjI0NyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
