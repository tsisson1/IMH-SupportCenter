<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50194:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/domain-names/im-trying-to-change-my-domain-name-to-point-to-my-new-web-site" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, Thanks for the question and sorry for the problems with the domain name. Basically, since the domain name you're trying to use is NOT pointed to ..." />
  <title>I'm trying to change my domain name to point to my new web site | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/domain-names/im-trying-to-change-my-domain-name-to-point-to-my-new-web-site" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:dc743093acedee3218b087aa2aec9ad7 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>I'm trying to change my domain name to point to my new web site</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2014-04-24 7:13 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>30</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I'm trying to change my domain name fohnetik.com which is currently on Domain.com to point to my new web site. I have no idea what URL I'm supposed to use.<br />
</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_4863' id='upvote_answer_4863' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='4863' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_4863').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_4863' id='downvote_answer_4863' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='4863' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_4863').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
Thanks for the question and sorry for the problems with the domain name. Basically, since the domain name you're trying to use is NOT pointed to our servers. Your domain name will not work with your website being hosted here until you update your name servers.  When I checked it, I could see that it's not pointing to our name servers.   Please reference this <a href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/updating-your-domains-nameservers">article</a> to get information on how to change your name servers so that they point to our servers.  Once the change is made, you will encounter a short delay called <a href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/domain-names-dns-changes">DNS propagation</a>.  The internet servers are being updated during this short period of time (usually less than 24 hours) in order to recognize your domain name when someone types it in a browser.<br />
<br />
I hope that explains the issue!  Please let us know if you have any further questions.<br />
<br />
Regards,<br />
Arnel C.<br />
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_4863').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_4863' id='form_comment_on_answer_4863' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/domain-names/im-trying-to-change-my-domain-name-to-point-to-my-new-web-site&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/domain-names/im-trying-to-change-my-domain-name-to-point-to-my-new-web-site'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="3aad997c47bd9b1f67ad887875eae6e8" value="1" />	</div>
	</form>
<!-- <br />
