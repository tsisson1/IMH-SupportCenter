<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:57870:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-25/305-php-temporary-directory-not-set" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-02-15T15:05:09-08:00" />
  <meta name="keywords" content="joomla 2.5 php temporary directory is not set" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="In this Joomla 2.5 tutorial, we'll show you how to resolve the php temporary directory is not set warning message." />
  <title>305: Joomla 2.5 - The PHP temporary directory is not set - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-25/305-php-temporary-directory-not-set" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:e9a3981848cf1e062a711d79f1bd561f -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															305: Joomla 2.5 - The PHP temporary directory is not set									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>30,747</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: May 22, 2012'><span style='color:#606060;'>Published:</span> Feb 15, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/php-temporary-directory/the-php-temporary-directory-is-not-set.gif"><img style="float: right; margin: 0px 0px 15px 15px;" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/php-temporary-directory/the-php-temporary-directory-is-not-set.gif" alt="the-php-temporary-directory-is-not-set"  width="100" /></a>While performing regular maintenance on our Joomla 2.5 website, we found the following warning in the extension manage:</p>
<p style="margin-left: 20px;"><code style="word-wrap: break-word;"><strong>The PHP temporary directory is not set</strong><br />The PHP temporary directory is the directory that PHP uses to store an uploaded file before Joomla! can access this file. Whilst the directory not being set isn't always a problem, if you are having issues with manifest files not being detected or uploaded files not being detected, setting this in your php.ini file might fix the issue.</code><br style="clear: both;" /></p>
<h2>Fixing the The "PHP temporary directory is not set" error</h2>
<p>To resolve this issue, you'll need to adjust the <strong>upload_tmp_dir</strong> setting in your php.ini file.</p>
<p class="alert"><strong>Please note:</strong><br />Not every user will have a php.ini file! Depending on how your server is setup, you may or may not have access to adjust your php.ini settings. If you don't have a php.ini file, most settings you can adjust via a .htaccess file as well. It is best to contact your hosting provider for help with updating the upload_tmp_dir setting. If you host you website with InMotion Hosting, you can find more help here with <a target="_blank" href="/support/website/general-server-setup/update-local-php-settings">adjusting your php settings</a>.</p>
<p>In our example, we created /administrator/php.ini and put in the following code:</p>
<p class="code_block">upload_tmp_dir = /home/userna5/tmp</p>
<p>userna5 is our cPanel username, and in the root of our account we have a writable folder named tmp.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 4: 305: Joomla 2.5 - The PHP temporary directory is not set</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 5: <a href='/support/edu/joomla-25/306-mass-mail-users'>306: How to use the Mass Mail Feature in Joomla 2.5</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-25/305-php-temporary-directory-not-set&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-25/305-php-temporary-directory-not-set'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD05NyZpZD0yMzgyJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/c0c5802f0d6fb4ba063cabb7f62c4f8c?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/c0c5802f0d6fb4ba063cabb7f62c4f8c'>Jonathan Frewin</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-04 1:11 pm</div>
				                <div><p>Great fix - thanks for posting.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9414);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
