<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:67069:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/prestashop-15/managing-customers/set-new-customer-notification" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-07-24T19:07:20-07:00" />
  <meta name="keywords" content="edit enable disable new customer notification PrestaShop 1.5 back office dashboard panel" />
  ...
  <title>How to enable/disable the new customer notification in PrestaShop 1.5 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/prestashop-15/managing-customers/set-new-customer-notification" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:f3d9b43fff8cd466ad716d2831732f99 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '190.141.3.20']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to enable/disable the new customer notification in PrestaShop 1.5									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>4,849</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jun 19, 2012'><span style='color:#606060;'>Published:</span> Jul 24, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In the PrestsShop 1.5 back office interface, several notifications are enabled by default. These are new order, new customer, and new message notifications. These can be disabled or re-eneabled by using the back office dashboard. This article goes over how to edit the new customer notification setting. Disabling or enabling the new customer notification in PrestaShop 1.5 is easy when you use the following steps:</p>
<p><strong>How to enable/disable the new customer setting in PrestaShop 1.5:</strong></p>
...
<li>You are now on the <strong>Administration : Preferences</strong> screen. In the lower section, named <strong>Notifications</strong>, you will see the setting named <strong>Show notifications for new customers</strong>. This is set to <strong>Yes</strong> by default, which means the notification is turned on. To turn it off, simply click the radio button next to the red <strong>X</strong>.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Administration/Preferences/administration-preferences-notifications-customer.png"><img  alt="administration-preferences-notifications-customer" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Administration/Preferences/administration-preferences-notifications-customer.png" /></a></li>
<li>Once finished, click the green <strong>Save </strong>button in the upper right corner.</li>
</ol>
<p>That is how you change the new customer setting in PrestaShop 1.5</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/prestashop-15/managing-customers'>201: Managing Customers in PrestaShop 1.5</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 20: How to enable/disable the new customer notification in PrestaShop 1.5</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 19: <a href='/support/edu/prestashop-15/managing-customers/set-new-message-notification'>How to enable/disable the new message notification in PrestaShop 1.5</a>
								</td>
...
<div style='display:inline-block;'>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yMzgmaWQ9MTQ4MiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="0bf218367fa418f21aa8b559c8f3d278" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/prestashop-15/managing-customers?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Managing Customers in PrestaShop 1.5</h3></a>
		<table><tr><td colspan='2'><h4>Basic Customer Record Management</h4></td></tr>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/prestashop-15/managing-customers/manually-add-customer?tsrc=rsbedu'>Manually adding  a customer in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/prestashop-15/managing-customers/manually-delete-a-customer?tsrc=rsbedu'>How to manually delete a customer in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/prestashop-15/managing-customers/manually-edit-a-customer?tsrc=rsbedu'>How to manually edit a customer in PrestaShop 1.5</a></td>
                </tr>
        <tr><td colspan='2'><h4>Other Customer Settings</h4></td></tr>  <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/prestashop-15/managing-customers/change-group-access?tsrc=rsbedu'>Changing user group access in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/prestashop-15/managing-customers/change-newsletter-setting?tsrc=rsbedu'>Changing a customer's newsletter setting in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/prestashop-15/managing-customers/changing-opt-in-status?tsrc=rsbedu'>Changing a customer's opt-in status in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>7.</td>
                        <td><a href='/support/edu/prestashop-15/managing-customers/disable-user-login?tsrc=rsbedu'>How to disable a customer's login in PrestaShop 1.5</a></td>
                </tr>
        <tr><td colspan='2'><h4>Customer address management</h4></td></tr>  <tr >
                        <td valign='top'>8.</td>
                        <td><a href='/support/edu/prestashop-15/managing-customers/add-customer-address?tsrc=rsbedu'>How to add a customer address in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>9.</td>
                        <td><a href='/support/edu/prestashop-15/managing-customers/edit-customer-address?tsrc=rsbedu'>How to edit a customer address in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>10.</td>
                        <td><a href='/support/edu/prestashop-15/managing-customers/deleting-a-customer-address?tsrc=rsbedu'>How to delete a customer address in PrestaShop 1.5</a></td>
                </tr>
        <tr><td colspan='2'><h4>Managing Customer Groups</h4></td></tr>  <tr >
                        <td valign='top'>11.</td>
                        <td><a href='/support/edu/prestashop-15/managing-customers/adding-a-new-customer-group?tsrc=rsbedu'>Adding a customer group in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>12.</td>
                        <td><a href='/support/edu/prestashop-15/managing-customers/delete-a-customer-group?tsrc=rsbedu'>How to delete a customer group in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>13.</td>
                        <td><a href='/support/edu/prestashop-15/managing-customers/create-a-group-discount?tsrc=rsbedu'>Creating a group discount in PrestaShop 1.5</a></td>
                </tr>
        <tr><td colspan='2'><h4>General Customer Settings</h4></td></tr>  <tr >
                        <td valign='top'>14.</td>
                        <td><a href='/support/edu/prestashop-15/managing-customers/changing-registration-process-type?tsrc=rsbedu'>Changing Registration Process Type in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>15.</td>
                        <td><a href='/support/edu/prestashop-15/managing-customers/changing-regenerate-password?tsrc=rsbedu'>Changing the regenerate password minimum time in Prestashop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>16.</td>
                        <td><a href='/support/edu/prestashop-15/managing-customers/adding-a-contact-email?tsrc=rsbedu'>How to add a contact email address in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>17.</td>
                        <td><a href='/support/edu/prestashop-15/managing-customers/deleting-a-contact-point?tsrc=rsbedu'>How to delete a contact point in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>18.</td>
                        <td><a href='/support/edu/prestashop-15/managing-customers/add-gender-title?tsrc=rsbedu'>How to add a new gender title in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>19.</td>
                        <td><a href='/support/edu/prestashop-15/managing-customers/set-new-message-notification?tsrc=rsbedu'>How to enable/disable the new message notification in PrestaShop 1.5</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>20.</td>
                        <td><a href='/support/edu/prestashop-15/managing-customers/set-new-customer-notification?tsrc=rsbedu'>How to enable/disable the new customer notification in PrestaShop 1.5</a></td>
                </tr>
          	</table>
