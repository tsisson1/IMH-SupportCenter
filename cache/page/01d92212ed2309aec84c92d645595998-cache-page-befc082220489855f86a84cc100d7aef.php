<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:61670:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-35/getting-started/manual-installation" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-01-12T21:07:46-08:00" />
  <meta name="keywords" content="Joomla 3.5 install manual" />
  <meta name="author" content="John-Paul Briones" />
  <meta name="description" content="Manually installing Joomla 3.5 - walk-through guide." />
  <title>How to Manually Install Joomla 3.5 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-35/getting-started/manual-installation" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<script type="text/javascript">
		...
		_gaq.push(['_setCustomVar', 4, 'DateMonthPublished', '2016-01', 3]);
	...
	<!-- cid:a6753f3d086a6e702cedd8c2db75acd0 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '49.207.185.56']);
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/joomla-35' itemprop='url'><span itemprop='title'>Joomla 3.5<span></a><div class='dropdown_2columns'><h2>Joomla 3.5 Education Channel</h2><div class='col_2'><h3>100 Level Classes</h3><div><a href='/support/edu/joomla-35/getting-started'>101: Getting Started with Joomla 3.5</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/joomla-35/getting-started' itemprop='url'><span itemprop='title'>101: Getting Started with Joomla 3.5<span></a><div class='dropdown_3columns'><h2> Getting Started with Joomla 3.5</h2><div class='col_3'><div>1. <a style='display:inline;' href='/support/edu/joomla-35/getting-started/manual-installation'>How to Manually Install Joomla 3.5</a></div><div>2. <a style='display:inline;' href='/support/edu/joomla-35/getting-started/how-to-log-in-to-administrative-dashboard'>How to Log in to your Joomla 3.5 Dashboard</a></div><div>3. <a style='display:inline;' href='/support/edu/joomla-35/getting-started/create-new-article'>How to Create a New Article in Joomla 3.5</a></div><div>4. <a style='display:inline;' href='/support/edu/joomla-35/getting-started/create-category'>How to Create a New Category in Joomla 3.5</a></div><div>5. <a style='display:inline;' href='/support/edu/joomla-35/getting-started/change-article-category'>How to Change an Article Category in Joomla 3.5</a></div><div>6. <a style='display:inline;' href='/support/edu/joomla-35/getting-started/how-to-enable-disable-maintenance-mode'>How to Enable & Disable Maintenance Mode in Joomla 3.5</a></div><div>7. <a style='display:inline;' href='/support/edu/joomla-35/getting-started/enable-two-factor-authentication'>How to Enable Two Factor Authentication in Joomla 3.5</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to Manually Install Joo...</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to Manually Install Joomla 3.5									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>482</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 12, 2016'><span style='color:#606060;'>Published:</span> Jan 12, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In this tutorial, we will show you how perform a manual installation of Joomla <a href="/support/edu/joomla-35">3.5</a>. This allows you to setup and begin building your website with the latest version of Joomla.</p>

<div class="alert alert-danger" role="alert">At the time this article was written, Joomla 3.5 was only availabe as a beta release.</div>

<a name="install"></a>
<h2>Manually Installing Joomla 3.5</h2>
<ol class="article_list">

<li>Download Joomla 3.5 from the official <a href="https://www.joomla.org/download.html" target="_blank" rel="nofollow">download</a> page.</li>
<li><a href="/support/how-do-i-create-a-mysql-database-in-my-control-panel-cpanel">Create a MySQL database in your Control Panel (cPanel)</a>. Be sure to save the database name for later use.</li>
<li>Create a database user, and attach the user to the database you just created. Save the database username and password you setup in this step.</li>
<li><a href="/support/how-to-upload-files-server">Upload</a> the <strong>.zip</strong> file to your server.</a>.</li>
<li>Uncompress the zip file to the location you want your Joomla 3.5 site to be installed. For more information of your file structure, see our full guide <a href="/support/where-to-upload-files">How to find the Document Root for your website / What directory should I put my files in?</a>.</li>
<li>In a browser navigate to the location of the Joomla files. In my test I am going to example.com since I uploaded the files to the "public_html" folder. You should see the "<em>Main Configuration</em>" page for Joomla.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/joomla/35/manual-install/joomla-35-main-configuration.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/joomla/35/manual-install/joomla-35-main-configuration.png" alt="Installing Joomla 3.5" title="Main Configuration page in Joomla Installation" /></a></li>
<li>Fill in the fields with your information, then click the <strong>Next</strong> button. Below is is a description of the available fields provided by Joomla:<br><br>
...
<td>Click the drop-down box to select a language for your Joomla installation.</td>
</tr>
<tr>
<td>Site Name</td>
<td>Enter the name of your Joomla! site.</td>
</tr>
<tr>
<td>Description</td>
<td>Enter a description of the overall Web site that is to be used by search engines. Generally, a maximum of 20 words is optimal.</td>
</tr>
<tr>
<td>Admin Email</td>
<td>Enter an email address. This will be the email address of the Web site Super Administrator.</td>
</tr>
<tr>
<td>Admin Username</td>
<td>Set the username for your Super Administrator account.</td>
</tr>
<tr>
<td>Admin Password</td>
<td>Set the password for your Super Administrator account and confirm it in the field below.</td>
</tr>
<tr>
<td>Confirm Admin Password</td>
<td>Enter your Admin Password again here.</td>
</tr>
<tr>
<td>Site Offline</td>
<td>Set the site frontend offline when installation is completed. The site can be set online later on through the Global Configuration.</td>
</tr>
</tbody>
</table> 
</li>
<li>You will then be on the <em>Database Configuration</em> page. Fill in the fields with your Database information. Below is a description of the available fields along with the recommended settings:<br>
...
<tr>
<td>Username</td>
<td>Either something as "root" or a username given by the host.</td>
<td>Enter your database username here. Such as: example_jom</td>
</tr>

<tr>
<td>Password</td>
<td>For site security using a password for the database account is mandatory.</td>
<td>fdsaf</td>
</tr>

<tr>
<td>Database Name</td>
<td>Some hosts allow only a certain DB name per site. Use table prefix in this case for distinct Joomla! sites.</td>
<td>Enter your Database password, be sure it is <a href="/support/password-strength"><strong>strong</strong></a>.</td>
</tr>

<tr>
<td>Table Prefix</td>
<td>Choose a table prefix or use the randomly generated. Ideally, three or four characters long, contain only alphanumeric characters, and MUST end in an underscore. Make sure that the prefix chosen is not used by other tables.</td>
<td>There will be a prefix randomly generated, such as this: jre83_</td>
</tr>

<tr>
<td>Old DatabaseProcess</td>
<td>Any existing backup tables from former Joomla! installations will be replaced.</td>
<td>Choose if you want to backup, or remove backup tables from older Joomla installations. Since this is a new installation, I chose Remove.</td>
</tr>
</tbody>
</table> 
</li>
<li>You will then be on the <em>Finalization</em> page.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/joomla/35/manual-install/joomla-35-finalization.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/joomla/35/manual-install/joomla-35-finalization.png" alt="Complete Joomla 3.5 Installation" title="Joomla 3.5 Finalization" /></a><br><br>
 Choose if you want Sample Data installed. Options are: None, Blog, Brochure, Default, Learn Joomla, or Test.</li>
<li>Next to <em>Email Configuration</em> select <strong>Yes</strong> to send the configuration settings to your <em>Admin Email</em> address,or <strong>No</strong> if you do not need the email.
<li>Click the <strong>Install</strong> button.</li> 

<li>When you see a "<em>Congratulations! Joomla! is now installed</em>" message, click the <strong>Remove installation folder</strong> button.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/joomla/35/manual-install/joomla-35-remove-installation-folder.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/joomla/35/manual-install/joomla-35-remove-installation-folder.png" alt="Joomla 3.5 Installation complete" title="Removing Joomla 3.5 Installation folder" /></a></li>
</ol>
<br>
<p>Congratulations, you have successfully completed a manual installation of Joomla 3.5! Now you can <a href="/support/login-dashboard">login to your Administrator Dashboard</a> and begin building your website.</p>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/joomla-35/getting-started'>101: Getting Started with Joomla 3.5</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 1: How to Manually Install Joomla 3.5</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 2: <a href='/support/edu/joomla-35/getting-started/how-to-log-in-to-administrative-dashboard'>How to Log in to your Joomla 3.5 Dashboard</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-35/getting-started/manual-installation&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-35/getting-started/manual-installation'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD01NTAmaWQ9MzcxMCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="659269b9b35e6656d2b3cbf15668266f" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/joomla-35/getting-started?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Getting Started with Joomla 3.5</h3></a>
		<table>  <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/joomla-35/getting-started/manual-installation?tsrc=rsbedu'>How to Manually Install Joomla 3.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/joomla-35/getting-started/how-to-log-in-to-administrative-dashboard?tsrc=rsbedu'>How to Log in to your Joomla 3.5 Dashboard</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/joomla-35/getting-started/create-new-article?tsrc=rsbedu'>How to Create a New Article in Joomla 3.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/joomla-35/getting-started/create-category?tsrc=rsbedu'>How to Create a New Category in Joomla 3.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/joomla-35/getting-started/change-article-category?tsrc=rsbedu'>How to Change an Article Category in Joomla 3.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/joomla-35/getting-started/how-to-enable-disable-maintenance-mode?tsrc=rsbedu'>How to Enable & Disable Maintenance Mode in Joomla 3.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>7.</td>
                        <td><a href='/support/edu/joomla-35/getting-started/enable-two-factor-authentication?tsrc=rsbedu'>How to Enable Two Factor Authentication in Joomla 3.5</a></td>
                </tr>
          	</table>
