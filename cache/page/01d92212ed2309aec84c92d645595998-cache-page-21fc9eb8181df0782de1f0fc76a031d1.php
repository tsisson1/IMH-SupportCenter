<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:58339:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/email/my-iphone-email-account-stopped-working-suddenly-i-get-the-message-cannot-get-mail-the-mail-server-is-not-responding-i-tried-deleting-and-reconfiguring-the-account-but-still-get-the-same-message-what-is-the-fix" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="I had the same issue. What worked for me (just a few minutes ago) was to go to Setting, then General, and at the bottom tap Reset, then on next page I h..." />
  <title>My iPhone email account stopped working suddenly. I get the message &quot;Cannot get Mail.&quot; The mail server ... is not responding...&quot; I tried deleting and reconfiguring the account, but still get the same message. What is the fix? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/email/my-iphone-email-account-stopped-working-suddenly-i-get-the-message-cannot-get-mail-the-mail-server-is-not-responding-i-tried-deleting-and-reconfiguring-the-account-but-still-get-the-same-message-what-is-the-fix" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:6973cc40d9ec0dd76d134499ff7afd7c -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '72.192.224.108']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>My iPhone email account stopped working suddenly. I get the message &quot;Cannot get Mail.&quot; The mail server ... is not responding...&quot; I tried deleting and reconfiguring the account, but still get the same message. What is the fix?</h1>
		<div style='margin-bottom:20px; margin-top:10px; clear:both; color:#6e6e6e;'>Category: <a href='/support/community-support/email'>Email</a></div>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='http://graph.facebook.com/billie.j.collins.1/picture?type=normal' class='user_avatar' /><br />
			<a href='/support/community-support/users/Lockwood'>Lockwood</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-07-13 6:03 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>180,258</span>
			</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_3540' id='upvote_answer_3540' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='3540' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_3540').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_3540' id='downvote_answer_3540' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='3540' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_3540').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hi Lockwood,<br />
<br />
I'm sorry to hear about the email issue you're having, and hopefully I can help. If you are checking your email and it is failing because:<br />
<br />
&lt;strong&gt;The mail server is not responding&lt;/strong&gt;<br />
<br />
... most likely there was a temporary issue on the server. If that is the case, it should be resolved by now as these temporary issues are not usually long lived. Are you still having this issue?<br />
<br />
&lt;strong&gt;IP Blocked/Blacklisted on server&lt;/strong&gt;<br />
<br />
At times the server's security software may see your IP address a a threat. For example, a script may be trying to connect to the server over and over from your &lt;strong&gt;IP address&lt;/strong&gt;. This would cause you to get blocked/blacklisted. You can easily &lt;a href=&quot;http://www.inmotionhosting.com/support/community-support/website-troubleshooting/is-my-ip-address-blocked#how-to-check&quot;&gt;determine if your IP is blocked&lt;/a&gt; from the server.<br />
<br />
&lt;strong&gt;Try changing your email server names&lt;/strong&gt;<br />
<br />
If you are still having this issue, you can try updating your mail server in your iphone. For example, you can use several different values for the email server, such as the server's hostname or the server's IP address.<br />
<br />
Even though the following article is about FTP, it describes several different values you can use as a server name. The same principle applies for both ftp and email (unless you are connecting securley using secure##.inmotionhosting.com). If you are still having the, &quot;mail server is not responding&quot; problem, please try a different &lt;strong&gt;Host name&lt;/strong&gt; as described on &lt;a href='http://www.inmotionhosting.com/support/website/file-management/getting-started-guide-ftp'&gt;this page&lt;/a&gt;.<br />
<br />
&lt;strong&gt;Webmail as a temporary alternative&lt;/strong&gt;<br />
<br />
If you need to check your email immediately, as a temporary work around, you can use webmail:<br />
<br />
&lt;a href='http://www.inmotionhosting.com/support/edu/cpanel/cpanel-email/logging-into-webmail'&gt;How to log into Webmail&lt;/a&gt;<br />
<br />
Thanks,<br />
- Brad
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_3540').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_3540' id='form_comment_on_answer_3540' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>If you have remove and re-added the email account and it is still not working, I recommend &lt;a href=&quot;http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support&quot;&gt;contacting our support department via phone, chat, or email&lt;/a&gt; to ensure that the settings that you are entering are correct.  If the settings are correct and you have removed/re-added the account to your phone, I recommend contacting Apple for further assistance as something within your phone may be corrupted.</div>
...
<div class=' straight_bottom not_best_answer'>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px; width:50px;' valign='top'>
<div class='vote_div'>
	<form method='post' name='upvote_answer_4195' id='upvote_answer_4195' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='4195' />
		<input type='hidden' name='component' id='component' value='qa' />
		<input type='hidden' name='vote_value' id='vote_value' value='1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_4195').submit();"></div>
	</form>
	<div class='vote_sum'>1</div>
	<form method='post' name='downvote_answer_4195' id='downvote_answer_4195' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='4195' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_4195').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					<img src='http://graph.facebook.com/joseph.e.donlan/picture?type=normal' class='user_avatar' style='max-width:60px;' /><br />
                		        <a href='/support/community-support/users/JoeDonlan'>JoeDonlan</a>
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_4195').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_4195' id='form_comment_on_answer_4195' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
					                <p>You must <a href='/support/login'>login</a> before you can post a comment about this answer.</p>
					        </div></div></div></div>
					</form>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Thank you JoeDonlan !!! It worked perfectly ! Thanks God I found your comment !</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='http://graph.facebook.com/natalia.starikova.77/picture?type=normal' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/NataliaS'>NataliaS</a><br />
									3 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2014-12-28 4:33 pm EST
								</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/email/my-iphone-email-account-stopped-working-suddenly-i-get-the-message-cannot-get-mail-the-mail-server-is-not-responding-i-tried-deleting-and-reconfiguring-the-account-but-still-get-the-same-message-what-is-the-fix&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/email/my-iphone-email-account-stopped-working-suddenly-i-get-the-message-cannot-get-mail-the-mail-server-is-not-responding-i-tried-deleting-and-reconfiguring-the-account-but-still-get-the-same-message-what-is-the-fix'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="66a2a90daf7b4d1674ea49273dcb908c" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
                                ...
                                <h3>Related Articles</h3><a target='_blank' href='http://inmotionhosting.com/support/convert-vcf-to-csv-for-email-contacts'>Convert .vcf to .csv for email contacts</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/change-pop3-account-to-imap-or-imap-to-pop3'>Change POP3 account to IMAP, or IMAP to POP3</a><br/><br />
		</div>
