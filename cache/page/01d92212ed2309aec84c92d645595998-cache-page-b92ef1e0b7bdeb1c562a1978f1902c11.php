<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:64912:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/server-usage/what-should-i-do-if-my-account-uses-excessive-resources" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2011-12-08T19:41:47-08:00" />
  <meta name="keywords" content="excessive resource usage wordpress caching Mysql optimization upgrade" />
  <meta name="author" content="Tim Sisson" />
  <meta name="description" content="Learn some common tips on how to address excessive resource usage." />
  <title>What should I do if my account uses excessive resources? - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/server-usage/what-should-i-do-if-my-account-uses-excessive-resources" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:98c7d901e29e529f7a8abe40e5e76046 -->
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>What should I do if my account uses excessive resources?</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															What should I do if my account uses excessive resources?									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>7,128</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Dec 8, 2011'><span style='color:#606060;'>Published:</span> Dec 8, 2011</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Any time our systems administrators flag your account for excessive resource usage, we try to provide the option to either reduce your resource usage, or upgrade your account to a VPS or Dedicated platform.</p>
<p>In some cases it may not be possible to decrease your usage to levels that are acceptable on a shared hosting platform. Sites that require larger databases or are controlled by server-driven software (like PHP, Python, and Perl) and/or have larger images and files being hosted naturally require more resources in order the function properly. Resources usage intensifies as traffic increases, which is why higher-traffic server-interactive sites tend to outgrow a shared platform more easily than static HTML sites. If your site is generally too resource-intensive for a shared system, an upgrade may be in your best interest.</p>
<p>Keep in mind, we cannot offer programming assistance or support for third-party software, and we cannot provide definitive solutions to decrease your usage. However, when possible we can offer tips and suggestions that have helped other customers in similar situations.</p>
<p>Any site has the potential to be resource intensive, but some software has a greater potential to use more system resources than others. Software we commonly see associated with high resource usage are listed below:</p>
<ul>
<li><strong>WordPress</strong> - <a href="/support/website/wordpress/how-to-optimize-wordpress">How to Optimize WordPress</a> , <a href="http://www.wpbeginner.com/beginners-guide/how-to-install-and-setup-wp-super-cache-for-beginners/">Setting up WordPress Super Cache</a></li>
<li><strong>Joomla/Mambo</strong> - <a href="/support/website/joomla/how-to-optimize-joomla-mambo">How to Optimize Joomla/Mambo</a></li>
<li><strong>Gallery2</strong> - <a href="http://codex.gallery2.org/Gallery2:Performance_Tips">Gallery2 Optimization Tips</a></li>
<li><strong>Vbulletin</strong> - <a href="http://www.vbulletin-faq.com/optimize-vbulletin-server.htm">vBulletin Optimization Tips</a></li>
<li><strong>Magento</strong> - <a href="http://www.magentocommerce.com/blog/comments/performance-is-key-notes-on-magentos-performance">Increasing Magento's Performance</a>&nbsp;Note: the developers of Magento have warned about high resource usage, indicating that it may not be shared-server friendly</li>
</ul>
<h2>Enabling Caching</h2>
<p>Since PHP and MySQL are server-side languages, the server has to compile every PHP page and process every MySQL query. If your site uses PHP or MySQL , caching can reduce your resource usage and improve the performance of your website load times. Caching stores PHP pages as static HTML files, so the next time the page is loaded, the HTML page is loaded instead. If you are using a Content Management System such as WordPress or Drupal, you likely have a caching system in place or can download a third party plugin to help with caching.</p>
<ul>
<li><strong>WordPress</strong> – <a href="http://wordpress.org/extend/plugins/wp-super-cache/">WP Super Cache</a></li>
</ul>
<h2>Optimizing MySQL&nbsp;</h2>
<p>As databases grow they may need to be re-indexed. Indexing databases help speed up how data is retrieved when a query is ran. This reduces how hard the server has to work to get the data. Think of database indexes as a table of contents in a book. The index or table of contents allows the server to go to the specific place where the data is stored without having to “read” the entire database.</p>
<p>The easiest way to accomplish this is by logging into your cPanel &gt; phpMyAdmin and running the 'optimize' or 'repair' commands against your database. Please read our article on <a href="/support/website/databases/how-to-use-phpmyadmin-to-optimize-a-database">How to Use phpMyAdmin to optimize a database</a>.</p>
<h2>Enabling Hotlink Protection</h2>
<p>Hotlinking is more common with sites that serve a lot of images, such as gallery sites. Hotlinking is a term that describes when another site directly links to images on your site, and is generally frowned upon and described as "bandwidth stealing." You can enable hotlink protection in your cPanel, but be sure to include your addon/parked/sub-domains in the 'allow' list so that all your sites function properly. Please see our article on <a href="/support/website/cpanel/how-do-i-enable-hotlink-protection-in-my-control-panel-cpanel">Enabling Hotlink Protection</a> for more information.</p>
<h2>Using a Robots.txt File</h2>
<p>Search engines and robots can account for a large percentage of a site's traffic, and most of this traffic can be unnecessary so reducing it can save a lot of resources on the server. You don't want to eliminate search engines altogether, but you should restrict them from being able to access directories that don't contain content you need indexes, and you should block unfamiliar bots and spiders that are frequenting your site. You can identify the spiders and bots crawling your site by looking at your AWstats, and restrict their activity using a robots.txt file. Also, they may be crawling youor website too quickly. You can use Webmaster Tools to set a crawl delay to help in this case. Please see our article on <a href="/support/website/how-to/how-to-stop-search-engines-from-crawling-your-website">how to block search engines from crawling my site</a> and our article on <a href="/support/website/google-tools/setting-a-crawl-delay-in-google-webmaster-tools">how to set a crawl delay using Webmaster Tools</a>.</p>
<h2>Upgrading your hosting plan</h2>
<p>If your website is using a large amount of system resource it isn’t always an issue with the site or coding. It’s not uncommon for popular websites to start out on a shared hosting platform and eventually outgrow it.</p>
<p>If this is the case, typically our systems administrator’s will notify you of the plan you’ll need to upgrade to that will provide minimum platform requirements to meet your site’s resource usage. For more information please see our article on<a href="/support/website/general-server-setup/upgrade-downgrade-hosting-plan"> upgrading your hosting package in AMP</a>.</p>
<p>In most cases when you choose to upgrade we will handle moving your account over to the VPS or Dedicated server, and most moves do not result in downtime for your site(s).</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/server-usage/what-should-i-do-if-my-account-uses-excessive-resources&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/server-usage/what-should-i-do-if-my-account-uses-excessive-resources'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD04NSZpZD0zMzImdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="098d10e673c4294e28b26608ea7be0bd" value="1" />	</div>
	</form>
<!-- <br />
