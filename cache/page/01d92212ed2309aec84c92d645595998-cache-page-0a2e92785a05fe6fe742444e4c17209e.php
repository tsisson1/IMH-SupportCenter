...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/databases/link-a-search-button-to-an-sql-query" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, Thanks for the question. It will require adding code to your site. If you have the query finished in MySQL, then you can use PHP to get the query..." />
  <title>Link a search button to an SQL query | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/databases/link-a-search-button-to-an-sql-query" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:de1c0425587a21bba058124afe6ec47a -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Link a search button to an SQL query</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2014-08-21 6:15 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>126</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>How do I link a search button on a webpage to a query/search in mysql. I want a customer to input a product that he searching for and the location of the product and press search and a list of suppliers must be listed on the search page.</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_5491' id='upvote_answer_5491' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='5491' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_5491').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_5491' id='downvote_answer_5491' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='5491' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_5491').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
Thanks for the question.  It will require adding code to your site.  If you have the query finished in MySQL, then you can use PHP to get the query to show up on your website page.  We do not provide a tutorial for this as it does require some knowledge on how to program.  However, you can find information on how to do that by going to <a href="http://www.w3schools.com/php/php_mysql_insert.asp" rel="nofollow" target="_blank">Insert PHP MySQL on your website</a>.  <br />
<br />
I hope that helps to provide the information that you require.<br />
<br />
Regards,<br />
Arnel C.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_5491').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_5491' id='form_comment_on_answer_5491' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/databases/link-a-search-button-to-an-sql-query&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/databases/link-a-search-button-to-an-sql-query'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="5f76f9df532e1fc3f9378b77c13262dd" value="1" />	</div>
	</form>
<!-- <br />
