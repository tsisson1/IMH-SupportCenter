<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:61131:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/prestashop-15/increase-store-performance/enabling-ccc" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-11-20T18:05:58-08:00" />
  <meta name="keywords" content="improve performance CCC PrestaShop 1.5" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="This PrestaShop 1.5 article demonstrates how to improve performance with the CCC section." />
  <title>Increasing performance with CCC in PrestaShop 1.5 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/prestashop-15/increase-store-performance/enabling-ccc" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:ceec39bd081b4498418649383514a16c -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Increasing performance with CCC in PrestaShop 1.5									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>3,811</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Nov 20, 2012'><span style='color:#606060;'>Published:</span> Nov 20, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In addition to the Smarty caching, our next step for improving performance is to enable the CCC (Combine, Compress, and Cach) feature. This tackles several settings designed to improve the load time of your shop's theme pages.</p>
<p><strong>Enabling CCC (Combine, Compress, and Cache) for performance in PrestaShop 1.5</strong></p>
<ol class="article_list">
<li><a href="/support/edu/prestashop-15/getting-started/login-to-dashboard"> Log into your PrestaShop 1.5 dashboard</a>.</li>
<li>Using the top menu bar, hover over the <strong>Advanced Preferences</strong> tab and select the <strong>Performance</strong> option.</li>
<li>From this page, find the <em>CCC (Combine, Compress and Cache)</em>section, located about halfway down the page. There are several fields to consider in this section.
<table class="article_table"></table>
<table class="article_table">
<tbody>
<tr><th>Smart Cache for CSS</th>
<td>select <strong>Use CCC for CSS</strong></td>
</tr>
<tr><th>Smart Cache for JavaScript</th>
<td>select<strong> Use CCC for Javascript</strong></td>
</tr>
<tr><th>Minify HTML</th>
<td>select <strong>Minify HTML after "smarty compile" execution</strong></td>
</tr>
<tr><th>Compress inline JavaScript in HTML</th>
<td>select <strong>Compress inline JavaScript in HTML after "smarty compile" execution</strong></td>
</tr>
<tr><th>High risk HTML Compression</th>
<td>select <strong>Keep W3C validation<br /></strong></td>
</tr>
<tr><th>Apache Optimization</th>
<td>select the green checkmark</td>
</tr>
</tbody>
</table>
<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Advanced_Paramaters/improve-performance/ccc/configure_ccc2.png"><img  alt="configure ccc2" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Advanced_Paramaters/improve-performance/ccc/configure_ccc2.png" /></a></li>
<li>Once you have selected your settings, select the green <strong>Save</strong> button located in the upper right corner of the screen to save the configuration.</li>
</ol>
<p>Please check the next article on <a href="/support/edu/prestashop-15/advanced-parameters/setting-ciphering">setting the ciphering settings</a>. If you missed our previous article on <a href="/support/edu/prestashop-15/increase-store-performance/enable-smarty-caching">enabling caching for Smarty</a>, please see the tutorial. For more information on this course please visit <a href="/support/edu/prestashop-15/increase-store-performance">Increasing Store Performance in PrestaShop 1.5</a>.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/prestashop-15/increase-store-performance'>217: Increasing Store Performance in PrestaShop 1.5</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 2: Increasing performance with CCC in PrestaShop 1.5</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 1: <a href='/support/edu/prestashop-15/increase-store-performance/enable-smarty-caching'>How to enable caching in the Smarty template engine in PrestaShop 1.5</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 3: <a href='/support/edu/prestashop-15/increase-store-performance/cipher-performance'>Setting Ciphering for improved performance in PrestaShop 1.5</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/prestashop-15/increase-store-performance/enabling-ccc&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/prestashop-15/increase-store-performance/enabling-ccc'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yOTUmaWQ9MjAwMiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="a04015054c0ba3bb7431bf9266907303" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/prestashop-15/increase-store-performance?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Increasing Store Performance in PrestaShop 1.5</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/prestashop-15/increase-store-performance/enable-smarty-caching?tsrc=rsbedu'>How to enable caching in the Smarty template engine in PrestaShop 1.5</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/prestashop-15/increase-store-performance/enabling-ccc?tsrc=rsbedu'>Increasing performance with CCC in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/prestashop-15/increase-store-performance/cipher-performance?tsrc=rsbedu'>Setting Ciphering for improved performance in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/prestashop-15/increase-store-performance/move-images?tsrc=rsbedu'>How to increase performance by moving images in PrestaShop 1.5</a></td>
                </tr>
          <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/prestashop-15/increase-store-performance/editing-caching?tsrc=rsbedu'>Adjusting the caching setting for performance in PrestaShop 1.5 </a></td>
                </tr>
          <tr >
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/prestashop-15/increase-store-performance/enable-caching?tsrc=rsbedu'>How to enable caching in PrestaShop 1.5</a></td>
                </tr>
          	</table>
