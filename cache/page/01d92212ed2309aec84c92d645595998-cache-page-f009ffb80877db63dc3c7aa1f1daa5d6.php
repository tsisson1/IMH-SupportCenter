<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:64336:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/wordpress/how-to-manually-install-wordpress" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-04-21T23:35:55-07:00" />
  <meta name="keywords" content="wordpress manual installation VPS dedicated 5 minute install" />
  <meta name="author" content="Tim Sisson" />
  <meta name="description" content="In this tutorial, we'll walk you through the manual installation process for WordPress." />
  <title>How to manually install WordPress - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/wordpress/how-to-manually-install-wordpress" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:d8b1298456d49805e48c6a7e8867abc0 -->
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to manually install WordPress</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to manually install WordPress									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>12,283</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Mar 6, 2012'><span style='color:#606060;'>Published:</span> Apr 21, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<p>The easiest method to <a href="/support/edu/wordpress/wordpress-introduction/install-wordpress">install WordPress is through Fantastico</a>. Fantastico is included for free with all shared hosting pacakages. If you are a VPS or Dedicated customer you can <a href="/support/website/how-to/how-to-request-a-fantastico-license-in-amp">request to purchase a Fantastico license</a> or follow the steps below to install WordPress manually.</p>
<p>The installation process includes downloading the WordPress files, creating a database, and configuring the installation. In this tutorial, we'll walk you through each of these steps.&nbsp;</p>
<h2>Uploading the WordPress files</h2>
<ol class="article_list">
<li>First, you'll have to <a href="http://wordpress.org/download/">download the lastest version of WordPress</a></li>
<li>Extract the files in the ZIP file you downloaded to your local computer</li>
<li>Use an <a href="/support/website/file-management/getting-started-guide-ftp">FTP Program to upload the files</a> to your account. If this is your primary domain, you'll want to upload the files to the <strong>public_html folder</strong>. Be sure to upload the contents of the wordpress folder and<strong> NOT</strong> the folder itself</li>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/WP/wp_manual_1.jpg"><img  alt="wp_manual_1" src="//cdn.inmotionhosting.com/support/images/stories/WP/wp_manual_1.jpg" /></a></p>
</ol>
...
<li>Click on the <strong>Database Wizard</strong></li>
<li>Type in the <strong>database name</strong> and click "<strong>next step</strong>"</li>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/WP/wp_manual_2.jpg"><img  alt="wp_manual_2" src="//cdn.inmotionhosting.com/support/images/stories/WP/wp_manual_2.jpg" /></a></p>
<li>Fill in the <strong>database user, password, and password (again)</strong></li>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/WP/wp_manual_3.jpg"><img  alt="wp_manual_3" src="//cdn.inmotionhosting.com/support/images/stories/WP/wp_manual_3.jpg" /></a></p>
<li>Click <strong>create user</strong></li>
<li>Check the box "<strong>ALL PRIVILEGES</strong>" and click "<strong>Next Step</strong>"</li>
<li>Write down the <strong>Database name, Database User, and Database password</strong></li>
</ol>
<h2>Finishing WordPress Installation</h2>
<ol class="article_list">
<li>Go to example.com (replacing example.com with your actual domain)</li>
<li>Click "<strong>Create a Configuration File</strong>" and then click "<strong>Let's Go</strong>!"</li>
<li>Fill in the<strong> Database Name, User Name, and Password that you wrote down from above</strong></li>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/WP/wp_manual_4.jpg"><img  alt="wp_manual_4" src="//cdn.inmotionhosting.com/support/images/stories/WP/wp_manual_4.jpg" /></a></p>
  <p><em>NOTE: As per the screen shot above, the <b>Database Host</b> is set to "localhost" by default.  If this is not set as the database host, then type it in as you see it in the screen shot. The database host name will only be different if you are connecting to a database that is not on the hosting server.  By default all InMotion Hosting databases will be coming from the local server.</em></p>
<li>Click "<strong>Submit</strong>"</li>
<li>Fill in the <strong>Site Title, Username, Password, twice, and your email</strong></li>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/WP/wp_manual_5.jpg"><img  alt="wp_manual_5" src="//cdn.inmotionhosting.com/support/images/stories/WP/wp_manual_5.jpg" /></a></p>
<li>Click "<strong>Install WordPress</strong>"</li>
</ol>
<p>Now, when you visit your website, you'll see the default installation of WordPress:</p>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/WP/wp_manual_6.jpg"><img  alt="wp_manual_6" src="//cdn.inmotionhosting.com/support/images/stories/WP/wp_manual_6.jpg" /></a></p>
<p>If you need further assistance please feel free <a href="/support/community-support">ask a question on the support center</a>.</p>
<h2>Hosting with a VPS</h2>
<p>When it comes to hosting Wordpress, a <a href="/wordpress-hosting.html">shared hosting account</a> can keep you covered. But if you are thinking about upgrading to a VPS, then <a href="http://www.inmotionhosting.com/vps_hosting/articles/buy-a-vps.html">click here</a> to read about our VPS's.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/wordpress/how-to-manually-install-wordpress&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/wordpress/how-to-manually-install-wordpress'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD02MyZpZD0zODQmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/wordpress/wordpress-install-unable-to-connect?tsrc=rsbraq'>Wordpress installation unable to connect to database</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/getting-started-guides/do-you-have-to-use-softaculous-to-install-wordpress?tsrc=rsbraq'>Do you have to use softaculous to install wordpress?</a>
                                </div>
