<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:62653:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/dokuwiki/writing-content-dokuwiki/internal-external-links-doku" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-01-08T20:16:52-08:00" />
  <meta name="keywords" content="Creating internal External links DokuWiki site navigation linking make create link Doku wiki" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="Creating internal and External links in DokuWiki are important for site navigation. This article will explain how to make an internal and external link in DokuWiki." />
  <title>Inserting internal and external links in DokuWiki - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/dokuwiki/writing-content-dokuwiki/internal-external-links-doku" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:82adc298c9dc47f85d3f04a01fcee1d3 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '165.4.7.100']);
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/dokuwiki' itemprop='url'><span itemprop='title'>Dokuwiki<span></a><div class='dropdown_4columns'><h2>Dokuwiki Education Channel</h2><div class='col_2'><h3>100 Level Classes</h3><div><a href='/support/edu/dokuwiki/geting-started-dokuwiki'>101: Getting Started with Dokuwiki</a></div><div><a href='/support/edu/dokuwiki/writing-content-dokuwiki'>102: Writing content for DokuWiki</a></div><div><a href='/support/edu/dokuwiki/change-dokuwiki-appearance'>103: Changing the DokuWiki Appearance</a></div><div><a href='/support/edu/dokuwiki/add-contact-form-dokuwiki'>104: Adding a contact form in DokuWiki</a></div><div><a href='/support/edu/dokuwiki/install-configure-plugins-doku'>105: Installing and Configuring plugins in DokuWiki</a></div></div><div class='col_2'><h3>200 Level Classes</h3><div><a href='/support/edu/dokuwiki/working-with-menus'>201: Working with menus in DokuWiki</a></div><div><a href='/support/edu/dokuwiki/change-language-doku-wiki'>202: Changing the language in DokuWiki</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/dokuwiki/writing-content-dokuwiki' itemprop='url'><span itemprop='title'>102: Writing content for DokuWiki<span></a><div class='dropdown_3columns'><h2> Writing content for DokuWiki</h2><div class='col_3'><div>1. <a style='display:inline;' href='/support/edu/dokuwiki/writing-content-dokuwiki/edit-create-delete-restore-dokuwiki'>How to create pages in DokuWiki</a></div><div>2. <a style='display:inline;' href='/support/edu/dokuwiki/writing-content-dokuwiki/create-namespace-doku'>How to create namespaces in DokuWiki</a></div><div>3. <a style='display:inline;' href='/support/edu/dokuwiki/writing-content-dokuwiki/edit-delete-restore-pages'>How to edit and delete DokuWiki pages</a></div><div>4. <a style='display:inline;' href='/support/edu/dokuwiki/writing-content-dokuwiki/delete-rename-namespaces-doku'>How to delete and rename namespaces in DokuWiki</a></div><div>5. <a style='display:inline;' href='/support/edu/dokuwiki/writing-content-dokuwiki/redirect-page-doku'>Redirecting pages in DokuWiki</a></div><div>6. <a style='display:inline;' href='/support/edu/dokuwiki/writing-content-dokuwiki/format-doku-content'>How to format content in DokuWiki</a></div><div>7. <a style='display:inline;' href='/support/edu/dokuwiki/writing-content-dokuwiki/internal-external-links-doku'>Inserting internal and external links in DokuWiki</a></div><div>8. <a style='display:inline;' href='/support/edu/dokuwiki/writing-content-dokuwiki/inserting-images-doku'>How to insert images into a DokuWIki page</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Inserting internal and external ...</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Inserting internal and external links in DokuWiki									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>4,961</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 7, 2013'><span style='color:#606060;'>Published:</span> Jan 8, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Due to the nature of DokuWiki code, inserting a link that navigates internally and externally is done differently than other programs. Where most sites allow standard HTML code to be inserted, DokuWiki has its special code to create navigation.</p>
<p>There are 2 types of links, internal and external links. Internal links link to a page within your wiki site for navigation. An external link is for linking to another website that is not a part of your wiki. These are usually for reference on an information source. This article will explain the steps on inserting a link that links to an existing page in DokuWiki and the steps for inserting an external link.</p>
<h2>How to create an internal link</h2>
<p>An internal link is a link that tkes you to a page on your own DokuWiki site. This is for linking to other articles within your wiki. This section swill explain how to insert an internal link.</p>
<ol class="article_list">
<li><a href="/support/edu/dokuwiki/geting-started-dokuwiki/login-dokuwiki" title="Click for more information" target="_blank"><strong>Log into DokuWiki</strong></a>.
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/inset-internal-external-links/linking-to-pages-1-get-url.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="Get url from address bar DokuWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/inset-internal-external-links/linking-to-pages-1-get-url.gif" title="Click here to view the larger image" width="100" /></a>Before we insert the link, we will show you what DokuWiki uses when linking to internal pages.</p>
<p>Go to the page you want to link to. The last part of the url in the address bar is what you use to link to another page. In this case, <strong>http://dokuwiki.yourwebsite.com/doku.php?id=helping_community</strong>, The last part is as follows:</p>
<p style="margin-left: 20px;"><strong>helping_community</strong></p>
<br style="clear: both;" /></li>
<li>Now, <strong>Go to the page</strong> you want to inset the link into. <strong>Click "<em>Edit this page</em>"</strong> to the right. <br style="clear: both;" /></li>
<li><strong>Highlight the text</strong> you want to make an internal link out of and <strong>click the Insert internal&nbsp;<img alt="DokuWiki internal link icon" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/inset-internal-external-links/internal-link.gif" height="20" width="27" /></strong> link<strong> </strong>icon in the WYSIWYG editor. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/inset-internal-external-links/linking-to-pages-2-link-wizard.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Select teh lonk Wizard DokuWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/inset-internal-external-links/linking-to-pages-2-link-wizard.gif" title="Click here to view the larger image" width="100" /></a><strong>Select the page</strong> you want to link to within your wiki. You should see the page in the list of pages within your DokuWiki site.<br style="clear: both;" />
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/inset-internal-external-links/linking-to-pages-3-internal-wiki-code.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Code for the internal Wiki code" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/inset-internal-external-links/linking-to-pages-3-internal-wiki-code.gif" title="Click here to view the larger image" width="100" /></a>Now the code for the link will be inserted into the page. You will see that the part of the url for the page is the first part and the second part is the Text the link is for. In this case you will see the following:</p>
<p style="margin-left: 20px;">[[helping_community|Helping Each other]]</p>
<br style="clear: both;" />
<p>&nbsp;</p>
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/inset-internal-external-links/linking-to-pages-4-internal-preview.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Preview of internal link DokuWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/inset-internal-external-links/linking-to-pages-4-internal-preview.gif" title="Click here to view the larger image" width="100" /></a>When done, <strong>save the changes</strong> and the link will look like the snapshot to the right. <br style="clear: both;" /></li>
</ol>
<h2>How to create an external link</h2>
<p>An external link is whused when you need to link to another wbsite page that is not a part of your DokuWiki site. The foillowing steps will explain how to insert an external link.</p>
<ol class="article_list">
<li><a href="/support/edu/dokuwiki/geting-started-dokuwiki/login-dokuwiki" title="Click for more information" target="_blank"><strong>Log into DokuWiki</strong></a>.</li>
<li><strong>Navigate to the page </strong>you want to create an external link for and <strong>click "<em>Edit this page</em>"</strong> to the right.</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/inset-internal-external-links/linking-to-pages-5-highlight-text.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Highlght the text to link DokuWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/inset-internal-external-links/linking-to-pages-5-highlight-text.gif" title="Click here to view the larger image" width="100" /></a><strong>Insert the text</strong> for the link you are creating and <strong>click the External Link <img alt="DokuWiki external link icon" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/inset-internal-external-links/external-link.gif" height="21" width="27" /></strong> button in the WYSIWYG editor.. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/inset-internal-external-links/linking-to-pages-6-external-link.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Create the external link DokuWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/inset-internal-external-links/linking-to-pages-6-external-link.gif" title="Click here to view the larger image" width="100" /></a>The code for an external link will look like the following.
<p style="margin-left: 20px;">[[http://dogs.com]]</p>
<br style="clear: both;" />
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/inset-internal-external-links/linking-to-pages-7-functional-link.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Preview of the External Link Dokuwiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/inset-internal-external-links/linking-to-pages-7-functional-link.gif" title="Click here to view the larger image" width="100" /></a><strong>Save the page</strong> and you should see the link display like the snapshot to the right. <br style="clear: both;" /></p>
</li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/dokuwiki/writing-content-dokuwiki'>102: Writing content for DokuWiki</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 7: Inserting internal and external links in DokuWiki</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 6: <a href='/support/edu/dokuwiki/writing-content-dokuwiki/format-doku-content'>How to format content in DokuWiki</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 8: <a href='/support/edu/dokuwiki/writing-content-dokuwiki/inserting-images-doku'>How to insert images into a DokuWIki page</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/dokuwiki/writing-content-dokuwiki/internal-external-links-doku&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/dokuwiki/writing-content-dokuwiki/internal-external-links-doku'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMTkmaWQ9MjE0OCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/dokuwiki/writing-content-dokuwiki?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Writing content for DokuWiki</h3></a>
		<table><tr><td colspan='2'><h4>Pages and Namespaces</h4></td></tr>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/dokuwiki/writing-content-dokuwiki/edit-create-delete-restore-dokuwiki?tsrc=rsbedu'>How to create pages in DokuWiki</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/dokuwiki/writing-content-dokuwiki/create-namespace-doku?tsrc=rsbedu'>How to create namespaces in DokuWiki</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/dokuwiki/writing-content-dokuwiki/edit-delete-restore-pages?tsrc=rsbedu'>How to edit and delete DokuWiki pages</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/dokuwiki/writing-content-dokuwiki/delete-rename-namespaces-doku?tsrc=rsbedu'>How to delete and rename namespaces in DokuWiki</a></td>
                </tr>
          <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/dokuwiki/writing-content-dokuwiki/redirect-page-doku?tsrc=rsbedu'>Redirecting pages in DokuWiki</a></td>
                </tr>
        <tr><td colspan='2'><h4>Editing content</h4></td></tr>  <tr >
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/dokuwiki/writing-content-dokuwiki/format-doku-content?tsrc=rsbedu'>How to format content in DokuWiki</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>7.</td>
                        <td><a href='/support/edu/dokuwiki/writing-content-dokuwiki/internal-external-links-doku?tsrc=rsbedu'>Inserting internal and external links in DokuWiki</a></td>
                </tr>
          <tr >
                        <td valign='top'>8.</td>
                        <td><a href='/support/edu/dokuwiki/writing-content-dokuwiki/inserting-images-doku?tsrc=rsbedu'>How to insert images into a DokuWIki page</a></td>
                </tr>
          	</table>
