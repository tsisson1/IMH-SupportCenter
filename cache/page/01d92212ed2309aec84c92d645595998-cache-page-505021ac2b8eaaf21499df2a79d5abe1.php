<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:53887:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/website-troubleshooting/is-there-a-problem-with-my-server" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, and thanks for your questions. Unfortunately as I don't have a way to determine what server you're hosted on with this question being submitted a..." />
  <title>Is there a problem with my server? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/website-troubleshooting/is-there-a-problem-with-my-server" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:483aca46c97a072862a02b4b97da0cc3 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Is there a problem with my server?</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-10-04 1:37 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>280</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Ok ok, so after lots of testing... here's what I got:<br />
<br />
1. my domain name is registered<br />
2. it is pointing to your servers, and dns has not been updated in 6 months<br />
3. the connection between my computer and your server is lightning fast<br />
<br />
My website runs off of php, and it runs off of mysql. I'm on a shared server.<br />
<br />
MY QUESTIONS ARE:<br />
1. How can I tell if php is running on my server?<br />
2. How can I tell if MySQL is running on my server?<br />
3. Is there like a, &quot;server health&quot; page or something on the server that I can visit to ensure everything is AOK?<br />
<br />
thank you thank you thank you thank you!</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_4069' id='upvote_answer_4069' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='4069' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_4069').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_4069' id='downvote_answer_4069' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='4069' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_4069').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>9,968 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2013-10-04 4:15 pm EST
                		        </div>
					
		                </div>

				Hello, and thanks for your questions.<br />
<br />
Unfortunately as I don't have a way to determine what server you're hosted on with this question being submitted anonymously, I can't provide a direct answer to if there are any problems on it.<br />
<br />
&lt;h2&gt;How to tell if PHP us running on server&lt;/h2&gt;<br />
<br />
If you're on a shared server and are curious if PHP is working, the easiest way to test this is to simply create a small PHP script and try to access it. For instance the following &lt;strong&gt;test.php&lt;/strong&gt; code would work fine:<br />
<br />
&lt;pre class=&quot;code_block&quot; style=&quot;width: 500px; white-space: normal; margin-bottom: -30px;&quot;&gt;&amp;lt;?php<br />
echo &quot;test&quot;;<br />
?&amp;gt;&lt;/pre&gt;<br />
<br />
&lt;h2&gt;How to tell if MySQL is running on server&lt;/h2&gt;<br />
<br />
To tell if MySQL is also running, you could connect to MySQL from a simple PHP script like:<br />
<br />
&lt;pre class=&quot;code_block&quot; style=&quot;width: 500px; white-space: normal; margin-bottom: -30px;&quot;&gt;&amp;lt;?php<br />
<br />
$hostname = &quot;localhost&quot;;<br />
$db_Name = &quot;userna5_db&quot;;<br />
$db_User = &quot;userna5_user&quot;;<br />
$db_Pass = &quot;g00dpaSS&quot;;<br />
<br />
//Connect to MySQL<br />
$con = mysql_connect($hostname, $db_User, $db_Pass);<br />
<br />
// Display error if connection to MySQL server fails<br />
if (!$con){<br />
        die('MySQL server error: ' . mysql_error());<br />
}<br />
<br />
//Select database<br />
$selectDB = mysql_select_db($db_Name, $con);<br />
<br />
// Display error if selecting the database fails<br />
if (!$selectDB){<br />
        die('MySQL database error: ' . mysql_error());<br />
}<br />
<br />
?&amp;gt;<br />
&lt;/pre&gt;<br />
<br />
&lt;h2&gt;Viewing the server health&lt;/h2&gt;<br />
<br />
Unfortunately on a shared server there isn't a server health dashboard that you can view. You could &lt;a href=&quot;http://www.inmotionhosting.com/support/edu/cpanel/301-run-cron-job&quot; target=&quot;_blank&quot;&gt;run a cron job&lt;/a&gt; which is just a scheduled task to query the server once a day if you were curious about historical usage.<br />
<br />
For instance if you created this file called &lt;strong&gt;LOAD_CHECK&lt;/strong&gt; in your home directory &lt;strong&gt;/home/userna5/&lt;/strong&gt;:<br />
<br />
&lt;pre class=&quot;code_block&quot; style=&quot;width: 575px; white-space: normal; margin-bottom: -30px;&quot;&gt;#!/bin/bash<br />
// Get number of processors on server<br />
CPU_COUNT=$(grep processor /proc/cpuinfo -c)<br />
<br />
// Log the date, and times server has spiked over the number of processors<br />
date &gt; ~/LOAD_LOG<br />
sar -q | awk -v CPUs=$CPU_COUNT '{ if ($5&gt;=CPUs) print $0}' &gt;&gt; ~/LOAD_LOG&lt;/pre&gt;<br />
<br />
You could then create a cronjob to call that script once everyday at 11:45PM which would look like this:<br />
<br />
&lt;pre class=&quot;code_block&quot; style=&quot;width: 500px; white-space: normal; margin-bottom: -30px;&quot;&gt;45	23	*	*	*	bash /home/userna5/LOAD_CHECK&lt;/pre&gt; <br />
<br />
Then what that script does is create a &lt;strong&gt;LOAD_LOG&lt;/strong&gt; file in your home directory. Which the output would look something like:<br />
<br />
&lt;pre class=&quot;code_block&quot; style=&quot;width: 500px; white-space: normal; margin-bottom: -30px;&quot;&gt;Fri Oct  4 16:13:01 EDT 2013<br />
00:00:01      runq-sz  plist-sz   ldavg-1   ldavg-5  ldavg-15<br />
11:46:01           10      4418     25.53     18.13     13.31<br />
11:48:01           12      4444     16.26     16.64     13.32&lt;/pre&gt;<br />
<br />
In this case, it would show that there were 2 minutes today in which the server had spiked over its optimal load of &lt;strong&gt;16&lt;/strong&gt; based on how many processors the server has. If you saw a whole lot of these types of entries, than that could indicate problems on the server during those time periods.<br />
<br />
I hope that information was helpful, if you had any further questions at all please let us know.<br />
<br />
- Jacob<br />
<br />
 <br />
<br />
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_4069').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_4069' id='form_comment_on_answer_4069' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/website-troubleshooting/is-there-a-problem-with-my-server&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/website-troubleshooting/is-there-a-problem-with-my-server'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="2711e5869621ce4a43701836df3f69fa" value="1" />	</div>
	</form>
<!-- <br />
