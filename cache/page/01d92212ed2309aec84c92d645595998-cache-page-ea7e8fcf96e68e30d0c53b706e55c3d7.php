<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:87798:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/ssh/speed-up-grep-searches-with-lc-all" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-03-19T23:25:00-07:00" />
  <meta name="keywords" content="speed up fast faster quick quicker grep search LC_ALL LC_ALL=C utf8" />
  <meta name="author" content="Jacob Nicholson" />
  <meta name="description" content="Ever try to run a grep search on a large file, and wish there was a way to speed things up? Using the LC_ALL=C variable you can do just that!" />
  <title>Speed up grep searches with LC_ALL=C - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/ssh/speed-up-grep-searches-with-lc-all" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<script type="text/javascript">
		...
		_gaq.push(['_setCustomVar', 4, 'DateMonthPublished', '2013-08', 3]);
	...
	<!-- cid:bc066d08ea001565672fa118ec97469a -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-22']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '137.224.252.10']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Speed up grep searches with LC_ALL=C</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Speed up grep searches with LC_ALL=C									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>17,230</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Aug 23, 2013'><span style='color:#606060;'>Published:</span> Mar 19, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<div style="width: 41%; float: left;"><p>Ever try to run a <strong>grep</strong> search on a large file, and wish there was a way to speed things up?</p>
  
  <p>After some late night Googling, I ran across a proposed method of significantly speeding up a <strong>grep</strong> search from <a href="http://stackoverflow.com/users/7412/dogbane" target="_blank" rel="nofollow">dogbane</a> over on <a href="http://stackoverflow.com/questions/13913014/grepping-a-huge-file-80gb-any-way-to-speed-it-up#13913220" target="_blank" rel="nofollow">StackOverflow</a>.</p>
  
<p>I went ahead and dug deeper with research and even setup a little test to try things out and understand what's going on.</p>
            
<p>As someone that's used <strong>grep</strong> for nearly a decade, I'm a bit embarassed to say I'd never heard of this.</p>

<p>If you care to skip over my extensive research on this and are just curious in the actual <a href="#results">testing results</a>, I won't get offended, much.</p>
  
</div>

<div style="width: 58%; float: right; padding-top: 40px;">
 <img src="//cdn.inmotionhosting.com/support/images/stories/website/how-to/speed-up-grep/speed-up-your-grep-search.png" alt="speed up grep search" />
</div>
<div style="clear:both;"></div>
<a name="locale"></a>
<h2>Locale and internationalisation variables</h2>            
            
<p>In a shell execution environment, you alter the environment behaviour with variables.</p>

<p>There is a special sub-set of internationalisation variables that deal with how support for internationalised applications behave, with <strong>grep</strong> being one of these applications.</p>

<p>You can easily view your server's current locale setting by running:</p>

<pre class="code_block" style="width: 350px; margin-bottom: 15px;">
root@server [~] <strong style="color:red;">locale</strong>
LANG=en_US.UTF-8
...
<h2>LC_ALL variable</h2>

<p>One variable you can adjust is called <strong>LC_ALL</strong>. This sets all <strong>LC_</strong> type variables at once to a specified locale.</p>

<p>If we simply append <strong>LC_ALL=C</strong> before our command. We change the locale used by the command.</p>

<p>When using the locale <strong>C</strong> it will default to the server's base Unix/Linux language of <strong>ASCII</strong>.</p>
    
<pre class="code_block" style="width: 350px; margin-bottom: 15px;">
root@server [~] <strong style="color:red;">LC_ALL=C locale</strong>
LANG=en_US.UTF-8
LC_CTYPE="C"
LC_NUMERIC="C"
LC_TIME="C"
...
<h2>UTF8 vs ASCII</h2>
<p>This all might not make a whole lot of sense yet, but hang with me.</p>
<p>Basically when you <strong>grep</strong> something, by default your locale is going to be internationalised and set to <strong>UTF8</strong>.</p>

<p><strong>UTF8</strong> can represent every character in the Unicode character set to help display any of the world's writing systems, currently over more than <strong>110,000</strong> unique characters.</p>
    
<p>So what's the big deal? Well typically you <strong>grep</strong> through files encoded in <strong>ASCII</strong>. The <strong>ASCII</strong> character set is comprised of a whopping <strong>128</strong> unique characters.</p>

<p>Servers and computers these days can quickly process data thrown at them, but the more efficiently we hand it data, the faster it will be able to accomplish the task and with fewer resources.</p>

<h2>Using strace to see what's going on</h2>
    
<p>I won't get too technical on it in this article, but <strong>strace</strong> is a utility to keep tabs on what a process is up to.</p>

<p>Below I'm displaying a file with 1 line with the <strong>cat</strong> command. The <strong>strace</strong> output is stored in a file called <strong>TRACE</strong>.</p> 
    
<p>Then I call <strong>egrep</strong> to only show mentions of <strong>open</strong> and <strong>read</strong> operations:</p>

<pre class="code_block" style="max-width: 650px; width: 650px; margin-bottom: 15px;">
root@server [~] <strong style="color:red;">strace -o TRACE cat TEST_FILE</strong>
This is a test

root@server [~] <strong style="color:red;">egrep "open|read" TRACE</strong>
...
<p>Now here is the same thing with our little <strong>LC_ALL=C</strong> trick:</p>

<pre class="code_block" style="max-width: 650px; width: 650px; margin-bottom: 15px;">
root@server [~] <strong style="color:red;">LC_ALL=C strace -o TRACE cat TEST_FILE</strong>
This is a test
...
<p>That was <strong>19 opens</strong> and <strong>5 reads</strong> for my first test, and <strong>3 opens</strong> and <strong>3 reads</strong> for the <strong>LC_ALL=C</strong> test.</p>

<p>You can see that in the default test we had to open multiple files in the <strong>/usr/lib/locale/en_US.utf8</strong> directory.</p>

<p>The largest of these locale files is <strong>LC_COLLATE</strong> and <strong>LC_CTYPE</strong>.</p>
            
<p>I threw in a plain <strong>en_US</strong> locale for comparison sake, which is much smaller than the <strong>utf8</strong> version:</p>
    
<pre class="code_block" style="max-width: 650px; width: 650px; margin-bottom: 15px;">
root@server [~] <strong style="color:red;">ls -lahSr /usr/lib/locale/en_US/LC_C* /usr/lib/locale/en_US.utf8/LC_C*</strong>
...
<p>If you're anything like me, I'm sure at some point in your life you've had to recite your ABCs to figure out the alphabetical sorting of something. Imagine having thousands and thousands of letters to keep track of and having to keep starting over, doesn't sound too efficient does it?</p>
    
<p>Now I also bring up an alphabetial sorting example, because it's important to note that you don't want to just go always using <strong>LC_ALL=C</strong> for everything. I won't go in depth here but basically just know that when using the <strong>sort</strong> command it's gonna give you different types of sorting based on the locale.</p>
    
<pre class="code_block" style="width: 300px; margin-bottom: 15px;">
root@server [~] <strong style="color:red;">cat TEST_FILE</strong>
C
B
A
c
...
root@server [~] <strong style="color:red;">sort TEST_FILE</strong>
a
A
b
B
...
root@server [~] <strong style="color:red;">LC_ALL=C sort TEST_FILE</strong>
A
B
C
a
...
<p>Once I understood the basic principles of what was supposed to be happening, I was excited to start testing right away to see just how much of a boost in search speed I could get.</p>

<h2>Avoiding filesystem caching</h2>
            
<p>Now due to the way Linux caches things from the disk into memory, you might have noticed if you <strong>grep</strong> a file, the first time you do it could take 5-10 seconds. But if you do the exact same search a bit later, it's almost instant.</p>
            
<p>That's because the filesystem caches the file into memory which is way faster than your hard drive.</p>

<p>I knew this going into my tests, so I knew I couldn't just run a timed <strong>grep</strong> against my file, and then do it again a few seconds later without severly skewed results due to the system caching.</p>

<p>So what I did was first build up a 5MB or so test file, by running the following command:</p>

<pre class="code_block" style="width: 425px; margin-bottom: 15px;">
grep wp-login.php /usr/local/apache/domlogs/ -R > WP_LOGINS
</pre>
    
<p>So now my <strong>WP_LOGINS</strong> file had about <strong>21,000</strong> lines of attempted <strong>wp-login.php</strong> requests.</p>

<p>I wanted a ton more to really see the impact on large files, so I proceeded to duplicate the contents of my <strong>WP_LOGINS</strong> file 100 times into a new file called <strong>WP_LOGINS2</strong> with this command:</p>

<pre class="code_block" style="width: 425px; margin-bottom: 15px;">
for i in {1..100}; do cat WP_LOGINS >> WP_LOGINS2; done
</pre>
    
<p>Now I've got a <strong>504MB</strong> file with <strong>2,100,000</strong> lines, and that should provide a great testbed, at least for one of the tests. So I also duplicated this file multiple times to again avoid filesystem caching in-between tests.</p>

<a name="results"></a>
<h2>Testing LC_ALL=C grep and fgrep performance</h2>
            
<p>I ran 2 test with the default <strong>grep</strong> command looking for hits of <strong>wp-login.php</strong> and providing a count.</p>
            
<p>I also did 2 with <strong>LC_ALL=C</strong> set first, and 2 using both <strong>LC_ALL=C</strong> and <strong>fgrep</strong> which matches only fixed strings and is even more efficient when doing simple searches like in this case.</p>
    
<p>Here is the series of tests I ran:</p>
...
<p>The results are broken up from the <strong>time</strong> command into 3 values, funny enough the <strong>LC_ALL=C</strong> locale also alters the output from the <strong>time</strong> command, which is why the results are different.</p>
            
<p>Here are the meanings behind these values:</p>            
            
<p><strong>real</strong> - How much wall clock time the test took</p>

<p><strong>user</strong> - CPU seconds consumed in user space</p>

<p><strong>sys</strong> - CPU seconds consumed in system space</p>
            
<p>Now here are the results from the tests:</p>            
...
<tbody>
    <tr>
    <th>&nbsp;</th>
    <th style="padding:0px 15px 0px 5px;">real</th>
    <th style="padding:0px 15px 0px 5px;">user</th>
    <th style="padding:0px 15px 0px 5px;">sys</th>
    </tr>
    <tr>
    <th>grep 1</th>
        <td style="padding:5px;">9.56</td>
        <td style="padding:5px;">9.42</td>
        <td style="padding:5px;">0.13</td>
        
    </tr>
    <tr>
    <th>grep 2</th>
        <td style="padding:5px;">9.45</td>
        <td style="padding:5px;">9.32</td>
        <td style="padding:5px;">0.13</td>
    </tr>
    <tr>
    <th>LC_ALL 1</th>
        <td style="padding:5px;">1.50</td>
        <td style="padding:5px;">1.37</td>
        <td style="padding:5px;">0.13</td>
    </tr>
    <tr>
    <th>LC_ALL 2</th>
        <td style="padding:5px;">1.48</td>
        <td style="padding:5px;">1.37</td>
    ...
    <tr>
    <th>fgrep 1</th>
        <td style="padding:5px;">0.67</td>
        <td style="padding:5px;">0.54</td>
        <td style="padding:5px;">0.12</td>
    </tr>
    <tr>
    <th>fgrep 2</th>
        <td style="padding:5px;">0.66</td>
        <td style="padding:5px;">0.54</td>
        <td style="padding:5px;">0.12</td>
    </tr>
...
<p style="margin-top:15px;">So there you have it, standard <strong>grep</strong> took <strong>9 1/2 seconds</strong>.</p>
            
<p>Using the <strong>LC_ALL=C</strong> locale increased our performance <strong>640%</strong> and brought that time down to <strong>1 1/2 seconds</strong>.</p>            

<p>Using <strong>fgrep</strong> increased our performance <strong>1427%</strong> and brought that time down to just over a <strong>1/2 second</strong>.</p>
            
<p>If you skipped down here and were wondering why things got faster, check out my <a href="#locale">locale research</a> above.</p>            
            
<p>Needless to say, I'll be using this tactic in a ton of scripts and when doing manual <strong>grep</strong> searches going forward. Hopefully this information will help speed along your own searches as well.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/ssh/speed-up-grep-searches-with-lc-all&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/ssh/speed-up-grep-searches-with-lc-all'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MTEmaWQ9MjgxNyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="40c17b5de177534bef2e198cc592f22d" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/a70b738309454fc003206983e505794b?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/a70b738309454fc003206983e505794b'>Noah Spurrier</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-29 5:12 pm</div>
				                <div><p>You could also eliminate the Linux buffer cache from skewing your testing by droppig the caches before each test.</p>
<p>&nbsp; &nbsp;&nbsp;<span style="color: rgb(0, 221, 0); font-size: 13px; line-height: 1.1em; background-color: rgb(0, 0, 0);">echo 3 &gt; /proc/sys/vm/drop_caches</span></p>
<p>&nbsp;</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10978);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-29 5:24 pm</div>
				                <div>Hello Noah, and thanks for the comment!<br />
<br />
You are correct! That is another great way to make sure the pagecache isn't skewing results. However be careful because your system could seem a bit sluggish as it rebuilds back up the pagecache after totally clearing it out.<br />
<br />
Thanks again!<br />
<br />
- Jacob</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10979);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-15011'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/0cfb5b8e1e22b390c5d46d1531f41680?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/0cfb5b8e1e22b390c5d46d1531f41680'>Sridhar</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-12 3:07 pm</div>
				                <div><p>As you wrote, this may not give you what you were expecting:</p>
<p><code>LC_ALL=C sort moop.txt</code></p>
<p>But, this might:</p>
<p><code>LC_ALL=C sort -f moop.txt</code></p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15011);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-16289'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/3ae97d6d60b1bd473ecdd81988318563?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/3ae97d6d60b1bd473ecdd81988318563'>askapache</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-15 8:29 am</div>
				                <div><p>Hey great article Jacob,This does affect more than meets the eye.&nbsp; For instance download a file with UTF-8 characters in it, like many web pages, and then use an strace to see how greps regex is affected:</p>
<pre>$ export LANG=C LC_ALL=C;$ strace -f -q -e trace=write -o TRACE.CC 2&gt;&amp;1 grep -o '.\{1\}' t.htmlWhen in ASCII mode grep will incorrectly count utf-8 characters.write(1, "\342\n", 2)write(1, "\200\n", 2)write(1, "\235\n", 2)vs$ export LANG=en_US.UTF-8 LC_ALL=en_US.UTF-8;$ strace -f -q -e trace=write -o TRACE.8 2&gt;&amp;1 grep -o '.\{1\}' t.htmlWhen in UTF-8 mode grep will correctly count a utf-8 character as 1 character.write(1, "\342\200\235\n", 4)</pre></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16289);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-20906'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/8a17d62f0ddda8938406b40748e3cb23?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/8a17d62f0ddda8938406b40748e3cb23'>MadMan</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-20 1:50 pm</div>
				                <div><p>Tried this on a Centos 5 system with no luck.&nbsp; Is it OS or distro specific?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20906);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-20 3:08 pm</div>
				                <div>Hello MadMan,<br />
<br />
This tutorial was made either on a Centos 5.6 or 6.0 server. This should work. Are you getting any errors?<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20910);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-20 3:23 pm</div>
				                <div><p>No errors, just no improvement in time to run grep commands.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20912);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-21233'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/1ebaf7889b3faaf04f48127ec5ab3539?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/1ebaf7889b3faaf04f48127ec5ab3539'>Great great trick!!</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-02 3:14 pm</div>
				                <div>Thank you for sharing this great finding! This trick made my process go from 1.20 hours to a matter of seconds!
Thanks again for making my life better =)</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21233);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
