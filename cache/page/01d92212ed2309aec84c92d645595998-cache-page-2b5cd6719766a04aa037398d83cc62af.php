<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:70400:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/magento/getting-started-tutorial/how-to-log-into-magento-admin-panel" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-06-27T13:59:48-07:00" />
  <meta name="keywords" content="how to log into magento admin panel administrator backend" />
  <meta name="author" content="Tim Sisson" />
  <meta name="description" content="This Magento tutorial will show you how to log into your Magento Admin Panel for the first time after you've completed the initial installation process." />
  <title>How to log into Magento 1.6 Admin Panel - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/magento/getting-started-tutorial/how-to-log-into-magento-admin-panel" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:78078dd3b4ac83c06cec0de25617ecf9 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '83.170.230.134']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to log into Magento 1.6 Admin Panel									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>78,575</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Mar 21, 2012'><span style='color:#606060;'>Published:</span> Jun 27, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>At this point, you’ve <a href="/support/edu/magento/getting-started-tutorial/how-to-install-magento">installed and configured Magento</a> and you’re ready to log into your Magento 1.6 Admin Panel. The administrator backend is where you’ll perform all of your shopping cart’s administrator functions. Please feel free to look over our other <a href="/support/edu/magento">Magento Tutorials</a> as well.</p>
<p>Some of the most common uses of the Admin backend are:</p>
<ul>
<li>Change the look and feel of Magento</li>
<li>Manage Customers and Customer Groups</li>
<li>Manage Sales</li>
<li>Change initial settings during the installation</li>
<li>Create promotions</li>
<li>Manage Newsletter</li>
<li>View Reports</li>
</ul>
<p>Logging into the admin for your Magento 1.6 website is easy. Where ever you installed Magento, simply <strong>add /admin to the URL</strong>.</p>
<ol class="article_list">
<li>&nbsp;Go to your Magento website. Add <strong>/admin</strong> to the URL and <strong>reload the page</strong></li>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/magento/magento_admin_log_in_1.jpg"><img src="//cdn.inmotionhosting.com/support/images/stories/magento/magento_admin_log_in_1.jpg" alt="magento_admin_log_in_1"  /></a></p>
<li>Type in your <strong>username and password</strong> that you set up during the installation process</li>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/magento/magento_admin_log_in_2.jpg"><img src="//cdn.inmotionhosting.com/support/images/stories/magento/magento_admin_log_in_2.jpg" alt="magento_admin_log_in_2"  /></a></p>
</ol>
<p>You’re now logged into your Magento Admin panel.</p>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/magento/magento_admin_log_in_3.jpg"><img src="//cdn.inmotionhosting.com/support/images/stories/magento/magento_admin_log_in_3.jpg" alt="magento_admin_log_in_3"  /></a></p>
<p>If you need further assistance please feel free to <a href="/support/community-support">ask a question on our support center</a>.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/magento/getting-started-tutorial'>101: Magento 1.6 Installation and Setup Guide</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 2: How to log into Magento 1.6 Admin Panel</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 1: <a href='/support/edu/magento/getting-started-tutorial/how-to-install-magento'>How to Install Magento 1.6</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 3: <a href='/support/edu/magento/getting-started-tutorial/what-version-of-magento-am-i-using'>What Version of Magento am I using?</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/magento/getting-started-tutorial/how-to-log-into-magento-admin-panel&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/magento/getting-started-tutorial/how-to-log-into-magento-admin-panel'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xNjImaWQ9MTIxOCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="072c8cc6f5d7265ed774630284f34f98" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/magento/getting-started-tutorial?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Magento 1.6 Installation and Setup Guide</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/magento/getting-started-tutorial/how-to-install-magento?tsrc=rsbedu'>How to Install Magento 1.6</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/magento/getting-started-tutorial/how-to-log-into-magento-admin-panel?tsrc=rsbedu'>How to log into Magento 1.6 Admin Panel</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/magento/getting-started-tutorial/what-version-of-magento-am-i-using?tsrc=rsbedu'>What Version of Magento am I using?</a></td>
                </tr>
          	</table>
...
<a name='comments'></a>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/01f2618275731c61ba57b7667288ef10?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/01f2618275731c61ba57b7667288ef10'>balaji</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-13 7:04 am</div>
				                <div><p>Thanks it helped me a lot.................</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11497);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-16798'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/29b7ea22705ddb14b727bfbe83118359?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/29b7ea22705ddb14b727bfbe83118359'>Ashish @ MagikCommerce</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-28 3:42 am</div>
				                <div><p>Thanks for sharing this. Please write how to remove /index.php/ from the middle of the admin page URL.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16798);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-28 8:42 am</div>
				                <div>I have located an excellent &lt;a href=&quot;http://stackoverflow.com/questions/10474740/how-to-remove-index-php-from-urls&quot;&gt;answer on StackOverflow&lt;/a&gt; that should get you started with removing index.php from your URLs.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16806);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-21879'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/4d7de9be36d63c044f08e7cabad5aeb6?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/4d7de9be36d63c044f08e7cabad5aeb6'>dheerendra</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-20 1:10 am</div>
				                <div><p>i am using correct user name &amp; pass bt not login.. if i am use wrong pass then show message i.e. invalid username &amp; password... plz give me solution how to solved it.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21879);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-23 1:18 pm</div>
				                <div>Hello dheerendra,<br />
<br />
What kind of behavior are you seeing when  you use the correct name and password? No error message? Is it just staying on the login page? Is there any other type of message or page showing up?<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21950);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-24404'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/6969cce808269bf59690eecaf1c10fbf?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/6969cce808269bf59690eecaf1c10fbf'>Arkadien</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-24 8:37 am</div>
				                <div>Hi, I try to login with the ..../admin , but only my hompage (Home) will open. No Login screen. What can I do to get access to the login screen???

Thx, Udo</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24404);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-24 3:49 pm</div>
				                <div>Hello Arkadien,<br />
<br />
Apparently, there are multiple issues with logging into Magento that have been reported.  Check out these <a href="http://stackoverflow.com/questions/2176195/cant-log-in-to-magento-admin" rel="nofollow" target="_blank">forum responses</a> from Magento users.  Hopefully, these responses will provide the information you need.<br />
<br />
If you have any further questions or comments, please let us know.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24418);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
