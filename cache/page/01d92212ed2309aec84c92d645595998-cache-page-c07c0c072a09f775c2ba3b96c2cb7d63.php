<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:65816:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/prestashop-15/working-with-orders/create-credit-slip" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-09-04T17:05:55-07:00" />
  <meta name="keywords" content="create credit slip return item PrestShop 1.5" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="This PrestaShop 1.5 tutorial will show you how to crate a credit slip for a returned item." />
  <title>Creating a credit slip in PrestaShop 1.5  - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/prestashop-15/working-with-orders/create-credit-slip" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:90847dc4af9ea56aab3f104e0a52af94 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Creating a credit slip in PrestaShop 1.5 									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>3,774</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Aug 31, 2012'><span style='color:#606060;'>Published:</span> Sep 4, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Prestashop 1.5 gives the ability for customers to return items. When this occurs, you will need to add a credit slip to the order. This adds the item back to inventory and credits the money back to the customer. Follow along with the steps below to learn how to make a credit slip in PrestaShop 1.5</p>
<p><strong>How to generate a credit slip in PrestaShop 1.5</strong></p>
...
<li>Using the top menu bar, hover over the <strong>Orders</strong> tab and click on the <strong>Orders</strong> option.</li>
<li>A credit slip can only be issued for a returned product. You must issue the return from within the order itself. In the example below. J. Smith has been issued a refund and has returned his order. Click on the <strong>View</strong> button (paper with magnifying glass over it) to enter the order edit screen.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Orders/Credit_Slips/credit-order.png"><img  alt="credit-order" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Orders/Credit_Slips/credit-order.png" /></a></li>
<li>From this view screen you will see an icon in the upper right group labeled <strong>Return Products</strong>. Click this and the screen will scroll down to the area to return the product and generate the slip. <br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Orders/Credit_Slips/return-products.png"><img  alt="return-products" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Orders/Credit_Slips/return-products.png" /></a></li>
<li>Next, be sure to choose the checkbox for the item or items that are  being returned.  There are three optional checkboxes below the items.  Check the one labeled <strong>Generate a Credit Slip</strong>. Click the <strong>Return Products </strong>button and the return will be issued and the credit slip created.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Orders/Credit_Slips/return-products2.png"><img  alt="return-products2" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Orders/Credit_Slips/return-products2.png" /></a></li>
<li>You can now view the credit slip by hovering over the <strong>Orders</strong> tab and click on the <strong>Credit Slips</strong> option. This takes you to the <em>Credit Slips</em> list page. If you wish to print the slips as a pdf report, choose the date range you wish to have reported and click on the <strong>Generate PDF File</strong> button. This will generate a pdf of the credit slips issued which may be printed out for your records.     <br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Orders/Credit_Slips/credit-slip-list.png"><img  alt="credit-slip-list" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Orders/Credit_Slips/credit-slip-list.png" /></a><br /> <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Orders/Credit_Slips/credit-slip-pdf.png"><img  alt="credit-slip-pdf" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Orders/Credit_Slips/credit-slip-pdf.png" /></a></li>
<strong> </strong></ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 13: Creating a credit slip in PrestaShop 1.5 </div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 12: <a href='/support/edu/prestashop-15/working-with-orders/delete-status'>Deleting an order status in PrestaShop 1.5 </a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 14: <a href='/support/edu/prestashop-15/working-with-orders/delete-credit-slip'>Deleting a credit slip in PrestaShop 1.5 </a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/prestashop-15/working-with-orders/create-credit-slip&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/prestashop-15/working-with-orders/create-credit-slip'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP3RzcmM9cnNiZWR1Jm9wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNTUmaWQ9MTczOCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="ec3d8c258845ba0ee5eed8f08763acc8" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
        ...
        <tr><td colspan='2'><h4>Credit and Delivery Slips</h4></td></tr>  <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>13.</td>
