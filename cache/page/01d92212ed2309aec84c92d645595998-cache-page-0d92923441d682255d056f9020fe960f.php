<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:64281:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/how-to/enable-telnet" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-02-17T18:38:38-08:00" />
  <meta name="keywords" content="enable telnet windows vista seven 7 eight 8 version" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="With telnet disabled on the newest versions of Windows, you can follow this article to learn how to turn it on." />
  <title>Enabling telnet on a Windows computer - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/how-to/enable-telnet" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:f7b9372061d7dee18343ac96aa873f2f -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '176.10.250.16']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Enabling telnet on a Windows computer</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Enabling telnet on a Windows computer									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>14,052</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 29, 2013'><span style='color:#606060;'>Published:</span> Feb 17, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p><a href="http://www.telnet.org/">Telnet</a> can be used to test different connections and ports on your hosting server. It is not always enabled by default on Windows machines (Vista, 7, 8), however. When attempting to use Telnet you may get an error like <em>'telnet' is not recognized as an internal or external command, operable program or batch file.</em>This means that your machine does not have telnet currently enabled. Follow the guide below to learn how to enable telnet for your computer.</p>

<h2>How to enable telnet in Windows (Vista, 7)</h2>
<ol class="article_list">
  <li>Click on the windows icon in the lower left hand corner of yrou desktop and then select <strong>Control Panel</strong>.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/howto/telnet/enable/control-panel.png"><img  alt="click on control panel" src="//cdn.inmotionhosting.com/support/images/stories/edu/howto/telnet/enable/control-panel.png" /></a></li>
  <li>From there, click on the <strong>Programs</strong> category title.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/howto/telnet/enable/click-programs.png"><img  alt="select programs category" src="//cdn.inmotionhosting.com/support/images/stories/edu/howto/telnet/enable/click-programs.png" /></a></li>
  <li>This brings you to the various options for programs. Find and click on the <strong>Turn Windows features on and off</strong> link found in the <em>Programs and Features</em> category.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/howto/telnet/enable/feature-on.png"><img  alt="turn features on or off" src="//cdn.inmotionhosting.com/support/images/stories/edu/howto/telnet/enable/feature-on.png" /></a></li>
  <li>You will see a popup with a list of all the available features to enable or disable. Scroll down until you see the <strong>Telnet Client</strong> option. Check the box next to it and click the <strong>OK</strong> button at the bottom. This will enable the telnet feature for your computer.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/howto/telnet/enable/enable-telnet.png"><img  alt="checkbox to enable telnet" src="//cdn.inmotionhosting.com/support/images/stories/edu/howto/telnet/enable/enable-telnet.png" /></a></li>
</ol>
<h2>Enabling telnet in Windows 8</h2>
<ol class="article_list">
  <li>Click <strong>Control Panel</strong> from the available options listed on the screen.</li>
  <li>On the next window click <strong>More Settings</strong> found on the left hand sidebar.</li>
  <li>On the appeared window click <strong>Programs</strong> category and then click <strong>Turn Windows features on or off</strong> sub category under <em>Programs and Features</em> on the next window that appears.</li>
  <li>From the features popup box, select the <strong>Telnet Client</strong> checkbox and click the <strong>OK</strong> button.</li>
</ol> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/how-to/enable-telnet&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/how-to/enable-telnet'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zNSZpZD01MjYmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="15cf18cd1305c520cc618f3f9b332837" value="1" />	</div>
	</form>
<!-- <br />
...
<a name='comments'></a>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/75d2bacc5dc0906eebc310545a912950?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/75d2bacc5dc0906eebc310545a912950'>Umesh</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-01 2:15 am</div>
				                <div>Its a very easiest way to understand Every user. No need to improve.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13518);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-28004'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/0bf2909d64e5a07e42188cd6b02c07c9?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/0bf2909d64e5a07e42188cd6b02c07c9'>Ly Christ</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-29 9:53 pm</div>
				                <div><p>Merci beaucoup por le renseignement!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28004);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
