<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:63508:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/ssl/received-error-code-errsslprotocolerror-how-to-resolve" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello schnickelfritz, Thank you for your question. If you are being redirected to another domain, its possible the domain is still setup as the URL some..." />
  <title>Received error code: 'ERR_SSL_PROTOCOL_ERROR'; how to resolve. | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/ssl/received-error-code-errsslprotocolerror-how-to-resolve" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:63eb68d79b867813921140667b600203 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Received error code: 'ERR_SSL_PROTOCOL_ERROR'; how to resolve.</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='https://lh6.googleusercontent.com/-SHhafwD89mE/AAAAAAAAAAI/AAAAAAAAAEw/GbiTmsQ3FoA/photo.jpg?sz=90' class='user_avatar' /><br />
			<a href='/support/community-support/users/schnickelfritz'>schnickelfritz</a>
			<div>23 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2014-10-30 12:11 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>2,381</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I'm running WordPress and installed a program called Infinite WP (IWP) to manage multiple WP installations on different domains &amp; hosting servers.  I figured out how to access the IWP admin login page using IMH's shared SSL certificate.  [In the browser, I called the secure server &amp; my account user name in the browser.]  When I enter my login credentials into IWP, I get rerouted from IMH's secure server url (https://secure158.inmotionhosting.com/~******16/iwp/login.php) to my personal account url where the IWP files are stored in a domain subdirectory (https://spiralwebdb.com/iwp/).  The browser then throws the following error message:  SSL Connection Error ( 'ERR_SSL_PROTOCOL_ERROR').  <br />
<br />
This might be a chicken or egg situation (Q: which came first?); is the problem caused by an error in the IWP files (either config.php or login.php)?  Or does the problem lie with the web host, in terms of not having the proper authentications with the shared SSL certificate?  </div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_5869' id='upvote_answer_5869' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='5869' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_5869').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_5869' id='downvote_answer_5869' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='5869' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_5869').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello schnickelfritz,<br />
<br />
Thank you for your question. If you are being redirected to another domain, its possible the domain is still setup as the URL somewhere.<br />
<br />
Make sure you have <a href="https://make.wordpress.org/support/user-manual/web-publishing/https-for-wordpress/" target="_blank">Enabled https</a> in WordPress.<br />
<br />
Then updated the <a href="http://www.inmotionhosting.com/support/website/wordpress/wordpress-changing-the-site-url-and-home-settings">Wordpress site URL</a> to reflect the shared SSL address.<br />
<br />
I also checked the shared SSL with an <a href="https://www.sslshopper.com/ssl-checker.html#hostname=secure158.inmotionhosting.com" target="_blank" >online SSL checker</a> and it is valid and installed correctly.<br />
<br />
...
John-Paul
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_5869').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_5869' id='form_comment_on_answer_5869' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
...
<br />
Unfortunately, you have referred me to screenshot of a WP admin panel on a site hosted by WordPress.com.  My web site is built on WordPress from the WP.org repository.  The feature you refer me to 'enable https' is unavailable on the profile page of a WP.org site.  My current setup of WordPress does not allow me to activate https from the admin panel.   Something is happening when I attempt to login to the Infinite WP dashboard.  I'm getting redirected from the IWP login page on IMH's secure server to my domain url (http:spiralwebdb.com/iwp/.  Not sure why.  <br />
<br />
Well, we figured out one thing....my shared SSL certificate from IMH is valid.  <br />
<br />
This issue is not resolved.   I'm going to write to Infinite WP and open a new support ticket to see if the problem orginates from their end (something wonky with their code). <br />
</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='https://lh6.googleusercontent.com/-SHhafwD89mE/AAAAAAAAAAI/AAAAAAAAAEw/GbiTmsQ3FoA/photo.jpg?sz=90' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/schnickelfritz'>schnickelfritz</a><br />
									23 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello schnickelfritz<br />
<br />
Thanks for letting me know, I updated the link to the wordpress.org version of the guide. <br />
<br />
Since you are using <em>Infinite WP</em>, the setup is a little different. I looked on their official support site and found their guide on <a href="http://support.infinitewp.com/support/solutions/articles/195238-how-to-enable-ssl-for-the-admin-panel" target="_blank" rel="nofollow" >How to enable SSL</a> for the admin panel.<br />
<br />
If you are being redirected to spiralwebdb.com/iwp/ it must still be set somewhere. If you have already updated the URL in the admin section and it is still not working, you have to make the change elsewhere, such as the wpconfig file, or database. They are covered in our guide on <a href="http://www.inmotionhosting.com/support/website/wordpress/wordpress-changing-the-site-url-and-home-settings">changing your site URL</a>.<br />
<br />
Let us know if you get a response from the developer.<br />
<br />
Thank you,<br />
John-Paul</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>JP: In your comment below, you refer to InfiniteWP's instructions to enable HTTPS in their config.php.  The files for Infinite WP are placed in a subdirectory of one's root directory.  The program connects to a separate MySQL database via settings in the IWP config.php file.  HTTPS permissions can be activated in the IWP config.php file by adding an additional line of code and setting the definition to true (which I did).  The addition of that code did not make a difference in my case.  I still continue to receive the error message 'SSL Certificate Error'.<br />
<br />
Not sure how changing my site url in the WordPress admin panel will help in this situation.  I can login into my web domain (spiralwebdb.com) , and access it directly in a browser.  My problem is logging into the admin panel of IWP, whose files are sitting in a subdirectory of my domain.   I don't think changing the URL settings in my WP install is going to fix that (but I could be wrong). <br />
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>My use of the term 'SSL Certificate Error' in my last post was incorrect.  I should have said 'SSL Connection Error'. </div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello again schnickelfritz,<br />
<br />
Since it is going to take a while to test and troubleshoot this specific issue. Please allow some time, and I will post updates as soon as possible.<br />
<br />
Thank you,<br />
John-Paul</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello J-P:  Three business days have passed since you last posted regarding this issue.  Has this issue risen to the top of the queue with technical support?  Is IMH any closer to a resolution of the problem?</div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello schnickelfritz,<br />
<br />
Thank you for contacting us. I spent quite some time researching/working on this, and was unable to find a working solution. The problem is that you just want the shared SSL for the Admin section, which presents problems. You either have to change your entire site to the shared SSL, or <a href="http://www.inmotionhosting.com/support/website/ssl/how-do-i-obtain-an-ssl-certificate">purchase an SSL</a> for your specific domain. Keep in mind you are not required to purchase the SSL from us.<br />
<br />
This doesn't seem related to Infinite WP, since I am still unable to use the shared SSL for <em>only</em the admin section of Wordpress, when Infinite WP is not installed.<br />
<br />
This is just our <a href="http://www.inmotionhosting.com/support">public forum</a>, so there is no ticket queue. Here is our guide on how you can <a href="http://www.inmotionhosting.com/support/website/getting-started-guides/submitting-and-checking-on-status-of-tickets#submit-ticket">submit a ticket</a> with Live Support.<br />
<br />
If you have any further questions, feel free to post them below.<br />
<br />
Thank you,<br />
John-Paul</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/ssl/received-error-code-errsslprotocolerror-how-to-resolve&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/ssl/received-error-code-errsslprotocolerror-how-to-resolve'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="d3b12962b155415f36032d1276248171" value="1" />	</div>
	</form>
<!-- <br />
