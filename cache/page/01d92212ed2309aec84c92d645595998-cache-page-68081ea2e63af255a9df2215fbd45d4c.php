<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:79404:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/managing-files/how-to-delete-a-file" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-07-14T18:26:06-07:00" />
  <meta name="keywords" content="how to delete a file filezilla file manager cpanel server" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="To learn how to delete a file on your server, read this article." />
  <title>How do I delete a file on my server? - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/managing-files/how-to-delete-a-file" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:aeebf673806bb85e0c92116f3a3182b8 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '46.13.74.57']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How do I delete a file on my server?									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>15,139</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Feb 22, 2013'><span style='color:#606060;'>Published:</span> Jul 14, 2015</div>
							...
							<div style='clear:both;'></div>
								...
								<iframe width="560" height="315" src="https://www.youtube.com/embed/_c3fv3Y1Rkk" frameborder="0" allowfullscreen></iframe>
<p>When you are managing your files on your server, you may need to delete files off the server. You can delete files several different ways from your server. You can connect with an FTP program like FileZilla and delete files, or you can Use your cPanel File Manager. Below are the steps to delete a file from your server using File Manager and FTP.</p>
<a name="file-manager"></a><h2>How to delete a file through File Manager</h2>
<p>You can use the cPanel file manager to delete files from your server. Below are the steps to delete a file from your server using the File Manager.</p>
...
<li><a href="/support/edu/cpanel/cpanel-file-manager/using-file-manager-in-cpanel" target="_blank" title="Click here for info">Go to the File Manager</a>, Select your domain where you want to delete the files and click Go.</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/how-to/how-to-delete-a-file/how-to-delete-a-file-1-file-manager.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Right click to delete in File Manager" src="//cdn.inmotionhosting.com/support/images/stories/website/how-to/how-to-delete-a-file/how-to-delete-a-file-1-file-manager.gif" title="Click here to view the larger image" width="100" /></a>Navigate though your files to locate the file you want to delete. Right click the file and select Delete from the pop up menu. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/how-to/how-to-delete-a-file/how-to-delete-a-file-2-confirm-delete.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Confirm the delete File Manager" src="//cdn.inmotionhosting.com/support/images/stories/website/how-to/how-to-delete-a-file/how-to-delete-a-file-2-confirm-delete.gif" title="Click here to view the larger image" width="100" /></a>Confirm the file is deleted. Now the file will be gone from the server.. <br style="clear: both;" /></li>
</ol>
<h2>How to delete a file through FTP</h2>
<p>To delete files using FTP, you can follow the steps below. This will only explain how to delete through FileZilla. Other FTP clients should work basically the same.</p>
<ol class="article_list">
<li>Open FileZilla and <a target="_blank" href="/support/website/file-management/configuring-your-site-in-filezilla" title="Click for more information">connect to your server</a>.</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/how-to/how-to-delete-a-file/how-to-delete-a-file-3-delete-filezilla.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Right click to delete in FileZilla" src="//cdn.inmotionhosting.com/support/images/stories/website/how-to/how-to-delete-a-file/how-to-delete-a-file-3-delete-filezilla.gif" title="Click here to view the larger image" width="100" /></a>Navigate to the file you want to delete on the server. Right click the file and select delete. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/how-to/how-to-delete-a-file/how-to-delete-a-file-4-confirm-delete.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Confirm the delete in FileZilla" src="//cdn.inmotionhosting.com/support/images/stories/website/how-to/how-to-delete-a-file/how-to-delete-a-file-4-confirm-delete.gif" title="Click here to view the larger image" width="100" /></a>Click OK to confirm the delete Now your file is no longer on the server. <br style="clear: both;" /></li>
</ol> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/managing-files/how-to-delete-a-file&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/managing-files/how-to-delete-a-file'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NDYmaWQ9NTg2JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="73456273e5af13a98078f82ea10b1ef6" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/5fbfd3ca6c3abdab69ad4346160f15b4?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/5fbfd3ca6c3abdab69ad4346160f15b4'>kara</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-05 11:58 am</div>
				                <div><p>I am able to delete files just fine. What I am unable to do is delete empty folders. Is there a trick for this?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10385);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-05 12:23 pm</div>
				                <div>Hello kara,<br />
<br />
Thank you for your question. You should be able to delete a file with <em>File Manager</em>, or <em>FTP</em> , as described above.<br />
<br />
If you are not able to delete a file, you may want to check the file/folder permissions as described <a href="http://www.inmotionhosting.com/support/website/managing-files/change-file-permissions">here</a>.<br />
<br />
If your problems persist, please provide more information such as an error message, or details on what happens when you try to delete the folder.<br />
<br />
If you have any further questions, feel free to post them below.<br />
Thank you,<br />
<br />
-John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10388);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-14629'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/69f9a3e6831638002939f3b2a5e35991?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/69f9a3e6831638002939f3b2a5e35991'>gopi krishna</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-03 2:10 am</div>
				                <div><p>Hi John,</p>
<p>I have developed a website using wordpress. Am trying to delete infected files in a folder through filezilla, am getting the "550 could not delete single.php: Operation not Permitted" message. How to resolve this issue.</p>
<p>&nbsp;</p>
<p>Thanks in Advance</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14629);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-03 9:29 am</div>
				                <div>Hello Gopi,<br />
<br />
Thank you for  your question. I found a similar post in the <a href="https://forum.filezilla-project.org/viewtopic.php?f=6&t=22964">Official FIleZilla forum</a>, where it was caused by a permission error.<br />
<br />
I recommend <a href="http://www.inmotionhosting.com/support/website/managing-files/change-file-permissions">checking the permissions</a> for the files you want to delete, to make sure you have the ability to modify them.<br />
<br />
If you have any further question, feel free to post them below.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14646);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-19843'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/cd6794bdbabcc04df5c6549b4d820a2d?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/cd6794bdbabcc04df5c6549b4d820a2d'>ify</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-23 4:30 am</div>
				                <div><p>hi John,&nbsp;</p>
<p>&nbsp; my website was developed with wordpress, but now i no longer want wordpress. i deleted the wordpress files from my host server and i uploaded a new file, but it gives me a 403 forbidden error. please i need to fix this asap</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19843);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-23 10:57 am</div>
				                <div>Hello ify,<br />
<br />
The <a href="http://www.inmotionhosting.com/support/website/error-numbers/403-forbidden-error">403 error</a> is typically a permissions issue. If you are one of our customers and cannot figure out the specific issue, our <a href="http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support">Live Support team</a> can reset the permissions on your account for you.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19857);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-27789'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/e7e64732e5e6a424516e81c7a6c0de88?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/e7e64732e5e6a424516e81c7a6c0de88'>Mohamed Alsayed</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-22 8:18 pm</div>
				                <div><p>i suggest that you use &nbsp;"Long Path Tool" its an amazing tool google it AND will solve your problem</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27789);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-29014'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/a62c84aebdacb2c2da11f8d5b765084e?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/a62c84aebdacb2c2da11f8d5b765084e'>Ahsan</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-12-04 11:35 pm</div>
				                <div><p>Hi,</p>
<p>i need your help please,</p>
<p>recently i have been blamed by my company that i have deleted files from server and there is no back up with the IT neither IT are able to recover this data, they put allegations that I used &nbsp;a special software to permanently delete files.</p>
<p>&nbsp;</p>
<p>kindly advise how can i defend my self as I never did any thing like this.</p>
<p>&nbsp;</p>
<p>thankyou in advance,</p>
<p>Regards</p>
<p>Ahsan</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29014);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-12-07 9:55 am</div>
				                <div>Hello Ahsan,<br />
<br />
Thank you for contacting us. You can possibly review the <a href="http://www.inmotionhosting.com/support/website/getting-started-guides/cpanel-logs-for-access-apache-email-error-ftp-mysql-whm">Server Logs</a> for any record of these files.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29038);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
