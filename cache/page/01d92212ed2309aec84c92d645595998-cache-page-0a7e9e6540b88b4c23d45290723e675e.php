<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50846:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/dns-nameserver-changes/creating-a-txt-record-for-office365-verification" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hi NiraCC, If you're on a Shared Hosting account, our Support Department will need to create the TXT record for you. Making DNS changes to your account ..." />
  <title>Creating a TXT record for Office365 verification | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/dns-nameserver-changes/creating-a-txt-record-for-office365-verification" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:c38f2d9b35a91495b999ebe89f251bbd -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '167.220.148.81']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Creating a TXT record for Office365 verification</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/NiraCC'>NiraCC</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-01-11 5:38 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>13,381</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Hi<br />
I'm trying to set up an Office365 account using my existing domain (chaparral-inc.com) which is hosted by inmotion hosting.  I want to point my emails to Office365.<br />
<br />
At this point, Office365 is simply wanting to verify that we hold the domain, chparral-inc.com so they want me to set up a temporary TXT record that points to MS=ms74736274 for TTL of 1 hour.<br />
<br />
I went to your help area and the tutorial explained that In Motion Hosting would need to create that TXT.<br />
</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_394' id='upvote_answer_394' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='394' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_394').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_394' id='downvote_answer_394' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='394' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_394').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hi NiraCC,<br />
<br />
If you're on a &lt;a href='http://www.inmotionhosting.com/hostingplans.html' target='_blank'&gt;Shared Hosting&lt;/a&gt; account, our Support Department will need to create the TXT record for you.<br />
<br />
Making DNS changes to your account (such as the one that you've requested) will require a verified ticket with our Support Department. A verified ticket can simply be an email that you send to support@inmotionhosting.com in which you authorize the changes by including either your current AMP password or the last 4 digits of the current credit card on file. Once our team has this information, they can easily create the new TXT record for you.<br />
<br />
Please note, if you are on either a &lt;a href='http://www.inmotionhosting.com/vps_hosting.html' target='_blank'&gt;VPS Hosting&lt;/a&gt; or &lt;a href='http://www.inmotionhosting.com/dedicated_servers.html' target='_blank'&gt;Dedicated Hosting&lt;/a&gt; plan, you can &lt;a href='http://www.inmotionhosting.com/support/community-support/dns-nameserver-changes/how-do-i-create-dns-txt-records' target='_blank' target='_blank'&gt;use the Advanced DNS Zone Editor to create the TXT record&lt;/a&gt;.<br />
<br />
I hope this helps point you in the right direction. Be sure to let us know if you run into any issues with getting your TXT record setup.<br />
<br />
Thanks!<br />
- Brad
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_394').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_394' id='form_comment_on_answer_394' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/dns-nameserver-changes/creating-a-txt-record-for-office365-verification&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/dns-nameserver-changes/creating-a-txt-record-for-office365-verification'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="32c84a2817cea6d195d5e3293a8d06a9" value="1" />	</div>
	</form>
<!-- <br />
