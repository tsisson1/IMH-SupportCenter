<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:68765:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/google-tools/verifying-your-website-with-google" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-04-04T18:32:43-07:00" />
  <meta name="keywords" content="google webmaster tools verify website site verification" />
  <meta name="author" content="Tim Sisson" />
  <meta name="description" content="In this tutorial, we'll show you how to verify as website with Google and why it's important to do so. " />
  <title>Verifying your website with Google - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/google-tools/verifying-your-website-with-google" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:dd480f25d227ac4ad821a1beecba3f89 -->
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Verifying your website with Google</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Verifying your website with Google									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>8,592</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Mar 19, 2012'><span style='color:#606060;'>Published:</span> Apr 4, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Anytime you use a Google Webmaster tools, you’ll need to verify ownership of the website to Google. Verification with Google does not affect PageRank or your website’s performance in any way. It does allow you to use Google’s products. Verifying ownership of a website is easy and you have more than one option on how to do so. There are many reasons to verify your site with Google and here’s a list of some of the more popular reasons:</p>
<h2>Why should I verify my website with Google?</h2>
<ul>
<li>So you can see the data Google has on your Webmaster tools account</li>
<li>Tell Google when your website changes or updates</li>
<li>Remove site pages from Google Search results</li>
<li>Specify to Google how your website should be indexed</li>
<li>Set a specific geographic region your website targets</li>
<li>Request a crawl rate change </li>
Add other site owners to share your website’s data 
</ul>
<h2>How to verify your website with Google by uploading a file</h2>
<p>The easiest and quickest method to verifying your website with Google is uploading a file that they provide. The file can be easily uploaded via file manager in cPanel.</p>
<ol class="article_list">
<li><a href="/support/website/google-tools/introduction-to-google-webmaster-tools">Log into Google Webmaster Tools</a> and <strong>download the file for HTML verification</strong></li>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/webmaster_tools/google_verification_1.jpg"><img  alt="google_verification_1" src="//cdn.inmotionhosting.com/support/images/stories/webmaster_tools/google_verification_1.jpg" /></a></p>
...
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/webmaster_tools/google_verification_2.jpg"><img  alt="google_verification_2" src="//cdn.inmotionhosting.com/support/images/stories/webmaster_tools/google_verification_2.jpg" /></a></p>
<li>Go to the <strong>domains root folder</strong> (if this is your main domain it will be your public_html folder)</li>
<li>Click “<strong>Upload</strong>” and <strong>upload the HTML file you downloaded from Google</strong></li>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/webmaster_tools/google_verification_3.jpg"><img  alt="google_verification_3" src="//cdn.inmotionhosting.com/support/images/stories/webmaster_tools/google_verification_3.jpg" /></a></p>
<li>Once the file has uploaded. Go back to the page you downloaded the HTML file from in Google Webmaster Tools and click “<strong>Verify</strong>”</li>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/webmaster_tools/google_verification_4.jpg"><img  alt="google_verification_4" src="//cdn.inmotionhosting.com/support/images/stories/webmaster_tools/google_verification_4.jpg" /></a></p>
</ol>

<p class="alert"><strong>Important!</strong> If Google does not find your HTML file you may need to check your DNS. Your domain may not be <a href="/support/domain-names/dns-nameserver-changes/updating-your-domains-nameservers">pointing to our server</a> or you may need to use a different method to verify. </p>
...
<div style='display:inline-block;'>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD03OCZpZD0zODgmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
...
<a name='comments'></a>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/e1c77d97ce8bc7c568ba36c6d862a1ab?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/e1c77d97ce8bc7c568ba36c6d862a1ab'>Evans</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-08 10:10 am</div>
				                <div><p>This was very helpfull.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12476);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-23392'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/a6f459f181c92db09f472b8071d0dbbf?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/a6f459f181c92db09f472b8071d0dbbf'>Jeremiah</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-05-13 6:12 pm</div>
				                <div><p>Hi,</p>
<p>Just to say that your guide is very useful. Thanks</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23392);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-25548'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/98c7f8896f5e79d4f67fce3e2c4ff288?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/98c7f8896f5e79d4f67fce3e2c4ff288'>Val @ Love My DIY Home</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-06 3:40 pm</div>
				                <div><p>Thanks for this simple explanation - much better than Google's. Go figure.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25548);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-31806'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/2978bf835cb77fce509f50e94a7e4db3?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/2978bf835cb77fce509f50e94a7e4db3'>D. Welch</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-08 3:30 pm</div>
				                <div><p>Thank you for the step by step instructions. &nbsp;For once - something EASY TO FOLLOW! I have been going crazy trying to understand the verification process &amp; Google+!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31806);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
