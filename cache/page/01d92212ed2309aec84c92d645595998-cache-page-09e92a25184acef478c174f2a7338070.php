<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:68761:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/ftp-client-setup/add-a-ftp-site-to-your-windows-favorites" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-02-04T21:10:40-08:00" />
  <meta name="keywords" content="add ftp windows favorite favorites webdisk webdav" />
  <meta name="author" content="Jacob Nicholson" />
  <meta name="description" content="In this article I'll go over how you can add a FTP site to your Windows favorites so that you can quickly access your website files on the server." />
  <title>Add a FTP site to your Windows favorites - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/ftp-client-setup/add-a-ftp-site-to-your-windows-favorites" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:8a96a424fc6012009bc28ce2d6e1b143 -->
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Add a FTP site to your Windows favorites</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Add a FTP site to your Windows favorites									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>5,887</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Mar 29, 2013'><span style='color:#606060;'>Published:</span> Feb 4, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In this article I'll go over how you can add a <a href="http://www.inmotionhosting.com/support/website/ftp/getting-started-guide" target="_blank">FTP</a> site to your Windows favorites so that you can quickly access your website files on the server, much like you would with either <a href="http://www.inmotionhosting.com/support/website/file-management/an-introduction-to-webdav-web-disk" target="_blank">WebDav or WebDisk</a> being enabled on the server.</p>

<h2>Adding a FTP site to Windows favorites</h2>

<p>Using the steps below I'll show you how to make your FTP account very simple to access by using Windows Explorer in Windows 7.</p>

<p>For this example I'm using a dummy domain called <strong>example.com</strong> with a FTP user of <strong>example</strong> and a password of <strong>qwerty123</strong>

<ol class="article_list">
  
   <li style="clear: both;"><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/add-ftp-to-favorites/click-on-start-type-in-computer-and-click-on-computer.png"><img  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;"src="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/add-ftp-to-favorites/click-on-start-type-in-computer-and-click-on-computer.png" alt="click on start type in computer and click on computer" /></a>Click on the <strong>Start</strong> button, type in <strong>computer</strong> in the <strong>Search programs and files</strong> box, then click on <strong>Computer</strong>.</li>
  
  <li style="clear: both;"><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/add-ftp-to-favorites/click-map-network-drive.png"><img  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;"src="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/add-ftp-to-favorites/click-map-network-drive.png" alt="click map network drive" /></a>Next click on <strong>Map network drive</strong> at the top.</li>
  
  <li style="clear: both;"><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/add-ftp-to-favorites/click-on-connect-to-a-web-site.png"><img  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;"src="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/add-ftp-to-favorites/click-on-connect-to-a-web-site.png" alt="click on connect to a web site" /></a>Then click on <strong>Connect to a Web site that you can use to store your documents and pictures</strong>.</li>
  
  <li style="clear: both;">On the <strong>Welcome to the Add Network Location Wizard</strong> page, simply click <strong>Next</strong>.</li>
  
  <li style="clear: both;"><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/add-ftp-to-favorites/click-choose-a-custom-network-location-click-next.png"><img  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;"src="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/add-ftp-to-favorites/click-choose-a-custom-network-location-click-next.png" alt="click choose a custom network location click next" /></a>Now click on <strong>Choose a custom network location</strong>, then click on <strong>Next</strong>.</li>
  
  <li style="clear: both;"><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/add-ftp-to-favorites/type-in-ftp-address-then-click-next.png"><img  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;"src="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/add-ftp-to-favorites/type-in-ftp-address-then-click-next.png" alt="type in ftp address then click next" /></a>Under the <strong>Internet or network address</strong> field type in your full FTP path including username and password if you would like to not be prompted each time for this information.
    <p>&nbsp;</p>
    <p>In this example I've used the following network address:</p>
    
    <p class="code_block" style="width: 500px;">ftp://example:qwerty123@example.com</p>
    
    <p>The address should be in the format of <strong>ftp://</strong><strong style="color: red;">username</strong><strong>:</strong><strong style="color: red;">password</strong><strong>@</strong><strong style="color: red;">example.com</strong></p>
  </li>
  
  <li style="clear: both;"><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/add-ftp-to-favorites/name-ftp-location-click-on-next.png"><img  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;"src="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/add-ftp-to-favorites/name-ftp-location-click-on-next.png" alt="name ftp location click on next" /></a>Give a name for this FTP connection, then click on <strong>Next</strong>.</li>
  
  <li style="clear: both;"><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/add-ftp-to-favorites/un-check-open-this-network-click-finish.png"><img  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;"src="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/add-ftp-to-favorites/un-check-open-this-network-click-finish.png" alt="un check open this network click finish" /></a>In this case, go ahead and un-check <strong>Open this network location when I click Finish</strong>, then click on <strong>Finish</strong>.</li>
  
  <li style="clear: both;"><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/add-ftp-to-favorites/drag-ftp-link-to-favorites.png"><img  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;"src="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/add-ftp-to-favorites/drag-ftp-link-to-favorites.png" alt="drag ftp link to favorites" /></a>Now you should see your FTP site below the <strong>Computer</strong> section, go ahead and drag it up to your <strong>Favorites</strong> to create a shortcut.</li>
  
  <li style="clear: both;"><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/add-ftp-to-favorites/click-on-ftp-favorite-link.png"><img  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;"src="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/add-ftp-to-favorites/click-on-ftp-favorite-link.png" alt="click on ftp favorite link" /></a>Now go ahead and click on your FTP site under your <strong>Favorites</strong>.</li>
  
  <li style="clear: both;"><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/add-ftp-to-favorites/drag-public-html-to-favorites.png"><img  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;"src="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/add-ftp-to-favorites/drag-public-html-to-favorites.png" alt="drag public html to favorites" /></a>At this point I'd recommend dragging your <strong>public_html</strong> directory under the first favorite we created. That way you have quick access to your full account, but can also just directly drag files to your <strong>public_html</strong> directory to have them display on your website.</li>
  
  <li style="clear: both;"><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/add-ftp-to-favorites/drag-file-to-public-html.png"><img  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;"src="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/add-ftp-to-favorites/drag-file-to-public-html.png" alt="drag file to public html" /></a>Here you can see I'm dragging an image file <strong>sunset-over-mountains.png</strong> into my <strong>public_html on example.com</strong> shortcut.</li>
  
  <li style="clear: both;"><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/add-ftp-to-favorites/view-uploaded-image-in-browser.png"><img  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;"src="//cdn.inmotionhosting.com/support/images/stories/website/ftp-file-management/add-ftp-to-favorites/view-uploaded-image-in-browser.png" alt="view uploaded image in browser" /></a>Because I uploaded the image to my <strong>public_html</strong> image, I can go ahead and pull it up in my web-browser now with success.</li>
  
  <p style="clear: both;">&nbsp;</p>
  
</ol>

<p>You should now understand how you can use the built-in Windows favorites links to quickly access your account via FTP.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/ftp-client-setup/add-a-ftp-site-to-your-windows-favorites&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/ftp-client-setup/add-a-ftp-site-to-your-windows-favorites'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MDEmaWQ9MjU2NyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="5e7ac92645c0708fb245b7d2d8b3fa3b" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/860d56a4daa5e84545bce1f751bcf6c5?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/860d56a4daa5e84545bce1f751bcf6c5'>Aparna</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-01 1:28 am</div>
				                <div><p>Thank you.This helped me :)</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26237);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
