<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:75413:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/prestashop-15/working-with-orders/create-order" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-09-05T18:46:22-07:00" />
  <meta name="keywords" content="create new order PrestaShop 1.5 back office" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="This article explains how to create a new order within the PrestaShop 1.5 back office." />
  <title>How to create an Order in PrestaShop 1.5 back office  - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/prestashop-15/working-with-orders/create-order" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:edc56897c9b24c1baab73004bb535804 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to create an Order in PrestaShop 1.5 back office 									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>6,943</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Aug 22, 2012'><span style='color:#606060;'>Published:</span> Sep 5, 2012</div>
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Comments:</span> <a href='#comments'>5</a></div>
...
<li>Using the top menu bar, hover over the <strong>Orders</strong> tab and click on the <strong>Order</strong> option.     <br /><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/prestashop1.5/Orders/Order_Messages/_order-messages.png"><img  alt="_order-messages" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/prestashop1.5/Orders/Order_Messages/_order-messages.png" /></a>c</li>
<li>You will now be at the Orders list which shows all current orders. To begin a new order, click on the green <strong>Add New</strong> button found in the upper right corner.</li>
<li>Now you are on the actual order screen. Sections will appear on the screen as you step through the order. The first section is the customer section. If your customer is already registered, simply begin typing their name in the <strong>customer</strong> field. Matching names will appear below and you can select your customer from there by clicking the <strong>Choose</strong> button. If this is a new customer, you will need to click the <strong>Add New Customer</strong> button to enter the new customer data. <br /><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/prestashop1.5/Orders/New/customer.png"><img  alt="customer" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/prestashop1.5/Orders/New/customer.png" /></a> </li>
<li>Once your customer is confirmed, the Cart section appears. From here you will enter the products the customer is wanting to order. Entering the name of the product will cause information specific to that product to appear below. In our example, we chose the ipod. Several fields appeared that let us choose the correct product and quantity. Click the <strong>Add to Cart</strong> button to add the product. Repeat the step to add more products, if desired.</li>
<li>
<p>The cart information was generated when entering the screen. The newest cart will appear at the top and show the totals for any saved data. At this point, nothing is saved, so it shows a $0.00 total.<br /><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/prestashop1.5/Orders/New/cart.png"><img  alt="cart" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/prestashop1.5/Orders/New/cart.png" /></a></p>
</li>
<li>The next step is to add any vouchers, or cart rules, under the Voucher section.<br /><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/prestashop1.5/Orders/New/vouchers.png"><img  alt="vouchers" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/prestashop1.5/Orders/New/vouchers.png" /></a></li>
<li>After the vouchers, select the address to which the delivery will be made. The address will be selected from the dropdown.<br /><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/prestashop1.5/Orders/New/address.png"><img  alt="address" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/prestashop1.5/Orders/New/address.png" /></a></li>
<li>Next is the shipping details. Enter any details that are different from the defaults.<br /><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/prestashop1.5/Orders/New/shipping.png"><img  alt="shipping" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/prestashop1.5/Orders/New/shipping.png" /></a></li>
<li>The remaining section is the Summary. This is where you review the totals, add any order messages, payment info, and order status. Once finished, click the <strong>Create the Order</strong> button to complete the order. This completes and saves the order and takes you to the edit screen for that order in case you want to make any changes.<br /><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/prestashop1.5/Orders/New/summary.png"><img  alt="summary" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/prestashop1.5/Orders/New/summary.png" /></a></li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 1: How to create an Order in PrestaShop 1.5 back office </div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/prestashop-15/working-with-orders/create-order&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/prestashop-15/working-with-orders/create-order'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNTUmaWQ9MTcxMyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="48ae00e91a551c20d358f4b6d7d7dcff" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<table><tr><td colspan='2'><h4>Managing Orders</h4></td></tr>  <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>1.</td>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/801cf18a30a08791aa5ebb02f471ee78?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/801cf18a30a08791aa5ebb02f471ee78'>sara</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-04 5:07 pm</div>
				                <div><p>Hi, thanks for the guide.</p>
<p>Is it possible to add product by its ID, when you as I do have many products with the same name it will make it much easier.</p>
<p>&nbsp;</p>
<p>// Sara</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17093);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-04 5:35 pm</div>
				                <div>Unfortunately, products may only be added by their name.  It could be possible to hire a developer to custom develop a solution for you though.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17097);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-31124'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/0fd3d5052976c1fc0a81f5a95a2592ee?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/0fd3d5052976c1fc0a81f5a95a2592ee'>Patrick</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-10 11:29 am</div>
				                <div><p>Hi</p>
<p>My shop is built with Prestashop 1.5.6.</p>
<p>The shop has around 2000 products, with an average of 10 combinations per product.</p>
<p>Therefore, some processes in the Back Office take time.</p>
<p>As an example, when we want to create an order from the BO, <strong>searching for the product can take up to one minute</strong>.</p>
<p>In the BO, the same trouble occurs when we want to add a product to an existing order.</p>
<p><strong>Is there a way to increase the search of a product in the Back Office, in the AdminOrders page</strong> ?</p>
<p>Thank you in advance for any suggestion.</p>
<p>Patrick</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31124);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-10 5:00 pm</div>
				                <div>Hello Patrick,<br />
<br />
Thank you for contacting us. There are several 3rd party modules available for increasing the search function in PrestaShop.<br />
<br />
Since I have never tried any, I cannot recommend a specific one. I recomend checking for search modules in the official <a href="http://addons.prestashop.com/en/2-modules-prestashop" target="_blank">PrestaShop</a> site.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31136);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
	...
	<div name='fixComments' id='fixComments' style='width:220px; margin:0px; float:right;'>
		<div class='moduletable'>
			<h3><span class='comment-count'>5</span> Questions & <span class='comment-text'>Comments</span></h3>
