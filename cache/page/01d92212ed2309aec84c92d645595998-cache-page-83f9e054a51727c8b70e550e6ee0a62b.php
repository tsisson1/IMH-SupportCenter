<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:86657:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/modsecurity/disable-mod-security-via-modsec-manager" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-01-07T17:14:59-08:00" />
  <meta name="keywords" content="modsec manager mod_sec mod_security enable disable turn on off cpanel" />
  <meta name="author" content="Jacob Nicholson" />
  <meta name="description" content="In this article we'll discuss disabling and enabling mod_security on your domains using our Modsec Manager cPanel plugin" />
  <title>How to Disable mod_security via cPanel Modsec Manager - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/modsecurity/disable-mod-security-via-modsec-manager" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:390c0589f646d2f3728727eda5fbfb20 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-22']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '120.161.1.175']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to Disable mod_security via cPanel Modsec Manager									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>38,271</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Oct 17, 2012'><span style='color:#606060;'>Published:</span> Jan 7, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In this article we'll discuss disabling <strong>mod_security</strong> on your account via our <strong>Modsec Manager</strong> plugin for cPanel.</p>
<p>If you don't know what <strong>mod_security</strong> is, you might want to first check out our article on <a href="/support/website/website-troubleshooting/what-is-modsecurity-and-why-is-it-important">what is <strong>mod_security</strong> and why is it important</a>.</p>
<p>Also you might be getting <a href="/support/website/website-troubleshooting/406-not-acceptable-error-message">406 Non Acceptable Error Messages</a> from having <strong>mod_security</strong> enabled as well.</p>
<p>Below are the steps to follow to disable <strong>mod_security</strong> for one of your domains.</p>
...
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/modsec-manager/modsec-manager.png"><img style="float: right; margin: 0px 0px 15px 15px;" src="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/modsec-manager/modsec-manager.png" alt="modsec-manager"  width="150" /></a>Under the <strong>Security</strong> section, click on <strong>Modsec Manager</strong>.<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/modsec-manager/modsec-manager-default-on.png"><img style="float: right; margin: 0px 0px 15px 15px;" src="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/modsec-manager/modsec-manager-default-on.png" alt="modsec-manager-default-on"  width="150" /></a><strong>mod_security</strong> will be on by default for all your sites, shown by a checkmark beside them.<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/modsec-manager/modsec-manager-update-off.png"><img style="float: right; margin: 0px 0px 15px 15px;" src="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/modsec-manager/modsec-manager-update-off.png" alt="modsec-manager-update-off"  width="150" /></a>Remove the checkmark beside the domain you wish to turn <strong>mod_security</strong> off for, and click <strong>Update</strong>.<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/modsec-manager/modsec-manager-complete.png"><img style="float: right; margin: 0px 0px 15px 15px;" src="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/modsec-manager/modsec-manager-complete.png" alt="modsec-manager-complete"  width="150" /></a>You should now see that <strong>mod_security</strong> was disabled for the domain you selected.<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/modsec-manager/modsec-manager-disabled.png"><img style="float: right; margin: 0px 0px 15px 15px;" src="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/modsec-manager/modsec-manager-disabled.png" alt="modsec-manager-disabled"  width="150" /></a>If you have <strong>mod_security</strong> disabled, you'll see a blank checkbox beside the domain.<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/modsec-manager/modsec-manager-update-on.png"><img style="float: right; margin: 0px 0px 15px 15px;" src="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/modsec-manager/modsec-manager-update-on.png" alt="modsec-manager-update-on"  width="150" /></a>To enable <strong>mod_security</strong> on a disabled domain, place a checkmark beside the domain and click on <strong>Update</strong>.<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/modsec-manager/modsec-manager-enabled.png"><img style="float: right; margin: 0px 0px 15px 15px;" src="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/modsec-manager/modsec-manager-enabled.png" alt="modsec-manager-enabled"  width="150" /></a>You should now see that <strong>mod_security</strong> was enabled for the selected domain.<br style="clear: both;" /></li>
</ol>
<p>You should now know how to turn <strong>mod_security</strong> on and off for any of your domains that might be encountering problems relating to it being enabled by default.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/modsecurity/disable-mod-security-via-modsec-manager&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/modsecurity/disable-mod-security-via-modsec-manager'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MDgmaWQ9NDQ1JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="066e50f4d826203b9a9a8f5fb66a8187" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/drupal-7/modsecurity-error-in-drupal-install?tsrc=rsbraq'>Mod_Security Error in Drupal Install</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/drupal/the-modsecurity-error-on-the-server?tsrc=rsbraq'>The mod_security error on the server?</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/wordpress/http-errors-on-uploading-images-with-wp?tsrc=rsbraq'>HTTP errors on uploading images with WP</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/e1b15df1ea20efa2629750dbfd069409?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/e1b15df1ea20efa2629750dbfd069409'>vikrant</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-18 9:35 am</div>
				                <div>i am searching the mod_securty on cpannal i upload the vedio in admin pannal so find the error        in my cpannal  modsec option not appere                        Not Acceptable<br />
<br />
An appropriate representation of the requested resource /admin/manage_conditions.php could not be found on this server.<br />
<br />
...
<br />
						...
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12988);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-18 10:49 am</div>
				                <div>This error is indeed typically caused by mod_security.  We recommend using the Modsec Manager described in this article to turn mod_security off.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13001);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-13821'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/7fda75777ca499ae9d52b52f3d719f60?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/7fda75777ca499ae9d52b52f3d719f60'>Dave</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-08 8:00 pm</div>
				                <div>I disabled mod security on all my domains, as instructed in a support ticket, and it didn't solve the problem.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13821);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-14529'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/d5c6360466e579ac0aac2a576608f8d6?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/d5c6360466e579ac0aac2a576608f8d6'>Janice McIntire-Stearn</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-31 6:27 pm</div>
				                <div><p>I followed the instructions but I am still recieving the an error message on my site. The error message Looks like:</p>
<p>"Error 406 - Not Acceptable</p>
<p>Generally a 406 error is caused because a request has been blocked by Mod Security. If you believe that your request has been blocked by mistake please contact the web site owner."&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14529);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-02 1:18 pm</div>
				                <div>Hello Janice,<br />
<br />
If you are still getting the error, you will want to contact our <a href="http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support">Live Support</a> team to have them take a look for the specific rule that is being violated.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14589);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-31 6:28 pm</div>
				                <div><p>I followed the instructions but I am still recieving the an error message on my site. The error message Looks like:</p>
<p>&nbsp;</p>
<p>"Error 406 - Not Acceptable</p>
<p>Generally a 406 error is caused because a request has been blocked by Mod Security. If you believe that your request has been blocked by mistake please contact the web site owner."</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14530);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-30 7:11 pm</div>
				                <div>There are some things which cannot be disabled due to them being critical security issues.  Could you clarify what exactly you are trying to do when you get this?</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15717);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-15715'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/586dffc3308324e0c294a0abff58eb86?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/586dffc3308324e0c294a0abff58eb86'>Terrance Hale</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-30 6:59 pm</div>
				                <div><p>Thanks for the article. Saved me from having to start a chat session! :)</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15715);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-05 11:08 am</div>
				                <div><p>modsec is not where it should be under "security" in the cpanel. It is nowhere to be found. I need access to my site ASAP to update a post, but apparently it was under a "brute force" attack.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15889);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-06 9:09 am</div>
				                <div>Hello Seth,<br />
<br />
If you are not seeing the icon, you will want to <a href="http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support">contact Live Support</a> so they can take care of that for you.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15908);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-22965'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/68c05b89b3131f37cda9a0e9466d78a5?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/68c05b89b3131f37cda9a0e9466d78a5'>Mike Greg</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-27 3:32 am</div>
				                <div><p>Dear Admin, please help me out, am getting the below error while trying to access index.html though am using a free host.</p>
<h1>412 Error</h1>
<p>Your request got filtered out due to possible security issues.</p>
<p>One or more things in your request were suspicious (defective request header, invalid cookies, bad parameters)</p>
...
<p>If you are the owner of the website, you can consider revising the rules of the mod_security module or turning it off from your Web Hosting Control Panel.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22965);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-27 9:20 am</div>
				                <div>Hello Mike,<br />
<br />
Thank you for your question. I recommend <a href="http://www.inmotionhosting.com/support/website/modsecurity/find-and-disable-specific-modsecurity-rules">Finding and disabling specific ModSecurity rules</a>.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22974);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
