<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:58686:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/drupal-7/configure-caching/enable-cache-blocks" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-07-10T14:34:41-07:00" />
  <meta name="keywords" content="Drupal 7 enable configure cache block data turn on set" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="In this Drupal 7 article you will learn how to enable the caching of block data." />
  <title>How to enable cache blocks in Drupal 7 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/drupal-7/configure-caching/enable-cache-blocks" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:f96525782eccd27fef0fd6cc4894bc32 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '190.158.44.135']);
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
				<img src='/support/images/stories/drupal-partner/supporting-partner-80_3.png' style='float:right; margin:0px 0px 15px 15px;' alt='Drupal Association Support Partner'>		<h1>
															How to enable cache blocks in Drupal 7									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>6,910</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jun 28, 2012'><span style='color:#606060;'>Published:</span> Jul 10, 2012</div>
...
<li>On the top menu bar, locate the <strong>Configuration </strong>option and click on it.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Configuration/_main-dashboard-configuration.png"><img  alt="_main-dashboard-configuration" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Configuration/_main-dashboard-configuration.png" /></a></li>
<li>This brings you to the main <strong>Configuration </strong>category screen. Find the subcategory named <strong>Development </strong>and click on the <strong>Performance </strong>link.</li>
<li>Once on the <strong>Performance </strong>screen, locate the <strong>Caching </strong>section and click on the checkbox labeled<strong> Cache Blocks.</strong> This enables Drupal to cache block data and store it in the database for faster site loading.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Configuration/Development/Performance/config-dev-perf-cache-blocks.png"><img  alt="config-dev-perf-cache-blocks" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Configuration/Development/Performance/config-dev-perf-cache-blocks.png" /></a></li>
<li>Once finished, go down to the bottom of the screen and click the <strong>Save Configuration</strong> button.</li>
</ol>
<p>You have successfully turned on the Cache Blocks feature in Drupal 7.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 4: How to enable cache blocks in Drupal 7</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 3: <a href='/support/edu/drupal-7/configure-caching/enable-anonymous-caching'>Enabling caching for anonymous users in Drupal 7</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 5: <a href='/support/edu/drupal-7/configure-caching/config-min-cache-lifespan'>How to configure minimum cache lifespan in Drupal 7</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/drupal-7/configure-caching/enable-cache-blocks&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/drupal-7/configure-caching/enable-cache-blocks'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yMTkmaWQ9MTUzNCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
