<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:63860:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/wordpress/photographers-guide-wordpress/creating-wp-photo-header" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-03-25T20:49:56-07:00" />
  <meta name="author" content="Arnel Custodio" />
  <meta name="description" content="See how to create a banner or header image that will grace your Wordpress photo portfolio website" />
  <title>Creating a Header Image for your WordPress Photo Site - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/wordpress/photographers-guide-wordpress/creating-wp-photo-header" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:2e67c141f9c1c923ec51aa8c73b6a7e6 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Creating a Header Image for your WordPress Photo Site									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>699</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Mar 25, 2015'><span style='color:#606060;'>Published:</span> Mar 25, 2015</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Depending on your theme, you may need to create a header image that goes across the top of your website.  Here's an example:</p>

<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wpphoto/example-banner.jpg"><img style="margin: 0px 0px 15px 15px;"  alt="header example" src="//cdn.inmotionhosting.com/support/images/stories/wpphoto/example-banner.jpg" align="center" /></a>

<p>The following tutorial will show you how to create an easy header image or banner using a graphics tool.</p>

<ol class="article_list">

<li><a href="http://www.inmotionhosting.com/support/edu/wordpress/wordpress-introduction/logging-into-wordpress-dashboard" target="_blank">Login to the WordPress Administrator Dashboard</a>. </li>

  <li>The first thing you should do is look at your theme and see if they give you the dimensions that they recommend for the header image.  Click on <b>Appearance</b>, then click on <b>Customize</b></li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wpphoto/header-image-theme.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Header image" src="//cdn.inmotionhosting.com/support/images/stories/wpphoto/header-image-theme.png" align="right" /></a>
<p>Scroll down to where you see <b>Header Image</b> and click on the drop-down arrow. Notice the text for the theme:</p>
<p><pre>after clicking Add new image, your theme recommends a header size of 1260 × 240 pixels.</pre></p>
<p>Make a note of this size as we will need it when creating the header image.</p>
<div style="clear:both;"></div>
</li>

<li>You will need to plan how you want to create your header image.  Bear in mind that it should fit within the 1260 x 240 pixels. You will need a graphic tool to create the image. For the purpose of this tutorial, I am using <a href="http://www.adobe.com/products/photoshop.html?sdid=KKQIN&kw=semgeneric&ttsrccat=sem-ww-di-ps-brand&skwcid=AL!3085!3!61478816418!e!!g!!adobe%20photoshop&ef_id=VEEy6AAAAal5hfJY:20150324184111:s" rel="nofollow" target="_blank">Adobe Photoshop</a> to create the header image. Planning for the header image may involve getting a company logo, finding a particular font, and getting a key image. Sketch it out and then make a list of the elements you need for your header image.</li>


  <li><p>The next step will be to combine or create your header image elements. Make sure that the image works for your website appearance. Do the colors match or blend? Does your logo look okay? Is everything spelled correctly? Is it easy to read? Remember that the image should be optimized for web display.  The banner I am creating in this tutorial will consist of two elements - a picture and title text.  I will also need to make sure that the background matches the picture.  Here are the separate elements I used to create the banner:</p>

<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wpphoto/separate-elements.png"><img style="float: center; margin: 0px 0px 15px 15px;"  width="200"  alt="elements of the header image" src="//cdn.inmotionhosting.com/support/images/stories/wpphoto/separate-elements.png" align="center" /></a>
<div style="clear:both;"></div>
</li>

<li><i>The next steps will need to be completed with in the graphic tool of your choice. </i> Create the blank graphic in the recommended dimensions  1260 x 240 pixels at 72 dpi. </li>  

<li>Create the layer with the primary image at left. </li>

<li>Next, your image will either need to be 1260 pixels wide, or you will need to stretch and then blend the background so that it matches with the primary image.  This is needed to create a seamless background because the colors are not uniform from top to bottom. If you can get your background to be one color, then it makes the header image easier to create.  Having a seamless background will go a long way to help you portray the quality of your photography site. </li>

<li><p>Merge all of the header image elements together into a single image. Use your graphic tool to smooth out any rough areas in the image so that the image looks smooth and seamless. The final header image looks like this:</p>

<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wpphoto/header-image-final.jpg"><img style="float: center; margin: 0px 0px 15px 15px;"   alt="elements of the header image" src="//cdn.inmotionhosting.com/support/images/stories/wpphoto/header-image-final.jpg" align="center" /></a>
<br />
<p class= "alert alert-info">Note:  Fonts are not always free, contrary to popular belief.  If you are working with a header image that must have a specific font, make sure that font name or the files have been provided for the creation of the image.</p>
<div style="clear:both;"></div>
</li>

  <li>Finally, you can add the header image to your WordPress site. In the WordPress Admin, click on <b>Appearance</b>, then <b>Customize</b>.  Click on <b>Header Image</b>, then add the image by clicking on <b>Add new image</b>.  </li>
  
<li>Click on the blue button labeled <b>Save and Publish</b> and your header image will be saved to your WordPress site. </li>
  
</ol>

<p>The header image also has a randomize feature that allows you to randomize the header based on the previously uploaded header images.  Use this option to help keep your WordPress site fresh and interesting.  Here's what the final header image looks like in the WordPress website:</p>

<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wpphoto/photo-site-landing.png"><img style="float: center; margin: 0px 0px 15px 15px;"   alt="elements of the header image" src="//cdn.inmotionhosting.com/support/images/stories/wpphoto/photo-site-landing.png" align="center" /></a> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/wordpress/photographers-guide-wordpress'>207: Photographers Guide to a Simple WordPress Site</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 4: Creating a Header Image for your WordPress Photo Site</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 3: <a href='/support/edu/wordpress/photographers-guide-wordpress/creating-a-static-page'>Creating a Static Page in Wordpress</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 5: <a href='/support/edu/wordpress/photographers-guide-wordpress/creating-wp-page-or-post'>Creating a Page or Post in WordPress</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/wordpress/photographers-guide-wordpress/creating-wp-photo-header&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/wordpress/photographers-guide-wordpress/creating-wp-photo-header'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD01MjkmaWQ9MzUzNCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="ce23151edc29b14ff5d5ea6373adb7d3" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/wordpress/photographers-guide-wordpress?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Photographers Guide to a Simple WordPress Site</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/wordpress/photographers-guide-wordpress/how-to-build-a-simple-photo-portfolio-website?tsrc=rsbedu'>How to Build a Simple Photo Portfolio Website</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/wordpress/photographers-guide-wordpress/manual-wp-install?tsrc=rsbedu'>Manual WordPress Installation</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/wordpress/photographers-guide-wordpress/creating-a-static-page?tsrc=rsbedu'>Creating a Static Page in Wordpress</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/wordpress/photographers-guide-wordpress/creating-wp-photo-header?tsrc=rsbedu'>Creating a Header Image for your WordPress Photo Site</a></td>
                </tr>
          <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/wordpress/photographers-guide-wordpress/creating-wp-page-or-post?tsrc=rsbedu'>Creating a Page or Post in WordPress</a></td>
                </tr>
          <tr >
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/wordpress/photographers-guide-wordpress/create-wp-photo-menu?tsrc=rsbedu'>Creating a Menu for your WordPress Photography Site</a></td>
                </tr>
          <tr >
                        <td valign='top'>7.</td>
                        <td><a href='/support/edu/wordpress/photographers-guide-wordpress/create-wp-footer?tsrc=rsbedu'>Create a Footer for WordPress</a></td>
                </tr>
          <tr >
                        <td valign='top'>8.</td>
                        <td><a href='/support/edu/wordpress/photographers-guide-wordpress/create-simple-wp-gallery?tsrc=rsbedu'>How to Create a Gallery in Wordpress without a plugin</a></td>
                </tr>
          <tr >
                        <td valign='top'>9.</td>
                        <td><a href='/support/edu/wordpress/photographers-guide-wordpress/remove-comments-2?tsrc=rsbedu'>Remove Comments from a WordPress Page or Post</a></td>
                </tr>
          <tr >
                        <td valign='top'>10.</td>
                        <td><a href='/support/edu/wordpress/photographers-guide-wordpress/changing-theme-colors?tsrc=rsbedu'>Changing Colors in WordPress</a></td>
                </tr>
          <tr >
                        <td valign='top'>11.</td>
                        <td><a href='/support/edu/wordpress/photographers-guide-wordpress/changing-the-font-sizes?tsrc=rsbedu'>Changing the Font Sizes in WordPress</a></td>
                </tr>
          	</table>
