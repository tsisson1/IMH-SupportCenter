<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:57776:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/phpbb/manage-forums/adding-a-new-category" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-01-10T19:57:14-08:00" />
  <meta name="keywords" content="add create parent category phpBB" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="This phpBB 3.0 article will guide you in setting up a new parent category." />
  <title>Adding a new category in phpBB  3.0 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/phpbb/manage-forums/adding-a-new-category" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:855a6bce0770b6dce8db0bd5860c12bd -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Adding a new category in phpBB  3.0									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>3,513</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Dec 12, 2012'><span style='color:#606060;'>Published:</span> Jan 10, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>A 'Category' is a special type of forum. Think of it as the parent container of the forums under it. PhpBB allows unlimited subforums, but the category is the top of the chain. Learn how to add a new category in your phpBB site by following the instructions below. </p>
<div><strong>How to create a new Category in phpBB 3.0</strong></div>
...
<li>This brings you to the forum management screen. In the lower right corner of the screen, enter the desired name for your new category. Click on the <strong>Create New Forum</strong> button.</li>
<li>You are now on the <em>New Category</em> initial settings screen. The initial settings are very similar to those you see when creating a new forum. The other settings below are very different and will be discussed in other articles.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/forums/create-category/1-category-settings.png"><img  alt="1-category-settings" src="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/forums/create-category/1-category-settings.png" /></a><br />
<table class="article_table">
<tbody>
<tr><th>Forum Type</th>
<td>Select Category from the dropdown.</td>
</tr>
<tr><th>Parent Forum</th>
<td>Categories are usually independent and have no parent, however you can nest categories by placing them under another.</td>
</tr>
<tr><th>Copy Permissions From</th>
<td>If you do not want to create custom permissions, you can select another category or forum from which to copy permissions from. They can be further customized later.</td>
</tr>
<tr><th>Forum Name</th>
<td>This is the name of your Category.</td>
</tr>
<tr><th>Description</th>
<td>A description about the Category's purpose.</td>
</tr>
<tr><th>Forum Image</th>
<td>the relative path that leads to the image you wish to use for your category.</td>
</tr>
<tr><th>Forum Password</th>
<td>If you wish to make the Category private and accessed only by password, enter it here.</td>
</tr>
<tr><th>Confirm Forum Password</th>
<td>If you have entered a password above, confirm it by re-entering it here.</td>
</tr>
<tr><th>Forum Style</th>
<td>Select the type of style or theme you want to use for your category.</td>
</tr>
</tbody>
</table>
</li>
<li>After entering the initial settings for your Category, scroll to the bottom of the page and click on the <strong>Submit</strong><span data-mce-bogus="true" id="_mce_caret"> button. This will save the settings and give you a confirmation screen. Once you return to the <em>Forums</em> tab you will see the new category listed. <br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/forums/create-category/2-new-category-after.png"><img  alt="2-new-category-after" src="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/forums/create-category/2-new-category-after.png" /></a><br /></span></li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 4: Adding a new category in phpBB  3.0</div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/phpbb/manage-forums/adding-a-new-category&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/phpbb/manage-forums/adding-a-new-category'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMDkmaWQ9MjA2OCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="37cd0d3bde252284b2966e2cdaa9827f" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/44fe379cc1f9bb20e19e2f378a5cebc0?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/44fe379cc1f9bb20e19e2f378a5cebc0'>Skhiri Med</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-29 8:34 pm</div>
				                <div><p>Thank you, that was helpful!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23059);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
