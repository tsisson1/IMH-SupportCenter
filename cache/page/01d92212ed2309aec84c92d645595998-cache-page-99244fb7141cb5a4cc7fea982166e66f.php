<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:64254:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/php-fusion/adding-content-to-php-fusion/set-home-page" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-03-25T19:05:03-07:00" />
  <meta name="keywords" content="add change edit find home page link URL admin panel php-fusion phpfusion php fusion" />
  <meta name="author" content="Arnel Custodio" />
  <meta name="description" content="PHP-Fusion uses a thematic framework which basically makes up the main appearance of the site, but the home page can still be defined.  The following article shows where to define the home page and how it can be changed. " />
  <title>How to Set the Home Page in PHP-Fusion - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/php-fusion/adding-content-to-php-fusion/set-home-page" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:b41656e9201d652ccb81c83421dbbf31 -->
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/php-fusion' itemprop='url'><span itemprop='title'>PHP-Fusion<span></a><div class='dropdown_2columns'><h2>PHP-Fusion Education Channel</h2><div class='col_2'><h3>100 Level Classes</h3><div><a href='/support/edu/php-fusion/getting-started-php-fusion'>101: Getting started with PHP-Fusion</a></div><div><a href='/support/edu/php-fusion/adding-content-to-php-fusion'>102: Adding content to your PHP-Fusion website</a></div><div><a href='/support/edu/php-fusion/working-with-menus-php-fusion'>103: Working with menus in PHP-Fusion</a></div><div><a href='/support/edu/php-fusion/changing-appearance-php-fusion'>104: Changing the PHP-Fusion Appearance</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/php-fusion/adding-content-to-php-fusion' itemprop='url'><span itemprop='title'>102: Adding content to your PHP-Fusion website<span></a><div class='dropdown_3columns'><h2> Adding content to your PHP-Fusion website</h2><div class='col_3'><div>1. <a style='display:inline;' href='/support/edu/php-fusion/adding-content-to-php-fusion/set-home-page'>How to Set the Home Page in PHP-Fusion</a></div><div>2. <a style='display:inline;' href='/support/edu/php-fusion/adding-content-to-php-fusion/new-article'>Creating a new article in Php-Fusion</a></div><div>3. <a style='display:inline;' href='/support/edu/php-fusion/adding-content-to-php-fusion/edit-article'>How to edit an article in Php-Fusion</a></div><div>4. <a style='display:inline;' href='/support/edu/php-fusion/adding-content-to-php-fusion/adding-a-link-to-an-article-using-php-fusion'>Adding a Link to an Article Using PHP-Fusion</a></div><div>5. <a style='display:inline;' href='/support/edu/php-fusion/adding-content-to-php-fusion/how-to-add-images-to-articles-in-php-fusion'>How to Add Images to Articles in PHP-Fusion</a></div><div>6. <a style='display:inline;' href='/support/edu/php-fusion/adding-content-to-php-fusion/creating-article-categories-in-php-fusion'>Creating Article Categories in PHP-Fusion</a></div><div>7. <a style='display:inline;' href='/support/edu/php-fusion/adding-content-to-php-fusion/how-to-insert-an-iframe-youtube-video-in-php-fusion'>How to insert an iFrame / YouTube video in PHP-Fusion</a></div><div>8. <a style='display:inline;' href='/support/edu/php-fusion/adding-content-to-php-fusion/how-to-insert-javascript-into-a-php-fusion-article'>How to insert JavaScript into a PHP-Fusion article</a></div><div>9. <a style='display:inline;' href='/support/edu/php-fusion/adding-content-to-php-fusion/contact-form'>Using the Contact Form in PHP-Fusion</a></div><div>10. <a style='display:inline;' href='/support/edu/php-fusion/adding-content-to-php-fusion/create-download'>How to add a new download in Php-Fusion</a></div><div>11. <a style='display:inline;' href='/support/edu/php-fusion/adding-content-to-php-fusion/new-download-category'>Creating a new download category in Php-Fusion</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to Set the Ho...</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to Set the Home Page in PHP-Fusion									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>2,771</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Mar 22, 2013'><span style='color:#606060;'>Published:</span> Mar 25, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Setting the Home page in PHP-Fusion is a matter of knowing the Site Links, and Panels that are set within the layout of the theme that is used with your PHP-Fusion installation.  The theme settings also let you designate an opening page, but it will be affected by the panel settings.  The following article is based on the default theme used when loading PHP-Fusion explaining how to change the home page setting and the elements that make up the page.</p>

<h2>Defining the Home Page in PHP-Fusion</h2>
<br />
<p>The following screenshot describes the different parts of the home page from a default PHP-Fusion installation</p> 
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/php-fusion/homepage/panel-sections3.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/edu/php-fusion/homepage/panel-sections3.png" alt="Shows the default home page and the sections of the page" ></a>
<p>This is the default layout of the home page.  Note that the page consists of areas called panels, the sub-header bar, and links within each of the panels called site links. Under the <strong>WELCOME</strong> section, you will also see the <strong>NEWS</strong> page which is designated in the <strong>Site Opening Page</strong> option found in <strong>Settings>Main</strong>.  The top of the page with the site log is called the header while the bottom of the page with the copyright notice is the site footer.  These elements typically carry over from page to page.  The following steps will take you to the <strong>Settings</strong> menu and show you were to set the <strong>Site opening page</strong>.</p><br />

<strong>Settings - Site Opening Page</strong>
<ol class="article_list">
<li><a href="/support/edu/php-fusion/getting-started-php-fusion/login-admin-panel">Login to the PHP-Fusion Admin Panel.</a><div style="clear:both;"></div></li>
<li>Click on the Admin Panel Link.<div style="clear:both;"></div></li>
<li>Click on the <strong>Settings</strong> tab.<div style="clear:both;"></div></li>  
<li>Next, click on the icon labeled <strong>MAIN</strong> in the top right hand section of the <strong>Settings</strong> tab. <div style="clear:both;"></div></li>
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/php-fusion/homepage/site-intro-correlation.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="200" src="//cdn.inmotionhosting.com/support/images/stories/edu/php-fusion/homepage/site-intro-correlation.png" alt="Shows where Site introduction text is placed in home page" align="right" ></a>When you get into this section, scroll down until you get to the division labeled <strong>OTHER SETTINGS</strong>.  Here the main areas that affect the <em>HOME</em> page are the <strong>SITE INTRODUCTION</strong>, <strong>SITE OPENING PAGE</strong>, and the exclude panel settings. Click on the <strong>SITE INTRODUCTION</strong> field.  Observe that this setting directly affects the content in the <em>WELCOME</em> portion of the site.  See the screenshot at right to see the correlation.<div style="clear:both;"></div></li>
  <li>Click on the <strong>SITE OPENING PAGE</strong> field.  This setting places the news page in the <em>HOME</em> page beneath the <em>WELCOME</em> message. The previous section shows the news section beneath the Welcome section. <div style="clear:both;"></div></li>
  <li>Scroll down until you see the first section labeled <strong>EXCLUDE LEFT PANELS</strong>.  The exclusions area of the settings let you remove the panels so that they are not showing on the <em>HOME</em> page.<div style="clear:both;"></div></li>
  <li>Click on <strong>SAVE SETTINGS</strong>at the bottom of the screen save your entries.<div style="clear:both;"></div></li>
</ol><br />


<strong>Finding the Home Page site link</strong>  
<ol class="article_list">
<li><a href="/support/edu/php-fusion/getting-started-php-fusion/login-admin-panel">Login to the PHP-Fusion Admin Panel.</a><div style="clear:both;"></div></li>
<li>Click on the Admin Panel Link.<div style="clear:both;"></div></li>
<li>Click on the <strong>SYSTEM ADMIN</strong> tab.<div style="clear:both;"></div></li>  
<li>Next, click on the icon labeled <strong>SITE LINKS</strong> in the bottom left portion of the <strong>System Admin</strong> tab. <div style="clear:both;"></div></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/php-fusion/homepage/site-link-page2.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="200" src="//cdn.inmotionhosting.com/support/images/stories/edu/php-fusion/homepage/site-link-page2.png" alt="Edit Site links" align="right" ></a>This will bring you to the <strong>ADD/EDIT SITE LINK</strong> and <strong>CURRENT SITE LINKS</strong> page.<div style="clear:both;"></div></li>
<li>Click on <strong>EDIT</strong> for the <strong>HOME</strong> link.  This will allow you to change what page the link will connect to - by default it is set to <strong>INDEX.PHP</strong>.  Here, you can also change who has access to this particular page through the link.  For more information on making changes to Site Links, please go to <a href="/support/edu/php-fusion/getting-started-php-fusion/managing-site-links">Managing Site Links in PHP-Fusion.</a> <div style="clear:both;"></div></li>
</ol><br />
  
<strong>Editing the Panels on the Home Page</strong> 
<ol class="article_list">  
<li><a href="/support/edu/php-fusion/getting-started-php-fusion/login-admin-panel">Login to the PHP-Fusion Admin Panel.</a><div style="clear:both;"></div></li>
<li>Click on the Admin Panel Link.<div style="clear:both;"></div></li>
<li>Click on the <strong>SYSTEM ADMIN</strong> tab.<div style="clear:both;"></div></li>  
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/php-fusion/homepage/panel-menu-main.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="200" src="//cdn.inmotionhosting.com/support/images/stories/edu/php-fusion/homepage/panel-menu-main.png" alt="Main Panel menu" align="right" ></a>Next, click on the icon labeled <strong>PANELS</strong> in the middle of the<strong> System Admin</strong> tab. <div style="clear:both;"></div></li>   
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/php-fusion/homepage/edit-panel.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="200" src="//cdn.inmotionhosting.com/support/images/stories/edu/php-fusion/homepage/edit-panel.png" alt="Edit area for Panels" align="right" ></a>Click on <strong>EDIT</strong> for one of the panels.  This will allow you include or exclude pages.  So, if you wish add or remove pages, you can use the Edit panel option to do so.  For more information on editing panels, go to <a href="/support/edu/php-fusion/getting-started-php-fusion/managing-panels">Managing Panels in PHP-Fusion.</a><div style="clear:both;"></div></li>
  <li>Click on <strong>SAVE PANEL</strong> to save your changes.<div style="clear:both;"></div></li>
</ol><br />
<p>Content on the <em>HOME</em> page will differ depending on what you include in the content pages and what you have allowed the user to see. It will also vary depending on the theme that you have selected. Here's an example where the theme has been changed, but the elements have remained in the same place as per a default installation:
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/php-fusion/homepage/home-page-final.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/edu/php-fusion/homepage/home-page-final.png" alt="PHP-Fusion Home page with different theme" ></a>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/php-fusion/adding-content-to-php-fusion'>102: Adding content to your PHP-Fusion website</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 1: How to Set the Home Page in PHP-Fusion</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 2: <a href='/support/edu/php-fusion/adding-content-to-php-fusion/new-article'>Creating a new article in Php-Fusion</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/php-fusion/adding-content-to-php-fusion/set-home-page&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/php-fusion/adding-content-to-php-fusion/set-home-page'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zNTgmaWQ9MjUxNCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="078c0d18c87632340dd7d69bf6a3f523" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/php-fusion/adding-content-to-php-fusion?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Adding content to your PHP-Fusion website</h3></a>
		<table><tr><td colspan='2'><h4>Adding content to pages</h4></td></tr>  <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/php-fusion/adding-content-to-php-fusion/set-home-page?tsrc=rsbedu'>How to Set the Home Page in PHP-Fusion</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/php-fusion/adding-content-to-php-fusion/new-article?tsrc=rsbedu'>Creating a new article in Php-Fusion</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/php-fusion/adding-content-to-php-fusion/edit-article?tsrc=rsbedu'>How to edit an article in Php-Fusion</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/php-fusion/adding-content-to-php-fusion/adding-a-link-to-an-article-using-php-fusion?tsrc=rsbedu'>Adding a Link to an Article Using PHP-Fusion</a></td>
                </tr>
          <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/php-fusion/adding-content-to-php-fusion/how-to-add-images-to-articles-in-php-fusion?tsrc=rsbedu'>How to Add Images to Articles in PHP-Fusion</a></td>
                </tr>
          <tr >
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/php-fusion/adding-content-to-php-fusion/creating-article-categories-in-php-fusion?tsrc=rsbedu'>Creating Article Categories in PHP-Fusion</a></td>
                </tr>
          <tr >
                        <td valign='top'>7.</td>
                        <td><a href='/support/edu/php-fusion/adding-content-to-php-fusion/how-to-insert-an-iframe-youtube-video-in-php-fusion?tsrc=rsbedu'>How to insert an iFrame / YouTube video in PHP-Fusion</a></td>
                </tr>
        <tr><td colspan='2'><h4>Adding dynamic content to pages</h4></td></tr>  <tr >
                        <td valign='top'>8.</td>
                        <td><a href='/support/edu/php-fusion/adding-content-to-php-fusion/how-to-insert-javascript-into-a-php-fusion-article?tsrc=rsbedu'>How to insert JavaScript into a PHP-Fusion article</a></td>
                </tr>
          <tr >
                        <td valign='top'>9.</td>
                        <td><a href='/support/edu/php-fusion/adding-content-to-php-fusion/contact-form?tsrc=rsbedu'>Using the Contact Form in PHP-Fusion</a></td>
                </tr>
          <tr >
                        <td valign='top'>10.</td>
                        <td><a href='/support/edu/php-fusion/adding-content-to-php-fusion/create-download?tsrc=rsbedu'>How to add a new download in Php-Fusion</a></td>
                </tr>
          <tr >
                        <td valign='top'>11.</td>
                        <td><a href='/support/edu/php-fusion/adding-content-to-php-fusion/new-download-category?tsrc=rsbedu'>Creating a new download category in Php-Fusion</a></td>
                </tr>
          	</table>
