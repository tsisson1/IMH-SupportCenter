<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:64739:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/www.inmotionhosting.com/support/website/php/command-line-settings" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-01-09T19:34:41-08:00" />
  <meta name="keywords" content="php settings command line php.ini" />
  <meta name="author" content="John-Paul Briones" />
  <meta name="description" content="Learn how to set your php.ini file, or PHP settings in command line." />
  <title>Setting your PHP Settings in Command Line - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/php/command-line-settings" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:04c24e2e6f96cc2e583224461a0b3f47 -->
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Setting your PHP Settings in Command Line</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Setting your PHP Settings in Command Line									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>4,138</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Nov 18, 2014'><span style='color:#606060;'>Published:</span> Jan 9, 2015</div>
  ...
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('php-file');">Specify the php.ini file</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('php-settings');">Change PHP settings</button>
</div>

<p>When you are running a PHP file from command line, there may be times when you need to make changes to the PHP settings. In this guide we will show you how to specify the php.ini file, and change a PHP setting in command line. If you are <em>not</em> working in <em>command line</em>, you can <a href="/support/website/php/update-local-php-settings">change your PHP settings in cPanel</a>.</p>

<a name="php-file"></a>
<h2>Specify the php.ini File in Command Line</h2>
<ol class="article_list">
  <li><a href="/support/website/ssh/shared-reseller-ssh">Connect to your server using SSH</a>.</li>
<li>You can specify the php.ini file in command line by using the following syntax:<br>
<p class="code_block">php -c [Path to php.ini file] [Path to .php file]</p>
...
<a name="php-settings"></a>
<h2>Change PHP settings</h2>
<ol class="article_list">
  <li><a href="/support/website/ssh/shared-reseller-ssh">Connect to your server using SSH</a>.</li>
<li>You can specify php.ini settings in command line with this syntax:<br>
<p class="code_block">php -c [Path to php.ini file] [Path to .php file] -d [PHP setting]</p>

For example:<br>
<p class="code_block">php -c /home/userna5/public_html/php.ini /home/userna5/public_html/example.php -d memory_limit=256M</p>
  In this example, you can see I am setting the <strong>memory limit</strong> to 256 Megabytes. Here are some other PHP settings that are often modified:<br>
...
<p>Congratulations, now you know how to set the php.ini file, and change your PHP settings from command line!</p>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/www.inmotionhosting.com/support/website/php/command-line-settings&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/www.inmotionhosting.com/support/website/php/command-line-settings'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MTImaWQ9MzQ1MyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/f479d54e5deb939decb33a591fdc438c?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/f479d54e5deb939decb33a591fdc438c'>kp</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-28 1:27 pm</div>
				                <div><p>thanks for this, however how do i just change the php.ini settings from command line and not worry about defining&nbsp;<span style="font-family: 'Courier New', Courier, monospace; font-size: 12px; line-height: 22px; white-space: nowrap; background-color: #f2f2f2;">&nbsp;"</span><span style="font-family: 'Courier New', Courier, monospace; font-size: 12px; line-height: 22px; white-space: nowrap; background-color: #f2f2f2;">[Path to .php file]"</span></p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30200);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-28 1:32 pm</div>
				                <div>Hello kp,<br />
<br />
Thank you for contacting us. You must specify the path to the .php file, or the command will not know what to run.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30203);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
