<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:84203:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/email/squirrelmail-webmail/create-signature" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-05-22T16:40:21-07:00" />
  <meta name="keywords" content="create squirrelmail email signature" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="This SquirrelMail tutorial demonstrates how to create an email signature." />
  <title>How to create an email signature in SquirrelMail - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/email/squirrelmail-webmail/create-signature" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:c4bdda19beed1669151139fbedbe7cd2 -->
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/email/squirrelmail-webmail' itemprop='url'><span itemprop='title'>SquirrelMail Webmail<span></a>
			<div class='dropdown_3columns' style='width:900px; margin-left:-250px;'>
				<div class='col_1' style='width:290px;'><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/email/squirrelmail-webmail/create-signature'>How to create an email signature in SquirrelMail</a> (14,626 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/email/squirrelmail-webmail/how-to-login-to-squirrelmail'>How to login to SquirrelMail</a> (4,578 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/email/squirrelmail-webmail/modifying-display-preferences-squirrelmail'>Modifying display preferences in SquirrelMail</a> (3,256 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/email/squirrelmail-webmail/folders-squirrelmail'>Creating Folders in SquirrelMail</a> (1,847 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/email/squirrelmail-webmail/edit-profile'>Editing your profile in SquirrelMail</a> (107 hits)</div></div>
				<div class='col_1' style='width:290px;'><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/email/squirrelmail-webmail/using-boxtrapper'>Using BoxTrapper</a> (6,049 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/email/squirrelmail-webmail/managing-your-address-book-squirrelmail'>Managing your address book in SquirrelMail</a> (3,481 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/email/squirrelmail-webmail/composing-a-new-email-message'>Composing a new email message</a> (3,219 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/email/squirrelmail-webmail/subscribe-webmail-folders'>How to subscribe to folders in Squirrel Mail</a> (1,361 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/email/squirrelmail-webmail/read-email'>Reading an email in SquirrelMail</a> (93 hits)</div></div>
				<div class='col_1' style='width:290px;'><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/email/squirrelmail-webmail/creating-an-email-filter'>Video: Creating an email filter</a> (4,716 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/email/squirrelmail-webmail/modifying-folder-preferences'>Modifying folder preferences in SquirrelMail</a> (3,260 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/email/squirrelmail-webmail/modifying-index-order-squirrelmail'>Modifying Index Order in SquirrelMail</a> (3,162 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/email/squirrelmail-webmail/message-highlighting'>Using Message Highlighting in SquirrelMail </a> (163 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/email/squirrelmail-webmail/create-email'>How to create an email in SquirrelMail</a> (85 hits)</div></div>
			</div>
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to create an email signature in SquirrelMail</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to create an email signature in SquirrelMail									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>14,626</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Nov 6, 2012'><span style='color:#606060;'>Published:</span> May 22, 2015</div>
							...
							<div style='clear:both;'></div>
								...
								<center><iframe width="560" height="315" src="https://www.youtube.com/embed/ieqqBdeeMaw?list=PLz91o-yiaKWrMnwomijJJ8Ye91A_Kp8Ay" frameborder="0" allowfullscreen></iframe></center>
<br />
<p>Email signatures are generally used to display the sender's name and contact information at the end of an email. Sometimes they are used to give website links or even memorable anecdotes. Regardless of what you wish to make your signature say, it is much easier if this content is automatically added to the end of every email instead of having to add it manually for each email. Below are instructions that teach you how to add your own custom email signature within your <em>Squirrelmail</em> client.</p>
<div class="alert">
  <span style="color:red;"><strong>Note - </strong> The instructions below are for text signatures only. SquirrelMail does not support HTML or images in signatures by default.</span>
</div>
<h2>Creating an email signature in Squirrelmail</h2>
<ol class="article_list">
<li><a href="/support/edu/cpanel/cpanel-email/logging-into-webmail">Log into your Webmail dashboard</a> and choose the <strong>Squirrelmail</strong> option.</li>
<li>From the <em>Squirrelmail</em> dashboard, click on the <strong>Options</strong> setting from the upper menu bar on the screen. <br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/email/squirrelmail/create-signature/select-options.png"><img  alt="select-options" src="//cdn.inmotionhosting.com/support/images/stories/edu/email/squirrelmail/create-signature/select-options.png" /></a></li>
<li>This brings you to the <em>Squirrelmail Options</em> screen. Click on the <strong>Personal Information</strong> link to continue on to the next page.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/email/squirrelmail/create-signature/personal-information.png"><img  alt="personal-information" src="//cdn.inmotionhosting.com/support/images/stories/edu/email/squirrelmail/create-signature/personal-information.png" /></a></li>
<li>From the <em>Personal Information</em> page, you can now insert your new signature at the <strong>Signature</strong> field. Also, be certain to select the checkbox named <strong>Use Signature</strong> located under <em>Signature Options</em> at the bottom of the page.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/email/squirrelmail/create-signature/add-signature.png"><img  alt="add-signature" src="//cdn.inmotionhosting.com/support/images/stories/edu/email/squirrelmail/create-signature/add-signature.png" /></a></li>
<li>Click the <strong>Submit</strong> button found in the lower right corner of the screen to save the signature changes. Below is a screenshot of how your signature will display when creating a new email. <br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/email/squirrelmail/create-signature/signature-after.png"><img  alt="signature-after" src="//cdn.inmotionhosting.com/support/images/stories/edu/email/squirrelmail/create-signature/signature-after.png" /></a><br /><br /><br /></li>
</ol> 
...
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/email/squirrelmail-webmail/create-signature'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD03NCZpZD03OTAmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="d74af4dcd86fdd40ad03d4b4d4993e03" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/e0ec9da8b848f1c636bfca0a374b9f5a?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/e0ec9da8b848f1c636bfca0a374b9f5a'>Maureen</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-02 2:41 am</div>
				                <div><p>My boss is using squirrel mail, we need to change the telephone number in the company address how can I do this.</p>
<p>&nbsp;</p>
<p>Kind egards</p>
<p>Maureen</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8710);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-03 11:03 am</div>
				                <div>It sounds like it is something that is just within the signature of the email.  To do so, you would take the same steps as this article, but edit the signature as well.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8730);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-9401'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/f38c6a9f1a41ba60d6d07f35a03815d0?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/f38c6a9f1a41ba60d6d07f35a03815d0'>Kennedy</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-04 7:09 am</div>
				                <div><p>i have just successfully created the email signature on Squirelmail with steps provided above but now I want to insert my company logo on that signature,&nbsp;</p>
<p>HOW CAN I DO THIS AND CAN I BE ABLE TO CHANGE THE FONT &amp; COLOUR ON MY EMAIL SIGNATURE?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9401);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-04 9:58 am</div>
				                <div>To do so, you will need to use HTML to perform the formatting.  To learn about this, you may want to take a look at the &lt;a href=&quot;http://www.w3schools.com/tags/tag_font.asp&quot;&gt;W3Schools documentation on the font tag&lt;/a&gt;.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9404);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/9f22db3459ea9ab0d3eadcd27d2d1d5c?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/9f22db3459ea9ab0d3eadcd27d2d1d5c'>Katherine</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-09 12:44 pm</div>
				                <div><p>I also would like to insert a logo and our company font in our autosig. Can you provide more detailed info, please?</p>
<p>&nbsp;</p>
<p>Thanks!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11279);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-09 1:21 pm</div>
				                <div>Hello Katherine,<br />
<br />
Squirrelmail is the most basic of the three interfaces and does not allow HTML in the signature area. Horde and RoundCube will allow this, however. We recently created a video on <a href="http://www.inmotionhosting.com/support/email/horde-webmail/create-signature">how to create an email signature</a> for Horde. You may want to look at that as an alternative.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11282);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-11624'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/ceb119063b3132d5b7cd43e3f09ca242?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/ceb119063b3132d5b7cd43e3f09ca242'>Elizabeth</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-15 4:47 pm</div>
				                <div><p>When I review sent items in Squirrelmail, the message will end with 51 of these &gt; symbols in a vertical line followed by seven signatures.&nbsp; When I go into Options - Personal Information - Signature there is nothing recorded.&nbsp; Even the 'use signature' option is unticked.</p>
<p>&nbsp;</p>
<p>Does anyone know how I can rectify this?&nbsp; My business emails look really unprofessional.</p>
<p>&nbsp;</p>
<p>Thank you in andvance.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11624);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-16 9:38 am</div>
				                <div>You may have a further issue within your account.  I recommend &lt;a href=&quot;http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support&quot;&gt;contacting technical support&lt;/a&gt; as they would be able to look further into the issue and make changes to your account as needed.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11651);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-16 9:52 am</div>
				                <div><p>I'll do that.&nbsp; Thank you for your reply.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11653);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-12601'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/af6b9bf95df3cbb852d4495db1257269?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/af6b9bf95df3cbb852d4495db1257269'>Paul</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-10 11:45 am</div>
				                <div>It is perfect</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12601);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-13085'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/280f1e5cab0497ac4b0b25ca7471e854?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/280f1e5cab0497ac4b0b25ca7471e854'>Joseph Chong</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-21 10:38 am</div>
				                <div><p>How do I make an attached logo a hyperlink so that individuals who click on the image can be directed to the company website?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13085);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-21 11:18 am</div>
				                <div>Hello Joseph,<br />
<br />
Thank you for your question. Squirrel mail is very basic, and I could not find anywhere to setup a logo link in the signature.<br />
<br />
You can still add a logo to a signature, and make them linkable in Webmail however. Just use <a href="http://www.inmotionhosting.com/support/email/roundcube-webmail/create-signature">RoundCube</a>, or <a href="http://www.inmotionhosting.com/support/email/horde-webmail/create-signature">Horde</a> signatures. This is because Horde and Roundcube allow you to create <em>HTML</em> signatures.<br />
<br />
If you have any further questions, feel free to post them below.<br />
Thank you,<br />
<br />
-John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13087);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-15165'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/b26215059efc2e1feba9c5a403583d3c?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/b26215059efc2e1feba9c5a403583d3c'>Claudette G.</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-17 11:14 pm</div>
				                <div><p>How to I add the business logo to my email signature?</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15165);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-18 8:36 am</div>
				                <div>Hello Claudette,<br />
<br />
SquirrelMail does not currently allow for HTML type signatures, which are required in order to place  your logo in it. You can, however use the <a href="http://www.inmotionhosting.com/support/email/horde-webmail/create-signature">HordeMail</a> or <a href="http://www.inmotionhosting.com/support/email/roundcube-webmail/create-signature">Roundcube</a> interfaces, which do allow for HTML emails and images in the signature.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15185);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
