<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:51315:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/wordpress/add-plugin-option-missing-from-wordpress-dashboard" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello RB2013, The only information I found on this issue is that if you installed Wordpress using the MULTI-SITE option, then you will need to login to ..." />
  <title>&amp;quot;Add plugin&amp;quot; option missing from Wordpress dashboard | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/wordpress/add-plugin-option-missing-from-wordpress-dashboard" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:cd0e50daafd3de0091dca385906bfe13 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-20']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '69.253.56.154']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>&amp;quot;Add plugin&amp;quot; option missing from Wordpress dashboard</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/RB2013'>RB2013</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-02-13 8:33 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>582</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I have recently set up wordpress on my domain. I can access preinstalled plugins but the &quot;Add plugin&quot; is missing from the menu. I have admin account. Does this have something to do with wrong installation of wordpress?  Do I need to reinstall wordpress. If so can I backup the content of my site and restore it on a new installation?<br />
</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_2277' id='upvote_answer_2277' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='2277' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_2277').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_2277' id='downvote_answer_2277' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='2277' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_2277').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello RB2013,<br />
<br />
The only information I found on this issue is that if you installed Wordpress using the MULTI-SITE option, then you will need to login to the NETWORK administrator (<a href="http://codex.wordpress.org/Create_A_Network#WordPress_Plugins" rel="nofollow" target="new">Enable Plugins for Individual Site Administrators of a MS Wordpress install</a>).  The multisite installation is typically used to have multiple Wordpress installations under one database.  This isn't always necessary.  If you installed it that way and you're using Softaculous from the Cpanel, then go back into Softaculous and uninstall the current installation and re-install NOT using the multi-site option.<br />
<br />
If you're still having an issue with the plugin button, then let us know.  If you could provide a test URL, it would also help.  If you want to keep the issue private, then please contact live technical support (available 24/7).  All posts on the Customer Support center are open to the public.<br />
<br />
...
Arnel C.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_2277').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_2277' id='form_comment_on_answer_2277' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/wordpress/add-plugin-option-missing-from-wordpress-dashboard&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/wordpress/add-plugin-option-missing-from-wordpress-dashboard'></div>
<script type='text/javascript'>
  (function() {
