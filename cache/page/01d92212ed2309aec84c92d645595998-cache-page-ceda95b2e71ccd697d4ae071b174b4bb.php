<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49817:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/email/can-email-forwarding-be-set-up-using-a-dummy-account-name" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Stan05, and thanks for your question. You can indeed setup an email forwarder without the email address actually existing as a physical email acco..." />
  <title>Can email forwarding be set up using a dummy account name? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/email/can-email-forwarding-be-set-up-using-a-dummy-account-name" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:77c81861e496104d84a6d36f065ee9ac -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-22']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '5.148.145.70']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Can email forwarding be set up using a dummy account name?</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='https://lh5.googleusercontent.com/-S32CXR9BWJ4/AAAAAAAAAAI/AAAAAAAAAEE/WfyIr52oWfs/photo.jpg?sz=90' class='user_avatar' /><br />
			<a href='/support/community-support/users/Stan05'>Stan05</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-12-14 1:36 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>929</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Does the email name have to be a functioning email acct or can it be a dummy or pass-through account name that simply forwards, but isn't holding email messages?</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_4320' id='upvote_answer_4320' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='4320' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_4320').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_4320' id='downvote_answer_4320' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='4320' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_4320').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>9,968 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2013-12-14 9:54 pm EST
                		        </div>
					
		                </div>

				Hello Stan05, and thanks for your question.<br />
<br />
You can indeed &lt;a href=&quot;http://www.inmotionhosting.com/support/edu/everything-email/email-features/set-up-email-forwarder&quot; target=&quot;_blank&quot;&gt;setup an email forwarder&lt;/a&gt; without the email address actually existing as a physical email account.<br />
<br />
You can even go so far as to setup multiple email forwarders to the same account. So for instance if I had the physical email account &lt;strong&gt;Jacob@example.com&lt;/strong&gt; setup, I could create an &lt;strong&gt;email forwarder&lt;/strong&gt; of &lt;strong&gt;J@example.com&lt;/strong&gt;, and &lt;strong&gt;Jake@example.com&lt;/strong&gt; both going to that original physical email account. Then if someone emails any of those 3 accounts, they'd all end up in the &lt;strong&gt;Jacob@example.com&lt;/strong&gt; email account for me to read, and the forwarders wouldn't store the message just pass it along to the actual email account.<br />
<br />
I hope that answered your question, please let us know if you had any further questions at all!<br />
<br />
- Jacob
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_4320').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_4320' id='form_comment_on_answer_4320' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/email/can-email-forwarding-be-set-up-using-a-dummy-account-name&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/email/can-email-forwarding-be-set-up-using-a-dummy-account-name'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="1f0ed8eb34e049285d40c4819c72349e" value="1" />	</div>
	</form>
<!-- <br />
