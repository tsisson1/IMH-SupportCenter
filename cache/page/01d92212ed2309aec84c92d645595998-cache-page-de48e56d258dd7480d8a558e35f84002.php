<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50150:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/website/need-help-linking-my-facebook-page-to-my-website" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, Thank you for contacting us about placing a Facebook link on your website. Facebook has an official development site with plugins you can use if ..." />
  <title>Need help linking my facebook page to my website.  | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/website/need-help-linking-my-facebook-page-to-my-website" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:36c4d2565d58482ed0621dd15989fbc3 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Need help linking my facebook page to my website. </h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2016-04-19 11:05 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>19</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I am trying to link my Facebook page to my website so all people have to do is click on the Facebook link in my website to take them to my Facebook page. When I click on the Facebook icon at the top of my screen it tells me the page cannot be displayed. Please help!<br />
<br />
My website is www.highsandlowsofparentingexceptionalchildren.com<br />
My Facebook page is https://www.facebook.com/highsandlowsofparentingexceptionalchildren/</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_9721' id='upvote_answer_9721' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='9721' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_9721').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_9721' id='downvote_answer_9721' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='9721' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_9721').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
Thank you for contacting us about placing a Facebook link on your website. Facebook has an official development site with plugins you can use if you like to do your own coding. You will just need to switch their code with the links to your own Facebook page. <br />
<br />
However, I see your site is built with WordPress. This may make it easier for you to get the same effect mentioned above using one of the many popular <a href="http://www.inmotionhosting.com/support/website/social-media/social-media-plugins-for-your-website">social media plugins</a>.<br />
<br />
Best,<br />
Christopher M.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_9721').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_9721' id='form_comment_on_answer_9721' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/website/need-help-linking-my-facebook-page-to-my-website&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/website/need-help-linking-my-facebook-page-to-my-website'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="90f5f470910ebf5bef58cc9cde964830" value="1" />	</div>
	</form>
<!-- <br />
