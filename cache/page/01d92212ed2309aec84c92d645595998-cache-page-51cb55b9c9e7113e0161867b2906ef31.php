<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:67319:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/phplist/getting-started/install-phplist-manually" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-03-27T21:51:34-07:00" />
  <meta name="keywords" content="install setup configure phplist manually" />
  <meta name="author" content="Jacob Nicholson" />
  <meta name="description" content="In this article we'll discuss installing the phpList software manually onto your website." />
  <title>Install phpList manually - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/phplist/getting-started/install-phplist-manually" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:7d756be51cabdf54a9b564df25c0edaf -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-22']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '82.114.67.10']);
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/phplist' itemprop='url'><span itemprop='title'>phpList<span></a><div class='dropdown_2columns'><h2>phpList Education Channel</h2><div class='col_2'><h3>100 Level Classes</h3><div><a href='/support/edu/phplist/getting-started'>101: Getting started with phpList</a></div><div><a href='/support/edu/phplist/working-with-lists'>102: Working with lists in phpList</a></div><div><a href='/support/edu/phplist/working-with-users'>103: Working with users in phpList</a></div><div><a href='/support/edu/phplist/sending-messages'>104: Sending messages with phpList</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/phplist/getting-started' itemprop='url'><span itemprop='title'>101: Getting started with phpList<span></a><div class='dropdown_3columns'><h2> Getting started with phpList</h2><div class='col_3'><div>1. <a style='display:inline;' href='/support/edu/phplist/getting-started/install-phplist-with-softaculous'>Install phpList with Softaculous</a></div><div>2. <a style='display:inline;' href='/support/edu/phplist/getting-started/install-phplist-manually'>Install phpList manually</a></div><div>3. <a style='display:inline;' href='/support/edu/phplist/getting-started/complete-phplist-setup-after-manual-install'>Complete phpList setup after manual install</a></div><div>4. <a style='display:inline;' href='/support/edu/phplist/getting-started/complete-phplist-setup-after-softaculous-install'>Complete phpList setup after Softaculous install</a></div><div>5. <a style='display:inline;' href='/support/edu/phplist/getting-started/how-to-retrieve-my-phplist-admin-password'>How to retrieve my phpList admin password</a></div><div>6. <a style='display:inline;' href='/support/edu/phplist/getting-started/how-to-reset-my-phplist-admin-password'>How to reset my phpList admin password</a></div><div>7. <a style='display:inline;' href='/support/edu/phplist/getting-started/how-to-log-into-phplist-admin-dashboard'>How to log into phpList admin dashboard</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Install phpList manually</span></li>			</ul>
		</div>
	</div>
</div>
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>9,749</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Dec 11, 2012'><span style='color:#606060;'>Published:</span> Mar 27, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In this article we'll review how to install <strong>phpList</strong> manually onto your website. <strong>phpList</strong> is used for easy web based email marketing, and allows you to do direct email marketing to your users.</p>

<p>If you've been looking for a great way to send out email blasts, for opt in email marketing, <strong>phpList</strong> is among one of the simplest email marketing software packages that you can use.</p>

<p>If you're already a customer of InMotion Hosting, I'd recommend using our guide on <a href="/support/edu/phplist/getting-started/install-phplist-with-softaculous" target="_blank">how to install <strong>phpList</strong> with Softaculous</a>. That's because the Softaculous installer that we use can complete a <strong>phpList</strong> installation with just a few clicks.</p>

<p>After you've completed a <strong>phpList</strong> installation, either manually, or with Softaculous, we'll also cover how to configure and setup <strong>phpList</strong> in this education channel. This way you can take full advantage of this popular open source newsletter software.</p>

<p>To get started simply follow the steps below.</p>


<h2>Download phpList from SourceForge</h2>
<ol class="article_list">
<li>

  <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phplist/install-manually/click-on-download-zip-link-on-phplist-site.png"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/phplist/install-manually/click-on-download-zip-link-on-phplist-site.png" alt="click-on-download-zip-link-on-phplist-site"  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;" /></a>
  
  You'll need to download <strong>phpList</strong> from <a href="http://www.phplist.com/download" target="_blank" rel="nofollow">phpList.com</a><br />
  
  <p>Click on the <strong>download ZIP</strong> link.</p>
  
  <p>The latest version of <strong>phpList</strong> was <strong>2.10.19</strong> at this time.</p>
  
  <br style="clear: both;" />

</li>
<li>
  <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phplist/install-manually/phplist-sourceforge-download.png"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/phplist/install-manually/phplist-sourceforge-download.png" alt="phplist-sourceforge-download"  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;" /></a>

  You will be taken to <strong>SourceForge</strong> to download the file.

  <p>Wait for the download count-down to complete, or you can click on either the <strong>direct link</strong>, or <strong>mirror</strong> links to begin the download.</p>
  
  <br style="clear: both;">
</li>
<li>
  Extract the downloaded <strong>phplist-2.10.19.zip</strong> archive to a local folder on your computer.
  <p class="alert">Note the folder location as we'll need to come back to these files in just a minute.</p>
</li>
</ol>


<h2>Create a MySQL database to store phpList settings</h2>
<ol class="article_list">
<li>
  First <a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">login to your cPanel</a>.
</li>
<li>
  <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phplist/install-manually/click-on-mysql-database-wizard.png"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/phplist/install-manually/click-on-mysql-database-wizard.png" alt="click-on-mysql-database-wizard"  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;" /></a>
  
  Under the <strong>Databases</strong> section, click on <strong>MySQL Database Wizard</strong>.<br style="clear: both;" />
</li>
<li>
  <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phplist/install-manually/name-database-click-on-next-step.png"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/phplist/install-manually/name-database-click-on-next-step.png" alt="name-database-click-on-next-step"  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;" /></a>
  
  In the <strong>New Database</strong> field, give your database a name, in this example we're using <strong>phplist</strong>. Then click on <strong>Next Step</strong>.
  <br style="clear: both;" />
</li>
<li>
  <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phplist/install-manually/create-database-user-click-on-create-user.png"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/phplist/install-manually/create-database-user-click-on-create-user.png" alt="create-database-user-click-on-create-user"  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;" /></a>

  In the <strong>Username</strong> field, create a database username, in this example we're using <strong>phplist</strong>. Then fill out and confirm the <strong>Password</strong> making sure that you've copied it down. Finally click on <strong>Create User</strong>.<br style="clear: both;" />
</li>
<li>
  <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phplist/install-manually/select-all-privileges-click-on-next-step.png"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/phplist/install-manually/select-all-privileges-click-on-next-step.png" alt="select-all-privileges-click-on-next-step"  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;" /></a>

  Finally place a check mark beside <strong>ALL PRIVELEGES</strong>, then click on <strong>Next Step</strong>.
  <br style="clear: both;" />
</li>
<li>
  You should now simply see that your database user was added to your database.
  
  <p><strong>User "userna1_phplist" was added to the database "userna1_phplist".</strong></p>
</li>
</ol>

<h2>Upload phpList files via FTP to server</h2>
<ol class="article_list">
<li>
  Using your favorite <a href="/support/website/file-management/getting-started-guide-ftp">FTP</a> client, navigate to the local folder that you had extracted <strong>phpList</strong> to in the left pane, being sure to go into the <strong>\public_html\</strong> folder.</li>
<li>Connect to your account on the server and in the right pane navigate to your <strong>/public_html/</strong> directory.</li>
<li>
  <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phplist/install-manually/filezilla-drag-lists-folder-onto-server.png"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/phplist/install-manually/filezilla-drag-lists-folder-onto-server.png" alt="filezilla-drag-lists-folder-onto-server"  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;" /></a>
  
  Now drag the <strong>lists</strong> folder from your local computer, into the <strong>/public_html/</strong> directory on the server.<br style="clear: both;" /> 
</li>
<li>You can right-click on the <strong>lists</strong> directory on the server, then select <strong>Rename</strong> if you want your <strong>phpList</strong> installation to be accessible from another location than the default. In this case I've chosen simply <strong>list</strong>.<br /> 
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phplist/install-manually/filezilla-rename-folder.png"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/phplist/install-manually/filezilla-rename-folder.png" alt="filezilla-rename-folder"  /></a> 
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phplist/install-manually/filezilla-rename-folder-complete.png"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/phplist/install-manually/filezilla-rename-folder-complete.png" alt="filezilla-rename-folder-complete"  /></a>
</li>
</ol>
<div>&nbsp;</div>

<h2>Update phpList config.php to connect to your database</h2>
<ol class="article_list">
<div style="width: 50%; float: left; position: relative; top: 15px;">
...
<div style="width: 46%; float: right;"><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phplist/install-manually/cpanel-file-manager-go-to-document-root.png"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/phplist/install-manually/cpanel-file-manager-go-to-document-root.png" alt="cpanel-file-manager-go-to-document-root"  /></a></div>
<div style="clear: both;">&nbsp;</div>
<li>
  <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phplist/install-manually/cpanel-file-manager-navigate-to-config.png"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/phplist/install-manually/cpanel-file-manager-navigate-to-config.png" alt="cpanel-file-manager-navigate-to-config"  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;" /></a>
  
  Navigate to the <strong>/public_html/list/config</strong> directory from the left-hand pane.
  <br style="clear: both;" />
</li>
<li>
  <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phplist/install-manually/edit-config-php-file.png"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/phplist/install-manually/edit-config-php-file.png" alt="edit-config-php-file"  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;" /></a>
  
  Now right-click on the <strong>config.php</strong> file, then click on <strong>Edit</strong>
  <br style="clear: both;" />
</li>
<li>You might have a text editor encoding dialog box pop-up, you can simply click on <strong>Edit</strong>.</li>
<li>Now you'll want to enter in your database credentials that you setup earlier when creating your MySQL database. In our case this would be:
<pre class="code_block" style="width: 500px;">$database_name = "userna1_phplist";
$database_user = "userna1_phplist";
$database_password = "phpli$tp@$$";
</pre>
<p>After making these edits, click on <strong>Save Changes</strong> at the top-right.</p>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phplist/install-manually/edit-config-php-file-click-save-changes.png"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/phplist/install-manually/edit-config-php-file-click-save-changes.png" alt="edit-config-php-file-click-save-changes"  /></a>

</li>
</ol>
<p>You should now have successfully installed the <strong>phpList</strong> newsletter management software manually onto your website. You can now continue on to my guide on how to <a href="/support/edu/phplist/getting-started/complete-phplist-setup-after-manual-install">complete phpList setup after manual install</a> to finish setting up phpList.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/phplist/getting-started'>101: Getting started with phpList</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 2: Install phpList manually</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 1: <a href='/support/edu/phplist/getting-started/install-phplist-with-softaculous'>Install phpList with Softaculous</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 3: <a href='/support/edu/phplist/getting-started/complete-phplist-setup-after-manual-install'>Complete phpList setup after manual install</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMDcmaWQ9MjA2NiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/phplist/getting-started?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Getting started with phpList</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/phplist/getting-started/install-phplist-with-softaculous?tsrc=rsbedu'>Install phpList with Softaculous</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/phplist/getting-started/install-phplist-manually?tsrc=rsbedu'>Install phpList manually</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/phplist/getting-started/complete-phplist-setup-after-manual-install?tsrc=rsbedu'>Complete phpList setup after manual install</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/phplist/getting-started/complete-phplist-setup-after-softaculous-install?tsrc=rsbedu'>Complete phpList setup after Softaculous install</a></td>
                </tr>
          <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/phplist/getting-started/how-to-retrieve-my-phplist-admin-password?tsrc=rsbedu'>How to retrieve my phpList admin password</a></td>
                </tr>
          <tr >
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/phplist/getting-started/how-to-reset-my-phplist-admin-password?tsrc=rsbedu'>How to reset my phpList admin password</a></td>
                </tr>
          <tr >
                        <td valign='top'>7.</td>
                        <td><a href='/support/edu/phplist/getting-started/how-to-log-into-phplist-admin-dashboard?tsrc=rsbedu'>How to log into phpList admin dashboard</a></td>
                </tr>
          	</table>
			...
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/everything-email/does-phplist-work-on-shared-not-vps-instances?tsrc=rsbraq'>Does phpList work on shared (not VPS) instances?</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/e0043b66842d5b99cc915f4db9f7b316?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/e0043b66842d5b99cc915f4db9f7b316'>Deniz</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-09 6:17 pm</div>
				                <div><p>Man really!</p>
<p>You saved my day. After trying 3 hours of Installation your simple short guide saved my day.&nbsp;</p>
<p>&nbsp;</p>
<p>Thanks a lot for this quick help!</p>
<p>Greetings from Germany</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8865);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
