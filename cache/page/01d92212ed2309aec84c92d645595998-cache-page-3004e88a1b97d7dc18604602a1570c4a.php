<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:60073:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/email/squirrelmail-webmail/how-to-login-to-squirrelmail" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-05-26T15:05:01-07:00" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Looking for how to login to your SquirrelMail? Learn how in this quick tutorial. Also has video!" />
  <title>How to login to SquirrelMail - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/email/squirrelmail-webmail/how-to-login-to-squirrelmail" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<script type="text/javascript">
		...
		_gaq.push(['_setCustomVar', 4, 'DateMonthPublished', '2015-05', 3]);
	...
	<!-- cid:8cf7491c3f2ac5c83d21ff0965c2d467 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '150.70.173.56']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to login to SquirrelMail</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to login to SquirrelMail									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>4,578</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: May 21, 2015'><span style='color:#606060;'>Published:</span> May 26, 2015</div>
							...
							<div style='clear:both;'></div>
								...
								<center><iframe width="560" height="315" src="https://www.youtube.com/embed/nRRHtivwrrg?list=PLz91o-yiaKWrMnwomijJJ8Ye91A_Kp8Ay" frameborder="0" allowfullscreen></iframe>
</center>

<p>SquirrelMail is one of the three webmail interfaces that are offered within your cPanel. This article will guide you on how to log into the SquirrelMail interface and what you should expect to see your first time.</p>

<h2>Logging into SquirrelMail</h2>

<ol class="article_list">
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/email/squirrelmail/login/1-enter-login-credentials.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="login credentials" src="//cdn.inmotionhosting.com/support/images/stories/edu/email/squirrelmail/login/1-enter-login-credentials.png" title="Click here to view the larger image" width="200" /></a> Start by <a href="/support/edu/cpanel/cpanel-email/logging-into-webmail">logging into your webmail</a>. You can get to the webmail login by using the format <em>example.com/webmail</em> in your browser's address bar. Be sure to replace <em>example.com</em> with your own domain name.<div style="clear:both;"></div></li>

	<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/email/squirrelmail/login/2-click-squirrelmail.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="click on squirrelmail interface" src="//cdn.inmotionhosting.com/support/images/stories/edu/email/squirrelmail/login/2-click-squirrelmail.png" title="Click here to view 
      the larger image" width="200" /></a> Click on the <strong>SquirrelMail</strong> option from the selection of interfaces.<div style="clear:both;"></div></li>

	<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/email/squirrelmail/login/3-personal-info.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="enter additional information" src="//cdn.inmotionhosting.com/support/images/stories/edu/email/squirrelmail/login/3-personal-info.png" title="Click here to view the larger image" width="200" /></a> The first time you sign into SquirrelMail you will be asked to enter some additional information. Enter what you wish and then click on any of the <strong>Submit</strong> buttons to save.<div style="clear:both;"></div></li>
</ol>
<br /><br />
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/email/squirrelmail/login/3-enter-inbox.png"><img   style="float:right; margin:0px 15px 15px 15px;" alt="inbox" src="//cdn.inmotionhosting.com/support/images/stories/edu/email/squirrelmail/login/3-enter-inbox.png" title="Click here to view the larger image" width="200" /></a> Once you have logged into the SquirrelMail interface you will be brought to your Inbox. Fron there you can manage your emails as desired.</p>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/email/squirrelmail-webmail/how-to-login-to-squirrelmail&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/email/squirrelmail-webmail/how-to-login-to-squirrelmail'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD03NCZpZD0zNTY2JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="558580b7f358bbad61093ee4f2e0698d" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/8b8b6ee0222c06e67836858b7c5800ea?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/8b8b6ee0222c06e67836858b7c5800ea'>Mohammed Rahman</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-26 3:13 am</div>
				                <div><p>I need to buy squirrelmail login link and&nbsp; Password</p>
<p>pay you with perfect money.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28772);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-27 12:58 pm</div>
				                <div>Hello Mohammed,<br />
<br />
Thank you for contacting  us. Since all  of our <a href="http://www.inmotionhosting.com/business-hosting">Hosting Plans</a> include Squirrel Mail, I recommend contacting our <a href="/support/">Sales team</a> and signing up for a plan.<br />
<br />
If you have any further questions, feel free to post them below.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28799);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
