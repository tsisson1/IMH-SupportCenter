<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:52640:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/blacklist-check/website-reported-unsafe-by-microsoft-smartscreen" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello youtag, and thanks for your question. Unfortunately it looks like the official Microsoft SmartScreen Filter FAQ doesn't give an indication of the ..." />
  <title>website reported unsafe by microsoft smartscreen | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/blacklist-check/website-reported-unsafe-by-microsoft-smartscreen" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:3ba2c6dea332959ab66e113f4b933e78 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>website reported unsafe by microsoft smartscreen</h1>
		<div style='margin-bottom:20px; margin-top:10px; clear:both; color:#6e6e6e;'>Category: <a href='/support/community-support/blacklist-check'>Blacklist Check</a></div>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='https://lh3.googleusercontent.com/-8sLWT-gyfY8/AAAAAAAAAAI/AAAAAAAAADg/B9rdOgeetf8/photo.jpg?sz=90' class='user_avatar' /><br />
			<a href='/support/community-support/users/youtag'>youtag</a>
			<div>8 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-07-18 5:34 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>2,478</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>a domain under my account &quot;deiereklinik.lu&quot; was briefly hosting a malicious file: &quot;/powered/Welcome1.htm&quot; I was able to remove it within hours thanks to malware notification. (this happened about a month ago, before launch)<br />
<br />
however, the website has been reported as &quot;phishing&quot; by Microsoft, and IE users see a red warning page each time they access any page on the domain. this warning does not go away despite having been reported as safe through their own form!<br />
<br />
anyone knows how long it takes for MS to verify and remove the warning?</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_3570' id='upvote_answer_3570' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='3570' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_3570').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_3570' id='downvote_answer_3570' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='3570' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_3570').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>9,968 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2013-07-18 11:40 am EST
                		        </div>
					
		                </div>

				Hello youtag, and thanks for your question.<br />
<br />
Unfortunately it looks like the official &lt;a href=&quot;http://windows.microsoft.com/en-US/windows-vista/smartscreen-filter-frequently-asked-questions&quot; target=&quot;_blank&quot;&gt;Microsoft SmartScreen Filter FAQ&lt;/a&gt; doesn't give an indication of the turn-around time for a scan:<br />
<br />
&lt;strong&gt;One of the sites I visit is being flagged by SmartScreen Filter, but it's not an unsafe website. What can I do?&lt;/strong&gt;<br />
&lt;i&gt;From the warning, you can choose to report this site as a safe site. Click the Report that this site does not contain threats link to go online to the Microsoft feedback website, and then follow the instructions.&lt;/i&gt;<br />
<br />
I wasn't able to find any references online on how long it takes either. I would assume it's probably going to take a few days at least, which is the typical time it takes for a Google Safe Browsing warning to disappear.<br />
<br />
If you had any further questions at all, please let us know!<br />
<br />
- Jacob
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_3570').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_3570' id='form_comment_on_answer_3570' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hi Jacob, I have read their FAQ already, ... seems SmartScreen is not that smart after all :(<br />
<br />
since I have no access to a PC (and IE for that matter) I have no way to check it for myself. Could you confirm if the URL is still flagged, and notify it as safe if it is so (the only way to do so is to use the link on the red page)?<br />
<br />
Thanks again, Paul</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='https://lh3.googleusercontent.com/-8sLWT-gyfY8/AAAAAAAAAAI/AAAAAAAAADg/B9rdOgeetf8/photo.jpg?sz=90' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/youtag'>youtag</a><br />
									8 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2013-07-18 11:56 am EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello Youtag,<br />
<br />
I checked the website through a few browsers including my version of IE (version 10) and I do not see a warning at this time.  You might need to <a href="http://www.inmotionhosting.com/support/website/how-to/clear-browser-cache" target="new">clear your browser cache</a> if you're still seeing a warning.  <br />
<br />
If you have any further questions or concerns, please let us know.<br />
<br />
Regards,<br />
Arnel C.<br />
</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/blacklist-check/website-reported-unsafe-by-microsoft-smartscreen&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/blacklist-check/website-reported-unsafe-by-microsoft-smartscreen'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="c7c63b5ad12052d8c997c30708abdf71" value="1" />	</div>
	</form>
<!-- <br />
