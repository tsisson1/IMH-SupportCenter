<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:58289:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/comment-spam/unattended-forums-getting-used-for-spam" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-08-19T19:44:53-07:00" />
  <meta name="keywords" content="unattended forums moderator spam" />
  <meta name="author" content="Jacob Nicholson" />
  <meta name="description" content="In this article I'm going to review why an unattended forum getting used for spam, can lead to resource usage problems for your account." />
  <title>Unattended forums getting used for spam - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/comment-spam/unattended-forums-getting-used-for-spam" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:c835255c0556a58ca7f395cc70568a9a -->
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/website/comment-spam' itemprop='url'><span itemprop='title'>Troubleshooting Comment Spam<span></a><div class='dropdown_3columns'><div class='col_3'><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/comment-spam/excessive-amount-of-spam-comments-or-guestbook-entries'>Excessive amount of spam comments, or guestbook entries</a> (7380 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/comment-spam/unattended-forums-getting-used-for-spam'>Unattended forums getting used for spam</a> (4456 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/comment-spam/dealing-with-spam-in-your-posts-and-comments'>Dealing with spam in your posts and comments</a> (3095 hits)</div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Unattended forums getting used for spam</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Unattended forums getting used for spam									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>4,456</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Mar 4, 2013'><span style='color:#606060;'>Published:</span> Aug 19, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In this article I'm going to review why an unattended forum getting used for spam, can lead to resource usage problems for your account.</p>
<h2>What is an unattended forum?</h2>
<p>An unattended forum is considered one where there is not daily or at least weekly moderation of the new user sign-ups, or the new posts that are getting posted on the forum.</p>
<p>The reason why this can be problematic, is that if you end up with a lot of fake user registrations, there can be a lot of resource usage used up while running all the scripts to handle the registration of these users. Also if these users sign up successfully, they could then fill your forum up with spam content.</p>
<p>When your forum is filled with spam content, this can increase the size of your database, cause slow loading, and also possibly damage your search engine ranking if the spam content is left in place.</p>
<p>An unattended forum is also a common cause for an <a href="/support/website/website-troubleshooting/account-suspensions" target="_blank">account suspension</a>, so it's important to be aware of the impact leaving an unattended forum on your account can cause.</p>
<h2>How to resolve spam issues on a forum</h2>
<p>A lot of the time a forum will have been setup for community discussion, but then because of time constraints of simply lack of interest the forum no longer gets used by the moderator. If this is the case and the forum is simply not being used by the community of the website anymore, simply completely removing the forum from your account should help stop it from getting used for spam purposes.</p>
<p>If you still would like to keep your forum active, but just clean up all the spam, then you'll typically need to go through and remove all fake user registration and their posts. Then you'd want to ensure your forum is utilizing a CAPTCHA system for account sign-ups to help prevent automated bots from signing up for new accounts.</p>
<p>If you notice that your forum is always having fake user registration attempts, or spam posts, from certain IP addresses you can also <a href="/support/website/website-troubleshooting/block-unwanted-users-from-your-site-using-htaccess" target="_blank">block unwanted users from your site using .htaccess</a> to prevent them access from even getting to your forum in the first place.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/comment-spam/unattended-forums-getting-used-for-spam&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/comment-spam/unattended-forums-getting-used-for-spam'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MTcmaWQ9NjA0JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
