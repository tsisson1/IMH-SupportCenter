<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:58714:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-3/305-change-database-settings" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-10-02T13:45:41-07:00" />
  <meta name="keywords" content="joomla 3.0 database connection setup" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="If you're having any trouble connecting Joomla 3.0 to a MySQL database, read this article for an overview on the steps needed to ensure you have Joomla setup correctly." />
  <title>305: How to Change your Joomla 3.1 Database Settings - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-3/305-change-database-settings" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:1ac4384405589f96a2eab943bf9edefa -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															305: How to Change your Joomla 3.1 Database Settings									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>26,573</span></div>
							...
							<div style='clear:both;'></div>
								...
								<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/global-configuration/error-displaying-the-error-page-application-instantiation-error.jpg"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="error-displaying-the-error-page-application-instantiation-error" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/global-configuration/error-displaying-the-error-page-application-instantiation-error.jpg" /></a>In our last tutorial, we showed you how having the wrong database credentials in your Joomla 3.0 configuration.php file can cause the <a href="/support/edu/joomla-3/database-errors">Error displaying the error page: Application Instantiation Error</a>. To resolve this database error, you need to confirm that your database credentials with your hosting provider match those set within your Joomla configuration file.</p>
<p>In this tutorial, we are going to give you a broad overview of how to ensure your Joomla 3.0 website is connecting successfully to your MySQL database. This article assumes that you are familiar with basic file editing, using a program such as the <a href="/support/edu/cpanel/cpanel-file-manager/using-file-manager-in-cpanel">File Manager</a> (located within cPanel).</p>
<div style="clear: both;"></div>
<h2>To ensure you are using the correct database settings in Joomla 3.0:</h2>
<ol class="article_list">
<li><strong>Review the database settings you are currently using</strong><br /><br />Using an editor of your choice and open your Joomla configuration.php file. This file will be located in the top level of your Joomla 3.0 files on your server. When you open the file, pay attention to the following settings:<br /><br />
<pre class="code_block">public $host = 'localhost';
public $user = 'juser';
public $password = 'jpass';
public $db = 'jdb';</pre>
<p>As you can see in the above, my database server is <strong>localhost</strong>. I am connecting to a database named <strong>jdb</strong>, with <strong>juser</strong> and <strong>jpass</strong> as the database username and password.</p>
</li>
<li><strong>Confirm with your <a href="http://www.inmotionhosting.com/joomla-hosting.html">Joomla Hosting provider</a> your settings are correct</strong><br /><br />Most hosting providers will give you an interface where you can setup databases. If you're familiar with their tools, confirm that the database settings you are using in your Joomla configuration.php file match what is set on the server. If you can't see the password set on the server, reset it so you can be sure you are using the correct database password. If you need any assistance, contact your host's technical support for further assistance.</li>
<li><strong>If needed, update the database settings in Joomla's configuration.php file</strong><br /><br />The key to connecting Joomla 3.0 to your database successfully is knowing what your database settings actually are on your server, and then making sure they match within Joomla's configuration.php file. For example, if you reset your database password on the server in step 2 above, be sure to update the password in your configuration file as well.</li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 38: 305: How to Change your Joomla 3.1 Database Settings</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 37: <a href='/support/edu/joomla-3/306-configure-smtp'>306: Joomla 3.1 Error - Could not instantiate mail function</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-3/305-change-database-settings&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-3/305-change-database-settings'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xMDEmaWQ9MjM5NyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/7c375d6e4d1adcd74a743a84806161c5?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/7c375d6e4d1adcd74a743a84806161c5'>Zuhair</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-20 8:01 am</div>
				                <div><p>thank you very much for your help,its work.Keep it up guys :)</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29946);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
