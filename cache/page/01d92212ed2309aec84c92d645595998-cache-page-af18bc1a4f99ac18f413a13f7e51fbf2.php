<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:88419:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/managing-files/how-to-move-files-on-server" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-10-17T20:04:56-07:00" />
  <meta name="keywords" content="how to move files file manager cpanel filezilla ftp" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="This article will teach you how to move files from on folder to another in cPanel File Manager and through FileZilla FTP." />
  <title>How do I move files on my server? - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/managing-files/how-to-move-files-on-server" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:2aaf190997e2a99ac46e709dc47c420d -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '115.112.36.34']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How do I move files on my server?									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>11,922</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Feb 5, 2013'><span style='color:#606060;'>Published:</span> Oct 17, 2013</div>
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Comments:</span> <a href='#comments'>9</a></div>
							<div style='clear:both;'></div>
								...
								<p>When working with your website files, it is necessary to move files from one location to another. There are many ways you can move files around on your server. You can use the <a href="/support/edu/cpanel/cpanel-file-manager/using-file-manager-in-cpanel" target="_blank" title="Click here for info"><strong>cPanel File manager</strong></a>, an <a href="/support/website/file-management/getting-started-guide-ftp" target="_blank" title="Click here for info"><strong>FTP program</strong></a>, <a target="_blank" title="Click here for more info on SSH" href="/support/website/general-server-setup/how-to-login-ssh"><strong>Shell using SSH</strong></a>, or and <strong>HTML editor</strong> like DreamWeaver. This tutorial will explain how to move your files in cPanel and using FTP (FileZilla).</p>
...
<a name="file-manager"></a><h2>Moving Files Using cPanel File Manager</h2>
<p>You can use the File manager to move your files on your server. The File Manager is a way you can move your files without having a program installed on your local computer like FileZilla or CyberDuck. This allows you to move your files from any location that has internet access. The following will explain how to drag files to move them and how to use the "<em>Move</em>" button to move files to a specific directory path.</p>
<h3>Dragging files in cPanel File Manager</h3>
<ol class="article_list">
<li><a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel" target="_blank" title="Click here for info">Login into your cPanel.</a> <a href="/support/edu/cpanel/cpanel-file-manager/using-file-manager-in-cpanel" target="_blank" title="Click here for info">Go to the File Manager</a>, select your directory and click Go.</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/how-to/how-to-move-files/cpanel-move-files-1-drag.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Drag files to move them cPanel File Manager" src="//cdn.inmotionhosting.com/support/images/stories/website/how-to/how-to-move-files/cpanel-move-files-1-drag.gif" title="Click here to view the larger image" width="100" /></a>Navigate to the directory that contains the files your want to move. In this case we are moving .png images to the "<em>test</em>" folder.
<p>Select the files and drag them into the directory you want to move them to on the left side. See image to the right.</p>
<br style="clear: both;" />
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/how-to/how-to-move-files/cpanel-move-files-2-in-new-directory.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="New directory cPanel File Manager" src="//cdn.inmotionhosting.com/support/images/stories/website/how-to/how-to-move-files/cpanel-move-files-2-in-new-directory.gif" title="Click here to view the larger image" width="100" /></a>Now the files will show in the "<em>test</em>" folder. <br style="clear: both;" /></p>
</li>
</ol>
<h3>Moving files to a specific directory with the move button</h3>
<ol class="article_list">
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/how-to/how-to-move-files/cpanel-move-files-3-move-link.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Move button cPanel File Manager" src="//cdn.inmotionhosting.com/support/images/stories/website/how-to/how-to-move-files/cpanel-move-files-3-move-link.gif" title="Click here to view the larger image" width="100" /></a>You can also use the "<em>Move</em>" button to move your files if you know the path to the file location.
<p>Select the files you want to move. Right click one of the files to show the options pop up.</p>
<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/how-to/how-to-move-files/cpanel-move-files-3-type-path.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="type path to folder cPanel File Manager" src="//cdn.inmotionhosting.com/support/images/stories/website/how-to/how-to-move-files/cpanel-move-files-3-type-path.gif" title="Click here to view the larger image" width="100" /></a>Type the path to the folder you want to move the files to. In this case we are moving the files to the <code>/public_html/test/images </code>folder.
<p>Click "<em>Move file(s</em>)".</p>
<br style="clear: both;" />
<p>Now the files will show up in the "<em>images</em>" folder.</p>
</li>
</ol>
<h2>Moving Files Using FileZilla</h2>
<p>There are many different FTP programs you can use to move your files around. Most FTP programs work the same way. For tutorial purposes, this section will focus on how to move your files from one folder to another using FileZilla.</p>
<ol class="article_list">
<li><a href="/support/website/file-management/configuring-your-site-in-filezilla" target="_blank" title="Configuring your site in FileZilla ">Open your FileZilla FTP program.</a></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/how-to/how-to-move-files/how-to-move-files-1-begin.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Moving files in filezilla" src="//cdn.inmotionhosting.com/support/images/stories/website/how-to/how-to-move-files/how-to-move-files-1-begin.gif" title="Click here to view the larger image" width="100" /></a>Navigate to the folder where you want to move your files. In this case ware are moving a template from a subdirectory called "<em>templatemo_353_beauty_class</em>" to the "<em>test</em>" folder one directory above.
<p>The "<em>Remote site</em>" is where the files are on the server. The "<em>Filename</em>" box underneath the "<em>Remote Site</em>" box is where your files are for on the server.</p>
<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/how-to/how-to-move-files/how-to-move-files-2-drag-animation.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Drag files to outer folder filezilla" src="//cdn.inmotionhosting.com/support/images/stories/website/how-to/how-to-move-files/how-to-move-files-2-drag-animation.gif" title="Click here to view the larger image" width="100" /></a>You can drag files from one folder location to another. In the image to the right you will see how all the files in one directory are selected and dragged into another folder in the server.
<p>In this example, the files and folders in the "<em>templatemo_353_beauty_class</em>" folder are being dragged to the "<em>test</em>" folder.</p>
Drag the files you selected to the folder you want to move them to. The files will automatically move to that location.<br style="clear: both;" />
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/how-to/how-to-move-files/how-to-move-files-3-files-in-directory.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Files in directory filezilla" src="//cdn.inmotionhosting.com/support/images/stories/website/how-to/how-to-move-files/how-to-move-files-3-files-in-directory.gif" title="Click here to view the larger image" width="100" /></a>Now when you navigate to the folder you will see the files in that directory. <br style="clear: both;" /></p>
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/how-to/how-to-move-files/how-to-move-files-4-drag-within-server.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Drag within the server window filezilla" src="//cdn.inmotionhosting.com/support/images/stories/website/how-to/how-to-move-files/how-to-move-files-4-drag-within-server.gif" title="Click here to view the larger image" width="100" /></a>To move files from a folder to a subfolder, You can select the files and drag them into the folder within the "<em>Filename</em>" box under the "<em>Remote site</em>" box. See the image to the right. In this example we moved the images in the test folder to the images folder.<br style="clear: both;" />
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/how-to/how-to-move-files/how-to-move-files-5-files-moved.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Final view of file location filezilla" src="//cdn.inmotionhosting.com/support/images/stories/website/how-to/how-to-move-files/how-to-move-files-5-files-moved.gif" title="Click here to view the larger image" width="100" /></a> Now the files will be found in the images subfolder. <br style="clear: both;" /></p>
</li>
</ol>
<p>To learn how to edit a file see our tutorial on <a target="_blank" title="Click here for how to edit a file" href="/support/website/how-to/how-to-edit-a-file">How do I edit a file on my server?</a>. Also, see our aticles on <a target="_blank" title="Click for how to create a file" href="/support/website/how-to/create-new-file">How to create a new file</a> and <a target="_blank" title="Click for for how to upload a file" href="/support/website/how-to/how-to-upload-files-server">How do I upload a file to my server?</a>. To see other articles available on how to manage your files, please visit <a target="_self" title="How to manage your files on your server?" href="/support/website/how-to/how-to-manage-files-server">How to manage your files on your server?</a>.</p> 
...
<div style='display:inline-block;'>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NDYmaWQ9NTUzJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="bbe4e609f48cfaf947c09b476cfae27a" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/website-design/change-to-builder?tsrc=rsbraq'>How do I Change from Joomla to the Builder?</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/2311f8e70b773aa983728f636edc186b?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/2311f8e70b773aa983728f636edc186b'>Prezak</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-24 2:31 pm</div>
				                <div><p>Hi,</p>
<p>If I used the way 'Move files to a specific directory using the move button' and moved my files to a directory that it doesn't exist (I typed wrong folder name). Now I cannot find them. I searched them in my cpanel, but I couldn't find them.</p>
<p>Do you know if they are saved to any temporary folder?</p>
<p>Thank you in advance.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13269);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-24 3:15 pm</div>
				                <div>Hello Prezak, and thanks for the great question.<br />
<br />
It can be a bit tricky dealing with moving files in cPanel and on a Linux server and there are a few scenarios you might have encountered.<br />
<br />
Let's say you had a file named &lt;span style=&quot;color: red;&quot;&gt;test.txt&lt;/span&gt; in your &lt;span style=&quot;color: red;&quot;&gt;/public_html&lt;/span&gt; directory, and you decided to click on &lt;strong&gt;Move&lt;/strong&gt; in the &lt;a href=&quot;http://www.inmotionhosting.com/support/edu/cpanel/cpanel-file-manager/using-file-manager-in-cpanel&quot; target=&quot;_blank&quot;&gt;cPanel File Manager&lt;/a&gt;.<br />
<br />
If you set the target destination to &lt;span style=&quot;color: red;&quot;&gt;/public_html/FOLDER&lt;/span&gt; and then click on &lt;strong&gt;Move File(s)&lt;/strong&gt;, it literally changes the file from:<br />
<br />
&lt;span style=&quot;color: red;&quot;&gt;/public_html/test.txt&lt;/span&gt;<br />
<br />
To:<br />
<br />
&lt;span style=&quot;color: red;&quot;&gt;/public_html/FOLDER&lt;/span&gt;<br />
<br />
If the &lt;span style=&quot;color: red;&quot;&gt;/public_html/FOLDER&lt;/span&gt; directory does exist, then moving a file to either &lt;span style=&quot;color: red;&quot;&gt;/FOLDER&lt;/span&gt; or &lt;span style=&quot;color: red;&quot;&gt;/FOLDER/&lt;/span&gt; should move that file there. So your file would end up here if you already had that folder created<br />
<br />
&lt;span style=&quot;color: red;&quot;&gt;/public_html/FOLDER/test.txt&lt;/span&gt;<br />
<br />
If you have multiple files selected and try to move them to a directory that doesn't exist, cPanel should throw an error of &lt;em&gt;FileOp Failire (source file could not be read): Multiple sources may not be moved to a non-directory destination.&lt;/em&gt;. So luckily your files shouldn't be gone for good, or merged all into one.<br />
<br />
So it sounds like you probably just need to look for the misspelled folder that you typed in, but be aware it will be down with the files as it was a folder that didn't exist on the server. So you literally moved your file from having one name to the other, so if you're searching for the original name, you won't find it.<br />
<br />
Please let us know if you're still having issues, or if you were able to locate your files using the method described above.<br />
<br />
- Jacob</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13273);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-24 4:50 pm</div>
				                <div><p>I still cannot find it. To be more specific, I tried to move two files (videos1.zip &amp; videos2.zip) to a folder named public_html/images/stories/videos although I hadn't created the folder videos yet.</p>
<p>I searched for the file public_html/images/stories/videos/videos1.zip and it doesn't find anything.</p>
<p>Any other ideas?</p>
<p>The server seem to have these two files as it has 600MB size and the other files of the server about 150Mb . So, now the used size of the server is about 750MB, so somewhere there are my "precious" files.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13280);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-24 5:25 pm</div>
				                <div>Hello Prezak,<br />
<br />
If you don't have access to secure shell (SSH), then probably the easiest way to search for it is by using the SEARCH function at the top of the cPanel page.  I can't tell if you're a customer or not but in cPanel, you can use the File Manager's search function to find files.  If you know the first part of the file name, you can simply type it in the search field and it will give you a search result based on those few letters - you'll see the path were the file exists in the results. <br />
<br />
Also, you can order the folders by DATE MODIFIED.  That at least give you an idea where the files could be.<br />
<br />
If you can give account particulars, we can always search for the files our selves (if you're our customer).<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13281);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-24 5:34 pm</div>
				                <div><p>This is the way I am searching...through the file manager that cPanel has, and I searched with or without the path (public_html/images/stories/videos/videos1.zip or videos1.zip or a lot of combinations) but it returned 'no results'.</p>
<p>Thank you that&nbsp;you support me although I am not a client of yours.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13282);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-24 6:02 pm</div>
				                <div>Hello Prezak,<br />
<br />
We don't mind helping.  Try widening the search.  You're looking within the vdeos folder.  Have you tried looking in the public_html? Or even just in your HOME folder.  It's possible the files are not in the public_html folder if you put them in the wrong area.  I would suggest speaking with your technical support or whoever has SSH access on the site.  They could find it pretty quickly with access to the shell.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13283);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-24 6:39 pm</div>
				                <div><p>Yes, I have searched all over the server files, not only a specific folder. Anyway, I will contact with the technical support and I hope to find a solution.&nbsp;</p>
<p>Thank you for your help.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13284);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-24 7:14 pm</div>
				                <div>Hello Prezak,<br />
<br />
As I had mentioned in my first reply, if you took the file:<br />
<br />
&lt;span style=&quot;color: red;&quot;&gt;/public_html/videos1.zip&lt;/span&gt;<br />
<br />
Then moved it to a non-existent folder of:<br />
<br />
&lt;span style=&quot;color: red;&quot;&gt;/public_html/images/stories/videos&lt;/span&gt;<br />
<br />
The &lt;span style=&quot;color: red;&quot;&gt;videos1.zip&lt;/span&gt; file should now be located in the &lt;span style=&quot;color: red;&quot;&gt;/public_html/images/stories&lt;/span&gt; directory, and it would be called just &lt;span style=&quot;color: red;&quot;&gt;videos&lt;/span&gt; and it would not be a separate directory containing that same &lt;span style=&quot;color: red;&quot;&gt;.zip&lt;/span&gt; file.<br />
<br />
If you then took your &lt;span style=&quot;color: red;&quot;&gt;videos2.zip&lt;/span&gt; file and tried to move it to the same non-existent directory, because that path is now the file name for your original &lt;span style=&quot;color: red;&quot;&gt;videos1.zip&lt;/span&gt; file, the &lt;span style=&quot;color: red;&quot;&gt;videos1.zip&lt;/span&gt; content would be overwritten with the content from &lt;span style=&quot;color: red;&quot;&gt;videos2.zip&lt;/span&gt;, but again the file name itself would just be &lt;span style=&quot;color: red;&quot;&gt;/public_html/images/stories/videos&lt;/span&gt;.<br />
<br />
So I'd just double-check to make sure you're looking for the file called &lt;span style=&quot;color: red;&quot;&gt;videos&lt;/span&gt;, and not a directory named that, or one of the names of the original &lt;span style=&quot;color: red;&quot;&gt;.zip&lt;/span&gt; files.<br />
<br />
Hope that helps. Please let us know if you are able to find out from your host where the file is if the scenario described above isn't what happened.<br />
<br />
- Jacob</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13289);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-25 8:41 am</div>
				                <div><p>Hi again,</p>
<p>I found a file (about 350MB),not a folder, with the name videos. I think it wasn't in my files, so I deleted it and upload my files again.</p>
<p>Thank you for all.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13304);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
	...
	<div name='fixComments' id='fixComments' style='width:220px; margin:0px; float:right;'>
		<div class='moduletable'>
			<h3><span class='comment-count'>9</span> Questions & <span class='comment-text'>Comments</span></h3>
