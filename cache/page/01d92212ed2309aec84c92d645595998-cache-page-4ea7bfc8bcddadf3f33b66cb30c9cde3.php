<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:46120:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/movable-type" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="InMotion Hosting Support Center" />
  <title>Movable Type | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/movable-type" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:fce632396a1b2c60ca8b070e5280a44a -->
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Movable Type</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	...
	<div class='item-page'>
		<div class='page-header'>
			<h1>Movable Type Education Channel</h1>
		</div>
	
<div style='clear:both;'></div>

<div class='edu_class_listing white_box'>
	<h2>Movable Type Tutorials</h2>
	<ul style='float:left; width:300px; margin-right:20px;'>
<li  ><a href='/support/edu/movable-type/geting-started-movable-type'>101: Getting Started with Movable Type</a></li>
<li  ><a href='/support/edu/movable-type/adding-content-movable-type'>102: Adding Content to Movable Type</a></li>
<li  ><a href='/support/edu/movable-type/change-theme-template-movable-type'>103: Changing the Appearance of Movable Type</a></li>
<li  ><a href='/support/edu/movable-type/widgets-movable-type'>104: Working with Widgets in Movable Type</a></li>
<li  ><a href='/support/edu/movable-type/create-blog-movable-type'>105: Creating a Blog in Movable Type</a></li></ul><ul style='float:left; width:300px; margin-right:20px;'>
<li  ><a href='/support/edu/movable-type/site-security-in-movable-type'>201: Site Security in Movable Type</a></li></ul><div style='clear:both;'></div></div>
...
<div class='edu_most_popular white_box'>
	<h2>Most Popular Articles</h2>
		<div style='width:300px; height:75px; float:left; margin-right:20px;'>
							<a href='/support/edu/movable-type/geting-started-movable-type/moveable-type-admin'>How to log into your Movable Type admin dashboard</a>
							<div class='smallgrey'>Hits: 4,822</div>
						</div>
						<div style='width:300px; height:75px; float:left; margin-right:20px;'>
							<a href='/support/edu/movable-type/change-theme-template-movable-type/edit-footer-banner-module'>Editing the Footer Banner module text in Movable Type</a>
							<div class='smallgrey'>Hits: 2,892</div>
						</div>
						<div style='width:300px; height:75px; float:left; margin-right:20px;'>
							<a href='/support/edu/movable-type/change-theme-template-movable-type/remove-powered-by-reference'>Removing the Powered By information in Movable Type</a>
							<div class='smallgrey'>Hits: 2,587</div>
						</div>
						<div style='width:300px; height:75px; float:left; margin-right:20px;'>
							<a href='/support/edu/movable-type/create-blog-movable-type/creating-blog'>Creating a Blog in Movable Type</a>
							<div class='smallgrey'>Hits: 2,020</div>
						</div>
						<div style='width:300px; height:75px; float:left; margin-right:20px;'>
							<a href='/support/edu/movable-type/change-theme-template-movable-type/change-theme-movable-type'>How to change the theme in Movable Type</a>
							<div class='smallgrey'>Hits: 1,811</div>
						</div>
						<div style='width:300px; height:75px; float:left; margin-right:20px;'>
							<a href='/support/edu/movable-type/create-blog-movable-type/register-new-account'>How to register for an account in Movable Type</a>
							<div class='smallgrey'>Hits: 1,720</div>
						</div>
						<div style='clear:both;'></div>
</div>
...
<form action="http://www.inmotionhosting.com/support/edu/movable-type" method="post" name="adminForm" id="adminForm" class="form-inline">
	...
	<option value="0">All</option>
		...
		<h2>Movable Type - Advanced Tutorials</h2>
		<table style='margin-top:20px;'>
			...
			<tr>
				...
				<td valign='top' style='padding-bottom:15px;'>
					<div><a href='/support/edu/movable-type/301-add-google-analytics'>301: How to Add Google Analytics to a Movable Type Website</a></div>
					<div>301: Setting up Google Analytics is a simple matter due to the Movable Type interface.  Movable Type's templates make it easy to add the Google Analytics code.  The following article explains how to setup Google Analytics using the Movable Type Administrator Dashboard.</div>
					<div class='smallgrey'>
			...
			<tr>
				<td valign='top' style='padding:6px 15px 0px 0px;'><img src='https://lh3.googleusercontent.com/-np8xy9GiNy8/AAAAAAAAAAI/AAAAAAAAAEU/Eu1yKGoTxiA/photo.jpg?sz=50' class='sc_rc' style='width:55px;' /></td>
				<td valign='top' style='padding-bottom:15px;'>
					<div><a href='/support/edu/movable-type/errors-database'>302: Database Connection or Authenication errors wth Movable Type</a></div>
					<div>Occasionally it is possible to have problems with connecting or authenticating to the MySQL database for Movable Type.  The following article describes the errors that you may see.</div>
					<div class='smallgrey'>
						Written by Arnel Custodio<br />
						Hits: 1,595
					</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xMTImaWQ9MTEyJnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="3a3baa73146e943c38636290f29a4ebf" value="1" />	</div>
	</form>
<!-- <br />
