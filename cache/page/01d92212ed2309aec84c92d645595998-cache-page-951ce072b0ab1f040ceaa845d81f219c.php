<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:59106:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/wordpress/i-am-getting-redirect-loops-on-our-site" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Tom, The update could very well be part of the problem. I would suggest to (temporarily) disable all plugins and see if that makes any change. Als..." />
  <title>I am getting redirect loops on our site.... | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/wordpress/i-am-getting-redirect-loops-on-our-site" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:9665cd21286215942df980bf733af213 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '71.204.216.105']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>I am getting redirect loops on our site....</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-07-28 5:57 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>173</span>
			</div>
...
<br />
I called the support line just now to try and get an answer. The guy on the phone couldn't get an answer to my problem and he suggested I contact you to help. <br />
<br />
I noticed some links on my Wordpress site are not working properly and showing a &quot;redirect loop&quot;. I see that when I roll over support on www.nallatech.com and then click on &quot;all fpga cards&quot;, this problem happens. If you notice the &quot;https&quot; in the address bar after clicking &quot;all fpga cards&quot; this is what appears to be the issue and not sure what is happening.  Please help me get my website back to where it was!<br />
<br />
Thanks, Tom</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_7756' id='upvote_answer_7756' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='7756' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_7756').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_7756' id='downvote_answer_7756' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='7756' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_7756').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Tom,<br />
<br />
When I replicated the problem I did not see a https redirect however it just goes back to the from page. Have you tried disabling any plugins to see if they may be causing a problem? Have you made any changes to that page recently? Do you have any custom work in your .htaccess file? I would also suggest clearing your minify cache as well to see if that may resolve the problem. It should not be a database/file structure problem since it is one link that I can find. <br />
<br />
Best Regards,<br />
TJ Edens
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_7756').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_7756' id='form_comment_on_answer_7756' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hi TJ,<br />
<br />
I have tried to disable a few plugins, but I have a lot of them. I can try to disable and troubleshoot this, I was hoping for an easier fix, considering I have not done anything to the site. I did see there was a new Wordpress update though, so it could cause problems with plugins. <br />
<br />
I have not made any changes to the site for a couple weeks. I tested the site and all worked as expected. <br />
<br />
I have not done any custom work to the .htaccess file, no.<br />
<br />
I cleared the minify cache just now and did not clear up the problem. <br />
<br />
I am getting problems on more than just the &quot;solutions / all fpga cards&quot; page with the following links:<br />
http://www.nallatech.com/support/support-inquiry/<br />
<br />
The really strange thing is I made the 'solutions / all fpga cards'  page my 404 error default to page. If you click the following link you can go to my fpga cards page, which is the link above and I cannot navigate to. <br />
<br />
http://www.nallatech.com/solutions/fpga-cardsXXX/<br />
<br />
Tom<br />
</div>
							...
							<td style='width:96px;' valign='top'>
								<img src='https://lh5.googleusercontent.com/-zC-BFl-GDMY/AAAAAAAAAAI/AAAAAAAAAvo/EUcCJJbTwhY/photo.jpg?sz=90' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/isipkg'>isipkg</a><br />
									9 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2015-07-28 6:57 pm EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Also, I inserted the following method to see if it helped. I failed to mention in my prior message that users of our site were not able to login to our support lounge, which after I did the following method, it seemed to help: http://northernoptic.com/2015/07/24/fix-ssl-being-incorrectly-set-in-chrome-v44/<br />
<br />
Also, do you think this could have something to do with the most recent update to Wordpress on July 23rd?</div>
...
<div class=' straight_bottom not_best_answer'>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px; width:50px;' valign='top'>
<div class='vote_div'>
	<form method='post' name='upvote_answer_7767' id='upvote_answer_7767' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='7767' />
		<input type='hidden' name='component' id='component' value='qa' />
		<input type='hidden' name='vote_value' id='vote_value' value='1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_7767').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_7767' id='downvote_answer_7767' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='7767' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_7767').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Tom,<br />
<br />
The update could very well be part of the problem. I would suggest to (temporarily) disable all plugins and see if that makes any change. Also I was able to load up http://www.nallatech.com/support/support-inquiry/ with no errors. Is that url still being a problem for you?<br />
<br />
Best Regards,<br />
TJ Edens
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_7767').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_7767' id='form_comment_on_answer_7767' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
					                <p>You must <a href='/support/login'>login</a> before you can post a comment about this answer.</p>
					        </div></div></div></div>
					</form>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>I found the solution to the problem. It was the WooCommerce plugin that caused the problem. One little check box solved the issue. <br />
<br />
To fix I disabled all plugins and immediately activated back in the Revolutions slider to get site's layout for the most part. Then I went down and activated all WooCommerce plugins. The issue of 'redirect loop' immediately came back. I searched for 'woocommerce redirect loop' and found the thread right away. The 'force http' check box on the checkout tab should not be checked. <br />
<br />
https://wordpress.org/support/topic/redirect-loop-error-with-woocommerce<br />
<br />
Thanks for your help! Tom</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/wordpress/i-am-getting-redirect-loops-on-our-site&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/wordpress/i-am-getting-redirect-loops-on-our-site'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="92cd24e3f8b32d69a616554779cda910" value="1" />	</div>
	</form>
<!-- <br />
