<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:51210:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/wordpress/wordpress-contact-form-does-not-send-email-as-designed" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, Thanks for the question and sorry for the frustration with the form. I logged in with a temporary admin to check your settings and it appears tha..." />
  <title>Wordpress contact form does not send email as designed | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/wordpress/wordpress-contact-form-does-not-send-email-as-designed" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:78bf6ff2c407109acc6368b7ee1ee392 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Wordpress contact form does not send email as designed</h1>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_5650' id='upvote_answer_5650' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='5650' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_5650').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_5650' id='downvote_answer_5650' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='5650' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_5650').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
Thanks for the question and sorry for the frustration with the form.  I logged in with a temporary admin to check your settings and it appears that your Jetpack form was not activated.  Did you turn it off?  Or do you have the form in a different location than the ivbc.org website?  I wanted to see your settings so that we could see what was happening.  If you were not using the SMTP settings for the form, please make sure to do so - you can find those settings by using the <a href="http://www.inmotionhosting.com/support/edu/everything-email/introduction-email/how-to-find-email-settings">email settings</a> of an existing account.   If you can provide us a little more information, we can investigate issue further.<br />
<br />
kindest regards,<br />
Arnel C.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_5650').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_5650' id='form_comment_on_answer_5650' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/wordpress/wordpress-contact-form-does-not-send-email-as-designed&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/wordpress/wordpress-contact-form-does-not-send-email-as-designed'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="36a8546746cfc0ed05da23c1f05b937f" value="1" />	</div>
	</form>
<!-- <br />
