<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:52325:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/ssl/gnupn-key-and-https" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello hsn, Your best option would be to generate a self-signed certificate and use that. You will receive SSL warnings that it is not a commercial SSL, ..." />
  <title>GnuPN key and https | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/ssl/gnupn-key-and-https" rel="canonical" />
...
<script>
  ...
  ga('send', 'pageview');
	...
	<!-- cid:b9caff4cf605de6f679427f72f8e7600 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>GnuPN key and https</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/hsn'>hsn</a>
			<div>20 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-02-06 6:40 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>63</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>hi<br />
I created a GnuPG key so that the login page is accessible through https, but it seems it's not working.<br />
Can I use the created key to access my website through https? If yes, how? If no, can I use my own keys and certificate (I created them in my mac terminal with openssl)? <br />
<br />
I don't need a commercial ssl since I just need it to secure the login page. No online payment. </div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_6482' id='upvote_answer_6482' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='6482' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_6482').submit();"></div>
	</form>
	<div class='vote_sum'>1</div>
	<form method='post' name='downvote_answer_6482' id='downvote_answer_6482' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='6482' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_6482').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello hsn,<br />
<br />
Your best option would be to generate a self-signed certificate and use that.  You will receive SSL warnings that it is not a commercial SSL, but your content will be encrypted.<br />
<br />
Best regards,<br />
JeffMa
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_6482').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_6482' id='form_comment_on_answer_6482' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hi Jeff<br />
Thanks for your reply<br />
I already have a self signed key and certificate, but I dont know where to put it and how am I gonna tell the host to use my key.<br />
And by the way, whats the use of GnuPG if I have to us my own key?</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='/support/images/avatars/default_avatar.jpg' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/hsn'>hsn</a><br />
									20 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2015-02-06 7:34 pm EST
								</div>
				...
				<div style='padding:15px 15px 15px 76px; border:1px solid #ddd; border-top:0px; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>GPG is primarily used to encrypt files and sign documents and not encrypting web traffic.  If you have an self-signed SSL certificate, you may install it using our guide on &lt;a href=&quot;http://www.inmotionhosting.com/support/website/ssl/install-third-party-ssl&quot;&gt;installing SSL certificates&lt;/a&gt;.</div>
				...
				<div style='padding:15px 15px 15px 76px; border:1px solid #ddd; border-top:0px; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Thanks Jeff. I didnt try what was aid in there, but I think thats what Im looking for.</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/ssl/gnupn-key-and-https&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/ssl/gnupn-key-and-https'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="d53cdb041302aee024e3166126b0452b" value="1" />	</div>
	</form>
<!-- <br />
