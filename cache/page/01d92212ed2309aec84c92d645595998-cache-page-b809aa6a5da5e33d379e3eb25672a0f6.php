<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:51671:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/website/how-do-i-point-my-domain-name-to-a-specific-subfolder" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Kevin.Raihala, When you want to have more than one independent website within your hosting account, you will want to create addon domains. These a..." />
  <title>How do I point my domain name to a specific subfolder? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/website/how-do-i-point-my-domain-name-to-a-specific-subfolder" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:f2bd280a9c494d669f702f08561bc5ba -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '64.183.147.198']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>How do I point my domain name to a specific subfolder?</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='http://a0.twimg.com/profile_images/2322564775/8r9lur8hm6iz4n2g2mt3_bigger.png' class='user_avatar' /><br />
			<a href='/support/community-support/users/Kevin&per;Raihala'>Kevin.Raihala</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-04-25 10:09 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>49,177</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I have more than one web site and like to keep them all separated in separate directories in the root of my account. How do I point mydomain.com to a folder below my home directory?</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_2965' id='upvote_answer_2965' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='2965' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_2965').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_2965' id='downvote_answer_2965' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='2965' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_2965').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>37,019 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2013-04-25 10:22 am EST
                		        </div>
					
		                </div>

				Hello Kevin.Raihala,<br />
<br />
When you want to have more than one independent website within your hosting account, you will want to <a href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-manage-domains/adding-add-on-domain-in-cpanel" target="_blank">create addon domains</a>. These addon domains will assign a subfolder, typically with the same name as the domain, under the public_html directory. The website files for that domain will be kept there. <br />
<br />
For example, if I want to add <em>domainb.com</em> as an addon, its folder will appear on the server as <em>public_html/domainb.com</em>.  This is true for all addon domains by default.<br />
<br />
If you have already created addon domains, you can always <a href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-manage-domains/modify-addon-domain-document-root" target="_blank">alter their document root</a> as you see fit.<br />
<br />
Your <a href="http://www.inmotionhosting.com/support/website/how-to/locate-primary-domain-name" target="_blank">main domain</a>, (the primary one assigned to your account) does not have this ability by default. Its <a href="/support/ http://www.inmotionhosting.com/support/website/getting-started-guides/where-to-upload-files#document-root" target="_blank">root folder</a> is simply the <em>public_html</em> folder itself. If you wish to have the primary domain have its own folder, then our support team will need to make a change known as a '<a href="http://www.inmotionhosting.com/support/website/general-server-setup/changing-the-document-root-with-root-access" target="_blank">document root change</a>' .   As noted in the previous link:<br />  "<em>changing a primary domain doc root is NEVER RECOMMENDED by InMotion Hosting. cPanel restores packages based on default settings and miss document root changes. So if the account is moved, the accounts with the doc root change may break.</em>"<br />
<br />
If you wish to have a document root change performed, however, you will need to <a href="http://www.inmotionhosting.com/support/community-support/website/how-do-i-point-my-domain-name-to-a-specific-subfolder" target="_blank">contact our Live Support department</a> at <strong>support@inmotionhosting.com</strong> with that request. Be sure to validate your account with either the last 4 digits of the credit card on file, or the current <a href="http://www.inmotionhosting.com/support/website/general-server-setup/what-is-my-username-and-password#amp" target="_blank">Account Management Panel (AMP) password</a>.<br />
<br />
Best Regards,<br />
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_2965').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_2965' id='form_comment_on_answer_2965' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/website/how-do-i-point-my-domain-name-to-a-specific-subfolder&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/website/how-do-i-point-my-domain-name-to-a-specific-subfolder'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="da4e15fed0ad7e538a903df2ac58907a" value="1" />	</div>
	</form>
<!-- <br />
