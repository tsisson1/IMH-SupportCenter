<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:76256:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-3/banners/show-banner" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-11-06T15:50:28-08:00" />
  <meta name="keywords" content="show joomla 3.0 banner module" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="Now that we've created a new banner, the next step is to create a banner module to show the banner on our site." />
  <title>How to show a banner in Joomla 3.1 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-3/banners/show-banner" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:add49db93b327cc12353e7eae579d5a1 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '86.155.77.162']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to show a banner in Joomla 3.1									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>18,269</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Oct 31, 2012'><span style='color:#606060;'>Published:</span> Nov 6, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>If you're following along in our tutorial series on using Joomla 3.0 banners, we now know how to create both <a href="/support/edu/joomla-3/banners/create-banner">image banners</a> and <a href="/support/edu/joomla-3/banners/banner-code">flash banners</a>. Creating a banner doesn't automatically show it on your website, and so that's the next topic we will discuss.</p>
<h2>How to create a banner module</h2>
<p>In order to show a banner on your website, you need to create a banner module. Creating a banner module allows you to specify what banners to show on your page, and into which module positions they will show.</p>
...
<li>Under <em>Select a Module Type</em>, click <strong>Banners</strong></li>
<li>There are many settings available for your banner module. In our testing we focused on the following essential options:<br />
<table class="article_table">
<tbody>
<tr><th>Title</th>
<td>Module must have a Title. This title will show on your site by default, however setting the <em>Show Title</em> option to <em>Hide</em> will prevent this title from showing.<br /><br />In our testing, we entered <em>Your banner here!</em> as the module title.</td>
</tr>
<tr><th>Position</th>
<td>You may select a module position from the modal display of pre-defined positions where you can filter by type and template, or enter your own module position by typing the name in the field and Save.<br /><br />In our testing, we chose <em>Left [position-8]</em>. If you're not sure about how to choose a module position, <a href="/support/edu/joomla-3/extension/viewing-module-positions">learn more here</a>.</td>
</tr>
</tbody>
</table>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/banners/our-banner-is-now-shown-in-joomla.jpg"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="our-banner-is-now-shown-in-joomla" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/banners/our-banner-is-now-shown-in-joomla.jpg" /></a>When finished entering the details of your new module, click <strong>Save</strong> in the top left menu. You can see in the screenshot to the right our new banner is now showing!</p>
<div style="clear: both;">&nbsp;</div>
</li>
</ol>
<h2>Why is my banner not showing up?</h2>
<p>If your banner is missing or not displaying correctly, there are a few things you check:</p>
<ol class="article_list">
<li><strong>Check Client and Cateogry settings</strong><br /><br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/banners/banner-client-and-category-settings.jpg"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="banner-client-and-category-settings" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/banners/banner-client-and-category-settings.jpg" /></a>If you are organising your banners by client and category, it can can make it more difficult to get your banner to work properly. You'll want to check your banner module's client and category settings to ensure they are correct. For example, if you set a banner to Category A and your banner module only shows banners from Category B, then your banner will not show.<br /><br />To check banner module client / category settings, go to: <strong>Extensions</strong> » <strong>Module Manager</strong> » Click the banner module in question » Click the <strong>Basic Options</strong> tab » Find the <strong>Client</strong> and <strong>Category</strong> settings. If you believe one of these settings is causing your banners not to show, "reset" them by setting the <em>Client</em> setting to <strong>- No client -</strong> and the <em>Category</em> setting to <strong>- All Categories -</strong>
<div style="clear: both;">&nbsp;</div>
</li>
<li><strong>Check your Search By Tag setting</strong><br /><br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/banners/disable-search-by-tag.jpg"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="disable-search-by-tag" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/banners/disable-search-by-tag.jpg" /></a>The banners component is a very powerful tool, and one of the more advanced features is the tagging system. Unfortunately if you don't have any tags set for your banners but you have the <strong>Search by Tag</strong> setting enabled, your banners will not show.<br /><br />To disable the Search by Tab setting, go to: <strong>Extensions</strong> » <strong>Module Manager</strong> » Click the banner module in question » Click the <strong>Basic Options</strong> tab » Find the <strong>Search by Tab</strong> setting and change this to <strong>No</strong>
<div style="clear: both;">&nbsp;</div>
</li>
<li><strong>Check your version of Joomla</strong><br /><br />If you are using Joomla 3.0, please upgrade to Joomla 3.0.1 as there were a few bugs in the Banners Component that have been resolved (we personally faced this issue)</li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/joomla-3/banners'>209: Working with Banners in Joomla 3</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 3: How to show a banner in Joomla 3.1</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 2: <a href='/support/edu/joomla-3/banners/banner-code'>Using HTML to show a swf flash banner in Joomla 3.1</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 4: <a href='/support/edu/joomla-3/banners/create-new-category'>How to create a banner Category in Joomla 3.1</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-3/banners/show-banner&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-3/banners/show-banner'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yOTImaWQ9MTk1MyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="7c1e40a632101058e7fa020b1e5fd32f" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/joomla-3/banners?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Working with Banners in Joomla 3</h3></a>
		<table><tr><td colspan='2'><h4>Creating and Showing Banners</h4></td></tr>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/joomla-3/banners/create-banner?tsrc=rsbedu'>How to create a new image banner in Joomla 3.1</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/joomla-3/banners/banner-code?tsrc=rsbedu'>Using HTML to show a swf flash banner in Joomla 3.1</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/joomla-3/banners/show-banner?tsrc=rsbedu'>How to show a banner in Joomla 3.1</a></td>
                </tr>
        <tr><td colspan='2'><h4>Banner Categories and Clients</h4></td></tr>  <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/joomla-3/banners/create-new-category?tsrc=rsbedu'>How to create a banner Category in Joomla 3.1</a></td>
                </tr>
          <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/joomla-3/banners/create-client?tsrc=rsbedu'>How to create a Banner Client in Joomla 3.1</a></td>
                </tr>
        <tr><td colspan='2'><h4>Impression and Click Data</h4></td></tr>  <tr >
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/joomla-3/banners/tracking?tsrc=rsbedu'>Tracking Banner Impressions and Clicks in Joomla 3.1</a></td>
                </tr>
        <tr><td colspan='2'><h4>Miscellaneous Tutorials</h4></td></tr>  <tr >
                        <td valign='top'>7.</td>
                        <td><a href='/support/edu/joomla-3/banners/banner-size?tsrc=rsbedu'>How to change Joomla 3.1 Banner Sizes</a></td>
                </tr>
          <tr >
                        <td valign='top'>8.</td>
                        <td><a href='/support/edu/joomla-3/banners/open-same-window?tsrc=rsbedu'>Controlling which windows banners open into in Joomla 3.1</a></td>
                </tr>
          <tr >
                        <td valign='top'>9.</td>
                        <td><a href='/support/edu/joomla-3/banners/rotating?tsrc=rsbedu'>Rotating Banners in Joomla 3.1</a></td>
                </tr>
          <tr >
                        <td valign='top'>10.</td>
                        <td><a href='/support/edu/joomla-3/banners/side-by-side?tsrc=rsbedu'>How to show Joomla 3.1 banners side by side</a></td>
                </tr>
          	</table>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/75f53ef8c0ea94eb7347d9338eebb9a6?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/75f53ef8c0ea94eb7347d9338eebb9a6'>joan</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-29 5:12 pm</div>
				                <div><p>Hello, thank you for the tutorial.</p>
<p>my problem is that when I create a banner and then the module pointing to the same category, my banner shows duplicated in the banner position (top of the page) and in the right position (the place where I really want to appear). If I decide to unpublish the banner, it disappears both banners, the baner created and the module.</p>
<p>can you help me?</p>
<p>thank you</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10288);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-14940'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/d6262e7a9c7ea30aa687bbd0cc77d2f2?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/d6262e7a9c7ea30aa687bbd0cc77d2f2'>prabhjot suri</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-10 9:45 pm</div>
				                <div>This is complete in itself. No changes required.  Thanks a ton. Keep on helping me in developing new websites. </div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14940);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-31426'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/9618fbb22193058e5d0563234cea39f8?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/9618fbb22193058e5d0563234cea39f8'>Janaq Shimplaku</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-23 3:31 pm</div>
				                <div><p>hellow&nbsp;</p>
<p>I am new user of joomla</p>
<p>I need a help</p>
<p>I am not able to put the categories in a meny</p>
<p>and the layout is not very clear how is in the google blog</p>
<p>can You help me how to put the categories in meny and how to understand the layout clearly and how to put a video My site in joomla is&nbsp;https://beautyhealth.demojoomla.com/</p>
<p>an how to change foto of the header&nbsp;</p>
<p>all this question are for reason of I do not undrstand better layout</p>
<p>thankyou very much for spending the time with me</p>
<p>regards&nbsp;</p>
<p>Janaq Shimplaku</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31426);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-23 4:42 pm</div>
				                <div>Hello Janaq,<br />
<br />
Sorry to hear that you'r having problems with the use of Joomla.  We unfortunately do not offer personal help with the use of the software, but you can use our tutorials to helps answer the questions that you have posted. We have many tutorials that you can find <a href="http://www.inmotionhosting.com/support/edu/joomla-3">here</a>, and we also have many video tutorials.  If you look in YouTube, you will hundreds if not thousands of video tutorials showing you how to changes that you are asking for.  <br />
<br />
I hope this helps to provide answers for your questions, please let us know if you require any further  questions.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31429);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-32441'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/d70c9e0264c79b71b9420bcaa707140b?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/d70c9e0264c79b71b9420bcaa707140b'>sanket thakkar</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-05-04 2:03 am</div>
				                <div><p>how can fetch banners in home page (index.php) in joomla</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32441);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-05-04 12:34 pm</div>
				                <div>Hello Sanket,<br />
<br />
Sorry for the problem with fetching banners in the home page in your Joomla installation.  We're not exactly sure what you are asking.  Can you please describe in detail what you are trying to do?<br />
<br />
If you have any further questions or comments, please let us know.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32457);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
