<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49766:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/registrations-and-transfers/help-with-googlebot-cant-access-your-site-error" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Thank you for your question south! You will get that error from Google if the crawler has an error reaching the server. This can be caused by a temp DNS..." />
  <title>Help with Googlebot can&amp;amp;#039;t access your site Error | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/registrations-and-transfers/help-with-googlebot-cant-access-your-site-error" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:ebda02165b29dfc4345d7aebcc2537fa -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Help with Googlebot can&amp;amp;#039;t access your site Error</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/south'>south</a>
			<div>15 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-03-18 4:23 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>677</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I'm getting a: Googlebot can't access your site error.   Getting &quot;Google couldn't access your site because of a server connectivity issue.  &quot;Re-did my sitemap and resubmitted it Google.  Re-did fetch.  </div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_2439' id='upvote_answer_2439' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='2439' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_2439').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_2439' id='downvote_answer_2439' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='2439' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_2439').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>5,889 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2013-03-18 4:34 pm EST
                		        </div>
					
		                </div>

				Thank you for your question south!<br />
<br />
You will get that error from Google if the crawler has an error reaching the server. This can be caused by a temp DNS connection or network problem at the time that report was made. If you recently made DNS changes on your domain such as a nameserver change or an A record change and so forth, you will get that error from Google. You shouldn't see the error again unless there is a permanent DNS problem with your site. Currently your domain is pointing correctly. <br />
<br />
Best Regards,<br />
James R
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_2439').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_2439' id='form_comment_on_answer_2439' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/registrations-and-transfers/help-with-googlebot-cant-access-your-site-error&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/registrations-and-transfers/help-with-googlebot-cant-access-your-site-error'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="825775c105bb60e7cfb9feec54eba9a9" value="1" />	</div>
	</form>
<!-- <br />
