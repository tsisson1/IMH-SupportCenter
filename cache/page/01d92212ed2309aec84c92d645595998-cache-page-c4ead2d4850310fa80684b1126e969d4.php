<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:55944:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-3/login-description-image" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-01-10T20:26:13-08:00" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="In this tutorial, we'll show you how to use the Login Description Text and Login Image settings. These options allow you to add additional text/images to your Joomla login pages." />
  <title>Using the Joomla Login Description Text and Login Image settings - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-3/login-description-image" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:056b45fb1f9e522e7d67f90f848afbc8 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '190.210.214.14']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Using the Joomla Login Description Text and Login Image settings									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 10, 2014'><span style='color:#606060;'>Published:</span> Jan 10, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>When creating a Joomla <em>Login Form</em> <a href="/support/edu/joomla-3/menu/add-menu-item">menu item</a>, two of the several options you'll see are <strong>Login Description Text</strong> and <strong>Login Image</strong>. The <em>Login Description Text</em> allows you to show a block of text before the login form itself, and the <em>Login Image</em> setting allows you to show an image before the login form.</p>

<h2>How does the Login Description Text and Login Image appear?</h2>

<p>In our testing, we entered the following details:</p>

<div class='white_box' style='margin:15px 0px;'>
  <p><strong>Login Description Text</strong>: <em>Please sign in to access more features</em>.</p>
  <p><strong>Login Image</strong>: We selected <em>images/banners/osmbanner2.png</em></p>
</div>

<p>In the screenshot below, you can see how these changes affected our Login Form.</p>

<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/menu-item-types/login-description-and-image.gif"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/menu-item-types/login-description-and-image.gif"  style='max-width:675px; margin:15px 0px;' /></a>

<p class='alert alert-warning'><strong>Please note!</strong> The Login Description setting must be set to Show in order to see Login Description Text. It does not however affect whether or not the Login Image is displayed.</p>

<h3>How to change the Login Description Text and Login Image</h3>

<ol class='article_list'>
  
  <li><a href="/support/edu/joomla-3/getting-started/login-dashboard">Login to your Joomla Admin Dashboard</a></li>

  <li>In the top menu, Click <strong>Menus</strong> and then click <strong>Menu Manager</strong></li>

  <li>Click the name of the menu your <em>Login Form</em> belongs to, and when the page refreshes, find and click on your Login Form menu item</li>

  <li>Click the <strong>Options</strong> tab. From here, enter in a <strong>Login Description Text</strong>, Select a <strong>Login Image</strong>, and click <strong>Save</strong> in the top left of the page.</li>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 29: Using the Joomla Login Description Text and Login Image settings</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 28: <a href='/support/edu/joomla-3/page-title-page-header'>Changing Page Display options for Joomla 3 menu items</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-3/login-description-image&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-3/login-description-image'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xMDEmaWQ9MzA2MSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="288463e1d515adc2cb6025b3a00bc825" value="1" />	</div>
	</form>
<!-- <br />
