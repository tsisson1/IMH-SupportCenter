<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:74332:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/how-do-i-clear-my-local-dns-cache" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-08-06T12:45:10-07:00" />
  <meta name="keywords" content="flush DNS clear cache windows mac linux command line flushdns" />
  <meta name="author" content="Tim Sisson" />
  <meta name="description" content="Learn how to flush or clear your local computer's DNS cache. " />
  <title>How do I clear my local DNS cache? - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/how-do-i-clear-my-local-dns-cache" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:b1c5c7efc6174bfa2e6b72faf7d97ca0 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '112.198.103.36']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How do I clear my local DNS cache?									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>56,528</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Nov 23, 2011'><span style='color:#606060;'>Published:</span> Aug 6, 2015</div>
...
<button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('flush-windows-cache');">Flush Windows Cache</button>
<button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('flush-osx-cache');">Flush Mac OS X Cache</button>
<button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('flush-linux-cache');">Flush Linux Cache</button>
</div>


<p>DNS resolves domain name to IP addresses so people do not have to remember a series of numbers (IP addresses) when trying to visit a website. In order the speed up this process and reduce the traffic on the DNS servers, most computer operating systems will store or cache DNS lookups on your computer locally. At times, you may need to clear the cache to see changes . In this tutorial, we'll show you how to clear the DNS cache for the major operating systems on the market. Typically, this process is referred to as clearing or flushing the local DNS cache.</p>

<a name="flush-windows-cache"></a>
<h2>Flushing Local DNS Cache in Windows</h2>
<p>Open the command line window, and depending on your version of Windows, this can be done in one of the following ways:</p>
<ul>
<li><strong>Windows 7 and Vista</strong>:                                                        
<ul>
<li>Click on the Start Menu&nbsp;</li>
<li>Type cmd in the search box</li>
<li>Right click on cmd in the programs search results and choose Run as Administrator</li>
</ul>
</li>
<p> </p>
<li><strong>Windows 98/NT/2000/XP</strong> 
<ul>
<li>Click on the Start Menu</li>
<li>Select Run</li>
<li>Type or select cmd to open the command line window</li>
</ul>
</li>
</ul>
<p> </p>
<p>Once the command line window is open type the following command at the prompt and hit enter</p>
<p class="code_block">ipconfig /flushdns</p>
<p>After the flushdns is cpmpleted, type <strong>exit</strong> to close the command line window.</p>

<a name="flush-osx-cache"></a>
<h2>Flushing Local DNS Cache in Mac OS X</h2>
<h3>OS X 10.10</h3>
<ul>
<li>Open a Terminal window</li>
<li>Type this command and hit <strong>return</strong>
<p class="code_block">sudo discoveryutil mdnsflushcache</p>
<p class ="alert alert-info">As of version 10.10.4, Apple has changed the command to the following:
  </p>
<p class="code_block">
...
<h3>OS X 10.7 - 10.9</h3>
<ul>
<li>Open a Terminal window</li>
<li>Type this command and hit <strong>return</strong>
<p class="code_block">sudo killall -HUP mDNSResponder</p>
</li>
<li>Close the terminal window</li>
</ul>

<h3>OS X 10.6 and below</h3>
<ul>
<li>Open a Terminal window</li>
<li>Type this command and hit <strong>return</strong>
<p class="code_block">sudo dscacheutil -flushcache</p>
</li>
<li>Close the terminal window</li>
</ul>

<a name="flush-linux-cache"></a>
<h2>Flushing Local DNS Cache in Linux</h2>
<p>With the various distributions of Linux, you will find that by some run a daemon in the background to manage DNS cache, while others do not. Ubuntu is a good example of a distribution that doesn't run this daemon by default. If you're running Ubuntu and you have not already installed the ncsd daemon, you can install it with this command:</p>
<p class="code_block">sudo aptitude install nscd</p>
<p>To restart the ncsd deamon in Linux, use this command:</p>
<p class="code_block">sudo /etc/init.d/networking restart</p>
<p>If you need further assistance please feel free to <a href="/support/website/website-troubleshooting/how-to-get-great-technical-support">contact our support department</a>.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/how-do-i-clear-my-local-dns-cache&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/how-do-i-clear-my-local-dns-cache'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD02OCZpZD04NTgmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="168d7478f0f0f191c19cc29b8306e6eb" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/3c04eb76ed9b29be254758dd2d0bd52b?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/3c04eb76ed9b29be254758dd2d0bd52b'>Pete </a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-07 10:38 am</div>
				                <div><p>I have windows 8 and I have tried 3 times to flush dns 3 times and it doesn't work.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17197);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-07 12:18 pm</div>
				                <div>Hello Pete,<br />
<br />
The command is the same for Windows 8, however is there a certain domain you are trying to go to but your DNS is cached? Can you provide such domain or why you are needing to flush your local DNS cache?<br />
<br />
Kindest Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17208);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/0925422859c3c7c5811ede511aa0ac10?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/0925422859c3c7c5811ede511aa0ac10'>Jeffrey</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-05-13 1:25 pm</div>
				                <div><p>Youshould update these infos.</p>
<p>Use what apple suggests :</p>
<p>https://support.apple.com/en-ca/HT202516</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23385);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-05-18 4:08 pm</div>
				                <div>Hello Jeffrey,<br />
<br />
Thank you for your suggestion. I have updated the article with the latest information as per your recommendation. <br />
<br />
The steps for clearing cache in Mac OSX should now be accurate.<br />
<br />
If you have any further suggestions, please let us know.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23514);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-24451'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/d2c8eedd364f1faac832e256fee98bb0?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/d2c8eedd364f1faac832e256fee98bb0'>Moin Uddin</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-25 3:50 pm</div>
				                <div><p>i am using windows 8 i am also 2 times sucessfully clear DNS cache but my site is not open proper show message (http://www.example.com/cgi-sys/suspendedpage.cgi</p>
<h2 style="margin: 0px 0px 15px; padding: 0px; font-size: 20px; font-family: arial; text-align: center; background-color: rgb(223, 244, 254);"><strong style="margin: 0px; padding: 0px;">This Account Has Been Suspended</strong></h2>
<p>how to solve this problem please solve this as soon as possbile.&nbsp;</p>
<p>www.example.com</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24451);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-25 4:37 pm</div>
				                <div>Hello Moin,<br />
<br />
Thank you for contacting us. When I navigate to your site, I see "we are sorry but this store is down for maintenance<br />
please try again later ..."<br />
<br />
Have you tried <a href="http://www.inmotionhosting.com/support/website/how-to/clear-browser-cache">clearing your browser cache</a>, testing in a different browser (such as Chrome FireFox, Safari, IE, etc.), or testing on a different computer, or device?<br />
<br />
Are you able to try on different network, for example if you are on a college campus, library, or coffeeshop.<br />
<br />
If it is only on one computer, check that you have not made any <a href="http://www.inmotionhosting.com/support/website/how-to/modifying-your-hosts-file">Host File Modifications</a>.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24459);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						...
						<div><a style='font-size:16px;' href='/support/community-support/users/jenett'>jenett</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-04 1:55 pm</div>
				                <div>The instructions you show for OS X 10.10 no longer work as of 10.10.4 as 'discoveryutil' was removed with that update.  Per https://support.apple.com/en-us/HT202516, they've reverted to using &quot;sudo killall -HUP mDNSResponder&quot; for v10.10.4.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25458);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-05 10:26 am</div>
				                <div>In the end, restarting my computer seemed to work best (OS X v10.10.4)</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25493);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-06 8:46 am</div>
				                <div>Hello Jenett,<br />
<br />
Thanks for the information - I did update the article to reflect the change mentioned in the link that you provided.  <br />
<br />
If you have any further questions or comments, please let us know.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25526);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
