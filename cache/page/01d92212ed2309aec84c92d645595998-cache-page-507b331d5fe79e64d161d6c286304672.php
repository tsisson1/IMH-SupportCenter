<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:59251:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/prestashop-15/managing-price-rules/create-cart-rule" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-08-13T16:20:59-07:00" />
  <meta name="keywords" content="create cart rule Prestashop 1.5" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="This PrestaShop 1.5 article walks you through creating a basic cart rule." />
  <title>How to create a cart rule in PrestaShop 1.5 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/prestashop-15/managing-price-rules/create-cart-rule" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:0c8eeb8f4b29edff849f994d1d508637 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to create a cart rule in PrestaShop 1.5									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>1,662</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Aug 10, 2012'><span style='color:#606060;'>Published:</span> Aug 13, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>PrestaShop 1.5 has newly updated cart rules. These allow you to be more specific and flexible with discounts than in the previous PrestaShop 1.4. Creating a cart rule is a straightforward process when you follow the instructions below.</p>
<p><strong>Creating a Cart Rule in PrestaShop 1.5</strong></p>
...
<li>You are now on the <strong>Cart Rules</strong> screen. Click on the green <strong>Add New</strong> button found in the upper right hand corner to continue.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Price_Rules/Cart_Rules/Add_Rule/cart-rule-add.png"><img  alt="cart-rule-add" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Price_Rules/Cart_Rules/Add_Rule/cart-rule-add.png" /></a></li>
<li>From this page, you need to first name the rule by entering data in the <strong>Name</strong> field. This is the only required field. <br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Price_Rules/Cart_Rules/Add_Rule/cart-rule-data.png"><img  alt="cart-rule-data" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Price_Rules/Cart_Rules/Add_Rule/cart-rule-data.png" /></a></li>
<li>Click on the green <strong>Save</strong> button in the upper right corner to save your new rule. Your new rule will now appear in the cart rules list.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Price_Rules/Cart_Rules/Add_Rule/add-rule-after.png"><img  alt="add-rule-after" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Price_Rules/Cart_Rules/Add_Rule/add-rule-after.png" /></a></li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 2: How to create a cart rule in PrestaShop 1.5</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 1: <a href='/support/edu/prestashop-15/managing-price-rules/intro-cart-rules'>Introduction to Cart Rules in PrestaShop 1.5</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 3: <a href='/support/edu/prestashop-15/managing-price-rules/delete-cart-rule'>How to delete a cart rule in PrestaShop 1.5</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/prestashop-15/managing-price-rules/create-cart-rule&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/prestashop-15/managing-price-rules/create-cart-rule'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNzYmaWQ9MTY3MyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="ff6f7d4435be45010c57a57c20b9bba6" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<table><tr><td colspan='2'><h4>Basic Cart Rule (voucher) Management</h4></td></tr>  <tr >
                        <td valign='top'>1.</td>
