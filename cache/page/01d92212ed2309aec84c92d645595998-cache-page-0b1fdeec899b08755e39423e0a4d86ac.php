<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:51683:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/email-troubleshooting/550unrouteable-address" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Thank you for your question RickP! We looked at your bestbadge.com domain and Hostgator still has your domain in their DNS server configuration. When yo..." />
  <title>550-Unrouteable address | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/email-troubleshooting/550unrouteable-address" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:e517fc66bddf94fcff7cbf96656953ae -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>550-Unrouteable address</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/RickP'>RickP</a>
			<div>13 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-03-07 5:57 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>9,577</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>My email messages to a Hostgater hosted account are returned with these error messages:<br />
SMTP error from remote mail server after RCPT TO::<br />
    host riches2me.com [50.22.80.51]: 550-Verification failed for <br />
    550-Unrouteable address<br />
    550 Sender verify failed<br />
<br />
I'm using mail.bestbadge.com as SMTP server and don't know of any problems sending to other addresses.  What is the meaning of these error codes &amp; how do I fix it?<br />
</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_2382' id='upvote_answer_2382' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='2382' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_2382').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_2382' id='downvote_answer_2382' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='2382' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_2382').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>5,889 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2013-03-07 10:32 am EST
                		        </div>
					
		                </div>

				Thank you for your question RickP!<br />
<br />
We looked at your bestbadge.com domain and Hostgator still has your domain in their DNS server configuration. When you email riches2me.com from your bestbadge.com on our server, when the email resolves at Hostgator, the Hostgator server sees your domain in their DNS as delivering email locally ( to the Hostgator server ); however, there is no email account at Hostgator so it gives the 550 no such user error. <br />
<br />
The following NS look up from the Linux command line shows your domain still in their nameserver cluster.<br />
<br />
&lt;div style=&quot;margin-left:20px;&quot;&gt;&lt;strong&gt;dig @ns1346.websitewelcome.com bestbadge.com&lt;/strong&gt;<br />
<br />
; &lt;&lt;&gt;&gt; DiG 9.8.2rc1-RedHat-9.8.2-0.10.rc1.el6_3.6 &lt;&lt;&gt;&gt; @ns1346.websitewelcome.com bestbadge.com<br />
; (1 server found)<br />
;; global options: +cmd<br />
;; Got answer:<br />
;; -&gt;&gt;HEADER&lt;&lt;- opcode: QUERY, status: NOERROR, id: 38873<br />
;; flags: qr aa rd; QUERY: 1, ANSWER: 1, AUTHORITY: 2, ADDITIONAL: 2<br />
;; WARNING: recursion requested but not available<br />
<br />
;; QUESTION SECTION:<br />
;bestbadge.com.                 IN      A<br />
<br />
;; ANSWER SECTION:<br />
bestbadge.com.          14400   IN      A       66.117.4.196<br />
<br />
;; AUTHORITY SECTION:<br />
bestbadge.com.          86400   IN      NS      ns1345.websitewelcome.com.<br />
bestbadge.com.          86400   IN      NS      ns1346.websitewelcome.com.<br />
<br />
;; ADDITIONAL SECTION:<br />
ns1345.websitewelcome.com. 14400 IN     A       50.22.80.51<br />
ns1346.websitewelcome.com. 14400 IN     A       50.22.67.32&lt;/div&gt;<br />
<br />
You will need to contact Hostgator or the person who had your domain at Hostgator and have them remove the domain from their DNS. <br />
<br />
If your Domain was not in the Hostgator DNS cluster, you would get a &quot;Not Found&quot; when digging your domain at their nameservers like the following  results:  <br />
<br />
&lt;div style=&quot;margin-left:20px;&quot;&gt;dig: couldn't get address for 'ns1346.websitewelcome.com': not found&lt;/div&gt;<br />
Unfortunately this is not the case. Sorry for the inconvenience. There is nothing we can do from our end.<br />
<br />
Best Regards,<br />
James R
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_2382').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_2382' id='form_comment_on_answer_2382' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/email-troubleshooting/550unrouteable-address&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/email-troubleshooting/550unrouteable-address'></div>
<script type='text/javascript'>
  (function() {
