<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49973:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/website/can-i-increase-phpvalue-maxinputvars-on-my-server" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, Thank you for your question about increasing the php_value max_input_vars. This is a PHP setting you can adjust in your cPanel at any time. This ..." />
  <title>Can I increase php_value max_input_vars on my server? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/website/can-i-increase-phpvalue-maxinputvars-on-my-server" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:16a0cf24d9ede39e4461e24caec23b91 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '78.83.95.30']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Can I increase php_value max_input_vars on my server?</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-03-20 6:16 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>2,633</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I have a website that list many products that I sell in my store.  I use wordpress and Marketpress plugin to manage all the products, my problem occurs when I create a menu of categories and submenu of products under each catgory. The menu wont display and prevents the rest of the content from displaying as well. Researching this increasing my php_value max_input_vars to 5000 may work.</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_6831' id='upvote_answer_6831' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='6831' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_6831').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_6831' id='downvote_answer_6831' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='6831' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_6831').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
Thank you for your question about increasing the <strong>php_value max_input_vars</strong>. This is a PHP setting you can adjust in your cPanel at any time.<br />
<br />
This is covered in depth in our guide on how to <a href="http://www.inmotionhosting.com/support/website/php/update-local-php-settings">Change PHP settings in your hosting account</a>.<br />
<br />
...
John-Paul
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_6831').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_6831' id='form_comment_on_answer_6831' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/website/can-i-increase-phpvalue-maxinputvars-on-my-server&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/website/can-i-increase-phpvalue-maxinputvars-on-my-server'></div>
<script type='text/javascript'>
  (function() {
