<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:66800:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/wordpress-plugins/woocommerce-exclude-products" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-04-26T16:41:25-07:00" />
  <meta name="author" content="Jeff Matson" />
  <meta name="description" content="Do you need to exclude products from your coupon code in WooCommerce.  In this article, we'll walk you through product exclusion." />
  <title>How to Exclude Products from WooCommerce Coupons - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/wordpress-plugins/woocommerce-exclude-products" rel="canonical" />
...
<script>
  ...
  ga('send', 'pageview');
	...
	<!-- cid:9d04a905632c2363b1a89496bcfacae6 -->
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to Exclude Products from WooCommerce Coupons</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to Exclude Products from WooCommerce Coupons									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>1,081</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Mar 24, 2014'><span style='color:#606060;'>Published:</span> Apr 26, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In some circumstances, you may want to exclude a product from being able to use a coupon code on it.  In this article, we will show you how to exclude a product from a coupon code in WooCommerce.  If you need to create coupon codes for specific products, take a look at our article on <a href="http://www.inmotionhosting.com/support/website/wordpress-plugins/woocommerce-specific-coupon">creating product-specific WooCommerce coupon codes</a>.</p>
<h2>Excluding Products from WooCommerce Coupons</h2>
<ol class="article_list">
    ...
    <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/woocommerce-exclude-coupons-1.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/woocommerce-exclude-coupons-1.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>Once you are logged in, visit the coupon code that you want to disable products on.  To do so, hover over <strong>WooCommerce</strong>, then click on <strong>Coupons</strong>, then on the coupon that you want to edit.  If you have not already created a coupon and need to learn how to do so, take a look at our article on <a href="http://www.inmotionhosting.com/support/website/wordpress-plugins/woocommerce-coupon-codes">creating WooCommerce coupon codes</a>.</p></li>
    <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/woocommerce-exclude-coupons-2.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/woocommerce-exclude-coupons-2.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>Within the coupon edit screen, look toward the <em>Coupon Data</em> box and click on the <strong>Usage Restriction</strong> tab.</p></li>
    <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/woocommerce-exclude-coupons-3.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-plugins/woocommerce-exclude-coupons-3.png"  style='float:right; margin:15px 15px 15px 15px;'></a><p>You should now see various fields here.  The fields that we will be modifying will be the <em>Exclude products</em> and <em>Exclude categories</em>.  In these fields, you may begin typing the product or category that you want to exclude from the coupon.  When you see that product that you want to exclude, simply click on it to add it to the exclusion list.  </p></li>
    <li style='clear:both;'><p>Once complete, be sure to save your changes.</p></li>
</ol> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/wordpress-plugins/woocommerce-exclude-products&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/wordpress-plugins/woocommerce-exclude-products'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NjcmaWQ9MzE2NyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="243d3d4d2f4923b9df176aff8283a618" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/01047a281806ff0ca33538bd162ac8d2?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/01047a281806ff0ca33538bd162ac8d2'>Maurice</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-05 2:02 am</div>
				                <div><p>This is quite obvious, but how do you, on product level, exclude that product from coupon discount?</p>
<p>I.e. when you open a PRODUCT and disable&nbsp;coupons for this product...</p>
<p>I create coupons automatically and store them in an autoresponder for future use. Thousands of coupons are circulating and emailed out. Now I have a new product and I want to exclude this product from coupon discount.Any idea?</p>
<p>Maurice</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25477);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-05 4:10 pm</div>
				                <div>Hello Maurice,<br />
<br />
I'm not sure how you would do this automatically.  It would probably require custom coding in order to meet your needs.  You may need to speak with the Woocommerce developers to see if they can meet your needs.  In order to exclude products from coupons manually, you can check out this <a href="https://bobwp.com/how-to-set-up-woocommerce-coupons/" rel="nofollow" target="_blank">tutorial</a>.  I hope this helps to answer your question, please let us know if you require any further  assistance.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25502);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
