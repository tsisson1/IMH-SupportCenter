<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:63253:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/moodle/user-roles-moodle/add-new-user" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-10-24T13:35:57-07:00" />
  <meta name="keywords" content="adding creating create setup setting up users user roles role moodle 2.3" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="In order for the Courses to be utilized. Users will need to be added to the Courses. This tutorial will explain how to create and add users to the Moodle 2.3 database." />
  <title>Adding new users to the Moodle User Accounts - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/moodle/user-roles-moodle/add-new-user" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:04204b66fae3216dc54c3dc14458ee89 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '195.251.65.68']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Adding new users to the Moodle User Accounts									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>6,731</span></div>
							...
							<div style='clear:both;'></div>
								...
								<p>When done <a target="_blank" href="/support/edu/moodle/activity-resource" title="Click here to view the previous article">Adding an activity or resource to a course in Moodle</a>, Users can be set up for accessing the Moodle site. The most important factor in setting up a Moodle site (outside of creating the courses themselves) is to create users for loging in and taking the Course. There are many settings that can be set when adding users in the Moodle site administration. This tutorial will walk through the basic steps for setting up a user in Moodle 2.3.</p>
<h3>Create new Users in Moodle</h3>
...
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/105/new-user/new-user-1-add.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="new-user-1-add" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/105/new-user/new-user-1-add.gif" title="Click here to view the larger image" width="200" /></a>In the <strong>Site Administration</strong> section on the left in the <strong>Settings</strong> section, navigate to <strong>Users</strong> &gt; <strong>Accounts</strong>, click<strong> Add new users</strong>.
...
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/105/new-user/new-user-2-general.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="new-user-2-general" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/105/new-user/new-user-2-general.gif" title="Click here to view the larger image" width="200" /></a>On the <strong>Add new user page</strong>, Fill out the required fields. The required fields show in red and are the Username, New password, First name, Surname, Email address, City/town, and Select a country. Below is a brief description of what each section contains. Once these values are set, click <strong>Update Profile</strong>.
<p><strong>General:</strong> The general settings contain the basic information for the user like the username, password, address and email, and other login information. The <strong>Choose an Authentication method</strong> drop box determines how users are authenticated when logging in. With this setting, the <strong>authentication method must be available</strong> in order for the method to work. In most cases, the <strong>Manual Account</strong> will be selected. To prevent users from loging in, the method can be set to <strong>No Login</strong>.</p>
<p><strong>User picture:</strong> Here, users can have an image uploaded to represent their user account.</p>
<p><strong>Interests:</strong> Allows details about the users non-course related activities.</p>
<p><strong>Optional:</strong> Data such as the users Web URL, Skype, Yahoo, AIM, or MSN login, and phone numbers can be added.</p>
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/105/new-user/new-user-3-list.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="new-user-3-list" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/105/new-user/new-user-3-list.gif" title="Click here to view the larger image" width="200" /></a>After the clicking <strong>Update Profile</strong>, the Users list will appear with the users in the Moodle database. If the User list does not show, click in the <strong>Settings</strong> section to the left, <strong>Site administration</strong> &gt; <strong>Users</strong> &gt; <strong>Accounts</strong> &gt; <strong>Browse list of users</strong> to view the User list. <br style="clear: both;" />
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/105/new-user/new-user-4-view.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="new-user-4-view" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/105/new-user/new-user-4-view.gif" title="Click here to view the larger image" width="200" /></a>Once the user is added, the user will be seen in the <strong>List of Users</strong>. <br style="clear: both;" /></p>
</li>
</ol>
<p>This concludes the tutorial on Adding new users to the Moodle User Accounts in Moodle 2.3. Please check the next article on <a target="_blank" href="/support/edu/moodle/user-roles-moodle/user-profile-fields" title="Click here to view the next article">Editing User profile fields in Moodle</a>. For more information on this Education Channel please visit <a target="_blank" href="/support/edu/moodle/user-roles-moodle" title="Click here to view the courses">Managing users and roles in Moodle</a></p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 1: Adding new users to the Moodle User Accounts</div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/moodle/user-roles-moodle/add-new-user&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/moodle/user-roles-moodle/add-new-user'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yODcmaWQ9MTkxNiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="f52bbb40ed2ada725206c5d212b0a0eb" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<table><tr><td colspan='2'><h4>User Accounts</h4></td></tr>  <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>1.</td>
