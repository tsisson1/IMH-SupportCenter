<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:45783:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/drupal-8/menus" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="InMotion Hosting Support Center" />
  <title>104: Working with Menus in Drupal 8 | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/drupal-8/menus" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:ec49e555da1c40319bb8190e41d003cf -->
...
<div class='page-header'>
	<h1>104: Working with Menus in Drupal 8</h1>
</div>
<div class='section_listing'>
	This course will take you through the functions of a menu in Drupal 8. You will learn how to create menus, add links to menus, set and arrange them on your site, and even remove them from your inventory.
	<table>
		<tr>
				<td style='width:75px; font-weight:bold;'>Section 1:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/drupal-8/menus/menu-introduction'>How to create a custom menu in Drupal 8</a>
					<div>This article guides you on creating custom menus in Drupal 8.</div>
					<div class='smallgrey'>Hits: 3,396</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/drupal-8/menus/add-items'>How to add items to your menus in Drupal 8</a>
					<div>Let us guide you on how to enter new items into your menu in the Drupal 8 admin dashboard.</div>
					<div class='smallgrey'>Hits: 1,894</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/drupal-8/menus/add-menu-block-to-page'>Assigning a menu to your pages in Drupal 8</a>
					<div>After creating the menu and adding items, you still need to add the block to the page layout. This article will teach you how to do that in Drupal 8.</div>
					<div class='smallgrey'>Hits: 2,108</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/drupal-8/menus/change-link-order'>Changing link order in Drupal 8 menus</a>
					<div>When working with menus, it is likely you will need to reorder links at some point. This article shows you how to do so in Drupal 8.</div>
					<div class='smallgrey'>Hits: 941</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/drupal-8/menus/delete-menu'>Deleting a custom menu in Drupal 8</a>
					<div>Need to delete a menu in Drupal 8? This article will guide you in how to do just that.</div>
					<div class='smallgrey'>Hits: 635</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/drupal-8/menus/disable-main-secondary-menus'>Disabling main and secondary menus in Drupal 8</a>
					<div>If you wish to disable the main or secondary menus in your Drupal 8 themes, check out this article. </div>
					<div class='smallgrey'>Hits: 762</div>
				</td>
			</tr>
			</table>
</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zOTUmaWQ9Mzk1JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
