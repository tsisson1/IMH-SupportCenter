<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:108290:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/amp/upgrade-downgrade-hosting-plan" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-03-18T14:42:40-07:00" />
  <meta name="keywords" content="Upgrade downgrade change hosting plan limits amp 2xram" />
  <meta name="author" content="Jacob Nicholson" />
  <meta name="description" content="In this tutorial we will show you how to upgrade or downgrade your hosting plan with InMotion Hosting. " />
  <title>How to Upgrade/Downgrade your Hosting Plan in AMP - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/amp/upgrade-downgrade-hosting-plan" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:2efd440d770b4e0bef6bc517ef2f77f4 -->
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to Upgrade/Downgrade your Hosting Plan in AMP</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to Upgrade/Downgrade your Hosting Plan in AMP									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>31,514</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Aug 23, 2011'><span style='color:#606060;'>Published:</span> Mar 18, 2015</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In this tutorial we will show you how to upgrade or downgrade your Hosting Plan in <a href="http://www.inmotionhosting.com/support/website/amp">AMP (Account Management Panel)</a>. If you've outgrown or underutilized your current hosting plan, you can easily sign-in and take advantage of the <a href="https://secure1.inmotionhosting.com/index/login">AMP</a> to upgrade, or downgrade your plan to match your current hosting needs. If you just want to change your plan term (payment cycle), for example from 1 year to 2 years, see our guide <a href="/support/website/amp/change-hosting-term-subscription">here</a>.</p>

<h2>Upgrade / Downgrade hosting plan</h2>

<p>Using the <strong>Change Plan</strong> option in AMP, will allow you to do just that! Using the steps below I'll show you how to accomplish either an account upgrade or downgrade.</p>

<p>So if you need to upgrade to a <a href="http://www.inmotionhosting.com/vps_hosting.html" target="_blank">VPS</a> or <a href="http://www.inmotionhosting.com/dedicated_servers.html" target="_blank">dedicated server</a>, or change the limits of your <a href="http://www.inmotionhosting.com/business-hosting" target="_blank">business class shared hosting</a> plan, you'll have the knowledge to accomplish this at anytime.</p>

<ol class="article_list">

  <li><a href="/support/website/amp/how-to-log-into-amp">Login to AMP</a>.</li>

<li>Find the hosting plan you want to modify, then click the <strong>Change Hosting Plan</strong> button.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/revamp/change-hosting-plan.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/revamp/change-hosting-plan.png" alt="" /></a></li>

<li style="clear: both;"><a name="term"></a>
    <div style="background-color: #DFDFDF; padding: 5px; height: 590px;">
    <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/amp/upgrade-downgrade-plan/select-plan-term-and-click-submit.png"><img  style="width: 350px; float: right; margin-left: 5px; max-height: 800px;" src="//cdn.inmotionhosting.com/support/images/stories/amp/upgrade-downgrade-plan/select-plan-term-and-click-submit.png" alt="Click on AMP login"></a>
      <p style="margin-top: 75px;">For the <strong>Change to</strong> field, select the plan you are thinking about upgrading/downgrading to.</p>
    <p style="margin-top: 25px;">For <strong>Select term</strong>, you can choose the appropriate billing cycle that works for you.</p>
    <p style="margin-top: 25px;">In this example you can see that I would have a  <strong style="background-color: yellow;">$112.00 CREDIT</strong> from my current <strong>Change from</strong> plan of <strong>VPS 1000</strong> when selecting my <strong>Change to</strong> plan of <strong>VPS 2000</strong>.</p>
    <p style="margin-top: 125px;">You will see your total cost for the upgrade, or any credit you'd receive from a downgrade.</p>
    <p style="margin-top: 5px;">Finally click on <strong>Submit</strong>.</p>
    </div>
</li>
<li style="clear: both;">
    <p>Now that you've submitted your upgrade or downgrade request for your hosting plan, our systems administration team will take it from here and send you an email when the process is complete.</p>
    
    <p class="alert" style="color:red"><strong>**Note:</strong><br>The <em>time frame</em> for <strong>Upgrading/Downgrading</strong> will differ, depending on your request, but you will receive an email upon completion.
    </p>
</li>

</ol>
<p>&nbsp;</p>
<p>If you are moving platforms from a shared account to a VPS or an <a href="http://www.inmotionhosting.com/dedicated_servers/articles/inexpensive-web-hosting.html">inexpensive dedicated hosting package</a> our systems administrators take care of the account move.</p>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/amp/upgrade-downgrade-hosting-plan&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/amp/upgrade-downgrade-hosting-plan'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MjcmaWQ9MTM3JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="0a1394fb5e5708f62de2fcee76051262" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/billing/i-need-extra-domain-spaces?tsrc=rsbraq'>I need extra domain spaces.</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/website/https-redirection-from-domaina-to-domainb?tsrc=rsbraq'>https redirection from domainA to domainB</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/whm/i-cant-login-into-my-whm?tsrc=rsbraq'>i can't login into my whm</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/whm/unable-to-login?tsrc=rsbraq'>Unable to login to WHM</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/databases/i-cannot-install-more-than-one-program-because-of-database-limit?tsrc=rsbraq'>I cannot install more than one program because of database limit</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/file-management/hosting-plan-change-migration?tsrc=rsbraq'>Hosting plan change migration</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/billing/i-am-very-disappointed?tsrc=rsbraq'>I am very disappointed.</a>
                                </div>
...
<a name='comments'></a>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						...
						<div><a style='font-size:16px;' href='/support/community-support/users/McIronLung'>McIronLung</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2011-12-29 10:18 pm</div>
				                <div>I did this for my hosting plan, and it went very smoothly. I highly recommend it if you are over paying for your current plan.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(5863);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-11135'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/ce295e3937a7d66142831fc809aba3b8?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/ce295e3937a7d66142831fc809aba3b8'>Roger Gardner</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-04 3:16 am</div>
				                <div><p>Doesnt' work. There is no "Change Hosting Plan"</p>
<p>&nbsp;</p>
<p>this is outdated eventhough the date on it is 2 june 2014</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11135);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-04 8:39 am</div>
				                <div>The &lt;em&gt;Change Hosting Plan&lt;/em&gt; icon is indeed there within AMP, although it could be in a different row depending on your specific plan and browser window size.  Look through this section in AMP and you will certainly find it.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11148);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-12305'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/bf7bb433f8d63dd7968cb935ea7a9c26?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/bf7bb433f8d63dd7968cb935ea7a9c26'>Jorge</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-03 1:49 pm</div>
				                <div><p>Can I add RAM memory to my dedicated server through AMP?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12305);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-03 1:58 pm</div>
				                <div>Hello Jorge, and thanks for your comment.<br />
<br />
You can request additional RAM for your dedicated server in AMP, as also explained in our &lt;a href=&quot;http://www.inmotionhosting.com/support/news/updated-dedicated-server-specs&quot; target=&quot;_blank&quot;&gt;updated dedicated server specs&lt;/a&gt; article.<br />
<br />
You would just need to &lt;a href=&quot;http://www.inmotionhosting.com/support/website/getting-started-guides/submitting-and-checking-on-status-of-tickets#submit-ticket&quot; target=&quot;_blank&quot;&gt;submit a verfied ticket&lt;/a&gt; so our system administration department can get in contact with you to plan the upgrade of RAM.<br />
<br />
Please let us know if you had any other questions!<br />
<br />
- Jacob</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12306);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-13582'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//graph.facebook.com/debbie.lancione.3/picture?type=normal' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='/support/community-support/users/momebs'>momebs</a></div>
						<div></div>
						<div></div>
						<div>3 <a href='/support/team/points' target='_blank'>Points</a></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-03 10:47 am</div>
				                <div>This is helpful.  Where can I find information on which hosting plan is best for me?</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13582);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-04 10:40 am</div>
				                <div>Hello momebs,<br />
<br />
We have charts for each type of hosting so you can compare them and see which one is best for you.<br />
<a href="http://www.inmotionhosting.com/business-hosting">Business Hosting</a><br />
<a href="http://www.inmotionhosting.com/vps-hosting">VPS Hosting</a><br />
<a href="http://www.inmotionhosting.com/dedicated-servers">Dedicated Hosting</a><br />
<a h ref="http://www.inmotionhosting.com/reseller-hosting">Reseller Hosting</a><br />
<br />
Kindest Regards,<br />
Scott M<br />
</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13617);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-17411'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/7c6f8564ee6260651efec420b7262791?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/7c6f8564ee6260651efec420b7262791'>april r</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-13 9:27 pm</div>
				                <div><p>By credit do you mean store credit or returned credit amount.</p>
<p>if store credit, How would i be able to use the store credit?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17411);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-13 9:45 pm</div>
				                <div>Hello april,<br />
<br />
Thank you for your question. When you perform an upgrade like the example above, it is crediting the money you already paid, and applying it toward your upgrade.<br />
<br />
If you have any specific questions about your account, <a href="http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support">Live Support</a> would be happy to help.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17412);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-19374'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/9ba486aa64317652c22d673dfd7177f2?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/9ba486aa64317652c22d673dfd7177f2'>Darin Redding</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-10 4:09 am</div>
				                <div><p>Looking at upgrading my&nbsp;Pro Plan to a VPS. Here's your published annual costs for a lower tier VPS:</p>
<p>Non-customers&nbsp;$348.00 ($29.99/mo.)</p>
<p>Long time customers like me: $539.88 with a credit of $168.10 = 371.78.</p>
<p>huh?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19374);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-12 2:48 pm</div>
				                <div>Hello Darin,<br />
<br />
I see your point,loyal customers do deserve something as well. Our customer service department would have more information on how the discounts work. I do know that some plans have a recurring discount on them for loyal customers such as yourself. These work out much better in the long run as they are 'forever discounts' and long time customers qualify for pretty decent discounts. The new VPS S-class do not currently have a discount as they are new, but likely will starting next year.  Please feel free to contact our <a href="http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support">Live Billing team</a> to see what the details are for your individual account. <br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19457);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-25648'></a>
		<div  style='margin:2px 0px 0px 80px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/d96ca3a5381763f2faee50108e3fd0d7?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/d96ca3a5381763f2faee50108e3fd0d7'>Robert</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-10 10:18 pm</div>
				                <div><p>Greetings,</p>
<p>I would like to quote Darin's message of below and ask for an update.&nbsp;</p>
<p>Essentially I am currently with Godaddy.com and VERY much wish to transfer over to InMotion. We expect to be on the ProPlan for about 6 months and to then upgrade to VPS. HOWEVER, as per your current pricing plans and discounts, it makes a lot more sense for us to WAIT until we are ready for the VPS before transferring.</p>
<p>Could you please consider a pricing plan that would provide the incentives to transfer NOW rather than later --- otherwise we lose about $191 during Year 1&nbsp;in the deal. (OUCH!)</p>
...
<img class="sc_rc" style="height: auto; max-width: 90px; vertical-align: middle; border: 0px; border-radius: 5px; margin-right: 15px; display: block;" src="http://www.gravatar.com/avatar/9ba486aa64317652c22d673dfd7177f2?s=90" alt="" />
<div><a style="color: rgb(63, 137, 194); outline: 0px; font-size: 16px;" href="http://www.gravatar.com/9ba486aa64317652c22d673dfd7177f2">Darin Redding</a></div>
<div>&nbsp;</div>
<div>&nbsp;</div>
<div><span title="Posted anonymously - anonymous users receive no points">n/a&nbsp;<a style="color: rgb(75, 160, 225); text-decoration: none;" href="/support/../../team/points" target="_blank">Points</a></span></div>


<div style="float: right; margin: 0px 0px 15px 15px; font-size: 12px; color: rgb(170, 170, 170);">2015-01-10 4:09 am</div>
<div>
<p style="margin: 0px 0px 11px;">Looking at upgrading my&nbsp;Pro Plan to a VPS. Here's your published annual costs for a lower tier VPS:</p>
<p style="margin: 0px 0px 11px;">Non-customers&nbsp;$348.00 ($29.99/mo.)</p>
<p style="margin: 0px 0px 11px;">Long time customers like me: $539.88 with a credit of $168.10 = 371.78.</p>
<p style="margin: 0px 0px 11px;">huh?</p>
</div>



</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25648);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-11 11:22 pm</div>
				                <div>Hello Robert,<br />
<br />
I understand that some may not like the price after the initial year discount, however our department is not able to handle the pricing as that would be handled by our <a href="http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support">billing department</a>. I would suggest either an email or chat with that department to see if you can get a lower rate.<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25679);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-23635'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/5c1560b90f5c2f0ff875425e84bb56ea?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/5c1560b90f5c2f0ff875425e84bb56ea'>Joe</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-05-22 5:04 pm</div>
				                <div><p>What happens if I move from a VPS to a shared plan? Do you do the move?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23635);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-05-26 11:47 am</div>
				                <div>Hello Joe,<br />
<br />
Thank you for contacting. This has to be handled on a case-by-case basis, since it depends on your specific setup. I recommend contacting <a href="http://www.inmotionhosting.com/contact">Live Support</a>, so they can provide information specific to your account.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23696);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-25520'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/b99de4a980d01df7362b70aac55b2002?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/b99de4a980d01df7362b70aac55b2002'>David Neale</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-06 5:22 am</div>
				                <div><p>I'm considering downgrading from VPS to reseller as I think that is all I really need. What happens to clients DNS settings at registrars?</p>
<p>Do they remain the same? (hopefully :)</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25520);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-06 4:04 pm</div>
				                <div>Hello David,<br />
<br />
Thank you for contacting us. It depends how  you are currently setup, but you may have some nameserver changes to make. But this should just result in normal <a href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/domain-names-dns-changes">propagation</a> issues, which should not cause major issues.<br />
<br />
I recommend scheduling this type of move at an off-peak time, to avoid any major loss in traffic. <br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25550);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-29735'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/56c8ef5857352d8df7e03e5a688db0e8?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/56c8ef5857352d8df7e03e5a688db0e8'>hksingh</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-12 8:43 am</div>
				                <div>This is very nice information regarding upgrade hosting but how to upgrade hosting on bigrock and godaddy </div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29735);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-12 9:11 am</div>
				                <div>This article refers to our hosting packages. I advise checking with Bigrock or GoDaddy for differences concerning how to use their products.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29736);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='/support/images/avatars/default_avatar.jpg' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='/support/community-support/users/jandjp6'>jandjp6</a></div>
						<div></div>
						<div></div>
						<div>3 <a href='/support/team/points' target='_blank'>Points</a></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-02-18 2:56 pm</div>
				                <div>I purchased a WordPress hosting plan that could accommodate two sites. What my zealous little sales bot forgot to mention is I wouldn't get enough databases to install Wordpress on both sites. Got sent to this link by support.  Hate getting suckered..  On my way to Yelp for a one star review.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30663);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-02-18 3:34 pm</div>
				                <div>Hello jandjp6,<br />
<br />
Thank you for contacting us. Even our lowest <a href="http://www.inmotionhosting.com/business-hosting">Business Class Hosting plan</a> allows 2 databases, which will accommodate 2 WordPress websites.<br />
<br />
I checked in your account and can confirm that you are using both database slots for WordPress sites. <br />
<br />
It looks like both databases are being used for the same domain, which seems unnecessary. Feel free to contact <a href="http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support">Live Support</a> if you need assistance identifying which database can be removed.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30664);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
