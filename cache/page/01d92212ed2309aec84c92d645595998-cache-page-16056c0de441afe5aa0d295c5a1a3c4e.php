<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49798:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/how-to/my-add-to-cart-button-is-gone-on-my-prestashop-site" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, You will want to try and remember what you did right before the behavior started. If it was a module you enabled, then disable it and see if that..." />
  <title>my &quot;add to cart&quot; button is gone on my prestashop site | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/how-to/my-add-to-cart-button-is-gone-on-my-prestashop-site" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:49698ce03fd1d680fc6a1dcc4b441096 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '188.37.188.6']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>my &quot;add to cart&quot; button is gone on my prestashop site</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2014-11-10 2:10 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>485</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Im having trouble with my prestashop site. My &quot;add to cart&quot; button is gone on my prestashop 1.6 ive been trying for a long while now to get it back ive tried going to &quot;orders&quot; then turning on the add to cart switch n im still having no luck????</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_5928' id='upvote_answer_5928' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='5928' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_5928').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_5928' id='downvote_answer_5928' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='5928' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_5928').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
You will want to try and remember what you did right before the behavior started. If it was a module you enabled, then disable it and see if that helps. Also, be sure the store is not set to 'catalog mode.' Unfortunately with no site, steps, or other information provided, there is not much additional advice we can give at this time.<br />
<br />
Kindest Regards,<br />
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_5928').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_5928' id='form_comment_on_answer_5928' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/how-to/my-add-to-cart-button-is-gone-on-my-prestashop-site&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/how-to/my-add-to-cart-button-is-gone-on-my-prestashop-site'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="bffe090e16bfa160d37366da7123b6f4" value="1" />	</div>
	</form>
<!-- <br />
