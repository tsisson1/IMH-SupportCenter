<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:66671:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/wordpress/change-wordpress-appearance/appearance-editor-css-code" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-03-04T16:20:03-08:00" />
  <meta name="keywords" content="custom css change menu font appearance editor wordpress thene" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="To change the CSS style of your WordPress you will need to use the Appearance editor. This article will tell you how." />
  <title>How do I use the Appearance editor in WordPress? - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/wordpress/change-wordpress-appearance/appearance-editor-css-code" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:8eaa6f0419ed258f2ec10f96bbac3fe1 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How do I use the Appearance editor in WordPress?									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>7,302</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Mar 4, 2013'><span style='color:#606060;'>Published:</span> Mar 4, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In WordPress, you have the option of editing the templates with the template editor; however, some specific changes can only be done in the code of the site. You can edit the code using the Appearance Editor in the WordPress dashboard. In this article we will explain how to change the size of the font in the menu of the "<em>Twenty Twelve</em>" theme using the <strong>Appearance Editor</strong>.</p>
<h2>Steps to change the font of the menu</h2>
<ol class="article_list">
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/105/using-the-appearance-editor/change-font-css-1-visit-site.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Visit your site WordPress" src="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/105/using-the-appearance-editor/change-font-css-1-visit-site.gif" title="Click here to view the larger image" width="100" /></a>First you need to find the CSS code that requires editing. You do this by inspecting the code of your site. The following explains how to find the CSS code to edit.
<p><strong>Visit your website</strong>.</p>
<p>Highlight the menu items. Right click the the highlighted text and select view Selection Source (This is specific to FireFox. Other browsers will have a different way to inspect the code.)</p>
<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/105/using-the-appearance-editor/change-font-css-2-nav-menu.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="nav-menu css class WordPress" src="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/105/using-the-appearance-editor/change-font-css-2-nav-menu.gif" title="Click here to view the larger image" width="100" /></a>Find the class for your navigation Menu. In this case the class we are going to edit it the <em>nav-menu</em>class. See image to the right.
<p>Copy the <em>nav-menu</em> class name.</p>
<br style="clear: both;" /></li>
<li>Now you will need to paste the class name in the <em>style.css</em> sheet for your Wordpress. <a href="/support/edu/wordpress/wordpress-introduction/logging-into-wordpress-dashboard" target="_blank" title="Click for more information">Log into the WordPress Dashboard</a>.</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/105/using-the-appearance-editor/change-font-css-3-appearance-editor.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Appearance editor WordPress" src="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/105/using-the-appearance-editor/change-font-css-3-appearance-editor.gif" title="Click here to view the larger image" width="100" /></a>Go to <strong>Appearance</strong> and select <strong>Editor</strong>. <br style="clear: both;" />
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/105/using-the-appearance-editor/change-font-css-4-select-style-css.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Select the CSS style.css WordPress" src="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/105/using-the-appearance-editor/change-font-css-4-select-style-css.gif" title="Click here to view the larger image" width="100" /></a>You should by default be taken to the <em>style.css</em> stylesheet. If not, make sure you are on the <em>style.css</em> page by viewing the "<em>Styles</em>" section on the bottom right, and make sure the <em>style.css</em> is blue highlighted like the image to the right. <br style="clear: both;" /></p>
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/105/using-the-appearance-editor/change-font-css-5-add-code.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Add code to your CSS WordPress" src="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/105/using-the-appearance-editor/change-font-css-5-add-code.gif" title="Click here to view the larger image" width="100" /></a>Paste the class name at the bottom of the <em>style.css</em>page. Make sure you have a ( . ) dot in front of it. The code should look like the following:
<pre style="margin-left: 20px;">.nav-menu {}</pre>
<p>You can add attributes to your CSS to change the size, color, and more of the text. In this example, we are changing the font size to 24 pixels (24px). The code looks like the following.</p>
<pre style="margin-left: 20px;">.nav-menu {font-size:24px;}</pre>
<p>When done adding the CSS, click <strong>Update File</strong>.</p>
<p class="alert"><strong>Important!</strong> You may need to <a target="_blank" title="Click here for more info" href="/support/website/how-to/clear-browser-cache"><strong>Clear your browser cache</strong></a> to see the changes take effect.<br style="clear: both;" /></p>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/105/using-the-appearance-editor/change-font-css-6-larger-font.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Larger menu font WordPress" src="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/105/using-the-appearance-editor/change-font-css-6-larger-font.gif" title="Click here to view the larger image" width="100" /></a>Now the font on your menu is larger. You can add different properties to change to look of specific areas of your WordPress site with the Appearance Editor of WordPress. <br style="clear: both;" /></p>
</li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 5: How do I use the Appearance editor in WordPress?</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 4: <a href='/support/edu/wordpress/change-wordpress-appearance/how-to-edit-wordpress-theme'>How do I edit my WordPress theme?</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 6: <a href='/support/edu/wordpress/change-wordpress-appearance/using-kitchen-sink'>Using the Kitchen Sink in WordPress</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/wordpress/change-wordpress-appearance/appearance-editor-css-code&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/wordpress/change-wordpress-appearance/appearance-editor-css-code'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMzkmaWQ9MjI1NyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
          ...
          <tr >
			...
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/wordpress/adding-featured-image-problem?tsrc=rsbraq'>adding featured image problem</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/a582c55ec13e90449d0664a9013831a9?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/a582c55ec13e90449d0664a9013831a9'>Shahan</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-02-28 4:05 am</div>
				                <div><p>Hi,</p>
<p>Is this method makes the use of inline style?</p>
<p>If so heard that it effects in the SEO.</p>
<p>&nbsp;</p>
<p>Thanks</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8685);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-02-28 8:42 am</div>
				                <div>Styles do not necessarily affect the SEO of your site at all unless you are attempting to hide data from the page.  This is not an inline style as it is located on another stylesheet.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8687);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
