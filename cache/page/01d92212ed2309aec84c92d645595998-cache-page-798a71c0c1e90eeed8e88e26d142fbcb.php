<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:54558:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/opencart/open-cart-css" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello simonbk, and thanks a lot for your question. For your first question unfortunately I'm not quite following along with where you are seeing a &quot;my t..." />
  <title>Open Cart CSS | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/opencart/open-cart-css" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:9494814df52db7a25d9406f8d888981c -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Open Cart CSS</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/simonbk'>simonbk</a>
			<div>284 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-12-21 10:18 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>3,969</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Good morning wizards of Open Cart.<br />
<br />
Two questions for you:<br />
<br />
FIRST QUESTION<br />
<br />
1.  In the link to get to an Open Cart Css file is the link &quot;my theme&quot;.  I have used everything I can think of for the  &quot;my theme&quot; part.  I have used:<br />
<br />
1. The theme name<br />
2. My URL<br />
3. My Domain<br />
4. The Open Cart version number.<br />
<br />
Nothing works.  What should be in there?<br />
<br />
SECOND QUESTION<br />
<br />
My site is:<br />
<br />
heartlandpetbeds.com/test<br />
<br />
If you look you will notice that the home page has no lines or breaks or borders between banner/sections.  How do I put something in there?  Yes, I know it is the CSS.  What is the code I would use and would it go at the bottom or replace a line item?<br />
<br />
Thanks,<br />
<br />
Simon<br />
...
UPDATE:<br />
<br />
If a tilt my screen I can see that there are some lines between sections but they very very light.  You can't see them.  Why is that?</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_2019' id='upvote_answer_2019' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='2019' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_2019').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_2019' id='downvote_answer_2019' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='2019' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_2019').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>9,968 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2012-12-21 2:39 pm EST
                		        </div>
					
		                </div>

				Hello simonbk, and thanks a lot for your question.<br />
<br />
For your first question unfortunately I'm not quite following along with where you are seeing a &quot;my theme&quot; link at. Is this in the OpenCart admin dashboard itself that you're seeing this option?<br />
<br />
If you haven't yet found a theme to use, you can follow our guide on &lt;a href=&quot;http://www.inmotionhosting.com/support/edu/opencart/customizing-store-look-and-feel/finding-theme-for-opencart&quot; target=&quot;_blank&quot;&gt;finding a theme for your OpenCart site&lt;/a&gt; for some steps of where to find OpenCart themes at.<br />
<br />
Once you've found a theme to use, you'll want to install it on the server and make it active by following our guide on &lt;a href=&quot;http://www.inmotionhosting.com/support/edu/opencart/customizing-store-look-and-feel/installing-an-opencart-theme&quot; target=&quot;_blank&quot;&gt;installating an OpenCart theme&lt;/a&gt;.<br />
<br />
If you've already installed a theme, which taking a look at your site it does look like you've used the &lt;strong&gt;simple&lt;/strong&gt; theme instead of just the &lt;strong&gt;default&lt;/strong&gt; one. You should notice where you installed OpenCart there is a new directory for that theme's files in the following location:<br />
<br />
&lt;span class=&quot;code_block&quot;&gt;/catalog/view/theme/simple/stylesheet&lt;/span&gt;<br />
<br />
In that directory would be your &lt;strong&gt;.css&lt;/strong&gt; cascading style sheet files that control the look and feel of the OpenCart site. So those would be the files you'd want to be modifying to make display changes on the site.<br />
<br />
In regards to your second question and update, I think this is going to be an issue of what kind of device you're looking at the site on. For instance when I view your site I can clearly see the 1 pixel borders you have between each section.<br />
<br />
If you wanted to make these more prominent you could increase the pixel value for each section. This could get a bit tricky, because it does need to be modifed in multiple places inside your &lt;strong&gt;stylesheet.css&lt;/strong&gt; file.<br />
<br />
You'll more than likely want to make a backup copy of the theme's original &lt;strong&gt;stylesheet.css&lt;/strong&gt; file so that if you need to revert any changes you can do so. Then you can modify the file on your local computer and upload the new one with your favorite &lt;a href=&quot;index.php?option=com_content&amp;amp;amp;view=article&amp;amp;amp;id=38:getting-started-guide-ftp&amp;amp;amp;catid=23&amp;amp;amp;Itemid=101&quot; target=&quot;_blank&quot;&gt;FTP&lt;/a&gt; client, or you can use &lt;a href=&quot;index.php?option=com_content&amp;amp;amp;view=article&amp;amp;amp;id=983:using-file-manager-in-cpanel&amp;amp;amp;catid=135&amp;amp;amp;Itemid=101&quot; target=&quot;_blank&quot;&gt;cPanel's File Manager&lt;/a&gt;, right-click on the file, and choose &lt;strong&gt;Code Edit&lt;/strong&gt;.<br />
<br />
Taking a look at your test page you provided, these are the sections that would need to be modified in your CSS file to make the borders larger:<br />
<br />
Change line 53 from:<br />
&lt;p class=&quot;code_block&quot; style=&quot;white-space: pre-wrap;&quot;&gt;#header{padding-bottom:7px;border-bottom:&lt;strong&gt;1px&lt;/strong&gt; solid #EEEDE8;margin-bottom:7px;}&lt;/p&gt;<br />
To:<br />
&lt;p class=&quot;code_block&quot; style=&quot;white-space: pre-wrap;&quot;&gt;#header{padding-bottom:7px;border-bottom:&lt;strong&gt;5px&lt;/strong&gt; solid #EEEDE8;margin-bottom:7px;}&lt;/p&gt;<br />
Change line 119 from:<br />
&lt;p class=&quot;code_block&quot; style=&quot;white-space: pre-wrap;&quot;&gt;.slideshow{position:relative;border-bottom:&lt;strong&gt;1px&lt;/strong&gt; solid #EEEDE8;padding-bottom:7px;}&lt;/p&gt;<br />
To:<br />
&lt;p class=&quot;code_block&quot; style=&quot;white-space: pre-wrap;&quot;&gt;.slideshow{position:relative;border-bottom:&lt;strong&gt;5px&lt;/strong&gt; solid #EEEDE8;padding-bottom:7px;}&lt;/p&gt;<br />
Change line 354 from:<br />
&lt;p class=&quot;code_block&quot; style=&quot;white-space: pre-wrap;&quot;&gt;#footer{padding:10px 0 0;margin:0; border:1px solid #ececec;border-width:&lt;strong&gt;1px&lt;/strong&gt; 0 0;}&lt;/p&gt;<br />
To:<br />
&lt;p class=&quot;code_block&quot; style=&quot;white-space: pre-wrap;&quot;&gt;#footer{padding:10px 0 0;margin:0; border:1px solid #ececec;border-width:&lt;strong&gt;5px&lt;/strong&gt; 0 0;}&lt;/p&gt;<br />
I hope that this information was helpful to you. Please don't hesitate to provide us further details on exactly what you're trying to accomplish, so we can try to steer you in the right direction and get all of your questions answered.<br />
<br />
- Jacob
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_2019').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_2019' id='form_comment_on_answer_2019' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/opencart/open-cart-css&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/opencart/open-cart-css'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="ab0f535eb3533ee365af41b1d4468531" value="1" />	</div>
	</form>
<!-- <br />
