<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:62124:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/dokuwiki/geting-started-dokuwiki/user-edit-control-doku" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-01-15T21:34:38-08:00" />
  <meta name="keywords" content="Dokuwiki doku wiki restrict user permissions edit remove" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="DokuWiki by default allows all users to edit the site. This tutorial will explain how to restrict edit features for users." />
  <title>Controlling user access for edit pages in DokuWiki - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/dokuwiki/geting-started-dokuwiki/user-edit-control-doku" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:884b91bf3ff412cec606ed34316acd6c -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '80.110.41.203']);
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/dokuwiki' itemprop='url'><span itemprop='title'>Dokuwiki<span></a><div class='dropdown_4columns'><h2>Dokuwiki Education Channel</h2><div class='col_2'><h3>100 Level Classes</h3><div><a href='/support/edu/dokuwiki/geting-started-dokuwiki'>101: Getting Started with Dokuwiki</a></div><div><a href='/support/edu/dokuwiki/writing-content-dokuwiki'>102: Writing content for DokuWiki</a></div><div><a href='/support/edu/dokuwiki/change-dokuwiki-appearance'>103: Changing the DokuWiki Appearance</a></div><div><a href='/support/edu/dokuwiki/add-contact-form-dokuwiki'>104: Adding a contact form in DokuWiki</a></div><div><a href='/support/edu/dokuwiki/install-configure-plugins-doku'>105: Installing and Configuring plugins in DokuWiki</a></div></div><div class='col_2'><h3>200 Level Classes</h3><div><a href='/support/edu/dokuwiki/working-with-menus'>201: Working with menus in DokuWiki</a></div><div><a href='/support/edu/dokuwiki/change-language-doku-wiki'>202: Changing the language in DokuWiki</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/dokuwiki/geting-started-dokuwiki' itemprop='url'><span itemprop='title'>101: Getting Started with Dokuwiki<span></a><div class='dropdown_3columns'><h2> Getting Started with Dokuwiki</h2><div class='col_3'><div>1. <a style='display:inline;' href='/support/edu/dokuwiki/geting-started-dokuwiki/what-is-doku'>What is DokuWiki?</a></div><div>2. <a style='display:inline;' href='/support/edu/dokuwiki/geting-started-dokuwiki/install-dokuwiki-softaculous'>Installing DokuWiki with Softaculous</a></div><div>3. <a style='display:inline;' href='/support/edu/dokuwiki/geting-started-dokuwiki/installing-dokuwiki-manually'>Installing DokuWiki Manually</a></div><div>4. <a style='display:inline;' href='/support/edu/dokuwiki/geting-started-dokuwiki/login-dokuwiki'>How to log into DokuWiki</a></div><div>5. <a style='display:inline;' href='/support/edu/dokuwiki/geting-started-dokuwiki/forgot-username-password-doku'>What if I forgot my DokuWiki username or password?</a></div><div>6. <a style='display:inline;' href='/support/edu/dokuwiki/geting-started-dokuwiki/manage-user-accounts-dokuwiki'>How to manage users in DokuWiki</a></div><div>7. <a style='display:inline;' href='/support/edu/dokuwiki/geting-started-dokuwiki/user-edit-control-doku'>Controlling user access for edit pages in DokuWiki</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Controlling user access for edi...</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Controlling user access for edit pages in DokuWiki									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>5,276</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 10, 2013'><span style='color:#606060;'>Published:</span> Jan 15, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/101/restrict-user-access/restrict-users-1-with-edit.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Preview with edit links in the site." src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/101/restrict-user-access/restrict-users-1-with-edit.gif" title="Click here to view the larger image" width="100" /></a>DokuWiki by default allows all visitors of the site to edit your wiki pages. In some cases, random users can deface your wiki site and delete your pages. The image to the right will show the edit options available for any visitor on the site.</p>
<p>To prevent only certain users for editing the site, you can use the "<em>Access Control List Management</em>" in the Administration section of your DokuWiki to change the permissions of the users. This article will explain how to set the permissions for all visitors to read only and how to set specific uses to be allowed to edit the wiki.<br style="clear: both;" /></p>
<h2>Brief Outline of Permissions</h2>
<p>Below is a table with a brief explanation of what each permission is for. The higher permissions will also include the lower permissions. For example, the Create permission will also allow the Read and Edit permission.</p>
<table style="width: 100%;" class="article_table">
<tbody>
<tr><th colspan="3">User Permissions in DokuWiki</th></tr>
<tr><th>Name</th><th>Permission Description</th></tr>
<tr>
<td>1 None</td>
<td>Wiki is not accessible at all</td>
</tr>
<tr>
<td>2 Read</td>
<td>The wiki can be Read Only</td>
</tr>
<tr>
<td>3 Edit</td>
<td>Can read and edit pages that are all ready created</td>
</tr>
<tr>
<td>4 Create</td>
<td>Allows Pages and Namespaces to be created</td>
</tr>
<tr>
<td>5 Upload</td>
<td>Allows media to be uploaded to pages</td>
</tr>
<tr>
<td>6 Delete</td>
<td>Media files can be overwritten or deleted</td>
</tr>
<tr>
<td>7 Admin</td>
<td>Restricted to the Admin user</td>
</tr>
</tbody>
</table>
<h2>Changing permissions for all users on DokuWIki</h2>
<ol class="article_list">
<li><strong><a target="_blank" href="/support/edu/dokuwiki/geting-started-dokuwiki/login-dokuwiki" title="Click for more information">Log into DokuWiki</a></strong>.</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/101/restrict-user-access/
restrict-users-1-admin.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Admin link DokuWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/101/restrict-user-access/
restrict-users-1-admin.gif" title="Click here to view the larger image" width="100" /></a><strong>Click the Admin link</strong> at the top right. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/101/restrict-user-access/
restrict-users-2-access-control-list.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Select the Access Conrtrol DokuWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/101/restrict-user-access/
restrict-users-2-access-control-list.gif" title="Click here to view the larger image" width="100" /></a><strong>Select the Access Control List Management</strong> link. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/101/restrict-user-access/
restrict-users-1a-set-all-read.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="ACL Rules in DokuWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/101/restrict-user-access/
restrict-users-1a-set-all-read.gif" title="Click here to view the larger image" width="100" /></a>Towards the bottom in the list of "<em>Current ACL Rules</em>", To restrict all users from editing, <strong>select the "<em>Read</em>" radio button and click update</strong>. <br style="clear: both;" />
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/101/restrict-user-access/
restrict-users-1b-no-edit.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="View with no edit links DokuWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/101/restrict-user-access/
restrict-users-1b-no-edit.gif" title="Click here to view the larger image" width="100" /></a>Now when visiting the site as a regular visitor, you will see the Edit features not available anymore.. <br style="clear: both;" /></p>
</li>
</ol>
<h2>Allowing certain registered users the Edit capability</h2>
<ol class="article_list">
<li><strong><a target="_blank" href="/support/edu/dokuwiki/geting-started-dokuwiki/login-dokuwiki" title="Click for more information">Log into DokuWiki</a>.</strong></li>
<li><strong>Click the Admin link</strong> at the top right. <br style="clear: both;" /></li>
<li><strong>Select the Access Control List Management</strong> link. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/101/restrict-user-access/
restrict-users-3-select-root.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Click the Root directory link DokuWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/101/restrict-user-access/
restrict-users-3-select-root.gif" title="Click here to view the larger image" width="100" /></a><strong>Select the "<em>Root</em>" directory</strong> in the Access Control List. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/101/restrict-user-access/
restrict-users-4-select-user.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Select the user to add permissions toDokuWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/101/restrict-user-access/
restrict-users-4-select-user.gif" title="Click here to view the larger image" width="100" /></a>In the "<em>Permissions for</em>" section, <strong>Select "<em>User</em>" and enter the username </strong>to allow access to edit.
<p><strong>Click Select.</strong></p>
<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/101/restrict-user-access/
restrict-users-5-select-edit-save.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Save Add new Entry DokuWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/101/restrict-user-access/
restrict-users-5-select-edit-save.gif" title="Click here to view the larger image" width="100" /></a>In the Add new Entry box, <strong>select the "<em>Edit</em>" radio button</strong> and <strong>click Save</strong>. <br style="clear: both;" />
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/101/restrict-user-access/
restrict-users-6-select-users.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="List of User permissions DokuWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/101/restrict-user-access/
restrict-users-6-select-users.gif" title="Click here to view the larger image" width="100" /></a>Now only the users that you add to the edit permission to will be allowed to edit any pages. <br style="clear: both;" /></p>
</li>
</ol>
<p>This concludes the user permissions tutorial.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/dokuwiki/geting-started-dokuwiki'>101: Getting Started with Dokuwiki</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 7: Controlling user access for edit pages in DokuWiki</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 6: <a href='/support/edu/dokuwiki/geting-started-dokuwiki/manage-user-accounts-dokuwiki'>How to manage users in DokuWiki</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/dokuwiki/geting-started-dokuwiki/user-edit-control-doku&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/dokuwiki/geting-started-dokuwiki/user-edit-control-doku'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMDQmaWQ9MjE2NSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="52042101c26c76d16fef1ad8255e6c46" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/dokuwiki/geting-started-dokuwiki?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Getting Started with Dokuwiki</h3></a>
		<table><tr><td colspan='2'><h4>DokuWiki Overview</h4></td></tr>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/dokuwiki/geting-started-dokuwiki/what-is-doku?tsrc=rsbedu'>What is DokuWiki?</a></td>
                </tr>
        <tr><td colspan='2'><h4>Installing DokuWiki</h4></td></tr>  <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/dokuwiki/geting-started-dokuwiki/install-dokuwiki-softaculous?tsrc=rsbedu'>Installing DokuWiki with Softaculous</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/dokuwiki/geting-started-dokuwiki/installing-dokuwiki-manually?tsrc=rsbedu'>Installing DokuWiki Manually</a></td>
                </tr>
        <tr><td colspan='2'><h4>Doku login and user management</h4></td></tr>  <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/dokuwiki/geting-started-dokuwiki/login-dokuwiki?tsrc=rsbedu'>How to log into DokuWiki</a></td>
                </tr>
          <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/dokuwiki/geting-started-dokuwiki/forgot-username-password-doku?tsrc=rsbedu'>What if I forgot my DokuWiki username or password?</a></td>
                </tr>
          <tr >
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/dokuwiki/geting-started-dokuwiki/manage-user-accounts-dokuwiki?tsrc=rsbedu'>How to manage users in DokuWiki</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>7.</td>
                        <td><a href='/support/edu/dokuwiki/geting-started-dokuwiki/user-edit-control-doku?tsrc=rsbedu'>Controlling user access for edit pages in DokuWiki</a></td>
                </tr>
          	</table>
