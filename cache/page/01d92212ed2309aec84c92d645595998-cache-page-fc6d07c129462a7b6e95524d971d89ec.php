<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:60015:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/domain-names-registrar-transfer-versus-nameserver-change" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-05-08T20:29:06-07:00" />
  <meta name="keywords" content="transfer domain name registrar nameserver dns" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="Learn the difference between a registrar transfer and a nameserver change." />
  <title>Domain Names - Registrar Transfer versus NameServer Change - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/domain-names-registrar-transfer-versus-nameserver-change" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:cb99856f893402ad712a22381148dec7 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Domain Names - Registrar Transfer versus NameServer Change									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>37,928</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Aug 29, 2011'><span style='color:#606060;'>Published:</span> May 8, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>There is often confusion with the term "transfer" when it applies to domain names. Most people are actually looking to perform a nameserver change to point the domain correctly, usually after changing hosts, and this is an entirely different process from performing a registrar transfer.</p>
<h2>Changing Nameservers:</h2>
<p>You can change nameservers by merely logging into your current registrar account and replacing the existing nameservers with your host nameserver, in our case:</p>
<p><strong>ns.inmotionhosting.com - IP address: 74.124.210.242</strong><br /><strong>ns2.inmotionhosting.com - IP address: 70.39.150.2</strong></p>
<p>Pointing the nameservers will only point the domain to where the DNS is located. The DNS can be pointed from our server to other services like Google or Weebly. By default, updating the nameservers to ours will point your domain to our server where your website and email files are located. To learn more about DNS see our article on <a href="/support/domain-names/dns-nameserver-changes/updating-your-domains-nameservers" target="_blank">Updating your domain's dns / nameservers</a>. For more information on updating your nameservers, please see <a href="/support/domain-names/dns-nameserver-changes">DNS and Nameserver Changes</a>.</p>
<h2>What is a Registrar?</h2>
<p>Domains must be registered with a company that holds the domain ownership and domain information (WHOIS). This company that holds the domain is called the Registrar. There are many registrars out there (Namecheap, Network Solutions, etc.). We use Melbourne IT for our registrar at InMotion Hosting.</p>
<h2><b>Do I need a Registrar transfer?</b></h2>
<p>You only need a registrar transfer if you wish to have InMotion Hosting be the registration service managing the domain. This would mean we bill the domain renewal to you, and you will be able to access the domain maintenence tool for your domain through our website.</p>
<p>Registrar transfers cost $11.99, and they extend the current expiration date for one year automatically.</p>
<p>Should you wish to have IMH initiate a registrar transfer, please read this article for additional information on&nbsp;<a href="/support/domain-names/registrations-and-transfers/transfer-domain-name-to-inmotion-hosting" style="outline-style: none; outline-width: initial; outline-color: initial; color: #306090;">transferring your domain name in AMP</a>.</p>
<p><strong>Additional Notes:</strong></p>
<ol>
<li>Make sure the nameservers have been pointed to your account prior to requesting a registrar transfer</li>
<li>Make sure the domain is unlocked with the old registrar prior to making the request. We ususally recommend at least 12 hours prior to ensure all services are seeing the "unlocked" status of your domain</li>
<li>Make sure you have access to the administrative email address for your domain prior to making the request.</li>
</ol>
<p>Once you request a registrar transfer from IMH, we'll bill you for $11.99 and initiate the process. You will then receive an email at the administrative email address requesting your consent or authorization for the transfer.</p>
<p>After you approve the transfer, it will complete in<strong> 1 to 7 days</strong>, depending on the response from the old, or losing, registrar.</p>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/domain-names-registrar-transfer-versus-nameserver-change&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/domain-names-registrar-transfer-versus-nameserver-change'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD02OCZpZD04NDMmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="b0fdad8159827287ac8052f065c7f999" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/how-to/transfer-a-second-domain?tsrc=rsbraq'>Transfer a second domain</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/aa1c9fbf3cedaae9fbbeccc0e5bf4ace?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/aa1c9fbf3cedaae9fbbeccc0e5bf4ace'>zaheerabbas</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-07 3:53 am</div>
				                <div><p>i want<span style="color: #00ff00; font-family: 'Times New Roman'; font-size: 18px; line-height: 22.1579990386963px; background-color: #000000;">Authorization Code:</span></p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22402);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-07 8:42 am</div>
				                <div>Hello zaheerabbas,<br />
<br />
We have an <a href="http://www.inmotionhosting.com/support/domain-names/registrations-and-transfers/how-to-unlock-domain-name-retrieve-authorization-code">article here</a> that helps you with releasing your domain name and getting your Auth code for transfer.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22414);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
