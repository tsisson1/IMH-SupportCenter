<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:54117:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/email-troubleshooting/mail-delivery-failed-return-message-to-sender" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello bluviper, and thanks for your question. Sorry to hear that you're having issues with email delivery from your new addon domain. There are several ..." />
  <title>Mail delivery failed: return message to sender | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/email-troubleshooting/mail-delivery-failed-return-message-to-sender" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:2bf0419bed60a9e9fae3b71ee86fb7d0 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-22']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '164.151.130.61']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Mail delivery failed: return message to sender</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='https://lh3.googleusercontent.com/-SWKHPn9vR6Q/AAAAAAAAAAI/AAAAAAAAAwo/ymg98-n8pCo/photo.jpg?sz=90' class='user_avatar' /><br />
			<a href='/support/community-support/users/bluviper'>bluviper</a>
			<div>8 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-07-08 12:33 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>1,446</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I have created several emails under an addon domain account here @ inmotion hosting.<br />
<br />
after 24hours i tried sending email to my other addresses hosted on another mail server. but it cannot be sent. and it always issues the error Mail delivery failed: return to sender<br />
<br />
inside it holds the error xxx@mydomain.com &quot;No user here&quot; <br />
<br />
I also tried sending to another email address, this time its hosted by inmotion, and it failed again. having the same error No user here.<br />
<br />
how come im having these errors? tho i can send to gmail and yahoo addresses.. but not to these ones...</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_3506' id='upvote_answer_3506' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='3506' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_3506').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_3506' id='downvote_answer_3506' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='3506' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_3506').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>9,968 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2013-07-08 1:15 pm EST
                		        </div>
					
		                </div>

				Hello bluviper, and thanks for your question.<br />
<br />
Sorry to hear that you're having issues with email delivery from your new addon domain. There are several things that can lead to getting a &lt;strong&gt;550 No Such User Here&lt;/strong&gt; mail delivery error.<br />
<br />
Unfortunately without knowing the email addresses involved there wouldn't be a good way for us to guess as to which problem you might be encountering. We have a guide on &lt;a href=&quot;http://www.inmotionhosting.com/support/email/email-troubleshooting/fixing-no-such-user-here&quot; target=&quot;_blank&quot;&gt;fixing the 550 No Such User email error&lt;/a&gt; that goes over some of the possible issues you might be encountering.<br />
<br />
If none of those options work for you, please be sure to &lt;a href=&quot;http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support&quot; target=&quot;_blank&quot;&gt;contact technical support&lt;/a&gt; and pass along the email accounts you are attempting to send from, and to, so that we can further investigate these problems for you.<br />
<br />
...
- Jacob
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_3506').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_3506' id='form_comment_on_answer_3506' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello Jacob,<br />
nice of you to answer the query, actually a support member help sort out the issue, i told him everything, and fortunately we found the culprit...<br />
<br />
Previously i was searching on the help section about setting up MX entries, and it brought me to the page involving setup for third party MX entries and I thought that it was inmotionhotings mail server all along. and it contains google servers (hahaha), so i was setting up a third party server all the while, without me noticing it. thats why it bounces back with an Unknown user error, because Gmail doesnt want to send/receive it that way.<br />
<br />
So what the support member did, was he removed all google servers, and rename the record to mail.mydomain.com with priority 0, then its all good from there.<br />
<br />
Once again, hats off to the support team for taking some patience to understand the situation.<br />
More power!</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='https://lh3.googleusercontent.com/-SWKHPn9vR6Q/AAAAAAAAAAI/AAAAAAAAAwo/ymg98-n8pCo/photo.jpg?sz=90' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/bluviper'>bluviper</a><br />
									8 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2013-07-08 9:37 pm EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello bluviper,<br />
<br />
No problem, I'm glad to see that you had the problems sorted out by support.<br />
<br />
It does make sense like you said that if your &lt;strong&gt;MX&lt;/strong&gt; (Mail eXchange) records were pointed at Google, but you didn't have those email accounts setup there that you'd get the &lt;strong&gt;550 No user here&lt;/strong&gt; error.<br />
<br />
Sounds like everything is back to normal now which is great, just let us know if you run into any further issues at all.<br />
<br />
- Jacob</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/email-troubleshooting/mail-delivery-failed-return-message-to-sender&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/email-troubleshooting/mail-delivery-failed-return-message-to-sender'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="3a6c340452f63cdbe625bb40bc2c1436" value="1" />	</div>
	</form>
<!-- <br />
