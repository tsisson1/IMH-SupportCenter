...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-3/breadcrumbs/show-last" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-04-25T14:24:31-07:00" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="In this tutorial, we'll show you how to use the &quot;Show Last&quot; setting within your Joomla 3 breadcrumbs module." />
  <title>Show Last - Hiding the current page in your Joomla 3 breadcrumbs - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-3/breadcrumbs/show-last" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:83dc60cb8718e46a20720ca019406e18 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Show Last - Hiding the current page in your Joomla 3 breadcrumbs									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>428</span></div>
							...
							<div style='clear:both;'></div>
								...
								<p>As we continue reviewing the <a href="/support/edu/joomla-3/breadcrumbs">settings available for the breadcrumb module</a> in Joomla, we come across the <strong>Show Last</strong> setting. According to Joomla, this setting controls the following:</p>

<p class='white_box'><strong>Show Last</strong><br /><em>Show/Hide the last element in the Pathway</em></p>

<p>Breadcrumbs are intended to show you where within the site you are, and to allow you to easily explore other areas of the site. If you are on a page named <em>Commonly asked questions</em>, showing this in the breadcrumbs may not be a benefit as you already know you're on that page.</p>

<p>In Joomla 3, you can configure the breadcrumbs not to show the current page the user is on. This is controlled by the <strong>Show Last</strong> setting. Below, we'll show you how to toggle this setting on/off.</p>

<p><strong>To hide the current page in your breadcrumbs:</strong></p>
...
<ol class='article_list'>
  ...
  <li>Find and click on your <em>breadcrumb</em> module</li>
  
  <li>
  
  <p>Find the <strong>Show Last</strong> setting. Depending on your Joomla version, it should be under the <em>Module</em> tab for the <em>Basic Settings</em> tab.</p>
  
  <p>Click either <strong>Yes</strong> or <strong>No</strong>, and then click the <strong>Save</strong> button at the top of the page.</p>
  
  <p>Below are screenshots that help demonstrate how the <em>show last</em> setting will affect your breadcrumbs:</p>
    
    <table>
      <tr>
        <th>Show Last - Enabled</th>
        <td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/breadcrumbs/show-last-enabled.png"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/breadcrumbs/show-last-enabled.png"  /></a></td>
      </tr>
        <tr>
          <th style='padding-right:15px;'>Show Last - Disabled</th>
          <td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/breadcrumbs/show-last-set-to-no.png"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/breadcrumbs/show-last-set-to-no.png"  /></a></td>
        </tr>
      </table>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 4: Show Last - Hiding the current page in your Joomla 3 breadcrumbs</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 3: <a href='/support/edu/joomla-3/breadcrumbs/text-for-home-entry'>Changing the "Home" text</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 5: <a href='/support/edu/joomla-3/breadcrumbs/text-separator'>Change the orange arrow</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-3/breadcrumbs/show-last&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-3/breadcrumbs/show-last'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD01MDYmaWQ9MzIyMSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="be3d61153cfbd898166a5c4df81841a9" value="1" />	</div>
	</form>
<!-- <br />
