<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:56911:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/tiki-wiki/create-menu-tikiwiki/featured-links-menu" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-05-02T16:45:40-07:00" />
  <meta name="keywords" content="add adding links menu featured tiki wiki tikiwiki create creating urls" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="This article shows the steps for adding a featured links menu to the footer of TikiWIki." />
  <title>How to add the Featured Links menu in the TikiWiki - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/tiki-wiki/create-menu-tikiwiki/featured-links-menu" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:4de66de9bff42fd05dec4b6143862f7d -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to add the Featured Links menu in the TikiWiki									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>1,472</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 4, 2013'><span style='color:#606060;'>Published:</span> May 2, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<p>TikiWiki has the featured links module that is pre set to display links in a menu on your site. This menu can be added anywhere to your site. In this article, we will add the featured links menu module to the footer of your TikiWIki site.</p>
<h2>Steps to add the Featured Links menu to the footer</h2>
<ol class="article_list">
<li><a href="/support/edu/tiki-wiki/getting-started-tiki-wiki/login-tikiwiki" title="Click for more information" target="_blank"><strong>Log into TikiWiki</strong></a> and <strong>click the Modules icon</strong> in the Quick Admin bar.</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/103/featured-links-menu/edit-modules-1a-add.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="Click Add Module TikiWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/103/featured-links-menu/edit-modules-1a-add.gif" title="Click here to view the larger image" width="100" /></a><strong>Click Add Module</strong>. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/103/featured-links-menu/edit-modules-1-add-module.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Select Module from list TikiWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/103/featured-links-menu/edit-modules-1-add-module.gif" title="Click here to view the larger image" width="100" /></a>For the Module Name, <strong>Select Featured Links</strong>. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/103/featured-links-menu/edit-modules-2-module-error-action.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Module Error for Featured Links TikiWiKi" src="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/103/featured-links-menu/edit-modules-2-module-error-action.gif" title="Click here to view the larger image" width="100" /></a>Next, you will see a Module Error. To fix this error, <strong>select the Actions Icon</strong> from the Error pop up box. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/103/featured-links-menu/edit-modules-3-view.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="View modules TikiWIki" src="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/103/featured-links-menu/edit-modules-3-view.gif" title="Click here to view the larger image" width="100" /></a><strong>Click View</strong>. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/103/featured-links-menu/edit-modules-4-set.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Set the module TikiWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/103/featured-links-menu/edit-modules-4-set.gif" title="Click here to view the larger image" width="100" /></a><strong>Click the <em>Change them here</em> checkbox and click Set. </strong><br style="clear: both;" />
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/103/featured-links-menu/edit-modules-5-feature-enabled.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Featured Links Enabled TikiWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/103/featured-links-menu/edit-modules-5-feature-enabled.gif" title="Click here to view the larger image" width="100" /></a>The Preference feature featuredLinks enabled will confirm the module was enabled. <br style="clear: both;" /></p>
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/103/featured-links-menu/edit-modules-6-list.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="List of Modules TikiWIki" src="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/103/featured-links-menu/edit-modules-6-list.gif" title="Click here to view the larger image" width="100" /></a>The featured_links module will show in the list of modules for the page location.
<p>To add links to the featured_links, <strong>visit tiki-admin_links.php in your browser.</strong> Simply append the tiki-admin_links.php to the end of your TikiWiki home page similar to the following.</p>
<p style="margin-left: 20px;"><strong>example.com/tiki-admin_links.php</strong></p>
<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/103/featured-links-menu/edit-modules-7-add-link.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Adding links to the featured Links TikiWIki" src="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/103/featured-links-menu/edit-modules-7-add-link.gif" title="Click here to view the larger image" width="100" /></a><strong>Add the URL and Title for the link you want to add and click save</strong>. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/103/featured-links-menu/edit-modules-8-list-of-links.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="List of URLS in Featured Links TikiWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/103/featured-links-menu/edit-modules-8-list-of-links.gif" title="Click here to view the larger image" width="100" /></a><strong>Repeat the last step</strong> in adding links to the featured_links till you have a list of links you want to display in the footer. <br style="clear: both;" />
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/103/featured-links-menu/edit-modules-9-final-result.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Final view of Featured Links tikiwiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/103/featured-links-menu/edit-modules-9-final-result.gif" title="Click here to view the larger image" width="100" /></a>Now your Featured links will display as a menu in your footer like the snapshot to the right. <br style="clear: both;" /></p>
</li>
</ol> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/tiki-wiki/create-menu-tikiwiki/featured-links-menu&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/tiki-wiki/create-menu-tikiwiki/featured-links-menu'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMjMmaWQ9MjE0NCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="f694a4b32bbefb66eb5431c0d422018a" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/tiki-wiki/create-menu-tikiwiki?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Creating menus in TikiWIki</h3></a>
		<table>  <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/tiki-wiki/create-menu-tikiwiki/featured-links-menu?tsrc=rsbedu'>How to add the Featured Links menu in the TikiWiki</a></td>
                </tr>
          	</table>
