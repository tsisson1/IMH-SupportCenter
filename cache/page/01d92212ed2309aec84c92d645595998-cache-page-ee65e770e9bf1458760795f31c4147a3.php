<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:59750:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/email/mac-mail/fix-apple-mail-error-moving-files" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-04-06T15:00:01-07:00" />
  <meta name="author" content="Arnel Custodio" />
  <meta name="description" content="Apple's mail client often has an error when the folders have not been assigned with a mail account.  Fix the &quot;error while moving messages &quot;null&quot; error by following the directions in this tutorial." />
  <title>How to fix error while moving messages in Apple Mail - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/email/mac-mail/fix-apple-mail-error-moving-files" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:d4dcc19909154444e0780fdf380399de -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-20']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '50.80.157.97']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to fix error while moving messages in Apple Mail									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>5,049</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Dec 9, 2015'><span style='color:#606060;'>Published:</span> Apr 6, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<p>A common problem with Apple Mail (also often called Mac Mail) is the "error occurred while moving messages to mailbox (null)" error. This problem occurs when folders for the Drafts, Sent, Junk, or Trash mailbox are not assigned.  This error most commonly occurs when deleting messages and the Trash mail box has not been assigned, but happens whenever messages are moved without the folders being assigned. Here's a screenshot of the error:</p>

<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/fix-apple-mail-folders/moving-mail-error.png"><img style="float: left; margin: 15px 15px 0px 0px;"  width="200" alt="Apple Mail error when moving messages" src="//cdn.inmotionhosting.com/support/images/stories/fix-apple-mail-folders/moving-mail-error.png" align="left" /></a>
	<div style="clear:both;"></div>
<br />

<p>In order to use these instructions, you will need to have added an email account into the Apple Mail client.</p>

<ol class="article_list">

<li>Login to the Apple Mail Client</li>

<li>
	<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/fix-apple-mail-folders/choose-folder-for-mailbox-assign.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="200" alt="choose folder" src="//cdn.inmotionhosting.com/support/images/stories/fix-apple-mail-folders/choose-folder-for-mailbox-assign.png" align="right" /></a>
	
	<p>Scroll down to your newly added mail account.  Click on the drop-arrow to see the Drafts, Sent, Junk, and Trash folders, then click on the Drafts folder to highlight it</p>

	<div style="clear:both;"></div>
</li>

<li>
	<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/mac-mail-folder-assign/choose-drafts-folder.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="200" alt="Choose drafts folder" src="//cdn.inmotionhosting.com/support/images/stories/mac-mail-folder-assign/choose-drafts-folder.png" align="right" /></a>

	<p>In the Menu at the top of the screen, click on Mailbox, then scroll down to Use This Mailbox As, then click on the Drafts Mailbox.  This will assign the Drafts folder in the client to the corresponding server folder.  </p>

 	<div style="clear:both;"></div>  
</li>

<li>Repeat this action for all of your folders (Sent, Junk, and Trash), and make sure to click on the respective folder assignment. As you add these folders, you will see the email account name added for each option. </li>

</ol>	
<br />

<p>When the folders have been assigned, the error will not appear.
</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/email/mac-mail/fix-apple-mail-error-moving-files&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/email/mac-mail/fix-apple-mail-error-moving-files'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD01OSZpZD0zNjkzJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/6341c40531e8936d7b18a14e4f3f68c3?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/6341c40531e8936d7b18a14e4f3f68c3'>Mike</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-31 1:15 am</div>
				                <div><p>When I do this, all of the options for how to "Use this mailbox as" are grayed out. &nbsp;Now what?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31569);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-01 11:23 am</div>
				                <div>Hello Mike,<br />
<br />
Thank you for contacting us. I found a post in the apple forums where they discuss  the <a href="https://discussions.apple.com/thread/4266632?tstart=0">"Use This Mailbox For" grayed out</a> issue.<br />
<br />
I hope this helps,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31622);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-32175'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/3e2cca7b65d82029f6fb97b813288b4c?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/3e2cca7b65d82029f6fb97b813288b4c'>James</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-22 10:39 am</div>
				                <div><p>Worked like a charm!!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32175);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
