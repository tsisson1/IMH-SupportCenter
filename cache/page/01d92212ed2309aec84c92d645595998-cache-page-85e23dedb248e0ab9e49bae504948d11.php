<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49682:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/email/insert-data-into-database-using-javascript" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, Thanks for the question. If you are looking for code to insert data via javascript on your HTML form, that service is unfortunately beyond the sc..." />
  <title>insert data into database using JAVASCRIPT | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/email/insert-data-into-database-using-javascript" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:c87b7656b9cfed713402382fbf1253fa -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>insert data into database using JAVASCRIPT</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2014-12-24 6:50 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>474</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I am working on a registration form in html.<br />
I want to get  the input field and post them into database(I am having the link of my datadase) using  JAVASCRIPT ONLY</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_6181' id='upvote_answer_6181' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='6181' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_6181').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_6181' id='downvote_answer_6181' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='6181' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_6181').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
Thanks for the question.  If you are looking for code to insert data via javascript on your HTML form, that service is unfortunately beyond the scope of our support in the support center.  However, there are many resources available on the internet that can help you with this particular issue.  Check out <a href="https://developer.mozilla.org/en-US/docs/Web/Guide/HTML/Forms/Sending_forms_through_JavaScript" rel="nofollow" target="_blank">Mozilla's guide on Sending forms through Javascript</a>.  You may also want to run a query through your favorite search engine for many other examples and helpful information.<br />
<br />
Sorry we can't provide a specific answer for this issue, but please let us know if you have any further questions or comments.<br />
<br />
Regards,<br />
Arnel C.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_6181').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_6181' id='form_comment_on_answer_6181' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/email/insert-data-into-database-using-javascript&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/email/insert-data-into-database-using-javascript'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="13b8fe3d2db95a35d3474fd5237cae5a" value="1" />	</div>
	</form>
<!-- <br />
