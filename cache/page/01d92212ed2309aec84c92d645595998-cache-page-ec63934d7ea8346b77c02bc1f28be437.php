<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:85438:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-file-manager/coming-soon-page" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-01-30T21:28:20-08:00" />
  <meta name="keywords" content="coming soon under construction page website" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Want to create a Coming Soon or Under Construction page for your website? Read this article to find out how." />
  <title>Creating an Under Construction or Coming Soon page - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-file-manager/coming-soon-page" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:b27df7f4461bcf2eb1722f0832831e4d -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '196.218.121.2']);
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/cpanel' itemprop='url'><span itemprop='title'>cPanel<span></a><div class='dropdown_4columns'><h2>cPanel Education Channel</h2><div class='col_2'><h3>100 Level Classes</h3><div><a href='/support/edu/cpanel/getting-started-cpanel'>101: Getting Started in cPanel</a></div><div><a href='/support/edu/cpanel/cpanel-fantastico'>102: Fantastico de Luxe</a></div><div><a href='/support/edu/cpanel/softaculous'>103: Using Softaculous</a></div></div><div class='col_2'><h3>200 Level Classes</h3><div><a href='/support/edu/cpanel/cpanel-email'>201: Using Email</a></div><div><a href='/support/edu/cpanel/cpanel-file-manager'>202: Managing your Files in cPanel</a></div><div><a href='/support/edu/cpanel/cpanel-manage-domains'>203: Managing your Domains in cPanel</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/cpanel/cpanel-file-manager' itemprop='url'><span itemprop='title'>202: Managing your Files in cPanel<span></a><div class='dropdown_3columns'><h2> Managing your Files in cPanel</h2><div class='col_3'><div>1. <a style='display:inline;' href='/support/edu/cpanel/cpanel-file-manager/complete-cpanel-backup'>How to Perform a Full Backup in cPanel</a></div><div>2. <a style='display:inline;' href='/support/edu/cpanel/cpanel-file-manager/renaming-files-folders'>Renaming files and folders in cPanel</a></div><div>3. <a style='display:inline;' href='/support/edu/cpanel/cpanel-file-manager/using-file-manager-in-cpanel'>Using File Manager in cPanel</a></div><div>4. <a style='display:inline;' href='/support/edu/cpanel/cpanel-file-manager/file-manager-code-editor'>How to Use the Code Editor in the cPanel File Manager</a></div><div>5. <a style='display:inline;' href='/support/edu/cpanel/cpanel-file-manager/coming-soon-page'>Creating an Under Construction or Coming Soon page</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Creating an Under Construction or...</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Creating an Under Construction or Coming Soon page									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>49,632</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 30, 2013'><span style='color:#606060;'>Published:</span> Jan 30, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<div>When building a website, you may not want random visitors snooping your pages until you are ready for them. Even while some programs allow you to build your site on your local computer and then publish when you are finished, you still may want to test your site on the live server before opening to the public. In this case, you may want to place an "Under Construction" or "Coming Soon" page in place.</div>
<div>&nbsp;</div>
<div>The problem lies with how your hosting server looks for the first page of your site, also called the index page. The server looks for pages that are named index.htm, index.html, index.php, and default.htm, in that order. If it finds a file with one of those names, it places that as the landing page of your website. Website design programs most often create an index.html or index.php page. When publishing your site, even for testing, it is likely that the first page will begin to display to the public. This article will guide you on how to create and set up a placeholder page so that you can work on your site in the background.</div>
<div>&nbsp;</div>
<h2>How to create a custom Under Construction/Coming Soon page</h2>
<ol class="article_list">
<li><a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">Log into cPanel</a>.</li>
<li><a href="/support/edu/cpanel/cpanel-file-manager/using-file-manager-in-cpanel">Enter the File Manager</a>. Be sure to navigate to the root folder for the domain you are working with. If it is the primary domain, use <em>public_html</em>.</li>
<li>Click on <strong>New File</strong>, an icon found in the toolbar at the top of the page.</li>
<li>Next, give the file a name. Our example will be named <em>comingsoon.html</em>. Click on the <strong>Create New File</strong> button to complete its creation. Note this simply creates an empty file.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/howto/website/namepage.png"><img  alt="create and name the file" src="//cdn.inmotionhosting.com/support/images/stories/edu/howto/website/namepage.png" /></a></li>
<li>Now we need to edit the empty file. Highlight the filename and then click on <strong>HTML Editor</strong>. This allows you to create the page visually, no coding needed. You can make it as fancy or simple as you wish. In our example we will make it very simple.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/howto/website/edit-page.png"><img  alt="add page content" src="//cdn.inmotionhosting.com/support/images/stories/edu/howto/website/edit-page.png" /></a></li>
<li>Once you have designed your page, click on the <strong>Save</strong> button in the upper left of the tool bar. It appears as a floppy disk.<br /><br /></li>
<li>Now that you have created the page, you need to set the filen ame as your default for your website. Those instructions are found in our article on <a href="/support/website/general-server-setup/htaccess-change-index-page">How to change your default index page in .htaccess</a>. Below is a screenshot of how the page will display on the web once that is completed.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/howto/website/after.png"><img  alt="coming soon page in place" src="//cdn.inmotionhosting.com/support/images/stories/edu/howto/website/after.png" /></a></li>
</ol>
<div>&nbsp;</div> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/cpanel/cpanel-file-manager'>202: Managing your Files in cPanel</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 5: Creating an Under Construction or Coming Soon page</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 4: <a href='/support/edu/cpanel/cpanel-file-manager/file-manager-code-editor'>How to Use the Code Editor in the cPanel File Manager</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/cpanel/cpanel-file-manager/coming-soon-page&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/cpanel/cpanel-file-manager/coming-soon-page'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xMzUmaWQ9MjIxNSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="95e2bf48c0fa2a538598be42b5879b48" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/cpanel/cpanel-file-manager?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Managing your Files in cPanel</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/cpanel/cpanel-file-manager/complete-cpanel-backup?tsrc=rsbedu'>How to Perform a Full Backup in cPanel</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/cpanel/cpanel-file-manager/renaming-files-folders?tsrc=rsbedu'>Renaming files and folders in cPanel</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/cpanel/cpanel-file-manager/using-file-manager-in-cpanel?tsrc=rsbedu'>Using File Manager in cPanel</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/cpanel/cpanel-file-manager/file-manager-code-editor?tsrc=rsbedu'>How to Use the Code Editor in the cPanel File Manager</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/cpanel/cpanel-file-manager/coming-soon-page?tsrc=rsbedu'>Creating an Under Construction or Coming Soon page</a></td>
                </tr>
          	</table>
...
<a name='comments'></a>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/9856346f9c99f5a4a9b82ad72d361bb3?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/9856346f9c99f5a4a9b82ad72d361bb3'>ranvijay</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-26 12:49 pm</div>
				                <div><p>i created the webpage for under construction&nbsp;now how do i remove this so that my website gets online ?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12029);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-26 12:52 pm</div>
				                <div>To do so, you will simply revert the changes that you made to your .htaccess file and remove the file that you created.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12030);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-12114'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/3e3c1f344d02ac5cb47f0afce1403f0e?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/3e3c1f344d02ac5cb47f0afce1403f0e'>Tom</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-28 3:54 pm</div>
				                <div><p>Hello,</p>
<p>What about if we have more than a website on the same hoem directory and we wish to display the message for only one site? Is this possible?</p>
<p>&nbsp;</p>
<p>Thank you</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12114);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-06-28 4:34 pm</div>
				                <div>Hello Tom,<br />
<br />
Yes, the public_html is the root folder for your primary domain. Other addon domains will have their own home folders (usually named the same as the website, only the public_html is different in that regard) so they will be unaffected by files in other folders.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12115);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-14139'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/677201c3437e002bcf26ece4daa79293?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/677201c3437e002bcf26ece4daa79293'>Benard</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-20 4:25 am</div>
				                <div><p>I would like to have this default page /underconstraction package in my hosting packages.In that when a clients purchases any package before they add anything&nbsp; the default page shuld be displayed</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14139);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-20 10:48 am</div>
				                <div>Hello Benard,<br />
<br />
Thank you for your question. You can <a href="http://www.inmotionhosting.com/support/reseller/custom-default-page">setup a custom Landing page</a> in cPanel.<br />
<br />
It will then load the custom page by default.<br />
<br />
If you have any further questions, feel free to post them below.<br />
Thank you,<br />
<br />
-John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14150);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-21106'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/8e68409ef6e0c3719f5c4254fa6a2dd6?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/8e68409ef6e0c3719f5c4254fa6a2dd6'>William</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-26 2:13 pm</div>
				                <div><p>Hello,</p>
<p>I just put my website to under construction mode, please how do i restore or make it active for people to have access.</p>
<p>Thank</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21106);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-27 9:33 am</div>
				                <div>Hello William,<br />
<br />
If you are ready for the world to see your site, simply rename or delete the coming soon page.<br />
<br />
Kindest Regards,<br />
Scott M<br />
</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21143);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-21684'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/8cfdc427f60f3e5b5ed42f7261b47ec9?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/8cfdc427f60f3e5b5ed42f7261b47ec9'>sam</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-13 9:14 am</div>
				                <div><p>how can i undo the cpanel underconstruction? it cant load the page.</p>
<p>http://euyne.com</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21684);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-16 11:53 am</div>
				                <div>Hello Sam,<br />
<br />
I am seeing a coming soon page, but not one from cPanel. Also, your domain is not pointed to us, so I am unable to see an account on our servers. You will want to check your main index page and that should be the one that is the coming soon page. Replace that one with the first page of your site and it should display properly.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21759);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-23602'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/b8deb086b22bb8e4252af9bc1e21d362?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/b8deb086b22bb8e4252af9bc1e21d362'>ariyo</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-05-21 1:53 pm</div>
				                <div><p>Hello, i have created a coming soon page and placed this in my .htaccess file. but my website is not displaying the comingsoon file still..</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23602);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-05-21 3:59 pm</div>
				                <div>Hello ariyo,<br />
<br />
Thank you for contacting us. Make sure your website is pointed to your host. For example, if you are hosted with us you should <a href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes">Point to InMotion Hosting</a>.<br />
<br />
What happens when you visit your site? Do you get an error?<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23611);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-32508'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/1b58e0c481eafebcc88c9a84913652c1?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/1b58e0c481eafebcc88c9a84913652c1'>bhargavi</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-05-07 3:03 am</div>
				                <div><p>why &nbsp;it will show the error like website under construction due to url error or structural error??? can anyone help</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32508);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-05-09 9:39 am</div>
				                <div>Hello bhargavi,<br />
<br />
Thank you for contacting us. What is the full error you are getting?<br />
<br />
Can you provide a link to the error message?<br />
<br />
Best Regards,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32530);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
