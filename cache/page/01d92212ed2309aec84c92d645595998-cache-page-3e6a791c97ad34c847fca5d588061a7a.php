<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49650:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/email-client-setup/maildomaincom" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hi Keat Wei, Thanks fro posting your question. You need not change the CNAME record. You'll need to set up MX records to handle mail for your Google App..." />
  <title>mail.domain.com | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/email-client-setup/maildomaincom" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:56b5278422c17a7dc6d9277301a0a95e -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>mail.domain.com</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/daveckw'>daveckw</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2011-11-19 8:03 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>9,743</span>
			</div>
...
<br />
I tried to add a CNAME for my mail.domain.com but the system said it is Reserved. How do I change this because i want to point it to Google Apps.<br />
Thank you.<br />
<br />
Regards,<br />
Keat Wei</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_251' id='upvote_answer_251' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='251' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_251').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_251' id='downvote_answer_251' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='251' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_251').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hi Keat Wei,<br />
<br />
Thanks fro posting your question. You need not change the CNAME record. You'll need to set up MX records to handle mail for your Google Apps account. Here's a few links that you may find helpful:<br />
<br />
<a href="http://www.google.com/support/a/bin/answer.py?answer=174125">Google Mail set up for Google Apps</a><br />
<br />
<a href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-email/modfying-mx-records">Modifying MX records</a><br />
<br />
...
Tim S
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_251').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_251' id='form_comment_on_answer_251' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/email-client-setup/maildomaincom&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/email-client-setup/maildomaincom'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="776ac0a749ed7749c1ca6807a0fae9bd" value="1" />	</div>
	</form>
<!-- <br />
