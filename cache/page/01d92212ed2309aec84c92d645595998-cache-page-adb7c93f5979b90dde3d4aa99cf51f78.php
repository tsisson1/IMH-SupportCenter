...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/drupal-7/working-with-content" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="When you begin using Drupal 7, one of the first things you should learn is how to create new pages. In the following tutorials, we'll explain the differences between basic pages and articles, and we'll also show you how to create each of these." />
  <title>102: Working with Content in Drupal 7 | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/drupal-7/working-with-content" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:0d2f30d6f81d7ceef2a9e7ae691621b7 -->
...
<div class='page-header'>
	<h1>102: Working with Content in Drupal 7</h1>
</div>
<div class='section_listing'>
		...
		<tr>
			...
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/drupal-7/working-with-content/writing-articles'>Creating an Article in Drupal 7</a>
					<div>Articles in Drupal 7 are like news bulletins. They show on your homepage, and as you publish more articles the older ones get pushed further down the page.</div>
					<div class='smallgrey'>Hits: 10,463</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/drupal-7/working-with-content/add-download-field'>How to add a download field in Drupal 7</a>
					<div>This article will guide you on how to add a download field for visitors to be able to download a file on a content page in Drupal 7.</div>
					<div class='smallgrey'>Hits: 11,011</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/drupal-7/working-with-content/add-text-file-for-download'>How to add a text file for visitor download in Drupal 7</a>
					<div>This Drupal 7 article walks you through adding a text file for your users to download within a page of specific content type.</div>
					<div class='smallgrey'>Hits: 3,628</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/drupal-7/working-with-content/wysiwyg-troubleshooting'>How to get the WYSIWYG editor to work in Drupal 7</a>
					<div>This article helps with troubleshooting when your wysisyg module's buttons do not display after it is installed and configured.</div>
					<div class='smallgrey'>Hits: 11,882</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/drupal-7/working-with-content/add-image'>How to add an image in Drupal 7</a>
					<div>This Drupal 7 article will guide you on how to add an image to a content page.</div>
					<div class='smallgrey'>Hits: 6,182</div>
				</td>
			</tr>
			<tr>
