<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:72429:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/wordpress/secure-wordpress-with-wordpress-captcha-plugin" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-05-17T12:43:43-07:00" />
  <meta name="keywords" content="install wordpress captcha plugin" />
  <meta name="author" content="Jacob Nicholson" />
  <meta name="description" content="In this article we'll discuss how to install and secure your WordPress website with the WordPress Captcha plugin, which can help secure your WordPress forms. The WordPress Captcha plugin can help secure your login form, register form, lost password form, and comments form from unwanted spam bots that might try to register for fake accounts to leave comment spam on your site." />
  <title>How to Secure WordPress with WordPress Captcha plugin - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/wordpress/secure-wordpress-with-wordpress-captcha-plugin" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:84eb3bbfba6af686c9b1a42cbc87e138 -->
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to Secure WordPress with WordPress Captcha plugin</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to Secure WordPress with WordPress Captcha plugin									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>10,351</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Dec 3, 2012'><span style='color:#606060;'>Published:</span> May 17, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In this article we'll discuss how to install and secure your WordPress website with the WordPress Captcha plugin, which can help secure your WordPress forms. The WordPress Captcha plugin can help secure your login form, register form, lost password form, and comments form from unwanted spam bots that might try to register for fake accounts to leave comment spam on your site.</p>
<p>If you are already dealing with an outbreak of comment spam on your WordPress site, we would recommend reading about <a href="/support/website/website-troubleshooting/dealing-with-spam-in-your-posts-and-comments">dealing with spam in your posts and comments</a> for some instructions on how you can clean up this spam.</p>
<p>The WordPress Captcha plugin is a bit different than some other common Captcha systems out there that utilize skewed words or other ways to make text harder to read. This plugin instead operates by requiring users to solve simple math problems before allowing them to leave a comment, or registering for a new account.</p>
<p>Following the steps below we'll walk you though installing and configuring the WordPress Captcha plugin on your website so that you can help secure your WordPress installation from malicious users trying to leave spam on your site.</p>
<h2>
  Securing WordPress with the Captcha plugin
</h2>
<ol class="article_list">
<li>First login to your WordPress administration dashboard, this is typically done by just going to be your website's address followed by <span class="code_block">/wp-admin</span>.</li>
<li>Hover over <strong>Plugins</strong> in the left-hand menu, then click on <strong>Add New</strong>.<br /> <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/wordpress-captcha/click-on-plugins-select-add-new.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/wordpress-captcha/click-on-plugins-select-add-new.png" alt="click-on-plugins-select-add-new"  /></a></li>
<li>In the <strong>Search</strong> field, type in <strong>Captcha</strong> and then click <strong>Search Plugins</strong>.</li>
<li>Beside <strong>Captcha</strong> click on <strong>Install Now</strong>.<br /> <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/wordpress-captcha/click-install-now.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/wordpress-captcha/click-install-now.png" alt="click-install-now"  /></a></li>
<li>Next click <strong>Yes</strong> on the <strong>Are you sure you want to install this plugin?</strong> confirmation pop-up.</li>
<li>Then click on <strong>Activate Plugin</strong> after the plugin has installed.<br /> <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/wordpress-captcha/click-on-activate-plugin.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/wordpress-captcha/click-on-activate-plugin.png" alt="click-on-activate-plugin"  /></a></li>
<li>Now you should be dropped back to the main <strong>Plugins</strong> page, from here click on <strong>Settings</strong> under <strong>Captcha</strong>.<br /> <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/wordpress-captcha/click-on-settings-for-captcha-plugin.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/wordpress-captcha/click-on-settings-for-captcha-plugin.png" alt="click-on-settings-for-captcha-plugin"  /></a></li>
<li>From the plugin's settings page, you can set which forms you'd like to protect with the <strong>Captcha</strong> plugin, the label you'd like to display above it, and also the type of arithmetic actions and difficulties you'd like available. When you're done with your settings click on <strong>Save Changes</strong>.<br /> <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/wordpress-captcha/captcha-options-click-save-changes.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/wordpress-captcha/captcha-options-click-save-changes.png" alt="captcha-options-click-save-changes"  /></a></li>
<li>You should now see the <strong>Captcha</strong> plugin has added itself to your comment form. We used the label <strong>Human verification</strong> in our settings so that's what you'll see on the form.<br /> <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/wordpress-captcha/fill-in-captcha-invalid.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/wordpress-captcha/fill-in-captcha-invalid.png" alt="fill-in-captcha-invalid"  /></a>
<p>You should also notice that in this example I've answered the math question incorrectly by typing in a <strong>4</strong> instead of the proper <strong>3</strong>. When we try to submit the form with this invalid answer we should now be getting an error:</p>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/wordpress-captcha/captcha-error-wrong-phrase.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/wordpress/wordpress-captcha/captcha-error-wrong-phrase.png" alt="captcha-error-wrong-phrase"  /></a></li>
</ol>
<p>You should now understand how to help secure your WordPress website from unwanted comment spam and fake user registrations using the WordPress Captcha plugin.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/wordpress/secure-wordpress-with-wordpress-captcha-plugin&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/wordpress/secure-wordpress-with-wordpress-captcha-plugin'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD02MyZpZD00ODkmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="a0e484cfec85794eff6efaa9f98133b4" value="1" />	</div>
	</form>
<!-- <br />
...
<a name='comments'></a>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/f12f16d400d0cb3d4174d39e1ee5f863?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/f12f16d400d0cb3d4174d39e1ee5f863'>Aron &amp; Rebekah Schrepfer</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-11 3:15 pm</div>
				                <div>Thank you!  InMotion has been a huge help to us as we develop and maintain our blogs.  Recommending this plugin was just one way that you have not only hosted our sites, but helped us improve them.  Thank you!</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17313);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-18314'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/1f1a6b8126bfc339bc15d20e7c8f7668?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/1f1a6b8126bfc339bc15d20e7c8f7668'>neha</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-10 6:12 am</div>
				                <div><p>can you please provide us shortcode for this to be use on custom forms? please reply asap.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(18314);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-10 12:29 pm</div>
				                <div>Hello Neha,<br />
<br />
According to the plugin description for the <a href="https://wordpress.org/plugins/recaptcha-form/" rel="nofollow" target="_blank">recaptcha form</a>, you simply have to use <b> [recaptcha_form]</b> on any page or post.  I hope this helps to answer your question, please let us know if you require any further  assistance.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(18329);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-26796'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/303c7fabe3d0d43bd613975bd49507d8?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/303c7fabe3d0d43bd613975bd49507d8'>Shah Alam</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-19 11:42 am</div>
				                <div><p><code>Thanks for the information</code></p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26796);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
