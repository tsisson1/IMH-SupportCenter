<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:60569:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/prestashop-15/sql-manager/add-sql-queries" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-10-05T13:52:47-07:00" />
  <meta name="keywords" content="custom SQL query queries PrestaShop 1.5" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="This PrestaShop 1.5 article covers how to add custom SQL queries to your store." />
  <title>How to add custom SQL Queries in PrestaShop 1.5  - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/prestashop-15/sql-manager/add-sql-queries" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:8861d90e23ccd1fa83cc9b667e034711 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '82.229.12.109']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to add custom SQL Queries in PrestaShop 1.5 									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>6,875</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Oct 5, 2012'><span style='color:#606060;'>Published:</span> Oct 5, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Our first article in our course on <a href="/support/edu/prestashop-15/sql-manager">Working with SQL Manager</a> discusses the ability for you to work with custom SQL queries. It is a complex technical feature and should only be used by those familiar with the SQL database query language, however, it can be a very powerful tool if used properly.</p>
<p><strong>Adding SQL queries in PrestaShop 1.5</strong></p>
<ol class="article_list">
<li><a href="/support/edu/prestashop-15/getting-started/login-to-dashboard"> Log into your PrestaShop 1.5 dashboard</a>.</li>
<li>Using the top menu bar, hover over the <strong>Advanced Parameters</strong> tab and click on the <strong>SQL Manager</strong> option from the menu.</li>
<li>You are now on the <em>SQL Manager</em> page. To add a new custom query, click on the green <strong>Add New</strong> button found in the upper right hand corner of the screen.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Advanced_Paramaters/SQL_Manager/Add/add-query.png"><img  alt="add-query" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Advanced_Paramaters/SQL_Manager/Add/add-query.png" /></a></li>
<li>This brings you to the query build screen. There are two fields here, Name and Request. Both are required. The Name field is simply the name you want to give your query. The Request field is where you type your SQL query code in. Our query is a very simple one that selects data from all the fields from the ps_product table.     <br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Advanced_Paramaters/SQL_Manager/Add/build-query.png"><img  alt="build-query" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Advanced_Paramaters/SQL_Manager/Add/build-query.png" /></a>&nbsp;     <br /> Below that is an area where you see a list of all the tables within your PrestaShop 1.5 database. You can highlight any table and see the fields associated with that table on the right. This way you can get the field names you need to help build a complex query.     <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Advanced_Paramaters/SQL_Manager/Add/table-list.png"><img  alt="table-list" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Advanced_Paramaters/SQL_Manager/Add/table-list.png" /></a></li>
<li>Once you have your query constructed, click the <strong>Save</strong> button located underneath the <strong>Request</strong> field. This will save your query and return you to the <em>Query</em> list page. You will see your new query in the list.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Advanced_Paramaters/SQL_Manager/Add/add-query-after.png"><img  alt="add-query-after" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/Advanced_Paramaters/SQL_Manager/Add/add-query-after.png" /></a></li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/prestashop-15/sql-manager'>215: Working with SQL Manager in PrestaShop 1.5</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 1: How to add custom SQL Queries in PrestaShop 1.5 </div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 2: <a href='/support/edu/prestashop-15/sql-manager/view-query-results'>How to view custom SQL Query results in PrestaShop 1.5 </a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/prestashop-15/sql-manager/add-sql-queries&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/prestashop-15/sql-manager/add-sql-queries'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNzImaWQ9MTgzOSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="7680a10421e43a374e28956939f4cb66" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/prestashop-15/sql-manager?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Working with SQL Manager in PrestaShop 1.5</h3></a>
		<table>  <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/prestashop-15/sql-manager/add-sql-queries?tsrc=rsbedu'>How to add custom SQL Queries in PrestaShop 1.5 </a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/prestashop-15/sql-manager/view-query-results?tsrc=rsbedu'>How to view custom SQL Query results in PrestaShop 1.5 </a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/prestashop-15/sql-manager/export-custom-query?tsrc=rsbedu'>How to export a custom SQL Query in PrestaShop 1.5 </a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/prestashop-15/sql-manager/delete-custom-query?tsrc=rsbedu'>How to delete a custom SQL Query in PrestaShop 1.5 </a></td>
                </tr>
          <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/prestashop-15/sql-manager/set-encoding-type?tsrc=rsbedu'>How to set the Encoding Type for SQL Manager in PrestaShop 1.5 </a></td>
                </tr>
          	</table>
