<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:76408:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.net/support/website/general-server-setup/server-security-best-practices" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-06-03T18:28:01-07:00" />
  <meta name="keywords" content="secure securing security server best practices" />
  ...
  <link href="http://www.inmotionhosting.com/support/website/general-server-setup/server-security-best-practices" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:29fce74ce495eb84798fff5f8730a1ff -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-22']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '157.55.39.84']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Server security best practices									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>7,399</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Dec 5, 2012'><span style='color:#606060;'>Published:</span> Jun 3, 2015</div>
...
<p class="alert alert-danger">Although some of the information applies to shared, <a href="http://www.inmotionhosting.com/reseller-hosting">Reseller</a>, VPS, and Dedicaed plans. In order to follow some of these guidelines you would need to have <a href="http://www.inmotionhosting.com/support/edu/whm/intro-to-web-hosting/standard-vs-root-access" target="_blank">root access</a> first on your server.</p>

<h2>Strong passwords</h2>
<p>The first line of defense for most services that run on your server will be the <a href="http://www.inmotionhosting.com/support/website/security/password-strength" target="_blank">password strength</a> of your passwords.</p>
...
<p>If you have <a href="http://www.inmotionhosting.com/support/website/general-server-setup/root-access-faq">root access</a> on your server, if an unauthorized user logs into your server via the root user, this can be very bad. Sometimes this requires an evacuation to a new server to ensure nothing malicious was left behind.</p>

<h2>Limit server access</h2>
<p>Limit server access to only those that need it with the iptables firewall available on most Linux servers.</p>

<p>The default <a href="#apf">APF (Advanced Policy Firewall)</a> allows easy management of your iptables rules. There is also the more advanced <a href="#csf">CSF (ConfigServer Firewall)</a> that also controls your iptables but has a more robust feature set.</p>

<p>One common thing to do is <a href="http://www.inmotionhosting.com/support/website/pci-compliance/close-open-ports-for-pci-compliance" target="_blank">close open ports in your server firewall</a>. That way only the ports your server need to communicate to the outside world on will be accessible.</p>

<p>You can also <a href="http://www.inmotionhosting.com/support/website/whm/enable-cphulk-brute-force-protection" target="_blank">enable cPHulk brute force protection</a> on your server to automatically block users that repeatedly try to login with invalid credentials to various services.</p>

<a name="apf"></a>
<h3>APF - Advanced Policy Firewall</h3>
<p>APF or Advanced Policy Firewall should be installed on your server by default. APF allows for easy management of your iptables firewall rules for things such as <a href="http://www.inmotionhosting.com/support/website/general-server-setup/how-to-open-a-port-in-your-firewall" target="_blank">opening ports in your firewall</a>.</p>

<button class="btn btn-success collapsed" data-toggle="collapse" data-target="#viewdetailsA" style="margin-left: 150px;margin: 0px 0px 15px 175px;">Click here for more APF information</button>

<div class="collapse-group">
  <div class="collapse" id="viewdetailsA" style="height: 0px;">
    <div>
      <h4>Example commands:</h4>
    <p>Add IP to allowed hosts:</p>

    <p class="cli">apf -a 123.123.123.123 "Home IP"</p><p>Block IP from server:</p>
    <p class="cli">apf -d 123.123.123.123 "Hitting login.php again and again"</p>
    <p>Unblock a blocked IP:</p>
    <p class="cli">apf -u 123.123.123.123</p>
    <p>Block IP ranges:</p>
    <p class="cli">apf -d 123.123.123.123/24 <span style="color: red;">Not recommended</span></p>
<pre class="cli">vi /etc/apf/deny_hosts.rules
d=80:s=123.123.123.123/24
<span style="color: #75FF3F;">Recommended way to block IP range from accessing port 80</span>
</pre>

    <h4>Files:</h4>

<pre class="cli">/etc/apf 
<span style="color: #75FF3F;">Location of APF core files</span>
/etc/apf/conf.apf 
<span style="color: #75FF3F;">Main APF config file, contains options and allowed port definitions</span>
/etc/apf/allow_hosts.rules 
<span style="color: #75FF3F;">List of allowed IP addresses and ranges</span>
/etc/apf/deny_hosts.rules 
<span style="color: #75FF3F;">List of denies (blocked) IP addresses and ranges</span>
/etc/apf/bt.rules 
<span style="color: #75FF3F;">Rules based on conditions set in conf.apf, should not be edited manually unless required</span>
/var/log/apf_log 
<span style="color: #75FF3F;">Logs the output of APF start/stop/restart processes only</span></pre>
  </div>
  </div>
</div>

<a name="csf"></a>
<h3>CSF - ConfigServer Firewall</h3>
...
<button class="btn btn-success collapsed" data-toggle="collapse" data-target="#viewdetailsB" style="margin-left: 150px;margin: 0px 0px 15px 175px;">Click here for more CSF information</button>

<div class="collapse-group">
  <div class="collapse" id="viewdetailsB" style="height: 0px;">
    <div>
      <h4>Example commands:</h4>
    <p>Allow an IP:</p>
    <p class="cli">csf -a 123.123.123.123</p>

    <p>Temp allow an IP:</p>
    <p class="cli">csf -ta 123.123.123.123 15s (s - seconds / h - hours / m - minutes / d - day)</p>

    <p>Block an IP:</p>
    <p class="cli">csf -d 123.123.123.123</p>

    <p>Temp block an IP</p>
    <p class="cli">csf -td 123.123.123.123 15s (s - seconds / h - hours / m - minutes / d - day)</p>

    <p>Unblock a permanent blocked IP:</p>
    <p class="cli">csf -dr 123.123.123.123</p>

    <p>Unblock a temporary blocked IP:</p>
    <p class="cli">csf -tr 123.123.123.123</p>

    <p>List temporary blocked IPs and durations:</p>
    <p class="cli">csf -t</p>

    <p>Remove all temporary IP blocks:</p>
    <p class="cli">csf -tf</p>

    <p>Log all SYN packets from an IP</p>
    <p class="cli">csf -w 123.123.123.123</p>
    ...
    <p class="cli">vi /etc/csf/csf.conf</p>
    <p class="cli">SYNFLOOD=1</p>
    <p class="cli">service csf restart</p>
    ...
    <p class="cli">/etc/csf/csf.conf</p>
    ...
    <h4>Enable LFD Brute Force protection</h4>

    <p>You can enable the LFD brute force protection by editing:</p>

    <p class="cli">vi /etc/csf/csf.conf</p>

    <p class="cli">LF_DAEMON=1</p>

    <p>You can use the <span style="color: #75FF3F;">LF_*</span> settings down further in the file to set the login limits for each service on the server.</p>

    <h4>Reading the CSF log</h4>

    <p>When an IP has a packet dropped, it should be logged to:</p>

    <p class="cli">/var/log/messages</p>

    <p>Example dropped packet message:</p>

    <p class="cli">Aug 15 07:14:39 server kernel: Firewall: *TCP_IN Blocked* <span style="color: #75FF3F;">IN</span>=eth0 OUT= MAC=78:2b:cb:1c:00:1d:00:02:17:2c:6c:00:08:00 <span style="color: #75FF3F;">SRC</span>=190.86.203.61 <span style="color: #75FF3F;">DST</span>=173.247.251.145 
    LEN=52 TOS=0x00 PREC=0x00 TTL=112 ID=1155 DF <span style="color: #75FF3F;">PROTO</span>=TCP <span style="color: #75FF3F;">SPT</span>=49528 <span style="color: #75FF3F;">DPT</span>=2525 WINDOW=8192 RES=0x00 SYN URGP=0</p>

    <p>Log key:</p>

<pre class="cli"><span style="color: #75FF3F;">IN</span> : The interface
<span style="color: #75FF3F;">SRC</span> : The IP attempting to connect
<span style="color: #75FF3F;">DST</span> : The IP being connected to (the local server)
<span style="color: #75FF3F;">PROTO</span> : Protocol used (TCP/UDP)
<span style="color: #75FF3F;">SPT</span> : Source port
<span style="color: #75FF3F;">DPT</span> : Destination port</pre>
...
<pre class="cli">service apf stop
chkconfig --del apf
rm -f /etc/init.d/apf
rm -f /usr/local/sbin/apf
rm -rf /etc/apf</pre>

    <h4>Remove WHM Add IP to firewall feature</h4>

<pre class="cli">rm -rf /usr/local/cpanel/whostmgr/cgi/apfadd
rm -f /usr/local/cpanel/whostmgr/cgi/addon_add2apf.cgi</pre>

    <h4>Install CSF</h4>

    <p>InMotion Hosting customers:</p>

    <p class="cli">yum install -y csf-ded</p>

    <p>On any server:</p>

    <p>Download CSF source from <a href="http://configserver.com/cp/csf.html" target="_blank">ConfigServer CSF</a>.</p>

    <h4>Lost server access</h4>
...
<pre class="cli">/etc/csf 
<span style="color: #75FF3F;">location of CSF core files</span>
/etc/csf/csf.conf
<span style="color: #75FF3F;">Main CSF config file, contains options and allowed port definitions</span>
/etc/csf/csf.allow 
<span style="color: #75FF3F;">List of allowed IP addresses and ranges</span>
/etc/csf/csf.deny 
<span style="color: #75FF3F;">List of denies (blocked) IP addresses and ranges</span>
/etc/csf/csf.tempban 
<span style="color: #75FF3F;">Dynamically-updated list of temporarily-blocked IPs</span>
/var/log/messages
<span style="color: #75FF3F;">Where CSF logs its actions</span>
/etc/csf/csf.gallow
<span style="color: #75FF3F;">Global allow list (is generated automatically)</span>
/etc/csf/csf.gdeny
<span style="color: #75FF3F;">Global deny list (is generated automatically)</span>
/etc/csf/csf.gignore
<span style="color: #75FF3F;">Global ignore list (is generated automatically)</span></pre>
  </div>
  </div>
</div>

<h2>Limit website access</h2>

<p>You should review website access logs for unwanted activity and to <a href="http://www.inmotionhosting.com/support/website/security/block-unwanted-users-from-your-site-using-htaccess" target="_blank">block unwanted users from your website</a> if you find any. Blocking bad users at the website level is a good step before blocking them in your server's firewall.</p>

<p>We have an entire section dedicated to keeping tabs on <a href="http://www.inmotionhosting.com/support/website/server-usage" target="_blank">server usage</a> and for ways of finding and taking care of malicious activity that you will probably want to review and bookmark.</p>

<p>If you are using a CMS such as WordPress to run your website, make sure you're protected from things like a <a href="http://www.inmotionhosting.com/support/news/general/wp-login-brute-force-attack" target="_blank">WordPress Brute Force attack</a> so you admin dashboard is safe as well.</p>

<h2>Login to your server securely</h2>

<p>To securely connect to your server directly, you can use <a href="http://www.inmotionhosting.com/support/website/ssh/how-to-login-ssh" target="_blank">SSH</a> (Secure Shell) which encrypts your data.</p>

<p>By default, no outside IP addresses will be allowed to connect via SSH to your server for better security. So you will first want to <a href="http://www.inmotionhosting.com/support/website/ssh/add-ip-to-firewall" target="_blank">add your IP to the server firewall</a> so that you are able to connect.</p>

<h3>Secure file management</h3>

<p>When working with files on your server especially from a shared network, it's important to encrypt your login credentials so they are not passed in clear-text. You can also always <a href="http://www.inmotionhosting.com/support/website/server-security/disable-ftp-clear-plain-text-authentication" target="_blank">disable FTP clear/plain-text authentication</a> server-wide to force everyone connecting to your server to use a secure protocol.</p>

<p>You can use the underlying SSH technology to securely connect over port 22 on the server with <a href="http://www.inmotionhosting.com/support/website/ftp/connecting-scp-sftp" target="_blank">SCP and SFTP</a>.</p>

<p>You can also securely use FTP over SSL with the <a href="http://www.inmotionhosting.com/support/website/ftp/securely-connecting-your-website-using-ftp" target="_blank">FTPS</a> protocol.</p>

<h3>Secure application logins</h3>
...
<h4>Insecure cPanel application logins</h4>
...
<pre class="cli">http://example.com/cpanel      <span style="color: #75FF3F;">cPanel</span>
http://cpanel.example.com      <span style="color: #75FF3F;">cPanel</span>
http://example.com/whm         <span style="color: #75FF3F;">WHM</span>
http://whm.example.com         <span style="color: #75FF3F;">WHM</span>
http://example.com/webmail     <span style="color: #75FF3F;">Webmail</span>
http://webmail.example.com     <span style="color: #75FF3F;">Webmail</span></pre>

<h4>Secure cPanel application logins</h4>
...
<pre class="cli">https://example.com:2083     <span style="color: #75FF3F;">cPanel</span>
https://example.com:2087     <span style="color: #75FF3F;">WHM</span>
https://example.com:2096     <span style="color: #75FF3F;">Webmail</span></pre>

<p class="alert alert-success" style="margin-top: 15px;">You can <a href="http://www.inmotionhosting.com/support/edu/whm/creating-and-managing-accounts/log-into-whm" target="_blank">login to WHM</a> and then navigate to <strong>Tweak Settings &gt; Redirection</strong> and turn on <strong>Always redirect to SSL</strong> to force all cPanel applications to use <strong>https</strong> by default.</p>

<p class="alert alert-danger" style="margin-top: 15px;">If you didn't buy a SSL certificate for your server, you might get a <a href="http://www.inmotionhosting.com/support/website/ssl/self-signed-ssl-certificate-warning" target="_blank">self-signed SSL certificate warning</a> which is fine, your connection is still encrypted.</p>

<h4>Other server application logins</h4>
...
<h2>Make your server secure enough to handle credit card data</h2>
...
<p>In some cases the security recommendations could be overkill for general purpose websites. But when it comes to the security of your server it's always better to be safe than sorry. You can look at our article on <a href="/support/website/website-troubleshooting/how-to-pass-pci-scans" target="_blank">how to pass PCI compliance scans</a> for more information on the common things you can do to help further secure your server.</p>

<h2>General application security and updates</h2>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.net/support/website/general-server-setup/server-security-best-practices&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.net/support/website/general-server-setup/server-security-best-practices'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NCZpZD00OTMmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="78566190392b17dd7260a6aa5ea873f5" value="1" />	</div>
	</form>
<!-- <br />
