<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:47177:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/magento/108-products-a-product-categories-in-magento" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="This section in the Magento Tutorial series is aimed at teaching you how to work with products and product categories in the Magento Admin panel." />
  <title>108: Products and Product Categories in Magento 1.6 | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/magento/108-products-a-product-categories-in-magento" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:0b4b26db8ca5110563c89eb98dd9ef61 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '91.240.48.126']);
...
<div class='page-header'>
	<h1>108: Products and Product Categories in Magento 1.6</h1>
</div>
<div class='section_listing'>
	...
	<table>
		<tr>
				...
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/magento/108-products-a-product-categories-in-magento/creating-product-categories-in-magento'>Creating Product Categories in Magento 1.6</a>
					<div>In this Magento Tutorial, we'll show you how to create product categories. </div>
					<div class='smallgrey'>Hits: 2,515</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/magento/108-products-a-product-categories-in-magento/deleting-product-categories-in-magento'>Deleting Product Categories in Magento 1.6</a>
					<div>In this tutorial, we'll show you how to delete a product category in the Magento Backend. </div>
					<div class='smallgrey'>Hits: 3,786</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/magento/108-products-a-product-categories-in-magento/adding-products-in-magento'>Adding Products in Magento 1.6</a>
					<div>In this Magento Tutorial, we'll show you how to add new products to your catalog in the Magento backend. </div>
					<div class='smallgrey'>Hits: 1,533</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/magento/108-products-a-product-categories-in-magento/deleting-products-in-magento'>Deleting Products in Magento 1.6</a>
					<div>In this tutorial, we'll show you how to delete an existing product from your Magento backend.</div>
					<div class='smallgrey'>Hits: 2,046</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/magento/108-products-a-product-categories-in-magento/disabling-products-in-magento'>Disabling Products in Magento 1.6</a>
					<div>Learn how to disable a product but keep all of the settings in this Magento Tutorial.</div>
					<div class='smallgrey'>Hits: 3,166</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/magento/108-products-a-product-categories-in-magento/setting-a-special-price-for-products-in-magento'>Setting a Special Price for Products in Magento 1.6</a>
					<div>In this Magento Tutorial, we'll show you how to set a special price for a product in the Magento Admin Panel.</div>
					<div class='smallgrey'>Hits: 3,889</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/magento/108-products-a-product-categories-in-magento/allowing-backorders-for-specifc-products-in-magento'>Allowing Backorders for Specifc Products in Magento 1.6</a>
					<div>Learn how to allow backorders on specific products in Magento.</div>
					<div class='smallgrey'>Hits: 2,448</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/magento/108-products-a-product-categories-in-magento/labeling-a-product-out-of-stock-in-magento'>Labeling a Product Out of Stock in Magento 1.6</a>
					<div>Learn how to manually change the stock availability of out of stock for a specific product in Magento.</div>
					<div class='smallgrey'>Hits: 2,415</div>
				</td>
			</tr>
			</table>
</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xNzgmaWQ9MTc4JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="a1566729a1d45586ec9adf2b7fa2f18c" value="1" />	</div>
	</form>
<!-- <br />
