<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:72802:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/microsoft-publisher/publish-microsoft-publisher" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-04-21T22:51:13-07:00" />
  <meta name="keywords" content="MS publisher publishing" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="In this article, we will discuss how to publish using Microsoft Publisher." />
  <title>How to publish using Microsoft Publisher - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/microsoft-publisher/publish-microsoft-publisher" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:cbcc66c80129ab165f588691b0a297b0 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '89.191.53.110']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/website/microsoft-publisher' itemprop='url'><span itemprop='title'>Microsoft Publisher<span></a><div class='dropdown_3columns'><div class='col_3'><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/microsoft-publisher/publish-microsoft-publisher'>How to publish using Microsoft Publisher</a> (10295 hits)</div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to publish using Microsoft Publisher</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to publish using Microsoft Publisher									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>10,295</span></div>
							...
							<div style='clear:both;'></div>
								...
								<p>The following tutorial will assist you with publishing your website using Microsoft Publisher.</p>
<ol class="article_list">
<li>Open<strong> Microsoft Publisher</strong>, and then open the website you have developed.</li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/ms-publisher/mp_1.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="mp_1" src="//cdn.inmotionhosting.com/support/images/stories/ms-publisher/mp_1.gif" / align="right"></a>
<p>Click, "<strong>File</strong>", "<strong>Publish to the Web...</strong>"</p>
<div style="clear:both;"></div>
  <br />
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/ms-publisher/mp_2.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="mp_2"  src="//cdn.inmotionhosting.com/support/images/stories/ms-publisher/mp_2.gif" align="right"/></a><p>If you receive a generic message regarding, "<strong>To publish your Web site, you need to subscribe to a Web Hosting provider</strong>." Click <strong>OK</strong> to continue.<br /></p></li><div style="clear:both;"></div>
  
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/ms-publisher/mp_3.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="mp_3" src="//cdn.inmotionhosting.com/support/images/stories/ms-publisher/mp_3.gif" align="right" /></a>You will see a window asking you to save the file as index.htm. Change index.htm to ftp://example.com (replace example.com with your actual domain name) and click <strong>Save</strong>.
</li><div style="clear:both;"></div> 
  
  <li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/ms-publisher/mp_4.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="mp_4" src="//cdn.inmotionhosting.com/support/images/stories/ms-publisher/mp_4.gif" align="right"/></a><p>In the, "<strong>FTP Log On</strong>" window:<br />- Select, "<strong>User</strong>"<br />- Enter your cPanel username as the User<br />- Enter your cPanel password as the Password<br />- click <strong>OK</strong></p><br /><div style="clear:both;"></div>
  
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/ms-publisher/mp_5.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="mp_5" src="//cdn.inmotionhosting.com/support/images/stories/ms-publisher/mp_5.gif"  align="right" /></a><p>If you receive a dialog box from Windows asking, "<strong>Do you want to keep blocking this program?</strong>" click <strong>Unblock</strong>.<br /></p></li><div style="clear:both;"></div>
  
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/ms-publisher/mp_6.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="mp_6" src="//cdn.inmotionhosting.com/support/images/stories/ms-publisher/mp_6.gif" align="right" /></a>Your website files need to be uploaded to your <strong>public_html folder</strong>. Double click, "<strong>public_html</strong>" to open this folder. If your website is going to be directly in the <a href="/support/website/file-management/where-are-my-files-located">document root</a> then you don't need to do anything further.  If your website will be in a separate folder, then you need to look for the folder where your files will be saved and <strong>click it</strong>. For example, if you are publishing your website into a folder called "blog", then the website path may look like <b>http://document_root.com/blog</b>.</li><div style="clear:both;"></div>
  
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/ms-publisher/mp_7.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="mp_7" src="//cdn.inmotionhosting.com/support/images/stories/ms-publisher/mp_7.gif" align="right"/></a>Click, "<strong>Save</strong>"<br />
<p class="alert"><strong>Important!</strong> Make sure to <strong>click on the folder where your website files will be located before saving</strong>.</p>
</li>
<p>If you receive a warning regarding, "<strong>Publisher has created a filtered HTML version...</strong>" click <strong>OK</strong> to continue.<br /></p>
<p>You will see a ,"<strong>Publishing HTML file(s)...</strong>" message. When this has completed, your website has been uploaded!</p>
</ol>  
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/microsoft-publisher/publish-microsoft-publisher&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/microsoft-publisher/publish-microsoft-publisher'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MSZpZD0zOSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="e478d6cf81a6e4ac24df650f091fb980" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/microsoft-publisher/contrast-between-publisher-2003-vs-2007?tsrc=rsbraq'>What are the differences between Microsoft Publisher 2003 and 2007</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/frontpage/instead-of-word-press?tsrc=rsbraq'>Can I use Publisher Instead of WordPress?</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/4b39ebcd1d1fb9f76e982f83416a8cdd?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/4b39ebcd1d1fb9f76e982f83416a8cdd'>Rodwell Smith</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-16 3:04 pm</div>
				                <div><p>Appreciate the article,</p>
<p>Especially since I did not think it was possible to post from MS Publisher. However, I do use WordPress and can post a newsletter from MS Word. I noticed in the artcle it is for html site, so how could I post to a WordPress site?</p>
<p>Thank you,</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24254);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-17 12:05 am</div>
				                <div>Hello Rodwell Smith,<br />
<br />
You should be able to export the HTML like normal and put that HTML code in a post or page.<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24259);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-27587'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/402aff5ea9405f0778b4a1aa00c460a5?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/402aff5ea9405f0778b4a1aa00c460a5'>syahmi.r</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-16 4:35 am</div>
				                <div><p>hi, i want to create website by using ms publisher 2013. however i have problem with htp logon (win 7) which is i dont know what is the password. can you post or email me the tutorial of making website with ms publisher 2013?</p>
<p>&nbsp;</p>
<p>thank you, really need your help</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27587);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-19 12:08 pm</div>
				                <div>Hello ,<br />
<br />
Thank you for contacting us. Here is a link to our guide on <a href="http://www.inmotionhosting.com/support/website/microsoft-publisher/publish-microsoft-publisher">How to publish using Microsoft Publisher</a>.<br />
<br />
You can <a href="http://www.inmotionhosting.com/support/website/ftp/resetting-your-ftp-password-in-cpanel">reset your FTP password</a> in cPanel, and also <a href="http://www.inmotionhosting.com/support/website/ftp/getting-started-guide#view-settings">view your settings</a> at any time.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27646);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-32630'></a>
		<div  style='margin:2px 0px 0px 80px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/dbd79ce3e9490771383bb16694bb1c2a?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/dbd79ce3e9490771383bb16694bb1c2a'>Mugisha Dennis </a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-05-12 8:59 am</div>
				                <div><p>Hullo Sir, I managed to develop a website app using Ms Pulisher but i do not kown how to do the cade fragments and also i do not know how to pulish it to the web host plese advise me what to do. Is it posible to convert it to a smart phone app?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32630);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-05-12 12:13 pm</div>
				                <div>Hello Mugisha,<br />
<br />
Thank you for contacting us. I found a post via online search that explains how to <a href="http://answers.microsoft.com/en-us/office/forum/officeversion_other-office_other/how-to-embed-code-in-publisher-2007/b376dc47-69c6-4613-9000-ac5059ad35ba?auth=1" target="_blank" rel="nofollow">embed code in publisher 2007</a>.<br />
<br />
The above guide will help you publish to your web host.<br />
<br />
You would have to custom code it to make it work as a smart phone app.<br />
<br />
Best Regards,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32637);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
