<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:44809:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/moodle/moodle-plugins" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="keywords" content="Moodle 2.3 plugins customized installed Plugin Activities Assignments Block adding editing install installing add edit" />
  <meta name="description" content="Moodle 2.3 plugins can be customized and installed. Plugins are used for Activities, Assignments, Block and many other uses. This section will explain the different functions available in Moodle for plugins." />
  <title>108: Managing Moodle Plugins | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/moodle/moodle-plugins" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:8e96d8417ff4f2de1879e0e69a74fdab -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '89.32.195.72']);
...
<div class='page-header'>
	<h1>108: Managing Moodle Plugins</h1>
</div>
<div class='section_listing'>
		...
		<tr>
				...
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/moodle-plugins/plugin-overview'>Moodle 2.3 Plugin Overview</a>
					<div>Moodle 2.3 has the capability of enabling, disabling, installing and uninstalling plugins that are used for the Moodle site to function. This tutorial will overview the default plugins.</div>
					<div class='smallgrey'>Hits: 1,785</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/moodle-plugins/install-plugin'>How to install a plugin in Moodle 2.3</a>
					<div>Moodle has a rich repository of plugins that can be accessed at the Moodle Plugins Directory. This article will walk through the steps to install a plugin in Moodle.</div>
					<div class='smallgrey'>Hits: 4,052</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/moodle-plugins/uninstall-plugin'>Uninstalling or removing a Moodle plugin</a>
					<div>This tutorial will explain how to uninstall or remove a plugin from a Moodle 2.3 site.</div>
					<div class='smallgrey'>Hits: 11,001</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/moodle-plugins/enrollment-plugin'>Managing Enrollments in the Moodle plugins</a>
					<div>The Moodle 2.3 Enrollment plugin allows the administrator to enable or disable, edit the settings, or uninstall an Enrolment plugin altogether. This tutorial will explain how to disable an enrolement plugin.</div>
					<div class='smallgrey'>Hits: 1,474</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-bottom:10px;'>
					...
					<div>This article will explain how to configure the Moodle 2.3 messaging system to use SMTP.</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yOTcmaWQ9Mjk3JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="ff710bac227b5eb99271328738cd6b2e" value="1" />	</div>
	</form>
<!-- <br />
