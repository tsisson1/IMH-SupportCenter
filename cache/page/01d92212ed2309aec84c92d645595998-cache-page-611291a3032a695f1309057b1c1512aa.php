<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:59493:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/moodle/custom-moodle-reports/set-up-configurable-reports-block" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-06-19T21:25:04-07:00" />
  <meta name="keywords" content="install Configurable Reports block Moodleset up report" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="After you install the Configurable Reports block in Moodle, you will need to set up a report. This article will teach you how." />
  <title>Setting up the Configurable Reports Block in Moodle - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/moodle/custom-moodle-reports/set-up-configurable-reports-block" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:cd10f0b32920e153dd63e684eda97dc2 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '203.187.255.130']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Setting up the Configurable Reports Block in Moodle									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>5,209</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jun 19, 2013'><span style='color:#606060;'>Published:</span> Jun 19, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>After you install the Moodle Configurable Report Block, you will need to create your custom report. The steps below explain how to set up a basic custom report in the Configurable Report Block.</p>

<h2>Setting up the General Settings for your Custom Report</h2>

<ol class="article_list white_box">

<li><a target="_blank" href="/support/component/content/email/email-client-setup/moodle-login-administrator?Itemid=242" title="Click for more information">Log into the Moodle Dashboard</a>.</li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/202/configurable-reports-block/moodle-customizable-report-block-5-manage-reports.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Moodle Configurable reports manage reports" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/202/configurable-reports-block/moodle-customizable-report-block-5-manage-reports.png" title="Click here to view the larger image" width="100" /></a>Go to the <em>Configurable Blocks</em> block. 
<p class="alert"><strong>Note!</strong> If you do not see the block you will need to add it. See the previous tutorial.</p>
<p>Click the <strong>Manage reports</strong> link.<br style="clear: both;" /></p></li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/202/configurable-reports-block/moodle-customizable-report-block-6-add.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Add Moodle Configurable reports" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/202/configurable-reports-block/moodle-customizable-report-block-6-add.png" title="Click here to view the larger image" width="100" /></a>Initially there will be No Reports available.
<p>Click <strong>Add Report</strong>.<br style="clear: both;" /></p></li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/202/configurable-reports-block/moodle-customizable-report-block-7-options-add.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Option Moodle Configurable reports" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/202/configurable-reports-block/moodle-customizable-report-block-7-options-add.png" title="Click here to view the larger image" width="100" /></a>Enter the name of the Report and the Summary.
  <p>In the <em>Type of Report</em>, you can select the following types for reports.</p>

<ol class="article_list_number">
<li>Categories Report</li>
<li>Courses Report</li>
<li>SQL Report</li>
<li>Timeline Report</li>
<li>User Report</li>
</ol>

<p>Select the type of report. Check the <em>Export in XLS Format</em> of you want the report to be downloaded to an Excel spreadsheet.</p>
<p>Click <strong>Add</strong>.<br style="clear: both;" />
</p></li>
</ol>



<h2>Configure the columns for the custom report</h2>

<ol class="article_list white_box">

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/202/configurable-reports-block/moodle-customizable-report-block-8-user-profile-field.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="User Profile field Moodle Configurable reports" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/202/configurable-reports-block/moodle-customizable-report-block-8-user-profile-field.png" title="Click here to view the larger image" width="100" /></a>Next, you will need to add the columns to your report. Select the type from the <em>Add</em> drop box. In this case we are adding a <em>User Profile Field</em>.

  <p class="alert"><strong>Note!</strong> These options will vary depending on what type of report you selected in the Report General Settings.<br style="clear: both;" />
  </p></li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/202/configurable-reports-block/moodle-customizable-report-block-9-add-field.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Add Field Moodle Configurable reports" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/202/configurable-reports-block/moodle-customizable-report-block-9-add-field.png" title="Click here to view the larger image" width="100" /></a>Choose from the column drop box what type of data you will be displaying in the report. In this case, We are going to display the students <em>usernames</em>.
  <p>Give the Column and Cell properties a name.</p>
<p>Click <strong>Add</strong>.<br style="clear: both;" />
</p></li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/202/configurable-reports-block/moodle-customizable-report-block-10-columns.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Columns Moodle Configurable reports" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/202/configurable-reports-block/moodle-customizable-report-block-10-columns.png" title="Click here to view the larger image" width="100" /></a>Repeat the same steps adding the parameters you want in the report. Once finished you should have a list of fields like the snapshot to the right.
  <p>To see the report, click the <em>View Report</em> tab.<br style="clear: both;" />
  </p>

<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/202/configurable-reports-block/moodle-customizable-report-block-11-edit.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="View the report Moodle Configurable reports" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/202/configurable-reports-block/moodle-customizable-report-block-11-edit.png" title="Click here to view the larger image" width="100" /></a>The report will look similar to the snapshot to the right.
<br style="clear: both;" /></p>

<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/202/configurable-reports-block/moodle-customizable-report-block-12-edit.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Edit teh report Moodle Configurable reports" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/202/configurable-reports-block/moodle-customizable-report-block-12-edit.png" title="Click here to view the larger image" width="100" /></a>You can always go back to the Manage Reports and edit the Report to add or remove fields in the Report parameters.
<br style="clear: both;" />
</p></li>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/moodle/custom-moodle-reports'>202: Making Custom Moodle Reports</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 2: Setting up the Configurable Reports Block in Moodle</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 1: <a href='/support/edu/moodle/custom-moodle-reports/configurable-reports-block'>Installing the Configurable reports block in Moodle</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/moodle/custom-moodle-reports/set-up-configurable-reports-block&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/moodle/custom-moodle-reports/set-up-configurable-reports-block'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zOTYmaWQ9Mjc3MiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="1a7a8e8d5a8a7f9981f3dc71512ac724" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/moodle/custom-moodle-reports?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Making Custom Moodle Reports</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/moodle/custom-moodle-reports/configurable-reports-block?tsrc=rsbedu'>Installing the Configurable reports block in Moodle</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/moodle/custom-moodle-reports/set-up-configurable-reports-block?tsrc=rsbedu'>Setting up the Configurable Reports Block in Moodle</a></td>
                </tr>
          	</table>
