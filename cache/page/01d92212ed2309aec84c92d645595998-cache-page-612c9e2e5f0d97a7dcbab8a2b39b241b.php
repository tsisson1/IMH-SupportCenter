<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:55980:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/change-google-domain-nameservers" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-02-26T22:44:23-08:00" />
  <meta name="author" content="Arnel Custodio" />
  <meta name="description" content="If you have used Google to register domain, then you may need some help with setting the name servers.  The following tutorial shows you how to set the name servers for your Google Domain. Be aware of the 24 hours needed propagate a change to the nameservers" />
  <title>How to Change Name Servers in Google Domains (2) - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/change-google-domain-nameservers" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:70ba19794d865a03cf27a4eb548a6a06 -->
    ...
    <ul>
		...
		<li><a href='/support/tools/what-is-my-ip-address'>What is my IP address?</a></li>
			...
			<div class='dropdown_3columns' style='width:900px; margin-left:-250px;'>
				...
				<div class='col_1' style='width:290px;'><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/domain-names/dns-nameserver-changes/what-is-a-name-server'>What is a name server?</a> (125,247 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/domain-names/dns-nameserver-changes/a-record-change'>Adding an A Record</a> (48,681 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/domain-names/dns-nameserver-changes/add-cname-record'>Adding a CNAME Record</a> (37,554 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/domain-names/dns-nameserver-changes/vanity-nameservers-what-are-they-and-how-do-i-set-them-up'>Vanity Nameservers: What are they and how do I set them up?</a> (23,322 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/domain-names/dns-nameserver-changes/change-google-domain-nameservers'>How to Change Name Servers in Google Domains (2)</a> (453 hits)</div></div>
			</div>
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to Change Name Servers in Google Domains (2)</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to Change Name Servers in Google Domains (2)									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>453</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Feb 26, 2016'><span style='color:#606060;'>Published:</span> Feb 26, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Google has recently become a domain registrar and allows you register domains of many different types for a relatively low cost.  You can use a domain registered through Google Domains, but you will either need to point an A Record to an InMotion Hosting server, or change the name servers to point to InMotion Hosting.  The following tutorial will walk you through how to change the name servers to point to InMotion Hosting web servers.</p>

<h2>How to Change Name Servers for a Domain Registered in Google Domains</h2>

<ol class="article_list">

<li>
	<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/google-domain-nameservers/main-domain-screen.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="200" alt="Google Domains Account login" src="//cdn.inmotionhosting.com/support/images/stories/google-domain-nameservers/main-domain-screen.png" align="right" /></a>
	<p>Login to your Google Domains Account</p>
	<div style="clear:both;"></div>

</li>

<li>
	<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/google-domain-nameservers/google-configure-dns.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="200" alt="Configure DNS" src="//cdn.inmotionhosting.com/support/images/stories/google-domain-nameservers/google-configure-dns.png" align="right" /></a>
	<p>If you have multiple domains, you will need to select the domain where you will change the DNS.  If you hover over the icon, you will see that the third icon to the right will be labeled <b>Configure DNS</b>.  Click on this icon.</p>
	<div style="clear:both;"></div>
</li>

<li>
	<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/google-domain-nameservers/nameserver-1.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="200" alt="Select Use Custom name servers" src="//cdn.inmotionhosting.com/support/images/stories/google-domain-nameservers/nameserver-1.png" align="right" /></a>
	<p>A section titled Name servers will appear and you will have the option to select either:  <i>Use Google's name servers</i> or <i>Use custom name servers</i>.  Click on <b>Use custom name servers</b>.</p>
	<div style="clear:both;"></div>

</li>

<li>
	<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/google-domain-nameservers/"><img style="float: right; margin: 0px 0px 15px 15px;"  width="200" alt="Google Domains Account login" src="//cdn.inmotionhosting.com/support/images/stories/google-domain-nameservers/" align="right" /></a>

	<p>Click on the blue button labeled <b>ADD</b> in order to add your name servers.  If you make a mistake or there are name servers already in this section, you can click on <b>Edit</b> in order to make changes to name servers. </p> 
	<div style="clear:both;"></div>

<h3>InMotion Hosting only uses two name servers:</h3>
<p>ns.inmotionhosting.com</p>
<p>ns2.inmotionhosting.com</p>
</li>
<li>Once you have completed adding the name servers, click on <b>SAVE</b> to save your changes. </li>
</ol>

<p>If you are using InMotion Hosting to host your website, then these are the only name servers you will need to add for your Google Domain.  Remember that any changes to the name servers may require a propagation time of up to 24 hours to complete.	
</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/change-google-domain-nameservers&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/change-google-domain-nameservers'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD02OCZpZD0zNzg5JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="f8f3df5b04eb8b9033f6c827909586e1" value="1" />	</div>
	</form>
<!-- <br />
