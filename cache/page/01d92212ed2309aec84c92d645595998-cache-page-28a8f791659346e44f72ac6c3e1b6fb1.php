<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:75191:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.net/support/edu/joomla-3/server-settings/change-path-to-temp-folder" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-08-30T15:42:34-07:00" />
  <meta name="keywords" content="joomla 3.0 temp folder" />
  ...
  <link href="http://www.inmotionhosting.com/support/edu/joomla-3/server-settings/change-path-to-temp-folder" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:1b8b5b412c43f9908bb865f5ef9290d6 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to change the path to your Temp Directory in Joomla 3.1									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>41,848</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Aug 30, 2012'><span style='color:#606060;'>Published:</span> Aug 30, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>One of the settings available in Joomla 3.0 is the <strong>Path to Temp Folder</strong>. It's safe to assume that this <em>temporary folder</em> is used for miscellaneous purposes, and the files stored in this folder are most likely deleted or moved to a more permanent location almost immediately after being put in the tmp folder.</p>
<p> </p>
...
<p><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/joomla-3/global-configuration/no-permissions-on-tmp-folder.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="no-permissions-on-tmp-folder" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/joomla-3/global-configuration/no-permissions-on-tmp-folder.gif" /></a><strong>Warning</strong><br /><em>Warning: Failed to move file!<br /><br />JFolder: :files: Path is not a folder. Path: /home/bradm/public_html/github2/tmp/install_503f7ef32c55c<br /><br />JFolder: :folder: Path is not a folder. Path: /home/bradm/public_html/github2/tmp/install_503f7ef32c55c<br /><br />JFolder: :files: Path is not a folder. Path: /home/bradm/public_html/github2/tmp/install_503f7ef32c55c<br /><br />JInstaller: :Install: Cannot find Joomla XML setup file</em><br /><br /><strong>Error</strong><br /><em>Archive does not exist</em></p>
<div style="clear: both;"></div>
<p> </p>
...
<li>Next to <strong>Path to Temp Folder</strong>, enter the full path to your tmp folder and then click the Save button in the top left of the page.<br /><br />By default it will be set to (path/to/joomla)/tmp
<p class="alert">If the new temp folder does not exist, Joomla 3.0 will attempt to create it the next time it needs it.</p>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/joomla-3/server-settings'>206: Configuring Server Settings in Joomla 3</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 1: How to change the path to your Temp Directory in Joomla 3.1</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 2: <a href='/support/edu/joomla-3/server-settings/gzip-page-compression'>How to use Gzip Page Compression in Joomla 3.1</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.net/support/edu/joomla-3/server-settings/change-path-to-temp-folder&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.net/support/edu/joomla-3/server-settings/change-path-to-temp-folder'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNTgmaWQ9MTcyOCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="38e952ff0107162f09e1838f6bfcc5e9" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/joomla-3/server-settings?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Configuring Server Settings in Joomla 3</h3></a>
		<table><tr><td colspan='2'><h4>Server Settings</h4></td></tr>  <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/joomla-3/server-settings/change-path-to-temp-folder?tsrc=rsbedu'>How to change the path to your Temp Directory in Joomla 3.1</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/joomla-3/server-settings/gzip-page-compression?tsrc=rsbedu'>How to use Gzip Page Compression in Joomla 3.1</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/joomla-3/server-settings/error-reporting?tsrc=rsbedu'>Joomla 3.1 Error Reporting</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/joomla-3/server-settings/force-ssl-setting?tsrc=rsbedu'>How to Force SSL in Joomla 3.1</a></td>
                </tr>
        <tr><td colspan='2'><h4>Location Settings</h4></td></tr>  <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/joomla-3/server-settings/server-time-zone?tsrc=rsbedu'>Joomla 3.1 Server TimeZone</a></td>
                </tr>
        <tr><td colspan='2'><h4>FTP Settings</h4></td></tr>  <tr >
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/joomla-3/server-settings/ftp-settings?tsrc=rsbedu'>Configuring FTP Settings in Joomla 3.1</a></td>
                </tr>
        <tr><td colspan='2'><h4>Database Settings</h4></td></tr>  <tr >
                        <td valign='top'>7.</td>
                        <td><a href='/support/edu/joomla-3/server-settings/database-settings?tsrc=rsbedu'>How to change Database Settings within Joomla 3.1</a></td>
                </tr>
        <tr><td colspan='2'><h4>Mail Settings</h4></td></tr>  <tr >
                        <td valign='top'>8.</td>
                        <td><a href='/support/edu/joomla-3/server-settings/change-email-settings?tsrc=rsbedu'>Changing Email Settings in Joomla 3.1</a></td>
                </tr>
          	</table>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/9b98f48ddcff6555e035ee8d8ac7f2d3?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/9b98f48ddcff6555e035ee8d8ac7f2d3'>Marty</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-05 1:12 am</div>
				                <div><p>Other errors that can indicate a bad path.</p>
<p>The archive file is corrupt, truncated or archive parts are missing</p>
<p>COM_FINDER_INDEXER_INVALID_DRIVER</p>
<p>Note: The absolute path is the best way to ensure the tmp location will be found.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12357);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-16778'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/f7693a1fcaee9d5f40b0053876ecd816?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/f7693a1fcaee9d5f40b0053876ecd816'>darshan</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-27 3:57 pm</div>
				                <div><p>I have a problem while displaying the .xls files using ari doc viwer.pls help</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16778);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
...
<br />
What kind of issues are you having with the viewer? Are you getting an error? If so, what is the message?<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16783);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-27958'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/27b2ffc0db055b62e3bce49571bed44d?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/27b2ffc0db055b62e3bce49571bed44d'>joe</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-28 12:49 pm</div>
				                <div><h4 class="alert-heading" style="margin: 0px; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-weight: bold; line-height: 16px; color: #c09853; text-rendering: optimizeLegibility; font-size: 14px; font-style: normal; font-variant: normal; letter-spacing: normal; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: 1; word-spacing: 0px; -webkit-text-stroke-width: 0px;">Warning</h4>
<p style="margin: 0px 0px 9px; color: #c09853; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 13px; font-style: normal; font-variant: normal; font-weight: normal; letter-spacing: normal; line-height: 18px; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: 1; word-spacing: 0px; -webkit-text-stroke-width: 0px;">JFolder::create: Could not create directoryPath: /clickandbuilds</p>
<p style="margin: 0px 0px 9px; color: #c09853; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 13px; font-style: normal; font-variant: normal; font-weight: normal; letter-spacing: normal; line-height: 18px; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: 1; word-spacing: 0px; -webkit-text-stroke-width: 0px;">Warning: Failed to move file!</p>
<p style="margin: 0px 0px 9px; color: #c09853; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 13px; font-style: normal; font-variant: normal; font-weight: normal; letter-spacing: normal; line-height: 18px; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: 1; word-spacing: 0px; -webkit-text-stroke-width: 0px;">JFolder: :files: Path is not a folder. Path: /clickandbuilds/Joomla/MyCMS3/tmp/install_5630f8b6cc5bb</p>
<p style="margin: 0px 0px 9px; color: #c09853; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 13px; font-style: normal; font-variant: normal; font-weight: normal; letter-spacing: normal; line-height: 18px; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: 1; word-spacing: 0px; -webkit-text-stroke-width: 0px;">JFolder: :folder: Path is not a folder. Path: /clickandbuilds/Joomla/MyCMS3/tmp/install_5630f8b6cc5bb</p>
<p style="margin: 0px 0px 9px; color: #c09853; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 13px; font-style: normal; font-variant: normal; font-weight: normal; letter-spacing: normal; line-height: 18px; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: 1; word-spacing: 0px; -webkit-text-stroke-width: 0px;">JFolder: :files: Path is not a folder. Path: /clickandbuilds/Joomla/MyCMS3/tmp/install_5630f8b6cc5bb</p>
<p style="margin: 0px 0px 9px; color: #c09853; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 13px; font-style: normal; font-variant: normal; font-weight: normal; letter-spacing: normal; line-height: 18px; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: 1; word-spacing: 0px; -webkit-text-stroke-width: 0px;">JInstaller: :Install: Cannot find Joomla XML setup file</p>
...
<p style="margin: 0px 0px 9px; color: #c09853; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 13px; font-style: normal; font-variant: normal; font-weight: normal; letter-spacing: normal; line-height: 18px; orphans: auto; text-align: start; text-indent: 0px; text-transform: none; white-space: normal; widows: 1; word-spacing: 0px; -webkit-text-stroke-width: 0px;">need help to this issue. thanks in advance</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27958);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-28 6:29 pm</div>
				                <div>Hello Joe,<br />
<br />
As per the  the warning it appears that the designated path is either incorrect or doesn't exist.  If you moved your installation and did not recreate the path structure previously used, then Joomla may be looking for something that existed in its previous location.  Check out this <a href="https://www.ostraining.com/blog/joomla/jfoldercreate/" rel="nofollow" target="_blank">post</a>.  It may provide the answer you're searching for.  <br />
<br />
I hope this helps to answer your question, please let us know if you require any further  assistance.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27964);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
