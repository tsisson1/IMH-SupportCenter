<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50372:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/dns-nameserver-changes/parked-and-addon-domains" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, Thanks for the question. If you create a parked domain, then you should not lose the 301 redirects, unless you edit your .htaccess file. Parked d..." />
  <title>parked and addon domains | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/dns-nameserver-changes/parked-and-addon-domains" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:b52dcbaa9ce17d2dabd744509b2feb85 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>parked and addon domains</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2014-10-06 10:40 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>76</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I would like to use a plugin called Pretty link and use an alternate URL for the pretty link.  <br />
<br />
Their instructions are: the alternate base URL must forward or be added as a parked domain in your hosting account for the main domain. Here's an article to reference here: http://prettylinkpro.com/user-manual/use-an-alternate-base-url-for-your-pretty-links/<br />
<br />
My question is this - I have the domain set up as an addon domain, not parked domain. And there are htaccess rewrite rules for 301 redirects.  If I remove it as an addon domain and add it as a parked domain, will I los ethe htaccess conditions?  Also - if the domain is set up as a parked domain, will the htaccess rewrite rules still be read as they are now?</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_5743' id='upvote_answer_5743' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='5743' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_5743').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_5743' id='downvote_answer_5743' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='5743' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_5743').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
Thanks for the question.  If you create a parked domain,  then you should not lose the 301 redirects, unless you edit your .htaccess file.  Parked domain changes do not affect .htaccess files.   You would need to make sure that the rules do not affect your site once you make a parked domain.  Parked domains point to the primary domain.  <br />
<br />
I hope that helps to answer your question!  Let us know if you have any further question.<br />
<br />
Regards,<br />
Arnel C.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_5743').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_5743' id='form_comment_on_answer_5743' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/dns-nameserver-changes/parked-and-addon-domains&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/dns-nameserver-changes/parked-and-addon-domains'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="d029a5a4923aeca76a220572156442ad" value="1" />	</div>
	</form>
<!-- <br />
