<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50163:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/ssl/shopping-carts-ssl-and-how-the-url-will-look" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hi CPL, Thanks for posting your question. I'm more than happy to help you. You are correct the SSL on shared servers are in the format 'securexxx.inmoti..." />
  <title>shopping carts, SSL, and how the URL will look.. | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/ssl/shopping-carts-ssl-and-how-the-url-will-look" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:a3211cefbd34a921e14d91a7d1d44093 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>shopping carts, SSL, and how the URL will look..</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/CPL'>CPL</a>
			<div>73 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2011-11-15 1:25 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>9,246</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>This is more to simply verify what I think I read, so:<br />
  Since my site is on a shared server and I'm using a shared SSL certificate, is it correct that a shopping cart I set up to use a secured connection will always show a URL that looks like 'securexxx.inmotionhosting.com/...'?<br />
<br />
I know this can make some users unsure whether they're still on the same site, but, short of buying my own certificate, is there no way to have the url show my domain name?<br />
Thanks,<br />
CPL</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_243' id='upvote_answer_243' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='243' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_243').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_243' id='downvote_answer_243' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='243' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_243').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hi CPL,<br />
<br />
Thanks for posting your question. I'm more than happy to help you. You are correct the SSL on shared servers are in the format 'securexxx.inmotionhosting.com'<br />
<br />
There is no way to change the SSL url for the shared certificate since the certificate was issued under that URL. If you wish to have an SSL for your domain you'll need to purchase one. SSL certificates can be purchased through AMP.<br />
<br />
<a href="http://www.inmotionhosting.com/support/website/ssl/how-do-i-obtain-an-ssl-certificate">How to obtain an SSL</a><br />
<br />
...
Tim S
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_243').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_243' id='form_comment_on_answer_243' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/ssl/shopping-carts-ssl-and-how-the-url-will-look&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/ssl/shopping-carts-ssl-and-how-the-url-will-look'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="fd4446400a0fda27d79e12893befc451" value="1" />	</div>
	</form>
<!-- <br />
