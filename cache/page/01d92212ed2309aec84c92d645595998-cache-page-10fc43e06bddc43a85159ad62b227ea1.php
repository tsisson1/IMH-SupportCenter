<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:71754:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/website-design/using-php-and-mysql/using-php-include-function" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-03-20T15:06:49-07:00" />
  ...
  <link href="http://www.inmotionhosting.com/support/edu/website-design/using-php-and-mysql/using-php-include-function" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:6cc06d88722fc3241b47aeda8b4f39f2 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '176.12.55.170']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Using the php include function to reuse code									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>45,220</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 26, 2012'><span style='color:#606060;'>Published:</span> Mar 20, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In <a href="/support/edu/website-design/using-php-and-mysql">this tutorial series</a>, we're creating a simple 2 page website in which each page allows users to post comments. In our previous articles, we've <a href="/support/edu/website-design/using-php-and-mysql/database-setup">created and setup our database</a>, and we've <a href="/support/edu/website-design/using-php-and-mysql/create-html-form">created the html form</a> that will allow users to type in and submit their comments. In this article, we now need to incorporate our HTML form into our 2 pages.</p>
<h2>Creating our Test website</h2>
...
<tbody>
<tr>
<td><strong>page1.php</strong></td>
<td><strong>page2.php</strong></td>
</tr>
<tr>
<td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/phpmysql/this-is-page1.gif"><img  alt="this-is-page1" src="//cdn.inmotionhosting.com/support/images/stories/website/phpmysql/this-is-page1.gif" /></a></td>
<td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/phpmysql/this-is-page2.gif"><img  alt="this-is-page2" src="//cdn.inmotionhosting.com/support/images/stories/website/phpmysql/this-is-page2.gif" /></a></td>
</tr>
</tbody>
</table>
<h2>Adding our HTML form to our website using PHP's include function</h2>
<p>In our <a href="/support/edu/website-design/using-php-and-mysql/create-html-form">previous article</a>, we created an HTML form. Because we only have 2 pages, we could copy and paste the same code onto each page. In this example, that could be OK. If we however had 100 pages, that would be quite a bit of work. Also, if we had to make a change to that form, we would need to make that change to 100 different pages, which would be very tedious.</p>
...
<ol>
<li>create a new file named formcode.php and insert our form code (<a href="/support/edu/website-design/using-php-and-mysql/create-html-form">found in our previous article</a>)</li>
<li>add <span class="code_block">&lt;? include("formcode.php"); ?&gt;</span> in both page1.php and page2.php where you would like the form to appear.</li>
</ol>
...
<tr>
<td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/phpmysql/page1-with-the-form-added.gif"><img  alt="page1-with-the-form-added" src="//cdn.inmotionhosting.com/support/images/stories/website/phpmysql/page1-with-the-form-added.gif" /></a></td>
<td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/phpmysql/page2-with-the-form-added.gif"><img  alt="page2-with-the-form-added" src="//cdn.inmotionhosting.com/support/images/stories/website/phpmysql/page2-with-the-form-added.gif" /></a></td>
</tr>
</tbody>
</table>
...
<p>In our next tutorial, we'll show you <a href="/support/edu/website-design/using-php-and-mysql/php-insert-database">how to process the user's comment after they have clicked the submit button</a> to submit their comment.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 4: Using the php include function to reuse code</div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/website-design/using-php-and-mysql/using-php-include-function&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/website-design/using-php-and-mysql/using-php-include-function'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xNjAmaWQ9MTEzMiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="2fb44e1ffa5e55d355d1cd5089e12c23" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/ab682f194697637338b5ec0affde3c01?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/ab682f194697637338b5ec0affde3c01'>cj</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-07 2:38 pm</div>
				                <div><p>I had to change this <span class="code_block">&lt;? include("formcode.php"); ?&gt;</span></p>
<p><span class="code_block">to this</span><span class="code_block">&lt;?php include("formcode.php"); ?&gt;</span></p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13751);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-19060'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/d78e6b916f3fdaebdc01c9c757b08b4f?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/d78e6b916f3fdaebdc01c9c757b08b4f'>jerry</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-31 12:13 pm</div>
				                <div><p>i have done all, i seen here, but still any time i submit a comment to mysql database, it redirect to another page saying connected successful !! the only time i see user comment on the webpage is when i go back and refresh the page. please i need help with this immediately thanks</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19060);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-31 12:25 pm</div>
				                <div>Hello Jerry,<br />
<br />
Sorry to hear that you're having problems with the php Code provided above.  The issue you're referring to should be addressed in the next article, <a href="http://www.inmotionhosting.com/support/edu/website-design/using-php-and-mysql/php-insert-database">How to process the user's comment after they have clicked the submit button</a>.  If you have followed those directions and you're still having issues, then please provide us more information (such as the code you're using), or at least a URL, so that we can observer what you have done and troubleshoot if there is an existing problem.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19061);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-21733'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/2703d854a59ad8584462f118059512eb?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/2703d854a59ad8584462f118059512eb'>daniel</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-16 7:02 am</div>
				                <div><p>I am an up and comming new business and this was very helpfull to understand who I need my domain to go through.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21733);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/f9f7b455526c6a8d020d4a06e54e5b52?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/f9f7b455526c6a8d020d4a06e54e5b52'>Andrea</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-21 11:07 pm</div>
				                <div><p>Although it&nbsp;sounds like a dumb question, but how do i assign id=1 and id=2 to the url for both pages</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25971);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-24 1:40 pm</div>
				                <div>Hello Andrea,<br />
<br />
The id is added automatically by the database. You can see that from an article <a href="http://www.inmotionhosting.com/support/edu/website-design/using-php-and-mysql/database-setup">earlier in the series</a>.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26027);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
