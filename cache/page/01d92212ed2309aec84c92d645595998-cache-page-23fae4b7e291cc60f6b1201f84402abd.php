<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:58446:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/boldgrid/getting-started/evaluate" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-05-04T19:11:45-07:00" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Looking for the next steps after installing your Inspiration? Learn how to evaluate your BoldGrid site to make it your own." />
  <title>Evaluating your BoldGrid site - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/boldgrid/getting-started/evaluate" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:e1454390a26b9173f898efeada160d81 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Evaluating your BoldGrid site									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>171</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jul 22, 2015'><span style='color:#606060;'>Published:</span> May 4, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Now that you have installed your <em>Inspiration</em>, you can now begin to think about customizing it and make it your own. Below we guide you on taking the steps into customizing your new BoldGrid site.</p>

<h2>Define Your Site's Scope</h2>
<p>First, you want to define the scope of your website. For our real estate site example, we want to have a home page, but also would like to have a contact page so visitors can get in touch with us. A page for showing all the listings and an informational <em>About Us</em> page would also round out the site.</p>

<h2>Decide What You Want to Change</h2>
<p>Now that you know what you want, you need to start by looking at what your chosen <em>Inspiration</em> has provided. Click on the <strong>Visit Active Site</strong> option located in your Admin toolbar at the top of the dashboard.</p>

<p>This brings you to the site, allowing you to see it at the default level. Obvious changes such as the site title, call to action, and footer information will need to be made, but take some time to explore each page to see how you will want to change them to make the site your own. You may want to remove some of the pages, change pictures, etc. Be sure to make notes on what you want to change.</p>

<h2>Begin Making your Changes</h2>
<p>Remember you will be able to add or remove pages as needed. For example, looking at our sample site we decide that we do not want to use the default <em>About Us</em> page, but that the <em>Services</em> page layout fits better. In this case, we decide that we need to remove a page.</p>

<p>You will also want to be sure to change the written content on your pages to make it unique. Google loves unique content so making your content stand out as much as possible will help  your site show up higher in the search engine rankings. In our sample site's case, we would like to have great unique content regarding the company and the listing in the area so it shows up when visitors look for real estate for the local area or cities.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 8: Evaluating your BoldGrid site</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 7: <a href='/support/edu/boldgrid/getting-started/setup-staging'>How to Set Up Staging in BoldGrid</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/boldgrid/getting-started/evaluate&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/boldgrid/getting-started/evaluate'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD01MzcmaWQ9MzYwNyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
