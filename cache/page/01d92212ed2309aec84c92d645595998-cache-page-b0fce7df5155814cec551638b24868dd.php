<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:57781:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/whm/delete-cpanel" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-11-11T15:10:47-08:00" />
  <meta name="keywords" content="delete cPanel whm" />
  <meta name="author" content="John-Paul Briones" />
  <meta name="description" content="This is a walk-through tutorial on how to delete a cPanel via Web Host Manager (WHM)." />
  <title>How to Delete a cPanel in WHM - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/whm/delete-cpanel" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:51888272d9987eb9377c5b475576265c -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '205.206.0.55']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to Delete a cPanel in WHM									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>19,135</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: May 20, 2013'><span style='color:#606060;'>Published:</span> Nov 11, 2015</div>
							...
							<div style='clear:both;'></div>
								...
								<center><iframe width="560" height="315" src="https://www.youtube.com/embed/CPziSLx44fg" frameborder="0" allowfullscreen></iframe></center>
If you are no longer hosting a website, or you are closing it down, you may want to <strong>delete</strong> or terminate the <strong>account</strong> from the Web Host Manager(<strong>WHM</strong>). In this tutorial we will show you how to remove a <strong>cPanel</strong> from the WHM. <br><br>
<p class="alert">This tutorial is only for <a href="http://www.inmotionhosting.com/support/reseller">Resellers</a>, and accounts with <a href="http://www.inmotionhosting.com/vps-hosting" target="_blank">VPS</a> or <a href="http://www.inmotionhosting.com/dedicated-servers" target="_blank">Dedicated servers</a>.</p>

<h2>Deleting a cPanel from WHM</h2>
<ol class="article_list">
  <li>If you want to save the files associated with this account, I recommend <a href="/support/edu/cpanel/cpanel-file-manager/backing-up-your-cpanel" target="_blank">Backing Up your Website</a> and downloading a copy.</li>
  <li><a href="/support/edu/whm/creating-and-managing-accounts/log-into-whm">Login to your Web Host Manager(WHM)</a>.</li>
  <li>Click the <strong>Account Functions</strong> Button.<br>
  <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/WHM/delete-cpanel/account-functions.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/WHM/delete-cpanel/account-functions.png" alt="accesing cPanel account in WHM so you can delete" /></a></li>
  <li>Now, click the <strong>Terminate an Account</strong> button.<br>
  <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/WHM/delete-cpanel/terminate-cpanel-account.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/WHM/delete-cpanel/terminate-cpanel-account.png" alt="delete an account option in WHM" /></a></li>
  <li>Select the account you want to delete, you can also search by <em>Domain name</em>, or <em>User name</em>. Then click the <strong>Terminate</strong> button.<br>
  <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/WHM/delete-cpanel/terminate.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/WHM/delete-cpanel/terminate.png" alt="deleting a cPanel example in WHM" /></a></li>
  <li>A message will pop up asking "<em>Are you sure you want to delete this account?</em>," click the <strong>OK</strong> button to confirm the account deletion.<br>
  <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/WHM/delete-cpanel/confirm-delete-account.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/WHM/delete-cpanel/confirm-delete-account.png" alt="clicking ok to delete account from WHM" /></a><br><br>
    The cpanel account will now be deleted. It may take a few moments to complete this step, depending how large the account is.<br><br>
    Also, here is a link to the official <a href="http://docs1.cpanel.net/twiki/bin/view/11_30/WHMDocs/TerminateAccount">cPanel documentation</a> on terminating an account.<br><br> </li></ol>
<p>Congratulations, now you know how to <strong>remove</strong> a <strong>cPanel</strong> acount from <strong>WHM</strong>!</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 5: How to Delete a cPanel in WHM</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 4: <a href='/support/edu/whm/disable-spamcop-in-whm'>Disabling SpamCop RBL in WHM</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/whm/delete-cpanel&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/whm/delete-cpanel'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD04NiZpZD0yNzI2JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/3b70eed2afaa850ca76ee0c55dd00a45?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/3b70eed2afaa850ca76ee0c55dd00a45'>Yuri Habib</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-05 6:04 am</div>
				                <div><p>Thank you a lot :) .</p>
<p>This was really helpful :D&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21327);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/773a8766fc082a179daf64eee4ebe57f?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/773a8766fc082a179daf64eee4ebe57f'>sagar patil</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-14 6:36 am</div>
				                <div><p>helps alot, thank you</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24872);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
