<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50216:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/databases/how-do-i-find-a-database-server-address" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello rollingcycle, The servername localhost is the one to use if the drupal installation and the MySQL database are on the same server. If you are look..." />
  <title>How do I find a database server address? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/databases/how-do-i-find-a-database-server-address" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:8c309aca463bf4f19901bd9955331136 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '89.242.36.248']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>How do I find a database server address?</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/rollingcycle'>rollingcycle</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-08-29 10:41 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>8,923</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>My friend is in the process of building up my website using Drupal. I've set up the MySQL database and created a user account for him, but he says a server address to start setting up Drupal. I haven't been able to find anything and localhost doesn't work.<br />
<br />
Thanks.</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_1494' id='upvote_answer_1494' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='1494' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_1494').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_1494' id='downvote_answer_1494' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='1494' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_1494').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>36,993 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2012-08-29 12:35 pm EST
                		        </div>
					
		                </div>

				Hello rollingcycle,<br />
<br />
The servername localhost is the one to use if the drupal installation and the MySQL database are on the same server. If you are looking to make a remote connection to the database you will want to follow <a href="http://www.inmotionhosting.com/support/website/databases/setting-up-a-remote-mysql-connection-in-cpanel" target="_blank">these instructions here</a>.<br />
<br />
If it is not a remote connection and 'localhost' is not working, then there is likely something incorrect with the settings. We will need to take a look in that case. <br />
<br />
You can send the specific information to <strong>docs@inmotionhosting.com</strong>. Be sure to validate your account with either the last 4 digits of the credit card on file, or the current Account Management Panel (AMP) password. As we do not actively monitor that address, be sure to leave a comment below so we know the information was sent.<br />
<br />
Best Regards,<br />
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_1494').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_1494' id='form_comment_on_answer_1494' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/databases/how-do-i-find-a-database-server-address&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/databases/how-do-i-find-a-database-server-address'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="8a753ae7fbaec0442a48f502f7acc609" value="1" />	</div>
	</form>
<!-- <br />
