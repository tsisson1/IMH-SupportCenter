<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:96977:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/email/bounceback-errors/email-error-552" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-05-02T16:10:27-07:00" />
  <meta name="keywords" content="email e-mail error 552 bounce bounceback bounce-back error errors message messages" />
  <meta name="author" content="Jacob Nicholson" />
  <meta name="description" content="552 email errors are generally encountered when a recipient has exceeded their storage quota, or the size of the attachment is larger than the receiving mail server accepts." />
  <title>Email error 552 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/email/bounceback-errors/email-error-552" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:adb7d56f5b241ce18bc45c78cfbc0abd -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-22']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '98.175.228.194']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Email error 552</span></li>			</ul>
		</div>
	</div>
</div>
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>50,688</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Oct 26, 2012'><span style='color:#606060;'>Published:</span> May 2, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<p>A <strong>552 email error</strong>&nbsp;is typically ecountered when there is a problem related to an attachement in your email. Either it has exceeded the size limits of the remote server, or the file-type isn't allowed by the remote server. Some mail servers also seem to use this error code incorrectly when blocking a message due to triggering a filter such as a URL in the message being found in a domain black list.</p>
<p>You should receive a bounce-back message from the server with a variation of&nbsp;<strong>email error 552</strong>&nbsp;in the subject, and the body should contain your original message that you attempted to deliver.</p>
<h2>Example bounce-back message</h2>
<div class="cli">
<div>Return-path: &lt;&gt;<br />Envelope-to: <strong>sender@example.com</strong><br />Delivery-date: Mon, 22 Oct 2012 11:30:14 -0700<br />Received: from mailnull by biz24.inmotionhosting.com with local (Exim 4.77)<br />id 1TQMlS-0005G9-3e<br />for <strong>sender@example.com</strong>; Mon, 22 Oct 2012 11:30:14 -0700<br />X-Failed-Recipients: <strong>recipient@RemoteDomain.com</strong><br />Auto-Submitted: auto-replied<br />From: Mail Delivery System &lt;Mailer-Daemon@biz24.inmotionhosting.com&gt;<br />To: <strong>sender@example.com</strong><br />Subject: Mail delivery failed: returning message to sender<br />Message-Id: &lt;E1TQMlS-0005G9-3e@biz24.inmotionhosting.com&gt;<br />Date: Mon, 22 Oct 2012 11:30:14 -0700</div>
<div>&nbsp;</div>
<div>
...
<div>&nbsp;</div>
<div><strong>recipient@RemoteDomain.com</strong><br />SMTP error from remote mail server after end of data:<br />host RemoteDomain.com [123.123.123.123]:<br /><strong>552 5.3.4 Message size exceeds fixed maximum message size</strong></div>
<div>&nbsp;</div>
<div>------ This is a copy of the message, including all the headers. ------<br />------ The body of the message is 10672605 characters long; only the first<br />------ 106496 or so are included here.</div>
<div>&nbsp;</div>
<div>Return-path: &lt;<strong>sender@example.com</strong>&gt;<br />Received: from comcast.net ([123.123.123]:33534 helo=Admin)<br />by biz24.inmotionhosting.com with esmtpsa (TLSv1:AES128-SHA:128)<br />(Exim 4.77)<br />(envelope-from &lt;<strong>sender@example.com</strong>&gt;)<br />id 1TQMjz-0004Ug-Sz; Mon, 22 Oct 2012 11:29:42 -0700<br />From: Sender &lt;<strong>sender@example.com</strong>&gt;<br />Subject: Annual report<br />Date: Mon, 22 Oct 2012 14:29:18 -0400<br />To: Recipient &lt;<strong>recipient@RemoteDomain.com</strong>&gt;</div>
<div>&nbsp;</div>
</div>
</div>
<div>
<h2>Common variations of the 552 email error</h2>
</div>
<ul>
<li>552 5.2.2 mailbox quota exceeded for this recipient</li>
<li>552 5.2.2 User mailstore exceeded quota limit</li>
<li>552 5.2.3 Message exceeds local size limit.</li>
<li>552 5.2.3 message size exceeds fixed maximum message size</li>
<li>552 5.3.4 Message size exceeds fixed limit</li>
<li>552 5.3.4 Message size exceeds fixed maximum message size</li>
<li>552 5.3.4 message size limit exceeded at MAIL FROM</li>
<li>552 Backend Replied [mxlogic.net]: 5.3.4 Message size exceeds fixed maximum</li>
<li>552 mail size or count over quota.</li>
<li>552 message size exceeds maximum message size</li>
<li>552 size limit exceeded</li>
<li>552 too many messages in this mail box.</li>
<li>552 Transaction failed, remote said "550 failed: User does not exist."&nbsp;</li>
</ul>
<ul>
<li>552-Requested mail action aborted: exceeded storage allocation\n</li>
<li>552-5.2.2 The email account that you tried to reach is over quota.</li>
<li>552-5.2.3 Your message exceeded Google's message size limits. Please visit\n</li>
<li>552-5.7.0 Our system detected an illegal attachment on your message. Please\n&nbsp;</li>
</ul>
<ul>
<li>552 Virus found inside of the email</li>
<li>552 5.2.0 Remote MTA 74.124.198.61: An URL contained in this message is blacklisted by SURBL. See http://www.surbl.org</li>
</ul>
<div>
<h2>Resolving a 552 email error bounceback</h2>
<p>The 552 series of errors can sometimes be a soft or hard bounce. For a more in-depth review of what a soft or hard bounce is, and general email bounceback reasons you can read&nbsp;<a href="/support/email/email-troubleshooting/email-bounce-bounceback-error">why does email bounce, bounceback, or error?</a></p>
<p>In our example bounce-back error above the reason the message has failed is because the server for&nbsp;<strong>RemoteDomains.com </strong>has a fixed message size limit. The attempted message exceeded this limit so it was not accepted and generated this bounce-back error.</p>
</div> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/email/bounceback-errors/email-error-552&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/email/bounceback-errors/email-error-552'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NjImaWQ9NzgxJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/13906b3113c7d125c2a97a246d4933ae?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/13906b3113c7d125c2a97a246d4933ae'>Andy Cooper</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-15 12:03 pm</div>
				                <div><p>Very straightforward and easy to understand explanations, to problems which, if explained differently, would make the average Layman's head fall off!</p>


Maybe suggest a solution, (Error 552 size limit exceeded), or does this issue need to be resolved by the recipient?
Thanks, Andy Cooper</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12786);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-15 12:25 pm</div>
				                <div>Hello Andy Cooper,<br />
<br />
The solution depends on the error and yes, many of these will require action by either the recipient or the sender.  In some cases, if the email is too large for the recipient, then either the sender needs to find an alternate way of sending the message, or the receiver needs to make it possible for the size of the email to be able to received (this would be generally done by the email server administrator).  <br />
<br />
In other cases, the email account may be full and the recipient needs to clear space in order to receive it.  So there are many variants as to how this particular error can appear, but the action that is required depends on the wording of the error message being sent.  It's generally self-explanatory.  However,  if there is a confusion in interpreting the error message, then the sender should <a href="http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support">contact our live technical support team</a>  for further clarification.<br />
<br />
Kindest regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12788);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-13774'></a>
		<div  style='margin:2px 0px 0px 80px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/a85a162a94f96b003b9a846d5dafd66d?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/a85a162a94f96b003b9a846d5dafd66d'>Ncedo</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-08 3:51 am</div>
				                <div><p><span style="color: #444444; font-family: monospace; font-size: 15px; line-height: 21.299999237060547px;">This is the mail system at host cordelia.telkomsa.net.</span><span style="color: #444444; font-family: monospace; font-size: 15px; line-height: 21.299999237060547px;">I'm sorry to have to inform you that your message could not</span><span style="color: #444444; font-family: monospace; font-size: 15px; line-height: 21.299999237060547px;">be delivered to one or more recipients. It's attached below.</span><span style="color: #444444; font-family: monospace; font-size: 15px; line-height: 21.299999237060547px;">For further assistance, please send mail to postmaster.</span><span style="color: #444444; font-family: monospace; font-size: 15px; line-height: 21.299999237060547px;">If you do so, please include this problem report. You can</span><span style="color: #444444; font-family: monospace; font-size: 15px; line-height: 21.299999237060547px;">delete your own text from the attached returned message.</span><span style="color: #444444; font-family: monospace; font-size: 15px; line-height: 21.299999237060547px;">The mail system</span><span style="color: #444444; font-family: monospace; font-size: 15px; line-height: 21.299999237060547px;">&lt;online2758278@telkomsa.net&gt;: host mail4.telkomsa.net[192.168.16.233] said: 552</span><span style="color: #444444; font-family: monospace; font-size: 15px; line-height: 21.299999237060547px;">5.2.2 Over quota (in reply to end of DATA command)</span></p>
<p><span style="color: #444444; font-family: monospace; font-size: 15px; line-height: 21.299999237060547px;">&nbsp;</span></p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13774);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-08 9:19 am</div>
				                <div>Hello Ncedo,<br />
<br />
Unfortunately your post does not give any details about why the message was not delivered. You may want to check out our <a href="http://www.inmotionhosting.com/support/tools/bounce-back-parser">bounce back parser</a> tool that may help give an explanation. If not,  you may want to contact our <a href="http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support">Live Support</a> to have them check into the server logs (assuming you are one of our customers)<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13788);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-14737'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/195fbce599c99cc4a046d0adfefcf14d?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/195fbce599c99cc4a046d0adfefcf14d'>Shyam</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-05 2:28 am</div>
				                <div><p>HI,Need a support on Email Bounce back. Yesterday evening we have sent an email with attachment of 8MB in size. And we got a bounce back message that the <span style="font-family: 'Calibri','sans-serif'; font-size: 11pt; mso-ascii-theme-font: minor-latin; mso-fareast-font-family: Calibri; mso-fareast-theme-font: minor-latin; mso-hansi-theme-font: minor-latin; mso-bidi-font-family: 'Times New Roman'; mso-bidi-theme-font: minor-bidi; mso-ansi-language: EN-US; mso-fareast-language: EN-US; mso-bidi-language: AR-SA;">Message size exceeds the fixed limit.</span></p>
<p class="MsoPlainText" style="margin: 0in 0in 0pt;">&nbsp;</p>
<p class="MsoPlainText" style="margin: 0in 0in 0pt;">The error that the other server returned was: 552 5.3.4 Message size exceeds fixed limit.</p>
<p>I can understand about the attachment limits.My question is why we are getting the bounce back after 12 hours. Generaly it should bounce back immediatly.Please advise on the same.Thanks &amp; RegardsK Shyam kumar</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14737);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-05 8:44 am</div>
				                <div>Hello Shyam,<br />
<br />
Email was never meant to be instant, so if emails or even returned emails do not come back immediately, it is neither uncommon nor an issue. It seems the attachment size for the receiving server is hard set for their security reasons so you would just need to know the size limit. Perhaps you can compress the file to be under that limit.<br />
<br />
...
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14749);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-16885'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/59c43e5f0c40b85c7e1915ee800e1d43?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/59c43e5f0c40b85c7e1915ee800e1d43'>vub engg.</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-30 3:37 am</div>
				                <div><p><strong>Respected Sir/ Mam,</strong></p>
<p><strong>Please help me . and confirm urgnetly&nbsp;</strong></p>
<p><strong>&nbsp;How many size for attached file and type, &nbsp;Error &nbsp;522 (5:2:2) Mostly</strong></p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p><strong>&nbsp;</strong></p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16885);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-30 10:31 am</div>
				                <div>Hello vub,<br />
<br />
Thank you for contacting us today. I'm not exactly sure what you are asking, but the maximum <a href="http://www.inmotionhosting.com/support/email/email-troubleshooting/max-email-size">email size limit</a> for our servers is 50MB. <br />
<br />
If you need additional help, please provide more details into your problem and what you are trying to accomplish.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16900);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-20363'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/87428ef3cfe01f4bdb608a568f2ebdc1?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/87428ef3cfe01f4bdb608a568f2ebdc1'>christo</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-04 12:07 pm</div>
				                <div><p>hi</p>
<p>&nbsp;</p>
<p>i can send a 15mb file but my frend cant get a bounce back error 552 file size exceeded how can i fix it pleas help</p>
<p>thanks</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20363);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-04 12:30 pm</div>
				                <div>Hello  Christo,<br />
<br />
Sorry for the error you're getting.  The problem is usually due to restrictions at an email host. If your friend is unable to receive the file, then you should either split the file so that it's smaller, or use a service or option like Google Drive, where you can share the file and then your friend can download it, in spite of its size.  If your friend has file size restrictions, then sharing the file with something like Google drive is the most cost effective way to handle it, because its' free!<br />
<br />
Kindest regards,<br />
Arnel C.<br />
<br />
</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20366);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-26072'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/091f0f94920e3dfbff4ed70aa607a5e3?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/091f0f94920e3dfbff4ed70aa607a5e3'>Shaun</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-25 7:58 am</div>
				                <div><p>&nbsp;</p>
<p style="margin: 0cm 0cm 0pt;"><span style="font-family: Calibri; font-size: medium;">This is the mail system at host juliet.telkomsa.net.</span></p>
<p>&nbsp;</p>
<p style="margin: 0cm 0cm 0pt;"><span style="font-family: Calibri; font-size: medium;">&nbsp;</span></p>
<p>&nbsp;</p>
<p style="margin: 0cm 0cm 0pt;"><span style="font-family: Calibri; font-size: medium;">I'm sorry to have to inform you that your message could not be delivered to one or more recipients. It's attached below.</span></p>
<p>&nbsp;</p>
<p style="margin: 0cm 0cm 0pt;"><span style="font-family: Calibri; font-size: medium;">&nbsp;</span></p>
<p>&nbsp;</p>
<p style="margin: 0cm 0cm 0pt;"><span style="font-family: Calibri; font-size: medium;">For further assistance, please send mail to postmaster.</span></p>
<p>&nbsp;</p>
<p style="margin: 0cm 0cm 0pt;"><span style="font-family: Calibri; font-size: medium;">&nbsp;</span></p>
<p>&nbsp;</p>
<p style="margin: 0cm 0cm 0pt;"><span style="font-family: Calibri; font-size: medium;">If you do so, please include this problem report. You can delete your own text from the attached returned message.</span></p>
<p>&nbsp;</p>
<p style="margin: 0cm 0cm 0pt;"><span style="font-family: Calibri; font-size: medium;">&nbsp;</span></p>
<p>&nbsp;</p>
<p style="margin: 0cm 0cm 0pt;"><span style="font-family: Calibri;"><span style="font-size: medium;"><span style="mso-spacerun: yes;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </span>The mail system</span></span></p>
<p>&nbsp;</p>
<p style="margin: 0cm 0cm 0pt;"><span style="font-family: Calibri; font-size: medium;">&nbsp;</span></p>
<p>&nbsp;</p>
<p style="margin: 0cm 0cm 0pt;"><span style="font-family: Calibri; font-size: medium;">&lt;online2208759@telkomsa.net&gt; (expanded from &lt;copetcc@telkomsa.net&gt;): host</span></p>
<p>&nbsp;</p>
<p style="margin: 0cm 0cm 0pt;"><span style="font-family: Calibri;"><span style="font-size: medium;"><span style="mso-spacerun: yes;">&nbsp;&nbsp;&nbsp; </span>mail7.telkomsa.net[192.168.16.238] said: 552 5.2.2 Over quota (in reply to</span></span></p>
<p>&nbsp;</p>
<p style="margin: 0cm 0cm 0pt;"><span style="font-family: Calibri;"><span style="font-size: medium;"><span style="mso-spacerun: yes;">&nbsp;&nbsp;&nbsp; </span>end of DATA command)</span></span></p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26072);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-25 8:59 pm</div>
				                <div>Hello Shaun,<br />
<br />
This error is stating that the email address you are sending too has run out of disk space allotted to them. There is nothing you can do on your end. <br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26092);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/bbba2a34ae8d173a3fec706466497d41?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/bbba2a34ae8d173a3fec706466497d41'>sharon scherzer</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-02 4:50 am</div>
				                <div><p>was receiving no emails, sent one to myself, message from system administrator who remains anonymous, unreachable. sent my self email to my gmail account it arrived. i had received the message that mail box of the recipient, meaning me, was full.&nbsp; i completely emptyed my delete folder,drafts, everything and eventually i could send an email to myself that arrived.&nbsp; i do not want this to happen again what was the cause.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27167);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-02 4:25 pm</div>
				                <div>Hello sharon,<br />
<br />
Thank you for contacting us. We are happy to help, but will need some additional information such as the exact error you are seeing, and specific sending and receiving email addresses.<br />
<br />
If you do not want to post this information here in our public forums, I recommend submitting a ticket for review to <a href="http://www.inmotionhosting.com/contact">Live Support</a>. Be sure to include as much information as possible to help us replicate your specific issue.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27190);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-28833'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/2d45116498e5237a74af2619e89228a6?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/2d45116498e5237a74af2619e89228a6'>Rashesh Jani</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-30 6:03 am</div>
				                <div><p>Dear All,</p>
<p>&nbsp;</p>
<p>I have SME 9.0 server mails are confiugre and working properly in Thunderbird Lates version and if i try to&nbsp;configure MS Office 2013 on IMAP i got the error</p>
<p>The server respond:552 Mail with no date header not accepted &nbsp;here&nbsp;</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28833);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-30 6:48 pm</div>
				                <div>Hello Rashesh,<br />
<br />
That error is typical of Outlook having issues with attachments. Please check out <a href="http://answers.microsoft.com/en-us/office/forum/office_2013_release-outlook/552-mail-with-no-date-header-not-accepted-here/cc081ae5-cf91-4344-834a-c500e078d6f7">this Microsoft thread</a> on their help forums for more information.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28857);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
