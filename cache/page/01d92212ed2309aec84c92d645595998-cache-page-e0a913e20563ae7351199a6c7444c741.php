<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:47786:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/oscommerce" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="keywords" content="oscommerce educational channel" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="this Educational Course will teach you how to set up and use osCommerce on your server." />
  <title>osCommerce | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/oscommerce" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:812ea0bc0f35c22fa85f55d1618ecbce -->
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>osCommerce</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	...
	<div class='item-page'>
		<div class='page-header'>
			<h1>osCommerce Education Channel</h1>
		</div>
...
<div class='edu_class_listing white_box'>
	<h2>osCommerce Tutorials</h2>
	<ul style='float:left; width:300px; margin-right:20px;'>
<li  ><a href='/support/edu/oscommerce/new-store'>101: Getting Started with osCommerce</a></li>
<li  ><a href='/support/edu/oscommerce/adding-products-content'>102: Adding products and content to osCommerce</a></li>
<li  ><a href='/support/edu/oscommerce/config-tax-payment-shipping'>103: Configuring Taxes and Shipping in osCommerce</a></li>
<li  ><a href='/support/edu/oscommerce/payment-gateway-configuration'>104: osCommerce payment gateway configuration</a></li>
<li  ><a href='/support/edu/oscommerce/testing-ecommerce-functionality'>105: Testing the osCommerce site</a></li></ul><ul style='float:left; width:300px; margin-right:20px;'>
<li  ><a href='/support/edu/oscommerce/change-theme-template-appearance'>201: Changing your osCommerce appearance</a></li>
<li  ><a href='/support/edu/oscommerce/manage-users-administrators'>202: Managing Users in osCommerce</a></li>
<li  ><a href='/support/edu/oscommerce/add-security-addons'>203: Adding security to osCommerce</a></li></ul><div style='clear:both;'></div></div>
...
<div class='edu_most_popular white_box'>
	<h2>Most Popular Articles</h2>
		<div style='width:300px; height:75px; float:left; margin-right:20px;'>
						...
						<div style='width:300px; height:75px; float:left; margin-right:20px;'>
							<a href='/support/edu/oscommerce/testing-ecommerce-functionality/setting-up-smtp-with-oscommerce'>Setting up SMTP with osCommerce</a>
							<div class='smallgrey'>Hits: 16,761</div>
						</div>
						<div style='width:300px; height:75px; float:left; margin-right:20px;'>
...
<form action="http://www.inmotionhosting.com/support/edu/oscommerce" method="post" name="adminForm" id="adminForm" class="form-inline">
	...
	<option value="0">All</option>
		...
		<h2>osCommerce - Advanced Tutorials</h2>
		<table style='margin-top:20px;'>
			...
			<tr>
				...
				<td valign='top' style='padding-bottom:15px;'>
					<div><a href='/support/edu/oscommerce/301-adding-google-analytics-to-oscommerce'>301: Adding Google Analytics to osCommerce</a></div>
					<div>This article will explain how to add your Google Analytics code to your osCommerce website.</div>
					<div class='smallgrey'>
			...
			<tr>
				<td valign='top' style='padding:6px 15px 0px 0px;'><img src='https://lh5.googleusercontent.com/-sqOlcmmeoz4/AAAAAAAAAAI/AAAAAAAAAIM/EKb76fhiG6s/photo.jpg?sz=50' class='sc_rc' style='width:55px;' /></td>
				<td valign='top' style='padding-bottom:15px;'>
					<div><a href='/support/edu/oscommerce/302-404-base-href-googlebot-error-in-oscommerce'>302: 404 base href Googlebot error in osCommerce</a></div>
					<div>If you are getting 404 errors with Googlebot in your osCommerce site, you will need to comment out the base href code in your template header. This article will show you how.</div>
					<div class='smallgrey'>
						Written by James Richardson<br />
						Hits: 1,436
					</div>
			...
			<tr>
				...
				<td valign='top' style='padding-bottom:15px;'>
					<div><a href='/support/edu/oscommerce/admin-view-sales-order'>Administrator View of Sales Order in osCommerce</a></div>
					<div>Understanding the sales order process from the administrator's view is important because it allows you make the proper decisions based on the sales interaction with the customer.  The following article follows a sale within the osCommerce dashboard and how an administrator can interact with it.</div>
					<div class='smallgrey'>
			...
			<tr>
				<td valign='top' style='padding:6px 15px 0px 0px;'><img src='https://lh3.googleusercontent.com/-np8xy9GiNy8/AAAAAAAAAAI/AAAAAAAAAEU/Eu1yKGoTxiA/photo.jpg?sz=50' class='sc_rc' style='width:55px;' /></td>
				<td valign='top' style='padding-bottom:15px;'>
					<div><a href='/support/edu/oscommerce/viewing-the-best-viewed-report-in-oscommerce'>Viewing the Best Viewed Report in osCommerce</a></div>
					<div>The best viewed report shows the number of visitors per your products in your osCommerce report.  The following article explains how to run this report.</div>
					<div class='smallgrey'>
						Written by Arnel Custodio<br />
						Hits: 917
					</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zNjkmaWQ9MzY5JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
