<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50969:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/general-server-setup/considering-upgrading-from-power-plan-to-vps-will-i-lose-any-features-from-this-upgrade" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Mark3000, There are a couple of features that you will lose when upgrading to a VPS. The first is the unlimited space and bandwidth. As you will b..." />
  <title>Considering upgrading from Power plan to VPS. Will I lose any features from this upgrade?  | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/general-server-setup/considering-upgrading-from-power-plan-to-vps-will-i-lose-any-features-from-this-upgrade" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:d217c3a9e03071293c83de9bf4d5f9bb -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Considering upgrading from Power plan to VPS. Will I lose any features from this upgrade? </h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/Mark3000'>Mark3000</a>
			<div>13 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-07-22 4:57 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>607</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Will I lose any features from this upgrade?  I cannot find a side-by-side comparison.  Example concerns might be like... Will I still have 50 MYSQL accounts, etc?<br />
<br />
Also, are there any additional costs if I add customers to this account that will have their own cpanel?<br />
<br />
My plan is to add customers to this plan (like a reseller) and I want to account for any expenses that may not be on my radar.</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_1332' id='upvote_answer_1332' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='1332' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_1332').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_1332' id='downvote_answer_1332' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='1332' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_1332').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Mark3000,<br />
<br />
There are a couple of features that you will lose when upgrading to a VPS. The first is the unlimited space and bandwidth. As you will be getting dedicated resources, you will have specific allotments of hard drive space and bandwidth usage per month. Just how much is based on the different plans.<br />
<br />
The other thing you will lose will be the Fantastico tool. That is an optional feature on the VPS/Dedicated servers and can be added for $5 per month, or $50 per year.<br />
<br />
You do gain a lot more, however, by upgrading. Dedicated resources means <a href='http://www.inmotionhosting.com/vps_hosting/articles/fast-vps.html'>faster processing</a>. You will be able to add unlimited cpanels (no additional cost for those). <br />
<br />
For administration you will gain SSH (shell) access and the ability to use the Web Host Manager (WHM) tool. Root access is also a free option should you decide you need that.<br />
<br />
Asking us about a VPS is a great start. You can also read about how to get a VPS <a href="http://www.inmotionhosting.com/vps_hosting/articles/how-to-get-vps.html">here</a>.<br />
<br />
Best Regards,<br />
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_1332').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_1332' id='form_comment_on_answer_1332' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/general-server-setup/considering-upgrading-from-power-plan-to-vps-will-i-lose-any-features-from-this-upgrade&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/general-server-setup/considering-upgrading-from-power-plan-to-vps-will-i-lose-any-features-from-this-upgrade'></div>
<script type='text/javascript'>
  (function() {
