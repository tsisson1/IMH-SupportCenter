<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:51361:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/cpanel/i-cannot-access-cpanel" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello InMotionFans, Thank you for contacting us about accessing cPanel. The cPanel license should renew automatically, but this error occurs when it fai..." />
  <title>I cannot access cPanel | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/cpanel/i-cannot-access-cpanel" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:c0091136ee1284cac697ce628694cb0f -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>I cannot access cPanel</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-01-08 4:01 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>624</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I am not able to access my cPanel, either directly or through AMP. After logging in to cPanel, I am directed to a page that displays: <br />
<br />
&quot;This server is currently not licensed. Please contact the server administrator. Other services available on this server such as web services are likely functioning normally. (Cannot read license file)<br />
<br />
Once the license on this server is active, you will no longer see this message.	If you have installed a license since loading this page, click here to reload.&quot;<br />
<br />
How can I resolve this problem? I have not interacted with any files that are unfamiliar to me, so I'm uncertain as to why this is happening.</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_6247' id='upvote_answer_6247' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='6247' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_6247').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_6247' id='downvote_answer_6247' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='6247' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_6247').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>22,986 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2015-01-08 10:30 am EST
                		        </div>
					
		                </div>

				Hello InMotionFans,<br />
<br />
Thank you for contacting us about accessing cPanel. The cPanel license should renew automatically, but this error occurs when it fails to renew.<br />
<br />
I notified our System Admin team, and they were able to successfully update your cPanel license. You should no longer see this error when you <a href="http://www.inmotionhosting.com/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">access cPanel</a>.<br />
<br />
We really apologize for any inconvenience this may have caused.<br />
<br />
...
John-Paul
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_6247').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_6247' id='form_comment_on_answer_6247' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
...
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/cpanel/i-cannot-access-cpanel'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="dc0556ee71875de0a2643c328bcf1879" value="1" />	</div>
	</form>
<!-- <br />
