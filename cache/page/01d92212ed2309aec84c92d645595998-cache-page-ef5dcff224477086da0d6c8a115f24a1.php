<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:52470:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/prestashop-15/missing-globalcss-problem-with-theme" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Bruce, The global.css file is a good file to centralize many of the theme formatting. The theme you have obtained may not necessarily have a centr..." />
  <title>Missing global.css problem with theme. | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/prestashop-15/missing-globalcss-problem-with-theme" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:43ea6284932d27bf137d3546caf9c2b8 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box straight_bottom'>
                <h1 style='font-size:26px;'>Missing global.css problem with theme.</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='https://lh6.googleusercontent.com/-eimZj3aQAaU/AAAAAAAAAAI/AAAAAAAAAB0/edeX8fR7puA/photo.jpg?sz=90' class='user_avatar' /><br />
			<a href='/support/community-support/users/heartlandpet'>heartlandpet</a>
			<div>333 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-04-08 11:59 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>262</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Hey all,<br />
<br />
I finally found a theme that is working fine, no issues.  But,  I see that global.css is missing.  Never seen that before.  The theme is working fine so it has got to have the global.css and inspect element shows a global.css.<br />
<br />
Please see if you can find it for me.<br />
<br />
Theme:  ixt0010490petz_p<br />
<br />
r,<br />
<br />
Bruce<br />
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px;'>
				<div style='font-size:12px; max-width:500px; overflow:auto;'>Arnel,<br />
<br />
A CHROME &quot;inspect element&quot; check shows that it is indeed working off of global.css.  The problem is that it does not show up in my INMotion File Manager.  That is why I need your help.  Help me out here.<br />
<br />
r,<br />
<br />
Bruce</div>
			...
			<td style='width:100px;' valign='top'>
				<img src='https://lh6.googleusercontent.com/-eimZj3aQAaU/AAAAAAAAAAI/AAAAAAAAAB0/edeX8fR7puA/photo.jpg?sz=90' style='width:40px;' class='user_avatar' />
				<div class='smallgrey'>
					<a href='/support/community-support/users/heartlandpet'>heartlandpet</a><br />
					333 <a href='/support/team/points' target='_blank'>Points</a><br />
					2015-04-08 06:03 pm EST
				</div>
			</td>
		</tr>
	</table>
...
<div style='padding:15px; border:1px solid #d6d6d6; border-top:0px; background:#ebebeb;' class='round_bottom' >
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px;'>
				<div style='font-size:12px; max-width:500px; overflow:auto;'>Oh,<br />
<br />
I almost forgot.  When you go to the individual .css for blocks......everyone of them say the following:<br />
<br />
&quot;see global.css&quot;</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_6978' id='upvote_answer_6978' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='6978' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_6978').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_6978' id='downvote_answer_6978' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='6978' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_6978').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Bruce,<br />
<br />
The global.css file is a good file to centralize many of the theme formatting. The theme you have obtained may not necessarily have a centralized CSS file.  Each section my have its own CSS file, so in order to make changes to that section, you would need to modify the CSS file that applies to the part of the theme.<br />
<br />
...
Arnel
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_6978').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_6978' id='form_comment_on_answer_6978' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hi Bruce, <br />
<br />
There is definitely a file called global.css, but if it's the overall global.css, over one of several depends on how they created the theme.  If you want to see its location, when you use your Chrome Inspect Element option, hover over the global.css link and you will be able to see the location of the file.<br />
<br />
Regards,<br />
Arnel C.</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/prestashop-15/missing-globalcss-problem-with-theme&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/prestashop-15/missing-globalcss-problem-with-theme'></div>
<script type='text/javascript'>
  (function() {
