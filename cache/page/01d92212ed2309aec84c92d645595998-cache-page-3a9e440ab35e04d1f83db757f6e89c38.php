<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:64661:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/everything-email/mcafee/block-blacklist" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-04-29T23:01:12-07:00" />
  <meta name="keywords" content="blocked email senders list blacklist mcafee control console" />
  <meta name="author" content="John-Paul Briones" />
  <meta name="description" content="In this tutorial we show you how to add an email address to the blocked senders list (or blacklist), in the McAfee Control Console." />
  <title>Blocking / Blacklisting an Email Address in the McAfee Control Console - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/everything-email/mcafee/block-blacklist" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:c1cb3d7afab2eca1fdb1e483c9cf374b -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '50.192.11.106']);
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/everything-email' itemprop='url'><span itemprop='title'>Everything Email<span></a><div class='dropdown_4columns'><h2>Everything Email Education Channel</h2><div class='col_2'><h3>100 Level Classes</h3><div><a href='/support/edu/everything-email/introduction-email'>101: Basic Introduction to Email</a></div><div><a href='/support/edu/everything-email/email-features'>102: Email Features</a></div><div><a href='/support/edu/everything-email/organizing-email'>103: Organizing your Email</a></div></div><div class='col_2'><h3>200 Level Classes</h3><div><a href='/support/edu/everything-email/spam-prevention-techniques'>201: Dealing with Spam</a></div><div><a href='/support/edu/everything-email/202-using-dada-mail-for-sending-newsletters'>202: Using DaDa Mail for sending Newsletters</a></div><div><a href='/support/edu/everything-email/203-common-email-errors'>203: Common Email errors</a></div><div><a href='/support/edu/everything-email/mcafee'>203: McAfee Email Protection</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/everything-email/mcafee' itemprop='url'><span itemprop='title'>203: McAfee Email Protection<span></a><div class='dropdown_3columns'><h2> McAfee Email Protection</h2><div class='col_3'><div>1. <a style='display:inline;' href='/support/edu/everything-email/mcafee/recover-lost-password-control-console'>Recover the Lost Password for the McAfee Control Console</a></div><div>2. <a style='display:inline;' href='/support/edu/everything-email/mcafee/control-console-user'>Accessing the McAfee Control Console as an Email User</a></div><div>3. <a style='display:inline;' href='/support/edu/everything-email/mcafee/allow-address'>Allowing / Whitelisting an Email Address in the McAfee Control Console</a></div><div>4. <a style='display:inline;' href='/support/edu/everything-email/mcafee/block-blacklist'>Blocking / Blacklisting an Email Address in the McAfee Control Console</a></div><div>5. <a style='display:inline;' href='/support/edu/everything-email/mcafee/quarantine-list'>Using the Quarantined List for McAfee Email Protection</a></div><div>6. <a style='display:inline;' href='/support/edu/everything-email/mcafee/time-zone'>Changing Your Time Zone in the McAfee Control Console</a></div><div>7. <a style='display:inline;' href='/support/edu/everything-email/mcafee/changing-pasword'>Changing the Password and Security Question for the McAfee Control Console</a></div><div>8. <a style='display:inline;' href='/support/edu/everything-email/mcafee/language-preference'>How to Change the Language in the McAfee Control Console</a></div><div>9. <a style='display:inline;' href='/support/edu/everything-email/mcafee/spam-reporting'>Set How Often You Receive a McAfee Spam Report</a></div><div>10. <a style='display:inline;' href='/support/edu/everything-email/mcafee/spam-report-format'>Setting the Format for Your McAfee Spam Report</a></div><div>11. <a style='display:inline;' href='/support/edu/everything-email/mcafee/mcafee-email'>View / Change Your McAfee Admin Email Address</a></div><div>12. <a style='display:inline;' href='/support/edu/everything-email/mcafee/admin-login'>Accessing the McAfee Control Console as an Admin</a></div><div>13. <a style='display:inline;' href='/support/edu/everything-email/mcafee/profanity-filter'>Turning the Profanity Filter Off in the McAfee Control Console</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Blocking / Blacklisting an Em...</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Blocking / Blacklisting an Email Address in the McAfee Control Console									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>2,484</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Feb 21, 2013'><span style='color:#606060;'>Published:</span> Apr 29, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<div>In this guide we will show you how to add an email address to the blocked senders list (or blacklist), which stops any emails from that address before they can make it to your Inbox.&nbsp;</div>
<p class="alert">This guide is for people who are subscribed to the <a href="/support/edu/everything-email/mcafee/email-protection" target="_blank">McAfee Email Protection</a> option.</p>
<h1>How to Block / Blacklist an Address:</h1>
<ol class="article_list">
<li><a href="/support/edu/everything-email/mcafee/control-console-user" target="_blank">Login to the McAfee Control Console</a>.</li>
<li>Click the <strong>Blocked Senders</strong> tab.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/mcafee/blocked-list/blocked-senders-tab.png"><img src="//cdn.inmotionhosting.com/support/images/stories/mcafee/blocked-list/blocked-senders-tab.png" alt="selecting the blacklist tab in the mcafee control console"  style="margin: 15px;" /></a></li>
<li>In the field next to the <em>New </em>button, enter the address you want to block, then click the <strong>New</strong> button.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/mcafee/blocked-list/blocking-address.png"><img src="//cdn.inmotionhosting.com/support/images/stories/mcafee/blocked-list/blocking-address.png" alt="adding a new address to the blocked list in the mcafee control console"  style="margin: 15px;" /></a></li>
<li>You will then see the address listed in the field above, click the Apply button to Save what you have done. This address will now be blocked from emailing you.<br /><br /></li>
</ol>
<div>&nbsp;</div>
<div>Congratulations, now you know how to add an email address to your blocked sender list (or blacklist)!</div>
<div>&nbsp;</div> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/everything-email/mcafee'>203: McAfee Email Protection</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 4: Blocking / Blacklisting an Email Address in the McAfee Control Console</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 3: <a href='/support/edu/everything-email/mcafee/allow-address'>Allowing / Whitelisting an Email Address in the McAfee Control Console</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 5: <a href='/support/edu/everything-email/mcafee/quarantine-list'>Using the Quarantined List for McAfee Email Protection</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/everything-email/mcafee/block-blacklist&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/everything-email/mcafee/block-blacklist'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMzcmaWQ9MjI0MiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="c002b6536fc5b69aa9489e2adb66e636" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/everything-email/mcafee?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> McAfee Email Protection</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/everything-email/mcafee/recover-lost-password-control-console?tsrc=rsbedu'>Recover the Lost Password for the McAfee Control Console</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/everything-email/mcafee/control-console-user?tsrc=rsbedu'>Accessing the McAfee Control Console as an Email User</a></td>
                </tr>
        <tr><td colspan='2'><h4>Working with the Allowed / Blocked Senders List</h4></td></tr>  <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/everything-email/mcafee/allow-address?tsrc=rsbedu'>Allowing / Whitelisting an Email Address in the McAfee Control Console</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/everything-email/mcafee/block-blacklist?tsrc=rsbedu'>Blocking / Blacklisting an Email Address in the McAfee Control Console</a></td>
                </tr>
        <tr><td colspan='2'><h4>Basic McAfee Options & Settings</h4></td></tr>  <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/everything-email/mcafee/quarantine-list?tsrc=rsbedu'>Using the Quarantined List for McAfee Email Protection</a></td>
                </tr>
          <tr >
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/everything-email/mcafee/time-zone?tsrc=rsbedu'>Changing Your Time Zone in the McAfee Control Console</a></td>
                </tr>
          <tr >
                        <td valign='top'>7.</td>
                        <td><a href='/support/edu/everything-email/mcafee/changing-pasword?tsrc=rsbedu'>Changing the Password and Security Question for the McAfee Control Console</a></td>
                </tr>
          <tr >
                        <td valign='top'>8.</td>
                        <td><a href='/support/edu/everything-email/mcafee/language-preference?tsrc=rsbedu'>How to Change the Language in the McAfee Control Console</a></td>
                </tr>
          <tr >
                        <td valign='top'>9.</td>
                        <td><a href='/support/edu/everything-email/mcafee/spam-reporting?tsrc=rsbedu'>Set How Often You Receive a McAfee Spam Report</a></td>
                </tr>
          <tr >
                        <td valign='top'>10.</td>
                        <td><a href='/support/edu/everything-email/mcafee/spam-report-format?tsrc=rsbedu'>Setting the Format for Your McAfee Spam Report</a></td>
                </tr>
        <tr><td colspan='2'><h4>Administration</h4></td></tr>  <tr >
                        <td valign='top'>11.</td>
                        <td><a href='/support/edu/everything-email/mcafee/mcafee-email?tsrc=rsbedu'>View / Change Your McAfee Admin Email Address</a></td>
                </tr>
          <tr >
                        <td valign='top'>12.</td>
                        <td><a href='/support/edu/everything-email/mcafee/admin-login?tsrc=rsbedu'>Accessing the McAfee Control Console as an Admin</a></td>
                </tr>
          <tr >
                        <td valign='top'>13.</td>
                        <td><a href='/support/edu/everything-email/mcafee/profanity-filter?tsrc=rsbedu'>Turning the Profanity Filter Off in the McAfee Control Console</a></td>
                </tr>
          	</table>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/d1bf9f2605332e3902ef5f55b324bb99?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/d1bf9f2605332e3902ef5f55b324bb99'>John Maxwell</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-14 4:06 pm</div>
				                <div><p>I receive a rediculous amount of spam every day. On my personal email, I can check a box beside an unopened email and block the sender. Simple. Just read instructions that say I have to open a control console and manually put an address in- meaning I have to open each spam email (with possible viruses attached). Why is it so convoluted?</p>
<p>Thanks</p>
<p>John</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19540);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-15 11:52 am</div>
				                <div>Hello John,<br />
<br />
Sorry for the way that the blacklist option works with SpamAssassin.  Unfortunately, we don't develop the software that works within the cPanel, these are free tools that are for email access and spam prevention.  You can purchase different email clients that allow you to click and then add email to a junk/spam list.  You can also get programs that scan your emails for you.  By the way, if you open an email (in Plain text), you can avoid any malware or virus issues by simply not clicking on the links in the email and not loading any of the graphics or attachments that come with the email.  Many email clients automatically block content from opening in order to help prevent you from going to a page that leads to malware (e.g. Mozilla Thunderbird, Microsoft Outlook).   You can always setup these email clients to access your email from InMotion.   If you use something like Gmail or Yahoo, you can also set those email clients to load the emails for you as well.   Check out <a href="http://www.inmotionhosting.com/support/email/email-client-setup/setting-up-gmail-for-pop3-and-smtp">Setting up Gmail to access your email</a>, if you want to try it out.<br />
<br />
Hope that helps to provide you an option that may work for you.  Please let us know if you have any further questions or comments.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19580);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
