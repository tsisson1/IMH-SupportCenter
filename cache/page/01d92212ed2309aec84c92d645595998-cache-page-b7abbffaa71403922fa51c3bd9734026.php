<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:70840:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/moodle/new-to-moodle/moodle-password-reset-phpmyadmin" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-10-25T20:14:37-07:00" />
  <meta name="keywords" content="Moodle Forgot username reset Administrator change password PhpMyAdmin" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="Forgot your Moodle username or password and the forgot password link is not sending the email for the login credentials. This will show how to change the password in PhpMyAdmin." />
  <title>Changing the Moodle admin password through PhpMyAdmin - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/moodle/new-to-moodle/moodle-password-reset-phpmyadmin" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:272eb6bdb36c22c80ec2ba1c2f1c7e6e -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '78.184.77.137']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Changing the Moodle admin password through PhpMyAdmin									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>32,206</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Oct 11, 2012'><span style='color:#606060;'>Published:</span> Oct 25, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>The previous article in the <a target="_blank" title="Click here for more information" href="/support/edu/moodle/new-to-moodle">Getting Started with Moodle course</a> explained the process for <a target="_blank" href="/support/edu/moodle/new-to-moodle/change-username-password-moodle">resetting the Moodle username and password in the Moodle dashboard</a>. In the event the Moodle dashboard is not accessible to do this, the password and username can be reset in the database through PhpMyAdmin.</p>
<p><strong>Using PhpMyAdmin to reset the User Password/Username</strong></p>
<ol class="article_list">
<li><strong>Log into phpMyAdmin</strong> cPanel hosting will have a database utility called PhpMyAdmin within the cpanel. If the Moodle is installed on a non cPanel hosting, contact the hosting company for information on how to edit your database on the server. For more information on loging into PhpMyAdmin, please see the article on "<a href="/support/website/cpanel/how-do-i-manage-a-mysql-database-in-phpmyadmin-in-my-control-panel-cpanel" target="_parent">How do I manage a MySQL database in PHPMyAdmin in my control panel (cpanel)?</a>".</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/pass-reset-phpmyadmin/moodle-password-reset-phpmyadmin-second-page.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="moodle-password-reset-phpmyadmin-second-page" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/pass-reset-phpmyadmin/moodle-password-reset-phpmyadmin-second-page.gif" width="200" /></a> In PhpMyAdmin, find the table called <strong>mdl_user</strong> and select it. Since Moodle has many tables, the <strong>mdl_user</strong> table may be on the second page. Select the second page.<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/pass-reset-phpmyadmin/moodle-password-reset-phpmyadmin-select-mdl_user.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="moodle-password-reset-phpmyadmin-select-mdl_user" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/pass-reset-phpmyadmin/moodle-password-reset-phpmyadmin-select-mdl_user.gif" width="200" /></a>Click the <strong>mdl_user</strong> table. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/pass-reset-phpmyadmin/moodle-password-reset-phpmyadmin-edit.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="moodle-password-reset-phpmyadmin-edit" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/pass-reset-phpmyadmin/moodle-password-reset-phpmyadmin-edit.gif" width="200" /></a>After selecting the table, find the table row for the user that is being edited. Click the <strong>Edit</strong> link with the pencil icon. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/pass-reset-phpmyadmin/moodle-password-reset-phpmyadmin-md5.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="moodle-password-reset-phpmyadmin-md5" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/pass-reset-phpmyadmin/moodle-password-reset-phpmyadmin-md5.gif" width="200" /></a> There will be a series or characters and numbers in the password field. This is an encrypted password so it cannot be viewed in the database. Replace the encrypted text with the new password for the login. Next, in the drop down menu to the left, select <strong>MD5</strong> then click <strong>Go</strong>. This can also be done for the Email address and the Username. The Email and the Username do not need the MD5 hash. <br style="clear: both;" /></li>
</ol>
<p>Now that the basics of the Moodle set up is established, it is time to learn more about how to use Moodle. Please check the next article on <a target="_blank" href="/support/edu/moodle/new-to-moodle/edit-front-page-settings" title="Click here to view the next article"> How to edit the Front page settings in Moodle</a>.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 6: Changing the Moodle admin password through PhpMyAdmin</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 5: <a href='/support/edu/moodle/new-to-moodle/change-username-password-moodle'>How to change the Username and Password in Moodle</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 7: <a href='/support/edu/moodle/new-to-moodle/edit-front-page-settings'>How to edit the Front page settings in Moodle</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/moodle/new-to-moodle/moodle-password-reset-phpmyadmin&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/moodle/new-to-moodle/moodle-password-reset-phpmyadmin'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNzQmaWQ9MTg2MSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
...
<a name='comments'></a>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/979728b45fce6c0045252d9e683e8347?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/979728b45fce6c0045252d9e683e8347'>mohsen</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-07 3:00 am</div>
				                <div>thnk u very much. its best!</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13712);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-16717'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/e73121b982e17a847c8d6002788e1ce4?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/e73121b982e17a847c8d6002788e1ce4'>asanka</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-26 12:46 am</div>
				                <div><p>Thanks for the Information. Very helpful</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16717);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-17756'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/e0880a8057963931c470e6a8acdc1278?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/e0880a8057963931c470e6a8acdc1278'>Vicent</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-23 9:25 am</div>
				                <div>It is perfect: clear and easy to understand!</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17756);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-25570'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/b8e703223db396a6bc23de9ec5e95d70?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/b8e703223db396a6bc23de9ec5e95d70'>dodo</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-07 3:25 am</div>
				                <div><p>Thankyou very much....</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25570);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-32874'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/b15b415826b45cd3c4cdb67c3c082a09?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/b15b415826b45cd3c4cdb67c3c082a09'>Stuart</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-05-22 2:40 pm</div>
				                <div><p>Saved me heaps of rework. Cheers mate.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32874);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
