<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:72353:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/what-is-vps-hosting" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-08-12T20:32:53-07:00" />
  <meta name="keywords" content="what is vps hosting 30_xfer" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="VPS Hosting is a virtualized server used to host a website. It uses operating system virtualization, and gives you dedicated server benefits at a fraction of the cost." />
  <title>What is VPS Hosting? - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/what-is-vps-hosting" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:47cef7b97453cb3c14b9a268c0867169 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '74.95.238.233']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>What is VPS Hosting?</span></li>			</ul>
		</div>
	</div>
</div>
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>50,655</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Nov 15, 2011'><span style='color:#606060;'>Published:</span> Aug 12, 2015</div>
							...
							<div style='clear:both;'></div>
								...
								<p>VPS hosting is a <strong>Virtual Private Server</strong>, and is a virtualized server. A VPS hosting environment mimics a dedicated server within a shared hosting environment. It is technically both shared hosting and dedicated hosting.</p>
<p><a href="http://www.inmotionhosting.com/vps-hosting">VPS Hosting</a> is one of several types of web hosting accounts you can choose from to host your website online. To have a website on the internet, you need to have your website files on a web server. Setting up and managing a server can not only be expensive, but difficult too. Purchasing web hosting allows someone to rent space on a web server, making it easier for the average person to have host a website online because all they need to do is upload their site files (no server setup is needed on their part).</p>
<p>All three of these hosting account types are similar in the fact that they all give you a web server to run your website on. They vary in how they are setup, the features they offer, and the level of customization you can have with each one. Check out more information about our various<a href="http://www.inmotionhosting.com/cloud-vs-vps"> VPS plans and features</a>.</p>
<h2>Why is VPS Hosting different than Shared and Dedicated</h2>
...
<p>If you are considering a dedicated server and are unsure if it is right for you, perhaps you will need to get VPS hosting.</p>
...
<p>Our VPS hosting envionments function in the same manner. While we have one physical server, we can run several different virtualized operating systems on that one server. Each virtualized operating system acts as if it was a dedicated server. This allows you to have all of the benefits of a dedicated server at a fraction of the cost.</p>
<p>InMotion Hosting uses Parallels Virtuozzo Containers in order to virtualize the Operative System. Each VPS hosting environment is referred to as a container, and the physical server each container is provisioned to is referred to as a node.</p>
<h2>What are the benefits of VPS Hosting?</h2>
...
<tbody>
<tr><th>Privacy</th>
<td>As you don't share your OS with anyone else, there are no other websites on your server that potentially have access to your files.</td>
</tr>
<tr><th>Customization</th>
<td>With a VPS Server, you have your own Operating System. This also means that you have your own instances of all server applications such as Apache, PHP, and MySQL. If you need to have any of these services customized, you can make changes to suit the server to your needs.</td>
</tr>
<tr><th>Control</th>
<td>If you're installing server applications that require a system restart, you can do so at any time. Even though technically you share a server with other VPS servers, your VPS server can be restarted without affecting anyone else.</td>
</tr>
<tr><th>Dedicated Resources</th>
<td>On a VPS Server, you have dedicated amounts of RAM available to you at any time. Unlike shared hosting, there is no one else on your server that can use utilize all the RAM when you need it most!</td>
</tr>
</tbody>
</table>
<h2>VPS Server Management</h2>
<p>All VPS hosting environments with cPanel VPS Optimized for free! This means that you can easily upload files, manage domains, secure your server, and perform many other tasks to help keep your server running smoothly. To learn more about cPanel VPS Optimized, <a href="http://www.inmotionhosting.com/cpanel-hosting/vps-with-cpanel.html">click here</a>.</p>
<p>Please check the next article on <a target="_blank" href="/support/?id=1074:cpanel-vs-whm&amp;catid=148" title="Click here to view the next article">cPanel vs. WHM ( Web Host Manager )</a>. For more information on this course please visit <a target="_blank" href="/support/?id=148" title="Click here to view the courses">An Introduction to Web Hosting</a></p>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/what-is-vps-hosting&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/what-is-vps-hosting'></div>
	<script type='text/javascript'>
	  (function() {
...
<script type='text/javascript'>
  ...
  ga('send', 'pageview');
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD05JmlkPTEwMjImdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/ae925f0678396c1a06d7eff766a91a69?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/ae925f0678396c1a06d7eff766a91a69'>Jen Rowell</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-05-04 4:29 pm</div>
				                <div><p>How do I know what&nbsp;network&nbsp;am I&nbsp; on?</p>
<p>I followed the steps and alls I can see is my server&nbsp;is vps11695 but it dont tell me the network?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23173);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-05-04 5:06 pm</div>
				                <div>Hello Jen,<br />
<br />
You are not on a network (other than the Internet itself) but on a VPS server. The VPS#### is the number of your container. That is the highest level of access you have and it can be reached by calling up that particular container directly.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23174);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/ca633b8e5821d516187413e185f42185?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/ca633b8e5821d516187413e185f42185'>Monoj kumar mondal</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-13 1:13 pm</div>
				                <div><p>how can i use a vps?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27502);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-14 12:52 am</div>
				                <div>Hello Monoj,<br />
<br />
What are you trying to accomplish by getting a VPS? Maybe we can point you in the right direction.<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27510);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-28682'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/cc148f8f9a65311cc4c032f834b95b94?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/cc148f8f9a65311cc4c032f834b95b94'>Ebenezer</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-23 2:55 pm</div>
				                <div><p>Please I am creating a research website with a blog in it. How do I use a VPS in this because I want to get a personal server for the website. And what other things do I need for that.</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28682);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-23 3:49 pm</div>
				                <div>Hello Ebenezer,<br />
<br />
VPS hosting works the same as Shared Hosting, except you have additional features such as your own WHM panel. If you have any questions about the specifics of our hosting, be sure to contact our <a href="http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support">Live Sales</a> center for more help.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28683);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
