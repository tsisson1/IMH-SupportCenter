<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:81325:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/amp/change-hosting-term-subscription" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-06-11T16:38:05-07:00" />
  <meta name="keywords" content="change term payment subscription" />
  <meta name="author" content="John-Paul Briones" />
  <meta name="description" content="This is a tutorial on how to change the terms of your billing cycle in AMP." />
  <title>How to change the Term of your Hosting Subscription - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/amp/change-hosting-term-subscription" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:e88764b54803423539063ba4894166b6 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '196.0.52.30']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to change the Term of your Hosting Subscription</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to change the Term of your Hosting Subscription									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>1,810</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jun 2, 2014'><span style='color:#606060;'>Published:</span> Jun 11, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In this guide I will show you how to <strong>change</strong> the <strong>Terms</strong> of your <strong>hosting</strong> plan in AMP (Account Management Panel). For example, you may want to pay every 2 years instead of on a yearly billing cycle. You will also be able to see your price listed, before making the change. This can help you decide which term works best for your needs. If you want to change the Hosting Plan you are subscribed to, see our guide on <a href="/support/website/amp/upgrade-downgrade-hosting-plan">upgrading/downgrading your plan</a>.</p>
    
  
  <h2>Changing the Terms of your Hosting Plan</h2>
  <ol class="article_list">
    <li><a href="/support/website/amp/how-to-log-into-amp">Login to AMP</a>.</li>
  <li>Find the hosting plan you want to modify, and click the <strong>Change Hosting Plan</strong> button.<br>
  <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/revamp/change-hosting-plan.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/revamp/change-hosting-plan.png" alt="Modify plan in AMP" title="Change Hosting Plan button" /></a></li>
  <li>To the right of the <strong>Select term</strong> option, click the drop-down box.<br>
  <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/revamp/changing-terms-of-hosting-plan.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/revamp/changing-terms-of-hosting-plan.png" alt="change plan terms in amp" title="Selecting new Terms for your hosting subscription" /></a><br><br>
  You will see a list of available terms, along with a <strong>prorated</strong> price. Select the option that you want to change to.</li>
  <li>Next to <em>Payment Method</em> choose if you want to pay with <strong>Credit Card</strong>, or <strong>Check</strong>, then fill in information as needed. Click the <strong>SUBMIT</strong> button when you are done. You will finally see a message stating "<em>Your order has been submitted for processing. Please look for a follow up from our staff shortly.</em>"<br>
  <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/revamp/change-hosting-plan-terms-order-processing.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/revamp/change-hosting-plan-terms-order-processing.png" alt="Plan subscription modification" title="Processing change of terms to plan in AMP" /></a></li>
  <br></ol>
    
<p>Congratulations, now you know how to <strong>change</strong> the <strong>Terms</strong> of your <strong>hosting subscription</strong> in AMP!</p>   
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/amp/change-hosting-term-subscription&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/amp/change-hosting-term-subscription'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MjcmaWQ9MzI2OSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="99dc358a505372f5e9f69ba3ee726078" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/99033c7216e99085ce5b11e30765dd90?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/99033c7216e99085ce5b11e30765dd90'>Joe </a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-31 10:20 pm</div>
				                <div><p>I would like to discontinue auto renew on my site</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22244);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-02 1:51 am</div>
				                <div>Hello Joe,<br />
<br />
The <B>autorenew</b> is a mandatory part of the subscription to the service  that you have signed up.  The only way to remove it would be to request that the subscription be set to expire.  The danger here is if you do NOT intend to leave InMotion, then if the subscription were to expire,  your website would not be available until you renewed the service.  Autorenew allows the account to automatically renew the subscription.<br />
<br />
If removing the autorenew is an absolute necessity, then you will need to submit a verified ticket or contact the Billing department to have your account set to expire.  I hope this helps to answer your question, please let us know if you require any further  assistance.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22270);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-22680'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/b32356fe88a30e86b3c4e832ee2c772c?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/b32356fe88a30e86b3c4e832ee2c772c'>Trexx</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-15 4:41 pm</div>
				                <div><p>When upgrading hosting plans from VPS to dedicated server, will the migration of existing domains, websites, etc. be done for me?</p>
<p>Regards,</p>
<p>Trexx</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22680);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-16 11:12 am</div>
				                <div>Hello Trexx,<br />
<br />
Yes, if you upgrade to a dedicated server from a VPS, they will migrate the files and websites to the new server.  Everything that was running on the VPS would be running on the dedicated server.<br />
<br />
If you have any further questions or comments, please let us know.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22705);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-27998'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/33bfe03310c009513992eb659fcd6f2c?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/33bfe03310c009513992eb659fcd6f2c'>Peter Shilla</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-29 1:48 pm</div>
				                <div><p>Wish to change plan from elite dedicated to VPS, will there be a set up fee for this or will be taken care of under the new plan fees?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27998);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-29 2:15 pm</div>
				                <div>Hello Peter Shilla,<br />
<br />
Typically, when you downgrade from a dedicated server to a VPS, there is a required review from the systems department, and then billing will make the change once the downgrade is approved.  The fees are typically covered in the downgrade.  If  you have any questions, please contact our customer service  department.   <br />
<br />
If you have any further questions or comments, please let us know.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27999);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-28143'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/88302debe6d0fec89732aea9da0234be?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/88302debe6d0fec89732aea9da0234be'>Mark Behnken</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-03 5:59 pm</div>
				                <div><p>This doc needs to be updated to be more clear. I followed each step to a tee and it invoked a change from my VPS to a Launch Plan. You should really mention that the "change to" field needs to reflect the same plan because the dropdown defaults to Launch Plan. I spent unecessary time on a service call that could have been avoided if this doc was more clear. A downgrade would have potentially hurt my business and waisted my time and your server teams time making the unecessary change. Thank you.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28143);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-03 11:12 pm</div>
				                <div>Hello Mark,<br />
<br />
Thank you for your input. I will add this article to our list that needs to be updated as our system does change often.<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28153);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-29024'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/249b8cd2975cd2c64969311633e87858?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/249b8cd2975cd2c64969311633e87858'>Abdulah</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-12-06 1:33 am</div>
				                <div><p>I want to renew my plan for 1 year</p>
<p>so should i select change plan and then slect PRO again but for 1 year? and can i renew it with PRO for 2 years?</p>
<p>regards,</p>
<p>Abdullah&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29024);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-12-07 4:10 pm</div>
				                <div>Hello Abdullah,<br />
<br />
If it offers you the chance to change the term when updating, you should be able to select 1 year. If you do not see that ability, you can always contact the Live Billing team via chat and they will be able to assist you there.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29046);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
