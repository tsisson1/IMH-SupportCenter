<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:70888:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/mediawiki/getting-started-mediawiki/mediawiki-manage-user-accounts" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-01-21T20:20:00-08:00" />
  <meta name="keywords" content="create edit delete restrict users MediaWiki media wiki user deleting remove creating editing restricting change changing update updating email e-mail password passwords spam bot [gs]" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="This section will explain how to create, edit, delete, and restrict users on the MediaWiki site." />
  <title>Managing User Accounts in MediaWiki - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/mediawiki/getting-started-mediawiki/mediawiki-manage-user-accounts" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:6c50ca00f486b98c4fa4f739a56e5482 -->
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/mediawiki' itemprop='url'><span itemprop='title'>MediaWiki<span></a><div class='dropdown_4columns'><h2>MediaWiki Education Channel</h2><div class='col_2'><h3>100 Level Classes</h3><div><a href='/support/edu/mediawiki/getting-started-mediawiki'>101: Getting Started with MediaWiki</a></div><div><a href='/support/edu/mediawiki/adding-content-mediawiki'>102: Adding content to MediaWiki</a></div><div><a href='/support/edu/mediawiki/change-media-wiki-appearance'>103: Changing the MediaWiki appearance</a></div><div><a href='/support/edu/mediawiki/add-contact-form-media-wiki'>104: Adding a contact form in MediaWiki</a></div></div><div class='col_2'><h3>200 Level Classes</h3><div><a href='/support/edu/mediawiki/change-mediawiki-interface-language'>201: Changing the MediaWiki interface Language</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/mediawiki/getting-started-mediawiki' itemprop='url'><span itemprop='title'>101: Getting Started with MediaWiki<span></a><div class='dropdown_3columns'><h2> Getting Started with MediaWiki</h2><div class='col_3'><div>1. <a style='display:inline;' href='/support/edu/mediawiki/getting-started-mediawiki/overview-media-wiki'>Basic MediaWiki site overview</a></div><div>2. <a style='display:inline;' href='/support/edu/mediawiki/getting-started-mediawiki/install-mediawiki-softaculous'>Installing MediaWiki with Softaculous</a></div><div>3. <a style='display:inline;' href='/support/edu/mediawiki/getting-started-mediawiki/install-mediawiki-manually'>Installing MediaWiki manually</a></div><div>4. <a style='display:inline;' href='/support/edu/mediawiki/getting-started-mediawiki/login-username-password'>How to log into MediaWiki</a></div><div>5. <a style='display:inline;' href='/support/edu/mediawiki/getting-started-mediawiki/password-username-media-wiki'>Managing passwords and usernames in MediaWiki</a></div><div>6. <a style='display:inline;' href='/support/edu/mediawiki/getting-started-mediawiki/mediawiki-manage-user-accounts'>Managing User Accounts in MediaWiki</a></div><div>7. <a style='display:inline;' href='/support/edu/mediawiki/getting-started-mediawiki/remove-add-account-access'>Adding / Removing account access features in MediaWiki</a></div><div>8. <a style='display:inline;' href='/support/edu/mediawiki/getting-started-mediawiki/change-url'>Changing your URL in Mediawiki</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Managing User Accounts in Med...</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Managing User Accounts in MediaWiki									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>24,783</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Dec 14, 2012'><span style='color:#606060;'>Published:</span> Jan 21, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>MediaWiki as an open source software that is designed to allow free access to the wiki site. This enables the site to be created by a group of users that have the experience and knowledge required to build the site. MediaWiki by default will allow users to create an account, edit their own profile, contribute to the articles, and much much more. This section will explain how to create, edit, delete, and restrict users on the MediaWiki site.</p>
<h2>Creating, Editing, and Removing User accounts</h2>
<h3>How do I create an account?</h3>
<p>Most wiki sites are open for free discussion on the internet to allow contributions to the site. The following steps will show how to create an account in MediaWiki.</p>
<ol class="article_list">
<li>Navigate to the MediaWiki site.</li>
<li><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/mediawiki/101/manage-users-mediawiki/mediawiki-create-account-1.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="mediawiki-create-account-1" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/mediawiki/101/manage-users-mediawiki/mediawiki-create-account-1.gif" title="Click here to view the larger image" width="100" /></a><strong>Click</strong> the <strong>Create Account</strong> link at the top right. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/mediawiki/101/manage-users-mediawiki/mediawiki-create-account-2.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="mediawiki-create-account-2" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/mediawiki/101/manage-users-mediawiki/mediawiki-create-account-2.gif" title="Click here to view the larger image" width="100" /></a>On the Log in / create account page, fill out the Username, password, e-mail address, and real name.
<p><strong>Click Create Account</strong>.<br style="clear: both;" /></p>
</li>
<li><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/mediawiki/101/manage-users-mediawiki/mediawiki-create-account-3.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="mediawiki-create-account-3" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/mediawiki/101/manage-users-mediawiki/mediawiki-create-account-3.gif" title="Click here to view the larger image" width="100" /></a>When the Account is Created Successfully, The Login Successful - Welcome screen will load. <br style="clear: both;" />
</li>
</ol>
<h3>Editing my user information</h3>
<p>Each user has a page they can add content to that allows them to display their personal information that they want to be public. this allows them to be recognized as contributors to the site. The following information will explain how to access the editing section for the user profile.</p>
<ol class="article_list">
<li><a target="_blank" href="/support/edu/mediawiki/getting-started-mediawiki/login-username-password" title="Click for more information">Log into MediaWiki</a></li>
<li><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/mediawiki/101/manage-users-mediawiki/edit-account-mediawiki-1.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="edit-account-mediawiki-1" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/mediawiki/101/manage-users-mediawiki/edit-account-mediawiki-1.gif" title="Click here to view the larger image" width="50" /></a><strong>Click special pages</strong> to the left of. <br style="clear: both;" />
</li>
<li><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/mediawiki/101/manage-users-mediawiki/edit-account-mediawiki-2.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="edit-account-mediawiki-2" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/mediawiki/101/manage-users-mediawiki/edit-account-mediawiki-2.gif" title="Click here to view the larger image" width="50" /></a><strong>Click User list</strong>. <br style="clear: both;" />
</li>
<li><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/mediawiki/101/manage-users-mediawiki/edit-account-mediawiki-3.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="edit-account-mediawiki-3" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/mediawiki/101/manage-users-mediawiki/edit-account-mediawiki-3.gif" title="Click here to view the larger image" width="50" /></a><strong>Select the user</strong> from the list to edit. <br style="clear: both;" />
</li>
<li><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/mediawiki/101/manage-users-mediawiki/edit-account-mediawiki-4.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="edit-account-mediawiki-4" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/mediawiki/101/manage-users-mediawiki/edit-account-mediawiki-4.gif" title="Click here to view the larger image" width="50" /></a><strong>Click</strong> the <strong>Edit tab</strong>. <br style="clear: both;" />
</li>
<li><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/mediawiki/101/manage-users-mediawiki/edit-account-mediawiki-5.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="edit-account-mediawiki-5" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/mediawiki/101/manage-users-mediawiki/edit-account-mediawiki-5.gif" title="Click here to view the larger image" width="50" /></a>Now the <strong>Edit User</strong> box will load where the user data can be changed or edited <br style="clear: both;" />
</li>
</ol>
<h3>How do I change my email address?</h3>
<p>When an email address is invalid or needs to be updated, the e-mail address can be changed in the Users' <strong>special pages</strong>.</p>
<ol class="article_list">
<li><a target="_blank" href="/support/edu/mediawiki/getting-started-mediawiki/login-username-password" title="Click for more information">Log into MediaWiki</a></li>
<li><strong>Click Special pages</strong> in the left navigation.</li>
<li><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/mediawiki/101/manage-users-mediawiki/change-email-mediawiki-1.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="change-email-mediawiki-1" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/mediawiki/101/manage-users-mediawiki/change-email-mediawiki-1.gif" title="Click here to view the larger image" width="100" /></a>In The Users and rights section. <strong>Click  e-mail-address</strong>. <br style="clear: both;" />
</li>
<li><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/mediawiki/101/manage-users-mediawiki/change-email-mediawiki-2.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="change-email-mediawiki-2" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/mediawiki/101/manage-users-mediawiki/change-email-mediawiki-2.gif" title="Click here to view the larger image" width="100" /></a>Type the new email address and enter your password. <strong>Click Change e-mail</strong>. <br style="clear: both;" />
</li>
</ol>
<h3>How do I change my password?</h3>
<p>The following section will explain how to change your MediaWiki user password.</p>
<ol class="article_list">
<li><a target="_blank" href="/support/edu/mediawiki/getting-started-mediawiki/login-username-password" title="Click for more information">Log into MediaWiki</a></li>
<li><strong>Click Special pages</strong> in the left navigation.</li>
<li><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/mediawiki/101/manage-users-mediawiki/change-password-mediawiki-1.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="change-password-mediawiki-1" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/mediawiki/101/manage-users-mediawiki/change-password-mediawiki-1.gif" title="Click here to view the larger image" width="100" /></a>In The Users and rights section. <strong>Click  Reset password</strong>. <br style="clear: both;" />
</li>
<li><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/mediawiki/101/manage-users-mediawiki/change-password-mediawiki-2.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="change-password-mediawiki-2" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/mediawiki/101/manage-users-mediawiki/change-password-mediawiki-2.gif" title="Click here to view the larger image" width="100" /></a>The Change e-mail address page should load confirming the email password was sent to the email address on file. <br style="clear: both;" />
<p><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/mediawiki/101/manage-users-mediawiki/change-password-mediawiki-3.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="change-password-mediawiki-3" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/mediawiki/101/manage-users-mediawiki/change-password-mediawiki-3.gif" title="Click here to view the larger image" width="100" /></a>If the Password was sent within 24 hours, the page will display "<em>A password reminder has already been sent, within the last 24 hours.</em>" <br style="clear: both;" />
</p>
</li>
<li><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/mediawiki/101/manage-users-mediawiki/change-password-mediawiki-4.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="change-password-mediawiki-4" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/mediawiki/101/manage-users-mediawiki/change-password-mediawiki-4.gif" title="Click here to view the larger image" width="100" /></a><strong>Check your email.</strong> The password reset email should look similar to the snapshot to the right.
  <p>The password and username will be included in the email.</p>
<br style="clear: both;" /></li>
</ol>
<h3>Deleting a user Account</h3>
<p><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/mediawiki/101/manage-users-mediawiki/delete-user-mediawiki.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="delete-user-mediawiki" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/mediawiki/101/manage-users-mediawiki/delete-user-mediawiki.gif" title="Click here to view the larger image" width="100" /></a>When MediaWiki users are created by spam bots, they cannot be deleted through the MediaWiki administration section. In order to delete these users, you will need to manually remove them from the database through PhpMyAdmin. This is not recommended for users that are real and have contributed to the wiki. The following will explain how to remove a user from MediaWiki.<br style="clear: both;" /></p>
<ol class="article_list">
<li><a title="Click here for more information" href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">Log into cPanel</a></li>
<li>Navigate to <strong>Databases</strong> &gt; <strong>PhpMyAdmin</strong>.</li>
<li><strong>Select the database</strong> on the left.</li>
<li>Find the user table and locate the user you want to delete. <strong>Get the user_id</strong>. in this case, the user table is mw_users and the user_id is 2.</li>
<li><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/mediawiki/101/manage-users-mediawiki/delete-user-mediawiki-1.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="delete-user-mediawiki-1" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/mediawiki/101/manage-users-mediawiki/delete-user-mediawiki-1.gif" title="Click here to view the larger image" width="100" /></a><strong>Click the SQL tab</strong>. Enter the following SQL statement.
<p class="alert"><strong>Important!</strong> BACKUP YOUR DATABASE. Backing up your database prior to running an SQL command can save potential mistakes that could break the site completely, ALSO! This is for newly made users. If the user has any contributions, they will need to be removed before running this command</p>
<pre>DELETE FROM mw_user WHERE user_id=2</pre>
<p><strong>Click Go</strong>.</p>
<br style="clear: both;" />
<p><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/mediawiki/101/manage-users-mediawiki/delete-user-mediawiki-2.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="delete-user-mediawiki-2" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/mediawiki/101/manage-users-mediawiki/delete-user-mediawiki-2.gif" title="Click here to view the larger image" width="100" /></a>PhpMyAdmin should show Green with how long the query took. <br style="clear: both;" /></p>
<p><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/mediawiki/101/manage-users-mediawiki/delete-user-mediawiki-3.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="delete-user-mediawiki-" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/mediawiki/101/manage-users-mediawiki/delete-user-mediawiki-3.gif" title="Click here to view the larger image" width="100" /></a>Now when going to the Users list the user will no longer be listed. <br style="clear: both;" /></p>
</li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/mediawiki/getting-started-mediawiki'>101: Getting Started with MediaWiki</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 6: Managing User Accounts in MediaWiki</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 5: <a href='/support/edu/mediawiki/getting-started-mediawiki/password-username-media-wiki'>Managing passwords and usernames in MediaWiki</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 7: <a href='/support/edu/mediawiki/getting-started-mediawiki/remove-add-account-access'>Adding / Removing account access features in MediaWiki</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/mediawiki/getting-started-mediawiki/mediawiki-manage-user-accounts&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/mediawiki/getting-started-mediawiki/mediawiki-manage-user-accounts'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMDMmaWQ9MjA3OSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/mediawiki/getting-started-mediawiki?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Getting Started with MediaWiki</h3></a>
		<table><tr><td colspan='2'><h4>MediaWiki overview</h4></td></tr>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/mediawiki/getting-started-mediawiki/overview-media-wiki?tsrc=rsbedu'>Basic MediaWiki site overview</a></td>
                </tr>
        <tr><td colspan='2'><h4>Installing MediaWiki</h4></td></tr>  <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/mediawiki/getting-started-mediawiki/install-mediawiki-softaculous?tsrc=rsbedu'>Installing MediaWiki with Softaculous</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/mediawiki/getting-started-mediawiki/install-mediawiki-manually?tsrc=rsbedu'>Installing MediaWiki manually</a></td>
                </tr>
        <tr><td colspan='2'><h4>Manage Users and login</h4></td></tr>  <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/mediawiki/getting-started-mediawiki/login-username-password?tsrc=rsbedu'>How to log into MediaWiki</a></td>
                </tr>
          <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/mediawiki/getting-started-mediawiki/password-username-media-wiki?tsrc=rsbedu'>Managing passwords and usernames in MediaWiki</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/mediawiki/getting-started-mediawiki/mediawiki-manage-user-accounts?tsrc=rsbedu'>Managing User Accounts in MediaWiki</a></td>
                </tr>
          <tr >
                        <td valign='top'>7.</td>
                        <td><a href='/support/edu/mediawiki/getting-started-mediawiki/remove-add-account-access?tsrc=rsbedu'>Adding / Removing account access features in MediaWiki</a></td>
                </tr>
          <tr >
                        <td valign='top'>8.</td>
                        <td><a href='/support/edu/mediawiki/getting-started-mediawiki/change-url?tsrc=rsbedu'>Changing your URL in Mediawiki</a></td>
                </tr>
          	</table>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/f1a1bb7a3f731f08ec658456d1d66811?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/f1a1bb7a3f731f08ec658456d1d66811'>Joey,</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-26 1:31 pm</div>
				                <div><p>Echt hartstikke bedankt voor je hulp!!! Met PhPMyadmin had ik eindelijk 500 accounts en een stuk of 70 spamberichten gemakkelijk kunnen verwijderen.</p>
<p>Veel gedoe gehad met die extencies wat niet werkte!</p>
<p>Remember... I am Dutch. So translate it ;)</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28784);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
