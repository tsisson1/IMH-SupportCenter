<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50537:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/email/add-security-exception-in-thunderbird-wont-go-away" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Ariel_Fox, Thank you for your question. If you are getting security errors regarding Thunderbird, you can permanently accept the certificate, here..." />
  <title>&quot;Add Security Exception&quot; in Thunderbird won't go away | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/email/add-security-exception-in-thunderbird-wont-go-away" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:c27db754de6dda9e0b85c11bd540616f -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>&quot;Add Security Exception&quot; in Thunderbird won't go away</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='http://graph.facebook.com/ariel.fox.14/picture?type=normal' class='user_avatar' /><br />
			<a href='/support/community-support/users/Ariel_Fox'>Ariel_Fox</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-07-17 10:29 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>8,433</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>For one of my accounts in Thunderbird, I often see this pop up box no matter how many times I click on &quot;Get Certificate&quot; and &quot;Confirm Security Exception&quot;:<br />
<br />
The pop up says: <br />
<br />
&quot;Add Security Exception.<br />
<br />
...
This site attempts to identify itself with valid information.<br />
<br />
Wrong Site<br />
Certificate belongs to a different site, which could indicate identity theft.<br />
<br />
Outdated Information<br />
Certificate is not currently valid.  It is impossible to verify whether this identity was reported as stolen or lost.<br />
<br />
Unknown Identity<br />
Certificate is not trusted, because it hasn't been verified by recognized authority.&quot;</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_3561' id='upvote_answer_3561' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='3561' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_3561').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_3561' id='downvote_answer_3561' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='3561' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_3561').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Ariel_Fox, <br />
<br />
Thank you for your question. If you are getting security errors regarding Thunderbird, you can permanently accept the certificate, here is a link to a <a href="http://www.inmotionhosting.com/support/email/email-troubleshooting/thunderbird-ssl-warnings" target="_blank" >walk-through guide</a>.<br />
<br />
Essentially, there should be a check box that you can click, it will look like this:<br />
<img  class="std_ss" src="http://www.inmotionhosting.com/support/images/stories/email/thunderbird-ssl-add-exception.jpg"><br />
<br />
If this persists with only this account, I recommend checking your settings, or <a href="http://www.inmotionhosting.com/support/email/thunderbird/creating-an-email-account-in-thunderbird" target="_blank" >setting up the account in Thunderbird</a> again.<br />
<br />
...
-John-Paul
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_3561').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_3561' id='form_comment_on_answer_3561' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/email/add-security-exception-in-thunderbird-wont-go-away&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/email/add-security-exception-in-thunderbird-wont-go-away'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="8b89ad2dd136d8b6fe89b24a192d27a7" value="1" />	</div>
	</form>
<!-- <br />
