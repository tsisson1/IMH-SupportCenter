<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:62143:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/prestashop-15/images-and-descriptions/removing-product-images" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-08-17T11:13:22-07:00" />
  <meta name="keywords" content="remove delete edit image images product products PrestaShop 1.5" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="This tutorial demonstrates how to delete an image from the product image list in PrestaShop 1.5" />
  <title>Removing product images in PrestaShop 1.5 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/prestashop-15/images-and-descriptions/removing-product-images" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:95886a283288f1193e179ab152bd2474 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '189.33.195.110']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Removing product images in PrestaShop 1.5									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>3,852</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: May 22, 2012'><span style='color:#606060;'>Published:</span> Aug 17, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>The procedure to remove images in PrestaShop 1.5 is much the same as <a href="/support/edu/prestashop-15/images-and-descriptions/add-product-image">adding</a> them. There are times when you may want to update with newer images, so you will want to remove the older images from the image list for your product. The following steps will show you how to edit the image list in PrestaShop 1.5.</p>
<p><strong>To remove an image from your product in PrestaShop 1.5:</strong></p>
<ol class="article_list">
<li><a href="/support/edu/prestashop-15/getting-started/login-to-dashboard">Log into your PrestaShop 1.5</a></li>
<li>Using the top menu bar, hover over the <strong>Catalog </strong>tab and click on the <strong>Products </strong>selection.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/product-remove-images/catalog-tab-products.png"><img  alt="catalog-tab-products" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/product-remove-images/catalog-tab-products.png" /></a></li>
<li>You are now on the <strong>Catalog: Products</strong> list page. From here, select the <strong>Edit </strong>icon (it looks like paper and pencil) on the right for the product you want to edit.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/product-remove-images/product-list-edit.png"><img  alt="product-list-edit" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/product-remove-images/product-list-edit.png" /></a></li>
<li>You are now on the <strong>Catalog : Edit Products</strong> page. From here click on the <strong>Images </strong>tab on the left sidebar.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/product-remove-images/product-remove-image-before.png"><img  alt="product-remove-image-before" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/product-remove-images/product-remove-image-before.png" /></a></li>
<li>Find the image you want to delete and click on the <strong>Delete </strong>icon (the trashcan) next to it. You will get a confirmation pop up. Click on <strong>OK </strong>to confirm the deletion.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/product-remove-images/product-remove-image-confirm.png"><img  alt="product-remove-image-confirm" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/product-remove-images/product-remove-image-confirm.png" /></a></li>
<li>With the selected image deleted, the list will now refresh with the remaining images.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/product-remove-images/product-remove-image-after.png"><img  alt="product-remove-image-after" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/product-remove-images/product-remove-image-after.png" /></a><br /><br />You can now delete images from your PrestaShop 1.5 storefront!</li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 5: Removing product images in PrestaShop 1.5</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 4: <a href='/support/edu/prestashop-15/images-and-descriptions/change-image-position'>How to order images for a product in PrestaShop 1.5</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/prestashop-15/images-and-descriptions/removing-product-images&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/prestashop-15/images-and-descriptions/removing-product-images'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNTMmaWQ9MTM1MSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="6b5de8ec4a55f58b429f50984d3444a5" value="1" />	</div>
	</form>
<!-- <br />
