<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:62919:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/email/fighting-spam/dmarc-setup" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-10-26T17:47:59-07:00" />
  <meta name="keywords" content="DMARC SPF DKIM" />
  <meta name="author" content="John-Paul Briones" />
  <meta name="description" content="Learn how to setup DMARC record in cPanel, to specify how to handle mail from your server that fails SPF and DKIM Validation." />
  <title>How to Setup DMARC records in cPanel - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/email/fighting-spam/dmarc-setup" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:9636584832a5577205c8d0ba4f13dc9b -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '24.251.64.41']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to Setup DMARC records in cPanel</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to Setup DMARC records in cPanel									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>9,736</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Oct 26, 2015'><span style='color:#606060;'>Published:</span> Oct 26, 2015</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In this tutorial, we will show you how to setup <strong>DMARC</strong> records in cPanel. This allows you to specify how mail servers should handle messages from your domain that do not have valid <a href="/support/edu/everything-email/spam-prevention-techniques/spf-records-domain-keys-combating-spam"><strong>SPF</strong> and <strong>DKIM</strong></a> records setup. Since the DMARC standard is used by many email providers (such as Gmail, Yahoo, AOL, Hotmail, Outlook), it can increase your chances of email being delivered successfully.</p>

<div class="alert alert-warning" role="alert">We provide basic DMARC record examples below. There are also many helpful tools available online for creating custom DMARC records, such as <a href="https://www.unlocktheinbox.com/dmarcwizard/" target="_blank" rel="nofollow">DMARC Wizard</a>, or <a href="http://www.kitterman.com/dmarc/assistant.html"  target="_blank" rel="nofollow">DMARC Record Assistant</a></div>
...
<li>Click the <strong>Advanced DNS Zone Editor</strong> button in the <em>Domains</em> section.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/email/dmarc/cpanel-advanced-dns-zone-editor-dmarc.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/email/dmarc/cpanel-advanced-dns-zone-editor-dmarc.png" alt="DMARC setup in cPanel" title="cPanel Advanced Zone Editor" /></a></li>
<li>Choose your domain from the drop down box.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/email/dmarc/advanced-dns-zone-editor-domain-selection.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/email/dmarc/advanced-dns-zone-editor-domain-selection.png" alt="DMARC settings in cPanel" title="Choosing domain in cPanel for DMARC setup" /></a></li>
<li>You will then see an available <em>Add a Record</em> section. Below are the settings you should enter in the fields:<br>
...
<tr>
<td>TXT Data</td>
<td>In this field you must choose how you want recipient servers to handle email from your domain that fails <a href="/support/edu/everything-email/spam-prevention-techniques/spf-records-domain-keys-combating-spam">SPF/DKIM</a> validation. Options are outlined below in red:<br>
  <strong>None: </strong> <code>"v=DMARC1; p=none; sp=none; rf=afrf; pct=100; ri=86400"</code><br>
  <strong>Reject:</strong> <code>"v=DMARC1; p=reject; sp=none; rf=afrf; pct=100; ri=86400"</code><br>
  <strong>Quarantine:</strong> <code>"v=DMARC1; p=quarantine; sp=none; rf=afrf; pct=100; ri=86400"</code><br><br>
  <p>Alternately, you can request an email report of failed DMARC validations by adding a valid email address, such as the following:</p>
  <strong>None: </strong> <code>"v=DMARC1; p=none; sp=none; ruf=mailto:user@example.com; rf=afrf; pct=100; ri=86400"</code><br>
  <strong>Reject:</strong> <code>"v=DMARC1; p=reject; sp=none; rf=afrf; pct=100; ruf=mailto:user@example.com; ri=86400"</code><br>
  <strong>Quarantine:</strong> <code>"v=DMARC1; p=quarantine; sp=none; ruf=mailto:user@example.com; rf=afrf; pct=100; ri=86400"</code><br>
...
<li>Click the <strong>Add Record</strong> button to save your record.<br>
  <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/email/dmarc/add-dmarc-record.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/email/dmarc/add-dmarc-record.png" alt="Saving DMARC settings" title="Adding DMARC records in cPanel" /></a><br><br>
  You will then see your record listed on the <em>Zone File Records</em> section.<br>
  <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/email/dmarc/example-dmarc-record.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/email/dmarc/example-dmarc-record.png" alt="DMARC zone file record in cPanel" title="DMARC Record" /></a></li><br>
</ol>
<br>
<p>Congratulations, now you know how to setup DMARC records in your cPanel for email validation! This should increase the chances of your email being delivered to many emails servers.</p> 
...
<div style='display:inline-block;'>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NiZpZD0zNjgwJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="3f0ba352813f8836a5c6a8d22b2b985a" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						...
						<div><a style='font-size:16px;' href='/support/community-support/users/markw'>markw</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-12 4:47 am</div>
				                <div>When a Cpanel account is created, why is this not set up automatically? It seems to me that what should be working out of the box, is no longer reliably working with some mail recipients because of changing policies. I have also read somewhere that you need DKIM and SPF set up too before DMARC works. Have you assumed that in this article?</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28365);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-12 11:46 am</div>
				                <div>Hello markw,<br />
<br />
Thank you for contacting us. DMARC settings simply tell a recipient server how to handle emails from a servers that do not "pass" DKIM/SPF authentication. <br />
<br />
Since websites have many different email configurations, we allow each cPanel to control their own specific settings.<br />
<br />
For example if you do not have SPF and DKIM setup, you can set your DMARC record as "none". This means do not "reject" or "quarantine" emails from your server if it fails SPF and DKIM. (This is not recommended, but many users have contact forms, or shopping carts that are setup this way). In this instance, I highly recommend adding an email address to the "TXT Data" as described above to receive an email report of failed DMARC validations.<br />
<br />
If you are having trouble setting up DMARC or SPF/DKIM records, your host should be able to assist you. If you are hosted with us, our <a href="http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support">live support</a> team is available 24/7, 365 days a year.<br />
<br />
Also, here is a helpful link to our guide on <a href="http://www.inmotionhosting.com/support/email/bounceback-errors/what-to-do-if-an-email-is-returned">What to do if an email is returned</a>, it can help troubleshoot returned, or <a href="http://www.inmotionhosting.com/support/email/bounceback-errors/email-bounce-bounceback-error">bounced</a> back.<br />
<br />
If you have any further questions, feel free to post them below.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28374);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
