<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:63749:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/php-fusion/getting-started-php-fusion/login-admin-panel" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-03-15T19:01:00-07:00" />
  <meta name="keywords" content="login access admin panel php fusion phpfusion php-fusion" />
  <meta name="author" content="Arnel Custodio" />
  <meta name="description" content="Controls for managing PHP-Fusion  can be found in the Admin Panel. This includes management of content, users, systems and program specific settings.  The following article explains how to login as the Admin Panel and what they will typically see.  " />
  <title>How to login to the PHP-Fusion Admin Panel - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/php-fusion/getting-started-php-fusion/login-admin-panel" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:064a5b1b929292916c53b3691646b723 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to login to the PHP-Fusion Admin Panel									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>11,086</span></div>
							...
							<div style='clear:both;'></div>
								...
								<div>The back end controls for managing the PHP-Fusion content management system are accessible only through an administrator login. &nbsp; The interface does not change much when you initially login as the admin, but upon accessing the admin panel link, the options become visible. &nbsp;Management options for the administrator are organized in four major categories: &nbsp;Content, User, System and Settings. &nbsp;The following article simply explains how to login into the Admin Panel for the PHP-Fusion Admin Panel.</div>
<div>&nbsp;</div>
<h2><br /><img src="//cdn.inmotionhosting.com/support/images/stories/edu/php-fusion/admin-login/php-fusion-logo.png" alt="Logo for PHP-Fusion" /><br />Accessing the PHP-Fusion Admin Panel</h2>
<div>&nbsp;</div>
<div><ol class="article_list">
<li>Access your internet browser and then type in the Administrator URL. &nbsp;Typically the URL will resemble the following<br /><br /><span class="code_block">http://domain_name.com/administration/index.php<a href="http://domain_name.com/administration/index.php"><br /></a><a href="http://domain_name.com/administration/index.php"></a></span><a href="http://domain_name.com/administration/index.php"><br /></a></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/php-fusion/admin-login/php-fusion-main-page.png"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/php-fusion/admin-login/php-fusion-main-page.png" width="200" height="91" alt="Main PHP-Fusion landing page"  style="margin: 0px 0px 15px 15px; float: right;" /></a>In a default interface, you will see the LOGIN section as a portion of the general PHP-Fusion interface.
<div style="clear: both;">&nbsp;</div>
</li>
<li>Click on the <strong>USERNAME</strong> field in the Login section and type in the administrator user name. &nbsp;</li>
<li>Click on the <strong>PASSWORD</strong> field and type in the password for the administrator.</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/php-fusion/admin-login/login-section.png"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/php-fusion/admin-login/login-section.png" width="100" height="121" alt="Login section of the PHP-Fusion interface"  style="margin: 0px 0px 15px 15px; float: right;" /></a>Click on <strong>LOGIN</strong>. &nbsp;You have the option to click on a check box next to the <strong>LOGIN&nbsp;</strong>button that lets the browser remember your password.
<div style="clear: both;">&nbsp;</div>
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/php-fusion/admin-login/admin-login-section.png"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/php-fusion/admin-login/admin-login-section.png" width="100" height="61" alt="Section that appears when logging in as administrator"  style="margin: 0px 0px 15px 15px; float: right;" /></a>When you login, you will see the same interface, but there will be a section under your Administrator login name. &nbsp;
<div style="clear: both;">&nbsp;</div>
</li>
<li>Click on <strong>ADMIN PANEL</strong> in order to see all of the Administrator controls and options. &nbsp;</li>
</ol>
<div>&nbsp;</div>
<div>&nbsp;</div>
<div>When you login to the Admin Panel, you will see all of the typical Administration options listed as per below:<br /><br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/php-fusion/admin-login/admin-panel-main.png"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/php-fusion/admin-login/admin-panel-main.png" alt="admin-panel-main"  /></a></div>
<div>&nbsp;</div>
<div>&nbsp;</div>
</div> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 3: How to login to the PHP-Fusion Admin Panel</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 2: <a href='/support/edu/php-fusion/getting-started-php-fusion/install-php-fusion-manually'>Installing PHP-Fusion manually</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 4: <a href='/support/edu/php-fusion/getting-started-php-fusion/change-reset-password'>How to change/reset my PHP-Fusion password</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/php-fusion/getting-started-php-fusion/login-admin-panel&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/php-fusion/getting-started-php-fusion/login-admin-panel'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zNTEmaWQ9MjMwMyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
...
<a name='comments'></a>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/d8c2366365c3ada77284917bdb17d118?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/d8c2366365c3ada77284917bdb17d118'>Abdul Wali</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-16 5:07 pm</div>
				                <div><p>I've used it, it works very nice for &lt;a href="http://www.onlinetuting.com/admin-panel-and-cms-in-php/"&gt;PHP Admin Panel&lt;/a&gt;. thanks</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15101);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-19536'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/90db12688420ac3bce9064fe92311c23?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/90db12688420ac3bce9064fe92311c23'>Steeven</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-14 1:03 pm</div>
				                <div><p>I'm using PHPFusion and its a cool website and pretty straight forward. I have removed the admin pannel normaly found on the right of the page which leads as shown above the dash board and since I can not access the dash board. Any advice and thanks in advance.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19536);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-15 11:09 am</div>
				                <div>Hello Steeven,<br />
<br />
You should still be able to access the admin page by entering a URL in this format:<br />
<div class="code_block">http://example.com/administration/index.php</div><br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19570);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
