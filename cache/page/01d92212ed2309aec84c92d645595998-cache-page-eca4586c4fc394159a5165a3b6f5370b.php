<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:69219:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/everything-email/introduction-email/create-an-email-account" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-09-16T14:34:19-07:00" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Learn how to create an email account within your cPanel. " />
  <title>Creating an Email Account in cPanel - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/everything-email/introduction-email/create-an-email-account" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<script type="text/javascript">
		...
		_gaq.push(['_setCustomVar', 4, 'DateMonthPublished', '2015-09', 3]);
	...
	<!-- cid:11993172576b57331c9d99b5ae90cdc9 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '70.63.105.202']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Creating an Email Account in cPanel									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>92,496</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Sep 16, 2015'><span style='color:#606060;'>Published:</span> Sep 16, 2015</div>
							...
							<div style='clear:both;'></div>
								...
								<iframe width="560" height="315" src="https://www.youtube.com/embed/484qJxLqBHg" frameborder="0" allowfullscreen></iframe>
<p>Before you can use email, you must create the email account in cPanel.</p>
...
<li>Once logged into cpanel, click on the "<strong>Email Accounts</strong>" located in the <em>Mail</em> section of cPanel:<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/email/cpanel-email.jpg"><img src="//cdn.inmotionhosting.com/support/images/stories/email/cpanel-email.jpg" alt="cpanel-email"  /></a></li>
<li>That will open a screen so you can create a new email address. You should see the below screenshot.
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/email/cPanel-add-email.jpg"><img src="//cdn.inmotionhosting.com/support/images/stories/email/cPanel-add-email.jpg" alt="cPanel-add-email"  /></a><br><br>
  Fill in the fields, below is a description of what to enter:<br>
<table class="article_table">
<tbody>
<tr><th>Email:</th>
<td>This is the name of the account. This will be before the @ symbol in the email address.</td>
</tr>
<tr><th>Password:</th>
<td>This is the password you assign to the email account.</td>
</tr>
<tr><th>Password (again):</th>
<td>Re-type the password</td>
</tr>
<tr><th>Mailbox Quota:</th>
<td>Select the size of the mailbox you want to create.</td>
</tr>
</tbody>
</table><br>

After entering your information in the fields, click the button labeled "<strong>Create Account</strong>"</li>
<li>Once the account has been created, you will see the following screen to verify the account was created.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/email/cPanel-account-created.jpg"><img src="//cdn.inmotionhosting.com/support/images/stories/email/cPanel-account-created.jpg" alt="cPanel-account-created"  /></a></li>
</ol>
...
<p>Congratulations, now you know how to create an email account in cPanel. Please check the next article on <a target="_blank" href="/support/edu/everything-email/introduction-email/checking-email-account" title="Click here to view the next article"> Checking your Email Account</a>. If you missed our previous article, please see the <a href="/support/edu/everything-email/introduction-email/email-basic-introduction" title="Click here to view the previous article" target="_blank">Email Introduction</a> tutorial, which is part of our <a target="_blank" href="/support/edu/everything-email/introduction-email" title="Click here to view the courses">Introduction to Email </a>class.</p>

<h3>Migrating email from another host</h3>
<p>If you're in the process of transferring to InMotion Hosting from a different hosting provider, you may have emails that you want to copy to this email account you just created. We have a tutorial on how to accomplish that <a href="/support/email/general-information/transferring-emails-from-your-old-host-to-inmotion-hosting">here</a>.</p>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 1: Creating an Email Account in cPanel</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 2: <a href='/support/edu/everything-email/introduction-email/email-basic-introduction'>Email: a Basic Introduction</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/everything-email/introduction-email/create-an-email-account&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/everything-email/introduction-email/create-an-email-account'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xNDMmaWQ9MzY2MCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="13f63d59f5bb2e7d7b3a77f71fced495" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/55b0ea7284cfe78e13057828b1d96c8e?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/55b0ea7284cfe78e13057828b1d96c8e'>CJStevens</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-05-05 7:31 pm</div>
				                <div><p>Arn - I logged in correctly and the other items in the list don't apply. Any other thoughts?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32491);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-05-05 8:28 pm</div>
				                <div>Hello CJStevens,<br />
<br />
Thank you for contacting us. We are happy to help, but it is not clear what you are trying to accomplish.<br />
<br />
Are you following the above guide?<br />
<br />
Could you provide additional details on what you are attempting?<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32492);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-32845'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/a022d1cdf32fe8ba8d2a781636b6509b?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/a022d1cdf32fe8ba8d2a781636b6509b'>Karen</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-05-20 12:52 pm</div>
				                <div><p>I just purchased a new domain in order to create new email addresses. I cannot find the domain on the pull down menu in CPanel where I create email addresses. What's going on?&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32845);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-05-20 1:06 pm</div>
				                <div>Hello Karen,<br />
<br />
Have you added the domain as an <a href="http://www.inmotionhosting.com/support/domain-names/general-information/domain-names-what-is-the-difference-how-to-work-with-addon-parked-and-subdomains">addon or parked domain</a> within your cPanel? You have to do this no matter where you bought the domain from.<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32846);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-32998'></a>
		<div  style='margin:2px 0px 0px 80px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/a0c922ffcffc75e44fd13f7d357381f2?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/a0c922ffcffc75e44fd13f7d357381f2'>Karen Zastudil</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-05-26 8:07 pm</div>
				                <div><p>an addition domain was transferred&nbsp;to InMotion Hosting to park.&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32998);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-05-27 12:03 am</div>
				                <div>Hello Karen,<br />
<br />
Thank you for contacting us. Here is a link to our full guide on <a href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-manage-domains/park">how to park a domain in cPanel</a>. Once the domain has been parked you will be able to create email accounts as described above.<br />
<br />
If you need account specific our assistance, our <a href="http://www.inmotionhosting.com/contact">Live Support</a> team is happy to assist you 24/7.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(33001);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
