<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:66667:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/email/exim/view-summary-of-mail-from-exim-mail-log" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-03-19T23:25:00-07:00" />
  <meta name="keywords" content="exim view glance review summary mail log" />
  ...
  <link href="http://www.inmotionhosting.com/support/email/exim/view-summary-of-mail-from-exim-mail-log" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:e9eb01af726cbd1cf34370da51420035 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-22']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '86.125.19.62']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															View full summary of mail activity from the Exim mail log									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>17,270</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 21, 2013'><span style='color:#606060;'>Published:</span> Mar 19, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In this article I'm going to teach you how to use the Exim mail log on your VPS (Virtual Private Server) or dedicated server to get a full summary of the mailing activity from a specified time range.</p>
<p>If you happened to have read either of my previous articles on either <a href="/support/email/email-troubleshooting/manage-the-exim-mail-queue-via-ssh" target="_blank">managing the Exim mail queue via SSH</a>, or <a href="/support/email/email-troubleshooting/manage-the-exim-mail-queue-in-whm" target="_blank">how to manage the Exim mail queue in WHM</a>, then you should already know how to view and manage the live Exim mail queue on your server. I've also talked about <a href="/support/email/email-troubleshooting/view-a-summary-of-the-exim-mail-queue" target="_blank">how to view a summary of the Exim mail queue</a> recently, which allows you to get a full summary of the messages currently in your Exim mail queue.</p>
<p>Now we're going to cover how you can view a summary of all messages that have already left the Exim mail queue and have either been delivered or failed. We're going to take advantage of a built in tool for Exim called <strong>eximstats</strong>, and I'll also provide you with a small bit of code that will allow you to use that command on just a specified time range instead of your entire Exim mail log.</p>
<p class="alert">To be able to follow along with the steps below, you'll need <a href="/support/website/general-server-setup/root-access-faq" target="_blank">root access</a> to either your VPS or dedicated server so that you have full access to the Exim mail log and the <strong>eximstats</strong> command that we'll be using.</p>
...
<p class="code_block" style="width: 500px;">date --date="5 hours ago" +%Y-%m-%d\ %H</p>
<span class="code_block">2013-01-21 09</span>
<p>Then this command will give you the current hour:</p>
<p class="code_block" style="width: 500px;">date +%Y-%m-%d\ %H</p>
<span class="code_block">2013-01-21 14</span>
<p>So now we know we're going to be searching between <strong>09:00 - 14:59</strong> for the last 5 hours of data. This next command will do just that and place all the data into a file called <strong>EXIM_LOG</strong>:</p>
<p class="code_block" style="width: 500px;">egrep "2013-01-21 09|2013-01-21 10|2013-01-21 11|2013-01-21 12|2013-01-21 13|2013-01-21 14" /var/log/exim_mainlog &gt; EXIM_LOG</p>
<p><strong>Code breakdown:</strong></p>
<table class="article_table">
<tbody>
<tr><th style="width: 55%; padding: 15px;">egrep "2013-01-21 09|2013-01-21 10|2013-01-21 11|2013-01-21 12|2013-01-21 13|2013-01-21 14" /var/log/exim_mainlog</th>
<td style="padding: 15px;">Locate any lines in the Exim mail log that contain an hour from our 5 hour range.</td>
</tr>
<tr><th style="width: 55%; padding: 15px;">&gt; EXIM_LOG</th>
<td style="padding: 15px;">Place the data from our search into a file called <strong>EXIM_LOG</strong> that we'll run further commands on.</td>
</tr>
</tbody>
</table>
<li>Now you will want to run the following command to get a summary of all the Exim activity from our <strong>EXIM_LOG</strong>&nbsp;file that we dumped all our data into:
<p class="code_block" style="width: 500px;">eximstats EXIM_LOG | less</p>
<p><strong>Code breakdown:</strong></p>
<table class="article_table">
<tbody>
<tr><th style="width: 55%; padding: 15px;">eximstats EXIM_LOG</th>
<td style="padding: 15px;">Run the <strong>eximstats</strong> command on our <strong>EXIM_LOG</strong> file that we created.</td>
</tr>
<tr><th style="width: 55%; padding: 15px;">less</th>
<td style="padding: 15px;">Use the <strong>less</strong> command so that when we get back the summary from our Exim mail log it doesn't all scroll by at once. Instead we can use the up and down arrows, or page up and page down to navigate through the data. Press <strong>q</strong> to quit when done reviewing.</td>
</tr>
</tbody>
</table>
<p>There is a ton of information available in the Exim mail log summary, the things you'll be looking through include <strong>Grand total summary</strong>, <strong>Deliveries by transport</strong>, <strong>Messages received per hour</strong>, <strong>Deliveries per hour</strong>, <strong>Time spent on the queue</strong>, <strong>Relayed messages</strong>, <strong>Top 50 mail rejection reasons by message count</strong>, <strong>Top 50 mail temporary rejection reasons by message count</strong>, <strong>Top 50 sending hosts by message count</strong>, <strong>Top 50 sending hosts by volume</strong>, <strong>Top 50 local senders by message count</strong>, <strong>Top 50 local senders by volume</strong>, <strong>Top 50 host destinations by message count</strong>, <strong>Top 50 host destinations by volume</strong>, <strong>Top 50 local destinations by message count</strong>, <strong>Top 50 local destinations by volume</strong>, <strong>Top 50 rejected ips by message count</strong>, <strong>Top 50 temporarily rejected ips by message count</strong>, <strong>List of errors</strong>, and finally <strong>Errors encountered</strong>.</p>
</li>
<li>Once you're done reviewing the Exim mail queue summary for the time frame we specified, you'll want to go ahead and remove the <strong>EXIM_LOG</strong> file we created with the following command:<br /><br /> <span class="code_block">rm -rf ./EXIM_LOG</span>
<p>If you didn't want to specify any sort of time range, and simply wish to see a full Exim summary of everything in the mail log you can simply run the <strong>eximstats</strong> command directly on the main Exim log file with this command:</p>
<span class="code_block" style="width: 500px;">eximstats /var/log/exim_mainlog | less</span>
...
<p>You should now understand how to login to your server and take a look at the full Exim summary of all of your mail activity that has been happening on your server, by using the Exim mail log and the <strong>eximstats</strong> command.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/email/exim/view-summary-of-mail-from-exim-mail-log&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/email/exim/view-summary-of-mail-from-exim-mail-log'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NjMmaWQ9ODEyJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="19965d9bb95e476710c28537f43e26c4" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/dd11dd36453505bf472a398bd41e6de2?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/dd11dd36453505bf472a398bd41e6de2'>Brajesh</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-12-02 8:41 am</div>
				                <div><p>hello</p>
<p>please give solutation </p>
<p>how to restore email data from exim server who install centos 6.6 for particular email id</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28911);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-12-02 11:20 am</div>
				                <div>Hello Brajesh,<br />
<br />
Typically, this would be done through a restoration of backups on the server.    In looking this issue up in support forums check out <a href="http://superuser.com/questions/472531/how-to-restore-emails-on-centos" rel="nofollow" target="_blank">How to restore emails on CentOS</a>, though they talk more about location of the files than the actual process.  <br />
<br />
If you have any further questions or comments, please let us know.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28925);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-29589'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/4c30ba9007ccf787b11982c1860e81b1?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/4c30ba9007ccf787b11982c1860e81b1'>upul</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-06 4:34 am</div>
				                <div><p>can i know how to find which file or user use exim binary file in cpanl-linux</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29589);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-06 10:48 am</div>
				                <div>Hello Upul,<br />
<br />
We're not sure what you are asking.  Can you please provide a more thorough explanation of the request?  Please clarify and we would happy to try to help.<br />
<br />
If you have any further questions or comments, please let us know.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29597);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
