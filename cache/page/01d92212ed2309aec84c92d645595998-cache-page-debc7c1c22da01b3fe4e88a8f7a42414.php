<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49505:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/website/site-is-not-available" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="The domain is resolving to the correct server and the server is relaying the correct information to any visitors, but it does look like you have an infi..." />
  <title>Site is not available | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/website/site-is-not-available" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:d2130d1e9e30928c0c754ffa0544d9bc -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Site is not available</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='http://graph.facebook.com/cosic/picture?type=normal' class='user_avatar' /><br />
			<a href='/support/community-support/users/NinoCosic'>NinoCosic</a>
			<div>10 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-10-02 7:03 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>513</span>
			</div>
...
<br />
I've added my pcrawl.com domain as an addon domain but no mather how much time passes it is still not reachable :(<br />
<br />
Please assist.<br />
<br />
thanks,<br />
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_4050' id='upvote_answer_4050' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='4050' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_4050').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_4050' id='downvote_answer_4050' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='4050' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_4050').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>11,186 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2013-10-02 8:15 am EST
                		        </div>
					
		                </div>

				The domain is resolving to the correct server and the server is relaying the correct information to any visitors, but it does look like you have an infinite redirect loop within the code of your site that is causing the errors.  As most redirects happen within your .htaccess file, try renaming it.  It should fix your issue.  If you need information on modifying files, you may view this article on the File Manager:<br />
<br />
&lt;a href=&quot;http://www.inmotionhosting.com/support/edu/cpanel/cpanel-file-manager/using-file-manager-in-cpanel&quot;&gt;Using File Manager in cPanel&lt;/a&gt;
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_4050').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_4050' id='form_comment_on_answer_4050' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/website/site-is-not-available&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/website/site-is-not-available'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="aebdd7ea32d444fbc407090a6c858ead" value="1" />	</div>
	</form>
<!-- <br />
