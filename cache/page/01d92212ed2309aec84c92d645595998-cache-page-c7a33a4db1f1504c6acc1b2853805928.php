<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:47759:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/boldgrid/getting-started" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="keywords" content="BoldGrid WordPress Started" />
  <meta name="description" content="Learn how to begin building your website using BoldGrid for WordPress." />
  <title>Getting Started | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/boldgrid/getting-started" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:b02e1af286beb4fe2645fd24bb751c3a -->
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/boldgrid' itemprop='url'><span itemprop='title'>BoldGrid<span></a><div class='dropdown_2columns'><h2>BoldGrid Education Channel</h2><div class='col_2'><h3>100 Level Classes</h3></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Getting Started</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='section_listing'>
	Learn how to get started with your BoldGrid Website for WordPress.	<table>
		<tr>
				<td style='width:75px; font-weight:bold;'>Section 1:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/boldgrid/getting-started/new-boldgrid-user-no-website'>BoldGrid - First Steps for New Website Creators</a>
					<div>If you have never created a website before, then you will find the BoldGrid system to be an ideal solution to get your first site up and running.  BoldGrid allows you to use a staging area where you can build your website within the WordPress interface.  Viewers of your website will not see your Staged site until you're ready to deploy.  BoldGrid uses fully developed Inspirations that are themed based on popular industry categories. Using BoldGrid, you can quickly and easily build a beautiful and functional website in very little time.</div>
					<div class='smallgrey'>Hits: 947</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/boldgrid/getting-started/how-to-install'>How to Install BoldGrid</a>
					<div>BoldGrid installation guide.</div>
					<div class='smallgrey'>Hits: 420</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/boldgrid/getting-started/how-to-login'>How to Login to BoldGrid</a>
					<div>Learn how to Login to your BoldGrid for WordPress  site.</div>
					<div class='smallgrey'>Hits: 3,091</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/boldgrid/getting-started/install-inspiration'>How to install your first Inspiration</a>
					<div>Looking for your first steps in creating a site in BoldGrid? Learn how to install your first Inspiration here!</div>
					<div class='smallgrey'>Hits: 682</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/boldgrid/getting-started/evaluating-boldgrid-inspirations'>How to Evaluate the Inspirations</a>
					<div>Inspirations are fully populated themes available for use for your WordPress website.  There are several ways to evaluate them.  This article will walk you through seeing the Inspirations through a web browser, the administrator edit view, or the live preview option.  </div>
					<div class='smallgrey'>Hits: 260</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/boldgrid/getting-started/change-themes'>How to Change Themes in BoldGrid for WordPress</a>
					<div>Learn how to change your Theme in BoldGrid for WordPress.</div>
					<div class='smallgrey'>Hits: 591</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/boldgrid/getting-started/setup-staging'>How to Set Up Staging in BoldGrid</a>
					<div>Learn how to setup a staging site in BoldGrid for WordPress.</div>
					<div class='smallgrey'>Hits: 440</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/boldgrid/getting-started/evaluate'>Evaluating your BoldGrid site</a>
					<div>Looking for the next steps after installing your Inspiration? Learn how to evaluate your BoldGrid site to make it your own.</div>
			...
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/boldgrid/getting-started/add-new-pages'>How to Add new Pages in BoldGrid</a>
					<div>Learn how to Add new Pages to your BoldGrid for WordPress site.</div>
					<div class='smallgrey'>Hits: 284</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/boldgrid/getting-started/edit-page'>How to Edit Pages using the BoldGrid Editor</a>
					<div>Confused about how to edit your page in BoldGrid? Check out this article to learn how!</div>
					<div class='smallgrey'>Hits: 402</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/boldgrid/getting-started/desktop-tablet-phone-view'>Using the Desktop, Tablet, and Phone Views in the Editor</a>
					<div>How to see how your BoldGrid site will display on a phone, tablet, or desktop computer</div>
					<div class='smallgrey'>Hits: 180</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/boldgrid/getting-started/create-new-menu'>Creating a New Menu in BoldGrid</a>
					<div>BoldGrid for WordPress - Creating a new menu.</div>
			...
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/boldgrid/getting-started/edit-footer'>How to change your BoldGrid Footer Information</a>
					<div>Looking for how to edit or change the footer information in your BoldGrid site? Learn how with this tutorial.</div>
					<div class='smallgrey'>Hits: 365</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/boldgrid/getting-started/start-over'>How to start over in BoldGrid for WordPress</a>
					<div>Learn how to Start over in BoldGrid for WordPress.</div>
					<div class='smallgrey'>Hits: 598</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/boldgrid/getting-started/remove'>How to remove BoldGrid</a>
					<div>Learn how to remove BoldGrid from your IMH hosting account.</div>
					<div class='smallgrey'>Hits: 705</div>
				</td>
			</tr>
			</table>
</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD01MzcmaWQ9NTM3JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
