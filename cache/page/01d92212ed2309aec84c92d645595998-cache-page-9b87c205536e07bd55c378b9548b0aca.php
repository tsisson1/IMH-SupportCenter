<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:58120:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/drupal-7/configure-rss-feeds/edit-rss-description" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-07-18T17:57:52-07:00" />
  <meta name="keywords" content="drupal 7 set edit configure RSS feed description" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="This Drupal 7 tutorial will guide you on editing or configuring the RSS feed description" />
  <title>How to Edit the RSS description in Drupal 7 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/drupal-7/configure-rss-feeds/edit-rss-description" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:495264ca1fd5f89009fe8a885f0867aa -->
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
				<img src='/support/images/stories/drupal-partner/supporting-partner-80_3.png' style='float:right; margin:0px 0px 15px 15px;' alt='Drupal Association Support Partner'>		<h1>
															How to Edit the RSS description in Drupal 7									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>8,619</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jul 3, 2012'><span style='color:#606060;'>Published:</span> Jul 18, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Drupal 7 has a section for managing your RSS Feeds. From there you can manage the description, set the number of elements displayed, and even how they are displayed. This article will show you how to modify or create the RSS feed description. Creating the RSS description in Drupal 7 is simple with the following directions.</p>
<p><strong>How to Configure the RSS Feed description in Drupal 7:</strong></p>
...
<li>Find and click the <strong>Configuration </strong>menu item from the top menu bar.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Configuration/_main-dashboard-configuration.png"><img  alt="_main-dashboard-configuration" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Configuration/_main-dashboard-configuration.png" /></a></li>
<li>From the <strong>Configuration </strong>page, find the <strong>Web Services</strong> category and then click on the <strong>RSS Publishing</strong> link.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Configuration/Development/Web_Services/config-web-rss.png"><img  alt="config-web-rss" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Configuration/Development/Web_Services/config-web-rss.png" /></a></li>
<li>This brings you to the <strong>RSS Publishing</strong> page. From here, the <strong>RSS Description</strong> box is at the top of the page. Here you can edit or add a description of your RSS feed.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Configuration/web_services/config-web-rss-desc.png"><img  alt="config-web-rss-desc" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Configuration/web_services/config-web-rss-desc.png" /></a></li>
<li>Click the <strong>Save Configuration</strong> button at the bottom of the screen to save the changes. You can see the description on your RSS feed page.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Configuration/web_services/rss-desc.png"><img  alt="rss-desc" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Configuration/web_services/rss-desc.png" /></a></li>
</ol>
<p>You have now successfully edited the RSS Feed description in Drupal 7.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 2: How to Edit the RSS description in Drupal 7</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 1: <a href='/support/edu/drupal-7/configure-rss-feeds/intro-to-rss'>Introduction to RSS Feeds in Drupal 7</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/drupal-7/configure-rss-feeds/edit-rss-description&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/drupal-7/configure-rss-feeds/edit-rss-description'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yMjAmaWQ9MTU0NSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
