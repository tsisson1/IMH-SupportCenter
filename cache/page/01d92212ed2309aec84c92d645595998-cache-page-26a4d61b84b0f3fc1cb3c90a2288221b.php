<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50384:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/wordpress/some-users-are-getting-redirected-to-inmotion-url" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello FargonIndustries, I was able to recreate the issue with the redirect and I realized it was an error on the server with DNS and I went ahead and fi..." />
  <title>Some users are getting redirected to inMotion url | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/wordpress/some-users-are-getting-redirected-to-inmotion-url" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:6f631933cc3e3622d5556048c08f568b -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '123.125.71.54']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Some users are getting redirected to inMotion url</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/FargonIndustries'>FargonIndustries</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-09-01 9:08 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>34</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>* I can't recreate issue but some users when they access fargonindustries.com they receive a page that says &quot;In motion Hosting&quot; with the logo and the IP address and can't view any of the website. Anyone have this issue before? </div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_8017' id='upvote_answer_8017' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='8017' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_8017').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_8017' id='downvote_answer_8017' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='8017' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_8017').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>9,548 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2015-09-01 9:19 am EST
                		        </div>
					
		                </div>

				Hello FargonIndustries,<br />
<br />
I was able to recreate the issue with the redirect and I realized it was an error on the server with DNS and I went ahead and fixed it as it should have been affecting other customers as well. Please allow 4-24 hours for the DNS to be fixed world wide. <br />
<br />
Best Regards,<br />
TJ Edens
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_8017').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_8017' id='form_comment_on_answer_8017' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/wordpress/some-users-are-getting-redirected-to-inmotion-url&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/wordpress/some-users-are-getting-redirected-to-inmotion-url'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="878d4d16c6c6c4ec83bffd18a0dd98c0" value="1" />	</div>
	</form>
<!-- <br />
