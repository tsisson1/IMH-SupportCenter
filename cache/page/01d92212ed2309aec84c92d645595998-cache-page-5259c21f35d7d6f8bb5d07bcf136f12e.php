...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/website/where-do-i-find-my-whm-password" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hi acavella, Thanks for posting your question. I'm glad to see (based on your update) that you were able to resolve your issues! For others that find th..." />
  <title>Where do I find my WHM password? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/website/where-do-i-find-my-whm-password" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:0e6ce233d02020fd8842f7a858557e9b -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '156.196.69.243']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Where do I find my WHM password?</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/acavella'>acavella</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-01-21 10:25 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>9,713</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I just started using my new VPS account.  However, I am unable to log in to my WHM or cPanel accounts.  I do not know the passwords.<br />
<br />
In my AMP home it shows my username as: droidr5  However, my password showns that it is hidden for security reasons and it is obviously not the same as my AMP password.  Please forward these to me.  <br />
<br />
Edit: Nevermind I have found the reset password option.</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_440' id='upvote_answer_440' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='440' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_440').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_440' id='downvote_answer_440' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='440' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_440').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hi acavella,<br />
<br />
Thanks for posting your question. I'm glad to see (based on your update) that you were able to resolve your issues!<br />
<br />
For others that find this question, your WHM password is the same as your <a href='http://www.inmotionhosting.com/support/website/cpanel/resetting-cpanel-password-amp' target='_blank'>cPanel password</a>.<br />
<br />
Because you have <a href='http://www.inmotionhosting.com/vps_hosting.html' target='_blank'>vps hosting</a>, if you haven't already, we would highly recommend checking out our <a href='http://www.inmotionhosting.com/support/edu/whm' target='_blank'>Web Host Manager Education Channel</a>.<br />
<br />
...
Tim S
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_440').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_440' id='form_comment_on_answer_440' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/website/where-do-i-find-my-whm-password&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/website/where-do-i-find-my-whm-password'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="0f8601c7248880009b6591cf78ebfa91" value="1" />	</div>
	</form>
<!-- <br />
