<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:72402:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/drupal-7/how-can-i-enable-http-secure-https-for-a-drupal-7-site-i-am-working-on" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Jeremy_steel, Thanks for the question! Yes, you can use a shared SSL certificate. The Shared SSL certificate is preset, so there is no configurati..." />
  <title>How can I enable HTTP Secure (HTTPS) for a Drupal 7 site I am working on? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/drupal-7/how-can-i-enable-http-secure-https-for-a-drupal-7-site-i-am-working-on" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:f17d6a756383fb84f0f60c34306f1894 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-20']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '41.219.16.178']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>How can I enable HTTP Secure (HTTPS) for a Drupal 7 site I am working on?</h1>
		<div style='margin-bottom:20px; margin-top:10px; clear:both; color:#6e6e6e;'>Category: <a href='/support/community-support/drupal-7'>Drupal 7</a></div>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/jeremy_steel'>jeremy_steel</a>
			<div>25 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-07-23 6:26 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>18,202</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I am working on a Drupal 7 site that has some basic e-commerce functionality. I want to enable the entire site to be HTTPS. The plan is Business Class Hosting Launch. I have read how to obtain a shared SSL certificate. However Drupal instructions mention &quot;configuring the server&quot; and apparently the hosting company does this. <br />
<br />
Can you advise me what I need to?<br />
<br />
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_3598' id='upvote_answer_3598' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='3598' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_3598').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_3598' id='downvote_answer_3598' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='3598' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_3598').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Jeremy_steel,<br />
<br />
Thanks for the question!  Yes, you can use a shared SSL certificate. The Shared SSL certificate is preset, so there is no configuration done on the server side.  Please review our article on <a href="http://www.inmotionhosting.com/support/website/ssl/how-does-the-shared-ssl-work" target="new">Shared SSLs</a> in order to determine the URL that you would use for your site.  Note that a shared SSL is NOT the same URL as the URL that you have setup for your site initially.  So, you may need to also set a base URL setting in the settings.php file of your Drupal installation.  I found the following instructions with someone who had also asked the same thing in forums online:<br />
<br />
<ol><br />
<li>Determine your shared SSL (as per the article above)</li><br />
<li>Once you know your Shared SSL URL, you will need to determine your Drupal installation directory as it applies to the shared SSL.  For example:  If your ssl path is https://bizXXX.inmotionhosting.com/~username, and you installed your Drupal site in a folder called 'Drupal', then your path would be https://bizXXX.inmotionhosting.com/~username/Drupal.   If you installed your site to the default directory (public_html), then you would not need to change the shared SSL path - it would remain https://bizXXX.inmotionhosting.com/~username.  </li><br />
<li>Edit the <em>settings.php</em> file in your sites/default folder</li><br />
<li>Follow the directions to allow Drupal to use SSL (<a href="https://drupal.org/https-information" rel="nofollow" target="new">Drupal HTTPS information</a></li><br />
<li>Add the following line (there should be an example of it in the file already):  $base_url="https://bizXXX.inmotionhosting.com/~username/...)</li><br />
</ol><br />
<strong><em>NOTE: Make sure to use the correct shared SSL path - the URL I used in the steps above is simply an example and not the actual path.</em></strong><br />
<br />
...
<br />
I hope this helps to answer your question!  If you require any further assistance, please let us know.<br />
<br />
Regards,<br />
Arnel C.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_3598').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_3598' id='form_comment_on_answer_3598' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hi Arnel,<br />
<br />
thanks for you help. I have worked through the instructions you provided.<br />
<br />
1. I worked out the URL for the shared SSL from InMotion Hosting guide (going from &quot;http://bizXXX.inmotionhosting.com/~my_user_name&quot; to &quot;https://secureXXX.inmotionhosting.com/~my_user_name&quot;. <br />
<br />
2. I installed my site to the default directory (public_html) and so the SSL shared directory is &quot;https://bizXXX.inmotionhosting.com/~my_user_name&quot;.<br />
<br />
I then configured Drupal 7 to run clean URLs. What happened was the shared SSL url only works for the homepage. All other pages return an Error 404 message. The regular &quot;non-SSL&quot; pages still work with the clean urls.<br />
<br />
I checked documentation on one of the links you listed (https://drupal.org/https-information) and it says that <br />
<br />
&quot;If you enabled HTTPS and it only works on the homepage and your sub links are broken, it's because the VirtualHost:443 bucket needs AllowOverride All enabled so URL's can be rewritten while in HTTPS mode.&quot; <br />
<br />
I want to support both HTTP and HTTPS on my site and so I am thinking this latest problem is server configuration. Can you just confirm server configuration. If the server is configured to support mixed-mode HTTPS and HTTP sessions then it means the problem is at my end. By the way I am using Ubercart SSL module for the mixed-mode HTTPS and HTTP sessions.<br />
<br />
Again thanks for your help.</div>
							...
							<td style='width:96px;' valign='top'>
								...
								<div class='smallgrey'>
									<a href='/support/community-support/users/jeremy_steel'>jeremy_steel</a><br />
									25 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello jeremy_steel,<br />
<br />
Most, but not all settings for AllowOverride are available. We are happy to help, but we would need more information to provide a specific answer.<br />
<br />
What is the full error/issue you are experiencing?<br />
<br />
Do you have a link to the page where we can view this error?<br />
<br />
Also, in <a href="https://drupal.org/https-information" target="_blank" >this guide on the official Drupal site</a>, in the section titled <strong> Drupal Configuration</strong> it gives several options for mixed mode. Which method are you using?<br />
<br />
...
-John-Paul</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hi Jean-Paul,<br />
<br />
thanks for your reply.<br />
<br />
I guess the full error/issue is twofold:<br />
<br />
1. The broken links when using https I mentioned previously.<br />
<br />
2. When I configure Ubercart SSL (entering both &quot;Secure Domain Name&quot; and &quot;Non-Secure Domain Name&quot;), I receive the following alert:<br />
<br />
&quot;Ubercart SSL (uc_ssl): The uc_ssl_check() function is returning FALSE because it was unable to contact the SSL (https) version of your website that you defined in the settings. This can be caused by 3 things. 1. Your website is not setup properly for SSL, 2. The OpenSSL extension is not enabled on in your PHP installation, 3. allow_url_fopen is not enabled in php.ini. If #2 fails, uc_ssl will try to use file_get_contents() which requires allow_url_fopen to be set to TRUE in php.ini. Hopefully these hints will help you fix this issue so that you can use uc_ssl. You can try to debug this by going to https://secure139.inmotionhosting.com/~username//?uc_ssl_check=1<br />
CRITICAL ERROR! The domain you entered for the secured domain came back as non-secure or it does not point back to this installation of drupal. Your secure domain name MUST be setup and MUST be pointing at this install of drupal.&quot;<br />
<br />
<br />
For Drupal configuration I am using option 2 on the page you mention. It says:<br />
<br />
&quot;For even better security, leave $conf['https'] at the default value (FALSE) and send all authenticated traffic through HTTPS and use HTTP for anonymous sessions. Once again contributed modules like 443 Session or Secure Login can help you here. Drupal 7 automatically enables the session.cookie_secure PHP configuration on HTTPS sites, which causes SSL-only secure session cookies to be issued to the browser.&quot;<br />
<br />
However instead of the modules &quot;443 Session1 or &quot;Secure Login&quot; I am using &quot;Ubercart SSL&quot;. <br />
<br />
It would be great for you guys to take a look at the actual site. I am using Ubercart and I am testing with Paypal sandbox. The e-commerce is working fine. However it is still being tested and so I don't want to make it public right now. Can I give you guys confidential access to the site? <br />
<br />
Again thanks for all the help.</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>My apologies for the mistake with your name John-Paul :( <br />
It has been a long long day trying to solve this problem...<br />
<br />
</div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello jeremy_steel,<br />
<br />
If your site is not live on our servers yet, the <a href="http://www.inmotionhosting.com/support/website/ssl/how-does-the-shared-ssl-work" target="_blank" >shared SSL</a> will not function successfully. Also, I would recommend trying one of the modules they list in the article "443 Session1 or "Secure Login" to see if you get a different affect.<br />
<br />
We would be happy to take a look, you can email your site information to <a href="mailto:docs@inmotionhosting.com">docs@inmotionhosting.com</a><br />
<br />
With the Subject: jeremy_steel<br />
<br />
Then, post a comment letting us know it has been sent here on this forum post.<br />
<br />
If you have any further questions, feel free to post them below.<br />
Thank you,<br />
<br />
-John-Paul</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hi John-Paul,<br />
<br />
the site is live on your servers. I sent an email with details.<br />
<br />
Thanks <br />
<br />
Jeremy</div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello jeremy_steel,<br />
<br />
I checked the file mentioned in the <a href="https://drupal.org/https-information" target="_blank" >Drupal Guide</a> (sites/default/settings.php) on enabling HTTPS, and it was not updated:<br />
<br />
The article states "If you want to support mixed-mode HTTPS and HTTP sessions open up sites/default/settings.php and add $conf['https'] = TRUE;"<br />
<br />
According to the tutorial you have to add this line to the file:<br />
$conf['https'] = TRUE;<br />
<br />
But since you are following option 2 of the guide, it says to set it to "False":<br />
"For even better security, leave $conf['https'] at the default value (FALSE) and send all authenticated traffic through HTTPS and use HTTP for anonymous sessions. Once again contributed modules like 443 Session or Secure Login can help you here. Drupal 7 automatically enables the session.cookie_secure PHP configuration on HTTPS sites, which causes SSL-only secure session cookies to be issued to the browser. "<br />
<br />
So you should <a href="http://www.inmotionhosting.com/support/website/how-to/how-to-edit-a-file" target="_blank" >edit the file</a>:<br />
<strong>sites/default/settings.php</strong><br />
<br />
Then add the line of code:<br />
<strong>$conf['https'] = FALSE;</strong><br />
<br />
Also make sure you are entering the correct secure address for your <a href="http://www.inmotionhosting.com/support/website/ssl/how-does-the-shared-ssl-work" target="_blank" >Shared SSL</a> in the <em>sites/default/settings.php</em>.<br />
<br />
I recommend following these steps, then letting us know if it works successfully, or you get a different error.<br />
<br />
If you have any further questions, feel free to post them below.<br />
Thank you,<br />
<br />
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hi John-Paul,<br />
<br />
previously I had modified settings.php as suggested but it made no difference, so I left it unchanged. I tried again today and still no solution. I also tried changing the RewriteBase settings in the  .htaccess file and $base_url in settngs.php but neither solved the problem.<br />
<br />
I can outline what I did yesterday:<br />
<br />
I began by sourcing the two recommended modules Secure Pages and 443 Session.<br />
<br />
<br />
Secure Pages<br />
After I installed Secure Pages module I tried to configure it but the &quot;Enable Secure Pages&quot; option is grayed out and says: &quot;To start using secure pages this setting must be enabled. This setting will only be able to changed when the web server has been configured for SSL.&quot; As far as I know the web server is configured for SSL and so I do not know what is going on here.<br />
<br />
443 Session<br />
I then sourced the 443 Session module but it hasn't been released for Drupal 7. It also says that for the type of site I am doing (mixed HTTP and HTTPS) it isn't recommended. It says:<br />
<br />
&quot;Since 443 Session module uses separate session cookies for HTTP/HTTPS this means that when a user navigates from an HTTP page to an HTTPS page any session data will appear to be lost. This makes this module unsuitable for running an e-commerce site where most pages are HTTP except for the checkout which is HTTPS. In this case the user's cart contents would appear to be lost when they go to checkout. For this scenario please see the Mixed Session module.&quot;<br />
<br />
I then sourced the Mixed Sessions module.<br />
<br />
Mixed Sessions Module<br />
There is no Drupal 7 version. It does reference Uber SSL though.<br />
<br />
I then sourced Uber SSL<br />
<br />
Uber SSL<br />
<br />
I installed Uber SSL but then encountered the problems I described previously. In the Uber SSL page it says:<br />
<br />
&quot;- Clean URLs must be enabled<br />
- SSL Certificate must be installed and working for your website<br />
- Ubercart is NOT required for this module btw, it can be used for pretty much anything u want. But its most common use is with ubercart so thats where it gets its name from.&quot;<br />
<br />
It also says:<br />
<br />
&quot;If you have an SSL Certificate and you want to secure your ubercart pages with that Cert then this is the module for you. Download this module, install, config it, and you'll be running with your cert in no time. This module does NOT help you get your certificate running!! If your website does NOT work with https by manually typing it in, then you need to get that working FIRST and then you can configure this module. You can install it before hand but you will not be able to configure it as it does test to see if SSL is actually working or not.&quot;<br />
<br />
So I enabled clean URLs but have the problem I mentioned with Uber SSL unable to contact the SSL (https) version of my website.<br />
<br />
For now the main problem seems to be Inmotions TEMP URL and clean URLs used in Drupal 7. I ran some tests this morning comparing the TEMP URL with the permanent URL  (disabling Uber SSL). Here are the results:<br />
<br />
TEMP URL<br />
Disable clean URLs in Drupal 7 and the site works for both http and https<br />
e.g.: <br />
http://bizXXX.inmotionhosting.com/~username/?q=about_us<br />
https://secureXXX.inmotionhosting.com/~username/?q=about_us<br />
<br />
Enable clean URLs in Drupal 7 and the site shows only the homepage for both http and https. Other pages produce Error 404.<br />
e.g.: <br />
&quot;http://bizXXX.inmotionhosting.com/~username/&quot; shows but &quot;http://bizXXX.inmotionhosting.com/~username/about_us&quot; produces Error 404. <br />
&quot;https://secureXXX.inmotionhosting.com/~username/&quot; shows but &quot;https://secureXXX.inmotionhosting.com/~username/about_us&quot; produces Error 404. <br />
<br />
<br />
PERMANENT URL<br />
Disable clean URLs in Drupal 7 and the site works for http (https not available using permanent URL with shared SSL)<br />
e.g.: <br />
http://mysite.com/?q=about_us<br />
<br />
Enable clean URLs in Drupal 7 and the site works for http (https not available using permanent URL with shared SSL)<br />
e.g.: <br />
http://mysite.com/about_us<br />
<br />
So there seems an issue with Drupal 7 clean URLs and Inmotions TEMP URL (which I have to use for the shared SSL).<br />
 <br />
I found another Drupal 7 user had this same problem (https://drupal.org/node/1734722) and solved it via server configuration (I mentioned this previously - changing &quot;AllowOverride None&quot; to &quot;AllowOverride All&quot; for https). Is it possible this is our solution since I have tried everything else?<br />
<br />
Again big thanks to all you guys for trying to help me solve this one.</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/drupal-7/how-can-i-enable-http-secure-https-for-a-drupal-7-site-i-am-working-on&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/drupal-7/how-can-i-enable-http-secure-https-for-a-drupal-7-site-i-am-working-on'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="edfa2271eda37888f6575a147a44f911" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
                                ...
                                <h3>Related Articles</h3><a target='_blank' href='http://inmotionhosting.com/support/find-version'>How to find your Drupal version number</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/312-flush-error-log'>312: How to flush your error logs in Drupal 7</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/311-fixing-the-an-unrecoverable-error-occurred-error-in-drupal'>311: Fixing the "An unrecoverable error occurred" error in Drupal</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/309-locate-db-name'>309: How to find your Drupal 7 database name</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/duplicate-drupal-test-site'>308: Making a duplicate Drupal test site</a><br/><br />
		</div>
