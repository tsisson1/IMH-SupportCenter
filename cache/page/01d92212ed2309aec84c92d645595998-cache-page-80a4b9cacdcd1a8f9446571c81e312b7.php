<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50589:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/moodle/changing-appearance-moodle" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="keywords" content="Moodle 2.3 comes 12 themes customize look site customizing appearance Moodle site change changing template" />
  <meta name="description" content="Moodle 2.3 comes with 12 different themes to customize the look of the Moodle site. These tutorials will explain how to customize the appearance of your Moodle site." />
  <title>107: Changing the Appearance of Moodle | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/moodle/changing-appearance-moodle" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:26e1d9c6141a9b219fb5132cee11c743 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '194.117.40.54']);
...
<div class='page-header'>
	<h1>107: Changing the Appearance of Moodle</h1>
</div>
<div class='section_listing'>
		<table>
	<tr><td colspan='3'><h2>Moodle Themes</h2><div>This section will discuss configuring Moodle themes.</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 1:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/changing-appearance-moodle/changing-default-theme'>Changing the default Standard theme in Moodle</a>
					<div>When installing and working with Moodle 2.3 for the first time, the default theme Formal white is set as the theme. This tutorial will explain how to change the default theme.</div>
					<div class='smallgrey'>Hits: 11,480</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/changing-appearance-moodle/change-logo-footer'>Changing the Logo and Footer in Moodle themes</a>
					<div>Another feature in Changing the Appearance of Moodle 2.3 themes is the ability to edit the footer and logo. This tutorial will explain how to update the Logo and Footer.</div>
					<div class='smallgrey'>Hits: 35,210</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/changing-appearance-moodle/add-logo-fusion-theme-code'>Adding a logo through the theme code in Moodle</a>
					<div>When a theme cannot have the logo changed through the Moodle dashboard, you will have to edit the theme code. This article explains how to add a logo to the header and footer of the Fusion theme.</div>
					<div class='smallgrey'>Hits: 10,056</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/changing-appearance-moodle/manual-theme-install'>Manually installing a theme for Moodle 2.3</a>
					<div>Moodle 2.3 themes can be installed manually. In this article, we will manually install a theme for Moodle 2.3.</div>
					<div class='smallgrey'>Hits: 6,165</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/changing-appearance-moodle/removing-branded-logo'>Removing the branded Moodle image from a theme footer</a>
					<div>In most Moodle 2.3 themes, the Moodle branded logo is shown at the bottom of each page. This article will explain how to remove the branded Moodle link at the bottom of a theme.</div>
					<div class='smallgrey'>Hits: 20,258</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/changing-appearance-moodle/change-theme-font'>Changing the default font in the Moodle Standard theme</a>
					<div>In Moodle 2.3, the default font for themes can be changed to a more palatable font type. This article will explain how to change the Standard theme font.</div>
					<div class='smallgrey'>Hits: 10,052</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/changing-appearance-moodle/purge-clear-cache'>Clearing or Purging the cache from Moodle 2.3</a>
					<div>When working in Moodle 2.3, there comes a time when the cache will need to be cleared from the server. This Article will detail how to clear the cache from your Moodle site.</div>
					<div class='smallgrey'>Hits: 11,757</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/changing-appearance-moodle/customize-front-page'>Customizing the Moodle Frontpage Appearance</a>
					<div>By default, Moodle 2.3  will show courses and categories on the Front page. This tutorial will explain how to customize the Frontpage in Moodle 2.3.</div>
					<div class='smallgrey'>Hits: 17,524</div>
				</td>
			</tr>
		<tr><td colspan='3' style='padding-top:20px;'><h2>Moodle Blocks</h2><div>Blocks are great for making Moodle user friendly to navigate. This section will explain Blocks.</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 9:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/changing-appearance-moodle/blocks-overview'>Moodle Blocks Overview</a>
					<div>Moodle 2.3 has the option to create different navigation functionality using the Moodle Blocks feature. This article will discuss an overview of Moodle Blocks.</div>
					<div class='smallgrey'>Hits: 2,372</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/changing-appearance-moodle/calendar-appearance'>Changing the Appearance of the Calendar in Moodle</a>
					<div>After learning how to Change the default theme in Moodle 2.3, the administrator may want to customize the appearance of the calendar. This article will explain the Appearance settings for the calendar in Moodle 2.3.</div>
					<div class='smallgrey'>Hits: 2,832</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/changing-appearance-moodle/edit-navigation-block'>Configuring the Navigation block in Moodle</a>
					<div>In Moodle 2.3, the navigation block can be configured to the administrators specifications. This tutorial will go over the Navigation block configuration.</div>
					<div class='smallgrey'>Hits: 11,201</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/changing-appearance-moodle/add-delete-blocks'>Adding and Deleting blocks from the Moodle sidebar</a>
					<div>Moodle 2.3 has the ability to add blocks and remove blocks from the sidebar navigation. This tutorial will explain how to add and delete blocks from the Moodle sidebar.</div>
					<div class='smallgrey'>Hits: 4,937</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/changing-appearance-moodle/comments-block'>Comments block configuration in Moodle</a>
					<div>The Moodle 2.3 Comments block is a handy way of allowing comments in a course within the sidebar navigation. This article explains the Comments block.</div>
					<div class='smallgrey'>Hits: 1,814</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/changing-appearance-moodle/managing-blocks'>Managing Blocks within Moodle 2.3</a>
					<div>When adding blocks through out a Moodle 2.3 site, occasionally a block may need to be removed completely through out the entire site. This tutorial will show how to delete a block from the Moodle site.</div>
					<div class='smallgrey'>Hits: 2,321</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/moodle/changing-appearance-moodle/changing-the-default-my-moodle-page'>Changing the Default My Moodle page</a>
					<div>To customize the students home page you will need to edit the Default My Moodle page. This article will show you how.</div>
					<div class='smallgrey'>Hits: 7,643</div>
				</td>
			</tr>
			</table>
</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yOTQmaWQ9Mjk0JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="0787292c8adfba07be9cb4b336c047bc" value="1" />	</div>
	</form>
<!-- <br />
