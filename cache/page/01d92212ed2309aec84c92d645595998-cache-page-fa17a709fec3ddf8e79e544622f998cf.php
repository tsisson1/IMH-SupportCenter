<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:75543:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/wordpress-themes/importing-theme-data-into-the-cherry-framework" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-02-14T15:23:52-08:00" />
  <meta name="author" content="Jeff Matson" />
  <meta name="description" content="InMotion Hosting Support Center" />
  <title>Importing theme data into the Cherry Framework - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/wordpress-themes/importing-theme-data-into-the-cherry-framework" rel="canonical" />
...
<script>
  ...
  ga('send', 'pageview');
	...
	<!-- cid:938956d71978821eb533f34a76ede9ad -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Importing theme data into the Cherry Framework									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>4,605</span></div>
							...
							<div style='clear:both;'></div>
								...
								<p>In this article, we will teach you how to import sample data into the Cherry Framework.  This is especially useful if you have purchased a theme that uses the Cherry Framework such as one purchased from Template Monster.</p>
<ol class="article_list">
  <li><p>First, you will need to <a href="http://www.inmotionhosting.com/support/edu/wordpress/wordpress-introduction/logging-into-wordpress-dashboard">log into your Wordpress dashboard</a>.</p></li>
    <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-themes/cherryframework/cherry-import-data-1.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-themes/cherryframework/cherry-import-data-1.png"  style='float:right; margin:0px 0px 15px 15px;'></a><p>Next, click on <em>Cherry Options</em>, then <em>Import</em>.</p></li>
    <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-themes/cherryframework/cherry-import-data-2.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-themes/cherryframework/cherry-import-data-2.png"  style='float:right; margin:0px 0px 15px 15px;'></a><p>You should now be within the import screen on the first step.  To complete this first step,clock the <em>Browse</em> button and locate the XML file that was provided by your theme.  For example, in Template Monster themes, it will be located within a folder labeled sample_data.  Select it and click <em>Upload and Import</em>.</p></li>
    <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-themes/cherryframework/cherry-import-data-3.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-themes/cherryframework/cherry-import-data-3.png"  style='float:right; margin:0px 0px 15px 15px;'></a><p>After you have imported your sample data, you will then need to select the author for the data that you have imported.  In this case, I only have one user which is my admin user so I will set that as the user.</p></li>
    <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-themes/cherryframework/cherry-import-data-4.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-themes/cherryframework/cherry-import-data-4.png"  style='float:right; margin:0px 0px 15px 15px;'></a><p>Next, the Cherry Framework will ask you to import your Widget settings.  As many themes heavily rely on widgets such as almost all of them made by Template Monster, you will need to import your widget settings here as well.  This file is typically labeled widgets.json and would be located in the same folder that you located your sample data.  Browse to it and import that json file as well.</p></li>
    <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-themes/cherryframework/cherry-import-data-5.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-themes/cherryframework/cherry-import-data-5.png"  style='float:right; margin:0px 0px 15px 15px;'></a><p>Now you will need to select what data you want to be imported from the widgets file.  In most cases, you will want to leave all of these boxes checked and your theme may rely on them.</p></li>
    <li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-themes/cherryframework/cherry-import-data-6.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-themes/cherryframework/cherry-import-data-6.png"  style='float:right; margin:0px 0px 15px 15px;'></a><p>On the final step, you will be taken to your permalink settings.  In this case, it has deirected me to set your category and postname as the structure which is most common and is a good practice for most sites.  Save your settings and you will everything will be complete.</p></li>
    <div style='clear:both;'></div>
    </ol>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress-themes/cherryframework/cherry-import-data-7.png"><img src="//cdn.inmotionhosting.com/support/images/stories/wordpress-themes/cherryframework/cherry-import-data-7.png"  style='float:right; margin:0px 0px 15px 15px;'></a><p>If you followed these steps, your theme data for your theme that uses the Cherry Framework should now be fully imported and the process will be complete.</p>
<div style='clear:both;'></div> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/wordpress-themes/importing-theme-data-into-the-cherry-framework&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/wordpress-themes/importing-theme-data-into-the-cherry-framework'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NzYmaWQ9Mjk2NSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="ba6ed5d6020e114a64683d5381da6c18" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/dead2445ef2f6fc087263eb44ea4f16e?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/dead2445ef2f6fc087263eb44ea4f16e'>vahid</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-19 5:53 am</div>
				                <div><p>hi dear!</p>
<p>how can import parent theme(cherryframework) or child theme(interior_woocommerce) data sample.xml from cpanel on theme???</p>
<p>i have problems :(</p>
<p>when i go in cherry content import say:</p>
<h3 style="color: #222222; font-size: 1.3em; margin: 1em 0px; font-family: Tahoma, Arial, sans-serif;">Caution!</h3>
<h4 class="title" style="font-size: 13px; margin: 1.33em 0px; color: #444444; font-family: Tahoma, Arial, sans-serif; line-height: 13px;">Some of your server settings do not meet the requirements for installing the sample data. Please, consult with your hosting provider on how to increase the required values</h4>


Server SettingsCurrentRequired
...
<div id="area-drag-drop" class="pointer_events" style="outline: 0px; pointer-events: none;">
<div class="drag-drop-inside" style="outline: 0px; text-align: center; overflow: hidden; padding: 150px 0px;">
<p class="drag-drop-info" style="font-size: 20px; line-height: 1.5; margin: 5px 0px; color: #aaaaaa;">&nbsp;to import sample data</p>
<p style="font-size: 20px; line-height: 1.5; margin: 5px 0px; color: #aaaaaa;">or</p>
<p class="drag-drop-buttons" style="font-size: 20px; line-height: 1.5; margin: 5px 0px; color: #aaaaaa;">&nbsp;</p>
<p class="max-upload-size" style="font-size: 12px; line-height: 1.5; margin: 10px 0px 25px; color: #2c89ae;">Maximum upload file size: 8 MB.</p>
<p id="import-demo-video" style="font-size: inherit; line-height: inherit; margin: 5px 0px; color: #aaaaaa;"><a class="thickbox" style="color: #0074a2; transition: border 0.05s ease-in-out, background, color; -webkit-transition: border 0.05s ease-in-out, background, color; outline: 0px; text-decoration: none; font-size: 12px;" title="Files Import demo" href="http://www.netbaar.com/wp-admin/admin.php?page=import-page&amp;import=true#TB_inline?width=600&amp;height=505&amp;inlineId=help_import">View Demo </a></p>
</div>
</div>

<div id="import_step_2" style="outline: 0px; margin-top: -476px; position: relative; z-index: 1; color: #444444; font-family: Tahoma, Arial, sans-serif; font-size: 13px; line-height: 13px;">
<div id="import_xml_status" style="outline: 0px; min-height: 480px; overflow: auto; padding: 10px 20px; border: 1px solid #e5e5e5; -webkit-box-shadow: rgba(0, 0, 0, 0.0392157) 0px 1px 1px; box-shadow: rgba(0, 0, 0, 0.0392157) 0px 1px 1px; box-sizing: border-box; background-image: initial; background-attachment: initial; background-size: initial; background-origin: initial; background-clip: initial; background-position: initial; background-repeat: initial;">
<div id="status_log" style="outline: 0px;">
<p class="done_import" style="font-size: 14px; line-height: 1.5; margin: 10px 0px; color: #4bbd00;">Installing content started.</p>
<p class="error_import" style="font-size: 14px; line-height: 1.5; margin: 10px 0px; color: #f50000;">Importing XML &nbsp; &nbsp; X</p>
<p class="error_import" style="font-size: 14px; line-height: 1.5; margin: 10px 0px; color: #f50000;">Installing content error &nbsp; &nbsp;!</p>
<p class="error_import" style="font-size: 14px; line-height: 1.5; margin: 10px 0px; color: #f50000;">&nbsp;</p>
<p class="error_import" style="font-size: 14px; line-height: 1.5; margin: 10px 0px; color: #f50000;">please help me!</p>
<p class="error_import" style="font-size: 14px; line-height: 1.5; margin: 10px 0px; color: #f50000;">thanks</p>
</div>
</div>
</div></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19675);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-19 10:30 am</div>
				                <div>Hello Vahid,<br />
<br />
Thanks for the question.  By default, many of the values in the php.ini file are set to their minimum or to the optimum for a hosting account (if you're an InMotion Hosting customer).  You can modify the <b>php.ini</b> file to get you by this message.  I would suggest that you review<a href="http://www.inmotionhosting.com/support/website/php/increase-the-max-file-upload-size-in-php-ini">this article</a>.  Even though it's about the max upload size, it talks about modifying the php.ini file.  You simply need to look for the <i>max input time</i> and increase so that you can import the sample data.   Once you have completed the import, you can reduce the time again to keep your settings set to the server default. <br />
<br />
I hope this helps to answer your question, please let us know if you require any further  assistance.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19692);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-24120'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/99ebb977cbf3decabf89994af32bada5?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/99ebb977cbf3decabf89994af32bada5'>Rodel</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-11 4:18 am</div>
				                <div><p>Hi, whenever I import a sample data, it gives me an error on "Importing Tags". Why is that?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24120);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-11 9:33 am</div>
				                <div>Hello Rodel,<br />
<br />
Thank you for contacting us. I looked into this, and was not able to find a solution via google search. We are happy to help, but will need some additional information. <br />
<br />
What theme are you using?<br />
<br />
Have you contacted your theme developer for a workaround, or possible solution?<br />
<br />
What sample data are you using?<br />
<br />
Please include any additional information that will help us troubleshoot the issue.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24129);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-24446'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/940f0139f5512c481b34d445e8d51858?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/940f0139f5512c481b34d445e8d51858'>Shailesh</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-25 12:26 pm</div>
				                <div><p>Increasing the max_input_time in php.ini resolved the "installing content error" message for me.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24446);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
