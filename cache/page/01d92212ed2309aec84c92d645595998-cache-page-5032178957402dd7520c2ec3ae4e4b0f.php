...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/ssh/navigate-command-line" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-04-21T23:23:06-07:00" />
  <meta name="keywords" content="ls list directory contents pwd print working cd change navigate linux command line" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="After logging into your server via ssh, you'll next need to learn how to navigate through your folders and files." />
  <title>Navigate command line structure in SSH - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/ssh/navigate-command-line" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:bbb0a60b8339eeba2942d2965ec49cc1 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '95.97.64.17']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Navigate command line structure in SSH									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>26,483</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Dec 5, 2011'><span style='color:#606060;'>Published:</span> Apr 21, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In our previous article, we showed you <a href="/support/website/general-server-setup/how-to-login-ssh">how to login to your server via SSH</a>. If you're following along our tutorial, the next item to learn is how to navigate around the file system. This is the same whether you are using a <a href="http://www.inmotionhosting.com/business-hosting">shared</a>, <a href="http://www.inmotionhosting.com/vps-hosting">VPS</a>, or <a href="http://www.inmotionhosting.com/dedicated-servers">Dedicated</a> account.</p>
<p><strong>In the tutorial below, we are using the following account:</strong><br /><strong>domain:</strong> <em>example.com</em><br /><strong>cPanel username:</strong> <em>user5</em></p>
<h2>What directory am I working in?</h2>
<p>When you first log in via SSH, you will be placed in your home folder. For our user, it is <strong>/home/user5</strong>. Further on in this page, you'll change directories. If you ever need to determine which directory you are currently in, use the <strong>pwd</strong> command. The <a href="/support/website/linux/pwd-command">pwd command</a> will print the working directory:</p>
<p class="cli"><em>user5@example.com [~]</em># <strong>pwd</strong><br />/home/user5</p>
<h2>What is in this directory?</h2>
<p>Now that you know which directory you are in, you may want to know what files and folders and in this directory. You can use the <a href="/support/website/linux/ls-command"><strong>ls</strong> command</a> to list the directory contents:</p>
<p class="cli"><em>user5@example.com [~]#</em> <strong>ls</strong><br />./&nbsp; ../&nbsp; .bash_logout&nbsp; .bash_profile&nbsp; .bashrc&nbsp; .contactemail&nbsp; .dns&nbsp; .gemrc&nbsp; .htpasswds/&nbsp; etc/&nbsp; mail/&nbsp; perl5/&nbsp; public_ftp/&nbsp; public_html/&nbsp; tmp/&nbsp; www@</p>
<p><br />The results above are simply a listing of files and folders in your current account. Many times you'll need more information than this. For example, you may need to see file sizes or permissions. You can add the <strong>-alh</strong> flags to:</p>
<ul>
...
<p class="cli"><em>user5@example.com [~]#</em> <strong>ls -alh</strong><br />total 60K<br />drwx--x--x&nbsp;&nbsp; 9 user5 user5&nbsp; 4.0K Dec&nbsp; 5 11:23 ./<br />drwx--x--x&nbsp; 36 root&nbsp; root&nbsp;&nbsp; 4.0K Dec&nbsp; 5 11:15 ../<br />-rw-r--r--&nbsp;&nbsp; 1 user5 user5&nbsp;&nbsp;&nbsp; 24 Dec&nbsp; 5 11:15 .bash_logout<br />-rw-r--r--&nbsp;&nbsp; 1 user5 user5&nbsp;&nbsp; 191 Dec&nbsp; 5 11:15 .bash_profile<br />-rw-r--r--&nbsp;&nbsp; 1 user5 user5&nbsp;&nbsp; 124 Dec&nbsp; 5 11:15 .bashrc<br />-rw-------&nbsp;&nbsp; 1 user5 user5&nbsp;&nbsp;&nbsp; 18 Dec&nbsp; 5 11:15 .contactemail<br />-rw-r--r--&nbsp;&nbsp; 1 user5 user5&nbsp;&nbsp;&nbsp; 20 Dec&nbsp; 5 12:27 .dns<br />-rw-r--r--&nbsp;&nbsp; 1 user5 user5&nbsp;&nbsp; 147 Dec&nbsp; 5 11:15 .gemrc<br />drwxr-x---&nbsp;&nbsp; 2 user5 nobody 4.0K Dec&nbsp; 5 11:15 .htpasswds/<br />drwxr-x---&nbsp;&nbsp; 2 user5 mail&nbsp;&nbsp; 4.0K Dec&nbsp; 5 11:15 etc/<br />drwxr-x---&nbsp;&nbsp; 8 user5 user5&nbsp; 4.0K Dec&nbsp; 5 11:15 mail/<br />drwxr-xr-x&nbsp;&nbsp; 2 user5 user5&nbsp; 4.0K Dec&nbsp; 5 11:23 perl5/<br />drwxr-xr-x&nbsp;&nbsp; 3 user5 user5&nbsp; 4.0K Dec&nbsp; 5 11:15 public_ftp/<br />drwxr-x---&nbsp;&nbsp; 3 user5 nobody 4.0K Dec&nbsp; 5 11:15 public_html/<br />drwxr-xr-x&nbsp;&nbsp; 2 user5 user5&nbsp; 4.0K Dec&nbsp; 5 11:15 tmp/<br />lrwxrwxrwx&nbsp;&nbsp; 1 user5 user5&nbsp;&nbsp;&nbsp; 11 Dec&nbsp; 5 11:15 www -&gt; public_html/</p>
<p> </p>
<h2>How can I navigate to another directory?</h2>
...
<p class="cli"><em>user5@example.com [~]#</em> <strong>cd public_html/</strong></p>
<p>To confirm you are in this directory, you can use pwd to print the directory you are currently in:</p>
<p class="cli"><em>user5@example.com [~/public_html]#</em> <strong>pwd</strong><br />/home/user5/public_html</p>
<h2>How can I go back one directory?</h2>
<p>We were previously at /home/user5 and we changed to our /home/user5/public_html folder. If we want to go up one level, i.e back to our /home/user5 folder, you can use <strong>cd ..</strong></p>
<p class="cli">user5@example.com [~/public_html]# <strong>cd ..</strong></p>
<p>We can confirm where we're at by printing the directory we're currently in:</p>
<p class="cli"><em>user5@example.com [~]#</em> <strong>pwd</strong><br />/home/user5</p>
<P>Learn more about <a href="http://www.inmotionhosting.com/ssh-hosting">SSH Hosting</a></p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/ssh/navigate-command-line&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/ssh/navigate-command-line'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MTEmaWQ9MzIxJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="12421f9f21eb781927581ecf96ab886d" value="1" />	</div>
	</form>
<!-- <br />
