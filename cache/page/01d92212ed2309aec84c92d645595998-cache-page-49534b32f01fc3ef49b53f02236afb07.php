<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:61962:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/dokuwiki/change-dokuwiki-appearance/change-dokuwiki-logo" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-01-15T20:19:37-08:00" />
  <meta name="keywords" content="cPanel File manager change changing upload uploading logo DokuWiki Media Manager Doku Wiki [gs]" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="This article explains how to change the logo in DokuWiki through cPanel File manager and DokuWiki Media Manager." />
  <title>How to change the DokuWiki logo - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/dokuwiki/change-dokuwiki-appearance/change-dokuwiki-logo" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:a2475d0403f723e3f8ad7b461924a890 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '194.153.130.248']);
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/dokuwiki' itemprop='url'><span itemprop='title'>Dokuwiki<span></a><div class='dropdown_4columns'><h2>Dokuwiki Education Channel</h2><div class='col_2'><h3>100 Level Classes</h3><div><a href='/support/edu/dokuwiki/geting-started-dokuwiki'>101: Getting Started with Dokuwiki</a></div><div><a href='/support/edu/dokuwiki/writing-content-dokuwiki'>102: Writing content for DokuWiki</a></div><div><a href='/support/edu/dokuwiki/change-dokuwiki-appearance'>103: Changing the DokuWiki Appearance</a></div><div><a href='/support/edu/dokuwiki/add-contact-form-dokuwiki'>104: Adding a contact form in DokuWiki</a></div><div><a href='/support/edu/dokuwiki/install-configure-plugins-doku'>105: Installing and Configuring plugins in DokuWiki</a></div></div><div class='col_2'><h3>200 Level Classes</h3><div><a href='/support/edu/dokuwiki/working-with-menus'>201: Working with menus in DokuWiki</a></div><div><a href='/support/edu/dokuwiki/change-language-doku-wiki'>202: Changing the language in DokuWiki</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/dokuwiki/change-dokuwiki-appearance' itemprop='url'><span itemprop='title'>103: Changing the DokuWiki Appearance<span></a><div class='dropdown_3columns'><h2> Changing the DokuWiki Appearance</h2><div class='col_3'><div>1. <a style='display:inline;' href='/support/edu/dokuwiki/change-dokuwiki-appearance/site-title-url-license-basic-settings'>DokuWiki Basic Settings: Site title, Site URL, and License</a></div><div>2. <a style='display:inline;' href='/support/edu/dokuwiki/change-dokuwiki-appearance/change-template-dokuwiki'>Changing the DokuWiki template</a></div><div>3. <a style='display:inline;' href='/support/edu/dokuwiki/change-dokuwiki-appearance/change-dokuwiki-logo'>How to change the DokuWiki logo</a></div><div>4. <a style='display:inline;' href='/support/edu/dokuwiki/change-dokuwiki-appearance/removing-footer-buttons-text'>Removing the DokuWiki footer buttons and text</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to change the DokuWiki l...</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to change the DokuWiki logo									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>29,008</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Dec 27, 2012'><span style='color:#606060;'>Published:</span> Jan 15, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Changing the logo in DokuWiki can be done in two ways. The logo can be uploaded to the server directly through the cPanel File manager; or, the logo can be uploaded through the <strong>Media Manager</strong> through DokuWiki interface. This article will explain how to upload the logo through cPanel File manager and DokuWiki Media Manager.</p>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/change-logo/change-logo-1-default-logo.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="Default DokuWiki logo" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/change-logo/change-logo-1-default-logo.gif" title="Click here to view the larger image" width="100" /></a>The default logo size that DokuWiki uses for the wiki logo is 64px x 64px. To make sure the image is the correct format, make sure the file type is .png and that your logo is the same dimensions of the wiki logo. Logos that are sized differently than the original one may distort and look unappealing. The default DokuWiki logo is shown in the snapshot to the right.<br style="clear: both;" /></p>
<h2>Changing the logo through the Media Manager</h2>
<p>Through the Media Manager, the logo can be uploaded to the wiki images on the server. DokuWiki stores the logo in the <strong>wiki:logo.png</strong> location (This will be explained on step 3). The logo will automatically replace the default DokuWiki logo. The following steps will explain how to upload your custom logo to the server through the Media Manager.</p>
<ol class="article_list">
<li><a target="_blank" href="/support/edu/dokuwiki/geting-started-dokuwiki/login-dokuwiki" title="Click for more information">Log into your DokuWiki as admin</a></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/change-logo/change-logo-5-media-manager.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Click the Medis Manager in DokuWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/change-logo/change-logo-5-media-manager.gif" title="Click here to view the larger image" width="100" /></a><strong>Click the Media Manager</strong> link at the top right side. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/change-logo/change-logo-6-wiki.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Media Manager location for log is wiki:logo.png" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/change-logo/change-logo-6-wiki.gif" title="Click here to view the larger image" width="100" /></a>Under [root], <strong>Click the wiki link on the left</strong> to load the wiki images. This is where the <strong>wiki:logo.png</strong> is stored.<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/change-logo/change-logo-7-upload.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Upload custom logo in DokuWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/change-logo/change-logo-7-upload.gif" title="Click here to view the larger image" width="100" /></a><strong>Select the Upload tab</strong>. Click the upload button to <strong>upload your new logo</strong>.
<p class="alert"><strong>Important!</strong> Y<strong>our logo must be named logo.png</strong> for the logo to display on your DokuWiki site.<br style="clear: both;" /></p>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/change-logo/change-logo-8-image-list.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="List of images in the Media Manager" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/change-logo/change-logo-8-image-list.gif" title="Click here to view the larger image" width="100" /></a>You should see the logo in the list of images on the Media Manager wiki page.<br style="clear: both;" /></p>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/change-logo/change-logo-9-custom.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="DokuWiki custom logo" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/change-logo/change-logo-9-custom.gif" title="Click here to view the larger image" width="100" /></a><a target="_blank" title="Click here for more info" href="/support/website/how-to/clear-browser-cache"><strong>Clear your browser cache</strong></a></p>
<p><strong>Visit your wiki homepage</strong>. The logo should automatically load and display on your wiki site similar to the image at the right.</p>
<br style="clear: both;" /></li>
</ol>
<h2>Uploading the logo through File Manager</h2>
<p>In the event you cannot upload through the Media Manager, you can directly upload the image to the server. The following will explain the steps in uploading your logo through the File Manager.</p>
<ol class="article_list">
<li><a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel" target="_blank" title="Click here for info"><strong>Login into your cPanel</strong></a>.</li>
<li><a href="/support/edu/cpanel/cpanel-file-manager/using-file-manager-in-cpanel" target="_blank" title="Click here for info"><strong>Go to the File Manager</strong></a>. Select the web root (public_html/www) directory and <strong>click Go</strong>.</li>
<li><strong>Navigate to your wiki folder where your DokuWiki was installed</strong>. The location will be similar to the following path. (Change "<em>yourwiki</em>" in the path to your wiki location.)
<p style="margin-left: 20px;">public_html/yourwiki/lib/tpl/dokuwiki/images</p>
</li>
<li><strong>Download the logo.png image</strong> to your desktop.</li>
<li><strong>Open the logo.png in an image editor</strong> like Photoshop or <a href="/support/website/image-editing/installing-gimp-to-edit-images">Gimp</a>.</li>
<li><strong>Edit the image </strong>and add the graphics and text to the logo to suit your Wiki site.
<p><strong>Save the image</strong>.</p>
<p class="alert"><strong>Important!</strong> Your logo must be named logo.png for the logo to display on your DokuWiki site.</p>
<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/change-logo/change-logo-2-logo-old.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="Renaming the old logo" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/change-logo/change-logo-2-logo-old.gif" title="Click here to view the larger image" width="100" /></a><strong>Rename the logo.png file on the server to logo-old.png</strong>. See the image to the right.<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/change-logo/change-logo-3-png.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="View of both files in File Manager DokuWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/change-logo/change-logo-3-png.gif" title="Click here to view the larger image" width="100" /></a><a href="/support/website/file-management/how-to-upload-a-file-using-file-manager-in-cpanel"><strong>Upload your new logo</strong></a>. You should see both the logo-old.png and the loog.png in the files. See the snapshot to the right. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/change-logo/change-logo-4-new-logo.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="View of the new logo in DokuWiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/dokuwiki/102/change-logo/change-logo-4-new-logo.gif" title="Click here to view the larger image" width="100" /></a><a target="_blank" title="Click here for more info" href="/support/website/how-to/clear-browser-cache"><strong>Clear your browser cache</strong></a> and <strong>visit the home page</strong>.
<p>Now your DokuWiki site will display your new custom made logo.</p>
<br style="clear: both;" /></li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/dokuwiki/change-dokuwiki-appearance'>103: Changing the DokuWiki Appearance</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 3: How to change the DokuWiki logo</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 2: <a href='/support/edu/dokuwiki/change-dokuwiki-appearance/change-template-dokuwiki'>Changing the DokuWiki template</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 4: <a href='/support/edu/dokuwiki/change-dokuwiki-appearance/removing-footer-buttons-text'>Removing the DokuWiki footer buttons and text</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/dokuwiki/change-dokuwiki-appearance/change-dokuwiki-logo&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/dokuwiki/change-dokuwiki-appearance/change-dokuwiki-logo'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMjUmaWQ9MjExOCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="1872d6271ba070acaf360fff09b823ac" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/dokuwiki/change-dokuwiki-appearance?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Changing the DokuWiki Appearance</h3></a>
		<table><tr><td colspan='2'><h4>Basic Settings</h4></td></tr>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/dokuwiki/change-dokuwiki-appearance/site-title-url-license-basic-settings?tsrc=rsbedu'>DokuWiki Basic Settings: Site title, Site URL, and License</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/dokuwiki/change-dokuwiki-appearance/change-template-dokuwiki?tsrc=rsbedu'>Changing the DokuWiki template</a></td>
                </tr>
        <tr><td colspan='2'><h4>Header, Footer, and Logo</h4></td></tr>  <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/dokuwiki/change-dokuwiki-appearance/change-dokuwiki-logo?tsrc=rsbedu'>How to change the DokuWiki logo</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/dokuwiki/change-dokuwiki-appearance/removing-footer-buttons-text?tsrc=rsbedu'>Removing the DokuWiki footer buttons and text</a></td>
                </tr>
          	</table>
