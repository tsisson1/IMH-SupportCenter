<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:55080:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/phpbb/301-edit-registration-page" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-12-23T19:45:15-08:00" />
  <meta name="keywords" content="change text add phpBB terms registration new visitors members" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Need to change your terms of registration for new members? Learn how to change the text with this phpBB article." />
  <title>301: How to Modify the Registration Page Text in phpBB - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/phpbb/301-edit-registration-page" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:2f2e5a47d3821ad15cc979f4bdd95c2e -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															301: How to Modify the Registration Page Text in phpBB									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>8,017</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Feb 20, 2013'><span style='color:#606060;'>Published:</span> Dec 23, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>After <a href="/support/edu/phpbb/getting-started-phpbb/phpbb-softaculous-install">installing your phpbb</a> and getting your <a href="/support/edu/phpbb/manage-forums/add-new-forum">first basic forums</a> set up, it is time to begin customizing your site to be your own. While at first you may think of color schemes, logos, and themes, you may also want to consider the text on your site. The registration page gives your users the terms and conditions under which they are registering for the site. Although the standard text is very good, you may want to add your own conditions or flair. Below are the steps on how to make changes to your registration text in phpBB.</p>

<h2>Changing the Registration Page Text in phpBB3</h2>
<ol class="article_list">
<li>First, <a target="_blank" href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">log into your cPanel</a> dashboard</li>
<li>From the cpanel main page, find and <a target="_blank" href="/support/edu/cpanel/cpanel-file-manager/using-file-manager-in-cpanel">enter the <strong>File Manager</strong></a>.</li>
<li>From within the <em>File Manager</em>, you will need to locate your root folder for your phpBB application. Most often, this is the root folder for your domain, but if you have the phpbb appliation under a subfolder, be sure to click on that foler to enter it as well. In our case, our domain's root is at the <em>public_html/phpbb</em> folder.</li>
<li>Now that you are in the root folder for your phpBB site, locate and click on the <em>languages</em> folder, then click on the folder for the particular language you are using for your site. For example, if you are using English, the folder will be named <em>en</em>.</li>
<li>From inside the base language folder (inour example we are in the <em>public_html/phpbb/languages/en</em> folder), you will see various files. Find the <strong>ucp.php</strong> file and <a target="_blank" href="/support/website/how-to/how-to-edit-a-file">open it for editing</a>.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/howto/change-registration-text/edit.png"><img  alt="edit the ucp.php file" src="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/howto/change-registration-text/edit.png" /></a></li>
<li>From inside the editor, you can see there are many different variables and the text for them inside this file. Look for the text for the <em>TERMS_OF_USE_CONTENT</em> section (this is around line 40 in the file). From here you can add or change text. For example purposes we will be adding the highlighted text below: <em>ADDED TEXT!!!<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/howto/change-registration-text/added-text.png"><img  alt="new text added to terms" src="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/howto/change-registration-text/added-text.png" /></a><br /></em></li>
<li>Once you have added or change the text as desired, click the <strong>Save Changes</strong> button located in the upper right corner of the screen. This saves your changes so the next person who registers with your site will see the new text. Below is a screen shot of the registration page before and after making the change in our example.<br />
<table class="article_table">
<tbody>
<tr><th>Before</th><th>After</th></tr>
<tr>
<td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/howto/change-registration-text/before.png"><img style="max-width: 250px;"  alt="registration text before change" src="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/howto/change-registration-text/before.png" /></a></td>
<td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/howto/change-registration-text/after.png"><img style="max-width: 250px;"  alt="new registration text after change" src="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/howto/change-registration-text/after.png" /></a></td>
</tr>
</tbody>
</table>
</li>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 7: 301: How to Modify the Registration Page Text in phpBB</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 6: <a href='/support/edu/phpbb/301-fixing-the-specified-forum-image-does-not-exist-error'>302: Fixing "The specified forum image does not exist" error in phpBB</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/phpbb/301-edit-registration-page&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/phpbb/301-edit-registration-page'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xMDQmaWQ9MjQ2NyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="292f6d7f7478ca40896a94356bb3f256" value="1" />	</div>
	</form>
<!-- <br />
