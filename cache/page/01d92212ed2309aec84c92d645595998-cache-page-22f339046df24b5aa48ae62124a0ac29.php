<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:61653:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/opencart/installing-opencart-and-adding-products/adding-new-products-to-opencart" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2011-12-21T18:29:15-08:00" />
  <meta name="keywords" content="add new products opencart items" />
  <meta name="author" content="Tim Sisson" />
  <meta name="description" content="This tutorial will show you how to add new products to your OpenCart shopping cart." />
  <title>Adding New Products to OpenCart - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/opencart/installing-opencart-and-adding-products/adding-new-products-to-opencart" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<script type="text/javascript">
		...
		_gaq.push(['_setCustomVar', 3, 'DateMonthModified', '2011-12', 3]);
	...
	<!-- cid:733d9ede6e8c2a2fbfb3e580caeb3d74 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Adding New Products to OpenCart									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>11,499</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Dec 21, 2011'><span style='color:#606060;'>Published:</span> Dec 21, 2011</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Now that you have<a href="/support/edu/opencart/installing-opencart-and-adding-products/removing-products-from-opencart"> removed the default products in OpenCart </a>and <a href="/support/edu/opencart/installing-opencart-and-adding-products/adding-product-categories-in-opencart">added product categories</a>, you can start adding your own products. This is done through your OpenCart dashboard. You'll need to add each product individually.</p>
<ol>
...
<li>To add a new product, click "<strong>Insert</strong>" in the top right corner.</li>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/opencart/opencart_add_product_1.jpg"><img src="//cdn.inmotionhosting.com/support/images/stories/opencart/opencart_add_product_1.jpg" alt="opencart_add_product_1"  /></a></p>
<li>Now you will see seven tabs (General, Data, Links, Attribute, Option, Discount, Special, Image, Reward Points, and Design). Be sure to fill in the <strong>Product Name</strong> - the only required field - on the first tab.</li>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/opencart/opencart_add_product_2.jpg"><img src="//cdn.inmotionhosting.com/support/images/stories/opencart/opencart_add_product_2.jpg" alt="opencart_add_product_2"  /></a></p>
<li>Click on the "<strong>Data</strong>" tab. The only other field that is required to set up a product is the <strong>model</strong>. Go through each tab and fill in the fields you want.</li>
<li>Click "<strong>Save</strong>"</li>
</ol>
<p>You have now added your first product on your OpenCart shopping cart. You'll follow these steps for each product until all your products have been added. You can add new products, edit existing products, and delete current products at any time.</p>
<p>If you need further assistance please feel free to <a href="/support/community-support">ask a question on our Support Center</a>.&nbsp;</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 8: Adding New Products to OpenCart</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 7: <a href='/support/edu/opencart/installing-opencart-and-adding-products/removing-products-from-opencart'>Removing Products from OpenCart</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/opencart/installing-opencart-and-adding-products/adding-new-products-to-opencart&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/opencart/installing-opencart-and-adding-products/adding-new-products-to-opencart'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xNTAmaWQ9MTAyMSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="85effdfa2d07180b738250eef04b783c" value="1" />	</div>
	</form>
<!-- <br />
          ...
          <tr >
			...
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/opencart/how-to-add-product-opencart?tsrc=rsbraq'>How to add products to OpenCart</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/opencart/need-to-update-opencart-pages?tsrc=rsbraq'>Need to update OpenCart Pages</a>
                                </div>
