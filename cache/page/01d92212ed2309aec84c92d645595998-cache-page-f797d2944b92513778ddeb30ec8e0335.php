<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:63466:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/prestashop-15/catalog-setup/allow-out-of-stock-orders" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-09-18T17:26:16-07:00" />
  <meta name="keywords" content="allow out of stock products PrestaShop 1.5" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Learn how to allow ordering on out-of-stock products in PrestaShop 1.5" />
  <title>How to allow orders on out-of-stock products in PrestaShop 1.5 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/prestashop-15/catalog-setup/allow-out-of-stock-orders" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:17f5dd5fbf90c861f440255e55245928 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '78.213.242.206']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to allow orders on out-of-stock products in PrestaShop 1.5									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>5,471</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jun 6, 2012'><span style='color:#606060;'>Published:</span> Sep 18, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Deciding whether or not to allow customers to order out-of-stock products is one of the many details of your site. Fortunately, Prestashop has a setting for that. Allowing orders on out-of-stock product in PrestaShop 1.5 is very simple.</p>
<p><strong>To allow orders on out-of-stock product in PrestaShop 1.5:</strong></p>
<ol class="article_list">
<li><a href="/support/edu/prestashop-15/getting-started/login-to-dashboard">Log into your PrestaShop 1.5 dashboard.</a></li>
<li>Using the top menu bar, hover over the <strong>Preferences </strong>tab and select the <strong>Products </strong>option.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/preferences-products-allow-out-of-stock-orders/_preferences-tab-products.png"><img  alt="_preferences-tab-products" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/preferences-products-allow-out-of-stock-orders/_preferences-tab-products.png" /></a></li>
<li>You are now on the <em>Preferences : Products</em> screen. Under the <strong>Products Stock</strong> section, find the <strong>Allow ordering of out-of-stock products</strong> setting.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/preferences-products-allow-out-of-stock-orders/preferences-product-allow-out-of-stock.png"><img  alt="preferences-product-allow-out-of-stock" src="//cdn.inmotionhosting.com/support/images/stories/edu/prestashop1.5/preferences-products-allow-out-of-stock-orders/preferences-product-allow-out-of-stock.png" /></a></li>
<li>Select either the <strong>Yes </strong>or <strong>No </strong>radio button. The <strong>Yes </strong>option will allow your customers to order products if they are out-of-stock (back ordering) while the <strong>No </strong>option will not allow it to be ordered.</li>
<li>Click on the Save button in the upper right corner when finished to save the change.</li>
</ol>
<p>That is how you allow out-of-stock ordering in PrestaShop 1.5.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 1: How to allow orders on out-of-stock products in PrestaShop 1.5</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 2: <a href='/support/edu/prestashop-15/catalog-setup/set-new-orcer-notification'>How to enable/disable the new order notification in PrestaShop 1.5</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/prestashop-15/catalog-setup/allow-out-of-stock-orders&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/prestashop-15/catalog-setup/allow-out-of-stock-orders'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yMzYmaWQ9MTQxOCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="5e3a0b31997693872b28b2d77cde507a" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<table><tr><td colspan='2'><h4>Features</h4></td></tr>  <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>1.</td>
