<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:51386:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/joomla-3/joomla-read-more-not-working" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Rchorsch, Sorry to hear you're having problems with the Read More feature of Joomla. I couldn't find an account associated with your Support Cente..." />
  <title>Joomla &quot;read more&quot; not working? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/joomla-3/joomla-read-more-not-working" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:8b4d8b8eca9806a49ac8525da5337620 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Joomla &quot;read more&quot; not working?</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-09-10 4:06 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>1,695</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Joomla &quot;read more&quot; is enabled (there is a red line in the article editor at appropriate place) but nothing happens in the template --the complete text is displayed without the &quot;read more&quot; feature.<br />
<br />
Did I forget to enable something?</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_3921' id='upvote_answer_3921' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='3921' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_3921').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_3921' id='downvote_answer_3921' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='3921' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_3921').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Rchorsch,<br />
<br />
Sorry to hear you're having problems with the Read More feature of Joomla.  I couldn't find an account associated with your Support Center login, so I was not able to review the problem on your website.  Check out this article about the "read more" feature: <br />
<br />
<a href="http://docs.joomla.org/Splitting_an_Article_into_an_introduction_with_a_link_to_read_more" rel="nofollow" target="new">Read More feature for Joomla</a>. <br />
<br />
Make sure to read the note at the end of the article as it details the requirements for the read more option to work.<br />
<br />
I hope this helps to provide you the answer that you need.  Please let us know if you have any further questions or comments.<br />
<br />
Regards,<br />
Arnel C.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_3921').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_3921' id='form_comment_on_answer_3921' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="490cf2402119cdd93f8fc4f343549c11" value="1" />	</div>
	</form>
<!-- <br />
