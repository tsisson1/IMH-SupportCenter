<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:51070:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/website-troubleshooting/how-can-i-add-line-breaks-in-php" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hi SteveC, Why is this happening? When you use PHP to print a new line using \n, it does print a newline to the screen. The problem is that if you want ..." />
  <title>How can I add line breaks in php? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/website-troubleshooting/how-can-i-add-line-breaks-in-php" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:ad3836b1fc10c812efa9715331998103 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>How can I add line breaks in php?</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-02-09 6:04 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>46,113</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>My php cgi code includes writing out strings with &quot;\n&quot; at the end; I thought this would give me a new line, but that isn't happening. I am just getting one continuous string. I also tried &quot;\n\r&quot; but that did not make a difference.<br />
<br />
Works on my mainframe server.<br />
<br />
</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_550' id='upvote_answer_550' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='550' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_550').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_550' id='downvote_answer_550' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='550' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_550').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
...
<br />
When you use PHP to print a new line using \n, it does print a newline to the screen. The problem is that if you want to add a line break in PHP, you'll need to print &amp;lt;br /&amp;gt; to the screen instead of \n.<br />
<br />
For example, your php code may print the following:<br />
&lt;div class='code_block'&gt;This is<br />
<br />
my test string<br />
<br />
with new lines in it<br />
&lt;/div&gt;<br />
<br />
A web browser will not automatically add line breaks however to lines. The above code when viewed in a browser will look like:<br />
<br />
&lt;div class='code_block'&gt;This ismy test stringwith new lines in it&lt;/div&gt;<br />
<br />
<br />
&lt;strong&gt;To resolve this issue:&lt;/strong&gt;<br />
<br />
To help resolve this issue, you can use PHP to either:<br />
<br />
1. &lt;a href='http://php.net/manual/en/function.str-replace.php' target='_blank'&gt;Replace&lt;/a&gt; all instances of \n with &lt;br /&gt;<br />
<br />
2. Use PHP's built in &lt;a href='http://php.net/manual/en/function.nl2br.php' target='_blank'&gt;nl2br function&lt;/a&gt; to insert HTML line breaks before all newlines.<br />
<br />
<br />
&lt;strong&gt;Why is this working on your own server?&lt;/strong&gt;<br />
<br />
I can't say for sure why this works on your mainframe server without having more details. The first thing I would do is view the html source code on your mainframe server and check to see if you have some setup that automatically adds line breaks to your code. Also, you may be using the &amp;lt;pre&amp;gt; tag to output your text, and in that case, the new lines (\n) will print as you are expecting.<br />
<br />
<br />
If you have any further questions, feel free to update your question or post in the comments, and I'll be happy to assist further.<br />
<br />
Thanks!<br />
- Brad
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_550').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_550' id='form_comment_on_answer_550' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/website-troubleshooting/how-can-i-add-line-breaks-in-php&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/website-troubleshooting/how-can-i-add-line-breaks-in-php'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="1299ed464da486d859830ae950f422d0" value="1" />	</div>
	</form>
<!-- <br />
