<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:40875:" 
...
<meta name="viewport" content="width=device-width" />
  ...
  <link href="http://www.inmotionhosting.com/support/component/users/?view=reset&amp;layout=confirm" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:d13dc09a9c1ea13e5d5964583c088d5e -->
...
<div class='container'>
	...
	<form action="/support/component/users?task=reset.confirm" method="post" class="form-validate">

				<p>An email has been sent to your email address. The email contains a verification code, please paste the verification code in the field below to prove that you are the owner of this account.</p>		<fieldset>
			<dl>
							<dt><label id="jform_username-lbl" for="jform_username" class="hasTooltip required" title="&lt;strong&gt;Username&lt;/strong&gt;&lt;br /&gt;Enter your username.">
	Username:<span class="star">&#160;*</span></label></dt>
				<dd><input type="text" name="jform[username]" id="jform_username" value="" class="required" size="30" required aria-required="true" /></dd>
							<dt><label id="jform_token-lbl" for="jform_token" class="hasTooltip required" title="&lt;strong&gt;Verification Code&lt;/strong&gt;&lt;br /&gt;Enter the password reset verification code you received by email.">
	Verification Code:<span class="star">&#160;*</span></label></dt>
				<dd><input type="text" name="jform[token]" id="jform_token" value="" class="required" size="32" required aria-required="true" /></dd>
						</dl>
		</fieldset>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP3ZpZXc9cmVzZXQmbGF5b3V0PWNvbmZpcm0mb3B0aW9uPWNvbV91c2Vycw==" />
