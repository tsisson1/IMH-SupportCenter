<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:61634:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/mediawiki/change-media-wiki-appearance/changing-mediawiki-skins" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-01-23T20:08:44-08:00" />
  <meta name="keywords" content="mediawiki media wiki change changing switch switching skin skins skinning theme themes template templates default [gs]" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="This article will explain how to change your MediaWiki skin to the modern, nostalgia and gmwfreeblue themes." />
  <title>How to change MediaWiki skins - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/mediawiki/change-media-wiki-appearance/changing-mediawiki-skins" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:42b95b6078bb865d8c010025483df9b1 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to change MediaWiki skins									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>9,906</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Dec 21, 2012'><span style='color:#606060;'>Published:</span> Jan 23, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>The default appearance of MediaWiki can be changed to better represent your wiki site. The themes in mediawiki are called skins. Skinning the MediaWiki site is necessary in order to customize the site to your personal preferences. This article will explain how to change the skin and to upload a free skin in MediaWiki.</p>
<h2>Default MediaWiki skins</h2>
<p>MediaWiki has 9 skins built into teh default installation available for use. The included MediaWiki skins are:</p>
<ul style="float: left;">
<li>Chick</li>
<li>Classic</li>
<li>Cologne Blue</li>
...
<li>Nostalgia</li>
<li>Simple</li>
<li>Vector (the default)</li>
</ul>
<p style="clear: both;">In the following section, we will switch the default vector them to the nostalgia and the modern theme.</p>
<h2>How do I change the MediaWiki Default skin?</h2>
<ol class="article_list">
<li><a title="Click here for more information" href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">Log into cPanel</a> and Navigate to your <a target="_blank" href="/support/edu/cpanel/cpanel-file-manager/using-file-manager-in-cpanel" title="Click for more information">File manager</a> select the MediaWiki install folder and click Go.</li>
<li>Navigate to the following file in your MediaWiki installation directory.
<p style="margin-left: 20px;">/public_html/mediawiki/LocalSettings.php</p>
<p>Open the file in the code editor.</p>
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/102/changing-mediawiki-appearance/mediawiki-change-theme-1-vector-skin.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="MediaWiki Vector skin code" src="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/102/changing-mediawiki-appearance/mediawiki-change-theme-1-vector-skin.gif" title="Click here to view the larger image" width="100" /></a>Find the following line in your LocalSettings.php file.
<p style="margin-left: 20px;">$wgDefaultSkin = "vector";<br style="clear: both;" /></p>
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/102/changing-mediawiki-appearance/mediawiki-change-theme-1-modern-skin.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="MediaWIki Modern skin code" src="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/102/changing-mediawiki-appearance/mediawiki-change-theme-1-modern-skin.gif" title="Click here to view the larger image" width="100" /></a>To change the skin to "<em>the modern skin</em>", change the code to the following and save the changes.
<p style="margin-left: 20px;">$wgDefaultSkin = "modern";<br style="clear: both;" /></p>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/102/changing-mediawiki-appearance/mediawiki-change-theme-3-vector-skin-preview.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="MediaWiki Modern Skin preview" src="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/102/changing-mediawiki-appearance/mediawiki-change-theme-3-vector-skin-preview.gif" title="Click here to view the larger image" width="100" /></a>Now the MediaWiki site will look like the snapshot to the right. <br style="clear: both;" /></p>
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/102/changing-mediawiki-appearance/mediawiki-change-theme-2-nostalgia-skin.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="MediaWiki Nostalgia code" src="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/102/changing-mediawiki-appearance/mediawiki-change-theme-2-nostalgia-skin.gif" title="Click here to view the larger image" width="100" /></a>Now try the nostalgia skin. Type the following in the code and save the page.
<p style="margin-left: 20px;">$wgDefaultSkin = "nostalgia";<br style="clear: both;" /></p>
<br style="clear: both;" />
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/102/changing-mediawiki-appearance/mediawiki-change-theme-2-nostalgia-skin-preview.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="MediaWiki Nostalgia skin preview" src="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/102/changing-mediawiki-appearance/mediawiki-change-theme-2-nostalgia-skin-preview.gif" title="Click here to view the larger image" width="100" /></a>Now you should see the familiar yellow base skin. <br style="clear: both;" /></p>
</li>
</ol>
<h2>Uploading and Installing a free skin</h2>
<p>MediaWiki skins can be downloaded for free as well. Instead of using the basic skins, you can download free templates from various free sites. This tutorial will use the free template from <strong><a href="http://gomediawiki.com/wiki/Skin_download_page" target="_blank">Go media wiki</a></strong>.</p>
<p>This free theme can be downloaded <strong><a href="https://github.com/naumenko/GMW-Free-Skin/zipball/master" target="_blank">here</a></strong>. The downloaded file will be called:</p>
<p style="margin-left: 20px;">naumenko-GMW-Free-Skin-e6b5fd4.zip</p>
<h3>&nbsp;Steps to upload a free theme in MediaWiki</h3>
<ol class="article_list">
<li><a title="Click here for more information" href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">Log into cPanel</a> and go to the file manager and select your mediawiki folder location and click Go.</li>
<li>Navigate to public_html/mediawiki/skins</li>
<li>Upload the naumenko-GMW-Free-Skin-e6b5fd4.zip file</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/102/changing-mediawiki-appearance/mediawiki-change-theme-4-upload-free-skin.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="GMW Free Theme file manager view" src="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/102/changing-mediawiki-appearance/mediawiki-change-theme-4-upload-free-skin.gif" title="Click here to view the larger image" width="100" /></a><a href="/support/website/cpanel/compressing-uncompressing-files" target="_blank" title="How can I compress / uncompress files using the File Manager?">Extract</a>the files and move the following files and folders to the skins folder location so it looks like the snapshot to the right.
<p style="margin-left: 20px;">gmwfreeblue<br /> gmwfreegreen<br /> gmwfreered<br /> COPYING<br /> GMWFreeBlue.php<br /> GMWFreeGreen.php<br /> GWMFreeRed.php<br /> README<br style="clear: both;" /></p>
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/102/changing-mediawiki-appearance/mediawiki-change-theme-5-gmwfreeblue-skin.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="MediaWiki gmwfreeblue theme code" src="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/102/changing-mediawiki-appearance/mediawiki-change-theme-5-gmwfreeblue-skin.gif" title="Click here to view the larger image" width="100" /></a>To change thye current theme to the blue theme, edit the LocalSettings.php file and change the $wgDefaultSkin to the following.
<p style="margin-left: 20px;">$wgDefaultSkin = "gmwfreeblue";<br style="clear: both;" /></p>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/102/changing-mediawiki-appearance/mediawiki-change-theme-6-gmwfreeblue-skin-preview.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="MediaWiki gmwfreeblue theme preview" src="//cdn.inmotionhosting.com/support/images/stories/edu/mediawiki/102/changing-mediawiki-appearance/mediawiki-change-theme-6-gmwfreeblue-skin-preview.gif" title="Click here to view the larger image" width="100" /></a>Now the Template will look like the snapshot to the right. <br style="clear: both;" /></p>
</li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 1: How to change MediaWiki skins</div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/mediawiki/change-media-wiki-appearance/changing-mediawiki-skins&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/mediawiki/change-media-wiki-appearance/changing-mediawiki-skins'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMTQmaWQ9MjExMSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<table><tr><td colspan='2'><h4>Themes, templates, and skins</h4></td></tr>  <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>1.</td>
