<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:54101:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="keywords" content="%default%" />
  <meta name="description" content="DNS and Nameserver Changes Category" />
  <title>DNS and Nameserver Changes | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:ad46027826902455f13b8adadbfa3667 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '50.79.41.65']);
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/domain-names' itemprop='url'><span itemprop='title'>Domain Names<span></a><div class='dropdown_2columns'><div class='col_2'><div><a href='/support/domain-names/3rd-party-registrars'>3rd Party Registrars</a> (13)</div><div><a href='/support/domain-names/dns-nameserver-changes'>DNS and Nameserver Changes</a> (18)</div><div><a href='/support/domain-names/general-information'>General Information</a> (9)</div><div><a href='/support/domain-names/registrations-and-transfers'>Registrations and Transfers</a> (5)</div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>DNS and Nameserver Changes</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='item-page'>
        ...
        <div class='page-header'>
                <h1>DNS and Nameserver Changes</h1>
        </div>

<div class='in_this_tutorial'>
  <h2>Navigation:</h2>
  <button type="button" class="btn btn-primary" onclick="window.location.hash='nameservers';">Nameservers</button>
  <button type="button" class="btn btn-primary" onclick="window.location='/support/domain-names/dns-nameserver-changes/a-record-change';">A (IP addresses)</button>
  <button type="button" class="btn btn-primary" onclick="window.location='/support/edu/cpanel/cpanel-email/modfying-mx-records';">MX (email)</button>
 <button type="button" class="btn btn-primary" onclick="window.location='/support/domain-names/dns-nameserver-changes/add-cname-record';">CNAMES</button>
  <button type="button" class="btn btn-primary" onclick="window.location='/support/email/fighting-spam/email-authentication-spf-domainkeys';">SPF / DomainKeys</button>
</div>

<a name='nameservers'></a>
<p>To get your domain working on your server with InMotion Hosting, you will need to point your domain to our server. You can point your domain Using a <a href="/support/domain-names/dns-nameserver-changes/how-do-i-make-custom-dns-records">DNS change</a> or you can update your <a href="/support/domain-names/dns-nameserver-changes/domain-names-registrar-transfer-versus-nameserver-change">nameservers</a> to ours. This information applies to all <a href="http://www.inmotionhosting.com/business-hosting">shared</a>, <a href="http://www.inmotionhosting.com/vps-hosting">VPS</a>, <a href="http://www.inmotionhosting.com/reseller-hosting">Reseller</a>, and <a href="http://www.inmotionhosting.com/dedicated-servers">Dedicated server</a> plans.</p>
<h2>InMotion Hosting Nameservers</h2>
<p>When updating your domain's nameservers to point your domain to InMotion Hosting, you will need to use the following nameservers:</p>
...
<p>Please be aware that it may take up to 24 hours before these changes begin to take effect. More info on this can be found in, <a href="/support/domain-names/dns-nameserver-changes/domain-names-dns-changes">How long do DNS changes take?</a></p>



<h2>Nameservers for Reseller accounts (Not for VPS or Dedicated customers)</h2>
<p>When updating your domain's nameservers to point your domain to a Reseller account, you will need to use the following nameservers:</p>
<table border="0" align="center" class="table table-bordered table-striped">
  <tr>
    <th colspan="2"><div align="center">Nameservers for Resellers:</div></th>
  </tr>
  <tr>
    <th width="184"><div align="center">Hostname</div></th>
    <th width="215"><div align="center">IP Address</div></th>
  ...
  <tr>
    <th width="184"><div align="center">ns1.servconfig.com</div></th>
    <td width="215"><div align="center">216.194.168.112</div></td>
  </tr>
  <tr>
    <th><div align="center">ns2.servconfig.com</div></th>
    <td><div align="center">70.39.146.236</div></td>
  </tr>
</table><br>
<p>As a reseller you can also use custom Nameservers, here is a link to our guide on <a href="/support/reseller/custom-name-server">Using Custom Nameservers as a Reseller</a>.</p><br>

<p>Please be aware that it may take up to 24 hours before these changes begin to take effect. More info on this can be found in, <a href="/support/domain-names/dns-nameserver-changes/domain-names-dns-changes">How long do DNS changes take?</a></p>

<h2>Changing nameservers at other registrars</h2>
<p>Your nameservers will need to be updated at your domain's registrar, such as <em>GoDaddy.com</em> or <em>NetworkSolutions.com</em>. If you're unsure how to update your nameservers, please contact your current registrar for further assistance. For the more popular registrars, we do have documentation available to assist, located in the list below:</p>
<table style="font-size: 11px;" border="0" cellpadding="4" cellspacing="4" align="center">
<tbody>
<tr>
<td width="33%" valign="top">
<ul>

<li><a href="/support/domain-names/dns-nameserver-changes/making-dns-changes-atndotstercom">Making DNS Changes at Dotster.com</a></li>
<li><a href="/support/domain-names/dns-nameserver-changes/making-dns-changes-atnenomcom">Making DNS Changes at Enom.com</a></li>
<li><a href="/support/domain-names/dns-nameserver-changes/making-dns-changes-atngodaddycom">Making DNS Changes at GoDaddy.com</a></li>
<li><a href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/change-google-domain-nameservers">How to change Nameservers for Registered Google Domains</a></li>    
</ul>
</td>
<td width="33%" valign="top">
<ul>
<li><a href="/support/domain-names/dns-nameserver-changes/making-dns-changes-atnmelbourneitcomau">Making DNS Changes at MelbourneIT.com.au</a></li>
<li><a href="/support/domain-names/dns-nameserver-changes/making-dns-changes-atnnamecheapcom">Making DNS Changes at NameCheap.com</a></li>
<li><a href="/support/domain-names/dns-nameserver-changes/making-dns-changes-atnnetworksolutionscom">Making DNS Changes at NetworkSolutions.com</a></li>
<li><a href="/support/domain-names/dns-nameserver-changes/making-dns-changes-atnopensrsnet">Making DNS Changes at OpenSRS.net</a></li>
</ul>
</td>
<td width="33%" valign="top">
<ul>
<li><a href="/support/domain-names/dns-nameserver-changes/making-dns-changes-atnregistercom">Making DNS Changes at Register.com</a></li>
<li><a href="/support/domain-names/dns-nameserver-changes/making-dns-changes-at-stargatecom">Making DNS Changes at StarGate.com</a></li>
<li><a href="/support/domain-names/dns-nameserver-changes/making-dns-changes-atndrams-dramsystemcom">Making DNS Changes at DRAMS (dramsystem.com)</a></li>
<li><a href="/support/domain-names/dns-nameserver-changes/making-dns-changes-atnitsyourdomaincom">Making DNS Changes at ItsYourDomain.com</a></li>
...
<form action="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes?utm_source=imh&amp;utm_medium=transfers&amp;utm_campaign=gettingstarted" method="post" name="adminForm" id="adminForm" class="form-inline">
  ...
  <table class='article_list'>
          ...
          <tr>
                  ...
                  <tr>
                                <td style='padding-right:20px;'><a href='/support/domain-names/dns-nameserver-changes/change-google-domain-nameservers'>How to Change Name Servers in Google Domains (2)</a></td>
                                <td>453</td>
                        </tr>
                  </table>
		...
		<ul><li class="pagination-start"><span class="pagenav">Start</span></li><li class="pagination-prev"><span class="pagenav">Prev</span></li><li><span class="pagenav">1</span></li><li><a href="/support/domain-names/dns-nameserver-changes?utm_source=imh&amp;utm_medium=transfers&amp;utm_campaign=gettingstarted&amp;start=15" class="pagenav">2</a></li><li class="pagination-next"><a title="Next" href="/support/domain-names/dns-nameserver-changes?utm_source=imh&amp;utm_medium=transfers&amp;utm_campaign=gettingstarted&amp;start=15" class="hasTooltip pagenav">Next</a></li><li class="pagination-end"><a title="End" href="/support/domain-names/dns-nameserver-changes?utm_source=imh&amp;utm_medium=transfers&amp;utm_campaign=gettingstarted&amp;start=15" class="hasTooltip pagenav">End</a></li></ul>	</div>
	</form>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP3V0bV9zb3VyY2U9aW1oJnV0bV9tZWRpdW09dHJhbnNmZXJzJnV0bV9jYW1wYWlnbj1nZXR0aW5nc3RhcnRlZCZvcHRpb249Y29tX2NvbnRlbnQmY2F0aWQ9NjgmaWQ9Njgmdmlldz1jYXRlZ29yeSZJdGVtaWQ9MTAx" />
