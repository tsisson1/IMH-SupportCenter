<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:57623:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/drupal-7/sef-urls/setting-up-url-aliases-in-drupal" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-07-17T21:04:58-07:00" />
  <meta name="keywords" content="drupal alias SEO URL set up configure" />
  <meta name="author" content="Tim Sisson" />
  <meta name="description" content="In this tutorial, you'll learn how to create URL aliases for so your URLs contain keywords in your Drupal website. " />
  <title>Setting up URL Aliases in Drupal 7 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/drupal-7/sef-urls/setting-up-url-aliases-in-drupal" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:7766b38c088bff3154a8b0b604c4ae07 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '85.242.216.42']);
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
				<img src='/support/images/stories/drupal-partner/supporting-partner-80_3.png' style='float:right; margin:0px 0px 15px 15px;' alt='Drupal Association Support Partner'>		<h1>
															Setting up URL Aliases in Drupal 7									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>9,861</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Feb 17, 2012'><span style='color:#606060;'>Published:</span> Jul 17, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In our last few articles, we introduced you to <a href="/support/edu/drupal-7/sef-urls/sef-intro">the idea of Search Engine Friendly URLs</a> and walked you through the steps for <a href="/support/edu/drupal-7/sef-urls/how-to-enable-search-engine-friendly-urls-in-drupal-7">enabling clean URLs</a> in Drupal 7. At this point we have all the right settings in place, and we just need to setup our custom aliases! Continue reading to learn how to create custom URLs for your Drupal 7 pages.</p>
<p class="alert"><strong>Please note!</strong><br />When we showed you <a href="/support/edu/drupal-7/working-with-content">how to create basic pages and articles in Drupal 7</a>, we touched based on how you can setup a URL alias right from those pages. If you didn't setup aliases at that time, you can instead follow the steps below. Either way, you will be accomplishing the same task.</p>
<p><strong>To set up a URL alias in Drupal 7:</strong></p>
...
<li>Click on <strong>URL aliases </strong>located under the <strong>Search and metadata</strong> category.<br /> <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/drupal/drupal_alias_2.jpg"><img  alt="drupal_alias_2" src="//cdn.inmotionhosting.com/support/images/stories/drupal/drupal_alias_2.jpg" /></a></li>
<li>Click “<strong>Add alias</strong>”</li>
<li>Fill in the <strong>Existing Path</strong> and the <strong>Path alias</strong>. If you do not know the current path of the page, you can bring up the page in your browser and see the URL in the address bar.<br /><br />Also, when separating words, Google recommends using dashes '-' over underscores '_' <br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/drupal/drupal_alias_3.jpg"><img  alt="drupal_alias_3" src="//cdn.inmotionhosting.com/support/images/stories/drupal/drupal_alias_3.jpg" /></a></li>
<li>Click <strong>Save</strong><br /><br />Now, when you visit the page, you’ll see the URL change to the <strong>Alias</strong> instead. You will want to repeat this for each page you want to set up an alias for.<br /> <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/drupal/drupal_alias_4.jpg"><img  alt="drupal_alias_4" src="//cdn.inmotionhosting.com/support/images/stories/drupal/drupal_alias_4.jpg" /></a></li>
</ol>
<p>If you need further assistance please feel free to <a href="/support/community-support/">ask a question on our support center</a>.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 3: Setting up URL Aliases in Drupal 7</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 2: <a href='/support/edu/drupal-7/sef-urls/how-to-enable-search-engine-friendly-urls-in-drupal-7'>How to enable Search Engine Friendly URLs in Drupal 7</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/drupal-7/sef-urls/setting-up-url-aliases-in-drupal&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/drupal-7/sef-urls/setting-up-url-aliases-in-drupal'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yMDgmaWQ9MTE2NyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="08bbec3efb81acb079ae199407902c43" value="1" />	</div>
	</form>
<!-- <br />
