<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:67623:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/cpanel/softaculous/upgrade-within-softaculous" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-09-18T18:49:10-07:00" />
  <meta name="keywords" content="softaculous upgrade" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="Keeping your software up to date is very important, and in this tutorial we'll show you how to upgrade programs within Softaculous." />
  <title>How to upgrade a program installed with Softaculous - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/cpanel/softaculous/upgrade-within-softaculous" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:1a7cdf59f1a76d001bc3465684b499ab -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '192.40.93.206']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to upgrade a program installed with Softaculous									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>4,628</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Aug 28, 2012'><span style='color:#606060;'>Published:</span> Sep 18, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Keeping your software up to date is very important. New versions are released on a regular basis, and these updates often contain bug fixes and security patches. In this tutorial, we'll show you how to upgrade a program that you previously <a href="/support/edu/cpanel/softaculous/how-to-install">installed using Softaculous</a>.</p>
<p><strong>To upgrade software using Softaculous:</strong></p>
<ol class="article_list">
<li><a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">Log into your cPanel</a></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/cpanel/softaculous/softaculous-updates-available.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="softaculous-updates-available" src="//cdn.inmotionhosting.com/support/images/stories/edu/cpanel/softaculous/softaculous-updates-available.gif" /></a>If there are any upgrades available, you will see a message within your cPanel Notices section, similar to:<br /><br /><strong>Softaculous</strong><br /><em>3 Update(s) available.</em><br /><br /><strong>Click the <em>updates available</em> link.</strong>
<div style="clear: both;"></div>
</li>
<li>You will then be brought to <a href="/support/edu/cpanel/softaculous/whats-installed">your scripts installation page</a>, where only the programs with available updates are shown. Next to the program you would like to upgrade, click the <img alt="icon_upgrade" src="//cdn.inmotionhosting.com/support/images/stories/edu/cpanel/softaculous/icon_upgrade.gif" style="margin-bottom: -5px;" height="26" width="24" /> upgrade icon.</li>
<li>We recommended following Softaculous' suggestion and creating a backup before you perform the upgrade. To do this, check the box next to <strong>Create Backup</strong>.</li>
<li>Click the <strong>Upgrade</strong> button<br /><br />A progress bar will show on the screen, and when the upgrade has completed, you will see the following message:<br /><em>Congratulations, the software was upgraded successfully.</em></li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 7: How to upgrade a program installed with Softaculous</div>
...
<div style='display:inline-block;'>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNTcmaWQ9MTcyNSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="abfedc330bd77a1aca6e3d96127fae23" value="1" />	</div>
	</form>
<!-- <br />
          ...
          <tr >
			...
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/wordpress/how-can-i-remove-softaculous-from-monitoring-a-wordpress-install?tsrc=rsbraq'>How can I remove Softaculous from monitoring a WordPress install?</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-28 12:06 pm</div>
				                <div>Open Cart has come out with a new version 2.0 in October and it now the end of November....do you know when cPanel will have that 2.0 version in there so I can click &quot;update&quot; ?   We novices have to wait patiently until softaculous has the update listed to do the updates since we can't do them &quot;manually&quot;. </div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17922);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-28 12:43 pm</div>
				                <div>Hello Paul,<br />
<br />
Thanks for the question.  Unfortunately, we don't necessarily have a release date for the updated version of Softaculous. I am also aware of the 2.0 version of OpenCart, but we are not informed as to when or if that version will be available through Softaculous.  You can always get the installation directly from the OpenCart website.<br />
<br />
Apologies that we don't have direct answer at this time, but please let us know if you have any further questions or comments.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17928);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-28 1:49 pm</div>
				                <div>Thanks Arnel.  I already have 1.54 running so for me it would be an &quot;upgrade&quot; so none of my items would be changed...which is why I need Softaculous to do it...because I wouldn't know how to manually install a totally new version, new folder, new database and move all the 1.5 info and items into the new one.  I am sure that could be &quot;easy&quot; for some people...not me.  I will just be patient and wait to see the simple &quot;upgrade&quot; button come live on cPanel and click that.  I can handle that.  :)  </div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17939);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
