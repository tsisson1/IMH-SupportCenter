<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:80995:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/managing-files/change-file-permissions" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-11-19T18:48:08-08:00" />
  <meta name="keywords" content="file permissions read write execute user group world access" />
  <meta name="author" content="null" />
  <meta name="description" content="This article gives an introduction to file permissions and how to change you file and folder permissions." />
  <title>Changing File Permissions in cPanel - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/managing-files/change-file-permissions" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:bc74a14e5f7d5f35f4b9b572779b5190 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-37']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '208.71.253.147']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Changing File Permissions in cPanel									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>33,696</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Sep 20, 2011'><span style='color:#606060;'>Published:</span> Nov 19, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Each file and directory(folder) in your account has <a href="/support/website/linux/file-permissions">permissions</a> which control who can read, write and execute that file. When files are created, default permissions are assigned. Most users won't need to change permissions, but there are times when an update, instalaltion, etc. will require a file permissions change.</p>
<h1>Viewing File Permissions</h1>
<p>File permissions can be viewed and changed through either the cPanel File Manager or most FTP programs. We'll walk you through viewing and changing your permissions through the cPanel File Manger here.</p>
<p>Let's look at an example below:</p>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/cpanel/cpanel-view-file-permissions.jpg"><img src="//cdn.inmotionhosting.com/support/images/stories/cpanel/cpanel-view-file-permissions.jpg" alt="cpanel-view-file-permissions" title="View File Permissions in cPanel"  /></a></p>
<p>In the image above you can see the permissions for each file listed on the right side of the screen. Probably the most important thing to keep in mind is that certain file types and folders should be set to particular permissons. Below are some examples:</p>
<p><strong>public_html</strong> - 750<br /><strong>Folders</strong> - 755<br /><strong>CGI and Perl scripts</strong> - 755<br /><strong>.html .php and other Document Types</strong> - 644</p>
<h2>What to do when permissions are set wrong</h2>
<p>Incorrect file permissions can cause errors or even worse, allow unauthorized users to hack your site. Once an unauthorized user gains access, they can further alter more of your file permissions to make a site even more vulnerable. Remember that 777 permissions means that your file is readable, writeable and executable by the "world". This is not common, as it is a rare situation where a file needs to be written and executed by the "world." If you find files or folders with permissions that do not match the default permissons, it's usually best to change them to the recommended permissions.</p>
<h2>How to change file permission settings</h2>
<p>You can change the permissions for files through the cPanel File Manager or in your preferred FTP program. In File Manager, locate the file you wish to change the permissions for. Next, right click and select Change Permissions from the menu (or select the icon near the top of the screen).</p>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/cpanel/cpanel-change-file-permissions.jpg"><img src="//cdn.inmotionhosting.com/support/images/stories/cpanel/cpanel-change-file-permissions.jpg" alt="cpanel-change-file-permissions" title="Change File Permissions in cPanel"  /></a></p>
<p>This will bring up the Change Permissions window where you can adjust the settings as needed by checking the box by each permission you want for each level of access (User, Group and World).</p>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/cpanel/cPanel-file-permissions-change.jpg"><img src="//cdn.inmotionhosting.com/support/images/stories/cpanel/cPanel-file-permissions-change.jpg" alt="cPanel-file-permissions-change" title="Change File Permissions in cPanel"  /></a></p>
<p>Once you are finished editing your file permissions, click the "Change Permissions" button.</p>
<p>Keep in mind that you should only change file permissions if needed. You want to make sure that you aren't allowing more access to your files than is necessary, since that can leave your website vulnerable. If you have any questions or need additional assistance changing file permissions, please <a href="/support/website/website-troubleshooting/how-to-get-great-technical-support">contact our support team</a> and we'll be happy to help you.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/managing-files/change-file-permissions&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/managing-files/change-file-permissions'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NDYmaWQ9MTI5JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="05cc97b67ed10ffe35840e1a1090f39d" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/drupal-7/drupal-permisssion-issues?tsrc=rsbraq'>Drupal permisssion issues</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/joomla/cannot-install-extension?tsrc=rsbraq'>Internal Server Error when installing Joomla Extension</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/joomla-25/comvirtuemartshoppersini-not-loading?tsrc=rsbraq'>com_virtuemart.shoppers.ini not loading</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/joomla-3/cannot-use-php-53?tsrc=rsbraq'>cannot use php 5.3</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/drupal-7/drupal-can-not-write-to-sites-default-files-directory?tsrc=rsbraq'>Drupal can not write to sites --&gt; default --&gt; files directory</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/56f8d6f0f2505e2c813a2dca8c103ebb?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/56f8d6f0f2505e2c813a2dca8c103ebb'>Joe R. Garcia, Jr.</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-29 10:15 am</div>
				                <div>It does tell how to get access to or where cPanel situated. </div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20090);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						...
						<div><a style='font-size:16px;' href='/support/community-support/users/AdriianM'>AdriianM</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-02 8:16 pm</div>
				                <div>I can´t fix the 500 error, and I can´t upload a new theme on worpdress its said &quot;500 Error&quot; also for active the Envalto WordPress Toolkit...</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23882);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-02 9:06 pm</div>
				                <div>Hello AdriianM,<br />
<br />
Can you provide us with your domain so we may try to troubleshoot your 500 error? Also have you checked your .htaccess file for any misspelled directives?<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23883);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-23900'></a>
		<div  style='margin:2px 0px 0px 80px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/ad165f8e01f942894b7032c1a06354e7?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/ad165f8e01f942894b7032c1a06354e7'>AdriianM</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-03 8:35 am</div>
				                <div><p>aight, its www.proaltus.com&nbsp;</p>
<p>&nbsp;</p>
<p>Greetings</p>
<p>Adriian</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23900);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-03 6:19 pm</div>
				                <div>hello Adriian,<br />
<br />
Apologies, but we need the exact url where your Wordpress folder is located.  You have several listed in your account, so we're not really sure WHICH one is the correct location.  Please provide the location so that we can investigate the issues further.<br />
<br />
Regards,<br />
Arnel C.<br />
<br />
</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23914);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-25513'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/810507ec10359c4a5afbe559db1835f0?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/810507ec10359c4a5afbe559db1835f0'>Aftab</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-06 12:33 am</div>
				                <div><p>Hi,</p>
<p>I have asset managment system which is developed by me in plane php. when i call services on Server(LINUX). It cause 505 internal server error while its working fine on localhost.&nbsp;</p>
<p>Can any body help me. Should i swich from linux to window or any other salution?</p>
<p>Thanks</p>
<p>Aftab</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25513);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-06 3:47 pm</div>
				                <div>Hello Aftab,<br />
<br />
Thank you for contacting us. 505 server errors are very general. Unfortunately, it is very difficult to troubleshoot custom developed PHP errors. <br />
<br />
We are happy to help, but will need some additional information, such as a link to the error, and replication steps.<br />
<br />
Please include any additional information that will help us duplicate your testing.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25549);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-26484'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/b53e8a83e3a32ca006b103d6ee7bedab?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/b53e8a83e3a32ca006b103d6ee7bedab'>Cindy</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-09 8:12 am</div>
				                <div><p>Good Day.</p>
<p>&nbsp;</p>
<p>So changed my theme of my website to richer, however I would like to install the demo xml, but is giving me a error saying failed, could anyone please advise me how to approach this matter?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26484);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-09 12:35 pm</div>
				                <div>Hello Cindy,<br />
<br />
As per your question, it appears that your theme is blocking the installation of your XML data.  If we had more information in regards to the theme you're using, versions, how you're trying to import, the exact error message then we can investigate the issue in more depth.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26502);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-30327'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/a74e2c1e5be0a9e30e06e0a830faa31c?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/a74e2c1e5be0a9e30e06e0a830faa31c'>Linda</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-02-03 10:27 pm</div>
				                <div><p>I'm very beginner and I was confused nearly 5 hours ago. I'm confused about "where I must edit write to read" and it turns out there in the last column file menager lol&nbsp;</p>
<p>Thanks this article that are useful and easy to understand for beginners.</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30327);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
