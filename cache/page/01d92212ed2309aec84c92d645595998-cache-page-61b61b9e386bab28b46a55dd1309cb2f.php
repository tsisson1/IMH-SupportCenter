<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:56140:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/how-to/how-do-i-redirect-any-404-pagenotfound-errors-to-my-site-map-page" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Custo150, Cpanel has a way for you create custom 404 pages, but you would need to add code on the 404 page in order to provide a link to another p..." />
  <title>How do I redirect any 404 page-not-found errors to my site map page? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/how-to/how-do-i-redirect-any-404-pagenotfound-errors-to-my-site-map-page" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:a7a379dd4b002f995a090748886d0068 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box straight_bottom'>
                <h1 style='font-size:26px;'>How do I redirect any 404 page-not-found errors to my site map page?</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='http://graph.facebook.com/customprintedtiles/picture?type=normal' class='user_avatar' /><br />
			<a href='/support/community-support/users/custo150'>custo150</a>
			<div>18 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-05-08 7:39 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>26,382</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>How do I redirect any 404 page-not-found errors to my site map page?</div>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px;'>
				<div style='font-size:12px; max-width:500px; overflow:auto;'>Does cpanel have an app for redirecting all 404's to a page which I specify (http://custom-tiles.com/site-map-for-custom-tiles)?</div>
				
				
			</td>
			<td style='width:100px;' valign='top'>
				<img src='http://graph.facebook.com/customprintedtiles/picture?type=normal' style='width:40px;' class='user_avatar' />
				<div class='smallgrey'>
					<a href='/support/community-support/users/custo150'>custo150</a><br />
					18 <a href='/support/team/points' target='_blank'>Points</a><br />
					2013-05-08 08:01 pm EST
				</div>
			</td>
		</tr>
	</table>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_3068' id='upvote_answer_3068' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='3068' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_3068').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_3068' id='downvote_answer_3068' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='3068' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_3068').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Custo150,<br />
<br />
You can create a custom 404 error page and then embed code to redirect to another page .  We have an article that you can use called <a href="http://www.inmotionhosting.com/support/website/how-to/creating-a-custom-404-error-page" target="new">creating a custom 404 error page</a>.  The 404 error is a standard error message but you can direct a customer to a page by adding the code in your .htaccess file like this:<br />
<br />
ErrorDocument 404 index.html  <br />
<br />
This will show the index page when the 404 error shows.  For more information on editing your .htaccess file check out <a href="http://www.inmotionhosting.com/support/website/how-to/setting-a-404-error-page-via-htaccess" target="new">Setting a 404 error page via .htaccess</a>.<br />
<br />
...
Community Support Team
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_3068').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_3068' id='form_comment_on_answer_3068' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
...
<div class=' straight_bottom not_best_answer'>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px; width:50px;' valign='top'>
<div class='vote_div'>
	<form method='post' name='upvote_answer_3070' id='upvote_answer_3070' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='3070' />
		<input type='hidden' name='component' id='component' value='qa' />
		<input type='hidden' name='vote_value' id='vote_value' value='1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_3070').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_3070' id='downvote_answer_3070' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='3070' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_3070').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Custo150,<br />
<br />
Cpanel has a way for you create custom 404 pages, but you would need to add code on the 404 page in order to provide a link to another page.  Automatically re-directing everytime there is a 404 can also get you penalized by search engines, so it's not always recommended.  Here's a suggestion for making your 404 pages jump after a period of time.  You would need to paste this code in your custom 404 error page:<br />
<br />
 <div class="code_block"><em>&lt;meta http-equiv="Refresh" content = "10; URL=http://www.domain_name.com/sitemap.html"&gt;</em></div><br />
<br />
This will cause the page to refresh in 10 seconds and then automatically jump to the page that you indicate.    Here's Google Webmaster Tools take on the issue of using 404 errors:  <a href="http://support.google.com/webmasters/bin/answer.py?hl=en&answer=2409439" rel="nofollow" target="new">404(Not Found - About Not Found Errors</a>.<br />
<br />
If you have any further questions, please <a href="http://www.inmotionhosting.com/contact" target="new">contact technical support</a> available 24 hours a day / 7 days a week.<br />
<br />
Arnel C.<br />
...
Community Support Team
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_3070').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_3070' id='form_comment_on_answer_3070' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
					                <p>You must <a href='/support/login'>login</a> before you can post a comment about this answer.</p>
					        </div></div></div></div>
					</form>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>404ErrorsFound is a simple &amp; powerful tool to handle all 404 errors in your website project. http://www.404errorsfound.com/ #404error</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='http://graph.facebook.com/vishal.desai.904750/picture?type=normal' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/desaivishal11'>desaivishal11</a><br />
									3 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2014-10-14 4:03 pm EST
								</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/how-to/how-do-i-redirect-any-404-pagenotfound-errors-to-my-site-map-page&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/how-to/how-do-i-redirect-any-404-pagenotfound-errors-to-my-site-map-page'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="b14df4df50a18acd9e7ff6a83c0f729b" value="1" />	</div>
	</form>
<!-- <br />
