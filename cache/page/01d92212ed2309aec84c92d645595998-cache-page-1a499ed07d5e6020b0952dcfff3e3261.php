<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:61401:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/drupal-8/comments/add-comment-field" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-11-20T13:44:04-08:00" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Not all content types have a comment field by default. Follow this guide to learn how to add them in Drupal 8." />
  <title>Adding a comment field to a basic page in Drupal 8 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/drupal-8/comments/add-comment-field" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:c9cbc311dbb7ccd21b17e68ab170510c -->
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
				<img src='/support/images/stories/drupal-partner/supporting-partner-80_3.png' style='float:right; margin:0px 0px 15px 15px;' alt='Drupal Association Support Partner'>		<h1>
															Adding a comment field to a basic page in Drupal 8									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>681</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Nov 19, 2013'><span style='color:#606060;'>Published:</span> Nov 20, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>While comments are connected to the <em>article</em> content type by default in Drupal 8, there are others that do not. In these cases, such as the <em>page</em> content type, it will need to be added to the default structure. Follow along below as we guide you on how to add the <em>comment</em> field to a <em>basic page</em> in Drupal 8.</p>

<h2>How to enable comments for a basic page</h2>
...
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/_common-images/select-structure.png"><img  alt="" style="float:right; margin:0px 0px 15px 15px;" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/_common-images/select-structure.png" title="Click here to view the larger image" max-width="250" /></a>Using the top menu bar, select the <strong>Menu</strong> option. From there, another menu will appear below. Choose the <strong>Structure</strong> option from the second menu.<div style="clear:both;"></div></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/107/enable-comment-field/1-select-content-type.png"><img  style="float:right; margin:0px 0px 15px 15px;" alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/107/enable-comment-field/1-select-content-type.png" title="Click here to view the larger image" max-width="250" /></a>This will bring up a screen of all the structure types. Click on the <strong>Content types</strong> to continue.<div style="clear:both;"></div></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/107/enable-comment-field/2-select-content-type.png"><img style="float:right; margin:0px 0px 15px 15px;"  alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/107/enable-comment-field/2-select-content-type.png" title="Click here to view the larger image" max-width="250" /></a>This will list all of the current content types available. The procedure for adding a comment field is the same regardless of content type. Select the content type you want to work with. We will work with the <em>Basic page</em> content type. Click on the <strong>Manage fields</strong> option from the dropdown to the right side of the <em>Basic page</em> row.<div style="clear:both;"></div></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/107/enable-comment-field/3-add-comment-data.png"><img style="float:right; margin:0px 0px 15px 15px;"  alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/107/enable-comment-field/3-add-comment-data.png" title="Click here to view the larger image" max-width="250" /></a>This leads you to the <em>Basic page</em> settings page. You will see the basic fields for the <em>basic page</em>, which is the <em>body</em> field. Under this field is an empty field labeled <strong>Add new field</strong>> Give the comment field a name here, most likely something line '<em>comment</em>'. <div style="clear:both;"></div></li>
<li>Next, move to the dropdown to the right and select the field type <strong>Comments</strong> from the list.<div style="clear:both;"></div></li>
<li>Once you have completed that, click on the <strong>Save</strong> button at the bottom of the page. This will activate your new <em>comment</em> field for the <em>basic page</em> 
(or whichever content type you worked with).

<table class="article_table">
<tr><th>Default</th><th>Coment field added</th><tr>
<tr><td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/107/enable-comment-field/before.png"><img  alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/107/enable-comment-field/before.png" title="Click here to view the larger image" max-width="250" /></a></td><td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/107/enable-comment-field/after.png"><img  alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/107/enable-comment-field/after.png" title="Click here to view the larger image" max-width="250" /></a></td></tr>
</table>
...
<div style="clear:both;"></div></li>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/drupal-8/comments'>107: Working with Comments in Drupal 8</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 4: Adding a comment field to a basic page in Drupal 8</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 3: <a href='/support/edu/drupal-8/comments/introduction'>Comment Introduction for Drupal 8</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 5: <a href='/support/edu/drupal-8/comments/set-page-max'>Setting maximum comments per page in Drupal 8</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/drupal-8/comments/add-comment-field&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/drupal-8/comments/add-comment-field'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NzgmaWQ9Mjk4NyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/drupal-8/comments?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Working with Comments in Drupal 8</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/drupal-8/comments/allow-visitor-comments?tsrc=rsbedu'>Allowing non-members to leave comments in Drupal 8</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/drupal-8/comments/enable-comment-editing?tsrc=rsbedu'>Allowing comment editing in Drupal 8</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/drupal-8/comments/introduction?tsrc=rsbedu'>Comment Introduction for Drupal 8</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/drupal-8/comments/add-comment-field?tsrc=rsbedu'>Adding a comment field to a basic page in Drupal 8</a></td>
                </tr>
          <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/drupal-8/comments/set-page-max?tsrc=rsbedu'>Setting maximum comments per page in Drupal 8</a></td>
                </tr>
          <tr >
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/drupal-8/comments/customize-comments?tsrc=rsbedu'>Customizing your Comments field in Drupal 8</a></td>
                </tr>
          <tr >
                        <td valign='top'>7.</td>
                        <td><a href='/support/edu/drupal-8/comments/disable-node-comment?tsrc=rsbedu'>Disabling comments for specific nodes in Drupal 8</a></td>
                </tr>
          <tr >
                        <td valign='top'>8.</td>
                        <td><a href='/support/edu/drupal-8/comments/disable-article-comment?tsrc=rsbedu'>Disabling comments for Article content type in Drupal 8</a></td>
                </tr>
          <tr >
                        <td valign='top'>9.</td>
                        <td><a href='/support/edu/drupal-8/comments/force-admin-approval?tsrc=rsbedu'>Forcing comment approval in Drupal 8</a></td>
                </tr>
          <tr >
                        <td valign='top'>10.</td>
                        <td><a href='/support/edu/drupal-8/comments/disable-title?tsrc=rsbedu'>Disabling comment titles for users in Drupal 8</a></td>
                </tr>
          	</table>
