<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:44373:" 
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:82c7fd7beae3a6dd1905d9341d5912df -->
...
<div class='container'>
	...
	<div class='item-page'>
		<div class='page-header'><h1>Search results for: <span style='color:#aaa;'>vanity</span></h1></div>
		<form method='get' action='/support/search' >
                        <input type='text' name='searchword' id='mod-search-searchword' style='width:500px;' value='vanity' />
                        <button class='button btn btn-info' onclick='this.form.searchword.focus();' style='display:inline-block; width:80px; border-radius:3px; height:32px; line-height:22px; margin:0px;'>Search</button>
                	        ...
                	        <p><a href='http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/vanity-nameservers-what-are-they-and-how-do-i-set-them-up'><b>Vanity</b> Nameservers: What are they and how do I set them up <b>...</b></a><br />May 12, 2014 <b>...</b> A <b>vanity</b> nameserver is a name server that is branded to a website of your choice, <br>
instead of our public name servers. This can make your site&nbsp;...</p>
	                
                	        <p><a href='http://www.inmotionhosting.com/support/reseller/custom-name-server'>Using Custom Nameservers as a Reseller - InMotion Hosting</a><br />May 2, 2016 <b>...</b> So if the <b>vanity</b> domain you wanted to use for your name servers was ... Can I <br>
used <b>vanity</b> NS and Custom NS at the same time, in order to get&nbsp;...</p>
	                
                	        <p><a href='http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/using-custom-name-servers'>Using custom name servers - InMotion Hosting</a><br />Mar 30, 2016 <b>...</b> Shared and Reseller hosting customers can achieve this same branding affect for <br>
their domains by instead setting up <b>vanity</b> name servers.</p>
	                
                	        <p><a href='http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/what-is-a-name-server'>What is a name server? - InMotion Hosting</a><br />Feb 28, 2014 <b>...</b> We&#39;ll also go over InMotion Hosting&#39;s public name servers, <b>vanity</b> name servers, <br>
and custom name servers. The terms name server, and&nbsp;...</p>
	                
                	        <p><a href='http://www.inmotionhosting.com/support/community-support/dns-nameserver-changes/vps-custom-nameservers'>VPS custom nameservers </a><br />Oct 11, 2012 <b>...</b> Hello mjpinla, and thanks for the question. In order to use one of your domain <br>
names as your custom name servers, this first requires that your&nbsp;...</p>
	                
                	        <p><a href='http://www.inmotionhosting.com/support/search?searchword=reseller+nameserver'>InMotion Hosting Support - InMotion Hosting</a><br />Search. Using Custom Nameservers as a Reseller This is a Reseller tutorial on <br>
how to use Custom Nameservers. Using Custom Nameservers as a Reseller&nbsp;...</p>
	                
                	        <p><a href='http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes'>DNS and Nameserver Changes </a><br />How to change your Domain Nameservers in AMP, 35,675. Using custom name <br>
servers, 28,811. <b>Vanity</b> Nameservers: What are they and how do I set them up?</p>
	                
                	        <p><a href='http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/how-do-i-make-custom-dns-records'>How do I make custom DNS records? - InMotion Hosting</a><br />May 2, 2016 <b>...</b> In this tutorial we will explain how to make custom DNS changes.</p>
	                
                	        <p><a href='http://www.inmotionhosting.com/support/reseller'>Everything Reseller </a><br />This section includes tutorials for users with Reseller accounts.</p>
	                
                	        <p><a href='http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/change-dns-records-to-use-3rd-party-services'>Change DNS records to use 3rd party services - InMotion Hosting</a><br />May 14, 2014 <b>...</b> In this article we&#39;ll go over how you can modify your domain&#39;s DNS records, in <br>
order to split up your various services between multiple hosting&nbsp;...</p>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP3NlYXJjaHdvcmQ9dmFuaXR5Jm9wdGlvbj1jb21fY29udGVudCZjYXRpZD0zNTYmaWQ9MzU2JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="b72a92774edc8bd18bfaaaf128367e73" value="1" />	</div>
	</form>
<!-- <br />
