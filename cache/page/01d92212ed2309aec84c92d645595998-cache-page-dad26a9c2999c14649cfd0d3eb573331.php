<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:64598:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/opencart/installing-opencart-and-adding-products/installing-open-cart-with-softaculous" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-08-05T20:15:12-07:00" />
  <meta name="keywords" content="install Open Cart easy with Softaculous" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="You can install Open Cart easy with Softaculous. This article will show you how." />
  <title>Installing Open Cart with Softaculous - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/opencart/installing-opencart-and-adding-products/installing-open-cart-with-softaculous" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:d474978214f5501b9d792e76432c7369 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '172.58.32.136']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Installing Open Cart with Softaculous									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>6,440</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Apr 15, 2013'><span style='color:#606060;'>Published:</span> Aug 5, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>You can install Open Cart easily by using <em>Softaculous</em> in your cPanel Software / Services. This article will teach you how to install Open Cart through Softaculous. You can then <a href="/support/edu/opencart/installing-opencart-and-adding-products/dashboard-login">login to your <strong>Administrative Dashboard</strong></a>, and begin designing your site.</p>

<h2>Steps to install Open Cart</h2>
...
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/opencart/101/install-softaculous/install-softaculous-1-click-install.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Click Install Open Cart Softaculous" src="//cdn.inmotionhosting.com/support/images/stories/edu/opencart/101/install-softaculous/install-softaculous-1-click-install.png" title="Click here to view the larger image" width="100" /></a>Navigate to the <em>Software/Services</em> section and click the icon that says <em>Softaculous</em>. On the main "<em>Top Applications</em>" screen you should see Open Carts logo in one of the boxes. 
<p>Click <strong>Install</strong>.</p>
<br style="clear: both;" /></li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/opencart/101/install-softaculous/install-softaculous-2-software-setup.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Software set up Open Cart Softaculous" src="//cdn.inmotionhosting.com/support/images/stories/edu/opencart/101/install-softaculous/install-softaculous-2-software-setup.png" title="Click here to view the larger image" width="100" /></a>Fill in the following information in the <em>Software Setup</em> and <em>Admin Account</em> Sections.
<h3>Software Setup</h3>
<p><strong>Choose Domain:</strong> Select the domain you want to install Open Cart on.<br />
<strong>In Directory:</strong> Leave this blank to install Open Cart in the document root directory of the domain you selected. Enter a folder name if you want your Open Cart installed in a subfolder.</p>

<h3>Admin Account</h3>
<p><strong>Admin Username:</strong> This is the username you will use to log into your Administrator Dashboard for your Open Cart.<br />
<strong>Admin Password:</strong> The Open Cart Administrators password.<br />
<strong>Admin Email:</strong> This needs to be a valid email address. Make sure you fill this out Softaculous will automatically create a filler email that is not valid.<br />
<strong>First Name / Last Name:</strong> This is a different name than the Open Cart Administrators login.<br />
</p>
<p>Click <strong>Install</strong>.</p>
<br style="clear: both;" /></li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/opencart/101/install-softaculous/install-softaculous-3-installing.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Installing status Open Cart Softaculous" src="//cdn.inmotionhosting.com/support/images/stories/edu/opencart/101/install-softaculous/install-softaculous-3-installing.png" title="Click here to view the larger image" width="100" /></a><strong>Wait</strong> for Softaculous to install the software.
<br style="clear: both;" />

<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/opencart/101/install-softaculous/install-softaculous-4-congratulations.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Congratulations Open Cart Softaculous" src="//cdn.inmotionhosting.com/support/images/stories/edu/opencart/101/install-softaculous/install-softaculous-4-congratulations.png" title="Click here to view the larger image" width="100" /></a>When the installer is done you will see the <em>Congratulations</em> screen stating you successfully installed Open Cart.
<p>Click <strong>Return to Overview</strong>.</p>
<br style="clear: both;" /></p></li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/opencart/101/install-softaculous/install-softaculous-5-overview.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Overview Open Cart Softaculous" src="//cdn.inmotionhosting.com/support/images/stories/edu/opencart/101/install-softaculous/install-softaculous-5-overview.png" title="Click here to view the larger image" width="100" /></a>You will now see the new Open Cart installation listed in the &quot;<em>Current Installations</em>&quot;. You can click the link or the admin icon to go either to your home page of your Open Cart site or to the administrators login.
<br style="clear: both;" />

<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/opencart/101/install-softaculous/install-softaculous-6-new-install.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="New Install Open Cart Softaculous" src="//cdn.inmotionhosting.com/support/images/stories/edu/opencart/101/install-softaculous/install-softaculous-6-new-install.png" title="Click here to view the larger image" width="100" /></a>When visiting your Open Cart site you will see a brand new web site like the snapshot to the right.
<br style="clear: both;" /></p></li>
</ol><br>
<p>Congratulations, now you know how to install OpenCart with Softaculous! Next you will want to <a href="/support/edu/opencart/installing-opencart-and-adding-products/dashboard-login">login to your <strong>Admin Dashboard</strong></a>, and begin building your website.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 1: Installing Open Cart with Softaculous</div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/opencart/installing-opencart-and-adding-products/installing-open-cart-with-softaculous&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/opencart/installing-opencart-and-adding-products/installing-open-cart-with-softaculous'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xNTAmaWQ9MjYwNyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="1df5d9ac35657615b050a614ab6c6b00" value="1" />	</div>
	</form>
<!-- <br />
          ...
          <tr >
			...
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/opencart/can-opencart-be-used-as-just-a-shopping-cart?tsrc=rsbraq'>Can OpenCart be used as just a 'shopping cart'?</a>
                                </div>
