<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:77077:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/wordpress/wordpress-introduction/wordpress-hyperlink" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-02-01T18:39:46-08:00" />
  <meta name="keywords" content="create link post page wordpress" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="Linking to other sites and posts is very common and almost necessary when creating a site. This article will show you how to do that in Wordpress." />
  <title>Creating a link in Wordpress - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/wordpress/wordpress-introduction/wordpress-hyperlink" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:80122bed550889f66df931e28eec65c6 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Creating a link in Wordpress									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>8,138</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Feb 1, 2013'><span style='color:#606060;'>Published:</span> Feb 1, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<div>
<div>When working with your Wordpress pages and posts, you may want to create a link (also called a hyperlink) to another website, or even another page or post on your site. This is done via the page or post editor. You can do so either with the Text editor or the Visual editor. Below are instructions for creating links for your WordPress content.</div>
<h2>How to create a link in your page or post</h2>
<ol class="article_list">
<li><a href="/support/edu/wordpress/wordpress-introduction/logging-into-wordpress-dashboard">Log into your WordPress admin dashboard</a>.</li>
<li>Using the left-hand side menu, click on the <strong>Post</strong> or <strong>Page</strong> menu. In this example, we will click on the <strong>Post</strong> option.</li>
<li>Now, select <strong>All Posts</strong> (or <strong>All Pages</strong>) to bring up the list of existing posts/pages.</li>
<li>Hover over the post or page you want to edit and click on the <strong>Edit</strong> link.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/create-link/click-edit.png"><img  alt="click post edit" src="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/create-link/click-edit.png" /></a></li>
<li>This opens the content editor. First highlight the text you want to create the link with. Our example will make the words '<em>link to another webpage</em>' into a link.<br /><br />In <em>Visual</em> mode, click on the link button on the toolbar, it is the one shaped like a small chain.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/create-link/1-visual-link.png"><img  alt="create visual link" src="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/create-link/1-visual-link.png" /></a><br />In <em>Text</em> mode, click on the button simply labeled link.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/create-link/2-text-link.png"><img  alt="create text link" src="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/create-link/2-text-link.png" /></a><br /><br /></li>
<li>A popup will appear where you will want to enter the URL you want to link the text to. There are three fields here to consider.<br />
<table class="article_table">
<tbody>
<tr><th>URL</th>
<td>The web address (URL) you are linking to.</td>
</tr>
<tr><th>Title</th>
<td>A text title that will appear when the visitor hovers over the link.</td>
</tr>
<tr><th>Open link in new window/tab</th>
<td>Checking this box will make the link open in a new window or tab instead of navigating away from your&nbsp; site in the current window.</td>
</tr>
</tbody>
</table>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/create-link/3-external-link.png"><img  alt="create external link" src="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/create-link/3-external-link.png" /></a><br /><br />You can also link to another page or post on your site. Click on the <strong>Or link to existing content</strong> link to open up the lower area of the popup. If needed, you can use the search function to filter the list. In our case, all posts and pages can be listed at once. Click on the page or post you want to link to. This will fill in the URL and Title fields above with the correct information.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/create-link/4-post-link.png"><img  alt="link to another post" src="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/create-link/4-post-link.png" /></a></li>
<li>Once you have entered the URL for your link, click on the <strong>Add Link</strong> button to finalize the link's creation. You can now visit the site to see your link in action.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/create-link/5-link-after.png"><img  alt="after link creation" src="//cdn.inmotionhosting.com/support/images/stories/edu/wordpress/create-link/5-link-after.png" /></a></li>
</ol></div> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 17: Creating a link in Wordpress</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 18: <a href='/support/edu/wordpress/wordpress-introduction/allowing-user-registration-wordpress'>Allowing User Registration in Wordpress</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/wordpress/wordpress-introduction/wordpress-hyperlink&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/wordpress/wordpress-introduction/wordpress-hyperlink'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xMzgmaWQ9MjIyMyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="d8a6b8a15ce2df0b2659d08c8d99c214" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/e333c46cb9dfd5cb58b489c01e22cb19?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/e333c46cb9dfd5cb58b489c01e22cb19'>liz packwood</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-08 3:33 am</div>
				                <div>Thank you so much...it's a simple thing but I could not find it so am very happy ...sometimes it is tricky to find these simple instructions...the codex was all about coding the link in. And I'm not doing any coding yet, but I really need to start off with simple instructions. maybe you can help with that too. Can I subscribe to your site?</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12484);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-08 12:41 pm</div>
				                <div>Hello Liz,<br />
<br />
Thanks for the question!  We don't really have a subscription process for our page at this time.  However, please feel free to bookmark and then reference it when you need help.  You can always questions, even if you're not a customer.  We would be happy to help.<br />
<br />
Thanks again for you time and patience!<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12497);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-23132'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/c85940c26e91a9c8d2784a164e0de415?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/c85940c26e91a9c8d2784a164e0de415'>Mohamed A Attiah</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-05-02 2:58 pm</div>
				                <div><p>I am trying&nbsp;to hyperlink the text on the webpage to a specific PDF document which was previously uploaded to the library.&nbsp;</p>
<p>This procedure is not working in this case because the URL I am getting pertains to the library page NOT to the specific document I want to link.</p>
<p>Your help is most appreciated?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23132);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-05-03 8:08 am</div>
				                <div>Hello Mohamed,<br />
<br />
Are you trying to link to the document specifically? Are you able to provide a link so we can see what you are talking about? This would possibly help us better understand the issue.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23139);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-05-03 6:39 pm</div>
				                <div><p>Thanks Scott for your offer to help. I was trying to hyper link a text on my webpage so it can open a PDF document which I had previously uploaded to the media library.&nbsp;</p>
<p>The solution as I found was not that difficult.</p>
<p>1. First I had to click on the document icon inside my&nbsp;library.</p>
<p>2. This opens another page with lots of info about the document. On the right hand side of the page there is a box that contains the&nbsp;URL link of the document on the server. I then had to highlight the URL, copy it using the mouth right click.</p>
<p>3. I move back to my webpage editor, highlight the text I desire to hyperlink then click the chain on the menue to link.</p>
<p>4.&nbsp;<span style="color: rgb(35, 35, 35); font-family: adelle-sans, Helvetica, Arial, sans-serif; font-size: 13px; line-height: 22px; background-color: rgb(248, 248, 248);">A popup will appear where I&nbsp;will have to paste the URL that I want to link the text to.</span></p>
<p><span style="color: rgb(35, 35, 35); font-family: adelle-sans, Helvetica, Arial, sans-serif; font-size: 13px; line-height: 22px; background-color: rgb(248, 248, 248);">Thanks for your support</span></p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>I followed the same procedure i.e. I first&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23148);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
