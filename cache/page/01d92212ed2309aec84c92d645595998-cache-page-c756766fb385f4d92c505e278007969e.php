<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50302:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/how-to/host-multiple-sites" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, Thank you for your question about hosting multiple sites in your account. Power plans can host up to 6 different websites in one hosting account,..." />
  <title>Multiple Site Hosting Question | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/how-to/host-multiple-sites" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:eb79d5c2102fd95dcb35d9943d09f86a -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '81.149.113.69']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Multiple Site Hosting Question</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-01-11 12:19 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>989</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I currently have the power plan hosting plan while hosting 1 website currently.  I recently registered a new domain and would like to host that domain under my current plan instead of purchasing new hosting. <br />
 Is that possible under the power plan here on Inmotion?</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_6264' id='upvote_answer_6264' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='6264' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_6264').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_6264' id='downvote_answer_6264' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='6264' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_6264').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
Thank you for your question about hosting multiple sites in your account. <strong>Power</strong> plans can host up to 6 different websites in one hosting account, see our comparison chart <a href="http://www.inmotionhosting.com/business-hosting">here</a>.<br />
<br />
Adding the new site as an <a href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-manage-domains/adding-add-on-domain-in-cpanel">Addon Domain</a> in your cPanel, will create the folders for storing your new site.<br />
<br />
This information is incuded in our guide on <a href="http://www.inmotionhosting.com/support/domain-names/registrations-and-transfers/add-another-domain-name-account">how to add another domain name to your account</a>,<br />
<br />
Be sure to allow up to 24 hours for the new domain to <a href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/domain-names-dns-changes">propagate</a> to the world.<br />
<br />
...
John-Paul
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_6264').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_6264' id='form_comment_on_answer_6264' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="bbde4262b5005d8d3de764f552d1ccdc" value="1" />	</div>
	</form>
<!-- <br />
