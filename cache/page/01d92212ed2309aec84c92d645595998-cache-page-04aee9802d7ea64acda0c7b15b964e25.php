<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:62530:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.net/support/edu/moodle/new-to-moodle/language-pack" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-12-05T13:38:16-08:00" />
  <meta name="keywords" content="Moodle Language packs installed removed multiple languages installing  language pack Spanish  2.3 install change changing changes removing remove" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="Moodle includes a vast array of Language packs that can be installed or removed, allowing the site to be viewed in multiple languages. This article will focus on installing a language pack for Spanish in Moodle 2.3." />
  <title>Installing a Language pack in Moodle - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/moodle/new-to-moodle/language-pack" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:77e689e06e8ef67a2f817d8aa335cf77 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '157.55.39.203']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Installing a Language pack in Moodle									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>3,400</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Nov 28, 2012'><span style='color:#606060;'>Published:</span> Dec 5, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>When Moodle is initially installed, the language will be set to the one specified in the installation steps. Many educational institutions offer multilingual capabilities for their students who speak different languages other than the default&nbsp; language. To accommodate this need, Moodle included a vast array of<strong> Language packs</strong> that can be installed or removed. This allows the Moodle site to be viewed in multiple languages. This article will focus on installing a language pack for Spanish in Moodle 2.3.</p>
...
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/101/language-pack/language-pack-1-select.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="language-pack-1-select-moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/101/language-pack/language-pack-1-select.gif" title="Click here to view the larger image" width="200" /></a> Navigate to the <strong>Site administration</strong> &gt; <strong>Language</strong> &gt; <strong>Language packs</strong> section in the settings. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/101/language-pack/language-pack-2-add.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="language-pack-2-add-moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/101/language-pack/language-pack-2-add.gif" title="Click here to view the larger image" width="200" /></a>On the <strong>Language import utility </strong>page, select the language to install.
<p>Click <strong>Install selected language pack</strong>.</p>
<p>On the left hand side, the language will show in the <strong>Installed language packs</strong> list.</p>
<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/101/language-pack/language-pack-3-settings.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="language-pack-3-settings-moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/101/language-pack/language-pack-3-settings.gif" title="Click here to view the larger image" width="200" /></a> To set the default language, navigate to <strong>Site administration</strong> &gt; <strong>Language</strong> &gt; <strong>Language settings</strong>. <br style="clear: both;" />
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/101/language-pack/language-pack-4-auto-detect.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="language-pack-4-auto-detect-moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/101/language-pack/language-pack-4-auto-detect.gif" title="Click here to view the larger image" width="200" /></a> Deselect the Language autodetect check box and select the Language from the Default language drop box. <br style="clear: both;" /></p>
<p><strong>Save the changes</strong>.</p>
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/101/language-pack/language-pack-5-final.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="language-pack-5-final-moodle" src="//cdn.inmotionhosting.com/support/images/stories/edu/moodle/101/language-pack/language-pack-5-final.gif" title="Click here to view the larger image" width="200" /></a>Now the option to select the language will appear at the top of the site. Selecting the language from the drop box will automatically change the language for the site.
<p class="alert"><strong>Important!</strong> If the courses are set up in English in the first place, Moodle will not translate those sections. Moodle only translates the core language of the Moodle software with the Language packs.</p>
<br style="clear: both;" /></li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 15: Installing a Language pack in Moodle</div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.net/support/edu/moodle/new-to-moodle/language-pack&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.net/support/edu/moodle/new-to-moodle/language-pack'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNzQmaWQ9MjAyMCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
        ...
        <tr><td colspan='2'><h4>Configuring Languages</h4></td></tr>  <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>15.</td>
