<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:54133:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/roundcube-webmail/webmail-server-errors-appear-to-be-logged-out" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Mike, Sorry to hear you are having an issue with your RoundCube. In speaking with higher admin folks they are not aware of a setting that limits a..." />
  <title>webmail server errors - appear to be logged out | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/roundcube-webmail/webmail-server-errors-appear-to-be-logged-out" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:43d597c45c77e63b9ee131b605c670bb -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '46.116.223.185']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box straight_bottom'>
                <h1 style='font-size:26px;'>webmail server errors - appear to be logged out</h1>
		<div style='margin-bottom:20px; margin-top:10px; clear:both; color:#6e6e6e;'>Category: <a href='/support/community-support/roundcube-webmail'>Roundcube Webmail</a></div>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/8907FamilyMike'>8907FamilyMike</a>
			<div>8 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-06-29 3:28 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>738</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I'm using Roundcube webmail.  If I don't use it actively for a few minutes I get a dialog box that says &quot;an Error Occurred! Server Error! (Access Denied)&quot;, and it appears that I'm logged out.  Is there some way to reset this apparent timeout to something more like 30 mins?  I looked at cpanel and amp and didn't see anything but as I'm a new user I may have missed it.<br />
<br />
Thanks,  Mike.</div>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px;'>
				<div style='font-size:12px; max-width:500px; overflow:auto;'>We are having the same problem  &quot;an Error Occurred! Server Error! (Access Denied)&quot;,  directly in Roundcube.<br />
<br />
Other issues are Roundcube time zone and date format revert back to defaults rather than keeping our correct time zone.</div>
			...
			<td style='width:100px;' valign='top'>
				...
				<div class='smallgrey'>
					<a href='/support/community-support/users/fiedler'>fiedler</a><br />
					19 <a href='/support/team/points' target='_blank'>Points</a><br />
					2015-12-23 04:17 pm EST
				</div>
			</td>
		</tr>
	</table>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_7541' id='upvote_answer_7541' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='7541' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_7541').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_7541' id='downvote_answer_7541' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='7541' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_7541').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Mike,<br />
<br />
Sorry to hear you are having an issue with your RoundCube. In speaking with higher admin folks they are not aware of a setting that limits a webmail session. Does this happen with specific browsers? Is it only specific email addresses? Have you tried a third party email client like Outlook, Thunderbird, or Opera?<br />
<br />
Kindest Regards,<br />
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_7541').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_7541' id='form_comment_on_answer_7541' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
  ...
  I'm using Firefox, but am testing the suspect email account on Chrome and a different email account on Firefox.  Not sure what an imap session would have to do with a webmail session, but I don't get errors in Outlook via imap (that I've seen so far).<br />
<br />
After about 10 mins in Chrome i did not get any errors, nor did I get any on the other email account in Firefox. Am now running the 'problem account' in another Firefox tab and will see if it happens again or was just an apparent fluke.  It happened to me 3 or 4 times (only on the webmail client) this afternoon while I was testing send/receive between outlook in pop3 on other accounts and this one as imap. both in webmail and through the Outlook client.  If it happens again I'll get more details if I can.<br />
<br />
...
Mike.</div>
							...
							<td style='width:96px;' valign='top'>
								<img src='/support/images/avatars/default_avatar.jpg' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/8907FamilyMike'>8907FamilyMike</a><br />
									8 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2015-06-29 4:11 pm EST
								</div>
				...
				<div style='padding:15px 15px 15px 76px; border:1px solid #ddd; border-top:0px; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Fiedler,<br />
<br />
We're sorry that you're seeing error with Roundcube.  We do need more information to troubleshoot the issue.  If you're hosted with us, can you please provide the email address you're trying to use login? If you want to handle the issue privately, then please submit a verified support ticket to our live technical support team. The timezone issue cannot be fixed if you're running Roundcube from a shared server.  The timezone on the server is what applies to all of the email times.<br />
<br />
...
Arnel C.</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/roundcube-webmail/webmail-server-errors-appear-to-be-logged-out&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/roundcube-webmail/webmail-server-errors-appear-to-be-logged-out'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="3bdb8a53ab49c77e7d6f99d741df1cce" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
                                ...
                                <h3>Related Articles</h3><a target='_blank' href='http://inmotionhosting.com/support/html-signature-image'>How to Add an Image to Your RoundCube HTML Signature</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/read-new-message'>How to Read a new Email message in Roundcube</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/how-to-compose'>How to Compose an email in Roundcube</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/import-email-contact-list'>How to import a contact list in your Roundcube mail client</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/export-contact-list'>How to export contacts in the Roundcube email client</a><br/><br />
		</div>
