<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:61151:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/wordpress/failed-to-write-to-disk" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2011-11-03T15:35:05-07:00" />
  <meta name="keywords" content="wordpress error failed to write file to disk" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="If you're getting a Failed to write file to disk error in WordPress, most often your tmp upload folder is full." />
  <title>WordPress Error : Failed to write file to disk - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/wordpress/failed-to-write-to-disk" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<script type="text/javascript">
		...
		_gaq.push(['_setCustomVar', 3, 'DateMonthModified', '2011-11', 3]);
	...
	<!-- cid:aea855fcc1dd8048e0cf581026b0d187 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '212.18.223.26']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															WordPress Error : Failed to write file to disk									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>21,480</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Nov 3, 2011'><span style='color:#606060;'>Published:</span> Nov 3, 2011</div>
							...
							<div style='clear:both;'></div>
								...
								<p>When troubleshooting error messages similar to "Failed to write file to disk", the most common causes include:</p>
<ul>
<li>The server's hard drive is full</li>
<li>The server's tmp folder is full</li>
<li>There are not sufficient privileges set to the folder being written to</li>
</ul>
<p>This error, "Failed to write file to disk", within WordPress generally means that the tmp folder is full. While there could be other causes of the error, a review of posts in WordPress' forums shows the issue is most often with your php tmp folder setup, upload_tmp_dir.</p>
<h2>If you are an InMotion Hosting Customer</h2>
<p>The default WordPress installation with InMotion Hosting has no problems with the tmp folder and how WordPress uploads images. If you are getting this error, <a href="/support/website/general-server-setup/update-local-php-settings">Create a phpinfo.php file</a> and check what the "upload_tmp_dir" is set to. If it is set to:</p>
<ul>
<li>"no value" - WordPress is defaulting to the /tmp folder on the server. This is rare, but the /tmp folder may have become full. Please <a href="/support/website/website-troubleshooting/how-to-get-great-technical-support">contact our Support Department</a> for further assistance.</li>
<li>something other than "no value" - It would appear that you have a custom folder set for your upload_tmp_dir. Please ensure that you have that <a href="/support/website/how-to/change-file-permissions">folder's permissions</a> set to 755.</li>
</ul>
<ul>
</ul>
<h2>If you are not an InMotion Hosting Customer</h2>
<p>If you are not an InMotion Hosting customer, the same items as above generally apply. If you have not set a custom upload_tmp_dir, then you're using the server's default tmp folder and you should contact your host and ask for help with checking to see if the /tmp folder is full or not.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/wordpress/failed-to-write-to-disk&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/wordpress/failed-to-write-to-disk'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD02MyZpZD0yODYmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="f0be95bd514c0e12d566ec581a0dc1a1" value="1" />	</div>
	</form>
<!-- <br />
