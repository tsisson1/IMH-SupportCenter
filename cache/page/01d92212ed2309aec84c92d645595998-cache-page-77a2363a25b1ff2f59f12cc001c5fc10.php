<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50306:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/cpanel/how-can-i-increase-php-memory-limit" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello juliusb, The default php.ini is located in the /usr/lib directory. You are able to access and alter that via SSH with your main account username a..." />
  <title>How can I increase php memory limit? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/cpanel/how-can-i-increase-php-memory-limit" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:c48fb581c34cdb37d20cbb040b45381b -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>How can I increase php memory limit?</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/juliusb'>juliusb</a>
			<div>11 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-09-19 9:13 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>1,438</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>We need to increase default php memory limit from 256M to 512M on VPS 2000 server.</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_1569' id='upvote_answer_1569' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='1569' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_1569').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_1569' id='downvote_answer_1569' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='1569' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_1569').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello juliusb,<br />
<br />
The default php.ini is located in the /usr/lib directory. You are able to access and alter that via <a href="http://www.inmotionhosting.com/support/website/general-server-setup/how-to-login-ssh" target="_blank">SSH</a> with your main account username and password.<br />
<br />
Best Regards,<br />
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_1569').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_1569' id='form_comment_on_answer_1569' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/cpanel/how-can-i-increase-php-memory-limit&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/cpanel/how-can-i-increase-php-memory-limit'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="d38f257e8cfa63340a01d1fcb59e7f19" value="1" />	</div>
	</form>
<!-- <br />
