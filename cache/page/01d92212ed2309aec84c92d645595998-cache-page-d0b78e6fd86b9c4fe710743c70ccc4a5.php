<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:60078:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-3/breadcrumbs/text-separator" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-04-25T15:16:29-07:00" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="The text separator setting allows you to separate items in your Joomla 3 breadcrumbs using something other than the default orange arrow." />
  <title>Text Separator - Joomla 3 Breadcrumb settings - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-3/breadcrumbs/text-separator" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:cda88d03fb56fbe59b1442093395829d -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Text Separator - Joomla 3 Breadcrumb settings									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>2,017</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Apr 25, 2014'><span style='color:#606060;'>Published:</span> Apr 25, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Be default, individual items in your <a href="/support/edu/joomla-3/breadcrumbs">Joomla 3 breadcrumbs</a> are separated by an orange arrow, <img src='/support/media/system/images/arrow.png' />. You actually have the option to use a different separator in your breadcrumbs, and you can change the separator using the <strong>Text Separator</strong> breadcrumb setting.</p>

<p>Joomla doesn't say much about the <em>Text Separator</em> setting. The <em>help</em> information they provide in the dashboard is as follows:</p>

<p class='white_box'><strong>Text Separator</strong><br />A text separator</p>

<p>What they meant to say was:</p>

<ul>
<li>If you don't want the orange arrow to show, enter a new separator here.</li>
<li>You cannot use html in this setting, such as an image, only text is valid.</li>
</ul>

<p>Below, we'll show you how to change the <em>Text Separator</em>.</p>
...
<ol class='article_list'>
  ...
  <li>Find and click on your <em>breadcrumbs</em> module</li>
  
  <li>
  
  <p>Find the <em>Text Separator</em> setting. Depending on your Joomla version, it should be under either the <em>Module</em> tab or the <em>Basic Settings</em> tab.</p>
  
  <p>Enter a value here, such as a forward slash. Then save the change by clicking <strong>Save</strong> in the top menu.</p>
  
  <p>Below are screenshots showing how the change we made affected our breadcrumbs:</p>
  
  <table>
  <tr>
  <th style='padding-right:15px;'>Text Separator left blank</th>
    <td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/breadcrumbs/blank-separator.png"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/breadcrumbs/blank-separator.png"  /></a></td>
  </tr>
  <tr>
    <th>Text Separator set as /</th>
    <td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/breadcrumbs/slash-separator.png"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/breadcrumbs/slash-separator.png"  /></a></td>
  </tr>
  </table>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/joomla-3/breadcrumbs'>Breadcrumbs</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 5: Text Separator - Joomla 3 Breadcrumb settings</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 4: <a href='/support/edu/joomla-3/breadcrumbs/show-last'>Hide the current page</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-3/breadcrumbs/text-separator&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-3/breadcrumbs/text-separator'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD01MDYmaWQ9MzIyMiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="f01c87dc073ed6a668307c760dae7358" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/joomla-3/breadcrumbs?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'></h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/joomla-3/breadcrumbs/you-are-here?tsrc=rsbedu'>Remove "You are here"</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/joomla-3/breadcrumbs/show-home?tsrc=rsbedu'>Remove "Home"</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/joomla-3/breadcrumbs/text-for-home-entry?tsrc=rsbedu'>Change "Home"</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/joomla-3/breadcrumbs/show-last?tsrc=rsbedu'>Remove current page</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/joomla-3/breadcrumbs/text-separator?tsrc=rsbedu'>Change "Text Separator"</a></td>
                </tr>
          	</table>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/7f112ddf6227e8133e281d9fe371af1c?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/7f112ddf6227e8133e281d9fe371af1c'>Head-e</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-23 1:55 am</div>
				                <div><p>This should be able to overwritten on the template level with a template override mod_breadcrumbs/default.php instead of being in the helper.php script.&nbsp; This is a great example of how Joomla is NOT fully customizable without core hacks.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17748);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
