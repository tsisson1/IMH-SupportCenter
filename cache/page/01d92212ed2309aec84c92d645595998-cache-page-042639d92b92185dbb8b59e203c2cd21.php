<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49990:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/ssl/install-ssl-before-i-have-my-domain" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, Thank you for your question today. Yes, you may purchase an SSL certificate and have it installed on your server before pointing the domain to ou..." />
  <title>Install SSL before I have my domain pointed | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/ssl/install-ssl-before-i-have-my-domain" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:39aa186b8a731d1db54983ad505f4061 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '88.157.148.190']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Install SSL before I have my domain pointed</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-10-27 5:05 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>1,011</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Can I purchase (through InMotion) and install a dedicated SSL before I change DNS for my domain?  I'm trying to develop an eCommerce WordPress site and want to get it all working before I change the DNS to point to the new site... which means my InMotion site does not have its real domain yet.</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_4150' id='upvote_answer_4150' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='4150' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_4150').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_4150' id='downvote_answer_4150' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='4150' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_4150').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
Thank you for your question today. Yes, you may purchase an <a href="http://www.inmotionhosting.com/support/website/ssl/what-is-ssl-and-why-is-it-important">SSL certificate</a> and have it installed on your server before pointing the domain to our <a href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/updating-your-domains-nameservers">nameservers</a>. You would simply need to do a temporary <a href="http://www.inmotionhosting.com/support/website/how-to/modifying-your-hosts-file">hosts file modification</a> in order to test it, however.<br />
<br />
Kindest Regards,<br />
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_4150').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_4150' id='form_comment_on_answer_4150' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/ssl/install-ssl-before-i-have-my-domain&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/ssl/install-ssl-before-i-have-my-domain'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="7c47be5ea758fb70368fd3bbccd79da5" value="1" />	</div>
	</form>
<!-- <br />
