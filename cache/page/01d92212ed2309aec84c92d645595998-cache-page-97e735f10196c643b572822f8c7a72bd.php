<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:64386:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/everything-email/email-features/how-to-setup-an-autoresponder" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-12-11T18:23:35-08:00" />
  <meta name="author" content="John-Paul Briones" />
  <meta name="description" content="InMotion Hosting Support Center" />
  <title>How to Create an Email Autoresponder in Webmail - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/everything-email/email-features/how-to-setup-an-autoresponder" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<script type="text/javascript">
		...
		_gaq.push(['_setCustomVar', 4, 'DateMonthPublished', '2015-06', 3]);
	...
	<!-- cid:c77c47cde5cd1a4531bf8ec57e5b63cb -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '81.155.91.179']);
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/everything-email' itemprop='url'><span itemprop='title'>Everything Email<span></a><div class='dropdown_4columns'><h2>Everything Email Education Channel</h2><div class='col_2'><h3>100 Level Classes</h3><div><a href='/support/edu/everything-email/introduction-email'>101: Basic Introduction to Email</a></div><div><a href='/support/edu/everything-email/email-features'>102: Email Features</a></div><div><a href='/support/edu/everything-email/organizing-email'>103: Organizing your Email</a></div></div><div class='col_2'><h3>200 Level Classes</h3><div><a href='/support/edu/everything-email/spam-prevention-techniques'>201: Dealing with Spam</a></div><div><a href='/support/edu/everything-email/202-using-dada-mail-for-sending-newsletters'>202: Using DaDa Mail for sending Newsletters</a></div><div><a href='/support/edu/everything-email/203-common-email-errors'>203: Common Email errors</a></div><div><a href='/support/edu/everything-email/mcafee'>203: McAfee Email Protection</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/everything-email/email-features' itemprop='url'><span itemprop='title'>102: Email Features<span></a><div class='dropdown_3columns'><h2> Email Features</h2><div class='col_3'><div>1. <a style='display:inline;' href='/support/edu/everything-email/email-features/how-to-setup-an-autoresponder'>How to Create an Email Autoresponder in Webmail</a></div><div>2. <a style='display:inline;' href='/support/edu/everything-email/email-features/configuration-editing-email-profile'>Configuration Options and Editing your Email Profile</a></div><div>3. <a style='display:inline;' href='/support/edu/everything-email/email-features/managing-address-book'>Managing your Address Book</a></div><div>4. <a style='display:inline;' href='/support/edu/everything-email/email-features/adding-email-signature'>Adding an Email Signature </a></div><div>5. <a style='display:inline;' href='/support/edu/everything-email/email-features/set-up-email-forwarder'>How to Setup an Email Forwarder in cPanel & Webmail</a></div><div>6. <a style='display:inline;' href='/support/edu/everything-email/email-features/email-calendars'>Email Calendars Explained</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to Create an Email Autoresponder i...</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to Create an Email Autoresponder in Webmail									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>3,236</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jun 29, 2015'><span style='color:#606060;'>Published:</span> Dec 11, 2015</div>
							...
							<div style='clear:both;'></div>
								...
								<iframe width="560" height="315" src="https://www.youtube.com/embed/WRa4z0dkCy4" frameborder="0" allowfullscreen></iframe>
<div class="in_this_tutorial">
  <h2>In this tutorial:</h2>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('what');">What is an AutoResponder?</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('when');">When to use an AutoResponder</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('how');">How to Setup an AutoResponder</button>
</div>
...
<p>An autoresponder is a feature within your email settings that allows you to automatically send a response when an email is sent to a specific email address.</p>

<a name="when"></a>
<h2>When should I use an AutoResponder?</h2>
<p>It's really up to you when to use the autoresponder feature. Typically, businesses will use the autoresponder feature to let others know when they are out of the office, to confirm receipt of an email, and to acknowledge and thank customers for an order that may have been placed.</p>

<a name="how"></a>
<h2>How do I Setup an AutoResponder in Webmail</h2>

<ol class="article_list">
<li><a href="/support/edu/cpanel/cpanel-email/test-webmail-login">Login to Webmail</a>.</li>
<li>Click the <strong>Auto Responders</strong> button on the bottom of the page.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/email/autoresponder/auto-responder-link.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/email/autoresponder/auto-responder-link.png" alt="Setup Auto Responder in Webmail" title="Webmail AutoResponder" /></a><br><br>
You will then be on the <em>Auto Responders</em> page. Any existing Email Forwarders will be listed.</li>
<li>Click the <strong>Add Auto Responder</strong> button.<br>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/email/autoresponder/adding-auto-responder.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/email/autoresponder/adding-auto-responder.png" alt="cPanel Email Responder" title="Adding an Autoresponder in Webmail" /></a></li>
<li>You will now be able to fill in the fields to setup your AutoResponder. Below is a brief description of the available options.<br>
...
<tr>
<td>Character Set</td>
<td>The standard Character set is "<strong>utf-8</strong>," but you can change it here.</td>
</tr>

<tr>
<td>Interval</td>
<td>Here you can set how many hours to wait before autoresponding to the same email address.</td>
</tr>

<tr>
<td>Email</td>
<td>This will list the email address you are setting up the autoresponder for.</td>
</tr>

<tr>
<td>From</td>
<td>You can enter a "<strong>From</strong>" address here. I recommend using the same address a the Email field.</td>
</tr>

<tr>
<td>Subject</td>
<td>Enter a subject line here. For example: "John is out of the office."</td>
</tr>

<tr>
<td>HTML</td>
<td>Check this if you want to enter HTML into the "Body" of your email.</td>
</tr>

<tr>
<td>Body</td>
<td>Enter your Autoresponder message here.</td>
</tr>

<tr>
<td>Start</td>
<td>Choose if want this autoresponder to begin <strong>Immediately</strong> or set a <strong>Custom</strong> start time.</td>
</tr>

<tr>
<td>Stop</td>
<td>Here you can set a <strong>Custom</strong> date for your Autoresponder to stop responding, or set to <strong>Never</strong></td>
</tr>
...
<li>Click the <strong>Create/Modify</strong> button to save your changes. You are finished when you see a message stating "<em>You have successfully created auto responder.</em>"</li>

</ol>
<br>
<p>Congratulations, now you know how to setup an email AutoResponder in WebMail! You can also <a href="/support/edu/cpanel/cpanel-email/setup-auto-responder">Setup an AutoResponder in cPanel</a>.</p>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/everything-email/email-features/how-to-setup-an-autoresponder&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/everything-email/email-features/how-to-setup-an-autoresponder'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xNDQmaWQ9MzU5MyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="593efbe2842a36ca5c7c0f12fef91d79" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/everything-email/email-features?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Email Features</h3></a>
		<table>  <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/everything-email/email-features/how-to-setup-an-autoresponder?tsrc=rsbedu'>How to Create an Email Autoresponder in Webmail</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/everything-email/email-features/configuration-editing-email-profile?tsrc=rsbedu'>Configuration Options and Editing your Email Profile</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/everything-email/email-features/managing-address-book?tsrc=rsbedu'>Managing your Address Book</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/everything-email/email-features/adding-email-signature?tsrc=rsbedu'>Adding an Email Signature </a></td>
                </tr>
          <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/everything-email/email-features/set-up-email-forwarder?tsrc=rsbedu'>How to Setup an Email Forwarder in cPanel & Webmail</a></td>
                </tr>
          <tr >
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/everything-email/email-features/email-calendars?tsrc=rsbedu'>Email Calendars Explained</a></td>
                </tr>
          	</table>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/5d6a2831e0a547222cfa777353799267?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/5d6a2831e0a547222cfa777353799267'>Leslie</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-02-19 1:00 pm</div>
				                <div><p>Ive set up an autoresponder but there are certain recipients I dont want to receive it.&nbsp; How do I set exceptions?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30690);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-02-20 3:37 am</div>
				                <div>Hello Leslie,<br />
<br />
Unfortunately there is no way at this time to set up exceptions to receiving the auto responder message.<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30702);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-32151'></a>
		<div  style='margin:2px 0px 0px 80px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/c25451c9a8a8daadd12ac447e9232ac8?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/c25451c9a8a8daadd12ac447e9232ac8'>Volkan Dogan</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-21 12:01 pm</div>
				                <div><p>when i set up the autoreply, it replies back as 1 line...no body structure or anything...is there anyway to change this?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32151);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-21 12:51 pm</div>
				                <div>Helo Volkan,<br />
<br />
Thank you for contacting us. You can try using HTML to format the message, but keep in mind the recipients may not choose to display your email correctly, since it is a preference in their email client.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32153);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
