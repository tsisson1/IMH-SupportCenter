<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:62501:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/drupal-7/working-with-images/set-min-upload-size" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-07-24T15:04:36-07:00" />
  <meta name="keywords" content="minimum min upload resolution size Drupal 7" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="By following the instructions in this Drupal 7 article,  you will learn how to set the minimum image resolution for uploads." />
  <title>How to set the min upload image size in Drupal 7 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/drupal-7/working-with-images/set-min-upload-size" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:5a65b77d154fd09d84ab33e37a66fd8d -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '167.56.44.132']);
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/drupal-7' itemprop='url'><span itemprop='title'>Drupal 7<span></a><div class='dropdown_4columns'><h2>Drupal 7 Education Channel</h2><div class='col_2'><h3>100 Level Classes</h3><div><a href='/support/edu/drupal-7/getting-started'>101: Installing and Getting Started with Drupal 7</a></div><div><a href='/support/edu/drupal-7/working-with-content'>102: Working with Content in Drupal 7</a></div><div><a href='/support/edu/drupal-7/homepage'>103: Working with your Drupal 7 homepage</a></div><div><a href='/support/edu/drupal-7/blocks-and-regions'>104: Working with Blocks and Regions in Drupal 7</a></div><div><a href='/support/edu/drupal-7/menus'>105: Working with Menus in Drupal 7</a></div><div><a href='/support/edu/drupal-7/customize-theme'>106: Working with themes in Drupal 7</a></div><div><a href='/support/edu/drupal-7/managing-users'>107: Managing Users in Drupal 7</a></div><div><a href='/support/edu/drupal-7/comments'>108: Working with Comments in Drupal 7</a></div><div><a href='/support/edu/drupal-7/working-with-images'>109: Working with Images in Drupal 7</a></div></div><div class='col_2'><h3>200 Level Classes</h3><div><a href='/support/edu/drupal-7/intro-to-modules'>201: An Introduction to Drupal 7 Modules</a></div><div><a href='/support/edu/drupal-7/sef-urls'>202: Search Engine Friendly URLs in Drupal 7</a></div><div><a href='/support/edu/drupal-7/forums'>203: Creating and Managing Forums in Drupal 7</a></div><div><a href='/support/edu/drupal-7/contact-us-page'>204: Creating a Contact Us Page in Drupal 7</a></div><div><a href='/support/edu/drupal-7/blogging'>205: Blogging in Drupal 7</a></div><div><a href='/support/edu/drupal-7/configure-caching'>206: Configuring Caching in Drupal 7</a></div><div><a href='/support/edu/drupal-7/configure-rss-feeds'>207: Configuring RSS Feeds in Drupal 7</a></div><div><a href='/support/edu/drupal-7/blocking-ips'>208: Blocking IP Addresses in Drupal 7</a></div><div><a href='/support/edu/drupal-7/reports-and-logs'>209: Drupal 7 Administrative Reports and Logs</a></div><div><a href='/support/edu/drupal-7/basic-setup'>210: Changing common configuration settings in Drupal 7</a></div><div><a href='/support/edu/drupal-7/views-module-tutorial'>211: Views Module Tutorial</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/drupal-7/working-with-images' itemprop='url'><span itemprop='title'>109: Working with Images in Drupal 7<span></a><div class='dropdown_3columns'><h2> Working with Images in Drupal 7</h2><div class='col_3'><div>1. <a style='display:inline;' href='/support/edu/drupal-7/working-with-images/enable-images-in-basic-pages'>How to enable images for Basic Pages in Drupal 7</a></div><div>2. <a style='display:inline;' href='/support/edu/drupal-7/working-with-images/edit-allowed-file-types'>How to change the allowed image file types in Drupal 7</a></div><div>3. <a style='display:inline;' href='/support/edu/drupal-7/working-with-images/set-max-upload-size'>How to set the max upload image size in Drupal 7</a></div><div>4. <a style='display:inline;' href='/support/edu/drupal-7/working-with-images/set-min-upload-size'>How to set the min upload image size in Drupal 7</a></div><div>5. <a style='display:inline;' href='/support/edu/drupal-7/working-with-images/set-max-upload-file-size'>How to set max image upload file size in Drupal 7</a></div><div>6. <a style='display:inline;' href='/support/edu/drupal-7/working-with-images/set-image-title'>How to set the image title in Drupal 7</a></div><div>7. <a style='display:inline;' href='/support/edu/drupal-7/working-with-images/edit-max-number'>Changing the max number of images allowed in Drupal 7</a></div><div>8. <a style='display:inline;' href='/support/edu/drupal-7/working-with-images/add-image-subfolder'>How to add a subfolder to default image directory in Drupal 7</a></div><div>9. <a style='display:inline;' href='/support/edu/drupal-7/working-with-images/create-preview-style'>How to create an image preview style in Drupal 7</a></div><div>10. <a style='display:inline;' href='/support/edu/drupal-7/working-with-images/set-default-image'>How to set a default image for content types in Drupal 7</a></div><div>11. <a style='display:inline;' href='/support/edu/drupal-7/working-with-images/change-preview-style'>How to modify image preview style in Drupal 7 </a></div><div>12. <a style='display:inline;' href='/support/edu/drupal-7/working-with-images/remove-label-field'>How to remove the label from an image field in Drupal 7</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to set the min upload ima...</span></li>			</ul>
		</div>
	</div>
</div>
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
				<img src='/support/images/stories/drupal-partner/supporting-partner-80_3.png' style='float:right; margin:0px 0px 15px 15px;' alt='Drupal Association Support Partner'>		<h1>
															How to set the min upload image size in Drupal 7									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>2,652</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jul 23, 2012'><span style='color:#606060;'>Published:</span> Jul 24, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>When working with your images in Drupal 7, there are many settings you can adjust to optimize and customize the site you have in mind. One of these settings is to set a minimum size for uploading images. This is for when you may have a particular width and height range you want to work with. Setting this minimum size means that any users who upload images must ensure that the image is at least the height and width that you specify, otherwise the image will be rejected. Modifying the minimum height and width for uploadable images in Drupal 7 is easily done within the admin dashboard. Below are the instructions on how to perform just that.</p>
<h2>Modifying the minimum height and width for image uploads in Drupal 7:</h2>
<ol>
<li><a href="/support/edu/drupal-7/getting-started/how-to-log-into-the-drupal-admin-dashboard">Log into the Drupal 7 admin dashboard</a>.</li>
<li>Using the top menu bar, locate and click on the <strong>Structure </strong>option.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/structure.png"><img  alt="structure" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/structure.png" /></a></li>
<li>From this next page, click on the <strong>Content Types</strong> link.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Content_Types/content-types.jpg"><img  alt="content-types" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Content_Types/content-types.jpg" /></a></li>
<li>On the <strong>Content Types</strong> page, find the <strong>Basic Pages</strong> row and click on the <strong>Manage Fields</strong> link.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Content_Types/manage-fields.jpg"><img  alt="manage-fields" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Content_Types/manage-fields.jpg" /></a></li>
<li>Find the <strong>Image</strong> row and then click on the <strong>Edit </strong>link to take you to the settings page.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Content_Types/image-edit.jpg"><img  alt="image-edit" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Content_Types/image-edit.jpg" /></a></li>
<li>On the settings page, scroll down and find the <strong>Minimum Image Resolution </strong>setting. The defaults are blank, which means there is no minimum setting. To set the minimum range, simply enter your desired minimum range in pixels. In this example, we have set it for 100 width x 110 height. If a user uploads a site that is smaller than the range, Drupal will reject the image for uploading.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Content_Types/image-min-res.jpg"><img  alt="image-min-res" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal_7/Structure/Content_Types/image-min-res.jpg" /></a></li>
<li>Click on the <strong>Save Settings</strong> button at the bottom of the page to save your new minimum upload size settings.</li>
</ol>
<p>Now that you have specified your minimum settings, all users must ensure the image is at least that big for this image field to accept it for upload.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/drupal-7/working-with-images'>109: Working with Images in Drupal 7</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 4: How to set the min upload image size in Drupal 7</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 3: <a href='/support/edu/drupal-7/working-with-images/set-max-upload-size'>How to set the max upload image size in Drupal 7</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 5: <a href='/support/edu/drupal-7/working-with-images/set-max-upload-file-size'>How to set max image upload file size in Drupal 7</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/drupal-7/working-with-images/set-min-upload-size&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/drupal-7/working-with-images/set-min-upload-size'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNDEmaWQ9MTU5OSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/drupal-7/working-with-images?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Working with Images in Drupal 7</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/drupal-7/working-with-images/enable-images-in-basic-pages?tsrc=rsbedu'>How to enable images for Basic Pages in Drupal 7</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/drupal-7/working-with-images/edit-allowed-file-types?tsrc=rsbedu'>How to change the allowed image file types in Drupal 7</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/drupal-7/working-with-images/set-max-upload-size?tsrc=rsbedu'>How to set the max upload image size in Drupal 7</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/drupal-7/working-with-images/set-min-upload-size?tsrc=rsbedu'>How to set the min upload image size in Drupal 7</a></td>
                </tr>
          <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/drupal-7/working-with-images/set-max-upload-file-size?tsrc=rsbedu'>How to set max image upload file size in Drupal 7</a></td>
                </tr>
          <tr >
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/drupal-7/working-with-images/set-image-title?tsrc=rsbedu'>How to set the image title in Drupal 7</a></td>
                </tr>
          <tr >
                        <td valign='top'>7.</td>
                        <td><a href='/support/edu/drupal-7/working-with-images/edit-max-number?tsrc=rsbedu'>Changing the max number of images allowed in Drupal 7</a></td>
                </tr>
          <tr >
                        <td valign='top'>8.</td>
                        <td><a href='/support/edu/drupal-7/working-with-images/add-image-subfolder?tsrc=rsbedu'>How to add a subfolder to default image directory in Drupal 7</a></td>
                </tr>
          <tr >
                        <td valign='top'>9.</td>
                        <td><a href='/support/edu/drupal-7/working-with-images/create-preview-style?tsrc=rsbedu'>How to create an image preview style in Drupal 7</a></td>
                </tr>
          <tr >
                        <td valign='top'>10.</td>
                        <td><a href='/support/edu/drupal-7/working-with-images/set-default-image?tsrc=rsbedu'>How to set a default image for content types in Drupal 7</a></td>
                </tr>
          <tr >
                        <td valign='top'>11.</td>
                        <td><a href='/support/edu/drupal-7/working-with-images/change-preview-style?tsrc=rsbedu'>How to modify image preview style in Drupal 7 </a></td>
                </tr>
          <tr >
                        <td valign='top'>12.</td>
                        <td><a href='/support/edu/drupal-7/working-with-images/remove-label-field?tsrc=rsbedu'>How to remove the label from an image field in Drupal 7</a></td>
                </tr>
          	</table>
