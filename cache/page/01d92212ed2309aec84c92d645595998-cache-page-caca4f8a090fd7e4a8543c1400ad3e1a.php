<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50758:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/billing/when-i-login-my-cpanel-citeground-i-cant-access-file-manager-it-says-fetching-directory-contents-how-can-i-solve-please-help-me-tnks" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello mustafe, It sounds as if the server is trying to get the data and display it, but is having issues. You will want to contact siteground support an..." />
  <title>cpanel file manager display issue with siteground | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/billing/when-i-login-my-cpanel-citeground-i-cant-access-file-manager-it-says-fetching-directory-contents-how-can-i-solve-please-help-me-tnks" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:5f236265794af3db404de55bb5a801db -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '122.165.130.201']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>cpanel file manager display issue with siteground</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='http://graph.facebook.com/mustafemoh/picture?type=normal' class='user_avatar' /><br />
			<a href='/support/community-support/users/mustafe'>mustafe</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-06-23 11:48 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>1,541</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>when i login my cpanel (citeground), i cant access FILE MANAGER, IT SAYS &quot;Fetching directory contents...&quot; HOW CAN I SOLVE PLEASE HELP ME! TNKS</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_3399' id='upvote_answer_3399' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='3399' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_3399').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_3399' id='downvote_answer_3399' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='3399' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_3399').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello mustafe,<br />
<br />
It sounds as if the server is trying to get the data and display it, but is  having issues. You will want to contact siteground support and have them take a look at the process to see why it is hanging when you click on the File Manager.<br />
<br />
Best Regards,<br />
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_3399').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_3399' id='form_comment_on_answer_3399' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/billing/when-i-login-my-cpanel-citeground-i-cant-access-file-manager-it-says-fetching-directory-contents-how-can-i-solve-please-help-me-tnks&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/billing/when-i-login-my-cpanel-citeground-i-cant-access-file-manager-it-says-fetching-directory-contents-how-can-i-solve-please-help-me-tnks'></div>
<script type='text/javascript'>
  (function() {
