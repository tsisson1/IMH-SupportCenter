<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:60435:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/php-configuration/find-php-version-and-options-of-your-server" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-07-17T13:57:25-07:00" />
  <meta name="keywords" content="find php version options info page" />
  ...
  <link href="http://www.inmotionhosting.com/support/website/php-configuration/find-php-version-and-options-of-your-server" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:a099a490f2a51189d698d8f4a4889448 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-22']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '62.77.231.162']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Find PHP version and options of your server									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>15,835</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Mar 6, 2013'><span style='color:#606060;'>Published:</span> Jul 17, 2015</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In this article I'm going to quickly show you how you can find the PHP version of your server creating a PHP info page, this will also allow you to see the options PHP is using and any active PHP extensions.</p>
<h2>Why does PHP version matter?</h2>
...
<h2>Creating a PHP info page</h2>
<p>Using the steps below I'll show you how to create a PHP info page that will allow you to not only see your PHP version, but also all the PHP options that are currently in use.</p>
...
<li>Now <a href="/support/edu/cpanel/cpanel-file-manager/file-manager-code-editor" target="_blank">open the file with the Code Editor in cPanel</a>&nbsp;and enter in the following code:
<p class="code_block" style="width: 500px;">&lt;? phpinfo(); ?&gt;</p>
<p>Then click on <strong>Save Changes</strong> at the top-right hand corner of the screen.</p>
</li>
<li>Now if you visit your website such as <strong>http://example.com/info.php</strong> you should see the PHP info page. This example screen shot shows that this server is running PHP version 5.2.17, and that the PHP configurations are getting loaded from the file <strong>/home/userna5/public_html/php.ini</strong><br /><br /> <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/php/php-info-page.png"><img src="//cdn.inmotionhosting.com/support/images/stories/php/php-info-page.png" alt="php info page"  /></a></li>
<li>You can scroll further down the PHP info page, to also see individual PHP options that you can set.</li>
</ol>
<h2>Changing PHP version</h2>
<p>Now that you know how to check what version of PHP is running on your server, you might also be interested in changing it.</p>
<p>You can learn about <a href="/support/website/general-server-setup/how-to-change-the-php-version-your-account-uses" target="_blank">how to change the PHP version your account uses</a>, which will show you how to select the version of PHP you'd like to use from cPanel.</p>
<p>You can also <a href="/support/website/how-to/using-multiple-php-versions-one-account" target="_blank">use multiple PHP versions on your one account</a> by adding some <strong>.htaccess</strong> rules. If you're running any automated PHP scripts via a cron job, you might also be interested in <a href="/support/website/how-to/cron-job-php-version" target="_blank">forcing cron jobs to use chosen PHP version</a>.</p>
<p>If you're on a <a href="http://www.inmotionhosting.com/vps-hosting">VPS (Virtual Private Server)</a> or dedicated server and have <a href="/support/website/general-server-setup/root-access-faq" target="_blank">root access</a> to your server, you can also <a href="/support/edu/whm/302-upgrade-php-using-easyapache" target="_blank">upgrade PHP using EasyApache</a> if the version of PHP you're currently using is too old for your needs.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/php-configuration/find-php-version-and-options-of-your-server&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/php-configuration/find-php-version-and-options-of-your-server'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NTImaWQ9NjEzJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="a3f56a9a8c788c7c89b2edcf9086a6fd" value="1" />	</div>
	</form>
<!-- <br />
