<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:45629:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/mambo/add-content-mambo" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="keywords" content="adding content to your Mambo site" />
  <meta name="description" content="In Mambo you can create pages, add content, create contact forms and more. This course will explain how to add content to your Mambo site. " />
  <title>102: Adding content to your Mambo site | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/mambo/add-content-mambo" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:f1553de27c712228ddf2673c523b352b -->
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/mambo' itemprop='url'><span itemprop='title'>Mambo<span></a><div class='dropdown_2columns'><h2>Mambo Education Channel</h2><div class='col_2'><h3>100 Level Classes</h3><div><a href='/support/edu/mambo/getting-started-mambo'>101: Getting Started with Mambo</a></div><div><a href='/support/edu/mambo/add-content-mambo'>102: Adding content to your Mambo site</a></div><div><a href='/support/edu/mambo/changing-mambo-appearance'>103: Changing the Mambo Appearance</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>102: Adding content to your Mambo site</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='page-header'>
	<h1>102: Adding content to your Mambo site</h1>
</div>
<div class='section_listing'>
	<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/mambo/102/mambo-content.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Adding Content in Mambo" src="//cdn.inmotionhosting.com/support/images/stories/edu/mambo/102/mambo-content.png" title="Click here to view the larger image" width="100" /></a>In Mambo you can create pages, add content, create contact forms and more. This course will explain how to add content to your Mambo site. <br style="clear: both;" /></p>
	<table>
	<tr><td colspan='3'><h2>Adding content to your site</h2><div>The beginning step in setting up your Mambo site is to add content. This section will teach you the basics in adding content to your site.</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 1:</td>
				<td style='padding-right:10px;'><div class='gold_star'></div></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/mambo/add-content-mambo/new-page'>How to Create a New Page in Mambo</a>
					<div>This is a guide on how to create a new page in Mambo.</div>
					<div class='smallgrey'>Hits: 1,392</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'><div class='gold_star'></div></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/mambo/add-content-mambo/insert-internal-link-mambo'>Inserting an internal link in Mambo</a>
					<div>To insert links to your pages in your Mambo site, you will need to use the Insert / Edit in the WYSIWYG editor. This article will show you how.</div>
					<div class='smallgrey'>Hits: 742</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'><div class='gold_star'></div></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/mambo/add-content-mambo/add-image'>Adding an Image to a Page in Mambo</a>
					<div>This is a guide on adding an image to a page in mambo.</div>
					<div class='smallgrey'>Hits: 632</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/mambo/add-content-mambo/adding-an-iframe-to-a-mambo-page'>Adding an iframe to a Mambo page</a>
					<div>In this article I'm going to explain how you can easily add an iframe to one of your Mambo pages.</div>
					<div class='smallgrey'>Hits: 1,536</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/mambo/add-content-mambo/create-contact-form-mambo'>How to create a contact form in Mambo</a>
					<div>This article will teach you how to create a contact form in Mambo.</div>
					<div class='smallgrey'>Hits: 1,423</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/mambo/add-content-mambo/using-captcha'>Using Captcha in Mambo</a>
					<div>One of the methods to stop spammers is to use a verification method called Captcha.  Mambo includes this ooption within its Administration interface. The following article </div>
					<div class='smallgrey'>Hits: 1,306</div>
				</td>
			</tr>
		<tr><td colspan='3' style='padding-top:20px;'><h2>Search Engine Optimization</h2><div>You monitor your site and make your Mambo site search engine freindly by setting up Google Analytics and other Gogle tools. This section will explain how to set up your site with Google.</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 7:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/mambo/add-content-mambo/installing-google-analytics'>Installing Google Analytics in Mambo</a>
					<div>Google Analytics is one of the best free website analytics programs that you can find on the internet.  You can use it with your Mambo installation with a just a few steps.  The following article explains how to install Google Analytics using the Mambo Administrator.</div>
					<div class='smallgrey'>Hits: 1,215</div>
				</td>
			</tr>
			</table>
</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zNDkmaWQ9MzQ5JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="7a1f65f0cfd4a1612c45aa777bf00125" value="1" />	</div>
	</form>
<!-- <br />
