<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:58008:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/cpanel/cpanel-login" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello chatterjeetinkoo321, Thank you for your question. When you sign up for a hosting account, it includes a cPanel by default. We offer hosting accoun..." />
  <title>Log into cPanel for Addon domain | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/cpanel/cpanel-login" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:25985175f837fbcb28de98cf9942f0c1 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box straight_bottom'>
                <h1 style='font-size:26px;'>Log into cPanel for Addon domain</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/thecardcollectors'>thecardcollectors</a>
			<div>8 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-03-23 7:23 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>1,850</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I just purchased a new domain name, as an addon to my main domain name.<br />
<br />
How can I log in to the CPanel for my new domain?<br />
<br />
Thanks.</div>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px;'>
				<div style='font-size:12px; max-width:500px; overflow:auto;'>how may i have cpanel?</div>
				
				
			</td>
			<td style='width:100px;' valign='top'>
				<img src='http://graph.facebook.com/arun.chatterjee.75/picture?type=normal' style='width:40px;' class='user_avatar' />
				<div class='smallgrey'>
					<a href='/support/community-support/users/chatterjeetinkoo321'>chatterjeetinkoo321</a><br />
					0 <a href='/support/team/points' target='_blank'>Points</a><br />
					2013-05-22 12:07 am EST
				</div>
			</td>
		</tr>
	</table>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_2513' id='upvote_answer_2513' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='2513' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_2513').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_2513' id='downvote_answer_2513' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='2513' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_2513').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>22,986 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2013-03-25 10:01 am EST
                		        </div>
					
		                </div>

				Hello thecardcollectors,<br />
<br />
Thank you for your question.  When you <a href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-manage-domains/adding-add-on-domain-in-cpanel">Addon a Domain</a> to your existing cPanel, it creates a folder where the new domain's files can be stored.<br />
<br />
You can then <a href="http://www.inmotionhosting.com/support/website/file-management/using-ftp-with-your-addon-domain">access/publish the files for the Addon domain using FTP</a>, or, <a href='http://www.inmotionhosting.com/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel'>log into cPanel</a> and use the <a href='http://www.inmotionhosting.com/support/edu/cpanel/cpanel-file-manager/using-file-manager-in-cpanel'>File Manager</a> / <a href='http://www.inmotionhosting.com/support/edu/cpanel/softaculous'>Softaculous</a> to build the site.<br />
<br />
With <a href="http://www.inmotionhosting.com/support/edu/whm/into-to-web-hosting/difference-between-shared-vps-dedicated-hosting">VPS/ dedicated servers</a>, you have the ability to <a href="http://www.inmotionhosting.com/support/edu/whm/creating-and-managing-accounts/how-to-create-a-cpanel-account">create additional cPanel accounts</a>.<br />
<br />
...
-John-Paul
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_2513').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_2513' id='form_comment_on_answer_2513' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hi there John,<br />
<br />
Thanks for replying! The reason why I want to log on to my cPanel for my new domain is because I want to install Wordpress onto the domain. How should I do that?</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='/support/images/avatars/default_avatar.jpg' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/thecardcollectors'>thecardcollectors</a><br />
									8 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2013-03-25 8:41 pm EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello thecardcollectors,<br />
<br />
Here is a link to our guide on <a href="http://www.inmotionhosting.com/support/edu/wordpress/wordpress-introduction/install-wordpress">installing Wordpress</a>, I recommend using Softaculous.<br />
<br />
If you have any further questions, feel free to post them below.<br />
Thank you,<br />
<br />
...
<div class='  not_best_answer'>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px; width:50px;' valign='top'>
<div class='vote_div'>
	<form method='post' name='upvote_answer_3175' id='upvote_answer_3175' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='3175' />
		<input type='hidden' name='component' id='component' value='qa' />
		<input type='hidden' name='vote_value' id='vote_value' value='1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_3175').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_3175' id='downvote_answer_3175' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='3175' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_3175').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>22,986 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2013-05-22 10:05 am EST
                		        </div>
					
		                </div>

				Hello chatterjeetinkoo321,<br />
<br />
Thank you for your question. When you sign up for a hosting account, it includes a cPanel by default. <br />
<br />
We offer hosting accounts that range from <a href="http://www.inmotionhosting.com/business-hosting">Business Class</a>, and <a href="http://www.inmotionhosting.com/vps-hosting">VPS's</a>, and <a href="http://www.inmotionhosting.com/dedicated-servers">Dedicated servers</a>.<br />
<br />
If you have any further questions, feel free to post them below.<br />
Thank you,<br />
<br />
-John-Paul
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_3175').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_3175' id='form_comment_on_answer_3175' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
					                <p>You must <a href='/support/login'>login</a> before you can post a comment about this answer.</p>
					        </div></div></div></div>
					</form>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/cpanel/cpanel-login&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/cpanel/cpanel-login'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP3RzcmM9cnNicmFxJm9wdGlvbj1jb21fY29tbXVuaXR5c3VwcG9ydCZJdGVtaWQ9MTAwMDI=" />
		<input type="hidden" name="4bd60c108b749c8ac2a02befe8d54aae" value="1" />	</div>
	</form>
<!-- <br />
