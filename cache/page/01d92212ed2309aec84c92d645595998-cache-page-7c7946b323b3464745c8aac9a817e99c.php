<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:44167:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/website-design/html-5-syntax" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="keywords" content="html 5 tutorials" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="Learn how to use HTML 5 in the education course." />
  <title>105: HTML 5 Basic syntax | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/website-design/html-5-syntax" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:38f22298f68d02c89d6c17bbbc1c7134 -->
...
<div class='page-header'>
	<h1>105: HTML 5 Basic syntax</h1>
</div>
<div class='section_listing'>
	This course will explain the basics of HTML 5.
	<table>
		<tr>
				<td style='width:75px; font-weight:bold;'>Section 1:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/website-design/html-5-syntax/what-is-html5'>What is HTML5?</a>
					<div>The term HTML5 is gaining quite a bit of popularity these days, and in this article we'll introduce you to HTML5 and what's new with HTML.</div>
					<div class='smallgrey'>Hits: 1,694</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/website-design/html-5-syntax/can-i-use-html5-with-my-hosting-account'>Can I use HTML5 with my Hosting Account?</a>
					<div>As HTML5 is run by a user's browser and not by the server, HTML5 can used on our servers.</div>
					<div class='smallgrey'>Hits: 3,863</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/website-design/html-5-syntax/using-html-5-to-add-videos'>Using HTML5 to add videos</a>
					<div>This article will teach you how to use HTML 5 to add videos to your site.</div>
					<div class='smallgrey'>Hits: 3,859</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/website-design/html-5-syntax/html5-video-player'>HTML5 Video Player Elements</a>
					<div>In this tutorial, we'll show you how you can use the HTML5 video element to play a video on your webpage. We'll also list the various attributes for the video element that are available and how you can use them.</div>
					<div class='smallgrey'>Hits: 2,308</div>
				</td>
			</tr>
			</table>
</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zNjgmaWQ9MzY4JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
