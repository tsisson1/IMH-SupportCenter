<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:52093:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/opencart/opencart-product-options-wont-save" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Zac, Have you tried increasing your PHP memory limit? Here is a step by step tutorial on increasing the php memory within your php.ini file. Best ..." />
  <title>OpenCart Product Options - Wont Save | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/opencart/opencart-product-options-wont-save" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:c39e210edb34632a814ddc92988d179d -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '89.243.223.207']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>OpenCart Product Options - Wont Save</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-03-10 2:39 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>146</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Hello, I have OpenCart and I have all of my options set up in the options area but when I add them to an actual product it wont save past 96 options. I've tried everything including changing my max_input_vars up tried 2000, 4000 and 10000 but still wont save in the product. I have OpenCart 2.0.1.1 - don't have hosting through you but you popped up in Google when I searched this question - answer wasnt what I needed though.<br />
Thanks!<br />
Zac</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_6739' id='upvote_answer_6739' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='6739' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_6739').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_6739' id='downvote_answer_6739' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='6739' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_6739').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Zac,<br />
<br />
Have you tried increasing your PHP memory limit? Here is a step by step tutorial on <a href="http://www.inmotionhosting.com/support/website/php/update-local-php-settings">increasing the php memory within your php.ini file</a>.<br />
<br />
Best Regards,<br />
TJ Edens
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_6739').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_6739' id='form_comment_on_answer_6739' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Just checked and my php memory limit is set to 512M is that a good setting?</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='http://graph.facebook.com/zacweidler/picture?type=normal' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/indclassictrophy'>indclassictrophy</a><br />
									3 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2015-03-10 8:59 pm EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello Zac,<br />
<br />
512M should technically be good but try increasing it to 1024M. Also try changing your max_execution time to 120. Please update us with what happens.<br />
<br />
Best Regards,<br />
TJ Edens</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/opencart/opencart-product-options-wont-save&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/opencart/opencart-product-options-wont-save'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="780a9fedf4cd31bb3b3d55efcd275693" value="1" />	</div>
	</form>
<!-- <br />
