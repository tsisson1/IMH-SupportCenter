<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:67145:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/wordpress/installed-theme-on-host-does-not-appear-in-wordpress-dashboard" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Cjbirch, I looked into your wordpress installation on your server with us and I saw the genesis theme installed correctly. I also noticed a theme ..." />
  <title>Installed theme on host; does not appear in Wordpress dashboard | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/wordpress/installed-theme-on-host-does-not-appear-in-wordpress-dashboard" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:ea505637df725f1111b473db5550cb82 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-20']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '173.34.186.163']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Installed theme on host; does not appear in Wordpress dashboard</h1>
		<div style='margin-bottom:20px; margin-top:10px; clear:both; color:#6e6e6e;'>Category: <a href='/support/community-support/wordpress'>Wordpress</a></div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_5896' id='upvote_answer_5896' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='5896' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_5896').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_5896' id='downvote_answer_5896' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='5896' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_5896').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
Sorry for the WordPress problem.  Yes, it's very possible that the problem you're having has to do with the domain pointing to the hosting service.  If you just registered it or changed it, then you should allow for up to 24 hours of <a href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/domain-names-dns-changes">DNS propagation time</a>.  Since you didn't provide the domain names I couldn't check it myself.  If you wish for us to investigate the issue further, then provide the domain name.  <br />
<br />
Otherwise, I hope this helps to answer your question!<br />
<br />
Kindest regards,<br />
Arnel C.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_5896').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_5896' id='form_comment_on_answer_5896' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Original poster here (couldn't log in with AMP for some reason). The domain names are thebelieverstrust.wordpress.com and believerstrust.org.</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='https://lh6.googleusercontent.com/-e_dNFOGzUjI/AAAAAAAAAAI/AAAAAAAAAKI/ETgMg73Pykw/photo.jpg?sz=90' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/cjbirch'>cjbirch</a><br />
									18 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
...
<div class=' straight_bottom not_best_answer'>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px; width:50px;' valign='top'>
<div class='vote_div'>
	<form method='post' name='upvote_answer_5897' id='upvote_answer_5897' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='5897' />
		<input type='hidden' name='component' id='component' value='qa' />
		<input type='hidden' name='vote_value' id='vote_value' value='1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_5897').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_5897' id='downvote_answer_5897' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='5897' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_5897').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Cjbirch,<br />
<br />
I looked into your wordpress installation on your server with us and I saw the genesis theme installed correctly. I also noticed a theme called Parallax-Pro installed as well. Both themes are showing up in the file directory and the wordpress dashboard at this time. Are you installing this theme via the dashboard or by uploading the zip file? Your DNS has already propagated to our server so that is not currently the issue. <br />
<br />
Kindest Regards,<br />
TJ Edens
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_5897').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_5897' id='form_comment_on_answer_5897' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
					                <p>You must <a href='/support/login'>login</a> before you can post a comment about this answer.</p>
					        </div></div></div></div>
					</form>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>I installed it by uploading the zip file; I've heard that the next step in the process is to go to the Wordpress dashboard and activate the theme (Parallax-Pro is the desired theme, a child theme to Genesis) but I can't find where to do that. Also, the admin credentials I put in at setup don't currently let me into the Dashboard; I can only get to the Dashboard using the UN/PW I set up on Wordpress.com.</div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello CJ,<br />
<br />
Sorry that you're still having problems with the login.  I arrive at the WP-Admin screen by typing "believerstrust.org/wp-admin" - you can't get there using the cPanel.  Are you typing the URL directly in the browser? Are you sure that you are NOT using a <a href="http://www.inmotionhosting.com/support/website/how-to/modifying-your-hosts-file">hosts file modification</a> that is affecting how the URL appears on your computer?  Please tell us what address you are typing into the browser and or if you're using a shortcut to get to the URL.  <br />
<br />
I hope this helps to clarify the issue. If you're able to get to the correct login page, then make sure to go through  the <a href="http://www.inmotionhosting.com/support/website/wordpress/resetting-your-wordpress-admin-password">to reset the WordPress Admin password</a>.  You can also use these steps to verify the user you used to log in.  <br />
<br />
Kindest regards,<br />
Arnel C.</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello cjbirch,<br />
<br />
Thank you for the additional information. I looked up up the <a href="http://www.inmotionhosting.com/support/domain-names/general-information/how-to-look-up-domain-whois">Whois</a> information for your domain, and it is showing as modified 11/05/2014.<br />
<br />
It usually occurs much sooner, but you may be experiencing <a href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/domain-names-dns-changes">propagation</a> if you made DNS changes (such as pointing to our nameservers) yesterday.<br />
<br />
Alternately, the the network you are on may not update the DNS information regularly, and may be holding on to old cache. <a href="http://technet.microsoft.com/en-us/library/cc781949(v=ws.10).aspx" target="_blank" >Flushing the cache</a> may help clear out stored information.<br />
<br />
If your problems persist, please perform a <a href="http://www.inmotionhosting.com/support/website/slow-websites/why-is-my-server-slow-how-do-i-run-a-ping-and-tracert-test">Ping/Traceroute</a> and reply with the results. This will give us detailed information on the route you are taking to our servers. <br />
<br />
Thank you,<br />
John-Paul</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Looks like John-Paul's theory is the most accurate; I've tried to access it from several different computers running on the same network and consistently receive the same page. Computers on other networks, however, can access the page no problem. I've talked with our network admins and they're working on solving it right now, but 10 to 1 that's the issue.<br />
<br />
Thanks for your help, guys! I really appreciate it!</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/wordpress/installed-theme-on-host-does-not-appear-in-wordpress-dashboard&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/wordpress/installed-theme-on-host-does-not-appear-in-wordpress-dashboard'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="f3502a4fead8cb19b6673c3a8f86f6b1" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
                                ...
                                <h3>Related Articles</h3><a target='_blank' href='http://inmotionhosting.com/support/disable-wordpress-plugins'>309: How to Disable WordPress Plugins</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/install-setup-smtp'>How to Install & Setup Easy WP SMTP in WordPress </a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/wordpress-caching-rewrites'>WordPress Caching Rewrites</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/installing-the-elasticpress-plugin'>Installing the ElasticPress plugin</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/editing-your-wordpress-wp-config-php-file'>Editing your WordPress wp-config.php file</a><br/><br />
		</div>
