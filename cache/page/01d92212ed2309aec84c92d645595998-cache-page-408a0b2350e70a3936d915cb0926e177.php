<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:51651:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/cpanel/cpanel-two-login-boxes-one-as-separate-window" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Whyiask, The reason you're getting two separate boxes might be due to the browser trying to authenticate the certificate. You can cancel the first..." />
  <title>cpanel two login boxes one as separate window | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/cpanel/cpanel-two-login-boxes-one-as-separate-window" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:93d8abef85c989379313aa34cd25e2aa -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>cpanel two login boxes one as separate window</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='http://graph.facebook.com/rich.posson/picture?type=normal' class='user_avatar' /><br />
			<a href='/support/community-support/users/Whyiask'>Whyiask</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-10-31 4:09 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>997</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>When I login in using Chrome I get two login boxes. They are different. I cancel the second and click on the first one. The second is a pop up small box. And then it works fine. But when I login using Firefox the second box is larger/longer and cancel does not assist, I can not login and even if I enter user name and pass as I did for the first box. <br />
Pop up second login box text:<br />
A username and password are being requested by https://secure83.inmotionhosting.com:2083. The site says: &quot;cPanel&quot;</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_4166' id='upvote_answer_4166' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='4166' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_4166').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_4166' id='downvote_answer_4166' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='4166' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_4166').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
...
Arnel C.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_4166').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_4166' id='form_comment_on_answer_4166' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/cpanel/cpanel-two-login-boxes-one-as-separate-window&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/cpanel/cpanel-two-login-boxes-one-as-separate-window'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="54eba27d938752b8a4f9d123eed09019" value="1" />	</div>
	</form>
<!-- <br />
