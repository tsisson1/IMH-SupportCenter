<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49132:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/cyberduck/i-can-not-open-an-ftp-connection-in-cyberduck" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, Sorry for the problem with connecting to FTP with Cyberduck. You may want to review the settings for using FTP. We would need more information on..." />
  <title>I can not open an FTP Connection in Cyberduck | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/cyberduck/i-can-not-open-an-ftp-connection-in-cyberduck" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:aa381bcfbd2fb9a97713c4b2deb9f9fe -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>I can not open an FTP Connection in Cyberduck</h1>
		<div style='margin-bottom:20px; margin-top:10px; clear:both; color:#6e6e6e;'>Category: <a href='/support/community-support/cyberduck'>Cyberduck</a></div>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2016-01-13 1:48 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>45</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>When I enter my info into the server, username, password fields and then I choose Passive for the connect option, I am unable to  connect.  It says &quot;opening FTP connection&quot; to my website and then does not ever quite get the job done.</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_8940' id='upvote_answer_8940' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='8940' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_8940').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_8940' id='downvote_answer_8940' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='8940' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_8940').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
Sorry for the problem with connecting to FTP with Cyberduck.  You may want to review the settings for <a href="http://www.inmotionhosting.com/support/website/ftp/getting-started-guide">using FTP</a>.  We would need more information on your account and settings in order to determine why your FTP is not working.  I hope this helps to answer your question, please let us know if you require any further  assistance.<br />
<br />
Regards,<br />
Arnel C.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_8940').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_8940' id='form_comment_on_answer_8940' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/cyberduck/i-can-not-open-an-ftp-connection-in-cyberduck&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/cyberduck/i-can-not-open-an-ftp-connection-in-cyberduck'></div>
<script type='text/javascript'>
  (function() {
