<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:62938:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/whm/disable-curlwrappers" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-08-16T19:58:35-07:00" />
  <meta name="keywords" content="error curlwrappers php compile whm easyapache" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="If you get the error &quot;PHP was compiled with --with-curlwrappers which will cause issues with HTTP authentication and GitHub. Recompile it without this flag if possible&quot; you will need to disable curlwrappers in your php compilation. Learn how to do that via the Easy Apache tool." />
  <title>How to disable curlwrappers in WHM - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/whm/disable-curlwrappers" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:d1ee00b0695a6e826862810277ebe5ed -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to disable curlwrappers in WHM									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>1,733</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: May 7, 2013'><span style='color:#606060;'>Published:</span> Aug 16, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>When working with your VPS and dedicated accounts, you may try to install different programs to enhance your server to fit your needs. If you are using the default server setup, you may come across a time when you need to disable certain options. One such option is the <em>with-curlwrappers</em> option. You will know you need to disable this if you receive the following warning message:<br />
<em>PHP was compiled with --with-curlwrappers which will cause issues with HTTP authentication and GitHub.
Recompile it without this flag if possible</em>
</p>

<h2>Disabling curlwrappers in Easy Apache</h2>
...
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/whm/software/easyapache/click-easy-apache.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="clck on easy apache option" src="//cdn.inmotionhosting.com/support/images/stories/edu/whm/software/easyapache/click-easy-apache.png" title="Click here to view the larger image" max-width="200px" /></a>Once in the WHM, look to the left hand menu, locate and click on the <strong>EasyApache (Apache Update)</strong> option under the <em>Software</em> category.<div style="clear:both;"></div></li>
  
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/whm/software/easyapache/disable-curlwrappers/1-customize-build.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="select custom build" src="//cdn.inmotionhosting.com/support/images/stories/edu/whm/software/easyapache/disable-curlwrappers/1-customize-build.png" title="Click here to view the larger image" width="200px" /></a>From the first page, be sure to select the default <strong>Previously Saved Configuration</strong> and click on the <strong>Start customizing based on profile</strong> button.<div style="clear:both;"></div></li>
  
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/whm/software/easyapache/disable-curlwrappers/2-exhaustive.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="choose exhaustive options list" src="//cdn.inmotionhosting.com/support/images/stories/edu/whm/software/easyapache/disable-curlwrappers/2-exhaustive.png" title="Click here to view the larger image" width="200px" /></a>Click <strong>Next</strong> until you get to step 4. From here you will see the different options, scroll to the bottom and expand the options by clicking on the <strong>Exhaustive Options List</strong> button.<div style="clear:both;"></div></li>
  
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/whm/software/easyapache/disable-curlwrappers/3-uncheck-option.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="uncheck curlwrappers" src="//cdn.inmotionhosting.com/support/images/stories/edu/whm/software/easyapache/disable-curlwrappers/3-uncheck-option.png" title="Click here to view the larger image" width="200px" /></a>This opens up more options from which to select. Scroll down to the section on Php and find the checkbox labeled <strong>Curlwrappers</strong> and uncheck the box.<div style="clear:both;"></div></li>
  
<li>Once unchecked, simply scroll down to the bottom and click on the <strong>Save and Build</strong> button. This will recompile your php without the curlwrappers option.<div style="clear:both;"></div></li>
</ol> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/whm/disable-curlwrappers&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/whm/disable-curlwrappers'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MTQmaWQ9MjY5MSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="66911c498b9b5d41f7c0feef1fdc9599" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/2035f51eff9fb75be2b8e4655830e4bc?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/2035f51eff9fb75be2b8e4655830e4bc'>Ryan</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-22 12:32 am</div>
				                <div><p>Thanks, got the error while installing composer - your solution worked like a charm.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9960);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
