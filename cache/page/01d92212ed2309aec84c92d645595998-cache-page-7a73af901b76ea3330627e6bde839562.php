<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50040:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/whm/how-to-open-new-port-with-ssh-putty-2" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hi hareshvidja, It looks like we didn't have any documentation showing how to open a port on your server, so I wrote the following guide for you: Openin..." />
  <title>How to open new port with SSH putty? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/whm/how-to-open-new-port-with-ssh-putty-2" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:3e1d13d59ad84e9b484fee410f3fd807 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '190.237.79.40']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>How to open new port with SSH putty?</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/hareshvidja'>hareshvidja</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-05-17 5:27 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>6,649</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I had installed openfire in VPS using SSH.. but cor client connection need to open some ports<br />
<br />
Using $vi /etc/sysconfig/iptables I had added below lines<br />
<br />
-A INPUT -p tcp -i eth0 --dport 5222 -j ACCEPT<br />
-A INPUT -p udp -i eth0 --dport 5222 -j ACCEPT<br />
-A INPUT -p tcp -i eth0 --dport 7777 -j ACCEPT<br />
-A INPUT -p udp -i eth0 --dport 7777 -j ACCEPT<br />
...
-A INPUT -p udp -i eth0 --dport 9091 -j ACCEPT<br />
<br />
After this I had restarted configurations by<br />
<br />
$iptables-restore &lt; /etc/sysconfig/iptables<br />
<br />
Still port not working.. so please help me out.</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_3132' id='upvote_answer_3132' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='3132' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_3132').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_3132' id='downvote_answer_3132' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='3132' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_3132').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hi hareshvidja,<br />
<br />
It looks like we didn't have any documentation showing how to open a port on your server, so I wrote the following guide for you:<br />
<br />
&lt;a href='http://www.inmotionhosting.com/support/website/general-server-setup/how-to-open-a-port-in-your-firewall'&gt;Opening a Port&lt;/a&gt;<br />
<br />
I hope this helps, be sure to let me know if you have any follow up questions.<br />
<br />
Thanks,<br />
- Brad
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_3132').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_3132' id='form_comment_on_answer_3132' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/whm/how-to-open-new-port-with-ssh-putty-2&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/whm/how-to-open-new-port-with-ssh-putty-2'></div>
<script type='text/javascript'>
  (function() {
