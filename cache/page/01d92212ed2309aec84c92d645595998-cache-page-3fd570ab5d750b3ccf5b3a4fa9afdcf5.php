<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:51765:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-25/create-template" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Learn how to create a Joomla 2.5 template by example. We will pick apart templates included with Joomla 2.5 and show you what each section of code does." />
  <title>219: Joomla 2.5 Template Development Tutorial | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-25/create-template" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:4141b1e1af4cf67d3d2c280489a225ad -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '123.231.122.218']);
...
<div class='page-header'>
	<h1>219: Joomla 2.5 Template Development Tutorial</h1>
</div>
<div class='section_listing'>
		...
		<tr>
				...
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/create-template/defined-jexec-or-die'>Joomla 2.5 Templates - defined('_JEXEC') or die</a>
					<div>_JEXEC is a variable defined in Joomla's main index.php file. When you check if the variable has been defined yet, you can learn whether a file is being accessed directly or is being included as it should.</div>
					<div class='smallgrey'>Hits: 10,917</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/create-template/showrightcolumn'>Joomla 2.5 Templates - $showRightColumn</a>
					<div>The $showRightColumn variable has a 1 or 0 value. If there are no modules being loaded in the right column, it has a value of 0, or false. Likewise, if modules are being loaded, it has a value of 1, or true.</div>
					<div class='smallgrey'>Hits: 5,336</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/create-template/this-countmodules'>Joomla 2.5 Templates - $this->countModules('position-3')</a>
					<div>The $this-countModules() function returns the total number of active modules for the given position. In this tutorial, we'll show you how it works.</div>
					<div class='smallgrey'>Hits: 9,386</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/create-template/this-params-get'>Joomla 2.5 Templates - $this->params->get('templatecolor');</a>
					<div>When using $this-params-get() in a Joomla 2.5 template file, you can call the value of a parameter set by the user for the template. For example, if your template allows the user to enter the background color of the template, using $this-params-get you can grab the color the user entered.</div>
					<div class='smallgrey'>Hits: 24,397</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/create-template/jfactory-get-application'>Joomla 2.5 Templates - JFactory::getApplication()</a>
					<div>While JFactory::getApplication() can be used in many different ways, it appears it is only used in the Beez2 template to get the value of the site's title and description (which are Advanced Options) for the template.</div>
					<div class='smallgrey'>Hits: 29,427</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/create-template/jfactory-get-document'>Joomla 2.5 Templates - JFactory::getDocument()</a>
					<div>In the Beez2 template, JFactory::getDocument is called in order to tell Joomla to include an additional javascript file in the page.</div>
					<div class='smallgrey'>Hits: 12,545</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/create-template/this'>Joomla 2.5 Templates - $this-></a>
					<div>The $this variable is used quite often in the Beez2 Joomla 2.5 template, and it references the JDocumentHTML Object.</div>
					<div class='smallgrey'>Hits: 5,422</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/create-template/this-baseurl'>Joomla 2.5 Templates - $this->baseurl</a>
					<div>In this tutorial, we'll show you how to use the $this-baseurl variable within a Joomla template to reference your site's URL.</div>
					<div class='smallgrey'>Hits: 24,237</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/create-template/this-template'>Joomla 2.5 Templates - $this->template</a>
					<div>$this-template in a Joomla 2.5 template can be used to get the folder name of the current template, which is helpful for dynamically creating URLs to css and other files.</div>
					<div class='smallgrey'>Hits: 11,404</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/create-template/this-language'>Joomla 2.5 Templates - $this->language</a>
					<div>The $this-language variable in Joomla 2.5 can be used to reference the current language being used, such as en-gb or es-es.</div>
					<div class='smallgrey'>Hits: 6,406</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/create-template/this-direction'>Joomla 2.5 Templates - $this->direction</a>
					<div>$this-direction in a Joomla 2.5 template gives you access to the direction text has been set to (for example ltr - left to right).</div>
					<div class='smallgrey'>Hits: 2,695</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/create-template/add-new-position'>How to add a new position to a Joomla 2.5 Template</a>
					<div>In the following Joomla 2.5 template tutorial, we'll show you how to add a new position to your template.</div>
					<div class='smallgrey'>Hits: 16,271</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/create-template/files-jhtml'>Joomla 2.5 Templates - $files = JHtml::_(stylesheet)</a>
					<div>$files = JHtml::_(stylesheet) is used in our Joomla 2.5 template's index.php file as a method of loading a css file, general.css</div>
					<div class='smallgrey'>Hits: 6,425</div>
				</td>
			</tr>
			</table>
</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yMjQmaWQ9MjI0JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="ff57335f9a91e647b14072cf94c4dd56" value="1" />	</div>
	</form>
<!-- <br />
