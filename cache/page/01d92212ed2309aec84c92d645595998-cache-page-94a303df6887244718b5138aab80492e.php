<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:79086:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/php/custom-php-ini-with-fastcgi" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-10-21T15:58:21-07:00" />
  <meta name="keywords" content="fastcgi fcgi custom php.ini per user" />
  ...
  <link href="http://www.inmotionhosting.com/support/website/php/custom-php-ini-with-fastcgi" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:be33fc69c9cc818d56f91f756f8af059 -->
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Custom php.ini file with FastCGI</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Custom php.ini file with FastCGI									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>23,664</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Oct 25, 2012'><span style='color:#606060;'>Published:</span> Oct 21, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In this article we'll discuss how you can set a custom <a href="/support/website/general-server-setup/update-local-php-settings">php.ini</a> file per user when using FastCGI on your server. FastCGI is a PHP handler that is good for reducing CPU usage on a server, you might be interested in <a href="/support/website/general-server-setup/choosing-the-best-php-handler">choosing the best PHP handler</a> for your specific server needs if FastCGI isn't working well for you.</p>
<p>These instructions will allow you to have separate PHP configurations per user, so for instance you can set different memory limits or use opcode caching only on certain users. Please note that making these changes yourself would require <a href="/support/website/general-server-setup/root-access-faq">root access</a> to your server.</p>
...
<p class="code_block">#!/bin/sh<br /><br /># If you customize the contents of this wrapper script, place<br /># a copy at /var/cpanel/conf/apache/wrappers/php5<br /># so that it will be reinstalled when Apache is updated or the<br /># PHP handler configuration is changed<br /><br /> exec /usr/bin/php</p>
</li>
...
<p class="code_block">#!/bin/sh<br /><br /># If you customize the contents of this wrapper script, place<br /># a copy at /var/cpanel/conf/apache/wrappers/php5<br /># so that it will be reinstalled when Apache is updated or the<br /># PHP handler configuration is changed<br /><br />[[ -f ~/public_html/php.ini ]] &amp;&amp; exec /usr/bin/php -c ~/public_html/php.ini<br />exec /usr/bin/php</p>
...
<p>The rest of the code simply executes the PHP binary at <strong>/usr/bin/php</strong> with the <strong>-c</strong> flag which sets the location where you'd like to load a php.ini from from. In this case we are telling the server we'd like to use the php.ini file inside the user's <strong>/public_html/</strong> directory if one exists, instead of <strong>/usr/local/lib/php.ini</strong> which would be the server's default.</p>
</li>
...
<p class="code_block">mkdir -p /var/cpanel/conf/apache/wrappers<br />cp -frp /usr/local/cpanel/cgi-sys/php5 /var/cpanel/conf/apache/wrappers/php5</p>
</li>
...
<p class="code_block">echo '&lt?php phpinfo(); ?&gt' > ~user1/public_html/info.php</p>
  
  
<p>Now when you visit your website and access the newly crated <strong>info.php</strong> script, you should see your custom <strong>php.ini</strong> being loaded next to the <strong>Loaded Configuration File</strong> section<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/php-ini-loaded-configuration-file.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/php-ini-loaded-configuration-file.png" alt="php-ini-loaded-configuration-file"  /></a></p>
</li>
</ol>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/php/custom-php-ini-with-fastcgi&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/php/custom-php-ini-with-fastcgi'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MTImaWQ9NDU1JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2012-10-29 11:25 am</div>
				                <div>Hi, I am trying to follow the steps above, but am getting lost at step 1. PhpInfo reports that &quot;Server API&quot; is set to &quot;CGI/FastCGI&quot;, so I think these are the steps to follow. But when I go to /usr/local/cpanel/cgi-sys, and &quot;ls&quot;, I don't see any php5 file; the file list shows movingpage.cgi followed by randhtml.cgi -- no php file names in between. Would I want to create a php5 file there, with the contents indicated? And would it have the root/wheel ownership of all the other files listed there?</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(7107);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2012-10-29 5:31 pm</div>
				                <div>I figured it out ... even though PhpInfo was reporting the PHP handler as &quot;CGI/FastCGI&quot;, the PHP handler in WHM was set to &quot;suphp&quot;. Once I changed that, the php5 file appeared in the location as you noted, and I was able to finish all the configuration steps.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(7111);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2012-10-30 8:48 am</div>
				                <div>Hello 3abnwebmaster,<br />
<br />
...
<br />
This article was intended for if you already had FastCGI up and running as your PHP handler, but it doesn't look like we have an article on getting FastCGI itself setup, so I'll work on one of those.<br />
<br />
- Jacob</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(7114);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-24779'></a>
		<div  style='margin:2px 0px 0px 40px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/8a22823eed7a0587b478a19fa042f290?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/8a22823eed7a0587b478a19fa042f290'>Rashmi</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-10 7:40 pm</div>
				                <div><p>HI</p>
<p>&nbsp;</p>
<p>I am new to cpanel and trying to store one library. My program need one library. So I am trying to give include path for jpgraph in php.ini file, but my system is not recognizing my php.ini file. I tried to put the line you mentioned in .htaccess fie. still it is not changing.</p>
<p>&nbsp;</p>
<p>Any help is appreciated.</p>
<p>&nbsp;</p>
<p>Thanks</p>
<p>Rashmi</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24779);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-13 1:18 pm</div>
				                <div>Hello Rashmi,<br />
<br />
Thank you for contacting us. Were you able to complete <strong>Step 7</strong>above, in order to verify your settings have been applied?<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24838);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2012-10-31 2:58 pm</div>
				                <div>Hi Jacob, I look forward to checking out the article on setting up FastCGI. I am not sure how to access EasyApache, so it's likely I've overlooked something.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(7138);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-28483'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/9bec8d88425db2d1b19d41bfe1276f79?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/9bec8d88425db2d1b19d41bfe1276f79'>Nithin C</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-17 1:42 am</div>
				                <div><p style="margin-bottom: 0cm;">Hello</p>
<p style="margin-bottom: 0cm;">Please create a domain sayitloud.com via backend and create an addondomain iloud.com and subdomain i.sayitloud.com and park weloud.com to i.sayitloud.com. Then change the php handler and create a custom php.ini to sayitloud.com. Kinldy attach the steps to dao that.</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28483);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-17 9:49 am</div>
				                <div>Hello Nithin,<br />
<br />
If you have a hosting plan then you should already have your primary domain which I am assuming is sayitloud.com. You would follow this guide on how to <a href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-manage-domains/adding-add-on-domain-in-cpanel">add addon domains in cPanel</a>. Here is how you <a href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-manage-domains/creating-a-subdomain">add subdomains to your account</a>, and here is how you <a href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-manage-domains/park">add parked domains</a>.  If you are on anything above a shared server you can <a href="http://www.inmotionhosting.com/support/website/php/choosing-the-best-php-handler">modify your PHP handler</a> via root access. And this guide goes over creating a custom php.ini file.<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28489);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
