<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:82911:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/file-management/resolve-ftp-eainodata-error" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-07-04T23:26:57-07:00" />
  <meta name="keywords" content="ftp EAI_NODATA EHOSTUNREACH ECONNABORTED nodename error connection refused" />
  <meta name="author" content="Jacob Nicholson" />
  <meta name="description" content="In this article I'm going to review why you might be encountering an EAI_NODATA - No address associated with nodename error in your FTP client. Sometimes an EAI_NODATA error is also related to either a EHOSTUNREACH error, or an ECONNABORTED error as well." />
  <title>Resolve FTP EAI_NODATA error - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/file-management/resolve-ftp-eainodata-error" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:29f14acc928d6b523919c550641af2b3 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-22']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '151.29.151.165']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Resolve FTP EAI_NODATA error									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>41,569</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Feb 4, 2013'><span style='color:#606060;'>Published:</span> Jul 4, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In this article I'm going to review why you might be encountering an <strong>EAI_NODATA - No address associated with nodename</strong> error&nbsp;in your FTP client. Sometimes an <strong>EAI_NODATA</strong> error is also related to either a <strong>EHOSTUNREACH</strong> error, or an <strong>ECONNABORTED</strong> error as well.</p>

<p>These are common FTP errors that occur when your domain name is not registered and pointing to a web server. Also sometimes if you just recently changed where your domain name is hosted at, your FTP client can cache private data settings from the old connection. This could prevent you from connecting to the correct server.</p>

<p>When DNS changes are made to your domain name, this changes the physical server your domain's website files are hosted on. These changes can take up to 24 hours to fully propagate, and especially after <a href="/support/domain-names/dns-nameserver-changes/updating-your-domains-nameservers" target="_blank">updating your domain's name servers</a>&nbsp;you might get the <strong>EAI_NODATA</strong> error within your FTP program</p>

<h2>Fixing EAI_NODATA error</h2>

<p>The steps below should be able to resolve the <strong>EAI_NODATA - No address associated with nodename</strong> error from happening. There are two methods in which you can utilize to try to prevent this error from happening to you.</p>

<ol class="article_list">
  <li><p>The easiest method would simply be to <a href="/support/website/cpanel/find-server-name-in-cpanel" target="_blank">find your server name in cPanel</a>, then in the <strong>hostname</strong>&nbsp;field of your FTP client, use that server name.</p>
<p>This would ensure that your FTP client is directly connecting to our web server that hosts your website, and it wouldn't have to rely on any recent changes to your domain name's DNS setting.</p>
<p>If your server was <strong>biz104</strong> for instance, you would want to use the hostname <strong>biz104.inmotionhosting.com</strong> to be able to connect.</p>
</li>
  
  <li><p>To try to resolve the <strong>EAI_NODATA</strong> error and keep using your domain name, you'd want to clear out the private data associated with that connection in your FTP client.</p>
<p>In this example we're going to be using <a href="/support/website/file-management/configuring-your-site-in-filezilla" target="_blank">FileZilla</a>.</p>
<ul style="counter-reset: toc 0; padding: 0px 0px 0px 50px; margin: 0px; border: 1px solid #CCC; background: #F8F8F8;">
<li>In FileZilla's menu click on <strong>Edit</strong> then select <strong>Clear private data...</strong></li>
<li>Ensure that <strong>Clear quickconnect history</strong> and <strong>Clear reconnect information</strong> and selected then click on <strong>OK</strong>.</li>
<li>If you get a <strong>Reconnect information cannot be cleared while connected to a server.</strong> pop-up, go ahead and click on <strong>OK</strong> to re-connect your FTP session to try again.</li>
</ul>
</li>
</ol>
<p>Hopefully this fixes any common FTP errors like <strong>EAI_NODATA</strong>, <strong>EHOSTUNREACH</strong>, or <strong>ECONNABORTED</strong>. If for some reason you're still having issues you should still be able to <a href="/support/website/file-management/how-to-upload-a-file-using-file-manager-in-cpanel" target="_blank">upload a file using File Manager in cPanel</a> as well.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/file-management/resolve-ftp-eainodata-error&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/file-management/resolve-ftp-eainodata-error'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yMyZpZD01NTImdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/04d51717c2070e1f746c571e7f16d79b?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/04d51717c2070e1f746c571e7f16d79b'>Howard</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-09 11:16 am</div>
				                <div><p>Hi, very easy instructions to follow and understand, no problem there. When I tried passive set up and test I got aborted error. When I tried Active I get 503 error.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9547);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-09 7:30 pm</div>
				                <div>Hello Howard,<br />
<br />
It sounds like you are more than likely encountering a firewall issue. Do you currently have any firewall software running on the computer that you're trying to establish an FTP connection from?<br />
<br />
Have you been able to FTP from your current computer to any other FTP servers, or are you just having a problem connecting to your website's FTP account?<br />
<br />
- Jacob</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9567);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-12517'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/f1c79050965c187b9aae2f46b1367556?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/f1c79050965c187b9aae2f46b1367556'>Abby See</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-09 3:25 am</div>
				                <div>It is good enough, very simple and clear. Thank you so much!</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12517);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-13446'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/387309cf47ed05a4d131d8a7cda23222?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/387309cf47ed05a4d131d8a7cda23222'>Mark</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-29 4:20 pm</div>
				                <div><p>Had this error, this fixed it like a charm (the three steps for Filezilla above) - so thanks!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13446);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-15543'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/a517f93baff274abac256edcd331b952?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/a517f93baff274abac256edcd331b952'>Yve</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-26 7:35 am</div>
				                <div><p>ECONNREFUSED - Connection refused by server"I'm getting the above error and followed the insturctions in&nbsp;http://www.inmotionhosting.com/support/community-support/file-management/how-do-i-fix-a-connection-refused-error-in-filezillabut it didn't work. I also tried to turn off the firewall. &nbsp;The surprising thing is that I can access other servers from the same program bar one&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15543);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-26 10:12 am</div>
				                <div>Hello Yve,<br />
<br />
Thank you for contacting us. In the <a href="https://forum.filezilla-project.org/viewtopic.php?t=7876" target="_blank">Official FileZilla forums</a>, they discuss several other solutions. Aside from the firewall, they recommend checking your anti-virus.<br />
<br />
We are happy to help, but will need some additional information. Have you made any DNS changes recently to the domain you are connecting to?<br />
<br />
Have you confirmed domain's nameservers/DNS are pointed to the right location?<br />
<br />
If you have any further questions, feel free to post them below.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15549);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-16291'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/851a19b13e37eb636d7a54f1235d78c5?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/851a19b13e37eb636d7a54f1235d78c5'>Nadine</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-15 9:46 am</div>
				                <div><p>Thank you for sharing this! Worked for me.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16291);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-22031'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/2f09aa909ae100b276325c6bc49e67e0?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/2f09aa909ae100b276325c6bc49e67e0'>Punar</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-25 6:50 pm</div>
				                <div><p>I had this problem, but the solution was much simpler since it was a silly mistake from me.</p>
<p>I had written as host: ftp.mydomain.com.</p>
<p>When I changed it to just mydomain.com without ftp in front, it worked.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22031);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-25962'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/52dc9e300aaf1f073f6898d5a3209231?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/52dc9e300aaf1f073f6898d5a3209231'>GSS IMPORTS</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-21 11:41 am</div>
				                <div><p>RESOLVI DE PRIMEIRA.&nbsp;</p>
<p>OBRIGADO.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25962);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-27214'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/08a206714ad75eaa50a946ec2d0f840a?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/08a206714ad75eaa50a946ec2d0f840a'>Ballu Gupta</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-04 2:37 pm</div>
				                <div><p>Hi</p>
<p>&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;I am very upsate for ftp and browser not opening my hosting and webpage on my computer.. please help me</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27214);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-05 12:07 pm</div>
				                <div>Hello Ballu,<br />
<br />
Thank you for contacting us. We are happy to help, but will need some additional information. Did you try the solution above?<br />
<br />
Have you tried the Quickconnect option in FileZilla?<br />
<br />
Have you checked your <a href="http://www.inmotionhosting.com/support/website/getting-started-guides/cpanel-logs-for-access-apache-email-error-ftp-mysql-whm">FTP logs</a> for any errors or record of your connection? If you are on a shared server, Live Support can assist you with this.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27235);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
