<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:59231:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/everything-email/setting-up-an-email-account-on-your-kindle-fire-tablet" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-03-19T21:19:22-07:00" />
  <meta name="author" content="Arnel Custodio" />
  <meta name="description" content="InMotion Hosting Support Center" />
  <title>Setting up an email account on your Kindle Fire Tablet - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/everything-email/setting-up-an-email-account-on-your-kindle-fire-tablet" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:e3f72e864bd320bd7b4d3b21e4f5ac08 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-20']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '161.185.151.242']);
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/everything-email' itemprop='url'><span itemprop='title'>Everything Email<span></a><div class='dropdown_4columns'><h2>Everything Email Education Channel</h2><div class='col_2'><h3>100 Level Classes</h3><div><a href='/support/edu/everything-email/introduction-email'>101: Basic Introduction to Email</a></div><div><a href='/support/edu/everything-email/email-features'>102: Email Features</a></div><div><a href='/support/edu/everything-email/organizing-email'>103: Organizing your Email</a></div></div><div class='col_2'><h3>200 Level Classes</h3><div><a href='/support/edu/everything-email/spam-prevention-techniques'>201: Dealing with Spam</a></div><div><a href='/support/edu/everything-email/202-using-dada-mail-for-sending-newsletters'>202: Using DaDa Mail for sending Newsletters</a></div><div><a href='/support/edu/everything-email/203-common-email-errors'>203: Common Email errors</a></div><div><a href='/support/edu/everything-email/mcafee'>203: McAfee Email Protection</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Setting up an email account on your Kindle Fire Tablet</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Setting up an email account on your Kindle Fire Tablet									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>9,826</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Mar 6, 2014'><span style='color:#606060;'>Published:</span> Mar 19, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/kindle-fire-email/full-device-screen.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="100" alt="Carrier list" src="//cdn.inmotionhosting.com/support/images/stories/edu/kindle-fire-email/full-device-screen.png" align="right" /></a>

<p>The following article shows how to set up an email account on your Kindle Fire tablet. Each tablet can be set up to view a single or multiple email accounts using the POP3 or IMAP protocol available with your InMotion Hosting account.  Like any good email client, you can use either secure or non-secure settings.  The tutorial will explain these settings and display the options that you can select. </p>
<div style="clear:both;"></div> 


<h2>Setting up email for Kindle Fire Tablets</h2>


<ol class="article_list">

<li>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/kindle-fire-email/email-icon-kindle.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="100" alt="Carrier list" src="//cdn.inmotionhosting.com/support/images/stories/edu/kindle-fire-email/email-icon-kindle.png" align="right" /></a>
<p>Power on your Kindle, then go to your apps and look for the Email icon.  Click on the email icon (which looks like an envelope with a letter sticking out of it) to start the set up process.</p>
</li>
<div style="clear:both;"></div> 
<li>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/kindle-fire-email/add-email-address.png"><img  width="100" alt="Type in your account email address" src="//cdn.inmotionhosting.com/support/images/stories/edu/kindle-fire-email/add-email-address.png" align="right" /></a>
<p>If you are setting it up for the first time, then you will be requested to type in the email address of the account you're trying to set up.  If there is an account already setup, then you will be launching the email application.  Type in the email address, then click on the <b>NEXT</b> button or <b>DONE</b> button.
</p>
<div style="clear:both;"></div> 
</li>
...
<li>
<p>You will then need to type in the email password.  Click <b>NEXT</b> to proceed.</p>
</li>

<li>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/kindle-fire-email/add-mail-server-name.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="100" alt="Choose email protocol" src="//cdn.inmotionhosting.com/support/images/stories/edu/kindle-fire-email/add-mail-server-name.png" align="right" /></a>

<p>The next step in adding an account will require you to determine if you're using a POP3, IMAP or Exchange account.  If you're using email from your InMotion Hosting account then you should only choose either POP3 or IMAP.  To learn more about the difference between POP3 and IMAP please go to <a href="http://www.inmotionhosting.com/support/edu/everything-email/introduction-email/checking-email-account">How email works</a>.  Click on the email protocol that you wish to use.</p>
<div style="clear:both;"></div> 
</li>  
<li>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/kindle-fire-email/select-account-type.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="100" alt="Choose email protocol" src="//cdn.inmotionhosting.com/support/images/stories/edu/kindle-fire-email/select-account-type.png" align="right" /></a>  
  
<p>
Immediately below where you have chosen either POP3 or IMAP you will see the blank field for the name of the server.  Type in the name of the incoming mail server.  If you need help finding this setting, please go to <a href="http://www.inmotionhosting.com/support/edu/everything-email/introduction-email/how-to-find-email-settings">how to find your email settings</a>. By default, typical server accounts for InMotion Hosting servers usually follow this format:  mail.domain_name.com .  You would replace "domain_name.com" with the name of the domain where your email is set up.  
</p>
<div style="clear:both;"></div>  
</li>
...
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/kindle-fire-email/checking-settings.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="100" alt="Choose email protocol" src="//cdn.inmotionhosting.com/support/images/stories/edu/kindle-fire-email/checking-settings.png" align="right" /></a>  
  
<p>
  Click <b>NEXT</b> in order to proceed.  Note that you may see a screen that shows a message that states "Checking server settings...".  You can click on the <b>CANCEL</b> button to cancel the check at this point.
</p>
<div style="clear:both;"></div>
</li>
...
<li>
  ...
  <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/kindle-fire-email/outgoing-server.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="100" alt="SMTP server settings" src="//cdn.inmotionhosting.com/support/images/stories/edu/kindle-fire-email/outgoing-server.png" align="right" /></a> 
  
<p>Click on <b>NEXT</b> to advance through the different settings for the email account.  The next blank is <b>SERVER FOLDER</b>.  You can leave this entry blank.  If you click <b>NEXT</b> again, you will be filling in the <b>SMTP server setting</b> under <i>Outgoing Server settings</i>. The typical format for the outgoing server/SMTP server name will look exactly like the incoming server name:
</p>
<div style="clear:both;"></div>  
<br />

<p><b>mail.domain_name.com</b></p>
<br />

<p>
For more information on determining your email server settings, please go to <a href="http://www.inmotionhosting.com/support/edu/everything-email/introduction-email/how-to-find-email-settings">How to find your email settings</a>.
</p>
</li>

<li>
  
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/kindle-fire-email/security-settings-ports.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="100" alt="Security Settings" src="//cdn.inmotionhosting.com/support/images/stories/edu/kindle-fire-email/security-settings-ports.png" align="right" /></a>   
  
<p>When you are on the Outgoing Server Settings screen, there is a section labeled Security Settings and Ports. Click on this section to open the screen. Email settings generally come in two forms - secured and non-secured. By default, the secure settings are checked.</p>

<p>Here are examples of server names used by InMotion Hosting accounts:</p>

  <p><i>biz##.inmotionhosting.com</i></p>
  <p><i>ecbiz##.inmotionhosting.com</i></p>

  <p><i><b>Note:</b>To find your server name, please see <a href="http://www.inmotionhosting.com/support/website/amp/viewing-account-technicial-information-in-amp">Viewing your Account Technical Information in AMP</a>.
    </i>
    </p>

<p>Here's a list of typical email port settings:</p>

<table cellpadding="10"; border="1">
<tr><th>Secure</th><th>Non-Secure</th>
</tr>
<tr><td><p>Incoming</p> 
  <p>IMAP port = 993</p>
  <p>POP3 port = 995</p>
...
<tr><td><p>Outgoing</p>
  ...
  <br />
<p>If you check the "Use secure connection (SSL)", then the port will change to 465. Select the settings you wish to use. </p>
<div style="clear:both;"></div>  
  
</li>

<li>When you have completed choosing your Security settings, click on <b>SAVE</b>.
</li>
...
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/kindle-fire-email/successful-install.png"><img style="float: right; margin: 0px 0px 15px 15px;"  width="100" alt="Setup complete!" src="//cdn.inmotionhosting.com/support/images/stories/edu/kindle-fire-email/successful-install.png" align="right" /></a> 

<p>Once the settings are saved the tablet will attempt to connect to the email server to confirm your settings.  you'll see the "Setup complete!" screen.  You can also add another email account at this point.  
</p>
<div style="clear:both;"></div>
</div>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/everything-email'>Everything Email</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 3: Setting up an email account on your Kindle Fire Tablet</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 2: <a href='/support/edu/everything-email/aol-dmarc'>AOL Rejecting Mail due to DMARC policy</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 4: <a href='/support/edu/everything-email/setup-windows-phone-email'>Steps to setup Email on a Windows Phone</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/everything-email/setting-up-an-email-account-on-your-kindle-fire-tablet&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/everything-email/setting-up-an-email-account-on-your-kindle-fire-tablet'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD01MSZpZD0zMTM2JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="912ea8ed16a2a7ce73bcb7d987cdf96c" value="1" />	</div>
	</form>
<!-- <br />
