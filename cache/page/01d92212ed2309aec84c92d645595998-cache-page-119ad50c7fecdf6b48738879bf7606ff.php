...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.net/support/edu/joomla-3/create-template" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Looking to build a new bootstrap template for your Joomla 3 website? We have many step by step articles on how to do so." />
  <title>208: Building a Basic Joomla 3 Template with Bootstrap | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-3/create-template" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:596e221de387328429a9e33bc0a7a1a0 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '188.212.23.199']);
...
<div class='page-header'>
	<h1>208: Building a Basic Joomla 3 Template with Bootstrap</h1>
</div>
<div class='section_listing'>
	<div style="float: right; margin: 0px 0px 15px 15px; text-align: center;"><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/create-template/basic-joomla3.0-template.jpg"><img  alt="basic-joomla3.0-template" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/create-template/basic-joomla3.0-template.jpg" /></a><br /><br /><a href="http://www.inmotionhosting.com/support/files/joomla-3/templates/basicjoomla3.0template.zip">Download <strong>Basic Joomla 3.0 Template</strong></a></div>
<div>In the following set of tutorials, we will show you how to build a Joomla 3.0 template. This template will include bootstrap, and will be fully responsive.</div>
<p>This basic template that we are creating is being developed from the standpoint of a developer. We can't promiss it will be a pretty template, but we will show you how to build a simple Joomla 3.0 template that works.</p>
<p>A screenshot of the template and a download link can be found to the right, and our tutorial series documenting how we developed the template can be found below. Learn more about <a href="http://www.inmotionhosting.com/joomla-hosting">Joomla Hosting here</a>.</p>
<div style="clear: both;">&nbsp;</div>
	<table>
		<tr>
				...
				<td style='padding-bottom:10px;'>
					...
					<div class='smallgrey'>Hits: 95,844</div>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-3/create-template/zip-template'>How to zip a Joomla 3.1 template</a>
					<div>Now that we have all the files necessary for our template, we will show you the basics of zipping the file and getting it ready for installation.</div>
					<div class='smallgrey'>Hits: 27,897</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-3/create-template/how-to-install-template'>How to install a Joomla 3.1 Template</a>
					<div>In this Joomla 3.0 tutorial, we will walk you through the steps for installing a Joomla 3.0 template</div>
					<div class='smallgrey'>Hits: 74,088</div>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td style='padding-bottom:10px;'>
					...
					<div class='smallgrey'>Hits: 62,202</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-bottom:10px;'>
					...
					<div class='smallgrey'>Hits: 79,268</div>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-3/create-template/security-using-jexec'>Adding security to a Joomla 3.1 template using JEXEC</a>
					<div>In this tutorial, we'll show you how to add JEXEC to your Joomla 3.0 to help add a standard layer of security to your template.</div>
					<div class='smallgrey'>Hits: 20,135</div>
				</td>
			</tr>
		<tr><td colspan='3' style='padding-top:20px;'><h2>Adding CSS and Style to the template</h2><div>Learn how we added basic style to the template by updating our css/style.css file</div></td></tr>	<tr>
			...
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-3/create-template/css-to-sidebar'>Adding CSS to sidebar items in a Joomla 3.1 template</a>
					<div>In this Joomla 3.0 tutorial, we'll show you how to style the modules in our template's right sidebar using CSS.</div>
					<div class='smallgrey'>Hits: 21,135</div>
				</td>
			</tr>
			</table>
</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNzEmaWQ9MjcxJnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
