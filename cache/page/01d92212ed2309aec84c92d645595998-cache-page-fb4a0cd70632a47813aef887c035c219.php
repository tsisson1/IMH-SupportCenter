<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49790:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/how-to/how-do-i-see-all-files-on-my-server" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, Thanks for the question about downloading your MySQL database. If you do not know how to use SSH to export a database through MYSQL, then you can..." />
  <title>How do I see all files on my server.  | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/how-to/how-do-i-see-all-files-on-my-server" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:5ad497268f7fc185285e17b387488347 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>How do I see all files on my server. </h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-04-08 6:23 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>39</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I have already obtained root access. I need to be able to download MySql databases directly. </div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_6982' id='upvote_answer_6982' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='6982' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_6982').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_6982' id='downvote_answer_6982' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='6982' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_6982').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello, <br />
<br />
Thanks for the question about downloading your MySQL database.  If you do not know how to use SSH to export a database through MYSQL, then you can use <a href="http://www.inmotionhosting.com/support/website/phpmyadmin/export-database-using-phpmyadmin">export a database using phpMyAdmin</a>.  The interface for a database is not like file manager.  You can access it through SSH, but we do not provide instruction on its use.  You can also interact with a database through a graphical interface like phpMyadmin.  I hope this helps to answer your question, please let us know if you require any further  assistance.<br />
<br />
Regards,<br />
Arnel C.<br />
<br />
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_6982').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_6982' id='form_comment_on_answer_6982' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
