<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:68330:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/wordpress/use-wordpress-cache-to-speed-up-your-site" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-01-02T19:44:47-08:00" />
  <meta name="keywords" content="wordpress cache caching optimize speed up plugin plugins W3 Total Cache WP Super Cache WP Fastest Cache plugin" />
  <meta name="author" content="Jacob Nicholson" />
  <meta name="description" content="A WordPress cache plugin will help your WordPress website run faster and more efficiently while using less resources on the server." />
  <title>Use WordPress cache to speed up your site - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/wordpress/use-wordpress-cache-to-speed-up-your-site" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:05d3264206218bcb2513718fd03f0a27 -->
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Use WordPress cache to speed up your site</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Use WordPress cache to speed up your site									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>5,978</span></div>
  ...
  <h2>Navigation:</h2>
  <button type="button" class="btn btn-primary" onclick="window.location.hash='what-is-caching';">What is caching?</button>
  <button type="button" class="btn btn-primary" onclick="window.location.hash='w3-total-cache';">W3 Total Cache</button>
  <button type="button" class="btn btn-primary" onclick="window.location.hash='wp-super-cache';">WP Super Cache</button>
  <button type="button" class="btn btn-primary" onclick="window.location.hash='wp-fastest-cache';">WP Fastest Cache</button>
</div>

<p>Every time a visitor comes to your WordPress website, by default, WordPress will create the page requested. Taking advantage of a WordPress cache plugin, you can create a static copy of your pages to speed things up.</p>

<p>With a WordPress caching plugin you can reduce your account's <a href="http://www.inmotionhosting.com/support/website/server-usage/viewing-resource-usage-with-cpu-graphs" target="_blank">resource usage</a>, allowing you to run more WordPress sites on a single account. While at the sime time, your visitors can enjoy a faster browsing experience. </p>

<!-- //NOTE What is caching? -->
<a name="what-is-caching"></a>
<h2>What is caching?</h2>

<p>To serve a page, the server needs to send some HTML code back to the web-browser of a visitor for them to view. A CMS like WordPress, uses a server-side language called PHP to first put together all the pieces of your web page.</p>

<p>For every visitor, a PHP script will run, pull info from your WordPress database, and spit back the HTML code.</p>

<p>A WordPress caching plugin will make a copy of the HTML code, then serve that to the next visitor, saving time.</p>

<!-- //NOTE WordPress without caching -->
<h3>WordPress without caching</h3>

<p>This is the output from running the <a href="http://www.inmotionhosting.com/support/website/server-usage/using-the-linux-top-command-in-batch-mode" target="_blank">top command in batch mode</a> while requesting the front page of my WordPress site 5 times, and then one post from the site 5 times. I've highlighted each completed request in yellow:</p>

<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress/caching/php-processes-before-caching.png"><img  style="max-width: 610px; max-height: 300px; width: 610px; float: left;" src="//cdn.inmotionhosting.com/support/images/stories/wordpress/caching/php-processes-before-caching.png" alt="php processes before caching"></a>

<pre class="code_block" style="width: 50px; float: right; line-height: 2.0em; margin-top: 5px;">0:00.22
0:00.17
0:00.23
0:00.24
0:00.21
...
<p style="margin-top: 5px;">The 11th column shows the CPU time used to fulfill each PHP request when hitting my WordPress site repeatedly.</p>

<p>For <strong>10 requests</strong> it took <strong>2 seconds of CPU time</strong>. With hundreds, or thousands of requets, this can add up.</p>

<!-- //NOTE WordPress with caching -->
<h3>WordPress with caching</h3>

<p>Here are the same <strong>10 requests</strong> from above, this time with a WordPress cache plugin installed and running:</p>

<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress/caching/php-processes-after-caching.png"><img  style="max-width: 610px; max-height: 300px; width: 610px;" src="//cdn.inmotionhosting.com/support/images/stories/wordpress/caching/php-processes-after-caching.png" alt="php processes after caching"></a>

<pre class="code_block" style="width: 50px; float: right; line-height: 1.3em;">0:00.29
0:00.18
    
0:00.47</pre>

<p style="margin-top: 15px;">Now my WordPress site is only using <strong>.47 seconds of CPU time</strong> instead of <strong>2 seconds</strong> to serve the same <strong>10 requests</strong>.</p>

<p>With a WordPress cache, only 2 PHP scripts ran, one to generate the front page, and one for the additional post. Every refresh I did of the page after that, the server just handed me the HTML copy that WordPress cached.</p>

<!-- //NOTE WordPress caching saves time -->
<h3>WordPress caching saves time</h3>

<p>On average my WordPress site with minimal plugins installed used <strong>.2 seconds of CPU time</strong>, so if I do the math.</p>

<table class="article_table" style="width: 650px;">
<tr>
    <th colspan="3" style="text-align: center;">WordPress without cache plugin</th>
    <th colspan="3" style="text-align: center;">WordPress with cache plugin</th>
...
<p style="margin-top: 15px;">It's important to note that this is on a bare WordPress website with only one minimal WordPress plugin installed. If you happen to be running an <a href="http://www.inmotionhosting.com/support/website/wordpress/how-to-optimize-wordpress#intensive-plugins" target="_blank">intensive WordPress plugin</a>, your CPU time per single page could be much higher.</p>

<p>This is why it's important to run a WordPress caching plugin, especially in a shared environment. 
If you suddenly have a surge in traffic to a few of your pages, it could quickly cause a lot of resources to be used needlessly.</p>

<!-- //NOTE W3 Total Cache -->
<a name="w3-total-cache"></a>
<h2>W3 Total Cache</h2>

<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress/caching/w3-total-cache.png"><img  style="width: 150px; float: left; margin-right: 15px;" src="//cdn.inmotionhosting.com/support/images/stories/wordpress/caching/w3-total-cache.png" alt="w3 total cache"></a>

<p>The <a href="http://www.inmotionhosting.com/support/edu/wordpress/recommended-wordpress-plugins/optimizing-wordpress-with-w3-total-cache" target="_blank">W3 Total Cache plugin for WordPress</a> is a highly customizable caching plugin and is typically used in more advanced scenarios where you might be interested in utilizing a CDN (Content Delivery Network) or other more advanced features.</p>

<p>As you can see from the screenshot on the left, there are quite a few options to control. So if you aren't interesting in configuring all of those, you might be interested in using a more simple caching plugin.</p>

<div style="clear: both;"></div>

<!-- //NOTE WP Super Cache -->
<a name="wp-super-cache"></a>
<h2>WP Super Cache</h2>

<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress/caching/wp-super-cache.png"><img  style="width: 150px; float: left; margin-right: 15px;" src="//cdn.inmotionhosting.com/support/images/stories/wordpress/caching/wp-super-cache.png" alt="wp super cache"></a>

<p>The <a href="http://www.inmotionhosting.com/support/edu/wordpress/recommended-wordpress-plugins/optimizing-wordpress-with-wp-super-cache" target="_blank">WP Super Cache plugin for WordPress</a> is a very easy to setup caching plugin that still has a good amount of features, but is normally used in more basic caching scenarios.</p>

<p>Again as you can tell from the screen shot on the left, there are a decent amount of options for you to configure, but far less than W3 Total Cache.</p>

<div style="clear: both;"></div>

<!-- //NOTE WP Fastest Cache -->
<a name="wp-fastest-cache"></a>
<h2>WP Fastest Cache</h2>

<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/wordpress/caching/wp-fastest-cache.png"><img  style="width: 150px; float: left; margin-right: 15px;" src="//cdn.inmotionhosting.com/support/images/stories/wordpress/caching/wp-fastest-cache.png" alt="wp fastest cache"></a>

<p>The <a href="http://www.inmotionhosting.com/support/edu/wordpress/recommended-wordpress-plugins/simple-wordpress-caching-with-wp-fastest-cache" target="_blank">WP Fastest Cache plugin for WordPress</a> is a newer less robust caching plugin. However it is very simple to setup and configure correctly and still does a great job at reducing usage.</p>

<p>As you can see from the screenshot on the left, this is one of the most stripped down and basic WordPress caching plugins. It still does a great job though!</p>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/wordpress/use-wordpress-cache-to-speed-up-your-site&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/wordpress/use-wordpress-cache-to-speed-up-your-site'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD02MyZpZD0zMDQ3JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
