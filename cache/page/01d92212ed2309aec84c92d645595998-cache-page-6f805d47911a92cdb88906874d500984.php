<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:123818:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/backup-and-restore/restoring-a-backup" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-02-11T17:02:24-08:00" />
  <meta name="keywords" content="backup data restore files" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="Learn about backups, how to request to restore files and if we have a current backup to restore for you." />
  <title>Restoring a Backup - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/backup-and-restore/restoring-a-backup" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:cec841b93ab60d5cc908c3117e70649d -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '87.17.33.179']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Restoring a Backup</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>33,419</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Sep 19, 2011'><span style='color:#606060;'>Published:</span> Feb 11, 2014</div>
  ...
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('our_backups');">Automated backups</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('cpanel');">cPanel backups</button>
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('sql');">MySQL backups</button>
</div>
<p>Keeping backups of your your website is critical at all times.  Backups can be restored from our backups, your own cPanel backup, or SQL files for your database.  In this article, we will review the process for restoring each of these options.</p>
<a name='our_backups'></a>
<h2>Restoring from our automated backups</h2>
<p>InMotion Hosting does perform some backups. Backups are ran every 24 to 36 hours and <strong>overwrite</strong> the previous backup. Not all accounts are backed up so let's review what accounts are backed up:</p>
<ul>
<li>Personal/Cheap Hosting Plans under 10GB</li>
<li>Business Class Hosting Plans under 10GB (this excludes the LD servers)</li>
<li><a href="http://www.inmotionhosting.com/vps_hosting.html" target="_blank">VPS</a> accounts under 10GB</li>
</ul>
<p>Because backups run every 24 to 36 hours and overwrite the previous one, if you want a backup from a week ago restored, it is not likely we will have a backup. If you would like to find out if we have a backup available to restore please contact our technical support department for further assistance.</p>

<p>Once you have determined there is a backup that you would like to have restored, you can follow the steps below to request a data restoration.</p>

</p>
            

<ol class="article_list">
<li><a href="http://www.inmotionhosting.com/support/website/how-to/how-to-log-into-amp" target="_blank">Login to AMP</a>.</li>         

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/data-restoration/data-restoration-request.png"><img  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;" src="//cdn.inmotionhosting.com/support/images/stories/data-restoration/data-restoration-request.png" alt="click on other under additional services"></a>Under your account name, click the <strong>Data Restoration Request</strong> button.</li>
            
            <li style="clear: both;">
            <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/data-restoration/data-restoration-info.png"><img  style="width: 160px; float: right; margin-left: 10px; position: relative; bottom: 15px;" src="//cdn.inmotionhosting.com/support/images/stories/data-restoration/data-restoration-info.png" alt="click on data restore"></a>Read through the information regarding data restorations, and click the <strong>NEXT</strong> button to proceed.<br>
</li>
                
               
<li style="clear: both;">Now fill in the fields regarding what you need restored and then click <strong>Submit</strong>. You will then see an “<em>Order Processing</em>” message
            </li>
            <p style="clear: both;">&nbsp;</p>
            
            </ol>

<p>You should receive an email once your data restoration request has been completed. Please note that data restorations are not instant, and depending on the size of the files you have requested to restore, and the current queue of ticket requests prior to yours, it could take a few hours to complete.</p>

<a name='cpanel'></a>

<h2>Restoring a full cPanel backup</h2>

<p>If you have previously made a full cPanel backup from another host, or an earlier backup of your account with us, your cPanel backup can be restored.  On shared hosting, or a VPS/dedicated server without root access, our technical support team will need to restore this backup for you.  To do so, simply upload your full cPanel backup to your home directory via <a href="http://www.inmotionhosting.com/support/webinars/website-transfers/upload-website-files">FTP</a> or the <a href="http://www.inmotionhosting.com/support/website/file-management/how-to-upload-a-file-using-file-manager-in-cpanel">cPanel File Manager</a>, then <a href="http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support">submit a ticket to support</a> letting them know where it is located.</p>
<a name='sql'></a>
<h2>Restoring databases</h2>
<p>To restore a database, you may do so <a href="http://www.inmotionhosting.com/support/website/phpmyadmin/import-database-using-phpmyadmin">from within PHPMyAdmin</a> if your database is under 50MB.  If your database is over 50MB, technical support would need to restore it for you.  To do so, you may upload your SQL file to your home directory, then <a href="http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support">submit a ticket to support</a> with the path to the database file, as well as the name of the database that you want to restore it to.</p>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/backup-and-restore/restoring-a-backup&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/backup-and-restore/restoring-a-backup'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP3RzcmM9YW1wJm9wdGlvbj1jb21fY29udGVudCZjYXRpZD00MjImaWQ9MjM4JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="6ab3288deb6a126043ee0040be1a3186" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/everything-email/problems-after-restoration?tsrc=rsbraq'>Problems with email after a data restoration</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/databases/long-wait-database-restoration?tsrc=rsbraq'>Long wait for database restoration</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/prestashop-15/shipping-mod-not-working-the-carriers-option-is-not-dropping-down?tsrc=rsbraq'>Shipping mod not working &amp; the Carriers option is not dropping down</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/prestashop-15/back-office-not-working-after-upgrade?tsrc=rsbraq'>Back Office not working after 1-click upgrade to 1.6.011</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/joomla-3/css-not-working-in-root-installation?tsrc=rsbraq'>CSS not working in root installation</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/billing/publichtml-folder-deleted-from-home-directory?tsrc=rsbraq'>public_html folder deleted from home directory</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/d9601154b21ab996dc7f2b7dbb9ccc9a?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/d9601154b21ab996dc7f2b7dbb9ccc9a'>Andy</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-19 5:12 pm</div>
				                <div><p>The cPanel file manager limits uploads to 1.0GB. My website backup is over 8GB and so I cannot upload it through cPanel. My FTP&nbsp;domain currently still points to my previous domain registrar, so I can't use an FTP client to upload the backup. What should I do?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9043);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-19 8:03 pm</div>
				                <div>&lt;div style=&quot;background-color: #FFF; padding-left: 10px;&quot;&gt;Hello Andy,<br />
<br />
You can simply &lt;a href=&quot;http://www.inmotionhosting.com/support/website/cpanel/how-to-find-your-shared-ip-address-of-your-server-in-cpanel&quot; target=&quot;_blank&quot;&gt;find the shared IP address of your server&lt;/a&gt;, or &lt;a href=&quot;http://www.inmotionhosting.com/support/website/cpanel/find-server-name-in-cpanel&quot; target=&quot;_blank&quot;&gt;find the server name in cPanel&lt;/a&gt;.<br />
<br />
Then use your FTP client to go to that IP address or server name instead of a full hostname with your domain name.<br />
<br />
You could also &lt;a href=&quot;http://www.inmotionhosting.com/support/website/how-to/modifying-your-hosts-file&quot; target=&quot;_blank&quot;&gt;modify your hosts file&lt;/a&gt; to force your computer to resolve your domain name directly at our server.<br />
<br />
Please let us know if you had any other questions at all.<br />
<br />
- Jacob&lt;/div&gt;</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9050);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/2df237281a15aff04637a865a5e36200?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/2df237281a15aff04637a865a5e36200'>Otto Colette</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-26 6:52 pm</div>
				                <div><p>I need this file restored&nbsp; from FTP file amoney@a-amoney-tree,com/home/amoney...html/amoney</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10184);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-28 12:59 am</div>
				                <div>Hello Otto,<br />
<br />
If you need any files restored from our backups, please <a href"http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support">contact our support department</a> as son as possible. Our backups are good for 24 hours before being overwritten.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10222);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-10923'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/3ad6be8e4d14f957e9c904bccbc57368?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/3ad6be8e4d14f957e9c904bccbc57368'>Deborah Mitchell</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-27 9:21 am</div>
				                <div><p>Your "Restoring a Backup" page does not coinside with what is actually on the AMP page. I could not restore anything by following the directions, as the icons on the AMP page are not there. I am extremely frustrated.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10923);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-27 10:13 am</div>
				                <div>Hello Deborah,<br />
<br />
We are so sorry you were not able to see the icons. You have been with us so long that the hosting plan name had changed. The AMP looks for specific plan names and displays icons accordingly. I have set the plan name correctly in your account and the icons display for you as they should. Your plan and price did NOT change, only the name. <br />
<br />
You should now  be able to request the data restoration as in the instructions. Thank you for bringing this to our attention and thank you for being such a loyal customer!<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10927);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-13632'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/081bfe6f83516d6ca41156bf39329583?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/081bfe6f83516d6ca41156bf39329583'>Peter Mallett</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-04 2:25 pm</div>
				                <div><p>I want to request and automated backup because my site is down. I already chatted with a tech rep and then said might be best. It appears to be recently added plugins causing a conflict. I'm not sure what information to request on the next page after this article ends, and where to get to find the information to fill in. I don't know if everything needs to be restored.&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13632);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-04 2:40 pm</div>
				                <div>Hello Peter,<br />
<br />
Thank you for your question. Since you are not sure what needs to be restored, I recommend putting as much information in the request as possible.<br />
<br />
A full restoration may be required to restore your site.<br />
<br />
If you have any further questions, feel free to post them below.<br />
Thank you,<br />
<br />
-John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13634);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-04 2:54 pm</div>
				                <div><p>Where do I find the information to fill in each section? Unfortunately I may have to wait til because I have to be at work soon.&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13636);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-04 3:12 pm</div>
				                <div>Hello Peter,<br />
<br />
The information you may need to fill out the Data restoration request can all be found from within your cPanel. Look either in the Databases category (for database info) or the File Manager (for file and folder information).<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13638);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-15852'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//graph.facebook.com/leopoldo.hernandezchanona/picture?type=normal' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='/support/community-support/users/leopoldo'>leopoldo</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-03 3:15 pm</div>
				                <div>necesito informacion en español de como acceder a mi cuenta ya que tengo 30 dias que no puedo acceder<br />
correo alternativo **********@gmail.com<br />
<br />
need information in Spanish on how to access my account and I have 30 days that I can not access<br />
alternative e **********@gmail.com</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15852);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-03 3:33 pm</div>
				                <div>Hello leopoldo,<br />
<br />
Thank you for contacting us. Unfortunately, we only offer support in english. <br />
<br />
We are happy to help you with your email, but we will need some additional information. <br />
<br />
What happens when you try to check your email? Are you using Outlook, Thunderbird, Webmail, etc.?<br />
<br />
Are you getting errors? What are they?<br />
<br />
If you have any additional questions/information, feel free to post them below.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15854);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-16667'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/33b32367e2a146212a65b3fa7960c18f?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/33b32367e2a146212a65b3fa7960c18f'>harubel</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-24 12:40 am</div>
				                <div>Please add some pic and example to make it more useful</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16667);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-30 9:19 am</div>
				                <div>Hello harubel,<br />
<br />
Thank you for your suggestion. I will review the article and update it as needed.<br />
<br />
If you have any other feedback, feel free to let us know.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16897);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-16741'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/817b8c32d08bfff60d5c95a25004071d?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/817b8c32d08bfff60d5c95a25004071d'>David</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-27 1:23 am</div>
				                <div><p>I just had some tech help to put in a restore from backup request after a Wordpress theme update crashed my site. Now I'm learning more about backups (as a relative newcomer to website mgmt). I see InMotion does backups and overwrites prior backups, so, if I hadn't noticed immediately when my site crashed, would the clock be ticking? In other words, suppose my site crashed, I went away for a weekend, and InMotion generated a backup after the crash. Would it backup an empty site and overwrite the good version, or would it fail to generate a backup and essentially give me enough time to catch the crash?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16741);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-27 9:18 am</div>
				                <div>Hello David,<br />
<br />
Thank you for your question about backups. Yes, that is correct, our backups occur every 24 to 36 hours, and will overwrite the previous backup. Please <a href="http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support">contact us</a> as soon as possible if you require a data restoration, as we prioritize these due to the time sensitive nature of the request.<br />
<br />
Keep in mind you can perform a <a href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-file-manager/backing-up-your-cpanel">complete backup</a> of your account at any time. I recommend performing a backup before/after any major updates/modifications to your website.<br />
<br />
Often when a site crashes it is due to a 3rd party plugin or addon, or coding issue, and you can troubleshoot or correct the problem. It typically will not cause actual damage to the <em>data</em> of the website.<br />
<br />
If you have any further questions, feel free to post them below.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16764);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-16882'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/87aad8e2f4b4bac3eac4379638dee0fd?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/87aad8e2f4b4bac3eac4379638dee0fd'>Jon </a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-29 11:08 pm</div>
				                <div><p>The article on moving an account from another hosting company to inmotion says to email support after loading the backups to the home directorys, which I did. I then noticed the request restore tab in my account panel. Will the email suffice or do I need to fill out the request form?</p>
<p>Thanks</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16882);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-30 9:16 am</div>
				                <div>Hello Jon,<br />
<br />
Thank you for your question. There is no need fill out an additional <strong>Data Restoration</strong> request in AMP. <br />
<br />
When you email our Support Team, it creates at ticket for them, and they will email you back upon completion. Keep in mind that the time frame depends on the difficulty of the request, and amount of data involved in the transfer.<br />
<br />
If you have any further questions, feel free to post them below.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16896);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-17237'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/a62474026c2157660a1d684ea9429563?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/a62474026c2157660a1d684ea9429563'>Billy Block</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-08 5:45 pm</div>
				                <div>Love the service and attention to detail with in motion. thanks so much</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17237);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-22856'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/7012663156382892811fbf90eba3849d?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/7012663156382892811fbf90eba3849d'>Chito</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-22 7:24 am</div>
				                <div><p>Dear Support Team.</p>
<p>Greetings! is there any chance that i could retrieve 2 email address that i accidentally deleted from the cpanel email accounts? i just accidentally deleted this morning and i want to retrieve it as these emails is using by 2 managers here in our office.</p>
<p>Please i you can help me regarding this matter it will be appreciated.</p>
<p>&nbsp;</p>
<p>Thank you</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22856);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-23 8:32 am</div>
				                <div>Hello Chito,<br />
<br />
The only way to restore 2 deleted cPanel email accounts is through a backup restore.  Follow this <a href="http://www.inmotionhosting.com/support/website/backup-and-restore/restoring-a-backup" target="_blank">article</a> and it should help you get the restore done as quickly as possible.  Remember that daily backups occur every 24-36 hours, so you should send the request immediately before the next backup occurs that would wipe your chance to restore those email account entries.  <br />
<br />
Regards,<br />
Arnel C.<br />
</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22879);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-30697'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/a2da55ea75746834d26c93f43dd3fdf9?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/a2da55ea75746834d26c93f43dd3fdf9'>Todd</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-02-19 11:57 pm</div>
				                <div><p>I just received a notification from admin saying the following. &nbsp;My site is down and I can't access the WP code at all. &nbsp;Is it possible to restore the entire site from the latest backup?<span style="font-family: Helvetica; font-size: 12px;">Our System Administration team has discovered your account security was compromised and 'hacks' inserted into your account. These 'hacks' were loaded onto your account through either a weak password that was guessed or by a third-party via an exploit in the software on your site.</span><span style="font-family: Helvetica; font-size: 12px;">&nbsp;</span></p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30697);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-02-20 9:39 am</div>
				                <div>It might be possible, but it really depends on when the last backup was ran. You cen reply to the email and someone should be able to assist you. Feel free to contact Live Support as well. </div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30706);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/ee5357175ff09a77f2b3537fd919f707?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/ee5357175ff09a77f2b3537fd919f707'>Alex</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-09 8:54 pm</div>
				                <div><p>Well I find this quite funny, I am moving away from a cheap company that even with the shared hosting provided daily files and/or mysql backups with an history of 2 weeks. There should be an easy option in the cPanel to&nbsp;set up daily backups which also allows you to restore them very easily, browsing by day/folder. but still after spending 500$ a year for a VPS that option seems to be disabled. I mean it's my own virtual server why can't I decide to have daily backups?&nbsp;Let's say I realise I got hacked a week after that happened, are my clean files lost forever?? come on!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31099);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-10 4:01 pm</div>
				                <div>Hello Alex,<br />
<br />
Thank you for contacting us. If you have a VPS or dedicated server with WHM access, you can configure local backups on your server. This will allow you to maintain copies of your good data locally on the same server that you host your website with.<br />
<br />
This is from our full guide on how to <a href="http://www.inmotionhosting.com/support/website/backup-and-restore/configure-local-backups-in-whm">Configure local backups in WHM</a>. Keep in mind this can fill your server space, so it is recommended to remove/download the backups and store them elsewhere. (You also don't want to rely on backups stored in the same location as your active site, in case there is a catastrophic incident you wouldn't be able to access either. This is like storing your spare key on the same key chain as your main key).<br />
<br />
Alternately, you can also custom-code a cron job to automate backups, here are some helpful links:<br />
<a href="http://www.inmotionhosting.com/support/edu/cpanel/301-run-cron-job" target="_blank">How to run a cron job</a><br />
<br />
<a href="http://www.inmotionhosting.com/support/community-support/tools/how-to-schedule-backups-with-a-cron-job" target="_blank">How to Schedule backups with a cron job</a><br />
<br />
Keep in mind you can perform a <a href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-file-manager/complete-cpanel-backup">complete backup</a> at any time, as well as <a href="http://www.inmotionhosting.com/support/edu/cpanel/softaculous/create-backup">backup your site/files using Softaculous</a>.<br />
<br />
Also, most CMS's (such as WordPress, Joomla, Drupal, Magento, OpenCart, etc.) have plugins/extensions you can use to automate backups.<br />
<br />
If you have any further questions, feel free to post them below.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31129);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-31315'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/fd5d89dfadab7c9602f5d9bbfd4b815f?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/fd5d89dfadab7c9602f5d9bbfd4b815f'>jainy </a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-18 8:32 am</div>
				                <div><p>I have done restore website data from old host to inmotion.now what should I di next?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31315);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-18 9:19 am</div>
				                <div>Hello Jainy,<br />
<br />
If you have moved everything over, has your DNS been changed to our nameservers? If so then you should be able to close things with your previous host.<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31317);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
