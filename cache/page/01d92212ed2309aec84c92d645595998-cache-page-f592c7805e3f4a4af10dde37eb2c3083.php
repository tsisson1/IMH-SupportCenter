<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:58429:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/drupal-7/sef-urls/how-to-enable-search-engine-friendly-urls-in-drupal-7" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-07-18T17:36:15-07:00" />
  <meta name="keywords" content="drupal search engine friendly URL URLs clean how to use" />
  <meta name="author" content="Tim Sisson" />
  <meta name="description" content="In this tutorial we'll show you how to enable clean URLs in Drupal 7, and we'll also show you the changes that this setting makes to your URLs." />
  <title>How to enable Search Engine Friendly URLs in Drupal 7 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/drupal-7/sef-urls/how-to-enable-search-engine-friendly-urls-in-drupal-7" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:bda01b7b311b35872dc27cb236a6b3bd -->
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
				<img src='/support/images/stories/drupal-partner/supporting-partner-80_3.png' style='float:right; margin:0px 0px 15px 15px;' alt='Drupal Association Support Partner'>		<h1>
															How to enable Search Engine Friendly URLs in Drupal 7									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>4,298</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Feb 23, 2012'><span style='color:#606060;'>Published:</span> Jul 18, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In our last tutorial, we explained the basic concept of <a href="/support/edu/drupal-7/sef-urls/sef-intro">Search Engine Friendly URLs in Drupal 7</a>. In this tutorial, we'll expand upon those ideas and show you how to enable clean URLs, which is required for Search Engine Friendly URLs to work.</p>
<p class="alert"><strong>Please note:</strong><br />Clean URLs, the setting discussed in this article, is enabled by default. You should only have to follow these steps if you are experiencing an issue with getting your new URLs to work correctly.</p>
...
<li>Go to <strong>Configuration &gt;&gt; Search and Meta Data &gt;&gt; Clean URLs</strong></li>
<li>Place a checkbox next to <strong>Enable clean URLs</strong>. This is enabled by default.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/drupal/drupal_clean_urls_1.jpg"><img  alt="drupal_clean_urls_1" src="//cdn.inmotionhosting.com/support/images/stories/drupal/drupal_clean_urls_1.jpg" /></a></li>
<li>Click the <strong>Save configuration</strong> button.<br /><br />At this point, you can test to see if clean URLs is working correctly. In our Drupal 7 site, there is a link in the sidebar that says <em>Create new account</em>. The following table shows the URL structure of this page before and after clean URLs are enabled:<br /><br /> 
<table class="article_table">
<tbody>
<tr>
<th>Clean URLs Disabled</th> <th>Clean URLs Enabled</th>
</tr>
<tr>
<td>http://domain.com<span style="color: #ff0000;">/?q=user/register</span></td>
<td>http://domain.com<span style="color: #ff0000;">/user/register</span></td>
</tr>
</tbody>
</table>
<p>The Clean URLs setting also impacts URL aliases set for content types, such as basic pages and articles. In previous tutorials we <a href="/support/edu/drupal-7/working-with-content">created basic pages and articles</a>. In one of our basic pages, we set the URL alias to about-this-site. Again, you can see in the table below how the clean URLs option impacts this page:</p>
<table class="article_table">
<tbody>
<tr>
<th>Clean URLs Disabled</th> <th>Clean URLs Enabled</th>
...
<tr>
<td>http://domain.com<span style="color: #ff0000;">/?q=about-this-site</span></td>
<td>http://domain.com<span style="color: #ff0000;">/about-this-site</span></td>
</tr>
</tbody>
</table>
</li>
...
<p>If you need further assistance please feel free to <a href="/support/community-support">ask a question on our support center</a>.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/drupal-7/sef-urls'>202: Search Engine Friendly URLs in Drupal 7</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 2: How to enable Search Engine Friendly URLs in Drupal 7</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 1: <a href='/support/edu/drupal-7/sef-urls/sef-intro'>Understanding SEF URLs in Drupal 7</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 3: <a href='/support/edu/drupal-7/sef-urls/setting-up-url-aliases-in-drupal'>Setting up URL Aliases in Drupal 7</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/drupal-7/sef-urls/how-to-enable-search-engine-friendly-urls-in-drupal-7&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/drupal-7/sef-urls/how-to-enable-search-engine-friendly-urls-in-drupal-7'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP3RzcmM9cnNicmFxJm9wdGlvbj1jb21fY29udGVudCZjYXRpZD0yMDgmaWQ9MTE4MSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="394e54a92143780883c36ec284064f03" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/drupal-7/sef-urls?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Search Engine Friendly URLs in Drupal 7</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/drupal-7/sef-urls/sef-intro?tsrc=rsbedu'>Understanding SEF URLs in Drupal 7</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/drupal-7/sef-urls/how-to-enable-search-engine-friendly-urls-in-drupal-7?tsrc=rsbedu'>How to enable Search Engine Friendly URLs in Drupal 7</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/drupal-7/sef-urls/setting-up-url-aliases-in-drupal?tsrc=rsbedu'>Setting up URL Aliases in Drupal 7</a></td>
                </tr>
          	</table>
			...
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/drupal-7/enable-clean-urls-with-a-temporary-domain-url?tsrc=rsbraq'>Should I enable clean URLs using the temporary URL?</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/billing/drupal-clean-urls-temp-url-with-or-without-hosts-file-modified?tsrc=rsbraq'>Drupal Clean Urls, Temp Url,  With Or Without Hosts File Modified</a>
                                </div>
