<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:59729:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/email-client-setup/sent-mail-does-not-show-up-in-sent-folder" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Mike, First, be sure you are subscribed to the Sent folder. This may make a difference. I am unsure if it is possible to view the Sent folder of o..." />
  <title>Sent mail does not show up in sent folder | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/email-client-setup/sent-mail-does-not-show-up-in-sent-folder" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:0be326e2f30876b6b2846dda3452a52d -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-22']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '105.184.188.80']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Sent mail does not show up in sent folder</h1>
		<div style='margin-bottom:20px; margin-top:10px; clear:both; color:#6e6e6e;'>Category: <a href='/support/community-support/email-client-setup'>Email Client Setup</a></div>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='http://graph.facebook.com/mike.kister.16/picture?type=normal' class='user_avatar' /><br />
			<a href='/support/community-support/users/INIart'>INIart</a>
			<div>14 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2014-07-07 9:46 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>22,632</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Hello, I use Windows Live Mail on Win 8. My problem is that when I send an email it does not show up in my &quot;Sent Items&quot; folder. How can I configure this to work? This is a second account in the app. The first account is no longer valid but I need to keep the older emails.<br />
<br />
Thank you,<br />
Mike</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_5221' id='upvote_answer_5221' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='5221' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_5221').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_5221' id='downvote_answer_5221' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='5221' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_5221').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Mike,<br />
<br />
First, do you have your email account setup as a &lt;a href=&quot;http://www.inmotionhosting.com/support/email/change-pop3-account-to-imap-or-imap-to-pop3#pop3-vs-imap&quot; target=&quot;_blank&quot;&gt;POP3 or IMAP mail&lt;/a&gt; account?<br />
<br />
The reason I ask, is because if you have it setup as &lt;strong&gt;POP3&lt;/strong&gt; your sent messages would just be stored locally in your email client. While if you have it setup as &lt;strong&gt;IMAP&lt;/strong&gt; it could be stored just on the server depending on your email client settings.<br />
&lt;h2&gt;Subscribe to an IMAP folder in Windows Live mail&lt;/h2&gt;<br />
These instructions and modified from the &lt;a href=&quot;http://windows.microsoft.com/en-us/windows-vista/get-e-mail-from-specific-imap-folders&quot; target=&quot;_blank&quot;&gt;subscribe to specific IMAP folders&lt;/a&gt; guide from Microsoft.<br />
&lt;ol class=&quot;article_list&quot;&gt;<br />
&lt;li&gt;Open &lt;strong&gt;Windows Mail&lt;/strong&gt;&lt;/li&gt;<br />
&lt;li&gt;From the &lt;strong&gt;Folders&lt;/strong&gt; list, select an IMAP server&lt;/li&gt;<br />
&lt;li&gt;Click &lt;strong&gt;IMAP Folders&lt;/strong&gt;&lt;/li&gt;<br />
&lt;li&gt;From the &lt;strong&gt;Show/Hide IMAP Folders&lt;/strong&gt; box, select your &lt;strong&gt;Sent&lt;/strong&gt; or &lt;strong&gt;Sent Items&lt;/strong&gt; folder&lt;/li&gt;<br />
&lt;li&gt;To view the folder, click &lt;strong&gt;Show&lt;/strong&gt;&lt;/li&gt;<br />
&lt;/ol&gt;<br />
Hope that helps, please let us know if you need anything else.<br />
<br />
- Jacob
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_5221').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_5221' id='form_comment_on_answer_5221' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hi, My old account is a POP3 set-up, my new account is IMAP. I have a list of folders down the left side with a quick views folder and my two accounts (the POP3 is now inactive) along with their sub-folders. There is no option for selecting IMAP folders. In poking around the program I cannot find anything for selecting IMAP folders.  In the properties window for my IMAP account there is an IMAP tab and it has: Folders &gt;Root Folder Path with a blank field, a checked checkbox for &quot;Check for new messages in all folders. Next is Special Folders&gt;a checked checkbox for Store Special folders on IMAP server and a set of four parameters with filled in fields for Sent items path: &quot;Sent Items&quot;, Drafts path: &quot;drafts&quot;, Deleted items path: &quot;Deleted Items&quot; &amp; Junk Path: &quot;Junk E-mail&quot;.<br />
<br />
I can see my Sent Items folder in the new account but none of my sent emails show up there.<br />
<br />
Thanks</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='http://graph.facebook.com/mike.kister.16/picture?type=normal' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/INIart'>INIart</a><br />
									14 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2014-07-08 2:44 pm EST
								</div>
				...
				<div style='padding:15px 15px 15px 76px; border:1px solid #ddd; border-top:0px; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello INIart,<br />
<br />
It looks like you might not have read the steps above for connecting to an IMAP account, I just cleaned them up from the Microsoft guide on the same steps above.<br />
<br />
Your IMAP folders are going to be under your IMAP account, an example of one is the &lt;strong&gt;Inbox&lt;/strong&gt; folder itself. Just right-click on it then click &lt;strong&gt;IMAP Folders&lt;/strong&gt;.<br />
<br />
If you aren't seeing that, as you mentioned go to the properties window for your IMAP account and go to the &lt;strong&gt;IMAP&lt;/strong&gt; tab. For the &lt;strong&gt;Folders &amp;gt; Root Folder Path&lt;/strong&gt; section type in &lt;strong&gt;INBOX&lt;/strong&gt; in all caps.<br />
<br />
It sounds like your mail client is storing the special folder &lt;strong&gt;Sent Items&lt;/strong&gt;, so you want to make sure you're subscribing to that IMAP folder from your mail client.<br />
<br />
- Jacob</div>
				...
				<div style='padding:15px 15px 15px 76px; border:1px solid #ddd; border-top:0px; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello, Entering INBOX in the Root Folder Path worked.<br />
<br />
Thank you!</div>
...
<div class=' straight_bottom not_best_answer'>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px; width:50px;' valign='top'>
<div class='vote_div'>
	<form method='post' name='upvote_answer_5219' id='upvote_answer_5219' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='5219' />
		<input type='hidden' name='component' id='component' value='qa' />
		<input type='hidden' name='vote_value' id='vote_value' value='1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_5219').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_5219' id='downvote_answer_5219' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='5219' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_5219').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Mike,<br />
<br />
First, be sure you are subscribed to the Sent folder. This may make a difference. I am unsure if it is possible to view the Sent folder of one account while logged into another, but also be sure you are in the correct account when you attempt to view the Sent mail.  <br />
<br />
Kindest Regards,<br />
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_5219').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_5219' id='form_comment_on_answer_5219' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
					                <p>You must <a href='/support/login'>login</a> before you can post a comment about this answer.</p>
					        </div></div></div></div>
					</form>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hi Scott, thanks for the reply. Forgive my ignorance but how do I subscribe to a folder? I tried to search the support threads but nothing turned up for Live Mail.<br />
<br />
Thanks,<br />
Mike<br />
<br />
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/email-client-setup/sent-mail-does-not-show-up-in-sent-folder&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/email-client-setup/sent-mail-does-not-show-up-in-sent-folder'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="0bcb835b87144f88d0abdd2295d0453c" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
                                ...
                                <h3>Related Articles</h3><a target='_blank' href='http://inmotionhosting.com/support/how-to-fix-the-apple-folder-assignments'>How to Fix the Apple Folder Assignments</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/installing-opera-mail-client'>Setting up the Opera Mail Client</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/configure-iphone6-email'>Configuring your iPhone 6 for Email</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/common-3rd-party-smtp-settings'>Common 3rd party SMTP settings</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/mac-mail-mavericks-os'>Updated: How to Set Up Mac Mail</a><br/><br />
		</div>
