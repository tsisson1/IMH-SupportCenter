<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:44773:" 
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:57edb9bb9d92b4e7f3633e4fe1a45eb0 -->
...
<div class='container'>
	...
	<div class='item-page'>
		<div class='page-header'><h1>Search results for: <span style='color:#aaa;'>dns</span></h1></div>
		<form method='get' action='/support/search' >
                        <input type='text' name='searchword' id='mod-search-searchword' style='width:500px;' value='dns' />
                        <button class='button btn btn-info' onclick='this.form.searchword.focus();' style='display:inline-block; width:80px; border-radius:3px; height:32px; line-height:22px; margin:0px;'>Search</button>
                	        ...
                	        <p><a href='http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes'><b>DNS</b> and Nameserver Changes </a><br />To get your domain working on your server with InMotion Hosting, you will need <br>
to point your domain to our server. You can point your domain Using a <b>DNS</b>&nbsp;...</p>
	                
                	        <p><a href='http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/how-do-i-make-custom-dns-records'>How do I make custom <b>DNS</b> records? - InMotion Hosting</a><br />May 2, 2016 <b>...</b> <b>DNS</b> is the component of the Internet which converts human-readable domain <br>
names (example.com) into computer-readable IP addresses&nbsp;...</p>
	                
                	        <p><a href='http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/how-do-i-clear-my-local-dns-cache'>How do I clear my local <b>DNS</b> cache? - InMotion Hosting</a><br />Aug 6, 2015 <b>...</b> In order the speed up this process and reduce the traffic on the <b>DNS</b> servers, <br>
most computer operating systems will store or cache <b>DNS</b> lookups&nbsp;...</p>
	                
                	        <p><a href='http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/godaddy'>Making <b>DNS</b> Nameserver Changes at GoDaddy.com - InMotion <b>...</b></a><br />Mar 26, 2015 <b>...</b> To get a Godaddy domain working on your InMotion Hosting server, the <br>
nameservers will need to be updated to point the domain to our <b>DNS</b>&nbsp;...</p>
	                
                	        <p><a href='http://www.inmotionhosting.com/support/edu/cpanel/cpanel-manage-domains/advanced-dns-editor-cpanel'>How to use the Advanced <b>DNS</b> Editor in cPanel. - InMotion Hosting</a><br />Oct 26, 2015 <b>...</b> The server looks for the <b>DNS</b> record associated with webmail.yourdomainname.<br>
com and knows to send you to the Webmail login area.</p>
	                
                	        <p><a href='http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/updating-your-domains-nameservers'>Updating Your Domain&#39;s <b>DNS</b> / Nameservers - InMotion Hosting</a><br />Dec 20, 2014 <b>...</b> When you ADD an add-on domain in the cPanel, the cPanel is automatically <br>
notifying the server that <b>DNS</b> entries need to be added, and these&nbsp;...</p>
	                
                	        <p><a href='http://www.inmotionhosting.com/support/email/general-information/third-party-mx'>Changing MX records to point to InMotion servers from third party <b>DNS</b></a><br />May 2, 2016 <b>...</b> This is most certainly possible but does take working with both your InMotion <br>
account and your third party <b>DNS</b> service. Follow the instructions&nbsp;...</p>
	                
                	        <p><a href='http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/domain-names-dns-changes'>Domain Names - How long do <b>DNS</b> changes take? - InMotion Hosting</a><br />Jan 14, 2015 <b>...</b> When you make a <b>DNS</b> change, it takes time for the changes to take effect. This is <br>
called <b>DNS</b> propagation. It is the time it takes for the domain&nbsp;...</p>
	                
                	        <p><a href='http://www.inmotionhosting.com/support/edu/whm/306-configuring-advanced-dns'>306: How to enable or disable Advanced <b>DNS</b> editor in WHM <b>...</b></a><br />Nov 4, 2015 <b>...</b> The Basic <b>DNS</b> Zone editor allows the user to choose between two record types, <br>
the A record and the CNAME record. Users of the basic editor&nbsp;...</p>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP3NlYXJjaHdvcmQ9ZG5zJm9wdGlvbj1jb21fY29udGVudCZjYXRpZD0zNTYmaWQ9MzU2JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
