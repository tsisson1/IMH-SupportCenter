...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/file-management/compress-file" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-02-17T15:15:46-08:00" />
  <meta name="keywords" content="compress file 7-Zip" />
  <meta name="author" content="John-Paul Briones" />
  <meta name="description" content="Learn how to compress or zip a file using 7-Zip." />
  <title>Compress Files Using 7-Zip - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/file-management/compress-file" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:5610aec15dab89f53e9789d033df528d -->
		...
		<div class="page-header">
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='clear:both;'></div>
								...
								<iframe width="640" height="480" src="//www.youtube.com/embed/UwwmZwk4nlg" frameborder="0" allowfullscreen></iframe>
<div>In this guide we will show you how to <strong>compress</strong> a <strong>file</strong> or folder into a <em>.zip</em> file using <strong>7-zip</strong>. This is recommended before transferring a file over the internet, so that it is not corrupted in-transit.<br /><br /></div>

<p class="alert">You must have 7-zip installed before attempting to follow this guide. 7-Zip is a free open-source software; <a href="http://www.7-zip.org/download.html" target="_blank">download 7-zip here</a>.</p>

<h2>How to Compress a File</h2>
<ol class="article_list">
<li>Open the 7-Zip File Manager.</li>
  <li>Navigate to the <em>file</em> you want to <strong>compress</strong>, and click it, then click the <strong>Add</strong> button.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/7-zip/adding-file-7-zip.png"><img src="//cdn.inmotionhosting.com/support/images/stories/7-zip/adding-file-7-zip.png" alt="adding a file to be compressed in 7-zip"  style="margin: 15px;" /></a></li>
<li>The <em>Add to Archive</em> window will pop up, make sure the <em>Archive format</em> is set to <strong>zip</strong>, and click the <strong>OK</strong> button to proceed.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/7-zip/add-to-archive.png"><img src="//cdn.inmotionhosting.com/support/images/stories/7-zip/add-to-archive.png" alt="compressing a folder into a zip file in 7-zip"  style="margin: 15px;" /></a><br />The file will be compressed into a <em>zip</em> file, that will be located in the same location as the original file.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/7-zip/zipped-and-original-file.png"><img src="//cdn.inmotionhosting.com/support/images/stories/7-zip/zipped-and-original-file.png" alt="view of the compressed and uncompressed file on desktop"  style="margin: 15px;" /></a><br /><br /></li>
</ol>
<br>
<div>Congratulations, now you know how to <strong>compress</strong> a file into a <strong>.zip</strong> format using <strong>7-Zip</strong>!</div> 
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/email/backup-individual-email-account?tsrc=rsbraq'>Backup individual email account</a>
                                </div>
			
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/email-troubleshooting/images-are-not-received?tsrc=rsbraq'>Images Are not Received via Email</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/8b568dcb6165f11b49e3f5856c92d0ac?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/8b568dcb6165f11b49e3f5856c92d0ac'>Anthony K.</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-24 10:35 am</div>
				                <div>After the simple explanation, if you added more detail of what each feature does and how it affects the speed of your Zip operation, then it would greatly help beginners.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13251);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-01 9:36 am</div>
				                <div>Hello Anthony,<br />
<br />
Thank you for your helpful suggestion. I will hopefully write more detailed guides on using <strong>7-Zip</strong>.<br />
<br />
If you have any further questions, feel free to post them below.<br />
Thank you,<br />
<br />
-John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13536);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-13476'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/0e69d3467b2d4ed9d1b56605d6d47874?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/0e69d3467b2d4ed9d1b56605d6d47874'>Sarah</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-30 11:50 am</div>
				                <div>Very helpful - first time I've used 7zip and this was just what I needed.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13476);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-14065'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/b8965a0b690c02dca3e583d93013a486?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/b8965a0b690c02dca3e583d93013a486'>ConfusedUK</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-17 3:24 pm</div>
				                <div><p>I follow the steps in the above helf file, and this creates &nbsp;a .zip file as you say.HOWEVER, I want a&nbsp;<em>compressed</em> file, not just a zipped file - the .zip file i create using the above method is exactly the same size as the original, which for me defeats the purpose</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14065);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-18 12:40 pm</div>
				                <div>Hello ConfusedUK,<br />
<br />
Thank you for contacting us regarding <strong>File Compression</strong>, I understand your frustration. <br />
<br />
The amount of compression can be increased, but also depends on the files you are zipping.<br />
<br />
<h2>Increase the Compression Level in 7-Zip:</h2><ol class="article_list"><li>In <strong>Step 3</strong> of the above guide, click the box next to <em>Compression level</em>, and choose <strong>Ultra</strong>.</li></ol><h3>Reasons a Compressed file is the same size:</h3><p>Some file formats cannot be further compressed. For example jpeg file are already compressed and will not zip much smaller. In this case you can optimize the images by size, meta tags, etc. Which reduces the file sizes.</p><br />
If you have any further questions, feel free to post them below.<br />
Thank you,<br />
<br />
-John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14100);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/2eb787ffd78e69cc55982949b995779a?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/2eb787ffd78e69cc55982949b995779a'>sanjivsir</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-12 1:46 am</div>
				                <div>Hello dear friend how are u hope well there,
...
Thanks</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16119);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-13 8:03 am</div>
				                <div>Hello,<br />
<br />
The amount of compression will vary depending on the file and its type. For example, text files (htmp. php,etc) can usually compress somewhat. Some files such as image and pdf files do not compress much at all. As for the types of compression available in 7-zip, I tested a txt file with each type. The top 4 compression formats, starting from the smallest, are .xz, .7z, .gz, and .zip. The difference between each was very small, so all formats will be fine.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16146);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-16923'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/cd456c956c0efbaf753f7f5ad1296713?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/cd456c956c0efbaf753f7f5ad1296713'>Vic W</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-30 7:15 pm</div>
				                <div>This article is complete and it's clearer than the crow of a rooster.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16923);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-17502'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/65becf9c2141a1a2fb1147c2789a709f?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/65becf9c2141a1a2fb1147c2789a709f'>Bangso</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-17 1:44 pm</div>
				                <div><p>Hey Dear</p>
<p>I have downloaded the 7 zip folder but it seems i cant get to the add botton. I am using windows 7 with 64 bit operating system but it just cant work! When you open the folder, only you see as icons are the following: organize, include in library, share with etc.</p>
<p>I will appreciate if you can guide me through the process!!!! I can actually see the folder /files i want to zip in the 7 zip but i cant go further in adding or do anythin else. Pls help. Its urgent</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17502);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-17 3:32 pm</div>
				                <div>Hello Bangso,<br />
<br />
Thank you for your question. When you first open 7zip, you should see the button on the top left. If it is not there, you may have a different version, or it may not have installed successfully.<br />
<br />
It may be easier for you to <a href="http://www.inmotionhosting.com/support/website/file-management/zip-unzip-win7">Zip the file</a> using the built-in tool in Windows 7.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17508);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-20123'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/e4fc0a86de93ab07beb3625356f976b5?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/e4fc0a86de93ab07beb3625356f976b5'>Sharjeel Abbas</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-29 7:37 pm</div>
				                <div><p>Hi bro ... i m admin of a site for software and games and any others applications etc and i need to uploads very large files in my site but you know large files take many tim for uploding .. so please tell me how to compres softwares or games large files into smal size and plz also tell me how we can divided these files into some parts i see many sites they upload some parts of one software and when we download all parts save these parts same drictry (folder) user extrect only one part and install whole software... please tell me how to use these tow methods plz plz plz reply me soon thanks :)</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20123);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-02 10:41 am</div>
				                <div>Hello Sharjeel,<br />
<br />
This article does not cover splitting up large files. We do not yet have a guide for that, but I did find a tutorial for you that goes over how to do this. Check out <a href="http://www.linglom.com/it-support/how-to-split-a-large-file-using-7-zip/">How to split large files with 7zip</a> and see if that helps you.   We have not tested the guide, nor do we endorse the site, it was just something I found when searching the web.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20243);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-29555'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/f3e4cf9a0e2dd58c060f6530b3645edf?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/f3e4cf9a0e2dd58c060f6530b3645edf'>Reza Bouzhmehrani</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-05 2:43 am</div>
				                <div><p>hello</p>
<p>I want a phone number of 7zip company . do you help me?</p>
<p>thanks</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29555);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-01-05 12:37 pm</div>
				                <div>Hello Reza,<br />
<br />
7-Zip is an open-source software project. They don't have a support staff in the same sense that InMotion Hosting does. However, if you have a specific question we'll be happy to look into it for you.<br />
<br />
However, if you would be interested in visiting a 7-Zip forum to find more information or ask questions, you can start with the following link:<br />
<br />
http://www.7-zip.org/</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29572);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
