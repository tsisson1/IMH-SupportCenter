<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50539:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/website/server-is-being-down-lately" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello acrwebline, Thank you for contacting us about a server being down due to resource issues. We are happy to help, but this is just the public forum...." />
  <title>Server is being down lately | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/website/server-is-being-down-lately" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:6d373e153d583cce0348b36160ab2f69 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Server is being down lately</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/acrwebline'>acrwebline</a>
			<div>8 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-05-22 9:12 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>54</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>My server has been down lately and I was directed to get your team to check the server resources. They could't SSH and had to restart the services. The domain is acr-sbc.com</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_7306' id='upvote_answer_7306' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='7306' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_7306').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_7306' id='downvote_answer_7306' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='7306' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_7306').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello acrwebline,<br />
<br />
Thank you for contacting us about a server being down due to resource issues. We are happy to help, but this is just the public forum. Please <a href="http://www.inmotionhosting.com/support/website/getting-started-guides/submitting-and-checking-on-status-of-tickets#submit-ticket">submit a ticket</a> to Live Support, and request a review. This will allow them to provide account specific information in a secure non-public setting.<br />
<br />
...
John-Paul B
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_7306').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_7306' id='form_comment_on_answer_7306' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>I apologize, I realize this afterwards. I posted a ticker this morning also. Thank you for your prompt response.</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='/support/images/avatars/default_avatar.jpg' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/acrwebline'>acrwebline</a><br />
									8 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2015-05-22 12:44 pm EST
								</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/website/server-is-being-down-lately&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/website/server-is-being-down-lately'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="3a959d135c854e5823d7eda3eef1a851" value="1" />	</div>
	</form>
<!-- <br />
