<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50139:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/wordpress/wordpress-maintenance-mode-setup" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Thank you for your Question FredThor. We have an article on this. I just revamped it to have step by step instructions that are a bit clearer. Please se..." />
  <title>WordPress Maintenance Mode setup | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/wordpress/wordpress-maintenance-mode-setup" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:98b4a8b871c4d14d45ac70463233a34d -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>WordPress Maintenance Mode setup</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/FredThor'>FredThor</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-01-07 4:38 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>258</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>How can I have a &quot;work in progress&quot; homepage while I'm building the website on WordPress so people won't see it until it's fully done?</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_2081' id='upvote_answer_2081' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='2081' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_2081').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_2081' id='downvote_answer_2081' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='2081' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_2081').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>5,889 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2013-01-07 5:42 pm EST
                		        </div>
					
		                </div>

				Thank you for your Question FredThor.<br />
<br />
We have an article on this. I just revamped it to have step by step instructions that are a bit clearer. Please see the following link.<br />
<br />
&lt;a href=&quot;http://www.inmotionhosting.com/support/edu/wordpress/310-enabling-wordpress-maintenance-mode&quot;&gt;Enabling WordPress Maintenance Mode&lt;/a&gt;<br />
<br />
The maintenance mode will allow you to edit the site while the under construction page is up. Hope this helps.<br />
<br />
Regards,<br />
James R
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_2081').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_2081' id='form_comment_on_answer_2081' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="01bfadf06c0fecb78359ed9aba01bdca" value="1" />	</div>
	</form>
<!-- <br />
