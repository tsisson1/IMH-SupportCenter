<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:59021:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/billing/i-cant-log-in-to-amp" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hi ljmpful, To confirm, you're trying to log into AMP using this url, correct? https://secure1.inmotionhosting.com/index/login..." />
  <title>I can't log in to AMP | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/billing/i-cant-log-in-to-amp" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:eb3aaf7e84c73c161e6ac1069db9e712 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box straight_bottom'>
                <h1 style='font-size:26px;'>I can't log in to AMP</h1>
		<div style='margin-bottom:20px; margin-top:10px; clear:both; color:#6e6e6e;'>Category: <a href='/support/community-support/billing'>Billing</a></div>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='http://graph.facebook.com/lindsay.philp/picture?type=normal' class='user_avatar' /><br />
			<a href='/support/community-support/users/ljmpful'>ljmpful</a>
			<div>8 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2013-05-16 4:04 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>2,341</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Despite changing my password, the log in page still says that my password is invalid!  I want to change my payment card but can't log in to do so!</div>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px;'>
				<div style='font-size:12px; max-width:500px; overflow:auto;'>I am having the same problem. I spent an hour with Live Support today trying to fix this. I know I have a valid account because I paid my bill on the account by phone since I was already getting support. But I still cannot log in. I have changed the password about six times so far. I carefully type everything in, I have made very simple Passwords that I can't screw up, I do the tic tac toe thing, and I get either no response or &quot;wrong email and/or password&quot;. The support person was able to log in so I can't figure out why I can't. I have tried 2 different computers (Mac and PC) and 3 browsers. I have been an IM customer since 2009 and have never had this kind of trouble.</div>
				
				
			</td>
			<td style='width:100px;' valign='top'>
				<img src='https://lh3.googleusercontent.com/-PVMvplWBbBE/AAAAAAAAAAI/AAAAAAAAABs/MnYG-XifXjg/photo.jpg?sz=90' style='width:40px;' class='user_avatar' />
				<div class='smallgrey'>
					<a href='/support/community-support/users/TimCRNA'>TimCRNA</a><br />
					14 <a href='/support/team/points' target='_blank'>Points</a><br />
					2015-08-17 06:41 pm EST
				</div>
			</td>
		</tr>
	</table>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_3123' id='upvote_answer_3123' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='3123' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_3123').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_3123' id='downvote_answer_3123' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='3123' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_3123').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello ljmpful,<br />
<br />
When <a href="http://www.inmotionhosting.com/support/website/how-to/how-to-log-into-amp" target="_blank">logging into your AMP (Account Management Panel)</a>, be sure you are using the primary email address for your account along with the correct password.  Although if you are receiving a password change mail to a specific address, that would be the correct one. <br />
<br />
If you are still unable to log in, you will want to contact the Live Support department</a> at <strong>support@inmotionhosting.com</strong> with that request so they can evaluate the situation with you live and correct the issue.<br />
<br />
Best Regards,<br />
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_3123').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_3123' id='form_comment_on_answer_3123' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
...
<div class=' straight_bottom not_best_answer'>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px; width:50px;' valign='top'>
<div class='vote_div'>
	<form method='post' name='upvote_answer_3125' id='upvote_answer_3125' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='3125' />
		<input type='hidden' name='component' id='component' value='qa' />
		<input type='hidden' name='vote_value' id='vote_value' value='1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_3125').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_3125' id='downvote_answer_3125' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='3125' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_3125').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					<img src='https://lh6.googleusercontent.com/-fe0eHQ-V1M4/AAAAAAAAAAI/AAAAAAAAAC4/piKrSF1i5G8/photo.jpg?sz=90' class='user_avatar' style='max-width:60px;' /><br />
                		        <a href='/support/community-support/users/BradM'>BradM</a>
					
					<div>5,399 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2013-05-16 1:18 pm EST
                		        </div>
				...
				Hi ljmpful,<br />
<br />
To confirm, you're trying to log into AMP using this url, correct?<br />
<br />
&lt;a href='https://secure1.inmotionhosting.com/index/login'&gt;https://secure1.inmotionhosting.com/index/login&lt;/a&gt;
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_3125').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_3125' id='form_comment_on_answer_3125' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
					                <p>You must <a href='/support/login'>login</a> before you can post a comment about this answer.</p>
					        </div></div></div></div>
					</form>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Yes, I used this url...it was the same link that I received in the email.  When I log on, I'm told that there are multiple domains associated with the account, pick the primary one.  When I do that, I'm told that I have an invalid user name/password!</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='http://graph.facebook.com/lindsay.philp/picture?type=normal' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/ljmpful'>ljmpful</a><br />
									8 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2013-05-17 2:38 am EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>To confirm, do you have more than one account with us? Please try testing using the primary domain on your account. If you look at the tutorial on &lt;a href='http://www.inmotionhosting.com/support/website/how-to/viewing-account-technicial-information-in-amp'&gt;this page&lt;/a&gt;, you'll see the main domain listed as &lt;strong&gt;domain&lt;/strong&gt; in the screenshot.<br />
<br />
If that doesn't help, you may need to live chat with us so we can do some further testing with your account specifically.</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='https://lh6.googleusercontent.com/-fe0eHQ-V1M4/AAAAAAAAAAI/AAAAAAAAAC4/piKrSF1i5G8/photo.jpg?sz=90' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/BradM'>BradM</a><br />
									5,399 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2013-05-17 9:09 am EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>I'm having this same issue, and the support person on Live Chat said they were able to log in with my credentials no problem.  But I still can't login - in any browser.  So what now?  Live Chat again?  </div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='https://lh5.googleusercontent.com/-_uLjVjAa8aI/AAAAAAAAAAI/AAAAAAAAFd8/JIMtHGl8rZk/photo.jpg?sz=90' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/kdemerly2'>kdemerly2</a><br />
									24 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2015-01-18 3:12 pm EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello Kdemerly2,<br />
<br />
Sorry for the continued problem.  You should contact support again via phone/chat /mail to fix the issue because they can fix it for you over the phone WHILE you are connected.  Also, this is done privately, whereas, the replies that we provide here in the Support Center are public domain.  Make sure to stay on the chat or call with the tech support person until you can successfully login.<br />
<br />
Regards,<br />
Arnel C.</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/billing/i-cant-log-in-to-amp&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/billing/i-cant-log-in-to-amp'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="2ec84ce188e63d2db735a8ae1b7667af" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
                                ...
                                <h3>Related Articles</h3><a target='_blank' href='http://inmotionhosting.com/support/print-amp-invoice'>Printing an invoice in AMP</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/viewing-renewal-dates-in-the-account-management-panel'>Viewing Renewal Dates in the Account Management Panel</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/countries'>Countries We Cannot Do Business With</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/renew-current-plan-amp'>Renew / Pay for your Current Plan in AMP</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/add-change-credit-card-amp'>How to Add or Change a Credit Card in AMP</a><br/><br />
		</div>
