<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:73422:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/hacks/clean-up-code-injection-attack" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-08-15T19:03:24-07:00" />
  <meta name="keywords" content="clean remove code script injection injections" />
  ...
  <title>Clean up a code injection attack - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/hacks/clean-up-code-injection-attack" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:9169418d80499b10e316cdbd92964357 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-22']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '194.219.76.73']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Clean up a code injection attack									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>21,272</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Nov 9, 2012'><span style='color:#606060;'>Published:</span> Aug 15, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In this article we'll discuss how to clean up a code or script injection that might have occurred on your website that is causing it to try to load malicious content to your visitors, or preventing your site from displaying properly.</p>
...
<li>Navigate to the user's <strong>/public_html</strong> directory with the hacked website with the following command:<br /><br /><span class="code_block">cd ~userna5/public_html/</span><br /><br /></li>
<li>Now open up that sites index page, in this case <strong>index.php</strong> using the <strong>vim</strong> text editor with the following command:<br /><br /><span class="code_block">vim index.php</span><br /><br /></li>
<li>
<p style="width: 48%; float: left;">It should be very obvious at the top of this file that there has been a script injection, usually one of the tell tale signs of a script injection is having a <strong>base64_decode</strong> function mentioned, especially if it's at the top of a bunch of scripts.<br /><br />You'll want to copy the text starting at <strong>eval(base64_decode</strong> and grabbing about the first 10 or so characters, in most SSH clients simply highlighting text will copy it to the clipboard.</p>
<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/script-injections/vim-viewing-base-64-decode-string.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/script-injections/vim-viewing-base-64-decode-string.png" alt="vim-viewing-base-64-decode-string"  style="width: 48%; float: right; position: relative; top: 25px;" /></a><br style="clear: both;" /></li>
<li>Now you'll want to type in the following command using the text that you copied from the <strong>/public_html</strong> directory:<br /><br /> <span class="code_block">grep 'eval(base64_decode("DQplcnJvcl' ./ -Rl &gt; HACKS</span><br /><br /> This will take some time to complete as it's going to look through all of your files for that string, it will be placing them in a file called <strong>HACKS</strong>.<br /><br /></li>
<li>Now using that <strong>HACKS</strong> file in a loop, we want to create a backup copy of each injected script with the suffix <strong>-HACKED</strong> using the following command in case when we are stripping out the injection it happens to grab any good code accidentally:<br /><br /> <span class="code_block">for hackFile in `cat HACKS`; do cp -frp $hackFile $hackFile"-HACKED"; done</span><br /><br /></li>
<li>Now we can use the same loop, but this time using the <strong>sed</strong> command to replace the code injection of each original file:<br /><br />
<p class="code_block">for hackFile in `cat HACKS`; do sed -i 's#&lt;?php.*eval(base64_decode("DQplcnJvcl.*));#&lt;?php#' $hackFile; done</p>
<br /><br /> What this <strong>sed</strong> command is doing is using the <strong>-i</strong> flag for an in place replacement, the <strong>'s#</strong> part is telling it we're doing a string replace, with the <strong>#</strong> symbol being the delimiter of our strings.<br /><br /> The next part is the sting we want to replace, it begins with <strong>&lt;?php</strong> then we are using <strong>.*</strong> to state any character at all, followed by <strong>eval(base64_decode("DQplcnJvcl</strong> which is the part of the injection we had copied earlier, then finally it ends with another <strong>.*</strong> to grab all of the rest of the text till finally the last part of the string&nbsp;<strong>));</strong> is encountered.<br /><br /> After the second <strong>#</strong> we put the string we want the first string to be replaced with, in this case just <strong>&lt;?php</strong>, then we finish up the&nbsp;<strong>sed</strong> command with another&nbsp;<strong>#'</strong> then we put&nbsp;<strong>$hackFile</strong> after the&nbsp;<strong><br /></strong>full&nbsp;<strong>sed</strong> command since that will be the file name of the current file in our loop.</li>
</ol>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/hacks/clean-up-code-injection-attack&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/hacks/clean-up-code-injection-attack'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MDYmaWQ9NDcxJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="a86acad2915583996656db4470974949" value="1" />	</div>
	</form>
<!-- <br />
...
<a name='comments'></a>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/1a8ccaf60bf0e5434c0b1082eb3672b4?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/1a8ccaf60bf0e5434c0b1082eb3672b4'>davea0511</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-13 5:30 pm</div>
				                <div><p>Super helpful at identifying backdoor insertion after Drupal was compromised about 6 months ago. &nbsp;Created some scripts based on this that I have running periodically ona cron job. &nbsp;Have caught problems that way since. Thanks!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22613);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-26439'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/3708fe6ab77431f6805a37604b247d70?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/3708fe6ab77431f6805a37604b247d70'>Crashby</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-08 12:08 pm</div>
				                <div><p>This worked great for me, apart from one thing. If the infected filename has a space in it the sed command falls over. I've tried quotes, escape chars, and it just won't process them. Any advice?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26439);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-09 11:21 am</div>
				                <div>Hello Crashby,<br />
<br />
Thank you for contacting us. We reviewed the command, and it should not have a problem with spaces. <br />
<br />
Can you provide the specific code you are running?<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26497);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-28698'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/defa7a485f86550ce5e604d52350f4cb?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/defa7a485f86550ce5e604d52350f4cb'>Muhammad Asghar Shah</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-24 1:35 am</div>
				                <div><p>That's it ... thanks dude.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28698);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-32317'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/40b330c8a45b43a40b4ef842f61842cc?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/40b330c8a45b43a40b4ef842f61842cc'>amit</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-28 3:54 pm</div>
				                <div><p>Hi my index.php file is getting deleted every night, could you please suggest, how to identify the root cause.</p>
<p>Thanks</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32317);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-28 4:32 pm</div>
				                <div>Hello amit,<br />
<br />
Thank you for contacting us. I recommend reviewing the <a href="http://www.inmotionhosting.com/support/website/getting-started-guides/cpanel-logs-for-access-apache-email-error-ftp-mysql-whm">FTP, and Access logs</a> for record of the file, or access to your cPanel.<br />
<br />
You can also perform a shell scan for malware with the following steps:<ol><li>Connect to your account using SSH.</li><br />
Run the command:<br />
<span class="cli">shellscan</span></li></ol><br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32320);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
