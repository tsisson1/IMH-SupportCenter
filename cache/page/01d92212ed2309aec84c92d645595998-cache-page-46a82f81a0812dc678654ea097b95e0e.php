<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:57923:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.info/support/email/outlook/create-mac-signature-2011" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-02-17T18:47:09-08:00" />
  <meta name="keywords" content="outlook 2011 mac create email signature" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="This Outlook 2011 for Mac tutorial shows you how to add a signature to be appended to the end of emails." />
  <title>How to create an email signature for  Mac in Outlook 2011 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/email/outlook/create-mac-signature-2011" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:a83e3589a8d9fdd4bdbfef9a3aee7c27 -->
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to create an email signature for  Mac in Outlook 2011</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to create an email signature for  Mac in Outlook 2011									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>35,342</span></div>
							...
							<div style='clear:both;'></div>
								...
								<p>Email signatures are traditionally used to display the sender's name and contact information at the end of an email. Some people find furhter use for them and use them to give website links, insert logos, or even memorable anecdotes. It is much easier if this information is automatically added to the end of every email by default instead of having to add it manually each time you create and send an email. Below are instructions that teach you how to create and add your own custom email signature within your <em>Outlook 2011 </em>email client for Macs.</p>
<p><strong>Creating an email signature in <a href="http://www.inmotionhosting.com/support/email/outlook">Outlook 2011</a> for Mac<br /></strong></p>
<ol class="article_list">
<li>Open up your <em>Outlook 2011 </em>email client and select <strong>Outlook</strong> from the menu.</li>
<li><strong></strong>Click on <strong>Preferences</strong>.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/email/outlook/2011-mac/create-signature/select-preferences.png"><img  alt="select-preferences" src="//cdn.inmotionhosting.com/support/images/stories/edu/email/outlook/2011-mac/create-signature/select-preferences.png" /></a></li>
<li>Next, click on the <strong>Signatures</strong> icon to continue.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/email/outlook/2011-mac/create-signature/select-signatures.png"><img  alt="select-signatures" src="//cdn.inmotionhosting.com/support/images/stories/edu/email/outlook/2011-mac/create-signature/select-signatures.png" /></a></li>
<li>From the Signatures screen, select the <strong>+</strong> icon in the lower left hand corner of the screen. You will then be able to add your new signature in the right hand panel. In this sample, we have selected both signatures to be edited the same way. You can, however, have each signature formatted differently.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/email/outlook/2011-mac/create-signature/add-new-signature.png"><img  alt="add-new-signature" src="//cdn.inmotionhosting.com/support/images/stories/edu/email/outlook/2011-mac/create-signature/add-new-signature.png" /></a></li>
<li>Next, click on the <strong>Default Signatures</strong> button at the bottom right. This brings up the next screen where you will assign a signature to an email account. Use the up and down arrows on the right to select which signature you want to use for the account. If you have more than one account, they will be listed as well and you will select a signature for each. Click the <strong>OK</strong> button once you have finished to save your settings.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/email/outlook/2011-mac/create-signature/default-signature.jpg"><img  alt="default-signature" src="//cdn.inmotionhosting.com/support/images/stories/edu/email/outlook/2011-mac/create-signature/default-signature.jpg" /></a></li>
</ol> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.info/support/email/outlook/create-mac-signature-2011&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.info/support/email/outlook/create-mac-signature-2011'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD01NSZpZD03OTQmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="7a81f45858c5feb97d3698f0c24ed937" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/222d6b096b06264caeddf5037ef75f65?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/222d6b096b06264caeddf5037ef75f65'>Satisfied customer</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-22 8:03 am</div>
				                <div><p>Thanks for the clear concise instructions.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25067);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
