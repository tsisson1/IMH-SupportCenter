<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:65451:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/html/inserting-flash-into-html" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-09-24T16:41:31-07:00" />
  <meta name="keywords" content="HTML Flash videos how to" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="In this tutorial, we will explain how to insert Flash into HTML" />
  <title>Inserting Flash into HTML - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/html/inserting-flash-into-html" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:edcc1ed40d98f25e475d7252b5803644 -->
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/website/html' itemprop='url'><span itemprop='title'>HTML<span></a><div class='dropdown_3columns'><div class='col_3'><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/html/inserting-flash-into-html'>Inserting Flash into HTML</a> (27595 hits)</div><div style='margin-bottom:10px;'><a style='display:inline;' href='/support/website/html/streaming-audiovideo-on-your-site'>Streaming Audio/Video on Your Site</a> (16389 hits)</div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Inserting Flash into HTML</span></li>			</ul>
		</div>
	</div>
</div>
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>27,595</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Aug 26, 2011'><span style='color:#606060;'>Published:</span> Sep 24, 2013</div>
				...
				<a class="ddtut" href="http://support.inmotionhosting.com/userguides/flash/flash_publish.swf" style='display:block; margin-bottom:15px;'>
					<img src='/support/images/icon.movie.png' /><br />
					Click here to watch a video tutorial
				</a>
				

								<p>For more information on streaming audio and video, please visit our other article:</p>
<p><a href="/support/website/how-to/streaming-audiovideo-on-your-site">Streaming Audio/Video on your Site</a></p>
<h1>How to insert your Flash movies into your website</h1>
<p>After creating a Flash movie you normally go to&nbsp;<strong>File ~&gt;Save As</strong> from the top menu to save your movie. Save the file as "<strong>yourmovie.fla</strong>".</p>
<p>To embed the Flash movie into an HTML page, you should go back to your Flash progam and:</p>
<ol>
<li>choose file ~&gt; Open the Flash movie</li>
<li>choose file ~&gt; Export Movie</li>
<li>Name the file "yourmovie.swf". Choose the location where the file is to stored (in your Web folder) and click OK.</li>
<li>Open the HTML page where you want to insert your Flash movie. Insert this code:</li>
</ol>
<div class="code_block">
<p>&lt;object width="550" height="400"&gt;</p>
<p>&lt;param name="movie" value="somefilename.swf"&gt;</p>
<p>&lt;embed src="/support/somefilename.swf" width="550" height="400"&gt;</p>
<p>&lt;/embed&gt;</p>
<p>&lt;/object&gt;</p>
</div>
<p>The width and height tags specify the frame of the movie, which you will need to adjust accordingly. This is the minimum code you need to embed a Flash movie in a browser. A broken icon will appear on the Web page if the user does not have the Flash plug-in installed.</p>
<p>More information on Flash streaming can be found on the Macromedia support site:</p>
<p><a href="http://kb.adobe.com/selfservice/viewContent.do?externalId=tn_4150" target="_blank">http://kb.adobe.com/selfservice/viewContent.do?externalId=tn_4150</a></p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/html/inserting-flash-into-html&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/html/inserting-flash-into-html'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MzgmaWQ9Nzkmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/3628348b02a9808967413812b7fd3a52?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/3628348b02a9808967413812b7fd3a52'>Gaurav Prajapati</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-19 12:18 pm</div>
				                <div><p>Hi I want to know how can I insert flash in this site - http://*********.com/how-a-fuel-cell-vehicle-works-animated-infographic/</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27647);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-19 2:56 pm</div>
				                <div>Hello Gaurav,<br />
<br />
Thank you for contacting us. The above guide should walk you through inserting flash into your site. Are you having trouble with a specific step?<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27658);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-30794'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/25489b7b7d57b9fb9c6c871ac038363b?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/25489b7b7d57b9fb9c6c871ac038363b'>Drew</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-02-25 9:01 am</div>
				                <div><p>Hello. I have flash version 18,0,0,209 installed on ym computer. When I try and upload a flash file via html editor it works (is visible once saved) in I.E. 11, but when I use chrome, or firefox the flash doesnt load. The rest of the page loads normally, i put the cursor over where the video should be and right click and all it says is, "Movie not loaded...". Any idea as to what might be going on here?</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30794);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-02-25 12:10 pm</div>
				                <div>Can you provide a link for us to test/replicate the issue?<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30800);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
