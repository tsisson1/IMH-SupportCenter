<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:59943:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/magento/202-magento-polling/creating-a-poll-in-magento" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-06-27T13:50:49-07:00" />
  <meta name="keywords" content="poll create add new polling question answer magento" />
  <meta name="author" content="Tim Sisson" />
  <meta name="description" content="Learn how to add a new poll to your Magento web store in this short tutorial." />
  <title>Creating a Poll in Magento 1.6 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/magento/202-magento-polling/creating-a-poll-in-magento" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:29cbed0c1b0cadd104dc83f1dd631666 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Creating a Poll in Magento 1.6									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>1,460</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Apr 2, 2012'><span style='color:#606060;'>Published:</span> Jun 27, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Magento 1.6 has the ability to post a question on your website so your visitors can answer it. This is a good way to see if your customers like or dislike something on your website, or even determine out of a list of options what your customers preferences are. You can add or create a new poll to your Magento 1.6 shopping cart in the Magento Admin Backend.</p>
<ol class="article_list">
<li><a href="/support/edu/magento/getting-started-tutorial/how-to-log-into-magento-admin-panel">Log into your Mageneto Admin Panel</a></li>
<li>Go to <strong>CMS -&gt;&gt; Polls</strong></li>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/magento/magento_add_poll_0.jpg"><img  alt="magento_add_poll_0" src="//cdn.inmotionhosting.com/support/images/stories/magento/magento_add_poll_0.jpg" /></a></p>
<li> Click "<strong>Add New Poll</strong>"</li>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/magento/magento_add_poll_1.jpg"><img  alt="magento_add_poll_1" src="//cdn.inmotionhosting.com/support/images/stories/magento/magento_add_poll_1.jpg" /></a></p>
<li>Fill in the "<strong>Poll Question</strong>" and change the status to "<strong>Open</strong>" </li>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/magento/magento_add_poll_2.jpg"><img  alt="magento_add_poll_2" src="//cdn.inmotionhosting.com/support/images/stories/magento/magento_add_poll_2.jpg" /></a></p>
<li>Click "<strong>Poll Answers</strong>" and then click "<strong>Add New Answer</strong>"</li>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/magento/magento_add_poll_3.jpg"><img  alt="magento_add_poll_3" src="//cdn.inmotionhosting.com/support/images/stories/magento/magento_add_poll_3.jpg" /></a></p>
<li>Fill in the "<strong>Answer Title</strong>" and "<strong>Votes Count</strong>"</li>
<li>Repeat the last two steps for every option in your answer</li>
<li>Click "<strong>Save Poll</strong>"</li>
</ol>
<p>If you need further assistance please feel free to <a href="/support/community-support">ask a question on our Support Center</a>.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/magento/202-magento-polling'>202: Magento 1.6 Polling</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 2: Creating a Poll in Magento 1.6</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 1: <a href='/support/edu/magento/202-magento-polling/deleting-a-poll-in-magento'>Deleting a poll in Magento 1.6</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/magento/202-magento-polling/creating-a-poll-in-magento&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/magento/202-magento-polling/creating-a-poll-in-magento'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xNzMmaWQ9MTI2MSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/magento/202-magento-polling?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Magento 1.6 Polling</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/magento/202-magento-polling/deleting-a-poll-in-magento?tsrc=rsbedu'>Deleting a poll in Magento 1.6</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/magento/202-magento-polling/creating-a-poll-in-magento?tsrc=rsbedu'>Creating a Poll in Magento 1.6</a></td>
                </tr>
          	</table>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/31b4c688232f94a4c972d501f45da1fe?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/31b4c688232f94a4c972d501f45da1fe'>Ramesh</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-24 11:07 pm</div>
				                <div><p>Hi,</p>
<p>Im new to this magnento programming and i would like to ask wheter i can create a poll where the question poll is set by me and the answer are based on the user. For exampelPoll Information :what is your favourite color?Poll Answer :&lt;--( In this section i wont enter any information so that the user can enter any answer they want rather than i prepare a group of color's.) Is there any way i can do ?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9170);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-25 7:56 am</div>
				                <div>Unfortunately, Magento doesn't have any built-in functionality to do so, however, a developer may be able to custom code this for you.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9183);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
