<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:42678:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhsoting.com/support/u/blocking-ip-addresses-using-htaccess-if-behind-varnish" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="InMotion Hosting Support Center" />
  <title>Blocking IP Addresses using .htaccess IF behind Varnish | InMotion Hosting</title>
  <link href="http://www.inmotionhsoting.com/support/u" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:e7b829f04f062bac57893d6bf3489fdf -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '217.69.133.225']);
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/u' itemprop='url'><span itemprop='title'>U<span></a></li>			</ul>
		</div>
	</div>
</div>
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class='item-page'>
			...
			<div class='page-header'>
				<h1 class='pup_title'>Blocking IP Addresses using .htaccess IF behind Varnish</h1>
				<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
					<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Written by:</span> <a href='https://plus.google.com/102670474114655224886?rel=author' target='_blank'>BradM</a></div>
					<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>1407</span></div>
					<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Published:</span> 2014-02-12 08:13:41</div>
					<div style='float:left;'><span style='color:#606060;'>Last Modified:</span> 2014-02-12 08:25:04</div>
				</div>
			...
			<div class='pup_content'><p>If your server is behind <a href="https://www.varnish-cache.org/">Varnish</a>, you may know that <a href="http://stackoverflow.com/questions/10024877/varnish-client-ip-not-logging-in-apache-logs">Varnish does not pass a user's IP address</a>&nbsp;in the standard fashion. Because of this, <a href="/support/website/protecting-files/using-the-ip-deny-manager">blocking IP addresses using your .htaccess file</a>&nbsp;using normal means does not work.</p>
<h2>Blocking with .htaccess</h2>
<p>If you're using Varnish, you can use the following snippet of code in your .htaccess file to block IP addresses:</p>
<pre class="code_block">order allow,deny
SetEnvIF X-Forwarded-For "88.198.184.230" DenyIP
Deny from env=DenyIP
allow from all</pre>
<h2>Blocking with APF</h2>
<p>Even though this blocks the IP address and returns a <a href="/support/website/error-numbers/403-forbidden-error">403 forbidden error</a>, apache will still log the user's request. If your server is under a <a href="/support/website/what-is/what-is-a-ddos-attack">ddos attack</a>, you can block the user's IP address but <a href="/support/website/getting-started-guides/cpanel-logs-for-access-apache-email-error-ftp-mysql-whm">your apache log file</a>&nbsp;will still be written to. This constant writing to the log file can raise your server&nbsp;<a href="/support/website/server-usage/server-load-monitoring">load average</a>&nbsp;and affect your server's stability. If you block the IP address with APF using the following command, the request will not hit apache and you can prevent your apache log files from being filled with 403 errors:</p>
<pre class="code_block">apf -d 88.198.184.230</pre></div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP0l0ZW1pZD0xMDAxNw==" />
		<input type="hidden" name="e3ed857e9414e6705527845d9027030a" value="1" />	</div>
	</form>
<!-- <br />
