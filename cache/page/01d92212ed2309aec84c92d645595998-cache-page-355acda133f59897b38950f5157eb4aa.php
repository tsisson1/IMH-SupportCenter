<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:73056:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-3/protostar/logo" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-02-20T15:46:47-08:00" />
  <meta name="keywords" content="joomla 3.0 protostar upload logo" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="In this Joomla 3.0 tutorial, we'll show you how to upload a custom logo for your template and use it in the Protostar template." />
  <title>How to upload a logo in the Joomla 3.1 Protostar template - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-3/protostar/logo" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:ffd58216c4dd5a05ca3e55ac0d459ad4 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '157.55.39.142']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to upload a logo in the Joomla 3.1 Protostar template									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>40,187</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Oct 19, 2012'><span style='color:#606060;'>Published:</span> Feb 20, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Another <a href="/support/edu/joomla-3/protostar">option in the Joomla 3.0 Protostar template</a> we will review is the logo setting:</p>
<p><strong>Logo</strong><br /><em>Upload a custom logo for the site template.</em></p>
<p>Uploading a custom logo in your <a href="http://www.inmotionhosting.com/joomla-hosting">Joomla 3.0 hosted website</a> is straight forward, and you can see in the screenshots below how the logo will show in the upper left of your pages:</p>
<table class="article_table">
<tbody>
<tr><th>Without a Logo</th><th>With a custom logo</th></tr>
<tr>
<td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/protostar/logo-no-logo.jpg"><img style="max-width: 240px;"  alt="logo-no-logo" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/protostar/logo-no-logo.jpg" /></a></td>
<td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/protostar/logo-custom-logo-uploaded.jpg"><img style="max-width: 240px;"  alt="logo-custom-logo-uploaded" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/protostar/logo-custom-logo-uploaded.jpg" /></a></td>
</tr>
</tbody>
</table>
<p>You'll notice that if you choose to show a custom logo, your site title will no longer show. In our testing, you can see the <strong>My Joomla 3.0 Website</strong> title shows in the before screenshot, but not in the after.</p>
<h2>To add a logo in Joomla 3.0</h2>
...
<li>In the list of templates, find and click on the <strong>Protostar</strong> template. In our testing, we clicked on <strong>My Default Style (Protostar)</strong></li>
  <li>Click the <strong>Options</strong> (or <strong>Advanced</strong> if you don't see <em>Options</em>) tab towards the top of the page</li>
<li>Find the setting labeled <strong>Logo</strong>, and then click the <strong>Select</strong> button next to it.</li>
<li>
  <p>At this point you have several options:<br /><br /><em>6.1</em>: Browse through files you've already uploaded and click on an image<br /><em>6.2</em>: Next to <strong>Image URL</strong>, type in the url to the image<br /><em>6.3</em>: Next to <strong>Upload file</strong>, click <strong>Choose Files</strong> and then upload a logo from your computer<br /><br />After using one of the three options above, click the <strong>Insert</strong> button in the top right of the pop-up and then click the <strong>Save</strong> button in the top left of the page to save the settings for you new logo.</p>
  
  <p>A note about <strong>File size</strong>:<br />Joomla will show you the file size limit if you decided to upload a file. For example, we saw at message stating there was a 10mb limit. As far as dimenions, we were allowed to upload an image 2000px long. The chrome browser resized the long image so it didn't stretch off the screen, but Firefox showed the full 2000px wide image (which didn't look good at all).</p></li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 3: How to upload a logo in the Joomla 3.1 Protostar template</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 2: <a href='/support/edu/joomla-3/protostar/background-colour'>Changing your template background colour in Joomla 3.1</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-3/protostar/logo&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-3/protostar/logo'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yODQmaWQ9MTg5NiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="79c3fab6dfc2cea2d2fc741f5cbdb4c4" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/d4579efb6122894318d1e3bcb260f886?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/d4579efb6122894318d1e3bcb260f886'>Chris Rose</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-20 3:00 pm</div>
				                <div><p>Thanks for the help with adding a logo. What width did work for the logo, so that it doesn't stretch off the screen when viewed in Mozilla?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14172);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-20 3:55 pm</div>
				                <div>Hello Chris,<br />
<br />
The reference to the file size in the article is related to the maximum size of the graphic.  The size that you need will be related to the size of the logo graphic in its correct proportions.  This will depend on your graphic.  For example, if you took a logo graphic that was proportionally correct at 320x200 pixels, and then set the graphic size, to 1000x1000pixels, then it would look stretched because the proportions of the graphic are not proportionate.   If you wanted to double the size the graphic that is 320x200, then you would simply use 640x480 pixels to keep the proportions correct.  <br />
<br />
I hope that helps to explain it!  Please let us know if you have any further questions or comments.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(14174);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/87223b58689bb30ac61bc12052cbf981?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/87223b58689bb30ac61bc12052cbf981'>lmanolog</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-12 6:05 am</div>
				                <div>Su documentaciÃ³n es correcta , pero como  se puede superponer logo,?<br />
es decir,  en la cabecera tener una rotaciÃ³n de imÃ¡genes y encima el logo en posiciÃ³n fija.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16122);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-06 1:14 pm</div>
				                <div>Unfortunately, we only speak English and your comment did not translate well.  If you could provide your comment in English, I will be happy to assist you.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19249);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-25583'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/fdfbd58a0eb5bac4775121e86f701822?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/fdfbd58a0eb5bac4775121e86f701822'>Tom Eijkelenberg</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-07 1:07 pm</div>
				                <div><p>Hello, I am learning to work with Joomla and I have uploaded the logo, but how can I make it smaller? The website is www.example.nl.</p>
<p>Thanks you!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25583);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-07 3:01 pm</div>
				                <div>Hello Tom,<br />
<br />
Thank you for contacting us. I recommend re-sizing the image on your computer before uploading. Most computers include an image processor, such as Paint, or Gimp. There are also many available online.<br />
<br />
This reduces the amount of processing your server has to do, and can speed up load times, since the image is already the right size (and doesn't have to be resized when the page loads).<br />
<br />
Thank you,<br />
John-Paul<br />
<br />
</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25589);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-07 6:17 pm</div>
				                <div><p>Hello John-Paul,</p>
<p>Thank you!</p>
<p>I am going to try it first thing in the morning!</p>
<p>Regards,</p>
<p>Tom</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25594);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
