<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:59734:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/boldgrid/installing-boldgrid/site-hosted-elsewhere" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-05-05T21:14:13-07:00" />
  <meta name="keywords" content="BoldGrid Hosted Elsewhere" />
  <meta name="author" content="John-Paul Briones" />
  <meta name="description" content="This guide explains how to use the BoldGrid for Wordpress builder, when you are not hosted with InMotion Hosting." />
  <title>How to Use BoldGrid when your site is not hosted with InMotion Hosting - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/boldgrid/installing-boldgrid/site-hosted-elsewhere" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<script type="text/javascript">
		...
		_gaq.push(['_setCustomVar', 4, 'DateMonthPublished', '2015-08', 3]);
	...
	<!-- cid:7b5d86b0c898055d1439de80df2006ae -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to Use BoldGrid when your site is not hosted with InMotion Hosting									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>384</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Aug 14, 2015'><span style='color:#606060;'>Published:</span> May 5, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/boldgrid/how-to-install/boldgrid-logo.png"><img  src="//cdn.inmotionhosting.com/support/images/stories/boldgrid/how-to-install/boldgrid-logo.png" alt="Bold Grid" class="pull-right" title="BoldGrid powered by WordPress" style="margin: 15px 15px 15px 15px;" /></a>
<p>If you have decided that <a href="http://www.boldgrid.com">BoldGrid</a> is going to be your solution for creating your new website but you have an existing website that you're going to keep on a different host than InMotion Hosting, then you have a few options . You can:
<ul>
<li>Start a new website with a new domain name</li>
<li>Use your old domain name for your website immediately, transferring it to InMotion.  If you do this without replacing the domain name, your old website will no longer appear on the web. You would need to let <a href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/domain-names-dns-changes">domain propagation</a> complete before using the domain name at your new InMotion Hosting account.</li>
<li>Use your old domain name for your website, but wait until development of your new website is complete before transferring the domain name.  You can use a temporary domain name for the development of your BoldGrid website that will need to be changed when you're ready to go live with your actual domain name. </li>
<li><a href="http://www.inmotionhosting.com/support/website/amp/wtr">Transfer your old website to InMotion Hosting</a>. If it is a WordPress installation, then you can have BoldGrid installed and use the Staging feature to develop a new website while making the transferred site into the active site.  When the development is complete you would be able to replace the website by deploying the Staging site. If the transferred website is not a WordPress site, then you would need to create a separate BoldGrid installation. </li>
</ul>
</p>
<p>As you can see, there are few different situations that may apply to you.  If you have another website that you are hosting in a different location, give the matter some serious consideration in order to provide the best experience for you you and your audience. The following instructions provides a general list if you're keeping your other website running while you're developing a new one with BoldGrid.</p>

<h2>Steps to take when developing a new BoldGrid site while maintaining your old website on a different host</h2>

<ol class="article_list">

  <li><a href="/contact">Contact our sales team</a> and setup an account and request BoldGrid.</li>
<li>Decide if you're going to <a href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/domain-names-registrar-transfer-versus-nameserver-change">transfer your domain name or simply change the name servers</a>. <i>You will need a domain name for your BoldGrid site.</i></li>
<li>If necessary, plan and then transfer your website media (i.e. your website graphics, video, etc.) in order to bring your website to InMotion Hosting. If you're not using your existing website media, then you are welcome to create a new site using the media available with BoldGrid.</li>
  <li><a href="/support/edu/boldgrid/getting-started">Develop your BoldGrid site</a>.</li>
<li>When you have finished developing your BoldGrid site, review it then decide on how you're going to transfer your domain name if you're not already using it.</li>
<li>Take down your old site and <a href="http://www.inmotionhosting.com/support/domain-names/dns-nameserver-changes/domain-names-registrar-transfer-versus-nameserver-change">transfer the domain name</a> if necessary. Be aware that transferring a domain name is not always immediate, it may take some time - known as domain propagation. </li>
<li><a href="/support/edu/boldgrid/intermediate-topics/deploy-staging">Deploy your finished BoldGrid website</a>.</li>
</ol><br>
<p>For more infromation about BoldGrid or if you want to <a href="http://www.boldgrid.com/support/questions/">post a question</a> that related to BoldGrid you can do so on the <a href="http://www.boldgrid.com/support/">BoldGrid Support Center</a>. 
</p>
</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 10: How to Use BoldGrid when your site is not hosted with InMotion Hosting</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 9: <a href='/support/edu/boldgrid/installing-boldgrid/boldgrid-use-different-domain'>How to use BoldGrid in a Different Domain</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 11: <a href='/support/edu/boldgrid/installing-boldgrid/move-wordpress-folder'>Move WordPress folder</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/boldgrid/installing-boldgrid/site-hosted-elsewhere&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/boldgrid/installing-boldgrid/site-hosted-elsewhere'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP3RzcmM9cnNiZWR1Jm9wdGlvbj1jb21fY29udGVudCZjYXRpZD01MzYmaWQ9MzY0MiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
