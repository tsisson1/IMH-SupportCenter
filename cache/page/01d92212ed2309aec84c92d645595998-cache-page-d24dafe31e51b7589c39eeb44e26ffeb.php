<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:79945:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/prestashop-15/i-can-not-log-in-at-admin-panel-in-prestashop-it-stays-at-the-homepage" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="I have seen this issue before in which there was an issue with the PrestaShop core files. First, make a backup of your site as well as the database, the..." />
  <title>I can not log in at admin panel in Prestashop it stays at the homepage | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/prestashop-15/i-can-not-log-in-at-admin-panel-in-prestashop-it-stays-at-the-homepage" rel="canonical" />
...
<script>
  ...
  ga('send', 'pageview');
	...
	<!-- cid:9d6ab95fc5008113169cc411781ba475 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '201.241.248.118']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>I can not log in at admin panel in Prestashop it stays at the homepage</h1>
		<div style='margin-bottom:20px; margin-top:10px; clear:both; color:#6e6e6e;'>Category: <a href='/support/community-support/prestashop-15'>Prestashop 15</a></div>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/FerBo7'>FerBo7</a>
			<div>107 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2014-05-25 4:31 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>6,855</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I am transfering the website to Inmotion but always happens the same. I have transfer the whole files through ftp and configuring the database. My website works but not admin panel. When I tried to log in nothing happens like if I introduce a wrong password or username but without a message. The user and pass are both correct because when I set a wrong password the message that my password or username is incorrect appears.<br />
<br />
I dont know what to do. My version is 1.5.0.7. If I cant log in into my admin panel my website is usefulness.<br />
<br />
I tried clearing the .htaccess file because something wrong with the redirection but it does not fix the issue.</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_5024' id='upvote_answer_5024' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='5024' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_5024').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_5024' id='downvote_answer_5024' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='5024' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_5024').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					<img src='https://lh6.googleusercontent.com/-ML7FcuvnOJw/AAAAAAAAAAI/AAAAAAAAAB0/UiLncgP8kr8/photo.jpg?sz=90' class='user_avatar' style='max-width:60px;' /><br />
                		        <a href='/support/community-support/users/JeffMa'>JeffMa</a>
					
					<div>11,186 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2014-05-27 7:55 am EST
                		        </div>
					
		                </div>

				I have seen this issue before in which there was an issue with the PrestaShop core files.  <br />
<br />
First, &lt;a href=&quot;http://www.inmotionhosting.com/support/website/backup-and-restore&quot;&gt;make a backup of your site as well as the database&lt;/a&gt;, then replace the &lt;a href=&quot;http://www.prestashop.com/en/developers-versions&quot;&gt;core PrestaShop files&lt;/a&gt;.  Be sure leave the /config/settings.inc.php intact as this is required to connect to your database.  The issue should then be resolved.  <br />
<br />
After resolving your issues with PrestaShop 1.5.0.7, I highly recommend updating your  PrestaShop installation as running older versions can introduce various bugs like this as well as security issues.
				

				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_5024').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_5024' id='form_comment_on_answer_5024' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>What core files? Why cant run on your hosting but in the other hosting runs smothly?</div>
							...
							<td style='width:96px;' valign='top'>
								...
								<div class='smallgrey'>
									<a href='/support/community-support/users/FerBo7'>FerBo7</a><br />
									107 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2014-05-27 11:47 am EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello FerBo7,<br />
<br />
The Core Files (as per the link provided above) relate to the files installed by PrestaShop.  They do not include the custom module or theme files.  We host many PrestaShop users and are the recommended host by PrestaShop.  When you transfer from one host to another, though,  there may always be differences which can cause the problem.  Make sure to try Jeff's suggestion first.  If you continue to have the problem, then please let us know and we can investigate the issue further.  We also provide a tutorial <a href="http://www.inmotionhosting.com/support/edu/prestashop-15/reset-prestashop-admin-password">for recovering a PrestaShop admin password</a> if needed.<br />
<br />
Regards,<br />
Arnel C.</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>But where can I get the core files for my Prestashop version? Also what are the files installed by Prestashop, they are many. I dont think that recovering password will help because is not a password issue.</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello FerBoy,<br />
<br />
Here's the link for the files again:  http://www.prestashop.com/en/developers-versions.  When you get to the page scroll down and you'll see ALL of the versions that have been released - including your version.  The files are compressed, you simply have to uncompress them, then replace the same files that you migrated to the server.  You can always run a clean install and then try migrating your database in as well.  If you replace ALL of the files, then you will need to install any plugin/theme that you had from before.  Also, make sure that you are not using SEO friendly URLs.  They will need to be reset once you have the shop up and running correctly without that setting turned on. <br />
<br />
I advised on the password recovery option, because it doesn't appear to be taking your password.  You may think it's correct, but it might be slightly different.  Using the tutorial, you can reset the password, double-check the user name and make sure that the issue is not related to corrupted user credentials.<br />
<br />
Regards,<br />
Arnel C.</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Thanks for your reply. As I told you before when I set a wrong password the page says &quot;wrong username or password&quot; but if I introduce the correct one does nothing.</div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello FerBo7,<br />
<br />
Yes, I understand what you are saying, but it doesn't appear as though you're able to login  - this is typically NOT an issue of the software not working correctly.  Using the tutorial to change the password will let you set both the user name and the password to something that you can verify.  The problem now is that it is possible that the field is corrupted or it has been changed.<br />
<br />
Regards,<br />
Arnel C.</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>I have reset the password and cant log in. What if I replace the core files of a newer version?</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>I dont know if it is a cookie issue within file settings.inc.php</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>The last time it was solved replacing core files but whats the file with the failure? How can I replace just the needed files not the whole installation files :S</div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello FerBo7,<br />
<br />
Unfortunately it would be hard to tell exactly what the missing file is. Did you modify anything recently in your PrestaShop before your lost access to the admin? Depending on what section you were modifying could possibly help determine which core files have been modified.<br />
<br />
You might want to &lt;a href=&quot;http://www.inmotionhosting.com/support/website/getting-started-guides/submitting-and-checking-on-status-of-tickets#submit-ticket&quot; target=&quot;_blank&quot;&gt;submit a ticket&lt;/a&gt; if you continue to have problems because it seems like your problems are very specific to either file or setting problems directly with your account.<br />
<br />
- Jacob</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='https://lh6.googleusercontent.com/-71IjFLXWAbo/AAAAAAAAAAI/AAAAAAAAZoM/rUwpCEjduSw/photo.jpg?sz=90' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/JacobIMH'>JacobIMH</a><br />
									9,968 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2014-05-30 6:30 am EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>I dont modify anything recently. I dont know what core files replace to start the testing and finally migrate my entire website. Could you help me? Thanks for your help :D</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Whats files should I replace? I have downloaded the zip file.</div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello FerBo7,<br />
<br />
If you haven't recently modified any PrestaShop files then you would essentially want to replace them all. This is considered the &quot;core&quot; files for PrestaShop as they are required to get it up and running.<br />
<br />
The only file you don't want to replace would be your &lt;span style=&quot;color: red;&quot;&gt;/config/settings.inc.php&lt;/span&gt; file which would contain the special settings for connecting to your PrestaShop database which you also should have already imported into the server. If you haven't, we have a guide on &lt;a href=&quot;http://www.inmotionhosting.com/support/website/phpmyadmin/import-database-using-phpmyadmin&quot; target=&quot;_blank&quot;&gt;importing a database with phpMyAdmin&lt;/a&gt; you could use.<br />
<br />
Basically if you're migrating your PrestaShop install from one host to another, you just want to make sure you're transferring all of your PrestaShop files, as well as the database. You also need to make sure that the database name in your &lt;span style=&quot;color: red;&quot;&gt;/config/settings.inc.php&lt;/span&gt; file is referencing the database name and database username on our server instead of at your previous host.<br />
<br />
- Jacob</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Yes, everything is ok. But what folder have the core files? I am not going to replace modules folder not other that have my actual configuration</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>I replace the core files of Prestashop. After that I get a loop if I leave the install folder or I get the error &quot;Error: 'install' directory is missing&quot; if I delete or rename the install folder?</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Remove the install folder and ensure that your settings.inc.php file is still intact.  If this is missing or changed, it can cause the issues that you are seeing.</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Done. Now the following messange &quot;Bad SubDomain SQL query.&quot;</div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello FerBo7,<br />
<br />
Were you trying to do a new PrestaShop install now? The PrestaShop error of &lt;em&gt;Bad SubDomain SQL query&lt;/em&gt; is typically caused when you've done an upgrade from 1.4.x to 1.5.x. The following SQL file is run:<br />
<br />
&lt;span style=&quot;color: red;&quot;&gt;/install/upgrade/sql/1.5.0.9.sql&lt;/span&gt;<br />
<br />
This statement drops the &lt;span style=&quot;color: red;&quot;&gt;_subdomain&lt;/span&gt; table:<br />
<br />
&lt;span style=&quot;color: red;&quot;&gt;DROP TABLE `PREFIX_subdomain`;&lt;/span&gt;<br />
<br />
I found doing a Google search that this can sometimes be fixed by re-creating that table:<br />
<br />
&lt;pre class=&quot;code_block&quot; style=&quot;margin: -10px 0px -30px 0px; line-height: .9em&quot;&gt;CREATE TABLE 'ps_subdomain' (<br />
  'id_subdomain' int(10) unsigned NOT NULL auto_increment,<br />
  'name' varchar(16) NOT NULL,<br />
  PRIMARY KEY  ('id_subdomain')<br />
) ENGINE=ENGINE_TYPE DEFAULT CHARSET=utf8;&lt;/pre&gt;<br />
<br />
Then inserting data for the &lt;span style=&quot;color: red;&quot;&gt;www&lt;/span&gt; subdomain into it.<br />
<br />
&lt;pre class=&quot;code_block&quot; style=&quot;margin: -10px 0px -30px 0px; line-height: .9em&quot;&gt;INSERT INTO 'ps_subdomain' ('id_subdomain', 'name') VALUES (1, 'www');&lt;/pre&gt;<br />
<br />
- Jacob</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>No, I dont reinstall prestashop, I just replace the core files. All the files of the zip file prestashop_1.5.0.1.zip found at the developer section of prestashop site. Thanks :)</div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello FerBo7,<br />
<br />
I'm not sure why you would be getting the particular error you've mentioned if you've just replaced the PrestaShop core files. Are you getting the error when just trying to access the PrestaShop admin?<br />
<br />
It looks like in your original posting you mentioned that you were trying to migrate over a PrestaShop 1.5.0.7 install and it sounds like you've downloaded the core files for PrestaShop 1.5.0.1.<br />
<br />
Looking at the &lt;a href=&quot;http://www.prestashop.com/en/developers-versions&quot; target=&quot;_blank&quot;&gt;PrestaShop developers versions&lt;/a&gt; I see there is a PrestaShop 1.5.0.17, is this possibly what you had prior to attempting to migrate your PrestaShop store in the first place?<br />
<br />
- Jacob</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Sorry, I did that. I will replace the version 1.5.0.17 that I have. I made a mistake is NOT 1.5.0.7. Should I do it different?</div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello FerBo7,<br />
<br />
Whatever version of PrestaShop that you had prior to migrating it to our server, is the version of the core files you'd want to download.<br />
<br />
It looks like your PrestaShop admin dashboard is accessible from what I can see. If you're still having any issues, please let us know how to replicate the problems you're having.<br />
<br />
- Jacob</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Now, the webpage is blank also when I log in the admin panel or backoffice. Please check www.vapemex.com</div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello FerBo7,<br />
<br />
If you would like for us to attempt to login to your PrestaShop admin to replicate any problems that you're having, please &lt;a href=&quot;http://www.inmotionhosting.com/support/website/getting-started-guides/submitting-and-checking-on-status-of-tickets#submit-ticket&quot; target=&quot;_blank&quot;&gt;submit a ticket&lt;/a&gt; with you admin URL and login info.<br />
<br />
Please include in that ticket if there was anything you've recently changed before the admin started being blank.<br />
<br />
- Jacob</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/prestashop-15/i-can-not-log-in-at-admin-panel-in-prestashop-it-stays-at-the-homepage&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/prestashop-15/i-can-not-log-in-at-admin-panel-in-prestashop-it-stays-at-the-homepage'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="3359b361987d851ed40ef632ec302b9d" value="1" />	</div>
	</form>
<!-- <br />
