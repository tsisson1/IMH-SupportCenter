<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:63056:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/protecting-files/using-the-ip-deny-manager" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-04-16T19:32:10-07:00" />
  <meta name="keywords" content="IP deny rules .htaccess cpanel allow restrict user access control host name hostname order apache range CIDR format manager" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="Learn how to block IP addresses from your website and eliminate unwanted traffic." />
  <title>Restrict access with .htaccess and the IP Deny Manager - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/protecting-files/using-the-ip-deny-manager" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:a11ec7d036452bdce1f8865825f7e4f6 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '217.238.33.228']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Restrict access with .htaccess and the IP Deny Manager									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>47,472</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Sep 13, 2011'><span style='color:#606060;'>Published:</span> Apr 16, 2014</div>
				...
				<a class="ddtut" href="http://support.inmotionhosting.com/userguides/cpflash_x3/cpanel_x3_ipdeny.swf" style='display:block; margin-bottom:15px;'>
					<img src='/support/images/icon.movie.png' /><br />
					Click here to watch a video tutorial
				</a>
				

								<p>Access control is an important part of managing visitor access to your website. Visitors can be restricted from accessing your site by using the IP deny manager in your cPanel or by adding the <code>Allow</code> or <code>Deny</code> code in your <a target="_blank" href="/support/website/general-server-setup/what-is-the-htaccess-file-and-what-do-i-use-it-for">.htaccess</a> file.</p>
<p>This is especially useful when robots or malicious visitors from specific countries or domain addresses spam your site or place comments on your site that you do not want. The following sections will explain how to block IP's in your <a target="_blank" href="/support/website/general-server-setup/what-is-the-htaccess-file-and-what-do-i-use-it-for">.htaccess</a> file and through the cPanel IP deny manager.</p>
<p class="alert"><strong>Important!</strong> If you are on a VPS or Dedicated server, you can bloack IPs globally server wide. Please <a target="_blank" href="/support/email/email-troubleshooting/535-incorrect-authentication">click here</a> to learn how.</p>
...
<pre style="margin-left: 20px;">Order deny,allow
Deny from all
...
<pre style="margin-left: 20px;">Deny from unwanted-domain.com
</pre>
...
<pre style="margin-left: 20px;">Deny from 192.168.205
Deny from unwanted-domain.com unwanted-domain-2.com
Deny from domain-part
</pre>
<h2>Access control using the IP Deny Manager</h2>
...
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/how-to/deny-ip-manager/ip-deny-manager-1.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Select IP deny manager cPanel" src="//cdn.inmotionhosting.com/support/images/stories/website/how-to/deny-ip-manager/ip-deny-manager-1.gif" title="Click here to view the larger image" width="100" /></a>Navigate to the Security setion and <strong>click IP Deny Manager</strong>. The following table explains what formats you can use to block Ips. <br style="clear: both;" />
<table class="article_table" border="0">
<tbody>
<tr><th colspan="2" align="center">IP formats (taken from cPanel)</th></tr>
<tr><th>Single IP Address</th>
<td>10.5.3.333 (Only this IP will be blocked)</td>
</tr>
<tr><th>Implied Range</th>
<td>10.5.3.3-10.5.3.40 (This blocks a range of IP's that fit the parameters between IP 10.5.3.3 and 10.5.3.40)</td>
</tr>
<tr><th>CIDR Format</th>
<td>10.5.3.3/32 (This blocks all IP's in the 10.3.3 range from 10.3.3.00 to 10.3.3.32)</td>
</tr>
<tr><th>Implied IP Address</th>
<td>10. Implies 10.*.*.* (blocks all IP's starting with 10.)</td>
</tr>
</tbody>
</table>
<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/how-to/deny-ip-manager/ip-deny-manager-2-add.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="Add IP in the Deny Manager cPanel" src="//cdn.inmotionhosting.com/support/images/stories/website/how-to/deny-ip-manager/ip-deny-manager-2-add.gif" title="Click here to view the larger image" width="100" /></a><strong>Type the IP </strong>you want to block.
<p><strong>Click Add.</strong></p>
<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/how-to/deny-ip-manager/ip-deny-manager-2-current.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="List of current IPs added" src="//cdn.inmotionhosting.com/support/images/stories/website/how-to/deny-ip-manager/ip-deny-manager-2-current.gif" title="Click here to view the larger image" width="100" /></a>You will be directed to a success page.
<p><strong>Click back</strong>.</p>
<p>Now you will see the IP address in the list of current IP's that are blocked and the IP will not be allowed to access your site.</p>
<br style="clear: both;" /></li>
</ol>
<p>You can also watch the following video tutorial to learn how to block IP addresses:</p>
<p><a class="ddtut" href="http://support.inmotionhosting.com/userguides/cpflash_x3/cpanel_x3_ipdeny.swf">Using IP Deny Manager</a></p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/protecting-files/using-the-ip-deny-manager&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/protecting-files/using-the-ip-deny-manager'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MzcmaWQ9NSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="dbf8ca7ff2dc4017327d196a96ce9d62" value="1" />	</div>
	</form>
<!-- <br />
