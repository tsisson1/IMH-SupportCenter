<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:45398:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/tools/email-configuration" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Need your email settings for your client? This tool will automatically generate all of the settings that you should need to get connected." />
  <title>Email Configuration Tool | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/tools/email-configuration" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:c432038858572a39bd5c59bd23283596 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '71.115.156.87']);
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Email Configuration</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class='item-page'><h1>Email Configuration</h1><p>Simply fill out an email address below and click submit to get the universal email client configuration settings.</p>
    
<!-- <form class="well-small domains-pill row-fluid" action="" method="post" style="width:98%">
<div id="domain-input-wrap" class="span8">
 <input style="margin-bottom: 0px;width:400px;" type="text" name="email" value="" placeholder="example@example.com" ><div class="res-container"></div>
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD01MzMmaWQ9NTMzJnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="5e191f44718775ceece8f8d0b22aa28d" value="1" />	</div>
	</form>
<!-- <br />
