...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/moodle/advanced-tutorials/post-max-size-error" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-01-27T17:30:54-08:00" />
  <meta name="keywords" content="moodle post_max_size php.ini error" />
  <meta name="author" content="John-Paul Briones" />
  <meta name="description" content="How to fix the post_max_size directing in php.ini error." />
  <title>How to Fix the &quot;uploaded file may exceed the post_max_size directive in php.ini&quot; error in Moodle - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/moodle/advanced-tutorials/post-max-size-error" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:27a26270abfeab1d6b704dba75b3a894 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to Fix the &quot;uploaded file may exceed the post_max_size directive in php.ini&quot; error in Moodle									</h1>
...
<ol class="article_list">
  ...
  <li>Click the <strong>File Manager</strong> button in the <em>Files</em> section. If the <em>Directory Selection</em> window pops up, click the <strong>Go</strong> button.</li>
  <li>Navigate to the folder where your Moodle is installed and click the <strong>php.ini</strong> file. Then click the <strong>Code Editor</strong> button on top. If a <em>Code Editor</em> box pops up, click the <strong>Edit</strong> button.</li>
...
<p>Congratulations, now you know how to fix the "<em>uploaded file may exceed the post_max_size directive in php.ini</em>" error in Moodle!</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 3: How to Fix the &quot;uploaded file may exceed the post_max_size directive in php.ini&quot; error in Moodle</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 2: <a href='/support/edu/moodle/advanced-tutorials/additional-name-fields'>Displaying Additional Name Fields in Moodle</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 4: <a href='/support/edu/moodle/advanced-tutorials/change-url'>How to change your URL in Moodle</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/a5f8fff0deb6716f7352f7f5d59fbffa?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/a5f8fff0deb6716f7352f7f5d59fbffa'>Christian E. McQuilkin</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-02 5:56 am</div>
				                <div><p>You should also mention that the&nbsp;upload_max_filesize should be&nbsp;less than or equal to that of the post_max_size for it to work.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13567);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
