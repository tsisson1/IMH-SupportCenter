<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:78524:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/ssh/how-to-login-ssh" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-05-10T14:01:29-07:00" />
  <meta name="keywords" content="login ssh putty VPS Dedicated 2xram" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="How to use a program called PuTTY to SSH into your VPS / Dedicated server." />
  <title>How to log in to your VPS via SSH - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/ssh/how-to-login-ssh" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:eabbe4969684e8720ffc26f6dd54a801 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '187.75.2.153']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to log in to your VPS via SSH									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>165,466</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Dec 1, 2011'><span style='color:#606060;'>Published:</span> May 10, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<h2>Before you can login to your server, you need to ensure the following prerequisites are met:</h2>
<ol>
<li><a href="/support/website/file-management/how-to-enable-ssh-through-whm" target="_blank">Your account has ssh access</a>. </li>
  <li><a href="/support/website/general-server-setup/add-ip-to-firewall">Your IP address has been added to the firewall</a>.</li>
<li>You have a SSH client.</li>
 
</ol>
<p>If you are looking for information on how log in via SSH with a shared server, please see <a href="http://www.inmotionhosting.com/support/ssh/shared-reseller-ssh">SSH access for Resellers and Shared Servers</a>. Click here to learn more about <a href="http://www.inmotionhosting.com/dedicated-servers">Dedicated Server hosting</a>.</p>
<br />

<p>In this tutorial, we're going to be using PuTTY to connect to your <a href="http://www.inmotionhosting.com/vps-hosting">VPS</a> or <a href="http://www.inmotionhosting.com/dedicated-servers">dedicated server</a> via SSH. If you don't already have an SSH client, we recommend that you <a href="http://www.chiark.greenend.org.uk/~sgtatham/putty/download.html" target="_blank" rel="nofollow">download PuTTY</a>.</p>
...
<p>If you are trying to directly connect from a Linux or Mac terminal via SSH, please note the format of the command would need to be in this format:</p>
  <p class="cli">[Bob ~]$ <span style="color: red; text-shadow: 0 0px 0;">ssh username@example.com -p 22</span></p>
...
<h2>Before we open PuTTY, you'll need the following settings:</h2>
<p class="alert"><strong>Note!</strong> Your hostname and username can be found in the <a target="_blank" href="/support/website/how-to/viewing-account-technicial-information-in-amp">Technical Details of your AMP</a> home page.</p>
<table border="0" cellspacing="5">
<tbody>
<tr>
<td><strong>Host Name</strong>:</td>
<td>As your hostname, you can use either your server's ip address, your domain, or your server name (as in vps####.inmotionhosting.com or biz152.inmotionhosting.com)</td>
</tr>
<tr>
<td><strong>Username</strong>:</td>
<td>Use your cPanel username.</td>
</tr>
<tr>
<td><strong>Password</strong>:</td>
<td>Use your cPanel password.</td>
</tr>
</tbody>
</table>
...
<h2>How to connect using PuTTY</h2>
...
<li style="margin-bottom: 10px;">Open Putty.<br style="clear:both;" />
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/whm-edu/how-go-ssh-into-server/open-putty-and-enter-your-hostname-then-click-open.gif"><img style="margin: 0px 0px 15px 15px; float: right;" src="//cdn.inmotionhosting.com/support/images/stories/whm-edu/how-go-ssh-into-server/open-putty-and-enter-your-hostname-then-click-open.gif" alt="open-putty-and-enter-your-hostname-then-click-open"  width="150" /></a>Enter your hostname.
</li>
<li style="margin-bottom: 10px;">
  <p>Click "<em>Open</em>".</p>
  <p style='font-size:11px;'><span class="alert alert-error" style="padding:2px;">Can't connect?</span> Getting an error message <em>Network Error: Connection timed out</em>? Be sure to <a href="/support/website/general-server-setup/add-ip-to-firewall">add your ip address to the firewall</a>.</p>
  
  
</li>
<li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/whm-edu/how-go-ssh-into-server/click-yes-to-the-putty-security-alert.gif"><img style="margin: 0px 0px 15px 15px; float: right;" src="//cdn.inmotionhosting.com/support/images/stories/whm-edu/how-go-ssh-into-server/click-yes-to-the-putty-security-alert.gif" alt="click-yes-to-the-putty-security-alert"  height="94" width="150" /></a>If you get a "<em>PuTTY Security Alert</em>", click yes to continue (If you read the message, this is your server so you should trust it).<br style="clear:both;" />
</li>
<li style='clear:both;'><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/whm-edu/how-go-ssh-into-server/putty-login-as-prompt-is-asking-for-your-username.gif"><img style="margin: 0px 0px 15px 15px; float: right;" src="//cdn.inmotionhosting.com/support/images/stories/whm-edu/how-go-ssh-into-server/putty-login-as-prompt-is-asking-for-your-username.gif" alt="putty-login-as-prompt-is-asking-for-your-username"  height="93" width="150" /></a>You will see "<em>Login As</em>". Please enter your username and then hit Enter.
<br style="clear:both;" />
</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/whm-edu/how-go-ssh-into-server/enter-your-password-into-putty.gif"><img style="margin: 0px 0px 15px 15px; float: right;" src="//cdn.inmotionhosting.com/support/images/stories/whm-edu/how-go-ssh-into-server/enter-your-password-into-putty.gif" alt="enter-your-password-into-putty"  height="79" width="150" /></a>You will then see <code>username@vps####.inmotionhosting.com's password:</code>. Enter your password and hit enter. For security reasons, PuTTY will not show anything when you type your password, this is normal.
<br style="clear:both;" />
</li>
<li>When you have successfully logged in, you'll see <code>username@vps####.inmotionhosting.com [~]#</code>.
  <p class="alert"><strong>Note!</strong> If you get an error stating Shell Access is Not Enabled on your server, you will need to contact <a href="/support/component/content/help/how-to-get-great-technical-support?Itemid=204" target="_blank" title="Click here for how to contact support">tech support</a> to have our higher level of support enable the shell access. If you can access your WHM, <a href="/support/website/file-management/how-to-enable-ssh-through-whm" target="_blank">you can enable SSH through your WHM</a>.<br style="clear:both;" />
</p>

</li>
</ol>
<p>Congratulations, you have now successfully logged into your server via SSH! Are you looking for hosting that supports SSH? Learn what <a href="http://www.inmotionhosting.com/ssh-hosting">SSH Hosting</a> we have to offer!</p> 


<br />
<div class="AW-Form-1702357380"></div>
<br /> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/ssh/how-to-login-ssh&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/ssh/how-to-login-ssh'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MTEmaWQ9MzE4JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/general-server-setup/user-with-shell-access?tsrc=rsbraq'>User with shell access</a>
                                </div>
...
<a name='comments'></a>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/0bd6a9b786c22a798a1a8e761adebbd8?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/0bd6a9b786c22a798a1a8e761adebbd8'>teresa bongioni</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-03-17 2:22 pm</div>
				                <div><p>Un buon server vps richiede molta parsimonia e ponderazione.&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(21808);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-25857'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/1fc5dc56296ce45b3e0bd2fe0c945e65?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/1fc5dc56296ce45b3e0bd2fe0c945e65'>Ernest Burden</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-17 7:26 pm</div>
				                <div><p>I am a little fuzzy on your reference to connecting using terminal on a MAC. As PuTTY is not a MAC option.</p>
<p>You have a short info explanation in the blue box:</p>
<p>[Bob ~]$ <span style="color: red; text-shadow: 0 0px 0;">ssh username@example.com -p 22</span></p>
<p>If I understand this then I would enter ssh myusername@vps(mynumber).inmotionhosting.com -p 22</p>
<p>Not sure about the "-p22"</p>
<p>Tried to find an Inmotion video regarding connecting to SSH using terminal. Haven't found yet. Is there one?</p>
<p>thanks.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25857);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-17 7:57 pm</div>
				                <div>Hello Ernest,<br />
<br />
Yes, you should be able to use that command via Terminal on the Mac. The -p 22 indicates that it should connect using port 22.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25858);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						...
						<div><a style='font-size:16px;' href='/support/community-support/users/locrasto'>locrasto</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-12-22 9:36 pm</div>
				                <div>Port should be 2222, however, still cannot connect using just a password.  The server responds with a public key.  </div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29343);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-12-23 12:35 pm</div>
				                <div>Hello Locrasto,<br />
<br />
For VPS/Dedicated servers the port is 22 not 2222. It is only 2222 if either you change it or you are trying to <a href="http://www.inmotionhosting.com/support/website/ssh/shared-reseller-ssh">connect to one of our shared or reseller servers via SSH</a>.<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29356);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-30981'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/3ae29d0f2410785a062393d451bde0ce?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/3ae29d0f2410785a062393d451bde0ce'>Muhammad Nomman</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-04 8:54 am</div>
				                <div><p>Hi all,</p>
<p>I've a Web Hosting with the Domain. I am using a Video Sharing Site that I installed on my Domain via Web Hosting CPanel. But the Video Sharing Site required the ffmpeg module. I've tried so many time to install this module using Perl Mdule in the CPanel. But it could not be installed and give an error.</p>
<p>So anyone here to help me out. Ho can I install ffmpeg module for my Website.</p>
<p>Thanks in Advance</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30981);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-04 10:44 am</div>
				                <div>Hello Muhammad,<br />
<br />
Are you on a shared server? Please keep in mind that ffmpeg can only installed on a VPS or higher package.<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30985);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
