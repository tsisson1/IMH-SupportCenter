<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:66256:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/drupal-7/getting-started/how-to-log-into-the-drupal-admin-dashboard" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-05-02T16:35:49-07:00" />
  <meta name="keywords" content="log in drupal dashboard admin administrator" />
  <meta name="author" content="Tim Sisson" />
  <meta name="description" content="Learn how to log into the Drupal admininstrator dashboard so you can effectively build, manage and edit your site and its users." />
  <title>How to log into the Drupal 7 Administrator Dashboard - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/drupal-7/getting-started/how-to-log-into-the-drupal-admin-dashboard" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:92c50fdb474f04659b340b81139faef8 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '109.164.157.44']);
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
				<img src='/support/images/stories/drupal-partner/supporting-partner-80_3.png' style='float:right; margin:0px 0px 15px 15px;' alt='Drupal Association Support Partner'>		<h1>
															How to log into the Drupal 7 Administrator Dashboard									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>79,123</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Feb 14, 2012'><span style='color:#606060;'>Published:</span> May 2, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Now that you have <a href="/support/edu/drupal-7/getting-started/manually-installing-the-latest-version-of-drupal">installed</a> and <a href="/support/edu/drupal-7/getting-started/initial-configuration-of-drupal-installation">configured</a> Drupal 7, most of your tasks will be done through the Drupal 7 dashboard. You will be able to login to your Drupal 7 Dashboard from any web browser.</p>
<ol class="article_list">
<li>Go to <strong>example.com/admin</strong> (Be sure to <em>replace example.com</em> with your <em>actual domain name.)<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/drupal/drupal_login_1.jpg"><img src="//cdn.inmotionhosting.com/support/images/stories/drupal/drupal_login_1.jpg" alt="drupal_login_1"  /></a></em></li>
<li>Type in your <strong>username and password</strong> that you set up for the administrator. <em>Note: If you just finished installing Drupal, you may already be logged in and can skip this step</em>.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/drupal/drupal_login_2.jpg"><img src="//cdn.inmotionhosting.com/support/images/stories/drupal/drupal_login_2.jpg" alt="drupal_login_2"  /></a></li>
<li>Click <strong>Log in</strong> and now you will see your Drupal Admin Dashboard<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/drupal/drupal_login_3.jpg"><img src="//cdn.inmotionhosting.com/support/images/stories/drupal/drupal_login_3.jpg" alt="drupal_login_3"  /></a></li>
</ol>
<p>You have successfully logged into the Drupal 7 admin dashboard. You may want to proceed to our next class entitled <a href="/support/edu/drupal-7/working-with-content">Working with Content in Drupal 7</a>.For more information on this course please visit <a href="/support/edu/drupal-7/getting-started">Installing and Getting Started with Drupal 7</a>.</p>
<p>If you need further assistance, please feel free to <a href="/support/community-support/">ask a question on our support center</a>.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 5: How to log into the Drupal 7 Administrator Dashboard</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 4: <a href='/support/edu/drupal-7/getting-started/initial-configuration-of-drupal-installation'>Manually install Drupal 7 - Part 2/2 - Initial Configuration</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/drupal-7/getting-started/how-to-log-into-the-drupal-admin-dashboard&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/drupal-7/getting-started/how-to-log-into-the-drupal-admin-dashboard'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yMDEmaWQ9MTE1NiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="18b3c56b7b35bf0fdacbe739f8b12f88" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/84d06c2b58539cfa2f1c063e6dc40c76?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/84d06c2b58539cfa2f1c063e6dc40c76'>Umar</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-22 8:37 am</div>
				                <div><p>I create a custom theme using drupal 7 when i logout who can i login again i try all things like www.mydomainname.com/user and www.mydomainname.com/q=user but i canot find admin login form. please help me.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16579);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-22 8:58 am</div>
				                <div>Hello Umar,<br />
<br />
Be sure you have the question mark in the URL when using http://example.com/?q=user<br />
<br />
Other than that, the URL should work and present a login section. If not, then you may have done something in the theme to prevent it. <br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16581);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-08 9:55 pm</div>
				                <div><p>http://localhost/drupal/admin</p>
<p>http://localhost/drupal/?q=admin</p>
<p>a password to log in is exactly but i can't login.</p>
<p>Hope your replying. Thanks!</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19330);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-01-09 2:38 pm</div>
				                <div>Hello hophuong,<br />
<br />
Thank you for your question. If your password/username combination is not working in Drupal 7, you may have to <a href="https://www.drupal.org/node/1023428" target="_blank">reset your Admin Password</a>.<br />
<br />
If you have any further questions, feel free to post them below.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(19360);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
