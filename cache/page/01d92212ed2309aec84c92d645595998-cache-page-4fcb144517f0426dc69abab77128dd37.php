<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:76269:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/joomla-25/setup-virtuemart-shipping" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-05-28T16:35:48-07:00" />
  <meta name="keywords" content="virtuemart joomla 2.5 shipping" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="VirtueMart Shipping is handled by Joomla plugins. VM - Shipment, By weight, ZIP and countries is the default shipping plugin for VirtueMart, and we'll walk you through its setup steps in this tutorial." />
  <title>How to setup VirtueMart Shipping - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/joomla-25/setup-virtuemart-shipping" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:82638fae754a9061abd0434b20211cbd -->
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to setup VirtueMart Shipping</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to setup VirtueMart Shipping									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>19,446</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: May 1, 2012'><span style='color:#606060;'>Published:</span> May 28, 2015</div>
							...
							<div style='clear:both;'></div>
								...
								<p>VirtueMart includes one option by default to handle shipping, <strong>VM - Shipment, By weight, ZIP and countries</strong>. This shipping module allows you to set shipping prices based upon the weight of the order and which zip code / country the order is being shipped to. In this tutorial, we will walk you through the steps for setting up a shipping option for products under 10 pounds.</p>
<h2>To configure VM - Shipment, By weight, ZIP and countries:</h2>
<ol class="article_list">
<li><a href="/support/edu/joomla-25/getting-started/how-to-log-into-dashboard">Log into your Joomla Dashboard</a></li>
<li>In the top menu, hover over <strong>Components</strong> and click <strong>VirtueMart</strong></li>
<li>In the left menu, click <strong>Shop</strong> and then click <strong>Shipment Methods<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/virtuemart-shipping/under-shop-click-shipment-methods.gif"><img  alt="under-shop-click-shipment-methods" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/virtuemart-shipping/under-shop-click-shipment-methods.gif" /></a></strong></li>
<li>Click <strong>New</strong> in the top right menu</li>
<li>Fill out the details under the <strong>Shipment Method Information</strong>, and then click <strong>Save</strong> in the top right menu. We entered the following details:<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/virtuemart-shipping/fill-out-shipment-method-information.gif"><img  alt="fill-out-shipment-method-information" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/virtuemart-shipping/fill-out-shipment-method-information.gif" /></a><br />
<table class="article_table">
<tbody>
<tr><th>Shipment Name</th>
<td>Standard Shipping (under 10 pounds)</td>
</tr>
<tr><th>Published</th>
<td>Yes</td>
</tr>
<tr><th>Shipment Description</th>
<td>This shipping method is only available for orders 10 pounds or less.</td>
</tr>
<tr><th>Shipment Method</th>
<td>VM - Shipment, By weight, ZIP and countries</td>
</tr>
</tbody>
</table>
</li>
<li>Click the <strong>Configuration</strong> tab, and then fill out the details below and click <strong>Save &amp; Close</strong> in the top right menu. We used the following settings:<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/virtuemart-shipping/fill-out-shipment-configuration-settings.gif"><img  alt="fill-out-shipment-configuration-settings" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/virtuemart-shipping/fill-out-shipment-configuration-settings.gif" /></a><br />
<table class="article_table">
<tbody>
<tr><th>Lowest Weight</th>
<td>0</td>
</tr>
<tr><th>Heights Weight</th>
<td>10</td>
</tr>
<tr><th>Weight Unit</th>
<td>Pounds</td>
</tr>
<tr><th>Minimum number of products</th>
<td>1</td>
</tr>
<tr><th>Maximum number of products</th>
<td>100</td>
</tr>
<tr><th>Minimum order amount</th>
<td>.01</td>
</tr>
<tr><th>Maximum order amount</th>
<td>1000</td>
</tr>
<tr><th>Shipment Cost</th>
<td>5.00</td>
</tr>
<tr><th>Package Fee</th>
<td>0</td>
</tr>
</tbody>
</table>
</li>
<li>When you test your online store, you will now see your <strong>new VirtueMart Shipping option</strong> available! As we setup our shipping option for orders 10 pounds and less, be sure your order weight matches the shipping you just created during your testing or else it won't be available.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/virtuemart-shipping/new-shipping-option-is-now-available.gif"><img  alt="new-shipping-option-is-now-available" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/virtuemart-shipping/new-shipping-option-is-now-available.gif" /></a></li>
</ol> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/joomla-25/setup-virtuemart-shipping&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/joomla-25/setup-virtuemart-shipping'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD04OSZpZD00MjAmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="ba0152f2d7758a814f280a132b2e4b38" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/9594d50809a8200c345daab1f14340a3?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/9594d50809a8200c345daab1f14340a3'>YANIV</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-31 1:56 am</div>
				                <div><p>HI</p>
<p>IN MY SHOP I HAVE CATEGORY FREE-SHIPPING&nbsp;</p>
<p>ALL I &nbsp;NEED&nbsp;</p>
<p>IN THE END ACCOUNT IF THE ITEM HAVE CATEGORY FREE-SHIPPING&nbsp;</p>
<p>THE COST FOR SHIPPING IS 0&nbsp;</p>
<p>IT FOR ALL ITEM THAT HAVE CATEGORY FREE-SHIPPING&nbsp;</p>
<p>HOW CAN I DO THAT ?</p>
<p>THANK YOU&nbsp;</p>
<p>YANIV&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11015);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-31 9:57 am</div>
				                <div>Hello YANIV,<br />
<br />
Thank you for your question. I found a helpful solution in the Official VirtueMart forums, <a href="http://forum.virtuemart.net/index.php?topic=71811.0" target="_blank" >here</a> is a link to the post.<br />
<br />
If you have any further questions, feel free to post them below.<br />
Thank you,<br />
<br />
-John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(11019);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-15207'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/6361a6b23e3854fe943ea6cdc7935bb2?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/6361a6b23e3854fe943ea6cdc7935bb2'>Benjamin Esfandi</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-18 2:22 pm</div>
				                <div><p>Hey John-Paul,</p>
<p>I offer free shipping on orders over $75 but don't know how to remove shipping cost in checkout screen on the orders that qualify. &nbsp;Would you be able to help or point me in a direction?</p>
<p>Thank you,</p>
<p>Ben</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15207);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-18 2:59 pm</div>
				                <div>Hello Benjamin,<br />
<br />
Thanks for the question.  As per this <a href="http://forum.virtuemart.net/index.php?topic=104783.0" rel="nofollow" target="_blank">forum post</a>, it appears to be in the VirtueMart configuration under Edit Store > Store Information > Minimum Amount for Free Shipping.<br />
<br />
I hope that helps to answer your question!<br />
<br />
Kindest regards<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15208);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-23658'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/2679d0a33a96437c88bb46fe48bc6284?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/2679d0a33a96437c88bb46fe48bc6284'>edgar sotero estor</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-05-24 7:39 pm</div>
				                <div><p>I have some issue with regards to shipping, My client wanted to make the shipping visible in the cart section like when the user enter certain quantity it then mulply that quantity on the unit price. The total amount will then be multiplied to a certain percentage and add a certain amount depending on the number of production day the user choose.. is this possible in virtue mart.. thanks</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23658);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-05-27 12:28 am</div>
				                <div>Hello Edgar,<br />
<br />
Your request seems to be much more complex than what a normal virtuemart installation would provide. You may be able to get with a virtuemart developer to have this done for you. I apologize that I do not have a better answer for your situation.<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23720);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
