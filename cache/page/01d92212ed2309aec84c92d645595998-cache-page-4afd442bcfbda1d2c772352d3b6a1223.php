<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:57534:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/phplist/phplist-error-smtp-error-data-not-accepted-smtp-server-error" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, While I understand why you removed the specific information, there is very little I can tell you because that information is not there. That is t..." />
  <title>PHPlist error - SMTP Error: Data not accepted. SMTP server error: | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/phplist/phplist-error-smtp-error-data-not-accepted-smtp-server-error" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:0d886473657fe9042e19754bfe1b98a6 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '200.18.248.253']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>PHPlist error - SMTP Error: Data not accepted. SMTP server error:</h1>
		<div style='margin-bottom:20px; margin-top:10px; clear:both; color:#6e6e6e;'>Category: <a href='/support/community-support/phplist'>Phplist</a></div>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2014-10-06 4:34 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>4,845</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>We are using a locally hosted copy of phpList and attempting to send out newsletter campaigns. While testing our newsletter (before sending it to customers) we are running into the above error. We have been using phpList with another hosting company (register.com) for several months with no issues. Here is a cut &amp; paste of my config file (I have removed all of my account information) for review.::<br />
<br />
&lt;?php<br />
<br />
/*<br />
...
*<br />
*<br />
* The minimum requirements to get phpList working are in this file.<br />
* If you are interested in tweaking more options, check out the config_extended.php file<br />
* or visit http://resources.phplist.com/system/config<br />
*<br />
* ** NOTE: To use options from config_extended.php, you need to copy them to this file **<br />
*<br />
==============================================================================================================<br />
<br />
*/<br />
<br />
# what is your Mysql database server hostname<br />
$database_host = &quot;192.168.1.81&quot;;<br />
<br />
# what is the name of the database we are using<br />
$database_name = &quot;dbname&quot;;<br />
<br />
# what user has access to this database<br />
$database_user = &quot;webuser&quot;;<br />
<br />
# and what is the password to login to control the database<br />
$database_password = 'dbpassword';<br />
<br />
$pageroot = '/newsletter';<br />
$adminpages = '/newsletter/admin';<br />
<br />
# if you have an SMTP server, set it here. Otherwise it will use the normal php mail() function<br />
## if your SMTP server is called &quot;smtp.mydomain.com&quot; you enter this below like this:<br />
##<br />
##     define(&quot;PHPMAILERHOST&quot;,'smtp.mydomain.com');<br />
<br />
define(&quot;PHPMAILER&quot;,1);<br />
define(&quot;PHPMAILERHOST&quot;,'SMTP.ADDRESS.COM');<br />
$phpmailer_smtpuser = 'User@Domain.com';<br />
$phpmailer_smtppassword = 'MagicPassword!';<br />
#define(&quot;PHPMAILER_SECURE&quot;,'ssl');<br />
define('PHPMAILERPORT',25);<br />
<br />
# if test is true (not 0) it will not actually send ANY messages, but display what it would have sent<br />
# this is here, to make sure you edited the config file and mails are not sent &quot;accidentally&quot;<br />
# on unmanaged systems<br />
<br />
define (&quot;TEST&quot;,0);<br />
<br />
/*<br />
==============================================================================================================<br />
*<br />
* Settings for handling bounces<br />
*<br />
* This section is OPTIONAL, and not necessary to send out mailings, but it is highly recommended to correctly<br />
* set up bounce processing. Without processing of bounces your system will end up sending large amounts of<br />
* unnecessary messages, which overloads your own server, the receiving servers and internet traffic as a whole<br />
*<br />
==============================================================================================================<br />
*/<br />
<br />
# Message envelope.<br />
#<br />
# This is the address that most bounces will be delivered to<br />
# Your should make this an address that no PERSON reads<br />
# but a mailbox that phpList can empty every so often, to process the bounces<br />
<br />
$message_envelope = 'User@Domain.com';<br />
<br />
# Handling bounces. Check README.bounces for more info<br />
# This can be 'pop' or 'mbox'<br />
$bounce_protocol = 'pop';<br />
<br />
# set this to 0, if you set up a cron to download bounces regularly by using the<br />
...
# commandline<br />
define (&quot;MANUALLY_PROCESS_BOUNCES&quot;,1);<br />
<br />
# when the protocol is pop, specify these three<br />
$bounce_mailbox_host = 'POP.ADDRESS.COM';<br />
$bounce_mailbox_user = 'User@Domain.com';<br />
$bounce_mailbox_password = 'MagicPassword!';<br />
<br />
# the &quot;port&quot; is the remote port of the connection to retrieve the emails<br />
# the default should be fine but if it doesn't work, you can try the second<br />
# one. To do that, add a # before the first line and take off the one before the<br />
# second line<br />
$bounce_mailbox_port = &quot;110/pop3/notls&quot;;<br />
#$bounce_mailbox_port = &quot;110/pop3&quot;;<br />
<br />
# it's getting more common to have secure connections, in which case you probably want to use<br />
#$bounce_mailbox_port = &quot;995/pop3/ssl/novalidate-cert&quot;;<br />
<br />
# when the protocol is mbox specify this one<br />
# it needs to be a local file in mbox format, accessible to your webserver user<br />
$bounce_mailbox = '/var/mail/listbounces';<br />
<br />
# set this to 0 if you want to keep your messages in the mailbox. this is potentially<br />
# a problem, because bounces will be counted multiple times, so only do this if you are<br />
# testing things.<br />
$bounce_mailbox_purge = 1;<br />
<br />
# set this to 0 if you want to keep unprocessed messages in the mailbox. Unprocessed<br />
# messages are messages that could not be matched with a user in the system<br />
# messages are still downloaded into phpList, so it is safe to delete them from<br />
# the mailbox and view them in phpList<br />
$bounce_mailbox_purge_unprocessed = 1;<br />
<br />
# how many bounces in a row need to have occurred for a user to be marked unconfirmed<br />
$bounce_unsubscribe_threshold = 5;<br />
<br />
# add spamblock<br />
# if you set this to 1, phplist will try to check if the subscribe attempt is a spambot trying to send<br />
# nonsense. If you think this doesnt work, set this to 0<br />
# this is currently only implemented on the subscribe pages<br />
define('USE_SPAM_BLOCK',1);<br />
<br />
# notify spam<br />
# when phplist detects a possible spam attack, it can send you a notification about it<br />
# you can check for a while to see if the spam check was correct and if so, set this value<br />
# to 0, if you think the check does its job correctly.<br />
# it will only send you emails if you have &quot;Does the admin get copies of subscribe, update and unsubscribe messages&quot;<br />
# in the configuration set to true<br />
define('NOTIFY_SPAM',1);<br />
<br />
# When only user is unconfirmed when consecutive bounces are over the threshold, 'mark all users<br />
# confirmed' will cause a lot of useless bouncing (email that is, not pogo). Its better to blacklist<br />
# the address so phplist will never try again. Default on.<br />
define('BLACKLIST_EMAIL_ON_BOUNCE', 1);<br />
<br />
# ---------------------------------------------------------------------------------<br />
# Settings for the Mailqueue and how many messages are to be sent within a time period.<br />
# ---------------------------------------------------------------------------------<br />
<br />
# batch processing disabled:<br />
define(&quot;MAILQUEUE_BATCH_SIZE&quot;,0);<br />
<br />
# Batch_period is not effective when batch processing is disabled:<br />
# define(&quot;MAILQUEUE_BATCH_PERIOD&quot;,3600);<br />
<br />
# Amount of pause between messages (in seconds). Can be a decimal fraction (0.5 to be a half second)<br />
define('MAILQUEUE_THROTTLE',4.86);<br />
<br />
# Enables the Advanced bounce handling routines.<br />
define('USE_ADVANCED_BOUNCEHANDLING',1);<br />
<br />
define(&quot;PLUGIN_ROOTDIR&quot;,&quot;plugins&quot;);</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_5750' id='upvote_answer_5750' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='5750' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_5750').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_5750' id='downvote_answer_5750' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='5750' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_5750').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
While I understand why you removed the specific information, there is very little I can tell you because that information is not there. That is the information that makes or breaks the code. If any of that information is incorrect, it will not work. However I will do the best I can.<br />
<br />
What I can see, is that there may be an error in your port number. If using SSL, then you will not use port 25, but 465. Also, I see you are using an IP address as the host. When the hosting account and the mail functions are on the same server, it is best to use 'localhost' as the host name instead of a full IP address.  <br />
<br />
That may help you. If not, and you are one of our customers, then you will want to contact <a href=http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support">Live Support</a> so you can give them the specific private information you did not show here.<br />
<br />
Kindest Regards,<br />
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_5750').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_5750' id='form_comment_on_answer_5750' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/phplist/phplist-error-smtp-error-data-not-accepted-smtp-server-error&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/phplist/phplist-error-smtp-error-data-not-accepted-smtp-server-error'></div>
<script type='text/javascript'>
  (function() {
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
                                ...
                                <h3>Related Articles</h3><a target='_blank' href='http://inmotionhosting.com/support/302-disable-browser-resize-in-phplist'>302: Disable browser resize in phpList</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/301-process-bounces-from-gmail-in-phplist'>301: Process bounces from Gmail in phpList</a><br/><br />
		</div>
