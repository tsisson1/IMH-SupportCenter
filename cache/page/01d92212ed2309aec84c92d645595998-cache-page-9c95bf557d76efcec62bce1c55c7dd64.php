<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:42917:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/tools/domain-checker" />
  ...
  <link href="http://www.inmotionhosting.com/support/tools/domain-checker?domain=http://www.astoria.com.qa/" rel="canonical" />
  <link href="http://www.inmotionhosting.com/support/tools/domain-checker" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:6614d55152d43890a1eb0e9dcabaf998 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '178.152.225.6']);
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Domain Checker</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	...
	<form method='get'>
		<strong style='padding-right:20px;'>Domain:</strong> <input type='text' name='domain' id='domain' style='width:300px;' value='http://www.astoria.com.qa/' /><input type='submit' value='check domain' class='btn btn-primary' />
	...
	<h2 style='border-bottom:1px solid #ddd;'>Whois and DNS Checks</h2>
			...
			<div>It appears the domain name www.astoria.com.qa is not registered. <a href='/support/domain-names/registrations-and-transfers/registering-a-new-domain-name' target='_blank'>Have you registered the domain yet</a>?</div>
		
				<div class='alert alert-error'>At this time, this tool does not work with sub domains. For example "www" is a subdomain, and will not work with this tool. If you want to instead search for <strong>astoria.com.qa</strong>, <a href='/support/tools/domain-checker?domain=astoria.com.qa'>click here</a>.</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP2RvbWFpbj1odHRwOi8vd3d3LmFzdG9yaWEuY29tLnFhLyZvcHRpb249Y29tX2NvbnRlbnQmY2F0aWQ9NDcwJmlkPTQ3MCZ2aWV3PWNhdGVnb3J5Jkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="2505ca4a8561399a376e8a2a8c63ee6f" value="1" />	</div>
	</form>
<!-- <br />
