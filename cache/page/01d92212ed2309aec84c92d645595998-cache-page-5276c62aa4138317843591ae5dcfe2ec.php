<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:61572:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-3/server-settings/error-reporting" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-01-11T15:13:39-08:00" />
  <meta name="keywords" content="joomla 3.0 hide error reporting" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="In this tutorial, we'll review the Error Reporting setting in Joomla 3.0, which allows you to control the level of information displayed in error messages." />
  <title>Joomla 3.1 Error Reporting - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-3/server-settings/error-reporting" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:850d57277b54afd259ffc7d938d5b6a1 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '2.239.82.184']);
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>7,538</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Aug 31, 2012'><span style='color:#606060;'>Published:</span> Jan 11, 2016</div>
...
<button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('what-is');">What is Error Reporting?</button>
<button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('options');">Error Reporting Options</button>
<button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('testing-results');">Testing Results</button>
<button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('change-setting');">Change Error Reporting Settings</button>
</div>

<p>One of <a href="/support/edu/joomla-3/server-settings">Joomla 3.0's Server Settings</a> is <strong>Error Reporting</strong>. Jooma gives the follow description for this setting:</p>

<a name="what-is"></a>
<h2>What is Error Reporting?</h2>
<p><strong>Error Reporting</strong><br /><em>Select the appropriate level of reporting from the drop down list. See the Help Screen for full details.</em><br /><br />If you click the help button on the page, it unfortunately does not give any information yet as this time.</p>


<a name="options"></a>
<h2>What options are available for Error Reporting?</h2>
<p>The following options are available for Error Reporting:</p>
<ol>
...
<h2>Our Testing of the Error Reporting Setting</h2>
<p>To test the different options that are available for Error Reporting, we created a simple syntax error in the mod_login module by removing a ; from the PHP code. We then went through the various <strong>Error Reporting</strong> settings to see what type of error would be reported. Here are our findings:</p>
<table class="article_table">
<tbody>
<tr>
<th>System Default</th>
<td><b>Parse error</b>:  syntax error, unexpected T_REQUIRE in <b>/home/bradm/public_html/github2/modules/mod_login/mod_login.php</b> on line <b>21</b></td>
</tr>
<tr>
<th>None</th>
<td></td>
...
<p>As you can see in the table above, all settings showed the same error message, except the <strong>none</strong> setting. As the <em>none</em> setting implies, no error messages are shown on the screen.</p>


<a name="change-setting"></a>
<h2>To change the Joomla 3.0 Error Reporting Setting</h2>
...
<li>In the tabbed menu, click the <strong>Server</strong> tab</li>
<li>Find the <strong>Error Reporting</strong> setting under the <em>Server Settings</em> heading. Change the value as needed, and then click the <strong>Save</strong> button in the top left of the page.</li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 3: Joomla 3.1 Error Reporting</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 4: <a href='/support/edu/joomla-3/server-settings/force-ssl-setting'>How to Force SSL in Joomla 3.1</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-3/server-settings/error-reporting&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-3/server-settings/error-reporting'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNTgmaWQ9MTczMCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="31aebd9f4f7d3338f4e915f669987477" value="1" />	</div>
	</form>
<!-- <br />
        ...
        <tr><td colspan='2'><h4>Mail Settings</h4></td></tr>  <tr >
			...
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/joomla-3/partial-backend-of-site-not-visable-after-backup-and-restoration?tsrc=rsbraq'>Partial backend of site not visable after backup and restoration</a>
                                </div>
