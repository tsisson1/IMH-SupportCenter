...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/email/email-troubleshooting/missing-email" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-10-22T19:27:19-07:00" />
  <meta name="keywords" content="missing email arrive expect receive" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="If you are expecting an email that fails to arrive, check this article for troubleshooting tips." />
  <title>An email I was expecting did not arrive - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/email/email-troubleshooting/missing-email" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:d4d41790ba1da92f795c62286e1d68a0 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '80.113.167.1']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>An email I was expecting did not arrive</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															An email I was expecting did not arrive									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>3,731</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 29, 2013'><span style='color:#606060;'>Published:</span> Oct 22, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<div>In the world of email there are various issues and problems that can occur. This particular article guides you through troubleshooting an issue where you are expecting an email yet it does not arrive. There can be various causes and the issue can be from the sending side, the route in between the sender and your email hosting server, or your email server itself. While you cannot do anything about the sender's side or the route in between, we do have some tips to help you rule out or find the issue on your side. <br /><br />
  <div class="alert" style="color:red">Note that this article assumes you are using InMotion Hosting servers for your email.</div>
</div>
<h2>Test Message</h2>
<div>The first test is to check and ensure your email account is working in general and is receiving email properly. The easiest way to do this is to send yourself a test email. It is best to send the test message from a third party email service such as Yahoo or Gmail, but you can use any InMotion email account if you do not have a third party account. Optionally, you can have a friend send you a test message.</div>
<div><br />If your email account does not receive the test message the sending email account should receive a notice known as a bounceback. The bounceback message will contain information on why it was not received properly. We have an article that lists some of the more common reasons <a href="/support/email/email-troubleshooting/what-to-do-if-an-email-is-returned">why emails are returned</a>. If you do not receive the email and the sending account does not receive a bounceback email, you will want to <a href="/support/website/website-troubleshooting/how-to-get-great-technical-support">contact our Live Support</a> department for further investigation.<br /><br /></div>
<h2>Check the IP Blacklists</h2>
<div>If your email address is receiving emails in general, you may want to check the IP address to see if it is being blacklisted by spam filtering services. You will need the sender's mail IP address to perform this test. Once you have the IP address, you can check it using our <a href="/support/tools/blacklist-check">Online IP BLacklist Checker</a>. If the IP address is being blacklisted, either the sender or the sender's host will need to contact the companies involved to get the IP off the list. It is very common for mail servers to be blacklisted and removed regularly from the filtering services.</div>

<h2>Check the MX Records</h2>
<div>If the MX records are incorrect, this can affect the way email is sent and received. You can check the MX records for your domain by using the MX Entry tool in the cPanel. Your MX records should appear at the bottom of the page. If you do not see any records, there should be a message stating it will default to the domain's A record, which is fine if you are using InMotion Hosting for your email. If your MX records are incorrect, you can either delete and recreate them, or <a href="/support/website/website-troubleshooting/how-to-get-great-technical-support">contact our Live Support team</a> for additional help.</div>

<h2>Did the Email Bounce Back?</h2>
<div>There are many reasons an email will be returned, or bounce back to a sender. Use the <strong>Bounce Back Parser tool</strong> to troubleshooting these returned emails:<br>
<strong><a href="http://www.inmotionhosting.com/support/tools/bounce-back-parser" target="_blank" >Bounceback Parser Tool</a></strong> </div>

<h2>Contact our Live Support Department</h2>
<div>If you check all the above and everything appears to be normal, it may be time to check with our <a href="/support/website/website-troubleshooting/how-to-get-great-technical-support">Live Support team</a>. They have the ability to check into server logs to see if there was an attempted delivery. Even failed attempts are logged, so if the email contacted our servers for any reason, there will be a record of it. If there is no record of a delivery attempt, this means the email had issues either from the sending server or somewhere along the route. Troubleshooting will then need to take place starting on the sender's side.</div>  
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/email/email-troubleshooting/missing-email&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/email/email-troubleshooting/missing-email'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NSZpZD04MTUmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
