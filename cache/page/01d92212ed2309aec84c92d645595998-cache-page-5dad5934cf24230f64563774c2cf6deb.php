...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/cpanel/bybass-firewalls-with-cpanel-proxy-subdomains" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-02-04T21:38:23-08:00" />
  <meta name="keywords" content="cpanel whm webmail proxy access firewall" />
  <meta name="author" content="Jacob Nicholson" />
  <meta name="description" content="In this article I'm going to review connecting to your cPanel account's various services, when there is a firewall on your computer or network not allowing a normal connection over the standard ports." />
  <title>Bypass firewalls with cPanel proxy subdomains - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/cpanel/bybass-firewalls-with-cpanel-proxy-subdomains" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:d73d37306b258d8214b70ef6fc3a46a3 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-22']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '190.80.8.31']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Bypass firewalls with cPanel proxy subdomains</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Bypass firewalls with cPanel proxy subdomains									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>14,247</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 28, 2013'><span style='color:#606060;'>Published:</span> Feb 4, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>In this article I'm going to review connecting to your cPanel account's various services, when there is a firewall on your computer or router not allowing a normal connection over the standard ports.</p>
...
<p>Below I'll go over the default ports used to access <a href="http://www.inmotionhosting.com/support/website/cpanel/cpanel-control-panel" target="_blank">cPanel</a>, <a href="http://www.inmotionhosting.com/support/edu/cpanel/cpanel-email/logging-into-webmail" target="_blank">webmail</a>, and <a href="http://www.inmotionhosting.com/support/edu/whm/creating-and-managing-accounts/log-into-whm" target="_blank">WHM</a> (Web Host Manager), and then I'll also cover the proxy subdomains that you can use to access these services when your firewall is blocking their normal ports.</p>
<h2>cPanel proxy subdomains</h2>
<p>The following table shows the standard port that the various cPanel services operate under, as well as the secure port that they can use when accessing it over an SSL encrypted <strong>https://</strong> connection. The proxy subdomain for each service will be a URL you can use to access the particular service over the standard port 80 that should be open in your firewall if you're having issues accessing it otherwise.</p>
<p class="alert">Be sure to replace <strong>example.com</strong> with your own domain name when using any of the cPanel proxies.</p>
<table class="article_table">
<tbody>
<tr><th>Service</th>
<td>Standard port</td>
<td>Secure port</td>
<td>Proxy subdomain</td>
</tr>
<tr><th>cPanel</th>
<td>2082</td>
<td>2083</td>
<td><strong>cpanel</strong>.example.com</td>
</tr>
<tr><th>Webmail</th>
<td>2095</td>
<td>2096</td>
<td><strong>webmail</strong>.example.com</td>
</tr>
<tr><th>WHM (Only on VPS and dedicated servers)</th>
<td>2086</td>
<td>2087</td>
<td><strong>whm</strong>.example.com</td>
</tr>
</tbody>
</table>
<p>You should now understand why you might be having issues trying to connect to various cPanel services with the default ports that they use on the server. Using the cPanel proxy domain examples you should be able to still access the particular service even behind a firewall that is blocking the standard ports.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/cpanel/bybass-firewalls-with-cpanel-proxy-subdomains&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/cpanel/bybass-firewalls-with-cpanel-proxy-subdomains'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD01NyZpZD01MjQmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="f23213019632c8aa4fc8097688070d39" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/0610030816c5008f0d7440dd0a71250c?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/0610030816c5008f0d7440dd0a71250c'>Pedro</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-09 9:37 am</div>
				                <div>I work in a company that blocked ports 2095 and 2096. I need to use webmail (the provider is JustHost.com), and accesing through the proxy webmail.example.com or whm.example.com, and  in both cases I can access, but receiving the message "there is no website configured at this address". What  I can do? </div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9543);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-09 9:57 am</div>
				                <div>Hello Pedro,<br />
<br />
Thank you for your comment. Your host (justhost) will have to setup a cPanel proxy for webmail; which allows you to access webmail over port 80 (the standard internet port). <br />
<br />
This is setup by default on all of InMotion's servers.<br />
<br />
If you have any further questions, feel free to post them below.<br />
Thank you,<br />
<br />
-John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9544);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-28123'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/6350f785d9c6492faf7697acd102cd36?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/6350f785d9c6492faf7697acd102cd36'>Srinivas</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-03 9:42 am</div>
				                <div><p>I am unable to open cpanel websites as they are blocked in our institute, can u suggest me an proxy server</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28123);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-03 12:17 pm</div>
				                <div>Hello Srinivas,<br />
<br />
Have you tried to go to http://cpanel.yourdomain.com? This URL uses port 80 instead of 2082. If you get a page not found then you will need to <a href="/support/www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support">contact our support department</a> to have it enabled for you.<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28129);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
