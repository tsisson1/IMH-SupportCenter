<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:64688:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/tiki-wiki/getting-started-tiki-wiki/install-tikiwiki-manually" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-12-07T21:59:50-08:00" />
  <meta name="keywords" content="manually installing TikiWiki manual install setup set up" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="This article will walk through the steps in manually installing TikiWiki on your server." />
  <title>Installing TikiWiki manually - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/tiki-wiki/getting-started-tiki-wiki/install-tikiwiki-manually" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:1e8e1ebd1c087967c8d8c137b7cba212 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Installing TikiWiki manually									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>3,724</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Dec 7, 2012'><span style='color:#606060;'>Published:</span> Dec 7, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>TikiWiki is a free open source program designed to make a Wiki site on your server. If for whatever reason, TikiWiki cannot be installed through Softaculous, TikiWiki can be uploaded manually and installed on your server. This article will walk through the steps in setting up TikiWiki on your server.</p>
<p>The version we will be using is the <strong>CURRENT STABLE 9.2</strong> version that is available for download at the following link.</p>
<p><a href="http://sourceforge.net/projects/tikiwiki/files/Tiki_9.x_Herbig_Haro/" target="_blank"><strong>Download Tiki 9.x LTS</strong></a></p>
<p>The file that is downloaded should be called:</p>
<p><strong>tiki-9.2.zip</strong></p>
<p>Once you have downloaded the appropriate files for your TikiWiki installation, we can move forward in installing the software on your server.</p>
<h3>Installing TikiWiki manually</h3>
<ol class="article_list">
<li>If you are not installing TikiWiki on the main domain or an Addon domain, <a href="/support/website/cpanel/how-do-i-create-a-subdomain-in-my-control-panel-cpanel" target="_blank" title="click here for How to create a subdomain">Create a subdomain</a> for the TikiWiki site.</li>
<li><a href="/support/website/cpanel/how-do-i-create-a-mysql-database-in-my-control-panel-cpanel" target="_blank" title="Click here for how to create a database and user">Create a database and database user</a>.<strong> Add the database user </strong>to the database.
<p class="alert"><strong>Important!</strong> Save the Username, Password, and Database name in a notepad or other editor to reference it later. This will be needed to set up the TikiWiki program.</p>
</li>
<li><a href="/support/website/file-management/how-to-upload-a-file-using-file-manager-in-cpanel" target="_blank" title="Click here for how to upload in File Manager">Upload the tiki-9.2.zip</a> file through the cPanel and <a href="/support/website/cpanel/compressing-uncompressing-files" target="_blank" title="Click here for how to extract a zip file in File Manager">extract the file to the server</a>, or upload the contents of the tiki-9.2 folder, that was extracted to your local computer, to the directory for the subdomain <a href="/support/website/file-management/getting-started-guide-ftp" target="_blank" title="Click here for getting started with FTP">using ftp</a>.</li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/101/installing-tikiwiki-manually/install-tikiwiki-manually-1.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="install-tikiwiki-manually-1" src="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/101/installing-tikiwiki-manually/install-tikiwiki-manually-1.gif" title="Click here to view the larger image" width="100" /></a>Navigate to the domain/subdomain that as created for TikiWiki. The <strong>Welcome </strong>page should load.
<p><strong>Select the Language</strong> and <strong>Click Continue</strong>.</p>
<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/101/installing-tikiwiki-manually/install-tikiwiki-manually-2.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="install-tikiwiki-manually-2-itkiwiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/101/installing-tikiwiki-manually/install-tikiwiki-manually-2.gif" title="Click here to view the larger image" width="100" /></a>On the <strong>Read License </strong>page, read the agreement if you do not know what GNU licensing is.
<p>Otherwise, <strong>Click Continue</strong>.</p>
<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/101/installing-tikiwiki-manually/install-tikiwiki-manually-3.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="install-tikiwiki-manually-3-tikiwiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/101/installing-tikiwiki-manually/install-tikiwiki-manually-3.gif" title="Click here to view the larger image" width="100" /></a>On the <strong>Review the System Requirements </strong>page, Check if there are any system requirement errors. If the server is set up correctly everything should look like the snapshot to the right.
<p>If all the settings show green and white checks, <strong>Click Continue</strong>.</p>
<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/101/installing-tikiwiki-manually/install-tikiwiki-manually-4.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="install-tikiwiki-manually-4-tikiwiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/101/installing-tikiwiki-manually/install-tikiwiki-manually-4.gif" title="Click here to view the larger image" width="100" /></a>Next, the Set the Database Connection page should display. Here is where the database credentials that were save in step 2 will be entered.
<p><strong>Enter the Database username, password, and database name</strong>. Hostname is localhost.</p>
<p>Keep the Character set as utf-8.</p>
<p><strong>Click Continue</strong>.</p>
<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/101/installing-tikiwiki-manually/install-tikiwiki-manually-5.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="install-tikiwiki-manually-5-tikiwiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/101/installing-tikiwiki-manually/install-tikiwiki-manually-5.gif" title="Click here to view the larger image" width="100" /></a>On the install screen, keep the database engine <strong>MyISAM</strong>.
<p><strong>Click Install</strong>.</p>
<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/101/installing-tikiwiki-manually/install-tikiwiki-manually-6.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="install-tikiwiki-manually-6-tikiwiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/101/installing-tikiwiki-manually/install-tikiwiki-manually-6.gif" title="Click here to view the larger image" width="100" /></a>Now the Review the Installation page will load. This should say <strong>Installation operations executed successfully: 9956 SQL queries</strong>.
<p><strong>Click Continue</strong>.</p>
<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/101/installing-tikiwiki-manually/install-tikiwiki-manually-7.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="install-tikiwiki-manually-7-tikiwiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/101/installing-tikiwiki-manually/install-tikiwiki-manually-7.gif" title="Click here to view the larger image" width="100" /></a>On the Configure General Settings page, enter the general information for the administrator login.
<p>Keep the <strong>Secure login</strong> as <strong>Disabled</strong>. This is because, if you do not have an SSL, the login page will give an error when accessing it.</p>
<p>Enter the admin email address and <strong>Click Continue</strong>.</p>
<br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/101/installing-tikiwiki-manually/install-tikiwiki-manually-8.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="install-tikiwiki-manually-8-tikiwiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/101/installing-tikiwiki-manually/install-tikiwiki-manually-8.gif" title="Click here to view the larger image" width="100" /></a>When the <strong>Enter Your Tiki</strong> page loads, <strong>click Enter Tiki and Lock the installer (Recommended)</strong>. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/101/installing-tikiwiki-manually/install-tikiwiki-manually-9.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="install-tikiwiki-manually-9-tikiwiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/101/installing-tikiwiki-manually/install-tikiwiki-manually-9.gif" title="Click here to view the larger image" width="100" /></a>You will be directed to a <strong>Change password enforced </strong>page where you will be prompted to change your password. Leave the Old Password field as is.
<p>Enter a new password twice and <strong>click Change</strong>.</p>
<br style="clear: both;" /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/101/installing-tikiwiki-manually/install-tikiwiki-manually-10.gif"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="install-tikiwiki-manually-10-tikiwiki" src="//cdn.inmotionhosting.com/support/images/stories/edu/tikiwiki/101/installing-tikiwiki-manually/install-tikiwiki-manually-10.gif" title="Click here to view the larger image" width="100" /></a>Congratulations, TikiWiki was manually installed successfully. you can now begin creating the Wiki site. <br style="clear: both;" /></li>
</ol>
<p>This concludes this article on Installing TikiWiki manually. For more information on Getting Started with TikiWiki, please visit <a target="_blank" href="/support/edu/tiki-wiki/getting-started-tiki-wiki" title="Click here to view the courses">click here</a>.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 3: Installing TikiWiki manually</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 2: <a href='/support/edu/tiki-wiki/getting-started-tiki-wiki/installing-tikiwiki-softaculous'>Installing TikiWiki through Softaculous</a>
								</td>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/tiki-wiki/getting-started-tiki-wiki/install-tikiwiki-manually&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/tiki-wiki/getting-started-tiki-wiki/install-tikiwiki-manually'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMDUmaWQ9MjA2MSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
