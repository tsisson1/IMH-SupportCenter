...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/server-usage" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="keywords" content="%default%" />
  <meta name="description" content="Server Usage" />
  <title>Server Usage | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/server-usage" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:eb44d3aaff525a94083f4965fd89dea0 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '67.237.33.247']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Server Usage</span></li>			</ul>
		</div>
	</div>
</div>
...
Written by <a href='https://plus.google.com/114847242487896512921'>Jacob Nicholson</a>
<h1>Resolving server usage problems</h1>
<p>When your server is running slow or crashing this can be a very frustrating experience and we'd like to help. There are multiple factors that can lead to your server's usage being higher than it should be.</p>
<p>In this section we'll cover diagnostic and troubleshooting tactics that you can use to extract information from your server's running processes and logs to help better understand what is causing your server usage problems.</p>

<div class="white_box">
<h2 style="margin-top:0px;padding-top:0px;">Best practices for info gathering</h2>
<div style="margin: 5px 15px 5px 10px">
<p>These articles will guide you on ensuring that website access logging is enabled to actually catch things, and also how to setup scripts that alert you via email when there are problems.</p>

<ul>
<li><a href="/support/website/cpanel/enable-raw-access-logs-in-cpanel" target="_blank">Enabling raw access log archiving in cPanel</a></li>
<li><a href="/support/website/how-to/enable-raw-access-log-archiving-for-all-cpanel-accounts" target="_blank">Enable raw access log archiving for all cPanel accounts</a></li>
<li><a href="/support/edu/whm/304-install-munin-plugin-for-whm" target="_blank">Install Munin Service Monitor plugin for WHM</a></li>
<li><a href="/support/website/server-usage/create-server-load-monitoring-bash-script" target="_blank">Create server load monitoring bash script</a></li>
<li><a href="/support/website/server-usage/create-mysql-query-monitoring-bash-script" target="_blank">Create MySQL query monitoring bash script</a></li>
</ul>
</div></div>
...
<div class="white_box">
<h2 style="margin-top:0px;padding-top:0px;">Using logs to locate problems</h2>
<div style="margin: 5px 15px 5px 10px">
<p>This collection of articles walks you through using log files on your server to help track down and see where server issues are coming from.</p>

<ul>
<li><a href="/support/website/website-troubleshooting/determine-cause-of-server-usage-spike" target="_blank">Determine cause of server usage spike</a></li>
<li><a href="/support/website/website-troubleshooting/find-ip-address-of-malicious-user" target="_blank">Find IP address of malicious user</a></li>
<li><a href="/support/website/website-troubleshooting/locate-problematic-user-agents" target="_blank">Locate problematic user agents</a></li>
<li><a href="/support/website/server-usage/review-recent-website-requests" target="_blank">Review recent website requests</a></li>
<li><a href="/support/website/server-usage/view-level-of-traffic-with-apache-access-log" target="_blank">View level of traffic with Apache access log</a></li>
<li><a href="/support/website/server-usage/view-request-type-url-and-response-codes-apache-access-log" target="_blank">View request type, URL, and response codes from Apache access log</a></li>
<li><a href="http://www.inmotionhosting.com/support/website/server-usage/parse-archived-raw-access-logs-from-cpanel" target="_blank">Parse archived raw access logs from cPanel</a></li>
</ul>
</div></div>
<br />

<div class="white_box">
<h2 style="margin-top:0px;padding-top:0px;">Server tools to help with usage</h2>
<div style="margin: 5px 15px 5px 10px">
<p>Articles found here will help explain the built in server tools that you can use to help monitor and limit your server usage.</p>
<ul>
<li><a href="/support/website/server-usage/advanced-server-load-monitoring" target="_blank">Advanced server load monitoring</a></li>
<li><a href="/support/website/server-usage/viewing-resource-usage-with-cpu-graphs" target="_blank">Viewing resource usage with CPU graphs (Shared)</a></li>
<li><a href="/support/website/server-usage/limit-cpu-usage-of-intensive-tasks" target="_blank">Limit CPU usage of intensive tasks</a></li>
<li><a href="/support/website/server-usage/using-the-linux-top-command-in-batch-mode" target="_blank">Using the Linux top command in batch mode</a></li>
</ul>
</div></div>
<br />

<div class="white_box">
<h2 style="margin-top:0px;padding-top:0px;">Exim mail service usage</h2>
<div style="margin: 5px 15px 5px 10px">
<p>These articles cover the Exim mail service which is the MTA (Mail Transfer Agent) that handles mail deliveries on your server, and can be a common cause of server usage spikes.</p>
...
<li><a href="/support/email/fighting-spam/find-number-of-times-spamassassin-has-to-run" target="_blank">Find the number of times SpamAssassin has to run</a></li>
<li><a href="/support/email/fighting-spam/find-number-of-times-boxtrapper-has-to-run" target="_blank">Find the number of times BoxTrapper has to run</a></li>
<li><a href="/support/email/email-troubleshooting/535-incorrect-authentication" target="_blank">535 incorrect authentication</a></li>
...
<br />
<div class="white_box">
<h2 style="margin-top:0px;padding-top:0px;">Stopping malicious activity</h2>
<div style="margin: 5px 15px 5px 10px">
<p>All of these articles help explain how you can stop potential or currently happening malicious activity, which can easily lead to server usage issues.</p>

<ul>
<li><a href="/support/website/website-troubleshooting/dealing-with-spam-in-your-posts-and-comments" target="_blank">Dealing with spam in your posts and comments</a></li>
<li><a href="/support/website/website-troubleshooting/block-unwanted-users-from-your-site-using-htaccess" target="_blank">Block unwanted users from your site using .htaccess</a></li>
<li><a href="/support/website/website-troubleshooting/stopping-brute-force-and-spam-attacks" target="_blank">Stopping brute force and spam attacks</a></li>
<li><a href="/support/website/website-troubleshooting/cleaning-up-a-htaccess-hack" target="_blank">Cleaning up a .htaccess hack</a></li>
<li><a href="/support/website/website-troubleshooting/clean-up-code-injection-attack" target="_blank">Clean up a code injection attack</a></li>
<li><a href="/support/edu/wordpress/320-wordpress-comment-spam" target="_blank">WordPress comment spam clean up</a></li>
<li><a href="/support/component/content/help/disable-problematic-site-for-troubleshooting?Itemid=204" target="_blank">Disable problematic site for troubleshooting</a></li>
</ul>
</div></div>

<br />
<div class="white_box">
<h2 style="margin-top:0px;padding-top:0px;">Common server usage problems</h2>
<div style="margin: 5px 15px 5px 10px">
<p>Finally this group of articles serves as an informational collection of common things that can cause server usage problems.</p>
...
<li><a href="/support/website/website-troubleshooting/chat-software-can-cause-high-usage" target="_blank">Chat software can cause high usage</a></li>
<li><a href="/support/website/website-troubleshooting/excessive-mysql-activity" target="_blank">Excessive MySQL activity</a></li>
...
<li><a href="/support/website/general-server-setup/choosing-the-best-php-handler" target="_blank">Choosing the best PHP handler</a></li>
<li><a href="/support/website/general-server-setup/speed-up-php-with-apc" target="_blank">Speed up PHP with APC - Alternative PHP Cache</a></li>
</ul>
</div></div>

<form action="http://www.inmotionhosting.com/support/website/server-usage" method="post" name="adminForm" id="adminForm" class="form-inline">
  ...
  <table class='article_list'>
		...
		<ul><li class="pagination-start"><span class="pagenav">Start</span></li><li class="pagination-prev"><span class="pagenav">Prev</span></li><li><span class="pagenav">1</span></li><li><a href="/support/website/server-usage?start=15" class="pagenav">2</a></li><li class="pagination-next"><a title="Next" href="/support/website/server-usage?start=15" class="hasTooltip pagenav">Next</a></li><li class="pagination-end"><a title="End" href="/support/website/server-usage?start=15" class="hasTooltip pagenav">End</a></li></ul>	</div>
	</form>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD04NSZpZD04NSZ2aWV3PWNhdGVnb3J5Jkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="0f94db4f7589274c3bf51f3195ed8ceb" value="1" />	</div>
	</form>
<!-- <br />
