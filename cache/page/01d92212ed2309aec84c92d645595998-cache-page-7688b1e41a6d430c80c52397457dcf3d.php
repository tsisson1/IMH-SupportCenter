<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:55322:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/cpanel/browser-issue-with-cpanel" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Phoebus417, Sorry to hear about your cPanel login issues. I have not heard of this specific error with cPanel logins before. What is the exact err..." />
  <title>Browser issue with cpanel | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/cpanel/browser-issue-with-cpanel" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:7a6a76a81d752fc25cb4c60525461727 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box straight_bottom'>
                <h1 style='font-size:26px;'>Browser issue with cpanel</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/Phoebus417'>Phoebus417</a>
			<div>19 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-03-15 9:46 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>579</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I am having trouble logging into cpanel my browser says the server says my location is multi user?</div>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px;'>
				<div style='font-size:12px; max-width:500px; overflow:auto;'>PRIVACY ERROR: Attackers might be trying to steal your information from advanced372.inmotionhosting.com (for example, passwords, messages, or credit cards). NET::ERR_CERT_AUTHORITY_INVALID</div>
			...
			<td style='width:100px;' valign='top'>
				...
				<div class='smallgrey'>
					<a href='/support/community-support/users/Phoebus417'>Phoebus417</a><br />
					19 <a href='/support/team/points' target='_blank'>Points</a><br />
					2015-03-18 02:31 pm EST
				</div>
			</td>
		</tr>
	</table>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_6797' id='upvote_answer_6797' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='6797' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_6797').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_6797' id='downvote_answer_6797' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='6797' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_6797').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Phoebus417,<br />
<br />
Sorry to hear about your <a href="http://www.inmotionhosting.com/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">cPanel login</a> issues. I have not heard of this specific error with cPanel logins before.  What is the exact error message you are receiving?<br />
<br />
Kindest Regards,<br />
Scott M
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_6797').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_6797' id='form_comment_on_answer_6797' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>It gives the 721advancedserver.inmotionhosting.com &quot;your connection is not considered private. There are multiple users on your connection.&quot;</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>I added the entire message to my original question.</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello Phoebus417,<br />
<br />
Thank you for contacting us. I was able to see the same error, and it is due to the <a href="http://www.inmotionhosting.com/support/website/ssl/self-signed-ssl-certificate-warning">self-signed SSL on your server</a>.<br />
<br />
"<em>By default the SSL certificate that would be configured on your server would be a self-signed one, essentially meaning that it has not been issued by a Certificate Authority (CA), but instead your own server has signed the certificate as being valid.<br />
<br />
This works perfectly fine for encrypting data, but it will present you with an error or warning in your web-browser when trying to access the secure content.<br />
<br />
If you'd like to not have a self-signed SSL certificate error when accessing your server via SSL, you can read our guide on <a href="http://www.inmotionhosting.com/support/website/ssl/how-do-i-obtain-an-ssl-certificate">how do I obtain an SSL certificate</a>, as that explains how you could purchase a dedicated SSL certificate that would be issued via a Certificate Authority and not display the same warning.</em>"<br />
<br />
...
John-Paul</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/cpanel/browser-issue-with-cpanel&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/cpanel/browser-issue-with-cpanel'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="11d2132c9834543536a0dad5526669c6" value="1" />	</div>
	</form>
<!-- <br />
