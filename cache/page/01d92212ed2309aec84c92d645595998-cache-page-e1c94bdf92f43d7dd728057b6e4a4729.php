<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:65184:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/reseller/sub-accounts" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-05-20T18:59:34-07:00" />
  <meta name="keywords" content="enom subaccounts sub reseller retail imhstore imh store inmotion" />
  <meta name="author" content="John-Paul Briones" />
  <meta name="description" content="This guide explains the main differences between a Sub-Retail and Sub-Reseller accounts with eNom." />
  <title>What is the difference between eNom Sub-Retail and Sub-Reseller account in the InMotion Store? - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/reseller/sub-accounts" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:4dc3f67e2f958aab8dff2f5bad3c9c02 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															What is the difference between eNom Sub-Retail and Sub-Reseller account in the InMotion Store?									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>4,027</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Sep 18, 2013'><span style='color:#606060;'>Published:</span> May 20, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								The <strong>InMotion Store</strong> can be accessed at <a href="http://imhstore.com/">http://imhstore.com</a> and allows you to buy domains via eNom. As a <a href="/support/reseller">Reseller</a>, eNom sub-accounts let you manage domains for your customers. There are 2 options when creating sub-accounts: <strong>Sub-Retail</strong>, and <strong>Sub-Reseller</strong>. Every account is setup as a Sub-Retail account by default; which, is still a reseller. Here are some of the main differences between the accounts types, as per their <a href="http://www.enom.com/help/faq-subaccounts.aspx" target="_blank" >FAQ page</a>.<br>
<br>
<p class="alert" style="color:red">You can change it to a Sub-Reseller account, but once it is changed it CANNOT be changed back. If you are still interested, please <a href="/support/website/website-troubleshooting/how-to-get-great-technical-support">contact Live Tech Support</a> and request the upgrade.</p>
<table border="1" bordercolor="#" style="background-color:" width="100%" cellpadding="3" cellspacing="3" class="table table-bordered table-striped">
  <tr>
    <td><strong>Distinctions</strong></td>
    <td><strong>Sub-Retail</strong></td>
    <td><strong>Sub Reseller</strong></td>
  </tr>
  
  <tr>
    <td>How to Pay</tdogin>
    <td><ul><li style="text-align: left;">Pay for each transaction from the credit card you have setup in the account.</li></ul></td>
    <td><ul><li style="text-align: left;">Add money to the account, then use these "credits" to pay.</li></ul></td>
  </tr>
  
  <tr>
    <td>How much Admin Control will you get?</td>
    <td><ul><li style="text-align: left;">You can perform almost any action in a retail sub-account.</li></ul></td>
    <td><ul><li style="text-align: left;">There are actions you can perform only if you log in to the subaccount directly. You can’t perform actions such as purchases and viewing credit card information if you log in from the parent account.</li></ul></td>
  </tr>
  
  <tr>
    <td>Benefits</tdogin>
    <td><ul><li style="text-align: left;">Do not have to keep an account balance with eNom (IMH Store)</li></ul></td>
    <td><ul><li style="text-align: left;">You are able to use the API which allows our customer's clients to purchase a domain instantly through the customer's site.</li><li style="text-align: left;">The prices are lower for a sub-reseller account than for a sub-retail.</li></ul></td>
  </tr>
  
  <tr>
    <td>Drawbacks</tdogin>
    <td><ul><li style="text-align: left;">Have to purchase each domain on behalf of their customer through the imhstore site.</li><li style="text-align: left;">The prices are higher for a sub-retail account than for a sub-reseller.</li></ul></td>
    <td><ul><li style="text-align: left;">Having to keep an account balance on file at eNom.</li>
    <li style="text-align: left;">Not being able to change back to Sub-Retail if that is desired. (A New account would have to be created if they wanted to go back to Sub-Retail)</li></ul></td>
  </tr>
</table> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/reseller/sub-accounts&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/reseller/sub-accounts'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MjQmaWQ9Mjg1MiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="c23f1fadf3cadc97eeeda58796ab9ca4" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/2b415b60f36d7651820ec18d2513e3b2?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/2b415b60f36d7651820ec18d2513e3b2'>farha</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-06 8:06 am</div>
				                <div><p>do have demo for reseller</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(18223);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-08 12:04 pm</div>
				                <div>Hello Farha,<br />
<br />
While we do not have a reseller demo on our servers, it is very much like the <a href="http://whm.demo.cpanel.net/">WHM demo</a> that cPanel provides. Reseller accounts do not allow for root access, so they will not have as many functions available as a WHM account with root, but that is the only difference there. Resellers also have access to our IMH store where you can sign up to be a domain reseller for extra income as well.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(18252);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-22919'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='https://lh4.googleusercontent.com/-dTKC06Dk9uc/AAAAAAAAAAI/AAAAAAAAHxM/jfzj2C73m4U/photo.jpg?sz=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='/support/community-support/users/adelapuente'>adelapuente</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-24 12:34 pm</div>
				                <div>My brand new IMHStore account has been upgraded from sub-retailer to sub-reseller. Now, how am I able to use the API to sell domains through my site?<br />
<br />
I quote: &quot;You are able to use the API which allows our customer's clients to purchase a domain instantly through the customer's site.&quot;<br />
<br />
Thank you,<br />
Alejandro.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22919);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-24 4:26 pm</div>
				                <div>Hello Alejandro,<br />
<br />
<br />
<br />
<br />
As per your question (on a different page), the use of the API requires some coding on your website.  We unfortunately can't provide that direct code, but eNom provides some great references that may help:<br />
<br />
<a href="http://www.enom.com/resellers/api-documentation.aspx?" rel="nofollow" target="_blank">API Documentation</a><br />
<a href="http://www.enom.com/APICommandCatalog/index.htm?domains=DomainNames" rel="nofollow" target="_blank">eNom Reference page</a><br />
<br />
Sorry that we can't provide a direct solution for you, but we hope the guides help.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22936);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-24 4:32 pm</div>
				                <div>Arnel, thank you for help and I'll review the links that you mention. Later on I'll let you know if they helped (which they might). Cheers!</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22937);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-28894'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/1ff2e0e6f9b50848e7982840dd41e6ae?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/1ff2e0e6f9b50848e7982840dd41e6ae'>Wayller</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-12-01 4:42 pm</div>
				                <div><p>Since I know what my account?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28894);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-12-01 4:54 pm</div>
				                <div>Hello Wayller,<br />
<br />
What are you trying to do?<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28896);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
