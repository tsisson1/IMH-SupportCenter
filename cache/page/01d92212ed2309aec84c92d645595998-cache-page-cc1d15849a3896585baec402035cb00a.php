<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:67072:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/drupal-7/managing-users/creating-a-new-user-account-in-drupal-7" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-06-01T15:06:27-07:00" />
  <meta name="keywords" content="new user account manual create drupal 7" />
  <meta name="author" content="Tim Sisson" />
  <meta name="description" content="In this tutorial, we'll show you how to create a new user account in your Drupal 7 website. " />
  <title>Creating a New User Account in Drupal 7 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/drupal-7/managing-users/creating-a-new-user-account-in-drupal-7" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:0df112a1f594112ff13b5f523cdf061a -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '80.74.72.85']);
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/drupal-7' itemprop='url'><span itemprop='title'>Drupal 7<span></a><div class='dropdown_4columns'><h2>Drupal 7 Education Channel</h2><div class='col_2'><h3>100 Level Classes</h3><div><a href='/support/edu/drupal-7/getting-started'>101: Installing and Getting Started with Drupal 7</a></div><div><a href='/support/edu/drupal-7/working-with-content'>102: Working with Content in Drupal 7</a></div><div><a href='/support/edu/drupal-7/homepage'>103: Working with your Drupal 7 homepage</a></div><div><a href='/support/edu/drupal-7/blocks-and-regions'>104: Working with Blocks and Regions in Drupal 7</a></div><div><a href='/support/edu/drupal-7/menus'>105: Working with Menus in Drupal 7</a></div><div><a href='/support/edu/drupal-7/customize-theme'>106: Working with themes in Drupal 7</a></div><div><a href='/support/edu/drupal-7/managing-users'>107: Managing Users in Drupal 7</a></div><div><a href='/support/edu/drupal-7/comments'>108: Working with Comments in Drupal 7</a></div><div><a href='/support/edu/drupal-7/working-with-images'>109: Working with Images in Drupal 7</a></div></div><div class='col_2'><h3>200 Level Classes</h3><div><a href='/support/edu/drupal-7/intro-to-modules'>201: An Introduction to Drupal 7 Modules</a></div><div><a href='/support/edu/drupal-7/sef-urls'>202: Search Engine Friendly URLs in Drupal 7</a></div><div><a href='/support/edu/drupal-7/forums'>203: Creating and Managing Forums in Drupal 7</a></div><div><a href='/support/edu/drupal-7/contact-us-page'>204: Creating a Contact Us Page in Drupal 7</a></div><div><a href='/support/edu/drupal-7/blogging'>205: Blogging in Drupal 7</a></div><div><a href='/support/edu/drupal-7/configure-caching'>206: Configuring Caching in Drupal 7</a></div><div><a href='/support/edu/drupal-7/configure-rss-feeds'>207: Configuring RSS Feeds in Drupal 7</a></div><div><a href='/support/edu/drupal-7/blocking-ips'>208: Blocking IP Addresses in Drupal 7</a></div><div><a href='/support/edu/drupal-7/reports-and-logs'>209: Drupal 7 Administrative Reports and Logs</a></div><div><a href='/support/edu/drupal-7/basic-setup'>210: Changing common configuration settings in Drupal 7</a></div><div><a href='/support/edu/drupal-7/views-module-tutorial'>211: Views Module Tutorial</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/drupal-7/managing-users' itemprop='url'><span itemprop='title'>107: Managing Users in Drupal 7<span></a><div class='dropdown_3columns'><h2> Managing Users in Drupal 7</h2><div class='col_3'><div>1. <a style='display:inline;' href='/support/edu/drupal-7/managing-users/intro-to-users'>Introduction to Users in Drupal 7</a></div><div>2. <a style='display:inline;' href='/support/edu/drupal-7/managing-users/creating-a-new-user-account-in-drupal-7'>Creating a New User Account in Drupal 7</a></div><div>3. <a style='display:inline;' href='/support/edu/drupal-7/managing-users/edit-who-can-register'>Editing who can register accounts in Drupal 7</a></div><div>4. <a style='display:inline;' href='/support/edu/drupal-7/managing-users/block-user-account'>How to block a user account in Drupal 7 </a></div><div>5. <a style='display:inline;' href='/support/edu/drupal-7/managing-users/enable-user-signature'>How to enable user signatures in Drupal 7</a></div><div>6. <a style='display:inline;' href='/support/edu/drupal-7/managing-users/disable-user-images'>How to disable user pictures in Drupal 7</a></div><div>7. <a style='display:inline;' href='/support/edu/drupal-7/managing-users/edit-image-directory'>How to change the picture upload directory in Drupal 7</a></div><div>8. <a style='display:inline;' href='/support/edu/drupal-7/managing-users/set-default-user-pic'>How to set a default user picture in Drupal 7</a></div><div>9. <a style='display:inline;' href='/support/edu/drupal-7/managing-users/edit-image-display'>How to change the user image display style in Drupal 7</a></div><div>10. <a style='display:inline;' href='/support/edu/drupal-7/managing-users/edit-max-image-dimension'>How to set the max user image dimensions in Drupal 7</a></div><div>11. <a style='display:inline;' href='/support/edu/drupal-7/managing-users/set-image-file-size'>How to modify the max picture upload file size in Drupal 7</a></div><div>12. <a style='display:inline;' href='/support/edu/drupal-7/managing-users/enable-blocked-notification'>How to enable Account Blocked email in Drupal 7</a></div><div>13. <a style='display:inline;' href='/support/edu/drupal-7/managing-users/change-welcome-text'>How to change Welcome Mail text in Drupal 7</a></div><div>14. <a style='display:inline;' href='/support/edu/drupal-7/managing-users/set-activation-email'>How to edit Account Activation email text in Drupal 7</a></div><div>15. <a style='display:inline;' href='/support/edu/drupal-7/managing-users/set-cancellation-email'>How to change the Account Cancellation email body text in Drupal 7</a></div><div>16. <a style='display:inline;' href='/support/edu/drupal-7/managing-users/edit-password-recovery'>How to modify the Password Recovery email text in Drupal 7</a></div><div>17. <a style='display:inline;' href='/support/edu/drupal-7/managing-users/disable-email-verification'>How to disable registration email verification for Drupal 7</a></div><div>18. <a style='display:inline;' href='/support/edu/drupal-7/managing-users/edit-anonymous-username'>How to change the username for Anonymous users in Drupal 7</a></div><div>19. <a style='display:inline;' href='/support/edu/drupal-7/managing-users/terminate-user-account'>How to cancel a user account in Drupal 7 </a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Creating a New User Account in Dru...</span></li>			</ul>
		</div>
	</div>
</div>
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
				<img src='/support/images/stories/drupal-partner/supporting-partner-80_3.png' style='float:right; margin:0px 0px 15px 15px;' alt='Drupal Association Support Partner'>		<h1>
															Creating a New User Account in Drupal 7									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>10,831</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Feb 24, 2012'><span style='color:#606060;'>Published:</span> Jun 1, 2012</div>
							...
							<div style='clear:both;'></div>
								...
								<p>As your Drupal 7 site administrator, you have the ability to add users at any time. In a perfect world, visitors to your website would create their own user accounts and you would never have to do anything. However, you may meet someone somewhere that you want to create an account on your website for. Drupal gives you the ability to manually create new accounts and automatically email the new user their login information. Creating a new user account in Drupal is done in the dashboard.</p>
<p><strong>To Create a New User in Drupal 7:</strong></p>
<ol class="article_list">
<li><a href="/support/edu/drupal-7/getting-started/how-to-log-into-the-drupal-admin-dashboard">Log into your Drupal Dashboard</a></li>
<li>Go to <strong>People</strong></li>
<li>Click <strong>Add User</strong></li>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/drupal/drupal_add_user_1.jpg"><img src="//cdn.inmotionhosting.com/support/images/stories/drupal/drupal_add_user_1.jpg" alt="drupal_add_user_1"  /></a></p>
<li>Fill in the fields as required</li>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/drupal/drupal_add_user_2.jpg"><img src="//cdn.inmotionhosting.com/support/images/stories/drupal/drupal_add_user_2.jpg" alt="drupal_add_user_2"  /></a></p>
<table class="article_table">
<tbody>
<tr>
<th width="100">Username</th>
<td>The username is required and must be unique. It may contain letters, numbers, and the characters specified in the help text below the field. Usernames are not case sensitive.&nbsp;The username “James” is the same as “james” in Drupal 7, and the user can log in using both.</td>
</tr>
<tr>
<th>E-mail address</th>
<td>The email is also required. It’s important that this be a valid email address for the user since Drupal uses it for various tasks. Since Drupal does does not include anything for bounced emails, it’s important you use a correct email.</td>
</tr>
<tr>
<th>Password</th>
<td>This is another required field. The password can be numbers, letters, symbols, and spaces. Keep in mind that Drupal 7 passwords cannot be all spaces though.</td>
</tr>
<tr>
<th>Confirm password</th>
<td>This is a security measure to prevent errors in typing the password.</td>
</tr>
<tr>
<th>Status</th>
<td>These are buttons to indicate whether the user’s account is active and can be used on the site.</td>
</tr>
<tr>
<th>Roles Section</th>
<td>This tab contains check boxes for each role or permission registered users and have on your website.</td>
</tr>
<tr>
<th>Notify user of new account</th>
<td>If you select this, Drupal 7 will send an email to the email address you entered in above to notify the user their account has been created</td>
</tr>
</tbody>
</table>
<li>Click the <strong>Create new account</strong> button at the bottom.</li>
<li>Once you create the account, if you select the checkbox option labeled <strong>Notify user of new account</strong>, an email will be sent and will look like the screenshot below:<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/drupal/drupal_add_user_3.jpg"><img src="//cdn.inmotionhosting.com/support/images/stories/drupal/drupal_add_user_3.jpg" alt="drupal_add_user_3"  /></a></li>
</ol>
<p> </p>
<p>If you need further assistance please feel free to <a href="/support/community-support">ask a question on our support center</a>.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/drupal-7/managing-users'>107: Managing Users in Drupal 7</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 2: Creating a New User Account in Drupal 7</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 1: <a href='/support/edu/drupal-7/managing-users/intro-to-users'>Introduction to Users in Drupal 7</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 3: <a href='/support/edu/drupal-7/managing-users/edit-who-can-register'>Editing who can register accounts in Drupal 7</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/drupal-7/managing-users/creating-a-new-user-account-in-drupal-7&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/drupal-7/managing-users/creating-a-new-user-account-in-drupal-7'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yMDcmaWQ9MTE4NiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="abc27aa19a36e8e875f77ddc82ddc7a1" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/drupal-7/managing-users?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Managing Users in Drupal 7</h3></a>
		<table>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/drupal-7/managing-users/intro-to-users?tsrc=rsbedu'>Introduction to Users in Drupal 7</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/drupal-7/managing-users/creating-a-new-user-account-in-drupal-7?tsrc=rsbedu'>Creating a New User Account in Drupal 7</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/drupal-7/managing-users/edit-who-can-register?tsrc=rsbedu'>Editing who can register accounts in Drupal 7</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/drupal-7/managing-users/block-user-account?tsrc=rsbedu'>How to block a user account in Drupal 7 </a></td>
                </tr>
          <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/drupal-7/managing-users/enable-user-signature?tsrc=rsbedu'>How to enable user signatures in Drupal 7</a></td>
                </tr>
          <tr >
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/drupal-7/managing-users/disable-user-images?tsrc=rsbedu'>How to disable user pictures in Drupal 7</a></td>
                </tr>
          <tr >
                        <td valign='top'>7.</td>
                        <td><a href='/support/edu/drupal-7/managing-users/edit-image-directory?tsrc=rsbedu'>How to change the picture upload directory in Drupal 7</a></td>
                </tr>
          <tr >
                        <td valign='top'>8.</td>
                        <td><a href='/support/edu/drupal-7/managing-users/set-default-user-pic?tsrc=rsbedu'>How to set a default user picture in Drupal 7</a></td>
                </tr>
          <tr >
                        <td valign='top'>9.</td>
                        <td><a href='/support/edu/drupal-7/managing-users/edit-image-display?tsrc=rsbedu'>How to change the user image display style in Drupal 7</a></td>
                </tr>
          <tr >
                        <td valign='top'>10.</td>
                        <td><a href='/support/edu/drupal-7/managing-users/edit-max-image-dimension?tsrc=rsbedu'>How to set the max user image dimensions in Drupal 7</a></td>
                </tr>
          <tr >
                        <td valign='top'>11.</td>
                        <td><a href='/support/edu/drupal-7/managing-users/set-image-file-size?tsrc=rsbedu'>How to modify the max picture upload file size in Drupal 7</a></td>
                </tr>
          <tr >
                        <td valign='top'>12.</td>
                        <td><a href='/support/edu/drupal-7/managing-users/enable-blocked-notification?tsrc=rsbedu'>How to enable Account Blocked email in Drupal 7</a></td>
                </tr>
          <tr >
                        <td valign='top'>13.</td>
                        <td><a href='/support/edu/drupal-7/managing-users/change-welcome-text?tsrc=rsbedu'>How to change Welcome Mail text in Drupal 7</a></td>
                </tr>
          <tr >
                        <td valign='top'>14.</td>
                        <td><a href='/support/edu/drupal-7/managing-users/set-activation-email?tsrc=rsbedu'>How to edit Account Activation email text in Drupal 7</a></td>
                </tr>
          <tr >
                        <td valign='top'>15.</td>
                        <td><a href='/support/edu/drupal-7/managing-users/set-cancellation-email?tsrc=rsbedu'>How to change the Account Cancellation email body text in Drupal 7</a></td>
                </tr>
          <tr >
                        <td valign='top'>16.</td>
                        <td><a href='/support/edu/drupal-7/managing-users/edit-password-recovery?tsrc=rsbedu'>How to modify the Password Recovery email text in Drupal 7</a></td>
                </tr>
          <tr >
                        <td valign='top'>17.</td>
                        <td><a href='/support/edu/drupal-7/managing-users/disable-email-verification?tsrc=rsbedu'>How to disable registration email verification for Drupal 7</a></td>
                </tr>
          <tr >
                        <td valign='top'>18.</td>
                        <td><a href='/support/edu/drupal-7/managing-users/edit-anonymous-username?tsrc=rsbedu'>How to change the username for Anonymous users in Drupal 7</a></td>
                </tr>
          <tr >
                        <td valign='top'>19.</td>
                        <td><a href='/support/edu/drupal-7/managing-users/terminate-user-account?tsrc=rsbedu'>How to cancel a user account in Drupal 7 </a></td>
                </tr>
          	</table>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/837bee68d557b28a04eff1bc6b688543?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/837bee68d557b28a04eff1bc6b688543'>Walugembe Everest</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-04-08 10:09 am</div>
				                <div><p>Thanks alot for the tutorials and help you provide in drupal, am new to it and working on a website but most times your help is straight to the point and helpful. Highly appreciated... Thanks for the Good work</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(22474);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
