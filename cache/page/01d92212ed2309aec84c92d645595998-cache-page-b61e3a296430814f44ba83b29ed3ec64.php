<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:66033:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-3/template-style" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-01-30T19:28:13-08:00" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="In this tutorial, we'll show you how to can use a different template for specific pages in your Joomla site by altering the template style setting." />
  <title>Template Style settings in Joomla 3 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-3/template-style" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:a0e88838d528a7ce7f4525c51da926f0 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '5.56.47.166']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Template Style settings in Joomla 3									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>4,492</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jan 16, 2014'><span style='color:#606060;'>Published:</span> Jan 30, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/menu-item-options/template-style.gif"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/menu-item-options/template-style.gif"  style='float:right; margin:0px 0px 15px 15px;' /></a>

<p>The <strong>Template Style</strong> setting for <a href="/support/edu/joomla-3/menu/menu-item-types">Joomla 3 <em>menu items</em></a> controls which Joomla template the target page will use. This means that you have the ability to use certain templates for some pages but not others.</p>

<p>In a <a href="/support/edu/joomla-3/getting-started/install-joomla-3">standard installation of Joomla 3</a>, you will have <a href='/support/edu/joomla-3/protostar'>the Protostar template</a> and the Beez3 template installed. In this tutorial, we use these two templates to demonstrate how the <em>Template Style</em> setting works in Joomla 3.</p>

<p><strong>Confused thus far?</strong> If you are not familiar with menu items in Joomla 3, it may help to start at the beginning and learn <a href="/support/edu/joomla-3/menu/create-menu-and-module">how to create menus in Joomla 3</a>.</p>

<h2 style='clear:both;'>Template Style Options</h2>

<h3>Use Default</h3>

<p>When <strong>Use Default</strong> is set as the <em>Template Style</em>, the page will use the default template style already set for the site.</p>

<h3>Beez3</h3>

<p>In our testing, our <em>site template</em> is set to the Protostar template. You can see in the screenshot below that our menu link however shows the Beez3 template when it is clicked. This is because the menu item <em>Template Style</em> was set to <strong>Beez3</strong>.</p>

<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/menu-item-options/protostar-to-beez3.gif"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/menu-item-options/protostar-to-beez3.gif"  style='min-width:655px;' /></a>

<h3>Protostar</h3>

<p>In our testing, <a href="/support/edu/joomla-3/create-template/switch-site-template">we changed the site template</a> to Beez3. Then, we changed the <em>Template Style</em> to <strong>Protostar</strong> for the menu item. As you can see in this screenshot, the new page uses the Protostar template.</p>


<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/menu-item-options/beez3-to-protostar.gif"><img src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/menu-item-options/beez3-to-protostar.gif"  style='min-width:655px;' /></a> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 26: Template Style settings in Joomla 3</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 25: <a href='/support/edu/joomla-3/menu-location'>Menu Location settings in Joomla 3</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 27: <a href='/support/edu/joomla-3/target-window'>Target Window Settings in Joomla 3</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-3/template-style&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-3/template-style'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xMDEmaWQ9MzA3MCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="a5061ba52e8aaeffe12d66f76e92a99a" value="1" />	</div>
	</form>
<!-- <br />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/eb4655674950dc90d850772d5a983101?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/eb4655674950dc90d850772d5a983101'>Andrey</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-22 7:23 am</div>
				                <div><h1 style="margin: 0px; font-family: adelle, sans-serif; line-height: 33px; text-rendering: optimizelegibility; padding: 0px; font-size: 24px; background-color: #f9f9f9;"><span style="color: #aaaaaa;">how to remove Back To Pop link from protostar template</span></h1></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10801);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-22 10:11 am</div>
				                <div>To remove the &lt;em&gt;Back to Top&lt;/em&gt; link on the Protostar template, remove the following line from the index.php file within the Protostar template folder:<br />
&lt;p class=&quot;code_block&quot;&gt;	&amp;lt;a href=&quot;#top&quot; id=&quot;back-top&quot;&amp;gt;<br />
&amp;lt;?php echo JText::_('TPL_PROTOSTAR_BACKTOTOP'); ?&amp;gt;<br />
&amp;lt;/a&amp;gt;&lt;/p&gt;</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10806);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-05-23 2:20 pm</div>
				                <div><p>Thank you very much. I made it.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(10866);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-23170'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/6a8797556ebca028823e862327667723?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/6a8797556ebca028823e862327667723'>Michael Rose</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-05-04 3:07 pm</div>
				                <div><p>Hello</p>
<p>Very New to Joomla, can post articles add pictures etc, I am using Beez3 and want to replace the Joomla open source content management banner with one that I have greated for our society, did it about a year ago on another website but cannot see how I do it now, Would appreciate some help with this.</p>
<p>Thanks</p>
<p>Michael</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23170);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-05-04 4:00 pm</div>
				                <div>Hello Michael,<br />
<br />
The easiest way would be to rename the stock banner and save your new one in the same folder with the name of the original banner. This will display yours instead of the original.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23172);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
