...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/whm/creating-and-managing-accounts" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Creating and Managing Accounts with WHM" />
  <title>102: Creating and Managing Accounts with WHM | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/whm/creating-and-managing-accounts" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:320dcd1ddafbb32b94c7f7e079a1d847 -->
...
<div class='page-header'>
	<h1>102: Creating and Managing Accounts with WHM</h1>
</div>
<div class='section_listing'>
		...
		<tr>
				...
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/whm/creating-and-managing-accounts/change-theme'>How to Change your Softaculous Theme in WHM</a>
					<div>Learn how to change your Softaculous theme in WHM in this guide.</div>
					<div class='smallgrey'>Hits: 477</div>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/whm/creating-and-managing-accounts/feature-lists'>How to Work with Feature Lists in WHM</a>
					<div>Feature Lists allow you to specify which features (such as the File Manager or Awstats) that your cPanel accounts have access to.</div>
			...
			<tr>
				...
				<td style='padding-bottom:10px;'>
					...
					<div>The settings you defined when creating a cPanel account are not set in stone. If you need to change details, such as the number of addon and parked domain names available to an account, you can do so at any time. You can use the Modify an Account feature in WHM to modify cPanel accounts.</div>
			...
			<tr>
				...
				<td style='padding-bottom:10px;'>
					...
					<div>You can use the Brand Editor within WHM to brand cPanel specifically for you, allowing your users to see your logo / color scheme / etc in their cPanel.</div>
