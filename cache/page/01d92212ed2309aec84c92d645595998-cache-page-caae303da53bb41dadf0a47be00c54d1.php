...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/component/users" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="InMotion Hosting Support Center" />
  <title>InMotion Hosting - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/component/users/?view=registration" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:3758a6a7bf5cb9f58e29d8283252f35e -->
...
<div class="registration">
	...
	<form id="member-registration" action="/support/component/users?task=registration.register" method="post" class="form-validate form-horizontal">
				<fieldset>
	...
	Name:<span class="star">&#160;*</span></label>										</div>
					<div class="controls">
						<input type="text" name="jform[name]" id="jform_name" value="" class="required" size="30" required aria-required="true" />					</div>
												...
												<div class="control-group">
					<div class="control-label">
					<label id="jform_username-lbl" for="jform_username" class="hasTooltip required" title="&lt;strong&gt;Username&lt;/strong&gt;&lt;br /&gt;Enter your desired username.">
	Username:<span class="star">&#160;*</span></label>										</div>
					<div class="controls">
						<input type="text" name="jform[username]" id="jform_username" value="" class="validate-username required" size="30" required aria-required="true" />					</div>
												...
												<div class="control-group">
					<div class="control-label">
					<label id="jform_password1-lbl" for="jform_password1" class="hasTooltip required" title="&lt;strong&gt;Password&lt;/strong&gt;&lt;br /&gt;Enter your desired password.">
	Password:<span class="star">&#160;*</span></label>										</div>
					<div class="controls">
						<input type="password" name="jform[password1]" id="jform_password1" value="" autocomplete="off" class="validate-password required" size="30" maxlength="99" required aria-required="true" />					</div>
												...
												<div class="control-group">
					<div class="control-label">
					<label id="jform_password2-lbl" for="jform_password2" class="hasTooltip required" title="&lt;strong&gt;Confirm Password&lt;/strong&gt;&lt;br /&gt;Confirm your password.">
	Confirm Password:<span class="star">&#160;*</span></label>										</div>
					<div class="controls">
	...
	Confirm email Address:<span class="star">&#160;*</span></label>										</div>
					<div class="controls">
	...
	Captcha<span class="star">&#160;*</span></label>										</div>
					<div class="controls">
						<script src="https://www.google.com/recaptcha/api.js"></script><div class="g-recaptcha" data-sitekey="6Lf2uAATAAAAAOOOxvgqxV9fz3faRRgGL_oy-0Yk"></div>					</div>
				</div>
							</fieldset>
					<fieldset>
					<legend>Newsletter</legend>
											<div class="control-group">
					<div class="control-label">
					<label id="jform_cmc_newsletter-lbl" for="jform_cmc_newsletter" class="form-label cmc-label hasTooltip" title="&lt;strong&gt;Newsletter&lt;/strong&gt;&lt;br /&gt;Subscribe to Newsletter">
	Newsletter</label>										</div>
					<div class="controls">
						<input type="checkbox" name="jform[cmc][newsletter]" id="jform_cmc_newsletter" value="1" class="submitMerge inputbox cmc-checkboxes cmc-checkbox-subscribe" checked />					</div>
				</div>
												<input type="hidden" name="jform[cmc][listid]" id="jform_cmc_listid" value="84c935b0db" />							</fieldset>
					<fieldset>
	...
	First Name</label>										</div>
					<div class="controls">
						<input type="text" name="jform[cmc_groups][FNAME]" id="jform_cmc_groups_FNAME" value="" class="inputbox input-medium" placeholder="First Name " />					</div>
				</div>
							</fieldset>
	<legend>Youtube</legend><div class="g-ytsubscribe" data-channel="InMotionSupport" data-layout="full" data-count="hidden"></div>
