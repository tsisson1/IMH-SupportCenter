<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:63719:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/joomla-25/virtuemart-search" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-02-16T18:32:53-08:00" />
  <meta name="keywords" content="joomla 2.5 VirtueMart Search" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="VirtueMart search can be handled by either the default search module or by 3rd party extensions and plugins. Some VirtueMart search modules include ajax and filter functionality, and most of them are commercial products." />
  <title>VirtueMart Product Search Extensions &amp; Plugins for Joomla 2.5 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/joomla-25/virtuemart-search" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:4fa192c3cddeba28700a4ed90b899de5 -->
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>VirtueMart Product Search Extensions &amp; Plugins for Joomla 2.5</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															VirtueMart Product Search Extensions &amp; Plugins for Joomla 2.5									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>8,080</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Apr 27, 2012'><span style='color:#606060;'>Published:</span> Feb 16, 2015</div>
							...
							<div style='clear:both;'></div>
								...
								<p class="alert">Joomla 2.5 has reached its end of life as for 12/31/2014. Please be advised this may be a security risk to your website. You can view more information about the end of life <a href="https://docs.joomla.org/Joomla!_CMS_versions">here</a>.</p><p>VirtueMart search refers to the way your customers search your website and find your products. <a href="/support/website/joomla-25/add-new-product-in-virtuemart">Products added to VirtueMart</a> by default can be found within Joomla 2.5's search feature. As you can see in the screenshot below, searching for "Ubuntu" shows our only Ubuntu VirtueMart product in the results. In addition to Joomla's search module, VirtueMart includes a search module that finds products as well. The results of VirtueMart's query displays products in a more user friendly view. Instead of showing the product as an article, the results instead include an image of the product, a product description, and the product's price.</p>
<table class="article_table">
<tbody>
<tr>
<th>Joomla Search</th> <th>VirtueMart Search</th>
</tr>
<tr>
<td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/virtuemart-search/joomla-search-finds-virtuemart-products.gif"><img style="max-width: 250px;"  alt="joomla-search-finds-virtuemart-products" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/virtuemart-search/joomla-search-finds-virtuemart-products.gif" /></a></td>
<td><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/virtuemart-search/virtuemart-includes-search-module.gif"><img style="max-width: 250px;"  alt="virtuemart-includes-search-module" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla25/virtuemart-search/virtuemart-includes-search-module.gif" /></a></td>
</tr>
</tbody>
</table>
<p>If you're looking for more search functionality, there are several VirtueMart plugins and extensions available for Joomla 2.5.</p>
<p><strong>Ajax Search</strong><br /><em>VirtueMart products Ajax search</em> is a VirtueMart search module that can be found within Joomla's extension directory. It currently lists for $15.99, but it includes quite a few options. Based upon this extension's screenshots, as you type in your product search term it uses ajax to fetch the search results. The nice thing is that in the search results a product image is shown along with the product title and description. You can also filter the search based upon manufacturer, product prices, and any custom fields that you've configured. This VirtueMart search extension currently has a 5 out of 5 rating based upon 12 ratings. If you're looking to improve your VirtueMart search, this may be a viable option for you!</p>
<p><strong>Category Filters</strong><br />Another popular VirtueMart search extension found in the Joomla Extension directory is <em>Cat Filters</em>. This is a commercial plugin that allows you to assign products to multiple categories. For example, this plugin will allow you to add a pair of shoes to both an "Children's" category and a "Sports" category. Just like the ajax search module we listed above, Cat Filters allow you to filter search results based up manufacturer, price, and other attributes.</p>
<p>Many of the VirtueMart search extension we found were commercial plugins, meaning you have to pay for them. Popular features shared among the top VirtueMart search plugins included ajax search, advanced search result filtering, and search statistics available for the Joomla administrator's review. While the standard Joomla search and VirtueMart search modules work, if you're looking for more robust search features, check out Joomla's extension directory for more options.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/joomla-25/virtuemart-search&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/joomla-25/virtuemart-search'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD04OSZpZD00MTgmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
		<input type="hidden" name="07842cf6fb4012d1f986f1b18e3a61f1" value="1" />	</div>
	</form>
<!-- <br />
