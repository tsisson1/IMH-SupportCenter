<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:103203:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-3/recaptcha-setup" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-02-19T14:42:36-08:00" />
  <meta name="keywords" content="joomla 3.0 install recaptcha plugin" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="In this Joomla 3.0 tutorial, we'll show you how to setup the popular captcha plugin, ReCaptcha." />
  <title>303: How to setup ReCaptcha in Joomla 3.1 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-3/recaptcha-setup" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:eb9a054cd0c4e462f5a5e0c0d55078c5 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '195.154.173.103']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															303: How to setup ReCaptcha in Joomla 3.1									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>28,808</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Aug 7, 2012'><span style='color:#606060;'>Published:</span> Feb 19, 2016</div>
							...
							<div style='clear:both;'></div>
								...
								<p>ReCaptcha is a very popular <a href="/support/email/fighting-spam/what-is-captcha">captcha plugin</a>. It is in use all across the web, and is not just limited for use in Joomla 3.0. In addition to being a very high quality tool, there are several <a href="http://www.google.com/recaptcha" target="_blank">interesting facts about ReCaptcha</a> that you may not be aware of.</p>
<p>In this Joomla 3.0 tutorial, we'll show you how to setup ReCaptcha.</p>

<h2>Configuring ReCaptcha for Joomla 3.0:</h2>
<ol class="article_list">
<li><a href="/support/edu/joomla-3/getting-started/login-dashboard">Log into your Joomla 3.0 admin</a></li>
<li>In your <strong>Global Configuration</strong> settings, <a href="/support/edu/joomla-3/site-settings/default-captcha">set ReCaptcha as your default captcha plugin</a> (located in the <em>Global Configuration</em> settings under the <em>Site</em> tab).</li>
<li>While still in your Joomla 3.0 admin area, in the top menu go to <strong>Extenstions</strong> » <strong>Plugin Manager</strong>.</li>
<li>Using the filter feature at the top of the page, type in <em>recaptcha</em>. Click on the result <strong>Captcha - ReCaptcha<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/global-configuration/click-captcha-recaptcha.gif"><img  alt="click-captcha-recaptcha" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/global-configuration/click-captcha-recaptcha.gif" /></a></strong></li>
<li>On the <em>Details</em> tab, ensure that <strong>Status</strong> is set to <strong>Enabled</strong>.</li>
<li>Click the <em>Basic Options</em> tab. Fill in the <strong>Public Key</strong> and <strong>Private Key</strong>, which you can get by <a href="http://www.google.com/recaptcha" target="_blank">registering your site here</a>.<br /><br />Another basic option you can set is the Theme. The following themes are available: Clean, White, BlackGlass, and Red.<br /><br />After setting all options, click the <strong>Save</strong> button in the top left.</li>
<li>Be sure to test ReCaptcha to ensure it is working! You can do this by visiting your <em>user registration</em> page. At the bottom of the page, you should see ReCaptcha, as it appears in this screenshot:<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/global-configuration/recaptcha-in-action.gif"><img  alt="recaptcha-in-action" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/global-configuration/recaptcha-in-action.gif" /></a><br /><br />If ReCaptcha is working correctly, you should see the following message after trying to register:<br /><br /><strong>Message</strong><br /><em>Your account has been created and an activation link has been sent to the email address you entered. Note that you must activate the account by clicking on the activation link when you get the email before you can login.</em></li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/joomla-3'>Joomla 3</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 40: 303: How to setup ReCaptcha in Joomla 3.1</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 39: <a href='/support/edu/joomla-3/database-errors'>304: Troubleshooting Joomla 3.1 Database Connection Errors</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 41: <a href='/support/edu/joomla-3/302-blog-brochure-default'>302: Joomla 3.1 Sample Data Set - Blog vs. Brochure vs. Default</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xMDEmaWQ9MjM5NSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="a7dd259efbc9b6831d1830af74e0ccce" value="1" />	</div>
	</form>
<!-- <br />
...
<a name='comments'></a>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='https://lh5.googleusercontent.com/-0OH3-z1tG6M/AAAAAAAAAAI/AAAAAAAAAAA/HGJOoo8VE2k/photo.jpg?sz=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='/support/community-support/users/SKR1501'>SKR1501</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2013-04-19 2:50 pm</div>
				                <div>i tried the steps of this article &amp; it worked in my first attempt. Thanks &amp; keep posting such types of articles.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(7781);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-18738'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/7b25680c20fd432575df17445da060ad?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/7b25680c20fd432575df17445da060ad'>Matteo</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-21 7:53 am</div>
				                <div><p>Hi, i've remove default plugin recaptcha on joomla 3 and i remove the directory in to plugin directory.</p>
<p id="setup-start" style="margin: 0px 0px 8px; padding: 0px; border: 0px; outline: 0px; font-weight: normal; font-size: 16px; font-family: Arial, Helvetica, sans-serif; vertical-align: baseline; line-height: 24px; color: #222222;"></p>
<p style="margin: 0px;">there is the possibility to reinstall it?</p>
<p style="margin: 0px;">&nbsp;</p>
<p style="margin: 0px;">Thanks</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(18738);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-12-22 9:54 am</div>
				                <div>It appears that the only way to do so would be to download Joomla 3, then copy the contents of that folder back over again.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(18760);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-23853'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/0473f7371f648db71849f46720dd2260?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/0473f7371f648db71849f46720dd2260'>rajiva</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-01 1:21 pm</div>
				                <div><p>I don't see " <em>Basic Options</em> tab" to file the <strong>Public Key</strong> and <strong>Private Key. I only can see "</strong>plugin" tab. :( any reason for this. Appriciate help.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23853);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-06-01 3:19 pm</div>
				                <div>Hello rajiva,<br />
<br />
Which specific version of Joomla are you using? Are you getting lost on any particular step? If so, please let us know which one so we can assist and test it for you.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(23864);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-24579'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/e8ddbd873a0060d4d28bcca79c557935?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/e8ddbd873a0060d4d28bcca79c557935'>swaantje</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-02 6:44 am</div>
				                <div><p>Hey,</p>
<p>i enabled the captcha plugin, insert the private and public key from google in the basic option and i set the default captcha in the site setting to captcha.</p>
<p>&nbsp;</p>
<p>In&nbsp; the Contactformular ist still</p>
<p>"captcha *" No Picture and nothing for captcha. The Website is offline but i have this one registered at google to become the keys.</p>
<p>&nbsp;</p>
<p>Can you help me please?</p>
<p>&nbsp;</p>
<p>My english is not so good. soory, i am a german girl ;-)</p>
<p>&nbsp;</p>
<p>I use joomla 3.0.3</p>
<p>&nbsp;</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24579);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-02 1:34 pm</div>
				                <div>Hello Swaantje,<br />
<br />
Sorry for the problem with captcha!  Make sure that you have <a href="http://www.inmotionhosting.com/support/website/how-to/clear-browser-cache">cleared your browser</a>.  If you continue to have a problem with the captcha, go back and double-check your configuration of the captcha installation in your site.  We would need to see the installation and know the exact URL where you have installed it in order to assess the issue.  If you are an InMotion customer, then we can investigate in more depth. Othewise, you may need to provide access or have a developer look at your installation.<br />
<br />
Regards,<br />
Arnel C.<br />
<br />
...
<br />
						...
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(24593);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-25176'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/59d35f54ca6c76fc3dcba8d90a3c95e3?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/59d35f54ca6c76fc3dcba8d90a3c95e3'>Jeff Johnson</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-25 10:17 pm</div>
				                <div><p>What if you have one that does not work and you have disabled at least two of them and after deleting the cache and history, it is still staring me in the face?BTW, the catptcha you have on this page.. so nice to actually click the field and see a cursor show up... See I was not asking from it so much.&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25176);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-27 2:15 pm</div>
				                <div>Hello Jeff,<br />
<br />
 I am not quite understanding what you are asking here. Could you please be more specific with the steps that you are taking and what you are actually seeing (errors, etc).<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25208);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/59d35f54ca6c76fc3dcba8d90a3c95e3?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/59d35f54ca6c76fc3dcba8d90a3c95e3'>Jeff </a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-28 12:49 pm</div>
				                <div><p>I am having some serious issues in regards to ReCaptcha not wanting to get the hint and leave the presence of my website. I have spent nearly 12 hours on this. I have read most all of the support forums regarding the SSL Issues and with Google changing the address (which affected Joomla 2.5 mostly it seems). &nbsp;I have disabledthe recaptcha extensions in all my software, I have disabled it in Global Configurations and disabled the plugin. &nbsp;It is still there. I really would rather not supply my web address, but I will in yopes that you could edit it or remove it for me once you are able to see it.. it is example.com.&nbsp;When you got to register it will show up but you can not see what is typed in the field of the recaptcha. I wasnted to remove it and start fresh, but like some squatter, it won't leave.&nbsp;Kind Regards,&nbsp;Jeff&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25257);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-29 12:56 am</div>
				                <div>Hello Jeff,<br />
<br />
In regards to your captcha, have you tried clearing your websites cache? Things like this have been known to stick around until the cache has been cleared.<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25278);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-29 10:18 pm</div>
				                <div><p>Thank you,Yes, absolutely. There are support chats for this and it actually looks to irritate even the advanced Joomla troubleshooters:&nbsp;<span style="color: rgb(102, 102, 102); font-family: Tahoma, Verdana, Arial, sans-serif; font-size: 11.6800003051758px; line-height: 14.0160007476807px;">http://forum.joomla.org/viewtopic.php?p=2727676 I do see a patch was made as well to resolve it, but&nbsp;that was&nbsp;for 2.5, I am running the most current 3.x, and not seeing anyone else having this issue. Which is basically, when you try to enter image number into the field, the field will act like your cursor is not there. - It will also not show you what you time. I know little about CSS, could my template be causing that issue?&nbsp;</span></p>
<p><span style="color: #666666; font-family: Tahoma, Verdana, Arial, sans-serif;"><span style="font-size: 11.6800003051758px; line-height: 14.0160007476807px;">That still does not explain why I can't remove the Recaptcha though.&nbsp;</span></span></p>
<p>I did notice that part of my jomsocial directory has duplicated itself. &nbsp;Ex: website/profile and website/community/profile. But I look back on backups and it has been that way for awhile. Also according to Joomla support this is not common but not rare either. So not sure if that has anything to do with it.&nbsp;Could just rename the files but I would rather figure out if I am missing somethign simple or if I have a much bigger issues, such as a corrupted instal. &nbsp;&nbsp;Lastly, if you do mind, could you please remove the domain name from the support I posted above. I added it in case you may need it. I thought I could edit it out later, but it won't let me.&nbsp;Kind Regards,&nbsp;Jeff</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25312);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-30 4:19 pm</div>
				                <div>Hello Jeff,<br />
<br />
Thank you for contacting us. There seems to be an issue with the way reCAPTCHA interacts with recent versions of Joomla, and it has actually been <a href="https://docs.joomla.org/J3.2:The_reCaptcha_function_has_been_temporarily_disabled_for_Joomla_3.2" target="_blank">disabled</a> from what I can tell. This could very well be related to your issue.<br />
<br />
We can help guide you with Joomla, but our knowledge of this issue is limited. I recommend posting in the <a href="http://forum.joomla.org/" target="_blank">Official Joomla Forums</a>, since it is frequented by Joomla developers who may have a fix, or workaround.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25332);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-29 10:22 pm</div>
				                <div><p>Wow, just realized how tired I must have been that day. I must have just got done staring deep into the code for 10 hours striaght. Obviously my mind was done for the day and hadchecked out. &nbsp; Sorry for that.&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25313);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-07-30 10:48 pm</div>
				                <div><p>Thank you guys, I appreciate it. I contactd an old freelancer I used. He will contact me Fri night to start working on it.&nbsp;If I remember and he is able to figure it out, I will send you guys &nbsp;a message.. Thanks again for your attempts.&nbsp;Jeff</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25344);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-01 4:52 pm</div>
				                <div><p>Hey, For the issue I was having in regards to not being able to type into the field of Recaptcha, I was told that it appeared to be an issue with the CSS files conflicting with Recapthca. He appeared to test it by changing some font and it suddenly allowing me to type use it. He was not able to split the colors of the other fields on the website (which background changes to 5 other colors) and keep the reacaptcha working. So he had to remove it..The issue with it not going away appears to be some serious cache issues as he was having trouble too. It might have had to do with CDN through CloudFlare. Not sure. But anyways he removed the ReCaptcha and downgraded me to an older version it looks like.&nbsp;He stated that the Recaptcha would have issues with Jomsocial 3 and the templates css. I know little about css.. so I had know knowledge to object on, but anyways. The site has its basic functionality back.&nbsp;Thank you.&nbsp;Jeff</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25378);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-28480'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/e17d350e5e1b5f4aff9d8578e337ab19?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/e17d350e5e1b5f4aff9d8578e337ab19'>stephen</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-16 9:14 pm</div>
				                <div><p>hey guys, link to recaptcha is a 404 fyi</p>
<p>&nbsp;</p>
<p>Cheers</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28480);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-02-19 10:43 am</div>
				                <div>Hello Stephen,<br />
<br />
I appreciate your input, I have updated the links but we do need to revisit this article to update it for the nocaptcha recaptcha.<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30679);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-30671'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/f8184e795114ae62aa17bf38a1abecdb?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/f8184e795114ae62aa17bf38a1abecdb'>bea</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-02-19 5:35 am</div>
				                <div><p>after I enabled re-captcha, I cannot find my joomla backend, carmonagov.net/main_home/administrator</p>
<p>Please help me on this. Thank you</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30671);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-02-19 10:49 am</div>
				                <div>Hello Bea,<br />
<br />
Did you remove any files or change any other settings? I am getting a 404 on your component and shows me logged in as some blank user without logging in to anything. You may want to edit the configuration.php to change back the captcha settings, as there may be a conflict with another setting.<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30682);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-32468'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/603d9da03ea70c745c8ba9a64eb7dd9b?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/603d9da03ea70c745c8ba9a64eb7dd9b'>Syed Hussaini</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-05-04 2:45 pm</div>
				                <div><p>Is there a way we can setup this thing on User Login Module as well and not just register module?</p>
<p>Regards,</p>
<p>Syed H</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32468);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-05-04 9:46 pm</div>
				                <div>Hello Syed Hussaini,<br />
<br />
Thanks for the question about using recaptcha in the User Login Module.  As far as I can tell, it cannot be done, but you may want to direct your question towards the authors of the add-on as they may know of a solution.<br />
<br />
I hope that helps to answer your question!  If you require further assistance, please let us know!<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(32475);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
