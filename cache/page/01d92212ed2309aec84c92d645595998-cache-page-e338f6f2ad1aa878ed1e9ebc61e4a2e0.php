<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:64304:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/slow-websites/use-pingplotter-to-troubleshoot-network-slowdowns" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-12-06T00:34:47-08:00" />
  <meta name="keywords" content="pingplotter ping plot trace route traceroute traceroutes network connectivity" />
  <meta name="author" content="Jacob Nicholson" />
  <meta name="description" content="You can use the PingPlotter application on Windows to get a better understanding of what might be causing network slowdowns to your website." />
  <title>Use PingPlotter to troubleshoot network slowdowns - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/slow-websites/use-pingplotter-to-troubleshoot-network-slowdowns" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:078f0641d7cedd83d9063e5ca9c3917e -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Use PingPlotter to troubleshoot network slowdowns									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>2,661</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Dec 6, 2013'><span style='color:#606060;'>Published:</span> Dec 6, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>If you're on a Windows machine, and your website appears to be running slow. You can try out the <strong>PingPlotter</strong> application to help pinpoint any problems with network connectivity.</p>

<p>We have a guide on <a href="http://www.inmotionhosting.com/support/website/slow-websites/why-is-my-server-slow-how-do-i-run-a-ping-and-tracert-test" target="_blank">running a ping and traceroute test</a> when you feel your website is running slow. However when you use the <strong>PingPlotter</strong> application, you'll be able to get a much better view on possible networking problems.</p>

<h2>Install and run a trace with PingPlotter</h2>

<p>The steps below will walk you through downloading <strong>PingPlotter</strong>, and then starting a <strong>trace</strong> with it to troubleshoot possible network connectivity issues.</p>

<ol class="article_list">
<li>
    <p><a href="http://www.pingplotter.com/download.html" target="_blank">Download PingPlotter</a> from their website.</p>
</li>

<li>
    <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/slow-websites/tools/pingplotter/click-http-download-link-for-pingplotter.png"><img  style="width: 190px; float: right;" src="//cdn.inmotionhosting.com/support/images/stories/website/slow-websites/tools/pingplotter/click-http-download-link-for-pingplotter.png" alt="click on http download link for pingplotter"></a>
    <p>It's recommended to download <strong>PingPlotter Standard</strong> for more features, and you'd click on the <strong>HTTP</strong> link to begin your download.</p>
    <p>There is also the <a href="http://www.pingplotter.com/freeware.html" target="_blank">PingPlotter Freeware</a> edition available that lacks some of the features such as a graph over time, but it's free.</p>
    <div style="clear: both;"></div>
</li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/slow-websites/tools/pingplotter/click-launch-pingplotter-after-install.png"><img  style="width: 190px; float: right;" src="//cdn.inmotionhosting.com/support/images/stories/website/slow-websites/tools/pingplotter/click-launch-pingplotter-after-install.png" alt="click launch pingplotter after install"></a>
    <p>After installing, click on the <strong>Launch PingPlotter Standard Now</strong> button to launch the application.</p>
    <div style="clear: both;"></div>    
</li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/slow-websites/tools/pingplotter/click-continue-to-bypass-welcome-page.png"><img  style="width: 190px; float: right;" src="//cdn.inmotionhosting.com/support/images/stories/website/slow-websites/tools/pingplotter/click-continue-to-bypass-welcome-page.png" alt="click continue to bypass welcome page"></a>
    <p>Now you can click on <strong>Continue</strong> to bypass the welcome screen, or click on any of the links for more details.</p>
    <div style="clear: both;"></div>    
</li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/slow-websites/tools/pingplotter/default-pingplotter-setup.png"><img  style="width: 190px; float: right;" src="//cdn.inmotionhosting.com/support/images/stories/website/slow-websites/tools/pingplotter/default-pingplotter-setup.png" alt="default pingplotter setup"></a>
    <p>By default <strong>PingPlotter</strong> will already come with some defaults typed in that can help you troubleshoot if you're just having general network connectivity issues.</p>
    <div style="clear: both;"></div>
    
    <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/slow-websites/tools/pingplotter/change-settings-then-click-trace.png"><img  style="width: 190px; float: right;" src="//cdn.inmotionhosting.com/support/images/stories/website/slow-websites/tools/pingplotter/change-settings-then-click-trace.png" alt="change settings then click trace"></a>
    <p>Here you can see I've made a few adjustments:</p>
    <p><strong>Address to Trace:</strong> example.com</p>
    <p><strong>Sampling</strong> - <strong># of times to trace</strong> 10</p>
    <p><strong>Sampling</strong> - <strong>Trace Interval</strong> 15 seconds</p>
    <p><strong>Statistics</strong> - <strong>Samples to include</strong> 10</p>
    <p>Then click on <strong>Trace</strong> to begin the test.</p>
    <div style="clear: both;"></div>     
</li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/slow-websites/tools/pingplotter/running-a-trace-with-pingplotter.gif"><img  style="width: 190px; float: right;" src="//cdn.inmotionhosting.com/support/images/stories/website/slow-websites/tools/pingplotter/running-a-trace-with-pingplotter.gif" alt="running a trace with pingplotter"></a>
    <p>In this case we did <strong>10 traces</strong> with a <strong>15 seconds interval</strong> in-between them. So you'll see that <strong>PingPlotter</strong> graphs the response we're getting on each interation.</p>
    <p>We can see from this test that <strong>hop 5</strong> is experincing some packet-loss. But overall we are averaging around a <strong>8ms</strong> round-trip response time.</p>
    <div style="clear: both;"></div> 
    <a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/slow-websites/tools/pingplotter/final-test-showing-packet-loss.png"><img  style="width: 190px; float: right;" src="//cdn.inmotionhosting.com/support/images/stories/website/slow-websites/tools/pingplotter/final-test-showing-packet-loss.png" alt="final test showing packet loss"></a>
    <p>Finally at the end, we're left with the results of the whole test, and in this case we can clearly see that <strong>hop 5</strong> with the IP address of <strong>68.1.4.246</strong> is encountering an average of <strong>22.28%</strong> packet-loss.</p>
    <p>So if my website seemed to be responding slow at this time, this could possibly be the culprit.</p>
    <div style="clear: both;"></div>    
</li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/slow-websites/tools/pingplotter/arin-info-for-cox-ip-address.png"><img  style="width: 190px; float: right;" src="//cdn.inmotionhosting.com/support/images/stories/website/slow-websites/tools/pingplotter/arin-info-for-cox-ip-address.png" alt="arin info for cox ip address"></a>
    <p>Now that we know which IP address seems to possibly be affecting our network performance, we can go over to <a href="https://www.arin.net/whois_tou.html" target="_blank">ARIN.net</a> who is in charge of IP address assignments, and use their <strong>SEARCH Whois</strong> function at the top-right of the page.</p>
    <p>In this case we can see this router belongs to <strong>Cox Communications</strong> out of <strong>Atlanta, GA</strong>. So they might temporarily be having some issues affecting the connection between my local computer and the server.</p>
    <p>In this case because the network connectivity issue doesn't reside within a network that InMotion Hosting has any control over, contacting us regarding the network slowness won't help resolve the issue.</p>
    <p>These types of routing issues are typically temporary as the Internet can find multiple routes for a connection to go through. Using <strong>PingPlotter</strong> can help you keep tabs on just how frequently these issues are happening, and if any further investigation should be done.</p>
    <div style="clear: both;"></div>  
</li>
</ol> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/slow-websites/use-pingplotter-to-troubleshoot-network-slowdowns&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/slow-websites/use-pingplotter-to-troubleshoot-network-slowdowns'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00NTcmaWQ9MzAyMyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="513f261268f46c67b99b329f3c97e90c" value="1" />	</div>
	</form>
<!-- <br />
