<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:60281:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/wordpress/get-the-id-wordpress-function" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-07-08T16:32:13-07:00" />
  <meta name="author" content="Jeff Matson" />
  <meta name="description" content="In this article, we will intorduce you to the get_the_ID() WordPress function that can be used to get the ID of your WordPress posts within the loop." />
  <title>The get_the_ID() WordPress function - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/wordpress/get-the-id-wordpress-function" rel="canonical" />
...
<script>
  ...
  ga('send', 'pageview');
	...
	<!-- cid:b59d57e6470e3fb8765f4382ec325223 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '78.66.84.29']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>The get_the_ID() WordPress function</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															The get_the_ID() WordPress function									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>1,685</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jul 8, 2014'><span style='color:#606060;'>Published:</span> Jul 8, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>If you need to obtain the post ID from your posts, you can easily use the <em>get_the_ID()</em> WordPress function.  In this article, we will introduce you to the <em>get_the_ID()</em> function.</p>
<div class="alert alert-warning">This function can only be used inside <a href="http://www.inmotionhosting.com/support/website/wordpress/the-wordpress-loop">the WordPress loop</a>.</div>
<h2>Basic usage</h2>
<p class="code_block">&lt;?php get_the_ID(); ?&gt;</p>
<p>This function does not have any parameters that can be called within it.  It simply returns the post ID exactly as it is.</p>
<h2>Example</h2>
...
<p>In this example, we use the <em>get_the_ID()</em> function to get the post ID, and assign it to the <em>$postid</em> variable.  Then, we display the contents of the <em>$postid</em> variable using the PHP echo command.</p>
<h2>References</h2>
<p>For more information on the <em>get_the_ID()</em> function, take a look at the <a href="http://codex.wordpress.org/Function_Reference/get_the_ID" target="_blank"><em>get_the_ID()</em> WordPress Codex page</a>.</p>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/wordpress/get-the-id-wordpress-function&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/wordpress/get-the-id-wordpress-function'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD02MyZpZD0zMzQ3JnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
