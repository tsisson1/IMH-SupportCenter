<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:46743:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/oscommerce/new-store" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="keywords" content="install log in set up manually softaculous oscommerce" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="This course will explain how to get started with osCommerce." />
  <title>101: Getting Started with osCommerce | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/oscommerce/new-store" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:0d81819e761484778849a8ac26f80f9b -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '86.233.137.145']);
...
<div class='page-header'>
	<h1>101: Getting Started with osCommerce</h1>
</div>
<div class='section_listing'>
	<p>To get your osCommerce website working you will need to install, log in and set up your osCommerce software. This educational channel will explain how to get started with osCommerce.</p>	<table>
	<tr><td colspan='3'><h2>Installing and setting up osCommerce</h2><div>These articles will teach you the basics of setting up osCommerce on your server.</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 1:</td>
				<td style='padding-right:10px;'><div class='gold_star'></div></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/oscommerce/new-store/getting-started-guide-oscommerce'>Getting Started Guide OsCommerce</a>
					<div>In this article, we will introduce you to OSCommerce which is a free shopping cart and e-commerce software solution.</div>
					<div class='smallgrey'>Hits: 8,606</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'><div class='gold_star'></div></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/oscommerce/new-store/softaculous-install'>How to Install osCommerce via Softaculous</a>
					<div>Learn how to install osCommerce using the Softaculous installer tool.</div>
					<div class='smallgrey'>Hits: 784</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/oscommerce/new-store/installing-oscommerce-manually'>Installing osCommerce manually</a>
					<div>Follow this tutorial to learn how to install osCommerce manually.</div>
			...
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/oscommerce/new-store/oscommerce-manually-installing-oscommerce'>Manually Installing osCommerce Video</a>
					<div>How to manually install the OsCommerce e-commmerce program.</div>
					<div class='smallgrey'>Hits: 3,284</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'><div class='gold_star'></div></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/oscommerce/new-store/oscommerce-registerglobals-error'>OsCommerce - register_globals error</a>
					<div>In this article, we will discuss register_globals error upon installation and how to correct the error.</div>
					<div class='smallgrey'>Hits: 8,372</div>
				</td>
			</tr>
		<tr><td colspan='3' style='padding-top:20px;'><h2>osCommerce login</h2><div>The following articles deal with logging into osCommerce.</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 6:</td>
				<td style='padding-right:10px;'><div class='gold_star'></div></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/oscommerce/new-store/oscommerce-admin-login'>How to log into your osCommerce Admin dashboard</a>
					<div>In this osCommerce tutorial, we'll show you how to log into your administrative dashboard for the first time. </div>
					<div class='smallgrey'>Hits: 18,242</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/oscommerce/new-store/how-to-log-into-oscommerce'>How to change the osCommerce admin password</a>
					<div>When you manage an admin account in osCommerce you will need to know how to chance the password for your osCommerce. This article will teach you how.</div>
					<div class='smallgrey'>Hits: 2,447</div>
				</td>
			</tr>
		<tr><td colspan='3' style='padding-top:20px;'><h2>Basic osCommerce configuration</h2><div>The following tutorials teach about the catalog and the home page of your osCommerce site.</div></td></tr>	<tr>
				<td style='width:75px; font-weight:bold;'>Section 8:</td>
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/oscommerce/new-store/oscommerce-store-configure'>Configuring your store in OsCommerce</a>
					<div>This tutorial shows you how to configure your store in your OcCommerce shop.</div>
					<div class='smallgrey'>Hits: 4,197</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/oscommerce/new-store/oscommerce-editing-your-home-page'>Editing your home page in OSCommerce</a>
					<div>Learn to edit your Homepage in the OsCommerce ecommerce program.</div>
					<div class='smallgrey'>Hits: 5,652</div>
				</td>
			</tr>
			</table>
</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zNzAmaWQ9MzcwJnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="807ff979f21dcb346529de029e9c2cdf" value="1" />	</div>
	</form>
<!-- <br />
