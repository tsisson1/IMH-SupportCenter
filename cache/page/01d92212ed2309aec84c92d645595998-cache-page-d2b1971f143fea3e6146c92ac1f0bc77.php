<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:60513:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/drupal-8/comments/set-page-max" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-11-21T16:43:47-08:00" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="This article teaches you how to adjust the maximum number of comments allowed per page in Drupal 8." />
  <title>Setting maximum comments per page in Drupal 8 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/drupal-8/comments/set-page-max" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:9e2562e74d51ada302966a393ab2b5be -->
	...
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
				<img src='/support/images/stories/drupal-partner/supporting-partner-80_3.png' style='float:right; margin:0px 0px 15px 15px;' alt='Drupal Association Support Partner'>		<h1>
															Setting maximum comments per page in Drupal 8									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>292</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Nov 21, 2013'><span style='color:#606060;'>Published:</span> Nov 21, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Drupal allows you to control the number of comments that appear on your pages. The default is set to 50, which means up to 50 comments will display  per page. Any comments beyond the first 50 will then display on a second page. Below is a guide to help you adjust the maximum number of comments per page in your Drupal 8 site.</p>

<h2>How to set the max comments per page</h2>
...
<li>Using the top menu bars, first click on the <strong>Menu</strong> option. When the second menu bar appears, click on the <strong>Structure</strong> option.<div style="clear:both;"></div></li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/107/adjust-max-comments/1-select-content-type.png"><img style="float:right; margin:0px 0px 15px 15px;"  alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/107/adjust-max-comments/1-select-content-type.png" title="Click here to view the larger image" max-width="250" /></a>
From the <em>Structure</em> menu page, find and click on the <strong>Content Types</strong> link.<div style="clear:both;"></div></li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/107/adjust-max-comments/2-select-manage-fields.png"><img style="float:right; margin:0px 0px 15px 15px;"  alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/107/adjust-max-comments/2-select-manage-fields.png" title="Click here to view the larger image" max-width="250" /></a>
Here you will see a list of all the content types that you can use currently. Find the one you want to manage and click on the <strong>Manage Fields</strong> option from the right hand dropdown. In this example, we will be working with the <em>Article</em> content type.<div style="clear:both;"></div></li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/107/adjust-max-comments/3-select-edit.png"><img style="float:right; margin:0px 0px 15px 15px;"  alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/107/adjust-max-comments/3-select-edit.png" title="Click here to view the larger image" max-width="250" /></a>
Now that you are on the <em>Manage Fields</em> tab for the <em>Article</em> content type, locate the <em>Comment Settings</em> row from the list of field types and click on the <strong>Edit</strong> option from the right hand dropdown.<div style="clear:both;"></div></li>

<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/107/adjust-max-comments/4-select-comments-per-page.png"><img style="float:right; margin:0px 0px 15px 15px;"  alt="" src="//cdn.inmotionhosting.com/support/images/stories/edu/Drupal-8/107/adjust-max-comments/4-select-comments-per-page.png" title="Click here to view the larger image" max-width="250" /></a>
This leads to the <em>Comment settings</em> page. Find the <strong>Comments per page</strong> dropdown and select your desired maximum number of comments per page. They range in different increments starting at 10 and go up to 300.<div style="clear:both;"></div></li>

<li>Once you have set the dropdown to your desired amount, click on the <strong>Save settings</strong> button at the bottom of the page.<div style="clear:both;"></div></li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 5: Setting maximum comments per page in Drupal 8</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 4: <a href='/support/edu/drupal-8/comments/add-comment-field'>Adding a comment field to a basic page in Drupal 8</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 6: <a href='/support/edu/drupal-8/comments/customize-comments'>Customizing your Comments field in Drupal 8</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/drupal-8/comments/set-page-max&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/drupal-8/comments/set-page-max'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP3RzcmM9cnNiZWR1Jm9wdGlvbj1jb21fY29udGVudCZjYXRpZD00NzgmaWQ9Mjk5MiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="9c21b98c4dc054b8a70dddf61ee4bec4" value="1" />	</div>
	</form>
<!-- <br />
