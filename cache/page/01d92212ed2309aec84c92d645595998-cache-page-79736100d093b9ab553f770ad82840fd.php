<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:58729:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/server-usage/easyapache-3-vs-easyapache-4" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello SSDCougars, Thanks for the question about EasyApache 3 vs EasyApache 4. There really should not be a reason for you not to use EasyApache 4 unless..." />
  <title>EasyApache 3 vs EasyApache 4 | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/server-usage/easyapache-3-vs-easyapache-4" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:992b10c52d646c025583b99b8f9df4b3 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-20']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '90.112.156.169']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>EasyApache 3 vs EasyApache 4</h1>
		<div style='margin-bottom:20px; margin-top:10px; clear:both; color:#6e6e6e;'>Category: <a href='/support/community-support/server-usage'>Server Usage</a></div>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/ssdcougars'>ssdcougars</a>
			<div>50 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2016-01-06 3:21 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>2,771</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I was puxing around with WHM and saw EasyApache 3 and EasyApache 4. I always like running the latest and greatest software, however, I've been burned before by incompatibilities. Are there any reasons why I should stay with EasyApache 3.32.8 and not upgrade to 4? I'm running wordpress, nothing really special.</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_8903' id='upvote_answer_8903' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='8903' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_8903').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_8903' id='downvote_answer_8903' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='8903' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_8903').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello SSDCougars,<br />
<br />
Thanks for the question about EasyApache 3 vs EasyApache 4.  There really should not be a reason for you not to use EasyApache 4 unless there is some compelling option in version 3 that is not present in version 4.  As far as I know, 4 is an improvement on 3.  You can find more details by going to the <a href="https://documentation.cpanel.net/display/EA4/Introduction+to+EasyApache+4" rel="nofollow" target="_blank">official documentation on the new version</a>.  As with <b>any</b> upgrade or change to your server software/installations, you should make a full backup before committing to any changes.<br />
<br />
...
Arnel C.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_8903').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_8903' id='form_comment_on_answer_8903' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Well, I tried the upgrade via the instructions provided in the link (https://documentation.cpanel.net/display/EA4/How%20to%20Install%20or%20Uninstall%20EasyApache%204) and received a 500 Internal Server error across my whole network. :(</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='/support/images/avatars/default_avatar.jpg' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/ssdcougars'>ssdcougars</a><br />
									50 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2016-01-07 3:16 pm EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>So I get errors that seem to be from Mod Security that are blocking the upgrades in critical paths. I have a copy of all of the error messages if I could email them to determine the best way to upgrade.</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Luckily I was able to revert back to 3 without issue (at least my sites are back up.), (although I was prompted about CRITICAL errors due to Mod_Sec.</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello ssdcougars,<br />
<br />
Thank you for contacting us. As a test, you can try <a href="http://www.inmotionhosting.com/support/website/modsecurity/disable-modsecurity-for-a-domain">disabling mod security</a > before installing. This requires <a href="http://www.inmotionhosting.com/support/website/cpanel-account-management/obtain-root-access">root</a> access, or a <a href="http://www.inmotionhosting.com/support/website/getting-started-guides/submitting-and-checking-on-status-of-tickets#submit-ticket">ticket</a> request.<br />
<br />
Thank you,<br />
John-Paul</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>John-Paul I tried that, and Mod_Sec still seems to be enabled. Yes, I am root and logged in SSH as root. I followed your directions posted, and made sure in WHM that Mod Sec was all set to Ignore Rules. I gracefully restarted HTTPD and I still get errors when trying to upgrade!</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>This time when I upgraded, one domain worked fine, the other 500'd.<br />
MOD_SEC - DESPITE BEING DISABLED VIA GUIDE- still reported false SQL Injections and PHP codes. http://www.ssdcougars.tv/error.png http://www.ssdcougars.tv/modsecerror.png <br />
I currently downgraded my server back to EA3 again and all seems well, but would like to upgrade without error. MOD_SEC seems to prevent this, even though I could have sworn it was globally disabled. Any suggestions?<br />
{As of now, I am back on EA3 and MOD_SEC reenabled} </div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>After several diagnostics I narrowed down a few things. MOD_SEC was blocking some crtitical things from updating. In addition to the link you provided, I went into each cPanel and disabled ModSec, and disabled via root, Mod Sec Vendors to ensure nothing was on at all. I initiated the upgrade. One site still showed a 500 error. After realizing that a random directory not a part of wordpress did NOT give me a 500 error, I discovered it was a Wordpress issue. I went about disabling plugins and noticed that it was seemingly random which ones I disabled and enabled that caused a 500 error. Lastly, after a ton of googling, I realized my php.ini file and wordpress memory limit settings did not match for this domain. WP was still defaulted at 64M while php.ini was 512M. I added &quot;define ( 'WP_MEMORY_LIMIT', '512M' ); to wp-config and all plugins, all pages, and all domains now work.</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/server-usage/easyapache-3-vs-easyapache-4&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/server-usage/easyapache-3-vs-easyapache-4'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="e089b2e9ddf0e6f237fc347f98572551" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
                                ...
                                <h3>Related Articles</h3><a target='_blank' href='http://inmotionhosting.com/support/linux-check-memory-usage'>Linux Memory Usage</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/edit-main-phpini'>Editing your main php.ini on VPS and Dedicated accounts</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/stop-man-in-the-middle-attacks'>Stopping man-in-the-middle attacks on VPS accounts</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/when-should-i-restart-my-vps'>When should I restart my VPS?</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/what-is-high-system-resource-usage'>What is high system resource usage?</a><br/><br />
		</div>
