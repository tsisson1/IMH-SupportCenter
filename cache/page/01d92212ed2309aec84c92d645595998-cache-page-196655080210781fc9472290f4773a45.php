<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:61430:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotion.net/support/edu/php-fusion/getting-started-php-fusion/install-php-fusion-manually" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-03-15T18:59:47-07:00" />
  <meta name="keywords" content="install php fusion php-fusion manually" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="When you cannot use Softaculous to install PHP-Fusion, you can get the files and install it on your server manually. This article will show you how." />
  <title>Installing PHP-Fusion manually - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/php-fusion/getting-started-php-fusion/install-php-fusion-manually" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:3023f16278845c00a1019f23b1ffd478 -->
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/php-fusion' itemprop='url'><span itemprop='title'>PHP-Fusion<span></a><div class='dropdown_2columns'><h2>PHP-Fusion Education Channel</h2><div class='col_2'><h3>100 Level Classes</h3><div><a href='/support/edu/php-fusion/getting-started-php-fusion'>101: Getting started with PHP-Fusion</a></div><div><a href='/support/edu/php-fusion/adding-content-to-php-fusion'>102: Adding content to your PHP-Fusion website</a></div><div><a href='/support/edu/php-fusion/working-with-menus-php-fusion'>103: Working with menus in PHP-Fusion</a></div><div><a href='/support/edu/php-fusion/changing-appearance-php-fusion'>104: Changing the PHP-Fusion Appearance</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/php-fusion/getting-started-php-fusion' itemprop='url'><span itemprop='title'>101: Getting started with PHP-Fusion<span></a><div class='dropdown_3columns'><h2> Getting started with PHP-Fusion</h2><div class='col_3'><div>1. <a style='display:inline;' href='/support/edu/php-fusion/getting-started-php-fusion/installing-php-fusion-softaculous'>Installing PHP-Fusion with Softaculous</a></div><div>2. <a style='display:inline;' href='/support/edu/php-fusion/getting-started-php-fusion/install-php-fusion-manually'>Installing PHP-Fusion manually</a></div><div>3. <a style='display:inline;' href='/support/edu/php-fusion/getting-started-php-fusion/login-admin-panel'>How to login to the PHP-Fusion Admin Panel</a></div><div>4. <a style='display:inline;' href='/support/edu/php-fusion/getting-started-php-fusion/change-reset-password'>How to change/reset my PHP-Fusion password</a></div><div>5. <a style='display:inline;' href='/support/edu/php-fusion/getting-started-php-fusion/changing-languages-in-php-fusion'>Changing Languages in PHP-Fusion</a></div><div>6. <a style='display:inline;' href='/support/edu/php-fusion/getting-started-php-fusion/security-options'>Security Options in PHP-Fusion</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Installing PHP-Fusion manua...</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Installing PHP-Fusion manually									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>1,778</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Mar 15, 2013'><span style='color:#606060;'>Published:</span> Mar 15, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/php-fusion/101/install-manually/install-manually-1-download.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="text" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/php-fusion/101/install-manually/install-manually-1-download.png" title="Click here to view the larger image" width="100" /></a>In the event you cannot install PHP-Fusion on your server using Softaculous, you can install PHP-Fusion manually by downloading the files from the PHP-Fusion site.</p>
<p>To get started installing PHP-Fusion manually, you will need to download the "<em>PHP-Fusion v7.02.06 (full) 7.02.06</em>" files. Visit the following link and click the Download icon for PH-Fusion.</p>
<pre style="margin-left: 20px;">http://www.php-fusion.co.uk/downloads.php?cat_id=23&amp;download_id=264</pre>
<p>You should have the following file on your Desktop.</p>
<pre style="margin-left: 20px;">PHP-Fusion_7-02-06_full.zip</pre>
<p>After you get the files, follow the steps below to install PHP-Fusion to your server.<br style="clear: both;" /></p>
<h2>Steps to install PHP-Fusion manually</h2>
...
<li><a href="/support/edu/cpanel/cpanel-file-manager/using-file-manager-in-cpanel" target="_blank" title="Click here for info">Go to the File Manager</a>. Select the directory you want to install PHP-Fusion on and click Go.</li>
<li><a target="_blank" href="/support/website/how-to/how-to-edit-a-file" title="How do I upload a file on my server?">How to upload a file</a> to your server. <a target="_blank" href="/support/website/cpanel/compressing-uncompressing-files">Extract the .zip file</a>. Make sure the software is not in a files subfolder. If so you will need to <a target="_blank" href="/support/website/how-to/how-to-move-files-on-server" title="How do I move files on my server?">move the files</a> to the document root.</li>
<li><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/php-fusion/101/install-manually/install-manually-3-save-config.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="text" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/php-fusion/101/install-manually/install-manually-3-save-config.png" title="Click here to view the larger image" width="100" /></a><strong>Make a copy of the _config.php</strong> file and name it config.php. <br style="clear: both;" /></li>
<li><strong>Create a database</strong>and add a user with full permissions to that database.
<p class="alert">Make sure you notate the username, database name and password you set for the Database. This will be needed on Step 3.</p>
</li>
<li><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/php-fusion/101/install-manually/install-manually-4-language.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="text" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/php-fusion/101/install-manually/install-manually-4-language.png" title="Click here to view the larger image" width="100" /></a>Visit the url where you uploaded the files on your server. On Step 1, select your language and click <strong>Next</strong>. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/php-fusion/101/install-manually/install-manually-5-write-perms.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="text" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/php-fusion/101/install-manually/install-manually-5-write-perms.png" title="Click here to view the larger image" width="100" /></a>On Step 2, PHP-Fusion will check the file permissions on the server. When finished, click <strong>Next</strong>. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/php-fusion/101/install-manually/install-manually-6-database-cred.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="text" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/php-fusion/101/install-manually/install-manually-6-database-cred.png" title="Click here to view the larger image" width="100" /></a>Enter the Database username, name, and password. :Leave the other settings as is. Click <strong>Next</strong>. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/php-fusion/101/install-manually/install-manually-7-success.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="text" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/php-fusion/101/install-manually/install-manually-7-success.png" title="Click here to view the larger image" width="100" /></a>On Step 4, you should see a confirmation that the database tables were created. Click <strong>Next</strong>. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/php-fusion/101/install-manually/install-manually-8-admin-details.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="text" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/php-fusion/101/install-manually/install-manually-8-admin-details.png" title="Click here to view the larger image" width="100" /></a>Enter the admin username. you will need 2 different passwords, one for the standard login and one for the admin login. Click <strong>Next</strong>. <br style="clear: both;" /></li>
<li><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/php-fusion/101/install-manually/install-manually-9-finish.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="text" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/php-fusion/101/install-manually/install-manually-9-finish.png" title="Click here to view the larger image" width="100" /></a>You should see a confirmation that PHP-Fusion was installed. Click <strong>Next</strong>. <br style="clear: both;" />
<p><a class="std_ss" href="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/php-fusion/101/install-manually/install-manually-10-new-php-fusion.png"><img style="float: right; margin: 0px 0px 15px 15px;"  alt="text" src="//imh01-inmotionhosting1.netdna-ssl.com/support/images/stories/edu/php-fusion/101/install-manually/install-manually-10-new-php-fusion.png" title="Click here to view the larger image" width="100" /></a>You should see a fresh install of PHP-Fusion on your domain now. <br style="clear: both;" /></p>
<p class="alert"><strong>Important!</strong> When you are done installing PHP-Fusion, you will need to delete the <strong>setup.php</strong> file from your server. If you don't you will get a "<em>Warning: setup.php detected, please delete it immediately</em>" error when loging in.</p>
</li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/php-fusion/getting-started-php-fusion'>101: Getting started with PHP-Fusion</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 2: Installing PHP-Fusion manually</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 1: <a href='/support/edu/php-fusion/getting-started-php-fusion/installing-php-fusion-softaculous'>Installing PHP-Fusion with Softaculous</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 3: <a href='/support/edu/php-fusion/getting-started-php-fusion/login-admin-panel'>How to login to the PHP-Fusion Admin Panel</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotion.net/support/edu/php-fusion/getting-started-php-fusion/install-php-fusion-manually&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotion.net/support/edu/php-fusion/getting-started-php-fusion/install-php-fusion-manually'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zNTEmaWQ9MjMwMiZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="3aa0a835636b87a32543788b1456ae34" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/php-fusion/getting-started-php-fusion?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Getting started with PHP-Fusion</h3></a>
		<table><tr><td colspan='2'><h4>Installing and Logging into PHP-Fusion</h4></td></tr>  <tr >
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/php-fusion/getting-started-php-fusion/installing-php-fusion-softaculous?tsrc=rsbedu'>Installing PHP-Fusion with Softaculous</a></td>
                </tr>
          <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/php-fusion/getting-started-php-fusion/install-php-fusion-manually?tsrc=rsbedu'>Installing PHP-Fusion manually</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/php-fusion/getting-started-php-fusion/login-admin-panel?tsrc=rsbedu'>How to login to the PHP-Fusion Admin Panel</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/php-fusion/getting-started-php-fusion/change-reset-password?tsrc=rsbedu'>How to change/reset my PHP-Fusion password</a></td>
                </tr>
        <tr><td colspan='2'><h4>Other base configuration settings</h4></td></tr>  <tr >
                        <td valign='top'>5.</td>
                        <td><a href='/support/edu/php-fusion/getting-started-php-fusion/changing-languages-in-php-fusion?tsrc=rsbedu'>Changing Languages in PHP-Fusion</a></td>
                </tr>
          <tr >
                        <td valign='top'>6.</td>
                        <td><a href='/support/edu/php-fusion/getting-started-php-fusion/security-options?tsrc=rsbedu'>Security Options in PHP-Fusion</a></td>
                </tr>
          	</table>
