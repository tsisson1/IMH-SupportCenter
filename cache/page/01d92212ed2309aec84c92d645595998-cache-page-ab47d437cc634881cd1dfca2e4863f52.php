<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:61690:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/wordpress/migrating-wordpress-inmotion-hosting/configuring-wordpress-after-a-migration" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-10-24T19:06:53-07:00" />
  <meta name="keywords" content="server move migration wordpress configuration wp-config.php" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="Learn how to configure your WordPress website after you have migrated it to your InMotion Hosting account. " />
  <title>Configuring WordPress After a Migration - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/wordpress/migrating-wordpress-inmotion-hosting/configuring-wordpress-after-a-migration" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:8875e5f5283b70f13b6fe6145049421a -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '72.198.173.131']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Configuring WordPress After a Migration									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>21,718</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Aug 31, 2011'><span style='color:#606060;'>Published:</span> Oct 24, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>So far in this tutorial you have <a href="/support/edu/wordpress/migrating-wordpress-inmotion-hosting/migrating-your-wordpress-database">migrated your WordPress database</a> and <a href="/support/edu/wordpress/migrating-wordpress-inmotion-hosting/migrating-wordpress-files">copied the files</a> associated with your website. The next step you will need to update your configuration settings so the files you just migrated can communicate correctly with the database. Until you perform this, your site will not display any content and you will receive a <a href="/support/website/database-connections/is-mysql-available">database connection error</a>.</p>
<p>A few steps ago in this tutorial we asked you to write down the <em>database name</em>, <em>username</em>, and <em>password</em>. Now, we will need this information to continue the migration process.</p>
<h2>Opening the wp-config.php file</h2>
<ol class="article_list">
  <li><p><a href="/support/edu/cpanel/getting-started-cpanel/how-to-log-into-cpanel">Log into your cPanel account</a>.</p></li>
<li><p>Click on <strong>File Manager</strong> located in the <em>Files</em> section of cPanel.</p>
<p>&nbsp;<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/WP/open_filemanager.jpg"><img src="//cdn.inmotionhosting.com/support/images/stories/WP/open_filemanager.jpg" alt="open_filemanager"  /></a></p></li>
<li><p>Choose <strong>web root</strong> and make sure to check <strong>show hidden files</strong>. Next, click <strong>Go</strong>.</p></li>
  <li><p>In the right window pane of file manager, navigate to the folder to which you uploaded <em>WordPress</em>.</p></li>
<li><p>Find the file <strong>wp-config.php</strong>, right-click on it, and choose <strong>edit</strong>.</p>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/WP/edit_wp-config.jpg"><img src="//cdn.inmotionhosting.com/support/images/stories/WP/edit_wp-config.jpg" alt="edit_wp-config"  /></a></p>
  </li>
</ol>

<h2>Editing the wp-config.php File</h2>
<p>For the purposes of this tutorial we will say we created the database with the following database credentials:</p>
<ul>
<li><strong>Database name</strong>: inmoti5_wpress</li>
<li><strong>Database username</strong>: inmoti5_wpuser</li>
<li><strong>Database password</strong>: secretpassword123</li>
</ul>
<p>&nbsp;</p>
<p>Our current cpanel username is <em>inmoti5</em> and as you will notice it automatically adds the prefix to database names and usernames.</p>
<table>
<tbody>
<tr>
<td>
  <p>The database credentials that <em>WordPress</em> uses to connect to your database are contained within the <em>wp-config</em> file. What we will need to do is find the files and simply change them. Start off by finding this section within the <em>wp-config.php</em> file:</p>
<div class="code_block">
<p><span>// ** MySQL settings - You can get this info from your web host ** //</span><br /><span>/** The name of the database for WordPress */</span><br /><strong>define('DB_NAME', 'userna5_wp1');</strong></p>
<p>/** MySQL database username */<br /><strong>define('DB_USER', 'userna5_wp1');</strong></p>
<p>/** MySQL database password */<br /><strong>define('DB_PASSWORD', 'passwordgoeshere');</strong></p>
<p>/** MySQL hostname */<br /><strong>define('DB_HOST', 'localhost');</strong></p>
</div>
  <p>Take a look carefully at the above code, and you should see that this file is define what the <em>database name</em>, <em>username</em>, and <em>password</em> are. The value '<em>localhost</em>' is very commonly defined as the host, and the average user does not need to change this. After you find this section, update the values accordingly. In our example, the new changes will look like this:</p>
<div class="code_block" style="border-style: initial; border-color: initial; font-style: inherit; vertical-align: baseline; margin: 0px;">
<p>// ** MySQL settings - You can get this info from your web host ** //<br /><span>/** The name of the database for WordPress */</span><br />define('DB_NAME', '<strong>inmoti5_wpress</strong>');</p>
<p>/** MySQL database username */<br />define('DB_USER', '<strong>inmoti5_wpuser</strong>');</p>
<p>/** MySQL database password */<br />define('DB_PASSWORD', '<strong>secretpassword123</strong>');</p>
<p><span>/** MySQL hostname */</span><br />define('DB_HOST', 'localhost');</p>
</div>
<p>After you've made the above changes, click the <strong>Save Changes</strong> button in the upper right.</p>
  <p>There are only a couple of steps left to migrating your <em>WordPress</em> site. In the next tutorial we will discuss how to correct image links from your posts and pages.</p>
</td>
</tr>
</tbody>
</table>
<p>Please check the next article on <a href="/support/edu/wordpress/migrating-wordpress-inmotion-hosting/correct-image-links">Correcting image links after a WordPress migration</a>. If you missed our previous article, please see the <a href="/support/edu/wordpress/migrating-wordpress-inmotion-hosting/migrating-wordpress-files" title="Click here to view the previous article" target="_blank">Migrating WordPress Files</a> tutorial. For more information on this course please visit <a target="_blank" href="/support/edu/wordpress/migrating-wordpress-inmotion-hosting" title="Click here to view the courses">Migrating your Existing WordPress site to InMotion Hosting</a>.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 4: Configuring WordPress After a Migration</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 3: <a href='/support/edu/wordpress/migrating-wordpress-inmotion-hosting/migrating-wordpress-files'>Migrating WordPress Files</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 5: <a href='/support/edu/wordpress/migrating-wordpress-inmotion-hosting/correct-image-links'>Correcting image links after a WordPress migration</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/wordpress/migrating-wordpress-inmotion-hosting/configuring-wordpress-after-a-migration&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/wordpress/migrating-wordpress-inmotion-hosting/configuring-wordpress-after-a-migration'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xMzAmaWQ9MTA1NCZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="dc21893c83325ef0b53988e846ab128e" value="1" />	</div>
	</form>
<!-- <br />
          ...
          <tr >
			...
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/wordpress/how-get-access-to-wpadmin?tsrc=rsbraq'>How get access to wp-admin</a>
                                </div>
