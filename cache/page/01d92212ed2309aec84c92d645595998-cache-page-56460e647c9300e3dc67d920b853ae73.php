<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:45440:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/mediawiki" />
	...
	<h2>Most Popular Articles</h2>
		<div style='width:300px; height:75px; float:left; margin-right:20px;'>
						...
						<div style='width:300px; height:75px; float:left; margin-right:20px;'>
							...
							<div class='smallgrey'>Hits: 24,785</div>
						</div>
						<div style='width:300px; height:75px; float:left; margin-right:20px;'>
...
<form action="http://www.inmotionhosting.com/support/edu/mediawiki" method="post" name="adminForm" id="adminForm" class="form-inline">
