<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49223:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/phpbb" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Learn how to add a community board section or create a forum based site with the phpBB software." />
  <title>phpBB | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/phpbb" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:d5318949808b95a9eb2ac58cae54532e -->
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>phpBB</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	...
	<div class='item-page'>
		<div class='page-header'>
			<h1>phpBB Education Channel</h1>
		</div>
	
<div style='clear:both;'></div>

<div class='edu_class_listing white_box'>
	<h2>phpBB Tutorials</h2>
	<ul style='float:left; width:300px; margin-right:20px;'>
<li  ><a href='/support/edu/phpbb/getting-started-phpbb'>101: Getting Started in phpBB 3.0</a></li>
<li  ><a href='/support/edu/phpbb/manage-forums'>102: Creating Forums in phpBB 3.0</a></li>
<li  ><a href='/support/edu/phpbb/working-with-users'>103: Working with Users in phpBB 3.0</a></li></ul><ul style='float:left; width:300px; margin-right:20px;'>
<li  ><a href='/support/edu/phpbb/general-settings'>201: Working with General Settings in phpBB 3</a></li>
<li  ><a href='/support/edu/phpbb/manage-posting-settings'>202: Working with posting settings in phpBB 3.0</a></li>
<li  ><a href='/support/edu/phpbb/managing-permissions'>203: Managing permissions in phpBB 3.0</a></li>
<li  ><a href='/support/edu/phpbb/manage-styles'>204: Managing styles and themes in phpBB 3.0</a></li>
<li  ><a href='/support/edu/phpbb/maintaining-forum'>205: Forum moderation in phpBB 3.0</a></li>
<li  ><a href='/support/edu/phpbb/manage-system-settings'>206: Manging System Settings in phpBB 3.0</a></li></ul><div style='clear:both;'></div></div>
...
<div class='edu_most_popular white_box'>
	<h2>Most Popular Articles</h2>
		<div style='width:300px; height:75px; float:left; margin-right:20px;'>
							<a href='/support/edu/phpbb/manage-styles/remove-footer'>How to Remove Powered by phpBB in phpBB 3.R</a>
							<div class='smallgrey'>Hits: 94,789</div>
						</div>
						<div style='width:300px; height:75px; float:left; margin-right:20px;'>
						...
						<div style='width:300px; height:75px; float:left; margin-right:20px;'>
							<a href='/support/edu/phpbb/maintaining-forum/how-to-prune-forums'>PhpBB 3.0 - Forum Pruning</a>
							<div class='smallgrey'>Hits: 10,855</div>
						</div>
						<div style='width:300px; height:75px; float:left; margin-right:20px;'>
							<a href='/support/edu/phpbb/maintaining-forum/manage-forums'>How to manage your forum logs in phpBB 3.0</a>
							<div class='smallgrey'>Hits: 10,558</div>
						</div>
						<div style='width:300px; height:75px; float:left; margin-right:20px;'>
							<a href='/support/edu/phpbb/maintaining-forum/post-approval'>Approving a post in phpBB 3.0</a>
							<div class='smallgrey'>Hits: 10,527</div>
						</div>
						<div style='width:300px; height:75px; float:left; margin-right:20px;'>
							<a href='/support/edu/phpbb/manage-system-settings/change-logo'>How to replace the default logo in phpBB 3.0</a>
							<div class='smallgrey'>Hits: 9,454</div>
						</div>
						<div style='clear:both;'></div>
</div>
...
<form action="http://www.inmotionhosting.com/support/edu/phpbb" method="post" name="adminForm" id="adminForm" class="form-inline">
	...
	<option value="0">All</option>
		...
		<h2>phpBB - Advanced Tutorials</h2>
		<table style='margin-top:20px;'>
			...
			<tr>
				...
				<td valign='top' style='padding-bottom:15px;'>
					<div><a href='/support/edu/phpbb/301-edit-registration-page'>301: How to Modify the Registration Page Text in phpBB</a></div>
					<div>Need to change your terms of registration for new members? Learn how to change the text with this phpBB article.</div>
					<div class='smallgrey'>
			...
			<tr>
				...
				<td valign='top' style='padding-bottom:15px;'>
					<div><a href='/support/edu/phpbb/301-fixing-the-specified-forum-image-does-not-exist-error'>302: Fixing "The specified forum image does not exist" error in phpBB</a></div>
					<div>This article will explain how to fix the Warning: The specified forum image does not exist error.</div>
					<div class='smallgrey'>
			...
			<tr>
				<td valign='top' style='padding:6px 15px 0px 0px;'><img src='https://lh5.googleusercontent.com/-sqOlcmmeoz4/AAAAAAAAAAI/AAAAAAAAAIM/EKb76fhiG6s/photo.jpg?sz=50' class='sc_rc' style='width:55px;' /></td>
				<td valign='top' style='padding-bottom:15px;'>
					<div><a href='/support/edu/phpbb/303-allowing-e-mail-re-use-in-phpbb'>303: Allowing e-mail re-use in phpBB</a></div>
					<div>To allow multiple email addresses for user registration in phpBB you can set the option to yes. This article will explain how.</div>
					<div class='smallgrey'>
						Written by James Richardson<br />
						Hits: 1,915
					</div>
			...
			<tr>
				<td valign='top' style='padding:6px 15px 0px 0px;'><img src='https://lh3.googleusercontent.com/-et9qjCJVL08/AAAAAAAAAAI/AAAAAAAAAC4/C539ZYF2HNc/s90-p-rw-no/photo.jpg' class='sc_rc' style='width:55px;' /></td>
				<td valign='top' style='padding-bottom:15px;'>
					<div><a href='/support/edu/phpbb/304-bypass-new-user-group'>304: How to bypass the Newly Registered Users group in phpBB</a></div>
					<div>New users are automatically assigned to the Newly Registered Users group. Learn to bypass this requirement in this phpbb article.</div>
					<div class='smallgrey'>
						Written by Scott Mitchell<br />
						Hits: 4,461
					</div>
			...
			<tr>
				<td valign='top' style='padding:6px 15px 0px 0px;'><img src='https://lh3.googleusercontent.com/-et9qjCJVL08/AAAAAAAAAAI/AAAAAAAAAC4/C539ZYF2HNc/s90-p-rw-no/photo.jpg' class='sc_rc' style='width:55px;' /></td>
				<td valign='top' style='padding-bottom:15px;'>
					<div><a href='/support/edu/phpbb/305-manage-account-activation'>305: How to manage new account activation in phpBB</a></div>
					<div>Want to manage the way new members are activated? Check out this phpBB article to learn how.</div>
					<div class='smallgrey'>
						Written by Scott Mitchell<br />
						Hits: 5,743
					</div>
			...
			<tr>
				<td valign='top' style='padding:6px 15px 0px 0px;'><img src='https://lh3.googleusercontent.com/-et9qjCJVL08/AAAAAAAAAAI/AAAAAAAAAC4/C539ZYF2HNc/s90-p-rw-no/photo.jpg' class='sc_rc' style='width:55px;' /></td>
				<td valign='top' style='padding-bottom:15px;'>
					<div><a href='/support/edu/phpbb/306-change-group-display-color'>306: How to change your group's display color in phpbb</a></div>
					<div>You can change the color of different user groups so that the name of group members stand out in the Online list. Learn how in this phpBB tutorial. </div>
					<div class='smallgrey'>
						Written by Scott Mitchell<br />
						Hits: 2,422
					</div>
			...
			<tr>
				<td valign='top' style='padding:6px 15px 0px 0px;'><img src='https://lh3.googleusercontent.com/-et9qjCJVL08/AAAAAAAAAAI/AAAAAAAAAC4/C539ZYF2HNc/s90-p-rw-no/photo.jpg' class='sc_rc' style='width:55px;' /></td>
				<td valign='top' style='padding-bottom:15px;'>
					<div><a href='/support/edu/phpbb/307-create-user-ranks'>307: How to create and manage user ranks in phpBB 3.0</a></div>
					<div>Looking to create user ranks so your users can have some fun? Find out how in this phpBB 3.0 tutorial.</div>
					<div class='smallgrey'>
						Written by Scott Mitchell<br />
						Hits: 1,982
					</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0xMDQmaWQ9MTA0JnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
