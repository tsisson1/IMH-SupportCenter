<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:54096:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/email/did-i-do-this-cron-job-correctly" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Rachel75, You should be able to import your current subscribers list to Mailchimp and nothing will change that your subscribers can see. I apologi..." />
  <title>Did I do this cron job correctly? | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/email/did-i-do-this-cron-job-correctly" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:50d13d8086ef6e9ea05caa5b6f6fbba2 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Did I do this cron job correctly?</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-08-28 1:06 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>41</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I just followed instructions from Gopiplus to set up a cron job. The idea is to send out an e-mail automatically to my subscribers just once a week rather than with every new post as it is now, using Gopiplus's subscribers wordpress plugin. Being completely computer illiterate, I'm nervous that I didn't follow the instructions right. Can someone check and make sure I did it right? Here's what the table at the bottom says now:<br />
<br />
Minute	Hour	Day	Month	Weekday	Command	Actions<br />
0	           0	           *	             *	               0	                     /bin/wget -O /dev/null “http://rachelheller.org/?es=cron&amp;guid=udnish-bdyimt-stzobg-lypdti-jbgcua&quot;	<br />
<br />
So did I do it right? The inmotion help center has instructions for automating e-mails, but not for this plug-in. I'm afraid if I switch plug-ins I'll lose the few subscribers I already have! Many fellow bloggers recommend mailchimp, but I'm afraid to switch over. Any help/reassurance would be greatly appreciated!</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_8001' id='upvote_answer_8001' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='8001' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_8001').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_8001' id='downvote_answer_8001' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='8001' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_8001').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello,<br />
<br />
Your cron job does look to be correct. However on the Mailchimp side, we also use this service and it has taken a big load off of our monthly activities for gathering signups and distributing list to our subscribers. So I would honestly suggest Mailchimp if you have less than 12000 subscribers as then it is free.<br />
<br />
Best Regards,<br />
TJ Edens
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_8001').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_8001' id='form_comment_on_answer_8001' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Can I change over to Mailchimp without losing the subscribers I already have?</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='/support/images/avatars/default_avatar.jpg' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/rachel75'>rachel75</a><br />
									3 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2015-08-28 2:34 pm EST
								</div>
...
<div class='  not_best_answer'>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px; width:50px;' valign='top'>
<div class='vote_div'>
	<form method='post' name='upvote_answer_8004' id='upvote_answer_8004' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='8004' />
		<input type='hidden' name='component' id='component' value='qa' />
		<input type='hidden' name='vote_value' id='vote_value' value='1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_8004').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_8004' id='downvote_answer_8004' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='8004' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_8004').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello Rachel75,<br />
<br />
You should be able to import your current subscribers list to Mailchimp and nothing will change that your subscribers can see. I apologize for my delayed response.<br />
<br />
Best Regards,<br />
TJ Edens
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_8004').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_8004' id='form_comment_on_answer_8004' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
					                <p>You must <a href='/support/login'>login</a> before you can post a comment about this answer.</p>
					        </div></div></div></div>
					</form>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/email/did-i-do-this-cron-job-correctly&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/email/did-i-do-this-cron-job-correctly'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="e53a88a6b25edc64df602672ba7b366e" value="1" />	</div>
	</form>
<!-- <br />
