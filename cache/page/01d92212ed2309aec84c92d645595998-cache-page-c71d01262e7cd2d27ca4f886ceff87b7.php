<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:50695:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/send-email-from-a-page/form-not-working-on-my-website" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Joefontana@gmail.com, Sorry for the PHP-based email form not working on your website. You may need to adjust your form to use SMTP in order to wor..." />
  <title>Form not working on my website | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/send-email-from-a-page/form-not-working-on-my-website" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:51d5add60cc069bc9953907fe6522247 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Form not working on my website</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/joefontana@gmail&per;com'>joefontana@gmail.com</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-12-23 12:44 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>215</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>For http://crowntastic.com (user: xxxxx pass: xxxxxx) I am using a free HTML5 template called &quot;Oxygen&quot;. My problem is that the sendmail.php file does not send out email from the contact form. Here is the sendmail.php code; btw the email address it sends to has been tested so that's not the issue; any help is very much appreciated!<br />
<br />
&lt;?php<br />
$name       = @trim(stripslashes($_POST['name'])); <br />
$from       = @trim(stripslashes($_POST['email'])); <br />
$subject    = @trim(stripslashes($_POST['subject'])); <br />
$message    = @trim(stripslashes($_POST['message'])); <br />
$to   		= 'xxxx@crowntastic.com';//replace with your email<br />
<br />
$headers   = array();<br />
$headers[] = &quot;MIME-Version: 1.0&quot;;<br />
$headers[] = &quot;Content-type: text/plain; charset=iso-8859-1&quot;;<br />
$headers[] = &quot;From: {$name} &lt;{$from}&gt;&quot;;<br />
$headers[] = &quot;Reply-To: &lt;{$from}&gt;&quot;;<br />
$headers[] = &quot;Subject: {$subject}&quot;;<br />
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_8815' id='upvote_answer_8815' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='8815' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_8815').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_8815' id='downvote_answer_8815' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='8815' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_8815').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>32,263 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2015-12-23 1:18 pm EST
                		        </div>
					
		                </div>

				Hello Joefontana@gmail.com,<br />
<br />
Sorry for the PHP-based email form not working on your website.  You  may need to adjust your form to use SMTP in order to work.  Check out <a href="http://www.inmotionhosting.com/support/email/send-email-from-a-page/why-wont-my-php-app-send-mail" target="_blank">Why won't my PHP app send mail</a>?  This tutorial describes the settings for SMTP that will help resolve your mail sending issue.  I hope that helps to answer your question!  If you require further assistance, please let us know!<br />
<br />
Regards,<br />
Arnel C.
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_8815').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_8815' id='form_comment_on_answer_8815' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="64e93558b92eaf8b6be27b59ee5794b1" value="1" />	</div>
	</form>
<!-- <br />
