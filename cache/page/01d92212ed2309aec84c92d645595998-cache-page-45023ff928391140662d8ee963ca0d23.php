<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:56364:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/drupal-7/311-fixing-the-an-unrecoverable-error-occurred-error-in-drupal" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-03-26T20:49:54-07:00" />
  <meta name="keywords" content="An unrecoverable error occurred. The uploaded file likely exceeded the maximum file size (32 MB) that this server supports drupal" />
  <meta name="author" content="James Richardson" />
  <meta name="description" content="This article will explain the cause of the &quot;An unrecoverable error occurred. The uploaded file likely exceeded the maximum file size (32 MB) that this server supports&quot; error in Drupal." />
  <title>311: Fixing the &quot;An unrecoverable error occurred&quot; error in Drupal - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/drupal-7/311-fixing-the-an-unrecoverable-error-occurred-error-in-drupal" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:b42520b1e5c73cf4e07468dc0e0e1f86 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-21']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '190.25.99.218']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															311: Fixing the &quot;An unrecoverable error occurred&quot; error in Drupal									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>6,530</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Mar 26, 2013'><span style='color:#606060;'>Published:</span> Mar 26, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>When installing a New Drupal installation or upgrading your Drupal you may experience the following error.</p>
<p style="margin-left:20px;">"An unrecoverable error occurred. The uploaded file likely exceeded the maximum file size (32 MB) that this server supports."</p>
<h2>What causes this error?</h2>
<p>There are several reasons this error may be thrown. There may be an issue with the <em>php.ini settings</em>, <em>conflicting .htaccess or settings.php code</em>, or you may be <em>flagging Apache's mod_security</em>. Below are some fixes to this &quot;<em>An unrecoverable error</em>&quot; occurred error.</p>
<h3>Checking the php.ini memory settings</h3>
<p><a href="/support/website/general-server-setup/update-local-php-settings">Edit your local PHP settings</a> to see if your file size settings are high enough for your Drupal to work. The following shows a typical file size settings</p>
<pre style="margin-left:20px;">post_max_size = 128 MB
upload_max_filesize = 32MB</pre>
<p>You can increase the <em>post_max_size</em> and the <em>upload_max_filesize</em> to a higher number to see if this fixes the problem. You will need to <a href="/support/website/general-server-setup/recursive-php-ini" target="_blank" title="Click here for info">make the php.ini recursive in the .htaccess</a> for the change to take effect.</p>
<h3>Check the .htaccess or settings.php for conflicting code</h3>
<p><a href="/support/website/general-server-setup/what-is-the-htaccess-file-and-what-do-i-use-it-for">Edit the .htaccess</a> file to see if there are any overrides in the code. Some server configurations allow <em>.htaccess</em> settings to override your file upload size. <a href="/support/edu/website-design/website-design-basics/comment-php-javascript-html-css-code">Comment any code</a> that controls the files upload size and save the changes.</p>
<p>The <em>settings.php</em> file also can hold overrides for the file upload size. <a href="/support/website/how-to/find-config-files">Edit the settings.php</a> directly on the server or you can change the settings through the Drupal dashboard by going to <strong>Administer > Site configuration > File uploads</strong> and updating the settings from there.</p>
<h3>Apache mod_security is flagging bad code</h3>
<p><a href="/support/website/website-troubleshooting/what-is-modsecurity-and-why-is-it-important">Mod Security is an Apache Module</a> that scans incoming <em>http</em> requests for any malicious scripts. There may be an issue with the script causing mod_security  to stop the script. In the event that mod_security is causing the error, you will need to contact <a href="/support/website/website-troubleshooting/how-to-get-great-technical-support" target="_blank" title="Click here for how to contact support">tech support</a> to have them look at the logs to see what is exactly causing mod_security to flag the uploaded file. You may need to <a href="/support/website/website-troubleshooting/disable-mod-security-via-modsec-manager">Disable mod_security via cPanel Modsec Manager</a> on your specific domain if there is no work around. Otherwise, tech support will need do this for you.</p>
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 3: 311: Fixing the &quot;An unrecoverable error occurred&quot; error in Drupal</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 2: <a href='/support/edu/drupal-7/302-how-to-enable-maintenance-mode-in-drupal'>302: How to enable maintenance mode in Drupal 7</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 4: <a href='/support/edu/drupal-7/309-locate-db-name'>309: How to find your Drupal 7 database name</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/drupal-7/311-fixing-the-an-unrecoverable-error-occurred-error-in-drupal&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/drupal-7/311-fixing-the-an-unrecoverable-error-occurred-error-in-drupal'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD05OCZpZD0yNTMxJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
