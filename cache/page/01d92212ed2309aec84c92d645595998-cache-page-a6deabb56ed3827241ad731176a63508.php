<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:72385:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/ftp-client-setup/ftp-internet-explorer" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2016-04-21T22:52:11-07:00" />
  <meta name="keywords" content="FTP Internet Explorer transferring files with IE" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="the following tutorial will assist you with connecting to your account via FTP using Internet Explorer (versions 7 and 8). " />
  <title>How to FTP with Internet Explorer 7/8 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/ftp-client-setup/ftp-internet-explorer" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:ac4dfce64ccfd5f8ded1ebd7121a1566 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '1.186.48.58']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>How to FTP with Internet Explorer 7/8</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to FTP with Internet Explorer 7/8									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>38,702</span></div>
							...
							<div style='clear:both;'></div>
								...
								<p>The following tutorial will assist you with connecting to your account via <a href="/support/website/ftp/getting-started-guide">FTP</a> using the Internet Explorer browser (versions 7 and 8). This is an easy way to use FTP with your web hosting account, and will work on all <a href="http://www.inmotionhosting.com/business-hosting">shared</a> / <a href="http://www.inmotionhosting.com/vps-hosting">VPS</a> / and <a href="http://www.inmotionhosting.com/dedicated-servers" target="_blank">dedicated servers</a>.</p>

<h2>Setting up FTP in Internet Explorer 7/8</h2>
<ol class="article_list">
  <li>Open <strong>Internet Explorer</strong>.</li>
  <li>In the address bar, type the following and then hit enter:<br />
    ftp://userna5:password@example.com<br />
    
<table style="list-style-type: none; list-style-position: initial; list-style-image: initial; font: normal normal normal 12px/140% 'Lucida Sans Unicode', 'Lucida Grande', Verdana, Arial, sans; color: #484848; padding: 0px; margin: 0px;">
<tbody>
<tr style="list-style-type: none; list-style-position: initial; list-style-image: initial; font: normal normal normal 12px/140% 'Lucida Sans Unicode', 'Lucida Grande', Verdana, Arial, sans; color: #484848; padding: 0px; margin: 0px;">
<td style="list-style-type: none; list-style-position: initial; list-style-image: initial; font: normal normal normal 12px/140% 'Lucida Sans Unicode', 'Lucida Grande', Verdana, Arial, sans; color: #484848; padding: 0px; margin: 0px;"><b>userna5</b></td>
<td style="list-style-type: none; list-style-position: initial; list-style-image: initial; font: normal normal normal 12px/140% 'Lucida Sans Unicode', 'Lucida Grande', Verdana, Arial, sans; color: #484848; padding: 0px; margin: 0px;"><i>replace this with your cPanel username</i></td>
</tr>
<tr style="list-style-type: none; list-style-position: initial; list-style-image: initial; font: normal normal normal 12px/140% 'Lucida Sans Unicode', 'Lucida Grande', Verdana, Arial, sans; color: #484848; padding: 0px; margin: 0px;">
<td style="list-style-type: none; list-style-position: initial; list-style-image: initial; font: normal normal normal 12px/140% 'Lucida Sans Unicode', 'Lucida Grande', Verdana, Arial, sans; color: #484848; padding: 0px; margin: 0px;"><b>password</b></td>
<td style="list-style-type: none; list-style-position: initial; list-style-image: initial; font: normal normal normal 12px/140% 'Lucida Sans Unicode', 'Lucida Grande', Verdana, Arial, sans; color: #484848; padding: 0px; margin: 0px;"><i>replace this with your cPanel password</i></td>
</tr>
<tr style="list-style-type: none; list-style-position: initial; list-style-image: initial; font: normal normal normal 12px/140% 'Lucida Sans Unicode', 'Lucida Grande', Verdana, Arial, sans; color: #484848; padding: 0px; margin: 0px;">
<td style="list-style-type: none; list-style-position: initial; list-style-image: initial; font: normal normal normal 12px/140% 'Lucida Sans Unicode', 'Lucida Grande', Verdana, Arial, sans; color: #484848; padding: 0px; margin: 0px;"><b>example.com </b></td>
<td style="list-style-type: none; list-style-position: initial; list-style-image: initial; font: normal normal normal 12px/140% 'Lucida Sans Unicode', 'Lucida Grande', Verdana, Arial, sans; color: #484848; padding: 0px; margin: 0px;"><i>replace this with your actual domain name</i></td>
</tr>
</tbody>
</table>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/IE/ie8_ftp_1.gif"><img src="//cdn.inmotionhosting.com/support/images/stories/IE/ie8_ftp_1.gif" style="padding: 1px;" alt="ie8_ftp_1"  /></a></p>
<p>When you have connected successfully, you will see a page similar to the following:<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/IE/ie8_ftp_2.gif"><img src="//cdn.inmotionhosting.com/support/images/stories/IE/ie8_ftp_2.gif" style="padding: 1px;" alt="ie8_ftp_2"  /></a></p>
    </li>

<li>Click, "<strong>Page</strong>" and then click, "<strong>Open FTP Site in Windows Explorer</strong>"<br />.<a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/IE/ie8_ftp_3.gif"><img src="//cdn.inmotionhosting.com/support/images/stories/IE/ie8_ftp_3.gif" style="padding: 1px;" alt="ie8_ftp_3"  /></a></li>
<li>You will receive a generic, "<strong>FTP Folder Error</strong>". Click <strong>OK</strong> to continue.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/IE/ie8_ftp_4.gif"><img src="//cdn.inmotionhosting.com/support/images/stories/IE/ie8_ftp_4.gif" style="padding: 1px;" alt="ie8_ftp_4"  /></a></li>
<li>Click, "<strong>File</strong>", "<strong>Login As...</strong>"<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/IE/ie8_ftp_5.gif"><img src="//cdn.inmotionhosting.com/support/images/stories/IE/ie8_ftp_5.gif" style="padding: 1px;" alt="ie8_ftp_5"  /></a></li>
<li>Enter your cPanel username as the, "<strong>User name</strong>", and enter your cPanel password as the, "<strong>Password</strong>". Click, "<strong>Log On</strong>"<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/IE/ie8_ftp_6.gif"><img src="//cdn.inmotionhosting.com/support/images/stories/IE/ie8_ftp_6.gif" style="padding: 1px;" alt="ie8_ftp_6"  /></a></li>
</ol>
<p>You are now connected to your account via FTP! To upload files, you can either copy/paste them into the ftp window, or you can drag and drop them from your desktop to the ftp window.</p> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/ftp-client-setup/ftp-internet-explorer&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/ftp-client-setup/ftp-internet-explorer'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MDEmaWQ9NDAmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/576e7e9013dbe8591b1808d30729b675?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/576e7e9013dbe8591b1808d30729b675'>somnath</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-25 4:11 am</div>
				                <div><p>hi, i having a issue inserting the password, my password contening @ sign</p>
<p>ie. ftp://user:user@1@myftp.com/</p>
<p>user = User Name</p>
<p>user@1 = Password</p>
<p>myftp.com = actual domain name</p>
<p>kindly suggest how to pass the url in internet explorer without changing the password. as i am not the ftp server administrator.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16700);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-27 7:14 am</div>
				                <div>Hello somnath,<br />
<br />
Thank you for your question. I found a possible <a href="http://forums.cpanel.net/f5/problems-using-username-internet-explorer-ftp-56364.html" target="_blank" >workaround</a> via online search, where they suggest using the hex value.<br />
<br />
For example: <br />
user%401 = Password<br />
<br />
If this does not help, it may be easier to use an FTP client such as FileZilla.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16755);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-27 8:26 am</div>
				                <div><p>Sir, in that example. The "@" sine is in the user name. But in my case the "@" sine is with the password only... Password = "passkey@123"</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16757);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
				...
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-27 8:40 am</div>
				                <div>Hello somnath,<br />
<br />
I understand the article was not exactly the same, but it was the only possible workaround I was able to find.<br />
<br />
Since IE 7 and 8 are very old and outdated (they are on IE11), it would be much simpler just to use <a href="http://www.inmotionhosting.com/support/website/ftp-client-setup/add-a-ftp-site-to-your-windows-favorites">Windows Explorer</a>, <a href="http://www.inmotionhosting.com/support/website/ftp-client-setup/configuring-your-site-in-filezilla">FileZilla</a> or one of the many other free FTP clients available. With older software it is difficult to troubleshoot, since it is no longer supported by its creator.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16760);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
