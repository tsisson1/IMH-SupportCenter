...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/wordpress/get-the-post-thumbnail-wordpress-function" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-09-02T21:26:28-07:00" />
  ...
  <title>The get_the_post_thumbnail() WordPress function - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/wordpress/get-the-post-thumbnail-wordpress-function" rel="canonical" />
...
<script>
  ...
  ga('send', 'pageview');
	...
	<!-- cid:71b41b88ed7eec41d4129a211f880763 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '82.170.102.151']);
...
<div class='col_1'>
    <ul>
		...
		</li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>The get_the_post_thumbnail() WordPress function</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															The get_the_post_thumbnail() WordPress function									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>7,830</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Jul 1, 2014'><span style='color:#606060;'>Published:</span> Sep 2, 2014</div>
							...
							<div style='clear:both;'></div>
								...
								<p>The <em>get_the_post_thumbnail()</em> WordPress function will allow you to get the featured image and display it using your theme or plugin.  In this article, we will teach you how to use the <em>get_the_post_thumbnail()</em> function to display featured images anywhere you want to.</p>
<p>If you would like more information on creating WordPress plugins, see our tutorial series on <a href="http://www.inmotionhosting.com/support/website/wordpress-development/create-your-first-wordpress-plugin">creating your first WordPress plugin</a>.</p>
<div class="alert alert-warning"><p><strong>Note:</strong> To use the <em>get_the_post_thumbnail() function, you will need to enable support for it within your theme.</em></p>
...
<p>As you can see from the above code, the image size is 100x100.</p>
...
<h2>References</h2>
<p>For more information on the <em>get_the_post_thumbnail()</em> function, take a look at the <a href="http://codex.wordpress.org/Function_Reference/get_the_post_thumbnail"><em>get_the_post_thumbnail()</em> WordPress codex page</a>.</p>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/wordpress/get-the-post-thumbnail-wordpress-function&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/wordpress/get-the-post-thumbnail-wordpress-function'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD02MyZpZD0zMzMyJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/b8436a25936d66f990b47ec798ac66e9?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/b8436a25936d66f990b47ec798ac66e9'>kallol banerjee</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-08 3:33 am</div>
				                <div>Give the parameters when we use a loop to get the post id.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12485);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-08 1:02 pm</div>
				                <div>Hello Kallol,<br />
<br />
For more explicit information concerning the POST ID, please reference the WordPress codex on this function.  Here is the specific link to the get post reference:  <a href="http://codex.wordpress.org/Function_Reference/get_post_meta" rel="nofollow" target="_blank">get post meta</a>.<br />
<br />
Kindest regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12498);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
