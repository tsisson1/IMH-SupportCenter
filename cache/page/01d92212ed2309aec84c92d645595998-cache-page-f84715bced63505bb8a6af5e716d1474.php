<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:71158:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-3/menu/create-menu-and-module" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2014-09-29T16:13:00-07:00" />
  <meta name="keywords" content="create joomla 3.0 menu module" />
  <meta name="author" content="Brad Markle" />
  <meta name="description" content="In this tutorial, we will show you how to create a menu and menu module in Joomla 3.0" />
  <title>How to Create a Menu and Menu Module in Joomla 3.1 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-3/menu/create-menu-and-module" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:23ea9d4fe7445c51d138fe6b091f6a06 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															How to Create a Menu and Menu Module in Joomla 3.1									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>42,663</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Sep 27, 2012'><span style='color:#606060;'>Published:</span> Sep 29, 2014</div>
  ...
  <button type="button" class="btn btn-primary" onclick="trackAnchorClickSC('create-menu');">Creating a Menu</button>
  <button type="button" class="btn btn-success" onclick="trackAnchorClickSC('create-menu-module');">Creating a Menu Module</button>
</div>

<p>An important part of making your website easy to navigate is by creating menus. The initial creation of a menu is generally a two step process, <strong>creating the menu</strong> and then <strong>creating a module</strong> for the menu. In this tutorial, we will walk you through the steps for setting up a menu in Joomla 3.0.</p>
<p> </p>

<a name="create-menu"></a>
<h2>How to create a menu in Joomla 3.0</h2>
...
<li>In the top menu, click <strong>Menus</strong> and then click <strong>Menu Manager</strong></li>
<li>In the top left of the page, click the <strong>New</strong> button</li>
<li>Enter the following details for your menu, and then click the <strong>Save &amp; Close</strong> button in the top left of the page:<br /> 
<table class="article_table">
<tbody>
<tr>
<th>Title</th>
<td>The title of the menu to display in the Administrator Menubar and lists.</td>
</tr>
<tr>
<th>Menu type</th>
<td>The system name of the menu.</td>
</tr>
<tr>
<th>Description</th>
<td>A description about the purpose of the menu.</td>
</tr>
</tbody>
</table>
<p>In our testing, we are creating a menu to list the <em>test articles</em> that we have created.</p>
<p><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/menus/creating-a-new-menu.gif"><img style="margin: 0px 0px 15px 15px; float: right;"  alt="creating-a-new-menu" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/menus/creating-a-new-menu.gif" /></a><strong>Title</strong>: Test Articles<br /><strong>Menu type</strong>: testarticles<br /><strong>Description</strong>: A list of our test articles</p>
<p>At this point, you have successfully created a new menu! Our next step is to create a module for this menu.</p>
<div style="clear: both;"></div>
</li>
</ol>
<p> </p>

<a name="create-menu-module"></a>
<h2>How to Create a Menu Module in Joomla 3.0</h2>
<ol class="article_list">
<li><a href="/support/edu/joomla-3/getting-started/login-dashboard">Log into your Joomla 3.0 Admin Dashboard</a></li>
<li>In the top menu, click <strong>Menus</strong> and then click <strong>Menu Manager</strong></li>
<li><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/menus/add-a-module-for-this-menu-type.gif"><img  alt="add-a-module-for-this-menu-type" src="//cdn.inmotionhosting.com/support/images/stories/edu/joomla-3/menus/add-a-module-for-this-menu-type.gif" style="float: right; margin: 0px 0px 15px 15px;" /></a> In the list of menus, find the menu you want to create a module for. Within the table, under the <em>Linked Modules</em> heading, click the link next to the menu that says <strong>Add a module for this menu type</strong>.
<div style="clear: both;"></div>
</li>
<li>There are many different settings you can configure for your new module. In our testing, we are only going to enter just a few settings:<br /> 
<table class="article_table">
<tbody>
<tr>
<th>Title</th>
<td><em>Module must have a title</em></td>
<td>Test Articles</td>
</tr>
<tr>
<th>Position</th>
<td><em>You may select a module position from the modal display of <a href="/support/edu/joomla-3/extension/viewing-module-positions">pre-defined positions</a> where you can filter by type and template, or enter your own module position by typing the name in the field and Save.</em></td>
<td>Right [position-7]</td>
</tr>
</tbody>
</table>
<p>When finished entering the settings for your new menu, click the <strong>Save &amp; Close</strong> button in the top menu.</p>
</li>
</ol>
<p class="alert">Even though we have created a new menu and menu module, it will not show up on our website until we <a href="/support/edu/joomla-3/menu/add-menu-item">add a new menu item to our menu</a>.</p> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						...
						<div style='text-align:center;color:#c52228;'>You are viewing Section 1: How to Create a Menu and Menu Module in Joomla 3.1</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								<td valign='top' style='width:50%;border-right:1px solid #aaa;text-align:left;padding-right:10px;'>
									...
									Section 0: <a href='/support/edu/joomla-3/menu/quiz'>Quiz - Joomla 3 menus</a>
								</td>
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 2: <a href='/support/edu/joomla-3/menu/add-menu-item'>Adding a Menu Item to a Menu in Joomla 3.1</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/joomla-3/menu/create-menu-and-module&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/joomla-3/menu/create-menu-and-module'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yNjMmaWQ9MTgxMyZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
          ...
          <tr >
			...
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/joomla-3/menus-pages?tsrc=rsbraq'>How do Joomla menus and pages work?</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-02 5:46 am</div>
				                <div><p>I am a beginner joomla developer. Gradually i am learning development of websites in joomla. Commercailly i have just got my 1st website order. Feeling very difficult to complete the order. So, taking the help from this website is fantastic. In future I EXPECT YOU PEOPLE &nbsp;TO HELP ME IN ALL MY JOOMLA DIFFICULTIES.</p>
<p>&nbsp;THANKYOU</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8711);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/97fb3261f6a15cb6999d0a3bf6c84141?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/97fb3261f6a15cb6999d0a3bf6c84141'>Biplob</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-03-03 9:30 am</div>
				                <div><p>This article is really helpful.If someone learn about joomla 2.5 then it is easier to learn 3+ joomla</p>
<p>Thank you</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(8723);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-12506'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/560bba87970e6083c3b8530a4e2d87b4?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/560bba87970e6083c3b8530a4e2d87b4'>Rick</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-08 4:45 pm</div>
				                <div>You're missing assigning the template part. There's also assigning the proper modules to your menu.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12506);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-07-08 5:09 pm</div>
				                <div>Hello Rick, and thanks for your comment,<br />
<br />
Can you please elaborate a bit on specifically what our guide is missing, is this information you're talking about not in the next article linked at the bottom of this one on &lt;a href=&quot;http://www.inmotionhosting.com/support/edu/joomla-3/menu/add-menu-item&quot; target=&quot;_blank&quot;&gt;adding a menu item to a menu in Joomla&lt;/a&gt;?<br />
<br />
- Jacob</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(12507);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-05 11:52 pm</div>
				                <div><p>Hi,</p>
<p>thanks for the steps and the screenshots,</p>
<p>and also for the link which redirects me to "how to access joomla admin side" page.</p>
<p>its really very helpful to create me a menu and menu module, its very easy for new joomla user to follow your steps and screen shots.</p>
<p>thanks agian.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13677);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-08-05 11:55 pm</div>
				                <div>its easy to follow your steps and screen shot are very easy to understand.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(13678);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
