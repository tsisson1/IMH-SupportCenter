<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:49986:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/zen-cart/cant-view-new-installed-template-in-zencart" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hi archtech, Thanks for posting your question. I'm sorry you're having issues with a blank screen in ZenCart. I'm more than happy to help you. A blank s..." />
  <title>Can&amp;#039;t view new installed template in zencart | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/zen-cart/cant-view-new-installed-template-in-zencart" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:abf356ac22d510269993ecbcd6664ac8 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Can&amp;#039;t view new installed template in zencart</h1>
		<div style='margin-bottom:20px; margin-top:10px; clear:both; color:#6e6e6e;'>Category: <a href='/support/community-support/zen-cart'>Zen Cart</a></div>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/archtech'>archtech</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2012-04-24 12:26 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>1,295</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>I downloaded and installed new zencart template. I can't view the same in temp. URL.<br />
Can some one help?</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_946' id='upvote_answer_946' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='946' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_946').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_946' id='downvote_answer_946' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='946' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_946').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hi archtech,<br />
<br />
Thanks for posting your question. I'm sorry you're having issues with a blank screen in ZenCart. I'm more than happy to help you. <br />
<br />
A blank screen is an indicator of an error. ZenCart automatically logs the error in the /cache folder. If you look in your cache folder there's files that start with "myDEBUG" and these files contain the errors the site is having. <br />
<br />
I've looked at your error logs and it looks like you are missing a file "includes/modules/sideboxes/languages_header.php"<br />
<br />
I'd make sure to re-attempt to upload all the files and folders again and see if that corrects the issue.<br />
<br />
...
Tim S
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_946').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_946' id='form_comment_on_answer_946' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/zen-cart/cant-view-new-installed-template-in-zencart&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/zen-cart/cant-view-new-installed-template-in-zencart'></div>
<script type='text/javascript'>
  (function() {
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
                                ...
                                <h3>Related Articles</h3><a target='_blank' href='http://inmotionhosting.com/support/admin-dash-login'>Logging into the ZenCart admin dashboard</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/installing-a-theme-in-zencart'>Installing a theme in Zencart</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/finding-db-name'>Finding the database name for your Zen Cart website</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/mass-price-adjustment'>How to perform a mass price increase for all products in Zen Cart.</a><br/><br />
<a target='_blank' href='http://inmotionhosting.com/support/resetting-your-zencart-admin-password'>Resetting your Zen Cart 1.5 Admin Password in PHPMyAdmin</a><br/><br />
		</div>
