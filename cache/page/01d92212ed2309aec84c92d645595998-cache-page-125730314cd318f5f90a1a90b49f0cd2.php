<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:45076:" 
...
<meta name="viewport" content="width=device-width" />
  ...
  <link href="http://www.inmotionhosting.com/support/search?searchword=what%20is%20mysql" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:ffae8921ba895fe8d35ba44ee1a54ebe -->
...
<div class='container'>
	...
	<div class='item-page'>
		<div class='page-header'><h1>Search results for: <span style='color:#aaa;'>what is mysql</span></h1></div>
		<form method='get' action='/support/search' >
                        <input type='text' name='searchword' id='mod-search-searchword' style='width:500px;' value='what is mysql' />
                        <button class='button btn btn-info' onclick='this.form.searchword.focus();' style='display:inline-block; width:80px; border-radius:3px; height:32px; line-height:22px; margin:0px;'>Search</button>
                	        ...
                	        <p><a href='http://www.inmotionhosting.com/support/community-support/wordpress/what-is-the-mysql-hostname-for-the-wpconfigphp-entry'>What is the <b>MySQL</b> hostname for the wp-config.php entry </a><br />Dec 24, 2012 <b>...</b> ... and thanks for your question. You only need to add the <b>MySQL</b> hostname of <br>
localhost for that DB_HOST variable. There are 4 places in total .</p>
	                
                	        <p><a href='http://www.inmotionhosting.com/support/website/database-setup/how-do-i-create-a-mysql-database-in-my-control-panel-cpanel'>How do I create a <b>MySQL</b> database in my control panel (cpanel <b>...</b></a><br />Jul 6, 2015 <b>...</b> In this article, we will explain how to create a new <b>MySQL</b> database in ... Creating <br>
a database in cPanel using the <b>MySQL</b> Database Wizard:.</p>
	                
                	        <p><a href='http://www.inmotionhosting.com/support/website/database-troubleshooting/error-1064'><b>MySQL</b> Error 1064: You have an error in your SQL syntax - InMotion <b>...</b></a><br />Mar 31, 2015 <b>...</b> Every version of <b>MySQL</b> has its own list of reserved words. These are words that <br>
are used for specific purposes or perform specific functions&nbsp;...</p>
	                
                	        <p><a href='http://www.inmotionhosting.com/support/website/getting-started-guides/cpanel-logs-for-access-apache-email-error-ftp-mysql-whm'>cPanel logs for access, Apache, email, error, ftp, <b>mysql</b>, and WHM <b>...</b></a><br />Feb 4, 2016 <b>...</b> This guide will cover the locations of the log files for things such as access logs, <br>
Apache web server logs, email logs, error logs, ftp logs, <b>MySQL</b>&nbsp;...</p>
	                
                	        <p><a href='http://www.inmotionhosting.com/support/website/database-connections/connect-database-remotely-mysql-workbench'>Connecting to a database with <b>MySQL</b> Workbench 5.2 - InMotion <b>...</b></a><br />Jan 16, 2015 <b>...</b> Download <b>MySQL</b> Workbench One tool you can use to connect to remotely <br>
connect to databases on your shared, VPS, or Dedicated hosting&nbsp;...</p>
	                
                	        <p><a href='http://www.inmotionhosting.com/support/website/amp/what-is-my-hostname'>What is my hostname ? - InMotion Hosting</a><br />Apr 21, 2016 <b>...</b> When you are running an application on the server that connects to <b>MySQL</b>, use &#39;<br>
localhost&#39; (without the quotes) as your <b>MySQL</b> hostname.</p>
	                
                	        <p><a href='http://www.inmotionhosting.com/support/community-support/website/database-connection-error'>Database connection error (2): Could not connect to <b>MySQL</b> <b>...</b></a><br />Sep 13, 2013 <b>...</b> Hello newsch5, Thank you for your error connecting to <b>mysql</b> question. If you are <br>
getting database connection errors, this means means that a&nbsp;...</p>
	                
                	        <p><a href='http://www.inmotionhosting.com/support/website/database-connections/is-mysql-available'>Database connection error - InMotion Hosting</a><br />Sep 24, 2013 <b>...</b> It means that a program running on your site is not able to communicate with the <br>
<b>MySQL</b> database service to retrieve data. There are two main&nbsp;...</p>
	                
                	        <p><a href='http://www.inmotionhosting.com/support/website/databases/setting-up-a-remote-mysql-connection-in-cpanel'>Setting up a Remote <b>MySQL</b> connection in cPanel - InMotion Hosting</a><br />Oct 28, 2013 <b>...</b> If you need to connect to your database using third party software that does not <br>
run on the server, such as a <b>MySQL</b> client on your desktop a&nbsp;...</p>
	                
                	        <p><a href='http://www.inmotionhosting.com/support/website/databases/how-to-change-mysql-server-time-zone'>How to change <b>MySQL</b> server time zone - InMotion Hosting</a><br />Nov 26, 2012 <b>...</b> In this article we&#39;ll discuss how you can change the <b>MySQL</b> time zone on your <br>
server so that data stored in your databases will by default use&nbsp;...</p>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP3NlYXJjaHdvcmQ9d2hhdCBpcyBteXNxbCZvcHRpb249Y29tX2NvbnRlbnQmY2F0aWQ9MzU2JmlkPTM1NiZ2aWV3PWNhdGVnb3J5Jkl0ZW1pZD0xMDE=" />
