<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:48546:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/joomla-25/user-profile" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Learn about the Joomla 2.5 User Profile Plugin" />
  <title>217: Joomla 2.5 User Profile Plugin | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/joomla-25/user-profile" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:9327658a04afd23ef1442d536b891173 -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-19']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '108.75.120.159']);
...
<div class='page-header'>
	<h1>217: Joomla 2.5 User Profile Plugin</h1>
</div>
<div class='section_listing'>
		...
		<tr>
				...
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/user-profile/enable-user-profile'>How to enable the Joomla 2.5 User Profile plugin</a>
					<div>In this tutorial, we'll show you how to enable the Joomla 2.5 user profile plugin.</div>
					<div class='smallgrey'>Hits: 9,741</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/user-profile/view-profile'>Viewing User Profiles in Joomla 2.5</a>
					<div>Learn more about Joomla 2.5 User Profiles by first seeing what the user sees as their profile.</div>
					<div class='smallgrey'>Hits: 10,156</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/user-profile/basic-options'>Understanding the Joomla 2.5 User Profile Plugin's Basic Options</a>
					<div>Within the Joomla 2.5 User Profile Plugin's settings, we'll explain the difference between Fields for registration and administrator user forms AND Profile fields for profile edit form.</div>
					<div class='smallgrey'>Hits: 9,146</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/user-profile/user-profile-menu-item'>How to create a User Profile menu item in Joomla 2.5</a>
					<div>Using the Joomla 2.5 menu manager, you can create a new menu item that points to the User Profile page, which will allow users to view and edit their user profile.</div>
					<div class='smallgrey'>Hits: 11,776</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/user-profile/copy-user-profile-plugin'>Adding Custom User Profile Fields in Joomla 2.5 - Step 1/3 - Copy the Plugin</a>
					<div>The first step in creating custom user profile fields is to copy the current user profile plugin. This will help ensure you don't lose your changes if a Joomla 2.5 update overwrites the files.</div>
					<div class='smallgrey'>Hits: 51,989</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/user-profile/front-end-form'>Adding Custom User Profile Fields in Joomla 2.5 - Step 2/3 - The Front End Form</a>
					<div>Our next step in adding custom user profile fields in Joomla 2.5 is to edit the front end form and ask the user to enter the new information.</div>
					<div class='smallgrey'>Hits: 25,299</div>
				</td>
			</tr>
			<tr>
				...
				<td style='padding-right:10px;'></td>
				<td style='padding-bottom:10px;'>
					<a href='/support/edu/joomla-25/user-profile/profile-plugin-parameters'>Adding Custom User Profile Fields in Joomla 2.5 - Step 3/3 - Plugin Parameters</a>
					<div>The final step in adding new fields to the Joomla 2.5 user profile plugin is to allow site administrators to toggle whether the new field is required or not.</div>
					<div class='smallgrey'>Hits: 39,020</div>
				</td>
			</tr>
			</table>
</div>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0yMjImaWQ9MjIyJnZpZXc9Y2F0ZWdvcnkmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="f45db966776d586dc4905ca14f2a6dc5" value="1" />	</div>
	</form>
<!-- <br />
