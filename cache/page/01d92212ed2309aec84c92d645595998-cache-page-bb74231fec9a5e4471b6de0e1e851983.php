<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:56256:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/cpanel/cannot-find-phpini-trying-to-upload-larger-backup-file-than-50mb" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello markomaja, Thank you for your question. Here is a helpful link to our guide on how to Increase the Max File Upload size in PHP.INI. If you do not ..." />
  <title>Cannot find php.ini / trying to upload larger backup file than 50Mb | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/cpanel/cannot-find-phpini-trying-to-upload-larger-backup-file-than-50mb" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:c73657e5e8acd845a5cd2d52f8d4f6b4 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>Cannot find php.ini / trying to upload larger backup file than 50Mb</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			<img src='https://lh4.googleusercontent.com/-fvHVKIg3SVE/AAAAAAAAAAI/AAAAAAAAADA/plz_8-eJ6Pk/photo.jpg?sz=90' class='user_avatar' /><br />
			<a href='/support/community-support/users/markomaja'>markomaja</a>
			<div>5 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2014-05-17 11:54 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>172</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Dear sir/madam, I need to change settings in phpMyAdmin in order to upload larger backupfile. Currently I can only load 50Mb which is not enough. I have followed your instructions how to upload larger backup files on the server, but when I tried to locate php.ini in order to copy it to my subdomain folder, I found out that I cannot locate it.<br />
<br />
Please help me!<br />
<br />
Thanks</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_5059' id='upvote_answer_5059' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='5059' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_5059').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_5059' id='downvote_answer_5059' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='5059' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_5059').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					<img src='https://lh5.googleusercontent.com/-e83rDg4p6b4/AAAAAAAAAAI/AAAAAAAAAJc/-cFi6snv9Lw/photo.jpg?sz=90' class='user_avatar' style='max-width:60px;' /><br />
                		        <a href='/support/community-support/users/cynthia_'>cynthia_</a>
				...
				Hi,<br />
<br />
Firstly, let me state that I'm not a member of the staff. I've a VPS via Inmotion Hosting, and I was in a similar situation.<br />
<br />
I solved the upload procedure with the use of a .htaccess file.<br />
<br />
---// example of .htaccess //----<br />
...
---// example of .htaccess //----<br />
<br />
I've uploaded the file to the root folder of my website.<br />
<br />
I hope it helps a little....<br />
<br />
TTFN<br />
Cynthia<br />
<br />
P.s. keep in mind that you've to create .htaccess with a program like notepad!  <br />
<br />
<br />
Disclaimer: always be cautious when working with. htaccess files, if you make a typo than your server will display an internal error message.  If you encounter troubles, then simply delete the .htaccess file. <br />
<br />
<br />
<br />
<br />
...
<br />
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_5059').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_5059' id='form_comment_on_answer_5059' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				        ...
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>P.s.  you can also use a third party program to access your database and create backup's, etc. I use dbForge studio. <br />
<br />
You can find it here: http://www.devart.com/dbforge/mysql/studio/<br />
<br />
</div>
								
				                        </td>
							<td style='width:96px;' valign='top'>
								<img src='https://lh5.googleusercontent.com/-e83rDg4p6b4/AAAAAAAAAAI/AAAAAAAAAJc/-cFi6snv9Lw/photo.jpg?sz=90' style='width:40px;' class='user_avatar' />
								<div class='smallgrey'>
									<a href='/support/community-support/users/cynthia_'>cynthia_</a><br />
									16 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2014-06-05 8:49 am EST
								</div>
...
<div class='  not_best_answer'>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px; width:50px;' valign='top'>
<div class='vote_div'>
	<form method='post' name='upvote_answer_5060' id='upvote_answer_5060' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='5060' />
		<input type='hidden' name='component' id='component' value='qa' />
		<input type='hidden' name='vote_value' id='vote_value' value='1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_5060').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_5060' id='downvote_answer_5060' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='5060' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_5060').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				Hello markomaja,<br />
<br />
Thank you for your question. Here is a helpful link to our guide on how to <a href="/support/" target="_blank" >Increase the Max File Upload size in PHP.INI</a>.<br />
<br />
If you do not have a default <strong>php.ini</strong> file, please <a href="http://www.inmotionhosting.com/contact">contact Live Tech Support</a>. They can copy the default <em>php.ini</em> for your server, to your account.<br />
<br />
...
-John-Paul
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_5060').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_5060' id='form_comment_on_answer_5060' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
					                <p>You must <a href='/support/login'>login</a> before you can post a comment about this answer.</p>
					        </div></div></div></div>
					</form>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/cpanel/cannot-find-phpini-trying-to-upload-larger-backup-file-than-50mb&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/cpanel/cannot-find-phpini-trying-to-upload-larger-backup-file-than-50mb'></div>
<script type='text/javascript'>
  (function() {
...
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src='//platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document,'script','twitter-wjs');</script>
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="a439cbac823b55077f7bf840eecfdb1a" value="1" />	</div>
	</form>
<!-- <br />
