<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:57429:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/wordpress/existing-mysql-new-install-of-wordpress-data-pages-not-appearing" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello Purpleshorts, Are you sure you pointed the WordPress configuration back to the correct database? Have you logged into PHPMyAdmin and checked the p..." />
  <title>Existing mySQL; new install of WordPress. Data (pages) not appearing. | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/wordpress/existing-mysql-new-install-of-wordpress-data-pages-not-appearing" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:d3debbfb97bd59cfc99e0367d0252550 -->
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box straight_bottom'>
                <h1 style='font-size:26px;'>Existing mySQL; new install of WordPress. Data (pages) not appearing.</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<a href='/support/community-support/users/purpleshorts'>purpleshorts</a>
			<div>16 <a href='/support/team/points' target='_blank'>Points</a></div>
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2015-08-14 9:55 am EST<br /><br />
				Hits: <span name='page_views' id='page_views'>90</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>1. WP site got hacked, quarantined. <br />
2. Reinstalled WP. (to avoid reinstating contaminated WP files)<br />
3. Edited wp-config file to point to old database (hoping to get old text back)<br />
4. In admin mode, no pages visible in list.</div>
	...
	<table style='width:100%;'>
		<tr>
			<td style='padding-right:15px;'>
				<div style='font-size:12px; max-width:500px; overflow:auto;'>How does one reconnect a new install of WP to an old/existing mySQL, and force WP to recognize it?</div>
			...
			<td style='width:100px;' valign='top'>
				...
				<div class='smallgrey'>
					<a href='/support/community-support/users/purpleshorts'>purpleshorts</a><br />
					16 <a href='/support/team/points' target='_blank'>Points</a><br />
					2015-08-14 09:58 am EST
				</div>
			</td>
		</tr>
	</table>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_7907' id='upvote_answer_7907' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='7907' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_7907').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_7907' id='downvote_answer_7907' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='7907' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_7907').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
				...
				<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
					...
					<div>9,548 <a href='/support/team/points' target='_blank'>Points</a></div>
                        		<div class='smallgrey' style='margin-top:10px;'>
						2015-08-14 10:11 am EST
                		        </div>
					
		                </div>

				Hello Purpleshorts,<br />
<br />
Are you sure you pointed the WordPress configuration back to the correct database? Have you logged into PHPMyAdmin and checked the pages table to make sure there are entries? <br />
<br />
Best Regards,<br />
TJ edens
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_7907').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_7907' id='form_comment_on_answer_7907' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Are you sure you pointed the WordPress configuration back to the correct database? <br />
-Yes<br />
Have you logged into PHPMyAdmin and checked the pages table to make sure there are entries? <br />
- I do not see a pages table. I see:<br />
wp_commentmeta<br />
wp_comments<br />
wp_da_commentmeta<br />
wp_da_comments<br />
wp_da_links<br />
wp_da_options<br />
wp_da_postmeta<br />
wp_da_posts<br />
wp_da_redirection_404<br />
wp_da_redirection_groups<br />
wp_da_redirection_items<br />
wp_da_redirection_logs<br />
wp_da_redirection_modules<br />
wp_da_terms<br />
wp_da_term_relationships<br />
wp_da_term_taxonomy<br />
wp_da_usermeta<br />
wp_da_users<br />
wp_da_wysija_campaign<br />
wp_da_wysija_campaign_list<br />
wp_da_wysija_custom_field<br />
wp_da_wysija_email<br />
wp_da_wysija_email_user_stat<br />
wp_da_wysija_email_user_url<br />
wp_da_wysija_form<br />
wp_da_wysija_list<br />
wp_da_wysija_queue<br />
wp_da_wysija_url<br />
wp_da_wysija_url_mail<br />
wp_da_wysija_user<br />
wp_da_wysija_user_field<br />
wp_da_wysija_user_history<br />
wp_da_wysija_user_list<br />
wp_links<br />
wp_options<br />
wp_postmeta<br />
wp_posts<br />
...
wp_users</div>
							...
							<td style='width:96px;' valign='top'>
								...
								<div class='smallgrey'>
									<a href='/support/community-support/users/purpleshorts'>purpleshorts</a><br />
									16 <a href='/support/team/points' target='_blank'>Points</a>
									<br />
									2015-08-14 10:52 am EST
								</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' >
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>How do I proceed? I don't see the pages table. You imply it should be there. But I know I did not delete it, and I have earlier backups of this database? p.s. Could you please answer this time with a statement and not questions? Even better, is it possible for you to email me directly or call?</div>
				...
				<div style='padding:15px 15px 15px px; border-top:1px dotted #ccc; ' class='round_bottom'>
				        <table style='width:100%'>
				                <tr>
				                        <td style='padding-right:15px;'>
                                				<div style='font-size:12px;'>Hello Purpleshorts,<br />
<br />
I spent some time looking at your database entries and found a few things.  First, the database that you're currently attaching to in WordPress is one that I rebuilt using an export from your "DA" db.  When I look at your databases in PHP, they're in a sub-structure which is not normal.  I created one outside of that in order to see if the website would come up normally.  If you pull up the database list in phpMyadmin, you'll see what I'm referring to.  The database need to be directly under the User ID (like your repaired db).  However, even after adding the normal WordPress .htaccess entries, the posts were not showing.  So, I took a longer look at the individual post entries.  We had changed the PERMALINK settings to default in order to reset them.  However, when I look in the database, ONLY the first post has a correct entry.  All of the other posts do not show a proper path.  I noticed that you did happen to have a rebuilt database that you might be using.  The entries in that database indicate a proper path for the posts.  <br />
<br />
WordPress "attaches" to a database by the entries within the wp-config.php file.  Yours are definitely working correctly, but the problem with your WordPress installation lies within the database.  Try using your rebuilt database with your installation.  It should work properly if the database entries have not  been affected by the hack or have been restored to their normal state.<br />
<br />
Apologies for not being able to call you.  Support Center assistance works through the posts on the website.  If you require immediate assistance, you are welcome to contact <a href="http://www.inmotionhosting.com/support/website/website-troubleshooting/how-to-get-great-technical-support">our live technical support team</a>.  They are available via phone/email/chat 24/7.<br />
<br />
...
Arnel C.</div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/wordpress/existing-mysql-new-install-of-wordpress-data-pages-not-appearing&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/wordpress/existing-mysql-new-install-of-wordpress-data-pages-not-appearing'></div>
<script type='text/javascript'>
  (function() {
