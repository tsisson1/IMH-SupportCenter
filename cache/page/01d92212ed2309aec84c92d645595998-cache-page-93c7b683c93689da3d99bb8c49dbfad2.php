<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:81035:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/edu/phpbb/manage-forums/add-new-forum" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2015-08-17T14:40:37-07:00" />
  <meta name="keywords" content="create new forum phpBB 3.0 [gs]" />
  <meta name="author" content="Scott Mitchell" />
  <meta name="description" content="This phpBB 3.0 article instructs you on how to create a new forum for your site." />
  <title>Creating a new forum in phpBB 3.0 - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/edu/phpbb/manage-forums/add-new-forum" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:ab7032f8ff4870ef437ed0e00feebfbd -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-23']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '24.27.62.128']);
...
</div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/phpbb' itemprop='url'><span itemprop='title'>phpBB<span></a><div class='dropdown_4columns'><h2>phpBB Education Channel</h2><div class='col_2'><h3>100 Level Classes</h3><div><a href='/support/edu/phpbb/getting-started-phpbb'>101: Getting Started in phpBB 3.0</a></div><div><a href='/support/edu/phpbb/manage-forums'>102: Creating Forums in phpBB 3.0</a></div><div><a href='/support/edu/phpbb/working-with-users'>103: Working with Users in phpBB 3.0</a></div></div><div class='col_2'><h3>200 Level Classes</h3><div><a href='/support/edu/phpbb/general-settings'>201: Working with General Settings in phpBB 3</a></div><div><a href='/support/edu/phpbb/manage-posting-settings'>202: Working with posting settings in phpBB 3.0</a></div><div><a href='/support/edu/phpbb/managing-permissions'>203: Managing permissions in phpBB 3.0</a></div><div><a href='/support/edu/phpbb/manage-styles'>204: Managing styles and themes in phpBB 3.0</a></div><div><a href='/support/edu/phpbb/maintaining-forum'>205: Forum moderation in phpBB 3.0</a></div><div><a href='/support/edu/phpbb/manage-system-settings'>206: Manging System Settings in phpBB 3.0</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_with_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><a href='/support/edu/phpbb/manage-forums' itemprop='url'><span itemprop='title'>102: Creating Forums in phpBB 3.0<span></a><div class='dropdown_3columns'><h2> Creating Forums in phpBB 3.0</h2><div class='col_3'><div>1. <a style='display:inline;' href='/support/edu/phpbb/manage-forums/add-new-forum'>Creating a new forum in phpBB 3.0</a></div><div>2. <a style='display:inline;' href='/support/edu/phpbb/manage-forums/new-topic'>How to create a new forum topic in phpBB 3.0</a></div><div>3. <a style='display:inline;' href='/support/edu/phpbb/manage-forums/new-reply'>How to reply to a topic in phpBB 3.0</a></div><div>4. <a style='display:inline;' href='/support/edu/phpbb/manage-forums/adding-a-new-category'>Adding a new category in phpBB  3.0</a></div></div></div></li><li class='bc_arrow'>&gt;&gt;</li><li class='bc_no_dd' itemscope itemtype='http://data-vocabulary.org/Breadcrumb'><span itemprop='title'>Creating a new forum in phpBB 3.0</span></li>			</ul>
		</div>
	</div>
</div>
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Creating a new forum in phpBB 3.0									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>6,314</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Dec 11, 2012'><span style='color:#606060;'>Published:</span> Aug 17, 2015</div>
							...
							<div style='clear:both;'></div>
								...
								<p>One of the basic features of a&nbsp; board administrator is to create new forums for your users in your phpBB board. The ability to create forums is only found in the Administator Control Panel, so only those with access to that panel can do so. Forums are 'containers' that house the topics and replies. They are usually organized in some way. For example, if you have a 'Sports' <a href="/support/edu/phpbb/manage-forums/adding-a-new-category">category</a>, you may want to have separate 'Baseball' and 'Basketball' forums. Inside each, the users will create different topics about their respecitve sport. The instructions below will demonstrate how to create a brand new forum for your site.</p>
<h2>
  How to create a new forum in phpBB 3.0</h2>
<ol class="article_list">
<li><a href="/support/edu/phpbb/getting-started-phpbb/phpbb-login">Log into your phpBB Administrator Control Panel (ACP)</a>.</li>
<li>From there, click on the <strong>Forums</strong> tab located across the top of the page.</li>
<li>This brings you to the Forums management screen. In the lower right corner of the screen, enter the name of the your new forum. Click on the <strong>Create New Forum</strong> button. In our example, the forum is named <em>First New Forum.</em><br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/forums/create-new-forum/forum-manage-screen.png"><img  alt="forum-manage-screen" src="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/forums/create-new-forum/forum-manage-screen.png" /></a></li>
<li>You will be taken to the forum settings page. The top section is the most important for new forums. There are several fields and settings to set up and customize when creating a new forum. Below is a table of the basic fields and their explanations. If you are unsure about the settings here, don't worry. They can always be changed later on. There are other sections below with many more settings for customization, but they are not important to the forum's creation and will be explained in later articles.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/forums/create-new-forum/new-forum-settings.png"><img  alt="new-forum-settings" src="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/forums/create-new-forum/new-forum-settings.png" /></a>
<table class="article_table">
<tbody>
<tr><th>Forum Type</th>
<td>Choose your forum type from the dropdown (Category, Forum, Link). In this case, we want to choose <strong>Forum</strong>.</td>
</tr>
<tr><th>Parent Forum</th>
<td>Select the parent of your new forum. You can have unlimited subfolders and place a new forum under a category, another forum, or have it be independent. In our example. we are going to place the forum under the category named <strong>Your First Category</strong>.</td>
</tr>
<tr><th>Copy Permissions From</th>
<td>Select a forum to copy your permissions from. If none, you will need to create permissions before it is active. Since we are provided with a default forum to select from, we will copy permissions from <strong>Your First Forum</strong>.</td>
</tr>
<tr><th>Forum Name</th>
<td>Give your forum a name.</td>
</tr>
<tr><th>Description</th>
<td>A statement describing the forum and its purpose.</td>
</tr>
<tr><th>Forum Image</th>
<td>Input the path for the forum's image. This is not a required field, so if you do not have an image ready or do not want one, simply leave it blank.</td>
</tr>
<tr><th>Forum Password</th>
<td>If you want to password protect your forum, enter the desired password here.</td>
</tr>
<tr><th>Confirm Forum Password</th>
<td>Re-enter the same password as above for confirmation.</td>
</tr>
<tr><th>Forum Style</th>
<td>Select your forum's style from the dropdown. This is a cosmetic change and can be changed later, so if you are unsure, simply leave <strong>Default Style</strong> selected.</td>
</tr>
</tbody>
</table>
</li>
<li>Once you have configured your first forum, scroll to the bottom and click on the <strong>Submit</strong> button to save your new forum and it's configuration. Your new forum will now appear in the forum list for its appropriate category. You will see it from the main screen when you click on the parent category.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/forums/create-new-forum/new-forum-after.png"><img  alt="new forum display" src="//cdn.inmotionhosting.com/support/images/stories/edu/phpbb/forums/create-new-forum/new-forum-after.png" /></a><br /><br />Now that you have learned to create a forum, you can either wait for visitors to <a href="/support/edu/phpbb/working-with-users/create-user">register</a> and create their own topics, or you may want to <a href="/support/edu/phpbb/manage-forums/new-topic">create a few topics</a> of your own.</li>
</ol> 
  ...
  <div class='quotebordered-first raised' style='margin:15px 0px;'>
					<div class='quotebordered raised'>
						<div style='text-align:center;font-size:18px;font-weight:bold;padding-top:15px;'>Continued Education in Course <a href='/support/edu/phpbb/manage-forums'>102: Creating Forums in phpBB 3.0</a></div>
						<div style='text-align:center;color:#c52228;'>You are viewing Section 1: Creating a new forum in phpBB 3.0</div>
						<table style='width:100%;margin:15px 0px;font-size:15px;line-height:17px;'>
							<tr>
								...
								<td valign='top' style='width:50%;text-align:right;padding-left:10px;'>
									...
									Section 2: <a href='/support/edu/phpbb/manage-forums/new-topic'>How to create a new forum topic in phpBB 3.0</a>
								</td>
							</tr>
						</table>
                                        	<div style='clear:both;'></div>
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/edu/phpbb/manage-forums/add-new-forum&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/edu/phpbb/manage-forums/add-new-forum'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP3RzcmM9cnNiZWR1Jm9wdGlvbj1jb21fY29udGVudCZjYXRpZD0zMDkmaWQ9MjA2NSZ2aWV3PWFydGljbGUmSXRlbWlkPTEwMQ==" />
		<input type="hidden" name="114be18ea7591948f7202b6e9f9e4d4f" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
		...
		<a href='/support/edu/phpbb/manage-forums?tsrc=rsbedu'><h3 style='border-bottom:1px solid #bbb; margin-bottom:10px; padding-bottom:2px; font-size:16px; line-height:17px;'> Creating Forums in phpBB 3.0</h3></a>
		<table>  <tr style='border-top:1px solid #bbb; border-bottom:1px solid #bbb; background:#eee;'>
                        <td valign='top'>1.</td>
                        <td><a href='/support/edu/phpbb/manage-forums/add-new-forum?tsrc=rsbedu'>Creating a new forum in phpBB 3.0</a></td>
                </tr>
          <tr >
                        <td valign='top'>2.</td>
                        <td><a href='/support/edu/phpbb/manage-forums/new-topic?tsrc=rsbedu'>How to create a new forum topic in phpBB 3.0</a></td>
                </tr>
          <tr >
                        <td valign='top'>3.</td>
                        <td><a href='/support/edu/phpbb/manage-forums/new-reply?tsrc=rsbedu'>How to reply to a topic in phpBB 3.0</a></td>
                </tr>
          <tr >
                        <td valign='top'>4.</td>
                        <td><a href='/support/edu/phpbb/manage-forums/adding-a-new-category?tsrc=rsbedu'>Adding a new category in phpBB  3.0</a></td>
                </tr>
          	</table>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/46f19bcda4a06d444e417dd2e93c5716?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/46f19bcda4a06d444e417dd2e93c5716'>YanSteven</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-19 3:42 am</div>
				                <div><p>&nbsp;</p>
<p>Dear sir, I can not open my PHPBB forum for a few days ..&nbsp;</p>
<div><span style="background-color: transparent;">Sir, PHPBB forum can't be opened for 3 days .. by YanSteven </span></div>
<div>need help .. thanks a lot&nbsp; ..</div>
<div>&nbsp;</div>
<div>Forum address:</div>
<div class="MsoNormal" style="margin: 0in 0in 0pt;"><a href="http://www.makephpbb.com/yansteven259452/" target="_blank"><span style="mso-fareast-font-family: 'Times New Roman';"><span style="text-decoration: underline;"><span style="font-family: Times New Roman; font-size: medium;">http://www.makephpbb.com/yansteven259452/</span></span></span></a>&nbsp;</div>
<div class="MsoNormal" style="margin: 0in 0in 0pt;"><span style="font-family: 'Arial','sans-serif'; color: black; font-size: 10pt;">&nbsp;my registration email address : </span><a title="mailto:yansteven@aol.com" href="mailto:yansteven@aol.com"><span style="font-family: 'Arial','sans-serif'; mso-bidi-font-size: 10.0pt;"><span style="text-decoration: underline;"><span style="color: #0000ff; font-size: medium;">yansteven@aol.com</span></span></span></a>&nbsp;</div>
<div class="MsoNormal" style="margin: 0in 0in 0pt;">&nbsp;</div>
<div class="MsoNormal" style="margin: 0in 0in 0pt;"><span style="font-family: 'Arial','sans-serif'; color: black; font-size: 10pt;">Original Reg. to PHPBB on Oct. 2007 ] </span></div>
<div class="MsoNormal" style="margin: 0in 0in 0pt;">&nbsp;</div>
<div><span style="font-family: 'Arial','sans-serif'; color: black; font-size: 10pt;">&nbsp;&hellip;&hellip;. </span><span style="font-size: medium;"><span style="font-family: Times New Roman;"><strong>full forum URL!</strong><span style="mso-spacerun: yes;">&nbsp; </span>: </span></span><span style="font-family: 'Arial','sans-serif'; color: black; font-size: 10pt;">&nbsp;&hellip; </span><a title="http://www.makephpbb.com/phpbb/admin/index.php?admin=1&amp;mforum=yansteven259452&amp;sid=d663aa006b9e8351b17fd2f38cd34168&amp;mforum=yansteven259452" href="http://www.makephpbb.com/phpbb/admin/index.php?admin=1&amp;mforum=yansteven259452&amp;sid=d663aa006b9e8351b17fd2f38cd34168&amp;mforum=yansteven259452" target="_blank"><strong><span style="font-family: 'Arial','sans-serif'; mso-bidi-font-size: 10.0pt;"><span style="text-decoration: underline;"><span style="color: #0000ff; font-size: medium;">http://www.makephpbb.com/phpbb/admin/index.php?admin=1&amp;mforum=yansteven259452&amp;sid=d663aa006b9e8351b17fd2f38cd34168&amp;mforum=yansteven259452</span></span></span></strong></a>&nbsp;</div>
<div class="MsoNormal" style="margin: 0in 0in 0pt;">&nbsp;</div></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15222);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-09-19 8:00 am</div>
				                <div>Hello YanSteven,<br />
<br />
When attempting to visit your domain, I get a message it cannot be located. When I look for the location of the site, there are no public DNS records showing. You may want to contact your host or registrar to see why the domain is not pointing anywhere at the moment.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15230);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-16582'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/3fa7c621e1c908afda34913398b4deeb?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/3fa7c621e1c908afda34913398b4deeb'>Calvin</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-22 10:46 am</div>
				                <div><p>Hi,</p>
<p>I created a new forum in phpBB3 directly on&nbsp;http://www.forumotion.com. What do you think about this platform please ? Because it seems easier than phpbb. But I'm not sure there are the same options and features. It's a really recent forums, if phpbb it's better, I can change but it's not free, right ?</p>
<p>&nbsp;</p>
<p>Thank you for your help Scott !</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16582);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-22 11:41 am</div>
				                <div>Hello Calvin,<br />
<br />
Thanks for the question.  I'm not sure what version of PHPBB that you're referring to as the one we offer is PHPBB 3.0.12.  I'm not aware of a paid version known as phpBB3.  The software is free, to my knowledge.  You can obtain it through <a href="http://www.inmotionhosting.com/support/edu/cpanel/softaculous/how-to-install">Softaculous</a> or you can go directly to their <a href="https://www.phpbb.com/downloads/" rel="nofollow" target="_blank"> website</a>.  <br />
<br />
phpBB has been around for many years and is still in use by many users, so the platform definitely has some positive value for forum use.  In regards to your question, I can't really make a recommendation other than to say that the  3.x versions have many <a href="https://www.phpbb.com/about/launch/" rel="nofollow" target="_blank">improvements</a> and will be more secure.<br />
<br />
Hope that helps to answer your questions!<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16585);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-22 11:46 am</div>
				                <div><p>Hello Arn,</p>
<p>The forum software is free but to enjoy a phpBB3 forum, you need to pay a server, a domain name and install it :) ! Thanks for all the information, it will be really helpful for me.</p>
<p>&nbsp;</p>
<p>Best,</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16586);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-22 12:04 pm</div>
				                <div>Hello Calvin,<br />
<br />
InMotion Hosting is a hosting company that provides the hosting server, and domain name services.  We also provide the server interface software (cPanel) that houses the Softaculous software that allows you to install the software (for free).  <br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(16587);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-25809'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/99f30af3f56db0ca228105efbf6c8bba?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/99f30af3f56db0ca228105efbf6c8bba'>Shabu2018</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-15 2:22 pm</div>
				                <div><p>Hey... I created a forum, but it's not showing it. I created a category and a forum parented by it, but it simply doesn't show it.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25809);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-17 10:39 am</div>
				                <div>Hello Shabu2018,<br />
<br />
Are you getting any error messages?<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25840);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-29420'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/c7c4699ce6b01344aaea461a37b6de4e?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/c7c4699ce6b01344aaea461a37b6de4e'>Anup kumar</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-12-29 6:09 am</div>
				                <div><p>Hello Scott,</p>
<p>Thank you for your reply which I recieved but I have a link please check it&nbsp;http://www.freeforums.org/ . It is working as I asked you before its appearing before the domain name. I have one more question regarding PHPBB is that How we can make a custom page as it is appearing in the url which I have provided.</p>
<p>&nbsp;</p>
<p>Thank you</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29420);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-12-29 10:05 pm</div>
				                <div>Hello Anup,<br />
<br />
What kind of custom page are you trying to create? Do you mean a custom page within your phpBB installation?</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(29441);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
