<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:105110:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/database-connections/connecting-to-a-database-using-php" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2013-09-12T20:36:07-07:00" />
  <meta name="keywords" content="PHP MySQL connect database db configure" />
  ...
  <link href="http://www.inmotionhosting.com/support/website/database-connections/connecting-to-a-database-using-php" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:18bf731321c7139c2bc9a1db550cc68b -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-25']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '122.164.4.38']);
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Connecting to a Database using PHP									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>28,557</span></div>
							<div style='float:left; margin-right:20px;' title='Originally published: Dec 13, 2011'><span style='color:#606060;'>Published:</span> Sep 12, 2013</div>
							...
							<div style='clear:both;'></div>
								...
								<p>Sometimes you may need to connect your PHP driven website to a database. In most instances content management systems this is done through the config.php file. Below is a sample PHP script that connects to a database and shows all the fields for a specific table you specify in the code.</p>
<p class="alert"><strong>Important!</strong> In order for the database connection to work, you will need to <a target="_blank" href="/support/website/cpanel/how-do-i-create-a-mysql-database-in-my-control-panel-cpanel">create the database</a>, <a target="_blank" href="/support/website/databases/create-db-user">add the database user</a>, and be sure that you <a href="/support/website/databases/create-db-user#assign-user-to-db">attach a MySQL user to the database</a> before attempting to run the script on the server.<br /><br /> If you need to run a database script on your local computer, you will need to set up your computer to run <strong>Apache</strong>, <strong>MySQL</strong>, and <strong>PHP</strong>. You can do this by installing <a target="_blank" href="http://www.wampserver.com/en/">WAMP</a> (Windows), <a target="_blank" href="http://www.mamp.info/en/index.html">MAMP</a> (Mac), or <a target="_blank" href="http://www.apachefriends.org/en/xampp.html">XAMPP</a>.</p>
...
<p><strong>$password</strong>: This is the password for the username you just entered in.</p>
...
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/database-connections/connecting-to-a-database-using-php'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD00MDUmaWQ9MzQwJnZpZXc9YXJ0aWNsZSZJdGVtaWQ9MTAx" />
		<input type="hidden" name="1323d9608f3ce5e2405891aed3b25d2b" value="1" />	</div>
	</form>
<!-- <br />
...
<div style="text-align: right; visibility: hidden; "><a style="text-decoration:none; color: #c0c0c0; font-family: arial,helvetica,sans-serif; font-size: 5pt;" target="_blank" href="http://joomline.org/extensions/component-for-joomla/slogin.html">Social Login Joomla</a></div>		</div>
			<div class="moduletable">
				...
				<div style='margin:10px 0px;'>
                                        <a href='/support/community-support/databases/connect-using-php?tsrc=rsbraq'>How do I connect to a MySQL Database with PHP?</a>
                                </div>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/d496a70238aebd6bdc055efbec06842a?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/d496a70238aebd6bdc055efbec06842a'>viet nam</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-14 10:36 am</div>
				                <div><p>&nbsp;</p>
<p>&nbsp;</p>
<p>project/config/config.php</p>
<p>connect mysql exactly</p>
<p>define ("DB_HOST", "localhost");</p>
<p>define ("DB_POST", "");</p>
<p>define ("DB_USER", "root");</p>
<p>define ("DB_PASSWORD", "");</p>
<p>define ("DB_NAME", "");</p>
<p>&nbsp;</p>
<p>models/congfig.php</p>
<p>&nbsp;</p>
<p>class Db {</p>
<p>&nbsp; &nbsp; &nbsp; static $connection &nbsp;= NULL;</p>
<p>public function __constructe (){</p>
<p>&nbsp; &nbsp;</p>
<p>&nbsp; &nbsp; if (!isset(self::$connection)){</p>
<p>&nbsp; &nbsp; self::$connection = mysql_connect (DB_HOST.":" . DB_POST, DB_USER, DB_PASSWORD);</p>
<p>&nbsp; &nbsp; mysql_select_db( DB_NAME , self::$connection);</p>
<p>&nbsp; &nbsp; mysql_query ( " SET CHARACTER SET utf8 ") or die (mysql_error());</p>
<p>&nbsp; &nbsp;&nbsp;</p>
<p>&nbsp; &nbsp; }</p>
<p>&nbsp;</p>
<p>}</p>
<p>&nbsp;</p>
<p>public function qurery ($query){</p>
<p>&nbsp; &nbsp; &nbsp; &nbsp; $data = mysql_query($query,self::$connection);</p>
<p>&nbsp; &nbsp; &nbsp; &nbsp; if (is_bool($data)) return array;</p>
<p>&nbsp; &nbsp; &nbsp; &nbsp; $rows = array();</p>
<p>&nbsp; &nbsp; &nbsp; &nbsp; while ($row = mysql_fetch_assoc($data)){</p>
<p>&nbsp; &nbsp; &nbsp; &nbsp; $rows[] = $row;</p>
<p>&nbsp; &nbsp; &nbsp; &nbsp; }</p>
<p>&nbsp; &nbsp; &nbsp; &nbsp; return $rows;</p>
<p>&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;</p>
...
<p>&nbsp;</p>
<p>&nbsp;</p>
<p>project/models/function.php&nbsp;</p>
<p>&nbsp;</p>
<p>class Result extends {</p>
<p>&nbsp; &nbsp; &nbsp;private $_table = "name_table";</p>
<p>&nbsp; &nbsp; &nbsp;public function __construct(){</p>
<p>&nbsp; &nbsp; self::__construct();</p>
<p>&nbsp; &nbsp; &nbsp;}</p>
<p>&nbsp; &nbsp; &nbsp;public function select (){</p>
<p>&nbsp; &nbsp; &nbsp;$query = " SELECT * FROM " . $this-&gt;_table;</p>
<p>&nbsp; &nbsp; &nbsp;$select_table = $this-&gt;query($query);</p>
<p>&nbsp; &nbsp; &nbsp;return $select_table;</p>
<p>&nbsp; &nbsp; &nbsp;</p>
<p>&nbsp; &nbsp; &nbsp;}</p>
<p>&nbsp; &nbsp; &nbsp;}</p>
<p>&nbsp; &nbsp; &nbsp;</p>
<p>&nbsp; &nbsp; &nbsp;</p>
<p>&nbsp; &nbsp; &nbsp;</p>
<p>&nbsp; &nbsp; &nbsp;project/index.php&nbsp;</p>
<p>&nbsp; &nbsp; &nbsp;</p>
<p>&nbsp; &nbsp; &nbsp;$data = new Result();</p>
<p>&nbsp; &nbsp; &nbsp;$select = $data-&gt;select();</p>
<p>&nbsp; &nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9697);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-14 10:45 am</div>
				                <div>Your question is a bit unclear.  Could you clarify what we can assist you with?</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9698);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 80px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-16 10:04 am</div>
				                <div><p>I want to ask you, is there a standard way to connect database and correct,&nbsp;</p>
<p>I see a lot of connection types and display data, the standard way with php and mysql not, ?</p>
<p>&nbsp;as I have presented is called the standard php mysql not ?</p>
<p>Best Regards,</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9762);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 120px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-04-16 12:08 pm</div>
				                <div>Hello Viet nam,<br />
<br />
If you are hosting on our servers, then database is "local" to the website files, so the connection is made "locally".  Therefore, the connection setting is set to "localhost" by default.   If you're trying to connect to a database outside of the hosting server, then you would have to setup a connection string using something like the <a href="http://www.w3schools.com/php/php_mysql_connect.asp" rel="nofollow" target="new">mysqli_connect() function</a> .  <br />
<br />
I hope that helps to answer your question.  Please let us know if you need further assistance.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(9765);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-17190'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/6a11cfa5ca5cc3f66415b021aea62dd0?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/6a11cfa5ca5cc3f66415b021aea62dd0'>gunasekaran</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-07 8:31 am</div>
				                <div><p>Hi sir i am Guna,</p>
<p>I am new to PHP. i know the Concepts of Core PHP. but i have no idea about PHP mailer. concepts so please help me for that like how to send a mail using PHP. i have the files(class.pop3.php, class.phpmailer.php &amp; class.smtp.php) but i dont know how to use that and configure. so please help me.</p>
<p>&nbsp;</p>
<p>Regards.</p>
<p>GunaSrini.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17190);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-11-07 12:14 pm</div>
				                <div>Hello Guna,<br />
<br />
We do not have specific articles on those particular functions, however we do have an article on <a href="http://www.inmotionhosting.com/support/email/send-email-from-a-page/using-phpmailer-to-send-mail-through-php">php mailer</a> that may help.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(17205);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/46373ceb80a1c50c80c496e7bc2915d6?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/46373ceb80a1c50c80c496e7bc2915d6'>arvin </a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-14 9:40 am</div>
				                <div><p>hi sir. i ask if that code is the same in the storing data in the data base???&nbsp;and that is the code for MYSQL . how about for the sybase ?? they are the same ??&nbsp;</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25788);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-14 3:08 pm</div>
				                <div>Hello Arvin,<br />
<br />
Thanks for the question.  I would hesitate to say it's the same in Sybase, the underlying principles may be the same, but the code is different.  We do not provide coding support as it is beyond the scope of our support.<br />
<br />
If you have any further questions or comments, please let us know.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25793);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-25906'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/95116eb4070cc32ba50711c7f4db1964?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/95116eb4070cc32ba50711c7f4db1964'>michael harvard</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-19 12:11 pm</div>
				                <div><p>where do i upload the config.php script using ftp?</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25906);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-08-19 1:36 pm</div>
				                <div>Hello Michael,<br />
<br />
We're not exactly sure what you're using, or if you're hosting a site with us.  The location may differ depending on the software you're talking about, your host, and where you have installed the website.   Please provide more information about your installation  - website software used, how it was installed, and where it was installed.<br />
<br />
If you have any further questions or comments, please let us know.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(25913);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-26575'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/cca4a62ca441c61beb566b748e6656fb?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/cca4a62ca441c61beb566b748e6656fb'>Keith</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-11 9:37 am</div>
				                <div><p>Hello,</p>
<p>I am working for a client with a VPS on inmotion. The work I'm doing is being moved from my server to the client's. I have created the database, database user, attached the database user to the database and imported structure and data (verified using phpMyAdmin).</p>
<p>However, the PHP code is unable to connect to the database. I'm using "localhost" (which is what phpMyAdmin shows), I've double-checked and double-set the password, ensured that username and database names are correct (including prefix with underscore). I've even given the database user all privileges for the purpose of troubleshooting.</p>
<p>MySQL Info:</p>
<ul>
<li id="li_server_info">Server: Localhost via UNIX socket</li>
<li id="li_server_type">Server type: MySQL</li>
<li id="li_server_version">Server version: 5.1.73-cll - MySQL Community Server (GPLv2)</li>
<li id="li_user_info">Protocol version: 10</li>
<li id="li_select_mysql_charset">Server charset: <span dir="ltr" lang="en"> UTF-8 Unicode (utf8) </span></li>
</ul>
<p>PHP Version 5.4.45, using mysqli (and have verified through phpinfo() that mysqli is supported in the build). </p>
<p>What assistance can you offer?</p>
<p>Thanks,</p>
<p>Keith</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26575);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-09-14 12:41 pm</div>
				                <div>Hello Keith,<br />
<br />
From what you told me, there shouldn't be any issues. You may want to contact our Live Support so wec an walk through the setup step by step. It would require divulging some sensitive info you do not want to put here.<br />
<br />
Kindest Regards,<br />
Scott M</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(26627);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-27132'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/a0fd6d2f69bad0cf1c9c5be71c42c85d?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/a0fd6d2f69bad0cf1c9c5be71c42c85d'>via Karen</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-01 1:09 pm</div>
				                <div><p>hi! im new to PHP but im willing to learn. we are required by oir professor to develop an "Online grading system".. we already have our database for students' login account (containg their username &amp; password).. our index and login page is already okay.. but our problem is, how will I make that when a student logged in, for example me (via karen), when i logged in , my grades for the semester will appear. and when my classmate (Mark) logged in in his account, his grades na ssubjects for the semester will appear.? can you help us please?</p>
<p>&nbsp;</p>
<p>&nbsp;</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27132);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-01 2:37 pm</div>
				                <div>Hello Karen,<br />
<br />
Thank you for contacting. We are happy to help guide you, but your question will require a custom-coded solution. <br />
<br />
I recommend consulting a developer to assist you in working toward a solution.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27143);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-28597'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/1d545a2678cd8663c8de0ec06fbaf56d?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/1d545a2678cd8663c8de0ec06fbaf56d'>Olanrewaju</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-20 3:54 pm</div>
				                <div><p>Not clear about the topic above. My question is, on migrating to inmotion, what exactly do i replace "localhost" with? It's confusing what should be used.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28597);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-11-20 6:10 pm</div>
				                <div>Hello Olanrewaju,<br />
<br />
The problem here is that we quite often address people not being hosted with InMotion Hosting.  So, if you're not a customer and you don't understand how to connect to your database, then you'll need to speak with your host's technical support, or speak with a local developer who can look at your code.  For our customers, you do NOT replace "localhost" because the web server connects to the database locally in our network.  The article above was created for InMotion Hosting customers in general.  However, we do try to help anyone who asks, but we would need more information about how you are connecting to your database server in order to provide you an answer.<br />
<br />
I hope this helps to answer your question, please let us know if you require any further  assistance.<br />
<br />
Regards,<br />
Arnel C.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(28602);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-30938'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/f6f1f5755b1a4f6702cc321e8cf9826d?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/f6f1f5755b1a4f6702cc321e8cf9826d'>Mekbeb Engdashet</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-02 4:00 am</div>
				                <div><p>My Website is Not Connect with web page on Web server My website Host By Freewebhostarea.com So How to Connect My Website Database Pls tell Guys?</p>
<p></p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30938);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-02 10:00 pm</div>
				                <div>Hello Mekbeb,<br />
<br />
Sorry for the problem with connecting your database.  This will differ from host to host and may also differ based on your website's configuration requirements.  Please confer with your host to see how to connect to your database.  Additionally, make sure to verify how your website is configuring it's connection information for your website.<br />
<br />
If you have any further questions or comments, please let us know.<br />
<br />
Regards,<br />
...
<br />
						...
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30955);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-31594'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/bbe2cbb6f0ca2192ab66a0c41813cf2e?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/bbe2cbb6f0ca2192ab66a0c41813cf2e'>Kerrie</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-03-31 2:31 pm</div>
				                <div><p>When I add in this section:</p>
<pre class="code_block" style="margin-let: 20px;">//Setup connection variables, such as database username
//and password
$hostname="localhost";
$username="your_dbusername";
$password="your_dbpassword";
...
//Connect to the database
$connection = mysql_connect($hostname, $username, $password);
mysql_select_db($dbname, $connection);Where do I actually replace username and password with those values? Is it just in the section //Connect to the database? or //Setup connection variables, such as database username
//and password?  or both? I'm guessing we don't want to leave them saying 'ussername' and 'password'?Also, setting up this connection page will ensure password and usernames won'tshow up in the source files of the code and protect the security of our website?Thanks for any help here!Kerrie </pre></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31594);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-04-01 9:55 am</div>
				                <div>Hello Kerrie,<br />
<br />
Thank you for contacting us. You should replace the information within the quotation ("") marks.<br />
<br />
Thank you,<br />
John-Paul</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(31619);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
