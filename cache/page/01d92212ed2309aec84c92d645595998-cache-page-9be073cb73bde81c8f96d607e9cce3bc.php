<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:74155:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/website/how-to/creating-a-custom-404-error-page" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta http-equiv="last-modified" content="2012-10-18T18:17:52-07:00" />
  <meta name="keywords" content="create creating custom static 404 error not found pages page cpanel file manager" />
  <meta name="author" content="Jacob Nicholson" />
  <meta name="description" content="In this article we'll discuss how you can setup a custom 404 error page for your website, allowing you to control what message is displayed for requests to non-existent pages." />
  <title>Creating a custom 404 error page - InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/website/how-to/creating-a-custom-404-error-page" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:ee8922ebda210728f2b61bf99f059e17 -->
...
<div class='container'>
	<div class='main-left-sc' name='sc_left' id='sc_left' style='max-width:705px;'>
		...
		<div class="page-header">
						<h1>
															Creating a custom 404 error page									</h1>
					...
					<div style='font-size:12px; color:#aaa; margin-bottom:-10px; padding-top:5px;'>
							...
							<div style='float:left; margin-right:20px;'><span style='color:#606060;'>Views:</span> <span name='page_views' id='page_views'>26,180</span></div>
							...
							<div style='clear:both;'></div>
								...
								<p>In this article we'll discuss how you can setup a custom 404 error page for your website. This will allow you to control exactly what message is displayed to your visitors when they try to request a page that doesn't exist.</p>
<p>If you read our previous article on <a href="/support/website/website-troubleshooting/404-error-not-found-pages">404 error not found pages</a>, you should have a good understanding of why creating a custom 404 error page can be helpful.</p>
<p>You can simply upload a file such as <strong>404.html</strong> to your website via <a href="/support/website/file-management/getting-started-guide-ftp">FTP</a>, or if you prefer you can follow the instructions below for creating this file in cPanel via the File Manager.</p>
<div>&nbsp;</div>
...
<li>Select the <strong>Web Root (public_html/www)</strong> option.</li>
<li>Click <strong>Go</strong>.</li>
</div>
<div style="width: 46%; float: right;"><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/404s/create-404/file-manager-go.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/404s/create-404/file-manager-go.png" alt="file-manager-go"  /></a></div>
<div style="clear: both;">&nbsp;</div>
<li>From the top left-hand menu, click on <strong>New File</strong>.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/404s/create-404/new-file.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/404s/create-404/new-file.png" alt="new-file"  /></a></li>
<li>Under <strong>New File Name:</strong> type in <strong>404.html</strong> then click <strong>Create New File</strong>.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/404s/create-404/create-new-file.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/404s/create-404/create-new-file.png" alt="create-new-file"  /></a></li>
<li><strong>Right-click</strong> on the newly created <strong>404.html</strong> then click on <strong>Edit</strong>.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/404s/create-404/right-click-edit.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/404s/create-404/right-click-edit.png" alt="right-click-edit"  /></a></li>
<li>In the <strong>Text Editor</strong> pop-up, simply click on <strong>Edit</strong>.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/404s/create-404/text-editor-edit.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/404s/create-404/text-editor-edit.png" alt="text-editor-edit"  /></a></li>
<li>Now you'd want to type in the HTML code for your custom 404 page, in this example we're using a very basic one that you can copy if you'd like. However you can get very fancy with your own, even going so far as to copying the style and images of your main site and placing your error message in the middle of that.<br /><br />
<p>&lt;html&gt;<br /> &lt;head&gt;<br /> &lt;title&gt;404 Page Not Found&lt;/title&gt;<br /> &lt;body&gt;<br /><br /> &lt;H2&gt;We're sorry but the page you're looking for could not be found&lt;/H2&gt;<br /><br /> &lt;/body&gt;<br /> &lt;/html&gt;</p>
</li>
<li>After you've made your edits, click on <strong>Save Changes</strong>, and you should see a green Success pop-up.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/404s/create-404/text-editor-save-changes.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/404s/create-404/text-editor-save-changes.png" alt="text-editor-save-changes"  /></a><br /><img src="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/404s/file-manager-text-editor-save-success.png" width="243" height="36" alt="file-manager-text-editor-save-success" /></li>
<li>Now if you directly try to pull up <strong>/404.html</strong> in your web-browser, you should see the page we just created.<br /><a class="std_ss" href="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/404s/create-404/web-browser-view-404.png"><img src="//cdn.inmotionhosting.com/support/images/stories/website/website-troubleshooting/404s/create-404/web-browser-view-404.png" alt="web-browser-view-404"  /></a></li>
</ol>
<p>Now that you've learned how to create a custom 404 error page to handle your 404 errors, you'll also more than likely want to learn about <a href="/support/website/how-to/setting-a-404-error-page-via-htaccess">setting a 404 error page via .htaccess</a>. This way any requests for non-existent pages will go directly to your custom static 404 error page that you just created.</p>
<p>You can get even more advanced with your 404 error page by <a href="/support/component/content/education-channels-content/using-google-custom-404-page-widget?Itemid=205">using Google's custom 404 page widget</a> as well. This can help provide relevant content from your site to visitors from a Google search against your website.</p>
<p>If you're using WordPress you might also be interested in learning about <a href="/support/component/content/email/email-client-setup/optimizing-wordpress-with-w3-total-cache?Itemid=242">how to cache&nbsp;404 pages in WordPress using the W3 Total Cache plugin</a>.</p>
</div> 
...
<div style='display:inline-block;'>
	<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/website/how-to/creating-a-custom-404-error-page&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
</div>

	                        
<div style='display:inline-block;'>
	<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/website/how-to/creating-a-custom-404-error-page'></div>
	<script type='text/javascript'>
	  (function() {
	...
	<div name='sc_right' id='sc_right'>
		...
		<input type="hidden" name="return" value="aW5kZXgucGhwP29wdGlvbj1jb21fY29udGVudCZjYXRpZD0zNSZpZD00NDYmdmlldz1hcnRpY2xlJkl0ZW1pZD0xMDE=" />
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/c21ea03d230527610bfe132c45361751?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/c21ea03d230527610bfe132c45361751'>Leo L&Atilde;&sup3;pez</a></div>
						<div></div>
						<div></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2014-10-07 3:50 pm</div>
				                <div>explicando la forma correcta de activar un error404 personalizado, y que funcione.<br />
Translated by Google: explaining the correct way to trigger a custom error404 , and it works.</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(15972);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-20815'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/df99fbc15708a99d6cc12867d7bdcfcd?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/df99fbc15708a99d6cc12867d7bdcfcd'>Adrian Pusca</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-18 6:31 am</div>
				                <div><p>Thanks :) I did it!</p>
<p>Useful guide.</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20815);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-20847'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/97fa245beec1dc29fe1ce15318ffa5e2?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/97fa245beec1dc29fe1ce15318ffa5e2'>Keith Miller</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-02-19 6:10 am</div>
				                <div>This was extremely helpful!</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(20847);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<a name='comment-27259'></a>
		<div  style='margin:40px 0px 0px 0px;'>
			
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					<td valign='top' style='width:100px; padding:5px; border-right:1px solid #aaa;background-image: -webkit-linear-gradient(top,#e3e3e3,#efefef);background-image: linear-gradient(to bottom, #E3E3E3, #EFEFEF); border-bottom-left-radius: 5px; border-top-left-radius: 5px;'>
						<img src='//www.gravatar.com/avatar/206a6d8456d6911748e1ba9aa18096bf?s=90' class='sc_rc' style='max-width:90px; margin-right:15px;display:block;' />
						<div><a style='font-size:16px;' href='//www.gravatar.com/206a6d8456d6911748e1ba9aa18096bf'>Digambar sonavdekar</a></div>
						<div></div>
						<div></div>
						<div><span title='Posted anonymously - anonymous users receive no points'>n/a <a href='/support/team/points' target='_blank'>Points</a></span></div>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-06 6:30 am</div>
				                <div><p>.htaccess file not work in&nbsp;https://www.way2wealthrealty.com</p></div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27259);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:2px 0px 0px 40px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2015-10-06 11:02 pm</div>
				                <div>Hello Digambar,<br />
<br />
Can you please provide what modifications you are trying to perform? Also are you using Apache as your web server service?<br />
<br />
Best Regards,<br />
TJ Edens</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(27275);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
		...
		<div  style='margin:40px 0px 0px 0px;'>
			...
			<table style='width:100%; border-collapse:separate; border:1px solid #aaa;' class='sc_rc'>
				<tr>
					...
					<td valign='top' style='padding:5px; background:#fff; border-bottom-right-radius: 5px; border-top-right-radius: 5px;'>
						<div style='float:right;margin:0px 0px 15px 15px;font-size:12px;color:#aaa'>2016-02-16 8:47 am</div>
				                <div>very useful article, thanks!</div>
						<div style='text-align:right; clear:both;'><a href='#post_a_comment' class='btn btn-primary' style='text-transform:none;' onClick="jQuery('#new_comment_parent_id').val(30594);jQuery('html, body').animate({scrollTop: jQuery('#main_comment_submission_div').offset().top}, 1500);return false;" >Reply</a></div>
