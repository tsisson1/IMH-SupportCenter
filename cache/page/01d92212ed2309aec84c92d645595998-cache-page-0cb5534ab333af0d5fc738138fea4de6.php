<?php die("Access Denied"); ?>#x#a:3:{s:4:"body";s:51028:" 
...
<meta name="viewport" content="width=device-width" />
		  ...
		  <base href="http://www.inmotionhosting.com/support/community-support/databases/auto-increment-to-database-id-field" />
  <meta http-equiv="content-type" content="text/html; charset=utf-8" />
  <meta name="description" content="Hello, and thanks for your question. You can use phpMyadmin on the server to manage your MySQL databases. You can simply click on the A_I column check-b..." />
  <title>AUTO INCREMENT option for database ID field | InMotion Hosting</title>
  <link href="http://www.inmotionhosting.com/support/community-support/databases/auto-increment-to-database-id-field" rel="canonical" />
...
<script type="text/javascript">
  ...
  (function() {
	...
	<!-- cid:61c48a252540071186faad2214c17bcc -->
...
<script type="text/javascript">
                ...
                window.open('https://www.inmotionhosting.com/support/launch-chat/?rdid=2324923566971164486&url=' + escape(document.location.href), 'Chat8718689652968401074', 'toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=0,resizable=1,width=640,height=650');
                        ...
                        _gaq.push(['_setAccount', 'UA-1501988-22']);
                        _gaq.push(['_trackEvent', 'chat-by-ip', 'launch-by-ip', '112.133.243.242']);
...
<div class='item-page'>
	<div class='page-header cs_nav'>
        ...
        <div class='white_box '>
                <h1 style='font-size:26px;'>AUTO INCREMENT option for database ID field</h1>
		...
		<div style='float:right; width:110px; margin:0px 0px 25px 25px;'>
			...
			<div class='smallgrey' style='margin-top:10px;'>
				Asked:<br />
				2014-06-05 3:26 pm EST<br /><br />
				Hits: <span name='page_views' id='page_views'>2,842</span>
			</div>
			
		</div>
		<div>
			<div style='min-height:110px;'>Where is the auto increment option to ID field in database?</div>
...
<div class='vote_div'>
	<form method='post' name='upvote_answer_5063' id='upvote_answer_5063' class='f_vote_option'>
		<input type='hidden' name='object_type' id='object_type' value='answer' />
		<input type='hidden' name='object_id' id='object_id' value='5063' />
		...
		<div class='thumbs_up' onClick="document.getElementById('upvote_answer_5063').submit();"></div>
	</form>
	<div class='vote_sum'>0</div>
	<form method='post' name='downvote_answer_5063' id='downvote_answer_5063' class='f_vote_option'>
                <input type='hidden' name='object_type' id='object_type' value='answer' />
                <input type='hidden' name='object_id' id='object_id' value='5063' />
                <input type='hidden' name='component' id='component' value='qa' />
                <input type='hidden' name='vote_value' id='vote_value' value='-1' />
		<input type='hidden' name='sc_task' id='sc_task' value='vote' />
                <div class='thumbs_down' onClick="document.getElementById('downvote_answer_5063').submit();"></div>
        </form>
</div>
	</td>
			<td valign='top'>
...
<br />
You can use &lt;a href=&quot;http://www.inmotionhosting.com/support/website/database-setup/how-do-i-manage-a-mysql-database-in-phpmyadmin-in-my-control-panel-cpanel&quot; target=&quot;_blank&quot;&gt;phpMyadmin&lt;/a&gt; on the server to manage your MySQL databases. You can simply click on the &lt;strong&gt;A_I&lt;/strong&gt; column check-box for &lt;strong&gt;Auto Increment&lt;/strong&gt; on the far-right of the column you want auto incremented.<br />
<br />
&lt;img class=&quot;std_ss&quot; alt=&quot;phpmyadmin auto increment location&quot; src=&quot;http://inmotionhosting.com/support/images/stories/questions/phpmyadmin-auto-increment-location.png&quot;&gt;<br />
<br />
If you already have a database column in mind that you'd like to set to &lt;strong&gt;Auto Increment&lt;/strong&gt;, select your database in phpMyAdmin from the left-hand menu under your cPanel username. <br />
<br />
Click on &lt;strong&gt;Structure&lt;/strong&gt; beside the table that contains the column you want auto incremented.<br />
<br />
Then click on &lt;strong&gt;Change&lt;/strong&gt; beside the column you want auto incremented, place a check in the &lt;strong&gt;A_I&lt;/strong&gt; column, and then click &lt;strong&gt;Save&lt;/strong&gt;.<br />
<br />
If you haven't created the table yet, at the bottom of the screen once you've selected your database, under the &lt;strong&gt;Create table&lt;/strong&gt; section name your table and how many columns you want, then click &lt;strong&gt;Go&lt;/strong&gt; and you should see the same options.<br />
<br />
If you are just trying to use SQL directly to modify an already existing column to become auto incremented, the syntax would look like this:<br />
<br />
&lt;pre class=&quot;code_block&quot; style=&quot;margin: -10px 0px -30px 0px; line-height: .9em&quot;&gt;ALTER TABLE `User` CHANGE `id` `id` INT(3) NOT NULL AUTO_INCREMENT;&lt;/pre&gt;<br />
<br />
...
- Jacob
				...
				<div style='clear:both; margin:10px 0px;'>
					<a name='post_a_comment'></a><input class='std_blue_button' type='button' value='Comment on this answer' onClick="jQuery('#form_comment_on_answer_5063').slideToggle('slow');" style='display:inline;'>
				        
				          <form name='form_comment_on_answer_5063' id='form_comment_on_answer_5063' class='form_comment_on_answer'>
						<div id='system-message-container'><div id='system-message'><div class='alert alert-notice'><div>
	...
	<div style='text-align:right; margin:15px -30px 15px 0px;'>
		...
		<iframe src='//www.facebook.com/plugins/like.php?href=http://www.inmotionhosting.com/support/community-support/databases/auto-increment-to-database-id-field&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=false&amp;font=verdana&amp;colorscheme=light&amp;action=like&amp;height=21&amp;appId=209145459223160' scrolling='no' frameborder='0' style='border:none; overflow:hidden; width:100px; height:21px;' allowTransparency='true'></iframe>
		
<div class='g-plusone' data-size='medium' data-href='http://www.inmotionhosting.com/support/community-support/databases/auto-increment-to-database-id-field'></div>
<script type='text/javascript'>
  (function() {
